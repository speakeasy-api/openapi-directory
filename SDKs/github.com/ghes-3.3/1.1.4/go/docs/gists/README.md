...
func main() {
    ...
    res, err := s.Gists.GistsCreate(ctx, operations.GistsCreateRequestBody{
        ...
        Files: map[string]GistsCreateRequestBodyFiles{
            ...
            "blanditiis": operations.GistsCreateRequestBodyFiles{
                Content: "quas",
            },
            "hic": operations.GistsCreateRequestBodyFiles{
                Content: "nesciunt",
            },
        },
...
func main() {
    ...
    res, err := s.Gists.GistsList(ctx, operations.GistsListRequest{
        Page: sdk.Int64(967966),
        PerPage: sdk.Int64(131852),
        Since: types.MustTimeFromString("2020-11-16T19:55:44.497Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Gists.GistsListCommits(ctx, operations.GistsListCommitsRequest{
        GistID: "iste",
        Page: sdk.Int64(292794),
        PerPage: sdk.Int64(671907),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Gists.GistsListForUser(ctx, operations.GistsListForUserRequest{
        ...
        Since: types.MustTimeFromString("2022-04-21T22:21:50.112Z"),
...
func main() {
    ...
    res, err := s.Gists.GistsListPublic(ctx, operations.GistsListPublicRequest{
        ...
        Since: types.MustTimeFromString("2022-06-15T09:17:17.445Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Gists.GistsListStarred(ctx, operations.GistsListStarredRequest{
        ...
        Since: types.MustTimeFromString("2022-05-29T20:03:41.130Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
    ...
    res, err := s.Gists.GistsUpdate(ctx, operations.GistsUpdateRequest{
        RequestBody: operations.GistsUpdateRequestBody1{
            ...
            Files: map[string]interface{}{
                "occaecati": operations.GistsUpdateRequestBody1Files2{
                    Content: sdk.String("voluptatibus"),
                    Filename: "tempora",
                },
                "tempora": operations.GistsUpdateRequestBody1Files2{
