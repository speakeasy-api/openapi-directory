 ...
 */
export class DestinyDefinitionsDestinyItemSocketEntryDefinition extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    elemType: DestinyDefinitionsDestinyItemSocketEntryPlugItemDefinition,
  })
