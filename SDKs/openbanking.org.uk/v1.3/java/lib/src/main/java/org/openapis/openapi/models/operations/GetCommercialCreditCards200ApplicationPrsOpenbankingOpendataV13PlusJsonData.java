...
public class GetCommercialCreditCards200ApplicationPrsOpenbankingOpendataV13PlusJsonData {
    ...
    public GetCommercialCreditCards200ApplicationPrsOpenbankingOpendataV13PlusJsonData(@JsonProperty("Benefits") GetCommercialCreditCards200ApplicationPrsOpenbankingOpendataV13PlusJsonDataBenefits benefits, @JsonProperty("Description") String description, @JsonProperty("Details") GetCommercialCreditCards200ApplicationPrsOpenbankingOpendataV13PlusJsonDataDetails details, @JsonProperty("Eligibility") GetCommercialCreditCards200ApplicationPrsOpenbankingOpendataV13PlusJsonDataEligibility eligibility, @JsonProperty("KeyFeatures") String keyFeatures, @JsonProperty("Organisation") GetCommercialCreditCards200ApplicationPrsOpenbankingOpendataV13PlusJsonDataOrganisation organisation, @JsonProperty("PaymentHoliday") Boolean paymentHoliday, @JsonProperty("ProductIdentifier") String productIdentifier, @JsonProperty("ProductName") String productName, @JsonProperty("ProductType") GetCommercialCreditCards200ApplicationPrsOpenbankingOpendataV13PlusJsonDataProductTypeEnum productType, @JsonProperty("ProductURL") String[] productURL, @JsonProperty("TsandCs") String[] tsandCs) {
        this.benefits = benefits;
        this.description = description;
        this.details = details;
        this.eligibility = eligibility;
