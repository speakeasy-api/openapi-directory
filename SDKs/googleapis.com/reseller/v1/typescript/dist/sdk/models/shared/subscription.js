...
var SubscriptionPlan = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=commitmentInterval" }),
        __metadata("design:type", SubscriptionPlanCommitmentInterval)
    ], SubscriptionPlan.prototype, "commitmentInterval", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isCommitmentPlan" }),
...
var SubscriptionTransferInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=currentLegacySkuId" }),
        __metadata("design:type", String)
    ], SubscriptionTransferInfo.prototype, "currentLegacySkuId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=minimumTransferableSeats" }),
        __metadata("design:type", Number)
    ], SubscriptionTransferInfo.prototype, "minimumTransferableSeats", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transferabilityExpirationTime" }),
        __metadata("design:type", String)
...
var SubscriptionTrialSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isInTrial" }),
        __metadata("design:type", Boolean)
    ], SubscriptionTrialSettings.prototype, "isInTrial", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=trialEndTime" }),
        __metadata("design:type", String)
...
var Subscription = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transferInfo" }),
