...
var Pac = /** @class */ (function () {
    ...
    Pac.prototype.userPACs = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/users/{userId}/pac", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.UserPACsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.userPACs200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.UserPACs200ApplicationJSON);
                    }
