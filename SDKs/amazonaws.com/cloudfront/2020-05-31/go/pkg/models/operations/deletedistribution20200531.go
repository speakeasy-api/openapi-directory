...
type DeleteDistribution20200531PathParams struct {
	// The distribution ID.
	ID string `pathParam:"style=simple,explode=false,name=Id"`
}

type DeleteDistribution20200531Headers struct {
...
type DeleteDistribution20200531Request struct {
	PathParams DeleteDistribution20200531PathParams
	Headers    DeleteDistribution20200531Headers
}

type DeleteDistribution20200531Response struct {
	Body        []byte
	ContentType string
	StatusCode  int
