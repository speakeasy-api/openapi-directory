...
export class Dcim {
  ...
  dcimChoicesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DcimChoicesListResponse =
        new operations.DcimChoicesListResponse({
  ...
  dcimChoicesRead(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/dcim/_choices/{id}/", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DcimChoicesReadResponse =
        new operations.DcimChoicesReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  dcimDevicesCreate(
    req: shared.WritableDeviceInput,
    config?: AxiosRequestConfig
  ...
  dcimInterfaceConnectionsCreate(
    req: shared.WritableInterfaceConnectionInput,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DcimInterfaceConnectionsCreateResponse =
        new operations.DcimInterfaceConnectionsCreateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.interfaceConnection = utils.objectToClass(
              httpRes?.data,
              shared.InterfaceConnection
            );
          }
          break;
      }
  ...
  dcimInterfaceConnectionsDelete(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DcimInterfaceConnectionsDeleteResponse =
        new operations.DcimInterfaceConnectionsDeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  dcimInterfaceConnectionsPartialUpdate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DcimInterfaceConnectionsPartialUpdateResponse =
        new operations.DcimInterfaceConnectionsPartialUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  dcimInterfaceConnectionsRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DcimInterfaceConnectionsReadResponse =
        new operations.DcimInterfaceConnectionsReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  dcimInterfaceConnectionsUpdate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DcimInterfaceConnectionsUpdateResponse =
        new operations.DcimInterfaceConnectionsUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  dcimRacksUnits(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DcimRacksUnitsResponse =
        new operations.DcimRacksUnitsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
