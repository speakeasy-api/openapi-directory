...
from ..shared import eevalidatepinrequest as shared_eevalidatepinrequest
from ..shared import eevalidatepinresponse as shared_eevalidatepinresponse
...
class ValidatePinRequestRequest:
    ...
    ee_validate_pin_request: shared_eevalidatepinrequest.EeValidatePinRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ValidatePinRequestResponse:
    ...
    ee_validate_pin_response: Optional[shared_eevalidatepinresponse.EeValidatePinResponse] = dataclasses.field(default=None)
