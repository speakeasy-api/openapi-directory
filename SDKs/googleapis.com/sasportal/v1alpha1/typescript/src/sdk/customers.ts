...
export class Customers {
  ...
  **/
  sasportalCustomersList(
  ...
  ): Promise<operations.SasportalCustomersListResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.SasportalCustomersListRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.SasportalCustomersListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
