...
class UpsertAccount429ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\UpsertAccount429ApplicationJSONMeta')]
    public UpsertAccount429ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\UpsertAccount429ApplicationJSONMeta();
	}
}
