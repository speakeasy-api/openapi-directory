 ...
 */
export declare class DescribeSecurityGroupsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeSecurityGroupsRequest extends SpeakeasyBase {
    dryRun?: boolean;
