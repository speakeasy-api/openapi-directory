...
class IamPolicyAnalysis:
    ...
    non_critical_errors: Optional[list[shared_iampolicyanalysisstate.IamPolicyAnalysisState]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nonCriticalErrors'), 'exclude': lambda f: f is None }})
    r"""A list of non-critical errors happened during the query handling."""  
