...
var HeavyEquipmentsSearchResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: heavyequipmentsbaselisting_1.HeavyEquipmentsBaseListing }),
        (0, class_transformer_1.Expose)({ name: "listings" }),
        (0, class_transformer_1.Type)(function () { return heavyequipmentsbaselisting_1.HeavyEquipmentsBaseListing; }),
