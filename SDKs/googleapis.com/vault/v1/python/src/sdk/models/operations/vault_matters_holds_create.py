...
class VaultMattersHoldsCreateRequest:
    path_params: VaultMattersHoldsCreatePathParams = dataclasses.field()
    query_params: VaultMattersHoldsCreateQueryParams = dataclasses.field()
    security: VaultMattersHoldsCreateSecurity = dataclasses.field()
    request: Optional[shared_hold.Hold] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
