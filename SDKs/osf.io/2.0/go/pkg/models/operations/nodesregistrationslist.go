...
type NodesRegistrationsListRegistrationAttributesCategoryEnum string

const (
	NodesRegistrationsListRegistrationAttributesCategoryEnumAnalysis           NodesRegistrationsListRegistrationAttributesCategoryEnum = "analysis"
	NodesRegistrationsListRegistrationAttributesCategoryEnumCommunication      NodesRegistrationsListRegistrationAttributesCategoryEnum = "communication"
	NodesRegistrationsListRegistrationAttributesCategoryEnumData               NodesRegistrationsListRegistrationAttributesCategoryEnum = "data"
	NodesRegistrationsListRegistrationAttributesCategoryEnumHypothesis         NodesRegistrationsListRegistrationAttributesCategoryEnum = "hypothesis"
	NodesRegistrationsListRegistrationAttributesCategoryEnumInstrumentation    NodesRegistrationsListRegistrationAttributesCategoryEnum = "instrumentation"
	NodesRegistrationsListRegistrationAttributesCategoryEnumMethodsAndMeasures NodesRegistrationsListRegistrationAttributesCategoryEnum = "methods and measures"
	NodesRegistrationsListRegistrationAttributesCategoryEnumProcedure          NodesRegistrationsListRegistrationAttributesCategoryEnum = "procedure"
	NodesRegistrationsListRegistrationAttributesCategoryEnumProject            NodesRegistrationsListRegistrationAttributesCategoryEnum = "project"
	NodesRegistrationsListRegistrationAttributesCategoryEnumSoftware           NodesRegistrationsListRegistrationAttributesCategoryEnum = "software"
	NodesRegistrationsListRegistrationAttributesCategoryEnumOther              NodesRegistrationsListRegistrationAttributesCategoryEnum = "other"
)

func (e NodesRegistrationsListRegistrationAttributesCategoryEnum) ToPointer() *NodesRegistrationsListRegistrationAttributesCategoryEnum {
	return &e
}

func (e *NodesRegistrationsListRegistrationAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = NodesRegistrationsListRegistrationAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NodesRegistrationsListRegistrationAttributesCategoryEnum: %v", v)
	}
}

// NodesRegistrationsListRegistrationAttributes - The properties of the registration entity.
type NodesRegistrationsListRegistrationAttributes struct {
	// The category of the registered node.
	Category *NodesRegistrationsListRegistrationAttributesCategoryEnum
...
type NodesRegistrationsListRegistrationLinks struct {
...
type NodesRegistrationsListRegistrationRelationships struct {
