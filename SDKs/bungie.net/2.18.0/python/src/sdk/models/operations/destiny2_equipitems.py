...
from ..shared import destiny_destinyequipitemresults as shared_destiny_destinyequipitemresults
...
class Destiny2EquipItems200Wildcard:
    ...
    response: Optional[shared_destiny_destinyequipitemresults.DestinyDestinyEquipItemResults] = dataclasses.field(default=None)
    r"""The results of a bulk Equipping operation performed through the Destiny API."""  
