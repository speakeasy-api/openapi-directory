...
// documentClassification - Document Classification Functions
...
func (s *documentClassification) AdultContentDetection(ctx context.Context, request operations.AdultContentDetectionRequestBody) (*operations.AdultContentDetectionResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) CommercialDetection(ctx context.Context, request operations.CommercialDetectionRequestBody) (*operations.CommercialDetectionResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) EducationalDetection(ctx context.Context, request operations.EducationalDetectionRequestBody) (*operations.EducationalDetectionResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) GenderDetection(ctx context.Context, request operations.GenderDetectionRequestBody) (*operations.GenderDetectionResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) LanguageDetection(ctx context.Context, request operations.LanguageDetectionRequestBody) (*operations.LanguageDetectionResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) ReadabilityAssessment(ctx context.Context, request operations.ReadabilityAssessmentRequestBody) (*operations.ReadabilityAssessmentResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) SentimentAnalysis(ctx context.Context, request operations.SentimentAnalysisRequestBody) (*operations.SentimentAnalysisResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) SpamDetection(ctx context.Context, request operations.SpamDetectionRequestBody) (*operations.SpamDetectionResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) SubjectivityAnalysis(ctx context.Context, request operations.SubjectivityAnalysisRequestBody) (*operations.SubjectivityAnalysisResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) TopicClassification(ctx context.Context, request operations.TopicClassificationRequestBody) (*operations.TopicClassificationResponse, error) {
	baseURL := s.serverURL
...
func (s *documentClassification) TwitterSentimentAnalysis(ctx context.Context, request operations.TwitterSentimentAnalysisRequestBody) (*operations.TwitterSentimentAnalysisResponse, error) {
	baseURL := s.serverURL
