...
import dataclasses
from ..shared import rfqdetailsvo as shared_rfqdetailsvo
...
class RfqExpandVO:
    r"""Java type: com.noosh.nooshapi.vo.RfqExpandVO"""
    
    result: Optional[shared_rfqdetailsvo.RfqDetailsVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
