...
exports.SearchEarthSatelliteLandsatResponse = exports.SearchEarthSatelliteLandsatRequest = exports.SearchEarthSatelliteLandsatQueryParams = void 0;
...
var SearchEarthSatelliteLandsatQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.earth_satellite_landsat.archive_version_number" }),
        __metadata("design:type", Number)
    ], SearchEarthSatelliteLandsatQueryParams.prototype, "searchEarthSatelliteLandsatArchiveVersionNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.earth_satellite_landsat.ground_station" }),
        __metadata("design:type", String)
    ], SearchEarthSatelliteLandsatQueryParams.prototype, "searchEarthSatelliteLandsatGroundStation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.earth_satellite_landsat.satellite" }),
        __metadata("design:type", String)
    ], SearchEarthSatelliteLandsatQueryParams.prototype, "searchEarthSatelliteLandsatSatellite", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.earth_satellite_landsat.sensor" }),
        __metadata("design:type", String)
    ], SearchEarthSatelliteLandsatQueryParams.prototype, "searchEarthSatelliteLandsatSensor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.earth_satellite_landsat.wrs_path_number" }),
        __metadata("design:type", Number)
    ], SearchEarthSatelliteLandsatQueryParams.prototype, "searchEarthSatelliteLandsatWrsPathNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.earth_satellite_landsat.wrs_row_number" }),
        __metadata("design:type", Number)
...
exports.SearchEarthSatelliteLandsatQueryParams = SearchEarthSatelliteLandsatQueryParams;
