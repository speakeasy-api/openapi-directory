...
public class Assembly {
    @JsonProperty("group_probabilities")
    public Double[] groupProbabilities;
    public Assembly withGroupProbabilities(Double[] groupProbabilities) {
        this.groupProbabilities = groupProbabilities;
        return this;
    }
    @JsonProperty("sites_in_groups")
    public Long[][] sitesInGroups;
    public Assembly withSitesInGroups(Long[][] sitesInGroups) {
