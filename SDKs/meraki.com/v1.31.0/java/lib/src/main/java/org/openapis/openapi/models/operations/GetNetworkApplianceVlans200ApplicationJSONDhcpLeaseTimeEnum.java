 ...
 */
public enum GetNetworkApplianceVlans200ApplicationJSONDhcpLeaseTimeEnum {
    ONE_DAY("1 day"),
    ONE_HOUR("1 hour"),
    ONE_WEEK("1 week"),
    ...
    private GetNetworkApplianceVlans200ApplicationJSONDhcpLeaseTimeEnum(String value) {
        this.value = value;
    }
}
