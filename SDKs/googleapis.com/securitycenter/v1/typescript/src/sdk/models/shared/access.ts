...
export class Access extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: ServiceAccountDelegationInfo })
  @Expose({ name: "serviceAccountDelegationInfo" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "serviceAccountKeyName" })
