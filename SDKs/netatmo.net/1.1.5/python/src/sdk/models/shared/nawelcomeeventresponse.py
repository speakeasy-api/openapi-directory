...
import dataclasses
from ..shared import nawelcomeeventdata as shared_nawelcomeeventdata
...
class NAWelcomeEventResponse:
    r"""Successful response"""
    
    body: Optional[shared_nawelcomeeventdata.NAWelcomeEventData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
