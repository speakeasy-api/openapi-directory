...
var ConfigManagementOperatorState = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: configmanagementinstallerror_1.ConfigManagementInstallError }),
        (0, class_transformer_1.Expose)({ name: "errors" }),
        (0, class_transformer_1.Type)(function () { return configmanagementinstallerror_1.ConfigManagementInstallError; }),
