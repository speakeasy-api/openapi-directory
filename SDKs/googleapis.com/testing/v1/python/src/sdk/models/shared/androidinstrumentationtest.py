...
class AndroidInstrumentationTest:
    ...
    orchestrator_option: Optional[AndroidInstrumentationTestOrchestratorOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('orchestratorOption') }})
    sharding_option: Optional[shared_shardingoption.ShardingOption] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('shardingOption') }})
    test_apk: Optional[shared_filereference.FileReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('testApk') }})
