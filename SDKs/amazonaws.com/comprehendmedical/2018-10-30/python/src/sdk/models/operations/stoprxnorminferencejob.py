...
class StopRxNormInferenceJobRequest:
    ...
    stop_rx_norm_inference_job_request: shared_stoprxnorminferencejobrequest.StopRxNormInferenceJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
