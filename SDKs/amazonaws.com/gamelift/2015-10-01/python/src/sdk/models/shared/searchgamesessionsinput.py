...
class SearchGameSessionsInput:
    ...
    sort_expression: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortExpression'), 'exclude': lambda f: f is None }})  
