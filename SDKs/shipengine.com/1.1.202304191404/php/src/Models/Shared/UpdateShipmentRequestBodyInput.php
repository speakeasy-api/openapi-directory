...
class UpdateShipmentRequestBodyInput
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyDeliveryConfirmationEnum $confirmation
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyDeliveryConfirmationEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateShipmentRequestBodyDeliveryConfirmationEnum $confirmation = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyInternationalShipmentOptionsInput $customs
     */
	#[\JMS\Serializer\Annotation\SerializedName('customs')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyInternationalShipmentOptionsInput')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateShipmentRequestBodyInternationalShipmentOptionsInput $customs = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyInsuranceProviderEnum $insuranceProvider
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_provider')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyInsuranceProviderEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateShipmentRequestBodyInsuranceProviderEnum $insuranceProvider = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyOriginTypeEnum $originType
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyOriginTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateShipmentRequestBodyOriginTypeEnum $originType = null;
     ...
     * 
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\PackageInput> $packages
     */
	#[\JMS\Serializer\Annotation\SerializedName('packages')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\PackageInput>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UpdateShipmentRequestBodyValidateAddressEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UpdateShipmentRequestBodyValidateAddressEnum $validateAddress = null;
