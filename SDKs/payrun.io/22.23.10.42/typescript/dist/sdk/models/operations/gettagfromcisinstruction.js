...
exports.GetTagFromCisInstructionResponse = exports.GetTagFromCisInstructionRequest = void 0;
...
var GetTagFromCisInstructionRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromCisInstructionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisInstructionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisInstructionId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisInstructionRequest.prototype, "cisInstructionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisInstructionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisInstructionRequest.prototype, "subContractorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisInstructionRequest.prototype, "tagId", void 0);
    return GetTagFromCisInstructionRequest;
}(utils_1.SpeakeasyBase));
exports.GetTagFromCisInstructionRequest = GetTagFromCisInstructionRequest;
var GetTagFromCisInstructionResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromCisInstructionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.GetTagFromCisInstructionResponse = GetTagFromCisInstructionResponse;
