...
exports.GetNextPayPeriodDatesReportOutputResponse = exports.GetNextPayPeriodDatesReportOutputRequest = void 0;
...
var GetNextPayPeriodDatesReportOutputRequest = /** @class */ (function (_super) {
    ...
    ], GetNextPayPeriodDatesReportOutputRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetNextPayPeriodDatesReportOutputRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployerKey",
        }),
        __metadata("design:type", String)
    ], GetNextPayPeriodDatesReportOutputRequest.prototype, "employerKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PayScheduleKey",
        }),
        __metadata("design:type", String)
    ], GetNextPayPeriodDatesReportOutputRequest.prototype, "payScheduleKey", void 0);
...
var GetNextPayPeriodDatesReportOutputResponse = /** @class */ (function (_super) {
    ...
    ], GetNextPayPeriodDatesReportOutputResponse.prototype, "rawResponse", void 0);
