...
public class DetachTypedLinkRequestBodyTypedLinkSpecifier {
    ...
    public DetachTypedLinkRequestBodyTypedLinkSpecifier withIdentityAttributeValues(openapisdk.models.shared.AttributeNameAndValue[] identityAttributeValues) {
    ...
    public DetachTypedLinkRequestBodyTypedLinkSpecifier withSourceObjectReference(openapisdk.models.shared.ObjectReference sourceObjectReference) {
    ...
    public DetachTypedLinkRequestBodyTypedLinkSpecifier withTargetObjectReference(openapisdk.models.shared.ObjectReference targetObjectReference) {
    ...
    public DetachTypedLinkRequestBodyTypedLinkSpecifier withTypedLinkFacet(openapisdk.models.shared.TypedLinkSchemaAndFacetName typedLinkFacet) {
