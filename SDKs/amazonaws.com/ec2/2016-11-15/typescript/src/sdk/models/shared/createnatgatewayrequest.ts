 ...
 */
export enum CreateNatGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateNatGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateNatGatewayRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateNatGatewayRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateNatGatewayRequestTagSpecificationsTags })
  tags?: CreateNatGatewayRequestTagSpecificationsTags[];
}

export class CreateNatGatewayRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  allocationId?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateNatGatewayRequestTagSpecifications })
