...
func (e *POSTModifyReservedInstancesActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "ModifyReservedInstances":
		*e = POSTModifyReservedInstancesActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTModifyReservedInstancesActionEnum: %s", s)
	}
}
...
func (e *POSTModifyReservedInstancesVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2016-11-15":
		*e = POSTModifyReservedInstancesVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTModifyReservedInstancesVersionEnum: %s", s)
	}
}
