...
class VerifyUserAttributeRequest:
    ...
    verify_user_attribute_request: shared_verifyuserattributerequest.VerifyUserAttributeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
