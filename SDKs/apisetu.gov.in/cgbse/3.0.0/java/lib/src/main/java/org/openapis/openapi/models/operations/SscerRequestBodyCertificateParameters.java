...
public class SscerRequestBodyCertificateParameters {
    ...
    public SscerRequestBodyCertificateParameters withExamtype(String examtype) {
    ...
    public SscerRequestBodyCertificateParameters(@JsonProperty("FullName") String fullName, @JsonProperty("examtype") String examtype, @JsonProperty("rollno") String rollno, @JsonProperty("year") String year) {
        this.fullName = fullName;
        this.examtype = examtype;
        this.rollno = rollno;
        this.year = year;
