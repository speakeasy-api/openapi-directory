...
from ..shared import motorcyclesearchresponse as shared_motorcyclesearchresponse
...
class GetSearchMotorcycleActiveRequest:
    query_params: GetSearchMotorcycleActiveQueryParams = dataclasses.field()
...
class GetSearchMotorcycleActiveResponse:
    ...
    motorcycle_search_response: Optional[shared_motorcyclesearchresponse.MotorcycleSearchResponse] = dataclasses.field(default=None)
