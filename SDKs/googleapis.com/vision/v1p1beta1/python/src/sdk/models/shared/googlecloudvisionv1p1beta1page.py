...
class GoogleCloudVisionV1p1beta1Page:
    ...
    blocks: Optional[list[shared_googlecloudvisionv1p1beta1block.GoogleCloudVisionV1p1beta1Block]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('blocks'), 'exclude': lambda f: f is None }})
