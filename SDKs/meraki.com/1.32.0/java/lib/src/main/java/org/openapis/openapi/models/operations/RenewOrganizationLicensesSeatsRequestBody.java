...
public class RenewOrganizationLicensesSeatsRequestBody {
    ...
    public RenewOrganizationLicensesSeatsRequestBody(@JsonProperty("licenseIdToRenew") String licenseIdToRenew, @JsonProperty("unusedLicenseId") String unusedLicenseId) {
        this.licenseIdToRenew = licenseIdToRenew;
        this.unusedLicenseId = unusedLicenseId;
  }
}
