...
class DeleteSecurityConfigurationRequest:
    ...
    delete_security_configuration_request: shared_deletesecurityconfigurationrequest.DeleteSecurityConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
