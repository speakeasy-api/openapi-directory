...
public class AndroidpublisherEditsInsertRequest {
    ...
    public AndroidpublisherEditsInsertRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public AndroidpublisherEditsInsertRequest withAccessToken(String accessToken) {
    ...
    public AndroidpublisherEditsInsertRequest withCallback(String callback) {
    ...
    public AndroidpublisherEditsInsertRequest withUploadType(String uploadType) {
    ...
    public AndroidpublisherEditsInsertRequest withUploadProtocol(String uploadProtocol) {
