...
export class DatamigrationProjectsLocationsConnectionProfilesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatamigrationProjectsLocationsConnectionProfilesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatamigrationProjectsLocationsConnectionProfilesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
