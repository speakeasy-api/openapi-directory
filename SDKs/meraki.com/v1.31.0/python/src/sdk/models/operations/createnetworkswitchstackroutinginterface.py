...
class CreateNetworkSwitchStackRoutingInterfaceRequestBody:
    ...
    vlan_id: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vlanId') }})
    ...
    ipv6: Optional[CreateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ipv6'), 'exclude': lambda f: f is None }})
    r"""The IPv6 settings of the interface."""  
    multicast_routing: Optional[CreateNetworkSwitchStackRoutingInterfaceRequestBodyMulticastRoutingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('multicastRouting'), 'exclude': lambda f: f is None }})
    r"""Enable multicast support if, multicast routing between VLANs is required. Options are, 'disabled', 'enabled' or 'IGMP snooping querier'. Default is 'disabled'."""  
    ospf_settings: Optional[CreateNetworkSwitchStackRoutingInterfaceRequestBodyOspfSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ospfSettings'), 'exclude': lambda f: f is None }})
    r"""The OSPF routing settings of the interface."""  
...
class CreateNetworkSwitchStackRoutingInterfaceRequest:
    ...
    request_body: CreateNetworkSwitchStackRoutingInterfaceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
