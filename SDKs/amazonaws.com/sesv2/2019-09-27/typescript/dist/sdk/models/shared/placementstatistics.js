...
exports.PlacementStatistics = void 0;
...
var PlacementStatistics = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DkimPercentage" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MissingPercentage" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SpfPercentage" }),
        __metadata("design:type", Number)
