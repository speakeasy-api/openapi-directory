...
class AssociateApprovalRuleTemplateWithRepositoryRequest:
    ...
    associate_approval_rule_template_with_repository_input: shared_associateapprovalruletemplatewithrepositoryinput.AssociateApprovalRuleTemplateWithRepositoryInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class AssociateApprovalRuleTemplateWithRepositoryResponse:
    ...
    r"""MaximumRuleTemplatesAssociatedWithRepositoryException"""  
