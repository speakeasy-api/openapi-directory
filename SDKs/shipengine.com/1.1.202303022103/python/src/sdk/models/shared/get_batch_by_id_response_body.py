...
class GetBatchByIDResponseBodyLabelFormatEnum(str, Enum):
...
class GetBatchByIDResponseBodyLabelLayoutEnum(str, Enum):
...
class GetBatchByIDResponseBodyBatchStatusEnum(str, Enum):
...
class GetBatchByIDResponseBody:
    ...
    batch_errors_url: GetBatchByIDResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('batch_errors_url') }})
    ...
    form_download: GetBatchByIDResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('form_download') }})
    ...
    label_download: GetBatchByIDResponseBodyLabelDownload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_download') }})
    r"""The label download for the batch"""  
    label_format: GetBatchByIDResponseBodyLabelFormatEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_format') }})  
    label_layout: GetBatchByIDResponseBodyLabelLayoutEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_layout') }})
    r"""label layout"""  
    ...
    status: GetBatchByIDResponseBodyBatchStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
