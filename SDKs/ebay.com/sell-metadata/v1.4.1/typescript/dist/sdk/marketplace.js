...
var Marketplace = /** @class */ (function () {
    ...
    **/
    Marketplace.prototype.getAutomotivePartsCompatibilityPolicies = function (req, config) {
    ...
    **/
    Marketplace.prototype.getItemConditionPolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Marketplace.prototype.getListingStructurePolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Marketplace.prototype.getNegotiatedPricePolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Marketplace.prototype.getProductAdoptionPolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Marketplace.prototype.getReturnPolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
