...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.liens = new liens_1.Liens(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
