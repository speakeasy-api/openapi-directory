...
exports.IpamServicesListResponse = exports.IpamServicesList200ApplicationJSON = exports.IpamServicesListRequest = void 0;
...
var IpamServicesListRequest = /** @class */ (function (_super) {
    ...
    ], IpamServicesListRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=device_id",
        }),
        __metadata("design:type", String)
    ], IpamServicesListRequest.prototype, "deviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], IpamServicesListRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], IpamServicesListRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], IpamServicesListRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=port" }),
        __metadata("design:type", Number)
    ], IpamServicesListRequest.prototype, "port", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=protocol",
        }),
        __metadata("design:type", String)
    ], IpamServicesListRequest.prototype, "protocol", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q" }),
        __metadata("design:type", String)
    ], IpamServicesListRequest.prototype, "q", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tag" }),
        __metadata("design:type", String)
    ], IpamServicesListRequest.prototype, "tag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=virtual_machine",
        }),
        __metadata("design:type", String)
    ], IpamServicesListRequest.prototype, "virtualMachine", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=virtual_machine_id",
        }),
        __metadata("design:type", String)
    ], IpamServicesListRequest.prototype, "virtualMachineId", void 0);
...
var IpamServicesList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.Service; }),
...
var IpamServicesListResponse = /** @class */ (function (_super) {
    ...
    ], IpamServicesListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
