...
class FindingTypeEnum(str, Enum):
    r"""The type of finding. For details about each type, see <a href=\\"https://docs.aws.amazon.com/macie/latest/user/findings-types.html\\">Types of Amazon Macie findings</a> in the <i>Amazon Macie User Guide</i>. Possible values are:"""
