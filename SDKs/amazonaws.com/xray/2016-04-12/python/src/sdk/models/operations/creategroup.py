...
class CreateGroupRequestBody:
    ...
    r"""The case-sensitive name of the new group. Default is a reserved name and names must be unique."""  
    ...
    r"""The filter expression defining criteria by which to group traces."""  
    insights_configuration: Optional[CreateGroupRequestBodyInsightsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InsightsConfiguration'), 'exclude': lambda f: f is None }})
    r"""The structure containing configurations related to insights."""  
