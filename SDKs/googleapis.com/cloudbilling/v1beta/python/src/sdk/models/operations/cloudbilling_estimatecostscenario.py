...
class CloudbillingEstimateCostScenarioRequest:
    ...
    r"""JSONP"""  
    estimate_cost_scenario_with_list_price_request: Optional[shared_estimatecostscenariowithlistpricerequest.EstimateCostScenarioWithListPriceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
