...
class ProductCreateRequest:
    ...
    create_with_default_tax: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('createWithDefaultTax'), 'exclude': lambda f: f is None }})  
