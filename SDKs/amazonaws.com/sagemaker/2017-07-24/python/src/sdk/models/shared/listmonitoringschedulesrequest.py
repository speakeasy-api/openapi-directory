...
from ..shared import monitoringschedulesortkey_enum as shared_monitoringschedulesortkey_enum
...
class ListMonitoringSchedulesRequest:
    ...
    monitoring_type_equals: Optional[shared_monitoringtype_enum.MonitoringTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MonitoringTypeEquals'), 'exclude': lambda f: f is None }})  
    ...
    sort_by: Optional[shared_monitoringschedulesortkey_enum.MonitoringScheduleSortKeyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    ...
    status_equals: Optional[shared_schedulestatus_enum.ScheduleStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
