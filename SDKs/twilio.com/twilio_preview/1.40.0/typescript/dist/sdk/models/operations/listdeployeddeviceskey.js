...
exports.ListDeployedDevicesKeyResponse = exports.ListDeployedDevicesKeyListDeployedDevicesKeyResponse = exports.ListDeployedDevicesKeyListDeployedDevicesKeyResponseMeta = exports.ListDeployedDevicesKeyRequest = exports.ListDeployedDevicesKeySecurity = exports.ListDeployedDevicesKeyServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListDeployedDevicesKeyServerList = [
...
var ListDeployedDevicesKeySecurity = /** @class */ (function (_super) {
    ...
    ], ListDeployedDevicesKeySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListDeployedDevicesKeySecurity.prototype, "username", void 0);
    return ListDeployedDevicesKeySecurity;
}(utils_1.SpeakeasyBase));
exports.ListDeployedDevicesKeySecurity = ListDeployedDevicesKeySecurity;
var ListDeployedDevicesKeyRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListDeployedDevicesKeyRequest.prototype, "deviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FleetSid",
        }),
        __metadata("design:type", String)
    ], ListDeployedDevicesKeyRequest.prototype, "fleetSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListDeployedDevicesKeyRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListDeployedDevicesKeyRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListDeployedDevicesKeyRequest.prototype, "pageToken", void 0);
    return ListDeployedDevicesKeyRequest;
}(utils_1.SpeakeasyBase));
exports.ListDeployedDevicesKeyRequest = ListDeployedDevicesKeyRequest;
...
exports.ListDeployedDevicesKeyListDeployedDevicesKeyResponseMeta = ListDeployedDevicesKeyListDeployedDevicesKeyResponseMeta;
/**
 * OK
 */
var ListDeployedDevicesKeyListDeployedDevicesKeyResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewDeployedDevicesFleetKey }),
        (0, class_transformer_1.Expose)({ name: "keys" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewDeployedDevicesFleetKey; }),
        __metadata("design:type", Array)
    ], ListDeployedDevicesKeyListDeployedDevicesKeyResponse.prototype, "keys", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListDeployedDevicesKeyListDeployedDevicesKeyResponseMeta; }),
...
exports.ListDeployedDevicesKeyListDeployedDevicesKeyResponse = ListDeployedDevicesKeyListDeployedDevicesKeyResponse;
var ListDeployedDevicesKeyResponse = /** @class */ (function (_super) {
    ...
    ], ListDeployedDevicesKeyResponse.prototype, "rawResponse", void 0);
    return ListDeployedDevicesKeyResponse;
}(utils_1.SpeakeasyBase));
exports.ListDeployedDevicesKeyResponse = ListDeployedDevicesKeyResponse;
