...
func (e UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum) ToPointer() *UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum {
	return &e
}

func (e *UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "CONVERT_TO_TEXT":
		*e = UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum: %v", v)
	}
}
