...
class TflAPIPresentationEntitiesStatusSeverity:
    ...
    severity_level: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('severityLevel'), 'exclude': lambda f: f is None }})  
