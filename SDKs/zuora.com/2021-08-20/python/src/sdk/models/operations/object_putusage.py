...
from ..shared import proxymodifyusage as shared_proxymodifyusage
...
class ObjectPUTUsageRequest:
    ...
    r"""Object id"""  
    proxy_modify_usage: shared_proxymodifyusage.ProxyModifyUsage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
