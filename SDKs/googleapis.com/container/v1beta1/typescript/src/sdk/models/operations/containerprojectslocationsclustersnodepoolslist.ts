...
export class ContainerProjectsLocationsClustersNodePoolsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsClustersNodePoolsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsClustersNodePoolsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
