...
class ListPolicyAttachmentsRequestBody:
    ...
    policy_reference: ListPolicyAttachmentsRequestBodyPolicyReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PolicyReference') }})
    r"""The reference that identifies an object."""  
...
class ListPolicyAttachmentsRequest:
    ...
    request_body: ListPolicyAttachmentsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
