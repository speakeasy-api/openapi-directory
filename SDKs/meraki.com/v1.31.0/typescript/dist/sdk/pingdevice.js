...
exports.PingDevice = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var PingDevice = /** @class */ (function () {
    function PingDevice(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Enqueue a job to check connectivity status to the device
     */
    PingDevice.prototype.createDeviceLiveToolsPingDevice = function (req, config) {
        var _a;
     ...
     */
    PingDevice.prototype.getDeviceLiveToolsPingDevice = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
