...
public class ListSettingsUpdateQueryParams {
    ...
    public Long page;
    public ListSettingsUpdateQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListSettingsUpdateQueryParams withPageToken(String pageToken) {
    ...
    public ListSettingsUpdateQueryParams withStatus(org.openapis.openapi.models.shared.SettingsUpdateEnumStatusEnum status) {
        this.status = status;
        return this;
    }
