...
class GoogleTypeDateTime:
    ...
    time_zone: Optional[shared_googletypetimezone.GoogleTypeTimeZone] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('timeZone') }})
    utc_offset: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('utcOffset') }})
