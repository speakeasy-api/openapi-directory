...
func main() {
    ...
    res, err := s.Search.SearchAccount(ctx, operations.SearchAccountRequest{
        Page: sdk.Int(919783),
        Pagelen: sdk.Int(116098),
        SearchQuery: "accusantium",
        SelectedUser: "beatae",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Search.SearchTeam(ctx, operations.SearchTeamRequest{
        Page: sdk.Int(174772),
        Pagelen: sdk.Int(316488),
        SearchQuery: "laboriosam",
        Username: "Delbert.Wilderman",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Search.SearchWorkspace(ctx, operations.SearchWorkspaceRequest{
        Page: sdk.Int(906355),
        Pagelen: sdk.Int(160467),
        SearchQuery: "occaecati",
        Workspace: "officiis",
    })
    if err != nil {
        log.Fatal(err)
