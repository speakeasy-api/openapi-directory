...
class ListSyncServiceListSyncServiceResponse:
    ...
    meta: Optional[ListSyncServiceListSyncServiceResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    services: Optional[list[shared_preview_sync_service.PreviewSyncService]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
