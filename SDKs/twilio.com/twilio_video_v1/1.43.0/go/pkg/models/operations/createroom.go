...
func (e CreateRoomCreateRoomRequestStatusCallbackMethodEnum) ToPointer() *CreateRoomCreateRoomRequestStatusCallbackMethodEnum {
	return &e
}
...
func (e *CreateRoomCreateRoomRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateRoomCreateRoomRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateRoomCreateRoomRequestStatusCallbackMethodEnum: %v", v)
	}
}
