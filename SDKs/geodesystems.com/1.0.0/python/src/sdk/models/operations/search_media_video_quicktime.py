...
class SearchMediaVideoQuicktimeQueryParams:
...
@dataclasses.dataclass
class SearchMediaVideoQuicktimeRequest:
    query_params: SearchMediaVideoQuicktimeQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchMediaVideoQuicktimeResponse:
