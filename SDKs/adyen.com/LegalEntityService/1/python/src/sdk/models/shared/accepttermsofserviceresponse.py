...
class AcceptTermsOfServiceResponseTypeEnum(str, Enum):
...
class AcceptTermsOfServiceResponse:
    ...
    r"""The unique identifier of the Terms of Service acceptance."""  
    ...
    r"""The IP address of the user that accepted the Terms of Service."""  
    ...
    type: Optional[AcceptTermsOfServiceResponseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of Terms of Service."""  
