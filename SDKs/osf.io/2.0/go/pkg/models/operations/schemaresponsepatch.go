...
func (e SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum) ToPointer() *SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum {
	return &e
}
...
func (e *SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "pending_moderation":
		*e = SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SchemaResponsePatchSchemaResponsesAttributesReviewsStateEnum: %v", v)
	}
}
