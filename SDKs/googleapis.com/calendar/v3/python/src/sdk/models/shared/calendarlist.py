...
class CalendarList:
    ...
    items: Optional[list[shared_calendarlistentry.CalendarListEntry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
