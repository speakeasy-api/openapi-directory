...
class YoutubeCommentsInsertQueryParams:
...
@dataclasses.dataclass
class YoutubeCommentsInsertRequest:
    query_params: YoutubeCommentsInsertQueryParams = dataclasses.field()
    security: YoutubeCommentsInsertSecurity = dataclasses.field()
