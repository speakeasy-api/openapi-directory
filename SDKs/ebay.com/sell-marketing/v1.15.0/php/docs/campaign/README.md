...
use \OpenAPI\OpenAPI\Models\Operations\CloneCampaignRequest;
use \OpenAPI\OpenAPI\Models\Shared\CloneCampaignRequest;
use \OpenAPI\OpenAPI\Models\Shared\FundingStrategy;
use \OpenAPI\OpenAPI\Models\Shared\DynamicAdRatePreference;
use \OpenAPI\OpenAPI\Models\Operations\CloneCampaignSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CloneCampaignRequest();
    $request->cloneCampaignRequest = new CloneCampaignRequest();
    $request->cloneCampaignRequest->campaignName = 'commodi';
    $request->cloneCampaignRequest->endDate = 'quam';
    $request->cloneCampaignRequest->fundingStrategy = new FundingStrategy();
    $request->cloneCampaignRequest->fundingStrategy->adRateStrategy = 'molestiae';
    $request->cloneCampaignRequest->fundingStrategy->bidPercentage = 'velit';
    $request->cloneCampaignRequest->fundingStrategy->dynamicAdRatePreferences = [
        new DynamicAdRatePreference(),
        new DynamicAdRatePreference(),
        new DynamicAdRatePreference(),
    ];
    $request->cloneCampaignRequest->fundingStrategy->fundingModel = 'quia';
    $request->cloneCampaignRequest->startDate = 'quis';
    $request->campaignId = 'vitae';

    $requestSecurity = new CloneCampaignSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->cloneCampaign($request, $requestSecurity);

    if ($response->cloneCampaign201ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\CampaignBudgetRequest;
use \OpenAPI\OpenAPI\Models\Shared\BudgetRequest;
use \OpenAPI\OpenAPI\Models\Shared\Amount;
use \OpenAPI\OpenAPI\Models\Shared\CampaignCriterion;
use \OpenAPI\OpenAPI\Models\Shared\SelectionRule;
use \OpenAPI\OpenAPI\Models\Shared\FundingStrategy;
use \OpenAPI\OpenAPI\Models\Shared\DynamicAdRatePreference;
use \OpenAPI\OpenAPI\Models\Operations\CreateCampaignSecurity;
...
try {
    ...
    $request->budget = new CampaignBudgetRequest();
    $request->budget->daily = new BudgetRequest();
    $request->budget->daily->amount = new Amount();
    $request->budget->daily->amount->currency = 'laborum';
    $request->budget->daily->amount->value = 'animi';
    $request->campaignCriterion = new CampaignCriterion();
    $request->campaignCriterion->autoSelectFutureInventory = false;
    $request->campaignCriterion->criterionType = 'enim';
    $request->campaignCriterion->selectionRules = [
        new SelectionRule(),
    ];
    $request->campaignName = 'quo';
    $request->endDate = 'sequi';
    $request->fundingStrategy = new FundingStrategy();
    $request->fundingStrategy->adRateStrategy = 'tenetur';
    $request->fundingStrategy->bidPercentage = 'ipsam';
    $request->fundingStrategy->dynamicAdRatePreferences = [
        new DynamicAdRatePreference(),
        new DynamicAdRatePreference(),
        new DynamicAdRatePreference(),
    ];
    $request->fundingStrategy->fundingModel = 'possimus';
    $request->marketplaceId = 'aut';
    $request->startDate = 'quasi';

    $requestSecurity = new CreateCampaignSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->createCampaign($request, $requestSecurity);

    if ($response->createCampaign201ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Operations\DeleteCampaignSecurity;
...
try {
    ...
    $requestSecurity = new DeleteCampaignSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->deleteCampaign($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\EndCampaignRequest;
use \OpenAPI\OpenAPI\Models\Operations\EndCampaignSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new EndCampaignRequest();
    $request->campaignId = 'temporibus';

    $requestSecurity = new EndCampaignSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->endCampaign($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceRequest;
use \OpenAPI\OpenAPI\Models\Operations\FindCampaignByAdReferenceSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FindCampaignByAdReferenceRequest();
    $request->inventoryReferenceId = 'laborum';
    $request->inventoryReferenceType = 'quasi';
    $request->listingId = 'reiciendis';

    $requestSecurity = new FindCampaignByAdReferenceSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->findCampaignByAdReference($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\Models\Operations\GetCampaignSecurity;
...
try {
    ...
    $request->campaignId = 'voluptatibus';

    $requestSecurity = new GetCampaignSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->getCampaign($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetCampaignByNameSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetCampaignByNameRequest();
    $request->campaignName = 'vero';

    $requestSecurity = new GetCampaignByNameSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->getCampaignByName($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\Models\Operations\GetCampaignsSecurity;
...
try {
    ...
    $request->campaignName = 'nihil';
    $request->campaignStatus = 'praesentium';
    $request->endDateRange = 'voluptatibus';
    $request->fundingStrategy = 'ipsa';
    $request->limit = 'omnis';
    $request->offset = 'voluptate';
    $request->startDateRange = 'cum';

    $requestSecurity = new GetCampaignsSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->getCampaigns($request, $requestSecurity);

    if ($response->campaignPagedCollectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Operations\PauseCampaignSecurity;
...
try {
    ...
    $request->campaignId = 'perferendis';

    $requestSecurity = new PauseCampaignSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->pauseCampaign($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\Models\Operations\ResumeCampaignSecurity;
...
try {
    ...
    $requestSecurity = new ResumeCampaignSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->resumeCampaign($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\SuggestItemsRequest;
use \OpenAPI\OpenAPI\Models\Operations\SuggestItemsSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new SuggestItemsRequest();
    $request->campaignId = 'reprehenderit';
    $request->categoryIds = 'ut';
    $request->limit = 'maiores';
    $request->offset = 'dicta';

    $requestSecurity = new SuggestItemsSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->suggestItems($request, $requestSecurity);

    if ($response->targetedAdsPagedCollection !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategyRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdateAdrateStrategyRequest;
use \OpenAPI\OpenAPI\Models\Shared\DynamicAdRatePreference;
use \OpenAPI\OpenAPI\Models\Operations\UpdateAdRateStrategySecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateAdRateStrategyRequest();
    $request->updateAdrateStrategyRequest = new UpdateAdrateStrategyRequest();
    $request->updateAdrateStrategyRequest->adRateStrategy = 'corporis';
    $request->updateAdrateStrategyRequest->bidPercentage = 'dolore';
    $request->updateAdrateStrategyRequest->dynamicAdRatePreferences = [
        new DynamicAdRatePreference(),
        new DynamicAdRatePreference(),
    ];
    $request->campaignId = 'dicta';

    $requestSecurity = new UpdateAdRateStrategySecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->updateAdRateStrategy($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdateCampaignBudgetRequest;
use \OpenAPI\OpenAPI\Models\Shared\BudgetRequest;
use \OpenAPI\OpenAPI\Models\Shared\Amount;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignBudgetSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateCampaignBudgetRequest();
    $request->updateCampaignBudgetRequest = new UpdateCampaignBudgetRequest();
    $request->updateCampaignBudgetRequest->daily = new BudgetRequest();
    $request->updateCampaignBudgetRequest->daily->amount = new Amount();
    $request->updateCampaignBudgetRequest->daily->amount->currency = 'harum';
    $request->updateCampaignBudgetRequest->daily->amount->value = 'enim';
    $request->campaignId = 'accusamus';

    $requestSecurity = new UpdateCampaignBudgetSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->updateCampaignBudget($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdateCampaignIdentificationRequest;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCampaignIdentificationSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateCampaignIdentificationRequest();
    $request->updateCampaignIdentificationRequest = new UpdateCampaignIdentificationRequest();
    $request->updateCampaignIdentificationRequest->campaignName = 'commodi';
    $request->updateCampaignIdentificationRequest->endDate = 'repudiandae';
    $request->updateCampaignIdentificationRequest->startDate = 'quae';
    $request->campaignId = 'ipsum';

    $requestSecurity = new UpdateCampaignIdentificationSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->campaign->updateCampaignIdentification($request, $requestSecurity);
