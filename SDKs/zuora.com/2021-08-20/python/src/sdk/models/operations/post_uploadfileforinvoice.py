...
class POSTUploadFileForInvoiceRequestBody:
    ...
    r"""The PDF file to upload for the invoice."""  
...
class POSTUploadFileForInvoiceRequest:
    ...
    r"""The ID of the invoice that you want to upload a PDF file for. For example, 2c92c8955bd63cc1015bd7c151af02ab."""  
    request_body: Optional[POSTUploadFileForInvoiceRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})  
