...
public class DeleteVirtualGatewayRequest {
    ...
    public DeleteVirtualGatewayRequest withXAmzAlgorithm(String xAmzAlgorithm) {
    ...
    public DeleteVirtualGatewayRequest withXAmzContentSha256(String xAmzContentSha256) {
    ...
    public DeleteVirtualGatewayRequest withXAmzCredential(String xAmzCredential) {
    ...
    public DeleteVirtualGatewayRequest withXAmzDate(String xAmzDate) {
    ...
    public DeleteVirtualGatewayRequest withXAmzSecurityToken(String xAmzSecurityToken) {
    ...
    public DeleteVirtualGatewayRequest withXAmzSignature(String xAmzSignature) {
    ...
    public DeleteVirtualGatewayRequest withXAmzSignedHeaders(String xAmzSignedHeaders) {
    ...
    public DeleteVirtualGatewayRequest(@JsonProperty("meshName") String meshName, @JsonProperty("virtualGatewayName") String virtualGatewayName) {
        this.meshName = meshName;
        this.virtualGatewayName = virtualGatewayName;
  }
}
