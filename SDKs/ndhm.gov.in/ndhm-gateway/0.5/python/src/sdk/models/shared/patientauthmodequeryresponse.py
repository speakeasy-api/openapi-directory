...
class PatientAuthModeQueryResponseAuth:
    ...
    modes: list[shared_authenticationmode_enum.AuthenticationModeEnum] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modes') }})  
...
class PatientAuthModeQueryResponse:
    ...
    auth: Optional[PatientAuthModeQueryResponseAuth] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth'), 'exclude': lambda f: f is None }})  
