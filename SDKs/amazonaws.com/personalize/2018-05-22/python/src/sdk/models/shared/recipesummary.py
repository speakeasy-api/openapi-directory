...
class RecipeSummary:
    r"""Provides a summary of the properties of a recipe. For a complete listing, call the <a href=\\"https://docs.aws.amazon.com/personalize/latest/dg/API_DescribeRecipe.html\\">DescribeRecipe</a> API."""
