...
from ..shared import getapiresourcecoverageresponse as shared_getapiresourcecoverageresponse
...
class APIResourceCoverageOneResponse:
    ...
    get_api_resource_coverage_response: Optional[shared_getapiresourcecoverageresponse.GetAPIResourceCoverageResponse] = dataclasses.field(default=None)
    r"""ApiResources"""  
