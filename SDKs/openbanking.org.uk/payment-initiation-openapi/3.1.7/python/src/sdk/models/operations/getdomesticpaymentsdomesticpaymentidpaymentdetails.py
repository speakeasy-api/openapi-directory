...
class GetDomesticPaymentsDomesticPaymentIDPaymentDetailsPathParams:
    domestic_payment_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'DomesticPaymentId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDomesticPaymentsDomesticPaymentIDPaymentDetailsHeaders:
...
@dataclasses.dataclass
class GetDomesticPaymentsDomesticPaymentIDPaymentDetailsSecurity:
    tppo_auth2_security: shared_security.SchemeTppoAuth2Security = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class GetDomesticPaymentsDomesticPaymentIDPaymentDetailsRequest:
    headers: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsHeaders = dataclasses.field()
    path_params: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsPathParams = dataclasses.field()
    security: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetDomesticPaymentsDomesticPaymentIDPaymentDetailsResponse:
