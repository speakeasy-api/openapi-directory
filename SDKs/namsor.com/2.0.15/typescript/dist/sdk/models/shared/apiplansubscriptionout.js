...
var ApiPlanSubscriptionOut = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=currencyFactor" }),
        __metadata("design:type", Number)
    ], ApiPlanSubscriptionOut.prototype, "currencyFactor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=planBaseFeesKey" }),
        __metadata("design:type", String)
    ], ApiPlanSubscriptionOut.prototype, "planBaseFeesKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=planEnded" }),
        __metadata("design:type", Number)
    ], ApiPlanSubscriptionOut.prototype, "planEnded", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=planName" }),
        __metadata("design:type", String)
    ], ApiPlanSubscriptionOut.prototype, "planName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=planQuota" }),
        __metadata("design:type", Number)
    ], ApiPlanSubscriptionOut.prototype, "planQuota", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=planStarted" }),
        __metadata("design:type", Number)
    ], ApiPlanSubscriptionOut.prototype, "planStarted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=planStatus" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=priceOverage" }),
        __metadata("design:type", Number)
    ], ApiPlanSubscriptionOut.prototype, "priceOverage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=priceOverageUSD" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=priorPlanStarted" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=stripeStatus" }),
        __metadata("design:type", String)
    ], ApiPlanSubscriptionOut.prototype, "stripeStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=stripeSubscription" }),
        __metadata("design:type", String)
