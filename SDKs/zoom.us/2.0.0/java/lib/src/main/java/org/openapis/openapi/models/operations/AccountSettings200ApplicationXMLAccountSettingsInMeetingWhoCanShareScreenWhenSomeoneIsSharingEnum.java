 ...
 * 
 */
public enum AccountSettings200ApplicationXMLAccountSettingsInMeetingWhoCanShareScreenWhenSomeoneIsSharingEnum {
    HOST("host"),
    ALL("all");
    ...
    private AccountSettings200ApplicationXMLAccountSettingsInMeetingWhoCanShareScreenWhenSomeoneIsSharingEnum(String value) {
        this.value = value;
    }
}
