...
export class AppsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum AppsListDollarOrderByEnum {
  DisplayName = "display_name",
  Name = "name",
}

export class AppsListRequest extends SpeakeasyBase {
  /**
   * The name of the attribute by which to order the response by. By default, apps are in order of creation. All results are ordered in ascending order.
   */
  @SpeakeasyMetadata({
...
export enum AppsListDefaultApplicationJSONErrorCodeEnum {
...
export class AppsListDefaultApplicationJSONError extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
 ...
 * Error
 */
export class AppsListDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => AppsListDefaultApplicationJSONError)
  error: AppsListDefaultApplicationJSONError;
}

export class AppsList200ApplicationJSONAzureSubscription extends SpeakeasyBase {
  /**
...
export enum AppsList200ApplicationJSONMemberPermissionsEnum {
  Manager = "manager",
  Developer = "developer",
  Viewer = "viewer",
  Tester = "tester",
 ...
 */
export enum AppsList200ApplicationJSONOriginEnum {
  Appcenter = "appcenter",
  Hockeyapp = "hockeyapp",
  Codepush = "codepush",
}
 ...
 */
export enum AppsList200ApplicationJSONOsEnum {
  Android = "Android",
  IOS = "iOS",
  MacOS = "macOS",
  Tizen = "Tizen",
 ...
 */
export enum AppsList200ApplicationJSONOwnerTypeEnum {
  Org = "org",
  User = "user",
}
 ...
 */
export class AppsList200ApplicationJSONOwner extends SpeakeasyBase {
  /**
 ...
 */
export enum AppsList200ApplicationJSONPlatformEnum {
  Java = "Java",
...
export class AppsList200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @Type(() => AppsList200ApplicationJSONAzureSubscription)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "owner" })
  @Type(() => AppsList200ApplicationJSONOwner)
...
export class AppsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   * Success
   */
  @SpeakeasyMetadata({ elemType: AppsList200ApplicationJSON })
