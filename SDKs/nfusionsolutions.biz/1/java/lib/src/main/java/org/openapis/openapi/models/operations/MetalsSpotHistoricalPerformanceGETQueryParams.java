...
public class MetalsSpotHistoricalPerformanceGETQueryParams {
    /**
    ...
    public MetalsSpotHistoricalPerformanceGETQueryParams withCurrency(String currency) {
    ...
    public MetalsSpotHistoricalPerformanceGETQueryParams withFormat(MetalsSpotHistoricalPerformanceGETFormatEnum format) {
        this.format = format;
        return this;
    }
    ...
    public MetalsSpotHistoricalPerformanceGETQueryParams withMetals(String metals) {
        this.metals = metals;
        return this;
    }
    ...
    public MetalsSpotHistoricalPerformanceGETQueryParams withUnitofmeasure(MetalsSpotHistoricalPerformanceGETUnitofmeasureEnum unitofmeasure) {
