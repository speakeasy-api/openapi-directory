...
public class GetOrganizationConfigTemplateSwitchProfilePortRequest {
    ...
    public GetOrganizationConfigTemplateSwitchProfilePortRequest(@JsonProperty("configTemplateId") String configTemplateId, @JsonProperty("organizationId") String organizationId, @JsonProperty("portId") String portId, @JsonProperty("profileId") String profileId) {
        this.configTemplateId = configTemplateId;
        this.organizationId = organizationId;
        this.portId = portId;
        this.profileId = profileId;
