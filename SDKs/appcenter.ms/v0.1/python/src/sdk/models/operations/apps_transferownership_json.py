...
class AppsTransferOwnershipJSONSecurity:
...
class AppsTransferOwnershipJSONDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
@dataclasses.dataclass
class AppsTransferOwnershipJSONDefaultApplicationJSONError:
    
    code: AppsTransferOwnershipJSONDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class AppsTransferOwnershipJSONDefaultApplicationJSON:
    ...
    error: AppsTransferOwnershipJSONDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
...
class AppsTransferOwnershipJSON200ApplicationJSONMemberPermissionsEnum(str, Enum):
    MANAGER = 'manager'
    DEVELOPER = 'developer'
    VIEWER = 'viewer'
    TESTER = 'tester'

class AppsTransferOwnershipJSON200ApplicationJSONOriginEnum(str, Enum):
    r"""The creation origin of this app"""
    APPCENTER = 'appcenter'
    HOCKEYAPP = 'hockeyapp'
    CODEPUSH = 'codepush'

class AppsTransferOwnershipJSON200ApplicationJSONOsEnum(str, Enum):
...
class AppsTransferOwnershipJSON200ApplicationJSONOwnerTypeEnum(str, Enum):
...
class AppsTransferOwnershipJSON200ApplicationJSONOwner:
    ...
    type: AppsTransferOwnershipJSON200ApplicationJSONOwnerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The owner type. Can either be 'org' or 'user'"""  
...
class AppsTransferOwnershipJSON200ApplicationJSONPlatformEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsTransferOwnershipJSON200ApplicationJSON:
    r"""Success"""
    ...
    origin: AppsTransferOwnershipJSON200ApplicationJSONOriginEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin') }})
    r"""The creation origin of this app"""  
    os: AppsTransferOwnershipJSON200ApplicationJSONOsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('os') }})
    r"""The OS the app will be running on"""  
    owner: AppsTransferOwnershipJSON200ApplicationJSONOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The information about the app's owner"""  
    platform: AppsTransferOwnershipJSON200ApplicationJSONPlatformEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform') }})
    r"""The platform of the app"""  
    azure_subscription: Optional[AppsTransferOwnershipJSON200ApplicationJSONAzureSubscription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('azure_subscription'), 'exclude': lambda f: f is None }})  
    ...
    member_permissions: Optional[list[AppsTransferOwnershipJSON200ApplicationJSONMemberPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('member_permissions'), 'exclude': lambda f: f is None }})
...
class AppsTransferOwnershipJSONResponse:
    ...
    apps_transfer_ownership_json_200_application_json_object: Optional[AppsTransferOwnershipJSON200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    apps_transfer_ownership_json_default_application_json_object: Optional[AppsTransferOwnershipJSONDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
