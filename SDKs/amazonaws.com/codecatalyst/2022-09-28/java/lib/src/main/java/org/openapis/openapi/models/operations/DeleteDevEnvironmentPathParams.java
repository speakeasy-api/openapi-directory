...
public class DeleteDevEnvironmentPathParams {
    /**
    ...
    public String id;
    public DeleteDevEnvironmentPathParams withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public DeleteDevEnvironmentPathParams withProjectName(String projectName) {
    ...
    public DeleteDevEnvironmentPathParams withSpaceName(String spaceName) {
