...
var UserAuth = /** @class */ (function () {
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthNotify = function (req, config) {
        var _a;
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthOnConfirm = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthOnFetchModes = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    UserAuth.prototype.postV05UsersAuthOnInit = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
