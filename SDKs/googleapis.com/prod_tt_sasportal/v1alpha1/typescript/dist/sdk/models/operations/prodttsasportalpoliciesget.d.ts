...
export declare class ProdTtSasportalPoliciesGetSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalPoliciesGetSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalPoliciesGetSecurity extends SpeakeasyBase {
    option1?: ProdTtSasportalPoliciesGetSecurityOption1;
    option2?: ProdTtSasportalPoliciesGetSecurityOption2;
}
