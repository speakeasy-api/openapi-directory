 ...
 */
export declare enum NotificationEndpointListWarningCodeEnum {
...
export declare class NotificationEndpointListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NotificationEndpointListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class NotificationEndpointList extends SpeakeasyBase {
    /**
