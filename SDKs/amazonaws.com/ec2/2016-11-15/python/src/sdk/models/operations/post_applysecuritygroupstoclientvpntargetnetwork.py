...
class PostApplySecurityGroupsToClientVpnTargetNetworkQueryParams:
    action: PostApplySecurityGroupsToClientVpnTargetNetworkActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostApplySecurityGroupsToClientVpnTargetNetworkVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostApplySecurityGroupsToClientVpnTargetNetworkRequest:
    headers: PostApplySecurityGroupsToClientVpnTargetNetworkHeaders = dataclasses.field()
    query_params: PostApplySecurityGroupsToClientVpnTargetNetworkQueryParams = dataclasses.field()
