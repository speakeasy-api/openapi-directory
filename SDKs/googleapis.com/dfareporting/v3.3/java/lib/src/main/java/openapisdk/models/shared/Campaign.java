...
public class Campaign {
    ...
    public Campaign withNielsenOcrEnabled(Boolean nielsenOcrEnabled) {
    ...
    public String[] traffickerEmails;
    public Campaign withTraffickerEmails(String[] traffickerEmails) {
