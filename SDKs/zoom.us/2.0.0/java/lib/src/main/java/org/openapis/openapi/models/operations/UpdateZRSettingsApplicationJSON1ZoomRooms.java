...
public class UpdateZRSettingsApplicationJSON1ZoomRooms {
    /**
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withAllowMultipleContentSharing(Boolean allowMultipleContentSharing) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withAudioDeviceDailyAutoTest(Boolean audioDeviceDailyAutoTest) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withAutoDirectSharing(Boolean autoDirectSharing) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withAutoStartScheduledMeeting(Boolean autoStartScheduledMeeting) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withAutoStopScheduledMeeting(Boolean autoStopScheduledMeeting) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withCountAttendeesNumberInRoom(Boolean countAttendeesNumberInRoom) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withDisplayFeedbackSurvey(Boolean displayFeedbackSurvey) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withDisplayMeetingList(Boolean displayMeetingList) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withDisplayTopBanner(Boolean displayTopBanner) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withEncryptSharedScreenContent(Boolean encryptSharedScreenContent) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withHideIdForPrivateMeeting(Boolean hideIdForPrivateMeeting) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withHideShareInstruction(Boolean hideShareInstruction) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withSendWhiteboardToInternalContactOnly(Boolean sendWhiteboardToInternalContactOnly) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withShowAlertBeforeMeeting(Boolean showAlertBeforeMeeting) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withShowCallHistoryInRoom(Boolean showCallHistoryInRoom) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withShowContactListOnController(Boolean showContactListOnController) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withShowNonVideoParticipants(Boolean showNonVideoParticipants) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withStartAirplayManually(Boolean startAirplayManually) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withStartAirplayMirroring(Boolean startAirplayMirroring) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withSupportJoin3rdPartyMeeting(Boolean supportJoin3rdPartyMeeting) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withTransformMeetingToPrivate(Boolean transformMeetingToPrivate) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withUpcomingMeetingAlert(Boolean upcomingMeetingAlert) {
    ...
    public UpdateZRSettingsApplicationJSON1ZoomRooms withWeeklySystemRestart(Boolean weeklySystemRestart) {
