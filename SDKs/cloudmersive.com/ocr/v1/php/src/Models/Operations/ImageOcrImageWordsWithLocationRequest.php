...
class ImageOcrImageWordsWithLocationRequest
{
    ...
    public ImageOcrImageWordsWithLocationRequestBody $requestBody;
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\ImageOcrImageWordsWithLocationRequestBody();
		$this->language = null;
