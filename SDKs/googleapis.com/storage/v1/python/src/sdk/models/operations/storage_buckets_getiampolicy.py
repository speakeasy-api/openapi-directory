...
class StorageBucketsGetIamPolicySecurity:
    option1: Optional[StorageBucketsGetIamPolicySecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageBucketsGetIamPolicySecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageBucketsGetIamPolicyRequest:
    path_params: StorageBucketsGetIamPolicyPathParams = dataclasses.field()
    query_params: StorageBucketsGetIamPolicyQueryParams = dataclasses.field()
    security: StorageBucketsGetIamPolicySecurity = dataclasses.field()
