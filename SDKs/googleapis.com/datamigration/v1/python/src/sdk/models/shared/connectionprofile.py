...
from ..shared import oracleconnectionprofile as shared_oracleconnectionprofile
...
class ConnectionProfile:
    ...
    alloydb: Optional[shared_alloydbconnectionprofile.AlloyDbConnectionProfile] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alloydb'), 'exclude': lambda f: f is None }})
    ...
    oracle: Optional[shared_oracleconnectionprofile.OracleConnectionProfile] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('oracle'), 'exclude': lambda f: f is None }})
    r"""Specifies connection parameters required specifically for Oracle databases."""  
    postgresql: Optional[shared_postgresqlconnectionprofile.PostgreSQLConnectionProfile] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('postgresql'), 'exclude': lambda f: f is None }})
...
class ConnectionProfileInput:
    ...
    alloydb: Optional[shared_alloydbconnectionprofile.AlloyDbConnectionProfileInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alloydb'), 'exclude': lambda f: f is None }})
    r"""Specifies required connection parameters, and the parameters required to create an AlloyDB destination cluster."""  
    ...
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""The name of this connection profile resource in the form of projects/{project}/locations/{location}/connectionProfiles/{connectionProfile}."""  
    oracle: Optional[shared_oracleconnectionprofile.OracleConnectionProfileInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('oracle'), 'exclude': lambda f: f is None }})
    r"""Specifies connection parameters required specifically for Oracle databases."""  
    postgresql: Optional[shared_postgresqlconnectionprofile.PostgreSQLConnectionProfileInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('postgresql'), 'exclude': lambda f: f is None }})
    r"""Specifies connection parameters required specifically for PostgreSQL databases."""  
    provider: Optional[ConnectionProfileProviderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('provider'), 'exclude': lambda f: f is None }})
    r"""The database provider."""  
    state: Optional[ConnectionProfileStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
