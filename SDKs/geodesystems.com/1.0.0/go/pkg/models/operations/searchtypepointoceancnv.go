...
type SearchTypePointOceanCnvQueryParams struct {
...
type SearchTypePointOceanCnvRequest struct {
	QueryParams SearchTypePointOceanCnvQueryParams
}

type SearchTypePointOceanCnvResponse struct {
	ContentType string
	StatusCode  int
