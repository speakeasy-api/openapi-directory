...
class CoveragePlanCreateRequestBenefitDetailsEnum(str, Enum):
...
class CoveragePlanCreateRequest:
    ...
    benefit_details: Optional[CoveragePlanCreateRequestBenefitDetailsEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('benefit_details'), 'exclude': lambda f: f is None }})
    r"""The add-on benefits offered by the plan."""  
    cobra_rules: Optional[CoveragePlanCreateRequestCobraRules] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cobra_rules'), 'exclude': lambda f: f is None }})
    r"""COBRA rules for the group medical plan"""  
