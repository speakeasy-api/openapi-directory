...
exports.GetCisLinesWithTagResponse = exports.GetCisLinesWithTagRequest = void 0;
...
var GetCisLinesWithTagRequest = /** @class */ (function (_super) {
    ...
    ], GetCisLinesWithTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCisLinesWithTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCisLinesWithTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetCisLinesWithTagRequest.prototype, "subContractorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetCisLinesWithTagRequest.prototype, "tagId", void 0);
...
var GetCisLinesWithTagResponse = /** @class */ (function (_super) {
    ...
    ], GetCisLinesWithTagResponse.prototype, "rawResponse", void 0);
