...
export declare enum PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum {
    Uniform = "uniform"
}
/**
 * Uniformly distributed random response delay.
 */
export declare class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniform extends SpeakeasyBase {
    lower?: number;
    type?: PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum;
    upper?: number;
}
export declare enum PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum {
    Lognormal = "lognormal"
}
/**
 * Log normal randomly distributed response delay.
 */
export declare class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormal extends SpeakeasyBase {
    median?: number;
    sigma?: number;
