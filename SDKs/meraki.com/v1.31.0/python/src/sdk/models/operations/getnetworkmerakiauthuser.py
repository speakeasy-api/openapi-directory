...
class GetNetworkMerakiAuthUser200ApplicationJSON:
    ...
    authorizations: Optional[list[GetNetworkMerakiAuthUser200ApplicationJSONAuthorizations]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authorizations'), 'exclude': lambda f: f is None }})
...
class GetNetworkMerakiAuthUserResponse:
    ...
    get_network_meraki_auth_user_200_application_json_object: Optional[GetNetworkMerakiAuthUser200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
