...
class LicensingLicenseAssignmentsGetRequest:
    path_params: LicensingLicenseAssignmentsGetPathParams = dataclasses.field()
    query_params: LicensingLicenseAssignmentsGetQueryParams = dataclasses.field()
    security: LicensingLicenseAssignmentsGetSecurity = dataclasses.field()
