...
public class PaymentLinkApiNewFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PaymentLinkApiNewFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public PaymentLinkApiNewFormHeaders withXAuthSecret(String xAuthSecret) {
