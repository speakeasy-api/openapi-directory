...
public class Repository {
    ...
    public Repository withAllowAutoMerge(Boolean allowAutoMerge) {
    ...
    public Repository withAllowUpdateBranch(Boolean allowUpdateBranch) {
    ...
    public RepositoryMergeCommitMessageEnum mergeCommitMessage;
    public Repository withMergeCommitMessage(RepositoryMergeCommitMessageEnum mergeCommitMessage) {
    ...
    public RepositoryMergeCommitTitleEnum mergeCommitTitle;
    public Repository withMergeCommitTitle(RepositoryMergeCommitTitleEnum mergeCommitTitle) {
    ...
    public RepositorySquashMergeCommitMessageEnum squashMergeCommitMessage;
    public Repository withSquashMergeCommitMessage(RepositorySquashMergeCommitMessageEnum squashMergeCommitMessage) {
    ...
    public RepositorySquashMergeCommitTitleEnum squashMergeCommitTitle;
    public Repository withSquashMergeCommitTitle(RepositorySquashMergeCommitTitleEnum squashMergeCommitTitle) {
    ...
    public Repository withUseSquashPrTitleAsDefault(Boolean useSquashPrTitleAsDefault) {
    ...
    public Repository withWebCommitSignoffRequired(Boolean webCommitSignoffRequired) {
