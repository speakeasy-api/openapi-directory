...
class StartConfigRulesEvaluationRequest:
    ...
    start_config_rules_evaluation_request: shared_startconfigrulesevaluationrequest.StartConfigRulesEvaluationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
