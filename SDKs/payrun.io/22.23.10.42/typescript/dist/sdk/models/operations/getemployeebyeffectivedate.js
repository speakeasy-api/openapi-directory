...
exports.GetEmployeeByEffectiveDateResponse = exports.GetEmployeeByEffectiveDateRequest = void 0;
...
var GetEmployeeByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetEmployeeByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetEmployeeByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetEmployeeByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetEmployeeByEffectiveDateRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetEmployeeByEffectiveDateRequest.prototype, "employerId", void 0);
    return GetEmployeeByEffectiveDateRequest;
}(utils_1.SpeakeasyBase));
exports.GetEmployeeByEffectiveDateRequest = GetEmployeeByEffectiveDateRequest;
var GetEmployeeByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetEmployeeByEffectiveDateResponse.prototype, "rawResponse", void 0);
    return GetEmployeeByEffectiveDateResponse;
}(utils_1.SpeakeasyBase));
exports.GetEmployeeByEffectiveDateResponse = GetEmployeeByEffectiveDateResponse;
