...
import dataclasses
from ..shared import subnetcidrreservationtype_enum as shared_subnetcidrreservationtype_enum
from enum import Enum
from typing import Optional

class CreateSubnetCidrReservationRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateSubnetCidrReservationRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateSubnetCidrReservationRequestTagSpecifications:
    ...
    resource_type: Optional[CreateSubnetCidrReservationRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateSubnetCidrReservationRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateSubnetCidrReservationRequest:
    ...
    reservation_type: shared_subnetcidrreservationtype_enum.SubnetCidrReservationTypeEnum = dataclasses.field()  
    subnet_id: str = dataclasses.field()  
    description: Optional[str] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateSubnetCidrReservationRequestTagSpecifications]] = dataclasses.field(default=None)  
