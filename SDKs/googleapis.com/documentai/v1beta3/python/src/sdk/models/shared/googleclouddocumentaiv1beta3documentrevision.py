...
import dataclasses
from ..shared import googleclouddocumentaiv1beta3documentrevisionhumanreview as shared_googleclouddocumentaiv1beta3documentrevisionhumanreview
...
class GoogleCloudDocumentaiV1beta3DocumentRevision:
    ...
    human_review: Optional[shared_googleclouddocumentaiv1beta3documentrevisionhumanreview.GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('humanReview'), 'exclude': lambda f: f is None }})
