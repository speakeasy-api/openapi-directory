...
exports.POSTBatchDeleteAttributesResponse = exports.POSTBatchDeleteAttributesRequest = exports.POSTBatchDeleteAttributesVersionEnum = exports.POSTBatchDeleteAttributesActionEnum = void 0;
...
var POSTBatchDeleteAttributesRequest = /** @class */ (function (_super) {
    ...
    ], POSTBatchDeleteAttributesRequest.prototype, "awsAccessKeyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Action",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteAttributesRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTBatchDeleteAttributesRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Signature",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteAttributesRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureMethod",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteAttributesRequest.prototype, "signatureMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureVersion",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteAttributesRequest.prototype, "signatureVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Timestamp",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteAttributesRequest.prototype, "timestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteAttributesRequest.prototype, "version", void 0);
...
var POSTBatchDeleteAttributesResponse = /** @class */ (function (_super) {
    ...
    ], POSTBatchDeleteAttributesResponse.prototype, "rawResponse", void 0);
