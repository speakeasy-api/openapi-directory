...
public class ListPaymentRefundsQueryParams {
    /**
    ...
    public ListPaymentRefundsQueryParams withBeginTime(String beginTime) {
    ...
    public ListPaymentRefundsQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public ListPaymentRefundsQueryParams withEndTime(String endTime) {
    ...
    public Long limit;
    public ListPaymentRefundsQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListPaymentRefundsQueryParams withLocationId(String locationId) {
    ...
    public ListPaymentRefundsQueryParams withSortOrder(String sortOrder) {
    ...
    public ListPaymentRefundsQueryParams withSourceType(String sourceType) {
    ...
    public ListPaymentRefundsQueryParams withStatus(String status) {
        this.status = status;
        return this;
    }
