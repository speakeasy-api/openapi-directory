...
export class GetScreenshotsTargetScreenshotTestIdTargetVersionIdComparisonBaseResultIdSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetScreenshotsTargetScreenshotTestIdTargetVersionIdComparisonBaseResultIdRequest extends SpeakeasyBase {
  /**
...
export class GetScreenshotsTargetScreenshotTestIdTargetVersionIdComparisonBaseResultIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
