...
type CreateCategory200ApplicationJSONCategoryRequiredTagGroups struct {
	MinCount int64  `json:"min_count"`
	Name     string `json:"name"`
}

type CreateCategory200ApplicationJSONCategory struct {
	...
	FormTemplateIds                     []interface{}                                               `json:"form_template_ids,omitempty"`
	GroupPermissions                    []CreateCategory200ApplicationJSONCategoryGroupPermissions  `json:"group_permissions"`
	...
	RequiredTagGroups                   []CreateCategory200ApplicationJSONCategoryRequiredTagGroups `json:"required_tag_groups"`
...
type CreateCategory200ApplicationJSON struct {
	Category CreateCategory200ApplicationJSONCategory `json:"category"`
}
