...
class AdsensehostCustomchannelsUpdateRequest:
    path_params: AdsensehostCustomchannelsUpdatePathParams = dataclasses.field()
    query_params: AdsensehostCustomchannelsUpdateQueryParams = dataclasses.field()
    security: AdsensehostCustomchannelsUpdateSecurity = dataclasses.field()
