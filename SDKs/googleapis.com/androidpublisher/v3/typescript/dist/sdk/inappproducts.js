...
var Inappproducts = /** @class */ (function () {
    ...
    **/
    Inappproducts.prototype.androidpublisherInappproductsDelete = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/androidpublisher/v3/applications/{packageName}/inappproducts/{sku}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.inAppProduct = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Inappproducts.prototype.androidpublisherInappproductsInsert = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/androidpublisher/v3/applications/{packageName}/inappproducts", req.pathParams);
    ...
    Inappproducts.prototype.androidpublisherInappproductsList = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.inappproductsListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
