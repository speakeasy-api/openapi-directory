...
exports.ListEngagementResponse = exports.ListEngagementListEngagementResponse = exports.ListEngagementListEngagementResponseMeta = exports.ListEngagementRequest = exports.ListEngagementSecurity = exports.ListEngagementServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListEngagementServerList = ["https://studio.twilio.com"];
var ListEngagementSecurity = /** @class */ (function (_super) {
    ...
    ], ListEngagementSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListEngagementSecurity.prototype, "username", void 0);
...
var ListEngagementRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListEngagementRequest.prototype, "flowSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListEngagementRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListEngagementRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListEngagementRequest.prototype, "pageToken", void 0);
...
var ListEngagementListEngagementResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.StudioV1FlowEngagement }),
        (0, class_transformer_1.Expose)({ name: "engagements" }),
        (0, class_transformer_1.Type)(function () { return shared.StudioV1FlowEngagement; }),
        __metadata("design:type", Array)
    ], ListEngagementListEngagementResponse.prototype, "engagements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListEngagementListEngagementResponseMeta; }),
...
var ListEngagementResponse = /** @class */ (function (_super) {
    ...
    ], ListEngagementResponse.prototype, "rawResponse", void 0);
