...
from ..shared import getreferenceresponse as shared_getreferenceresponse
from enum import Enum
from typing import Any, Optional

class GetReferenceFileEnum(str, Enum):
...
class GetReferenceRequest:
    ...
    file: Optional[GetReferenceFileEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'file', 'style': 'form', 'explode': True }})
    r"""The file to retrieve."""  
    range: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Range', 'style': 'simple', 'explode': False }})
    r"""The range to retrieve."""  
...
class GetReferenceResponse:
    ...
    get_reference_response: Optional[shared_getreferenceresponse.GetReferenceResponse] = dataclasses.field(default=None)
    r"""Success"""  
