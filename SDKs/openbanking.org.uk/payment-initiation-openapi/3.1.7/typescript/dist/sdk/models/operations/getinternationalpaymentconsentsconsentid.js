...
exports.GetInternationalPaymentConsentsConsentIdResponse = exports.GetInternationalPaymentConsentsConsentIdRequest = exports.GetInternationalPaymentConsentsConsentIdSecurity = void 0;
...
exports.GetInternationalPaymentConsentsConsentIdSecurity = GetInternationalPaymentConsentsConsentIdSecurity;
var GetInternationalPaymentConsentsConsentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConsentId",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetInternationalPaymentConsentsConsentIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentConsentsConsentIdRequest = GetInternationalPaymentConsentsConsentIdRequest;
var GetInternationalPaymentConsentsConsentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetInternationalPaymentConsentsConsentIdResponse.prototype, "rawResponse", void 0);
    return GetInternationalPaymentConsentsConsentIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentConsentsConsentIdResponse = GetInternationalPaymentConsentsConsentIdResponse;
