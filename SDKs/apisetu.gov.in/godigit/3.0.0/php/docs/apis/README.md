...
try {
    ...
    $request->certificateParameters->documentNumber = '01234567890/12345678901234567/AA11AA1111';
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->gender = 'M';
    $request->certificateParameters->policyNumber = 'D0123456789';
    $request->certificateParameters->searchDocument = 'Mobile Number,Chassis Number,Vehicle Registration Number';
