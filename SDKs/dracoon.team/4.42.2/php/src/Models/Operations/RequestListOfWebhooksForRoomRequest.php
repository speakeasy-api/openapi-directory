...
class RequestListOfWebhooksForRoomRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestListOfWebhooksForRoomXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestListOfWebhooksForRoomXSdsDateFormatEnum $xSdsDateFormat = null;
