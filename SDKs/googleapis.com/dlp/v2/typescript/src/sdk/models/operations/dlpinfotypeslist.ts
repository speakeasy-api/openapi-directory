...
export class DlpInfoTypesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DlpInfoTypesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DlpInfoTypesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
