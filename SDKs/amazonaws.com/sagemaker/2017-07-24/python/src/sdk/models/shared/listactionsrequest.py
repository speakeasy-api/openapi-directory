...
from ..shared import sortactionsby_enum as shared_sortactionsby_enum
...
class ListActionsRequest:
    ...
    sort_by: Optional[shared_sortactionsby_enum.SortActionsByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
