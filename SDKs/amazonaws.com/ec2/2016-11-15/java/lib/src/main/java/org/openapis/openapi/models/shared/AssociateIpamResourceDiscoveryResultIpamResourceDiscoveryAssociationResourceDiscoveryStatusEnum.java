 ...
 */
public enum AssociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationResourceDiscoveryStatusEnum {
    ACTIVE("active"),
    NOT_FOUND("not-found");
    ...
    private AssociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationResourceDiscoveryStatusEnum(String value) {
        this.value = value;
    }
}
