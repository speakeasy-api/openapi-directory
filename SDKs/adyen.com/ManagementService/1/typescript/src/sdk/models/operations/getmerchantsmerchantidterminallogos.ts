...
export class GetMerchantsMerchantIdTerminalLogosSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetMerchantsMerchantIdTerminalLogosRequest extends SpeakeasyBase {
  /**
...
export class GetMerchantsMerchantIdTerminalLogosResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
