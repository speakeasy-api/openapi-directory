...
func (e ScoreCreationDataEncodingEnum) ToPointer() *ScoreCreationDataEncodingEnum {
	return &e
}
...
func (e *ScoreCreationDataEncodingEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "base64":
		*e = ScoreCreationDataEncodingEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ScoreCreationDataEncodingEnum: %v", v)
	}
}
