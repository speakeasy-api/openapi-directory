...
class DescribeLocalGatewayRouteTablesRequestFilters:
...
class DescribeLocalGatewayRouteTablesRequest:
    ...
    filters: Optional[list[DescribeLocalGatewayRouteTablesRequestFilters]] = dataclasses.field(default=None)  
    local_gateway_route_table_ids: Optional[list[str]] = dataclasses.field(default=None)  
