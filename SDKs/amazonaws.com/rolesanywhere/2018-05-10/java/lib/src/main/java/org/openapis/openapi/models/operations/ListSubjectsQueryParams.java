...
public class ListSubjectsQueryParams {
    /**
    ...
    public ListSubjectsQueryParams withNextToken(String nextToken) {
    ...
    public ListSubjectsQueryParams withPageSize(Long pageSize) {
