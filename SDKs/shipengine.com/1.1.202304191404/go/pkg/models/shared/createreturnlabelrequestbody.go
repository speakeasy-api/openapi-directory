...
func (e CreateReturnLabelRequestBodyDisplaySchemeEnum) ToPointer() *CreateReturnLabelRequestBodyDisplaySchemeEnum {
	return &e
}
...
func (e *CreateReturnLabelRequestBodyDisplaySchemeEnum) UnmarshalJSON(data []byte) error {
	...
	case "label_and_qr_code":
		*e = CreateReturnLabelRequestBodyDisplaySchemeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateReturnLabelRequestBodyDisplaySchemeEnum: %v", v)
	}
}
...
func (e CreateReturnLabelRequestBodyLabelDownloadTypeEnum) ToPointer() *CreateReturnLabelRequestBodyLabelDownloadTypeEnum {
	return &e
}
...
func (e *CreateReturnLabelRequestBodyLabelDownloadTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "url":
		fallthrough
	case "inline":
		*e = CreateReturnLabelRequestBodyLabelDownloadTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateReturnLabelRequestBodyLabelDownloadTypeEnum: %v", v)
	}
}
...
func (e CreateReturnLabelRequestBodyLabelFormatEnum) ToPointer() *CreateReturnLabelRequestBodyLabelFormatEnum {
	return &e
}
...
func (e *CreateReturnLabelRequestBodyLabelFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "png":
		fallthrough
	case "zpl":
		*e = CreateReturnLabelRequestBodyLabelFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateReturnLabelRequestBodyLabelFormatEnum: %v", v)
	}
}
...
func (e CreateReturnLabelRequestBodyLabelLayoutEnum) ToPointer() *CreateReturnLabelRequestBodyLabelLayoutEnum {
	return &e
}
...
func (e *CreateReturnLabelRequestBodyLabelLayoutEnum) UnmarshalJSON(data []byte) error {
	...
	case "4x6":
		fallthrough
	case "letter":
		*e = CreateReturnLabelRequestBodyLabelLayoutEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateReturnLabelRequestBodyLabelLayoutEnum: %v", v)
	}
}
