...
type DatastreamProjectsLocationsStreamsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatastreamProjectsLocationsStreamsListPathParams struct {
	// Required. The parent that owns the collection of streams.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatastreamProjectsLocationsStreamsListQueryParams struct {
	// V1 error format.
...
type DatastreamProjectsLocationsStreamsListRequest struct {
...
type DatastreamProjectsLocationsStreamsListResponse struct {
	ContentType string
	// Successful response
