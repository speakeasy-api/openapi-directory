...
public class GetUserPostsQueryParams {
    /**
    ...
    public GetUserPostsQueryParams withDateMax(OffsetDateTime dateMax) {
    ...
    public GetUserPostsQueryParams withDateMin(OffsetDateTime dateMin) {
    ...
    public GetUserPostsQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public GetUserPostsQueryParams withGroupIds(String groupIds) {
    ...
    public GetUserPostsQueryParams withIncludeReposts(Long includeReposts) {
    ...
    public GetUserPostsQueryParams withLatitude(Double latitude) {
    ...
    public GetUserPostsQueryParams withLongitude(Double longitude) {
    ...
    public GetUserPostsQueryParams withOutcomes(String outcomes) {
    ...
    public Long page;
    public GetUserPostsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetUserPostsQueryParams withPerPage(Long perPage) {
    ...
    public GetUserPostsQueryParams withRadius(Double radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetUserPostsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetUserPostsQueryParams withSources(String sources) {
    ...
    public String types;
    public GetUserPostsQueryParams withTypes(String types) {
        this.types = types;
        return this;
    }
