...
var ApiKeys = /** @class */ (function () {
     ...
     * Delete Api Key
    **/
    ApiKeys.prototype.deleteApiKeysId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteApiKeysIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api_keys/{id}", req.pathParams);
     ...
     * List Api Keys
    **/
    ApiKeys.prototype.getApiKeys = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetApiKeysRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api_keys";
        var client = this._defaultClient;
     ...
     * Show Api Key
    **/
    ApiKeys.prototype.getApiKeysId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update Api Key
    **/
    ApiKeys.prototype.patchApiKeysId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Create Api Key
    **/
    ApiKeys.prototype.postApiKeys = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
