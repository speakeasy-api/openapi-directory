...
class CalendarCalendarListPatchRequest:
    path_params: CalendarCalendarListPatchPathParams = dataclasses.field()
    query_params: CalendarCalendarListPatchQueryParams = dataclasses.field()
    security: CalendarCalendarListPatchSecurity = dataclasses.field()
