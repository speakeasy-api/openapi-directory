...
try {
    ...
    $request->teamId = 86955;
    $request->username = 'Willow_Waters7';
...
try {
    ...
    $request->username = 'Mikel.Senger90';
...
try {
    ...
    $request->teamId = 799866;
    $request->username = 'Janet49';
...
try {
    ...
    $request->requestBody->permission = TeamsAddOrUpdateProjectPermissionsInOrgRequestBodyPermissionEnum::WRITE;
    $request->org = 'rerum';
    $request->projectId = 643997;
    $request->teamSlug = 'odit';
...
try {
    ...
    $request->requestBody->permission = 'iusto';
    $request->org = 'esse';
...
try {
    ...
    $request->requestBody->ldapDn = 'temporibus';
    ...
    $request->requestBody->name = 'Brandon Willms';
    $request->requestBody->parentTeamId = 379661;
...
try {
    ...
    $request->discussionNumber = 546868;
    $request->org = 'molestiae';
    $request->teamSlug = 'quis';
...
try {
    ...
    $request->requestBody->body = 'iure';
    $request->discussionNumber = 68596;
    $request->teamId = 308658;
...
try {
    ...
    $request->commentNumber = 515595;
    $request->discussionNumber = 722392;
    $request->org = 'nemo';
...
try {
    ...
    $request->commentNumber = 371213;
    $request->discussionNumber = 328954;
    $request->teamId = 273383;
...
try {
    ...
    $request->discussionNumber = 19691;
...
try {
    ...
    $request->discussionNumber = 854137;
    $request->teamId = 257821;
...
try {
    ...
    $request->commentNumber = 769789;
    $request->discussionNumber = 394724;
    $request->org = 'cumque';
    $request->teamSlug = 'soluta';
...
try {
    ...
    $request->commentNumber = 856568;
    $request->discussionNumber = 389287;
    $request->teamId = 720319;
...
try {
    ...
    $request->discussionNumber = 315387;
    $request->org = 'maiores';
...
try {
    ...
    $request->discussionNumber = 898826;
    $request->teamId = 803792;
...
try {
    ...
    $request->teamId = 29080;
    $request->username = 'Ladarius30';
...
try {
    ...
    $request->username = 'Brenden_Kautzer82';
...
try {
    ...
    $request->teamId = 143061;
    $request->username = 'Gardner52';
...
try {
    ...
    $request->page = 46384;
    $request->perPage = 915408;
    $request->teamId = 822711;
...
try {
    ...
    $request->page = 943063;
    $request->perPage = 980649;
    $request->teamId = 990652;
...
try {
    ...
    $request->page = 585628;
    $request->perPage = 656839;
    $request->pinned = 'provident';
...
try {
    ...
    $request->page = 53529;
    $request->perPage = 4929;
    $request->teamId = 181622;
...
try {
    ...
    $request->page = 227431;
    $request->perPage = 346608;
    $request->teamId = 847018;
...
try {
    ...
    $request->teamId = 506532;
    $request->username = 'Leann_Murphy22';
...
try {
    ...
    $request->username = 'Yasmine_Smith';
...
try {
    ...
    $request->projectId = 42763;
    $request->teamId = 217504;
...
try {
    ...
    $request->commentNumber = 101770;
    $request->discussionNumber = 953564;
    $request->org = 'laborum';
...
try {
    ...
    $request->requestBody->body = 'quod';
    $request->commentNumber = 951103;
    $request->discussionNumber = 185313;
    $request->teamId = 34989;
...
try {
    ...
    $request->discussionNumber = 519985;
    $request->org = 'tenetur';
    $request->teamSlug = 'voluptate';
...
try {
    ...
    $request->requestBody->body = 'quam';
    $request->requestBody->title = 'Miss';
    $request->discussionNumber = 110247;
    $request->teamId = 960523;
...
try {
    ...
    $request->requestBody->name = 'Jared Blick';
    $request->requestBody->parentTeamId = 681578;
...
try {
    ...
    $request->requestBody->name = 'Jimmy Rosenbaum MD';
    $request->requestBody->parentTeamId = 609172;
