...
class DeleteInvitationsRequestBody:
    ...
    r"""The list of member account IDs that received the invitations you want to delete."""  
    

@dataclasses.dataclass
class DeleteInvitationsRequest:
    
    request_body: DeleteInvitationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
