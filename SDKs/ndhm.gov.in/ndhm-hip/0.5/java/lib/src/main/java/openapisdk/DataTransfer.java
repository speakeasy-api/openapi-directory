...
public class DataTransfer {
     ...
     * 
    **/
    public openapisdk.models.operations.PostV05HealthInformationTransferResponse postV05HealthInformationTransfer(openapisdk.models.operations.PostV05HealthInformationTransferRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.PostV05HealthInformationTransferRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v0.5/health-information/transfer");
        ...
        openapisdk.models.operations.PostV05HealthInformationTransferResponse res = new openapisdk.models.operations.PostV05HealthInformationTransferResponse() {{
            errorResponse = null;
            body = null;
            errorResponse = null;
            body = null;
