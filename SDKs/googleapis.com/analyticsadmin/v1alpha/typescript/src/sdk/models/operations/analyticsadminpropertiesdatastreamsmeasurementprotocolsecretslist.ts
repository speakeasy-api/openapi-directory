...
export class AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListSecurity extends SpeakeasyBase {
...
export class AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
