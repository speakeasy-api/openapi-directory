...
class PostDescribeDbProxyEndpointsQueryParams:
    action: PostDescribeDbProxyEndpointsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeDbProxyEndpointsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDbProxyEndpointsRequest:
    headers: PostDescribeDbProxyEndpointsHeaders = dataclasses.field()
    query_params: PostDescribeDbProxyEndpointsQueryParams = dataclasses.field()
