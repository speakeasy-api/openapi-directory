...
from ..shared import proxycreateaccount as shared_proxycreateaccount
...
class ObjectPOSTAccountRequest:
    ...
    proxy_create_account: shared_proxycreateaccount.ProxyCreateAccount = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
