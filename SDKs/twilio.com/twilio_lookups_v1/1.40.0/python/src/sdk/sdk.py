...
class SDK:
    ...
    def fetch_phone_number(self, request: operations.FetchPhoneNumberRequest, security: operations.FetchPhoneNumberSecurity, server_url: Optional[str] = None) -> operations.FetchPhoneNumberResponse:
        ...
        url = utils.generate_url(operations.FetchPhoneNumberRequest, base_url, '/v1/PhoneNumbers/{PhoneNumber}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.LookupsV1PhoneNumber])
