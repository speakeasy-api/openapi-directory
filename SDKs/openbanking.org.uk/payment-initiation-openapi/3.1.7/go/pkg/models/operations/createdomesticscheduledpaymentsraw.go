...
type CreateDomesticScheduledPaymentsRawSecurity struct {
	PSUOAuth2Security shared.SchemePsuoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateDomesticScheduledPaymentsRawHeaders struct {
...
type CreateDomesticScheduledPaymentsRawRequest struct {
	Headers CreateDomesticScheduledPaymentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateDomesticScheduledPaymentsRawSecurity
}

type CreateDomesticScheduledPaymentsRawResponse struct {
	Body        []byte
	ContentType string
