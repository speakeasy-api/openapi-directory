...
type MlProjectsModelsGetIamPolicySecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type MlProjectsModelsGetIamPolicyPathParams struct {
	// REQUIRED: The resource for which the policy is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
	Resource string `pathParam:"style=simple,explode=false,name=resource"`
}

type MlProjectsModelsGetIamPolicyQueryParams struct {
	// V1 error format.
...
type MlProjectsModelsGetIamPolicyRequest struct {
...
type MlProjectsModelsGetIamPolicyResponse struct {
	ContentType string
	// Successful response
