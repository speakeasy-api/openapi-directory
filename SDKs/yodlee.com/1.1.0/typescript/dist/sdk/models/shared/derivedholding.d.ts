...
export declare enum DerivedHoldingHoldingTypeEnum {
    Stock = "stock",
...
export declare enum DerivedHoldingOptionTypeEnum {
    Put = "put",
    Call = "call",
    Unknown = "unknown",
    Other = "other"
}
export declare class DerivedHolding extends SpeakeasyBase {
    accountId?: number;
    accruedIncome?: Money;
