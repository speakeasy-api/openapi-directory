...
exports.InsightsByAssessment = void 0;
 ...
 */
var InsightsByAssessment = /** @class */ (function (_super) {
    __extends(InsightsByAssessment, _super);
    ...
    ], InsightsByAssessment.prototype, "assessmentControlsCountByNoncompliantEvidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "compliantEvidenceCount" }),
        __metadata("design:type", Number)
    ], InsightsByAssessment.prototype, "compliantEvidenceCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "inconclusiveEvidenceCount" }),
        __metadata("design:type", Number)
    ], InsightsByAssessment.prototype, "inconclusiveEvidenceCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], InsightsByAssessment.prototype, "lastUpdated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "noncompliantEvidenceCount" }),
        __metadata("design:type", Number)
    ], InsightsByAssessment.prototype, "noncompliantEvidenceCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "totalAssessmentControlsCount" }),
        __metadata("design:type", Number)
    ], InsightsByAssessment.prototype, "totalAssessmentControlsCount", void 0);
    return InsightsByAssessment;
}(utils_1.SpeakeasyBase));
exports.InsightsByAssessment = InsightsByAssessment;
