...
class GetRelationalDatabaseLogStreamsRequest:
    ...
    get_relational_database_log_streams_request: shared_getrelationaldatabaselogstreamsrequest.GetRelationalDatabaseLogStreamsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
