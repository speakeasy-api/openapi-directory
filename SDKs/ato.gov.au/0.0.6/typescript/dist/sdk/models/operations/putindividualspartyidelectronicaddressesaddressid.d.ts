...
export declare class PutIndividualsPartyIdElectronicAddressesAddressIdRequest extends SpeakeasyBase {
    /**
...
export declare class PutIndividualsPartyIdElectronicAddressesAddressIdResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
