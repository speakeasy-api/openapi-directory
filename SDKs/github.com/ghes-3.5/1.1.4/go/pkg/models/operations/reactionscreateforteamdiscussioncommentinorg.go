...
// ReactionsCreateForTeamDiscussionCommentInOrgRequestBodyContentEnum - The [reaction type](https://docs.github.com/enterprise-server@3.5/rest/reference/reactions#reaction-types) to add to the team discussion comment.
...
func (e ReactionsCreateForTeamDiscussionCommentInOrgRequestBodyContentEnum) ToPointer() *ReactionsCreateForTeamDiscussionCommentInOrgRequestBodyContentEnum {
	return &e
}
...
func (e *ReactionsCreateForTeamDiscussionCommentInOrgRequestBodyContentEnum) UnmarshalJSON(data []byte) error {
	...
	case "rocket":
		fallthrough
	case "eyes":
		*e = ReactionsCreateForTeamDiscussionCommentInOrgRequestBodyContentEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ReactionsCreateForTeamDiscussionCommentInOrgRequestBodyContentEnum: %v", v)
	}
}
