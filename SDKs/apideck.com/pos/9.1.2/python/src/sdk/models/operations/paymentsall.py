...
from ..shared import getpospaymentsresponse as shared_getpospaymentsresponse
...
class PaymentsAllSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class PaymentsAllRequest:
...
class PaymentsAllResponse:
    ...
    r"""Bad Request"""  
    get_pos_payments_response: Optional[shared_getpospaymentsresponse.GetPosPaymentsResponse] = dataclasses.field(default=None)
    r"""PosPayments"""  
