...
class GetUserTaskListRequest:
    path_params: GetUserTaskListPathParams = dataclasses.field()
    query_params: GetUserTaskListQueryParams = dataclasses.field()
...
class GetUserTaskListResponse:
    ...
    get_user_task_list_200_application_json_object: Optional[GetUserTaskList200ApplicationJSON] = dataclasses.field(default=None)
