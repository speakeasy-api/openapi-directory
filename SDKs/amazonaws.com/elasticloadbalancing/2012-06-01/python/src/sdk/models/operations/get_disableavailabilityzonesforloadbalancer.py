...
class GetDisableAvailabilityZonesForLoadBalancerQueryParams:
    action: GetDisableAvailabilityZonesForLoadBalancerActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDisableAvailabilityZonesForLoadBalancerVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisableAvailabilityZonesForLoadBalancerRequest:
    headers: GetDisableAvailabilityZonesForLoadBalancerHeaders = dataclasses.field()
    query_params: GetDisableAvailabilityZonesForLoadBalancerQueryParams = dataclasses.field()
