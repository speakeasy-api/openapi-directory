...
var SDK = /** @class */ (function () {
     ...
     */
    SDK.prototype.batchPutMetrics = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BatchPutMetricsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/BatchPutMetrics";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.BatchPutMetricsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.batchPutMetricsResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.BatchPutMetricsResponse);
                    }
                    break;
            }
            return res;
