...
public class UpdateSiteRackPhysicalPropertiesRequest {
    ...
    public UpdateSiteRackPhysicalPropertiesRequest(@JsonProperty("RequestBody") UpdateSiteRackPhysicalPropertiesRequestBody requestBody, @JsonProperty("SiteId") String siteId) {
        this.requestBody = requestBody;
        this.siteId = siteId;
  }
}
