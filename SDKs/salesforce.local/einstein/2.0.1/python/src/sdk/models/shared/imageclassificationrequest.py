...
class ImageClassificationRequest:
    ...
    sample_base64_content: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sampleBase64Content') }, 'multipart_form': { 'field_name': 'sampleBase64Content' }})
    ...
    sample_location: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sampleLocation') }, 'multipart_form': { 'field_name': 'sampleLocation' }})
