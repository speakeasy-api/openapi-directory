...
class GoogleCloudDatacatalogV1beta1TaxonomyServiceNameEnum(str, Enum):
...
class GoogleCloudDatacatalogV1beta1TaxonomyService:
    ...
    name: Optional[GoogleCloudDatacatalogV1beta1TaxonomyServiceNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""The Google Cloud service name."""  
