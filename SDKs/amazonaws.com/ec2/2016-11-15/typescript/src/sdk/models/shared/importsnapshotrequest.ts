 ...
 */
export enum ImportSnapshotRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class ImportSnapshotRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class ImportSnapshotRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: ImportSnapshotRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: ImportSnapshotRequestTagSpecificationsTags })
  tags?: ImportSnapshotRequestTagSpecificationsTags[];
}

export class ImportSnapshotRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: ImportSnapshotRequestTagSpecifications })
