...
export declare class Candidate {
     ...
     *
     */
    getCandidatesTotalsAggregates(req: operations.GetCandidatesTotalsAggregatesRequest, config?: AxiosRequestConfig): Promise<operations.GetCandidatesTotalsAggregatesResponse>;
    /**
