...
from ..shared import postaccounttype as shared_postaccounttype
...
class POSTAccountRequest:
    ...
    post_account_type: shared_postaccounttype.POSTAccountType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
