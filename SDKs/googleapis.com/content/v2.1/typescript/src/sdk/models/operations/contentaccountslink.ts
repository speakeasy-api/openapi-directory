...
export class ContentAccountsLinkSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccountsLinkRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccountsLinkResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
