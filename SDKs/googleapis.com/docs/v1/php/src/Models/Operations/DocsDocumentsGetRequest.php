...
class DocsDocumentsGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DocsDocumentsGetSuggestionsViewModeEnum $suggestionsViewMode
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=suggestionsViewMode')]
    public ?DocsDocumentsGetSuggestionsViewModeEnum $suggestionsViewMode = null;
