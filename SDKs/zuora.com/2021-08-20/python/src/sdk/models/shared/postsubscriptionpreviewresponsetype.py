...
class PostSubscriptionPreviewResponseTypeChargeMetrics:
    r"""PostSubscriptionPreviewResponseTypeChargeMetrics
...
class PostSubscriptionPreviewResponseTypeCreditMemo:
    r"""PostSubscriptionPreviewResponseTypeCreditMemo
...
class PostSubscriptionPreviewResponseType:
    amount: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('amount') }})
    amount_without_tax: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('amountWithoutTax') }})
    charge_metrics: Optional[PostSubscriptionPreviewResponseTypeChargeMetrics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('chargeMetrics') }})
    ...
    credit_memo: Optional[PostSubscriptionPreviewResponseTypeCreditMemo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('creditMemo') }})
    ...
    invoice_items: Optional[list[shared_postsubscriptionpreviewinvoiceitemstype.PostSubscriptionPreviewInvoiceItemsType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('invoiceItems') }})
