...
class LanguageTranslationsTranslateRequest:
    ...
    translate_text_request: Optional[shared_translatetextrequest.TranslateTextRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
