...
class CreateHITWithHITTypeRequest:
    ...
    create_hit_with_hit_type_request: shared_createhitwithhittyperequest.CreateHITWithHITTypeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
