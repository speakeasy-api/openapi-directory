...
exports.ListTaskChannelResponse = exports.ListTaskChannelListTaskChannelResponse = exports.ListTaskChannelListTaskChannelResponseMeta = exports.ListTaskChannelRequest = exports.ListTaskChannelSecurity = exports.ListTaskChannelServerList = void 0;
...
var ListTaskChannelSecurity = /** @class */ (function (_super) {
    ...
    ], ListTaskChannelSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListTaskChannelSecurity.prototype, "username", void 0);
...
var ListTaskChannelRequest = /** @class */ (function (_super) {
    ...
    ], ListTaskChannelRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListTaskChannelRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListTaskChannelRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], ListTaskChannelRequest.prototype, "workspaceSid", void 0);
...
var ListTaskChannelListTaskChannelResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TaskrouterV1WorkspaceTaskChannel }),
        (0, class_transformer_1.Expose)({ name: "channels" }),
        (0, class_transformer_1.Type)(function () { return shared.TaskrouterV1WorkspaceTaskChannel; }),
        __metadata("design:type", Array)
    ], ListTaskChannelListTaskChannelResponse.prototype, "channels", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListTaskChannelListTaskChannelResponseMeta; }),
...
var ListTaskChannelResponse = /** @class */ (function (_super) {
    ...
    ], ListTaskChannelResponse.prototype, "rawResponse", void 0);
