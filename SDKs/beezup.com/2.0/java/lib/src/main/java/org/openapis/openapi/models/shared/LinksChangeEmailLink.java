...
public class LinksChangeEmailLink {
    /**
    ...
    public LinksChangeEmailLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksChangeEmailLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksChangeEmailLink withDescription(String description) {
    ...
    public LinksChangeEmailLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksChangeEmailLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksChangeEmailLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksChangeEmailLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksChangeEmailLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksChangeEmailLink withOperationId(String operationId) {
    ...
    public LinksChangeEmailLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksChangeEmailLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksChangeEmailLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
