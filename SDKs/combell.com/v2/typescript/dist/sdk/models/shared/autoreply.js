 ...
 */
var AutoReply = /** @class */ (function (_super) {
    __extends(AutoReply, _super);
    function AutoReply() {
    ...
    ], AutoReply.prototype, "enabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "message" }),
        __metadata("design:type", String)
    ], AutoReply.prototype, "message", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subject" }),
        __metadata("design:type", String)
    ], AutoReply.prototype, "subject", void 0);
    return AutoReply;
