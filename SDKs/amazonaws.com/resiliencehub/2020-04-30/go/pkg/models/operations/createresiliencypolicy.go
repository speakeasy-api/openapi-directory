...
type CreateResiliencyPolicyHeaders struct {
...
type CreateResiliencyPolicyRequest struct {
	Headers CreateResiliencyPolicyHeaders
	Request CreateResiliencyPolicyRequestBody `request:"mediaType=application/json"`
}
