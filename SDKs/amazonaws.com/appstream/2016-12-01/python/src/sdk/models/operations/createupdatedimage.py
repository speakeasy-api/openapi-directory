...
class CreateUpdatedImageRequest:
    ...
    create_updated_image_request: shared_createupdatedimagerequest.CreateUpdatedImageRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
