...
from ..shared import getpayrollsresponse as shared_getpayrollsresponse
...
class PayrollsAllRequest:
    headers: PayrollsAllHeaders = dataclasses.field()
    query_params: PayrollsAllQueryParams = dataclasses.field()
    security: PayrollsAllSecurity = dataclasses.field()
...
class PayrollsAllResponse:
    ...
    get_payrolls_response: Optional[shared_getpayrollsresponse.GetPayrollsResponse] = dataclasses.field(default=None)
