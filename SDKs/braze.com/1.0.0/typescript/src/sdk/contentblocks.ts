...
export class ContentBlocks {
  ...
  listAvailableContentBlocks(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ListAvailableContentBlocksResponse =
        new operations.ListAvailableContentBlocksResponse({
  ...
  seeContentBlockInformation(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SeeContentBlockInformationResponse =
        new operations.SeeContentBlockInformationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
