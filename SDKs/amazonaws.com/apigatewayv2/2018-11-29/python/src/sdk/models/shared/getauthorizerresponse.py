...
class GetAuthorizerResponseJwtConfiguration:
    r"""GetAuthorizerResponseJwtConfiguration
...
class GetAuthorizerResponse:
    ...
    jwt_configuration: Optional[GetAuthorizerResponseJwtConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('JwtConfiguration') }})
