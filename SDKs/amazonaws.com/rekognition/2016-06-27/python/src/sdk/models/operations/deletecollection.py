...
class DeleteCollectionRequest:
    headers: DeleteCollectionHeaders = dataclasses.field()
    request: shared_deletecollectionrequest.DeleteCollectionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
