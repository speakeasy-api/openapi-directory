...
export class MybusinessbusinessinformationAccountsLocationsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessbusinessinformationAccountsLocationsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
