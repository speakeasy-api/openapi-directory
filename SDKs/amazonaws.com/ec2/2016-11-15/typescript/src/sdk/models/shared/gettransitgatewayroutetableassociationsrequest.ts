 ...
 */
export class GetTransitGatewayRouteTableAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetTransitGatewayRouteTableAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
