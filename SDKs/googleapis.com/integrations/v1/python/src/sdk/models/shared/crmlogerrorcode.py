...
class CrmlogErrorCode:
    ...
    common_error_code: Optional[CrmlogErrorCodeCommonErrorCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('commonErrorCode'), 'exclude': lambda f: f is None }})  
