...
class DeleteEmailIdentityPolicyRequest:
    headers: DeleteEmailIdentityPolicyHeaders = dataclasses.field()
    path_params: DeleteEmailIdentityPolicyPathParams = dataclasses.field()
...
class DeleteEmailIdentityPolicyResponse:
    ...
    delete_email_identity_policy_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
