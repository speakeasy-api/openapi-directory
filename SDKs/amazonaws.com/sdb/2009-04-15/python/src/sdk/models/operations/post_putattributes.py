...
class PostPutAttributesQueryParams:
    ...
    action: PostPutAttributesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostPutAttributesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class PostPutAttributesRequest:
    query_params: PostPutAttributesQueryParams = dataclasses.field()
