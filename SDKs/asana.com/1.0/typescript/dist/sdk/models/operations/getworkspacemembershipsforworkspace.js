...
exports.GetWorkspaceMembershipsForWorkspaceResponse = exports.GetWorkspaceMembershipsForWorkspace200ApplicationJSON = exports.GetWorkspaceMembershipsForWorkspaceRequest = void 0;
...
var GetWorkspaceMembershipsForWorkspaceRequest = /** @class */ (function (_super) {
    ...
    ], GetWorkspaceMembershipsForWorkspaceRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], GetWorkspaceMembershipsForWorkspaceRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=opt_fields",
        }),
        __metadata("design:type", Array)
    ], GetWorkspaceMembershipsForWorkspaceRequest.prototype, "optFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=opt_pretty",
        }),
        __metadata("design:type", Boolean)
    ], GetWorkspaceMembershipsForWorkspaceRequest.prototype, "optPretty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=user" }),
        __metadata("design:type", String)
    ], GetWorkspaceMembershipsForWorkspaceRequest.prototype, "user", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace_gid",
        }),
        __metadata("design:type", String)
    ], GetWorkspaceMembershipsForWorkspaceRequest.prototype, "workspaceGid", void 0);
...
var GetWorkspaceMembershipsForWorkspaceResponse = /** @class */ (function (_super) {
    ...
    ], GetWorkspaceMembershipsForWorkspaceResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
