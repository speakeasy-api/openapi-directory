...
type DomainsProjectsLocationsRegistrationsRetrieveAuthorizationCodeSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DomainsProjectsLocationsRegistrationsRetrieveAuthorizationCodePathParams struct {
...
type DomainsProjectsLocationsRegistrationsRetrieveAuthorizationCodeQueryParams struct {
	// V1 error format.
...
type DomainsProjectsLocationsRegistrationsRetrieveAuthorizationCodeRequest struct {
...
type DomainsProjectsLocationsRegistrationsRetrieveAuthorizationCodeResponse struct {
	// Successful response
