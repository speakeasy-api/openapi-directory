...
from ..shared import postrevenueschedulebychargetype as shared_postrevenueschedulebychargetype
...
class POSTRSforSubscChargeRequest:
    ...
    r"""ID of the subscription rate plan charge; for example, 402892793e173340013e173b81000012."""  
    post_revenue_schedule_by_charge_type: shared_postrevenueschedulebychargetype.POSTRevenueScheduleByChargeType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
