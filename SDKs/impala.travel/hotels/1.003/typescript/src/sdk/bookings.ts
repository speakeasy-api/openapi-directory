...
export class Bookings {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.booking = utils.objectToClass(httpRes?.data, shared.Booking);
          }
          break;
  ...
  createBooking(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/bookings";
   ...
   */
  listBookings(
    req: operations.ListBookingsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ListBookingsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListBookingsResponse =
        new operations.ListBookingsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listBookings200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.ListBookings200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 400:
  ...
  updateBookingContact(
    req: operations.UpdateBookingContactRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.UpdateBookingContactResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateBookingContactResponse =
        new operations.UpdateBookingContactResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
