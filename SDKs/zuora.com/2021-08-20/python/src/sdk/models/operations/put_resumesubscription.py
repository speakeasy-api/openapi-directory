...
class PUTResumeSubscriptionRequest:
    ...
    put_subscription_resume_type: shared_putsubscriptionresumetype.PUTSubscriptionResumeType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    subscription_key: str = dataclasses.field(metadata={'path_param': { 'field_name': 'subscription-key', 'style': 'simple', 'explode': False }})
    r"""Subscription number or ID. Subscription status must be Suspended."""  
