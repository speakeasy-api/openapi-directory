...
export class DeleteCloudFrontOriginAccessIdentity20181105Request extends SpeakeasyBase {
  /**
...
export class DeleteCloudFrontOriginAccessIdentity20181105Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
