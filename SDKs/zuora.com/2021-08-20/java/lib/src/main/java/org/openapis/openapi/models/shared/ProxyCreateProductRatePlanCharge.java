...
public class ProxyCreateProductRatePlanCharge {
    ...
    public ProxyCreateProductRatePlanCharge withAccountingCode(String accountingCode) {
    ...
    public ProxyCreateProductRatePlanCharge withApplyDiscountTo(String applyDiscountTo) {
    ...
    public ProxyCreateProductRatePlanCharge withBillCycleDay(Integer billCycleDay) {
    ...
    public ProxyCreateProductRatePlanCharge withBillCycleType(String billCycleType) {
    ...
    public ProxyCreateProductRatePlanCharge withBillingPeriod(String billingPeriod) {
    ...
    public ProxyCreateProductRatePlanCharge withBillingPeriodAlignment(String billingPeriodAlignment) {
    ...
    public ProxyCreateProductRatePlanCharge withBillingTiming(String billingTiming) {
    ...
    public ProxyCreateProductRatePlanCharge withChargeModel(String chargeModel) {
    ...
    public ProxyCreateOrModifyProductRatePlanChargeChargeModelConfiguration chargeModelConfiguration;
    public ProxyCreateProductRatePlanCharge withChargeModelConfiguration(ProxyCreateOrModifyProductRatePlanChargeChargeModelConfiguration chargeModelConfiguration) {
    ...
    public ProxyCreateProductRatePlanCharge withChargeType(String chargeType) {
    ...
    public ProxyCreateProductRatePlanCharge withClassNS(String classNS) {
    ...
    public ProxyCreateProductRatePlanCharge withDefaultQuantity(Double defaultQuantity) {
    ...
    public ProxyCreateProductRatePlanCharge withDeferredRevAccountNS(String deferredRevAccountNS) {
    ...
    public ProxyCreateProductRatePlanCharge withDeferredRevenueAccount(String deferredRevenueAccount) {
    ...
    public ProxyCreateProductRatePlanCharge withDepartmentNS(String departmentNS) {
    ...
    public ProxyCreateProductRatePlanCharge withDescription(String description) {
    ...
    public ProxyCreateProductRatePlanCharge withDiscountLevel(String discountLevel) {
    ...
    public ProxyCreateProductRatePlanCharge withEndDateCondition(String endDateCondition) {
    ...
    public ProxyCreateProductRatePlanChargeIncludeChildrenNSEnum includeChildrenNS;
    public ProxyCreateProductRatePlanCharge withIncludeChildrenNS(ProxyCreateProductRatePlanChargeIncludeChildrenNSEnum includeChildrenNS) {
    ...
    public ProxyCreateProductRatePlanCharge withIncludedUnits(Double includedUnits) {
    ...
    public ProxyCreateProductRatePlanCharge withIntegrationIdNS(String integrationIdNS) {
    ...
    public ProxyCreateProductRatePlanCharge withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public ProxyCreateProductRatePlanChargeItemTypeNSEnum itemTypeNS;
    public ProxyCreateProductRatePlanCharge withItemTypeNS(ProxyCreateProductRatePlanChargeItemTypeNSEnum itemTypeNS) {
    ...
    public ProxyCreateProductRatePlanCharge withLegacyRevenueReporting(Boolean legacyRevenueReporting) {
    ...
    public ProxyCreateProductRatePlanCharge withListPriceBase(String listPriceBase) {
    ...
    public ProxyCreateProductRatePlanCharge withLocationNS(String locationNS) {
    ...
    public ProxyCreateProductRatePlanCharge withMaxQuantity(Double maxQuantity) {
    ...
    public ProxyCreateProductRatePlanCharge withMinQuantity(Double minQuantity) {
    ...
    @JsonProperty("Name")
    public String name;
    public ProxyCreateProductRatePlanCharge withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ProxyCreateProductRatePlanCharge withNumberOfPeriod(Long numberOfPeriod) {
    ...
    public ProxyCreateProductRatePlanCharge withOverageCalculationOption(String overageCalculationOption) {
    ...
    public ProxyCreateProductRatePlanCharge withOverageUnusedUnitsCreditOption(String overageUnusedUnitsCreditOption) {
    ...
    public ProxyCreateProductRatePlanCharge withPriceChangeOption(String priceChangeOption) {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("PriceIncreaseOption")
    public ProxyCreateProductRatePlanChargePriceIncreaseOptionEnum priceIncreaseOption;
    public ProxyCreateProductRatePlanCharge withPriceIncreaseOption(ProxyCreateProductRatePlanChargePriceIncreaseOptionEnum priceIncreaseOption) {
    ...
    public ProxyCreateProductRatePlanCharge withPriceIncreasePercentage(Double priceIncreasePercentage) {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("ProductRatePlanChargeTierData")
    public ProxyCreateOrModifyProductRatePlanChargeTierData productRatePlanChargeTierData;
    public ProxyCreateProductRatePlanCharge withProductRatePlanChargeTierData(ProxyCreateOrModifyProductRatePlanChargeTierData productRatePlanChargeTierData) {
    ...
    public ProxyCreateProductRatePlanCharge withProductRatePlanId(String productRatePlanId) {
    ...
    public ProxyCreateProductRatePlanCharge withRatingGroup(String ratingGroup) {
    ...
    public ProxyCreateProductRatePlanCharge withRecognizedRevAccountNS(String recognizedRevAccountNS) {
    ...
    public ProxyCreateProductRatePlanCharge withRecognizedRevenueAccount(String recognizedRevenueAccount) {
    ...
    public ProxyCreateProductRatePlanCharge withRevRecCode(String revRecCode) {
    ...
    public ProxyCreateProductRatePlanChargeRevRecEndNSEnum revRecEndNS;
    public ProxyCreateProductRatePlanCharge withRevRecEndNS(ProxyCreateProductRatePlanChargeRevRecEndNSEnum revRecEndNS) {
    ...
    public ProxyCreateProductRatePlanChargeRevRecStartNSEnum revRecStartNS;
    public ProxyCreateProductRatePlanCharge withRevRecStartNS(ProxyCreateProductRatePlanChargeRevRecStartNSEnum revRecStartNS) {
    ...
    public ProxyCreateProductRatePlanCharge withRevRecTemplateTypeNS(String revRecTemplateTypeNS) {
    ...
    public ProxyCreateProductRatePlanCharge withRevRecTriggerCondition(String revRecTriggerCondition) {
    ...
    public ProxyCreateProductRatePlanCharge withRevenueRecognitionRuleName(String revenueRecognitionRuleName) {
    ...
    public ProxyCreateProductRatePlanCharge withSmoothingModel(String smoothingModel) {
    ...
    public ProxyCreateProductRatePlanCharge withSpecificBillingPeriod(Long specificBillingPeriod) {
    ...
    public ProxyCreateProductRatePlanCharge withSubsidiaryNS(String subsidiaryNS) {
    ...
    public ProxyCreateProductRatePlanCharge withSyncDateNS(String syncDateNS) {
    ...
    public ProxyCreateProductRatePlanCharge withTaxCode(String taxCode) {
    ...
    public ProxyCreateProductRatePlanCharge withTaxMode(String taxMode) {
    ...
    public ProxyCreateProductRatePlanCharge withTaxable(Boolean taxable) {
    ...
    public ProxyCreateProductRatePlanCharge withTriggerEvent(String triggerEvent) {
    ...
    @JsonProperty("UOM")
    public String uom;
    public ProxyCreateProductRatePlanCharge withUom(String uom) {
        this.uom = uom;
        return this;
    }
    ...
    public ProxyCreateProductRatePlanCharge withUpToPeriods(Long upToPeriods) {
    ...
    public ProxyCreateProductRatePlanCharge withUpToPeriodsType(String upToPeriodsType) {
    ...
    public ProxyCreateProductRatePlanChargeUsageRecordRatingOptionEnum usageRecordRatingOption;
    public ProxyCreateProductRatePlanCharge withUsageRecordRatingOption(ProxyCreateProductRatePlanChargeUsageRecordRatingOptionEnum usageRecordRatingOption) {
    ...
    public ProxyCreateProductRatePlanCharge withUseDiscountSpecificAccountingCode(Boolean useDiscountSpecificAccountingCode) {
    ...
    public ProxyCreateProductRatePlanCharge withUseTenantDefaultForPriceChange(Boolean useTenantDefaultForPriceChange) {
    ...
    public ProxyCreateProductRatePlanCharge withWeeklyBillCycleDay(String weeklyBillCycleDay) {
