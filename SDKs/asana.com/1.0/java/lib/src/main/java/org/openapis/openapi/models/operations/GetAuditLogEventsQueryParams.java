...
public class GetAuditLogEventsQueryParams {
    /**
    ...
    public GetAuditLogEventsQueryParams withActorGid(String actorGid) {
    ...
    public GetAuditLogEventsQueryParams withActorType(org.openapis.openapi.models.shared.AuditLogActorTypeEnum actorType) {
    ...
    public GetAuditLogEventsQueryParams withEndAt(OffsetDateTime endAt) {
        this.endAt = endAt;
        return this;
    }
    ...
    public GetAuditLogEventsQueryParams withEventType(String eventType) {
    ...
    public Long limit;
    public GetAuditLogEventsQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetAuditLogEventsQueryParams withOffset(String offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GetAuditLogEventsQueryParams withResourceGid(String resourceGid) {
    ...
    public GetAuditLogEventsQueryParams withStartAt(OffsetDateTime startAt) {
