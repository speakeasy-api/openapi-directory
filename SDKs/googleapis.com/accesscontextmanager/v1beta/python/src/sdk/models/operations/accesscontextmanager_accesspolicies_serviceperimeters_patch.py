...
class AccesscontextmanagerAccessPoliciesServicePerimetersPatchRequest:
    ...
    service_perimeter: Optional[shared_serviceperimeter.ServicePerimeter] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""Required. Mask to control which fields get updated. Must be non-empty."""  
