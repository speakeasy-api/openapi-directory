...
class UpdateNetworkDeviceRequest:
    ...
    request_body: Optional[UpdateNetworkDeviceRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateNetworkDeviceResponse:
    ...
    update_network_device_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
