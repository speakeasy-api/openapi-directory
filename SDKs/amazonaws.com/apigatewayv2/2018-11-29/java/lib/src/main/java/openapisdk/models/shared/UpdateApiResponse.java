...
public class UpdateApiResponse {
    ...
    public UpdateApiResponse withApiEndpoint(java.util.Map<String, Object> apiEndpoint) {
    ...
    public UpdateApiResponse withApiGatewayManaged(java.util.Map<String, Object> apiGatewayManaged) {
    ...
    public UpdateApiResponse withApiId(java.util.Map<String, Object> apiId) {
        this.apiId = apiId;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
    ...
    public UpdateApiResponse withApiKeySelectionExpression(java.util.Map<String, Object> apiKeySelectionExpression) {
    ...
    public UpdateApiResponse withCreatedDate(java.util.Map<String, Object> createdDate) {
    ...
    public UpdateApiResponse withDescription(java.util.Map<String, Object> description) {
    ...
    public UpdateApiResponse withDisableExecuteApiEndpoint(java.util.Map<String, Object> disableExecuteApiEndpoint) {
    ...
    public UpdateApiResponse withDisableSchemaValidation(java.util.Map<String, Object> disableSchemaValidation) {
    ...
    public UpdateApiResponse withImportInfo(java.util.Map<String, Object> importInfo) {
    ...
    public UpdateApiResponse withName(java.util.Map<String, Object> name) {
        this.name = name;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
    ...
    public UpdateApiResponse withProtocolType(java.util.Map<String, Object> protocolType) {
    ...
    public UpdateApiResponse withRouteSelectionExpression(java.util.Map<String, Object> routeSelectionExpression) {
    ...
    public UpdateApiResponse withVersion(java.util.Map<String, Object> version) {
    ...
    public UpdateApiResponse withWarnings(java.util.Map<String, Object> warnings) {
