...
type DisableRegionHeaders struct {
...
type DisableRegionRequestBody struct {
...
type DisableRegionRequest struct {
	Headers DisableRegionHeaders
	Request DisableRegionRequestBody `request:"mediaType=application/json"`
}

type DisableRegionResponse struct {
