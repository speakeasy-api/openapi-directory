...
class GETDebitMemosStatusEnum(str, Enum):
...
class GETDebitMemosRequest:
    ...
    r"""This parameter filters the response based on the `balance` field."""  
    ...
    r"""This parameter filters the response based on the `beAppliedAmount` field."""  
    ...
    r"""This parameter filters the response based on the `debitMemoDate` field."""  
    due_date: Optional[date] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'dueDate', 'style': 'form', 'explode': True }})
    r"""This parameter filters the response based on the `dueDate` field."""  
    ...
    *field_name* indicates the name of a sortable field. The supported sortable fields of this operation are as below:
    ...
    """  
    status: Optional[GETDebitMemosStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'status', 'style': 'form', 'explode': True }})
    r"""This parameter filters the response based on the `status` field."""  
