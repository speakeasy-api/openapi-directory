...
func (s *userRateLimit) GetUserRateLimits(ctx context.Context, request operations.GetUserRateLimitsRequest, security operations.GetUserRateLimitsSecurity) (*operations.GetUserRateLimitsResponse, error) {
	baseURL := s.serverURL
