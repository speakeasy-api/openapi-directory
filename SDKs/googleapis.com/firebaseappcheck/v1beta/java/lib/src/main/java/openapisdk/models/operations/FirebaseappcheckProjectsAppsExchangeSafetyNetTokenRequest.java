...
public class FirebaseappcheckProjectsAppsExchangeSafetyNetTokenRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest request;
    public FirebaseappcheckProjectsAppsExchangeSafetyNetTokenRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest request) {
