 ...
 */
export declare enum VpnGatewaysScopedListWarningCodeEnum {
...
export declare class VpnGatewaysScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class VpnGatewaysScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class VpnGatewaysScopedList extends SpeakeasyBase {
    /**
