...
func main() {
    ...
    res, err := s.SDK.AllStars(ctx, operations.AllStarsRequest{
...
func main() {
    ...
    res, err := s.SDK.PlayerDetailsByFreeAgent(ctx, operations.PlayerDetailsByFreeAgentRequest{
        Format: operations.PlayerDetailsByFreeAgentFormatEnumXML,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.PlayerGameLogsBySeason(ctx, operations.PlayerGameLogsBySeasonRequest{
        Format: operations.PlayerGameLogsBySeasonFormatEnumJSON,
