...
class HybridTransaction:
    ...
    cleared: HybridTransactionClearedEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('cleared') }})
    ...
    type: HybridTransactionTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    ...
    flag_color: Optional[HybridTransactionFlagColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('flag_color') }})
    ...
    parent_transaction_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('parent_transaction_id') }})
