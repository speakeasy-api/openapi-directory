...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.CloseAccountRequest req = new CloseAccountRequest("tempora");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.CreateAccountRequest req = new CreateAccountRequest("voluptate") {{
                description = "reiciendis";
                payoutSchedule = CreateAccountRequestPayoutScheduleEnum.HOLD;
                payoutScheduleReason = "sit";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.UpdateAccountRequest req = new UpdateAccountRequest("non") {{
                description = "officiis";
                payoutSchedule = new UpdatePayoutScheduleRequest(UpdatePayoutScheduleRequestScheduleEnum.MONTHLY) {{
