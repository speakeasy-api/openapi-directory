...
class ApplyArchiveRuleRequest:
    headers: ApplyArchiveRuleHeaders = dataclasses.field()
    request: ApplyArchiveRuleRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
