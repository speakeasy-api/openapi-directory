...
public class Destiny2GetVendorsQueryParams {
    /**
    ...
    public Destiny2GetVendorsQueryParams withComponents(Integer[] components) {
    ...
    public Destiny2GetVendorsQueryParams withFilter(Integer filter) {
        this.filter = filter;
        return this;
    }
