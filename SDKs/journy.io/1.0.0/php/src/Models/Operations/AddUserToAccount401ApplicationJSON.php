...
class AddUserToAccount401ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\AddUserToAccount401ApplicationJSONMeta')]
    public AddUserToAccount401ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\AddUserToAccount401ApplicationJSONMeta();
	}
}
