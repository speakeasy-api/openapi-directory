...
var BatchCreateContactsRequestInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: contacttocreate_1.ContactToCreateInput }),
        (0, class_transformer_1.Expose)({ name: "contacts" }),
        (0, class_transformer_1.Type)(function () { return contacttocreate_1.ContactToCreateInput; }),
