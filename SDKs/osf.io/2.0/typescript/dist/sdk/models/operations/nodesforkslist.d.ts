 ...
 */
export declare enum NodesForksListNodeAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class NodesForksListNodeAttributes extends SpeakeasyBase {
    /**
     * The category of the node, as selected by project contributors.
     */
 ...
 */
export declare class NodesForksListNodeLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodesForksListNodeRelationships extends SpeakeasyBase {
    /**
...
export declare class NodesForksListNode extends SpeakeasyBase {
    /**
     * The properties of the node entity.
     */
