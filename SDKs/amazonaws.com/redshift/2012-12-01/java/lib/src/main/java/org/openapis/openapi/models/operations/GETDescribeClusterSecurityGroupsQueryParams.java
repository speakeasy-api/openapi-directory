...
public class GETDescribeClusterSecurityGroupsQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETDescribeClusterSecurityGroupsActionEnum action;
    public GETDescribeClusterSecurityGroupsQueryParams withAction(GETDescribeClusterSecurityGroupsActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETDescribeClusterSecurityGroupsQueryParams withClusterSecurityGroupName(String clusterSecurityGroupName) {
    ...
    public GETDescribeClusterSecurityGroupsQueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public GETDescribeClusterSecurityGroupsQueryParams withMaxRecords(Long maxRecords) {
    ...
    public GETDescribeClusterSecurityGroupsQueryParams withTagKeys(String[] tagKeys) {
    ...
    public GETDescribeClusterSecurityGroupsQueryParams withTagValues(String[] tagValues) {
    ...
    public GETDescribeClusterSecurityGroupsQueryParams withVersion(GETDescribeClusterSecurityGroupsVersionEnum version) {
