...
class OBWriteDomesticScheduledConsentResponse5
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsentResponse5Data();
		$this->links = null;
		$this->meta = null;
