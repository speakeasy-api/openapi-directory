...
class Error429AISAdditionalErrors:
    ...
    code: shared_messagecode429_ais_enum.MessageCode429AISEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
...
class Error429AIS:
    ...
    additional_errors: Optional[list[Error429AISAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
