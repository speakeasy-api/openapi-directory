...
class SearchProjectOrganizationQueryParams:
    ...
    search_project_organization_organization_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_organization.organization_type', 'style': 'form', 'explode': True }})
    search_project_organization_status: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_organization.status', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchProjectOrganizationRequest:
    query_params: SearchProjectOrganizationQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectOrganizationResponse:
