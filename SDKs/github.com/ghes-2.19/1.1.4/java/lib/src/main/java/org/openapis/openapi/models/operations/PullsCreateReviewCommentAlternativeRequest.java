...
public class PullsCreateReviewCommentAlternativeRequest {
    ...
    public PullsCreateReviewCommentAlternativeRequest(@JsonProperty("RequestBody") PullsCreateReviewCommentAlternativeRequestBody requestBody, @JsonProperty("owner") String owner, @JsonProperty("pull_number") Long pullNumber, @JsonProperty("repo") String repo) {
        this.requestBody = requestBody;
        this.owner = owner;
        this.pullNumber = pullNumber;
        this.repo = repo;
