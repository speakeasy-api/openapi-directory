...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-comment-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-hooks-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-issues-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-milestone-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-organization-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-pages-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-pull-requests-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-repository-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-users-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.22/rest/reference/enterprise-admin#get-gist-statistics - API method documentation
func (s *enterpriseAdmin) GetEnterpriseStatsGists(ctx context.Context) (*operations.GetEnterpriseStatsGistsResponse, error) {
	baseURL := s.serverURL
	...
	res := &operations.GetEnterpriseStatsGistsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
