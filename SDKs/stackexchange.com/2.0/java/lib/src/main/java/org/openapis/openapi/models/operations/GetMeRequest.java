...
public class GetMeRequest {
    ...
    public GetMeRequest withCallback(String callback) {
    ...
    public GetMeRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeRequest withFromdate(Long fromdate) {
    ...
    public GetMeRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetMeRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetMeRequest withOrder(GetMeOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetMeRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeRequest withPagesize(Long pagesize) {
    ...
    public GetMeRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetMeRequest withSort(GetMeSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetMeRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetMeRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
