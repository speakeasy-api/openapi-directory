...
class DeleteTaskSetRequest:
    headers: DeleteTaskSetHeaders = dataclasses.field()
    request: shared_deletetasksetrequest.DeleteTaskSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
