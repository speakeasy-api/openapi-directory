...
exports.WebhookTests = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var WebhookTests = /** @class */ (function () {
    function WebhookTests(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    WebhookTests.prototype.createNetworkWebhooksWebhookTest = function (req, config) {
        var _a;
    ...
    **/
    WebhookTests.prototype.getNetworkWebhooksWebhookTest = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.WebhookTests = WebhookTests;
