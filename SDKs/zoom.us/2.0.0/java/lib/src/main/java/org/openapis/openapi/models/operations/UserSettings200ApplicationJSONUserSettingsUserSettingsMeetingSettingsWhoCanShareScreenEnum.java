 ...
 * 
 */
public enum UserSettings200ApplicationJSONUserSettingsUserSettingsMeetingSettingsWhoCanShareScreenEnum {
    HOST("host"),
    ALL("all");
    ...
    private UserSettings200ApplicationJSONUserSettingsUserSettingsMeetingSettingsWhoCanShareScreenEnum(String value) {
        this.value = value;
    }
}
