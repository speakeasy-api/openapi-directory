...
class CreateRecommenderConfigurationRequestBody:
    ...
    create_recommender_configuration: CreateRecommenderConfigurationRequestBodyCreateRecommenderConfiguration = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreateRecommenderConfiguration') }})
    r"""Specifies Amazon Pinpoint configuration settings for retrieving and processing recommendation data from a recommender model."""  
...
class CreateRecommenderConfigurationRequest:
    ...
    request_body: CreateRecommenderConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
