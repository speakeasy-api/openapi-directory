...
class DataPointsGetHitsRequest:
    ...
    timeframe: DataPointsGetHitsTimeframeEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'timeframe', 'style': 'form', 'explode': True }})
    r"""Timeframe of the request. See list at $timeframeList"""  
    filter: Optional[DataPointsGetHitsFilterEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'form', 'explode': True }})
    r"""Filter event type (\\"spiders\\"/\\"uniques\\"/\\"nonuniques\\"/\\"conversions\\")"""  
