 ...
 */
public enum Webinar200ApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private Webinar200ApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
