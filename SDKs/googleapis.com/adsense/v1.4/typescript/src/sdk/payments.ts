...
export class Payments {
  ...
  adsensePaymentsList(
    ...
    security: operations.AdsensePaymentsListSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensePaymentsListSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AdsensePaymentsListResponse =
        new operations.AdsensePaymentsListResponse({
