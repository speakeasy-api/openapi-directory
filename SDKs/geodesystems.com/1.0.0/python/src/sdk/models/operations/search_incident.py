...
class SearchIncidentQueryParams:
    ...
    search_incident_cause: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.incident.cause', 'style': 'form', 'explode': True }})
    search_incident_incidenttype: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.incident.incidenttype', 'style': 'form', 'explode': True }})
    search_incident_state: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.incident.state', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchIncidentRequest:
    query_params: SearchIncidentQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchIncidentResponse:
