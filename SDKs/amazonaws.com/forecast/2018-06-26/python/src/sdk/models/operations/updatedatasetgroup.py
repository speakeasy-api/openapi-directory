...
class UpdateDatasetGroupRequest:
    ...
    update_dataset_group_request: shared_updatedatasetgrouprequest.UpdateDatasetGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
