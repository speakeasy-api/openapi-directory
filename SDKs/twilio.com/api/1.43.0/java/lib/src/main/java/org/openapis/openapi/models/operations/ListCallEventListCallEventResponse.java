...
public class ListCallEventListCallEventResponse {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("events")
    public org.openapis.openapi.models.shared.ApiV2010AccountCallCallEvent[] events;

    public ListCallEventListCallEventResponse withEvents(org.openapis.openapi.models.shared.ApiV2010AccountCallCallEvent[] events) {
        this.events = events;
        return this;
    }
    ...
    public ListCallEventListCallEventResponse(){}
}
