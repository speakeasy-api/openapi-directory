...
var Token = /** @class */ (function () {
    ...
    **/
    Token.prototype.createToken = function (req, config) {
        var _a;
    ...
    **/
    Token.prototype.deleteToken = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Token.prototype.getToken = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Token.prototype.listTokens = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
