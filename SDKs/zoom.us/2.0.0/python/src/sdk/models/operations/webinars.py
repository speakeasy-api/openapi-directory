...
class WebinarsPathParams:
    user_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'userId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class WebinarsQueryParams:
...
class WebinarsUserList:
    ...
    webinars: Optional[list[WebinarsUserListWebinars]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('webinars') }})
    

@dataclasses.dataclass
class WebinarsRequest:
    path_params: WebinarsPathParams = dataclasses.field()
    query_params: WebinarsQueryParams = dataclasses.field()
    security: WebinarsSecurity = dataclasses.field()
