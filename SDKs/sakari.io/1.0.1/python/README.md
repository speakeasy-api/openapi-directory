...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/sakari.io/1.0.1/python
```
...
* `contacts_create_json` - Create contact
* `contacts_create_string` - Create contact
...
* `tools_share_file_multipart` - Share file - use to host a file and generate a short link to be used directly in a message or as a link to media for a MMS
* `tools_share_file_raw` - Share file - use to host a file and generate a short link to be used directly in a message or as a link to media for a MMS
