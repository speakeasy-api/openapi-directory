...
type DfareportingAdvertiserInvoicesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DfareportingAdvertiserInvoicesListPathParams struct {
...
type DfareportingAdvertiserInvoicesListQueryParams struct {
	// V1 error format.
...
type DfareportingAdvertiserInvoicesListRequest struct {
...
type DfareportingAdvertiserInvoicesListResponse struct {
	// Successful response
