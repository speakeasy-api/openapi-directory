...
export class TeamsUpdatePermissionsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export enum TeamsUpdatePermissionsRequestBodyPermissionsEnum {
  Manager = "manager",
  Developer = "developer",
  Viewer = "viewer",
}

export class TeamsUpdatePermissionsRequestBody extends SpeakeasyBase {
  /**
...
export class TeamsUpdatePermissionsRequest extends SpeakeasyBase {
...
export enum TeamsUpdatePermissionsDefaultApplicationJSONErrorCodeEnum {
...
export class TeamsUpdatePermissionsDefaultApplicationJSONError extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
 ...
 * Error
 */
export class TeamsUpdatePermissionsDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => TeamsUpdatePermissionsDefaultApplicationJSONError)
  error: TeamsUpdatePermissionsDefaultApplicationJSONError;
}

export class TeamsUpdatePermissions200ApplicationJSONAzureSubscription extends SpeakeasyBase {
  /**
...
export enum TeamsUpdatePermissions200ApplicationJSONMemberPermissionsEnum {
  Manager = "manager",
  Developer = "developer",
  Viewer = "viewer",
  Tester = "tester",
 ...
 */
export enum TeamsUpdatePermissions200ApplicationJSONOriginEnum {
  Appcenter = "appcenter",
  Hockeyapp = "hockeyapp",
  Codepush = "codepush",
}
 ...
 */
export enum TeamsUpdatePermissions200ApplicationJSONOsEnum {
  Android = "Android",
  IOS = "iOS",
  MacOS = "macOS",
  Tizen = "Tizen",
 ...
 */
export enum TeamsUpdatePermissions200ApplicationJSONOwnerTypeEnum {
  Org = "org",
  User = "user",
}
 ...
 */
export class TeamsUpdatePermissions200ApplicationJSONOwner extends SpeakeasyBase {
  /**
 ...
 */
export enum TeamsUpdatePermissions200ApplicationJSONPlatformEnum {
  Java = "Java",
...
export enum TeamsUpdatePermissions200ApplicationJSONTeamPermissionsEnum {
  Manager = "manager",
  Developer = "developer",
  Viewer = "viewer",
}
 ...
 * Success
 */
export class TeamsUpdatePermissions200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @Type(() => TeamsUpdatePermissions200ApplicationJSONAzureSubscription)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "owner" })
  @Type(() => TeamsUpdatePermissions200ApplicationJSONOwner)
...
export class TeamsUpdatePermissionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
