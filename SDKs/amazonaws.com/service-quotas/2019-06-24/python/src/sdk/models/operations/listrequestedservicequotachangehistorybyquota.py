...
class ListRequestedServiceQuotaChangeHistoryByQuotaRequest:
    ...
    list_requested_service_quota_change_history_by_quota_request: shared_listrequestedservicequotachangehistorybyquotarequest.ListRequestedServiceQuotaChangeHistoryByQuotaRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
