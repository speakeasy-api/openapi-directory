...
try {
    ...
    $request->certificateParameters->degree = 'BACHELOR OF ENGINEERING,BACHELOR OF COMPUTER APPLICATIONS,BACHELOR OF JOURNALISM,BACHELOR OF BUSINES';
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->rroll = 'I086010055';
