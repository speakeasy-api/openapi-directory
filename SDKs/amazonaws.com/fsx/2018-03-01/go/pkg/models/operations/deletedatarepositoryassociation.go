...
type DeleteDataRepositoryAssociationHeaders struct {
...
type DeleteDataRepositoryAssociationRequest struct {
	Headers DeleteDataRepositoryAssociationHeaders
	Request shared.DeleteDataRepositoryAssociationRequest `request:"mediaType=application/json"`
}
