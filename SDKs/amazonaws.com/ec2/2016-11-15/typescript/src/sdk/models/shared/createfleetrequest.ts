 ...
 */
export enum CreateFleetRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateFleetRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateFleetRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateFleetRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateFleetRequestTagSpecificationsTags })
...
export class CreateFleetRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: FleetLaunchTemplateConfigListRequest })
  ...
  @SpeakeasyMetadata({ elemType: CreateFleetRequestTagSpecifications })
