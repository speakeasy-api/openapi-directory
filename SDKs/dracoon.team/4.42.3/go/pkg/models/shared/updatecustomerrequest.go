...
func (e UpdateCustomerRequestCustomerContractTypeEnum) ToPointer() *UpdateCustomerRequestCustomerContractTypeEnum {
	return &e
}
...
func (e *UpdateCustomerRequestCustomerContractTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "free":
		fallthrough
	case "pay":
		*e = UpdateCustomerRequestCustomerContractTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateCustomerRequestCustomerContractTypeEnum: %v", v)
	}
}
