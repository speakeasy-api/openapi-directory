...
class ClassroomUserProfilesGuardianInvitationsListRequest:
    ...
    r"""The ID of the student whose guardian invitations are to be returned. The identifier can be one of the following: * the numeric identifier for the user * the email address of the user * the string literal `\\"me\\"`, indicating the requesting user * the string literal `\\"-\\"`, indicating that results should be returned for all students that the requesting user is permitted to view guardian invitations."""  
    ...
    r"""If specified, only results with the specified `invited_email_address` are returned."""  
    ...
    r"""If specified, only results with the specified `state` values are returned. Otherwise, results with a `state` of `PENDING` are returned."""  
