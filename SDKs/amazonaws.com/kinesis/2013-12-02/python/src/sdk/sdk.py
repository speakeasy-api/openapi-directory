...
__doc__ = """ SDK Documentation: https://docs.aws.amazon.com/kinesis/ - Amazon Web Services documentation"""
import requests
...
class SDK:
    r"""SDK Documentation: https://docs.aws.amazon.com/kinesis/ - Amazon Web Services documentation"""
    ...
    def add_tags_to_stream(self, request: operations.AddTagsToStreamRequest) -> operations.AddTagsToStreamResponse:
        ...
        res = operations.AddTagsToStreamResponse(status_code=r.status_code, content_type=content_type)
    ...
    def create_stream(self, request: operations.CreateStreamRequest) -> operations.CreateStreamResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.CreateStream"
    ...
    def decrease_stream_retention_period(self, request: operations.DecreaseStreamRetentionPeriodRequest) -> operations.DecreaseStreamRetentionPeriodResponse:
        r"""<p>Decreases the Kinesis data stream's retention period, which is the length of time data records are accessible after they are added to the stream. The minimum value of a stream's retention period is 24 hours.</p> <p>This operation may result in lost data. For example, if the stream's retention period is 48 hours and is decreased to 24 hours, any data already in the stream that is older than 24 hours is inaccessible.</p>
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.DecreaseStreamRetentionPeriod"
        ...
        res = operations.DecreaseStreamRetentionPeriodResponse(status_code=r.status_code, content_type=content_type)
    ...
    def deregister_stream_consumer(self, request: operations.DeregisterStreamConsumerRequest) -> operations.DeregisterStreamConsumerResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.DeregisterStreamConsumer"
        ...
        res = operations.DeregisterStreamConsumerResponse(status_code=r.status_code, content_type=content_type)
    ...
    def describe_limits(self, request: operations.DescribeLimitsRequest) -> operations.DescribeLimitsResponse:
        r"""<p>Describes the shard limits and usage for the account.</p> <p>If you update your account limits, the old limits might be returned for a few minutes.</p> <p>This operation has a limit of one transaction per second per account.</p>
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.DescribeLimits"
        ...
        res = operations.DescribeLimitsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeLimitsOutput])
    ...
    def describe_stream(self, request: operations.DescribeStreamRequest) -> operations.DescribeStreamResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.DescribeStream"
    ...
    def describe_stream_consumer(self, request: operations.DescribeStreamConsumerRequest) -> operations.DescribeStreamConsumerResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.DescribeStreamConsumer"
        ...
        res = operations.DescribeStreamConsumerResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeStreamConsumerOutput])
                res.describe_stream_consumer_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.limit_exceeded_exception = out
    ...
    def describe_stream_summary(self, request: operations.DescribeStreamSummaryRequest) -> operations.DescribeStreamSummaryResponse:
        r"""<p>Provides a summarized description of the specified Kinesis data stream without the shard list.</p> <p>The information returned includes the stream name, Amazon Resource Name (ARN), status, record retention period, approximate creation time, monitoring, encryption details, and open shard count. </p> <p> <a>DescribeStreamSummary</a> has a limit of 20 transactions per second per account.</p>
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.DescribeStreamSummary"
        ...
        res = operations.DescribeStreamSummaryResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeStreamSummaryOutput])
                res.describe_stream_summary_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def disable_enhanced_monitoring(self, request: operations.DisableEnhancedMonitoringRequest) -> operations.DisableEnhancedMonitoringResponse:
        r"""Disables enhanced monitoring.
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.DisableEnhancedMonitoring"
        ...
        res = operations.DisableEnhancedMonitoringResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EnhancedMonitoringOutput])
                res.enhanced_monitoring_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_argument_exception = out
    ...
    def enable_enhanced_monitoring(self, request: operations.EnableEnhancedMonitoringRequest) -> operations.EnableEnhancedMonitoringResponse:
        r"""Enables enhanced Kinesis data stream monitoring for shard-level metrics.
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.EnableEnhancedMonitoring"
        ...
        res = operations.EnableEnhancedMonitoringResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_records(self, request: operations.GetRecordsRequest) -> operations.GetRecordsResponse:
        ...
        res = operations.GetRecordsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetRecordsOutput])
    ...
    def get_shard_iterator(self, request: operations.GetShardIteratorRequest) -> operations.GetShardIteratorResponse:
        ...
        res = operations.GetShardIteratorResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetShardIteratorOutput])
    ...
    def increase_stream_retention_period(self, request: operations.IncreaseStreamRetentionPeriodRequest) -> operations.IncreaseStreamRetentionPeriodResponse:
        ...
        res = operations.IncreaseStreamRetentionPeriodResponse(status_code=r.status_code, content_type=content_type)
    ...
    def list_shards(self, request: operations.ListShardsRequest) -> operations.ListShardsResponse:
        ...
        res = operations.ListShardsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListShardsOutput])
                res.list_shards_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def list_stream_consumers(self, request: operations.ListStreamConsumersRequest) -> operations.ListStreamConsumersResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.ListStreamConsumers"
        ...
        res = operations.ListStreamConsumersResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListStreamConsumersOutput])
                res.list_stream_consumers_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def list_streams(self, request: operations.ListStreamsRequest) -> operations.ListStreamsResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.ListStreams"
    ...
    def list_tags_for_stream(self, request: operations.ListTagsForStreamRequest) -> operations.ListTagsForStreamResponse:
        r"""Lists the tags for the specified Kinesis data stream. This operation has a limit of five transactions per second per account.
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.ListTagsForStream"
    ...
    def merge_shards(self, request: operations.MergeShardsRequest) -> operations.MergeShardsResponse:
        ...
        res = operations.MergeShardsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def put_record(self, request: operations.PutRecordRequest) -> operations.PutRecordResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.PutRecord"
    ...
    def put_records(self, request: operations.PutRecordsRequest) -> operations.PutRecordsResponse:
        ...
        res = operations.PutRecordsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutRecordsOutput])
                res.put_records_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def register_stream_consumer(self, request: operations.RegisterStreamConsumerRequest) -> operations.RegisterStreamConsumerResponse:
        r"""<p>Registers a consumer with a Kinesis data stream. When you use this operation, the consumer you register can then call <a>SubscribeToShard</a> to receive data from the stream using enhanced fan-out, at a rate of up to 2 MiB per second for every shard you subscribe to. This rate is unaffected by the total number of consumers that read from the same stream.</p> <p>You can register up to 20 consumers per stream. A given consumer can only be registered with one stream at a time.</p> <p>For an example of how to use this operations, see <a href=\"/streams/latest/dev/building-enhanced-consumers-api.html\">Enhanced Fan-Out Using the Kinesis Data Streams API</a>.</p> <p>The use of this operation has a limit of five transactions per second per account. Also, only 5 consumers can be created simultaneously. In other words, you cannot have more than 5 consumers in a <code>CREATING</code> status at the same time. Registering a 6th consumer while there are 5 in a <code>CREATING</code> status results in a <code>LimitExceededException</code>.</p>
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.RegisterStreamConsumer"
        ...
        res = operations.RegisterStreamConsumerResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RegisterStreamConsumerOutput])
                res.register_stream_consumer_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_argument_exception = out
    ...
    def remove_tags_from_stream(self, request: operations.RemoveTagsFromStreamRequest) -> operations.RemoveTagsFromStreamResponse:
        r"""<p>Removes tags from the specified Kinesis data stream. Removed tags are deleted and cannot be recovered after this operation successfully completes.</p> <p>If you specify a tag that does not exist, it is ignored.</p> <p> <a>RemoveTagsFromStream</a> has a limit of five transactions per second per account.</p>
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.RemoveTagsFromStream"
        ...
        res = operations.RemoveTagsFromStreamResponse(status_code=r.status_code, content_type=content_type)
    ...
    def split_shard(self, request: operations.SplitShardRequest) -> operations.SplitShardResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.SplitShard"
        ...
        res = operations.SplitShardResponse(status_code=r.status_code, content_type=content_type)
    ...
    def start_stream_encryption(self, request: operations.StartStreamEncryptionRequest) -> operations.StartStreamEncryptionResponse:
        ...
        url = base_url.removesuffix("/") + "/#X-Amz-Target=Kinesis_20131202.StartStreamEncryption"
        ...
        res = operations.StartStreamEncryptionResponse(status_code=r.status_code, content_type=content_type)
    ...
    def stop_stream_encryption(self, request: operations.StopStreamEncryptionRequest) -> operations.StopStreamEncryptionResponse:
        ...
        res = operations.StopStreamEncryptionResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_shard_count(self, request: operations.UpdateShardCountRequest) -> operations.UpdateShardCountResponse:
        ...
        res = operations.UpdateShardCountResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateShardCountOutput])
                res.update_shard_count_output = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_argument_exception = out
