...
export class RunProjectsLocationsServicesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsServicesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsServicesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
