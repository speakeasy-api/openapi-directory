...
var BaseFirewallRule = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destination_any" }),
        __metadata("design:type", Boolean)
    ], BaseFirewallRule.prototype, "destinationAny", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destination_inversion" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rule_id" }),
        __metadata("design:type", String)
    ], BaseFirewallRule.prototype, "ruleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=section_id" }),
        __metadata("design:type", String)
    ], BaseFirewallRule.prototype, "sectionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=section_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=service_any" }),
        __metadata("design:type", Boolean)
    ], BaseFirewallRule.prototype, "serviceAny", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=services", elemType: reference_1.Reference }),
        __metadata("design:type", Array)
    ], BaseFirewallRule.prototype, "services", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=source_any" }),
        __metadata("design:type", Boolean)
    ], BaseFirewallRule.prototype, "sourceAny", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=source_inversion" }),
        __metadata("design:type", Boolean)
