...
var Parcels = /** @class */ (function () {
    function Parcels(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Parcels.prototype.getParcelsPidsSiteIdOutputFormat = function (req, config) {
