...
exports.PostOwnershipInstallResponse = exports.PostOwnershipInstallRequest = void 0;
...
var PostOwnershipInstallRequest = /** @class */ (function (_super) {
    ...
    ], PostOwnershipInstallRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=customData",
        }),
        __metadata("design:type", String)
    ], PostOwnershipInstallRequest.prototype, "customData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=model" }),
        __metadata("design:type", String)
    ], PostOwnershipInstallRequest.prototype, "model", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=modelId",
        }),
        __metadata("design:type", String)
    ], PostOwnershipInstallRequest.prototype, "modelId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userId",
        }),
        __metadata("design:type", String)
    ], PostOwnershipInstallRequest.prototype, "userId", void 0);
...
var PostOwnershipInstallResponse = /** @class */ (function (_super) {
    ...
    ], PostOwnershipInstallResponse.prototype, "rawResponse", void 0);
