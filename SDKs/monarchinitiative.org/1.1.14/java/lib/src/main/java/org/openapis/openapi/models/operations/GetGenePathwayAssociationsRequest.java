...
public class GetGenePathwayAssociationsRequest {
    ...
    public GetGenePathwayAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGenePathwayAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGenePathwayAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenePathwayAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGenePathwayAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGenePathwayAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withRelation(String relation) {
    ...
    public GetGenePathwayAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGenePathwayAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenePathwayAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGenePathwayAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
