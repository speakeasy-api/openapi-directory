...
export class ItemsAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ItemsAllRequest extends SpeakeasyBase {
  /**
...
export class ItemsAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
