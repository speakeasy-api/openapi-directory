...
export class ServiceusageServicesBatchEnableSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServiceusageServicesBatchEnableSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServiceusageServicesBatchEnableSecurity extends SpeakeasyBase {
...
export class ServiceusageServicesBatchEnableRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServiceusageServicesBatchEnableResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
