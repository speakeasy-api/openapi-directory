...
class UpdateNetworkSwitchSettingsQosRuleRequestBodyProtocolEnum(str, Enum):
...
class UpdateNetworkSwitchSettingsQosRuleRequestBody:
    ...
    r"""DSCP tag that should be assigned to incoming packet. Set this to -1 to trust incoming DSCP. Default value is 0."""  
    ...
    protocol: Optional[UpdateNetworkSwitchSettingsQosRuleRequestBodyProtocolEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""The protocol of the incoming packet. Can be one of \\"ANY\\", \\"TCP\\" or \\"UDP\\". Default value is \\"ANY\\"."""  
...
class UpdateNetworkSwitchSettingsQosRuleRequest:
    ...
    request_body: Optional[UpdateNetworkSwitchSettingsQosRuleRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateNetworkSwitchSettingsQosRuleResponse:
    ...
    update_network_switch_settings_qos_rule_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
