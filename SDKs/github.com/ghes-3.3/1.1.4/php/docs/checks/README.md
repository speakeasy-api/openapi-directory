...
try {
    ...
    $request->requestBody->headSha = 'quibusdam';
    $request->owner = 'illum';
    $request->repo = 'sequi';
...
try {
    ...
    $request->appId = 753570;
    $request->checkName = 'ducimus';
...
try {
    ...
    $request->checkName = 'possimus';
    $request->checkSuiteId = 297842;
...
try {
    ...
    $request->appId = 97844;
    $request->checkName = 'ex';
    $request->owner = 'nulla';
    $request->page = 569211;
    $request->perPage = 972920;
    $request->ref = 'nostrum';
