...
func (e *CreateTrunkCreateTrunkRequestDisasterRecoveryMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateTrunkCreateTrunkRequestDisasterRecoveryMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateTrunkCreateTrunkRequestDisasterRecoveryMethodEnum: %s", s)
	}
}
