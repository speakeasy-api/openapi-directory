...
class BooksPersonalizedstreamGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksPersonalizedstreamGetMaxAllowedMaturityRatingEnum $maxAllowedMaturityRating
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=maxAllowedMaturityRating')]
    public ?BooksPersonalizedstreamGetMaxAllowedMaturityRatingEnum $maxAllowedMaturityRating = null;
