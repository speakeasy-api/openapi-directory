...
public class GetSigningBasketRequest {
    ...
    public GetSigningBasketRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public GetSigningBasketRequest withPSUAccept(String psuAccept) {
    ...
    public GetSigningBasketRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public GetSigningBasketRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetSigningBasketRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetSigningBasketRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public GetSigningBasketRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public GetSigningBasketRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public GetSigningBasketRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public GetSigningBasketRequest withPSUIPPort(String psuIPPort) {
    ...
    public GetSigningBasketRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public GetSigningBasketRequest withSignature(String signature) {
    ...
    public GetSigningBasketRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetSigningBasketRequest withXRequestID(String xRequestID) {
    ...
    public GetSigningBasketRequest withBasketId(String basketId) {
        this.basketId = basketId;
        return this;
    }
    
    public GetSigningBasketRequest(@JsonProperty("X-Request-ID") String xRequestID, @JsonProperty("basketId") String basketId) {
        this.xRequestID = xRequestID;
        this.basketId = basketId;
  }
}
