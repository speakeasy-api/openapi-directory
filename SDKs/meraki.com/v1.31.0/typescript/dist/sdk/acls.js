...
var Acls = /** @class */ (function () {
    function Acls(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Creates new adaptive policy ACL
     */
    Acls.prototype.createOrganizationAdaptivePolicyAcl = function (req, config) {
        var _a;
     ...
     */
    Acls.prototype.deleteOrganizationAdaptivePolicyAcl = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Returns the adaptive policy ACL information
     */
    Acls.prototype.getOrganizationAdaptivePolicyAcl = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List adaptive policy ACLs in a organization
     */
    Acls.prototype.getOrganizationAdaptivePolicyAcls = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Updates an adaptive policy ACL
     */
    Acls.prototype.updateOrganizationAdaptivePolicyAcl = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
