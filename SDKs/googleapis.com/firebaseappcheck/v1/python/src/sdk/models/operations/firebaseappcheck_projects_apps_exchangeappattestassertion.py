...
class FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest:
    ...
    google_firebase_appcheck_v1_exchange_app_attest_assertion_request: Optional[shared_googlefirebaseappcheckv1exchangeappattestassertionrequest.GoogleFirebaseAppcheckV1ExchangeAppAttestAssertionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
