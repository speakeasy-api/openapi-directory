...
class GetDisassociateClientVpnTargetNetworkQueryParams:
    action: GetDisassociateClientVpnTargetNetworkActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDisassociateClientVpnTargetNetworkVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisassociateClientVpnTargetNetworkRequest:
    headers: GetDisassociateClientVpnTargetNetworkHeaders = dataclasses.field()
    query_params: GetDisassociateClientVpnTargetNetworkQueryParams = dataclasses.field()
