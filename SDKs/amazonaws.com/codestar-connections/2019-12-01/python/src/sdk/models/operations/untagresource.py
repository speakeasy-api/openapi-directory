...
class UntagResourceXAmzTargetEnum(str, Enum):
    COM_AMAZONAWS_CODESTAR_CONNECTIONS_CODE_STAR_CONNECTIONS_20191201_UNTAG_RESOURCE = "com.amazonaws.codestar.connections.CodeStar_connections_20191201.UntagResource"
