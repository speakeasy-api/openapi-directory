...
class BooksMylibraryBookshelvesAddVolumeRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksMylibraryBookshelvesAddVolumeReasonEnum $reason
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=reason')]
    public ?BooksMylibraryBookshelvesAddVolumeReasonEnum $reason = null;
