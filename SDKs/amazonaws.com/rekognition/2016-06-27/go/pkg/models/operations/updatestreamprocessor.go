...
type UpdateStreamProcessorHeaders struct {
...
type UpdateStreamProcessorRequest struct {
	Headers UpdateStreamProcessorHeaders
	Request shared.UpdateStreamProcessorRequest `request:"mediaType=application/json"`
}
