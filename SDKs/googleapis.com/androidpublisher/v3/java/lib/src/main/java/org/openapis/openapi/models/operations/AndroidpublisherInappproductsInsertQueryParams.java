...
public class AndroidpublisherInappproductsInsertQueryParams {
    ...
    public AndroidpublisherInappproductsInsertQueryParams withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public AndroidpublisherInappproductsInsertQueryParams withAccessToken(String accessToken) {
    ...
    public AndroidpublisherInappproductsInsertQueryParams withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public AndroidpublisherInappproductsInsertQueryParams withCallback(String callback) {
    ...
    public AndroidpublisherInappproductsInsertQueryParams withUploadType(String uploadType) {
    ...
    public AndroidpublisherInappproductsInsertQueryParams withUploadProtocol(String uploadProtocol) {
