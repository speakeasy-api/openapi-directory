...
class PostDescribeAlarmHistoryQueryParams:
    action: PostDescribeAlarmHistoryActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeAlarmHistoryVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeAlarmHistoryRequest:
    headers: PostDescribeAlarmHistoryHeaders = dataclasses.field()
    query_params: PostDescribeAlarmHistoryQueryParams = dataclasses.field()
