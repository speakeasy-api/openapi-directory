...
class RegisterToWorkMailRequest:
    headers: RegisterToWorkMailHeaders = dataclasses.field()
    request: shared_registertoworkmailrequest.RegisterToWorkMailRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
