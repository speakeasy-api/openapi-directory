...
from ..shared import secret_scanning_location as shared_secret_scanning_location
...
@dataclasses.dataclass
class SecretScanningListLocationsForAlert503ApplicationJSON:
...
class SecretScanningListLocationsForAlertResponse:
    ...
    secret_scanning_locations: Optional[list[shared_secret_scanning_location.SecretScanningLocation]] = dataclasses.field(default=None)
    r"""Response"""  
    secret_scanning_list_locations_for_alert_503_application_json_object: Optional[SecretScanningListLocationsForAlert503ApplicationJSON] = dataclasses.field(default=None)
    r"""Service unavailable"""  
