...
class RunProjectsLocationsServicesTestIamPermissionsRequest:
    path_params: RunProjectsLocationsServicesTestIamPermissionsPathParams = dataclasses.field()
    query_params: RunProjectsLocationsServicesTestIamPermissionsQueryParams = dataclasses.field()
    security: RunProjectsLocationsServicesTestIamPermissionsSecurity = dataclasses.field()
