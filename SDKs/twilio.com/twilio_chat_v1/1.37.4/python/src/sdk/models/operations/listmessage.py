...
class ListMessageListMessageResponse:
    messages: Optional[list[shared_chat_v1_service_channel_message.ChatV1ServiceChannelMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('messages') }})
