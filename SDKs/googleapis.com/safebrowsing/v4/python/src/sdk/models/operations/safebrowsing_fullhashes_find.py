...
class SafebrowsingFullHashesFindRequest:
    ...
    google_security_safebrowsing_v4_find_full_hashes_request: Optional[shared_googlesecuritysafebrowsingv4findfullhashesrequest.GoogleSecuritySafebrowsingV4FindFullHashesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
