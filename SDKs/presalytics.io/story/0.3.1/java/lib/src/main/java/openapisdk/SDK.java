...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.GetEnvironmentResponse getEnvironment() throws Exception {
    ...
    **/
    public openapisdk.models.operations.SpecNoTagsResponse specNoTags() throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/no_tags_spec");
        ...
        openapisdk.models.operations.SpecNoTagsResponse res = new openapisdk.models.operations.SpecNoTagsResponse() {{
            problemDetail = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
