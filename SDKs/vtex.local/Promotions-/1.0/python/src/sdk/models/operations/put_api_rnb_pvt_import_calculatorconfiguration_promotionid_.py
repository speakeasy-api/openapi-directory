...
class PutAPIRnbPvtImportCalculatorConfigurationPromotionIDRequest:
    ...
    promotion_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'promotionId', 'style': 'simple', 'explode': False }})
    r"""Promotion unique identifier."""  
...
@dataclasses.dataclass
class PutAPIRnbPvtImportCalculatorConfigurationPromotionIDResponse:
