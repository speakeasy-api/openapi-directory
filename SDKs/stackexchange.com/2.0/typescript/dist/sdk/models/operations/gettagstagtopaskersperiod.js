...
exports.GetTagsTagTopAskersPeriodResponse = exports.GetTagsTagTopAskersPeriodRequest = exports.GetTagsTagTopAskersPeriodPeriodEnum = void 0;
...
var GetTagsTagTopAskersPeriodRequest = /** @class */ (function (_super) {
    ...
    ], GetTagsTagTopAskersPeriodRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetTagsTagTopAskersPeriodRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetTagsTagTopAskersPeriodRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetTagsTagTopAskersPeriodRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=period",
        }),
        __metadata("design:type", String)
    ], GetTagsTagTopAskersPeriodRequest.prototype, "period", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetTagsTagTopAskersPeriodRequest.prototype, "site", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=tag" }),
        __metadata("design:type", String)
    ], GetTagsTagTopAskersPeriodRequest.prototype, "tag", void 0);
...
var GetTagsTagTopAskersPeriodResponse = /** @class */ (function (_super) {
    ...
    ], GetTagsTagTopAskersPeriodResponse.prototype, "rawResponse", void 0);
