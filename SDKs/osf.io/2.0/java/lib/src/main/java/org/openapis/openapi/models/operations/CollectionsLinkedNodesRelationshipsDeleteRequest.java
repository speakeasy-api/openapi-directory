...
public class CollectionsLinkedNodesRelationshipsDeleteRequest {
    ...
    public CollectionsLinkedNodesRelationshipsDeleteRequest(@JsonProperty("RequestBody") java.util.Map<String, Object> requestBody, @JsonProperty("collection_id") String collectionId) {
        this.requestBody = requestBody;
        this.collectionId = collectionId;
  }
}
