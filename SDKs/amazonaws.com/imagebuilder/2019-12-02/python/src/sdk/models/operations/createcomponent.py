...
class CreateComponentRequestBody:
    ...
    platform: CreateComponentRequestBodyPlatformEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('platform') }})
...
class CreateComponentRequest:
    headers: CreateComponentHeaders = dataclasses.field()
    request: CreateComponentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
