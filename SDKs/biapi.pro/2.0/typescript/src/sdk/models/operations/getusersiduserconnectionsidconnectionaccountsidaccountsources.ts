...
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountSourcesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 * sources
 */
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountSources200ApplicationJSON extends SpeakeasyBase {
...
export class GetUsersIdUserConnectionsIdConnectionAccountsIdAccountSourcesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
