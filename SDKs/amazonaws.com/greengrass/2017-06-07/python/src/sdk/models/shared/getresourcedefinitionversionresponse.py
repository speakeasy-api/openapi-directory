...
class GetResourceDefinitionVersionResponse:
    ...
    definition: Optional[shared_resourcedefinitionversion.ResourceDefinitionVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Definition'), 'exclude': lambda f: f is None }})  
