...
export class PostCertificatesIdActionsRetryActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PostCertificatesIdActionsRetryActionResponseActionError)
  ...
  @Type(() => PostCertificatesIdActionsRetryActionResponseActionResources)
...
export class PostCertificatesIdActionsRetryActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => PostCertificatesIdActionsRetryActionResponseAction)
