 ...
 */
export declare enum AcceleratorTypeAggregatedListWarningCodeEnum {
...
export declare class AcceleratorTypeAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class AcceleratorTypeAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class AcceleratorTypeAggregatedList extends SpeakeasyBase {
    /**
