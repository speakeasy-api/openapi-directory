...
var Ping = /** @class */ (function () {
    function Ping(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Enqueue a job to ping a target host from the device
     */
    Ping.prototype.createDeviceLiveToolsPing = function (req, config) {
        var _a;
     ...
     */
    Ping.prototype.getDeviceLiveToolsPing = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
