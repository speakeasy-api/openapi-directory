...
export class GetIndividualsPartyIdAddressesAddressIdRequest extends SpeakeasyBase {
  /**
...
export class GetIndividualsPartyIdAddressesAddressIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
