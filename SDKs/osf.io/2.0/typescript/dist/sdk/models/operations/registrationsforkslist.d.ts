...
export declare class RegistrationsForksListRequest extends SpeakeasyBase {
    /**
 ...
 */
export declare enum RegistrationsForksListRegistrationAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class RegistrationsForksListRegistrationAttributes extends SpeakeasyBase {
    /**
     * The category of the registered node.
     */
 ...
 */
export declare class RegistrationsForksListRegistrationLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegistrationsForksListRegistrationRelationships extends SpeakeasyBase {
    /**
...
export declare class RegistrationsForksListRegistration extends SpeakeasyBase {
    /**
     * The properties of the registration entity.
     */
...
export declare class RegistrationsForksListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
