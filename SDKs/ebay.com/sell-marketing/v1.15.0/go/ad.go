...
func (s *ad) BulkCreateAdsByInventoryReference(ctx context.Context, request operations.BulkCreateAdsByInventoryReferenceRequest, security operations.BulkCreateAdsByInventoryReferenceSecurity) (*operations.BulkCreateAdsByInventoryReferenceResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_create_ads_by_inventory_reference", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BulkCreateAdsByInventoryReferenceRequest", "json")
	if err != nil {
...
func (s *ad) BulkCreateAdsByListingID(ctx context.Context, request operations.BulkCreateAdsByListingIDRequest, security operations.BulkCreateAdsByListingIDSecurity) (*operations.BulkCreateAdsByListingIDResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_create_ads_by_listing_id", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BulkCreateAdRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) BulkDeleteAdsByInventoryReference(ctx context.Context, request operations.BulkDeleteAdsByInventoryReferenceRequest, security operations.BulkDeleteAdsByInventoryReferenceSecurity) (*operations.BulkDeleteAdsByInventoryReferenceResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_delete_ads_by_inventory_reference", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BulkDeleteAdsByInventoryReferenceRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) BulkDeleteAdsByListingID(ctx context.Context, request operations.BulkDeleteAdsByListingIDRequest, security operations.BulkDeleteAdsByListingIDSecurity) (*operations.BulkDeleteAdsByListingIDResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_delete_ads_by_listing_id", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BulkDeleteAdRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) BulkUpdateAdsBidByInventoryReference(ctx context.Context, request operations.BulkUpdateAdsBidByInventoryReferenceRequest, security operations.BulkUpdateAdsBidByInventoryReferenceSecurity) (*operations.BulkUpdateAdsBidByInventoryReferenceResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_update_ads_bid_by_inventory_reference", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *ad) BulkUpdateAdsBidByListingID(ctx context.Context, request operations.BulkUpdateAdsBidByListingIDRequest, security operations.BulkUpdateAdsBidByListingIDSecurity) (*operations.BulkUpdateAdsBidByListingIDResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_update_ads_bid_by_listing_id", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *ad) BulkUpdateAdsStatus(ctx context.Context, request operations.BulkUpdateAdsStatusRequest, security operations.BulkUpdateAdsStatusSecurity) (*operations.BulkUpdateAdsStatusResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_update_ads_status", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BulkUpdateAdStatusRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) BulkUpdateAdsStatusByListingID(ctx context.Context, request operations.BulkUpdateAdsStatusByListingIDRequest, security operations.BulkUpdateAdsStatusByListingIDSecurity) (*operations.BulkUpdateAdsStatusByListingIDResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/bulk_update_ads_status_by_listing_id", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BulkUpdateAdStatusByListingIDRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) CreateAdByListingID(ctx context.Context, request operations.CreateAdByListingIDRequest, security operations.CreateAdByListingIDSecurity) (*operations.CreateAdByListingIDResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/ad", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CreateAdRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) CreateAdsByInventoryReference(ctx context.Context, request operations.CreateAdsByInventoryReferenceRequest, security operations.CreateAdsByInventoryReferenceSecurity) (*operations.CreateAdsByInventoryReferenceResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/create_ads_by_inventory_reference", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CreateAdsByInventoryReferenceRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) DeleteAd(ctx context.Context, request operations.DeleteAdRequest, security operations.DeleteAdSecurity) (*operations.DeleteAdResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/ad/{ad_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *ad) DeleteAdsByInventoryReference(ctx context.Context, request operations.DeleteAdsByInventoryReferenceRequest, security operations.DeleteAdsByInventoryReferenceSecurity) (*operations.DeleteAdsByInventoryReferenceResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/delete_ads_by_inventory_reference", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeleteAdsByInventoryReferenceRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *ad) GetAd(ctx context.Context, request operations.GetAdRequest, security operations.GetAdSecurity) (*operations.GetAdResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/ad/{ad_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *ad) GetAds(ctx context.Context, request operations.GetAdsRequest, security operations.GetAdsSecurity) (*operations.GetAdsResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/ad", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *ad) GetAdsByInventoryReference(ctx context.Context, request operations.GetAdsByInventoryReferenceRequest, security operations.GetAdsByInventoryReferenceSecurity) (*operations.GetAdsByInventoryReferenceResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/get_ads_by_inventory_reference", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *ad) UpdateBid(ctx context.Context, request operations.UpdateBidRequest, security operations.UpdateBidSecurity) (*operations.UpdateBidResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/ad_campaign/{campaign_id}/ad/{ad_id}/update_bid", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateBidPercentageRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
