...
public class ListResourcesRequest {
    ...
    public ListResourcesRequest withEvAccessToken(String evAccessToken) {
    ...
    public ListResourcesRequest withEvApiKey(String evApiKey) {
    ...
    public ListResourcesRequest withInclude(String include) {
    ...
    public ListResourcesRequest withResource(String resource) {
    ...
    public String sort;
    public ListResourcesRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
