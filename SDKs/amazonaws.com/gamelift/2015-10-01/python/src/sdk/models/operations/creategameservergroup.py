...
class CreateGameServerGroupRequest:
    ...
    create_game_server_group_input: shared_creategameservergroupinput.CreateGameServerGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
