 ...
 */
export enum VpnGatewayAggregatedListWarningCodeEnum {
...
export class VpnGatewayAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class VpnGatewayAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnGatewayAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class VpnGatewayAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnGatewaysScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, VpnGatewaysScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], VpnGatewaysScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
