...
var billingsubpartnerapi_1 = require("./billingsubpartnerapi");
var paymentsapi_1 = require("./paymentsapi");
var payoutsapi_1 = require("./payoutsapi");
var recurringpaymentsapiemailsubscriptionsfeature_1 = require("./recurringpaymentsapiemailsubscriptionsfeature");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.billingSubPartnerAPI = new billingsubpartnerapi_1.BillingSubPartnerAPI(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.paymentsAPI = new paymentsapi_1.PaymentsAPI(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.payoutsAPI = new payoutsapi_1.PayoutsAPI(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.recurringPaymentsAPIEmailSubscriptionsFeature =
            new recurringpaymentsapiemailsubscriptionsfeature_1.RecurringPaymentsAPIEmailSubscriptionsFeature(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
