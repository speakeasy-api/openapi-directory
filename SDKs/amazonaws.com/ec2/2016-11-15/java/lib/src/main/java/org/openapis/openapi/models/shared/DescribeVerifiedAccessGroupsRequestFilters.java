...
public class DescribeVerifiedAccessGroupsRequestFilters {
    ...
    public DescribeVerifiedAccessGroupsRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeVerifiedAccessGroupsRequestFilters(){}
}
