...
exports.GETAllRecordsForCustomObjectTypeResponse = exports.GETAllRecordsForCustomObjectTypeRequest = void 0;
...
var GETAllRecordsForCustomObjectTypeRequest = /** @class */ (function (_super) {
    ...
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Zuora-Entity-Ids",
        }),
        __metadata("design:type", String)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "zuoraEntityIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Zuora-Track-Id",
        }),
        __metadata("design:type", String)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "zuoraTrackId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Zuora-Version;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "zuoraVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cursor",
        }),
        __metadata("design:type", String)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ids" }),
        __metadata("design:type", String)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "ids", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=object",
        }),
        __metadata("design:type", String)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "object", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q" }),
        __metadata("design:type", String)
    ], GETAllRecordsForCustomObjectTypeRequest.prototype, "q", void 0);
...
var GETAllRecordsForCustomObjectTypeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GETAllRecordsForCustomObjectTypeResponse.prototype, "rawResponse", void 0);
