...
type GetPublicationDiseaseAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetPublicationDiseaseAssociationsQueryParams struct {
