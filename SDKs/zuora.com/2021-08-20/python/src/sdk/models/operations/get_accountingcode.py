...
from ..shared import getaccountingcodeitemtype as shared_getaccountingcodeitemtype
...
class GETAccountingCodeRequest:
    ...
    r"""ID of the accounting code you want to query."""  
...
class GETAccountingCodeResponse:
    ...
    get_accounting_code_item_type: Optional[shared_getaccountingcodeitemtype.GETAccountingCodeItemType] = dataclasses.field(default=None)  
