...
class UpcomingScheduleByPlayerRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\UpcomingScheduleByPlayerFormatEnum $format
     */
	...
	{
		$this->format = \OpenAPI\OpenAPI\Models\Operations\UpcomingScheduleByPlayerFormatEnum::XML;
		$this->playerid = "";
	}
}
