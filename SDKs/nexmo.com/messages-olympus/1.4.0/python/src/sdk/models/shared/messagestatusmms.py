...
class MessageStatusMMSChannelEnum(str, Enum):
...
class MessageStatusMMSStatusEnum(str, Enum):
...
class MessageStatusMMSUsageCurrencyEnum(str, Enum):
...
class MessageStatusMMSUsage:
    ...
    currency: Optional[MessageStatusMMSUsageCurrencyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('currency'), 'exclude': lambda f: f is None }})
    r"""The charge currency in ISO 4217 format."""  
...
class MessageStatusMMS:
    ...
    channel: MessageStatusMMSChannelEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('channel') }})
    r"""The channel sending to."""  
    ...
    status: MessageStatusMMSStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""The status of the message."""  
    ...
    error: Optional[MessageStatusMMSError] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error'), 'exclude': lambda f: f is None }})
    r"""If the message encountered a problem a descriptive error will be supplied in this object."""  
    usage: Optional[MessageStatusMMSUsage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('usage'), 'exclude': lambda f: f is None }})  
