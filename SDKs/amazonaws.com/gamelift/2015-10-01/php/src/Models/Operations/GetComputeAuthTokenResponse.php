...
class GetComputeAuthTokenResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetComputeAuthTokenOutput $getComputeAuthTokenOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetComputeAuthTokenOutput $getComputeAuthTokenOutput = null;
	...
	{
		$this->contentType = "";
		$this->getComputeAuthTokenOutput = null;
