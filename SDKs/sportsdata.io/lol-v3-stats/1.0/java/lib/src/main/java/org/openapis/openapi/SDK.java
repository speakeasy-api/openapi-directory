...
public class SDK {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ChampionsResponse champions(org.openapis.openapi.models.operations.ChampionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ChampionsPathParams.class, baseUrl, "/{format}/Champions", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.ChampionsResponse res = new org.openapis.openapi.models.operations.ChampionsResponse() {{
            champions = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.Champion[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.Champion[].class);
                res.champions = out;
            }
        }
    ...
    public org.openapis.openapi.models.operations.ItemsResponse items(org.openapis.openapi.models.operations.ItemsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ItemsPathParams.class, baseUrl, "/{format}/Items", request.pathParams, null);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.SpellsResponse spells(org.openapis.openapi.models.operations.SpellsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.SpellsPathParams.class, baseUrl, "/{format}/Spells", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.SpellsResponse res = new org.openapis.openapi.models.operations.SpellsResponse() {{
            spells = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.Spell[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.Spell[].class);
                res.spells = out;
            }
        }
