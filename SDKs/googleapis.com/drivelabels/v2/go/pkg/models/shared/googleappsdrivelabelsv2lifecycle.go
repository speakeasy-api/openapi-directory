...
func (e GoogleAppsDriveLabelsV2LifecycleStateEnum) ToPointer() *GoogleAppsDriveLabelsV2LifecycleStateEnum {
	return &e
}
...
func (e *GoogleAppsDriveLabelsV2LifecycleStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "DISABLED":
		fallthrough
	case "DELETED":
		*e = GoogleAppsDriveLabelsV2LifecycleStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleAppsDriveLabelsV2LifecycleStateEnum: %v", v)
	}
}
...
type GoogleAppsDriveLabelsV2LifecycleInput struct {
	// The policy that governs how to treat a disabled label, field, or selection choice in different contexts.
	DisabledPolicy *GoogleAppsDriveLabelsV2LifecycleDisabledPolicy `json:"disabledPolicy,omitempty"`
}
