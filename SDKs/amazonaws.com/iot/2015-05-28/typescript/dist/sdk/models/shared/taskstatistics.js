...
var TaskStatistics = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "canceledChecks" }),
        __metadata("design:type", Number)
    ], TaskStatistics.prototype, "canceledChecks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "compliantChecks" }),
        __metadata("design:type", Number)
    ], TaskStatistics.prototype, "compliantChecks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "failedChecks" }),
        __metadata("design:type", Number)
    ], TaskStatistics.prototype, "failedChecks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "inProgressChecks" }),
        __metadata("design:type", Number)
    ], TaskStatistics.prototype, "inProgressChecks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nonCompliantChecks" }),
        __metadata("design:type", Number)
    ], TaskStatistics.prototype, "nonCompliantChecks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "totalChecks" }),
        __metadata("design:type", Number)
    ], TaskStatistics.prototype, "totalChecks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "waitingForDataCollectionChecks" }),
        __metadata("design:type", Number)
