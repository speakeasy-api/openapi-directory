...
public class GetMeAssociatedRequest {
    ...
    public GetMeAssociatedRequest withCallback(String callback) {
    ...
    public GetMeAssociatedRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeAssociatedRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeAssociatedRequest withPagesize(Long pagesize) {
        this.pagesize = pagesize;
        return this;
    }
    
    public GetMeAssociatedRequest(){}
}
