...
class DfareportingSubaccountsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingSubaccountsListSortFieldEnum $sortField
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortField')]
    public ?DfareportingSubaccountsListSortFieldEnum $sortField = null;
    
    /**
     * Order of sorted results.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingSubaccountsListSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?DfareportingSubaccountsListSortOrderEnum $sortOrder = null;
