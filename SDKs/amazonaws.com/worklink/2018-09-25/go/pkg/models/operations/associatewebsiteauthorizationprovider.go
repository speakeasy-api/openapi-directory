...
func (e AssociateWebsiteAuthorizationProviderRequestBodyAuthorizationProviderTypeEnum) ToPointer() *AssociateWebsiteAuthorizationProviderRequestBodyAuthorizationProviderTypeEnum {
	return &e
}
...
func (e *AssociateWebsiteAuthorizationProviderRequestBodyAuthorizationProviderTypeEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "SAML":
		*e = AssociateWebsiteAuthorizationProviderRequestBodyAuthorizationProviderTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AssociateWebsiteAuthorizationProviderRequestBodyAuthorizationProviderTypeEnum: %v", v)
	}
}
