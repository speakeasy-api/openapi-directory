...
exports.NotifyConfigurationType = void 0;
var utils_1 = require("../../../internal/utils");
var notifyemailtype_1 = require("./notifyemailtype");
...
var NotifyConfigurationType = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "BlockEmail" }),
        (0, class_transformer_1.Type)(function () { return notifyemailtype_1.NotifyEmailType; }),
        __metadata("design:type", notifyemailtype_1.NotifyEmailType)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MfaEmail" }),
        (0, class_transformer_1.Type)(function () { return notifyemailtype_1.NotifyEmailType; }),
        __metadata("design:type", notifyemailtype_1.NotifyEmailType)
    ], NotifyConfigurationType.prototype, "mfaEmail", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "NoActionEmail" }),
        (0, class_transformer_1.Type)(function () { return notifyemailtype_1.NotifyEmailType; }),
        __metadata("design:type", notifyemailtype_1.NotifyEmailType)
