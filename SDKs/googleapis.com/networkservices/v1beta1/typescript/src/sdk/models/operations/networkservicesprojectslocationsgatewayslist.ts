...
export class NetworkservicesProjectsLocationsGatewaysListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsGatewaysListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsGatewaysListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
