 ...
 */
public enum CreateTransitGatewayPeeringAttachmentResultTransitGatewayPeeringAttachmentStateEnum {
    ...
    private CreateTransitGatewayPeeringAttachmentResultTransitGatewayPeeringAttachmentStateEnum(String value) {
        this.value = value;
    }
}
