...
class GetCandidateCandidateIDCommitteesHistoryRequest:
    path_params: GetCandidateCandidateIDCommitteesHistoryPathParams = dataclasses.field()
    query_params: GetCandidateCandidateIDCommitteesHistoryQueryParams = dataclasses.field()
