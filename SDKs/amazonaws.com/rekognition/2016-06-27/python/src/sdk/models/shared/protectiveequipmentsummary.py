...
class ProtectiveEquipmentSummary:
    ...
    persons_indeterminate: Optional[list[int]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PersonsIndeterminate') }})
    persons_with_required_equipment: Optional[list[int]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PersonsWithRequiredEquipment') }})
    persons_without_required_equipment: Optional[list[int]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PersonsWithoutRequiredEquipment') }})
