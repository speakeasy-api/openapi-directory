...
exports.ConnectionsTokenResponse = exports.ConnectionsTokenRequest = exports.ConnectionsTokenSecurity = void 0;
...
exports.ConnectionsTokenSecurity = ConnectionsTokenSecurity;
var ConnectionsTokenRequest = /** @class */ (function (_super) {
    ...
    ], ConnectionsTokenRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=service_id",
        }),
        __metadata("design:type", String)
    ], ConnectionsTokenRequest.prototype, "serviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=unified_api",
        }),
        __metadata("design:type", String)
    ], ConnectionsTokenRequest.prototype, "unifiedApi", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ConnectionsTokenRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], ConnectionsTokenRequest.prototype, "xApideckConsumerId", void 0);
    return ConnectionsTokenRequest;
}(utils_1.SpeakeasyBase));
exports.ConnectionsTokenRequest = ConnectionsTokenRequest;
var ConnectionsTokenResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ConnectionsTokenResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ConnectionsTokenResponse = ConnectionsTokenResponse;
