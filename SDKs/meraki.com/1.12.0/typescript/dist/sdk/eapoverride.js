...
exports.EapOverride = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var EapOverride = /** @class */ (function () {
    function EapOverride(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    EapOverride.prototype.getNetworkWirelessSsidEapOverride = function (req, config) {
    ...
    **/
    EapOverride.prototype.updateNetworkWirelessSsidEapOverride = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.EapOverride = EapOverride;
