...
from ..shared import getplayerconnectionstatusresult as shared_getplayerconnectionstatusresult
...
class GetPlayerConnectionStatusRequest:
    ...
    r"""The unique identifier representing a player."""  
...
class GetPlayerConnectionStatusResponse:
    ...
    get_player_connection_status_result: Optional[shared_getplayerconnectionstatusresult.GetPlayerConnectionStatusResult] = dataclasses.field(default=None)
    r"""Success"""  
