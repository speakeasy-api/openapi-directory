...
class GETCreateTransitGatewayPrefixListReferenceRequest
{
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETCreateTransitGatewayPrefixListReferenceActionEnum::CREATE_TRANSIT_GATEWAY_PREFIX_LIST_REFERENCE;
		$this->blackhole = null;
		$this->dryRun = null;
		$this->prefixListId = "";
		$this->transitGatewayAttachmentId = null;
		$this->transitGatewayRouteTableId = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETCreateTransitGatewayPrefixListReferenceVersionEnum::TWO_THOUSAND_AND_SIXTEEN1115;
