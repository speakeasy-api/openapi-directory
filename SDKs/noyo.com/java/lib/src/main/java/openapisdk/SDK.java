...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.PingResponse ping() throws Exception {
        ...
        openapisdk.models.operations.PingResponse res = new openapisdk.models.operations.PingResponse() {{
        }};
