 ...
 */
public enum GetIpamResourceCidrsResultIpamResourceCidrsOverlapStatusEnum {
    ...
    private GetIpamResourceCidrsResultIpamResourceCidrsOverlapStatusEnum(String value) {
        this.value = value;
    }
}
