 ...
 */
public enum CreateCapacityReservationResultCapacityReservationStateEnum {
    ACTIVE("active"),
    EXPIRED("expired"),
    CANCELLED("cancelled"),
    PENDING("pending"),
    ...
    private CreateCapacityReservationResultCapacityReservationStateEnum(String value) {
        this.value = value;
    }
}
