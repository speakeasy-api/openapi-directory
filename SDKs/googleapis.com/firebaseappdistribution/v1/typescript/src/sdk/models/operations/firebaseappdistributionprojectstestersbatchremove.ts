...
export class FirebaseappdistributionProjectsTestersBatchRemoveSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsTestersBatchRemoveRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappdistributionProjectsTestersBatchRemoveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
