...
exports.SearchProfilesResponse = exports.SearchProfilesRequest = exports.SearchProfilesRequestBody = exports.SearchProfilesRequestBodyLogicalOperatorEnum = void 0;
 ...
 */
var SearchProfilesRequestBodyLogicalOperatorEnum;
(function (SearchProfilesRequestBodyLogicalOperatorEnum) {
    SearchProfilesRequestBodyLogicalOperatorEnum["And"] = "AND";
    SearchProfilesRequestBodyLogicalOperatorEnum["Or"] = "OR";
})(SearchProfilesRequestBodyLogicalOperatorEnum = exports.SearchProfilesRequestBodyLogicalOperatorEnum || (exports.SearchProfilesRequestBodyLogicalOperatorEnum = {}));
var SearchProfilesRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AdditionalSearchKey }),
        (0, class_transformer_1.Expose)({ name: "AdditionalSearchKeys" }),
        (0, class_transformer_1.Type)(function () { return shared.AdditionalSearchKey; }),
        __metadata("design:type", Array)
    ], SearchProfilesRequestBody.prototype, "additionalSearchKeys", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SearchProfilesRequestBody.prototype, "logicalOperator", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.SearchProfilesRequestBody = SearchProfilesRequestBody;
var SearchProfilesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "domainName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", SearchProfilesRequestBody)
    ], SearchProfilesRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max-results",
        }),
        __metadata("design:type", Number)
    ], SearchProfilesRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=next-token",
        }),
        __metadata("design:type", String)
    ], SearchProfilesRequest.prototype, "nextToken", void 0);
...
var SearchProfilesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], SearchProfilesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
