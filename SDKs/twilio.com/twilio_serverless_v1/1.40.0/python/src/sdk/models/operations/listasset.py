...
class ListAssetRequest:
    ...
    r"""The SID of the Service to read the Asset resources from."""  
...
class ListAssetListAssetResponse:
    ...
    assets: Optional[list[shared_serverless_v1_service_asset.ServerlessV1ServiceAsset]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assets'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListAssetListAssetResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
