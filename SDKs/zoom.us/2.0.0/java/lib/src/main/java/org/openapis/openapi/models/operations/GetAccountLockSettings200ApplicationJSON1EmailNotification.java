...
public class GetAccountLockSettings200ApplicationJSON1EmailNotification {
    /**
    ...
    public GetAccountLockSettings200ApplicationJSON1EmailNotification withAlternativeHostReminder(Boolean alternativeHostReminder) {
    ...
    public GetAccountLockSettings200ApplicationJSON1EmailNotification withCancelMeetingReminder(Boolean cancelMeetingReminder) {
    ...
    public GetAccountLockSettings200ApplicationJSON1EmailNotification withCloudRecordingAvailableReminder(Boolean cloudRecordingAvailableReminder) {
    ...
    public GetAccountLockSettings200ApplicationJSON1EmailNotification withJbhReminder(Boolean jbhReminder) {
    ...
    public GetAccountLockSettings200ApplicationJSON1EmailNotification withScheduleForHostReminder(Boolean scheduleForHostReminder) {
