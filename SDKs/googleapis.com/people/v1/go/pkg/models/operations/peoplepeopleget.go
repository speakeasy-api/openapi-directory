...
func (e PeoplePeopleGetSourcesEnum) ToPointer() *PeoplePeopleGetSourcesEnum {
	return &e
}

func (e *PeoplePeopleGetSourcesEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "READ_SOURCE_TYPE_DOMAIN_CONTACT":
		*e = PeoplePeopleGetSourcesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PeoplePeopleGetSourcesEnum: %v", v)
	}
}
