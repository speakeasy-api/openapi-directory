...
public class LegalEntities {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostLegalEntitiesIdCheckVerificationErrorsResponse postLegalEntitiesIdCheckVerificationErrors(org.openapis.openapi.models.operations.PostLegalEntitiesIdCheckVerificationErrorsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.PostLegalEntitiesIdCheckVerificationErrorsPathParams.class, baseUrl, "/legalEntities/{id}/checkVerificationErrors", request.pathParams, null);
