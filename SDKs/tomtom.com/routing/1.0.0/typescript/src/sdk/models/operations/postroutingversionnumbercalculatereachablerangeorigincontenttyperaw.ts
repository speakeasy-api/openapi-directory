 ...
 */
export enum PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawVehicleEngineTypeEnum {
  Combustion = "combustion",
  Electric = "electric",
}

export class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawRequest extends SpeakeasyBase {
  ...
  vehicleEngineType?: PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawVehicleEngineTypeEnum;
...
export class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
