...
class SandboxConfig:
    ...
    sandbox_type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sandboxType'), 'exclude': lambda f: f is None }})
    r"""Type of the sandbox to use for the node (e.g. 'gvisor')"""  
