...
const (
	TagResourceXAmzTargetEnumKinesisAnalytics20180523TagResource TagResourceXAmzTargetEnum = "KinesisAnalytics_20180523.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "KinesisAnalytics_20180523.TagResource":
