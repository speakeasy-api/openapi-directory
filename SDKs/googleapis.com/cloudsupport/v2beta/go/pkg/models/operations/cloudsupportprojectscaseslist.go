...
type CloudsupportProjectsCasesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudsupportProjectsCasesListPathParams struct {
	// Required. The fully qualified name of parent resource to list cases under.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type CloudsupportProjectsCasesListQueryParams struct {
	// V1 error format.
...
type CloudsupportProjectsCasesListRequest struct {
	PathParams  CloudsupportProjectsCasesListPathParams
	QueryParams CloudsupportProjectsCasesListQueryParams
	Security    CloudsupportProjectsCasesListSecurity
}

type CloudsupportProjectsCasesListResponse struct {
	ContentType string
	// Successful response
