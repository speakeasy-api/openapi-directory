...
class CompileAPI 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PostCompileRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PostCompileResponse
     * @see https://blog.openpolicyagent.org/partial-evaluation-162750eaf422
     */
	public function postCompile(
        \OpenAPI\OpenAPI\Models\Operations\PostCompileRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PostCompileResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/compile');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "requestBody", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\PostCompileRequest::class, $request, null));
        
        $httpResponse = $this->_defaultClient->request('POST', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\PostCompileResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->postCompile200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\PostCompile200ApplicationJSON', 'json');
            }
        }
