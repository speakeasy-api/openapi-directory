 ...
 */
export enum TargetPoolAggregatedListWarningCodeEnum {
...
export class TargetPoolAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetPoolAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetPoolAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class TargetPoolAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetPoolsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, TargetPoolsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], TargetPoolsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
