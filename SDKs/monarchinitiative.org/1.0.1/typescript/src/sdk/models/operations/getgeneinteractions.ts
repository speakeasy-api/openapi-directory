...
export class GetGeneInteractionsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGeneInteractionsQueryParams extends SpeakeasyBase {
...
export class GetGeneInteractionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneInteractionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
