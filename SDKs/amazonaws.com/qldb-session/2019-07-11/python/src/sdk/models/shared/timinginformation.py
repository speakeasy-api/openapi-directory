...
class TimingInformation:
    ...
    processing_time_milliseconds: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ProcessingTimeMilliseconds') }})
