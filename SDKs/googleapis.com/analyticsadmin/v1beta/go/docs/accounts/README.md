...
func main() {
    ...
    if res.GoogleAnalyticsAdminV1betaListAccountsResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.Accounts.AnalyticsadminAccountsProvisionAccountTicket(ctx, operations.AnalyticsadminAccountsProvisionAccountTicketRequest{
        DollarXgafv: shared.XgafvEnumTwo.ToPointer(),
        GoogleAnalyticsAdminV1betaProvisionAccountTicketRequestInput: &shared.GoogleAnalyticsAdminV1betaProvisionAccountTicketRequestInput{
            Account: &shared.GoogleAnalyticsAdminV1betaAccountInput{
    ...
    if res.GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.Accounts.AnalyticsadminAccountsSearchChangeHistoryEvents(ctx, operations.AnalyticsadminAccountsSearchChangeHistoryEventsRequest{
        DollarXgafv: shared.XgafvEnumTwo.ToPointer(),
        GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest: &shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest{
            Action: []shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestActionEnum{
                shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestActionEnumUpdated,
                shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestActionEnumActionTypeUnspecified,
                shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestActionEnumUpdated,
            },
            ActorEmail: []string{
                "optio",
            ...
            ResourceType: []shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestResourceTypeEnum{
                shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestResourceTypeEnumProperty,
                shared.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestResourceTypeEnumMeasurementProtocolSecret,
            },
        },
    ...
    if res.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse != nil {
        // handle response
    }
}
```
