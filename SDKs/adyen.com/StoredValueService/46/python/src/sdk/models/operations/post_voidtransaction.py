...
from ..shared import storedvaluevoidresponse as shared_storedvaluevoidresponse
...
class PostVoidTransactionResponse:
    ...
    stored_value_void_response: Optional[shared_storedvaluevoidresponse.StoredValueVoidResponse] = dataclasses.field(default=None)
