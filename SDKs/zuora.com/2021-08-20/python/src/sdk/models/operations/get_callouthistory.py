...
class GETCalloutHistoryRequest:
    ...
    r"""The final date and time of records to be returned. Defaults to now. Use format yyyy-MM-ddTHH:mm:ss."""  
    ...
    **Note**: The `eventCategory` will be ignored if the `objectId` is present in query parameters.
    ...
    r"""If `true`, only return failed records. If `false`, return all records in the given date range. The default value is `true`.
    ...
    **Note**: The `failedOnly` will be treated as `false` if the `objectId` is present in query parameters.
    ...
    r"""The ID of an object that triggered a callout notification.
    ...
    **Note**: If the `objectId` is present in query parameters, the `eventCategory` will be ignored and the `failedOnly` will be treated as `false`.
    ...
    r"""The initial date and time of records to be returned. Defaults to (end time - 1 day). Use format yyyy-MM-ddTHH:mm:ss."""  
