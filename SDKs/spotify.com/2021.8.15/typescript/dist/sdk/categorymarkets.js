...
exports.CategoryMarkets = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CategoryMarkets = /** @class */ (function () {
    function CategoryMarkets(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CategoryMarkets.prototype.endpointGetAvailableMarkets = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.EndpointGetAvailableMarketsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/markets";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.marketsObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
...
exports.CategoryMarkets = CategoryMarkets;
