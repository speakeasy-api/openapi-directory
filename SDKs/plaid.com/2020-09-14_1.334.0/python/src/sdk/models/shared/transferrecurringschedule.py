...
import dataclasses
from ..shared import transferscheduleintervalunit_enum as shared_transferscheduleintervalunit_enum
...
class TransferRecurringSchedule:
    ...
    """  
    interval_unit: shared_transferscheduleintervalunit_enum.TransferScheduleIntervalUnitEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interval_unit') }})
