...
func (s *projects) ServicedirectoryProjectsLocationsNamespacesCreate(ctx context.Context, request operations.ServicedirectoryProjectsLocationsNamespacesCreateRequest, security operations.ServicedirectoryProjectsLocationsNamespacesCreateSecurity) (*operations.ServicedirectoryProjectsLocationsNamespacesCreateResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/namespaces", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *projects) ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreate(ctx context.Context, request operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateRequest, security operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateSecurity) (*operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/endpoints", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *projects) ServicedirectoryProjectsLocationsNamespacesServicesResolve(ctx context.Context, request operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveRequest, security operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveSecurity) (*operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}:resolve", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *projects) ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicy(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyRequest, security operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicySecurity) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyResponse, error) {
	baseURL := s.serverURL
...
func (s *projects) ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicy(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyRequest, security operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicySecurity) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyResponse, error) {
	baseURL := s.serverURL
