...
exports.POSTBatchDeleteClusterSnapshotsResponse = exports.POSTBatchDeleteClusterSnapshotsRequest = exports.POSTBatchDeleteClusterSnapshotsVersionEnum = exports.POSTBatchDeleteClusterSnapshotsActionEnum = void 0;
...
var POSTBatchDeleteClusterSnapshotsRequest = /** @class */ (function (_super) {
    ...
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], POSTBatchDeleteClusterSnapshotsRequest.prototype, "xAmzSignedHeaders", void 0);
...
var POSTBatchDeleteClusterSnapshotsResponse = /** @class */ (function (_super) {
    ...
    ], POSTBatchDeleteClusterSnapshotsResponse.prototype, "rawResponse", void 0);
