...
public class PolicysimulatorProjectsLocationsReplaysCreateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudPolicysimulatorV1ReplayInput request;
    public PolicysimulatorProjectsLocationsReplaysCreateRequest withRequest(openapisdk.models.shared.GoogleCloudPolicysimulatorV1ReplayInput request) {
