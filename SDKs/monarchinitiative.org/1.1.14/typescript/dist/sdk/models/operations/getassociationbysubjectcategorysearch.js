...
exports.GetAssociationBySubjectCategorySearchResponse = exports.GetAssociationBySubjectCategorySearchRequest = void 0;
...
var GetAssociationBySubjectCategorySearchRequest = /** @class */ (function (_super) {
    ...
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "evidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=exclude_automatic_assertions",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "excludeAutomaticAssertions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=object_taxon",
        }),
        __metadata("design:type", String)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "objectTaxon", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=relation",
        }),
        __metadata("design:type", String)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "relation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rows" }),
        __metadata("design:type", Number)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "rows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start" }),
        __metadata("design:type", Number)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "start", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=subject_category",
        }),
        __metadata("design:type", String)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "subjectCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=subject_taxon",
        }),
        __metadata("design:type", String)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "subjectTaxon", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=unselect_evidence",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "unselectEvidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=use_compact_associations",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationBySubjectCategorySearchRequest.prototype, "useCompactAssociations", void 0);
...
var GetAssociationBySubjectCategorySearchResponse = /** @class */ (function (_super) {
    ...
    ], GetAssociationBySubjectCategorySearchResponse.prototype, "rawResponse", void 0);
