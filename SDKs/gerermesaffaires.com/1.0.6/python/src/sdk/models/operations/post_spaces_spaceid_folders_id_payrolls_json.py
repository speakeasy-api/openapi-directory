...
class PostSpacesSpaceIDFoldersIDPayrollsJSONSecurity:
    
    gma_auth: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2', 'field_name': 'Authorization' }})  
    
class PostSpacesSpaceIDFoldersIDPayrollsApplicationJSON2AccountingWorkbookEnum(str, Enum):
    CUSTOMER = 'customer'
    PROVIDER = 'provider'
    BANK = 'bank'
...
@dataclasses.dataclass
class PostSpacesSpaceIDFoldersIDPayrollsApplicationJSON2Accounting:
    ...
    workbook: Optional[PostSpacesSpaceIDFoldersIDPayrollsApplicationJSON2AccountingWorkbookEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Workbook'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostSpacesSpaceIDFoldersIDPayrollsApplicationJSON2File:
...
class PostSpacesSpaceIDFoldersIDPayrollsApplicationJSON2:
    ...
    file: PostSpacesSpaceIDFoldersIDPayrollsApplicationJSON2File = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('File') }})  
    title: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Title') }})  
    accounting: Optional[PostSpacesSpaceIDFoldersIDPayrollsApplicationJSON2Accounting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Accounting'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostSpacesSpaceIDFoldersIDPayrollsJSON201ApplicationJSON:
...
@dataclasses.dataclass
class PostSpacesSpaceIDFoldersIDPayrollsJSONResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    headers: Optional[dict[str, list[str]]] = dataclasses.field(default=None)  
    post_spaces_space_id_folders_id_payrolls_json_201_application_json_object: Optional[PostSpacesSpaceIDFoldersIDPayrollsJSON201ApplicationJSON] = dataclasses.field(default=None)
    r"""Id of document created"""  
