...
class VideoVersionsUser
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserAccountEnum $account
     */
	#[\JMS\Serializer\Annotation\SerializedName('account')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserAccountEnum>')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserContentFilterEnum $contentFilter
     */
	#[\JMS\Serializer\Annotation\SerializedName('content_filter')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserContentFilterEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoVersionsUserContentFilterEnum $contentFilter = null;
     ...
     * The user's metadata.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserMetadata $metadata
     */
	#[\JMS\Serializer\Annotation\SerializedName('metadata')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserMetadata')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserPreferences')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoVersionsUserPreferences $preferences = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserUploadQuota $uploadQuota
     */
	#[\JMS\Serializer\Annotation\SerializedName('upload_quota')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserUploadQuota')]
     ...
     * The user's websites.
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserWebsites> $websites
     */
	#[\JMS\Serializer\Annotation\SerializedName('websites')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserWebsites>')]
    public array $websites;
    
	public function __construct()
	{
		$this->account = \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserAccountEnum::BASIC;
		$this->bio = "";
		...
		$this->link = "";
		$this->location = "";
		$this->metadata = new \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserMetadata();
		$this->name = "";
		$this->pictures = new \OpenAPI\OpenAPI\Models\Shared\Picture();
		$this->preferences = null;
		$this->resourceKey = "";
		$this->uploadQuota = new \OpenAPI\OpenAPI\Models\Shared\VideoVersionsUserUploadQuota();
		$this->uri = "";
		$this->websites = [];
	}
}
