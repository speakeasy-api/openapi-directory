...
**/
var S3Config = /** @class */ (function (_super) {
    __extends(S3Config, _super);
    function S3Config() {
    ...
    ], S3Config.prototype, "kmsKeyArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Path" }),
        __metadata("design:type", String)
    ], S3Config.prototype, "path", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=RoleArn" }),
        __metadata("design:type", String)
    ], S3Config.prototype, "roleArn", void 0);
    return S3Config;
