...
var commentbodytexttypeenum_1 = require("./commentbodytexttypeenum");
var class_transformer_1 = require("class-transformer");
/**
 * Represents the content of a <code>Comment</code> to be returned to agents.
 */
var CommentContent = /** @class */ (function (_super) {
    __extends(CommentContent, _super);
    ...
    ], CommentContent.prototype, "body", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "contentType" }),
        __metadata("design:type", String)
    ], CommentContent.prototype, "contentType", void 0);
