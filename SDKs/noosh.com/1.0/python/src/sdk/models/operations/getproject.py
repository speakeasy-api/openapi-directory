...
from ..shared import projectexpandvo as shared_projectexpandvo
...
class GetProjectResponse:
    ...
    project_expand_vo: Optional[shared_projectexpandvo.ProjectExpandVO] = dataclasses.field(default=None)
