...
from ..shared import security as shared_security
from ..shared import liststepthumbnailsresponse as shared_liststepthumbnailsresponse
...
@dataclasses.dataclass
class ToolresultsProjectsHistoriesExecutionsStepsThumbnailsListQueryParams:
...
class ToolresultsProjectsHistoriesExecutionsStepsThumbnailsListRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsThumbnailsListPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsThumbnailsListQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsStepsThumbnailsListSecurity = dataclasses.field()
...
class ToolresultsProjectsHistoriesExecutionsStepsThumbnailsListResponse:
    ...
    list_step_thumbnails_response: Optional[shared_liststepthumbnailsresponse.ListStepThumbnailsResponse] = dataclasses.field(default=None)
