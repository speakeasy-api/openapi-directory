...
public class GetVariantGenotypeAssociationsRequest {
    /**
    ...
    public GetVariantGenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetVariantGenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetVariantGenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetVariantGenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetVariantGenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetVariantGenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetVariantGenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetVariantGenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetVariantGenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetVariantGenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
