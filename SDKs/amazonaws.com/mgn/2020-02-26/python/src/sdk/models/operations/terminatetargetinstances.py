...
class TerminateTargetInstancesRequestBody:
    ...
    r"""Terminate Target instance by Source Server IDs."""  
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tags'), 'exclude': lambda f: f is None }})
    r"""Terminate Target instance by Tags."""  
    

@dataclasses.dataclass
class TerminateTargetInstancesRequest:
    
    request_body: TerminateTargetInstancesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
