...
class UpdateBudgetActionRequest:
    ...
    update_budget_action_request: shared_updatebudgetactionrequest.UpdateBudgetActionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
