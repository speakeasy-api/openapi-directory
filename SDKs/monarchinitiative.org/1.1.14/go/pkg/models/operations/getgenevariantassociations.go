...
type GetGeneVariantAssociationsPathParams struct {
	// CURIE identifier of gene, e.g. HGNC:10896
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetGeneVariantAssociationsQueryParams struct {
