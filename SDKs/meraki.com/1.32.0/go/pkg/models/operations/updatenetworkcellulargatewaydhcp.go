...
func (e UpdateNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum) ToPointer() *UpdateNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum {
	return &e
}
...
func (e *UpdateNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum) UnmarshalJSON(data []byte) error {
	...
	case "30 minutes":
		fallthrough
	case "4 hours":
		*e = UpdateNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkCellularGatewayDhcp200ApplicationJSONDhcpLeaseTimeEnum: %v", v)
	}
}
...
func (e UpdateNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum) ToPointer() *UpdateNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum {
	return &e
}
...
func (e *UpdateNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum) UnmarshalJSON(data []byte) error {
	...
	case "opendns":
		fallthrough
	case "upstream_dns":
		*e = UpdateNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkCellularGatewayDhcp200ApplicationJSONDNSNameserversEnum: %v", v)
	}
}
