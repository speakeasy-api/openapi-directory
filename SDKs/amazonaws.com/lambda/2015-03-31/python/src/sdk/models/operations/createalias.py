...
class CreateAliasRequestBody:
    ...
    function_version: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FunctionVersion') }})
    ...
    routing_config: Optional[CreateAliasRequestBodyRoutingConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RoutingConfig'), 'exclude': lambda f: f is None }})
    r"""The <a href=\\"https://docs.aws.amazon.com/lambda/latest/dg/lambda-traffic-shifting-using-aliases.html\\">traffic-shifting</a> configuration of a Lambda function alias."""  
...
class CreateAliasRequest:
    ...
    request_body: CreateAliasRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
