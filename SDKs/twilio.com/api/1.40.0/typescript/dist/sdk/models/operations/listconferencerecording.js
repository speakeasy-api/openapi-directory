...
exports.ListConferenceRecordingResponse = exports.ListConferenceRecordingListConferenceRecordingResponse = exports.ListConferenceRecordingRequest = exports.ListConferenceRecordingSecurity = exports.ListConferenceRecordingServerList = void 0;
...
var ListConferenceRecordingSecurity = /** @class */ (function (_super) {
    ...
    ], ListConferenceRecordingSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListConferenceRecordingSecurity.prototype, "username", void 0);
...
var ListConferenceRecordingRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListConferenceRecordingRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConferenceSid",
        }),
        __metadata("design:type", String)
    ], ListConferenceRecordingRequest.prototype, "conferenceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRecordingRequest.prototype, "dateCreated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated<;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRecordingRequest.prototype, "dateCreatedLessThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated>;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListConferenceRecordingRequest.prototype, "dateCreatedGreaterThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListConferenceRecordingRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListConferenceRecordingRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListConferenceRecordingRequest.prototype, "pageToken", void 0);
...
var ListConferenceRecordingListConferenceRecordingResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountConferenceConferenceRecording; }),
...
var ListConferenceRecordingResponse = /** @class */ (function (_super) {
    ...
    ], ListConferenceRecordingResponse.prototype, "rawResponse", void 0);
