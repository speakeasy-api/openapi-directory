 ...
 */
export class DescribeClientVpnRoutesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeClientVpnRoutesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: DescribeClientVpnRoutesRequestFilters })
  filters?: DescribeClientVpnRoutesRequestFilters[];
