...
from ..shared import getcreditmemoitemtype as shared_getcreditmemoitemtype
...
class GETCreditMemoItemRequest:
    ...
    r"""The unique ID of a credit memo item. You can get the credit memo item ID from the response of [List credit memo items](https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoItems)."""  
...
class GETCreditMemoItemResponse:
    ...
    get_credit_memo_item_type: Optional[shared_getcreditmemoitemtype.GETCreditMemoItemType] = dataclasses.field(default=None)  
