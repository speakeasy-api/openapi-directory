...
class ListConversationListConversationResponse:
    ...
    conversations: Optional[list[shared_conversations_v1_conversation.ConversationsV1Conversation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversations'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListConversationListConversationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
