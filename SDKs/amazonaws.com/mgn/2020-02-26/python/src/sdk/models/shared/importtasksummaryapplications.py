...
class ImportTaskSummaryApplications:
    r"""Import task summary applications."""
    
    created_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('createdCount'), 'exclude': lambda f: f is None }})  
