 ...
 */
var StepOutput = /** @class */ (function (_super) {
    __extends(StepOutput, _super);
    function StepOutput() {
    ...
    ], StepOutput.prototype, "dataType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "name" }),
        __metadata("design:type", String)
    ], StepOutput.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "required" }),
        __metadata("design:type", Boolean)
    ], StepOutput.prototype, "required", void 0);
    return StepOutput;
