...
class PartnerUnclaim:
    r"""Identifies one unclaim request."""
    ...
    section_type: Optional[PartnerUnclaimSectionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sectionType'), 'exclude': lambda f: f is None }})
    r"""Required. The section type of the device's provisioning record."""  
    ...
    r"""Optional. The duration of the vacation unlock starting from when the request is processed. (1 day is treated as 24 hours)"""  
    ...
    r"""Optional. The expiration time of the vacation unlock."""  
