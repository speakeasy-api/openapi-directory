 ...
 */
export class GetTransitGatewayPolicyTableAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetTransitGatewayPolicyTableAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({
    elemType: GetTransitGatewayPolicyTableAssociationsRequestFilters,
  })
  filters?: GetTransitGatewayPolicyTableAssociationsRequestFilters[];
