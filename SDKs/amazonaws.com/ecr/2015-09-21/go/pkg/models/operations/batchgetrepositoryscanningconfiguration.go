...
func (e *BatchGetRepositoryScanningConfigurationXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonEC2ContainerRegistry_V20150921.BatchGetRepositoryScanningConfiguration":
		*e = BatchGetRepositoryScanningConfigurationXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for BatchGetRepositoryScanningConfigurationXAmzTargetEnum: %s", s)
	}
}

type BatchGetRepositoryScanningConfigurationHeaders struct {
...
type BatchGetRepositoryScanningConfigurationRequest struct {
	Headers BatchGetRepositoryScanningConfigurationHeaders
	Request shared.BatchGetRepositoryScanningConfigurationRequest `request:"mediaType=application/json"`
}
