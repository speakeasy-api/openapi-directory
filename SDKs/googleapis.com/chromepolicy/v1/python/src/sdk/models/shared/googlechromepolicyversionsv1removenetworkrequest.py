...
class GoogleChromePolicyVersionsV1RemoveNetworkRequest:
    r"""Request object for removing a network"""
    ...
    r"""Required. The GUID of the network to remove."""  
    ...
    r"""Required. The target resource on which this network will be removed. The following resources are supported: * Organizational Unit (\\"orgunits/{orgunit_id}\\")"""  
