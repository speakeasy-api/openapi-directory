...
class ServicePlan:
    ...
    create_json_schema: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('create_json_schema'), 'exclude': lambda f: f is None }})  
    ...
    r"""ID of the resource"""  
    resource_version: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resource_version'), 'exclude': lambda f: f is None }})  
    ...
    update_json_schema: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('update_json_schema'), 'exclude': lambda f: f is None }})  
