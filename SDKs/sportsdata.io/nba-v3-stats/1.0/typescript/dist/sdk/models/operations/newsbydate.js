...
exports.NewsByDateResponse = exports.NewsByDateRequest = exports.NewsByDateFormatEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
 */
var NewsByDateFormatEnum;
(function (NewsByDateFormatEnum) {
    NewsByDateFormatEnum["Xml"] = "XML";
    NewsByDateFormatEnum["Json"] = "JSON";
})(NewsByDateFormatEnum = exports.NewsByDateFormatEnum || (exports.NewsByDateFormatEnum = {}));
var NewsByDateRequest = /** @class */ (function (_super) {
    ...
    ], NewsByDateRequest.prototype, "date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=format",
        }),
        __metadata("design:type", String)
    ], NewsByDateRequest.prototype, "format", void 0);
    return NewsByDateRequest;
}(utils_1.SpeakeasyBase));
exports.NewsByDateRequest = NewsByDateRequest;
var NewsByDateResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.News }),
    ...
    ], NewsByDateResponse.prototype, "rawResponse", void 0);
    return NewsByDateResponse;
}(utils_1.SpeakeasyBase));
exports.NewsByDateResponse = NewsByDateResponse;
