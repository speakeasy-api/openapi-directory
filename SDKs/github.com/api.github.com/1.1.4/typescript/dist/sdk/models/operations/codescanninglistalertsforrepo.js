...
exports.CodeScanningListAlertsForRepoResponse = exports.CodeScanningListAlertsForRepoRequest = exports.CodeScanningListAlertsForRepo503ApplicationJson = exports.CodeScanningListAlertsForRepoQueryParams = exports.CodeScanningListAlertsForRepoPathParams = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var CodeScanningListAlertsForRepoPathParams = /** @class */ (function (_super) {
    __extends(CodeScanningListAlertsForRepoPathParams, _super);
    function CodeScanningListAlertsForRepoPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=owner" }),
        __metadata("design:type", String)
    ], CodeScanningListAlertsForRepoPathParams.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=repo" }),
        __metadata("design:type", String)
    ], CodeScanningListAlertsForRepoPathParams.prototype, "repo", void 0);
    return CodeScanningListAlertsForRepoPathParams;
}(utils_1.SpeakeasyBase));
exports.CodeScanningListAlertsForRepoPathParams = CodeScanningListAlertsForRepoPathParams;
var CodeScanningListAlertsForRepoQueryParams = /** @class */ (function (_super) {
    __extends(CodeScanningListAlertsForRepoQueryParams, _super);
    function CodeScanningListAlertsForRepoQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], CodeScanningListAlertsForRepoQueryParams.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=per_page" }),
        __metadata("design:type", Number)
    ], CodeScanningListAlertsForRepoQueryParams.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ref" }),
        __metadata("design:type", String)
    ], CodeScanningListAlertsForRepoQueryParams.prototype, "ref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=state" }),
        __metadata("design:type", String)
    ], CodeScanningListAlertsForRepoQueryParams.prototype, "state", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tool_guid" }),
        __metadata("design:type", String)
    ], CodeScanningListAlertsForRepoQueryParams.prototype, "toolGuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tool_name" }),
        __metadata("design:type", String)
    ], CodeScanningListAlertsForRepoQueryParams.prototype, "toolName", void 0);
    return CodeScanningListAlertsForRepoQueryParams;
}(utils_1.SpeakeasyBase));
exports.CodeScanningListAlertsForRepoQueryParams = CodeScanningListAlertsForRepoQueryParams;
...
var CodeScanningListAlertsForRepoRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", CodeScanningListAlertsForRepoPathParams)
    ], CodeScanningListAlertsForRepoRequest.prototype, "pathParams", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", CodeScanningListAlertsForRepoQueryParams)
    ], CodeScanningListAlertsForRepoRequest.prototype, "queryParams", void 0);
