...
class HTTPEndpointDestinationUpdate:
    r"""Updates the specified HTTP endpoint destination."""
    ...
    endpoint_configuration: Optional[shared_httpendpointconfiguration.HTTPEndpointConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EndpointConfiguration'), 'exclude': lambda f: f is None }})  
