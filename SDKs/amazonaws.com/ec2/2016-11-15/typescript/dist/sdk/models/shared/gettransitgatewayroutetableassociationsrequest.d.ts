 ...
 */
export declare class GetTransitGatewayRouteTableAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetTransitGatewayRouteTableAssociationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: GetTransitGatewayRouteTableAssociationsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
