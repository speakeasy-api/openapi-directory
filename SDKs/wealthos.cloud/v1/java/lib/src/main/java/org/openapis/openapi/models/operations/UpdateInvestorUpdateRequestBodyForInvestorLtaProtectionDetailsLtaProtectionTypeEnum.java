 ...
 */
public enum UpdateInvestorUpdateRequestBodyForInvestorLtaProtectionDetailsLtaProtectionTypeEnum {
    PRIMARY("primary"),
    ENHANCED("enhanced"),
    FP12("fp12"),
    FP14("fp14"),
    ...
    private UpdateInvestorUpdateRequestBodyForInvestorLtaProtectionDetailsLtaProtectionTypeEnum(String value) {
        this.value = value;
    }
}
