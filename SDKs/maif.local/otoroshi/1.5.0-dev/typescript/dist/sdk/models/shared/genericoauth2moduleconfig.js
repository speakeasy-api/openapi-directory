...
var GenericOauth2ModuleConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=accessTokenField" }),
        __metadata("design:type", String)
    ], GenericOauth2ModuleConfig.prototype, "accessTokenField", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=authorizeUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=claims" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=oidConfig" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=readProfileFromToken" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tokenUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=useCookies" }),
        __metadata("design:type", Boolean)
    ], GenericOauth2ModuleConfig.prototype, "useCookies", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=useJson" }),
        __metadata("design:type", Boolean)
    ], GenericOauth2ModuleConfig.prototype, "useJson", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=userInfoUrl" }),
        __metadata("design:type", String)
