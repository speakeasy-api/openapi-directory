...
const (
	UntagResourceXAmzTargetEnumAwsShield20160616UntagResource UntagResourceXAmzTargetEnum = "AWSShield_20160616.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AWSShield_20160616.UntagResource":
