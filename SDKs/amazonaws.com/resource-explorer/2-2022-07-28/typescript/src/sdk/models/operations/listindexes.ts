 ...
 */
export enum ListIndexesRequestBodyTypeEnum {
  Local = "LOCAL",
  Aggregator = "AGGREGATOR",
}

export class ListIndexesRequestBody extends SpeakeasyBase {
  /**
...
export class ListIndexesRequest extends SpeakeasyBase {
  /**
   * Pagination limit
   */
  @SpeakeasyMetadata({
