...
class Webproperties:
    r"""A web property collection lists Analytics web properties to which the user has access. Each resource in the collection corresponds to a single Analytics web property."""
    
    items: Optional[list[shared_webproperty.Webproperty]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""A list of web properties."""  
    ...
    r"""Link to next page for this web property collection."""  
    ...
    r"""Link to previous page for this web property collection."""  
