...
type AnalyticsadminAccountSummariesListSecurityOption1 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AnalyticsadminAccountSummariesListSecurityOption2 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AnalyticsadminAccountSummariesListSecurity struct {
	Option1 *AnalyticsadminAccountSummariesListSecurityOption1 `security:"option"`
	Option2 *AnalyticsadminAccountSummariesListSecurityOption2 `security:"option"`
}

type AnalyticsadminAccountSummariesListQueryParams struct {
	// V1 error format.
