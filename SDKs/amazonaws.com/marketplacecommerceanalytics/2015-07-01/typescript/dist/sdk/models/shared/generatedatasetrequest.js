...
exports.GenerateDataSetRequest = void 0;
...
var GenerateDataSetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=customerDefinedValues" }),
        __metadata("design:type", Object)
    ], GenerateDataSetRequest.prototype, "customerDefinedValues", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dataSetPublicationDate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destinationS3BucketName" }),
        __metadata("design:type", String)
    ], GenerateDataSetRequest.prototype, "destinationS3BucketName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destinationS3Prefix" }),
        __metadata("design:type", String)
    ], GenerateDataSetRequest.prototype, "destinationS3Prefix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=roleNameArn" }),
        __metadata("design:type", String)
