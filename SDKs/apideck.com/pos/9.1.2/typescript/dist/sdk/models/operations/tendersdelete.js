...
exports.TendersDeleteResponse = exports.TendersDeleteRequest = exports.TendersDeleteSecurity = void 0;
...
var TendersDeleteRequest = /** @class */ (function (_super) {
    ...
    ], TendersDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], TendersDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], TendersDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], TendersDeleteRequest.prototype, "xApideckServiceId", void 0);
...
var TendersDeleteResponse = /** @class */ (function (_super) {
    ...
    ], TendersDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
