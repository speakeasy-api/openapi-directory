...
exports.GetRealmUsersIdGroupsResponse = exports.GetRealmUsersIdGroupsRequest = void 0;
...
var GetRealmUsersIdGroupsRequest = /** @class */ (function (_super) {
    ...
    ], GetRealmUsersIdGroupsRequest.prototype, "briefRepresentation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=first" }),
        __metadata("design:type", Number)
    ], GetRealmUsersIdGroupsRequest.prototype, "first", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetRealmUsersIdGroupsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max" }),
        __metadata("design:type", Number)
    ], GetRealmUsersIdGroupsRequest.prototype, "max", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=realm",
        }),
        __metadata("design:type", String)
    ], GetRealmUsersIdGroupsRequest.prototype, "realm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], GetRealmUsersIdGroupsRequest.prototype, "search", void 0);
    return GetRealmUsersIdGroupsRequest;
}(utils_1.SpeakeasyBase));
exports.GetRealmUsersIdGroupsRequest = GetRealmUsersIdGroupsRequest;
var GetRealmUsersIdGroupsResponse = /** @class */ (function (_super) {
    ...
    ], GetRealmUsersIdGroupsResponse.prototype, "rawResponse", void 0);
    return GetRealmUsersIdGroupsResponse;
}(utils_1.SpeakeasyBase));
exports.GetRealmUsersIdGroupsResponse = GetRealmUsersIdGroupsResponse;
