...
from ..shared import proxygetsubscription as shared_proxygetsubscription
...
class ObjectGETSubscriptionResponse:
    ...
    proxy_get_subscription: Optional[shared_proxygetsubscription.ProxyGetSubscription] = dataclasses.field(default=None)  
