...
class NetworkconnectivityProjectsLocationsInternalRangesCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\InternalRangeInput $internalRangeInput = null;
     ...
     * 
     * @var ?string $internalRangeId
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=internalRangeId')]
    public ?string $internalRangeId = null;
