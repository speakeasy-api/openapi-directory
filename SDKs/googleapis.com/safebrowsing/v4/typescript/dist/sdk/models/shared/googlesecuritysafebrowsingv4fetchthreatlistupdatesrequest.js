...
var GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: googlesecuritysafebrowsingv4fetchthreatlistupdatesrequestlistupdaterequest_1.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequestListUpdateRequest,
        }),
        (0, class_transformer_1.Expose)({ name: "listUpdateRequests" }),
        (0, class_transformer_1.Type)(function () {
            return googlesecuritysafebrowsingv4fetchthreatlistupdatesrequestlistupdaterequest_1.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesRequestListUpdateRequest;
        }),
