...
class Status 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\StatusGetResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/api/Status');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\StatusGetRequest::class, $request, null));
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->messageStatus = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\MessageStatus', 'json');
            }
        }
