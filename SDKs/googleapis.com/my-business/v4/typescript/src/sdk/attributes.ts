...
export class Attributes {
  ...
  mybusinessAttributesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.MybusinessAttributesListResponse =
        new operations.MybusinessAttributesListResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listAttributeMetadataResponse = utils.objectToClass(
              httpRes?.data,
              shared.ListAttributeMetadataResponse
            );
          }
          break;
      }
