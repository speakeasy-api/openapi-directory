...
class DescribeRaidArraysResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribeRaidArraysResult $describeRaidArraysResult
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribeRaidArraysResult $describeRaidArraysResult = null;
	...
	{
		$this->contentType = "";
		$this->describeRaidArraysResult = null;
