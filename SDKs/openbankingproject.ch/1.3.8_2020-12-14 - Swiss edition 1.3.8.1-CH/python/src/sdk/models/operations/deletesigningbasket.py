...
class DeleteSigningBasketRequest:
    headers: DeleteSigningBasketHeaders = dataclasses.field()
    path_params: DeleteSigningBasketPathParams = dataclasses.field()
    security: DeleteSigningBasketSecurity = dataclasses.field()
