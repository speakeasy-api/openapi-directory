...
class GetSecretValueRequest:
    ...
    version_stage: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VersionStage'), 'exclude': lambda f: f is None }})  
