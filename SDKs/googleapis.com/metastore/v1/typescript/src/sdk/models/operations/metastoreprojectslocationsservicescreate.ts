...
export class MetastoreProjectsLocationsServicesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
