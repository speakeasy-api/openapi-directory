...
export enum POSTDescribeUsersActionEnum {
  DescribeUsers = "DescribeUsers",
}

export enum POSTDescribeUsersVersionEnum {
  TwoThousandAndFifteen0202 = "2015-02-02",
}

export class POSTDescribeUsersRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTDescribeUsersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
