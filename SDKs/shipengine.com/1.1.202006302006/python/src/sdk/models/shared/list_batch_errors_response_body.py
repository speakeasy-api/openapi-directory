...
class ListBatchErrorsResponseBodyPaginationLink:
    r"""ListBatchErrorsResponseBodyPaginationLink
...
class ListBatchErrorsResponseBody:
    r"""ListBatchErrorsResponseBody
    A batch errors response body
    """
    
    errors: list[shared_batch_response_error.BatchResponseError] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('errors') }})
    links: ListBatchErrorsResponseBodyPaginationLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
