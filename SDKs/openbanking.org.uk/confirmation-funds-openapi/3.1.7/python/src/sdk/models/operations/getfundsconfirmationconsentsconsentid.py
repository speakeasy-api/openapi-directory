...
class GetFundsConfirmationConsentsConsentIDRequest:
    headers: GetFundsConfirmationConsentsConsentIDHeaders = dataclasses.field()
    path_params: GetFundsConfirmationConsentsConsentIDPathParams = dataclasses.field()
    security: GetFundsConfirmationConsentsConsentIDSecurity = dataclasses.field()
