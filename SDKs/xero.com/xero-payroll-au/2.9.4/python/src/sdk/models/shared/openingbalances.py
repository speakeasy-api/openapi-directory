...
class OpeningBalances:
    ...
    opening_balance_date: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OpeningBalanceDate'), 'exclude': lambda f: f is None }})
    r"""Opening Balance Date. (YYYY-MM-DD)"""  
