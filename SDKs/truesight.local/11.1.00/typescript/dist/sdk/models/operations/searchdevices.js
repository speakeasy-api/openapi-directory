...
exports.SearchDevicesResponse = exports.SearchDevicesRequest = void 0;
...
var SearchDevicesRequest = /** @class */ (function (_super) {
    ...
    ], SearchDevicesRequest.prototype, "applicationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupId",
        }),
        __metadata("design:type", String)
    ], SearchDevicesRequest.prototype, "groupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], SearchDevicesRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", String)
    ], SearchDevicesRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=searchTerms",
        }),
        __metadata("design:type", String)
    ], SearchDevicesRequest.prototype, "searchTerms", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=serviceId",
        }),
        __metadata("design:type", String)
    ], SearchDevicesRequest.prototype, "serviceId", void 0);
...
var SearchDevicesResponse = /** @class */ (function (_super) {
    ...
    ], SearchDevicesResponse.prototype, "rawResponse", void 0);
