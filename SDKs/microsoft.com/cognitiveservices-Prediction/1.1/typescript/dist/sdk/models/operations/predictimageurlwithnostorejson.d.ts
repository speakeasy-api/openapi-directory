...
export declare class PredictImageUrlWithNoStoreJsonRequest extends SpeakeasyBase {
    /**
...
export declare class PredictImageUrlWithNoStoreJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * OK
