    ...
    public static void main(String[] args) {
        try {
            ...
            DpicrRequestBody req = new DpicrRequestBody(DpicrRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new DpicrRequestBodyCertificateParameters("SAP/20XX/XXX01", "123412341234");;
            ...
            DpicrResponse res = sdk.apIs.dpicr(req, new DpicrSecurity("molestiae", "minus") {{
