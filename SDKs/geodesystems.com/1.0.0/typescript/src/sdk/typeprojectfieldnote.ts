...
export class TypeProjectFieldnote {
  ...
  searchProjectFieldnote(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/project_fieldnote";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchProjectFieldnoteResponse =
        new operations.SearchProjectFieldnoteResponse({
