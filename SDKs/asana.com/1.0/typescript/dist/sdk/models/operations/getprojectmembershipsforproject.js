...
exports.GetProjectMembershipsForProjectResponse = exports.GetProjectMembershipsForProject200ApplicationJSON = exports.GetProjectMembershipsForProjectRequest = void 0;
...
var GetProjectMembershipsForProjectRequest = /** @class */ (function (_super) {
    ...
    ], GetProjectMembershipsForProjectRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], GetProjectMembershipsForProjectRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=opt_fields",
        }),
        __metadata("design:type", Array)
    ], GetProjectMembershipsForProjectRequest.prototype, "optFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=opt_pretty",
        }),
        __metadata("design:type", Boolean)
    ], GetProjectMembershipsForProjectRequest.prototype, "optPretty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project_gid",
        }),
        __metadata("design:type", String)
    ], GetProjectMembershipsForProjectRequest.prototype, "projectGid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=user" }),
        __metadata("design:type", String)
    ], GetProjectMembershipsForProjectRequest.prototype, "user", void 0);
...
var GetProjectMembershipsForProject200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ProjectMembershipCompact }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.ProjectMembershipCompact; }),
        __metadata("design:type", Array)
...
var GetProjectMembershipsForProjectResponse = /** @class */ (function (_super) {
    ...
    ], GetProjectMembershipsForProjectResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
