...
class GetDisableVpcClassicLinkQueryParams:
    action: GetDisableVpcClassicLinkActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDisableVpcClassicLinkVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisableVpcClassicLinkRequest:
    headers: GetDisableVpcClassicLinkHeaders = dataclasses.field()
    query_params: GetDisableVpcClassicLinkQueryParams = dataclasses.field()
