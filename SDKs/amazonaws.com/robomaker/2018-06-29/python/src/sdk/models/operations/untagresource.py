...
class UntagResourceRequest:
    ...
    r"""The Amazon Resource Name (ARN) of the AWS RoboMaker resource you are removing tags."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""A map that contains tag keys and tag values that will be unattached from the resource."""  
