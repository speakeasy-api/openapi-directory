...
public class Sessions {
     ...
     * 
    **/
    public openapisdk.models.operations.SessionsCreateResponse sessionsCreate(openapisdk.models.operations.SessionsCreateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/vault/sessions");
        ...
        openapisdk.models.operations.SessionsCreateResponse res = new openapisdk.models.operations.SessionsCreateResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CreateSessionResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateSessionResponse.class);
