...
class DescribeScalingPoliciesRequest:
    ...
    describe_scaling_policies_request: shared_describescalingpoliciesrequest.DescribeScalingPoliciesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
