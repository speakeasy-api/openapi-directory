...
class PostAuthorizeDbSecurityGroupIngressQueryParams:
    action: PostAuthorizeDbSecurityGroupIngressActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostAuthorizeDbSecurityGroupIngressVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostAuthorizeDbSecurityGroupIngressRequest:
    headers: PostAuthorizeDbSecurityGroupIngressHeaders = dataclasses.field()
    query_params: PostAuthorizeDbSecurityGroupIngressQueryParams = dataclasses.field()
