...
from ..shared import refundfundstransferresponse as shared_refundfundstransferresponse
...
class PostRefundFundsTransferResponse:
    ...
    refund_funds_transfer_response: Optional[shared_refundfundstransferresponse.RefundFundsTransferResponse] = dataclasses.field(default=None)
