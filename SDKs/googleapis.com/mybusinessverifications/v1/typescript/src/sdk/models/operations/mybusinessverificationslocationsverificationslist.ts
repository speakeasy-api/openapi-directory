...
export class MybusinessverificationsLocationsVerificationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessverificationsLocationsVerificationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
