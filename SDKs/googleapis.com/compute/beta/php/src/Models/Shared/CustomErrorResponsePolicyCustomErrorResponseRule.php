...
class CustomErrorResponsePolicyCustomErrorResponseRule
{
     ...
     * 
     * @var ?array<string> $matchResponseCodes
     */
	#[\JMS\Serializer\Annotation\SerializedName('matchResponseCodes')]
    #[\JMS\Serializer\Annotation\Type('array<string>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?array $matchResponseCodes = null;
     ...
     * 
     * @var ?int $overrideResponseCode
     */
	#[\JMS\Serializer\Annotation\SerializedName('overrideResponseCode')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $overrideResponseCode = null;
	...
	{
		$this->matchResponseCodes = null;
		$this->overrideResponseCode = null;
		$this->path = null;
	}
}
