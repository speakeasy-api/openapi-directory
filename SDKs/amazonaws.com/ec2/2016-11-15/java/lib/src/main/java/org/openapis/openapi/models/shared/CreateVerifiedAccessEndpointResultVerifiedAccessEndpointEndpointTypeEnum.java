 ...
 */
public enum CreateVerifiedAccessEndpointResultVerifiedAccessEndpointEndpointTypeEnum {
    ...
    private CreateVerifiedAccessEndpointResultVerifiedAccessEndpointEndpointTypeEnum(String value) {
        this.value = value;
    }
}
