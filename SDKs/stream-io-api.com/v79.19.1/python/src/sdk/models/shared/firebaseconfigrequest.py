...
class FirebaseConfigRequest:
    ...
    data_template: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data_template'), 'exclude': lambda f: f is None }})  
