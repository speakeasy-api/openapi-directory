...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/apmcservices/3.0.0/go
```
...
func main() {
    ...
    res, err := s.APIs.Apmcl(ctx, operations.ApmclRequestBody{
        ...
        Format: operations.ApmclRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.ApmclSecurity{
