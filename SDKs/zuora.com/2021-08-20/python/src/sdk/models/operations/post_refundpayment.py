...
from ..shared import getrefundpaymenttype as shared_getrefundpaymenttype
from ..shared import postrefundtype as shared_postrefundtype
...
class POSTRefundPaymentRequest:
    ...
    r"""The unique ID of an unapplied payment. For example, 8a8082e65b27f6c3015b89e4344c16b1."""  
    post_refund_type: shared_postrefundtype.PostRefundType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class POSTRefundPaymentResponse:
    ...
    get_refund_payment_type: Optional[shared_getrefundpaymenttype.GETRefundPaymentType] = dataclasses.field(default=None)  
