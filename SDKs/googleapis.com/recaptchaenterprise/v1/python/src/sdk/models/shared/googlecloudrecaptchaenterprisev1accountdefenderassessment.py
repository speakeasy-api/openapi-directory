...
class GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessment:
    ...
    labels: Optional[list[GoogleCloudRecaptchaenterpriseV1AccountDefenderAssessmentLabelsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labels') }})
