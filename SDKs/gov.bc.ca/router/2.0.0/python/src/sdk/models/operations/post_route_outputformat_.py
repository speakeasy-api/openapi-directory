...
class PostRouteOutputFormatPathParams:
    output_format: PostRouteOutputFormatOutputFormatEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class PostRouteOutputFormatQueryParams:
    ...
    criteria: Optional[PostRouteOutputFormatCriteriaEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'criteria', 'style': 'form', 'explode': True }})
    ...
    distance_unit: Optional[PostRouteOutputFormatDistanceUnitEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'distanceUnit', 'style': 'form', 'explode': True }})
...
class PostRouteOutputFormatRequest:
    path_params: PostRouteOutputFormatPathParams = dataclasses.field()
    query_params: PostRouteOutputFormatQueryParams = dataclasses.field()
