...
func (s *Projects) GetDefaultProject(ctx context.Context) (*operations.GetDefaultProjectResponse, error) {
	baseURL := s._serverURL
...
func (s *Projects) ListProjects(ctx context.Context) (*operations.ListProjectsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/projects"
...
func (s *Projects) PatchDefaultProject(ctx context.Context, request operations.PatchDefaultProjectRequest) (*operations.PatchDefaultProjectResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/projects/default"
...
func (s *Projects) PatchProject(ctx context.Context, request operations.PatchProjectRequest) (*operations.PatchProjectResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/projects/{project_id}", request.PathParams)
...
func (s *Projects) UpdateDefaultProject(ctx context.Context, request operations.UpdateDefaultProjectRequest) (*operations.UpdateDefaultProjectResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/projects/default"
