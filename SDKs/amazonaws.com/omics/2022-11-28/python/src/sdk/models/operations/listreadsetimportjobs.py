...
from ..shared import listreadsetimportjobsresponse as shared_listreadsetimportjobsresponse
...
class ListReadSetImportJobsRequestBodyFilter:
    r"""A filter for import read set jobs."""
    ...
    status: Optional[shared_readsetimportjobstatus_enum.ReadSetImportJobStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
...
class ListReadSetImportJobsRequestBody:
    ...
    filter: Optional[ListReadSetImportJobsRequestBodyFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filter'), 'exclude': lambda f: f is None }})
    r"""A filter for import read set jobs."""  
...
class ListReadSetImportJobsRequest:
    ...
    request_body: ListReadSetImportJobsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListReadSetImportJobsResponse:
    ...
    list_read_set_import_jobs_response: Optional[shared_listreadsetimportjobsresponse.ListReadSetImportJobsResponse] = dataclasses.field(default=None)
    r"""Success"""  
