...
var RandomSplitActivity = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: randomsplitentry_1.RandomSplitEntry }),
        (0, class_transformer_1.Expose)({ name: "Branches" }),
        (0, class_transformer_1.Type)(function () { return randomsplitentry_1.RandomSplitEntry; }),
