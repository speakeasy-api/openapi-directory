...
var IosDeviceCatalog = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: iosmodel_1.IosModel }),
        (0, class_transformer_1.Expose)({ name: "models" }),
        (0, class_transformer_1.Type)(function () { return iosmodel_1.IosModel; }),
        __metadata("design:type", Array)
    ], IosDeviceCatalog.prototype, "models", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "runtimeConfiguration" }),
        (0, class_transformer_1.Type)(function () { return iosruntimeconfiguration_1.IosRuntimeConfiguration; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: iosversion_1.IosVersion }),
        (0, class_transformer_1.Expose)({ name: "versions" }),
        (0, class_transformer_1.Type)(function () { return iosversion_1.IosVersion; }),
        __metadata("design:type", Array)
    ], IosDeviceCatalog.prototype, "versions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: xcodeversion_1.XcodeVersion }),
        (0, class_transformer_1.Expose)({ name: "xcodeVersions" }),
        (0, class_transformer_1.Type)(function () { return xcodeversion_1.XcodeVersion; }),
        __metadata("design:type", Array)
