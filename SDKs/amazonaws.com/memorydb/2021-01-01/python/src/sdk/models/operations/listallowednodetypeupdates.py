...
class ListAllowedNodeTypeUpdatesRequest:
    ...
    list_allowed_node_type_updates_request: shared_listallowednodetypeupdatesrequest.ListAllowedNodeTypeUpdatesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
