...
class SearchLidarCollectionQueryParams:
...
@dataclasses.dataclass
class SearchLidarCollectionRequest:
    query_params: SearchLidarCollectionQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchLidarCollectionResponse:
