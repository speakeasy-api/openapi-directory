...
var Event = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=division_keys" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=event_type_string" }),
        __metadata("design:type", String)
    ], Event.prototype, "eventTypeString", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=first_event_code" }),
        __metadata("design:type", String)
    ], Event.prototype, "firstEventCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=first_event_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=parent_event_key" }),
        __metadata("design:type", String)
    ], Event.prototype, "parentEventKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=playoff_type" }),
        __metadata("design:type", Number)
    ], Event.prototype, "playoffType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=playoff_type_string" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=short_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=webcasts", elemType: webcast_1.Webcast }),
        __metadata("design:type", Array)
