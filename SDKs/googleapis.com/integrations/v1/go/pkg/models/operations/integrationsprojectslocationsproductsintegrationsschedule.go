...
type IntegrationsProjectsLocationsProductsIntegrationsScheduleRequest struct {
	...
	GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest *shared.GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest `request:"mediaType=application/json"`
	// OAuth access token.
