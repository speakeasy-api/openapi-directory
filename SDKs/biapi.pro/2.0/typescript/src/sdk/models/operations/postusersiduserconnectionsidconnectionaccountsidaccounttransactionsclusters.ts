...
export class PostUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsclustersRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PostUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsclustersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
