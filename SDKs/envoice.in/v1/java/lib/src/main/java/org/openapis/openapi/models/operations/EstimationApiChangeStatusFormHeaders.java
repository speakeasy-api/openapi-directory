...
public class EstimationApiChangeStatusFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiChangeStatusFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiChangeStatusFormHeaders withXAuthSecret(String xAuthSecret) {
