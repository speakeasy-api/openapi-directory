...
class Items:
    ...
    def create_vault_item(self, request: operations.CreateVaultItemRequest) -> operations.CreateVaultItemResponse:
        ...
        res = operations.CreateVaultItemResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FullItem])
                res.full_item = out
    ...
    def delete_vault_item(self, request: operations.DeleteVaultItemRequest) -> operations.DeleteVaultItemResponse:
        ...
        res = operations.DeleteVaultItemResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_vault_item_by_id(self, request: operations.GetVaultItemByIDRequest) -> operations.GetVaultItemByIDResponse:
        ...
        res = operations.GetVaultItemByIDResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_vault_items(self, request: operations.GetVaultItemsRequest) -> operations.GetVaultItemsResponse:
        ...
        res = operations.GetVaultItemsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.Item]])
                res.items = out
        elif r.status_code == 401:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ErrorResponse])
    ...
    def patch_vault_item(self, request: operations.PatchVaultItemRequest) -> operations.PatchVaultItemResponse:
        ...
        res = operations.PatchVaultItemResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_vault_item(self, request: operations.UpdateVaultItemRequest) -> operations.UpdateVaultItemResponse:
        ...
        res = operations.UpdateVaultItemResponse(status_code=r.status_code, content_type=content_type)
