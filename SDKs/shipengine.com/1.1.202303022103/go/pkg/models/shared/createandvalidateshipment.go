...
func (e *CreateAndValidateShipmentDeliveryConfirmationEnum) UnmarshalJSON(data []byte) error {
	...
	case "verbal_confirmation":
		*e = CreateAndValidateShipmentDeliveryConfirmationEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateAndValidateShipmentDeliveryConfirmationEnum: %s", s)
	}
}
...
func (e *CreateAndValidateShipmentInternationalShipmentOptionsPackageContentsEnum) UnmarshalJSON(data []byte) error {
	...
	case "returned_goods":
		fallthrough
	case "sample":
		*e = CreateAndValidateShipmentInternationalShipmentOptionsPackageContentsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateAndValidateShipmentInternationalShipmentOptionsPackageContentsEnum: %s", s)
	}
}
...
func (e *CreateAndValidateShipmentInternationalShipmentOptionsNonDeliveryEnum) UnmarshalJSON(data []byte) error {
	...
	case "treat_as_abandoned":
		*e = CreateAndValidateShipmentInternationalShipmentOptionsNonDeliveryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateAndValidateShipmentInternationalShipmentOptionsNonDeliveryEnum: %s", s)
	}
}
...
func (e *CreateAndValidateShipmentInsuranceProviderEnum) UnmarshalJSON(data []byte) error {
	...
	case "carrier":
		fallthrough
	case "third_party":
		*e = CreateAndValidateShipmentInsuranceProviderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateAndValidateShipmentInsuranceProviderEnum: %s", s)
	}
}
...
func (e *CreateAndValidateShipmentOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "pickup":
		fallthrough
	case "drop_off":
		*e = CreateAndValidateShipmentOriginTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateAndValidateShipmentOriginTypeEnum: %s", s)
	}
}
...
func (e *CreateAndValidateShipmentShipmentStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "label_purchased":
		fallthrough
	case "cancelled":
		*e = CreateAndValidateShipmentShipmentStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateAndValidateShipmentShipmentStatusEnum: %s", s)
	}
}
