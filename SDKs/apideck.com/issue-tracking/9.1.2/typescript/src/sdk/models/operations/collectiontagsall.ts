...
export class CollectionTagsAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CollectionTagsAllRequest extends SpeakeasyBase {
  /**
   * The collection ID
   */
  @SpeakeasyMetadata({
...
export class CollectionTagsAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
