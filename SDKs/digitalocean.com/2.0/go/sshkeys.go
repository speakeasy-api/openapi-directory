...
func (s *SSHKeys) CreateSSHKey(ctx context.Context, request operations.CreateSSHKeyRequest) (*operations.CreateSSHKeyResponse, error) {
...
func (s *SSHKeys) DestroySSHKey(ctx context.Context, request operations.DestroySSHKeyRequest) (*operations.DestroySSHKeyResponse, error) {
	baseURL := s._serverURL
...
func (s *SSHKeys) ListAllKeys(ctx context.Context, request operations.ListAllKeysRequest) (*operations.ListAllKeysResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/account/keys"
...
func (s *SSHKeys) UpdateSSHKey(ctx context.Context, request operations.UpdateSSHKeyRequest) (*operations.UpdateSSHKeyResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/account/keys/{ssh_key_identifier}", request.PathParams)
