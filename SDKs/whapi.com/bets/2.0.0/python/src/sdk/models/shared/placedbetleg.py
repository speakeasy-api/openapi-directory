...
class PlacedBetLeg:
    ...
    r"""The leg number of the bet"""  
    parts: list[shared_placedbetpart.PlacedBetPart] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parts') }})  
