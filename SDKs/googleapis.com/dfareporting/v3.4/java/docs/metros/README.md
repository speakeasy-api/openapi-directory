...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DfareportingMetrosListRequest req = new DfareportingMetrosListRequest("dolores") {{
            ...
            DfareportingMetrosListResponse res = sdk.metros.dfareportingMetrosList(req, new DfareportingMetrosListSecurity("dolorem", "mollitia") {{
