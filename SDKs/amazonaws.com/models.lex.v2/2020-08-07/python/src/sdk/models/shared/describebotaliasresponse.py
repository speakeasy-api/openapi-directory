...
class DescribeBotAliasResponse:
    ...
    bot_alias_history_events: Optional[list[shared_botaliashistoryevent.BotAliasHistoryEvent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('botAliasHistoryEvents'), 'exclude': lambda f: f is None }})  
