...
class AdsensehostCustomchannelsDeleteRequest:
    path_params: AdsensehostCustomchannelsDeletePathParams = dataclasses.field()
    query_params: AdsensehostCustomchannelsDeleteQueryParams = dataclasses.field()
    security: AdsensehostCustomchannelsDeleteSecurity = dataclasses.field()
