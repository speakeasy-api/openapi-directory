 ...
 */
export declare enum TargetHttpProxyAggregatedListWarningCodeEnum {
...
export declare class TargetHttpProxyAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetHttpProxyAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetHttpProxyAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetHttpProxyAggregatedListWarningData[];
    /**
...
export declare class TargetHttpProxyAggregatedList extends SpeakeasyBase {
     ...
     * [Output Only] Informational warning message.
     */
    warning?: TargetHttpProxyAggregatedListWarning;
}
