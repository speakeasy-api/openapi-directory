...
export enum POSTListServerCertificatesActionEnum {
  ListServerCertificates = "ListServerCertificates",
}

export enum POSTListServerCertificatesVersionEnum {
  TwoThousandAndTen0508 = "2010-05-08",
}

export class POSTListServerCertificatesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTListServerCertificatesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
