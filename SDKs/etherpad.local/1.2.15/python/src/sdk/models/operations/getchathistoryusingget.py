...
class GetChatHistoryUsingGet200ApplicationJSONData:
    messages: Optional[list[GetChatHistoryUsingGet200ApplicationJSONDataMessages]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('messages') }})
...
class GetChatHistoryUsingGet200ApplicationJSON:
    ...
    data: Optional[GetChatHistoryUsingGet200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetChatHistoryUsingGetRequest:
    query_params: GetChatHistoryUsingGetQueryParams = dataclasses.field()
...
class GetChatHistoryUsingGetResponse:
    ...
    get_chat_history_using_get_200_application_json_object: Optional[GetChatHistoryUsingGet200ApplicationJSON] = dataclasses.field(default=None)
    get_chat_history_using_get_400_application_json_object: Optional[GetChatHistoryUsingGet400ApplicationJSON] = dataclasses.field(default=None)
    get_chat_history_using_get_401_application_json_object: Optional[GetChatHistoryUsingGet401ApplicationJSON] = dataclasses.field(default=None)
    get_chat_history_using_get_500_application_json_object: Optional[GetChatHistoryUsingGet500ApplicationJSON] = dataclasses.field(default=None)
