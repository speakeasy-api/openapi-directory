...
const (
	TagResourceXAmzTargetEnumAwsCloud9WorkspaceManagementServiceTagResource TagResourceXAmzTargetEnum = "AWSCloud9WorkspaceManagementService.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSCloud9WorkspaceManagementService.TagResource":
