...
public class GetRecommendedLocationQueryParams {
    /**
    ...
    public GetRecommendedLocationQueryParams withCityCodes(String cityCodes) {
    ...
    public GetRecommendedLocationQueryParams withDestinationCountryCodes(String destinationCountryCodes) {
    ...
    public GetRecommendedLocationQueryParams withTravelerCountryCode(String travelerCountryCode) {
