...
class ListTableRowsRequest:
    headers: ListTableRowsHeaders = dataclasses.field()
    path_params: ListTableRowsPathParams = dataclasses.field()
    query_params: ListTableRowsQueryParams = dataclasses.field()
    request: ListTableRowsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
