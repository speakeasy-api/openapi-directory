...
var Message = /** @class */ (function () {
    function Message(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Message.prototype.getMessages = function (req, config) {
     ...
     *
    **/
    Message.prototype.getMessagesSend = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Message.prototype.getMessagesId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Message.prototype.getMessagesIdRelatedReceivedMessages = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Message.prototype.postMessages = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
