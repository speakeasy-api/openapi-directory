...
class RejectResourceShareInvitationRequest:
    headers: RejectResourceShareInvitationHeaders = dataclasses.field()
    request: RejectResourceShareInvitationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
