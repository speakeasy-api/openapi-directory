...
@dataclasses.dataclass
class MybusinessAccountsLocationsReviewsDeleteReplyQueryParams:
...
class MybusinessAccountsLocationsReviewsDeleteReplyRequest:
    path_params: MybusinessAccountsLocationsReviewsDeleteReplyPathParams = dataclasses.field()
    query_params: MybusinessAccountsLocationsReviewsDeleteReplyQueryParams = dataclasses.field()
