...
from ..shared import updatebackendapiresponse as shared_updatebackendapiresponse
...
class UpdateBackendAPIRequestBodyResourceConfigConflictResolution:
    r"""UpdateBackendAPIRequestBodyResourceConfigConflictResolution
...
@dataclass_json
@dataclasses.dataclass
class UpdateBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings:
    r"""UpdateBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings
...
class UpdateBackendAPIRequestBodyResourceConfigDefaultAuthType:
    r"""UpdateBackendAPIRequestBodyResourceConfigDefaultAuthType
    ...
    settings: Optional[UpdateBackendAPIRequestBodyResourceConfigDefaultAuthTypeSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Settings') }})
...
class UpdateBackendAPIRequestBodyResourceConfig:
    ...
    conflict_resolution: Optional[UpdateBackendAPIRequestBodyResourceConfigConflictResolution] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ConflictResolution') }})
    default_auth_type: Optional[UpdateBackendAPIRequestBodyResourceConfigDefaultAuthType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultAuthType') }})
...
class UpdateBackendAPIRequestBody:
    ...
    resource_config: Optional[UpdateBackendAPIRequestBodyResourceConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceConfig') }})
    

@dataclasses.dataclass
class UpdateBackendAPIRequest:
    headers: UpdateBackendAPIHeaders = dataclasses.field()
    path_params: UpdateBackendAPIPathParams = dataclasses.field()
    request: UpdateBackendAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateBackendAPIResponse:
    ...
    update_backend_api_response: Optional[shared_updatebackendapiresponse.UpdateBackendAPIResponse] = dataclasses.field(default=None)
