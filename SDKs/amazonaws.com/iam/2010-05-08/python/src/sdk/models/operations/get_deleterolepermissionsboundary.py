...
class GetDeleteRolePermissionsBoundaryQueryParams:
    action: GetDeleteRolePermissionsBoundaryActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetDeleteRolePermissionsBoundaryVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteRolePermissionsBoundaryRequest:
    headers: GetDeleteRolePermissionsBoundaryHeaders = dataclasses.field()
    query_params: GetDeleteRolePermissionsBoundaryQueryParams = dataclasses.field()
