...
public class RequestCustomerHeaders {
    /**
    ...
    public RequestCustomerHeaders withXSdsDateFormat(RequestCustomerXSdsDateFormatEnum xSdsDateFormat) {
    ...
    public RequestCustomerHeaders withXSdsServiceToken(String xSdsServiceToken) {
