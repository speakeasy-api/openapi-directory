...
class DcimConsoleServerPortTemplatesPartialUpdateRequest:
    ...
    writable_console_server_port_template_input: shared_writableconsoleserverporttemplate.WritableConsoleServerPortTemplateInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
