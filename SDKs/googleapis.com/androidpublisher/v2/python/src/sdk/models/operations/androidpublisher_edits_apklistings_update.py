...
class AndroidpublisherEditsApklistingsUpdateRequest:
    ...
    r"""The APK version code whose APK-specific listings should be read or modified."""  
    ...
    r"""The language code (a BCP-47 language tag) of the APK-specific localized listing to read or modify. For example, to select Austrian German, pass \\"de-AT\\"."""  
    ...
    apk_listing: Optional[shared_apklisting.ApkListing] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
