...
var CompanyViewModel = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "bookingWebhookUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "customerWebhookUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "disableEmailAndSmsNotifications" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notificationFromEmailAddress" }),
        __metadata("design:type", String)
    ], CompanyViewModel.prototype, "notificationFromEmailAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notificationFromName" }),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CompanyViewModel.prototype, "object", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "registrationEmail" }),
        __metadata("design:type", String)
    ], CompanyViewModel.prototype, "registrationEmail", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "reminderWebhookUrl" }),
        __metadata("design:type", String)
    ], CompanyViewModel.prototype, "reminderWebhookUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "resourceWebhookUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CompanyViewModel.prototype, "timezoneName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "webhookSignatureHash" }),
        __metadata("design:type", String)
    ], CompanyViewModel.prototype, "webhookSignatureHash", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
