 ...
 * @access public
 */
class InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferIntention
{
    /**
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferIntentionCurrencyEnum $currency
     */
	#[\JMS\Serializer\Annotation\SerializedName('currency')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferIntentionCurrencyEnum>')]
    public InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferIntentionCurrencyEnum $currency;
	...
	public function __construct()
	{
		...
		$this->addressZip = "";
		$this->amount = 0;
		$this->currency = \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferIntentionCurrencyEnum::CAD;
		$this->recipientName = "";
		$this->transferId = "";
	}
}
