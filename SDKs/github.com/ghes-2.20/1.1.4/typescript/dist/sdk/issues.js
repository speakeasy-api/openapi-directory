            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.issueSimple = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IssueSimple);
                    }
                    break;
            }
            return res;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.issueSimples = [];
                        var resFieldDepth = utils.getResFieldDepth(res);
                        res.issueSimples = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.IssueSimple, resFieldDepth);
                    }
                    break;
