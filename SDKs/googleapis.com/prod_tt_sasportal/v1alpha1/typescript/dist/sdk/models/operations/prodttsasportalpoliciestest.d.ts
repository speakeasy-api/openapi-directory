...
export declare class ProdTtSasportalPoliciesTestSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalPoliciesTestSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ProdTtSasportalPoliciesTestSecurity extends SpeakeasyBase {
    option1?: ProdTtSasportalPoliciesTestSecurityOption1;
    option2?: ProdTtSasportalPoliciesTestSecurityOption2;
}
