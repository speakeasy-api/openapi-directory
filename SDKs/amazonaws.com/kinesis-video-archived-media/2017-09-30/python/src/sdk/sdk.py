...
SERVERS = [
    ...
    r"""The Kinesis Video Archived Media multi-region endpoint"""
    "https://kinesisvideo.{region}.amazonaws.com",
    r"""The Kinesis Video Archived Media multi-region endpoint"""
    "http://kinesisvideo.{region}.amazonaws.com.cn",
    r"""The Kinesis Video Archived Media endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def get_clip(self, request: operations.GetClipRequest) -> operations.GetClipResponse:
        ...
        res = operations.GetClipResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetClipOutput])
    ...
    def get_dash_streaming_session_url(self, request: operations.GetDASHStreamingSessionURLRequest) -> operations.GetDASHStreamingSessionURLResponse:
        ...
        res = operations.GetDASHStreamingSessionURLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDASHStreamingSessionURLOutput])
    ...
    def get_hls_streaming_session_url(self, request: operations.GetHLSStreamingSessionURLRequest) -> operations.GetHLSStreamingSessionURLResponse:
        ...
        res = operations.GetHLSStreamingSessionURLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetHLSStreamingSessionURLOutput])
    ...
    def get_images(self, request: operations.GetImagesRequest) -> operations.GetImagesResponse:
        r"""Retrieves a list of Images corresponding to each timestamp for a given time range, sampling interval, and image format configuration."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/getImages'
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetImagesOutput])
                res.get_images_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_media_for_fragment_list(self, request: operations.GetMediaForFragmentListRequest) -> operations.GetMediaForFragmentListResponse:
        ...
        res = operations.GetMediaForFragmentListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetMediaForFragmentListOutput])
    ...
    def list_fragments(self, request: operations.ListFragmentsRequest) -> operations.ListFragmentsResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListFragmentsRequest, request)
        ...
        res = operations.ListFragmentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListFragmentsOutput])
