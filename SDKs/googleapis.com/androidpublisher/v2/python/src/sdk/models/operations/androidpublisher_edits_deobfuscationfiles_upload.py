...
class AndroidpublisherEditsDeobfuscationfilesUploadRequest:
    ...
    r"""The version code of the APK whose deobfuscation file is being uploaded."""  
    ...
    r"""Unique identifier of the Android app for which the deobfuscation files are being uploaded; for example, \\"com.spiffygame\\"."""  
