...
class ClearMerchantOrderInfoListV3Request:
    ...
    clear_merchant_order_info_list_request: shared_clearmerchantorderinfolistrequest.ClearMerchantOrderInfoListRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
