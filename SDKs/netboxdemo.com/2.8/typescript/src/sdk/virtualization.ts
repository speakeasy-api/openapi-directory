...
export class Virtualization {
  ...
  virtualizationInterfacesCreate(
    req: shared.WritableVirtualMachineInterfaceInput,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.virtualMachineInterface = utils.objectToClass(
              httpRes?.data,
              shared.VirtualMachineInterface
            );
          }
          break;
      }
  ...
  virtualizationInterfacesPartialUpdate(
    ...
    try {
      [reqBodyHeaders, reqBody] = utils.serializeRequestBody(
        req,
        "writableVirtualMachineInterfaceInput",
        "json"
      );
    } catch (e: unknown) {
      if (e instanceof Error) {
  ...
  virtualizationVirtualMachinesCreate(
    req: shared.WritableVirtualMachineWithConfigContextInput,
    config?: AxiosRequestConfig
  ...
  virtualizationVirtualMachinesPartialUpdate(
    ...
    try {
      [reqBodyHeaders, reqBody] = utils.serializeRequestBody(
        req,
        "writableVirtualMachineWithConfigContextInput",
        "json"
      );
    } catch (e: unknown) {
      if (e instanceof Error) {
