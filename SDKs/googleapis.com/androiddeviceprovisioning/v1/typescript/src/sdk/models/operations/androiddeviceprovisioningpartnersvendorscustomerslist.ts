...
export class AndroiddeviceprovisioningPartnersVendorsCustomersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AndroiddeviceprovisioningPartnersVendorsCustomersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
