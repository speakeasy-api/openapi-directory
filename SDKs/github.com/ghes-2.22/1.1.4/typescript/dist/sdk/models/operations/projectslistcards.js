...
exports.ProjectsListCardsResponse = exports.ProjectsListCardsRequest = exports.ProjectsListCardsArchivedStateEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Filters the project cards that are returned by the card's state. Can be one of `all`,`archived`, or `not_archived`.
 */
var ProjectsListCardsArchivedStateEnum;
...
})(ProjectsListCardsArchivedStateEnum = exports.ProjectsListCardsArchivedStateEnum || (exports.ProjectsListCardsArchivedStateEnum = {}));
var ProjectsListCardsRequest = /** @class */ (function (_super) {
    ...
    ], ProjectsListCardsRequest.prototype, "archivedState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=column_id",
        }),
        __metadata("design:type", Number)
    ], ProjectsListCardsRequest.prototype, "columnId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ProjectsListCardsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ProjectsListCardsRequest.prototype, "perPage", void 0);
...
var ProjectsListCardsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ProjectsListCardsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
