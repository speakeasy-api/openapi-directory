...
class ListMessagingConfigurationListMessagingConfigurationResponse:
    ...
    messaging_configurations: Optional[list[shared_verify_v2_service_messaging_configuration.VerifyV2ServiceMessagingConfiguration]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messaging_configurations'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListMessagingConfigurationListMessagingConfigurationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
