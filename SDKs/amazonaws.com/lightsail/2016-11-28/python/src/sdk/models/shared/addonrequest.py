...
class AddOnRequest:
    ...
    auto_snapshot_add_on_request: Optional[shared_autosnapshotaddonrequest.AutoSnapshotAddOnRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('autoSnapshotAddOnRequest') }})
