...
use \OpenAPI\OpenAPI\Models\Operations\FacetscategoryRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FacetscategoryRequest();
    ...
    $response = $sdk->facets->facetscategory($request);

    if ($response->facetscategory200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest();
    $request->accept = 'application/json';
    $request->contentType = 'application/json';
    $request->from = '1';
    $request->to = '50';
    ...
    $response = $sdk->facets->getApiCatalogSystemPubFacetsCategoryCategoryId($request);

    if ($response->getApiCatalogSystemPubFacetsCategoryCategoryId200ApplicationJSONObjects !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
