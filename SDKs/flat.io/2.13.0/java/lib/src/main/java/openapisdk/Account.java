...
public class Account {
     ...
     * 
    **/
    public openapisdk.models.operations.GetAuthenticatedUserResponse getAuthenticatedUser(openapisdk.models.operations.GetAuthenticatedUserRequest request) throws Exception {
        ...
        openapisdk.models.operations.GetAuthenticatedUserResponse res = new openapisdk.models.operations.GetAuthenticatedUserResponse() {{
            userDetails = null;
