...
class DeleteEventTrackerRequest:
    ...
    delete_event_tracker_request: shared_deleteeventtrackerrequest.DeleteEventTrackerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
