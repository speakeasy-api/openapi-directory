...
export class DatastreamProjectsLocationsStreamsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsStreamsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsStreamsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
