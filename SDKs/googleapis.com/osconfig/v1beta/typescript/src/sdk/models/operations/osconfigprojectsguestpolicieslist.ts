...
export class OsconfigProjectsGuestPoliciesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OsconfigProjectsGuestPoliciesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OsconfigProjectsGuestPoliciesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
