...
type ListCustomEntityTypesQueryParams struct {
	// Pagination limit
...
type ListCustomEntityTypesHeaders struct {
...
type ListCustomEntityTypesRequest struct {
	QueryParams ListCustomEntityTypesQueryParams
	Headers     ListCustomEntityTypesHeaders
	Request     shared.ListCustomEntityTypesRequest `request:"mediaType=application/json"`
}
