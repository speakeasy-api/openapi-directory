...
class PoolRemoveNodesRequest:
    headers: PoolRemoveNodesHeaders = dataclasses.field()
    path_params: PoolRemoveNodesPathParams = dataclasses.field()
    query_params: PoolRemoveNodesQueryParams = dataclasses.field()
