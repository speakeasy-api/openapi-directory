...
class GETDetectStackSetDriftRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETDetectStackSetDriftCallAsEnum $callAs
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=CallAs')]
    public ?GETDetectStackSetDriftCallAsEnum $callAs = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETDetectStackSetDriftOperationPreferences $operationPreferences
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=OperationPreferences')]
    public ?GETDetectStackSetDriftOperationPreferences $operationPreferences = null;
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETDetectStackSetDriftActionEnum::DETECT_STACK_SET_DRIFT;
		$this->callAs = null;
		$this->operationId = null;
		$this->operationPreferences = null;
		$this->stackSetName = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETDetectStackSetDriftVersionEnum::TWO_THOUSAND_AND_TEN0515;
