...
class OBWriteInternationalStandingOrderResponse7DataInitiation
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationCreditor $creditor
     */
	#[\JMS\Serializer\Annotation\SerializedName('Creditor')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationCreditor')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrderResponse7DataInitiationCreditor $creditor = null;
    
    /**
     * Provides the details to identify the beneficiary account.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAccount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAgent $creditorAgent
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAgent')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAgent')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAgent $creditorAgent = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount $debtorAccount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationInstructedAmount $instructedAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('InstructedAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationInstructedAmount')]
	...
	public function __construct()
	{
		...
		$this->creditor = null;
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAccount();
		...
		$this->frequency = "";
		$this->instructedAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrderResponse7DataInitiationInstructedAmount();
