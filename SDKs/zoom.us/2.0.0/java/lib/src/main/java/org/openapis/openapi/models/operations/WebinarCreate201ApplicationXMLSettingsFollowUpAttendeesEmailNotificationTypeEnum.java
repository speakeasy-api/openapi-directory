 ...
 */
public enum WebinarCreate201ApplicationXMLSettingsFollowUpAttendeesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreate201ApplicationXMLSettingsFollowUpAttendeesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
