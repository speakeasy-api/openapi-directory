...
public class ListAccountStatementsQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=account_id")
    public String accountId;
    public ListAccountStatementsQueryParams withAccountId(String accountId) {
    ...
    public ListAccountStatementsQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public Long limit;
    public ListAccountStatementsQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListAccountStatementsQueryParams withStatementPeriodStartAfter(OffsetDateTime statementPeriodStartAfter) {
    ...
    public ListAccountStatementsQueryParams withStatementPeriodStartBefore(OffsetDateTime statementPeriodStartBefore) {
    ...
    public ListAccountStatementsQueryParams withStatementPeriodStartOnOrAfter(OffsetDateTime statementPeriodStartOnOrAfter) {
    ...
    public ListAccountStatementsQueryParams withStatementPeriodStartOnOrBefore(OffsetDateTime statementPeriodStartOnOrBefore) {
