...
func (s *blogs) BloggerBlogsGetByURL(ctx context.Context, request operations.BloggerBlogsGetByURLRequest, security operations.BloggerBlogsGetByURLSecurity) (*operations.BloggerBlogsGetByURLResponse, error) {
	baseURL := s.serverURL
