...
exports.VoiceV1ByocTrunk = exports.VoiceV1ByocTrunkVoiceMethodEnum = exports.VoiceV1ByocTrunkVoiceFallbackMethodEnum = exports.VoiceV1ByocTrunkStatusCallbackMethodEnum = void 0;
var utils_1 = require("../../../internal/utils");
var class_transformer_1 = require("class-transformer");
/**
 * The HTTP method we use to call `status_callback_url`. Either `GET` or `POST`.
 */
var VoiceV1ByocTrunkStatusCallbackMethodEnum;
...
})(VoiceV1ByocTrunkStatusCallbackMethodEnum = exports.VoiceV1ByocTrunkStatusCallbackMethodEnum || (exports.VoiceV1ByocTrunkStatusCallbackMethodEnum = {}));
/**
 * The HTTP method we use to call `voice_fallback_url`. Can be: `GET` or `POST`.
 */
var VoiceV1ByocTrunkVoiceFallbackMethodEnum;
...
})(VoiceV1ByocTrunkVoiceFallbackMethodEnum = exports.VoiceV1ByocTrunkVoiceFallbackMethodEnum || (exports.VoiceV1ByocTrunkVoiceFallbackMethodEnum = {}));
/**
 * The HTTP method we use to call `voice_url`. Can be: `GET` or `POST`.
 */
var VoiceV1ByocTrunkVoiceMethodEnum;
...
})(VoiceV1ByocTrunkVoiceMethodEnum = exports.VoiceV1ByocTrunkVoiceMethodEnum || (exports.VoiceV1ByocTrunkVoiceMethodEnum = {}));
/**
 * Created
 */
var VoiceV1ByocTrunk = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "connection_policy_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "from_domain_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "status_callback_url" }),
        __metadata("design:type", String)
