...
class ConstraintViolation:
    constraint_type: Optional[ConstraintViolationConstraintTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraintType') }})
    ...
    expected: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('expected') }})
