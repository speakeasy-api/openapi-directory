...
export class NetworksecurityProjectsLocationsUrlListsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsUrlListsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
