...
from ..shared import security as shared_security
from ..shared import goals as shared_goals
...
class AnalyticsManagementGoalsListSecurity:
    ...
    option3: Optional[AnalyticsManagementGoalsListSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
...
class AnalyticsManagementGoalsListResponse:
    ...
    goals: Optional[shared_goals.Goals] = dataclasses.field(default=None)
