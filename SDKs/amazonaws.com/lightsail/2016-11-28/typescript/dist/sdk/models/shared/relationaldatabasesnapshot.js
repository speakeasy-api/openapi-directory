...
var RelationalDatabaseSnapshot = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fromRelationalDatabaseArn" }),
        __metadata("design:type", String)
    ], RelationalDatabaseSnapshot.prototype, "fromRelationalDatabaseArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fromRelationalDatabaseBlueprintId" }),
        __metadata("design:type", String)
    ], RelationalDatabaseSnapshot.prototype, "fromRelationalDatabaseBlueprintId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fromRelationalDatabaseBundleId" }),
        __metadata("design:type", String)
    ], RelationalDatabaseSnapshot.prototype, "fromRelationalDatabaseBundleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fromRelationalDatabaseName" }),
        __metadata("design:type", String)
