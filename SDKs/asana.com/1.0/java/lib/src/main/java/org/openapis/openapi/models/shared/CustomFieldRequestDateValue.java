 ...
 */
public class CustomFieldRequestDateValue {
    /**
    ...
    @JsonProperty("date")
    public String date;
    public CustomFieldRequestDateValue withDate(String date) {
        this.date = date;
        return this;
    }
    ...
    public CustomFieldRequestDateValue withDateTime(String dateTime) {
