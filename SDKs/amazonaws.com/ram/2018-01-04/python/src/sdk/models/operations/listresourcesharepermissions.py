...
class ListResourceSharePermissionsRequestBody:
    ...
    r"""Specifies the <a href=\\"https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html\\">Amazon Resoure Name (ARN)</a> of the resource share for which you want to retrieve the associated permissions."""  
...
class ListResourceSharePermissionsRequest:
    ...
    request_body: ListResourceSharePermissionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
