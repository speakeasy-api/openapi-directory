...
class POSTCreateDBClusterParameterGroupRequest:
    ...
    action: POSTCreateDBClusterParameterGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    version: POSTCreateDBClusterParameterGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
