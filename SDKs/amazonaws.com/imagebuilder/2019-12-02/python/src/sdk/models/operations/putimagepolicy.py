...
class PutImagePolicyRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the image that this policy should be applied to."""  
...
class PutImagePolicyRequest:
    ...
    request_body: PutImagePolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
