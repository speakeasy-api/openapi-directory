...
class UpdateBulkInventoryRequestBody:
    ...
    file: UpdateBulkInventoryRequestBodyFile = dataclasses.field(metadata={'multipart_form': { 'file': True }})
    r"""Feed file to upload"""  
    
class UpdateBulkInventoryFeedTypeEnum(str, Enum):
    r"""The feed Type"""
    INVENTORY = 'inventory'
...
class UpdateBulkInventoryRequest:
    ...
    feed_type: UpdateBulkInventoryFeedTypeEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'feedType', 'style': 'form', 'explode': True }})
    r"""The feed Type"""  
    ...
    request_body: Optional[UpdateBulkInventoryRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})  
    ship_node: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'shipNode', 'style': 'form', 'explode': True }})
    r"""The shipNode for which the inventory is to be updated. Not required in case of Multi Node Inventory Update Feed (feedType=MP_INVENTORY)"""  
...
@dataclasses.dataclass
class UpdateBulkInventory200ApplicationXML:
