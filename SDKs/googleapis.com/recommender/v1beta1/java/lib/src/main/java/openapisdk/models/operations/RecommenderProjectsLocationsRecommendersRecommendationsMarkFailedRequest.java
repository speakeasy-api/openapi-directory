...
public class RecommenderProjectsLocationsRecommendersRecommendationsMarkFailedRequest {
    ...
    public openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest request;
    public RecommenderProjectsLocationsRecommendersRecommendationsMarkFailedRequest withRequest(openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkRecommendationFailedRequest request) {
