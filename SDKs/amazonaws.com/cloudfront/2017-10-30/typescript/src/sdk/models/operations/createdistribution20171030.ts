 ...
 */
export class CreateDistribution20171030RequestBodyDistributionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateDistribution20171030RequestBody extends SpeakeasyBase {
  /**
   * A distribution configuration.
   */
  @SpeakeasyMetadata()
  distributionConfig: CreateDistribution20171030RequestBodyDistributionConfig;
}

export class CreateDistribution20171030Request extends SpeakeasyBase {
...
export class CreateDistribution20171030Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
