...
class GetDebitMemoItemPathParams:
...
class GetDebitMemoItemRequest:
    headers: GetDebitMemoItemHeaders = dataclasses.field()
    path_params: GetDebitMemoItemPathParams = dataclasses.field()
    

@dataclasses.dataclass
class GetDebitMemoItemResponse:
    content_type: str = dataclasses.field()
    headers: dict[str, list[str]] = dataclasses.field()
    status_code: int = dataclasses.field()
    get_debit_memo_item_type: Optional[dict[str, Any]] = dataclasses.field(default=None)
