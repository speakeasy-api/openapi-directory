...
var Search = /** @class */ (function () {
    ...
    **/
    Search.prototype.youtubeSearchList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.YoutubeSearchListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/youtube/v3/search";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.searchListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
