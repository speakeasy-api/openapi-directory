...
class DataPointsGetStatisticsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsListGroupByEnum $groupBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=groupBy')]
    public ?DataPointsGetStatisticsListGroupByEnum $groupBy = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsListTimeFrameEnum $timeFrame
     */
	...
	public function __construct()
	{
		...
		$this->groupBy = null;
		$this->id = 0;
		$this->timeFrame = \OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsListTimeFrameEnum::TODAY;
		$this->toDay = null;
	}
}
