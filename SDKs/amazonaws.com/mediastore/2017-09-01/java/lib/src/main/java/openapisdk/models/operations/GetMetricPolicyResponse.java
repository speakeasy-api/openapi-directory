...
public class GetMetricPolicyResponse {
    ...
    public openapisdk.models.shared.GetMetricPolicyOutput getMetricPolicyOutput;
    public GetMetricPolicyResponse withGetMetricPolicyOutput(openapisdk.models.shared.GetMetricPolicyOutput getMetricPolicyOutput) {
    ...
    public GetMetricPolicyResponse withStatusCode(Long statusCode) {
