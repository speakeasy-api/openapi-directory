...
class GetSeriesRequest:
    ...
    r"""Limit the result to series with an ad deal of this Ad Ops profile."""  
    ...
    r"""Limit the result to series owned by this network."""  
    ...
    r"""Limit the result to series with a title or slug containing this parameter in a case-insensitive way."""  
...
class GetSeries400ApplicationVndAPIPlusJSONErrors:
    ...
    source: Optional[GetSeries400ApplicationVndAPIPlusJSONErrorsSource] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source'), 'exclude': lambda f: f is None }})
    r"""An object containing references to the source of the error, optionally including any of the following members."""  
...
class GetSeries400ApplicationVndAPIPlusJSON:
    ...
    errors: Optional[list[GetSeries400ApplicationVndAPIPlusJSONErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('errors'), 'exclude': lambda f: f is None }})
...
class GetSeries200ApplicationVndAPIPlusJSON:
    ...
    data: Optional[list[shared_series.Series]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
