...
class ClassroomCoursesCourseWorkStudentSubmissionsReclaimRequest:
    path_params: ClassroomCoursesCourseWorkStudentSubmissionsReclaimPathParams = dataclasses.field()
    query_params: ClassroomCoursesCourseWorkStudentSubmissionsReclaimQueryParams = dataclasses.field()
    security: ClassroomCoursesCourseWorkStudentSubmissionsReclaimSecurity = dataclasses.field()
