...
export class Projects {
  ...
  managedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermission(
    ...
    security: operations.ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionRequest(
          req
        );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1beta1/{domain}:checkMigrationPermission",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionResponse =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.checkMigrationPermissionResponse = utils.objectToClass(
              httpRes?.data,
              shared.CheckMigrationPermissionResponse
            );
          }
          break;
      }
  ...
  managedidentitiesProjectsLocationsGlobalDomainsDisableMigration(
    ...
    security: operations.ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigrationSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigrationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigrationRequest(
          req
        );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1beta1/{domain}:disableMigration",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigrationSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigrationResponse =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigrationResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  managedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachine(
    req: operations.ManagedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachineRequest,
    security: operations.ManagedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachineSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ManagedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachineResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachineRequest(
          req
        );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1beta1/{domain}:domainJoinMachine",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachineSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ManagedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachineResponse =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsDomainJoinMachineResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.domainJoinMachineResponse = utils.objectToClass(
              httpRes?.data,
              shared.DomainJoinMachineResponse
            );
          }
          break;
      }
  ...
  managedidentitiesProjectsLocationsGlobalDomainsEnableMigration(
    ...
    security: operations.ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigrationSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigrationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigrationRequest(
          req
        );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1beta1/{domain}:enableMigration",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigrationSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigrationResponse =
        new operations.ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigrationResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  managedidentitiesProjectsLocationsGlobalDomainsResetAdminPassword(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1beta1/{name}:resetAdminPassword",
      req
    );
  ...
  managedidentitiesProjectsLocationsGlobalDomainsSqlIntegrationsList(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/v1beta1/{parent}/sqlIntegrations",
      req
    );
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
