...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/epramanhp/3.0.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/epramanhp/3.0.0/typescript
```
...
const req: AgcerRequestBody = {
  ...
  format: AgcerRequestBodyFormatEnum.Pdf,
