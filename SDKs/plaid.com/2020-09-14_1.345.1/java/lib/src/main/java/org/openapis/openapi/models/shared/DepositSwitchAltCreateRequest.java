...
public class DepositSwitchAltCreateRequest {
    ...
    public DepositSwitchAltCreateRequest(@JsonProperty("target_account") java.util.Map<String, Object> targetAccount, @JsonProperty("target_user") java.util.Map<String, Object> targetUser) {
        this.targetAccount = targetAccount;
        this.targetUser = targetUser;
  }
}
