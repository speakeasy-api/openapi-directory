 ...
 */
export enum MachineTypeAggregatedListWarningCodeEnum {
...
export class MachineTypeAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class MachineTypeAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: MachineTypeAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class MachineTypeAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: MachineTypesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, MachineTypesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], MachineTypesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
