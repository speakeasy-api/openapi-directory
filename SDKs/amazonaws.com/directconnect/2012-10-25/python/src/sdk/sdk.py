...
SERVERS = [
    ...
    r"""The AWS Direct Connect multi-region endpoint"""
    "https://directconnect.{region}.amazonaws.com",
    r"""The AWS Direct Connect multi-region endpoint"""
    "http://directconnect.{region}.amazonaws.com.cn",
    r"""The AWS Direct Connect endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def accept_direct_connect_gateway_association_proposal(self, request: operations.AcceptDirectConnectGatewayAssociationProposalRequest) -> operations.AcceptDirectConnectGatewayAssociationProposalResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "accept_direct_connect_gateway_association_proposal_request", 'json')
        ...
        res = operations.AcceptDirectConnectGatewayAssociationProposalResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AcceptDirectConnectGatewayAssociationProposalResult])
    ...
    def allocate_connection_on_interconnect(self, request: operations.AllocateConnectionOnInterconnectRequest) -> operations.AllocateConnectionOnInterconnectResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "allocate_connection_on_interconnect_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AllocateConnectionOnInterconnectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def allocate_hosted_connection(self, request: operations.AllocateHostedConnectionRequest) -> operations.AllocateHostedConnectionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "allocate_hosted_connection_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AllocateHostedConnectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def allocate_private_virtual_interface(self, request: operations.AllocatePrivateVirtualInterfaceRequest) -> operations.AllocatePrivateVirtualInterfaceResponse:
        r"""<p>Provisions a private virtual interface to be owned by the specified Amazon Web Services account.</p> <p>Virtual interfaces created using this action must be confirmed by the owner using <a>ConfirmPrivateVirtualInterface</a>. Until then, the virtual interface is in the <code>Confirming</code> state and is not available to handle traffic.</p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.AllocatePrivateVirtualInterface'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "allocate_private_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AllocatePrivateVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.VirtualInterface])
    ...
    def allocate_public_virtual_interface(self, request: operations.AllocatePublicVirtualInterfaceRequest) -> operations.AllocatePublicVirtualInterfaceResponse:
        r"""<p>Provisions a public virtual interface to be owned by the specified Amazon Web Services account.</p> <p>The owner of a connection calls this function to provision a public virtual interface to be owned by the specified Amazon Web Services account.</p> <p>Virtual interfaces created using this function must be confirmed by the owner using <a>ConfirmPublicVirtualInterface</a>. Until this step has been completed, the virtual interface is in the <code>confirming</code> state and is not available to handle traffic.</p> <p>When creating an IPv6 public virtual interface, omit the Amazon address and customer address. IPv6 addresses are automatically assigned from the Amazon pool of IPv6 addresses; you cannot specify custom IPv6 addresses.</p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.AllocatePublicVirtualInterface'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "allocate_public_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AllocatePublicVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def allocate_transit_virtual_interface(self, request: operations.AllocateTransitVirtualInterfaceRequest) -> operations.AllocateTransitVirtualInterfaceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "allocate_transit_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AllocateTransitVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AllocateTransitVirtualInterfaceResult])
    ...
    def associate_connection_with_lag(self, request: operations.AssociateConnectionWithLagRequest) -> operations.AssociateConnectionWithLagResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "associate_connection_with_lag_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AssociateConnectionWithLagResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def associate_hosted_connection(self, request: operations.AssociateHostedConnectionRequest) -> operations.AssociateHostedConnectionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "associate_hosted_connection_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AssociateHostedConnectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def associate_mac_sec_key(self, request: operations.AssociateMacSecKeyRequest) -> operations.AssociateMacSecKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "associate_mac_sec_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AssociateMacSecKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AssociateMacSecKeyResponse])
    ...
    def associate_virtual_interface(self, request: operations.AssociateVirtualInterfaceRequest) -> operations.AssociateVirtualInterfaceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "associate_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AssociateVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def confirm_connection(self, request: operations.ConfirmConnectionRequest) -> operations.ConfirmConnectionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "confirm_connection_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ConfirmConnectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ConfirmConnectionResponse])
    ...
    def confirm_customer_agreement(self, request: operations.ConfirmCustomerAgreementRequest) -> operations.ConfirmCustomerAgreementResponse:
        r"""The confirmation of the terms of agreement when creating the connection/link aggregation group (LAG)."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.ConfirmCustomerAgreement'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "confirm_customer_agreement_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ConfirmCustomerAgreementResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ConfirmCustomerAgreementResponse])
                res.confirm_customer_agreement_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.direct_connect_server_exception = out
    ...
    def confirm_private_virtual_interface(self, request: operations.ConfirmPrivateVirtualInterfaceRequest) -> operations.ConfirmPrivateVirtualInterfaceResponse:
        r"""<p>Accepts ownership of a private virtual interface created by another Amazon Web Services account.</p> <p>After the virtual interface owner makes this call, the virtual interface is created and attached to the specified virtual private gateway or Direct Connect gateway, and is made available to handle traffic.</p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.ConfirmPrivateVirtualInterface'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "confirm_private_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ConfirmPrivateVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ConfirmPrivateVirtualInterfaceResponse])
    ...
    def confirm_public_virtual_interface(self, request: operations.ConfirmPublicVirtualInterfaceRequest) -> operations.ConfirmPublicVirtualInterfaceResponse:
        r"""<p>Accepts ownership of a public virtual interface created by another Amazon Web Services account.</p> <p>After the virtual interface owner makes this call, the specified virtual interface is created and made available to handle traffic.</p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.ConfirmPublicVirtualInterface'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "confirm_public_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ConfirmPublicVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ConfirmPublicVirtualInterfaceResponse])
    ...
    def confirm_transit_virtual_interface(self, request: operations.ConfirmTransitVirtualInterfaceRequest) -> operations.ConfirmTransitVirtualInterfaceResponse:
        r"""<p>Accepts ownership of a transit virtual interface created by another Amazon Web Services account.</p> <p> After the owner of the transit virtual interface makes this call, the specified transit virtual interface is created and made available to handle traffic.</p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.ConfirmTransitVirtualInterface'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "confirm_transit_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ConfirmTransitVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ConfirmTransitVirtualInterfaceResponse])
    ...
    def create_bgp_peer(self, request: operations.CreateBGPPeerRequest) -> operations.CreateBGPPeerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_bgp_peer_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateBGPPeerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateBGPPeerResponse])
    ...
    def create_direct_connect_gateway(self, request: operations.CreateDirectConnectGatewayRequest) -> operations.CreateDirectConnectGatewayResponse:
        r"""Creates a Direct Connect gateway, which is an intermediate object that enables you to connect a set of virtual interfaces and virtual private gateways. A Direct Connect gateway is global and visible in any Amazon Web Services Region after it is created. The virtual interfaces and virtual private gateways that are connected through a Direct Connect gateway can be in different Amazon Web Services Regions. This enables you to connect to a VPC in any Region, regardless of the Region in which the virtual interfaces are located, and pass traffic between them."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.CreateDirectConnectGateway'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_direct_connect_gateway_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateDirectConnectGatewayResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDirectConnectGatewayResult])
    ...
    def create_direct_connect_gateway_association(self, request: operations.CreateDirectConnectGatewayAssociationRequest) -> operations.CreateDirectConnectGatewayAssociationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_direct_connect_gateway_association_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateDirectConnectGatewayAssociationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDirectConnectGatewayAssociationResult])
    ...
    def create_direct_connect_gateway_association_proposal(self, request: operations.CreateDirectConnectGatewayAssociationProposalRequest) -> operations.CreateDirectConnectGatewayAssociationProposalResponse:
        r"""<p>Creates a proposal to associate the specified virtual private gateway or transit gateway with the specified Direct Connect gateway.</p> <p>You can associate a Direct Connect gateway and virtual private gateway or transit gateway that is owned by any Amazon Web Services account. </p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.CreateDirectConnectGatewayAssociationProposal'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_direct_connect_gateway_association_proposal_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateDirectConnectGatewayAssociationProposalResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateDirectConnectGatewayAssociationProposalResult])
    ...
    def create_interconnect(self, request: operations.CreateInterconnectRequest) -> operations.CreateInterconnectResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_interconnect_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateInterconnectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Interconnect])
    ...
    def create_lag(self, request: operations.CreateLagRequest) -> operations.CreateLagResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_lag_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateLagResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Lag])
                res.lag = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
    ...
    def create_private_virtual_interface(self, request: operations.CreatePrivateVirtualInterfaceRequest) -> operations.CreatePrivateVirtualInterfaceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_private_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreatePrivateVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_public_virtual_interface(self, request: operations.CreatePublicVirtualInterfaceRequest) -> operations.CreatePublicVirtualInterfaceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_public_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreatePublicVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_transit_virtual_interface(self, request: operations.CreateTransitVirtualInterfaceRequest) -> operations.CreateTransitVirtualInterfaceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_transit_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateTransitVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateTransitVirtualInterfaceResult])
    ...
    def delete_bgp_peer(self, request: operations.DeleteBGPPeerRequest) -> operations.DeleteBGPPeerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_bgp_peer_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteBGPPeerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteBGPPeerResponse])
    ...
    def delete_direct_connect_gateway(self, request: operations.DeleteDirectConnectGatewayRequest) -> operations.DeleteDirectConnectGatewayResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_direct_connect_gateway_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDirectConnectGatewayResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteDirectConnectGatewayResult])
    ...
    def delete_direct_connect_gateway_association(self, request: operations.DeleteDirectConnectGatewayAssociationRequest) -> operations.DeleteDirectConnectGatewayAssociationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_direct_connect_gateway_association_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDirectConnectGatewayAssociationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteDirectConnectGatewayAssociationResult])
    ...
    def delete_direct_connect_gateway_association_proposal(self, request: operations.DeleteDirectConnectGatewayAssociationProposalRequest) -> operations.DeleteDirectConnectGatewayAssociationProposalResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_direct_connect_gateway_association_proposal_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteDirectConnectGatewayAssociationProposalResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteDirectConnectGatewayAssociationProposalResult])
    ...
    def delete_interconnect(self, request: operations.DeleteInterconnectRequest) -> operations.DeleteInterconnectResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_interconnect_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteInterconnectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteInterconnectResponse])
    ...
    def delete_lag(self, request: operations.DeleteLagRequest) -> operations.DeleteLagResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_lag_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteLagResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_virtual_interface(self, request: operations.DeleteVirtualInterfaceRequest) -> operations.DeleteVirtualInterfaceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_virtual_interface_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteVirtualInterfaceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteVirtualInterfaceResponse])
    ...
    def describe_connection_loa(self, request: operations.DescribeConnectionLoaRequest) -> operations.DescribeConnectionLoaResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_connection_loa_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeConnectionLoaResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeConnectionLoaResponse])
    ...
    def describe_connections(self, request: operations.DescribeConnectionsRequest) -> operations.DescribeConnectionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_connections_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def describe_connections_on_interconnect(self, request: operations.DescribeConnectionsOnInterconnectRequest) -> operations.DescribeConnectionsOnInterconnectResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_connections_on_interconnect_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeConnectionsOnInterconnectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_customer_metadata(self, request: operations.DescribeCustomerMetadataRequest) -> operations.DescribeCustomerMetadataResponse:
        r"""Get and view a list of customer agreements, along with their signed status and whether the customer is an NNIPartner, NNIPartnerV2, or a nonPartner."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.DescribeCustomerMetadata'
        ...
        res = operations.DescribeCustomerMetadataResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeCustomerMetadataResponse])
                res.describe_customer_metadata_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.direct_connect_server_exception = out
    ...
    def describe_direct_connect_gateway_association_proposals(self, request: operations.DescribeDirectConnectGatewayAssociationProposalsRequest) -> operations.DescribeDirectConnectGatewayAssociationProposalsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_direct_connect_gateway_association_proposals_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeDirectConnectGatewayAssociationProposalsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeDirectConnectGatewayAssociationProposalsResult])
    ...
    def describe_direct_connect_gateway_associations(self, request: operations.DescribeDirectConnectGatewayAssociationsRequest) -> operations.DescribeDirectConnectGatewayAssociationsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_direct_connect_gateway_associations_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeDirectConnectGatewayAssociationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeDirectConnectGatewayAssociationsResult])
    ...
    def describe_direct_connect_gateway_attachments(self, request: operations.DescribeDirectConnectGatewayAttachmentsRequest) -> operations.DescribeDirectConnectGatewayAttachmentsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_direct_connect_gateway_attachments_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeDirectConnectGatewayAttachmentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeDirectConnectGatewayAttachmentsResult])
    ...
    def describe_direct_connect_gateways(self, request: operations.DescribeDirectConnectGatewaysRequest) -> operations.DescribeDirectConnectGatewaysResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_direct_connect_gateways_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeDirectConnectGatewaysResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeDirectConnectGatewaysResult])
    ...
    def describe_hosted_connections(self, request: operations.DescribeHostedConnectionsRequest) -> operations.DescribeHostedConnectionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_hosted_connections_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeHostedConnectionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_interconnect_loa(self, request: operations.DescribeInterconnectLoaRequest) -> operations.DescribeInterconnectLoaResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_interconnect_loa_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeInterconnectLoaResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeInterconnectLoaResponse])
    ...
    def describe_interconnects(self, request: operations.DescribeInterconnectsRequest) -> operations.DescribeInterconnectsResponse:
        r"""Lists the interconnects owned by the Amazon Web Services account or only the specified interconnect."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.DescribeInterconnects'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_interconnects_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeInterconnectsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Interconnects])
    ...
    def describe_lags(self, request: operations.DescribeLagsRequest) -> operations.DescribeLagsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_lags_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeLagsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Lags])
                res.lags = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
    ...
    def describe_loa(self, request: operations.DescribeLoaRequest) -> operations.DescribeLoaResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_loa_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeLoaResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Loa])
                res.loa = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
    ...
    def describe_locations(self, request: operations.DescribeLocationsRequest) -> operations.DescribeLocationsResponse:
        r"""Lists the Direct Connect locations in the current Amazon Web Services Region. These are the locations that can be selected when calling <a>CreateConnection</a> or <a>CreateInterconnect</a>."""
        base_url = self._server_url
        ...
        res = operations.DescribeLocationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_router_configuration(self, request: operations.DescribeRouterConfigurationRequest) -> operations.DescribeRouterConfigurationResponse:
        r"""Details about the router."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.DescribeRouterConfiguration'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_router_configuration_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeRouterConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeRouterConfigurationResponse])
                res.describe_router_configuration_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.direct_connect_server_exception = out
    ...
    def describe_virtual_gateways(self, request: operations.DescribeVirtualGatewaysRequest) -> operations.DescribeVirtualGatewaysResponse:
        r"""<p>Lists the virtual private gateways owned by the Amazon Web Services account.</p> <p>You can create one or more Direct Connect private virtual interfaces linked to a virtual private gateway.</p>"""
        base_url = self._server_url
        ...
        res = operations.DescribeVirtualGatewaysResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.VirtualGateways])
    ...
    def describe_virtual_interfaces(self, request: operations.DescribeVirtualInterfacesRequest) -> operations.DescribeVirtualInterfacesResponse:
        ...
        res = operations.DescribeVirtualInterfacesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.VirtualInterfaces])
    ...
    def disassociate_connection_from_lag(self, request: operations.DisassociateConnectionFromLagRequest) -> operations.DisassociateConnectionFromLagResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disassociate_connection_from_lag_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisassociateConnectionFromLagResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def disassociate_mac_sec_key(self, request: operations.DisassociateMacSecKeyRequest) -> operations.DisassociateMacSecKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disassociate_mac_sec_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisassociateMacSecKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DisassociateMacSecKeyResponse])
    ...
    def list_virtual_interface_test_history(self, request: operations.ListVirtualInterfaceTestHistoryRequest) -> operations.ListVirtualInterfaceTestHistoryResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_virtual_interface_test_history_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListVirtualInterfaceTestHistoryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListVirtualInterfaceTestHistoryResponse])
    ...
    def start_bgp_failover_test(self, request: operations.StartBgpFailoverTestRequest) -> operations.StartBgpFailoverTestResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_bgp_failover_test_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartBgpFailoverTestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartBgpFailoverTestResponse])
    ...
    def stop_bgp_failover_test(self, request: operations.StopBgpFailoverTestRequest) -> operations.StopBgpFailoverTestResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "stop_bgp_failover_test_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StopBgpFailoverTestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StopBgpFailoverTestResponse])
    ...
    def update_direct_connect_gateway(self, request: operations.UpdateDirectConnectGatewayRequest) -> operations.UpdateDirectConnectGatewayResponse:
        r"""Updates the name of a current Direct Connect gateway."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=OvertureService.UpdateDirectConnectGateway'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_direct_connect_gateway_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateDirectConnectGatewayResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateDirectConnectGatewayResponse])
                res.update_direct_connect_gateway_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.direct_connect_server_exception = out
    ...
    def update_direct_connect_gateway_association(self, request: operations.UpdateDirectConnectGatewayAssociationRequest) -> operations.UpdateDirectConnectGatewayAssociationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_direct_connect_gateway_association_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateDirectConnectGatewayAssociationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateDirectConnectGatewayAssociationResult])
    ...
    def update_lag(self, request: operations.UpdateLagRequest) -> operations.UpdateLagResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_lag_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateLagResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_virtual_interface_attributes(self, request: operations.UpdateVirtualInterfaceAttributesRequest) -> operations.UpdateVirtualInterfaceAttributesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_virtual_interface_attributes_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateVirtualInterfaceAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
