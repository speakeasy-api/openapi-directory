...
export declare class GetUser200ApplicationJSONUserCustomFields extends SpeakeasyBase {
    firstName?: string;
}
export declare class GetUser200ApplicationJSONUserGroupUsers extends SpeakeasyBase {
    groupId: number;
    notificationLevel: number;
    owner?: boolean;
    userId: number;
}
export declare class GetUser200ApplicationJSONUserGroups extends SpeakeasyBase {
...
export declare class GetUser200ApplicationJSONUserUserAuthTokens extends SpeakeasyBase {
    browser: string;
    clientIp: string;
    createdAt: string;
    device: string;
...
export declare class GetUser200ApplicationJSONUserUserFields extends SpeakeasyBase {
    one: string;
    two: string;
}
export declare class GetUser200ApplicationJSONUserUserNotificationSchedule extends SpeakeasyBase {
    day0EndTime: number;
...
export declare class GetUser200ApplicationJSONUserUserOption extends SpeakeasyBase {
...
export declare class GetUser200ApplicationJSONUser extends SpeakeasyBase {
    admin: boolean;
    ...
    createdAt: string;
    customFields: GetUser200ApplicationJSONUserCustomFields;
    ...
    flairName: string;
    flairUrl: string;
    groupUsers: GetUser200ApplicationJSONUserGroupUsers[];
    groups: GetUser200ApplicationJSONUserGroups[];
    ...
    userApiKeys: string;
    userAuthTokens: GetUser200ApplicationJSONUserUserAuthTokens[];
    userFields?: GetUser200ApplicationJSONUserUserFields;
    userNotificationSchedule: GetUser200ApplicationJSONUserUserNotificationSchedule;
    userOption: GetUser200ApplicationJSONUserUserOption;
    username: string;
...
export declare class GetUser200ApplicationJSON extends SpeakeasyBase {
    user: GetUser200ApplicationJSONUser;
    userBadges: any[];
}
