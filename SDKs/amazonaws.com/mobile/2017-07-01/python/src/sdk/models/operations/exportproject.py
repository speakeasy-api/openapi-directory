...
from ..shared import exportprojectresult as shared_exportprojectresult
...
class ExportProjectRequest:
    headers: ExportProjectHeaders = dataclasses.field()
...
class ExportProjectResponse:
    ...
    export_project_result: Optional[shared_exportprojectresult.ExportProjectResult] = dataclasses.field(default=None)
