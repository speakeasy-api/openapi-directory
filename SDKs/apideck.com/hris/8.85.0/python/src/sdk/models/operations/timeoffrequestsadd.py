...
from ..shared import createtimeoffrequestresponse as shared_createtimeoffrequestresponse
...
class TimeOffRequestsAddRequest:
    headers: TimeOffRequestsAddHeaders = dataclasses.field()
    query_params: TimeOffRequestsAddQueryParams = dataclasses.field()
    request: shared_timeoffrequest.TimeOffRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: TimeOffRequestsAddSecurity = dataclasses.field()
...
class TimeOffRequestsAddResponse:
    ...
    create_time_off_request_response: Optional[shared_createtimeoffrequestresponse.CreateTimeOffRequestResponse] = dataclasses.field(default=None)
