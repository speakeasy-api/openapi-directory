...
type SearchProjectServiceQueryParams struct {
	...
	// Provider
	SearchProjectServiceProvider *string `queryParam:"style=form,explode=true,name=search.project_service.provider"`
	// Service Type
	SearchProjectServiceServiceType *string `queryParam:"style=form,explode=true,name=search.project_service.service_type"`
	// Number to skip
...
type SearchProjectServiceRequest struct {
	QueryParams SearchProjectServiceQueryParams
}

type SearchProjectServiceResponse struct {
	ContentType string
	StatusCode  int
