...
public class GETCreateDefaultSubnetRequest {
    ...
    public GETCreateDefaultSubnetRequest(@JsonProperty("Action") GETCreateDefaultSubnetActionEnum action, @JsonProperty("AvailabilityZone") String availabilityZone, @JsonProperty("Version") GETCreateDefaultSubnetVersionEnum version) {
        this.action = action;
        this.availabilityZone = availabilityZone;
        this.version = version;
  }
