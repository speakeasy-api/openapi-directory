...
export declare class CommonAreaPhones {
    ...
    **/
    addCommonAreaPhone(req: operations.AddCommonAreaPhoneRequest, config?: AxiosRequestConfig): Promise<operations.AddCommonAreaPhoneResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`
    **/
    deleteCommonAreaPhone(req: operations.DeleteCommonAreaPhoneRequest, config?: AxiosRequestConfig): Promise<operations.DeleteCommonAreaPhoneResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`
    **/
    getACommonAreaPhone(req: operations.GetACommonAreaPhoneRequest, config?: AxiosRequestConfig): Promise<operations.GetACommonAreaPhoneResponse>;
    /**
    ...
    **/
    listCommonAreaPhones(req: operations.ListCommonAreaPhonesRequest, config?: AxiosRequestConfig): Promise<operations.ListCommonAreaPhonesResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`
    **/
    updateCommonAreaPhone(req: operations.UpdateCommonAreaPhoneRequest, config?: AxiosRequestConfig): Promise<operations.UpdateCommonAreaPhoneResponse>;
}
