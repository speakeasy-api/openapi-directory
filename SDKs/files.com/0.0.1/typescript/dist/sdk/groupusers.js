...
var GroupUsers = /** @class */ (function () {
    function GroupUsers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Delete Group User
    **/
    GroupUsers.prototype.deleteGroupUsersId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteGroupUsersIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/group_users/{id}", req.pathParams);
     ...
     * List Group Users
    **/
    GroupUsers.prototype.getGroupUsers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetGroupUsersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/group_users";
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
     ...
     * Update Group User
    **/
    GroupUsers.prototype.patchGroupUsersId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.groupUserEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
     ...
     * Create Group User
    **/
    GroupUsers.prototype.postGroupUsers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
