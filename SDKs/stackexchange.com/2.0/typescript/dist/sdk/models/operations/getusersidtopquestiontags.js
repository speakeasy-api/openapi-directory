...
exports.GetUsersIdTopQuestionTagsResponse = exports.GetUsersIdTopQuestionTagsRequest = void 0;
...
var GetUsersIdTopQuestionTagsRequest = /** @class */ (function (_super) {
    ...
    ], GetUsersIdTopQuestionTagsRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetUsersIdTopQuestionTagsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetUsersIdTopQuestionTagsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetUsersIdTopQuestionTagsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdTopQuestionTagsRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetUsersIdTopQuestionTagsRequest.prototype, "site", void 0);
...
var GetUsersIdTopQuestionTagsResponse = /** @class */ (function (_super) {
    ...
    ], GetUsersIdTopQuestionTagsResponse.prototype, "rawResponse", void 0);
