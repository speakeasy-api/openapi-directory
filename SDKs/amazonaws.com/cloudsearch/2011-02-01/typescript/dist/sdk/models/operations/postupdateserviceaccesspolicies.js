...
exports.POSTUpdateServiceAccessPoliciesResponse = exports.POSTUpdateServiceAccessPoliciesRequest = exports.POSTUpdateServiceAccessPoliciesVersionEnum = exports.POSTUpdateServiceAccessPoliciesActionEnum = void 0;
...
var POSTUpdateServiceAccessPoliciesRequest = /** @class */ (function (_super) {
    ...
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], POSTUpdateServiceAccessPoliciesRequest.prototype, "xAmzSignedHeaders", void 0);
...
var POSTUpdateServiceAccessPoliciesResponse = /** @class */ (function (_super) {
    ...
    ], POSTUpdateServiceAccessPoliciesResponse.prototype, "rawResponse", void 0);
