...
func (e ActivityAttendeeStatusEnum) ToPointer() *ActivityAttendeeStatusEnum {
	return &e
}

func (e *ActivityAttendeeStatusEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "tentative":
		fallthrough
	case "declined":
		*e = ActivityAttendeeStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ActivityAttendeeStatusEnum: %v", v)
	}
}
