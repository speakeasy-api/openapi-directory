...
var GeneralServices = /** @class */ (function () {
    function GeneralServices(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    GeneralServices.prototype.healthCheck = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.HealthCheckRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/health/check";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.healthCheck200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
