...
class DeleteDatastoreRequest:
    headers: DeleteDatastoreHeaders = dataclasses.field()
    path_params: DeleteDatastorePathParams = dataclasses.field()
