...
class PatchUpdateDomainRecordRequest:
    path_params: PatchUpdateDomainRecordPathParams = dataclasses.field()
...
class PatchUpdateDomainRecordResponse:
    ...
    patch_update_domain_record_200_application_json_any: Optional[Any] = dataclasses.field(default=None)
    patch_update_domain_record_401_application_json_object: Optional[PatchUpdateDomainRecord401ApplicationJSON] = dataclasses.field(default=None)
