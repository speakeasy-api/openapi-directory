...
type NetworksecurityProjectsLocationsServerTLSPoliciesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type NetworksecurityProjectsLocationsServerTLSPoliciesListPathParams struct {
...
type NetworksecurityProjectsLocationsServerTLSPoliciesListQueryParams struct {
	// V1 error format.
...
type NetworksecurityProjectsLocationsServerTLSPoliciesListRequest struct {
...
type NetworksecurityProjectsLocationsServerTLSPoliciesListResponse struct {
	ContentType string
	// Successful response
