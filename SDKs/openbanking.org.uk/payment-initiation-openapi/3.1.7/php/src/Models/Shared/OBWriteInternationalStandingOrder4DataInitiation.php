...
class OBWriteInternationalStandingOrder4DataInitiation
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationCreditor $creditor
     */
	#[\JMS\Serializer\Annotation\SerializedName('Creditor')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationCreditor')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrder4DataInitiationCreditor $creditor = null;
    
    /**
     * Provides the details to identify the beneficiary account.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationCreditorAccount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationCreditorAgent $creditorAgent
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAgent')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationCreditorAgent')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrder4DataInitiationCreditorAgent $creditorAgent = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteInternationalStandingOrder4DataInitiationDebtorAccount $debtorAccount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationInstructedAmount $instructedAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('InstructedAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationInstructedAmount')]
	...
	public function __construct()
	{
		...
		$this->creditor = null;
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationCreditorAccount();
		...
		$this->frequency = "";
		$this->instructedAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalStandingOrder4DataInitiationInstructedAmount();
