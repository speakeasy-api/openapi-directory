...
from ..shared import getlocationsresponse as shared_getlocationsresponse
...
@dataclasses.dataclass
class LocationsAllSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class LocationsAllRequest:
    headers: LocationsAllHeaders = dataclasses.field()
    query_params: LocationsAllQueryParams = dataclasses.field()
    security: LocationsAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class LocationsAllResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_locations_response: Optional[shared_getlocationsresponse.GetLocationsResponse] = dataclasses.field(default=None)
