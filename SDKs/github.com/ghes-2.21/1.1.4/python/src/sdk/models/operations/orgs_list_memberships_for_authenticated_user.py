...
class OrgsListMembershipsForAuthenticatedUserStateEnum(str, Enum):
    r"""Indicates the state of the memberships to return. Can be either `active` or `pending`. If not specified, the API returns both active and pending memberships."""
    ACTIVE = 'active'
    PENDING = 'pending'
