...
class GetWebhookResourceSecurity:
...
@dataclasses.dataclass
class GetWebhookResourceResponse:
    ...
    webhook_resource: Optional[shared_webhookresource.WebhookResource] = dataclasses.field(default=None)
