...
func (e ListCachePolicies20200531TypeEnum) ToPointer() *ListCachePolicies20200531TypeEnum {
	return &e
}
...
func (e *ListCachePolicies20200531TypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "managed":
		fallthrough
	case "custom":
		*e = ListCachePolicies20200531TypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListCachePolicies20200531TypeEnum: %v", v)
	}
}
