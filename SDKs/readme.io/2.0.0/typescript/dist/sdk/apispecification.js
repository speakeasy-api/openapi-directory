...
exports.ApiSpecification = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ApiSpecification = /** @class */ (function () {
    function ApiSpecification(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ApiSpecification.prototype.deleteApiSpecification = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteApiSpecificationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api-specification/{id}", req.pathParams);
    ...
    **/
    ApiSpecification.prototype.getApiSpecification = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetApiSpecificationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api-specification";
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    ApiSpecification.prototype.updateApiSpecification = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApiSpecification.prototype.uploadApiSpecification = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
