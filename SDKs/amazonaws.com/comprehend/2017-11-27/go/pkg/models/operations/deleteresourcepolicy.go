...
const (
	DeleteResourcePolicyXAmzTargetEnumComprehend20171127DeleteResourcePolicy DeleteResourcePolicyXAmzTargetEnum = "Comprehend_20171127.DeleteResourcePolicy"
)
...
func (e *DeleteResourcePolicyXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "Comprehend_20171127.DeleteResourcePolicy":
