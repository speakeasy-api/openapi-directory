...
type ListPricesQueryParams struct {
	// Pagination token
...
func (e *ListPricesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "Route53Domains_v20140515.ListPrices":
		*e = ListPricesXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListPricesXAmzTargetEnum: %s", s)
	}
}

type ListPricesHeaders struct {
...
type ListPricesRequest struct {
	QueryParams ListPricesQueryParams
	Headers     ListPricesHeaders
	Request     shared.ListPricesRequest `request:"mediaType=application/json"`
}
