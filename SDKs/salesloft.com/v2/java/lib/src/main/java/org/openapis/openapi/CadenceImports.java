...
public class CadenceImports {
	...
	public CadenceImports(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.PostV2CadenceImportsJsonResponse postV2CadenceImportsJson(org.openapis.openapi.models.operations.PostV2CadenceImportsJsonRequestBody request) throws Exception {
        ...
        org.openapis.openapi.models.operations.PostV2CadenceImportsJsonResponse res = new org.openapis.openapi.models.operations.PostV2CadenceImportsJsonResponse(contentType, httpRes.statusCode()) {{
            body = null;
        }};
