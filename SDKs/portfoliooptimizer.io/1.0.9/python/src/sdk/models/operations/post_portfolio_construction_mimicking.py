...
class PostPortfolioConstructionMimickingRequestBody:
    ...
    assets: list[PostPortfolioConstructionMimickingRequestBodyAssets] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assets') }})  
    ...
    r"""benchmarkReturns[t] is the return of the benchmark at the time t; the benchmarkReturns array must have the same length as all the assetReturns arrays"""  
    constraints: Optional[PostPortfolioConstructionMimickingRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
