...
class FetchTaskQueueStatisticsRequest:
    path_params: FetchTaskQueueStatisticsPathParams = dataclasses.field()
    query_params: FetchTaskQueueStatisticsQueryParams = dataclasses.field()
    security: FetchTaskQueueStatisticsSecurity = dataclasses.field()
