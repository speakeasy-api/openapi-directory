...
func (e *GetNetworkWirelessClientConnectivityEventsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessClientConnectivityEventsBandEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessClientConnectivityEventsBandEnum: %s", s)
	}
}
...
func (e *GetNetworkWirelessClientConnectivityEventsIncludedSeveritiesEnum) UnmarshalJSON(data []byte) error {
	...
	case "info":
		fallthrough
	case "warn":
		*e = GetNetworkWirelessClientConnectivityEventsIncludedSeveritiesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessClientConnectivityEventsIncludedSeveritiesEnum: %s", s)
	}
}
...
type GetNetworkWirelessClientConnectivityEventsSsidNumberEnum string
...
func (e *GetNetworkWirelessClientConnectivityEventsSsidNumberEnum) UnmarshalJSON(data []byte) error {
	...
	case "13":
		fallthrough
	case "14":
		*e = GetNetworkWirelessClientConnectivityEventsSsidNumberEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessClientConnectivityEventsSsidNumberEnum: %s", s)
	}
}
...
func (e *GetNetworkWirelessClientConnectivityEventsTypesEnum) UnmarshalJSON(data []byte) error {
	...
	case "roam":
		fallthrough
	case "sticky":
		*e = GetNetworkWirelessClientConnectivityEventsTypesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessClientConnectivityEventsTypesEnum: %s", s)
	}
}
