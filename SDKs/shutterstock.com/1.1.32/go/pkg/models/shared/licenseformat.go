...
func (e LicenseFormatMediaTypeEnum) ToPointer() *LicenseFormatMediaTypeEnum {
	return &e
}
...
func (e *LicenseFormatMediaTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "audio":
		fallthrough
	case "editorial":
		*e = LicenseFormatMediaTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for LicenseFormatMediaTypeEnum: %v", v)
	}
}
