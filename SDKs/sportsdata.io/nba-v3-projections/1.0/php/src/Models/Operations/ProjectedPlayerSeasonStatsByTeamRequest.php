...
class ProjectedPlayerSeasonStatsByTeamRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\ProjectedPlayerSeasonStatsByTeamFormatEnum $format
     */
	...
	{
		$this->format = \OpenAPI\OpenAPI\Models\Operations\ProjectedPlayerSeasonStatsByTeamFormatEnum::XML;
		$this->season = "";
		$this->team = "";
	}
}
