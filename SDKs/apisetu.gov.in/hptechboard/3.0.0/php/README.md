...
use \OpenAPI\OpenAPI\Models\Operations\DipcrRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\DipcrRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\DipcrRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\DipcrSecurity;
...
try {
    ...
    $request->certificateParameters = new DipcrRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->rollNo = '99999999';
    ...
    $request->format = DipcrRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new DipcrSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->dipcr($request, $requestSecurity);
