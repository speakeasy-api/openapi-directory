...
public class Location {
    ...
    public Location withPostalAddress(String postalAddress) {
    ...
    public Location(@JsonProperty("address") String address, @JsonProperty("address-components") java.util.Map<String, String> addressComponents, @JsonProperty("city") String city, @JsonProperty("country") String country, @JsonProperty("country-code") String countryCode, @JsonProperty("country-code3") String countryCode3, @JsonProperty("currency-code") String currencyCode, @JsonProperty("latitude") Double latitude, @JsonProperty("location-tags") String[] locationTags, @JsonProperty("location-type") String locationType, @JsonProperty("longitude") Double longitude, @JsonProperty("postal-address") String postalAddress, @JsonProperty("postal-code") String postalCode, @JsonProperty("region-code") String regionCode, @JsonProperty("state") String state, @JsonProperty("timezone") Timezone timezone) {
        this.address = address;
        this.addressComponents = addressComponents;
        this.city = city;
        this.country = country;
