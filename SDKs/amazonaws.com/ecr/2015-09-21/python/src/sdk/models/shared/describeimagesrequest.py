...
class DescribeImagesRequest:
    ...
    filter: Optional[shared_describeimagesfilter.DescribeImagesFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('filter') }})
