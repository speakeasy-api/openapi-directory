...
@dataclasses.dataclass
class PaymentsresellersubscriptionPartnersSubscriptionsCreateQueryParams:
...
class PaymentsresellersubscriptionPartnersSubscriptionsCreateRequest:
    path_params: PaymentsresellersubscriptionPartnersSubscriptionsCreatePathParams = dataclasses.field()
    query_params: PaymentsresellersubscriptionPartnersSubscriptionsCreateQueryParams = dataclasses.field()
