...
exports.ScheduleLambdaFunctionDecisionAttributes = void 0;
...
**/
var ScheduleLambdaFunctionDecisionAttributes = /** @class */ (function (_super) {
    __extends(ScheduleLambdaFunctionDecisionAttributes, _super);
    ...
    ], ScheduleLambdaFunctionDecisionAttributes.prototype, "control", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=id" }),
        __metadata("design:type", String)
    ], ScheduleLambdaFunctionDecisionAttributes.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=input" }),
        __metadata("design:type", String)
    ], ScheduleLambdaFunctionDecisionAttributes.prototype, "input", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], ScheduleLambdaFunctionDecisionAttributes.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startToCloseTimeout" }),
        __metadata("design:type", String)
    ], ScheduleLambdaFunctionDecisionAttributes.prototype, "startToCloseTimeout", void 0);
