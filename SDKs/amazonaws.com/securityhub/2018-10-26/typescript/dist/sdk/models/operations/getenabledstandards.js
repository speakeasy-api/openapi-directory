...
exports.GetEnabledStandardsResponse = exports.GetEnabledStandardsRequest = exports.GetEnabledStandardsRequestBody = void 0;
...
var GetEnabledStandardsRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "StandardsSubscriptionArns" }),
        __metadata("design:type", Array)
    ], GetEnabledStandardsRequestBody.prototype, "standardsSubscriptionArns", void 0);
    return GetEnabledStandardsRequestBody;
}(utils_1.SpeakeasyBase));
exports.GetEnabledStandardsRequestBody = GetEnabledStandardsRequestBody;
var GetEnabledStandardsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=NextToken",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "nextToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", GetEnabledStandardsRequestBody)
    ], GetEnabledStandardsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GetEnabledStandardsRequest.prototype, "xAmzSignedHeaders", void 0);
    return GetEnabledStandardsRequest;
}(utils_1.SpeakeasyBase));
exports.GetEnabledStandardsRequest = GetEnabledStandardsRequest;
var GetEnabledStandardsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetEnabledStandardsResponse.prototype, "rawResponse", void 0);
    return GetEnabledStandardsResponse;
}(utils_1.SpeakeasyBase));
exports.GetEnabledStandardsResponse = GetEnabledStandardsResponse;
