...
public class TaxApiUpdateJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public TaxApiUpdateJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public TaxApiUpdateJsonHeaders withXAuthSecret(String xAuthSecret) {
