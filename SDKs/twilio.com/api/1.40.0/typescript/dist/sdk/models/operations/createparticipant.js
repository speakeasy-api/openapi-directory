...
exports.CreateParticipantResponse = exports.CreateParticipantRequest = exports.CreateParticipantCreateParticipantRequest = exports.CreateParticipantCreateParticipantRequestWaitMethodEnum = exports.CreateParticipantCreateParticipantRequestStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestRecordingStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestConferenceStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestConferenceRecordingStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestAmdStatusCallbackMethodEnum = exports.CreateParticipantSecurity = exports.CreateParticipantServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.CreateParticipantServerList = ["https://api.twilio.com"];
var CreateParticipantSecurity = /** @class */ (function (_super) {
    ...
    ], CreateParticipantSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], CreateParticipantSecurity.prototype, "username", void 0);
 ...
 */
var CreateParticipantCreateParticipantRequestAmdStatusCallbackMethodEnum;
...
})(CreateParticipantCreateParticipantRequestAmdStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestAmdStatusCallbackMethodEnum || (exports.CreateParticipantCreateParticipantRequestAmdStatusCallbackMethodEnum = {}));
/**
 * The HTTP method we should use to call `conference_recording_status_callback`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateParticipantCreateParticipantRequestConferenceRecordingStatusCallbackMethodEnum;
...
})(CreateParticipantCreateParticipantRequestConferenceRecordingStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestConferenceRecordingStatusCallbackMethodEnum || (exports.CreateParticipantCreateParticipantRequestConferenceRecordingStatusCallbackMethodEnum = {}));
/**
 * The HTTP method we should use to call `conference_status_callback`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateParticipantCreateParticipantRequestConferenceStatusCallbackMethodEnum;
...
})(CreateParticipantCreateParticipantRequestConferenceStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestConferenceStatusCallbackMethodEnum || (exports.CreateParticipantCreateParticipantRequestConferenceStatusCallbackMethodEnum = {}));
/**
 * The HTTP method we should use when we call `recording_status_callback`. Can be: `GET` or `POST` and defaults to `POST`.
 */
var CreateParticipantCreateParticipantRequestRecordingStatusCallbackMethodEnum;
...
})(CreateParticipantCreateParticipantRequestRecordingStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestRecordingStatusCallbackMethodEnum || (exports.CreateParticipantCreateParticipantRequestRecordingStatusCallbackMethodEnum = {}));
/**
 * The HTTP method we should use to call `status_callback`. Can be: `GET` and `POST` and defaults to `POST`.
 */
var CreateParticipantCreateParticipantRequestStatusCallbackMethodEnum;
...
})(CreateParticipantCreateParticipantRequestStatusCallbackMethodEnum = exports.CreateParticipantCreateParticipantRequestStatusCallbackMethodEnum || (exports.CreateParticipantCreateParticipantRequestStatusCallbackMethodEnum = {}));
/**
 * The HTTP method we should use to call `wait_url`. Can be `GET` or `POST` and the default is `POST`. When using a static audio file, this should be `GET` so that we can cache the file.
 */
var CreateParticipantCreateParticipantRequestWaitMethodEnum;
...
})(CreateParticipantCreateParticipantRequestWaitMethodEnum = exports.CreateParticipantCreateParticipantRequestWaitMethodEnum || (exports.CreateParticipantCreateParticipantRequestWaitMethodEnum = {}));
var CreateParticipantCreateParticipantRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=AmdStatusCallback" }),
        __metadata("design:type", String)
    ], CreateParticipantCreateParticipantRequest.prototype, "amdStatusCallback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=AmdStatusCallbackMethod" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=JitterBufferSize" }),
        __metadata("design:type", String)
...
var CreateParticipantRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateParticipantRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConferenceSid",
        }),
        __metadata("design:type", String)
    ], CreateParticipantRequest.prototype, "conferenceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", CreateParticipantCreateParticipantRequest)
    ], CreateParticipantRequest.prototype, "requestBody", void 0);
...
var CreateParticipantResponse = /** @class */ (function (_super) {
    ...
    ], CreateParticipantResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
