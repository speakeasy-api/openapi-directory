...
class AdultInfo:
    ...
    gore_score: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('goreScore'), 'exclude': lambda f: f is None }})
    r"""Score from 0 to 1 that indicates how gory is the image."""  
    ...
    is_gory_content: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('isGoryContent'), 'exclude': lambda f: f is None }})
    r"""A value indicating if the image is gory."""  
