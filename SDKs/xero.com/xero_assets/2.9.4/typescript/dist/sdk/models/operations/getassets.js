...
exports.GetAssetsResponse = exports.GetAssetsRequest = exports.GetAssetsSortDirectionEnum = exports.GetAssetsOrderByEnum = exports.GetAssetsSecurity = void 0;
...
var GetAssetsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetAssetsRequest.prototype, "filterBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=orderBy",
        }),
        __metadata("design:type", String)
    ], GetAssetsRequest.prototype, "orderBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetAssetsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], GetAssetsRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sortDirection",
        }),
        __metadata("design:type", String)
    ], GetAssetsRequest.prototype, "sortDirection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], GetAssetsRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=xero-tenant-id",
        }),
        __metadata("design:type", String)
    ], GetAssetsRequest.prototype, "xeroTenantId", void 0);
...
var GetAssetsResponse = /** @class */ (function (_super) {
    ...
    ], GetAssetsResponse.prototype, "rawResponse", void 0);
