...
import { NetworkEndpointWithHealthStatus } from "./networkendpointwithhealthstatus";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum NetworkEndpointGroupsListNetworkEndpointsWarningCodeEnum {
...
export declare class NetworkEndpointGroupsListNetworkEndpointsWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkEndpointGroupsListNetworkEndpointsWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NetworkEndpointGroupsListNetworkEndpointsWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NetworkEndpointGroupsListNetworkEndpointsWarningData[];
    /**
 ...
 * Successful response
 */
export declare class NetworkEndpointGroupsListNetworkEndpoints extends SpeakeasyBase {
    /**
