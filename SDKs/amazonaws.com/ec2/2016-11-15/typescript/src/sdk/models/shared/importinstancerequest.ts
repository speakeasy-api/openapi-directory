 ...
 */
export enum ImportInstanceRequestLaunchSpecificationArchitectureEnum {
  I386 = "i386",
  X8664 = "x86_64",
  Arm64 = "arm64",
  X8664Mac = "x86_64_mac",
 ...
 */
export enum ImportInstanceRequestLaunchSpecificationInstanceInitiatedShutdownBehaviorEnum {
  Stop = "stop",
  Terminate = "terminate",
}
 ...
 */
export enum ImportInstanceRequestLaunchSpecificationInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export enum ImportInstanceRequestLaunchSpecificationPlacementTenancyEnum {
  Default = "default",
  Dedicated = "dedicated",
  Host = "host",
}
 ...
 */
export class ImportInstanceRequestLaunchSpecificationPlacement extends SpeakeasyBase {
  @SpeakeasyMetadata()
  affinity?: string;
 ...
 */
export class ImportInstanceRequestLaunchSpecificationUserData extends SpeakeasyBase {
  @SpeakeasyMetadata()
  data?: string;
}
 ...
 */
export class ImportInstanceRequestLaunchSpecification extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum ImportInstanceRequestPlatformEnum {
  Windows = "Windows",
}
...
export class ImportInstanceRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: DiskImage })
