...
class Text
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TextChromaKey $chromaKey
     */
	#[\JMS\Serializer\Annotation\SerializedName('chroma-key')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\TextChromaKey')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TextChromaKey $chromaKey = null;
     ...
     * Crops the element
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TextCrop $crop
     */
	#[\JMS\Serializer\Annotation\SerializedName('crop')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\TextCrop')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TextCrop $crop = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TextPanEnum $pan
     */
	#[\JMS\Serializer\Annotation\SerializedName('pan')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TextPanEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TextPanEnum $pan = null;
    
    /**
     * Sets the element position in the scene. A value of 'custom' sets a custom position based on the provided 'x' and 'y' properties
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TextPositionEnum $position
     */
	#[\JMS\Serializer\Annotation\SerializedName('position')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TextPositionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TextPositionEnum $position = null;
    
	#[\JMS\Serializer\Annotation\SerializedName('rotate')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\TextRotate')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TextRotate $rotate = null;
    
	#[\JMS\Serializer\Annotation\SerializedName('scale')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\TextScale')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TextScale $scale = null;
	...
	public function __construct()
	{
		...
		$this->style = null;
		$this->text = "";
		$this->type = \OpenAPI\OpenAPI\Models\Shared\TextTypeEnum::TEXT;
		$this->width = null;
		$this->x = null;
		$this->y = null;
		$this->zIndex = null;
