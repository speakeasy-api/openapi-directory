 ...
 */
public enum CreateRestoreImageTaskRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateRestoreImageTaskRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
