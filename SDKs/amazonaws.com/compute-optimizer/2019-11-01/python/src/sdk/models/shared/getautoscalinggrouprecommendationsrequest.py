...
class GetAutoScalingGroupRecommendationsRequest:
    ...
    auto_scaling_group_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('autoScalingGroupArns'), 'exclude': lambda f: f is None }})  
