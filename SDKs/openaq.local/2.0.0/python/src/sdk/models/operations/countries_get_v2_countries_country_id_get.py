...
class CountriesGetV2CountriesCountryIDGetOrderByCountriesOrderEnum(str, Enum):
    r"""An enumeration."""
    COUNTRY = 'country'
...
class CountriesGetV2CountriesCountryIDGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class CountriesGetV2CountriesCountryIDGetRequest:
    ...
    order_by: Optional[CountriesGetV2CountriesCountryIDGetOrderByCountriesOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""An enumeration."""  
    page: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'page', 'style': 'form', 'explode': True }})
    r"""Paginate through results."""  
    sort: Optional[CountriesGetV2CountriesCountryIDGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Define sort order."""  
