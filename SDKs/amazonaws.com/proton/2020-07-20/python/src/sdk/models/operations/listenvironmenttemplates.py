...
class ListEnvironmentTemplatesRequest:
    ...
    list_environment_templates_input: shared_listenvironmenttemplatesinput.ListEnvironmentTemplatesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
