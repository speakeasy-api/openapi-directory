...
func (s *Users) GetFlags(ctx context.Context, request operations.GetFlagsRequest) (*operations.GetFlagsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/flags"
	...
	res := &operations.GetFlagsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Users) GetMe(ctx context.Context, request operations.GetMeRequest) (*operations.GetMeResponse, error) {
	baseURL := s._serverURL
...
func (s *Users) PostUsersIDPassword(ctx context.Context, request operations.PostUsersIDPasswordRequest) (*operations.PostUsersIDPasswordResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostUsersIDPasswordResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Users) PutMePassword(ctx context.Context, request operations.PutMePasswordRequest) (*operations.PutMePasswordResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/me/password"
	...
	res := &operations.PutMePasswordResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
