...
type IamProjectsServiceAccountsPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IamProjectsServiceAccountsPatchPathParams struct {
...
type IamProjectsServiceAccountsPatchQueryParams struct {
	// V1 error format.
...
type IamProjectsServiceAccountsPatchResponse struct {
	ContentType string
	// Successful response
