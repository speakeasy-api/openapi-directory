 ...
 */
export enum CreateLaunchTemplateRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateLaunchTemplateRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateLaunchTemplateRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateLaunchTemplateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({ elemType: CreateLaunchTemplateRequestTagSpecifications })
