...
class DeleteArchivePathParams:
    ...
    archive_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'archiveId', 'style': 'simple', 'explode': False }})
...
class DeleteArchiveRequest:
    headers: DeleteArchiveHeaders = dataclasses.field()
    path_params: DeleteArchivePathParams = dataclasses.field()
