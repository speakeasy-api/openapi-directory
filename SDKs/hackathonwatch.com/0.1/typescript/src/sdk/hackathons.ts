...
export class Hackathons {
  ...
  getHackathonsIdFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GETHackathonsIdFormatResponse =
        new operations.GETHackathonsIdFormatResponse({
  ...
  getHackathonsComingFormat(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETHackathonsComingFormatResponse =
        new operations.GETHackathonsComingFormatResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
