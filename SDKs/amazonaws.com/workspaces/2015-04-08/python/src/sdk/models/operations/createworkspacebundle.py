...
class CreateWorkspaceBundleRequest:
    ...
    create_workspace_bundle_request: shared_createworkspacebundlerequest.CreateWorkspaceBundleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
