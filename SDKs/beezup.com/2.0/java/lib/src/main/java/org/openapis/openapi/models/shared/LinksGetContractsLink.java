...
public class LinksGetContractsLink {
    ...
    public LinksGetContractsLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetContractsLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetContractsLink withDescription(String description) {
    ...
    public LinksGetContractsLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetContractsLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetContractsLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetContractsLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetContractsLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetContractsLink withOperationId(String operationId) {
    ...
    public LinksGetContractsLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetContractsLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetContractsLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
