 ...
 */
export enum AcceleratorTypesScopedListWarningCodeEnum {
...
export class AcceleratorTypesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AcceleratorTypesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: AcceleratorTypesScopedListWarningData })
  @Expose({ name: "data" })
...
export class AcceleratorTypesScopedList extends SpeakeasyBase {
  /**
