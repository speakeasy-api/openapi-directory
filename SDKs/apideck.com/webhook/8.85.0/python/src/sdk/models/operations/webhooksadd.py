...
class WebhooksAddRequest:
    headers: WebhooksAddHeaders = dataclasses.field()
    request: shared_createwebhookrequest.CreateWebhookRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: WebhooksAddSecurity = dataclasses.field()
