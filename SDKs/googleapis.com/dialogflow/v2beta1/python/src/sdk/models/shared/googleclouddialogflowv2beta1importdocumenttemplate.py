...
class GoogleCloudDialogflowV2beta1ImportDocumentTemplate:
    ...
    knowledge_types: Optional[list[GoogleCloudDialogflowV2beta1ImportDocumentTemplateKnowledgeTypesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('knowledgeTypes'), 'exclude': lambda f: f is None }})
