...
type EnableRegionHeaders struct {
...
type EnableRegionRequestBody struct {
...
type EnableRegionRequest struct {
	Headers EnableRegionHeaders
	Request EnableRegionRequestBody `request:"mediaType=application/json"`
}

type EnableRegionResponse struct {
