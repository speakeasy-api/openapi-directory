...
public class VideointelligenceVideosAnnotateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest request;
    public VideointelligenceVideosAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest request) {
