...
class SurveyAnswer:
    ...
    question_answer_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('question_answer_id'), 'exclude': lambda f: f is None }})  
    question_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('question_id'), 'exclude': lambda f: f is None }})  
