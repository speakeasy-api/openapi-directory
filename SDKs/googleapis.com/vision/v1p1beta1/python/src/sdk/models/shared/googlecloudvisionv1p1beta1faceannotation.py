...
class GoogleCloudVisionV1p1beta1FaceAnnotation:
    ...
    anger_likelihood: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationAngerLikelihoodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('angerLikelihood'), 'exclude': lambda f: f is None }})
    r"""Anger likelihood."""  
    blurred_likelihood: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationBlurredLikelihoodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('blurredLikelihood'), 'exclude': lambda f: f is None }})
    r"""Blurred likelihood."""  
    ...
    fd_bounding_poly: Optional[shared_googlecloudvisionv1p1beta1boundingpoly.GoogleCloudVisionV1p1beta1BoundingPoly] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fdBoundingPoly'), 'exclude': lambda f: f is None }})
    r"""A bounding polygon for the detected image annotation."""  
    headwear_likelihood: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationHeadwearLikelihoodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('headwearLikelihood'), 'exclude': lambda f: f is None }})
    r"""Headwear likelihood."""  
    joy_likelihood: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationJoyLikelihoodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('joyLikelihood'), 'exclude': lambda f: f is None }})
    r"""Joy likelihood."""  
    ...
    landmarks: Optional[list[shared_googlecloudvisionv1p1beta1faceannotationlandmark.GoogleCloudVisionV1p1beta1FaceAnnotationLandmark]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('landmarks'), 'exclude': lambda f: f is None }})
    ...
    sorrow_likelihood: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationSorrowLikelihoodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sorrowLikelihood'), 'exclude': lambda f: f is None }})
    r"""Sorrow likelihood."""  
    surprise_likelihood: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationSurpriseLikelihoodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('surpriseLikelihood'), 'exclude': lambda f: f is None }})
    r"""Surprise likelihood."""  
    ...
    under_exposed_likelihood: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationUnderExposedLikelihoodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('underExposedLikelihood'), 'exclude': lambda f: f is None }})
    r"""Under-exposed likelihood."""  
