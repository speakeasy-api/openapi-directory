...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export enum ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesCreateForceOnlyEnum {
...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
