...
class CreateTrackerRequestBody:
    pricing_plan: CreateTrackerRequestBodyPricingPlanEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PricingPlan') }})
...
class CreateTrackerRequest:
    headers: CreateTrackerHeaders = dataclasses.field()
    request: CreateTrackerRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
