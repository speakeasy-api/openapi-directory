...
export class GoogleCloudPaymentsResellerSubscriptionV1SubscriptionLineItem extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "lineItemFreeTrialEndTime" })
  ...
  @Expose({ name: "lineItemPromotionSpecs" })
  @Type(
    () => GoogleCloudPaymentsResellerSubscriptionV1SubscriptionPromotionSpec
  )
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "oneTimeRecurrenceDetails" })
  @Type(
    () =>
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "productPayload" })
  @Type(() => GoogleCloudPaymentsResellerSubscriptionV1ProductPayload)
