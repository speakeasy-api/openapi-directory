 ...
 */
export declare class DescribeIpamResourceDiscoveryAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeIpamResourceDiscoveryAssociationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeIpamResourceDiscoveryAssociationsRequestFilters[];
