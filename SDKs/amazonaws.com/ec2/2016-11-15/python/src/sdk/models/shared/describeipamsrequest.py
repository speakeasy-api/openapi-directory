...
class DescribeIpamsRequestFilters:
...
class DescribeIpamsRequest:
    ...
    filters: Optional[list[DescribeIpamsRequestFilters]] = dataclasses.field(default=None)  
    ipam_ids: Optional[list[str]] = dataclasses.field(default=None)  
