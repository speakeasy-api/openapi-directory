...
public class SocialGetPlatformFriendListPathParams {
    /**
    ...
    public SocialGetPlatformFriendListPathParams withFriendPlatform(Integer friendPlatform) {
    ...
    public String page;
    public SocialGetPlatformFriendListPathParams withPage(String page) {
        this.page = page;
        return this;
    }
