...
export class Api {
  ...
  createApiApplication(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreateApiApplicationResponse =
        new operations.CreateApiApplicationResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.apiApplication = utils.objectToClass(
              httpRes?.data,
              operations.CreateApiApplicationApiApplication
            );
          }
          break;
      }
