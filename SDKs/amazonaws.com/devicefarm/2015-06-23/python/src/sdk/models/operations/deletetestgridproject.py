...
class DeleteTestGridProjectRequest:
    ...
    delete_test_grid_project_request: shared_deletetestgridprojectrequest.DeleteTestGridProjectRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
