 ...
 */
export declare enum AuthorizedSellerStatusTargetingOptionDetailsAuthorizedSellerStatusEnum {
 ...
 */
export declare class AuthorizedSellerStatusTargetingOptionDetails extends SpeakeasyBase {
    /**
     * Output only. The authorized seller status.
     */
