...
public class DriveChangesListQueryParams {
    ...
    public DriveChangesListQueryParams withIncludeDeleted(Boolean includeDeleted) {
    ...
    public DriveChangesListQueryParams withIncludeSubscribed(Boolean includeSubscribed) {
    ...
    public DriveChangesListQueryParams withMaxResults(Long maxResults) {
    ...
    public DriveChangesListQueryParams withStartChangeId(String startChangeId) {
