 ...
 */
export declare enum CommitmentsScopedListWarningCodeEnum {
...
export declare class CommitmentsScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class CommitmentsScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class CommitmentsScopedList extends SpeakeasyBase {
    /**
