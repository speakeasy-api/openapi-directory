...
class RecordingRegistrantQuestionUpdateRecordingRegistrantQuestionsCustomQuestions:
    ...
    type: Optional[RecordingRegistrantQuestionUpdateRecordingRegistrantQuestionsCustomQuestionsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of registration question and answers."""  
...
class RecordingRegistrantQuestionUpdateRecordingRegistrantQuestionsQuestions:
    ...
    field_name: Optional[RecordingRegistrantQuestionUpdateRecordingRegistrantQuestionsQuestionsFieldNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('field_name'), 'exclude': lambda f: f is None }})
    r"""Field name."""  
    required: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('required'), 'exclude': lambda f: f is None }})
...
class RecordingRegistrantQuestionUpdateRecordingRegistrantQuestions:
    ...
    custom_questions: Optional[list[RecordingRegistrantQuestionUpdateRecordingRegistrantQuestionsCustomQuestions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom_questions'), 'exclude': lambda f: f is None }, 'multipart_form': { 'field_name': 'custom_questions', 'json': True }})
    r"""Array of Registrant Custom Questions"""  
    questions: Optional[list[RecordingRegistrantQuestionUpdateRecordingRegistrantQuestionsQuestions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('questions'), 'exclude': lambda f: f is None }, 'multipart_form': { 'field_name': 'questions', 'json': True }})
...
class RecordingRegistrantQuestionUpdateRequest:
    ...
    """  
    request_body: RecordingRegistrantQuestionUpdateRecordingRegistrantQuestions = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Recording Registrant Questions"""  
