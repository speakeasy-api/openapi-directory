 ...
 */
public enum AuthorizeSecurityGroupIngressRequestTagSpecificationsResourceTypeEnum {
    ...
    private AuthorizeSecurityGroupIngressRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
