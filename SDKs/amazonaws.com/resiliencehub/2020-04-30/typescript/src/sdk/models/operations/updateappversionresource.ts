 ...
 */
export class UpdateAppVersionResourceRequestBodyLogicalResourceId extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateAppVersionResourceRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(() => UpdateAppVersionResourceRequestBodyLogicalResourceId)
...
export class UpdateAppVersionResourceRequest extends SpeakeasyBase {
...
export class UpdateAppVersionResourceResponse extends SpeakeasyBase {
  /**
