...
import { VmEndpointNatMappings } from "./vmendpointnatmappings";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum VmEndpointNatMappingsListWarningCodeEnum {
...
export declare class VmEndpointNatMappingsListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class VmEndpointNatMappingsListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: VmEndpointNatMappingsListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: VmEndpointNatMappingsListWarningData[];
    /**
 ...
 */
export declare class VmEndpointNatMappingsList extends SpeakeasyBase {
    /**
