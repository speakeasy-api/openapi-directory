...
var Environments = /** @class */ (function () {
     ...
     */
    Environments.prototype.allLines = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AllLinesResponse({
     ...
     */
    Environments.prototype.servicesForALine = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ServicesForALineRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/lines/{line}/services", req);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ServicesForALineResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
