...
try {
    ...
    $request->order = OrderEnum::DESC;
    $request->page = 413086;
    $request->perPage = 287141;
    $request->q = 'expedita';
    $request->sort = SearchIssuesAndPullRequestsSortEnum::REACTIONS_SMILE;
...
try {
    ...
    $request->page = 123795;
    $request->perPage = 317260;
    $request->q = 'nulla';
    $request->repositoryId = 979271;
...
try {
    ...
    $request->order = OrderEnum::ASC;
    $request->page = 770997;
    $request->perPage = 880998;
    $request->q = 'et';
    $request->sort = SearchReposSortEnum::HELP_WANTED_ISSUES;
