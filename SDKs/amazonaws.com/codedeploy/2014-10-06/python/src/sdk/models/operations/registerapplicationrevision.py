...
class RegisterApplicationRevisionRequest:
    headers: RegisterApplicationRevisionHeaders = dataclasses.field()
    request: shared_registerapplicationrevisioninput.RegisterApplicationRevisionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
