...
class GetBlobsRequest:
    ...
    r"""Filter based on the unique blob_key"""  
    ...
    r"""Filter based on the hash of the blob."""  
    ...
    r"""Filter based on the last time the blob was accessed"""  
...
class GetBlobs200ApplicationJSON:
    r"""A JSON object containing a list of blobs"""
    ...
    results: Optional[list[shared_blob.Blob]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
