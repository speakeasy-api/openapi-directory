...
class CreateUnderstandModelBuildRequest:
    ...
    request_body: Optional[CreateUnderstandModelBuildCreateUnderstandModelBuildRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
