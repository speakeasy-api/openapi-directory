...
class ScanInput:
    r"""Represents the input of a <code>Scan</code> operation."""
    ...
    total_segments: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TotalSegments'), 'exclude': lambda f: f is None }})  
