...
exports.PricingExpression = void 0;
var utils_1 = require("../../../internal/utils");
var tierrate_1 = require("./tierrate");
...
var PricingExpression = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "baseUnit" }),
        __metadata("design:type", String)
    ], PricingExpression.prototype, "baseUnit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "baseUnitConversionFactor" }),
        __metadata("design:type", Number)
    ], PricingExpression.prototype, "baseUnitConversionFactor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "baseUnitDescription" }),
        __metadata("design:type", String)
    ], PricingExpression.prototype, "baseUnitDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "displayQuantity" }),
        __metadata("design:type", Number)
    ], PricingExpression.prototype, "displayQuantity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: tierrate_1.TierRate }),
        (0, class_transformer_1.Expose)({ name: "tieredRates" }),
        (0, class_transformer_1.Type)(function () { return tierrate_1.TierRate; }),
        __metadata("design:type", Array)
    ], PricingExpression.prototype, "tieredRates", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usageUnit" }),
        __metadata("design:type", String)
    ], PricingExpression.prototype, "usageUnit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usageUnitDescription" }),
        __metadata("design:type", String)
    ], PricingExpression.prototype, "usageUnitDescription", void 0);
    return PricingExpression;
}(utils_1.SpeakeasyBase));
exports.PricingExpression = PricingExpression;
