...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum {
...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateResponse extends SpeakeasyBase {
    /**
     * Successful response
     */
