...
class UpdateNetworkSwitchQosRuleRequestBody:
    ...
    protocol: Optional[UpdateNetworkSwitchQosRuleRequestBodyProtocolEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""The protocol of the incoming packet. Can be one of \\"ANY\\", \\"TCP\\" or \\"UDP\\". Default value is \\"ANY\\"."""  
...
class UpdateNetworkSwitchQosRuleRequest:
    ...
    request_body: Optional[UpdateNetworkSwitchQosRuleRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
