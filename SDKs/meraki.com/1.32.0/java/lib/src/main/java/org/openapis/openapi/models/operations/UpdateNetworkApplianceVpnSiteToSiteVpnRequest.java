...
public class UpdateNetworkApplianceVpnSiteToSiteVpnRequest {
    ...
    public UpdateNetworkApplianceVpnSiteToSiteVpnRequest(@JsonProperty("RequestBody") UpdateNetworkApplianceVpnSiteToSiteVpnRequestBody requestBody, @JsonProperty("networkId") String networkId) {
        this.requestBody = requestBody;
        this.networkId = networkId;
  }
}
