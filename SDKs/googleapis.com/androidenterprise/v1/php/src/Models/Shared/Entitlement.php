...
class Entitlement
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\EntitlementReasonEnum $reason
     */
	#[\JMS\Serializer\Annotation\SerializedName('reason')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\EntitlementReasonEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?EntitlementReasonEnum $reason = null;
