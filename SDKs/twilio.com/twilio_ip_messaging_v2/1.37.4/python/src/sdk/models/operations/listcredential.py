...
class ListCredentialListCredentialResponse:
    credentials: Optional[list[shared_ip_messaging_v2_credential.IPMessagingV2Credential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('credentials') }})
