...
public class AssignedTargetingOptionInput {
    ...
    public DeviceTypeAssignedTargetingOptionDetailsInput deviceTypeDetails;
    public AssignedTargetingOptionInput withDeviceTypeDetails(DeviceTypeAssignedTargetingOptionDetailsInput deviceTypeDetails) {
    ...
    public AssignedTargetingOptionInput withDigitalContentLabelExclusionDetails(DigitalContentLabelAssignedTargetingOptionDetails digitalContentLabelExclusionDetails) {
    ...
    public AssignedTargetingOptionInput withSensitiveCategoryExclusionDetails(SensitiveCategoryAssignedTargetingOptionDetails sensitiveCategoryExclusionDetails) {
