...
type GETCreditMemoTypeStatusEnum string

const (
	GETCreditMemoTypeStatusEnumDraft            GETCreditMemoTypeStatusEnum = "Draft"
	GETCreditMemoTypeStatusEnumPosted           GETCreditMemoTypeStatusEnum = "Posted"
	GETCreditMemoTypeStatusEnumCanceled         GETCreditMemoTypeStatusEnum = "Canceled"
	GETCreditMemoTypeStatusEnumError            GETCreditMemoTypeStatusEnum = "Error"
	GETCreditMemoTypeStatusEnumPendingForTax    GETCreditMemoTypeStatusEnum = "PendingForTax"
	GETCreditMemoTypeStatusEnumGenerating       GETCreditMemoTypeStatusEnum = "Generating"
	GETCreditMemoTypeStatusEnumCancelInProgress GETCreditMemoTypeStatusEnum = "CancelInProgress"
)

func (e *GETCreditMemoTypeStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "CancelInProgress":
		*e = GETCreditMemoTypeStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreditMemoTypeStatusEnum: %s", s)
	}
}
...
type GETCreditMemoTypeTaxStatusEnum string

const (
	GETCreditMemoTypeTaxStatusEnumComplete GETCreditMemoTypeTaxStatusEnum = "Complete"
	GETCreditMemoTypeTaxStatusEnumError    GETCreditMemoTypeTaxStatusEnum = "Error"
)

func (e *GETCreditMemoTypeTaxStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Complete":
		fallthrough
	case "Error":
		*e = GETCreditMemoTypeTaxStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreditMemoTypeTaxStatusEnum: %s", s)
	}
}
...
type GETCreditMemoTypeTransferredToAccountingEnum string

const (
	GETCreditMemoTypeTransferredToAccountingEnumProcessing GETCreditMemoTypeTransferredToAccountingEnum = "Processing"
	GETCreditMemoTypeTransferredToAccountingEnumYes        GETCreditMemoTypeTransferredToAccountingEnum = "Yes"
	GETCreditMemoTypeTransferredToAccountingEnumNo         GETCreditMemoTypeTransferredToAccountingEnum = "No"
	GETCreditMemoTypeTransferredToAccountingEnumError      GETCreditMemoTypeTransferredToAccountingEnum = "Error"
	GETCreditMemoTypeTransferredToAccountingEnumIgnore     GETCreditMemoTypeTransferredToAccountingEnum = "Ignore"
)

func (e *GETCreditMemoTypeTransferredToAccountingEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Error":
		fallthrough
	case "Ignore":
		*e = GETCreditMemoTypeTransferredToAccountingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETCreditMemoTypeTransferredToAccountingEnum: %s", s)
	}
}
...
type GETCreditMemoType struct {
	...
	//
	Status *GETCreditMemoTypeStatusEnum `json:"status,omitempty"`
	...
	// **Note**: This field is only applicable to tax calculation by third-party tax engines.
	//
	TaxStatus *GETCreditMemoTypeTaxStatusEnum `json:"taxStatus,omitempty"`
	...
	//
	TransferredToAccounting *GETCreditMemoTypeTransferredToAccountingEnum `json:"transferredToAccounting,omitempty"`
