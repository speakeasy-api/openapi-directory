...
class GetListTagsForResourceQueryParams:
    action: GetListTagsForResourceActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    resource_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ResourceName', 'style': 'form', 'explode': True }})
    version: GetListTagsForResourceVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListTagsForResourceRequest:
    headers: GetListTagsForResourceHeaders = dataclasses.field()
    query_params: GetListTagsForResourceQueryParams = dataclasses.field()
