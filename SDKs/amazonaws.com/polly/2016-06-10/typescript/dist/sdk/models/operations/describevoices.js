...
exports.DescribeVoicesResponse = exports.DescribeVoicesRequest = exports.DescribeVoicesLanguageCodeEnum = exports.DescribeVoicesEngineEnum = void 0;
...
(function (DescribeVoicesLanguageCodeEnum) {
    ...
    DescribeVoicesLanguageCodeEnum["CaES"] = "ca-ES";
    DescribeVoicesLanguageCodeEnum["DeAT"] = "de-AT";
    DescribeVoicesLanguageCodeEnum["YueCN"] = "yue-CN";
    DescribeVoicesLanguageCodeEnum["ArAE"] = "ar-AE";
    DescribeVoicesLanguageCodeEnum["FIFI"] = "fi-FI";
...
var DescribeVoicesRequest = /** @class */ (function (_super) {
    ...
    ], DescribeVoicesRequest.prototype, "engine", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IncludeAdditionalLanguageCodes",
        }),
        __metadata("design:type", Boolean)
    ], DescribeVoicesRequest.prototype, "includeAdditionalLanguageCodes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=LanguageCode",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "languageCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=NextToken",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "nextToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DescribeVoicesRequest.prototype, "xAmzSignedHeaders", void 0);
...
var DescribeVoicesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DescribeVoicesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
