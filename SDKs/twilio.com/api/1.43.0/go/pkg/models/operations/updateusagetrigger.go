...
func (e UpdateUsageTriggerUpdateUsageTriggerRequestCallbackMethodEnum) ToPointer() *UpdateUsageTriggerUpdateUsageTriggerRequestCallbackMethodEnum {
	return &e
}
...
func (e *UpdateUsageTriggerUpdateUsageTriggerRequestCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateUsageTriggerUpdateUsageTriggerRequestCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateUsageTriggerUpdateUsageTriggerRequestCallbackMethodEnum: %v", v)
	}
}
