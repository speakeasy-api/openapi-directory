...
func (e *ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum: %s", s)
	}
}
