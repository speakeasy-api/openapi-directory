...
class GETRemoveTagsFromResourceRequest:
    ...
    r"""The Amazon Neptune resource that the tags are removed from. This value is an Amazon Resource Name (ARN). For information about creating an ARN, see <a href=\\"https://docs.aws.amazon.com/neptune/latest/UserGuide/tagging.ARN.html#tagging.ARN.Constructing\\"> Constructing an Amazon Resource Name (ARN)</a>."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'TagKeys', 'style': 'form', 'explode': True }})
    r"""The tag key (name) of the tag to be removed."""  
