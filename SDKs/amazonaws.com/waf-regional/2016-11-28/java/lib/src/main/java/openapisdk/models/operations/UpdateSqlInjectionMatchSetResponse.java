...
public class UpdateSqlInjectionMatchSetResponse {
    ...
    public UpdateSqlInjectionMatchSetResponse withStatusCode(Long statusCode) {
        this.statusCode = statusCode;
        return this;
    }
    public openapisdk.models.shared.UpdateSqlInjectionMatchSetResponse updateSqlInjectionMatchSetResponse;
    public UpdateSqlInjectionMatchSetResponse withUpdateSqlInjectionMatchSetResponse(openapisdk.models.shared.UpdateSqlInjectionMatchSetResponse updateSqlInjectionMatchSetResponse) {
