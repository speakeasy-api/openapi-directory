...
class CreateAssetRequest:
    ...
    r"""The SID of the Service to create the Asset resource under."""  
    request_body: Optional[CreateAssetCreateAssetRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
