...
class HIUConsentNotificationResponse:
    ...
    acknowledgement: Optional[list[shared_consentacknowledgement.ConsentAcknowledgement]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('acknowledgement'), 'exclude': lambda f: f is None }})  
