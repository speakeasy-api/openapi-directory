...
from ..shared import getworkflowstepsresponse as shared_getworkflowstepsresponse
...
class GetWorkflowStepsResponse:
    ...
    get_workflow_steps_response: Optional[shared_getworkflowstepsresponse.GetWorkflowStepsResponse] = dataclasses.field(default=None)
    r"""Success"""  
