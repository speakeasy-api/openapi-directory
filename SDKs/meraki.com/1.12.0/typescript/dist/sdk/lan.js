...
var Lan = /** @class */ (function () {
    function Lan(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Lan.prototype.getDeviceCellularGatewayLan = function (req, config) {
    ...
    **/
    Lan.prototype.updateDeviceCellularGatewayLan = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
