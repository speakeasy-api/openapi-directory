...
type CreateRotationOverrideHeaders struct {
...
type CreateRotationOverrideRequest struct {
	Headers CreateRotationOverrideHeaders
	Request shared.CreateRotationOverrideRequest `request:"mediaType=application/json"`
}
