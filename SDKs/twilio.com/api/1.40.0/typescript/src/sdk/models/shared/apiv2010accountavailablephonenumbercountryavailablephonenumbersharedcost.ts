 ...
 */
export class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCostCapabilities extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "fax" })
  fax?: boolean;
...
export class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost extends SpeakeasyBase {
  /**
