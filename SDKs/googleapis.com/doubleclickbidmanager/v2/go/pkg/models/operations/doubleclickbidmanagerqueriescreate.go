...
type DoubleclickbidmanagerQueriesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DoubleclickbidmanagerQueriesCreateQueryParams struct {
	// V1 error format.
...
type DoubleclickbidmanagerQueriesCreateResponse struct {
	ContentType string
	// Successful response
	Query       *shared.Query
	StatusCode  int
