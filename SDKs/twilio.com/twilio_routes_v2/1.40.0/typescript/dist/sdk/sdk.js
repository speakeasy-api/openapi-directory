 ...
 */
exports.ServerList = ["https://routes.twilio.com"];
/**
...
var SDK = /** @class */ (function () {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.routesV2PhoneNumber = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.RoutesV2PhoneNumber);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.fetchSipDomain = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/SipDomains/{SipDomain}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.routesV2SipDomain = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.RoutesV2SipDomain);
                    }
                    break;
            }
            return res;
     ...
     */
    SDK.prototype.fetchTrunks = function (req, security, serverURL, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Trunks/{SipTrunkDomain}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.FetchTrunksResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.routesV2Trunks = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.RoutesV2Trunks);
                    }
                    break;
            }
            return res;
     ...
     */
    SDK.prototype.updateTrunks = function (req, security, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.UpdateTrunksResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
