...
public class TypeNotesNotebook {
    ...
    public org.openapis.openapi.models.operations.SearchNotesNotebookResponse searchNotesNotebook(org.openapis.openapi.models.operations.SearchNotesNotebookRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.SearchNotesNotebookQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.SearchNotesNotebookResponse res = new org.openapis.openapi.models.operations.SearchNotesNotebookResponse() {{
        }};
