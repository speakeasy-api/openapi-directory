...
class CompleteUserQuota:
    r"""user's upload quota"""
    
    unlimited_upload_quota: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unlimited_upload_quota'), 'exclude': lambda f: f is None }})
    r"""unlimited upload quota."""  
    upload_seconds_used: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('upload_seconds_used'), 'exclude': lambda f: f is None }})
    r"""upload seconds used."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CompleteUserSubscriptions1Product:
    r"""product"""
...
class CompleteUserSubscriptions1:
    ...
    product: Optional[CompleteUserSubscriptions1Product] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('product'), 'exclude': lambda f: f is None }})
    r"""product"""  
...
@dataclasses.dataclass
class CompleteUser:
    r"""SoundCloud Complete User object"""
    ...
    primary_email_confirmed: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_email_confirmed'), 'exclude': lambda f: f is None }})
    r"""boolean if email is confirmed."""  
    private_playlists_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('private_playlists_count'), 'exclude': lambda f: f is None }})
    r"""number of private playlists."""  
    private_tracks_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('private_tracks_count'), 'exclude': lambda f: f is None }})
    r"""number of private tracks."""  
    ...
    quota: Optional[CompleteUserQuota] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('quota'), 'exclude': lambda f: f is None }})
    r"""user's upload quota"""  
