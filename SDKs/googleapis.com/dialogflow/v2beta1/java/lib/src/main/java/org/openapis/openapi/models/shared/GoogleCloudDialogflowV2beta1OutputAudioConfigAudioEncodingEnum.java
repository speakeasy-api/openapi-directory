 ...
 */
public enum GoogleCloudDialogflowV2beta1OutputAudioConfigAudioEncodingEnum {
    ...
    private GoogleCloudDialogflowV2beta1OutputAudioConfigAudioEncodingEnum(String value) {
        this.value = value;
    }
}
