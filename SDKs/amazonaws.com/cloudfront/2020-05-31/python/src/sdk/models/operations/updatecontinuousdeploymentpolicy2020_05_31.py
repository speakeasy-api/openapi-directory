...
class UpdateContinuousDeploymentPolicy20200531RequestBodyContinuousDeploymentPolicyConfig:
...
class UpdateContinuousDeploymentPolicy20200531RequestBody:
    ...
    continuous_deployment_policy_config: UpdateContinuousDeploymentPolicy20200531RequestBodyContinuousDeploymentPolicyConfig = dataclasses.field()
    r"""Contains the configuration for a continuous deployment policy."""  
    

@dataclasses.dataclass
class UpdateContinuousDeploymentPolicy20200531Request:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'Id', 'style': 'simple', 'explode': False }})
    r"""The identifier of the continuous deployment policy that you are updating."""  
    ...
    r"""The current version (<code>ETag</code> value) of the continuous deployment policy that you are updating."""  
...
@dataclasses.dataclass
class UpdateContinuousDeploymentPolicy20200531Response:
