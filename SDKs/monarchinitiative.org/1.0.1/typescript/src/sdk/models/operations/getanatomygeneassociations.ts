...
export class GetAnatomyGeneAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetAnatomyGeneAssociationsQueryParams extends SpeakeasyBase {
...
export class GetAnatomyGeneAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetAnatomyGeneAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
