...
exports.VerifyV2Service = void 0;
...
var VerifyV2Service = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "code_length" }),
        __metadata("design:type", Number)
    ], VerifyV2Service.prototype, "codeLength", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "custom_code_enabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_template_sid" }),
        __metadata("design:type", String)
    ], VerifyV2Service.prototype, "defaultTemplateSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "do_not_share_warning_enabled" }),
        __metadata("design:type", Boolean)
    ], VerifyV2Service.prototype, "doNotShareWarningEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "dtmf_input_required" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lookup_enabled" }),
        __metadata("design:type", Boolean)
    ], VerifyV2Service.prototype, "lookupEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "psd2_enabled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "skip_sms_to_landlines" }),
        __metadata("design:type", Boolean)
    ], VerifyV2Service.prototype, "skipSmsToLandlines", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "totp" }),
        __metadata("design:type", Object)
    ], VerifyV2Service.prototype, "totp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tts_name" }),
        __metadata("design:type", String)
...
exports.VerifyV2Service = VerifyV2Service;
