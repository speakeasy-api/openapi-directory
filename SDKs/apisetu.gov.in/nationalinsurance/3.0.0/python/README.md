...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/nationalinsurance/3.0.0/python
```
...
req = operations.CripcRequestBody(
    certificate_parameters=operations.CripcRequestBodyCertificateParameters(
        customer_id="9520949605",
        policy_number="500100501910002284",
        policy_start_date="06/03/2020",
    ),
