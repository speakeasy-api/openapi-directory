...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\JobsProjectsClientEventsCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/clientEvents', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsClientEventsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/companies', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsCompaniesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/companies', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsCompaniesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{name}:complete', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsCompleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/jobs:batchDelete', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsBatchDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/jobs', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{name}', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsDeleteRequest::class, $request);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetResponse
     */
	public function jobsProjectsJobsGet(
        \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{name}', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsGetResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/jobs', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{name}', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/jobs:search', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsSearchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v3/{parent}/jobs:searchForAlert', \OpenAPI\OpenAPI\Models\Operations\JobsProjectsJobsSearchForAlertRequest::class, $request);
