...
class GetUsersIDUserConnectionsIDConnectionLogsRequest:
...
class GetUsersIDUserConnectionsIDConnectionLogsResponse:
    ...
    get_users_id_user_connections_id_connection_logs_200_application_json_object: Optional[GetUsersIDUserConnectionsIDConnectionLogs200ApplicationJSON] = dataclasses.field(default=None)
    r"""connectionlogs"""  
