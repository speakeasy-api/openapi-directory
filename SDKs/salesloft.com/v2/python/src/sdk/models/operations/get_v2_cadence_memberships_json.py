...
class GetV2CadenceMembershipsJSONRequest:
    ...
    cadence_id: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'cadence_id', 'style': 'form', 'explode': True }})
    r"""ID of the cadence to find cadence memberships for"""  
    currently_on_cadence: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'currently_on_cadence', 'style': 'form', 'explode': True }})
    r"""If true, return only cadence memberships for people currently on cadences.  If false, return cadence memberships for people who have been removed from or have completed a cadence."""  
    ids: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ids', 'style': 'form', 'explode': False }})
    r"""IDs of cadence memberships to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
    ...
    person_id: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'person_id', 'style': 'form', 'explode': True }})
    r"""ID of the person to find cadence memberships for"""  
    sort_by: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort_by', 'style': 'form', 'explode': True }})
    r"""Key to sort on, must be one of: added_at, updated_at. Defaults to updated_at"""  
...
@dataclasses.dataclass
class GetV2CadenceMembershipsJSONResponse:
