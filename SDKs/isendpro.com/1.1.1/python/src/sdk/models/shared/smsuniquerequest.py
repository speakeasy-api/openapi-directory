...
class SmsUniqueRequest:
    ...
    """  
    gmt_zone: Optional[SmsUniqueRequestGmtZoneEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gmt_zone'), 'exclude': lambda f: f is None }})
    r"""Fuseau horaire de la date d'envoi"""  
    ...
    num_azur: Optional[SmsUniqueRequestNumAzurEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('numAzur'), 'exclude': lambda f: f is None }})  
