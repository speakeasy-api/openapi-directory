...
var Delete = /** @class */ (function () {
    function Delete(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Delete.prototype.keyRevoke = function (req, config) {
     ...
     *
    **/
    Delete.prototype.keyRevokeNosecret = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Delete.prototype.signDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
