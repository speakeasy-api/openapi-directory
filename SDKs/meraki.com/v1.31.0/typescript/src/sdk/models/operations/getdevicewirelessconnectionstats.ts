 ...
 */
export class GetDeviceWirelessConnectionStats200ApplicationJSONConnectionStats extends SpeakeasyBase {
  /**
 ...
 */
export class GetDeviceWirelessConnectionStats200ApplicationJSON extends SpeakeasyBase {
  /**
   * The connection stats of the device
   */
  @SpeakeasyMetadata()
  @Expose({ name: "connectionStats" })
  @Type(() => GetDeviceWirelessConnectionStats200ApplicationJSONConnectionStats)
