...
class GetNetworkSwitchAccessPolicyRequest:
    path_params: GetNetworkSwitchAccessPolicyPathParams = dataclasses.field()
...
class GetNetworkSwitchAccessPolicyResponse:
    ...
    get_network_switch_access_policy_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
