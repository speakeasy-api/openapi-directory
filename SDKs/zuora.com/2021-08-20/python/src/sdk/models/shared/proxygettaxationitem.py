...
class ProxyGetTaxationItem:
    ...
    r"""The ID of the user who created the taxation item.
    **Character limit**: 32 **Values**: automatically generated
    ...
    r"""The date when the payment was created in the Zuora system.
    ...
    **Character limit**: 10 **Values**: `Percentage`, `FlatFee`
    ...
    r"""The ID of the user who last updated the taxation item.
    **Character limit**: **Values**: automatically generated
    ...
    r"""The date when the taxation item was last updated. **Character limit**: **Values**: automatically generated"""  
