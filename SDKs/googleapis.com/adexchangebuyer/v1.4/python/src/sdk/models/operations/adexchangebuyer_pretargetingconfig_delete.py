...
class AdexchangebuyerPretargetingConfigDeleteRequest:
    path_params: AdexchangebuyerPretargetingConfigDeletePathParams = dataclasses.field()
    query_params: AdexchangebuyerPretargetingConfigDeleteQueryParams = dataclasses.field()
    security: AdexchangebuyerPretargetingConfigDeleteSecurity = dataclasses.field()
