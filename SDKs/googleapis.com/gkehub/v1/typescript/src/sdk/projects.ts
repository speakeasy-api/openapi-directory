...
export class Projects {
  ...
  **/
  gkehubProjectsLocationsFeaturesCreate(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/features", req.pathParams);
  ...
  **/
  gkehubProjectsLocationsMembershipsGenerateConnectManifest(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{name}:generateConnectManifest", req.pathParams);
