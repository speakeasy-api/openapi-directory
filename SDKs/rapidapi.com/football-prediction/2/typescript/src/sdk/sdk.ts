...
export class SDK {
  ...
  getApiV2ListFederations(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetApiV2ListFederationsResponse =
        new operations.GetApiV2ListFederationsResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2ListFederations200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2ListFederations200ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2ListFederations404ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2ListFederations404ApplicationJSON
              );
          }
          break;
      }
  ...
  getApiV2ListMarkets(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetApiV2ListMarketsResponse =
        new operations.GetApiV2ListMarketsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2ListMarkets200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2ListMarkets200ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2ListMarkets404ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2ListMarkets404ApplicationJSON
              );
          }
          break;
      }
  ...
  getApiV2PerformanceStats(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/v2/performance-stats";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetApiV2PerformanceStatsResponse =
        new operations.GetApiV2PerformanceStatsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2PerformanceStats200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2PerformanceStats200ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2PerformanceStats404ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2PerformanceStats404ApplicationJSON
              );
          }
          break;
      }
  ...
  getApiV2Predictions(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetApiV2PredictionsResponse =
        new operations.GetApiV2PredictionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2Predictions404ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2Predictions404ApplicationJSON
              );
          }
          break;
      }
  ...
  getApiV2PredictionsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetApiV2PredictionsIdResponse =
        new operations.GetApiV2PredictionsIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2PredictionsId200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2PredictionsId200ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getApiV2PredictionsId404ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetApiV2PredictionsId404ApplicationJSON
              );
          }
          break;
      }
