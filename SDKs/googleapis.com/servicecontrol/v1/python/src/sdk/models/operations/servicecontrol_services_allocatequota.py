...
class ServicecontrolServicesAllocateQuotaRequest:
    ...
    r"""Name of the service as specified in the service configuration. For example, `\\"pubsub.googleapis.com\\"`. See google.api.Service for the definition of a service name."""  
    dollar_xgafv: Optional[shared__xgafv_enum.XgafvEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': '$.xgafv', 'style': 'form', 'explode': True }})
    r"""V1 error format."""  
    access_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'access_token', 'style': 'form', 'explode': True }})
    r"""OAuth access token."""  
    allocate_quota_request: Optional[shared_allocatequotarequest.AllocateQuotaRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
