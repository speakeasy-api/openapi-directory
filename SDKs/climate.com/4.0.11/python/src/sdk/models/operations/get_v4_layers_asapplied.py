...
from ..shared import applicationactivities as shared_applicationactivities
...
class GetV4LayersAsAppliedResponse:
    ...
    application_activities: Optional[shared_applicationactivities.ApplicationActivities] = dataclasses.field(default=None)
    r"""OK"""  
