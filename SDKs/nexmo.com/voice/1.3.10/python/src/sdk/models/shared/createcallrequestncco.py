...
class CreateCallRequestNcco:
    ...
    r"""The [Nexmo Call Control Object](/voice/voice-api/ncco-reference) to use for this call."""  
    to: list[Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('to') }})  
    event_method: Optional[CreateCallRequestNccoEventMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('event_method'), 'exclude': lambda f: f is None }})
    r"""The HTTP method used to send event information to `event_url`."""  
    ...
    machine_detection: Optional[CreateCallRequestNccoMachineDetectionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('machine_detection'), 'exclude': lambda f: f is None }})
    r"""Configure the behavior when Vonage detects that the call is answered by voicemail. If `continue`, Vonage sends an HTTP request to `event_url` with the Call event machine. If `hangup`, Vonage ends the call."""  
