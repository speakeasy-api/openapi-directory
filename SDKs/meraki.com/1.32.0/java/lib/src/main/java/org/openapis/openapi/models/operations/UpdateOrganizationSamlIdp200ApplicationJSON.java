...
public class UpdateOrganizationSamlIdp200ApplicationJSON {
    /**
    ...
    public UpdateOrganizationSamlIdp200ApplicationJSON withConsumerUrl(String consumerUrl) {
    ...
    public UpdateOrganizationSamlIdp200ApplicationJSON withIdpId(String idpId) {
        this.idpId = idpId;
        return this;
    }
    ...
    public UpdateOrganizationSamlIdp200ApplicationJSON withSloLogoutUrl(String sloLogoutUrl) {
    ...
    public UpdateOrganizationSamlIdp200ApplicationJSON withX509certSha1Fingerprint(String x509certSha1Fingerprint) {
        this.x509certSha1Fingerprint = x509certSha1Fingerprint;
        return this;
    }
    
    public UpdateOrganizationSamlIdp200ApplicationJSON(){}
}
