...
class AddonIssue:
    r"""An issue related to an add-on."""
    
    code: Optional[shared_addonissuecode_enum.AddonIssueCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})  
