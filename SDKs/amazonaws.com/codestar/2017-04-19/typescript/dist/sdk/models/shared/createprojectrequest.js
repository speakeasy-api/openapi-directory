...
var CreateProjectRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "sourceCode" }),
        (0, class_transformer_1.Type)(function () { return code_1.Code; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "toolchain" }),
        (0, class_transformer_1.Type)(function () { return toolchain_1.Toolchain; }),
        __metadata("design:type", toolchain_1.Toolchain)
