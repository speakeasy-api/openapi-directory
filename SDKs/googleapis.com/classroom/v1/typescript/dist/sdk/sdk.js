...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.invitations = new invitations_1.Invitations(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
