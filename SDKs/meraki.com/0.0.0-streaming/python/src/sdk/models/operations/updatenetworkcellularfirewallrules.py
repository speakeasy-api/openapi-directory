...
class UpdateNetworkCellularFirewallRulesRequestBodyRulesPolicyEnum(str, Enum):
    r"""'allow' or 'deny' traffic specified by this rule"""
    ALLOW = 'allow'
    DENY = 'deny'

class UpdateNetworkCellularFirewallRulesRequestBodyRulesProtocolEnum(str, Enum):
...
class UpdateNetworkCellularFirewallRulesRequestBodyRules:
    ...
    policy: UpdateNetworkCellularFirewallRulesRequestBodyRulesPolicyEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policy') }})
    r"""'allow' or 'deny' traffic specified by this rule"""  
    protocol: UpdateNetworkCellularFirewallRulesRequestBodyRulesProtocolEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol') }})
    r"""The type of protocol (must be 'tcp', 'udp', 'icmp', 'icmp6' or 'any')"""  
...
class UpdateNetworkCellularFirewallRulesRequestBody:
    ...
    rules: Optional[list[UpdateNetworkCellularFirewallRulesRequestBodyRules]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules'), 'exclude': lambda f: f is None }})
...
class UpdateNetworkCellularFirewallRulesRequest:
    ...
    request_body: Optional[UpdateNetworkCellularFirewallRulesRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateNetworkCellularFirewallRulesResponse:
    ...
    update_network_cellular_firewall_rules_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
