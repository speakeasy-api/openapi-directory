...
exports.CalendarFreebusyQueryResponse = exports.CalendarFreebusyQueryRequest = exports.CalendarFreebusyQuerySecurity = exports.CalendarFreebusyQuerySecurityOption2 = exports.CalendarFreebusyQuerySecurityOption1 = void 0;
...
var CalendarFreebusyQueryRequest = /** @class */ (function (_super) {
    ...
    ], CalendarFreebusyQueryRequest.prototype, "freeBusyRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], CalendarFreebusyQueryRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], CalendarFreebusyQueryRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], CalendarFreebusyQueryRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], CalendarFreebusyQueryRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], CalendarFreebusyQueryRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], CalendarFreebusyQueryRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], CalendarFreebusyQueryRequest.prototype, "userIp", void 0);
...
var CalendarFreebusyQueryResponse = /** @class */ (function (_super) {
    ...
    ], CalendarFreebusyQueryResponse.prototype, "rawResponse", void 0);
