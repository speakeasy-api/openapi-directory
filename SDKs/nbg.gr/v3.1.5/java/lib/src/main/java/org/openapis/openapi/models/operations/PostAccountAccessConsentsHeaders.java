...
public class PostAccountAccessConsentsHeaders {
    /**
     * The unique id of the sandbox to be used
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=sandbox-id")
    public String sandboxId;
    public PostAccountAccessConsentsHeaders withSandboxId(String sandboxId) {
    ...
    public PostAccountAccessConsentsHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public PostAccountAccessConsentsHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public PostAccountAccessConsentsHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public PostAccountAccessConsentsHeaders withXFapiInteractionId(String xFapiInteractionId) {
