...
func (s *Users) DelUser(ctx context.Context, request operations.DelUserRequest) (*operations.DelUserResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.DelUserResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Users) GetUser(ctx context.Context, request operations.GetUserRequest) (*operations.GetUserResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetUser200ApplicationJSONOneOf = out
		}
	}
...
func (s *Users) PutUser(ctx context.Context, request operations.PutUserRequest) (*operations.PutUserResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/users/{id}", request.PathParams)
...
func (s *Users) RegisterUser(ctx context.Context, request operations.RegisterUserRequest) (*operations.RegisterUserResponse, error) {
	baseURL := s._serverURL
...
func (s *Users) ResendEmailToVerifyUser(ctx context.Context) (*operations.ResendEmailToVerifyUserResponse, error) {
	baseURL := s._serverURL
...
// containing a secret.
func (s *Users) VerifyUser(ctx context.Context, request operations.VerifyUserRequest) (*operations.VerifyUserResponse, error) {
	baseURL := s._serverURL
