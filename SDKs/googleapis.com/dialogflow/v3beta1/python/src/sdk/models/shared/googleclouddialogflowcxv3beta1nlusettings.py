...
class GoogleCloudDialogflowCxV3beta1NluSettings:
    ...
    model_training_mode: Optional[GoogleCloudDialogflowCxV3beta1NluSettingsModelTrainingModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modelTrainingMode'), 'exclude': lambda f: f is None }})
    r"""Indicates NLU model training mode."""  
    model_type: Optional[GoogleCloudDialogflowCxV3beta1NluSettingsModelTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('modelType'), 'exclude': lambda f: f is None }})
    r"""Indicates the type of NLU model."""  
