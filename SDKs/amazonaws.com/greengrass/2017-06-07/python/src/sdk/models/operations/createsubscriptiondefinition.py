...
class CreateSubscriptionDefinitionRequestBodyInitialVersion:
    r"""Information about a subscription definition version."""
...
class CreateSubscriptionDefinitionRequestBody:
    ...
    initial_version: Optional[CreateSubscriptionDefinitionRequestBodyInitialVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InitialVersion'), 'exclude': lambda f: f is None }})
    r"""Information about a subscription definition version."""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Name'), 'exclude': lambda f: f is None }})
    r"""The name of the subscription definition."""  
...
class CreateSubscriptionDefinitionRequest:
    ...
    request_body: CreateSubscriptionDefinitionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
