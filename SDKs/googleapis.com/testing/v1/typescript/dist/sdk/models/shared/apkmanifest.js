...
var ApkManifest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: intentfilter_1.IntentFilter }),
        (0, class_transformer_1.Expose)({ name: "intentFilters" }),
        (0, class_transformer_1.Type)(function () { return intentfilter_1.IntentFilter; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "minSdkVersion" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "targetSdkVersion" }),
        __metadata("design:type", Number)
    ], ApkManifest.prototype, "targetSDKVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: usesfeature_1.UsesFeature }),
        (0, class_transformer_1.Expose)({ name: "usesFeature" }),
        (0, class_transformer_1.Type)(function () { return usesfeature_1.UsesFeature; }),
        __metadata("design:type", Array)
    ], ApkManifest.prototype, "usesFeature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usesPermission" }),
        __metadata("design:type", Array)
