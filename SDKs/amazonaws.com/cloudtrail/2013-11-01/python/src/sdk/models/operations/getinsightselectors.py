...
class GetInsightSelectorsRequest:
    headers: GetInsightSelectorsHeaders = dataclasses.field()
    request: shared_getinsightselectorsrequest.GetInsightSelectorsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
