...
type TwoSendPaymentsWithSavedCreditCardPathParams struct {
	TransactionID string `pathParam:"style=simple,explode=false,name=transactionId"`
}

type TwoSendPaymentsWithSavedCreditCardHeaders struct {
...
type TwoSendPaymentsWithSavedCreditCardRequest struct {
	PathParams TwoSendPaymentsWithSavedCreditCardPathParams
	Headers    TwoSendPaymentsWithSavedCreditCardHeaders
	Request    []shared.TwoSendPaymentsWithSavedCreditCardRequest `request:"mediaType=application/json"`
}

type TwoSendPaymentsWithSavedCreditCardResponse struct {
	ContentType string
	StatusCode  int
