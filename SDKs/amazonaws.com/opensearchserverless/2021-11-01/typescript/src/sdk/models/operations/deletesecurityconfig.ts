...
export enum DeleteSecurityConfigXAmzTargetEnum {
  OpenSearchServerlessDeleteSecurityConfig = "OpenSearchServerless.DeleteSecurityConfig",
}

export class DeleteSecurityConfigRequest extends SpeakeasyBase {
...
export class DeleteSecurityConfigResponse extends SpeakeasyBase {
  /**
   * ConflictException
   */
  @SpeakeasyMetadata()
