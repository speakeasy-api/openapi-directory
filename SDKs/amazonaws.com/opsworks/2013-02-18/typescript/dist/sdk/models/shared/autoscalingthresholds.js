...
var AutoScalingThresholds = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CpuThreshold" }),
        __metadata("design:type", Number)
    ], AutoScalingThresholds.prototype, "cpuThreshold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "IgnoreMetricsTime" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MemoryThreshold" }),
        __metadata("design:type", Number)
    ], AutoScalingThresholds.prototype, "memoryThreshold", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ThresholdsWaitTime" }),
        __metadata("design:type", Number)
