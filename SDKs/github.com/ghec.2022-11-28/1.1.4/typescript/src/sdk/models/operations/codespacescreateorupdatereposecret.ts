...
export class CodespacesCreateOrUpdateRepoSecretRequestBody extends SpeakeasyBase {
  /**
...
export class CodespacesCreateOrUpdateRepoSecretRequest extends SpeakeasyBase {
...
export class CodespacesCreateOrUpdateRepoSecretResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
