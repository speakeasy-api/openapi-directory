...
class GetCaseDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetCaseDiseaseAssociationsQueryParams:
...
class GetCaseDiseaseAssociationsRequest:
    path_params: GetCaseDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetCaseDiseaseAssociationsQueryParams = dataclasses.field()
