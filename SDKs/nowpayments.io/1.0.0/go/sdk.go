...
func New(opts ...SDKOption) *SDK {
	...
	sdk.BillingSubPartnerAPI = newBillingSubPartnerAPI(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.PaymentsAPI = newPaymentsAPI(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.RecurringPaymentsAPIEmailSubscriptionsFeature = newRecurringPaymentsAPIEmailSubscriptionsFeature(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
