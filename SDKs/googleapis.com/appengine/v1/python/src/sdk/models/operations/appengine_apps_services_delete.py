...
@dataclasses.dataclass
class AppengineAppsServicesDeleteQueryParams:
...
class AppengineAppsServicesDeleteRequest:
    path_params: AppengineAppsServicesDeletePathParams = dataclasses.field()
    query_params: AppengineAppsServicesDeleteQueryParams = dataclasses.field()
    security: AppengineAppsServicesDeleteSecurity = dataclasses.field()
