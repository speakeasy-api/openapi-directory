...
exports.ConversionsGetDatapointsCountResponse = exports.ConversionsGetDatapointsCountRequest = void 0;
...
var ConversionsGetDatapointsCountRequest = /** @class */ (function (_super) {
    ...
    ], ConversionsGetDatapointsCountRequest.prototype, "conversionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdAfter",
        }),
        __metadata("design:type", String)
    ], ConversionsGetDatapointsCountRequest.prototype, "createdAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdBefore",
        }),
        __metadata("design:type", String)
    ], ConversionsGetDatapointsCountRequest.prototype, "createdBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], ConversionsGetDatapointsCountRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tags" }),
        __metadata("design:type", String)
    ], ConversionsGetDatapointsCountRequest.prototype, "tags", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=textSearch",
        }),
        __metadata("design:type", String)
    ], ConversionsGetDatapointsCountRequest.prototype, "textSearch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], ConversionsGetDatapointsCountRequest.prototype, "type", void 0);
    return ConversionsGetDatapointsCountRequest;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetDatapointsCountRequest = ConversionsGetDatapointsCountRequest;
var ConversionsGetDatapointsCountResponse = /** @class */ (function (_super) {
    ...
    ], ConversionsGetDatapointsCountResponse.prototype, "rawResponse", void 0);
    return ConversionsGetDatapointsCountResponse;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetDatapointsCountResponse = ConversionsGetDatapointsCountResponse;
