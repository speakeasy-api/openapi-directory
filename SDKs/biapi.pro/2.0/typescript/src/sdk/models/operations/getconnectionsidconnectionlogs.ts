...
export class GetConnectionsIdConnectionLogsRequest extends SpeakeasyBase {
  /**
   * UUID of a connector
   */
  @SpeakeasyMetadata({
 ...
 * connectionlogs
 */
export class GetConnectionsIdConnectionLogs200ApplicationJSON extends SpeakeasyBase {
...
export class GetConnectionsIdConnectionLogsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
