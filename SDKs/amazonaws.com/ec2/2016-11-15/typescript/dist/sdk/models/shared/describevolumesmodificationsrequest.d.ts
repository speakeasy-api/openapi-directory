 ...
 */
export declare class DescribeVolumesModificationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVolumesModificationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
