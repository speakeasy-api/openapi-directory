...
from ..shared import gettemporarygluetablecredentialsresponse as shared_gettemporarygluetablecredentialsresponse
...
class GetTemporaryGlueTableCredentialsRequestBody:
    ...
    r"""A list of supported permission types for the table. Valid values are <code>COLUMN_PERMISSION</code> and <code>CELL_FILTER_PERMISSION</code>."""  
    table_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TableArn') }})
    r"""The ARN identifying a table in the Data Catalog for the temporary credentials request."""  
    audit_context: Optional[GetTemporaryGlueTableCredentialsRequestBodyAuditContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuditContext'), 'exclude': lambda f: f is None }})
    r"""A structure used to include auditing information on the privileged API."""  
...
class GetTemporaryGlueTableCredentialsRequest:
    ...
    request_body: GetTemporaryGlueTableCredentialsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class GetTemporaryGlueTableCredentialsResponse:
    ...
    get_temporary_glue_table_credentials_response: Optional[shared_gettemporarygluetablecredentialsresponse.GetTemporaryGlueTableCredentialsResponse] = dataclasses.field(default=None)
    r"""Success"""  
