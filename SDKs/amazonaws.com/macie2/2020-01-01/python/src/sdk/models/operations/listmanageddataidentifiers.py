...
class ListManagedDataIdentifiersRequest:
    headers: ListManagedDataIdentifiersHeaders = dataclasses.field()
    request: ListManagedDataIdentifiersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
