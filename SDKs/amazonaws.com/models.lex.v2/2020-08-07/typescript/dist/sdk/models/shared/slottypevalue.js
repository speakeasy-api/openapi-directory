...
var SlotTypeValue = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "sampleValue" }),
        (0, class_transformer_1.Type)(function () { return samplevalue_1.SampleValue; }),
        __metadata("design:type", samplevalue_1.SampleValue)
    ], SlotTypeValue.prototype, "sampleValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: samplevalue_1.SampleValue }),
