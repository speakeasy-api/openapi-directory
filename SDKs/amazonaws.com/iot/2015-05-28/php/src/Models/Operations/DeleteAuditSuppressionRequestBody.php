...
class DeleteAuditSuppressionRequestBody
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\DeleteAuditSuppressionRequestBodyResourceIdentifier $resourceIdentifier
     */
	#[\JMS\Serializer\Annotation\SerializedName('resourceIdentifier')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\DeleteAuditSuppressionRequestBodyResourceIdentifier')]
    public DeleteAuditSuppressionRequestBodyResourceIdentifier $resourceIdentifier;
    
	public function __construct()
	{
		$this->checkName = "";
		$this->resourceIdentifier = new \OpenAPI\OpenAPI\Models\Operations\DeleteAuditSuppressionRequestBodyResourceIdentifier();
	}
}
