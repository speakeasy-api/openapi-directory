...
export class ProdTtSasportalNodesNodesDevicesCreateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ProdTtSasportalNodesNodesDevicesCreateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ProdTtSasportalNodesNodesDevicesCreateSecurity extends SpeakeasyBase {
  ...
  option1?: ProdTtSasportalNodesNodesDevicesCreateSecurityOption1;

  @SpeakeasyMetadata({ data: "security, option=true" })
  option2?: ProdTtSasportalNodesNodesDevicesCreateSecurityOption2;
}
