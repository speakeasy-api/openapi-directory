...
var KubernetesResourceInput = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "membershipCrManifest" }),
        __metadata("design:type", String)
    ], KubernetesResourceInput.prototype, "membershipCrManifest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "resourceOptions" }),
        (0, class_transformer_1.Type)(function () { return resourceoptions_1.ResourceOptions; }),
...
var KubernetesResource = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: resourcemanifest_1.ResourceManifest }),
        (0, class_transformer_1.Expose)({ name: "connectResources" }),
        (0, class_transformer_1.Type)(function () { return resourcemanifest_1.ResourceManifest; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: resourcemanifest_1.ResourceManifest }),
        (0, class_transformer_1.Expose)({ name: "membershipResources" }),
        (0, class_transformer_1.Type)(function () { return resourcemanifest_1.ResourceManifest; }),
        __metadata("design:type", Array)
