...
export class GoogleCloudRetailV2alphaProductInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2alphaFulfillmentInfo })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2alphaImage })
  @Expose({ name: "images" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2alphaPromotion })
  @Expose({ name: "promotions" })
  @Type(() => GoogleCloudRetailV2alphaPromotion)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "rating" })
  @Type(() => GoogleCloudRetailV2alphaRating)
