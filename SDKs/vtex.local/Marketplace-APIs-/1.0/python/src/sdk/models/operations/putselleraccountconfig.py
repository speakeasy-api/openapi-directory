...
from ..shared import putselleraccountconfigrequest as shared_putselleraccountconfigrequest
...
class PutselleraccountconfigRequest:
    ...
    putselleraccountconfig_request: shared_putselleraccountconfigrequest.PutselleraccountconfigRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class PutselleraccountconfigResponse:
