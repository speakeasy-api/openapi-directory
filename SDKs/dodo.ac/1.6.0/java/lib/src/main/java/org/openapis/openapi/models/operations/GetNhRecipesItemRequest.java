...
public class GetNhRecipesItemRequest {
    ...
    public GetNhRecipesItemRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhRecipesItemRequest withXApiKey(String xApiKey) {
    ...
    public GetNhRecipesItemRequest withItem(String item) {
        this.item = item;
        return this;
    }
    ...
    public GetNhRecipesItemRequest withThumbsize(Long thumbsize) {
        this.thumbsize = thumbsize;
        return this;
    }
    
    public GetNhRecipesItemRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey, @JsonProperty("item") String item) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
        this.item = item;
  }
