...
exports.CreateDomainAssociationResponse = exports.CreateDomainAssociationRequest = exports.CreateDomainAssociationRequestBody = void 0;
...
var CreateDomainAssociationRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SubDomainSetting }),
        (0, class_transformer_1.Expose)({ name: "subDomainSettings" }),
        (0, class_transformer_1.Type)(function () { return shared.SubDomainSetting; }),
        __metadata("design:type", Array)
    ], CreateDomainAssociationRequestBody.prototype, "subDomainSettings", void 0);
    return CreateDomainAssociationRequestBody;
}(utils_1.SpeakeasyBase));
exports.CreateDomainAssociationRequestBody = CreateDomainAssociationRequestBody;
var CreateDomainAssociationRequest = /** @class */ (function (_super) {
    ...
    ], CreateDomainAssociationRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=appId",
        }),
        __metadata("design:type", String)
    ], CreateDomainAssociationRequest.prototype, "appId", void 0);
...
var CreateDomainAssociationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateDomainAssociationResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.CreateDomainAssociationResponse = CreateDomainAssociationResponse;
