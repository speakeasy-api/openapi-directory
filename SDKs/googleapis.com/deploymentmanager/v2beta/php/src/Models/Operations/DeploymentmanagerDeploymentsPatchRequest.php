...
class DeploymentmanagerDeploymentsPatchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DeploymentmanagerDeploymentsPatchCreatePolicyEnum $createPolicy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=createPolicy')]
    public ?DeploymentmanagerDeploymentsPatchCreatePolicyEnum $createPolicy = null;
    
    /**
     * Sets the policy to use for deleting resources.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DeploymentmanagerDeploymentsPatchDeletePolicyEnum $deletePolicy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=deletePolicy')]
    public ?DeploymentmanagerDeploymentsPatchDeletePolicyEnum $deletePolicy = null;
