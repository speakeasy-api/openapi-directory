...
class PostListPlatformVersionsQueryParams:
    action: PostListPlatformVersionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostListPlatformVersionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostListPlatformVersionsRequest:
    headers: PostListPlatformVersionsHeaders = dataclasses.field()
    query_params: PostListPlatformVersionsQueryParams = dataclasses.field()
