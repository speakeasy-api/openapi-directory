...
from ..shared import getcustomersupportcustomerresponse as shared_getcustomersupportcustomerresponse
...
class CustomersOneSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CustomersOneRequest:
...
class CustomersOneResponse:
    ...
    r"""Bad Request"""  
    get_customer_support_customer_response: Optional[shared_getcustomersupportcustomerresponse.GetCustomerSupportCustomerResponse] = dataclasses.field(default=None)
