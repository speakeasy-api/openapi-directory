...
public class UpdateRouteResult {
    ...
    public UpdateRouteResult withApiGatewayManaged(java.util.Map<String, Object> apiGatewayManaged) {
    ...
    public UpdateRouteResult withApiKeyRequired(java.util.Map<String, Object> apiKeyRequired) {
    ...
    public UpdateRouteResult withAuthorizationScopes(java.util.Map<String, Object> authorizationScopes) {
    ...
    public UpdateRouteResult withAuthorizationType(java.util.Map<String, Object> authorizationType) {
    ...
    public UpdateRouteResult withAuthorizerId(java.util.Map<String, Object> authorizerId) {
    ...
    public UpdateRouteResult withModelSelectionExpression(java.util.Map<String, Object> modelSelectionExpression) {
    ...
    public UpdateRouteResult withOperationName(java.util.Map<String, Object> operationName) {
    ...
    public UpdateRouteResult withRouteId(java.util.Map<String, Object> routeId) {
    ...
    public UpdateRouteResult withRouteKey(java.util.Map<String, Object> routeKey) {
    ...
    public UpdateRouteResult withRouteResponseSelectionExpression(java.util.Map<String, Object> routeResponseSelectionExpression) {
    ...
    public UpdateRouteResult withTarget(java.util.Map<String, Object> target) {
        this.target = target;
        return this;
    }
}