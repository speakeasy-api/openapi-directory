...
exports.GetGroupVideosResponse = exports.GetGroupVideosRequest = exports.GetGroupVideosSortEnum = exports.GetGroupVideosFilterEnum = exports.GetGroupVideosDirectionEnum = void 0;
...
var GetGroupVideosRequest = /** @class */ (function (_super) {
    ...
    ], GetGroupVideosRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetGroupVideosRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter_embeddable",
        }),
        __metadata("design:type", Boolean)
    ], GetGroupVideosRequest.prototype, "filterEmbeddable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=group_id",
        }),
        __metadata("design:type", Number)
    ], GetGroupVideosRequest.prototype, "groupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetGroupVideosRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetGroupVideosRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetGroupVideosRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetGroupVideosRequest.prototype, "sort", void 0);
...
var GetGroupVideosResponse = /** @class */ (function (_super) {
    ...
    ], GetGroupVideosResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
