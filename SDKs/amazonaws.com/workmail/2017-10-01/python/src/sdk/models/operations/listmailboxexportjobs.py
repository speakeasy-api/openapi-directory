...
class ListMailboxExportJobsRequest:
    ...
    list_mailbox_export_jobs_request: shared_listmailboxexportjobsrequest.ListMailboxExportJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
