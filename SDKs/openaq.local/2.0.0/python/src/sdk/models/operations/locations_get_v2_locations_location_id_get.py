...
class LocationsGetV2LocationsLocationIDGetOrderByLocationsOrderEnum(str, Enum):
    r"""An enumeration."""
    CITY = 'city'
    COUNTRY = 'country'
    LOCATION = 'location'
...
class LocationsGetV2LocationsLocationIDGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class LocationsGetV2LocationsLocationIDGetRequest:
    ...
    order_by: Optional[LocationsGetV2LocationsLocationIDGetOrderByLocationsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""Order by a field"""  
    ...
    r"""Type of Sensor"""  
    sort: Optional[LocationsGetV2LocationsLocationIDGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Sort Direction"""  
