...
class AdsenseAccountsReportsGenerateRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateDateRangeEnum $dateRange
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=dateRange')]
    public ?AdsenseAccountsReportsGenerateDateRangeEnum $dateRange = null;
    
    /**
     * Dimensions to base the report on.
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateDimensionsEnum> $dimensions
     */
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateMetricsEnum> $metrics
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateReportingTimeZoneEnum $reportingTimeZone
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=reportingTimeZone')]
    public ?AdsenseAccountsReportsGenerateReportingTimeZoneEnum $reportingTimeZone = null;
