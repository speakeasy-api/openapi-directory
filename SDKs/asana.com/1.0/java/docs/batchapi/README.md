...
import org.openapis.openapi.models.operations.CreateBatchRequestRequest;
import org.openapis.openapi.models.operations.CreateBatchRequestRequestBody;
import org.openapis.openapi.models.operations.CreateBatchRequestResponse;
import org.openapis.openapi.models.shared.BatchRequest;
import org.openapis.openapi.models.shared.BatchRequestAction;
import org.openapis.openapi.models.shared.BatchRequestActionMethodEnum;
import org.openapis.openapi.models.shared.BatchRequestActionOptions;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CreateBatchRequestRequest req = new CreateBatchRequestRequest(                new CreateBatchRequestRequestBody() {{
                                data = new BatchRequest() {{
                                    actions = new org.openapis.openapi.models.shared.BatchRequestAction[]{{
                                        add(new BatchRequestAction(BatchRequestActionMethodEnum.GET, "/tasks/123") {{
                                            data = new java.util.HashMap<String, Object>() {{
                                                put("beatae", "commodi");
                                                put("molestiae", "modi");
                                                put("qui", "impedit");
                                            }};
                                            method = BatchRequestActionMethodEnum.GET;
                                            options = new BatchRequestActionOptions() {{
                                                fields = new String[]{{
                                                    add("esse"),
                                                    add("ipsum"),
                                                    add("excepturi"),
                                                ...
                                                limit = 50L;
                                                offset = eyJ0eXAiOJiKV1iQLCJhbGciOiJIUzI1NiJ9L;
                                            }};
            ...
            CreateBatchRequestResponse res = sdk.batchAPI.createBatchRequest(req);

            if (res.createBatchRequest200ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
