...
func (s *Operations) CloudprivatecatalogproducerOperationsCancel(ctx context.Context, request operations.CloudprivatecatalogproducerOperationsCancelRequest) (*operations.CloudprivatecatalogproducerOperationsCancelResponse, error) {
...
func (s *Operations) CloudprivatecatalogproducerOperationsList(ctx context.Context, request operations.CloudprivatecatalogproducerOperationsListRequest) (*operations.CloudprivatecatalogproducerOperationsListResponse, error) {
	baseURL := s._serverURL
