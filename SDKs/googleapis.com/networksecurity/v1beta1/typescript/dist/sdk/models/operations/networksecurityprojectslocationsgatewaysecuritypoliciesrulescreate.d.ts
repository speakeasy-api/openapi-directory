...
export declare class NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesCreateResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
