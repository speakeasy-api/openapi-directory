...
class GetDatasetContentRequest:
    ...
    r"""The name of the dataset whose contents are retrieved."""  
    version_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'versionId', 'style': 'form', 'explode': True }})
    r"""The version of the dataset whose contents are retrieved. You can also use the strings \\"$LATEST\\" or \\"$LATEST_SUCCEEDED\\" to retrieve the contents of the latest or latest successfully completed dataset. If not specified, \\"$LATEST_SUCCEEDED\\" is the default."""  
