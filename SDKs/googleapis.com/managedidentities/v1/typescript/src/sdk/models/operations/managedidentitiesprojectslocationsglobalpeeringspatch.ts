...
export class ManagedidentitiesProjectsLocationsGlobalPeeringsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalPeeringsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalPeeringsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
