...
PRODUCT_SEARCH_WHO_BOUGHT_ALSO_BOUGHT_SERVERS = [
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion:
    ...
    zero: Optional[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('0'), 'exclude': lambda f: f is None }})
    r"""Delivery SLA ID."""  
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments:
    ...
    interest_rate: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interestRate') }})
    r"""Interest rate."""  
    seller_merchant_installments: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sellerMerchantInstallments') }})
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions:
    ...
    r"""Bin."""  
    installments: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('installments') }})
    r"""Installments."""  
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptions:
    ...
    r"""GiftCards."""  
    installment_options: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('installmentOptions') }})
    ...
    r"""Payments."""  
    payment_systems: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('paymentSystems') }})
    r"""Payment systems."""  
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOffer:
    ...
    delivery_sla_samples: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeliverySlaSamples') }})
    r"""Delivery SLA samples."""  
    delivery_sla_samples_per_region: ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeliverySlaSamplesPerRegion') }})
    r"""Delivery SLA samples per region."""  
    ...
    installments: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferInstallments] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Installments') }})
    ...
    payment_options: ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PaymentOptions') }})
    r"""Payment options."""  
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellers:
    ...
    commertial_offer: ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOffer = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('commertialOffer') }})
    r"""AKA Commertial Condition."""  
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSONItems:
    ...
    images: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsImages] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('images') }})
    ...
    item_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemId') }})
    r"""SKU ID."""  
    kit_items: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsKitItems] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kitItems') }})
    ...
    r"""SKU complete name."""  
    reference_id: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsReferenceID] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('referenceId') }})
    r"""Reference code ID."""  
    sellers: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellers] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sellers') }})
...
class ProductSearchWhoBoughtAlsoBought200ApplicationJSON:
    ...
    items: list[ProductSearchWhoBoughtAlsoBought200ApplicationJSONItems] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items') }})
...
class ProductSearchWhoBoughtAlsoBoughtResponse:
    ...
    product_search_who_bought_also_bought_200_application_json_objects: Optional[list[ProductSearchWhoBoughtAlsoBought200ApplicationJSON]] = dataclasses.field(default=None)
    r"""OK"""  
