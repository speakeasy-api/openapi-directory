...
public class UpdateAppResponse {
    ...
    public UpdateAppResponse withAPIError(org.openapis.openapi.models.shared.APIError apiError) {
    ...
    public UpdateAppResponse withResponse(org.openapis.openapi.models.shared.Response response) {
