 ...
 */
export enum AssociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationResourceDiscoveryStatusEnum {
  Active = "active",
  NotFound = "not-found",
}
 ...
 */
export enum AssociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationStateEnum {
 ...
 * Describes a tag.
 */
export class AssociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class AssociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociation extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipamArn?: string;
  ...
  @SpeakeasyMetadata({
    elemType:
      AssociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationTags,
  })
 ...
 * Success
 */
export class AssociateIpamResourceDiscoveryResult extends SpeakeasyBase {
  @SpeakeasyMetadata()
