...
from ..shared import modifier as shared_modifier


@dataclass_json
@dataclasses.dataclass
class GetModifierResponse:
    data: shared_modifier.Modifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
