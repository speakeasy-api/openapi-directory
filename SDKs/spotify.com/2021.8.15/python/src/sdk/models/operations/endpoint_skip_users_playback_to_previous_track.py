...
class EndpointSkipUsersPlaybackToPreviousTrackRequest:
    headers: EndpointSkipUsersPlaybackToPreviousTrackHeaders = dataclasses.field()
    query_params: EndpointSkipUsersPlaybackToPreviousTrackQueryParams = dataclasses.field()
    security: EndpointSkipUsersPlaybackToPreviousTrackSecurity = dataclasses.field()
