...
var Registrations = /** @class */ (function () {
    ...
    **/
    Registrations.prototype.registrationsChildrenList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsChildrenListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/children/", req.pathParams);
    ...
    **/
    Registrations.prototype.registrationsCitationRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsCitationReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/citations/{citation_id}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsCitationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsCitationsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/citations/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsCommentsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsCommentsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/comments/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsContributorsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsContributorsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/contributors/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsContributorsRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsContributorsReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/contributors/{user_id}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsFilesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsFilesListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/files/{provider}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * If the request is unsuccessful, an `errors` key containing information about the failure will be returned. Refer to the [list of error codes](#tag/Errors-and-Error-Codes) to understand why this request may have failed.
    **/
    Registrations.prototype.registrationsFilesRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsFilesReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/files/{provider}/{path}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * If the request is unsuccessful, an `errors` key containing information about the failure will be returned. Refer to the [list of error codes](#tag/Errors-and-Error-Codes) to understand why this request may have failed.
    **/
    Registrations.prototype.registrationsForksCreate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsForksCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/forks/", req.pathParams);
        var client = this._defaultClient;
     ...
     * The `links` key contains a dictionary of links that can be used for [pagination](#tag/Pagination).
    **/
    Registrations.prototype.registrationsForksList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Registrations.prototype.registrationsIdentifiersList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsIdentifiersListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/identifiers/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * The `links` key contains a dictionary of links that can be used for [pagination](#tag/Pagination).
    **/
    Registrations.prototype.registrationsInstitutionsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsInstitutionsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/institutions/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsLinkedNodesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsLinkedNodesListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/linked_nodes/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * Registrations may be filtered by their `id`, `title`, `category`, `description`, `public`, `tags`, `date_created`, `date_modified`, `root`, `parent`, and `contributors`.
    **/
    Registrations.prototype.registrationsList = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/registrations/";
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsLogsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsLogsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/logs/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * If the request is unsuccessful, an `errors` key containing information about the failure will be returned. Refer to the [list of error codes](#tag/Errors-and-Error-Codes) to understand why this request may have failed.
    **/
    Registrations.prototype.registrationsPartialUpdate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsPartialUpdateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    Registrations.prototype.registrationsProvidersList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsProvidersListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/files/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * If the request is unsuccessful, an `errors` key containing information about the failure will be returned. Refer to the [list of error codes](#tag/Errors-and-Error-Codes) to understand why this request may have failed.
    **/
    Registrations.prototype.registrationsRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Registrations.prototype.registrationsViewOnlyLinksList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsViewOnlyLinksListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/view_only_links/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * View only links on a registration, public or private, are readable and writeable only by users that are administrators on the registration.
    **/
    Registrations.prototype.registrationsViewOnlyLinksRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsViewOnlyLinksReadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/view_only_links/{link_id}/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Registrations.prototype.registrationsWikisList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegistrationsWikisListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/registrations/{registration_id}/wikis/", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
