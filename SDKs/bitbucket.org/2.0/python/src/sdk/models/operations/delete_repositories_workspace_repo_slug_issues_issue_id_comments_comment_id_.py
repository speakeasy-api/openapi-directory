...
class DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDPathParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDSecurity = dataclasses.field()
