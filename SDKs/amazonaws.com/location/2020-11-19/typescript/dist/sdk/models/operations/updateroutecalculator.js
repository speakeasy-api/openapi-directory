...
exports.UpdateRouteCalculatorResponse = exports.UpdateRouteCalculatorRequest = exports.UpdateRouteCalculatorRequestBody = exports.UpdateRouteCalculatorRequestBodyPricingPlanEnum = void 0;
 ...
 */
var UpdateRouteCalculatorRequestBodyPricingPlanEnum;
...
})(UpdateRouteCalculatorRequestBodyPricingPlanEnum = exports.UpdateRouteCalculatorRequestBodyPricingPlanEnum || (exports.UpdateRouteCalculatorRequestBodyPricingPlanEnum = {}));
...
exports.UpdateRouteCalculatorRequestBody = UpdateRouteCalculatorRequestBody;
var UpdateRouteCalculatorRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "calculatorName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", UpdateRouteCalculatorRequestBody)
    ], UpdateRouteCalculatorRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateRouteCalculatorRequest.prototype, "xAmzSignedHeaders", void 0);
...
var UpdateRouteCalculatorResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateRouteCalculatorResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
