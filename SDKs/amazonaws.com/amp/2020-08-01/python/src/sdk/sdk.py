...
__doc__ = """ SDK Documentation: https://docs.aws.amazon.com/aps/ - Amazon Web Services documentation"""
import requests
...
class SDK:
    r"""SDK Documentation: https://docs.aws.amazon.com/aps/ - Amazon Web Services documentation"""
    ...
    def create_workspace(self, request: operations.CreateWorkspaceRequest) -> operations.CreateWorkspaceResponse:
        ...
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateWorkspaceResponse])
    ...
    def delete_workspace(self, request: operations.DeleteWorkspaceRequest) -> operations.DeleteWorkspaceResponse:
        ...
        url = utils.generate_url(base_url, "/workspaces/{workspaceId}", request.path_params)
    ...
    def describe_workspace(self, request: operations.DescribeWorkspaceRequest) -> operations.DescribeWorkspaceResponse:
        ...
        res = operations.DescribeWorkspaceResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeWorkspaceResponse])
    ...
    def update_workspace_alias(self, request: operations.UpdateWorkspaceAliasRequest) -> operations.UpdateWorkspaceAliasResponse:
        ...
        url = utils.generate_url(base_url, "/workspaces/{workspaceId}/alias", request.path_params)
        ...
        res = operations.UpdateWorkspaceAliasResponse(status_code=r.status_code, content_type=content_type)
