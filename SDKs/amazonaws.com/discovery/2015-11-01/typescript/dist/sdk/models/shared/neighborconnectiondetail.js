...
exports.NeighborConnectionDetail = void 0;
...
var NeighborConnectionDetail = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connectionsCount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destinationServerId" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transportProtocol" }),
        __metadata("design:type", String)
