...
class WritableVirtualMachineWithConfigContextInput:
    ...
    status: Optional[WritableVirtualMachineWithConfigContextStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
