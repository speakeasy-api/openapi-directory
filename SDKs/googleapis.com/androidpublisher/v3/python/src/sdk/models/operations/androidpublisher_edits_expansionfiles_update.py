...
class AndroidpublisherEditsExpansionfilesUpdatePathParams:
    ...
    expansion_file_type: AndroidpublisherEditsExpansionfilesUpdateExpansionFileTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'expansionFileType', 'style': 'simple', 'explode': False }})
...
class AndroidpublisherEditsExpansionfilesUpdateRequest:
    path_params: AndroidpublisherEditsExpansionfilesUpdatePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsExpansionfilesUpdateQueryParams = dataclasses.field()
    security: AndroidpublisherEditsExpansionfilesUpdateSecurity = dataclasses.field()
