...
var Get = /** @class */ (function () {
    function Get(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Get.prototype.keyRetrieve = function (req, config) {
    ...
    **/
    Get.prototype.signRetrieve = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
