...
class BigqueryreservationProjectsLocationsCapacityCommitmentsCreateRequest:
    path_params: BigqueryreservationProjectsLocationsCapacityCommitmentsCreatePathParams = dataclasses.field()
    query_params: BigqueryreservationProjectsLocationsCapacityCommitmentsCreateQueryParams = dataclasses.field()
    security: BigqueryreservationProjectsLocationsCapacityCommitmentsCreateSecurity = dataclasses.field()
    request: Optional[shared_capacitycommitment.CapacityCommitmentInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
