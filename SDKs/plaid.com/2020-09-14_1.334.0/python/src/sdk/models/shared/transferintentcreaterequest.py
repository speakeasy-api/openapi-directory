...
from ..shared import transferintentcreatemode_enum as shared_transferintentcreatemode_enum
from ..shared import transferintentcreatenetwork_enum as shared_transferintentcreatenetwork_enum
...
class TransferIntentCreateRequest:
    ...
    mode: shared_transferintentcreatemode_enum.TransferIntentCreateModeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mode') }})
    ...
    """  
    network: Optional[shared_transferintentcreatenetwork_enum.TransferIntentCreateNetworkEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('network'), 'exclude': lambda f: f is None }})
