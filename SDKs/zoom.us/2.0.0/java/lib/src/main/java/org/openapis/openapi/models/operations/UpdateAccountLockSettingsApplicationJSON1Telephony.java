...
public class UpdateAccountLockSettingsApplicationJSON1Telephony {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("telephony_regions")
    public Boolean telephonyRegions;
    public UpdateAccountLockSettingsApplicationJSON1Telephony withTelephonyRegions(Boolean telephonyRegions) {
    ...
    public UpdateAccountLockSettingsApplicationJSON1Telephony withThirdPartyAudio(Boolean thirdPartyAudio) {
