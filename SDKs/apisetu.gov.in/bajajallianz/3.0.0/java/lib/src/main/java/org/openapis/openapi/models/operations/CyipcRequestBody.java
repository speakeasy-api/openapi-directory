...
public class CyipcRequestBody {
    ...
    public CyipcRequestBody withConsentArtifact(org.openapis.openapi.models.shared.ConsentArtifactSchema consentArtifact) {
    ...
    public CyipcRequestBody(@JsonProperty("format") CyipcRequestBodyFormatEnum format, @JsonProperty("txnId") String txnId) {
        this.format = format;
        this.txnId = txnId;
  }
}
