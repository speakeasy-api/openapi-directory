...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum {
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
  ...
  targetingType: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum;
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
