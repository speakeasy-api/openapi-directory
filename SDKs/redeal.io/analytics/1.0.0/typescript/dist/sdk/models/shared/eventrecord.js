...
var EventRecord = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=browsertype" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=click" }),
        __metadata("design:type", String)
    ], EventRecord.prototype, "click", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=clicks" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=costcurrency" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=deal name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=denyreason" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=emailaddrsha256" }),
        __metadata("design:type", String)
    ], EventRecord.prototype, "emailaddrsha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=flow" }),
        __metadata("design:type", String)
    ], EventRecord.prototype, "flow", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=flowstep" }),
        __metadata("design:type", String)
    ], EventRecord.prototype, "flowstep", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=flowtype" }),
        __metadata("design:type", String)
    ], EventRecord.prototype, "flowtype", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=impression" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=optin" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=revenue" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=site name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=userlanguage" }),
        __metadata("design:type", String)
