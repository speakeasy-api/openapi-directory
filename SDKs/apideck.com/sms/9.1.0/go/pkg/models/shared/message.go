...
func (e *MessageMessageTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "sms":
		fallthrough
	case "mms":
		*e = MessageMessageTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MessageMessageTypeEnum: %s", s)
	}
}
...
func (e *MessageDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "outbound-reply":
		fallthrough
	case "unknown":
		*e = MessageDirectionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MessageDirectionEnum: %s", s)
	}
}
...
func (e *MessageStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "received":
		fallthrough
	case "read":
		*e = MessageStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for MessageStatusEnum: %s", s)
	}
}
