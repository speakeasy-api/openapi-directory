...
func (e *PostServersIDActionsAttachToNetworkActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsAttachToNetworkActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsAttachToNetworkActionResponseActionStatusEnum: %s", s)
	}
}
