...
exports.GetUsersIdsTimelineResponse = exports.GetUsersIdsTimelineRequest = void 0;
...
var GetUsersIdsTimelineRequest = /** @class */ (function (_super) {
    ...
    ], GetUsersIdsTimelineRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetUsersIdsTimelineRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fromdate",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdsTimelineRequest.prototype, "fromdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ids" }),
        __metadata("design:type", String)
    ], GetUsersIdsTimelineRequest.prototype, "ids", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetUsersIdsTimelineRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdsTimelineRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetUsersIdsTimelineRequest.prototype, "site", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=todate",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdsTimelineRequest.prototype, "todate", void 0);
...
var GetUsersIdsTimelineResponse = /** @class */ (function (_super) {
    ...
    ], GetUsersIdsTimelineResponse.prototype, "rawResponse", void 0);
