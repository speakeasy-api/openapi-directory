...
class ContentOrdersReturnlineitemRequest:
    ...
    orders_return_line_item_request: Optional[shared_ordersreturnlineitemrequest.OrdersReturnLineItemRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
