...
type ListPosts200ApplicationJSONLatestPosts struct {
	ActionsSummary              []ListPosts200ApplicationJSONLatestPostsActionsSummary `json:"actions_summary,omitempty"`
...
type ListPosts200ApplicationJSON struct {
	LatestPosts []ListPosts200ApplicationJSONLatestPosts `json:"latest_posts,omitempty"`
}
