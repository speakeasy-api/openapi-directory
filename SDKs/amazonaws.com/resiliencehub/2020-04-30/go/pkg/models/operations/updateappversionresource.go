...
type UpdateAppVersionResourceHeaders struct {
...
type UpdateAppVersionResourceRequestBody struct {
...
type UpdateAppVersionResourceRequest struct {
	Headers UpdateAppVersionResourceHeaders
	Request UpdateAppVersionResourceRequestBody `request:"mediaType=application/json"`
}
