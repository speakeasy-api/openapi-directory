...
export class ListDeployedDevicesDeploymentListDeployedDevicesDeploymentResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.PreviewDeployedDevicesFleetDeployment })
  @Expose({ name: "deployments" })
  @Type(() => shared.PreviewDeployedDevicesFleetDeployment)
  deployments?: shared.PreviewDeployedDevicesFleetDeployment[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(
    () => ListDeployedDevicesDeploymentListDeployedDevicesDeploymentResponseMeta
  )
