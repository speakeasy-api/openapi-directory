...
func main() {
    ...
    res, err := s.Avatars.AvatarsGetBrowser(ctx, operations.AvatarsGetBrowserRequest{
        Code: "maiores",
        Height: sdk.Int(473608),
        Quality: sdk.Int(799159),
        Width: sdk.Int(800911),
...
func main() {
    ...
    res, err := s.Avatars.AvatarsGetCreditCard(ctx, operations.AvatarsGetCreditCardRequest{
        Code: "esse",
        Height: sdk.Int(520478),
        Quality: sdk.Int(780529),
        Width: sdk.Int(678880),
...
func main() {
    ...
    res, err := s.Avatars.AvatarsGetFlag(ctx, operations.AvatarsGetFlagRequest{
        Code: "nam",
        Height: sdk.Int(639921),
        Quality: sdk.Int(582020),
        Width: sdk.Int(143353),
...
func main() {
    ...
    res, err := s.Avatars.AvatarsGetImage(ctx, operations.AvatarsGetImageRequest{
        Height: sdk.Int(537373),
        URL: "hic",
        Width: sdk.Int(758616),
...
func main() {
    ...
    res, err := s.Avatars.AvatarsGetInitials(ctx, operations.AvatarsGetInitialsRequest{
        Background: sdk.String("totam"),
        Color: sdk.String("beatae"),
        Height: sdk.Int(414662),
        Name: sdk.String("Pauline Dibbert"),
        Width: sdk.Int(456150),
