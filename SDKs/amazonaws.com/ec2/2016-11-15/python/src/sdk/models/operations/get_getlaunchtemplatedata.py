...
class GetGetLaunchTemplateDataQueryParams:
    action: GetGetLaunchTemplateDataActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    instance_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'InstanceId', 'style': 'form', 'explode': True }})
    version: GetGetLaunchTemplateDataVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetLaunchTemplateDataRequest:
    headers: GetGetLaunchTemplateDataHeaders = dataclasses.field()
    query_params: GetGetLaunchTemplateDataQueryParams = dataclasses.field()
