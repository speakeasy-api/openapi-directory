...
try {
    ...
    $request->page = 104736;
    $request->perPage = 278329;
    $request->q = 'dicta';
    $request->sort = SearchIssuesAndPullRequestsSortEnum::REACTIONS;
