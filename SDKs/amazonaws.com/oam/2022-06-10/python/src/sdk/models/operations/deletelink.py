...
class DeleteLinkRequestBody:
    ...
    r"""The ARN of the link to delete."""  
    

@dataclasses.dataclass
class DeleteLinkRequest:
    
    request_body: DeleteLinkRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteLinkResponse:
    ...
    delete_link_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
