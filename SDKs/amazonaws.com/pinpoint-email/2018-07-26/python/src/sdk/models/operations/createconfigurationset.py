...
class CreateConfigurationSetRequestBodyReputationOptions:
    r"""Enable or disable collection of reputation metrics for emails that you send using this configuration set in the current AWS Region."""
...
class CreateConfigurationSetRequestBody:
    ...
    r"""An array of objects that define the tags (keys and values) that you want to associate with the configuration set."""  
