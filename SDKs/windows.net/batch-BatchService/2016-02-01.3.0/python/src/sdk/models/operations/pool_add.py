...
from ..shared import pooladdparameter as shared_pooladdparameter
...
class PoolAddRequest:
    ...
    pool_add_parameter: shared_pooladdparameter.PoolAddParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The pool to be added."""  
