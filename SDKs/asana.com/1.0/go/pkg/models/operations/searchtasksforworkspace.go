...
type SearchTasksForWorkspaceQueryParams struct {
	...
	ResourceSubtype   *shared.FieldsEnum1 `queryParam:"style=form,explode=true,name=resource_subtype"`
	...
	SortBy            *shared.FieldsEnum2 `queryParam:"style=form,explode=true,name=sort_by"`
