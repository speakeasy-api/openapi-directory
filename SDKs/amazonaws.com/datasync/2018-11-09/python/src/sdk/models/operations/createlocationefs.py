...
class CreateLocationEfsRequest:
    headers: CreateLocationEfsHeaders = dataclasses.field()
    request: shared_createlocationefsrequest.CreateLocationEfsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
