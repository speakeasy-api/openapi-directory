...
exports.VoiceConversion = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var VoiceConversion = /** @class */ (function () {
    function VoiceConversion(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VoiceConversion.prototype.voiceConversion = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VoiceConversionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/voice";
...
exports.VoiceConversion = VoiceConversion;
