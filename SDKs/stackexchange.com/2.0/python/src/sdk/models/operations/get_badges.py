...
class GetBadgesOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetBadgesSortEnum(str, Enum):
    RANK = "rank"
    NAME = "name"
    TYPE = "type"
...
class GetBadgesQueryParams:
    ...
    order: Optional[GetBadgesOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetBadgesSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetBadgesRequest:
    query_params: GetBadgesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetBadgesResponse:
