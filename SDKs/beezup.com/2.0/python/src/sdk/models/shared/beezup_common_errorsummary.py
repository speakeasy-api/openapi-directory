...
class BeezUPCommonErrorSummary:
    ...
    exception_detail: Optional[shared_beezup_common_exceptiondetail.BeezUPCommonExceptionDetail] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('exceptionDetail'), 'exclude': lambda f: f is None }})  
