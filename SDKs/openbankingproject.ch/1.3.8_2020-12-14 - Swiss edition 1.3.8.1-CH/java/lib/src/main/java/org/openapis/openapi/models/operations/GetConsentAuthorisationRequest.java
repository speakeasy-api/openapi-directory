...
public class GetConsentAuthorisationRequest {
    ...
    public GetConsentAuthorisationRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public GetConsentAuthorisationRequest withPSUAccept(String psuAccept) {
    ...
    public GetConsentAuthorisationRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public GetConsentAuthorisationRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetConsentAuthorisationRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetConsentAuthorisationRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public GetConsentAuthorisationRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public GetConsentAuthorisationRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public GetConsentAuthorisationRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public GetConsentAuthorisationRequest withPSUIPPort(String psuIPPort) {
    ...
    public GetConsentAuthorisationRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public GetConsentAuthorisationRequest withSignature(String signature) {
    ...
    public GetConsentAuthorisationRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetConsentAuthorisationRequest withXRequestID(String xRequestID) {
    ...
    public GetConsentAuthorisationRequest withConsentId(String consentId) {
        this.consentId = consentId;
        return this;
    }
    
    public GetConsentAuthorisationRequest(@JsonProperty("X-Request-ID") String xRequestID, @JsonProperty("consentId") String consentId) {
        this.xRequestID = xRequestID;
        this.consentId = consentId;
  }
}
