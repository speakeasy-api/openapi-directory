...
from ..shared import describeusersresult as shared_describeusersresult
...
class DescribeUsersResponse:
    ...
    describe_users_result: Optional[shared_describeusersresult.DescribeUsersResult] = dataclasses.field(default=None)
