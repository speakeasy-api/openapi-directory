...
class CancelImageCreationResponse:
    ...
    image_build_version_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('imageBuildVersionArn'), 'exclude': lambda f: f is None }})  
