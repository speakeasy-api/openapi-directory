...
class DeleteRefundRequest:
    headers: DeleteRefundHeaders = dataclasses.field()
    path_params: DeleteRefundPathParams = dataclasses.field()
    

@dataclasses.dataclass
class DeleteRefundResponse:
