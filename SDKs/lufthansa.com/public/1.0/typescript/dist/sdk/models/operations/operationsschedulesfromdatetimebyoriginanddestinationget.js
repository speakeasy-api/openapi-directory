...
exports.OperationsSchedulesFromDateTimeByOriginAndDestinationGetResponse = exports.OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest = exports.OperationsSchedulesFromDateTimeByOriginAndDestinationGetSecurity = void 0;
...
var OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest.prototype, "accept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=destination",
        }),
        __metadata("design:type", String)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest.prototype, "destination", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=directFlights",
        }),
        __metadata("design:type", Boolean)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest.prototype, "directFlights", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fromDateTime",
        }),
        __metadata("design:type", String)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest.prototype, "fromDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", String)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=origin",
        }),
        __metadata("design:type", String)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetRequest.prototype, "origin", void 0);
...
var OperationsSchedulesFromDateTimeByOriginAndDestinationGetResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], OperationsSchedulesFromDateTimeByOriginAndDestinationGetResponse.prototype, "rawResponse", void 0);
