...
class ClassroomCoursesCourseWorkMaterialsPatchRequest:
    path_params: ClassroomCoursesCourseWorkMaterialsPatchPathParams = dataclasses.field()
    query_params: ClassroomCoursesCourseWorkMaterialsPatchQueryParams = dataclasses.field()
    security: ClassroomCoursesCourseWorkMaterialsPatchSecurity = dataclasses.field()
