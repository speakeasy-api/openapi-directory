...
class PutAlternateContactRequestBodyAlternateContactTypeEnum(str, Enum):
    r"""Specifies which alternate contact you want to create or update."""
    BILLING = 'BILLING'
...
class PutAlternateContactRequestBody:
    ...
    alternate_contact_type: PutAlternateContactRequestBodyAlternateContactTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AlternateContactType') }})
    r"""Specifies which alternate contact you want to create or update."""  
    email_address: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EmailAddress') }})
    r"""Specifies an email address for the alternate contact."""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Name') }})
    r"""Specifies a name for the alternate contact."""  
    phone_number: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PhoneNumber') }})
    r"""Specifies a phone number for the alternate contact."""  
    title: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Title') }})
    r"""Specifies a title for the alternate contact."""  
...
class PutAlternateContactRequest:
    ...
    request_body: PutAlternateContactRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
