...
class GetUsersUserIDTracksRequest:
    path_params: GetUsersUserIDTracksPathParams = dataclasses.field()
    query_params: GetUsersUserIDTracksQueryParams = dataclasses.field()
    security: GetUsersUserIDTracksSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetUsersUserIDTracksResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error: Optional[shared_error.Error] = dataclasses.field(default=None)
    get_users_user_id_tracks_200_application_json_one_of: Optional[Any] = dataclasses.field(default=None)
