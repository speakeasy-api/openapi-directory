...
type NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesListSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesListRequest struct {
	// V1 error format.
...
type NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesListResponse struct {
	ContentType string
	// Successful response
