...
export class GetPublicationDiseaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPublicationDiseaseAssociationsQueryParams extends SpeakeasyBase {
