...
class CountPendingDecisionTasksRequest:
    headers: CountPendingDecisionTasksHeaders = dataclasses.field()
    request: shared_countpendingdecisiontasksinput.CountPendingDecisionTasksInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
