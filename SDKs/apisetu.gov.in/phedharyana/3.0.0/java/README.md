...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EtcerResponse res = sdk.apIs.etcer(req, new EtcerSecurity("molestiae", "minus") {{
...
* [etcer](docs/apis/README.md#etcer) - Enlistment Certificate
* [govid](docs/apis/README.md#govid) - ID Card
* [sicer](docs/apis/README.md#sicer) - Sanction Letter/ Certificate
