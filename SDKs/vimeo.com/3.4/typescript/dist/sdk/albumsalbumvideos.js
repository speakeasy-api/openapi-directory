...
var AlbumsAlbumVideos = /** @class */ (function () {
    ...
    **/
    AlbumsAlbumVideos.prototype.addVideoToAlbum = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoToAlbumRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/albums/{album_id}/videos/{video_id}", req.pathParams);
    ...
    **/
    AlbumsAlbumVideos.prototype.addVideoToAlbumAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoToAlbumAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/me/albums/{album_id}/videos/{video_id}", req.pathParams);
        var client = this._securityClient;
        var r = client.request(__assign({ url: url, method: "put" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    AlbumsAlbumVideos.prototype.getAlbumVideos = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/albums/{album_id}/videos", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    AlbumsAlbumVideos.prototype.getAlbumVideosAlt1 = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/me/albums/{album_id}/videos", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    AlbumsAlbumVideos.prototype.removeVideoFromAlbum = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AlbumsAlbumVideos.prototype.removeVideoFromAlbumAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AlbumsAlbumVideos.prototype.replaceVideosInAlbum = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This method replaces all the existing videos in an album with one or more videos.
    **/
    AlbumsAlbumVideos.prototype.replaceVideosInAlbumAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AlbumsAlbumVideos.prototype.setVideoAsAlbumThumbnail = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SetVideoAsAlbumThumbnailRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/albums/{album_id}/videos/{video_id}/set_album_thumbnail", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    AlbumsAlbumVideos.prototype.setVideoAsAlbumThumbnailAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SetVideoAsAlbumThumbnailAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/me/albums/{album_id}/videos/{video_id}/set_album_thumbnail", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
