...
class ListPullRequestsRequest:
    headers: ListPullRequestsHeaders = dataclasses.field()
    query_params: ListPullRequestsQueryParams = dataclasses.field()
    request: shared_listpullrequestsinput.ListPullRequestsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
