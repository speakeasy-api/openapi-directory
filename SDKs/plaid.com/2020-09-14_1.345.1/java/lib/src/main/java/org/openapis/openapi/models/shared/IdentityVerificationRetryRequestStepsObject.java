...
public class IdentityVerificationRetryRequestStepsObject {
    ...
    public IdentityVerificationRetryRequestStepsObject(@JsonProperty("documentary_verification") Boolean documentaryVerification, @JsonProperty("kyc_check") Boolean kycCheck, @JsonProperty("selfie_check") Boolean selfieCheck, @JsonProperty("verify_sms") Boolean verifySms) {
        this.documentaryVerification = documentaryVerification;
        this.kycCheck = kycCheck;
        this.selfieCheck = selfieCheck;
        this.verifySms = verifySms;
