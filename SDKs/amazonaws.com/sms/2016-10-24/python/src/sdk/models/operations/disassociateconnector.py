...
class DisassociateConnectorRequest:
    ...
    disassociate_connector_request: shared_disassociateconnectorrequest.DisassociateConnectorRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
