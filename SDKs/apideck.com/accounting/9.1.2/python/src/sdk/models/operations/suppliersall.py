...
from ..shared import getsuppliersresponse as shared_getsuppliersresponse
...
from ..shared import suppliersfilter as shared_suppliersfilter
...
class SuppliersAllRequest:
    ...
    filter: Optional[shared_suppliersfilter.SuppliersFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
class SuppliersAllResponse:
    ...
    r"""Bad Request"""  
    get_suppliers_response: Optional[shared_getsuppliersresponse.GetSuppliersResponse] = dataclasses.field(default=None)
    r"""Suppliers"""  
