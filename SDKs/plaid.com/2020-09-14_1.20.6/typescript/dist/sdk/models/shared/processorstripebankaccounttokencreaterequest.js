...
exports.ProcessorStripeBankAccountTokenCreateRequest = void 0;
...
var ProcessorStripeBankAccountTokenCreateRequest = /** @class */ (function (_super) {
    ...
    function ProcessorStripeBankAccountTokenCreateRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=access_token" }),
        __metadata("design:type", String)
    ], ProcessorStripeBankAccountTokenCreateRequest.prototype, "accessToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=account_id" }),
        __metadata("design:type", String)
    ], ProcessorStripeBankAccountTokenCreateRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=client_id" }),
        __metadata("design:type", String)
    ], ProcessorStripeBankAccountTokenCreateRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=secret" }),
        __metadata("design:type", String)
    ], ProcessorStripeBankAccountTokenCreateRequest.prototype, "secret", void 0);
