...
class VpnTunnels 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsResponse
     */
	public function computeVpnTunnelsTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/vpnTunnels/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeVpnTunnelsTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
