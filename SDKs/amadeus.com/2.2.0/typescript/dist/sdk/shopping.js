...
var Shopping = /** @class */ (function () {
    ...
    Shopping.prototype.getFlightOffers = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetFlightOffersResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.amadeus+json")) {
                        res.success = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetFlightOffersSuccess);
                    }
                    break;
    ...
    Shopping.prototype.searchFlightOffers = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "getFlightOffersQuery", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.SearchFlightOffersResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.amadeus+json")) {
                        res.success = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.SearchFlightOffersSuccess);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/vnd.amadeus+json")) {
