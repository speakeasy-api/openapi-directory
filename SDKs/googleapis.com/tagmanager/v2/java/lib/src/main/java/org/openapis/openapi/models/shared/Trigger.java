...
public class Trigger {
    ...
    public Trigger withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public Trigger withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public Trigger withTagManagerUrl(String tagManagerUrl) {
    ...
    public Trigger withWorkspaceId(String workspaceId) {
