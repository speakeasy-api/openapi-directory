...
public class ContainerProjectsZonesClustersUpdatePathParams {
    /**
     * Required. Deprecated. The name of the cluster to upgrade. This field has been deprecated and replaced by the name field.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=clusterId")
    public String clusterId;
    public ContainerProjectsZonesClustersUpdatePathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersUpdatePathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersUpdatePathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
