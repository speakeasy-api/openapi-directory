...
func (s *system) GetResourceLimits(ctx context.Context) (*operations.GetResourceLimitsResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/system/limits"
	...
	res := &operations.GetResourceLimitsResponse{
