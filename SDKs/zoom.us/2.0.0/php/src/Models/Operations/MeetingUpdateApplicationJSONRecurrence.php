...
class MeetingUpdateApplicationJSONRecurrence
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceMonthlyWeekEnum $monthlyWeek
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceMonthlyWeekEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingUpdateApplicationJSONRecurrenceMonthlyWeekEnum $monthlyWeek = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceMonthlyWeekDayEnum $monthlyWeekDay
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week_day')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceMonthlyWeekDayEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingUpdateApplicationJSONRecurrenceMonthlyWeekDayEnum $monthlyWeekDay = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceTypeEnum>')]
     ...
     *  <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceWeeklyDaysEnum $weeklyDays
     */
	#[\JMS\Serializer\Annotation\SerializedName('weekly_days')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceWeeklyDaysEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingUpdateApplicationJSONRecurrenceWeeklyDaysEnum $weeklyDays = null;
	...
	public function __construct()
	{
		...
		$this->type = \OpenAPI\OpenAPI\Models\Operations\MeetingUpdateApplicationJSONRecurrenceTypeEnum::ONE;
