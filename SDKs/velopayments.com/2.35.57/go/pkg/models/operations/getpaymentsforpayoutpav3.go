...
func (e GetPaymentsForPayoutPAV3StatusEnum) ToPointer() *GetPaymentsForPayoutPAV3StatusEnum {
	return &e
}
...
func (e *GetPaymentsForPayoutPAV3StatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "RETURNED":
		fallthrough
	case "WITHDRAWN":
		*e = GetPaymentsForPayoutPAV3StatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetPaymentsForPayoutPAV3StatusEnum: %v", v)
	}
}
