 ...
 */
export declare enum VideoPlayerSizeTargetingOptionDetailsVideoPlayerSizeEnum {
 ...
 */
export declare class VideoPlayerSizeTargetingOptionDetails extends SpeakeasyBase {
    /**
     * Output only. The video player size.
     */
