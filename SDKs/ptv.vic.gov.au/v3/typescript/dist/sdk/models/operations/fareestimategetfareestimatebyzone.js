...
exports.FareEstimateGetFareEstimateByZoneResponse = exports.FareEstimateGetFareEstimateByZoneRequest = exports.FareEstimateGetFareEstimateByZoneQueryParams = exports.FareEstimateGetFareEstimateByZonePathParams = void 0;
...
var FareEstimateGetFareEstimateByZonePathParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=maxZone" }),
        __metadata("design:type", Number)
    ], FareEstimateGetFareEstimateByZonePathParams.prototype, "maxZone", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=minZone" }),
        __metadata("design:type", Number)
...
exports.FareEstimateGetFareEstimateByZonePathParams = FareEstimateGetFareEstimateByZonePathParams;
var FareEstimateGetFareEstimateByZoneQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=is_journey_in_free_tram_zone" }),
        __metadata("design:type", Boolean)
    ], FareEstimateGetFareEstimateByZoneQueryParams.prototype, "isJourneyInFreeTramZone", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=journey_touch_off_utc" }),
        __metadata("design:type", Date)
    ], FareEstimateGetFareEstimateByZoneQueryParams.prototype, "journeyTouchOffUtc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=journey_touch_on_utc" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=travelled_route_types" }),
...
exports.FareEstimateGetFareEstimateByZoneQueryParams = FareEstimateGetFareEstimateByZoneQueryParams;
