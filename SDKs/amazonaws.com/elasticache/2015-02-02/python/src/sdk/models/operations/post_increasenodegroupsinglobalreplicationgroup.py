...
class PostIncreaseNodeGroupsInGlobalReplicationGroupQueryParams:
    action: PostIncreaseNodeGroupsInGlobalReplicationGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostIncreaseNodeGroupsInGlobalReplicationGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostIncreaseNodeGroupsInGlobalReplicationGroupRequest:
    headers: PostIncreaseNodeGroupsInGlobalReplicationGroupHeaders = dataclasses.field()
    query_params: PostIncreaseNodeGroupsInGlobalReplicationGroupQueryParams = dataclasses.field()
