...
from ..shared import updateinvoiceitemsresponse as shared_updateinvoiceitemsresponse
...
class InvoiceItemsUpdateRequest:
    ...
    invoice_item_input: shared_invoiceitem.InvoiceItemInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class InvoiceItemsUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_invoice_items_response: Optional[shared_updateinvoiceitemsresponse.UpdateInvoiceItemsResponse] = dataclasses.field(default=None)
    r"""InvoiceItems"""  
