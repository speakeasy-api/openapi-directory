...
try {
    ...
    if ($response->chatV2ServiceChannelChannelWebhook !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2Credential !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2ServiceChannelInvite !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2ServiceChannelMember !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2ServiceChannelMessage !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2ServiceRole !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2Service !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2ServiceUser !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\UserChannelEnumWebhookEnabledTypeEnum;
...
try {
    ...
    $request->xTwilioWebhookEnabled = UserChannelEnumWebhookEnabledTypeEnum::FALSE;
...
try {
    ...
    if ($response->chatV2ServiceBinding !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2ServiceUserUserBinding !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    if ($response->chatV2ServiceUserUserChannel !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->channelSid = 'repudiandae';
    $request->identity = [
        'veritatis',
        'itaque',
        'incidunt',
...
try {
    ...
    $request->serviceSid = 'necessitatibus';
    $request->userSid = 'sint';
...
try {
    ...
    $request->requestBody->attributes = 'officia';
    $request->requestBody->createdBy = 'dolor';
    $request->requestBody->dateCreated = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2020-02-22T17:45:21.686Z');
    $request->requestBody->dateUpdated = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-02-08T14:21:47.573Z');
    $request->requestBody->friendlyName = 'in';
    $request->requestBody->uniqueName = 'illum';
