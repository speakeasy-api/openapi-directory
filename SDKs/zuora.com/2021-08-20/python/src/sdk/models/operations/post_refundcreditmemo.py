...
from ..shared import getrefundcreditmemotype as shared_getrefundcreditmemotype
from ..shared import postnonrefrefundtype as shared_postnonrefrefundtype
...
class POSTRefundCreditMemoRequest:
    ...
    post_non_ref_refund_type: shared_postnonrefrefundtype.PostNonRefRefundType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class POSTRefundCreditMemoResponse:
    ...
    get_refund_credit_memo_type: Optional[shared_getrefundcreditmemotype.GETRefundCreditMemoType] = dataclasses.field(default=None)  
