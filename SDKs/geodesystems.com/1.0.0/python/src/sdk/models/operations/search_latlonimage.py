...
class SearchLatlonimageQueryParams:
...
@dataclasses.dataclass
class SearchLatlonimageRequest:
    query_params: SearchLatlonimageQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchLatlonimageResponse:
