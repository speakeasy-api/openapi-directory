...
class GETDescribeSuggestersRequest:
    ...
    r"""The name of the domain you want to describe."""  
    ...
    r"""Whether to display the deployed configuration (<code>true</code>) or include any pending changes (<code>false</code>). Defaults to <code>false</code>."""  
    ...
    r"""The suggesters you want to describe."""  
