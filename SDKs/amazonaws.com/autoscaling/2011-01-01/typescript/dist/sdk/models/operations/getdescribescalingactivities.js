...
exports.GetDescribeScalingActivitiesResponse = exports.GetDescribeScalingActivitiesRequest = exports.GetDescribeScalingActivitiesHeaders = exports.GetDescribeScalingActivitiesQueryParams = exports.GetDescribeScalingActivitiesVersionEnum = exports.GetDescribeScalingActivitiesActionEnum = void 0;
...
var GetDescribeScalingActivitiesQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ActivityIds" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=IncludeDeletedGroups" }),
...
exports.GetDescribeScalingActivitiesQueryParams = GetDescribeScalingActivitiesQueryParams;
...
exports.GetDescribeScalingActivitiesHeaders = GetDescribeScalingActivitiesHeaders;
