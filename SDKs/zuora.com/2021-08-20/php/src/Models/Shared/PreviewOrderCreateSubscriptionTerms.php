...
class PreviewOrderCreateSubscriptionTerms
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTerm $initialTerm
     */
	#[\JMS\Serializer\Annotation\SerializedName('initialTerm')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTerm')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsRenewalSettingEnum $renewalSetting
     */
	#[\JMS\Serializer\Annotation\SerializedName('renewalSetting')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsRenewalSettingEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PreviewOrderCreateSubscriptionTermsRenewalSettingEnum $renewalSetting = null;
	...
	{
		$this->autoRenew = null;
		$this->initialTerm = new \OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTermsInitialTerm();
