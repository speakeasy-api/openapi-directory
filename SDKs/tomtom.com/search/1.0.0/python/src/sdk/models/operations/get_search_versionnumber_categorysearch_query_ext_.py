...
class GetSearchVersionNumberCategorySearchQueryExtRequest:
    path_params: GetSearchVersionNumberCategorySearchQueryExtPathParams = dataclasses.field()
    query_params: GetSearchVersionNumberCategorySearchQueryExtQueryParams = dataclasses.field()
