...
class CreateVpcRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateVpcRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVpcRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVpcRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateVpcRequest:
    ...
    instance_tenancy: Optional[CreateVpcRequestInstanceTenancyEnum] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[CreateVpcRequestTagSpecifications]] = dataclasses.field(default=None)  
