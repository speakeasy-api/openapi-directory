...
func main() {
    ...
    res, err := s.Nodes.NodesAddonRead(ctx, operations.NodesAddonReadRequest{
        NodeID: "reprehenderit",
        Provider: "ut",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesAddonsFoldersList(ctx, operations.NodesAddonsFoldersListRequest{
        NodeID: "maiores",
        Provider: "dicta",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesAddonsList(ctx, operations.NodesAddonsListRequest{
        NodeID: "corporis",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesChildrenCreate(ctx, operations.NodesChildrenCreateRequest{
        RequestBody: operations.NodesChildrenCreateNodeInput{
            Attributes: operations.NodesChildrenCreateNodeAttributesInput{
                Category: operations.NodesChildrenCreateNodeAttributesCategoryEnumData,
                Description: sdk.String("iusto"),
                NodeLicense: sdk.String("dicta"),
                ...
                TemplateFrom: sdk.String("repudiandae"),
                Title: "Mr.",
            },
            Type: "ipsum",
        },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesChildrenList(ctx, operations.NodesChildrenListRequest{
        NodeID: "molestias",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesCitationList(ctx, operations.NodesCitationListRequest{
        NodeID: "excepturi",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesCitationRead(ctx, operations.NodesCitationReadRequest{
        NodeID: "pariatur",
        StyleID: "modi",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesCommentCreate(ctx, operations.NodesCommentCreateRequest{
        RequestBody: operations.NodesCommentCreateCommentInput{
            Attributes: &operations.NodesCommentCreateCommentAttributesInput{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesCommentsList(ctx, operations.NodesCommentsListRequest{
        NodeID: "voluptates",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesContributorsCreate(ctx, operations.NodesContributorsCreateRequest{
        RequestBody: operations.NodesContributorsCreateContributorInput{
            Attributes: &operations.NodesContributorsCreateContributorAttributesInput{
                Bibliographic: sdk.Bool(false),
                Index: sdk.Int64(93940),
                Permission: operations.NodesContributorsCreateContributorAttributesPermissionEnumAdmin.ToPointer(),
            },
            Relationships: operations.NodesContributorsCreateContributorRelationshipsInput{
                User: "sint",
            },
        },
        NodeID: "veritatis",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesContributorsDelete(ctx, operations.NodesContributorsDeleteRequest{
        NodeID: "itaque",
        UserID: "incidunt",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesContributorsList(ctx, operations.NodesContributorsListRequest{
        NodeID: "enim",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesContributorsPartialUpdate(ctx, operations.NodesContributorsPartialUpdateRequest{
        RequestBody: operations.NodesContributorsPartialUpdateContributorInput{
            Attributes: &operations.NodesContributorsPartialUpdateContributorAttributesInput{
                Bibliographic: sdk.Bool(false),
                Index: sdk.Int64(9356),
                Permission: operations.NodesContributorsPartialUpdateContributorAttributesPermissionEnumAdmin.ToPointer(),
            },
            Relationships: operations.NodesContributorsPartialUpdateContributorRelationshipsInput{
                User: "quibusdam",
            },
        },
        NodeID: "explicabo",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesContributorsRead(ctx, operations.NodesContributorsReadRequest{
        NodeID: "distinctio",
        UserID: "quibusdam",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesCreate(ctx, operations.NodesCreateNodeInput{
        Attributes: operations.NodesCreateNodeAttributesInput{
            Category: operations.NodesCreateNodeAttributesCategoryEnumData,
            Description: sdk.String("modi"),
            NodeLicense: sdk.String("qui"),
            Public: sdk.Bool(false),
            Tags: []string{
                "cupiditate",
                "quos",
            },
            TemplateFrom: sdk.String("perferendis"),
            Title: "Mr.",
        },
        Type: "assumenda",
    })
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesDelete(ctx, operations.NodesDeleteRequest{
        NodeID: "ipsam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesDraftRegistrationsCreate(ctx, operations.NodesDraftRegistrationsCreateRequest{
        RequestBody: operations.NodesDraftRegistrationsCreateDraftRegistrationInput{
            Attributes: operations.NodesDraftRegistrationsCreateDraftRegistrationAttributesInput{
                Category: sdk.String("alias"),
                Description: sdk.String("fugit"),
                NodeLicense: &operations.NodesDraftRegistrationsCreateDraftRegistrationAttributesNodeLicense{
                    CopyrightHolders: []string{
                        "excepturi",
                        "tempora",
                        "facilis",
                    },
                    Year: sdk.Int64(735194),
                },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesDraftRegistrationsDelete(ctx, operations.NodesDraftRegistrationsDeleteRequest{
        DraftID: "rerum",
        NodeID: "dicta",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesDraftRegistrationsList(ctx, operations.NodesDraftRegistrationsListRequest{
        NodeID: "magnam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesDraftRegistrationsPartialUpdate(ctx, operations.NodesDraftRegistrationsPartialUpdateRequest{
        RequestBody: operations.NodesDraftRegistrationsPartialUpdateDraftRegistrationInput{
            Attributes: operations.NodesDraftRegistrationsPartialUpdateDraftRegistrationAttributesInput{
                Category: sdk.String("cumque"),
                Description: sdk.String("facere"),
                NodeLicense: &operations.NodesDraftRegistrationsPartialUpdateDraftRegistrationAttributesNodeLicense{
                    CopyrightHolders: []string{
                        "aliquid",
                        "laborum",
                    },
                    Year: sdk.Int64(881104),
                },
                RegistrationMetadata: map[string]interface{}{
                    "occaecati": "enim",
                },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesFilesList(ctx, operations.NodesFilesListRequest{
        NodeID: "omnis",
        Provider: "molestiae",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesFilesRead(ctx, operations.NodesFilesReadRequest{
        NodeID: "perferendis",
        Path: "nihil",
        Provider: "magnam",
    })
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesForksCreate(ctx, operations.NodesForksCreateRequest{
        RequestBody: operations.NodesForksCreateNodeInput{
            Attributes: operations.NodesForksCreateNodeAttributesInput{
                Category: operations.NodesForksCreateNodeAttributesCategoryEnumProject,
                Description: sdk.String("id"),
                NodeLicense: sdk.String("labore"),
                Public: sdk.Bool(false),
                Tags: []string{
                    "suscipit",
                    "natus",
                },
                TemplateFrom: sdk.String("nobis"),
                Title: "Ms.",
            },
            Type: "vero",
        },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesForksList(ctx, operations.NodesForksListRequest{
        NodeID: "architecto",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesIdentifiersList(ctx, operations.NodesIdentifiersListRequest{
        NodeID: "magnam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesInstitutionsList(ctx, operations.NodesInstitutionsListRequest{
        NodeID: "et",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesLinkedNodesList(ctx, operations.NodesLinkedNodesListRequest{
        NodeID: "excepturi",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesLogsList(ctx, operations.NodesLogsListRequest{
        NodeID: "ullam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesNodeAddonUpdate(ctx, operations.NodesNodeAddonUpdateRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesPartialUpdate(ctx, operations.NodesPartialUpdateRequest{
        RequestBody: map[string]interface{}{
            "necessitatibus": "odit",
        },
        NodeID: "nemo",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesPreprintsList(ctx, operations.NodesPreprintsListRequest{
        NodeID: "quasi",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesProvidersList(ctx, operations.NodesProvidersListRequest{
        NodeID: "iure",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesProvidersRead(ctx, operations.NodesProvidersReadRequest{
        NodeID: "doloribus",
        Provider: "debitis",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesRead(ctx, operations.NodesReadRequest{
        NodeID: "eius",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesRegistrationsList(ctx, operations.NodesRegistrationsListRequest{
        NodeID: "maxime",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesViewOnlyLinksList(ctx, operations.NodesViewOnlyLinksListRequest{
        NodeID: "deleniti",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesViewOnlyLinksRead(ctx, operations.NodesViewOnlyLinksReadRequest{
        LinkID: "facilis",
        NodeID: "in",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Nodes.NodesWikisList(ctx, operations.NodesWikisListRequest{
        NodeID: "architecto",
    })
    if err != nil {
        log.Fatal(err)
