...
public class CreateAdByListingIdRequest {
    ...
    public CreateAdByListingIdRequest(@JsonProperty("CreateAdRequest") org.openapis.openapi.models.shared.CreateAdRequest createAdRequest, @JsonProperty("campaign_id") String campaignId) {
        this.createAdRequest = createAdRequest;
        this.campaignId = campaignId;
  }
}
