...
export class SearchProjectSiteRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.project_site.country",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.project_site.county",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.project_site.network",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.project_site.short_name",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.project_site.site_type",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.project_site.state",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.project_site.status",
  })
