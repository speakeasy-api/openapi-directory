...
func (e *WirelessV1SimCommandsCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = WirelessV1SimCommandsCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WirelessV1SimCommandsCallbackMethodEnum: %s", s)
	}
}
...
func (e *WirelessV1SimSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = WirelessV1SimSmsFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WirelessV1SimSmsFallbackMethodEnum: %s", s)
	}
}
...
func (e *WirelessV1SimSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = WirelessV1SimSmsMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WirelessV1SimSmsMethodEnum: %s", s)
	}
}
...
func (e *WirelessV1SimVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = WirelessV1SimVoiceFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WirelessV1SimVoiceFallbackMethodEnum: %s", s)
	}
}
...
func (e *WirelessV1SimVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = WirelessV1SimVoiceMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for WirelessV1SimVoiceMethodEnum: %s", s)
	}
}
