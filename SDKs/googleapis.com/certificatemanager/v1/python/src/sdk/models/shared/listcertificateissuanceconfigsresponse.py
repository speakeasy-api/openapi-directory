...
class ListCertificateIssuanceConfigsResponse:
    ...
    certificate_issuance_configs: Optional[list[shared_certificateissuanceconfig.CertificateIssuanceConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('certificateIssuanceConfigs'), 'exclude': lambda f: f is None }})
    r"""A list of certificate configs for the parent resource."""  
