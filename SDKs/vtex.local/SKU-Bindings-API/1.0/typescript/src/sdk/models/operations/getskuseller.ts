...
export class GetSKUsellerRequest extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class GetSKUseller200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class GetSKUsellerResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
