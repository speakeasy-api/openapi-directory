...
var BackupConfiguration = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "backupRetentionSettings" }),
        (0, class_transformer_1.Type)(function () { return backupretentionsettings_1.BackupRetentionSettings; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "binaryLogEnabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pointInTimeRecoveryEnabled" }),
        __metadata("design:type", Boolean)
    ], BackupConfiguration.prototype, "pointInTimeRecoveryEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "replicationLogArchivingEnabled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "transactionLogRetentionDays" }),
