...
public class ListUserChannelListUserChannelResponse {
    ...
    public openapisdk.models.shared.ChatV1ServiceUserUserChannel[] channels;
    public ListUserChannelListUserChannelResponse withChannels(openapisdk.models.shared.ChatV1ServiceUserUserChannel[] channels) {
