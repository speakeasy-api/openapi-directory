...
class GetDescribeIndexFieldsQueryParams:
    action: GetDescribeIndexFieldsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetDescribeIndexFieldsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    deployed: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Deployed', 'style': 'form', 'explode': True }})
    field_names: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'FieldNames', 'style': 'form', 'explode': True }})
...
class GetDescribeIndexFieldsRequest:
    headers: GetDescribeIndexFieldsHeaders = dataclasses.field()
    query_params: GetDescribeIndexFieldsQueryParams = dataclasses.field()
