...
export class CreateDomesticPaymentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticPaymentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticPaymentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
