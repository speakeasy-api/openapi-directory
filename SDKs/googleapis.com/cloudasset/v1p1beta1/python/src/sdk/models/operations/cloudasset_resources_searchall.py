...
class CloudassetResourcesSearchAllRequest:
    path_params: CloudassetResourcesSearchAllPathParams = dataclasses.field()
    query_params: CloudassetResourcesSearchAllQueryParams = dataclasses.field()
    security: CloudassetResourcesSearchAllSecurity = dataclasses.field()
