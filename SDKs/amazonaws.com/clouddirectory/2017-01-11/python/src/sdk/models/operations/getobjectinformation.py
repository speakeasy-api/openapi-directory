...
class GetObjectInformationRequestBody:
    ...
    object_reference: GetObjectInformationRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
    
class GetObjectInformationXAmzConsistencyLevelEnum(str, Enum):
    r"""The consistency level at which to retrieve the object information."""
...
class GetObjectInformationRequest:
    ...
    request_body: GetObjectInformationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_data_partition: str = dataclasses.field(metadata={'header': { 'field_name': 'x-amz-data-partition', 'style': 'simple', 'explode': False }})
    r"""The ARN of the directory being retrieved."""  
