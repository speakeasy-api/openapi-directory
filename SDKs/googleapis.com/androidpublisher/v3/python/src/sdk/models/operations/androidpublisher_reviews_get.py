...
class AndroidpublisherReviewsGetRequest:
    path_params: AndroidpublisherReviewsGetPathParams = dataclasses.field()
    query_params: AndroidpublisherReviewsGetQueryParams = dataclasses.field()
    security: AndroidpublisherReviewsGetSecurity = dataclasses.field()
