...
export declare class NetworksecurityProjectsLocationsGatewaySecurityPoliciesListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsGatewaySecurityPoliciesListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsGatewaySecurityPoliciesListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
