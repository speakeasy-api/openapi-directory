...
class ServiceCalendarViewModel:
    ...
    calendar_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('calendarName'), 'exclude': lambda f: f is None }})  
