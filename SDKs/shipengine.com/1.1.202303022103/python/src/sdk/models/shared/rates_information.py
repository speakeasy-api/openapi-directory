...
class RatesInformationRateRateTypeEnum(str, Enum):
    r"""The possible rate type values"""
    CHECK = 'check'
    SHIPMENT = 'shipment'

class RatesInformationRateValidationStatusEnum(str, Enum):
...
class RatesInformationRate:
    ...
    r"""carrier nickname"""  
    confirmation_amount: RatesInformationRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation_amount') }})
    ...
    insurance_amount: RatesInformationRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_amount') }})
    ...
    other_amount: RatesInformationRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('other_amount') }})
    ...
    r"""A string that uniquely identifies the rate"""  
    rate_type: RatesInformationRateRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rate_type') }})  
    ...
    r"""service type"""  
    shipping_amount: RatesInformationRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipping_amount') }})
    ...
    validation_status: RatesInformationRateValidationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('validation_status') }})  
    ...
    r"""ship date"""  
    tax_amount: Optional[RatesInformationRateMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tax_amount'), 'exclude': lambda f: f is None }})
    r"""Tariff and additional taxes associated with an international shipment."""  
    
class RatesInformationRateResponseStatusEnum(str, Enum):
...
class RatesInformation:
    r"""A rates information resource"""
    
    created_at: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('created_at'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})
    r"""When the rate was created"""  
    ...
    invalid_rates: Optional[list[RatesInformationRate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invalid_rates'), 'exclude': lambda f: f is None }})
    r"""An array of invalid shipment rates"""  
    rate_request_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rate_request_id'), 'exclude': lambda f: f is None }})
    r"""A string that uniquely identifies the rate request"""  
    rates: Optional[list[RatesInformationRate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rates'), 'exclude': lambda f: f is None }})
    r"""An array of shipment rates"""  
    ...
    status: Optional[RatesInformationRateResponseStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
