 ...
 */
public enum CreateCapacityReservationResultCapacityReservationTenancyEnum {
    DEFAULT_("default"),
    DEDICATED("dedicated");
    ...
    private CreateCapacityReservationResultCapacityReservationTenancyEnum(String value) {
        this.value = value;
    }
}
