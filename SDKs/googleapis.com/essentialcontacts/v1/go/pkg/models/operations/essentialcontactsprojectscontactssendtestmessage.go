...
type EssentialcontactsProjectsContactsSendTestMessageSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type EssentialcontactsProjectsContactsSendTestMessagePathParams struct {
...
type EssentialcontactsProjectsContactsSendTestMessageQueryParams struct {
	// V1 error format.
...
type EssentialcontactsProjectsContactsSendTestMessageRequest struct {
	...
	Request     *shared.GoogleCloudEssentialcontactsV1SendTestMessageRequest `request:"mediaType=application/json"`
	Security    EssentialcontactsProjectsContactsSendTestMessageSecurity
}

type EssentialcontactsProjectsContactsSendTestMessageResponse struct {
	ContentType string
	// Successful response
