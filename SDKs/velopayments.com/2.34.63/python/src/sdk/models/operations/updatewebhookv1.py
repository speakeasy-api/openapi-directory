...
class UpdateWebhookV1Request:
    ...
    r"""Webhook id"""  
    update_webhook_request: Optional[shared_updatewebhookrequest.UpdateWebhookRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
