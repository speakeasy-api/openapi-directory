...
type CreateUserAccessLoggingSettingsHeaders struct {
...
type CreateUserAccessLoggingSettingsRequest struct {
	Headers CreateUserAccessLoggingSettingsHeaders
	Request CreateUserAccessLoggingSettingsRequestBody `request:"mediaType=application/json"`
}
