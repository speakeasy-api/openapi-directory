...
class SamplingRuleRecord:
    ...
    sampling_rule: Optional[shared_samplingrule.SamplingRule] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SamplingRule') }})
