...
public class UpdateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingL3FirewallRules {
    ...
    public UpdateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingL3FirewallRules(@JsonProperty("destCidr") String destCidr, @JsonProperty("policy") String policy, @JsonProperty("protocol") String protocol) {
        this.destCidr = destCidr;
        this.policy = policy;
        this.protocol = protocol;
  }
