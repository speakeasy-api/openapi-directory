...
class SearchTypeGtfsRouteQueryParams:
    ...
    search_type_gtfs_route_route_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_gtfs_route.route_id', 'style': 'form', 'explode': True }})
    search_type_gtfs_route_stop_names: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_gtfs_route.stop_names', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchTypeGtfsRouteRequest:
    query_params: SearchTypeGtfsRouteQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeGtfsRouteResponse:
