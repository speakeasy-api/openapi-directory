...
class GetBadgesRecipientsQueryParams:
...
@dataclasses.dataclass
class GetBadgesRecipientsRequest:
    query_params: GetBadgesRecipientsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetBadgesRecipientsResponse:
