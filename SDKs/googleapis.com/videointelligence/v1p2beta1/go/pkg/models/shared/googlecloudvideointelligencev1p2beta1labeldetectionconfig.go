...
func (e *GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "SHOT_AND_FRAME_MODE":
		*e = GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum: %s", s)
	}
}
