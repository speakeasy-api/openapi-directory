 ...
 */
public enum DescribeCapacityReservationsResultCapacityReservationsInstanceMatchCriteriaEnum {
    OPEN("open"),
    TARGETED("targeted");
    ...
    private DescribeCapacityReservationsResultCapacityReservationsInstanceMatchCriteriaEnum(String value) {
        this.value = value;
    }
}
