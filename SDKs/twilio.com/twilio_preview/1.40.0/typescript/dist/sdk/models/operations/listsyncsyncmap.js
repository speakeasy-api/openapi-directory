...
exports.ListSyncSyncMapResponse = exports.ListSyncSyncMapListSyncSyncMapResponse = exports.ListSyncSyncMapListSyncSyncMapResponseMeta = exports.ListSyncSyncMapRequest = exports.ListSyncSyncMapSecurity = exports.ListSyncSyncMapServerList = void 0;
...
var ListSyncSyncMapSecurity = /** @class */ (function (_super) {
    ...
    ], ListSyncSyncMapSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSyncSyncMapSecurity.prototype, "username", void 0);
...
var ListSyncSyncMapRequest = /** @class */ (function (_super) {
    ...
    ], ListSyncSyncMapRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSyncSyncMapRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSyncSyncMapRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListSyncSyncMapRequest.prototype, "serviceSid", void 0);
...
var ListSyncSyncMapListSyncSyncMapResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewSyncServiceSyncMap }),
        (0, class_transformer_1.Expose)({ name: "maps" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewSyncServiceSyncMap; }),
        __metadata("design:type", Array)
    ], ListSyncSyncMapListSyncSyncMapResponse.prototype, "maps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListSyncSyncMapListSyncSyncMapResponseMeta; }),
...
var ListSyncSyncMapResponse = /** @class */ (function (_super) {
    ...
    ], ListSyncSyncMapResponse.prototype, "rawResponse", void 0);
