...
public class UpdateModelBuildPathParams {
    /**
    ...
    public UpdateModelBuildPathParams withAssistantSid(String assistantSid) {
    ...
    public String sid;
    public UpdateModelBuildPathParams withSid(String sid) {
        this.sid = sid;
        return this;
    }
