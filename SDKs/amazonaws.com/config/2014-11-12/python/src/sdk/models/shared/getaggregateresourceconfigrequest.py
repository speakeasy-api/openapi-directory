...
class GetAggregateResourceConfigRequest:
    ...
    resource_identifier: shared_aggregateresourceidentifier.AggregateResourceIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ResourceIdentifier') }})  
