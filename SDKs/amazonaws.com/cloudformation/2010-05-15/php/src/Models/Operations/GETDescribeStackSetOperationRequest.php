...
class GETDescribeStackSetOperationRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETDescribeStackSetOperationCallAsEnum $callAs
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=CallAs')]
    public ?GETDescribeStackSetOperationCallAsEnum $callAs = null;
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETDescribeStackSetOperationActionEnum::DESCRIBE_STACK_SET_OPERATION;
		$this->callAs = null;
		$this->operationId = "";
		$this->stackSetName = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETDescribeStackSetOperationVersionEnum::TWO_THOUSAND_AND_TEN0515;
