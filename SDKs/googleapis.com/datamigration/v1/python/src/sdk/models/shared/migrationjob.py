...
import dataclasses
from ..shared import conversionworkspaceinfo as shared_conversionworkspaceinfo
...
class MigrationJobInput:
    ...
    conversion_workspace: Optional[shared_conversionworkspaceinfo.ConversionWorkspaceInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversionWorkspace'), 'exclude': lambda f: f is None }})
    ...
    dump_flags: Optional[shared_dumpflags.DumpFlags] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dumpFlags'), 'exclude': lambda f: f is None }})
    ...
    r"""The path to the dump file in Google Cloud Storage, in the format: (gs://[BUCKET_NAME]/[OBJECT_NAME]). This field and the \\"dump_flags\\" field are mutually exclusive."""  
    ...
    r"""This field can be used to select the entities to migrate as part of the migration job. It uses AIP-160 notation to select a subset of the entities configured on the associated conversion-workspace. This field should not be set on migration-jobs that are not associated with a conversion workspace."""  
