...
export class RegionInstanceGroups {
  ...
  computeRegionInstanceGroupsTestIamPermissions(
    req: operations.ComputeRegionInstanceGroupsTestIamPermissionsRequest,
    security: operations.ComputeRegionInstanceGroupsTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeRegionInstanceGroupsTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeRegionInstanceGroupsTestIamPermissionsRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeRegionInstanceGroupsTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeRegionInstanceGroupsTestIamPermissionsResponse =
        new operations.ComputeRegionInstanceGroupsTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
