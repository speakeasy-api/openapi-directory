...
export class RunProjectsLocationsRoutesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsRoutesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsRoutesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
