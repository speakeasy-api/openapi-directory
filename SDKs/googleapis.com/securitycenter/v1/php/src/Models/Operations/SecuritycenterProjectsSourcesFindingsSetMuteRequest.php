...
class SecuritycenterProjectsSourcesFindingsSetMuteRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\SetMuteRequest $setMuteRequest = null;
