...
class GetTagsSynonymsQueryParams:
    ...
    order: Optional[GetTagsSynonymsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetTagsSynonymsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetTagsSynonymsRequest:
    query_params: GetTagsSynonymsQueryParams = dataclasses.field()
