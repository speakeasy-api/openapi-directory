...
class RunsForRouteAndRouteTypeRouteTypeEnum(str, Enum):
...
class RunsForRouteAndRouteTypeRequest:
    ...
    r"""List of objects to be returned in full (i.e. expanded) - options include: All, VehiclePosition, VehicleDescriptor, or None. Default is All."""  
    ...
    route_type: RunsForRouteAndRouteTypeRouteTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'route_type', 'style': 'simple', 'explode': False }})
    r"""Number identifying transport mode; values returned via RouteTypes API"""  
...
class RunsForRouteAndRouteTypeResponse:
    ...
    r"""All trip/service run details for the specified route ID and route type."""  
