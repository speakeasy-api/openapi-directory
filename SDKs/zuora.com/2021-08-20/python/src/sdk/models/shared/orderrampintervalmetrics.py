...
from ..shared import rampintervalchargedeltametrics as shared_rampintervalchargedeltametrics
from ..shared import rampintervalchargemetrics as shared_rampintervalchargemetrics


@dataclass_json
@dataclasses.dataclass
class OrderRampIntervalMetrics:
    ...
    interval_delta_metrics: Optional[list[shared_rampintervalchargedeltametrics.RampIntervalChargeDeltaMetrics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intervalDeltaMetrics') }})
