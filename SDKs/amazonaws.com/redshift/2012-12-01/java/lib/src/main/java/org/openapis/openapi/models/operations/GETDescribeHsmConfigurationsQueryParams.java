...
public class GETDescribeHsmConfigurationsQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETDescribeHsmConfigurationsActionEnum action;
    public GETDescribeHsmConfigurationsQueryParams withAction(GETDescribeHsmConfigurationsActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETDescribeHsmConfigurationsQueryParams withHsmConfigurationIdentifier(String hsmConfigurationIdentifier) {
    ...
    public GETDescribeHsmConfigurationsQueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public GETDescribeHsmConfigurationsQueryParams withMaxRecords(Long maxRecords) {
    ...
    public GETDescribeHsmConfigurationsQueryParams withTagKeys(String[] tagKeys) {
    ...
    public GETDescribeHsmConfigurationsQueryParams withTagValues(String[] tagValues) {
    ...
    public GETDescribeHsmConfigurationsQueryParams withVersion(GETDescribeHsmConfigurationsVersionEnum version) {
