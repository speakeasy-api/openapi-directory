...
class POSTReconcileRefundRequest:
    ...
    post_reconcile_refund_request: shared_postreconcilerefundrequest.POSTReconcileRefundRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    refund_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'refund-id', 'style': 'simple', 'explode': False }})
    r"""Unique ID of the refund."""  
