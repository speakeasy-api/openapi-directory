...
type CreateConnectClientAddInHeaders struct {
...
type CreateConnectClientAddInRequest struct {
	Headers CreateConnectClientAddInHeaders
	Request shared.CreateConnectClientAddInRequest `request:"mediaType=application/json"`
}
