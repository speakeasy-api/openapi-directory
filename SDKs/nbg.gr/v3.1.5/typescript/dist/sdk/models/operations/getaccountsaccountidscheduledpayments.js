...
exports.GetAccountsAccountIdScheduledPaymentsResponse = exports.GetAccountsAccountIdScheduledPaymentsRequest = exports.GetAccountsAccountIdScheduledPaymentsSecurity = void 0;
...
var GetAccountsAccountIdScheduledPaymentsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetAccountsAccountIdScheduledPaymentsRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdScheduledPaymentsRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdScheduledPaymentsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdScheduledPaymentsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdScheduledPaymentsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdScheduledPaymentsRequest.prototype, "xFapiInteractionId", void 0);
...
var GetAccountsAccountIdScheduledPaymentsResponse = /** @class */ (function (_super) {
    ...
    ], GetAccountsAccountIdScheduledPaymentsResponse.prototype, "rawResponse", void 0);
