...
class Span:
    ...
    span_kind: Optional[SpanSpanKindEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('spanKind') }})
    ...
    time_events: Optional[shared_timeevents.TimeEvents] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('timeEvents') }})
