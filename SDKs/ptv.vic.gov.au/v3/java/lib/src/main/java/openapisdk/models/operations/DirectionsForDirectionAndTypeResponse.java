...
public class DirectionsForDirectionAndTypeResponse {
    ...
    public DirectionsForDirectionAndTypeResponse withStatusCode(Long statusCode) {
        this.statusCode = statusCode;
        return this;
    }
    public openapisdk.models.shared.V3DirectionsResponse v3DirectionsResponse;
    public DirectionsForDirectionAndTypeResponse withV3DirectionsResponse(openapisdk.models.shared.V3DirectionsResponse v3DirectionsResponse) {
        this.v3DirectionsResponse = v3DirectionsResponse;
        return this;
    }
    public openapisdk.models.shared.V3ErrorResponse v3ErrorResponse;
    public DirectionsForDirectionAndTypeResponse withV3ErrorResponse(openapisdk.models.shared.V3ErrorResponse v3ErrorResponse) {
