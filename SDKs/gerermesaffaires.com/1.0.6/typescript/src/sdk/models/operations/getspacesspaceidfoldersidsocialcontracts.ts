...
export class GetSpacesSpaceIdFoldersIdSocialContractsRequest extends SpeakeasyBase {
  /**
...
export class GetSpacesSpaceIdFoldersIdSocialContractsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.SocialContract })
