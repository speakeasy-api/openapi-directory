...
class DescribeSourceServersRequestBodyFilters:
    ...
    source_server_i_ds: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sourceServerIDs') }})
    

@dataclass_json
@dataclasses.dataclass
class DescribeSourceServersRequestBody:
    filters: DescribeSourceServersRequestBodyFilters = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('filters') }})
...
class DescribeSourceServersRequest:
    headers: DescribeSourceServersHeaders = dataclasses.field()
    query_params: DescribeSourceServersQueryParams = dataclasses.field()
    request: DescribeSourceServersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
