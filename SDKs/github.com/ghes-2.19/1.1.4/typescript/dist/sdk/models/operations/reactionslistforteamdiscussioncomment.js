...
exports.ReactionsListForTeamDiscussionCommentResponse = exports.ReactionsListForTeamDiscussionCommentRequest = exports.ReactionsListForTeamDiscussionCommentContentEnum = void 0;
 ...
 */
var ReactionsListForTeamDiscussionCommentContentEnum;
...
})(ReactionsListForTeamDiscussionCommentContentEnum = exports.ReactionsListForTeamDiscussionCommentContentEnum || (exports.ReactionsListForTeamDiscussionCommentContentEnum = {}));
var ReactionsListForTeamDiscussionCommentRequest = /** @class */ (function (_super) {
    ...
    ], ReactionsListForTeamDiscussionCommentRequest.prototype, "accept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=comment_number",
        }),
        __metadata("design:type", Number)
    ], ReactionsListForTeamDiscussionCommentRequest.prototype, "commentNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=content",
        }),
        __metadata("design:type", String)
    ], ReactionsListForTeamDiscussionCommentRequest.prototype, "content", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=discussion_number",
        }),
        __metadata("design:type", Number)
    ], ReactionsListForTeamDiscussionCommentRequest.prototype, "discussionNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ReactionsListForTeamDiscussionCommentRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ReactionsListForTeamDiscussionCommentRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=team_id",
        }),
        __metadata("design:type", Number)
    ], ReactionsListForTeamDiscussionCommentRequest.prototype, "teamId", void 0);
...
var ReactionsListForTeamDiscussionCommentResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ReactionsListForTeamDiscussionCommentResponse.prototype, "rawResponse", void 0);
    __decorate([
