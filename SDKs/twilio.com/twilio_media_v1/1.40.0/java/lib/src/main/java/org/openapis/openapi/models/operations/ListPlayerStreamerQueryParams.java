...
public class ListPlayerStreamerQueryParams {
    ...
    public ListPlayerStreamerQueryParams withOrder(org.openapis.openapi.models.shared.PlayerStreamerEnumOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public ListPlayerStreamerQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListPlayerStreamerQueryParams withPageToken(String pageToken) {
    ...
    public ListPlayerStreamerQueryParams withStatus(org.openapis.openapi.models.shared.PlayerStreamerEnumStatusEnum status) {
        this.status = status;
        return this;
    }
