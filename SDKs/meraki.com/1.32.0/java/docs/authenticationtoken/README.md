...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CreateDeviceApplianceVmxAuthenticationTokenRequest req = new CreateDeviceApplianceVmxAuthenticationTokenRequest("aliquid");            

            CreateDeviceApplianceVmxAuthenticationTokenResponse res = sdk.authenticationToken.createDeviceApplianceVmxAuthenticationToken(req);
