...
export class OrgpolicyOrganizationsCustomConstraintsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OrgpolicyOrganizationsCustomConstraintsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OrgpolicyOrganizationsCustomConstraintsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
