...
exports.GetCisInstructionsWithTagResponse = exports.GetCisInstructionsWithTagRequest = void 0;
...
var GetCisInstructionsWithTagRequest = /** @class */ (function (_super) {
    ...
    ], GetCisInstructionsWithTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionsWithTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionsWithTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionsWithTagRequest.prototype, "subContractorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetCisInstructionsWithTagRequest.prototype, "tagId", void 0);
...
var GetCisInstructionsWithTagResponse = /** @class */ (function (_super) {
    ...
    ], GetCisInstructionsWithTagResponse.prototype, "rawResponse", void 0);
