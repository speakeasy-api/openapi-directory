...
exports.SearchGeoGpxResponse = exports.SearchGeoGpxRequest = exports.SearchGeoGpxQueryParams = void 0;
...
var SearchGeoGpxQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.geo_gpx.distance" }),
        __metadata("design:type", Number)
    ], SearchGeoGpxQueryParams.prototype, "searchGeoGpxDistance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.geo_gpx.elevation_gain" }),
        __metadata("design:type", Number)
    ], SearchGeoGpxQueryParams.prototype, "searchGeoGpxElevationGain", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.geo_gpx.elevation_loss" }),
        __metadata("design:type", Number)
    ], SearchGeoGpxQueryParams.prototype, "searchGeoGpxElevationLoss", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.geo_gpx.moving_time" }),
        __metadata("design:type", Number)
    ], SearchGeoGpxQueryParams.prototype, "searchGeoGpxMovingTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.geo_gpx.speed" }),
        __metadata("design:type", Number)
    ], SearchGeoGpxQueryParams.prototype, "searchGeoGpxSpeed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.geo_gpx.total_time" }),
        __metadata("design:type", Number)
...
exports.SearchGeoGpxQueryParams = SearchGeoGpxQueryParams;
