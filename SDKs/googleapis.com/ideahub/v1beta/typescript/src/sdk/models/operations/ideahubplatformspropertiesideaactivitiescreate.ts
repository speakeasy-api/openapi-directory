...
export class IdeahubPlatformsPropertiesIdeaActivitiesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IdeahubPlatformsPropertiesIdeaActivitiesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
