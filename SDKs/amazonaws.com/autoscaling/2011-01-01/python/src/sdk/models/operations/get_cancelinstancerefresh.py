...
class GetCancelInstanceRefreshQueryParams:
    action: GetCancelInstanceRefreshActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetCancelInstanceRefreshVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCancelInstanceRefreshRequest:
    headers: GetCancelInstanceRefreshHeaders = dataclasses.field()
    query_params: GetCancelInstanceRefreshQueryParams = dataclasses.field()
