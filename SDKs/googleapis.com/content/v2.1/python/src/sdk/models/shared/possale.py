...
class PosSale:
    ...
    r"""Identifies what kind of resource this is. Value: the fixed string \\"`content#posSale`\\" """  
    ...
    r"""Required. The identifier of the merchant's store. Either a `storeCode` inserted through the API or the code of the store in a Business Profile."""  
