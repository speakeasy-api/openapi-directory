 ...
 */
var DatafeedsCustomBatchRequestEntry = /** @class */ (function (_super) {
    __extends(DatafeedsCustomBatchRequestEntry, _super);
    function DatafeedsCustomBatchRequestEntry() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "datafeed" }),
        (0, class_transformer_1.Type)(function () { return datafeed_1.Datafeed; }),
        __metadata("design:type", datafeed_1.Datafeed)
    ], DatafeedsCustomBatchRequestEntry.prototype, "datafeed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "datafeedId" }),
