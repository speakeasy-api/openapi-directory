...
from ..shared import dynamodbstreamstartposition_enum as shared_dynamodbstreamstartposition_enum
...
class PipeSourceDynamoDBStreamParameters:
    ...
    starting_position: shared_dynamodbstreamstartposition_enum.DynamoDBStreamStartPositionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StartingPosition') }})  
