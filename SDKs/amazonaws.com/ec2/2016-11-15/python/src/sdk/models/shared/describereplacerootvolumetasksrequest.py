...
class DescribeReplaceRootVolumeTasksRequestFilters:
...
class DescribeReplaceRootVolumeTasksRequest:
    ...
    filters: Optional[list[DescribeReplaceRootVolumeTasksRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    replace_root_volume_task_ids: Optional[list[str]] = dataclasses.field(default=None)  
