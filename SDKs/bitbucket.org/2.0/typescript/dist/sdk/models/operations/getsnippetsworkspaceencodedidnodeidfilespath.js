...
exports.GetSnippetsWorkspaceEncodedIdNodeIdFilesPathResponse = exports.GetSnippetsWorkspaceEncodedIdNodeIdFilesPathRequest = exports.GetSnippetsWorkspaceEncodedIdNodeIdFilesPathSecurity = void 0;
...
var GetSnippetsWorkspaceEncodedIdNodeIdFilesPathRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdNodeIdFilesPathRequest.prototype, "encodedId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=node_id",
        }),
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdNodeIdFilesPathRequest.prototype, "nodeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=path",
        }),
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdNodeIdFilesPathRequest.prototype, "path", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetSnippetsWorkspaceEncodedIdNodeIdFilesPathRequest.prototype, "workspace", void 0);
...
var GetSnippetsWorkspaceEncodedIdNodeIdFilesPathResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetSnippetsWorkspaceEncodedIdNodeIdFilesPathResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
