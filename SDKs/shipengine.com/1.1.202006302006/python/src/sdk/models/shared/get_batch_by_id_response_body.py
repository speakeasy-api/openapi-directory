...
class GetBatchByIDResponseBodyOptionalLink:
    r"""GetBatchByIDResponseBodyOptionalLink
...
@dataclass_json
@dataclasses.dataclass
class GetBatchByIDResponseBodyLabelDownload:
    r"""GetBatchByIDResponseBodyLabelDownload
...
class GetBatchByIDResponseBody:
    ...
    batch_errors_url: GetBatchByIDResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('batch_errors_url') }})
    ...
    form_download: GetBatchByIDResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('form_download') }})
    forms: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('forms') }})
    label_download: GetBatchByIDResponseBodyLabelDownload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_download') }})
