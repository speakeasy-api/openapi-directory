...
exports.KendraConfiguration = void 0;
var utils_1 = require("../../../internal/utils");
// KendraConfiguration
/**
 * Provides configuration information for the AMAZON.KendraSearchIntent intent. When you use this intent, Amazon Lex searches the specified Amazon Kendra index and returns documents from the index that match the user's utterance.
**/
var KendraConfiguration = /** @class */ (function (_super) {
    __extends(KendraConfiguration, _super);
    ...
    ], KendraConfiguration.prototype, "kendraIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=queryFilterString" }),
        __metadata("design:type", String)
    ], KendraConfiguration.prototype, "queryFilterString", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=queryFilterStringEnabled" }),
        __metadata("design:type", Boolean)
    ], KendraConfiguration.prototype, "queryFilterStringEnabled", void 0);
