...
class BatchUpdateValuesByDataFilterResponse:
    ...
    responses: Optional[list[shared_updatevaluesbydatafilterresponse.UpdateValuesByDataFilterResponse]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('responses') }})
