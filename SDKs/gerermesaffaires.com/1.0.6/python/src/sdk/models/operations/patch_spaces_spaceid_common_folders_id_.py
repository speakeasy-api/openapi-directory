...
class PatchSpacesSpaceIDCommonFoldersIDRequestBodyLevelEnum(str, Enum):
...
class PatchSpacesSpaceIDCommonFoldersIDRequestBody:
    r"""Folder to modify"""
    ...
    level: Optional[PatchSpacesSpaceIDCommonFoldersIDRequestBodyLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Name'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class PatchSpacesSpaceIDCommonFoldersIDRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""Id of the folder"""  
    request_body: PatchSpacesSpaceIDCommonFoldersIDRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Folder to modify"""  
...
@dataclasses.dataclass
class PatchSpacesSpaceIDCommonFoldersIDResponse:
