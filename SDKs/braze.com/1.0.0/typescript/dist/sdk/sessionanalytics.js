...
var SessionAnalytics = /** @class */ (function () {
    function SessionAnalytics(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * ```
    **/
    SessionAnalytics.prototype.appSessionsByTime = function (req, config) {
