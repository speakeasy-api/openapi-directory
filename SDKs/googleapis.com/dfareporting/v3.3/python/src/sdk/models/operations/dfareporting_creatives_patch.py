...
class DfareportingCreativesPatchRequest:
    path_params: DfareportingCreativesPatchPathParams = dataclasses.field()
    query_params: DfareportingCreativesPatchQueryParams = dataclasses.field()
    security: DfareportingCreativesPatchSecurity = dataclasses.field()
