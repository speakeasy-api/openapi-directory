 ...
 */
public class GetZRSettings200ApplicationXML2Notification {
    /**
     * Send an alert when the audio echo test result meets usability threshold.
     */
    
    public Boolean audioMeetUsabilityThreshold;
    public GetZRSettings200ApplicationXML2Notification withAudioMeetUsabilityThreshold(Boolean audioMeetUsabilityThreshold) {
    ...
    public GetZRSettings200ApplicationXML2Notification withAudioNotMeetUsabilityThreshold(Boolean audioNotMeetUsabilityThreshold) {
    ...
    public GetZRSettings200ApplicationXML2Notification withBatteryIsCharging(Boolean batteryIsCharging) {
    ...
    public GetZRSettings200ApplicationXML2Notification withBatteryLowAndNotCharging(Boolean batteryLowAndNotCharging) {
    ...
    public GetZRSettings200ApplicationXML2Notification withBatteryPercentage(String batteryPercentage) {
    ...
    public GetZRSettings200ApplicationXML2Notification withControllerSchedulingDisconnected(Boolean controllerSchedulingDisconnected) {
    ...
    public GetZRSettings200ApplicationXML2Notification withControllerSchedulingReconnected(Boolean controllerSchedulingReconnected) {
    ...
    public GetZRSettings200ApplicationXML2Notification withCpuUsageHighDetected(Boolean cpuUsageHighDetected) {
    ...
    public GetZRSettings200ApplicationXML2Notification withMicSpeakerCameraDisconnected(Boolean micSpeakerCameraDisconnected) {
    ...
    public GetZRSettings200ApplicationXML2Notification withMicSpeakerCameraReconnected(Boolean micSpeakerCameraReconnected) {
    ...
    public GetZRSettings200ApplicationXML2Notification withNetworkUnstableDetected(Boolean networkUnstableDetected) {
    ...
    public GetZRSettings200ApplicationXML2Notification withSipRegistrationFailed(Boolean sipRegistrationFailed) {
    ...
    public GetZRSettings200ApplicationXML2Notification withSipRegistrationReEnabled(Boolean sipRegistrationReEnabled) {
    ...
    public GetZRSettings200ApplicationXML2Notification withZoomRoomComeBackOnline(Boolean zoomRoomComeBackOnline) {
    ...
    public GetZRSettings200ApplicationXML2Notification withZoomRoomDisplayDisconnected(Boolean zoomRoomDisplayDisconnected) {
    ...
    public GetZRSettings200ApplicationXML2Notification withZoomRoomOffline(Boolean zoomRoomOffline) {
