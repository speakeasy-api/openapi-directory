...
**/
var QueryInfo = /** @class */ (function (_super) {
    __extends(QueryInfo, _super);
    function QueryInfo() {
    ...
    ], QueryInfo.prototype, "createTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=logGroupName" }),
        __metadata("design:type", String)
    ], QueryInfo.prototype, "logGroupName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=queryId" }),
        __metadata("design:type", String)
    ], QueryInfo.prototype, "queryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=queryString" }),
        __metadata("design:type", String)
    ], QueryInfo.prototype, "queryString", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], QueryInfo.prototype, "status", void 0);
    return QueryInfo;
