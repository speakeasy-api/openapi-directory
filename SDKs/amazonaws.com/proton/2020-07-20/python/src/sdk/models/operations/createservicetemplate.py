...
class CreateServiceTemplateRequest:
    ...
    create_service_template_input: shared_createservicetemplateinput.CreateServiceTemplateInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
