...
const (
	UntagResourceXAmzTargetEnumSpencerFrontendServiceUntagResource UntagResourceXAmzTargetEnum = "SpencerFrontendService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "SpencerFrontendService.UntagResource":
