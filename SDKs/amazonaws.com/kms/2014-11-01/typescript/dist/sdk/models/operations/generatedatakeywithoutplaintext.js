...
exports.GenerateDataKeyWithoutPlaintextResponse = exports.GenerateDataKeyWithoutPlaintextRequest = exports.GenerateDataKeyWithoutPlaintextXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GenerateDataKeyWithoutPlaintextXAmzTargetEnum;
...
})(GenerateDataKeyWithoutPlaintextXAmzTargetEnum = exports.GenerateDataKeyWithoutPlaintextXAmzTargetEnum || (exports.GenerateDataKeyWithoutPlaintextXAmzTargetEnum = {}));
var GenerateDataKeyWithoutPlaintextRequest = /** @class */ (function (_super) {
    ...
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "generateDataKeyWithoutPlaintextRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], GenerateDataKeyWithoutPlaintextRequest.prototype, "xAmzTarget", void 0);
...
var GenerateDataKeyWithoutPlaintextResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GenerateDataKeyWithoutPlaintextResponse.prototype, "rawResponse", void 0);
