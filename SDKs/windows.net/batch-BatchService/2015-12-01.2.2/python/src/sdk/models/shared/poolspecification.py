...
class PoolSpecification:
    ...
    r"""Gets or sets the formula for the desired number of compute nodes in the pool."""  
    ...
    r"""Gets or sets a list of certificates to be installed on each compute node in the pool."""  
    ...
    r"""Gets or sets whether the pool size should automatically adjust over time."""  
    ...
    r"""Gets or sets the timeout for allocation of compute nodes to the pool."""  
    ...
    r"""Gets or sets the desired number of compute nodes in the pool."""  
    ...
    r"""Gets or sets the Azure Guest OS version to be installed on the virtual machines in the pool."""  
    ...
    r"""Gets or sets the size of the virtual machines in the pool. All VMs in a pool are the same size."""  
