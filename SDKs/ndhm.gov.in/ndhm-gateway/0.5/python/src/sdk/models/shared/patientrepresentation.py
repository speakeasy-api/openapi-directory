...
class PatientRepresentation:
    ...
    care_contexts: Optional[list[shared_carecontextrepresentation.CareContextRepresentation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('careContexts') }})
