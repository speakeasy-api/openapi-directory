...
class UpdateJourneyRequestBody:
    ...
    write_journey_request: UpdateJourneyRequestBodyWriteJourneyRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WriteJourneyRequest') }})
    r"""Specifies the configuration and other settings for a journey."""  
...
class UpdateJourneyRequest:
    ...
    request_body: UpdateJourneyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
