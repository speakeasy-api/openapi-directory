...
class GetSpacesIDPersonsPersonIDPortfoliosRequest:
    ...
    r"""Id of the person to get portfolios"""  
    
class GetSpacesIDPersonsPersonIDPortfolios200ApplicationJSONLevelEnum(str, Enum):
...
class GetSpacesIDPersonsPersonIDPortfolios200ApplicationJSON:
    ...
    level: Optional[GetSpacesIDPersonsPersonIDPortfolios200ApplicationJSONLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
...
class GetSpacesIDPersonsPersonIDPortfoliosResponse:
    ...
    get_spaces_id_persons_person_id_portfolios_200_application_json_anies: Optional[list[GetSpacesIDPersonsPersonIDPortfolios200ApplicationJSON]] = dataclasses.field(default=None)
    r"""A list of portfolios"""  
