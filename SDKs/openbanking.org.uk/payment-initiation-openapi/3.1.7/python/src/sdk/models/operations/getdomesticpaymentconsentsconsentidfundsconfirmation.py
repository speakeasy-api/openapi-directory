...
from ..shared import obwritefundsconfirmationresponse1 as shared_obwritefundsconfirmationresponse1


@dataclasses.dataclass
class GetDomesticPaymentConsentsConsentIDFundsConfirmationPathParams:
    consent_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ConsentId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDomesticPaymentConsentsConsentIDFundsConfirmationHeaders:
...
@dataclasses.dataclass
class GetDomesticPaymentConsentsConsentIDFundsConfirmationSecurity:
    psuo_auth2_security: shared_security.SchemePsuoAuth2Security = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class GetDomesticPaymentConsentsConsentIDFundsConfirmationRequest:
    headers: GetDomesticPaymentConsentsConsentIDFundsConfirmationHeaders = dataclasses.field()
    path_params: GetDomesticPaymentConsentsConsentIDFundsConfirmationPathParams = dataclasses.field()
    security: GetDomesticPaymentConsentsConsentIDFundsConfirmationSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetDomesticPaymentConsentsConsentIDFundsConfirmationResponse:
    ...
    ob_write_funds_confirmation_response1: Optional[shared_obwritefundsconfirmationresponse1.ObWriteFundsConfirmationResponse1] = dataclasses.field(default=None)
