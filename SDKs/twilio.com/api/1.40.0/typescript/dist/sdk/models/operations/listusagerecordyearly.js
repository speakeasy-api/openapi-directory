...
exports.ListUsageRecordYearlyResponse = exports.ListUsageRecordYearlyListUsageRecordYearlyResponse = exports.ListUsageRecordYearlyRequest = exports.ListUsageRecordYearlySecurity = exports.ListUsageRecordYearlyServerList = void 0;
...
var ListUsageRecordYearlySecurity = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordYearlySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordYearlySecurity.prototype, "username", void 0);
...
var ListUsageRecordYearlyRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUsageRecordYearlyRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Category",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordYearlyRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EndDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordYearlyRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IncludeSubaccounts",
        }),
        __metadata("design:type", Boolean)
    ], ListUsageRecordYearlyRequest.prototype, "includeSubaccounts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUsageRecordYearlyRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUsageRecordYearlyRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordYearlyRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordYearlyRequest.prototype, "startDate", void 0);
...
var ListUsageRecordYearlyListUsageRecordYearlyResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountUsageUsageRecordUsageRecordYearly,
        }),
        (0, class_transformer_1.Expose)({ name: "usage_records" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountUsageUsageRecordUsageRecordYearly; }),
...
var ListUsageRecordYearlyResponse = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordYearlyResponse.prototype, "rawResponse", void 0);
