...
public class GetGenotypeGenotypeAssociationsRequest {
    ...
    public GetGenotypeGenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGenotypeGenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGenotypeGenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenotypeGenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGenotypeGenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGenotypeGenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetGenotypeGenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGenotypeGenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenotypeGenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGenotypeGenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
