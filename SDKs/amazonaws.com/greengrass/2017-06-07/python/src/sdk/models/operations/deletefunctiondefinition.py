...
class DeleteFunctionDefinitionRequest:
    headers: DeleteFunctionDefinitionHeaders = dataclasses.field()
    path_params: DeleteFunctionDefinitionPathParams = dataclasses.field()
...
class DeleteFunctionDefinitionResponse:
    ...
    delete_function_definition_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
