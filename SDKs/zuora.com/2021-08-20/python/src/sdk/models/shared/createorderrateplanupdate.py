...
class CreateOrderRatePlanUpdate:
    ...
    charge_updates: Optional[list[shared_createorderchargeupdate.CreateOrderChargeUpdate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('chargeUpdates'), 'exclude': lambda f: f is None }})  
    ...
    r"""The id of the rate plan to be updated. It can be the latest version or any history version id."""  
