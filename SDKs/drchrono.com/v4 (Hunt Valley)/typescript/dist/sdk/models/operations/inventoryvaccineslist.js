...
exports.InventoryVaccinesListResponse = exports.InventoryVaccinesList200ApplicationJSON = exports.InventoryVaccinesListRequest = exports.InventoryVaccinesListSecurity = void 0;
...
var InventoryVaccinesListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], InventoryVaccinesListRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cvx_code",
        }),
        __metadata("design:type", String)
    ], InventoryVaccinesListRequest.prototype, "cvxCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], InventoryVaccinesListRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], InventoryVaccinesListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], InventoryVaccinesListRequest.prototype, "since", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], InventoryVaccinesListRequest.prototype, "status", void 0);
...
var InventoryVaccinesList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.InventoryVaccine }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.InventoryVaccine; }),
...
var InventoryVaccinesListResponse = /** @class */ (function (_super) {
    ...
    ], InventoryVaccinesListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
