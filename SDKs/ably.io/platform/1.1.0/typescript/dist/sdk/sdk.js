 ...
 */
exports.ServerList = ["https://rest.ably.io"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.publishing = new publishing_1.Publishing(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
