...
export const ListMemberServerList = ["https://api.twilio.com"] as const;
...
export class ListMemberListMemberResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ApiV2010AccountQueueMember })
  @Expose({ name: "queue_members" })
  @Type(() => shared.ApiV2010AccountQueueMember)
