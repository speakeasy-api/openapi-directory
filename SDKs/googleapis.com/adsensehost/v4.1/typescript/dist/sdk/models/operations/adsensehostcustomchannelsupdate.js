...
exports.AdsensehostCustomchannelsUpdateResponse = exports.AdsensehostCustomchannelsUpdateRequest = exports.AdsensehostCustomchannelsUpdateSecurity = void 0;
...
var AdsensehostCustomchannelsUpdateRequest = /** @class */ (function (_super) {
    ...
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "customChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=adClientId",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "adClientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsUpdateRequest.prototype, "userIp", void 0);
...
var AdsensehostCustomchannelsUpdateResponse = /** @class */ (function (_super) {
    ...
    ], AdsensehostCustomchannelsUpdateResponse.prototype, "rawResponse", void 0);
