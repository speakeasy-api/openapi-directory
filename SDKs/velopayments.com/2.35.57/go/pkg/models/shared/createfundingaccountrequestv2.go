...
func (e CreateFundingAccountRequestV2TypeEnum) ToPointer() *CreateFundingAccountRequestV2TypeEnum {
	return &e
}
...
func (e *CreateFundingAccountRequestV2TypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "WUBS_DECOUPLED":
		fallthrough
	case "PRIVATE":
		*e = CreateFundingAccountRequestV2TypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateFundingAccountRequestV2TypeEnum: %v", v)
	}
}
