...
class AccountHolders:
    ...
    def post_close_stores(self, request: shared.CloseStoresRequest, security: operations.PostCloseStoresSecurity) -> operations.PostCloseStoresResponse:
        r"""Close stores
        ...
        res = operations.PostCloseStoresResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
