...
var ListChannelConnectionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: channelconnection_1.ChannelConnection }),
        (0, class_transformer_1.Expose)({ name: "channelConnections" }),
        (0, class_transformer_1.Type)(function () { return channelconnection_1.ChannelConnection; }),
