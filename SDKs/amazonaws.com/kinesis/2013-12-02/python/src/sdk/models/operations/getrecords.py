...
class GetRecordsRequest:
    headers: GetRecordsHeaders = dataclasses.field()
    request: shared_getrecordsinput.GetRecordsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
