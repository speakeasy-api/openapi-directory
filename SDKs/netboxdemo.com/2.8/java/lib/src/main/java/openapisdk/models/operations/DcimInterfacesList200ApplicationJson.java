...
public class DcimInterfacesList200ApplicationJson {
    ...
    public openapisdk.models.shared.DeviceInterface[] results;
    public DcimInterfacesList200ApplicationJson withResults(openapisdk.models.shared.DeviceInterface[] results) {
