...
class AndroidpublisherEditsTracksPatchRequest:
    path_params: AndroidpublisherEditsTracksPatchPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsTracksPatchQueryParams = dataclasses.field()
    security: AndroidpublisherEditsTracksPatchSecurity = dataclasses.field()
    request: Optional[shared_track.Track] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
