...
class APIInformation:
    ...
    def get_api_version(self) -> operations.GetAPIVersionResponse:
        ...
        res = operations.GetAPIVersionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_health(self) -> operations.GetHealthResponse:
        ...
        res = operations.GetHealthResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.APIHealthStatus])
