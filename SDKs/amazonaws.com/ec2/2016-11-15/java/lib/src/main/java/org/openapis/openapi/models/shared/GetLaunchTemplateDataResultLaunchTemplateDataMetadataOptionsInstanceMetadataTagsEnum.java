 ...
 */
public enum GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsInstanceMetadataTagsEnum {
    DISABLED("disabled"),
    ENABLED("enabled");
    ...
    private GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsInstanceMetadataTagsEnum(String value) {
        this.value = value;
    }
}
