...
public class ProductApiUpdateJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiUpdateJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiUpdateJsonHeaders withXAuthSecret(String xAuthSecret) {
