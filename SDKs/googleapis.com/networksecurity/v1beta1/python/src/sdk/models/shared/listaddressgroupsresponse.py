...
import dataclasses
from ..shared import addressgroup as shared_addressgroup
...
class ListAddressGroupsResponse:
    ...
    address_groups: Optional[list[shared_addressgroup.AddressGroup]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('addressGroups'), 'exclude': lambda f: f is None }})
    r"""List of AddressGroups resources."""  
