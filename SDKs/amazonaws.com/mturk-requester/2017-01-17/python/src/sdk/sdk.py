...
SERVERS = [
    ...
    r"""The Amazon MTurk multi-region endpoint"""
    "https://mturk-requester.{region}.amazonaws.com",
    r"""The Amazon MTurk multi-region endpoint"""
    "http://mturk-requester.{region}.amazonaws.com.cn",
    r"""The Amazon MTurk endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    r"""<fullname>Amazon Mechanical Turk API Reference</fullname>
    ...
    def accept_qualification_request(self, request: operations.AcceptQualificationRequestRequest) -> operations.AcceptQualificationRequestResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "accept_qualification_request_request", 'json')
        ...
        res = operations.AcceptQualificationRequestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def approve_assignment(self, request: operations.ApproveAssignmentRequest) -> operations.ApproveAssignmentResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "approve_assignment_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ApproveAssignmentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def associate_qualification_with_worker(self, request: operations.AssociateQualificationWithWorkerRequest) -> operations.AssociateQualificationWithWorkerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "associate_qualification_with_worker_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AssociateQualificationWithWorkerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_additional_assignments_for_hit(self, request: operations.CreateAdditionalAssignmentsForHITRequest) -> operations.CreateAdditionalAssignmentsForHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_additional_assignments_for_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateAdditionalAssignmentsForHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_hit(self, request: operations.CreateHITRequest) -> operations.CreateHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateHITResponse])
    ...
    def create_hit_type(self, request: operations.CreateHITTypeRequest) -> operations.CreateHITTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_hit_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateHITTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateHITTypeResponse])
    ...
    def create_hit_with_hit_type(self, request: operations.CreateHITWithHITTypeRequest) -> operations.CreateHITWithHITTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_hit_with_hit_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateHITWithHITTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateHITWithHITTypeResponse])
    ...
    def create_qualification_type(self, request: operations.CreateQualificationTypeRequest) -> operations.CreateQualificationTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_qualification_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateQualificationTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateQualificationTypeResponse])
    ...
    def create_worker_block(self, request: operations.CreateWorkerBlockRequest) -> operations.CreateWorkerBlockResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_worker_block_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateWorkerBlockResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_hit(self, request: operations.DeleteHITRequest) -> operations.DeleteHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_qualification_type(self, request: operations.DeleteQualificationTypeRequest) -> operations.DeleteQualificationTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_qualification_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteQualificationTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_worker_block(self, request: operations.DeleteWorkerBlockRequest) -> operations.DeleteWorkerBlockResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_worker_block_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteWorkerBlockResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def disassociate_qualification_from_worker(self, request: operations.DisassociateQualificationFromWorkerRequest) -> operations.DisassociateQualificationFromWorkerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disassociate_qualification_from_worker_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisassociateQualificationFromWorkerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_account_balance(self, request: operations.GetAccountBalanceRequest) -> operations.GetAccountBalanceResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetAccountBalanceResponse])
    ...
    def get_assignment(self, request: operations.GetAssignmentRequest) -> operations.GetAssignmentResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_assignment_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetAssignmentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetAssignmentResponse])
    ...
    def get_file_upload_url(self, request: operations.GetFileUploadURLRequest) -> operations.GetFileUploadURLResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_file_upload_url_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetFileUploadURLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetFileUploadURLResponse])
    ...
    def get_hit(self, request: operations.GetHITRequest) -> operations.GetHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetHITResponse])
    ...
    def get_qualification_score(self, request: operations.GetQualificationScoreRequest) -> operations.GetQualificationScoreResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_qualification_score_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetQualificationScoreResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetQualificationScoreResponse])
    ...
    def get_qualification_type(self, request: operations.GetQualificationTypeRequest) -> operations.GetQualificationTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_qualification_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetQualificationTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetQualificationTypeResponse])
    ...
    def list_assignments_for_hit(self, request: operations.ListAssignmentsForHITRequest) -> operations.ListAssignmentsForHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_assignments_for_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListAssignmentsForHITRequest, request)
        ...
        res = operations.ListAssignmentsForHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAssignmentsForHITResponse])
    ...
    def list_bonus_payments(self, request: operations.ListBonusPaymentsRequest) -> operations.ListBonusPaymentsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_bonus_payments_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListBonusPaymentsRequest, request)
        ...
        res = operations.ListBonusPaymentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListBonusPaymentsResponse])
    ...
    def list_hi_ts(self, request: operations.ListHITsRequest) -> operations.ListHITsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_hi_ts_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListHITsRequest, request)
        ...
        res = operations.ListHITsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListHITsResponse])
    ...
    def list_hi_ts_for_qualification_type(self, request: operations.ListHITsForQualificationTypeRequest) -> operations.ListHITsForQualificationTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_hi_ts_for_qualification_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListHITsForQualificationTypeRequest, request)
        ...
        res = operations.ListHITsForQualificationTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListHITsForQualificationTypeResponse])
    ...
    def list_qualification_requests(self, request: operations.ListQualificationRequestsRequest) -> operations.ListQualificationRequestsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_qualification_requests_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListQualificationRequestsRequest, request)
        ...
        res = operations.ListQualificationRequestsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListQualificationRequestsResponse])
    ...
    def list_qualification_types(self, request: operations.ListQualificationTypesRequest) -> operations.ListQualificationTypesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_qualification_types_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListQualificationTypesRequest, request)
        ...
        res = operations.ListQualificationTypesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListQualificationTypesResponse])
    ...
    def list_review_policy_results_for_hit(self, request: operations.ListReviewPolicyResultsForHITRequest) -> operations.ListReviewPolicyResultsForHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_review_policy_results_for_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListReviewPolicyResultsForHITRequest, request)
        ...
        res = operations.ListReviewPolicyResultsForHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListReviewPolicyResultsForHITResponse])
    ...
    def list_reviewable_hi_ts(self, request: operations.ListReviewableHITsRequest) -> operations.ListReviewableHITsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_reviewable_hi_ts_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListReviewableHITsRequest, request)
        ...
        res = operations.ListReviewableHITsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListReviewableHITsResponse])
    ...
    def list_worker_blocks(self, request: operations.ListWorkerBlocksRequest) -> operations.ListWorkerBlocksResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_worker_blocks_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListWorkerBlocksRequest, request)
        ...
        res = operations.ListWorkerBlocksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListWorkerBlocksResponse])
    ...
    def list_workers_with_qualification_type(self, request: operations.ListWorkersWithQualificationTypeRequest) -> operations.ListWorkersWithQualificationTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_workers_with_qualification_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListWorkersWithQualificationTypeRequest, request)
        ...
        res = operations.ListWorkersWithQualificationTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListWorkersWithQualificationTypeResponse])
    ...
    def notify_workers(self, request: operations.NotifyWorkersRequest) -> operations.NotifyWorkersResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "notify_workers_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.NotifyWorkersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.NotifyWorkersResponse])
    ...
    def reject_assignment(self, request: operations.RejectAssignmentRequest) -> operations.RejectAssignmentResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "reject_assignment_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RejectAssignmentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def reject_qualification_request(self, request: operations.RejectQualificationRequestRequest) -> operations.RejectQualificationRequestResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "reject_qualification_request_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RejectQualificationRequestResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def send_bonus(self, request: operations.SendBonusRequest) -> operations.SendBonusResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "send_bonus_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SendBonusResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def send_test_event_notification(self, request: operations.SendTestEventNotificationRequest) -> operations.SendTestEventNotificationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "send_test_event_notification_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SendTestEventNotificationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_expiration_for_hit(self, request: operations.UpdateExpirationForHITRequest) -> operations.UpdateExpirationForHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_expiration_for_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateExpirationForHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_hit_review_status(self, request: operations.UpdateHITReviewStatusRequest) -> operations.UpdateHITReviewStatusResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_hit_review_status_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateHITReviewStatusResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_hit_type_of_hit(self, request: operations.UpdateHITTypeOfHITRequest) -> operations.UpdateHITTypeOfHITResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_hit_type_of_hit_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateHITTypeOfHITResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_notification_settings(self, request: operations.UpdateNotificationSettingsRequest) -> operations.UpdateNotificationSettingsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_notification_settings_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def update_qualification_type(self, request: operations.UpdateQualificationTypeRequest) -> operations.UpdateQualificationTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_qualification_type_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateQualificationTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateQualificationTypeResponse])
