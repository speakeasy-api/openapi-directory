...
func (e VexAssessmentStateEnum) ToPointer() *VexAssessmentStateEnum {
	return &e
}
...
func (e *VexAssessmentStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "UNDER_INVESTIGATION":
		*e = VexAssessmentStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for VexAssessmentStateEnum: %v", v)
	}
}
