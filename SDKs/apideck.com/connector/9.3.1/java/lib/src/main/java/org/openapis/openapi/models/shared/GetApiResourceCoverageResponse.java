...
public class GetApiResourceCoverageResponse {
    ...
    public GetApiResourceCoverageResponse(@JsonProperty("data") ApiResourceCoverage data, @JsonProperty("status") String status, @JsonProperty("status_code") Long statusCode) {
        this.data = data;
        this.status = status;
        this.statusCode = statusCode;
  }
