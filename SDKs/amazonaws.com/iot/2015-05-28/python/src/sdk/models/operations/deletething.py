...
class DeleteThingRequest:
    headers: DeleteThingHeaders = dataclasses.field()
    path_params: DeleteThingPathParams = dataclasses.field()
    query_params: DeleteThingQueryParams = dataclasses.field()
...
class DeleteThingResponse:
    ...
    delete_thing_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
