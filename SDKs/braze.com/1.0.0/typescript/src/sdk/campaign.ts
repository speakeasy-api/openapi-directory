...
export class Campaign {
  ...
  campaignAnalytics(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CampaignAnalyticsResponse =
        new operations.CampaignAnalyticsResponse({
  ...
  campaignDetails(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CampaignDetailsResponse =
        new operations.CampaignDetailsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  campaignList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CampaignListResponse =
        new operations.CampaignListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  sendAnalytics(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SendAnalyticsResponse =
        new operations.SendAnalyticsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
