...
export enum RespondDecisionTaskCompletedXAmzTargetEnum {
  SimpleWorkflowServiceRespondDecisionTaskCompleted = "SimpleWorkflowService.RespondDecisionTaskCompleted",
}

export class RespondDecisionTaskCompletedRequest extends SpeakeasyBase {
...
export class RespondDecisionTaskCompletedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
