...
type SearchProjectStandardNameQueryParams struct {
	...
	// Aliases
	SearchProjectStandardNameAliases *string `queryParam:"style=form,explode=true,name=search.project_standard_name.aliases"`
	// Canonical Unit
	SearchProjectStandardNameUnit *string `queryParam:"style=form,explode=true,name=search.project_standard_name.unit"`
	// Number to skip
...
type SearchProjectStandardNameRequest struct {
	QueryParams SearchProjectStandardNameQueryParams
}

type SearchProjectStandardNameResponse struct {
	ContentType string
	StatusCode  int
