...
public class GetNumbersPrimeIsPellPrimeSecurity {
    ...
    public GetNumbersPrimeIsPellPrimeSecurity withXMathtoolsApiSecret(String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
        return this;
    }
    
    public GetNumbersPrimeIsPellPrimeSecurity(@JsonProperty("X-Mathtools-Api-Secret") String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
  }
}
