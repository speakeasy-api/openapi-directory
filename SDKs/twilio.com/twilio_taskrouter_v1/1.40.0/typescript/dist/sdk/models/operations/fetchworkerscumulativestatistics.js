...
exports.FetchWorkersCumulativeStatisticsResponse = exports.FetchWorkersCumulativeStatisticsRequest = exports.FetchWorkersCumulativeStatisticsSecurity = exports.FetchWorkersCumulativeStatisticsServerList = void 0;
...
var FetchWorkersCumulativeStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchWorkersCumulativeStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchWorkersCumulativeStatisticsSecurity.prototype, "username", void 0);
...
var FetchWorkersCumulativeStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchWorkersCumulativeStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchWorkersCumulativeStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchWorkersCumulativeStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchWorkersCumulativeStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkersCumulativeStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchWorkersCumulativeStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchWorkersCumulativeStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
