...
func (e ListUsersInGroupXAmzTargetEnum) ToPointer() *ListUsersInGroupXAmzTargetEnum {
	return &e
}
...
func (e *ListUsersInGroupXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSCognitoIdentityProviderService.ListUsersInGroup":
		*e = ListUsersInGroupXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListUsersInGroupXAmzTargetEnum: %v", v)
	}
}
