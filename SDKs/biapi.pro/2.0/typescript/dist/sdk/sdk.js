...
var pfm_1 = require("./pfm");
var providers_1 = require("./providers");
var timeline_1 = require("./timeline");
var usersmanagement_1 = require("./usersmanagement");
var axios_1 = __importDefault(require("axios"));
/**
 * Contains the list of servers available to the SDK
 */
exports.ServerList = ["//budgea.biapi.pro/2.0"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.administration = new administration_1.Administration(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.banks = new banks_1.Banks(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.pfm = new pfm_1.Pfm(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.usersManagement = new usersmanagement_1.UsersManagement(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
