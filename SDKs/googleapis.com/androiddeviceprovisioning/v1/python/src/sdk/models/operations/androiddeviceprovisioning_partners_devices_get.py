...
@dataclasses.dataclass
class AndroiddeviceprovisioningPartnersDevicesGetQueryParams:
...
class AndroiddeviceprovisioningPartnersDevicesGetRequest:
    path_params: AndroiddeviceprovisioningPartnersDevicesGetPathParams = dataclasses.field()
    query_params: AndroiddeviceprovisioningPartnersDevicesGetQueryParams = dataclasses.field()
