...
class UpdateIdentityProviderRequest:
    ...
    update_identity_provider_request: shared_updateidentityproviderrequest.UpdateIdentityProviderRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
