...
type RealtimebiddingBiddersPretargetingConfigsRemoveTargetedAppsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RealtimebiddingBiddersPretargetingConfigsRemoveTargetedAppsPathParams struct {
...
type RealtimebiddingBiddersPretargetingConfigsRemoveTargetedAppsQueryParams struct {
	// V1 error format.
...
type RealtimebiddingBiddersPretargetingConfigsRemoveTargetedAppsRequest struct {
	...
	Request     *shared.RemoveTargetedAppsRequest `request:"mediaType=application/json"`
	Security    RealtimebiddingBiddersPretargetingConfigsRemoveTargetedAppsSecurity
}

type RealtimebiddingBiddersPretargetingConfigsRemoveTargetedAppsResponse struct {
	ContentType string
	// Successful response
