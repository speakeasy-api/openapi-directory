...
type ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum string

const (
	ProxyModifyProductRatePlanChargeIncludeChildrenNSEnumYes ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum = "Yes"
	ProxyModifyProductRatePlanChargeIncludeChildrenNSEnumNo  ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum = "No"
)

func (e *ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Yes":
		fallthrough
	case "No":
		*e = ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum: %s", s)
	}
}

// ProxyModifyProductRatePlanChargeItemTypeNSEnum - Type of item that is created in NetSuite for the product rate plan charge. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).
type ProxyModifyProductRatePlanChargeItemTypeNSEnum string

const (
	ProxyModifyProductRatePlanChargeItemTypeNSEnumInventory    ProxyModifyProductRatePlanChargeItemTypeNSEnum = "Inventory"
	ProxyModifyProductRatePlanChargeItemTypeNSEnumNonInventory ProxyModifyProductRatePlanChargeItemTypeNSEnum = "Non Inventory"
	ProxyModifyProductRatePlanChargeItemTypeNSEnumService      ProxyModifyProductRatePlanChargeItemTypeNSEnum = "Service"
)

func (e *ProxyModifyProductRatePlanChargeItemTypeNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Non Inventory":
		fallthrough
	case "Service":
		*e = ProxyModifyProductRatePlanChargeItemTypeNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyProductRatePlanChargeItemTypeNSEnum: %s", s)
	}
}
...
type ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum string

const (
	ProxyModifyProductRatePlanChargePriceIncreaseOptionEnumFromTenantPercentageValue ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum = "FromTenantPercentageValue"
	ProxyModifyProductRatePlanChargePriceIncreaseOptionEnumSpecificPercentageValue   ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum = "SpecificPercentageValue"
)

func (e *ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "SpecificPercentageValue":
		*e = ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum: %s", s)
	}
}

// ProxyModifyProductRatePlanChargeRevRecEndNSEnum - End date condition of the corresponding item in NetSuite. Only available if you have installed the [Zuora Connector for NetSuite](https://www.zuora.com/connect/app/?appId=265).
type ProxyModifyProductRatePlanChargeRevRecEndNSEnum string

const (
	ProxyModifyProductRatePlanChargeRevRecEndNSEnumChargePeriodStart         ProxyModifyProductRatePlanChargeRevRecEndNSEnum = "Charge Period Start"
	ProxyModifyProductRatePlanChargeRevRecEndNSEnumRevRecTriggerDate         ProxyModifyProductRatePlanChargeRevRecEndNSEnum = "Rev Rec Trigger Date"
	ProxyModifyProductRatePlanChargeRevRecEndNSEnumUseNetSuiteRevRecTemplate ProxyModifyProductRatePlanChargeRevRecEndNSEnum = "Use NetSuite Rev Rec Template"
)

func (e *ProxyModifyProductRatePlanChargeRevRecEndNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Use NetSuite Rev Rec Template":
		*e = ProxyModifyProductRatePlanChargeRevRecEndNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyProductRatePlanChargeRevRecEndNSEnum: %s", s)
	}
}
...
type ProxyModifyProductRatePlanChargeRevRecStartNSEnum string

const (
	ProxyModifyProductRatePlanChargeRevRecStartNSEnumChargePeriodStart         ProxyModifyProductRatePlanChargeRevRecStartNSEnum = "Charge Period Start"
	ProxyModifyProductRatePlanChargeRevRecStartNSEnumRevRecTriggerDate         ProxyModifyProductRatePlanChargeRevRecStartNSEnum = "Rev Rec Trigger Date"
	ProxyModifyProductRatePlanChargeRevRecStartNSEnumUseNetSuiteRevRecTemplate ProxyModifyProductRatePlanChargeRevRecStartNSEnum = "Use NetSuite Rev Rec Template"
)

func (e *ProxyModifyProductRatePlanChargeRevRecStartNSEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "Rev Rec Trigger Date":
		fallthrough
	case "Use NetSuite Rev Rec Template":
		*e = ProxyModifyProductRatePlanChargeRevRecStartNSEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyProductRatePlanChargeRevRecStartNSEnum: %s", s)
	}
}
...
type ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum string

const (
	ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnumEndOfBillingPeriod ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum = "EndOfBillingPeriod"
	ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnumOnDemand           ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum = "OnDemand"
)

func (e *ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "EndOfBillingPeriod":
		fallthrough
	case "OnDemand":
		*e = ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum: %s", s)
	}
}

// ProxyModifyProductRatePlanCharge - Container for custom fields of a Product Rate Plan Charge object.
type ProxyModifyProductRatePlanCharge struct {
	...
	//
	IncludeChildrenNS *ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum `json:"IncludeChildren__NS,omitempty"`
	...
	//
	ItemTypeNS             *ProxyModifyProductRatePlanChargeItemTypeNSEnum `json:"ItemType__NS,omitempty"`
	...
	// Applies an automatic price change when a termed subscription is renewed.
	//
	PriceIncreaseOption *ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum `json:"PriceIncreaseOption,omitempty"`
	...
	//
	RevRecEndNS *ProxyModifyProductRatePlanChargeRevRecEndNSEnum `json:"RevRecEnd__NS,omitempty"`
	...
	//
	RevRecStartNS *ProxyModifyProductRatePlanChargeRevRecStartNSEnum `json:"RevRecStart__NS,omitempty"`
	...
	//
	UsageRecordRatingOption *ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum `json:"UsageRecordRatingOption,omitempty"`
