...
class DemilestonedIssueEvent:
    ...
    milestone: DemilestonedIssueEventMilestone = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('milestone') }})  
