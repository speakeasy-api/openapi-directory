...
from ..shared import monitoringalerthistorysortkey_enum as shared_monitoringalerthistorysortkey_enum
...
class ListMonitoringAlertHistoryRequest:
    ...
    sort_by: Optional[shared_monitoringalerthistorysortkey_enum.MonitoringAlertHistorySortKeyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    ...
    status_equals: Optional[shared_monitoringalertstatus_enum.MonitoringAlertStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
