...
var resourceshareinvitationstatusenum_1 = require("./resourceshareinvitationstatusenum");
...
var ResourceShareInvitation = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=invitationTimestamp" }),
        __metadata("design:type", Date)
    ], ResourceShareInvitation.prototype, "invitationTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=receiverAccountId" }),
        __metadata("design:type", String)
    ], ResourceShareInvitation.prototype, "receiverAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=receiverArn" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resourceShareAssociations" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=senderAccountId" }),
        __metadata("design:type", String)
