...
exports.GetBlobsResponse = exports.GetBlobsRequest = exports.GetBlobs200ApplicationJson = exports.GetBlobsQueryParams = void 0;
...
var GetBlobsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=blob_key" }),
        __metadata("design:type", String)
    ], GetBlobsQueryParams.prototype, "blobKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=content_type" }),
        __metadata("design:type", String)
    ], GetBlobsQueryParams.prototype, "contentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filename" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=time_last_accessed" }),
        __metadata("design:type", String)
...
exports.GetBlobsQueryParams = GetBlobsQueryParams;
var GetBlobs200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=results", elemType: shared.Blob }),
