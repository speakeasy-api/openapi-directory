...
export class PostVolumesIdActionsDetachActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PostVolumesIdActionsDetachActionResponseActionError)
  ...
  @Type(() => PostVolumesIdActionsDetachActionResponseActionResources)
...
export class PostVolumesIdActionsDetachActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => PostVolumesIdActionsDetachActionResponseAction)
