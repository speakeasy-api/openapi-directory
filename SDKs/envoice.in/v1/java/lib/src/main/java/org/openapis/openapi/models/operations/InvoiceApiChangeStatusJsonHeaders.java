...
public class InvoiceApiChangeStatusJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiChangeStatusJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiChangeStatusJsonHeaders withXAuthSecret(String xAuthSecret) {
