...
class ListCredentialListCredentialResponse:
    credentials: Optional[list[shared_chat_v2_credential.ChatV2Credential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('credentials') }})
