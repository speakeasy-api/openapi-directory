...
from ..shared import updateprimaryemailaddressrequest as shared_updateprimaryemailaddressrequest
...
class UpdatePrimaryEmailAddressHeaders:
    x_amz_target: UpdatePrimaryEmailAddressXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdatePrimaryEmailAddressRequest:
    headers: UpdatePrimaryEmailAddressHeaders = dataclasses.field()
    request: shared_updateprimaryemailaddressrequest.UpdatePrimaryEmailAddressRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdatePrimaryEmailAddressResponse:
    ...
    update_primary_email_address_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
