...
class UpdateDomainRequestBodyMatching:
    r"""UpdateDomainRequestBodyMatching
...
class UpdateDomainRequestBody:
    ...
    matching: Optional[UpdateDomainRequestBodyMatching] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Matching') }})
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Tags') }})
    

@dataclasses.dataclass
class UpdateDomainRequest:
    headers: UpdateDomainHeaders = dataclasses.field()
    path_params: UpdateDomainPathParams = dataclasses.field()
    request: UpdateDomainRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
