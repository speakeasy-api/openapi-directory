...
export declare class PhoneCallQueues {
    ...
    **/
    addMembersToCallQueue(req: operations.AddMembersToCallQueueRequest, config?: AxiosRequestConfig): Promise<operations.AddMembersToCallQueueResponse>;
    /**
     ...
     *
    **/
    assignPhoneToCallQueue(req: operations.AssignPhoneToCallQueueRequest, config?: AxiosRequestConfig): Promise<operations.AssignPhoneToCallQueueResponse>;
    /**
     ...
     *
    **/
    changeCallQueueManager(req: operations.ChangeCallQueueManagerRequest, config?: AxiosRequestConfig): Promise<operations.ChangeCallQueueManagerResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`
    **/
    createCallQueue(req: operations.CreateCallQueueRequest, config?: AxiosRequestConfig): Promise<operations.CreateCallQueueResponse>;
    /**
     ...
     *
    **/
    deleteACallQueue(req: operations.DeleteACallQueueRequest, config?: AxiosRequestConfig): Promise<operations.DeleteACallQueueResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`
    **/
    getACallQueue(req: operations.GetACallQueueRequest, config?: AxiosRequestConfig): Promise<operations.GetACallQueueResponse>;
    /**
    ...
    **/
     ...
     *
    **/
    listCallQueues(req: operations.ListCallQueuesRequest, config?: AxiosRequestConfig): Promise<operations.ListCallQueuesResponse>;
    /**
     ...
     *
    **/
    unAssignPhoneNumCallQueue(req: operations.UnAssignPhoneNumCallQueueRequest, config?: AxiosRequestConfig): Promise<operations.UnAssignPhoneNumCallQueueResponse>;
    /**
     ...
     *
    **/
    unassignAPhoneNumCallQueue(req: operations.UnassignAPhoneNumCallQueueRequest, config?: AxiosRequestConfig): Promise<operations.UnassignAPhoneNumCallQueueResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`
    **/
    unassignAllMembers(req: operations.UnassignAllMembersRequest, config?: AxiosRequestConfig): Promise<operations.UnassignAllMembersResponse>;
    /**
     ...
     *
    **/
    unassignMemberFromCallQueue(req: operations.UnassignMemberFromCallQueueRequest, config?: AxiosRequestConfig): Promise<operations.UnassignMemberFromCallQueueResponse>;
    /**
     ...
     *
    **/
    updateCallQueue(req: operations.UpdateCallQueueRequest, config?: AxiosRequestConfig): Promise<operations.UpdateCallQueueResponse>;
}
