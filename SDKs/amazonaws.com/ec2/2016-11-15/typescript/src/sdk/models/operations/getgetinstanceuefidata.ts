...
export enum GETGETInstanceUefiDataActionEnum {
  GetInstanceUefiData = "GetInstanceUefiData",
}

export enum GETGETInstanceUefiDataVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETGETInstanceUefiDataRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETGETInstanceUefiDataResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
