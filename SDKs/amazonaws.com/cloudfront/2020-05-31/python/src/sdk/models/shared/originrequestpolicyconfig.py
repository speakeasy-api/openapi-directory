...
class OriginRequestPolicyConfig:
    ...
    cookies_config: shared_originrequestpolicycookiesconfig.OriginRequestPolicyCookiesConfig = dataclasses.field()
    headers_config: shared_originrequestpolicyheadersconfig.OriginRequestPolicyHeadersConfig = dataclasses.field()
    name: str = dataclasses.field()
    query_strings_config: shared_originrequestpolicyquerystringsconfig.OriginRequestPolicyQueryStringsConfig = dataclasses.field()
