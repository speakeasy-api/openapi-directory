...
class CountPendingActivityTasksRequest:
    ...
    count_pending_activity_tasks_input: shared_countpendingactivitytasksinput.CountPendingActivityTasksInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
