...
class RemarketingList:
    ...
    life_span: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('lifeSpan') }})
    list_population_rule: Optional[shared_listpopulationrule.ListPopulationRule] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('listPopulationRule') }})
    list_size: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('listSize') }})
    list_source: Optional[RemarketingListListSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('listSource') }})
