...
var Edit = /** @class */ (function () {
    function Edit(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Edit.prototype.getRender = function (req, config) {
    ...
    **/
    Edit.prototype.postRender = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
