...
class DrivelabelsLabelsCreateRequest:
    ...
    google_apps_drive_labels_v2beta_label_input: Optional[shared_googleappsdrivelabelsv2betalabel.GoogleAppsDriveLabelsV2betaLabelInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""The BCP-47 language code to use for evaluating localized Field labels in response. When not specified, values in the default configured language will be used."""  
    ...
    r"""Set to `true` in order to use the user's admin privileges. The server will verify the user is an admin before allowing access."""  
