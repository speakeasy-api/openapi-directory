...
class GetOrganisationsPartyIDElectronicAddressesRequest:
...
@dataclasses.dataclass
class GetOrganisationsPartyIDElectronicAddressesResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    electronic_addresses: Optional[list[shared_electronic_address.ElectronicAddress]] = dataclasses.field(default=None)
    r"""Electronic addresses were retrieved successfully"""  
