...
export class CloudsupportProjectsCasesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudsupportProjectsCasesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudsupportProjectsCasesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
