...
func (s *dealItem) GetDealItems(ctx context.Context, request operations.GetDealItemsRequest, security operations.GetDealItemsSecurity) (*operations.GetDealItemsResponse, error) {
	baseURL := s.serverURL
