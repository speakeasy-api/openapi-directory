...
class Error404AISAdditionalErrors:
    ...
    code: shared_messagecode404_ais_enum.MessageCode404AISEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
...
class Error404AIS:
    ...
    additional_errors: Optional[list[Error404AISAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
