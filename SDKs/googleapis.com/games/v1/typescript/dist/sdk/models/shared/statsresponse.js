...
var StatsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=avg_session_length_minutes" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "avgSessionLengthMinutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=churn_probability" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "churnProbability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=days_since_last_played" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "daysSinceLastPlayed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=high_spender_probability" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=num_purchases" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "numPurchases", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=num_sessions" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "numSessions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=num_sessions_percentile" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "numSessionsPercentile", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=spend_percentile" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "spendPercentile", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=spend_probability" }),
        __metadata("design:type", Number)
    ], StatsResponse.prototype, "spendProbability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_spend_next_28_days" }),
        __metadata("design:type", Number)
