...
public class Projects {
    ...
    **/
    public openapisdk.models.operations.WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionResponse workflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecution(openapisdk.models.operations.WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/{workflow}:triggerPubsubExecution", request.pathParams);
        ...
        openapisdk.models.operations.WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionResponse res = new openapisdk.models.operations.WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionResponse() {{
            execution = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
