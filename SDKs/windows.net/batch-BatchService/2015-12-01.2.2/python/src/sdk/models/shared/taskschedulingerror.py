...
class TaskSchedulingErrorCategoryEnum(str, Enum):
    r"""Gets or sets the category of the task scheduling error."""
    USERERROR = 'usererror'
...
class TaskSchedulingError:
    ...
    r"""Gets or sets an identifier for the task scheduling error.  Codes are invariant and are intended to be consumed programmatically."""  
    ...
    r"""Gets or sets the list of additional error details related to the scheduling error."""  
    message: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message'), 'exclude': lambda f: f is None }})
    r"""Gets or sets a message describing the task scheduling error, intended to be suitable for display in a user interface."""  
