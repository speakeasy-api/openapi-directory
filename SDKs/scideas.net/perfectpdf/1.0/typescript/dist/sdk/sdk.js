 ...
 */
exports.ServerList = ["https://services.scideas.net"];
/**
...
var SDK = /** @class */ (function () {
     ...
     */
    SDK.prototype.postPerfectpdfApi = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.PerfectpdfApiBody(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/perfectpdf/api";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostPerfectpdfApiResponse({
