...
public class TariffPriceAPI {
    ...
    public org.openapis.openapi.models.operations.TariffSlph0Response tariffSlph0(org.openapis.openapi.models.operations.TariffSlph0Request request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.TariffSlph0QueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.TariffcomponentsResponse tariffcomponents(org.openapis.openapi.models.operations.TariffcomponentsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.TariffcomponentsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
