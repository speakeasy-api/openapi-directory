...
export class PostAnnotateQueryParams extends SpeakeasyBase {
...
export class PostAnnotateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: PostAnnotateQueryParams;
}


export class PostAnnotateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
