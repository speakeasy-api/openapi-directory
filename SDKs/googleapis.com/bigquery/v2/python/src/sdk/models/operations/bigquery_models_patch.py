...
class BigqueryModelsPatchSecurity:
    ...
    option1: Optional[BigqueryModelsPatchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[BigqueryModelsPatchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class BigqueryModelsPatchRequest:
    ...
    r"""Required. Dataset ID of the model to patch."""  
    model_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'modelId', 'style': 'simple', 'explode': False }})
    r"""Required. Model ID of the model to patch."""  
    project_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'projectId', 'style': 'simple', 'explode': False }})
    r"""Required. Project ID of the model to patch."""  
