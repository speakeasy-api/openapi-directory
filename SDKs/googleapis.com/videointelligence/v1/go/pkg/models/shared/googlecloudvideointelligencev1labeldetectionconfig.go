...
func (e GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum) ToPointer() *GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum {
	return &e
}

func (e *GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "SHOT_AND_FRAME_MODE":
		*e = GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum: %v", v)
	}
}
