...
public class DeleteUserDefinedMessageSubscriptionRequest {
    ...
    public DeleteUserDefinedMessageSubscriptionRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CallSid") String callSid, @JsonProperty("Sid") String sid) {
        this.accountSid = accountSid;
        this.callSid = callSid;
        this.sid = sid;
  }
