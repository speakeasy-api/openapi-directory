...
public class GoogleCloudRetailV2UserEvent {
    ...
    public GoogleCloudRetailV2UserEvent withAttributes(java.util.Map<String, GoogleCloudRetailV2CustomAttribute> attributes) {
    ...
    public GoogleCloudRetailV2UserEvent withAttributionToken(String attributionToken) {
    ...
    public GoogleCloudRetailV2UserEvent withCartId(String cartId) {
        this.cartId = cartId;
        return this;
    }
    ...
    public GoogleCloudRetailV2UserEvent withCompletionDetail(GoogleCloudRetailV2CompletionDetail completionDetail) {
    ...
    public GoogleCloudRetailV2UserEvent withEntity(String entity) {
        this.entity = entity;
        return this;
    }
    ...
    public GoogleCloudRetailV2UserEvent withEventTime(String eventTime) {
    ...
    public GoogleCloudRetailV2UserEvent withEventType(String eventType) {
    ...
    public GoogleCloudRetailV2UserEvent withExperimentIds(String[] experimentIds) {
    ...
    public GoogleCloudRetailV2UserEvent withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GoogleCloudRetailV2UserEvent withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GoogleCloudRetailV2UserEvent withOrderBy(String orderBy) {
    ...
    public GoogleCloudRetailV2UserEvent withPageCategories(String[] pageCategories) {
    ...
    public GoogleCloudRetailV2UserEvent withPageViewId(String pageViewId) {
    ...
    public GoogleCloudRetailV2ProductDetail[] productDetails;

    public GoogleCloudRetailV2UserEvent withProductDetails(GoogleCloudRetailV2ProductDetail[] productDetails) {
    ...
    public GoogleCloudRetailV2UserEvent withPurchaseTransaction(GoogleCloudRetailV2PurchaseTransaction purchaseTransaction) {
    ...
    public GoogleCloudRetailV2UserEvent withReferrerUri(String referrerUri) {
    ...
    public GoogleCloudRetailV2UserEvent withSearchQuery(String searchQuery) {
    ...
    public GoogleCloudRetailV2UserEvent withSessionId(String sessionId) {
    ...
    public GoogleCloudRetailV2UserEvent withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public GoogleCloudRetailV2UserEvent withUserInfo(GoogleCloudRetailV2UserInfo userInfo) {
    ...
    public GoogleCloudRetailV2UserEvent withVisitorId(String visitorId) {
