...
func New(opts ...SDKOption) *SDK {
	...
	sdk.BucketAccessControls = NewBucketAccessControls(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.DefaultObjectAccessControls = NewDefaultObjectAccessControls(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
	...
	sdk.ObjectAccessControls = NewObjectAccessControls(
		sdk._defaultClient,
		sdk._securityClient,
		sdk._serverURL,
		sdk._language,
