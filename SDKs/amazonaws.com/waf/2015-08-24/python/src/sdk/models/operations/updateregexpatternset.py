...
class UpdateRegexPatternSetRequest:
    ...
    update_regex_pattern_set_request: shared_updateregexpatternsetrequest.UpdateRegexPatternSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateRegexPatternSetResponse:
    ...
    r"""WAFInvalidRegexPatternException"""  
