...
type UpdateAppVersionAppComponentHeaders struct {
...
type UpdateAppVersionAppComponentRequest struct {
	Headers UpdateAppVersionAppComponentHeaders
	Request UpdateAppVersionAppComponentRequestBody `request:"mediaType=application/json"`
}
