...
class SearchTypeDocumentCsvQueryParams:
...
@dataclasses.dataclass
class SearchTypeDocumentCsvRequest:
    query_params: SearchTypeDocumentCsvQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeDocumentCsvResponse:
