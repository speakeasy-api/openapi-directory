...
from ..shared import pricing_v2_voice_voice_country_instance as shared_pricing_v2_voice_voice_country_instance
...
class FetchVoiceCountryResponse:
    ...
    pricing_v2_voice_voice_country_instance: Optional[shared_pricing_v2_voice_voice_country_instance.PricingV2VoiceVoiceCountryInstance] = dataclasses.field(default=None)
