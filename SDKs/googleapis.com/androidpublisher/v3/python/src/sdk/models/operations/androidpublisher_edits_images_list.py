...
from ..shared import security as shared_security
from ..shared import imageslistresponse as shared_imageslistresponse
...
class AndroidpublisherEditsImagesListPathParams:
    ...
    image_type: AndroidpublisherEditsImagesListImageTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'imageType', 'style': 'simple', 'explode': False }})
...
@dataclasses.dataclass
class AndroidpublisherEditsImagesListQueryParams:
...
class AndroidpublisherEditsImagesListRequest:
    path_params: AndroidpublisherEditsImagesListPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsImagesListQueryParams = dataclasses.field()
    security: AndroidpublisherEditsImagesListSecurity = dataclasses.field()
...
class AndroidpublisherEditsImagesListResponse:
    ...
    images_list_response: Optional[shared_imageslistresponse.ImagesListResponse] = dataclasses.field(default=None)
