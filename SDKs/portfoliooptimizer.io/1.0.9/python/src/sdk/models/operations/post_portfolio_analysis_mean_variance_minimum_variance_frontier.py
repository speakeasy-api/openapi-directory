...
class PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontierRequestBody:
    ...
    constraints: Optional[PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontierRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
    ...
    r"""The number of portfolios to compute on the mean-variance minimum variance frontier"""  
...
class PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontier200ApplicationJSON:
    ...
    portfolios: list[PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontier200ApplicationJSONPortfolios] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portfolios') }})  
