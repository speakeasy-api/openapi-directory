...
public class VcdVmSnapshotSummary {
    ...
    public VcdVmSnapshotSummary withIndexState(Long indexState) {
    ...
    public VcdVmSnapshotSummary withVcdVmMoid(String vcdVmMoid) {
    ...
    public VcdVmSnapshotSummary withVcenterVmId(String vcenterVmId) {
    ...
    public VcdVmSnapshotSummary withVmName(String vmName) {
        this.vmName = vmName;
        return this;
    }
    ...
    public VcdVmSnapshotSummary withVmSnapshotId(String vmSnapshotId) {
        this.vmSnapshotId = vmSnapshotId;
        return this;
    }
    
    public VcdVmSnapshotSummary(@JsonProperty("vcdVmMoid") String vcdVmMoid, @JsonProperty("vcenterVmId") String vcenterVmId, @JsonProperty("vmName") String vmName, @JsonProperty("vmSnapshotId") String vmSnapshotId) {
        this.vcdVmMoid = vcdVmMoid;
        this.vcenterVmId = vcenterVmId;
        this.vmName = vmName;
        this.vmSnapshotId = vmSnapshotId;
