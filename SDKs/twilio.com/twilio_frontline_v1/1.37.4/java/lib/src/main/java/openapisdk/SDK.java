    ...
    public openapisdk.models.operations.FetchUserResponse fetchUser(openapisdk.models.operations.FetchUserRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.FrontlineV1User out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.FrontlineV1User.class);
