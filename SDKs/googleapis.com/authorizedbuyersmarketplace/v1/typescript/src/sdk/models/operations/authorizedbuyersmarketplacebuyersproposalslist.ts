...
export class AuthorizedbuyersmarketplaceBuyersProposalsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersProposalsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersProposalsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
