...
class GetRepositoriesWorkspaceRepoSlugPatchSpecRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPatchSpecPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugPatchSpecSecurity = dataclasses.field()
