...
export class RemotebuildexecutionProjectsInstancesWorkerpoolsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RemotebuildexecutionProjectsInstancesWorkerpoolsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RemotebuildexecutionProjectsInstancesWorkerpoolsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
