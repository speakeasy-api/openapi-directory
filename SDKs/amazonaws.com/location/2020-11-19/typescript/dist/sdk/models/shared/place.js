...
var placegeometry_1 = require("./placegeometry");
...
var Place = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return placegeometry_1.PlaceGeometry; }),
        __metadata("design:type", placegeometry_1.PlaceGeometry)
    ], Place.prototype, "geometry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Interpolated" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "UnitNumber" }),
        __metadata("design:type", String)
