...
from ..shared import algorithmsortby_enum as shared_algorithmsortby_enum
...
class ListAlgorithmsInput:
    ...
    sort_by: Optional[shared_algorithmsortby_enum.AlgorithmSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
