...
class Fleet:
    ...
    state: Optional[shared_fleetlifecyclestate.FleetLifecycleState] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
