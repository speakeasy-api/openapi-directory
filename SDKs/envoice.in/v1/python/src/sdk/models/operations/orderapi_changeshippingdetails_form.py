...
class OrderAPIChangeShippingDetailsFormRequest:
    ...
    order_shipping_details_api_model: shared_ordershippingdetailsapimodel.OrderShippingDetailsAPIModel = dataclasses.field(metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
...
@dataclasses.dataclass
class OrderAPIChangeShippingDetailsFormResponse:
