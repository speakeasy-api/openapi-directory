...
public class GetDirectionsOutputFormatRequest {
    ...
    public GetDirectionsOutputFormatRequest withCorrectSide(Boolean correctSide) {
    ...
    public GetDirectionsOutputFormatRequest withCriteria(GetDirectionsOutputFormatCriteriaEnum criteria) {
    ...
    public GetDirectionsOutputFormatRequest withDeparture(OffsetDateTime departure) {
    ...
    public GetDirectionsOutputFormatRequest withDisable(String disable) {
    ...
    public GetDirectionsOutputFormatRequest withDistanceUnit(GetDirectionsOutputFormatDistanceUnitEnum distanceUnit) {
    ...
    public GetDirectionsOutputFormatRequest withOutputFormat(GetDirectionsOutputFormatOutputFormatEnum outputFormat) {
    ...
    public GetDirectionsOutputFormatRequest withOutputSRS(GetDirectionsOutputFormatOutputSrsEnum outputSRS) {
    ...
    public GetDirectionsOutputFormatRequest withPoints(String points) {
        this.points = points;
        return this;
    }
    ...
    public GetDirectionsOutputFormatRequest withRoundTrip(Boolean roundTrip) {
    ...
    public GetDirectionsOutputFormatRequest withRouteDescription(String routeDescription) {
        this.routeDescription = routeDescription;
        return this;
    }
    
    public GetDirectionsOutputFormatRequest(@JsonProperty("outputFormat") GetDirectionsOutputFormatOutputFormatEnum outputFormat, @JsonProperty("points") String points) {
        this.outputFormat = outputFormat;
        this.points = points;
  }
}
