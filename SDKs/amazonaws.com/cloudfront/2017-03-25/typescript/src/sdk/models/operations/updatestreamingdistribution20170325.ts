 ...
 */
export class UpdateStreamingDistribution20170325RequestBodyStreamingDistributionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateStreamingDistribution20170325RequestBody extends SpeakeasyBase {
  /**
   * The RTMP distribution's configuration information.
   */
  @SpeakeasyMetadata()
