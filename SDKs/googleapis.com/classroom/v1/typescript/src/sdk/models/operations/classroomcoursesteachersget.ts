...
export class ClassroomCoursesTeachersGetSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClassroomCoursesTeachersGetSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ClassroomCoursesTeachersGetSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ClassroomCoursesTeachersGetSecurityOption4 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ClassroomCoursesTeachersGetSecurity extends SpeakeasyBase {
...
export class ClassroomCoursesTeachersGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClassroomCoursesTeachersGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
