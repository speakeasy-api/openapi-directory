...
@dataclasses.dataclass
class ToolresultsProjectsHistoriesExecutionsStepsGetQueryParams:
...
class ToolresultsProjectsHistoriesExecutionsStepsGetRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsGetPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsGetQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsStepsGetSecurity = dataclasses.field()
