...
* [lpgsv](#lpgsv) - LPG Subscription Voucher
* [lpgtv](#lpgtv) - Termination Voucher
...
use \OpenAPI\OpenAPI\Models\Operations\LpgsvRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\LpgsvRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\LpgsvRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\LpgsvSecurity;
...
try {
    ...
    $request->certificateParameters = new LpgsvRequestBodyCertificateParameters();
    ...
    $request->format = LpgsvRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new LpgsvSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->lpgsv($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\LpgtvRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\LpgtvRequestBodyCertificateParameters;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchema;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsent;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentData;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentDataConsumer;
...
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentUser;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaSignature;
use \OpenAPI\OpenAPI\Models\Operations\LpgtvRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\LpgtvSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new LpgtvRequestBody();
    $request->certificateParameters = new LpgtvRequestBodyCertificateParameters();
    $request->certificateParameters->uid = '123412341234';
    $request->consentArtifact = new ConsentArtifactSchema();
    $request->consentArtifact->consent = new ConsentArtifactSchemaConsent();
    $request->consentArtifact->consent->consentId = 'ea9c43aa-7f5a-4bf3-a0be-e1caa24737ba';
    ...
    $request->format = LpgtvRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new LpgtvSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->lpgtv($request, $requestSecurity);
