...
public class RejectedPaymentV3 {
    ...
    public RejectedPaymentV3(@JsonProperty("amount") Long amount, @JsonProperty("currencyType") String currencyType, @JsonProperty("payorPaymentId") String payorPaymentId, @JsonProperty("reason") String reason, @JsonProperty("remoteId") String remoteId, @JsonProperty("sourceAccountName") String sourceAccountName) {
        this.amount = amount;
        this.currencyType = currencyType;
        this.payorPaymentId = payorPaymentId;
        this.reason = reason;
