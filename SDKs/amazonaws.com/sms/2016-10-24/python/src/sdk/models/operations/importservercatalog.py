...
class ImportServerCatalogHeaders:
    x_amz_target: ImportServerCatalogXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ImportServerCatalogRequest:
    headers: ImportServerCatalogHeaders = dataclasses.field()
...
class ImportServerCatalogResponse:
    ...
    import_server_catalog_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
