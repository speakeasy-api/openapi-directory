...
class Documents 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\LanguageDocumentsAnalyzeEntitiesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/documents:analyzeEntities');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/documents:analyzeEntitySentiment');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/documents:analyzeSentiment');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/documents:analyzeSyntax');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/documents:annotateText');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta2/documents:classifyText');
