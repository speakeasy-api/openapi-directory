...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            AlsfcResponse res = sdk.apIs.alsfc(req, new AlsfcSecurity("maiores", "molestiae") {{
    ...
    public static void main(String[] args) {
        try {
            ...
            ClcerRequestBody req = new ClcerRequestBody(ClcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new ClcerRequestBodyCertificateParameters("123412341234", "SAS2F2803");;
            ...
            ClcerResponse res = sdk.apIs.clcer(req, new ClcerSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            SrcerRequestBody req = new SrcerRequestBody(SrcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SrcerRequestBodyCertificateParameters("123412341234", "SAS2F2803");;
            ...
            SrcerResponse res = sdk.apIs.srcer(req, new SrcerSecurity("iure", "saepe") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
