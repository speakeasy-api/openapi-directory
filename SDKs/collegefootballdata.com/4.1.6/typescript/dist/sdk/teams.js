...
var Teams = /** @class */ (function () {
    ...
    **/
    Teams.prototype.getFbsTeams = function (req, config) {
     ...
     * Roster data
    **/
    Teams.prototype.getRoster = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Teams.prototype.getTalent = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Matchup history
    **/
    Teams.prototype.getTeamMatchup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
