...
from ..shared import listbranchesresult as shared_listbranchesresult
...
class ListBranchesResponse:
    ...
    list_branches_result: Optional[shared_listbranchesresult.ListBranchesResult] = dataclasses.field(default=None)
