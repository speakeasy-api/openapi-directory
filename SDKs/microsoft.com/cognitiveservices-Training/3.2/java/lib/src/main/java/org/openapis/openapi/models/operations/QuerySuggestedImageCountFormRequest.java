...
public class QuerySuggestedImageCountFormRequest {
    ...
    public QuerySuggestedImageCountFormRequest(@JsonProperty("TagFilter") org.openapis.openapi.models.shared.TagFilter tagFilter, @JsonProperty("iterationId") String iterationId, @JsonProperty("projectId") String projectId) {
        this.tagFilter = tagFilter;
        this.iterationId = iterationId;
        this.projectId = projectId;
  }
