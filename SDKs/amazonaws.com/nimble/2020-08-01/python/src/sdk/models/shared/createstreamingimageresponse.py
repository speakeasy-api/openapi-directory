...
class CreateStreamingImageResponse:
    streaming_image: Optional[CreateStreamingImageResponseStreamingImage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('streamingImage') }})
