...
from ..shared import episodeminimum as shared_episodeminimum
...
class PodcastFull:
    ...
    episodes: Optional[list[shared_episodeminimum.EpisodeMinimum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('episodes') }})
    ...
    next_episode_pub_date: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('next_episode_pub_date') }})
