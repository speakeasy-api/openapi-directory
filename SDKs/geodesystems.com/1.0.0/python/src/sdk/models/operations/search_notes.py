...
class SearchNotesQueryParams:
    ...
    search_db_notes_note: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_notes.note', 'style': 'form', 'explode': True }})
...
class SearchNotesRequest:
    query_params: SearchNotesQueryParams = dataclasses.field()
