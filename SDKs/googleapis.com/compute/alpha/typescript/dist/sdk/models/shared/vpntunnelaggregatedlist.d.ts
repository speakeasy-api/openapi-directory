...
import { VpnTunnelsScopedList } from "./vpntunnelsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum VpnTunnelAggregatedListWarningCodeEnum {
...
export declare class VpnTunnelAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class VpnTunnelAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: VpnTunnelAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: VpnTunnelAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class VpnTunnelAggregatedList extends SpeakeasyBase {
    /**
