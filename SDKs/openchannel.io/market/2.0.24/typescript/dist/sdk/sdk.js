...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.customGatewayProcessPaymentsAndRefunds = new customgatewayprocesspaymentsandrefunds_1.CustomGatewayProcessPaymentsAndRefunds(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.developerAccountsFindAndModifyDeveloperAccounts = new developeraccountsfindandmodifydeveloperaccounts_1.DeveloperAccountsFindAndModifyDeveloperAccounts(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.developersFindAndModifyDevelopers = new developersfindandmodifydevelopers_1.DevelopersFindAndModifyDevelopers(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.permissionAddAndRemovePermissions = new permissionaddandremovepermissions_1.PermissionAddAndRemovePermissions(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.stripeGatewayProcessPaymentsAndRefunds = new stripegatewayprocesspaymentsandrefunds_1.StripeGatewayProcessPaymentsAndRefunds(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.transactionsFindPaymentsAndRefunds = new transactionsfindpaymentsandrefunds_1.TransactionsFindPaymentsAndRefunds(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.userAccountsFindAndModifyUserAccounts = new useraccountsfindandmodifyuseraccounts_1.UserAccountsFindAndModifyUserAccounts(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
