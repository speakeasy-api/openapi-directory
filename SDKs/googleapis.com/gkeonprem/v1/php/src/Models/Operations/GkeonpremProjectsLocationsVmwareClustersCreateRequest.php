...
class GkeonpremProjectsLocationsVmwareClustersCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\VmwareClusterInput $vmwareClusterInput = null;
