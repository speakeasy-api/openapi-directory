...
class DeleteAccountAccessConsentsConsentIDRequest:
    headers: DeleteAccountAccessConsentsConsentIDHeaders = dataclasses.field()
    path_params: DeleteAccountAccessConsentsConsentIDPathParams = dataclasses.field()
    security: DeleteAccountAccessConsentsConsentIDSecurity = dataclasses.field()
