...
public class GetSubstanceParticipantInAssociationsQueryParams {
    /**
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public Long rows;
    public GetSubstanceParticipantInAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetSubstanceParticipantInAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public Long start;
    public GetSubstanceParticipantInAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetSubstanceParticipantInAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
