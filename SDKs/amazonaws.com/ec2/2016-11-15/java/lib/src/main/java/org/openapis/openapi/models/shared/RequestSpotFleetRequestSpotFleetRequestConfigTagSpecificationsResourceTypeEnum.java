 ...
 */
public enum RequestSpotFleetRequestSpotFleetRequestConfigTagSpecificationsResourceTypeEnum {
    ...
    private RequestSpotFleetRequestSpotFleetRequestConfigTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
