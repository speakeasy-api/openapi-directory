...
public class Tabledata {
	...
	public Tabledata(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.BigqueryTabledataInsertAllResponse bigqueryTabledataInsertAll(org.openapis.openapi.models.operations.BigqueryTabledataInsertAllRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.TableDataInsertAllResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.TableDataInsertAllResponse.class);
    ...
    public org.openapis.openapi.models.operations.BigqueryTabledataListResponse bigqueryTabledataList(org.openapis.openapi.models.operations.BigqueryTabledataListRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.TableDataList out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.TableDataList.class);
