...
class SearchBoulderEmailsQueryParams:
    ...
    search_db_boulder_emails_email_subject: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_boulder_emails.email_subject', 'style': 'form', 'explode': True }})
    search_db_boulder_emails_plain_text_body: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_boulder_emails.plain_text_body', 'style': 'form', 'explode': True }})
    search_db_boulder_emails_received_date: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_boulder_emails.received_date', 'style': 'form', 'explode': True }})
    search_db_boulder_emails_sent_cc: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_boulder_emails.sent_cc', 'style': 'form', 'explode': True }})
    search_db_boulder_emails_sent_from: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_boulder_emails.sent_from', 'style': 'form', 'explode': True }})
    search_db_boulder_emails_sent_to: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_boulder_emails.sent_to', 'style': 'form', 'explode': True }})
...
class SearchBoulderEmailsRequest:
    query_params: SearchBoulderEmailsQueryParams = dataclasses.field()
