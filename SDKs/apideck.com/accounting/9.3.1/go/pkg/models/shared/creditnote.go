...
func (e CreditNoteAllocationsAllocationTypeEnum) ToPointer() *CreditNoteAllocationsAllocationTypeEnum {
	return &e
}
...
func (e *CreditNoteAllocationsAllocationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "over_payment":
		fallthrough
	case "pre_payment":
		*e = CreditNoteAllocationsAllocationTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreditNoteAllocationsAllocationTypeEnum: %v", v)
	}
}
...
func (e CreditNoteCreditNoteStatusEnum) ToPointer() *CreditNoteCreditNoteStatusEnum {
	return &e
}
...
func (e *CreditNoteCreditNoteStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "voided":
		fallthrough
	case "deleted":
		*e = CreditNoteCreditNoteStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreditNoteCreditNoteStatusEnum: %v", v)
	}
}
...
func (e CreditNoteCreditNoteTypeEnum) ToPointer() *CreditNoteCreditNoteTypeEnum {
	return &e
}
...
func (e *CreditNoteCreditNoteTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "accounts_payable_credit":
		*e = CreditNoteCreditNoteTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreditNoteCreditNoteTypeEnum: %v", v)
	}
}
