...
public class PutOrganisationsPartyIdBusinessNamesProductIdRequest {
    ...
    public PutOrganisationsPartyIdBusinessNamesProductIdRequest(@JsonProperty("apiKey") String apiKey, @JsonProperty("business-nameInput") org.openapis.openapi.models.shared.BusinessNameInput businessNameInput, @JsonProperty("partyId") String partyId, @JsonProperty("productId") String productId) {
        this.apiKey = apiKey;
        this.businessNameInput = businessNameInput;
        this.partyId = partyId;
        this.productId = productId;
