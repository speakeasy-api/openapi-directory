 ...
 */
public class GetNetworkSwitchAccessPolicies200ApplicationJSONRadiusCriticalAuth {
    /**
    ...
    public GetNetworkSwitchAccessPolicies200ApplicationJSONRadiusCriticalAuth withDataVlanId(Long dataVlanId) {
    ...
    public GetNetworkSwitchAccessPolicies200ApplicationJSONRadiusCriticalAuth withSuspendPortBounce(Boolean suspendPortBounce) {
    ...
    public GetNetworkSwitchAccessPolicies200ApplicationJSONRadiusCriticalAuth withVoiceVlanId(Long voiceVlanId) {
        this.voiceVlanId = voiceVlanId;
        return this;
    }
    
    public GetNetworkSwitchAccessPolicies200ApplicationJSONRadiusCriticalAuth(){}
}
