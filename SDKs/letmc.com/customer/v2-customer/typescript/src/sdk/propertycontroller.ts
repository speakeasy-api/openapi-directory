...
export class PropertyController {
  ...
  propertyControllerGetPropertiesPhotos(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PropertyControllerGetPropertiesPhotosResponse =
        new operations.PropertyControllerGetPropertiesPhotosResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.landlordPhotoModelResults = utils.objectToClass(
              httpRes?.data,
              shared.LandlordPhotoModelResults
            );
          }
