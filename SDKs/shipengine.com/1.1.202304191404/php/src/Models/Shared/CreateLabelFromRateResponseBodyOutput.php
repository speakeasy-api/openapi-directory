...
class CreateLabelFromRateResponseBodyOutput
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyDisplaySchemeEnum $displayScheme
     */
	#[\JMS\Serializer\Annotation\SerializedName('display_scheme')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyDisplaySchemeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyDisplaySchemeEnum $displayScheme = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyOptionalLink $formDownload
     */
	#[\JMS\Serializer\Annotation\SerializedName('form_download')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyOptionalLink')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyOptionalLink $formDownload = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyOptionalLink $insuranceClaim
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_claim')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyOptionalLink')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyOptionalLink $insuranceClaim = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyMonetaryValue $insuranceCost
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_cost')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyMonetaryValue $insuranceCost = null;
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyLabelDownload')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyLabelDownload $labelDownload = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyLabelFormatEnum $labelFormat
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_format')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyLabelFormatEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyLabelFormatEnum $labelFormat = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyLabelLayoutEnum $labelLayout
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_layout')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyLabelLayoutEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyLabelLayoutEnum $labelLayout = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyMonetaryValue $shipmentCost
     */
	#[\JMS\Serializer\Annotation\SerializedName('shipment_cost')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyMonetaryValue')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyMonetaryValue $shipmentCost = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyLabelStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyLabelStatusEnum $status = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyTrackingStatusEnum $trackingStatus
     */
	#[\JMS\Serializer\Annotation\SerializedName('tracking_status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CreateLabelFromRateResponseBodyTrackingStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateLabelFromRateResponseBodyTrackingStatusEnum $trackingStatus = null;
