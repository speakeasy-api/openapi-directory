...
public class SmcerSecurity {
    ...
    public SmcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SmcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SmcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
