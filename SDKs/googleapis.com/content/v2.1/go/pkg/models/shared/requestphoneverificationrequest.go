...
func (e *RequestPhoneVerificationRequestPhoneVerificationMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "SMS":
		fallthrough
	case "PHONE_CALL":
		*e = RequestPhoneVerificationRequestPhoneVerificationMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestPhoneVerificationRequestPhoneVerificationMethodEnum: %s", s)
	}
}
