...
exports.PutCisLineTypeTagResponse = exports.PutCisLineTypeTagRequest = void 0;
...
var PutCisLineTypeTagRequest = /** @class */ (function (_super) {
    ...
    ], PutCisLineTypeTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutCisLineTypeTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisLineTypeId",
        }),
        __metadata("design:type", String)
    ], PutCisLineTypeTagRequest.prototype, "cisLineTypeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutCisLineTypeTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], PutCisLineTypeTagRequest.prototype, "tagId", void 0);
...
var PutCisLineTypeTagResponse = /** @class */ (function (_super) {
    ...
    ], PutCisLineTypeTagResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
