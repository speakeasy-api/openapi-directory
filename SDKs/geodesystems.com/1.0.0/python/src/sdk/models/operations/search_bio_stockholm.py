...
class SearchBioStockholmQueryParams:
...
@dataclasses.dataclass
class SearchBioStockholmRequest:
    query_params: SearchBioStockholmQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchBioStockholmResponse:
