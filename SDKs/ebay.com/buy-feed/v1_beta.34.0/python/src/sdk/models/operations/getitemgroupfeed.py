...
from ..shared import itemgroupresponse as shared_itemgroupresponse
from typing import Optional


@dataclasses.dataclass
class GetItemGroupFeedSecurity:
    
    client_credentials: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class GetItemGroupFeedRequest:
...
@dataclasses.dataclass
class GetItemGroupFeedResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    body: Optional[bytes] = dataclasses.field(default=None)  
    headers: Optional[dict[str, list[str]]] = dataclasses.field(default=None)  
    item_group_response: Optional[shared_itemgroupresponse.ItemGroupResponse] = dataclasses.field(default=None)
    r"""Partial Content"""  
