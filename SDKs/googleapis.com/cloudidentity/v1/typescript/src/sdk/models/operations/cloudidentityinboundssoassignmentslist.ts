...
export class CloudidentityInboundSsoAssignmentsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudidentityInboundSsoAssignmentsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudidentityInboundSsoAssignmentsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
