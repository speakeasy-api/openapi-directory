...
const (
	ListTagsForResourceXAmzTargetEnumAwsLookoutEquipmentFrontendServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "AWSLookoutEquipmentFrontendService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSLookoutEquipmentFrontendService.ListTagsForResource":
