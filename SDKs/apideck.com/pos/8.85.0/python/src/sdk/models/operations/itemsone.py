...
class ItemsOneRequest:
    headers: ItemsOneHeaders = dataclasses.field()
    path_params: ItemsOnePathParams = dataclasses.field()
    query_params: ItemsOneQueryParams = dataclasses.field()
    security: ItemsOneSecurity = dataclasses.field()
