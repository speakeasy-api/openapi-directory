...
exports.PostCustomGatewayRefundOwnershipIdResponse = exports.PostCustomGatewayRefundOwnershipIdRequest = void 0;
...
var PostCustomGatewayRefundOwnershipIdRequest = /** @class */ (function (_super) {
    ...
    ], PostCustomGatewayRefundOwnershipIdRequest.prototype, "amount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=customData",
        }),
        __metadata("design:type", String)
    ], PostCustomGatewayRefundOwnershipIdRequest.prototype, "customData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date" }),
        __metadata("design:type", Number)
    ], PostCustomGatewayRefundOwnershipIdRequest.prototype, "date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=developerAmount",
        }),
        __metadata("design:type", Number)
    ], PostCustomGatewayRefundOwnershipIdRequest.prototype, "developerAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=feeAmount",
        }),
        __metadata("design:type", Number)
    ], PostCustomGatewayRefundOwnershipIdRequest.prototype, "feeAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=marketplaceAmount",
        }),
        __metadata("design:type", Number)
    ], PostCustomGatewayRefundOwnershipIdRequest.prototype, "marketplaceAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ownershipId",
        }),
        __metadata("design:type", String)
    ], PostCustomGatewayRefundOwnershipIdRequest.prototype, "ownershipId", void 0);
...
var PostCustomGatewayRefundOwnershipIdResponse = /** @class */ (function (_super) {
    ...
    ], PostCustomGatewayRefundOwnershipIdResponse.prototype, "rawResponse", void 0);
