...
exports.CreateNetworkInterfacePermissionResult = exports.CreateNetworkInterfacePermissionResultInterfacePermission = exports.CreateNetworkInterfacePermissionResultInterfacePermissionPermissionState = exports.CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum = exports.CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum = void 0;
var utils_1 = require("../../../internal/utils");
/**
 * The type of permission.
 */
var CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum;
(function (CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum) {
    CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum["InstanceAttach"] = "INSTANCE-ATTACH";
    CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum["EipAssociate"] = "EIP-ASSOCIATE";
})(CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum = exports.CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum || (exports.CreateNetworkInterfacePermissionResultInterfacePermissionPermissionEnum = {}));
/**
 * The state of the permission.
 */
var CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum;
(function (CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum) {
    CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum["Pending"] = "pending";
    CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum["Granted"] = "granted";
    CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum["Revoking"] = "revoking";
    CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum["Revoked"] = "revoked";
})(CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum = exports.CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum || (exports.CreateNetworkInterfacePermissionResultInterfacePermissionPermissionStateStateEnum = {}));
/**
