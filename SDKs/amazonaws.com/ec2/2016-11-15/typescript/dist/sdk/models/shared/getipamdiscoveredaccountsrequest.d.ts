 ...
 */
export declare class GetIpamDiscoveredAccountsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetIpamDiscoveredAccountsRequest extends SpeakeasyBase {
