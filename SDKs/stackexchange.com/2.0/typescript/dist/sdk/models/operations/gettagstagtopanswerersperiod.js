...
exports.GetTagsTagTopAnswerersPeriodResponse = exports.GetTagsTagTopAnswerersPeriodRequest = exports.GetTagsTagTopAnswerersPeriodPeriodEnum = void 0;
...
var GetTagsTagTopAnswerersPeriodRequest = /** @class */ (function (_super) {
    ...
    ], GetTagsTagTopAnswerersPeriodRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetTagsTagTopAnswerersPeriodRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetTagsTagTopAnswerersPeriodRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetTagsTagTopAnswerersPeriodRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=period",
        }),
        __metadata("design:type", String)
    ], GetTagsTagTopAnswerersPeriodRequest.prototype, "period", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetTagsTagTopAnswerersPeriodRequest.prototype, "site", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=tag" }),
        __metadata("design:type", String)
    ], GetTagsTagTopAnswerersPeriodRequest.prototype, "tag", void 0);
...
var GetTagsTagTopAnswerersPeriodResponse = /** @class */ (function (_super) {
    ...
    ], GetTagsTagTopAnswerersPeriodResponse.prototype, "rawResponse", void 0);
