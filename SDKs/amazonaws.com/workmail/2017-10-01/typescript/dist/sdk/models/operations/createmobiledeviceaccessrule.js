...
exports.CreateMobileDeviceAccessRuleResponse = exports.CreateMobileDeviceAccessRuleRequest = exports.CreateMobileDeviceAccessRuleXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var CreateMobileDeviceAccessRuleXAmzTargetEnum;
...
})(CreateMobileDeviceAccessRuleXAmzTargetEnum = exports.CreateMobileDeviceAccessRuleXAmzTargetEnum || (exports.CreateMobileDeviceAccessRuleXAmzTargetEnum = {}));
var CreateMobileDeviceAccessRuleRequest = /** @class */ (function (_super) {
    ...
    ], CreateMobileDeviceAccessRuleRequest.prototype, "createMobileDeviceAccessRuleRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], CreateMobileDeviceAccessRuleRequest.prototype, "xAmzTarget", void 0);
...
var CreateMobileDeviceAccessRuleResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateMobileDeviceAccessRuleResponse.prototype, "rawResponse", void 0);
