 ...
 */
export declare class UpdateProjectBriefRequestBodyInput extends SpeakeasyBase {
    data?: shared.ProjectBriefRequestInput;
}
export declare class UpdateProjectBriefRequest extends SpeakeasyBase {
    /**
     * The updated fields for the project brief.
     */
 ...
 */
export declare class UpdateProjectBrief200ApplicationJSON extends SpeakeasyBase {
    data?: shared.ProjectBriefResponse;
}
export declare class UpdateProjectBriefResponse extends SpeakeasyBase {
    contentType: string;
    /**
