...
var TaskrouterV1Workspace = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_activity_name" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "defaultActivityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "default_activity_sid" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "defaultActivitySid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "event_callback_url" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "eventCallbackUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "events_filter" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "multi_task_enabled" }),
        __metadata("design:type", Boolean)
    ], TaskrouterV1Workspace.prototype, "multiTaskEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "prioritize_queue_order" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "timeout_activity_name" }),
        __metadata("design:type", String)
    ], TaskrouterV1Workspace.prototype, "timeoutActivityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "timeout_activity_sid" }),
        __metadata("design:type", String)
