...
export enum DeleteEnvironmentAccountConnectionXAmzTargetEnum {
  AwsProton20200720DeleteEnvironmentAccountConnection = "AwsProton20200720.DeleteEnvironmentAccountConnection",
}

export class DeleteEnvironmentAccountConnectionRequest extends SpeakeasyBase {
...
export class DeleteEnvironmentAccountConnectionResponse extends SpeakeasyBase {
  /**
