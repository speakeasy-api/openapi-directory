...
func (e PostPortfolioAnalysisEffectiveNumberOfBetsRequestBodyFactorsExtractionMethodEnum) ToPointer() *PostPortfolioAnalysisEffectiveNumberOfBetsRequestBodyFactorsExtractionMethodEnum {
	return &e
}
...
func (e *PostPortfolioAnalysisEffectiveNumberOfBetsRequestBodyFactorsExtractionMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "approximateMinimumLinearTorsion":
		*e = PostPortfolioAnalysisEffectiveNumberOfBetsRequestBodyFactorsExtractionMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostPortfolioAnalysisEffectiveNumberOfBetsRequestBodyFactorsExtractionMethodEnum: %v", v)
	}
}
