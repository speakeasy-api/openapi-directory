...
exports.TaxonomyCategoriesResponse = exports.TaxonomyCategoriesRequest = exports.TaxonomyCategories200ApplicationJson = exports.TaxonomyCategories200ApplicationJsonData = exports.TaxonomyCategories200ApplicationJsonDataSubcategories = exports.TaxonomyCategoriesHeaders = exports.TaxonomyCategoriesQueryParams = void 0;
...
var TaxonomyCategoriesQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=destId" }),
        __metadata("design:type", Number)
    ], TaxonomyCategoriesQueryParams.prototype, "destId", void 0);
    return TaxonomyCategoriesQueryParams;
}(utils_1.SpeakeasyBase));
exports.TaxonomyCategoriesQueryParams = TaxonomyCategoriesQueryParams;
...
exports.TaxonomyCategoriesHeaders = TaxonomyCategoriesHeaders;
var TaxonomyCategories200ApplicationJsonDataSubcategories = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subCategoryUrlName" }),
        __metadata("design:type", String)
    ], TaxonomyCategories200ApplicationJsonDataSubcategories.prototype, "subCategoryUrlName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subcategoryId" }),
        __metadata("design:type", Number)
    ], TaxonomyCategories200ApplicationJsonDataSubcategories.prototype, "subcategoryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subcategoryName" }),
        __metadata("design:type", String)
...
var TaxonomyCategories200ApplicationJsonData = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=groupUrlName" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subcategories", elemType: TaxonomyCategories200ApplicationJsonDataSubcategories }),
...
var TaxonomyCategories200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=data", elemType: TaxonomyCategories200ApplicationJsonData }),
        __metadata("design:type", Array)
