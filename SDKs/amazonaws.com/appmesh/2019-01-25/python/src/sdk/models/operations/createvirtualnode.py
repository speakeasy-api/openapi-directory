...
class CreateVirtualNodeRequestBody:
    ...
    r"""Optional metadata that you can apply to the virtual node to assist with categorization and organization. Each tag consists of a key and an optional value, both of which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters."""  
...
class CreateVirtualNodeRequest:
    ...
    r"""The name of the service mesh to create the virtual node in."""  
