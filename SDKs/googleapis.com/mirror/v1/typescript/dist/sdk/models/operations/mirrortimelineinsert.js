...
exports.MirrorTimelineInsertResponse = exports.MirrorTimelineInsertRequest = exports.MirrorTimelineInsertSecurity = exports.MirrorTimelineInsertSecurityOption2 = exports.MirrorTimelineInsertSecurityOption1 = void 0;
...
var MirrorTimelineInsertRequest = /** @class */ (function (_super) {
    ...
    ], MirrorTimelineInsertRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], MirrorTimelineInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], MirrorTimelineInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], MirrorTimelineInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineInsertRequest.prototype, "userIp", void 0);
...
var MirrorTimelineInsertResponse = /** @class */ (function (_super) {
    ...
    ], MirrorTimelineInsertResponse.prototype, "rawResponse", void 0);
