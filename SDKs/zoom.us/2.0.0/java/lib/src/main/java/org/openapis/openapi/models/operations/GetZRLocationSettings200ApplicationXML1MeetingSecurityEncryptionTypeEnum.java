 ...
 */
public enum GetZRLocationSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum {
    ...
    private GetZRLocationSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum(String value) {
        this.value = value;
    }
}
