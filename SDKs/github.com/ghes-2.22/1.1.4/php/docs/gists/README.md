...
try {
    ...
    $request->files = [
        'minima' => new GistsCreateRequestBodyFiles(),
    ];
    $request->public = true;
...
try {
    ...
    $request->page = 68074;
    $request->perPage = 544591;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-12-20T03:36:13.455Z');
...
try {
    ...
    $request->gistId = 'impedit';
    $request->page = 131055;
    $request->perPage = 376226;
...
try {
    ...
    $request->page = 12036;
    $request->perPage = 491025;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-01-07T16:50:11.026Z');
    $request->username = 'Libbie.Frami99';
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-05-21T20:57:35.388Z');
...
try {
    ...
    $request->page = 490305;
    $request->perPage = 640024;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-11-23T22:16:07.257Z');
...
try {
    ...
    $request->requestBody->files = [
        'labore' => new GistsUpdateRequestBody2Files1(),
        'adipisci' => new GistsUpdateRequestBody2Files3(),
        'id' => new GistsUpdateRequestBody2Files2(),
        'velit' => new GistsUpdateRequestBody2Files2(),
    ];
    $request->gistId = 'est';
