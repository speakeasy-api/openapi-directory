...
public class Currency {
	...
	public Currency(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    **/
    public openapisdk.models.operations.GetConversionRateResponse getConversionRate(openapisdk.models.operations.GetConversionRateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/currencies");
        ...
        openapisdk.models.operations.GetConversionRateResponse res = new openapisdk.models.operations.GetConversionRateResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.ConversationRate out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ConversationRate.class);
