...
class GetInstanceMetricDataRequest:
    ...
    metric_name: shared_instancemetricname_enum.InstanceMetricNameEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricName') }})  
