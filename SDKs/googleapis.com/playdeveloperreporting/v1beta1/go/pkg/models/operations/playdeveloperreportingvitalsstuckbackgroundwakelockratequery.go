...
type PlaydeveloperreportingVitalsStuckbackgroundwakelockrateQueryRequest struct {
	...
	GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequest *shared.GooglePlayDeveloperReportingV1beta1QueryStuckBackgroundWakelockRateMetricSetRequest `request:"mediaType=application/json"`
	// OAuth access token.
