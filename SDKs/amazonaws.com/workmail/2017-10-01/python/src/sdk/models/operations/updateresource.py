...
class UpdateResourceRequest:
    headers: UpdateResourceHeaders = dataclasses.field()
    request: shared_updateresourcerequest.UpdateResourceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
