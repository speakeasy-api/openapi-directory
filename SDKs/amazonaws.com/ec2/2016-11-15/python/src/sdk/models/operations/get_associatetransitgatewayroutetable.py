...
class GetAssociateTransitGatewayRouteTableQueryParams:
    action: GetAssociateTransitGatewayRouteTableActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAssociateTransitGatewayRouteTableVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAssociateTransitGatewayRouteTableRequest:
    headers: GetAssociateTransitGatewayRouteTableHeaders = dataclasses.field()
    query_params: GetAssociateTransitGatewayRouteTableQueryParams = dataclasses.field()
