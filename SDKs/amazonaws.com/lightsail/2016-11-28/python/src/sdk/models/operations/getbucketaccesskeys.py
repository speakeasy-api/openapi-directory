...
class GetBucketAccessKeysRequest:
    ...
    get_bucket_access_keys_request: shared_getbucketaccesskeysrequest.GetBucketAccessKeysRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
