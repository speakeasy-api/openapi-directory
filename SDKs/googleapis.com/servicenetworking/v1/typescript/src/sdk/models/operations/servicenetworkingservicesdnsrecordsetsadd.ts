...
export class ServicenetworkingServicesDnsRecordSetsAddSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesDnsRecordSetsAddSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServicenetworkingServicesDnsRecordSetsAddSecurity extends SpeakeasyBase {
...
export class ServicenetworkingServicesDnsRecordSetsAddRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServicenetworkingServicesDnsRecordSetsAddResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
