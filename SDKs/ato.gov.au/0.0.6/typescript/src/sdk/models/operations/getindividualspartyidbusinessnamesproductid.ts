...
export class GetIndividualsPartyIdBusinessNamesProductIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetIndividualsPartyIdBusinessNamesProductIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
