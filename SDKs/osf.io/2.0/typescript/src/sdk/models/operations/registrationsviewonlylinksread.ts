 ...
 */
export class RegistrationsViewOnlyLinksReadViewOnlyLinksAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsViewOnlyLinksReadViewOnlyLinksRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class RegistrationsViewOnlyLinksReadViewOnlyLinks extends SpeakeasyBase {
  /**
   * The properties of the view only link entity.
   */
  @SpeakeasyMetadata()
