...
class GetItemsBatchInternationalTransferBatchItemsBatchItem
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetItemsBatchInternationalTransferBatchItemsBatchItemResult $result
     */
	#[\JMS\Serializer\Annotation\SerializedName('result')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetItemsBatchInternationalTransferBatchItemsBatchItemResult')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetItemsBatchInternationalTransferBatchItemsBatchItemResult $result = null;
    
    /**
     * status of the batch if internal trasnfer
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetItemsBatchInternationalTransferBatchItemsBatchItemStatusEnum $status
     */
	#[\JMS\Serializer\Annotation\SerializedName('status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetItemsBatchInternationalTransferBatchItemsBatchItemStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetItemsBatchInternationalTransferBatchItemsBatchItemStatusEnum $status = null;
