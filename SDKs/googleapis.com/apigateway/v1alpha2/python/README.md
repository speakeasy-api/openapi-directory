...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/googleapis.com/apigateway/v1alpha2/python
```
...
res = s.projects.apigateway_projects_locations_gateways_get_iam_policy(req, operations.ApigatewayProjectsLocationsGatewaysGetIamPolicySecurity(
