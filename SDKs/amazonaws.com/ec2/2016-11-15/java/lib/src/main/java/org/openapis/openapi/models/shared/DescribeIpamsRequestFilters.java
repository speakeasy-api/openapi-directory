 ...
 */
public class DescribeIpamsRequestFilters {
    
    public String name;

    public DescribeIpamsRequestFilters withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DescribeIpamsRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeIpamsRequestFilters(){}
}
