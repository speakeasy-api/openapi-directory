...
class Users 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\OsloginUsersGetLoginProfileResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1alpha/{name}/loginProfile', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersGetLoginProfileRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1alpha/{parent}:importSshPublicKey', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersImportSshPublicKeyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1alpha/{parent}/sshPublicKeys', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1alpha/{name}', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1alpha/{name}', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1alpha/{name}', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysPatchRequest::class, $request);
