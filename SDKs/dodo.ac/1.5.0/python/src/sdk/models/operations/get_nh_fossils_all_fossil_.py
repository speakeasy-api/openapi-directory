...
from ..shared import nhfossilgroupwithindividualfossils as shared_nhfossilgroupwithindividualfossils
...
class GetNhFossilsAllFossilRequest:
    ...
    fossil: str = dataclasses.field(metadata={'path_param': { 'field_name': 'fossil', 'style': 'simple', 'explode': False }})
    r"""The name of the fossil OR fossil group you wish to retrieve information about. If a fossil is provided, a fossil group that the specified fossil belongs to will be returned."""  
...
@dataclasses.dataclass
class GetNhFossilsAllFossilResponse:
    ...
    nh_fossil_group_with_individual_fossils: Optional[shared_nhfossilgroupwithindividualfossils.NHFossilGroupWithIndividualFossils] = dataclasses.field(default=None)
