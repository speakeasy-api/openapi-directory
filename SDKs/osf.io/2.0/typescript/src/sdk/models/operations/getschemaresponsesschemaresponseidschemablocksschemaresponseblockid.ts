...
export class GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRequest extends SpeakeasyBase {
  /**
 ...
 */
export enum GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRegistrationSchemaBlockAttributesBlockTypeEnum {
 ...
 */
export class GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRegistrationSchemaBlockAttributes extends SpeakeasyBase {
  /**
   * A string that represents the type of input that the schema will take and the UI element that appears to the user on the frontend.
   */
  @SpeakeasyMetadata()
 ...
 */
export class GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRegistrationSchemaBlockLinks extends SpeakeasyBase {
  /**
 ...
 */
export class GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRegistrationSchemaBlockRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdRegistrationSchemaBlock extends SpeakeasyBase {
  /**
   * The attributes of the Registration Schema Block.
   */
  @SpeakeasyMetadata()
...
export class GetSchemaResponsesSchemaResponseIdSchemaBlocksSchemaResponseBlockIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
