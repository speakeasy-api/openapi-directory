...
class PutV2AccountsIDJSONRequestBody:
    ...
    archived: Optional[bool] = dataclasses.field(default=None, metadata={'form': { 'field_name': 'archived' }})
    r"""Whether this Account should be archived or not. Setting this to true sets archived_at to the current time if it's not already set. Setting this to false will set archived_at to null"""  
...
@dataclasses.dataclass
class PutV2AccountsIDJSONRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""Account ID"""  
    request_body: PutV2AccountsIDJSONRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
    

@dataclasses.dataclass
class PutV2AccountsIDJSONResponse:
