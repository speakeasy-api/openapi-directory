...
from ..shared import postsubscriptiontype as shared_postsubscriptiontype
...
class POSTSubscriptionRequest:
    ...
    post_subscription_type: shared_postsubscriptiontype.POSTSubscriptionType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
