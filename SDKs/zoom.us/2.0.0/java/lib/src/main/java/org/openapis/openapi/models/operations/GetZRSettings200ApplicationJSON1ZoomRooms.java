...
public class GetZRSettings200ApplicationJSON1ZoomRooms {
    /**
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withAllowMultipleContentSharing(Boolean allowMultipleContentSharing) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withAudioDeviceDailyAutoTest(Boolean audioDeviceDailyAutoTest) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withAutoDirectSharing(Boolean autoDirectSharing) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withAutoStartScheduledMeeting(Boolean autoStartScheduledMeeting) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withAutoStopScheduledMeeting(Boolean autoStopScheduledMeeting) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withCountAttendeesNumberInRoom(Boolean countAttendeesNumberInRoom) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withDisplayFeedbackSurvey(Boolean displayFeedbackSurvey) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withDisplayMeetingList(Boolean displayMeetingList) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withDisplayTopBanner(Boolean displayTopBanner) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withEncryptSharedScreenContent(Boolean encryptSharedScreenContent) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withHideIdForPrivateMeeting(Boolean hideIdForPrivateMeeting) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withHideShareInstruction(Boolean hideShareInstruction) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withSendWhiteboardToInternalContactOnly(Boolean sendWhiteboardToInternalContactOnly) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withShowAlertBeforeMeeting(Boolean showAlertBeforeMeeting) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withShowCallHistoryInRoom(Boolean showCallHistoryInRoom) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withShowContactListOnController(Boolean showContactListOnController) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withShowNonVideoParticipants(Boolean showNonVideoParticipants) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withStartAirplayManually(Boolean startAirplayManually) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withStartAirplayMirroring(Boolean startAirplayMirroring) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withSupportJoin3rdPartyMeeting(Boolean supportJoin3rdPartyMeeting) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withTransformMeetingToPrivate(Boolean transformMeetingToPrivate) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withUpcomingMeetingAlert(Boolean upcomingMeetingAlert) {
    ...
    public GetZRSettings200ApplicationJSON1ZoomRooms withWeeklySystemRestart(Boolean weeklySystemRestart) {
