...
public class TwoSendPaymentsPublicHeaders {
    /**
    ...
    public TwoSendPaymentsPublicHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public TwoSendPaymentsPublicHeaders withContentType(String contentType) {
    ...
    public TwoSendPaymentsPublicHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public TwoSendPaymentsPublicHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
