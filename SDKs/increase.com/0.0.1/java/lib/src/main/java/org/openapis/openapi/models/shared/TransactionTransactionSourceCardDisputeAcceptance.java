 ...
 */
public class TransactionTransactionSourceCardDisputeAcceptance {
    /**
    ...
    public TransactionTransactionSourceCardDisputeAcceptance withAcceptedAt(OffsetDateTime acceptedAt) {
    ...
    public TransactionTransactionSourceCardDisputeAcceptance withCardDisputeId(String cardDisputeId) {
    ...
    public TransactionTransactionSourceCardDisputeAcceptance withTransactionId(String transactionId) {
