...
class HorizontalRule:
    ...
    r"""The suggested insertion IDs. A HorizontalRule may have multiple insertion IDs if it is a nested suggested change. If empty, then this is not a suggested insertion."""  
    ...
    r"""The suggested text style changes to this HorizontalRule, keyed by suggestion ID."""  
