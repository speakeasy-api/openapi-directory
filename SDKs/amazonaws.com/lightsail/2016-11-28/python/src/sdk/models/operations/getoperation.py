...
from ..shared import getoperationresult as shared_getoperationresult
...
class GetOperationResponse:
    ...
    get_operation_result: Optional[shared_getoperationresult.GetOperationResult] = dataclasses.field(default=None)
