...
public class StorageChannelsStopSecurity {
    ...
    @SpeakeasyMetadata("security:option=true")
    public StorageChannelsStopSecurityOption4 option4;

    public StorageChannelsStopSecurity withOption4(StorageChannelsStopSecurityOption4 option4) {
        this.option4 = option4;
        return this;
    }
    
    @SpeakeasyMetadata("security:option=true")
    public StorageChannelsStopSecurityOption5 option5;

    public StorageChannelsStopSecurity withOption5(StorageChannelsStopSecurityOption5 option5) {
        this.option5 = option5;
        return this;
    }
    
    public StorageChannelsStopSecurity(){}
}
