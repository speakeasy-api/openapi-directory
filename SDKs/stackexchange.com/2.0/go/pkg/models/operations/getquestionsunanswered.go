...
func (e *GetQuestionsUnansweredOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetQuestionsUnansweredOrderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetQuestionsUnansweredOrderEnum: %s", s)
	}
}
...
func (e *GetQuestionsUnansweredSortEnum) UnmarshalJSON(data []byte) error {
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetQuestionsUnansweredSortEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetQuestionsUnansweredSortEnum: %s", s)
	}
}
