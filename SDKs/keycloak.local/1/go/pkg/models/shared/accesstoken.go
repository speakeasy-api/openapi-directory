...
func (e *AccessTokenCategoryEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "ADMIN":
		fallthrough
	case "USERINFO":
		*e = AccessTokenCategoryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for AccessTokenCategoryEnum: %s", s)
	}
}
