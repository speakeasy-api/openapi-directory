...
use \OpenAPI\OpenAPI\Models\Operations\TdcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\TdcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\TdcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\TdcerSecurity;
...
try {
    ...
    $request->certificateParameters = new TdcerRequestBodyCertificateParameters();
    $request->certificateParameters->custID = 'Enter 14 Digit A/c No - TDS Information will be generated for all A/cs associated with Customer ID.';
    $request->certificateParameters->dob = '31-12-1980';
    $request->certificateParameters->finYr = '2018-2019';
    ...
    $request->format = TdcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new TdcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->tdcer($request, $requestSecurity);
...
* [tdcer](docs/apis/README.md#tdcer) - TDS Certificate
