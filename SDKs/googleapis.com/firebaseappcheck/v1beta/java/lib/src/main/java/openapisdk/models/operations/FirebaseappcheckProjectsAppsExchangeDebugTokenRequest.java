...
public class FirebaseappcheckProjectsAppsExchangeDebugTokenRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeDebugTokenRequest request;
    public FirebaseappcheckProjectsAppsExchangeDebugTokenRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeDebugTokenRequest request) {
