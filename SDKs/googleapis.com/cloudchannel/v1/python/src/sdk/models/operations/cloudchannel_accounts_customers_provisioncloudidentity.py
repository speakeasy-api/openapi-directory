...
class CloudchannelAccountsCustomersProvisionCloudIdentityRequest:
    ...
    r"""Required. Resource name of the customer. Format: accounts/{account_id}/customers/{customer_id}"""  
    ...
    google_cloud_channel_v1_provision_cloud_identity_request_input: Optional[shared_googlecloudchannelv1provisioncloudidentityrequest.GoogleCloudChannelV1ProvisionCloudIdentityRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
