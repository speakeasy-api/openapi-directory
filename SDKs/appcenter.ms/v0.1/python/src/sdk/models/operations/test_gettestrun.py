...
class TestGetTestRunSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    

@dataclasses.dataclass
class TestGetTestRunRequest:
...
class TestGetTestRunTestRun:
    ...
    stats: Optional[TestGetTestRunTestRunTestRunStatistics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stats'), 'exclude': lambda f: f is None }})
    r"""Summary single test run on Xamarin Test Cloud"""  
...
@dataclasses.dataclass
class TestGetTestRunResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)  
    test_run: Optional[TestGetTestRunTestRun] = dataclasses.field(default=None)
    r"""OK"""  
