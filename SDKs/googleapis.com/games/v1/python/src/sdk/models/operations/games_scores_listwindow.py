...
class GamesScoresListWindowPathParams:
    collection: GamesScoresListWindowCollectionEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'collection', 'style': 'simple', 'explode': False }})
...
class GamesScoresListWindowQueryParams:
    time_span: GamesScoresListWindowTimeSpanEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'timeSpan', 'style': 'form', 'explode': True }})
    ...
    results_above: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'resultsAbove', 'style': 'form', 'explode': True }})
    return_top_if_absent: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'returnTopIfAbsent', 'style': 'form', 'explode': True }})
...
class GamesScoresListWindowRequest:
    path_params: GamesScoresListWindowPathParams = dataclasses.field()
    query_params: GamesScoresListWindowQueryParams = dataclasses.field()
    security: GamesScoresListWindowSecurity = dataclasses.field()
