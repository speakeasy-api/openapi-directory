...
export class PutWebhooksIdWebhookRequestBody extends SpeakeasyBase {
  /**
...
export class PutWebhooksIdWebhookRequest extends SpeakeasyBase {
...
export class PutWebhooksIdWebhookResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
