...
from ..shared import itvprofiletoken as shared_itvprofiletoken
from ..shared import itvprofiletokenrequest as shared_itvprofiletokenrequest
...
class GetItvProfileTokenRequest:
    ...
    itv_profile_token_request: shared_itvprofiletokenrequest.ItvProfileTokenRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetItvProfileTokenResponse:
    ...
    itv_profile_token: Optional[shared_itvprofiletoken.ItvProfileToken] = dataclasses.field(default=None)
