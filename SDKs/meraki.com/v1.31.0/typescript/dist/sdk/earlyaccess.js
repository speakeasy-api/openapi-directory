...
exports.EarlyAccess = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var EarlyAccess = /** @class */ (function () {
    function EarlyAccess(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Create a new early access feature opt-in for an organization
     */
    EarlyAccess.prototype.createOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        var _a;
     ...
     * Delete an early access feature opt-in
     */
    EarlyAccess.prototype.deleteOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List the available early access features for organization
     */
    EarlyAccess.prototype.getOrganizationEarlyAccessFeatures = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Show an early access feature opt-in for an organization
     */
    EarlyAccess.prototype.getOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List the early access feature opt-ins for an organization
     */
    EarlyAccess.prototype.getOrganizationEarlyAccessFeaturesOptIns = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update an early access feature opt-in for an organization
     */
    EarlyAccess.prototype.updateOrganizationEarlyAccessFeaturesOptIn = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.EarlyAccess = EarlyAccess;
