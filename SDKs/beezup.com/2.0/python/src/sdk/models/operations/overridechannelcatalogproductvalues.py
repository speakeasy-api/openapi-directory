...
class OverrideChannelCatalogProductValuesPathParams:
...
class OverrideChannelCatalogProductValuesRequest:
    path_params: OverrideChannelCatalogProductValuesPathParams = dataclasses.field()
    request: dict[str, str] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
