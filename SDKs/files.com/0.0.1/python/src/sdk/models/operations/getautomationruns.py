...
class GetAutomationRunsRequest:
    
    automation_id: int = dataclasses.field(metadata={'query_param': { 'field_name': 'automation_id', 'style': 'form', 'explode': True }})
    ...
    r"""If set, return records where the specified field is equal to the supplied value. Valid fields are `status`."""  
    ...
    r"""If set, return records where the specified field is greater than the supplied value. Valid fields are `status`."""  
    ...
    r"""If set, return records where the specified field is greater than or equal to the supplied value. Valid fields are `status`."""  
    ...
    r"""If set, return records where the specified field is less than the supplied value. Valid fields are `status`."""  
    ...
    r"""If set, return records where the specified field is less than or equal to the supplied value. Valid fields are `status`."""  
    ...
    r"""If set, sort records by the specified field in either `asc` or `desc` direction (e.g. `sort_by[created_at]=desc`). Valid fields are `created_at` and `status`."""  
...
class GetAutomationRunsResponse:
    ...
    automation_run_entities: Optional[list[shared_automationrunentity.AutomationRunEntity]] = dataclasses.field(default=None)
    r"""A list of AutomationRuns objects."""  
