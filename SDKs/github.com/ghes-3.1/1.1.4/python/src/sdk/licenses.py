...
class Licenses:
    ...
    def licenses_get(self, request: operations.LicensesGetRequest) -> operations.LicensesGetResponse:
        r"""Get a license
        https://docs.github.com/enterprise-server@3.1/rest/reference/licenses#get-a-license - API method documentation
        """
    ...
    def licenses_get_all_commonly_used(self, request: operations.LicensesGetAllCommonlyUsedRequest) -> operations.LicensesGetAllCommonlyUsedResponse:
        ...
        https://docs.github.com/enterprise-server@3.1/rest/reference/licenses#get-all-commonly-used-licenses - API method documentation
        """
    ...
    def licenses_get_for_repo(self, request: operations.LicensesGetForRepoRequest) -> operations.LicensesGetForRepoResponse:
        ...
        https://docs.github.com/enterprise-server@3.1/rest/reference/licenses/#get-the-license-for-a-repository - API method documentation
        """
