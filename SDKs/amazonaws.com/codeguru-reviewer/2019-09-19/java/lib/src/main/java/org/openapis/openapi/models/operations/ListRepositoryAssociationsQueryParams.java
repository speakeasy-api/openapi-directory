...
public class ListRepositoryAssociationsQueryParams {
    ...
    public ListRepositoryAssociationsQueryParams withProviderType(org.openapis.openapi.models.shared.ProviderTypeEnum[] providerType) {
    ...
    public ListRepositoryAssociationsQueryParams withState(org.openapis.openapi.models.shared.RepositoryAssociationStateEnum[] state) {
        this.state = state;
        return this;
    }
