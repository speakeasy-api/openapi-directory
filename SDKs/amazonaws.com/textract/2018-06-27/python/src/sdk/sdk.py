...
SERVERS = [
    ...
    r"""The Amazon Textract multi-region endpoint"""
    "https://textract.{region}.amazonaws.com",
    r"""The Amazon Textract multi-region endpoint"""
    "http://textract.{region}.amazonaws.com.cn",
    r"""The Amazon Textract endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    r"""Amazon Textract detects and analyzes text in documents and converts it into machine-readable text. This is the API reference documentation for Amazon Textract.
    ...
    def analyze_document(self, request: operations.AnalyzeDocumentRequest) -> operations.AnalyzeDocumentResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "analyze_document_request", 'json')
        ...
        res = operations.AnalyzeDocumentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AnalyzeDocumentResponse])
    ...
    def analyze_expense(self, request: operations.AnalyzeExpenseRequest) -> operations.AnalyzeExpenseResponse:
        ...
        res = operations.AnalyzeExpenseResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AnalyzeExpenseResponse])
    ...
    def analyze_id(self, request: operations.AnalyzeIDRequest) -> operations.AnalyzeIDResponse:
        r"""Analyzes identity documents for relevant information. This information is extracted and returned as <code>IdentityDocumentFields</code>, which records both the normalized field and value of the extracted text. Unlike other Amazon Textract operations, <code>AnalyzeID</code> doesn't return any Geometry data."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=Textract.AnalyzeID'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "analyze_id_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.AnalyzeIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AnalyzeIDResponse])
                res.analyze_id_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def detect_document_text(self, request: operations.DetectDocumentTextRequest) -> operations.DetectDocumentTextResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "detect_document_text_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DetectDocumentTextResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DetectDocumentTextResponse])
    ...
    def get_document_analysis(self, request: operations.GetDocumentAnalysisRequest) -> operations.GetDocumentAnalysisResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_document_analysis_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetDocumentAnalysisResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDocumentAnalysisResponse])
    ...
    def get_document_text_detection(self, request: operations.GetDocumentTextDetectionRequest) -> operations.GetDocumentTextDetectionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_document_text_detection_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetDocumentTextDetectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetDocumentTextDetectionResponse])
    ...
    def get_expense_analysis(self, request: operations.GetExpenseAnalysisRequest) -> operations.GetExpenseAnalysisResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=Textract.GetExpenseAnalysis'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_expense_analysis_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetExpenseAnalysisResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetExpenseAnalysisResponse])
                res.get_expense_analysis_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def get_lending_analysis(self, request: operations.GetLendingAnalysisRequest) -> operations.GetLendingAnalysisResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=Textract.GetLendingAnalysis'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_lending_analysis_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetLendingAnalysisResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetLendingAnalysisResponse])
                res.get_lending_analysis_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def get_lending_analysis_summary(self, request: operations.GetLendingAnalysisSummaryRequest) -> operations.GetLendingAnalysisSummaryResponse:
        ...
        res = operations.GetLendingAnalysisSummaryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetLendingAnalysisSummaryResponse])
                res.get_lending_analysis_summary_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def start_document_analysis(self, request: operations.StartDocumentAnalysisRequest) -> operations.StartDocumentAnalysisResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_document_analysis_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartDocumentAnalysisResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartDocumentAnalysisResponse])
    ...
    def start_document_text_detection(self, request: operations.StartDocumentTextDetectionRequest) -> operations.StartDocumentTextDetectionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_document_text_detection_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartDocumentTextDetectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartDocumentTextDetectionResponse])
    ...
    def start_expense_analysis(self, request: operations.StartExpenseAnalysisRequest) -> operations.StartExpenseAnalysisResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=Textract.StartExpenseAnalysis'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_expense_analysis_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartExpenseAnalysisResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartExpenseAnalysisResponse])
                res.start_expense_analysis_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def start_lending_analysis(self, request: operations.StartLendingAnalysisRequest) -> operations.StartLendingAnalysisResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=Textract.StartLendingAnalysis'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_lending_analysis_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartLendingAnalysisResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartLendingAnalysisResponse])
                res.start_lending_analysis_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.invalid_parameter_exception = out
