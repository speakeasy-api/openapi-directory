...
import { KeyFormatEnum } from "./keyformatenum";
import { KeyTypeEnum } from "./keytypeenum";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateKeyPairRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateKeyPairRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateKeyPairRequestTagSpecifications extends SpeakeasyBase {
