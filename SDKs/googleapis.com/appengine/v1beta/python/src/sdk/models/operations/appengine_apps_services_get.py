...
class AppengineAppsServicesGetSecurity:
    option1: Optional[AppengineAppsServicesGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AppengineAppsServicesGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[AppengineAppsServicesGetSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AppengineAppsServicesGetRequest:
    path_params: AppengineAppsServicesGetPathParams = dataclasses.field()
    query_params: AppengineAppsServicesGetQueryParams = dataclasses.field()
    security: AppengineAppsServicesGetSecurity = dataclasses.field()
