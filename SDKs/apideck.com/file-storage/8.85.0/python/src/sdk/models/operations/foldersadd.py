...
from ..shared import createfolderresponse as shared_createfolderresponse
...
@dataclasses.dataclass
class FoldersAddSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class FoldersAddRequest:
    headers: FoldersAddHeaders = dataclasses.field()
    query_params: FoldersAddQueryParams = dataclasses.field()
    request: shared_createfolderrequest.CreateFolderRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: FoldersAddSecurity = dataclasses.field()
    

@dataclasses.dataclass
class FoldersAddResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    create_folder_response: Optional[shared_createfolderresponse.CreateFolderResponse] = dataclasses.field(default=None)
