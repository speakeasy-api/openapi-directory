...
var LeaderboardConfigurations = /** @class */ (function () {
    ...
    **/
    LeaderboardConfigurations.prototype.gamesConfigurationLeaderboardConfigurationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesConfigurationLeaderboardConfigurationsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/games/v1configuration/leaderboards/{leaderboardId}", req.pathParams);
    ...
    **/
    LeaderboardConfigurations.prototype.gamesConfigurationLeaderboardConfigurationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.leaderboardConfiguration = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    LeaderboardConfigurations.prototype.gamesConfigurationLeaderboardConfigurationsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesConfigurationLeaderboardConfigurationsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/games/v1configuration/applications/{applicationId}/leaderboards", req.pathParams);
    ...
    **/
    LeaderboardConfigurations.prototype.gamesConfigurationLeaderboardConfigurationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.leaderboardConfigurationListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    LeaderboardConfigurations.prototype.gamesConfigurationLeaderboardConfigurationsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
