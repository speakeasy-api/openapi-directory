...
public class PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("assetsGroups")
    public Long[][] assetsGroups;

    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints withAssetsGroups(Long[][] assetsGroups) {
    ...
    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints withAssetsGroupsMatrix(Double[][] assetsGroupsMatrix) {
    ...
    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints withMaximumAssetsGroupsWeights(Double[] maximumAssetsGroupsWeights) {
    ...
    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints withMaximumAssetsWeights(Double[] maximumAssetsWeights) {
    ...
    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints withMaximumPortfolioExposure(Double maximumPortfolioExposure) {
    ...
    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints withMinimumAssetsWeights(Double[] minimumAssetsWeights) {
    ...
    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints withMinimumPortfolioExposure(Double minimumPortfolioExposure) {
        this.minimumPortfolioExposure = minimumPortfolioExposure;
        return this;
    }
    
    public PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints(){}
}
