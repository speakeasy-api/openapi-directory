 ...
 */
public class PreprintsListPreprintRelationships {
    /**
    ...
    public PreprintsListPreprintRelationships withBibliographicContributors(String bibliographicContributors) {
    ...
    public PreprintsListPreprintRelationships withCitation(String citation) {
    ...
    public PreprintsListPreprintRelationships withIdentifiers(String identifiers) {
    ...
    public PreprintsListPreprintRelationships withLicense(String license) {
    ...
    public PreprintsListPreprintRelationships withNode(String node) {
        this.node = node;
        return this;
    }
    ...
    public PreprintsListPreprintRelationships withPrimaryFile(String primaryFile) {
    ...
    public PreprintsListPreprintRelationships withProvider(String provider) {
        this.provider = provider;
        return this;
    }
    
    public PreprintsListPreprintRelationships(@JsonProperty("node") String node, @JsonProperty("primary_file") String primaryFile, @JsonProperty("provider") String provider) {
        this.node = node;
        this.primaryFile = primaryFile;
        this.provider = provider;
  }
