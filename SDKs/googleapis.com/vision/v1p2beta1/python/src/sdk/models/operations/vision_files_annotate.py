...
class VisionFilesAnnotateQueryParams:
...
@dataclasses.dataclass
class VisionFilesAnnotateSecurity:
    option1: Optional[VisionFilesAnnotateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[VisionFilesAnnotateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class VisionFilesAnnotateRequest:
    query_params: VisionFilesAnnotateQueryParams = dataclasses.field()
    security: VisionFilesAnnotateSecurity = dataclasses.field()
