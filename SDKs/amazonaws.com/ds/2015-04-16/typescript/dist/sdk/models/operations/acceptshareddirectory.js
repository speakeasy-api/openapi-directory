...
exports.AcceptSharedDirectoryResponse = exports.AcceptSharedDirectoryRequest = exports.AcceptSharedDirectoryXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var AcceptSharedDirectoryXAmzTargetEnum;
...
})(AcceptSharedDirectoryXAmzTargetEnum = exports.AcceptSharedDirectoryXAmzTargetEnum || (exports.AcceptSharedDirectoryXAmzTargetEnum = {}));
var AcceptSharedDirectoryRequest = /** @class */ (function (_super) {
    ...
    ], AcceptSharedDirectoryRequest.prototype, "acceptSharedDirectoryRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], AcceptSharedDirectoryRequest.prototype, "xAmzTarget", void 0);
...
var AcceptSharedDirectoryResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], AcceptSharedDirectoryResponse.prototype, "rawResponse", void 0);
    return AcceptSharedDirectoryResponse;
}(utils_1.SpeakeasyBase));
exports.AcceptSharedDirectoryResponse = AcceptSharedDirectoryResponse;
