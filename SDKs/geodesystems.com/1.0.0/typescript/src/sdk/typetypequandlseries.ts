...
export class TypeTypeQuandlSeries {
  ...
  searchTypeQuandlSeries(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_quandl_series";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeQuandlSeriesResponse =
        new operations.SearchTypeQuandlSeriesResponse({
