...
class MediaV1MediaRecording:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the MediaRecording resource."""  
    ...
    r"""The duration of the MediaRecording in seconds."""  
    format: Optional[shared_media_recording_enum_format_enum.MediaRecordingEnumFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('format'), 'exclude': lambda f: f is None }})  
    ...
    r"""The size of the recording media in bytes."""  
    processor_sid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('processor_sid'), 'exclude': lambda f: f is None }})
    r"""The SID of the MediaProcessor resource which produced the MediaRecording."""  
    ...
    r"""The dimensions of the video image in pixels expressed as columns (width) and rows (height)."""  
    sid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sid'), 'exclude': lambda f: f is None }})
    r"""The unique string generated to identify the MediaRecording resource."""  
    ...
    r"""The SID of the resource that generated the original media track(s) of the MediaRecording."""  
    status: Optional[shared_media_recording_enum_status_enum.MediaRecordingEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
    ...
    r"""The URL to which Twilio will send asynchronous webhook requests for every MediaRecording event. See [Status Callbacks](/docs/live/status-callbacks) for more details."""  
    status_callback_method: Optional[MediaV1MediaRecordingStatusCallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status_callback_method'), 'exclude': lambda f: f is None }})
    r"""The HTTP method Twilio should use to call the `status_callback` URL. Can be `POST` or `GET` and the default is `POST`."""  
