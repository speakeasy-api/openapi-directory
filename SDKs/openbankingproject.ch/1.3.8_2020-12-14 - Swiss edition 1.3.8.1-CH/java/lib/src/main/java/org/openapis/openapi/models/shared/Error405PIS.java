...
/**
 * Error405PIS - Standardised definition of reporting error information according to [RFC7807]
...
public class Error405PIS {
    ...
    public Error405PIS(@JsonProperty("code") MessageCode405PISEnum code, @JsonProperty("type") String type) {
        this.code = code;
        this.type = type;
  }
}
