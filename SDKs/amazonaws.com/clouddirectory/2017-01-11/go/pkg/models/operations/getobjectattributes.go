...
func (e GetObjectAttributesXAmzConsistencyLevelEnum) ToPointer() *GetObjectAttributesXAmzConsistencyLevelEnum {
	return &e
}
...
func (e *GetObjectAttributesXAmzConsistencyLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "SERIALIZABLE":
		fallthrough
	case "EVENTUAL":
		*e = GetObjectAttributesXAmzConsistencyLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetObjectAttributesXAmzConsistencyLevelEnum: %v", v)
	}
}
