...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EpfscResponse res = sdk.apIs.epfsc(req, new EpfscSecurity("molestiae", "minus") {{
...
* [epfsc](docs/apis/README.md#epfsc) - Scheme Certificate
* [pecer](docs/apis/README.md#pecer) - Pension Certificate
* [uncrd](docs/apis/README.md#uncrd) - UAN Card
