...
type DescribeFileCachesQueryParams struct {
	// Pagination limit
...
type DescribeFileCachesHeaders struct {
...
type DescribeFileCachesRequest struct {
	QueryParams DescribeFileCachesQueryParams
	Headers     DescribeFileCachesHeaders
	Request     shared.DescribeFileCachesRequest `request:"mediaType=application/json"`
}
