...
from ..shared import listannotationimportjobsresponse as shared_listannotationimportjobsresponse
...
class ListAnnotationImportJobsRequestBodyFilter:
    r"""A filter for annotation import jobs."""
...
class ListAnnotationImportJobsRequestBody:
    ...
    filter: Optional[ListAnnotationImportJobsRequestBodyFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filter'), 'exclude': lambda f: f is None }})
    r"""A filter for annotation import jobs."""  
    ...
    r"""IDs of annotation import jobs to retrieve."""  
    

@dataclasses.dataclass
class ListAnnotationImportJobsRequest:
    
    request_body: ListAnnotationImportJobsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListAnnotationImportJobsResponse:
    ...
    list_annotation_import_jobs_response: Optional[shared_listannotationimportjobsresponse.ListAnnotationImportJobsResponse] = dataclasses.field(default=None)
    r"""Success"""  
