...
class DescribePortfolioSharesRequest:
    ...
    describe_portfolio_shares_input: shared_describeportfoliosharesinput.DescribePortfolioSharesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
