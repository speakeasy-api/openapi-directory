...
class AppAssessmentSummary:
    r"""Defines an application assessment summary."""
    ...
    invoker: Optional[shared_assessmentinvoker_enum.AssessmentInvokerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invoker'), 'exclude': lambda f: f is None }})  
