...
public class BankTransferCreateRequest {
    ...
    public BankTransferCreateRequest(@JsonProperty("access_token") String accessToken, @JsonProperty("account_id") String accountId, @JsonProperty("amount") String amount, @JsonProperty("description") String description, @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("iso_currency_code") String isoCurrencyCode, @JsonProperty("network") BankTransferNetworkEnum network, @JsonProperty("type") BankTransferTypeEnum type, @JsonProperty("user") java.util.Map<String, Object> user) {
        this.accessToken = accessToken;
        this.accountId = accountId;
        this.amount = amount;
        this.description = description;
