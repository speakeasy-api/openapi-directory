...
public class Http2HealthCheck {
    ...
    public Http2HealthCheckWeightReportModeEnum weightReportMode;

    public Http2HealthCheck withWeightReportMode(Http2HealthCheckWeightReportModeEnum weightReportMode) {
