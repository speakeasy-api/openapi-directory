...
class PostLoadBalancersIDActionsChangeDNSPtrChangeLoadbalancerDNSPtrRequest:
    ...
    r"""Hostname to set as a reverse DNS PTR entry"""  
    ip: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ip') }})
    r"""Public IP address for which the reverse DNS entry should be set"""  
...
class PostLoadBalancersIDActionsChangeDNSPtrRequest:
    ...
    request_body: Optional[PostLoadBalancersIDActionsChangeDNSPtrChangeLoadbalancerDNSPtrRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""Select the IP address for which to change the DNS entry by passing `ip`. It can be either IPv4 or IPv6. The target hostname is set by passing `dns_ptr`."""  
...
class PostLoadBalancersIDActionsChangeDNSPtrActionResponseAction:
    ...
    error: PostLoadBalancersIDActionsChangeDNSPtrActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostLoadBalancersIDActionsChangeDNSPtrActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostLoadBalancersIDActionsChangeDNSPtrActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostLoadBalancersIDActionsChangeDNSPtrActionResponse:
    ...
    action: PostLoadBalancersIDActionsChangeDNSPtrActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
