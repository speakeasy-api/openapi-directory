...
class DescribeMergeConflictsRequest:
    headers: DescribeMergeConflictsHeaders = dataclasses.field()
    query_params: DescribeMergeConflictsQueryParams = dataclasses.field()
    request: shared_describemergeconflictsinput.DescribeMergeConflictsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
