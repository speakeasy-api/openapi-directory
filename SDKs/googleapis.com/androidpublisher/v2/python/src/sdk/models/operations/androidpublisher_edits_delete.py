...
class AndroidpublisherEditsDeleteRequest:
    path_params: AndroidpublisherEditsDeletePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsDeleteQueryParams = dataclasses.field()
    security: AndroidpublisherEditsDeleteSecurity = dataclasses.field()
