...
class OrderLineItemCommonItemStateEnum(str, Enum):
    EXECUTING = "Executing"
    SENT_TO_BILLING = "SentToBilling"
    COMPLETE = "Complete"
    CANCELLED = "Cancelled"

class OrderLineItemCommonItemTypeEnum(str, Enum):
    PRODUCT = "Product"
    FEE = "Fee"
    SERVICES = "Services"

class OrderLineItemCommonTaxModeEnum(str, Enum):
...
class OrderLineItemCommon:
    ...
    item_state: Optional[OrderLineItemCommonItemStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itemState') }})
    item_type: Optional[OrderLineItemCommonItemTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itemType') }})
    ...
    tax_mode: Optional[OrderLineItemCommonTaxModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('taxMode') }})
