 ...
 */
export class CreateVpnConnectionRequestOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: VpnTunnelOptionsSpecification })
 ...
 */
export enum CreateVpnConnectionRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateVpnConnectionRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateVpnConnectionRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class CreateVpnConnectionRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: CreateVpnConnectionRequestTagSpecifications })
