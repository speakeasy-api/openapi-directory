...
var ListProfilingGroupsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "profilingGroupNames" }),
        __metadata("design:type", Array)
    ], ListProfilingGroupsResponse.prototype, "profilingGroupNames", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: profilinggroupdescription_1.ProfilingGroupDescription }),
        (0, class_transformer_1.Expose)({ name: "profilingGroups" }),
