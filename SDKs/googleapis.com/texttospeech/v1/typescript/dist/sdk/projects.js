...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.texttospeechProjectsLocationsVoicesSynthesizeLongAudio = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TexttospeechProjectsLocationsVoicesSynthesizeLongAudioRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}:SynthesizeLongAudio", req.pathParams);
