...
public class GetNhFossilsIndividualsFossilRequest {
    ...
    public GetNhFossilsIndividualsFossilRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsIndividualsFossilRequest withXApiKey(String xApiKey) {
    ...
    public GetNhFossilsIndividualsFossilRequest withFossil(String fossil) {
        this.fossil = fossil;
        return this;
    }
    ...
    public GetNhFossilsIndividualsFossilRequest withThumbsize(Long thumbsize) {
