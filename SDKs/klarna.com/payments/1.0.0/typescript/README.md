...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/klarna.com/payments/1.0.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/klarna.com/payments/1.0.0/typescript
```
