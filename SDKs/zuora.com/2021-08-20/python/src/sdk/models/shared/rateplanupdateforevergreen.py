...
class RatePlanUpdateForEvergreen:
    r"""RatePlanUpdateForEvergreen
    Information about an order action of type `UpdateProduct`.
    
    """
    
    charge_updates: Optional[list[shared_chargeupdateforevergreen.ChargeUpdateForEvergreen]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('chargeUpdates') }})
