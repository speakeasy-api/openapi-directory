 ...
 */
export declare enum InstanceGroupListWarningCodeEnum {
...
export declare class InstanceGroupListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceGroupListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceGroupListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceGroupListWarningData[];
    /**
 ...
 */
export declare class InstanceGroupList extends SpeakeasyBase {
    /**
