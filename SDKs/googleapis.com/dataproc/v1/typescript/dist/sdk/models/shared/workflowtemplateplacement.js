...
exports.WorkflowTemplatePlacement = exports.WorkflowTemplatePlacementInput = void 0;
...
var WorkflowTemplatePlacementInput = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "clusterSelector" }),
        (0, class_transformer_1.Type)(function () { return clusterselector_1.ClusterSelector; }),
        __metadata("design:type", clusterselector_1.ClusterSelector)
    ], WorkflowTemplatePlacementInput.prototype, "clusterSelector", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "managedCluster" }),
        (0, class_transformer_1.Type)(function () { return managedcluster_1.ManagedClusterInput; }),
        __metadata("design:type", managedcluster_1.ManagedClusterInput)
...
var WorkflowTemplatePlacement = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "managedCluster" }),
        (0, class_transformer_1.Type)(function () { return managedcluster_1.ManagedCluster; }),
