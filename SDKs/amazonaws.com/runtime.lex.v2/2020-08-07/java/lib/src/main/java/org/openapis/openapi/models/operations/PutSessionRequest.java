...
public class PutSessionRequest {
    ...
    public PutSessionRequest(@JsonProperty("RequestBody") PutSessionRequestBody requestBody, @JsonProperty("botAliasId") String botAliasId, @JsonProperty("botId") String botId, @JsonProperty("localeId") String localeId, @JsonProperty("sessionId") String sessionId) {
        this.requestBody = requestBody;
        this.botAliasId = botAliasId;
        this.botId = botId;
        this.localeId = localeId;
