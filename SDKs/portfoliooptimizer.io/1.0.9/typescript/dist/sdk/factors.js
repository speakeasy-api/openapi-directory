...
var Factors = /** @class */ (function () {
    ...
    Factors.prototype.postFactorsResidualization = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostFactorsResidualizationResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postFactorsResidualization200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.PostFactorsResidualization200ApplicationJSON);
                    }
                    break;
            }
            return res;
