...
export class TagmanagerAccountsUserPermissionsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TagmanagerAccountsUserPermissionsUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TagmanagerAccountsUserPermissionsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
