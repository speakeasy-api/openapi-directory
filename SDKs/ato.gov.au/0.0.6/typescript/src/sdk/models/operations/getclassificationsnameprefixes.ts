...
export class GetClassificationsNamePrefixesRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class GetClassificationsNamePrefixesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.NamePrefix })
