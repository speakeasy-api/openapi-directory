...
type ClassroomCoursesTeachersDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ClassroomCoursesTeachersDeletePathParams struct {
...
type ClassroomCoursesTeachersDeleteQueryParams struct {
	// V1 error format.
...
type ClassroomCoursesTeachersDeleteRequest struct {
...
type ClassroomCoursesTeachersDeleteResponse struct {
	ContentType string
	// Successful response
