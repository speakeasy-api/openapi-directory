...
class POSTReconcileRefundResponseFinanceInformation:
    ...
    transferred_to_accounting: Optional[POSTReconcileRefundResponseFinanceInformationTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the refund was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite."""  
...
class POSTReconcileRefundResponseGatewayStateEnum(str, Enum):
    r"""The status of the refund in the gateway; used for reconciliation."""
    SETTLED = 'Settled'
...
class POSTReconcileRefundResponse:
    ...
    r"""The ID of the customer account that the refund is for."""  
    ...
    r"""The date and time when the transaction was cancelled, in `yyyy-mm-dd hh:mm:ss` format."""  
    ...
    r"""The date and time when the refund is created, in `yyyy-mm-dd hh:mm:ss` format."""  
    ...
    finance_information: Optional[POSTReconcileRefundResponseFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the refund."""  
    ...
    gateway_state: Optional[POSTReconcileRefundResponseGatewayStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gatewayState'), 'exclude': lambda f: f is None }})
    r"""The status of the refund in the gateway; used for reconciliation."""  
    ...
    method_type: Optional[POSTReconcileRefundResponseMethodTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('methodType'), 'exclude': lambda f: f is None }})
    r"""How an external refund was issued to a customer."""  
    number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('number'), 'exclude': lambda f: f is None }})
    r"""The unique identification number of the refund. For example, R-00000001."""  
    ...
    r"""The date when the refund takes effect, in `yyyy-mm-dd` format. For example, 2020-03-01."""  
    ...
    type: Optional[POSTReconcileRefundResponseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the refund."""  
    ...
    r"""The date and time when the refund was last updated, in `yyyy-mm-dd hh:mm:ss` format."""  
