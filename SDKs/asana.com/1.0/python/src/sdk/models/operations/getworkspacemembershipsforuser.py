...
class GetWorkspaceMembershipsForUser200ApplicationJSON:
    r"""Successfully retrieved the requested user's workspace memberships."""
    
    data: Optional[list[shared_workspacemembershipcompact.WorkspaceMembershipCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
