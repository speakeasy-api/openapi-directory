 ...
 */
export declare class DescribeTransitGatewayConnectsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayConnectsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeTransitGatewayConnectsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
