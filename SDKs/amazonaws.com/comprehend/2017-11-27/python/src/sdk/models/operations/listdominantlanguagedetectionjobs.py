...
class ListDominantLanguageDetectionJobsRequest:
    ...
    list_dominant_language_detection_jobs_request: shared_listdominantlanguagedetectionjobsrequest.ListDominantLanguageDetectionJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
