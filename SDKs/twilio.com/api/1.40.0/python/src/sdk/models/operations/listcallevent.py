...
class ListCallEventListCallEventResponse:
    ...
    events: Optional[list[shared_api_v2010_account_call_call_event.APIV2010AccountCallCallEvent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('events'), 'exclude': lambda f: f is None }})  
