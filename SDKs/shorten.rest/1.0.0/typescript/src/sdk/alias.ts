...
export class Alias {
  ...
  createAlias(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.CreateAliasSecurity(security);
    }
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createAliasResponseModel = utils.objectToClass(
              httpRes?.data,
              shared.CreateAliasResponseModel
            );
          }
          break;
      }
  ...
  deleteAlias(
    ...
    security: operations.DeleteAliasSecurity,
    config?: AxiosRequestConfig
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/aliases";
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DeleteAliasSecurity(security);
    }
    const client: AxiosInstance = utils.createSecurityClient(
      this._defaultClient,
      security
  ...
  getAlias(
    ...
    security: operations.GetAliasSecurity,
    config?: AxiosRequestConfig
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/aliases";
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetAliasSecurity(security);
    }
    const client: AxiosInstance = utils.createSecurityClient(
      this._defaultClient,
      security
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.aliasModel = utils.objectToClass(
              httpRes?.data,
              shared.AliasModel
            );
          }
  ...
  getAliases(
    ...
    security: operations.GetAliasesSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetAliasesSecurity(security);
    }
    const client: AxiosInstance = utils.createSecurityClient(
      this._defaultClient,
      security
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetAliasesResponse =
        new operations.GetAliasesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getAliasesModel = utils.objectToClass(
              httpRes?.data,
              shared.GetAliasesModel
            );
          }
          break;
      }
  ...
  updateAlias(
    ...
    security: operations.UpdateAliasSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.UpdateAliasSecurity(security);
    }
    const client: AxiosInstance = utils.createSecurityClient(
      this._defaultClient,
      security
