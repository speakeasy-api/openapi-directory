...
class MigrationcenterProjectsLocationsReportConfigsReportsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ReportInput $reportInput = null;
     ...
     * @var ?string $reportId
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=reportId')]
