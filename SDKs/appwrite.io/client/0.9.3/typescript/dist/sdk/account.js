...
var Account = /** @class */ (function () {
    ...
    **/
    Account.prototype.accountCreate = function (req, config) {
        var _a;
    ...
    **/
    Account.prototype.accountCreateAnonymousSession = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Account.prototype.accountCreateJwt = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Account.prototype.accountCreateOAuth2Session = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Account.prototype.accountCreateSession = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
