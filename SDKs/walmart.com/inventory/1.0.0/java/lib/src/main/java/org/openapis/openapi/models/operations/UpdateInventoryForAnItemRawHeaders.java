...
public class UpdateInventoryForAnItemRawHeaders {
    /**
    ...
    public UpdateInventoryForAnItemRawHeaders withWmConsumerChannelType(String wmConsumerChannelType) {
    ...
    public UpdateInventoryForAnItemRawHeaders withWmQosCorrelationId(String wmQosCorrelationId) {
    ...
    public UpdateInventoryForAnItemRawHeaders withWmSecAccessToken(String wmSecAccessToken) {
    ...
    public UpdateInventoryForAnItemRawHeaders withWmSvcName(String wmSvcName) {
