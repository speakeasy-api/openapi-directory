...
public class TaxApiDeleteRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public TaxApiDeleteRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public TaxApiDeleteRawHeaders withXAuthSecret(String xAuthSecret) {
