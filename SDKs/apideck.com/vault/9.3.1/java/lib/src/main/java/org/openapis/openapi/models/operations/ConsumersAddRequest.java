...
public class ConsumersAddRequest {
    ...
    public ConsumersAddRequest(@JsonProperty("ConsumerInput") org.openapis.openapi.models.shared.ConsumerInput consumerInput, @JsonProperty("x-apideck-app-id") String xApideckAppId) {
        this.consumerInput = consumerInput;
        this.xApideckAppId = xApideckAppId;
  }
}
