 ...
 */
public enum ExecuteSellTrasaction200ApplicationJSONTransactionsSubTypeEnum {
    ...
    private ExecuteSellTrasaction200ApplicationJSONTransactionsSubTypeEnum(String value) {
        this.value = value;
    }
}
