 ...
 */
export enum NodesLinkedNodesListNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class NodesLinkedNodesListNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
 ...
 */
export class NodesLinkedNodesListNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesLinkedNodesListNodeRelationships extends SpeakeasyBase {
  /**
...
export class NodesLinkedNodesListNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
