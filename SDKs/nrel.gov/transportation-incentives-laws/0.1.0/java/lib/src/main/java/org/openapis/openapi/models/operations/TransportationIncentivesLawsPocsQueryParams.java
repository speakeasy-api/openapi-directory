...
public class TransportationIncentivesLawsPocsQueryParams {
    /**
     * API Key
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=api_key")
    public String apiKey;
    public TransportationIncentivesLawsPocsQueryParams withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public TransportationIncentivesLawsPocsQueryParams withJurisdiction(String jurisdiction) {
