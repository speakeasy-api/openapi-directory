    ...
    public static void main(String[] args) {
        try {
            ...
            CvipcRequestBody req = new CvipcRequestBody(CvipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CvipcRequestBodyCertificateParameters("31-12-1980", "01234567890/12345678901234567/AA11AA1111", "Sunil Kumar", "M", "D0123456789", "Mobile Number,Chassis Number,Vehicle Registration Number");;
    ...
    public static void main(String[] args) {
        try {
            ...
            TwipcRequestBody req = new TwipcRequestBody(TwipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TwipcRequestBodyCertificateParameters("31-12-1980", "01234567890/12345678901234567/AA11AA1111", "Sunil Kumar", "M", "D0123456789", "Mobile Number,Chassis Number,Vehicle Registration Number");;
