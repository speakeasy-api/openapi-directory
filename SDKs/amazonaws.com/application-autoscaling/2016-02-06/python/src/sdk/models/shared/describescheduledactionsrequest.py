...
class DescribeScheduledActionsRequest:
    ...
    scheduled_action_names: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ScheduledActionNames'), 'exclude': lambda f: f is None }})  
