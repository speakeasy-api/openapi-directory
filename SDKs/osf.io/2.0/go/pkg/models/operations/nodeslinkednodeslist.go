...
// NodesLinkedNodesListNodeAttributesCategoryEnum - The category of the node, as selected by project contributors.
type NodesLinkedNodesListNodeAttributesCategoryEnum string

const (
	NodesLinkedNodesListNodeAttributesCategoryEnumAnalysis           NodesLinkedNodesListNodeAttributesCategoryEnum = "analysis"
	NodesLinkedNodesListNodeAttributesCategoryEnumCommunication      NodesLinkedNodesListNodeAttributesCategoryEnum = "communication"
	NodesLinkedNodesListNodeAttributesCategoryEnumData               NodesLinkedNodesListNodeAttributesCategoryEnum = "data"
	NodesLinkedNodesListNodeAttributesCategoryEnumHypothesis         NodesLinkedNodesListNodeAttributesCategoryEnum = "hypothesis"
	NodesLinkedNodesListNodeAttributesCategoryEnumInstrumentation    NodesLinkedNodesListNodeAttributesCategoryEnum = "instrumentation"
	NodesLinkedNodesListNodeAttributesCategoryEnumMethodsAndMeasures NodesLinkedNodesListNodeAttributesCategoryEnum = "methods and measures"
	NodesLinkedNodesListNodeAttributesCategoryEnumProcedure          NodesLinkedNodesListNodeAttributesCategoryEnum = "procedure"
	NodesLinkedNodesListNodeAttributesCategoryEnumProject            NodesLinkedNodesListNodeAttributesCategoryEnum = "project"
	NodesLinkedNodesListNodeAttributesCategoryEnumSoftware           NodesLinkedNodesListNodeAttributesCategoryEnum = "software"
	NodesLinkedNodesListNodeAttributesCategoryEnumOther              NodesLinkedNodesListNodeAttributesCategoryEnum = "other"
)

func (e NodesLinkedNodesListNodeAttributesCategoryEnum) ToPointer() *NodesLinkedNodesListNodeAttributesCategoryEnum {
	return &e
}

func (e *NodesLinkedNodesListNodeAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = NodesLinkedNodesListNodeAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NodesLinkedNodesListNodeAttributesCategoryEnum: %v", v)
	}
}

// NodesLinkedNodesListNodeAttributes - The properties of the node entity.
type NodesLinkedNodesListNodeAttributes struct {
...
type NodesLinkedNodesListNodeLinks struct {
...
type NodesLinkedNodesListNodeRelationships struct {
...
type NodesLinkedNodesListNode struct {
