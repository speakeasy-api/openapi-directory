...
class UpdateThingRuntimeConfigurationRequestBodyTelemetryConfiguration:
    ...
    telemetry: Optional[shared_telemetry_enum.TelemetryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Telemetry'), 'exclude': lambda f: f is None }})  
...
class UpdateThingRuntimeConfigurationRequestBody:
    ...
    telemetry_configuration: Optional[UpdateThingRuntimeConfigurationRequestBodyTelemetryConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TelemetryConfiguration'), 'exclude': lambda f: f is None }})
    r"""Configuration settings for running telemetry."""  
...
class UpdateThingRuntimeConfigurationRequest:
    ...
    request_body: UpdateThingRuntimeConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
