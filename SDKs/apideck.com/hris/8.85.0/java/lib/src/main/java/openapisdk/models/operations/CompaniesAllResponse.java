...
public class CompaniesAllResponse {
    ...
    public openapisdk.models.shared.GetHrisCompaniesResponse getHrisCompaniesResponse;
    public CompaniesAllResponse withGetHrisCompaniesResponse(openapisdk.models.shared.GetHrisCompaniesResponse getHrisCompaniesResponse) {
