...
func (e *DescribeDirectConnectGatewayAssociationProposalsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "OvertureService.DescribeDirectConnectGatewayAssociationProposals":
		*e = DescribeDirectConnectGatewayAssociationProposalsXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeDirectConnectGatewayAssociationProposalsXAmzTargetEnum: %s", s)
	}
}
