...
class RealtimebiddingBiddersPretargetingConfigsCreateRequest:
    ...
    r"""Required. Name of the bidder to create the pretargeting configuration for. Format: bidders/{bidderAccountId}"""  
    ...
    pretargeting_config_input: Optional[shared_pretargetingconfig.PretargetingConfigInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
