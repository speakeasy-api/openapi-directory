...
func (e *GetNetworkWirelessSsidSplashSettings200ApplicationJSONSelfRegistrationAuthorizationTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "auto":
		fallthrough
	case "self_email":
		*e = GetNetworkWirelessSsidSplashSettings200ApplicationJSONSelfRegistrationAuthorizationTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessSsidSplashSettings200ApplicationJSONSelfRegistrationAuthorizationTypeEnum: %s", s)
	}
}
...
func (e *GetNetworkWirelessSsidSplashSettings200ApplicationJSONSentryEnrollmentStrengthEnum) UnmarshalJSON(data []byte) error {
	...
	case "focused":
		fallthrough
	case "strict":
		*e = GetNetworkWirelessSsidSplashSettings200ApplicationJSONSentryEnrollmentStrengthEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessSsidSplashSettings200ApplicationJSONSentryEnrollmentStrengthEnum: %s", s)
	}
}
