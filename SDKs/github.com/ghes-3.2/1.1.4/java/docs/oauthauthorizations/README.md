...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteAuthorizationRequest req = new OauthAuthorizationsDeleteAuthorizationRequest(431760L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteGrantRequest req = new OauthAuthorizationsDeleteGrantRequest(374753L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetAuthorizationRequest req = new OauthAuthorizationsGetAuthorizationRequest(614528L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetGrantRequest req = new OauthAuthorizationsGetGrantRequest(661607L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppRequestBody("ab") {{
                                fingerprint = "error";
                                note = "Update all gems";
                                noteUrl = "possimus";
                                scopes = new String[]{{
