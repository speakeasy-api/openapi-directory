...
export class GetSpacesSpaceIdFoldersIdVatDeclarationsRequest extends SpeakeasyBase {
  /**
...
export class GetSpacesSpaceIdFoldersIdVatDeclarationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.VATDeclaration })
