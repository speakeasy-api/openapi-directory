...
import { MachineTypesScopedList } from "./machinetypesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum MachineTypeAggregatedListWarningCodeEnum {
...
export declare class MachineTypeAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class MachineTypeAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: MachineTypeAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: MachineTypeAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class MachineTypeAggregatedList extends SpeakeasyBase {
    /**
