...
export class Tiers {
  ...
  sqlTiersList(
    ...
    security: operations.SqlTiersListSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SqlTiersListResponse =
        new operations.SqlTiersListResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.tiersListResponse = utils.objectToClass(
              httpRes?.data,
              shared.TiersListResponse
            );
          }
          break;
      }
