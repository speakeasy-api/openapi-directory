...
func (e GetOrganizationApplianceSecurityEventsSortOrderEnum) ToPointer() *GetOrganizationApplianceSecurityEventsSortOrderEnum {
	return &e
}
...
func (e *GetOrganizationApplianceSecurityEventsSortOrderEnum) UnmarshalJSON(data []byte) error {
	...
	case "ascending":
		fallthrough
	case "descending":
		*e = GetOrganizationApplianceSecurityEventsSortOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceSecurityEventsSortOrderEnum: %v", v)
	}
}
