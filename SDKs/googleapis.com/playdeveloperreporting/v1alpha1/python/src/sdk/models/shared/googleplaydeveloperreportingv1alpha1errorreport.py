...
class GooglePlayDeveloperReportingV1alpha1ErrorReport:
    ...
    report_text: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reportText') }})
    type: Optional[GooglePlayDeveloperReportingV1alpha1ErrorReportTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
