...
public class BpcrdSecurity {
    ...
    public BpcrdSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public BpcrdSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public BpcrdSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
