...
class WorkflowexecutionsProjectsLocationsWorkflowsExecutionsGetRequest:
    path_params: WorkflowexecutionsProjectsLocationsWorkflowsExecutionsGetPathParams = dataclasses.field()
    query_params: WorkflowexecutionsProjectsLocationsWorkflowsExecutionsGetQueryParams = dataclasses.field()
    security: WorkflowexecutionsProjectsLocationsWorkflowsExecutionsGetSecurity = dataclasses.field()
