...
from ..shared import requestactivationresponse as shared_requestactivationresponse
...
class PostMerchantsMerchantIDActivateResponse:
    ...
    request_activation_response: Optional[shared_requestactivationresponse.RequestActivationResponse] = dataclasses.field(default=None)
