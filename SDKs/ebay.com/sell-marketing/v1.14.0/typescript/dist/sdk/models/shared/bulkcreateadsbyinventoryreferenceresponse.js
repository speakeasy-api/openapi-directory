...
var BulkCreateAdsByInventoryReferenceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: createadsbyinventoryreferenceresponse_1.CreateAdsByInventoryReferenceResponse }),
        (0, class_transformer_1.Expose)({ name: "responses" }),
        (0, class_transformer_1.Type)(function () { return createadsbyinventoryreferenceresponse_1.CreateAdsByInventoryReferenceResponse; }),
