...
var OrgSettings = /** @class */ (function () {
    function OrgSettings(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
     */
    OrgSettings.prototype.getV2OrgsNameSettings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetV2OrgsNameSettingsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/orgs/{name}/settings", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetV2OrgsNameSettingsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.orgSettings = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OrgSettings);
                    }
                    break;
     ...
     *
     */
    OrgSettings.prototype.putV2OrgsNameSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PutV2OrgsNameSettingsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
