...
class ContractualRelationshipLevelEnum(str, Enum):
...
class ContractualRelationship:
    ...
    level: Optional[ContractualRelationshipLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
