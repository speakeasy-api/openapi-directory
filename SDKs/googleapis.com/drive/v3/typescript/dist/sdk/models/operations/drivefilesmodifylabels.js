...
exports.DriveFilesModifyLabelsResponse = exports.DriveFilesModifyLabelsRequest = exports.DriveFilesModifyLabelsSecurity = exports.DriveFilesModifyLabelsSecurityOption3 = exports.DriveFilesModifyLabelsSecurityOption2 = exports.DriveFilesModifyLabelsSecurityOption1 = void 0;
...
var DriveFilesModifyLabelsRequest = /** @class */ (function (_super) {
    ...
    ], DriveFilesModifyLabelsRequest.prototype, "modifyLabelsRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], DriveFilesModifyLabelsRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DriveFilesModifyLabelsRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fileId",
        }),
        __metadata("design:type", String)
    ], DriveFilesModifyLabelsRequest.prototype, "fileId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DriveFilesModifyLabelsRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DriveFilesModifyLabelsRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DriveFilesModifyLabelsRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DriveFilesModifyLabelsRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DriveFilesModifyLabelsRequest.prototype, "userIp", void 0);
...
var DriveFilesModifyLabelsResponse = /** @class */ (function (_super) {
    ...
    ], DriveFilesModifyLabelsResponse.prototype, "rawResponse", void 0);
