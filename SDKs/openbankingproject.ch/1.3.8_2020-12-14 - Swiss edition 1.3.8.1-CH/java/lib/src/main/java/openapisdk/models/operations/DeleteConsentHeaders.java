...
public class DeleteConsentHeaders {
    ...
    public DeleteConsentHeaders withPsuAcceptCharset(String psuAcceptCharset) {
    ...
    public DeleteConsentHeaders withPsuAcceptEncoding(String psuAcceptEncoding) {
    ...
    public DeleteConsentHeaders withPsuAcceptLanguage(String psuAcceptLanguage) {
    ...
    public DeleteConsentHeaders withPsuDeviceId(String psuDeviceID) {
    ...
    public DeleteConsentHeaders withPsuGeoLocation(String psuGeoLocation) {
    ...
    public DeleteConsentHeaders withPsuHttpMethod(openapisdk.models.shared.PsuHttpMethodEnum psuHttpMethod) {
    ...
    public DeleteConsentHeaders withPsuIpAddress(String psuIPAddress) {
        this.psuIPAddress = psuIPAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-IP-Port")
    public String psuIPPort;
    public DeleteConsentHeaders withPsuIpPort(String psuIPPort) {
    ...
    public DeleteConsentHeaders withPsuUserAgent(String psuUserAgent) {
        this.psuUserAgent = psuUserAgent;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Signature")
    public String signature;
    public DeleteConsentHeaders withSignature(String signature) {
    ...
    public DeleteConsentHeaders withTppSignatureCertificate(String tppSignatureCertificate) {
    ...
    public DeleteConsentHeaders withXRequestId(String xRequestID) {
