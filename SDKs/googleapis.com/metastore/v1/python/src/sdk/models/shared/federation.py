...
class Federation:
    ...
    backend_metastores: Optional[dict[str, shared_backendmetastore.BackendMetastore]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('backendMetastores') }})
    ...
    state: Optional[FederationStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
