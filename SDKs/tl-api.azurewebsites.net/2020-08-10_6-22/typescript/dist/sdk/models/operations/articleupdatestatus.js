...
exports.ArticleUpdateStatusResponse = exports.ArticleUpdateStatusRequest = void 0;
...
var ArticleUpdateStatusRequest = /** @class */ (function (_super) {
    ...
    ], ArticleUpdateStatusRequest.prototype, "articleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", Number)
    ], ArticleUpdateStatusRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userName",
        }),
        __metadata("design:type", String)
    ], ArticleUpdateStatusRequest.prototype, "userName", void 0);
    return ArticleUpdateStatusRequest;
}(utils_1.SpeakeasyBase));
exports.ArticleUpdateStatusRequest = ArticleUpdateStatusRequest;
var ArticleUpdateStatusResponse = /** @class */ (function (_super) {
    ...
    ], ArticleUpdateStatusResponse.prototype, "rawResponse", void 0);
    return ArticleUpdateStatusResponse;
}(utils_1.SpeakeasyBase));
exports.ArticleUpdateStatusResponse = ArticleUpdateStatusResponse;
