...
public class PublishedOralQuestionGetQueryParams {
    /**
    ...
    public PublishedOralQuestionGetQueryParams withParametersAnsweringBodyIds(Integer[] parametersAnsweringBodyIds) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersAnsweringDateEnd(OffsetDateTime parametersAnsweringDateEnd) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersAnsweringDateStart(OffsetDateTime parametersAnsweringDateStart) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersAskingMemberIds(Integer[] parametersAskingMemberIds) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersOralQuestionTimeId(Integer parametersOralQuestionTimeId) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersQuestionType(PublishedOralQuestionGetParametersQuestionTypeEnum parametersQuestionType) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersSkip(Integer parametersSkip) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersTake(Integer parametersTake) {
    ...
    public PublishedOralQuestionGetQueryParams withParametersUINs(Integer[] parametersUINs) {
