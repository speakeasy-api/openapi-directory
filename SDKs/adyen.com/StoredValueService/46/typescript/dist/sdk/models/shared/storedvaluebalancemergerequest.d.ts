 ...
 */
export declare enum StoredValueBalanceMergeRequestShopperInteractionEnum {
    Ecommerce = "Ecommerce",
    ContAuth = "ContAuth",
    Moto = "Moto",
    Pos = "POS"
}
export declare class StoredValueBalanceMergeRequest extends SpeakeasyBase {
    amount?: Amount;
    /**
     ...
     */
    sourcePaymentMethod: Record<string, string>;
    /**
