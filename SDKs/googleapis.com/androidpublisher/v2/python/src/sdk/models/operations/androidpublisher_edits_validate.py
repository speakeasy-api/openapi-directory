...
class AndroidpublisherEditsValidateRequest:
    path_params: AndroidpublisherEditsValidatePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsValidateQueryParams = dataclasses.field()
    security: AndroidpublisherEditsValidateSecurity = dataclasses.field()
