...
from ..shared import listedgedeploymentplanssortby_enum as shared_listedgedeploymentplanssortby_enum
...
class ListEdgeDeploymentPlansRequest:
    ...
    device_fleet_name_contains: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeviceFleetNameContains'), 'exclude': lambda f: f is None }})  
    ...
    sort_by: Optional[shared_listedgedeploymentplanssortby_enum.ListEdgeDeploymentPlansSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
