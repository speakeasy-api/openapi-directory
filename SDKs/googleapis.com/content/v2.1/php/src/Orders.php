...
class Orders 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderResponse
     */
	public function contentOrdersCaptureOrder(
        \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{merchantId}/orders/{orderId}/captureOrder', \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "requestBody", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ContentOrdersCaptureOrderResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->captureOrderResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CaptureOrderResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemResponse
     */
	public function contentOrdersRefunditem(
        \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{merchantId}/orders/{orderId}/refunditem', \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "ordersRefundItemRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefunditemResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->ordersRefundItemResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\OrdersRefundItemResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderResponse
     */
	public function contentOrdersRefundorder(
        \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{merchantId}/orders/{orderId}/refundorder', \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "ordersRefundOrderRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ContentOrdersRefundorderResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->ordersRefundOrderResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\OrdersRefundOrderResponse', 'json');
            }
        }
