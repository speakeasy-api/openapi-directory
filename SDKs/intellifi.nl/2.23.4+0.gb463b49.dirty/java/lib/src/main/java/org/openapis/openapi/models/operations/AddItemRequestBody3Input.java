...
public class AddItemRequestBody3Input {
    /**
    ...
    public AddItemRequestBody3Input withCodeHex(String codeHex) {
    ...
    public AddItemRequestBody3Input withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public AddItemRequestBody3Input withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    public AddItemRequestBody3Input withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public AddItemRequestBody3Input withLocationRequest(String locationRequest) {
    ...
    public AddItemRequestBody3Input withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public AddItemRequestBody3Input withProtocol(org.openapis.openapi.models.shared.ItemProtocolEnum protocol) {
    ...
    public AddItemRequestBody3Input withTechnology(org.openapis.openapi.models.shared.TechnologyEnum technology) {
    ...
    public AddItemRequestBody3Input withType(org.openapis.openapi.models.shared.ItemTypeEnum type) {
        this.type = type;
        return this;
    }
    
    public AddItemRequestBody3Input(){}
}
