...
class AndroidpublisherEditsTracksPatchRequest:
    ...
    track_path_parameter: str = dataclasses.field(metadata={'path_param': { 'field_name': 'track', 'style': 'simple', 'explode': False }})
    r"""Identifier of the track. [More on track name](https://developers.google.com/android-publisher/tracks#ff-track-name)"""  
    ...
    track1: Optional[shared_track.Track] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
