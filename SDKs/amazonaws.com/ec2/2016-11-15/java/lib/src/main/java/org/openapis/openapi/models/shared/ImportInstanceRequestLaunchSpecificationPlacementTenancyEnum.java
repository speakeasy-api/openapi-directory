 ...
 */
public enum ImportInstanceRequestLaunchSpecificationPlacementTenancyEnum {
    DEFAULT_("default"),
    DEDICATED("dedicated"),
    HOST("host");
    ...
    private ImportInstanceRequestLaunchSpecificationPlacementTenancyEnum(String value) {
        this.value = value;
    }
}
