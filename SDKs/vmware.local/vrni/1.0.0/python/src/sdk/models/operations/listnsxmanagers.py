...
class ListNsxManagersQueryParams:
...
@dataclasses.dataclass
class ListNsxManagersSecurity:
    api_key_auth: shared_security.SchemeAPIKeyAuth = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class ListNsxManagersRequest:
    query_params: ListNsxManagersQueryParams = dataclasses.field()
    security: ListNsxManagersSecurity = dataclasses.field()
