...
export class CloudresourcemanagerTagValuesListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerTagValuesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudresourcemanagerTagValuesListSecurity extends SpeakeasyBase {
...
export class CloudresourcemanagerTagValuesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerTagValuesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
