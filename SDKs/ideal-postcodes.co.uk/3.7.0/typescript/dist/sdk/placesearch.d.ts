...
export declare class PlaceSearch {
     ...
     *
     */
    findPlace(req: operations.FindPlaceRequest, config?: AxiosRequestConfig): Promise<operations.FindPlaceResponse>;
    /**
     * Resolve Place
     *
     * @remarks
     ...
     *
     */
    resolvePlace(req: operations.ResolvePlaceRequest, config?: AxiosRequestConfig): Promise<operations.ResolvePlaceResponse>;
}
