...
exports.GetOrdersIdHistoryJsonResponse = exports.GetOrdersIdHistoryJsonRequest = void 0;
...
var GetOrdersIdHistoryJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetOrdersIdHistoryJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetOrdersIdHistoryJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetOrdersIdHistoryJsonRequest.prototype, "login", void 0);
    return GetOrdersIdHistoryJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetOrdersIdHistoryJsonRequest = GetOrdersIdHistoryJsonRequest;
var GetOrdersIdHistoryJsonResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.OrderHistory }),
    ...
    ], GetOrdersIdHistoryJsonResponse.prototype, "rawResponse", void 0);
    return GetOrdersIdHistoryJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetOrdersIdHistoryJsonResponse = GetOrdersIdHistoryJsonResponse;
