...
class TranslateTextRequest:
    headers: TranslateTextHeaders = dataclasses.field()
    request: shared_translatetextrequest.TranslateTextRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
