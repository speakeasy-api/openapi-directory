...
class RegisterActivityTypeRequest:
    ...
    register_activity_type_input: shared_registeractivitytypeinput.RegisterActivityTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
