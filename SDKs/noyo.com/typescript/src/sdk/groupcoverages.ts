...
export class GroupCoverages {
  ...
  createGroupCoverage(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/api/v1/applications/{application_id}/group_coverages",
      req
    );
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreateGroupCoverageResponse =
        new operations.CreateGroupCoverageResponse({
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.groupCoverageResult = utils.objectToClass(
              httpRes?.data,
              shared.GroupCoverageResult
            );
          }
          break;
      }
  ...
  editGroupCoverage(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/api/v1/group_coverages/{group_coverage_id}/{version}",
      req
    );
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.EditGroupCoverageResponse =
        new operations.EditGroupCoverageResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getApplicationGroupCoverages(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetApplicationGroupCoveragesResponse =
        new operations.GetApplicationGroupCoveragesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paginatedGroupCoverageResult = utils.objectToClass(
              httpRes?.data,
              shared.PaginatedGroupCoverageResult
            );
          }
          break;
      }
  ...
  getGroupCoverage(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/api/v1/group_coverages/{group_coverage_id}",
      req
    );
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetGroupCoverageResponse =
        new operations.GetGroupCoverageResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
