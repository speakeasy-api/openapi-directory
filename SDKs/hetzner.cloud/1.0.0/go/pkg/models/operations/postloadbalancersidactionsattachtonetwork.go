...
func (e PostLoadBalancersIDActionsAttachToNetworkActionResponseActionStatusEnum) ToPointer() *PostLoadBalancersIDActionsAttachToNetworkActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostLoadBalancersIDActionsAttachToNetworkActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostLoadBalancersIDActionsAttachToNetworkActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostLoadBalancersIDActionsAttachToNetworkActionResponseActionStatusEnum: %v", v)
	}
}
