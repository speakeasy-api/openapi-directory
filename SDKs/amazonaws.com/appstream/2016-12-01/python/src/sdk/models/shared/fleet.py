...
class Fleet:
    ...
    compute_capacity_status: shared_computecapacitystatus.ComputeCapacityStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ComputeCapacityStatus') }})  
    ...
    state: shared_fleetstate_enum.FleetStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('State') }})  
    ...
    fleet_errors: Optional[list[shared_fleeterror.FleetError]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FleetErrors'), 'exclude': lambda f: f is None }})  
