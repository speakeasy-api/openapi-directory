...
public class Operations {
    ...
    **/
    public openapisdk.models.operations.CloudresourcemanagerOperationsGetResponse cloudresourcemanagerOperationsGet(openapisdk.models.operations.CloudresourcemanagerOperationsGetRequest request) throws Exception {
        ...
        openapisdk.models.operations.CloudresourcemanagerOperationsGetResponse res = new openapisdk.models.operations.CloudresourcemanagerOperationsGetResponse() {{
            operation = null;
        }};
