...
@dataclasses.dataclass
class Adexchangebuyer2AccountsCreativesCreateQueryParams:
    dollar_xgafv: Optional[shared__xgafv_enum.XgafvEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': '$.xgafv', 'style': 'form', 'explode': True }})
    access_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'access_token', 'style': 'form', 'explode': True }})
    alt: Optional[shared_alt_enum.AltEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    callback: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'callback', 'style': 'form', 'explode': True }})
    duplicate_id_mode: Optional[Adexchangebuyer2AccountsCreativesCreateDuplicateIDModeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'duplicateIdMode', 'style': 'form', 'explode': True }})
...
class Adexchangebuyer2AccountsCreativesCreateRequest:
    path_params: Adexchangebuyer2AccountsCreativesCreatePathParams = dataclasses.field()
    query_params: Adexchangebuyer2AccountsCreativesCreateQueryParams = dataclasses.field()
    security: Adexchangebuyer2AccountsCreativesCreateSecurity = dataclasses.field()
