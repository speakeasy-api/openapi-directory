...
export class IntegrationsProjectsLocationsAppsScriptProjectsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsAppsScriptProjectsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsAppsScriptProjectsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
