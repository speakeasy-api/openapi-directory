...
exports.GetGeocodeResponse = exports.GetGeocodeRequest = void 0;
...
var GetGeocodeRequest = /** @class */ (function (_super) {
    ...
    ], GetGeocodeRequest.prototype, "debug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetGeocodeRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locale",
        }),
        __metadata("design:type", String)
    ], GetGeocodeRequest.prototype, "locale", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=point" }),
        __metadata("design:type", String)
    ], GetGeocodeRequest.prototype, "point", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=provider",
        }),
        __metadata("design:type", String)
    ], GetGeocodeRequest.prototype, "provider", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q" }),
        __metadata("design:type", String)
    ], GetGeocodeRequest.prototype, "q", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=reverse",
        }),
        __metadata("design:type", Boolean)
    ], GetGeocodeRequest.prototype, "reverse", void 0);
...
var GetGeocodeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.GeocodingResponse)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetGeocodeResponse.prototype, "rawResponse", void 0);
