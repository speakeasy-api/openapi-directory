...
func (s *trafficReport) GetTrafficReport(ctx context.Context, request operations.GetTrafficReportRequest, security operations.GetTrafficReportSecurity) (*operations.GetTrafficReportResponse, error) {
	baseURL := s.serverURL
