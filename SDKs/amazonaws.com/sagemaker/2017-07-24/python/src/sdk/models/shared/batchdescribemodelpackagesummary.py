...
class BatchDescribeModelPackageSummary:
    r"""Provides summary information about the model package."""
    ...
    inference_specification: shared_inferencespecification.InferenceSpecification = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InferenceSpecification') }})
