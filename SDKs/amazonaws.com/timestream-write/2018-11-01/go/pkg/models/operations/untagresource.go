...
const (
	UntagResourceXAmzTargetEnumTimestream20181101UntagResource UntagResourceXAmzTargetEnum = "Timestream_20181101.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "Timestream_20181101.UntagResource":
