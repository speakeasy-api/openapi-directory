...
class LineItemTransaction:
    ...
    adjustment_group_code: Optional[LineItemTransactionAdjustmentGroupCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('adjustment_group_code') }})
    adjustment_reason: Optional[LineItemTransactionAdjustmentReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('adjustment_reason') }})
    ...
    claim_status: Optional[LineItemTransactionClaimStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('claim_status') }})
    ...
    ins_name: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ins_name') }})
    ins_paid: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ins_paid') }})
