...
export class GkehubProjectsLocationsScopesDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsScopesDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsScopesDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
