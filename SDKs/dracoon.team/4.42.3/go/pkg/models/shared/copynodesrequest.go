...
func (e CopyNodesRequestResolutionStrategyEnum) ToPointer() *CopyNodesRequestResolutionStrategyEnum {
	return &e
}
...
func (e *CopyNodesRequestResolutionStrategyEnum) UnmarshalJSON(data []byte) error {
	...
	case "overwrite":
		fallthrough
	case "fail":
		*e = CopyNodesRequestResolutionStrategyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CopyNodesRequestResolutionStrategyEnum: %v", v)
	}
}
