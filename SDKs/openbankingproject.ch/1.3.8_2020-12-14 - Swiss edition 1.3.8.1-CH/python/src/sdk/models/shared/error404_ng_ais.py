...
from ..shared import tppmessage404_ais as shared_tppmessage404_ais
...
class Error404NgAis:
    ...
    tpp_messages: Optional[list[shared_tppmessage404_ais.TppMessage404Ais]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
