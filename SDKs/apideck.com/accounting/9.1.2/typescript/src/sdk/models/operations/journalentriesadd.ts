...
export class JournalEntriesAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class JournalEntriesAddRequest extends SpeakeasyBase {
...
export class JournalEntriesAddResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
