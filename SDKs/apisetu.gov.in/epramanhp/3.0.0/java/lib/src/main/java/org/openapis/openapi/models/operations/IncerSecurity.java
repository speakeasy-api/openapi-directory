...
public class IncerSecurity {
    ...
    public IncerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public IncerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public IncerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
