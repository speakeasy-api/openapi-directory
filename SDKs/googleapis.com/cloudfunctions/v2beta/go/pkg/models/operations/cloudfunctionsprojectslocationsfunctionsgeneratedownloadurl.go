...
type CloudfunctionsProjectsLocationsFunctionsGenerateDownloadURLSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudfunctionsProjectsLocationsFunctionsGenerateDownloadURLPathParams struct {
	// Required. The name of function for which source code Google Cloud Storage signed URL should be generated.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type CloudfunctionsProjectsLocationsFunctionsGenerateDownloadURLQueryParams struct {
	// V1 error format.
...
type CloudfunctionsProjectsLocationsFunctionsGenerateDownloadURLRequest struct {
...
type CloudfunctionsProjectsLocationsFunctionsGenerateDownloadURLResponse struct {
	ContentType string
	// Successful response
