 ...
 */
public enum MeetingUpdateApplicationJSONSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum {
    APPROVE("approve"),
    DENY("deny");
    ...
    private MeetingUpdateApplicationJSONSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum(String value) {
        this.value = value;
    }
}
