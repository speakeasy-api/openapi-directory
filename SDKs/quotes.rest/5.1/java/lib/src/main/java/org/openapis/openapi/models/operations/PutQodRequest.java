...
public class PutQodRequest {
    ...
    public PutQodRequest withAuthors(String authors) {
    ...
    public PutQodRequest withLanguage(String language) {
    ...
    public PutQodRequest withPrivate(Boolean private_) {
    ...
    public PutQodRequest withRepeatAfter(Long repeatAfter) {
    ...
    public PutQodRequest withSfw(Boolean sfw) {
        this.sfw = sfw;
        return this;
    }
    ...
    public PutQodRequest withTitle(String title) {
        this.title = title;
        return this;
    }
    
    public PutQodRequest(@JsonProperty("title") String title) {
        this.title = title;
  }
}
