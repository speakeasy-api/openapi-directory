...
class TendersUpdateRequest:
    headers: TendersUpdateHeaders = dataclasses.field()
    path_params: TendersUpdatePathParams = dataclasses.field()
    query_params: TendersUpdateQueryParams = dataclasses.field()
    request: shared_tender.TenderInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: TendersUpdateSecurity = dataclasses.field()
