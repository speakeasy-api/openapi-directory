...
export declare class NetworksecurityProjectsLocationsTlsInspectionPoliciesCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsTlsInspectionPoliciesCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsTlsInspectionPoliciesCreateResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
