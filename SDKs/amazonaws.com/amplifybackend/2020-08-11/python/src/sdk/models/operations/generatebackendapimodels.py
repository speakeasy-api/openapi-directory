...
from ..shared import generatebackendapimodelsresponse as shared_generatebackendapimodelsresponse
...
class GenerateBackendAPIModelsRequest:
    headers: GenerateBackendAPIModelsHeaders = dataclasses.field()
    path_params: GenerateBackendAPIModelsPathParams = dataclasses.field()
    request: GenerateBackendAPIModelsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GenerateBackendAPIModelsResponse:
    ...
    generate_backend_api_models_response: Optional[shared_generatebackendapimodelsresponse.GenerateBackendAPIModelsResponse] = dataclasses.field(default=None)
