...
var GetCommentsForComparedCommitOutput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: commentsforcomparedcommit_1.CommentsForComparedCommit }),
        (0, class_transformer_1.Expose)({ name: "commentsForComparedCommitData" }),
        (0, class_transformer_1.Type)(function () { return commentsforcomparedcommit_1.CommentsForComparedCommit; }),
