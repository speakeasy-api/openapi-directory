...
func (e KkidChorelistGetDayEnum) ToPointer() *KkidChorelistGetDayEnum {
	return &e
}
...
func (e *KkidChorelistGetDayEnum) UnmarshalJSON(data []byte) error {
	...
	case "Saturday":
		fallthrough
	case "Weekly":
		*e = KkidChorelistGetDayEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for KkidChorelistGetDayEnum: %v", v)
	}
}
