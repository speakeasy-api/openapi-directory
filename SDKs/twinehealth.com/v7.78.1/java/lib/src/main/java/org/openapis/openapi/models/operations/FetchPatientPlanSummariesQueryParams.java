...
public class FetchPatientPlanSummariesQueryParams {
    /**
    ...
    public FetchPatientPlanSummariesQueryParams withFilterGroups(String filterGroups) {
    ...
    public FetchPatientPlanSummariesQueryParams withFilterOrganization(String filterOrganization) {
    ...
    public FetchPatientPlanSummariesQueryParams withFilterPatient(String filterPatient) {
    ...
    public FetchPatientPlanSummariesQueryParams withInclude(FetchPatientPlanSummariesIncludeEnum include) {
