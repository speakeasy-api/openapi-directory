...
from ..shared import deleteresiliencypolicyresponse as shared_deleteresiliencypolicyresponse
...
class DeleteResiliencyPolicyRequest:
    ...
    request_body: DeleteResiliencyPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteResiliencyPolicyResponse:
    ...
    r"""ConflictException"""  
    delete_resiliency_policy_response: Optional[shared_deleteresiliencypolicyresponse.DeleteResiliencyPolicyResponse] = dataclasses.field(default=None)
    r"""Success"""  
