...
type DfareportingAccountUserProfilesPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DfareportingAccountUserProfilesPatchPathParams struct {
	// User profile ID associated with this request.
	ProfileID string `pathParam:"style=simple,explode=false,name=profileId"`
}

type DfareportingAccountUserProfilesPatchQueryParams struct {
	// V1 error format.
...
type DfareportingAccountUserProfilesPatchRequest struct {
...
type DfareportingAccountUserProfilesPatchResponse struct {
	// Successful response
