...
public class GetRecordsFormatRequest {
    ...
    public GetRecordsFormatRequest withAuthenticationToken(String authenticationToken) {
    ...
    public GetRecordsFormatRequest withAndCategory(GetRecordsFormatAndCategoryEnum andCategory) {
    ...
    public GetRecordsFormatRequest withAndCentury(String andCentury) {
    ...
    public GetRecordsFormatRequest withAndCollection(String andCollection) {
    ...
    public GetRecordsFormatRequest withAndContentPartner(String andContentPartner) {
    ...
    public GetRecordsFormatRequest withAndCreator(String andCreator) {
    ...
    public GetRecordsFormatRequest withAndDate(String andDate) {
    ...
    public GetRecordsFormatRequest withAndDcType(String andDcType) {
    ...
    public GetRecordsFormatRequest withAndDecade(String andDecade) {
    ...
    public GetRecordsFormatRequest withAndFormat(String andFormat) {
    ...
    public GetRecordsFormatRequest withAndHasLargeThumbnailUrl(GetRecordsFormatAndHasLargeThumbnailUrlEnum andHasLargeThumbnailUrl) {
    ...
    public GetRecordsFormatRequest withAndHasLatLng(GetRecordsFormatAndHasLatLngEnum andHasLatLng) {
    ...
    public GetRecordsFormatRequest withAndIsCommercialUse(Boolean andIsCommercialUse) {
    ...
    public GetRecordsFormatRequest withAndOrFilterField(String andOrFilterField) {
    ...
    public GetRecordsFormatRequest withAndPlacename(String andPlacename) {
    ...
    public GetRecordsFormatRequest withAndPrimaryCollection(String andPrimaryCollection) {
    ...
    public GetRecordsFormatRequest withAndSubject(String andSubject) {
    ...
    public GetRecordsFormatRequest withAndTitle(String andTitle) {
    ...
    public GetRecordsFormatRequest withAndUsage(GetRecordsFormatAndUsageEnum andUsage) {
    ...
    public GetRecordsFormatRequest withAndYear(String andYear) {
    ...
    public GetRecordsFormatRequest withDirection(GetRecordsFormatDirectionEnum direction) {
    ...
    public GetRecordsFormatRequest withExcludeFiltersFromFacets(Boolean excludeFiltersFromFacets) {
    ...
    public GetRecordsFormatRequest withFacets(GetRecordsFormatFacetsEnum[] facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetRecordsFormatRequest withFacetsPage(Long facetsPage) {
    ...
    public GetRecordsFormatRequest withFacetsPerPage(Long facetsPerPage) {
    ...
    public GetRecordsFormatRequest withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public GetRecordsFormatRequest withFormat(org.openapis.openapi.models.shared.FormatEnum format) {
        this.format = format;
        return this;
    }
    ...
    public GetRecordsFormatRequest withGeoBbox(String geoBbox) {
    ...
    public Long page;
    public GetRecordsFormatRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetRecordsFormatRequest withPerPage(Long perPage) {
    ...
    public GetRecordsFormatRequest withSort(GetRecordsFormatSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public String text;
    public GetRecordsFormatRequest withText(String text) {
        this.text = text;
        return this;
    }
    ...
    public GetRecordsFormatRequest withWithoutFilterField(String withoutFilterField) {
