...
class ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesFormatEnum $format
     */
	...
	{
		$this->format = \OpenAPI\OpenAPI\Models\Operations\ProjectedPlayerGameStatsByPlayerWInjuriesLineupsDfsSalariesFormatEnum::XML;
		$this->playerid = "";
		$this->season = "";
		$this->week = "";
	}
