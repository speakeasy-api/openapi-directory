 ...
 *
 */
export declare class ProxyCreatePaymentMethodGatewayOptionData extends SpeakeasyBase {
 ...
 *
 */
export declare enum ProxyCreatePaymentMethodTypeEnum {
    Ach = "ACH",
 ...
 *
 */
export declare class ProxyCreatePaymentMethod extends SpeakeasyBase {
    /**
