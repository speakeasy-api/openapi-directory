...
public class FirebaseappcheckProjectsAppsExchangeAppAttestAttestationRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest request;
    public FirebaseappcheckProjectsAppsExchangeAppAttestAttestationRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest request) {
