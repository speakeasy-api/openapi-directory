...
public class VrwmiSecurity {
    ...
    public VrwmiSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public VrwmiSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public VrwmiSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
