...
export class PatientsCcdaPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class PatientsCcdaQueryParams extends SpeakeasyBase {
...
export class PatientsCcdaSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  drchronoOauth2: shared.SchemeDrchronoOauth2;
}


export class PatientsCcdaRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PatientsCcdaResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
