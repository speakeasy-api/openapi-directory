...
public class GicerRequestBodyCertificateParameters {
    ...
    public GicerRequestBodyCertificateParameters(@JsonProperty("customer_Id") String customerId, @JsonProperty("policy_Number") String policyNumber, @JsonProperty("policy_StartDate") String policyStartDate) {
        this.customerId = customerId;
        this.policyNumber = policyNumber;
        this.policyStartDate = policyStartDate;
  }
