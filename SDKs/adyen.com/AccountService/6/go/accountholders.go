...
func (s *accountHolders) PostCloseStores(ctx context.Context, request shared.CloseStoresRequest, security operations.PostCloseStoresSecurity) (*operations.PostCloseStoresResponse, error) {
	baseURL := s.serverURL
