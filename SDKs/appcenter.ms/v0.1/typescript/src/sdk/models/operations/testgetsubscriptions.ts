...
export class TestGetSubscriptionsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TestGetSubscriptionsRequest extends SpeakeasyBase {
  /**
...
export class TestGetSubscriptionsSubscriptionSubscriptionTier extends SpeakeasyBase {
  /**
 ...
 */
export class TestGetSubscriptionsSubscription extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "tier" })
  @Type(() => TestGetSubscriptionsSubscriptionSubscriptionTier)
  tier?: TestGetSubscriptionsSubscriptionSubscriptionTier;
}

export class TestGetSubscriptionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
