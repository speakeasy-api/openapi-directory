...
func (e *ModifierGroupIndicatesWhetherMultipleOptionsFromTheModifierGroupCanBeAppliedToASingleOrMultipleModifiersEnum) UnmarshalJSON(data []byte) error {
	...
	case "single":
		fallthrough
	case "multiple":
		*e = ModifierGroupIndicatesWhetherMultipleOptionsFromTheModifierGroupCanBeAppliedToASingleOrMultipleModifiersEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ModifierGroupIndicatesWhetherMultipleOptionsFromTheModifierGroupCanBeAppliedToASingleOrMultipleModifiersEnum: %s", s)
	}
}
