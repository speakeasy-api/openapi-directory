...
exports.GetTagsFromCisInstructionResponse = exports.GetTagsFromCisInstructionRequest = void 0;
...
var GetTagsFromCisInstructionRequest = /** @class */ (function (_super) {
    ...
    ], GetTagsFromCisInstructionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagsFromCisInstructionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisInstructionId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromCisInstructionRequest.prototype, "cisInstructionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromCisInstructionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromCisInstructionRequest.prototype, "subContractorId", void 0);
    return GetTagsFromCisInstructionRequest;
}(utils_1.SpeakeasyBase));
exports.GetTagsFromCisInstructionRequest = GetTagsFromCisInstructionRequest;
var GetTagsFromCisInstructionResponse = /** @class */ (function (_super) {
    ...
    ], GetTagsFromCisInstructionResponse.prototype, "rawResponse", void 0);
    return GetTagsFromCisInstructionResponse;
}(utils_1.SpeakeasyBase));
exports.GetTagsFromCisInstructionResponse = GetTagsFromCisInstructionResponse;
