...
func (e *DashboardWebinarParticipantsQOSTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "past":
		fallthrough
	case "live":
		*e = DashboardWebinarParticipantsQOSTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DashboardWebinarParticipantsQOSTypeEnum: %s", s)
	}
}
...
// DashboardWebinarParticipantsQOSParticipantQOSListParticipantQOSUserQOSVideoDeviceToCrc - QoS metrics on video output received by a participant who joined the meeting via a Cloud Room Connector.
