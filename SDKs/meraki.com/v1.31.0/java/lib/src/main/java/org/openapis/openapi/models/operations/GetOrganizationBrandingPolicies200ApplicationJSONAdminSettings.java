 ...
 */
public class GetOrganizationBrandingPolicies200ApplicationJSONAdminSettings {
    /**
    ...
    public GetOrganizationBrandingPolicies200ApplicationJSONAdminSettingsAppliesToEnum appliesTo;
    public GetOrganizationBrandingPolicies200ApplicationJSONAdminSettings withAppliesTo(GetOrganizationBrandingPolicies200ApplicationJSONAdminSettingsAppliesToEnum appliesTo) {
    ...
    public GetOrganizationBrandingPolicies200ApplicationJSONAdminSettings withValues(String[] values) {
        this.values = values;
        return this;
    }
