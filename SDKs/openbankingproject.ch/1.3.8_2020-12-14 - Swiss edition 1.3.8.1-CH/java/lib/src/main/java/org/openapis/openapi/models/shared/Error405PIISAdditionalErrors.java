...
/**
 * Error405PIISAdditionalErrors - This is a data element to support the declaration of additional errors in the context of [RFC7807].
 */
public class Error405PIISAdditionalErrors {
    ...
    public Error405PIISAdditionalErrors(@JsonProperty("code") MessageCode405PIISEnum code) {
        this.code = code;
  }
}
