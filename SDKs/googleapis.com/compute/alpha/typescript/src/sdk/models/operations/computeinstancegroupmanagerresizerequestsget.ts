...
export class ComputeInstanceGroupManagerResizeRequestsGetSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ComputeInstanceGroupManagerResizeRequestsGetSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ComputeInstanceGroupManagerResizeRequestsGetSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ComputeInstanceGroupManagerResizeRequestsGetSecurity extends SpeakeasyBase {
...
export class ComputeInstanceGroupManagerResizeRequestsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ComputeInstanceGroupManagerResizeRequestsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
