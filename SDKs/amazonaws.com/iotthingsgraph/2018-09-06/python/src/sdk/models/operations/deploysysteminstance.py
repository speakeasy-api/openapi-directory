...
class DeploySystemInstanceRequest:
    ...
    deploy_system_instance_request: shared_deploysysteminstancerequest.DeploySystemInstanceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
