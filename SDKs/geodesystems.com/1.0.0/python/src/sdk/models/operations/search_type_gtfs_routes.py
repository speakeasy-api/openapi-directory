...
class SearchTypeGtfsRoutesQueryParams:
...
@dataclasses.dataclass
class SearchTypeGtfsRoutesRequest:
    query_params: SearchTypeGtfsRoutesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeGtfsRoutesResponse:
