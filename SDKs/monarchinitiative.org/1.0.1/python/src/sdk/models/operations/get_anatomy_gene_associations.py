...
class GetAnatomyGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetAnatomyGeneAssociationsQueryParams:
...
@dataclasses.dataclass
class GetAnatomyGeneAssociationsRequest:
    path_params: GetAnatomyGeneAssociationsPathParams = dataclasses.field()
    query_params: GetAnatomyGeneAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetAnatomyGeneAssociationsResponse:
