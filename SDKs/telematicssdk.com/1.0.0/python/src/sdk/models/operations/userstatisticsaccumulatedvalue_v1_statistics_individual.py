...
class UserStatisticsAccumulatedValueV1StatisticsIndividual200ApplicationJSON:
    ...
    result: Optional[UserStatisticsAccumulatedValueV1StatisticsIndividual200ApplicationJSONResult] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Result') }})
...
class UserStatisticsAccumulatedValueV1StatisticsIndividualRequest:
    query_params: UserStatisticsAccumulatedValueV1StatisticsIndividualQueryParams = dataclasses.field()
