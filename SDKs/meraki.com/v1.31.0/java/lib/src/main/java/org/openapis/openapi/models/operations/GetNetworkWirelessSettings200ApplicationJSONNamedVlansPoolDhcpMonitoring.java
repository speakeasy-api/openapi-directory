 ...
 */
public class GetNetworkWirelessSettings200ApplicationJSONNamedVlansPoolDhcpMonitoring {
    /**
    ...
    public GetNetworkWirelessSettings200ApplicationJSONNamedVlansPoolDhcpMonitoring withDuration(Long duration) {
    ...
    public GetNetworkWirelessSettings200ApplicationJSONNamedVlansPoolDhcpMonitoring withEnabled(Boolean enabled) {
