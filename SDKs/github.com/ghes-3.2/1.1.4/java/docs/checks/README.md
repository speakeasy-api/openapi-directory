...
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#create-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#create-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksCreateSuiteRequest req = new ChecksCreateSuiteRequest(                new ChecksCreateSuiteRequestBody("aperiam");, "delectus", "dolorem");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#get-a-check-run>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetRequest req = new ChecksGetRequest(292147L, "labore", "adipisci");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#get-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetSuiteRequest req = new ChecksGetSuiteRequest(677263L, "architecto", "quae");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-run-annotations>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListAnnotationsRequest req = new ChecksListAnnotationsRequest(16429L, "quas", "itaque") {{
                page = 9240L;
                perPage = 669917L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-runs-for-a-git-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForRefRequest req = new ChecksListForRefRequest("repellendus", "porro", "doloribus") {{
                appId = 281730L;
                checkName = "facilis";
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-runs-in-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForSuiteRequest req = new ChecksListForSuiteRequest(485628L, "occaecati", "voluptatibus") {{
                checkName = "quisquam";
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#list-check-suites-for-a-git-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListSuitesForRefRequest req = new ChecksListSuitesForRefRequest("delectus", "voluptate", "consectetur") {{
                appId = 878870L;
                checkName = "tenetur";
                page = 492268L;
                perPage = 941378L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#rerequest-a-check-suite>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestSuiteRequest req = new ChecksRerequestSuiteRequest(715561L, "quod", "odio");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#update-repository-preferences-for-check-suites>
        ...
        try {
            ...
            ChecksSetSuitesPreferencesRequest req = new ChecksSetSuitesPreferencesRequest(                new ChecksSetSuitesPreferencesRequestBody() {{
                                autoTriggerChecks = new org.openapis.openapi.models.operations.ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks[]{{
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(874288L, false) {{
                                        appId = 708548L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(293020L, false) {{
                                        appId = 498140L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(848944L, false) {{
                                        appId = 844550L;
                                        setting = false;
                                    }}),
                                }};
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/checks#update-a-check-run>
