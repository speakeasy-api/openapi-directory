...
class GETCMTaxItemTypeFinanceInformation:
...
class GETCMTaxItemTypeTaxRateTypeEnum(str, Enum):
...
class GETCMTaxItemType:
    ...
    finance_information: Optional[GETCMTaxItemTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the taxation item."""  
    ...
    tax_rate_type: Optional[GETCMTaxItemTypeTaxRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType'), 'exclude': lambda f: f is None }})
    r"""The type of the tax rate."""  
