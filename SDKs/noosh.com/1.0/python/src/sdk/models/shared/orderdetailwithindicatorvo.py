...
class OrderDetailWithIndicatorVO:
    r"""Java type: com.noosh.nooshapi.vo.OrderDetailWithIndicatorVO"""
    ...
    r"""Java type: java.math.BigDecimal"""  
    is_sell_order: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('is_sell_order'), 'exclude': lambda f: f is None }})  
