 ...
 */
public class UpdateZRSettingsApplicationJSON2DigitalSignageDisplayPeriod {
    /**
    ...
    public UpdateZRSettingsApplicationJSON2DigitalSignageDisplayPeriod withStartDisplayingContent(Long startDisplayingContent) {
    ...
    public UpdateZRSettingsApplicationJSON2DigitalSignageDisplayPeriod withStopDisplayingContent(Long stopDisplayingContent) {
