...
export class RecaptchaenterpriseProjectsKeysPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RecaptchaenterpriseProjectsKeysPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RecaptchaenterpriseProjectsKeysPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
