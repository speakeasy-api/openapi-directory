...
from ..shared import taskprioritylistvo as shared_taskprioritylistvo
...
class TaskPriorityListResponse:
    ...
    task_priority_list_vo: Optional[shared_taskprioritylistvo.TaskPriorityListVO] = dataclasses.field(default=None)
