...
type AnalyticsadminAccountsProvisionAccountTicketRequest struct {
	...
	GoogleAnalyticsAdminV1alphaProvisionAccountTicketRequestInput *shared.GoogleAnalyticsAdminV1alphaProvisionAccountTicketRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
