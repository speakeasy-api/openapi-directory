...
public class GetTransactionListHeaders {
    /**
    ...
    public GetTransactionListHeaders withConsentID(String consentID) {
    ...
    public GetTransactionListHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public GetTransactionListHeaders withPSUAccept(String psuAccept) {
    ...
    public GetTransactionListHeaders withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public GetTransactionListHeaders withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetTransactionListHeaders withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetTransactionListHeaders withPSUDeviceID(String psuDeviceID) {
    ...
    public GetTransactionListHeaders withPSUGeoLocation(String psuGeoLocation) {
    ...
    public GetTransactionListHeaders withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public GetTransactionListHeaders withPSUIPAddress(String psuIPAddress) {
    ...
    public GetTransactionListHeaders withPSUIPPort(String psuIPPort) {
    ...
    public GetTransactionListHeaders withPSUUserAgent(String psuUserAgent) {
    ...
    public GetTransactionListHeaders withSignature(String signature) {
    ...
    public GetTransactionListHeaders withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetTransactionListHeaders withXRequestID(String xRequestID) {
