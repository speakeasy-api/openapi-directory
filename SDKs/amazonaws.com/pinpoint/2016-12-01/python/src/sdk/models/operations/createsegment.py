...
class CreateSegmentRequestBody:
    write_segment_request: CreateSegmentRequestBodyWriteSegmentRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('WriteSegmentRequest') }})
    

@dataclasses.dataclass
class CreateSegmentRequest:
    headers: CreateSegmentHeaders = dataclasses.field()
    path_params: CreateSegmentPathParams = dataclasses.field()
    request: CreateSegmentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
