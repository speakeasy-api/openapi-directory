...
exports.ListDialingPermissionsHrsPrefixesResponse = exports.ListDialingPermissionsHrsPrefixesListDialingPermissionsHrsPrefixesResponse = exports.ListDialingPermissionsHrsPrefixesListDialingPermissionsHrsPrefixesResponseMeta = exports.ListDialingPermissionsHrsPrefixesRequest = exports.ListDialingPermissionsHrsPrefixesSecurity = exports.ListDialingPermissionsHrsPrefixesServerList = void 0;
...
var ListDialingPermissionsHrsPrefixesSecurity = /** @class */ (function (_super) {
    ...
    ], ListDialingPermissionsHrsPrefixesSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListDialingPermissionsHrsPrefixesSecurity.prototype, "username", void 0);
...
var ListDialingPermissionsHrsPrefixesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListDialingPermissionsHrsPrefixesRequest.prototype, "isoCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListDialingPermissionsHrsPrefixesRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListDialingPermissionsHrsPrefixesRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListDialingPermissionsHrsPrefixesRequest.prototype, "pageToken", void 0);
...
var ListDialingPermissionsHrsPrefixesListDialingPermissionsHrsPrefixesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.VoiceV1DialingPermissionsDialingPermissionsCountryDialingPermissionsHrsPrefixes,
        }),
        (0, class_transformer_1.Expose)({ name: "content" }),
        (0, class_transformer_1.Type)(function () {
            return shared.VoiceV1DialingPermissionsDialingPermissionsCountryDialingPermissionsHrsPrefixes;
        }),
...
var ListDialingPermissionsHrsPrefixesResponse = /** @class */ (function (_super) {
    ...
    ], ListDialingPermissionsHrsPrefixesResponse.prototype, "rawResponse", void 0);
