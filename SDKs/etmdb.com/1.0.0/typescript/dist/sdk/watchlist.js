...
var Watchlist = /** @class */ (function () {
    function Watchlist(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Watchlist.prototype.watchlistSearchRead = function (req, config) {
     ...
     * [ref]: https://etmdb.com/en/movies/watchlist/id
    **/
    Watchlist.prototype.watchlistSearchallRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
