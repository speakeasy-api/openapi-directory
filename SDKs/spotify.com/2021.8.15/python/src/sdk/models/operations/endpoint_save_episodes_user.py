...
class EndpointSaveEpisodesUserRequest:
    headers: EndpointSaveEpisodesUserHeaders = dataclasses.field()
    query_params: EndpointSaveEpisodesUserQueryParams = dataclasses.field()
    security: EndpointSaveEpisodesUserSecurity = dataclasses.field()
    request: Optional[EndpointSaveEpisodesUserRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
