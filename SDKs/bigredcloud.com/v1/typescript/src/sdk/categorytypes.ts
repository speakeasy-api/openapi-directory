...
export class CategoryTypes {
  ...
  categoryTypesGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CategoryTypesGetResponse =
        new operations.CategoryTypesGetResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.pageResultCategoryTypeDto = utils.objectToClass(
              httpRes?.data,
              shared.PageResultCategoryTypeDto
            );
          }
          break;
      }
