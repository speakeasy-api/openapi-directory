...
class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListRequest:
    ...
    r"""Required. The ID of the line item to list assigned targeting options for."""  
    ...
    r"""A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListLineItemAssignedTargetingOptions` method. If not specified, the first page of results will be returned."""  
