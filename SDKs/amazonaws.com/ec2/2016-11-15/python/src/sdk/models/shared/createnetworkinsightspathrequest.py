...
import dataclasses
from ..shared import pathrequestfilter as shared_pathrequestfilter
from ..shared import protocol_enum as shared_protocol_enum
from enum import Enum
from typing import Optional

class CreateNetworkInsightsPathRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateNetworkInsightsPathRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateNetworkInsightsPathRequestTagSpecifications:
    ...
    resource_type: Optional[CreateNetworkInsightsPathRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateNetworkInsightsPathRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateNetworkInsightsPathRequest:
    ...
    protocol: shared_protocol_enum.ProtocolEnum = dataclasses.field()  
    ...
    filter_at_destination: Optional[shared_pathrequestfilter.PathRequestFilter] = dataclasses.field(default=None)  
    filter_at_source: Optional[shared_pathrequestfilter.PathRequestFilter] = dataclasses.field(default=None)  
    source_ip: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateNetworkInsightsPathRequestTagSpecifications]] = dataclasses.field(default=None)  
