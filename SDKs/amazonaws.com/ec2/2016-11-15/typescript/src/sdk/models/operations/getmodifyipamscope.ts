...
export enum GETModifyIpamScopeActionEnum {
  ModifyIpamScope = "ModifyIpamScope",
}

export enum GETModifyIpamScopeVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETModifyIpamScopeRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETModifyIpamScopeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
