...
class Projects:
    ...
    def eventarc_projects_locations_channel_connections_create(self, request: operations.EventarcProjectsLocationsChannelConnectionsCreateRequest, security: operations.EventarcProjectsLocationsChannelConnectionsCreateSecurity) -> operations.EventarcProjectsLocationsChannelConnectionsCreateResponse:
        r"""Create a new ChannelConnection in a particular project and location."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.EventarcProjectsLocationsChannelConnectionsCreateRequest, base_url, '/v1/{parent}/channelConnections', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "channel_connection_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.EventarcProjectsLocationsChannelConnectionsCreateRequest, request)
        ...
        res = operations.EventarcProjectsLocationsChannelConnectionsCreateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def eventarc_projects_locations_channel_connections_list(self, request: operations.EventarcProjectsLocationsChannelConnectionsListRequest, security: operations.EventarcProjectsLocationsChannelConnectionsListSecurity) -> operations.EventarcProjectsLocationsChannelConnectionsListResponse:
        r"""List channel connections."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.EventarcProjectsLocationsChannelConnectionsListRequest, base_url, '/v1/{parent}/channelConnections', request)
        
        query_params = utils.get_query_params(operations.EventarcProjectsLocationsChannelConnectionsListRequest, request)
        ...
        res = operations.EventarcProjectsLocationsChannelConnectionsListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListChannelConnectionsResponse])
                res.list_channel_connections_response = out

        return res

    def eventarc_projects_locations_channels_create(self, request: operations.EventarcProjectsLocationsChannelsCreateRequest, security: operations.EventarcProjectsLocationsChannelsCreateSecurity) -> operations.EventarcProjectsLocationsChannelsCreateResponse:
        r"""Create a new channel in a particular project and location."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.EventarcProjectsLocationsChannelsCreateRequest, base_url, '/v1/{parent}/channels', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "channel_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.EventarcProjectsLocationsChannelsCreateRequest, request)
        ...
        res = operations.EventarcProjectsLocationsChannelsCreateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def eventarc_projects_locations_channels_list(self, request: operations.EventarcProjectsLocationsChannelsListRequest, security: operations.EventarcProjectsLocationsChannelsListSecurity) -> operations.EventarcProjectsLocationsChannelsListResponse:
        r"""List channels."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.EventarcProjectsLocationsChannelsListRequest, base_url, '/v1/{parent}/channels', request)
        
        query_params = utils.get_query_params(operations.EventarcProjectsLocationsChannelsListRequest, request)
        ...
        res = operations.EventarcProjectsLocationsChannelsListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def eventarc_projects_locations_list(self, request: operations.EventarcProjectsLocationsListRequest, security: operations.EventarcProjectsLocationsListSecurity) -> operations.EventarcProjectsLocationsListResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsListRequest, base_url, '/v1/{name}/locations', request)
    ...
    def eventarc_projects_locations_operations_cancel(self, request: operations.EventarcProjectsLocationsOperationsCancelRequest, security: operations.EventarcProjectsLocationsOperationsCancelSecurity) -> operations.EventarcProjectsLocationsOperationsCancelResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsOperationsCancelRequest, base_url, '/v1/{name}:cancel', request)
    ...
    def eventarc_projects_locations_operations_list(self, request: operations.EventarcProjectsLocationsOperationsListRequest, security: operations.EventarcProjectsLocationsOperationsListSecurity) -> operations.EventarcProjectsLocationsOperationsListResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsOperationsListRequest, base_url, '/v1/{name}/operations', request)
    ...
    def eventarc_projects_locations_providers_list(self, request: operations.EventarcProjectsLocationsProvidersListRequest, security: operations.EventarcProjectsLocationsProvidersListSecurity) -> operations.EventarcProjectsLocationsProvidersListResponse:
        r"""List providers."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.EventarcProjectsLocationsProvidersListRequest, base_url, '/v1/{parent}/providers', request)
        
        query_params = utils.get_query_params(operations.EventarcProjectsLocationsProvidersListRequest, request)
        ...
        res = operations.EventarcProjectsLocationsProvidersListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def eventarc_projects_locations_triggers_create(self, request: operations.EventarcProjectsLocationsTriggersCreateRequest, security: operations.EventarcProjectsLocationsTriggersCreateSecurity) -> operations.EventarcProjectsLocationsTriggersCreateResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersCreateRequest, base_url, '/v1/{parent}/triggers', request)
    ...
    def eventarc_projects_locations_triggers_delete(self, request: operations.EventarcProjectsLocationsTriggersDeleteRequest, security: operations.EventarcProjectsLocationsTriggersDeleteSecurity) -> operations.EventarcProjectsLocationsTriggersDeleteResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersDeleteRequest, base_url, '/v1/{name}', request)
    ...
    def eventarc_projects_locations_triggers_get(self, request: operations.EventarcProjectsLocationsTriggersGetRequest, security: operations.EventarcProjectsLocationsTriggersGetSecurity) -> operations.EventarcProjectsLocationsTriggersGetResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersGetRequest, base_url, '/v1/{name}', request)
    ...
    def eventarc_projects_locations_triggers_get_iam_policy(self, request: operations.EventarcProjectsLocationsTriggersGetIamPolicyRequest, security: operations.EventarcProjectsLocationsTriggersGetIamPolicySecurity) -> operations.EventarcProjectsLocationsTriggersGetIamPolicyResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersGetIamPolicyRequest, base_url, '/v1/{resource}:getIamPolicy', request)
    ...
    def eventarc_projects_locations_triggers_list(self, request: operations.EventarcProjectsLocationsTriggersListRequest, security: operations.EventarcProjectsLocationsTriggersListSecurity) -> operations.EventarcProjectsLocationsTriggersListResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersListRequest, base_url, '/v1/{parent}/triggers', request)
    ...
    def eventarc_projects_locations_triggers_patch(self, request: operations.EventarcProjectsLocationsTriggersPatchRequest, security: operations.EventarcProjectsLocationsTriggersPatchSecurity) -> operations.EventarcProjectsLocationsTriggersPatchResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersPatchRequest, base_url, '/v1/{name}', request)
    ...
    def eventarc_projects_locations_triggers_set_iam_policy(self, request: operations.EventarcProjectsLocationsTriggersSetIamPolicyRequest, security: operations.EventarcProjectsLocationsTriggersSetIamPolicySecurity) -> operations.EventarcProjectsLocationsTriggersSetIamPolicyResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersSetIamPolicyRequest, base_url, '/v1/{resource}:setIamPolicy', request)
    ...
    def eventarc_projects_locations_triggers_test_iam_permissions(self, request: operations.EventarcProjectsLocationsTriggersTestIamPermissionsRequest, security: operations.EventarcProjectsLocationsTriggersTestIamPermissionsSecurity) -> operations.EventarcProjectsLocationsTriggersTestIamPermissionsResponse:
        ...
        url = utils.generate_url(operations.EventarcProjectsLocationsTriggersTestIamPermissionsRequest, base_url, '/v1/{resource}:testIamPermissions', request)
