...
export class GetGeneHomologAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}

export enum GetGeneHomologAssociationsHomologyTypeEnum {
    P = "P",
    O = "O",
    Ldo = "LDO"
}
...
export class GetGeneHomologAssociationsQueryParams extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=homology_type" })
...
export class GetGeneHomologAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneHomologAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
