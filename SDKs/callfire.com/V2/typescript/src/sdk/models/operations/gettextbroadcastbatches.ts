...
export class GetTextBroadcastBatchesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetTextBroadcastBatchesRequest extends SpeakeasyBase {
  /**
...
export class GetTextBroadcastBatchesResponse extends SpeakeasyBase {
  /**
