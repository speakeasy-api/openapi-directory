...
export class AnalyticsadminPropertiesDisplayVideo360AdvertiserLinkProposalsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesDisplayVideo360AdvertiserLinkProposalsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesDisplayVideo360AdvertiserLinkProposalsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
