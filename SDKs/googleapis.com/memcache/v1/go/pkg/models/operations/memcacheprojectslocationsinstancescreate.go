...
type MemcacheProjectsLocationsInstancesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type MemcacheProjectsLocationsInstancesCreatePathParams struct {
	// Required. The resource name of the instance location using the form: `projects/{project_id}/locations/{location_id}` where `location_id` refers to a GCP region
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type MemcacheProjectsLocationsInstancesCreateQueryParams struct {
	// V1 error format.
...
type MemcacheProjectsLocationsInstancesCreateResponse struct {
	ContentType string
	// Successful response
