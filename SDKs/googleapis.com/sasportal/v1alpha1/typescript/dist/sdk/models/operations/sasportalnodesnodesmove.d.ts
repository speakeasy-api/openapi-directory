...
export declare class SasportalNodesNodesMoveSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class SasportalNodesNodesMoveSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
