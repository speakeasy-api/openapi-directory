...
public class Apps {
    ...
    **/
    public openapisdk.models.operations.AppsCreateContentAttachmentResponse appsCreateContentAttachment(openapisdk.models.operations.AppsCreateContentAttachmentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/content_references/{content_reference_id}/attachments", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.AppsGetSubscriptionPlanForAccountResponse appsGetSubscriptionPlanForAccount(openapisdk.models.operations.AppsGetSubscriptionPlanForAccountRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/marketplace_listing/accounts/{account_id}", request.pathParams);
        ...
        openapisdk.models.operations.AppsGetSubscriptionPlanForAccountResponse res = new openapisdk.models.operations.AppsGetSubscriptionPlanForAccountResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.MarketplacePurchase out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.MarketplacePurchase.class);
    ...
    **/
    public openapisdk.models.operations.AppsGetSubscriptionPlanForAccountStubbedResponse appsGetSubscriptionPlanForAccountStubbed(openapisdk.models.operations.AppsGetSubscriptionPlanForAccountStubbedRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/marketplace_listing/stubbed/accounts/{account_id}", request.pathParams);
        ...
        openapisdk.models.operations.AppsGetSubscriptionPlanForAccountStubbedResponse res = new openapisdk.models.operations.AppsGetSubscriptionPlanForAccountStubbedResponse() {{
            marketplacePurchase = null;
            basicError = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
    ...
    **/
    public openapisdk.models.operations.AppsListAccountsForPlanResponse appsListAccountsForPlan(openapisdk.models.operations.AppsListAccountsForPlanRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/marketplace_listing/plans/{plan_id}/accounts", request.pathParams);
        ...
        openapisdk.models.operations.AppsListAccountsForPlanResponse res = new openapisdk.models.operations.AppsListAccountsForPlanResponse() {{
    ...
    **/
    public openapisdk.models.operations.AppsListAccountsForPlanStubbedResponse appsListAccountsForPlanStubbed(openapisdk.models.operations.AppsListAccountsForPlanStubbedRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/marketplace_listing/stubbed/plans/{plan_id}/accounts", request.pathParams);
        ...
        openapisdk.models.operations.AppsListAccountsForPlanStubbedResponse res = new openapisdk.models.operations.AppsListAccountsForPlanStubbedResponse() {{
            marketplacePurchases = null;
            basicError = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
    ...
    **/
    public openapisdk.models.operations.AppsListPlansResponse appsListPlans(openapisdk.models.operations.AppsListPlansRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/marketplace_listing/plans");
        ...
        openapisdk.models.operations.AppsListPlansResponse res = new openapisdk.models.operations.AppsListPlansResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.MarketplaceListingPlan[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.MarketplaceListingPlan[].class);
    ...
    **/
    public openapisdk.models.operations.AppsListPlansStubbedResponse appsListPlansStubbed(openapisdk.models.operations.AppsListPlansStubbedRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/marketplace_listing/stubbed/plans");
        ...
        openapisdk.models.operations.AppsListPlansStubbedResponse res = new openapisdk.models.operations.AppsListPlansStubbedResponse() {{
            marketplaceListingPlans = null;
            basicError = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
    ...
    **/
    public openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserResponse appsListSubscriptionsForAuthenticatedUser(openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/user/marketplace_purchases");
        ...
        openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserResponse res = new openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UserMarketplacePurchase[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UserMarketplacePurchase[].class);
    ...
    **/
    public openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserStubbedResponse appsListSubscriptionsForAuthenticatedUserStubbed(openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserStubbedRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/user/marketplace_purchases/stubbed");
        ...
        openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserStubbedResponse res = new openapisdk.models.operations.AppsListSubscriptionsForAuthenticatedUserStubbedResponse() {{
            userMarketplacePurchases = null;
            basicError = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
