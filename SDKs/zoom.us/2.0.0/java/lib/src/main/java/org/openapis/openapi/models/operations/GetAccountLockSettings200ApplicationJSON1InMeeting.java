...
public class GetAccountLockSettings200ApplicationJSON1InMeeting {
    /**
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withAlertGuestJoin(Boolean alertGuestJoin) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withAllowShowZoomWindows(Boolean allowShowZoomWindows) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withAnnotation(Boolean annotation) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withAnonymousQuestionAnswer(Boolean anonymousQuestionAnswer) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withAttendeeOnHold(Boolean attendeeOnHold) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withAutoAnswer(Boolean autoAnswer) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withAutoSavingChat(Boolean autoSavingChat) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withBreakoutRoom(Boolean breakoutRoom) {
    ...
    @JsonProperty("chat")
    public Boolean chat;
    public GetAccountLockSettings200ApplicationJSON1InMeeting withChat(Boolean chat) {
        this.chat = chat;
        return this;
    }
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withClosedCaption(Boolean closedCaption) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withCoHost(Boolean coHost) {
        this.coHost = coHost;
        return this;
    }
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withCustomDataCenterRegions(Boolean customDataCenterRegions) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withDscpMarking(Boolean dscpMarking) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withE2eEncryption(Boolean e2eEncryption) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withEntryExitChime(String entryExitChime) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withFarEndCameraControl(Boolean farEndCameraControl) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withFeedback(Boolean feedback) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withFileTransfer(Boolean fileTransfer) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withGroupHd(Boolean groupHd) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withOriginalAudio(Boolean originalAudio) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withPolling(Boolean polling) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withPostMeetingFeedback(Boolean postMeetingFeedback) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withPrivateChat(Boolean privateChat) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withRemoteControl(Boolean remoteControl) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withRequestPermissionToUnmute(Boolean requestPermissionToUnmute) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withScreenSharing(Boolean screenSharing) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withSendingDefaultEmailInvites(Boolean sendingDefaultEmailInvites) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withShowMeetingControlToolbar(Boolean showMeetingControlToolbar) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withStereoAudio(Boolean stereoAudio) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withUseHtmlFormatEmail(Boolean useHtmlFormatEmail) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withVirtualBackground(Boolean virtualBackground) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withWebinarQuestionAnswer(Boolean webinarQuestionAnswer) {
    ...
    public GetAccountLockSettings200ApplicationJSON1InMeeting withWhiteboard(Boolean whiteboard) {
