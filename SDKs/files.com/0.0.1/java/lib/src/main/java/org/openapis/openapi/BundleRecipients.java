...
public class BundleRecipients {
	...
	public BundleRecipients(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.GetBundleRecipientsResponse getBundleRecipients(org.openapis.openapi.models.operations.GetBundleRecipientsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.BundleRecipientEntity[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.BundleRecipientEntity[].class);
