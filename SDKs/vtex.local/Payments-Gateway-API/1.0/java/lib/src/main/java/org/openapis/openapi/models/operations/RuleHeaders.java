...
public class RuleHeaders {
    ...
    public RuleHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public RuleHeaders withContentType(String contentType) {
    ...
    public RuleHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public RuleHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
