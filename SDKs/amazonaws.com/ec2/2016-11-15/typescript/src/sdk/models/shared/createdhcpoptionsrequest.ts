...
export class CreateDhcpOptionsRequestDhcpConfigurations extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export enum CreateDhcpOptionsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateDhcpOptionsRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateDhcpOptionsRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateDhcpOptionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: CreateDhcpOptionsRequestDhcpConfigurations })
  dhcpConfigurations: CreateDhcpOptionsRequestDhcpConfigurations[];

  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: CreateDhcpOptionsRequestTagSpecifications })
