...
export const ListBuildServerList = ["https://serverless.twilio.com"] as const;
...
export class ListBuildListBuildResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ServerlessV1ServiceBuild })
  @Expose({ name: "builds" })
  @Type(() => shared.ServerlessV1ServiceBuild)
  builds?: shared.ServerlessV1ServiceBuild[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListBuildListBuildResponseMeta)
