...
from ..shared import collectionssort as shared_collectionssort
...
class CollectionsAllRequest:
    ...
    sort: Optional[shared_collectionssort.CollectionsSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
    r"""Apply sorting"""  
