...
class SDK:
    ...
    def team_schedule(self, request: operations.TeamScheduleRequest) -> operations.TeamScheduleResponse:
        ...
        url = utils.generate_url(operations.TeamScheduleRequest, base_url, '/{format}/TeamSchedule/{season}/{team}', request)
        ...
        res = operations.TeamScheduleResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
