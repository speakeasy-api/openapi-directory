...
class ListEntitiesDetectionJobsRequest:
    ...
    list_entities_detection_jobs_request: shared_listentitiesdetectionjobsrequest.ListEntitiesDetectionJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
