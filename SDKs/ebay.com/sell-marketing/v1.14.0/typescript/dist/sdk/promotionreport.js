...
var PromotionReport = /** @class */ (function () {
     ...
     */
    PromotionReport.prototype.getPromotionReports = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetPromotionReportsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.promotionsReportPagedCollection = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.PromotionsReportPagedCollection);
                    }
                    break;
