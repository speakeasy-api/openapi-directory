...
var Operations = /** @class */ (function () {
    ...
    Operations.prototype.vaultOperationsCancel = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.VaultOperationsCancelResponse({
    ...
    Operations.prototype.vaultOperationsDelete = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.VaultOperationsDeleteResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    Operations.prototype.vaultOperationsList = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.VaultOperationsListResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
