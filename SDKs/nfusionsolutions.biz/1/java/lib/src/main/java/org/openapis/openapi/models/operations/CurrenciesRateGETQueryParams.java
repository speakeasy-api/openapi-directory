...
public class CurrenciesRateGETQueryParams {
    /**
     * to override content negotiation specify a value of json or xml
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=format")
    public CurrenciesRateGETFormatEnum format;
    public CurrenciesRateGETQueryParams withFormat(CurrenciesRateGETFormatEnum format) {
        this.format = format;
        return this;
    }
    ...
    public String pairs;
    public CurrenciesRateGETQueryParams withPairs(String pairs) {
        this.pairs = pairs;
        return this;
    }
