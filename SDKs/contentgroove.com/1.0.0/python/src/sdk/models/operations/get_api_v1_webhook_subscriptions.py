...
class GetAPIV1WebhookSubscriptionsSortEnum(str, Enum):
...
@dataclasses.dataclass
class GetAPIV1WebhookSubscriptionsRequest:
    ...
    """  
    sort: Optional[GetAPIV1WebhookSubscriptionsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Sorting to be applied to the query. For more info: https://jsonapi.org/format/#fetching-sorting"""  
    

@dataclasses.dataclass
class GetAPIV1WebhookSubscriptionsResponse:
