...
public class GetDpsMessageReportOutputRequest {
    ...
    public GetDpsMessageReportOutputRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerKey") String employerKey, @JsonProperty("FromDate") LocalDate fromDate) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerKey = employerKey;
        this.fromDate = fromDate;
