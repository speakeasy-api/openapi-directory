...
func (s *Push) PublishPushNotificationToDevices(ctx context.Context, request operations.PublishPushNotificationToDevicesRequest) (*operations.PublishPushNotificationToDevicesResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PublishPushNotificationToDevicesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
