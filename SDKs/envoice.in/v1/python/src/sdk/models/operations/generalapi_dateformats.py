...
class GeneralAPIDateFormatsResponse:
    ...
    general_api_date_formats_200_application_json_strings: Optional[list[str]] = dataclasses.field(default=None)
    r"""OK"""  
    general_api_date_formats_200_text_json_strings: Optional[list[str]] = dataclasses.field(default=None)
    r"""OK"""  
