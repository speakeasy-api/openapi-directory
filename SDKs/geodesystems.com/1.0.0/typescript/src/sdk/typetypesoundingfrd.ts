...
export class TypeTypeSoundingFrd {
  ...
  searchTypeSoundingFrd(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_sounding_frd";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeSoundingFrdResponse =
        new operations.SearchTypeSoundingFrdResponse({
