...
class GetAttachLoadBalancerToSubnetsQueryParams:
    action: GetAttachLoadBalancerToSubnetsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAttachLoadBalancerToSubnetsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAttachLoadBalancerToSubnetsRequest:
    headers: GetAttachLoadBalancerToSubnetsHeaders = dataclasses.field()
    query_params: GetAttachLoadBalancerToSubnetsQueryParams = dataclasses.field()
