...
export class GetExpiredCertsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetExpiredCertsRequest extends SpeakeasyBase {
  /**
...
export class GetExpiredCertsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
