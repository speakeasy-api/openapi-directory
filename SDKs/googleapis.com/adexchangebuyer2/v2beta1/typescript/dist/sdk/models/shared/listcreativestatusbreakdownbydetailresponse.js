...
var ListCreativeStatusBreakdownByDetailResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: filteredbiddetailrow_1.FilteredBidDetailRow }),
        (0, class_transformer_1.Expose)({ name: "filteredBidDetailRows" }),
        (0, class_transformer_1.Type)(function () { return filteredbiddetailrow_1.FilteredBidDetailRow; }),
