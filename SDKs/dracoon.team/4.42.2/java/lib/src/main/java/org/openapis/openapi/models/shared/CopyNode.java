...
public class CopyNode {
    ...
    @JsonProperty("id")
    public Long id;
    public CopyNode withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    @JsonProperty("name")
    public String name;
    public CopyNode withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public CopyNode withTimestampCreation(OffsetDateTime timestampCreation) {
    ...
    public CopyNode withTimestampModification(OffsetDateTime timestampModification) {
