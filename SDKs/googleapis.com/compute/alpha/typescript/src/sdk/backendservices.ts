...
export class BackendServices {
  ...
  computeBackendServicesTestIamPermissions(
    req: operations.ComputeBackendServicesTestIamPermissionsRequest,
    security: operations.ComputeBackendServicesTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeBackendServicesTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeBackendServicesTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeBackendServicesTestIamPermissionsResponse =
        new operations.ComputeBackendServicesTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
