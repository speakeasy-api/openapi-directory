...
class UntagResource20171030QueryParams:
    operation: UntagResource20171030OperationEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class UntagResource20171030Request:
    headers: UntagResource20171030Headers = dataclasses.field()
    query_params: UntagResource20171030QueryParams = dataclasses.field()
