...
class UpdateEndpointRequestBody:
    endpoint_request: UpdateEndpointRequestBodyEndpointRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('EndpointRequest') }})
    

@dataclasses.dataclass
class UpdateEndpointRequest:
    headers: UpdateEndpointHeaders = dataclasses.field()
    path_params: UpdateEndpointPathParams = dataclasses.field()
    request: UpdateEndpointRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
