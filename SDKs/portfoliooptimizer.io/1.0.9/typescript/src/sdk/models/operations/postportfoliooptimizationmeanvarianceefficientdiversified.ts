...
export class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBodyConstraints extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(
    () =>
      PostPortfolioOptimizationMeanVarianceEfficientDiversifiedRequestBodyConstraints
  )
 ...
 * OK
 */
export class PostPortfolioOptimizationMeanVarianceEfficientDiversified200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class PostPortfolioOptimizationMeanVarianceEfficientDiversifiedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
