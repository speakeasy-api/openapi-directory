...
class GetPathwayGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPathwayGeneAssociationsQueryParams:
...
class GetPathwayGeneAssociationsRequest:
    path_params: GetPathwayGeneAssociationsPathParams = dataclasses.field()
    query_params: GetPathwayGeneAssociationsQueryParams = dataclasses.field()
