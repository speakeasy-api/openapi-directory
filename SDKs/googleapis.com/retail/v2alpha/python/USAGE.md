...
req = operations.RetailProjectsLocationsCatalogsAttributesConfigAddCatalogAttributeRequest(
    dollar_xgafv="2",
    google_cloud_retail_v2alpha_add_catalog_attribute_request_input=shared.GoogleCloudRetailV2alphaAddCatalogAttributeRequestInput(
        catalog_attribute=shared.GoogleCloudRetailV2alphaCatalogAttributeInput(
...
if res.google_cloud_retail_v2alpha_attributes_config is not None:
    # handle response
```
