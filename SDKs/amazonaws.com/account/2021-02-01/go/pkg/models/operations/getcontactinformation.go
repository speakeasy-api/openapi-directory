...
type GetContactInformationHeaders struct {
...
type GetContactInformationRequestBody struct {
...
type GetContactInformationRequest struct {
	Headers GetContactInformationHeaders
	Request GetContactInformationRequestBody `request:"mediaType=application/json"`
}
