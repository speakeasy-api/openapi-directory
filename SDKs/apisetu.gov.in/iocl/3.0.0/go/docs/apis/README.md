...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Lpgtv(ctx, operations.LpgtvRequestBody{
        CertificateParameters: &operations.LpgtvRequestBodyCertificateParameters{
            UID: "123412341234",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
            Consent: shared.ConsentArtifactSchemaConsent{
        ...
        Format: operations.LpgtvRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.LpgtvSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
