...
public class ClientApiNewFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ClientApiNewFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public ClientApiNewFormHeaders withXAuthSecret(String xAuthSecret) {
