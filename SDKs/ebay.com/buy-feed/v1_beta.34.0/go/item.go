...
func (s *item) GetItemFeed(ctx context.Context, request operations.GetItemFeedRequest, security operations.GetItemFeedSecurity) (*operations.GetItemFeedResponse, error) {
	baseURL := s.serverURL
