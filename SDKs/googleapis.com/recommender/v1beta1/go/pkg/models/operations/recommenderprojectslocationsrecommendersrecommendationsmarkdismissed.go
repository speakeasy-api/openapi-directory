...
type RecommenderProjectsLocationsRecommendersRecommendationsMarkDismissedRequest struct {
	...
	GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest *shared.GoogleCloudRecommenderV1beta1MarkRecommendationDismissedRequest `request:"mediaType=application/json"`
	// OAuth access token.
