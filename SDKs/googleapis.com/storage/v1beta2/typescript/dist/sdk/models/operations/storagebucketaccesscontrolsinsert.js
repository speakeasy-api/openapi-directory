...
exports.StorageBucketAccessControlsInsertResponse = exports.StorageBucketAccessControlsInsertRequest = exports.StorageBucketAccessControlsInsertSecurity = void 0;
...
var StorageBucketAccessControlsInsertRequest = /** @class */ (function (_super) {
    ...
    ], StorageBucketAccessControlsInsertRequest.prototype, "bucketAccessControl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=bucket",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsInsertRequest.prototype, "bucket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], StorageBucketAccessControlsInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], StorageBucketAccessControlsInsertRequest.prototype, "userIp", void 0);
...
var StorageBucketAccessControlsInsertResponse = /** @class */ (function (_super) {
    ...
    ], StorageBucketAccessControlsInsertResponse.prototype, "rawResponse", void 0);
