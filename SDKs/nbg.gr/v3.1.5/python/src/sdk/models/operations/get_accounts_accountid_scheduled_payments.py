...
from ..shared import obreadscheduledpayment3 as shared_obreadscheduledpayment3
...
class GetAccountsAccountIDScheduledPaymentsRequest:
    headers: GetAccountsAccountIDScheduledPaymentsHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDScheduledPaymentsPathParams = dataclasses.field()
    security: GetAccountsAccountIDScheduledPaymentsSecurity = dataclasses.field()
...
class GetAccountsAccountIDScheduledPaymentsResponse:
    ...
    ob_read_scheduled_payment3: Optional[shared_obreadscheduledpayment3.ObReadScheduledPayment3] = dataclasses.field(default=None)
