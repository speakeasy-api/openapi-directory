...
public class CreateInternationalStandingOrderConsentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalStandingOrderConsentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalStandingOrderConsentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalStandingOrderConsentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalStandingOrderConsentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalStandingOrderConsentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalStandingOrderConsentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalStandingOrderConsentsJsonHeaders withXJwsSignature(String xJwsSignature) {
