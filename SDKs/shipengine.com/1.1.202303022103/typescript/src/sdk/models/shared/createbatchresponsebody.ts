 ...
 *
 */
export enum CreateBatchResponseBodyLabelFormatEnum {
  Pdf = "pdf",
  Png = "png",
  Zpl = "zpl",
}
 ...
 *
 */
export enum CreateBatchResponseBodyLabelLayoutEnum {
  Fourx6 = "4x6",
  Letter = "letter",
}
 ...
 */
export enum CreateBatchResponseBodyBatchStatusEnum {
  Open = "open",
  Queued = "queued",
...
export class CreateBatchResponseBody extends SpeakeasyBase {
  ...
  @Type(() => CreateBatchResponseBodyOptionalLink)
  ...
  @Type(() => CreateBatchResponseBodyLabelDownload)
