...
exports.DeleteEmployerRevisionByNumberResponse = exports.DeleteEmployerRevisionByNumberRequest = void 0;
...
var DeleteEmployerRevisionByNumberRequest = /** @class */ (function (_super) {
    ...
    ], DeleteEmployerRevisionByNumberRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteEmployerRevisionByNumberRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployerRevisionByNumberRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RevisionNumber",
        }),
        __metadata("design:type", String)
    ], DeleteEmployerRevisionByNumberRequest.prototype, "revisionNumber", void 0);
    return DeleteEmployerRevisionByNumberRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteEmployerRevisionByNumberRequest = DeleteEmployerRevisionByNumberRequest;
var DeleteEmployerRevisionByNumberResponse = /** @class */ (function (_super) {
    ...
    ], DeleteEmployerRevisionByNumberResponse.prototype, "rawResponse", void 0);
    return DeleteEmployerRevisionByNumberResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteEmployerRevisionByNumberResponse = DeleteEmployerRevisionByNumberResponse;
