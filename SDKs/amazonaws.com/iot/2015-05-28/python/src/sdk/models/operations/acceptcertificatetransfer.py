...
class AcceptCertificateTransferRequest:
    headers: AcceptCertificateTransferHeaders = dataclasses.field()
    path_params: AcceptCertificateTransferPathParams = dataclasses.field()
    query_params: AcceptCertificateTransferQueryParams = dataclasses.field()
