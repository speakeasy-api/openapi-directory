...
public class GetDiseasePublicationAssociationsRequest {
    ...
    public GetDiseasePublicationAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseasePublicationAssociationsRequest withEvidence(String evidence) {
    ...
    public GetDiseasePublicationAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseasePublicationAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetDiseasePublicationAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetDiseasePublicationAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withRelation(String relation) {
    ...
    public GetDiseasePublicationAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseasePublicationAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetDiseasePublicationAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
