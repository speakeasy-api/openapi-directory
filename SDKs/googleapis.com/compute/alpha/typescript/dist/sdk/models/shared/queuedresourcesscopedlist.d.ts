 ...
 */
export declare enum QueuedResourcesScopedListWarningCodeEnum {
...
export declare class QueuedResourcesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class QueuedResourcesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: QueuedResourcesScopedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: QueuedResourcesScopedListWarningData[];
    /**
     * [Output Only] A human-readable description of the warning code.
     */
    message?: string;
}
export declare class QueuedResourcesScopedList extends SpeakeasyBase {
    /**
     ...
     * Informational warning which replaces the list of backend services when the list is empty.
     */
    warning?: QueuedResourcesScopedListWarning;
}
