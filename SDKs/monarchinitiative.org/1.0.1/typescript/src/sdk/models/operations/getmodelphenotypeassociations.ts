...
export class GetModelPhenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetModelPhenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetModelPhenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetModelPhenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
