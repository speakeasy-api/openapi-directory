...
public class EpfscSecurity {
    ...
    public EpfscSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public EpfscSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public EpfscSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
