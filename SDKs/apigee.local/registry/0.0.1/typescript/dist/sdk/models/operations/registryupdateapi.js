...
exports.RegistryUpdateApiResponse = exports.RegistryUpdateApiRequest = void 0;
...
var RegistryUpdateApiRequest = /** @class */ (function (_super) {
    ...
    ], RegistryUpdateApiRequest.prototype, "apiInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=allowMissing",
        }),
        __metadata("design:type", Boolean)
    ], RegistryUpdateApiRequest.prototype, "allowMissing", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=api" }),
        __metadata("design:type", String)
    ], RegistryUpdateApiRequest.prototype, "api", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=location",
        }),
        __metadata("design:type", String)
    ], RegistryUpdateApiRequest.prototype, "location", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project",
        }),
        __metadata("design:type", String)
    ], RegistryUpdateApiRequest.prototype, "project", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=updateMask",
        }),
        __metadata("design:type", String)
    ], RegistryUpdateApiRequest.prototype, "updateMask", void 0);
    return RegistryUpdateApiRequest;
}(utils_1.SpeakeasyBase));
exports.RegistryUpdateApiRequest = RegistryUpdateApiRequest;
var RegistryUpdateApiResponse = /** @class */ (function (_super) {
    ...
    ], RegistryUpdateApiResponse.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], RegistryUpdateApiResponse.prototype, "rawResponse", void 0);
    return RegistryUpdateApiResponse;
}(utils_1.SpeakeasyBase));
exports.RegistryUpdateApiResponse = RegistryUpdateApiResponse;
