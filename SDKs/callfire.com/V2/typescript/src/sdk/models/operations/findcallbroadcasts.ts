...
export class FindCallBroadcastsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FindCallBroadcastsRequest extends SpeakeasyBase {
  /**
...
export class FindCallBroadcastsResponse extends SpeakeasyBase {
  /**
