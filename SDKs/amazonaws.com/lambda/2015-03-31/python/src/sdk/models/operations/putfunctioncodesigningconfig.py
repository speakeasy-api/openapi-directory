...
class PutFunctionCodeSigningConfigRequest:
    headers: PutFunctionCodeSigningConfigHeaders = dataclasses.field()
    path_params: PutFunctionCodeSigningConfigPathParams = dataclasses.field()
    request: PutFunctionCodeSigningConfigRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
