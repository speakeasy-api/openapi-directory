...
class SearchTypeSoundingFrdQueryParams:
...
@dataclasses.dataclass
class SearchTypeSoundingFrdRequest:
    query_params: SearchTypeSoundingFrdQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeSoundingFrdResponse:
