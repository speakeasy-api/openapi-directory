...
func (e UpdateStateMachineXAmzTargetEnum) ToPointer() *UpdateStateMachineXAmzTargetEnum {
	return &e
}
...
func (e *UpdateStateMachineXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSStepFunctions.UpdateStateMachine":
		*e = UpdateStateMachineXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateStateMachineXAmzTargetEnum: %v", v)
	}
}
