...
from ..shared import putpaymentmethodrequest as shared_putpaymentmethodrequest
...
class PUTPaymentMethodRequest:
    ...
    put_payment_method_request: shared_putpaymentmethodrequest.PUTPaymentMethodRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
