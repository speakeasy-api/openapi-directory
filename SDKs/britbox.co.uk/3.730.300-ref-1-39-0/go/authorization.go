...
func (s *authorization) GetAccountToken(ctx context.Context, request operations.GetAccountTokenRequest) (*operations.GetAccountTokenResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "AccountTokenRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *authorization) GetAccountTokenByCode(ctx context.Context, request operations.GetAccountTokenByCodeRequest) (*operations.GetAccountTokenByCodeResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "AccountTokenByCodeRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
// before access is granted.
func (s *authorization) GetProfileToken(ctx context.Context, request operations.GetProfileTokenRequest, security operations.GetProfileTokenSecurity) (*operations.GetProfileTokenResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/authorization/profile"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ProfileTokenRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *authorization) RefreshToken(ctx context.Context, request operations.RefreshTokenRequest) (*operations.RefreshTokenResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "TokenRefreshRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *authorization) SingleSignOn(ctx context.Context, request operations.SingleSignOnRequest) (*operations.SingleSignOnResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "SingleSignOnRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
