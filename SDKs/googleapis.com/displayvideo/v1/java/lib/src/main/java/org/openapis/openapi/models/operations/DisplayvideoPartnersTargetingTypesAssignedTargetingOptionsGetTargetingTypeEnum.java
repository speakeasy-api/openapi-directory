 ...
 */
public enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum {
    ...
    private DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum(String value) {
        this.value = value;
    }
}
