...
export enum SendTaskHeartbeatXAmzTargetEnum {
  AWSStepFunctionsSendTaskHeartbeat = "AWSStepFunctions.SendTaskHeartbeat",
}

export class SendTaskHeartbeatRequest extends SpeakeasyBase {
...
export class SendTaskHeartbeatResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
