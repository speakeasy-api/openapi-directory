...
class DeleteSnippetsWorkspaceEncodedIDNodeIDRequest:
    path_params: DeleteSnippetsWorkspaceEncodedIDNodeIDPathParams = dataclasses.field()
    security: DeleteSnippetsWorkspaceEncodedIDNodeIDSecurity = dataclasses.field()
