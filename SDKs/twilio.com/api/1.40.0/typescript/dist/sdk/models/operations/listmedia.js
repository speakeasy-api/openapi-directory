...
exports.ListMediaResponse = exports.ListMediaListMediaResponse = exports.ListMediaRequest = exports.ListMediaSecurity = exports.ListMediaServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListMediaServerList = ["https://api.twilio.com"];
var ListMediaSecurity = /** @class */ (function (_super) {
    ...
    ], ListMediaSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListMediaSecurity.prototype, "username", void 0);
    return ListMediaSecurity;
}(utils_1.SpeakeasyBase));
exports.ListMediaSecurity = ListMediaSecurity;
var ListMediaRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListMediaRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListMediaRequest.prototype, "dateCreated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated<;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListMediaRequest.prototype, "dateCreatedLessThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreated>;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListMediaRequest.prototype, "dateCreatedGreaterThan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=MessageSid",
        }),
        __metadata("design:type", String)
    ], ListMediaRequest.prototype, "messageSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListMediaRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListMediaRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListMediaRequest.prototype, "pageToken", void 0);
    return ListMediaRequest;
}(utils_1.SpeakeasyBase));
exports.ListMediaRequest = ListMediaRequest;
/**
 * OK
 */
var ListMediaListMediaResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ApiV2010AccountMessageMedia }),
        (0, class_transformer_1.Expose)({ name: "media_list" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountMessageMedia; }),
...
exports.ListMediaListMediaResponse = ListMediaListMediaResponse;
var ListMediaResponse = /** @class */ (function (_super) {
    ...
    ], ListMediaResponse.prototype, "rawResponse", void 0);
    return ListMediaResponse;
}(utils_1.SpeakeasyBase));
exports.ListMediaResponse = ListMediaResponse;
