...
func (s *Verification) PostCheckAccountHolder(ctx context.Context, request operations.PostCheckAccountHolderRequest) (*operations.PostCheckAccountHolderResponse, error) {
	...
	res := &operations.PostCheckAccountHolderResponse{
...
func (s *Verification) PostDeletePayoutMethods(ctx context.Context, request operations.PostDeletePayoutMethodsRequest) (*operations.PostDeletePayoutMethodsResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostDeletePayoutMethodsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
