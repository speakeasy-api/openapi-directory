...
class PatientRepresentation:
    ...
    care_contexts: Optional[list[shared_carecontextrepresentation.CareContextRepresentation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('careContexts'), 'exclude': lambda f: f is None }})  
