...
export class ExtendTransactionRequestBody extends SpeakeasyBase {
  /**
...
export class ExtendTransactionRequest extends SpeakeasyBase {
...
export class ExtendTransactionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
