...
class StoredValueBalanceCheckResponseResultCodeEnum(str, Enum):
...
class StoredValueBalanceCheckResponse:
    ...
    """  
    result_code: Optional[StoredValueBalanceCheckResponseResultCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resultCode'), 'exclude': lambda f: f is None }})
    r"""The result of the payment. Possible values:
