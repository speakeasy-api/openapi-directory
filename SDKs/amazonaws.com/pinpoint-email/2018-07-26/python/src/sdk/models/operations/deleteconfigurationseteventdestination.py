...
class DeleteConfigurationSetEventDestinationRequest:
    ...
    r"""The name of the configuration set that contains the event destination that you want to delete."""  
    ...
    r"""The name of the event destination that you want to delete."""  
