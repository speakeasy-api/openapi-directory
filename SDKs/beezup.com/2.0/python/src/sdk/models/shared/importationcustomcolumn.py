...
class ImportationCustomColumn:
    ...
    links: shared_importationcustomcolumnlinks.ImportationCustomColumnLinks = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('links') }})  
