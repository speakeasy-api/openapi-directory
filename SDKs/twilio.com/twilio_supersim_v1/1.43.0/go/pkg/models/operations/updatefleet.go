...
func (e UpdateFleetUpdateFleetRequestIPCommandsMethodEnum) ToPointer() *UpdateFleetUpdateFleetRequestIPCommandsMethodEnum {
	return &e
}
...
func (e *UpdateFleetUpdateFleetRequestIPCommandsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateFleetUpdateFleetRequestIPCommandsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateFleetUpdateFleetRequestIPCommandsMethodEnum: %v", v)
	}
}
...
func (e UpdateFleetUpdateFleetRequestSmsCommandsMethodEnum) ToPointer() *UpdateFleetUpdateFleetRequestSmsCommandsMethodEnum {
	return &e
}
...
func (e *UpdateFleetUpdateFleetRequestSmsCommandsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateFleetUpdateFleetRequestSmsCommandsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateFleetUpdateFleetRequestSmsCommandsMethodEnum: %v", v)
	}
}
