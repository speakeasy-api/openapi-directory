...
export class RunNamespacesTasksGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesTasksGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesTasksGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
