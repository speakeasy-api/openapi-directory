...
class Onev21databases1Percent7BdatabaseClusterUUIDPercent7D1evictionPolicyGetResponses200ContentApplication1jsonSchema:
    eviction_policy: Onev21databases1Percent7BdatabaseClusterUUIDPercent7D1evictionPolicyGetResponses200ContentApplication1jsonSchemaEvictionPolicyEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('eviction_policy') }})
