...
func (s *permission) DeletePermission(ctx context.Context, request operations.DeletePermissionRequest) (*operations.DeletePermissionResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/Permission/{PermissionId}", request, nil)
	if err != nil {
...
func (s *permission) GetUserPermissions(ctx context.Context, request operations.GetUserPermissionsRequest) (*operations.GetUserPermissionsResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/User/{UserId}/Permissions", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
// GetUsersFromPermission - Gets the users with the specified permission
// Gets the users with the specified permission
func (s *permission) GetUsersFromPermission(ctx context.Context, request operations.GetUsersFromPermissionRequest) (*operations.GetUsersFromPermissionResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/Permission/{PermissionId}/Users", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetUsersFromPermissionResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
