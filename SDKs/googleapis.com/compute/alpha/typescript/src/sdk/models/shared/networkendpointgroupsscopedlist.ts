 ...
 */
export enum NetworkEndpointGroupsScopedListWarningCodeEnum {
...
export class NetworkEndpointGroupsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkEndpointGroupsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkEndpointGroupsScopedListWarningData })
  @Expose({ name: "data" })
...
export class NetworkEndpointGroupsScopedList extends SpeakeasyBase {
  /**
