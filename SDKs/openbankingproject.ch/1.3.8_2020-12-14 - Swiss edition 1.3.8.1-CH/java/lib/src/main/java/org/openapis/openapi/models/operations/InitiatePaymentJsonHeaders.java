...
public class InitiatePaymentJsonHeaders {
    /**
    ...
    public InitiatePaymentJsonHeaders withConsentID(String consentID) {
    ...
    public InitiatePaymentJsonHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public InitiatePaymentJsonHeaders withPSUAccept(String psuAccept) {
    ...
    public InitiatePaymentJsonHeaders withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public InitiatePaymentJsonHeaders withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public InitiatePaymentJsonHeaders withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public InitiatePaymentJsonHeaders withPSUCorporateID(String psuCorporateID) {
    ...
    public InitiatePaymentJsonHeaders withPSUCorporateIDType(String psuCorporateIDType) {
    ...
    public InitiatePaymentJsonHeaders withPSUDeviceID(String psuDeviceID) {
    ...
    public InitiatePaymentJsonHeaders withPSUGeoLocation(String psuGeoLocation) {
    ...
    public InitiatePaymentJsonHeaders withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public String psuId;
    public InitiatePaymentJsonHeaders withPsuId(String psuId) {
        this.psuId = psuId;
        return this;
    }
    ...
    public InitiatePaymentJsonHeaders withPSUIDType(String psuIDType) {
    ...
    public InitiatePaymentJsonHeaders withPSUIPAddress(String psuIPAddress) {
    ...
    public InitiatePaymentJsonHeaders withPSUIPPort(String psuIPPort) {
    ...
    public InitiatePaymentJsonHeaders withPSUUserAgent(String psuUserAgent) {
    ...
    public InitiatePaymentJsonHeaders withSignature(String signature) {
    ...
    public InitiatePaymentJsonHeaders withTPPBrandLoggingInformation(String tppBrandLoggingInformation) {
    ...
    public InitiatePaymentJsonHeaders withTPPExplicitAuthorisationPreferred(Boolean tppExplicitAuthorisationPreferred) {
    ...
    public InitiatePaymentJsonHeaders withTPPNokRedirectURI(String tppNokRedirectURI) {
    ...
    public InitiatePaymentJsonHeaders withTPPNotificationContentPreferred(String tppNotificationContentPreferred) {
    ...
    public InitiatePaymentJsonHeaders withTPPNotificationURI(String tppNotificationURI) {
    ...
    public InitiatePaymentJsonHeaders withTPPRedirectPreferred(Boolean tppRedirectPreferred) {
    ...
    public InitiatePaymentJsonHeaders withTPPRedirectURI(String tppRedirectURI) {
    ...
    public InitiatePaymentJsonHeaders withTPPRejectionNoFundsPreferred(Boolean tppRejectionNoFundsPreferred) {
    ...
    public InitiatePaymentJsonHeaders withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public InitiatePaymentJsonHeaders withXRequestID(String xRequestID) {
