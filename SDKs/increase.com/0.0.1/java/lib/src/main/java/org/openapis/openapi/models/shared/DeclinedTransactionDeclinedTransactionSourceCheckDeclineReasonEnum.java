 ...
 */
public enum DeclinedTransactionDeclinedTransactionSourceCheckDeclineReasonEnum {
    ...
    private DeclinedTransactionDeclinedTransactionSourceCheckDeclineReasonEnum(String value) {
        this.value = value;
    }
}
