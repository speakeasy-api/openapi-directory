...
class PutscorebyfieldRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\PutscorebyfieldRequest $putscorebyfieldRequest;
	...
	{
		$this->accept = "";
		$this->putscorebyfieldRequest = new \OpenAPI\OpenAPI\Models\Shared\PutscorebyfieldRequest();
		$this->acronym = "";
		$this->fieldName = "";
		$this->id = "";
	}
