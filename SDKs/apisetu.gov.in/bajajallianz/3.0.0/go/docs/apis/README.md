...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Cyipc(ctx, operations.CyipcRequestBody{
        CertificateParameters: &operations.CyipcRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            PolicyNumber: "OG-XX-XXXX-XXXX-XXXXXXXX",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.CyipcRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.CyipcSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
