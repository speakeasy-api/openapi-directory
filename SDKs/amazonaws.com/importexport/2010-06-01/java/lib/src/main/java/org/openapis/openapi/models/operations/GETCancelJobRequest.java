...
public class GETCancelJobRequest {
    ...
    public GETCancelJobRequest(@JsonProperty("AWSAccessKeyId") String awsAccessKeyId, @JsonProperty("Action") GETCancelJobActionEnum action, @JsonProperty("JobId") String jobId, @JsonProperty("Operation") GETCancelJobOperationEnum operation, @JsonProperty("Signature") String signature, @JsonProperty("SignatureMethod") String signatureMethod, @JsonProperty("SignatureVersion") String signatureVersion, @JsonProperty("Timestamp") String timestamp, @JsonProperty("Version") GETCancelJobVersionEnum version) {
        this.awsAccessKeyId = awsAccessKeyId;
        this.action = action;
        this.jobId = jobId;
        this.operation = operation;
