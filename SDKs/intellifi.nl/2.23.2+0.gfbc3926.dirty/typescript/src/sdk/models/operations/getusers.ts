...
export class GetUsersRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=is_admin",
  })
  isAdmin?: boolean;
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=is_locked",
  })
  isLocked?: boolean;
...
export class GetUsers200ApplicationJSON extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.UserOutput })
  @Expose({ name: "results" })
  @Type(() => shared.UserOutput)
