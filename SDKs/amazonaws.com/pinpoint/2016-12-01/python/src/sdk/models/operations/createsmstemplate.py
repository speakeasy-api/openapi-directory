...
from ..shared import createsmstemplateresponse as shared_createsmstemplateresponse
...
class CreateSmsTemplateRequestBody:
    sms_template_request: CreateSmsTemplateRequestBodySmsTemplateRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SMSTemplateRequest') }})
    

@dataclasses.dataclass
class CreateSmsTemplateRequest:
    headers: CreateSmsTemplateHeaders = dataclasses.field()
    path_params: CreateSmsTemplatePathParams = dataclasses.field()
    request: CreateSmsTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateSmsTemplateResponse:
    ...
    create_sms_template_response: Optional[shared_createsmstemplateresponse.CreateSmsTemplateResponse] = dataclasses.field(default=None)
