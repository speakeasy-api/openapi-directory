...
class DescribeTransitGatewayPeeringAttachmentsRequestFilters:
...
class DescribeTransitGatewayPeeringAttachmentsRequest:
    ...
    filters: Optional[list[DescribeTransitGatewayPeeringAttachmentsRequestFilters]] = dataclasses.field(default=None)  
