 ...
 */
public class PostLoadBalancersCreateLoadBalancerRequestLoadBalancerTargetLoadBalancerTargetIP {
    /**
    ...
    public PostLoadBalancersCreateLoadBalancerRequestLoadBalancerTargetLoadBalancerTargetIP withIp(String ip) {
        this.ip = ip;
        return this;
    }
    
    public PostLoadBalancersCreateLoadBalancerRequestLoadBalancerTargetLoadBalancerTargetIP(@JsonProperty("ip") String ip) {
        this.ip = ip;
  }
}
