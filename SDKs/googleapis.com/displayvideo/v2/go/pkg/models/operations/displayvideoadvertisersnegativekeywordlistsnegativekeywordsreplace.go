...
type DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsReplacePathParams struct {
...
type DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsReplaceQueryParams struct {
	// V1 error format.
