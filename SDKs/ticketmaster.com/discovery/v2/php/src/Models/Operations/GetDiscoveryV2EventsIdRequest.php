...
class GetDiscoveryV2EventsIdRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDiscoveryV2EventsIdIncludeLicensedContentEnum $includeLicensedContent
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=includeLicensedContent')]
    public ?GetDiscoveryV2EventsIdIncludeLicensedContentEnum $includeLicensedContent = null;
