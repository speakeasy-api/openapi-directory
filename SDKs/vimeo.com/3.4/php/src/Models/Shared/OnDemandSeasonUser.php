...
class OnDemandSeasonUser
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserAccountEnum $account
     */
	#[\JMS\Serializer\Annotation\SerializedName('account')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserAccountEnum>')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserContentFilterEnum $contentFilter
     */
	#[\JMS\Serializer\Annotation\SerializedName('content_filter')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserContentFilterEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandSeasonUserContentFilterEnum $contentFilter = null;
     ...
     * The user's metadata.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserMetadata $metadata
     */
	#[\JMS\Serializer\Annotation\SerializedName('metadata')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserMetadata')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserPreferences')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandSeasonUserPreferences $preferences = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserUploadQuota $uploadQuota
     */
	#[\JMS\Serializer\Annotation\SerializedName('upload_quota')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserUploadQuota')]
     ...
     * The user's websites.
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserWebsites> $websites
     */
	#[\JMS\Serializer\Annotation\SerializedName('websites')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserWebsites>')]
    public array $websites;
    
	public function __construct()
	{
		$this->account = \OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserAccountEnum::BASIC;
		$this->bio = "";
		...
		$this->link = "";
		$this->location = "";
		$this->metadata = new \OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserMetadata();
		$this->name = "";
		$this->pictures = new \OpenAPI\OpenAPI\Models\Shared\Picture();
		$this->preferences = null;
		$this->resourceKey = "";
		$this->uploadQuota = new \OpenAPI\OpenAPI\Models\Shared\OnDemandSeasonUserUploadQuota();
		$this->uri = "";
		$this->websites = [];
	}
}
