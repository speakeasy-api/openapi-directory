...
class PostDeleteTransitGatewayPrefixListReferenceQueryParams:
    action: PostDeleteTransitGatewayPrefixListReferenceActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDeleteTransitGatewayPrefixListReferenceVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDeleteTransitGatewayPrefixListReferenceRequest:
    headers: PostDeleteTransitGatewayPrefixListReferenceHeaders = dataclasses.field()
    query_params: PostDeleteTransitGatewayPrefixListReferenceQueryParams = dataclasses.field()
