...
class DisplayvideoAdvertisersChannelsSitesBulkEditRequest:
    ...
    r"""Required. The ID of the parent channel to which the sites belong."""  
    ...
    bulk_edit_sites_request_input: Optional[shared_bulkeditsitesrequest.BulkEditSitesRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
