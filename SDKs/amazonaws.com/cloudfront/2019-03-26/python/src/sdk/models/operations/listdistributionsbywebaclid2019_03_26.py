...
class ListDistributionsByWebACLId20190326Request:
    headers: ListDistributionsByWebACLId20190326Headers = dataclasses.field()
    path_params: ListDistributionsByWebACLId20190326PathParams = dataclasses.field()
    query_params: ListDistributionsByWebACLId20190326QueryParams = dataclasses.field()
