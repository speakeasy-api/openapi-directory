...
export class GetPaymentInitiationScaStatusPathParams extends SpeakeasyBase {
...
export class GetPaymentInitiationScaStatusHeaders extends SpeakeasyBase {
...
export class GetPaymentInitiationScaStatusSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class GetPaymentInitiationScaStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPaymentInitiationScaStatusResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
