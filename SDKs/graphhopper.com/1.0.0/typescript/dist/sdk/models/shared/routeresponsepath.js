...
var RouteResponsePathInstructions = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=exit_number" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=street_name" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=turn_angle" }),
        __metadata("design:type", Number)
...
var RouteResponsePath = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ascend" }),
        __metadata("design:type", Number)
    ], RouteResponsePath.prototype, "ascend", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bbox" }),
        __metadata("design:type", Array)
    ], RouteResponsePath.prototype, "bbox", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=descend" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=instructions", elemType: RouteResponsePathInstructions }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=points_order" }),
        __metadata("design:type", Array)
    ], RouteResponsePath.prototype, "pointsOrder", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=snapped_waypoints" }),
        __metadata("design:type", Object)
