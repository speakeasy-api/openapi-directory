...
class DetachInstancesFromLoadBalancerRequest:
    ...
    detach_instances_from_load_balancer_request: shared_detachinstancesfromloadbalancerrequest.DetachInstancesFromLoadBalancerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
