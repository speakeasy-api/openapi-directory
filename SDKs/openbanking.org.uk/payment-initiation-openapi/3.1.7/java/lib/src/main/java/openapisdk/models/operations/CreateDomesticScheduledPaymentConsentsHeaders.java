...
public class CreateDomesticScheduledPaymentConsentsHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticScheduledPaymentConsentsHeaders withAuthorization(String authorization) {
        this.authorization = authorization;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-customer-user-agent")
    public String xCustomerUserAgent;
    public CreateDomesticScheduledPaymentConsentsHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticScheduledPaymentConsentsHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticScheduledPaymentConsentsHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
        this.xFapiCustomerIpAddress = xFapiCustomerIpAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-fapi-interaction-id")
    public String xFapiInteractionId;
    public CreateDomesticScheduledPaymentConsentsHeaders withXFapiInteractionId(String xFapiInteractionId) {
        this.xFapiInteractionId = xFapiInteractionId;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-idempotency-key")
    public String xIdempotencyKey;
    public CreateDomesticScheduledPaymentConsentsHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticScheduledPaymentConsentsHeaders withXJwsSignature(String xJwsSignature) {
