...
class CreateInternationalPaymentsJSONRequest:
    ...
    ob_write_international3: shared_obwriteinternational3.OBWriteInternational3 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
...
@dataclasses.dataclass
class CreateInternationalPaymentsJSONResponse:
