...
export class InvoicePaymentRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "automatic_payment_source" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "computed_amount_money" })
  @Type(() => Money)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "fixed_amount_requested_money" })
  @Type(() => Money)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "percentage_requested" })
  percentageRequested?: string;

  /**
   * A list of one or more reminders to send for the payment request.
   */
  @SpeakeasyMetadata({ elemType: InvoicePaymentReminder })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "rounding_adjustment_included_money" })
  @Type(() => Money)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "total_completed_amount_money" })
  @Type(() => Money)
