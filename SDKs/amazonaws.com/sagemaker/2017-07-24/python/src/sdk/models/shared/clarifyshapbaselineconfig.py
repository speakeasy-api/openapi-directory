...
class ClarifyShapBaselineConfig:
    ...
    shap_baseline: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ShapBaseline'), 'exclude': lambda f: f is None }})  
    shap_baseline_uri: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ShapBaselineUri'), 'exclude': lambda f: f is None }})  
