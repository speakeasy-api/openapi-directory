...
public class GetPhenotypeGenotypeAssociationsRequest {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPhenotypeGenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPhenotypeGenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPhenotypeGenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
