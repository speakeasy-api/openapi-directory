...
exports.ListEnvironmentResponse = exports.ListEnvironmentListEnvironmentResponse = exports.ListEnvironmentListEnvironmentResponseMeta = exports.ListEnvironmentRequest = exports.ListEnvironmentSecurity = exports.ListEnvironmentServerList = void 0;
...
var ListEnvironmentSecurity = /** @class */ (function (_super) {
    ...
    ], ListEnvironmentSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListEnvironmentSecurity.prototype, "username", void 0);
...
var ListEnvironmentRequest = /** @class */ (function (_super) {
    ...
    ], ListEnvironmentRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListEnvironmentRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListEnvironmentRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListEnvironmentRequest.prototype, "serviceSid", void 0);
...
var ListEnvironmentListEnvironmentResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ServerlessV1ServiceEnvironment }),
        (0, class_transformer_1.Expose)({ name: "environments" }),
        (0, class_transformer_1.Type)(function () { return shared.ServerlessV1ServiceEnvironment; }),
        __metadata("design:type", Array)
    ], ListEnvironmentListEnvironmentResponse.prototype, "environments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListEnvironmentListEnvironmentResponseMeta; }),
...
var ListEnvironmentResponse = /** @class */ (function (_super) {
    ...
    ], ListEnvironmentResponse.prototype, "rawResponse", void 0);
