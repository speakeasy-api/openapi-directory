...
public class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsPatchRequest {
    ...
    public DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsPatchRequest withRequest(openapisdk.models.shared.GoogleCloudDiscoveryengineV1alphaDocument request) {
