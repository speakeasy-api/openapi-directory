...
type GetNhFossilsGroupsQueryParams struct {
...
type GetNhFossilsGroupsHeaders struct {
...
type GetNhFossilsGroupsRequest struct {
	QueryParams GetNhFossilsGroupsQueryParams
	Headers     GetNhFossilsGroupsHeaders
}

type GetNhFossilsGroupsResponse struct {
	ContentType string
	...
	NHFossilGroups []shared.NHFossilGroup
	StatusCode     int
