...
public class PaymentLink {
    ...
    public org.openapis.openapi.models.operations.PaymentLinkApiAllResponse paymentLinkApiAll(org.openapis.openapi.models.operations.PaymentLinkApiAllRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.PaymentLinkApiAllQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.PaymentLinkApiUriResponse paymentLinkApiUri(org.openapis.openapi.models.operations.PaymentLinkApiUriRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.PaymentLinkApiUriQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
