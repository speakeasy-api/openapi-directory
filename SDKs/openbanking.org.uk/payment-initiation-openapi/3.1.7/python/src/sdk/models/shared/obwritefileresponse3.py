...
class ObWriteFileResponse3DataInitiation:
    ...
    debtor_account: Optional[ObWriteFileResponse3DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DebtorAccount') }})
    ...
    remittance_information: Optional[ObWriteFileResponse3DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RemittanceInformation') }})
...
class ObWriteFileResponse3DataMultiAuthorisation:
    ...
    status: ObWriteFileResponse3DataMultiAuthorisationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
...
class ObWriteFileResponse3Data:
    ...
    file_payment_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('FilePaymentId') }})
    initiation: ObWriteFileResponse3DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Initiation') }})
    status: ObWriteFileResponse3DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
    ...
    charges: Optional[list[ObWriteFileResponse3DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Charges') }})
    ...
    multi_authorisation: Optional[ObWriteFileResponse3DataMultiAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MultiAuthorisation') }})
    

@dataclass_json
@dataclasses.dataclass
class ObWriteFileResponse3:
    data: ObWriteFileResponse3Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
