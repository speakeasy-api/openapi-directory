...
from ..shared import getrsdetailtype as shared_getrsdetailtype
...
class GETRSbyCreditMemoItemRequest:
    ...
    r"""The unique ID of a credit memo item. You can get the credit memo item ID from the response of [Get credit memo items](https://www.zuora.com/developer/api-reference/#operation/GET_CreditMemoItems)."""  
...
class GETRSbyCreditMemoItemResponse:
    ...
    getrs_detail_type: Optional[shared_getrsdetailtype.GETRSDetailType] = dataclasses.field(default=None)  
