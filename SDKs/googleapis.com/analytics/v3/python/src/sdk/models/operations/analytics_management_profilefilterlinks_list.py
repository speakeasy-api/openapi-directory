...
class AnalyticsManagementProfileFilterLinksListRequest:
    path_params: AnalyticsManagementProfileFilterLinksListPathParams = dataclasses.field()
    query_params: AnalyticsManagementProfileFilterLinksListQueryParams = dataclasses.field()
    security: AnalyticsManagementProfileFilterLinksListSecurity = dataclasses.field()
