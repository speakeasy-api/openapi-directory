...
export class GamesConfigurationLeaderboardConfigurationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GamesConfigurationLeaderboardConfigurationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GamesConfigurationLeaderboardConfigurationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
