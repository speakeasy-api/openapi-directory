...
class ServiceInstance:
    ...
    r"""ID of the resource"""  
    root_service_instance_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('root_service_instance_id'), 'exclude': lambda f: f is None }})
    r"""ID of the resource"""  
    ...
    r"""ID of the resource"""  
    service_plan_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service_plan_id'), 'exclude': lambda f: f is None }})
    r"""ID of the resource"""  
