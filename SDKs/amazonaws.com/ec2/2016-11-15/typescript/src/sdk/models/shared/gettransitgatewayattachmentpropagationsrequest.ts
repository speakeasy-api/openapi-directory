 ...
 */
export class GetTransitGatewayAttachmentPropagationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetTransitGatewayAttachmentPropagationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
