...
func (e ListClosedWorkflowExecutionsXAmzTargetEnum) ToPointer() *ListClosedWorkflowExecutionsXAmzTargetEnum {
	return &e
}
...
func (e *ListClosedWorkflowExecutionsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "SimpleWorkflowService.ListClosedWorkflowExecutions":
		*e = ListClosedWorkflowExecutionsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListClosedWorkflowExecutionsXAmzTargetEnum: %v", v)
	}
}
