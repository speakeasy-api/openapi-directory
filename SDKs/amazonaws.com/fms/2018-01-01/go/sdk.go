...
func (s *SDK) AssociateAdminAccount(ctx context.Context, request operations.AssociateAdminAccountRequest) (*operations.AssociateAdminAccountResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "AssociateAdminAccountRequest", "json")
	if err != nil {
...
func (s *SDK) AssociateThirdPartyFirewall(ctx context.Context, request operations.AssociateThirdPartyFirewallRequest) (*operations.AssociateThirdPartyFirewallResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.AssociateThirdPartyFirewall"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "AssociateThirdPartyFirewallRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.AssociateThirdPartyFirewallResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.AssociateThirdPartyFirewallResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) BatchAssociateResource(ctx context.Context, request operations.BatchAssociateResourceRequest) (*operations.BatchAssociateResourceResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.BatchAssociateResource"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BatchAssociateResourceRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.BatchAssociateResourceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.BatchAssociateResourceResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) BatchDisassociateResource(ctx context.Context, request operations.BatchDisassociateResourceRequest) (*operations.BatchDisassociateResourceResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.BatchDisassociateResource"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "BatchDisassociateResourceRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.BatchDisassociateResourceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.BatchDisassociateResourceResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DeleteAppsList(ctx context.Context, request operations.DeleteAppsListRequest) (*operations.DeleteAppsListResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeleteAppsListRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) DeleteProtocolsList(ctx context.Context, request operations.DeleteProtocolsListRequest) (*operations.DeleteProtocolsListResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeleteProtocolsListRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) DeleteResourceSet(ctx context.Context, request operations.DeleteResourceSetRequest) (*operations.DeleteResourceSetResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.DeleteResourceSet"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeleteResourceSetRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.DeleteResourceSetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *SDK) DisassociateThirdPartyFirewall(ctx context.Context, request operations.DisassociateThirdPartyFirewallRequest) (*operations.DisassociateThirdPartyFirewallResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.DisassociateThirdPartyFirewall"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DisassociateThirdPartyFirewallRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.DisassociateThirdPartyFirewallResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DisassociateThirdPartyFirewallResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetAdminScope(ctx context.Context, request operations.GetAdminScopeRequest) (*operations.GetAdminScopeResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.GetAdminScope"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetAdminScopeRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.GetAdminScopeResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetAdminScopeResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetAppsList(ctx context.Context, request operations.GetAppsListRequest) (*operations.GetAppsListResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetAppsListRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetComplianceDetail(ctx context.Context, request operations.GetComplianceDetailRequest) (*operations.GetComplianceDetailResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetComplianceDetailRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetPolicy(ctx context.Context, request operations.GetPolicyRequest) (*operations.GetPolicyResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetPolicyRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetProtectionStatus(ctx context.Context, request operations.GetProtectionStatusRequest) (*operations.GetProtectionStatusResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetProtectionStatusRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetProtocolsList(ctx context.Context, request operations.GetProtocolsListRequest) (*operations.GetProtocolsListResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetProtocolsListRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) GetResourceSet(ctx context.Context, request operations.GetResourceSetRequest) (*operations.GetResourceSetResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.GetResourceSet"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetResourceSetRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.GetResourceSetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetResourceSetResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetThirdPartyFirewallAssociationStatus(ctx context.Context, request operations.GetThirdPartyFirewallAssociationStatusRequest) (*operations.GetThirdPartyFirewallAssociationStatusResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.GetThirdPartyFirewallAssociationStatus"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetThirdPartyFirewallAssociationStatusRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.GetThirdPartyFirewallAssociationStatusResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetThirdPartyFirewallAssociationStatusResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetViolationDetails(ctx context.Context, request operations.GetViolationDetailsRequest) (*operations.GetViolationDetailsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetViolationDetailsRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
// ListAdminAccountsForOrganization - <p>Returns a <code>AdminAccounts</code> object that lists the Firewall Manager administrators within the organization that are onboarded to Firewall Manager by <a>AssociateAdminAccount</a>.</p> <p>This operation can be called only from the organization's management account.</p>
func (s *SDK) ListAdminAccountsForOrganization(ctx context.Context, request operations.ListAdminAccountsForOrganizationRequest) (*operations.ListAdminAccountsForOrganizationResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.ListAdminAccountsForOrganization"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListAdminAccountsForOrganizationRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.ListAdminAccountsForOrganizationResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListAdminAccountsForOrganizationResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListAdminsManagingAccount(ctx context.Context, request operations.ListAdminsManagingAccountRequest) (*operations.ListAdminsManagingAccountResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.ListAdminsManagingAccount"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListAdminsManagingAccountRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.ListAdminsManagingAccountResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListAdminsManagingAccountResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListAppsLists(ctx context.Context, request operations.ListAppsListsRequest) (*operations.ListAppsListsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListAppsListsRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListComplianceStatus(ctx context.Context, request operations.ListComplianceStatusRequest) (*operations.ListComplianceStatusResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListComplianceStatusRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListDiscoveredResources(ctx context.Context, request operations.ListDiscoveredResourcesRequest) (*operations.ListDiscoveredResourcesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.ListDiscoveredResources"
...
// ListMemberAccounts - <p>Returns a <code>MemberAccounts</code> object that lists the member accounts in the administrator's Amazon Web Services organization.</p> <p>Either an Firewall Manager administrator or the organization's management account can make this request.</p>
...
func (s *SDK) ListPolicies(ctx context.Context, request operations.ListPoliciesRequest) (*operations.ListPoliciesResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListPoliciesRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListProtocolsLists(ctx context.Context, request operations.ListProtocolsListsRequest) (*operations.ListProtocolsListsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListProtocolsListsRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) ListResourceSetResources(ctx context.Context, request operations.ListResourceSetResourcesRequest) (*operations.ListResourceSetResourcesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.ListResourceSetResources"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListResourceSetResourcesRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.ListResourceSetResourcesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListResourceSetResourcesResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListResourceSets(ctx context.Context, request operations.ListResourceSetsRequest) (*operations.ListResourceSetsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.ListResourceSets"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListResourceSetsRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.ListResourceSetsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListResourceSetsResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListThirdPartyFirewallFirewallPolicies(ctx context.Context, request operations.ListThirdPartyFirewallFirewallPoliciesRequest) (*operations.ListThirdPartyFirewallFirewallPoliciesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.ListThirdPartyFirewallFirewallPolicies"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListThirdPartyFirewallFirewallPoliciesRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.ListThirdPartyFirewallFirewallPoliciesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListThirdPartyFirewallFirewallPoliciesResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) PutAdminAccount(ctx context.Context, request operations.PutAdminAccountRequest) (*operations.PutAdminAccountResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.PutAdminAccount"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PutAdminAccountRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.PutAdminAccountResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *SDK) PutAppsList(ctx context.Context, request operations.PutAppsListRequest) (*operations.PutAppsListResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PutAppsListRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) PutNotificationChannel(ctx context.Context, request operations.PutNotificationChannelRequest) (*operations.PutNotificationChannelResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PutNotificationChannelRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) PutPolicy(ctx context.Context, request operations.PutPolicyRequest) (*operations.PutPolicyResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PutPolicyRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) PutProtocolsList(ctx context.Context, request operations.PutProtocolsListRequest) (*operations.PutProtocolsListResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PutProtocolsListRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) PutResourceSet(ctx context.Context, request operations.PutResourceSetRequest) (*operations.PutResourceSetResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AWSFMS_20180101.PutResourceSet"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PutResourceSetRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.PutResourceSetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.PutResourceSetResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
