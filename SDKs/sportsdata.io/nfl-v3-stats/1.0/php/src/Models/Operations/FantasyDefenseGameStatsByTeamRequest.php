...
class FantasyDefenseGameStatsByTeamRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\FantasyDefenseGameStatsByTeamFormatEnum $format
     */
	...
	{
		$this->format = \OpenAPI\OpenAPI\Models\Operations\FantasyDefenseGameStatsByTeamFormatEnum::XML;
		$this->season = "";
		$this->team = "";
		$this->week = "";
	}
