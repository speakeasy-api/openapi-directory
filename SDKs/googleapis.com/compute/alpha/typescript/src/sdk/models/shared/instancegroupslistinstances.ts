 ...
 */
export enum InstanceGroupsListInstancesWarningCodeEnum {
...
export class InstanceGroupsListInstancesWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupsListInstancesWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupsListInstancesWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class InstanceGroupsListInstances extends SpeakeasyBase {
  /**
