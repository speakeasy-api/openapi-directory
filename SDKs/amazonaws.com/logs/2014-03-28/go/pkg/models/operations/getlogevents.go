...
func (e GetLogEventsXAmzTargetEnum) ToPointer() *GetLogEventsXAmzTargetEnum {
	return &e
}
...
func (e *GetLogEventsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "Logs_20140328.GetLogEvents":
		*e = GetLogEventsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetLogEventsXAmzTargetEnum: %v", v)
	}
}
