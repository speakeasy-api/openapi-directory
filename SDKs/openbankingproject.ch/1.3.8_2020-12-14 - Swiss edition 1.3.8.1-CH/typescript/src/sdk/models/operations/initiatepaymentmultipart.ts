...
export class InitiatePaymentMultipartSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class InitiatePaymentMultipartRequest extends SpeakeasyBase {
  /**
...
export class InitiatePaymentMultipartResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
