...
type ChatSpacesMessagesDeleteSecurityOption1 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ChatSpacesMessagesDeleteSecurityOption2 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ChatSpacesMessagesDeleteSecurity struct {
	Option1 *ChatSpacesMessagesDeleteSecurityOption1 `security:"option"`
	Option2 *ChatSpacesMessagesDeleteSecurityOption2 `security:"option"`
}

type ChatSpacesMessagesDeletePathParams struct {
...
type ChatSpacesMessagesDeleteQueryParams struct {
	// V1 error format.
