...
class GetAnswersIdsQueryParams:
    ...
    order: Optional[GetAnswersIdsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetAnswersIdsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetAnswersIdsRequest:
    path_params: GetAnswersIdsPathParams = dataclasses.field()
    query_params: GetAnswersIdsQueryParams = dataclasses.field()
