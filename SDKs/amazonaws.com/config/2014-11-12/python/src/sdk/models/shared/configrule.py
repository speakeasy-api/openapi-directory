...
from ..shared import evaluationmodeconfiguration as shared_evaluationmodeconfiguration
...
class ConfigRule:
    ...
    config_rule_state: Optional[shared_configrulestate_enum.ConfigRuleStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConfigRuleState'), 'exclude': lambda f: f is None }})  
    ...
    evaluation_modes: Optional[list[shared_evaluationmodeconfiguration.EvaluationModeConfiguration]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EvaluationModes'), 'exclude': lambda f: f is None }})  
