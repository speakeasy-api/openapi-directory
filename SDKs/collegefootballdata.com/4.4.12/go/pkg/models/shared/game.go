...
type Game struct {
	...
	AwayPostgameElo *int64   `json:"away_postgame_elo,omitempty"`
	AwayPregameElo  *int64   `json:"away_pregame_elo,omitempty"`
	...
	HomePostgameElo *int64   `json:"home_postgame_elo,omitempty"`
	HomePregameElo  *int64   `json:"home_pregame_elo,omitempty"`
