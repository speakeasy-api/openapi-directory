...
class DescribeConformancePacksRequest:
    ...
    describe_conformance_packs_request: shared_describeconformancepacksrequest.DescribeConformancePacksRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
