...
func (s *SDK) DeleteLexicon(ctx context.Context, request operations.DeleteLexiconRequest) (*operations.DeleteLexiconResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/lexicons/{LexiconName}", request.PathParams)
	...
	res := &operations.DeleteLexiconResponse{
...
func (s *SDK) DescribeVoices(ctx context.Context, request operations.DescribeVoicesRequest) (*operations.DescribeVoicesResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.DescribeVoicesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeVoicesOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetLexicon(ctx context.Context, request operations.GetLexiconRequest) (*operations.GetLexiconResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/lexicons/{LexiconName}", request.PathParams)
	...
	res := &operations.GetLexiconResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetLexiconOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetSpeechSynthesisTask(ctx context.Context, request operations.GetSpeechSynthesisTaskRequest) (*operations.GetSpeechSynthesisTaskResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/synthesisTasks/{TaskId}", request.PathParams)
	...
	res := &operations.GetSpeechSynthesisTaskResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetSpeechSynthesisTaskOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListLexicons(ctx context.Context, request operations.ListLexiconsRequest) (*operations.ListLexiconsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/lexicons"
	...
	res := &operations.ListLexiconsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListLexiconsOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListSpeechSynthesisTasks(ctx context.Context, request operations.ListSpeechSynthesisTasksRequest) (*operations.ListSpeechSynthesisTasksResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/synthesisTasks"
	...
	res := &operations.ListSpeechSynthesisTasksResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ListSpeechSynthesisTasksOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) PutLexicon(ctx context.Context, request operations.PutLexiconRequest) (*operations.PutLexiconResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/lexicons/{LexiconName}", request.PathParams)
	...
	res := &operations.PutLexiconResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) StartSpeechSynthesisTask(ctx context.Context, request operations.StartSpeechSynthesisTaskRequest) (*operations.StartSpeechSynthesisTaskResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/synthesisTasks"
	...
	res := &operations.StartSpeechSynthesisTaskResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.StartSpeechSynthesisTaskOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) SynthesizeSpeech(ctx context.Context, request operations.SynthesizeSpeechRequest) (*operations.SynthesizeSpeechResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/speech"
	...
	res := &operations.SynthesizeSpeechResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.SynthesizeSpeechOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
