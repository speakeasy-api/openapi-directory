...
public class GetPhenotypePathwayAssociationsQueryParams {
    /**
    ...
    public GetPhenotypePathwayAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPhenotypePathwayAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetPhenotypePathwayAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPhenotypePathwayAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetPhenotypePathwayAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetPhenotypePathwayAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetPhenotypePathwayAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetPhenotypePathwayAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetPhenotypePathwayAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetPhenotypePathwayAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetPhenotypePathwayAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPhenotypePathwayAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
