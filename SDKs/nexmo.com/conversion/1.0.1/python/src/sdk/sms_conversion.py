...
class SMSConversion:
    ...
    def sms_conversion(self, request: operations.SmsConversionRequest) -> operations.SmsConversionResponse:
        ...
        query_params = utils.get_query_params(operations.SmsConversionRequest, request)
        ...
        res = operations.SmsConversionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
