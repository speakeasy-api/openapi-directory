...
class DeleteApplicationFromEnvironmentRequest:
    ...
    r"""The unique identifier of the application you want to delete."""  
    environment_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'environmentId', 'style': 'simple', 'explode': False }})
    r"""The unique identifier of the runtime environment where the application was previously deployed."""  
...
class DeleteApplicationFromEnvironmentResponse:
    ...
    r"""ConflictException"""  
    delete_application_from_environment_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
