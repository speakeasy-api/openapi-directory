 ...
 */
export enum SslPoliciesListWarningCodeEnum {
...
export class SslPoliciesListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SslPoliciesListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SslPoliciesListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class SslPoliciesList extends SpeakeasyBase {
  /**
