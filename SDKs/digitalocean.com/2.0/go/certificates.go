...
func (s *Certificates) CreateCertificates(ctx context.Context, request operations.CreateCertificatesRequest) (*operations.CreateCertificatesResponse, error) {
...
func (s *Certificates) ListCertificates(ctx context.Context, request operations.ListCertificatesRequest) (*operations.ListCertificatesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/certificates"
