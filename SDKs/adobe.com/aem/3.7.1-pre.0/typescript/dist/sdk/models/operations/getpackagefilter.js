...
exports.GetPackageFilterResponse = exports.GetPackageFilterRequest = void 0;
...
var GetPackageFilterRequest = /** @class */ (function (_super) {
    ...
    ], GetPackageFilterRequest.prototype, "group", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name",
        }),
        __metadata("design:type", String)
    ], GetPackageFilterRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=version",
        }),
        __metadata("design:type", String)
    ], GetPackageFilterRequest.prototype, "version", void 0);
...
var GetPackageFilterResponse = /** @class */ (function (_super) {
    ...
    ], GetPackageFilterResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
