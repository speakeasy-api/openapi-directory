...
class GroupsSettingsGroupsGetRequest:
    path_params: GroupsSettingsGroupsGetPathParams = dataclasses.field()
    query_params: GroupsSettingsGroupsGetQueryParams = dataclasses.field()
    security: GroupsSettingsGroupsGetSecurity = dataclasses.field()
