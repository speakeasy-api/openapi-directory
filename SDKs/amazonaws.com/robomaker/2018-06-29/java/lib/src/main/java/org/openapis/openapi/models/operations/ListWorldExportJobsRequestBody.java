...
public class ListWorldExportJobsRequestBody {
    /**
    ...
    public ListWorldExportJobsRequestBody withFilters(org.openapis.openapi.models.shared.Filter[] filters) {
    ...
    public ListWorldExportJobsRequestBody withMaxResults(Long maxResults) {
    ...
    public ListWorldExportJobsRequestBody withNextToken(String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
    
    public ListWorldExportJobsRequestBody(){}
}
