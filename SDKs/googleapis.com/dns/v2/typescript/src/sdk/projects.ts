...
export class Projects {
  ...
  dnsProjectsGet(
    ...
    security: operations.DnsProjectsGetSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DnsProjectsGetSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DnsProjectsGetResponse =
        new operations.DnsProjectsGetResponse({
