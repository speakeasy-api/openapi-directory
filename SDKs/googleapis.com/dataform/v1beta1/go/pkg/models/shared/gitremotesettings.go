...
func (e GitRemoteSettingsTokenStatusEnum) ToPointer() *GitRemoteSettingsTokenStatusEnum {
	return &e
}
...
func (e *GitRemoteSettingsTokenStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "INVALID":
		fallthrough
	case "VALID":
		*e = GitRemoteSettingsTokenStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GitRemoteSettingsTokenStatusEnum: %v", v)
	}
}
