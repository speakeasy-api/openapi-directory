...
export class ListFieldLevelEncryptionConfigs20180618Request extends SpeakeasyBase {
  /**
...
export class ListFieldLevelEncryptionConfigs20180618Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
