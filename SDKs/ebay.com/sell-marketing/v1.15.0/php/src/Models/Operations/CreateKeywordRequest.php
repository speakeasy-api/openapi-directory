...
class CreateKeywordRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CreateKeywordRequest $createKeywordRequest
     */
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public \OpenAPI\OpenAPI\Models\Shared\CreateKeywordRequest $createKeywordRequest;
	...
	{
		$this->createKeywordRequest = new \OpenAPI\OpenAPI\Models\Shared\CreateKeywordRequest();
		$this->campaignId = "";
	}
}
