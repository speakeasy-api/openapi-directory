  ...
  **/
  deleteFilesPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.DeleteFilesPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  patchFilesPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PatchFilesPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.fileEntity = httpRes?.data;
  ...
  **/
  postFilesPath(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostFilesPathResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
