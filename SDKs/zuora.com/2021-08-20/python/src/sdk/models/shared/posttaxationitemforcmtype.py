...
class POSTTaxationItemForCMTypeFinanceInformation:
...
class POSTTaxationItemForCMTypeTaxRateTypeEnum(str, Enum):
...
class POSTTaxationItemForCMType:
    ...
    r"""The amount of the tax applied to the credit memo."""  
    ...
    tax_rate_type: POSTTaxationItemForCMTypeTaxRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType') }})
    r"""The type of the tax rate applied to the credit memo."""  
    ...
    finance_information: Optional[POSTTaxationItemForCMTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the taxation item."""  
    ...
    r"""The ID of the credit memo that the taxation item is created for."""  
    ...
    r"""The ID of the taxation item of the invoice, which the credit memo is created from.
    ...
    **Note:** 
    ...
    r"""The date when the tax is applied to the credit memo."""  
