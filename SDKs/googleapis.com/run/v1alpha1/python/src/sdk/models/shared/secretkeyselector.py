...
class SecretKeySelector:
    ...
    r"""A Cloud Secret Manager secret version. Must be 'latest' for the latest version or an integer for a specific version. The key of the secret to select from. Must be a valid secret key."""  
    ...
    r"""(Optional) Specify whether the Secret or its key must be defined"""  
