...
type UpdateFindingsRequestBodyFilters struct {
	...
	ComplianceAssociatedStandardsID                []shared.StringFilter  `json:"ComplianceAssociatedStandardsId,omitempty"`
	ComplianceSecurityControlID                    []shared.StringFilter  `json:"ComplianceSecurityControlId,omitempty"`
	...
	Sample                                         []shared.BooleanFilter `json:"Sample,omitempty"`
...
func (e UpdateFindingsRequestBodyRecordStateEnum) ToPointer() *UpdateFindingsRequestBodyRecordStateEnum {
	return &e
}

func (e *UpdateFindingsRequestBodyRecordStateEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "ACTIVE":
		fallthrough
	case "ARCHIVED":
		*e = UpdateFindingsRequestBodyRecordStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateFindingsRequestBodyRecordStateEnum: %v", v)
	}
}
