...
import dataclasses
from ..shared import googlecloudconnectorsv1authconfig as shared_googlecloudconnectorsv1authconfig
from ..shared import googlecloudconnectorsv1configvariable as shared_googlecloudconnectorsv1configvariable
from ..shared import googlecloudconnectorsv1connectionstatus as shared_googlecloudconnectorsv1connectionstatus
from ..shared import googlecloudconnectorsv1destinationconfig as shared_googlecloudconnectorsv1destinationconfig
from ..shared import googlecloudconnectorsv1lockconfig as shared_googlecloudconnectorsv1lockconfig
from ..shared import googlecloudconnectorsv1nodeconfig as shared_googlecloudconnectorsv1nodeconfig
from ..shared import googlecloudconnectorsv1sslconfig as shared_googlecloudconnectorsv1sslconfig
...
class GoogleCloudConnectorsV1Connection:
    ...
    auth_config: Optional[shared_googlecloudconnectorsv1authconfig.GoogleCloudConnectorsV1AuthConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authConfig'), 'exclude': lambda f: f is None }})
    r"""AuthConfig defines details of a authentication type."""  
    config_variables: Optional[list[shared_googlecloudconnectorsv1configvariable.GoogleCloudConnectorsV1ConfigVariable]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('configVariables'), 'exclude': lambda f: f is None }})
    ...
    destination_configs: Optional[list[shared_googlecloudconnectorsv1destinationconfig.GoogleCloudConnectorsV1DestinationConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinationConfigs'), 'exclude': lambda f: f is None }})
    ...
    lock_config: Optional[shared_googlecloudconnectorsv1lockconfig.GoogleCloudConnectorsV1LockConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lockConfig'), 'exclude': lambda f: f is None }})
    ...
    node_config: Optional[shared_googlecloudconnectorsv1nodeconfig.GoogleCloudConnectorsV1NodeConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nodeConfig'), 'exclude': lambda f: f is None }})
    ...
    ssl_config: Optional[shared_googlecloudconnectorsv1sslconfig.GoogleCloudConnectorsV1SslConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sslConfig'), 'exclude': lambda f: f is None }})
    r"""SSL Configuration of a connection"""  
    status: Optional[shared_googlecloudconnectorsv1connectionstatus.GoogleCloudConnectorsV1ConnectionStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
