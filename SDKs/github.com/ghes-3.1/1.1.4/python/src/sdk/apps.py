...
class Apps:
    ...
    def apps_check_authorization(self, request: operations.AppsCheckAuthorizationRequest) -> operations.AppsCheckAuthorizationResponse:
        ...
        **Deprecation Notice:** GitHub Enterprise Server will discontinue OAuth endpoints that contain `access_token` in the path parameter. We have introduced new endpoints that allow you to securely manage tokens for OAuth Apps by moving `access_token` to the request body. For more information, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-app-endpoint/).
        ...
        url = utils.generate_url(operations.AppsCheckAuthorizationRequest, base_url, '/applications/{client_id}/tokens/{access_token}', request)
        ...
        res = operations.AppsCheckAuthorizationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.NullableAuthorization])
                res.nullable_authorization = out
    ...
    def apps_create_content_attachment(self, request: operations.AppsCreateContentAttachmentRequest) -> operations.AppsCreateContentAttachmentResponse:
        ...
        url = utils.generate_url(operations.AppsCreateContentAttachmentRequest, base_url, '/repos/{owner}/{repo}/content_references/{content_reference_id}/attachments', request)
        ...
        res = operations.AppsCreateContentAttachmentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ContentReferenceAttachment])
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AppsCreateContentAttachment415ApplicationJSON])
    ...
    def apps_revoke_authorization_for_application(self, request: operations.AppsRevokeAuthorizationForApplicationRequest) -> operations.AppsRevokeAuthorizationForApplicationResponse:
        ...
        **Deprecation Notice:** GitHub Enterprise Server will discontinue OAuth endpoints that contain `access_token` in the path parameter. We have introduced new endpoints that allow you to securely manage tokens for OAuth Apps by moving `access_token` to the request body. For more information, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-app-endpoint/).
        ...
        url = utils.generate_url(operations.AppsRevokeAuthorizationForApplicationRequest, base_url, '/applications/{client_id}/tokens/{access_token}', request)
        ...
        res = operations.AppsRevokeAuthorizationForApplicationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def apps_revoke_grant_for_application(self, request: operations.AppsRevokeGrantForApplicationRequest) -> operations.AppsRevokeGrantForApplicationResponse:
        ...
        **Deprecation Notice:** GitHub Enterprise Server will discontinue OAuth endpoints that contain `access_token` in the path parameter. We have introduced new endpoints that allow you to securely manage tokens for OAuth Apps by moving `access_token` to the request body. For more information, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-app-endpoint/).
        ...
        url = utils.generate_url(operations.AppsRevokeGrantForApplicationRequest, base_url, '/applications/{client_id}/grants/{access_token}', request)
        ...
        res = operations.AppsRevokeGrantForApplicationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
