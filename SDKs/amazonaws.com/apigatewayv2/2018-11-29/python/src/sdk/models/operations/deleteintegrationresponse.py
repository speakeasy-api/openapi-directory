...
class DeleteIntegrationResponsePathParams:
...
@dataclasses.dataclass
class DeleteIntegrationResponseHeaders:
...
class DeleteIntegrationResponseRequest:
    headers: DeleteIntegrationResponseHeaders = dataclasses.field()
    path_params: DeleteIntegrationResponsePathParams = dataclasses.field()
