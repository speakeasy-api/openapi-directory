...
public class GetV2CalendarEventsQueryParams {
    /**
    ...
    public GetV2CalendarEventsQueryParams withEndTime(String endTime) {
    ...
    public GetV2CalendarEventsQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public Long page;
    public GetV2CalendarEventsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2CalendarEventsQueryParams withPerPage(Long perPage) {
    ...
    public GetV2CalendarEventsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2CalendarEventsQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2CalendarEventsQueryParams withStartTime(String startTime) {
    ...
    public GetV2CalendarEventsQueryParams withUserGuid(String userGuid) {
