...
class PreprintsContributorsListRequest:
...
class PreprintsContributorsListContributorAttributesPermissionEnum(str, Enum):
...
class PreprintsContributorsListContributorAttributes:
    ...
    permission: Optional[PreprintsContributorsListContributorAttributesPermissionEnum] = dataclasses.field(default=None)
    r"""The permission level of the contributor. The default value is 'write'."""  
...
@dataclasses.dataclass
class PreprintsContributorsListContributorRelationships:
...
class PreprintsContributorsListContributor:
    ...
    relationships: PreprintsContributorsListContributorRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the contributor entity."""  
    type: str = dataclasses.field()
    r"""The type identifier of the contributor entity (`contributors`)."""  
    attributes: Optional[PreprintsContributorsListContributorAttributes] = dataclasses.field(default=None)
    r"""The properties of the contributor entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the contributor entity. Contributor identifiers have the form {preprint_id}-{user_id}."""  
    links: Optional[PreprintsContributorsListContributorLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the contributor entity."""  
    

@dataclasses.dataclass
class PreprintsContributorsListResponse:
