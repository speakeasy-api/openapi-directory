...
class GetShipmentByIdResponseBody
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyDeliveryConfirmationEnum $confirmation
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyDeliveryConfirmationEnum>')]
    public GetShipmentByIdResponseBodyDeliveryConfirmationEnum $confirmation;
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyInternationalShipmentOptions $customs
     */
	#[\JMS\Serializer\Annotation\SerializedName('customs')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyInternationalShipmentOptions')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyInsuranceProviderEnum $insuranceProvider
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_provider')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyInsuranceProviderEnum>')]
    public GetShipmentByIdResponseBodyInsuranceProviderEnum $insuranceProvider;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyOriginTypeEnum $originType
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyOriginTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetShipmentByIdResponseBodyOriginTypeEnum $originType = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyShipmentStatusEnum $shipmentStatus
     */
	#[\JMS\Serializer\Annotation\SerializedName('shipment_status')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyShipmentStatusEnum>')]
    public GetShipmentByIdResponseBodyShipmentStatusEnum $shipmentStatus;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyWeight $totalWeight
     */
	#[\JMS\Serializer\Annotation\SerializedName('total_weight')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyWeight')]
	...
	public function __construct()
	{
		...
		$this->carrierId = "";
		$this->confirmation = \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyDeliveryConfirmationEnum::NONE;
		$this->createdAt = new \DateTime();
		$this->customs = new \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyInternationalShipmentOptions();
		$this->externalOrderId = null;
		$this->externalShipmentId = null;
		$this->insuranceProvider = \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyInsuranceProviderEnum::NONE;
		$this->isReturn = null;
		$this->items = null;
		...
		$this->shipmentStatus = \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyShipmentStatusEnum::PENDING;
		$this->tags = [];
		$this->taxIdentifiers = null;
		$this->totalWeight = new \OpenAPI\OpenAPI\Models\Shared\GetShipmentByIdResponseBodyWeight();
		$this->warehouseId = "";
	}
}
