...
exports.AddressAggregatedList = exports.AddressAggregatedListWarning = exports.AddressAggregatedListWarningData = exports.AddressAggregatedListWarningCodeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var addressesscopedlist_1 = require("./addressesscopedlist");
var class_transformer_1 = require("class-transformer");
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
var AddressAggregatedListWarningCodeEnum;
(function (AddressAggregatedListWarningCodeEnum) {
...
})(AddressAggregatedListWarningCodeEnum = exports.AddressAggregatedListWarningCodeEnum || (exports.AddressAggregatedListWarningCodeEnum = {}));
var AddressAggregatedListWarningData = /** @class */ (function (_super) {
    __extends(AddressAggregatedListWarningData, _super);
    function AddressAggregatedListWarningData() {
    ...
    ], AddressAggregatedListWarningData.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "value" }),
        __metadata("design:type", String)
    ], AddressAggregatedListWarningData.prototype, "value", void 0);
    return AddressAggregatedListWarningData;
}(utils_1.SpeakeasyBase));
exports.AddressAggregatedListWarningData = AddressAggregatedListWarningData;
/**
 * [Output Only] Informational warning message.
 */
var AddressAggregatedListWarning = /** @class */ (function (_super) {
    __extends(AddressAggregatedListWarning, _super);
    function AddressAggregatedListWarning() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], AddressAggregatedListWarning.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: AddressAggregatedListWarningData }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return AddressAggregatedListWarningData; }),
        __metadata("design:type", Array)
    ], AddressAggregatedListWarning.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "message" }),
        __metadata("design:type", String)
    ], AddressAggregatedListWarning.prototype, "message", void 0);
    return AddressAggregatedListWarning;
}(utils_1.SpeakeasyBase));
exports.AddressAggregatedListWarning = AddressAggregatedListWarning;
/**
 * Successful response
 */
var AddressAggregatedList = /** @class */ (function (_super) {
    __extends(AddressAggregatedList, _super);
    function AddressAggregatedList() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], AddressAggregatedList.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: addressesscopedlist_1.AddressesScopedList }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], addressesscopedlist_1.AddressesScopedList);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
    ], AddressAggregatedList.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kind" }),
        __metadata("design:type", String)
    ], AddressAggregatedList.prototype, "kind", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nextPageToken" }),
        __metadata("design:type", String)
    ], AddressAggregatedList.prototype, "nextPageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selfLink" }),
        __metadata("design:type", String)
    ], AddressAggregatedList.prototype, "selfLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unreachables" }),
        __metadata("design:type", Array)
    ], AddressAggregatedList.prototype, "unreachables", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "warning" }),
        (0, class_transformer_1.Type)(function () { return AddressAggregatedListWarning; }),
        __metadata("design:type", AddressAggregatedListWarning)
    ], AddressAggregatedList.prototype, "warning", void 0);
    return AddressAggregatedList;
}(utils_1.SpeakeasyBase));
exports.AddressAggregatedList = AddressAggregatedList;
