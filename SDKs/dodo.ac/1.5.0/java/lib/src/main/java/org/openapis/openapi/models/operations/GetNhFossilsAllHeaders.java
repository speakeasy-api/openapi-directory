...
public class GetNhFossilsAllHeaders {
    /**
    ...
    public GetNhFossilsAllHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsAllHeaders withXApiKey(String xApiKey) {
