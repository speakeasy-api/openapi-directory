 ...
 */
export enum NodeTemplatesScopedListWarningCodeEnum {
...
export class NodeTemplatesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeTemplatesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeTemplatesScopedListWarningData })
  @Expose({ name: "data" })
...
export class NodeTemplatesScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of node templates contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: NodeTemplate })
  @Expose({ name: "nodeTemplates" })
  @Type(() => NodeTemplate)
