...
var VersionInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=agentHash" }),
        __metadata("design:type", String)
    ], VersionInfo.prototype, "agentHash", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=agentVersion" }),
        __metadata("design:type", String)
    ], VersionInfo.prototype, "agentVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dockerVersion" }),
        __metadata("design:type", String)
    ], VersionInfo.prototype, "dockerVersion", void 0);
    return VersionInfo;
