 ...
 */
export class GetPortfolioTemplate500ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class GetPortfolioTemplate429ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class GetPortfolioTemplate404ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class GetPortfolioTemplate403ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
 ...
 */
export class GetPortfolioTemplate401ApplicationJSON extends SpeakeasyBase {
  /**
   * Optional error code
   */
  @SpeakeasyMetadata()
...
export class GetPortfolioTemplate200ApplicationJSONRatios extends SpeakeasyBase {
  /**
 ...
 * success
 */
export class GetPortfolioTemplate200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: GetPortfolioTemplate200ApplicationJSONRatios })
  @Expose({ name: "ratios" })
  @Type(() => GetPortfolioTemplate200ApplicationJSONRatios)
