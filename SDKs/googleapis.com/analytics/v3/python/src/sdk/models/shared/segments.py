...
class Segments:
    r"""An segment collection lists Analytics segments that the user has access to. Each resource in the collection corresponds to a single Analytics segment."""
    
    items: Optional[list[shared_segment.Segment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""A list of segments."""  
    ...
    r"""Collection type for segments."""  
    ...
    r"""Link to next page for this segment collection."""  
    ...
    r"""Link to previous page for this segment collection."""  
