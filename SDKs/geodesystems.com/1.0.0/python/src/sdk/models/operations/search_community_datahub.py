...
class SearchCommunityDatahubQueryParams:
...
@dataclasses.dataclass
class SearchCommunityDatahubRequest:
    query_params: SearchCommunityDatahubQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchCommunityDatahubResponse:
