...
var EventReminders = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=overrides", elemType: eventreminder_1.EventReminder }),
...
var Event = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=anyoneCanAddSelf" }),
        __metadata("design:type", Boolean)
    ], Event.prototype, "anyoneCanAddSelf", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attachments", elemType: eventattachment_1.EventAttachment }),
        __metadata("design:type", Array)
    ], Event.prototype, "attachments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attendees", elemType: eventattendee_1.EventAttendee }),
        __metadata("design:type", Array)
    ], Event.prototype, "attendees", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attendeesOmitted" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conferenceData" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=endTimeUnspecified" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=extendedProperties" }),
        __metadata("design:type", EventExtendedProperties)
    ], Event.prototype, "extendedProperties", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gadget" }),
        __metadata("design:type", EventGadget)
    ], Event.prototype, "gadget", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=guestsCanInviteOthers" }),
        __metadata("design:type", Boolean)
    ], Event.prototype, "guestsCanInviteOthers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=guestsCanModify" }),
        __metadata("design:type", Boolean)
    ], Event.prototype, "guestsCanModify", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=guestsCanSeeOtherGuests" }),
        __metadata("design:type", Boolean)
    ], Event.prototype, "guestsCanSeeOtherGuests", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hangoutLink" }),
        __metadata("design:type", String)
    ], Event.prototype, "hangoutLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=htmlLink" }),
        __metadata("design:type", String)
    ], Event.prototype, "htmlLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=iCalUID" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=originalStartTime" }),
        __metadata("design:type", eventdatetime_1.EventDateTime)
    ], Event.prototype, "originalStartTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=privateCopy" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=recurringEventId" }),
        __metadata("design:type", String)
    ], Event.prototype, "recurringEventId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reminders" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transparency" }),
        __metadata("design:type", String)
