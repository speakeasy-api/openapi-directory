...
from ..shared import commentssort as shared_commentssort
from ..shared import getcommentsresponse as shared_getcommentsresponse
...
class CollectionTicketCommentsAllSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CollectionTicketCommentsAllRequest:
    ...
    sort: Optional[shared_commentssort.CommentsSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
    r"""Apply sorting"""  
...
class CollectionTicketCommentsAllResponse:
    ...
    r"""Bad Request"""  
    get_comments_response: Optional[shared_getcommentsresponse.GetCommentsResponse] = dataclasses.field(default=None)
    r"""List Comments"""  
