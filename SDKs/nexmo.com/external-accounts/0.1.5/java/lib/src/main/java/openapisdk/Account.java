    ...
    public openapisdk.models.operations.GetAllAccountsResponse getAllAccounts(openapisdk.models.operations.GetAllAccountsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.GetAllAccounts200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetAllAccounts200ApplicationJson.class);
