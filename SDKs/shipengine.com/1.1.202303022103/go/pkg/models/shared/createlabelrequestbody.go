...
func (e *CreateLabelRequestBodyDisplaySchemeEnum) UnmarshalJSON(data []byte) error {
	...
	case "label_and_qr_code":
		*e = CreateLabelRequestBodyDisplaySchemeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLabelRequestBodyDisplaySchemeEnum: %s", s)
	}
}
...
func (e *CreateLabelRequestBodyPartialShipmentOriginTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "pickup":
		fallthrough
	case "drop_off":
		*e = CreateLabelRequestBodyPartialShipmentOriginTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLabelRequestBodyPartialShipmentOriginTypeEnum: %s", s)
	}
}
