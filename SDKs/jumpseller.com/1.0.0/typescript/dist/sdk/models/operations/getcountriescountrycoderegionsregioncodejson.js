...
exports.GetCountriesCountryCodeRegionsRegionCodeJsonResponse = exports.GetCountriesCountryCodeRegionsRegionCodeJsonRequest = void 0;
...
var GetCountriesCountryCodeRegionsRegionCodeJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetCountriesCountryCodeRegionsRegionCodeJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=country_code",
        }),
        __metadata("design:type", String)
    ], GetCountriesCountryCodeRegionsRegionCodeJsonRequest.prototype, "countryCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetCountriesCountryCodeRegionsRegionCodeJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=region_code",
        }),
        __metadata("design:type", String)
    ], GetCountriesCountryCodeRegionsRegionCodeJsonRequest.prototype, "regionCode", void 0);
    return GetCountriesCountryCodeRegionsRegionCodeJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetCountriesCountryCodeRegionsRegionCodeJsonRequest = GetCountriesCountryCodeRegionsRegionCodeJsonRequest;
var GetCountriesCountryCodeRegionsRegionCodeJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetCountriesCountryCodeRegionsRegionCodeJsonResponse.prototype, "rawResponse", void 0);
    return GetCountriesCountryCodeRegionsRegionCodeJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetCountriesCountryCodeRegionsRegionCodeJsonResponse = GetCountriesCountryCodeRegionsRegionCodeJsonResponse;
