...
exports.PutDeliverabilityDashboardOptionResponse = exports.PutDeliverabilityDashboardOptionRequest = exports.PutDeliverabilityDashboardOptionRequestBody = void 0;
...
var PutDeliverabilityDashboardOptionRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "DashboardEnabled" }),
        __metadata("design:type", Boolean)
    ], PutDeliverabilityDashboardOptionRequestBody.prototype, "dashboardEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.DomainDeliverabilityTrackingOption }),
        (0, class_transformer_1.Expose)({ name: "SubscribedDomains" }),
        (0, class_transformer_1.Type)(function () { return shared.DomainDeliverabilityTrackingOption; }),
...
var PutDeliverabilityDashboardOptionRequest = /** @class */ (function (_super) {
    ...
    ], PutDeliverabilityDashboardOptionRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], PutDeliverabilityDashboardOptionRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], PutDeliverabilityDashboardOptionRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], PutDeliverabilityDashboardOptionRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], PutDeliverabilityDashboardOptionRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], PutDeliverabilityDashboardOptionRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], PutDeliverabilityDashboardOptionRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], PutDeliverabilityDashboardOptionRequest.prototype, "xAmzSignedHeaders", void 0);
...
var PutDeliverabilityDashboardOptionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PutDeliverabilityDashboardOptionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
