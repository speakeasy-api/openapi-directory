...
type UpdateNetworkWebhooksHTTPServerRequestBody struct {
	...
	PayloadTemplate *UpdateNetworkWebhooksHTTPServerRequestBodyPayloadTemplate `json:"payloadTemplate,omitempty"`
...
type UpdateNetworkWebhooksHTTPServer200ApplicationJSONPayloadTemplate struct {
...
type UpdateNetworkWebhooksHTTPServer200ApplicationJSON struct {
	// A Base64 encoded ID.
	...
	// The payload template to use when posting data to the HTTP server.
	PayloadTemplate *UpdateNetworkWebhooksHTTPServer200ApplicationJSONPayloadTemplate `json:"payloadTemplate,omitempty"`
