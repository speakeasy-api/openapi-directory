...
class UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestBodyRules:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestBody:
    
    rules: Optional[list[UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestBodyRules]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules'), 'exclude': lambda f: f is None }})
...
class UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequest:
    ...
    request_body: Optional[UpdateDeviceCellularGatewaySettingsPortForwardingRulesRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateDeviceCellularGatewaySettingsPortForwardingRulesResponse:
    ...
    update_device_cellular_gateway_settings_port_forwarding_rules_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
