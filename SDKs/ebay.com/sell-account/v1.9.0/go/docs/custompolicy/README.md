...
func main() {
    ...
    res, err := s.CustomPolicy.CreateCustomPolicy(ctx, operations.CreateCustomPolicyRequest{
        CustomPolicyCreateRequest: shared.CustomPolicyCreateRequest{
            ...
            PolicyType: sdk.String("suscipit"),
        },
        XEbayCMarketplaceID: "iure",
    }, operations.CreateCustomPolicySecurity{
    ...
    if res.CreateCustomPolicy201ApplicationJSONObject != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.CustomPolicy.GetCustomPolicies(ctx, operations.GetCustomPoliciesRequest{
        XEbayCMarketplaceID: "magnam",
        PolicyTypes: sdk.String("debitis"),
    }, operations.GetCustomPoliciesSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
    ...
    if res.CustomPolicyResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.CustomPolicy.GetCustomPolicy(ctx, operations.GetCustomPolicyRequest{
        XEbayCMarketplaceID: "ipsa",
        CustomPolicyID: "delectus",
    }, operations.GetCustomPolicySecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.CustomPolicy.UpdateCustomPolicy(ctx, operations.UpdateCustomPolicyRequest{
        ...
        XEbayCMarketplaceID: "excepturi",
        CustomPolicyID: "nisi",
    }, operations.UpdateCustomPolicySecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
