...
public class DescribeHostsRequestFilter {
    ...
    public DescribeHostsRequestFilter withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeHostsRequestFilter(){}
}
