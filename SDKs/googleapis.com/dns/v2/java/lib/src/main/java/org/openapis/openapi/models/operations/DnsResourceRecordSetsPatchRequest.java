...
public class DnsResourceRecordSetsPatchRequest {
    ...
    public DnsResourceRecordSetsPatchRequest withLocation(String location) {
    ...
    public DnsResourceRecordSetsPatchRequest(@JsonProperty("location") String location, @JsonProperty("managedZone") String managedZone, @JsonProperty("name") String name, @JsonProperty("project") String project, @JsonProperty("type") String type) {
        this.location = location;
        this.managedZone = managedZone;
        this.name = name;
        this.project = project;
