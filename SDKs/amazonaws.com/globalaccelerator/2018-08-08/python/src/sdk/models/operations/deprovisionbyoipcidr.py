...
class DeprovisionByoipCidrRequest:
    ...
    deprovision_byoip_cidr_request: shared_deprovisionbyoipcidrrequest.DeprovisionByoipCidrRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
