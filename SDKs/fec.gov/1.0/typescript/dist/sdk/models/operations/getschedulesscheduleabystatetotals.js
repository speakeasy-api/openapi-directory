...
exports.GetSchedulesScheduleAByStateTotalsResponse = exports.GetSchedulesScheduleAByStateTotalsRequest = void 0;
...
var GetSchedulesScheduleAByStateTotalsRequest = /** @class */ (function (_super) {
    ...
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=committee_type",
        }),
        __metadata("design:type", Array)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "committeeType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=cycle" }),
        __metadata("design:type", Array)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "cycle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "sortNullsLast", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=state" }),
        __metadata("design:type", Array)
    ], GetSchedulesScheduleAByStateTotalsRequest.prototype, "state", void 0);
...
var GetSchedulesScheduleAByStateTotalsResponse = /** @class */ (function (_super) {
    ...
    ], GetSchedulesScheduleAByStateTotalsResponse.prototype, "rawResponse", void 0);
