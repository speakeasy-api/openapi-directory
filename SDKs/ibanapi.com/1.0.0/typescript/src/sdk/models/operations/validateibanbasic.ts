...
export class ValidateIBANBasicSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ValidateIBANBasicRequest extends SpeakeasyBase {
  /**
   * The IBAN
   */
...
export class ValidateIBANBasicResponse extends SpeakeasyBase {
  /**
