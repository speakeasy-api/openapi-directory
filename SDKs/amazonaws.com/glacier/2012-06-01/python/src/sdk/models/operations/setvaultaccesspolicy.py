...
class SetVaultAccessPolicyRequestBodyPolicy:
    r"""Contains the vault access policy."""
...
class SetVaultAccessPolicyRequestBody:
    ...
    policy: Optional[SetVaultAccessPolicyRequestBodyPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policy'), 'exclude': lambda f: f is None }})
    r"""Contains the vault access policy."""  
...
class SetVaultAccessPolicyRequest:
    ...
    request_body: SetVaultAccessPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
