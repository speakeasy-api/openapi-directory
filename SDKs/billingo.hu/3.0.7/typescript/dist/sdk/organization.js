...
var Organization = /** @class */ (function () {
    ...
    Organization.prototype.getOrganizationData = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetOrganizationDataResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.organizationData = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OrganizationData);
                    }
                    break;
