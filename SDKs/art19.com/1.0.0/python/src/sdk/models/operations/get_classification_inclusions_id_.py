...
class GetClassificationInclusionsIDSecurity:
...
class GetClassificationInclusionsIDRequest:
    ...
    r"""The ID of the classification inclusion resource to load."""  
...
class GetClassificationInclusionsID200ApplicationVndAPIPlusJSON:
    ...
    data: Optional[shared_classificationinclusion.ClassificationInclusion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
