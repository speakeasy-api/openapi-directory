...
var TrafficReport = /** @class */ (function () {
     ...
     */
    TrafficReport.prototype.getTrafficReport = function (req, security, config) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetTrafficReportSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetTrafficReportResponse({
