 ...
 */
export declare enum CreateTransitGatewayMulticastDomainRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTransitGatewayMulticastDomainRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTransitGatewayMulticastDomainRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTransitGatewayMulticastDomainRequest extends SpeakeasyBase {
    dryRun?: boolean;
