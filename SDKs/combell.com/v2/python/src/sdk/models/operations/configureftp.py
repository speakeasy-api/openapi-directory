...
from ..shared import ftpconfiguration as shared_ftpconfiguration
...
class ConfigureFtpRequest:
    ...
    ftp_configuration: Optional[shared_ftpconfiguration.FtpConfiguration] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
