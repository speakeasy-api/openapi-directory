...
var PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrder = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_delay" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=failure_reason" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=incoming_phone_number_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=signing_document_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=verification_attempts" }),
        __metadata("design:type", Number)
    ], PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrder.prototype, "verificationAttempts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=verification_call_sids" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=verification_document_sid" }),
        __metadata("design:type", String)
    ], PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrder.prototype, "verificationDocumentSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=verification_type" }),
        __metadata("design:type", String)
