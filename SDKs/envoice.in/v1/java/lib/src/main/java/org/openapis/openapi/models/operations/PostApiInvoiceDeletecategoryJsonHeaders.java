...
public class PostApiInvoiceDeletecategoryJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceDeletecategoryJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceDeletecategoryJsonHeaders withXAuthSecret(String xAuthSecret) {
