 ...
 */
export declare enum NetworkEdgeSecurityServicesScopedListWarningCodeEnum {
...
export declare class NetworkEdgeSecurityServicesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkEdgeSecurityServicesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NetworkEdgeSecurityServicesScopedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NetworkEdgeSecurityServicesScopedListWarningData[];
    /**
     * [Output Only] A human-readable description of the warning code.
     */
    message?: string;
}
export declare class NetworkEdgeSecurityServicesScopedList extends SpeakeasyBase {
    /**
