 ...
 */
public enum WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum {
    ONE("1"),
    TWO("2"),
    THREE("3"),
    FOUR("4"),
    ...
    private WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum(String value) {
        this.value = value;
    }
}
