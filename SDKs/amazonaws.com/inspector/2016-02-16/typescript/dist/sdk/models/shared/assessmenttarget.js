...
**/
var AssessmentTarget = /** @class */ (function (_super) {
    __extends(AssessmentTarget, _super);
    ...
    ], AssessmentTarget.prototype, "arn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=createdAt" }),
        __metadata("design:type", Date)
    ], AssessmentTarget.prototype, "createdAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], AssessmentTarget.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resourceGroupArn" }),
        __metadata("design:type", String)
    ], AssessmentTarget.prototype, "resourceGroupArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=updatedAt" }),
        __metadata("design:type", Date)
    ], AssessmentTarget.prototype, "updatedAt", void 0);
