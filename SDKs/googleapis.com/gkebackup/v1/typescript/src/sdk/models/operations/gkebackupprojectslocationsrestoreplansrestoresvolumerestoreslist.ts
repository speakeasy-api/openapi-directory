...
export class GkebackupProjectsLocationsRestorePlansRestoresVolumeRestoresListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresVolumeRestoresListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansRestoresVolumeRestoresListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
