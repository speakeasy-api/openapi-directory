...
export class Adexchangebuyer2BiddersFilterSetsLosingBidsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2BiddersFilterSetsLosingBidsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class Adexchangebuyer2BiddersFilterSetsLosingBidsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
