...
class GetLatestCountryDataByNameQueryParams:
    ...
    format: Optional[GetLatestCountryDataByNameFormatEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'format', 'style': 'form', 'explode': True }})
...
class GetLatestCountryDataByNameRequest:
    query_params: GetLatestCountryDataByNameQueryParams = dataclasses.field()
...
class GetLatestCountryDataByNameResponse:
    ...
    get_latest_country_data_by_name_200_application_json_objects: Optional[list[GetLatestCountryDataByName200ApplicationJSON]] = dataclasses.field(default=None)
