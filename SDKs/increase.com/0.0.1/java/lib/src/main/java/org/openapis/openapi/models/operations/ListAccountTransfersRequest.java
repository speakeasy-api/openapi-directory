...
public class ListAccountTransfersRequest {
    ...
    public ListAccountTransfersRequest withAccountId(String accountId) {
    ...
    public ListAccountTransfersRequest withCreatedAtAfter(OffsetDateTime createdAtAfter) {
    ...
    public ListAccountTransfersRequest withCreatedAtBefore(OffsetDateTime createdAtBefore) {
    ...
    public ListAccountTransfersRequest withCreatedAtOnOrAfter(OffsetDateTime createdAtOnOrAfter) {
    ...
    public ListAccountTransfersRequest withCreatedAtOnOrBefore(OffsetDateTime createdAtOnOrBefore) {
    ...
    public ListAccountTransfersRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public Long limit;
    public ListAccountTransfersRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
