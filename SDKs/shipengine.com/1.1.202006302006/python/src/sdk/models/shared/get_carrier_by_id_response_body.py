...
class GetCarrierByIDResponseBodyCarrierAdvancedOption:
    r"""GetCarrierByIDResponseBodyCarrierAdvancedOption
...
class GetCarrierByIDResponseBodyPackageType:
    r"""GetCarrierByIDResponseBodyPackageType
...
class GetCarrierByIDResponseBodyService:
    r"""GetCarrierByIDResponseBodyService
...
class GetCarrierByIDResponseBody:
    ...
    options: Optional[list[GetCarrierByIDResponseBodyCarrierAdvancedOption]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('options') }})
    packages: Optional[list[GetCarrierByIDResponseBodyPackageType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('packages') }})
    ...
    services: Optional[list[GetCarrierByIDResponseBodyService]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('services') }})
