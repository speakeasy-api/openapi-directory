...
var VideoSuggestions = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "editorSuggestions" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "processingHints" }),
        __metadata("design:type", Array)
    ], VideoSuggestions.prototype, "processingHints", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "processingWarnings" }),
        __metadata("design:type", Array)
    ], VideoSuggestions.prototype, "processingWarnings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: videosuggestionstagsuggestion_1.VideoSuggestionsTagSuggestion }),
        (0, class_transformer_1.Expose)({ name: "tagSuggestions" }),
        (0, class_transformer_1.Type)(function () { return videosuggestionstagsuggestion_1.VideoSuggestionsTagSuggestion; }),
        __metadata("design:type", Array)
