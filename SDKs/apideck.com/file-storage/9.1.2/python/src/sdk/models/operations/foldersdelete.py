...
from ..shared import deletefolderresponse as shared_deletefolderresponse
...
class FoldersDeleteSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class FoldersDeleteRequest:
...
@dataclasses.dataclass
class FoldersDeleteResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    delete_folder_response: Optional[shared_deletefolderresponse.DeleteFolderResponse] = dataclasses.field(default=None)
    r"""Folders"""  
