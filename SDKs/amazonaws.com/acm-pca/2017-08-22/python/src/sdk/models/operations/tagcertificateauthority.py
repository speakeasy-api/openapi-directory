...
from ..shared import tagcertificateauthorityrequest as shared_tagcertificateauthorityrequest
...
class TagCertificateAuthorityHeaders:
    x_amz_target: TagCertificateAuthorityXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TagCertificateAuthorityRequest:
    headers: TagCertificateAuthorityHeaders = dataclasses.field()
    request: shared_tagcertificateauthorityrequest.TagCertificateAuthorityRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
