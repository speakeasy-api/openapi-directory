...
class CustomerInvoiceDatesDTO:
    ...
    invoice_date: Optional[shared_timedto.TimeDTO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invoiceDate'), 'exclude': lambda f: f is None }})  
