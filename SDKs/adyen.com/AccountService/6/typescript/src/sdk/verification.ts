...
export class Verification {
  ...
  postCheckAccountHolder(
    req: shared.PerformVerificationRequest,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PostCheckAccountHolderResponse =
        new operations.PostCheckAccountHolderResponse({
  ...
  postDeletePayoutMethods(
    req: shared.DeletePayoutMethodRequest,
    security: operations.PostDeletePayoutMethodsSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostDeletePayoutMethodsResponse =
        new operations.PostDeletePayoutMethodsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
