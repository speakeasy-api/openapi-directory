    ...
    public static void main(String[] args) {
        try {
            ...
            PecerRequestBody req = new PecerRequestBody(PecerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new PecerRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "M", "AZSPT67XXX", "4567890329XX");;
            ...
            PecerResponse res = sdk.apIs.pecer(req, new PecerSecurity("maiores", "molestiae") {{
