...
public class DescribeEventsRequest {
    ...
    public org.openapis.openapi.models.shared.DescribeEventsMessage describeEventsMessage;

    public DescribeEventsRequest withDescribeEventsMessage(org.openapis.openapi.models.shared.DescribeEventsMessage describeEventsMessage) {
        this.describeEventsMessage = describeEventsMessage;
        return this;
    }
    ...
    public DescribeEventsRequest withMaxRecords(String maxRecords) {
    ...
    public DescribeEventsRequest(@JsonProperty("DescribeEventsMessage") org.openapis.openapi.models.shared.DescribeEventsMessage describeEventsMessage, @JsonProperty("X-Amz-Target") DescribeEventsXAmzTargetEnum xAmzTarget) {
        this.describeEventsMessage = describeEventsMessage;
        this.xAmzTarget = xAmzTarget;
  }
}
