...
class ComputeRegionCommitmentsUpdateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\Commitment $commitment1 = null;
     ...
     * 
     * @var string $commitmentPathParameter
     */
