...
class DeleteFirewallRequest:
    path_params: DeleteFirewallPathParams = dataclasses.field()
...
class DeleteFirewallResponse:
    ...
    delete_firewall_401_application_json_object: Optional[DeleteFirewall401ApplicationJSON] = dataclasses.field(default=None)
