...
type PrivatecaProjectsLocationsCaPoolsCertificatesRevokeSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type PrivatecaProjectsLocationsCaPoolsCertificatesRevokePathParams struct {
	// Required. The resource name for this Certificate in the format `projects/*/locations/*/caPools/*/certificates/*`.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type PrivatecaProjectsLocationsCaPoolsCertificatesRevokeQueryParams struct {
	// V1 error format.
...
type PrivatecaProjectsLocationsCaPoolsCertificatesRevokeRequest struct {
...
type PrivatecaProjectsLocationsCaPoolsCertificatesRevokeResponse struct {
	// Successful response
