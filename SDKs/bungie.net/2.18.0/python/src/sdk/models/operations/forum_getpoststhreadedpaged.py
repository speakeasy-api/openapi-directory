...
class ForumGetPostsThreadedPagedRequest:
    ...
    get_parent_post: bool = dataclasses.field(metadata={'path_param': { 'field_name': 'getParentPost', 'style': 'simple', 'explode': False }})  
    ...
    parent_post_id: int = dataclasses.field(metadata={'path_param': { 'field_name': 'parentPostId', 'style': 'simple', 'explode': False }})  
...
@dataclasses.dataclass
class ForumGetPostsThreadedPaged200Wildcard:
