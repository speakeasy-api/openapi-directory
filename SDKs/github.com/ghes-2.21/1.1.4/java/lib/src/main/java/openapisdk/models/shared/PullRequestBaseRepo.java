...
public class PullRequestBaseRepo {
    ...
    public PullRequestBaseRepo withAnonymousAccessEnabled(Boolean anonymousAccessEnabled) {
    ...
    public PullRequestBaseRepoLicenseSimple license;
    public PullRequestBaseRepo withLicense(PullRequestBaseRepoLicenseSimple license) {
