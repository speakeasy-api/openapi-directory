...
public class InvoiceApiSendToAccountantJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiSendToAccountantJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiSendToAccountantJsonHeaders withXAuthSecret(String xAuthSecret) {
