 ...
 */
export class DescribeTransitGatewayRouteTableAnnouncementsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayRouteTableAnnouncementsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({
    elemType: DescribeTransitGatewayRouteTableAnnouncementsRequestFilters,
  })
