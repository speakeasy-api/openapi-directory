...
exports.ScalingInstruction = void 0;
var utils_1 = require("../../../internal/utils");
var customizedloadmetricspecification_1 = require("./customizedloadmetricspecification");
var predefinedloadmetricspecification_1 = require("./predefinedloadmetricspecification");
var predictivescalingmaxcapacitybehaviorenum_1 = require("./predictivescalingmaxcapacitybehaviorenum");
...
var scalingpolicyupdatebehaviorenum_1 = require("./scalingpolicyupdatebehaviorenum");
...
var ScalingInstruction = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "CustomizedLoadMetricSpecification" }),
        (0, class_transformer_1.Type)(function () { return customizedloadmetricspecification_1.CustomizedLoadMetricSpecification; }),
        __metadata("design:type", customizedloadmetricspecification_1.CustomizedLoadMetricSpecification)
    ], ScalingInstruction.prototype, "customizedLoadMetricSpecification", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DisableDynamicScaling" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MinCapacity" }),
        __metadata("design:type", Number)
    ], ScalingInstruction.prototype, "minCapacity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "PredefinedLoadMetricSpecification" }),
        (0, class_transformer_1.Type)(function () { return predefinedloadmetricspecification_1.PredefinedLoadMetricSpecification; }),
        __metadata("design:type", predefinedloadmetricspecification_1.PredefinedLoadMetricSpecification)
    ], ScalingInstruction.prototype, "predefinedLoadMetricSpecification", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "PredictiveScalingMaxCapacityBehavior" }),
        __metadata("design:type", String)
    ], ScalingInstruction.prototype, "predictiveScalingMaxCapacityBehavior", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "PredictiveScalingMaxCapacityBuffer" }),
        __metadata("design:type", Number)
    ], ScalingInstruction.prototype, "predictiveScalingMaxCapacityBuffer", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "PredictiveScalingMode" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ScalingPolicyUpdateBehavior" }),
        __metadata("design:type", String)
    ], ScalingInstruction.prototype, "scalingPolicyUpdateBehavior", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ScheduledActionBufferTime" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: targettrackingconfiguration_1.TargetTrackingConfiguration }),
        (0, class_transformer_1.Expose)({ name: "TargetTrackingConfigurations" }),
