...
export class AnalyticsadminPropertiesUserLinksBatchCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesUserLinksBatchCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesUserLinksBatchCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
