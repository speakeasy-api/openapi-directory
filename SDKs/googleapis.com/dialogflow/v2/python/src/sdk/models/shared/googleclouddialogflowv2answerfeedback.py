...
import dataclasses
from ..shared import googleclouddialogflowv2agentassistantfeedback as shared_googleclouddialogflowv2agentassistantfeedback
...
class GoogleCloudDialogflowV2AnswerFeedback:
    ...
    agent_assistant_detail_feedback: Optional[shared_googleclouddialogflowv2agentassistantfeedback.GoogleCloudDialogflowV2AgentAssistantFeedback] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('agentAssistantDetailFeedback'), 'exclude': lambda f: f is None }})
    ...
    correctness_level: Optional[GoogleCloudDialogflowV2AnswerFeedbackCorrectnessLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('correctnessLevel'), 'exclude': lambda f: f is None }})
    r"""The correctness level of the specific answer."""  
