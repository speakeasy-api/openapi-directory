...
class ChargeOverrideForEvergreenBillingBillCycleTypeEnum(str, Enum):
...
class ChargeOverrideForEvergreenBillingBillingPeriodEnum(str, Enum):
    MONTH = "Month"
    QUARTER = "Quarter"
...
class ChargeOverrideForEvergreenBillingBillingPeriodAlignmentEnum(str, Enum):
    ALIGN_TO_CHARGE = "AlignToCharge"
    ALIGN_TO_SUBSCRIPTION_START = "AlignToSubscriptionStart"
    ALIGN_TO_TERM_START = "AlignToTermStart"

class ChargeOverrideForEvergreenBillingBillingTimingEnum(str, Enum):
    IN_ADVANCE = "IN_ADVANCE"
    IN_ARREARS = "IN_ARREARS"

class ChargeOverrideForEvergreenBillingWeeklyBillCycleDayEnum(str, Enum):
    SUNDAY = "Sunday"
    MONDAY = "Monday"
    TUESDAY = "Tuesday"
    WEDNESDAY = "Wednesday"
...
class ChargeOverrideForEvergreenBilling:
    r"""ChargeOverrideForEvergreenBilling
    ...
    bill_cycle_type: Optional[ChargeOverrideForEvergreenBillingBillCycleTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billCycleType') }})
    billing_period: Optional[ChargeOverrideForEvergreenBillingBillingPeriodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingPeriod') }})
    billing_period_alignment: Optional[ChargeOverrideForEvergreenBillingBillingPeriodAlignmentEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingPeriodAlignment') }})
    billing_timing: Optional[ChargeOverrideForEvergreenBillingBillingTimingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingTiming') }})
    ...
    weekly_bill_cycle_day: Optional[ChargeOverrideForEvergreenBillingWeeklyBillCycleDayEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('weeklyBillCycleDay') }})
    

@dataclass_json
@dataclasses.dataclass
class ChargeOverrideForEvergreenPricing:
    r"""ChargeOverrideForEvergreenPricing
...
class ChargeOverrideForEvergreenRevRecTriggerConditionEnum(str, Enum):
...
class ChargeOverrideForEvergreenRevenueRecognitionRuleNameEnum(str, Enum):
...
@dataclass_json
@dataclasses.dataclass
class ChargeOverrideForEvergreen:
    r"""ChargeOverrideForEvergreen
    ...
    billing: Optional[ChargeOverrideForEvergreenBilling] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billing') }})
    ...
    pricing: Optional[ChargeOverrideForEvergreenPricing] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pricing') }})
    ...
    rev_rec_trigger_condition: Optional[ChargeOverrideForEvergreenRevRecTriggerConditionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('revRecTriggerCondition') }})
    revenue_recognition_rule_name: Optional[ChargeOverrideForEvergreenRevenueRecognitionRuleNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('revenueRecognitionRuleName') }})
