...
class GetModelPhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetModelPhenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetModelPhenotypeAssociationsRequest:
    path_params: GetModelPhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetModelPhenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetModelPhenotypeAssociationsResponse:
