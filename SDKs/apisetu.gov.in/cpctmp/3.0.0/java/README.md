    ...
    public static void main(String[] args) {
        try {
            ...
            SkmstRequestBody req = new SkmstRequestBody(SkmstRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SkmstRequestBodyCertificateParameters("eg 000000001", "0000001", "yyyy-mm-dd");;
            ...
            SkmstResponse res = sdk.apIs.skmst(req, new SkmstSecurity("molestiae", "minus") {{
