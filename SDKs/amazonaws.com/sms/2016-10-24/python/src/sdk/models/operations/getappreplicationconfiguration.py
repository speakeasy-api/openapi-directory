...
class GetAppReplicationConfigurationRequest:
    ...
    get_app_replication_configuration_request: shared_getappreplicationconfigurationrequest.GetAppReplicationConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
