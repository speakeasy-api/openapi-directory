...
class DashboardWebinarParticipantShare200ApplicationXMLParticipants:
    ...
    details: Optional[list[DashboardWebinarParticipantShare200ApplicationXMLParticipantsDetails]] = dataclasses.field(default=None)
...
@dataclasses.dataclass
class DashboardWebinarParticipantShare200ApplicationXML:
    r"""Pagination object."""
    ...
    r"""The number of records returned within a single API call."""  
    participants: Optional[list[DashboardWebinarParticipantShare200ApplicationXMLParticipants]] = dataclasses.field(default=None)
...
class DashboardWebinarParticipantShare200ApplicationJSONParticipants:
    ...
    details: Optional[list[DashboardWebinarParticipantShare200ApplicationJSONParticipantsDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('details'), 'exclude': lambda f: f is None }})
    r"""Array of sharing and recording details."""  
...
class DashboardWebinarParticipantShare200ApplicationJSON:
    ...
    r"""The number of records returned within a single API call."""  
    participants: Optional[list[DashboardWebinarParticipantShare200ApplicationJSONParticipants]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participants'), 'exclude': lambda f: f is None }})
    r"""Array of participants."""  
