...
public class UpdateNetworkSwitchStackRoutingInterfaceRequestBody {
    ...
    public UpdateNetworkSwitchStackRoutingInterfaceRequestBody withDefaultGateway(String defaultGateway) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("ipv6")
    public UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 ipv6;

    public UpdateNetworkSwitchStackRoutingInterfaceRequestBody withIpv6(UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 ipv6) {
        this.ipv6 = ipv6;
        return this;
    }
    ...
    public UpdateNetworkSwitchStackRoutingInterfaceRequestBody(){}
}
