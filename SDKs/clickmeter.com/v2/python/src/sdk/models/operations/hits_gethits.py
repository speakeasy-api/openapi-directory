...
class HitsGetHitsRequest:
    ...
    timeframe: HitsGetHitsTimeframeEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'timeframe', 'style': 'form', 'explode': True }})
    r"""Timeframe of the request. See list at $timeframeList"""  
    filter: Optional[HitsGetHitsFilterEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'form', 'explode': True }})
    r"""Filter event type (\\"spiders\\"/\\"uniques\\"/\\"nonuniques\\"/\\"conversions\\")"""  
