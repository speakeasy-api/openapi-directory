...
public class UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBody {
    ...
    public UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBody(@JsonProperty("rules") UpdateNetworkApplianceFirewallOneToManyNatRulesRequestBodyRules[] rules) {
        this.rules = rules;
  }
}
