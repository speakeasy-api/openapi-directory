...
from ..shared import disconnectplayerresult as shared_disconnectplayerresult
...
class DisconnectPlayerResponse:
    ...
    disconnect_player_result: Optional[shared_disconnectplayerresult.DisconnectPlayerResult] = dataclasses.field(default=None)
    r"""Success"""  
