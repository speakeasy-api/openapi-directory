...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.PostDisablePermitResponse;
import org.openapis.openapi.models.operations.PostDisablePermitSecurity;
import org.openapis.openapi.models.shared.DisablePermitRequest;
import org.openapis.openapi.models.shared.SchemeBasicAuth;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.DisablePermitRequest req = new DisablePermitRequest("saepe", "fuga");            

            PostDisablePermitResponse res = sdk.general.postDisablePermit(req, new PostDisablePermitSecurity() {{
                apiKeyAuth = "YOUR_API_KEY_HERE";
            }});

            if (res.disablePermitResult != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.RecurringDetailsRequest req = new RecurringDetailsRequest("in", "corporis") {{
                recurring = new Recurring() {{
                    contract = RecurringContractEnum.RECURRING;
                    recurringDetailName = "iure";
                    recurringExpiry = OffsetDateTime.parse("2020-11-28T02:15:07.561Z");
                    recurringFrequency = "architecto";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.NotifyShopperRequest req = new NotifyShopperRequest(                new Amount("reiciendis", 666767L);, "mollitia", "laborum", "dolores") {{
                billingDate = "dolorem";
                billingSequenceNumber = "corporis";
                displayedReference = "explicabo";
                recurringDetailReference = "nobis";
                storedPaymentMethodId = "enim";
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.shared.ScheduleAccountUpdaterRequest req = new ScheduleAccountUpdaterRequest("omnis", "nemo") {{
