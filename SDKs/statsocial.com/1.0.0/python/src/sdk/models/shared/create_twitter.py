...
import dataclasses
from ..shared import follower_create_response as shared_follower_create_response
...
class CreateTwitter:
    ...
    data: Optional[shared_follower_create_response.FollowerCreateResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
