...
class GetNamesNotOfficialSearchEmbedEnum(str, Enum):
    r"""A flag to indicate whether to embed the corresponding 'feature' into each matching name"""
    ZERO = '0'
    ONE = '1'

class GetNamesNotOfficialSearchExactSpellingEnum(str, Enum):
...
class GetNamesNotOfficialSearchOutputSrsEnum(str, Enum):
...
class GetNamesNotOfficialSearchRequest:
    ...
    r"""The format of the output."""  
    embed: Optional[GetNamesNotOfficialSearchEmbedEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'embed', 'style': 'form', 'explode': True }})
    r"""A flag to indicate whether to embed the corresponding 'feature' into each matching name"""  
    exact_spelling: Optional[GetNamesNotOfficialSearchExactSpellingEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'exactSpelling', 'style': 'form', 'explode': True }})
    r"""If the 'name' parameter is specified, 'exactSpelling' specifies whether to include only names that exactly match the search text (exactSpelling=1), or whether to also include names with similar spellings (exactSpelling=0)"""  
    ...
    output_srs: Optional[GetNamesNotOfficialSearchOutputSrsEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outputSRS', 'style': 'form', 'explode': True }})
    r"""The EPSG code of the spatial reference system (SRS) to use for output geometries."""  
