...
exports.GetContainersJsonResponse = exports.GetContainersJsonRequest = void 0;
...
var GetContainersJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetContainersJsonRequest.prototype, "xAuthProjectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Auth-Token",
        }),
        __metadata("design:type", String)
    ], GetContainersJsonRequest.prototype, "xAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=all" }),
        __metadata("design:type", String)
    ], GetContainersJsonRequest.prototype, "all", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filters",
        }),
        __metadata("design:type", String)
    ], GetContainersJsonRequest.prototype, "filters", void 0);
...
var GetContainersJsonResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.Container }),
    ...
    ], GetContainersJsonResponse.prototype, "rawResponse", void 0);
