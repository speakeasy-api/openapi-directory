...
class ListDistributionsByWebACLId20200531Request:
    headers: ListDistributionsByWebACLId20200531Headers = dataclasses.field()
    path_params: ListDistributionsByWebACLId20200531PathParams = dataclasses.field()
    query_params: ListDistributionsByWebACLId20200531QueryParams = dataclasses.field()
