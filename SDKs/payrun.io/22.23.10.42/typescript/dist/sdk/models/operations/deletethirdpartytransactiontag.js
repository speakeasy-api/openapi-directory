...
exports.DeleteThirdPartyTransactionTagResponse = exports.DeleteThirdPartyTransactionTagRequest = void 0;
...
var DeleteThirdPartyTransactionTagRequest = /** @class */ (function (_super) {
    ...
    ], DeleteThirdPartyTransactionTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteThirdPartyTransactionTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteThirdPartyTransactionTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeleteThirdPartyTransactionTagRequest.prototype, "tagId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ThirdPartyTransactionId",
        }),
        __metadata("design:type", String)
    ], DeleteThirdPartyTransactionTagRequest.prototype, "thirdPartyTransactionId", void 0);
...
var DeleteThirdPartyTransactionTagResponse = /** @class */ (function (_super) {
    ...
    ], DeleteThirdPartyTransactionTagResponse.prototype, "rawResponse", void 0);
