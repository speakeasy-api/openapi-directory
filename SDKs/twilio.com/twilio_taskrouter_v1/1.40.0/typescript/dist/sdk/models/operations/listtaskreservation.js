...
exports.ListTaskReservationResponse = exports.ListTaskReservationListTaskReservationResponse = exports.ListTaskReservationListTaskReservationResponseMeta = exports.ListTaskReservationRequest = exports.ListTaskReservationSecurity = exports.ListTaskReservationServerList = void 0;
...
var ListTaskReservationSecurity = /** @class */ (function (_super) {
    ...
    ], ListTaskReservationSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListTaskReservationSecurity.prototype, "username", void 0);
...
var ListTaskReservationRequest = /** @class */ (function (_super) {
    ...
    ], ListTaskReservationRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListTaskReservationRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListTaskReservationRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ReservationStatus",
        }),
        __metadata("design:type", String)
    ], ListTaskReservationRequest.prototype, "reservationStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TaskSid",
        }),
        __metadata("design:type", String)
    ], ListTaskReservationRequest.prototype, "taskSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=WorkerSid",
        }),
        __metadata("design:type", String)
    ], ListTaskReservationRequest.prototype, "workerSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], ListTaskReservationRequest.prototype, "workspaceSid", void 0);
...
var ListTaskReservationListTaskReservationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListTaskReservationListTaskReservationResponseMeta; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.TaskrouterV1WorkspaceTaskTaskReservation; }),
...
var ListTaskReservationResponse = /** @class */ (function (_super) {
    ...
    ], ListTaskReservationResponse.prototype, "rawResponse", void 0);
