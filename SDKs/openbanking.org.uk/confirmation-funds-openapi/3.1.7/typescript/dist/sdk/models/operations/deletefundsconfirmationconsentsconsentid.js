...
exports.DeleteFundsConfirmationConsentsConsentIdResponse = exports.DeleteFundsConfirmationConsentsConsentIdRequest = exports.DeleteFundsConfirmationConsentsConsentIdSecurity = void 0;
...
exports.DeleteFundsConfirmationConsentsConsentIdSecurity = DeleteFundsConfirmationConsentsConsentIdSecurity;
var DeleteFundsConfirmationConsentsConsentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DeleteFundsConfirmationConsentsConsentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConsentId",
        }),
        __metadata("design:type", String)
    ], DeleteFundsConfirmationConsentsConsentIdRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], DeleteFundsConfirmationConsentsConsentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], DeleteFundsConfirmationConsentsConsentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], DeleteFundsConfirmationConsentsConsentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], DeleteFundsConfirmationConsentsConsentIdRequest.prototype, "xFapiInteractionId", void 0);
    return DeleteFundsConfirmationConsentsConsentIdRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteFundsConfirmationConsentsConsentIdRequest = DeleteFundsConfirmationConsentsConsentIdRequest;
var DeleteFundsConfirmationConsentsConsentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DeleteFundsConfirmationConsentsConsentIdResponse.prototype, "rawResponse", void 0);
    return DeleteFundsConfirmationConsentsConsentIdResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteFundsConfirmationConsentsConsentIdResponse = DeleteFundsConfirmationConsentsConsentIdResponse;
