...
class GkeonpremProjectsLocationsBareMetalAdminClustersListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GkeonpremProjectsLocationsBareMetalAdminClustersListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?GkeonpremProjectsLocationsBareMetalAdminClustersListViewEnum $view = null;
