...
exports.ListSipAuthCallsIpAccessControlListMappingResponse = exports.ListSipAuthCallsIpAccessControlListMappingListSipAuthCallsIpAccessControlListMappingResponse = exports.ListSipAuthCallsIpAccessControlListMappingRequest = exports.ListSipAuthCallsIpAccessControlListMappingSecurity = exports.ListSipAuthCallsIpAccessControlListMappingServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSipAuthCallsIpAccessControlListMappingServerList = [
...
var ListSipAuthCallsIpAccessControlListMappingSecurity = /** @class */ (function (_super) {
    ...
    ], ListSipAuthCallsIpAccessControlListMappingSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSipAuthCallsIpAccessControlListMappingSecurity.prototype, "username", void 0);
    return ListSipAuthCallsIpAccessControlListMappingSecurity;
}(utils_1.SpeakeasyBase));
exports.ListSipAuthCallsIpAccessControlListMappingSecurity = ListSipAuthCallsIpAccessControlListMappingSecurity;
var ListSipAuthCallsIpAccessControlListMappingRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSipAuthCallsIpAccessControlListMappingRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomainSid",
        }),
        __metadata("design:type", String)
    ], ListSipAuthCallsIpAccessControlListMappingRequest.prototype, "domainSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSipAuthCallsIpAccessControlListMappingRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSipAuthCallsIpAccessControlListMappingRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSipAuthCallsIpAccessControlListMappingRequest.prototype, "pageToken", void 0);
    return ListSipAuthCallsIpAccessControlListMappingRequest;
}(utils_1.SpeakeasyBase));
exports.ListSipAuthCallsIpAccessControlListMappingRequest = ListSipAuthCallsIpAccessControlListMappingRequest;
/**
 * OK
 */
var ListSipAuthCallsIpAccessControlListMappingListSipAuthCallsIpAccessControlListMappingResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping,
        }),
        (0, class_transformer_1.Expose)({ name: "contents" }),
        (0, class_transformer_1.Type)(function () {
            return shared.ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIpAccessControlListMapping;
        }),
...
exports.ListSipAuthCallsIpAccessControlListMappingListSipAuthCallsIpAccessControlListMappingResponse = ListSipAuthCallsIpAccessControlListMappingListSipAuthCallsIpAccessControlListMappingResponse;
var ListSipAuthCallsIpAccessControlListMappingResponse = /** @class */ (function (_super) {
    ...
    ], ListSipAuthCallsIpAccessControlListMappingResponse.prototype, "rawResponse", void 0);
    return ListSipAuthCallsIpAccessControlListMappingResponse;
}(utils_1.SpeakeasyBase));
exports.ListSipAuthCallsIpAccessControlListMappingResponse = ListSipAuthCallsIpAccessControlListMappingResponse;
