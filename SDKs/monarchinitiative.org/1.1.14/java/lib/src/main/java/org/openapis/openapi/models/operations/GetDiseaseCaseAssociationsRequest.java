...
public class GetDiseaseCaseAssociationsRequest {
    ...
    public GetDiseaseCaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseaseCaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetDiseaseCaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseaseCaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseaseCaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetDiseaseCaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetDiseaseCaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetDiseaseCaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDiseaseCaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetDiseaseCaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetDiseaseCaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseaseCaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetDiseaseCaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
