 ...
 */
export declare class RegistrationsViewOnlyLinksReadViewOnlyLinksAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegistrationsViewOnlyLinksReadViewOnlyLinksRelationships extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export declare class RegistrationsViewOnlyLinksReadViewOnlyLinks extends SpeakeasyBase {
    /**
     * The properties of the view only link entity.
     */
