...
export class CatalogObject extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: CatalogV1Id })
  @Expose({ name: "catalog_v1_ids" })
  @Type(() => CatalogV1Id)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "custom_attribute_definition_data" })
   ...
   * to store any sensitive information (personally identifiable information, card details, etc.).
   */
  @SpeakeasyMetadata({ elemType: CatalogCustomAttributeValue })
  @Expose({ name: "custom_attribute_values" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, CatalogCustomAttributeValue> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], CatalogCustomAttributeValue);
      }
      return obj;
    },
    { toClassOnly: true }
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "item_option_value_data" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "item_variation_data" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "measurement_unit_data" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "modifier_list_data" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "present_at_location_ids" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "quick_amounts_settings_data" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "subscription_plan_data" })
