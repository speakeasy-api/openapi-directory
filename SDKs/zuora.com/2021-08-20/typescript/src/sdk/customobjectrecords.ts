...
export class CustomObjectRecords {
  ...
  deleteCustomObjectRecordByID(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DeleteCustomObjectRecordByIDResponse =
        new operations.DeleteCustomObjectRecordByIDResponse({
  ...
  getAllRecordsForCustomObjectType(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETAllRecordsForCustomObjectTypeResponse =
        new operations.GETAllRecordsForCustomObjectTypeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.queryCustomObjectRecordsResponse = utils.objectToClass(
              httpRes?.data,
              shared.QueryCustomObjectRecordsResponse
            );
          }
          break;
      }
  ...
  getCustomObjectRecordByID(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETCustomObjectRecordByIDResponse =
        new operations.GETCustomObjectRecordByIDResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.customObjectRecordWithAllFields = utils.objectToClass(
              httpRes?.data,
              shared.CustomObjectRecordWithAllFields
            );
          }
          break;
  ...
  postCustomObjectRecords(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTCustomObjectRecordsResponse =
        new operations.POSTCustomObjectRecordsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.postCustomObjectRecordsResponse = utils.objectToClass(
              httpRes?.data,
              shared.PostCustomObjectRecordsResponse
            );
          }
          break;
        case httpRes?.status == 400:
          if (
            ...
            res.customObjectRecordsErrorResponse = utils.objectToClass(
              httpRes?.data,
              shared.CustomObjectRecordsErrorResponse
            );
          }
          break;
        case httpRes?.status == 401:
          if (
            ...
            res.errorResponse401Record = utils.objectToClass(
              httpRes?.data,
              shared.ErrorResponse401Record
            );
          }
          break;
        case httpRes?.status == 500:
          if (
            ...
            res.customObjectRecordsThrottledResponse = utils.objectToClass(
              httpRes?.data,
              shared.CustomObjectRecordsThrottledResponse
            );
          }
          break;
      }
  ...
  postCustomObjectRecordsBatchUpdateOrDelete(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.POSTCustomObjectRecordsBatchUpdateOrDeleteRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTCustomObjectRecordsBatchUpdateOrDeleteResponse =
        new operations.POSTCustomObjectRecordsBatchUpdateOrDeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
        ...
        case httpRes?.status == 200:
          if (
            ...
            res.customObjectRecordsBatchUpdatePartialSuccessResponse =
              utils.objectToClass(
                httpRes?.data,
                shared.CustomObjectRecordsBatchUpdatePartialSuccessResponse
              );
          }
          break;
        case httpRes?.status == 400:
  ...
  putCustomObjectRecord(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PUTCustomObjectRecordResponse =
        new operations.PUTCustomObjectRecordResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  patchPartialUpdateCustomObjectRecord(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PatchPartialUpdateCustomObjectRecordResponse =
        new operations.PatchPartialUpdateCustomObjectRecordResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
