...
class SQLInjectionMatchSetUpdate:
    ...
    sql_injection_match_tuple: shared_sqlinjectionmatchtuple.SQLInjectionMatchTuple = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SqlInjectionMatchTuple') }})
