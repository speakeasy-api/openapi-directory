...
export class CloudchannelAccountsReportsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsReportsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsReportsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
