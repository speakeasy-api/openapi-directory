...
class GetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetIncludeLicensedContentEnum $includeLicensedContent
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=includeLicensedContent')]
    public ?GetIncludeLicensedContentEnum $includeLicensedContent = null;
