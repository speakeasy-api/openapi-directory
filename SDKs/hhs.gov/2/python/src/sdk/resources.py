...
class Resources:
    ...
    def get_resources_json(self, request: operations.GetResourcesJSONRequest) -> operations.GetResourcesJSONResponse:
        ...
        query_params = utils.get_query_params(operations.GetResourcesJSONRequest, request)
        ...
        res = operations.GetResourcesJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
