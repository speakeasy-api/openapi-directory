...
export class TypeTypeFredCategory {
  ...
  searchTypeFredCategory(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_fred_category";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeFredCategoryResponse =
        new operations.SearchTypeFredCategoryResponse({
