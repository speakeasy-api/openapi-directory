...
export class BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    elemType:
      BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditionsCancellationFromTourDate,
  })
...
export class BookingMybookings200ApplicationJSONDataItemSummaries extends SpeakeasyBase {
  ...
  @Type(
    () =>
      BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions
  )
  ...
  @SpeakeasyMetadata({
    elemType:
      BookingMybookings200ApplicationJSONDataItemSummariesTravellerAgeBands,
  })
...
export class BookingMybookings200ApplicationJSONData extends SpeakeasyBase {
  ...
  @Type(() => BookingMybookings200ApplicationJSONDataItemSummaries)
...
export class BookingMybookings200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
  @Type(() => BookingMybookings200ApplicationJSONData)
