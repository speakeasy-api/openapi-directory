...
public class DeleteSigningBasketHeaders {
    /**
     * Is contained if and only if the "Signature" element is contained in the header of the request.
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Digest")
    public String digest;
    public DeleteSigningBasketHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public DeleteSigningBasketHeaders withPSUAccept(String psuAccept) {
    ...
    public DeleteSigningBasketHeaders withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public DeleteSigningBasketHeaders withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public DeleteSigningBasketHeaders withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public DeleteSigningBasketHeaders withPSUDeviceID(String psuDeviceID) {
    ...
    public DeleteSigningBasketHeaders withPSUGeoLocation(String psuGeoLocation) {
    ...
    public DeleteSigningBasketHeaders withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public DeleteSigningBasketHeaders withPSUIPAddress(String psuIPAddress) {
    ...
    public DeleteSigningBasketHeaders withPSUIPPort(String psuIPPort) {
    ...
    public DeleteSigningBasketHeaders withPSUUserAgent(String psuUserAgent) {
    ...
    public DeleteSigningBasketHeaders withSignature(String signature) {
    ...
    public DeleteSigningBasketHeaders withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public DeleteSigningBasketHeaders withXRequestID(String xRequestID) {
