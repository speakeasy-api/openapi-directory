...
class RemoveUserFromAccount500ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\RemoveUserFromAccount500ApplicationJSONMeta')]
    public RemoveUserFromAccount500ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\RemoveUserFromAccount500ApplicationJSONMeta();
	}
}
