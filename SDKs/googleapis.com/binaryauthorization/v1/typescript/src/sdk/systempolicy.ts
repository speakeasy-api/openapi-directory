...
export class Systempolicy {
  ...
  binaryauthorizationSystempolicyGetPolicy(
    ...
    security: operations.BinaryauthorizationSystempolicyGetPolicySecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.BinaryauthorizationSystempolicyGetPolicySecurity(
          security
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.BinaryauthorizationSystempolicyGetPolicyResponse =
        new operations.BinaryauthorizationSystempolicyGetPolicyResponse({
