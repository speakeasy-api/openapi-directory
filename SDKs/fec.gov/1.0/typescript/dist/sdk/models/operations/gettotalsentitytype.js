...
exports.GetTotalsEntityTypeResponse = exports.GetTotalsEntityTypeRequest = exports.GetTotalsEntityTypeQueryParams = exports.GetTotalsEntityTypeOrganizationTypeEnum = exports.GetTotalsEntityTypeFilingFrequencyEnum = exports.GetTotalsEntityTypePathParams = exports.GetTotalsEntityTypeEntityTypeEnum = void 0;
...
var GetTotalsEntityTypePathParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=entity_type" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypePathParams.prototype, "entityType", void 0);
    return GetTotalsEntityTypePathParams;
}(utils_1.SpeakeasyBase));
exports.GetTotalsEntityTypePathParams = GetTotalsEntityTypePathParams;
...
var GetTotalsEntityTypeQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=committee_designation" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=committee_state" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max_disbursements" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypeQueryParams.prototype, "maxDisbursements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max_last_cash_on_hand_end_period" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypeQueryParams.prototype, "maxLastCashOnHandEndPeriod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max_last_debts_owed_by_committee" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypeQueryParams.prototype, "maxLastDebtsOwedByCommittee", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=max_receipts" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypeQueryParams.prototype, "maxReceipts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=min_disbursements" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypeQueryParams.prototype, "minDisbursements", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=min_last_cash_on_hand_end_period" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypeQueryParams.prototype, "minLastCashOnHandEndPeriod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=min_last_debts_owed_by_committee" }),
        __metadata("design:type", String)
    ], GetTotalsEntityTypeQueryParams.prototype, "minLastDebtsOwedByCommittee", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=min_receipts" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sponsor_candidate_id" }),
        __metadata("design:type", Array)
    ], GetTotalsEntityTypeQueryParams.prototype, "sponsorCandidateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=treasurer_name" }),
        __metadata("design:type", Array)
    ], GetTotalsEntityTypeQueryParams.prototype, "treasurerName", void 0);
    return GetTotalsEntityTypeQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetTotalsEntityTypeQueryParams = GetTotalsEntityTypeQueryParams;
