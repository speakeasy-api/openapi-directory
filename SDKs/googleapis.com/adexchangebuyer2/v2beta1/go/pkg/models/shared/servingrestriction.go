...
func (e ServingRestrictionStatusEnum) ToPointer() *ServingRestrictionStatusEnum {
	return &e
}
...
func (e *ServingRestrictionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "DISAPPROVAL":
		fallthrough
	case "PENDING_REVIEW":
		*e = ServingRestrictionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ServingRestrictionStatusEnum: %v", v)
	}
}
