...
class BuildArtifacts:
    r"""Information about build output artifacts."""
    ...
    md5sum: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('md5sum'), 'exclude': lambda f: f is None }})  
    ...
    sha256sum: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sha256sum'), 'exclude': lambda f: f is None }})  
