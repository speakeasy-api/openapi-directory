...
export class SecuritycenterProjectsSourcesFindingsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsSourcesFindingsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsSourcesFindingsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
