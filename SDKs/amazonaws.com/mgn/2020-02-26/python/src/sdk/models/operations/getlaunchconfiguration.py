...
class GetLaunchConfigurationRequest:
    headers: GetLaunchConfigurationHeaders = dataclasses.field()
    request: GetLaunchConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
