...
export class SearchBioDicomTestQueryParams extends SpeakeasyBase {
...
export class SearchBioDicomTestRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: SearchBioDicomTestQueryParams;
}


export class SearchBioDicomTestResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
