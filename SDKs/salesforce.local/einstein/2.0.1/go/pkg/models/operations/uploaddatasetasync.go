...
func (e UploadDatasetAsyncRequestBodyTypeEnum) ToPointer() *UploadDatasetAsyncRequestBodyTypeEnum {
	return &e
}
...
func (e *UploadDatasetAsyncRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "text-intent":
		fallthrough
	case "text-sentiment":
		*e = UploadDatasetAsyncRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UploadDatasetAsyncRequestBodyTypeEnum: %v", v)
	}
}
