...
from ..shared import untagresourceresult as shared_untagresourceresult

class UntagResourceXAmzTargetEnum(str, Enum):
    LIGHTSAIL_20161128_UNTAG_RESOURCE = "Lightsail_20161128.UntagResource"
...
class UntagResourceResponse:
    ...
    untag_resource_result: Optional[shared_untagresourceresult.UntagResourceResult] = dataclasses.field(default=None)
