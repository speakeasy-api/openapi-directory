...
class NodeRemoveParameterNodeDeallocationOptionEnum(str, Enum):
    r"""Sets when compute nodes may be removed from the pool."""
    REQUEUE = 'requeue'
    TERMINATE = 'terminate'
...
class NodeRemoveParameter:
    ...
    r"""Sets a list containing the id of the compute nodes to be removed from the specified pool."""  
    ...
    r"""Sets the timeout for removal of compute nodes to the pool. The default value is 10 minutes."""  
