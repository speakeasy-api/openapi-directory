...
class ExportProjectResult:
    r"""Result structure used for requests to export project configuration details."""
    ...
    share_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shareUrl'), 'exclude': lambda f: f is None }})  
