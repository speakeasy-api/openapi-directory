...
class ComputeEngineTargetDefaults:
    ...
    boot_option: Optional[ComputeEngineTargetDefaultsBootOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bootOption'), 'exclude': lambda f: f is None }})
    r"""Output only. The VM Boot Option, as set in the source vm."""  
    ...
    disk_type: Optional[ComputeEngineTargetDefaultsDiskTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('diskType'), 'exclude': lambda f: f is None }})
    r"""The disk type to use in the VM."""  
    ...
    license_type: Optional[ComputeEngineTargetDefaultsLicenseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('licenseType'), 'exclude': lambda f: f is None }})
    r"""The license type to use in OS adaptation."""  
