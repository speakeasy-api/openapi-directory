...
class PostImagesIDActionsChangeProtectionRequestBody:
    ...
    r"""If true, prevents the snapshot from being deleted"""  
...
class PostImagesIDActionsChangeProtectionRequest:
    ...
    r"""ID of the Image"""  
    request_body: Optional[PostImagesIDActionsChangeProtectionRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostImagesIDActionsChangeProtectionActionResponseAction:
    ...
    error: PostImagesIDActionsChangeProtectionActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostImagesIDActionsChangeProtectionActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostImagesIDActionsChangeProtectionActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostImagesIDActionsChangeProtectionActionResponse:
    ...
    action: PostImagesIDActionsChangeProtectionActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
