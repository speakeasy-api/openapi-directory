...
enum InboundRealTimePaymentsTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetailsVisaPointOfServiceEntryModeEnum: string
{
    case MANUAL = 'manual';
