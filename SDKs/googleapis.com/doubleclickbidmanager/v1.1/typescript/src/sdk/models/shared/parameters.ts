...
export enum ParametersGroupBysEnum {
  ...
  FilterMediaType = "FILTER_MEDIA_TYPE",
  FilterAudioFeedTypeName = "FILTER_AUDIO_FEED_TYPE_NAME",
  FilterTrueviewTargetingExpansion = "FILTER_TRUEVIEW_TARGETING_EXPANSION",
  FilterPublisherTrafficSource = "FILTER_PUBLISHER_TRAFFIC_SOURCE",
}

export enum ParametersMetricsEnum {
  ...
  MetricTrueviewAllAdSequenceImpressions = "METRIC_TRUEVIEW_ALL_AD_SEQUENCE_IMPRESSIONS",
  MetricImpressionsCoviewed = "METRIC_IMPRESSIONS_COVIEWED",
  MetricUniqueReachImpressionReachCoviewed = "METRIC_UNIQUE_REACH_IMPRESSION_REACH_COVIEWED",
  MetricUniqueReachTotalReachCoviewed = "METRIC_UNIQUE_REACH_TOTAL_REACH_COVIEWED",
  MetricUniqueReachAverageImpressionFrequencyCoviewed = "METRIC_UNIQUE_REACH_AVERAGE_IMPRESSION_FREQUENCY_COVIEWED",
  MetricGrpCorrectedImpressionsCoviewed = "METRIC_GRP_CORRECTED_IMPRESSIONS_COVIEWED",
  MetricVirtualPeopleImpressionReachByDemoCoviewed = "METRIC_VIRTUAL_PEOPLE_IMPRESSION_REACH_BY_DEMO_COVIEWED",
  MetricVirtualPeopleAverageImpressionFrequencyByDemoCoviewed = "METRIC_VIRTUAL_PEOPLE_AVERAGE_IMPRESSION_FREQUENCY_BY_DEMO_COVIEWED",
  MetricTargetRatingPointsCoviewed = "METRIC_TARGET_RATING_POINTS_COVIEWED",
  MetricDemoCompositionImpressionCoviewed = "METRIC_DEMO_COMPOSITION_IMPRESSION_COVIEWED",
  MetricVirtualPeopleImpressionReachSharePercentCoviewed = "METRIC_VIRTUAL_PEOPLE_IMPRESSION_REACH_SHARE_PERCENT_COVIEWED",
  MetricVirtualPeopleImpressionReachPercentCoviewed = "METRIC_VIRTUAL_PEOPLE_IMPRESSION_REACH_PERCENT_COVIEWED",
}
