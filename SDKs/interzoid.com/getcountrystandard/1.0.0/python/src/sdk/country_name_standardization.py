...
class CountryNameStandardization:
    ...
    def getcountrystandard(self, request: operations.GetcountrystandardRequest) -> operations.GetcountrystandardResponse:
        ...
        query_params = utils.get_query_params(operations.GetcountrystandardRequest, request)
        ...
        res = operations.GetcountrystandardResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.Getcountrystandard200ApplicationJSON])
