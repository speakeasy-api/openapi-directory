...
class UpdateThingGroupRequestBody:
    thing_group_properties: UpdateThingGroupRequestBodyThingGroupProperties = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('thingGroupProperties') }})
...
class UpdateThingGroupRequest:
    headers: UpdateThingGroupHeaders = dataclasses.field()
    path_params: UpdateThingGroupPathParams = dataclasses.field()
    request: UpdateThingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
