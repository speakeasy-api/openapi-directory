...
class GoogleCloudVisionV1p2beta1BatchAnnotateFilesRequest:
    ...
    requests: Optional[list[shared_googlecloudvisionv1p2beta1annotatefilerequest.GoogleCloudVisionV1p2beta1AnnotateFileRequest]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requests'), 'exclude': lambda f: f is None }})
    r"""Required. The list of file annotation requests. Right now we support only one AnnotateFileRequest in BatchAnnotateFilesRequest."""  
