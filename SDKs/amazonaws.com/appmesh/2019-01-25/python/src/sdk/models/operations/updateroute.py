...
from ..shared import updaterouteoutput as shared_updaterouteoutput
...
class UpdateRouteRequestBody:
    spec: UpdateRouteRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('spec') }})
...
class UpdateRouteRequest:
    ...
    query_params: UpdateRouteQueryParams = dataclasses.field()
...
class UpdateRouteResponse:
    ...
    update_route_output: Optional[shared_updaterouteoutput.UpdateRouteOutput] = dataclasses.field(default=None)
