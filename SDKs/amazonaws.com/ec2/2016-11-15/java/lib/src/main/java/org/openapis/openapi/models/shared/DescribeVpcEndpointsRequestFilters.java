 ...
 */
public class DescribeVpcEndpointsRequestFilters {
    
    public String name;

    public DescribeVpcEndpointsRequestFilters withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DescribeVpcEndpointsRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeVpcEndpointsRequestFilters(){}
}
