...
exports.ConnectorResourcesOneResponse = exports.ConnectorResourcesOneRequest = exports.ConnectorResourcesOneSecurity = void 0;
...
exports.ConnectorResourcesOneSecurity = ConnectorResourcesOneSecurity;
var ConnectorResourcesOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ConnectorResourcesOneRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=resource_id",
        }),
        __metadata("design:type", String)
    ], ConnectorResourcesOneRequest.prototype, "resourceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=unified_api",
        }),
        __metadata("design:type", String)
    ], ConnectorResourcesOneRequest.prototype, "unifiedApi", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ConnectorResourcesOneRequest.prototype, "xApideckAppId", void 0);
    return ConnectorResourcesOneRequest;
}(utils_1.SpeakeasyBase));
exports.ConnectorResourcesOneRequest = ConnectorResourcesOneRequest;
var ConnectorResourcesOneResponse = /** @class */ (function (_super) {
    ...
    ], ConnectorResourcesOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ConnectorResourcesOneResponse = ConnectorResourcesOneResponse;
