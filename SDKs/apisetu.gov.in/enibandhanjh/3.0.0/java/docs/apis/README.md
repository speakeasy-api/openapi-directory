...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.RegriiRequestBody;
import org.openapis.openapi.models.operations.RegriiRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.RegriiRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.RegriiResponse;
import org.openapis.openapi.models.operations.RegriiSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            RegriiRequestBody req = new RegriiRequestBody(RegriiRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new RegriiRequestBodyCertificateParameters("Sunil Kumar", "1", "Barhi,Bokaro,Bundu,Chaibasa,Chakradharpur,Chandil,Chatra,Deoghar,Dhanbad,Dumka,Dumri,Garhwa,Ghatshil", "20XX");;
            ...
            RegriiResponse res = sdk.apIs.regrii(req, new RegriiSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            RmcerRequestBody req = new RmcerRequestBody(RmcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new RmcerRequestBodyCertificateParameters("Sunil Kumar", "1", "Barhi,Bokaro,Bundu,Chaibasa,Chakradharpur,Chandil,Chatra,Deoghar,Dhanbad,Dumka,Dumri,Garhwa,Ghatshil", "20XX");;
