...
class Projects 
{
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#add-project-collaborator
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ProjectsAddCollaboratorResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 204 or $httpResponse->getStatusCode() === 304) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->projectsAddCollaborator415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ProjectsAddCollaborator415ApplicationJSON', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#create-a-project-card
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#create-a-project-column
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#create-a-user-project
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ProjectsCreateForAuthenticatedUserResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 201) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->projectsCreateForAuthenticatedUser415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ProjectsCreateForAuthenticatedUser415ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 422) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#create-an-organization-project
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#create-a-repository-project
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#delete-a-project
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#delete-a-project-card
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#delete-a-project-column
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#get-a-project
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#get-a-project-card
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#get-a-project-column
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#get-project-permission-for-a-user
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ProjectsGetPermissionForUserResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->projectsGetPermissionForUser415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ProjectsGetPermissionForUser415ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 422) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#list-project-cards
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#list-project-collaborators
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ProjectsListCollaboratorsResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->projectsListCollaborators415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ProjectsListCollaborators415ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 422) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#list-project-columns
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#list-organization-projects
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#list-repository-projects
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#list-user-projects
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ProjectsListForUserResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->projectsListForUser415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ProjectsListForUser415ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 422) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#move-a-project-card
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#move-a-project-column
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#remove-project-collaborator
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ProjectsRemoveCollaboratorResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 204 or $httpResponse->getStatusCode() === 304) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->projectsRemoveCollaborator415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ProjectsRemoveCollaborator415ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 422) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#update-a-project
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#update-a-project-card
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.19/rest/reference/projects#update-a-project-column
     */
