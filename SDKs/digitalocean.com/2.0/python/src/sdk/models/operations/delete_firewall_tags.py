...
class DeleteFirewallTagsRequest:
    path_params: DeleteFirewallTagsPathParams = dataclasses.field()
...
class DeleteFirewallTagsResponse:
    ...
    delete_firewall_tags_401_application_json_object: Optional[DeleteFirewallTags401ApplicationJSON] = dataclasses.field(default=None)
