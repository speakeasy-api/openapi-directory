...
func (e GetNetworkWirelessClientLatencyStatsBandEnum) ToPointer() *GetNetworkWirelessClientLatencyStatsBandEnum {
	return &e
}
...
func (e *GetNetworkWirelessClientLatencyStatsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessClientLatencyStatsBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessClientLatencyStatsBandEnum: %v", v)
	}
}
