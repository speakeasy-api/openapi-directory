...
type AnalyticsadminPropertiesUserLinksBatchCreateRequest struct {
	...
	GoogleAnalyticsAdminV1alphaBatchCreateUserLinksRequestInput *shared.GoogleAnalyticsAdminV1alphaBatchCreateUserLinksRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
