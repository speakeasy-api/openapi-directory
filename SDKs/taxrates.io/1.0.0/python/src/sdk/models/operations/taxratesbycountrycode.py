...
class TaxRatesByCountryCodeQueryParams:
    ...
    product_codes_: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'product_codes[]', 'style': 'form', 'explode': True }})
...
class TaxRatesByCountryCode200ApplicationJSON:
    ...
    taxes: Optional[list[TaxRatesByCountryCode200ApplicationJSONTaxes]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('taxes') }})
...
class TaxRatesByCountryCodeRequest:
    query_params: TaxRatesByCountryCodeQueryParams = dataclasses.field()
