 ...
 */
export declare enum InstanceGroupManagerListWarningCodeEnum {
...
export declare class InstanceGroupManagerListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceGroupManagerListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceGroupManagerListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceGroupManagerListWarningData[];
    /**
 ...
 */
export declare class InstanceGroupManagerList extends SpeakeasyBase {
    /**
