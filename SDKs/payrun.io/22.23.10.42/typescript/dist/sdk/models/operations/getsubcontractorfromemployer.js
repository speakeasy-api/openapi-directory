...
exports.GetSubContractorFromEmployerResponse = exports.GetSubContractorFromEmployerRequest = void 0;
...
var GetSubContractorFromEmployerRequest = /** @class */ (function (_super) {
    ...
    ], GetSubContractorFromEmployerRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetSubContractorFromEmployerRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetSubContractorFromEmployerRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetSubContractorFromEmployerRequest.prototype, "subContractorId", void 0);
...
var GetSubContractorFromEmployerResponse = /** @class */ (function (_super) {
    ...
    ], GetSubContractorFromEmployerResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
