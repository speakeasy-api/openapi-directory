...
public class SkcerSecurity {
    ...
    public SkcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SkcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SkcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
