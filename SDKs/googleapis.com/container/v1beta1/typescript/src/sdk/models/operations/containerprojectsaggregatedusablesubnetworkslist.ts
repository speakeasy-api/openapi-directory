...
export class ContainerProjectsAggregatedUsableSubnetworksListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsAggregatedUsableSubnetworksListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsAggregatedUsableSubnetworksListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
