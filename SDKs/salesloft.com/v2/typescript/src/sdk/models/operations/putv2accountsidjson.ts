...
export class PutV2AccountsIdJsonRequestBody extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ data: "form, name=archived" })
  archived?: boolean;
...
export class PutV2AccountsIdJsonRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PutV2AccountsIdJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
