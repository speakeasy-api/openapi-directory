...
class BigqueryDatasetsInsertSecurity:
    ...
    option1: Optional[BigqueryDatasetsInsertSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[BigqueryDatasetsInsertSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class BigqueryDatasetsInsertRequest:
    ...
    r"""Project ID of the new dataset"""  
