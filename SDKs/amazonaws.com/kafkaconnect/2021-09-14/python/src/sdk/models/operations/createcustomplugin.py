...
class CreateCustomPluginRequestBody:
    ...
    content_type: CreateCustomPluginRequestBodyContentTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contentType') }})
    r"""The type of the plugin file."""  
    location: CreateCustomPluginRequestBodyLocation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('location') }})
    r"""Information about the location of a custom plugin."""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""The name of the custom plugin."""  
...
class CreateCustomPluginRequest:
    ...
    request_body: CreateCustomPluginRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
