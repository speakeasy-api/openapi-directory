...
class ModifyReservedInstancesRequestTargetConfigurationsInstanceTypeEnum(str, Enum):
...
class ModifyReservedInstancesRequestTargetConfigurationsScopeEnum(str, Enum):
...
class ModifyReservedInstancesRequestTargetConfigurations:
    r"""Describes the configuration settings for the modified Reserved Instances."""
    
    availability_zone: Optional[str] = dataclasses.field(default=None)  
    instance_count: Optional[int] = dataclasses.field(default=None)  
    instance_type: Optional[ModifyReservedInstancesRequestTargetConfigurationsInstanceTypeEnum] = dataclasses.field(default=None)  
    platform: Optional[str] = dataclasses.field(default=None)  
    scope: Optional[ModifyReservedInstancesRequestTargetConfigurationsScopeEnum] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class ModifyReservedInstancesRequest:
    r"""Contains the parameters for ModifyReservedInstances."""
    
    reserved_instances_ids: list[str] = dataclasses.field()  
    target_configurations: list[ModifyReservedInstancesRequestTargetConfigurations] = dataclasses.field()  
