...
export declare class PricesAndFixedPrices {
     ...
     * ```
     */
    createUpdatePriceOrFixedPrice(req: operations.CreateUpdatePriceOrFixedPriceRequest, config?: AxiosRequestConfig): Promise<operations.CreateUpdatePriceOrFixedPriceResponse>;
    /**
     * Delete Price
     *
     * @remarks
     ...
     */
    deletePrice(req: operations.DeletePriceRequest, config?: AxiosRequestConfig): Promise<operations.DeletePriceResponse>;
    /**
     ...
     */
    deletefixedpricesonapricetableortradepolicy(req: operations.DeletefixedpricesonapricetableortradepolicyRequest, config?: AxiosRequestConfig): Promise<operations.DeletefixedpricesonapricetableortradepolicyResponse>;
    /**
     ...
     * ```
     */
    getComputedPricebypricetable(req: operations.GetComputedPricebypricetableRequest, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.GetComputedPricebypricetableResponse>;
    /**
     * Get Fixed Prices
     *
     * @remarks
     ...
     * ```
     */
    getFixedPrices(req: operations.GetFixedPricesRequest, config?: AxiosRequestConfig): Promise<operations.GetFixedPricesResponse>;
    /**
     ...
     * ```
     */
    getFixedPricesonapricetable(req: operations.GetFixedPricesonapricetableRequest, config?: AxiosRequestConfig): Promise<operations.GetFixedPricesonapricetableResponse>;
    /**
     * Get Price
     *
     * @remarks
     ...
     * ```
     */
    getPrice(req: operations.GetPriceRequest, config?: AxiosRequestConfig): Promise<operations.GetPriceResponse>;
    /**
     ...
     * ```
     */
    createorupdatefixedpricesonpricetableortradepolicy(req: operations.CreateorupdatefixedpricesonpricetableortradepolicyRequest, config?: AxiosRequestConfig): Promise<operations.CreateorupdatefixedpricesonpricetableortradepolicyResponse>;
}
