...
class DeregisterEcsClusterRequest:
    ...
    deregister_ecs_cluster_request: shared_deregisterecsclusterrequest.DeregisterEcsClusterRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
