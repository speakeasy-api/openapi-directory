 ...
 */
export enum PostAccountGuestsGuestIdTypePermissionsPatchFormTypeEnum {
  Datapoint = "datapoint",
  Group = "group",
}

export class PostAccountGuestsGuestIdTypePermissionsPatchFormRequest extends SpeakeasyBase {
  /**
...
export class PostAccountGuestsGuestIdTypePermissionsPatchFormResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
