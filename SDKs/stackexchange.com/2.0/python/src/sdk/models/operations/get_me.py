...
class GetMeOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeSortEnum(str, Enum):
...
class GetMeQueryParams:
    ...
    order: Optional[GetMeOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetMeRequest:
    query_params: GetMeQueryParams = dataclasses.field()
