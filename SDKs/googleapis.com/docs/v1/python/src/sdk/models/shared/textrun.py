...
class TextRun:
    ...
    r"""The text of this run. Any non-text elements in the run are replaced with the Unicode character U+E907."""  
    ...
    r"""The suggested insertion IDs. A TextRun may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion."""  
    ...
    r"""The suggested text style changes to this run, keyed by suggestion ID."""  
