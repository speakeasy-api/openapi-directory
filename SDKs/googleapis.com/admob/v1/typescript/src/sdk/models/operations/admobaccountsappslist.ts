...
export class AdmobAccountsAppsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdmobAccountsAppsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdmobAccountsAppsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
