 ...
 */
export declare enum AutoscalerListWarningCodeEnum {
...
export declare class AutoscalerListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class AutoscalerListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class AutoscalerList extends SpeakeasyBase {
    /**
