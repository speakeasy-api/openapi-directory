...
class UrlMaps 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsResponse
     */
	public function computeUrlMapsTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/urlMaps/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeUrlMapsTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
