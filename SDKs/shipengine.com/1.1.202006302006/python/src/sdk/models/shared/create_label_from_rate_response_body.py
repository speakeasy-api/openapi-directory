...
class CreateLabelFromRateResponseBodyOptionalLink:
    r"""CreateLabelFromRateResponseBodyOptionalLink
...
class CreateLabelFromRateResponseBodyMonetaryValue:
    r"""CreateLabelFromRateResponseBodyMonetaryValue
...
class CreateLabelFromRateResponseBodyLabelDownload:
    r"""CreateLabelFromRateResponseBodyLabelDownload
...
class CreateLabelFromRateResponseBodyOutput:
    r"""CreateLabelFromRateResponseBodyOutput
    ...
    form_download: Optional[CreateLabelFromRateResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('form_download') }})
    insurance_claim: Optional[CreateLabelFromRateResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_claim') }})
    insurance_cost: Optional[CreateLabelFromRateResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_cost') }})
    ...
    label_download: Optional[CreateLabelFromRateResponseBodyLabelDownload] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_download') }})
    ...
    shipment_cost: Optional[CreateLabelFromRateResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('shipment_cost') }})
