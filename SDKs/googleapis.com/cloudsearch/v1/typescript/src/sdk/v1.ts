...
export class V1 {
  ...
  cloudsearchInitializeCustomer(
    ...
    security: operations.CloudsearchInitializeCustomerSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CloudsearchInitializeCustomerResponse =
        new operations.CloudsearchInitializeCustomerResponse({
