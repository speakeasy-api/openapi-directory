...
class GetDomesticScheduledPaymentsDomesticScheduledPaymentIDPaymentDetailsRequest:
    headers: GetDomesticScheduledPaymentsDomesticScheduledPaymentIDPaymentDetailsHeaders = dataclasses.field()
    path_params: GetDomesticScheduledPaymentsDomesticScheduledPaymentIDPaymentDetailsPathParams = dataclasses.field()
    security: GetDomesticScheduledPaymentsDomesticScheduledPaymentIDPaymentDetailsSecurity = dataclasses.field()
