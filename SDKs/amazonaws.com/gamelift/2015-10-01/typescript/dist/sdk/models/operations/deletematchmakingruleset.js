...
exports.DeleteMatchmakingRuleSetResponse = exports.DeleteMatchmakingRuleSetRequest = exports.DeleteMatchmakingRuleSetXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var DeleteMatchmakingRuleSetXAmzTargetEnum;
...
})(DeleteMatchmakingRuleSetXAmzTargetEnum = exports.DeleteMatchmakingRuleSetXAmzTargetEnum || (exports.DeleteMatchmakingRuleSetXAmzTargetEnum = {}));
var DeleteMatchmakingRuleSetRequest = /** @class */ (function (_super) {
    ...
    ], DeleteMatchmakingRuleSetRequest.prototype, "deleteMatchmakingRuleSetInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], DeleteMatchmakingRuleSetRequest.prototype, "xAmzTarget", void 0);
    return DeleteMatchmakingRuleSetRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteMatchmakingRuleSetRequest = DeleteMatchmakingRuleSetRequest;
var DeleteMatchmakingRuleSetResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DeleteMatchmakingRuleSetResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.DeleteMatchmakingRuleSetResponse = DeleteMatchmakingRuleSetResponse;
