...
class AdsenseCustomchannelsGetSecurity:
    ...
    option1: Optional[AdsenseCustomchannelsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[AdsenseCustomchannelsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
