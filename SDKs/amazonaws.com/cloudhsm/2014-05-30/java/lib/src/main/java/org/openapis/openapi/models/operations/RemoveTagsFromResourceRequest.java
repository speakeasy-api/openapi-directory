...
public class RemoveTagsFromResourceRequest {
    ...
    public RemoveTagsFromResourceRequest(@JsonProperty("RemoveTagsFromResourceRequest") org.openapis.openapi.models.shared.RemoveTagsFromResourceRequest removeTagsFromResourceRequest, @JsonProperty("X-Amz-Target") RemoveTagsFromResourceXAmzTargetEnum xAmzTarget) {
        this.removeTagsFromResourceRequest = removeTagsFromResourceRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
