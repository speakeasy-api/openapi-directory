...
func (e BloggerCommentsListByBlogStatusEnum) ToPointer() *BloggerCommentsListByBlogStatusEnum {
	return &e
}
...
func (e *BloggerCommentsListByBlogStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "PENDING":
		fallthrough
	case "SPAM":
		*e = BloggerCommentsListByBlogStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BloggerCommentsListByBlogStatusEnum: %v", v)
	}
}
