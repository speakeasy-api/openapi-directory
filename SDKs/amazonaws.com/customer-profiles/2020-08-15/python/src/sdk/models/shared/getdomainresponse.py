...
class GetDomainResponse:
    ...
    stats: Optional[shared_domainstats.DomainStats] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Stats'), 'exclude': lambda f: f is None }})  
