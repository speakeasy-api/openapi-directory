...
class QueryFailoverClusterRequest
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\QueryFailoverClusterOperatingSystemTypeEnum $operatingSystemType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=operating_system_type')]
    public ?QueryFailoverClusterOperatingSystemTypeEnum $operatingSystemType = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\QueryFailoverClusterSLAAssignmentEnum $slaAssignment
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sla_assignment')]
    public ?QueryFailoverClusterSLAAssignmentEnum $slaAssignment = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\QueryFailoverClusterSortByEnum $sortBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort_by')]
    public ?QueryFailoverClusterSortByEnum $sortBy = null;
    
    /**
     * Sort order, either ascending or descending.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\QueryFailoverClusterSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort_order')]
    public ?QueryFailoverClusterSortOrderEnum $sortOrder = null;
