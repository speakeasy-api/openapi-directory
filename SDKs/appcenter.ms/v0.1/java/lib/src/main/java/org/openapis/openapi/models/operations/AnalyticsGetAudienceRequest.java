...
public class AnalyticsGetAudienceRequest {
    ...
    public AnalyticsGetAudienceRequest(@JsonProperty("app_name") String appName, @JsonProperty("audience_name") String audienceName, @JsonProperty("owner_name") String ownerName) {
        this.appName = appName;
        this.audienceName = audienceName;
        this.ownerName = ownerName;
  }
