...
export class ListMarketplaceInstalledAddOnListMarketplaceInstalledAddOnResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.PreviewMarketplaceInstalledAddOn })
  @Expose({ name: "installed_add_ons" })
  @Type(() => shared.PreviewMarketplaceInstalledAddOn)
  installedAddOns?: shared.PreviewMarketplaceInstalledAddOn[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(
    () => ListMarketplaceInstalledAddOnListMarketplaceInstalledAddOnResponseMeta
  )
