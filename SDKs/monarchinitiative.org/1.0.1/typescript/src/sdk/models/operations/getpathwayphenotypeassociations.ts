...
export class GetPathwayPhenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPathwayPhenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPathwayPhenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPathwayPhenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
