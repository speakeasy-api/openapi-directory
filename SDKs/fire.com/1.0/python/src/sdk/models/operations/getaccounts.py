...
class GetAccountsAccountsAccountCurrency:
    ...
    code: Optional[GetAccountsAccountsAccountCurrencyCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})
    r"""The three letter code for the currency - either `EUR` or `GBP`."""  
...
class GetAccountsAccountsAccount:
    ...
    r"""Internal Use"""  
    currency: Optional[GetAccountsAccountsAccountCurrency] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('currency'), 'exclude': lambda f: f is None }})
    r"""The currency."""  
    ...
    status: Optional[GetAccountsAccountsAccountStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""Live accounts can be used as normal. Migrated accounts were used before Brexit and are read-only."""  
...
class GetAccountsAccounts:
    ...
    accounts: Optional[list[GetAccountsAccountsAccount]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accounts'), 'exclude': lambda f: f is None }})  
