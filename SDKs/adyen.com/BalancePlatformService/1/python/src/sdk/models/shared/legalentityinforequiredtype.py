...
class LegalEntityInfoRequiredTypeTypeEnum(str, Enum):
...
class LegalEntityInfoRequiredTypeInput:
    ...
    type: LegalEntityInfoRequiredTypeTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of legal entity.
