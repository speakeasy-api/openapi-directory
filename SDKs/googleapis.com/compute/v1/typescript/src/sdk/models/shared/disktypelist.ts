 ...
 */
export enum DiskTypeListWarningCodeEnum {
...
export class DiskTypeListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class DiskTypeListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: DiskTypeListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: DiskTypeListWarningData })
  @Expose({ name: "data" })
  @Type(() => DiskTypeListWarningData)
  data?: DiskTypeListWarningData[];
 ...
 */
export class DiskTypeList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: DiskType })
  @Expose({ name: "items" })
  @Type(() => DiskType)
  items?: DiskType[];
