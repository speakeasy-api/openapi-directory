...
exports.ClusterApi = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ClusterApi = /** @class */ (function () {
    function ClusterApi(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    ClusterApi.prototype.asyncClusteringProblem = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AsyncClusteringProblemRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/cluster/calculate";
     ...
     *
    **/
    ClusterApi.prototype.getClusterSolution = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetClusterSolutionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/cluster/solution/{jobId}", req.pathParams);
        var client = this._securityClient;
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.clusterResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 404:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getClusterSolution404ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 500:
                    break;
     ...
     *
    **/
    ClusterApi.prototype.solveClusteringProblem = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
