  ...
  **/
  rdcer(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.RdcerResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  regrii(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.RegriiResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            break;
          case httpRes?.status == 400:
