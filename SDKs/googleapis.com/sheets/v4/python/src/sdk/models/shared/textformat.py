...
class TextFormat:
    ...
    r"""The font family."""  
    font_size: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fontSize'), 'exclude': lambda f: f is None }})
    r"""The size of the font."""  
    foreground_color: Optional[shared_color.Color] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('foregroundColor'), 'exclude': lambda f: f is None }})
    ...
    foreground_color_style: Optional[shared_colorstyle.ColorStyle] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('foregroundColorStyle'), 'exclude': lambda f: f is None }})
    r"""A color value."""  
    ...
    r"""True if the text is italicized."""  
    ...
    r"""An external or local reference."""  
    ...
    r"""True if the text has a strikethrough."""  
    ...
    r"""True if the text is underlined."""  
