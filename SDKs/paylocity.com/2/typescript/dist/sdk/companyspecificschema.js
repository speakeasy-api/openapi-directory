...
var CompanySpecificSchema = /** @class */ (function () {
     ...
     */
    CompanySpecificSchema.prototype.getCompanySpecificOpenAPIDocumentation = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCompanySpecificOpenAPIDocumentationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/companies/{companyId}/openapi", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetCompanySpecificOpenAPIDocumentationSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetCompanySpecificOpenAPIDocumentationResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case [200, 403, 429].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
                    break;
