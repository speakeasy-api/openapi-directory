...
export class RunNamespacesJobsRunSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesJobsRunRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesJobsRunResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
