...
from ..shared import nodereimageparameter as shared_nodereimageparameter
...
class ComputeNodeReimageRequest:
    ...
    r"""The id of the compute node that you want to restart."""  
    ...
    node_reimage_parameter: Optional[shared_nodereimageparameter.NodeReimageParameter] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
