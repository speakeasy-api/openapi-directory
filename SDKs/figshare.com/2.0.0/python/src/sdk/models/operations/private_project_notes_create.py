...
class PrivateProjectNotesCreatePathParams:
...
class PrivateProjectNotesCreateRequest:
    path_params: PrivateProjectNotesCreatePathParams = dataclasses.field()
    request: shared_projectnotecreate.ProjectNoteCreate = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PrivateProjectNotesCreateSecurity = dataclasses.field()
