...
export class CreateSubscriptionForEvergreenTerms extends SpeakeasyBase {
  ...
  @Type(() => CreateSubscriptionForEvergreenTermsInitialTerm)
...
export class CreateSubscriptionForEvergreen extends SpeakeasyBase {
  ...
  @Type(() => CreateSubscriptionForEvergreenNewSubscriptionOwnerAccount)
   ...
   *
   */
  @SpeakeasyMetadata({ elemType: RatePlanOverrideForEvergreen })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "terms" })
  @Type(() => CreateSubscriptionForEvergreenTerms)
