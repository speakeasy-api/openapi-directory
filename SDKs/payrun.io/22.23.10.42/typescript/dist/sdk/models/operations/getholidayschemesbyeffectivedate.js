...
exports.GetHolidaySchemesByEffectiveDateResponse = exports.GetHolidaySchemesByEffectiveDateRequest = void 0;
...
var GetHolidaySchemesByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemesByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemesByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetHolidaySchemesByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemesByEffectiveDateRequest.prototype, "employerId", void 0);
    return GetHolidaySchemesByEffectiveDateRequest;
}(utils_1.SpeakeasyBase));
exports.GetHolidaySchemesByEffectiveDateRequest = GetHolidaySchemesByEffectiveDateRequest;
var GetHolidaySchemesByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemesByEffectiveDateResponse.prototype, "rawResponse", void 0);
    return GetHolidaySchemesByEffectiveDateResponse;
}(utils_1.SpeakeasyBase));
exports.GetHolidaySchemesByEffectiveDateResponse = GetHolidaySchemesByEffectiveDateResponse;
