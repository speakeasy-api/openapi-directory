...
func (e CreateOrganizationNetworkRequestBodyProductTypesEnum) ToPointer() *CreateOrganizationNetworkRequestBodyProductTypesEnum {
	return &e
}
...
func (e *CreateOrganizationNetworkRequestBodyProductTypesEnum) UnmarshalJSON(data []byte) error {
	...
	case "systemsManager":
		fallthrough
	case "wireless":
		*e = CreateOrganizationNetworkRequestBodyProductTypesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganizationNetworkRequestBodyProductTypesEnum: %v", v)
	}
}
