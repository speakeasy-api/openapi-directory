...
from ..shared import importapiresponse as shared_importapiresponse
...
class ImportAPIRequest:
    headers: ImportAPIHeaders = dataclasses.field()
    query_params: ImportAPIQueryParams = dataclasses.field()
    request: ImportAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ImportAPIResponse:
    ...
    import_api_response: Optional[shared_importapiresponse.ImportAPIResponse] = dataclasses.field(default=None)
