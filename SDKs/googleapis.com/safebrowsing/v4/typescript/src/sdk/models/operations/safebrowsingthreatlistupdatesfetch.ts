...
export class SafebrowsingThreatListUpdatesFetchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SafebrowsingThreatListUpdatesFetchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
