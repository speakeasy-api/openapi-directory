...
class ObjectPUTInvoicePaymentRequest:
    ...
    r"""Object id"""  
    proxy_modify_invoice_payment: shared_proxymodifyinvoicepayment.ProxyModifyInvoicePayment = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
