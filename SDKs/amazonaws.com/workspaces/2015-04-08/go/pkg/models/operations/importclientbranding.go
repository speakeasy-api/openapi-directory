...
type ImportClientBrandingHeaders struct {
...
type ImportClientBrandingRequest struct {
	Headers ImportClientBrandingHeaders
	Request shared.ImportClientBrandingRequest `request:"mediaType=application/json"`
}
