...
class ListUnderstandSampleListUnderstandSampleResponse:
    ...
    meta: Optional[ListUnderstandSampleListUnderstandSampleResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    samples: Optional[list[shared_preview_understand_assistant_task_sample.PreviewUnderstandAssistantTaskSample]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('samples'), 'exclude': lambda f: f is None }})  
...
class ListUnderstandSampleResponse:
    ...
    list_understand_sample_response: Optional[ListUnderstandSampleListUnderstandSampleResponse] = dataclasses.field(default=None)
    r"""OK"""  
