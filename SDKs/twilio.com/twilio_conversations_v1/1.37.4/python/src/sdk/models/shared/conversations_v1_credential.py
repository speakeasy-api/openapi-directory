...
class ConversationsV1Credential:
    ...
    type: Optional[shared_credential_enum_push_type_enum.CredentialEnumPushTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
