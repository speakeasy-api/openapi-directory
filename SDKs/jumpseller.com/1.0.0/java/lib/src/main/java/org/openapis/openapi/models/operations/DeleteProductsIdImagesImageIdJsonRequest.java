...
public class DeleteProductsIdImagesImageIdJsonRequest {
    ...
    public DeleteProductsIdImagesImageIdJsonRequest(@JsonProperty("authtoken") String authtoken, @JsonProperty("id") Integer id, @JsonProperty("image_id") Integer imageId, @JsonProperty("login") String login) {
        this.authtoken = authtoken;
        this.id = id;
        this.imageId = imageId;
        this.login = login;
