...
var BeezUPCommonLinkParameter3 = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: beezupcommonlinkparameterproperty3_1.BeezUPCommonLinkParameterProperty3 }),
        (0, class_transformer_1.Expose)({ name: "properties" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], beezupcommonlinkparameterproperty3_1.BeezUPCommonLinkParameterProperty3);
            }
            return obj;
        }, { toClassOnly: true }),
