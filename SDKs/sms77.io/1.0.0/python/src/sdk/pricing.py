...
class Pricing:
    ...
    def pricing(self, request: operations.PricingRequest) -> operations.PricingResponse:
        ...
        query_params = utils.get_query_params(operations.PricingRequest, request)
        ...
        res = operations.PricingResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
