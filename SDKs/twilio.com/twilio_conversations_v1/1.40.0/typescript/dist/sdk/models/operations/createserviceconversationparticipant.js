...
exports.CreateServiceConversationParticipantResponse = exports.CreateServiceConversationParticipantRequest = exports.CreateServiceConversationParticipantCreateServiceConversationParticipantRequest = exports.CreateServiceConversationParticipantSecurity = exports.CreateServiceConversationParticipantServerList = void 0;
...
var CreateServiceConversationParticipantSecurity = /** @class */ (function (_super) {
    ...
    ], CreateServiceConversationParticipantSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], CreateServiceConversationParticipantSecurity.prototype, "username", void 0);
...
var CreateServiceConversationParticipantRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateServiceConversationParticipantRequest.prototype, "chatServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConversationSid",
        }),
        __metadata("design:type", String)
    ], CreateServiceConversationParticipantRequest.prototype, "conversationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", CreateServiceConversationParticipantCreateServiceConversationParticipantRequest)
    ], CreateServiceConversationParticipantRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Twilio-Webhook-Enabled",
        }),
        __metadata("design:type", String)
    ], CreateServiceConversationParticipantRequest.prototype, "xTwilioWebhookEnabled", void 0);
...
var CreateServiceConversationParticipantResponse = /** @class */ (function (_super) {
    ...
    ], CreateServiceConversationParticipantResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
