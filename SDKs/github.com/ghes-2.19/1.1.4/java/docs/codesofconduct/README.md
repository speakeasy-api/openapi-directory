...
<https://docs.github.com/enterprise-server@2.19/rest/reference/codes-of-conduct#get-all-codes-of-conduct>
...
API method documentation
<https://docs.github.com/enterprise-server@2.19/rest/reference/codes-of-conduct#get-a-code-of-conduct>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CodesOfConductGetConductCodeRequest req = new CodesOfConductGetConductCodeRequest("laborum");            
