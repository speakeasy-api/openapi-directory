...
public class Auth {
     ...
     */
    public org.openapis.openapi.models.operations.GetAuthResponse getAuth(org.openapis.openapi.models.operations.GetAuthRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.AuthResult out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.AuthResult.class);
                res.authResult = out;
            }
        }
