...
class AutomaticScaling:
    ...
    custom_metrics: Optional[list[shared_custommetric.CustomMetric]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customMetrics'), 'exclude': lambda f: f is None }})
    r"""Target scaling by user-provided metrics. Only applicable in the App Engine flexible environment."""  
