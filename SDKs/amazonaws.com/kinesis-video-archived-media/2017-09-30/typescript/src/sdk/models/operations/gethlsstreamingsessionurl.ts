...
export class GetHLSStreamingSessionURLRequestBody extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "HLSFragmentSelector" })
  @Type(() => GetHLSStreamingSessionURLRequestBodyHLSFragmentSelector)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "MaxMediaPlaylistFragmentResults" })
