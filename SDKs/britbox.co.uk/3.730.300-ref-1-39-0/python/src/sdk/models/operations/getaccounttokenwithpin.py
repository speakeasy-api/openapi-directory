...
from ..shared import itvpinauthrequest as shared_itvpinauthrequest
...
class GetAccountTokenWithPinRequest:
    ...
    itv_pin_auth_request: shared_itvpinauthrequest.ItvPinAuthRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
