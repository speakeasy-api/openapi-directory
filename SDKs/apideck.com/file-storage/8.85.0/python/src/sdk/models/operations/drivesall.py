...
from ..shared import drivesfilter as shared_drivesfilter
from ..shared import security as shared_security
from ..shared import badrequestresponse as shared_badrequestresponse
from ..shared import getdrivesresponse as shared_getdrivesresponse
...
class DrivesAllQueryParams:
    cursor: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'cursor', 'style': 'form', 'explode': True }})
    filter: Optional[shared_drivesfilter.DrivesFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
...
class DrivesAllRequest:
    headers: DrivesAllHeaders = dataclasses.field()
    query_params: DrivesAllQueryParams = dataclasses.field()
    security: DrivesAllSecurity = dataclasses.field()
...
class DrivesAllResponse:
    ...
    get_drives_response: Optional[shared_getdrivesresponse.GetDrivesResponse] = dataclasses.field(default=None)
