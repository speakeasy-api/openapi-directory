 ...
 */
public enum WebinarUpdateApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarUpdateApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
