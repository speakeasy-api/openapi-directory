...
public class GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateRequest {
    ...
    public GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateRequest(@JsonProperty("checkDate") String checkDate, @JsonProperty("companyId") String companyId, @JsonProperty("employeeId") String employeeId, @JsonProperty("year") String year) {
        this.checkDate = checkDate;
        this.companyId = companyId;
        this.employeeId = employeeId;
        this.year = year;
