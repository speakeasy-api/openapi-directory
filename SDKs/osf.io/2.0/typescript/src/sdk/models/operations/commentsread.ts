 ...
 */
export class CommentsReadCommentAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class CommentsReadCommentLinks extends SpeakeasyBase {
  /**
 ...
 */
export class CommentsReadCommentRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class CommentsReadComment extends SpeakeasyBase {
  /**
   * The properties of the comment entity.
   */
  @SpeakeasyMetadata()
