...
class OBWriteInternationalScheduled3DataInitiationExchangeRateInformation:
    ...
    rate_type: OBWriteInternationalScheduled3DataInitiationExchangeRateInformationRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RateType') }})
    r"""Specifies the type used to complete the currency exchange."""  
...
class OBWriteInternationalScheduled3DataInitiation:
    ...
    creditor_account: OBWriteInternationalScheduled3DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Unambiguous identification of the account of the creditor to which a credit entry will be posted as a result of the payment transaction."""  
    ...
    instructed_amount: OBWriteInternationalScheduled3DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructedAmount') }})
    r"""Amount of money to be moved between the debtor and creditor, before deduction of charges, expressed in the currency as ordered by the initiating party.
    Usage: This amount has to be transported unchanged through the transaction chain.
    """  
    ...
    creditor: Optional[OBWriteInternationalScheduled3DataInitiationCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Creditor'), 'exclude': lambda f: f is None }})
    r"""Party to which an amount of money is due."""  
    creditor_agent: Optional[OBWriteInternationalScheduled3DataInitiationCreditorAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAgent'), 'exclude': lambda f: f is None }})
    r"""Financial institution servicing an account for the creditor."""  
    debtor_account: Optional[OBWriteInternationalScheduled3DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction."""  
    ...
    """  
    exchange_rate_information: Optional[OBWriteInternationalScheduled3DataInitiationExchangeRateInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExchangeRateInformation'), 'exclude': lambda f: f is None }})
    r"""Provides details on the currency exchange rate and contract."""  
    ...
    instruction_priority: Optional[OBWriteInternationalScheduled3DataInitiationInstructionPriorityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructionPriority'), 'exclude': lambda f: f is None }})
    r"""Indicator of the urgency or order of importance that the instructing party would like the instructed party to apply to the processing of the instruction."""  
    ...
    """  
    remittance_information: Optional[OBWriteInternationalScheduled3DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RemittanceInformation'), 'exclude': lambda f: f is None }})
    r"""Information supplied to enable the matching of an entry with the items that the transfer is intended to settle, such as commercial invoices in an accounts' receivable system."""  
...
class OBWriteInternationalScheduled3Data:
    ...
    initiation: OBWriteInternationalScheduled3DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for a single scheduled international payment."""  
...
class OBWriteInternationalScheduled3:
    ...
    data: OBWriteInternationalScheduled3Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
