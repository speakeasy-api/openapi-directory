...
exports.PaymentResponseV4 = exports.PaymentResponseV4StatusEnum = exports.PaymentResponseV4FundingStatusEnum = void 0;
...
var PaymentResponseV4FundingStatusEnum;
...
})(PaymentResponseV4FundingStatusEnum = exports.PaymentResponseV4FundingStatusEnum || (exports.PaymentResponseV4FundingStatusEnum = {}));
var PaymentResponseV4StatusEnum;
...
})(PaymentResponseV4StatusEnum = exports.PaymentResponseV4StatusEnum || (exports.PaymentResponseV4StatusEnum = {}));
var PaymentResponseV4 = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=events", elemType: paymenteventresponse_1.PaymentEventResponse }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=isPaymentCcyBaseCcy" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=paymentTrackingReference" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=payout" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=remoteSystemPaymentId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=withdrawnReason" }),
        __metadata("design:type", String)
