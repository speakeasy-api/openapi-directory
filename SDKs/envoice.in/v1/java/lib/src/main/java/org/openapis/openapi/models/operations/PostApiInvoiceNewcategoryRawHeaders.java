...
public class PostApiInvoiceNewcategoryRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceNewcategoryRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceNewcategoryRawHeaders withXAuthSecret(String xAuthSecret) {
