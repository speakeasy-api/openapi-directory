...
func main() {
    ...
    res, err := s.SDK.BatchExecuteStatement(ctx, operations.BatchExecuteStatementRequest{
        BatchExecuteStatementInput: shared.BatchExecuteStatementInput{
            ...
            ClusterIdentifier: sdk.String("minus"),
            Database: "placeat",
            DbUser: sdk.String("voluptatum"),
            SecretArn: sdk.String("iusto"),
            Sqls: []string{
                "nisi",
                "recusandae",
                "temporibus",
            },
            StatementName: sdk.String("ab"),
            WithEvent: sdk.Bool(false),
            WorkgroupName: sdk.String("quis"),
        },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.CancelStatement(ctx, operations.CancelStatementRequest{
        ...
        XAmzTarget: operations.CancelStatementXAmzTargetEnumRedshiftDataCancelStatement,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.CancelStatementResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.DescribeStatement(ctx, operations.DescribeStatementRequest{
        ...
        XAmzTarget: operations.DescribeStatementXAmzTargetEnumRedshiftDataDescribeStatement,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.DescribeStatementResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.DescribeTable(ctx, operations.DescribeTableRequest{
        DescribeTableRequest: shared.DescribeTableRequest{
            ClusterIdentifier: sdk.String("occaecati"),
            ConnectedDatabase: sdk.String("numquam"),
            Database: "commodi",
            DbUser: sdk.String("quam"),
            MaxResults: sdk.Int64(474697),
            NextToken: sdk.String("velit"),
            Schema: sdk.String("error"),
            SecretArn: sdk.String("quia"),
            Table: sdk.String("quis"),
            WorkgroupName: sdk.String("vitae"),
        },
        ...
        XAmzTarget: operations.DescribeTableXAmzTargetEnumRedshiftDataDescribeTable,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.ExecuteStatement(ctx, operations.ExecuteStatementRequest{
        ExecuteStatementInput: shared.ExecuteStatementInput{
            ...
            SecretArn: sdk.String("commodi"),
            SQL: "repudiandae",
            StatementName: sdk.String("quae"),
            WithEvent: sdk.Bool(false),
            WorkgroupName: sdk.String("ipsum"),
        },
        ...
        XAmzTarget: operations.ExecuteStatementXAmzTargetEnumRedshiftDataExecuteStatement,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GetStatementResult(ctx, operations.GetStatementResultRequest{
        ...
        XAmzTarget: operations.GetStatementResultXAmzTargetEnumRedshiftDataGetStatementResult,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.GetStatementResultResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.ListDatabases(ctx, operations.ListDatabasesRequest{
        ListDatabasesRequest: shared.ListDatabasesRequest{
            ClusterIdentifier: sdk.String("necessitatibus"),
            Database: "sint",
            DbUser: sdk.String("officia"),
            MaxResults: sdk.Int64(223081),
            NextToken: sdk.String("debitis"),
            SecretArn: sdk.String("a"),
            WorkgroupName: sdk.String("dolorum"),
        },
        ...
        XAmzTarget: operations.ListDatabasesXAmzTargetEnumRedshiftDataListDatabases,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.ListSchemas(ctx, operations.ListSchemasRequest{
        ListSchemasRequest: shared.ListSchemasRequest{
            ClusterIdentifier: sdk.String("ea"),
            ConnectedDatabase: sdk.String("aliquid"),
            Database: "laborum",
            DbUser: sdk.String("accusamus"),
            MaxResults: sdk.Int64(249796),
            NextToken: sdk.String("occaecati"),
            SchemaPattern: sdk.String("enim"),
            SecretArn: sdk.String("accusamus"),
            WorkgroupName: sdk.String("delectus"),
        },
        ...
        XAmzTarget: operations.ListSchemasXAmzTargetEnumRedshiftDataListSchemas,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.ListStatements(ctx, operations.ListStatementsRequest{
        ListStatementsRequest: shared.ListStatementsRequest{
            MaxResults: sdk.Int64(394869),
            NextToken: sdk.String("vel"),
            RoleLevel: sdk.Bool(false),
            StatementName: sdk.String("natus"),
            Status: shared.StatusStringEnumAborted.ToPointer(),
        },
        ...
        XAmzTarget: operations.ListStatementsXAmzTargetEnumRedshiftDataListStatements,
    })
    if err != nil {
        log.Fatal(err)
    }

    if res.ListStatementsResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.SDK.ListTables(ctx, operations.ListTablesRequest{
        ListTablesRequest: shared.ListTablesRequest{
            ClusterIdentifier: sdk.String("natus"),
            ConnectedDatabase: sdk.String("nobis"),
            Database: "eum",
            DbUser: sdk.String("vero"),
            MaxResults: sdk.Int64(135474),
            NextToken: sdk.String("architecto"),
            SchemaPattern: sdk.String("magnam"),
            SecretArn: sdk.String("et"),
            TablePattern: sdk.String("excepturi"),
            WorkgroupName: sdk.String("ullam"),
        },
        ...
        XAmzTarget: operations.ListTablesXAmzTargetEnumRedshiftDataListTables,
    })
    if err != nil {
        log.Fatal(err)
    }
