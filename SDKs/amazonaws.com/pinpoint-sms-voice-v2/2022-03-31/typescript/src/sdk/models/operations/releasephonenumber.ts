...
export enum ReleasePhoneNumberXAmzTargetEnum {
  PinpointSMSVoiceV2ReleasePhoneNumber = "PinpointSMSVoiceV2.ReleasePhoneNumber",
}

export class ReleasePhoneNumberRequest extends SpeakeasyBase {
...
export class ReleasePhoneNumberResponse extends SpeakeasyBase {
  /**
