...
func (e PremiumNewsByDateFormatEnum) ToPointer() *PremiumNewsByDateFormatEnum {
	return &e
}
...
func (e *PremiumNewsByDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "xml":
		fallthrough
	case "json":
		*e = PremiumNewsByDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PremiumNewsByDateFormatEnum: %v", v)
	}
}
