...
public class DfareportingAccountUserProfilesListQueryParams {
    ...
    public DfareportingAccountUserProfilesListQueryParams withDollarXgafv(openapisdk.models.shared.XgafvEnum dollarXgafv) {
    ...
    public DfareportingAccountUserProfilesListQueryParams withAlt(openapisdk.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
