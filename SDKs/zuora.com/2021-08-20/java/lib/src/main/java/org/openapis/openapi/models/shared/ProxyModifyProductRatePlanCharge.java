...
public class ProxyModifyProductRatePlanCharge {
    ...
    public ProxyModifyProductRatePlanCharge withAccountingCode(String accountingCode) {
    ...
    public ProxyModifyProductRatePlanCharge withApplyDiscountTo(String applyDiscountTo) {
    ...
    public ProxyModifyProductRatePlanCharge withBillCycleDay(Integer billCycleDay) {
    ...
    public ProxyModifyProductRatePlanCharge withBillCycleType(String billCycleType) {
    ...
    public ProxyModifyProductRatePlanCharge withBillingPeriod(String billingPeriod) {
    ...
    public ProxyModifyProductRatePlanCharge withBillingPeriodAlignment(String billingPeriodAlignment) {
    ...
    public ProxyModifyProductRatePlanCharge withBillingTiming(String billingTiming) {
    ...
    public ProxyModifyProductRatePlanCharge withChargeModel(String chargeModel) {
    ...
    public ProxyModifyProductRatePlanCharge withChargeModelConfiguration(ProxyCreateOrModifyProductRatePlanChargeChargeModelConfiguration chargeModelConfiguration) {
    ...
    public ProxyModifyProductRatePlanCharge withClassNS(String classNS) {
    ...
    public ProxyModifyProductRatePlanCharge withDefaultQuantity(Double defaultQuantity) {
    ...
    public ProxyModifyProductRatePlanCharge withDeferredRevAccountNS(String deferredRevAccountNS) {
    ...
    public ProxyModifyProductRatePlanCharge withDeferredRevenueAccount(String deferredRevenueAccount) {
    ...
    public ProxyModifyProductRatePlanCharge withDepartmentNS(String departmentNS) {
    ...
    public ProxyModifyProductRatePlanCharge withDescription(String description) {
    ...
    public ProxyModifyProductRatePlanCharge withDiscountLevel(String discountLevel) {
    ...
    public ProxyModifyProductRatePlanCharge withEndDateCondition(String endDateCondition) {
    ...
    public ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum includeChildrenNS;
    public ProxyModifyProductRatePlanCharge withIncludeChildrenNS(ProxyModifyProductRatePlanChargeIncludeChildrenNSEnum includeChildrenNS) {
    ...
    public ProxyModifyProductRatePlanCharge withIncludedUnits(Double includedUnits) {
    ...
    public ProxyModifyProductRatePlanCharge withIntegrationIdNS(String integrationIdNS) {
    ...
    public ProxyModifyProductRatePlanCharge withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public ProxyModifyProductRatePlanChargeItemTypeNSEnum itemTypeNS;
    public ProxyModifyProductRatePlanCharge withItemTypeNS(ProxyModifyProductRatePlanChargeItemTypeNSEnum itemTypeNS) {
    ...
    public ProxyModifyProductRatePlanCharge withLegacyRevenueReporting(Boolean legacyRevenueReporting) {
    ...
    public ProxyModifyProductRatePlanCharge withListPriceBase(String listPriceBase) {
    ...
    public ProxyModifyProductRatePlanCharge withLocationNS(String locationNS) {
    ...
    public ProxyModifyProductRatePlanCharge withMaxQuantity(Double maxQuantity) {
    ...
    public ProxyModifyProductRatePlanCharge withMinQuantity(Double minQuantity) {
    ...
    @JsonProperty("Name")
    public String name;
    public ProxyModifyProductRatePlanCharge withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ProxyModifyProductRatePlanCharge withNumberOfPeriod(Long numberOfPeriod) {
    ...
    public ProxyModifyProductRatePlanCharge withOverageCalculationOption(String overageCalculationOption) {
    ...
    public ProxyModifyProductRatePlanCharge withOverageUnusedUnitsCreditOption(String overageUnusedUnitsCreditOption) {
    ...
    public ProxyModifyProductRatePlanCharge withPriceChangeOption(String priceChangeOption) {
    ...
    public ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum priceIncreaseOption;
    public ProxyModifyProductRatePlanCharge withPriceIncreaseOption(ProxyModifyProductRatePlanChargePriceIncreaseOptionEnum priceIncreaseOption) {
    ...
    public ProxyModifyProductRatePlanCharge withPriceIncreasePercentage(Double priceIncreasePercentage) {
    ...
    public ProxyModifyProductRatePlanCharge withProductRatePlanChargeTierData(ProxyCreateOrModifyProductRatePlanChargeTierData productRatePlanChargeTierData) {
    ...
    public ProxyModifyProductRatePlanCharge withProductRatePlanId(String productRatePlanId) {
    ...
    public ProxyModifyProductRatePlanCharge withRatingGroup(String ratingGroup) {
    ...
    public ProxyModifyProductRatePlanCharge withRecognizedRevAccountNS(String recognizedRevAccountNS) {
    ...
    public ProxyModifyProductRatePlanCharge withRecognizedRevenueAccount(String recognizedRevenueAccount) {
    ...
    public ProxyModifyProductRatePlanCharge withRevRecCode(String revRecCode) {
    ...
    public ProxyModifyProductRatePlanChargeRevRecEndNSEnum revRecEndNS;
    public ProxyModifyProductRatePlanCharge withRevRecEndNS(ProxyModifyProductRatePlanChargeRevRecEndNSEnum revRecEndNS) {
    ...
    public ProxyModifyProductRatePlanChargeRevRecStartNSEnum revRecStartNS;
    public ProxyModifyProductRatePlanCharge withRevRecStartNS(ProxyModifyProductRatePlanChargeRevRecStartNSEnum revRecStartNS) {
    ...
    public ProxyModifyProductRatePlanCharge withRevRecTemplateTypeNS(String revRecTemplateTypeNS) {
    ...
    public ProxyModifyProductRatePlanCharge withRevRecTriggerCondition(String revRecTriggerCondition) {
    ...
    public ProxyModifyProductRatePlanCharge withRevenueRecognitionRuleName(String revenueRecognitionRuleName) {
    ...
    public ProxyModifyProductRatePlanCharge withSmoothingModel(String smoothingModel) {
    ...
    public ProxyModifyProductRatePlanCharge withSpecificBillingPeriod(Long specificBillingPeriod) {
    ...
    public ProxyModifyProductRatePlanCharge withSubsidiaryNS(String subsidiaryNS) {
    ...
    public ProxyModifyProductRatePlanCharge withSyncDateNS(String syncDateNS) {
    ...
    public ProxyModifyProductRatePlanCharge withTaxCode(String taxCode) {
    ...
    public ProxyModifyProductRatePlanCharge withTaxMode(String taxMode) {
    ...
    public ProxyModifyProductRatePlanCharge withTaxable(Boolean taxable) {
    ...
    public ProxyModifyProductRatePlanCharge withTriggerEvent(String triggerEvent) {
    ...
    @JsonProperty("UOM")
    public String uom;
    public ProxyModifyProductRatePlanCharge withUom(String uom) {
        this.uom = uom;
        return this;
    }
    ...
    public ProxyModifyProductRatePlanCharge withUpToPeriods(Long upToPeriods) {
    ...
    public ProxyModifyProductRatePlanCharge withUpToPeriodsType(String upToPeriodsType) {
    ...
    public ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum usageRecordRatingOption;
    public ProxyModifyProductRatePlanCharge withUsageRecordRatingOption(ProxyModifyProductRatePlanChargeUsageRecordRatingOptionEnum usageRecordRatingOption) {
    ...
    public ProxyModifyProductRatePlanCharge withUseDiscountSpecificAccountingCode(Boolean useDiscountSpecificAccountingCode) {
    ...
    public ProxyModifyProductRatePlanCharge withUseTenantDefaultForPriceChange(Boolean useTenantDefaultForPriceChange) {
    ...
    public ProxyModifyProductRatePlanCharge withWeeklyBillCycleDay(String weeklyBillCycleDay) {
