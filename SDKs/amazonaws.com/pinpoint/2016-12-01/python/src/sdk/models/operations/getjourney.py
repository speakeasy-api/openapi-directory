...
from ..shared import getjourneyresponse as shared_getjourneyresponse
...
class GetJourneyRequest:
    headers: GetJourneyHeaders = dataclasses.field()
...
class GetJourneyResponse:
    ...
    get_journey_response: Optional[shared_getjourneyresponse.GetJourneyResponse] = dataclasses.field(default=None)
