...
public class GetNhFossilsAllRequest {
    ...
    public GetNhFossilsAllRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsAllRequest withXApiKey(String xApiKey) {
    ...
    public GetNhFossilsAllRequest withThumbsize(Long thumbsize) {
        this.thumbsize = thumbsize;
        return this;
    }
    
    public GetNhFossilsAllRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
  }
}
