...
class CreateRouteTableRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateRouteTableRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateRouteTableRequestTagSpecifications:
    ...
    resource_type: Optional[CreateRouteTableRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateRouteTableRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateRouteTableRequest:
    ...
    tag_specifications: Optional[list[CreateRouteTableRequestTagSpecifications]] = dataclasses.field(default=None)  
