...
public class CreateReturnLabelRequest {
    ...
    public CreateReturnLabelRequest(@JsonProperty("create_return_label_request_body") org.openapis.openapi.models.shared.CreateReturnLabelRequestBody createReturnLabelRequestBody, @JsonProperty("label_id") String labelId) {
        this.createReturnLabelRequestBody = createReturnLabelRequestBody;
        this.labelId = labelId;
  }
}
