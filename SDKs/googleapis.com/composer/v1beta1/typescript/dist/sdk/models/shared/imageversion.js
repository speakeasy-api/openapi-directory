...
var ImageVersion = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "creationDisabled" }),
        __metadata("design:type", Boolean)
    ], ImageVersion.prototype, "creationDisabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "imageVersionId" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "supportedPythonVersions" }),
        __metadata("design:type", Array)
    ], ImageVersion.prototype, "supportedPythonVersions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "upgradeDisabled" }),
        __metadata("design:type", Boolean)
