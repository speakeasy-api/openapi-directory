...
try {
    ...
    $request->certificateParameters->coursename = 'DEDH P,GI S,GI W,MESC,LCOM EW,LCOM Tac,CHME Q,AA/APP,SSR/NAM,Direct Entry El,ITSC S';
    $request->certificateParameters->personalno = '12345-T';
    $request->certificateParameters->unit = 'Valsura,Shivaji,Dronacharya,SignalSchool,NIAT';
