...
class GetCreateSpotDatafeedSubscriptionQueryParams:
    action: GetCreateSpotDatafeedSubscriptionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    bucket: str = dataclasses.field(metadata={'query_param': { 'field_name': 'Bucket', 'style': 'form', 'explode': True }})
    version: GetCreateSpotDatafeedSubscriptionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCreateSpotDatafeedSubscriptionRequest:
    headers: GetCreateSpotDatafeedSubscriptionHeaders = dataclasses.field()
    query_params: GetCreateSpotDatafeedSubscriptionQueryParams = dataclasses.field()
