 ...
 */
export declare class CreateDistribution20180618RequestBodyDistributionConfig extends SpeakeasyBase {
...
export declare class CreateDistribution20180618RequestBody extends SpeakeasyBase {
    /**
     * A distribution configuration.
     */
    distributionConfig: CreateDistribution20180618RequestBodyDistributionConfig;
}
export declare class CreateDistribution20180618Request extends SpeakeasyBase {
...
export declare class CreateDistribution20180618Response extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
