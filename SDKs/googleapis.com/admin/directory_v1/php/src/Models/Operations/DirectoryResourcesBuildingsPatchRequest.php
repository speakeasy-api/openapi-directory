...
class DirectoryResourcesBuildingsPatchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryResourcesBuildingsPatchCoordinatesSourceEnum $coordinatesSource
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=coordinatesSource')]
    public ?DirectoryResourcesBuildingsPatchCoordinatesSourceEnum $coordinatesSource = null;
