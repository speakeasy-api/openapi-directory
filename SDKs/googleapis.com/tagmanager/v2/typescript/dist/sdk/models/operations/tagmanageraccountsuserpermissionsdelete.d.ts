...
export declare class TagmanagerAccountsUserPermissionsDeleteSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare enum TagmanagerAccountsUserPermissionsDeleteTypeEnum {
...
export declare class TagmanagerAccountsUserPermissionsDeleteRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class TagmanagerAccountsUserPermissionsDeleteResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
