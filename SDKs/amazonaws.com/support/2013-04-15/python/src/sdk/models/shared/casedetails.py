...
class CaseDetails:
    ...
    recent_communications: Optional[shared_recentcasecommunications.RecentCaseCommunications] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recentCommunications') }})
