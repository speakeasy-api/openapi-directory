...
public class GetAccountsAccountIdStatementsHeaders {
    /**
     * The unique id of the sandbox to be used
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=sandbox-id")
    public String sandboxId;
    public GetAccountsAccountIdStatementsHeaders withSandboxId(String sandboxId) {
    ...
    public GetAccountsAccountIdStatementsHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountsAccountIdStatementsHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountsAccountIdStatementsHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public GetAccountsAccountIdStatementsHeaders withXFapiInteractionId(String xFapiInteractionId) {
