...
class GetSpacesSpaceIDProvidersRequest:
...
class GetSpacesSpaceIDProvidersResponse:
    ...
    get_spaces_space_id_providers_200_application_json_all_ofs: Optional[list[shared_provider.Provider]] = dataclasses.field(default=None)
