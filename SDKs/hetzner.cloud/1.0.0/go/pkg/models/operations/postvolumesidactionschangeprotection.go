...
func (e PostVolumesIDActionsChangeProtectionActionResponseActionStatusEnum) ToPointer() *PostVolumesIDActionsChangeProtectionActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostVolumesIDActionsChangeProtectionActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostVolumesIDActionsChangeProtectionActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostVolumesIDActionsChangeProtectionActionResponseActionStatusEnum: %v", v)
	}
}
