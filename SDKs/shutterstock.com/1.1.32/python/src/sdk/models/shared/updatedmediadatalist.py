...
from ..shared import updatedmedia as shared_updatedmedia
...
class UpdatedMediaDataList:
    r"""List of updated media"""
    
    data: Optional[list[shared_updatedmedia.UpdatedMedia]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""Updated media items"""  
