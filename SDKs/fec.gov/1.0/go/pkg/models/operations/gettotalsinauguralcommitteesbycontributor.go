...
type GetTotalsInauguralCommitteesByContributorRequest struct {
...
type GetTotalsInauguralCommitteesByContributorResponse struct {
	ContentType            string
	InauguralDonationsPage *shared.InauguralDonationsPage
	StatusCode             int
