...
export class DatalineageProjectsLocationsProcessesRunsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesRunsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesRunsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
