...
type CreateAccessControlConfigurationHeaders struct {
...
type CreateAccessControlConfigurationRequest struct {
	Headers CreateAccessControlConfigurationHeaders
	Request shared.CreateAccessControlConfigurationRequest `request:"mediaType=application/json"`
}
