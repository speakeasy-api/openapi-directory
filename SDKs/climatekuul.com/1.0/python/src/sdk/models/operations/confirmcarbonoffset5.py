...
CONFIRM_CARBON_OFFSET5_SERVERS = [
	"http://api.climatekuul.com:8000/footprint",
]


@dataclasses.dataclass
class ConfirmCarbonOffset5RequestBody:
...
@dataclasses.dataclass
class ConfirmCarbonOffset5Request:
    request: Optional[ConfirmCarbonOffset5RequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
    server_url: Optional[str] = dataclasses.field(default=None)
    

@dataclasses.dataclass
class ConfirmCarbonOffset5Response:
