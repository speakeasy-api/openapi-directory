...
exports.GetCommentaryFromEmployeeResponse = exports.GetCommentaryFromEmployeeRequest = void 0;
...
var GetCommentaryFromEmployeeRequest = /** @class */ (function (_super) {
    ...
    ], GetCommentaryFromEmployeeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCommentaryFromEmployeeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CommentaryId",
        }),
        __metadata("design:type", String)
    ], GetCommentaryFromEmployeeRequest.prototype, "commentaryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetCommentaryFromEmployeeRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCommentaryFromEmployeeRequest.prototype, "employerId", void 0);
    return GetCommentaryFromEmployeeRequest;
}(utils_1.SpeakeasyBase));
exports.GetCommentaryFromEmployeeRequest = GetCommentaryFromEmployeeRequest;
var GetCommentaryFromEmployeeResponse = /** @class */ (function (_super) {
    ...
    ], GetCommentaryFromEmployeeResponse.prototype, "rawResponse", void 0);
    return GetCommentaryFromEmployeeResponse;
}(utils_1.SpeakeasyBase));
exports.GetCommentaryFromEmployeeResponse = GetCommentaryFromEmployeeResponse;
