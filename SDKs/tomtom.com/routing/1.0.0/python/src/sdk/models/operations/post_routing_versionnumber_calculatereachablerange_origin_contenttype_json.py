...
class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJSONVehicleEngineTypeEnum(str, Enum):
...
class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJSONRequest:
    ...
    vehicle_engine_type: Optional[PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJSONVehicleEngineTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'vehicleEngineType', 'style': 'form', 'explode': True }})
    r"""Engine type of the vehicle."""  
