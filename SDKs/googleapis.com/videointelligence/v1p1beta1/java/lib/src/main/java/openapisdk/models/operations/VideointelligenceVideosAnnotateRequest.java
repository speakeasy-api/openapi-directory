...
public class VideointelligenceVideosAnnotateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest request;
    public VideointelligenceVideosAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest request) {
