...
class CreateExplainabilityExportRequest:
    ...
    explainability_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExplainabilityArn') }})  
    explainability_export_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExplainabilityExportName') }})  
