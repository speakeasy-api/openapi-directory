...
from ..shared import exporttasks3locationrequest as shared_exporttasks3locationrequest
from enum import Enum
from typing import Optional

class ExportImageRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class ExportImageRequestTagSpecifications:
    ...
    resource_type: Optional[ExportImageRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[ExportImageRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class ExportImageRequest:
    
    disk_image_format: shared_diskimageformat_enum.DiskImageFormatEnum = dataclasses.field()  
    image_id: str = dataclasses.field()  
    s3_export_location: shared_exporttasks3locationrequest.ExportTaskS3LocationRequest = dataclasses.field()  
    ...
    tag_specifications: Optional[list[ExportImageRequestTagSpecifications]] = dataclasses.field(default=None)  
