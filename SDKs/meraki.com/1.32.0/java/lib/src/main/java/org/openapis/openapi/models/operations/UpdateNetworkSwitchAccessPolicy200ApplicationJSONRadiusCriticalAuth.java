 ...
 */
public class UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth {
    /**
    ...
    public UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth withDataVlanId(Long dataVlanId) {
    ...
    public UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth withSuspendPortBounce(Boolean suspendPortBounce) {
    ...
    public UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth withVoiceVlanId(Long voiceVlanId) {
        this.voiceVlanId = voiceVlanId;
        return this;
    }
    
    public UpdateNetworkSwitchAccessPolicy200ApplicationJSONRadiusCriticalAuth(){}
}
