...
import { PacketMirroringsScopedList } from "./packetmirroringsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum PacketMirroringAggregatedListWarningCodeEnum {
...
export declare class PacketMirroringAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class PacketMirroringAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: PacketMirroringAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: PacketMirroringAggregatedListWarningData[];
    /**
 ...
 */
export declare class PacketMirroringAggregatedList extends SpeakeasyBase {
    /**
