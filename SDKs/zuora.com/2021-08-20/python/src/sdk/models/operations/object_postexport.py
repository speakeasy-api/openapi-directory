...
from ..shared import proxycreateexport as shared_proxycreateexport
...
class ObjectPostExportQueryParams:
...
class ObjectPostExportRequest:
    headers: ObjectPostExportHeaders = dataclasses.field()
    query_params: ObjectPostExportQueryParams = dataclasses.field()
    request: shared_proxycreateexport.ProxyCreateExport = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPostExportResponse:
