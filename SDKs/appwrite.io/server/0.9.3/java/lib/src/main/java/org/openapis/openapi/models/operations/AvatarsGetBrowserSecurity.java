...
public class AvatarsGetBrowserSecurity {
    ...
    public AvatarsGetBrowserSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public AvatarsGetBrowserSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public AvatarsGetBrowserSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public AvatarsGetBrowserSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
