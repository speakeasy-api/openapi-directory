...
class EnterpriseAdminSetSelfHostedRunnersInGroupForEnterpriseRequest:
    path_params: EnterpriseAdminSetSelfHostedRunnersInGroupForEnterprisePathParams = dataclasses.field()
    request: Optional[EnterpriseAdminSetSelfHostedRunnersInGroupForEnterpriseRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
