...
var UsersFollows = /** @class */ (function () {
    ...
    **/
    UsersFollows.prototype.checkIfUserIsFollowing = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/users/{user_id}/following/{follow_user_id}", req.pathParams);
    ...
    **/
    UsersFollows.prototype.checkIfUserIsFollowingAlt1 = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/me/following/{follow_user_id}", req.pathParams);
        var client = this._securityClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    UsersFollows.prototype.followUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    UsersFollows.prototype.followUserAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    UsersFollows.prototype.followUsers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FollowUsersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{user_id}/following", req.pathParams);
    ...
    **/
    UsersFollows.prototype.followUsersAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    UsersFollows.prototype.unfollowUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    UsersFollows.prototype.unfollowUserAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
