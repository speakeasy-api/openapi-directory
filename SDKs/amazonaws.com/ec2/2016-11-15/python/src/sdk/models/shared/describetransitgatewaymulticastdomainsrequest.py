...
class DescribeTransitGatewayMulticastDomainsRequestFilters:
...
class DescribeTransitGatewayMulticastDomainsRequest:
    ...
    filters: Optional[list[DescribeTransitGatewayMulticastDomainsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    transit_gateway_multicast_domain_ids: Optional[list[str]] = dataclasses.field(default=None)  
