...
export class CloudfunctionsProjectsLocationsRuntimesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudfunctionsProjectsLocationsRuntimesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudfunctionsProjectsLocationsRuntimesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
