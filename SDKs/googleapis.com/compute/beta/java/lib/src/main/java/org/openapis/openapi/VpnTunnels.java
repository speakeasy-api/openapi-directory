...
public class VpnTunnels {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeVpnTunnelsTestIamPermissionsResponse computeVpnTunnelsTestIamPermissions(org.openapis.openapi.models.operations.ComputeVpnTunnelsTestIamPermissionsRequest request, org.openapis.openapi.models.operations.ComputeVpnTunnelsTestIamPermissionsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeVpnTunnelsTestIamPermissionsRequest.class, baseUrl, "/projects/{project}/regions/{region}/vpnTunnels/{resource}/testIamPermissions", request, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeVpnTunnelsTestIamPermissionsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
