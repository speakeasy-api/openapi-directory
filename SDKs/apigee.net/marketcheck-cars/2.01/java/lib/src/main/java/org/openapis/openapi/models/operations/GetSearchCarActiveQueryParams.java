...
public class GetSearchCarActiveQueryParams {
    /**
    ...
    public GetSearchCarActiveQueryParams withActiveInventoryDateRange(String activeInventoryDateRange) {
    ...
    public GetSearchCarActiveQueryParams withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withAppendApiKey(Boolean appendApiKey) {
    ...
    public GetSearchCarActiveQueryParams withBaseExteriorColor(String baseExteriorColor) {
    ...
    public GetSearchCarActiveQueryParams withBaseInteriorColor(String baseInteriorColor) {
    ...
    public GetSearchCarActiveQueryParams withBodySubtype(String bodySubtype) {
    ...
    public GetSearchCarActiveQueryParams withBodyType(String bodyType) {
    ...
    public GetSearchCarActiveQueryParams withCarType(org.openapis.openapi.models.shared.CarCarTypeEnum carType) {
    ...
    public GetSearchCarActiveQueryParams withCarfax1Owner(org.openapis.openapi.models.shared.Carfax1OwnerEnum carfax1Owner) {
    ...
    public GetSearchCarActiveQueryParams withCarfaxCleanTitle(org.openapis.openapi.models.shared.CarfaxCleanTitleEnum carfaxCleanTitle) {
    ...
    public String city;
    public GetSearchCarActiveQueryParams withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withCityMpgRange(String cityMpgRange) {
    ...
    public GetSearchCarActiveQueryParams withCountry(org.openapis.openapi.models.shared.CarCountryEnum country) {
    ...
    public GetSearchCarActiveQueryParams withCylinders(String cylinders) {
    ...
    public GetSearchCarActiveQueryParams withDealerId(String dealerId) {
    ...
    public GetSearchCarActiveQueryParams withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetSearchCarActiveQueryParams withDedup(Boolean dedup) {
        this.dedup = dedup;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withDom180Range(String dom180Range) {
    ...
    public GetSearchCarActiveQueryParams withDomActiveRange(String domActiveRange) {
    ...
    public GetSearchCarActiveQueryParams withDomRange(String domRange) {
    ...
    public String doors;
    public GetSearchCarActiveQueryParams withDoors(String doors) {
        this.doors = doors;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withDrivetrain(String drivetrain) {
    ...
    public GetSearchCarActiveQueryParams withEngine(String engine) {
        this.engine = engine;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withEngineAspiration(String engineAspiration) {
    ...
    public GetSearchCarActiveQueryParams withEngineBlock(String engineBlock) {
    ...
    public GetSearchCarActiveQueryParams withEngineSize(String engineSize) {
    ...
    public GetSearchCarActiveQueryParams withEngineSizeRange(String engineSizeRange) {
    ...
    public GetSearchCarActiveQueryParams withExcludeCertified(Boolean excludeCertified) {
    ...
    public GetSearchCarActiveQueryParams withExcludeDealerIds(String excludeDealerIds) {
    ...
    public GetSearchCarActiveQueryParams withExcludeSources(String excludeSources) {
    ...
    public GetSearchCarActiveQueryParams withExteriorColor(String exteriorColor) {
    ...
    public GetSearchCarActiveQueryParams withFacetSort(org.openapis.openapi.models.shared.FacetSortEnum facetSort) {
    ...
    public GetSearchCarActiveQueryParams withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withFinanceDownPayment(String financeDownPayment) {
    ...
    public GetSearchCarActiveQueryParams withFinanceDownPaymentPer(String financeDownPaymentPer) {
    ...
    public GetSearchCarActiveQueryParams withFinanceEmp(String financeEmp) {
    ...
    public GetSearchCarActiveQueryParams withFinanceLoanApr(String financeLoanApr) {
    ...
    public GetSearchCarActiveQueryParams withFinanceLoanTerm(String financeLoanTerm) {
    ...
    public GetSearchCarActiveQueryParams withFirstSeenAtMcDays(String firstSeenAtMcDays) {
    ...
    public GetSearchCarActiveQueryParams withFirstSeenAtMcRange(String firstSeenAtMcRange) {
    ...
    public GetSearchCarActiveQueryParams withFirstSeenAtSourceDays(String firstSeenAtSourceDays) {
    ...
    public GetSearchCarActiveQueryParams withFirstSeenAtSourceRange(String firstSeenAtSourceRange) {
    ...
    public GetSearchCarActiveQueryParams withFirstSeenDays(String firstSeenDays) {
    ...
    public GetSearchCarActiveQueryParams withFirstSeenRange(String firstSeenRange) {
    ...
    public GetSearchCarActiveQueryParams withFuelType(String fuelType) {
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=high_value_features")
    public String highValueFeatures;
    public GetSearchCarActiveQueryParams withHighValueFeatures(String highValueFeatures) {
        this.highValueFeatures = highValueFeatures;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withHighwayMpgRange(String highwayMpgRange) {
    ...
    public GetSearchCarActiveQueryParams withInTransit(org.openapis.openapi.models.shared.InTransitEnum inTransit) {
    ...
    public GetSearchCarActiveQueryParams withIncludeFinance(Boolean includeFinance) {
    ...
    public GetSearchCarActiveQueryParams withIncludeLease(Boolean includeLease) {
    ...
    public GetSearchCarActiveQueryParams withIncludeNonVinListings(Boolean includeNonVinListings) {
    ...
    public GetSearchCarActiveQueryParams withIncludeRelevantLinks(Boolean includeRelevantLinks) {
    ...
    public GetSearchCarActiveQueryParams withInteriorColor(String interiorColor) {
    ...
    public GetSearchCarActiveQueryParams withInventoryCountRange(String inventoryCountRange) {
    ...
    public GetSearchCarActiveQueryParams withLastSeenDays(String lastSeenDays) {
    ...
    public GetSearchCarActiveQueryParams withLastSeenRange(String lastSeenRange) {
    ...
    public GetSearchCarActiveQueryParams withLatitude(Double latitude) {
    ...
    public GetSearchCarActiveQueryParams withLeaseDownPayment(String leaseDownPayment) {
    ...
    public GetSearchCarActiveQueryParams withLeaseEmp(String leaseEmp) {
    ...
    public GetSearchCarActiveQueryParams withLeaseTerm(String leaseTerm) {
    ...
    public GetSearchCarActiveQueryParams withLongitude(Double longitude) {
    ...
    public String make;
    public GetSearchCarActiveQueryParams withMake(String make) {
        this.make = make;
        return this;
    }
    ...
    public String match;
    public GetSearchCarActiveQueryParams withMatch(String match) {
        this.match = match;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withMilesRange(String milesRange) {
    ...
    public GetSearchCarActiveQueryParams withMinPhotoLinks(String minPhotoLinks) {
    ...
    public GetSearchCarActiveQueryParams withMinPhotoLinksCached(String minPhotoLinksCached) {
    ...
    public String mm;
    public GetSearchCarActiveQueryParams withMm(String mm) {
        this.mm = mm;
        return this;
    }
    ...
    public String model;
    public GetSearchCarActiveQueryParams withModel(String model) {
        this.model = model;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withMsaCode(String msaCode) {
    ...
    public GetSearchCarActiveQueryParams withMsrpRange(String msrpRange) {
    ...
    public GetSearchCarActiveQueryParams withNodedup(Boolean nodedup) {
    ...
    public GetSearchCarActiveQueryParams withOwned(Boolean owned) {
        this.owned = owned;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withPhotoLinks(Boolean photoLinks) {
    ...
    public GetSearchCarActiveQueryParams withPhotoLinksCached(Boolean photoLinksCached) {
    ...
    public Boolean plot;
    public GetSearchCarActiveQueryParams withPlot(Boolean plot) {
        this.plot = plot;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withPowertrainType(String powertrainType) {
    ...
    public GetSearchCarActiveQueryParams withPriceChange(org.openapis.openapi.models.shared.PriceChangeEnum priceChange) {
    ...
    public GetSearchCarActiveQueryParams withPriceChangeRange(String priceChangeRange) {
    ...
    public GetSearchCarActiveQueryParams withPriceRange(String priceRange) {
    ...
    public GetSearchCarActiveQueryParams withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetSearchCarActiveQueryParams withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withSeatingCapacity(String seatingCapacity) {
    ...
    public GetSearchCarActiveQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetSearchCarActiveQueryParams withSource(String source) {
        this.source = source;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public GetSearchCarActiveQueryParams withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String stats;
    public GetSearchCarActiveQueryParams withStats(String stats) {
        this.stats = stats;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withStockNo(String stockNo) {
    ...
    public GetSearchCarActiveQueryParams withTaxonomyVins(String taxonomyVins) {
    ...
    public GetSearchCarActiveQueryParams withTransmission(String transmission) {
    ...
    public String trim;
    public GetSearchCarActiveQueryParams withTrim(String trim) {
        this.trim = trim;
        return this;
    }
    ...
    public String trimO;
    public GetSearchCarActiveQueryParams withTrimO(String trimO) {
        this.trimO = trimO;
        return this;
    }
    ...
    public String trimR;
    public GetSearchCarActiveQueryParams withTrimR(String trimR) {
        this.trimR = trimR;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withVehicleType(String vehicleType) {
    ...
    public String vin;
    public GetSearchCarActiveQueryParams withVin(String vin) {
        this.vin = vin;
        return this;
    }
    ...
    public String vins;
    public GetSearchCarActiveQueryParams withVins(String vins) {
        this.vins = vins;
        return this;
    }
    ...
    public String year;
    public GetSearchCarActiveQueryParams withYear(String year) {
        this.year = year;
        return this;
    }
    ...
    public GetSearchCarActiveQueryParams withYearRange(String yearRange) {
    ...
    public String ymm;
    public GetSearchCarActiveQueryParams withYmm(String ymm) {
        this.ymm = ymm;
        return this;
    }
    ...
    public String ymmt;
    public GetSearchCarActiveQueryParams withYmmt(String ymmt) {
        this.ymmt = ymmt;
        return this;
    }
    ...
    public String zip;
    public GetSearchCarActiveQueryParams withZip(String zip) {
        this.zip = zip;
        return this;
    }
