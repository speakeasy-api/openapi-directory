...
type SearchTypeHydroColoradoQueryParams struct {
	...
	// Site ID
	SearchTypeHydroColoradoSiteID *string `queryParam:"style=form,explode=true,name=search.type_hydro_colorado.site_id"`
	// Number to skip
...
type SearchTypeHydroColoradoRequest struct {
	QueryParams SearchTypeHydroColoradoQueryParams
}

type SearchTypeHydroColoradoResponse struct {
	ContentType string
	StatusCode  int
