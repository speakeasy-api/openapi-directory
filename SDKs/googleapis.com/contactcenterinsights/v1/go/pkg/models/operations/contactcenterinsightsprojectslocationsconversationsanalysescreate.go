...
type ContactcenterinsightsProjectsLocationsConversationsAnalysesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContactcenterinsightsProjectsLocationsConversationsAnalysesCreatePathParams struct {
	// Required. The parent resource of the analysis.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ContactcenterinsightsProjectsLocationsConversationsAnalysesCreateQueryParams struct {
	// V1 error format.
...
type ContactcenterinsightsProjectsLocationsConversationsAnalysesCreateResponse struct {
	ContentType string
	// Successful response
