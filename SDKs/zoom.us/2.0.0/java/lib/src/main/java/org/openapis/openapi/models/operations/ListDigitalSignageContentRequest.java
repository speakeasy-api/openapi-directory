...
public class ListDigitalSignageContentRequest {
    ...
    public ListDigitalSignageContentRequest withFolderId(String folderId) {
    ...
    public ListDigitalSignageContentRequest withNextPageToken(String nextPageToken) {
    ...
    public ListDigitalSignageContentRequest withPageSize(Long pageSize) {
    ...
    public String type;
    public ListDigitalSignageContentRequest withType(String type) {
        this.type = type;
        return this;
    }
