...
import org.openapis.openapi.models.operations.CreateArtifactIfExistsEnum;
import org.openapis.openapi.models.operations.CreateArtifactRequest;
import org.openapis.openapi.models.operations.CreateArtifactResponse;
import org.openapis.openapi.models.operations.CreateArtifactXRegistryArtifactTypeEnum;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CreateArtifactRequest req = new CreateArtifactRequest("delectus".getBytes()) {{
                xRegistryArtifactId = "tempora";
                xRegistryArtifactType = CreateArtifactXRegistryArtifactTypeEnum.OPENAPI;
                ifExists = CreateArtifactIfExistsEnum.UPDATE;
            }};            

            CreateArtifactResponse res = sdk.artifacts.createArtifact(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DeleteArtifactRequest req = new DeleteArtifactRequest("minus");            
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetArtifactByGlobalIdRequest;
import org.openapis.openapi.models.operations.GetArtifactByGlobalIdResponse;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetArtifactByGlobalIdRequest req = new GetArtifactByGlobalIdRequest(812169L);            

            GetArtifactByGlobalIdResponse res = sdk.artifacts.getArtifactByGlobalId(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetLatestArtifactRequest req = new GetLatestArtifactRequest("voluptatum");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ListArtifactsResponse res = sdk.artifacts.listArtifacts();

            if (res.listArtifacts200ApplicationJSONStrings != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchArtifactsRequest req = new SearchArtifactsRequest(479977L, 568045L) {{
                order = SearchArtifactsOrderEnum.ASC;
                over = SearchArtifactsOverEnum.LABELS;
                search = "temporibus";
            }};            
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.UpdateArtifactRequest;
import org.openapis.openapi.models.operations.UpdateArtifactResponse;
import org.openapis.openapi.models.operations.UpdateArtifactXRegistryArtifactTypeEnum;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UpdateArtifactRequest req = new UpdateArtifactRequest("ab".getBytes(), "quis") {{
                xRegistryArtifactType = UpdateArtifactXRegistryArtifactTypeEnum.AVRO;
            }};            

            UpdateArtifactResponse res = sdk.artifacts.updateArtifact(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UpdateArtifactStateRequest req = new UpdateArtifactStateRequest(                new UpdateState(ArtifactStateEnum.DEPRECATED);, "perferendis");            
