...
class VoiceCallResponseCreateReport:
    ...
    links: Optional[shared__links_create_report.LinksCreateReport] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_links'), 'exclude': lambda f: f is None }})  
    ...
    request_status: Optional[shared_request_status_create_report_enum.RequestStatusCreateReportEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request_status'), 'exclude': lambda f: f is None }})
    ...
    status: Optional[shared_voice_status_enum.VoiceStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
