...
func (e *CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "DORMANT":
		fallthrough
	case "SUSPENDED":
		*e = CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CustomBiddingAlgorithmCustomBiddingAlgorithmStateEnum: %s", s)
	}
}
