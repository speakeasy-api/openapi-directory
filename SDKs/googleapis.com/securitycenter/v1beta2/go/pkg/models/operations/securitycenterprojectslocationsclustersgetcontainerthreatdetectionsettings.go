...
type SecuritycenterProjectsLocationsClustersGetContainerThreatDetectionSettingsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecuritycenterProjectsLocationsClustersGetContainerThreatDetectionSettingsPathParams struct {
...
type SecuritycenterProjectsLocationsClustersGetContainerThreatDetectionSettingsQueryParams struct {
	// V1 error format.
...
type SecuritycenterProjectsLocationsClustersGetContainerThreatDetectionSettingsRequest struct {
...
type SecuritycenterProjectsLocationsClustersGetContainerThreatDetectionSettingsResponse struct {
	// Successful response
