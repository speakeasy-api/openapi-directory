...
from ..shared import transfernetwork_enum as shared_transfernetwork_enum
from ..shared import transfertype_enum as shared_transfertype_enum
...
class TransferAuthorizationCreateRequest:
    ...
    network: shared_transfernetwork_enum.TransferNetworkEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('network') }})
    ...
    """  
    type: shared_transfertype_enum.TransferTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    ...
    ach_class: Optional[shared_achclass_enum.ACHClassEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ach_class'), 'exclude': lambda f: f is None }})
    ...
    r"""The unique identifier returned by Plaid's [beacon](https://plaid.com/docs/transfer/guarantee/#using-a-beacon) when it is run on your webpage. Required for Guarantee customers who are not using [Transfer UI](https://plaid.com/docs/transfer/using-transfer-ui/) and have a web checkout experience."""  
    ...
    r"""A random key provided by the client, per unique authorization. Maximum of 50 characters.
    ...
    r"""Required for Guarantee. If the end user is initiating the specific transfer themselves via an interactive UI, this should be `true`; for automatic recurring payments where the end user is not actually initiating each individual transfer, it should be `false`."""  
