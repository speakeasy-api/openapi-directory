...
class OBWriteInternationalScheduledConsentResponse6
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalScheduledConsentResponse6Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteInternationalScheduledConsentResponse6Data();
		$this->links = null;
		$this->meta = null;
