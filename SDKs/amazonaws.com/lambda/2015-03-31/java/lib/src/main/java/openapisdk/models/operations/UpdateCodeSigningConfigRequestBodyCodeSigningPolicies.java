...
**/
public class UpdateCodeSigningConfigRequestBodyCodeSigningPolicies {
    ...
    public UpdateCodeSigningConfigRequestBodyCodeSigningPolicies withUntrustedArtifactOnDeployment(openapisdk.models.shared.CodeSigningPolicyEnum untrustedArtifactOnDeployment) {
