...
public class Operations {
    ...
    **/
    public openapisdk.models.operations.CloudassetOperationsGetResponse cloudassetOperationsGet(openapisdk.models.operations.CloudassetOperationsGetRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1p7beta1/{name}", request.pathParams);
        ...
        openapisdk.models.operations.CloudassetOperationsGetResponse res = new openapisdk.models.operations.CloudassetOperationsGetResponse() {{
            operation = null;
        }};
