...
class IapProjectsIapTunnelLocationsDestGroupsDeleteRequest:
    ...
    r"""Required. Name of the TunnelDestGroup to delete. In the following format: `projects/{project_number/id}/iap_tunnel/locations/{location}/destGroups/{dest_group}`."""  
