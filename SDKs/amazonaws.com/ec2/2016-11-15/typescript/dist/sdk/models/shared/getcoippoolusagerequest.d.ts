 ...
 */
export declare class GetCoipPoolUsageRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetCoipPoolUsageRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: GetCoipPoolUsageRequestFilters[];
    maxResults?: number;
    nextToken?: string;
    poolId: string;
}
