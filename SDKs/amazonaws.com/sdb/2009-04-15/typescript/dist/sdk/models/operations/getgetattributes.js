...
exports.GETGETAttributesResponse = exports.GETGETAttributesRequest = exports.GETGETAttributesVersionEnum = exports.GETGETAttributesActionEnum = void 0;
var utils_1 = require("../../../internal/utils");
var GETGETAttributesActionEnum;
(function (GETGETAttributesActionEnum) {
    GETGETAttributesActionEnum["GetAttributes"] = "GetAttributes";
})(GETGETAttributesActionEnum = exports.GETGETAttributesActionEnum || (exports.GETGETAttributesActionEnum = {}));
var GETGETAttributesVersionEnum;
(function (GETGETAttributesVersionEnum) {
    GETGETAttributesVersionEnum["TwoThousandAndNine0415"] = "2009-04-15";
})(GETGETAttributesVersionEnum = exports.GETGETAttributesVersionEnum || (exports.GETGETAttributesVersionEnum = {}));
var GETGETAttributesRequest = /** @class */ (function (_super) {
    ...
    ], GETGETAttributesRequest.prototype, "awsAccessKeyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Action",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=AttributeNames",
        }),
        __metadata("design:type", Array)
    ], GETGETAttributesRequest.prototype, "attributeNames", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ConsistentRead",
        }),
        __metadata("design:type", Boolean)
    ], GETGETAttributesRequest.prototype, "consistentRead", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DomainName",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "domainName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ItemName",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "itemName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Signature",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureMethod",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "signatureMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureVersion",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "signatureVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Timestamp",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "timestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], GETGETAttributesRequest.prototype, "version", void 0);
    return GETGETAttributesRequest;
}(utils_1.SpeakeasyBase));
exports.GETGETAttributesRequest = GETGETAttributesRequest;
var GETGETAttributesResponse = /** @class */ (function (_super) {
    ...
    ], GETGETAttributesResponse.prototype, "rawResponse", void 0);
    return GETGETAttributesResponse;
}(utils_1.SpeakeasyBase));
exports.GETGETAttributesResponse = GETGETAttributesResponse;
