...
type UltraPlanOrGreater struct {
...
func NewUltraPlanOrGreater(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *UltraPlanOrGreater {
...
func (s *UltraPlanOrGreater) GetDealerSalesRegionDailySalesGet(ctx context.Context, request operations.GetDealerSalesRegionDailySalesGetRequest) (*operations.GetDealerSalesRegionDailySalesGetResponse, error) {
...
//
// Data availability depends on region and goes back up to 2016.
func (s *UltraPlanOrGreater) GetDealerSalesRegionSalesGet(ctx context.Context, request operations.GetDealerSalesRegionSalesGetRequest) (*operations.GetDealerSalesRegionSalesGetResponse, error) {
	baseURL := s._serverURL
...
func (s *UltraPlanOrGreater) GetListings2Listings2Get(ctx context.Context, request operations.GetListings2Listings2GetRequest) (*operations.GetListings2Listings2GetResponse, error) {
	baseURL := s._serverURL
...
// Results are paginated in chunks of up to 20 vehicles. Prices are in the dealer's local currency (generally USD).
func (s *UltraPlanOrGreater) GetListingsByDealerListingsByDateGet(ctx context.Context, request operations.GetListingsByDealerListingsByDateGetRequest) (*operations.GetListingsByDealerListingsByDateGetResponse, error) {
	baseURL := s._serverURL
...
// Listing keys are: vin, askPrice, msrp, isNew, firstSeen, lastSeen, modelName, brandName.
// Results are paginated in chunks of up to 20 vehicles. Prices are in the dealer's local currency (generally USD).
func (s *UltraPlanOrGreater) GetListingsByDealerListingsGet(ctx context.Context, request operations.GetListingsByDealerListingsGetRequest) (*operations.GetListingsByDealerListingsGetResponse, error) {
	baseURL := s._serverURL
...
// Listing keys are: vin, askPrice, msrp, isNew, firstSeen, lastSeen, modelName, brandName.
// Results are paginated in chunks of up to 20 vehicles. Prices are in the dealer's local currency (generally USD).
func (s *UltraPlanOrGreater) GetListingsByRegionAndDateListingsByRegionAndDateGet(ctx context.Context, request operations.GetListingsByRegionAndDateListingsByRegionAndDateGetRequest) (*operations.GetListingsByRegionAndDateListingsByRegionAndDateGetResponse, error) {
	baseURL := s._serverURL
...
// Listing keys are: vin, askPrice, msrp, isNew, firstSeen, lastSeen, modelName, brandName.
// Results are paginated in chunks of up to 20 vehicles. Prices are in the dealer's local currency (generally USD).
func (s *UltraPlanOrGreater) GetListingsByRegionListingsByRegionGet(ctx context.Context, request operations.GetListingsByRegionListingsByRegionGetRequest) (*operations.GetListingsByRegionListingsByRegionGetResponse, error) {
	baseURL := s._serverURL
...
func (s *UltraPlanOrGreater) GetRegionBrandMarketShareGetRegionBrandMarketShareGet(ctx context.Context, request operations.GetRegionBrandMarketShareGetRegionBrandMarketShareGetRequest) (*operations.GetRegionBrandMarketShareGetRegionBrandMarketShareGetResponse, error) {
	baseURL := s._serverURL
...
func (s *UltraPlanOrGreater) GetRegionMarketShareGetRegionMarketShareGet(ctx context.Context, request operations.GetRegionMarketShareGetRegionMarketShareGetRequest) (*operations.GetRegionMarketShareGetRegionMarketShareGetResponse, error) {
	baseURL := s._serverURL
...
func (s *UltraPlanOrGreater) GetVehicleSeenVehicleSeenGet(ctx context.Context, request operations.GetVehicleSeenVehicleSeenGetRequest) (*operations.GetVehicleSeenVehicleSeenGetResponse, error) {
	baseURL := s._serverURL
...
// Listing keys are: vin, askPrice, msrp, isNew, firstSeen, lastSeen, modelName, brandName.
// Results are paginated in chunks of up to 20 vehicles. Prices are in the dealer's local currency (generally USD).
func (s *UltraPlanOrGreater) ListingsByZipCodeAndDateListingsByZipCodeAndDateGet(ctx context.Context, request operations.ListingsByZipCodeAndDateListingsByZipCodeAndDateGetRequest) (*operations.ListingsByZipCodeAndDateListingsByZipCodeAndDateGetResponse, error) {
	baseURL := s._serverURL
...
// Listing keys are: vin, askPrice, msrp, isNew, firstSeen, lastSeen, modelName, brandName.
// Results are paginated in chunks of up to 20 vehicles. Prices are in the dealer's local currency (generally USD).
func (s *UltraPlanOrGreater) ListingsByZipCodeListingsByZipCodeGet(ctx context.Context, request operations.ListingsByZipCodeListingsByZipCodeGetRequest) (*operations.ListingsByZipCodeListingsByZipCodeGetResponse, error) {
	baseURL := s._serverURL
