...
class DirectoryChromeosdevicesUpdateRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryChromeosdevicesUpdateProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?DirectoryChromeosdevicesUpdateProjectionEnum $projection = null;
