...
from ..shared import beezup_common_paginationresultlinks as shared_beezup_common_paginationresultlinks
...
class BeezUpCommonPaginationResult:
    ...
    links: shared_beezup_common_paginationresultlinks.BeezUpCommonPaginationResultLinks = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
