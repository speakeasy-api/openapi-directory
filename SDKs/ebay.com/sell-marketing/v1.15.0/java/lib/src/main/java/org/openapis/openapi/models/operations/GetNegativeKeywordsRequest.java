...
public class GetNegativeKeywordsRequest {
    ...
    public GetNegativeKeywordsRequest withAdGroupIds(String adGroupIds) {
    ...
    public GetNegativeKeywordsRequest withCampaignIds(String campaignIds) {
    ...
    public GetNegativeKeywordsRequest withLimit(String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetNegativeKeywordsRequest withNegativeKeywordStatus(String negativeKeywordStatus) {
    ...
    public GetNegativeKeywordsRequest withOffset(String offset) {
        this.offset = offset;
        return this;
    }
    
    public GetNegativeKeywordsRequest(){}
}
