...
from ..shared import createaccountholderresponse as shared_createaccountholderresponse
...
class PostCreateAccountHolderResponse:
    ...
    create_account_holder_response: Optional[shared_createaccountholderresponse.CreateAccountHolderResponse] = dataclasses.field(default=None)
