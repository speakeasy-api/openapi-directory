...
const (
	TagResourceXAmzTargetEnumBackupOnPremisesV20210101TagResource TagResourceXAmzTargetEnum = "BackupOnPremises_v20210101.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "BackupOnPremises_v20210101.TagResource":
