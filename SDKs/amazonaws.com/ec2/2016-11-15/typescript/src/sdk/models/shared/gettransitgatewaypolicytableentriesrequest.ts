 ...
 */
export class GetTransitGatewayPolicyTableEntriesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetTransitGatewayPolicyTableEntriesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
