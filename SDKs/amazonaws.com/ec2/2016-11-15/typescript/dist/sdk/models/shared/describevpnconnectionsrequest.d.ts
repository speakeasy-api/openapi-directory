 ...
 */
export declare class DescribeVpnConnectionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
/**
 ...
 */
export declare class DescribeVpnConnectionsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVpnConnectionsRequestFilters[];
