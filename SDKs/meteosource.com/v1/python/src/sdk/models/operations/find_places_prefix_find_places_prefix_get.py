...
class FindPlacesPrefixFindPlacesPrefixGetSecurity:
    
    api_key_header: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Key' }})  
    
class FindPlacesPrefixFindPlacesPrefixGetLanguageLanguageEnum(str, Enum):
    r"""An enumeration."""
    CS = 'cs'
    EN = 'en'
    DE = 'de'
...
class FindPlacesPrefixFindPlacesPrefixGetRequest:
    ...
    language: Optional[FindPlacesPrefixFindPlacesPrefixGetLanguageLanguageEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'language', 'style': 'form', 'explode': True }})
