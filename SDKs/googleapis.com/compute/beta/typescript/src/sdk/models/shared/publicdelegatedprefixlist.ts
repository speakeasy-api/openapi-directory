 ...
 */
export enum PublicDelegatedPrefixListWarningCodeEnum {
...
export class PublicDelegatedPrefixListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class PublicDelegatedPrefixListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: PublicDelegatedPrefixListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class PublicDelegatedPrefixList extends SpeakeasyBase {
  /**
