...
const (
	TagResourceXAmzTargetEnumOpenSearchServerlessTagResource TagResourceXAmzTargetEnum = "OpenSearchServerless.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "OpenSearchServerless.TagResource":
