...
class UpdatePullRequestStatusRequest:
    headers: UpdatePullRequestStatusHeaders = dataclasses.field()
    request: shared_updatepullrequeststatusinput.UpdatePullRequestStatusInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
