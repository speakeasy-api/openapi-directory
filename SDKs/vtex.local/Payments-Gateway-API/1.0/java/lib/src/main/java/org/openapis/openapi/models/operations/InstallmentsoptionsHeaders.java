...
public class InstallmentsoptionsHeaders {
    /**
    ...
    public InstallmentsoptionsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public InstallmentsoptionsHeaders withContentType(String contentType) {
    ...
    public InstallmentsoptionsHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public InstallmentsoptionsHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
