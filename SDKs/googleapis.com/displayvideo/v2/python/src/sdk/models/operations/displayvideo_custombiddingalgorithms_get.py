...
class DisplayvideoCustomBiddingAlgorithmsGetRequest:
    path_params: DisplayvideoCustomBiddingAlgorithmsGetPathParams = dataclasses.field()
    query_params: DisplayvideoCustomBiddingAlgorithmsGetQueryParams = dataclasses.field()
    security: DisplayvideoCustomBiddingAlgorithmsGetSecurity = dataclasses.field()
