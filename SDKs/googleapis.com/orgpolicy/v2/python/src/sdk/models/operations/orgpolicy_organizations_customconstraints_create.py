...
class OrgpolicyOrganizationsCustomConstraintsCreateRequest:
    ...
    r"""Required. Must be in the following form: * `organizations/{organization_id}`"""  
    ...
    google_cloud_orgpolicy_v2_custom_constraint_input: Optional[shared_googlecloudorgpolicyv2customconstraint.GoogleCloudOrgpolicyV2CustomConstraintInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
