...
public class GetNhFurnitureQueryParams {
    /**
    ...
    public GetNhFurnitureQueryParams withCategory(GetNhFurnitureCategoryEnum category) {
    ...
    public GetNhFurnitureQueryParams withColor(GetNhFurnitureColorEnum[] color) {
        this.color = color;
        return this;
    }
    ...
    public GetNhFurnitureQueryParams withExcludedetails(String excludedetails) {
