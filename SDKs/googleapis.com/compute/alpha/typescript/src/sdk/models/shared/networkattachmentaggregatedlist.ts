 ...
 */
export enum NetworkAttachmentAggregatedListWarningCodeEnum {
...
export class NetworkAttachmentAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkAttachmentAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkAttachmentAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class NetworkAttachmentAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkAttachmentsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, NetworkAttachmentsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], NetworkAttachmentsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
