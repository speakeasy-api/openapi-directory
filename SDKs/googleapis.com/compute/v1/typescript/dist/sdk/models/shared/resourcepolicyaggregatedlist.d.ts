...
import { ResourcePoliciesScopedList } from "./resourcepoliciesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum ResourcePolicyAggregatedListWarningCodeEnum {
...
export declare class ResourcePolicyAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ResourcePolicyAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ResourcePolicyAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ResourcePolicyAggregatedListWarningData[];
    /**
 ...
 */
export declare class ResourcePolicyAggregatedList extends SpeakeasyBase {
    etag?: string;
    /**
