...
type ManagedidentitiesProjectsLocationsGlobalDomainsAttachTrustSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ManagedidentitiesProjectsLocationsGlobalDomainsAttachTrustPathParams struct {
...
type ManagedidentitiesProjectsLocationsGlobalDomainsAttachTrustQueryParams struct {
	// V1 error format.
...
type ManagedidentitiesProjectsLocationsGlobalDomainsAttachTrustResponse struct {
	ContentType string
	// Successful response
