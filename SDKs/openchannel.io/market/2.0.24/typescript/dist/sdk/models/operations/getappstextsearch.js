...
exports.GetAppsTextSearchResponse = exports.GetAppsTextSearchRequest = void 0;
...
var GetAppsTextSearchRequest = /** @class */ (function (_super) {
    ...
    ], GetAppsTextSearchRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=isOwned",
        }),
        __metadata("design:type", Boolean)
    ], GetAppsTextSearchRequest.prototype, "isOwned", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetAppsTextSearchRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageNumber",
        }),
        __metadata("design:type", Number)
    ], GetAppsTextSearchRequest.prototype, "pageNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetAppsTextSearchRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=text" }),
        __metadata("design:type", String)
    ], GetAppsTextSearchRequest.prototype, "text", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userId",
        }),
        __metadata("design:type", String)
    ], GetAppsTextSearchRequest.prototype, "userId", void 0);
...
var GetAppsTextSearchResponse = /** @class */ (function (_super) {
    ...
    ], GetAppsTextSearchResponse.prototype, "rawResponse", void 0);
