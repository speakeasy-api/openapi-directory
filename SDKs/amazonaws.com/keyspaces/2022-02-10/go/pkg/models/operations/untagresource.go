...
const (
	UntagResourceXAmzTargetEnumKeyspacesServiceUntagResource UntagResourceXAmzTargetEnum = "KeyspacesService.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "KeyspacesService.UntagResource":
