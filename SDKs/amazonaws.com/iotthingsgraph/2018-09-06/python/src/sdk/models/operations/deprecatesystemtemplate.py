...
class DeprecateSystemTemplateRequest:
    ...
    deprecate_system_template_request: shared_deprecatesystemtemplaterequest.DeprecateSystemTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
