...
class BusinessLine:
    ...
    capability: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('capability') }})
    ...
    web_data: Optional[list[shared_webdata.WebData]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webData'), 'exclude': lambda f: f is None }})
    r"""List of website URLs where your user's goods or services are sold. When this is required for a capability but your user does not have an online presence, provide the reason in the `webDataExemption` object."""  
