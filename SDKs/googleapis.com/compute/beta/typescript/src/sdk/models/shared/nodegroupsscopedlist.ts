 ...
 */
export enum NodeGroupsScopedListWarningCodeEnum {
...
export class NodeGroupsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeGroupsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeGroupsScopedListWarningData })
  @Expose({ name: "data" })
...
export class NodeGroupsScopedList extends SpeakeasyBase {
  /**
