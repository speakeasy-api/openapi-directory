...
class DeleteDatabaseRequest:
    path_params: DeleteDatabasePathParams = dataclasses.field()
...
class DeleteDatabaseResponse:
    ...
    delete_database_401_application_json_object: Optional[DeleteDatabase401ApplicationJSON] = dataclasses.field(default=None)
