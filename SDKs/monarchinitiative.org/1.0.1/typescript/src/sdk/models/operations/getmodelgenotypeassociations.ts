...
export class GetModelGenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetModelGenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetModelGenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetModelGenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
