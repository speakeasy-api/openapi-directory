...
class GetTagsTagsSynonymsQueryParams:
    ...
    order: Optional[GetTagsTagsSynonymsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetTagsTagsSynonymsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetTagsTagsSynonymsRequest:
    path_params: GetTagsTagsSynonymsPathParams = dataclasses.field()
    query_params: GetTagsTagsSynonymsQueryParams = dataclasses.field()
