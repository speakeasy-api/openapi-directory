...
export class DeleteFieldLevelEncryptionConfig20180618Request extends SpeakeasyBase {
  /**
...
export class DeleteFieldLevelEncryptionConfig20180618Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
