...
func (e AsymmetricSignResponseProtectionLevelEnum) ToPointer() *AsymmetricSignResponseProtectionLevelEnum {
	return &e
}
...
func (e *AsymmetricSignResponseProtectionLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "EXTERNAL":
		fallthrough
	case "EXTERNAL_VPC":
		*e = AsymmetricSignResponseProtectionLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AsymmetricSignResponseProtectionLevelEnum: %v", v)
	}
}
