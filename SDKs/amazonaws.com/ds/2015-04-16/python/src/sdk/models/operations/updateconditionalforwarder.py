...
class UpdateConditionalForwarderRequest:
    ...
    update_conditional_forwarder_request: shared_updateconditionalforwarderrequest.UpdateConditionalForwarderRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
