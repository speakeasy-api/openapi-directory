...
class HiuSubscriptionNotificationAcknowledgmentAcknowledgement:
    ...
    status: HiuSubscriptionNotificationAcknowledgmentAcknowledgementStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class HiuSubscriptionNotificationAcknowledgment:
    ...
    acknowledgement: Optional[HiuSubscriptionNotificationAcknowledgmentAcknowledgement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
