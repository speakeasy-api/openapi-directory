...
var Gitignore = /** @class */ (function () {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.19/rest/reference/gitignore#get-all-gitignore-templates} - API method documentation
     */
    Gitignore.prototype.gitignoreGetAllTemplates = function (config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GitignoreGetAllTemplatesResponse({
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.19/rest/reference/gitignore#get-a-gitignore-template} - API method documentation
     */
    Gitignore.prototype.gitignoreGetTemplate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/gitignore/templates/{name}", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GitignoreGetTemplateResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.gitignoreTemplate = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GitignoreTemplate);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 304:
                    break;
