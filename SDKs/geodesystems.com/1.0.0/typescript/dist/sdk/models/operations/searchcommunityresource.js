...
exports.SearchCommunityResourceResponse = exports.SearchCommunityResourceRequest = exports.SearchCommunityResourceQueryParams = void 0;
...
var SearchCommunityResourceQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.community_resource.address" }),
        __metadata("design:type", String)
    ], SearchCommunityResourceQueryParams.prototype, "searchCommunityResourceAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.community_resource.city" }),
        __metadata("design:type", String)
    ], SearchCommunityResourceQueryParams.prototype, "searchCommunityResourceCity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.community_resource.resource_type" }),
        __metadata("design:type", String)
    ], SearchCommunityResourceQueryParams.prototype, "searchCommunityResourceResourceType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.community_resource.state" }),
        __metadata("design:type", String)
    ], SearchCommunityResourceQueryParams.prototype, "searchCommunityResourceState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.community_resource.zipcode" }),
        __metadata("design:type", String)
...
exports.SearchCommunityResourceQueryParams = SearchCommunityResourceQueryParams;
