 ...
 */
export enum NodeGroupAggregatedListWarningCodeEnum {
...
export class NodeGroupAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeGroupAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeGroupAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class NodeGroupAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeGroupsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, NodeGroupsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], NodeGroupsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
