...
class AppPkgm:
    ...
    def subscriptions_post(self, request: operations.SubscriptionsPostRequest) -> operations.SubscriptionsPostResponse:
        ...
        res = operations.SubscriptionsPostResponse(status_code=r.status_code, content_type=content_type)
