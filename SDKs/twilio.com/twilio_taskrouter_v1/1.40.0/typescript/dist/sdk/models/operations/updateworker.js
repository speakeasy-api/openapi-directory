...
exports.UpdateWorkerResponse = exports.UpdateWorkerRequest = exports.UpdateWorkerUpdateWorkerRequest = exports.UpdateWorkerSecurity = exports.UpdateWorkerServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.UpdateWorkerServerList = [
...
var UpdateWorkerSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateWorkerSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], UpdateWorkerSecurity.prototype, "username", void 0);
    return UpdateWorkerSecurity;
}(utils_1.SpeakeasyBase));
exports.UpdateWorkerSecurity = UpdateWorkerSecurity;
var UpdateWorkerUpdateWorkerRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=RejectPendingReservations" }),
        __metadata("design:type", Boolean)
    ], UpdateWorkerUpdateWorkerRequest.prototype, "rejectPendingReservations", void 0);
    return UpdateWorkerUpdateWorkerRequest;
}(utils_1.SpeakeasyBase));
exports.UpdateWorkerUpdateWorkerRequest = UpdateWorkerUpdateWorkerRequest;
var UpdateWorkerRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateWorkerRequest.prototype, "ifMatch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", UpdateWorkerUpdateWorkerRequest)
    ], UpdateWorkerRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=Sid" }),
        __metadata("design:type", String)
    ], UpdateWorkerRequest.prototype, "sid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], UpdateWorkerRequest.prototype, "workspaceSid", void 0);
...
var UpdateWorkerResponse = /** @class */ (function (_super) {
    ...
    ], UpdateWorkerResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
