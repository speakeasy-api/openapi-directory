...
type GetNhFossilsAllFossilRequest struct {
	...
	Fossil string `pathParam:"style=simple,explode=false,name=fossil"`
...
type GetNhFossilsAllFossilResponse struct {
	ContentType string
	...
	NHFossilGroupWithIndividualFossils *shared.NHFossilGroupWithIndividualFossils
	StatusCode                         int
