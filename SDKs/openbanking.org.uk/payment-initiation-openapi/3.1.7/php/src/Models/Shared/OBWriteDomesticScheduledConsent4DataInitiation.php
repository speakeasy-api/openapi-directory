...
class OBWriteDomesticScheduledConsent4DataInitiation
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationCreditorAccount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticScheduledConsent4DataInitiationDebtorAccount $debtorAccount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationInstructedAmount $instructedAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('InstructedAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationInstructedAmount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation $remittanceInformation
     */
	#[\JMS\Serializer\Annotation\SerializedName('RemittanceInformation')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticScheduledConsent4DataInitiationRemittanceInformation $remittanceInformation = null;
	...
	{
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationCreditorAccount();
		$this->creditorPostalAddress = null;
		$this->debtorAccount = null;
		$this->endToEndIdentification = null;
		$this->instructedAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledConsent4DataInitiationInstructedAmount();
