...
class UpdateDeployedDevicesDeviceRequest:
    ...
    request_body: Optional[UpdateDeployedDevicesDeviceUpdateDeployedDevicesDeviceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
