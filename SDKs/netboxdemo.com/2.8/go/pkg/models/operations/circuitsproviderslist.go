...
type CircuitsProvidersListRequest struct {
	...
	AccountIc      *string `queryParam:"style=form,explode=true,name=account__ic"`
	AccountIe      *string `queryParam:"style=form,explode=true,name=account__ie"`
	AccountIew     *string `queryParam:"style=form,explode=true,name=account__iew"`
	AccountIsw     *string `queryParam:"style=form,explode=true,name=account__isw"`
	AccountN       *string `queryParam:"style=form,explode=true,name=account__n"`
	AccountNic     *string `queryParam:"style=form,explode=true,name=account__nic"`
	AccountNie     *string `queryParam:"style=form,explode=true,name=account__nie"`
	AccountNiew    *string `queryParam:"style=form,explode=true,name=account__niew"`
	AccountNisw    *string `queryParam:"style=form,explode=true,name=account__nisw"`
