...
class GetWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsSecurity:
...
@dataclasses.dataclass
class GetWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsResponse:
