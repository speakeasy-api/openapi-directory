...
func main() {
    ...
    res, err := s.Reactions.ReactionsCreateForTeamDiscussionCommentInOrg(ctx, operations.ReactionsCreateForTeamDiscussionCommentInOrgRequest{
        ...
        CommentNumber: 911451,
        DiscussionNumber: 673191,
        Org: "incidunt",
        TeamSlug: "maxime",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Reactions.ReactionsCreateForTeamDiscussionLegacy(ctx, operations.ReactionsCreateForTeamDiscussionLegacyRequest{
        RequestBody: operations.ReactionsCreateForTeamDiscussionLegacyRequestBody{
            Content: operations.ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnumLaugh,
        },
        DiscussionNumber: 777378,
        TeamID: 19462,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForCommitComment(ctx, operations.ReactionsListForCommitCommentRequest{
        ...
        Owner: "similique",
        Page: sdk.Int64(783274),
        PerPage: sdk.Int64(502453),
        Repo: "quae",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForIssue(ctx, operations.ReactionsListForIssueRequest{
        Content: operations.ReactionsListForIssueContentEnumMinus1.ToPointer(),
        IssueNumber: 885797,
        Owner: "sed",
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForIssueComment(ctx, operations.ReactionsListForIssueCommentRequest{
        ...
        Owner: "maiores",
        Page: sdk.Int64(514462),
        PerPage: sdk.Int64(982248),
        Repo: "alias",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForPullRequestReviewComment(ctx, operations.ReactionsListForPullRequestReviewCommentRequest{
        CommentID: 992667,
        Content: operations.ReactionsListForPullRequestReviewCommentContentEnumHeart.ToPointer(),
        Owner: "dicta",
        Page: sdk.Int64(380595),
        PerPage: sdk.Int64(938257),
        Repo: "doloribus",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForTeamDiscussionCommentInOrg(ctx, operations.ReactionsListForTeamDiscussionCommentInOrgRequest{
        CommentNumber: 203621,
        Content: operations.ReactionsListForTeamDiscussionCommentInOrgContentEnumEyes.ToPointer(),
        DiscussionNumber: 566312,
        Org: "accusantium",
        Page: sdk.Int64(185816),
        PerPage: sdk.Int64(771241),
        TeamSlug: "beatae",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForTeamDiscussionInOrg(ctx, operations.ReactionsListForTeamDiscussionInOrgRequest{
        ...
        DiscussionNumber: 424854,
        Org: "accusantium",
        Page: sdk.Int64(664197),
        PerPage: sdk.Int64(388169),
        TeamSlug: "ex",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Reactions.ReactionsListForTeamDiscussionLegacy(ctx, operations.ReactionsListForTeamDiscussionLegacyRequest{
        ...
        DiscussionNumber: 85794,
        Page: sdk.Int64(356440),
        PerPage: sdk.Int64(62688),
        TeamID: 631719,
    })
    if err != nil {
        log.Fatal(err)
