...
class CreateDistributionWithTags20180618QueryParams:
    with_tags: bool = dataclasses.field(metadata={'query_param': { 'field_name': 'WithTags', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class CreateDistributionWithTags20180618Headers:
...
class CreateDistributionWithTags20180618Request:
    headers: CreateDistributionWithTags20180618Headers = dataclasses.field()
    query_params: CreateDistributionWithTags20180618QueryParams = dataclasses.field()
