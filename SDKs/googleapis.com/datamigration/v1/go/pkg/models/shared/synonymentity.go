...
const (
	...
	SynonymEntitySourceTypeEnumDatabaseEntityTypeMaterializedView SynonymEntitySourceTypeEnum = "DATABASE_ENTITY_TYPE_MATERIALIZED_VIEW"
	SynonymEntitySourceTypeEnumDatabaseEntityTypeDatabase         SynonymEntitySourceTypeEnum = "DATABASE_ENTITY_TYPE_DATABASE"
)

func (e SynonymEntitySourceTypeEnum) ToPointer() *SynonymEntitySourceTypeEnum {
	return &e
}
...
func (e *SynonymEntitySourceTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "DATABASE_ENTITY_TYPE_DATABASE":
		*e = SynonymEntitySourceTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SynonymEntitySourceTypeEnum: %v", v)
	}
}
