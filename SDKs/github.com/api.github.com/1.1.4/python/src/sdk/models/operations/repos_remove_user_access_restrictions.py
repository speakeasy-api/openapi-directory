...
class ReposRemoveUserAccessRestrictionsRequest:
    path_params: ReposRemoveUserAccessRestrictionsPathParams = dataclasses.field()
    request: Optional[ReposRemoveUserAccessRestrictionsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
