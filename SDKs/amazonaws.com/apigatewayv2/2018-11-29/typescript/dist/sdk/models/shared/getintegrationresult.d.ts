 ...
 */
export declare enum GetIntegrationResultConnectionTypeEnum {
    Internet = "INTERNET",
    VpcLink = "VPC_LINK"
}
/**
 ...
 */
export declare enum GetIntegrationResultContentHandlingStrategyEnum {
 ...
 */
export declare enum GetIntegrationResultIntegrationTypeEnum {
    Aws = "AWS",
    Http = "HTTP",
    Mock = "MOCK",
 ...
 */
export declare enum GetIntegrationResultPassthroughBehaviorEnum {
