...
class AppPermissionsActionsEnum(str, Enum):
    r"""The level of permission to grant the access token for GitHub Actions workflows, workflow runs, and artifacts."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsAdministrationEnum(str, Enum):
    r"""The level of permission to grant the access token for repository creation, deletion, settings, teams, and collaborators creation."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsChecksEnum(str, Enum):
    r"""The level of permission to grant the access token for checks on code."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsContentsEnum(str, Enum):
    r"""The level of permission to grant the access token for repository contents, commits, branches, downloads, releases, and merges."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsDeploymentsEnum(str, Enum):
    r"""The level of permission to grant the access token for deployments and deployment statuses."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsEnvironmentsEnum(str, Enum):
    r"""The level of permission to grant the access token for managing repository environments."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsIssuesEnum(str, Enum):
    r"""The level of permission to grant the access token for issues and related comments, assignees, labels, and milestones."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsMembersEnum(str, Enum):
    r"""The level of permission to grant the access token for organization teams and members."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsMetadataEnum(str, Enum):
    r"""The level of permission to grant the access token to search repositories, list collaborators, and access repository metadata."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationAdministrationEnum(str, Enum):
    r"""The level of permission to grant the access token to manage access to an organization."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationAnnouncementBannersEnum(str, Enum):
    r"""The level of permission to grant the access token to view and manage announcement banners for an organization."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationCustomRolesEnum(str, Enum):
    r"""The level of permission to grant the access token for custom repository roles management. This property is in beta and is subject to change."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationHooksEnum(str, Enum):
    r"""The level of permission to grant the access token to manage the post-receive hooks for an organization."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationPackagesEnum(str, Enum):
    r"""The level of permission to grant the access token for organization packages published to GitHub Packages."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationPlanEnum(str, Enum):
    r"""The level of permission to grant the access token for viewing an organization's plan."""
    READ = 'read'

class AppPermissionsOrganizationProjectsEnum(str, Enum):
    r"""The level of permission to grant the access token to manage organization projects and projects beta (where available)."""
    READ = 'read'
    WRITE = 'write'
    ADMIN = 'admin'

class AppPermissionsOrganizationSecretsEnum(str, Enum):
    r"""The level of permission to grant the access token to manage organization secrets."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationSelfHostedRunnersEnum(str, Enum):
    r"""The level of permission to grant the access token to view and manage GitHub Actions self-hosted runners available to an organization."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsOrganizationUserBlockingEnum(str, Enum):
    r"""The level of permission to grant the access token to view and manage users blocked by the organization."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsPackagesEnum(str, Enum):
    r"""The level of permission to grant the access token for packages published to GitHub Packages."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsPagesEnum(str, Enum):
    r"""The level of permission to grant the access token to retrieve Pages statuses, configuration, and builds, as well as create new builds."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsPullRequestsEnum(str, Enum):
    r"""The level of permission to grant the access token for pull requests and related comments, assignees, labels, milestones, and merges."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsRepositoryAnnouncementBannersEnum(str, Enum):
    r"""The level of permission to grant the access token to view and manage announcement banners for a repository."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsRepositoryHooksEnum(str, Enum):
    r"""The level of permission to grant the access token to manage the post-receive hooks for a repository."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsRepositoryProjectsEnum(str, Enum):
    r"""The level of permission to grant the access token to manage repository projects, columns, and cards."""
    READ = 'read'
    WRITE = 'write'
    ADMIN = 'admin'

class AppPermissionsSecretScanningAlertsEnum(str, Enum):
    r"""The level of permission to grant the access token to view and manage secret scanning alerts."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsSecretsEnum(str, Enum):
    r"""The level of permission to grant the access token to manage repository secrets."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsSecurityEventsEnum(str, Enum):
    r"""The level of permission to grant the access token to view and manage security events like code scanning alerts."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsSingleFileEnum(str, Enum):
    r"""The level of permission to grant the access token to manage just a single file."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsStatusesEnum(str, Enum):
    r"""The level of permission to grant the access token for commit statuses."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsTeamDiscussionsEnum(str, Enum):
    r"""The level of permission to grant the access token to manage team discussions and related comments."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsVulnerabilityAlertsEnum(str, Enum):
    r"""The level of permission to grant the access token to manage Dependabot alerts."""
    READ = 'read'
    WRITE = 'write'

class AppPermissionsWorkflowsEnum(str, Enum):
    r"""The level of permission to grant the access token to update GitHub Actions workflow files."""
    WRITE = 'write'
...
class AppPermissions:
    ...
    r"""The level of permission to grant the access token to manage access to an organization."""  
    organization_announcement_banners: Optional[AppPermissionsOrganizationAnnouncementBannersEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('organization_announcement_banners'), 'exclude': lambda f: f is None }})
    r"""The level of permission to grant the access token to view and manage announcement banners for an organization."""  
    organization_custom_roles: Optional[AppPermissionsOrganizationCustomRolesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('organization_custom_roles'), 'exclude': lambda f: f is None }})
    r"""The level of permission to grant the access token for custom repository roles management. This property is in beta and is subject to change."""  
    ...
    r"""The level of permission to grant the access token for pull requests and related comments, assignees, labels, milestones, and merges."""  
    repository_announcement_banners: Optional[AppPermissionsRepositoryAnnouncementBannersEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('repository_announcement_banners'), 'exclude': lambda f: f is None }})
    r"""The level of permission to grant the access token to view and manage announcement banners for a repository."""  
