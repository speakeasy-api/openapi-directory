...
public class UpdateRouteRequest {
    ...
    public UpdateRouteRequest(@JsonProperty("RequestBody") UpdateRouteRequestBody requestBody, @JsonProperty("apiId") String apiId, @JsonProperty("routeId") String routeId) {
        this.requestBody = requestBody;
        this.apiId = apiId;
        this.routeId = routeId;
  }
