...
from ..shared import security as shared_security
from ..shared import googlecloudvisionv1p1beta1asyncbatchannotatefilesrequest as shared_googlecloudvisionv1p1beta1asyncbatchannotatefilesrequest
...
class VisionProjectsLocationsFilesAsyncBatchAnnotateRequest:
    ...
    request: Optional[shared_googlecloudvisionv1p1beta1asyncbatchannotatefilesrequest.GoogleCloudVisionV1p1beta1AsyncBatchAnnotateFilesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
