...
public class DeletePayCodeRevisionRequest {
    ...
    public DeletePayCodeRevisionRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EffectiveDate") LocalDate effectiveDate, @JsonProperty("EmployerId") String employerId, @JsonProperty("PayCodeId") String payCodeId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.effectiveDate = effectiveDate;
        this.employerId = employerId;
