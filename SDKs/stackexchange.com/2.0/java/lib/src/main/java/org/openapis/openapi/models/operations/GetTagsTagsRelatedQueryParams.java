...
public class GetTagsTagsRelatedQueryParams {
    /**
    ...
    public GetTagsTagsRelatedQueryParams withCallback(String callback) {
    ...
    public GetTagsTagsRelatedQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public Long page;
    public GetTagsTagsRelatedQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetTagsTagsRelatedQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetTagsTagsRelatedQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
