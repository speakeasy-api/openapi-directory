 ...
 */
export class GetCollectionsErrorSchema extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code: number;
...
export class GetCollectionsSchemaData extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class GetCollectionsSchema extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: GetCollectionsSchemaData })
  @Expose({ name: "data" })
  @Type(() => GetCollectionsSchemaData)
