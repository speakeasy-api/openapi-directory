...
class GetProjectAnalyses200ApplicationJSON:
    ...
    results: Optional[list[shared_analysis.Analysis]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
