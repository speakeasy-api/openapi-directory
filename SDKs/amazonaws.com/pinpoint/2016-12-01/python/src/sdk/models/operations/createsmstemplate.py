...
class CreateSmsTemplateRequestBody:
    ...
    sms_template_request: CreateSMSTemplateRequestBodySMSTemplateRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SMSTemplateRequest') }})
    r"""Specifies the content and settings for a message template that can be used in text messages that are sent through the SMS channel."""  
...
class CreateSmsTemplateRequest:
    ...
    request_body: CreateSmsTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
