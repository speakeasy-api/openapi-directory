 ...
 */
export class DescribeVpcEndpointServicePermissionsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVpcEndpointServicePermissionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  filters?: DescribeVpcEndpointServicePermissionsRequestFilters[];
