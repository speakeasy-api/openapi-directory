...
class DataformProjectsLocationsRepositoriesWorkspacesMoveFileRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\MoveFileRequest $moveFileRequest = null;
