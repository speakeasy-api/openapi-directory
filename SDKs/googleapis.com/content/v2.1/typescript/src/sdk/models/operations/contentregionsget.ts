...
export class ContentRegionsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentRegionsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentRegionsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
