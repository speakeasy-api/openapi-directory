...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum {
...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
