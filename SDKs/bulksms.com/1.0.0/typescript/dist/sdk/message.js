...
var Message = /** @class */ (function () {
     ...
     *
     */
    Message.prototype.getMessages = function (req, security, config) {
     ...
     *
     */
    Message.prototype.getMessagesSend = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetMessagesSendResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     */
    Message.prototype.getMessagesIdRelatedReceivedMessages = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetMessagesIdRelatedReceivedMessagesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/messages/{id}/relatedReceivedMessages", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetMessagesIdRelatedReceivedMessagesSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetMessagesIdRelatedReceivedMessagesResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     */
    Message.prototype.postMessages = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
