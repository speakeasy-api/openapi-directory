...
export declare enum GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum {
    Uniform = "uniform"
}
/**
 * Uniformly distributed random response delay.
 */
export declare class GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionUniform extends SpeakeasyBase {
    lower?: number;
    type?: GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum;
    upper?: number;
}
export declare enum GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum {
    Lognormal = "lognormal"
}
/**
 * Log normal randomly distributed response delay.
 */
export declare class GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionLogNormal extends SpeakeasyBase {
    median?: number;
    sigma?: number;
    type?: GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum;
}
/**
