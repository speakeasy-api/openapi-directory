...
var Analyse = /** @class */ (function () {
    function Analyse(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Analyse.prototype.interference = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.InterferenceRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/interference";
    ...
    **/
    Analyse.prototype.mesh = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MeshRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/mesh";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    Analyse.prototype.network = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.NetworkRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/network";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
