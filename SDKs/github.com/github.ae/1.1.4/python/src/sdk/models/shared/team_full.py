...
from ..shared import team_organization as shared_team_organization
...
class TeamFull:
    ...
    organization: shared_team_organization.TeamOrganization = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('organization') }})
    r"""Team Organization"""  
