...
class OnDemandPageUser
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserAccountEnum $account
     */
	#[\JMS\Serializer\Annotation\SerializedName('account')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserAccountEnum>')]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserContentFilterEnum $contentFilter
     */
	#[\JMS\Serializer\Annotation\SerializedName('content_filter')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserContentFilterEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageUserContentFilterEnum $contentFilter = null;
     ...
     * The user's metadata.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserMetadata $metadata
     */
	#[\JMS\Serializer\Annotation\SerializedName('metadata')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserMetadata')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserPreferences')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageUserPreferences $preferences = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserUploadQuota $uploadQuota
     */
	#[\JMS\Serializer\Annotation\SerializedName('upload_quota')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserUploadQuota')]
     ...
     * The user's websites.
     * 
     * @var array<\OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserWebsites> $websites
     */
	#[\JMS\Serializer\Annotation\SerializedName('websites')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserWebsites>')]
    public array $websites;
    
	public function __construct()
	{
		$this->account = \OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserAccountEnum::BASIC;
		$this->bio = "";
		...
		$this->link = "";
		$this->location = "";
		$this->metadata = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserMetadata();
		$this->name = "";
		$this->pictures = new \OpenAPI\OpenAPI\Models\Shared\Picture();
		$this->preferences = null;
		$this->resourceKey = "";
		$this->uploadQuota = new \OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserUploadQuota();
		$this->uri = "";
		$this->websites = [];
	}
}
