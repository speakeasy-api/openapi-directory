...
class PlayerDetail:
    ...
    latest_news: Optional[list[shared_news.News]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LatestNews'), 'exclude': lambda f: f is None }})  
    ...
    player_season: Optional[shared_playerseason.PlayerSeason] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PlayerSeason'), 'exclude': lambda f: f is None }})  
