...
class DataExtractsProviderAccountAggregationSourceEnum(str, Enum):
    SYSTEM = "SYSTEM"
    USER = "USER"

class DataExtractsProviderAccountOauthMigrationStatusEnum(str, Enum):
    IN_PROGRESS = "IN_PROGRESS"
    TO_BE_MIGRATED = "TO_BE_MIGRATED"
    COMPLETED = "COMPLETED"

class DataExtractsProviderAccountStatusEnum(str, Enum):
...
class DataExtractsProviderAccount:
    aggregation_source: Optional[DataExtractsProviderAccountAggregationSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('aggregationSource') }})
    ...
    oauth_migration_status: Optional[DataExtractsProviderAccountOauthMigrationStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('oauthMigrationStatus') }})
    ...
    status: Optional[DataExtractsProviderAccountStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
