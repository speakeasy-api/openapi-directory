...
public class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsCreateRequest {
    ...
    public DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsCreateRequest withRequest(openapisdk.models.shared.GoogleCloudDiscoveryengineV1betaDocument request) {
