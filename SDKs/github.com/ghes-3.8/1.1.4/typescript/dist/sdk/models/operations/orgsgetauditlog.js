...
exports.OrgsGetAuditLogResponse = exports.OrgsGetAuditLogRequest = void 0;
...
var OrgsGetAuditLogRequest = /** @class */ (function (_super) {
    ...
    ], OrgsGetAuditLogRequest.prototype, "after", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=before",
        }),
        __metadata("design:type", String)
    ], OrgsGetAuditLogRequest.prototype, "before", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=include",
        }),
        __metadata("design:type", String)
    ], OrgsGetAuditLogRequest.prototype, "include", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=order" }),
        __metadata("design:type", String)
    ], OrgsGetAuditLogRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=org" }),
        __metadata("design:type", String)
    ], OrgsGetAuditLogRequest.prototype, "org", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], OrgsGetAuditLogRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], OrgsGetAuditLogRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=phrase",
        }),
        __metadata("design:type", String)
    ], OrgsGetAuditLogRequest.prototype, "phrase", void 0);
...
var OrgsGetAuditLogResponse = /** @class */ (function (_super) {
    ...
    ], OrgsGetAuditLogResponse.prototype, "rawResponse", void 0);
    __decorate([
