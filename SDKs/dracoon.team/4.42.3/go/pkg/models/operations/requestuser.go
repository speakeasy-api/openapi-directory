...
func (e RequestUserXSdsDateFormatEnum) ToPointer() *RequestUserXSdsDateFormatEnum {
	return &e
}
...
func (e *RequestUserXSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = RequestUserXSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestUserXSdsDateFormatEnum: %v", v)
	}
}
