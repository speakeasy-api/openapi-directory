...
var Categories = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "MatchedCategories" }),
        __metadata("design:type", Array)
    ], Categories.prototype, "matchedCategories", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: categorydetails_1.CategoryDetails }),
        (0, class_transformer_1.Expose)({ name: "MatchedDetails" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], categorydetails_1.CategoryDetails);
            }
            return obj;
        }, { toClassOnly: true }),
