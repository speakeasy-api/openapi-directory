...
class ListWirelessSimListWirelessSimResponse:
    ...
    meta: Optional[ListWirelessSimListWirelessSimResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    sims: Optional[list[shared_preview_wireless_sim.PreviewWirelessSim]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sims'), 'exclude': lambda f: f is None }})  
