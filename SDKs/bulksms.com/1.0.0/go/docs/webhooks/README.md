...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Webhooks.GetWebhooks(ctx, operations.GetWebhooksSecurity{
        Password: "YOUR_PASSWORD_HERE",
        Username: "YOUR_USERNAME_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Webhooks.PostWebhooks(ctx, shared.WebhookEntry{
        Active: sdk.Bool(true),
        ContactEmailAddress: sdk.String("tech_team@example.com"),
        InvokeOption: shared.WebhookEntryInvokeOptionEnumMany.ToPointer(),
        Name: "My MT Webhook",
        OnWebApp: sdk.Bool(true),
        TriggerScope: shared.WebhookEntryTriggerScopeEnumSent,
        URL: "https://www.example.com",
    }, operations.PostWebhooksSecurity{
        Password: "YOUR_PASSWORD_HERE",
        Username: "YOUR_USERNAME_HERE",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Webhooks.PostWebhooksID(ctx, operations.PostWebhooksIDRequest{
