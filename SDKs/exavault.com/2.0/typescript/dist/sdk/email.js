...
var Email = /** @class */ (function () {
    ...
    Email.prototype.sendReferralEmail = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.SendReferralEmailResponse({
    ...
    Email.prototype.sendWelcomeEmail = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/email/welcome/{username}", req);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.SendWelcomeEmailResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
