...
var Schedules = /** @class */ (function () {
    function Schedules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Schedules.prototype.getNetworkCameraSchedules = function (req, config) {
    ...
    **/
    Schedules.prototype.getNetworkWirelessSsidSchedules = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Schedules.prototype.updateNetworkWirelessSsidSchedules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
