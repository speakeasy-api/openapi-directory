...
exports.ListAlertResponse = exports.ListAlertListAlertResponse = exports.ListAlertListAlertResponseMeta = exports.ListAlertRequest = exports.ListAlertSecurity = exports.ListAlertServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListAlertServerList = ["https://monitor.twilio.com"];
var ListAlertSecurity = /** @class */ (function (_super) {
    ...
    ], ListAlertSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListAlertSecurity.prototype, "username", void 0);
...
var ListAlertRequest = /** @class */ (function (_super) {
    ...
    ], ListAlertRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=LogLevel",
        }),
        __metadata("design:type", String)
    ], ListAlertRequest.prototype, "logLevel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListAlertRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListAlertRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListAlertRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListAlertRequest.prototype, "startDate", void 0);
...
var ListAlertListAlertResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.MonitorV1Alert }),
        (0, class_transformer_1.Expose)({ name: "alerts" }),
        (0, class_transformer_1.Type)(function () { return shared.MonitorV1Alert; }),
        __metadata("design:type", Array)
    ], ListAlertListAlertResponse.prototype, "alerts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListAlertListAlertResponseMeta; }),
...
var ListAlertResponse = /** @class */ (function (_super) {
    ...
    ], ListAlertResponse.prototype, "rawResponse", void 0);
