...
func (e PutRegistryPolicyXAmzTargetEnum) ToPointer() *PutRegistryPolicyXAmzTargetEnum {
	return &e
}
...
func (e *PutRegistryPolicyXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonEC2ContainerRegistry_V20150921.PutRegistryPolicy":
		*e = PutRegistryPolicyXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PutRegistryPolicyXAmzTargetEnum: %v", v)
	}
}
