...
export class PreprintsContributorsListRequest extends SpeakeasyBase {
  /**
 ...
 */
export enum PreprintsContributorsListContributorAttributesPermissionEnum {
  Read = "read",
  Write = "write",
  Admin = "admin",
}
 ...
 */
export class PreprintsContributorsListContributorAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class PreprintsContributorsListContributorLinks extends SpeakeasyBase {
  /**
 ...
 */
export class PreprintsContributorsListContributorRelationships extends SpeakeasyBase {
  /**
...
export class PreprintsContributorsListContributor extends SpeakeasyBase {
  /**
   * The properties of the contributor entity.
   */
  @SpeakeasyMetadata()
...
export class PreprintsContributorsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
