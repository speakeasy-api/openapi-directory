...
exports.DriveDrivesHideResponse = exports.DriveDrivesHideRequest = exports.DriveDrivesHideSecurity = void 0;
...
exports.DriveDrivesHideSecurity = DriveDrivesHideSecurity;
var DriveDrivesHideRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DriveDrivesHideRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=driveId",
        }),
        __metadata("design:type", String)
    ], DriveDrivesHideRequest.prototype, "driveId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DriveDrivesHideRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DriveDrivesHideRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DriveDrivesHideRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DriveDrivesHideRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DriveDrivesHideRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DriveDrivesHideRequest.prototype, "userIp", void 0);
    return DriveDrivesHideRequest;
}(utils_1.SpeakeasyBase));
exports.DriveDrivesHideRequest = DriveDrivesHideRequest;
var DriveDrivesHideResponse = /** @class */ (function (_super) {
    ...
    ], DriveDrivesHideResponse.prototype, "rawResponse", void 0);
    return DriveDrivesHideResponse;
}(utils_1.SpeakeasyBase));
exports.DriveDrivesHideResponse = DriveDrivesHideResponse;
