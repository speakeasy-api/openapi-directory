 ...
 */
export class CreateStreamingDistributionWithTags20171030RequestBodyStreamingDistributionConfigWithTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateStreamingDistributionWithTags20171030RequestBody extends SpeakeasyBase {
  /**
   * A streaming distribution Configuration and a list of tags to be associated with the streaming distribution.
   */
  @SpeakeasyMetadata()
...
export enum CreateStreamingDistributionWithTags20171030WithTagsEnum {
  True = "true",
}
