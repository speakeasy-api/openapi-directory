...
export class RouteTypes {
  ...
  routeTypesGetRouteTypes(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.RouteTypesGetRouteTypesResponse =
        new operations.RouteTypesGetRouteTypesResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.v3RouteTypesResponse = utils.objectToClass(
              httpRes?.data,
              shared.V3RouteTypesResponse
            );
          }
