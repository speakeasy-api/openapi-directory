...
class Locationsv1GetV1LocationsGetOrderByLocationsOrderEnum(str, Enum):
    r"""An enumeration."""
    CITY = 'city'
    COUNTRY = 'country'
    LOCATION = 'location'
...
class Locationsv1GetV1LocationsGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class Locationsv1GetV1LocationsGetRequest:
    ...
    order_by: Optional[Locationsv1GetV1LocationsGetOrderByLocationsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""Order by a field"""  
    ...
    r"""Type of Sensor"""  
    sort: Optional[Locationsv1GetV1LocationsGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Sort Direction"""  
