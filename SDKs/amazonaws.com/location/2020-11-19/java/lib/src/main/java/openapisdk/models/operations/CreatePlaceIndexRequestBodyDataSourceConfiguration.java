...
**/
public class CreatePlaceIndexRequestBodyDataSourceConfiguration {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("IntendedUse")
    public openapisdk.models.shared.IntendedUseEnum intendedUse;
    public CreatePlaceIndexRequestBodyDataSourceConfiguration withIntendedUse(openapisdk.models.shared.IntendedUseEnum intendedUse) {
