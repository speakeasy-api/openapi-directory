...
func main() {
    ...
    res, err := s.PaymentDispute.AcceptPaymentDispute(ctx, operations.AcceptPaymentDisputeRequest{
        AcceptPaymentDisputeRequest: &shared.AcceptPaymentDisputeRequest{
            ReturnAddress: &shared.ReturnAddress{
                ...
                City: sdk.String("Belleville"),
                Country: sdk.String("Greenland"),
                County: sdk.String("veritatis"),
                FullName: sdk.String("deserunt"),
                PostalCode: sdk.String("38971"),
                PrimaryPhone: &shared.Phone{
                    CountryCode: sdk.String("TG"),
                    Number: sdk.String("at"),
                },
                StateOrProvince: sdk.String("maiores"),
            },
            Revision: sdk.Int(473608),
        },
        PaymentDisputeID: "quod",
    }, operations.AcceptPaymentDisputeSecurity{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.AddEvidence(ctx, operations.AddEvidenceRequest{
        AddEvidencePaymentDisputeRequest: &shared.AddEvidencePaymentDisputeRequest{
            EvidenceType: sdk.String("quod"),
            Files: []shared.FileEvidence{
                shared.FileEvidence{
                    FileID: sdk.String("totam"),
                },
                shared.FileEvidence{
                    FileID: sdk.String("porro"),
                },
            },
            LineItems: []shared.OrderLineItems{
                shared.OrderLineItems{
                    ItemID: sdk.String("dicta"),
                    LineItemID: sdk.String("nam"),
                },
                shared.OrderLineItems{
                    ItemID: sdk.String("officia"),
        ...
        PaymentDisputeID: "hic",
    }, operations.AddEvidenceSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
    ...
    if res.AddEvidencePaymentDisputeResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.ContestPaymentDispute(ctx, operations.ContestPaymentDisputeRequest{
        ContestPaymentDisputeRequest: &shared.ContestPaymentDisputeRequest{
            Note: sdk.String("optio"),
            ReturnAddress: &shared.ReturnAddress{
                AddressLine1: sdk.String("totam"),
                AddressLine2: sdk.String("beatae"),
                City: sdk.String("Jarenboro"),
                Country: sdk.String("Cocos (Keeling) Islands"),
                County: sdk.String("impedit"),
                FullName: sdk.String("cum"),
                PostalCode: sdk.String("25103"),
                PrimaryPhone: &shared.Phone{
            ...
            Revision: sdk.Int(222321),
        },
        PaymentDisputeID: "natus",
    }, operations.ContestPaymentDisputeSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.FetchEvidenceContent(ctx, operations.FetchEvidenceContentRequest{
        EvidenceID: "laboriosam",
        FileID: "hic",
        PaymentDisputeID: "saepe",
    }, operations.FetchEvidenceContentSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.GetActivities(ctx, operations.GetActivitiesRequest{
        PaymentDisputeID: "fuga",
    }, operations.GetActivitiesSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
    ...
    if res.PaymentDisputeActivityHistory != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.GetPaymentDispute(ctx, operations.GetPaymentDisputeRequest{
        PaymentDisputeID: "in",
    }, operations.GetPaymentDisputeSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.GetPaymentDisputeSummaries(ctx, operations.GetPaymentDisputeSummariesRequest{
        BuyerUsername: sdk.String("corporis"),
        Limit: sdk.String("iste"),
        Offset: sdk.String("iure"),
        OpenDateFrom: sdk.String("saepe"),
        OpenDateTo: sdk.String("quidem"),
        OrderID: sdk.String("architecto"),
        PaymentDisputeStatus: sdk.String("ipsa"),
    }, operations.GetPaymentDisputeSummariesSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
    ...
    if res.DisputeSummaryResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.UpdateEvidence(ctx, operations.UpdateEvidenceRequest{
        UpdateEvidencePaymentDisputeRequest: &shared.UpdateEvidencePaymentDisputeRequest{
            EvidenceID: sdk.String("reiciendis"),
            EvidenceType: sdk.String("est"),
            Files: []shared.FileEvidence{
                shared.FileEvidence{
                    FileID: sdk.String("laborum"),
                },
                shared.FileEvidence{
                    FileID: sdk.String("dolores"),
                },
                shared.FileEvidence{
                    FileID: sdk.String("dolorem"),
                },
            },
            LineItems: []shared.OrderLineItems{
                shared.OrderLineItems{
                    ItemID: sdk.String("explicabo"),
                    LineItemID: sdk.String("nobis"),
                },
                shared.OrderLineItems{
                    ItemID: sdk.String("enim"),
                    LineItemID: sdk.String("omnis"),
                },
            },
        },
        PaymentDisputeID: "nemo",
    }, operations.UpdateEvidenceSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.PaymentDispute.UploadEvidenceFile(ctx, operations.UploadEvidenceFileRequest{
        PaymentDisputeID: "minima",
    }, operations.UploadEvidenceFileSecurity{
        APIAuth: "Bearer YOUR_ACCESS_TOKEN_HERE",
    })
    if err != nil {
        log.Fatal(err)
