...
exports.SchoolAdmins = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SchoolAdmins = /** @class */ (function () {
    function SchoolAdmins(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SchoolAdmins.prototype.getSchoolAdmin = function (req, config) {
    ...
    **/
    SchoolAdmins.prototype.getSchoolAdmins = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SchoolAdmins.prototype.getSchoolsForSchoolAdmin = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.SchoolAdmins = SchoolAdmins;
