...
export enum NodesAddonsListAddonAttributesCategoriesEnum {
 ...
 */
export class NodesAddonsListAddonAttributes extends SpeakeasyBase {
  /**
...
export class NodesAddonsListAddon extends SpeakeasyBase {
  /**
   * The properties of the addon entity.
   */
  @SpeakeasyMetadata()
