...
class MigrationcenterProjectsLocationsAssetsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MigrationcenterProjectsLocationsAssetsListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?MigrationcenterProjectsLocationsAssetsListViewEnum $view = null;
