...
func (e GetSpacesSpaceIDFoldersIDCustomer200ApplicationJSONLevelEnum) ToPointer() *GetSpacesSpaceIDFoldersIDCustomer200ApplicationJSONLevelEnum {
	return &e
}
...
func (e *GetSpacesSpaceIDFoldersIDCustomer200ApplicationJSONLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "regular":
		fallthrough
	case "public":
		*e = GetSpacesSpaceIDFoldersIDCustomer200ApplicationJSONLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSpacesSpaceIDFoldersIDCustomer200ApplicationJSONLevelEnum: %v", v)
	}
}
