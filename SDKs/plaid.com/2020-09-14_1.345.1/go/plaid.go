...
func (s *plaid) TransferConfigurationGet(ctx context.Context, request shared.TransferConfigurationGetRequest) (*operations.TransferConfigurationGetResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/transfer/configuration/get"
	...
	res := &operations.TransferConfigurationGetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.TransferConfigurationGetResponse = out
		}
	default:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
...
func (s *plaid) TransferMetricsGet(ctx context.Context, request shared.TransferMetricsGetRequest) (*operations.TransferMetricsGetResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/transfer/metrics/get"
	...
	res := &operations.TransferMetricsGetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.TransferMetricsGetResponse = out
		}
	default:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
