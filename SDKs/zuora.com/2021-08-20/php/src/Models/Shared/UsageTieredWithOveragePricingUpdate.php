...
class UsageTieredWithOveragePricingUpdate
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\UsageTieredWithOveragePricingUpdatePriceChangeOptionEnum $priceChangeOption
     */
	#[\JMS\Serializer\Annotation\SerializedName('priceChangeOption')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UsageTieredWithOveragePricingUpdatePriceChangeOptionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UsageTieredWithOveragePricingUpdatePriceChangeOptionEnum $priceChangeOption = null;
