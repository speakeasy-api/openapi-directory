 ...
 */
export enum ListAccountPermissionsRequestBodyServiceEnum {
  Ec2 = "EC2",
  Ecr = "ECR",
  Lambda = "LAMBDA",
}

export class ListAccountPermissionsRequestBody extends SpeakeasyBase {
  /**
...
export class ListAccountPermissionsRequest extends SpeakeasyBase {
