...
type AssociateOriginationIdentityHeaders struct {
...
type AssociateOriginationIdentityRequest struct {
	Headers AssociateOriginationIdentityHeaders
	Request shared.AssociateOriginationIdentityRequest `request:"mediaType=application/json"`
}
