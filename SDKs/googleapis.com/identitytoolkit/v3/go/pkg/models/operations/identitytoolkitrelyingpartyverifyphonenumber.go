...
type IdentitytoolkitRelyingpartyVerifyPhoneNumberSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IdentitytoolkitRelyingpartyVerifyPhoneNumberQueryParams struct {
...
type IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest struct {
	...
	Request     *shared.IdentitytoolkitRelyingpartyVerifyPhoneNumberRequest `request:"mediaType=application/json"`
