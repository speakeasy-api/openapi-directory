...
from ..shared import createmodifierresponse as shared_createmodifierresponse
...
class ModifiersAddRequest:
    headers: ModifiersAddHeaders = dataclasses.field()
    query_params: ModifiersAddQueryParams = dataclasses.field()
    request: shared_modifier.ModifierInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ModifiersAddSecurity = dataclasses.field()
...
class ModifiersAddResponse:
    ...
    create_modifier_response: Optional[shared_createmodifierresponse.CreateModifierResponse] = dataclasses.field(default=None)
