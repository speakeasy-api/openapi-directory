...
type SearchBioDicomTestQueryParams struct {
	...
	// Patient ID
	SearchBioDicomTestPatientID *string `queryParam:"style=form,explode=true,name=search.bio_dicom_test.PatientID"`
	// Patient Name
	SearchBioDicomTestPatientName *string `queryParam:"style=form,explode=true,name=search.bio_dicom_test.PatientName"`
	// Number to skip
...
type SearchBioDicomTestRequest struct {
	QueryParams SearchBioDicomTestQueryParams
}

type SearchBioDicomTestResponse struct {
	ContentType string
	StatusCode  int
