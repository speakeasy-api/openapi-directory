...
public class ItemApplicationScopesUpdateRequest {
    ...
    public ItemApplicationScopesUpdateRequest(@JsonProperty("access_token") String accessToken, @JsonProperty("application_id") String applicationId, @JsonProperty("context") ScopesContextEnum context, @JsonProperty("scopes") Scopes scopes) {
        this.accessToken = accessToken;
        this.applicationId = applicationId;
        this.context = context;
        this.scopes = scopes;
