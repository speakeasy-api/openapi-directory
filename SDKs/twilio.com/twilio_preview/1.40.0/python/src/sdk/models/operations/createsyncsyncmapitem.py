...
class CreateSyncSyncMapItemRequest:
    ...
    request_body: Optional[CreateSyncSyncMapItemCreateSyncSyncMapItemRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
