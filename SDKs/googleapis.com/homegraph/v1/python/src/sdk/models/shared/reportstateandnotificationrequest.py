...
class ReportStateAndNotificationRequest:
    ...
    follow_up_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('followUpToken') }})
    payload: Optional[shared_stateandnotificationpayload.StateAndNotificationPayload] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('payload') }})
