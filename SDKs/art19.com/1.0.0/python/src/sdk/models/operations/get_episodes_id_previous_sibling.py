...
class GetEpisodesIDPreviousSiblingSecurity:
...
class GetEpisodesIDPreviousSiblingRequest:
    ...
    r"""The ID of the episode to find the one episode released right before it."""  
    rss: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'rss', 'style': 'form', 'explode': True }})
    r"""If `true`, get the previously released and published episode with an available media file."""  
