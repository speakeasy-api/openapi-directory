...
class SDK:
    ...
    def batch_disassociate_client_device_from_core_device(self, request: operations.BatchDisassociateClientDeviceFromCoreDeviceRequest) -> operations.BatchDisassociateClientDeviceFromCoreDeviceResponse:
        r"""Disassociate a list of client devices from a core device. After you disassociate a client device from a core device, the client device won't be able to use cloud discovery to retrieve the core device's connectivity information and certificates.
        """
    ...
    def get_component(self, request: operations.GetComponentRequest) -> operations.GetComponentResponse:
        r"""Gets the recipe for a version of a component. Core devices can call this operation to identify the artifacts and requirements to install a component.
        """
    ...
    def get_component_version_artifact(self, request: operations.GetComponentVersionArtifactRequest) -> operations.GetComponentVersionArtifactResponse:
        r"""Gets the pre-signed URL to download a public component artifact. Core devices call this operation to identify the URL that they can use to download an artifact to install.
        """
    ...
    def get_core_device(self, request: operations.GetCoreDeviceRequest) -> operations.GetCoreDeviceResponse:
        r"""Retrieves metadata for a Greengrass core device.
        """
    ...
    def list_core_devices(self, request: operations.ListCoreDevicesRequest) -> operations.ListCoreDevicesResponse:
        r"""Retrieves a paginated list of Greengrass core devices.
        """
    ...
    def list_installed_components(self, request: operations.ListInstalledComponentsRequest) -> operations.ListInstalledComponentsResponse:
        r"""Retrieves a paginated list of the components that a Greengrass core device runs.
        """
