...
class CreateSigningBasketRequest:
    ...
    * DELETE
    ...
    signing_basket: Optional[shared_signingbasket.SigningBasket] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""Request body for a confirmation of an establishing signing basket request."""  
