...
class ResponsePolicies 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v2/projects/{project}/locations/{location}/responsePolicies', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v2/projects/{project}/locations/{location}/responsePolicies', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}', \OpenAPI\OpenAPI\Models\Operations\DnsResponsePoliciesUpdateRequest::class, $request);
