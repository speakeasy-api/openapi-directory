...
from ..shared import getleadresponse as shared_getleadresponse
...
class LeadsOneResponse:
    ...
    r"""Bad Request"""  
    get_lead_response: Optional[shared_getleadresponse.GetLeadResponse] = dataclasses.field(default=None)
    r"""Lead"""  
