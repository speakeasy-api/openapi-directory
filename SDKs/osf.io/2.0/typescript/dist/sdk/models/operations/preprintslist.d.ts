 ...
 */
export declare class PreprintsListPreprintAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class PreprintsListPreprintLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class PreprintsListPreprintRelationships extends SpeakeasyBase {
    /**
...
export declare class PreprintsListPreprint extends SpeakeasyBase {
    /**
     * The properties of the preprint entity.
     */
    attributes?: PreprintsListPreprintAttributes;
    /**
     ...
     * URLs to alternative representations of the preprint entity.
     */
    links?: PreprintsListPreprintLinks;
    /**
     * URLs to other entities or entity collections that have a relationship to the preprint entity.
     */
    relationships: PreprintsListPreprintRelationships;
    /**
     * The type identifier of the preprint entity (`preprints`).
     */
    type: string;
}
export declare class PreprintsListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
