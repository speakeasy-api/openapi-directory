...
export class Accounts {
  ...
  admobAccountsAdSourcesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AdmobAccountsAdSourcesListResponse =
        new operations.AdmobAccountsAdSourcesListResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listAdSourcesResponse = utils.objectToClass(
              httpRes?.data,
              shared.ListAdSourcesResponse
            );
          }
          break;
      }
