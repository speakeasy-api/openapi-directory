...
class OmInvoiceAPISettings:
    ...
    def get_order_invoice_design_settings(self) -> operations.GetOrderInvoiceDesignSettingsResponse:
        ...
        res = operations.GetOrderInvoiceDesignSettingsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.OrderInvoiceDesignSettings])
    ...
    def get_order_invoice_design_settings_preview(self, request: operations.GetOrderInvoiceDesignSettingsPreviewRequest) -> operations.GetOrderInvoiceDesignSettingsPreviewResponse:
        ...
        res = operations.GetOrderInvoiceDesignSettingsPreviewResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetOrderInvoiceDesignPreviewResponse])
    ...
    def get_order_invoice_general_settings(self) -> operations.GetOrderInvoiceGeneralSettingsResponse:
        ...
        res = operations.GetOrderInvoiceGeneralSettingsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetOrderInvoiceGeneralSettingsResponse])
    ...
    def save_order_invoice_design_settings(self, request: operations.SaveOrderInvoiceDesignSettingsRequest) -> operations.SaveOrderInvoiceDesignSettingsResponse:
        ...
        res = operations.SaveOrderInvoiceDesignSettingsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def save_order_invoice_general_settings(self, request: operations.SaveOrderInvoiceGeneralSettingsRequest) -> operations.SaveOrderInvoiceGeneralSettingsResponse:
        ...
        res = operations.SaveOrderInvoiceGeneralSettingsResponse(status_code=r.status_code, content_type=content_type)
