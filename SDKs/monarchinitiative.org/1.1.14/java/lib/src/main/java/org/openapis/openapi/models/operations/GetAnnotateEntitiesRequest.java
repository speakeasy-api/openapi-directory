...
public class GetAnnotateEntitiesRequest {
    ...
    public GetAnnotateEntitiesRequest withContent(String content) {
    ...
    public GetAnnotateEntitiesRequest withExcludeCategory(String[] excludeCategory) {
    ...
    public GetAnnotateEntitiesRequest withIncludeAbbreviation(Boolean includeAbbreviation) {
    ...
    public GetAnnotateEntitiesRequest withIncludeAcronym(Boolean includeAcronym) {
    ...
    public GetAnnotateEntitiesRequest withIncludeCategory(String[] includeCategory) {
    ...
    public GetAnnotateEntitiesRequest withIncludeNumbers(Boolean includeNumbers) {
    ...
    public GetAnnotateEntitiesRequest withLongestOnly(Boolean longestOnly) {
    ...
    public GetAnnotateEntitiesRequest withMinLength(String minLength) {
        this.minLength = minLength;
        return this;
    }
    
    public GetAnnotateEntitiesRequest(){}
}
