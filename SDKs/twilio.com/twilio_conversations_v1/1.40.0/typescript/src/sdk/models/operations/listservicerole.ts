...
export class ListServiceRoleListServiceRoleResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListServiceRoleListServiceRoleResponseMeta)
  meta?: ListServiceRoleListServiceRoleResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.ConversationsV1ServiceServiceRole })
  @Expose({ name: "roles" })
  @Type(() => shared.ConversationsV1ServiceServiceRole)
