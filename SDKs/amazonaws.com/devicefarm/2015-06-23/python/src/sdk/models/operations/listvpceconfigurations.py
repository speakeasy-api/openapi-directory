...
class ListVPCEConfigurationsRequest:
    ...
    list_vpce_configurations_request: shared_listvpceconfigurationsrequest.ListVPCEConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
