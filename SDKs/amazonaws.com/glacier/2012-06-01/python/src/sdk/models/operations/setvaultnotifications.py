...
class SetVaultNotificationsRequestBody:
    vault_notification_config: Optional[SetVaultNotificationsRequestBodyVaultNotificationConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('vaultNotificationConfig') }})
    

@dataclasses.dataclass
class SetVaultNotificationsRequest:
    headers: SetVaultNotificationsHeaders = dataclasses.field()
    path_params: SetVaultNotificationsPathParams = dataclasses.field()
    request: SetVaultNotificationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
