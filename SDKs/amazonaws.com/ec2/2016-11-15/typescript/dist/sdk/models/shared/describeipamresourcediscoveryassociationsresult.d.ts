 ...
 */
export declare enum DescribeIpamResourceDiscoveryAssociationsResultIpamResourceDiscoveryAssociationsResourceDiscoveryStatusEnum {
    Active = "active",
    NotFound = "not-found"
}
/**
 ...
 */
export declare enum DescribeIpamResourceDiscoveryAssociationsResultIpamResourceDiscoveryAssociationsStateEnum {
 ...
 * Describes a tag.
 */
export declare class DescribeIpamResourceDiscoveryAssociationsResultIpamResourceDiscoveryAssociationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class DescribeIpamResourceDiscoveryAssociationsResultIpamResourceDiscoveryAssociations extends SpeakeasyBase {
    ipamArn?: string;
    ipamId?: string;
    ipamRegion?: string;
 ...
 * Success
 */
export declare class DescribeIpamResourceDiscoveryAssociationsResult extends SpeakeasyBase {
