 ...
 */
export declare enum GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum {
 ...
 */
export declare class GoogleCloudDialogflowV2beta1SessionEntityType extends SpeakeasyBase {
    /**
