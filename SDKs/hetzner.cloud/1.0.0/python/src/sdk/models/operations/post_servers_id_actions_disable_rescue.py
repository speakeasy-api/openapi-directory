...
class PostServersIDActionsDisableRescueActionResponseAction:
    ...
    error: PostServersIDActionsDisableRescueActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostServersIDActionsDisableRescueActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostServersIDActionsDisableRescueActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostServersIDActionsDisableRescueActionResponse:
    ...
    action: PostServersIDActionsDisableRescueActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
