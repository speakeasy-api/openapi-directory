...
from ..shared import proxycreatetaxationitem as shared_proxycreatetaxationitem
...
class ObjectPOSTTaxationItemRequest:
    ...
    proxy_create_taxation_item: shared_proxycreatetaxationitem.ProxyCreateTaxationItem = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
