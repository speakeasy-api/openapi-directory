...
class LocationsUpdateRequest:
    headers: LocationsUpdateHeaders = dataclasses.field()
    path_params: LocationsUpdatePathParams = dataclasses.field()
    query_params: LocationsUpdateQueryParams = dataclasses.field()
    request: shared_location.LocationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: LocationsUpdateSecurity = dataclasses.field()
