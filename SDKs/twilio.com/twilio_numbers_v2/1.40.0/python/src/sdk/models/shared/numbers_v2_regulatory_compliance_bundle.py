...
class NumbersV2RegulatoryComplianceBundle:
    ...
    r"""The URLs of the Assigned Items of the Bundle resource."""  
    ...
    status: Optional[shared_bundle_enum_status_enum.BundleEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
    ...
    r"""The absolute URL of the Bundle resource."""  
