...
class DeleteKubernetesNodePoolRequest:
    path_params: DeleteKubernetesNodePoolPathParams = dataclasses.field()
...
class DeleteKubernetesNodePoolResponse:
    ...
    delete_kubernetes_node_pool_401_application_json_object: Optional[DeleteKubernetesNodePool401ApplicationJSON] = dataclasses.field(default=None)
