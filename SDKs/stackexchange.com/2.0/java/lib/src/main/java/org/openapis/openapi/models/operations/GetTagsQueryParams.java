...
public class GetTagsQueryParams {
    ...
    public GetTagsQueryParams withCallback(String callback) {
    ...
    public GetTagsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetTagsQueryParams withFromdate(Long fromdate) {
    ...
    public GetTagsQueryParams withInname(String inname) {
        this.inname = inname;
        return this;
    }
    ...
    public String max;
    public GetTagsQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetTagsQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetTagsOrderEnum order;
    public GetTagsQueryParams withOrder(GetTagsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetTagsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public String site;
    public GetTagsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetTagsSortEnum sort;
    public GetTagsQueryParams withSort(GetTagsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetTagsQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
