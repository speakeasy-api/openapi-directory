...
public class RecognizeUtteranceHeaders {
    /**
    ...
    public RecognizeUtteranceHeaders withContentType(String contentType) {
    ...
    public RecognizeUtteranceHeaders withResponseContentType(String responseContentType) {
    ...
    public RecognizeUtteranceHeaders withXAmzAlgorithm(String xAmzAlgorithm) {
    ...
    public RecognizeUtteranceHeaders withXAmzContentSha256(String xAmzContentSha256) {
    ...
    public RecognizeUtteranceHeaders withXAmzCredential(String xAmzCredential) {
    ...
    public RecognizeUtteranceHeaders withXAmzDate(String xAmzDate) {
    ...
    public RecognizeUtteranceHeaders withXAmzSecurityToken(String xAmzSecurityToken) {
    ...
    public RecognizeUtteranceHeaders withXAmzSignature(String xAmzSignature) {
    ...
    public RecognizeUtteranceHeaders withXAmzSignedHeaders(String xAmzSignedHeaders) {
    ...
    public RecognizeUtteranceHeaders withXAmzLexRequestAttributes(String xAmzLexRequestAttributes) {
    ...
    public RecognizeUtteranceHeaders withXAmzLexSessionState(String xAmzLexSessionState) {
