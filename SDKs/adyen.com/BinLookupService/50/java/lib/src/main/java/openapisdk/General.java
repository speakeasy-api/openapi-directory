...
public class General {
    ...
    **/
    public openapisdk.models.operations.PostGet3dsAvailabilityResponse postGet3dsAvailability(openapisdk.models.operations.PostGet3dsAvailabilityRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/get3dsAvailability");
        ...
        openapisdk.models.operations.PostGet3dsAvailabilityResponse res = new openapisdk.models.operations.PostGet3dsAvailabilityResponse() {{
    ...
    **/
    public openapisdk.models.operations.PostGetCostEstimateResponse postGetCostEstimate(openapisdk.models.operations.PostGetCostEstimateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/getCostEstimate");
        ...
        openapisdk.models.operations.PostGetCostEstimateResponse res = new openapisdk.models.operations.PostGetCostEstimateResponse() {{
