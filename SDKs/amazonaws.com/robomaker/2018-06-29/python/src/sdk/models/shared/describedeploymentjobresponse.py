...
class DescribeDeploymentJobResponse:
    ...
    robot_deployment_summary: Optional[list[shared_robotdeployment.RobotDeployment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('robotDeploymentSummary'), 'exclude': lambda f: f is None }})  
