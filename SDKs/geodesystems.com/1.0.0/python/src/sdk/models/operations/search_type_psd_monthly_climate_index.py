...
class SearchTypePsdMonthlyClimateIndexQueryParams:
    ...
    search_type_psd_monthly_climate_index_units: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_psd_monthly_climate_index.units', 'style': 'form', 'explode': True }})
...
class SearchTypePsdMonthlyClimateIndexRequest:
    query_params: SearchTypePsdMonthlyClimateIndexQueryParams = dataclasses.field()
