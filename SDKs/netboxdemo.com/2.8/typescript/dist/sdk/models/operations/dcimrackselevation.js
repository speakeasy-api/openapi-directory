...
exports.DcimRacksElevationResponse = exports.DcimRacksElevationRequest = exports.DcimRacksElevationQueryParams = exports.DcimRacksElevationRenderEnum = exports.DcimRacksElevationFaceEnum = exports.DcimRacksElevationPathParams = void 0;
...
exports.DcimRacksElevationPathParams = DcimRacksElevationPathParams;
var DcimRacksElevationFaceEnum;
(function (DcimRacksElevationFaceEnum) {
    DcimRacksElevationFaceEnum["Front"] = "front";
    DcimRacksElevationFaceEnum["Rear"] = "rear";
})(DcimRacksElevationFaceEnum = exports.DcimRacksElevationFaceEnum || (exports.DcimRacksElevationFaceEnum = {}));
var DcimRacksElevationRenderEnum;
(function (DcimRacksElevationRenderEnum) {
    DcimRacksElevationRenderEnum["Json"] = "json";
    DcimRacksElevationRenderEnum["Svg"] = "svg";
})(DcimRacksElevationRenderEnum = exports.DcimRacksElevationRenderEnum || (exports.DcimRacksElevationRenderEnum = {}));
var DcimRacksElevationQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=expand_devices" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=include_images" }),
        __metadata("design:type", Boolean)
    ], DcimRacksElevationQueryParams.prototype, "includeImages", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=legend_width" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=render" }),
        __metadata("design:type", String)
    ], DcimRacksElevationQueryParams.prototype, "render", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=unit_height" }),
        __metadata("design:type", Number)
    ], DcimRacksElevationQueryParams.prototype, "unitHeight", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=unit_width" }),
        __metadata("design:type", Number)
    ], DcimRacksElevationQueryParams.prototype, "unitWidth", void 0);
    return DcimRacksElevationQueryParams;
}(utils_1.SpeakeasyBase));
exports.DcimRacksElevationQueryParams = DcimRacksElevationQueryParams;
...
exports.DcimRacksElevationRequest = DcimRacksElevationRequest;
var DcimRacksElevationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.RackUnit }),
...
exports.DcimRacksElevationResponse = DcimRacksElevationResponse;
