...
class UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequestBodyRules:
    ...
    policy: UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequestBodyRulesPolicyEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policy') }})
    r"""'allow' or 'deny' traffic specified by this rule"""  
    protocol: UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequestBodyRulesProtocolEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol') }})
    r"""The type of protocol (must be 'tcp', 'udp', 'icmp', 'icmp6' or 'any')"""  
...
class UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequestBody:
    ...
    rules: Optional[list[UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequestBodyRules]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules'), 'exclude': lambda f: f is None }})
...
class UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequest:
    ...
    request_body: Optional[UpdateNetworkWirelessSsidFirewallL3FirewallRulesRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
