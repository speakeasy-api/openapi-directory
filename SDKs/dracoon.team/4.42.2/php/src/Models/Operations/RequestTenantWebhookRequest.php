...
class RequestTenantWebhookRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestTenantWebhookXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestTenantWebhookXSdsDateFormatEnum $xSdsDateFormat = null;
