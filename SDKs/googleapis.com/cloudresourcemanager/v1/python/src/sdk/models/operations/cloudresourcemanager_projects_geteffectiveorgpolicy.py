...
class CloudresourcemanagerProjectsGetEffectiveOrgPolicyRequest:
    ...
    r"""The name of the resource to start computing the effective `Policy`."""  
    ...
    get_effective_org_policy_request: Optional[shared_geteffectiveorgpolicyrequest.GetEffectiveOrgPolicyRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
