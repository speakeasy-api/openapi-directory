...
class CreateConsentRequest:
    ...
    consents: Optional[shared_consents.Consents] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""Request body for a consents request."""  
