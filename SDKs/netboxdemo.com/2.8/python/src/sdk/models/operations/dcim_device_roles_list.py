...
class DcimDeviceRolesListQueryParams:
    ...
    color_ic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__ic', 'style': 'form', 'explode': True }})
    color_ie: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__ie', 'style': 'form', 'explode': True }})
    color_iew: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__iew', 'style': 'form', 'explode': True }})
    color_isw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__isw', 'style': 'form', 'explode': True }})
    color_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__n', 'style': 'form', 'explode': True }})
    color_nic: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__nic', 'style': 'form', 'explode': True }})
    color_nie: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__nie', 'style': 'form', 'explode': True }})
    color_niew: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__niew', 'style': 'form', 'explode': True }})
    color_nisw: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'color__nisw', 'style': 'form', 'explode': True }})
