...
var Namespaces = /** @class */ (function () {
    ...
    Namespaces.prototype.runNamespacesJobsCreate = function (req, security, config) {
        ...
        var url = utils.generateURL(baseURL, "/apis/run.googleapis.com/v1alpha1/{parent}/jobs", req);
    ...
    Namespaces.prototype.runNamespacesJobsDelete = function (req, security, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/apis/run.googleapis.com/v1alpha1/{name}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
     ...
     */
    Namespaces.prototype.runNamespacesJobsGet = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.RunNamespacesJobsGetResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
