 ...
 */
export enum NetworkListWarningCodeEnum {
...
export class NetworkListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class NetworkList extends SpeakeasyBase {
  /**
