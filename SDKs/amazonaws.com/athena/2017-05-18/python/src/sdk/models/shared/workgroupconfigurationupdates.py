...
class WorkGroupConfigurationUpdates:
    ...
    remove_bytes_scanned_cutoff_per_query: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RemoveBytesScannedCutoffPerQuery') }})
    ...
    result_configuration_updates: Optional[shared_resultconfigurationupdates.ResultConfigurationUpdates] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ResultConfigurationUpdates') }})
