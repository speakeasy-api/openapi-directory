...
public class Operations {
    ...
    **/
    public openapisdk.models.operations.AccesscontextmanagerOperationsGetResponse accesscontextmanagerOperationsGet(openapisdk.models.operations.AccesscontextmanagerOperationsGetRequest request) throws Exception {
        ...
        openapisdk.models.operations.AccesscontextmanagerOperationsGetResponse res = new openapisdk.models.operations.AccesscontextmanagerOperationsGetResponse() {{
            operation = null;
        }};
