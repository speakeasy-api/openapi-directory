...
type GkebackupProjectsLocationsRestorePlansCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GkebackupProjectsLocationsRestorePlansCreatePathParams struct {
	// Required. The location within which to create the RestorePlan. Format: `projects/*/locations/*`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type GkebackupProjectsLocationsRestorePlansCreateQueryParams struct {
	// V1 error format.
	...
	RestorePlanID *string `queryParam:"style=form,explode=true,name=restorePlanId"`
...
type GkebackupProjectsLocationsRestorePlansCreateResponse struct {
	ContentType string
	// Successful response
