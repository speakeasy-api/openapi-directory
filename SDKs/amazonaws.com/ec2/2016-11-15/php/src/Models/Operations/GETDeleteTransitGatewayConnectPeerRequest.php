...
class GETDeleteTransitGatewayConnectPeerRequest
{
     ...
     * 
     * @var string $transitGatewayConnectPeerId
     */
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETDeleteTransitGatewayConnectPeerActionEnum::DELETE_TRANSIT_GATEWAY_CONNECT_PEER;
		$this->dryRun = null;
		$this->transitGatewayConnectPeerId = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETDeleteTransitGatewayConnectPeerVersionEnum::TWO_THOUSAND_AND_SIXTEEN1115;
