...
class StopReplicationToReplicaRequest:
    ...
    stop_replication_to_replica_request: shared_stopreplicationtoreplicarequest.StopReplicationToReplicaRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
