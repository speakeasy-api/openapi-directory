...
class DescribeLocalGatewayVirtualInterfaceGroupsRequest:
    ...
    filters: Optional[list[DescribeLocalGatewayVirtualInterfaceGroupsRequestFilters]] = dataclasses.field(default=None)  
    local_gateway_virtual_interface_group_ids: Optional[list[str]] = dataclasses.field(default=None)  
