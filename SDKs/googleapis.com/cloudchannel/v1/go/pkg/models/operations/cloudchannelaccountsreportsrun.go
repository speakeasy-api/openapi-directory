...
type CloudchannelAccountsReportsRunSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudchannelAccountsReportsRunPathParams struct {
...
type CloudchannelAccountsReportsRunQueryParams struct {
	// V1 error format.
...
type CloudchannelAccountsReportsRunRequest struct {
	PathParams  CloudchannelAccountsReportsRunPathParams
	QueryParams CloudchannelAccountsReportsRunQueryParams
	Request     *shared.GoogleCloudChannelV1RunReportJobRequest `request:"mediaType=application/json"`
	Security    CloudchannelAccountsReportsRunSecurity
}

type CloudchannelAccountsReportsRunResponse struct {
	ContentType string
	// Successful response
