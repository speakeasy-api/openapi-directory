...
class ListObjectAttributesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListObjectAttributesXAmzConsistencyLevelEnum $xAmzConsistencyLevel
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=x-amz-consistency-level')]
    public ?ListObjectAttributesXAmzConsistencyLevelEnum $xAmzConsistencyLevel = null;
	...
	public function __construct()
	{
		...
		$this->nextToken = null;
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\ListObjectAttributesRequestBody();
