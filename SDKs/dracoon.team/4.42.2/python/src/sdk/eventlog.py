...
class Eventlog:
    ...
    def request_audit_node_info(self, request: operations.RequestAuditNodeInfoRequest) -> operations.RequestAuditNodeInfoResponse:
        r"""Request nodes
        ...
        url = base_url.removesuffix('/') + '/v4/eventlog/audits/node_info'
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestAuditNodeInfoRequest, request)
        ...
        res = operations.RequestAuditNodeInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AuditNodeInfoResponse])
                res.audit_node_info_response = out
    ...
    def request_audit_node_user_data(self, request: operations.RequestAuditNodeUserDataRequest) -> operations.RequestAuditNodeUserDataResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestAuditNodeUserDataRequest, request)
        ...
        res = operations.RequestAuditNodeUserDataResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.AuditNodeResponse]])
    ...
    def request_log_events_as_json(self, request: operations.RequestLogEventsAsJSONRequest) -> operations.RequestLogEventsAsJSONResponse:
        ...
        * `Accept: text/csv`  
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestLogEventsAsJSONRequest, request)
        ...
        res = operations.RequestLogEventsAsJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_log_operations(self, request: operations.RequestLogOperationsRequest) -> operations.RequestLogOperationsResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestLogOperationsRequest, request)
        ...
        res = operations.RequestLogOperationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.LogOperationList])
