...
class DataprocProjectsRegionsJobsSubmitAsOperationRequest:
    ...
    submit_job_request_input: Optional[shared_submitjobrequest.SubmitJobRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
