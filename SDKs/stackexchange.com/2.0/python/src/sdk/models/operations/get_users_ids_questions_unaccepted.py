...
class GetUsersIdsQuestionsUnacceptedPathParams:
    ids: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ids', 'style': 'simple', 'explode': False }})
    
class GetUsersIdsQuestionsUnacceptedOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetUsersIdsQuestionsUnacceptedSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
@dataclasses.dataclass
class GetUsersIdsQuestionsUnacceptedQueryParams:
    ...
    order: Optional[GetUsersIdsQuestionsUnacceptedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsQuestionsUnacceptedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetUsersIdsQuestionsUnacceptedRequest:
    path_params: GetUsersIdsQuestionsUnacceptedPathParams = dataclasses.field()
    query_params: GetUsersIdsQuestionsUnacceptedQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetUsersIdsQuestionsUnacceptedResponse:
