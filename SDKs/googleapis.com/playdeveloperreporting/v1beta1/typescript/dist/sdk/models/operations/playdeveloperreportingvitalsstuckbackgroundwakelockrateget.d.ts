...
export declare class PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
...
export declare class PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetResponse extends SpeakeasyBase {
     ...
     * Successful response
     */
    googlePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet?: shared.GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet;
    statusCode: number;
