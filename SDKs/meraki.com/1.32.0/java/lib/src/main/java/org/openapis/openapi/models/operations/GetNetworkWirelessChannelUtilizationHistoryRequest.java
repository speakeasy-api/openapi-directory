...
public class GetNetworkWirelessChannelUtilizationHistoryRequest {
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withAutoResolution(Boolean autoResolution) {
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withBand(GetNetworkWirelessChannelUtilizationHistoryBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withClientId(String clientId) {
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withDeviceSerial(String deviceSerial) {
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withNetworkId(String networkId) {
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withResolution(Long resolution) {
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkWirelessChannelUtilizationHistoryRequest withTimespan(Float timespan) {
        this.timespan = timespan;
        return this;
    }
    
    public GetNetworkWirelessChannelUtilizationHistoryRequest(@JsonProperty("networkId") String networkId) {
        this.networkId = networkId;
  }
}
