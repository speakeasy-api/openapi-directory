...
class WorkstationsProjectsLocationsWorkstationClustersWorkstationConfigsWorkstationsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\WorkstationInput $workstationInput = null;
