...
from ..shared import hyperparametertuningjobsortbyoptions_enum as shared_hyperparametertuningjobsortbyoptions_enum
...
class ListHyperParameterTuningJobsRequest:
    ...
    sort_by: Optional[shared_hyperparametertuningjobsortbyoptions_enum.HyperParameterTuningJobSortByOptionsEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    ...
    status_equals: Optional[shared_hyperparametertuningjobstatus_enum.HyperParameterTuningJobStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
