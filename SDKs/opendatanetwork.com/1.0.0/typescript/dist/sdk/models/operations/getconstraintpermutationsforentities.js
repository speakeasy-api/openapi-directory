...
exports.GetConstraintPermutationsForEntitiesResponse = exports.GetConstraintPermutationsForEntitiesRequest = void 0;
...
var GetConstraintPermutationsForEntitiesRequest = /** @class */ (function (_super) {
    ...
    ], GetConstraintPermutationsForEntitiesRequest.prototype, "xAppToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=app_token",
        }),
        __metadata("design:type", String)
    ], GetConstraintPermutationsForEntitiesRequest.prototype, "appToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=constraint",
        }),
        __metadata("design:type", String)
    ], GetConstraintPermutationsForEntitiesRequest.prototype, "constraint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=entity_id",
        }),
        __metadata("design:type", String)
    ], GetConstraintPermutationsForEntitiesRequest.prototype, "entityId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=variable",
        }),
        __metadata("design:type", String)
    ], GetConstraintPermutationsForEntitiesRequest.prototype, "variable", void 0);
...
var GetConstraintPermutationsForEntitiesResponse = /** @class */ (function (_super) {
    ...
    ], GetConstraintPermutationsForEntitiesResponse.prototype, "rawResponse", void 0);
