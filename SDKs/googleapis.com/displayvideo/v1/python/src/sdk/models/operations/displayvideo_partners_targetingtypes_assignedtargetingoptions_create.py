...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreatePathParams:
    ...
    targeting_type: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateQueryParams:
...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateRequest:
    path_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreatePathParams = dataclasses.field()
    query_params: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateQueryParams = dataclasses.field()
    security: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsCreateSecurity = dataclasses.field()
