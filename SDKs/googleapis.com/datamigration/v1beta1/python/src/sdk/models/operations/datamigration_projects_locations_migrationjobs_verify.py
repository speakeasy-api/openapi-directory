...
class DatamigrationProjectsLocationsMigrationJobsVerifySecurity:
...
@dataclasses.dataclass
class DatamigrationProjectsLocationsMigrationJobsVerifyRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Name of the migration job resource to verify."""  
...
@dataclasses.dataclass
class DatamigrationProjectsLocationsMigrationJobsVerifyResponse:
