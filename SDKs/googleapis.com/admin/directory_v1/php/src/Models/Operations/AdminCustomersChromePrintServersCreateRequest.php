...
class AdminCustomersChromePrintServersCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\PrintServerInput $printServerInput = null;
