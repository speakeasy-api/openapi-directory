...
class UnlinkDeveloperIdentityRequest:
    ...
    unlink_developer_identity_input: shared_unlinkdeveloperidentityinput.UnlinkDeveloperIdentityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
