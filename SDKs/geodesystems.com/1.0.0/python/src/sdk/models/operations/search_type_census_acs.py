...
class SearchTypeCensusAcsQueryParams:
    ...
    search_type_census_acs_fields: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_census_acs.fields', 'style': 'form', 'explode': True }})
    search_type_census_acs_for_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_census_acs.for_type', 'style': 'form', 'explode': True }})
    search_type_census_acs_in_type1: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_census_acs.in_type1', 'style': 'form', 'explode': True }})
    search_type_census_acs_in_type2: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_census_acs.in_type2', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchTypeCensusAcsRequest:
    query_params: SearchTypeCensusAcsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeCensusAcsResponse:
