...
class SecurityAndNetworking 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DomainLookupRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DomainLookupResponse
     */
	public function domainLookup(
        \OpenAPI\OpenAPI\Models\Operations\DomainLookupRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DomainLookupResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/domain-lookup');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DomainLookupRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('GET', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\DomainLookupResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->domainLookupResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DomainLookupResponse', 'json');
            }
        }
        else {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\IPBlocklistDownloadResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $response->ipBlocklistDownload200ApplicationJSONBinaryString = $httpResponse->getBody()->getContents();
            }
        }
        else {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
