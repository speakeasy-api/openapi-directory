...
const (
	GetNetworkDevicesLatencyStatsBandEnumTwo4 GetNetworkDevicesLatencyStatsBandEnum = "2.4"
...
type GetNetworkDevicesLatencyStatsResponse struct {
	...
	GetNetworkDevicesLatencyStats200ApplicationJSONObjects []map[string]interface{}
}
