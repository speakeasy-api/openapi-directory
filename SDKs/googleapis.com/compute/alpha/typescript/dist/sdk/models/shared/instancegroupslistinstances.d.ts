 ...
 */
export declare enum InstanceGroupsListInstancesWarningCodeEnum {
...
export declare class InstanceGroupsListInstancesWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InstanceGroupsListInstancesWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InstanceGroupsListInstancesWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InstanceGroupsListInstancesWarningData[];
    /**
 ...
 * Successful response
 */
export declare class InstanceGroupsListInstances extends SpeakeasyBase {
    /**
