...
class PayeeLocations:
    ...
    def get_payee_location_by_id(self, request: operations.GetPayeeLocationByIDRequest) -> operations.GetPayeeLocationByIDResponse:
        ...
        res = operations.GetPayeeLocationByIDResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PayeeLocationResponse])
    ...
    def get_payee_locations(self, request: operations.GetPayeeLocationsRequest) -> operations.GetPayeeLocationsResponse:
        ...
        res = operations.GetPayeeLocationsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PayeeLocationsResponse])
    ...
    def get_payee_locations_by_payee(self, request: operations.GetPayeeLocationsByPayeeRequest) -> operations.GetPayeeLocationsByPayeeResponse:
        ...
        res = operations.GetPayeeLocationsByPayeeResponse(status_code=r.status_code, content_type=content_type)
