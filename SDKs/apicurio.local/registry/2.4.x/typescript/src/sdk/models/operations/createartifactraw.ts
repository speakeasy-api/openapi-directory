 ...
 */
export enum CreateArtifactRawXRegistryHashAlgorithmEnum {
  Sha256 = "SHA256",
  Md5 = "MD5",
}

export class CreateArtifactRawRequest extends SpeakeasyBase {
  /**
...
export class CreateArtifactRawResponse extends SpeakeasyBase {
  /**
