...
type LogsReadLogAttributesLogParams struct {
...
// LogsReadLogAttributes - The properties of the log.
type LogsReadLogAttributes struct {
...
type LogsReadLogRelationships struct {
