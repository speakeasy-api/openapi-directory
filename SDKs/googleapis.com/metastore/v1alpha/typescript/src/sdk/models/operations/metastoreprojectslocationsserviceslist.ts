...
export class MetastoreProjectsLocationsServicesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsServicesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
