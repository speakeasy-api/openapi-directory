...
class GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest:
    ...
    features: Optional[list[GoogleCloudVideointelligenceV1beta2AnnotateVideoRequestFeaturesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('features'), 'exclude': lambda f: f is None }})
    ...
    video_context: Optional[shared_googlecloudvideointelligencev1beta2_videocontext.GoogleCloudVideointelligenceV1beta2VideoContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('videoContext'), 'exclude': lambda f: f is None }})
