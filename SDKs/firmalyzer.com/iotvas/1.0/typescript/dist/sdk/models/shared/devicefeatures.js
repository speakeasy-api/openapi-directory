...
var DeviceFeatures = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "ftp_banner" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "http_response" }),
        __metadata("design:type", String)
    ], DeviceFeatures.prototype, "httpResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "https_response" }),
        __metadata("design:type", String)
    ], DeviceFeatures.prototype, "httpsResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nic_mac" }),
        __metadata("design:type", String)
    ], DeviceFeatures.prototype, "nicMac", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "snmp_sysdescr" }),
        __metadata("design:type", String)
    ], DeviceFeatures.prototype, "snmpSysdescr", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "snmp_sysoid" }),
        __metadata("design:type", String)
    ], DeviceFeatures.prototype, "snmpSysoid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "telnet_banner" }),
        __metadata("design:type", String)
    ], DeviceFeatures.prototype, "telnetBanner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "upnp_response" }),
        __metadata("design:type", String)
