...
public class FirebaseappcheckProjectsAppsExchangeCustomTokenRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeCustomTokenRequest request;
    public FirebaseappcheckProjectsAppsExchangeCustomTokenRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1ExchangeCustomTokenRequest request) {
