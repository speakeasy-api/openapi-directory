...
exports.AdexchangebuyerPretargetingConfigInsertResponse = exports.AdexchangebuyerPretargetingConfigInsertRequest = exports.AdexchangebuyerPretargetingConfigInsertSecurity = void 0;
...
var AdexchangebuyerPretargetingConfigInsertRequest = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "pretargetingConfig", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=accountId",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerPretargetingConfigInsertRequest.prototype, "userIp", void 0);
...
var AdexchangebuyerPretargetingConfigInsertResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerPretargetingConfigInsertResponse.prototype, "rawResponse", void 0);
