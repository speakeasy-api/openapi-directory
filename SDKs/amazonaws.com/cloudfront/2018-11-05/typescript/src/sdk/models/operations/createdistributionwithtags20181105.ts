 ...
 */
export class CreateDistributionWithTags20181105RequestBodyDistributionConfigWithTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateDistributionWithTags20181105RequestBody extends SpeakeasyBase {
  /**
   * A distribution Configuration and a list of tags to be associated with the distribution.
   */
  @SpeakeasyMetadata()
...
export enum CreateDistributionWithTags20181105WithTagsEnum {
  True = "true",
}
