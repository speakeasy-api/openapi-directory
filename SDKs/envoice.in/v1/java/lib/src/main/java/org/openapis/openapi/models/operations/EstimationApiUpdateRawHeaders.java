...
public class EstimationApiUpdateRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiUpdateRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiUpdateRawHeaders withXAuthSecret(String xAuthSecret) {
