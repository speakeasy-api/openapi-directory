...
export class DirectoryOrgunitsInsertSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DirectoryOrgunitsInsertRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DirectoryOrgunitsInsertResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
