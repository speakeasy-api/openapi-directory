...
class InventorySources 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoInventorySourcesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/inventorySources');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/inventorySources/{inventorySourceId}:editInventorySourceReadWriteAccessors', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoInventorySourcesEditInventorySourceReadWriteAccessorsRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/inventorySources/{inventorySourceId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoInventorySourcesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/inventorySources/{inventorySourceId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoInventorySourcesPatchRequest::class, $request);
