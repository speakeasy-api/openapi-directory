...
export class GetUsersIdUserConnectionsIdConnectionLogsRequest extends SpeakeasyBase {
  /**
   * UUID of a connector
   */
  @SpeakeasyMetadata({
 ...
 * connectionlogs
 */
export class GetUsersIdUserConnectionsIdConnectionLogs200ApplicationJSON extends SpeakeasyBase {
...
export class GetUsersIdUserConnectionsIdConnectionLogsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
