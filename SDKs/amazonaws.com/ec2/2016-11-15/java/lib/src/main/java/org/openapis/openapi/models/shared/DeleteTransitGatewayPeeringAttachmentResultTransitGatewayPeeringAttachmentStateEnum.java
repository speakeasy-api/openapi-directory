 ...
 */
public enum DeleteTransitGatewayPeeringAttachmentResultTransitGatewayPeeringAttachmentStateEnum {
    ...
    private DeleteTransitGatewayPeeringAttachmentResultTransitGatewayPeeringAttachmentStateEnum(String value) {
        this.value = value;
    }
}
