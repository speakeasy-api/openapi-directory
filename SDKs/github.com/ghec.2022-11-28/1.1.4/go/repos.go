...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/invitations#accept-a-repository-invitation - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#add-app-access-restrictions - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/collaborators#add-a-repository-collaborator - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#add-status-check-contexts - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#add-team-access-restrictions - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#add-user-access-restrictions - API method documentation
...
// endpoint.
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/collaborators#check-if-a-user-is-a-repository-collaborator - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#check-if-vulnerability-alerts-are-enabled-for-a-repository - API method documentation
func (s *repos) ReposCheckVulnerabilityAlerts(ctx context.Context, request operations.ReposCheckVulnerabilityAlertsRequest) (*operations.ReposCheckVulnerabilityAlertsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/vulnerability-alerts", request.PathParams, nil)
	...
	res := &operations.ReposCheckVulnerabilityAlertsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-codeowners-errors - API method documentation
func (s *repos) ReposCodeownersErrors(ctx context.Context, request operations.ReposCodeownersErrorsRequest) (*operations.ReposCodeownersErrorsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/codeowners/errors", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/commits#compare-two-commits - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/repos/autolinks#create-an-autolink-reference-for-a-repository - API method documentation
func (s *repos) ReposCreateAutolink(ctx context.Context, request operations.ReposCreateAutolinkRequest) (*operations.ReposCreateAutolinkResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/autolinks", request.PathParams, nil)
...
//
// This endpoint triggers [notifications](https://docs.github.com/enterprise-cloud@latest//github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See "[Secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/overview/resources-in-the-rest-api#secondary-rate-limits)" and "[Dealing with secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)" for details.
// https://docs.github.com/enterprise-cloud@latest//rest/commits/comments#create-a-commit-comment - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#create-commit-signature-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/statuses#create-a-commit-status - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deploy-keys#create-a-deploy-key - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/deployments#create-a-deployment - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/branch-policies#create-deployment-branch-policy - API method documentation
func (s *repos) ReposCreateDeploymentBranchPolicy(ctx context.Context, request operations.ReposCreateDeploymentBranchPolicyRequest) (*operations.ReposCreateDeploymentBranchPolicyResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/environments/{environment_name}/deployment-branch-policies", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/statuses#create-a-deployment-status - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#create-a-repository-dispatch-event - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#create-a-repository-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#create-a-fork - API method documentation
...
// *   `public_repo` scope or `repo` scope to create a public repository. Note: For GitHub AE, use `repo` scope to create an internal repository.
// *   `repo` scope to create a private repository
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#create-an-organization-repository - API method documentation
...
//
// You must authenticate using an access token with the `repo` scope to use this endpoint. GitHub Apps must have the `administration:write` permission for the repository to use this endpoint.
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/environments#create-or-update-an-environment - API method documentation
func (s *repos) ReposCreateOrUpdateEnvironment(ctx context.Context, request operations.ReposCreateOrUpdateEnvironmentRequest) (*operations.ReposCreateOrUpdateEnvironmentResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/environments/{environment_name}", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#create-or-update-file-contents - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#create-a-github-pages-deployment - API method documentation
func (s *repos) ReposCreatePagesDeployment(ctx context.Context, request operations.ReposCreatePagesDeploymentRequest) (*operations.ReposCreatePagesDeploymentResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/pages/deployment", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#create-a-github-pages-site - API method documentation
...
//
// This endpoint triggers [notifications](https://docs.github.com/enterprise-cloud@latest//github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See "[Secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/overview/resources-in-the-rest-api#secondary-rate-limits)" and "[Dealing with secondary rate limits](https://docs.github.com/enterprise-cloud@latest//rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)" for details.
// https://docs.github.com/enterprise-cloud@latest//rest/releases/releases#create-a-release - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#create-tag-protection-state-for-a-repository - API method documentation
func (s *repos) ReposCreateTagProtection(ctx context.Context, request operations.ReposCreateTagProtectionRequest) (*operations.ReposCreateTagProtectionResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/tags/protection", request.PathParams, nil)
...
// *   `public_repo` scope or `repo` scope to create a public repository. Note: For GitHub AE, use `repo` scope to create an internal repository.
// *   `repo` scope to create a private repository
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#create-a-repository-using-a-template - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repos#create-a-repository-webhook - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/invitations#decline-a-repository-invitation - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#delete-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#delete-access-restrictions - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#delete-admin-branch-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/environments#delete-an-environment - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/repos/autolinks#delete-an-autolink-reference-from-a-repository - API method documentation
func (s *repos) ReposDeleteAutolink(ctx context.Context, request operations.ReposDeleteAutolinkRequest) (*operations.ReposDeleteAutolinkResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/autolinks/{autolink_id}", request.PathParams, nil)
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#delete-branch-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/comments#delete-a-commit-comment - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#delete-commit-signature-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deploy-keys#delete-a-deploy-key - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/deployments#delete-a-deployment - API method documentation
...
//
// You must authenticate using an access token with the `repo` scope to use this endpoint. GitHub Apps must have the `administration:write` permission for the repository to use this endpoint.
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/branch-policies#delete-deployment-branch-policy - API method documentation
func (s *repos) ReposDeleteDeploymentBranchPolicy(ctx context.Context, request operations.ReposDeleteDeploymentBranchPolicyRequest) (*operations.ReposDeleteDeploymentBranchPolicyResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/environments/{environment_name}/deployment-branch-policies/{branch_policy_id}", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#delete-a-file - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/invitations#delete-a-repository-invitation - API method documentation
...
//
// To use this endpoint, you must be a repository administrator, maintainer, or have the 'manage GitHub Pages settings' permission. A token with the `repo` scope or Pages write permission is required. GitHub Apps must have the `administration:write` and `pages:write` permissions.
// https://docs.github.com/enterprise-cloud@latest//rest/pages#delete-a-github-pages-site - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#delete-pull-request-review-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#delete-a-release - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#delete-a-release-asset - API method documentation
...
// This endpoint is only available to repository administrators.
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#delete-tag-protection-state-for-a-repository - API method documentation
func (s *repos) ReposDeleteTagProtection(ctx context.Context, request operations.ReposDeleteTagProtectionRequest) (*operations.ReposDeleteTagProtectionResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/tags/protection/{tag_protection_id}", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repos#delete-a-repository-webhook - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#disable-automated-security-fixes - API method documentation
func (s *repos) ReposDisableAutomatedSecurityFixes(ctx context.Context, request operations.ReposDisableAutomatedSecurityFixesRequest) (*operations.ReposDisableAutomatedSecurityFixesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/automated-security-fixes", request.PathParams, nil)
	...
	res := &operations.ReposDisableAutomatedSecurityFixesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#disable-git-lfs-for-a-repository - API method documentation
func (s *repos) ReposDisableLfsForRepo(ctx context.Context, request operations.ReposDisableLfsForRepoRequest) (*operations.ReposDisableLfsForRepoResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/lfs", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#disable-vulnerability-alerts - API method documentation
func (s *repos) ReposDisableVulnerabilityAlerts(ctx context.Context, request operations.ReposDisableVulnerabilityAlertsRequest) (*operations.ReposDisableVulnerabilityAlertsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/vulnerability-alerts", request.PathParams, nil)
	...
	res := &operations.ReposDisableVulnerabilityAlertsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#download-a-repository-archive - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#enable-automated-security-fixes - API method documentation
func (s *repos) ReposEnableAutomatedSecurityFixes(ctx context.Context, request operations.ReposEnableAutomatedSecurityFixesRequest) (*operations.ReposEnableAutomatedSecurityFixesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/automated-security-fixes", request.PathParams, nil)
	...
	res := &operations.ReposEnableAutomatedSecurityFixesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#enable-git-lfs-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#enable-vulnerability-alerts - API method documentation
func (s *repos) ReposEnableVulnerabilityAlerts(ctx context.Context, request operations.ReposEnableVulnerabilityAlertsRequest) (*operations.ReposEnableVulnerabilityAlertsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/vulnerability-alerts", request.PathParams, nil)
	...
	res := &operations.ReposEnableVulnerabilityAlertsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#generate-release-notes - API method documentation
func (s *repos) ReposGenerateReleaseNotes(ctx context.Context, request operations.ReposGenerateReleaseNotesRequest) (*operations.ReposGenerateReleaseNotesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/releases/generate-notes", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#get-access-restrictions - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#get-admin-branch-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/environments#list-environments - API method documentation
func (s *repos) ReposGetAllEnvironments(ctx context.Context, request operations.ReposGetAllEnvironmentsRequest) (*operations.ReposGetAllEnvironmentsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/environments", request.PathParams, nil)
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#get-all-status-check-contexts - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-all-repository-topics - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#list-apps-with-access-to-the-protected-branch - API method documentation
...
//
// Information about autolinks are only available to repository administrators.
// https://docs.github.com/enterprise-cloud@latest//rest/repos/autolinks#get-an-autolink-reference-of-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branches#get-a-branch - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#get-branch-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/traffic#get-repository-clones - API method documentation
func (s *repos) ReposGetClones(ctx context.Context, request operations.ReposGetClonesRequest) (*operations.ReposGetClonesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/clones", request.PathParams, nil)
	...
	res := &operations.ReposGetClonesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/statistics#get-the-weekly-commit-activity - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/collaborators#get-repository-permissions-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/statuses#get-the-combined-status-for-a-specific-reference - API method documentation
...
// | `invalid` | The signature could not be cryptographically verified using the key whose key-id was found in the signature. |
// | `valid` | None of the above errors applied, so the signature is considered to be verified. |
// https://docs.github.com/enterprise-cloud@latest//rest/commits/commits#get-a-commit - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/statistics#get-the-last-year-of-commit-activity - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/comments#get-a-commit-comment - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#get-commit-signature-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/community#get-community-profile-metrics - API method documentation
func (s *repos) ReposGetCommunityProfileMetrics(ctx context.Context, request operations.ReposGetCommunityProfileMetricsRequest) (*operations.ReposGetCommunityProfileMetricsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/community/profile", request.PathParams, nil)
	...
	res := &operations.ReposGetCommunityProfileMetricsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CommunityProfile
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-repository-content - API method documentation
...
// *   `c` - Number of commits
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/statistics#get-all-contributor-commit-activity - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deploy-keys#get-a-deploy-key - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/deployments#get-a-deployment - API method documentation
...
//
// Anyone with read access to the repository can use this endpoint. If the repository is private, you must use an access token with the `repo` scope. GitHub Apps must have the `actions:read` permission to use this endpoint.
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/branch-policies#get-deployment-branch-policy - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/statuses#get-a-deployment-status - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/environments#get-an-environment - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#get-latest-pages-build - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-the-latest-release - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#get-a-github-pages-site - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#get-github-pages-build - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#get-a-dns-health-check-for-github-pages - API method documentation
func (s *repos) ReposGetPagesHealthCheck(ctx context.Context, request operations.ReposGetPagesHealthCheckRequest) (*operations.ReposGetPagesHealthCheckResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/pages/health", request.PathParams, nil)
	...
	res := &operations.ReposGetPagesHealthCheckResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.PagesHealthCheck
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/statistics#get-the-weekly-commit-count - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#get-pull-request-review-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/statistics#get-the-hourly-commit-count-for-each-day - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-a-repository-readme - API method documentation
...
//
// READMEs support [custom media types](https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#custom-media-types) for retrieving the raw content or rendered HTML.
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-a-repository-directory-readme - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-a-release - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-a-release-asset - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#get-a-release-by-tag-name - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#get-status-checks-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#list-teams-with-access-to-the-protected-branch - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/traffic#get-top-referral-paths - API method documentation
func (s *repos) ReposGetTopPaths(ctx context.Context, request operations.ReposGetTopPathsRequest) (*operations.ReposGetTopPathsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/popular/paths", request.PathParams, nil)
	...
	res := &operations.ReposGetTopPathsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/traffic#get-top-referral-sources - API method documentation
func (s *repos) ReposGetTopReferrers(ctx context.Context, request operations.ReposGetTopReferrersRequest) (*operations.ReposGetTopReferrersResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/popular/referrers", request.PathParams, nil)
	...
	res := &operations.ReposGetTopReferrersResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out []shared.ReferrerTraffic
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#list-users-with-access-to-the-protected-branch - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/metrics/traffic#get-page-views - API method documentation
func (s *repos) ReposGetViews(ctx context.Context, request operations.ReposGetViewsRequest) (*operations.ReposGetViewsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/traffic/views", request.PathParams, nil)
	...
	res := &operations.ReposGetViewsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repos#get-a-repository-webhook - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repo-config#get-a-webhook-configuration-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repo-deliveries#get-a-delivery-for-a-repository-webhook - API method documentation
func (s *repos) ReposGetWebhookDelivery(ctx context.Context, request operations.ReposGetWebhookDeliveryRequest) (*operations.ReposGetWebhookDeliveryResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/hooks/{hook_id}/deliveries/{delivery_id}", request.PathParams, nil)
...
//
// Information about autolinks are only available to repository administrators.
// https://docs.github.com/enterprise-cloud@latest//rest/repos/autolinks#list-all-autolinks-of-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branches#list-branches - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/commits#list-branches-for-head-commit - API method documentation
...
// endpoint. GitHub Apps must have the `members` organization permission and `metadata` repository permission to use this
// endpoint.
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/collaborators#list-repository-collaborators - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/comments#list-commit-comments - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/comments#list-commit-comments-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/statuses#list-commit-statuses-for-a-reference - API method documentation
...
// | `invalid` | The signature could not be cryptographically verified using the key whose key-id was found in the signature. |
// | `valid` | None of the above errors applied, so the signature is considered to be verified. |
// https://docs.github.com/enterprise-cloud@latest//rest/commits/commits#list-commits - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-repository-contributors - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deploy-keys#list-deploy-keys - API method documentation
...
//
// Anyone with read access to the repository can use this endpoint. If the repository is private, you must use an access token with the `repo` scope. GitHub Apps must have the `actions:read` permission to use this endpoint.
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/branch-policies#list-deployment-branch-policies - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/statuses#list-deployment-statuses - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/deployments#list-deployments - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-repositories-for-the-authenticated-user - API method documentation
...
//
// **Note:** In order to see the `security_and_analysis` block for a repository you must have admin permissions for the repository or be an owner or security manager for the organization that owns the repository. For more information, see "[Managing security managers in your organization](https://docs.github.com/enterprise-cloud@latest//organizations/managing-peoples-access-to-your-organization-with-roles/managing-security-managers-in-your-organization)."
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-organization-repositories - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-repositories-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-forks - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/invitations#list-repository-invitations - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/invitations#list-repository-invitations-for-the-authenticated-user - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-repository-languages - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#list-github-pages-builds - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-public-repositories - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/commits#list-pull-requests-associated-with-a-commit - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-release-assets - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-releases - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-tag-protection-state-of-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-repository-tags - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#list-repository-teams - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repo-deliveries#list-deliveries-for-a-repository-webhook - API method documentation
func (s *repos) ReposListWebhookDeliveries(ctx context.Context, request operations.ReposListWebhookDeliveriesRequest) (*operations.ReposListWebhookDeliveriesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/hooks/{hook_id}/deliveries", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repos#list-repository-webhooks - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branches#merge-a-branch - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branches#sync-a-fork-branch-with-the-upstream-repository - API method documentation
func (s *repos) ReposMergeUpstream(ctx context.Context, request operations.ReposMergeUpstreamRequest) (*operations.ReposMergeUpstreamResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/merge-upstream", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repos#ping-a-repository-webhook - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repo-deliveries#redeliver-a-delivery-for-a-repository-webhook - API method documentation
func (s *repos) ReposRedeliverWebhookDelivery(ctx context.Context, request operations.ReposRedeliverWebhookDeliveryRequest) (*operations.ReposRedeliverWebhookDeliveryResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/hooks/{hook_id}/deliveries/{delivery_id}/attempts", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#remove-app-access-restrictions - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/collaborators#remove-a-repository-collaborator - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#remove-status-check-contexts - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#remove-status-check-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#remove-team-access-restrictions - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#remove-user-access-restrictions - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branches#rename-a-branch - API method documentation
func (s *repos) ReposRenameBranch(ctx context.Context, request operations.ReposRenameBranchRequest) (*operations.ReposRenameBranchResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/branches/{branch}/rename", request.PathParams, nil)
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#replace-all-repository-topics - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/pages#request-a-github-pages-build - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#set-admin-branch-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#set-app-access-restrictions - API method documentation
...
// Protected branches are available in public repositories with GitHub Free and GitHub Free for organizations, and in public and private repositories with GitHub Pro, GitHub Team, GitHub Enterprise Cloud, and GitHub Enterprise Server. For more information, see [GitHub's products](https://docs.github.com/enterprise-cloud@latest//github/getting-started-with-github/githubs-products) in the GitHub Help documentation.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#set-status-check-contexts - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#set-team-access-restrictions - API method documentation
...
// | ------- | ----------------------------------------------------------------------------------------------------------------------------- |
// | `array` | Usernames for people who can have push access. **Note**: The list of users, apps, and teams in total is limited to 100 items. |
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#set-user-access-restrictions - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repos#test-the-push-repository-webhook - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#transfer-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/repos/repos#update-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#update-branch-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/commits/comments#update-a-commit-comment - API method documentation
...
//
// You must authenticate using an access token with the `repo` scope to use this endpoint. GitHub Apps must have the `administration:write` permission for the repository to use this endpoint.
// https://docs.github.com/enterprise-cloud@latest//rest/deployments/branch-policies#update-deployment-branch-policy - API method documentation
...
//
// To use this endpoint, you must be a repository administrator, maintainer, or have the 'manage GitHub Pages settings' permission. A token with the `repo` scope or Pages write permission is required. GitHub Apps must have the `administration:write` and `pages:write` permissions.
// https://docs.github.com/enterprise-cloud@latest//rest/pages#update-information-about-a-github-pages-site - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/collaborators/invitations#update-a-repository-invitation - API method documentation
...
//
// **Note**: Passing new arrays of `users` and `teams` replaces their previous values.
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#update-pull-request-review-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#update-a-release - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#update-a-release-asset - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/branches/branch-protection#update-status-check-protection - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repos#update-a-repository-webhook - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/webhooks/repo-config#update-a-webhook-configuration-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-cloud@latest//rest/reference/repos#upload-a-release-asset - API method documentation
