...
class MarketingEventPublicReadResponse:
    ...
    attendees: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attendees') }})
    r"""The number of HubSpot contacts that attended this marketing event."""  
    cancellations: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cancellations') }})
    r"""The number of HubSpot contacts that registered for this marketing event, but later cancelled their registration."""  
    ...
    no_shows: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('noShows') }})
    r"""The number of HubSpot contacts that registered for this marketing event, but did not attend. This field only had a value when the event is over."""  
    registrants: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('registrants') }})
    r"""The number of HubSpot contacts that registered for this marketing event."""  
    ...
    r"""A URL in the external event application where the marketing event can be managed."""  
