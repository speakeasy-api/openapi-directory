...
exports.CisJobInstructionBase = exports.CisJobInstructionBaseCisJobInstructionBase = exports.CisJobInstructionBaseCisJobInstructionBaseSubContractor = exports.CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor = exports.CisJobInstructionBaseCisJobInstructionBaseEmployer = void 0;
...
var CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor = /** @class */ (function (_super) {
    __extends(CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor, _super);
    function CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "@href" }),
        __metadata("design:type", String)
    ], CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor.prototype, "atHref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "@rel" }),
        __metadata("design:type", String)
    ], CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor.prototype, "atRel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "@title" }),
        __metadata("design:type", String)
    ], CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor.prototype, "atTitle", void 0);
    return CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor;
}(utils_1.SpeakeasyBase));
exports.CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor = CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor;
/**
...
var CisJobInstructionBaseCisJobInstructionBaseSubContractor = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor,
        }),
        (0, class_transformer_1.Expose)({ name: "SubContractor" }),
        (0, class_transformer_1.Type)(function () { return CisJobInstructionBaseCisJobInstructionBaseSubContractorSubContractor; }),
...
var CisJobInstructionBaseCisJobInstructionBase = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return CisJobInstructionBaseCisJobInstructionBaseEmployer; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SubContractors" }),
        (0, class_transformer_1.Type)(function () { return CisJobInstructionBaseCisJobInstructionBaseSubContractor; }),
...
var CisJobInstructionBase = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CisJobInstructionBase" }),
        (0, class_transformer_1.Type)(function () { return CisJobInstructionBaseCisJobInstructionBase; }),
