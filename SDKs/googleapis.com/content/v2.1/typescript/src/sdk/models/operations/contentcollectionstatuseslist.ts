...
export class ContentCollectionstatusesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentCollectionstatusesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentCollectionstatusesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
