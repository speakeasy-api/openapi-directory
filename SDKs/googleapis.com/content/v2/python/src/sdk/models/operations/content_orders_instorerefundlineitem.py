...
class ContentOrdersInstorerefundlineitemRequest:
    ...
    orders_in_store_refund_line_item_request: Optional[shared_ordersinstorerefundlineitemrequest.OrdersInStoreRefundLineItemRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
