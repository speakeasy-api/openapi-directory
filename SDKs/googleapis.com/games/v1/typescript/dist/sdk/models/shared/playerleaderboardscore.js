...
var PlayerLeaderboardScore = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=friendsRank" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=leaderboard_id" }),
        __metadata("design:type", String)
    ], PlayerLeaderboardScore.prototype, "leaderboardId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=publicRank" }),
        __metadata("design:type", leaderboardscorerank_1.LeaderboardScoreRank)
    ], PlayerLeaderboardScore.prototype, "publicRank", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=scoreString" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=socialRank" }),
        __metadata("design:type", leaderboardscorerank_1.LeaderboardScoreRank)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=writeTimestamp" }),
        __metadata("design:type", String)
