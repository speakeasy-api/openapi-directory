...
class ListCarrierPackageTypesResponseBody:
    r"""A list carrier package types response body"""
    
    packages: Optional[list[ListCarrierPackageTypesResponseBodyPackageType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('packages'), 'exclude': lambda f: f is None }})
    r"""An array of custom package types"""  
