...
class OBWriteDomesticScheduledResponse5DataInitiation:
    ...
    creditor_account: OBWriteDomesticScheduledResponse5DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Unambiguous identification of the account of the creditor to which a credit entry will be posted as a result of the payment transaction."""  
    instructed_amount: OBWriteDomesticScheduledResponse5DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructedAmount') }})
    r"""Amount of money to be moved between the debtor and creditor, before deduction of charges, expressed in the currency as ordered by the initiating party.
    Usage: This amount has to be transported unchanged through the transaction chain.
    """  
    ...
    debtor_account: Optional[OBWriteDomesticScheduledResponse5DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction."""  
    ...
    """  
    remittance_information: Optional[OBWriteDomesticScheduledResponse5DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RemittanceInformation'), 'exclude': lambda f: f is None }})
    r"""Information supplied to enable the matching of an entry with the items that the transfer is intended to settle, such as commercial invoices in an accounts' receivable system."""  
...
class OBWriteDomesticScheduledResponse5DataMultiAuthorisation:
    ...
    status: OBWriteDomesticScheduledResponse5DataMultiAuthorisationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    r"""Specifies the status of the authorisation flow in code form."""  
...
class OBWriteDomesticScheduledResponse5DataRefund:
    ...
    account: OBWriteDomesticScheduledResponse5DataRefundAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Account') }})
    r"""Provides the details to identify an account."""  
...
class OBWriteDomesticScheduledResponse5Data:
    ...
    2017-04-05T10:43:07+00:00
    """  
    domestic_scheduled_payment_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DomesticScheduledPaymentId') }})
    r"""OB: Unique identification as assigned by the ASPSP to uniquely identify the domestic schedule payment resource."""  
    initiation: OBWriteDomesticScheduledResponse5DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for a single scheduled domestic payment."""  
    status: OBWriteDomesticScheduledResponse5DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    r"""Specifies the status of the payment order resource."""  
    ...
    2017-04-05T10:43:07+00:00
    """  
    charges: Optional[list[OBWriteDomesticScheduledResponse5DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Charges'), 'exclude': lambda f: f is None }})  
    ...
    2017-04-05T10:43:07+00:00
    """  
    multi_authorisation: Optional[OBWriteDomesticScheduledResponse5DataMultiAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MultiAuthorisation'), 'exclude': lambda f: f is None }})
    r"""The multiple authorisation flow response from the ASPSP."""  
    refund: Optional[OBWriteDomesticScheduledResponse5DataRefund] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Refund'), 'exclude': lambda f: f is None }})
    r"""Unambiguous identification of the refund account to which a refund will be made as a result of the transaction."""  
...
class OBWriteDomesticScheduledResponse5:
    r"""Domestic Scheduled Payments Created"""
    
    data: OBWriteDomesticScheduledResponse5Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
