...
class CreateImagePipelineResponse:
    ...
    image_pipeline_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('imagePipelineArn'), 'exclude': lambda f: f is None }})  
