...
public class GetUserApiKeysRequest {
    ...
    public GetUserApiKeysRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetUserApiKeysRequest withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUserApiKeysRequest withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetUserApiKeysRequest withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetUserApiKeysRequest withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetUserApiKeysRequest withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetUserApiKeysRequest withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetUserApiKeysRequest withPerPage(Integer perPage) {
    ...
    public GetUserApiKeysRequest withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetUserApiKeysRequest withUserId(Integer userId) {
        this.userId = userId;
        return this;
    }
