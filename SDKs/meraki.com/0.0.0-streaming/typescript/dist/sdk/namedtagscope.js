...
exports.NamedTagScope = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var NamedTagScope = /** @class */ (function () {
    function NamedTagScope(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Add a target group
     */
    NamedTagScope.prototype.createNetworkSmTargetGroup = function (req, config) {
        var _a;
     ...
     * Delete a target group from a network
     */
    NamedTagScope.prototype.deleteNetworkSmTargetGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return a target group
     */
    NamedTagScope.prototype.getNetworkSmTargetGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List the target groups in this network
     */
    NamedTagScope.prototype.getNetworkSmTargetGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update a target group
     */
    NamedTagScope.prototype.updateNetworkSmTargetGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.NamedTagScope = NamedTagScope;
