...
from ..shared import createuploadsessionrequest as shared_createuploadsessionrequest
from ..shared import createuploadsessionresponse as shared_createuploadsessionresponse
...
UPLOAD_SESSIONS_ADD_SERVERS = [
	"https://upload.apideck.com",
]


@dataclasses.dataclass
class UploadSessionsAddSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class UploadSessionsAddRequest:
    
    create_upload_session_request: shared_createuploadsessionrequest.CreateUploadSessionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class UploadSessionsAddResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    create_upload_session_response: Optional[shared_createuploadsessionresponse.CreateUploadSessionResponse] = dataclasses.field(default=None)
    r"""UploadSessions"""  
