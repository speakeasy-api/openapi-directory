...
export class ApigatewayApiConfig extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "gatewayServiceAccount" })
  gatewayServiceAccount?: string;

  /**
   * Optional. gRPC service definition files. If specified, openapi_documents must not be included.
   */
  @SpeakeasyMetadata({ elemType: ApigatewayApiConfigGrpcServiceDefinition })
  @Expose({ name: "grpcServices" })
  ...
  @Expose({ name: "managedServiceConfigs" })
   ...
   */
  @SpeakeasyMetadata({ elemType: ApigatewayApiConfigOpenApiDocument })
  @Expose({ name: "openapiDocuments" })
