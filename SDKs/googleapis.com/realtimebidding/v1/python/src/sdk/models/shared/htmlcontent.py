...
class HTMLContent:
    ...
    r"""The height of the HTML snippet in pixels. Can be used to filter the response of the creatives.list method."""  
    ...
    r"""The width of the HTML snippet in pixels. Can be used to filter the response of the creatives.list method."""  
