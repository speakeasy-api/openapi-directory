...
import { SecurityPoliciesScopedList } from "./securitypoliciesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum SecurityPoliciesAggregatedListWarningCodeEnum {
...
export declare class SecurityPoliciesAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SecurityPoliciesAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: SecurityPoliciesAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: SecurityPoliciesAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class SecurityPoliciesAggregatedList extends SpeakeasyBase {
    etag?: string;
    /**
     ...
     */
    items?: Record<string, SecurityPoliciesScopedList>;
    /**
