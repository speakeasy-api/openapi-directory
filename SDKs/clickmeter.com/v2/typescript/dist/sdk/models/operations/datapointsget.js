...
exports.DataPointsGetResponse = exports.DataPointsGetRequest = exports.DataPointsGetTypeEnum = exports.DataPointsGetStatusEnum = exports.DataPointsGetSortDirectionEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Direction of sort "asc" or "desc"
 */
var DataPointsGetSortDirectionEnum;
(function (DataPointsGetSortDirectionEnum) {
    DataPointsGetSortDirectionEnum["Asc"] = "asc";
    DataPointsGetSortDirectionEnum["Desc"] = "desc";
})(DataPointsGetSortDirectionEnum = exports.DataPointsGetSortDirectionEnum || (exports.DataPointsGetSortDirectionEnum = {}));
/**
 * Status of the datapoint
 */
var DataPointsGetStatusEnum;
...
})(DataPointsGetStatusEnum = exports.DataPointsGetStatusEnum || (exports.DataPointsGetStatusEnum = {}));
/**
 * Type of the datapoint ("tp"/"tl")
 */
var DataPointsGetTypeEnum;
(function (DataPointsGetTypeEnum) {
    DataPointsGetTypeEnum["Tp"] = "tp";
    DataPointsGetTypeEnum["Tl"] = "tl";
})(DataPointsGetTypeEnum = exports.DataPointsGetTypeEnum || (exports.DataPointsGetTypeEnum = {}));
var DataPointsGetRequest = /** @class */ (function (_super) {
    ...
    ], DataPointsGetRequest.prototype, "createdAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdBefore",
        }),
        __metadata("design:type", String)
    ], DataPointsGetRequest.prototype, "createdBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], DataPointsGetRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], DataPointsGetRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=onlyFavorites",
        }),
        __metadata("design:type", Boolean)
    ], DataPointsGetRequest.prototype, "onlyFavorites", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sortBy",
        }),
        __metadata("design:type", String)
    ], DataPointsGetRequest.prototype, "sortBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sortDirection",
        }),
        __metadata("design:type", String)
    ], DataPointsGetRequest.prototype, "sortDirection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], DataPointsGetRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tags" }),
        __metadata("design:type", String)
    ], DataPointsGetRequest.prototype, "tags", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=textSearch",
        }),
        __metadata("design:type", String)
    ], DataPointsGetRequest.prototype, "textSearch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], DataPointsGetRequest.prototype, "type", void 0);
    return DataPointsGetRequest;
}(utils_1.SpeakeasyBase));
exports.DataPointsGetRequest = DataPointsGetRequest;
var DataPointsGetResponse = /** @class */ (function (_super) {
    ...
    ], DataPointsGetResponse.prototype, "rawResponse", void 0);
    return DataPointsGetResponse;
}(utils_1.SpeakeasyBase));
exports.DataPointsGetResponse = DataPointsGetResponse;
