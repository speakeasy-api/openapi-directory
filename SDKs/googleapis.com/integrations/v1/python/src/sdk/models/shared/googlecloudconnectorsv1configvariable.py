...
class GoogleCloudConnectorsV1ConfigVariable:
    ...
    secret_value: Optional[shared_googlecloudconnectorsv1secret.GoogleCloudConnectorsV1Secret] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('secretValue'), 'exclude': lambda f: f is None }})
