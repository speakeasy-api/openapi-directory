...
from ..shared import updateinfrastructureconfigurationresponse as shared_updateinfrastructureconfigurationresponse
...
class UpdateInfrastructureConfigurationRequestBody:
    ...
    logging: Optional[UpdateInfrastructureConfigurationRequestBodyLogging] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('logging') }})
...
class UpdateInfrastructureConfigurationRequest:
    headers: UpdateInfrastructureConfigurationHeaders = dataclasses.field()
    request: UpdateInfrastructureConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateInfrastructureConfigurationResponse:
    ...
    update_infrastructure_configuration_response: Optional[shared_updateinfrastructureconfigurationresponse.UpdateInfrastructureConfigurationResponse] = dataclasses.field(default=None)
