...
class ListEntityRecognizersRequest:
    ...
    list_entity_recognizers_request: shared_listentityrecognizersrequest.ListEntityRecognizersRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
