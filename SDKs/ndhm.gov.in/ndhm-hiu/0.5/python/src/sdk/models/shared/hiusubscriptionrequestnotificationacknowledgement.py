...
class HIUSubscriptionRequestNotificationAcknowledgementAcknowledgement:
    ...
    status: HIUSubscriptionRequestNotificationAcknowledgementAcknowledgementStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
    subscription_request_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subscriptionRequestId') }})  
...
class HIUSubscriptionRequestNotificationAcknowledgement:
    ...
    acknowledgement: Optional[HIUSubscriptionRequestNotificationAcknowledgementAcknowledgement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('acknowledgement'), 'exclude': lambda f: f is None }})  
