...
class GetVariantModelAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetVariantModelAssociationsQueryParams:
...
@dataclasses.dataclass
class GetVariantModelAssociationsRequest:
    path_params: GetVariantModelAssociationsPathParams = dataclasses.field()
    query_params: GetVariantModelAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetVariantModelAssociationsResponse:
