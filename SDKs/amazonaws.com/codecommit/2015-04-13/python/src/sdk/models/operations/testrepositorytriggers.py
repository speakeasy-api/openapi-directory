...
class TestRepositoryTriggersRequest:
    ...
    test_repository_triggers_input: shared_testrepositorytriggersinput.TestRepositoryTriggersInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
