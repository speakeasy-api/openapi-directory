...
class GetNetworkClientsConnectionStatsBandEnum(str, Enum):
...
class GetNetworkClientsConnectionStatsRequest:
    ...
    band: Optional[GetNetworkClientsConnectionStatsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information."""  
...
class GetNetworkClientsConnectionStatsResponse:
    ...
    get_network_clients_connection_stats_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
