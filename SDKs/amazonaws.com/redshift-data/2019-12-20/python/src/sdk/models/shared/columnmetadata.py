...
class ColumnMetadata:
    r"""The properties (metadata) of a column."""
    
    column_default: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('columnDefault'), 'exclude': lambda f: f is None }})  
