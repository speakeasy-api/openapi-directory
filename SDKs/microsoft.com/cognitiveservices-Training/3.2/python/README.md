...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/microsoft.com/cognitiveservices-Training/3.2/python
```
...
* `train_project_form` - Queues project for training.
* `train_project_json` - Queues project for training.
* `train_project_raw` - Queues project for training.
