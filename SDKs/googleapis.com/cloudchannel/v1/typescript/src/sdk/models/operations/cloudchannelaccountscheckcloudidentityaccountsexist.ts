...
export class CloudchannelAccountsCheckCloudIdentityAccountsExistSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCheckCloudIdentityAccountsExistRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCheckCloudIdentityAccountsExistResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
