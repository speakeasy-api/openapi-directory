 ...
 */
export enum OperationAggregatedListWarningCodeEnum {
...
export class OperationAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class OperationAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: OperationAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class OperationAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: OperationsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, OperationsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], OperationsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
