...
class GetUsersIdsTagsQueryParams:
    ...
    order: Optional[GetUsersIdsTagsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsTagsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetUsersIdsTagsRequest:
    path_params: GetUsersIdsTagsPathParams = dataclasses.field()
    query_params: GetUsersIdsTagsQueryParams = dataclasses.field()
