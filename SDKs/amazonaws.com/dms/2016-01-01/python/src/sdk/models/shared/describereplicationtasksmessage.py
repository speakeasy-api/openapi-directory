...
class DescribeReplicationTasksMessage:
    ...
    without_settings: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WithoutSettings'), 'exclude': lambda f: f is None }})  
