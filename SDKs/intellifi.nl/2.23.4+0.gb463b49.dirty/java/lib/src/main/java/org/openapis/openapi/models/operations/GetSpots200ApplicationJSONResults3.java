...
public class GetSpots200ApplicationJSONResults3 {
    /**
    ...
    public GetSpots200ApplicationJSONResults3AntennaReportLocations[] antennaReportLocations;

    public GetSpots200ApplicationJSONResults3 withAntennaReportLocations(GetSpots200ApplicationJSONResults3AntennaReportLocations[] antennaReportLocations) {
    ...
    public GetSpots200ApplicationJSONResults3 withConfig(java.util.Map<String, Object> config) {
        this.config = config;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults3 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetSpots200ApplicationJSONResults3 withGeoCoords(org.openapis.openapi.models.shared.GeoCoords geoCoords) {
    ...
    public GetSpots200ApplicationJSONResults3 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults3 withIsOnline(Boolean isOnline) {
    ...
    public GetSpots200ApplicationJSONResults3 withReportLocationUrl(String reportLocationUrl) {
    ...
    public GetSpots200ApplicationJSONResults3 withRequestCounter(Long requestCounter) {
    ...
    public GetSpots200ApplicationJSONResults3 withSenses(java.util.Map<String, Object> senses) {
        this.senses = senses;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults3 withSensesRequest(java.util.Map<String, Object> sensesRequest) {
    ...
    public GetSpots200ApplicationJSONResults3 withSerialNumber(Long serialNumber) {
    ...
    public GetSpots200ApplicationJSONResults3 withStatus(Object status) {
        this.status = status;
        return this;
    }
    ...
    public GetSpots200ApplicationJSONResults3 withTimeCreated(String timeCreated) {
    ...
    public GetSpots200ApplicationJSONResults3 withTimeUpdated(String timeUpdated) {
    ...
    public GetSpots200ApplicationJSONResults3 withUrl(String url) {
        this.url = url;
        return this;
    }
    
    public GetSpots200ApplicationJSONResults3(){}
}
