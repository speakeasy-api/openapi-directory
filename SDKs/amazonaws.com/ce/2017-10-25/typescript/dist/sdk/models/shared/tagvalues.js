 ...
 */
var TagValues = /** @class */ (function (_super) {
    __extends(TagValues, _super);
    function TagValues() {
    ...
    ], TagValues.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MatchOptions" }),
        __metadata("design:type", Array)
    ], TagValues.prototype, "matchOptions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Values" }),
        __metadata("design:type", Array)
    ], TagValues.prototype, "values", void 0);
    return TagValues;
