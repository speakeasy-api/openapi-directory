...
func (s *itemGroup) GetItemGroupFeed(ctx context.Context, request operations.GetItemGroupFeedRequest, security operations.GetItemGroupFeedSecurity) (*operations.GetItemGroupFeedResponse, error) {
	baseURL := s.serverURL
