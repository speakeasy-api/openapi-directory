...
exports.IssuesListForRepoResponse = exports.IssuesListForRepoRequest = exports.IssuesListForRepoStateEnum = exports.IssuesListForRepoSortEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * What to sort results by.
 */
var IssuesListForRepoSortEnum;
...
})(IssuesListForRepoSortEnum = exports.IssuesListForRepoSortEnum || (exports.IssuesListForRepoSortEnum = {}));
/**
 * Indicates the state of the issues to return.
 */
var IssuesListForRepoStateEnum;
...
})(IssuesListForRepoStateEnum = exports.IssuesListForRepoStateEnum || (exports.IssuesListForRepoStateEnum = {}));
var IssuesListForRepoRequest = /** @class */ (function (_super) {
    ...
    ], IssuesListForRepoRequest.prototype, "assignee", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=creator",
        }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "creator", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=direction",
        }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=labels",
        }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "labels", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=mentioned",
        }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "mentioned", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=milestone",
        }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "milestone", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], IssuesListForRepoRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], IssuesListForRepoRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=since;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], IssuesListForRepoRequest.prototype, "since", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=state" }),
        __metadata("design:type", String)
    ], IssuesListForRepoRequest.prototype, "state", void 0);
...
var IssuesListForRepoResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], IssuesListForRepoResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], IssuesListForRepoResponse.prototype, "issues", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
