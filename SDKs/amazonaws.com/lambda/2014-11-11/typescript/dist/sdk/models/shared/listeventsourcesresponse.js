...
var ListEventSourcesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: eventsourceconfiguration_1.EventSourceConfiguration }),
        (0, class_transformer_1.Expose)({ name: "EventSources" }),
        (0, class_transformer_1.Type)(function () { return eventsourceconfiguration_1.EventSourceConfiguration; }),
