...
exports.MergePullRequestByThreeWayInput = void 0;
...
var MergePullRequestByThreeWayInput = /** @class */ (function (_super) {
    __extends(MergePullRequestByThreeWayInput, _super);
    ...
    ], MergePullRequestByThreeWayInput.prototype, "authorName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=commitMessage" }),
        __metadata("design:type", String)
    ], MergePullRequestByThreeWayInput.prototype, "commitMessage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conflictDetailLevel" }),
        __metadata("design:type", String)
    ], MergePullRequestByThreeWayInput.prototype, "conflictDetailLevel", void 0);
    __decorate([
    ...
    ], MergePullRequestByThreeWayInput.prototype, "conflictResolution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conflictResolutionStrategy" }),
        __metadata("design:type", String)
    ], MergePullRequestByThreeWayInput.prototype, "conflictResolutionStrategy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=email" }),
        __metadata("design:type", String)
    ], MergePullRequestByThreeWayInput.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=keepEmptyFolders" }),
        __metadata("design:type", Boolean)
    ], MergePullRequestByThreeWayInput.prototype, "keepEmptyFolders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pullRequestId" }),
        __metadata("design:type", String)
    ], MergePullRequestByThreeWayInput.prototype, "pullRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=repositoryName" }),
        __metadata("design:type", String)
    ], MergePullRequestByThreeWayInput.prototype, "repositoryName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sourceCommitId" }),
        __metadata("design:type", String)
    ], MergePullRequestByThreeWayInput.prototype, "sourceCommitId", void 0);
    return MergePullRequestByThreeWayInput;
