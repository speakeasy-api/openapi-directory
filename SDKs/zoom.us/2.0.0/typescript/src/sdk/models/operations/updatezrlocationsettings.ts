 ...
 */
export class UpdateZRLocationSettingsApplicationJson2ClientAlert extends SpeakeasyBase {
  /**
...
export class UpdateZRLocationSettingsApplicationJson2DigitalSignageBanner extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class UpdateZRLocationSettingsApplicationJson2DigitalSignageDisplayPeriod extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayListActionEnum {
  Add = "add",
  Update = "update",
  Delete = "delete",
}
 ...
 * Content list.
 */
export class UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayListContents extends SpeakeasyBase {
  /**
...
export class UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayList extends SpeakeasyBase {
  /**
   * Specify an action for the content list. The value can be one of the following:<br>
   *
   * @remarks
  ...
  @SpeakeasyMetadata({
    elemType:
      UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayListContents,
  })
...
export class UpdateZRLocationSettingsApplicationJson2DigitalSignage extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "banner" })
  @Type(() => UpdateZRLocationSettingsApplicationJson2DigitalSignageBanner)
  ...
  @Type(
    () => UpdateZRLocationSettingsApplicationJson2DigitalSignageDisplayPeriod
  )
  ...
  @Type(() => UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayList)
 ...
 */
export class UpdateZRLocationSettingsApplicationJson2Notification extends SpeakeasyBase {
  /**
...
export class UpdateZRLocationSettingsApplicationJson2 extends SpeakeasyBase {
  /**
   * The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "client_alert" })
  @Type(() => UpdateZRLocationSettingsApplicationJson2ClientAlert)
  clientAlert?: UpdateZRLocationSettingsApplicationJson2ClientAlert;

  @SpeakeasyMetadata()
  @Expose({ name: "digital_signage" })
  @Type(() => UpdateZRLocationSettingsApplicationJson2DigitalSignage)
  ...
  @Type(() => UpdateZRLocationSettingsApplicationJson2Notification)
 ...
 */
export enum UpdateZRLocationSettingsApplicationJson1MeetingSecurityEncryptionTypeEnum {
  EnhancedEncryption = "enhanced_encryption",
  E2ee = "e2ee",
}

export class UpdateZRLocationSettingsApplicationJson1MeetingSecurity extends SpeakeasyBase {
  /**
   * Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
   *
   * @remarks
...
export class UpdateZRLocationSettingsApplicationJson1ZoomRooms extends SpeakeasyBase {
  /**
...
export class UpdateZRLocationSettingsApplicationJson1 extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meeting_security" })
  @Type(() => UpdateZRLocationSettingsApplicationJson1MeetingSecurity)
  meetingSecurity?: UpdateZRLocationSettingsApplicationJson1MeetingSecurity;

  @SpeakeasyMetadata()
  @Expose({ name: "zoom_rooms" })
  @Type(() => UpdateZRLocationSettingsApplicationJson1ZoomRooms)
