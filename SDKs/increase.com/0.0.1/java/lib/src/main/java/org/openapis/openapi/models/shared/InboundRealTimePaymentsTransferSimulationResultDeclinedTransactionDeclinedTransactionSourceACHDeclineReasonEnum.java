 ...
 */
public enum InboundRealTimePaymentsTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceACHDeclineReasonEnum {
    ...
    private InboundRealTimePaymentsTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceACHDeclineReasonEnum(String value) {
        this.value = value;
    }
}
