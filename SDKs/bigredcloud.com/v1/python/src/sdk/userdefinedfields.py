...
class UserDefinedFields:
    ...
    def user_defined_fields_get(self) -> operations.UserDefinedFieldsGetResponse:
        ...
        res = operations.UserDefinedFieldsGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PageResultUserDefinedFieldDto])
                res.page_result_user_defined_field_dto = out
