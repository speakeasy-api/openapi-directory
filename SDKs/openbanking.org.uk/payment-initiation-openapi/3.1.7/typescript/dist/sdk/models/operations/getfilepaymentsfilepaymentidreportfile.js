...
exports.GetFilePaymentsFilePaymentIdReportFileResponse = exports.GetFilePaymentsFilePaymentIdReportFileRequest = exports.GetFilePaymentsFilePaymentIdReportFileSecurity = void 0;
...
exports.GetFilePaymentsFilePaymentIdReportFileSecurity = GetFilePaymentsFilePaymentIdReportFileSecurity;
var GetFilePaymentsFilePaymentIdReportFileRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdReportFileRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FilePaymentId",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdReportFileRequest.prototype, "filePaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdReportFileRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdReportFileRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdReportFileRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentsFilePaymentIdReportFileRequest.prototype, "xFapiInteractionId", void 0);
    return GetFilePaymentsFilePaymentIdReportFileRequest;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentsFilePaymentIdReportFileRequest = GetFilePaymentsFilePaymentIdReportFileRequest;
var GetFilePaymentsFilePaymentIdReportFileResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetFilePaymentsFilePaymentIdReportFileResponse.prototype, "rawResponse", void 0);
    return GetFilePaymentsFilePaymentIdReportFileResponse;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentsFilePaymentIdReportFileResponse = GetFilePaymentsFilePaymentIdReportFileResponse;
