...
var TagsApi = /** @class */ (function () {
    ...
    **/
    TagsApi.prototype.createTag = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/projects/{projectId}/tags", req.pathParams);
    ...
    **/
    TagsApi.prototype.deleteTag = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/projects/{projectId}/tags/{tagId}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
    ...
    **/
    TagsApi.prototype.updateTag = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
