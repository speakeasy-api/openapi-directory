...
public class CreateInternationalStandingOrdersJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalStandingOrdersJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalStandingOrdersJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalStandingOrdersJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalStandingOrdersJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalStandingOrdersJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalStandingOrdersJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalStandingOrdersJsonHeaders withXJwsSignature(String xJwsSignature) {
