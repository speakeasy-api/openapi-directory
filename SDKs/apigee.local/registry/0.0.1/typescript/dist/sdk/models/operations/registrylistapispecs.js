...
exports.RegistryListApiSpecsResponse = exports.RegistryListApiSpecsRequest = void 0;
...
var RegistryListApiSpecsRequest = /** @class */ (function (_super) {
    ...
    ], RegistryListApiSpecsRequest.prototype, "api", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], RegistryListApiSpecsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=location",
        }),
        __metadata("design:type", String)
    ], RegistryListApiSpecsRequest.prototype, "location", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], RegistryListApiSpecsRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageToken",
        }),
        __metadata("design:type", String)
    ], RegistryListApiSpecsRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project",
        }),
        __metadata("design:type", String)
    ], RegistryListApiSpecsRequest.prototype, "project", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=version",
        }),
        __metadata("design:type", String)
    ], RegistryListApiSpecsRequest.prototype, "version", void 0);
...
var RegistryListApiSpecsResponse = /** @class */ (function (_super) {
    ...
    ], RegistryListApiSpecsResponse.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
    ...
    ], RegistryListApiSpecsResponse.prototype, "rawResponse", void 0);
