...
type CreateFilePaymentConsentsRawSecurity struct {
	TPPOAuth2Security shared.SchemeTppoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateFilePaymentConsentsRawHeaders struct {
...
type CreateFilePaymentConsentsRawRequest struct {
	Headers CreateFilePaymentConsentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateFilePaymentConsentsRawSecurity
}

type CreateFilePaymentConsentsRawResponse struct {
	Body        []byte
	ContentType string
