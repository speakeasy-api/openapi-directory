...
from ..shared import createuserprofileresponse as shared_createuserprofileresponse
...
class CreateUserProfileResponse:
    ...
    create_user_profile_response: Optional[shared_createuserprofileresponse.CreateUserProfileResponse] = dataclasses.field(default=None)
    r"""Success"""  
