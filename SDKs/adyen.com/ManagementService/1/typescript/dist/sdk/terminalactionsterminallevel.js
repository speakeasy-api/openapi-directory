...
exports.TerminalActionsTerminalLevel = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var shared = __importStar(require("./models/shared"));
var TerminalActionsTerminalLevel = /** @class */ (function () {
    function TerminalActionsTerminalLevel(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    TerminalActionsTerminalLevel.prototype.postTerminalsScheduleActions = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.ScheduleTerminalActionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/terminals/scheduleActions";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostTerminalsScheduleActionsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.scheduleTerminalActionsResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ScheduleTerminalActionsResponse);
                    }
                    break;
...
exports.TerminalActionsTerminalLevel = TerminalActionsTerminalLevel;
