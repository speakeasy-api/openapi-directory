...
exports.CreatePlaceIndexResponse = exports.CreatePlaceIndexRequest = exports.CreatePlaceIndexRequestBody = exports.CreatePlaceIndexRequestBodyPricingPlanEnum = exports.CreatePlaceIndexRequestBodyDataSourceConfiguration = void 0;
...
exports.CreatePlaceIndexRequestBodyDataSourceConfiguration = CreatePlaceIndexRequestBodyDataSourceConfiguration;
/**
 * No longer used. If included, the only allowed value is <code>RequestBasedUsage</code>.
 */
var CreatePlaceIndexRequestBodyPricingPlanEnum;
...
})(CreatePlaceIndexRequestBodyPricingPlanEnum = exports.CreatePlaceIndexRequestBodyPricingPlanEnum || (exports.CreatePlaceIndexRequestBodyPricingPlanEnum = {}));
var CreatePlaceIndexRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return CreatePlaceIndexRequestBodyDataSourceConfiguration; }),
...
exports.CreatePlaceIndexRequestBody = CreatePlaceIndexRequestBody;
var CreatePlaceIndexRequest = /** @class */ (function (_super) {
    ...
    ], CreatePlaceIndexRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreatePlaceIndexRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreatePlaceIndexRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreatePlaceIndexRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreatePlaceIndexRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreatePlaceIndexRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreatePlaceIndexRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreatePlaceIndexRequest.prototype, "xAmzSignedHeaders", void 0);
...
var CreatePlaceIndexResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreatePlaceIndexResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreatePlaceIndexResponse.prototype, "serviceQuotaExceededException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
