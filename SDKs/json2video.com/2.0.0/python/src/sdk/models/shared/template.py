...
class TemplatePanEnum(str, Enum):
...
class TemplatePositionEnum(str, Enum):
...
class Template:
    ...
    r"""ID of the Component element. Check all available components at <a href='https://json2video.com/docs/resources/basic/'>https://json2video.com/docs/resources/basic/</a>"""  
    type: TemplateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
    ...
    chroma_key: Optional[TemplateChromaKey] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('chroma-key'), 'exclude': lambda f: f is None }})
    r"""Allows to define a color (or a range of colors) that will be converted to transparent"""  
    comment: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('comment'), 'exclude': lambda f: f is None }})
    r"""Used for adding your comments"""  
    crop: Optional[TemplateCrop] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('crop'), 'exclude': lambda f: f is None }})
    r"""Crops the element"""  
    ...
    pan: Optional[TemplatePanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pan'), 'exclude': lambda f: f is None }})
    r"""Pans the element to the specified direction. If <code>zoom</code> property is not specified, the effect is a non-zooming pan"""  
    position: Optional[TemplatePositionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('position'), 'exclude': lambda f: f is None }})
    r"""Sets the element position in the scene. A value of 'custom' sets a custom position based on the provided 'x' and 'y' properties"""  
    rotate: Optional[TemplateRotate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rotate'), 'exclude': lambda f: f is None }})  
    scale: Optional[TemplateScale] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scale'), 'exclude': lambda f: f is None }})  
