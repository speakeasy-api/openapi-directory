...
export class GkebackupProjectsLocationsRestorePlansListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsRestorePlansListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
