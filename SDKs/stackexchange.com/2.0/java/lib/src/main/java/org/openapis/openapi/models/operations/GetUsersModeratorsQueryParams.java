...
public class GetUsersModeratorsQueryParams {
    /**
    ...
    public GetUsersModeratorsQueryParams withCallback(String callback) {
    ...
    public GetUsersModeratorsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersModeratorsQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetUsersModeratorsQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetUsersModeratorsQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetUsersModeratorsOrderEnum order;
    public GetUsersModeratorsQueryParams withOrder(GetUsersModeratorsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetUsersModeratorsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersModeratorsQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetUsersModeratorsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetUsersModeratorsSortEnum sort;
    public GetUsersModeratorsQueryParams withSort(GetUsersModeratorsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetUsersModeratorsQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
