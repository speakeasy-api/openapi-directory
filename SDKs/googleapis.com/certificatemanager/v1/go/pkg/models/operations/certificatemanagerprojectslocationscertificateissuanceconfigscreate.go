...
type CertificatemanagerProjectsLocationsCertificateIssuanceConfigsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CertificatemanagerProjectsLocationsCertificateIssuanceConfigsCreatePathParams struct {
	// Required. The parent resource of the certificate issuance config. Must be in the format `projects/*/locations/*`.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type CertificatemanagerProjectsLocationsCertificateIssuanceConfigsCreateQueryParams struct {
	// V1 error format.
	...
	CertificateIssuanceConfigID *string `queryParam:"style=form,explode=true,name=certificateIssuanceConfigId"`
...
type CertificatemanagerProjectsLocationsCertificateIssuanceConfigsCreateResponse struct {
	ContentType string
	// Successful response
