...
export declare class DisplayvideoTargetingTypesTargetingOptionsGetSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoTargetingTypesTargetingOptionsGetTargetingTypeEnum {
...
export declare class DisplayvideoTargetingTypesTargetingOptionsGetRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DisplayvideoTargetingTypesTargetingOptionsGetResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
