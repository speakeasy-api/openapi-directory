...
class RecognitionConfigInput:
    ...
    r"""If set, specifies the estimated number of speakers in the conversation. Defaults to '2'. Ignored unless enable_speaker_diarization is set to true. Note: Use diarization_config instead."""  
    ...
    r"""If 'true', enables speaker detection for each recognized word in the top alternative of the recognition result using a speaker_label provided in the WordInfo. Note: Use diarization_config instead."""  
    ...
    transcript_normalization: Optional[shared_transcriptnormalization.TranscriptNormalization] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transcriptNormalization'), 'exclude': lambda f: f is None }})
