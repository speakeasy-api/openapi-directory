...
class StartSupportDataExportRequest:
    ...
    start_support_data_export_request: shared_startsupportdataexportrequest.StartSupportDataExportRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
