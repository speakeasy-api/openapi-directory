...
type RequestreportbyorderdateQueryParams struct {
...
type RequestreportbyorderdateHeaders struct {
...
type RequestreportbyorderdateRequest struct {
	QueryParams RequestreportbyorderdateQueryParams
	Headers     RequestreportbyorderdateHeaders
}

type RequestreportbyorderdateResponse struct {
	ContentType string
	StatusCode  int
