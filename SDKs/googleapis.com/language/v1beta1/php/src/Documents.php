...
class Documents 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\LanguageDocumentsAnalyzeEntitiesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/documents:analyzeEntities');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/documents:analyzeSentiment');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/documents:analyzeSyntax');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/documents:annotateText');
