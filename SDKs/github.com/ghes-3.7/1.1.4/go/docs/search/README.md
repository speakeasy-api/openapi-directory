...
<https://docs.github.com/enterprise-server@3.7/rest/reference/search#search-code>
...
func main() {
    ...
    res, err := s.Search.SearchCode(ctx, operations.SearchCodeRequest{
        ...
        Page: sdk.Int64(943063),
        PerPage: sdk.Int64(980649),
        Q: "asperiores",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/search#search-commits>
...
func main() {
    ...
    res, err := s.Search.SearchCommits(ctx, operations.SearchCommitsRequest{
        ...
        Page: sdk.Int64(198892),
        PerPage: sdk.Int64(585628),
        Q: "animi",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/search#search-issues-and-pull-requests>
...
func main() {
    ...
    res, err := s.Search.SearchIssuesAndPullRequests(ctx, operations.SearchIssuesAndPullRequestsRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(56998),
        PerPage: sdk.Int64(650914),
        Q: "nam",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/search#search-labels>
...
func main() {
    ...
    res, err := s.Search.SearchLabels(ctx, operations.SearchLabelsRequest{
        Order: shared.OrderEnumAsc.ToPointer(),
        Page: sdk.Int64(684499),
        PerPage: sdk.Int64(733763),
        Q: "commodi",
        RepositoryID: 146742,
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/search#search-repositories>
...
func main() {
    ...
    res, err := s.Search.SearchRepos(ctx, operations.SearchReposRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(393122),
        PerPage: sdk.Int64(397160),
        Q: "provident",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/search#search-topics>
...
func main() {
    ...
    res, err := s.Search.SearchTopics(ctx, operations.SearchTopicsRequest{
        Page: sdk.Int64(881568),
        PerPage: sdk.Int64(68292),
        Q: "itaque",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/search#search-users>
...
func main() {
    ...
    res, err := s.Search.SearchUsers(ctx, operations.SearchUsersRequest{
        Order: shared.OrderEnumAsc.ToPointer(),
        Page: sdk.Int64(53529),
        PerPage: sdk.Int64(4929),
        Q: "qui",
