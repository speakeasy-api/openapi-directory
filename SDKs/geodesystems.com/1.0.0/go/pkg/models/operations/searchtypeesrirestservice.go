...
type SearchTypeEsriRestserviceQueryParams struct {
...
type SearchTypeEsriRestserviceRequest struct {
	QueryParams SearchTypeEsriRestserviceQueryParams
}

type SearchTypeEsriRestserviceResponse struct {
	ContentType string
	StatusCode  int
