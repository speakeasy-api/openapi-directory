...
class SDK
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\LineCombinationsBySeasonRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\LineCombinationsBySeasonResponse
     */
	public function lineCombinationsBySeason(
        \OpenAPI\OpenAPI\Models\Operations\LineCombinationsBySeasonRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\LineCombinationsBySeasonResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{format}/LinesBySeason/{season}', \OpenAPI\OpenAPI\Models\Operations\LineCombinationsBySeasonRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\LineCombinationsBySeasonResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->teamLines = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\TeamLine>', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\TeamStatsAllowedByPositionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\TeamStatsAllowedByPositionResponse
     */
	public function teamStatsAllowedByPosition(
        \OpenAPI\OpenAPI\Models\Operations\TeamStatsAllowedByPositionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\TeamStatsAllowedByPositionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{format}/TeamStatsAllowedByPosition/{season}', \OpenAPI\OpenAPI\Models\Operations\TeamStatsAllowedByPositionRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\TeamStatsAllowedByPositionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
