...
var UserPasswordValidationPolicy = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "allowedFailedAttempts" }),
        __metadata("design:type", Number)
    ], UserPasswordValidationPolicy.prototype, "allowedFailedAttempts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "enableFailedAttemptsCheck" }),
        __metadata("design:type", Boolean)
    ], UserPasswordValidationPolicy.prototype, "enableFailedAttemptsCheck", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "enablePasswordVerification" }),
        __metadata("design:type", Boolean)
    ], UserPasswordValidationPolicy.prototype, "enablePasswordVerification", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "passwordExpirationDuration" }),
        __metadata("design:type", String)
    ], UserPasswordValidationPolicy.prototype, "passwordExpirationDuration", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "status" }),
        (0, class_transformer_1.Type)(function () { return passwordstatus_1.PasswordStatus; }),
