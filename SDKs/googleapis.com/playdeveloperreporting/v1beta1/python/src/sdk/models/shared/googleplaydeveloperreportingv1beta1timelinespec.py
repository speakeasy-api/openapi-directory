...
class GooglePlayDeveloperReportingV1beta1TimelineSpec:
    r"""GooglePlayDeveloperReportingV1beta1TimelineSpec
    ...
    aggregation_period: Optional[GooglePlayDeveloperReportingV1beta1TimelineSpecAggregationPeriodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('aggregationPeriod') }})
