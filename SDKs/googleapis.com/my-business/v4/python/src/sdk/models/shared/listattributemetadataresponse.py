...
class ListAttributeMetadataResponse:
    r"""Response message for Locations.ListAttributeMetadata."""
    
    attributes: Optional[list[shared_attributemetadata.AttributeMetadata]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes'), 'exclude': lambda f: f is None }})
