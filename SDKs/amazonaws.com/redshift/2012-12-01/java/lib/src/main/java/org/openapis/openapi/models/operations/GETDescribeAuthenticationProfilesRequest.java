...
public class GETDescribeAuthenticationProfilesRequest {
    ...
    public GETDescribeAuthenticationProfilesRequest(@JsonProperty("Action") GETDescribeAuthenticationProfilesActionEnum action, @JsonProperty("Version") GETDescribeAuthenticationProfilesVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
