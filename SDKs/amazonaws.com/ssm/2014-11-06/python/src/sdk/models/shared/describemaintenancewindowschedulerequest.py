...
from ..shared import patchorchestratorfilter as shared_patchorchestratorfilter
...
class DescribeMaintenanceWindowScheduleRequest:
    ...
    filters: Optional[list[shared_patchorchestratorfilter.PatchOrchestratorFilter]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Filters'), 'exclude': lambda f: f is None }})  
