...
type VmmigrationProjectsLocationsSourcesMigratingVmsCloneJobsListPathParams struct {
	// Required. The parent, which owns this collection of source VMs.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type VmmigrationProjectsLocationsSourcesMigratingVmsCloneJobsListQueryParams struct {
	// V1 error format.
