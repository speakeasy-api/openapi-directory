...
public class BigquerydatatransferProjectsTransferConfigsRunsDeletePathParams {
    /**
    ...
    public String name;
    public BigquerydatatransferProjectsTransferConfigsRunsDeletePathParams withName(String name) {
        this.name = name;
        return this;
    }
