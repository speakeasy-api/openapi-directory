...
public class EstimationApiNewFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiNewFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiNewFormHeaders withXAuthSecret(String xAuthSecret) {
