 ...
 */
export declare const ServerList: readonly ["http://ingest.timestream.{region}.amazonaws.com", "https://ingest.timestream.{region}.amazonaws.com", "http://ingest.timestream.{region}.amazonaws.com.cn", "https://ingest.timestream.{region}.amazonaws.com.cn"];
/**
...
export declare class SDK {
     ...
     */
    createBatchLoadTask(req: operations.CreateBatchLoadTaskRequest, config?: AxiosRequestConfig): Promise<operations.CreateBatchLoadTaskResponse>;
    /**
     ...
     */
    describeBatchLoadTask(req: operations.DescribeBatchLoadTaskRequest, config?: AxiosRequestConfig): Promise<operations.DescribeBatchLoadTaskResponse>;
    /**
     ...
     */
    describeDatabase(req: operations.DescribeDatabaseRequest, config?: AxiosRequestConfig): Promise<operations.DescribeDatabaseResponse>;
    /**
     ...
     */
    listBatchLoadTasks(req: operations.ListBatchLoadTasksRequest, config?: AxiosRequestConfig): Promise<operations.ListBatchLoadTasksResponse>;
    /**
     ...
     *
     */
    resumeBatchLoadTask(req: operations.ResumeBatchLoadTaskRequest, config?: AxiosRequestConfig): Promise<operations.ResumeBatchLoadTaskResponse>;
    /**
     ...
     */
    writeRecords(req: operations.WriteRecordsRequest, config?: AxiosRequestConfig): Promise<operations.WriteRecordsResponse>;
}
