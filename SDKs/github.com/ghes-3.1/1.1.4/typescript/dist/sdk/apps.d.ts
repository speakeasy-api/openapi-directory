...
export declare class Apps {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#add-a-repository-to-an-app-installation} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#check-an-authorization} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#check-a-token} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#create-a-content-attachment} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#create-a-github-app-from-a-manifest} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps/#create-an-installation-access-token-for-an-app} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#delete-an-app-authorization} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#delete-an-installation-for-the-authenticated-app} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#delete-an-app-token} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-the-authenticated-app} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps/#get-an-app} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-an-installation-for-the-authenticated-app} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-an-organization-installation-for-the-authenticated-app} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-a-repository-installation-for-the-authenticated-app} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-a-user-installation-for-the-authenticated-app} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#get-a-webhook-configuration-for-an-app} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#list-repositories-accessible-to-the-user-access-token} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#list-installations-for-the-authenticated-app} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#list-app-installations-accessible-to-the-user-access-token} - API method documentation
     */
     ...
     * You must use an [installation access token](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-an-installation) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#list-repositories-accessible-to-the-app-installation} - API method documentation
     */
     ...
     * You must use a personal access token (which you can create via the [command line](https://docs.github.com/enterprise-server@3.1/github/authenticating-to-github/creating-a-personal-access-token) or [Basic Authentication](https://docs.github.com/enterprise-server@3.1/rest/overview/other-authentication-methods#basic-authentication)) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#remove-a-repository-from-an-app-installation} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#reset-an-authorization} - API method documentation
     */
     ...
     * OAuth applications can use this API method to reset a valid OAuth token without end-user involvement. Applications must save the "token" property in the response because changes take effect immediately. You must use [Basic Authentication](https://docs.github.com/enterprise-server@3.1/rest/overview/other-authentication-methods#basic-authentication) when accessing this endpoint, using the OAuth application's `client_id` and `client_secret` as the username and password. Invalid tokens will return `404 NOT FOUND`.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#reset-a-token} - API method documentation
     */
     ...
     * OAuth application owners can revoke a single token for an OAuth application. You must use [Basic Authentication](https://docs.github.com/enterprise-server@3.1/rest/overview/other-authentication-methods#basic-authentication) when accessing this endpoint, using the OAuth application's `client_id` and `client_secret` as the username and password.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#revoke-an-authorization-for-an-application} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#revoke-a-grant-for-an-application} - API method documentation
     */
     ...
     * You must use an [installation access token](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-an-installation) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#revoke-an-installation-access-token} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#create-a-scoped-access-token} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#suspend-an-app-installation} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#unsuspend-an-app-installation} - API method documentation
     */
     ...
     * You must use a [JWT](https://docs.github.com/enterprise-server@3.1/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.1/rest/reference/apps#update-a-webhook-configuration-for-an-app} - API method documentation
     */
