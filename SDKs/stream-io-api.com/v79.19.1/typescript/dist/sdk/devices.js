...
var Devices = /** @class */ (function () {
     ...
     */
    Devices.prototype.createDevice = function (req, config) {
        var _a;
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CreateDeviceResponse({
     ...
     * Deletes device
     */
    Devices.prototype.deleteDevice = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.DeleteDeviceResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
     ...
     */
    Devices.prototype.listDevices = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
