...
class TimeOffRequestsOneRequest:
    headers: TimeOffRequestsOneHeaders = dataclasses.field()
    path_params: TimeOffRequestsOnePathParams = dataclasses.field()
    query_params: TimeOffRequestsOneQueryParams = dataclasses.field()
    security: TimeOffRequestsOneSecurity = dataclasses.field()
