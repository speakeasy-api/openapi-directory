...
public class GETModifyUsageLimitRequest {
    ...
    public GETModifyUsageLimitRequest(@JsonProperty("Action") GETModifyUsageLimitActionEnum action, @JsonProperty("UsageLimitId") String usageLimitId, @JsonProperty("Version") GETModifyUsageLimitVersionEnum version) {
        this.action = action;
        this.usageLimitId = usageLimitId;
        this.version = version;
  }
