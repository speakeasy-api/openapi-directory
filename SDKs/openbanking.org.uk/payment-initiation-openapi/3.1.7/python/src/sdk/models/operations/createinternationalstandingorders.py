...
class CreateInternationalStandingOrdersRequests:
    ...
    ob_write_international_standing_order4: Optional[shared_obwriteinternationalstandingorder4.ObWriteInternationalStandingOrder4] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    ob_write_international_standing_order5: Optional[shared_obwriteinternationalstandingorder4.ObWriteInternationalStandingOrder4] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateInternationalStandingOrdersRequest:
    headers: CreateInternationalStandingOrdersHeaders = dataclasses.field()
    request: CreateInternationalStandingOrdersRequests = dataclasses.field()
    security: CreateInternationalStandingOrdersSecurity = dataclasses.field()
