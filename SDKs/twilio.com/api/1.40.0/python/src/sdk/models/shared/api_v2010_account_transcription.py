...
class APIV2010AccountTranscription:
    ...
    status: Optional[shared_transcription_enum_status_enum.TranscriptionEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
    ...
    r"""The transcription type. Can only be: `fast`."""  
