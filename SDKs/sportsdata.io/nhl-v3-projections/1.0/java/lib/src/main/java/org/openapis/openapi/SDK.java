...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.StartingGoaltendersByDateResponse startingGoaltendersByDate(org.openapis.openapi.models.operations.StartingGoaltendersByDateRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.StartingGoaltendersByDateResponse res = new org.openapis.openapi.models.operations.StartingGoaltendersByDateResponse(contentType, httpRes.statusCode()) {{
            startingGoaltenders = null;
        }};
        res.rawResponse = httpRes;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.StartingGoaltenders[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.StartingGoaltenders[].class);
