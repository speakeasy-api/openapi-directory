...
class FindPlacesFindPlacesGetRequest
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\FindPlacesFindPlacesGetLanguageLanguageEnum $language
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=language')]
    public ?FindPlacesFindPlacesGetLanguageLanguageEnum $language = null;
