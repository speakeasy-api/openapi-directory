...
class ListFlowRevisionListFlowRevisionResponse:
    ...
    meta: Optional[ListFlowRevisionListFlowRevisionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    revisions: Optional[list[shared_studio_v2_flow_flow_revision.StudioV2FlowFlowRevision]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('revisions'), 'exclude': lambda f: f is None }})  
