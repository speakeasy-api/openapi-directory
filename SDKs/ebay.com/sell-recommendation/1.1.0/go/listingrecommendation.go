...
func (s *listingRecommendation) FindListingRecommendations(ctx context.Context, request operations.FindListingRecommendationsRequest, security operations.FindListingRecommendationsSecurity) (*operations.FindListingRecommendationsResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/find"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "FindListingRecommendationRequest", "json")
	if err != nil {
