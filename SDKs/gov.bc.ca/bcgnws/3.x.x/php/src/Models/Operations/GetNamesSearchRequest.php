...
class GetNamesSearchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesSearchEmbedEnum $embed
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=embed')]
    public ?GetNamesSearchEmbedEnum $embed = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesSearchExactSpellingEnum $exactSpelling
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=exactSpelling')]
    public ?GetNamesSearchExactSpellingEnum $exactSpelling = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\GetNamesSearchOutputFormatEnum $outputFormat
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesSearchOutputSrsEnum $outputSRS
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputSRS')]
    public ?GetNamesSearchOutputSrsEnum $outputSRS = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesSearchOutputStyleEnum $outputStyle
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=outputStyle')]
    public ?GetNamesSearchOutputStyleEnum $outputStyle = null;
    
    /**
     * The distance to move the accessPoint away from the curb and towards the inside of the parcel (in metres). Ignored if locationDescriptor not set to accessPoint.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNamesSearchSortByEnum $sortBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortBy')]
    public ?GetNamesSearchSortByEnum $sortBy = null;
	...
	public function __construct()
	{
		...
		$this->name = "";
		$this->outputFormat = \OpenAPI\OpenAPI\Models\Operations\GetNamesSearchOutputFormatEnum::JSON;
		$this->outputSRS = null;
