...
public class GETARPaymentType {
    ...
    public GETARPaymentType withIntegrationIdNS(String integrationIdNS) {
    ...
    public GETARPaymentType withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public GETARPaymentType withOriginNS(String originNS) {
    ...
    public GETARPaymentType withSyncDateNS(String syncDateNS) {
    ...
    public GETARPaymentType withTransactionNS(String transactionNS) {
    ...
    public GETARPaymentType withAccountId(String accountId) {
    ...
    public GETARPaymentType withAmount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public GETARPaymentType withAppliedAmount(Double appliedAmount) {
    ...
    public GETARPaymentType withAuthTransactionId(String authTransactionId) {
    ...
    public GETARPaymentType withBankIdentificationNumber(String bankIdentificationNumber) {
    ...
    public GETARPaymentType withCancelledOn(OffsetDateTime cancelledOn) {
    ...
    public GETARPaymentType withComment(String comment) {
    ...
    public GETARPaymentType withCreatedById(String createdById) {
    ...
    public GETARPaymentType withCreatedDate(OffsetDateTime createdDate) {
    ...
    public GETARPaymentType withCreditBalanceAmount(Double creditBalanceAmount) {
    ...
    public GETARPaymentType withCurrency(String currency) {
    ...
    public GETARPaymentType withEffectiveDate(OffsetDateTime effectiveDate) {
    ...
    public GETARPaymentTypeFinanceInformation financeInformation;
    public GETARPaymentType withFinanceInformation(GETARPaymentTypeFinanceInformation financeInformation) {
    ...
    public GETARPaymentType withGatewayId(String gatewayId) {
    ...
    public GETARPaymentType withGatewayOrderId(String gatewayOrderId) {
    ...
    public GETARPaymentType withGatewayReconciliationReason(String gatewayReconciliationReason) {
    ...
    public GETARPaymentType withGatewayReconciliationStatus(String gatewayReconciliationStatus) {
    ...
    public GETARPaymentType withGatewayResponse(String gatewayResponse) {
    ...
    public GETARPaymentType withGatewayResponseCode(String gatewayResponseCode) {
    ...
    public GETARPaymentTypeGatewayStateEnum gatewayState;
    public GETARPaymentType withGatewayState(GETARPaymentTypeGatewayStateEnum gatewayState) {
    ...
    @JsonProperty("id")
    public String id;
    public GETARPaymentType withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GETARPaymentType withMarkedForSubmissionOn(OffsetDateTime markedForSubmissionOn) {
    ...
    public GETARPaymentType withNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    public GETARPaymentType withPaymentMethodId(String paymentMethodId) {
    ...
    public GETARPaymentType withPaymentMethodSnapshotId(String paymentMethodSnapshotId) {
    ...
    public GETARPaymentType withPayoutId(String payoutId) {
    ...
    public GETARPaymentType withReferenceId(String referenceId) {
    ...
    public GETARPaymentType withRefundAmount(Double refundAmount) {
    ...
    public GETARPaymentType withSecondPaymentReferenceId(String secondPaymentReferenceId) {
    ...
    public GETARPaymentType withSettledOn(OffsetDateTime settledOn) {
    ...
    public GETARPaymentType withSoftDescriptor(String softDescriptor) {
    ...
    public GETARPaymentType withSoftDescriptorPhone(String softDescriptorPhone) {
    ...
    public GETARPaymentType withStandalone(Boolean standalone) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    public GETARPaymentTypeStatusEnum status;
    public GETARPaymentType withStatus(GETARPaymentTypeStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public GETARPaymentType withSubmittedOn(OffsetDateTime submittedOn) {
    ...
    public GETARPaymentType withSuccess(Boolean success) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public GETARPaymentTypeTypeEnum type;
    public GETARPaymentType withType(GETARPaymentTypeTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GETARPaymentType withUnappliedAmount(Double unappliedAmount) {
    ...
    public GETARPaymentType withUpdatedById(String updatedById) {
    ...
    public GETARPaymentType withUpdatedDate(OffsetDateTime updatedDate) {
