...
public class FirewallPolicyRule {
    ...
    public FirewallPolicyRule withSecurityProfileGroup(String securityProfileGroup) {
    ...
    public Boolean tlsInspect;
    public FirewallPolicyRule withTlsInspect(Boolean tlsInspect) {
