...
export class UpdateDeviceCellularGatewayPortForwardingRulesRequestBody extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    elemType: UpdateDeviceCellularGatewayPortForwardingRulesRequestBodyRules,
  })
  @Expose({ name: "rules" })
  @Type(() => UpdateDeviceCellularGatewayPortForwardingRulesRequestBodyRules)
...
export class UpdateDeviceCellularGatewayPortForwardingRulesResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  updateDeviceCellularGatewayPortForwardingRules200ApplicationJSONObject?: Record<
    string,
    any
  >;
}
