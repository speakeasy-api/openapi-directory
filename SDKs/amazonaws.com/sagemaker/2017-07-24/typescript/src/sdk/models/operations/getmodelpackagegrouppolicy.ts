...
export enum GetModelPackageGroupPolicyXAmzTargetEnum {
  SageMakerGetModelPackageGroupPolicy = "SageMaker.GetModelPackageGroupPolicy",
}

export class GetModelPackageGroupPolicyRequest extends SpeakeasyBase {
...
export class GetModelPackageGroupPolicyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
