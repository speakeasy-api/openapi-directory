...
export class ListTaskChannelListTaskChannelResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.TaskrouterV1WorkspaceTaskChannel })
  @Expose({ name: "channels" })
  @Type(() => shared.TaskrouterV1WorkspaceTaskChannel)
  channels?: shared.TaskrouterV1WorkspaceTaskChannel[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListTaskChannelListTaskChannelResponseMeta)
