...
exports.PutEmployeeSecretResponse = exports.PutEmployeeSecretRequest = void 0;
...
var PutEmployeeSecretRequest = /** @class */ (function (_super) {
    ...
    ], PutEmployeeSecretRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutEmployeeSecretRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], PutEmployeeSecretRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutEmployeeSecretRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SecretId",
        }),
        __metadata("design:type", String)
    ], PutEmployeeSecretRequest.prototype, "secretId", void 0);
...
var PutEmployeeSecretResponse = /** @class */ (function (_super) {
    ...
    ], PutEmployeeSecretResponse.prototype, "rawResponse", void 0);
