 ...
 */
exports.ServerList = ["https://api.getthedata.com"];
/**
...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.getBng2latlongEastingNorthing = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/bng2latlong/{easting}/{northing}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetBng2latlongEastingNorthingResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getBng2latlongEastingNorthing200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetBng2latlongEastingNorthing200ApplicationJSON);
                    }
                    break;
            }
            return res;
