...
exports.SendAlexaOfferToMasterResponse = exports.SendAlexaOfferToMasterRequest = exports.SendAlexaOfferToMasterRequestBody = exports.SendAlexaOfferToMasterHeaders = void 0;
...
exports.SendAlexaOfferToMasterHeaders = SendAlexaOfferToMasterHeaders;
var SendAlexaOfferToMasterRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MessagePayload" }),
        __metadata("design:type", String)
    ], SendAlexaOfferToMasterRequestBody.prototype, "messagePayload", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SenderClientId" }),
        __metadata("design:type", String)
    ], SendAlexaOfferToMasterRequestBody.prototype, "senderClientId", void 0);
    return SendAlexaOfferToMasterRequestBody;
}(utils_1.SpeakeasyBase));
exports.SendAlexaOfferToMasterRequestBody = SendAlexaOfferToMasterRequestBody;
