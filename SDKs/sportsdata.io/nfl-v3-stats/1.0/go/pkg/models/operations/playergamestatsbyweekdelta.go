...
// PlayerGameStatsByWeekDeltaFormatEnum - Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
...
func (e PlayerGameStatsByWeekDeltaFormatEnum) ToPointer() *PlayerGameStatsByWeekDeltaFormatEnum {
	return &e
}

func (e *PlayerGameStatsByWeekDeltaFormatEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = PlayerGameStatsByWeekDeltaFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PlayerGameStatsByWeekDeltaFormatEnum: %v", v)
	}
}
