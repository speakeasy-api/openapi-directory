...
class AcceptDomainTransferFromAnotherAwsAccountRequest:
    ...
    accept_domain_transfer_from_another_aws_account_request: shared_acceptdomaintransferfromanotherawsaccountrequest.AcceptDomainTransferFromAnotherAwsAccountRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
