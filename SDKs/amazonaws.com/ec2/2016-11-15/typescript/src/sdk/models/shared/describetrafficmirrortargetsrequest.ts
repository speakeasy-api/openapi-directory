 ...
 */
export class DescribeTrafficMirrorTargetsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTrafficMirrorTargetsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeTrafficMirrorTargetsRequestFilters })
