...
from ..shared import getprofitandlossresponse as shared_getprofitandlossresponse
...
from ..shared import profitandlossfilter as shared_profitandlossfilter
...
class ProfitAndLossOneRequest:
    ...
    filter: Optional[shared_profitandlossfilter.ProfitAndLossFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
class ProfitAndLossOneResponse:
    ...
    r"""Bad Request"""  
    get_profit_and_loss_response: Optional[shared_getprofitandlossresponse.GetProfitAndLossResponse] = dataclasses.field(default=None)
