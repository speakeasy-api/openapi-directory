...
class PutEmployeeTagPathParams:
...
@dataclasses.dataclass
class PutEmployeeTagHeaders:
    api_version: str = dataclasses.field(metadata={'header': { 'field_name': 'Api-Version', 'style': 'simple', 'explode': False }})
    authorization: str = dataclasses.field(metadata={'header': { 'field_name': 'Authorization', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PutEmployeeTagRequest:
    headers: PutEmployeeTagHeaders = dataclasses.field()
    path_params: PutEmployeeTagPathParams = dataclasses.field()
    

@dataclasses.dataclass
class PutEmployeeTagResponse:
