...
public class DirectoryOrgunitsPatchPathParams {
    /**
    ...
    public DirectoryOrgunitsPatchPathParams withCustomerId(String customerId) {
    ...
    public DirectoryOrgunitsPatchPathParams withOrgUnitPath(String orgUnitPath) {
