...
from ..shared import jobsfilter as shared_jobsfilter
...
class ApplicantsAllQueryParams:
    ...
    filter: Optional[shared_jobsfilter.JobsFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
...
class ApplicantsAllRequest:
    headers: ApplicantsAllHeaders = dataclasses.field()
    query_params: ApplicantsAllQueryParams = dataclasses.field()
    security: ApplicantsAllSecurity = dataclasses.field()
