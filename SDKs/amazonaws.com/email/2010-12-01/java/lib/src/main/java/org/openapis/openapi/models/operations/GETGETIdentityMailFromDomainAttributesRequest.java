...
public class GETGETIdentityMailFromDomainAttributesRequest {
    ...
    public GETGETIdentityMailFromDomainAttributesRequest(@JsonProperty("Action") GETGETIdentityMailFromDomainAttributesActionEnum action, @JsonProperty("Identities") String[] identities, @JsonProperty("Version") GETGETIdentityMailFromDomainAttributesVersionEnum version) {
        this.action = action;
        this.identities = identities;
        this.version = version;
  }
