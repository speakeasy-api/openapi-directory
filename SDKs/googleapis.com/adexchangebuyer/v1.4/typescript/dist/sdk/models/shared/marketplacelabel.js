...
var MarketplaceLabel = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "createTimeMs" }),
        __metadata("design:type", String)
    ], MarketplaceLabel.prototype, "createTimeMs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "deprecatedMarketplaceDealParty" }),
        (0, class_transformer_1.Type)(function () { return marketplacedealparty_1.MarketplaceDealParty; }),
