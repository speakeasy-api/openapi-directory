...
class GetLikesAlt1Request
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetLikesAlt1FilterEnum $filter
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=filter')]
    public ?GetLikesAlt1FilterEnum $filter = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetLikesAlt1SortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?GetLikesAlt1SortEnum $sort = null;
