...
export class PutWebhooksAuthIdAuthRequestBody extends SpeakeasyBase {
  /**
...
export class PutWebhooksAuthIdAuthRequest extends SpeakeasyBase {
...
export class PutWebhooksAuthIdAuthResponse extends SpeakeasyBase {
  /**
