...
export class UpdatePaymentCancellationPsuDataPathParams extends SpeakeasyBase {
...
export class UpdatePaymentCancellationPsuDataHeaders extends SpeakeasyBase {
...
export class UpdatePaymentCancellationPsuDataSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class UpdatePaymentCancellationPsuDataRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdatePaymentCancellationPsuDataResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
