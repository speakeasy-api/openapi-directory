...
export class Quotes {
  ...
  getQuotesQuoteId(
    ...
    const url: string = utils.generateURL(baseURL, "/quotes/{quote_id}", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetQuotesQuoteIdResponse =
        new operations.GetQuotesQuoteIdResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getQuotesQuoteId200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetQuotesQuoteId200ApplicationJSON
            );
          }
          break;
      }
