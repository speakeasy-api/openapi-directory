...
class GoogleCloudDialogflowCxV3ConversationTurnUserInput:
    ...
    input: Optional[shared_googleclouddialogflowcxv3queryinput.GoogleCloudDialogflowCxV3QueryInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('input'), 'exclude': lambda f: f is None }})
