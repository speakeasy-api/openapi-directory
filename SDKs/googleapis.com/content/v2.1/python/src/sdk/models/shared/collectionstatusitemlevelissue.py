...
class CollectionStatusItemLevelIssue:
    r"""Issue associated with the collection."""
    ...
    r"""Country codes (ISO 3166-1 alpha-2) where issue applies to the offer."""  
    ...
    r"""How this issue affects the serving of the collection."""  
