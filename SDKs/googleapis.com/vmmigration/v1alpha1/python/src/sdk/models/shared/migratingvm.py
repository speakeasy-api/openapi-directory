...
class MigratingVM:
    ...
    aws_source_vm_details: Optional[shared_awssourcevmdetails.AwsSourceVMDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('awsSourceVmDetails') }})
    ...
    compute_engine_vm_defaults: Optional[shared_targetvmdetails.TargetVMDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('computeEngineVmDefaults') }})
    ...
    target_defaults: Optional[shared_targetvmdetails.TargetVMDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('targetDefaults') }})
...
class MigratingVMInput:
    ...
    compute_engine_vm_defaults: Optional[shared_targetvmdetails.TargetVMDetailsInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('computeEngineVmDefaults') }})
    current_sync_info: Optional[shared_replicationcycle.ReplicationCycle] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('currentSyncInfo') }})
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description') }})
    display_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('displayName') }})
    error: Optional[shared_status.Status] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    ...
    policy: Optional[shared_schedulepolicy.SchedulePolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('policy') }})
    source_vm_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sourceVmId') }})
    target_defaults: Optional[shared_targetvmdetails.TargetVMDetailsInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('targetDefaults') }})
