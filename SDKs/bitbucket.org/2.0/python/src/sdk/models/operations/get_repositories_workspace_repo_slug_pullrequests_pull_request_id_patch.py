...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDPatchRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDPatchPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDPatchSecurity = dataclasses.field()
