...
public class GetContainersUsageHeaders {
    /**
    ...
    public GetContainersUsageHeaders withXAuthProjectId(String xAuthProjectId) {
    ...
    public GetContainersUsageHeaders withXAuthToken(String xAuthToken) {
