...
exports.DeletePushDeviceDetailsResponse = exports.DeletePushDeviceDetailsRequest = void 0;
...
var DeletePushDeviceDetailsRequest = /** @class */ (function (_super) {
    ...
    ], DeletePushDeviceDetailsRequest.prototype, "xAblyVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=channel",
        }),
        __metadata("design:type", String)
    ], DeletePushDeviceDetailsRequest.prototype, "channel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=clientId",
        }),
        __metadata("design:type", String)
    ], DeletePushDeviceDetailsRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=deviceId",
        }),
        __metadata("design:type", String)
    ], DeletePushDeviceDetailsRequest.prototype, "deviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=format",
        }),
        __metadata("design:type", String)
    ], DeletePushDeviceDetailsRequest.prototype, "format", void 0);
...
var DeletePushDeviceDetailsResponse = /** @class */ (function (_super) {
    ...
    ], DeletePushDeviceDetailsResponse.prototype, "rawResponse", void 0);
