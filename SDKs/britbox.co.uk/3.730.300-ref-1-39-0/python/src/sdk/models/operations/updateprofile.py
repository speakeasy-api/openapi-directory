...
from ..shared import itvupdateprofilerequest as shared_itvupdateprofilerequest
...
class UpdateProfileRequest:
    ...
    itv_update_profile_request: shared_itvupdateprofilerequest.ItvUpdateProfileRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
