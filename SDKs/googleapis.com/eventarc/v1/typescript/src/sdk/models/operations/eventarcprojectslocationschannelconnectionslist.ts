...
export class EventarcProjectsLocationsChannelConnectionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsChannelConnectionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsChannelConnectionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
