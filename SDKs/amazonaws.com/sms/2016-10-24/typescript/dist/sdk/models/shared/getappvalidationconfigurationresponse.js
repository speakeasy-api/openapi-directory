...
var GetAppValidationConfigurationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: appvalidationconfiguration_1.AppValidationConfiguration }),
        (0, class_transformer_1.Expose)({ name: "appValidationConfigurations" }),
        (0, class_transformer_1.Type)(function () { return appvalidationconfiguration_1.AppValidationConfiguration; }),
        __metadata("design:type", Array)
    ], GetAppValidationConfigurationResponse.prototype, "appValidationConfigurations", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: servergroupvalidationconfiguration_1.ServerGroupValidationConfiguration }),
        (0, class_transformer_1.Expose)({ name: "serverGroupValidationConfigurations" }),
        (0, class_transformer_1.Type)(function () { return servergroupvalidationconfiguration_1.ServerGroupValidationConfiguration; }),
        __metadata("design:type", Array)
