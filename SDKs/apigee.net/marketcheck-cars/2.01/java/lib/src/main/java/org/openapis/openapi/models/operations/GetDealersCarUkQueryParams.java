...
public class GetDealersCarUkQueryParams {
    /**
     * The API Authentication Key. Mandatory with all API calls.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=api_key")
    public String apiKey;
    public GetDealersCarUkQueryParams withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public String city;
    public GetDealersCarUkQueryParams withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetDealersCarUkQueryParams withCountry(org.openapis.openapi.models.shared.NonDefaultCountryEnum country) {
    ...
    public GetDealersCarUkQueryParams withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public GetDealersCarUkQueryParams withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetDealersCarUkQueryParams withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetDealersCarUkQueryParams withInventoryUrl(String inventoryUrl) {
    ...
    public GetDealersCarUkQueryParams withLatitude(Double latitude) {
    ...
    public GetDealersCarUkQueryParams withListingCountRange(String listingCountRange) {
    ...
    public GetDealersCarUkQueryParams withLongitude(Double longitude) {
    ...
    public GetDealersCarUkQueryParams withPostalCode(String postalCode) {
    ...
    public GetDealersCarUkQueryParams withProvider(Boolean provider) {
    ...
    public GetDealersCarUkQueryParams withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetDealersCarUkQueryParams withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetDealersCarUkQueryParams withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDealersCarUkQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetDealersCarUkQueryParams withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetDealersCarUkQueryParams withStart(Integer start) {
        this.start = start;
        return this;
    }
