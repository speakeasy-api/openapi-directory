...
public class GetTagsTagTopAnswerersPeriodRequest {
    ...
    public GetTagsTagTopAnswerersPeriodRequest withCallback(String callback) {
    ...
    public GetTagsTagTopAnswerersPeriodRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetTagsTagTopAnswerersPeriodRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetTagsTagTopAnswerersPeriodRequest withPagesize(Long pagesize) {
    ...
    public GetTagsTagTopAnswerersPeriodRequest withPeriod(GetTagsTagTopAnswerersPeriodPeriodEnum period) {
        this.period = period;
        return this;
    }
    ...
    public GetTagsTagTopAnswerersPeriodRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetTagsTagTopAnswerersPeriodRequest withTag(String tag) {
        this.tag = tag;
        return this;
    }
    
    public GetTagsTagTopAnswerersPeriodRequest(@JsonProperty("period") GetTagsTagTopAnswerersPeriodPeriodEnum period, @JsonProperty("site") String site, @JsonProperty("tag") String tag) {
        this.period = period;
        this.site = site;
        this.tag = tag;
  }
