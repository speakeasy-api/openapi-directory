...
try {
    ...
    $request->compareFacesRequest->qualityFilter = QualityFilterEnum::HIGH;
    $request->compareFacesRequest->similarityThreshold = 8360.79;
    $request->compareFacesRequest->sourceImage = new Image();
    $request->compareFacesRequest->sourceImage->bytes = 'ab';
    $request->compareFacesRequest->sourceImage->s3Object = new S3Object();
    $request->compareFacesRequest->sourceImage->s3Object->bucket = 'quis';
    $request->compareFacesRequest->sourceImage->s3Object->name = 'Iris Aufderhar';
    $request->compareFacesRequest->sourceImage->s3Object->version = 'sapiente';
    $request->compareFacesRequest->targetImage = new Image();
    $request->compareFacesRequest->targetImage->bytes = 'quo';
    $request->compareFacesRequest->targetImage->s3Object = new S3Object();
    $request->compareFacesRequest->targetImage->s3Object->bucket = 'odit';
    $request->compareFacesRequest->targetImage->s3Object->name = 'Wilfred Wolff';
    $request->compareFacesRequest->targetImage->s3Object->version = 'quod';
    ...
    $response = $sdk->sdk->compareFaces($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CopyProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Shared\CopyProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Shared\OutputConfig;
use \OpenAPI\OpenAPI\Models\Operations\CopyProjectVersionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CopyProjectVersionRequest();
    $request->copyProjectVersionRequest = new CopyProjectVersionRequest();
    $request->copyProjectVersionRequest->destinationProjectArn = 'occaecati';
    $request->copyProjectVersionRequest->kmsKeyId = 'fugit';
    $request->copyProjectVersionRequest->outputConfig = new OutputConfig();
    $request->copyProjectVersionRequest->outputConfig->s3Bucket = 'deleniti';
    $request->copyProjectVersionRequest->outputConfig->s3KeyPrefix = 'hic';
    $request->copyProjectVersionRequest->sourceProjectArn = 'optio';
    $request->copyProjectVersionRequest->sourceProjectVersionArn = 'totam';
    $request->copyProjectVersionRequest->tags = [
        'commodi' => 'molestiae',
    ];
    $request->copyProjectVersionRequest->versionName = 'modi';
    ...
    $request->xAmzTarget = CopyProjectVersionXAmzTargetEnum::REKOGNITION_SERVICE_COPY_PROJECT_VERSION;

    $response = $sdk->sdk->copyProjectVersion($request);

    if ($response->copyProjectVersionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->createCollectionRequest->collectionId = 'perferendis';
    ...
    $request->xAmzTarget = CreateCollectionXAmzTargetEnum::REKOGNITION_SERVICE_CREATE_COLLECTION;
...
use \OpenAPI\OpenAPI\Models\Shared\DatasetSource;
use \OpenAPI\OpenAPI\Models\Shared\GroundTruthManifest;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
...
try {
    ...
    $request->createDatasetRequest->datasetSource = new DatasetSource();
    $request->createDatasetRequest->datasetSource->datasetArn = 'iste';
    $request->createDatasetRequest->datasetSource->groundTruthManifest = new GroundTruthManifest();
    $request->createDatasetRequest->datasetSource->groundTruthManifest->s3Object = new S3Object();
    $request->createDatasetRequest->datasetSource->groundTruthManifest->s3Object->bucket = 'iure';
    $request->createDatasetRequest->datasetSource->groundTruthManifest->s3Object->name = 'Dr. Rickey Boyle';
    $request->createDatasetRequest->datasetSource->groundTruthManifest->s3Object->version = 'mollitia';
    $request->createDatasetRequest->datasetType = DatasetTypeEnum::TEST;
    $request->createDatasetRequest->projectArn = 'dolores';
    ...
    $request->xAmzTarget = CreateDatasetXAmzTargetEnum::REKOGNITION_SERVICE_CREATE_DATASET;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CreateFaceLivenessSessionRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateFaceLivenessSessionRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateFaceLivenessSessionRequestSettings;
use \OpenAPI\OpenAPI\Models\Shared\LivenessOutputConfig;
use \OpenAPI\OpenAPI\Models\Operations\CreateFaceLivenessSessionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateFaceLivenessSessionRequest();
    $request->createFaceLivenessSessionRequest = new CreateFaceLivenessSessionRequest();
    $request->createFaceLivenessSessionRequest->clientRequestToken = 'minima';
    $request->createFaceLivenessSessionRequest->kmsKeyId = 'excepturi';
    $request->createFaceLivenessSessionRequest->settings = new CreateFaceLivenessSessionRequestSettings();
    $request->createFaceLivenessSessionRequest->settings->auditImagesLimit = 38425;
    $request->createFaceLivenessSessionRequest->settings->outputConfig = new LivenessOutputConfig();
    $request->createFaceLivenessSessionRequest->settings->outputConfig->s3Bucket = 'iure';
    $request->createFaceLivenessSessionRequest->settings->outputConfig->s3KeyPrefix = 'culpa';
    ...
    $request->xAmzTarget = CreateFaceLivenessSessionXAmzTargetEnum::REKOGNITION_SERVICE_CREATE_FACE_LIVENESS_SESSION;

    $response = $sdk->sdk->createFaceLivenessSession($request);

    if ($response->createFaceLivenessSessionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->createProjectRequest->projectName = 'repellat';
    ...
    $request->xAmzTarget = CreateProjectXAmzTargetEnum::REKOGNITION_SERVICE_CREATE_PROJECT;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CreateProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Shared\OutputConfig;
use \OpenAPI\OpenAPI\Models\Shared\TestingData;
use \OpenAPI\OpenAPI\Models\Shared\Asset;
use \OpenAPI\OpenAPI\Models\Shared\GroundTruthManifest;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Shared\TrainingData;
use \OpenAPI\OpenAPI\Models\Operations\CreateProjectVersionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateProjectVersionRequest();
    $request->createProjectVersionRequest = new CreateProjectVersionRequest();
    $request->createProjectVersionRequest->kmsKeyId = 'error';
    $request->createProjectVersionRequest->outputConfig = new OutputConfig();
    $request->createProjectVersionRequest->outputConfig->s3Bucket = 'quia';
    $request->createProjectVersionRequest->outputConfig->s3KeyPrefix = 'quis';
    $request->createProjectVersionRequest->projectArn = 'vitae';
    $request->createProjectVersionRequest->tags = [
        'animi' => 'enim',
        'odit' => 'quo',
        'sequi' => 'tenetur',
    ];
    $request->createProjectVersionRequest->testingData = new TestingData();
    $request->createProjectVersionRequest->testingData->assets = [
        new Asset(),
        new Asset(),
    ];
    $request->createProjectVersionRequest->testingData->autoCreate = false;
    $request->createProjectVersionRequest->trainingData = new TrainingData();
    $request->createProjectVersionRequest->trainingData->assets = [
        new Asset(),
        new Asset(),
        new Asset(),
    ];
    $request->createProjectVersionRequest->versionName = 'possimus';
    ...
    $request->xAmzTarget = CreateProjectVersionXAmzTargetEnum::REKOGNITION_SERVICE_CREATE_PROJECT_VERSION;

    $response = $sdk->sdk->createProjectVersion($request);

    if ($response->createProjectVersionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CreateStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\CreateStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorDataSharingPreference;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorInput;
use \OpenAPI\OpenAPI\Models\Shared\KinesisVideoStream;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorNotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorOutput;
use \OpenAPI\OpenAPI\Models\Shared\KinesisDataStream;
use \OpenAPI\OpenAPI\Models\Shared\S3Destination;
use \OpenAPI\OpenAPI\Models\Shared\RegionOfInterest;
use \OpenAPI\OpenAPI\Models\Shared\BoundingBox;
use \OpenAPI\OpenAPI\Models\Shared\Point;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorSettings;
use \OpenAPI\OpenAPI\Models\Shared\ConnectedHomeSettings;
use \OpenAPI\OpenAPI\Models\Shared\FaceSearchSettings;
use \OpenAPI\OpenAPI\Models\Operations\CreateStreamProcessorXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateStreamProcessorRequest();
    $request->createStreamProcessorRequest = new CreateStreamProcessorRequest();
    $request->createStreamProcessorRequest->dataSharingPreference = new StreamProcessorDataSharingPreference();
    $request->createStreamProcessorRequest->dataSharingPreference->optIn = false;
    $request->createStreamProcessorRequest->input = new StreamProcessorInput();
    $request->createStreamProcessorRequest->input->kinesisVideoStream = new KinesisVideoStream();
    $request->createStreamProcessorRequest->input->kinesisVideoStream->arn = 'voluptatibus';
    $request->createStreamProcessorRequest->kmsKeyId = 'vero';
    $request->createStreamProcessorRequest->name = 'Miss Irma Wolff';
    $request->createStreamProcessorRequest->notificationChannel = new StreamProcessorNotificationChannel();
    $request->createStreamProcessorRequest->notificationChannel->snsTopicArn = 'cum';
    $request->createStreamProcessorRequest->output = new StreamProcessorOutput();
    $request->createStreamProcessorRequest->output->kinesisDataStream = new KinesisDataStream();
    $request->createStreamProcessorRequest->output->kinesisDataStream->arn = 'perferendis';
    $request->createStreamProcessorRequest->output->s3Destination = new S3Destination();
    $request->createStreamProcessorRequest->output->s3Destination->bucket = 'doloremque';
    $request->createStreamProcessorRequest->output->s3Destination->keyPrefix = 'reprehenderit';
    $request->createStreamProcessorRequest->regionsOfInterest = [
        new RegionOfInterest(),
        new RegionOfInterest(),
    ];
    $request->createStreamProcessorRequest->roleArn = 'maiores';
    $request->createStreamProcessorRequest->settings = new StreamProcessorSettings();
    $request->createStreamProcessorRequest->settings->connectedHome = new ConnectedHomeSettings();
    $request->createStreamProcessorRequest->settings->connectedHome->labels = [
        'corporis',
    ];
    $request->createStreamProcessorRequest->settings->connectedHome->minConfidence = 2961.4;
    $request->createStreamProcessorRequest->settings->faceSearch = new FaceSearchSettings();
    $request->createStreamProcessorRequest->settings->faceSearch->collectionId = 'iusto';
    $request->createStreamProcessorRequest->settings->faceSearch->faceMatchThreshold = 1187.27;
    $request->createStreamProcessorRequest->tags = [
        'enim' => 'accusamus',
        'commodi' => 'repudiandae',
        'quae' => 'ipsum',
    ];
    ...
    $request->xAmzTarget = CreateStreamProcessorXAmzTargetEnum::REKOGNITION_SERVICE_CREATE_STREAM_PROCESSOR;

    $response = $sdk->sdk->createStreamProcessor($request);

    if ($response->createStreamProcessorResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->deleteCollectionRequest->collectionId = 'voluptates';
    ...
    $request->xAmzTarget = DeleteCollectionXAmzTargetEnum::REKOGNITION_SERVICE_DELETE_COLLECTION;
...
try {
    ...
    $request->deleteDatasetRequest->datasetArn = 'consequatur';
    ...
    $request->xAmzTarget = DeleteDatasetXAmzTargetEnum::REKOGNITION_SERVICE_DELETE_DATASET;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteFacesRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteFacesRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteFacesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteFacesRequest();
    $request->deleteFacesRequest = new DeleteFacesRequest();
    $request->deleteFacesRequest->collectionId = 'modi';
    $request->deleteFacesRequest->faceIds = [
        'aliquid',
    ];
    ...
    $request->xAmzTarget = DeleteFacesXAmzTargetEnum::REKOGNITION_SERVICE_DELETE_FACES;

    $response = $sdk->sdk->deleteFaces($request);

    if ($response->deleteFacesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->deleteProjectRequest->projectArn = 'fugit';
    ...
    $request->xAmzTarget = DeleteProjectXAmzTargetEnum::REKOGNITION_SERVICE_DELETE_PROJECT;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteProjectPolicyRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteProjectPolicyRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteProjectPolicyXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteProjectPolicyRequest();
    $request->deleteProjectPolicyRequest = new DeleteProjectPolicyRequest();
    $request->deleteProjectPolicyRequest->policyName = 'eum';
    $request->deleteProjectPolicyRequest->policyRevisionId = 'non';
    $request->deleteProjectPolicyRequest->projectArn = 'eligendi';
    ...
    $request->xAmzTarget = DeleteProjectPolicyXAmzTargetEnum::REKOGNITION_SERVICE_DELETE_PROJECT_POLICY;

    $response = $sdk->sdk->deleteProjectPolicy($request);

    if ($response->deleteProjectPolicyResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteProjectVersionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteProjectVersionRequest();
    $request->deleteProjectVersionRequest = new DeleteProjectVersionRequest();
    $request->deleteProjectVersionRequest->projectVersionArn = 'debitis';
    ...
    $request->xAmzTarget = DeleteProjectVersionXAmzTargetEnum::REKOGNITION_SERVICE_DELETE_PROJECT_VERSION;

    $response = $sdk->sdk->deleteProjectVersion($request);

    if ($response->deleteProjectVersionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\DeleteStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteStreamProcessorXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteStreamProcessorRequest();
    $request->deleteStreamProcessorRequest = new DeleteStreamProcessorRequest();
    $request->deleteStreamProcessorRequest->name = 'Valerie Runolfsson';
    ...
    $request->xAmzTarget = DeleteStreamProcessorXAmzTargetEnum::REKOGNITION_SERVICE_DELETE_STREAM_PROCESSOR;

    $response = $sdk->sdk->deleteStreamProcessor($request);

    if ($response->deleteStreamProcessorResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Shared\DescribeCollectionRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeCollectionXAmzTargetEnum;
...
try {
    ...
    $request->describeCollectionRequest->collectionId = 'delectus';
    $request->xAmzAlgorithm = 'quidem';
    ...
    $request->xAmzTarget = DescribeCollectionXAmzTargetEnum::REKOGNITION_SERVICE_DESCRIBE_COLLECTION;

    $response = $sdk->sdk->describeCollection($request);
...
try {
    ...
    $request->describeDatasetRequest->datasetArn = 'amet';
    ...
    $request->xAmzTarget = DescribeDatasetXAmzTargetEnum::REKOGNITION_SERVICE_DESCRIBE_DATASET;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DescribeProjectVersionsRequest;
use \OpenAPI\OpenAPI\Models\Shared\DescribeProjectVersionsRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeProjectVersionsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DescribeProjectVersionsRequest();
    $request->describeProjectVersionsRequest = new DescribeProjectVersionsRequest();
    $request->describeProjectVersionsRequest->maxResults = 470132;
    $request->describeProjectVersionsRequest->nextToken = 'magnam';
    $request->describeProjectVersionsRequest->projectArn = 'distinctio';
    $request->describeProjectVersionsRequest->versionNames = [
        'labore',
        'labore',
        'suscipit',
    ];
    ...
    $request->xAmzTarget = DescribeProjectVersionsXAmzTargetEnum::REKOGNITION_SERVICE_DESCRIBE_PROJECT_VERSIONS;

    $response = $sdk->sdk->describeProjectVersions($request);

    if ($response->describeProjectVersionsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DescribeProjectsRequest;
use \OpenAPI\OpenAPI\Models\Shared\DescribeProjectsRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeProjectsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DescribeProjectsRequest();
    $request->describeProjectsRequest = new DescribeProjectsRequest();
    $request->describeProjectsRequest->maxResults = 354047;
    $request->describeProjectsRequest->nextToken = 'provident';
    $request->describeProjectsRequest->projectNames = [
        'sint',
        'accusantium',
        'mollitia',
    ];
    ...
    $request->xAmzTarget = DescribeProjectsXAmzTargetEnum::REKOGNITION_SERVICE_DESCRIBE_PROJECTS;

    $response = $sdk->sdk->describeProjects($request);

    if ($response->describeProjectsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DescribeStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\DescribeStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Operations\DescribeStreamProcessorXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DescribeStreamProcessorRequest();
    $request->describeStreamProcessorRequest = new DescribeStreamProcessorRequest();
    $request->describeStreamProcessorRequest->name = 'Melba Toy';
    ...
    $request->xAmzTarget = DescribeStreamProcessorXAmzTargetEnum::REKOGNITION_SERVICE_DESCRIBE_STREAM_PROCESSOR;

    $response = $sdk->sdk->describeStreamProcessor($request);

    if ($response->describeStreamProcessorResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DetectCustomLabelsRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectCustomLabelsRequest;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\DetectCustomLabelsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DetectCustomLabelsRequest();
    $request->detectCustomLabelsRequest = new DetectCustomLabelsRequest();
    $request->detectCustomLabelsRequest->image = new Image();
    $request->detectCustomLabelsRequest->image->bytes = 'expedita';
    $request->detectCustomLabelsRequest->image->s3Object = new S3Object();
    $request->detectCustomLabelsRequest->image->s3Object->bucket = 'nihil';
    $request->detectCustomLabelsRequest->image->s3Object->name = 'Marty Cormier';
    $request->detectCustomLabelsRequest->image->s3Object->version = 'accusantium';
    $request->detectCustomLabelsRequest->maxResults = 162493;
    $request->detectCustomLabelsRequest->minConfidence = 5083.15;
    $request->detectCustomLabelsRequest->projectVersionArn = 'natus';
    ...
    $request->xAmzTarget = DetectCustomLabelsXAmzTargetEnum::REKOGNITION_SERVICE_DETECT_CUSTOM_LABELS;

    $response = $sdk->sdk->detectCustomLabels($request);

    if ($response->detectCustomLabelsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DetectFacesRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectFacesRequest;
use \OpenAPI\OpenAPI\Models\Shared\AttributeEnum;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\DetectFacesXAmzTargetEnum;
...
try {
    ...
    $request->detectFacesRequest = new DetectFacesRequest();
    $request->detectFacesRequest->attributes = [
        AttributeEnum::DEFAULT,
        AttributeEnum::DEFAULT,
        AttributeEnum::DEFAULT,
    ];
    $request->detectFacesRequest->image = new Image();
    $request->detectFacesRequest->image->bytes = 'ab';
    $request->detectFacesRequest->image->s3Object = new S3Object();
    $request->detectFacesRequest->image->s3Object->bucket = 'maiores';
    $request->detectFacesRequest->image->s3Object->name = 'Clyde Kling';
    $request->detectFacesRequest->image->s3Object->version = 'eaque';
    ...
    $request->xAmzTarget = DetectFacesXAmzTargetEnum::REKOGNITION_SERVICE_DETECT_FACES;

    $response = $sdk->sdk->detectFaces($request);

    if ($response->detectFacesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DetectLabelsRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectLabelsRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectLabelsFeatureNameEnum;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Shared\DetectLabelsSettings;
use \OpenAPI\OpenAPI\Models\Shared\GeneralLabelsSettings;
use \OpenAPI\OpenAPI\Models\Shared\DetectLabelsImagePropertiesSettings;
use \OpenAPI\OpenAPI\Models\Operations\DetectLabelsXAmzTargetEnum;
...
try {
    ...
    $request->detectLabelsRequest = new DetectLabelsRequest();
    $request->detectLabelsRequest->features = [
        DetectLabelsFeatureNameEnum::GENERAL_LABELS,
        DetectLabelsFeatureNameEnum::IMAGE_PROPERTIES,
        DetectLabelsFeatureNameEnum::IMAGE_PROPERTIES,
        DetectLabelsFeatureNameEnum::IMAGE_PROPERTIES,
    ];
    $request->detectLabelsRequest->image = new Image();
    $request->detectLabelsRequest->image->bytes = 'dolores';
    $request->detectLabelsRequest->image->s3Object = new S3Object();
    $request->detectLabelsRequest->image->s3Object->bucket = 'quis';
    $request->detectLabelsRequest->image->s3Object->name = 'Lance Becker';
    $request->detectLabelsRequest->image->s3Object->version = 'eos';
    $request->detectLabelsRequest->maxLabels = 18521;
    $request->detectLabelsRequest->minConfidence = 1709.86;
    $request->detectLabelsRequest->settings = new DetectLabelsSettings();
    $request->detectLabelsRequest->settings->generalLabels = new GeneralLabelsSettings();
    $request->detectLabelsRequest->settings->generalLabels->labelCategoryExclusionFilters = [
        'quam',
        'dolor',
        'vero',
        'nostrum',
    ];
    $request->detectLabelsRequest->settings->generalLabels->labelCategoryInclusionFilters = [
        'recusandae',
        'omnis',
        'facilis',
        'perspiciatis',
    ];
    $request->detectLabelsRequest->settings->generalLabels->labelExclusionFilters = [
        'porro',
    ];
    $request->detectLabelsRequest->settings->generalLabels->labelInclusionFilters = [
        'blanditiis',
    ];
    $request->detectLabelsRequest->settings->imageProperties = new DetectLabelsImagePropertiesSettings();
    $request->detectLabelsRequest->settings->imageProperties->maxDominantColors = 621479;
    ...
    $request->xAmzTarget = DetectLabelsXAmzTargetEnum::REKOGNITION_SERVICE_DETECT_LABELS;

    $response = $sdk->sdk->detectLabels($request);

    if ($response->detectLabelsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DetectModerationLabelsRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectModerationLabelsRequest;
...
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\DetectModerationLabelsXAmzTargetEnum;
...
try {
    ...
    $request->detectModerationLabelsRequest = new DetectModerationLabelsRequest();
    $request->detectModerationLabelsRequest->humanLoopConfig = new HumanLoopConfig();
    $request->detectModerationLabelsRequest->humanLoopConfig->dataAttributes = new HumanLoopDataAttributes();
    $request->detectModerationLabelsRequest->humanLoopConfig->dataAttributes->contentClassifiers = [
        ContentClassifierEnum::FREE_OF_ADULT_CONTENT,
        ContentClassifierEnum::FREE_OF_ADULT_CONTENT,
        ContentClassifierEnum::FREE_OF_ADULT_CONTENT,
    ];
    $request->detectModerationLabelsRequest->humanLoopConfig->flowDefinitionArn = 'provident';
    $request->detectModerationLabelsRequest->humanLoopConfig->humanLoopName = 'nobis';
    $request->detectModerationLabelsRequest->image = new Image();
    $request->detectModerationLabelsRequest->image->bytes = 'libero';
    $request->detectModerationLabelsRequest->image->s3Object = new S3Object();
    $request->detectModerationLabelsRequest->image->s3Object->bucket = 'delectus';
    $request->detectModerationLabelsRequest->image->s3Object->name = 'Billie Jacobi';
    $request->detectModerationLabelsRequest->image->s3Object->version = 'dolor';
    $request->detectModerationLabelsRequest->minConfidence = 1861.93;
    ...
    $request->xAmzSignedHeaders = 'reiciendis';
    $request->xAmzTarget = DetectModerationLabelsXAmzTargetEnum::REKOGNITION_SERVICE_DETECT_MODERATION_LABELS;

    $response = $sdk->sdk->detectModerationLabels($request);

    if ($response->detectModerationLabelsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DetectProtectiveEquipmentRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectProtectiveEquipmentRequest;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Shared\ProtectiveEquipmentSummarizationAttributes;
use \OpenAPI\OpenAPI\Models\Shared\ProtectiveEquipmentTypeEnum;
use \OpenAPI\OpenAPI\Models\Operations\DetectProtectiveEquipmentXAmzTargetEnum;
...
try {
    ...
    $request->detectProtectiveEquipmentRequest = new DetectProtectiveEquipmentRequest();
    $request->detectProtectiveEquipmentRequest->image = new Image();
    $request->detectProtectiveEquipmentRequest->image->bytes = 'amet';
    $request->detectProtectiveEquipmentRequest->image->s3Object = new S3Object();
    $request->detectProtectiveEquipmentRequest->image->s3Object->bucket = 'dolorum';
    $request->detectProtectiveEquipmentRequest->image->s3Object->name = 'Ms. Christine Beer';
    $request->detectProtectiveEquipmentRequest->image->s3Object->version = 'quaerat';
    $request->detectProtectiveEquipmentRequest->summarizationAttributes = new ProtectiveEquipmentSummarizationAttributes();
    $request->detectProtectiveEquipmentRequest->summarizationAttributes->minConfidence = 8810.05;
    $request->detectProtectiveEquipmentRequest->summarizationAttributes->requiredEquipmentTypes = [
        ProtectiveEquipmentTypeEnum::HEAD_COVER,
        ProtectiveEquipmentTypeEnum::HAND_COVER,
        ProtectiveEquipmentTypeEnum::HAND_COVER,
    ];
    ...
    $request->xAmzTarget = DetectProtectiveEquipmentXAmzTargetEnum::REKOGNITION_SERVICE_DETECT_PROTECTIVE_EQUIPMENT;

    $response = $sdk->sdk->detectProtectiveEquipment($request);

    if ($response->detectProtectiveEquipmentResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DetectTextRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectTextRequest;
use \OpenAPI\OpenAPI\Models\Shared\DetectTextFilters;
use \OpenAPI\OpenAPI\Models\Shared\RegionOfInterest;
use \OpenAPI\OpenAPI\Models\Shared\BoundingBox;
use \OpenAPI\OpenAPI\Models\Shared\Point;
use \OpenAPI\OpenAPI\Models\Shared\DetectionFilter;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\DetectTextXAmzTargetEnum;
...
try {
    ...
    $request->detectTextRequest = new DetectTextRequest();
    $request->detectTextRequest->filters = new DetectTextFilters();
    $request->detectTextRequest->filters->regionsOfInterest = [
        new RegionOfInterest(),
        new RegionOfInterest(),
    ];
    $request->detectTextRequest->filters->wordFilter = new DetectionFilter();
    $request->detectTextRequest->filters->wordFilter->minBoundingBoxHeight = 4536.97;
    $request->detectTextRequest->filters->wordFilter->minBoundingBoxWidth = 6770.82;
    $request->detectTextRequest->filters->wordFilter->minConfidence = 5365.79;
    $request->detectTextRequest->image = new Image();
    $request->detectTextRequest->image->bytes = 'omnis';
    $request->detectTextRequest->image->s3Object = new S3Object();
    $request->detectTextRequest->image->s3Object->bucket = 'necessitatibus';
    $request->detectTextRequest->image->s3Object->name = 'Emmett Kovacek';
    $request->detectTextRequest->image->s3Object->version = 'id';
    ...
    $request->xAmzSignedHeaders = 'accusamus';
    $request->xAmzTarget = DetectTextXAmzTargetEnum::REKOGNITION_SERVICE_DETECT_TEXT;

    $response = $sdk->sdk->detectText($request);

    if ($response->detectTextResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DistributeDatasetEntriesRequest;
use \OpenAPI\OpenAPI\Models\Shared\DistributeDatasetEntriesRequest;
use \OpenAPI\OpenAPI\Models\Shared\DistributeDataset;
use \OpenAPI\OpenAPI\Models\Operations\DistributeDatasetEntriesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DistributeDatasetEntriesRequest();
    $request->distributeDatasetEntriesRequest = new DistributeDatasetEntriesRequest();
    $request->distributeDatasetEntriesRequest->datasets = [
        new DistributeDataset(),
        new DistributeDataset(),
    ];
    $request->xAmzAlgorithm = 'saepe';
    ...
    $request->xAmzTarget = DistributeDatasetEntriesXAmzTargetEnum::REKOGNITION_SERVICE_DISTRIBUTE_DATASET_ENTRIES;

    $response = $sdk->sdk->distributeDatasetEntries($request);

    if ($response->distributeDatasetEntriesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetCelebrityInfoRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetCelebrityInfoRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetCelebrityInfoXAmzTargetEnum;
...
try {
    ...
    $request->getCelebrityInfoRequest = new GetCelebrityInfoRequest();
    $request->getCelebrityInfoRequest->id = 'a0d446ce-2af7-4a73-8f3b-e453f870b326';
    ...
    $request->xAmzTarget = GetCelebrityInfoXAmzTargetEnum::REKOGNITION_SERVICE_GET_CELEBRITY_INFO;

    $response = $sdk->sdk->getCelebrityInfo($request);

    if ($response->getCelebrityInfoResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetCelebrityRecognitionRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetCelebrityRecognitionRequest;
use \OpenAPI\OpenAPI\Models\Shared\CelebrityRecognitionSortByEnum;
use \OpenAPI\OpenAPI\Models\Operations\GetCelebrityRecognitionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetCelebrityRecognitionRequest();
    $request->getCelebrityRecognitionRequest = new GetCelebrityRecognitionRequest();
    $request->getCelebrityRecognitionRequest->jobId = 'cupiditate';
    $request->getCelebrityRecognitionRequest->maxResults = 807581;
    $request->getCelebrityRecognitionRequest->nextToken = 'pariatur';
    $request->getCelebrityRecognitionRequest->sortBy = CelebrityRecognitionSortByEnum::TIMESTAMP;
    ...
    $request->xAmzTarget = GetCelebrityRecognitionXAmzTargetEnum::REKOGNITION_SERVICE_GET_CELEBRITY_RECOGNITION;

    $response = $sdk->sdk->getCelebrityRecognition($request);

    if ($response->getCelebrityRecognitionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetContentModerationRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetContentModerationRequest;
use \OpenAPI\OpenAPI\Models\Shared\ContentModerationSortByEnum;
use \OpenAPI\OpenAPI\Models\Operations\GetContentModerationXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetContentModerationRequest();
    $request->getContentModerationRequest = new GetContentModerationRequest();
    $request->getContentModerationRequest->jobId = 'quam';
    $request->getContentModerationRequest->maxResults = 565421;
    $request->getContentModerationRequest->nextToken = 'temporibus';
    $request->getContentModerationRequest->sortBy = ContentModerationSortByEnum::NAME;
    ...
    $request->xAmzTarget = GetContentModerationXAmzTargetEnum::REKOGNITION_SERVICE_GET_CONTENT_MODERATION;

    $response = $sdk->sdk->getContentModeration($request);

    if ($response->getContentModerationResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetFaceDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetFaceDetectionRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetFaceDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetFaceDetectionRequest();
    $request->getFaceDetectionRequest = new GetFaceDetectionRequest();
    $request->getFaceDetectionRequest->jobId = 'cumque';
    $request->getFaceDetectionRequest->maxResults = 746994;
    $request->getFaceDetectionRequest->nextToken = 'nobis';
    ...
    $request->xAmzTarget = GetFaceDetectionXAmzTargetEnum::REKOGNITION_SERVICE_GET_FACE_DETECTION;

    $response = $sdk->sdk->getFaceDetection($request);

    if ($response->getFaceDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetFaceLivenessSessionResultsRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetFaceLivenessSessionResultsRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetFaceLivenessSessionResultsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetFaceLivenessSessionResultsRequest();
    $request->getFaceLivenessSessionResultsRequest = new GetFaceLivenessSessionResultsRequest();
    $request->getFaceLivenessSessionResultsRequest->sessionId = 'delectus';
    $request->xAmzAlgorithm = 'dolorem';
    ...
    $request->xAmzTarget = GetFaceLivenessSessionResultsXAmzTargetEnum::REKOGNITION_SERVICE_GET_FACE_LIVENESS_SESSION_RESULTS;

    $response = $sdk->sdk->getFaceLivenessSessionResults($request);

    if ($response->getFaceLivenessSessionResultsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetFaceSearchRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetFaceSearchRequest;
use \OpenAPI\OpenAPI\Models\Shared\FaceSearchSortByEnum;
use \OpenAPI\OpenAPI\Models\Operations\GetFaceSearchXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetFaceSearchRequest();
    $request->getFaceSearchRequest = new GetFaceSearchRequest();
    $request->getFaceSearchRequest->jobId = 'aut';
    $request->getFaceSearchRequest->maxResults = 555649;
    $request->getFaceSearchRequest->nextToken = 'itaque';
    $request->getFaceSearchRequest->sortBy = FaceSearchSortByEnum::INDEX;
    ...
    $request->xAmzSignedHeaders = 'quae';
    $request->xAmzTarget = GetFaceSearchXAmzTargetEnum::REKOGNITION_SERVICE_GET_FACE_SEARCH;

    $response = $sdk->sdk->getFaceSearch($request);

    if ($response->getFaceSearchResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetLabelDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetLabelDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\LabelDetectionAggregateByEnum;
use \OpenAPI\OpenAPI\Models\Shared\LabelDetectionSortByEnum;
use \OpenAPI\OpenAPI\Models\Operations\GetLabelDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetLabelDetectionRequest();
    $request->getLabelDetectionRequest = new GetLabelDetectionRequest();
    $request->getLabelDetectionRequest->aggregateBy = LabelDetectionAggregateByEnum::SEGMENTS;
    $request->getLabelDetectionRequest->jobId = 'odio';
    $request->getLabelDetectionRequest->maxResults = 580447;
    $request->getLabelDetectionRequest->nextToken = 'voluptatibus';
    $request->getLabelDetectionRequest->sortBy = LabelDetectionSortByEnum::TIMESTAMP;
    ...
    $request->xAmzTarget = GetLabelDetectionXAmzTargetEnum::REKOGNITION_SERVICE_GET_LABEL_DETECTION;

    $response = $sdk->sdk->getLabelDetection($request);

    if ($response->getLabelDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetPersonTrackingRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetPersonTrackingRequest;
use \OpenAPI\OpenAPI\Models\Shared\PersonTrackingSortByEnum;
use \OpenAPI\OpenAPI\Models\Operations\GetPersonTrackingXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetPersonTrackingRequest();
    $request->getPersonTrackingRequest = new GetPersonTrackingRequest();
    $request->getPersonTrackingRequest->jobId = 'dignissimos';
    $request->getPersonTrackingRequest->maxResults = 941378;
    $request->getPersonTrackingRequest->nextToken = 'distinctio';
    $request->getPersonTrackingRequest->sortBy = PersonTrackingSortByEnum::TIMESTAMP;
    ...
    $request->xAmzTarget = GetPersonTrackingXAmzTargetEnum::REKOGNITION_SERVICE_GET_PERSON_TRACKING;

    $response = $sdk->sdk->getPersonTracking($request);

    if ($response->getPersonTrackingResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetSegmentDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetSegmentDetectionRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetSegmentDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetSegmentDetectionRequest();
    $request->getSegmentDetectionRequest = new GetSegmentDetectionRequest();
    $request->getSegmentDetectionRequest->jobId = 'natus';
    $request->getSegmentDetectionRequest->maxResults = 773326;
    $request->getSegmentDetectionRequest->nextToken = 'aut';
    ...
    $request->xAmzTarget = GetSegmentDetectionXAmzTargetEnum::REKOGNITION_SERVICE_GET_SEGMENT_DETECTION;

    $response = $sdk->sdk->getSegmentDetection($request);

    if ($response->getSegmentDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetTextDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\GetTextDetectionRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetTextDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetTextDetectionRequest();
    $request->getTextDetectionRequest = new GetTextDetectionRequest();
    $request->getTextDetectionRequest->jobId = 'ducimus';
    $request->getTextDetectionRequest->maxResults = 4048;
    $request->getTextDetectionRequest->nextToken = 'officia';
    ...
    $request->xAmzTarget = GetTextDetectionXAmzTargetEnum::REKOGNITION_SERVICE_GET_TEXT_DETECTION;

    $response = $sdk->sdk->getTextDetection($request);

    if ($response->getTextDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\IndexFacesRequest;
use \OpenAPI\OpenAPI\Models\Shared\IndexFacesRequest;
use \OpenAPI\OpenAPI\Models\Shared\AttributeEnum;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Shared\QualityFilterEnum;
use \OpenAPI\OpenAPI\Models\Operations\IndexFacesXAmzTargetEnum;
...
try {
    ...
    $request->indexFacesRequest = new IndexFacesRequest();
    $request->indexFacesRequest->collectionId = 'laudantium';
    $request->indexFacesRequest->detectionAttributes = [
        AttributeEnum::DEFAULT,
    ];
    $request->indexFacesRequest->externalImageId = 'maiores';
    $request->indexFacesRequest->image = new Image();
    $request->indexFacesRequest->image->bytes = 'quasi';
    $request->indexFacesRequest->image->s3Object = new S3Object();
    $request->indexFacesRequest->image->s3Object->bucket = 'ex';
    $request->indexFacesRequest->image->s3Object->name = 'Marshall Wiza';
    $request->indexFacesRequest->image->s3Object->version = 'quisquam';
    $request->indexFacesRequest->maxFaces = 906556;
    $request->indexFacesRequest->qualityFilter = QualityFilterEnum::LOW;
    ...
    $request->xAmzSignedHeaders = 'ea';
    $request->xAmzTarget = IndexFacesXAmzTargetEnum::REKOGNITION_SERVICE_INDEX_FACES;

    $response = $sdk->sdk->indexFaces($request);

    if ($response->indexFacesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->listCollectionsRequest->maxResults = 775220;
    $request->listCollectionsRequest->nextToken = 'consectetur';
    ...
    $request->xAmzTarget = ListCollectionsXAmzTargetEnum::REKOGNITION_SERVICE_LIST_COLLECTIONS;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListDatasetEntriesRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListDatasetEntriesRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListDatasetEntriesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListDatasetEntriesRequest();
    $request->listDatasetEntriesRequest = new ListDatasetEntriesRequest();
    $request->listDatasetEntriesRequest->containsLabels = [
        'aliquam',
        'fugit',
        'accusamus',
        'inventore',
    ];
    $request->listDatasetEntriesRequest->datasetArn = 'non';
    $request->listDatasetEntriesRequest->hasErrors = false;
    $request->listDatasetEntriesRequest->labeled = false;
    $request->listDatasetEntriesRequest->maxResults = 89603;
    $request->listDatasetEntriesRequest->nextToken = 'dolorum';
    $request->listDatasetEntriesRequest->sourceRefContains = 'laborum';
    ...
    $request->xAmzTarget = ListDatasetEntriesXAmzTargetEnum::REKOGNITION_SERVICE_LIST_DATASET_ENTRIES;

    $response = $sdk->sdk->listDatasetEntries($request);

    if ($response->listDatasetEntriesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListDatasetLabelsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListDatasetLabelsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListDatasetLabelsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListDatasetLabelsRequest();
    $request->listDatasetLabelsRequest = new ListDatasetLabelsRequest();
    $request->listDatasetLabelsRequest->datasetArn = 'libero';
    $request->listDatasetLabelsRequest->maxResults = 96549;
    $request->listDatasetLabelsRequest->nextToken = 'tempora';
    ...
    $request->xAmzTarget = ListDatasetLabelsXAmzTargetEnum::REKOGNITION_SERVICE_LIST_DATASET_LABELS;

    $response = $sdk->sdk->listDatasetLabels($request);

    if ($response->listDatasetLabelsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListFacesRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListFacesRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListFacesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListFacesRequest();
    $request->listFacesRequest = new ListFacesRequest();
    $request->listFacesRequest->collectionId = 'esse';
    $request->listFacesRequest->maxResults = 524593;
    $request->listFacesRequest->nextToken = 'fuga';
    ...
    $request->xAmzTarget = ListFacesXAmzTargetEnum::REKOGNITION_SERVICE_LIST_FACES;

    $response = $sdk->sdk->listFaces($request);

    if ($response->listFacesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListProjectPoliciesRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListProjectPoliciesRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListProjectPoliciesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListProjectPoliciesRequest();
    $request->listProjectPoliciesRequest = new ListProjectPoliciesRequest();
    $request->listProjectPoliciesRequest->maxResults = 788546;
    $request->listProjectPoliciesRequest->nextToken = 'veritatis';
    $request->listProjectPoliciesRequest->projectArn = 'ipsa';
    ...
    $request->xAmzTarget = ListProjectPoliciesXAmzTargetEnum::REKOGNITION_SERVICE_LIST_PROJECT_POLICIES;

    $response = $sdk->sdk->listProjectPolicies($request);

    if ($response->listProjectPoliciesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ListStreamProcessorsRequest;
use \OpenAPI\OpenAPI\Models\Shared\ListStreamProcessorsRequest;
use \OpenAPI\OpenAPI\Models\Operations\ListStreamProcessorsXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ListStreamProcessorsRequest();
    $request->listStreamProcessorsRequest = new ListStreamProcessorsRequest();
    $request->listStreamProcessorsRequest->maxResults = 373813;
    $request->listStreamProcessorsRequest->nextToken = 'ab';
    ...
    $request->xAmzSignedHeaders = 'esse';
    $request->xAmzTarget = ListStreamProcessorsXAmzTargetEnum::REKOGNITION_SERVICE_LIST_STREAM_PROCESSORS;

    $response = $sdk->sdk->listStreamProcessors($request);

    if ($response->listStreamProcessorsResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->listTagsForResourceRequest->resourceArn = 'recusandae';
    ...
    $request->xAmzSignedHeaders = 'totam';
    $request->xAmzTarget = ListTagsForResourceXAmzTargetEnum::REKOGNITION_SERVICE_LIST_TAGS_FOR_RESOURCE;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\PutProjectPolicyRequest;
use \OpenAPI\OpenAPI\Models\Shared\PutProjectPolicyRequest;
use \OpenAPI\OpenAPI\Models\Operations\PutProjectPolicyXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new PutProjectPolicyRequest();
    $request->putProjectPolicyRequest = new PutProjectPolicyRequest();
    $request->putProjectPolicyRequest->policyDocument = 'accusamus';
    $request->putProjectPolicyRequest->policyName = 'aliquam';
    $request->putProjectPolicyRequest->policyRevisionId = 'odio';
    $request->putProjectPolicyRequest->projectArn = 'occaecati';
    ...
    $request->xAmzTarget = PutProjectPolicyXAmzTargetEnum::REKOGNITION_SERVICE_PUT_PROJECT_POLICY;

    $response = $sdk->sdk->putProjectPolicy($request);

    if ($response->putProjectPolicyResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\RecognizeCelebritiesRequest;
use \OpenAPI\OpenAPI\Models\Shared\RecognizeCelebritiesRequest;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\RecognizeCelebritiesXAmzTargetEnum;
...
try {
    ...
    $request->recognizeCelebritiesRequest = new RecognizeCelebritiesRequest();
    $request->recognizeCelebritiesRequest->image = new Image();
    $request->recognizeCelebritiesRequest->image->bytes = 'eum';
    $request->recognizeCelebritiesRequest->image->s3Object = new S3Object();
    $request->recognizeCelebritiesRequest->image->s3Object->bucket = 'quas';
    $request->recognizeCelebritiesRequest->image->s3Object->name = 'Eugene Leuschke';
    $request->recognizeCelebritiesRequest->image->s3Object->version = 'mollitia';
    ...
    $request->xAmzSignedHeaders = 'sapiente';
    $request->xAmzTarget = RecognizeCelebritiesXAmzTargetEnum::REKOGNITION_SERVICE_RECOGNIZE_CELEBRITIES;

    $response = $sdk->sdk->recognizeCelebrities($request);

    if ($response->recognizeCelebritiesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\SearchFacesRequest;
use \OpenAPI\OpenAPI\Models\Shared\SearchFacesRequest;
use \OpenAPI\OpenAPI\Models\Operations\SearchFacesXAmzTargetEnum;
...
try {
    ...
    $request->searchFacesRequest = new SearchFacesRequest();
    $request->searchFacesRequest->collectionId = 'consequuntur';
    $request->searchFacesRequest->faceId = 'ratione';
    $request->searchFacesRequest->faceMatchThreshold = 1294.12;
    $request->searchFacesRequest->maxFaces = 903984;
    ...
    $request->xAmzTarget = SearchFacesXAmzTargetEnum::REKOGNITION_SERVICE_SEARCH_FACES;

    $response = $sdk->sdk->searchFaces($request);

    if ($response->searchFacesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\SearchFacesByImageRequest;
use \OpenAPI\OpenAPI\Models\Shared\SearchFacesByImageRequest;
use \OpenAPI\OpenAPI\Models\Shared\Image;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Shared\QualityFilterEnum;
use \OpenAPI\OpenAPI\Models\Operations\SearchFacesByImageXAmzTargetEnum;
...
try {
    ...
    $request->searchFacesByImageRequest = new SearchFacesByImageRequest();
    $request->searchFacesByImageRequest->collectionId = 'esse';
    $request->searchFacesByImageRequest->faceMatchThreshold = 8003.79;
    $request->searchFacesByImageRequest->image = new Image();
    $request->searchFacesByImageRequest->image->bytes = 'nam';
    $request->searchFacesByImageRequest->image->s3Object = new S3Object();
    $request->searchFacesByImageRequest->image->s3Object->bucket = 'vero';
    $request->searchFacesByImageRequest->image->s3Object->name = 'Frances Turner';
    $request->searchFacesByImageRequest->image->s3Object->version = 'molestiae';
    $request->searchFacesByImageRequest->maxFaces = 699622;
    $request->searchFacesByImageRequest->qualityFilter = QualityFilterEnum::LOW;
    $request->xAmzAlgorithm = 'minima';
    $request->xAmzContentSha256 = 'distinctio';
    ...
    $request->xAmzTarget = SearchFacesByImageXAmzTargetEnum::REKOGNITION_SERVICE_SEARCH_FACES_BY_IMAGE;

    $response = $sdk->sdk->searchFacesByImage($request);

    if ($response->searchFacesByImageResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartCelebrityRecognitionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartCelebrityRecognitionRequest;
use \OpenAPI\OpenAPI\Models\Shared\NotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartCelebrityRecognitionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartCelebrityRecognitionRequest();
    $request->startCelebrityRecognitionRequest = new StartCelebrityRecognitionRequest();
    $request->startCelebrityRecognitionRequest->clientRequestToken = 'cumque';
    $request->startCelebrityRecognitionRequest->jobTag = 'consequuntur';
    $request->startCelebrityRecognitionRequest->notificationChannel = new NotificationChannel();
    $request->startCelebrityRecognitionRequest->notificationChannel->roleArn = 'consequatur';
    $request->startCelebrityRecognitionRequest->notificationChannel->snsTopicArn = 'minus';
    $request->startCelebrityRecognitionRequest->video = new Video();
    $request->startCelebrityRecognitionRequest->video->s3Object = new S3Object();
    $request->startCelebrityRecognitionRequest->video->s3Object->bucket = 'quaerat';
    $request->startCelebrityRecognitionRequest->video->s3Object->name = 'Glenn Koch';
    $request->startCelebrityRecognitionRequest->video->s3Object->version = 'a';
    $request->xAmzAlgorithm = 'nulla';
    ...
    $request->xAmzTarget = StartCelebrityRecognitionXAmzTargetEnum::REKOGNITION_SERVICE_START_CELEBRITY_RECOGNITION;

    $response = $sdk->sdk->startCelebrityRecognition($request);

    if ($response->startCelebrityRecognitionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartContentModerationRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartContentModerationRequest;
use \OpenAPI\OpenAPI\Models\Shared\NotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartContentModerationXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartContentModerationRequest();
    $request->startContentModerationRequest = new StartContentModerationRequest();
    $request->startContentModerationRequest->clientRequestToken = 'pariatur';
    $request->startContentModerationRequest->jobTag = 'possimus';
    $request->startContentModerationRequest->minConfidence = 1576.32;
    $request->startContentModerationRequest->notificationChannel = new NotificationChannel();
    $request->startContentModerationRequest->notificationChannel->roleArn = 'eveniet';
    $request->startContentModerationRequest->notificationChannel->snsTopicArn = 'asperiores';
    $request->startContentModerationRequest->video = new Video();
    $request->startContentModerationRequest->video->s3Object = new S3Object();
    $request->startContentModerationRequest->video->s3Object->bucket = 'facere';
    $request->startContentModerationRequest->video->s3Object->name = 'Marilyn Botsford';
    $request->startContentModerationRequest->video->s3Object->version = 'aliquid';
    ...
    $request->xAmzTarget = StartContentModerationXAmzTargetEnum::REKOGNITION_SERVICE_START_CONTENT_MODERATION;

    $response = $sdk->sdk->startContentModeration($request);

    if ($response->startContentModerationResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartFaceDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartFaceDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\FaceAttributesEnum;
use \OpenAPI\OpenAPI\Models\Shared\NotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartFaceDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartFaceDetectionRequest();
    $request->startFaceDetectionRequest = new StartFaceDetectionRequest();
    $request->startFaceDetectionRequest->clientRequestToken = 'illum';
    $request->startFaceDetectionRequest->faceAttributes = FaceAttributesEnum::ALL;
    $request->startFaceDetectionRequest->jobTag = 'accusantium';
    $request->startFaceDetectionRequest->notificationChannel = new NotificationChannel();
    $request->startFaceDetectionRequest->notificationChannel->roleArn = 'aliquam';
    $request->startFaceDetectionRequest->notificationChannel->snsTopicArn = 'sapiente';
    $request->startFaceDetectionRequest->video = new Video();
    $request->startFaceDetectionRequest->video->s3Object = new S3Object();
    $request->startFaceDetectionRequest->video->s3Object->bucket = 'dicta';
    $request->startFaceDetectionRequest->video->s3Object->name = 'Delores Hermiston IV';
    $request->startFaceDetectionRequest->video->s3Object->version = 'qui';
    ...
    $request->xAmzTarget = StartFaceDetectionXAmzTargetEnum::REKOGNITION_SERVICE_START_FACE_DETECTION;

    $response = $sdk->sdk->startFaceDetection($request);

    if ($response->startFaceDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartFaceSearchRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartFaceSearchRequest;
use \OpenAPI\OpenAPI\Models\Shared\NotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartFaceSearchXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartFaceSearchRequest();
    $request->startFaceSearchRequest = new StartFaceSearchRequest();
    $request->startFaceSearchRequest->clientRequestToken = 'tenetur';
    $request->startFaceSearchRequest->collectionId = 'quasi';
    $request->startFaceSearchRequest->faceMatchThreshold = 8694.89;
    $request->startFaceSearchRequest->jobTag = 'et';
    $request->startFaceSearchRequest->notificationChannel = new NotificationChannel();
    $request->startFaceSearchRequest->notificationChannel->roleArn = 'voluptate';
    $request->startFaceSearchRequest->notificationChannel->snsTopicArn = 'ipsa';
    $request->startFaceSearchRequest->video = new Video();
    $request->startFaceSearchRequest->video->s3Object = new S3Object();
    $request->startFaceSearchRequest->video->s3Object->bucket = 'minima';
    $request->startFaceSearchRequest->video->s3Object->name = 'Edith Ferry';
    $request->startFaceSearchRequest->video->s3Object->version = 'accusantium';
    ...
    $request->xAmzTarget = StartFaceSearchXAmzTargetEnum::REKOGNITION_SERVICE_START_FACE_SEARCH;

    $response = $sdk->sdk->startFaceSearch($request);

    if ($response->startFaceSearchResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartLabelDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartLabelDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\LabelDetectionFeatureNameEnum;
use \OpenAPI\OpenAPI\Models\Shared\NotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\LabelDetectionSettings;
use \OpenAPI\OpenAPI\Models\Shared\GeneralLabelsSettings;
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartLabelDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartLabelDetectionRequest();
    $request->startLabelDetectionRequest = new StartLabelDetectionRequest();
    $request->startLabelDetectionRequest->clientRequestToken = 'non';
    $request->startLabelDetectionRequest->features = [
        LabelDetectionFeatureNameEnum::GENERAL_LABELS,
    ];
    $request->startLabelDetectionRequest->jobTag = 'dolor';
    $request->startLabelDetectionRequest->minConfidence = 5801.52;
    $request->startLabelDetectionRequest->notificationChannel = new NotificationChannel();
    $request->startLabelDetectionRequest->notificationChannel->roleArn = 'numquam';
    $request->startLabelDetectionRequest->notificationChannel->snsTopicArn = 'impedit';
    $request->startLabelDetectionRequest->settings = new LabelDetectionSettings();
    $request->startLabelDetectionRequest->settings->generalLabels = new GeneralLabelsSettings();
    $request->startLabelDetectionRequest->settings->generalLabels->labelCategoryExclusionFilters = [
        'voluptas',
    ];
    $request->startLabelDetectionRequest->settings->generalLabels->labelCategoryInclusionFilters = [
        'dignissimos',
    ];
    $request->startLabelDetectionRequest->settings->generalLabels->labelExclusionFilters = [
        'maiores',
    ];
    $request->startLabelDetectionRequest->settings->generalLabels->labelInclusionFilters = [
        'velit',
        'voluptatibus',
        'voluptas',
    ];
    $request->startLabelDetectionRequest->video = new Video();
    $request->startLabelDetectionRequest->video->s3Object = new S3Object();
    $request->startLabelDetectionRequest->video->s3Object->bucket = 'asperiores';
    $request->startLabelDetectionRequest->video->s3Object->name = 'Eileen Hagenes';
    $request->startLabelDetectionRequest->video->s3Object->version = 'officia';
    ...
    $request->xAmzTarget = StartLabelDetectionXAmzTargetEnum::REKOGNITION_SERVICE_START_LABEL_DETECTION;

    $response = $sdk->sdk->startLabelDetection($request);

    if ($response->startLabelDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartPersonTrackingRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartPersonTrackingRequest;
use \OpenAPI\OpenAPI\Models\Shared\NotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartPersonTrackingXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartPersonTrackingRequest();
    $request->startPersonTrackingRequest = new StartPersonTrackingRequest();
    $request->startPersonTrackingRequest->clientRequestToken = 'porro';
    $request->startPersonTrackingRequest->jobTag = 'quod';
    $request->startPersonTrackingRequest->notificationChannel = new NotificationChannel();
    $request->startPersonTrackingRequest->notificationChannel->roleArn = 'labore';
    $request->startPersonTrackingRequest->notificationChannel->snsTopicArn = 'ab';
    $request->startPersonTrackingRequest->video = new Video();
    $request->startPersonTrackingRequest->video->s3Object = new S3Object();
    $request->startPersonTrackingRequest->video->s3Object->bucket = 'adipisci';
    $request->startPersonTrackingRequest->video->s3Object->name = 'Orlando Homenick';
    $request->startPersonTrackingRequest->video->s3Object->version = 'est';
    ...
    $request->xAmzTarget = StartPersonTrackingXAmzTargetEnum::REKOGNITION_SERVICE_START_PERSON_TRACKING;

    $response = $sdk->sdk->startPersonTracking($request);

    if ($response->startPersonTrackingResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Operations\StartProjectVersionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartProjectVersionRequest();
    $request->startProjectVersionRequest = new StartProjectVersionRequest();
    $request->startProjectVersionRequest->maxInferenceUnits = 287051;
    $request->startProjectVersionRequest->minInferenceUnits = 822560;
    $request->startProjectVersionRequest->projectVersionArn = 'facilis';
    ...
    $request->xAmzSignedHeaders = 'nemo';
    $request->xAmzTarget = StartProjectVersionXAmzTargetEnum::REKOGNITION_SERVICE_START_PROJECT_VERSION;

    $response = $sdk->sdk->startProjectVersion($request);

    if ($response->startProjectVersionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartSegmentDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartSegmentDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartSegmentDetectionFilters;
use \OpenAPI\OpenAPI\Models\Shared\StartShotDetectionFilter;
use \OpenAPI\OpenAPI\Models\Shared\StartTechnicalCueDetectionFilter;
use \OpenAPI\OpenAPI\Models\Shared\BlackFrame;
use \OpenAPI\OpenAPI\Models\Shared\NotificationChannel;
use \OpenAPI\OpenAPI\Models\Shared\SegmentTypeEnum;
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartSegmentDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartSegmentDetectionRequest();
    $request->startSegmentDetectionRequest = new StartSegmentDetectionRequest();
    $request->startSegmentDetectionRequest->clientRequestToken = 'recusandae';
    $request->startSegmentDetectionRequest->filters = new StartSegmentDetectionFilters();
    $request->startSegmentDetectionRequest->filters->shotFilter = new StartShotDetectionFilter();
    $request->startSegmentDetectionRequest->filters->shotFilter->minSegmentConfidence = 3975.33;
    $request->startSegmentDetectionRequest->filters->technicalCueFilter = new StartTechnicalCueDetectionFilter();
    $request->startSegmentDetectionRequest->filters->technicalCueFilter->blackFrame = new BlackFrame();
    $request->startSegmentDetectionRequest->filters->technicalCueFilter->blackFrame->maxPixelThreshold = 460.07;
    $request->startSegmentDetectionRequest->filters->technicalCueFilter->blackFrame->minCoveragePercentage = 7386.83;
    $request->startSegmentDetectionRequest->filters->technicalCueFilter->minSegmentConfidence = 2326.27;
    $request->startSegmentDetectionRequest->jobTag = 'in';
    $request->startSegmentDetectionRequest->notificationChannel = new NotificationChannel();
    $request->startSegmentDetectionRequest->notificationChannel->roleArn = 'exercitationem';
    $request->startSegmentDetectionRequest->notificationChannel->snsTopicArn = 'earum';
    $request->startSegmentDetectionRequest->segmentTypes = [
        SegmentTypeEnum::TECHNICAL_CUE,
        SegmentTypeEnum::SHOT,
        SegmentTypeEnum::TECHNICAL_CUE,
        SegmentTypeEnum::SHOT,
    ];
    $request->startSegmentDetectionRequest->video = new Video();
    $request->startSegmentDetectionRequest->video->s3Object = new S3Object();
    $request->startSegmentDetectionRequest->video->s3Object->bucket = 'quidem';
    $request->startSegmentDetectionRequest->video->s3Object->name = 'Dr. Terence Gulgowski';
    $request->startSegmentDetectionRequest->video->s3Object->version = 'non';
    ...
    $request->xAmzSignedHeaders = 'corporis';
    $request->xAmzTarget = StartSegmentDetectionXAmzTargetEnum::REKOGNITION_SERVICE_START_SEGMENT_DETECTION;

    $response = $sdk->sdk->startSegmentDetection($request);

    if ($response->startSegmentDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessingStartSelector;
use \OpenAPI\OpenAPI\Models\Shared\KinesisVideoStreamStartSelector;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessingStopSelector;
use \OpenAPI\OpenAPI\Models\Operations\StartStreamProcessorXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartStreamProcessorRequest();
    $request->startStreamProcessorRequest = new StartStreamProcessorRequest();
    $request->startStreamProcessorRequest->name = 'Rick Beer';
    $request->startStreamProcessorRequest->startSelector = new StreamProcessingStartSelector();
    $request->startStreamProcessorRequest->startSelector->kvsStreamStartSelector = new KinesisVideoStreamStartSelector();
    $request->startStreamProcessorRequest->startSelector->kvsStreamStartSelector->fragmentNumber = 'vitae';
    $request->startStreamProcessorRequest->startSelector->kvsStreamStartSelector->producerTimestamp = 881721;
    $request->startStreamProcessorRequest->stopSelector = new StreamProcessingStopSelector();
    $request->startStreamProcessorRequest->stopSelector->maxDurationInSeconds = 631126;
    $request->xAmzAlgorithm = 'tempora';
    $request->xAmzContentSha256 = 'aspernatur';
    ...
    $request->xAmzTarget = StartStreamProcessorXAmzTargetEnum::REKOGNITION_SERVICE_START_STREAM_PROCESSOR;

    $response = $sdk->sdk->startStreamProcessor($request);

    if ($response->startStreamProcessorResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StartTextDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartTextDetectionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StartTextDetectionFilters;
use \OpenAPI\OpenAPI\Models\Shared\RegionOfInterest;
use \OpenAPI\OpenAPI\Models\Shared\BoundingBox;
use \OpenAPI\OpenAPI\Models\Shared\Point;
use \OpenAPI\OpenAPI\Models\Shared\DetectionFilter;
...
use \OpenAPI\OpenAPI\Models\Shared\Video;
use \OpenAPI\OpenAPI\Models\Shared\S3Object;
use \OpenAPI\OpenAPI\Models\Operations\StartTextDetectionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StartTextDetectionRequest();
    $request->startTextDetectionRequest = new StartTextDetectionRequest();
    $request->startTextDetectionRequest->clientRequestToken = 'dolorum';
    $request->startTextDetectionRequest->filters = new StartTextDetectionFilters();
    $request->startTextDetectionRequest->filters->regionsOfInterest = [
        new RegionOfInterest(),
    ];
    $request->startTextDetectionRequest->filters->wordFilter = new DetectionFilter();
    $request->startTextDetectionRequest->filters->wordFilter->minBoundingBoxHeight = 7955.35;
    $request->startTextDetectionRequest->filters->wordFilter->minBoundingBoxWidth = 1718.53;
    $request->startTextDetectionRequest->filters->wordFilter->minConfidence = 5039.34;
    $request->startTextDetectionRequest->jobTag = 'in';
    $request->startTextDetectionRequest->notificationChannel = new NotificationChannel();
    $request->startTextDetectionRequest->notificationChannel->roleArn = 'dolore';
    $request->startTextDetectionRequest->notificationChannel->snsTopicArn = 'aliquam';
    $request->startTextDetectionRequest->video = new Video();
    $request->startTextDetectionRequest->video->s3Object = new S3Object();
    $request->startTextDetectionRequest->video->s3Object->bucket = 'officiis';
    $request->startTextDetectionRequest->video->s3Object->name = 'Dustin Ferry';
    $request->startTextDetectionRequest->video->s3Object->version = 'quas';
    ...
    $request->xAmzTarget = StartTextDetectionXAmzTargetEnum::REKOGNITION_SERVICE_START_TEXT_DETECTION;

    $response = $sdk->sdk->startTextDetection($request);

    if ($response->startTextDetectionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StopProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Shared\StopProjectVersionRequest;
use \OpenAPI\OpenAPI\Models\Operations\StopProjectVersionXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StopProjectVersionRequest();
    $request->stopProjectVersionRequest = new StopProjectVersionRequest();
    $request->stopProjectVersionRequest->projectVersionArn = 'exercitationem';
    ...
    $request->xAmzTarget = StopProjectVersionXAmzTargetEnum::REKOGNITION_SERVICE_STOP_PROJECT_VERSION;

    $response = $sdk->sdk->stopProjectVersion($request);

    if ($response->stopProjectVersionResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\StopStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\StopStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Operations\StopStreamProcessorXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new StopStreamProcessorRequest();
    $request->stopStreamProcessorRequest = new StopStreamProcessorRequest();
    $request->stopStreamProcessorRequest->name = 'Miss Jared Quitzon';
    ...
    $request->xAmzSignature = 'explicabo';
    $request->xAmzSignedHeaders = 'voluptas';
    $request->xAmzTarget = StopStreamProcessorXAmzTargetEnum::REKOGNITION_SERVICE_STOP_STREAM_PROCESSOR;

    $response = $sdk->sdk->stopStreamProcessor($request);

    if ($response->stopStreamProcessorResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $request->tagResourceRequest->resourceArn = 'unde';
    ...
    $request->xAmzTarget = TagResourceXAmzTargetEnum::REKOGNITION_SERVICE_TAG_RESOURCE;
...
try {
    ...
    $request->untagResourceRequest->resourceArn = 'sed';
    ...
    $request->xAmzTarget = UntagResourceXAmzTargetEnum::REKOGNITION_SERVICE_UNTAG_RESOURCE;
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\UpdateDatasetEntriesRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdateDatasetEntriesRequest;
use \OpenAPI\OpenAPI\Models\Shared\DatasetChanges;
use \OpenAPI\OpenAPI\Models\Operations\UpdateDatasetEntriesXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateDatasetEntriesRequest();
    $request->updateDatasetEntriesRequest = new UpdateDatasetEntriesRequest();
    $request->updateDatasetEntriesRequest->changes = new DatasetChanges();
    $request->updateDatasetEntriesRequest->changes->groundTruth = 'reiciendis';
    $request->updateDatasetEntriesRequest->datasetArn = 'ex';
    ...
    $request->xAmzSignedHeaders = 'incidunt';
    $request->xAmzTarget = UpdateDatasetEntriesXAmzTargetEnum::REKOGNITION_SERVICE_UPDATE_DATASET_ENTRIES;

    $response = $sdk->sdk->updateDatasetEntries($request);

    if ($response->updateDatasetEntriesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\UpdateStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\UpdateStreamProcessorRequest;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorDataSharingPreference;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorParameterToDeleteEnum;
use \OpenAPI\OpenAPI\Models\Shared\RegionOfInterest;
use \OpenAPI\OpenAPI\Models\Shared\BoundingBox;
use \OpenAPI\OpenAPI\Models\Shared\Point;
use \OpenAPI\OpenAPI\Models\Shared\StreamProcessorSettingsForUpdate;
use \OpenAPI\OpenAPI\Models\Shared\ConnectedHomeSettingsForUpdate;
use \OpenAPI\OpenAPI\Models\Operations\UpdateStreamProcessorXAmzTargetEnum;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateStreamProcessorRequest();
    $request->updateStreamProcessorRequest = new UpdateStreamProcessorRequest();
    $request->updateStreamProcessorRequest->dataSharingPreferenceForUpdate = new StreamProcessorDataSharingPreference();
    $request->updateStreamProcessorRequest->dataSharingPreferenceForUpdate->optIn = false;
    $request->updateStreamProcessorRequest->name = 'Miss Alyssa Leffler';
    $request->updateStreamProcessorRequest->parametersToDelete = [
        StreamProcessorParameterToDeleteEnum::CONNECTED_HOME_MIN_CONFIDENCE,
        StreamProcessorParameterToDeleteEnum::REGIONS_OF_INTEREST,
    ];
    $request->updateStreamProcessorRequest->regionsOfInterestForUpdate = [
        new RegionOfInterest(),
        new RegionOfInterest(),
        new RegionOfInterest(),
        new RegionOfInterest(),
    ];
    $request->updateStreamProcessorRequest->settingsForUpdate = new StreamProcessorSettingsForUpdate();
    $request->updateStreamProcessorRequest->settingsForUpdate->connectedHomeForUpdate = new ConnectedHomeSettingsForUpdate();
    $request->updateStreamProcessorRequest->settingsForUpdate->connectedHomeForUpdate->labels = [
        'magni',
        'aperiam',
        'saepe',
        'numquam',
    ];
    $request->updateStreamProcessorRequest->settingsForUpdate->connectedHomeForUpdate->minConfidence = 3299.35;
    ...
    $request->xAmzTarget = UpdateStreamProcessorXAmzTargetEnum::REKOGNITION_SERVICE_UPDATE_STREAM_PROCESSOR;

    $response = $sdk->sdk->updateStreamProcessor($request);

    if ($response->updateStreamProcessorResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
