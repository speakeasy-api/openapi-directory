...
class DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugCommitCommitApprovePathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveSecurity = dataclasses.field()
