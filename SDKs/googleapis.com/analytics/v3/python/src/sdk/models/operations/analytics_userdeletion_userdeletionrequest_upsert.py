...
class AnalyticsUserDeletionUserDeletionRequestUpsertRequest:
    ...
    user_deletion_request_input: Optional[shared_userdeletionrequest.UserDeletionRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
