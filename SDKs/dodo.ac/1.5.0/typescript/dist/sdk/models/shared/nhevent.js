...
exports.NHEvent = exports.NHEventTypeEnum = void 0;
 ...
 */
var NHEventTypeEnum;
(function (NHEventTypeEnum) {
    NHEventTypeEnum["Event"] = "Event";
    NHEventTypeEnum["NookShopping"] = "Nook Shopping";
    NHEventTypeEnum["Recipes"] = "Recipes";
    NHEventTypeEnum["Birthday"] = "Birthday";
})(NHEventTypeEnum = exports.NHEventTypeEnum || (exports.NHEventTypeEnum = {}));
var NHEvent = /** @class */ (function (_super) {
    __extends(NHEvent, _super);
    function NHEvent() {
    ...
    ], NHEvent.prototype, "date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "event" }),
        __metadata("design:type", String)
    ], NHEvent.prototype, "event", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "type" }),
        __metadata("design:type", String)
    ], NHEvent.prototype, "type", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "url" }),
        __metadata("design:type", String)
    ], NHEvent.prototype, "url", void 0);
    return NHEvent;
}(utils_1.SpeakeasyBase));
exports.NHEvent = NHEvent;
