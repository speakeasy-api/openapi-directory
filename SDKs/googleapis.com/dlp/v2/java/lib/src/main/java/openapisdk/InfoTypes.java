...
public class InfoTypes {
	...
	public InfoTypes(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    **/
    public openapisdk.models.operations.DlpInfoTypesListResponse dlpInfoTypesList(openapisdk.models.operations.DlpInfoTypesListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/infoTypes");
        ...
        openapisdk.models.operations.DlpInfoTypesListResponse res = new openapisdk.models.operations.DlpInfoTypesListResponse() {{
