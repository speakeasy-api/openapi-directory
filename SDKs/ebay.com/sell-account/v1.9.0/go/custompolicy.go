...
func (s *customPolicy) CreateCustomPolicy(ctx context.Context, request operations.CreateCustomPolicyRequest) (*operations.CreateCustomPolicyResponse, error) {
	baseURL := s.serverURL
...
func (s *customPolicy) GetCustomPolicies(ctx context.Context, request operations.GetCustomPoliciesRequest) (*operations.GetCustomPoliciesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/custom_policy/"
...
func (s *customPolicy) GetCustomPolicy(ctx context.Context, request operations.GetCustomPolicyRequest) (*operations.GetCustomPolicyResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/custom_policy/{custom_policy_id}", request.PathParams, nil)
...
func (s *customPolicy) UpdateCustomPolicy(ctx context.Context, request operations.UpdateCustomPolicyRequest) (*operations.UpdateCustomPolicyResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/custom_policy/{custom_policy_id}", request.PathParams, nil)
