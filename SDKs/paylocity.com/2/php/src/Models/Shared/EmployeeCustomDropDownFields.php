...
class EmployeeCustomDropDownFields
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\EmployeeCustomDropDownFieldsCategoryEnum $category
     */
	#[\JMS\Serializer\Annotation\SerializedName('category')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\EmployeeCustomDropDownFieldsCategoryEnum>')]
	...
	{
		$this->category = \OpenAPI\OpenAPI\Models\Shared\EmployeeCustomDropDownFieldsCategoryEnum::PAYROLL_AND_HR;
		$this->label = "";
		$this->value = "";
	}
}
