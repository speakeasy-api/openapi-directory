...
func (e *GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesEnum) UnmarshalJSON(data []byte) error {
	...
	case "PERSON_DETECTION":
		*e = GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1AnnotateVideoRequestFeaturesEnum: %s", s)
	}
}
