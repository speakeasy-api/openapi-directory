...
exports.ListUsAppToPersonResponse = exports.ListUsAppToPersonListUsAppToPersonResponse = exports.ListUsAppToPersonListUsAppToPersonResponseMeta = exports.ListUsAppToPersonRequest = exports.ListUsAppToPersonSecurity = exports.ListUsAppToPersonServerList = void 0;
...
var ListUsAppToPersonSecurity = /** @class */ (function (_super) {
    ...
    ], ListUsAppToPersonSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUsAppToPersonSecurity.prototype, "username", void 0);
...
var ListUsAppToPersonRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUsAppToPersonRequest.prototype, "messagingServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUsAppToPersonRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUsAppToPersonRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUsAppToPersonRequest.prototype, "pageToken", void 0);
...
var ListUsAppToPersonListUsAppToPersonResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.MessagingV1ServiceUsAppToPerson }),
        (0, class_transformer_1.Expose)({ name: "compliance" }),
        (0, class_transformer_1.Type)(function () { return shared.MessagingV1ServiceUsAppToPerson; }),
        __metadata("design:type", Array)
    ], ListUsAppToPersonListUsAppToPersonResponse.prototype, "compliance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListUsAppToPersonListUsAppToPersonResponseMeta; }),
...
var ListUsAppToPersonResponse = /** @class */ (function (_super) {
    ...
    ], ListUsAppToPersonResponse.prototype, "rawResponse", void 0);
