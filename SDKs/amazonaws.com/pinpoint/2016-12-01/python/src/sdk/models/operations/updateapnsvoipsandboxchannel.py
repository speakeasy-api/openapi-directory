...
class UpdateApnsVoipSandboxChannelRequestBody:
    apns_voip_sandbox_channel_request: UpdateApnsVoipSandboxChannelRequestBodyApnsVoipSandboxChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('APNSVoipSandboxChannelRequest') }})
    

@dataclasses.dataclass
class UpdateApnsVoipSandboxChannelRequest:
    headers: UpdateApnsVoipSandboxChannelHeaders = dataclasses.field()
    path_params: UpdateApnsVoipSandboxChannelPathParams = dataclasses.field()
    request: UpdateApnsVoipSandboxChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
