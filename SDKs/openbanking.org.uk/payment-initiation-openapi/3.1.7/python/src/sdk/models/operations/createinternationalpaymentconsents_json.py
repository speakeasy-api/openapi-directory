...
class CreateInternationalPaymentConsentsJSONSecurity:
...
class CreateInternationalPaymentConsentsJSONRequest:
    ...
    ob_write_international_consent5: shared_obwriteinternationalconsent5.OBWriteInternationalConsent5 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
