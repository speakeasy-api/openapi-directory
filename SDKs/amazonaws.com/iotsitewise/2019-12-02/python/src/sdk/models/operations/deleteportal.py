...
from ..shared import deleteportalresponse as shared_deleteportalresponse
...
class DeletePortalRequest:
    headers: DeletePortalHeaders = dataclasses.field()
    path_params: DeletePortalPathParams = dataclasses.field()
    query_params: DeletePortalQueryParams = dataclasses.field()
...
class DeletePortalResponse:
    ...
    delete_portal_response: Optional[shared_deleteportalresponse.DeletePortalResponse] = dataclasses.field(default=None)
