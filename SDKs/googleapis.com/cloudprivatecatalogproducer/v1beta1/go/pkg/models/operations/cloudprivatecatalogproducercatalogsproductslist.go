...
type CloudprivatecatalogproducerCatalogsProductsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudprivatecatalogproducerCatalogsProductsListPathParams struct {
	// The resource name of the parent resource.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type CloudprivatecatalogproducerCatalogsProductsListQueryParams struct {
	// V1 error format.
...
type CloudprivatecatalogproducerCatalogsProductsListRequest struct {
...
type CloudprivatecatalogproducerCatalogsProductsListResponse struct {
	Body        []byte
	ContentType string
	StatusCode  int
