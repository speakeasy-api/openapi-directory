...
export class ConnectorResources {
  ...
  connectorResourcesOne(
    ...
    security: operations.ConnectorResourcesOneSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ConnectorResourcesOneResponse =
        new operations.ConnectorResourcesOneResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getConnectorResourceResponse = utils.objectToClass(
              httpRes?.data,
              shared.GetConnectorResourceResponse
            );
          }
          break;
