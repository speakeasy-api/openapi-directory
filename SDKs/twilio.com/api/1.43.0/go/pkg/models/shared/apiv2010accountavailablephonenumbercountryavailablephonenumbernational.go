...
// APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities - The set of Boolean properties that indicate whether a phone number can receive calls or messages.  Capabilities are: `Voice`, `SMS`, and `MMS` and each capability can be: `true` or `false`.
