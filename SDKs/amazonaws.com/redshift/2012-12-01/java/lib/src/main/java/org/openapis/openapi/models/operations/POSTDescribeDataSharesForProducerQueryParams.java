...
public class POSTDescribeDataSharesForProducerQueryParams {
    ...
    public POSTDescribeDataSharesForProducerQueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public POSTDescribeDataSharesForProducerQueryParams withMaxRecords(String maxRecords) {
