...
class GetTrailStatusRequest:
    headers: GetTrailStatusHeaders = dataclasses.field()
    request: shared_gettrailstatusrequest.GetTrailStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
