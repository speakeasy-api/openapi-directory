...
class AutoScheduleAutoImportRequest:
    ...
    schedule_auto_import_request: shared_scheduleautoimportrequest.ScheduleAutoImportRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class AutoScheduleAutoImportResponse:
    ...
    r"""When the max catalog Auto Import count has been reached.
