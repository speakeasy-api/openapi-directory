...
public class ListFieldLevelEncryptionConfigs20171030QueryParams {
    /**
    ...
    public ListFieldLevelEncryptionConfigs20171030QueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListFieldLevelEncryptionConfigs20171030QueryParams withMaxItems(String maxItems) {
