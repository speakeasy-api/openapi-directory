...
export class ListRoomParticipantSubscribedTrackListRoomParticipantSubscribedTrackResponse extends SpeakeasyBase {
  ...
  @Type(
    () =>
      ListRoomParticipantSubscribedTrackListRoomParticipantSubscribedTrackResponseMeta
  )
  ...
  @Expose({ name: "subscribed_tracks" })
  @Type(() => shared.VideoV1RoomRoomParticipantRoomParticipantSubscribedTrack)
