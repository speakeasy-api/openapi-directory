...
export class ResourcePolicies {
  ...
  computeResourcePoliciesPatch(
    req: operations.ComputeResourcePoliciesPatchRequest,
    security: operations.ComputeResourcePoliciesPatchSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeResourcePoliciesPatchResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeResourcePoliciesPatchResponse =
        new operations.ComputeResourcePoliciesPatchResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
