...
class ImGroupMembersPathParams:
    group_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'groupId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ImGroupMembersQueryParams:
...
class ImGroupMembersGroupMemberListMembers:
    r"""ImGroupMembersGroupMemberListMembers
    Group member object.
    """
...
class ImGroupMembersGroupMemberList:
    r"""ImGroupMembersGroupMemberList
    Pagination Object.
    """
    
    members: Optional[list[ImGroupMembersGroupMemberListMembers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('members') }})
...
class ImGroupMembersRequest:
    path_params: ImGroupMembersPathParams = dataclasses.field()
    query_params: ImGroupMembersQueryParams = dataclasses.field()
    security: ImGroupMembersSecurity = dataclasses.field()
