...
export enum GETStopStackSetOperationActionEnum {
 ...
 */
export enum GETStopStackSetOperationCallAsEnum {
  Self = "SELF",
  DelegatedAdmin = "DELEGATED_ADMIN",
}

export enum GETStopStackSetOperationVersionEnum {
  TwoThousandAndTen0515 = "2010-05-15",
}

export class GETStopStackSetOperationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETStopStackSetOperationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
