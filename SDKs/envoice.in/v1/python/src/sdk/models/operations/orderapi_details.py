...
from ..shared import orderfulldetailsapimodel as shared_orderfulldetailsapimodel
...
class OrderAPIDetailsResponse:
    ...
    order_full_details_api_model: Optional[shared_orderfulldetailsapimodel.OrderFullDetailsAPIModel] = dataclasses.field(default=None)
    r"""OK"""  
