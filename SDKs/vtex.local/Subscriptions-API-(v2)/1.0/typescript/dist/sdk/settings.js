...
var Settings = /** @class */ (function () {
     ...
     */
    Settings.prototype.editSettings = function (req, config) {
        var _a;
        ...
        try {
            _a = utils.serializeRequestBody(req, "settings", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.EditSettingsResponse({
     ...
     */
    Settings.prototype.getSettings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
