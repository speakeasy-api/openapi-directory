 ...
 */
export class CreateDistribution20170325RequestBodyDistributionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateDistribution20170325RequestBody extends SpeakeasyBase {
  /**
   * A distribution configuration.
   */
  @SpeakeasyMetadata()
