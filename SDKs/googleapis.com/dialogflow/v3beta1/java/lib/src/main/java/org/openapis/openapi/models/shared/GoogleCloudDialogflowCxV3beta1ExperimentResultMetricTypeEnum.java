 ...
 */
public enum GoogleCloudDialogflowCxV3beta1ExperimentResultMetricTypeEnum {
    ...
    private GoogleCloudDialogflowCxV3beta1ExperimentResultMetricTypeEnum(String value) {
        this.value = value;
    }
}
