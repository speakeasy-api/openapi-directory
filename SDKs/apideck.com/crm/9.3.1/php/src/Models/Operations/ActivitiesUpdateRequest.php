...
class ActivitiesUpdateRequest
{
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public \OpenAPI\OpenAPI\Models\Shared\ActivityInput $activityInput;
	...
	{
		$this->activityInput = new \OpenAPI\OpenAPI\Models\Shared\ActivityInput();
		$this->id = "";
		$this->raw = null;
		$this->xApideckAppId = "";
