...
class AchievementSetStepsAtLeastResponse:
    r"""An achievement set steps at least response."""
    ...
    r"""Uniquely identifies the type of this resource. Value is always the fixed string `games#achievementSetStepsAtLeastResponse`."""  
