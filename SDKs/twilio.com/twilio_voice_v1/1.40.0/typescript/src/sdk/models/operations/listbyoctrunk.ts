...
export const ListByocTrunkServerList = ["https://voice.twilio.com"] as const;
...
export class ListByocTrunkListByocTrunkResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.VoiceV1ByocTrunk })
  @Expose({ name: "byoc_trunks" })
  @Type(() => shared.VoiceV1ByocTrunk)
  byocTrunks?: shared.VoiceV1ByocTrunk[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListByocTrunkListByocTrunkResponseMeta)
