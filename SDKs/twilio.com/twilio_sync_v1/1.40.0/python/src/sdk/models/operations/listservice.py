...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_sync_v1_service.SyncV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
