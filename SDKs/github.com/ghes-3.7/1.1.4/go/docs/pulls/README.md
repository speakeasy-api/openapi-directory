...
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#check-if-a-pull-request-has-been-merged>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#create-a-reply-for-a-review-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#create-a-review-for-a-pull-request>
        ...
        RequestBody: &operations.PullsCreateReviewRequestBody{
            ...
            Comments: []PullsCreateReviewRequestBodyComments{
                ...
                operations.PullsCreateReviewRequestBodyComments{
                    ...
                    Line: sdk.Int64(28),
                    Path: "alias",
                    Position: sdk.Int64(526413),
                    Side: sdk.String("RIGHT"),
                    StartLine: sdk.Int64(26),
                    StartSide: sdk.String("LEFT"),
                },
            },
            CommitID: sdk.String("aut"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#create-a-review-comment-for-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#delete-a-pending-review-for-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#delete-a-review-comment-for-a-pull-request>
...
**Note:** To dismiss a pull request review on a [protected branch](https://docs.github.com/enterprise-server@3.7/rest/reference/repos#branches), you must be a repository administrator or be included in the list of people or teams who can dismiss pull request reviews.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#dismiss-a-review-for-a-pull-request>
...
*   If merged as a [merge commit](https://docs.github.com/enterprise-server@3.7/articles/about-merge-methods-on-github/), `merge_commit_sha` represents the SHA of the merge commit.
*   If merged via a [squash](https://docs.github.com/enterprise-server@3.7/articles/about-merge-methods-on-github/#squashing-your-merge-commits), `merge_commit_sha` represents the SHA of the squashed commit on the base branch.
*   If [rebased](https://docs.github.com/enterprise-server@3.7/articles/about-merge-methods-on-github/#rebasing-and-merging-your-commits), `merge_commit_sha` represents the commit that the base branch was updated to.

Pass the appropriate [media type](https://docs.github.com/enterprise-server@3.7/rest/overview/media-types/#commits-commit-comparison-and-pull-requests) to fetch diff and patch formats.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#get-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#get-a-review-for-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#get-a-review-comment-for-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#list-pull-requests>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#list-comments-for-a-pull-request-review>
...
Lists a maximum of 250 commits for a pull request. To receive a complete commit list for pull requests with more than 250 commits, use the [List commits](https://docs.github.com/enterprise-server@3.7/rest/reference/repos#list-commits) endpoint.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#list-commits-on-a-pull-request>
...
func main() {
    ...
    res, err := s.Pulls.PullsListCommits(ctx, operations.PullsListCommitsRequest{
        Owner: "quia",
        Page: sdk.Int64(354225),
        PerPage: sdk.Int64(786860),
        PullNumber: 120277,
        Repo: "voluptatibus",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#list-pull-requests-files>
...
Gets the users or teams whose review is requested for a pull request. Once a requested reviewer submits a review, they are no longer considered a requested reviewer. Their review will instead be returned by the [List reviews for a pull request](https://docs.github.com/enterprise-server@3.7/rest/pulls/reviews#list-reviews-for-a-pull-request) operation.

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#get-all-requested-reviewers-for-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#list-review-comments-on-a-pull-request>
...
func main() {
    ...
    res, err := s.Pulls.PullsListReviewComments(ctx, operations.PullsListReviewCommentsRequest{
        ...
        PullNumber: 615058,
        Repo: "dicta",
        Since: types.MustTimeFromString("2022-04-15T21:21:40.603Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#list-review-comments-in-a-repository>
...
func main() {
    ...
    res, err := s.Pulls.PullsListReviewCommentsForRepo(ctx, operations.PullsListReviewCommentsForRepoRequest{
        Direction: operations.PullsListReviewCommentsForRepoDirectionEnumAsc.ToPointer(),
        Owner: "itaque",
        Page: sdk.Int64(807419),
        PerPage: sdk.Int64(265905),
        Repo: "consequuntur",
        Since: types.MustTimeFromString("2020-05-15T20:39:22.036Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#list-reviews-for-a-pull-request>
...
func main() {
    ...
    res, err := s.Pulls.PullsListReviews(ctx, operations.PullsListReviewsRequest{
        Owner: "impedit",
        Page: sdk.Int64(783397),
        PerPage: sdk.Int64(883819),
        PullNumber: 518990,
        Repo: "reiciendis",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#merge-a-pull-request>
...
func main() {
    ...
    res, err := s.Pulls.PullsMerge(ctx, operations.PullsMergeRequest{
        RequestBody: &operations.PullsMergeRequestBody{
            CommitMessage: sdk.String("ab"),
            CommitTitle: sdk.String("sint"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#remove-requested-reviewers-from-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#request-reviewers-for-a-pull-request>
...
Submits a pending review for a pull request. For more information about creating a pending review for a pull request, see "[Create a review for a pull request](https://docs.github.com/enterprise-server@3.7/rest/pulls#create-a-review-for-a-pull-request)."

API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#submit-a-review-for-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls/#update-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#update-a-pull-request-branch>
...
func main() {
    ...
    res, err := s.Pulls.PullsUpdateBranch(ctx, operations.PullsUpdateBranchRequest{
        RequestBody: &operations.PullsUpdateBranchRequestBody{
            ExpectedHeadSha: sdk.String("ipsam"),
        },
        Owner: "cupiditate",
        PullNumber: 761437,
        Repo: "alias",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#update-a-review-for-a-pull-request>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/pulls#update-a-review-comment-for-a-pull-request>
