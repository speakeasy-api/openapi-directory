...
class GETCancelSpotInstanceRequestsRequest:
    ...
    action: GETCancelSpotInstanceRequestsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    spot_instance_request_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'SpotInstanceRequestId', 'style': 'form', 'explode': True }})
    r"""One or more Spot Instance request IDs."""  
    version: GETCancelSpotInstanceRequestsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
