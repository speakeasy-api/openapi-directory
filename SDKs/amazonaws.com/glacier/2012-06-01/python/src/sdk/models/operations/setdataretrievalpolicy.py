...
class SetDataRetrievalPolicyRequestBody:
    policy: Optional[SetDataRetrievalPolicyRequestBodyPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Policy') }})
    

@dataclasses.dataclass
class SetDataRetrievalPolicyRequest:
    headers: SetDataRetrievalPolicyHeaders = dataclasses.field()
    path_params: SetDataRetrievalPolicyPathParams = dataclasses.field()
    request: SetDataRetrievalPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
