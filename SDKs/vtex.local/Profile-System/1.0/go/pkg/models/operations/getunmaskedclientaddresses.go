...
type GetUnmaskedClientAddressesPathParams struct {
...
type GetUnmaskedClientAddressesQueryParams struct {
...
type GetUnmaskedClientAddressesHeaders struct {
...
type GetUnmaskedClientAddressesRequest struct {
	PathParams  GetUnmaskedClientAddressesPathParams
	QueryParams GetUnmaskedClientAddressesQueryParams
	Headers     GetUnmaskedClientAddressesHeaders
}

type GetUnmaskedClientAddressesResponse struct {
	ContentType string
	// OK
	GetUnmaskedClientAddresses200ApplicationJSONObjects []map[string]interface{}
	StatusCode                                          int
