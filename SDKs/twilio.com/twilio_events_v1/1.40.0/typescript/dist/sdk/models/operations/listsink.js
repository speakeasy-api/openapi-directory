...
exports.ListSinkResponse = exports.ListSinkListSinkResponse = exports.ListSinkListSinkResponseMeta = exports.ListSinkRequest = exports.ListSinkSecurity = exports.ListSinkServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSinkServerList = ["https://events.twilio.com"];
var ListSinkSecurity = /** @class */ (function (_super) {
    ...
    ], ListSinkSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSinkSecurity.prototype, "username", void 0);
...
var ListSinkRequest = /** @class */ (function (_super) {
    ...
    ], ListSinkRequest.prototype, "inUse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSinkRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSinkRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSinkRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListSinkRequest.prototype, "status", void 0);
...
var ListSinkListSinkResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListSinkListSinkResponseMeta; }),
        __metadata("design:type", ListSinkListSinkResponseMeta)
    ], ListSinkListSinkResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.EventsV1Sink }),
        (0, class_transformer_1.Expose)({ name: "sinks" }),
        (0, class_transformer_1.Type)(function () { return shared.EventsV1Sink; }),
...
var ListSinkResponse = /** @class */ (function (_super) {
    ...
    ], ListSinkResponse.prototype, "rawResponse", void 0);
