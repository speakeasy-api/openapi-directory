...
class ActionsReRunJobForWorkflowRunRequestBody:
...
class ActionsReRunJobForWorkflowRunRequest:
    ...
    request_body: Optional[ActionsReRunJobForWorkflowRunRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
