...
export declare class AuthAuthkeyPostSecurity extends SpeakeasyBase {
    appKey: string;
}
export declare class AuthAuthkeyPostRequest extends SpeakeasyBase {
    /**
...
export declare class AuthAuthkeyPostResponse extends SpeakeasyBase {
    /**
     * Access Denied
     */
