...
public class Drives {
    ...
    **/
    public openapisdk.models.operations.DriveDrivesInsertResponse driveDrivesInsert(openapisdk.models.operations.DriveDrivesInsertRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.DriveDrivesInsertResponse res = new openapisdk.models.operations.DriveDrivesInsertResponse() {{
            drive = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
