...
var Organisation = /** @class */ (function () {
    function Organisation(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Organisation.prototype.getOrg = function (config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.orgResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
