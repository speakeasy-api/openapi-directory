...
const (
	DeleteResourcePolicyXAmzTargetEnumAmazonSsmDeleteResourcePolicy DeleteResourcePolicyXAmzTargetEnum = "AmazonSSM.DeleteResourcePolicy"
)
...
func (e *DeleteResourcePolicyXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AmazonSSM.DeleteResourcePolicy":
