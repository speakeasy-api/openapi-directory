...
class SDK:
    ...
    def create_environment_ec2(self, request: operations.CreateEnvironmentEc2Request) -> operations.CreateEnvironmentEc2Response:
        ...
        res = operations.CreateEnvironmentEc2Response(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateEnvironmentEc2Result])
    ...
    def create_environment_membership(self, request: operations.CreateEnvironmentMembershipRequest) -> operations.CreateEnvironmentMembershipResponse:
        ...
        res = operations.CreateEnvironmentMembershipResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateEnvironmentMembershipResult])
    ...
    def delete_environment_membership(self, request: operations.DeleteEnvironmentMembershipRequest) -> operations.DeleteEnvironmentMembershipResponse:
        ...
        res = operations.DeleteEnvironmentMembershipResponse(status_code=r.status_code, content_type=content_type)
    ...
    def describe_environment_memberships(self, request: operations.DescribeEnvironmentMembershipsRequest) -> operations.DescribeEnvironmentMembershipsResponse:
        ...
        res = operations.DescribeEnvironmentMembershipsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeEnvironmentMembershipsResult])
    ...
    def describe_environment_status(self, request: operations.DescribeEnvironmentStatusRequest) -> operations.DescribeEnvironmentStatusResponse:
        ...
        res = operations.DescribeEnvironmentStatusResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeEnvironmentStatusResult])
    ...
    def describe_environments(self, request: operations.DescribeEnvironmentsRequest) -> operations.DescribeEnvironmentsResponse:
        ...
        res = operations.DescribeEnvironmentsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeEnvironmentsResult])
    ...
    def list_environments(self, request: operations.ListEnvironmentsRequest) -> operations.ListEnvironmentsResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListEnvironmentsResult])
    ...
    def update_environment_membership(self, request: operations.UpdateEnvironmentMembershipRequest) -> operations.UpdateEnvironmentMembershipResponse:
        ...
        res = operations.UpdateEnvironmentMembershipResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateEnvironmentMembershipResult])
