...
export declare class CreateInternationalStandingOrdersJsonSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateInternationalStandingOrdersJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalStandingOrdersJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
