...
class UpdateGatewayRouteRequestBody:
    ...
    spec: UpdateGatewayRouteRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('spec') }})
    r"""An object that represents a gateway route specification. Specify one gateway route type."""  
...
class UpdateGatewayRouteRequest:
    ...
    r"""The name of the gateway route to update."""  
    ...
    request_body: UpdateGatewayRouteRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
