...
class DetachObjectRequestBody:
    ...
    r"""The link name associated with the object that needs to be detached."""  
    parent_reference: DetachObjectRequestBodyParentReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ParentReference') }})
    r"""The reference that identifies an object."""  
...
class DetachObjectRequest:
    ...
    request_body: DetachObjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_data_partition: str = dataclasses.field(metadata={'header': { 'field_name': 'x-amz-data-partition', 'style': 'simple', 'explode': False }})
    r"""The Amazon Resource Name (ARN) that is associated with the <a>Directory</a> where objects reside. For more information, see <a>arns</a>."""  
