...
LIST_INSIGHTS_ASSESSMENTS_SERVERS = [
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListInsightsAssessmentsListInsightsAssessmentsResponse:
    r"""OK"""
    
    assessments: Optional[list[shared_flex_v1_insights_assessments.FlexV1InsightsAssessments]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assessments'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListInsightsAssessmentsListInsightsAssessmentsResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
...
class ListInsightsAssessmentsResponse:
    ...
    list_insights_assessments_response: Optional[ListInsightsAssessmentsListInsightsAssessmentsResponse] = dataclasses.field(default=None)
    r"""OK"""  
