...
public class ContainerProjectsZonesClustersLegacyAbacPathParams {
    /**
    ...
    public ContainerProjectsZonesClustersLegacyAbacPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersLegacyAbacPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersLegacyAbacPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
