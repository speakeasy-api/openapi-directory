...
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#add-an-email-address-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#check-if-a-user-follows-another-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckFollowingForUserRequest req = new UsersCheckFollowingForUserRequest("maiores", "exercitationem");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#check-if-a-person-is-followed-by-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckPersonIsFollowedByAuthenticatedRequest req = new UsersCheckPersonIsFollowedByAuthenticatedRequest("culpa");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#create-a-gpg-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreateGpgKeyForAuthenticatedUserRequestBody req = new UsersCreateGpgKeyForAuthenticatedUserRequestBody("repudiandae");            
...
Adds a public SSH key to the authenticated user's GitHub account. Requires that you are authenticated via Basic Auth, or OAuth with at least `write:public_key` [scope](https://docs.github.com/enterprise-server@3.5/apps/building-oauth-apps/understanding-scopes-for-oauth-apps/).

API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#create-a-public-ssh-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreatePublicSshKeyForAuthenticatedUserRequestBody req = new UsersCreatePublicSshKeyForAuthenticatedUserRequestBody("aspernatur") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#delete-an-email-address-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = "neque"            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#delete-a-gpg-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeleteGpgKeyForAuthenticatedUserRequest req = new UsersDeleteGpgKeyForAuthenticatedUserRequest(640565L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#delete-a-public-ssh-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeletePublicSshKeyForAuthenticatedUserRequest req = new UsersDeletePublicSshKeyForAuthenticatedUserRequest(379661L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#follow-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersFollowRequest req = new UsersFollowRequest("harum");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#get-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#get-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetByUsernameRequest req = new UsersGetByUsernameRequest("ducimus");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#get-contextual-information-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetContextForUserRequest req = new UsersGetContextForUserRequest("doloremque") {{
                subjectId = "perferendis";
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#get-a-gpg-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetGpgKeyForAuthenticatedUserRequest req = new UsersGetGpgKeyForAuthenticatedUserRequest(481704L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#get-a-public-ssh-key-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetPublicSshKeyForAuthenticatedUserRequest req = new UsersGetPublicSshKeyForAuthenticatedUserRequest(546868L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-users>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-email-addresses-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-the-people-the-authenticated-user-follows>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-followers-of-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-followers-of-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowersForUserRequest req = new UsersListFollowersForUserRequest("est") {{
                page = 435142L;
                perPage = 787629L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-the-people-a-user-follows>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowingForUserRequest req = new UsersListFollowingForUserRequest("provident") {{
                page = 515595L;
                perPage = 722392L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-gpg-keys-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-gpg-keys-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListGpgKeysForUserRequest req = new UsersListGpgKeysForUserRequest("ipsam") {{
                page = 328954L;
                perPage = 273383L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-public-email-addresses-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-public-keys-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListPublicKeysForUserRequest req = new UsersListPublicKeysForUserRequest("doloremque") {{
                page = 854137L;
                perPage = 257821L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#list-public-ssh-keys-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users#unfollow-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersUnfollowRequest req = new UsersUnfollowRequest("nobis");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/users/#update-the-authenticated-user>
