...
* [govid](#govid) - ID Card
* [mbcer](#mbcer) - Membership Certificate
    ...
    public static void main(String[] args) {
        try {
            ...
            GovidRequestBody req = new GovidRequestBody(GovidRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new GovidRequestBodyCertificateParameters("Sunil Kumar", "ACS 128XX");;
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.MbcerRequestBody;
import org.openapis.openapi.models.operations.MbcerRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.MbcerRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.MbcerResponse;
import org.openapis.openapi.models.operations.MbcerSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            MbcerRequestBody req = new MbcerRequestBody(MbcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new MbcerRequestBodyCertificateParameters("ACS,FCS,COP", "Sunil Kumar", "128XX");;
            ...
            MbcerResponse res = sdk.apIs.mbcer(req, new MbcerSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
