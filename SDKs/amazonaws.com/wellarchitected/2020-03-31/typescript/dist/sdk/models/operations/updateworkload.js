...
exports.UpdateWorkloadResponse = exports.UpdateWorkloadRequest = exports.UpdateWorkloadRequestBody = exports.UpdateWorkloadRequestBodyImprovementStatusEnum = exports.UpdateWorkloadRequestBodyEnvironmentEnum = exports.UpdateWorkloadRequestBodyDiscoveryConfig = void 0;
 ...
 */
var UpdateWorkloadRequestBodyDiscoveryConfig = /** @class */ (function (_super) {
    __extends(UpdateWorkloadRequestBodyDiscoveryConfig, _super);
    function UpdateWorkloadRequestBodyDiscoveryConfig() {
    ...
    ], UpdateWorkloadRequestBodyDiscoveryConfig.prototype, "trustedAdvisorIntegrationStatus", void 0);
    return UpdateWorkloadRequestBodyDiscoveryConfig;
}(utils_1.SpeakeasyBase));
exports.UpdateWorkloadRequestBodyDiscoveryConfig = UpdateWorkloadRequestBodyDiscoveryConfig;
/**
...
var UpdateWorkloadRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", Array)
    ], UpdateWorkloadRequestBody.prototype, "applications", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return UpdateWorkloadRequestBodyDiscoveryConfig; }),
        __metadata("design:type", UpdateWorkloadRequestBodyDiscoveryConfig)
    ], UpdateWorkloadRequestBody.prototype, "discoveryConfig", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
var UpdateWorkloadRequest = /** @class */ (function (_super) {
    ...
    ], UpdateWorkloadRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkloadId",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "workloadId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateWorkloadRequest.prototype, "xAmzSignedHeaders", void 0);
...
var UpdateWorkloadResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateWorkloadResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
