...
exports.StopsStopsByGeolocationResponse = exports.StopsStopsByGeolocationRequest = exports.StopsStopsByGeolocationRouteTypesEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var StopsStopsByGeolocationRouteTypesEnum;
(function (StopsStopsByGeolocationRouteTypesEnum) {
    StopsStopsByGeolocationRouteTypesEnum["Zero"] = "0";
    StopsStopsByGeolocationRouteTypesEnum["One"] = "1";
    StopsStopsByGeolocationRouteTypesEnum["Two"] = "2";
    StopsStopsByGeolocationRouteTypesEnum["Three"] = "3";
    StopsStopsByGeolocationRouteTypesEnum["Four"] = "4";
})(StopsStopsByGeolocationRouteTypesEnum = exports.StopsStopsByGeolocationRouteTypesEnum || (exports.StopsStopsByGeolocationRouteTypesEnum = {}));
var StopsStopsByGeolocationRequest = /** @class */ (function (_super) {
    ...
    ], StopsStopsByGeolocationRequest.prototype, "devid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=latitude",
        }),
        __metadata("design:type", Number)
    ], StopsStopsByGeolocationRequest.prototype, "latitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=longitude",
        }),
        __metadata("design:type", Number)
    ], StopsStopsByGeolocationRequest.prototype, "longitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max_distance",
        }),
        __metadata("design:type", Number)
    ], StopsStopsByGeolocationRequest.prototype, "maxDistance", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max_results",
        }),
        __metadata("design:type", Number)
    ], StopsStopsByGeolocationRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=route_types",
        }),
        __metadata("design:type", Array)
    ], StopsStopsByGeolocationRequest.prototype, "routeTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=signature",
        }),
        __metadata("design:type", String)
    ], StopsStopsByGeolocationRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=stop_disruptions",
        }),
        __metadata("design:type", Boolean)
    ], StopsStopsByGeolocationRequest.prototype, "stopDisruptions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=token" }),
        __metadata("design:type", String)
    ], StopsStopsByGeolocationRequest.prototype, "token", void 0);
...
var StopsStopsByGeolocationResponse = /** @class */ (function (_super) {
    ...
    ], StopsStopsByGeolocationResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
