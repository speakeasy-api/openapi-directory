...
class UnassignPrivateNatGatewayAddressResultNatGatewayAddressesStatusEnum(str, Enum):
...
class UnassignPrivateNatGatewayAddressResultNatGatewayAddresses:
    ...
    status: Optional[UnassignPrivateNatGatewayAddressResultNatGatewayAddressesStatusEnum] = dataclasses.field(default=None)  
...
class UnassignPrivateNatGatewayAddressResult:
    ...
    nat_gateway_addresses: Optional[list[UnassignPrivateNatGatewayAddressResultNatGatewayAddresses]] = dataclasses.field(default=None)  
