 ...
 */
export declare class DescribeVerifiedAccessInstancesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVerifiedAccessInstancesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVerifiedAccessInstancesRequestFilters[];
    maxResults?: number;
    nextToken?: string;
