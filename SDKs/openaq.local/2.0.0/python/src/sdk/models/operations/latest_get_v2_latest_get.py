...
class LatestGetV2LatestGetOrderByLocationsOrderEnum(str, Enum):
    r"""An enumeration."""
    CITY = 'city'
    COUNTRY = 'country'
    LOCATION = 'location'
...
class LatestGetV2LatestGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class LatestGetV2LatestGetRequest:
    ...
    order_by: Optional[LatestGetV2LatestGetOrderByLocationsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""Order by a field"""  
    ...
    r"""Type of Sensor"""  
    sort: Optional[LatestGetV2LatestGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Sort Direction"""  
