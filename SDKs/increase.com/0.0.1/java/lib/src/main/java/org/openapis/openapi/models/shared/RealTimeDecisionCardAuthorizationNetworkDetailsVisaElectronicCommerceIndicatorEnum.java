 ...
 */
public enum RealTimeDecisionCardAuthorizationNetworkDetailsVisaElectronicCommerceIndicatorEnum {
    ...
    private RealTimeDecisionCardAuthorizationNetworkDetailsVisaElectronicCommerceIndicatorEnum(String value) {
        this.value = value;
    }
}
