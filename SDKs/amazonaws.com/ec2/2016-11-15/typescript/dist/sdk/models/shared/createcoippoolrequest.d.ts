 ...
 */
export declare enum CreateCoipPoolRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateCoipPoolRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateCoipPoolRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateCoipPoolRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateCoipPoolRequestTagSpecificationsTags[];
}
export declare class CreateCoipPoolRequest extends SpeakeasyBase {
    dryRun?: boolean;
