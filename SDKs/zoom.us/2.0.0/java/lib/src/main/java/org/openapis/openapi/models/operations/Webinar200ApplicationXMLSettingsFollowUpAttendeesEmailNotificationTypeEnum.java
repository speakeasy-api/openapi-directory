 ...
 */
public enum Webinar200ApplicationXMLSettingsFollowUpAttendeesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private Webinar200ApplicationXMLSettingsFollowUpAttendeesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
