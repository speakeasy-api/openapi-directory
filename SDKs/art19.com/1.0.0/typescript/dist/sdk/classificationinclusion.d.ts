...
export declare class ClassificationInclusion {
     ...
     *
     */
    getClassificationInclusions(req: operations.GetClassificationInclusionsRequest, security: operations.GetClassificationInclusionsSecurity, config?: AxiosRequestConfig): Promise<operations.GetClassificationInclusionsResponse>;
    /**
     * Get a specific classification inclusion
     */
    getClassificationInclusionsId(req: operations.GetClassificationInclusionsIdRequest, security: operations.GetClassificationInclusionsIdSecurity, config?: AxiosRequestConfig): Promise<operations.GetClassificationInclusionsIdResponse>;
}
