 ...
 */
export declare enum TargetHttpsProxiesScopedListWarningCodeEnum {
...
export declare class TargetHttpsProxiesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetHttpsProxiesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetHttpsProxiesScopedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetHttpsProxiesScopedListWarningData[];
    /**
     * [Output Only] A human-readable description of the warning code.
     */
    message?: string;
}
export declare class TargetHttpsProxiesScopedList extends SpeakeasyBase {
    /**
