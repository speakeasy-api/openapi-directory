...
from ..shared import listcustombiddingalgorithmsresponse as shared_listcustombiddingalgorithmsresponse
...
class DisplayvideoCustomBiddingAlgorithmsListRequest:
    ...
    r"""The ID of the DV360 advertiser that has access to the custom bidding algorithm."""  
    ...
    r"""A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListCustomBiddingAlgorithms` method. If not specified, the first page of results will be returned."""  
    partner_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'partnerId', 'style': 'form', 'explode': True }})
    r"""The ID of the DV360 partner that has access to the custom bidding algorithm."""  
...
class DisplayvideoCustomBiddingAlgorithmsListResponse:
    ...
    list_custom_bidding_algorithms_response: Optional[shared_listcustombiddingalgorithmsresponse.ListCustomBiddingAlgorithmsResponse] = dataclasses.field(default=None)
