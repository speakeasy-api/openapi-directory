...
class DescribeVpcEndpointConnectionNotificationsRequestFilters:
...
class DescribeVpcEndpointConnectionNotificationsRequest:
    ...
    filters: Optional[list[DescribeVpcEndpointConnectionNotificationsRequestFilters]] = dataclasses.field(default=None)  
