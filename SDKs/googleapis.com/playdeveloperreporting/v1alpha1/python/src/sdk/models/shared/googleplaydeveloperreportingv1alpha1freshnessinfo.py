...
class GooglePlayDeveloperReportingV1alpha1FreshnessInfo:
    ...
    freshnesses: Optional[list[shared_googleplaydeveloperreportingv1alpha1freshnessinfofreshness.GooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('freshnesses'), 'exclude': lambda f: f is None }})
