...
exports.IdentityPsks = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var IdentityPsks = /** @class */ (function () {
    function IdentityPsks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    IdentityPsks.prototype.createNetworkWirelessSsidIdentityPsk = function (req, config) {
        var _a;
    ...
    **/
    IdentityPsks.prototype.deleteNetworkWirelessSsidIdentityPsk = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    IdentityPsks.prototype.getNetworkWirelessSsidIdentityPsk = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    IdentityPsks.prototype.getNetworkWirelessSsidIdentityPsks = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    IdentityPsks.prototype.updateNetworkWirelessSsidIdentityPsk = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.IdentityPsks = IdentityPsks;
