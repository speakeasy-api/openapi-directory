...
class PostDescribeCustomAvailabilityZonesQueryParams:
    action: PostDescribeCustomAvailabilityZonesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeCustomAvailabilityZonesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeCustomAvailabilityZonesRequest:
    headers: PostDescribeCustomAvailabilityZonesHeaders = dataclasses.field()
    query_params: PostDescribeCustomAvailabilityZonesQueryParams = dataclasses.field()
