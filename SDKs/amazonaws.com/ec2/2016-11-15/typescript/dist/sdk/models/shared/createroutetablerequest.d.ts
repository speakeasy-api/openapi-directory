 ...
 */
export declare enum CreateRouteTableRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateRouteTableRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateRouteTableRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateRouteTableRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateRouteTableRequestTagSpecificationsTags[];
}
export declare class CreateRouteTableRequest extends SpeakeasyBase {
    dryRun?: boolean;
