...
func (e MybusinessCategoriesListViewEnum) ToPointer() *MybusinessCategoriesListViewEnum {
	return &e
}
...
func (e *MybusinessCategoriesListViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = MybusinessCategoriesListViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MybusinessCategoriesListViewEnum: %v", v)
	}
}
