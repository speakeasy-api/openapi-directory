...
exports.CompanyInfoOneResponse = exports.CompanyInfoOneRequest = exports.CompanyInfoOneSecurity = void 0;
...
exports.CompanyInfoOneSecurity = CompanyInfoOneSecurity;
var CompanyInfoOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CompanyInfoOneRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], CompanyInfoOneRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], CompanyInfoOneRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], CompanyInfoOneRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], CompanyInfoOneRequest.prototype, "xApideckServiceId", void 0);
    return CompanyInfoOneRequest;
}(utils_1.SpeakeasyBase));
exports.CompanyInfoOneRequest = CompanyInfoOneRequest;
var CompanyInfoOneResponse = /** @class */ (function (_super) {
    ...
    ], CompanyInfoOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CompanyInfoOneResponse = CompanyInfoOneResponse;
