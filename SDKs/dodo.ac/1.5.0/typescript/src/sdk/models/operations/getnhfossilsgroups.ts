...
export class GetNhFossilsGroupsRequest extends SpeakeasyBase {
  /**
...
export class GetNhFossilsGroupsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.NHFossilGroup })
