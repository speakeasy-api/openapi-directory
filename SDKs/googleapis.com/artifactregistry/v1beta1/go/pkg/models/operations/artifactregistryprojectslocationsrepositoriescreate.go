...
type ArtifactregistryProjectsLocationsRepositoriesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ArtifactregistryProjectsLocationsRepositoriesCreatePathParams struct {
	// Required. The name of the parent resource where the repository will be created.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ArtifactregistryProjectsLocationsRepositoriesCreateQueryParams struct {
	// V1 error format.
...
type ArtifactregistryProjectsLocationsRepositoriesCreateResponse struct {
	ContentType string
	// Successful response
