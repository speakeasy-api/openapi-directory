...
import { InterconnectLocation } from "./interconnectlocation";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum InterconnectLocationListWarningCodeEnum {
...
export declare class InterconnectLocationListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InterconnectLocationListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InterconnectLocationListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InterconnectLocationListWarningData[];
    /**
 ...
 */
export declare class InterconnectLocationList extends SpeakeasyBase {
    /**
