...
exports.InvoiceRecurringApiModel = exports.InvoiceRecurringApiModelStatusEnum = exports.InvoiceRecurringApiModelRecurrancePatternEnum = exports.InvoiceRecurringApiModelDayOfWeekEnum = void 0;
var utils_1 = require("../../../internal/utils");
var class_transformer_1 = require("class-transformer");
/**
 * Day when the recurrance should happen
 */
var InvoiceRecurringApiModelDayOfWeekEnum;
...
})(InvoiceRecurringApiModelDayOfWeekEnum = exports.InvoiceRecurringApiModelDayOfWeekEnum || (exports.InvoiceRecurringApiModelDayOfWeekEnum = {}));
/**
 * How often the recurrance occurs
 */
var InvoiceRecurringApiModelRecurrancePatternEnum;
...
})(InvoiceRecurringApiModelRecurrancePatternEnum = exports.InvoiceRecurringApiModelRecurrancePatternEnum || (exports.InvoiceRecurringApiModelRecurrancePatternEnum = {}));
/**
 * The status of the recurrance
 */
var InvoiceRecurringApiModelStatusEnum;
...
})(InvoiceRecurringApiModelStatusEnum = exports.InvoiceRecurringApiModelStatusEnum || (exports.InvoiceRecurringApiModelStatusEnum = {}));
/**
...
var InvoiceRecurringApiModel = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DueDateInDays" }),
        __metadata("design:type", Number)
    ], InvoiceRecurringApiModel.prototype, "dueDateInDays", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EndOfRecurrance" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RecurrancePattern" }),
        __metadata("design:type", String)
    ], InvoiceRecurringApiModel.prototype, "recurrancePattern", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RecurranceValue" }),
        __metadata("design:type", Number)
    ], InvoiceRecurringApiModel.prototype, "recurranceValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "StartOfRecurrance" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
...
exports.InvoiceRecurringApiModel = InvoiceRecurringApiModel;
