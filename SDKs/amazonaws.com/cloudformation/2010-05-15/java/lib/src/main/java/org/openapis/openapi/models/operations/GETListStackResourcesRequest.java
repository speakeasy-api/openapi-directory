...
public class GETListStackResourcesRequest {
    ...
    public GETListStackResourcesRequest(@JsonProperty("Action") GETListStackResourcesActionEnum action, @JsonProperty("StackName") String stackName, @JsonProperty("Version") GETListStackResourcesVersionEnum version) {
        this.action = action;
        this.stackName = stackName;
        this.version = version;
  }
