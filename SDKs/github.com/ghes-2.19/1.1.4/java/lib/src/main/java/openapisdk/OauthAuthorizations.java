...
public class OauthAuthorizations {
    ...
    **/
    public openapisdk.models.operations.OauthAuthorizationsCheckAuthorizationResponse oauthAuthorizationsCheckAuthorization(openapisdk.models.operations.OauthAuthorizationsCheckAuthorizationRequest request) throws Exception {
        ...
        openapisdk.models.operations.OauthAuthorizationsCheckAuthorizationResponse res = new openapisdk.models.operations.OauthAuthorizationsCheckAuthorizationResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.AuthorizationWithUser out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.AuthorizationWithUser.class);
    ...
    **/
    public openapisdk.models.operations.OauthAuthorizationsResetAuthorizationResponse oauthAuthorizationsResetAuthorization(openapisdk.models.operations.OauthAuthorizationsResetAuthorizationRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/applications/{client_id}/tokens/{access_token}", request.pathParams);
        ...
        openapisdk.models.operations.OauthAuthorizationsResetAuthorizationResponse res = new openapisdk.models.operations.OauthAuthorizationsResetAuthorizationResponse() {{
            authorizationWithUser = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse oauthAuthorizationsRevokeAuthorizationForApplication(openapisdk.models.operations.OauthAuthorizationsRevokeAuthorizationForApplicationRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/applications/{client_id}/tokens/{access_token}", request.pathParams);
        ...
        openapisdk.models.operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse res = new openapisdk.models.operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.OauthAuthorizationsRevokeGrantForApplicationResponse oauthAuthorizationsRevokeGrantForApplication(openapisdk.models.operations.OauthAuthorizationsRevokeGrantForApplicationRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.OauthAuthorizationsRevokeGrantForApplicationResponse res = new openapisdk.models.operations.OauthAuthorizationsRevokeGrantForApplicationResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
