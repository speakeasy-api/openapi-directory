 ...
 *
 */
export enum PutInvoiceItemTypeRevRecTriggerConditionEnum {
 ...
 *
 */
export enum PutInvoiceItemTypeTaxModeEnum {
 ...
 *
 */
export class PutInvoiceItemType extends SpeakeasyBase {
  /**
