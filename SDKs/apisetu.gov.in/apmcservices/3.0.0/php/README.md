...
use \OpenAPI\OpenAPI\Models\Operations\ApmclRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\ApmclRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\ApmclRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\ApmclSecurity;
...
try {
    ...
    $request->certificateParameters = new ApmclRequestBodyCertificateParameters();
    $request->certificateParameters->documentNumber = '123456789';
    ...
    $request->format = ApmclRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new ApmclSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->apmcl($request, $requestSecurity);
...
* [apmcl](docs/apis/README.md#apmcl) - Agriculture Produce Market Committee License
