...
class CalendarList:
    ...
    items: Optional[list[shared_calendarlistentry.CalendarListEntry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})
    r"""Calendars that are present on the user's calendar list."""  
    kind: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kind'), 'exclude': lambda f: f is None }})
    r"""Type of the collection (\\"calendar#calendarList\\")."""  
