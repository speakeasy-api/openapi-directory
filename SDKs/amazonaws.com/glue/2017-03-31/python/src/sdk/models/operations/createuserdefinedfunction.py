...
class CreateUserDefinedFunctionRequest:
    ...
    create_user_defined_function_request: shared_createuserdefinedfunctionrequest.CreateUserDefinedFunctionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
