 ...
 */
public enum CreatePublicIpv4PoolRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreatePublicIpv4PoolRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
