 ...
 */
public enum WebinarCreateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
