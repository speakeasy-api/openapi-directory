...
type DeleteDefaultMessageTypeHeaders struct {
...
type DeleteDefaultMessageTypeRequest struct {
	Headers DeleteDefaultMessageTypeHeaders
	Request shared.DeleteDefaultMessageTypeRequest `request:"mediaType=application/json"`
}
