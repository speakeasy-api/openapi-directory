...
var SscerRequestBodyCertificateParameters = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Cent" }),
        __metadata("design:type", String)
    ], SscerRequestBodyCertificateParameters.prototype, "cent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MName" }),
        __metadata("design:type", String)
    ], SscerRequestBodyCertificateParameters.prototype, "mName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], SscerRequestBodyCertificateParameters.prototype, "name", void 0);
    __decorate([
