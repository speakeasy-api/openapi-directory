...
class CreationInfo:
    ...
    owner_gid: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('OwnerGid') }})
    owner_uid: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('OwnerUid') }})
    permissions: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Permissions') }})
