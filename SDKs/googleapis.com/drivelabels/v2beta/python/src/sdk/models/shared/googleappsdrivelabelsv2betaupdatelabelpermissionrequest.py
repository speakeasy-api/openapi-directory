...
class GoogleAppsDriveLabelsV2betaUpdateLabelPermissionRequest:
    ...
    label_permission: Optional[shared_googleappsdrivelabelsv2betalabelpermission.GoogleAppsDriveLabelsV2betaLabelPermission] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('labelPermission'), 'exclude': lambda f: f is None }})
