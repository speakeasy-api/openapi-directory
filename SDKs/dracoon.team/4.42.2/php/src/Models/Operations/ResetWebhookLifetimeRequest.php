...
class ResetWebhookLifetimeRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ResetWebhookLifetimeXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?ResetWebhookLifetimeXSdsDateFormatEnum $xSdsDateFormat = null;
