 ...
 */
export declare enum BookingRequestPaymentTypeEnum {
    Api = "API"
}
export declare class BookingRequestRooms extends SpeakeasyBase {
    /**
 ...
 */
export declare class BookingRequest extends SpeakeasyBase {
    /**
