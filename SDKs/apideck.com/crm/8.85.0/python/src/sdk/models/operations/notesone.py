...
from ..shared import getnoteresponse as shared_getnoteresponse
...
class NotesOneRequest:
    headers: NotesOneHeaders = dataclasses.field()
    path_params: NotesOnePathParams = dataclasses.field()
    query_params: NotesOneQueryParams = dataclasses.field()
    security: NotesOneSecurity = dataclasses.field()
...
class NotesOneResponse:
    ...
    get_note_response: Optional[shared_getnoteresponse.GetNoteResponse] = dataclasses.field(default=None)
