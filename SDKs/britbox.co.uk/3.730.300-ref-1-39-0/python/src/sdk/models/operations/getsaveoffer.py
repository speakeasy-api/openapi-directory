...
from ..shared import itvgetdiscountresponse as shared_itvgetdiscountresponse
...
class GetSaveOfferResponse:
    ...
    itv_get_discount_response: Optional[shared_itvgetdiscountresponse.ItvGetDiscountResponse] = dataclasses.field(default=None)
