...
exports.ActivitiesDeleteResponse = exports.ActivitiesDeleteRequest = exports.ActivitiesDeleteSecurity = void 0;
...
exports.ActivitiesDeleteSecurity = ActivitiesDeleteSecurity;
var ActivitiesDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ActivitiesDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], ActivitiesDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ActivitiesDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], ActivitiesDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], ActivitiesDeleteRequest.prototype, "xApideckServiceId", void 0);
    return ActivitiesDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.ActivitiesDeleteRequest = ActivitiesDeleteRequest;
var ActivitiesDeleteResponse = /** @class */ (function (_super) {
    ...
    ], ActivitiesDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ActivitiesDeleteResponse = ActivitiesDeleteResponse;
