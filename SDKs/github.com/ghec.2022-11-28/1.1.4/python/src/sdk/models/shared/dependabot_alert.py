...
class DependabotAlertDependencyScopeEnum(str, Enum):
...
class DependabotAlertDependency:
    ...
    scope: Optional[DependabotAlertDependencyScopeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scope'), 'exclude': lambda f: f is None }})
    r"""The execution scope of the vulnerable dependency."""  
    
class DependabotAlertDismissedReasonEnum(str, Enum):
...
class DependabotAlertStateEnum(str, Enum):
...
class DependabotAlert:
    ...
    dependency: DependabotAlertDependency = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dependency') }})
    r"""Details for the vulnerable dependency."""  
    ...
    dismissed_reason: DependabotAlertDismissedReasonEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dismissed_reason') }})
    r"""The reason that the alert was dismissed."""  
    ...
    state: DependabotAlertStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""The state of the Dependabot alert."""  
