...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_ip_messaging_v2_service.IPMessagingV2Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
