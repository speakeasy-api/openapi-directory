...
var DescribeDeploymentJobResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: robotdeployment_1.RobotDeployment }),
        (0, class_transformer_1.Expose)({ name: "robotDeploymentSummary" }),
        (0, class_transformer_1.Type)(function () { return robotdeployment_1.RobotDeployment; }),
        __metadata("design:type", Array)
