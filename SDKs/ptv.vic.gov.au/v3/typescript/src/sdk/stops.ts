...
export class Stops {
  ...
  stopsStopDetails(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.StopsStopDetailsResponse =
        new operations.StopsStopDetailsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.v3StopResponse = utils.objectToClass(
              httpRes?.data,
              shared.V3StopResponse
            );
          }
  ...
  stopsStopsByGeolocation(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StopsStopsByGeolocationResponse =
        new operations.StopsStopsByGeolocationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.v3StopsByDistanceResponse = utils.objectToClass(
              httpRes?.data,
              shared.V3StopsByDistanceResponse
            );
          }
          if (utils.matchContentType(contentType, `text/json`)) {
            res.v3StopsByDistanceResponse = utils.objectToClass(
  ...
  stopsStopsForRoute(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StopsStopsForRouteResponse =
        new operations.StopsStopsForRouteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.v3StopsOnRouteResponse = utils.objectToClass(
              httpRes?.data,
              shared.V3StopsOnRouteResponse
            );
          }
          if (utils.matchContentType(contentType, `text/json`)) {
            res.v3StopsOnRouteResponse = utils.objectToClass(
