...
public class HarvestOrderPathParams {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=accountId")
    public Integer accountId;
    public HarvestOrderPathParams withAccountId(Integer accountId) {
    ...
    public HarvestOrderPathParams withBeezUPOrderId(String beezUPOrderId) {
    ...
    public HarvestOrderPathParams withMarketplaceTechnicalCode(String marketplaceTechnicalCode) {
