...
public class CloudidentityDevicesDeviceUsersBlockRequest {
    ...
    public openapisdk.models.shared.GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest request;
    public CloudidentityDevicesDeviceUsersBlockRequest withRequest(openapisdk.models.shared.GoogleAppsCloudidentityDevicesV1BlockDeviceUserRequest request) {
