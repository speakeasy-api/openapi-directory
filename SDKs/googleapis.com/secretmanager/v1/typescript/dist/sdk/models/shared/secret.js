...
exports.Secret = exports.SecretInput = void 0;
...
var SecretInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=replication" }),
        __metadata("design:type", replication_1.Replication)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=versionAliases" }),
        __metadata("design:type", Object)
