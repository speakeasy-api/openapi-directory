...
class AndroiddeviceprovisioningCustomersDevicesRemoveConfigurationRequest:
    ...
    r"""Required. The customer managing the device in the format `customers/[CUSTOMER_ID]`."""  
    ...
    r"""JSONP"""  
    customer_remove_configuration_request: Optional[shared_customerremoveconfigurationrequest.CustomerRemoveConfigurationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
