...
export const ListAppServerList = ["https://microvisor.twilio.com"] as const;
...
export class ListAppListAppResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.MicrovisorV1App })
  @Expose({ name: "apps" })
  @Type(() => shared.MicrovisorV1App)
  apps?: shared.MicrovisorV1App[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListAppListAppResponseMeta)
