...
public class FirebaseappcheckProjectsServicesBatchUpdateRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest request;
    public FirebaseappcheckProjectsServicesBatchUpdateRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest request) {
