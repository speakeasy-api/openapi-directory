...
class ListTokensRequest:
    ...
    token_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TokenIds'), 'exclude': lambda f: f is None }})  
