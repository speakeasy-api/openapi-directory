...
class NullableMilestoneStateEnum(str, Enum):
...
class NullableMilestone:
    ...
    state: NullableMilestoneStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""The state of the milestone."""  
