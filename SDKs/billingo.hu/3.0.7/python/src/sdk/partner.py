...
class Partner:
    ...
    def create_partner(self, request: operations.CreatePartnerRequest) -> operations.CreatePartnerResponse:
        r"""Create a partner
        ...
        res = operations.CreatePartnerResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_partner(self, request: operations.DeletePartnerRequest) -> operations.DeletePartnerResponse:
        ...
        url = utils.generate_url(base_url, "/partners/{id}", request.path_params)
        ...
        res = operations.DeletePartnerResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_partner(self, request: operations.GetPartnerRequest) -> operations.GetPartnerResponse:
        ...
        res = operations.GetPartnerResponse(status_code=r.status_code, content_type=content_type)
    ...
    def list_partner(self, request: operations.ListPartnerRequest) -> operations.ListPartnerResponse:
        ...
        res = operations.ListPartnerResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PartnerList])
    ...
    def update_partner(self, request: operations.UpdatePartnerRequest) -> operations.UpdatePartnerResponse:
        ...
        res = operations.UpdatePartnerResponse(status_code=r.status_code, content_type=content_type)
