...
class GETPaidInvoicesType:
    
    applied_payment_amount: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('appliedPaymentAmount'), 'exclude': lambda f: f is None }})
    r"""Amount of the payment applied to this invoice."""  
