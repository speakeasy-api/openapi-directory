...
export class HMACSignatures {
  ...
  postHMACSignatures(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.POSTHMACSignaturesResponse =
        new operations.POSTHMACSignaturesResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.posthmacSignatureResponseType = utils.objectToClass(
              httpRes?.data,
              shared.POSTHMACSignatureResponseType
            );
          }
          break;
      }
