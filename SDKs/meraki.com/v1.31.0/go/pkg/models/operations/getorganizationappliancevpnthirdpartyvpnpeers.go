...
func (e *GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIkeVersionEnum) UnmarshalJSON(data []byte) error {
	...
	case "1":
		fallthrough
	case "2":
		*e = GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIkeVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIkeVersionEnum: %s", s)
	}
}
...
func (e *GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildAuthAlgoEnum) UnmarshalJSON(data []byte) error {
	...
	case "sha1":
		fallthrough
	case "sha256":
		*e = GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildAuthAlgoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildAuthAlgoEnum: %s", s)
	}
}
...
func (e *GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildCipherAlgoEnum) UnmarshalJSON(data []byte) error {
	...
	case "null":
		fallthrough
	case "tripledes":
		*e = GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildCipherAlgoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesChildCipherAlgoEnum: %s", s)
	}
}
...
func (e *GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeAuthAlgoEnum) UnmarshalJSON(data []byte) error {
	...
	case "sha1":
		fallthrough
	case "sha256":
		*e = GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeAuthAlgoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeAuthAlgoEnum: %s", s)
	}
}
...
func (e *GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeCipherAlgoEnum) UnmarshalJSON(data []byte) error {
	...
	case "des":
		fallthrough
	case "tripledes":
		*e = GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeCipherAlgoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkeCipherAlgoEnum: %s", s)
	}
}
...
func (e *GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkePrfAlgoEnum) UnmarshalJSON(data []byte) error {
	...
	case "prfsha1":
		fallthrough
	case "prfsha256":
		*e = GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkePrfAlgoEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceVPNThirdPartyVPNPeers200ApplicationJSONPeersIpsecPoliciesIkePrfAlgoEnum: %s", s)
	}
}
