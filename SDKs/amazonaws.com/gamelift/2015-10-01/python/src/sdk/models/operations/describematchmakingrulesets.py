...
class DescribeMatchmakingRuleSetsRequest:
    ...
    describe_matchmaking_rule_sets_input: shared_describematchmakingrulesetsinput.DescribeMatchmakingRuleSetsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
