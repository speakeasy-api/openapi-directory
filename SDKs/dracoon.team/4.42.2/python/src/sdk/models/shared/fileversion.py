...
class FileVersion:
    ...
    r"""Name"""  
    reference_id: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('referenceId') }})
    r"""Reference ID. Identical across all versions of a file"""  
