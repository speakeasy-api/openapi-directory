...
var Documents = /** @class */ (function () {
     ...
     * Deletes a document.
    **/
    Documents.prototype.deleteDocumentsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteDocumentsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/documents/{id}", req.pathParams);
    ...
    **/
    Documents.prototype.getDocumentsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Documents.prototype.patchDocumentsId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Documents.prototype.postDocuments = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
