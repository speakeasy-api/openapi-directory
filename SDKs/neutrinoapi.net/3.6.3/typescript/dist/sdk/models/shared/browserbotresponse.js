...
var BrowserBotResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "error-message" }),
        __metadata("design:type", String)
    ], BrowserBotResponse.prototype, "errorMessage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "exec-results" }),
        __metadata("design:type", Array)
    ], BrowserBotResponse.prototype, "execResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "http-redirect-url" }),
        __metadata("design:type", String)
    ], BrowserBotResponse.prototype, "httpRedirectUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "http-status-code" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is-http-ok" }),
        __metadata("design:type", Boolean)
    ], BrowserBotResponse.prototype, "isHttpOk", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is-http-redirect" }),
        __metadata("design:type", Boolean)
    ], BrowserBotResponse.prototype, "isHttpRedirect", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is-secure" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "response-headers" }),
        __metadata("design:type", Object)
    ], BrowserBotResponse.prototype, "responseHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "security-details" }),
        __metadata("design:type", Object)
