...
var Tba = /** @class */ (function () {
    function Tba(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Tba.prototype.getStatus = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.apiStatus = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
