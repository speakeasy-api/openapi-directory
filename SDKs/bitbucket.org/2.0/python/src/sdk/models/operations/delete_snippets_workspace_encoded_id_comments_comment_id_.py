...
class DeleteSnippetsWorkspaceEncodedIDCommentsCommentIDRequest:
    path_params: DeleteSnippetsWorkspaceEncodedIDCommentsCommentIDPathParams = dataclasses.field()
    security: DeleteSnippetsWorkspaceEncodedIDCommentsCommentIDSecurity = dataclasses.field()
