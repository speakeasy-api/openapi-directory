...
class CreateDeploymentGroupRequest:
    headers: CreateDeploymentGroupHeaders = dataclasses.field()
    request: shared_createdeploymentgroupinput.CreateDeploymentGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
