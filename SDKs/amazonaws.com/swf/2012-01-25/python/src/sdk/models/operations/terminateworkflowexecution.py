...
class TerminateWorkflowExecutionRequest:
    ...
    terminate_workflow_execution_input: shared_terminateworkflowexecutioninput.TerminateWorkflowExecutionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
