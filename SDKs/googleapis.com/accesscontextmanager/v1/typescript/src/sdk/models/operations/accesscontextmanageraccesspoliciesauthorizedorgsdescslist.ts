...
export class AccesscontextmanagerAccessPoliciesAuthorizedOrgsDescsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AccesscontextmanagerAccessPoliciesAuthorizedOrgsDescsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AccesscontextmanagerAccessPoliciesAuthorizedOrgsDescsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
