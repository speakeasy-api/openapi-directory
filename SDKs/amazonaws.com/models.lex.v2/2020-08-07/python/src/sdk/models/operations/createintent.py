...
class CreateIntentRequestBodyDialogCodeHook:
    r"""CreateIntentRequestBodyDialogCodeHook
...
class CreateIntentRequestBodyFulfillmentCodeHook:
    r"""CreateIntentRequestBodyFulfillmentCodeHook
...
class CreateIntentRequestBodyIntentClosingSetting:
    r"""CreateIntentRequestBodyIntentClosingSetting
...
class CreateIntentRequestBodyIntentConfirmationSetting:
    r"""CreateIntentRequestBodyIntentConfirmationSetting
...
class CreateIntentRequestBodyKendraConfiguration:
    r"""CreateIntentRequestBodyKendraConfiguration
...
class CreateIntentRequestBody:
    ...
    dialog_code_hook: Optional[CreateIntentRequestBodyDialogCodeHook] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dialogCodeHook') }})
    fulfillment_code_hook: Optional[CreateIntentRequestBodyFulfillmentCodeHook] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fulfillmentCodeHook') }})
    ...
    intent_closing_setting: Optional[CreateIntentRequestBodyIntentClosingSetting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intentClosingSetting') }})
    intent_confirmation_setting: Optional[CreateIntentRequestBodyIntentConfirmationSetting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intentConfirmationSetting') }})
    kendra_configuration: Optional[CreateIntentRequestBodyKendraConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kendraConfiguration') }})
...
class CreateIntentRequest:
    headers: CreateIntentHeaders = dataclasses.field()
    path_params: CreateIntentPathParams = dataclasses.field()
    request: CreateIntentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
