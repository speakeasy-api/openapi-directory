...
public class GetNhFishFishHeaders {
    /**
    ...
    public GetNhFishFishHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFishFishHeaders withXApiKey(String xApiKey) {
