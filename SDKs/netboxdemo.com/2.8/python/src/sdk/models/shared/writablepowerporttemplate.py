...
class WritablePowerPortTemplateInput:
    ...
    type: Optional[WritablePowerPortTemplateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
