...
public class GETAssignPrivateIpAddressesQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETAssignPrivateIpAddressesActionEnum action;
    public GETAssignPrivateIpAddressesQueryParams withAction(GETAssignPrivateIpAddressesActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETAssignPrivateIpAddressesQueryParams withAllowReassignment(Boolean allowReassignment) {
    ...
    public GETAssignPrivateIpAddressesQueryParams withIpv4Prefix(String[] ipv4Prefix) {
    ...
    public GETAssignPrivateIpAddressesQueryParams withIpv4PrefixCount(Long ipv4PrefixCount) {
    ...
    public GETAssignPrivateIpAddressesQueryParams withNetworkInterfaceId(String networkInterfaceId) {
    ...
    public GETAssignPrivateIpAddressesQueryParams withPrivateIpAddress(String[] privateIpAddress) {
    ...
    public GETAssignPrivateIpAddressesQueryParams withSecondaryPrivateIpAddressCount(Long secondaryPrivateIpAddressCount) {
    ...
    public GETAssignPrivateIpAddressesQueryParams withVersion(GETAssignPrivateIpAddressesVersionEnum version) {
