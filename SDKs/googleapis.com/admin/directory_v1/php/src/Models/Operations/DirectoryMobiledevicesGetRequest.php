...
class DirectoryMobiledevicesGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryMobiledevicesGetProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?DirectoryMobiledevicesGetProjectionEnum $projection = null;
