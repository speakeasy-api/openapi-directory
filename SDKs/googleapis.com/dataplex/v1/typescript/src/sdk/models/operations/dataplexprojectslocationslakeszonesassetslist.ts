...
export class DataplexProjectsLocationsLakesZonesAssetsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesZonesAssetsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesZonesAssetsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
