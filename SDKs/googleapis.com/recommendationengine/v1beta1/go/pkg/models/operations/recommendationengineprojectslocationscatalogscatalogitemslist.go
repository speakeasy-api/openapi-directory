...
type RecommendationengineProjectsLocationsCatalogsCatalogItemsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RecommendationengineProjectsLocationsCatalogsCatalogItemsListPathParams struct {
	// Required. The parent catalog resource name, such as `projects/*/locations/global/catalogs/default_catalog`.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type RecommendationengineProjectsLocationsCatalogsCatalogItemsListQueryParams struct {
	// V1 error format.
...
type RecommendationengineProjectsLocationsCatalogsCatalogItemsListRequest struct {
...
type RecommendationengineProjectsLocationsCatalogsCatalogItemsListResponse struct {
	ContentType string
	// Successful response
