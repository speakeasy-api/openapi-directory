...
public class EmployeeSchedules {
    ...
    **/
    public openapisdk.models.operations.EmployeeSchedulesAllResponse employeeSchedulesAll(openapisdk.models.operations.EmployeeSchedulesAllRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hris/schedules/employees/{employee_id}", request.pathParams);
        ...
        openapisdk.models.operations.EmployeeSchedulesAllResponse res = new openapisdk.models.operations.EmployeeSchedulesAllResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetEmployeeSchedulesResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetEmployeeSchedulesResponse.class);
