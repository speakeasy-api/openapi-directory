...
export class RunNamespacesExecutionsCancelSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesExecutionsCancelRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesExecutionsCancelResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
