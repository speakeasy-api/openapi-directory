...
export class ChromemanagementCustomersTelemetryDevicesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ChromemanagementCustomersTelemetryDevicesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ChromemanagementCustomersTelemetryDevicesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
