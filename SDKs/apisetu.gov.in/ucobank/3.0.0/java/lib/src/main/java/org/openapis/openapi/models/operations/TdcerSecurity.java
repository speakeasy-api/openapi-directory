...
public class TdcerSecurity {
    ...
    public TdcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public TdcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public TdcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
