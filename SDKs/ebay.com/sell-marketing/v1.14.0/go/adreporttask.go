...
func (s *adReportTask) CreateReportTask(ctx context.Context, request shared.CreateReportTask, security operations.CreateReportTaskSecurity) (*operations.CreateReportTaskResponse, error) {
	baseURL := s.serverURL
...
func (s *adReportTask) DeleteReportTask(ctx context.Context, request operations.DeleteReportTaskRequest, security operations.DeleteReportTaskSecurity) (*operations.DeleteReportTaskResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_report_task/{report_task_id}", request, nil)
...
func (s *adReportTask) GetReportTask(ctx context.Context, request operations.GetReportTaskRequest, security operations.GetReportTaskSecurity) (*operations.GetReportTaskResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/ad_report_task/{report_task_id}", request, nil)
...
func (s *adReportTask) GetReportTasks(ctx context.Context, request operations.GetReportTasksRequest, security operations.GetReportTasksSecurity) (*operations.GetReportTasksResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/ad_report_task"
