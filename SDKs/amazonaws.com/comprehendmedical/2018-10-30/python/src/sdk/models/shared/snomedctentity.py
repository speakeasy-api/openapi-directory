...
import dataclasses
from ..shared import snomedctattribute as shared_snomedctattribute
...
from ..shared import snomedctentitytype_enum as shared_snomedctentitytype_enum
...
class SNOMEDCTEntity:
    ...
    attributes: Optional[list[shared_snomedctattribute.SNOMEDCTAttribute]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Attributes'), 'exclude': lambda f: f is None }})  
    ...
    type: Optional[shared_snomedctentitytype_enum.SNOMEDCTEntityTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Type'), 'exclude': lambda f: f is None }})  
