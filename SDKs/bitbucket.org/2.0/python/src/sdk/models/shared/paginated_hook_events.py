...
class PaginatedHookEvents:
    ...
    values: Optional[list[shared_hook_event.HookEvent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('values'), 'exclude': lambda f: f is None }})  
