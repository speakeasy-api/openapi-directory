...
class Actions:
    ...
    def actions_get_github_actions_default_workflow_permissions_enterprise(self, request: operations.ActionsGetGithubActionsDefaultWorkflowPermissionsEnterpriseRequest) -> operations.ActionsGetGithubActionsDefaultWorkflowPermissionsEnterpriseResponse:
        r"""Get default workflow permissions for an enterprise
        ...
        url = utils.generate_url(operations.ActionsGetGithubActionsDefaultWorkflowPermissionsEnterpriseRequest, base_url, '/enterprises/{enterprise}/actions/permissions/workflow', request)
        ...
        res = operations.ActionsGetGithubActionsDefaultWorkflowPermissionsEnterpriseResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def actions_set_github_actions_default_workflow_permissions_enterprise(self, request: operations.ActionsSetGithubActionsDefaultWorkflowPermissionsEnterpriseRequest) -> operations.ActionsSetGithubActionsDefaultWorkflowPermissionsEnterpriseResponse:
        r"""Set default workflow permissions for an enterprise
        ...
        url = utils.generate_url(operations.ActionsSetGithubActionsDefaultWorkflowPermissionsEnterpriseRequest, base_url, '/enterprises/{enterprise}/actions/permissions/workflow', request)
        ...
        res = operations.ActionsSetGithubActionsDefaultWorkflowPermissionsEnterpriseResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
