...
type DetectImageURLRawPathParams struct {
	// The project id.
...
type DetectImageURLRawQueryParams struct {
	// Optional. Specifies the name of application using the endpoint.
	Application *string `queryParam:"style=form,explode=true,name=application"`
}

type DetectImageURLRawRequest struct {
	PathParams  DetectImageURLRawPathParams
	QueryParams DetectImageURLRawQueryParams
	// An ImageUrl that contains the url of the image to be evaluated.
	Request []byte `request:"mediaType=text/xml"`
}

type DetectImageURLRawResponse struct {
	Body        []byte
	ContentType string
	// Error response
