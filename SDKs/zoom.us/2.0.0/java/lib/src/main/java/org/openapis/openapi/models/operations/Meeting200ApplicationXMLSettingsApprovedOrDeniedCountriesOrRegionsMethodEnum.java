 ...
 */
public enum Meeting200ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum {
    APPROVE("approve"),
    DENY("deny");
    ...
    private Meeting200ApplicationXMLSettingsApprovedOrDeniedCountriesOrRegionsMethodEnum(String value) {
        this.value = value;
    }
}
