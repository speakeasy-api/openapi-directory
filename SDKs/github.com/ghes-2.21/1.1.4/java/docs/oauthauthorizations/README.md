...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteAuthorizationRequest req = new OauthAuthorizationsDeleteAuthorizationRequest(115484L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteGrantRequest req = new OauthAuthorizationsDeleteGrantRequest(981640L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetAuthorizationRequest req = new OauthAuthorizationsGetAuthorizationRequest(618480L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetGrantRequest req = new OauthAuthorizationsGetGrantRequest(244651L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppRequestBody("voluptatibus") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequestBody("consequuntur") {{
                                note = "Update all gems";
                                noteUrl = "repellendus";
                                scopes = new String[]{{
                                    add("maxime"),
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsUpdateAuthorizationRequest req = new OauthAuthorizationsUpdateAuthorizationRequest(241418L) {{
