...
class StoredValueLoadRequestLoadTypeEnum(str, Enum):
    r"""The type of load you are trying to do, when absent we default to 'Load'"""
    MERCHANDISE_RETURN = 'merchandiseReturn'
    LOAD = 'load'

class StoredValueLoadRequestShopperInteractionEnum(str, Enum):
...
class StoredValueLoadRequest:
    ...
    """  
    load_type: Optional[StoredValueLoadRequestLoadTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('loadType'), 'exclude': lambda f: f is None }})
    r"""The type of load you are trying to do, when absent we default to 'Load'"""  
    ...
    shopper_interaction: Optional[StoredValueLoadRequestShopperInteractionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shopperInteraction'), 'exclude': lambda f: f is None }})
    r"""Specifies the sales channel, through which the shopper gives their card details, and whether the shopper is a returning customer.
    For the web service API, Adyen assumes Ecommerce shopper interaction by default.
