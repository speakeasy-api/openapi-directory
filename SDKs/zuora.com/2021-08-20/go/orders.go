...
func (s *Orders) DeleteOrder(ctx context.Context, request operations.DeleteOrderRequest) (*operations.DeleteOrderResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/{orderNumber}", request.PathParams)
...
func (s *Orders) GetAllOrders(ctx context.Context, request operations.GetAllOrdersRequest) (*operations.GetAllOrdersResponse, error) {
	baseURL := s._serverURL
	...
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *shared.GetAllOrdersResponseType
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Orders) GetJobStatusAndResponse(ctx context.Context, request operations.GetJobStatusAndResponseRequest) (*operations.GetJobStatusAndResponseResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/async-jobs/{jobId}", request.PathParams)
	...
	res := &operations.GetJobStatusAndResponseResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *operations.GetJobStatusAndResponse200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Orders) GetOrderMetricsforEvergreenSubscription(ctx context.Context, request operations.GetOrderMetricsforEvergreenSubscriptionRequest) (*operations.GetOrderMetricsforEvergreenSubscriptionResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/{orderNumber}/evergreenMetrics/{subscriptionNumber}", request.PathParams)
	...
	res := &operations.GetOrderMetricsforEvergreenSubscriptionResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *shared.GetOrderResponseForEvergreen
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Orders) GetOrdersByInvoiceOwner(ctx context.Context, request operations.GetOrdersByInvoiceOwnerRequest) (*operations.GetOrdersByInvoiceOwnerResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/invoiceOwner/{accountNumber}", request.PathParams)
	...
	res := &operations.GetOrdersByInvoiceOwnerResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Orders) GetOrdersBySubscriptionNumber(ctx context.Context, request operations.GetOrdersBySubscriptionNumberRequest) (*operations.GetOrdersBySubscriptionNumberResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/subscription/{subscriptionNumber}", request.PathParams)
	...
	res := &operations.GetOrdersBySubscriptionNumberResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Orders) GetOrdersBySubscriptionOwner(ctx context.Context, request operations.GetOrdersBySubscriptionOwnerRequest) (*operations.GetOrdersBySubscriptionOwnerResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/subscriptionOwner/{accountNumber}", request.PathParams)
	...
	res := &operations.GetOrdersBySubscriptionOwnerResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Orders) GetSubscriptionTermInfo(ctx context.Context, request operations.GetSubscriptionTermInfoRequest) (*operations.GetSubscriptionTermInfoResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/term/{subscriptionNumber}", request.PathParams)
	...
	res := &operations.GetSubscriptionTermInfoResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *shared.GetSubscriptionTermInfoResponseType
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Orders) PostCreateOrderAsynchronously(ctx context.Context, request operations.PostCreateOrderAsynchronouslyRequest) (*operations.PostCreateOrderAsynchronouslyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostCreateOrderAsynchronouslyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 202:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *operations.PostCreateOrderAsynchronously202ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Orders) PostOrder(ctx context.Context, request operations.PostOrderRequest) (*operations.PostOrderResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/orders"
	...
	res := &operations.PostOrderResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *shared.PostOrderResponseType
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
//
// If you have a need for a large order that exceeds any limits of the above, you can request a limit increase for the Orders asynchronous API by submitting a request at [Zuora Global Support](https://support.zuora.com).
func (s *Orders) PostPreviewOrder(ctx context.Context, request operations.PostPreviewOrderRequest) (*operations.PostPreviewOrderResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostPreviewOrderResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *shared.PostOrderPreviewResponseType
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
//
// If you have a need for a large order that exceeds any limits of the above, you can request a limit increase for the Orders asynchronous API by submitting a request at [Zuora Global Support](https://support.zuora.com).
func (s *Orders) PostPreviewOrderAsynchronously(ctx context.Context, request operations.PostPreviewOrderAsynchronouslyRequest) (*operations.PostPreviewOrderAsynchronouslyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostPreviewOrderAsynchronouslyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 202:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *operations.PostPreviewOrderAsynchronously202ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Orders) PutOrderTriggerDates(ctx context.Context, request operations.PutOrderTriggerDatesRequest) (*operations.PutOrderTriggerDatesResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/{orderNumber}/triggerDates", request.PathParams)
	...
	res := &operations.PutOrderTriggerDatesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json; charset=utf-8`):
			var out *shared.PutOrderTriggerDatesResponseType
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Orders) PutUpdateOrderCustomFields(ctx context.Context, request operations.PutUpdateOrderCustomFieldsRequest) (*operations.PutUpdateOrderCustomFieldsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/orders/{orderNumber}/customFields", request.PathParams)
	...
	res := &operations.PutUpdateOrderCustomFieldsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Orders) PutUpdateSubscriptionCustomFields(ctx context.Context, request operations.PutUpdateSubscriptionCustomFieldsRequest) (*operations.PutUpdateSubscriptionCustomFieldsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/subscriptions/{subscriptionNumber}/customFields", request.PathParams)
	...
	res := &operations.PutUpdateSubscriptionCustomFieldsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
