...
from ..shared import getreadsetimportjobresponse as shared_getreadsetimportjobresponse
...
class GetReadSetImportJobResponse:
    ...
    get_read_set_import_job_response: Optional[shared_getreadsetimportjobresponse.GetReadSetImportJobResponse] = dataclasses.field(default=None)
    r"""Success"""  
