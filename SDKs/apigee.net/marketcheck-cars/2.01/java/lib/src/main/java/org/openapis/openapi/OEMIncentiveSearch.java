...
public class OEMIncentiveSearch {
    ...
    public org.openapis.openapi.models.operations.OemSearchResponse oemSearch(org.openapis.openapi.models.operations.OemSearchRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.OemSearchRequest.class, request, null);
        if (queryParams != null) {
