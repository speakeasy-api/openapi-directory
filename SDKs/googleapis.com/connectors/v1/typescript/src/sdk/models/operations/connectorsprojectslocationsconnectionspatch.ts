...
export class ConnectorsProjectsLocationsConnectionsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsConnectionsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsConnectionsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
