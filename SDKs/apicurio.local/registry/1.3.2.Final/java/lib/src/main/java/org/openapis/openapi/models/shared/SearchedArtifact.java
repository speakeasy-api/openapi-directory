...
public class SearchedArtifact {
    ...
    public SearchedArtifact(@JsonProperty("createdBy") String createdBy, @JsonProperty("createdOn") OffsetDateTime createdOn, @JsonProperty("id") String id, @JsonProperty("state") ArtifactStateEnum state, @JsonProperty("type") ArtifactTypeEnum type) {
        this.createdBy = createdBy;
        this.createdOn = createdOn;
        this.id = id;
        this.state = state;
