...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("possimus") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("sapiente") {{
                order = OrderEnum.ASC;
                page = 65121L;
                perPage = 552646L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("non") {{
                order = OrderEnum.ASC;
                page = 324052L;
                perPage = 305047L;
                sort = SearchIssuesAndPullRequestsSortEnum.INTERACTIONS;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("quas", 162450L) {{
                order = OrderEnum.ASC;
                page = 81581L;
                perPage = 400448L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("est") {{
                order = OrderEnum.DESC;
                page = 400879L;
                perPage = 232316L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("rem") {{
                page = 527715L;
                perPage = 498534L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("adipisci") {{
                order = OrderEnum.ASC;
                page = 271306L;
                perPage = 503449L;
