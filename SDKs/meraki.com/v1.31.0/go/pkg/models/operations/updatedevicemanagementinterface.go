...
func (e *UpdateDeviceManagementInterfaceRequestBodyWan1WanEnabledEnum) UnmarshalJSON(data []byte) error {
	...
	case "enabled":
		fallthrough
	case "not configured":
		*e = UpdateDeviceManagementInterfaceRequestBodyWan1WanEnabledEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceManagementInterfaceRequestBodyWan1WanEnabledEnum: %s", s)
	}
}
...
func (e *UpdateDeviceManagementInterfaceRequestBodyWan2WanEnabledEnum) UnmarshalJSON(data []byte) error {
	...
	case "enabled":
		fallthrough
	case "not configured":
		*e = UpdateDeviceManagementInterfaceRequestBodyWan2WanEnabledEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceManagementInterfaceRequestBodyWan2WanEnabledEnum: %s", s)
	}
}
