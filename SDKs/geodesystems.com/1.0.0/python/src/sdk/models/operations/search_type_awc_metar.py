...
class SearchTypeAwcMetarQueryParams:
    ...
    search_type_awc_metar_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_awc_metar.site_id', 'style': 'form', 'explode': True }})
...
class SearchTypeAwcMetarRequest:
    query_params: SearchTypeAwcMetarQueryParams = dataclasses.field()
