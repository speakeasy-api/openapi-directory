...
public class GetUsersIdsTagsRequest {
    ...
    public GetUsersIdsTagsRequest withCallback(String callback) {
    ...
    public GetUsersIdsTagsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsTagsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withOrder(GetUsersIdsTagsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsTagsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withSort(GetUsersIdsTagsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUsersIdsTagsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetUsersIdsTagsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
