 ...
 */
export declare class DescribeSubnetsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeSubnetsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeSubnetsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
    subnetIds?: string[];
}
