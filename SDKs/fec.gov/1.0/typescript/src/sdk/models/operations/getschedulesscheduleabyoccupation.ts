...
export class GetSchedulesScheduleAByOccupationRequest extends SpeakeasyBase {
  /**
   *
   * @remarks
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=occupation",
  })
  occupation?: string[];
...
export class GetSchedulesScheduleAByOccupationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
