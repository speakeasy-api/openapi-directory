...
class StartMonitoringMemberHeaders:
...
class StartMonitoringMemberRequest:
    headers: StartMonitoringMemberHeaders = dataclasses.field()
    request: StartMonitoringMemberRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
