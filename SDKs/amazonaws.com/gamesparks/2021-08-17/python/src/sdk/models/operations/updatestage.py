...
from ..shared import updatestageresult as shared_updatestageresult
...
class UpdateStageRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the role to use for the game snapshots deployed to this stage."""  
...
class UpdateStageResponse:
    ...
    update_stage_result: Optional[shared_updatestageresult.UpdateStageResult] = dataclasses.field(default=None)
    r"""Success"""  
