 ...
 */
export enum PUTSpecificDateAllocationTypeDistributionTypeEnum {
 ...
 *
 */
export enum PUTSpecificDateAllocationTypeEventTypeEnum {
 ...
 *
 */
export class PUTSpecificDateAllocationType extends SpeakeasyBase {
  /**
