...
exports.GetTagFromPayLineResponse = exports.GetTagFromPayLineRequest = void 0;
...
var GetTagFromPayLineRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromPayLineRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayLineRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayLineRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayLineRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayLineId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayLineRequest.prototype, "payLineId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromPayLineRequest.prototype, "tagId", void 0);
...
var GetTagFromPayLineResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromPayLineResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
