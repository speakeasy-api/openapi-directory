...
export class DataplexProjectsLocationsDataTaxonomiesAttributesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataTaxonomiesAttributesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=dataAttributeId",
  })
...
export class DataplexProjectsLocationsDataTaxonomiesAttributesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
