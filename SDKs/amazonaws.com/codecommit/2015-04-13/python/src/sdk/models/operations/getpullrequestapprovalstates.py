...
class GetPullRequestApprovalStatesRequest:
    ...
    get_pull_request_approval_states_input: shared_getpullrequestapprovalstatesinput.GetPullRequestApprovalStatesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
