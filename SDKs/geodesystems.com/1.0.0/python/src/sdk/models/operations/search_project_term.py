...
class SearchProjectTermQueryParams:
    ...
    search_project_term_value: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_term.value', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchProjectTermRequest:
    query_params: SearchProjectTermQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectTermResponse:
