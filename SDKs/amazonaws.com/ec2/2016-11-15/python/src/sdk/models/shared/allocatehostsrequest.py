...
class AllocateHostsRequestAutoPlacementEnum(str, Enum):
...
class AllocateHostsRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class AllocateHostsRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class AllocateHostsRequestTagSpecifications:
    ...
    resource_type: Optional[AllocateHostsRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[AllocateHostsRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class AllocateHostsRequest:
    ...
    auto_placement: Optional[AllocateHostsRequestAutoPlacementEnum] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[AllocateHostsRequestTagSpecifications]] = dataclasses.field(default=None)  
