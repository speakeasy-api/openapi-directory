...
type MlProjectsPredictSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type MlProjectsPredictPathParams struct {
...
type MlProjectsPredictQueryParams struct {
	// V1 error format.
...
type MlProjectsPredictRequest struct {
	PathParams  MlProjectsPredictPathParams
	QueryParams MlProjectsPredictQueryParams
	Request     *shared.GoogleCloudMlV1PredictRequest `request:"mediaType=application/json"`
	Security    MlProjectsPredictSecurity
}

type MlProjectsPredictResponse struct {
	ContentType string
	// Successful response
