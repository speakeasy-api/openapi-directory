...
class SearchTypeBizStockseriesQueryParams:
...
@dataclasses.dataclass
class SearchTypeBizStockseriesRequest:
    query_params: SearchTypeBizStockseriesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeBizStockseriesResponse:
