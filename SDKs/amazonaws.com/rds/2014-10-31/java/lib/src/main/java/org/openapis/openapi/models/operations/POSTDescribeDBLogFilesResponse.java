...
public class POSTDescribeDBLogFilesResponse {
    ...
    public POSTDescribeDBLogFilesResponse withStatusCode(Integer statusCode) {
    ...
    public POSTDescribeDBLogFilesResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
