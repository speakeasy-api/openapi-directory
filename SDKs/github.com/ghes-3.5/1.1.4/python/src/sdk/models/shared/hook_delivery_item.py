...
class HookDeliveryItem:
    r"""Delivery made by a webhook, without request and response information."""
    ...
    r"""Time when the webhook delivery occurred."""  
    ...
    r"""Unique identifier of the webhook delivery."""  
    ...
    r"""Whether the webhook delivery is a redelivery."""  
    ...
    r"""Describes the response returned after attempting the delivery."""  
