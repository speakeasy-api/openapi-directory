 ...
 */
export enum RegistrationsChildrenListRegistrationAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class RegistrationsChildrenListRegistrationAttributes extends SpeakeasyBase {
  /**
   * The category of the registered node.
   */
  @SpeakeasyMetadata()
 ...
 */
export class RegistrationsChildrenListRegistrationLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsChildrenListRegistrationRelationships extends SpeakeasyBase {
  /**
...
export class RegistrationsChildrenListRegistration extends SpeakeasyBase {
  /**
   * The properties of the registration entity.
   */
  @SpeakeasyMetadata()
