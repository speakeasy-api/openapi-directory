...
class InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDecline
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineCurrencyEnum $currency
     */
	#[\JMS\Serializer\Annotation\SerializedName('currency')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineCurrencyEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkEnum $network
     */
	#[\JMS\Serializer\Annotation\SerializedName('network')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetails $networkDetails
     */
	#[\JMS\Serializer\Annotation\SerializedName('network_details')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetails')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineReasonEnum $reason
     */
	#[\JMS\Serializer\Annotation\SerializedName('reason')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineReasonEnum>')]
    public InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineReasonEnum $reason;
    
	public function __construct()
	{
		$this->amount = 0;
		$this->currency = \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineCurrencyEnum::CAD;
		...
		$this->merchantState = "";
		$this->network = \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkEnum::VISA;
		$this->networkDetails = new \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetails();
		$this->realTimeDecisionId = "";
		$this->reason = \OpenAPI\OpenAPI\Models\Shared\InboundAchTransferSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineReasonEnum::CARD_NOT_ACTIVE;
	}
}
