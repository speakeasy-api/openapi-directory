...
var DescribeCasesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "afterTime" }),
        __metadata("design:type", String)
    ], DescribeCasesRequest.prototype, "afterTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "beforeTime" }),
        __metadata("design:type", String)
    ], DescribeCasesRequest.prototype, "beforeTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "caseIdList" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "includeCommunications" }),
        __metadata("design:type", Boolean)
    ], DescribeCasesRequest.prototype, "includeCommunications", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "includeResolvedCases" }),
        __metadata("design:type", Boolean)
