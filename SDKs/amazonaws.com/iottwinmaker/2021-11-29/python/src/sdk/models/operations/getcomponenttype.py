...
from ..shared import getcomponenttyperesponse as shared_getcomponenttyperesponse
...
class GetComponentTypeResponse:
    ...
    get_component_type_response: Optional[shared_getcomponenttyperesponse.GetComponentTypeResponse] = dataclasses.field(default=None)
    r"""Success"""  
