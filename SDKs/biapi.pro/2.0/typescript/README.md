...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/biapi.pro/2.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/biapi.pro/2.0/typescript
```
