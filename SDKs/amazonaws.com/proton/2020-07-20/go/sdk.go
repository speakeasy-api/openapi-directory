...
func (s *SDK) CreateServiceInstance(ctx context.Context, request operations.CreateServiceInstanceRequest) (*operations.CreateServiceInstanceResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.CreateServiceInstance"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CreateServiceInstanceInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.CreateServiceInstanceResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CreateServiceInstanceOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// CreateServiceSyncConfig - Create the Proton Ops configuration file.
func (s *SDK) CreateServiceSyncConfig(ctx context.Context, request operations.CreateServiceSyncConfigRequest) (*operations.CreateServiceSyncConfigResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.CreateServiceSyncConfig"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CreateServiceSyncConfigInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.CreateServiceSyncConfigResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CreateServiceSyncConfigOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// DeleteServiceSyncConfig - Delete the Proton Ops file.
func (s *SDK) DeleteServiceSyncConfig(ctx context.Context, request operations.DeleteServiceSyncConfigRequest) (*operations.DeleteServiceSyncConfigResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.DeleteServiceSyncConfig"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "DeleteServiceSyncConfigInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.DeleteServiceSyncConfigResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DeleteServiceSyncConfigOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// GetServiceInstanceSyncStatus - Get the status of the synced service instance.
func (s *SDK) GetServiceInstanceSyncStatus(ctx context.Context, request operations.GetServiceInstanceSyncStatusRequest) (*operations.GetServiceInstanceSyncStatusResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.GetServiceInstanceSyncStatus"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetServiceInstanceSyncStatusInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.GetServiceInstanceSyncStatusResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetServiceInstanceSyncStatusOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// GetServiceSyncBlockerSummary - Get detailed data for the service sync blocker summary.
func (s *SDK) GetServiceSyncBlockerSummary(ctx context.Context, request operations.GetServiceSyncBlockerSummaryRequest) (*operations.GetServiceSyncBlockerSummaryResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.GetServiceSyncBlockerSummary"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetServiceSyncBlockerSummaryInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.GetServiceSyncBlockerSummaryResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetServiceSyncBlockerSummaryOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// GetServiceSyncConfig - Get detailed information for the service sync configuration.
func (s *SDK) GetServiceSyncConfig(ctx context.Context, request operations.GetServiceSyncConfigRequest) (*operations.GetServiceSyncConfigResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.GetServiceSyncConfig"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetServiceSyncConfigInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.GetServiceSyncConfigResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetServiceSyncConfigOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// UpdateServiceSyncBlocker - Update the service sync blocker by resolving it.
func (s *SDK) UpdateServiceSyncBlocker(ctx context.Context, request operations.UpdateServiceSyncBlockerRequest) (*operations.UpdateServiceSyncBlockerResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.UpdateServiceSyncBlocker"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateServiceSyncBlockerInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.UpdateServiceSyncBlockerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateServiceSyncBlockerOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// UpdateServiceSyncConfig - Update the Proton Ops config file.
func (s *SDK) UpdateServiceSyncConfig(ctx context.Context, request operations.UpdateServiceSyncConfigRequest) (*operations.UpdateServiceSyncConfigResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=AwsProton20200720.UpdateServiceSyncConfig"

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateServiceSyncConfigInput", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.UpdateServiceSyncConfigResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.UpdateServiceSyncConfigOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
