...
from ..shared import usage_record_enum_category_enum as shared_usage_record_enum_category_enum
from ..shared import security as shared_security
from ..shared import api_v2010_account_usage_usage_record as shared_api_v2010_account_usage_usage_record
...
class ListUsageRecordQueryParams:
    category: Optional[shared_usage_record_enum_category_enum.UsageRecordEnumCategoryEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Category', 'style': 'form', 'explode': True }})
...
class ListUsageRecordListUsageRecordResponse:
    ...
    usage_records: Optional[list[shared_api_v2010_account_usage_usage_record.APIV2010AccountUsageUsageRecord]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
