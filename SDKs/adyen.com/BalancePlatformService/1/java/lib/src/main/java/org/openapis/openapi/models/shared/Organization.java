...
public class Organization {
    ...
    public Organization withPhone(PhoneNumber2 phone) {
        this.phone = phone;
        return this;
    }
    ...
    public Organization withPrincipalPlaceOfBusiness(Address3 principalPlaceOfBusiness) {
    ...
    public Organization withRegisteredAddress(Address3 registeredAddress) {
    ...
    public Organization(@JsonProperty("legalName") String legalName, @JsonProperty("registeredAddress") Address3 registeredAddress) {
        this.legalName = legalName;
        this.registeredAddress = registeredAddress;
  }
}
