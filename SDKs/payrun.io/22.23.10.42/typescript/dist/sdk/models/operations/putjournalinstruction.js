...
exports.PutJournalInstructionResponse = exports.PutJournalInstructionRequest = void 0;
...
var PutJournalInstructionRequest = /** @class */ (function (_super) {
    ...
    ], PutJournalInstructionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutJournalInstructionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutJournalInstructionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=JournalInstructionId",
        }),
        __metadata("design:type", String)
    ], PutJournalInstructionRequest.prototype, "journalInstructionId", void 0);
    return PutJournalInstructionRequest;
}(utils_1.SpeakeasyBase));
exports.PutJournalInstructionRequest = PutJournalInstructionRequest;
var PutJournalInstructionResponse = /** @class */ (function (_super) {
    ...
    ], PutJournalInstructionResponse.prototype, "rawResponse", void 0);
    return PutJournalInstructionResponse;
}(utils_1.SpeakeasyBase));
exports.PutJournalInstructionResponse = PutJournalInstructionResponse;
