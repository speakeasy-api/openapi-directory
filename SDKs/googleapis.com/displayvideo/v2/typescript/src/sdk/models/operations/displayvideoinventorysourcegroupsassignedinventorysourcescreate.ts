...
export class DisplayvideoInventorySourceGroupsAssignedInventorySourcesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoInventorySourceGroupsAssignedInventorySourcesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoInventorySourceGroupsAssignedInventorySourcesCreateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
