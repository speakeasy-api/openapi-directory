...
import org.openapis.openapi.models.operations.FacetscategoryRequest;
import org.openapis.openapi.models.operations.FacetscategoryResponse;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FacetscategoryRequest req = new FacetscategoryRequest("application/json", "application/json", "c", "2") {{
                from = "1";
                to = "50";
            }};            

            FacetscategoryResponse res = sdk.facets.facetscategory(req);

            if (res.facetscategory200ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest;
import org.openapis.openapi.models.operations.GetApiCatalogSystemPubFacetsCategoryCategoryIdResponse;
import org.openapis.openapi.models.shared.Security;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest req = new GetApiCatalogSystemPubFacetsCategoryCategoryIdRequest("application/json", "application/json", "1") {{
                from = "1";
                to = "50";
            }};            

            GetApiCatalogSystemPubFacetsCategoryCategoryIdResponse res = sdk.facets.getApiCatalogSystemPubFacetsCategoryCategoryId(req);

            if (res.getApiCatalogSystemPubFacetsCategoryCategoryId200ApplicationJSONObjects != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
