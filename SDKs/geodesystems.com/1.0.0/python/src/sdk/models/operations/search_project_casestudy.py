...
class SearchProjectCasestudyQueryParams:
    ...
    search_project_casestudy_intended_use: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_casestudy.intended_use', 'style': 'form', 'explode': True }})
    search_project_casestudy_location: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_casestudy.location', 'style': 'form', 'explode': True }})
...
class SearchProjectCasestudyRequest:
    query_params: SearchProjectCasestudyQueryParams = dataclasses.field()
