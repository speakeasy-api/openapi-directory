...
public class PutPayScheduleTagRequest {
    ...
    public PutPayScheduleTagRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerId") String employerId, @JsonProperty("PayScheduleId") String payScheduleId, @JsonProperty("TagId") String tagId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerId = employerId;
        this.payScheduleId = payScheduleId;
