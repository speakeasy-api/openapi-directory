...
public class InvoicesUpdateRequest {
    ...
    public InvoicesUpdateRequest(@JsonProperty("InvoiceInput") org.openapis.openapi.models.shared.InvoiceInput invoiceInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.invoiceInput = invoiceInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
