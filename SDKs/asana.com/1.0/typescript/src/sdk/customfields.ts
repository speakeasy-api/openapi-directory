...
export class CustomFields {
  ...
  createCustomField(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreateCustomFieldResponse =
        new operations.CreateCustomFieldResponse({
  ...
  deleteCustomField(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteCustomFieldResponse =
        new operations.DeleteCustomFieldResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  updateEnumOption(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateEnumOptionResponse =
        new operations.UpdateEnumOptionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
