...
class DescribeVpcEndpointServiceConfigurationsRequestFilters:
...
class DescribeVpcEndpointServiceConfigurationsRequest:
    ...
    filters: Optional[list[DescribeVpcEndpointServiceConfigurationsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    service_ids: Optional[list[str]] = dataclasses.field(default=None)  
