...
exports.SyslogServers = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SyslogServers = /** @class */ (function () {
    function SyslogServers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SyslogServers.prototype.getNetworkSyslogServers = function (req, config) {
    ...
    **/
    SyslogServers.prototype.updateNetworkSyslogServers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.SyslogServers = SyslogServers;
