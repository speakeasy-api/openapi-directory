...
public class PredictImageUrlFormQueryParams {
    /**
     * Optional. Specifies the name of application using the endpoint
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=application")
    public String application;
    public PredictImageUrlFormQueryParams withApplication(String application) {
    ...
    public PredictImageUrlFormQueryParams withIterationId(String iterationId) {
