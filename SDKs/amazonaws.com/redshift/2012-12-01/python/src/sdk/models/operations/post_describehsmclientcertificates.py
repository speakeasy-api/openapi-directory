...
class PostDescribeHsmClientCertificatesQueryParams:
    action: PostDescribeHsmClientCertificatesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeHsmClientCertificatesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeHsmClientCertificatesRequest:
    headers: PostDescribeHsmClientCertificatesHeaders = dataclasses.field()
    query_params: PostDescribeHsmClientCertificatesQueryParams = dataclasses.field()
