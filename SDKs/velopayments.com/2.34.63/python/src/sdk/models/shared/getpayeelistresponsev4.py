...
from ..shared import getpayeelistresponsecompanyv4 as shared_getpayeelistresponsecompanyv4
from ..shared import getpayeelistresponseindividualv4 as shared_getpayeelistresponseindividualv4
...
class GetPayeeListResponseV4:
    ...
    company: Optional[shared_getpayeelistresponsecompanyv4.GetPayeeListResponseCompanyV4] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('company'), 'exclude': lambda f: f is None }})  
    ...
    individual: Optional[shared_getpayeelistresponseindividualv4.GetPayeeListResponseIndividualV4] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('individual'), 'exclude': lambda f: f is None }})  
