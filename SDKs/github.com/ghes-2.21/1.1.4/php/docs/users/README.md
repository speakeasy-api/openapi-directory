...
try {
    ...
    $request->targetUser = 'quasi';
    $request->username = 'Luther.Schmidt';
...
try {
    ...
    $request->username = 'Alexandrea_Schumm0';
...
try {
    ...
    $request->armoredPublicKey = 'eaque';
...
try {
    ...
    $request->username = 'Willis_Abbott11';
...
try {
    ...
    $request->perPage = 985360;
    $request->since = 244569;
...
try {
    ...
    $request->username = 'Alia.Denesik27';
