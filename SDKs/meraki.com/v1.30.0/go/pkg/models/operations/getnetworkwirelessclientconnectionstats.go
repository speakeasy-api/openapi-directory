...
// GetNetworkWirelessClientConnectionStatsBandEnum - Filter results by band (either '2.4', '5' or '6'). Note that data prior to February 2020 will not have band information.
...
const (
	...
	GetNetworkWirelessClientConnectionStatsBandEnumSix  GetNetworkWirelessClientConnectionStatsBandEnum = "6"
)

func (e *GetNetworkWirelessClientConnectionStatsBandEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessClientConnectionStatsBandEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessClientConnectionStatsBandEnum: %s", s)
	}
}
