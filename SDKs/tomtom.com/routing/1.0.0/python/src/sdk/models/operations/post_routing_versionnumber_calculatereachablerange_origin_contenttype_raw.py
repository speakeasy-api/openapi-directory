...
class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawVehicleEngineTypeEnum(str, Enum):
...
class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawRequest:
    ...
    vehicle_engine_type: Optional[PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawVehicleEngineTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'vehicleEngineType', 'style': 'form', 'explode': True }})
    r"""Engine type of the vehicle."""  
...
@dataclasses.dataclass
class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawResponse:
