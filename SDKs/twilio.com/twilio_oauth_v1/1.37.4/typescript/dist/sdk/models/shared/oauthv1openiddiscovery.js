...
exports.OauthV1OpenidDiscovery = void 0;
...
var OauthV1OpenidDiscovery = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=authorization_endpoint" }),
        __metadata("design:type", String)
    ], OauthV1OpenidDiscovery.prototype, "authorizationEndpoint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=claims_supported" }),
        __metadata("design:type", Array)
    ], OauthV1OpenidDiscovery.prototype, "claimsSupported", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=device_authorization_endpoint" }),
        __metadata("design:type", String)
    ], OauthV1OpenidDiscovery.prototype, "deviceAuthorizationEndpoint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=id_token_signing_alg_values_supported" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=jwk_uri" }),
        __metadata("design:type", String)
    ], OauthV1OpenidDiscovery.prototype, "jwkUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=response_type_supported" }),
        __metadata("design:type", Array)
    ], OauthV1OpenidDiscovery.prototype, "responseTypeSupported", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=revocation_endpoint" }),
        __metadata("design:type", String)
    ], OauthV1OpenidDiscovery.prototype, "revocationEndpoint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=scopes_supported" }),
        __metadata("design:type", Array)
    ], OauthV1OpenidDiscovery.prototype, "scopesSupported", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subject_type_supported" }),
        __metadata("design:type", Array)
    ], OauthV1OpenidDiscovery.prototype, "subjectTypeSupported", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=token_endpoint" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=userinfo_endpoint" }),
        __metadata("design:type", String)
    ], OauthV1OpenidDiscovery.prototype, "userinfoEndpoint", void 0);
    return OauthV1OpenidDiscovery;
}(utils_1.SpeakeasyBase));
exports.OauthV1OpenidDiscovery = OauthV1OpenidDiscovery;
