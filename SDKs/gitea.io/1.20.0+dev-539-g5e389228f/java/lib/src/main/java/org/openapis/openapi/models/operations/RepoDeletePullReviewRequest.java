...
public class RepoDeletePullReviewRequest {
    ...
    public RepoDeletePullReviewRequest(@JsonProperty("id") Long id, @JsonProperty("index") Long index, @JsonProperty("owner") String owner, @JsonProperty("repo") String repo) {
        this.id = id;
        this.index = index;
        this.owner = owner;
        this.repo = repo;
