...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CreateResolverRequestBodyRuntime:
...
class CreateResolverRequestBody:
    ...
    r"""The name of the field to attach the resolver to."""  
    caching_config: Optional[CreateResolverRequestBodyCachingConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cachingConfig'), 'exclude': lambda f: f is None }})
    r"""The caching configuration for a resolver that has caching activated."""  
    ...
    r"""The name of the data source for which the resolver is being created."""  
    kind: Optional[CreateResolverRequestBodyKindEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kind'), 'exclude': lambda f: f is None }})
    r"""<p>The resolver type.</p> <ul> <li> <p> <b>UNIT</b>: A UNIT resolver type. A UNIT resolver is the default resolver type. You can use a UNIT resolver to run a GraphQL query against a single data source.</p> </li> <li> <p> <b>PIPELINE</b>: A PIPELINE resolver type. You can use a PIPELINE resolver to invoke a series of <code>Function</code> objects in a serial manner. You can use a pipeline resolver to run a GraphQL query against multiple data sources.</p> </li> </ul>"""  
    ...
    pipeline_config: Optional[CreateResolverRequestBodyPipelineConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pipelineConfig'), 'exclude': lambda f: f is None }})
    r"""The pipeline configuration for a resolver of kind <code>PIPELINE</code>."""  
    ...
    r"""<p>The mapping template to use for requests.</p> <p>A resolver uses a request mapping template to convert a GraphQL expression into a format that a data source can understand. Mapping templates are written in Apache Velocity Template Language (VTL).</p> <p>VTL request mapping templates are optional when using an Lambda data source. For all other data sources, VTL request and response mapping templates are required.</p>"""  
    ...
    r"""The mapping template to use for responses from the data source."""  
    runtime: Optional[CreateResolverRequestBodyRuntime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('runtime'), 'exclude': lambda f: f is None }})
    r"""Describes a runtime used by an Amazon Web Services AppSync pipeline resolver or Amazon Web Services AppSync function. Specifies the name and version of the runtime to use. Note that if a runtime is specified, code must also be specified."""  
    sync_config: Optional[CreateResolverRequestBodySyncConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('syncConfig'), 'exclude': lambda f: f is None }})
    r"""<p>Describes a Sync configuration for a resolver.</p> <p>Specifies which Conflict Detection strategy and Resolution strategy to use when the resolver is invoked.</p>"""  
...
class CreateResolverRequest:
    ...
    r"""The ID for the GraphQL API for which the resolver is being created."""  
    request_body: CreateResolverRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    type_name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'typeName', 'style': 'simple', 'explode': False }})
    r"""The name of the <code>Type</code>."""  
