...
class ComputeInstancesSetShieldedInstanceIntegrityPolicyRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ShieldedInstanceIntegrityPolicy $shieldedInstanceIntegrityPolicy = null;
