...
from ..shared import tppmessage400_ais as shared_tppmessage400_ais
...
class Error400NgAis:
    ...
    tpp_messages: Optional[list[shared_tppmessage400_ais.TppMessage400Ais]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
