...
class SoldToContactPostOrderOtherPhoneTypeEnum(str, Enum):
...
class SoldToContactPostOrder:
    ...
    other_phone_type: Optional[SoldToContactPostOrderOtherPhoneTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('otherPhoneType'), 'exclude': lambda f: f is None }})
    r"""Specifies the type of phone number in the `otherPhone` field."""  
