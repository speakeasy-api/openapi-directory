...
public class POSTRejectTransitGatewayVpcAttachmentRequest {
    ...
    public POSTRejectTransitGatewayVpcAttachmentRequest(@JsonProperty("Action") POSTRejectTransitGatewayVpcAttachmentActionEnum action, @JsonProperty("Version") POSTRejectTransitGatewayVpcAttachmentVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
