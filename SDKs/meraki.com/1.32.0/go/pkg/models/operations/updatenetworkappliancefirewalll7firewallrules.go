...
func (e UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesPolicyEnum) ToPointer() *UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesPolicyEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesPolicyEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "deny":
		*e = UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesPolicyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesPolicyEnum: %v", v)
	}
}
...
func (e UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesTypeEnum) ToPointer() *UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesTypeEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ipRange":
		fallthrough
	case "port":
		*e = UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallL7FirewallRulesRequestBodyRulesTypeEnum: %v", v)
	}
}
