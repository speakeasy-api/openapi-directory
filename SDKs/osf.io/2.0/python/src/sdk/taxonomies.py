...
class Taxonomies:
    ...
    def taxonomies_list(self) -> operations.TaxonomiesListResponse:
        ...
        res = operations.TaxonomiesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def taxonomies_read(self, request: operations.TaxonomiesReadRequest) -> operations.TaxonomiesReadResponse:
        ...
        url = utils.generate_url(operations.TaxonomiesReadRequest, base_url, '/taxonomies/{taxonomy_id}/', request)
        ...
        res = operations.TaxonomiesReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
