...
export class SavedColumns {
  ...
  doubleclicksearchSavedColumnsList(
    ...
    security: operations.DoubleclicksearchSavedColumnsListSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.DoubleclicksearchSavedColumnsListSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DoubleclicksearchSavedColumnsListResponse =
        new operations.DoubleclicksearchSavedColumnsListResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.savedColumnList = utils.objectToClass(
              httpRes?.data,
              shared.SavedColumnList
            );
          }
          break;
      }
