...
public class ActionPOSTqueryRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActionqueryRequest proxyActionqueryRequest;
    public ActionPOSTqueryRequest withProxyActionqueryRequest(org.openapis.openapi.models.shared.ProxyActionqueryRequest proxyActionqueryRequest) {
        this.proxyActionqueryRequest = proxyActionqueryRequest;
        return this;
    }
    ...
    public ActionPOSTqueryRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTqueryRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTqueryRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTqueryRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
