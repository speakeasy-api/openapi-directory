...
class FirebaseappcheckProjectsAppsExchangeAppAttestAttestationRequest:
    ...
    google_firebase_appcheck_v1_exchange_app_attest_attestation_request: Optional[shared_googlefirebaseappcheckv1exchangeappattestattestationrequest.GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
