...
class Projects:
    ...
    def tpu_projects_locations_accelerator_types_list(self, request: operations.TpuProjectsLocationsAcceleratorTypesListRequest) -> operations.TpuProjectsLocationsAcceleratorTypesListResponse:
        ...
        url = utils.generate_url(base_url, "/v1/{parent}/acceleratorTypes", request.path_params)
    ...
    def tpu_projects_locations_nodes_create(self, request: operations.TpuProjectsLocationsNodesCreateRequest) -> operations.TpuProjectsLocationsNodesCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1/{parent}/nodes", request.path_params)
    ...
    def tpu_projects_locations_nodes_reimage(self, request: operations.TpuProjectsLocationsNodesReimageRequest) -> operations.TpuProjectsLocationsNodesReimageResponse:
        r"""Reimages a node's OS.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/v1/{name}:reimage", request.path_params)
        ...
        res = operations.TpuProjectsLocationsNodesReimageResponse(status_code=r.status_code, content_type=content_type)
    ...
    def tpu_projects_locations_tensorflow_versions_get(self, request: operations.TpuProjectsLocationsTensorflowVersionsGetRequest) -> operations.TpuProjectsLocationsTensorflowVersionsGetResponse:
        ...
        res = operations.TpuProjectsLocationsTensorflowVersionsGetResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TensorFlowVersion])
                res.tensor_flow_version = out

        return res

    
    def tpu_projects_locations_tensorflow_versions_list(self, request: operations.TpuProjectsLocationsTensorflowVersionsListRequest) -> operations.TpuProjectsLocationsTensorflowVersionsListResponse:
        r"""List TensorFlow versions supported by this API.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/v1/{parent}/tensorflowVersions", request.path_params)
        ...
        res = operations.TpuProjectsLocationsTensorflowVersionsListResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListTensorFlowVersionsResponse])
