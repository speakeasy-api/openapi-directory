...
exports.GetPortfolioMembershipsForPortfolioResponse = exports.GetPortfolioMembershipsForPortfolio200ApplicationJSON = exports.GetPortfolioMembershipsForPortfolioRequest = void 0;
...
var GetPortfolioMembershipsForPortfolioRequest = /** @class */ (function (_super) {
    ...
    ], GetPortfolioMembershipsForPortfolioRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], GetPortfolioMembershipsForPortfolioRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=opt_fields",
        }),
        __metadata("design:type", Array)
    ], GetPortfolioMembershipsForPortfolioRequest.prototype, "optFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=opt_pretty",
        }),
        __metadata("design:type", Boolean)
    ], GetPortfolioMembershipsForPortfolioRequest.prototype, "optPretty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=portfolio_gid",
        }),
        __metadata("design:type", String)
    ], GetPortfolioMembershipsForPortfolioRequest.prototype, "portfolioGid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=user" }),
        __metadata("design:type", String)
    ], GetPortfolioMembershipsForPortfolioRequest.prototype, "user", void 0);
...
var GetPortfolioMembershipsForPortfolioResponse = /** @class */ (function (_super) {
    ...
    ], GetPortfolioMembershipsForPortfolioResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
