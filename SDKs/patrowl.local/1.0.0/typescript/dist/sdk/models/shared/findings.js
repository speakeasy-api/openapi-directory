...
var FindingsMetaRisk = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cvss_base_score" }),
        __metadata("design:type", Array)
    ], FindingsMetaRisk.prototype, "cvssBaseScore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cvss_vector" }),
        __metadata("design:type", Array)
    ], FindingsMetaRisk.prototype, "cvssVector", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=exploit_available" }),
        __metadata("design:type", Array)
    ], FindingsMetaRisk.prototype, "exploitAvailable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=exploitability_ease" }),
        __metadata("design:type", Array)
    ], FindingsMetaRisk.prototype, "exploitabilityEase", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=patch_publication_date" }),
        __metadata("design:type", Array)
...
var FindingsMetaVulnRefs = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bid" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cve" }),
        __metadata("design:type", Array)
    ], FindingsMetaVulnRefs.prototype, "cve", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cwe" }),
        __metadata("design:type", Array)
...
var Findings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=issue_id" }),
        __metadata("design:type", Number)
    ], Findings.prototype, "issueId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=meta_links" }),
        __metadata("design:type", Array)
    ], Findings.prototype, "metaLinks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=meta_risk" }),
        __metadata("design:type", FindingsMetaRisk)
    ], Findings.prototype, "metaRisk", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=meta_tags" }),
        __metadata("design:type", Array)
    ], Findings.prototype, "metaTags", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=meta_vuln_refs" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=solution" }),
        __metadata("design:type", String)
    ], Findings.prototype, "solution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=target_addrs" }),
        __metadata("design:type", Array)
    ], Findings.prototype, "targetAddrs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=target_proto" }),
        __metadata("design:type", Array)
