...
class UserResponse:
    ...
    photo: Optional[UserResponsePhoto] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('photo'), 'exclude': lambda f: f is None }})
    r"""A map of the user’s profile photo in various sizes, or null if no photo is set. Sizes provided are 21, 27, 36, 60, 128, and 1024. All images are in PNG format, except for 1024 (which is in JPEG format)."""  
    ...
    workspaces: Optional[list[shared_workspacecompact.WorkspaceCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('workspaces'), 'exclude': lambda f: f is None }})
    r"""Workspaces and organizations this user may access.
