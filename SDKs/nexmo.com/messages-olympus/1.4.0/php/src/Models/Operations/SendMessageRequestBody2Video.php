...
class SendMessageRequestBody2Video
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoChannelEnum $channel
     */
	#[\JMS\Serializer\Annotation\SerializedName('channel')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoChannelEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoMessageTypeEnum $messageType
     */
	#[\JMS\Serializer\Annotation\SerializedName('message_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoMessageTypeEnum>')]
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoVideo')]
    public SendMessageRequestBody2VideoVideo $video;
    
	public function __construct()
	{
		$this->channel = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoChannelEnum::MMS;
		$this->clientRef = null;
		$this->from = "";
		$this->messageType = \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoMessageTypeEnum::VIDEO;
		$this->to = "";
		$this->video = new \OpenAPI\OpenAPI\Models\Operations\SendMessageRequestBody2VideoVideo();
	}
}
