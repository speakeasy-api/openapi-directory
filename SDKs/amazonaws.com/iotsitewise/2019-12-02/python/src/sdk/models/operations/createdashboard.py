...
class CreateDashboardRequestBody:
    ...
    r"""The dashboard definition specified in a JSON literal. For detailed information, see <a href=\\"https://docs.aws.amazon.com/iot-sitewise/latest/userguide/create-dashboards-using-aws-cli.html\\">Creating dashboards (CLI)</a> in the <i>IoT SiteWise User Guide</i>."""  
    dashboard_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dashboardName') }})
    r"""A friendly name for the dashboard."""  
    project_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('projectId') }})
    r"""The ID of the project in which to create the dashboard."""  
    ...
    r"""A description for the dashboard."""  
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tags'), 'exclude': lambda f: f is None }})
    r"""A list of key-value pairs that contain metadata for the dashboard. For more information, see <a href=\\"https://docs.aws.amazon.com/iot-sitewise/latest/userguide/tag-resources.html\\">Tagging your IoT SiteWise resources</a> in the <i>IoT SiteWise User Guide</i>."""  
    

@dataclasses.dataclass
class CreateDashboardRequest:
    
    request_body: CreateDashboardRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
