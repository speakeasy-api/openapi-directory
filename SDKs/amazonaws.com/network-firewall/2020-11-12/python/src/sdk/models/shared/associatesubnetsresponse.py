...
class AssociateSubnetsResponse:
    ...
    subnet_mappings: Optional[list[shared_subnetmapping.SubnetMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SubnetMappings'), 'exclude': lambda f: f is None }})  
