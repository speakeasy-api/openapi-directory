...
class MarkdownRenderRequestBodyModeEnum(str, Enum):
    r"""The rendering mode. Can be either `markdown` or `gfm`."""
    MARKDOWN = 'markdown'
    GFM = 'gfm'
...
class MarkdownRenderRequestBody:
    ...
    r"""The repository context to use when creating references in `gfm` mode.  For example, setting `context` to `octo-org/octo-repo` will change the text `#42` into an HTML link to issue 42 in the `octo-org/octo-repo` repository."""  
