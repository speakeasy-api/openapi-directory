...
public class DistributionGroupsRemoveUserRequest {
    ...
    public DistributionGroupsRemoveUserRequest(@JsonProperty("RequestBody") DistributionGroupsRemoveUserRequestBody requestBody, @JsonProperty("app_name") String appName, @JsonProperty("distribution_group_name") String distributionGroupName, @JsonProperty("owner_name") String ownerName) {
        this.requestBody = requestBody;
        this.appName = appName;
        this.distributionGroupName = distributionGroupName;
        this.ownerName = ownerName;
