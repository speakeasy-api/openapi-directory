...
export class DisplayvideoCustomBiddingAlgorithmsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoCustomBiddingAlgorithmsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoCustomBiddingAlgorithmsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
