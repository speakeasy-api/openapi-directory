...
class SearchProjectDataformatQueryParams:
    ...
    search_project_dataformat_data_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_dataformat.data_type', 'style': 'form', 'explode': True }})
    search_project_dataformat_field: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_dataformat.field', 'style': 'form', 'explode': True }})
...
class SearchProjectDataformatRequest:
    query_params: SearchProjectDataformatQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectDataformatResponse:
