...
var IpamServicesListQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=port__gt" }),
        __metadata("design:type", String)
    ], IpamServicesListQueryParams.prototype, "portGt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=port__gte" }),
        __metadata("design:type", String)
    ], IpamServicesListQueryParams.prototype, "portGte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=port__lt" }),
        __metadata("design:type", String)
    ], IpamServicesListQueryParams.prototype, "portLt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=port__lte" }),
        __metadata("design:type", String)
    ], IpamServicesListQueryParams.prototype, "portLte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=port__n" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=protocol__n" }),
        __metadata("design:type", String)
