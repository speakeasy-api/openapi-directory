...
export class DatalabelingProjectsDatasetsAnnotatedDatasetsFeedbackThreadsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsDatasetsAnnotatedDatasetsFeedbackThreadsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalabelingProjectsDatasetsAnnotatedDatasetsFeedbackThreadsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
