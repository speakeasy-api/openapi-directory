...
public class GetNetworkDevicesConnectionStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkDevicesConnectionStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkDevicesConnectionStatsQueryParams withBand(GetNetworkDevicesConnectionStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkDevicesConnectionStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkDevicesConnectionStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkDevicesConnectionStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkDevicesConnectionStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkDevicesConnectionStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
