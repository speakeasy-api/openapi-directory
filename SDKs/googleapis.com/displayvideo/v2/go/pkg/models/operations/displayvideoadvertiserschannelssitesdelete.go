...
type DisplayvideoAdvertisersChannelsSitesDeleteSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type DisplayvideoAdvertisersChannelsSitesDeleteRequest struct {
	// V1 error format.
...
type DisplayvideoAdvertisersChannelsSitesDeleteResponse struct {
	ContentType string
	// Successful response
