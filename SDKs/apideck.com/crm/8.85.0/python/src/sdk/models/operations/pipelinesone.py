...
class PipelinesOneRequest:
    headers: PipelinesOneHeaders = dataclasses.field()
    path_params: PipelinesOnePathParams = dataclasses.field()
    query_params: PipelinesOneQueryParams = dataclasses.field()
    security: PipelinesOneSecurity = dataclasses.field()
