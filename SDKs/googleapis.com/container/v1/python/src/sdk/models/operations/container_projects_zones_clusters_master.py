...
from ..shared import updatemasterrequest as shared_updatemasterrequest
...
@dataclasses.dataclass
class ContainerProjectsZonesClustersMasterRequest:
    ...
    update_master_request: Optional[shared_updatemasterrequest.UpdateMasterRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
