...
class MetalsBenchmarkHistoryGETRequest
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MetalsBenchmarkHistoryGETFormatEnum $format
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=format')]
    public ?MetalsBenchmarkHistoryGETFormatEnum $format = null;
     ...
     * dwt=pennyweight
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MetalsBenchmarkHistoryGETUnitofmeasureEnum $unitofmeasure
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=unitofmeasure')]
    public ?MetalsBenchmarkHistoryGETUnitofmeasureEnum $unitofmeasure = null;
