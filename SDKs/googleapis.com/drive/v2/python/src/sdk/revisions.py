...
class Revisions:
    ...
    def drive_revisions_patch(self, request: operations.DriveRevisionsPatchRequest, security: operations.DriveRevisionsPatchSecurity) -> operations.DriveRevisionsPatchResponse:
        r"""Updates a revision."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.DriveRevisionsPatchRequest, base_url, '/files/{fileId}/revisions/{revisionId}', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "revision", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.DriveRevisionsPatchRequest, request)
        ...
        res = operations.DriveRevisionsPatchResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
