...
func (e *ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetViewEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetViewEnum: %s", s)
	}
}
