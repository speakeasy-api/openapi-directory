 ...
 */
public enum CreateNetworkInsightsAccessScopeRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateNetworkInsightsAccessScopeRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
