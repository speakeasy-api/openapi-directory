...
from ..shared import modelyeardistentry as shared_modelyeardistentry


@dataclass_json
@dataclasses.dataclass
class ModelYearDistResp:
    data: list[shared_modelyeardistentry.ModelYearDistEntry] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
