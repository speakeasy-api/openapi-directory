...
class CreatePipelineForRepositoryResponse:
    ...
    r"""The account or repository is not enabled, the yml file does not exist in the repository for the given revision, or the request body contained invalid properties."""  
    headers: Optional[dict[str, list[str]]] = dataclasses.field(default=None)  
    pipeline: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""The initiated pipeline."""  
