...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesListPathParams struct {
...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesListQueryParams struct {
	// V1 error format.
...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesListRequest struct {
...
type PrivatecaProjectsLocationsCaPoolsCertificateAuthoritiesListResponse struct {
	ContentType string
	// Successful response
