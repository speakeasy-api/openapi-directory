...
export declare enum Onev21volumes1actionsPostRequestBodyContentApplication1jsonSchemaAnyOf0TypeEnum {
    Attach = "attach",
    Detach = "detach",
    Resize = "resize"
}
export declare class Onev21volumes1actionsPostRequestBodyContentApplication1jsonSchemaAnyOf0 extends SpeakeasyBase {
    dropletId: number;
