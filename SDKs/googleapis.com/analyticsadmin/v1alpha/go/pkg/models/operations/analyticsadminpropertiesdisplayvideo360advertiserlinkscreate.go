...
type AnalyticsadminPropertiesDisplayVideo360AdvertiserLinksCreateRequest struct {
	...
	GoogleAnalyticsAdminV1alphaDisplayVideo360AdvertiserLinkInput *shared.GoogleAnalyticsAdminV1alphaDisplayVideo360AdvertiserLinkInput `request:"mediaType=application/json"`
	// OAuth access token.
