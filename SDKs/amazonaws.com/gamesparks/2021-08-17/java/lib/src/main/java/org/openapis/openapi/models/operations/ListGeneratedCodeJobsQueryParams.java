...
public class ListGeneratedCodeJobsQueryParams {
    /**
    ...
    public ListGeneratedCodeJobsQueryParams withMaxResults(Long maxResults) {
    ...
    public ListGeneratedCodeJobsQueryParams withNextToken(String nextToken) {
