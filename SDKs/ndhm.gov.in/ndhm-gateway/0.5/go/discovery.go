...
func (s *Discovery) PostV05CareContextsOnDiscover(ctx context.Context, request operations.PostV05CareContextsOnDiscoverRequest) (*operations.PostV05CareContextsOnDiscoverResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05CareContextsOnDiscoverResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
