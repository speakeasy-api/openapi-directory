...
class ListFacetAttributesRequestBody:
    ...
    r"""The name of the facet whose attributes will be retrieved."""  
...
class ListFacetAttributesRequest:
    ...
    request_body: ListFacetAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_data_partition: str = dataclasses.field(metadata={'header': { 'field_name': 'x-amz-data-partition', 'style': 'simple', 'explode': False }})
    r"""The ARN of the schema where the facet resides."""  
