 ...
 */
export declare enum CreateCustomerGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateCustomerGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateCustomerGatewayRequestTagSpecifications extends SpeakeasyBase {
 ...
 */
export declare class CreateCustomerGatewayRequest extends SpeakeasyBase {
    bgpAsn?: number;
