...
export class SecuritycenterOrganizationsSourcesFindingsSetStateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsSourcesFindingsSetStateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsSourcesFindingsSetStateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
