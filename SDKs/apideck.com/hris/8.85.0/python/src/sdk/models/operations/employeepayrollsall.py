...
class EmployeePayrollsAllRequest:
    headers: EmployeePayrollsAllHeaders = dataclasses.field()
    path_params: EmployeePayrollsAllPathParams = dataclasses.field()
    query_params: EmployeePayrollsAllQueryParams = dataclasses.field()
    security: EmployeePayrollsAllSecurity = dataclasses.field()
