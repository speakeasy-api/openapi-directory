...
class AssociateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class AssociateIpamResourceDiscoveryRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class AssociateIpamResourceDiscoveryRequestTagSpecifications:
    ...
    resource_type: Optional[AssociateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[AssociateIpamResourceDiscoveryRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class AssociateIpamResourceDiscoveryRequest:
    ...
    tag_specifications: Optional[list[AssociateIpamResourceDiscoveryRequestTagSpecifications]] = dataclasses.field(default=None)  
