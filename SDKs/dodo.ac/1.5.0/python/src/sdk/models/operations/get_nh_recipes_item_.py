...
class GetNhRecipesItemRequest:
    ...
    r"""The name of the item you wish to retrieve recipe information about."""  
...
@dataclasses.dataclass
class GetNhRecipesItemResponse:
    ...
    nh_recipe: Optional[shared_nhrecipe.NHRecipe] = dataclasses.field(default=None)
