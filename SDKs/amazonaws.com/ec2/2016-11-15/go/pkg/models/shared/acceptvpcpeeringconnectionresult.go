...
func (e AcceptVpcPeeringConnectionResultVpcPeeringConnectionStatusCodeEnum) ToPointer() *AcceptVpcPeeringConnectionResultVpcPeeringConnectionStatusCodeEnum {
	return &e
}
...
func (e *AcceptVpcPeeringConnectionResultVpcPeeringConnectionStatusCodeEnum) UnmarshalJSON(data []byte) error {
	...
	case "provisioning":
		fallthrough
	case "deleting":
		*e = AcceptVpcPeeringConnectionResultVpcPeeringConnectionStatusCodeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AcceptVpcPeeringConnectionResultVpcPeeringConnectionStatusCodeEnum: %v", v)
	}
}
