...
from ..shared import updateregexpatternsetrequest as shared_updateregexpatternsetrequest
from ..shared import updateregexpatternsetresponse as shared_updateregexpatternsetresponse
...
class UpdateRegexPatternSetHeaders:
    x_amz_target: UpdateRegexPatternSetXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateRegexPatternSetRequest:
    headers: UpdateRegexPatternSetHeaders = dataclasses.field()
    request: shared_updateregexpatternsetrequest.UpdateRegexPatternSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateRegexPatternSetResponse:
    ...
    update_regex_pattern_set_response: Optional[shared_updateregexpatternsetresponse.UpdateRegexPatternSetResponse] = dataclasses.field(default=None)
    ...
    waf_invalid_regex_pattern_exception: Optional[Any] = dataclasses.field(default=None)
