...
class PUTSubscriptionRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\PUTSubscriptionType $putSubscriptionType;
	...
	{
		$this->putSubscriptionType = new \OpenAPI\OpenAPI\Models\Shared\PUTSubscriptionType();
