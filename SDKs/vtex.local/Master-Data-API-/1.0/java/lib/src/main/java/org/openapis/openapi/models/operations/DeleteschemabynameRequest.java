...
public class DeleteschemabynameRequest {
    ...
    public DeleteschemabynameRequest(@JsonProperty("Content-Type") String contentType, @JsonProperty("dataEntityName") String dataEntityName, @JsonProperty("schemaName") String schemaName) {
        this.contentType = contentType;
        this.dataEntityName = dataEntityName;
        this.schemaName = schemaName;
  }
