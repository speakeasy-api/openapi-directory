...
public class UpdateNetworkApplianceTrafficShapingCustomPerformanceClassRequest {
    ...
    public UpdateNetworkApplianceTrafficShapingCustomPerformanceClassRequest(@JsonProperty("customPerformanceClassId") String customPerformanceClassId, @JsonProperty("networkId") String networkId) {
        this.customPerformanceClassId = customPerformanceClassId;
        this.networkId = networkId;
  }
}
