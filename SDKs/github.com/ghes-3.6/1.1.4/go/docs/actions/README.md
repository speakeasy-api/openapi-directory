...
func main() {
    ...
    res, err := s.Actions.ActionsListArtifactsForRepo(ctx, operations.ActionsListArtifactsForRepoRequest{
        ...
        Owner: "perferendis",
        Page: sdk.Int64(164940),
        PerPage: sdk.Int64(828940),
        Repo: "ipsam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Actions.ActionsListJobsForWorkflowRun(ctx, operations.ActionsListJobsForWorkflowRunRequest{
        ...
        Owner: "facilis",
        Page: sdk.Int64(735194),
        PerPage: sdk.Int64(288476),
        Repo: "delectus",
        RunID: 433288,
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Actions.ActionsListJobsForWorkflowRunAttempt(ctx, operations.ActionsListJobsForWorkflowRunAttemptRequest{
        AttemptNumber: 248753,
        Owner: "eligendi",
        Page: sdk.Int64(576157),
        PerPage: sdk.Int64(396098),
        Repo: "provident",
        RunID: 896039,
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Actions.ActionsListSelectedReposForOrgSecret(ctx, operations.ActionsListSelectedReposForOrgSecretRequest{
        Org: "delectus",
        Page: sdk.Int64(692532),
        PerPage: sdk.Int64(588465),
        SecretName: "nam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Actions.ActionsListSelfHostedRunnerGroupsForOrg(ctx, operations.ActionsListSelfHostedRunnerGroupsForOrgRequest{
        ...
        VisibleToRepository: sdk.String("nisi"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Actions.ActionsListSelfHostedRunnersForOrg(ctx, operations.ActionsListSelfHostedRunnersForOrgRequest{
        Org: "vel",
        Page: sdk.Int64(618809),
        PerPage: sdk.Int64(606393),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Actions.ActionsListWorkflowRunArtifacts(ctx, operations.ActionsListWorkflowRunArtifactsRequest{
        Owner: "suscipit",
        Page: sdk.Int64(618016),
        PerPage: sdk.Int64(749170),
        Repo: "eum",
        RunID: 878453,
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Actions.ActionsListWorkflowRuns(ctx, operations.ActionsListWorkflowRunsRequest{
        ...
        Branch: sdk.String("architecto"),
        CheckSuiteID: sdk.Int64(298282),
        Created: types.MustTimeFromString("2022-06-06T23:06:26.119Z"),
        Event: sdk.String("ullam"),
        ExcludePullRequests: sdk.Bool(false),
        Owner: "provident",
        Page: sdk.Int64(551816),
        PerPage: sdk.Int64(574325),
        Repo: "accusantium",
...
func main() {
    ...
    res, err := s.Actions.ActionsListWorkflowRunsForRepo(ctx, operations.ActionsListWorkflowRunsForRepoRequest{
        Actor: sdk.String("reiciendis"),
        Branch: sdk.String("mollitia"),
        CheckSuiteID: sdk.Int64(320997),
        Created: types.MustTimeFromString("2022-10-12T05:44:19.260Z"),
        Event: sdk.String("necessitatibus"),
        ExcludePullRequests: sdk.Bool(false),
        Owner: "odit",
...
func main() {
    ...
    res, err := s.Actions.ActionsSetWorkflowAccessToRepository(ctx, operations.ActionsSetWorkflowAccessToRepositoryRequest{
        ActionsWorkflowAccessToRepository: shared.ActionsWorkflowAccessToRepository{
            AccessLevel: shared.ActionsWorkflowAccessToRepositoryAccessLevelEnumEnterprise,
        },
        Owner: "voluptate",
        Repo: "dignissimos",
    })
