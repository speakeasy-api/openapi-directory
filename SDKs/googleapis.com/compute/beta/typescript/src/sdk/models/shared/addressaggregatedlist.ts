...
import { AddressesScopedList } from "./addressesscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum AddressAggregatedListWarningCodeEnum {
...
export class AddressAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AddressAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: AddressAggregatedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: AddressAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => AddressAggregatedListWarningData)
  data?: AddressAggregatedListWarningData[];
 ...
 * Successful response
 */
export class AddressAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: AddressesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, AddressesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], AddressesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
