...
export class ContentRegionsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentRegionsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentRegionsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
