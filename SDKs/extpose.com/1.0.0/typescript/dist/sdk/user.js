...
var User = /** @class */ (function () {
    ...
    **/
    User.prototype.getUserExtensions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetUserExtensionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/user-extensions";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.extensions = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
