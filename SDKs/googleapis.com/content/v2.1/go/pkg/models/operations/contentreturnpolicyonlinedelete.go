...
type ContentReturnpolicyonlineDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentReturnpolicyonlineDeletePathParams struct {
...
type ContentReturnpolicyonlineDeleteQueryParams struct {
	// V1 error format.
...
type ContentReturnpolicyonlineDeleteRequest struct {
...
type ContentReturnpolicyonlineDeleteResponse struct {
	ContentType string
	StatusCode  int
