...
class ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsListRequest:
    ...
    r"""The name of the parent resource whose versions will be listed."""  
    ...
    r"""Optional. The field to order the results by."""  
    page_size: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'pageSize', 'style': 'form', 'explode': True }})
    r"""The maximum number of versions to return. Maximum page size is 1,000."""  
