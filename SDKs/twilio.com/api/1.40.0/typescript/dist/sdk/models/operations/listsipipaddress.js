...
exports.ListSipIpAddressResponse = exports.ListSipIpAddressListSipIpAddressResponse = exports.ListSipIpAddressRequest = exports.ListSipIpAddressSecurity = exports.ListSipIpAddressServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSipIpAddressServerList = ["https://api.twilio.com"];
var ListSipIpAddressSecurity = /** @class */ (function (_super) {
    ...
    ], ListSipIpAddressSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSipIpAddressSecurity.prototype, "username", void 0);
    return ListSipIpAddressSecurity;
}(utils_1.SpeakeasyBase));
exports.ListSipIpAddressSecurity = ListSipIpAddressSecurity;
var ListSipIpAddressRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSipIpAddressRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=IpAccessControlListSid",
        }),
        __metadata("design:type", String)
    ], ListSipIpAddressRequest.prototype, "ipAccessControlListSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSipIpAddressRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSipIpAddressRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSipIpAddressRequest.prototype, "pageToken", void 0);
    return ListSipIpAddressRequest;
}(utils_1.SpeakeasyBase));
exports.ListSipIpAddressRequest = ListSipIpAddressRequest;
/**
 * OK
 */
var ListSipIpAddressListSipIpAddressResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountSipSipIpAccessControlListSipIpAddress; }),
...
exports.ListSipIpAddressListSipIpAddressResponse = ListSipIpAddressListSipIpAddressResponse;
var ListSipIpAddressResponse = /** @class */ (function (_super) {
    ...
    ], ListSipIpAddressResponse.prototype, "rawResponse", void 0);
    return ListSipIpAddressResponse;
}(utils_1.SpeakeasyBase));
exports.ListSipIpAddressResponse = ListSipIpAddressResponse;
