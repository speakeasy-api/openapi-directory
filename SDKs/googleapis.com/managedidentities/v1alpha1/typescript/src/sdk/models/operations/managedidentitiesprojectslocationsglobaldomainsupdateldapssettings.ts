...
export class ManagedidentitiesProjectsLocationsGlobalDomainsUpdateLdapssettingsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalDomainsUpdateLdapssettingsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManagedidentitiesProjectsLocationsGlobalDomainsUpdateLdapssettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
