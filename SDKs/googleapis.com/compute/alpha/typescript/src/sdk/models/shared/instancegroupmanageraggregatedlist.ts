 ...
 */
export enum InstanceGroupManagerAggregatedListWarningCodeEnum {
...
export class InstanceGroupManagerAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupManagerAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
 ...
 * Successful response
 */
export class InstanceGroupManagerAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceGroupManagersScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, InstanceGroupManagersScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], InstanceGroupManagersScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
