...
class GetListInstanceProfilesForRoleQueryParams:
    action: GetListInstanceProfilesForRoleActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetListInstanceProfilesForRoleVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListInstanceProfilesForRoleRequest:
    headers: GetListInstanceProfilesForRoleHeaders = dataclasses.field()
    query_params: GetListInstanceProfilesForRoleQueryParams = dataclasses.field()
