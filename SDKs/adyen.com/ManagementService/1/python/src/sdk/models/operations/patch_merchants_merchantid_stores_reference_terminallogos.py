...
class PatchMerchantsMerchantIDStoresReferenceTerminalLogosSecurity:
...
class PatchMerchantsMerchantIDStoresReferenceTerminalLogosRequest:
    ...
    r"""The reference that identifies the store."""  
    logo: Optional[shared_logo.Logo] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class PatchMerchantsMerchantIDStoresReferenceTerminalLogosResponse:
