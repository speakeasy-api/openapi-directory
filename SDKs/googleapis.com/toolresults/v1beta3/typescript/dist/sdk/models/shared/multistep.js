...
var MultiStep = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "primaryStep" }),
        (0, class_transformer_1.Type)(function () { return primarystep_1.PrimaryStep; }),
        __metadata("design:type", primarystep_1.PrimaryStep)
    ], MultiStep.prototype, "primaryStep", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "primaryStepId" }),
