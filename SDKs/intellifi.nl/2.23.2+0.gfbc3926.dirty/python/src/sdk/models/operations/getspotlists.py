...
class GetSpotListsRequest:
    ...
    r"""Filter based on the total amount of spots in the list"""  
...
class GetSpotLists200ApplicationJSON:
    r"""A JSON object containing a list of spot lists"""
    ...
    results: Optional[list[shared_spotlist.SpotList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
