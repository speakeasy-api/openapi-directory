...
public class PresetsUserMetadataInteractionsAddPrivacyUser {
    /**
    ...
    public PresetsUserMetadataInteractionsAddPrivacyUser withOptions(String[] options) {
    ...
    @JsonProperty("uri")
    public String uri;
    public PresetsUserMetadataInteractionsAddPrivacyUser withUri(String uri) {
        this.uri = uri;
        return this;
    }
