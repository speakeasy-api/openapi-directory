...
export class Actions {
  ...
  **/
  actionPosTamend(
    req: operations.ActionPosTamendRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTamendResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTamendRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/amend";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.ActionPosTamendResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.proxyActionamendResponse = httpRes?.data;
            }
            break;
  ...
  **/
  actionPosTcreate(
    req: operations.ActionPosTcreateRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTcreateResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTcreateRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/create";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTcreateResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.saveResults = httpRes?.data;
            }
            break;
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
  ...
  **/
  actionPosTdelete(
    req: operations.ActionPosTdeleteRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTdeleteResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTdeleteRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/delete";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTdeleteResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.deleteResults = httpRes?.data;
            }
            break;
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
  ...
  **/
  actionPosTexecute(
    req: operations.ActionPosTexecuteRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTexecuteResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTexecuteRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/execute";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTexecuteResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.executeResults = httpRes?.data;
            }
            break;
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
  ...
  **/
  actionPosTgenerate(
    req: operations.ActionPosTgenerateRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTgenerateResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTgenerateRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/generate";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTgenerateResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.saveResults = httpRes?.data;
  ...
  **/
  actionPosTquery(
    req: operations.ActionPosTqueryRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTqueryResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTqueryRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/query";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTqueryResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.proxyActionqueryResponse = httpRes?.data;
            }
            break;
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
  ...
  **/
  actionPosTqueryMore(
    req: operations.ActionPosTqueryMoreRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTqueryMoreResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTqueryMoreRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/queryMore";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTqueryMoreResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.proxyActionqueryMoreResponse = httpRes?.data;
            }
            break;
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
  ...
  **/
  actionPosTsubscribe(
    req: operations.ActionPosTsubscribeRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTsubscribeResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTsubscribeRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/subscribe";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTsubscribeResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.subscribeResults = httpRes?.data;
            }
            break;
          case httpRes?.status == 401:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
  ...
  **/
  actionPosTupdate(
    req: operations.ActionPosTupdateRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ActionPosTupdateResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ActionPosTupdateRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/action/update";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ActionPosTupdateResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json; charset=utf-8`)) {
                res.saveResults = httpRes?.data;
