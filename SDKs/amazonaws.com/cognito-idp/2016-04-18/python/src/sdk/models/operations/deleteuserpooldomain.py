...
class DeleteUserPoolDomainRequest:
    ...
    delete_user_pool_domain_request: shared_deleteuserpooldomainrequest.DeleteUserPoolDomainRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
