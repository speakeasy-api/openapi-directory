...
class CreateFunctionRequestBody:
    ...
    r"""The <code>Function</code> name. The function name does not have to be unique."""  
    ...
    r"""The <code>Function</code> response mapping template."""  
    runtime: Optional[CreateFunctionRequestBodyRuntime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('runtime'), 'exclude': lambda f: f is None }})
    r"""Describes a runtime used by an Amazon Web Services AppSync pipeline resolver or Amazon Web Services AppSync function. Specifies the name and version of the runtime to use. Note that if a runtime is specified, code must also be specified."""  
    sync_config: Optional[CreateFunctionRequestBodySyncConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('syncConfig'), 'exclude': lambda f: f is None }})
    r"""<p>Describes a Sync configuration for a resolver.</p> <p>Specifies which Conflict Detection strategy and Resolution strategy to use when the resolver is invoked.</p>"""  
