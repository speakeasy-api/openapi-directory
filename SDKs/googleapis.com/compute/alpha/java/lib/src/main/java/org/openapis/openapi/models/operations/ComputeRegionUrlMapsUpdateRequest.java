...
public class ComputeRegionUrlMapsUpdateRequest {
    ...
    public ComputeRegionUrlMapsUpdateRequest(@JsonProperty("project") String project, @JsonProperty("region") String region, @JsonProperty("urlMapPathParameter") String urlMapPathParameter) {
        this.project = project;
        this.region = region;
        this.urlMapPathParameter = urlMapPathParameter;
  }
