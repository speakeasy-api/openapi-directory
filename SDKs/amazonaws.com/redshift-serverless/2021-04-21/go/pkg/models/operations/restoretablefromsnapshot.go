...
type RestoreTableFromSnapshotHeaders struct {
...
type RestoreTableFromSnapshotRequest struct {
	Headers RestoreTableFromSnapshotHeaders
	Request shared.RestoreTableFromSnapshotRequest `request:"mediaType=application/json"`
}
