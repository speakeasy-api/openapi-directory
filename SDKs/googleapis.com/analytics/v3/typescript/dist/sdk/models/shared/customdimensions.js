...
**/
var CustomDimensions = /** @class */ (function (_super) {
    __extends(CustomDimensions, _super);
    function CustomDimensions() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=items", elemType: customdimension_1.CustomDimension }),
        __metadata("design:type", Array)
    ], CustomDimensions.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=itemsPerPage" }),
        __metadata("design:type", Number)
    ], CustomDimensions.prototype, "itemsPerPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=kind" }),
        __metadata("design:type", String)
    ], CustomDimensions.prototype, "kind", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nextLink" }),
        __metadata("design:type", String)
    ], CustomDimensions.prototype, "nextLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=previousLink" }),
        __metadata("design:type", String)
    ], CustomDimensions.prototype, "previousLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startIndex" }),
        __metadata("design:type", Number)
    ], CustomDimensions.prototype, "startIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalResults" }),
        __metadata("design:type", Number)
    ], CustomDimensions.prototype, "totalResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=username" }),
        __metadata("design:type", String)
    ], CustomDimensions.prototype, "username", void 0);
