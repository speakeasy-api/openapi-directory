...
public class Person {
    ...
    public org.openapis.openapi.models.operations.GetPeopleResponse getPeople(org.openapis.openapi.models.operations.GetPeopleRequest request, org.openapis.openapi.models.operations.GetPeopleSecurity security) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/vnd.api+json")) {
                ...
                org.openapis.openapi.models.operations.GetPeople200ApplicationVndApiPlusJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetPeople200ApplicationVndApiPlusJson.class);
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/vnd.api+json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetPeople400ApplicationVndApiPlusJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetPeople400ApplicationVndApiPlusJson.class);
    ...
    public org.openapis.openapi.models.operations.GetPeopleIdResponse getPeopleId(org.openapis.openapi.models.operations.GetPeopleIdRequest request, org.openapis.openapi.models.operations.GetPeopleIdSecurity security) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/vnd.api+json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetPeopleId200ApplicationVndApiPlusJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetPeopleId200ApplicationVndApiPlusJson.class);
