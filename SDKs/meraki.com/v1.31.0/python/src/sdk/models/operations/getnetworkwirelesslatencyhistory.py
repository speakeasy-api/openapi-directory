...
class GetNetworkWirelessLatencyHistory200ApplicationJSON:
    ...
    avg_latency_ms: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('avgLatencyMs'), 'exclude': lambda f: f is None }})
    r"""Average latency in milliseconds"""  
...
class GetNetworkWirelessLatencyHistoryResponse:
    ...
    get_network_wireless_latency_history_200_application_json_objects: Optional[list[GetNetworkWirelessLatencyHistory200ApplicationJSON]] = dataclasses.field(default=None)
