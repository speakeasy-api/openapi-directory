...
export declare class CreateInternationalScheduledPaymentsJsonSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateInternationalScheduledPaymentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalScheduledPaymentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
