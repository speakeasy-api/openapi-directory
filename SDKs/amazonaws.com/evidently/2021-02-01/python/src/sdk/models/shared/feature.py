...
from ..shared import variation as shared_variation
from ..shared import variationvaluetype_enum as shared_variationvaluetype_enum
...
class Feature:
    ...
    value_type: shared_variationvaluetype_enum.VariationValueTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('valueType') }})  
    variations: list[shared_variation.Variation] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('variations') }})  
