...
type StartDevEnvironmentPathParams struct {
...
type StartDevEnvironmentRequest struct {
	PathParams StartDevEnvironmentPathParams
	Request    StartDevEnvironmentRequestBody `request:"mediaType=application/json"`
}
