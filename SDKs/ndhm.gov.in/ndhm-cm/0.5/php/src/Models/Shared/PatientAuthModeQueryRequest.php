...
class PatientAuthModeQueryRequest
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PatientAuthModeQueryRequestQuery')]
	...
	{
		$this->query = new \OpenAPI\OpenAPI\Models\Shared\PatientAuthModeQueryRequestQuery();
		$this->requestId = "";
