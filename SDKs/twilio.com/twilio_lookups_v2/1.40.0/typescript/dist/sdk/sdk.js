 ...
 */
exports.ServerList = ["https://lookups.twilio.com"];
/**
...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.fetchPhoneNumber = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/PhoneNumbers/{PhoneNumber}", req);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.lookupsV2PhoneNumber = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.LookupsV2PhoneNumber);
                    }
                    break;
            }
            return res;
