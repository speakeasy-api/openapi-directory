...
import dataclasses
from ..shared import googleclouddialogflowv2messageannotation as shared_googleclouddialogflowv2messageannotation
...
class GoogleCloudDialogflowV2Message:
    ...
    message_annotation: Optional[shared_googleclouddialogflowv2messageannotation.GoogleCloudDialogflowV2MessageAnnotation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messageAnnotation'), 'exclude': lambda f: f is None }})
    ...
    participant_role: Optional[GoogleCloudDialogflowV2MessageParticipantRoleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participantRole'), 'exclude': lambda f: f is None }})
    r"""Output only. The role of the participant."""  
    ...
    sentiment_analysis: Optional[shared_googleclouddialogflowv2sentimentanalysisresult.GoogleCloudDialogflowV2SentimentAnalysisResult] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sentimentAnalysis'), 'exclude': lambda f: f is None }})
