 ...
 */
public enum AccountSettings200ApplicationXMLAccountSettingsRecordingArchiveTypeEnum {
    ONE("1"),
    TWO("2"),
    THREE("3");
    ...
    private AccountSettings200ApplicationXMLAccountSettingsRecordingArchiveTypeEnum(String value) {
        this.value = value;
    }
}
