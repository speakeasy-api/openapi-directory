...
from ..shared import changenodecommentrequest as shared_changenodecommentrequest
from ..shared import comment as shared_comment
from ..shared import errorresponse as shared_errorresponse
from enum import Enum
from typing import Optional

class UpdateNodeCommentXSdsDateFormatEnum(str, Enum):
...
class UpdateNodeCommentRequest:
    ...
    change_node_comment_request: shared_changenodecommentrequest.ChangeNodeCommentRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    ...
    x_sds_date_format: Optional[UpdateNodeCommentXSdsDateFormatEnum] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-Sds-Date-Format', 'style': 'simple', 'explode': False }})
    r"""Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))"""  
