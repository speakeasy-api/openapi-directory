...
exports.AggregationResultBatch = exports.AggregationResultBatchMoreResultsEnum = void 0;
var utils_1 = require("../../../internal/utils");
var aggregationresult_1 = require("./aggregationresult");
var class_transformer_1 = require("class-transformer");
/**
 * The state of the query after the current batch. Only COUNT(*) aggregations are supported in the initial launch. Therefore, expected result type is limited to `NO_MORE_RESULTS`.
 */
var AggregationResultBatchMoreResultsEnum;
...
})(AggregationResultBatchMoreResultsEnum = exports.AggregationResultBatchMoreResultsEnum || (exports.AggregationResultBatchMoreResultsEnum = {}));
/**
...
var AggregationResultBatch = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: aggregationresult_1.AggregationResult }),
        (0, class_transformer_1.Expose)({ name: "aggregationResults" }),
        (0, class_transformer_1.Type)(function () { return aggregationresult_1.AggregationResult; }),
...
exports.AggregationResultBatch = AggregationResultBatch;
