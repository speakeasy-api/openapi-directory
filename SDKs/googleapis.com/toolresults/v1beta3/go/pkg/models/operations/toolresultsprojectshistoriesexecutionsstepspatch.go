...
type ToolresultsProjectsHistoriesExecutionsStepsPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ToolresultsProjectsHistoriesExecutionsStepsPatchPathParams struct {
...
type ToolresultsProjectsHistoriesExecutionsStepsPatchQueryParams struct {
	// V1 error format.
...
type ToolresultsProjectsHistoriesExecutionsStepsPatchRequest struct {
	...
	Request     *shared.Step `request:"mediaType=application/json"`
	Security    ToolresultsProjectsHistoriesExecutionsStepsPatchSecurity
}

type ToolresultsProjectsHistoriesExecutionsStepsPatchResponse struct {
	ContentType string
	StatusCode  int
