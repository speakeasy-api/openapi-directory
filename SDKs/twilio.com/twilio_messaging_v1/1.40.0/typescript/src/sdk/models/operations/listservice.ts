...
export const ListServiceServerList = ["https://messaging.twilio.com"] as const;
...
export class ListServiceListServiceResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.MessagingV1Service })
  @Expose({ name: "services" })
  @Type(() => shared.MessagingV1Service)
