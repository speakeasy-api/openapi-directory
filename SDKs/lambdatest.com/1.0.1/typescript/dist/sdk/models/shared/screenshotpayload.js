...
var ScreenshotPayloadConfigs = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "macos mojave" }),
        (0, class_transformer_1.Type)(function () { return browsers_1.Browsers; }),
        __metadata("design:type", browsers_1.Browsers)
    ], ScreenshotPayloadConfigs.prototype, "macosMojave", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "windows 10" }),
        (0, class_transformer_1.Type)(function () { return browsers_1.Browsers; }),
        __metadata("design:type", browsers_1.Browsers)
...
var ScreenshotPayload = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ScreenshotPayloadConfigs; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tunnel" }),
        __metadata("design:type", Boolean)
    ], ScreenshotPayload.prototype, "tunnel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tunnel_identifier" }),
        __metadata("design:type", String)
