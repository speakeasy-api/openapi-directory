...
exports.ReportByCategoryRequest = void 0;
...
**/
var ReportByCategoryRequest = /** @class */ (function (_super) {
    __extends(ReportByCategoryRequest, _super);
    function ReportByCategoryRequest() {
    ...
    ], ReportByCategoryRequest.prototype, "advancedFilters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=beginPeriodUtcDate" }),
        __metadata("design:type", Date)
    ], ReportByCategoryRequest.prototype, "beginPeriodUtcDate", void 0);
    __decorate([
    ...
    ], ReportByCategoryRequest.prototype, "categoryFilter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=channelId" }),
        __metadata("design:type", String)
    ], ReportByCategoryRequest.prototype, "channelId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=endPeriodUtcDate" }),
        __metadata("design:type", Date)
    ], ReportByCategoryRequest.prototype, "endPeriodUtcDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=orderBy" }),
        __metadata("design:type", String)
    ], ReportByCategoryRequest.prototype, "orderBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=orderByDirection" }),
        __metadata("design:type", String)
    ], ReportByCategoryRequest.prototype, "orderByDirection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pageNumber" }),
        __metadata("design:type", Number)
    ], ReportByCategoryRequest.prototype, "pageNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pageSize" }),
        __metadata("design:type", Number)
    ], ReportByCategoryRequest.prototype, "pageSize", void 0);
    __decorate([
    ...
    ], ReportByCategoryRequest.prototype, "performanceIndicatorFilters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=periodType" }),
        __metadata("design:type", String)
    ], ReportByCategoryRequest.prototype, "periodType", void 0);
    return ReportByCategoryRequest;
}(utils_1.SpeakeasyBase));
exports.ReportByCategoryRequest = ReportByCategoryRequest;
