...
var ProductFeatures = /** @class */ (function () {
    function ProductFeatures(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ProductFeatures.prototype.objectDeleteProductFeature = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectDeleteProductFeatureRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/object/product-feature/{id}", req.pathParams);
    ...
    **/
    ProductFeatures.prototype.objectGetProductFeature = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetProductFeature = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
