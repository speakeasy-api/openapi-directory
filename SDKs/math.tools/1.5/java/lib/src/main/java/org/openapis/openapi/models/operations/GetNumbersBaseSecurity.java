...
public class GetNumbersBaseSecurity {
    ...
    public GetNumbersBaseSecurity withXMathtoolsApiSecret(String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
        return this;
    }
    
    public GetNumbersBaseSecurity(@JsonProperty("X-Mathtools-Api-Secret") String xMathtoolsApiSecret) {
        this.xMathtoolsApiSecret = xMathtoolsApiSecret;
  }
}
