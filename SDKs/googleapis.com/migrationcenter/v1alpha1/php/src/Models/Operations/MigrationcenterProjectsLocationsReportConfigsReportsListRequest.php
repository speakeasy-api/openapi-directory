...
class MigrationcenterProjectsLocationsReportConfigsReportsListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MigrationcenterProjectsLocationsReportConfigsReportsListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?MigrationcenterProjectsLocationsReportConfigsReportsListViewEnum $view = null;
