        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 415:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.teamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TeamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSON);
                    }
                    break;
    ...
    Teams.prototype.teamsCheckPermissionsForProjectLegacy = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 415:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.teamsCheckPermissionsForProjectLegacy415ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TeamsCheckPermissionsForProjectLegacy415ApplicationJSON);
                    }
                    break;
            }
            return res;
    ...
    Teams.prototype.teamsListProjectsLegacy = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 415:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.teamsListProjectsLegacy415ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TeamsListProjectsLegacy415ApplicationJSON);
                    }
                    break;
            }
            return res;
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 415:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.teamsRemoveProjectLegacy415ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.TeamsRemoveProjectLegacy415ApplicationJSON);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 422:
                    if (utils.matchContentType(contentType, "application/json")) {
