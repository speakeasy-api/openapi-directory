...
class GetSigningCertificateRequest:
    ...
    get_signing_certificate_request: shared_getsigningcertificaterequest.GetSigningCertificateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
