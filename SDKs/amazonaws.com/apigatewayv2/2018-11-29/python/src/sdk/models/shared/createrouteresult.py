...
class CreateRouteResultAuthorizationTypeEnum(str, Enum):
...
class CreateRouteResult:
    ...
    authorization_type: Optional[CreateRouteResultAuthorizationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorizationType'), 'exclude': lambda f: f is None }})  
