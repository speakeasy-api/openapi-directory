...
from ..shared import describemediastorageconfigurationoutput as shared_describemediastorageconfigurationoutput
...
class DescribeMediaStorageConfigurationRequest:
    ...
    request_body: DescribeMediaStorageConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class DescribeMediaStorageConfigurationResponse:
    ...
    describe_media_storage_configuration_output: Optional[shared_describemediastorageconfigurationoutput.DescribeMediaStorageConfigurationOutput] = dataclasses.field(default=None)
    r"""Success"""  
