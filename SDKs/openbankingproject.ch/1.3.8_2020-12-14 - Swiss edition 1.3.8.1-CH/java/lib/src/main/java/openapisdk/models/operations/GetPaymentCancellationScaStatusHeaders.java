...
public class GetPaymentCancellationScaStatusHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Digest")
    public String digest;
    public GetPaymentCancellationScaStatusHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-Accept")
    public String psuAccept;
    public GetPaymentCancellationScaStatusHeaders withPsuAccept(String psuAccept) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuAcceptCharset(String psuAcceptCharset) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuDeviceId(String psuDeviceID) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuGeoLocation(String psuGeoLocation) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuHttpMethod(openapisdk.models.shared.PsuHttpMethodEnum psuHttpMethod) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuIpAddress(String psuIPAddress) {
        this.psuIPAddress = psuIPAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-IP-Port")
    public String psuIPPort;
    public GetPaymentCancellationScaStatusHeaders withPsuIpPort(String psuIPPort) {
    ...
    public GetPaymentCancellationScaStatusHeaders withPsuUserAgent(String psuUserAgent) {
        this.psuUserAgent = psuUserAgent;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Signature")
    public String signature;
    public GetPaymentCancellationScaStatusHeaders withSignature(String signature) {
    ...
    public GetPaymentCancellationScaStatusHeaders withTppSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetPaymentCancellationScaStatusHeaders withXRequestId(String xRequestID) {
