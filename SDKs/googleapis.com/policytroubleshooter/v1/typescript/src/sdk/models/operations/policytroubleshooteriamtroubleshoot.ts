...
export class PolicytroubleshooterIamTroubleshootSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PolicytroubleshooterIamTroubleshootRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PolicytroubleshooterIamTroubleshootResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
