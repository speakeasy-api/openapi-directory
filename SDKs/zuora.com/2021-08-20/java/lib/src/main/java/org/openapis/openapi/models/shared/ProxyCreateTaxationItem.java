...
public class ProxyCreateTaxationItem {
    ...
    public ProxyCreateTaxationItem withAccountingCode(String accountingCode) {
    ...
    public ProxyCreateTaxationItem withExemptAmount(Double exemptAmount) {
    ...
    public ProxyCreateTaxationItem withInvoiceItemId(String invoiceItemId) {
    ...
    public ProxyCreateTaxationItem withJurisdiction(String jurisdiction) {
    ...
    public ProxyCreateTaxationItem withLocationCode(String locationCode) {
    ...
    @JsonProperty("Name")
    public String name;
    public ProxyCreateTaxationItem withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ProxyCreateTaxationItem withTaxAmount(Double taxAmount) {
    ...
    public ProxyCreateTaxationItem withTaxCode(String taxCode) {
    ...
    public ProxyCreateTaxationItem withTaxCodeDescription(String taxCodeDescription) {
    ...
    public ProxyCreateTaxationItem withTaxDate(LocalDate taxDate) {
    ...
    public ProxyCreateTaxationItem withTaxRate(Double taxRate) {
    ...
    public ProxyCreateTaxationItem withTaxRateDescription(String taxRateDescription) {
    ...
    public ProxyCreateTaxationItem withTaxRateType(String taxRateType) {
