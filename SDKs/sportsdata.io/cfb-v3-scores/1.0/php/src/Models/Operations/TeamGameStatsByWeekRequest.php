...
class TeamGameStatsByWeekRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\TeamGameStatsByWeekFormatEnum $format
     */
	...
	{
		$this->format = \OpenAPI\OpenAPI\Models\Operations\TeamGameStatsByWeekFormatEnum::XML;
		$this->season = "";
		$this->week = "";
	}
}
