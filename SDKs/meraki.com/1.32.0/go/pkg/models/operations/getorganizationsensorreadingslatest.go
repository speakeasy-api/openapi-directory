...
func (e GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsButtonPressTypeEnum) ToPointer() *GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsButtonPressTypeEnum {
	return &e
}
...
func (e *GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsButtonPressTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "long":
		fallthrough
	case "short":
		*e = GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsButtonPressTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsButtonPressTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsMetricEnum) ToPointer() *GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsMetricEnum {
	return &e
}
...
func (e *GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsMetricEnum) UnmarshalJSON(data []byte) error {
	...
	case "tvoc":
		fallthrough
	case "water":
		*e = GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsMetricEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationSensorReadingsLatest200ApplicationJSONReadingsMetricEnum: %v", v)
	}
}
