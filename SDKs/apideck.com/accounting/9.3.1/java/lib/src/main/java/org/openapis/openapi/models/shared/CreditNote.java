...
public class CreditNote {
    ...
    public CreditNoteAllocations[] allocations;

    public CreditNote withAllocations(CreditNoteAllocations[] allocations) {
    ...
    public CreditNote withCurrency(CurrencyEnum currency) {
    ...
    public CreditNote withLineItems(InvoiceLineItem[] lineItems) {
    ...
    public CreditNote withStatus(CreditNoteCreditNoteStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public CreditNote withType(CreditNoteCreditNoteTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public CreditNote(@JsonProperty("id") String id, @JsonProperty("total_amount") Double totalAmount) {
        this.id = id;
        this.totalAmount = totalAmount;
  }
}
