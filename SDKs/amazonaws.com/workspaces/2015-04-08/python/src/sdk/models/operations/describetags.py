...
from ..shared import describetagsresult as shared_describetagsresult
...
class DescribeTagsResponse:
    ...
    describe_tags_result: Optional[shared_describetagsresult.DescribeTagsResult] = dataclasses.field(default=None)
