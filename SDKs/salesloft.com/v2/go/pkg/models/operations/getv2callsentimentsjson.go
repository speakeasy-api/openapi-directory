...
type GetV2CallSentimentsJSONQueryParams struct {
...
type GetV2CallSentimentsJSONRequest struct {
	QueryParams GetV2CallSentimentsJSONQueryParams
}

type GetV2CallSentimentsJSONResponse struct {
	Body        []byte
	ContentType string
	StatusCode  int
