...
public class ContainerProjectsZonesClustersGetPathParams {
    /**
    ...
    public ContainerProjectsZonesClustersGetPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersGetPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersGetPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
