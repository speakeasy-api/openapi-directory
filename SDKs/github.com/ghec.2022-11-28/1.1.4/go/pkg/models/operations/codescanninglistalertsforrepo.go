...
func (e CodeScanningListAlertsForRepoSortEnum) ToPointer() *CodeScanningListAlertsForRepoSortEnum {
	return &e
}
...
func (e *CodeScanningListAlertsForRepoSortEnum) UnmarshalJSON(data []byte) error {
	...
	case "created":
		fallthrough
	case "updated":
		*e = CodeScanningListAlertsForRepoSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CodeScanningListAlertsForRepoSortEnum: %v", v)
	}
}
