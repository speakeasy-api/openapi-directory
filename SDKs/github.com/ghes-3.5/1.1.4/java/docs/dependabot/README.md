...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotAddSelectedRepoToOrgSecretRequest req = new DependabotAddSelectedRepoToOrgSecretRequest("culpa", 731398L, "adipisci");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotDeleteOrgSecretRequest req = new DependabotDeleteOrgSecretRequest("a", "error");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotDeleteRepoSecretRequest req = new DependabotDeleteRepoSecretRequest("sint", "pariatur", "possimus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetOrgPublicKeyRequest req = new DependabotGetOrgPublicKeyRequest("quia");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetOrgSecretRequest req = new DependabotGetOrgSecretRequest("eveniet", "asperiores");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetRepoPublicKeyRequest req = new DependabotGetRepoPublicKeyRequest("facere", "veritatis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetRepoSecretRequest req = new DependabotGetRepoSecretRequest("consequuntur", "quasi", "similique");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotListOrgSecretsRequest req = new DependabotListOrgSecretsRequest("culpa") {{
                page = 398434L;
                perPage = 949298L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotListRepoSecretsRequest req = new DependabotListRepoSecretsRequest("quae", "earum") {{
                page = 424032L;
                perPage = 447378L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotListSelectedReposForOrgSecretRequest req = new DependabotListSelectedReposForOrgSecretRequest("eius", "libero") {{
                page = 849039L;
                perPage = 742238L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotRemoveSelectedRepoFromOrgSecretRequest req = new DependabotRemoveSelectedRepoFromOrgSecretRequest("accusantium", 306986L, "sapiente");            
