...
exports.MirrorTimelineAttachmentsInsertResponse = exports.MirrorTimelineAttachmentsInsertRequest = exports.MirrorTimelineAttachmentsInsertSecurity = void 0;
...
var MirrorTimelineAttachmentsInsertRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=itemId",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "itemId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], MirrorTimelineAttachmentsInsertRequest.prototype, "userIp", void 0);
...
var MirrorTimelineAttachmentsInsertResponse = /** @class */ (function (_super) {
    ...
    ], MirrorTimelineAttachmentsInsertResponse.prototype, "rawResponse", void 0);
