...
// to the apex domain.
func (s *Domains) CreateDomain(ctx context.Context, request operations.CreateDomainRequest) (*operations.CreateDomainResponse, error) {
...
func (s *Domains) ListAllDomains(ctx context.Context) (*operations.ListAllDomainsResponseOutput, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v2/domains"
	...
	res := &operations.ListAllDomainsResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.ListAllDomains200ApplicationJSONOutput
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
