...
class ListBindingListBindingResponse:
    bindings: Optional[list[shared_chat_v2_service_binding.ChatV2ServiceBinding]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bindings') }})
