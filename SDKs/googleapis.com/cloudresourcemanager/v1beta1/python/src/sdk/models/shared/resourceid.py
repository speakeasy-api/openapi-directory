...
class ResourceID:
    ...
    r"""Required field for the type-specific id. This should correspond to the id used in the type-specific API's."""  
    type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Required field representing the resource type this id is for. At present, the valid types are \\"project\\", \\"folder\\", and \\"organization\\"."""  
