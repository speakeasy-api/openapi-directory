...
exports.PutCustomFieldsIdJsonResponse = exports.PutCustomFieldsIdJsonRequest = void 0;
...
var PutCustomFieldsIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutCustomFieldsIdJsonRequest.prototype, "customFieldEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutCustomFieldsIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutCustomFieldsIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutCustomFieldsIdJsonRequest.prototype, "login", void 0);
    return PutCustomFieldsIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutCustomFieldsIdJsonRequest = PutCustomFieldsIdJsonRequest;
var PutCustomFieldsIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutCustomFieldsIdJsonResponse.prototype, "rawResponse", void 0);
    return PutCustomFieldsIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PutCustomFieldsIdJsonResponse = PutCustomFieldsIdJsonResponse;
