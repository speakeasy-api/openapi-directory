...
from ..shared import scim_enterprise_user_list as shared_scim_enterprise_user_list
...
class EnterpriseAdminListProvisionedIdentitiesEnterpriseRequest:
    ...
    r"""If specified, only results that match the specified filter will be returned. Multiple filters are not supported. Possible filters are `userName`, `externalId`, `id`, and `displayName`. For example, `?filter=\\"externalId eq '9138790-10932-109120392-12321'\\"`."""  
...
class EnterpriseAdminListProvisionedIdentitiesEnterpriseResponse:
    ...
    scim_enterprise_user_list: Optional[shared_scim_enterprise_user_list.ScimEnterpriseUserList] = dataclasses.field(default=None)
