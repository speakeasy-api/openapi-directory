...
export class PostV2PeopleJsonRequestBody extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ data: "form, name=autotag_date" })
  autotagDate?: boolean;
...
export class PostV2PeopleJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
