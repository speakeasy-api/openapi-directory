...
export class NetworkconnectivityProjectsLocationsSpokesDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkconnectivityProjectsLocationsSpokesDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworkconnectivityProjectsLocationsSpokesDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
