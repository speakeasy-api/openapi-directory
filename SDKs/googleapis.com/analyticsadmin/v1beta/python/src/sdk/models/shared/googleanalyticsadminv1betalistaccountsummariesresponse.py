...
class GoogleAnalyticsAdminV1betaListAccountSummariesResponse:
    ...
    account_summaries: Optional[list[shared_googleanalyticsadminv1betaaccountsummary.GoogleAnalyticsAdminV1betaAccountSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accountSummaries'), 'exclude': lambda f: f is None }})
