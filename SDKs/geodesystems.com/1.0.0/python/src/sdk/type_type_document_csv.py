...
class TypeTypeDocumentCsv:
    ...
    def search_type_document_csv(self, request: operations.SearchTypeDocumentCsvRequest) -> operations.SearchTypeDocumentCsvResponse:
        ...
        query_params = utils.get_query_params(operations.SearchTypeDocumentCsvRequest, request)
        ...
        res = operations.SearchTypeDocumentCsvResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
