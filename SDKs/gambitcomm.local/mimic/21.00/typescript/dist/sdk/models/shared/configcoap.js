...
var ConfigCoap = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=primary_port" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=secure_port" }),
        __metadata("design:type", Number)
    ], ConfigCoap.prototype, "securePort", void 0);
    return ConfigCoap;
}(utils_1.SpeakeasyBase));
exports.ConfigCoap = ConfigCoap;
