...
class DevicesByEnergy:
    ...
    def devices_by_energy_get(self, request: operations.DevicesByEnergyGetRequest) -> operations.DevicesByEnergyGetResponse:
        ...
        query_params = utils.get_query_params(operations.DevicesByEnergyGetRequest, request)
        ...
        res = operations.DevicesByEnergyGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
