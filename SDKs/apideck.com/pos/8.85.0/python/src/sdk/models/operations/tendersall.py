...
from ..shared import gettendersresponse as shared_gettendersresponse
...
class TendersAllRequest:
    headers: TendersAllHeaders = dataclasses.field()
    query_params: TendersAllQueryParams = dataclasses.field()
    security: TendersAllSecurity = dataclasses.field()
...
class TendersAllResponse:
    ...
    get_tenders_response: Optional[shared_gettendersresponse.GetTendersResponse] = dataclasses.field(default=None)
