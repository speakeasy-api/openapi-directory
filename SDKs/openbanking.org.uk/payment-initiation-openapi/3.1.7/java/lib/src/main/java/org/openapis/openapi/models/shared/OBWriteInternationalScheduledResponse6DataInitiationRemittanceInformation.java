...
public class OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation {
    ...
    public OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation withReference(String reference) {
    ...
    public OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation withUnstructured(String unstructured) {
        this.unstructured = unstructured;
        return this;
    }
    
    public OBWriteInternationalScheduledResponse6DataInitiationRemittanceInformation(){}
}
