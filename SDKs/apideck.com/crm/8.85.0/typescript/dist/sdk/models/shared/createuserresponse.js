...
var CreateUserResponse = /** @class */ (function (_super) {
    ...
    ], CreateUserResponse.prototype, "operation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resource" }),
        __metadata("design:type", String)
    ], CreateUserResponse.prototype, "resource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=service" }),
        __metadata("design:type", String)
    ], CreateUserResponse.prototype, "service", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], CreateUserResponse.prototype, "status", void 0);
    __decorate([
