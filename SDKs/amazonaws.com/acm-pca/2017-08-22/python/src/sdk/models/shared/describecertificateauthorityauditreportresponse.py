...
class DescribeCertificateAuthorityAuditReportResponse:
    audit_report_status: Optional[shared_auditreportstatus_enum.AuditReportStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AuditReportStatus') }})
