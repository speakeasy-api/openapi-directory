...
class AndroiddeviceprovisioningPartnersDevicesClaimAsyncRequest:
    ...
    r"""JSONP"""  
    claim_devices_request: Optional[shared_claimdevicesrequest.ClaimDevicesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
