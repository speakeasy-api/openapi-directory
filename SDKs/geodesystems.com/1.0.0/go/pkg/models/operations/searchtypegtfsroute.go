...
type SearchTypeGtfsRouteQueryParams struct {
	...
	// Route ID
	SearchTypeGtfsRouteRouteID *string `queryParam:"style=form,explode=true,name=search.type_gtfs_route.route_id"`
	// Stop Names
	SearchTypeGtfsRouteStopNames *string `queryParam:"style=form,explode=true,name=search.type_gtfs_route.stop_names"`
	// Number to skip
...
type SearchTypeGtfsRouteRequest struct {
	QueryParams SearchTypeGtfsRouteQueryParams
}

type SearchTypeGtfsRouteResponse struct {
	ContentType string
	StatusCode  int
