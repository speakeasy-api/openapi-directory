...
exports.CreateAcceleratorRequest = void 0;
...
var CreateAcceleratorRequest = /** @class */ (function (_super) {
    ...
    ], CreateAcceleratorRequest.prototype, "enabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IdempotencyToken" }),
        __metadata("design:type", String)
    ], CreateAcceleratorRequest.prototype, "idempotencyToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IpAddressType" }),
        __metadata("design:type", String)
    ], CreateAcceleratorRequest.prototype, "ipAddressType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IpAddresses" }),
        __metadata("design:type", Array)
    ], CreateAcceleratorRequest.prototype, "ipAddresses", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], CreateAcceleratorRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Tags", elemType: tag_1.Tag }),
        __metadata("design:type", Array)
    ], CreateAcceleratorRequest.prototype, "tags", void 0);
