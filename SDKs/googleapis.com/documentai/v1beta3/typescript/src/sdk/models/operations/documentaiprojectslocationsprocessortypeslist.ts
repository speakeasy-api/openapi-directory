...
export class DocumentaiProjectsLocationsProcessorTypesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DocumentaiProjectsLocationsProcessorTypesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DocumentaiProjectsLocationsProcessorTypesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
