...
@dataclasses.dataclass
class CloudresourcemanagerTagValuesTestIamPermissionsQueryParams:
...
class CloudresourcemanagerTagValuesTestIamPermissionsSecurity:
    option1: Optional[CloudresourcemanagerTagValuesTestIamPermissionsSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerTagValuesTestIamPermissionsSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class CloudresourcemanagerTagValuesTestIamPermissionsRequest:
    path_params: CloudresourcemanagerTagValuesTestIamPermissionsPathParams = dataclasses.field()
    query_params: CloudresourcemanagerTagValuesTestIamPermissionsQueryParams = dataclasses.field()
    security: CloudresourcemanagerTagValuesTestIamPermissionsSecurity = dataclasses.field()
