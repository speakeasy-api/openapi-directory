...
exports.GetCustomersIdFieldsFieldIdResponse = exports.GetCustomersIdFieldsFieldIdRequest = void 0;
...
var GetCustomersIdFieldsFieldIdRequest = /** @class */ (function (_super) {
    ...
    ], GetCustomersIdFieldsFieldIdRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=field_id",
        }),
        __metadata("design:type", Number)
    ], GetCustomersIdFieldsFieldIdRequest.prototype, "fieldId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetCustomersIdFieldsFieldIdRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetCustomersIdFieldsFieldIdRequest.prototype, "login", void 0);
    return GetCustomersIdFieldsFieldIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetCustomersIdFieldsFieldIdRequest = GetCustomersIdFieldsFieldIdRequest;
var GetCustomersIdFieldsFieldIdResponse = /** @class */ (function (_super) {
    ...
    ], GetCustomersIdFieldsFieldIdResponse.prototype, "rawResponse", void 0);
    return GetCustomersIdFieldsFieldIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetCustomersIdFieldsFieldIdResponse = GetCustomersIdFieldsFieldIdResponse;
