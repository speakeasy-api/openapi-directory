...
from ..shared import associatemembertogrouprequest as shared_associatemembertogrouprequest
...
class AssociateMemberToGroupHeaders:
    x_amz_target: AssociateMemberToGroupXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateMemberToGroupRequest:
    headers: AssociateMemberToGroupHeaders = dataclasses.field()
    request: shared_associatemembertogrouprequest.AssociateMemberToGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class AssociateMemberToGroupResponse:
    ...
    associate_member_to_group_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
