...
public class CreateCredentialCreateCredentialRequest {
    ...
    public CreateCredentialCreateCredentialRequest withType(org.openapis.openapi.models.shared.CredentialEnumPushTypeEnum type) {
        this.type = type;
        return this;
    }
    
    public CreateCredentialCreateCredentialRequest(@JsonProperty("Type") org.openapis.openapi.models.shared.CredentialEnumPushTypeEnum type) {
        this.type = type;
  }
}
