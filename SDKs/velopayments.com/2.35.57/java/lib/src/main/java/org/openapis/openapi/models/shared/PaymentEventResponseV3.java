...
public class PaymentEventResponseV3 {
    ...
    public PaymentEventResponseV3(@JsonProperty("eventDateTime") OffsetDateTime eventDateTime, @JsonProperty("eventId") String eventId, @JsonProperty("eventType") String eventType) {
        this.eventDateTime = eventDateTime;
        this.eventId = eventId;
        this.eventType = eventType;
  }
