...
class GetCredentialsForIdentityRequest:
    ...
    get_credentials_for_identity_input: shared_getcredentialsforidentityinput.GetCredentialsForIdentityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class GetCredentialsForIdentityResponse:
    ...
    r"""InvalidIdentityPoolConfigurationException"""  
