...
export class NetworkconnectivityProjectsLocationsInternalRangesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkconnectivityProjectsLocationsInternalRangesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=internalRangeId",
  })
...
export class NetworkconnectivityProjectsLocationsInternalRangesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
