...
from ..shared import contacthistory as shared_contacthistory
from ..shared import errorresponse as shared_errorresponse
from typing import Optional


@dataclasses.dataclass
class GetContactHistorySecurity:
...
class GetContactHistoryResponse:
    ...
    contact_history: Optional[shared_contacthistory.ContactHistory] = dataclasses.field(default=None)
