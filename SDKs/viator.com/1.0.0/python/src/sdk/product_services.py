...
class ProductServices:
    ...
    def available_products(self, request: operations.AvailableProductsRequest) -> operations.AvailableProductsResponse:
        ...
        res = operations.AvailableProductsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AvailableProducts200ApplicationJSON])
    ...
    def product(self, request: operations.ProductRequest) -> operations.ProductResponse:
        ...
        **Videos**
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ProductRequest, request)
        ...
        res = operations.ProductResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.Product200ApplicationJSON])
    ...
    def product_photos(self, request: operations.ProductPhotosRequest) -> operations.ProductPhotosResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ProductPhotosRequest, request)
        ...
        res = operations.ProductPhotosResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.ProductPhotos200ApplicationJSON])
    ...
    def product_reviews(self, request: operations.ProductReviewsRequest) -> operations.ProductReviewsResponse:
        ...
        **Example:** \"Get the first three reviews for product `5010SYDNEY` sorted by rating in ascending order\":
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ProductReviewsRequest, request)
        ...
        res = operations.ProductReviewsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.ProductReviews200ApplicationJSON])
    ...
    def search_freetext(self, request: operations.SearchFreetextRequest) -> operations.SearchFreetextResponse:
        ...
        res = operations.SearchFreetextResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SearchFreetext200ApplicationJSON])
    ...
    def search_products(self, request: operations.SearchProductsRequest) -> operations.SearchProductsResponse:
        ...
        **&lt;u&gt;'Freesale-only' merchants&lt;/u&gt;**:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SearchProducts200ApplicationJSON])
    ...
    def search_products_codes(self, request: operations.SearchProductsCodesRequest) -> operations.SearchProductsCodesResponse:
        ...
        res = operations.SearchProductsCodesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SearchProductsCodes200ApplicationJSON])
