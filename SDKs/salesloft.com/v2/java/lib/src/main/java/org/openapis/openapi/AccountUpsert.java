...
public class AccountUpsert {
	...
	public AccountUpsert(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.PostV2AccountUpsertsJsonResponse postV2AccountUpsertsJson(org.openapis.openapi.models.operations.PostV2AccountUpsertsJsonRequestBody request) throws Exception {
        ...
        org.openapis.openapi.models.operations.PostV2AccountUpsertsJsonResponse res = new org.openapis.openapi.models.operations.PostV2AccountUpsertsJsonResponse(contentType, httpRes.statusCode()) {{
            body = null;
        }};
