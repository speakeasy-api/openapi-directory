 ...
 * @access public
 */
class InterestPaymentSimulationResultTransactionTransactionSourceCheckDepositAcceptance
{
    /**
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckDepositAcceptanceCurrencyEnum $currency
     */
	#[\JMS\Serializer\Annotation\SerializedName('currency')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckDepositAcceptanceCurrencyEnum>')]
    public InterestPaymentSimulationResultTransactionTransactionSourceCheckDepositAcceptanceCurrencyEnum $currency;
	...
	public function __construct()
	{
		...
		$this->auxiliaryOnUs = "";
		$this->checkDepositId = "";
		$this->currency = \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckDepositAcceptanceCurrencyEnum::CAD;
		$this->routingNumber = "";
		$this->serialNumber = "";
	}
}
