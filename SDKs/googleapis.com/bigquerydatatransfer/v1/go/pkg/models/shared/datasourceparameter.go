...
func (e DataSourceParameterTypeEnum) ToPointer() *DataSourceParameterTypeEnum {
	return &e
}
...
func (e *DataSourceParameterTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "RECORD":
		fallthrough
	case "PLUS_PAGE":
		*e = DataSourceParameterTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DataSourceParameterTypeEnum: %v", v)
	}
}
