...
export class Group {
  ...
  groupsAddMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GroupsAddMemberResponse =
        new operations.GroupsAddMemberResponse({
  ...
  groupsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{tenantID}/groups", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GroupsCreateResponse =
        new operations.GroupsCreateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.adGroup = utils.objectToClass(httpRes?.data);
          }
          if (utils.matchContentType(contentType, `text/json`)) {
            res.adGroup = utils.objectToClass(httpRes?.data);
          }
  ...
  groupsGetGroupMembers(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GroupsGetGroupMembersResponse =
        new operations.GroupsGetGroupMembersResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  groupsGetMemberGroups(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GroupsGetMemberGroupsResponse =
        new operations.GroupsGetMemberGroupsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.groupGetMemberGroupsResult = utils.objectToClass(
              httpRes?.data,
              shared.GroupGetMemberGroupsResult
            );
          }
          if (utils.matchContentType(contentType, `text/json`)) {
            res.groupGetMemberGroupsResult = utils.objectToClass(
  ...
  groupsIsMemberOf(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GroupsIsMemberOfResponse =
        new operations.GroupsIsMemberOfResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.checkGroupMembershipResult = utils.objectToClass(httpRes?.data);
          }
          if (utils.matchContentType(contentType, `text/json`)) {
            res.checkGroupMembershipResult = utils.objectToClass(httpRes?.data);
          }
  ...
  groupsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GroupsListResponse =
        new operations.GroupsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.groupListResult = utils.objectToClass(
              httpRes?.data,
              shared.GroupListResult
            );
          }
          if (utils.matchContentType(contentType, `text/json`)) {
            res.groupListResult = utils.objectToClass(
  ...
  groupsRemoveMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GroupsRemoveMemberResponse =
        new operations.GroupsRemoveMemberResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
