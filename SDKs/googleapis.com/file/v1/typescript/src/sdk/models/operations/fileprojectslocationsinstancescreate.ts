...
export class FileProjectsLocationsInstancesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FileProjectsLocationsInstancesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FileProjectsLocationsInstancesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
