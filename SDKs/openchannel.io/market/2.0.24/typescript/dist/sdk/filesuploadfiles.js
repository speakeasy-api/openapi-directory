...
exports.FilesUploadFiles = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var FilesUploadFiles = /** @class */ (function () {
    function FilesUploadFiles(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    FilesUploadFiles.prototype.getFiles = function (req, config) {
    ...
    **/
    FilesUploadFiles.prototype.getFilesByIdOrUrl = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFilesByIdOrUrlRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/files/byIdOrUrl";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    FilesUploadFiles.prototype.getFilesDownload = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFilesDownloadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/files/download";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
    **/
    FilesUploadFiles.prototype.postFiles = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    FilesUploadFiles.prototype.postFilesUrl = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostFilesUrlRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/files/url";
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
...
exports.FilesUploadFiles = FilesUploadFiles;
