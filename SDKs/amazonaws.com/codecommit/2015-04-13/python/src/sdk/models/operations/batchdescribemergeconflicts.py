...
class BatchDescribeMergeConflictsRequest:
    headers: BatchDescribeMergeConflictsHeaders = dataclasses.field()
    request: shared_batchdescribemergeconflictsinput.BatchDescribeMergeConflictsInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
