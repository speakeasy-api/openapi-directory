...
class CreateServiceConversationScopedWebhookRequest:
    ...
    request_body: Optional[CreateServiceConversationScopedWebhookCreateServiceConversationScopedWebhookRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
