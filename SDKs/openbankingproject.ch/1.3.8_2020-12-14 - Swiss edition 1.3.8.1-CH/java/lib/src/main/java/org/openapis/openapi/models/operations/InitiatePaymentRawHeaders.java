...
public class InitiatePaymentRawHeaders {
    /**
    ...
    public InitiatePaymentRawHeaders withConsentID(String consentID) {
    ...
    public InitiatePaymentRawHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public InitiatePaymentRawHeaders withPSUAccept(String psuAccept) {
    ...
    public InitiatePaymentRawHeaders withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public InitiatePaymentRawHeaders withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public InitiatePaymentRawHeaders withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public InitiatePaymentRawHeaders withPSUCorporateID(String psuCorporateID) {
    ...
    public InitiatePaymentRawHeaders withPSUCorporateIDType(String psuCorporateIDType) {
    ...
    public InitiatePaymentRawHeaders withPSUDeviceID(String psuDeviceID) {
    ...
    public InitiatePaymentRawHeaders withPSUGeoLocation(String psuGeoLocation) {
    ...
    public InitiatePaymentRawHeaders withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public String psuId;
    public InitiatePaymentRawHeaders withPsuId(String psuId) {
        this.psuId = psuId;
        return this;
    }
    ...
    public InitiatePaymentRawHeaders withPSUIDType(String psuIDType) {
    ...
    public InitiatePaymentRawHeaders withPSUIPAddress(String psuIPAddress) {
    ...
    public InitiatePaymentRawHeaders withPSUIPPort(String psuIPPort) {
    ...
    public InitiatePaymentRawHeaders withPSUUserAgent(String psuUserAgent) {
    ...
    public InitiatePaymentRawHeaders withSignature(String signature) {
    ...
    public InitiatePaymentRawHeaders withTPPBrandLoggingInformation(String tppBrandLoggingInformation) {
    ...
    public InitiatePaymentRawHeaders withTPPExplicitAuthorisationPreferred(Boolean tppExplicitAuthorisationPreferred) {
    ...
    public InitiatePaymentRawHeaders withTPPNokRedirectURI(String tppNokRedirectURI) {
    ...
    public InitiatePaymentRawHeaders withTPPNotificationContentPreferred(String tppNotificationContentPreferred) {
    ...
    public InitiatePaymentRawHeaders withTPPNotificationURI(String tppNotificationURI) {
    ...
    public InitiatePaymentRawHeaders withTPPRedirectPreferred(Boolean tppRedirectPreferred) {
    ...
    public InitiatePaymentRawHeaders withTPPRedirectURI(String tppRedirectURI) {
    ...
    public InitiatePaymentRawHeaders withTPPRejectionNoFundsPreferred(Boolean tppRejectionNoFundsPreferred) {
    ...
    public InitiatePaymentRawHeaders withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public InitiatePaymentRawHeaders withXRequestID(String xRequestID) {
