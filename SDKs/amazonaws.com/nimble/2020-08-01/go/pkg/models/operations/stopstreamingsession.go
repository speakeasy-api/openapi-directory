...
func (e *StopStreamingSessionRequestBodyVolumeRetentionModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "RETAIN":
		fallthrough
	case "DELETE":
		*e = StopStreamingSessionRequestBodyVolumeRetentionModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for StopStreamingSessionRequestBodyVolumeRetentionModeEnum: %s", s)
	}
}
