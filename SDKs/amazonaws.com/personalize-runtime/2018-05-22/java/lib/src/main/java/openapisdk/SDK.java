...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.GetPersonalizedRankingResponse getPersonalizedRanking(openapisdk.models.operations.GetPersonalizedRankingRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/personalize-ranking");
        ...
        openapisdk.models.operations.GetPersonalizedRankingResponse res = new openapisdk.models.operations.GetPersonalizedRankingResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetPersonalizedRankingResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetPersonalizedRankingResponse.class);
