...
class Profiles:
    r"""A view (profile) collection lists Analytics views (profiles) to which the user has access. Each resource in the collection corresponds to a single Analytics view (profile)."""
    ...
    r"""Link to next page for this view (profile) collection."""  
    ...
    r"""Link to previous page for this view (profile) collection."""  
