...
var CoachSeasons = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=postseason_rank" }),
        __metadata("design:type", Number)
    ], CoachSeasons.prototype, "postseasonRank", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=preseason_rank" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sp_defense" }),
        __metadata("design:type", Number)
    ], CoachSeasons.prototype, "spDefense", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sp_offense" }),
        __metadata("design:type", Number)
    ], CoachSeasons.prototype, "spOffense", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sp_overall" }),
        __metadata("design:type", Number)
    ], CoachSeasons.prototype, "spOverall", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=srs" }),
        __metadata("design:type", Number)
...
var Coach = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=seasons", elemType: CoachSeasons }),
