...
class ListMobileDeviceAccessRulesRequest:
    ...
    list_mobile_device_access_rules_request: shared_listmobiledeviceaccessrulesrequest.ListMobileDeviceAccessRulesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
