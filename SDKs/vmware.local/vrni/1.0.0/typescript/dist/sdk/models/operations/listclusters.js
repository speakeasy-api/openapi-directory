...
exports.ListClustersResponse = exports.ListClustersRequest = exports.ListClustersSecurity = exports.ListClustersQueryParams = void 0;
...
var ListClustersQueryParams = /** @class */ (function (_super) {
    ...
    ], ListClustersQueryParams.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=end_time" }),
        __metadata("design:type", Number)
    ], ListClustersQueryParams.prototype, "endTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=size" }),
        __metadata("design:type", Number)
    ], ListClustersQueryParams.prototype, "size", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start_time" }),
        __metadata("design:type", Number)
    ], ListClustersQueryParams.prototype, "startTime", void 0);
    return ListClustersQueryParams;
}(utils_1.SpeakeasyBase));
exports.ListClustersQueryParams = ListClustersQueryParams;
var ListClustersSecurity = /** @class */ (function (_super) {
    __extends(ListClustersSecurity, _super);
    function ListClustersSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeApiKeyAuth)
    ], ListClustersSecurity.prototype, "apiKeyAuth", void 0);
    return ListClustersSecurity;
}(utils_1.SpeakeasyBase));
exports.ListClustersSecurity = ListClustersSecurity;
var ListClustersRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", ListClustersSecurity)
    ], ListClustersRequest.prototype, "security", void 0);
...
var ListClustersResponse = /** @class */ (function (_super) {
    ...
    ], ListClustersResponse.prototype, "apiError", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
    ...
    ], ListClustersResponse.prototype, "pagedListResponseWithTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
