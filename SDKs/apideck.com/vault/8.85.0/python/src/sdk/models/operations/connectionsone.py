...
class ConnectionsOneRequest:
    headers: ConnectionsOneHeaders = dataclasses.field()
    path_params: ConnectionsOnePathParams = dataclasses.field()
    security: ConnectionsOneSecurity = dataclasses.field()
