 ...
 */
export enum YoutubeAdGroupAdGroupFormatEnum {
 ...
 */
export enum YoutubeAdGroupEntityStatusEnum {
 ...
 */
export class YoutubeAdGroup extends SpeakeasyBase {
  /**
   * The format of the ads in the ad group.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "adGroupFormat" })
