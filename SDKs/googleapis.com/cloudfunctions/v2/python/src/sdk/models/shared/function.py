...
class Function:
    ...
    r"""Output only. State of the function."""  
    state_messages: Optional[list[shared_googlecloudfunctionsv2statemessage.GoogleCloudFunctionsV2StateMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stateMessages'), 'exclude': lambda f: f is None }})
