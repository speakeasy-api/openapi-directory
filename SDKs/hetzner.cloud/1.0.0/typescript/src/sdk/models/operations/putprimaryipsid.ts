...
export class PutPrimaryIpsIdUpdatePrimaryIPRequest extends SpeakeasyBase {
  /**
...
export class PutPrimaryIpsIdRequest extends SpeakeasyBase {
 ...
 */
export enum PutPrimaryIpsIdPrimaryIPResponsePrimaryIPAssigneeTypeEnum {
  Server = "server",
}

export class PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDatacenterLocation extends SpeakeasyBase {
  /**
 ...
 */
export class PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDatacenterServerTypes extends SpeakeasyBase {
  /**
 ...
 */
export class PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDatacenter extends SpeakeasyBase {
  /**
  ...
  @Type(() => PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDatacenterLocation)
  ...
  @Type(() => PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDatacenterServerTypes)
  serverTypes: PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDatacenterServerTypes;
}

export class PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDnsPtr extends SpeakeasyBase {
  /**
 ...
 */
export class PutPrimaryIpsIdPrimaryIPResponsePrimaryIPProtection extends SpeakeasyBase {
  /**
 ...
 */
export enum PutPrimaryIpsIdPrimaryIPResponsePrimaryIPTypeEnum {
  Ipv4 = "ipv4",
  Ipv6 = "ipv6",
}

export class PutPrimaryIpsIdPrimaryIPResponsePrimaryIP extends SpeakeasyBase {
  /**
  ...
  @Type(() => PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDatacenter)
  ...
  @Expose({ name: "dns_ptr" })
  @Type(() => PutPrimaryIpsIdPrimaryIPResponsePrimaryIPDnsPtr)
  ...
  @Type(() => PutPrimaryIpsIdPrimaryIPResponsePrimaryIPProtection)
 ...
 */
export class PutPrimaryIpsIdPrimaryIPResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "primary_ip" })
  @Type(() => PutPrimaryIpsIdPrimaryIPResponsePrimaryIP)
  primaryIp: PutPrimaryIpsIdPrimaryIPResponsePrimaryIP;
}

export class PutPrimaryIpsIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
