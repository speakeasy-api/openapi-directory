...
class UpdateEvidenceRequest:
    ...
    update_evidence_payment_dispute_request: Optional[shared_updateevidencepaymentdisputerequest.UpdateEvidencePaymentDisputeRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
