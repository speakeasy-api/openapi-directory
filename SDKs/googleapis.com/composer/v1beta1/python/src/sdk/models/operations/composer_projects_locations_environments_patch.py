...
class ComposerProjectsLocationsEnvironmentsPatchRequest:
    ...
    r"""The relative resource name of the environment to update, in the form: \\"projects/{projectId}/locations/{locationId}/environments/{environmentId}\\" """  
    ...
    r"""JSONP"""  
    environment_input: Optional[shared_environment.EnvironmentInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
