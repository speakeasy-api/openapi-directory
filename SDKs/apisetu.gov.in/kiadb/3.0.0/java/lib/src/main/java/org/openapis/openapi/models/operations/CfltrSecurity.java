...
public class CfltrSecurity {
    ...
    public CfltrSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public CfltrSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public CfltrSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
