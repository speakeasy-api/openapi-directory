...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminStartPreReceiveEnvironmentDownloadRequest req = new EnterpriseAdminStartPreReceiveEnvironmentDownloadRequest(473221L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminSuspendUserRequest req = new EnterpriseAdminSuspendUserRequest("rerum") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminSyncLdapMappingForTeamRequest req = new EnterpriseAdminSyncLdapMappingForTeamRequest(327720L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminSyncLdapMappingForUserRequest req = new EnterpriseAdminSyncLdapMappingForUserRequest("distinctio");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUnsuspendUserRequest req = new EnterpriseAdminUnsuspendUserRequest("eligendi") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdateGlobalWebhookRequest req = new EnterpriseAdminUpdateGlobalWebhookRequest("culpa", 731398L) {{
                requestBody = new EnterpriseAdminUpdateGlobalWebhookRequestBody() {{
                    active = false;
                    config = new EnterpriseAdminUpdateGlobalWebhookRequestBodyConfig("adipisci") {{
                        contentType = "cumque";
                        insecureSsl = "consequuntur";
                        secret = "consequatur";
                    }};;
                    events = new String[]{{
                        add("quaerat"),
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdateLdapMappingForTeamRequest req = new EnterpriseAdminUpdateLdapMappingForTeamRequest(                new EnterpriseAdminUpdateLdapMappingForTeamRequestBody("blanditiis");, 590984L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdateLdapMappingForUserRequest req = new EnterpriseAdminUpdateLdapMappingForUserRequest(                new EnterpriseAdminUpdateLdapMappingForUserRequestBody("a");, "nulla");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdateOrgNameRequest req = new EnterpriseAdminUpdateOrgNameRequest(                new EnterpriseAdminUpdateOrgNameRequestBody("quas");, "esse");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdatePreReceiveEnvironmentRequest req = new EnterpriseAdminUpdatePreReceiveEnvironmentRequest(97468L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdatePreReceiveHookRequest req = new EnterpriseAdminUpdatePreReceiveHookRequest(908844L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdatePreReceiveHookEnforcementForOrgRequest req = new EnterpriseAdminUpdatePreReceiveHookEnforcementForOrgRequest("ullam", 391774L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdatePreReceiveHookEnforcementForRepoRequest req = new EnterpriseAdminUpdatePreReceiveHookEnforcementForRepoRequest("voluptatum", 185232L, "quibusdam") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdateSelfHostedRunnerGroupForEnterpriseRequest req = new EnterpriseAdminUpdateSelfHostedRunnerGroupForEnterpriseRequest("deleniti", 929292L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            EnterpriseAdminUpdateUsernameForUserRequest req = new EnterpriseAdminUpdateUsernameForUserRequest(                new EnterpriseAdminUpdateUsernameForUserRequestBody("voluptate");, "ipsa");            
