...
class GetOrganizationDevicesPowerModulesStatusesByDeviceRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum $tagsFilterType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=tagsFilterType')]
    public ?GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum $tagsFilterType = null;
