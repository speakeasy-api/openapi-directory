...
class Adexchangebuyer2AccountsCreativesCreateRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Adexchangebuyer2AccountsCreativesCreateDuplicateIDModeEnum $duplicateIdMode
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=duplicateIdMode')]
    public ?Adexchangebuyer2AccountsCreativesCreateDuplicateIDModeEnum $duplicateIdMode = null;
