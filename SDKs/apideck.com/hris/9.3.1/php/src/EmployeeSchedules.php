...
class EmployeeSchedules 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllResponse
     */
	public function employeeSchedulesAll(
        \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/hris/schedules/employees/{employee_id}', \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\EmployeeSchedulesAllResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->getEmployeeSchedulesResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetEmployeeSchedulesResponse', 'json');
            }
        }
