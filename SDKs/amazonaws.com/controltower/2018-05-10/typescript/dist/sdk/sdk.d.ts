 ...
 */
export declare const ServerList: readonly ["http://controltower.{region}.amazonaws.com", "https://controltower.{region}.amazonaws.com", "http://controltower.{region}.amazonaws.com.cn", "https://controltower.{region}.amazonaws.com.cn"];
/**
...
export declare class SDK {
     ...
     */
    disableControl(req: operations.DisableControlRequest, config?: AxiosRequestConfig): Promise<operations.DisableControlResponse>;
    /**
     ...
     */
    enableControl(req: operations.EnableControlRequest, config?: AxiosRequestConfig): Promise<operations.EnableControlResponse>;
    /**
     ...
     */
    getControlOperation(req: operations.GetControlOperationRequest, config?: AxiosRequestConfig): Promise<operations.GetControlOperationResponse>;
    /**
     * Lists the controls enabled by AWS Control Tower on the specified organizational unit and the accounts it contains.
     */
    listEnabledControls(req: operations.ListEnabledControlsRequest, config?: AxiosRequestConfig): Promise<operations.ListEnabledControlsResponse>;
}
