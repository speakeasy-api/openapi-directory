...
class CustomerUpdateJSONRequest:
    ...
    billbee_interfaces_billbee_api_model_customer_api_model_input: shared_billbee_interfaces_billbeeapi_model_customerapimodel.BillbeeInterfacesBillbeeAPIModelCustomerAPIModelInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
