...
class Error401PISAdditionalErrors:
    ...
    code: shared_messagecode401_pis_enum.MessageCode401PISEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
    r"""Message codes defined for PIS for HTTP Error code 401 (UNAUTHORIZED)."""  
...
class Error401PIS:
    ...
    additional_errors: Optional[list[Error401PISAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
