...
public class GetPublicationGeneAssociationsRequest {
    ...
    public GetPublicationGeneAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPublicationGeneAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPublicationGeneAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPublicationGeneAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPublicationGeneAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPublicationGeneAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withRelation(String relation) {
    ...
    public GetPublicationGeneAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPublicationGeneAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPublicationGeneAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPublicationGeneAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
