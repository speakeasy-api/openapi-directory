...
public class RulesHeaders {
    ...
    public RulesHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public RulesHeaders withContentType(String contentType) {
    ...
    public RulesHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public RulesHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
