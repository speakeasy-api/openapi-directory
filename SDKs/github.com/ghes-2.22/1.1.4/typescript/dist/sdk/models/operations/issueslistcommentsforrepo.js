...
exports.IssuesListCommentsForRepoResponse = exports.IssuesListCommentsForRepoRequest = exports.IssuesListCommentsForRepoDirectionEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Either `asc` or `desc`. Ignored without the `sort` parameter.
 */
var IssuesListCommentsForRepoDirectionEnum;
...
})(IssuesListCommentsForRepoDirectionEnum = exports.IssuesListCommentsForRepoDirectionEnum || (exports.IssuesListCommentsForRepoDirectionEnum = {}));
var IssuesListCommentsForRepoRequest = /** @class */ (function (_super) {
    ...
    ], IssuesListCommentsForRepoRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], IssuesListCommentsForRepoRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], IssuesListCommentsForRepoRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], IssuesListCommentsForRepoRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], IssuesListCommentsForRepoRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=since;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], IssuesListCommentsForRepoRequest.prototype, "since", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], IssuesListCommentsForRepoRequest.prototype, "sort", void 0);
...
var IssuesListCommentsForRepoResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], IssuesListCommentsForRepoResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
