...
class ActionPOSTamendRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\ProxyActionamendRequest $proxyActionamendRequest;
	...
	{
		$this->proxyActionamendRequest = new \OpenAPI\OpenAPI\Models\Shared\ProxyActionamendRequest();
