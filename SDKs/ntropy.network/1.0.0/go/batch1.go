...
func NewBatch1(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *Batch1 {
	return &Batch1{
...
func (s *Batch1) GetABatchOfBusinessTransactionClassificationResults(ctx context.Context, request operations.GetABatchOfBusinessTransactionClassificationResultsRequest) (*operations.GetABatchOfBusinessTransactionClassificationResultsResponse, error) {
