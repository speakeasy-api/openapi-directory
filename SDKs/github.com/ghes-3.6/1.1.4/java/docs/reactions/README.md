...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForCommitCommentRequest req = new ReactionsCreateForCommitCommentRequest(                new ReactionsCreateForCommitCommentRequestBody(ReactionsCreateForCommitCommentRequestBodyContentEnum.HEART);, 75566L, "labore", "assumenda");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForIssueRequest req = new ReactionsCreateForIssueRequest(                new ReactionsCreateForIssueRequestBody(ReactionsCreateForIssueRequestBodyContentEnum.LAUGH);, 790463L, "provident", "laudantium");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForIssueCommentRequest req = new ReactionsCreateForIssueCommentRequest(                new ReactionsCreateForIssueCommentRequestBody(ReactionsCreateForIssueCommentRequestBodyContentEnum.EYES);, 9683L, "maxime", "aspernatur");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForPullRequestReviewCommentRequest req = new ReactionsCreateForPullRequestReviewCommentRequest(                new ReactionsCreateForPullRequestReviewCommentRequestBody(ReactionsCreateForPullRequestReviewCommentRequestBodyContentEnum.HOORAY);, 711991L, "quas", "provident");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForReleaseRequest req = new ReactionsCreateForReleaseRequest(                new ReactionsCreateForReleaseRequestBody(ReactionsCreateForReleaseRequestBodyContentEnum.EYES);, "rerum", 492361L, "corporis");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForTeamDiscussionCommentInOrgRequest req = new ReactionsCreateForTeamDiscussionCommentInOrgRequest(                new ReactionsCreateForTeamDiscussionCommentInOrgRequestBody(ReactionsCreateForTeamDiscussionCommentInOrgRequestBodyContentEnum.ROCKET);, 629377L, 833982L, "iure", "dolorem");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForTeamDiscussionCommentLegacyRequest req = new ReactionsCreateForTeamDiscussionCommentLegacyRequest(                new ReactionsCreateForTeamDiscussionCommentLegacyRequestBody(ReactionsCreateForTeamDiscussionCommentLegacyRequestBodyContentEnum.CONFUSED);, 771226L, 415033L, 12171L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForTeamDiscussionInOrgRequest req = new ReactionsCreateForTeamDiscussionInOrgRequest(                new ReactionsCreateForTeamDiscussionInOrgRequestBody(ReactionsCreateForTeamDiscussionInOrgRequestBodyContentEnum.PLUS1);, 322829L, "quae", "amet");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsCreateForTeamDiscussionLegacyRequest req = new ReactionsCreateForTeamDiscussionLegacyRequest(                new ReactionsCreateForTeamDiscussionLegacyRequestBody(ReactionsCreateForTeamDiscussionLegacyRequestBodyContentEnum.ROCKET);, 506863L, 695526L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsDeleteForCommitCommentRequest req = new ReactionsDeleteForCommitCommentRequest(736853L, "amet", 97676L, "dicta");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsDeleteForIssueRequest req = new ReactionsDeleteForIssueRequest(514922L, "doloremque", 938412L, "iusto");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsDeleteForIssueCommentRequest req = new ReactionsDeleteForIssueCommentRequest(228646L, "provident", 677141L, "necessitatibus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsDeleteForPullRequestCommentRequest req = new ReactionsDeleteForPullRequestCommentRequest(592880L, "repudiandae", 10063L, "nemo");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsDeleteForReleaseRequest req = new ReactionsDeleteForReleaseRequest("molestiae", 930840L, 708771L, "corrupti");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsDeleteForTeamDiscussionRequest req = new ReactionsDeleteForTeamDiscussionRequest(43975L, "sint", 879522L, "eos");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsDeleteForTeamDiscussionCommentRequest req = new ReactionsDeleteForTeamDiscussionCommentRequest(520081L, 115861L, "voluptatem", 244376L, "dolor");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForCommitCommentRequest req = new ReactionsListForCommitCommentRequest(124289L, "a", "dolor") {{
                content = ReactionsListForCommitCommentContentEnum.HEART;
                page = 539813L;
                perPage = 107472L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForIssueRequest req = new ReactionsListForIssueRequest(868255L, "labore", "minus") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForIssueCommentRequest req = new ReactionsListForIssueCommentRequest(698558L, "ea", "aperiam") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForPullRequestReviewCommentRequest req = new ReactionsListForPullRequestReviewCommentRequest(784115L, "provident", "consectetur") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForReleaseRequest req = new ReactionsListForReleaseRequest("soluta", 620500L, "temporibus") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForTeamDiscussionCommentInOrgRequest req = new ReactionsListForTeamDiscussionCommentInOrgRequest(133949L, 778276L, "itaque", "illum") {{
                content = ReactionsListForTeamDiscussionCommentInOrgContentEnum.HOORAY;
                page = 490420L;
                perPage = 876285L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForTeamDiscussionCommentLegacyRequest req = new ReactionsListForTeamDiscussionCommentLegacyRequest(185348L, 232383L, 995816L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForTeamDiscussionInOrgRequest req = new ReactionsListForTeamDiscussionInOrgRequest(471457L, "non", "ab") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ReactionsListForTeamDiscussionLegacyRequest req = new ReactionsListForTeamDiscussionLegacyRequest(964925L, 251212L) {{
                content = ReactionsListForTeamDiscussionLegacyContentEnum.HOORAY;
                page = 450224L;
                perPage = 349993L;
            }};            
