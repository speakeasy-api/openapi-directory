...
class ConnectionSchedule
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ConnectionScheduleTimeUnitEnum>')]
	...
	{
		$this->timeUnit = \OpenAPI\OpenAPI\Models\Shared\ConnectionScheduleTimeUnitEnum::MINUTES;
		$this->units = 0;
	}
}
