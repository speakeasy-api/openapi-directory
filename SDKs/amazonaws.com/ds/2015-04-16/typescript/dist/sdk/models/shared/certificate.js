...
var certificatestateenum_1 = require("./certificatestateenum");
var certificatetypeenum_1 = require("./certificatetypeenum");
var clientcertauthsettings_1 = require("./clientcertauthsettings");
...
var Certificate = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ClientCertAuthSettings" }),
        (0, class_transformer_1.Type)(function () { return clientcertauthsettings_1.ClientCertAuthSettings; }),
        __metadata("design:type", clientcertauthsettings_1.ClientCertAuthSettings)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ExpiryDateTime" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RegisteredDateTime" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
