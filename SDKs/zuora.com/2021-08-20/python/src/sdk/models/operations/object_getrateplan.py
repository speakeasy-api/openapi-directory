...
from ..shared import proxygetrateplan as shared_proxygetrateplan
...
class ObjectGETRatePlanResponse:
    ...
    proxy_get_rate_plan: Optional[shared_proxygetrateplan.ProxyGetRatePlan] = dataclasses.field(default=None)  
