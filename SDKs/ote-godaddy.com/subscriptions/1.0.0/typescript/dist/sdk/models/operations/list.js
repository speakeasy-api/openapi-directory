...
(function (ListSortEnum) {
    ListSortEnum["ExpiresAt"] = "expiresAt";
    ListSortEnum["MinusExpiresAt"] = "-expiresAt";
...
var ListQueryParams = /** @class */ (function (_super) {
    ...
    ], ListQueryParams.prototype, "includes", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=false;name=productGroupKeys" }),
        __metadata("design:type", Array)
    ], ListQueryParams.prototype, "productGroupKeys", void 0);
    __decorate([
...
var ListResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ListResponse.prototype, "subscriptionList", void 0);
    return ListResponse;
}(utils_1.SpeakeasyBase));
