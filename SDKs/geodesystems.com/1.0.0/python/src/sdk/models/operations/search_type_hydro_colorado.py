...
class SearchTypeHydroColoradoQueryParams:
    ...
    search_type_hydro_colorado_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_hydro_colorado.site_id', 'style': 'form', 'explode': True }})
...
class SearchTypeHydroColoradoRequest:
    query_params: SearchTypeHydroColoradoQueryParams = dataclasses.field()
