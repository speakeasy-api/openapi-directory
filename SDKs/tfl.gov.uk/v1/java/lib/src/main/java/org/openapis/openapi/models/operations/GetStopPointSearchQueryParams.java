...
public class GetStopPointSearchQueryParams {
    /**
    ...
    public GetStopPointSearchQueryParams withFaresOnly(Boolean faresOnly) {
    ...
    public GetStopPointSearchQueryParams withIncludeHubs(Boolean includeHubs) {
    ...
    public String[] lines;
    public GetStopPointSearchQueryParams withLines(String[] lines) {
        this.lines = lines;
        return this;
    }
    ...
    public GetStopPointSearchQueryParams withMaxResults(Integer maxResults) {
    ...
    public String[] modes;
    public GetStopPointSearchQueryParams withModes(String[] modes) {
        this.modes = modes;
        return this;
    }
    ...
    public String query;
    public GetStopPointSearchQueryParams withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public GetStopPointSearchQueryParams withTflOperatedNationalRailStationsOnly(Boolean tflOperatedNationalRailStationsOnly) {
