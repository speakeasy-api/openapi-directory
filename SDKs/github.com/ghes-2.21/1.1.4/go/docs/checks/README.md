...
func main() {
    ...
    res, err := s.Checks.ChecksListAnnotations(ctx, operations.ChecksListAnnotationsRequest{
        CheckRunID: 449198,
        Owner: "illum",
        Page: sdk.Int64(978571),
        PerPage: sdk.Int64(699479),
        Repo: "dicta",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Checks.ChecksListForRef(ctx, operations.ChecksListForRefRequest{
        ...
        Owner: "ea",
        Page: sdk.Int64(396506),
        PerPage: sdk.Int64(675439),
        Ref: "accusamus",
        Repo: "non",
...
func main() {
    ...
    res, err := s.Checks.ChecksListSuitesForRef(ctx, operations.ChecksListSuitesForRefRequest{
        AppID: sdk.Int64(533206),
        CheckName: sdk.String("sapiente"),
        Owner: "amet",
        Page: sdk.Int64(643990),
        PerPage: sdk.Int64(394869),
        Ref: "vel",
        Repo: "natus",
    })
    if err != nil {
