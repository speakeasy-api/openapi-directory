...
class CreateGroupRequestBody:
    ...
    initial_version: Optional[CreateGroupRequestBodyInitialVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('InitialVersion') }})
