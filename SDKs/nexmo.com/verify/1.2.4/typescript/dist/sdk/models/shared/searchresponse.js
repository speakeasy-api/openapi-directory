...
var SearchResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=checks", elemType: SearchResponseChecks }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=date_submitted" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=events", elemType: SearchResponseEvents }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sender_id" }),
        __metadata("design:type", String)
