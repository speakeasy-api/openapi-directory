...
class GetSpacesSpaceIDEmployersAllRequest:
...
class GetSpacesSpaceIDEmployersAllResponse:
    ...
    get_spaces_space_id_employers_all_200_application_json_all_ofs: Optional[list[shared_employee.Employee]] = dataclasses.field(default=None)
