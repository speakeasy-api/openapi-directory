...
public class GetPaymentInitiationCancellationAuthorisationInformationRequest {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUAccept(String psuAccept) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUDeviceID(String psuDeviceID) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUGeoLocation(String psuGeoLocation) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUIPAddress(String psuIPAddress) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUIPPort(String psuIPPort) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPSUUserAgent(String psuUserAgent) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withSignature(String signature) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withXRequestID(String xRequestID) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPaymentProduct(org.openapis.openapi.models.shared.PaymentProductEnum paymentProduct) {
    ...
    public GetPaymentInitiationCancellationAuthorisationInformationRequest withPaymentService(org.openapis.openapi.models.shared.PaymentServiceEnum paymentService) {
