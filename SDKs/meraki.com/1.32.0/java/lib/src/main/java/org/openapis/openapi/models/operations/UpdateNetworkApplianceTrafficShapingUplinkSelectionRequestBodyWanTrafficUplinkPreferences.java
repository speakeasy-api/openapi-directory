...
public class UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyWanTrafficUplinkPreferences {
    ...
    public UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyWanTrafficUplinkPreferences(@JsonProperty("preferredUplink") UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyWanTrafficUplinkPreferencesPreferredUplinkEnum preferredUplink, @JsonProperty("trafficFilters") UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyWanTrafficUplinkPreferencesTrafficFilters[] trafficFilters) {
        this.preferredUplink = preferredUplink;
        this.trafficFilters = trafficFilters;
  }
}
