...
class GetExitStandbyQueryParams:
    action: GetExitStandbyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetExitStandbyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetExitStandbyRequest:
    headers: GetExitStandbyHeaders = dataclasses.field()
    query_params: GetExitStandbyQueryParams = dataclasses.field()
