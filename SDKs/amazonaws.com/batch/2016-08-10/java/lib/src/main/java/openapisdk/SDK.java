...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.CancelJobResponse cancelJob(openapisdk.models.operations.CancelJobRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/canceljob");
    ...
    **/
    public openapisdk.models.operations.CreateComputeEnvironmentResponse createComputeEnvironment(openapisdk.models.operations.CreateComputeEnvironmentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/createcomputeenvironment");
        ...
        openapisdk.models.operations.CreateComputeEnvironmentResponse res = new openapisdk.models.operations.CreateComputeEnvironmentResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.CreateComputeEnvironmentResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateComputeEnvironmentResponse.class);
    ...
    **/
    public openapisdk.models.operations.CreateJobQueueResponse createJobQueue(openapisdk.models.operations.CreateJobQueueRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/createjobqueue");
        ...
        openapisdk.models.operations.CreateJobQueueResponse res = new openapisdk.models.operations.CreateJobQueueResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.CreateJobQueueResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateJobQueueResponse.class);
    ...
    **/
    public openapisdk.models.operations.DeleteComputeEnvironmentResponse deleteComputeEnvironment(openapisdk.models.operations.DeleteComputeEnvironmentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/deletecomputeenvironment");
        ...
        openapisdk.models.operations.DeleteComputeEnvironmentResponse res = new openapisdk.models.operations.DeleteComputeEnvironmentResponse() {{
    ...
    **/
    public openapisdk.models.operations.DeleteJobQueueResponse deleteJobQueue(openapisdk.models.operations.DeleteJobQueueRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/deletejobqueue");
        ...
        openapisdk.models.operations.DeleteJobQueueResponse res = new openapisdk.models.operations.DeleteJobQueueResponse() {{
    ...
    **/
    public openapisdk.models.operations.DeregisterJobDefinitionResponse deregisterJobDefinition(openapisdk.models.operations.DeregisterJobDefinitionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/deregisterjobdefinition");
        ...
        openapisdk.models.operations.DeregisterJobDefinitionResponse res = new openapisdk.models.operations.DeregisterJobDefinitionResponse() {{
    ...
    **/
    public openapisdk.models.operations.DescribeComputeEnvironmentsResponse describeComputeEnvironments(openapisdk.models.operations.DescribeComputeEnvironmentsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/describecomputeenvironments");
        ...
        openapisdk.models.operations.DescribeComputeEnvironmentsResponse res = new openapisdk.models.operations.DescribeComputeEnvironmentsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeComputeEnvironmentsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeComputeEnvironmentsResponse.class);
    ...
    **/
    public openapisdk.models.operations.DescribeJobDefinitionsResponse describeJobDefinitions(openapisdk.models.operations.DescribeJobDefinitionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/describejobdefinitions");
        ...
        openapisdk.models.operations.DescribeJobDefinitionsResponse res = new openapisdk.models.operations.DescribeJobDefinitionsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeJobDefinitionsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeJobDefinitionsResponse.class);
    ...
    **/
    public openapisdk.models.operations.DescribeJobQueuesResponse describeJobQueues(openapisdk.models.operations.DescribeJobQueuesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/describejobqueues");
        ...
        openapisdk.models.operations.DescribeJobQueuesResponse res = new openapisdk.models.operations.DescribeJobQueuesResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeJobQueuesResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeJobQueuesResponse.class);
    ...
    **/
    public openapisdk.models.operations.DescribeJobsResponse describeJobs(openapisdk.models.operations.DescribeJobsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/describejobs");
        ...
        openapisdk.models.operations.DescribeJobsResponse res = new openapisdk.models.operations.DescribeJobsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeJobsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeJobsResponse.class);
    ...
    **/
    public openapisdk.models.operations.ListJobsResponse listJobs(openapisdk.models.operations.ListJobsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/listjobs");
    ...
    **/
    public openapisdk.models.operations.RegisterJobDefinitionResponse registerJobDefinition(openapisdk.models.operations.RegisterJobDefinitionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/registerjobdefinition");
        ...
        openapisdk.models.operations.RegisterJobDefinitionResponse res = new openapisdk.models.operations.RegisterJobDefinitionResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.RegisterJobDefinitionResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.RegisterJobDefinitionResponse.class);
    ...
    **/
    public openapisdk.models.operations.SubmitJobResponse submitJob(openapisdk.models.operations.SubmitJobRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/submitjob");
        ...
        openapisdk.models.operations.SubmitJobResponse res = new openapisdk.models.operations.SubmitJobResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.SubmitJobResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.SubmitJobResponse.class);
    ...
    **/
    public openapisdk.models.operations.TerminateJobResponse terminateJob(openapisdk.models.operations.TerminateJobRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/terminatejob");
        ...
        openapisdk.models.operations.TerminateJobResponse res = new openapisdk.models.operations.TerminateJobResponse() {{
    ...
    **/
    public openapisdk.models.operations.UpdateComputeEnvironmentResponse updateComputeEnvironment(openapisdk.models.operations.UpdateComputeEnvironmentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/updatecomputeenvironment");
        ...
        openapisdk.models.operations.UpdateComputeEnvironmentResponse res = new openapisdk.models.operations.UpdateComputeEnvironmentResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateComputeEnvironmentResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateComputeEnvironmentResponse.class);
    ...
    **/
    public openapisdk.models.operations.UpdateJobQueueResponse updateJobQueue(openapisdk.models.operations.UpdateJobQueueRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/updatejobqueue");
        ...
        openapisdk.models.operations.UpdateJobQueueResponse res = new openapisdk.models.operations.UpdateJobQueueResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateJobQueueResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateJobQueueResponse.class);
