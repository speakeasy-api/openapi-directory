...
class FileDeleteFromComputeNodeRequest:
    headers: FileDeleteFromComputeNodeHeaders = dataclasses.field()
    path_params: FileDeleteFromComputeNodePathParams = dataclasses.field()
    query_params: FileDeleteFromComputeNodeQueryParams = dataclasses.field()
