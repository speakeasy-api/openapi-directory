...
class PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2AccountingWorkbookEnum(str, Enum):
    CUSTOMER = 'customer'
    PROVIDER = 'provider'
    BANK = 'bank'
...
class PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2Accounting:
    ...
    workbook: Optional[PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2AccountingWorkbookEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Workbook'), 'exclude': lambda f: f is None }})  
...
class PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2:
    ...
    file: PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2File = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('File') }})  
    title: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Title') }})  
    accounting: Optional[PostSpacesSpaceIDFoldersIDSocialContractsApplicationJSON2Accounting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Accounting'), 'exclude': lambda f: f is None }})  
...
@dataclasses.dataclass
class PostSpacesSpaceIDFoldersIDSocialContractsJSONResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    headers: Optional[dict[str, list[str]]] = dataclasses.field(default=None)  
    post_spaces_space_id_folders_id_social_contracts_json_201_application_json_object: Optional[PostSpacesSpaceIDFoldersIDSocialContractsJSON201ApplicationJSON] = dataclasses.field(default=None)
    r"""Id of document created"""  
