...
export class SecuritycenterProjectsNotificationConfigsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsNotificationConfigsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsNotificationConfigsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
