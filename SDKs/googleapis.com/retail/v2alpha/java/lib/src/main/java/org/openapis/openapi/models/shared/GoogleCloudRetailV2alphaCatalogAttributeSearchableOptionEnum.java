 ...
 */
public enum GoogleCloudRetailV2alphaCatalogAttributeSearchableOptionEnum {
    ...
    private GoogleCloudRetailV2alphaCatalogAttributeSearchableOptionEnum(String value) {
        this.value = value;
    }
}
