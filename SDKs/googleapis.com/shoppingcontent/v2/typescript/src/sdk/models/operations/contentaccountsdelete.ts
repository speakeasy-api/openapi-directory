...
export class ContentAccountsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccountsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccountsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
