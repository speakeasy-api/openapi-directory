...
exports.InboundFirewallRules = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var InboundFirewallRules = /** @class */ (function () {
    function InboundFirewallRules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    InboundFirewallRules.prototype.getNetworkApplianceFirewallInboundFirewallRules = function (req, config) {
    ...
    **/
    InboundFirewallRules.prototype.updateNetworkApplianceFirewallInboundFirewallRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.InboundFirewallRules = InboundFirewallRules;
