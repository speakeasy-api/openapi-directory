...
from ..shared import tasktypelistvo as shared_tasktypelistvo
...
class GetCustomTaskTypesOfWgResponse:
    ...
    task_type_list_vo: Optional[shared_tasktypelistvo.TaskTypeListVO] = dataclasses.field(default=None)
