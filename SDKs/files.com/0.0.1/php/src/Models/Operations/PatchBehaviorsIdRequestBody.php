...
class PatchBehaviorsIdRequestBody
{
     ...
     * 
     * @var ?bool $attachmentDelete
     */
	#[SpeakeasyMetadata('multipartForm:name=attachment_delete')]
    public ?bool $attachmentDelete = null;
    
    /**
     * Certain behaviors may require a file, for instance, the "watermark" behavior requires a watermark image
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PatchBehaviorsIdRequestBodyAttachmentFile $attachmentFile
     */
	#[SpeakeasyMetadata('multipartForm:file=true')]
    public ?PatchBehaviorsIdRequestBodyAttachmentFile $attachmentFile = null;
