...
export class GetSearchRvUkActiveRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=mtplm" })
  mtplm?: string;
...
export class GetSearchRvUkActiveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
