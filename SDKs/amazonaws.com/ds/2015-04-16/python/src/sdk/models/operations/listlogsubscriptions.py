...
class ListLogSubscriptionsRequest:
    ...
    list_log_subscriptions_request: shared_listlogsubscriptionsrequest.ListLogSubscriptionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
