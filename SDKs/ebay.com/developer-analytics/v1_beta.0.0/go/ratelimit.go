...
func (s *rateLimit) GetRateLimits(ctx context.Context, request operations.GetRateLimitsRequest, security operations.GetRateLimitsSecurity) (*operations.GetRateLimitsResponse, error) {
	baseURL := s.serverURL
