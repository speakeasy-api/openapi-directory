...
exports.SupplyData = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SupplyData = /** @class */ (function () {
    function SupplyData(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SupplyData.prototype.daysSupplyDaysSupplyGet = function (req, config) {
     ...
     * The available brand and region names can be retrieved from their respective endpoints.
    **/
    SupplyData.prototype.daysToSellDaysToSellGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
