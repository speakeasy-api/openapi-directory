...
public class ProductApiDeleteRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ProductApiDeleteRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public ProductApiDeleteRawHeaders withXAuthSecret(String xAuthSecret) {
