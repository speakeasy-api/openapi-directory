...
var AggregationResult = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: value_1.Value }),
        (0, class_transformer_1.Expose)({ name: "aggregateProperties" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], value_1.Value);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
    ], AggregationResult.prototype, "aggregateProperties", void 0);
