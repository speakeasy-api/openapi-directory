...
type GamesManagementPlayersUnhideSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GamesManagementPlayersUnhidePathParams struct {
...
type GamesManagementPlayersUnhideQueryParams struct {
	// V1 error format.
...
type GamesManagementPlayersUnhideRequest struct {
...
type GamesManagementPlayersUnhideResponse struct {
	ContentType string
	StatusCode  int
