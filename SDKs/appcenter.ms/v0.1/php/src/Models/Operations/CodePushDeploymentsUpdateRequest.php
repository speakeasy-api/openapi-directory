...
class CodePushDeploymentsUpdateRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsUpdateRequestBody $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsUpdateRequestBody();
		$this->appName = "";
		$this->deploymentName = "";
		$this->ownerName = "";
	}
