...
export declare class Activity {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#check-if-a-repository-is-starred-by-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#delete-a-repository-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#delete-a-thread-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#get-feeds} - API method documentation
     */
    activityGetFeeds(config?: AxiosRequestConfig): Promise<operations.ActivityGetFeedsResponse>;
    /**
     * Get a repository subscription
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#get-a-repository-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#get-a-thread} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#get-a-thread-subscription-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-events-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-notifications-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-organization-events-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-public-events} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-public-events-for-a-network-of-repositories} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-public-events-for-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-public-organization-events} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-events-received-by-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-public-events-received-by-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-repository-events} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-repository-notifications-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-repositories-starred-by-the-authenticated-user} - API method documentation
     */
     ...
     * You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@3.2/rest/overview/media-types/) via the `Accept` header: `application/vnd.github.star+json`.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-repositories-starred-by-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-repositories-watched-by-a-user} - API method documentation
     */
     ...
     * You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@3.2/rest/overview/media-types/) via the `Accept` header: `application/vnd.github.star+json`.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-stargazers} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-repositories-watched-by-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#list-watchers} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#mark-notifications-as-read} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#mark-repository-notifications-as-read} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#mark-a-thread-as-read} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#set-a-repository-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#set-a-thread-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#star-a-repository-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.2/rest/reference/activity#unstar-a-repository-for-the-authenticated-user} - API method documentation
     */
