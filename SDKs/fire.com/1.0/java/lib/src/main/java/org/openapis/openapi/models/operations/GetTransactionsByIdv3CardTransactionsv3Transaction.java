...
public class GetTransactionsByIdv3CardTransactionsv3Transaction {
    /**
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withAmountAfterCharges(Long amountAfterCharges) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withAmountBeforeCharges(Long amountBeforeCharges) {
    ...
    public Long balance;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withBalance(Long balance) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3TransactionBatchItemDetails batchItemDetails;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withBatchItemDetails(GetTransactionsByIdv3CardTransactionsv3TransactionBatchItemDetails batchItemDetails) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("card")
    public GetTransactionsByIdv3CardTransactionsv3TransactionRelatedCard card;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withCard(GetTransactionsByIdv3CardTransactionsv3TransactionRelatedCard card) {
        this.card = card;
        return this;
    }
    ...
    public GetTransactionsByIdv3CardTransactionsv3TransactionCurrency currency;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withCurrency(GetTransactionsByIdv3CardTransactionsv3TransactionCurrency currency) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withDateAcknowledged(OffsetDateTime dateAcknowledged) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3TransactionDirectDebitDetails directDebitDetails;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withDirectDebitDetails(GetTransactionsByIdv3CardTransactionsv3TransactionDirectDebitDetails directDebitDetails) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withEventUuid(String eventUuid) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withFeeAmount(Long feeAmount) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3TransactionFxTrade fxTradeDetails;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withFxTradeDetails(GetTransactionsByIdv3CardTransactionsv3TransactionFxTrade fxTradeDetails) {
    ...
    @JsonProperty("ican")
    public Long ican;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withIcan(Long ican) {
        this.ican = ican;
        return this;
    }
    ...
    @JsonProperty("myRef")
    public String myRef;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withMyRef(String myRef) {
        this.myRef = myRef;
        return this;
    }
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withPaymentRequestPublicCode(String paymentRequestPublicCode) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3TransactionProprietarySchemeDetails[] proprietarySchemeDetails;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withProprietarySchemeDetails(GetTransactionsByIdv3CardTransactionsv3TransactionProprietarySchemeDetails[] proprietarySchemeDetails) {
    ...
    @JsonProperty("refId")
    public Long refId;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withRefId(Long refId) {
        this.refId = refId;
        return this;
    }
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withRelatedParty(Object relatedParty) {
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withTaxAmount(Long taxAmount) {
    ...
    @JsonProperty("txnId")
    public Long txnId;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withTxnId(Long txnId) {
        this.txnId = txnId;
        return this;
    }
    ...
    @JsonProperty("type")
    public String type;
    public GetTransactionsByIdv3CardTransactionsv3Transaction withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public GetTransactionsByIdv3CardTransactionsv3Transaction withYourRef(String yourRef) {
