...
from ..shared import listworkersresponse as shared_listworkersresponse
...
class ListWorkersResponse:
    ...
    list_workers_response: Optional[shared_listworkersresponse.ListWorkersResponse] = dataclasses.field(default=None)
    r"""Success"""  
