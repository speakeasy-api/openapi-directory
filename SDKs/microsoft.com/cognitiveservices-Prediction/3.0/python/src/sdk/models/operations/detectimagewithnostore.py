...
class DetectImageWithNoStorePathParams:
...
@dataclasses.dataclass
class DetectImageWithNoStoreQueryParams:
...
@dataclasses.dataclass
class DetectImageWithNoStoreRequestBodyImageData:
...
class DetectImageWithNoStoreRequestBody:
    image_data: DetectImageWithNoStoreRequestBodyImageData = dataclasses.field(metadata={'multipart_form': { 'file': True }})
    

@dataclasses.dataclass
class DetectImageWithNoStoreRequest:
    path_params: DetectImageWithNoStorePathParams = dataclasses.field()
    query_params: DetectImageWithNoStoreQueryParams = dataclasses.field()
    request: DetectImageWithNoStoreRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'multipart/form-data' }})
    

@dataclasses.dataclass
class DetectImageWithNoStoreResponse:
