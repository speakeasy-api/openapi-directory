...
public class LocerSecurity {
    ...
    public LocerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public LocerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public LocerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
