...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.deleteAMediaItem = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/:id";
    ...
    **/
    SDK.prototype.listAndSearchMediaItems = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listAndSearchMediaItems200ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.retrieveAMediaItem = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/:id/info";
        var client = this._defaultClient;
    ...
    **/
    SDK.prototype.updateAMediaItem = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
