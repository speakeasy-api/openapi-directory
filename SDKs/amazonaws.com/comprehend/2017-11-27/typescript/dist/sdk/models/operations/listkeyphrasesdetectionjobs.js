...
exports.ListKeyPhrasesDetectionJobsResponse = exports.ListKeyPhrasesDetectionJobsRequest = exports.ListKeyPhrasesDetectionJobsXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ListKeyPhrasesDetectionJobsXAmzTargetEnum;
...
})(ListKeyPhrasesDetectionJobsXAmzTargetEnum = exports.ListKeyPhrasesDetectionJobsXAmzTargetEnum || (exports.ListKeyPhrasesDetectionJobsXAmzTargetEnum = {}));
var ListKeyPhrasesDetectionJobsRequest = /** @class */ (function (_super) {
    ...
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "listKeyPhrasesDetectionJobsRequest", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ListKeyPhrasesDetectionJobsRequest.prototype, "xAmzTarget", void 0);
...
var ListKeyPhrasesDetectionJobsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ListKeyPhrasesDetectionJobsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
