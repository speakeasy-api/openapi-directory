...
class PostRepositoriesWorkspaceRepoSlugForksRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugForksPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugForksSecurity = dataclasses.field()
