...
public class GetUnmaskedAddressQueryParams {
    /**
    ...
    public GetUnmaskedAddressQueryParams withAlternativeKey(String alternativeKey) {
    ...
    public GetUnmaskedAddressQueryParams withReason(String reason) {
        this.reason = reason;
        return this;
    }
