 ...
 */
export enum ModifyIpamResourceCidrResultIpamResourceCidrComplianceStatusEnum {
  Compliant = "compliant",
 ...
 */
export enum ModifyIpamResourceCidrResultIpamResourceCidrManagementStateEnum {
  Managed = "managed",
  Unmanaged = "unmanaged",
  Ignored = "ignored",
}
 ...
 */
export enum ModifyIpamResourceCidrResultIpamResourceCidrOverlapStatusEnum {
 ...
 */
export class ModifyIpamResourceCidrResultIpamResourceCidrResourceTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export enum ModifyIpamResourceCidrResultIpamResourceCidrResourceTypeEnum {
  Vpc = "vpc",
  Subnet = "subnet",
  Eip = "eip",
 ...
 */
export class ModifyIpamResourceCidrResultIpamResourceCidr extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 * Success
 */
export class ModifyIpamResourceCidrResult extends SpeakeasyBase {
  @SpeakeasyMetadata()
