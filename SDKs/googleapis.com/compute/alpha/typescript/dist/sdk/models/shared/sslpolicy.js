...
var servertlssettings_1 = require("./servertlssettings");
...
var SslPolicy = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SslPolicy.prototype, "selfLinkWithId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tlsSettings" }),
        (0, class_transformer_1.Type)(function () { return servertlssettings_1.ServerTlsSettings; }),
        __metadata("design:type", servertlssettings_1.ServerTlsSettings)
    ], SslPolicy.prototype, "tlsSettings", void 0);
    __decorate([
