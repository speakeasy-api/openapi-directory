...
class GetModelGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetModelGeneAssociationsQueryParams:
...
class GetModelGeneAssociationsRequest:
    path_params: GetModelGeneAssociationsPathParams = dataclasses.field()
    query_params: GetModelGeneAssociationsQueryParams = dataclasses.field()
