...
class BusinessLineInfoUpdateServiceEnum(str, Enum):
...
class BusinessLineInfoUpdateInput:
    ...
    service: BusinessLineInfoUpdateServiceEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('service') }})
    r"""The service for which you are creating the business line.
    ...
    industry_code: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('industryCode'), 'exclude': lambda f: f is None }})
    r"""A code that represents the industry of your legal entity. For example, **4431A** for computer software stores."""  
