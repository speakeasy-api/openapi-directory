...
class GetListUserTagsQueryParams:
    action: GetListUserTagsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    user_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'UserName', 'style': 'form', 'explode': True }})
    version: GetListUserTagsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListUserTagsRequest:
    headers: GetListUserTagsHeaders = dataclasses.field()
    query_params: GetListUserTagsQueryParams = dataclasses.field()
