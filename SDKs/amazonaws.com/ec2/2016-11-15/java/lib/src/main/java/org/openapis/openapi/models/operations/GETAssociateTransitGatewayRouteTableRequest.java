...
public class GETAssociateTransitGatewayRouteTableRequest {
    ...
    public GETAssociateTransitGatewayRouteTableRequest(@JsonProperty("Action") GETAssociateTransitGatewayRouteTableActionEnum action, @JsonProperty("TransitGatewayAttachmentId") String transitGatewayAttachmentId, @JsonProperty("TransitGatewayRouteTableId") String transitGatewayRouteTableId, @JsonProperty("Version") GETAssociateTransitGatewayRouteTableVersionEnum version) {
        this.action = action;
        this.transitGatewayAttachmentId = transitGatewayAttachmentId;
        this.transitGatewayRouteTableId = transitGatewayRouteTableId;
        this.version = version;
