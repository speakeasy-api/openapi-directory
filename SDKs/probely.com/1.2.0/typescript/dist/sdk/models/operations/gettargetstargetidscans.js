...
exports.GetTargetsTargetIdScansResponse = exports.GetTargetsTargetIdScans200ApplicationJSON = exports.GetTargetsTargetIdScans401ApplicationJSON = exports.GetTargetsTargetIdScans404ApplicationJSON = exports.GetTargetsTargetIdScansRequest = void 0;
...
var GetTargetsTargetIdScansRequest = /** @class */ (function (_super) {
    ...
    ], GetTargetsTargetIdScansRequest.prototype, "length", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ordering",
        }),
        __metadata("design:type", String)
    ], GetTargetsTargetIdScansRequest.prototype, "ordering", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetTargetsTargetIdScansRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], GetTargetsTargetIdScansRequest.prototype, "search", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=started",
        }),
        __metadata("design:type", Array)
    ], GetTargetsTargetIdScansRequest.prototype, "started", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], GetTargetsTargetIdScansRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=target_id",
        }),
        __metadata("design:type", String)
    ], GetTargetsTargetIdScansRequest.prototype, "targetId", void 0);
...
var GetTargetsTargetIdScans200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.Scan }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.Scan; }),
        __metadata("design:type", Array)
...
var GetTargetsTargetIdScansResponse = /** @class */ (function (_super) {
    ...
    ], GetTargetsTargetIdScansResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
