...
public class OBWriteDomestic2DataInitiationRemittanceInformation {
    ...
    public OBWriteDomestic2DataInitiationRemittanceInformation withReference(String reference) {
    ...
    public OBWriteDomestic2DataInitiationRemittanceInformation withUnstructured(String unstructured) {
        this.unstructured = unstructured;
        return this;
    }
    
    public OBWriteDomestic2DataInitiationRemittanceInformation(){}
}
