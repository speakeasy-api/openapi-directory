...
class AddUserToAccount429ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\AddUserToAccount429ApplicationJSONMeta')]
    public AddUserToAccount429ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\AddUserToAccount429ApplicationJSONMeta();
	}
}
