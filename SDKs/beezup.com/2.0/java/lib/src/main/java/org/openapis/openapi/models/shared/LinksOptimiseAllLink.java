...
public class LinksOptimiseAllLink {
    /**
    ...
    public LinksOptimiseAllLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksOptimiseAllLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksOptimiseAllLink withDescription(String description) {
    ...
    public LinksOptimiseAllLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksOptimiseAllLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksOptimiseAllLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksOptimiseAllLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksOptimiseAllLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksOptimiseAllLink withOperationId(String operationId) {
    ...
    public LinksOptimiseAllLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksOptimiseAllLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksOptimiseAllLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
