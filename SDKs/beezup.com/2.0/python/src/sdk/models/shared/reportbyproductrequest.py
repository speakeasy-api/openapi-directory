...
class ReportByProductRequest:
    r"""ReportByProductRequest
    ...
    product_state: shared_productstatefilter_enum.ProductStateFilterEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('productState') }})
