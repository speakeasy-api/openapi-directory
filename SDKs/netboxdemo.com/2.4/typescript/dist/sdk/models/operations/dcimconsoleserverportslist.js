...
exports.DcimConsoleServerPortsListResponse = exports.DcimConsoleServerPortsList200ApplicationJSON = exports.DcimConsoleServerPortsListRequest = void 0;
...
var DcimConsoleServerPortsListRequest = /** @class */ (function (_super) {
    ...
    ], DcimConsoleServerPortsListRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=device_id",
        }),
        __metadata("design:type", String)
    ], DcimConsoleServerPortsListRequest.prototype, "deviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], DcimConsoleServerPortsListRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], DcimConsoleServerPortsListRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], DcimConsoleServerPortsListRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tag" }),
        __metadata("design:type", String)
    ], DcimConsoleServerPortsListRequest.prototype, "tag", void 0);
...
var DcimConsoleServerPortsList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ConsoleServerPort }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.ConsoleServerPort; }),
...
var DcimConsoleServerPortsListResponse = /** @class */ (function (_super) {
    ...
    ], DcimConsoleServerPortsListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
