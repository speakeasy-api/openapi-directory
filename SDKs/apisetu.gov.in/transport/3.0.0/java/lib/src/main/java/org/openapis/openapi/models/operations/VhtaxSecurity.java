...
public class VhtaxSecurity {
    ...
    public VhtaxSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public VhtaxSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public VhtaxSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
