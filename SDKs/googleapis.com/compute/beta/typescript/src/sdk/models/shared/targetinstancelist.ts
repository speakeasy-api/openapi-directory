 ...
 */
export enum TargetInstanceListWarningCodeEnum {
...
export class TargetInstanceListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetInstanceListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: TargetInstanceListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: TargetInstanceListWarningData })
  @Expose({ name: "data" })
  @Type(() => TargetInstanceListWarningData)
  data?: TargetInstanceListWarningData[];
 ...
 */
export class TargetInstanceList extends SpeakeasyBase {
  /**
