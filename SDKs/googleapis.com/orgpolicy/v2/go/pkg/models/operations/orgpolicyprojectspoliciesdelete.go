...
type OrgpolicyProjectsPoliciesDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type OrgpolicyProjectsPoliciesDeletePathParams struct {
	// Required. Name of the policy to delete. See the policy entry for naming rules.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type OrgpolicyProjectsPoliciesDeleteQueryParams struct {
	// V1 error format.
...
type OrgpolicyProjectsPoliciesDeleteRequest struct {
...
type OrgpolicyProjectsPoliciesDeleteResponse struct {
	ContentType string
	// Successful response
