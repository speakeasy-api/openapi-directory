 ...
 */
export class DescribeVolumeStatusRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVolumeStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeVolumeStatusRequestFilters })
  filters?: DescribeVolumeStatusRequestFilters[];
