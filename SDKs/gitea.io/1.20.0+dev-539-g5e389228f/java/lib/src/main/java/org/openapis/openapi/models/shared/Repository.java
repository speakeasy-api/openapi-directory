...
public class Repository {
    ...
    public Repository withHasActions(Boolean hasActions) {
    ...
    public Repository withHasPackages(Boolean hasPackages) {
    ...
    public Repository withHasReleases(Boolean hasReleases) {
