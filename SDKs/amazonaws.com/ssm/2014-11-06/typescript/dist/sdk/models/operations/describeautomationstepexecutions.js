...
exports.DescribeAutomationStepExecutionsResponse = exports.DescribeAutomationStepExecutionsRequest = exports.DescribeAutomationStepExecutionsXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var DescribeAutomationStepExecutionsXAmzTargetEnum;
...
})(DescribeAutomationStepExecutionsXAmzTargetEnum = exports.DescribeAutomationStepExecutionsXAmzTargetEnum || (exports.DescribeAutomationStepExecutionsXAmzTargetEnum = {}));
var DescribeAutomationStepExecutionsRequest = /** @class */ (function (_super) {
    ...
    ], DescribeAutomationStepExecutionsRequest.prototype, "describeAutomationStepExecutionsRequest", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], DescribeAutomationStepExecutionsRequest.prototype, "xAmzTarget", void 0);
...
var DescribeAutomationStepExecutionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DescribeAutomationStepExecutionsResponse.prototype, "rawResponse", void 0);
    return DescribeAutomationStepExecutionsResponse;
}(utils_1.SpeakeasyBase));
exports.DescribeAutomationStepExecutionsResponse = DescribeAutomationStepExecutionsResponse;
