...
public class WebmastersSitesGetRequest {
    ...
    public WebmastersSitesGetRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public WebmastersSitesGetRequest withAccessToken(String accessToken) {
    ...
    public WebmastersSitesGetRequest withCallback(String callback) {
    ...
    public WebmastersSitesGetRequest withUploadType(String uploadType) {
    ...
    public WebmastersSitesGetRequest withUploadProtocol(String uploadProtocol) {
