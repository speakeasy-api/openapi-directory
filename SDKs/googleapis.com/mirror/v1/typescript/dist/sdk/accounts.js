...
var Accounts = /** @class */ (function () {
    ...
    **/
    Accounts.prototype.mirrorAccountsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MirrorAccountsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/accounts/{userToken}/{accountType}/{accountName}", req.pathParams);
