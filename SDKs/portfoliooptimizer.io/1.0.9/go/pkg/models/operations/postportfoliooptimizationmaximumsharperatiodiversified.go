...
type PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBodyConstraints struct {
...
type PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBody struct {
	...
	Constraints   *PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBodyConstraints `json:"constraints,omitempty"`
	// The risk free rate
...
type PostPortfolioOptimizationMaximumSharpeRatioDiversifiedResponse struct {
	ContentType string
	StatusCode  int
