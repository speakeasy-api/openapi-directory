...
class DescribeClientVpnAuthorizationRulesRequestFilters:
...
class DescribeClientVpnAuthorizationRulesRequest:
    ...
    filters: Optional[list[DescribeClientVpnAuthorizationRulesRequestFilters]] = dataclasses.field(default=None)  
