...
class V1p4beta1:
    ...
    def cloudasset_analyze_iam_policy(self, request: operations.CloudassetAnalyzeIamPolicyRequest) -> operations.CloudassetAnalyzeIamPolicyResponse:
        ...
        url = utils.generate_url(base_url, "/v1p4beta1/{parent}:analyzeIamPolicy", request.path_params)
    ...
    def cloudasset_export_iam_policy_analysis(self, request: operations.CloudassetExportIamPolicyAnalysisRequest) -> operations.CloudassetExportIamPolicyAnalysisResponse:
        ...
        url = utils.generate_url(base_url, "/v1p4beta1/{parent}:exportIamPolicyAnalysis", request.path_params)
        ...
        res = operations.CloudassetExportIamPolicyAnalysisResponse(status_code=r.status_code, content_type=content_type)
