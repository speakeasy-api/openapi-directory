...
public class DirectoryChromeosdevicesUpdatePathParams {
    /**
    ...
    public DirectoryChromeosdevicesUpdatePathParams withCustomerId(String customerId) {
    ...
    public DirectoryChromeosdevicesUpdatePathParams withDeviceId(String deviceId) {
