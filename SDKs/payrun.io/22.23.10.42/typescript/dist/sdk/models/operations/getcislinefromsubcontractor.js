...
exports.GetCisLineFromSubContractorResponse = exports.GetCisLineFromSubContractorRequest = void 0;
...
var GetCisLineFromSubContractorRequest = /** @class */ (function (_super) {
    ...
    ], GetCisLineFromSubContractorRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetCisLineFromSubContractorRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisLineId",
        }),
        __metadata("design:type", String)
    ], GetCisLineFromSubContractorRequest.prototype, "cisLineId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetCisLineFromSubContractorRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetCisLineFromSubContractorRequest.prototype, "subContractorId", void 0);
...
var GetCisLineFromSubContractorResponse = /** @class */ (function (_super) {
    ...
    ], GetCisLineFromSubContractorResponse.prototype, "rawResponse", void 0);
