...
class CloudsearchMediaUploadSecurity:
    ...
    option1: Optional[CloudsearchMediaUploadSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[CloudsearchMediaUploadSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
