...
class DescribeLDAPSSettingsRequest:
    ...
    describe_ldaps_settings_request: shared_describeldapssettingsrequest.DescribeLDAPSSettingsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
