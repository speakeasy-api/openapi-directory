...
export class Atm {
  ...
  getAtms(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetAtmsResponse = new operations.GetAtmsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.getAtms200ApplicationPrsOpenbankingOpendataV13PlusJsonObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetAtms200ApplicationPrsOpenbankingOpendataV13PlusJson
              );
          }
          break;
        case httpRes?.status == 400:
          if (
            ...
            res.fourHundredErrorObject = utils.objectToClass(
              httpRes?.data,
              operations.GetAtms400ErrorObject
            );
          }
          break;
        case httpRes?.status == 408:
          if (
            ...
            res.fourHundredAndEightErrorObject = utils.objectToClass(
              httpRes?.data,
              operations.GetAtms408ErrorObject
            );
          }
          break;
        case httpRes?.status == 429:
          if (
            ...
            res.fourHundredAndTwentyNineErrorObject = utils.objectToClass(
              httpRes?.data,
              operations.GetAtms429ErrorObject
            );
          }
          break;
        case httpRes?.status == 500:
          if (
            ...
            res.fiveHundredErrorObject = utils.objectToClass(
              httpRes?.data,
              operations.GetAtms500ErrorObject
            );
          }
          break;
        case httpRes?.status == 503:
          if (
            ...
            res.fiveHundredAndThreeErrorObject = utils.objectToClass(
              httpRes?.data,
              operations.GetAtms503ErrorObject
            );
          }
          break;
        default:
  ...
  headAtms(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.HeadAtmsResponse = new operations.HeadAtmsResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
