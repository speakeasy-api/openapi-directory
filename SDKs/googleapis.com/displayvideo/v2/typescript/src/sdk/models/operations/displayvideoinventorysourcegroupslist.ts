...
export class DisplayvideoInventorySourceGroupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoInventorySourceGroupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoInventorySourceGroupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
