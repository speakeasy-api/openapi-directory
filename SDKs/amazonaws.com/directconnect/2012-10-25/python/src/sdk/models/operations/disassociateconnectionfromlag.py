...
class DisassociateConnectionFromLagRequest:
    headers: DisassociateConnectionFromLagHeaders = dataclasses.field()
    request: shared_disassociateconnectionfromlagrequest.DisassociateConnectionFromLagRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
