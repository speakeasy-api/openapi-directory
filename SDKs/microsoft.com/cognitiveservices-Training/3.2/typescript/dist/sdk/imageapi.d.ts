...
export declare class ImageApi {
    ...
    **/
    querySuggestedImageCount(req: operations.QuerySuggestedImageCountRequest, config?: AxiosRequestConfig): Promise<operations.QuerySuggestedImageCountResponse>;
    /**
    ...
    **/
    querySuggestedImages(req: operations.QuerySuggestedImagesRequest, config?: AxiosRequestConfig): Promise<operations.QuerySuggestedImagesResponse>;
}
