...
class BankAccountDto:
    r"""Information of Bank Account to create."""
    ...
    o_balance: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('oBalance'), 'exclude': lambda f: f is None }})  
