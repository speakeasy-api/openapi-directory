...
public class PodcasterAPI {
    ...
    public org.openapis.openapi.models.operations.DeletePodcastByIdResponse deletePodcastById(org.openapis.openapi.models.operations.DeletePodcastByIdRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.DeletePodcastByIdPathParams.class, baseUrl, "/podcasts/{id}", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("DELETE");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.DeletePodcastByIdQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
