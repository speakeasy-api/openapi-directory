...
class GetObjectStatusDiffUsingGetPathParams:
...
@dataclasses.dataclass
class GetObjectStatusDiffUsingGetRequest:
    path_params: GetObjectStatusDiffUsingGetPathParams = dataclasses.field()
    

@dataclasses.dataclass
class GetObjectStatusDiffUsingGetResponse:
