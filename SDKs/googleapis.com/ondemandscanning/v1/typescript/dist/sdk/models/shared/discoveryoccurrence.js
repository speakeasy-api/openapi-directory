...
var DiscoveryOccurrence = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "analysisCompleted" }),
        (0, class_transformer_1.Type)(function () { return analysiscompleted_1.AnalysisCompleted; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "analysisError" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "analysisStatusError" }),
        (0, class_transformer_1.Type)(function () { return status_1.Status; }),
        __metadata("design:type", status_1.Status)
    ], DiscoveryOccurrence.prototype, "analysisStatusError", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "archiveTime" }),
        __metadata("design:type", String)
    ], DiscoveryOccurrence.prototype, "archiveTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "continuousAnalysis" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lastScanTime" }),
        __metadata("design:type", String)
