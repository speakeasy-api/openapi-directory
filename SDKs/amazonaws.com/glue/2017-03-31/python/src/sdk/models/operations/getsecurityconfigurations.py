...
class GetSecurityConfigurationsRequest:
    ...
    get_security_configurations_request: shared_getsecurityconfigurationsrequest.GetSecurityConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
