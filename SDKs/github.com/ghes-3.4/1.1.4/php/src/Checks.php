...
class Checks 
{
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#create-a-check-run
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#create-a-check-suite
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#get-a-check-run
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#get-a-check-suite
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#list-check-run-annotations
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#list-check-runs-for-a-git-reference
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#list-check-runs-in-a-check-suite
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#list-check-suites-for-a-git-reference
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#rerequest-a-check-run
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#rerequest-a-check-suite
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#update-repository-preferences-for-check-suites
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.4/rest/reference/checks#update-a-check-run
     */
