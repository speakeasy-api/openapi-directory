...
public class VerifyMobileOTPForTxnUsingPOSTRequest {
    ...
    public VerifyMobileOTPForTxnUsingPOSTRequest(@JsonProperty("VerifyMobileRequest") org.openapis.openapi.models.shared.VerifyMobileRequest verifyMobileRequest) {
        this.verifyMobileRequest = verifyMobileRequest;
  }
}
