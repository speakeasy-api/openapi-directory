...
class GetNhArtArtworkRequest:
    ...
    artwork: str = dataclasses.field(metadata={'path_param': { 'field_name': 'artwork', 'style': 'simple', 'explode': False }})
    r"""The name of the artwork you wish to retrieve information about."""  
...
class GetNhArtArtworkResponse:
    ...
    nh_artwork: Optional[shared_nhartwork.NHArtwork] = dataclasses.field(default=None)
