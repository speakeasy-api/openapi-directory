...
class ListComplianceStatusRequest:
    ...
    list_compliance_status_request: shared_listcompliancestatusrequest.ListComplianceStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
