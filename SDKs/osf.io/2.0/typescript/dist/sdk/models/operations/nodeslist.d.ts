 ...
 */
export declare enum NodesListNodeAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class NodesListNodeAttributes extends SpeakeasyBase {
    /**
     * The category of the node, as selected by project contributors.
     */
    category: NodesListNodeAttributesCategoryEnum;
    /**
 ...
 */
export declare class NodesListNodeLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodesListNodeRelationships extends SpeakeasyBase {
    /**
...
export declare class NodesListNode extends SpeakeasyBase {
    /**
     * The properties of the node entity.
     */
    attributes: NodesListNodeAttributes;
    /**
     ...
     * URLs to alternative representations of the node entity.
     */
    links?: NodesListNodeLinks;
    /**
     * URLs to other entities or entity collections that have a relationship to the node entity.
     */
    relationships?: NodesListNodeRelationships;
    /**
     * The type identifier of the node entity (`nodes`).
     */
    type: string;
}
export declare class NodesListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
