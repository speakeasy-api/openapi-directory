...
type DeleteSKUsellerassociationPathParams struct {
...
type DeleteSKUsellerassociationHeaders struct {
...
type DeleteSKUsellerassociationRequest struct {
	PathParams DeleteSKUsellerassociationPathParams
	Headers    DeleteSKUsellerassociationHeaders
}
