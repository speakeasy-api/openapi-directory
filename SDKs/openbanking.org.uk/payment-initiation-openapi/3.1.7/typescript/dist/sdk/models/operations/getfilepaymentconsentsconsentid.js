...
exports.GetFilePaymentConsentsConsentIdResponse = exports.GetFilePaymentConsentsConsentIdRequest = exports.GetFilePaymentConsentsConsentIdSecurity = void 0;
...
exports.GetFilePaymentConsentsConsentIdSecurity = GetFilePaymentConsentsConsentIdSecurity;
var GetFilePaymentConsentsConsentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConsentId",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetFilePaymentConsentsConsentIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetFilePaymentConsentsConsentIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentConsentsConsentIdRequest = GetFilePaymentConsentsConsentIdRequest;
var GetFilePaymentConsentsConsentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetFilePaymentConsentsConsentIdResponse.prototype, "rawResponse", void 0);
    return GetFilePaymentConsentsConsentIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetFilePaymentConsentsConsentIdResponse = GetFilePaymentConsentsConsentIdResponse;
