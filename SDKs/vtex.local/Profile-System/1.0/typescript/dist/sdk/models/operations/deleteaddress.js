...
var DeleteAddressRequest = /** @class */ (function (_super) {
    ...
    ], DeleteAddressRequest.prototype, "accept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Content-Type",
        }),
        __metadata("design:type", String)
    ], DeleteAddressRequest.prototype, "contentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=addressId",
        }),
        __metadata("design:type", String)
    ], DeleteAddressRequest.prototype, "addressId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=alternativeKey",
        }),
        __metadata("design:type", String)
    ], DeleteAddressRequest.prototype, "alternativeKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=profileId",
        }),
        __metadata("design:type", String)
    ], DeleteAddressRequest.prototype, "profileId", void 0);
