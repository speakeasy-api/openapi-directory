...
from ..shared import getinvoicesresponse as shared_getinvoicesresponse
from ..shared import invoicessort as shared_invoicessort
...
class InvoicesAllRequest:
    ...
    sort: Optional[shared_invoicessort.InvoicesSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
    r"""Apply sorting"""  
...
class InvoicesAllResponse:
    ...
    r"""Bad Request"""  
    get_invoices_response: Optional[shared_getinvoicesresponse.GetInvoicesResponse] = dataclasses.field(default=None)
    r"""Invoices"""  
