 ...
 */
export declare enum AddressAggregatedListWarningCodeEnum {
...
export declare class AddressAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class AddressAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class AddressAggregatedList extends SpeakeasyBase {
    /**
