...
exports.NlpAnnotate = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var NlpAnnotate = /** @class */ (function () {
    function NlpAnnotate(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    NlpAnnotate.prototype.getAnnotate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAnnotateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/nlp/annotate/";
    ...
    **/
    NlpAnnotate.prototype.getAnnotateEntities = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAnnotateEntitiesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/nlp/annotate/entities";
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.entityAnnotationResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    NlpAnnotate.prototype.postAnnotate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    NlpAnnotate.prototype.postAnnotateEntities = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.NlpAnnotate = NlpAnnotate;
