...
**/
var CertificateMap = /** @class */ (function (_super) {
    __extends(CertificateMap, _super);
    function CertificateMap() {
 ...
 * Defines a collection of certificate configurations.
**/
var CertificateMapInput = /** @class */ (function (_super) {
    __extends(CertificateMapInput, _super);
    function CertificateMapInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=description" }),
