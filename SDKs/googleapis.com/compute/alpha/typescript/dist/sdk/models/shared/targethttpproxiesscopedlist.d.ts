 ...
 */
export declare enum TargetHttpProxiesScopedListWarningCodeEnum {
...
export declare class TargetHttpProxiesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetHttpProxiesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class TargetHttpProxiesScopedList extends SpeakeasyBase {
    /**
