...
class PaginatedApplicationDocumentResult:
    ...
    meta: PaginatedApplicationDocumentResultMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta') }})
    r"""Metadata associated with the response data"""  
    response: list[shared_applicationdocumentresult.ApplicationDocumentResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response') }})
    r"""List of application document results"""  
