 ...
 */
export enum HealthChecksScopedListWarningCodeEnum {
...
export class HealthChecksScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HealthChecksScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: HealthChecksScopedListWarningData })
  @Expose({ name: "data" })
...
export class HealthChecksScopedList extends SpeakeasyBase {
  /**
