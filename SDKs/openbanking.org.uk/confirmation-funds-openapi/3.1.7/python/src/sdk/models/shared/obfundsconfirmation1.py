...
class ObFundsConfirmation1Data:
    ...
    instructed_amount: ObFundsConfirmation1DataInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('InstructedAmount') }})
...
class ObFundsConfirmation1:
    data: ObFundsConfirmation1Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
