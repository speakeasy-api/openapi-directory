 ...
 */
export const ServerList = ["https://{protocol}://{hostname}/api/v3"] as const;
 ...
 *
 * @see {@link https://docs.github.com/enterprise-server@3.0/rest/} - GitHub Enterprise Developer Docs
 */
export class SDK {
  /**
