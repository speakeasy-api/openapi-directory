...
var Branch = /** @class */ (function () {
    function Branch(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Branch.prototype.getBranches = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetBranchesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/branches";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/prs.openbanking.opendata.v1.3+json")) {
                        res.getBranches200ApplicationPrsOpenbankingOpendataV13PlusJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Branch.prototype.headBranches = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
