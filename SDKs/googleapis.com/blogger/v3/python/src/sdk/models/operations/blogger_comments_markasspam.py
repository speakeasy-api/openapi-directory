...
class BloggerCommentsMarkAsSpamPathParams:
...
@dataclasses.dataclass
class BloggerCommentsMarkAsSpamQueryParams:
...
@dataclasses.dataclass
class BloggerCommentsMarkAsSpamSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class BloggerCommentsMarkAsSpamRequest:
    path_params: BloggerCommentsMarkAsSpamPathParams = dataclasses.field()
    query_params: BloggerCommentsMarkAsSpamQueryParams = dataclasses.field()
    security: BloggerCommentsMarkAsSpamSecurity = dataclasses.field()
    

@dataclasses.dataclass
class BloggerCommentsMarkAsSpamResponse:
