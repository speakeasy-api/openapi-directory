...
var Raster = /** @class */ (function () {
    function Raster(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Raster.prototype.getMapVersionNumberStaticimage = function (req, config) {
    ...
    **/
    Raster.prototype.getMapVersionNumberTileLayerStyleZoomXYFormat = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
