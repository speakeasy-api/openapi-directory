...
public class ClientRegistrationPolicy {
	...
	public ClientRegistrationPolicy(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
