...
class Users 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoUsersBulkEditAssignedUserRolesResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/users/{userId}:bulkEditAssignedUserRoles', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoUsersBulkEditAssignedUserRolesRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/users/{userId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoUsersDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/users/{userId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoUsersGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v2/users/{userId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoUsersPatchRequest::class, $request);
