...
class ExtrasExportTemplatesListQueryParams:
    ...
    content_type_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'content_type__n', 'style': 'form', 'explode': True }})
    ...
    template_language: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'template_language', 'style': 'form', 'explode': True }})
    template_language_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'template_language__n', 'style': 'form', 'explode': True }})
