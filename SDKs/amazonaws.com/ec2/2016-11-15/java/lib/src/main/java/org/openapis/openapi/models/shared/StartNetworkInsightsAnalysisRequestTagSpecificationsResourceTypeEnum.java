 ...
 */
public enum StartNetworkInsightsAnalysisRequestTagSpecificationsResourceTypeEnum {
    ...
    private StartNetworkInsightsAnalysisRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
