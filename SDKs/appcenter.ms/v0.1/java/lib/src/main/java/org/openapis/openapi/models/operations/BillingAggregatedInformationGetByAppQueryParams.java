...
public class BillingAggregatedInformationGetByAppQueryParams {
    /**
    ...
    public BillingAggregatedInformationGetByAppQueryParams withPeriod(BillingAggregatedInformationGetByAppPeriodEnum period) {
        this.period = period;
        return this;
    }
    ...
    public BillingAggregatedInformationGetByAppQueryParams withService(BillingAggregatedInformationGetByAppServiceEnum service) {
    ...
    public BillingAggregatedInformationGetByAppQueryParams withShowOriginalPlans(Boolean showOriginalPlans) {
