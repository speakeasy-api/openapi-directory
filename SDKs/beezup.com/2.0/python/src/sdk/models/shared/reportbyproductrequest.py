...
class ReportByProductRequest:
    ...
    product_state: shared_productstatefilter_enum.ProductStateFilterEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('productState') }})
