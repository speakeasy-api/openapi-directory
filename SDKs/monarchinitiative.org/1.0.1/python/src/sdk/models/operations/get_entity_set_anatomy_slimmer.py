...
class GetEntitySetAnatomySlimmerQueryParams:
...
class GetEntitySetAnatomySlimmerRequest:
    query_params: GetEntitySetAnatomySlimmerQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetEntitySetAnatomySlimmerResponse:
