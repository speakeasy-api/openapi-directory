...
exports.LambdaFunctionCompletedEventAttributes = void 0;
var utils_1 = require("../../../internal/utils");
// LambdaFunctionCompletedEventAttributes
/**
 * Provides the details of the <code>LambdaFunctionCompleted</code> event. It isn't set for other event types.
**/
var LambdaFunctionCompletedEventAttributes = /** @class */ (function (_super) {
    __extends(LambdaFunctionCompletedEventAttributes, _super);
    ...
    ], LambdaFunctionCompletedEventAttributes.prototype, "result", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=scheduledEventId" }),
        __metadata("design:type", Number)
    ], LambdaFunctionCompletedEventAttributes.prototype, "scheduledEventId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startedEventId" }),
        __metadata("design:type", Number)
    ], LambdaFunctionCompletedEventAttributes.prototype, "startedEventId", void 0);
