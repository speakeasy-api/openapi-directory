...
export class ContentOrdersAcknowledgeSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentOrdersAcknowledgeRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentOrdersAcknowledgeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
