...
class DeleteDeviceDefinitionRequest:
    headers: DeleteDeviceDefinitionHeaders = dataclasses.field()
    path_params: DeleteDeviceDefinitionPathParams = dataclasses.field()
...
class DeleteDeviceDefinitionResponse:
    ...
    delete_device_definition_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
