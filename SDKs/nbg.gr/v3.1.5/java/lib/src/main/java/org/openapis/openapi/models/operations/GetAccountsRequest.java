...
public class GetAccountsRequest {
    ...
    public GetAccountsRequest withSandboxId(String sandboxId) {
    ...
    public GetAccountsRequest withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountsRequest withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountsRequest withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public GetAccountsRequest withXFapiInteractionId(String xFapiInteractionId) {
        this.xFapiInteractionId = xFapiInteractionId;
        return this;
    }
    
    public GetAccountsRequest(@JsonProperty("sandbox-id") String sandboxId) {
        this.sandboxId = sandboxId;
  }
}
