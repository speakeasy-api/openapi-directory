...
func (e DescribeProcessingJobXAmzTargetEnum) ToPointer() *DescribeProcessingJobXAmzTargetEnum {
	return &e
}
...
func (e *DescribeProcessingJobXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "SageMaker.DescribeProcessingJob":
		*e = DescribeProcessingJobXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeProcessingJobXAmzTargetEnum: %v", v)
	}
}
