...
class AnalyticsManagementProfileUserLinksInsertRequest:
    path_params: AnalyticsManagementProfileUserLinksInsertPathParams = dataclasses.field()
    query_params: AnalyticsManagementProfileUserLinksInsertQueryParams = dataclasses.field()
    security: AnalyticsManagementProfileUserLinksInsertSecurity = dataclasses.field()
