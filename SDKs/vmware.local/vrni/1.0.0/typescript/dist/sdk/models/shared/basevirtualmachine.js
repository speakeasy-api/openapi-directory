...
var BaseVirtualMachine = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_gateway" }),
        __metadata("design:type", String)
    ], BaseVirtualMachine.prototype, "defaultGateway", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destination_firewall_rules", elemType: ruleset_1.RuleSet }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ip_sets", elemType: reference_1.Reference }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=source_firewall_rules", elemType: ruleset_1.RuleSet }),
        __metadata("design:type", Array)
    ], BaseVirtualMachine.prototype, "sourceFirewallRules", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vnics", elemType: reference_1.Reference }),
        __metadata("design:type", Array)
