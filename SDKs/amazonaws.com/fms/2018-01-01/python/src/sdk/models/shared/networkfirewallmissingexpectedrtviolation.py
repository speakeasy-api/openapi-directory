...
class NetworkFirewallMissingExpectedRtViolation:
    ...
    current_route_table: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CurrentRouteTable') }})
    expected_route_table: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ExpectedRouteTable') }})
