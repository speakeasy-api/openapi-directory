...
exports.FirmwareUpgrades = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var FirmwareUpgrades = /** @class */ (function () {
    function FirmwareUpgrades(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    FirmwareUpgrades.prototype.createNetworkFirmwareUpgradesRollback = function (req, config) {
        var _a;
    ...
    **/
    FirmwareUpgrades.prototype.getNetworkFirmwareUpgrades = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FirmwareUpgrades.prototype.updateNetworkFirmwareUpgrades = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.FirmwareUpgrades = FirmwareUpgrades;
