...
type SnapshotLocationRetentionInfo struct {
	...
	IsExpirationDateCalculated *bool `json:"isExpirationDateCalculated,omitempty"`
	...
	//
	IsExpirationInformationUnavailable *bool `json:"isExpirationInformationUnavailable,omitempty"`
	...
	IsSnapshotPresent bool `json:"isSnapshotPresent"`
