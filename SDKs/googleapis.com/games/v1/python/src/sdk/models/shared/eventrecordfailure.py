...
class EventRecordFailure:
    ...
    failure_cause: Optional[EventRecordFailureFailureCauseEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('failureCause') }})
