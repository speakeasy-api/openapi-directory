 ...
 */
public class DescribeInstanceTypeOfferingsRequestFilters {
    
    public String name;

    public DescribeInstanceTypeOfferingsRequestFilters withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DescribeInstanceTypeOfferingsRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeInstanceTypeOfferingsRequestFilters(){}
}
