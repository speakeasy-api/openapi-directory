...
public class UpdateKnowledgeBaseTemplateUriRequest {
    ...
    public UpdateKnowledgeBaseTemplateUriRequest(@JsonProperty("RequestBody") UpdateKnowledgeBaseTemplateUriRequestBody requestBody, @JsonProperty("knowledgeBaseId") String knowledgeBaseId) {
        this.requestBody = requestBody;
        this.knowledgeBaseId = knowledgeBaseId;
  }
}
