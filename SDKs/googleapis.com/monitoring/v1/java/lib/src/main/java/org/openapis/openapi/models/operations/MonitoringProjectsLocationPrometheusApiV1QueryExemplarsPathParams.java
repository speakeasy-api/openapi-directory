...
public class MonitoringProjectsLocationPrometheusApiV1QueryExemplarsPathParams {
    /**
     * Location of the resource information. Has to be "global" now.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=location")
    public String location;
    public MonitoringProjectsLocationPrometheusApiV1QueryExemplarsPathParams withLocation(String location) {
    ...
    public String name;
    public MonitoringProjectsLocationPrometheusApiV1QueryExemplarsPathParams withName(String name) {
        this.name = name;
        return this;
    }
