...
class ListSimulationJobsRequest:
    ...
    request_body: ListSimulationJobsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
