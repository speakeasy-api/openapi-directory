...
class RefundTransactionLogs:
    ...
    def object_get_refund_transaction_log(self, request: operations.ObjectGETRefundTransactionLogRequest) -> operations.ObjectGETRefundTransactionLogResponse:
        ...
        url = utils.generate_url(operations.ObjectGETRefundTransactionLogRequest, base_url, '/v1/object/refund-transaction-log/{id}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ObjectGETRefundTransactionLogRequest, request)
        ...
        res = operations.ObjectGETRefundTransactionLogResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json; charset=utf-8'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProxyGetRefundTransactionLog])
