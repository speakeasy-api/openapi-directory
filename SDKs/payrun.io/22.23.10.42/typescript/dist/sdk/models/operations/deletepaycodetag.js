...
exports.DeletePayCodeTagResponse = exports.DeletePayCodeTagRequest = void 0;
...
var DeletePayCodeTagRequest = /** @class */ (function (_super) {
    ...
    ], DeletePayCodeTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeletePayCodeTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeletePayCodeTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayCodeId",
        }),
        __metadata("design:type", String)
    ], DeletePayCodeTagRequest.prototype, "payCodeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeletePayCodeTagRequest.prototype, "tagId", void 0);
...
var DeletePayCodeTagResponse = /** @class */ (function (_super) {
    ...
    ], DeletePayCodeTagResponse.prototype, "rawResponse", void 0);
