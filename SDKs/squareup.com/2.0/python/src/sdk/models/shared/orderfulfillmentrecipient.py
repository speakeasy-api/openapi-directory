...
class OrderFulfillmentRecipient:
    ...
    r"""The customer ID of the customer associated with the fulfillment.
    ...
    r"""The display name of the fulfillment recipient.
    ...
    r"""The email address of the fulfillment recipient.
    ...
    r"""The phone number of the fulfillment recipient.
