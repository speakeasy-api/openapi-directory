...
export class NonPrimaryStateTax {
  ...
  addOrUpdateNonPrimaryStateTax(
    ...
    security: operations.AddOrUpdateNonPrimaryStateTaxSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddOrUpdateNonPrimaryStateTaxResponse =
        new operations.AddOrUpdateNonPrimaryStateTaxResponse({
