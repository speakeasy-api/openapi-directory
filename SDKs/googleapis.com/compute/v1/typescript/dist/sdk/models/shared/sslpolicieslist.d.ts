 ...
 */
export declare enum SslPoliciesListWarningCodeEnum {
...
export declare class SslPoliciesListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SslPoliciesListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: SslPoliciesListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: SslPoliciesListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class SslPoliciesList extends SpeakeasyBase {
    /**
