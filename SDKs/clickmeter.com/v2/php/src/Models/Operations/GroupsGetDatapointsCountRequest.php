...
class GroupsGetDatapointsCountRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GroupsGetDatapointsCountStatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?GroupsGetDatapointsCountStatusEnum $status = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GroupsGetDatapointsCountTypeEnum $type
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=type')]
    public ?GroupsGetDatapointsCountTypeEnum $type = null;
