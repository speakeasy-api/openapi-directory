...
class UpsertUser500ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\UpsertUser500ApplicationJSONMeta')]
    public UpsertUser500ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\UpsertUser500ApplicationJSONMeta();
	}
}
