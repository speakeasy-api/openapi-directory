...
export class OauthAuthorizations {
  ...
  oauthAuthorizationsCheckAuthorization(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.OauthAuthorizationsCheckAuthorizationResponse =
        new operations.OauthAuthorizationsCheckAuthorizationResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.authorizationWithUser = utils.objectToClass(
              httpRes?.data,
              shared.AuthorizationWithUser
            );
          }
          break;
      }
  ...
  oauthAuthorizationsResetAuthorization(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.OauthAuthorizationsResetAuthorizationResponse =
        new operations.OauthAuthorizationsResetAuthorizationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  oauthAuthorizationsRevokeAuthorizationForApplication(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.OauthAuthorizationsRevokeAuthorizationForApplicationRequest(
          req
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse =
        new operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  oauthAuthorizationsRevokeGrantForApplication(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.OauthAuthorizationsRevokeGrantForApplicationRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.OauthAuthorizationsRevokeGrantForApplicationResponse =
        new operations.OauthAuthorizationsRevokeGrantForApplicationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
