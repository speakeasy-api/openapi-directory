...
@dataclasses.dataclass
class DataprocProjectsRegionsJobsPatchQueryParams:
...
class DataprocProjectsRegionsJobsPatchRequest:
    path_params: DataprocProjectsRegionsJobsPatchPathParams = dataclasses.field()
    query_params: DataprocProjectsRegionsJobsPatchQueryParams = dataclasses.field()
    security: DataprocProjectsRegionsJobsPatchSecurity = dataclasses.field()
    request: Optional[shared_job.JobInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
