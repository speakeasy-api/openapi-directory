...
class Cinema:
    ...
    def cinema_search_read(self, request: operations.CinemaSearchReadRequest) -> operations.CinemaSearchReadResponse:
        ...
        * __{id}__: Used as a key to search cinemas,
        ...
        url = utils.generate_url(operations.CinemaSearchReadRequest, base_url, '/api/v1/cinema/search/{id}', request)
        ...
        res = operations.CinemaSearchReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
