...
class AppsListForOrgSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    

@dataclasses.dataclass
class AppsListForOrgRequest:
...
class AppsListForOrgDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
class AppsListForOrgDefaultApplicationJSONError:
    ...
    code: AppsListForOrgDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class AppsListForOrgDefaultApplicationJSON:
    ...
    error: AppsListForOrgDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsListForOrg200ApplicationJSONAzureSubscription:
...
class AppsListForOrg200ApplicationJSONMemberPermissionsEnum(str, Enum):
    MANAGER = 'manager'
    DEVELOPER = 'developer'
    VIEWER = 'viewer'
    TESTER = 'tester'

class AppsListForOrg200ApplicationJSONOriginEnum(str, Enum):
    r"""The creation origin of this app"""
    APPCENTER = 'appcenter'
    HOCKEYAPP = 'hockeyapp'
    CODEPUSH = 'codepush'

class AppsListForOrg200ApplicationJSONOsEnum(str, Enum):
...
class AppsListForOrg200ApplicationJSONOwnerTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsListForOrg200ApplicationJSONOwner:
    ...
    type: AppsListForOrg200ApplicationJSONOwnerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The owner type. Can either be 'org' or 'user'"""  
...
class AppsListForOrg200ApplicationJSONPlatformEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsListForOrg200ApplicationJSON:
    ...
    origin: AppsListForOrg200ApplicationJSONOriginEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin') }})
    r"""The creation origin of this app"""  
    os: AppsListForOrg200ApplicationJSONOsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('os') }})
    r"""The OS the app will be running on"""  
    owner: AppsListForOrg200ApplicationJSONOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The information about the app's owner"""  
    platform: AppsListForOrg200ApplicationJSONPlatformEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform') }})
    r"""The platform of the app"""  
    azure_subscription: Optional[AppsListForOrg200ApplicationJSONAzureSubscription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('azure_subscription'), 'exclude': lambda f: f is None }})  
    ...
    member_permissions: Optional[list[AppsListForOrg200ApplicationJSONMemberPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('member_permissions'), 'exclude': lambda f: f is None }})
...
class AppsListForOrgResponse:
    ...
    apps_list_for_org_200_application_json_anies: Optional[list[AppsListForOrg200ApplicationJSON]] = dataclasses.field(default=None)
    r"""Success"""  
    apps_list_for_org_default_application_json_object: Optional[AppsListForOrgDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
