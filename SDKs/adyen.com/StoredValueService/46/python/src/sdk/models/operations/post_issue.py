...
from ..shared import storedvalueissueresponse as shared_storedvalueissueresponse
...
class PostIssueResponse:
    ...
    stored_value_issue_response: Optional[shared_storedvalueissueresponse.StoredValueIssueResponse] = dataclasses.field(default=None)
