...
try {
    ...
    $response = $sdk->messaging->getUpcomingScheduledCampaignsAndCanvases($request);
...
try {
    ...
    $request->schedule->time = 'error';

    $response = $sdk->messaging->scheduleApiTriggeredCanvases($request);
