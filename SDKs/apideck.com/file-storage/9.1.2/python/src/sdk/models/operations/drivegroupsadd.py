...
from ..shared import createdrivegroupresponse as shared_createdrivegroupresponse
...
@dataclasses.dataclass
class DriveGroupsAddResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    create_drive_group_response: Optional[shared_createdrivegroupresponse.CreateDriveGroupResponse] = dataclasses.field(default=None)
    r"""DriveGroups"""  
