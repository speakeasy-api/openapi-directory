 ...
 */
export enum GetNetworkDeviceLossAndLatencyHistoryUplinkEnum {
  Cellular = "cellular",
  Wan1 = "wan1",
  Wan2 = "wan2",
}

export class GetNetworkDeviceLossAndLatencyHistoryRequest extends SpeakeasyBase {
  /**
...
export class GetNetworkDeviceLossAndLatencyHistoryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkDeviceLossAndLatencyHistory200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
