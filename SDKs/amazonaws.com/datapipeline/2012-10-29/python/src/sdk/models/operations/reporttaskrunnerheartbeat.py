...
class ReportTaskRunnerHeartbeatRequest:
    ...
    report_task_runner_heartbeat_input: shared_reporttaskrunnerheartbeatinput.ReportTaskRunnerHeartbeatInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
