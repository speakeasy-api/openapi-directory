 ...
 */
public enum AccountSettings200ApplicationXMLAccountSettingsScheduleMeetingAudioTypeEnum {
    BOTH("both"),
    TELEPHONY("telephony"),
    VOIP("voip"),
    ...
    private AccountSettings200ApplicationXMLAccountSettingsScheduleMeetingAudioTypeEnum(String value) {
        this.value = value;
    }
}
