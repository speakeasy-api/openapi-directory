...
public class TeamsListSecurity {
    ...
    public TeamsListSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public TeamsListSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public TeamsListSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public TeamsListSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
