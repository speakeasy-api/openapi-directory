...
try {
    ...
    $request->requestBody->content = 'cupiditate';
    $request->requestBody->encoding = 'aperiam';
...
try {
    ...
    $request->requestBody->author->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-09-18T06:37:26.413Z');
    $request->requestBody->author->email = 'Marianne1@gmail.com';
    $request->requestBody->author->name = 'Percy Altenwerth';
    $request->requestBody->committer = new GitCreateCommitRequestBodyCommitter();
    $request->requestBody->committer->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2020-01-19T03:49:20.903Z');
    $request->requestBody->committer->email = 'Mckayla6@gmail.com';
    $request->requestBody->committer->name = 'Darren McClure';
    $request->requestBody->message = 'vero';
    $request->requestBody->parents = [
        'quis',
        'ipsum',
        'delectus',
    ];
    $request->requestBody->signature = 'voluptate';
    $request->requestBody->tree = 'consectetur';
    $request->owner = 'vero';
...
try {
    ...
    $request->requestBody->ref = 'dignissimos';
    $request->requestBody->sha = 'hic';
...
try {
    ...
    $request->requestBody->message = 'odio';
    $request->requestBody->object = 'similique';
    $request->requestBody->tag = 'facilis';
    $request->requestBody->tagger = new GitCreateTagRequestBodyTagger();
    $request->requestBody->tagger->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-07-04T12:52:28.765Z');
    $request->requestBody->tagger->email = 'Rosalinda61@gmail.com';
    $request->requestBody->tagger->name = 'Richard Wiza';
...
try {
    ...
    $request->requestBody->baseTree = 'doloribus';
...
try {
    ...
    $request->owner = 'quasi';
    $request->recursive = 'ex';
    $request->repo = 'nulla';
    $request->treeSha = 'excepturi';
...
try {
    ...
    $request->page = 343605;
    $request->perPage = 960835;
    $request->ref = 'quisquam';
    $request->repo = 'saepe';
