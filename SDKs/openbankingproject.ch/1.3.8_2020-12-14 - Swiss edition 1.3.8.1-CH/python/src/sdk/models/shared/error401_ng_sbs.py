...
from ..shared import tppmessage401_sbs as shared_tppmessage401_sbs
...
class Error401NgSbs:
    ...
    tpp_messages: Optional[list[shared_tppmessage401_sbs.TppMessage401Sbs]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
