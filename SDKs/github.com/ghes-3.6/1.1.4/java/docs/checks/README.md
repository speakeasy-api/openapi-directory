...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksCreateSuiteRequest req = new ChecksCreateSuiteRequest(                new ChecksCreateSuiteRequestBody("veniam");, "aliquid", "inventore");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetRequest req = new ChecksGetRequest(301831L, "ea", "quo");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksGetSuiteRequest req = new ChecksGetSuiteRequest(232234L, "recusandae", "aspernatur");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListAnnotationsRequest req = new ChecksListAnnotationsRequest(325310L, "eaque", "a") {{
                page = 725595L;
                perPage = 13948L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForRefRequest req = new ChecksListForRefRequest("aut", "deleniti", "impedit") {{
                appId = 304582L;
                checkName = "fugit";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListForSuiteRequest req = new ChecksListForSuiteRequest(677412L, "laborum", "placeat") {{
                checkName = "velit";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksListSuitesForRefRequest req = new ChecksListSuitesForRefRequest("assumenda", "nulla", "voluptas") {{
                appId = 727044L;
                checkName = "quasi";
                page = 270328L;
                perPage = 256139L;
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.ChecksRerequestRunRequest;
import org.openapis.openapi.models.operations.ChecksRerequestRunResponse;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestRunRequest req = new ChecksRerequestRunRequest(131482L, "provident", "ipsa");            

            ChecksRerequestRunResponse res = sdk.checks.checksRerequestRun(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ChecksRerequestSuiteRequest req = new ChecksRerequestSuiteRequest(476477L, "magnam", "odio");            
        ...
        try {
            ...
            ChecksSetSuitesPreferencesRequest req = new ChecksSetSuitesPreferencesRequest(                new ChecksSetSuitesPreferencesRequestBody() {{
                                autoTriggerChecks = new org.openapis.openapi.models.operations.ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks[]{{
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(456141L, false) {{
                                        appId = 458515L;
                                        setting = false;
                                    }}),
                                    add(new ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks(683282L, false) {{
                                        appId = 524593L;
                                        setting = false;
                                    }}),
                                }};
