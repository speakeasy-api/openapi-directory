...
func (s *UserAuth) PostV05UsersAuthConfirm(ctx context.Context, request operations.PostV05UsersAuthConfirmRequest) (*operations.PostV05UsersAuthConfirmResponse, error) {
	...
	res := &operations.PostV05UsersAuthConfirmResponse{
...
func (s *UserAuth) PostV05UsersAuthFetchModes(ctx context.Context, request operations.PostV05UsersAuthFetchModesRequest) (*operations.PostV05UsersAuthFetchModesResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05UsersAuthFetchModesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *UserAuth) PostV05UsersAuthInit(ctx context.Context, request operations.PostV05UsersAuthInitRequest) (*operations.PostV05UsersAuthInitResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05UsersAuthInitResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *UserAuth) PostV05UsersAuthNotify(ctx context.Context, request operations.PostV05UsersAuthNotifyRequest) (*operations.PostV05UsersAuthNotifyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05UsersAuthNotifyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
//  1. **auth.accessToken** - is specific to the purpose mentioned in the /auth/init. This token needs to be used for initiating the intended action. For example for HIP initiated linking of care-contexts
//  2. **NOTE**, only one of **X-HIP-ID** or **X-HIU-ID** will be sent as part of header, not both.
func (s *UserAuth) PostV05UsersAuthOnConfirm(ctx context.Context, request operations.PostV05UsersAuthOnConfirmRequest) (*operations.PostV05UsersAuthOnConfirmResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05UsersAuthOnConfirmResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *UserAuth) PostV05UsersAuthOnFetchModes(ctx context.Context, request operations.PostV05UsersAuthOnFetchModesRequest) (*operations.PostV05UsersAuthOnFetchModesResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05UsersAuthOnFetchModesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *UserAuth) PostV05UsersAuthOnInit(ctx context.Context, request operations.PostV05UsersAuthOnInitRequest) (*operations.PostV05UsersAuthOnInitResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05UsersAuthOnInitResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *UserAuth) PostV05UsersAuthOnNotify(ctx context.Context, request operations.PostV05UsersAuthOnNotifyRequest) (*operations.PostV05UsersAuthOnNotifyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05UsersAuthOnNotifyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
