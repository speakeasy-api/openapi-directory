...
public class FirebaseappcheckProjectsServicesPatchRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1betaService request;
    public FirebaseappcheckProjectsServicesPatchRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1betaService request) {
