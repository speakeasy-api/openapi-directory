 ...
 */
export declare enum SecurityPoliciesScopedListWarningCodeEnum {
...
export declare class SecurityPoliciesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SecurityPoliciesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class SecurityPoliciesScopedList extends SpeakeasyBase {
    /**
