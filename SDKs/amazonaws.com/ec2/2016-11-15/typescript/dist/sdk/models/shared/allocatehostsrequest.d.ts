 ...
 */
export declare enum AllocateHostsRequestAutoPlacementEnum {
    On = "on",
    Off = "off"
}
/**
 ...
 */
export declare enum AllocateHostsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class AllocateHostsRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class AllocateHostsRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: AllocateHostsRequestTagSpecificationsResourceTypeEnum;
    tags?: AllocateHostsRequestTagSpecificationsTags[];
}
export declare class AllocateHostsRequest extends SpeakeasyBase {
