...
class CreateSlotTypeRequestBody:
    ...
    r"""The name for the slot. A slot type name must be unique within the account."""  
    composite_slot_type_setting: Optional[CreateSlotTypeRequestBodyCompositeSlotTypeSetting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('compositeSlotTypeSetting'), 'exclude': lambda f: f is None }})
    r"""A composite slot is a combination of two or more slots that capture multiple pieces of information in a single user input."""  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})
    r"""A description of the slot type. Use the description to help identify the slot type in lists."""  
    external_source_setting: Optional[CreateSlotTypeRequestBodyExternalSourceSetting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('externalSourceSetting'), 'exclude': lambda f: f is None }})
    r"""Provides information about the external source of the slot type's definition."""  
    ...
    r"""<p>The built-in slot type used as a parent of this slot type. When you define a parent slot type, the new slot type has the configuration of the parent slot type.</p> <p>Only <code>AMAZON.AlphaNumeric</code> is supported.</p>"""  
    ...
    r"""A list of <code>SlotTypeValue</code> objects that defines the values that the slot type can take. Each value can have a list of synonyms, additional values that help train the machine learning model about the values that it resolves for a slot."""  
    value_selection_setting: Optional[CreateSlotTypeRequestBodyValueSelectionSetting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('valueSelectionSetting'), 'exclude': lambda f: f is None }})
    r"""Contains settings used by Amazon Lex to select a slot value."""  
...
class CreateSlotTypeRequest:
    ...
    r"""The identifier of the bot associated with this slot type."""  
    bot_version: str = dataclasses.field(metadata={'path_param': { 'field_name': 'botVersion', 'style': 'simple', 'explode': False }})
    r"""The identifier of the bot version associated with this slot type."""  
    locale_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'localeId', 'style': 'simple', 'explode': False }})
    r"""The identifier of the language and locale that the slot type will be used in. The string must match one of the supported locales. All of the bots, intents, and slots used by the slot type must have the same locale. For more information, see <a href=\\"https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html\\">Supported languages</a>."""  
    request_body: CreateSlotTypeRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
