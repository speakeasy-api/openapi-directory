...
class AllMonitors200ApplicationJSON:
    ...
    monitors: Optional[list[AllMonitors200ApplicationJSONMonitors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('monitors'), 'exclude': lambda f: f is None }})  
