...
type IdentitytoolkitAccountsMfaEnrollmentFinalizeRequest struct {
	...
	GoogleCloudIdentitytoolkitV2FinalizeMfaEnrollmentRequest *shared.GoogleCloudIdentitytoolkitV2FinalizeMfaEnrollmentRequest `request:"mediaType=application/json"`
	// OAuth access token.
