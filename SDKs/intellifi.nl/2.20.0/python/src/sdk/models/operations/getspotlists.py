...
class GetSpotLists200ApplicationJSON:
    ...
    results: Optional[list[shared_spotlist.SpotList]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclasses.dataclass
class GetSpotListsRequest:
    query_params: GetSpotListsQueryParams = dataclasses.field()
...
class GetSpotListsResponse:
    ...
    get_spot_lists_200_application_json_object: Optional[GetSpotLists200ApplicationJSON] = dataclasses.field(default=None)
