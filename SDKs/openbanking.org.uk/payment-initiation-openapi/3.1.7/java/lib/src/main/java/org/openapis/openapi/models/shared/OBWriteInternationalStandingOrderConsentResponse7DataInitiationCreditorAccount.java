...
public class OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAccount {
    ...
    public OBWriteInternationalStandingOrderConsentResponse7DataInitiationCreditorAccount(@JsonProperty("Identification") String identification, @JsonProperty("Name") String name, @JsonProperty("SchemeName") String schemeName) {
        this.identification = identification;
        this.name = name;
        this.schemeName = schemeName;
  }
