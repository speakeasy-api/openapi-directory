...
class MarketChangeMessage
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\MarketChangeMessageCtEnum $ct
     */
	#[\JMS\Serializer\Annotation\SerializedName('ct')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\MarketChangeMessageCtEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MarketChangeMessageCtEnum $ct = null;
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\MarketChange> $mc
     */
	#[\JMS\Serializer\Annotation\SerializedName('mc')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\MarketChange>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?array $mc = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\MarketChangeMessageSegmentTypeEnum $segmentType
     */
	#[\JMS\Serializer\Annotation\SerializedName('segmentType')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\MarketChangeMessageSegmentTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MarketChangeMessageSegmentTypeEnum $segmentType = null;
