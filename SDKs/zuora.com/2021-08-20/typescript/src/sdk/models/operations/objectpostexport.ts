...
export class ObjectPostExportQueryParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=rejectUnknownFields" })
  rejectUnknownFields?: boolean;
}


export class ObjectPostExportHeaders extends SpeakeasyBase {
...
export class ObjectPostExportRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class ObjectPostExportResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
