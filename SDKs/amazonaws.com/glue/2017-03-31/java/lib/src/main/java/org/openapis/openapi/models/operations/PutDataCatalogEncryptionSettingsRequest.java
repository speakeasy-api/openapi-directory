...
public class PutDataCatalogEncryptionSettingsRequest {
    ...
    public PutDataCatalogEncryptionSettingsRequest(@JsonProperty("PutDataCatalogEncryptionSettingsRequest") org.openapis.openapi.models.shared.PutDataCatalogEncryptionSettingsRequest putDataCatalogEncryptionSettingsRequest, @JsonProperty("X-Amz-Target") PutDataCatalogEncryptionSettingsXAmzTargetEnum xAmzTarget) {
        this.putDataCatalogEncryptionSettingsRequest = putDataCatalogEncryptionSettingsRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
