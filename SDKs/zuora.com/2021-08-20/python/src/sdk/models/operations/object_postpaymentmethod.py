...
class ObjectPostPaymentMethodQueryParams:
...
@dataclasses.dataclass
class ObjectPostPaymentMethodHeaders:
...
class ObjectPostPaymentMethodRequest:
    headers: ObjectPostPaymentMethodHeaders = dataclasses.field()
    query_params: ObjectPostPaymentMethodQueryParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPostPaymentMethodResponse:
