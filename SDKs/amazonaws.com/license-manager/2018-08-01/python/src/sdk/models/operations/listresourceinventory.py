...
class ListResourceInventoryRequest:
    ...
    list_resource_inventory_request: shared_listresourceinventoryrequest.ListResourceInventoryRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
