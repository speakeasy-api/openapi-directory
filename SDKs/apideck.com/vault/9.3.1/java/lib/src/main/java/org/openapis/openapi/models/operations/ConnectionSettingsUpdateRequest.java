...
public class ConnectionSettingsUpdateRequest {
    ...
    public ConnectionSettingsUpdateRequest(@JsonProperty("ConnectionInput") org.openapis.openapi.models.shared.ConnectionInput connectionInput, @JsonProperty("resource") String resource, @JsonProperty("service_id") String serviceId, @JsonProperty("unified_api") String unifiedApi, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.connectionInput = connectionInput;
        this.resource = resource;
        this.serviceId = serviceId;
        this.unifiedApi = unifiedApi;
