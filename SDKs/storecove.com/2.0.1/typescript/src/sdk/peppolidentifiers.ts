...
export class PeppolIdentifiers {
  ...
  **/
  createPeppolIdentifier(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.CreatePeppolIdentifierResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  deletePeppolIdentifier(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DeletePeppolIdentifierResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
