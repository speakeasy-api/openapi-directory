    ...
    public static void main(String[] args) {
        try {
            ...
            RdcerRequestBody req = new RdcerRequestBody(RdcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new RdcerRequestBodyCertificateParameters("Sunil Kumar", "123412341234", "2019/RANR/1234/BK1/1234");;
            ...
            RdcerResponse res = sdk.apIs.rdcer(req, new RdcerSecurity("molestiae", "minus") {{
