 ...
 */
export enum InstanceAggregatedListWarningCodeEnum {
...
export class InstanceAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class InstanceAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InstancesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, InstancesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], InstancesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
