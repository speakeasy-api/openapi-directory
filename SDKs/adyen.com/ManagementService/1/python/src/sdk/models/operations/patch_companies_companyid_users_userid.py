...
from ..shared import updatecompanyuserrequest as shared_updatecompanyuserrequest
from typing import Optional


@dataclasses.dataclass
class PatchCompaniesCompanyIDUsersUserIDSecurity:
...
class PatchCompaniesCompanyIDUsersUserIDRequest:
    ...
    update_company_user_request: Optional[shared_updatecompanyuserrequest.UpdateCompanyUserRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
