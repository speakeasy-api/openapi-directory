...
import { NodeGroupNode } from "./nodegroupnode";
import { Expose, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum NodeGroupsListNodesWarningCodeEnum {
...
export class NodeGroupsListNodesWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeGroupsListNodesWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: NodeGroupsListNodesWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: NodeGroupsListNodesWarningData })
  @Expose({ name: "data" })
  @Type(() => NodeGroupsListNodesWarningData)
  data?: NodeGroupsListNodesWarningData[];
 ...
 * Successful response
 */
export class NodeGroupsListNodes extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeGroupNode })
  @Expose({ name: "items" })
  @Type(() => NodeGroupNode)
  items?: NodeGroupNode[];
