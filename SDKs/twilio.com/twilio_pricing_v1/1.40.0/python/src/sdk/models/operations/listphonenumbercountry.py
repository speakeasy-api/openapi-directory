...
class ListPhoneNumberCountryListPhoneNumberCountryResponse:
    ...
    countries: Optional[list[shared_pricing_v1_phone_number_phone_number_country.PricingV1PhoneNumberPhoneNumberCountry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countries'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListPhoneNumberCountryListPhoneNumberCountryResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
