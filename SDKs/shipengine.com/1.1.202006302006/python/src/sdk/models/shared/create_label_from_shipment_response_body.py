...
class CreateLabelFromShipmentResponseBodyOptionalLink:
    r"""CreateLabelFromShipmentResponseBodyOptionalLink
...
class CreateLabelFromShipmentResponseBodyMonetaryValue:
    r"""CreateLabelFromShipmentResponseBodyMonetaryValue
...
class CreateLabelFromShipmentResponseBodyLabelDownload:
    r"""CreateLabelFromShipmentResponseBodyLabelDownload
...
class CreateLabelFromShipmentResponseBodyOutput:
    r"""CreateLabelFromShipmentResponseBodyOutput
    ...
    form_download: Optional[CreateLabelFromShipmentResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('form_download') }})
    insurance_claim: Optional[CreateLabelFromShipmentResponseBodyOptionalLink] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_claim') }})
    insurance_cost: Optional[CreateLabelFromShipmentResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_cost') }})
    ...
    label_download: Optional[CreateLabelFromShipmentResponseBodyLabelDownload] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_download') }})
    ...
    shipment_cost: Optional[CreateLabelFromShipmentResponseBodyMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('shipment_cost') }})
