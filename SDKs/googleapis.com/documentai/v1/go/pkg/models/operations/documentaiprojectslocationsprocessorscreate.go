...
type DocumentaiProjectsLocationsProcessorsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DocumentaiProjectsLocationsProcessorsCreatePathParams struct {
...
type DocumentaiProjectsLocationsProcessorsCreateQueryParams struct {
	// V1 error format.
...
type DocumentaiProjectsLocationsProcessorsCreateRequest struct {
	...
	Request     *shared.GoogleCloudDocumentaiV1ProcessorInput `request:"mediaType=application/json"`
	Security    DocumentaiProjectsLocationsProcessorsCreateSecurity
}

type DocumentaiProjectsLocationsProcessorsCreateResponse struct {
	ContentType string
	// Successful response
