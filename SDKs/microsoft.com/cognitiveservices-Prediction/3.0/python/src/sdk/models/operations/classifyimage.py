...
@dataclasses.dataclass
class ClassifyImageQueryParams:
...
class ClassifyImageRequestBody:
    image_data: ClassifyImageRequestBodyImageData = dataclasses.field(metadata={'multipart_form': { 'file': True }})
    

@dataclasses.dataclass
class ClassifyImageRequest:
    path_params: ClassifyImagePathParams = dataclasses.field()
    query_params: ClassifyImageQueryParams = dataclasses.field()
    request: ClassifyImageRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'multipart/form-data' }})
