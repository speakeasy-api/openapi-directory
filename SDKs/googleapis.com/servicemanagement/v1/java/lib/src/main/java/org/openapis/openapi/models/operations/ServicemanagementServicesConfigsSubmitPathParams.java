...
public class ServicemanagementServicesConfigsSubmitPathParams {
    /**
    ...
    public ServicemanagementServicesConfigsSubmitPathParams withServiceName(String serviceName) {
