...
class UpdateRouteRequestBody:
    ...
    spec: UpdateRouteRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('spec') }})
    r"""An object that represents a route specification. Specify one route type."""  
...
class UpdateRouteRequest:
    ...
    r"""The name of the service mesh that the route resides in."""  
