...
from ..shared import poolpatchparameter as shared_poolpatchparameter
from typing import Optional


@dataclasses.dataclass
class PoolPatchRequest:
    ...
    pool_patch_parameter: shared_poolpatchparameter.PoolPatchParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
