...
class CreateTrafficMirrorTargetRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateTrafficMirrorTargetRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateTrafficMirrorTargetRequestTagSpecifications:
    ...
    resource_type: Optional[CreateTrafficMirrorTargetRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateTrafficMirrorTargetRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateTrafficMirrorTargetRequest:
    ...
    tag_specifications: Optional[list[CreateTrafficMirrorTargetRequestTagSpecifications]] = dataclasses.field(default=None)  
