 ...
 */
export enum InstanceTemplateListWarningCodeEnum {
...
export class InstanceTemplateListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceTemplateListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceTemplateListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InstanceTemplateList extends SpeakeasyBase {
  /**
