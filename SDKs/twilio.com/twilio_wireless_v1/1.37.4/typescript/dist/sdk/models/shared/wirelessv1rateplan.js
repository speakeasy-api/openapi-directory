...
exports.WirelessV1RatePlan = void 0;
...
var WirelessV1RatePlan = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=data_enabled" }),
        __metadata("design:type", Boolean)
    ], WirelessV1RatePlan.prototype, "dataEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=data_limit" }),
        __metadata("design:type", Number)
    ], WirelessV1RatePlan.prototype, "dataLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=data_metering" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=international_roaming" }),
        __metadata("design:type", Array)
    ], WirelessV1RatePlan.prototype, "internationalRoaming", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=international_roaming_data_limit" }),
        __metadata("design:type", Number)
    ], WirelessV1RatePlan.prototype, "internationalRoamingDataLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=messaging_enabled" }),
        __metadata("design:type", Boolean)
    ], WirelessV1RatePlan.prototype, "messagingEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=national_roaming_data_limit" }),
        __metadata("design:type", Number)
    ], WirelessV1RatePlan.prototype, "nationalRoamingDataLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=national_roaming_enabled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=voice_enabled" }),
        __metadata("design:type", Boolean)
    ], WirelessV1RatePlan.prototype, "voiceEnabled", void 0);
    return WirelessV1RatePlan;
}(utils_1.SpeakeasyBase));
exports.WirelessV1RatePlan = WirelessV1RatePlan;
