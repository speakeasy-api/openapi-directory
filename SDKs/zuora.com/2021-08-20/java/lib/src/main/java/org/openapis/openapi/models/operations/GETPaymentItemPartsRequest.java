...
public class GETPaymentItemPartsRequest {
    ...
    public GETPaymentItemPartsRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETPaymentItemPartsRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETPaymentItemPartsRequest withPageSize(Long pageSize) {
    ...
    public GETPaymentItemPartsRequest withPartid(String partid) {
        this.partid = partid;
        return this;
    }
    ...
    public GETPaymentItemPartsRequest withPaymentId(String paymentId) {
