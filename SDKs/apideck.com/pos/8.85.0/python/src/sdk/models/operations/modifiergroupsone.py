...
class ModifierGroupsOneRequest:
    headers: ModifierGroupsOneHeaders = dataclasses.field()
    path_params: ModifierGroupsOnePathParams = dataclasses.field()
    query_params: ModifierGroupsOneQueryParams = dataclasses.field()
    security: ModifierGroupsOneSecurity = dataclasses.field()
