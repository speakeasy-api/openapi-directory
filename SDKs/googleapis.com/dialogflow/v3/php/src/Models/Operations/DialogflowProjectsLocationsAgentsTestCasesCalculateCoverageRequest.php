...
class DialogflowProjectsLocationsAgentsTestCasesCalculateCoverageRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DialogflowProjectsLocationsAgentsTestCasesCalculateCoverageTypeEnum $type
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=type')]
    public ?DialogflowProjectsLocationsAgentsTestCasesCalculateCoverageTypeEnum $type = null;
