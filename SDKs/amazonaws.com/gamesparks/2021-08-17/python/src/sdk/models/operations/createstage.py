...
from ..shared import createstageresult as shared_createstageresult
...
class CreateStageRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the role to run the game with. This role can be a game-defined role or the default role that GameSparks created."""  
    ...
    r"""The description of the stage."""  
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Tags'), 'exclude': lambda f: f is None }})
    r"""The list of tags to apply to the stage."""  
...
class CreateStageResponse:
    ...
    r"""ConflictException"""  
    create_stage_result: Optional[shared_createstageresult.CreateStageResult] = dataclasses.field(default=None)
    r"""Success"""  
