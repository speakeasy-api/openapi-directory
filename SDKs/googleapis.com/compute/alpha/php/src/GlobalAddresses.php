...
class GlobalAddresses 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceResponse
     */
	public function computeGlobalAddressesGetOwnerInstance(
        \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/addresses/getOwnerInstance', \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeGlobalAddressesGetOwnerInstanceResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getOwnerInstanceResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetOwnerInstanceResponse', 'json');
            }
        }
