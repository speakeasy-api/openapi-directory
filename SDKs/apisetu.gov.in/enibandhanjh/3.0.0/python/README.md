...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/enibandhanjh/3.0.0/python
```
...
req = operations.RdcerRequestBody(
    certificate_parameters=operations.RdcerRequestBodyCertificateParameters(
        ...
        uid="123412341234",
        final_doc_reg_no="2019/RANR/1234/BK1/1234",
    ),
