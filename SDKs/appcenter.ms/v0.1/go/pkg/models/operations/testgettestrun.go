...
type TestGetTestRunSecurity struct {
	APIToken shared.SchemeAPIToken `security:"scheme,type=apiKey,subtype=header"`
}

type TestGetTestRunPathParams struct {
...
type TestGetTestRunRequest struct {
	PathParams TestGetTestRunPathParams
	Security   TestGetTestRunSecurity
}

// TestGetTestRunTestRunTestRunStatistics - Summary single test run on Xamarin Test Cloud
type TestGetTestRunTestRunTestRunStatistics struct {
...
type TestGetTestRunTestRun struct {
	...
	Stats *TestGetTestRunTestRunTestRunStatistics `json:"stats,omitempty"`
...
type TestGetTestRunResponse struct {
	ContentType string
	StatusCode  int
