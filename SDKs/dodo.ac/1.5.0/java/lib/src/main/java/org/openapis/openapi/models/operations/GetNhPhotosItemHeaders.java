...
public class GetNhPhotosItemHeaders {
    /**
    ...
    public GetNhPhotosItemHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhPhotosItemHeaders withXApiKey(String xApiKey) {
