...
class StorageObjectAccessControlsUpdateRequest:
    path_params: StorageObjectAccessControlsUpdatePathParams = dataclasses.field()
    query_params: StorageObjectAccessControlsUpdateQueryParams = dataclasses.field()
    security: StorageObjectAccessControlsUpdateSecurity = dataclasses.field()
