...
class RequestOAuthApprovalsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestOAuthApprovalsXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestOAuthApprovalsXSdsDateFormatEnum $xSdsDateFormat = null;
