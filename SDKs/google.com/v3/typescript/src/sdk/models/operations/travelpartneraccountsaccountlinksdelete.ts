...
export class TravelpartnerAccountsAccountLinksDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TravelpartnerAccountsAccountLinksDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
