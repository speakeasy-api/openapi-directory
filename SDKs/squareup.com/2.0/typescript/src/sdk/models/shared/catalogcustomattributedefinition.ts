...
export class CatalogCustomAttributeDefinition extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "allowed_object_types" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "custom_attribute_usage_count" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "source_application" })
