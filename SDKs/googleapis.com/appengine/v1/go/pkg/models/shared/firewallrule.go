...
func (e FirewallRuleActionEnum) ToPointer() *FirewallRuleActionEnum {
	return &e
}
...
func (e *FirewallRuleActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "ALLOW":
		fallthrough
	case "DENY":
		*e = FirewallRuleActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for FirewallRuleActionEnum: %v", v)
	}
}
