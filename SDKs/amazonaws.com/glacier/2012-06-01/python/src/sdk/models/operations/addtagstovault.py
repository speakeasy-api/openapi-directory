...
class AddTagsToVaultRequestBody:
    ...
    r"""The tags to add to the vault. Each tag is composed of a key and a value. The value can be an empty string."""  
...
class AddTagsToVaultRequest:
    ...
    request_body: AddTagsToVaultRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
