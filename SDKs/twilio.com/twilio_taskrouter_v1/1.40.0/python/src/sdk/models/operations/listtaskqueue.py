...
class ListTaskQueueRequest:
    ...
    r"""The SID of the Workspace with the TaskQueue to read."""  
    evaluate_worker_attributes: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'EvaluateWorkerAttributes', 'style': 'form', 'explode': True }})
    r"""The attributes of the Workers to read. Returns the TaskQueues with Workers that match the attributes specified in this parameter."""  
    ...
    r"""The SID of the Worker with the TaskQueue resources to read."""  
...
class ListTaskQueueListTaskQueueResponse:
    ...
    meta: Optional[ListTaskQueueListTaskQueueResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    task_queues: Optional[list[shared_taskrouter_v1_workspace_task_queue.TaskrouterV1WorkspaceTaskQueue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('task_queues'), 'exclude': lambda f: f is None }})  
...
class ListTaskQueueResponse:
    ...
    list_task_queue_response: Optional[ListTaskQueueListTaskQueueResponse] = dataclasses.field(default=None)
    r"""OK"""  
