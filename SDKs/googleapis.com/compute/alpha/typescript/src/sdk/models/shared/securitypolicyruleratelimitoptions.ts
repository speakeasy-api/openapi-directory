...
export class SecurityPolicyRuleRateLimitOptions extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    elemType: SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig,
  })
  @Expose({ name: "enforceOnKeyConfigs" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "exceedActionRpcStatus" })
  @Type(() => SecurityPolicyRuleRateLimitOptionsRpcStatus)
