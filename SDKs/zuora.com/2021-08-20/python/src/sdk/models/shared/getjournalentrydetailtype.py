...
class GETJournalEntryDetailTypeStatusEnum(str, Enum):
    r"""Status of journal entry."""
    CREATED = 'Created'
    CANCELLED = 'Cancelled'

class GETJournalEntryDetailTypeTransferredToAccountingEnum(str, Enum):
...
class GETJournalEntryDetailType:
    ...
    r"""Returns true if the journal entry is aggregating currencies. That is, if the journal entry was created when the `Aggregate transactions with different currencies during a Journal Run` setting was configured to `Yes`. Otherwise, returns `false`."""  
    ...
    status: Optional[GETJournalEntryDetailTypeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""Status of journal entry."""  
    ...
    transferred_to_accounting: Optional[GETJournalEntryDetailTypeTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Status shows whether the journal entry has been transferred to an accounting system."""  
