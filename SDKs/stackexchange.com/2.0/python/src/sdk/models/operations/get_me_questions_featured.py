...
class GetMeQuestionsFeaturedQueryParams:
    ...
    order: Optional[GetMeQuestionsFeaturedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeQuestionsFeaturedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeQuestionsFeaturedRequest:
    query_params: GetMeQuestionsFeaturedQueryParams = dataclasses.field()
