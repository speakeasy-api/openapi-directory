...
class UpdateFieldLevelEncryptionConfig20190326RequestBodyFieldLevelEncryptionConfig:
...
class UpdateFieldLevelEncryptionConfig20190326RequestBody:
    ...
    field_level_encryption_config: UpdateFieldLevelEncryptionConfig20190326RequestBodyFieldLevelEncryptionConfig = dataclasses.field()
    r"""A complex data type that includes the profile configurations specified for field-level encryption."""  
