...
class ContentOrdersCanceltestorderbycustomerRequest:
    ...
    r"""The ID of the test order to cancel."""  
    ...
    orders_cancel_test_order_by_customer_request: Optional[shared_orderscanceltestorderbycustomerrequest.OrdersCancelTestOrderByCustomerRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
