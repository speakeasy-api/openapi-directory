...
var MappingJob = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "contractSize" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "idValue" }),
        __metadata("design:type", Object)
    ], MappingJob.prototype, "idValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "includeUnlistedEquities" }),
        __metadata("design:type", Boolean)
    ], MappingJob.prototype, "includeUnlistedEquities", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "marketSecDes" }),
        __metadata("design:type", String)
    ], MappingJob.prototype, "marketSecDes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maturity" }),
        __metadata("design:type", Array)
    ], MappingJob.prototype, "maturity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "micCode" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "securityType2" }),
        __metadata("design:type", String)
    ], MappingJob.prototype, "securityType2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "stateCode" }),
        __metadata("design:type", String)
