...
class SubmitAttachmentStateChangesRequest:
    ...
    attachments: list[shared_attachmentstatechange.AttachmentStateChange] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attachments') }})  
