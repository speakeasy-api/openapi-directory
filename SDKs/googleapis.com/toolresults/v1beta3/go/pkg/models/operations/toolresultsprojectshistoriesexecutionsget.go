...
type ToolresultsProjectsHistoriesExecutionsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ToolresultsProjectsHistoriesExecutionsGetPathParams struct {
...
type ToolresultsProjectsHistoriesExecutionsGetQueryParams struct {
	// V1 error format.
...
type ToolresultsProjectsHistoriesExecutionsGetRequest struct {
...
type ToolresultsProjectsHistoriesExecutionsGetResponse struct {
	ContentType string
	// Successful response
