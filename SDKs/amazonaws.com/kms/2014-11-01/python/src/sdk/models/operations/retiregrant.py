...
class RetireGrantRequest:
    headers: RetireGrantHeaders = dataclasses.field()
    request: shared_retiregrantrequest.RetireGrantRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
