...
exports.FetchWorkflowCumulativeStatisticsResponse = exports.FetchWorkflowCumulativeStatisticsRequest = exports.FetchWorkflowCumulativeStatisticsSecurity = exports.FetchWorkflowCumulativeStatisticsServerList = void 0;
...
var FetchWorkflowCumulativeStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchWorkflowCumulativeStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowCumulativeStatisticsSecurity.prototype, "username", void 0);
...
var FetchWorkflowCumulativeStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchWorkflowCumulativeStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchWorkflowCumulativeStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SplitByWaitTime",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowCumulativeStatisticsRequest.prototype, "splitByWaitTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchWorkflowCumulativeStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowCumulativeStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkflowSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowCumulativeStatisticsRequest.prototype, "workflowSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowCumulativeStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchWorkflowCumulativeStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchWorkflowCumulativeStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
