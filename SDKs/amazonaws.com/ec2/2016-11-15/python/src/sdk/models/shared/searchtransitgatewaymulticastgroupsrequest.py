...
class SearchTransitGatewayMulticastGroupsRequestFilters:
...
class SearchTransitGatewayMulticastGroupsRequest:
    ...
    filters: Optional[list[SearchTransitGatewayMulticastGroupsRequestFilters]] = dataclasses.field(default=None)  
