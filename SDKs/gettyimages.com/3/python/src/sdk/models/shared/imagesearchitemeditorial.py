...
from ..shared import editorialsource as shared_editorialsource
...
class ImageSearchItemEditorial:
    ...
    editorial_source: Optional[shared_editorialsource.EditorialSource] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('editorial_source') }})
