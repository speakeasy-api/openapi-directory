...
class ObjectGetPaymentPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectGetPaymentHeaders:
...
class ObjectGetPaymentRequest:
    headers: ObjectGetPaymentHeaders = dataclasses.field()
    path_params: ObjectGetPaymentPathParams = dataclasses.field()
...
class ObjectGetPaymentResponse:
    ...
    proxy_get_payment: Optional[dict[str, Any]] = dataclasses.field(default=None)
