...
from ..shared import deleteemployeeresponse as shared_deleteemployeeresponse
...
class EmployeesDeleteRequest:
    headers: EmployeesDeleteHeaders = dataclasses.field()
    path_params: EmployeesDeletePathParams = dataclasses.field()
    query_params: EmployeesDeleteQueryParams = dataclasses.field()
    security: EmployeesDeleteSecurity = dataclasses.field()
...
class EmployeesDeleteResponse:
    ...
    delete_employee_response: Optional[shared_deleteemployeeresponse.DeleteEmployeeResponse] = dataclasses.field(default=None)
