...
func (e CompanyInfoTheStartMonthOfFiscalYearEnum) ToPointer() *CompanyInfoTheStartMonthOfFiscalYearEnum {
	return &e
}
...
func (e *CompanyInfoTheStartMonthOfFiscalYearEnum) UnmarshalJSON(data []byte) error {
	...
	case "November":
		fallthrough
	case "December":
		*e = CompanyInfoTheStartMonthOfFiscalYearEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CompanyInfoTheStartMonthOfFiscalYearEnum: %v", v)
	}
}
...
func (e CompanyInfoCompanyStatusEnum) ToPointer() *CompanyInfoCompanyStatusEnum {
	return &e
}
...
func (e *CompanyInfoCompanyStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "active":
		fallthrough
	case "inactive":
		*e = CompanyInfoCompanyStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CompanyInfoCompanyStatusEnum: %v", v)
	}
}
