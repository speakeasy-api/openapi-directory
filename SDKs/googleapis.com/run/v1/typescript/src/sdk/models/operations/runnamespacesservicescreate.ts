...
export class RunNamespacesServicesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesServicesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesServicesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
