...
export enum DeleteExplainabilityExportXAmzTargetEnum {
  AmazonForecastDeleteExplainabilityExport = "AmazonForecast.DeleteExplainabilityExport",
}

export class DeleteExplainabilityExportRequest extends SpeakeasyBase {
...
export class DeleteExplainabilityExportResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
