...
class TeamSeason:
    ...
    conference_points_against: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConferencePointsAgainst'), 'exclude': lambda f: f is None }})  
    conference_points_for: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConferencePointsFor'), 'exclude': lambda f: f is None }})  
    ...
    points_against: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PointsAgainst'), 'exclude': lambda f: f is None }})  
    points_for: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PointsFor'), 'exclude': lambda f: f is None }})  
    ...
    road_losses: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RoadLosses'), 'exclude': lambda f: f is None }})  
    road_wins: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RoadWins'), 'exclude': lambda f: f is None }})  
