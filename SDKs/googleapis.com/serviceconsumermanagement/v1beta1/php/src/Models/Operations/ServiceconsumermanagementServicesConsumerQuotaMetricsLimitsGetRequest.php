...
class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsGetViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsGetViewEnum $view = null;
