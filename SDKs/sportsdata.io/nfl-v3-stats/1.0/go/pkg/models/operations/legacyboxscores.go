...
func (e LegacyBoxScoresFormatEnum) ToPointer() *LegacyBoxScoresFormatEnum {
	return &e
}

func (e *LegacyBoxScoresFormatEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = LegacyBoxScoresFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for LegacyBoxScoresFormatEnum: %v", v)
	}
}
