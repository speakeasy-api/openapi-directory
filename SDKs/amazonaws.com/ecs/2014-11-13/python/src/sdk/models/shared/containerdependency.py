...
from ..shared import containercondition_enum as shared_containercondition_enum
...
class ContainerDependency:
    ...
    condition: shared_containercondition_enum.ContainerConditionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('condition') }})
