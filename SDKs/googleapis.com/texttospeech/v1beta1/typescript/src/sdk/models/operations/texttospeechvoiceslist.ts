...
export class TexttospeechVoicesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class TexttospeechVoicesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TexttospeechVoicesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
