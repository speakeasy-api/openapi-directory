...
class FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest:
    ...
    google_firebase_appcheck_v1_exchange_device_check_token_request: Optional[shared_googlefirebaseappcheckv1exchangedevicechecktokenrequest.GoogleFirebaseAppcheckV1ExchangeDeviceCheckTokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
