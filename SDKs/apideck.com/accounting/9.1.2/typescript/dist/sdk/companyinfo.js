...
var CompanyInfo = /** @class */ (function () {
    function CompanyInfo(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Get company info
     */
    CompanyInfo.prototype.companyInfoOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CompanyInfoOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/accounting/company-info";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CompanyInfoOneResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getCompanyInfoResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetCompanyInfoResponse);
                    }
                    break;
