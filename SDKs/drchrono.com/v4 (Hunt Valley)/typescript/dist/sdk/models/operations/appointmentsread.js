...
exports.AppointmentsReadResponse = exports.AppointmentsReadRequest = exports.AppointmentsReadSecurity = void 0;
...
var AppointmentsReadRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AppointmentsReadRequest.prototype, "date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=date_range",
        }),
        __metadata("design:type", String)
    ], AppointmentsReadRequest.prototype, "dateRange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], AppointmentsReadRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], AppointmentsReadRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=office",
        }),
        __metadata("design:type", Number)
    ], AppointmentsReadRequest.prototype, "office", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], AppointmentsReadRequest.prototype, "patient", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], AppointmentsReadRequest.prototype, "since", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], AppointmentsReadRequest.prototype, "status", void 0);
...
var AppointmentsReadResponse = /** @class */ (function (_super) {
    ...
    ], AppointmentsReadResponse.prototype, "rawResponse", void 0);
