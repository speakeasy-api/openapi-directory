...
var Orders = /** @class */ (function () {
     ...
     */
    Orders.prototype.dfareportingOrdersGet = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingOrdersGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/userprofiles/{profileId}/projects/{projectId}/orders/{id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DfareportingOrdersGetResponse({
     ...
     */
    Orders.prototype.dfareportingOrdersList = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingOrdersListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/userprofiles/{profileId}/projects/{projectId}/orders", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.DfareportingOrdersListResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
