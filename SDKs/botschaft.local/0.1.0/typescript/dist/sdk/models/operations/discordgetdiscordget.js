...
exports.DiscordGetDiscordGetResponse = exports.DiscordGetDiscordGetRequest = void 0;
...
var DiscordGetDiscordGetRequest = /** @class */ (function (_super) {
    ...
    ], DiscordGetDiscordGetRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=base64_message",
        }),
        __metadata("design:type", String)
    ], DiscordGetDiscordGetRequest.prototype, "base64Message", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=channel",
        }),
        __metadata("design:type", String)
    ], DiscordGetDiscordGetRequest.prototype, "channel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=message",
        }),
        __metadata("design:type", String)
    ], DiscordGetDiscordGetRequest.prototype, "message", void 0);
...
var DiscordGetDiscordGetResponse = /** @class */ (function (_super) {
    ...
    ], DiscordGetDiscordGetResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
