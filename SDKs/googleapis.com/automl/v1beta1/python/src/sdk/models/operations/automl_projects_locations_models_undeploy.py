...
class AutomlProjectsLocationsModelsUndeploySecurity:
...
@dataclasses.dataclass
class AutomlProjectsLocationsModelsUndeployRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Required. Resource name of the model to undeploy."""  
...
@dataclasses.dataclass
class AutomlProjectsLocationsModelsUndeployResponse:
