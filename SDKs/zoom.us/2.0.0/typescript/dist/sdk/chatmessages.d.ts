...
export declare class ChatMessages {
     ...
     */
    deleteChatMessage(req: operations.DeleteChatMessageRequest, security: operations.DeleteChatMessageSecurity, config?: AxiosRequestConfig): Promise<operations.DeleteChatMessageResponse>;
    /**
     * Update a message
     *
     * @remarks
     ...
     *
     */
    editMessage(req: operations.EditMessageRequest, security: operations.EditMessageSecurity, config?: AxiosRequestConfig): Promise<operations.EditMessageResponse>;
    /**
     ...
     *
     */
    getChatMessages(req: operations.GetChatMessagesRequest, security: operations.GetChatMessagesSecurity, config?: AxiosRequestConfig): Promise<operations.GetChatMessagesResponse>;
    /**
     * Send a chat message
     *
     * @remarks
     ...
     *
     */
    sendaChatMessage(req: operations.SendaChatMessageRequest, security: operations.SendaChatMessageSecurity, config?: AxiosRequestConfig): Promise<operations.SendaChatMessageResponse>;
}
