...
class CitiesGetv1V1CitiesGetOrderByCitiesOrderEnum(str, Enum):
    r"""An enumeration."""
    CITY = 'city'
    COUNTRY = 'country'
...
class CitiesGetv1V1CitiesGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class CitiesGetv1V1CitiesGetRequest:
    ...
    order_by: Optional[CitiesGetv1V1CitiesGetOrderByCitiesOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""Order by a field"""  
    page: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'page', 'style': 'form', 'explode': True }})
    r"""Paginate through results."""  
    sort: Optional[CitiesGetv1V1CitiesGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Define sort order."""  
