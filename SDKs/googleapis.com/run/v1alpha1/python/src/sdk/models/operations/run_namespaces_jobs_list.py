...
class RunNamespacesJobsListRequest:
    path_params: RunNamespacesJobsListPathParams = dataclasses.field()
    query_params: RunNamespacesJobsListQueryParams = dataclasses.field()
    security: RunNamespacesJobsListSecurity = dataclasses.field()
