...
class StorageBucketAccessControlsGetSecurity:
    option1: Optional[StorageBucketAccessControlsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageBucketAccessControlsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class StorageBucketAccessControlsGetRequest:
    path_params: StorageBucketAccessControlsGetPathParams = dataclasses.field()
    query_params: StorageBucketAccessControlsGetQueryParams = dataclasses.field()
    security: StorageBucketAccessControlsGetSecurity = dataclasses.field()
