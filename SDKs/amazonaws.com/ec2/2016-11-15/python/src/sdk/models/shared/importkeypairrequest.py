...
class ImportKeyPairRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class ImportKeyPairRequestTagSpecifications:
    ...
    resource_type: Optional[ImportKeyPairRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[ImportKeyPairRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class ImportKeyPairRequest:
    ...
    public_key_material: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[ImportKeyPairRequestTagSpecifications]] = dataclasses.field(default=None)  
