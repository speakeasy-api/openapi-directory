...
class ListMarketplaceAvailableAddOnExtensionRequest:
    ...
    r"""The SID of the AvailableAddOn resource with the extensions to read."""  
...
class ListMarketplaceAvailableAddOnExtensionListMarketplaceAvailableAddOnExtensionResponse:
    ...
    extensions: Optional[list[shared_preview_marketplace_available_add_on_available_add_on_extension.PreviewMarketplaceAvailableAddOnAvailableAddOnExtension]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('extensions'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListMarketplaceAvailableAddOnExtensionListMarketplaceAvailableAddOnExtensionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
