...
class GetLoadBalancerMetricDataRequest:
    ...
    metric_name: shared_loadbalancermetricname_enum.LoadBalancerMetricNameEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricName') }})  
