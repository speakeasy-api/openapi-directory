...
export declare class NetworksecurityProjectsLocationsUrlListsListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsUrlListsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsUrlListsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
