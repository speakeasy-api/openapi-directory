...
exports.ChannelsCategories = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ChannelsCategories = /** @class */ (function () {
    function ChannelsCategories(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ChannelsCategories.prototype.addChannelCategories = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddChannelCategoriesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/channels/{channel_id}/categories", req.pathParams);
    ...
    **/
    ChannelsCategories.prototype.categorizeChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CategorizeChannelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/channels/{channel_id}/categories/{category}", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    ChannelsCategories.prototype.deleteChannelCategory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsCategories.prototype.getChannelCategories = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ChannelsCategories = ChannelsCategories;
