...
public class GetAnswersIdsCommentsRequest {
    ...
    public GetAnswersIdsCommentsRequest withCallback(String callback) {
    ...
    public GetAnswersIdsCommentsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetAnswersIdsCommentsRequest withFromdate(Long fromdate) {
    ...
    public GetAnswersIdsCommentsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetAnswersIdsCommentsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetAnswersIdsCommentsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetAnswersIdsCommentsOrderEnum order;

    public GetAnswersIdsCommentsRequest withOrder(GetAnswersIdsCommentsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetAnswersIdsCommentsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetAnswersIdsCommentsRequest withPagesize(Long pagesize) {
    ...
    public GetAnswersIdsCommentsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetAnswersIdsCommentsSortEnum sort;

    public GetAnswersIdsCommentsRequest withSort(GetAnswersIdsCommentsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetAnswersIdsCommentsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetAnswersIdsCommentsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
