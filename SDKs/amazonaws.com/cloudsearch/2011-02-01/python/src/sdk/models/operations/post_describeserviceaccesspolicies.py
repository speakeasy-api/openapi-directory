...
class PostDescribeServiceAccessPoliciesQueryParams:
    action: PostDescribeServiceAccessPoliciesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeServiceAccessPoliciesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeServiceAccessPoliciesRequest:
    headers: PostDescribeServiceAccessPoliciesHeaders = dataclasses.field()
    query_params: PostDescribeServiceAccessPoliciesQueryParams = dataclasses.field()
