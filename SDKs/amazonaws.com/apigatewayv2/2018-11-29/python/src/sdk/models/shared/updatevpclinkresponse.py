...
class UpdateVpcLinkResponseVpcLinkStatusEnum(str, Enum):
...
class UpdateVpcLinkResponseVpcLinkVersionEnum(str, Enum):
...
class UpdateVpcLinkResponse:
    ...
    vpc_link_status: Optional[UpdateVpcLinkResponseVpcLinkStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VpcLinkStatus'), 'exclude': lambda f: f is None }})  
    ...
    vpc_link_version: Optional[UpdateVpcLinkResponseVpcLinkVersionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VpcLinkVersion'), 'exclude': lambda f: f is None }})  
