...
public class GetV2CadencesJsonQueryParams {
    /**
    ...
    public GetV2CadencesJsonQueryParams withArchived(Boolean archived) {
    ...
    public GetV2CadencesJsonQueryParams withGroupIds(String groupIds) {
    ...
    public Long[] ids;
    public GetV2CadencesJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2CadencesJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2CadencesJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public String[] name;
    public GetV2CadencesJsonQueryParams withName(String[] name) {
        this.name = name;
        return this;
    }
    ...
    public GetV2CadencesJsonQueryParams withOwnedByGuid(String[] ownedByGuid) {
    ...
    public Long page;
    public GetV2CadencesJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Boolean peopleAddable;
    public GetV2CadencesJsonQueryParams withPeopleAddable(Boolean peopleAddable) {
        this.peopleAddable = peopleAddable;
        return this;
    }
    ...
    public Long perPage;
    public GetV2CadencesJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2CadencesJsonQueryParams withShared(Boolean shared) {
        this.shared = shared;
        return this;
    }
    ...
    public GetV2CadencesJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2CadencesJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2CadencesJsonQueryParams withTeamCadence(Boolean teamCadence) {
    ...
    public GetV2CadencesJsonQueryParams withUpdatedAt(String[] updatedAt) {
