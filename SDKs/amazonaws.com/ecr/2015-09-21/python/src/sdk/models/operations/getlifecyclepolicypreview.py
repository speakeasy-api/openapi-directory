...
class GetLifecyclePolicyPreviewRequest:
    ...
    get_lifecycle_policy_preview_request: shared_getlifecyclepolicypreviewrequest.GetLifecyclePolicyPreviewRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class GetLifecyclePolicyPreviewResponse:
    ...
    r"""LifecyclePolicyPreviewNotFoundException"""  
