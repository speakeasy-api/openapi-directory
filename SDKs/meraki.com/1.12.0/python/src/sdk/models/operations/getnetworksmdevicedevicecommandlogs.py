...
class GetNetworkSmDeviceDeviceCommandLogsRequest:
    path_params: GetNetworkSmDeviceDeviceCommandLogsPathParams = dataclasses.field()
    query_params: GetNetworkSmDeviceDeviceCommandLogsQueryParams = dataclasses.field()
...
class GetNetworkSmDeviceDeviceCommandLogsResponse:
    ...
    get_network_sm_device_device_command_logs_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
