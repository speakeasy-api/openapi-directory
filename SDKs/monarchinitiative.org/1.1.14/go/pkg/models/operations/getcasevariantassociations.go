...
type GetCaseVariantAssociationsPathParams struct {
	// CURIE identifier for a case
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetCaseVariantAssociationsQueryParams struct {
