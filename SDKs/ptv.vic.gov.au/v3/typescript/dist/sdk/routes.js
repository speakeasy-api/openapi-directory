...
var Routes = /** @class */ (function () {
    function Routes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Routes.prototype.routesOneOrMoreRoutes = function (req, config) {
    ...
    **/
    Routes.prototype.routesRouteFromId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
