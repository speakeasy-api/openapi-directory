...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("ducimus") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("porro") {{
                order = OrderEnum.DESC;
                page = 491591L;
                perPage = 458970L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("ad") {{
                order = OrderEnum.DESC;
                page = 316501L;
                perPage = 965090L;
                sort = SearchIssuesAndPullRequestsSortEnum.REACTIONS_THINKING_FACE;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("dignissimos", 729828L) {{
                order = OrderEnum.DESC;
                page = 69182L;
                perPage = 280114L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("saepe") {{
                order = OrderEnum.ASC;
                page = 334018L;
                perPage = 176499L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("earum") {{
                page = 444121L;
                perPage = 506312L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("nemo") {{
                order = OrderEnum.ASC;
                page = 789770L;
                perPage = 197259L;
