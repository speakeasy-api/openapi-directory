...
class UpdateResponseHeadersPolicy20200531RequestBody:
    ...
    response_headers_policy_config: UpdateResponseHeadersPolicy20200531RequestBodyResponseHeadersPolicyConfig = dataclasses.field()
    r"""<p>A response headers policy configuration.</p> <p>A response headers policy configuration contains metadata about the response headers policy, and configurations for sets of HTTP response headers.</p>"""  
    

@dataclasses.dataclass
class UpdateResponseHeadersPolicy20200531Request:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'Id', 'style': 'simple', 'explode': False }})
    r"""The identifier for the response headers policy that you are updating."""  
    ...
    r"""<p>The version of the response headers policy that you are updating.</p> <p>The version is returned in the cache policy's <code>ETag</code> field in the response to <code>GetResponseHeadersPolicyConfig</code>.</p>"""  
...
@dataclasses.dataclass
class UpdateResponseHeadersPolicy20200531Response:
