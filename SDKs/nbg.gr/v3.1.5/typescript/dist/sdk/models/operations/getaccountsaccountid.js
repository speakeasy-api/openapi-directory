...
exports.GetAccountsAccountIdResponse = exports.GetAccountsAccountIdRequest = exports.GetAccountsAccountIdSecurity = void 0;
...
var GetAccountsAccountIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetAccountsAccountIdRequest.prototype, "accountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=sandbox-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdRequest.prototype, "sandboxId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetAccountsAccountIdRequest.prototype, "xFapiInteractionId", void 0);
...
var GetAccountsAccountIdResponse = /** @class */ (function (_super) {
    ...
    ], GetAccountsAccountIdResponse.prototype, "rawResponse", void 0);
