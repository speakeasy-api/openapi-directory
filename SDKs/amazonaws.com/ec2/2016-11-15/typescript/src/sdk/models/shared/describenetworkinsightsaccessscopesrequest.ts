 ...
 */
export class DescribeNetworkInsightsAccessScopesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeNetworkInsightsAccessScopesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
