 ...
 */
public enum InboundWireTransferSimulationResultTransactionTransactionSourceCategoryEnum {
    ...
    private InboundWireTransferSimulationResultTransactionTransactionSourceCategoryEnum(String value) {
        this.value = value;
    }
}
