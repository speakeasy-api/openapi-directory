...
public class InvoiceApiDeleteRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiDeleteRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiDeleteRawHeaders withXAuthSecret(String xAuthSecret) {
