...
class RecordingSettingsUpdateRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\RecordingSettingsUpdateRecordingSettings $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\RecordingSettingsUpdateRecordingSettings();
		$this->meetingId = "";
	}
}
