...
var GetAggregateDiscoveredResourceCountsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: groupedresourcecount_1.GroupedResourceCount }),
        (0, class_transformer_1.Expose)({ name: "GroupedResourceCounts" }),
        (0, class_transformer_1.Type)(function () { return groupedresourcecount_1.GroupedResourceCount; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TotalDiscoveredResources" }),
