...
public class GetWorkspaceSlugActivitiesQueryParams {
    /**
    ...
    public GetWorkspaceSlugActivitiesQueryParams withActivityType(GetWorkspaceSlugActivitiesActivityTypeEnum activityType) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withAffiliation(GetWorkspaceSlugActivitiesAffiliationEnum affiliation) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withCities(String cities) {
        this.cities = cities;
        return this;
    }
    ...
    public GetWorkspaceSlugActivitiesQueryParams withCompany(String company) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withCountries(String countries) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withDirection(GetWorkspaceSlugActivitiesDirectionEnum direction) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withEndDate(String endDate) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withIdentity(GetWorkspaceSlugActivitiesIdentityEnum identity) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withItems(GetWorkspaceSlugActivitiesItemsEnum items) {
        this.items = items;
        return this;
    }
    ...
    public GetWorkspaceSlugActivitiesQueryParams withMemberTags(String memberTags) {
    ...
    public String orbit;
    public GetWorkspaceSlugActivitiesQueryParams withOrbit(String orbit) {
        this.orbit = orbit;
        return this;
    }
    ...
    public String page;
    public GetWorkspaceSlugActivitiesQueryParams withPage(String page) {
        this.page = page;
        return this;
    }
    ...
    public GetWorkspaceSlugActivitiesQueryParams withRegions(String regions) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withRelative(String relative) {
    ...
    public GetWorkspaceSlugActivitiesQueryParams withSort(GetWorkspaceSlugActivitiesSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetWorkspaceSlugActivitiesQueryParams withStartDate(String startDate) {
    ...
    public String title;
    public GetWorkspaceSlugActivitiesQueryParams withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public String type;
    public GetWorkspaceSlugActivitiesQueryParams withType(String type) {
        this.type = type;
        return this;
    }
