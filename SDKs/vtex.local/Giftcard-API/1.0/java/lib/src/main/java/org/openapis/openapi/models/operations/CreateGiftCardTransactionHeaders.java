...
public class CreateGiftCardTransactionHeaders {
    /**
    ...
    public CreateGiftCardTransactionHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public CreateGiftCardTransactionHeaders withContentType(String contentType) {
