...
type GetItemFeedHeaders struct {
...
type GetItemFeedRequest struct {
	QueryParams GetItemFeedQueryParams
	Headers     GetItemFeedHeaders
	Security    GetItemFeedSecurity
}

type GetItemFeedResponse struct {
	Body        []byte
	ContentType string
