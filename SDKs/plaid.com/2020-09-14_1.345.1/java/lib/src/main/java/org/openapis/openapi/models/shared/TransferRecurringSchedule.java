...
public class TransferRecurringSchedule {
    ...
    public TransferRecurringSchedule(@JsonProperty("interval_count") Long intervalCount, @JsonProperty("interval_execution_day") Long intervalExecutionDay, @JsonProperty("interval_unit") TransferScheduleIntervalUnitEnum intervalUnit, @JsonProperty("start_date") LocalDate startDate) {
        this.intervalCount = intervalCount;
        this.intervalExecutionDay = intervalExecutionDay;
        this.intervalUnit = intervalUnit;
        this.startDate = startDate;
