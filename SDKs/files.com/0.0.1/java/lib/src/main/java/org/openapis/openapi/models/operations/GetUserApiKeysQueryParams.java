...
public class GetUserApiKeysQueryParams {
    /**
     * Used for pagination.  When a list request has more records available, cursors are provided in the response headers `X-Files-Cursor-Next` and `X-Files-Cursor-Prev`.  Send one of those cursor value here to resume an existing list from the next available record.  Note: many of our SDKs have iterator methods that will automatically handle cursor-based pagination.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=cursor")
    public String cursor;
    public GetUserApiKeysQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetUserApiKeysQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUserApiKeysQueryParams withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetUserApiKeysQueryParams withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetUserApiKeysQueryParams withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetUserApiKeysQueryParams withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetUserApiKeysQueryParams withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetUserApiKeysQueryParams withPerPage(Integer perPage) {
    ...
    public GetUserApiKeysQueryParams withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetUserApiKeysQueryParams withUserId(Integer userId) {
        this.userId = userId;
        return this;
    }
