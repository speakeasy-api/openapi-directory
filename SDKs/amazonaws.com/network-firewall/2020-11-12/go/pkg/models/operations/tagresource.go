...
const (
	TagResourceXAmzTargetEnumNetworkFirewall20201112TagResource TagResourceXAmzTargetEnum = "NetworkFirewall_20201112.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "NetworkFirewall_20201112.TagResource":
