...
class CreateGoalMetricRequestBodyInput:
    r"""The goal metric to create."""
    
    data: Optional[shared_goalmetricrequest.GoalMetricRequestInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class CreateGoalMetricRequest:
    ...
    request_body: CreateGoalMetricRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The goal metric to create."""  
...
class CreateGoalMetric200ApplicationJSON:
    r"""Successfully created a new goal metric."""
