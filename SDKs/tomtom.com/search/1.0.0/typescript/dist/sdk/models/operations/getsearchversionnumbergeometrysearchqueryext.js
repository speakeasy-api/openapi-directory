...
exports.GetSearchVersionNumberGeometrySearchQueryExtResponse = exports.GetSearchVersionNumberGeometrySearchQueryExtRequest = void 0;
...
var GetSearchVersionNumberGeometrySearchQueryExtRequest = /** @class */ (function (_super) {
    ...
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "ext", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=extendedPostalCodesFor",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "extendedPostalCodesFor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=geometryList",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "geometryList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=idxSet",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "idxSet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=language",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=query",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=versionNumber",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberGeometrySearchQueryExtRequest.prototype, "versionNumber", void 0);
...
var GetSearchVersionNumberGeometrySearchQueryExtResponse = /** @class */ (function (_super) {
    ...
    ], GetSearchVersionNumberGeometrySearchQueryExtResponse.prototype, "rawResponse", void 0);
