 ...
 */
export class UpdateFieldLevelEncryptionConfig20190326RequestBodyFieldLevelEncryptionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateFieldLevelEncryptionConfig20190326RequestBody extends SpeakeasyBase {
  /**
   * A complex data type that includes the profile configurations specified for field-level encryption.
   */
  @SpeakeasyMetadata()
