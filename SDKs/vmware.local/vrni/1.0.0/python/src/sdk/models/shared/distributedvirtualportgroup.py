...
class DistributedVirtualPortgroup:
    ...
    distributed_virtual_switch: Optional[shared_reference.Reference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distributed_virtual_switch'), 'exclude': lambda f: f is None }})  
