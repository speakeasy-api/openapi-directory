 ...
 */
export declare enum FirewallListWarningCodeEnum {
...
export declare class FirewallListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class FirewallListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class FirewallList extends SpeakeasyBase {
    /**
