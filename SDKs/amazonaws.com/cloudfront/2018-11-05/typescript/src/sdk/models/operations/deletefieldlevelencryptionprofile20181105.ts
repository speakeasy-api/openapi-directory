...
export class DeleteFieldLevelEncryptionProfile20181105Request extends SpeakeasyBase {
  /**
...
export class DeleteFieldLevelEncryptionProfile20181105Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
