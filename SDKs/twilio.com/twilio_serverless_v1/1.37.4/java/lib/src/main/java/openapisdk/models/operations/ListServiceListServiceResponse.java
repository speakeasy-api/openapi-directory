...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.ServerlessV1Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.ServerlessV1Service[] services) {
