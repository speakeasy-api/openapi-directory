...
class Datafeeds:
    ...
    def content_datafeeds_fetchnow(self, request: operations.ContentDatafeedsFetchnowRequest) -> operations.ContentDatafeedsFetchnowResponse:
        r"""Invokes a fetch for the datafeed in your Merchant Center account. If you need to call this method more than once per day, we recommend you use the Products service to update your product data.
        """
