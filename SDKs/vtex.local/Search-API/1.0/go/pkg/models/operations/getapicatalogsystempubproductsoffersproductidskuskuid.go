...
type GetAPICatalogSystemPubProductsOffersProductIDSkuSkuID200ApplicationJSONMainImage struct {
...
type GetAPICatalogSystemPubProductsOffersProductIDSkuSkuID200ApplicationJSONOffersOffersPerSalesChannel struct {
...
type GetAPICatalogSystemPubProductsOffersProductIDSkuSkuID200ApplicationJSONOffers struct {
	// Trade policy that the SKU in contained.
	AvailableSalesChannels string `json:"AvailableSalesChannels"`
	// Offers per trade policy.
	OffersPerSalesChannel []GetAPICatalogSystemPubProductsOffersProductIDSkuSkuID200ApplicationJSONOffersOffersPerSalesChannel `json:"OffersPerSalesChannel"`
	// Seller ID.
...
type GetAPICatalogSystemPubProductsOffersProductIDSkuSkuID200ApplicationJSON struct {
	...
	MainImage GetAPICatalogSystemPubProductsOffersProductIDSkuSkuID200ApplicationJSONMainImage `json:"MainImage"`
	// SKU name.
	Name string `json:"Name"`
	// SKU complete name.
	NameComplete string `json:"NameComplete"`
	// AKA Commertial Condition.
	Offers []GetAPICatalogSystemPubProductsOffersProductIDSkuSkuID200ApplicationJSONOffers `json:"Offers"`
	// Product ID.
...
type GetAPICatalogSystemPubProductsOffersProductIDSkuSkuIDResponse struct {
	ContentType string
	StatusCode  int
