...
class Region:
    ...
    site_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('site_count'), 'exclude': lambda f: f is None }})  
