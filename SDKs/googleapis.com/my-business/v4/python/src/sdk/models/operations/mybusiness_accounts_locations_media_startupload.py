...
@dataclasses.dataclass
class MybusinessAccountsLocationsMediaStartUploadQueryParams:
...
class MybusinessAccountsLocationsMediaStartUploadRequest:
    path_params: MybusinessAccountsLocationsMediaStartUploadPathParams = dataclasses.field()
    query_params: MybusinessAccountsLocationsMediaStartUploadQueryParams = dataclasses.field()
...
class MybusinessAccountsLocationsMediaStartUploadResponse:
    ...
    media_item_data_ref: Optional[shared_mediaitemdataref.MediaItemDataRef] = dataclasses.field(default=None)
