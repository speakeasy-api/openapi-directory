...
var SubscriptionGroups = /** @class */ (function () {
    function SubscriptionGroups(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SubscriptionGroups.prototype.listUserSSubscriptionGroupSms = function (req, config) {
     ...
     * ```
    **/
    SubscriptionGroups.prototype.listUserSSubscriptionGroupStatusSms = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
