...
func (e GetOrganizationAPIRequestsMethodEnum) ToPointer() *GetOrganizationAPIRequestsMethodEnum {
	return &e
}
...
func (e *GetOrganizationAPIRequestsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "POST":
		fallthrough
	case "PUT":
		*e = GetOrganizationAPIRequestsMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationAPIRequestsMethodEnum: %v", v)
	}
}

// GetOrganizationAPIRequestsVersionEnum - Filter the results by the API version of the API request
type GetOrganizationAPIRequestsVersionEnum int64
...
func (e GetOrganizationAPIRequestsVersionEnum) ToPointer() *GetOrganizationAPIRequestsVersionEnum {
	return &e
}
...
func (e *GetOrganizationAPIRequestsVersionEnum) UnmarshalJSON(data []byte) error {
	...
	case 0:
		fallthrough
	case 1:
		*e = GetOrganizationAPIRequestsVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationAPIRequestsVersionEnum: %v", v)
	}
}
...
type GetOrganizationAPIRequests200ApplicationJSONVersionEnum int64
...
func (e GetOrganizationAPIRequests200ApplicationJSONVersionEnum) ToPointer() *GetOrganizationAPIRequests200ApplicationJSONVersionEnum {
	return &e
}
...
func (e *GetOrganizationAPIRequests200ApplicationJSONVersionEnum) UnmarshalJSON(data []byte) error {
	...
	case 0:
		fallthrough
	case 1:
		*e = GetOrganizationAPIRequests200ApplicationJSONVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationAPIRequests200ApplicationJSONVersionEnum: %v", v)
	}
}
