...
func (e GetUsersIdsQuestionsUnansweredOrderEnum) ToPointer() *GetUsersIdsQuestionsUnansweredOrderEnum {
	return &e
}

func (e *GetUsersIdsQuestionsUnansweredOrderEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetUsersIdsQuestionsUnansweredOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsQuestionsUnansweredOrderEnum: %v", v)
	}
}
...
func (e GetUsersIdsQuestionsUnansweredSortEnum) ToPointer() *GetUsersIdsQuestionsUnansweredSortEnum {
	return &e
}

func (e *GetUsersIdsQuestionsUnansweredSortEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetUsersIdsQuestionsUnansweredSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsQuestionsUnansweredSortEnum: %v", v)
	}
}
