...
class Drives:
    ...
    def drive_drives_create(self, request: operations.DriveDrivesCreateRequest, security: operations.DriveDrivesCreateSecurity) -> operations.DriveDrivesCreateResponse:
        r"""Creates a shared drive."""
        ...
        query_params = utils.get_query_params(operations.DriveDrivesCreateRequest, request)
        ...
        res = operations.DriveDrivesCreateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
