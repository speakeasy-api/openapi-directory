...
public enum GoogleCloudPolicysimulatorV1beta1BindingExplanationRolePermissionEnum {
    ...
    private GoogleCloudPolicysimulatorV1beta1BindingExplanationRolePermissionEnum(String value) {
        this.value = value;
    }
}
