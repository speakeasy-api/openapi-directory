...
class SoldToContactOtherPhoneTypeEnum(str, Enum):
...
class SoldToContact:
    ...
    other_phone_type: Optional[SoldToContactOtherPhoneTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('otherPhoneType'), 'exclude': lambda f: f is None }})
    r"""Specifies the type of phone number in the `otherPhone` field."""  
