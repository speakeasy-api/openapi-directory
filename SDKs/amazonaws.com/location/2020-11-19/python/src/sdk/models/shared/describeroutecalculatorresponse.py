...
class DescribeRouteCalculatorResponsePricingPlanEnum(str, Enum):
...
class DescribeRouteCalculatorResponse:
    ...
    pricing_plan: Optional[DescribeRouteCalculatorResponsePricingPlanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PricingPlan'), 'exclude': lambda f: f is None }})  
