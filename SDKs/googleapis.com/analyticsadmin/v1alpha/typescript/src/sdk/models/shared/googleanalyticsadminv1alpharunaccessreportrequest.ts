...
export class GoogleAnalyticsAdminV1alphaRunAccessReportRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleAnalyticsAdminV1alphaAccessDateRange })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleAnalyticsAdminV1alphaAccessDimension })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleAnalyticsAdminV1alphaAccessMetric })
  @Expose({ name: "metrics" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleAnalyticsAdminV1alphaAccessOrderBy })
