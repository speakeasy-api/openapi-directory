...
try {
    ...
    $request->analysisId = 536178;
    $request->confirmDelete = 'fugit';
    $request->owner = 'fuga';
...
try {
    ...
    $request->alertNumber = 129412;
    $request->owner = 'saepe';
    $request->page = 578922;
    $request->perPage = 543806;
    $request->ref = 'et';
    $request->repo = 'esse';
...
try {
    ...
    $request->after = 'eveniet';
    $request->before = 'accusamus';
    ...
    $request->toolGuid = 'quasi';
    $request->toolName = 'saepe';
...
try {
    ...
    $request->owner = 'harum';
    $request->page = 473221;
    $request->perPage = 699622;
    $request->ref = 'occaecati';
    $request->repo = 'minima';
    $request->sort = CodeScanningListAlertsForRepoSortEnum::UPDATED;
    $request->state = CodeScanningAlertStateEnum::FIXED;
    $request->toolGuid = 'sit';
    $request->toolName = 'culpa';
...
try {
    ...
    $request->toolGuid = 'minus';
    $request->toolName = 'quaerat';
...
try {
    ...
    $request->requestBody->commitSha = 'a';
    $request->requestBody->ref = 'nulla';
    $request->requestBody->sarif = 'quas';
    $request->requestBody->startedAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-11-26T10:10:26.600Z');
