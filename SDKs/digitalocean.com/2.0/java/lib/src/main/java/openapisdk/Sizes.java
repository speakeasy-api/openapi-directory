...
public class Sizes {
    ...
    **/
    public openapisdk.models.operations.ListAllSizesResponse listAllSizes(openapisdk.models.operations.ListAllSizesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/sizes");
        ...
        openapisdk.models.operations.ListAllSizesResponse res = new openapisdk.models.operations.ListAllSizesResponse() {{
            listAllSizes200ApplicationJSONObject = null;
            listAllSizes401ApplicationJSONObject = null;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.ListAllSizes200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.ListAllSizes200ApplicationJson.class);
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.ListAllSizes401ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.ListAllSizes401ApplicationJson.class);
