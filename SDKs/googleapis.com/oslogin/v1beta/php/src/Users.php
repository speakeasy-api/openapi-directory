...
class Users 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\OsloginUsersGetLoginProfileResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}/loginProfile', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersGetLoginProfileRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}:importSshPublicKey', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersImportSshPublicKeyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/sshPublicKeys', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}', \OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysPatchRequest::class, $request);
