 ...
 */
export declare class DescribeCapacityReservationFleetsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeCapacityReservationFleetsRequest extends SpeakeasyBase {
