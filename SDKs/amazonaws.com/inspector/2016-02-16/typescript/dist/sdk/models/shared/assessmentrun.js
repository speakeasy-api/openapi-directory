...
var AssessmentRun = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dataCollected" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=findingCounts" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notifications", elemType: assessmentrunnotification_1.AssessmentRunNotification }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=stateChanges", elemType: assessmentrunstatechange_1.AssessmentRunStateChange }),
        __metadata("design:type", Array)
