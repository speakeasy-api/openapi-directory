...
public class GetTemplateModelRequest {
    ...
    public GetTemplateModelRequest withApiVersion(String apiVersion) {
    ...
    public GetTemplateModelRequest withAuthorization(String authorization) {
    ...
    public GetTemplateModelRequest withDtoDataType(String dtoDataType) {
