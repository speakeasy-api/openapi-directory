...
try {
    ...
    $request->q = 'temporibus';
    $request->sort = SearchCommitsSortEnum::AUTHOR_DATE;
...
try {
    ...
    $request->order = OrderEnum::DESC;
    $request->page = 667215;
    $request->perPage = 33093;
    $request->q = 'quod';
    $request->repositoryId = 796117;
...
try {
    ...
    $request->order = OrderEnum::ASC;
    $request->page = 404774;
    $request->perPage = 832944;
    $request->q = 'unde';
    $request->sort = SearchUsersSortEnum::FOLLOWERS;
