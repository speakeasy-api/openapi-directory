...
export class GetDeviceSwitchPortStatusesPacketsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetDeviceSwitchPortStatusesPacketsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getDeviceSwitchPortStatusesPackets200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
