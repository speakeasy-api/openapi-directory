 ...
 */
export enum AutoscalersScopedListWarningCodeEnum {
...
export class AutoscalersScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AutoscalersScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: AutoscalersScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: AutoscalersScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => AutoscalersScopedListWarningData)
  data?: AutoscalersScopedListWarningData[];
...
export class AutoscalersScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of autoscalers contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: Autoscaler })
  @Expose({ name: "autoscalers" })
  @Type(() => Autoscaler)
