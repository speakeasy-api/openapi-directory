...
class PowerPortConnectionStatusValueEnum(str, Enum):
    FALSE = 'false'
    TRUE = 'true'
...
class PowerPortConnectionStatus:
    ...
    label: PowerPortConnectionStatusLabelEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label') }})  
    value: PowerPortConnectionStatusValueEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})  
...
class PowerPortType:
    ...
    label: PowerPortTypeLabelEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label') }})  
    value: PowerPortTypeValueEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})  
...
class PowerPort:
    ...
    connection_status: Optional[PowerPortConnectionStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connection_status'), 'exclude': lambda f: f is None }})  
    ...
    type: Optional[PowerPortType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
