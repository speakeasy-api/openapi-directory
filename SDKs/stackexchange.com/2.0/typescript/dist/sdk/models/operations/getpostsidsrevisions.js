...
exports.GetPostsIdsRevisionsResponse = exports.GetPostsIdsRevisionsRequest = void 0;
...
var GetPostsIdsRevisionsRequest = /** @class */ (function (_super) {
    ...
    ], GetPostsIdsRevisionsRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetPostsIdsRevisionsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fromdate",
        }),
        __metadata("design:type", Number)
    ], GetPostsIdsRevisionsRequest.prototype, "fromdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ids" }),
        __metadata("design:type", String)
    ], GetPostsIdsRevisionsRequest.prototype, "ids", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetPostsIdsRevisionsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetPostsIdsRevisionsRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetPostsIdsRevisionsRequest.prototype, "site", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=todate",
        }),
        __metadata("design:type", Number)
    ], GetPostsIdsRevisionsRequest.prototype, "todate", void 0);
...
var GetPostsIdsRevisionsResponse = /** @class */ (function (_super) {
    ...
    ], GetPostsIdsRevisionsResponse.prototype, "rawResponse", void 0);
