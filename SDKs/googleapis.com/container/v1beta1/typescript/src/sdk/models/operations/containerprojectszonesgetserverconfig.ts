...
export class ContainerProjectsZonesGetServerconfigSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesGetServerconfigRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsZonesGetServerconfigResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
