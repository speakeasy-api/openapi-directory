...
from ..shared import batchlistobjectparentsresponse as shared_batchlistobjectparentsresponse
...
class BatchReadSuccessfulResponse:
    ...
    list_object_parents: Optional[shared_batchlistobjectparentsresponse.BatchListObjectParentsResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ListObjectParents') }})
