...
type ListViewsQueryParams struct {
	// Pagination limit
...
type ListViewsRequestBody struct {
...
type ListViewsRequest struct {
	QueryParams ListViewsQueryParams
	Headers     ListViewsHeaders
	Request     ListViewsRequestBody `request:"mediaType=application/json"`
}
...
type ListViewsResponse struct {
	...
	// Success
	ListViewsOutput *shared.ListViewsOutput
	StatusCode      int
