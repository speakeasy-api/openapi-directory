 ...
 */
public enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsTagSpecificationsResourceTypeEnum {
    ...
    private RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
