...
exports.ChecksListForRefResponse = exports.ChecksListForRef200ApplicationJSON = exports.ChecksListForRefRequest = exports.ChecksListForRefFilterEnum = void 0;
 ...
 */
var ChecksListForRefFilterEnum;
(function (ChecksListForRefFilterEnum) {
    ChecksListForRefFilterEnum["Latest"] = "latest";
    ChecksListForRefFilterEnum["All"] = "all";
})(ChecksListForRefFilterEnum = exports.ChecksListForRefFilterEnum || (exports.ChecksListForRefFilterEnum = {}));
var ChecksListForRefRequest = /** @class */ (function (_super) {
    ...
    ], ChecksListForRefRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=check_name",
        }),
        __metadata("design:type", String)
    ], ChecksListForRefRequest.prototype, "checkName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], ChecksListForRefRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ChecksListForRefRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ChecksListForRefRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ChecksListForRefRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ref" }),
        __metadata("design:type", String)
    ], ChecksListForRefRequest.prototype, "ref", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ChecksListForRefRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], ChecksListForRefRequest.prototype, "status", void 0);
...
var ChecksListForRef200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.CheckRun }),
        (0, class_transformer_1.Expose)({ name: "check_runs" }),
        (0, class_transformer_1.Type)(function () { return shared.CheckRun; }),
...
var ChecksListForRefResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ChecksListForRefResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
