...
export class Instance extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "preservedStateSizeGb" })
   ...
   */
  @SpeakeasyMetadata({ elemType: ServiceIntegrationSpec })
  @Expose({ name: "serviceIntegrationSpecs" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, ServiceIntegrationSpec> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], ServiceIntegrationSpec);
      }
      return obj;
    },
    { toClassOnly: true }
