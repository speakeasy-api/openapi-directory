...
exports.AffiliateSearch = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var AffiliateSearch = /** @class */ (function () {
    function AffiliateSearch(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    AffiliateSearch.prototype.getV3AffiliatesSearchImages = function (req, config) {
    ...
    AffiliateSearch.prototype.getV3AffiliatesSearchVideos = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.AffiliateSearch = AffiliateSearch;
