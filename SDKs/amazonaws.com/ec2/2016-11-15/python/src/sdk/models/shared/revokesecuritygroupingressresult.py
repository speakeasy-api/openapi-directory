...
class RevokeSecurityGroupIngressResultUnknownIPPermissionsIPRanges:
...
@dataclasses.dataclass
class RevokeSecurityGroupIngressResultUnknownIPPermissionsUserIDGroupPairs:
...
class RevokeSecurityGroupIngressResultUnknownIPPermissions:
    ...
    ip_ranges: Optional[list[RevokeSecurityGroupIngressResultUnknownIPPermissionsIPRanges]] = dataclasses.field(default=None)  
    ipv6_ranges: Optional[list[RevokeSecurityGroupIngressResultUnknownIPPermissionsIpv6Ranges]] = dataclasses.field(default=None)  
    prefix_list_ids: Optional[list[RevokeSecurityGroupIngressResultUnknownIPPermissionsPrefixListIds]] = dataclasses.field(default=None)  
    to_port: Optional[int] = dataclasses.field(default=None)  
    user_id_group_pairs: Optional[list[RevokeSecurityGroupIngressResultUnknownIPPermissionsUserIDGroupPairs]] = dataclasses.field(default=None)  
...
class RevokeSecurityGroupIngressResult:
    ...
    unknown_ip_permissions: Optional[list[RevokeSecurityGroupIngressResultUnknownIPPermissions]] = dataclasses.field(default=None)  
