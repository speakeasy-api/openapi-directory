...
class BoxScore:
    ...
    shootout_plays: Optional[list[shared_play.Play]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ShootoutPlays'), 'exclude': lambda f: f is None }})  
