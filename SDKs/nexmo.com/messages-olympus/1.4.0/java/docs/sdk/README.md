...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = new SendMessageRequestBody5Video(SendMessageRequestBody5VideoChannelEnum.VIBER_SERVICE, "9876543210", SendMessageRequestBody5VideoMessageTypeEnum.VIDEO, "447700900000",                 new SendMessageRequestBody5VideoVideo("https://example.com/video.mp4");) {{
                channel = SendMessageRequestBody5VideoChannelEnum.VIBER_SERVICE;
                clientRef = "illum";
                from = "9876543210";
                messageType = SendMessageRequestBody5VideoMessageTypeEnum.VIDEO;
                to = "447700900000";
                viberService = new SendMessageRequestBody5VideoViberService() {{
                    category = SendMessageRequestBody5VideoViberServiceCategoryEnum.TRANSACTION;
                    duration = "123";
                    fileSize = "1";
                    ttl = 600L;
                    type = "error";
                }};
                video = new SendMessageRequestBody5VideoVideo("https://example.com/video.mp4") {{
                    url = "https://example.com/video.mp4";
                }};
            }}            

            SendMessageResponse res = sdk.sdk.sendMessage(req, new SendMessageSecurity() {{
            ...
            if (res.sendMessage202ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
