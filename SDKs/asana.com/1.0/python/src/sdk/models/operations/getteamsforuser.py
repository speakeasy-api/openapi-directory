...
class GetTeamsForUserRequest:
    ...
    r"""The workspace or organization to filter teams on."""  
...
class GetTeamsForUser200ApplicationJSON:
    r"""Returns the team records for all teams in the organization or workspace to which the given user is assigned."""
