...
func (s *operationsT) TexttospeechOperationsCancel(ctx context.Context, request operations.TexttospeechOperationsCancelRequest) (*operations.TexttospeechOperationsCancelResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) TexttospeechOperationsDelete(ctx context.Context, request operations.TexttospeechOperationsDeleteRequest) (*operations.TexttospeechOperationsDeleteResponse, error) {
	baseURL := s.serverURL
