...
class AnalyticsDataMcfGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AnalyticsDataMcfGetSamplingLevelEnum $samplingLevel
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=samplingLevel')]
    public ?AnalyticsDataMcfGetSamplingLevelEnum $samplingLevel = null;
