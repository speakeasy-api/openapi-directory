...
export declare class Scripts {
     ...
     */
    scriptScriptsRun(req: operations.ScriptScriptsRunRequest, security: operations.ScriptScriptsRunSecurity, config?: AxiosRequestConfig): Promise<operations.ScriptScriptsRunResponse>;
}
