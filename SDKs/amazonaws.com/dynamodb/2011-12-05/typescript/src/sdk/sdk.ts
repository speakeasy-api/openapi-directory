...
export class SDK {
  ...
  batchGetItem(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.BatchGetItemResponse =
        new operations.BatchGetItemResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.batchGetItemOutput = utils.objectToClass(
              httpRes?.data,
              shared.BatchGetItemOutput
            );
          }
          break;
  ...
  batchWriteItem(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.BatchWriteItemResponse =
        new operations.BatchWriteItemResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.batchWriteItemOutput = utils.objectToClass(
              httpRes?.data,
              shared.BatchWriteItemOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  createTable(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createTableOutput = utils.objectToClass(
              httpRes?.data,
              shared.CreateTableOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  deleteItem(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.deleteItemOutput = utils.objectToClass(
              httpRes?.data,
              shared.DeleteItemOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  deleteTable(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.deleteTableOutput = utils.objectToClass(
              httpRes?.data,
              shared.DeleteTableOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  describeTable(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.describeTableOutput = utils.objectToClass(
              httpRes?.data,
              shared.DescribeTableOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  getItem(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=DynamoDB_20111205.GetItem";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getItemOutput = utils.objectToClass(
              httpRes?.data,
              shared.GetItemOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  listTables(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listTablesOutput = utils.objectToClass(
              httpRes?.data,
              shared.ListTablesOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  putItem(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=DynamoDB_20111205.PutItem";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutItemResponse = new operations.PutItemResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.putItemOutput = utils.objectToClass(
              httpRes?.data,
              shared.PutItemOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  query(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=DynamoDB_20111205.Query";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.queryOutput = utils.objectToClass(
              httpRes?.data,
              shared.QueryOutput
            );
          }
  ...
  scan(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#X-Amz-Target=DynamoDB_20111205.Scan";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.scanOutput = utils.objectToClass(
              httpRes?.data,
              shared.ScanOutput
            );
          }
  ...
  updateItem(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateItemOutput = utils.objectToClass(
              httpRes?.data,
              shared.UpdateItemOutput
            );
          }
          break;
        case httpRes?.status == 480:
  ...
  updateTable(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateTableOutput = utils.objectToClass(
              httpRes?.data,
              shared.UpdateTableOutput
            );
          }
          break;
        case httpRes?.status == 480:
