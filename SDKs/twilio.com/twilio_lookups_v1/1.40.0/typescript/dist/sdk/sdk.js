...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.fetchPhoneNumber = function (req, security, serverURL, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/PhoneNumbers/{PhoneNumber}", req);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.lookupsV1PhoneNumber = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.LookupsV1PhoneNumber);
                    }
                    break;
            }
            return res;
