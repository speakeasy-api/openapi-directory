...
class CertificateConfiguration:
    ...
    certificate_type: shared_certificatetype_enum.CertificateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CertificateType') }})
