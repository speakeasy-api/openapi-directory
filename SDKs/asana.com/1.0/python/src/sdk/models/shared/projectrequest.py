...
class ProjectRequestCurrentStatusInput:
    ...
    color: ProjectRequestCurrentStatusColorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('color') }})
    r"""The color associated with the status update."""  
...
class ProjectRequestInput:
    ...
    color: Optional[ProjectRequestColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('color'), 'exclude': lambda f: f is None }})
    r"""Color of the project."""  
    ...
    default_view: Optional[ProjectRequestDefaultViewEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('default_view'), 'exclude': lambda f: f is None }})
    r"""The default view (list, board, calendar, or timeline) of a project."""  
