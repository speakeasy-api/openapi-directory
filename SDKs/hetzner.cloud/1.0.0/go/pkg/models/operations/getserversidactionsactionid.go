...
func (e *GetServersIDActionsActionIDActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = GetServersIDActionsActionIDActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetServersIDActionsActionIDActionResponseActionStatusEnum: %s", s)
	}
}
