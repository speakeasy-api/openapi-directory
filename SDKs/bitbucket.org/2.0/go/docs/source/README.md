...
func main() {
    ...
    res, err := s.Source.GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPath(ctx, operations.GetRepositoriesWorkspaceRepoSlugFilehistoryCommitPathRequest{
        Commit: "ullam",
        Path: "in",
        Q: sdk.String("nam"),
        Renames: sdk.String("earum"),
        RepoSlug: "officia",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Source.GetRepositoriesWorkspaceRepoSlugSrc(ctx, operations.GetRepositoriesWorkspaceRepoSlugSrcRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Source.GetRepositoriesWorkspaceRepoSlugSrcCommitPath(ctx, operations.GetRepositoriesWorkspaceRepoSlugSrcCommitPathRequest{
        Commit: "molestias",
        Format: operations.GetRepositoriesWorkspaceRepoSlugSrcCommitPathFormatEnumRendered.ToPointer(),
        MaxDepth: sdk.Int64(956933),
        Path: "cumque",
        Q: sdk.String("vitae"),
        RepoSlug: "rerum",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Source.PostRepositoriesWorkspaceRepoSlugSrc(ctx, operations.PostRepositoriesWorkspaceRepoSlugSrcRequest{
        Author: sdk.String("inventore"),
        Branch: sdk.String("fugit"),
        Files: sdk.String("cumque"),
        Message: sdk.String("quae"),
        Parents: sdk.String("perferendis"),
        RepoSlug: "velit",
