...
var Consent = /** @class */ (function () {
    function Consent(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Consent.prototype.postV05ConsentRequestsInit = function (req, config) {
        var _a;
    ...
    **/
    Consent.prototype.postV05ConsentRequestsStatus = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Consent.prototype.postV05ConsentsFetch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Consent.prototype.postV05ConsentsHipOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Consent.prototype.postV05ConsentsHiuOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
