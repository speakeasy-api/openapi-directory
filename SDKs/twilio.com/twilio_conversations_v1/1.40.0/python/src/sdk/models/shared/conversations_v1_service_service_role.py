...
class ConversationsV1ServiceServiceRole:
    ...
    type: Optional[shared_service_role_enum_role_type_enum.ServiceRoleEnumRoleTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
