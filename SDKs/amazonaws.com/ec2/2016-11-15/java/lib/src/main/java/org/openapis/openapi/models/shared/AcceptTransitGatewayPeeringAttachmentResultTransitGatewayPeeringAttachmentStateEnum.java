 ...
 */
public enum AcceptTransitGatewayPeeringAttachmentResultTransitGatewayPeeringAttachmentStateEnum {
    ...
    private AcceptTransitGatewayPeeringAttachmentResultTransitGatewayPeeringAttachmentStateEnum(String value) {
        this.value = value;
    }
}
