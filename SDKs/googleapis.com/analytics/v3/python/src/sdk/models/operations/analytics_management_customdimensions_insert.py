...
class AnalyticsManagementCustomDimensionsInsertRequest:
    path_params: AnalyticsManagementCustomDimensionsInsertPathParams = dataclasses.field()
    query_params: AnalyticsManagementCustomDimensionsInsertQueryParams = dataclasses.field()
    security: AnalyticsManagementCustomDimensionsInsertSecurity = dataclasses.field()
