...
func (e PostSpacesSpaceIDFoldersIDPayrollsMultipartFormDataAccountingWorkbookEnum) ToPointer() *PostSpacesSpaceIDFoldersIDPayrollsMultipartFormDataAccountingWorkbookEnum {
	return &e
}
...
func (e *PostSpacesSpaceIDFoldersIDPayrollsMultipartFormDataAccountingWorkbookEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "permanent":
		*e = PostSpacesSpaceIDFoldersIDPayrollsMultipartFormDataAccountingWorkbookEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesSpaceIDFoldersIDPayrollsMultipartFormDataAccountingWorkbookEnum: %v", v)
	}
}
