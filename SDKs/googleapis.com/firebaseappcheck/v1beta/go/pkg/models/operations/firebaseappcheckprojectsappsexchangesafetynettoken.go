...
type FirebaseappcheckProjectsAppsExchangeSafetyNetTokenRequest struct {
	...
	GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest *shared.GoogleFirebaseAppcheckV1betaExchangeSafetyNetTokenRequest `request:"mediaType=application/json"`
	// OAuth access token.
