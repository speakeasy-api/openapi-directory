...
class ComputeRegionTargetHttpsProxiesSetUrlMapRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\UrlMapReference $urlMapReference = null;
