...
class Wireless 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateNetworkWirelessSsidEapOverrideResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateNetworkWirelessSsidEapOverride200ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\UpdateNetworkWirelessSsidEapOverride200ApplicationJSON', 'json');
            }
        }
