...
public class CreateInternationalPaymentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalPaymentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalPaymentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalPaymentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalPaymentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalPaymentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalPaymentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalPaymentsRawHeaders withXJwsSignature(String xJwsSignature) {
