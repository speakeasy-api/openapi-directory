...
exports.ListBucketResponse = exports.ListBucketListBucketResponse = exports.ListBucketListBucketResponseMeta = exports.ListBucketRequest = exports.ListBucketSecurity = exports.ListBucketServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListBucketServerList = ["https://verify.twilio.com"];
var ListBucketSecurity = /** @class */ (function (_super) {
    ...
    ], ListBucketSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListBucketSecurity.prototype, "username", void 0);
...
var ListBucketRequest = /** @class */ (function (_super) {
    ...
    ], ListBucketRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListBucketRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListBucketRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RateLimitSid",
        }),
        __metadata("design:type", String)
    ], ListBucketRequest.prototype, "rateLimitSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListBucketRequest.prototype, "serviceSid", void 0);
...
var ListBucketListBucketResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.VerifyV2ServiceRateLimitBucket }),
        (0, class_transformer_1.Expose)({ name: "buckets" }),
        (0, class_transformer_1.Type)(function () { return shared.VerifyV2ServiceRateLimitBucket; }),
        __metadata("design:type", Array)
    ], ListBucketListBucketResponse.prototype, "buckets", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListBucketListBucketResponseMeta; }),
...
var ListBucketResponse = /** @class */ (function (_super) {
    ...
    ], ListBucketResponse.prototype, "rawResponse", void 0);
