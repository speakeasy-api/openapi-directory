...
type GetNhClothingClothingPathParams struct {
	// The name of the clothing you wish to retrieve information about.
	Clothing string `pathParam:"style=simple,explode=false,name=clothing"`
}

type GetNhClothingClothingQueryParams struct {
...
type GetNhClothingClothingHeaders struct {
...
type GetNhClothingClothingRequest struct {
	PathParams  GetNhClothingClothingPathParams
	QueryParams GetNhClothingClothingQueryParams
	Headers     GetNhClothingClothingHeaders
}

type GetNhClothingClothingResponse struct {
	ContentType string
