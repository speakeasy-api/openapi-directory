...
class DeleteRoomRequestBody:
    ...
    r"""Identifier of the room to be deleted. Currently this must be an ARN."""  
    

@dataclasses.dataclass
class DeleteRoomRequest:
    
    request_body: DeleteRoomRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
