...
public class BatchDeleteCustomVocabularyItemPathParams {
    /**
     * The identifier of the bot associated with this custom vocabulary.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=botId")
    public String botId;
    public BatchDeleteCustomVocabularyItemPathParams withBotId(String botId) {
        this.botId = botId;
        return this;
    }
    ...
    public BatchDeleteCustomVocabularyItemPathParams withBotVersion(String botVersion) {
    ...
    public BatchDeleteCustomVocabularyItemPathParams withLocaleId(String localeId) {
