...
class GetNetworkWirelessSsidSplashSettingsRequest:
    path_params: GetNetworkWirelessSsidSplashSettingsPathParams = dataclasses.field()
...
class GetNetworkWirelessSsidSplashSettingsResponse:
    ...
    get_network_wireless_ssid_splash_settings_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
