...
var Vendor = /** @class */ (function () {
    function Vendor(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Vendor.prototype.getAvailableVendors = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAvailableVendorsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/users/available-vendors";
