 ...
 */
public class MessageStatusMMSError {
    /**
    ...
    public MessageStatusMMSError withDetail(String detail) {
        this.detail = detail;
        return this;
    }
    ...
    public MessageStatusMMSError withInstance(String instance) {
    ...
    public MessageStatusMMSError withTitle(String title) {
        this.title = title;
        return this;
    }
    ...
    public MessageStatusMMSError withType(String type) {
        this.type = type;
        return this;
    }
    
    public MessageStatusMMSError(){}
}
