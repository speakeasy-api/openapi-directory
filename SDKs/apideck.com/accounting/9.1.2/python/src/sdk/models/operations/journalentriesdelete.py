...
from ..shared import deletejournalentryresponse as shared_deletejournalentryresponse
...
@dataclasses.dataclass
class JournalEntriesDeleteResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    delete_journal_entry_response: Optional[shared_deletejournalentryresponse.DeleteJournalEntryResponse] = dataclasses.field(default=None)
    r"""JournalEntries"""  
