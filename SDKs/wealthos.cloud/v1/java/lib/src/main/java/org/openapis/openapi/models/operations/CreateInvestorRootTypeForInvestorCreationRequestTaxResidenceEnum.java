 ...
 */
public enum CreateInvestorRootTypeForInvestorCreationRequestTaxResidenceEnum {
    GB_ENG("GB-ENG"),
    GB_NIR("GB-NIR"),
    GB_SCT("GB-SCT"),
    GB_WLS("GB-WLS");
    ...
    private CreateInvestorRootTypeForInvestorCreationRequestTaxResidenceEnum(String value) {
        this.value = value;
    }
}
