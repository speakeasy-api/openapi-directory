...
exports.CreditBalanceAdjustments = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CreditBalanceAdjustments = /** @class */ (function () {
    function CreditBalanceAdjustments(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CreditBalanceAdjustments.prototype.objectGetCreditBalanceAdjustment = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectGetCreditBalanceAdjustmentRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/object/credit-balance-adjustment/{id}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetCreditBalanceAdjustment = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    CreditBalanceAdjustments.prototype.objectPostCreditBalanceAdjustment = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectPostCreditBalanceAdjustmentRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/object/credit-balance-adjustment";
    ...
    **/
    CreditBalanceAdjustments.prototype.objectPutCreditBalanceAdjustment = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CreditBalanceAdjustments = CreditBalanceAdjustments;
