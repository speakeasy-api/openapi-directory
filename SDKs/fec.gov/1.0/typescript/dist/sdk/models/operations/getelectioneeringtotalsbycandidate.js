...
exports.GetElectioneeringTotalsByCandidateResponse = exports.GetElectioneeringTotalsByCandidateRequest = void 0;
...
var GetElectioneeringTotalsByCandidateRequest = /** @class */ (function (_super) {
    ...
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=candidate_id",
        }),
        __metadata("design:type", Array)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "candidateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=cycle" }),
        __metadata("design:type", Array)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "cycle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=election_full",
        }),
        __metadata("design:type", Boolean)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "electionFull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetElectioneeringTotalsByCandidateRequest.prototype, "sortNullsLast", void 0);
...
var GetElectioneeringTotalsByCandidateResponse = /** @class */ (function (_super) {
    ...
    ], GetElectioneeringTotalsByCandidateResponse.prototype, "rawResponse", void 0);
