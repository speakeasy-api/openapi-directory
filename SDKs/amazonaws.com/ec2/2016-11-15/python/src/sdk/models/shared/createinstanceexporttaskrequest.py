...
class CreateInstanceExportTaskRequestExportToS3TaskContainerFormatEnum(str, Enum):
    r"""The container format used to combine disk images with metadata (such as OVF). If absent, only the disk image is exported."""
    OVA = 'ova'

class CreateInstanceExportTaskRequestExportToS3TaskDiskImageFormatEnum(str, Enum):
...
class CreateInstanceExportTaskRequestExportToS3Task:
    r"""The format and location for an export instance task."""
    
    container_format: Optional[CreateInstanceExportTaskRequestExportToS3TaskContainerFormatEnum] = dataclasses.field(default=None)  
    disk_image_format: Optional[CreateInstanceExportTaskRequestExportToS3TaskDiskImageFormatEnum] = dataclasses.field(default=None)  
    s3_bucket: Optional[str] = dataclasses.field(default=None)  
    s3_prefix: Optional[str] = dataclasses.field(default=None)  
    
class CreateInstanceExportTaskRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateInstanceExportTaskRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateInstanceExportTaskRequestTagSpecifications:
    ...
    resource_type: Optional[CreateInstanceExportTaskRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateInstanceExportTaskRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    
class CreateInstanceExportTaskRequestTargetEnvironmentEnum(str, Enum):
...
class CreateInstanceExportTaskRequest:
    ...
    export_to_s3_task: CreateInstanceExportTaskRequestExportToS3Task = dataclasses.field()  
    instance_id: str = dataclasses.field()  
    target_environment: CreateInstanceExportTaskRequestTargetEnvironmentEnum = dataclasses.field()  
    description: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateInstanceExportTaskRequestTagSpecifications]] = dataclasses.field(default=None)  
