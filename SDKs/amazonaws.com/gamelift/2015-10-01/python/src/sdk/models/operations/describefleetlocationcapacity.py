...
class DescribeFleetLocationCapacityRequest:
    ...
    describe_fleet_location_capacity_input: shared_describefleetlocationcapacityinput.DescribeFleetLocationCapacityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
