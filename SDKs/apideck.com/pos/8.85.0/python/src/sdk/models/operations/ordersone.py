...
class OrdersOneRequest:
    headers: OrdersOneHeaders = dataclasses.field()
    path_params: OrdersOnePathParams = dataclasses.field()
    query_params: OrdersOneQueryParams = dataclasses.field()
    security: OrdersOneSecurity = dataclasses.field()
