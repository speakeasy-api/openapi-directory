...
class GetTagFromCisLinePathParams:
...
@dataclasses.dataclass
class GetTagFromCisLineHeaders:
    api_version: str = dataclasses.field(metadata={'header': { 'field_name': 'Api-Version', 'style': 'simple', 'explode': False }})
    authorization: str = dataclasses.field(metadata={'header': { 'field_name': 'Authorization', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetTagFromCisLineRequest:
    headers: GetTagFromCisLineHeaders = dataclasses.field()
    path_params: GetTagFromCisLinePathParams = dataclasses.field()
    

@dataclasses.dataclass
class GetTagFromCisLineResponse:
