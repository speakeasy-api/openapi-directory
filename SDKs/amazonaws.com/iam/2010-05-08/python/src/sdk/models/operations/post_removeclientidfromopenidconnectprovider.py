...
class PostRemoveClientIDFromOpenIDConnectProviderQueryParams:
    action: PostRemoveClientIDFromOpenIDConnectProviderActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRemoveClientIDFromOpenIDConnectProviderVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRemoveClientIDFromOpenIDConnectProviderRequest:
    headers: PostRemoveClientIDFromOpenIDConnectProviderHeaders = dataclasses.field()
    query_params: PostRemoveClientIDFromOpenIDConnectProviderQueryParams = dataclasses.field()
