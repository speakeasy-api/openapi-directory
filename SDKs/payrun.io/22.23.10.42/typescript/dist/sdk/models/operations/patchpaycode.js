...
exports.PatchPayCodeResponse = exports.PatchPayCodeRequest = void 0;
...
var PatchPayCodeRequest = /** @class */ (function (_super) {
    ...
    ], PatchPayCodeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PatchPayCodeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PatchPayCodeRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.PayCode)
    ], PatchPayCodeRequest.prototype, "payCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayCodeId",
        }),
        __metadata("design:type", String)
    ], PatchPayCodeRequest.prototype, "payCodeId", void 0);
    return PatchPayCodeRequest;
}(utils_1.SpeakeasyBase));
exports.PatchPayCodeRequest = PatchPayCodeRequest;
var PatchPayCodeResponse = /** @class */ (function (_super) {
    ...
    ], PatchPayCodeResponse.prototype, "rawResponse", void 0);
    return PatchPayCodeResponse;
}(utils_1.SpeakeasyBase));
exports.PatchPayCodeResponse = PatchPayCodeResponse;
