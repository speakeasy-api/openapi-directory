...
public class GetStrategiesRequest {
    /**
    ...
    public GetStrategiesRequest withWmConsumerChannelType(String wmConsumerChannelType) {
    ...
    public GetStrategiesRequest withWmQosCorrelationId(String wmQosCorrelationId) {
    ...
    public GetStrategiesRequest withWmSecAccessToken(String wmSecAccessToken) {
    ...
    public GetStrategiesRequest withWmSvcName(String wmSvcName) {
        this.wmSvcName = wmSvcName;
        return this;
    }
    
    public GetStrategiesRequest(@JsonProperty("WM_QOS.CORRELATION_ID") String wmQosCorrelationId, @JsonProperty("WM_SEC.ACCESS_TOKEN") String wmSecAccessToken, @JsonProperty("WM_SVC.NAME") String wmSvcName) {
        this.wmQosCorrelationId = wmQosCorrelationId;
        this.wmSecAccessToken = wmSecAccessToken;
        this.wmSvcName = wmSvcName;
  }
