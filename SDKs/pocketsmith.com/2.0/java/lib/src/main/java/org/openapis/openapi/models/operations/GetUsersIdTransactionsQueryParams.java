...
public class GetUsersIdTransactionsQueryParams {
    /**
    ...
    public GetUsersIdTransactionsQueryParams withEndDate(String endDate) {
    ...
    public GetUsersIdTransactionsQueryParams withNeedsReview(Long needsReview) {
    ...
    public Long page;
    public GetUsersIdTransactionsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdTransactionsQueryParams withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public GetUsersIdTransactionsQueryParams withStartDate(String startDate) {
    ...
    public GetUsersIdTransactionsQueryParams withType(GetUsersIdTransactionsTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GetUsersIdTransactionsQueryParams withUncategorised(Long uncategorised) {
    ...
    public GetUsersIdTransactionsQueryParams withUpdatedSince(String updatedSince) {
