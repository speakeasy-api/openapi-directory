...
public class Captions {
    ...
    public org.openapis.openapi.models.operations.GetCaptionsResponse getCaptions(org.openapis.openapi.models.operations.GetCaptionsRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetCaptionsRequest.class, baseUrl, "/jobs/{id}/captions", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetCaptionsRequest.class, request, null);
        if (queryParams != null) {
