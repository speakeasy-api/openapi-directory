...
var CustomerConnectorInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "activeConnectors" }),
        __metadata("design:type", Number)
    ], CustomerConnectorInfo.prototype, "activeConnectors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "blackListedConnectors" }),
        __metadata("design:type", Number)
    ], CustomerConnectorInfo.prototype, "blackListedConnectors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "healthyConnectors" }),
        __metadata("design:type", Number)
    ], CustomerConnectorInfo.prototype, "healthyConnectors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "shutdownConnectors" }),
        __metadata("design:type", Number)
    ], CustomerConnectorInfo.prototype, "shutdownConnectors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "totalConnectors" }),
        __metadata("design:type", Number)
    ], CustomerConnectorInfo.prototype, "totalConnectors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unhealthyConnectors" }),
        __metadata("design:type", Number)
    ], CustomerConnectorInfo.prototype, "unhealthyConnectors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unknownConnectors" }),
        __metadata("design:type", Number)
