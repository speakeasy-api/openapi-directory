...
const (
	PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJSONVehicleEngineTypeEnumCombustion PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJSONVehicleEngineTypeEnum = "combustion"
...
type PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJSONRequest struct {
	...
	VehicleEngineType *PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeJSONVehicleEngineTypeEnum `queryParam:"style=form,explode=true,name=vehicleEngineType"`
