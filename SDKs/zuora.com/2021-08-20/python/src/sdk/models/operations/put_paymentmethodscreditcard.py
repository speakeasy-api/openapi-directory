...
from ..shared import putpaymentmethodtype as shared_putpaymentmethodtype
...
class PUTPaymentMethodsCreditCardRequest:
    ...
    put_payment_method_type: shared_putpaymentmethodtype.PUTPaymentMethodType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
