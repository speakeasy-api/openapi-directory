...
public class GetUsersIdsAnswersQueryParams {
    /**
    ...
    public GetUsersIdsAnswersQueryParams withCallback(String callback) {
    ...
    public GetUsersIdsAnswersQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsAnswersQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetUsersIdsAnswersQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetUsersIdsAnswersQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsAnswersQueryParams withOrder(GetUsersIdsAnswersOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetUsersIdsAnswersQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsAnswersQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetUsersIdsAnswersQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsAnswersQueryParams withSort(GetUsersIdsAnswersSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetUsersIdsAnswersQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
