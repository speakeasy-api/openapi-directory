...
public class DisplayvideoAdvertisersInsertionOrdersDeleteRequest {
    ...
    public DisplayvideoAdvertisersInsertionOrdersDeleteRequest(@JsonProperty("advertiserId") String advertiserId, @JsonProperty("insertionOrderId") String insertionOrderId) {
        this.advertiserId = advertiserId;
        this.insertionOrderId = insertionOrderId;
  }
}
