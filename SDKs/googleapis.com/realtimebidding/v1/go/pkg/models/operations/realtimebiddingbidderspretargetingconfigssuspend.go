...
type RealtimebiddingBiddersPretargetingConfigsSuspendSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RealtimebiddingBiddersPretargetingConfigsSuspendPathParams struct {
...
type RealtimebiddingBiddersPretargetingConfigsSuspendQueryParams struct {
	// V1 error format.
...
type RealtimebiddingBiddersPretargetingConfigsSuspendRequest struct {
...
type RealtimebiddingBiddersPretargetingConfigsSuspendResponse struct {
	ContentType string
	// Successful response
