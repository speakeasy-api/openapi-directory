...
public class GitCreateCommitRequest {
    ...
    public GitCreateCommitRequest(@JsonProperty("RequestBody") GitCreateCommitRequestBody requestBody, @JsonProperty("owner") String owner, @JsonProperty("repo") String repo) {
        this.requestBody = requestBody;
        this.owner = owner;
        this.repo = repo;
  }
