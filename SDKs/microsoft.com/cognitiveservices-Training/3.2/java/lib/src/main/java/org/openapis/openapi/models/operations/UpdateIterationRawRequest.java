...
public class UpdateIterationRawRequest {
    ...
    public UpdateIterationRawRequest(@JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("iterationId") String iterationId, @JsonProperty("projectId") String projectId) {
        this.requestBody = requestBody;
        this.iterationId = iterationId;
        this.projectId = projectId;
  }
