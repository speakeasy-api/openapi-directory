...
var ScorecardChartSpec = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "baselineValueData" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "baselineValueFormat" }),
        (0, class_transformer_1.Type)(function () { return baselinevalueformat_1.BaselineValueFormat; }),
        __metadata("design:type", baselinevalueformat_1.BaselineValueFormat)
    ], ScorecardChartSpec.prototype, "baselineValueFormat", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "customFormatOptions" }),
        (0, class_transformer_1.Type)(function () { return chartcustomnumberformatoptions_1.ChartCustomNumberFormatOptions; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "keyValueData" }),
        (0, class_transformer_1.Type)(function () { return chartdata_1.ChartData; }),
        __metadata("design:type", chartdata_1.ChartData)
    ], ScorecardChartSpec.prototype, "keyValueData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "keyValueFormat" }),
        (0, class_transformer_1.Type)(function () { return keyvalueformat_1.KeyValueFormat; }),
        __metadata("design:type", keyvalueformat_1.KeyValueFormat)
    ], ScorecardChartSpec.prototype, "keyValueFormat", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "numberFormatSource" }),
        __metadata("design:type", String)
    ], ScorecardChartSpec.prototype, "numberFormatSource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "scaleFactor" }),
