...
var Tools = /** @class */ (function () {
    function Tools(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Tools.prototype.toolsShareFile = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ToolsShareFileRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/tools/sharefile";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.shareFileResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
