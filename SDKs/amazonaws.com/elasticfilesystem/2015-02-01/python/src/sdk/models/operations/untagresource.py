...
class UntagResourceRequest:
    ...
    r"""Specifies the EFS resource that you want to remove tags from."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""The keys of the key-value tag pairs that you want to remove from the specified EFS resource."""  
