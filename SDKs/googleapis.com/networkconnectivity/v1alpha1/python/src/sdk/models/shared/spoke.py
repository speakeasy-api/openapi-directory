...
class Spoke:
    ...
    linked_interconnect_attachments: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('linkedInterconnectAttachments') }})
    linked_router_appliance_instances: Optional[list[shared_routerapplianceinstance.RouterApplianceInstance]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('linkedRouterApplianceInstances') }})
    linked_vpn_tunnels: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('linkedVpnTunnels') }})
