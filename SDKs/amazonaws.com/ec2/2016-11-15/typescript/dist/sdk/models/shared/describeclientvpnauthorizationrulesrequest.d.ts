 ...
 */
export declare class DescribeClientVpnAuthorizationRulesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeClientVpnAuthorizationRulesRequest extends SpeakeasyBase {
    clientVpnEndpointId: string;
    dryRun?: boolean;
    filters?: DescribeClientVpnAuthorizationRulesRequestFilters[];
    maxResults?: number;
    nextToken?: string;
}
