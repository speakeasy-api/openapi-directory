...
public class NHBugNorth {
    ...
    public NHBugNorthAvailabilityArray[] availabilityArray;
    public NHBugNorth withAvailabilityArray(NHBugNorthAvailabilityArray[] availabilityArray) {
    ...
    public NHBugNorth withMonths(String months) {
        this.months = months;
        return this;
    }
    ...
    public NHBugNorth withMonthsArray(Long[] monthsArray) {
    ...
    public NHBugNorthTimesByMonth timesByMonth;
    public NHBugNorth withTimesByMonth(NHBugNorthTimesByMonth timesByMonth) {
