...
public class RecommenderProjectsLocationsInsightTypesInsightsMarkAcceptedRequest {
    ...
    public openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest request;
    public RecommenderProjectsLocationsInsightTypesInsightsMarkAcceptedRequest withRequest(openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest request) {
