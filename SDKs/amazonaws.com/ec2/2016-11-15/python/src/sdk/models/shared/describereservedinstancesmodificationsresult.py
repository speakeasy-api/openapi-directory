...
class DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfigurationInstanceTypeEnum(str, Enum):
    r"""The instance type for the modified Reserved Instances."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
class DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfigurationScopeEnum(str, Enum):
    r"""Whether the Reserved Instance is applied to instances in a Region or instances in a specific Availability Zone."""
...
class DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfiguration:
    r"""The target Reserved Instances configurations supplied as part of the modification request."""
    
    availability_zone: Optional[str] = dataclasses.field(default=None)  
    instance_count: Optional[int] = dataclasses.field(default=None)  
    instance_type: Optional[DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfigurationInstanceTypeEnum] = dataclasses.field(default=None)  
    platform: Optional[str] = dataclasses.field(default=None)  
    scope: Optional[DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfigurationScopeEnum] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResults:
    r"""Describes the modification request/s."""
    
    reserved_instances_id: Optional[str] = dataclasses.field(default=None)  
    target_configuration: Optional[DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfiguration] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DescribeReservedInstancesModificationsResultReservedInstancesModificationsReservedInstancesIds:
    r"""Describes the ID of a Reserved Instance."""
...
class DescribeReservedInstancesModificationsResultReservedInstancesModifications:
    r"""Describes a Reserved Instance modification."""
    
    client_token: Optional[str] = dataclasses.field(default=None)  
    create_date: Optional[datetime] = dataclasses.field(default=None)  
    effective_date: Optional[datetime] = dataclasses.field(default=None)  
    modification_results: Optional[list[DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResults]] = dataclasses.field(default=None)  
    reserved_instances_ids: Optional[list[DescribeReservedInstancesModificationsResultReservedInstancesModificationsReservedInstancesIds]] = dataclasses.field(default=None)  
    reserved_instances_modification_id: Optional[str] = dataclasses.field(default=None)  
...
class DescribeReservedInstancesModificationsResult:
    r"""Contains the output of DescribeReservedInstancesModifications."""
    
    next_token: Optional[str] = dataclasses.field(default=None)  
    reserved_instances_modifications: Optional[list[DescribeReservedInstancesModificationsResultReservedInstancesModifications]] = dataclasses.field(default=None)  
