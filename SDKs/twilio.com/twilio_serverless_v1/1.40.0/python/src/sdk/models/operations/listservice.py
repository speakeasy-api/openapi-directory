...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_serverless_v1_service.ServerlessV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
