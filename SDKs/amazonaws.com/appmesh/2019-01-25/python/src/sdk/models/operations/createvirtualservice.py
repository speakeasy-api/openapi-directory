...
class CreateVirtualServiceRequestBody:
    spec: CreateVirtualServiceRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('spec') }})
...
class CreateVirtualServiceRequest:
    headers: CreateVirtualServiceHeaders = dataclasses.field()
    path_params: CreateVirtualServicePathParams = dataclasses.field()
    query_params: CreateVirtualServiceQueryParams = dataclasses.field()
    request: CreateVirtualServiceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
