...
class SDK:
    ...
    def delete_domain_cert_v4(self, request: operations.DeleteDomainCertV4Request) -> operations.DeleteDomainCertV4Response:
        base_url = operations.DELETE_DOMAIN_CERT_V4_SERVERS[0]
        if request.server_url is not None:
            base_url = request.server_url
        
        
        url = utils.generate_url(base_url, "/v1/LinkShortening/Domains/{DomainSid}/Certificate", request.path_params)
        ...
        res = operations.DeleteDomainCertV4Response(status_code=r.status_code, content_type=content_type)
    ...
    def fetch_domain_cert_v4(self, request: operations.FetchDomainCertV4Request) -> operations.FetchDomainCertV4Response:
        ...
        res = operations.FetchDomainCertV4Response(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MessagingV1DomainCertV4])
                res.messaging_v1_domain_cert_v4 = out

        return res

    
    def fetch_domain_config(self, request: operations.FetchDomainConfigRequest) -> operations.FetchDomainConfigResponse:
        base_url = operations.FETCH_DOMAIN_CONFIG_SERVERS[0]
        if request.server_url is not None:
            base_url = request.server_url
        
        
        url = utils.generate_url(base_url, "/v1/LinkShortening/Domains/{DomainSid}/Config", request.path_params)
        ...
        res = operations.FetchDomainConfigResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MessagingV1DomainConfig])
    ...
    def update_domain_cert_v4(self, request: operations.UpdateDomainCertV4Request) -> operations.UpdateDomainCertV4Response:
        ...
        res = operations.UpdateDomainCertV4Response(status_code=r.status_code, content_type=content_type)
    ...
    def update_domain_config(self, request: operations.UpdateDomainConfigRequest) -> operations.UpdateDomainConfigResponse:
        ...
        res = operations.UpdateDomainConfigResponse(status_code=r.status_code, content_type=content_type)
