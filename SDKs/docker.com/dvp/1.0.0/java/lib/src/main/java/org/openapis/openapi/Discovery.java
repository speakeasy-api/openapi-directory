...
public class Discovery {
    ...
    public org.openapis.openapi.models.operations.GetNamespaceResponse getNamespace(org.openapis.openapi.models.operations.GetNamespaceRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.NamespaceMetadata out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.NamespaceMetadata.class);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetNamespacesResponse getNamespaces() throws Exception {
        String baseUrl = this._serverUrl;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.NamespaceData out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.NamespaceData.class);
