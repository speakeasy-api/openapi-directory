...
exports.InvoiceItemsDeleteResponse = exports.InvoiceItemsDeleteRequest = exports.InvoiceItemsDeleteSecurity = void 0;
...
exports.InvoiceItemsDeleteSecurity = InvoiceItemsDeleteSecurity;
var InvoiceItemsDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], InvoiceItemsDeleteRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], InvoiceItemsDeleteRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsDeleteRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsDeleteRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsDeleteRequest.prototype, "xApideckServiceId", void 0);
    return InvoiceItemsDeleteRequest;
}(utils_1.SpeakeasyBase));
exports.InvoiceItemsDeleteRequest = InvoiceItemsDeleteRequest;
var InvoiceItemsDeleteResponse = /** @class */ (function (_super) {
    ...
    ], InvoiceItemsDeleteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.InvoiceItemsDeleteResponse = InvoiceItemsDeleteResponse;
