...
export class BalanceSheet {
  ...
  balanceSheetOne(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/accounting/balance-sheet";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.BalanceSheetOneResponse =
        new operations.BalanceSheetOneResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getBalanceSheetResponse = utils.objectToClass(
              httpRes?.data,
              shared.GetBalanceSheetResponse
            );
          }
          break;
