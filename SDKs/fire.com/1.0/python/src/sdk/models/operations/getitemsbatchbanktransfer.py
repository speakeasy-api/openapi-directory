...
@dataclasses.dataclass
class GetItemsBatchBankTransferBatchItemsBatchItemResult:
...
class GetItemsBatchBankTransferBatchItemsBatchItemStatusEnum(str, Enum):
...
class GetItemsBatchBankTransferBatchItemsBatchItem:
    ...
    result: Optional[GetItemsBatchBankTransferBatchItemsBatchItemResult] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
    r"""The outcome of the attempted transaction."""  
    status: Optional[GetItemsBatchBankTransferBatchItemsBatchItemStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""status of the batch if internal trasnfer"""  
...
class GetItemsBatchBankTransferBatchItems:
    ...
    items: Optional[list[GetItemsBatchBankTransferBatchItemsBatchItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})  
...
class GetItemsBatchBankTransferResponse:
    ...
    batch_items: Optional[GetItemsBatchBankTransferBatchItems] = dataclasses.field(default=None)
    r"""A fire.com list object of Batch Items (Internal transfers or Bank transfers)."""  
