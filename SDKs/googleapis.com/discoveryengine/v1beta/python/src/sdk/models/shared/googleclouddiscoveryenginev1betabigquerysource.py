...
class GoogleCloudDiscoveryengineV1betaBigQuerySource:
    r"""GoogleCloudDiscoveryengineV1betaBigQuerySource
    ...
    gcs_staging_dir: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('gcsStagingDir') }})
    partition_date: Optional[shared_googletypedate.GoogleTypeDate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('partitionDate') }})
