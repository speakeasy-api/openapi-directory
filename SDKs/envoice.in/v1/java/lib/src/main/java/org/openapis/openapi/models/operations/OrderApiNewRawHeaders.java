...
public class OrderApiNewRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiNewRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiNewRawHeaders withXAuthSecret(String xAuthSecret) {
