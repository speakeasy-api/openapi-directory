...
export class GkebackupProjectsLocationsBackupPlansBackupsVolumeBackupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsBackupPlansBackupsVolumeBackupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkebackupProjectsLocationsBackupPlansBackupsVolumeBackupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
