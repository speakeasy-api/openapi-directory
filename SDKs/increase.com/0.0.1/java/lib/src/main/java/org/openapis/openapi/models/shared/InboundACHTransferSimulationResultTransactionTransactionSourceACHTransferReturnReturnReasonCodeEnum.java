 ...
 */
public enum InboundACHTransferSimulationResultTransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum {
    ...
    private InboundACHTransferSimulationResultTransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum(String value) {
        this.value = value;
    }
}
