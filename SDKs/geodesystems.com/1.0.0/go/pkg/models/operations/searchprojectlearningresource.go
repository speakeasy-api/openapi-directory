...
type SearchProjectLearningResourceQueryParams struct {
	...
	// Grade Level
	SearchProjectLearningResourceGradeLevel *string `queryParam:"style=form,explode=true,name=search.project_learning_resource.grade_level"`
	// Topic
	SearchProjectLearningResourceTopic *string `queryParam:"style=form,explode=true,name=search.project_learning_resource.topic"`
	// Number to skip
...
type SearchProjectLearningResourceRequest struct {
	QueryParams SearchProjectLearningResourceQueryParams
}

type SearchProjectLearningResourceResponse struct {
	ContentType string
	StatusCode  int
