...
type ClassroomCoursesTopicsPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ClassroomCoursesTopicsPatchPathParams struct {
...
type ClassroomCoursesTopicsPatchQueryParams struct {
	// V1 error format.
...
type ClassroomCoursesTopicsPatchRequest struct {
...
type ClassroomCoursesTopicsPatchResponse struct {
	ContentType string
	StatusCode  int
