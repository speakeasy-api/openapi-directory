 ...
 */
export class AssociateUserRequestBodyIdentityProvider extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class AssociateUserRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(() => AssociateUserRequestBodyIdentityProvider)
...
export class AssociateUserRequest extends SpeakeasyBase {
...
export class AssociateUserResponse extends SpeakeasyBase {
  /**
