...
public class DistributionGroupsPatchForOrgPathParams {
    /**
    ...
    public DistributionGroupsPatchForOrgPathParams withDistributionGroupName(String distributionGroupName) {
    ...
    public DistributionGroupsPatchForOrgPathParams withOrgName(String orgName) {
