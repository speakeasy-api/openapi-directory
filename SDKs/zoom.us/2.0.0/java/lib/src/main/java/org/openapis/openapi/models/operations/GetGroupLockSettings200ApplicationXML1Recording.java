...
public class GetGroupLockSettings200ApplicationXML1Recording {
    /**
     * Make cloud recordings accessible to account members only.
     */
    
    public Boolean accountUserAccessRecording;
    public GetGroupLockSettings200ApplicationXML1Recording withAccountUserAccessRecording(Boolean accountUserAccessRecording) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withAutoDeleteCmr(Boolean autoDeleteCmr) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withAutoRecording(String autoRecording) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withCloudRecording(Boolean cloudRecording) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withCloudRecordingDownload(Boolean cloudRecordingDownload) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withHostDeleteCloudRecording(Boolean hostDeleteCloudRecording) {
    ...
    public GetGroupLockSettings200ApplicationXML1RecordingIpAddressAccessControl ipAddressAccessControl;
    public GetGroupLockSettings200ApplicationXML1Recording withIpAddressAccessControl(GetGroupLockSettings200ApplicationXML1RecordingIpAddressAccessControl ipAddressAccessControl) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withLocalRecording(Boolean localRecording) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withPreventHostAccessRecording(Boolean preventHostAccessRecording) {
    ...
    public GetGroupLockSettings200ApplicationXML1Recording withRecordingAuthentication(Boolean recordingAuthentication) {
