...
class DescribeReservedInstancesListingsRequest:
    r"""Contains the parameters for DescribeReservedInstancesListings."""
    
    filters: Optional[list[DescribeReservedInstancesListingsRequestFilters]] = dataclasses.field(default=None)  
