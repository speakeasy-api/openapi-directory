 ...
 */
export enum NodeTypeAggregatedListWarningCodeEnum {
...
export class NodeTypeAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeTypeAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeTypeAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class NodeTypeAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeTypesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, NodeTypesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], NodeTypesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
