...
export class PutIndividualsPartyIdAddressesAddressIdRequest extends SpeakeasyBase {
  /**
...
export class PutIndividualsPartyIdAddressesAddressIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
