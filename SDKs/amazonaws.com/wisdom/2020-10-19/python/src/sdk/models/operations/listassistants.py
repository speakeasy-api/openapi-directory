...
from ..shared import listassistantsresponse as shared_listassistantsresponse
...
class ListAssistantsResponse:
    ...
    list_assistants_response: Optional[shared_listassistantsresponse.ListAssistantsResponse] = dataclasses.field(default=None)
    r"""Success"""  
