...
class GetEnvironmentAccountConnectionRequest:
    ...
    get_environment_account_connection_input: shared_getenvironmentaccountconnectioninput.GetEnvironmentAccountConnectionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
