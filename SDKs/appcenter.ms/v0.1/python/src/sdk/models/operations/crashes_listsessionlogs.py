...
class CrashesListSessionLogsSecurity:
...
class CrashesListSessionLogsDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
class CrashesListSessionLogsDefaultApplicationJSONError:
    ...
    code: CrashesListSessionLogsDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CrashesListSessionLogsDefaultApplicationJSON:
    r"""Error code with reason"""
    
    error: CrashesListSessionLogsDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
...
class CrashesListSessionLogs200ApplicationJSONLogsTypeEnum(str, Enum):
    r"""Log type."""
    EVENT = 'event'
    PAGE = 'page'
...
class CrashesListSessionLogs200ApplicationJSONLogs:
    ...
    device: CrashesListSessionLogs200ApplicationJSONLogsDevice = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('device') }})
    r"""Device characteristics."""  
    ...
    type: CrashesListSessionLogs200ApplicationJSONLogsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Log type."""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CrashesListSessionLogs200ApplicationJSON:
    r"""Session logs of specific crash"""
    
    logs: list[CrashesListSessionLogs200ApplicationJSONLogs] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logs') }})
    r"""the list of logs"""  
...
class CrashesListSessionLogsResponse:
    ...
    crashes_list_session_logs_200_application_json_object: Optional[CrashesListSessionLogs200ApplicationJSON] = dataclasses.field(default=None)
    r"""Session logs of specific crash"""  
    crashes_list_session_logs_default_application_json_object: Optional[CrashesListSessionLogsDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error code with reason"""  
