...
from ..shared import proxymodifyproduct as shared_proxymodifyproduct
...
class ObjectPUTProductRequest:
    ...
    r"""Object id"""  
    proxy_modify_product: shared_proxymodifyproduct.ProxyModifyProduct = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
