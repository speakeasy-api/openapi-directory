...
export declare class GetUserIdentiyProviderExternalIdRequest extends SpeakeasyBase {
    apiKey: string;
    apiUsername: string;
    externalId: string;
    /**
...
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUserCustomFields extends SpeakeasyBase {
    firstName?: string;
}
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUserGroupUsers extends SpeakeasyBase {
    groupId: number;
    notificationLevel: number;
    owner?: boolean;
    userId: number;
}
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUserGroups extends SpeakeasyBase {
...
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUserUserAuthTokens extends SpeakeasyBase {
    browser: string;
    clientIp: string;
    createdAt: string;
    device: string;
...
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUserUserFields extends SpeakeasyBase {
    one: string;
    two: string;
}
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUserUserNotificationSchedule extends SpeakeasyBase {
    day0EndTime: number;
...
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUserUserOption extends SpeakeasyBase {
...
export declare class GetUserIdentiyProviderExternalId200ApplicationJSONUser extends SpeakeasyBase {
    admin: boolean;
 ...
 * user response
 */
export declare class GetUserIdentiyProviderExternalId200ApplicationJSON extends SpeakeasyBase {
    user: GetUserIdentiyProviderExternalId200ApplicationJSONUser;
    userBadges: any[];
}
export declare class GetUserIdentiyProviderExternalIdResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
