...
var Beneficiaries = /** @class */ (function () {
     ...
     */
    Beneficiaries.prototype.getAccountsAccountIdBeneficiaries = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAccountsAccountIdBeneficiariesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/accounts/{accountId}/beneficiaries", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetAccountsAccountIdBeneficiariesSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetAccountsAccountIdBeneficiariesResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.obReadBeneficiary5 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OBReadBeneficiary5);
                    }
