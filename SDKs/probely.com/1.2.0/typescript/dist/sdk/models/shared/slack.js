...
var Slack = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "notify_finding_fixed" }),
        __metadata("design:type", Boolean)
    ], Slack.prototype, "notifyFindingFixed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notify_high_findings" }),
        __metadata("design:type", Boolean)
    ], Slack.prototype, "notifyHighFindings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notify_low_findings" }),
        __metadata("design:type", Boolean)
    ], Slack.prototype, "notifyLowFindings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notify_medium_findings" }),
        __metadata("design:type", Boolean)
    ], Slack.prototype, "notifyMediumFindings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notify_scan_completed" }),
        __metadata("design:type", Boolean)
    ], Slack.prototype, "notifyScanCompleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notify_scan_started" }),
        __metadata("design:type", Boolean)
