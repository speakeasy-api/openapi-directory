...
public class GetMissedMssqlDbSnapshotsRequest {
    /**
    ...
    public GetMissedMssqlDbSnapshotsRequest withAfterTime(OffsetDateTime afterTime) {
    ...
    public GetMissedMssqlDbSnapshotsRequest withBeforeTime(OffsetDateTime beforeTime) {
    ...
    public GetMissedMssqlDbSnapshotsRequest withId(String id) {
        this.id = id;
        return this;
    }
    
    public GetMissedMssqlDbSnapshotsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
