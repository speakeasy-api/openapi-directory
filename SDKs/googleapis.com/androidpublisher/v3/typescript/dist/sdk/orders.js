...
var Orders = /** @class */ (function () {
     ...
     */
    Orders.prototype.androidpublisherOrdersRefund = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidpublisherOrdersRefundRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/androidpublisher/v3/applications/{packageName}/orders/{orderId}:refund", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AndroidpublisherOrdersRefundResponse({
