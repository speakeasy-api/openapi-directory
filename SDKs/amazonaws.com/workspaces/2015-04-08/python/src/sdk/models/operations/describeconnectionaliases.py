...
class DescribeConnectionAliasesRequest:
    ...
    describe_connection_aliases_request: shared_describeconnectionaliasesrequest.DescribeConnectionAliasesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
