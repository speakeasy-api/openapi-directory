 ...
 */
public enum GetGroupSettings200ApplicationXML1ScheduleMeetingRequirePasswordForPmiMeetingsEnum {
    ALL("all"),
    JBH_ONLY("jbh_only"),
    NONE("none");
    ...
    private GetGroupSettings200ApplicationXML1ScheduleMeetingRequirePasswordForPmiMeetingsEnum(String value) {
        this.value = value;
    }
}
