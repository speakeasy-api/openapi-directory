...
exports.ListSipCredentialListMappingResponse = exports.ListSipCredentialListMappingListSipCredentialListMappingResponse = exports.ListSipCredentialListMappingRequest = exports.ListSipCredentialListMappingSecurity = exports.ListSipCredentialListMappingServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSipCredentialListMappingServerList = [
...
var ListSipCredentialListMappingSecurity = /** @class */ (function (_super) {
    ...
    ], ListSipCredentialListMappingSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSipCredentialListMappingSecurity.prototype, "username", void 0);
    return ListSipCredentialListMappingSecurity;
}(utils_1.SpeakeasyBase));
exports.ListSipCredentialListMappingSecurity = ListSipCredentialListMappingSecurity;
var ListSipCredentialListMappingRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSipCredentialListMappingRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomainSid",
        }),
        __metadata("design:type", String)
    ], ListSipCredentialListMappingRequest.prototype, "domainSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSipCredentialListMappingRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSipCredentialListMappingRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSipCredentialListMappingRequest.prototype, "pageToken", void 0);
    return ListSipCredentialListMappingRequest;
}(utils_1.SpeakeasyBase));
exports.ListSipCredentialListMappingRequest = ListSipCredentialListMappingRequest;
/**
 * OK
 */
var ListSipCredentialListMappingListSipCredentialListMappingResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "credential_list_mappings" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountSipSipDomainSipCredentialListMapping; }),
...
exports.ListSipCredentialListMappingListSipCredentialListMappingResponse = ListSipCredentialListMappingListSipCredentialListMappingResponse;
var ListSipCredentialListMappingResponse = /** @class */ (function (_super) {
    ...
    ], ListSipCredentialListMappingResponse.prototype, "rawResponse", void 0);
    return ListSipCredentialListMappingResponse;
}(utils_1.SpeakeasyBase));
exports.ListSipCredentialListMappingResponse = ListSipCredentialListMappingResponse;
