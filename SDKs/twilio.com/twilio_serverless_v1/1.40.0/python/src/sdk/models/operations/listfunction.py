...
class ListFunctionRequest:
    ...
    r"""The SID of the Service to read the Function resources from."""  
...
class ListFunctionListFunctionResponse:
    ...
    functions: Optional[list[shared_serverless_v1_service_function.ServerlessV1ServiceFunction]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('functions'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListFunctionListFunctionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
