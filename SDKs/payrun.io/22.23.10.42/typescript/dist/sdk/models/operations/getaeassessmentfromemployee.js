...
exports.GetAEAssessmentFromEmployeeResponse = exports.GetAEAssessmentFromEmployeeRequest = void 0;
...
var GetAEAssessmentFromEmployeeRequest = /** @class */ (function (_super) {
    ...
    ], GetAEAssessmentFromEmployeeRequest.prototype, "aeAssessmentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Api-Version",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentFromEmployeeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentFromEmployeeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentFromEmployeeRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentFromEmployeeRequest.prototype, "employerId", void 0);
...
var GetAEAssessmentFromEmployeeResponse = /** @class */ (function (_super) {
    ...
    ], GetAEAssessmentFromEmployeeResponse.prototype, "rawResponse", void 0);
