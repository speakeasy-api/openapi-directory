 ...
 */
public enum DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationStateEnum {
    ...
    private DisassociateIpamResourceDiscoveryResultIpamResourceDiscoveryAssociationStateEnum(String value) {
        this.value = value;
    }
}
