...
public class GetUnmaskedAddressPathParams {
    /**
    ...
    public GetUnmaskedAddressPathParams withAddressId(String addressId) {
    ...
    public GetUnmaskedAddressPathParams withProfileId(String profileId) {
