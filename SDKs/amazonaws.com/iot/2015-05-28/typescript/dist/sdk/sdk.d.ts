...
export declare class SDK {
     ...
     */
    describeManagedJobTemplate(req: operations.DescribeManagedJobTemplateRequest, config?: AxiosRequestConfig): Promise<operations.DescribeManagedJobTemplateResponse>;
    /**
     ...
     */
    listManagedJobTemplates(req: operations.ListManagedJobTemplatesRequest, config?: AxiosRequestConfig): Promise<operations.ListManagedJobTemplatesResponse>;
    /**
     * Lists the values reported for an IoT Device Defender metric (device-side metric, cloud-side metric, or custom metric) by the given thing during the specified time period.
     */
    listMetricValues(req: operations.ListMetricValuesRequest, config?: AxiosRequestConfig): Promise<operations.ListMetricValuesResponse>;
    /**
     ...
     */
    listRelatedResourcesForAuditFinding(req: operations.ListRelatedResourcesForAuditFindingRequest, config?: AxiosRequestConfig): Promise<operations.ListRelatedResourcesForAuditFindingResponse>;
    /**
     ...
     */
    putVerificationStateOnViolation(req: operations.PutVerificationStateOnViolationRequest, config?: AxiosRequestConfig): Promise<operations.PutVerificationStateOnViolationResponse>;
    /**
