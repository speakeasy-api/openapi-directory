...
public class General {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostDisablePermitResponse postDisablePermit(org.openapis.openapi.models.shared.DisablePermitRequest request, org.openapis.openapi.models.operations.PostDisablePermitSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/disablePermit");
        ...
        org.openapis.openapi.models.operations.PostDisablePermitResponse res = new org.openapis.openapi.models.operations.PostDisablePermitResponse() {{
            disablePermitResult = null;
            serviceError = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.DisablePermitResult out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.DisablePermitResult.class);
                res.disablePermitResult = out;
            }
        }
        else if (httpRes.statusCode() == 400 || httpRes.statusCode() == 401 || httpRes.statusCode() == 403 || httpRes.statusCode() == 422 || httpRes.statusCode() == 500) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
