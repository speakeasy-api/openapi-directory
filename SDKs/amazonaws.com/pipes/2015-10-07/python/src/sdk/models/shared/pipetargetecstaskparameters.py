...
from ..shared import ecstaskoverride as shared_ecstaskoverride
...
class PipeTargetEcsTaskParameters:
    r"""The parameters for using an Amazon ECS task as a target."""
    ...
    overrides: Optional[shared_ecstaskoverride.EcsTaskOverride] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Overrides'), 'exclude': lambda f: f is None }})  
