...
class ListEventSubscriptionsRequest:
    ...
    list_event_subscriptions_request: shared_listeventsubscriptionsrequest.ListEventSubscriptionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
