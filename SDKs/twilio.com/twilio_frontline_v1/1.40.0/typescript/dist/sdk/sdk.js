 ...
 */
exports.ServerList = ["https://frontline-api.twilio.com"];
/**
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.frontlineV1User = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.FrontlineV1User);
                    }
                    break;
            }
            return res;
