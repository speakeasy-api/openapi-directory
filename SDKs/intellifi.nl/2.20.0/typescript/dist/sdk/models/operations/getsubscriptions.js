...
exports.GetSubscriptionsResponse = exports.GetSubscriptionsRequest = exports.GetSubscriptions200ApplicationJson = exports.GetSubscriptionsQueryParams = void 0;
...
var GetSubscriptionsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=database_hold_time_h" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=populate_events" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=topic_filter" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=verify_target_certificate" }),
        __metadata("design:type", Boolean)
    ], GetSubscriptionsQueryParams.prototype, "verifyTargetCertificate", void 0);
    return GetSubscriptionsQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetSubscriptionsQueryParams = GetSubscriptionsQueryParams;
var GetSubscriptions200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=results", elemType: shared.Subscription }),
