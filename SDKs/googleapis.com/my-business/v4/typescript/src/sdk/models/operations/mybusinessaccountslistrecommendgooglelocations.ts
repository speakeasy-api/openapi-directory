...
export class MybusinessAccountsListRecommendGoogleLocationsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessAccountsListRecommendGoogleLocationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
