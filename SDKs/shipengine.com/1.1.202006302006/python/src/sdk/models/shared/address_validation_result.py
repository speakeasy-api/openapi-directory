...
class AddressValidationResultPartialAddress:
    r"""AddressValidationResultPartialAddress
...
class AddressValidationResult:
    ...
    matched_address: AddressValidationResultPartialAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('matched_address') }})
