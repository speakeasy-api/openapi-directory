...
export class FirebasehostingSitesVersionsPatchSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebasehostingSitesVersionsPatchSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebasehostingSitesVersionsPatchSecurity extends SpeakeasyBase {
...
export class FirebasehostingSitesVersionsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebasehostingSitesVersionsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
