 ...
 */
export enum MetalsBenchmarkSummaryGETFormatEnum {
  Json = "json",
  Xml = "xml",
}
 ...
 * dwt=pennyweight
 */
export enum MetalsBenchmarkSummaryGETUnitofmeasureEnum {
  Mg = "mg",
  G = "g",
  Kg = "kg",
  Gr = "gr",
...
export class MetalsBenchmarkSummaryGETRequest extends SpeakeasyBase {
  /**
...
export class MetalsBenchmarkSummaryGETResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
