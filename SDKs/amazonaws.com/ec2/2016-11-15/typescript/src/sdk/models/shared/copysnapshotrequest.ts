 ...
 */
export enum CopySnapshotRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CopySnapshotRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CopySnapshotRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CopySnapshotRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CopySnapshotRequestTagSpecificationsTags })
...
export class CopySnapshotRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: CopySnapshotRequestTagSpecifications })
