...
import dataclasses
from ..shared import point_pointdailyeveningcloudcoverdata as shared_point_pointdailyeveningcloudcoverdata
from ..shared import point_pointdailyeveningprecipitationdata as shared_point_pointdailyeveningprecipitationdata
from ..shared import point_pointdailyeveningprobdata as shared_point_pointdailyeveningprobdata
from ..shared import point_pointdailyeveningwinddata as shared_point_pointdailyeveningwinddata
...
class PointPointDailyEveningData:
    ...
    cloud_cover: shared_point_pointdailyeveningcloudcoverdata.PointPointDailyEveningCloudCoverData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cloud_cover') }})  
    precipitation: shared_point_pointdailyeveningprecipitationdata.PointPointDailyEveningPrecipitationData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('precipitation') }})  
    probability: shared_point_pointdailyeveningprobdata.PointPointDailyEveningProbData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('probability') }})  
    wind: shared_point_pointdailyeveningwinddata.PointPointDailyEveningWindData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('wind') }})  
    ...
    r"""Relative humidity. (evening avg)
    Unit: \%
    """  
    ...
    r"""Evening numeric identifier of the weather icon. The following values can appear:
    ...
    * 36 - Possible freezing rain (night)
    ...
    r"""Total column of ozone. (evening avg)
    Unit: Dobson
    """  
    ...
    r"""Atmospheric pressure at mean sea level. (evening avg)
    ...
    r"""Temperature 2 metres above ground. (evening avg)
    ...
    r"""Evening day string identifier of the weather icon, e.g. `light_rain`."""  
