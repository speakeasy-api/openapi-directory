...
class TeamsUpdateDiscussionCommentLegacyRequest:
    path_params: TeamsUpdateDiscussionCommentLegacyPathParams = dataclasses.field()
    request: Optional[TeamsUpdateDiscussionCommentLegacyRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
