...
class PostQuoteLikeRequest:
    query_params: PostQuoteLikeQueryParams = dataclasses.field()
    security: PostQuoteLikeSecurity = dataclasses.field()
