...
class ProcessBatchRequestBodyDisplaySchemeEnum(str, Enum):
    r"""The display format that the label should be shown in."""
    LABEL = 'label'
    QR_CODE = 'qr_code'
    LABEL_AND_QR_CODE = 'label_and_qr_code'

class ProcessBatchRequestBodyLabelFormatEnum(str, Enum):
...
class ProcessBatchRequestBodyLabelLayoutEnum(str, Enum):
...
class ProcessBatchRequestBody:
    r"""A process batch request body"""
    
    display_scheme: Optional[ProcessBatchRequestBodyDisplaySchemeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('display_scheme'), 'exclude': lambda f: f is None }})
    r"""The display format that the label should be shown in."""  
    label_format: Optional[ProcessBatchRequestBodyLabelFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_format'), 'exclude': lambda f: f is None }})  
    label_layout: Optional[ProcessBatchRequestBodyLabelLayoutEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('label_layout'), 'exclude': lambda f: f is None }})  
    ...
    r"""The Ship date the batch is being processed for"""  
