...
public class Status {
    ...
    public org.openapis.openapi.models.operations.StatusResponse status(org.openapis.openapi.models.operations.StatusRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.StatusRequest.class, request, null);
        if (queryParams != null) {
