...
class ColumnBreak:
    ...
    r"""The suggested insertion IDs. A ColumnBreak may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion."""  
    ...
    r"""The suggested text style changes to this ColumnBreak, keyed by suggestion ID."""  
