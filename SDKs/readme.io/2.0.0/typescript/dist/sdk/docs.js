...
var Docs = /** @class */ (function () {
    function Docs(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Docs.prototype.createDoc = function (req, config) {
        var _a;
    ...
    **/
    Docs.prototype.deleteDoc = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteDocRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/docs/{slug}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    Docs.prototype.getDoc = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Docs.prototype.searchDocs = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SearchDocsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/docs/search";
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
    ...
    **/
    Docs.prototype.updateDoc = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
