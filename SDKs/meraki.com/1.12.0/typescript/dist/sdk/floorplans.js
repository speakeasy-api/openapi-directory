...
exports.FloorPlans = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var FloorPlans = /** @class */ (function () {
    function FloorPlans(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Upload a floor plan
    **/
    FloorPlans.prototype.createNetworkFloorPlan = function (req, config) {
        var _a;
    ...
    **/
    FloorPlans.prototype.deleteNetworkFloorPlan = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FloorPlans.prototype.getNetworkFloorPlan = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FloorPlans.prototype.getNetworkFloorPlans = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FloorPlans.prototype.updateNetworkFloorPlan = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
