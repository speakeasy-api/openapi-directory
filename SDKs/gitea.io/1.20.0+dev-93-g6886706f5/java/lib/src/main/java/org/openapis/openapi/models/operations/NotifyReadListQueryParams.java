...
public class NotifyReadListQueryParams {
    /**
     * If true, mark all notifications on this repo. Default value is false
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=all")
    public String all;
    public NotifyReadListQueryParams withAll(String all) {
        this.all = all;
        return this;
    }
    ...
    public NotifyReadListQueryParams withLastReadAt(OffsetDateTime lastReadAt) {
    ...
    public NotifyReadListQueryParams withStatusTypes(String[] statusTypes) {
    ...
    public NotifyReadListQueryParams withToStatus(String toStatus) {
