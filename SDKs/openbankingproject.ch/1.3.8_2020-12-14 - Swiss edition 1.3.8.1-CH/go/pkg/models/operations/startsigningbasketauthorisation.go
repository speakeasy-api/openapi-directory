...
type StartSigningBasketAuthorisationRequestBodyType string

const (
	StartSigningBasketAuthorisationRequestBodyTypeAny                           StartSigningBasketAuthorisationRequestBodyType = "any"
	StartSigningBasketAuthorisationRequestBodyTypeUpdatePsuAuthentication       StartSigningBasketAuthorisationRequestBodyType = "updatePsuAuthentication"
	StartSigningBasketAuthorisationRequestBodyTypeSelectPsuAuthenticationMethod StartSigningBasketAuthorisationRequestBodyType = "selectPsuAuthenticationMethod"
	StartSigningBasketAuthorisationRequestBodyTypeTransactionAuthorisation      StartSigningBasketAuthorisationRequestBodyType = "transactionAuthorisation"
)

type StartSigningBasketAuthorisationRequestBody struct {
	Any                           interface{}
	...
	Type StartSigningBasketAuthorisationRequestBodyType
}

func CreateStartSigningBasketAuthorisationRequestBodyAny(any interface{}) StartSigningBasketAuthorisationRequestBody {
	typ := StartSigningBasketAuthorisationRequestBodyTypeAny

	return StartSigningBasketAuthorisationRequestBody{
		Any:  &any,
		Type: typ,
	}
}

func CreateStartSigningBasketAuthorisationRequestBodyUpdatePsuAuthentication(updatePsuAuthentication shared.UpdatePsuAuthentication) StartSigningBasketAuthorisationRequestBody {
	typ := StartSigningBasketAuthorisationRequestBodyTypeUpdatePsuAuthentication
...
func CreateStartSigningBasketAuthorisationRequestBodySelectPsuAuthenticationMethod(selectPsuAuthenticationMethod shared.SelectPsuAuthenticationMethod) StartSigningBasketAuthorisationRequestBody {
	typ := StartSigningBasketAuthorisationRequestBodyTypeSelectPsuAuthenticationMethod
...
func CreateStartSigningBasketAuthorisationRequestBodyTransactionAuthorisation(transactionAuthorisation shared.TransactionAuthorisation) StartSigningBasketAuthorisationRequestBody {
	typ := StartSigningBasketAuthorisationRequestBodyTypeTransactionAuthorisation
...
func (u *StartSigningBasketAuthorisationRequestBody) UnmarshalJSON(data []byte) error {
	var d *json.Decoder
	...
	if err := d.Decode(&any); err == nil {
		u.Any = any
		u.Type = StartSigningBasketAuthorisationRequestBodyTypeAny
		return nil
	}
	...
	if err := d.Decode(&updatePsuAuthentication); err == nil {
		...
		u.Type = StartSigningBasketAuthorisationRequestBodyTypeUpdatePsuAuthentication
		return nil
	}
	...
	if err := d.Decode(&selectPsuAuthenticationMethod); err == nil {
		...
		u.Type = StartSigningBasketAuthorisationRequestBodyTypeSelectPsuAuthenticationMethod
		return nil
	}
	...
	if err := d.Decode(&transactionAuthorisation); err == nil {
		...
		u.Type = StartSigningBasketAuthorisationRequestBodyTypeTransactionAuthorisation
		return nil
	}
...
func (u StartSigningBasketAuthorisationRequestBody) MarshalJSON() ([]byte, error) {
	if u.Any != nil {
...
type StartSigningBasketAuthorisationRequest struct {
	...
	RequestBody  *StartSigningBasketAuthorisationRequestBody `request:"mediaType=application/json"`
