...
class PostDescribeDbParametersQueryParams:
    action: PostDescribeDbParametersActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeDbParametersVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDbParametersRequest:
    headers: PostDescribeDbParametersHeaders = dataclasses.field()
    query_params: PostDescribeDbParametersQueryParams = dataclasses.field()
