...
class CloudBuildMembershipSpec:
    ...
    **Cloud Build**: Configurations for each Cloud Build enabled cluster.
    ...
    security_policy: Optional[CloudBuildMembershipSpecSecurityPolicyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('securityPolicy') }})
