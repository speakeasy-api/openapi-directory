...
public class FetchRecordingAddOnResultPayloadRequest {
    ...
    public FetchRecordingAddOnResultPayloadRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("AddOnResultSid") String addOnResultSid, @JsonProperty("ReferenceSid") String referenceSid, @JsonProperty("Sid") String sid) {
        this.accountSid = accountSid;
        this.addOnResultSid = addOnResultSid;
        this.referenceSid = referenceSid;
        this.sid = sid;
