...
class GetNetworkWirelessUsageHistoryRequest:
    ...
    r"""Filter results by network client to return per-device AP usage over time inner joined by the queried client's connection history."""  
    ...
    r"""Filter results by device. Requires :band."""  
...
class GetNetworkWirelessUsageHistory200ApplicationJSON:
    ...
    received_kbps: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('receivedKbps'), 'exclude': lambda f: f is None }})
    r"""Received kilobytes-per-second"""  
    sent_kbps: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sentKbps'), 'exclude': lambda f: f is None }})
    ...
    total_kbps: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('totalKbps'), 'exclude': lambda f: f is None }})
    r"""Total usage in kilobytes-per-second"""  
...
class GetNetworkWirelessUsageHistoryResponse:
    ...
    get_network_wireless_usage_history_200_application_json_objects: Optional[list[GetNetworkWirelessUsageHistory200ApplicationJSON]] = dataclasses.field(default=None)
