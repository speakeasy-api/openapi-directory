...
class CommentUserPreferencesVideosPrivacy
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CommentUserPreferencesVideosPrivacyCommentsEnum $comments
     */
	#[\JMS\Serializer\Annotation\SerializedName('comments')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CommentUserPreferencesVideosPrivacyCommentsEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CommentUserPreferencesVideosPrivacyCommentsEnum $comments = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CommentUserPreferencesVideosPrivacyEmbedEnum $embed
     */
	#[\JMS\Serializer\Annotation\SerializedName('embed')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CommentUserPreferencesVideosPrivacyEmbedEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CommentUserPreferencesVideosPrivacyEmbedEnum $embed = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CommentUserPreferencesVideosPrivacyViewEnum $view
     */
	#[\JMS\Serializer\Annotation\SerializedName('view')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\CommentUserPreferencesVideosPrivacyViewEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CommentUserPreferencesVideosPrivacyViewEnum $view = null;
