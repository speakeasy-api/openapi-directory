...
class DescribeLocalGatewayRouteTableVpcAssociationsRequest:
    ...
    filters: Optional[list[DescribeLocalGatewayRouteTableVpcAssociationsRequestFilters]] = dataclasses.field(default=None)  
    local_gateway_route_table_vpc_association_ids: Optional[list[str]] = dataclasses.field(default=None)  
