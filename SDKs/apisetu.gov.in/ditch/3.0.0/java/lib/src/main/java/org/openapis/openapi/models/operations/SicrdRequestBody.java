...
public class SicrdRequestBody {
    ...
    public SicrdRequestBody withConsentArtifact(org.openapis.openapi.models.shared.ConsentArtifactSchema consentArtifact) {
    ...
    public SicrdRequestBody(@JsonProperty("format") SicrdRequestBodyFormatEnum format, @JsonProperty("txnId") String txnId) {
        this.format = format;
        this.txnId = txnId;
  }
}
