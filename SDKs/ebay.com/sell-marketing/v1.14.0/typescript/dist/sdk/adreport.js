...
exports.AdReport = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var AdReport = /** @class */ (function () {
    function AdReport(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    AdReport.prototype.getReport = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ad_report/{report_id}", req);
