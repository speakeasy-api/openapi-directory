...
exports.AddFacetToObjectResponse = exports.AddFacetToObjectRequest = exports.AddFacetToObjectRequestBody = exports.AddFacetToObjectRequestBodySchemaFacet = exports.AddFacetToObjectRequestBodyObjectReference = void 0;
...
var AddFacetToObjectRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AttributeKeyAndValue }),
        (0, class_transformer_1.Expose)({ name: "ObjectAttributeList" }),
        (0, class_transformer_1.Type)(function () { return shared.AttributeKeyAndValue; }),
        __metadata("design:type", Array)
    ], AddFacetToObjectRequestBody.prototype, "objectAttributeList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ObjectReference" }),
        (0, class_transformer_1.Type)(function () { return AddFacetToObjectRequestBodyObjectReference; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return AddFacetToObjectRequestBodySchemaFacet; }),
...
var AddFacetToObjectRequest = /** @class */ (function (_super) {
    ...
    ], AddFacetToObjectRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-amz-data-partition",
        }),
        __metadata("design:type", String)
    ], AddFacetToObjectRequest.prototype, "xAmzDataPartition", void 0);
...
var AddFacetToObjectResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], AddFacetToObjectResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
