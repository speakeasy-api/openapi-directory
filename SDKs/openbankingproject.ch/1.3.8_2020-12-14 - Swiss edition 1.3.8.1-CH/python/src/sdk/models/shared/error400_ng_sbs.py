...
class Error400NGSBS:
    ...
    tpp_messages: Optional[list[shared_tppmessage400_sbs.TppMessage400SBS]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tppMessages'), 'exclude': lambda f: f is None }})  
