...
class DescribeEndpointSettingsRequest:
    ...
    describe_endpoint_settings_message: shared_describeendpointsettingsmessage.DescribeEndpointSettingsMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
