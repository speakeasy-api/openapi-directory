...
public class Me {
    ...
    public org.openapis.openapi.models.operations.GetMeResponse getMe() throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/v1/me");
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/hal+json")) {
                ...
                org.openapis.openapi.models.shared.MeModel out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.MeModel.class);
                res.meModel = out;
            }
