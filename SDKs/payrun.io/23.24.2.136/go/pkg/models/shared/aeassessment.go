...
func (e AEAssessmentAEAssessmentAssessmentCodeEnum) ToPointer() *AEAssessmentAEAssessmentAssessmentCodeEnum {
	return &e
}
...
func (e *AEAssessmentAEAssessmentAssessmentCodeEnum) UnmarshalJSON(data []byte) error {
	...
	case "NonEligibleJobHolder":
		fallthrough
	case "EntitledWorker":
		*e = AEAssessmentAEAssessmentAssessmentCodeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AEAssessmentAEAssessmentAssessmentCodeEnum: %v", v)
	}
}
...
func (e AEAssessmentAEAssessmentAssessmentEventEnum) ToPointer() *AEAssessmentAEAssessmentAssessmentEventEnum {
	return &e
}
...
func (e *AEAssessmentAEAssessmentAssessmentEventEnum) UnmarshalJSON(data []byte) error {
	...
	case "ContractualEnrolment":
		*e = AEAssessmentAEAssessmentAssessmentEventEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AEAssessmentAEAssessmentAssessmentEventEnum: %v", v)
	}
}
...
func (e AEAssessmentAEAssessmentAssessmentOverrideEnum) ToPointer() *AEAssessmentAEAssessmentAssessmentOverrideEnum {
	return &e
}
...
func (e *AEAssessmentAEAssessmentAssessmentOverrideEnum) UnmarshalJSON(data []byte) error {
	...
	case "Leaver":
		fallthrough
	case "Excluded":
		*e = AEAssessmentAEAssessmentAssessmentOverrideEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AEAssessmentAEAssessmentAssessmentOverrideEnum: %v", v)
	}
}
...
func (e AEAssessmentAEAssessmentAssessmentResultEnum) ToPointer() *AEAssessmentAEAssessmentAssessmentResultEnum {
	return &e
}
...
func (e *AEAssessmentAEAssessmentAssessmentResultEnum) UnmarshalJSON(data []byte) error {
	...
	case "Enrol":
		fallthrough
	case "Exit":
		*e = AEAssessmentAEAssessmentAssessmentResultEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AEAssessmentAEAssessmentAssessmentResultEnum: %v", v)
	}
}
