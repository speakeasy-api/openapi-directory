...
class DescribeTrafficMirrorFiltersRequest:
    ...
    filters: Optional[list[DescribeTrafficMirrorFiltersRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    traffic_mirror_filter_ids: Optional[list[str]] = dataclasses.field(default=None)  
