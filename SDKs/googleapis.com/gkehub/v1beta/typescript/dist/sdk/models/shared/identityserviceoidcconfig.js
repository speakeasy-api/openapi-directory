...
var IdentityServiceOidcConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "certificateAuthorityData" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "deployCloudConsoleProxy" }),
        __metadata("design:type", Boolean)
    ], IdentityServiceOidcConfig.prototype, "deployCloudConsoleProxy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "enableAccessToken" }),
        __metadata("design:type", Boolean)
    ], IdentityServiceOidcConfig.prototype, "enableAccessToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "encryptedClientSecret" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "groupPrefix" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "issuerUri" }),
        __metadata("design:type", String)
    ], IdentityServiceOidcConfig.prototype, "issuerUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kubectlRedirectUri" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userClaim" }),
        __metadata("design:type", String)
    ], IdentityServiceOidcConfig.prototype, "userClaim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userPrefix" }),
        __metadata("design:type", String)
