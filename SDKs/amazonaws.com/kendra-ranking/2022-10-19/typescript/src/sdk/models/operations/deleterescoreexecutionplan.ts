...
export enum DeleteRescoreExecutionPlanXAmzTargetEnum {
  AWSKendraRerankingFrontendServiceDeleteRescoreExecutionPlan = "AWSKendraRerankingFrontendService.DeleteRescoreExecutionPlan",
}

export class DeleteRescoreExecutionPlanRequest extends SpeakeasyBase {
...
export class DeleteRescoreExecutionPlanResponse extends SpeakeasyBase {
  /**
