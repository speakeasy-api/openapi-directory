...
class GetInternationalPaymentsInternationalPaymentIDRequest:
    headers: GetInternationalPaymentsInternationalPaymentIDHeaders = dataclasses.field()
    path_params: GetInternationalPaymentsInternationalPaymentIDPathParams = dataclasses.field()
    security: GetInternationalPaymentsInternationalPaymentIDSecurity = dataclasses.field()
