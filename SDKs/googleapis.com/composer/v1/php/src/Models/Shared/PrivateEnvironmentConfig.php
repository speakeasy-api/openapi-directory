...
class PrivateEnvironmentConfig
{
     ...
     * 
     * @var ?string $cloudComposerNetworkIpv4ReservedRange
     */
	#[\JMS\Serializer\Annotation\SerializedName('cloudComposerNetworkIpv4ReservedRange')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $cloudComposerNetworkIpv4ReservedRange = null;
     ...
     * 
     * @var ?string $webServerIpv4ReservedRange
     */
	#[\JMS\Serializer\Annotation\SerializedName('webServerIpv4ReservedRange')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $webServerIpv4ReservedRange = null;
