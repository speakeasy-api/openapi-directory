...
var VolumeseriesinfoVolumeSeriesIssue = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "issueDisplayNumber" }),
        __metadata("design:type", String)
    ], VolumeseriesinfoVolumeSeriesIssue.prototype, "issueDisplayNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "issueOrderNumber" }),
...
var VolumeseriesinfoVolumeSeries = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: VolumeseriesinfoVolumeSeriesIssue }),
        (0, class_transformer_1.Expose)({ name: "issue" }),
        (0, class_transformer_1.Type)(function () { return VolumeseriesinfoVolumeSeriesIssue; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "seriesBookType" }),
        __metadata("design:type", String)
...
var Volumeseriesinfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "bookDisplayNumber" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "shortSeriesBookTitle" }),
        __metadata("design:type", String)
    ], Volumeseriesinfo.prototype, "shortSeriesBookTitle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: VolumeseriesinfoVolumeSeries }),
        (0, class_transformer_1.Expose)({ name: "volumeSeries" }),
        (0, class_transformer_1.Type)(function () { return VolumeseriesinfoVolumeSeries; }),
        __metadata("design:type", Array)
