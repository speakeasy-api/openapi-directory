...
export class UrlMaps {
  ...
  computeUrlMapsTestIamPermissions(
    req: operations.ComputeUrlMapsTestIamPermissionsRequest,
    security: operations.ComputeUrlMapsTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeUrlMapsTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeUrlMapsTestIamPermissionsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeUrlMapsTestIamPermissionsResponse =
        new operations.ComputeUrlMapsTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
