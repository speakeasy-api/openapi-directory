...
class RegisterTaskWithMaintenanceWindowRequest:
    ...
    task_type: shared_maintenancewindowtasktype_enum.MaintenanceWindowTaskTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TaskType') }})  
