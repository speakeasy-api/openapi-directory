...
class AwsRdsDbParameterGroup:
    r"""AwsRdsDbParameterGroup
    Provides information about a parameter group for a DB instance.
    """
    
    db_parameter_group_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DbParameterGroupName') }})
