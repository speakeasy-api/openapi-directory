...
type DatafusionProjectsLocationsInstancesRestartSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatafusionProjectsLocationsInstancesRestartPathParams struct {
...
type DatafusionProjectsLocationsInstancesRestartQueryParams struct {
	// V1 error format.
...
type DatafusionProjectsLocationsInstancesRestartRequest struct {
...
type DatafusionProjectsLocationsInstancesRestartResponse struct {
	ContentType string
	// Successful response
