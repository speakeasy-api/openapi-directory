...
class DescribeInterconnectLoaRequest:
    ...
    describe_interconnect_loa_request: shared_describeinterconnectloarequest.DescribeInterconnectLoaRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
