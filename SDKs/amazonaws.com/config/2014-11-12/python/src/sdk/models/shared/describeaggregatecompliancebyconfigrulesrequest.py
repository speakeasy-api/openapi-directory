...
class DescribeAggregateComplianceByConfigRulesRequest:
    ...
    filters: Optional[shared_configrulecompliancefilters.ConfigRuleComplianceFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Filters'), 'exclude': lambda f: f is None }})  
