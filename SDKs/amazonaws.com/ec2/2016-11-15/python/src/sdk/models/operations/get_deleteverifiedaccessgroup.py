...
class GETDeleteVerifiedAccessGroupActionEnum(str, Enum):
    DELETE_VERIFIED_ACCESS_GROUP = 'DeleteVerifiedAccessGroup'

class GETDeleteVerifiedAccessGroupVersionEnum(str, Enum):
...
class GETDeleteVerifiedAccessGroupRequest:
    ...
    action: GETDeleteVerifiedAccessGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    ...
    version: GETDeleteVerifiedAccessGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
