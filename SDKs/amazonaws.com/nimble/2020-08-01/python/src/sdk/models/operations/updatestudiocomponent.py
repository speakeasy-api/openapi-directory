...
class UpdateStudioComponentRequestBody:
    configuration: Optional[UpdateStudioComponentRequestBodyConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('configuration') }})
    ...
    subtype: Optional[UpdateStudioComponentRequestBodySubtypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('subtype') }})
    type: Optional[UpdateStudioComponentRequestBodyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    

@dataclasses.dataclass
class UpdateStudioComponentRequest:
    headers: UpdateStudioComponentHeaders = dataclasses.field()
    path_params: UpdateStudioComponentPathParams = dataclasses.field()
    request: UpdateStudioComponentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
