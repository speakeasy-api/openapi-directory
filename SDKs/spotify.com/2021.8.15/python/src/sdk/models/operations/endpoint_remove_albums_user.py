...
class EndpointRemoveAlbumsUserRequest:
    headers: EndpointRemoveAlbumsUserHeaders = dataclasses.field()
    query_params: EndpointRemoveAlbumsUserQueryParams = dataclasses.field()
    security: EndpointRemoveAlbumsUserSecurity = dataclasses.field()
    request: Optional[EndpointRemoveAlbumsUserRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
