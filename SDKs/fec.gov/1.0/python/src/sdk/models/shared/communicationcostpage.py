...
class CommunicationCostPage:
    ...
    results: Optional[list[shared_communicationcost.CommunicationCost]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
