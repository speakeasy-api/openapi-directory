 ...
 */
export declare enum InterconnectAttachmentListWarningCodeEnum {
...
export declare class InterconnectAttachmentListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InterconnectAttachmentListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: InterconnectAttachmentListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: InterconnectAttachmentListWarningData[];
    /**
 ...
 */
export declare class InterconnectAttachmentList extends SpeakeasyBase {
    /**
