...
from ..shared import security as shared_security
from ..shared import creativedealids as shared_creativedealids
...
class AdexchangebuyerCreativesListDealsRequest:
    path_params: AdexchangebuyerCreativesListDealsPathParams = dataclasses.field()
    query_params: AdexchangebuyerCreativesListDealsQueryParams = dataclasses.field()
    security: AdexchangebuyerCreativesListDealsSecurity = dataclasses.field()
...
class AdexchangebuyerCreativesListDealsResponse:
    ...
    creative_deal_ids: Optional[shared_creativedealids.CreativeDealIds] = dataclasses.field(default=None)
