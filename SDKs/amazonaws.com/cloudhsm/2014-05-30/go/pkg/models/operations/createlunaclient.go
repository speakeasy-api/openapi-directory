...
func (e CreateLunaClientXAmzTargetEnum) ToPointer() *CreateLunaClientXAmzTargetEnum {
	return &e
}
...
func (e *CreateLunaClientXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CloudHsmFrontendService.CreateLunaClient":
		*e = CreateLunaClientXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLunaClientXAmzTargetEnum: %v", v)
	}
}
