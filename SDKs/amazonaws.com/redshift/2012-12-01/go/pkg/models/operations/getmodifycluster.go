...
func (e GETModifyClusterActionEnum) ToPointer() *GETModifyClusterActionEnum {
	return &e
}

func (e *GETModifyClusterActionEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "ModifyCluster":
		*e = GETModifyClusterActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETModifyClusterActionEnum: %v", v)
	}
}
...
func (e GETModifyClusterVersionEnum) ToPointer() *GETModifyClusterVersionEnum {
	return &e
}

func (e *GETModifyClusterVersionEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "2012-12-01":
		*e = GETModifyClusterVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETModifyClusterVersionEnum: %v", v)
	}
}
