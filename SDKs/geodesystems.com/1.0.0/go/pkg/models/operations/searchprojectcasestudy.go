...
type SearchProjectCasestudyQueryParams struct {
	...
	// Intended Use
	SearchProjectCasestudyIntendedUse *string `queryParam:"style=form,explode=true,name=search.project_casestudy.intended_use"`
	// Where
	SearchProjectCasestudyLocation *string `queryParam:"style=form,explode=true,name=search.project_casestudy.location"`
	// Number to skip
...
type SearchProjectCasestudyRequest struct {
	QueryParams SearchProjectCasestudyQueryParams
}

type SearchProjectCasestudyResponse struct {
	ContentType string
	StatusCode  int
