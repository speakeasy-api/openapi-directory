...
export declare class CreateInternationalPaymentConsentsJsonSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateInternationalPaymentConsentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateInternationalPaymentConsentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
