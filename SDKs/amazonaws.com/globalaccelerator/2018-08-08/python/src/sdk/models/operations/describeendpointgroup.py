...
class DescribeEndpointGroupRequest:
    ...
    describe_endpoint_group_request: shared_describeendpointgrouprequest.DescribeEndpointGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
