...
func (e RegisterCertificateWithoutCARequestBodyStatusEnum) ToPointer() *RegisterCertificateWithoutCARequestBodyStatusEnum {
	return &e
}
...
func (e *RegisterCertificateWithoutCARequestBodyStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "PENDING_ACTIVATION":
		*e = RegisterCertificateWithoutCARequestBodyStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RegisterCertificateWithoutCARequestBodyStatusEnum: %v", v)
	}
}
...
type RegisterCertificateWithoutCARequest struct {
	RequestBody       RegisterCertificateWithoutCARequestBody `request:"mediaType=application/json"`
