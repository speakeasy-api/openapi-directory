...
var Finding = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cvss_score" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=evidence" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fix" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=insertion_point" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_found" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reporter" }),
        __metadata("design:type", reporter_1.Reporter)
    ], Finding.prototype, "reporter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=requests", elemType: requests_1.Requests }),
        __metadata("design:type", Array)
    ], Finding.prototype, "requests", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=scans" }),
        __metadata("design:type", Array)
