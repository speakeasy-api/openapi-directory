...
class V3Tax:
    ...
    def all_tax_rates(self, request: operations.AllTaxRatesRequest) -> operations.AllTaxRatesResponse:
        ...
        query_params = utils.get_query_params(operations.AllTaxRatesRequest, request)
        ...
        res = operations.AllTaxRatesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[operations.AllTaxRates200ApplicationJSON]])
                res.all_tax_rates_200_application_json_objects = out
        elif http_res.status_code == 404:
            pass
        elif http_res.status_code == 500:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AllTaxRates500ApplicationJSON])
