...
var Artists = /** @class */ (function () {
    function Artists(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Artists.prototype.getV3ArtistsImages = function (req, config) {
    ...
    **/
    Artists.prototype.getV3ArtistsVideos = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
