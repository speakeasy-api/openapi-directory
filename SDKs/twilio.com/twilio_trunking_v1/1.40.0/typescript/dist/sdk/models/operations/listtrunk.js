...
exports.ListTrunkResponse = exports.ListTrunkListTrunkResponse = exports.ListTrunkListTrunkResponseMeta = exports.ListTrunkRequest = exports.ListTrunkSecurity = exports.ListTrunkServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListTrunkServerList = ["https://trunking.twilio.com"];
var ListTrunkSecurity = /** @class */ (function (_super) {
    ...
    ], ListTrunkSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListTrunkSecurity.prototype, "username", void 0);
    return ListTrunkSecurity;
}(utils_1.SpeakeasyBase));
exports.ListTrunkSecurity = ListTrunkSecurity;
var ListTrunkRequest = /** @class */ (function (_super) {
    ...
    ], ListTrunkRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListTrunkRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListTrunkRequest.prototype, "pageToken", void 0);
    return ListTrunkRequest;
}(utils_1.SpeakeasyBase));
exports.ListTrunkRequest = ListTrunkRequest;
...
exports.ListTrunkListTrunkResponseMeta = ListTrunkListTrunkResponseMeta;
/**
 * OK
 */
var ListTrunkListTrunkResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListTrunkListTrunkResponseMeta; }),
        __metadata("design:type", ListTrunkListTrunkResponseMeta)
    ], ListTrunkListTrunkResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TrunkingV1Trunk }),
        (0, class_transformer_1.Expose)({ name: "trunks" }),
        (0, class_transformer_1.Type)(function () { return shared.TrunkingV1Trunk; }),
        __metadata("design:type", Array)
    ], ListTrunkListTrunkResponse.prototype, "trunks", void 0);
    return ListTrunkListTrunkResponse;
}(utils_1.SpeakeasyBase));
exports.ListTrunkListTrunkResponse = ListTrunkListTrunkResponse;
var ListTrunkResponse = /** @class */ (function (_super) {
    ...
    ], ListTrunkResponse.prototype, "rawResponse", void 0);
    return ListTrunkResponse;
}(utils_1.SpeakeasyBase));
exports.ListTrunkResponse = ListTrunkResponse;
