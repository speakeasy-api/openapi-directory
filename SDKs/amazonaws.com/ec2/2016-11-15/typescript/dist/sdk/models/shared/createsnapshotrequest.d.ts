 ...
 */
export declare enum CreateSnapshotRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateSnapshotRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateSnapshotRequestTagSpecifications extends SpeakeasyBase {
