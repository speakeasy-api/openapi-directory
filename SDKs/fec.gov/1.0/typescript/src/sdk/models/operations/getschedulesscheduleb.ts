...
export class GetSchedulesScheduleBRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=disbursement_purpose_category",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=last_disbursement_amount",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=last_disbursement_date;dateTimeFormat=YYYY-MM-DD",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=recipient_committee_id",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=recipient_name",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=spender_committee_designation",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=spender_committee_org_type",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=spender_committee_type",
  })
