 ...
 */
public enum WebinarCreate201ApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreate201ApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
