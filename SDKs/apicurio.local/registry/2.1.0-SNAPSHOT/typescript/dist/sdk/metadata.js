...
var Metadata = /** @class */ (function () {
    ...
    **/
    Metadata.prototype.deleteArtifactVersionMetaData = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/versions/{version}/meta", req.pathParams);
    ...
    **/
    Metadata.prototype.getArtifactMetaData = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/meta", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
     ...
     *
    **/
    Metadata.prototype.getArtifactVersionMetaDataByContent = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
