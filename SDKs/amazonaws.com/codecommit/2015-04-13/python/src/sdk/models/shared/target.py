...
class Target:
    r"""Returns information about a target for a pull request."""
    
    repository_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('repositoryName') }})  
    source_reference: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceReference') }})  
