...
public class GetCaseModelAssociationsRequest {
    ...
    public GetCaseModelAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetCaseModelAssociationsRequest withEvidence(String evidence) {
    ...
    public GetCaseModelAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetCaseModelAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetCaseModelAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetCaseModelAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetCaseModelAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetCaseModelAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetCaseModelAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetCaseModelAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetCaseModelAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetCaseModelAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetCaseModelAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
