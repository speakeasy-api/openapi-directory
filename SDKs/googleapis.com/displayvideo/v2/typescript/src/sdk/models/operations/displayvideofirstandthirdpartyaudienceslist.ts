...
export class DisplayvideoFirstAndThirdPartyAudiencesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoFirstAndThirdPartyAudiencesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoFirstAndThirdPartyAudiencesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
