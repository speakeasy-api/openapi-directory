...
class AuthorizationScopedInstallation:
    ...
    repository_selection: AuthorizationScopedInstallationRepositorySelectionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('repository_selection') }})
...
class Authorization:
    ...
    app: AuthorizationApp = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('app') }})
    ...
    url: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    installation: Optional[AuthorizationScopedInstallation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('installation') }})
    user: Optional[AuthorizationSimpleUser] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('user') }})
