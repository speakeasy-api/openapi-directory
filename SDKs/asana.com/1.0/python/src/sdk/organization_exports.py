...
class OrganizationExports:
    ...
    def create_organization_export(self, request: operations.CreateOrganizationExportRequest) -> operations.CreateOrganizationExportResponse:
        ...
        res = operations.CreateOrganizationExportResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.CreateOrganizationExport201ApplicationJSON])
    ...
    def get_organization_export(self, request: operations.GetOrganizationExportRequest) -> operations.GetOrganizationExportResponse:
        ...
        url = utils.generate_url(base_url, "/organization_exports/{organization_export_gid}", request.path_params)
        ...
        res = operations.GetOrganizationExportResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetOrganizationExport200ApplicationJSON])
