...
func (e *PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsDetachFromNetworkActionResponseActionStatusEnum: %s", s)
	}
}
