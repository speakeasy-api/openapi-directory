 ...
 */
export declare enum StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class StartNetworkInsightsAccessScopeAnalysisRequestTagSpecifications extends SpeakeasyBase {
...
export declare class StartNetworkInsightsAccessScopeAnalysisRequest extends SpeakeasyBase {
    clientToken: string;
    dryRun?: boolean;
