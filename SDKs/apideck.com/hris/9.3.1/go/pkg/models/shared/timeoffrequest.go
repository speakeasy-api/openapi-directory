...
func (e TimeOffRequestRequestTypeEnum) ToPointer() *TimeOffRequestRequestTypeEnum {
	return &e
}
...
func (e *TimeOffRequestRequestTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "bereavement":
		fallthrough
	case "other":
		*e = TimeOffRequestRequestTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TimeOffRequestRequestTypeEnum: %v", v)
	}
}
...
func (e TimeOffRequestStatusEnum) ToPointer() *TimeOffRequestStatusEnum {
	return &e
}
...
func (e *TimeOffRequestStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "deleted":
		fallthrough
	case "other":
		*e = TimeOffRequestStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TimeOffRequestStatusEnum: %v", v)
	}
}
...
func (e TimeOffRequestUnitsEnum) ToPointer() *TimeOffRequestUnitsEnum {
	return &e
}
...
func (e *TimeOffRequestUnitsEnum) UnmarshalJSON(data []byte) error {
	...
	case "hours":
		fallthrough
	case "other":
		*e = TimeOffRequestUnitsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TimeOffRequestUnitsEnum: %v", v)
	}
}
