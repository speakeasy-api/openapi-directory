...
use \OpenAPI\OpenAPI\Models\Operations\FilesDetailRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FilesDetailRequest();
    $request->fileId = 'id';

    $response = $sdk->files->filesDetail($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\FilesPatchRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FilesPatchRequest();
    $request->requestBody = [
        'aut' => 'quasi',
        'error' => 'temporibus',
        'laborum' => 'quasi',
    ...
    $response = $sdk->files->filesPatch($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\FilesVersionDetailRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FilesVersionDetailRequest();
    $request->fileId = 'nihil';
    $request->versionId = 'praesentium';

    $response = $sdk->files->filesVersionDetail($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\FilesVersionsRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new FilesVersionsRequest();
    $request->fileId = 'voluptatibus';

    $response = $sdk->files->filesVersions($request);
