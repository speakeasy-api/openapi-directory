...
class NotesUpdateRequest:
    headers: NotesUpdateHeaders = dataclasses.field()
    path_params: NotesUpdatePathParams = dataclasses.field()
    query_params: NotesUpdateQueryParams = dataclasses.field()
    request: shared_note.NoteInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: NotesUpdateSecurity = dataclasses.field()
