...
class GetOrganizationConfigRuleDetailedStatusRequest:
    ...
    get_organization_config_rule_detailed_status_request: shared_getorganizationconfigruledetailedstatusrequest.GetOrganizationConfigRuleDetailedStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
