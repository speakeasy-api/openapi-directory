...
class DescribeTransitGatewayRouteTableAnnouncementsRequest:
    ...
    filters: Optional[list[DescribeTransitGatewayRouteTableAnnouncementsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    transit_gateway_route_table_announcement_ids: Optional[list[str]] = dataclasses.field(default=None)  
