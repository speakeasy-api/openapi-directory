...
public class LocationsAddRequest {
    ...
    public LocationsAddRequest(@JsonProperty("LocationInput") org.openapis.openapi.models.shared.LocationInput locationInput, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.locationInput = locationInput;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
  }
