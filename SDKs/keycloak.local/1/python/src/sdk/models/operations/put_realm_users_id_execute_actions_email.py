...
class PutRealmUsersIDExecuteActionsEmailRequest:
    ...
    r"""required actions the user needs to complete"""  
    client_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'client_id', 'style': 'form', 'explode': True }})
    r"""Client id"""  
    lifespan: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'lifespan', 'style': 'form', 'explode': True }})
    r"""Number of seconds after which the generated token expires"""  
