...
export class CloudchannelProductsSkusListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelProductsSkusListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelProductsSkusListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
