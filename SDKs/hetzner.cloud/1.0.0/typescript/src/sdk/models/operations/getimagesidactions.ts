...
export class GetImagesIdActionsActionsResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => GetImagesIdActionsActionsResponseActionError)
  ...
  @Type(() => GetImagesIdActionsActionsResponseActionResources)
...
export class GetImagesIdActionsActionsResponseMeta extends SpeakeasyBase {
  ...
  @Type(() => GetImagesIdActionsActionsResponseMetaPagination)
...
export class GetImagesIdActionsActionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: GetImagesIdActionsActionsResponseAction })
  @Expose({ name: "actions" })
  @Type(() => GetImagesIdActionsActionsResponseAction)
  actions: GetImagesIdActionsActionsResponseAction[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => GetImagesIdActionsActionsResponseMeta)
