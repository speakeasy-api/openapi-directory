...
class OrganizationConformancePackStatus:
    ...
    status: shared_organizationresourcestatus_enum.OrganizationResourceStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
