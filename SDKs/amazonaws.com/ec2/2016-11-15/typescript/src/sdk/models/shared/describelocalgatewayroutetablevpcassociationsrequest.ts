 ...
 */
export class DescribeLocalGatewayRouteTableVpcAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeLocalGatewayRouteTableVpcAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
