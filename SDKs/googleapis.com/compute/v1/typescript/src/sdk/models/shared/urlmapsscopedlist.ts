 ...
 */
export enum UrlMapsScopedListWarningCodeEnum {
...
export class UrlMapsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class UrlMapsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: UrlMapsScopedListWarningData })
  @Expose({ name: "data" })
...
export class UrlMapsScopedList extends SpeakeasyBase {
  /**
