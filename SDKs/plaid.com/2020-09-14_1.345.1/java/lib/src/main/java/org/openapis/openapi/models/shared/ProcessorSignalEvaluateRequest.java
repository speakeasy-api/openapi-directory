...
public class ProcessorSignalEvaluateRequest {
    ...
    public ProcessorSignalEvaluateRequest(@JsonProperty("amount") Double amount, @JsonProperty("client_transaction_id") String clientTransactionId, @JsonProperty("processor_token") String processorToken) {
        this.amount = amount;
        this.clientTransactionId = clientTransactionId;
        this.processorToken = processorToken;
  }
