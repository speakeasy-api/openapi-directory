...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/inspector2/2020-06-08/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/amazonaws.com/inspector2/2020-06-08/typescript
```
...
const req: AssociateMemberRequest = {
  requestBody: {
    accountId: "corrupti",
  },
...
sdk.associateMember(req).then((res: AssociateMemberResponse | AxiosError) => {
   // handle response
});
```
