...
from ..shared import describeorganizationhealthresponse as shared_describeorganizationhealthresponse
...
class DescribeOrganizationHealthRequest:
    ...
    request_body: DescribeOrganizationHealthRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DescribeOrganizationHealthResponse:
    ...
    describe_organization_health_response: Optional[shared_describeorganizationhealthresponse.DescribeOrganizationHealthResponse] = dataclasses.field(default=None)
    r"""Success"""  
