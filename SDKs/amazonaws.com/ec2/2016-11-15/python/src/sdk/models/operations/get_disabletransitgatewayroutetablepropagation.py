...
class GETDisableTransitGatewayRouteTablePropagationRequest:
    ...
    r"""The ID of the propagation route table."""  
    ...
    transit_gateway_route_table_announcement_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'TransitGatewayRouteTableAnnouncementId', 'style': 'form', 'explode': True }})
    r"""The ID of the route table announcement."""  
