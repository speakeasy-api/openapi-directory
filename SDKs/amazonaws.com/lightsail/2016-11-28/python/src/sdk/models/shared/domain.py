...
class Domain:
    ...
    domain_entries: Optional[list[shared_domainentry.DomainEntry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('domainEntries') }})
