...
public class GetShipmentByIdResponseBody {
    ...
    public GetShipmentByIdResponseBody withConfirmation(GetShipmentByIdResponseBodyDeliveryConfirmationEnum confirmation) {
    ...
    public GetShipmentByIdResponseBody withCreatedAt(OffsetDateTime createdAt) {
    ...
    public GetShipmentByIdResponseBody withInsuranceProvider(GetShipmentByIdResponseBodyInsuranceProviderEnum insuranceProvider) {
    ...
    public GetShipmentByIdResponseBody withModifiedAt(OffsetDateTime modifiedAt) {
    ...
    public GetShipmentByIdResponseBodyOriginTypeEnum originType;
    public GetShipmentByIdResponseBody withOriginType(GetShipmentByIdResponseBodyOriginTypeEnum originType) {
    ...
    public GetShipmentByIdResponseBody withReturnTo(ShippingAddress returnTo) {
    ...
    public GetShipmentByIdResponseBody withShipFrom(ShippingAddress shipFrom) {
    ...
    public GetShipmentByIdResponseBody withShipTo(ShippingAddress shipTo) {
        this.shipTo = shipTo;
        return this;
    }
    ...
    public GetShipmentByIdResponseBody withShipmentId(String shipmentId) {
    ...
    public GetShipmentByIdResponseBody withShipmentNumber(String shipmentNumber) {
    ...
    public GetShipmentByIdResponseBody withShipmentStatus(GetShipmentByIdResponseBodyShipmentStatusEnum shipmentStatus) {
    ...
    public GetShipmentByIdResponseBody withTaxIdentifiers(TaxIdentifier[] taxIdentifiers) {
    ...
    public GetShipmentByIdResponseBody withWarehouseId(String warehouseId) {
