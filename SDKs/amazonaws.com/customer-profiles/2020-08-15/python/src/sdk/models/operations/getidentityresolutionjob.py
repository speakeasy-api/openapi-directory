...
from ..shared import getidentityresolutionjobresponse as shared_getidentityresolutionjobresponse
...
class GetIdentityResolutionJobRequest:
    ...
    r"""The unique identifier of the Identity Resolution Job."""  
...
class GetIdentityResolutionJobResponse:
    ...
    get_identity_resolution_job_response: Optional[shared_getidentityresolutionjobresponse.GetIdentityResolutionJobResponse] = dataclasses.field(default=None)
    r"""Success"""  
