 ...
 */
public enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsBareMetalEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsBareMetalEnum(String value) {
        this.value = value;
    }
}
