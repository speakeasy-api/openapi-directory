...
class SDK:
    ...
    def get_describe_db_log_files(self, request: operations.GETDescribeDBLogFilesRequest) -> operations.GETDescribeDBLogFilesResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GETDescribeDBLogFilesRequest, request)
        ...
        res = operations.GETDescribeDBLogFilesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
