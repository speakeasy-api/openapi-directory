...
exports.PricingResponse = exports.PricingRequest = void 0;
...
var PricingRequest = /** @class */ (function (_super) {
    ...
    ], PricingRequest.prototype, "country", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=format",
        }),
        __metadata("design:type", String)
    ], PricingRequest.prototype, "format", void 0);
...
var PricingResponse = /** @class */ (function (_super) {
    ...
    ], PricingResponse.prototype, "rawResponse", void 0);
