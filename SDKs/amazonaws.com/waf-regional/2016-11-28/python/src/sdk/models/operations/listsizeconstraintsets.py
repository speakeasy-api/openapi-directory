...
class ListSizeConstraintSetsRequest:
    ...
    list_size_constraint_sets_request: shared_listsizeconstraintsetsrequest.ListSizeConstraintSetsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
