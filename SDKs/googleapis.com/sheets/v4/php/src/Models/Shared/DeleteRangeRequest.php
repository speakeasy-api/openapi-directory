...
class DeleteRangeRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DeleteRangeRequestShiftDimensionEnum $shiftDimension
     */
	#[\JMS\Serializer\Annotation\SerializedName('shiftDimension')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\DeleteRangeRequestShiftDimensionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?DeleteRangeRequestShiftDimensionEnum $shiftDimension = null;
    
	public function __construct()
	{
		$this->range = null;
		$this->shiftDimension = null;
	}
}
