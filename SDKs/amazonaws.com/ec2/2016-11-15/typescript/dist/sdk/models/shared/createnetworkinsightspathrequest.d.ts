...
import { PathRequestFilter } from "./pathrequestfilter";
import { ProtocolEnum } from "./protocolenum";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateNetworkInsightsPathRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateNetworkInsightsPathRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateNetworkInsightsPathRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateNetworkInsightsPathRequest extends SpeakeasyBase {
    clientToken: string;
    destination?: string;
