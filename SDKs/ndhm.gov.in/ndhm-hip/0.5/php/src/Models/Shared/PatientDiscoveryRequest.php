...
class PatientDiscoveryRequest
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PatientDiscoveryRequestPatient')]
	...
	{
		$this->patient = new \OpenAPI\OpenAPI\Models\Shared\PatientDiscoveryRequestPatient();
		$this->requestId = "";
