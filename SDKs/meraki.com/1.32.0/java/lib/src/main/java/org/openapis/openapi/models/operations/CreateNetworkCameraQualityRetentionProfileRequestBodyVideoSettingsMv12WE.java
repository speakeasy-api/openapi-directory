...
public class CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WE {
    ...
    public CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WE(@JsonProperty("quality") CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WEQualityEnum quality, @JsonProperty("resolution") CreateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WEResolutionEnum resolution) {
        this.quality = quality;
        this.resolution = resolution;
  }
}
