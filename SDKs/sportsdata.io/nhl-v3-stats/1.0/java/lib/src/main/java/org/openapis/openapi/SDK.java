...
public class SDK {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.LineCombinationsBySeasonResponse lineCombinationsBySeason(org.openapis.openapi.models.operations.LineCombinationsBySeasonRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.LineCombinationsBySeasonPathParams.class, baseUrl, "/{format}/LinesBySeason/{season}", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.LineCombinationsBySeasonResponse res = new org.openapis.openapi.models.operations.LineCombinationsBySeasonResponse() {{
            teamLines = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.TeamLine[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.TeamLine[].class);
                res.teamLines = out;
            }
        }
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PlayerDetailsByFreeAgentResponse playerDetailsByFreeAgent(org.openapis.openapi.models.operations.PlayerDetailsByFreeAgentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.PlayerDetailsByFreeAgentPathParams.class, baseUrl, "/{format}/FreeAgents", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.PlayerDetailsByFreeAgentResponse res = new org.openapis.openapi.models.operations.PlayerDetailsByFreeAgentResponse() {{
            players = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.TeamStatsAllowedByPositionResponse teamStatsAllowedByPosition(org.openapis.openapi.models.operations.TeamStatsAllowedByPositionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.TeamStatsAllowedByPositionPathParams.class, baseUrl, "/{format}/TeamStatsAllowedByPosition/{season}", request.pathParams, null);
        ...
        org.openapis.openapi.models.operations.TeamStatsAllowedByPositionResponse res = new org.openapis.openapi.models.operations.TeamStatsAllowedByPositionResponse() {{
            teamSeasons = null;
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
