 ...
 */
public class MeetingUpdateMultipartFormDataRecurrence {
    /**
    ...
    public MeetingUpdateMultipartFormDataRecurrence withEndDateTime(OffsetDateTime endDateTime) {
    ...
    public MeetingUpdateMultipartFormDataRecurrence withEndTimes(Long endTimes) {
    ...
    public MeetingUpdateMultipartFormDataRecurrence withMonthlyDay(Long monthlyDay) {
    ...
    public MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekEnum monthlyWeek;
    public MeetingUpdateMultipartFormDataRecurrence withMonthlyWeek(MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekEnum monthlyWeek) {
    ...
    public MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekDayEnum monthlyWeekDay;
    public MeetingUpdateMultipartFormDataRecurrence withMonthlyWeekDay(MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekDayEnum monthlyWeekDay) {
    ...
    public MeetingUpdateMultipartFormDataRecurrence withRepeatInterval(Long repeatInterval) {
    ...
    public MeetingUpdateMultipartFormDataRecurrence withType(MeetingUpdateMultipartFormDataRecurrenceTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public MeetingUpdateMultipartFormDataRecurrenceWeeklyDaysEnum weeklyDays;
    public MeetingUpdateMultipartFormDataRecurrence withWeeklyDays(MeetingUpdateMultipartFormDataRecurrenceWeeklyDaysEnum weeklyDays) {
