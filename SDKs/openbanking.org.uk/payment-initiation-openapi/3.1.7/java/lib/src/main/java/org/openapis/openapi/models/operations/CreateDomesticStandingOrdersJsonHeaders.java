...
public class CreateDomesticStandingOrdersJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticStandingOrdersJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticStandingOrdersJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticStandingOrdersJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticStandingOrdersJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticStandingOrdersJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticStandingOrdersJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticStandingOrdersJsonHeaders withXJwsSignature(String xJwsSignature) {
