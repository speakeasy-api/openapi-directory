...
class GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum(str, Enum):
...
class GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig:
    r"""GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig
    ...
    label_detection_mode: Optional[GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labelDetectionMode') }})
