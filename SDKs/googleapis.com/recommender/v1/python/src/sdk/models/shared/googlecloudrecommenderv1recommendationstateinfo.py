...
class GoogleCloudRecommenderV1RecommendationStateInfo:
    ...
    state: Optional[GoogleCloudRecommenderV1RecommendationStateInfoStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""The state of the recommendation, Eg ACTIVE, SUCCEEDED, FAILED."""  
