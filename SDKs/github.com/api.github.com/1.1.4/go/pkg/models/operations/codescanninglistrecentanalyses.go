...
func (e CodeScanningListRecentAnalysesSortEnum) ToPointer() *CodeScanningListRecentAnalysesSortEnum {
	return &e
}
...
func (e *CodeScanningListRecentAnalysesSortEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "created":
		*e = CodeScanningListRecentAnalysesSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CodeScanningListRecentAnalysesSortEnum: %v", v)
	}
}
