...
class CreateCallAnalyticsCategoryRequest:
    ...
    create_call_analytics_category_request: shared_createcallanalyticscategoryrequest.CreateCallAnalyticsCategoryRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
