...
type SecuritycenterOrganizationsSourcesFindingsSetStateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecuritycenterOrganizationsSourcesFindingsSetStatePathParams struct {
...
type SecuritycenterOrganizationsSourcesFindingsSetStateQueryParams struct {
	// V1 error format.
...
type SecuritycenterOrganizationsSourcesFindingsSetStateRequest struct {
...
type SecuritycenterOrganizationsSourcesFindingsSetStateResponse struct {
	ContentType string
	// Successful response
