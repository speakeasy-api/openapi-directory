 ...
 */
export class PaginatedMemberElectionResultMeta extends SpeakeasyBase {
  /**
 ...
 */
export class PaginatedMemberElectionResult extends SpeakeasyBase {
  /**
   * Metadata associated with the response data
   */
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => PaginatedMemberElectionResultMeta)
  meta: PaginatedMemberElectionResultMeta;

  /**
   * List of member election results
   */
  @SpeakeasyMetadata({ elemType: MemberElectionResult })
  @Expose({ name: "response" })
  @Type(() => MemberElectionResult)
