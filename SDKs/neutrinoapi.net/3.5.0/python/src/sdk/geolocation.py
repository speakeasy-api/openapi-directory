...
class Geolocation:
    ...
    def geocode_address(self, request: operations.GeocodeAddressRequest) -> operations.GeocodeAddressResponse:
        ...
        res = operations.GeocodeAddressResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GeocodeAddressResponse])
    ...
    def geocode_reverse(self, request: operations.GeocodeReverseRequest) -> operations.GeocodeReverseResponse:
        ...
        res = operations.GeocodeReverseResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GeocodeReverseResponse])
    ...
    def ip_info(self, request: operations.IPInfoRequest) -> operations.IPInfoResponse:
        ...
        res = operations.IPInfoResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPInfoResponse])
