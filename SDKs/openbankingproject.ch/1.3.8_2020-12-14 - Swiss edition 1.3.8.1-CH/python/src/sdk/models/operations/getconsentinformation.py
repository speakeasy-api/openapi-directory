...
class GetConsentInformationRequest:
    headers: GetConsentInformationHeaders = dataclasses.field()
    path_params: GetConsentInformationPathParams = dataclasses.field()
    security: GetConsentInformationSecurity = dataclasses.field()
