 ...
 */
export enum IntegrationConnectionTypeEnum {
  Internet = "INTERNET",
  VpcLink = "VPC_LINK",
}
 ...
 */
export enum IntegrationContentHandlingStrategyEnum {
 ...
 */
export enum IntegrationPassthroughBehaviorEnum {
 ...
 */
export class IntegrationTlsConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
