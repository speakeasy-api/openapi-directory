...
var Sense = /** @class */ (function () {
    function Sense(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Sense.prototype.getDeviceCameraSense = function (req, config) {
    ...
    **/
    Sense.prototype.getDeviceCameraSenseObjectDetectionModels = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Sense.prototype.updateDeviceCameraSense = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
