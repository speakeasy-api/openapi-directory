...
public class GetNhArtArtworkRequest {
    ...
    public GetNhArtArtworkRequest(@JsonProperty("Accept-Version") String acceptVersion, @JsonProperty("X-API-KEY") String xApiKey, @JsonProperty("artwork") String artwork) {
        this.acceptVersion = acceptVersion;
        this.xApiKey = xApiKey;
        this.artwork = artwork;
  }
