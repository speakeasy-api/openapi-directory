 ...
 */
export enum UpdateNetworkBluetoothSettingsRequestBodyMajorMinorAssignmentModeEnum {
  NonUnique = "Non-unique",
  Unique = "Unique",
}

export class UpdateNetworkBluetoothSettingsRequestBody extends SpeakeasyBase {
  /**
...
export class UpdateNetworkBluetoothSettingsRequest extends SpeakeasyBase {
 ...
 */
export class UpdateNetworkBluetoothSettings200ApplicationJSON extends SpeakeasyBase {
  /**
   * Whether APs will advertise beacons.
   */
  @SpeakeasyMetadata()
...
export class UpdateNetworkBluetoothSettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
