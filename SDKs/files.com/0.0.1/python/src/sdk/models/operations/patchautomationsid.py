...
class PatchAutomationsIDRequestBody:
    ...
    automation: Optional[PatchAutomationsIDRequestBodyAutomationEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'automation' }})
    r"""Automation type"""  
...
class PatchAutomationsIDRequest:
    ...
    r"""Automation ID."""  
    request_body: Optional[PatchAutomationsIDRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})  
