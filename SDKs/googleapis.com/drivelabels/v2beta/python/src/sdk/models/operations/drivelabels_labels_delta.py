...
class DrivelabelsLabelsDeltaRequest:
    ...
    google_apps_drive_labels_v2beta_delta_update_label_request_input: Optional[shared_googleappsdrivelabelsv2betadeltaupdatelabelrequest.GoogleAppsDriveLabelsV2betaDeltaUpdateLabelRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
