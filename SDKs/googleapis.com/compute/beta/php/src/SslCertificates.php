...
class SslCertificates 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsResponse
     */
	public function computeSslCertificatesTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/sslCertificates/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeSslCertificatesTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
