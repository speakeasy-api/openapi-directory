...
class PUTOrderLineItemRequest:
    ...
    r"""The id of the Order Line Item to update."""  
    order_line_item_common: shared_orderlineitemcommon.OrderLineItemCommon = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
