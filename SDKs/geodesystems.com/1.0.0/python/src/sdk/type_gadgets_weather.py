...
class TypeGadgetsWeather:
    ...
    def search_gadgets_weather(self, request: operations.SearchGadgetsWeatherRequest) -> operations.SearchGadgetsWeatherResponse:
        ...
        query_params = utils.get_query_params(operations.SearchGadgetsWeatherRequest, request)
        ...
        res = operations.SearchGadgetsWeatherResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
