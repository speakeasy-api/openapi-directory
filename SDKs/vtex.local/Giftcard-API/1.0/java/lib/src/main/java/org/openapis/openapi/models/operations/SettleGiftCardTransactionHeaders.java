...
public class SettleGiftCardTransactionHeaders {
    /**
    ...
    public SettleGiftCardTransactionHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public SettleGiftCardTransactionHeaders withContentType(String contentType) {
