...
exports.GetTagsFromRtiTransactionResponse = exports.GetTagsFromRtiTransactionRequest = void 0;
...
var GetTagsFromRtiTransactionRequest = /** @class */ (function (_super) {
    ...
    ], GetTagsFromRtiTransactionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagsFromRtiTransactionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromRtiTransactionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RtiTransactionId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromRtiTransactionRequest.prototype, "rtiTransactionId", void 0);
...
var GetTagsFromRtiTransactionResponse = /** @class */ (function (_super) {
    ...
    ], GetTagsFromRtiTransactionResponse.prototype, "rawResponse", void 0);
