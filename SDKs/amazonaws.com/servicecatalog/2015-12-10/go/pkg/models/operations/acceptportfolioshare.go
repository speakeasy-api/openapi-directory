...
func (e AcceptPortfolioShareXAmzTargetEnum) ToPointer() *AcceptPortfolioShareXAmzTargetEnum {
	return &e
}
...
func (e *AcceptPortfolioShareXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWS242ServiceCatalogService.AcceptPortfolioShare":
		*e = AcceptPortfolioShareXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AcceptPortfolioShareXAmzTargetEnum: %v", v)
	}
}
