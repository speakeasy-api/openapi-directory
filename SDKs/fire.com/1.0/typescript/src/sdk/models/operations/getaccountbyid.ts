 ...
 */
export enum GetAccountByIdAccountCurrencyCodeEnum {
  Eur = "EUR",
  Gbp = "GBP",
}
 ...
 * The currency.
 */
export class GetAccountByIdAccountCurrency extends SpeakeasyBase {
  /**
   * The three letter code for the currency - either `EUR` or `GBP`.
   */
  @SpeakeasyMetadata()
 ...
 */
export enum GetAccountByIdAccountStatusEnum {
  Live = "LIVE",
 ...
 */
export class GetAccountByIdAccount extends SpeakeasyBase {
  /**
  ...
  @Type(() => GetAccountByIdAccountCurrency)
