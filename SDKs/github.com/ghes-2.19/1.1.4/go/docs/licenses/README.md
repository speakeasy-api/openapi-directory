...
<https://docs.github.com/enterprise-server@2.19/rest/reference/licenses#get-a-license>
...
API method documentation
<https://docs.github.com/enterprise-server@2.19/rest/reference/licenses#get-all-commonly-used-licenses>
...
func main() {
    ...
    res, err := s.Licenses.LicensesGetAllCommonlyUsed(ctx, operations.LicensesGetAllCommonlyUsedRequest{
        ...
        Page: sdk.Int64(633931),
        PerPage: sdk.Int64(665859),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@2.19/rest/reference/licenses/#get-the-license-for-a-repository>
