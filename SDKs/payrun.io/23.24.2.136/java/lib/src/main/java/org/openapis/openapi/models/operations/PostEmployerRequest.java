...
public class PostEmployerRequest {
    ...
    public PostEmployerRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("Employer") org.openapis.openapi.models.shared.Employer employer) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employer = employer;
  }
