...
var Discovery = /** @class */ (function () {
     ...
     *
     */
    Discovery.prototype.postV05CareContextsDiscoverJson = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05CareContextsDiscoverJsonRequest(req);
        }
        var baseURL = operations.PostV05CareContextsDiscoverJsonServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
     ...
     *
     */
    Discovery.prototype.postV05CareContextsDiscoverRaw = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05CareContextsDiscoverRawRequest(req);
        }
        var baseURL = operations.PostV05CareContextsDiscoverRawServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
        var url = baseURL.replace(/\/$/, "") + "/v0.5/care-contexts/discover";
