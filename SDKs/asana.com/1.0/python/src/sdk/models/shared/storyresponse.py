...
class StoryResponseTargetResourceSubtypeEnum(str, Enum):
...
class StoryResponseTarget:
    ...
    resource_subtype: Optional[StoryResponseTargetResourceSubtypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resource_subtype'), 'exclude': lambda f: f is None }})
    r"""The subtype of this resource. Different subtypes retain many of the same fields and behavior, but may render differently in Asana or represent resources with different semantic meaning.
    The resource_subtype `milestone` represent a single moment in time. This means tasks with this subtype cannot have a start_date.
    """  
...
class StoryResponseTypeEnum(str, Enum):
    COMMENT = 'comment'
    SYSTEM = 'system'
...
class StoryResponse:
    ...
    *Note: This property only exists for comment stories.*
    ...
    resource_type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resource_type'), 'exclude': lambda f: f is None }})
    r"""The base type of this resource."""  
    source: Optional[StoryResponseSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source'), 'exclude': lambda f: f is None }})
    r"""The component of the Asana product the user used to trigger the story."""  
    sticker_name: Optional[StoryResponseStickerNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sticker_name'), 'exclude': lambda f: f is None }})
    r"""The name of the sticker in this story. `null` if there is no sticker."""  
    ...
    type: Optional[StoryResponseTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
