...
export const ListRatePlanServerList = ["https://wireless.twilio.com"] as const;
...
export class ListRatePlanListRatePlanResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListRatePlanListRatePlanResponseMeta)
  meta?: ListRatePlanListRatePlanResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.WirelessV1RatePlan })
  @Expose({ name: "rate_plans" })
  @Type(() => shared.WirelessV1RatePlan)
