...
class ApplicationInput:
    ...
    iap: Optional[shared_identityawareproxy.IdentityAwareProxyInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('iap') }})
