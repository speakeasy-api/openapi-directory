...
var BatchDescribeMergeConflictsOutput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: conflict_1.Conflict }),
        (0, class_transformer_1.Expose)({ name: "conflicts" }),
        (0, class_transformer_1.Type)(function () { return conflict_1.Conflict; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: batchdescribemergeconflictserror_1.BatchDescribeMergeConflictsError }),
        (0, class_transformer_1.Expose)({ name: "errors" }),
        (0, class_transformer_1.Type)(function () { return batchdescribemergeconflictserror_1.BatchDescribeMergeConflictsError; }),
        __metadata("design:type", Array)
