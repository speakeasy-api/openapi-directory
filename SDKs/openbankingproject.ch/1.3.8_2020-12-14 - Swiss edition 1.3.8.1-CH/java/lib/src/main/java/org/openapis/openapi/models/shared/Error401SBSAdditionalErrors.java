...
/**
 * Error401SBSAdditionalErrors - This is a data element to support the declaration of additional errors in the context of [RFC7807].
 */
public class Error401SBSAdditionalErrors {
    ...
    public Error401SBSAdditionalErrors(@JsonProperty("code") MessageCode401SBSEnum code) {
        this.code = code;
  }
}
