...
class DataflowProjectsLocationsTemplatesGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DataflowProjectsLocationsTemplatesGetViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?DataflowProjectsLocationsTemplatesGetViewEnum $view = null;
