...
class UpdateNumberOfDomainControllersRequest:
    ...
    update_number_of_domain_controllers_request: shared_updatenumberofdomaincontrollersrequest.UpdateNumberOfDomainControllersRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateNumberOfDomainControllersResponse:
    ...
    r"""DomainControllerLimitExceededException"""  
