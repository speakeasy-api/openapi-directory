...
class DfareportingCampaignsPatchRequest:
    path_params: DfareportingCampaignsPatchPathParams = dataclasses.field()
    query_params: DfareportingCampaignsPatchQueryParams = dataclasses.field()
    security: DfareportingCampaignsPatchSecurity = dataclasses.field()
