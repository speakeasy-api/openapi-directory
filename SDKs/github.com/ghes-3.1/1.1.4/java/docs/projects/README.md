...
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#add-project-collaborator>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsAddCollaboratorRequest req = new ProjectsAddCollaboratorRequest(373216L, "culpa") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#create-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#create-a-project-column>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateColumnRequest req = new ProjectsCreateColumnRequest(                new ProjectsCreateColumnRequestBody("Remaining tasks");, 80532L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#create-a-user-project>
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#create-an-organization-project>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateForOrgRequest req = new ProjectsCreateForOrgRequest(                new ProjectsCreateForOrgRequestBody("deleniti") {{
                                body = "veritatis";
                            }};, "tempora");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#create-a-repository-project>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsCreateForRepoRequest req = new ProjectsCreateForRepoRequest(                new ProjectsCreateForRepoRequestBody("dolor") {{
                                body = "consequatur";
                            }};, "architecto", "sit");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#delete-a-project>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteRequest req = new ProjectsDeleteRequest(265039L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#delete-a-project-card>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteCardRequest req = new ProjectsDeleteCardRequest(144286L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#delete-a-project-column>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsDeleteColumnRequest req = new ProjectsDeleteColumnRequest(66149L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#get-a-project>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetRequest req = new ProjectsGetRequest(513760L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#get-a-project-card>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetCardRequest req = new ProjectsGetCardRequest(65604L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#get-a-project-column>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetColumnRequest req = new ProjectsGetColumnRequest(222658L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#get-project-permission-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsGetPermissionForUserRequest req = new ProjectsGetPermissionForUserRequest(856277L, "ipsam");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#list-project-cards>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListCardsRequest req = new ProjectsListCardsRequest(162120L) {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#list-project-collaborators>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListCollaboratorsRequest req = new ProjectsListCollaboratorsRequest(773456L) {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#list-project-columns>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListColumnsRequest req = new ProjectsListColumnsRequest(153369L) {{
                page = 332191L;
                perPage = 199596L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#list-organization-projects>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForOrgRequest req = new ProjectsListForOrgRequest("expedita") {{
                page = 432984L;
                perPage = 426943L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#list-repository-projects>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForRepoRequest req = new ProjectsListForRepoRequest("magnam", "exercitationem") {{
                page = 70410L;
                perPage = 781480L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#list-user-projects>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsListForUserRequest req = new ProjectsListForUserRequest("nobis") {{
                page = 388319L;
                perPage = 927212L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#move-a-project-card>
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#move-a-project-column>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsMoveColumnRequest req = new ProjectsMoveColumnRequest(                new ProjectsMoveColumnRequestBody("last");, 350207L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#remove-project-collaborator>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsRemoveCollaboratorRequest req = new ProjectsRemoveCollaboratorRequest(895692L, "quasi");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#update-a-project>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateRequest req = new ProjectsUpdateRequest(392569L) {{
                requestBody = new ProjectsUpdateRequestBody() {{
                    body = "This project represents the sprint of the first week in January";
                    name = "Week One Sprint";
                    organizationPermission = ProjectsUpdateRequestBodyOrganizationPermissionEnum.NONE;
                    private_ = false;
                    state = "open";
                }};;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#update-a-project-card>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateCardRequest req = new ProjectsUpdateCardRequest(878373L) {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.1/rest/reference/projects#update-a-project-column>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ProjectsUpdateColumnRequest req = new ProjectsUpdateColumnRequest(                new ProjectsUpdateColumnRequestBody("Remaining tasks");, 667593L);            
