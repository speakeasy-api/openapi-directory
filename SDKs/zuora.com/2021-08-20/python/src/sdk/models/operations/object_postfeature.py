...
from ..shared import proxycreatefeature as shared_proxycreatefeature
...
class ObjectPOSTFeatureRequest:
    ...
    proxy_create_feature: shared_proxycreatefeature.ProxyCreateFeature = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
