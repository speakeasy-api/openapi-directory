...
func (e *CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum: %s", s)
	}
}
