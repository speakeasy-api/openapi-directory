...
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-blob>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateBlobRequest req = new GitCreateBlobRequest(                new GitCreateBlobRequestBody("reiciendis") {{
                                encoding = "dolorem";
                            }};, "harum", "dicta");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-commit>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateCommitRequest req = new GitCreateCommitRequest(                new GitCreateCommitRequestBody("architecto", "occaecati") {{
                                author = new GitCreateCommitRequestBodyAuthor("labore", "quidem") {{
                                    date = OffsetDateTime.parse("2021-08-28T11:18:39.050Z");
                                }};;
                                committer = new GitCreateCommitRequestBodyCommitter() {{
                                    date = OffsetDateTime.parse("2021-02-07T07:57:17.421Z");
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateRefRequest req = new GitCreateRefRequest(                new GitCreateRefRequestBody("mollitia", "veniam") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-tag-object>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateTagRequest req = new GitCreateTagRequest(                new GitCreateTagRequestBody("repudiandae", "quasi", "atque", GitCreateTagRequestBodyTypeEnum.TREE) {{
                                tagger = new GitCreateTagRequestBodyTagger("asperiores", "totam") {{
                                    date = OffsetDateTime.parse("2022-04-22T16:56:30.347Z");
                                }};;
                            }};, "maxime", "et");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#create-a-tree>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#delete-a-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitDeleteRefRequest req = new GitDeleteRefRequest("corrupti", "at", "error");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-blob>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetBlobRequest req = new GitGetBlobRequest("blanditiis", "suscipit", "repudiandae");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-commit>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetCommitRequest req = new GitGetCommitRequest("atque", "atque", "sunt");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetRefRequest req = new GitGetRefRequest("recusandae", "dolorum", "repellendus");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-tag>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTagRequest req = new GitGetTagRequest("labore", "reiciendis", "doloremque");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#get-a-tree>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitGetTreeRequest req = new GitGetTreeRequest("repudiandae", "dicta", "accusantium") {{
                recursive = "beatae";
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#list-matching-references>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitListMatchingRefsRequest req = new GitListMatchingRefsRequest("dolores", "enim", "laboriosam");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/git#update-a-reference>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitUpdateRefRequest req = new GitUpdateRefRequest(                new GitUpdateRefRequestBody("velit") {{
                                force = false;
                            }};, "a", "molestias", "magnam");            
