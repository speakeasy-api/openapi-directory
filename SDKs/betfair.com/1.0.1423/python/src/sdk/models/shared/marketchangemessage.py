...
import dataclasses
from ..shared import marketchange as shared_marketchange
from dataclasses_json import Undefined, dataclass_json
from enum import Enum
from sdk import utils
from typing import Optional

class MarketChangeMessageCtEnum(str, Enum):
    r"""Change Type - set to indicate the type of change - if null this is a delta)"""
    SUB_IMAGE = 'SUB_IMAGE'
    RESUB_DELTA = 'RESUB_DELTA'
    HEARTBEAT = 'HEARTBEAT'

class MarketChangeMessageSegmentTypeEnum(str, Enum):
...
class MarketChangeMessage:
    ...
    ct: Optional[MarketChangeMessageCtEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ct'), 'exclude': lambda f: f is None }})
    r"""Change Type - set to indicate the type of change - if null this is a delta)"""  
    ...
    r"""Token value (non-null) should be stored and passed in a MarketSubscriptionMessage to resume subscription (in case of disconnect)"""  
    mc: Optional[list[shared_marketchange.MarketChange]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mc'), 'exclude': lambda f: f is None }})
    r"""MarketChanges - the modifications to markets (will be null on a heartbeat"""  
    ...
    segment_type: Optional[MarketChangeMessageSegmentTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('segmentType'), 'exclude': lambda f: f is None }})
    r"""Segment Type - if the change is split into multiple segments, this denotes the beginning and end of a change, and segments in between. Will be null if data is not segmented"""  
