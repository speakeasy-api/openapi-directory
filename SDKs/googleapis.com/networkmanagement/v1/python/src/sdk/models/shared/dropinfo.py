...
class DropInfo:
    ...
    cause: Optional[DropInfoCauseEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cause'), 'exclude': lambda f: f is None }})
    r"""Cause that the packet is dropped."""  
    ...
    r"""URI of the resource that caused the drop."""  
