...
class Stats:
    ...
    def retrieve_current_neo_statistics(self) -> operations.RetrieveCurrentNeoStatisticsResponse:
        ...
        res = operations.RetrieveCurrentNeoStatisticsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Statistics])
                res.statistics = out
