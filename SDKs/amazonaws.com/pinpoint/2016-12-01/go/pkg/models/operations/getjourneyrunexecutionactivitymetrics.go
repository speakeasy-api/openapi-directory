...
type GetJourneyRunExecutionActivityMetricsRequest struct {
	...
	RunID string `pathParam:"style=simple,explode=false,name=run-id"`
}
...
type GetJourneyRunExecutionActivityMetricsResponse struct {
	...
	// Success
	GetJourneyRunExecutionActivityMetricsResponse *shared.GetJourneyRunExecutionActivityMetricsResponse
