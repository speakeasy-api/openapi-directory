...
var ResourceDataContainer = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "LocalDeviceResourceData" }),
        (0, class_transformer_1.Type)(function () { return localdeviceresourcedata_1.LocalDeviceResourceData; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LocalVolumeResourceData" }),
        (0, class_transformer_1.Type)(function () { return localvolumeresourcedata_1.LocalVolumeResourceData; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "S3MachineLearningModelResourceData" }),
        (0, class_transformer_1.Type)(function () { return s3machinelearningmodelresourcedata_1.S3MachineLearningModelResourceData; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SageMakerMachineLearningModelResourceData" }),
        (0, class_transformer_1.Type)(function () { return sagemakermachinelearningmodelresourcedata_1.SageMakerMachineLearningModelResourceData; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SecretsManagerSecretResourceData" }),
        (0, class_transformer_1.Type)(function () { return secretsmanagersecretresourcedata_1.SecretsManagerSecretResourceData; }),
