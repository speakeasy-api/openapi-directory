...
public class GetCommitteesQueryParams {
    ...
    public GetCommitteesQueryParams withMaxFirstF1Date(LocalDate maxFirstF1Date) {
    ...
    public GetCommitteesQueryParams withMinFirstF1Date(LocalDate minFirstF1Date) {
