...
public class HealthGetAntiVirusSecurity {
    ...
    public HealthGetAntiVirusSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public HealthGetAntiVirusSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public HealthGetAntiVirusSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
