...
export enum GETListSnapshotsInRecycleBinActionEnum {
  ListSnapshotsInRecycleBin = "ListSnapshotsInRecycleBin",
}

export enum GETListSnapshotsInRecycleBinVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETListSnapshotsInRecycleBinRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETListSnapshotsInRecycleBinResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
