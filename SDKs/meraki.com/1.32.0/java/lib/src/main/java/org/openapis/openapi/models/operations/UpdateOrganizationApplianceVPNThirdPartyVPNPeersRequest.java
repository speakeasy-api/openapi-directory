...
public class UpdateOrganizationApplianceVPNThirdPartyVPNPeersRequest {
    ...
    public UpdateOrganizationApplianceVPNThirdPartyVPNPeersRequest(@JsonProperty("RequestBody") UpdateOrganizationApplianceVPNThirdPartyVPNPeersRequestBody requestBody, @JsonProperty("organizationId") String organizationId) {
        this.requestBody = requestBody;
        this.organizationId = organizationId;
  }
}
