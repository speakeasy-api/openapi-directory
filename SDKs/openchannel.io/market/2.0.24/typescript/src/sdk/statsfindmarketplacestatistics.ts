...
export class StatsFindMarketplaceStatistics {
  ...
  getStatsSeriesPeriodFields(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetStatsSeriesPeriodFieldsResponse =
        new operations.GetStatsSeriesPeriodFieldsResponse({
  ...
  getStatsTotal(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetStatsTotalResponse =
        new operations.GetStatsTotalResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postStatsIncrementField(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostStatsIncrementFieldResponse =
        new operations.PostStatsIncrementFieldResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
