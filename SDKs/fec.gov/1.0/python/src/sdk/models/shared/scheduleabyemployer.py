...
class ScheduleAByEmployer:
    ...
    """  
    employer: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('employer') }})
    r"""Employer of contributor as reported on the committee's filing"""  
