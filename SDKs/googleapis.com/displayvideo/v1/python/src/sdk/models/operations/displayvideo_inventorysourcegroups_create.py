...
class DisplayvideoInventorySourceGroupsCreateQueryParams:
...
class DisplayvideoInventorySourceGroupsCreateRequest:
    query_params: DisplayvideoInventorySourceGroupsCreateQueryParams = dataclasses.field()
    security: DisplayvideoInventorySourceGroupsCreateSecurity = dataclasses.field()
    request: Optional[shared_inventorysourcegroup.InventorySourceGroupInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
