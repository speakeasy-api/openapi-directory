...
class PutConfigurationAggregatorRequest:
    ...
    put_configuration_aggregator_request: shared_putconfigurationaggregatorrequest.PutConfigurationAggregatorRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
