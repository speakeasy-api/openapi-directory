...
public class AccountGetSecurity {
    ...
    public AccountGetSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public AccountGetSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public AccountGetSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.project = project;
  }
}
