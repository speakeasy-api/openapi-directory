...
class IPSet:
    ...
    ip_set_descriptors: list[shared_ipsetdescriptor.IPSetDescriptor] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('IPSetDescriptors') }})
