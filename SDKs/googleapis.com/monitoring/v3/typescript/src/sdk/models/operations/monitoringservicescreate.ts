...
export class MonitoringServicesCreateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MonitoringServicesCreateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringServicesCreateSecurity extends SpeakeasyBase {
...
export class MonitoringServicesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MonitoringServicesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
