...
public class DistributionGroupsGetForOrgPathParams {
    /**
    ...
    public DistributionGroupsGetForOrgPathParams withDistributionGroupName(String distributionGroupName) {
    ...
    public DistributionGroupsGetForOrgPathParams withOrgName(String orgName) {
