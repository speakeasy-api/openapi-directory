...
export class IpGeolocationWithConfidenceAreaApiRequest extends SpeakeasyBase {
  /**
...
export class IpGeolocationWithConfidenceAreaApiResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
