...
public class DeleteEmployeeSecretRequest {
    ...
    public DeleteEmployeeSecretRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployeeId") String employeeId, @JsonProperty("EmployerId") String employerId, @JsonProperty("SecretId") String secretId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employeeId = employeeId;
        this.employerId = employerId;
