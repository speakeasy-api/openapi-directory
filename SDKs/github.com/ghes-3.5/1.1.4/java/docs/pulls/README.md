...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCheckIfMergedRequest req = new PullsCheckIfMergedRequest("recusandae", 630871L, "ut");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateRequest req = new PullsCreateRequest(                new PullsCreateRequestBody("quidem", "quis") {{
                                body = "beatae";
                                draft = false;
                                issue = 1L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReplyForReviewCommentRequest req = new PullsCreateReplyForReviewCommentRequest(                new PullsCreateReplyForReviewCommentRequestBody("cupiditate");, 147801L, "numquam", 256916L, "nesciunt");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewRequest req = new PullsCreateReviewRequest("at", 637856L, "dignissimos") {{
                requestBody = new PullsCreateReviewRequestBody() {{
                    ...
                    comments = new org.openapis.openapi.models.operations.PullsCreateReviewRequestBodyComments[]{{
                        add(new PullsCreateReviewRequestBodyComments("voluptatum", "cupiditate") {{
                            body = "corporis";
                            line = 28L;
                            path = "qui";
                            position = 708898L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("neque", "in") {{
                            body = "minima";
                            line = 28L;
                            path = "placeat";
                            position = 316542L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("corporis", "magnam") {{
                            body = "minus";
                            line = 28L;
                            path = "eum";
                            position = 266408L;
                        ...
                        add(new PullsCreateReviewRequestBodyComments("aperiam", "libero") {{
                            body = "voluptates";
                            line = 28L;
                            path = "maiores";
                            position = 731744L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsCreateReviewCommentRequest req = new PullsCreateReviewCommentRequest(                new PullsCreateReviewCommentRequestBody("totam", "occaecati", 375994L, "quo") {{
                                inReplyTo = 2L;
                                position = 242099L;
                                side = PullsCreateReviewCommentRequestBodySideEnum.RIGHT;
                                startLine = 684553L;
                                startSide = PullsCreateReviewCommentRequestBodyStartSideEnum.RIGHT;
                            }};, "est", 770873L, "delectus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeletePendingReviewRequest req = new PullsDeletePendingReviewRequest("tempore", 878601L, "odit", 997437L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDeleteReviewCommentRequest req = new PullsDeleteReviewCommentRequest(865946L, "nemo", "reprehenderit");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsDismissReviewRequest req = new PullsDismissReviewRequest(                new PullsDismissReviewRequestBody("aperiam") {{
                                event = PullsDismissReviewRequestBodyEventEnum.DISMISS;
                            }};, "odio", 325297L, "in", 496915L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetRequest req = new PullsGetRequest("excepturi", 172195L, "error");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewRequest req = new PullsGetReviewRequest("veritatis", 498180L, "voluptate", 866789L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsGetReviewCommentRequest req = new PullsGetReviewCommentRequest(932666L, "similique", "optio");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequest req = new PullsListRequest("ex", "quaerat") {{
                base = "commodi";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommentsForReviewRequest req = new PullsListCommentsForReviewRequest("modi", 59383L, "sint", 876027L) {{
                page = 194901L;
                perPage = 918547L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListCommitsRequest req = new PullsListCommitsRequest("cum", 120120L, "earum") {{
                page = 334474L;
                perPage = 659268L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListFilesRequest req = new PullsListFilesRequest("dolores", 724994L, "dicta") {{
                page = 164488L;
                perPage = 899867L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListRequestedReviewersRequest req = new PullsListRequestedReviewersRequest("nobis", 56877L, "ducimus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsRequest req = new PullsListReviewCommentsRequest("maiores", 87382L, "quasi") {{
                direction = PullsListReviewCommentsDirectionEnum.ASC;
                page = 863471L;
                perPage = 729448L;
                since = OffsetDateTime.parse("2021-11-04T21:45:16.507Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewCommentsForRepoRequest req = new PullsListReviewCommentsForRepoRequest("aliquam", "nostrum") {{
                direction = PullsListReviewCommentsForRepoDirectionEnum.DESC;
                page = 757364L;
                perPage = 574032L;
                since = OffsetDateTime.parse("2022-01-21T02:14:42.373Z");
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsListReviewsRequest req = new PullsListReviewsRequest("quas", 517326L, "molestias") {{
                page = 484966L;
                perPage = 51170L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsMergeRequest req = new PullsMergeRequest("saepe", 104078L, "quos") {{
                requestBody = new PullsMergeRequestBody() {{
                    commitMessage = "iste";
                    commitTitle = "assumenda";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsRequestReviewersRequest req = new PullsRequestReviewersRequest("quis", 333072L, "libero") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateRequest req = new PullsUpdateRequest("odit", 863477L, "amet") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateBranchRequest req = new PullsUpdateBranchRequest("tempore", 395233L, "voluptatibus") {{
                requestBody = new PullsUpdateBranchRequestBody() {{
                    expectedHeadSha = "quaerat";
                }};;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewRequest req = new PullsUpdateReviewRequest(                new PullsUpdateReviewRequestBody("blanditiis");, "distinctio", 392430L, "quis", 391933L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            PullsUpdateReviewCommentRequest req = new PullsUpdateReviewCommentRequest(                new PullsUpdateReviewCommentRequestBody("libero");, 794507L, "facere", "facilis");            
