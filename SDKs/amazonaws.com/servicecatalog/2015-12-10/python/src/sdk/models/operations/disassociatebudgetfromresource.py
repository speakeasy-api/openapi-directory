...
class DisassociateBudgetFromResourceRequest:
    ...
    disassociate_budget_from_resource_input: shared_disassociatebudgetfromresourceinput.DisassociateBudgetFromResourceInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
