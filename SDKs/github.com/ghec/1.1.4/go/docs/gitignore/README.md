...
<https://docs.github.com/enterprise-cloud@latest//rest/reference/gitignore#get-all-gitignore-templates>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/gitignore#get-a-gitignore-template>
