...
class GetOrganizationClientsSearchRequest:
    
    mac: str = dataclasses.field(metadata={'query_param': { 'field_name': 'mac', 'style': 'form', 'explode': True }})
    ...
    r"""The number of entries per page returned. Acceptable range is 3 - 5. Default is 5."""  
...
@dataclasses.dataclass
class GetOrganizationClientsSearchResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_organization_clients_search_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
