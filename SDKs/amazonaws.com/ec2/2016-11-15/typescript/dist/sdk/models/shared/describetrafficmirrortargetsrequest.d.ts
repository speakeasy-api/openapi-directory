 ...
 */
export declare class DescribeTrafficMirrorTargetsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTrafficMirrorTargetsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeTrafficMirrorTargetsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
