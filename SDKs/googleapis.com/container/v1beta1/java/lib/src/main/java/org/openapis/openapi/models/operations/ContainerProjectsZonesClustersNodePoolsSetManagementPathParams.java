...
public class ContainerProjectsZonesClustersNodePoolsSetManagementPathParams {
    /**
    ...
    public ContainerProjectsZonesClustersNodePoolsSetManagementPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersNodePoolsSetManagementPathParams withNodePoolId(String nodePoolId) {
    ...
    public ContainerProjectsZonesClustersNodePoolsSetManagementPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersNodePoolsSetManagementPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
