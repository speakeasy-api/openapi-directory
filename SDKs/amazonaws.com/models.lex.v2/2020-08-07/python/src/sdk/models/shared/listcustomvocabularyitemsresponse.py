...
class ListCustomVocabularyItemsResponse:
    ...
    custom_vocabulary_items: Optional[list[shared_customvocabularyitem.CustomVocabularyItem]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('customVocabularyItems'), 'exclude': lambda f: f is None }})  
