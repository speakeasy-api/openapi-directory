...
func (e EcommerceOrderFulfillmentStatusEnum) ToPointer() *EcommerceOrderFulfillmentStatusEnum {
	return &e
}
...
func (e *EcommerceOrderFulfillmentStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "returned":
		fallthrough
	case "unknown":
		*e = EcommerceOrderFulfillmentStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EcommerceOrderFulfillmentStatusEnum: %v", v)
	}
}
...
func (e EcommerceOrderPaymentStatusEnum) ToPointer() *EcommerceOrderPaymentStatusEnum {
	return &e
}
...
func (e *EcommerceOrderPaymentStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "voided":
		fallthrough
	case "unknown":
		*e = EcommerceOrderPaymentStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EcommerceOrderPaymentStatusEnum: %v", v)
	}
}
