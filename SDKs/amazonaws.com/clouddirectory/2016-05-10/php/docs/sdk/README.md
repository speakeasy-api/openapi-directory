...
try {
    ...
    $request->requestBody->name = 'Jaime O'Hara';
    ...
    $request->xAmzDataPartition = 'laborum';
...
try {
    ...
    $request->requestBody->linkName = 'animi';
    ...
    $request->requestBody->parentReference->selector = 'odit';
    $request->xAmzAlgorithm = 'quo';
    ...
    $request->xAmzDataPartition = 'quasi';
...
try {
    ...
    $request->requestBody->linkName = 'error';
    $request->requestBody->objectAttributeList = [
        new AttributeKeyAndValue(),
        new AttributeKeyAndValue(),
        new AttributeKeyAndValue(),
    ...
    $request->requestBody->parentReference->selector = 'laborum';
    ...
    $request->xAmzDataPartition = 'omnis';
...
try {
    ...
    $request->requestBody->name = 'Ms. Karla Aufderhar';
...
try {
    ...
    $request->requestBody->facetFilter->facetName = 'qui';
    $request->requestBody->facetFilter->schemaArn = 'neque';
    $request->requestBody->maxResults = 144847;
    ...
    $request->xAmzConsistencyLevel = ListObjectAttributesXAmzConsistencyLevelEnum::EVENTUAL;
    $request->xAmzDataPartition = 'et';
...
try {
    ...
    $request->requestBody->objectReference->selector = 'quos';
...
try {
    ...
    $request->requestBody->maxResults = 16429;
    $request->requestBody->nextToken = 'quas';
    $request->requestBody->objectReference = new ListObjectParentPathsRequestBodyObjectReference();
    $request->requestBody->objectReference->selector = 'itaque';
    ...
    $request->xAmzSignedHeaders = 'facilis';
    $request->xAmzDataPartition = 'cupiditate';
...
try {
    ...
    $request->requestBody->maxResults = 512393;
    $request->requestBody->nextToken = 'odio';
    $request->requestBody->objectReference = new ListObjectParentsRequestBodyObjectReference();
    $request->requestBody->objectReference->selector = 'occaecati';
    ...
    $request->xAmzDataPartition = 'consectetur';
...
try {
    ...
    $request->requestBody->consistencyLevel = ListOutgoingTypedLinksRequestBodyConsistencyLevelEnum::SERIALIZABLE;
    $request->requestBody->filterAttributeRanges = [
        new TypedLinkAttributeRange(),
        new TypedLinkAttributeRange(),
        new TypedLinkAttributeRange(),
    ...
    $request->requestBody->filterTypedLink->schemaArn = 'impedit';
    $request->requestBody->filterTypedLink->typedLinkName = 'aut';
    $request->requestBody->maxResults = 974259;
    $request->requestBody->nextToken = 'exercitationem';
    $request->requestBody->objectReference = new ListOutgoingTypedLinksRequestBodyObjectReference();
    $request->requestBody->objectReference->selector = 'nulla';
    ...
    $request->xAmzDataPartition = 'alias';
...
try {
    ...
    $request->requestBody->policyReference->selector = 'aspernatur';
    ...
    $request->xAmzConsistencyLevel = ListPolicyAttachmentsXAmzConsistencyLevelEnum::SERIALIZABLE;
    $request->xAmzDataPartition = 'maiores';
...
try {
    ...
    $request->requestBody->maxResults = 862192;
    $request->requestBody->nextToken = 'excepturi';
    $request->requestBody->schemaArn = 'voluptatibus';
...
try {
    ...
    $request->requestBody->name = 'Myron Haag';
    $request->requestBody->nextToken = 'inventore';
    ...
    $request->xAmzSignedHeaders = 'eum';
    $request->xAmzDataPartition = 'autem';
...
try {
    ...
    $request->requestBody->maxResults = 829603;
...
try {
    ...
    $request->requestBody->minorVersion = 'suscipit';
    $request->requestBody->name = 'Alan Lang Jr.';
    $request->requestBody->version = 'id';
...
try {
    ...
    $request->requestBody->document = 'voluptas';
    ...
    $request->xAmzDataPartition = 'sequi';
...
try {
    ...
    $request->requestBody->objectReference->selector = 'quo';
    $request->requestBody->schemaFacet = new RemoveFacetFromObjectRequestBodySchemaFacet();
    $request->requestBody->schemaFacet->facetName = 'esse';
    $request->requestBody->schemaFacet->schemaArn = 'recusandae';
    ...
    $request->xAmzDataPartition = 'accusamus';
...
try {
    ...
    $request->requestBody->resourceArn = 'aliquam';
...
try {
    ...
    $request->requestBody->resourceArn = 'porro';
...
try {
    ...
    $request->requestBody->name = 'Sue Corkery';
    $request->requestBody->objectType = UpdateFacetRequestBodyObjectTypeEnum::NODE;
...
try {
    ...
    $request->requestBody->typedLinkSpecifier->sourceObjectReference = new ObjectReference();
    $request->requestBody->typedLinkSpecifier->sourceObjectReference->selector = 'quod';
    $request->requestBody->typedLinkSpecifier->targetObjectReference = new ObjectReference();
    $request->requestBody->typedLinkSpecifier->targetObjectReference->selector = 'nam';
    $request->requestBody->typedLinkSpecifier->typedLinkFacet = new TypedLinkSchemaAndFacetName();
    $request->requestBody->typedLinkSpecifier->typedLinkFacet->schemaArn = 'vero';
    $request->requestBody->typedLinkSpecifier->typedLinkFacet->typedLinkName = 'aliquid';
    ...
    $request->xAmzDataPartition = 'minima';
...
try {
    ...
    $request->requestBody->objectReference->selector = 'eligendi';
    ...
    $request->xAmzDataPartition = 'minus';
...
try {
    ...
    $request->requestBody->name = 'Miranda Feest';
...
try {
    ...
    $request->requestBody->name = 'Miss Peter Cronin';
    ...
    $request->xAmzSignedHeaders = 'eius';
    $request->xAmzDataPartition = 'libero';
...
try {
    ...
    $request->requestBody->directoryArn = 'illum';
    $request->requestBody->dryRun = false;
    $request->requestBody->publishedSchemaArn = 'soluta';
    $request->xAmzAlgorithm = 'accusantium';
...
try {
    ...
    $request->requestBody->developmentSchemaArn = 'nisi';
    $request->requestBody->dryRun = false;
    $request->requestBody->minorVersion = 'aut';
    $request->requestBody->publishedSchemaArn = 'voluptatum';
