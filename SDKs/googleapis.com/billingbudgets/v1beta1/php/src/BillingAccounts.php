...
class BillingAccounts 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\BillingbudgetsBillingAccountsBudgetsCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/budgets', \OpenAPI\OpenAPI\Models\Operations\BillingbudgetsBillingAccountsBudgetsCreateRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudBillingBudgetsV1beta1CreateBudgetRequestInput", "json");
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->googleCloudBillingBudgetsV1beta1Budget = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleCloudBillingBudgetsV1beta1Budget', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\BillingbudgetsBillingAccountsBudgetsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\BillingbudgetsBillingAccountsBudgetsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/budgets', \OpenAPI\OpenAPI\Models\Operations\BillingbudgetsBillingAccountsBudgetsListRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleCloudBillingBudgetsV1beta1ListBudgetsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\BillingbudgetsBillingAccountsBudgetsPatchRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudBillingBudgetsV1beta1UpdateBudgetRequestInput", "json");
        $options = array_merge_recursive($options, $body);
