...
public class VideointelligenceVideosAnnotateRequest {
    ...
    public openapisdk.models.shared.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest request;
    public VideointelligenceVideosAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVideointelligenceV1beta2AnnotateVideoRequest request) {
