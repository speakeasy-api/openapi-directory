...
public class CodesOfConduct {
    ...
    **/
    public openapisdk.models.operations.CodesOfConductGetForRepoResponse codesOfConductGetForRepo(openapisdk.models.operations.CodesOfConductGetForRepoRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/repos/{owner}/{repo}/community/code_of_conduct", request.pathParams);
        ...
        openapisdk.models.operations.CodesOfConductGetForRepoResponse res = new openapisdk.models.operations.CodesOfConductGetForRepoResponse() {{
            codeOfConduct = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
