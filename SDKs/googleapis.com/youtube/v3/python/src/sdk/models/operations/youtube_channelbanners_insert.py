...
class YoutubeChannelBannersInsertRequest:
    ...
    r"""Unused, channel_id is currently derived from the security context of the requestor."""  
    ...
    request_body: Optional[bytes] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'image/png' }})  
