...
var VisionModels = /** @class */ (function () {
    function VisionModels(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VisionModels.prototype.deleteModel1 = function (req, config) {
    ...
    **/
    VisionModels.prototype.getTrainedModelLearningCurve1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    VisionModels.prototype.getTrainedModelMetrics1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    VisionModels.prototype.getTrainedModels1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
