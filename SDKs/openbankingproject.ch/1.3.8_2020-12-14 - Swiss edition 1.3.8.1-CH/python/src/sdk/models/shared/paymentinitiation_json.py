...
class PaymentInitiationJSON:
    r"""Generic Body for a payment initation via JSON.
    ...
    requested_execution_date: date = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requestedExecutionDate'), 'encoder': utils.dateisoformat(False), 'decoder': utils.datefromisoformat, 'mm_field': fields.DateTime(format='iso') }})  
    ...
    debtor_agent: Optional[shared_debtoragent7_ch.DebtorAgent7CH] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('debtorAgent'), 'exclude': lambda f: f is None }})
