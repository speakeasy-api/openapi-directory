...
class CreateFindingsFilterRequestBody
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\CreateFindingsFilterRequestBodyActionEnum $action
     */
	#[\JMS\Serializer\Annotation\SerializedName('action')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\CreateFindingsFilterRequestBodyActionEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\CreateFindingsFilterRequestBodyFindingCriteria $findingCriteria
     */
	#[\JMS\Serializer\Annotation\SerializedName('findingCriteria')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\CreateFindingsFilterRequestBodyFindingCriteria')]
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\CreateFindingsFilterRequestBodyActionEnum::ARCHIVE;
		$this->clientToken = null;
		$this->description = null;
		$this->findingCriteria = new \OpenAPI\OpenAPI\Models\Operations\CreateFindingsFilterRequestBodyFindingCriteria();
		$this->name = "";
		$this->position = null;
		$this->tags = null;
	}
