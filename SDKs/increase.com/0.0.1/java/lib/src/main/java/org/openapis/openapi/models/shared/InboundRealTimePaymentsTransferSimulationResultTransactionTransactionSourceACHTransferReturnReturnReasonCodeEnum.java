 ...
 */
public enum InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum {
    ...
    private InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum(String value) {
        this.value = value;
    }
}
