...
@dataclasses.dataclass
class GetPost200ApplicationJSONActionsSummary:
...
class GetPost200ApplicationJSON:
    ...
    actions_summary: Optional[list[GetPost200ApplicationJSONActionsSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('actions_summary'), 'exclude': lambda f: f is None }})  
...
class GetPostResponse:
    ...
    get_post_200_application_json_object: Optional[GetPost200ApplicationJSON] = dataclasses.field(default=None)
    r"""latest posts"""  
