...
class ListMigrationJobsResponse:
    ...
    migration_jobs: Optional[list[shared_migrationjob.MigrationJob]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('migrationJobs'), 'exclude': lambda f: f is None }})
    r"""The list of migration jobs objects."""  
