...
class CreateSnapshotRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateSnapshotRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateSnapshotRequestTagSpecifications:
    ...
    resource_type: Optional[CreateSnapshotRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateSnapshotRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateSnapshotRequest:
    ...
    tag_specifications: Optional[list[CreateSnapshotRequestTagSpecifications]] = dataclasses.field(default=None)  
