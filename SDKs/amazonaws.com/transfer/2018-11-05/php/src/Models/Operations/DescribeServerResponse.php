...
class DescribeServerResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribeServerResponse $describeServerResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribeServerResponse $describeServerResponse = null;
	...
	{
		$this->contentType = "";
		$this->describeServerResponse = null;
