...
func (e *GETDescribeClusterParameterGroupsActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeClusterParameterGroups":
		*e = GETDescribeClusterParameterGroupsActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeClusterParameterGroupsActionEnum: %s", s)
	}
}
...
func (e *GETDescribeClusterParameterGroupsVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2012-12-01":
		*e = GETDescribeClusterParameterGroupsVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeClusterParameterGroupsVersionEnum: %s", s)
	}
}
