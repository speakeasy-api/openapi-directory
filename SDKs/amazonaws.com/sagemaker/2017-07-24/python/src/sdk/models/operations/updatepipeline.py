...
from ..shared import updatepipelinerequest as shared_updatepipelinerequest
...
class UpdatePipelineRequest:
    ...
    update_pipeline_request: shared_updatepipelinerequest.UpdatePipelineRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
