...
class GETRegisterTransitGatewayMulticastGroupSourcesRequest:
    ...
    action: GETRegisterTransitGatewayMulticastGroupSourcesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    ...
    r"""The group sources' network interface IDs to register with the transit gateway multicast group."""  
    ...
    version: GETRegisterTransitGatewayMulticastGroupSourcesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
