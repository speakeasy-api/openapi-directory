...
export class GetNetworkWirelessDataRateHistory200ApplicationJSON extends SpeakeasyBase {
  /**
   * Average data rate in kilobytes-per-second
   */
  @SpeakeasyMetadata()
  @Expose({ name: "averageKbps" })
  averageKbps?: number;
