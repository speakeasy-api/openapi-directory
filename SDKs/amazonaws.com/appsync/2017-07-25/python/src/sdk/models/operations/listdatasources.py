...
class ListDataSourcesRequest:
    headers: ListDataSourcesHeaders = dataclasses.field()
    path_params: ListDataSourcesPathParams = dataclasses.field()
    query_params: ListDataSourcesQueryParams = dataclasses.field()
