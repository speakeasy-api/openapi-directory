...
class FeaturedCollectionDataList:
    r"""List of featured collections"""
    
    data: Optional[list[shared_featuredcollection.FeaturedCollection]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""Featured collections"""  
