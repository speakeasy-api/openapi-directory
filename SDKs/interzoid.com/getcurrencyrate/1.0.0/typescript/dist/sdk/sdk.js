...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.currencyRates = new currencyrates_1.CurrencyRates(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
