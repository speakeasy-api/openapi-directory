...
class Document:
    ...
    def cancel_document(self, request: operations.CancelDocumentRequest) -> operations.CancelDocumentResponse:
        ...
        url = utils.generate_url(base_url, "/documents/{id}/cancel", request.path_params)
        ...
        res = operations.CancelDocumentResponse(status_code=r.status_code, content_type=content_type)
    ...
    def create_document_from_proforma(self, request: operations.CreateDocumentFromProformaRequest) -> operations.CreateDocumentFromProformaResponse:
        ...
        url = utils.generate_url(base_url, "/documents/{id}/create-from-proforma", request.path_params)
        ...
        res = operations.CreateDocumentFromProformaResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_payment(self, request: operations.DeletePaymentRequest) -> operations.DeletePaymentResponse:
        ...
        url = utils.generate_url(base_url, "/documents/{id}/payments", request.path_params)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.PaymentHistory]])
    ...
    def download_document(self, request: operations.DownloadDocumentRequest) -> operations.DownloadDocumentResponse:
        ...
        url = utils.generate_url(base_url, "/documents/{id}/download", request.path_params)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/pdf"):
                res.download_document_200_application_pdf_binary_string = r.content
    ...
    def get_document(self, request: operations.GetDocumentRequest) -> operations.GetDocumentResponse:
        ...
        url = utils.generate_url(base_url, "/documents/{id}", request.path_params)
    ...
    def get_online_szamla_status(self, request: operations.GetOnlineSzamlaStatusRequest) -> operations.GetOnlineSzamlaStatusResponse:
        r"""Retrieve a document Online Számla status
        Retrieves the details of an existing document status.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/documents/{id}/online-szamla", request.path_params)
        ...
        res = operations.GetOnlineSzamlaStatusResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.OnlineSzamlaStatus])
    ...
    def get_public_url(self, request: operations.GetPublicURLRequest) -> operations.GetPublicURLResponse:
        ...
        url = utils.generate_url(base_url, "/documents/{id}/public-url", request.path_params)
        ...
        res = operations.GetPublicURLResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DocumentPublicURL])
    ...
    def send_document(self, request: operations.SendDocumentRequest) -> operations.SendDocumentResponse:
        ...
        url = utils.generate_url(base_url, "/documents/{id}/send", request.path_params)
        ...
        res = operations.SendDocumentResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SendDocument])
