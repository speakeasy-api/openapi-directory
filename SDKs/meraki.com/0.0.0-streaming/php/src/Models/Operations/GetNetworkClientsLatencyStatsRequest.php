...
class GetNetworkClientsLatencyStatsRequest
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkClientsLatencyStatsBandEnum $band
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=band')]
    public ?GetNetworkClientsLatencyStatsBandEnum $band = null;
