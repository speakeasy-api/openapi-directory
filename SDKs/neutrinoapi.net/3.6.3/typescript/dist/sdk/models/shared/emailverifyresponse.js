...
var EmailVerifyResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is-catch-all" }),
        __metadata("design:type", Boolean)
    ], EmailVerifyResponse.prototype, "isCatchAll", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is-deferred" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "smtp-response" }),
        __metadata("design:type", String)
    ], EmailVerifyResponse.prototype, "smtpResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "smtp-status" }),
        __metadata("design:type", String)
