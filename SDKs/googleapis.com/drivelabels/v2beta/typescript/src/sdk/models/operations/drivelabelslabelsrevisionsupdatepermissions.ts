...
export class DrivelabelsLabelsRevisionsUpdatePermissionsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DrivelabelsLabelsRevisionsUpdatePermissionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
