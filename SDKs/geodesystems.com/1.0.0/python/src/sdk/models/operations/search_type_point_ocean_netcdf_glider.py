...
class SearchTypePointOceanNetcdfGliderQueryParams:
    ...
    search_type_point_ocean_netcdf_track_platform: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_ocean_netcdf_track.platform', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchTypePointOceanNetcdfGliderRequest:
    query_params: SearchTypePointOceanNetcdfGliderQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointOceanNetcdfGliderResponse:
