...
class DestroyKubernetesAssociatedResourcesDangerousRequest:
    path_params: DestroyKubernetesAssociatedResourcesDangerousPathParams = dataclasses.field()
...
class DestroyKubernetesAssociatedResourcesDangerousResponse:
    ...
    destroy_kubernetes_associated_resources_dangerous_401_application_json_object: Optional[DestroyKubernetesAssociatedResourcesDangerous401ApplicationJSON] = dataclasses.field(default=None)
