...
public class Locations {
    ...
    public org.openapis.openapi.models.operations.ListLocationsResponse listLocations(org.openapis.openapi.models.operations.ListLocationsRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ListLocationsRequest.class, baseUrl, "/companies/{companyId}/connections/{connectionId}/data/commerce-locations", request, null);
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.LocationsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.LocationsResponse.class);
