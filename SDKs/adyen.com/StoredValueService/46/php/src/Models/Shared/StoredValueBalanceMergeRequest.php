...
class StoredValueBalanceMergeRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\StoredValueBalanceMergeRequestShopperInteractionEnum $shopperInteraction
     */
	#[\JMS\Serializer\Annotation\SerializedName('shopperInteraction')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\StoredValueBalanceMergeRequestShopperInteractionEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?StoredValueBalanceMergeRequestShopperInteractionEnum $shopperInteraction = null;
     ...
     * 
     * @var array<string, string> $sourcePaymentMethod
     */
	#[\JMS\Serializer\Annotation\SerializedName('sourcePaymentMethod')]
    #[\JMS\Serializer\Annotation\Type('array<string, string>')]
    public array $sourcePaymentMethod;
