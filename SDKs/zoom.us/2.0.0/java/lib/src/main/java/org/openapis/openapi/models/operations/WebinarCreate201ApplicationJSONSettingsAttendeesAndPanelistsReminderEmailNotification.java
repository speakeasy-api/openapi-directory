...
public class WebinarCreate201ApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotification {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public WebinarCreate201ApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum type;
    public WebinarCreate201ApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotification withType(WebinarCreate201ApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum type) {
        this.type = type;
        return this;
    }
