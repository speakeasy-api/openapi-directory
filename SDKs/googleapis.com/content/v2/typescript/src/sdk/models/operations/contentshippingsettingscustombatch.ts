...
export class ContentShippingsettingsCustombatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentShippingsettingsCustombatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentShippingsettingsCustombatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
