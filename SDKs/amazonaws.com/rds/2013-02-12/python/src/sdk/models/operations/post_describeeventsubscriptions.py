...
class PostDescribeEventSubscriptionsQueryParams:
    action: PostDescribeEventSubscriptionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeEventSubscriptionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeEventSubscriptionsRequest:
    headers: PostDescribeEventSubscriptionsHeaders = dataclasses.field()
    query_params: PostDescribeEventSubscriptionsQueryParams = dataclasses.field()
