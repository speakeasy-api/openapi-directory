...
public class FindWebhooksQueryParams {
    /**
     * A callback URL
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=callback")
    public String callback;
    public FindWebhooksQueryParams withCallback(String callback) {
    ...
    public FindWebhooksQueryParams withEnabled(Boolean enabled) {
    ...
    public String event;
    public FindWebhooksQueryParams withEvent(String event) {
        this.event = event;
        return this;
    }
    ...
    public FindWebhooksQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public FindWebhooksQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public String name;
    public FindWebhooksQueryParams withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public FindWebhooksQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public FindWebhooksQueryParams withResource(String resource) {
