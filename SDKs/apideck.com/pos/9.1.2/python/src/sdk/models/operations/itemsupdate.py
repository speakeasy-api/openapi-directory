...
from ..shared import updateitemresponse as shared_updateitemresponse
...
class ItemsUpdateRequest:
    ...
    item_input: shared_item.ItemInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ItemsUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_item_response: Optional[shared_updateitemresponse.UpdateItemResponse] = dataclasses.field(default=None)
    r"""Items"""  
