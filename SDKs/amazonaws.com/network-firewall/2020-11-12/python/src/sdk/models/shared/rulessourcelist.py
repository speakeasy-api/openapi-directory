...
class RulesSourceList:
    ...
    generated_rules_type: shared_generatedrulestype_enum.GeneratedRulesTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('GeneratedRulesType') }})
    target_types: list[shared_targettype_enum.TargetTypeEnum] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TargetTypes') }})
