...
public class UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRules {
    ...
    public UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRules(@JsonProperty("allowedIps") String[] allowedIps, @JsonProperty("lanIp") String lanIp, @JsonProperty("localPort") String localPort, @JsonProperty("protocol") UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesProtocolEnum protocol, @JsonProperty("publicPort") String publicPort) {
        this.allowedIps = allowedIps;
        this.lanIp = lanIp;
        this.localPort = localPort;
        this.protocol = protocol;
