...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/edistrictandaman/3.0.0/python
```
...
req = operations.BrlcsRequestBody(
    certificate_parameters=operations.BrlcsRequestBodyCertificateParameters(
        certificate_number="20190101IN00098",
    ),
...
res = s.ap_is.brlcs(req, operations.BrlcsSecurity(
