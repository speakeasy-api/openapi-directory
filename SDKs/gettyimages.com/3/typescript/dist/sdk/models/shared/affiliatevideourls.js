...
exports.AffiliateVideoUrls = void 0;
...
var AffiliateVideoUrls = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=large_motion" }),
        __metadata("design:type", String)
    ], AffiliateVideoUrls.prototype, "largeMotion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=large_still" }),
        __metadata("design:type", String)
    ], AffiliateVideoUrls.prototype, "largeStill", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=medium_still" }),
        __metadata("design:type", String)
    ], AffiliateVideoUrls.prototype, "mediumStill", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=small_motion" }),
        __metadata("design:type", String)
    ], AffiliateVideoUrls.prototype, "smallMotion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=small_still" }),
        __metadata("design:type", String)
    ], AffiliateVideoUrls.prototype, "smallStill", void 0);
    return AffiliateVideoUrls;
}(utils_1.SpeakeasyBase));
exports.AffiliateVideoUrls = AffiliateVideoUrls;
