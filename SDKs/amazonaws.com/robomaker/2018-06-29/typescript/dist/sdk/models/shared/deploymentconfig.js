...
var DeploymentConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "concurrentDeploymentPercentage" }),
        __metadata("design:type", Number)
    ], DeploymentConfig.prototype, "concurrentDeploymentPercentage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "downloadConditionFile" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "failureThresholdPercentage" }),
        __metadata("design:type", Number)
    ], DeploymentConfig.prototype, "failureThresholdPercentage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "robotDeploymentTimeoutInSeconds" }),
        __metadata("design:type", Number)
