...
exports.PoolDisableAutoScaleResponse = exports.PoolDisableAutoScaleRequest = void 0;
...
var PoolDisableAutoScaleRequest = /** @class */ (function (_super) {
    ...
    ], PoolDisableAutoScaleRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], PoolDisableAutoScaleRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], PoolDisableAutoScaleRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=poolId",
        }),
        __metadata("design:type", String)
    ], PoolDisableAutoScaleRequest.prototype, "poolId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], PoolDisableAutoScaleRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], PoolDisableAutoScaleRequest.prototype, "timeout", void 0);
...
var PoolDisableAutoScaleResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PoolDisableAutoScaleResponse.prototype, "rawResponse", void 0);
