...
var ChannelSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultTab" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "featuredChannelsTitle" }),
        __metadata("design:type", String)
    ], ChannelSettings.prototype, "featuredChannelsTitle", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "featuredChannelsUrls" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "moderateComments" }),
        __metadata("design:type", Boolean)
    ], ChannelSettings.prototype, "moderateComments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "profileColor" }),
        __metadata("design:type", String)
    ], ChannelSettings.prototype, "profileColor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "showBrowseView" }),
        __metadata("design:type", Boolean)
    ], ChannelSettings.prototype, "showBrowseView", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "showRelatedChannels" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "trackingAnalyticsAccountId" }),
        __metadata("design:type", String)
    ], ChannelSettings.prototype, "trackingAnalyticsAccountId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unsubscribedTrailer" }),
        __metadata("design:type", String)
