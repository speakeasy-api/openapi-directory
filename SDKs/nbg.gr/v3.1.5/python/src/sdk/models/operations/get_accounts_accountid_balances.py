...
from ..shared import obreadbalance1 as shared_obreadbalance1
...
class GetAccountsAccountIDBalancesRequest:
    headers: GetAccountsAccountIDBalancesHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDBalancesPathParams = dataclasses.field()
    security: GetAccountsAccountIDBalancesSecurity = dataclasses.field()
...
class GetAccountsAccountIDBalancesResponse:
    ...
    ob_read_balance1: Optional[shared_obreadbalance1.ObReadBalance1] = dataclasses.field(default=None)
