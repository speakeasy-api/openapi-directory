...
var AttendancePeriodsResponseDataAttributes = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is_holiday" }),
        __metadata("design:type", Boolean)
    ], AttendancePeriodsResponseDataAttributes.prototype, "isHoliday", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is_on_time_off" }),
        __metadata("design:type", Boolean)
...
var AttendancePeriodsResponseData = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: AttendancePeriodsResponseDataAttributes }),
        (0, class_transformer_1.Expose)({ name: "attributes" }),
        (0, class_transformer_1.Type)(function () { return AttendancePeriodsResponseDataAttributes; }),
...
var AttendancePeriodsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: AttendancePeriodsResponseData }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return AttendancePeriodsResponseData; }),
        __metadata("design:type", Array)
