 ...
 */
export declare enum OBWriteInternationalScheduledConsentResponse6DataAuthorisationAuthorisationTypeEnum {
    Any = "Any",
    Single = "Single"
}
/**
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataAuthorisation extends SpeakeasyBase {
    /**
     * Type of authorisation flow requested.
     */
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataCharges extends SpeakeasyBase {
    /**
 ...
 */
export declare enum OBWriteInternationalScheduledConsentResponse6DataExchangeRateInformationRateTypeEnum {
    Actual = "Actual",
    Agreed = "Agreed",
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataExchangeRateInformation extends SpeakeasyBase {
    /**
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiationCreditor extends SpeakeasyBase {
    /**
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAccount extends SpeakeasyBase {
    /**
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiationCreditorAgent extends SpeakeasyBase {
    /**
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiationDebtorAccount extends SpeakeasyBase {
    /**
     * Identification assigned by an institution to identify an account. This identification is known by the account owner.
     */
    identification: string;
 ...
 * Specifies the type used to complete the currency exchange.
 */
export declare enum OBWriteInternationalScheduledConsentResponse6DataInitiationExchangeRateInformationRateTypeEnum {
    Actual = "Actual",
    Agreed = "Agreed",
    Indicative = "Indicative"
}
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiationExchangeRateInformation extends SpeakeasyBase {
    /**
     * Unique and unambiguous reference to the foreign exchange contract agreed between the initiating party/creditor and the debtor agent.
     */
    contractIdentification?: string;
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiationInstructedAmount extends SpeakeasyBase {
    /**
 ...
 */
export declare enum OBWriteInternationalScheduledConsentResponse6DataInitiationInstructionPriorityEnum {
    Normal = "Normal",
    Urgent = "Urgent"
}
/**
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiationRemittanceInformation extends SpeakeasyBase {
    /**
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6DataInitiation extends SpeakeasyBase {
    /**
     * Specifies which party/parties will bear the charges associated with the processing of the payment transaction.
     */
    chargeBearer?: OBChargeBearerType1CodeEnum;
 ...
 */
export declare enum OBWriteInternationalScheduledConsentResponse6DataPermissionEnum {
    Create = "Create"
}
/**
 * Specifies to share the refund account details with PISP
 */
export declare enum OBWriteInternationalScheduledConsentResponse6DataReadRefundAccountEnum {
    No = "No",
    Yes = "Yes"
}
/**
 ...
 */
export declare enum OBWriteInternationalScheduledConsentResponse6DataStatusEnum {
    Authorised = "Authorised",
    AwaitingAuthorisation = "AwaitingAuthorisation",
    Consumed = "Consumed",
    Rejected = "Rejected"
}
export declare class OBWriteInternationalScheduledConsentResponse6Data extends SpeakeasyBase {
    /**
     * The authorisation type request from the TPP.
     */
 ...
 */
export declare class OBWriteInternationalScheduledConsentResponse6 extends SpeakeasyBase {
