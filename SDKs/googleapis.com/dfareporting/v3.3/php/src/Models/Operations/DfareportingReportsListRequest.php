...
class DfareportingReportsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingReportsListScopeEnum $scope
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=scope')]
    public ?DfareportingReportsListScopeEnum $scope = null;
    
    /**
     * The field by which to sort the list.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingReportsListSortFieldEnum $sortField
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortField')]
    public ?DfareportingReportsListSortFieldEnum $sortField = null;
    
    /**
     * Order of sorted results.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingReportsListSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?DfareportingReportsListSortOrderEnum $sortOrder = null;
