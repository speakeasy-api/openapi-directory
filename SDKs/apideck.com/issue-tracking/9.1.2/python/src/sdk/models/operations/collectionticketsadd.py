...
from ..shared import createticketresponse as shared_createticketresponse
...
@dataclasses.dataclass
class CollectionTicketsAddRequest:
...
class CollectionTicketsAddResponse:
    ...
    r"""Bad Request"""  
    create_ticket_response: Optional[shared_createticketresponse.CreateTicketResponse] = dataclasses.field(default=None)
    r"""Create a Ticket"""  
