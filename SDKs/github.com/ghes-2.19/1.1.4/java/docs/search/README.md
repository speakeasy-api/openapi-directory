...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("reprehenderit") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("est") {{
                order = OrderEnum.ASC;
                page = 753890L;
                perPage = 853606L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("officiis") {{
                order = OrderEnum.DESC;
                page = 220104L;
                perPage = 118041L;
                sort = SearchIssuesAndPullRequestsSortEnum.REACTIONS_HEART;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("porro", 111496L) {{
                order = OrderEnum.DESC;
                page = 458970L;
                perPage = 854115L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("aspernatur") {{
                order = OrderEnum.DESC;
                page = 965090L;
                perPage = 482584L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("libero") {{
                page = 72350L;
                perPage = 69182L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("incidunt") {{
                order = OrderEnum.ASC;
                page = 902581L;
                perPage = 734814L;
