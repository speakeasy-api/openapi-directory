...
export class DisplayvideoGuaranteedOrdersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoGuaranteedOrdersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoGuaranteedOrdersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
