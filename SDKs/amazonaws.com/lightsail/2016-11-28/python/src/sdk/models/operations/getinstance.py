...
from ..shared import getinstanceresult as shared_getinstanceresult

class GetInstanceXAmzTargetEnum(str, Enum):
    LIGHTSAIL_20161128_GET_INSTANCE = "Lightsail_20161128.GetInstance"
...
class GetInstanceResponse:
    ...
    get_instance_result: Optional[shared_getinstanceresult.GetInstanceResult] = dataclasses.field(default=None)
