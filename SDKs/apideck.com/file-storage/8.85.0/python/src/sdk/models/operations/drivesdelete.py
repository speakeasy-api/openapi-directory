...
from ..shared import deletedriveresponse as shared_deletedriveresponse
...
@dataclasses.dataclass
class DrivesDeleteSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class DrivesDeleteRequest:
    headers: DrivesDeleteHeaders = dataclasses.field()
    path_params: DrivesDeletePathParams = dataclasses.field()
    query_params: DrivesDeleteQueryParams = dataclasses.field()
    security: DrivesDeleteSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DrivesDeleteResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    delete_drive_response: Optional[shared_deletedriveresponse.DeleteDriveResponse] = dataclasses.field(default=None)
