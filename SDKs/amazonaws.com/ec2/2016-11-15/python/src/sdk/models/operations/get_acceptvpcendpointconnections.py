...
class GETAcceptVpcEndpointConnectionsRequest:
    ...
    action: GETAcceptVpcEndpointConnectionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    service_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ServiceId', 'style': 'form', 'explode': True }})
    r"""The ID of the VPC endpoint service."""  
    version: GETAcceptVpcEndpointConnectionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
    vpc_endpoint_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'VpcEndpointId', 'style': 'form', 'explode': True }})
    r"""The IDs of the interface VPC endpoints."""  
