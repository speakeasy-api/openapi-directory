...
exports.GetDpsMessageReportOutputResponse = exports.GetDpsMessageReportOutputRequest = void 0;
...
var GetDpsMessageReportOutputRequest = /** @class */ (function (_super) {
    ...
    ], GetDpsMessageReportOutputRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetDpsMessageReportOutputRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployerKey",
        }),
        __metadata("design:type", String)
    ], GetDpsMessageReportOutputRequest.prototype, "employerKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FromDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetDpsMessageReportOutputRequest.prototype, "fromDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MaxIndex",
        }),
        __metadata("design:type", String)
    ], GetDpsMessageReportOutputRequest.prototype, "maxIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MessageStatuses",
        }),
        __metadata("design:type", String)
    ], GetDpsMessageReportOutputRequest.prototype, "messageStatuses", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MessageTypes",
        }),
        __metadata("design:type", String)
    ], GetDpsMessageReportOutputRequest.prototype, "messageTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartIndex",
        }),
        __metadata("design:type", String)
    ], GetDpsMessageReportOutputRequest.prototype, "startIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ToDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetDpsMessageReportOutputRequest.prototype, "toDate", void 0);
    return GetDpsMessageReportOutputRequest;
}(utils_1.SpeakeasyBase));
exports.GetDpsMessageReportOutputRequest = GetDpsMessageReportOutputRequest;
var GetDpsMessageReportOutputResponse = /** @class */ (function (_super) {
    ...
    ], GetDpsMessageReportOutputResponse.prototype, "rawResponse", void 0);
    return GetDpsMessageReportOutputResponse;
}(utils_1.SpeakeasyBase));
exports.GetDpsMessageReportOutputResponse = GetDpsMessageReportOutputResponse;
