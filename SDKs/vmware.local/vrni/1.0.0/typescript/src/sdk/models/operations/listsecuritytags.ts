...
export class ListSecurityTagsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ListSecurityTagsRequest extends SpeakeasyBase {
  /**
...
export class ListSecurityTagsResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
