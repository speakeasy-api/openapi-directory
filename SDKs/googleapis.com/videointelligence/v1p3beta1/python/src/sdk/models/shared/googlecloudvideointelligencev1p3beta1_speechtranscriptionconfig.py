...
from ..shared import googlecloudvideointelligencev1p3beta1_speechcontext as shared_googlecloudvideointelligencev1p3beta1_speechcontext


@dataclass_json
@dataclasses.dataclass
class GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig:
    r"""GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig
    ...
    speech_contexts: Optional[list[shared_googlecloudvideointelligencev1p3beta1_speechcontext.GoogleCloudVideointelligenceV1p3beta1SpeechContext]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
