...
class WebBackendConnectionUpdate:
    ...
    r"""Name that will be set to the connection"""  
    ...
    operations: Optional[list[shared_webbackendoperationcreateorupdate.WebBackendOperationCreateOrUpdate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('operations'), 'exclude': lambda f: f is None }})  
    ...
    skip_reset: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('skipReset'), 'exclude': lambda f: f is None }})  
