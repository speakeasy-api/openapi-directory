...
func (e ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum) ToPointer() *ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum {
	return &e
}

func (e *ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum: %v", v)
	}
}
