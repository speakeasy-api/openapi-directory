...
class GetListInstanceProfileTagsQueryParams:
    action: GetListInstanceProfileTagsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    instance_profile_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'InstanceProfileName', 'style': 'form', 'explode': True }})
    version: GetListInstanceProfileTagsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListInstanceProfileTagsRequest:
    headers: GetListInstanceProfileTagsHeaders = dataclasses.field()
    query_params: GetListInstanceProfileTagsQueryParams = dataclasses.field()
