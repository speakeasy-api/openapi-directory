...
public class GetVCustomPricesRulesPriceAssociationIdPathParams {
    /**
    ...
    public GetVCustomPricesRulesPriceAssociationIdPathParams withPriceAssociationId(Long priceAssociationId) {
