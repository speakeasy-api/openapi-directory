...
export class TypeTypeServiceLink {
  ...
  searchTypeServiceLink(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_service_link";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeServiceLinkResponse =
        new operations.SearchTypeServiceLinkResponse({
