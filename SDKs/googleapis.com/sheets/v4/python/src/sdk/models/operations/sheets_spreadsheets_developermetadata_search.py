...
class SheetsSpreadsheetsDeveloperMetadataSearchRequest:
    ...
    r"""The ID of the spreadsheet to retrieve metadata from."""  
    ...
    search_developer_metadata_request: Optional[shared_searchdevelopermetadatarequest.SearchDeveloperMetadataRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
