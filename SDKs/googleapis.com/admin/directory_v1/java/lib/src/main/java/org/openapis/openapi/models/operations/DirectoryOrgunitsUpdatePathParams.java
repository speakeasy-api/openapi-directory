...
public class DirectoryOrgunitsUpdatePathParams {
    /**
    ...
    public DirectoryOrgunitsUpdatePathParams withCustomerId(String customerId) {
    ...
    public DirectoryOrgunitsUpdatePathParams withOrgUnitPath(String orgUnitPath) {
