...
class GETInvoiceTaxItemType:
    ...
    r"""The amount of the invoice taxation item that is available to credit."""  
    ...
    r"""The balance of the taxation item."""  
    ...
    r"""The amount of credit memos applied to the taxation item."""  
    ...
    r"""The amount of payments applied to the taxation item."""  
    ...
    r"""The tax code identifies which tax rules and tax rates to apply to a specific invoice."""  
    ...
    r"""The date that the tax is applied to the invoice, in `yyyy-mm-dd` format."""  
    ...
    r"""The tax rate applied to the invoice."""  
    ...
    tax_rate_type: Optional[GETInvoiceTaxItemTypeTaxRateTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxRateType'), 'exclude': lambda f: f is None }})
    r"""The type of the tax rate."""  
