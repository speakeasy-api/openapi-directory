    ...
    public static void main(String[] args) {
        try {
            ...
            DgmstRequestBody req = new DgmstRequestBody(DgmstRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new DgmstRequestBodyCertificateParameters("31-12-1980", "123456789012", "Sunil Kumar", "1234567890", "123412341234", "1,2,3,4,5");;
            ...
            DgmstResponse res = sdk.apIs.dgmst(req, new DgmstSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
