...
class ListAssistantListAssistantResponse:
    ...
    assistants: Optional[list[shared_autopilot_v1_assistant.AutopilotV1Assistant]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assistants'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListAssistantListAssistantResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
