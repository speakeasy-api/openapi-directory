...
public class OrderApiDeleteFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiDeleteFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiDeleteFormHeaders withXAuthSecret(String xAuthSecret) {
