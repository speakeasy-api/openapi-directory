...
public class GetNhFurnitureFurnitureHeaders {
    /**
    ...
    public GetNhFurnitureFurnitureHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFurnitureFurnitureHeaders withXApiKey(String xApiKey) {
