            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/hal+json")) {
                        ...
                        res.organizationModelHaljsons = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OrganizationModelHaljson, resFieldDepth);
                    }
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.organizationModels = [];
                        var resFieldDepth = utils.getResFieldDepth(res);
                        res.organizationModels = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OrganizationModel, resFieldDepth);
                    }
                    break;
