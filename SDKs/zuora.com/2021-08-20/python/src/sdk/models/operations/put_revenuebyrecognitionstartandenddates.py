...
from ..shared import putrstermtype as shared_putrstermtype
...
class PUTRevenueByRecognitionStartandEndDatesRequest:
    ...
    putrs_term_type: shared_putrstermtype.PUTRSTermType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    rs_number: str = dataclasses.field(metadata={'path_param': { 'field_name': 'rs-number', 'style': 'simple', 'explode': False }})
    r"""Revenue schedule number. Specify the revenue schedule whose revenue you want to distribute.
