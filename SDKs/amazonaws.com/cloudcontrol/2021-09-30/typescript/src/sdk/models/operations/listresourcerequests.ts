...
export enum ListResourceRequestsXAmzTargetEnum {
  CloudApiServiceListResourceRequests = "CloudApiService.ListResourceRequests",
}

export class ListResourceRequestsRequest extends SpeakeasyBase {
...
export class ListResourceRequestsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
