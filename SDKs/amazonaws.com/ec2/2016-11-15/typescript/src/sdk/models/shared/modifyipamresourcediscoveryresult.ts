 ...
 */
export class ModifyIpamResourceDiscoveryResultIpamResourceDiscoveryOperatingRegions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  regionName?: string;
}
 ...
 */
export enum ModifyIpamResourceDiscoveryResultIpamResourceDiscoveryStateEnum {
 ...
 * Describes a tag.
 */
export class ModifyIpamResourceDiscoveryResultIpamResourceDiscoveryTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class ModifyIpamResourceDiscoveryResultIpamResourceDiscovery extends SpeakeasyBase {
  @SpeakeasyMetadata()
  description?: string;
  ...
  @SpeakeasyMetadata({
    elemType:
      ModifyIpamResourceDiscoveryResultIpamResourceDiscoveryOperatingRegions,
  })
 ...
 * Success
 */
export class ModifyIpamResourceDiscoveryResult extends SpeakeasyBase {
  @SpeakeasyMetadata()
