...
class YoutubeLiveStreamsListRequest:
    ...
    r"""The *part* parameter specifies a comma-separated list of one or more liveStream resource properties that the API response will include. The part names that you can include in the parameter value are id, snippet, cdn, and status."""  
    ...
    r"""Return LiveStreams with the given ids from Stubby or Apiary."""  
