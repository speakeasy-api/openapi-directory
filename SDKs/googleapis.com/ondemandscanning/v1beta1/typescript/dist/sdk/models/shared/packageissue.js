...
var PackageIssue = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "affectedCpeUri" }),
        __metadata("design:type", String)
    ], PackageIssue.prototype, "affectedCpeUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "affectedPackage" }),
        __metadata("design:type", String)
    ], PackageIssue.prototype, "affectedPackage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "affectedVersion" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "effectiveSeverity" }),
        __metadata("design:type", String)
    ], PackageIssue.prototype, "effectiveSeverity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: grafeasv1filelocation_1.GrafeasV1FileLocation }),
        (0, class_transformer_1.Expose)({ name: "fileLocation" }),
        (0, class_transformer_1.Type)(function () { return grafeasv1filelocation_1.GrafeasV1FileLocation; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fixedCpeUri" }),
        __metadata("design:type", String)
    ], PackageIssue.prototype, "fixedCpeUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fixedPackage" }),
        __metadata("design:type", String)
    ], PackageIssue.prototype, "fixedPackage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fixedVersion" }),
        (0, class_transformer_1.Type)(function () { return version_1.Version; }),
        __metadata("design:type", version_1.Version)
