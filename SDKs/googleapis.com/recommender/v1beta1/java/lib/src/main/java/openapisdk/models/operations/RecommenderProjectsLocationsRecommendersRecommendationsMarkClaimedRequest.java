...
public class RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimedRequest {
    ...
    public openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest request;
    public RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimedRequest withRequest(openapisdk.models.shared.GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest request) {
