...
public class CreateInternationalPaymentConsentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalPaymentConsentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalPaymentConsentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalPaymentConsentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalPaymentConsentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalPaymentConsentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalPaymentConsentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalPaymentConsentsRawHeaders withXJwsSignature(String xJwsSignature) {
