...
public class GetofferslistQueryParams {
    /**
    ...
    public GetofferslistQueryParams withAccountName(String accountName) {
    ...
    public GetofferslistQueryParams withEnvironment(String environment) {
    ...
    public String fq;
    public GetofferslistQueryParams withFq(String fq) {
        this.fq = fq;
        return this;
    }
    ...
    public Long rows;
    public GetofferslistQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String sort;
    public GetofferslistQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetofferslistQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
