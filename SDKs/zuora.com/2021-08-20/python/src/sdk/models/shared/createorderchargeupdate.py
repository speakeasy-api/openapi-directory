...
class CreateOrderChargeUpdate:
    ...
    effective_date: Optional[shared_createorderupdateproducttriggerparams.CreateOrderUpdateProductTriggerParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('effectiveDate'), 'exclude': lambda f: f is None }})
    r"""Specifies when a charge becomes active."""  
    pricing: Optional[shared_createorderpricingupdate.CreateOrderPricingUpdate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pricing'), 'exclude': lambda f: f is None }})  
