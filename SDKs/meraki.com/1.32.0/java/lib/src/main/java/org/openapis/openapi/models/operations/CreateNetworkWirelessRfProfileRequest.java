...
public class CreateNetworkWirelessRfProfileRequest {
    ...
    public CreateNetworkWirelessRfProfileRequest(@JsonProperty("RequestBody") CreateNetworkWirelessRfProfileRequestBody requestBody, @JsonProperty("networkId") String networkId) {
        this.requestBody = requestBody;
        this.networkId = networkId;
  }
}
