...
class DatastreamProjectsLocationsConnectionProfilesCreateRequest:
    path_params: DatastreamProjectsLocationsConnectionProfilesCreatePathParams = dataclasses.field()
    query_params: DatastreamProjectsLocationsConnectionProfilesCreateQueryParams = dataclasses.field()
    security: DatastreamProjectsLocationsConnectionProfilesCreateSecurity = dataclasses.field()
