...
var IdentityServiceMembershipSpec = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: identityserviceauthmethod_1.IdentityServiceAuthMethod }),
        (0, class_transformer_1.Expose)({ name: "authMethods" }),
        (0, class_transformer_1.Type)(function () { return identityserviceauthmethod_1.IdentityServiceAuthMethod; }),
...
var IdentityServiceMembershipSpecInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: identityserviceauthmethod_1.IdentityServiceAuthMethodInput }),
        (0, class_transformer_1.Expose)({ name: "authMethods" }),
        (0, class_transformer_1.Type)(function () { return identityserviceauthmethod_1.IdentityServiceAuthMethodInput; }),
        __metadata("design:type", Array)
