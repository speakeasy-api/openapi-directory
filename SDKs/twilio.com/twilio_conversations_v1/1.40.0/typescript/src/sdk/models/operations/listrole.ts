...
export const ListRoleServerList = ["https://conversations.twilio.com"] as const;
...
export class ListRoleListRoleResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ConversationsV1Role })
  @Expose({ name: "roles" })
  @Type(() => shared.ConversationsV1Role)
