...
export class BaremetalsolutionProjectsLocationsInstancesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsInstancesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsInstancesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
