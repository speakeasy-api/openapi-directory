...
public class Repository {
    ...
    public RepositoryLicenseSimple license;
    public Repository withLicense(RepositoryLicenseSimple license) {
    ...
    public RepositorySimpleUser organization;
    public Repository withOrganization(RepositorySimpleUser organization) {
        this.organization = organization;
        return this;
    }
    @JsonProperty("owner")
    public RepositorySimpleUser owner;
    public Repository withOwner(RepositorySimpleUser owner) {
        this.owner = owner;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
