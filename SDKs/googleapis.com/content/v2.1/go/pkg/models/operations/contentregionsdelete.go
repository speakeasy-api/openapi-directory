...
type ContentRegionsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentRegionsDeletePathParams struct {
...
type ContentRegionsDeleteQueryParams struct {
	// V1 error format.
...
type ContentRegionsDeleteRequest struct {
...
type ContentRegionsDeleteResponse struct {
	ContentType string
	StatusCode  int
