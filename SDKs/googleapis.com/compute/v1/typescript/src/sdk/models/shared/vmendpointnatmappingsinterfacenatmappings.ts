 ...
 */
export class VmEndpointNatMappingsInterfaceNatMappings extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    elemType: VmEndpointNatMappingsInterfaceNatMappingsNatRuleMappings,
  })
  @Expose({ name: "ruleMappings" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "sourceAliasIpRange" })
