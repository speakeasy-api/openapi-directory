...
export class CreateDomesticStandingOrderConsentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticStandingOrderConsentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticStandingOrderConsentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
