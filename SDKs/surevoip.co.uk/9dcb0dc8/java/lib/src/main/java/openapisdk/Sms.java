...
public class Sms {
     ...
     * getSms - List SMS
    **/
    public openapisdk.models.operations.GetSmsResponse getSms() throws Exception {
        ...
        openapisdk.models.operations.GetSmsResponse res = new openapisdk.models.operations.GetSmsResponse() {{
        }};
