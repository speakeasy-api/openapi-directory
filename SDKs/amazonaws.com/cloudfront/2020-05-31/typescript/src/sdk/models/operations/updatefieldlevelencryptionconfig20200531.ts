 ...
 */
export class UpdateFieldLevelEncryptionConfig20200531RequestBodyFieldLevelEncryptionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateFieldLevelEncryptionConfig20200531RequestBody extends SpeakeasyBase {
  /**
   * A complex data type that includes the profile configurations specified for field-level encryption.
   */
  @SpeakeasyMetadata()
...
export class UpdateFieldLevelEncryptionConfig20200531Request extends SpeakeasyBase {
  /**
...
export class UpdateFieldLevelEncryptionConfig20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
