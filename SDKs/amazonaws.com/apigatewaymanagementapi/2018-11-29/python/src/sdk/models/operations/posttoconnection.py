...
class PostToConnectionRequestBody:
    ...
    r"""The data to be sent to the client specified by its connection id."""  
...
class PostToConnectionRequest:
    ...
    r"""The identifier of the connection that a specific client is using."""  
    request_body: PostToConnectionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
