...
class ListEnvironmentRequest:
    ...
    r"""The SID of the Service to read the Environment resources from."""  
...
class ListEnvironmentListEnvironmentResponse:
    ...
    environments: Optional[list[shared_serverless_v1_service_environment.ServerlessV1ServiceEnvironment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('environments'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListEnvironmentListEnvironmentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
