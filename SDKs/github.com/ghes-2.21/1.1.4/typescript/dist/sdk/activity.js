...
var Activity = /** @class */ (function () {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#check-if-a-repository-is-starred-by-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#delete-a-repository-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#delete-a-thread-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#get-feeds} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#get-a-repository-subscription} - API method documentation
     */
     ...
     * Get a thread
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#get-a-thread} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#get-a-thread-subscription-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-events-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-notifications-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-organization-events-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-public-events} - API method documentation
     */
    Activity.prototype.activityListPublicEvents = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ActivityListPublicEventsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 503:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.activityListPublicEvents503ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.ActivityListPublicEvents503ApplicationJSON);
                    }
                    break;
            }
            return res;
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-public-events-for-a-network-of-repositories} - API method documentation
     */
    Activity.prototype.activityListPublicEventsForRepoNetwork = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/networks/{owner}/{repo}/events", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ActivityListPublicEventsForRepoNetworkResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-public-events-for-a-user} - API method documentation
     */
    Activity.prototype.activityListPublicEventsForUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/events/public", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ActivityListPublicEventsForUserResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-public-organization-events} - API method documentation
     */
    Activity.prototype.activityListPublicOrgEvents = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orgs/{org}/events", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ActivityListPublicOrgEventsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-events-received-by-the-authenticated-user} - API method documentation
     */
    Activity.prototype.activityListReceivedEventsForUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/received_events", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ActivityListReceivedEventsForUserResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-public-events-received-by-a-user} - API method documentation
     */
    Activity.prototype.activityListReceivedPublicEventsForUser = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/users/{username}/received_events/public", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ActivityListReceivedPublicEventsForUserResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-repository-events} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-repository-notifications-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-repositories-starred-by-the-authenticated-user} - API method documentation
     */
     ...
     * You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@2.21/rest/overview/media-types/) via the `Accept` header:
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-repositories-starred-by-a-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-repositories-watched-by-a-user} - API method documentation
     */
     ...
     * You can also find out _when_ stars were created by passing the following custom [media type](https://docs.github.com/enterprise-server@2.21/rest/overview/media-types/) via the `Accept` header:
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-stargazers} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-repositories-watched-by-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#list-watchers} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#mark-notifications-as-read} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#mark-repository-notifications-as-read} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#mark-a-thread-as-read} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#set-a-repository-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#set-a-thread-subscription} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#star-a-repository-for-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@2.21/rest/reference/activity#unstar-a-repository-for-the-authenticated-user} - API method documentation
     */
