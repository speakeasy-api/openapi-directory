...
exports.CreateDirectoryConfigResponse = exports.CreateDirectoryConfigRequest = exports.CreateDirectoryConfigXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var CreateDirectoryConfigXAmzTargetEnum;
...
})(CreateDirectoryConfigXAmzTargetEnum = exports.CreateDirectoryConfigXAmzTargetEnum || (exports.CreateDirectoryConfigXAmzTargetEnum = {}));
var CreateDirectoryConfigRequest = /** @class */ (function (_super) {
    ...
    ], CreateDirectoryConfigRequest.prototype, "createDirectoryConfigRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], CreateDirectoryConfigRequest.prototype, "xAmzTarget", void 0);
    return CreateDirectoryConfigRequest;
}(utils_1.SpeakeasyBase));
exports.CreateDirectoryConfigRequest = CreateDirectoryConfigRequest;
var CreateDirectoryConfigResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateDirectoryConfigResponse.prototype, "rawResponse", void 0);
    return CreateDirectoryConfigResponse;
}(utils_1.SpeakeasyBase));
exports.CreateDirectoryConfigResponse = CreateDirectoryConfigResponse;
