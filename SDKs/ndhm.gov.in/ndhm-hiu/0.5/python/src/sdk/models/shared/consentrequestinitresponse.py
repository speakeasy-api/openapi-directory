...
class ConsentRequestInitResponse:
    ...
    consent_request: Optional[ConsentRequestInitResponseConsentRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('consentRequest'), 'exclude': lambda f: f is None }})  
