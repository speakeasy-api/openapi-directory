...
from ..shared import createdriveresponse as shared_createdriveresponse
...
@dataclasses.dataclass
class DrivesAddSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class DrivesAddRequest:
    headers: DrivesAddHeaders = dataclasses.field()
    query_params: DrivesAddQueryParams = dataclasses.field()
    request: shared_drive.DriveInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: DrivesAddSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DrivesAddResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    create_drive_response: Optional[shared_createdriveresponse.CreateDriveResponse] = dataclasses.field(default=None)
