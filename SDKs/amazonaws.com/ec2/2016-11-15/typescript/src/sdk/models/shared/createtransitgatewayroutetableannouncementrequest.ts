 ...
 */
export enum CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateTransitGatewayRouteTableAnnouncementRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({
    elemType:
      CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsTags,
  })
  tags?: CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsTags[];
}

export class CreateTransitGatewayRouteTableAnnouncementRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  @SpeakeasyMetadata({
    elemType:
      CreateTransitGatewayRouteTableAnnouncementRequestTagSpecifications,
  })
