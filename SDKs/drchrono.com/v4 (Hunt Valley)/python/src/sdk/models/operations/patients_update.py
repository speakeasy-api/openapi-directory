...
class PatientsUpdatePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsUpdateQueryParams:
...
class PatientsUpdateRequest:
    path_params: PatientsUpdatePathParams = dataclasses.field()
    query_params: PatientsUpdateQueryParams = dataclasses.field()
    security: PatientsUpdateSecurity = dataclasses.field()
