...
class DescribeApplicationSnapshotRequest:
    ...
    describe_application_snapshot_request: shared_describeapplicationsnapshotrequest.DescribeApplicationSnapshotRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
