...
public class GetTagsFromUserRequest {
    ...
    public GetTagsFromUserRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("UserId") String userId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.userId = userId;
  }
