 ...
 */
public enum InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceCategoryEnum {
    ...
    private InboundRealTimePaymentsTransferSimulationResultTransactionTransactionSourceCategoryEnum(String value) {
        this.value = value;
    }
}
