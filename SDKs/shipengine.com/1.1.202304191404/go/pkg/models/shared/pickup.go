...
type PickupPartialAddressAddressResidentialIndicatorEnum string

const (
	PickupPartialAddressAddressResidentialIndicatorEnumUnknown PickupPartialAddressAddressResidentialIndicatorEnum = "unknown"
	PickupPartialAddressAddressResidentialIndicatorEnumYes     PickupPartialAddressAddressResidentialIndicatorEnum = "yes"
	PickupPartialAddressAddressResidentialIndicatorEnumNo      PickupPartialAddressAddressResidentialIndicatorEnum = "no"
)

func (e PickupPartialAddressAddressResidentialIndicatorEnum) ToPointer() *PickupPartialAddressAddressResidentialIndicatorEnum {
	return &e
}

func (e *PickupPartialAddressAddressResidentialIndicatorEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "yes":
		fallthrough
	case "no":
		*e = PickupPartialAddressAddressResidentialIndicatorEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PickupPartialAddressAddressResidentialIndicatorEnum: %v", v)
	}
}

// PickupPartialAddress - A complete or partial mailing address.
type PickupPartialAddress struct {
	...
	AddressResidentialIndicator PickupPartialAddressAddressResidentialIndicatorEnum `json:"address_residential_indicator"`
...
type PickupOutput struct {
	...
	PickupAddress *PickupPartialAddress `json:"pickup_address,omitempty"`
