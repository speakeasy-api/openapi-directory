 ...
 */
export enum SslPoliciesAggregatedListWarningCodeEnum {
...
export class SslPoliciesAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SslPoliciesAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SslPoliciesAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => SslPoliciesAggregatedListWarningData)
 ...
 * Successful response
 */
export class SslPoliciesAggregatedList extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: SslPoliciesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, SslPoliciesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], SslPoliciesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "warning" })
  @Type(() => SslPoliciesAggregatedListWarning)
