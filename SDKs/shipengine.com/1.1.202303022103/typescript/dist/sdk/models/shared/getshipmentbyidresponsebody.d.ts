 ...
 */
export declare enum GetShipmentByIdResponseBodyDeliveryConfirmationEnum {
    None = "none",
    Delivery = "delivery",
    Signature = "signature",
 ...
 */
export declare enum GetShipmentByIdResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export declare enum GetShipmentByIdResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
...
export declare class GetShipmentByIdResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
     ...
     */
    contents: GetShipmentByIdResponseBodyInternationalShipmentOptionsPackageContentsEnum;
    /**
     ...
     */
    nonDelivery: GetShipmentByIdResponseBodyInternationalShipmentOptionsNonDeliveryEnum;
}
/**
 * The possible insurance provider values
 */
export declare enum GetShipmentByIdResponseBodyInsuranceProviderEnum {
    None = "none",
 ...
 */
export declare enum GetShipmentByIdResponseBodyOriginTypeEnum {
    Pickup = "pickup",
    DropOff = "drop_off"
}
/**
 ...
 */
export declare enum GetShipmentByIdResponseBodyShipmentStatusEnum {
    Pending = "pending",
...
export declare class GetShipmentByIdResponseBody extends SpeakeasyBase {
     ...
     */
    confirmation: GetShipmentByIdResponseBodyDeliveryConfirmationEnum;
    /**
     ...
     *
     */
    insuranceProvider: GetShipmentByIdResponseBodyInsuranceProviderEnum;
    /**
     ...
     * Indicates if the package will be picked up or dropped off by the carrier
     */
    originType?: GetShipmentByIdResponseBodyOriginTypeEnum;
    /**
     ...
     */
    shipmentStatus: GetShipmentByIdResponseBodyShipmentStatusEnum;
    /**
