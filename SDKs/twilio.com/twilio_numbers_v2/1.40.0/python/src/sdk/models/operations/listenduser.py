...
class ListEndUserListEndUserResponse:
    ...
    meta: Optional[ListEndUserListEndUserResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    results: Optional[list[shared_numbers_v2_regulatory_compliance_end_user.NumbersV2RegulatoryComplianceEndUser]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
...
class ListEndUserResponse:
    ...
    list_end_user_response: Optional[ListEndUserListEndUserResponse] = dataclasses.field(default=None)
    r"""OK"""  
