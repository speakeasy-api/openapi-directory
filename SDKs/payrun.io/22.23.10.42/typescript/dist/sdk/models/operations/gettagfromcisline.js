...
exports.GetTagFromCisLineResponse = exports.GetTagFromCisLineRequest = void 0;
...
var GetTagFromCisLineRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromCisLineRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisLineRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=CisLineId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisLineRequest.prototype, "cisLineId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisLineRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisLineRequest.prototype, "subContractorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromCisLineRequest.prototype, "tagId", void 0);
...
var GetTagFromCisLineResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromCisLineResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
