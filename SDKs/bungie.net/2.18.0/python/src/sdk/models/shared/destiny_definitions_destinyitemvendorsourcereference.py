...
class DestinyDefinitionsDestinyItemVendorSourceReference:
    r"""Represents that a vendor could sell this item, and provides a quick link to that vendor and sale item.
    ...
    r"""The identifier for the vendor that may sell this item."""  
    vendor_item_indexes: Optional[list[int]] = dataclasses.field(default=None)
    r"""The Vendor sale item indexes that represent the sale information for this item. The same vendor may sell an item in multiple \\"ways\\", hence why this is a list. (for instance, a weapon may be \\"sold\\" as a reward in a quest, for Glimmer, and for Masterwork Cores: each of those ways would be represented by a different vendor sale item with a different index)"""  
