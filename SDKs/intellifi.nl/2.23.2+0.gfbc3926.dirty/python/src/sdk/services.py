...
class Services:
    ...
    def get_service_by_id(self, request: operations.GetServiceByIDRequest) -> operations.GetServiceByIDResponse:
        ...
        url = utils.generate_url(operations.GetServiceByIDRequest, base_url, '/services/{id}', request)
        ...
        res = operations.GetServiceByIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_service(self, request: operations.UpdateServiceRequest) -> operations.UpdateServiceResponse:
        ...
        url = utils.generate_url(operations.UpdateServiceRequest, base_url, '/services/{id}', request)
