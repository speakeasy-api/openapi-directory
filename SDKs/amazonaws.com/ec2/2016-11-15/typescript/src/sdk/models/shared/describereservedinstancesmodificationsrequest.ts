 ...
 */
export class DescribeReservedInstancesModificationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export class DescribeReservedInstancesModificationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
    elemType: DescribeReservedInstancesModificationsRequestFilters,
  })
