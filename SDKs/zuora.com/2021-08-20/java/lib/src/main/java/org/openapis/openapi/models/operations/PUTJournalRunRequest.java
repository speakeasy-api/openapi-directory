...
public class PUTJournalRunRequest {
    ...
    public PUTJournalRunRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public PUTJournalRunRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public PUTJournalRunRequest withJrNumber(String jrNumber) {
