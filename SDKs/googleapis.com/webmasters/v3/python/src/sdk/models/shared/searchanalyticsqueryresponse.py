...
class SearchAnalyticsQueryResponse:
    ...
    response_aggregation_type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('responseAggregationType'), 'exclude': lambda f: f is None }})
