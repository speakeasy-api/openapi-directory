...
export class DataplexProjectsLocationsLakesTasksJobsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesTasksJobsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesTasksJobsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
