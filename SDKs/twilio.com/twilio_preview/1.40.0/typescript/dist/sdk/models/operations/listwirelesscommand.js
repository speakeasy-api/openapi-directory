...
exports.ListWirelessCommandResponse = exports.ListWirelessCommandListWirelessCommandResponse = exports.ListWirelessCommandListWirelessCommandResponseMeta = exports.ListWirelessCommandRequest = exports.ListWirelessCommandSecurity = exports.ListWirelessCommandServerList = void 0;
...
var ListWirelessCommandSecurity = /** @class */ (function (_super) {
    ...
    ], ListWirelessCommandSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListWirelessCommandSecurity.prototype, "username", void 0);
...
var ListWirelessCommandRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListWirelessCommandRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Direction",
        }),
        __metadata("design:type", String)
    ], ListWirelessCommandRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListWirelessCommandRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListWirelessCommandRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListWirelessCommandRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Sim" }),
        __metadata("design:type", String)
    ], ListWirelessCommandRequest.prototype, "sim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListWirelessCommandRequest.prototype, "status", void 0);
...
var ListWirelessCommandListWirelessCommandResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewWirelessCommand }),
        (0, class_transformer_1.Expose)({ name: "commands" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewWirelessCommand; }),
        __metadata("design:type", Array)
    ], ListWirelessCommandListWirelessCommandResponse.prototype, "commands", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListWirelessCommandListWirelessCommandResponseMeta; }),
...
var ListWirelessCommandResponse = /** @class */ (function (_super) {
    ...
    ], ListWirelessCommandResponse.prototype, "rawResponse", void 0);
