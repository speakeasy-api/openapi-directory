...
exports.ClinicalNoteFieldValuesCreateResponse = exports.ClinicalNoteFieldValuesCreateRequest = exports.ClinicalNoteFieldValuesCreateSecurity = void 0;
...
var ClinicalNoteFieldValuesCreateRequest = /** @class */ (function (_super) {
    ...
    ], ClinicalNoteFieldValuesCreateRequest.prototype, "appointment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=clinical_note_field",
        }),
        __metadata("design:type", Number)
    ], ClinicalNoteFieldValuesCreateRequest.prototype, "clinicalNoteField", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=clinical_note_template",
        }),
        __metadata("design:type", Number)
    ], ClinicalNoteFieldValuesCreateRequest.prototype, "clinicalNoteTemplate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], ClinicalNoteFieldValuesCreateRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], ClinicalNoteFieldValuesCreateRequest.prototype, "since", void 0);
...
var ClinicalNoteFieldValuesCreateResponse = /** @class */ (function (_super) {
    ...
    ], ClinicalNoteFieldValuesCreateResponse.prototype, "rawResponse", void 0);
