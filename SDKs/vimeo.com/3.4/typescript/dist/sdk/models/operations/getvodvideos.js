...
exports.GetVodVideosResponse = exports.GetVodVideosRequest = exports.GetVodVideosSortEnum = exports.GetVodVideosFilterEnum = exports.GetVodVideosDirectionEnum = void 0;
...
var GetVodVideosRequest = /** @class */ (function (_super) {
    ...
    ], GetVodVideosRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetVodVideosRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ondemand_id",
        }),
        __metadata("design:type", Number)
    ], GetVodVideosRequest.prototype, "ondemandId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetVodVideosRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetVodVideosRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetVodVideosRequest.prototype, "sort", void 0);
...
var GetVodVideosResponse = /** @class */ (function (_super) {
    ...
    ], GetVodVideosResponse.prototype, "rawResponse", void 0);
    __decorate([
