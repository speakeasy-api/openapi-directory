...
export class ContentConversionsourcesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentConversionsourcesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentConversionsourcesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
