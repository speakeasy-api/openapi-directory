...
public class PutCustomFieldsIdJsonRequest {
    ...
    public PutCustomFieldsIdJsonRequest(@JsonProperty("CustomFieldEdit") org.openapis.openapi.models.shared.CustomFieldEdit customFieldEdit, @JsonProperty("authtoken") String authtoken, @JsonProperty("id") Integer id, @JsonProperty("login") String login) {
        this.customFieldEdit = customFieldEdit;
        this.authtoken = authtoken;
        this.id = id;
        this.login = login;
