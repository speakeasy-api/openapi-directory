...
func (e *UpdateDataQualityRulesetXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSGlue.UpdateDataQualityRuleset":
		*e = UpdateDataQualityRulesetXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDataQualityRulesetXAmzTargetEnum: %s", s)
	}
}

type UpdateDataQualityRulesetHeaders struct {
...
type UpdateDataQualityRulesetRequest struct {
	Headers UpdateDataQualityRulesetHeaders
	Request shared.UpdateDataQualityRulesetRequest `request:"mediaType=application/json"`
}
