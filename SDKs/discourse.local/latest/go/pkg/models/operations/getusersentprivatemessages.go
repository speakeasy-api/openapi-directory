...
type GetUserSentPrivateMessages200ApplicationJSONTopicListTopics struct {
	...
	Posters            []GetUserSentPrivateMessages200ApplicationJSONTopicListTopicsPosters `json:"posters,omitempty"`
...
type GetUserSentPrivateMessages200ApplicationJSONTopicList struct {
	...
	Topics         []GetUserSentPrivateMessages200ApplicationJSONTopicListTopics `json:"topics,omitempty"`
}

type GetUserSentPrivateMessages200ApplicationJSONUsers struct {
...
type GetUserSentPrivateMessages200ApplicationJSON struct {
	PrimaryGroups []interface{}                                          `json:"primary_groups,omitempty"`
	TopicList     *GetUserSentPrivateMessages200ApplicationJSONTopicList `json:"topic_list,omitempty"`
	Users         []GetUserSentPrivateMessages200ApplicationJSONUsers    `json:"users,omitempty"`
}

type GetUserSentPrivateMessagesResponse struct {
	ContentType string
	StatusCode  int
