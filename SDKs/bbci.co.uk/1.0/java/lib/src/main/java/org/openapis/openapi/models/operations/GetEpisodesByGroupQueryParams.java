...
public class GetEpisodesByGroupQueryParams {
    /**
    ...
    public GetEpisodesByGroupQueryParams withAvailability(org.openapis.openapi.models.shared.AvailabilityEnum availability) {
    ...
    public GetEpisodesByGroupQueryParams withInitialChildCount(Long initialChildCount) {
    ...
    public GetEpisodesByGroupQueryParams withMixin(org.openapis.openapi.models.shared.MixinEnum mixin) {
        this.mixin = mixin;
        return this;
    }
    ...
    public Long page;
    public GetEpisodesByGroupQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetEpisodesByGroupQueryParams withPerPage(Long perPage) {
    ...
    public GetEpisodesByGroupQueryParams withRights(org.openapis.openapi.models.shared.RightsEnum rights) {
        this.rights = rights;
        return this;
    }
    ...
    public String sort;
    public GetEpisodesByGroupQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetEpisodesByGroupQueryParams withSortDirection(org.openapis.openapi.models.shared.SortDirectionEnum sortDirection) {
