...
export class YoutubeCommentsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class YoutubeCommentsUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class YoutubeCommentsUpdateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
