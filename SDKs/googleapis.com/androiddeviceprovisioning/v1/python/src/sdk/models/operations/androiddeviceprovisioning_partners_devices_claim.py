...
class AndroiddeviceprovisioningPartnersDevicesClaimRequest:
    ...
    r"""JSONP"""  
    claim_device_request: Optional[shared_claimdevicerequest.ClaimDeviceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
