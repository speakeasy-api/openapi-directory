 ...
 */
export enum DeleteAlternateContactRequestBodyAlternateContactTypeEnum {
  Billing = "BILLING",
  Operations = "OPERATIONS",
  Security = "SECURITY",
}

export class DeleteAlternateContactRequestBody extends SpeakeasyBase {
  /**
...
export class DeleteAlternateContactRequest extends SpeakeasyBase {
...
export class DeleteAlternateContactResponse extends SpeakeasyBase {
  /**
