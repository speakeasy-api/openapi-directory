...
func (e MoveOrganizationLicensingCotermLicensesRequestBodyDestinationModeEnum) ToPointer() *MoveOrganizationLicensingCotermLicensesRequestBodyDestinationModeEnum {
	return &e
}
...
func (e *MoveOrganizationLicensingCotermLicensesRequestBodyDestinationModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "addDevices":
		fallthrough
	case "renew":
		*e = MoveOrganizationLicensingCotermLicensesRequestBodyDestinationModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MoveOrganizationLicensingCotermLicensesRequestBodyDestinationModeEnum: %v", v)
	}
}
...
func (e MoveOrganizationLicensingCotermLicenses200ApplicationJSONMovedLicensesModeEnum) ToPointer() *MoveOrganizationLicensingCotermLicenses200ApplicationJSONMovedLicensesModeEnum {
	return &e
}
...
func (e *MoveOrganizationLicensingCotermLicenses200ApplicationJSONMovedLicensesModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "addDevices":
		fallthrough
	case "renew":
		*e = MoveOrganizationLicensingCotermLicenses200ApplicationJSONMovedLicensesModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MoveOrganizationLicensingCotermLicenses200ApplicationJSONMovedLicensesModeEnum: %v", v)
	}
}
...
func (e MoveOrganizationLicensingCotermLicenses200ApplicationJSONRemainderLicensesModeEnum) ToPointer() *MoveOrganizationLicensingCotermLicenses200ApplicationJSONRemainderLicensesModeEnum {
	return &e
}
...
func (e *MoveOrganizationLicensingCotermLicenses200ApplicationJSONRemainderLicensesModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "addDevices":
		fallthrough
	case "renew":
		*e = MoveOrganizationLicensingCotermLicenses200ApplicationJSONRemainderLicensesModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MoveOrganizationLicensingCotermLicenses200ApplicationJSONRemainderLicensesModeEnum: %v", v)
	}
}
