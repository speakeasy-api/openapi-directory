 ...
 */
export declare enum GetNetworkClientsConnectionStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkClientsConnectionStatsRequest extends SpeakeasyBase {
    /**
...
export declare class GetNetworkClientsConnectionStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
     ...
     */
    getNetworkClientsConnectionStats200ApplicationJSONObjects?: Record<string, any>[];
}
