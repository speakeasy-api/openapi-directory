...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DfareportingPostalCodesGetRequest req = new DfareportingPostalCodesGetRequest("ab", "distinctio") {{
            ...
            DfareportingPostalCodesGetResponse res = sdk.postalCodes.dfareportingPostalCodesGet(req, new DfareportingPostalCodesGetSecurity("quaerat", "vitae") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DfareportingPostalCodesListRequest req = new DfareportingPostalCodesListRequest("architecto") {{
                dollarXgafv = XgafvEnum.TWO;
            ...
            DfareportingPostalCodesListResponse res = sdk.postalCodes.dfareportingPostalCodesList(req, new DfareportingPostalCodesListSecurity("rem", "magni") {{
                oauth2 = "Bearer YOUR_ACCESS_TOKEN_HERE";
                oauth2c = "Bearer YOUR_ACCESS_TOKEN_HERE";
            }});
