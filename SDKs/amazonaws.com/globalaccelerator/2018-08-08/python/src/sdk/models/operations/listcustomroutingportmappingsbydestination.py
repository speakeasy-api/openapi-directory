...
class ListCustomRoutingPortMappingsByDestinationRequest:
    ...
    list_custom_routing_port_mappings_by_destination_request: shared_listcustomroutingportmappingsbydestinationrequest.ListCustomRoutingPortMappingsByDestinationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
