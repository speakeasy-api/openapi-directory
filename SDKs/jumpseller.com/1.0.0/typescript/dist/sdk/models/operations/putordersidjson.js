...
exports.PutOrdersIdJsonResponse = exports.PutOrdersIdJsonRequest = void 0;
...
var PutOrdersIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutOrdersIdJsonRequest.prototype, "orderEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutOrdersIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutOrdersIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutOrdersIdJsonRequest.prototype, "login", void 0);
    return PutOrdersIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutOrdersIdJsonRequest = PutOrdersIdJsonRequest;
var PutOrdersIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutOrdersIdJsonResponse.prototype, "rawResponse", void 0);
    return PutOrdersIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PutOrdersIdJsonResponse = PutOrdersIdJsonResponse;
