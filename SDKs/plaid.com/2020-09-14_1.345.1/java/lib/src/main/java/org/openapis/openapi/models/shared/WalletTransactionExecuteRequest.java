...
public class WalletTransactionExecuteRequest {
    ...
    public WalletTransactionExecuteRequest(@JsonProperty("amount") java.util.Map<String, Object> amount, @JsonProperty("counterparty") java.util.Map<String, Object> counterparty, @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("reference") String reference, @JsonProperty("wallet_id") String walletId) {
        this.amount = amount;
        this.counterparty = counterparty;
        this.idempotencyKey = idempotencyKey;
        this.reference = reference;
