...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/redhat.local/patchman-engine/v1.15.3/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/redhat.local/patchman-engine/v1.15.3/typescript
```
