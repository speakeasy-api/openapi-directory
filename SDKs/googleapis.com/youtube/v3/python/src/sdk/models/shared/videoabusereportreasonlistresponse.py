...
class VideoAbuseReportReasonListResponse:
    ...
    items: Optional[list[shared_videoabusereportreason.VideoAbuseReportReason]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
