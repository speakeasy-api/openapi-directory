...
export class NotebooksProjectsLocationsEnvironmentsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NotebooksProjectsLocationsEnvironmentsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NotebooksProjectsLocationsEnvironmentsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
