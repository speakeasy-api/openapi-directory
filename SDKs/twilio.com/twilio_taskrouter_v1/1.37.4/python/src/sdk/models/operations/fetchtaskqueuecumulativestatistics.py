...
class FetchTaskQueueCumulativeStatisticsRequest:
    path_params: FetchTaskQueueCumulativeStatisticsPathParams = dataclasses.field()
    query_params: FetchTaskQueueCumulativeStatisticsQueryParams = dataclasses.field()
    security: FetchTaskQueueCumulativeStatisticsSecurity = dataclasses.field()
