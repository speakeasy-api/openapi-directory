...
class GrpcRoute:
    ...
    rules: Optional[list[shared_grpcrouterouterule.GrpcRouteRouteRule]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rules') }})
