...
public class ListSipPhonesRequest {
    ...
    public ListSipPhonesRequest withNextPageToken(String nextPageToken) {
    ...
    public ListSipPhonesRequest withPageNumber(Long pageNumber) {
    ...
    public ListSipPhonesRequest withPageSize(Long pageSize) {
    ...
    public ListSipPhonesRequest withSearchKey(String searchKey) {
