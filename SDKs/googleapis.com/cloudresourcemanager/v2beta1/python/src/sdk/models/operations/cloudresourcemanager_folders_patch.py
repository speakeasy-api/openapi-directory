...
class CloudresourcemanagerFoldersPatchRequest:
    ...
    folder_input: Optional[shared_folder.FolderInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    ...
    r"""Required. Fields to be updated. Only the `display_name` can be updated."""  
