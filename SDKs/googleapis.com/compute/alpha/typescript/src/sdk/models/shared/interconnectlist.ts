 ...
 */
export enum InterconnectListWarningCodeEnum {
...
export class InterconnectListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InterconnectListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InterconnectListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InterconnectList extends SpeakeasyBase {
  /**
