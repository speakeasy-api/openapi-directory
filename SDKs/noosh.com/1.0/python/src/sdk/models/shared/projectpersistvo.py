...
class ProjectPersistVO:
    r"""Java type: com.noosh.domain.nooshapi.persist.vo.ProjectPersistVO"""
    
    project_status_id: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('project_status_id') }})  
    ...
    is_paper_direct: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('is_paper_direct'), 'exclude': lambda f: f is None }})  
    ...
    project_owner_user_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('project_owner_user_id'), 'exclude': lambda f: f is None }})  
