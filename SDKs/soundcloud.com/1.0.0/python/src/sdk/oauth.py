...
class Oauth:
    ...
    def get_connect(self, request: operations.GetConnectRequest, security: operations.GetConnectSecurity) -> operations.GetConnectResponse:
        ...
        * Use the `state` parameter for [CSRF protection](https://tools.ietf.org/html/draft-ietf-oauth-security-topics-16#section-4.7). Pass a sufficient  random nonce here and verify this nonce again after retrieving the token.
        ...
        query_params = utils.get_query_params(operations.GetConnectRequest, request)
        ...
        res = operations.GetConnectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 302:
            if utils.match_content_type(content_type, 'application/json; charset=utf-8'):
                res.get_connect_302_application_json_string = http_res.content
    ...
    def post_oauth2_token(self, request: Any, security: operations.PostOauth2TokenSecurity) -> operations.PostOauth2TokenResponse:
