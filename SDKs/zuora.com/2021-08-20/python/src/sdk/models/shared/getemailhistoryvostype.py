...
class GETEmailHistoryVOsType:
    ...
    email_histories: Optional[list[shared_getemailhistoryvotype.GETEmailHistoryVOType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('emailHistories'), 'exclude': lambda f: f is None }})
    r"""A container for email histories."""  
