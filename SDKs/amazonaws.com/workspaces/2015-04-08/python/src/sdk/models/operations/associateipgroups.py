...
class AssociateIPGroupsRequest:
    headers: AssociateIPGroupsHeaders = dataclasses.field()
    request: shared_associateipgroupsrequest.AssociateIPGroupsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
