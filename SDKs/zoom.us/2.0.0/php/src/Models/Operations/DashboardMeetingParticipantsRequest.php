...
class DashboardMeetingParticipantsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DashboardMeetingParticipantsIncludeFieldsEnum $includeFields
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=include_fields')]
    public ?DashboardMeetingParticipantsIncludeFieldsEnum $includeFields = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DashboardMeetingParticipantsTypeEnum $type
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=type')]
    public ?DashboardMeetingParticipantsTypeEnum $type = null;
