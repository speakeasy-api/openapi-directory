...
SERVERS = [
    ...
    r"""The WAF Regional multi-region endpoint"""
    "https://waf-regional.{region}.amazonaws.com",
    r"""The WAF Regional multi-region endpoint"""
    "http://waf-regional.{region}.amazonaws.com.cn",
    r"""The WAF Regional endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def associate_web_acl(self, request: operations.AssociateWebACLRequest) -> operations.AssociateWebACLResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "associate_web_acl_request", 'json')
        ...
        res = operations.AssociateWebACLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def disassociate_web_acl(self, request: operations.DisassociateWebACLRequest) -> operations.DisassociateWebACLResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disassociate_web_acl_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisassociateWebACLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_web_acl_for_resource(self, request: operations.GetWebACLForResourceRequest) -> operations.GetWebACLForResourceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_web_acl_for_resource_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetWebACLForResourceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetWebACLForResourceResponse])
    ...
    def list_resources_for_web_acl(self, request: operations.ListResourcesForWebACLRequest) -> operations.ListResourcesForWebACLResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_resources_for_web_acl_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListResourcesForWebACLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListResourcesForWebACLResponse])
