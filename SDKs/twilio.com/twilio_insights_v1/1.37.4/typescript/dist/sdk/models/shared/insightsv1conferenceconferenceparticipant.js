...
exports.InsightsV1ConferenceConferenceParticipant = void 0;
var utils_1 = require("../../../internal/utils");
var conferenceparticipantenumcalldirectionenum_1 = require("./conferenceparticipantenumcalldirectionenum");
var conferenceparticipantenumcallstatusenum_1 = require("./conferenceparticipantenumcallstatusenum");
var conferenceparticipantenumcalltypeenum_1 = require("./conferenceparticipantenumcalltypeenum");
var conferenceparticipantenumregionenum_1 = require("./conferenceparticipantenumregionenum");
var conferenceparticipantenumjitterbuffersizeenum_1 = require("./conferenceparticipantenumjitterbuffersizeenum");
var conferenceparticipantenumprocessingstateenum_1 = require("./conferenceparticipantenumprocessingstateenum");
var InsightsV1ConferenceConferenceParticipant = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_direction" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_status" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=coached_participants" }),
        __metadata("design:type", Array)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "coachedParticipants", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conference_region" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_coach" }),
        __metadata("design:type", Boolean)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "isCoach", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_moderator" }),
        __metadata("design:type", Boolean)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "isModerator", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=jitter_buffer_size" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outbound_queue_length" }),
        __metadata("design:type", Number)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "outboundQueueLength", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outbound_time_in_queue" }),
        __metadata("design:type", Number)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "outboundTimeInQueue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=participant_region" }),
        __metadata("design:type", String)
...
exports.InsightsV1ConferenceConferenceParticipant = InsightsV1ConferenceConferenceParticipant;
