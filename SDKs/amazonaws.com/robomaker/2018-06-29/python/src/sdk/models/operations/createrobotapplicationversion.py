...
class CreateRobotApplicationVersionHeaders:
...
class CreateRobotApplicationVersionRequest:
    headers: CreateRobotApplicationVersionHeaders = dataclasses.field()
    request: CreateRobotApplicationVersionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
