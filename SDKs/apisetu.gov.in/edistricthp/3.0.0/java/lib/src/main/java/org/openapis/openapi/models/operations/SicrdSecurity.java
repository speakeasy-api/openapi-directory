...
public class SicrdSecurity {
    ...
    public SicrdSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SicrdSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SicrdSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
