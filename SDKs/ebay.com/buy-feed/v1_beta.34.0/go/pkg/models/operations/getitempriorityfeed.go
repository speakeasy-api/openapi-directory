...
type GetItemPriorityFeedSecurity struct {
	ClientCredentials shared.SchemeClientCredentials `security:"scheme,type=oauth2"`
}

type GetItemPriorityFeedQueryParams struct {
...
type GetItemPriorityFeedHeaders struct {
...
type GetItemPriorityFeedRequest struct {
	QueryParams GetItemPriorityFeedQueryParams
	Headers     GetItemPriorityFeedHeaders
	Security    GetItemPriorityFeedSecurity
}

type GetItemPriorityFeedResponse struct {
	Body        []byte
	ContentType string
