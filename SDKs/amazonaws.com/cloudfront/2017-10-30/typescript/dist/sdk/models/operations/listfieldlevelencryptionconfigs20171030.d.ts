...
export declare class ListFieldLevelEncryptionConfigs20171030Request extends SpeakeasyBase {
    /**
...
export declare class ListFieldLevelEncryptionConfigs20171030Response extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
