...
func (e *AgeRangeTargetingOptionDetailsAgeRangeEnum) UnmarshalJSON(data []byte) error {
	...
	case "AGE_RANGE_UNKNOWN":
		fallthrough
	case "AGE_RANGE_18_20":
		fallthrough
	case "AGE_RANGE_21_24":
		fallthrough
	case "AGE_RANGE_25_29":
		fallthrough
	case "AGE_RANGE_30_34":
		fallthrough
	case "AGE_RANGE_35_39":
		fallthrough
	case "AGE_RANGE_40_44":
		fallthrough
	case "AGE_RANGE_45_49":
		fallthrough
	case "AGE_RANGE_50_54":
		fallthrough
