...
from ..shared import cloudtasklistresult as shared_cloudtasklistresult
...
class TaskListResponse:
    ...
    cloud_task_list_result: Optional[shared_cloudtasklistresult.CloudTaskListResult] = dataclasses.field(default=None)  
