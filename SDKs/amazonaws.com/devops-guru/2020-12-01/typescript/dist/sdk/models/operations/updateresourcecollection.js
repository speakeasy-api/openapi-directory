...
exports.UpdateResourceCollectionResponse = exports.UpdateResourceCollectionRequest = exports.UpdateResourceCollectionRequestBody = exports.UpdateResourceCollectionRequestBodyResourceCollection = exports.UpdateResourceCollectionRequestBodyActionEnum = void 0;
...
var UpdateResourceCollectionRequestBodyResourceCollection = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.UpdateCloudFormationCollectionFilter; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.UpdateTagCollectionFilter }),
        (0, class_transformer_1.Expose)({ name: "Tags" }),
        (0, class_transformer_1.Type)(function () { return shared.UpdateTagCollectionFilter; }),
        __metadata("design:type", Array)
    ], UpdateResourceCollectionRequestBodyResourceCollection.prototype, "tags", void 0);
...
var UpdateResourceCollectionRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return UpdateResourceCollectionRequestBodyResourceCollection; }),
...
var UpdateResourceCollectionRequest = /** @class */ (function (_super) {
    ...
    ], UpdateResourceCollectionRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateResourceCollectionRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateResourceCollectionRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateResourceCollectionRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateResourceCollectionRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateResourceCollectionRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateResourceCollectionRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateResourceCollectionRequest.prototype, "xAmzSignedHeaders", void 0);
...
var UpdateResourceCollectionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateResourceCollectionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
