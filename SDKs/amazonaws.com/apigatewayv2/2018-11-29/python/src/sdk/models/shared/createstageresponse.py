...
class CreateStageResponseDefaultRouteSettingsLoggingLevelEnum(str, Enum):
...
class CreateStageResponseDefaultRouteSettings:
    ...
    logging_level: Optional[CreateStageResponseDefaultRouteSettingsLoggingLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LoggingLevel'), 'exclude': lambda f: f is None }})  
...
class CreateStageResponse:
    ...
    access_log_settings: Optional[CreateStageResponseAccessLogSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AccessLogSettings'), 'exclude': lambda f: f is None }})  
    ...
    default_route_settings: Optional[CreateStageResponseDefaultRouteSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DefaultRouteSettings'), 'exclude': lambda f: f is None }})  
