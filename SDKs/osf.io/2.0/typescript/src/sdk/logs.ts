...
export class Logs {
  ...
  logsActions(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.LogsActionsResponse =
        new operations.LogsActionsResponse({
  ...
  logsRead(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/logs/{log_id}/", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.LogsReadResponse = new operations.LogsReadResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
