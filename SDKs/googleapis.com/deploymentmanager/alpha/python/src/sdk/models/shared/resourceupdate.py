...
class ResourceUpdate:
    ...
    runtime_policies: Optional[list[ResourceUpdateRuntimePoliciesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('runtimePolicies'), 'exclude': lambda f: f is None }})
    r"""Output only. In case this is an action, it will show the runtimePolicies that this action will have after updating the deployment."""  
