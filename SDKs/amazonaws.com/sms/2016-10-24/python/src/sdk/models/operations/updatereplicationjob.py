...
class UpdateReplicationJobRequest:
    ...
    update_replication_job_request: shared_updatereplicationjobrequest.UpdateReplicationJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateReplicationJobResponse:
    ...
    r"""ReplicationJobNotFoundException"""  
