...
class GetAdvertiseByoipCidrQueryParams:
    action: GetAdvertiseByoipCidrActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cidr: str = dataclasses.field(metadata={'query_param': { 'field_name': 'Cidr', 'style': 'form', 'explode': True }})
    version: GetAdvertiseByoipCidrVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAdvertiseByoipCidrRequest:
    headers: GetAdvertiseByoipCidrHeaders = dataclasses.field()
    query_params: GetAdvertiseByoipCidrQueryParams = dataclasses.field()
