...
export class TravelpartnerAccountsFreeBookingLinksReportViewsQueryRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class TravelpartnerAccountsFreeBookingLinksReportViewsQueryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
