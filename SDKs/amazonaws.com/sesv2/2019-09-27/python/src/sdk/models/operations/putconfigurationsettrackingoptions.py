...
class PutConfigurationSetTrackingOptionsRequestBody:
    ...
    r"""The domain to use for tracking open and click events."""  
...
class PutConfigurationSetTrackingOptionsRequest:
    ...
    request_body: PutConfigurationSetTrackingOptionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
