...
export class ListHiTsForQualificationTypeQueryParams extends SpeakeasyBase {
...
export enum ListHiTsForQualificationTypeXAmzTargetEnum {
    MTurkRequesterServiceV20170117ListHiTsForQualificationType = "MTurkRequesterServiceV20170117.ListHITsForQualificationType"
}


export class ListHiTsForQualificationTypeHeaders extends SpeakeasyBase {
