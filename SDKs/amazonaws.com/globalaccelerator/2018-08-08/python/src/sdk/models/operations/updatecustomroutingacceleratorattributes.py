...
class UpdateCustomRoutingAcceleratorAttributesRequest:
    ...
    update_custom_routing_accelerator_attributes_request: shared_updatecustomroutingacceleratorattributesrequest.UpdateCustomRoutingAcceleratorAttributesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
