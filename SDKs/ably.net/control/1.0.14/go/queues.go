...
func (s *Queues) DeleteAppsAppIDQueuesQueueID(ctx context.Context, request operations.DeleteAppsAppIDQueuesQueueIDRequest) (*operations.DeleteAppsAppIDQueuesQueueIDResponse, error) {
...
func (s *Queues) GetAppsAppIDQueues(ctx context.Context, request operations.GetAppsAppIDQueuesRequest) (*operations.GetAppsAppIDQueuesResponse, error) {
	baseURL := s._serverURL
...
func (s *Queues) PostAppsAppIDQueues(ctx context.Context, request operations.PostAppsAppIDQueuesRequest) (*operations.PostAppsAppIDQueuesResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/apps/{app_id}/queues", request.PathParams)
