...
class CloudkmsProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsMacVerifyRequest:
    ...
    r"""Required. The resource name of the CryptoKeyVersion to use for verification."""  
    ...
    mac_verify_request: Optional[shared_macverifyrequest.MacVerifyRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
