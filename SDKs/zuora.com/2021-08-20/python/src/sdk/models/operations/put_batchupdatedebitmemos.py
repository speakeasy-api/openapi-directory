...
class PUTBatchUpdateDebitMemosRequest:
    ...
    put_batch_debit_memos_request: shared_putbatchdebitmemosrequest.PUTBatchDebitMemosRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
