...
export enum GETCreateAccessKeyActionEnum {
  CreateAccessKey = "CreateAccessKey",
}

export enum GETCreateAccessKeyVersionEnum {
  TwoThousandAndTen0508 = "2010-05-08",
}

export class GETCreateAccessKeyRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETCreateAccessKeyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
