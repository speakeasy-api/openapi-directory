...
class PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedRequestBodyConstraints:
...
class PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedRequestBodySubsetPortfoliosAggregationMethodEnum(str, Enum):
    r"""The method to aggregate the subset portfolios"""
    AVERAGE = 'average'
    MEDIAN = 'median'

class PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedRequestBodySubsetPortfoliosEnumerationMethodEnum(str, Enum):
...
class PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
    ...
    subset_portfolios_aggregation_method: Optional[PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedRequestBodySubsetPortfoliosAggregationMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subsetPortfoliosAggregationMethod'), 'exclude': lambda f: f is None }})
    r"""The method to aggregate the subset portfolios"""  
    subset_portfolios_enumeration_method: Optional[PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedRequestBodySubsetPortfoliosEnumerationMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subsetPortfoliosEnumerationMethod'), 'exclude': lambda f: f is None }})
    r"""The method to enumerate the subset portfolios"""  
...
class PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBasedResponse:
    ...
    post_portfolio_optimization_maximum_sharpe_ratio_subset_resampling_based_200_application_json_object: Optional[PostPortfolioOptimizationMaximumSharpeRatioSubsetResamplingBased200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
