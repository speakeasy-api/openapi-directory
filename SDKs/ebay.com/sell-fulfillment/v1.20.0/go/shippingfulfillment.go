...
func (s *shippingFulfillment) CreateShippingFulfillment(ctx context.Context, request operations.CreateShippingFulfillmentRequest, security operations.CreateShippingFulfillmentSecurity) (*operations.CreateShippingFulfillmentResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/order/{orderId}/shipping_fulfillment", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}

	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ShippingFulfillmentDetails", "json")
	if err != nil {
...
func (s *shippingFulfillment) GetShippingFulfillment(ctx context.Context, request operations.GetShippingFulfillmentRequest, security operations.GetShippingFulfillmentSecurity) (*operations.GetShippingFulfillmentResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/order/{orderId}/shipping_fulfillment/{fulfillmentId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *shippingFulfillment) GetShippingFulfillments(ctx context.Context, request operations.GetShippingFulfillmentsRequest, security operations.GetShippingFulfillmentsSecurity) (*operations.GetShippingFulfillmentsResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/order/{orderId}/shipping_fulfillment", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
