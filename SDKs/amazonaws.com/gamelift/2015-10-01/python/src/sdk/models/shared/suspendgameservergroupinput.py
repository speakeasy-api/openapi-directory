...
class SuspendGameServerGroupInput:
    ...
    suspend_actions: list[shared_gameservergroupaction_enum.GameServerGroupActionEnum] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SuspendActions') }})  
