...
@dataclasses.dataclass
class DfareportingFloodlightActivityGroupsListQueryParams:
...
class DfareportingFloodlightActivityGroupsListRequest:
    path_params: DfareportingFloodlightActivityGroupsListPathParams = dataclasses.field()
    query_params: DfareportingFloodlightActivityGroupsListQueryParams = dataclasses.field()
    security: DfareportingFloodlightActivityGroupsListSecurity = dataclasses.field()
