...
class UpdateOrganizationAdminRequestBodyTags
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\UpdateOrganizationAdminRequestBodyTagsAccessEnum $access
     */
	#[\JMS\Serializer\Annotation\SerializedName('access')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\UpdateOrganizationAdminRequestBodyTagsAccessEnum>')]
	...
	{
		$this->access = \OpenAPI\OpenAPI\Models\Operations\UpdateOrganizationAdminRequestBodyTagsAccessEnum::FULL;
		$this->tag = "";
	}
}
