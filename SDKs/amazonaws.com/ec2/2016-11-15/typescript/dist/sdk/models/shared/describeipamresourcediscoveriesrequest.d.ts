 ...
 */
export declare class DescribeIpamResourceDiscoveriesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeIpamResourceDiscoveriesRequest extends SpeakeasyBase {
    dryRun?: boolean;
