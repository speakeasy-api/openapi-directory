...
from ..shared import modelcardsortby_enum as shared_modelcardsortby_enum
...
class ListModelCardsRequest:
    ...
    sort_by: Optional[shared_modelcardsortby_enum.ModelCardSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
