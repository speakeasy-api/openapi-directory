...
public class DownloadFileViaTokenPublic1QueryParams {
    /**
    ...
    public DownloadFileViaTokenPublic1QueryParams withGenericMimetype(Boolean genericMimetype) {
    ...
    public DownloadFileViaTokenPublic1QueryParams withInline(Boolean inline) {
        this.inline = inline;
        return this;
    }
