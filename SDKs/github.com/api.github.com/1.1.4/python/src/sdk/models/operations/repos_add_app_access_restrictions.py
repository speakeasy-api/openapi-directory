...
class ReposAddAppAccessRestrictionsRequest:
    path_params: ReposAddAppAccessRestrictionsPathParams = dataclasses.field()
    request: Optional[ReposAddAppAccessRestrictionsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
