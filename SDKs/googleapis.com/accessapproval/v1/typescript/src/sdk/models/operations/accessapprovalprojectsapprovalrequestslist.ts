...
export class AccessapprovalProjectsApprovalRequestsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AccessapprovalProjectsApprovalRequestsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AccessapprovalProjectsApprovalRequestsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
