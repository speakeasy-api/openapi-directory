 ...
 */
public enum TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum {
    ...
    private TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum(String value) {
        this.value = value;
    }
}
