...
var StudentSubmission = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=assignedGrade" }),
        __metadata("design:type", Number)
    ], StudentSubmission.prototype, "assignedGrade", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=assignmentSubmission" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=courseWorkId" }),
        __metadata("design:type", String)
    ], StudentSubmission.prototype, "courseWorkId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=courseWorkType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=late" }),
        __metadata("design:type", Boolean)
    ], StudentSubmission.prototype, "late", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=multipleChoiceSubmission" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=shortAnswerSubmission" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=submissionHistory", elemType: submissionhistory_1.SubmissionHistory }),
