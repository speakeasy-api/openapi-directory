...
class GetPlanByTokenRequest:
    ...
    r"""The identifier of the user provided by BT in an initial URL."""  
...
class GetPlanByTokenResponse:
    ...
    bt_plan_list_item: Optional[shared_btplanlistitem.BtPlanListItem] = dataclasses.field(default=None)
