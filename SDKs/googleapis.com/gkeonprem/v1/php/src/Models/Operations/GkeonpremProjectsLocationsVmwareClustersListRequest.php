...
class GkeonpremProjectsLocationsVmwareClustersListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GkeonpremProjectsLocationsVmwareClustersListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?GkeonpremProjectsLocationsVmwareClustersListViewEnum $view = null;
