...
public class UpdateNetworkWirelessSsidIdentityPskRequest {
    ...
    public UpdateNetworkWirelessSsidIdentityPskRequest(@JsonProperty("identityPskId") String identityPskId, @JsonProperty("networkId") String networkId, @JsonProperty("number") String number) {
        this.identityPskId = identityPskId;
        this.networkId = networkId;
        this.number = number;
  }
