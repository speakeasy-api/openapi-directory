...
class Images:
    ...
    def get_images_json(self, request: operations.GetImagesJSONRequest) -> operations.GetImagesJSONResponse:
        ...
        res = operations.GetImagesJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ImageInfo])
                res.image_info = out
    ...
    def get_images_name_or_id_json(self, request: operations.GetImagesNameOrIDJSONRequest) -> operations.GetImagesNameOrIDJSONResponse:
        ...
        url = utils.generate_url(operations.GetImagesNameOrIDJSONRequest, base_url, '/images/{name_or_id}/json', request)
        ...
        res = operations.GetImagesNameOrIDJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ImageDetail])
    ...
    def post_build(self, request: operations.PostBuildRequest) -> operations.PostBuildResponse:
        ...
        query_params = utils.get_query_params(operations.PostBuildRequest, request)
        ...
        res = operations.PostBuildResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
