...
from ..shared import getemployeeschedulesresponse as shared_getemployeeschedulesresponse
...
class EmployeeSchedulesAllRequest:
    headers: EmployeeSchedulesAllHeaders = dataclasses.field()
    path_params: EmployeeSchedulesAllPathParams = dataclasses.field()
    query_params: EmployeeSchedulesAllQueryParams = dataclasses.field()
    security: EmployeeSchedulesAllSecurity = dataclasses.field()
...
class EmployeeSchedulesAllResponse:
    ...
    get_employee_schedules_response: Optional[shared_getemployeeschedulesresponse.GetEmployeeSchedulesResponse] = dataclasses.field(default=None)
