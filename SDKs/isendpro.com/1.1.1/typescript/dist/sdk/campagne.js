...
var Campagne = /** @class */ (function () {
    function Campagne(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Campagne.prototype.getCampagne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCampagneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/campagne";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getCampagne200ApplicationJSONBinaryString = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
