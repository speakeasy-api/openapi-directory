...
var Notifications = /** @class */ (function () {
    ...
    **/
    Notifications.prototype.storageNotificationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StorageNotificationsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/b/{bucket}/notificationConfigs/{notification}", req.pathParams);
    ...
    **/
    Notifications.prototype.storageNotificationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.notification = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Notifications.prototype.storageNotificationsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StorageNotificationsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/b/{bucket}/notificationConfigs", req.pathParams);
    ...
    **/
    Notifications.prototype.storageNotificationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
