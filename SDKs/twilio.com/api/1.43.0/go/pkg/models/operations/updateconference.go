...
func (e UpdateConferenceUpdateConferenceRequestAnnounceMethodEnum) ToPointer() *UpdateConferenceUpdateConferenceRequestAnnounceMethodEnum {
	return &e
}
...
func (e *UpdateConferenceUpdateConferenceRequestAnnounceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateConferenceUpdateConferenceRequestAnnounceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateConferenceUpdateConferenceRequestAnnounceMethodEnum: %v", v)
	}
}
