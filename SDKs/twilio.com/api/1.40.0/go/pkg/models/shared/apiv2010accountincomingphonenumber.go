...
func (e *APIV2010AccountIncomingPhoneNumberSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountIncomingPhoneNumberSmsFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountIncomingPhoneNumberSmsFallbackMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountIncomingPhoneNumberSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountIncomingPhoneNumberSmsMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountIncomingPhoneNumberSmsMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountIncomingPhoneNumberStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountIncomingPhoneNumberStatusCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountIncomingPhoneNumberStatusCallbackMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountIncomingPhoneNumberVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountIncomingPhoneNumberVoiceFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountIncomingPhoneNumberVoiceFallbackMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountIncomingPhoneNumberVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountIncomingPhoneNumberVoiceMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountIncomingPhoneNumberVoiceMethodEnum: %s", s)
	}
}
