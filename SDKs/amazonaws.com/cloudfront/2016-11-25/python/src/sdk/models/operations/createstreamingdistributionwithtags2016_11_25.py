...
class CreateStreamingDistributionWithTags20161125Request:
    headers: CreateStreamingDistributionWithTags20161125Headers = dataclasses.field()
    query_params: CreateStreamingDistributionWithTags20161125QueryParams = dataclasses.field()
