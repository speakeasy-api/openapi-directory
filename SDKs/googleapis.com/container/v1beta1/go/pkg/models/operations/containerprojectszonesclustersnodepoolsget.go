...
type ContainerProjectsZonesClustersNodePoolsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsZonesClustersNodePoolsGetPathParams struct {
...
type ContainerProjectsZonesClustersNodePoolsGetQueryParams struct {
	// V1 error format.
...
type ContainerProjectsZonesClustersNodePoolsGetRequest struct {
...
type ContainerProjectsZonesClustersNodePoolsGetResponse struct {
	ContentType string
	// Successful response
