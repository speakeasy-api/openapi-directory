...
class ListServiceConversationMessageRequest:
    ...
    r"""The unique ID of the [Conversation](https://www.twilio.com/docs/conversations/api/conversation-resource) for messages."""  
...
class ListServiceConversationMessageListServiceConversationMessageResponse:
    ...
    messages: Optional[list[shared_conversations_v1_service_service_conversation_service_conversation_message.ConversationsV1ServiceServiceConversationServiceConversationMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messages'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListServiceConversationMessageListServiceConversationMessageResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
