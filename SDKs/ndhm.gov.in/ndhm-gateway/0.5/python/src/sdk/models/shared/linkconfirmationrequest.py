...
class LinkConfirmationRequestConfirmation:
    ...
    link_ref_number: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('linkRefNumber') }})  
...
class LinkConfirmationRequest:
    ...
    confirmation: LinkConfirmationRequestConfirmation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation') }})  
