...
class AdsenseAccountsReportsGenerateCsvRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateCsvDateRangeEnum $dateRange
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=dateRange')]
    public ?AdsenseAccountsReportsGenerateCsvDateRangeEnum $dateRange = null;
    
    /**
     * Dimensions to base the report on.
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateCsvDimensionsEnum> $dimensions
     */
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateCsvMetricsEnum> $metrics
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AdsenseAccountsReportsGenerateCsvReportingTimeZoneEnum $reportingTimeZone
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=reportingTimeZone')]
    public ?AdsenseAccountsReportsGenerateCsvReportingTimeZoneEnum $reportingTimeZone = null;
