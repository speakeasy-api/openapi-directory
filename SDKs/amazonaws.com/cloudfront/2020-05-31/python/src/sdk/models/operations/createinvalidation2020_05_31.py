...
@dataclasses.dataclass
class CreateInvalidation20200531Headers:
...
class CreateInvalidation20200531Request:
    headers: CreateInvalidation20200531Headers = dataclasses.field()
    path_params: CreateInvalidation20200531PathParams = dataclasses.field()
