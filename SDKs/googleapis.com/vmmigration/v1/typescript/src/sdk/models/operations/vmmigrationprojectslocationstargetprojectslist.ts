...
export class VmmigrationProjectsLocationsTargetProjectsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsTargetProjectsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VmmigrationProjectsLocationsTargetProjectsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
