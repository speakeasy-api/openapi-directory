...
class GETDeleteClientVpnRouteRequest:
    ...
    r"""The ID of the Client VPN endpoint from which the route is to be deleted."""  
    ...
    r"""The IPv4 address range, in CIDR notation, of the route to be deleted."""  
    ...
    r"""The ID of the target subnet used by the route."""  
