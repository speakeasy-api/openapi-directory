...
public class GetActivePayInstructionsReportOutputRequest {
    ...
    public GetActivePayInstructionsReportOutputRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployeeKey") String employeeKey, @JsonProperty("EmployerKey") String employerKey, @JsonProperty("FromDate") LocalDate fromDate) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employeeKey = employeeKey;
        this.employerKey = employerKey;
