...
export class RunNamespacesRoutesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesRoutesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesRoutesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
