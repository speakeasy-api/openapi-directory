...
from ..shared import participant_conversation_enum_state_enum as shared_participant_conversation_enum_state_enum
...
class ConversationsV1ParticipantConversation:
    ...
    conversation_state: Optional[shared_participant_conversation_enum_state_enum.ParticipantConversationEnumStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('conversation_state') }})
