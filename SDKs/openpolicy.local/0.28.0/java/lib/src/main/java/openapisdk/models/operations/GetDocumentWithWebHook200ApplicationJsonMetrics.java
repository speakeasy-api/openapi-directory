...
public class GetDocumentWithWebHook200ApplicationJsonMetrics {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("counter_server_query_cache_hit")
    public Double counterServerQueryCacheHit;
    public GetDocumentWithWebHook200ApplicationJsonMetrics withCounterServerQueryCacheHit(Double counterServerQueryCacheHit) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageBuildComprehensionIndexNs(Double timerQueryCompileStageBuildComprehensionIndexNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageCheckSafetyNs(Double timerQueryCompileStageCheckSafetyNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageCheckTypesNs(Double timerQueryCompileStageCheckTypesNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageCheckUndefinedFuncsNs(Double timerQueryCompileStageCheckUndefinedFuncsNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageCheckUnsafeBuiltinsNs(Double timerQueryCompileStageCheckUnsafeBuiltinsNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageResolveRefsNs(Double timerQueryCompileStageResolveRefsNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageRewriteComprehensionTermsNs(Double timerQueryCompileStageRewriteComprehensionTermsNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageRewriteDynamicTermsNs(Double timerQueryCompileStageRewriteDynamicTermsNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageRewriteExprTermsNs(Double timerQueryCompileStageRewriteExprTermsNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageRewriteLocalVarsNs(Double timerQueryCompileStageRewriteLocalVarsNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageRewriteToCaptureValueNs(Double timerQueryCompileStageRewriteToCaptureValueNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerQueryCompileStageRewriteWithValuesNs(Double timerQueryCompileStageRewriteWithValuesNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerRegoInputParseNs(Double timerRegoInputParseNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerRegoModuleCompileNs(Double timerRegoModuleCompileNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerRegoModuleParseNs(Double timerRegoModuleParseNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerRegoQueryCompileNs(Double timerRegoQueryCompileNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerRegoQueryEvalNs(Double timerRegoQueryEvalNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerRegoQueryParseNs(Double timerRegoQueryParseNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerServerHandlerNs(Double timerServerHandlerNs) {
    ...
    public GetDocumentWithWebHook200ApplicationJsonMetrics withTimerServerReadBytesNs(Double timerServerReadBytesNs) {
