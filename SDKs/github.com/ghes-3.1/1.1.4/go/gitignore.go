...
// https://docs.github.com/enterprise-server@3.1/rest/reference/gitignore#get-all-gitignore-templates - API method documentation
...
// https://docs.github.com/enterprise-server@3.1/rest/reference/gitignore#get-a-gitignore-template - API method documentation
