...
class DescribeInstanceTypeOfferingsResultInstanceTypeOfferingsInstanceTypeEnum(str, Enum):
...
class DescribeInstanceTypeOfferingsResultInstanceTypeOfferingsLocationTypeEnum(str, Enum):
    r"""The location type."""
    REGION = 'region'
...
class DescribeInstanceTypeOfferingsResultInstanceTypeOfferings:
    r"""The instance types offered."""
    
    instance_type: Optional[DescribeInstanceTypeOfferingsResultInstanceTypeOfferingsInstanceTypeEnum] = dataclasses.field(default=None)  
    location: Optional[str] = dataclasses.field(default=None)  
    location_type: Optional[DescribeInstanceTypeOfferingsResultInstanceTypeOfferingsLocationTypeEnum] = dataclasses.field(default=None)  
...
class DescribeInstanceTypeOfferingsResult:
    ...
    instance_type_offerings: Optional[list[DescribeInstanceTypeOfferingsResultInstanceTypeOfferings]] = dataclasses.field(default=None)  
