...
func (e BatchGetCrawlersXAmzTargetEnum) ToPointer() *BatchGetCrawlersXAmzTargetEnum {
	return &e
}
...
func (e *BatchGetCrawlersXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSGlue.BatchGetCrawlers":
		*e = BatchGetCrawlersXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BatchGetCrawlersXAmzTargetEnum: %v", v)
	}
}
