...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_chat_v2_service.ChatV2Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('services') }})
