...
class AdminConfirmSignUpRequest:
    ...
    admin_confirm_sign_up_request: shared_adminconfirmsignuprequest.AdminConfirmSignUpRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
