...
var NumberValidateResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CleansedPhoneNumberE164" }),
        __metadata("design:type", String)
    ], NumberValidateResponse.prototype, "cleansedPhoneNumberE164", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CleansedPhoneNumberNational" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CountryCodeIso2" }),
        __metadata("design:type", String)
    ], NumberValidateResponse.prototype, "countryCodeIso2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CountryCodeNumeric" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "OriginalCountryCodeIso2" }),
        __metadata("design:type", String)
    ], NumberValidateResponse.prototype, "originalCountryCodeIso2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "OriginalPhoneNumber" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "PhoneTypeCode" }),
