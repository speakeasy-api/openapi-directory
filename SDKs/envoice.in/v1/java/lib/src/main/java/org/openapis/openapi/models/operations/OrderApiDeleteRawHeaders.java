...
public class OrderApiDeleteRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiDeleteRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiDeleteRawHeaders withXAuthSecret(String xAuthSecret) {
