...
exports.GetDeviceWirelessLatencyStatsResponse = exports.GetDeviceWirelessLatencyStatsRequest = exports.GetDeviceWirelessLatencyStatsBandEnum = void 0;
...
(function (GetDeviceWirelessLatencyStatsBandEnum) {
    ...
    GetDeviceWirelessLatencyStatsBandEnum["Six"] = "6";
...
var GetDeviceWirelessLatencyStatsRequest = /** @class */ (function (_super) {
    ...
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "apTag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=band" }),
        __metadata("design:type", String)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "band", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=serial",
        }),
        __metadata("design:type", String)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "serial", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ssid" }),
        __metadata("design:type", Number)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "ssid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t0" }),
        __metadata("design:type", String)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "t0", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t1" }),
        __metadata("design:type", String)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "t1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timespan",
        }),
        __metadata("design:type", Number)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "timespan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=vlan" }),
        __metadata("design:type", Number)
    ], GetDeviceWirelessLatencyStatsRequest.prototype, "vlan", void 0);
...
var GetDeviceWirelessLatencyStatsResponse = /** @class */ (function (_super) {
    ...
    ], GetDeviceWirelessLatencyStatsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
