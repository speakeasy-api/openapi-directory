...
export declare class ChatSpacesMessagesDeleteSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesMessagesDeleteSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesMessagesDeleteSecurity extends SpeakeasyBase {
    option1?: ChatSpacesMessagesDeleteSecurityOption1;
    option2?: ChatSpacesMessagesDeleteSecurityOption2;
}
