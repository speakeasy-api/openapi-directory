...
type ListInvalidations20171030PathParams struct {
	// The distribution's ID.
	DistributionID string `pathParam:"style=simple,explode=false,name=DistributionId"`
}

type ListInvalidations20171030QueryParams struct {
...
type ListInvalidations20171030Headers struct {
...
type ListInvalidations20171030Request struct {
...
type ListInvalidations20171030Response struct {
	Body        []byte
	ContentType string
	StatusCode  int
