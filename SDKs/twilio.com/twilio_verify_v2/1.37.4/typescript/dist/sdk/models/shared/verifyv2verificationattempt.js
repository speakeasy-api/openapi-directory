...
exports.VerifyV2VerificationAttempt = void 0;
var utils_1 = require("../../../internal/utils");
var verificationattemptenumchannelsenum_1 = require("./verificationattemptenumchannelsenum");
var verificationattemptenumconversionstatusenum_1 = require("./verificationattemptenumconversionstatusenum");
var VerifyV2VerificationAttempt = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=channel_data" }),
        __metadata("design:type", Object)
    ], VerifyV2VerificationAttempt.prototype, "channelData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conversion_status" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=verification_sid" }),
        __metadata("design:type", String)
    ], VerifyV2VerificationAttempt.prototype, "verificationSid", void 0);
    return VerifyV2VerificationAttempt;
}(utils_1.SpeakeasyBase));
exports.VerifyV2VerificationAttempt = VerifyV2VerificationAttempt;
