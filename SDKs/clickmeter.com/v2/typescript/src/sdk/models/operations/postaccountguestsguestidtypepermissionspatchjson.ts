 ...
 */
export enum PostAccountGuestsGuestIdTypePermissionsPatchJsonTypeEnum {
  Datapoint = "datapoint",
  Group = "group",
}

export class PostAccountGuestsGuestIdTypePermissionsPatchJsonRequest extends SpeakeasyBase {
  /**
...
export class PostAccountGuestsGuestIdTypePermissionsPatchJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
