...
class CheckinNetworkSmDevicesRequestBody:
    ...
    r"""The ids of the devices to be checked-in."""  
    ...
    r"""The scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags of the devices to be checked-in."""  
    ...
    r"""The serials of the devices to be checked-in."""  
    ...
    r"""The wifiMacs of the devices to be checked-in."""  
...
class CheckinNetworkSmDevicesRequest:
    ...
    request_body: Optional[CheckinNetworkSmDevicesRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class CheckinNetworkSmDevicesResponse:
    ...
    checkin_network_sm_devices_200_application_json_object: Optional[CheckinNetworkSmDevices200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
