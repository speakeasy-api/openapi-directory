...
class ReleasesGetLatestByDistributionGroupRequest:
    ...
    r"""Also supports the constant `latest`, which will return the latest release in the distribution group."""  
...
class ReleasesGetLatestByDistributionGroup501ApplicationJSONCodeEnum(str, Enum):
...
class ReleasesGetLatestByDistributionGroup501ApplicationJSON:
    r"""Requesting a specific release_id is not supported."""
    
    code: ReleasesGetLatestByDistributionGroup501ApplicationJSONCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
    
class ReleasesGetLatestByDistributionGroup404ApplicationJSONCodeEnum(str, Enum):
    BAD_REQUEST = 'BadRequest'
    CONFLICT = 'Conflict'
    NOT_ACCEPTABLE = 'NotAcceptable'
    NOT_FOUND = 'NotFound'
...
class ReleasesGetLatestByDistributionGroup404ApplicationJSON:
    ...
    code: ReleasesGetLatestByDistributionGroup404ApplicationJSONCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
...
class ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinationTypeEnum(str, Enum):
...
class ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinationsDestinationTypeEnum(str, Enum):
    r"""Destination can be either store or group."""
    GROUP = 'group'
    STORE = 'store'
    TESTER = 'tester'

class ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinationsTypeEnum(str, Enum):
...
class ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinations:
    ...
    destination_type: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinationsDestinationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destination_type'), 'exclude': lambda f: f is None }})
    r"""Destination can be either store or group."""  
    ...
    type: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinationsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""  
...
class ReleasesGetLatestByDistributionGroup200ApplicationJSONDistributionStoresTypeEnum(str, Enum):
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""
    INTUNE = 'intune'
    GOOGLEPLAY = 'googleplay'
    APPLE = 'apple'
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ReleasesGetLatestByDistributionGroup200ApplicationJSONDistributionStores:
    ...
    publishing_status: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('publishing_status'), 'exclude': lambda f: f is None }})
    r"""publishing status of the release in the store."""  
    type: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSONDistributionStoresTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""type of the distribution store currently stores type can be intune, googleplay or windows."""  
    
class ReleasesGetLatestByDistributionGroup200ApplicationJSONOriginEnum(str, Enum):
    r"""The release's origin"""
    HOCKEYAPP = 'hockeyapp'
    APPCENTER = 'appcenter'

class ReleasesGetLatestByDistributionGroup200ApplicationJSONProvisioningProfileTypeEnum(str, Enum):
...
class ReleasesGetLatestByDistributionGroup200ApplicationJSON:
    ...
    r"""The app's OS."""  
    build: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSONBuild] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('build'), 'exclude': lambda f: f is None }})
    r"""Contains metadata about the build that produced the release being uploaded"""  
    ...
    destination_type: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destination_type'), 'exclude': lambda f: f is None }})
    r"""OBSOLETE. Will be removed in next version. The destination type.<br>
    <b>group</b>: The release distributed to internal groups and distribution_groups details will be returned.<br>
    <b>store</b>: The release distributed to external stores and distribution_stores details will be returned.<br>
    <b>tester</b>: The release distributed testers details will be returned.<br>
    """  
    destinations: Optional[list[ReleasesGetLatestByDistributionGroup200ApplicationJSONDestinations]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('destinations'), 'exclude': lambda f: f is None }})
    ...
    distribution_groups: Optional[list[ReleasesGetLatestByDistributionGroup200ApplicationJSONDistributionGroups]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distribution_groups'), 'exclude': lambda f: f is None }})
    r"""OBSOLETE. Will be removed in next version. A list of distribution groups that are associated with this release."""  
    distribution_stores: Optional[list[ReleasesGetLatestByDistributionGroup200ApplicationJSONDistributionStores]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('distribution_stores'), 'exclude': lambda f: f is None }})
    ...
    origin: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSONOriginEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin'), 'exclude': lambda f: f is None }})
    r"""The release's origin"""  
    ...
    provisioning_profile_type: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSONProvisioningProfileTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('provisioning_profile_type'), 'exclude': lambda f: f is None }})
    r"""The type of the provisioning profile for the requested app version."""  
...
class ReleasesGetLatestByDistributionGroupResponse:
    ...
    releases_get_latest_by_distribution_group_200_application_json_object: Optional[ReleasesGetLatestByDistributionGroup200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    releases_get_latest_by_distribution_group_404_application_json_object: Optional[ReleasesGetLatestByDistributionGroup404ApplicationJSON] = dataclasses.field(default=None)
    r"""Error Codes:
    - `not_found` - Distribution group or the app doesn't exist
    - `no_releases_for_app` - App has no releases.
    """  
    releases_get_latest_by_distribution_group_501_application_json_object: Optional[ReleasesGetLatestByDistributionGroup501ApplicationJSON] = dataclasses.field(default=None)
    r"""Requesting a specific release_id is not supported."""  
