...
public class Sla {
	...
	public Sla(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.CalculateSLAResponse calculateSLA(org.openapis.openapi.models.operations.CalculateSLARequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/api/logistics/pvt/shipping/calculate");
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ...
                org.openapis.openapi.models.operations.CalculateSLA200ApplicationJSON[][] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.CalculateSLA200ApplicationJSON[][].class);
