 ...
 */
export class NodesProvidersListFileAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class NodesProvidersListFileLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesProvidersListFileRelationships extends SpeakeasyBase {
  /**
...
export class NodesProvidersListFile extends SpeakeasyBase {
  /**
   * The properties of the file entity.
   */
  @SpeakeasyMetadata()
