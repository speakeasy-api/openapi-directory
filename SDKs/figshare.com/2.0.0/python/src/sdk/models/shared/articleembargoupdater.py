...
class ArticleEmbargoUpdater:
    embargo_date: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('embargo_date') }})
    embargo_type: ArticleEmbargoUpdaterEmbargoTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('embargo_type') }})
    is_embargoed: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('is_embargoed') }})
