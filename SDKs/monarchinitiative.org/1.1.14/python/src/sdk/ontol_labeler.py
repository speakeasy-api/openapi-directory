...
class OntolLabeler:
    ...
    def get_ontol_labeler_resource(self, request: operations.GetOntolLabelerResourceRequest) -> operations.GetOntolLabelerResourceResponse:
        ...
        query_params = utils.get_query_params(operations.GetOntolLabelerResourceRequest, request)
        ...
        res = operations.GetOntolLabelerResourceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
