...
from ..shared import queryfreebookinglinksreportresponse as shared_queryfreebookinglinksreportresponse
from typing import Optional


@dataclasses.dataclass
class TravelpartnerAccountsFreeBookingLinksReportViewsQueryRequest:
    ...
    r"""Specifies how to segment the metrics returned by the query. For example, if `userRegionCode` is specified, the `freeBookingLinksResult` will provide metrics aggregated by user region. The string value is a comma-separated list of fields. Valid fields are: `date`, `userRegionCode`, `deviceType`, `partnerHotelId`, and `partnerHotelDisplayName`. Only fields specified here are included in the FreeBookingLinksResult."""  
...
@dataclasses.dataclass
class TravelpartnerAccountsFreeBookingLinksReportViewsQueryResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    query_free_booking_links_report_response: Optional[shared_queryfreebookinglinksreportresponse.QueryFreeBookingLinksReportResponse] = dataclasses.field(default=None)
