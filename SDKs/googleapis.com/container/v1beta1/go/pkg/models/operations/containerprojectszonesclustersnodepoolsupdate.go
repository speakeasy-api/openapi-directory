...
type ContainerProjectsZonesClustersNodePoolsUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsZonesClustersNodePoolsUpdatePathParams struct {
...
type ContainerProjectsZonesClustersNodePoolsUpdateQueryParams struct {
	// V1 error format.
...
type ContainerProjectsZonesClustersNodePoolsUpdateRequest struct {
	...
	Request     *shared.UpdateNodePoolRequest `request:"mediaType=application/json"`
	Security    ContainerProjectsZonesClustersNodePoolsUpdateSecurity
}

type ContainerProjectsZonesClustersNodePoolsUpdateResponse struct {
	ContentType string
	// Successful response
