...
class DeleteVpcPeeringAuthorizationResponse
{
     ...
     * Success
     * 
     * @var ?array<string, mixed> $deleteVpcPeeringAuthorizationOutput
     */
	
    public ?array $deleteVpcPeeringAuthorizationOutput = null;
	...
	{
		$this->contentType = "";
		$this->deleteVpcPeeringAuthorizationOutput = null;
