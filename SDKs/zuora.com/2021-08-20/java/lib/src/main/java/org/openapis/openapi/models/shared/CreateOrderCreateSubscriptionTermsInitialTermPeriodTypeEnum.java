 ...
 * 
 */
public enum CreateOrderCreateSubscriptionTermsInitialTermPeriodTypeEnum {
    MONTH("Month"),
    YEAR("Year"),
    DAY("Day"),
    WEEK("Week");
    ...
    private CreateOrderCreateSubscriptionTermsInitialTermPeriodTypeEnum(String value) {
        this.value = value;
    }
}
