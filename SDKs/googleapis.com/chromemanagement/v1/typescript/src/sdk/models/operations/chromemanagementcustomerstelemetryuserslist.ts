...
export class ChromemanagementCustomersTelemetryUsersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ChromemanagementCustomersTelemetryUsersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ChromemanagementCustomersTelemetryUsersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
