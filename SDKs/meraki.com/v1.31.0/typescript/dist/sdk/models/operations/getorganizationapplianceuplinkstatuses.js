...
exports.GetOrganizationApplianceUplinkStatusesResponse = exports.GetOrganizationApplianceUplinkStatusesRequest = void 0;
...
var GetOrganizationApplianceUplinkStatusesRequest = /** @class */ (function (_super) {
    ...
    ], GetOrganizationApplianceUplinkStatusesRequest.prototype, "endingBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=iccids",
        }),
        __metadata("design:type", Array)
    ], GetOrganizationApplianceUplinkStatusesRequest.prototype, "iccids", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=networkIds",
        }),
        __metadata("design:type", Array)
    ], GetOrganizationApplianceUplinkStatusesRequest.prototype, "networkIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=organizationId",
        }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceUplinkStatusesRequest.prototype, "organizationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=perPage",
        }),
        __metadata("design:type", Number)
    ], GetOrganizationApplianceUplinkStatusesRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=serials",
        }),
        __metadata("design:type", Array)
    ], GetOrganizationApplianceUplinkStatusesRequest.prototype, "serials", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startingAfter",
        }),
        __metadata("design:type", String)
    ], GetOrganizationApplianceUplinkStatusesRequest.prototype, "startingAfter", void 0);
...
var GetOrganizationApplianceUplinkStatusesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetOrganizationApplianceUplinkStatusesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Array)
    ], GetOrganizationApplianceUplinkStatusesResponse.prototype, "getOrganizationApplianceUplinkStatuses200ApplicationJSONObjects", void 0);
