...
class PutResourceAttributesRequest:
    ...
    put_resource_attributes_request: shared_putresourceattributesrequest.PutResourceAttributesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
