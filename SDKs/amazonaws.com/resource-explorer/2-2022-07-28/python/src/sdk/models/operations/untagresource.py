...
class UntagResourceRequest:
    ...
    r"""The Amazon Resource Name (ARN) of the view or index that you want to remove tags from."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""A list of the keys for the tags that you want to remove from the specified view or index."""  
