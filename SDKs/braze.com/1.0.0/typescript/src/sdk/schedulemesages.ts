...
export class ScheduleMesages {
  ...
  getUpcomingScheduledCampaignsAndCanvases(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/messages/scheduled_broadcasts";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetUpcomingScheduledCampaignsAndCanvasesResponse =
        new operations.GetUpcomingScheduledCampaignsAndCanvasesResponse({
  ...
  scheduleApiTriggeredCanvases(
    req: operations.ScheduleApiTriggeredCanvasesRequestBody,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/canvas/trigger/schedule/create";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ScheduleApiTriggeredCanvasesResponse =
        new operations.ScheduleApiTriggeredCanvasesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
