...
class GetVariantGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetVariantGeneAssociationsQueryParams:
...
class GetVariantGeneAssociationsRequest:
    path_params: GetVariantGeneAssociationsPathParams = dataclasses.field()
    query_params: GetVariantGeneAssociationsQueryParams = dataclasses.field()
