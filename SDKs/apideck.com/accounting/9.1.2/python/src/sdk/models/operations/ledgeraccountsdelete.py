...
from ..shared import deleteledgeraccountresponse as shared_deleteledgeraccountresponse
...
class LedgerAccountsDeleteResponse:
    ...
    r"""Bad Request"""  
    delete_ledger_account_response: Optional[shared_deleteledgeraccountresponse.DeleteLedgerAccountResponse] = dataclasses.field(default=None)
