...
public class UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRules {
    ...
    public UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRules(@JsonProperty("destCidr") String destCidr, @JsonProperty("policy") UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRulesPolicyEnum policy, @JsonProperty("protocol") UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRulesProtocolEnum protocol, @JsonProperty("srcCidr") String srcCidr) {
        this.destCidr = destCidr;
        this.policy = policy;
        this.protocol = protocol;
        this.srcCidr = srcCidr;
