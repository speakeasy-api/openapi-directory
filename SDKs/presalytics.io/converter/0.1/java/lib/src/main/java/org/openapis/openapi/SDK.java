...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.SvgconvertResponse svgconvert(org.openapis.openapi.models.operations.SvgconvertFileToConvert request) throws Exception {
        ...
        org.openapis.openapi.models.operations.SvgconvertResponse res = new org.openapis.openapi.models.operations.SvgconvertResponse(contentType, httpRes.statusCode()) {{
            fileUrl = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.SvgconvertFileUrl out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.SvgconvertFileUrl.class);
                res.fileUrl = out;
            }
        }
        else if (httpRes.statusCode() == 400 || httpRes.statusCode() == 415) {
        }
