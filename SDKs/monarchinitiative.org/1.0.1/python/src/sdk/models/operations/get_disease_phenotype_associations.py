...
from ..shared import d2passociationresults as shared_d2passociationresults


@dataclasses.dataclass
class GetDiseasePhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseasePhenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetDiseasePhenotypeAssociationsRequest:
    path_params: GetDiseasePhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetDiseasePhenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetDiseasePhenotypeAssociationsResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    d2_p_association_results: Optional[shared_d2passociationresults.D2PAssociationResults] = dataclasses.field(default=None)
