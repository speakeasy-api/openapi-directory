...
class Rate:
    ...
    confirmation_amount: RateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('confirmation_amount') }})
    ...
    insurance_amount: RateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('insurance_amount') }})
    negotiated_rate: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('negotiated_rate') }})
    other_amount: RateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('other_amount') }})
    ...
    shipping_amount: RateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('shipping_amount') }})
    ...
    tax_amount: Optional[RateMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tax_amount') }})
