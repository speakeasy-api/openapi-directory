...
public class GetVariantDiseaseAssociationsRequest {
    ...
    public GetVariantDiseaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetVariantDiseaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetVariantDiseaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetVariantDiseaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetVariantDiseaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetVariantDiseaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withRelation(String relation) {
    ...
    public GetVariantDiseaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetVariantDiseaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetVariantDiseaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetVariantDiseaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
