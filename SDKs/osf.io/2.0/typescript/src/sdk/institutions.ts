...
export class Institutions {
  ...
  institutionsDetail(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.InstitutionsDetailResponse =
        new operations.InstitutionsDetailResponse({
  ...
  institutionsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.InstitutionsListResponse =
        new operations.InstitutionsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  institutionsNodeList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.InstitutionsNodeListResponse =
        new operations.InstitutionsNodeListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  institutionsRegistrationList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.InstitutionsRegistrationListResponse =
        new operations.InstitutionsRegistrationListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  institutionsUsersList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.InstitutionsUsersListResponse =
        new operations.InstitutionsUsersListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
