...
export class DatastreamProjectsLocationsFetchStaticIpsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsFetchStaticIpsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatastreamProjectsLocationsFetchStaticIpsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
