...
class GETCreditMemoItemTypeCreditFromItemSourceEnum(str, Enum):
...
class GETCreditMemoItemTypeFinanceInformation:
...
class GETCreditMemoItemTypeSourceItemTypeEnum(str, Enum):
...
class GETCreditMemoItemTypeTaxModeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GETCreditMemoItemTypeTaxationItems:
...
class GETCreditMemoItemType:
    ...
    **Note**: This field is not available if you set the `zuora-version` request header to `257.0` or later.
    ...
    credit_from_item_source: Optional[GETCreditMemoItemTypeCreditFromItemSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('creditFromItemSource'), 'exclude': lambda f: f is None }})
    r"""The type of the credit from item."""  
    ...
    **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.
    """  
    finance_information: Optional[GETCreditMemoItemTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the credit memo item."""  
    ...
    r"""The service start date of the credit memo item. If the associated charge is a one-time fee, this date is the date of that charge."""  
    ...
    """  
    source_item_type: Optional[GETCreditMemoItemTypeSourceItemTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sourceItemType'), 'exclude': lambda f: f is None }})
    r"""The type of the source item.
    ...
    taxation_items: Optional[GETCreditMemoItemTypeTaxationItems] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxationItems'), 'exclude': lambda f: f is None }})
    r"""Container for the taxation items of the credit memo item.
    
    **Note**: This field is only available if you set the `zuora-version` request header to `239.0` or later.
    """  
    tax_mode: Optional[GETCreditMemoItemTypeTaxModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxMode'), 'exclude': lambda f: f is None }})
    r"""The tax mode of the credit memo item, indicating whether the amount of the credit memo item includes tax."""  
