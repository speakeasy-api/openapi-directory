...
// CreateFunctionRequestBodySyncConfig - <p>Describes a Sync configuration for a resolver.</p> <p>Specifies which Conflict Detection strategy and Resolution strategy to use when the resolver is invoked.</p>
...
type CreateFunctionRequestBody struct {
	...
	Runtime *CreateFunctionRequestBodyRuntime `json:"runtime,omitempty"`
