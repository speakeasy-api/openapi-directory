...
class FirebaseappdistributionMediaUploadSecurity:
...
@dataclasses.dataclass
class FirebaseappdistributionMediaUploadRequest:
    
    app: str = dataclasses.field(metadata={'path_param': { 'field_name': 'app', 'style': 'simple', 'explode': False }})
    r"""The name of the app resource. Format: `projects/{project_number}/apps/{app_id}`"""  
...
@dataclasses.dataclass
class FirebaseappdistributionMediaUploadResponse:
