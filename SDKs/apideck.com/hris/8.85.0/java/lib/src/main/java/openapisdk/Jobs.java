...
public class Jobs {
    ...
    **/
    public openapisdk.models.operations.JobsAllResponse jobsAll(openapisdk.models.operations.JobsAllRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hris/jobs/employees/{employee_id}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetHrisJobsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetHrisJobsResponse.class);
    ...
    **/
    public openapisdk.models.operations.JobsOneResponse jobsOne(openapisdk.models.operations.JobsOneRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hris/jobs/employees/{employee_id}/jobs/{job_id}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetHrisJobResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetHrisJobResponse.class);
