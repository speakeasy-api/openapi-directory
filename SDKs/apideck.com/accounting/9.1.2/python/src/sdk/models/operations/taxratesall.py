...
from ..shared import gettaxratesresponse as shared_gettaxratesresponse
...
from ..shared import taxratesfilter as shared_taxratesfilter
...
class TaxRatesAllRequest:
    ...
    filter: Optional[shared_taxratesfilter.TaxRatesFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
@dataclasses.dataclass
class TaxRatesAllResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    get_tax_rates_response: Optional[shared_gettaxratesresponse.GetTaxRatesResponse] = dataclasses.field(default=None)
    r"""TaxRates"""  
