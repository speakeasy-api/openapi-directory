...
var ExportEvents = /** @class */ (function () {
    function ExportEvents(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Imports event logs related to the onboarding app into elastisearch
     */
    ExportEvents.prototype.createOrganizationInventoryOnboardingCloudMonitoringExportEvent = function (req, config) {
        var _a;
