...
export class GetWorkspacesWorkspaceProjectsProjectKeyDefaultReviewersSelectedUserSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetWorkspacesWorkspaceProjectsProjectKeyDefaultReviewersSelectedUserRequest extends SpeakeasyBase {
  /**
...
export class GetWorkspacesWorkspaceProjectsProjectKeyDefaultReviewersSelectedUserResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
