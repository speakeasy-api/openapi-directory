...
from .live_currency_rate_conversion import LiveCurrencyRateConversion
...
class SDK:
    ...
    live_currency_rate_conversion: LiveCurrencyRateConversion
    ...
    def _init_sdks(self):
        ...
        self.live_currency_rate_conversion = LiveCurrencyRateConversion(
            self._client,
