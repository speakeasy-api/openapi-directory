...
var Account = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "applyPretargetingToNonGuaranteedDeals" }),
        __metadata("design:type", Boolean)
    ], Account.prototype, "applyPretargetingToNonGuaranteedDeals", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: AccountBidderLocation }),
        (0, class_transformer_1.Expose)({ name: "bidderLocation" }),
        (0, class_transformer_1.Type)(function () { return AccountBidderLocation; }),
        __metadata("design:type", Array)
    ], Account.prototype, "bidderLocation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cookieMatchingNid" }),
        __metadata("design:type", String)
    ], Account.prototype, "cookieMatchingNid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cookieMatchingUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maximumActiveCreatives" }),
        __metadata("design:type", Number)
    ], Account.prototype, "maximumActiveCreatives", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maximumTotalQps" }),
        __metadata("design:type", Number)
    ], Account.prototype, "maximumTotalQps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "numberActiveCreatives" }),
        __metadata("design:type", Number)
