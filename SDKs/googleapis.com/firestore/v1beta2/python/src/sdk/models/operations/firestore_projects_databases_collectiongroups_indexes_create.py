...
class FirestoreProjectsDatabasesCollectionGroupsIndexesCreateSecurity:
    option1: Optional[FirestoreProjectsDatabasesCollectionGroupsIndexesCreateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirestoreProjectsDatabasesCollectionGroupsIndexesCreateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class FirestoreProjectsDatabasesCollectionGroupsIndexesCreateRequest:
    path_params: FirestoreProjectsDatabasesCollectionGroupsIndexesCreatePathParams = dataclasses.field()
    query_params: FirestoreProjectsDatabasesCollectionGroupsIndexesCreateQueryParams = dataclasses.field()
    security: FirestoreProjectsDatabasesCollectionGroupsIndexesCreateSecurity = dataclasses.field()
    request: Optional[shared_googlefirestoreadminv1beta2index.GoogleFirestoreAdminV1beta2Index] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
