...
class UpdateDeviceCellularGatewayLanRequestBody:
    ...
    fixed_ip_assignments: Optional[list[UpdateDeviceCellularGatewayLanRequestBodyFixedIPAssignments]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fixedIpAssignments'), 'exclude': lambda f: f is None }})
    r"""list of all fixed IP assignments for a single MG"""  
    reserved_ip_ranges: Optional[list[UpdateDeviceCellularGatewayLanRequestBodyReservedIPRanges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reservedIpRanges'), 'exclude': lambda f: f is None }})
...
class UpdateDeviceCellularGatewayLanRequest:
    ...
    request_body: Optional[UpdateDeviceCellularGatewayLanRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
