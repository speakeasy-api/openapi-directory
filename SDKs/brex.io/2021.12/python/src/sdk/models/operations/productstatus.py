...
@dataclasses.dataclass
class ProductStatusDefaultApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductStatus200ApplicationJSON:
...
class ProductStatusResponse:
    ...
    product_status_200_application_json_object: Optional[ProductStatus200ApplicationJSON] = dataclasses.field(default=None)
    r"""Product order details"""  
    product_status_default_application_json_object: Optional[ProductStatusDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
