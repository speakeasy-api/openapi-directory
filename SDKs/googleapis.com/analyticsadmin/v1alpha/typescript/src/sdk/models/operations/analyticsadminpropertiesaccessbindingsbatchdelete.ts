...
export class AnalyticsadminPropertiesAccessBindingsBatchDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesAccessBindingsBatchDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesAccessBindingsBatchDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
