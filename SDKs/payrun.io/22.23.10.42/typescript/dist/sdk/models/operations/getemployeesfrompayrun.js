...
exports.GetEmployeesFromPayRunResponse = exports.GetEmployeesFromPayRunRequest = void 0;
...
var GetEmployeesFromPayRunRequest = /** @class */ (function (_super) {
    ...
    ], GetEmployeesFromPayRunRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetEmployeesFromPayRunRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetEmployeesFromPayRunRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayRunId",
        }),
        __metadata("design:type", String)
    ], GetEmployeesFromPayRunRequest.prototype, "payRunId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetEmployeesFromPayRunRequest.prototype, "payScheduleId", void 0);
...
var GetEmployeesFromPayRunResponse = /** @class */ (function (_super) {
    ...
    ], GetEmployeesFromPayRunResponse.prototype, "rawResponse", void 0);
