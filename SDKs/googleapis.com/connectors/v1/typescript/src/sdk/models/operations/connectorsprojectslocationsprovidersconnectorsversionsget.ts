...
export class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum ConnectorsProjectsLocationsProvidersConnectorsVersionsGetViewEnum {
...
export class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
