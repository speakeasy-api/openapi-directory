...
var GETPaymentRunDataElementResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "amountToCollect" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: getpaymentrundatatransactionelementresponse_1.GETPaymentRunDataTransactionElementResponse }),
        (0, class_transformer_1.Expose)({ name: "transactions" }),
        (0, class_transformer_1.Type)(function () { return getpaymentrundatatransactionelementresponse_1.GETPaymentRunDataTransactionElementResponse; }),
