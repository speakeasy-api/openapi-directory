...
class Attributes:
    ...
    def mybusinessbusinessinformation_attributes_list(self, request: operations.MybusinessbusinessinformationAttributesListRequest) -> operations.MybusinessbusinessinformationAttributesListResponse:
        ...
        query_params = utils.get_query_params(operations.MybusinessbusinessinformationAttributesListRequest, request)
        ...
        res = operations.MybusinessbusinessinformationAttributesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAttributeMetadataResponse])
