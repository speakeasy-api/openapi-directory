...
class FlagResponse:
    ...
    flag: Optional[shared_flag.Flag] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flag'), 'exclude': lambda f: f is None }})
