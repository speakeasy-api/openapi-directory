...
class Aggregation:
    ...
    alignment_period: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('alignmentPeriod') }})
    cross_series_reducer: Optional[AggregationCrossSeriesReducerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('crossSeriesReducer') }})
    group_by_fields: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('groupByFields') }})
    per_series_aligner: Optional[AggregationPerSeriesAlignerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('perSeriesAligner') }})
