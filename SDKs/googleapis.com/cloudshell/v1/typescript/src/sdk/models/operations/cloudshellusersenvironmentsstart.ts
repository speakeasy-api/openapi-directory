...
export class CloudshellUsersEnvironmentsStartSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudshellUsersEnvironmentsStartRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudshellUsersEnvironmentsStartResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
