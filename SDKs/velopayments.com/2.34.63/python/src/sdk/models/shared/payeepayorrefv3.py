...
from ..shared import payableissuev3 as shared_payableissuev3
...
class PayeePayorRefV3:
    ...
    payable_issues: Optional[list[shared_payableissuev3.PayableIssueV3]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payableIssues'), 'exclude': lambda f: f is None }})
