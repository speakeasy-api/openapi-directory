...
class Orders 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\ListOrdersResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/companies/{companyId}/connections/{connectionId}/data/commerce-orders', \OpenAPI\OpenAPI\Models\Operations\ListOrdersRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->orders = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\Orders', 'json');
            }
        }
