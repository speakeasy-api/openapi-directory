...
class ListBotLocalesResponse:
    ...
    bot_locale_summaries: Optional[list[shared_botlocalesummary.BotLocaleSummary]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('botLocaleSummaries'), 'exclude': lambda f: f is None }})  
