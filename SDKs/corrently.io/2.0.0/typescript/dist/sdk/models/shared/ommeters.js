...
var Ommeters = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "currentScalingFactor" }),
        __metadata("design:type", Number)
    ], Ommeters.prototype, "currentScalingFactor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "loadProfileType" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "measurementType" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "voltageScalingFactor" }),
        __metadata("design:type", Number)
    ], Ommeters.prototype, "voltageScalingFactor", void 0);
    return Ommeters;
}(utils_1.SpeakeasyBase));
exports.Ommeters = Ommeters;
