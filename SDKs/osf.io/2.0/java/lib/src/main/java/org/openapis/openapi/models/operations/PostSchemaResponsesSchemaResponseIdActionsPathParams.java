...
public class PostSchemaResponsesSchemaResponseIdActionsPathParams {
    /**
    ...
    public PostSchemaResponsesSchemaResponseIdActionsPathParams withSchemaResponseId(String schemaResponseId) {
