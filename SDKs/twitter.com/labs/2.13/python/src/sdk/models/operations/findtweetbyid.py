...
from ..shared import singletweetlookupresponse as shared_singletweetlookupresponse
...
class FindTweetByIDResponse:
    ...
    single_tweet_lookup_response: Optional[shared_singletweetlookupresponse.SingleTweetLookupResponse] = dataclasses.field(default=None)
