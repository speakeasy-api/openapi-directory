...
import { InternalIpOwner } from "./internalipowner";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum IpOwnerListWarningCodeEnum {
...
export declare class IpOwnerListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class IpOwnerListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: IpOwnerListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: IpOwnerListWarningData[];
    /**
 ...
 */
export declare class IpOwnerList extends SpeakeasyBase {
    /**
