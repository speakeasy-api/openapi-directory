...
exports.ListStepResponse = exports.ListStepListStepResponse = exports.ListStepListStepResponseMeta = exports.ListStepRequest = exports.ListStepSecurity = exports.ListStepServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListStepServerList = ["https://studio.twilio.com"];
var ListStepSecurity = /** @class */ (function (_super) {
    ...
    ], ListStepSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListStepSecurity.prototype, "username", void 0);
    return ListStepSecurity;
}(utils_1.SpeakeasyBase));
exports.ListStepSecurity = ListStepSecurity;
var ListStepRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListStepRequest.prototype, "engagementSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FlowSid",
        }),
        __metadata("design:type", String)
    ], ListStepRequest.prototype, "flowSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListStepRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListStepRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListStepRequest.prototype, "pageToken", void 0);
    return ListStepRequest;
}(utils_1.SpeakeasyBase));
exports.ListStepRequest = ListStepRequest;
...
exports.ListStepListStepResponseMeta = ListStepListStepResponseMeta;
/**
 * OK
 */
var ListStepListStepResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListStepListStepResponseMeta; }),
        __metadata("design:type", ListStepListStepResponseMeta)
    ], ListStepListStepResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.StudioV1FlowEngagementStep }),
        (0, class_transformer_1.Expose)({ name: "steps" }),
        (0, class_transformer_1.Type)(function () { return shared.StudioV1FlowEngagementStep; }),
        __metadata("design:type", Array)
    ], ListStepListStepResponse.prototype, "steps", void 0);
    return ListStepListStepResponse;
}(utils_1.SpeakeasyBase));
exports.ListStepListStepResponse = ListStepListStepResponse;
var ListStepResponse = /** @class */ (function (_super) {
    ...
    ], ListStepResponse.prototype, "rawResponse", void 0);
    return ListStepResponse;
}(utils_1.SpeakeasyBase));
exports.ListStepResponse = ListStepResponse;
