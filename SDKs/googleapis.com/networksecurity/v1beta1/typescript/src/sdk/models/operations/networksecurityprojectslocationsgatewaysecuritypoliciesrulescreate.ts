...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesRulesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
