...
public class StorageUpdateFileSecurity {
    ...
    public StorageUpdateFileSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public StorageUpdateFileSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public StorageUpdateFileSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public StorageUpdateFileSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
