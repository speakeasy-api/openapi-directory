...
exports.GetJournalInstructionFromEmployerResponse = exports.GetJournalInstructionFromEmployerRequest = void 0;
...
var GetJournalInstructionFromEmployerRequest = /** @class */ (function (_super) {
    ...
    ], GetJournalInstructionFromEmployerRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetJournalInstructionFromEmployerRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetJournalInstructionFromEmployerRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=JournalInstructionId",
        }),
        __metadata("design:type", String)
    ], GetJournalInstructionFromEmployerRequest.prototype, "journalInstructionId", void 0);
...
var GetJournalInstructionFromEmployerResponse = /** @class */ (function (_super) {
    ...
    ], GetJournalInstructionFromEmployerResponse.prototype, "rawResponse", void 0);
