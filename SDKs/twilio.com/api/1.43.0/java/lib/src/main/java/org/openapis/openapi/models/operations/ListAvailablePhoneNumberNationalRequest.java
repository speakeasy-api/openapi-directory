...
public class ListAvailablePhoneNumberNationalRequest {
    ...
    public ListAvailablePhoneNumberNationalRequest withAccountSid(String accountSid) {
    ...
    public ListAvailablePhoneNumberNationalRequest withAreaCode(Long areaCode) {
    ...
    public ListAvailablePhoneNumberNationalRequest withBeta(Boolean beta) {
        this.beta = beta;
        return this;
    }
    ...
    public ListAvailablePhoneNumberNationalRequest withContains(String contains) {
    ...
    public ListAvailablePhoneNumberNationalRequest withCountryCode(String countryCode) {
    ...
    public ListAvailablePhoneNumberNationalRequest withDistance(Long distance) {
    ...
    public ListAvailablePhoneNumberNationalRequest withExcludeAllAddressRequired(Boolean excludeAllAddressRequired) {
    ...
    public ListAvailablePhoneNumberNationalRequest withExcludeForeignAddressRequired(Boolean excludeForeignAddressRequired) {
    ...
    public ListAvailablePhoneNumberNationalRequest withExcludeLocalAddressRequired(Boolean excludeLocalAddressRequired) {
    ...
    public ListAvailablePhoneNumberNationalRequest withFaxEnabled(Boolean faxEnabled) {
    ...
    public ListAvailablePhoneNumberNationalRequest withInLata(String inLata) {
        this.inLata = inLata;
        return this;
    }
    ...
    public ListAvailablePhoneNumberNationalRequest withInLocality(String inLocality) {
    ...
    public ListAvailablePhoneNumberNationalRequest withInPostalCode(String inPostalCode) {
    ...
    public ListAvailablePhoneNumberNationalRequest withInRateCenter(String inRateCenter) {
    ...
    public ListAvailablePhoneNumberNationalRequest withInRegion(String inRegion) {
    ...
    public ListAvailablePhoneNumberNationalRequest withMmsEnabled(Boolean mmsEnabled) {
    ...
    public ListAvailablePhoneNumberNationalRequest withNearLatLong(String nearLatLong) {
    ...
    public ListAvailablePhoneNumberNationalRequest withNearNumber(String nearNumber) {
    ...
    public ListAvailablePhoneNumberNationalRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListAvailablePhoneNumberNationalRequest withPageSize(Long pageSize) {
    ...
    public ListAvailablePhoneNumberNationalRequest withPageToken(String pageToken) {
    ...
    public ListAvailablePhoneNumberNationalRequest withSmsEnabled(Boolean smsEnabled) {
    ...
    public ListAvailablePhoneNumberNationalRequest withVoiceEnabled(Boolean voiceEnabled) {
        this.voiceEnabled = voiceEnabled;
        return this;
    }
    
    public ListAvailablePhoneNumberNationalRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CountryCode") String countryCode) {
        this.accountSid = accountSid;
        this.countryCode = countryCode;
  }
}
