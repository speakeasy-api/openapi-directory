...
public class FeeSchedulesList200ApplicationJSON {
    ...
    @JsonProperty("data")
    public org.openapis.openapi.models.shared.DoctorFeeSchedule[] data;

    public FeeSchedulesList200ApplicationJSON withData(org.openapis.openapi.models.shared.DoctorFeeSchedule[] data) {
        this.data = data;
        return this;
    }
    ...
    public FeeSchedulesList200ApplicationJSON(){}
}
