...
public class ChromepolicyCustomersPoliciesGroupsBatchModifyPathParams {
    /**
    ...
    public ChromepolicyCustomersPoliciesGroupsBatchModifyPathParams withCustomer(String customer) {
