 ...
 */
export enum InstanceGroupManagersListPerInstanceConfigsRespWarningCodeEnum {
...
export class InstanceGroupManagersListPerInstanceConfigsRespWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceGroupManagersListPerInstanceConfigsRespWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
 ...
 * Successful response
 */
export class InstanceGroupManagersListPerInstanceConfigsResp extends SpeakeasyBase {
  /**
