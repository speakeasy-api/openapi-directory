...
class LifesciencesProjectsLocationsPipelinesRunRequest:
    ...
    r"""The project and location that this request should be executed against."""  
    ...
    run_pipeline_request: Optional[shared_runpipelinerequest.RunPipelineRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
