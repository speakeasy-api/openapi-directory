...
exports.CertificateCancelDeletionResponse = exports.CertificateCancelDeletionRequest = void 0;
...
var CertificateCancelDeletionRequest = /** @class */ (function (_super) {
    ...
    ], CertificateCancelDeletionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], CertificateCancelDeletionRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], CertificateCancelDeletionRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], CertificateCancelDeletionRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=thumbprint",
        }),
        __metadata("design:type", String)
    ], CertificateCancelDeletionRequest.prototype, "thumbprint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=thumbprintAlgorithm",
        }),
        __metadata("design:type", String)
    ], CertificateCancelDeletionRequest.prototype, "thumbprintAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], CertificateCancelDeletionRequest.prototype, "timeout", void 0);
...
var CertificateCancelDeletionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CertificateCancelDeletionResponse.prototype, "rawResponse", void 0);
