...
var MaintenanceStatus = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: MaintenanceStatusConnectionServices }),
        (0, class_transformer_1.Expose)({ name: "connection_services" }),
        (0, class_transformer_1.Type)(function () { return MaintenanceStatusConnectionServices; }),
