...
var LandlordMaintenanceJobModel = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=AssignedTo" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MaintenanceNotes", elemType: landlordmaintenancejobnotemodel_1.LandlordMaintenanceJobNoteModel }),
