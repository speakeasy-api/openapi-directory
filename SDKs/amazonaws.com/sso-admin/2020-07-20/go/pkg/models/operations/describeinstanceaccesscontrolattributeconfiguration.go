...
type DescribeInstanceAccessControlAttributeConfigurationRequest struct {
	DescribeInstanceAccessControlAttributeConfigurationRequest shared.DescribeInstanceAccessControlAttributeConfigurationRequest `request:"mediaType=application/json"`
