...
try {
    ...
    $request->targetUser = 'non';
    $request->username = 'Norberto_Stark56';
...
try {
    ...
    $request->username = 'Gabriel_Klocko91';
...
try {
    ...
    $request->username = 'Gregorio.OConnell9';
...
try {
    ...
    $request->username = 'Ryley_Cummerata';
...
try {
    ...
    $request->subjectId = 'a';
    $request->subjectType = UsersGetContextForUserSubjectTypeEnum::PULL_REQUEST;
    $request->username = 'Leanna.Grady98';
...
try {
    ...
    $request->perPage = 818078;
    $request->since = 491380;
...
try {
    ...
    $request->page = 431258;
    $request->perPage = 385291;
    $request->username = 'Margarette.Jones85';
...
try {
    ...
    $request->page = 41306;
    $request->perPage = 32775;
    $request->username = 'Abigale.Frami';
...
try {
    ...
    $request->page = 555386;
    $request->perPage = 802976;
    $request->username = 'Thomas51';
...
try {
    ...
    $request->page = 667646;
    $request->perPage = 144058;
    $request->username = 'Arthur.Tromp';
