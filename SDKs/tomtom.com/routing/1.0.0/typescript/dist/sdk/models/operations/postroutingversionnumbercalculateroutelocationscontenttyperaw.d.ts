...
export declare class PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawRequest extends SpeakeasyBase {
...
export declare class PostRoutingVersionNumberCalculateRouteLocationsContentTypeRawResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
