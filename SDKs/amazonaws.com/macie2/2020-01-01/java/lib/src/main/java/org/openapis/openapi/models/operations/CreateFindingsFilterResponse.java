...
public class CreateFindingsFilterResponse {
    ...
    public org.openapis.openapi.models.shared.CreateFindingsFilterResponse createFindingsFilterResponse;

    public CreateFindingsFilterResponse withCreateFindingsFilterResponse(org.openapis.openapi.models.shared.CreateFindingsFilterResponse createFindingsFilterResponse) {
    ...
    public CreateFindingsFilterResponse withStatusCode(Integer statusCode) {
    ...
    public CreateFindingsFilterResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public CreateFindingsFilterResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
