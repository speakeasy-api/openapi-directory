...
export class OrgpolicyProjectsPoliciesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OrgpolicyProjectsPoliciesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OrgpolicyProjectsPoliciesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
