...
func (e *GoogleCloudDialogflowV2beta1VoiceSelectionParamsSsmlGenderEnum) UnmarshalJSON(data []byte) error {
	...
	case "SSML_VOICE_GENDER_NEUTRAL":
		*e = GoogleCloudDialogflowV2beta1VoiceSelectionParamsSsmlGenderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDialogflowV2beta1VoiceSelectionParamsSsmlGenderEnum: %s", s)
	}
}
