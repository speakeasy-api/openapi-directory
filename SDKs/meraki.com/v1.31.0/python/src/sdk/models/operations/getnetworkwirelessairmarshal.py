...
class GetNetworkWirelessAirMarshalRequest:
    ...
    r"""The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 31 days. The default is 7 days."""  
...
class GetNetworkWirelessAirMarshalResponse:
    ...
    get_network_wireless_air_marshal_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
