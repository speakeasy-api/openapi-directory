...
class GetCancelCapacityReservationQueryParams:
    action: GetCancelCapacityReservationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetCancelCapacityReservationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCancelCapacityReservationRequest:
    headers: GetCancelCapacityReservationHeaders = dataclasses.field()
    query_params: GetCancelCapacityReservationQueryParams = dataclasses.field()
