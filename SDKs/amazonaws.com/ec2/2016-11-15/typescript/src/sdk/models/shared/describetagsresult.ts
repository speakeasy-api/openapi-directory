 ...
 * The resource type.
 */
export enum DescribeTagsResultTagsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class DescribeTagsResultTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
...
export class DescribeTagsResult extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: DescribeTagsResultTags })
