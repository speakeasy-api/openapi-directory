...
public class Region {
    ...
    public org.openapis.openapi.models.operations.GetSellersByRegionResponse getSellersByRegion(org.openapis.openapi.models.operations.GetSellersByRegionRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetSellersByRegionPathParams.class, baseUrl, "/api/checkout/pub/regions/{regionId}", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetSellersByRegionQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
