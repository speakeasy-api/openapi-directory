...
public class GetPostsIdsCommentsRequest {
    ...
    public GetPostsIdsCommentsRequest withCallback(String callback) {
    ...
    public GetPostsIdsCommentsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withFromdate(Long fromdate) {
    ...
    public GetPostsIdsCommentsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withOrder(GetPostsIdsCommentsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withPagesize(Long pagesize) {
    ...
    public GetPostsIdsCommentsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withSort(GetPostsIdsCommentsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPostsIdsCommentsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetPostsIdsCommentsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
