...
func (e GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Sticky MAC allow list":
		*e = GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONAccessPolicyTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum) UnmarshalJSON(data []byte) error {
	...
	case "loop guard":
		fallthrough
	case "root guard":
		*e = GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONStpGuardEnum: %v", v)
	}
}
...
func (e GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "access":
		fallthrough
	case "trunk":
		*e = GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum) ToPointer() *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum {
	return &e
}
...
func (e *GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum) UnmarshalJSON(data []byte) error {
	...
	case "Alert only":
		fallthrough
	case "Enforce":
		*e = GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationConfigTemplateSwitchProfilePort200ApplicationJSONUdldEnum: %v", v)
	}
}
