...
type FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest struct {
	...
	GoogleFirebaseAppcheckV1ExchangeAppAttestAssertionRequest *shared.GoogleFirebaseAppcheckV1ExchangeAppAttestAssertionRequest `request:"mediaType=application/json"`
	// OAuth access token.
