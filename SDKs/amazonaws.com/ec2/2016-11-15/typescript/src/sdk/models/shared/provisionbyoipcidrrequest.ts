 ...
 */
export enum ProvisionByoipCidrRequestPoolTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class ProvisionByoipCidrRequestPoolTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class ProvisionByoipCidrRequestPoolTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
