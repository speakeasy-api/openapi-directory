...
exports.GetTagsFromPayInstructionResponse = exports.GetTagsFromPayInstructionRequest = void 0;
...
var GetTagsFromPayInstructionRequest = /** @class */ (function (_super) {
    ...
    ], GetTagsFromPayInstructionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagsFromPayInstructionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromPayInstructionRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromPayInstructionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayInstructionId",
        }),
        __metadata("design:type", String)
    ], GetTagsFromPayInstructionRequest.prototype, "payInstructionId", void 0);
...
var GetTagsFromPayInstructionResponse = /** @class */ (function (_super) {
    ...
    ], GetTagsFromPayInstructionResponse.prototype, "rawResponse", void 0);
