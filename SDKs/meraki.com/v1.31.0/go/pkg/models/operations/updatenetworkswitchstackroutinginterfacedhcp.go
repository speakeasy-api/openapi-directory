...
func (e *UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum) UnmarshalJSON(data []byte) error {
	...
	case "30 minutes":
		fallthrough
	case "4 hours":
		*e = UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "dhcpRelay":
		fallthrough
	case "dhcpServer":
		*e = UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpModeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ip":
		fallthrough
	case "text":
		*e = UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum) UnmarshalJSON(data []byte) error {
	...
	case "googlePublicDns":
		fallthrough
	case "openDns":
		*e = UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchStackRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum: %s", s)
	}
}
