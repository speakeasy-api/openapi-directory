...
class ListDeployedDevicesDeploymentListDeployedDevicesDeploymentResponse:
    ...
    deployments: Optional[list[shared_preview_deployed_devices_fleet_deployment.PreviewDeployedDevicesFleetDeployment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deployments'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListDeployedDevicesDeploymentListDeployedDevicesDeploymentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
