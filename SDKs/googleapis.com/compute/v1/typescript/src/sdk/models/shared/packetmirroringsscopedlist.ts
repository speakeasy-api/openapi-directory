 ...
 */
export enum PacketMirroringsScopedListWarningCodeEnum {
...
export class PacketMirroringsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class PacketMirroringsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: PacketMirroringsScopedListWarningData })
  @Expose({ name: "data" })
...
export class PacketMirroringsScopedList extends SpeakeasyBase {
  /**
   * A list of packetMirrorings contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: PacketMirroring })
  @Expose({ name: "packetMirrorings" })
