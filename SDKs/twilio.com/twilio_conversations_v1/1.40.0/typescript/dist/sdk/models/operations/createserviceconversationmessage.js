...
exports.CreateServiceConversationMessageResponse = exports.CreateServiceConversationMessageRequest = exports.CreateServiceConversationMessageCreateServiceConversationMessageRequest = exports.CreateServiceConversationMessageSecurity = exports.CreateServiceConversationMessageServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.CreateServiceConversationMessageServerList = [
...
var CreateServiceConversationMessageSecurity = /** @class */ (function (_super) {
    ...
    ], CreateServiceConversationMessageSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], CreateServiceConversationMessageSecurity.prototype, "username", void 0);
    return CreateServiceConversationMessageSecurity;
}(utils_1.SpeakeasyBase));
exports.CreateServiceConversationMessageSecurity = CreateServiceConversationMessageSecurity;
var CreateServiceConversationMessageCreateServiceConversationMessageRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateServiceConversationMessageCreateServiceConversationMessageRequest.prototype, "contentSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=ContentVariables" }),
        __metadata("design:type", String)
    ], CreateServiceConversationMessageCreateServiceConversationMessageRequest.prototype, "contentVariables", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
...
exports.CreateServiceConversationMessageCreateServiceConversationMessageRequest = CreateServiceConversationMessageCreateServiceConversationMessageRequest;
var CreateServiceConversationMessageRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateServiceConversationMessageRequest.prototype, "chatServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConversationSid",
        }),
        __metadata("design:type", String)
    ], CreateServiceConversationMessageRequest.prototype, "conversationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", CreateServiceConversationMessageCreateServiceConversationMessageRequest)
    ], CreateServiceConversationMessageRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Twilio-Webhook-Enabled",
        }),
        __metadata("design:type", String)
    ], CreateServiceConversationMessageRequest.prototype, "xTwilioWebhookEnabled", void 0);
    return CreateServiceConversationMessageRequest;
}(utils_1.SpeakeasyBase));
exports.CreateServiceConversationMessageRequest = CreateServiceConversationMessageRequest;
var CreateServiceConversationMessageResponse = /** @class */ (function (_super) {
    ...
    ], CreateServiceConversationMessageResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreateServiceConversationMessageResponse = CreateServiceConversationMessageResponse;
