...
class ProjectRequestCurrentStatusInput
{
    ...
    public ?UserCompactInput $author = null;
    
    /**
     * The color associated with the status update.
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\ProjectRequestCurrentStatusColorEnum $color
     */
	#[\JMS\Serializer\Annotation\SerializedName('color')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ProjectRequestCurrentStatusColorEnum>')]
    public ProjectRequestCurrentStatusColorEnum $color;
    
	#[\JMS\Serializer\Annotation\SerializedName('created_by')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\UserCompactInput')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UserCompactInput $createdBy = null;
	...
	{
		$this->author = null;
		$this->color = \OpenAPI\OpenAPI\Models\Shared\ProjectRequestCurrentStatusColorEnum::GREEN;
		$this->createdBy = null;
		$this->htmlText = null;
		$this->text = "";
		$this->title = null;
