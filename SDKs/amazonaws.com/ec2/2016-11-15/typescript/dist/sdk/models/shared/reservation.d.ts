 ...
 */
export declare class ReservationGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare enum ReservationInstancesArchitectureEnum {
    I386 = "i386",
    X8664 = "x86_64",
    Arm64 = "arm64",
    X8664Mac = "x86_64_mac",
 ...
 */
export declare enum ReservationInstancesBlockDeviceMappingsEbsStatusEnum {
    Attaching = "attaching",
    Attached = "attached",
    Detaching = "detaching",
    Detached = "detached"
 ...
 */
export declare class ReservationInstancesBlockDeviceMappingsEbs extends SpeakeasyBase {
    attachTime?: Date;
 ...
 */
export declare class ReservationInstancesBlockDeviceMappings extends SpeakeasyBase {
    deviceName?: string;
 ...
 */
export declare enum ReservationInstancesBootModeEnum {
 ...
 */
export declare enum ReservationInstancesCapacityReservationSpecificationCapacityReservationPreferenceEnum {
    Open = "open",
    None = "none"
}
/**
 ...
 */
export declare class ReservationInstancesCapacityReservationSpecificationCapacityReservationTarget extends SpeakeasyBase {
 ...
 */
export declare class ReservationInstancesCapacityReservationSpecification extends SpeakeasyBase {
 ...
 */
export declare class ReservationInstancesCpuOptions extends SpeakeasyBase {
    coreCount?: number;
 ...
 */
export declare enum ReservationInstancesCurrentInstanceBootModeEnum {
    LegacyBios = "legacy-bios",
    Uefi = "uefi"
}
/**
 ...
 */
export declare class ReservationInstancesElasticGpuAssociations extends SpeakeasyBase {
 ...
 */
export declare class ReservationInstancesElasticInferenceAcceleratorAssociations extends SpeakeasyBase {
 ...
 */
export declare class ReservationInstancesEnclaveOptions extends SpeakeasyBase {
    enabled?: boolean;
}
/**
 * Indicates whether the instance is enabled for hibernation.
 */
export declare class ReservationInstancesHibernationOptions extends SpeakeasyBase {
    configured?: boolean;
}
/**
 * The hypervisor type of the instance. The value <code>xen</code> is used for both Xen and Nitro hypervisors.
 */
export declare enum ReservationInstancesHypervisorEnum {
    Ovm = "ovm",
    Xen = "xen"
}
/**
 ...
 */
export declare class ReservationInstancesIamInstanceProfile extends SpeakeasyBase {
    arn?: string;
    id?: string;
}
/**
 ...
 */
export declare enum ReservationInstancesInstanceLifecycleEnum {
    Spot = "spot",
    Scheduled = "scheduled"
}
/**
 * The instance type.
 */
export declare enum ReservationInstancesInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 */
export declare class ReservationInstancesLicenses extends SpeakeasyBase {
    licenseConfigurationArn?: string;
}
/**
 * Provides information on the current automatic recovery behavior of your instance.
 */
export declare enum ReservationInstancesMaintenanceOptionsAutoRecoveryEnum {
    Disabled = "disabled",
    Default = "default"
}
/**
 ...
 */
export declare class ReservationInstancesMaintenanceOptions extends SpeakeasyBase {
 ...
 */
export declare enum ReservationInstancesMetadataOptionsHttpEndpointEnum {
    Disabled = "disabled",
    Enabled = "enabled"
}
/**
 ...
 */
export declare enum ReservationInstancesMetadataOptionsHttpProtocolIpv6Enum {
    Disabled = "disabled",
    Enabled = "enabled"
}
/**
 ...
 */
export declare enum ReservationInstancesMetadataOptionsHttpTokensEnum {
    Optional = "optional",
    Required = "required"
}
/**
 ...
 */
export declare enum ReservationInstancesMetadataOptionsInstanceMetadataTagsEnum {
    Disabled = "disabled",
    Enabled = "enabled"
}
/**
 ...
 */
export declare enum ReservationInstancesMetadataOptionsStateEnum {
    Pending = "pending",
    Applied = "applied"
}
/**
 ...
 */
export declare class ReservationInstancesMetadataOptions extends SpeakeasyBase {
 ...
 */
export declare enum ReservationInstancesMonitoringStateEnum {
    Disabled = "disabled",
    Disabling = "disabling",
    Enabled = "enabled",
    Pending = "pending"
 ...
 */
export declare class ReservationInstancesMonitoring extends SpeakeasyBase {
    state?: ReservationInstancesMonitoringStateEnum;
}
/**
 * The association information for an Elastic IPv4 associated with the network interface.
 */
export declare class ReservationInstancesNetworkInterfacesAssociation extends SpeakeasyBase {
    carrierIp?: string;
 ...
 * The attachment state.
 */
export declare enum ReservationInstancesNetworkInterfacesAttachmentStatusEnum {
    Attaching = "attaching",
    Attached = "attached",
    Detaching = "detaching",
    Detached = "detached"
 ...
 */
export declare class ReservationInstancesNetworkInterfacesAttachment extends SpeakeasyBase {
    attachTime?: Date;
    attachmentId?: string;
    deleteOnTermination?: boolean;
    deviceIndex?: number;
 ...
 * Describes a security group.
 */
export declare class ReservationInstancesNetworkInterfacesGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare class ReservationInstancesNetworkInterfacesIpv4Prefixes extends SpeakeasyBase {
    ipv4Prefix?: string;
}
/**
 * Describes an IPv6 address.
 */
export declare class ReservationInstancesNetworkInterfacesIpv6Addresses extends SpeakeasyBase {
    ipv6Address?: string;
}
/**
 * Information about an IPv6 prefix.
 */
export declare class ReservationInstancesNetworkInterfacesIpv6Prefixes extends SpeakeasyBase {
    ipv6Prefix?: string;
}
/**
 * The association information for an Elastic IP address for the network interface.
 */
export declare class ReservationInstancesNetworkInterfacesPrivateIpAddressesAssociation extends SpeakeasyBase {
    carrierIp?: string;
    customerOwnedIp?: string;
    ipOwnerId?: string;
    publicDnsName?: string;
 ...
 */
export declare class ReservationInstancesNetworkInterfacesPrivateIpAddresses extends SpeakeasyBase {
 ...
 */
export declare enum ReservationInstancesNetworkInterfacesStatusEnum {
    Available = "available",
 ...
 */
export declare class ReservationInstancesNetworkInterfaces extends SpeakeasyBase {
 ...
 */
export declare enum ReservationInstancesPlacementTenancyEnum {
    Default = "default",
    Dedicated = "dedicated",
    Host = "host"
}
 ...
 */
export declare class ReservationInstancesPlacement extends SpeakeasyBase {
    affinity?: string;
 ...
 */
export declare enum ReservationInstancesPlatformEnum {
    Windows = "Windows"
}
/**
 * The type of hostname to assign to an instance.
 */
export declare enum ReservationInstancesPrivateDnsNameOptionsHostnameTypeEnum {
    IpName = "ip-name",
 ...
 */
export declare class ReservationInstancesPrivateDnsNameOptions extends SpeakeasyBase {
 ...
 */
export declare enum ReservationInstancesProductCodesProductCodeTypeEnum {
    Devpay = "devpay",
 ...
 */
export declare class ReservationInstancesProductCodes extends SpeakeasyBase {
 ...
 */
export declare enum ReservationInstancesRootDeviceTypeEnum {
    Ebs = "ebs",
 ...
 * Describes a security group.
 */
export declare class ReservationInstancesSecurityGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare enum ReservationInstancesStateNameEnum {
    Pending = "pending",
    Running = "running",
 ...
 * The current state of the instance.
 */
export declare class ReservationInstancesState extends SpeakeasyBase {
    code?: number;
 ...
 */
export declare class ReservationInstancesStateReason extends SpeakeasyBase {
    code?: string;
    message?: string;
}
/**
 * Describes a tag.
 */
export declare class ReservationInstancesTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare enum ReservationInstancesVirtualizationTypeEnum {
    Hvm = "hvm",
 ...
 */
export declare class ReservationInstances extends SpeakeasyBase {
    ...
    currentInstanceBootMode?: ReservationInstancesCurrentInstanceBootModeEnum;
