...
public class MerchantsUpdateRequest {
    ...
    public MerchantsUpdateRequest(@JsonProperty("MerchantInput") org.openapis.openapi.models.shared.MerchantInput merchantInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.merchantInput = merchantInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
