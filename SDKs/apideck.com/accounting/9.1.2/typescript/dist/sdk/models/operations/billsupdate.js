...
exports.BillsUpdateResponse = exports.BillsUpdateRequest = exports.BillsUpdateSecurity = void 0;
...
exports.BillsUpdateSecurity = BillsUpdateSecurity;
var BillsUpdateRequest = /** @class */ (function (_super) {
    ...
    ], BillsUpdateRequest.prototype, "billInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], BillsUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], BillsUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], BillsUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], BillsUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], BillsUpdateRequest.prototype, "xApideckServiceId", void 0);
    return BillsUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.BillsUpdateRequest = BillsUpdateRequest;
var BillsUpdateResponse = /** @class */ (function (_super) {
    ...
    ], BillsUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.BillsUpdateResponse = BillsUpdateResponse;
