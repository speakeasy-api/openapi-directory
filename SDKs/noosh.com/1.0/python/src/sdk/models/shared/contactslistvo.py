...
import dataclasses
from ..shared import contactssimplevo as shared_contactssimplevo
...
class ContactsListVO:
    r"""Java type: com.noosh.nooshapi.vo.ContactsListVO"""
    
    results: Optional[list[shared_contactssimplevo.ContactsSimpleVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
