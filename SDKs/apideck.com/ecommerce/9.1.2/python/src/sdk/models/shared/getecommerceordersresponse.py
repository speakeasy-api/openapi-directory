...
import dataclasses
from ..shared import ecommerceorder as shared_ecommerceorder
...
class GetEcommerceOrdersResponse:
    r"""Orders"""
    
    data: list[shared_ecommerceorder.EcommerceOrder] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
