...
from ..shared import updatedevicestatusrequest as shared_updatedevicestatusrequest
...
class UpdateDeviceStatusHeaders:
    x_amz_target: UpdateDeviceStatusXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDeviceStatusRequest:
    headers: UpdateDeviceStatusHeaders = dataclasses.field()
    request: shared_updatedevicestatusrequest.UpdateDeviceStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateDeviceStatusResponse:
    ...
    update_device_status_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
