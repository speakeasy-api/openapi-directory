...
func main() {
    ...
    res, err := s.Images.VisionImagesAnnotate(ctx, operations.VisionImagesAnnotateRequest{
        ...
        GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest: &shared.GoogleCloudVisionV1p2beta1BatchAnnotateImagesRequest{
            ...
            Requests: []shared.GoogleCloudVisionV1p2beta1AnnotateImageRequest{
                shared.GoogleCloudVisionV1p2beta1AnnotateImageRequest{
                    Features: []shared.GoogleCloudVisionV1p2beta1Feature{
                        shared.GoogleCloudVisionV1p2beta1Feature{
                            ...
                            Type: shared.GoogleCloudVisionV1p2beta1FeatureTypeEnumProductSearch.ToPointer(),
                        },
                        shared.GoogleCloudVisionV1p2beta1Feature{
                            MaxResults: sdk.Int(411372),
                            Model: sdk.String("impedit"),
                            Type: shared.GoogleCloudVisionV1p2beta1FeatureTypeEnumLabelDetection.ToPointer(),
                        },
                    },
                    Image: &shared.GoogleCloudVisionV1p2beta1Image{
                        Content: sdk.String("veniam"),
                        Source: &shared.GoogleCloudVisionV1p2beta1ImageSource{
                ...
                shared.GoogleCloudVisionV1p2beta1AnnotateImageRequest{
                    Features: []shared.GoogleCloudVisionV1p2beta1Feature{
                        shared.GoogleCloudVisionV1p2beta1Feature{
                            ...
                            Type: shared.GoogleCloudVisionV1p2beta1FeatureTypeEnumWebDetection.ToPointer(),
                        },
                        shared.GoogleCloudVisionV1p2beta1Feature{
    ...
    if res.GoogleCloudVisionV1p2beta1BatchAnnotateImagesResponse != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    res, err := s.Images.VisionImagesAsyncBatchAnnotate(ctx, operations.VisionImagesAsyncBatchAnnotateRequest{
        ...
        GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest: &shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateImagesRequest{
            OutputConfig: &shared.GoogleCloudVisionV1p2beta1OutputConfig{
                BatchSize: sdk.Int(97468),
                GcsDestination: &shared.GoogleCloudVisionV1p2beta1GcsDestination{
                ...
                shared.GoogleCloudVisionV1p2beta1AnnotateImageRequest{
                    Features: []shared.GoogleCloudVisionV1p2beta1Feature{
                        shared.GoogleCloudVisionV1p2beta1Feature{
                            ...
                            Type: shared.GoogleCloudVisionV1p2beta1FeatureTypeEnumFaceDetection.ToPointer(),
                        },
                        shared.GoogleCloudVisionV1p2beta1Feature{
