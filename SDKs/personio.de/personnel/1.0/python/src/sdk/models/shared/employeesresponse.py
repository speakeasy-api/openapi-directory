...
class EmployeesResponseData:
    attributes: list[EmployeesResponseDataAttributes] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('attributes') }})
...
class EmployeesResponse:
    data: list[EmployeesResponseData] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
