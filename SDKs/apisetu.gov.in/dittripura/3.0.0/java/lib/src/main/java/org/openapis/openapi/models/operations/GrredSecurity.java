...
public class GrredSecurity {
    ...
    public GrredSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public GrredSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public GrredSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
