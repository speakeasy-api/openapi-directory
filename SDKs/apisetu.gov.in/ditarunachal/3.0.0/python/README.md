...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/ditarunachal/3.0.0/python
```
...
req = operations.IlpmtRequestBody(
    certificate_parameters=operations.IlpmtRequestBodyCertificateParameters(
        ...
        uid="123412341234",
        e_ilp_app_id="94XXX",
        e_ilp_contact_number="98765XXXXX",
    ),
...
res = s.ap_is.ilpmt(req, operations.IlpmtSecurity(
