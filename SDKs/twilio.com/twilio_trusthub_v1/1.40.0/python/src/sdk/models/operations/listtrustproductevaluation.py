...
class ListTrustProductEvaluationListTrustProductEvaluationResponse:
    ...
    meta: Optional[ListTrustProductEvaluationListTrustProductEvaluationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    results: Optional[list[shared_trusthub_v1_trust_product_trust_product_evaluation.TrusthubV1TrustProductTrustProductEvaluation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
