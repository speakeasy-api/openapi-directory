...
try {
    ...
    $request->getIamPolicyRequest->options->requestedPolicyVersion = 297534;
...
try {
    ...
    $response = $sdk->v1beta1->iapSetIamPolicy($request, $requestSecurity);
...
try {
    ...
    $response = $sdk->v1beta1->iapTestIamPermissions($request, $requestSecurity);
