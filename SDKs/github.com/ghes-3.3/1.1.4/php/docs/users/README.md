...
try {
    ...
    $request->username = 'Jordi.Prohaska';
...
try {
    ...
    $request->username = 'Jeff_Stoltenberg7';
...
try {
    ...
    $request->username = 'Faustino.Osinski80';
...
try {
    ...
    $request->perPage = 840641;
    $request->since = 762525;
...
try {
    ...
    $request->page = 960767;
    $request->perPage = 204373;
    $request->username = 'Lucile.Hoeger4';
...
try {
    ...
    $request->page = 20141;
    $request->perPage = 514480;
    $request->username = 'Jaylan.Lockman';
...
try {
    ...
    $request->page = 308658;
    $request->perPage = 228907;
    $request->username = 'Verna.Herzog';
...
try {
    ...
    $request->page = 515595;
    $request->perPage = 722392;
    $request->username = 'Frederic.Hamill';
