...
class GetImageLicenseListDownloadAvailabilityEnum(str, Enum):
...
class GetImageLicenseListRequest:
    ...
    download_availability: Optional[GetImageLicenseListDownloadAvailabilityEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'download_availability', 'style': 'form', 'explode': True }})
    r"""Filter licenses by download availability"""  
    ...
    r"""Show licenses for the specified image ID"""  
    license: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'license', 'style': 'form', 'explode': True }})
    r"""Show images that are available with the specified license, such as `standard` or `enhanced`; prepending a `-` sign excludes results from that license"""  
