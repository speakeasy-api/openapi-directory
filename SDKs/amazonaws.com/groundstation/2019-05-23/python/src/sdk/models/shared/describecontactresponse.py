...
class DescribeContactResponse:
    ...
    dataflow_list: Optional[list[shared_dataflowdetail.DataflowDetail]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataflowList'), 'exclude': lambda f: f is None }})  
