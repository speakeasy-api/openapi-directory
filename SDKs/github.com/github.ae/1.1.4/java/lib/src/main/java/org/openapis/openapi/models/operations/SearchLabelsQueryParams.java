...
public class SearchLabelsQueryParams {
    ...
    public SearchLabelsQueryParams withOrder(org.openapis.openapi.models.shared.OrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public SearchLabelsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public SearchLabelsQueryParams withPerPage(Long perPage) {
