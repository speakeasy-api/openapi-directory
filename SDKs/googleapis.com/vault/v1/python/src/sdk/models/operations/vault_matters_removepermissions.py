...
class VaultMattersRemovePermissionsRequest:
    ...
    remove_matter_permissions_request: Optional[shared_removematterpermissionsrequest.RemoveMatterPermissionsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
