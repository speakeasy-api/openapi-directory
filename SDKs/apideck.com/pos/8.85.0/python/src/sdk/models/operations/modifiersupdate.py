...
from ..shared import updatemodifierresponse as shared_updatemodifierresponse
...
class ModifiersUpdateRequest:
    headers: ModifiersUpdateHeaders = dataclasses.field()
    path_params: ModifiersUpdatePathParams = dataclasses.field()
    query_params: ModifiersUpdateQueryParams = dataclasses.field()
    request: shared_modifier.ModifierInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ModifiersUpdateSecurity = dataclasses.field()
...
class ModifiersUpdateResponse:
    ...
    update_modifier_response: Optional[shared_updatemodifierresponse.UpdateModifierResponse] = dataclasses.field(default=None)
