...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.GETDescribeGlobalClustersResponse getDescribeGlobalClusters(org.openapis.openapi.models.operations.GETDescribeGlobalClustersRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GETDescribeGlobalClustersQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
