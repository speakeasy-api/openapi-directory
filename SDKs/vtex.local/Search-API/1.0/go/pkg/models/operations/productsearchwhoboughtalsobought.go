...
var ProductSearchWhoBoughtAlsoBoughtServerList = []string{
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsKitItems struct {
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsReferenceID struct {
	// Reference Code.
	Key string `json:"Key"`
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples struct {
...
// ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0 - Delivery SLA ID.
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0 struct {
	// Delivery SLA per types.
	DeliverySLAPerTypes []interface{} `json:"DeliverySlaPerTypes"`
	// Region.
	Region string `json:"Region"`
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion struct {
	// Delivery SLA ID.
	Zero *ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0 `json:"0,omitempty"`
}

type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferInstallments struct {
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments struct {
	// Count.
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments struct {
	// Count.
	Count int64 `json:"count"`
	// Has interest rate.
	HasInterestRate bool `json:"hasInterestRate"`
	...
	SellerMerchantInstallments []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments `json:"sellerMerchantInstallments"`
	// Total.
	Total int64 `json:"total"`
	// Value.
	Value int64 `json:"value"`
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions struct {
	// Bin.
	Bin string `json:"bin"`
	// Installments.
	Installments []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments `json:"installments"`
	// Payment group name.
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems struct {
	// Available payments.
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptions struct {
	// Available accounts.
	...
	// installment options.
	InstallmentOptions []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions `json:"installmentOptions"`
	// Payment systems.
	PaymentSystems []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems `json:"paymentSystems"`
	// Payments.
	Payments []interface{} `json:"payments"`
}

// ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOffer - AKA Commertial Condition.
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOffer struct {
	...
	DeliverySLASamples []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples `json:"DeliverySlaSamples"`
	// Delivery SLA samples per region.
	DeliverySLASamplesPerRegion ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion `json:"DeliverySlaSamplesPerRegion"`
	// Discount hightlight.
	...
	Installments []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferInstallments `json:"Installments"`
	...
	// Payment options.
	PaymentOptions ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOfferPaymentOptions `json:"PaymentOptions"`
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellers struct {
	// URL to add the product to the cart.
	AddToCartLink string `json:"addToCartLink"`
	// AKA Commertial Condition.
	CommertialOffer ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellersCommertialOffer `json:"commertialOffer"`
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSONItems struct {
	// Videos.
	...
	Images []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsImages `json:"images"`
	// If the SKU is part of a kit.
	IsKit bool `json:"isKit"`
	// SKU ID.
	ItemID string `json:"itemId"`
	// Array with information of SKUs components from a Kit.
	KitItems []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsKitItems `json:"kitItems"`
	...
	// Reference code ID.
	ReferenceID []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsReferenceID `json:"referenceId"`
	// Array of SKU sellers.
	Sellers []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItemsSellers `json:"sellers"`
...
type ProductSearchWhoBoughtAlsoBought200ApplicationJSON struct {
	...
	Items []ProductSearchWhoBoughtAlsoBought200ApplicationJSONItems `json:"items"`
	// Product URL.
...
type ProductSearchWhoBoughtAlsoBoughtResponse struct {
	ContentType string
	// OK
