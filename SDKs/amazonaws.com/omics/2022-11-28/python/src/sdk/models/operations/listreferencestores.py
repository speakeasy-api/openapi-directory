...
from ..shared import listreferencestoresresponse as shared_listreferencestoresresponse
...
class ListReferenceStoresRequestBodyFilter:
    r"""A filter for reference stores."""
...
class ListReferenceStoresRequestBody:
    ...
    filter: Optional[ListReferenceStoresRequestBodyFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filter'), 'exclude': lambda f: f is None }})
    r"""A filter for reference stores."""  
...
class ListReferenceStoresRequest:
    ...
    request_body: ListReferenceStoresRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListReferenceStoresResponse:
    ...
    list_reference_stores_response: Optional[shared_listreferencestoresresponse.ListReferenceStoresResponse] = dataclasses.field(default=None)
    r"""Success"""  
