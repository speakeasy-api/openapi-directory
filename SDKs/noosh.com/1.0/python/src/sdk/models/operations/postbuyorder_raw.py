...
from ..shared import orderpo as shared_orderpo
from typing import Optional


@dataclasses.dataclass
class PostBuyOrderRawRequest:
...
class PostBuyOrderRawResponse:
    ...
    r"""Invalid data"""  
    order_po: Optional[shared_orderpo.OrderPO] = dataclasses.field(default=None)
