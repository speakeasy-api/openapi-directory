...
class ModifiersDeleteRequest:
    headers: ModifiersDeleteHeaders = dataclasses.field()
    path_params: ModifiersDeletePathParams = dataclasses.field()
    query_params: ModifiersDeleteQueryParams = dataclasses.field()
    security: ModifiersDeleteSecurity = dataclasses.field()
