 ...
 */
export class GetTransitGatewayPrefixListReferencesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetTransitGatewayPrefixListReferencesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
