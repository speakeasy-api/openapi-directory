...
/**
 * NodesReadNodeAttributes - The properties of the node entity.
 * 
 * @package OpenAPI\OpenAPI\Models\Operations
 * @access public
 */
class NodesReadNodeAttributes
{
    /**
     * The category of the node, as selected by project contributors.
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\NodesReadNodeAttributesCategoryEnum $category
     */
	
    public NodesReadNodeAttributesCategoryEnum $category;
	...
	{
		$this->category = \OpenAPI\OpenAPI\Models\Operations\NodesReadNodeAttributesCategoryEnum::ANALYSIS;
