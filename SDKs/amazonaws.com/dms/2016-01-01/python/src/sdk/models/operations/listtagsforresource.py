...
from ..shared import listtagsforresourcemessage as shared_listtagsforresourcemessage
...
class ListTagsForResourceRequest:
    ...
    request: shared_listtagsforresourcemessage.ListTagsForResourceMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
