...
func (e *CreateOpenIDIdpConfigRequestFlowEnum) UnmarshalJSON(data []byte) error {
	...
	case "authorization_code":
		fallthrough
	case "hybrid":
		*e = CreateOpenIDIdpConfigRequestFlowEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOpenIDIdpConfigRequestFlowEnum: %s", s)
	}
}
...
func (e *CreateOpenIDIdpConfigRequestUserInfoSourceEnum) UnmarshalJSON(data []byte) error {
	...
	case "user_info_endpoint":
		fallthrough
	case "id_token":
		*e = CreateOpenIDIdpConfigRequestUserInfoSourceEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOpenIDIdpConfigRequestUserInfoSourceEnum: %s", s)
	}
}
