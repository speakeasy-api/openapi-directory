...
from ..shared import security as shared_security
from ..shared import googlefirebaseappcheckv1betaexchangeappattestassertionrequest as shared_googlefirebaseappcheckv1betaexchangeappattestassertionrequest
...
class FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest:
    ...
    request: Optional[shared_googlefirebaseappcheckv1betaexchangeappattestassertionrequest.GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
