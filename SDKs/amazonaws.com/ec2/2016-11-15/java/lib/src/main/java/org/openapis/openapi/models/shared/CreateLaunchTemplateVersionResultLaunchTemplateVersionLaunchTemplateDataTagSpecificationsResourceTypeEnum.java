 ...
 */
public enum CreateLaunchTemplateVersionResultLaunchTemplateVersionLaunchTemplateDataTagSpecificationsResourceTypeEnum {
    ...
    private CreateLaunchTemplateVersionResultLaunchTemplateVersionLaunchTemplateDataTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
