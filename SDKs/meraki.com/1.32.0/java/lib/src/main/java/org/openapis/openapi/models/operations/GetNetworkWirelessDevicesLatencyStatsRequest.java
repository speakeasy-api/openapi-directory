...
public class GetNetworkWirelessDevicesLatencyStatsRequest {
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withBand(GetNetworkWirelessDevicesLatencyStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withNetworkId(String networkId) {
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withTimespan(Float timespan) {
    ...
    public GetNetworkWirelessDevicesLatencyStatsRequest withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
    
    public GetNetworkWirelessDevicesLatencyStatsRequest(@JsonProperty("networkId") String networkId) {
        this.networkId = networkId;
  }
}
