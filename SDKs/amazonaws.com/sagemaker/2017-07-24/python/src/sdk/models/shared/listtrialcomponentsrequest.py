...
from ..shared import sorttrialcomponentsby_enum as shared_sorttrialcomponentsby_enum
...
class ListTrialComponentsRequest:
    ...
    sort_by: Optional[shared_sorttrialcomponentsby_enum.SortTrialComponentsByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
