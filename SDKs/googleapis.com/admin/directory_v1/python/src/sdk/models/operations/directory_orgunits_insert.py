...
class DirectoryOrgunitsInsertSecurity:
...
@dataclasses.dataclass
class DirectoryOrgunitsInsertRequest:
    ...
    org_unit: Optional[shared_orgunit.OrgUnit] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class DirectoryOrgunitsInsertResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    org_unit: Optional[shared_orgunit.OrgUnit] = dataclasses.field(default=None)
