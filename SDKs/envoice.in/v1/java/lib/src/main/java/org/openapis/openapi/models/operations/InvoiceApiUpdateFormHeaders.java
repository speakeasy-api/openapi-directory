...
public class InvoiceApiUpdateFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiUpdateFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiUpdateFormHeaders withXAuthSecret(String xAuthSecret) {
