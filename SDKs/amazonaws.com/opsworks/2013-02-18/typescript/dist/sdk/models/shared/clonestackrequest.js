...
exports.CloneStackRequest = void 0;
...
var CloneStackRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CloneAppIds" }),
        __metadata("design:type", Array)
    ], CloneStackRequest.prototype, "cloneAppIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ClonePermissions" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SourceStackId" }),
        __metadata("design:type", String)
