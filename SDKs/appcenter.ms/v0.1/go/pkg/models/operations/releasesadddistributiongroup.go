...
type ReleasesAddDistributionGroupPathParams struct {
...
type ReleasesAddDistributionGroupRequest struct {
	PathParams ReleasesAddDistributionGroupPathParams
	// The release information.
	Request  ReleasesAddDistributionGroupRequestBody `request:"mediaType=application/json"`
	Security ReleasesAddDistributionGroupSecurity
}
