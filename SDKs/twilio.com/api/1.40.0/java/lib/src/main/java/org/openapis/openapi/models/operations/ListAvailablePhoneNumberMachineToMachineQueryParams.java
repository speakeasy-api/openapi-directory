...
public class ListAvailablePhoneNumberMachineToMachineQueryParams {
    ...
    public Long page;
    public ListAvailablePhoneNumberMachineToMachineQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListAvailablePhoneNumberMachineToMachineQueryParams withPageToken(String pageToken) {
