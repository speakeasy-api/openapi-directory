...
export class Customchannels {
  ...
  adsensehostCustomchannelsDelete(
    ...
    security: operations.AdsensehostCustomchannelsDeleteSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensehostCustomchannelsDeleteSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AdsensehostCustomchannelsDeleteResponse =
        new operations.AdsensehostCustomchannelsDeleteResponse({
  ...
  adsensehostCustomchannelsGet(
    ...
    security: operations.AdsensehostCustomchannelsGetSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensehostCustomchannelsGetSecurity(security);
    }
    const client: AxiosInstance = utils.createSecurityClient(
      this._defaultClient,
      security
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AdsensehostCustomchannelsGetResponse =
        new operations.AdsensehostCustomchannelsGetResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  adsensehostCustomchannelsInsert(
    ...
    security: operations.AdsensehostCustomchannelsInsertSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensehostCustomchannelsInsertSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AdsensehostCustomchannelsInsertResponse =
        new operations.AdsensehostCustomchannelsInsertResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  adsensehostCustomchannelsList(
    ...
    security: operations.AdsensehostCustomchannelsListSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensehostCustomchannelsListSecurity(security);
    }
    const client: AxiosInstance = utils.createSecurityClient(
      this._defaultClient,
      security
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AdsensehostCustomchannelsListResponse =
        new operations.AdsensehostCustomchannelsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  adsensehostCustomchannelsPatch(
    ...
    security: operations.AdsensehostCustomchannelsPatchSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensehostCustomchannelsPatchSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AdsensehostCustomchannelsPatchResponse =
        new operations.AdsensehostCustomchannelsPatchResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  adsensehostCustomchannelsUpdate(
    ...
    security: operations.AdsensehostCustomchannelsUpdateSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsensehostCustomchannelsUpdateSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AdsensehostCustomchannelsUpdateResponse =
        new operations.AdsensehostCustomchannelsUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
