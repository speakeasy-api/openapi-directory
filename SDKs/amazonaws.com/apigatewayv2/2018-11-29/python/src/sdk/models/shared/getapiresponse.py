...
class GetAPIResponseProtocolTypeEnum(str, Enum):
    r"""The API protocol."""
    WEBSOCKET = 'WEBSOCKET'
    HTTP = 'HTTP'
...
class GetAPIResponse:
    ...
    cors_configuration: Optional[GetAPIResponseCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CorsConfiguration'), 'exclude': lambda f: f is None }})  
    ...
    protocol_type: Optional[GetAPIResponseProtocolTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProtocolType'), 'exclude': lambda f: f is None }})  
