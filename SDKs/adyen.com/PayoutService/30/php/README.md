...
try {
    ...
    $request->selectedBrand = 'totam';
    $request->shopperEmail = 'beatae';
    $request->shopperName = new Name();
    $request->shopperName->firstName = 'Haskell';
    $request->shopperName->lastName = 'Krajcik';
    $request->shopperReference = 'modi';
    $request->socialSecurityNumber = 'qui';
