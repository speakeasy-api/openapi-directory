...
class GetCasePhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetCasePhenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetCasePhenotypeAssociationsRequest:
    path_params: GetCasePhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetCasePhenotypeAssociationsQueryParams = dataclasses.field()
