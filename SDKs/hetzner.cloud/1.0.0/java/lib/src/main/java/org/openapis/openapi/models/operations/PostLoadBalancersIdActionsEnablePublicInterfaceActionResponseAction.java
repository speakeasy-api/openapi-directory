...
public class PostLoadBalancersIdActionsEnablePublicInterfaceActionResponseAction {
    ...
    public PostLoadBalancersIdActionsEnablePublicInterfaceActionResponseAction(@JsonProperty("command") String command, @JsonProperty("error") PostLoadBalancersIdActionsEnablePublicInterfaceActionResponseActionError error, @JsonProperty("finished") String finished, @JsonProperty("id") Long id, @JsonProperty("progress") Double progress, @JsonProperty("resources") PostLoadBalancersIdActionsEnablePublicInterfaceActionResponseActionResources[] resources, @JsonProperty("started") String started, @JsonProperty("status") PostLoadBalancersIdActionsEnablePublicInterfaceActionResponseActionStatusEnum status) {
        this.command = command;
        this.error = error;
        this.finished = finished;
        this.id = id;
