...
from ..shared import invoiceitemsfilter as shared_invoiceitemsfilter
...
class InvoiceItemsAllRequest:
    ...
    filter: Optional[shared_invoiceitemsfilter.InvoiceItemsFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
