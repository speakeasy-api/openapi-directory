...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/ipqualityscore.com/1.0.0/python
```
...
* `malicious_url_scanner` - Malicious URL Scanner
