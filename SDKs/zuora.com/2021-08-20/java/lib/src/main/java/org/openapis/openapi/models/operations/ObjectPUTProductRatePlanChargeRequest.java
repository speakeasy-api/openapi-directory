...
public class ObjectPUTProductRatePlanChargeRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyModifyProductRatePlanCharge proxyModifyProductRatePlanCharge;
    public ObjectPUTProductRatePlanChargeRequest withProxyModifyProductRatePlanCharge(org.openapis.openapi.models.shared.ProxyModifyProductRatePlanCharge proxyModifyProductRatePlanCharge) {
    ...
    public ObjectPUTProductRatePlanChargeRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ObjectPUTProductRatePlanChargeRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ObjectPUTProductRatePlanChargeRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public String id;
    public ObjectPUTProductRatePlanChargeRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ObjectPUTProductRatePlanChargeRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
