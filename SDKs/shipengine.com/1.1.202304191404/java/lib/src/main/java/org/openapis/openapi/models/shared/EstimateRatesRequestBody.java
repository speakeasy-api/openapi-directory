...
public class EstimateRatesRequestBody {
    ...
    public EstimateRatesRequestBody(@JsonProperty("from_city_locality") String fromCityLocality, @JsonProperty("from_country_code") String fromCountryCode, @JsonProperty("from_postal_code") String fromPostalCode, @JsonProperty("from_state_province") String fromStateProvince, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("to_city_locality") String toCityLocality, @JsonProperty("to_country_code") String toCountryCode, @JsonProperty("to_postal_code") String toPostalCode, @JsonProperty("to_state_province") String toStateProvince, @JsonProperty("weight") Weight weight) {
        this.fromCityLocality = fromCityLocality;
        this.fromCountryCode = fromCountryCode;
        this.fromPostalCode = fromPostalCode;
        this.fromStateProvince = fromStateProvince;
