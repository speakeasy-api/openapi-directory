...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/bungie.net/2.18.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/bungie.net/2.18.0/typescript
```
