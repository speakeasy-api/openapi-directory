...
exports.PaymentsProgram = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var PaymentsProgram = /** @class */ (function () {
    function PaymentsProgram(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PaymentsProgram.prototype.getPaymentsProgram = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPaymentsProgramRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/payments_program/{marketplace_id}/{payments_program_type}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.paymentsProgramResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
...
exports.PaymentsProgram = PaymentsProgram;
