...
class GoogleCloudVisionV1p1beta1WebDetection:
    ...
    best_guess_labels: Optional[list[shared_googlecloudvisionv1p1beta1webdetectionweblabel.GoogleCloudVisionV1p1beta1WebDetectionWebLabel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bestGuessLabels'), 'exclude': lambda f: f is None }})
    ...
    pages_with_matching_images: Optional[list[shared_googlecloudvisionv1p1beta1webdetectionwebpage.GoogleCloudVisionV1p1beta1WebDetectionWebPage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pagesWithMatchingImages'), 'exclude': lambda f: f is None }})
    ...
    visually_similar_images: Optional[list[shared_googlecloudvisionv1p1beta1webdetectionwebimage.GoogleCloudVisionV1p1beta1WebDetectionWebImage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('visuallySimilarImages'), 'exclude': lambda f: f is None }})
    r"""The visually similar image results."""  
    web_entities: Optional[list[shared_googlecloudvisionv1p1beta1webdetectionwebentity.GoogleCloudVisionV1p1beta1WebDetectionWebEntity]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webEntities'), 'exclude': lambda f: f is None }})
