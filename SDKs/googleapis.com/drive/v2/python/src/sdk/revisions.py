...
class Revisions:
    ...
    def drive_revisions_delete(self, request: operations.DriveRevisionsDeleteRequest) -> operations.DriveRevisionsDeleteResponse:
        r"""Permanently deletes a file version. You can only delete revisions for files with binary content, like images or videos. Revisions for other files, like Google Docs or Sheets, and the last remaining file version can't be deleted.
        """
