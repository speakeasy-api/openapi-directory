...
class GetPhenotypePathwayAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypePathwayAssociationsQueryParams:
...
class GetPhenotypePathwayAssociationsRequest:
    path_params: GetPhenotypePathwayAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypePathwayAssociationsQueryParams = dataclasses.field()
