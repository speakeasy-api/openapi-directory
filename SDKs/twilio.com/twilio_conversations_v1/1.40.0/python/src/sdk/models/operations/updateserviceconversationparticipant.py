...
class UpdateServiceConversationParticipantRequest:
    ...
    request_body: Optional[UpdateServiceConversationParticipantUpdateServiceConversationParticipantRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
