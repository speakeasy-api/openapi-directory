...
exports.ExecutionStageState = exports.ExecutionStageStateExecutionStageStateEnum = void 0;
var utils_1 = require("../../../internal/utils");
var class_transformer_1 = require("class-transformer");
/**
 * Executions stage states allow the same set of values as JobState.
 */
var ExecutionStageStateExecutionStageStateEnum;
...
})(ExecutionStageStateExecutionStageStateEnum = exports.ExecutionStageStateExecutionStageStateEnum || (exports.ExecutionStageStateExecutionStageStateEnum = {}));
/**
...
var ExecutionStageState = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "executionStageName" }),
        __metadata("design:type", String)
    ], ExecutionStageState.prototype, "executionStageName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "executionStageState" }),
        __metadata("design:type", String)
    ], ExecutionStageState.prototype, "executionStageState", void 0);
    return ExecutionStageState;
}(utils_1.SpeakeasyBase));
exports.ExecutionStageState = ExecutionStageState;
