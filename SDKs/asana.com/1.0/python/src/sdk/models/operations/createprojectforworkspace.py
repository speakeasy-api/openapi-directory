...
class CreateProjectForWorkspaceRequest:
    ...
    request_body: CreateProjectForWorkspaceRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The new project to create."""  
...
class CreateProjectForWorkspace201ApplicationJSON:
    r"""Successfully created a new project in the specified workspace."""
