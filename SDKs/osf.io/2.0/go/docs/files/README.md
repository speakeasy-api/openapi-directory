...
func main() {
    ...
    res, err := s.Files.FilesDetail(ctx, operations.FilesDetailRequest{
        FileID: "id",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Files.FilesPatch(ctx, operations.FilesPatchRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Files.FilesVersionDetail(ctx, operations.FilesVersionDetailRequest{
        FileID: "nihil",
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Files.FilesVersions(ctx, operations.FilesVersionsRequest{
        FileID: "voluptatibus",
    })
    if err != nil {
        log.Fatal(err)
