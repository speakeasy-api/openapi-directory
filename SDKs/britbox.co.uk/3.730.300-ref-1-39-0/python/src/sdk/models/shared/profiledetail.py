...
class ProfileDetail:
    ...
    bookmarked: dict[str, datetime] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bookmarked') }})
    r"""A map of bookmarked itemIds => created date"""  
    ...
    **DEPRECATED** - Marketing material is no longer tied to profiles, only account. See `Account.marketingEnabled`.
    ...
    rated: dict[str, int] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rated') }})
    r"""A map of rated itemIds => rating out of 10"""  
    ...
    watched: dict[str, shared_watched.Watched] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('watched') }})
    r"""A map of watched itemIds => last watched position"""  
