...
exports.ListTaskQueueResponse = exports.ListTaskQueueListTaskQueueResponse = exports.ListTaskQueueListTaskQueueResponseMeta = exports.ListTaskQueueRequest = exports.ListTaskQueueSecurity = exports.ListTaskQueueServerList = void 0;
...
var ListTaskQueueSecurity = /** @class */ (function (_super) {
    ...
    ], ListTaskQueueSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListTaskQueueSecurity.prototype, "username", void 0);
...
var ListTaskQueueRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListTaskQueueRequest.prototype, "evaluateWorkerAttributes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FriendlyName",
        }),
        __metadata("design:type", String)
    ], ListTaskQueueRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Ordering",
        }),
        __metadata("design:type", String)
    ], ListTaskQueueRequest.prototype, "ordering", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListTaskQueueRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListTaskQueueRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListTaskQueueRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=WorkerSid",
        }),
        __metadata("design:type", String)
    ], ListTaskQueueRequest.prototype, "workerSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], ListTaskQueueRequest.prototype, "workspaceSid", void 0);
...
var ListTaskQueueListTaskQueueResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListTaskQueueListTaskQueueResponseMeta; }),
        __metadata("design:type", ListTaskQueueListTaskQueueResponseMeta)
    ], ListTaskQueueListTaskQueueResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TaskrouterV1WorkspaceTaskQueue }),
        (0, class_transformer_1.Expose)({ name: "task_queues" }),
        (0, class_transformer_1.Type)(function () { return shared.TaskrouterV1WorkspaceTaskQueue; }),
...
var ListTaskQueueResponse = /** @class */ (function (_super) {
    ...
    ], ListTaskQueueResponse.prototype, "rawResponse", void 0);
