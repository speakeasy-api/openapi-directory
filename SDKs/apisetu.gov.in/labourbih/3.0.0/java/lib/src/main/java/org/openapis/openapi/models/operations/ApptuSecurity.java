...
public class ApptuSecurity {
    ...
    public ApptuSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public ApptuSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public ApptuSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
