...
public class DcimDeviceBayTemplatesListQueryParams {
    ...
    public DcimDeviceBayTemplatesListQueryParams withDevicetypeIdN(String devicetypeIdN) {
    ...
    public String id;
    public DcimDeviceBayTemplatesListQueryParams withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String idGt;
    public DcimDeviceBayTemplatesListQueryParams withIdGt(String idGt) {
        this.idGt = idGt;
        return this;
    }
    ...
    public String idGte;
    public DcimDeviceBayTemplatesListQueryParams withIdGte(String idGte) {
        this.idGte = idGte;
        return this;
    }
    ...
    public String idLt;
    public DcimDeviceBayTemplatesListQueryParams withIdLt(String idLt) {
        this.idLt = idLt;
        return this;
    }
    ...
    public String idLte;
    public DcimDeviceBayTemplatesListQueryParams withIdLte(String idLte) {
        this.idLte = idLte;
        return this;
    }
    ...
    public String idN;
    public DcimDeviceBayTemplatesListQueryParams withIdN(String idN) {
        this.idN = idN;
        return this;
    }
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameIc(String nameIc) {
        this.nameIc = nameIc;
        return this;
    }
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameIe(String nameIe) {
        this.nameIe = nameIe;
        return this;
    }
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameIew(String nameIew) {
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameIsw(String nameIsw) {
    ...
    public String nameN;
    public DcimDeviceBayTemplatesListQueryParams withNameN(String nameN) {
        this.nameN = nameN;
        return this;
    }
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameNic(String nameNic) {
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameNie(String nameNie) {
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameNiew(String nameNiew) {
    ...
    public DcimDeviceBayTemplatesListQueryParams withNameNisw(String nameNisw) {
    ...
    public String q;
    public DcimDeviceBayTemplatesListQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
