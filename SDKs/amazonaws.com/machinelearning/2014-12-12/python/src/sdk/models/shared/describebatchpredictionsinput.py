...
from ..shared import batchpredictionfiltervariable_enum as shared_batchpredictionfiltervariable_enum
...
class DescribeBatchPredictionsInput:
    ...
    filter_variable: Optional[shared_batchpredictionfiltervariable_enum.BatchPredictionFilterVariableEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FilterVariable') }})
