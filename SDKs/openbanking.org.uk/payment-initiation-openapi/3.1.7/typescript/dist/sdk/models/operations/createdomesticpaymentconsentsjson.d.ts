...
export declare class CreateDomesticPaymentConsentsJsonSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateDomesticPaymentConsentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticPaymentConsentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
