 ...
 * Face landmark type.
 */
export declare enum GoogleCloudVisionV1p2beta1FaceAnnotationLandmarkTypeEnum {
 ...
 */
export declare class GoogleCloudVisionV1p2beta1FaceAnnotationLandmark extends SpeakeasyBase {
    /**
