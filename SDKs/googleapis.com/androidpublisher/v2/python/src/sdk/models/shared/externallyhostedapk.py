...
class ExternallyHostedApk:
    ...
    uses_permissions: Optional[list[shared_externallyhostedapkusespermission.ExternallyHostedApkUsesPermission]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usesPermissions') }})
