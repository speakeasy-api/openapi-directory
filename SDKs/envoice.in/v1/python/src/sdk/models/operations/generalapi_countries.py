...
from ..shared import countrydetailsapimodel as shared_countrydetailsapimodel
...
class GeneralAPICountriesResponse:
    ...
    country_details_api_models: Optional[list[shared_countrydetailsapimodel.CountryDetailsAPIModel]] = dataclasses.field(default=None)
    r"""OK"""  
