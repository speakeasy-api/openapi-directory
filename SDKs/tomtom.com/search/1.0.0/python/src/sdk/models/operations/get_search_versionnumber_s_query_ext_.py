...
class GetSearchVersionNumberSQueryExtPathParams:
...
@dataclasses.dataclass
class GetSearchVersionNumberSQueryExtQueryParams:
...
class GetSearchVersionNumberSQueryExtRequest:
    path_params: GetSearchVersionNumberSQueryExtPathParams = dataclasses.field()
    query_params: GetSearchVersionNumberSQueryExtQueryParams = dataclasses.field()
