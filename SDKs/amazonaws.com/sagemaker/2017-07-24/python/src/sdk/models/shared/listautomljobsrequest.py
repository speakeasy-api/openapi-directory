...
from ..shared import automlsortby_enum as shared_automlsortby_enum
...
class ListAutoMLJobsRequest:
    ...
    sort_by: Optional[shared_automlsortby_enum.AutoMLSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    ...
    status_equals: Optional[shared_automljobstatus_enum.AutoMLJobStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
