...
public class GetCountryQueryParams {
    ...
    public GetCountryQueryParams withCountryCode(String countryCode) {
    ...
    public GetCountryQueryParams withFormat(String format) {
        this.format = format;
        return this;
    }
    ...
    public String key;
    public GetCountryQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public String lang;
    public GetCountryQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetCountryQueryParams withParams(String params) {
        this.params = params;
        return this;
    }
