...
public class NtcerSecurity {
    ...
    public NtcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public NtcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public NtcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
