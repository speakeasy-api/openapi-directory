...
public class CloudtasksProjectsLocationsQueuesListQueryParams {
    ...
    public CloudtasksProjectsLocationsQueuesListQueryParams withDollarXgafv(openapisdk.models.shared.XgafvEnum dollarXgafv) {
    ...
    public CloudtasksProjectsLocationsQueuesListQueryParams withAlt(openapisdk.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
