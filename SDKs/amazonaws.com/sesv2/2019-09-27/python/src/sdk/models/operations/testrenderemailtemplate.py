...
class TestRenderEmailTemplateRequestBody:
    template_data: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TemplateData') }})
    

@dataclasses.dataclass
class TestRenderEmailTemplateRequest:
    headers: TestRenderEmailTemplateHeaders = dataclasses.field()
    path_params: TestRenderEmailTemplatePathParams = dataclasses.field()
    request: TestRenderEmailTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
