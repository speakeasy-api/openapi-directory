...
//
// ```
func (s *Export) AppSessionsByTime(ctx context.Context, request operations.AppSessionsByTimeRequest) (*operations.AppSessionsByTimeResponse, error) {
...
func (s *Export) CampaignAnalytics(ctx context.Context, request operations.CampaignAnalyticsRequest) (*operations.CampaignAnalyticsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/campaigns/data_series"
	...
	res := &operations.CampaignAnalyticsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
//
// ```
func (s *Export) CampaignDetails(ctx context.Context, request operations.CampaignDetailsRequest) (*operations.CampaignDetailsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/campaigns/details"
	...
	res := &operations.CampaignDetailsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
//
// ```
func (s *Export) CampaignList(ctx context.Context, request operations.CampaignListRequest) (*operations.CampaignListResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/campaigns/list"
	...
	res := &operations.CampaignListResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
//
// ```
func (s *Export) CanvasDataAnalyticsSummary(ctx context.Context, request operations.CanvasDataAnalyticsSummaryRequest) (*operations.CanvasDataAnalyticsSummaryResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) CanvasDataSeriesAnalytics(ctx context.Context, request operations.CanvasDataSeriesAnalyticsRequest) (*operations.CanvasDataSeriesAnalyticsResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) CanvasDetails(ctx context.Context, request operations.CanvasDetailsRequest) (*operations.CanvasDetailsResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) CanvasList(ctx context.Context, request operations.CanvasListRequest) (*operations.CanvasListResponse, error) {
	baseURL := s._serverURL
...
func (s *Export) CustomEventsAnalytics(ctx context.Context, request operations.CustomEventsAnalyticsRequest) (*operations.CustomEventsAnalyticsResponse, error) {
	baseURL := s._serverURL
...
// | 429 Rate Limited | Over rate limit                                                  |
// | 5XX              | Internal server error, you should retry with exponential backoff |
func (s *Export) CustomEventsList(ctx context.Context, request operations.CustomEventsListRequest) (*operations.CustomEventsListResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) DailyActiveUsersByDate(ctx context.Context, request operations.DailyActiveUsersByDateRequest) (*operations.DailyActiveUsersByDateResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) DailyNewUsersByDate(ctx context.Context, request operations.DailyNewUsersByDateRequest) (*operations.DailyNewUsersByDateResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) KpIsForDailyAppUninstallsByDate(ctx context.Context, request operations.KpIsForDailyAppUninstallsByDateRequest) (*operations.KpIsForDailyAppUninstallsByDateResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) MonthlyActiveUsersForLast30Days(ctx context.Context, request operations.MonthlyActiveUsersForLast30DaysRequest) (*operations.MonthlyActiveUsersForLast30DaysResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) NewsFeedCardAnalytics(ctx context.Context, request operations.NewsFeedCardAnalyticsRequest) (*operations.NewsFeedCardAnalyticsResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) NewsFeedCardsDetails(ctx context.Context, request operations.NewsFeedCardsDetailsRequest) (*operations.NewsFeedCardsDetailsResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) NewsFeedCardsList(ctx context.Context, request operations.NewsFeedCardsListRequest) (*operations.NewsFeedCardsListResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) SegmentAnalytics(ctx context.Context, request operations.SegmentAnalyticsRequest) (*operations.SegmentAnalyticsResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) SegmentDetails(ctx context.Context, request operations.SegmentDetailsRequest) (*operations.SegmentDetailsResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) SegmentList(ctx context.Context, request operations.SegmentListRequest) (*operations.SegmentListResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Export) SendAnalytics(ctx context.Context, request operations.SendAnalyticsRequest) (*operations.SendAnalyticsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/sends/data_series"
	...
	res := &operations.SendAnalyticsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
