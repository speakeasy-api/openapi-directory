...
class TeamDiscussion:
    r"""A team discussion is a persistent record of a free-form conversation within a team."""
    ...
    r"""The main text of the discussion."""  
    ...
    r"""The unique sequence number of a team discussion."""  
    pinned: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pinned') }})
    r"""Whether or not this discussion should be pinned for easy retrieval."""  
    private: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('private') }})
    r"""Whether or not this discussion should be restricted to team members and organization administrators."""  
    team_url: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('team_url') }})  
    title: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('title') }})
    r"""The title of the discussion."""  
