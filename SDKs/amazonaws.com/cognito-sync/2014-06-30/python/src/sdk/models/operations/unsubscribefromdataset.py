...
@dataclasses.dataclass
class UnsubscribeFromDatasetHeaders:
...
class UnsubscribeFromDatasetRequest:
    headers: UnsubscribeFromDatasetHeaders = dataclasses.field()
    path_params: UnsubscribeFromDatasetPathParams = dataclasses.field()
...
class UnsubscribeFromDatasetResponse:
    ...
    unsubscribe_from_dataset_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
