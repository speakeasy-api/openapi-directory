...
class GetSchedulesScheduleABySizeSizeEnum(str, Enum):
    ZERO = '0'
    TWO_HUNDRED = '200'
    FIVE_HUNDRED = '500'
    ONE_THOUSAND = '1000'
...
class GetSchedulesScheduleABySizeRequest:
    ...
    size: Optional[list[GetSchedulesScheduleABySizeSizeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'size', 'style': 'form', 'explode': True }})
