...
func (e GetOrganizationLicensingCotermLicenses200ApplicationJSONModeEnum) ToPointer() *GetOrganizationLicensingCotermLicenses200ApplicationJSONModeEnum {
	return &e
}
...
func (e *GetOrganizationLicensingCotermLicenses200ApplicationJSONModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "addDevices":
		fallthrough
	case "renew":
		*e = GetOrganizationLicensingCotermLicenses200ApplicationJSONModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationLicensingCotermLicenses200ApplicationJSONModeEnum: %v", v)
	}
}
