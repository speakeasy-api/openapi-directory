...
class TeamMatch:
    ...
    first_baron: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstBaron'), 'exclude': lambda f: f is None }})  
    first_blood: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstBlood'), 'exclude': lambda f: f is None }})  
    first_dragon: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstDragon'), 'exclude': lambda f: f is None }})  
    first_inhibitor: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstInhibitor'), 'exclude': lambda f: f is None }})  
    first_rift_herald: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstRiftHerald'), 'exclude': lambda f: f is None }})  
    first_tower: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstTower'), 'exclude': lambda f: f is None }})  
