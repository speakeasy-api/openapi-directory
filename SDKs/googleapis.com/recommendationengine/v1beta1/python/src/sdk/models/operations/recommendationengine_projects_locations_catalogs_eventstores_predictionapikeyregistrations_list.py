...
class RecommendationengineProjectsLocationsCatalogsEventStoresPredictionAPIKeyRegistrationsListRequest:
    ...
    r"""Required. The parent placement resource name such as `projects/1234/locations/global/catalogs/default_catalog/eventStores/default_event_store`"""  
    ...
    r"""Optional. Maximum number of results to return per page. If unset, the service will choose a reasonable default."""  
    page_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'pageToken', 'style': 'form', 'explode': True }})
    r"""Optional. The previous `ListPredictionApiKeyRegistration.nextPageToken`."""  
