...
var Host = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maintenance_mode" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "service_tag" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "vm_count" }),
        __metadata("design:type", Number)
    ], Host.prototype, "vmCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: reference_1.Reference }),
        (0, class_transformer_1.Expose)({ name: "vmknics" }),
        (0, class_transformer_1.Type)(function () { return reference_1.Reference; }),
        __metadata("design:type", Array)
