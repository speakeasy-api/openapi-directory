...
class DeleteSignalingChannelRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the signaling channel that you want to delete."""  
    ...
    r"""The current version of the signaling channel that you want to delete. You can obtain the current version by invoking the <code>DescribeSignalingChannel</code> or <code>ListSignalingChannels</code> API operations."""  
    

@dataclasses.dataclass
class DeleteSignalingChannelRequest:
    
    request_body: DeleteSignalingChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
