...
func (e *UpdateNetworkWirelessSsidVpnRequestBodySplitTunnelRulesProtocolEnum) UnmarshalJSON(data []byte) error {
	...
	case "TCP":
		fallthrough
	case "UDP":
		*e = UpdateNetworkWirelessSsidVpnRequestBodySplitTunnelRulesProtocolEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidVpnRequestBodySplitTunnelRulesProtocolEnum: %s", s)
	}
}
