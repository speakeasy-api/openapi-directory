...
from ..shared import verificationerror_recursive as shared_verificationerror_recursive
from dataclasses_json import Undefined, dataclass_json
from enum import Enum
from sdk import utils
from typing import Optional

class VerificationErrorCapabilitiesEnum(str, Enum):
...
class VerificationErrorTypeEnum(str, Enum):
    r"""The type of error."""
...
class VerificationError:
    ...
    capabilities: Optional[list[VerificationErrorCapabilitiesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('capabilities'), 'exclude': lambda f: f is None }})
    ...
    sub_errors: Optional[list[shared_verificationerror_recursive.VerificationErrorRecursive]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subErrors'), 'exclude': lambda f: f is None }})
    r"""An array containing more granular information about the cause of the verification error."""  
    type: Optional[VerificationErrorTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of error."""  
