...
class JSONSmsOutboundWithBody:
    ...
    concatenated: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('concatenated'), 'exclude': lambda f: f is None }})
    r"""Whether the SMS was split up into multiple parts (due to its length)."""  
    ...
    error_code_description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error_code_description'), 'exclude': lambda f: f is None }})
