...
class CreateCoreDefinitionRequestBody:
    initial_version: Optional[CreateCoreDefinitionRequestBodyInitialVersion] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('InitialVersion') }})
...
class CreateCoreDefinitionRequest:
    headers: CreateCoreDefinitionHeaders = dataclasses.field()
    request: CreateCoreDefinitionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
