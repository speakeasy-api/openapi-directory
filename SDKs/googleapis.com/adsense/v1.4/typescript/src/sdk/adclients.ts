...
export class Adclients {
  ...
  adsenseAdclientsList(
    ...
    security: operations.AdsenseAdclientsListSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsenseAdclientsListSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AdsenseAdclientsListResponse =
        new operations.AdsenseAdclientsListResponse({
