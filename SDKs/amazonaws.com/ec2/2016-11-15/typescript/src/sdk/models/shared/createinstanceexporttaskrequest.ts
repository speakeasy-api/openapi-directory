 ...
 */
export enum CreateInstanceExportTaskRequestExportToS3TaskContainerFormatEnum {
  Ova = "ova",
}
 ...
 */
export enum CreateInstanceExportTaskRequestExportToS3TaskDiskImageFormatEnum {
  Vmdk = "VMDK",
  Raw = "RAW",
  Vhd = "VHD",
}
 ...
 */
export class CreateInstanceExportTaskRequestExportToS3Task extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum CreateInstanceExportTaskRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateInstanceExportTaskRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateInstanceExportTaskRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum CreateInstanceExportTaskRequestTargetEnvironmentEnum {
  Citrix = "citrix",
  Vmware = "vmware",
  Microsoft = "microsoft",
}

export class CreateInstanceExportTaskRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  description?: string;
