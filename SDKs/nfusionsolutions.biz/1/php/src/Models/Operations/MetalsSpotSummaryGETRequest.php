...
class MetalsSpotSummaryGETRequest
{
    /**
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MetalsSpotSummaryGETFormatEnum $format
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=format')]
    public ?MetalsSpotSummaryGETFormatEnum $format = null;
     ...
     * dwt=pennyweight
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MetalsSpotSummaryGETUnitofmeasureEnum $unitofmeasure
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=unitofmeasure')]
    public ?MetalsSpotSummaryGETUnitofmeasureEnum $unitofmeasure = null;
