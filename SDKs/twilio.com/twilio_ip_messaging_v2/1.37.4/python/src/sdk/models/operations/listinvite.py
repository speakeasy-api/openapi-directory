...
class ListInviteListInviteResponse:
    invites: Optional[list[shared_ip_messaging_v2_service_channel_invite.IPMessagingV2ServiceChannelInvite]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('invites') }})
