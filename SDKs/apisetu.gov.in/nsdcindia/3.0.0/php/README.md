...
use \OpenAPI\OpenAPI\Models\Operations\EscerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\EscerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\EscerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\EscerSecurity;
...
try {
    ...
    $request->certificateParameters = new EscerRequestBodyCertificateParameters();
    $request->certificateParameters->dob = '31-12-1980';
    $request->certificateParameters->docid = '14tsi98v6oz0shve';
    ...
    $request->format = EscerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new EscerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->escer($request, $requestSecurity);
...
* [escer](docs/apis/README.md#escer) - Executive Skill Enhancement Certificate
