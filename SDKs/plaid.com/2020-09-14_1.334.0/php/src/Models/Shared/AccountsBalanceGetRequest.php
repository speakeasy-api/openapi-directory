...
class AccountsBalanceGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\AccountsBalanceGetRequestOptions $options
     */
	#[\JMS\Serializer\Annotation\SerializedName('options')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\AccountsBalanceGetRequestOptions')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AccountsBalanceGetRequestOptions $options = null;
