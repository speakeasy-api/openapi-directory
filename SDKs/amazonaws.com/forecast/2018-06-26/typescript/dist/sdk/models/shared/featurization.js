...
var Featurization = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: featurizationmethod_1.FeaturizationMethod }),
        (0, class_transformer_1.Expose)({ name: "FeaturizationPipeline" }),
        (0, class_transformer_1.Type)(function () { return featurizationmethod_1.FeaturizationMethod; }),
