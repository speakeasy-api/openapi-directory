...
class ConferenceMuteResponseMessageEnum(str, Enum):
    r"""Response message"""
...
class ConferenceMuteResponse:
    ...
    message: ConferenceMuteResponseMessageEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Message') }})
    r"""Response message"""  
