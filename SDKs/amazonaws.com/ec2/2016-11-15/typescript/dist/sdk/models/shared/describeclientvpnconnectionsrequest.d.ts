 ...
 */
export declare class DescribeClientVpnConnectionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeClientVpnConnectionsRequest extends SpeakeasyBase {
