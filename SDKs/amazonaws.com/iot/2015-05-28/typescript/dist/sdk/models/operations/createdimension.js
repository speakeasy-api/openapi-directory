...
exports.CreateDimensionResponse = exports.CreateDimensionRequest = exports.CreateDimensionRequestBody = exports.CreateDimensionRequestBodyTypeEnum = void 0;
 ...
 */
var CreateDimensionRequestBodyTypeEnum;
(function (CreateDimensionRequestBodyTypeEnum) {
    CreateDimensionRequestBodyTypeEnum["TopicFilter"] = "TOPIC_FILTER";
})(CreateDimensionRequestBodyTypeEnum = exports.CreateDimensionRequestBodyTypeEnum || (exports.CreateDimensionRequestBodyTypeEnum = {}));
...
exports.CreateDimensionRequestBody = CreateDimensionRequestBody;
var CreateDimensionRequest = /** @class */ (function (_super) {
    ...
    ], CreateDimensionRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name",
        }),
        __metadata("design:type", String)
    ], CreateDimensionRequest.prototype, "name", void 0);
    return CreateDimensionRequest;
}(utils_1.SpeakeasyBase));
exports.CreateDimensionRequest = CreateDimensionRequest;
var CreateDimensionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateDimensionResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
