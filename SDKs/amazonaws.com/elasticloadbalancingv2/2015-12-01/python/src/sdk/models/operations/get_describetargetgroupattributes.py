...
class GetDescribeTargetGroupAttributesQueryParams:
    action: GetDescribeTargetGroupAttributesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    target_group_arn: str = dataclasses.field(metadata={'query_param': { 'field_name': 'TargetGroupArn', 'style': 'form', 'explode': True }})
    version: GetDescribeTargetGroupAttributesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeTargetGroupAttributesRequest:
    headers: GetDescribeTargetGroupAttributesHeaders = dataclasses.field()
    query_params: GetDescribeTargetGroupAttributesQueryParams = dataclasses.field()
