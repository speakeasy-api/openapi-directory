...
class ListReviewableHITsRequest:
    ...
    list_reviewable_hi_ts_request: shared_listreviewablehitsrequest.ListReviewableHITsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
