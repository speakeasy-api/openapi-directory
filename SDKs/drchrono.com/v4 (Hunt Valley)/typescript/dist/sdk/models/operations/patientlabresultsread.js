...
exports.PatientLabResultsReadResponse = exports.PatientLabResultsReadRequest = exports.PatientLabResultsReadSecurity = void 0;
...
var PatientLabResultsReadRequest = /** @class */ (function (_super) {
    ...
    ], PatientLabResultsReadRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], PatientLabResultsReadRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ordering_doctor",
        }),
        __metadata("design:type", Number)
    ], PatientLabResultsReadRequest.prototype, "orderingDoctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], PatientLabResultsReadRequest.prototype, "patient", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], PatientLabResultsReadRequest.prototype, "since", void 0);
...
var PatientLabResultsReadResponse = /** @class */ (function (_super) {
    ...
    ], PatientLabResultsReadResponse.prototype, "rawResponse", void 0);
