...
public class GetUsersIdsCommentsToidRequest {
    ...
    public GetUsersIdsCommentsToidRequest withCallback(String callback) {
    ...
    public GetUsersIdsCommentsToidRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsCommentsToidRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withOrder(GetUsersIdsCommentsToidOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsCommentsToidRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withSort(GetUsersIdsCommentsToidSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    ...
    public GetUsersIdsCommentsToidRequest withToid(Long toid) {
        this.toid = toid;
        return this;
    }
    
    public GetUsersIdsCommentsToidRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site, @JsonProperty("toid") Long toid) {
        this.ids = ids;
        this.site = site;
        this.toid = toid;
  }
