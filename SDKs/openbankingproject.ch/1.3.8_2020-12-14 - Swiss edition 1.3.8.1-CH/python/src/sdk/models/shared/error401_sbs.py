...
class Error401SBSAdditionalErrors:
    ...
    code: shared_messagecode401_sbs_enum.MessageCode401SBSEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
    r"""Message codes defined for signing baskets for HTTP Error code 401 (UNAUTHORIZED)."""  
...
class Error401SBS:
    ...
    additional_errors: Optional[list[Error401SBSAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
