...
export class GoogleCloudRetailV2SearchResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2ExperimentInfo })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2SearchResponseFacet })
  @Expose({ name: "facets" })
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudRetailV2SearchResponseSearchResult,
  })
  @Expose({ name: "results" })
