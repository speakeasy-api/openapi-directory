...
class GetStoreTrackedOrdersResponse
{
     ...
     * Order list
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TrackedOrders $trackedOrders
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\TrackedOrders $trackedOrders = null;
