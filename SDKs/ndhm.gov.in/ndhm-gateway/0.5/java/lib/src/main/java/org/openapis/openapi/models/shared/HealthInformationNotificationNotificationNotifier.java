...
public class HealthInformationNotificationNotificationNotifier {
    ...
    public HealthInformationNotificationNotificationNotifier(@JsonProperty("id") String id, @JsonProperty("type") HealthInformationNotificationNotificationNotifierTypeEnum type) {
        this.id = id;
        this.type = type;
  }
}
