...
from ..shared import itvchangecarddetailsrequest as shared_itvchangecarddetailsrequest
...
class ChangeCardDetailsRequest:
    ...
    itv_change_card_details_request: shared_itvchangecarddetailsrequest.ItvChangeCardDetailsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
