...
from ..shared import accountholderbalanceresponse as shared_accountholderbalanceresponse
...
class PostAccountHolderBalanceResponse:
    ...
    account_holder_balance_response: Optional[shared_accountholderbalanceresponse.AccountHolderBalanceResponse] = dataclasses.field(default=None)
