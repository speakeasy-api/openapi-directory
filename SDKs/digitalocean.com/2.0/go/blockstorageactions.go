...
type BlockStorageActions struct {
...
func NewBlockStorageActions(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *BlockStorageActions {
...
func (s *BlockStorageActions) GetVolumeAction(ctx context.Context, request operations.GetVolumeActionRequest) (*operations.GetVolumeActionResponse, error) {
...
func (s *BlockStorageActions) ListAllVolumeActions(ctx context.Context, request operations.ListAllVolumeActionsRequest) (*operations.ListAllVolumeActionsResponse, error) {
	baseURL := s._serverURL
...
func (s *BlockStorageActions) PostVolumeActionByID(ctx context.Context, request operations.PostVolumeActionByIDRequest) (*operations.PostVolumeActionByIDResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/volumes/{volume_id}/actions", request.PathParams)
...
// | droplet_id  | Set to the Droplet's ID                                             |
// | region      | Set to the slug representing the region where the volume is located |
func (s *BlockStorageActions) PostVolumeActionByName(ctx context.Context, request operations.PostVolumeActionByNameRequest) (*operations.PostVolumeActionByNameResponse, error) {
	baseURL := s._serverURL
