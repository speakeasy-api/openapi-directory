...
class WritablePowerOutletConnectionStatusEnum(str, Enum):
    FALSE = 'false'
    TRUE = 'true'

class WritablePowerOutletFeedLegEnum(str, Enum):
    r"""Phase (for three-phase feeds)"""
    A = 'A'
    B = 'B'
    C = 'C'
...
class WritablePowerOutletInput:
    ...
    connection_status: Optional[WritablePowerOutletConnectionStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connection_status'), 'exclude': lambda f: f is None }})  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})  
    feed_leg: Optional[WritablePowerOutletFeedLegEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('feed_leg'), 'exclude': lambda f: f is None }})
    r"""Phase (for three-phase feeds)"""  
    power_port: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('power_port'), 'exclude': lambda f: f is None }})  
    tags: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tags'), 'exclude': lambda f: f is None }})  
    type: Optional[WritablePowerOutletTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Physical port type"""  
