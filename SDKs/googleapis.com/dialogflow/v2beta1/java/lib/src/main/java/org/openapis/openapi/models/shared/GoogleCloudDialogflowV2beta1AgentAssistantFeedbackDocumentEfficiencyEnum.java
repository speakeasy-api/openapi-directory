 ...
 */
public enum GoogleCloudDialogflowV2beta1AgentAssistantFeedbackDocumentEfficiencyEnum {
    ...
    private GoogleCloudDialogflowV2beta1AgentAssistantFeedbackDocumentEfficiencyEnum(String value) {
        this.value = value;
    }
}
