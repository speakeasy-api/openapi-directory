...
public class PaymentLinkApiDeleteFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PaymentLinkApiDeleteFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public PaymentLinkApiDeleteFormHeaders withXAuthSecret(String xAuthSecret) {
