...
exports.PasswordPolicyType = void 0;
...
var PasswordPolicyType = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RequireLowercase" }),
        __metadata("design:type", Boolean)
    ], PasswordPolicyType.prototype, "requireLowercase", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RequireNumbers" }),
        __metadata("design:type", Boolean)
    ], PasswordPolicyType.prototype, "requireNumbers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RequireSymbols" }),
        __metadata("design:type", Boolean)
    ], PasswordPolicyType.prototype, "requireSymbols", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RequireUppercase" }),
        __metadata("design:type", Boolean)
    ], PasswordPolicyType.prototype, "requireUppercase", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TemporaryPasswordValidityDays" }),
        __metadata("design:type", Number)
