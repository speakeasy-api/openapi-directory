...
class SystemSettingsConfig:
    ...
    def request_auth_config(self, request: operations.RequestAuthConfigRequest) -> operations.RequestAuthConfigResponse:
        ...
        res = operations.RequestAuthConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AuthConfig])
                res.auth_config = out
    ...
    def request_eventlog_config(self, request: operations.RequestEventlogConfigRequest) -> operations.RequestEventlogConfigResponse:
        ...
        res = operations.RequestEventlogConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.EventlogConfig])
    ...
    def request_general_settings(self, request: operations.RequestGeneralSettingsRequest) -> operations.RequestGeneralSettingsResponse:
        ...
        * Default refresh token validity: **30 days**
        ...
        res = operations.RequestGeneralSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GeneralSettings])
    ...
    def request_infrastructure_properties(self, request: operations.RequestInfrastructurePropertiesRequest) -> operations.RequestInfrastructurePropertiesResponse:
        ...
        res = operations.RequestInfrastructurePropertiesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.InfrastructureProperties])
    ...
    def request_syslog_config(self, request: operations.RequestSyslogConfigRequest) -> operations.RequestSyslogConfigResponse:
        ...
        res = operations.RequestSyslogConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SyslogConfig])
    ...
    def request_system_defaults(self, request: operations.RequestSystemDefaultsRequest) -> operations.RequestSystemDefaultsResponse:
        ...
        res = operations.RequestSystemDefaultsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SystemDefaults])
    ...
    def update_auth_config(self, request: operations.UpdateAuthConfigRequest) -> operations.UpdateAuthConfigResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "auth_config", 'json')
        ...
        res = operations.UpdateAuthConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_eventlog_config(self, request: operations.UpdateEventlogConfigRequest) -> operations.UpdateEventlogConfigResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_eventlog_config", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateEventlogConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_general_settings(self, request: operations.UpdateGeneralSettingsRequest) -> operations.UpdateGeneralSettingsResponse:
        ...
        * Default refresh token validity: **30 days**
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_general_settings", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateGeneralSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_syslog_config(self, request: operations.UpdateSyslogConfigRequest) -> operations.UpdateSyslogConfigResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_syslog_config", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateSyslogConfigResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_system_defaults(self, request: operations.UpdateSystemDefaultsRequest) -> operations.UpdateSystemDefaultsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_system_defaults", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateSystemDefaultsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
