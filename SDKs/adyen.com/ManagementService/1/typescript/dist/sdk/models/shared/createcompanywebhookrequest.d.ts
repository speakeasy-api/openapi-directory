 ...
 * * **json**
 */
export declare enum CreateCompanyWebhookRequestCommunicationFormatEnum {
    Http = "http",
    Json = "json",
    Soap = "soap"
}
 ...
 */
export declare enum CreateCompanyWebhookRequestFilterMerchantAccountTypeEnum {
 ...
 */
export declare enum CreateCompanyWebhookRequestNetworkTypeEnum {
    Local = "LOCAL",
    Public = "PUBLIC"
}
/**
 ...
 */
export declare enum CreateCompanyWebhookRequestSslVersionEnum {
    Http = "HTTP",
    Ssl = "SSL",
    SSLv3 = "SSLv3",
    Tls = "TLS",
...
export declare class CreateCompanyWebhookRequest extends SpeakeasyBase {
    /**
