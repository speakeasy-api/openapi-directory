...
try {
    ...
    $request->projectId = 568218;
    $request->username = 'Hollis59';
...
try {
    ...
    $request->requestBody->name = 'Bradford Abernathy';
    $request->org = 'velit';
...
try {
    ...
    $request->requestBody->name = 'Mr. Cindy Kub MD';
...
try {
    ...
    $request->projectId = 537236;
    $request->username = 'Velva_Klocko';
...
try {
    ...
    $request->archivedState = ProjectsListCardsArchivedStateEnum::NOT_ARCHIVED;
    $request->columnId = 654082;
    $request->page = 769967;
    $request->perPage = 373040;
...
try {
    ...
    $request->page = 288570;
    $request->perPage = 85066;
    $request->projectId = 874400;
...
try {
    ...
    $request->page = 112427;
    $request->perPage = 81371;
    $request->state = ProjectsListForOrgStateEnum::OPEN;
...
try {
    ...
    $request->projectId = 64435;
    $request->username = 'Anibal34';
