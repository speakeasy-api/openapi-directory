...
var Map = /** @class */ (function () {
    function Map(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Map.prototype.getChromosomeByAssemblyUsingGet = function (req, config) {
    ...
    **/
    Map.prototype.getChromosomesByAssemblyUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Map.prototype.getMapsBySpeciesUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
