...
class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsCreateQueryParams:
    ...
    rollout_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'rolloutId', 'style': 'form', 'explode': True }})
...
class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsCreateRequest:
    path_params: ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsCreatePathParams = dataclasses.field()
    query_params: ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsCreateQueryParams = dataclasses.field()
    security: ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsCreateSecurity = dataclasses.field()
    request: Optional[shared_rollout.RolloutInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
