...
class GetNetworkWirelessSignalQualityHistoryRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetNetworkWirelessSignalQualityHistoryBandEnum $band
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=band')]
    public ?GetNetworkWirelessSignalQualityHistoryBandEnum $band = null;
