...
func (e *HIUHealthInformationRequestResponseHiRequestSessionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "REQUESTED":
		fallthrough
	case "ACKNOWLEDGED":
		*e = HIUHealthInformationRequestResponseHiRequestSessionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for HIUHealthInformationRequestResponseHiRequestSessionStatusEnum: %s", s)
	}
}
