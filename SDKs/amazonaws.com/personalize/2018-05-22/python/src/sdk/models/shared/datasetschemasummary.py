...
class DatasetSchemaSummary:
    r"""Provides a summary of the properties of a dataset schema. For a complete listing, call the <a href=\\"https://docs.aws.amazon.com/personalize/latest/dg/API_DescribeSchema.html\\">DescribeSchema</a> API."""
