...
export declare class ManufacturersAccountsLanguagesProductCertificationsListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ManufacturersAccountsLanguagesProductCertificationsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class ManufacturersAccountsLanguagesProductCertificationsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
