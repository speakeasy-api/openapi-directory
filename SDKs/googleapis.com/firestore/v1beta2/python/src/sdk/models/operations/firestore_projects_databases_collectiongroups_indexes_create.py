...
class FirestoreProjectsDatabasesCollectionGroupsIndexesCreateRequest:
    ...
    google_firestore_admin_v1beta2_index: Optional[shared_googlefirestoreadminv1beta2index.GoogleFirestoreAdminV1beta2Index] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
