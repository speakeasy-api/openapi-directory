...
var FindReplaceRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "allSheets" }),
        __metadata("design:type", Boolean)
    ], FindReplaceRequest.prototype, "allSheets", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "find" }),
        __metadata("design:type", String)
    ], FindReplaceRequest.prototype, "find", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "includeFormulas" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "matchEntireCell" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "searchByRegex" }),
        __metadata("design:type", Boolean)
