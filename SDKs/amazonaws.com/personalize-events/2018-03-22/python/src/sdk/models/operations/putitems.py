...
class PutItemsRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the Items dataset you are adding the item or items to."""  
    items: list[shared_item.Item] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items') }})
    r"""A list of item data."""  
    

@dataclasses.dataclass
class PutItemsRequest:
    
    request_body: PutItemsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
