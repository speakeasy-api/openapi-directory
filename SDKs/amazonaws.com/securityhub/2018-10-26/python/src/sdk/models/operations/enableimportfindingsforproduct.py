...
class EnableImportFindingsForProductRequestBody:
    ...
    r"""The ARN of the product to enable the integration for."""  
    

@dataclasses.dataclass
class EnableImportFindingsForProductRequest:
    
    request_body: EnableImportFindingsForProductRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
