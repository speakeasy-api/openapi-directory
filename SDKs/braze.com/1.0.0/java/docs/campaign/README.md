...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CampaignDetailsResponse res = sdk.campaign.campaignDetails(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CampaignListResponse res = sdk.campaign.campaignList(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SendAnalyticsResponse res = sdk.campaign.sendAnalytics(req);
