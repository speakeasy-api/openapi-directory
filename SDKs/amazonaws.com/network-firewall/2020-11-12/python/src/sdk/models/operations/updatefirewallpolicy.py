...
class UpdateFirewallPolicyRequest:
    ...
    update_firewall_policy_request: shared_updatefirewallpolicyrequest.UpdateFirewallPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
