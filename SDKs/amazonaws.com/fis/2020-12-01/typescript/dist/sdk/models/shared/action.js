...
var Action = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: actionparameter_1.ActionParameter }),
        (0, class_transformer_1.Expose)({ name: "parameters" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], actionparameter_1.ActionParameter);
            }
            return obj;
        }, { toClassOnly: true }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Transform)(function (_a) {
            ...
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], actiontarget_1.ActionTarget);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
