...
class HealthCheckConfiguration:
    ...
    protocol: Optional[shared_healthcheckprotocol_enum.HealthCheckProtocolEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Protocol') }})
