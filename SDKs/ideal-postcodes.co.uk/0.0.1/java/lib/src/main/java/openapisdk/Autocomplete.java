...
public class Autocomplete {
     ...
     * 
    **/
    public openapisdk.models.operations.AddressAutocompleteResponse addressAutocomplete(openapisdk.models.operations.AddressAutocompleteRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/autocomplete/addresses");
        ...
        openapisdk.models.operations.AddressAutocompleteResponse res = new openapisdk.models.operations.AddressAutocompleteResponse() {{
            addressAutocompleteResponseSchema = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.AddressAutocompleteResponseSchema out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.AddressAutocompleteResponseSchema.class);
