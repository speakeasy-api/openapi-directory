...
class PipelinesUpdateRequest:
    headers: PipelinesUpdateHeaders = dataclasses.field()
    path_params: PipelinesUpdatePathParams = dataclasses.field()
    query_params: PipelinesUpdateQueryParams = dataclasses.field()
    request: shared_pipeline.PipelineInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PipelinesUpdateSecurity = dataclasses.field()
