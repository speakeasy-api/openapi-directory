 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsFault extends SpeakeasyBase {
  @SpeakeasyMetadata()
  code?: string;
 ...
 */
export enum RequestSpotInstancesResultSpotInstanceRequestsInstanceInterruptionBehaviorEnum {
  Hibernate = "hibernate",
  Stop = "stop",
  Terminate = "terminate",
}
 ...
 */
export enum RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbsVolumeTypeEnum {
  Standard = "standard",
  Io1 = "io1",
  Io2 = "io2",
  Gp2 = "gp2",
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbs extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappings extends SpeakeasyBase {
  @SpeakeasyMetadata()
  deviceName?: string;
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationIamInstanceProfile extends SpeakeasyBase {
  @SpeakeasyMetadata()
  arn?: string;
 ...
 */
export enum RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationMonitoring extends SpeakeasyBase {
  @SpeakeasyMetadata()
  enabled: boolean;
}
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv4Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv4Prefix?: string;
}
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Addresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Address?: string;
}
 ...
 * Describes the IPv4 prefix option for a network interface.
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Prefix?: string;
}
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesPrivateIpAddresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
  primary?: boolean;
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfaces extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({
    elemType:
      RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv4Prefixes,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Addresses,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Prefixes,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesPrivateIpAddresses,
  })
 ...
 */
export enum RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationPlacementTenancyEnum {
  Default = "default",
  Dedicated = "dedicated",
  Host = "host",
}
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationPlacement extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationSecurityGroups extends SpeakeasyBase {
  @SpeakeasyMetadata()
  groupId?: string;
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecification extends SpeakeasyBase {
  @SpeakeasyMetadata()
  addressingType?: string;

  @SpeakeasyMetadata({
    elemType:
      RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappings,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfaces,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationSecurityGroups,
  })
 ...
 */
export enum RequestSpotInstancesResultSpotInstanceRequestsProductDescriptionEnum {
 ...
 */
export enum RequestSpotInstancesResultSpotInstanceRequestsStateEnum {
  Open = "open",
  Active = "active",
  Closed = "closed",
  Cancelled = "cancelled",
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequestsStatus extends SpeakeasyBase {
  @SpeakeasyMetadata()
  code?: string;
 ...
 * Describes a tag.
 */
export class RequestSpotInstancesResultSpotInstanceRequestsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export enum RequestSpotInstancesResultSpotInstanceRequestsTypeEnum {
  OneTime = "one-time",
 ...
 */
export class RequestSpotInstancesResultSpotInstanceRequests extends SpeakeasyBase {
  @SpeakeasyMetadata()
