...
class HIPHealthInformationRequestAcknowledgementHiRequest:
    ...
    session_status: HIPHealthInformationRequestAcknowledgementHiRequestSessionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sessionStatus') }})  
...
class HIPHealthInformationRequestAcknowledgement:
    ...
    hi_request: Optional[HIPHealthInformationRequestAcknowledgementHiRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('hiRequest'), 'exclude': lambda f: f is None }})  
