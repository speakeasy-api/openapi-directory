...
public class GetOrganizationSamlIdps200ApplicationJSON {
    /**
    ...
    public GetOrganizationSamlIdps200ApplicationJSON withConsumerUrl(String consumerUrl) {
    ...
    @JsonProperty("idpId")
    public String idpId;
    public GetOrganizationSamlIdps200ApplicationJSON withIdpId(String idpId) {
        this.idpId = idpId;
        return this;
    }
    ...
    public GetOrganizationSamlIdps200ApplicationJSON withSloLogoutUrl(String sloLogoutUrl) {
    ...
    public GetOrganizationSamlIdps200ApplicationJSON withX509certSha1Fingerprint(String x509certSha1Fingerprint) {
