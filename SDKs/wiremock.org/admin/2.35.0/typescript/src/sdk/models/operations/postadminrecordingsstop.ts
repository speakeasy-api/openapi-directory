...
export enum PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum {
  Uniform = "uniform",
}
 ...
 */
export class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniform extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "lower" })
  lower?: number;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "type" })
  type?: PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum;
...
export enum PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum {
  Lognormal = "lognormal",
}
 ...
 */
export class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormal extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "median" })
  median?: number;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "type" })
  type?: PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum;
}
...
export class PostAdminRecordingsStop200ApplicationJSONMappings extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "request" })
  @Type(() => PostAdminRecordingsStop200ApplicationJSONMappingsRequest)
  ...
  @Type(() => PostAdminRecordingsStop200ApplicationJSONMappingsResponse)
...
export class PostAdminRecordingsStop200ApplicationJSON extends SpeakeasyBase {
  ...
  @Type(() => PostAdminRecordingsStop200ApplicationJSONMappings)
  mappings?: PostAdminRecordingsStop200ApplicationJSONMappings[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => PostAdminRecordingsStop200ApplicationJSONMeta)
