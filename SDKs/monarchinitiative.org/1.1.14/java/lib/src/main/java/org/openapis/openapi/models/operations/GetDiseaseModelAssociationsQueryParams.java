...
public class GetDiseaseModelAssociationsQueryParams {
    /**
    ...
    public GetDiseaseModelAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseaseModelAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetDiseaseModelAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseaseModelAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetDiseaseModelAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetDiseaseModelAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetDiseaseModelAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetDiseaseModelAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetDiseaseModelAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetDiseaseModelAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetDiseaseModelAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseaseModelAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseaseModelAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
