...
public class GetHTMLRequest {
    ...
    public GetHTMLRequest withCountry(org.openapis.openapi.models.shared.CountryEnum country) {
    ...
    public GetHTMLRequest withDevice(org.openapis.openapi.models.shared.DeviceEnum device) {
        this.device = device;
        return this;
    }
    ...
    public GetHTMLRequest withErrorOn404(Boolean errorOn404) {
    ...
    public GetHTMLRequest withErrorOnRedirect(Boolean errorOnRedirect) {
     ...
     */
    @SpeakeasyMetadata("queryParam:style=deepObject,explode=true,name=headers")
    public java.util.Map<String, String> headers;

    public GetHTMLRequest withHeaders(java.util.Map<String, String> headers) {
    ...
    public GetHTMLRequest withJs(Boolean js) {
        this.js = js;
        return this;
    }
    ...
    public GetHTMLRequest withJsTimeout(Long jsTimeout) {
    ...
    public GetHTMLRequest withProxy(org.openapis.openapi.models.shared.ProxyEnum proxy) {
        this.proxy = proxy;
        return this;
    }
    ...
    public GetHTMLRequest withTimeout(Long timeout) {
    ...
    public GetHTMLRequest withUrl(String url) {
        this.url = url;
        return this;
    }
    
    public GetHTMLRequest(@JsonProperty("url") String url) {
        this.url = url;
  }
}
