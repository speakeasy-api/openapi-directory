...
from ..shared import getsegmentimportjobsresponse as shared_getsegmentimportjobsresponse
...
@dataclasses.dataclass
class GetSegmentImportJobsQueryParams:
...
@dataclasses.dataclass
class GetSegmentImportJobsHeaders:
...
class GetSegmentImportJobsRequest:
    headers: GetSegmentImportJobsHeaders = dataclasses.field()
    path_params: GetSegmentImportJobsPathParams = dataclasses.field()
    query_params: GetSegmentImportJobsQueryParams = dataclasses.field()
...
class GetSegmentImportJobsResponse:
    ...
    get_segment_import_jobs_response: Optional[shared_getsegmentimportjobsresponse.GetSegmentImportJobsResponse] = dataclasses.field(default=None)
