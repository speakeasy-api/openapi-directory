...
class Config:
    ...
    def request_algorithms(self, request: operations.RequestAlgorithmsRequest) -> operations.RequestAlgorithmsResponse:
        ...
        res = operations.RequestAlgorithmsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AlgorithmVersionInfoList])
    ...
    def request_classification_policies_config_info(self, request: operations.RequestClassificationPoliciesConfigInfoRequest) -> operations.RequestClassificationPoliciesConfigInfoResponse:
        ...
        * `shareClassificationPolicies`
        ...
        url = base_url.removesuffix('/') + '/v4/config/info/policies/classifications'
        ...
        res = operations.RequestClassificationPoliciesConfigInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_current_product_packages(self, request: operations.RequestCurrentProductPackagesRequest) -> operations.RequestCurrentProductPackagesResponse:
        r"""Request list of currently enabled product packages
        ...
        url = base_url.removesuffix('/') + '/v4/config/info/product_packages/current'
        ...
        res = operations.RequestCurrentProductPackagesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProductPackageResponseList])
                res.product_package_response_list = out
        elif http_res.status_code in [401, 406, 412]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def request_general_settings_info(self, request: operations.RequestGeneralSettingsInfoRequest) -> operations.RequestGeneralSettingsInfoResponse:
        ...
        res = operations.RequestGeneralSettingsInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GeneralSettingsInfo])
    ...
    def request_guest_users_policies_config_info(self, request: operations.RequestGuestUsersPoliciesConfigInfoRequest) -> operations.RequestGuestUsersPoliciesConfigInfoResponse:
        r"""Request guest users policies
        ...
        url = base_url.removesuffix('/') + '/v4/config/info/policies/guest_users'
        ...
        res = operations.RequestGuestUsersPoliciesConfigInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_infrastructure_properties_info(self, request: operations.RequestInfrastructurePropertiesInfoRequest) -> operations.RequestInfrastructurePropertiesInfoResponse:
        ...
        res = operations.RequestInfrastructurePropertiesInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_notification_channels_info(self, request: operations.RequestNotificationChannelsInfoRequest) -> operations.RequestNotificationChannelsInfoResponse:
        ...
        res = operations.RequestNotificationChannelsInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_password_policies_config_info(self, request: operations.RequestPasswordPoliciesConfigInfoRequest) -> operations.RequestPasswordPoliciesConfigInfoResponse:
        ...
        * `encryption`
        ...
        res = operations.RequestPasswordPoliciesConfigInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_product_packages(self, request: operations.RequestProductPackagesRequest) -> operations.RequestProductPackagesResponse:
        r"""Request list of product packages
        <h3 style='padding: 5px; background-color: #F6F7F8; border: 1px solid #AAA; border-radius: 5px; display: table-cell;'>&#128640; Since v4.38.0</h3>
        ...
        url = base_url.removesuffix('/') + '/v4/config/info/product_packages'
        ...
        res = operations.RequestProductPackagesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_s3_tags_info(self, request: operations.RequestS3TagsInfoRequest) -> operations.RequestS3TagsInfoResponse:
        ...
        res = operations.RequestS3TagsInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_system_defaults_info(self, request: operations.RequestSystemDefaultsInfoRequest) -> operations.RequestSystemDefaultsInfoResponse:
        ...
        res = operations.RequestSystemDefaultsInfoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_system_settings(self, request: operations.RequestSystemSettingsRequest) -> operations.RequestSystemSettingsResponse:
        ...
        * `eula_active`
        ...
        res = operations.RequestSystemSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ConfigOptionList])
    ...
    def update_system_settings(self, request: operations.UpdateSystemSettingsRequest) -> operations.UpdateSystemSettingsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "config_option_list", 'json')
        ...
        res = operations.UpdateSystemSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
