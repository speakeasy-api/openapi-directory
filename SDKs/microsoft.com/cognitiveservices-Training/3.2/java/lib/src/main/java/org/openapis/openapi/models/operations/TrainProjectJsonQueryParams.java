...
public class TrainProjectJsonQueryParams {
    /**
    ...
    public TrainProjectJsonQueryParams withForceTrain(Boolean forceTrain) {
    ...
    public TrainProjectJsonQueryParams withNotificationEmailAddress(String notificationEmailAddress) {
    ...
    public TrainProjectJsonQueryParams withReservedBudgetInHours(Integer reservedBudgetInHours) {
    ...
    public TrainProjectJsonQueryParams withTrainingType(TrainProjectJsonTrainingTypeEnum trainingType) {
