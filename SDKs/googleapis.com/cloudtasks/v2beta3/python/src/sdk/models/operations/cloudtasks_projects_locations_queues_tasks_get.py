...
class CloudtasksProjectsLocationsQueuesTasksGetRequest:
    path_params: CloudtasksProjectsLocationsQueuesTasksGetPathParams = dataclasses.field()
    query_params: CloudtasksProjectsLocationsQueuesTasksGetQueryParams = dataclasses.field()
    security: CloudtasksProjectsLocationsQueuesTasksGetSecurity = dataclasses.field()
