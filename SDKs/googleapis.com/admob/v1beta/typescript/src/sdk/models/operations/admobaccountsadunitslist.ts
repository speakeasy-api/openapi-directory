...
export class AdmobAccountsAdUnitsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdmobAccountsAdUnitsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdmobAccountsAdUnitsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
