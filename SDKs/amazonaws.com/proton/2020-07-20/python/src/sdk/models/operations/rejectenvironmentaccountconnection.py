...
class RejectEnvironmentAccountConnectionRequest:
    ...
    reject_environment_account_connection_input: shared_rejectenvironmentaccountconnectioninput.RejectEnvironmentAccountConnectionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
