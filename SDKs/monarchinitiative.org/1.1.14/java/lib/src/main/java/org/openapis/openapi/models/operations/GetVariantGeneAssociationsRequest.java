...
public class GetVariantGeneAssociationsRequest {
    ...
    public GetVariantGeneAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetVariantGeneAssociationsRequest withEvidence(String evidence) {
    ...
    public GetVariantGeneAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetVariantGeneAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetVariantGeneAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetVariantGeneAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withRelation(String relation) {
    ...
    public GetVariantGeneAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetVariantGeneAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetVariantGeneAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetVariantGeneAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
