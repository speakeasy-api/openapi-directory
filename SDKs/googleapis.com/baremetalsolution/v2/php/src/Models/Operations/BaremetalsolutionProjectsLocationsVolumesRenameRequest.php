...
class BaremetalsolutionProjectsLocationsVolumesRenameRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\RenameVolumeRequest $renameVolumeRequest = null;
