...
public class PaymentMethodSnapshots {
     ...
     * 
    **/
    public openapisdk.models.operations.ObjectGetPaymentMethodSnapshotResponse objectGetPaymentMethodSnapshot(openapisdk.models.operations.ObjectGetPaymentMethodSnapshotRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/object/payment-method-snapshot/{id}", request.pathParams);
        ...
        openapisdk.models.operations.ObjectGetPaymentMethodSnapshotResponse res = new openapisdk.models.operations.ObjectGetPaymentMethodSnapshotResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                ...
                openapisdk.models.shared.ProxyGetPaymentMethodSnapshot out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ProxyGetPaymentMethodSnapshot.class);
