...
class SearchTypeDrilsdownCasestudyQueryParams:
...
class SearchTypeDrilsdownCasestudyRequest:
    query_params: SearchTypeDrilsdownCasestudyQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeDrilsdownCasestudyResponse:
