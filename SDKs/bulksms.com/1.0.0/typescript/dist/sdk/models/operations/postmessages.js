...
exports.PostMessagesResponse = exports.PostMessagesRequest = exports.PostMessagesSecurity = exports.PostMessagesQueryParams = void 0;
...
var PostMessagesQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=auto-unicode" }),
        __metadata("design:type", Boolean)
    ], PostMessagesQueryParams.prototype, "autoUnicode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=deduplication-id" }),
        __metadata("design:type", Number)
    ], PostMessagesQueryParams.prototype, "deduplicationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=schedule-date" }),
        __metadata("design:type", Date)
    ], PostMessagesQueryParams.prototype, "scheduleDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=schedule-description" }),
        __metadata("design:type", String)
    ], PostMessagesQueryParams.prototype, "scheduleDescription", void 0);
    return PostMessagesQueryParams;
}(utils_1.SpeakeasyBase));
exports.PostMessagesQueryParams = PostMessagesQueryParams;
...
exports.PostMessagesSecurity = PostMessagesSecurity;
var PostMessagesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json", elemType: shared.SubmissionEntry }),
...
exports.PostMessagesRequest = PostMessagesRequest;
...
exports.PostMessagesResponse = PostMessagesResponse;
