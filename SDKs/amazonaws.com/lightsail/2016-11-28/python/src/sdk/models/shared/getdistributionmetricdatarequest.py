...
class GetDistributionMetricDataRequest:
    ...
    metric_name: shared_distributionmetricname_enum.DistributionMetricNameEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('metricName') }})
