...
public class GetSuggestions {
    ...
    public org.openapis.openapi.models.operations.GetSuggestionResponse getSuggestion(org.openapis.openapi.models.operations.GetSuggestionRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetSuggestionPathParams.class, baseUrl, "/suggestions/{sellerId}/{sellerSkuId}", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetSuggestionQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
