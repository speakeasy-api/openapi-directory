...
public class DataplexProjectsLocationsDataTaxonomiesListPathParams {
    /**
    ...
    public DataplexProjectsLocationsDataTaxonomiesListPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
