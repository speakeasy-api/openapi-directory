...
public class CreateInternationalStandingOrdersRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalStandingOrdersRawHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalStandingOrdersRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalStandingOrdersRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalStandingOrdersRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalStandingOrdersRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalStandingOrdersRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalStandingOrdersRawHeaders withXJwsSignature(String xJwsSignature) {
