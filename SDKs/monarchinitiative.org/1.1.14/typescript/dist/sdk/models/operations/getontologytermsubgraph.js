...
exports.GetOntologyTermSubgraphResponse = exports.GetOntologyTermSubgraphRequest = void 0;
...
var GetOntologyTermSubgraphRequest = /** @class */ (function (_super) {
    ...
    ], GetOntologyTermSubgraphRequest.prototype, "cnode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetOntologyTermSubgraphRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=include_ancestors",
        }),
        __metadata("design:type", Boolean)
    ], GetOntologyTermSubgraphRequest.prototype, "includeAncestors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=include_descendants",
        }),
        __metadata("design:type", Boolean)
    ], GetOntologyTermSubgraphRequest.prototype, "includeDescendants", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=include_meta",
        }),
        __metadata("design:type", Boolean)
    ], GetOntologyTermSubgraphRequest.prototype, "includeMeta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=relation",
        }),
        __metadata("design:type", Array)
    ], GetOntologyTermSubgraphRequest.prototype, "relation", void 0);
...
var GetOntologyTermSubgraphResponse = /** @class */ (function (_super) {
    ...
    ], GetOntologyTermSubgraphResponse.prototype, "rawResponse", void 0);
