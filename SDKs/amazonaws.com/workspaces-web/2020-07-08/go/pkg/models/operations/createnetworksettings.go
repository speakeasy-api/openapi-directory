...
type CreateNetworkSettingsHeaders struct {
...
type CreateNetworkSettingsRequest struct {
	Headers CreateNetworkSettingsHeaders
	Request CreateNetworkSettingsRequestBody `request:"mediaType=application/json"`
}
