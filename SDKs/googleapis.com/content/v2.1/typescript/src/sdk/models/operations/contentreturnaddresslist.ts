...
export class ContentReturnaddressListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentReturnaddressListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentReturnaddressListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
