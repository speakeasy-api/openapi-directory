...
public class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesCreatePathParams {
    /**
    ...
    public ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesCreatePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
