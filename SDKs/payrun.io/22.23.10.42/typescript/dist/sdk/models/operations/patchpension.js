...
exports.PatchPensionResponse = exports.PatchPensionRequest = void 0;
...
var PatchPensionRequest = /** @class */ (function (_super) {
    ...
    ], PatchPensionRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PatchPensionRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PatchPensionRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.Pension)
    ], PatchPensionRequest.prototype, "pension", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PensionId",
        }),
        __metadata("design:type", String)
    ], PatchPensionRequest.prototype, "pensionId", void 0);
    return PatchPensionRequest;
}(utils_1.SpeakeasyBase));
exports.PatchPensionRequest = PatchPensionRequest;
var PatchPensionResponse = /** @class */ (function (_super) {
    ...
    ], PatchPensionResponse.prototype, "rawResponse", void 0);
    return PatchPensionResponse;
}(utils_1.SpeakeasyBase));
exports.PatchPensionResponse = PatchPensionResponse;
