...
class RecordingGroup:
    ...
    all_supported: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('allSupported') }})
    include_global_resource_types: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('includeGlobalResourceTypes') }})
    resource_types: Optional[list[shared_resourcetype_enum.ResourceTypeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceTypes') }})
