...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ListUserSSubscriptionGroupSmsResponse res = sdk.subscriptionGroups.listUserSSubscriptionGroupSms(req);
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ListUserSSubscriptionGroupStatusSmsResponse res = sdk.subscriptionGroups.listUserSSubscriptionGroupStatusSms(req);
