...
export class GooglePrivacyDlpV2Action extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "deidentify" })
  @Type(() => GooglePrivacyDlpV2Deidentify)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "jobNotificationEmails" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "publishFindingsToCloudDataCatalog" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "publishSummaryToCscc" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "publishToStackdriver" })
