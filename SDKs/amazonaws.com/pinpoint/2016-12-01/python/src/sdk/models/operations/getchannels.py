...
from ..shared import getchannelsresponse as shared_getchannelsresponse
...
class GetChannelsResponse:
    ...
    get_channels_response: Optional[shared_getchannelsresponse.GetChannelsResponse] = dataclasses.field(default=None)
