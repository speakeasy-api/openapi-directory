...
public class CreateInternationalPaymentConsentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalPaymentConsentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalPaymentConsentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalPaymentConsentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalPaymentConsentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalPaymentConsentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalPaymentConsentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalPaymentConsentsJsonHeaders withXJwsSignature(String xJwsSignature) {
