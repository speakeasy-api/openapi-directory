...
export class AdminCustomersChromePrintServersBatchDeletePrintServersSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintServersBatchDeletePrintServersRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdminCustomersChromePrintServersBatchDeletePrintServersResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
