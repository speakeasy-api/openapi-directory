...
export class GamesMetagameListCategoriesByPlayerSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum GamesMetagameListCategoriesByPlayerCollectionEnum {
  CollectionUnspecified = "COLLECTION_UNSPECIFIED",
  All = "ALL",
}

export class GamesMetagameListCategoriesByPlayerRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GamesMetagameListCategoriesByPlayerResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
