...
class GoogleCloudVisionV1p2beta1WebDetection:
    ...
    best_guess_labels: Optional[list[shared_googlecloudvisionv1p2beta1webdetectionweblabel.GoogleCloudVisionV1p2beta1WebDetectionWebLabel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bestGuessLabels') }})
    ...
    pages_with_matching_images: Optional[list[shared_googlecloudvisionv1p2beta1webdetectionwebpage.GoogleCloudVisionV1p2beta1WebDetectionWebPage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pagesWithMatchingImages') }})
    ...
    visually_similar_images: Optional[list[shared_googlecloudvisionv1p2beta1webdetectionwebimage.GoogleCloudVisionV1p2beta1WebDetectionWebImage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('visuallySimilarImages') }})
    web_entities: Optional[list[shared_googlecloudvisionv1p2beta1webdetectionwebentity.GoogleCloudVisionV1p2beta1WebDetectionWebEntity]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('webEntities') }})
