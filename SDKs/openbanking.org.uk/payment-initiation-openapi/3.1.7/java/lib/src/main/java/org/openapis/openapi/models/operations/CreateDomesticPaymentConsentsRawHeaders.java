...
public class CreateDomesticPaymentConsentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticPaymentConsentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticPaymentConsentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticPaymentConsentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticPaymentConsentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticPaymentConsentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticPaymentConsentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticPaymentConsentsRawHeaders withXJwsSignature(String xJwsSignature) {
