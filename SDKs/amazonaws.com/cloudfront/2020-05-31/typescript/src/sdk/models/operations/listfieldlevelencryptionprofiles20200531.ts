...
export class ListFieldLevelEncryptionProfiles20200531Request extends SpeakeasyBase {
  /**
...
export class ListFieldLevelEncryptionProfiles20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
