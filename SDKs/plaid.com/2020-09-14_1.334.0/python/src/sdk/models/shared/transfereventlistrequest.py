...
from ..shared import transfereventlisttransfertype_enum as shared_transfereventlisttransfertype_enum
from ..shared import transfereventtype_enum as shared_transfereventtype_enum
...
class TransferEventListRequest:
    ...
    event_types: Optional[list[shared_transfereventtype_enum.TransferEventTypeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('event_types'), 'exclude': lambda f: f is None }})
    ...
    transfer_type: Optional[shared_transfereventlisttransfertype_enum.TransferEventListTransferTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transfer_type'), 'exclude': lambda f: f is None }})
