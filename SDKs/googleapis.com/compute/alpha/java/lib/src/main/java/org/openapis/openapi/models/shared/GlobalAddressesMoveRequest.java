...
public class GlobalAddressesMoveRequest {
    ...
    public GlobalAddressesMoveRequest withDescription(String description) {
    ...
    public GlobalAddressesMoveRequest withDestinationAddress(String destinationAddress) {
