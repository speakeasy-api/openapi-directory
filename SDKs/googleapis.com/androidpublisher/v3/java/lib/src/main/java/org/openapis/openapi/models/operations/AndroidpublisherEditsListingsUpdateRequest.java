...
public class AndroidpublisherEditsListingsUpdateRequest {
    ...
    public AndroidpublisherEditsListingsUpdateRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public AndroidpublisherEditsListingsUpdateRequest withAccessToken(String accessToken) {
    ...
    public AndroidpublisherEditsListingsUpdateRequest withCallback(String callback) {
    ...
    public AndroidpublisherEditsListingsUpdateRequest withUploadType(String uploadType) {
    ...
    public AndroidpublisherEditsListingsUpdateRequest withUploadProtocol(String uploadProtocol) {
