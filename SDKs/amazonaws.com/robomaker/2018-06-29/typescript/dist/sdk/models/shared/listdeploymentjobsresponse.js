...
var ListDeploymentJobsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: deploymentjob_1.DeploymentJob }),
        (0, class_transformer_1.Expose)({ name: "deploymentJobs" }),
        (0, class_transformer_1.Type)(function () { return deploymentjob_1.DeploymentJob; }),
