...
public class UpdateCampaignBudgetRequest {
    ...
    public UpdateCampaignBudgetRequest(@JsonProperty("UpdateCampaignBudgetRequest") org.openapis.openapi.models.shared.UpdateCampaignBudgetRequest updateCampaignBudgetRequest, @JsonProperty("campaign_id") String campaignId) {
        this.updateCampaignBudgetRequest = updateCampaignBudgetRequest;
        this.campaignId = campaignId;
  }
}
