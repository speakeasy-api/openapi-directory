...
func (e AncillaryServiceEndorsementEnum) ToPointer() *AncillaryServiceEndorsementEnum {
	return &e
}
...
func (e *AncillaryServiceEndorsementEnum) UnmarshalJSON(data []byte) error {
	...
	case "leave_if_no_response":
		*e = AncillaryServiceEndorsementEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AncillaryServiceEndorsementEnum: %v", v)
	}
}
