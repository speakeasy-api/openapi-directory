...
public class UpdateInstanceResponse {
    ...
    public UpdateInstanceResponse withStatusCode(Integer statusCode) {
    ...
    public UpdateInstanceResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public UpdateInstanceResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
