...
public class PagesHttpsCertificate {
    ...
    public PagesHttpsCertificate(@JsonProperty("description") String description, @JsonProperty("domains") Object[] domains, @JsonProperty("state") PagesHttpsCertificateStateEnum state) {
        this.description = description;
        this.domains = domains;
        this.state = state;
  }
