...
exports.ClickStreamGetResponse = exports.ClickStreamGetRequest = exports.ClickStreamGetFilterEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Filter event type ("spiders"/"uniques"/"nonuniques"/"conversions")
 */
var ClickStreamGetFilterEnum;
...
})(ClickStreamGetFilterEnum = exports.ClickStreamGetFilterEnum || (exports.ClickStreamGetFilterEnum = {}));
var ClickStreamGetRequest = /** @class */ (function (_super) {
    ...
    ], ClickStreamGetRequest.prototype, "conversion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=datapoint",
        }),
        __metadata("design:type", Number)
    ], ClickStreamGetRequest.prototype, "datapoint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], ClickStreamGetRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=group" }),
        __metadata("design:type", Number)
    ], ClickStreamGetRequest.prototype, "group", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], ClickStreamGetRequest.prototype, "pageSize", void 0);
    return ClickStreamGetRequest;
}(utils_1.SpeakeasyBase));
exports.ClickStreamGetRequest = ClickStreamGetRequest;
var ClickStreamGetResponse = /** @class */ (function (_super) {
    ...
    ], ClickStreamGetResponse.prototype, "rawResponse", void 0);
    return ClickStreamGetResponse;
}(utils_1.SpeakeasyBase));
exports.ClickStreamGetResponse = ClickStreamGetResponse;
