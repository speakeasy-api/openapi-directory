...
var Image = /** @class */ (function () {
     ...
     *
     */
    Image.prototype.getImages = function (req, security, config) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getImages200ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetImages200ApplicationVndApiPlusJson);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getImages400ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetImages400ApplicationVndApiPlusJson);
                    }
                    break;
     ...
     *
     */
    Image.prototype.getImagesId = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getImagesId200ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetImagesId200ApplicationVndApiPlusJson);
                    }
                    break;
