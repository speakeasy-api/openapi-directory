...
public class ListCompositionQueryParams {
    ...
    public Long page;
    public ListCompositionQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListCompositionQueryParams withPageToken(String pageToken) {
    ...
    public ListCompositionQueryParams withStatus(org.openapis.openapi.models.shared.CompositionEnumStatusEnum status) {
        this.status = status;
        return this;
    }
