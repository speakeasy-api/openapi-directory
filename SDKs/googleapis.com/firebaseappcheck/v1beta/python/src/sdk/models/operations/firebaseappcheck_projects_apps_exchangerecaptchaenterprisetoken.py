...
class FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest:
    ...
    request: Optional[shared_googlefirebaseappcheckv1betaexchangerecaptchaenterprisetokenrequest.GoogleFirebaseAppcheckV1betaExchangeRecaptchaEnterpriseTokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
