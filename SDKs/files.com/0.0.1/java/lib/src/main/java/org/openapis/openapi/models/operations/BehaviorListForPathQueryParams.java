...
public class BehaviorListForPathQueryParams {
    /**
    ...
    public BehaviorListForPathQueryParams withBehavior(String behavior) {
    ...
    public BehaviorListForPathQueryParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public BehaviorListForPathQueryParams withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public BehaviorListForPathQueryParams withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public BehaviorListForPathQueryParams withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public BehaviorListForPathQueryParams withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public BehaviorListForPathQueryParams withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public BehaviorListForPathQueryParams withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public BehaviorListForPathQueryParams withPerPage(Integer perPage) {
    ...
    public BehaviorListForPathQueryParams withRecursive(String recursive) {
    ...
    public BehaviorListForPathQueryParams withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
