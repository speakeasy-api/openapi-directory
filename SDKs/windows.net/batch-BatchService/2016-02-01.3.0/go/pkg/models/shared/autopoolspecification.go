...
func (e AutoPoolSpecificationPoolLifetimeOptionEnum) ToPointer() *AutoPoolSpecificationPoolLifetimeOptionEnum {
	return &e
}
...
func (e *AutoPoolSpecificationPoolLifetimeOptionEnum) UnmarshalJSON(data []byte) error {
	...
	case "job":
		fallthrough
	case "unmapped":
		*e = AutoPoolSpecificationPoolLifetimeOptionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AutoPoolSpecificationPoolLifetimeOptionEnum: %v", v)
	}
}
