...
export class CertificatemanagerProjectsLocationsCertificateMapsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsCertificateMapsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsCertificateMapsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
