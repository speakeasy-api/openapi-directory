...
func (s *Push) GetPushDeviceDetails(ctx context.Context, request operations.GetPushDeviceDetailsRequest) (*operations.GetPushDeviceDetailsResponseOutput, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/push/deviceRegistrations/{device_id}", request.PathParams)
	...
	res := &operations.GetPushDeviceDetailsResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Push) GetPushSubscriptionsOnChannels(ctx context.Context, request operations.GetPushSubscriptionsOnChannelsRequest) (*operations.GetPushSubscriptionsOnChannelsResponseOutput, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/push/channelSubscriptions"
	...
	res := &operations.GetPushSubscriptionsOnChannelsResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Push) GetRegisteredPushDevices(ctx context.Context, request operations.GetRegisteredPushDevicesRequest) (*operations.GetRegisteredPushDevicesResponseOutput, error) {
	baseURL := s._serverURL
	...
	res := &operations.GetRegisteredPushDevicesResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Push) PatchPushDeviceDetails(ctx context.Context, request operations.PatchPushDeviceDetailsRequest) (*operations.PatchPushDeviceDetailsResponseOutput, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/push/deviceRegistrations/{device_id}", request.PathParams)
	...
	res := &operations.PatchPushDeviceDetailsResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Push) PutPushDeviceDetails(ctx context.Context, request operations.PutPushDeviceDetailsRequest) (*operations.PutPushDeviceDetailsResponseOutput, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/push/deviceRegistrations/{device_id}", request.PathParams)
	...
	res := &operations.PutPushDeviceDetailsResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Push) RegisterPushDevice(ctx context.Context, request operations.RegisterPushDeviceRequest) (*operations.RegisterPushDeviceResponseOutput, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/push/deviceRegistrations"
	...
	res := &operations.RegisterPushDeviceResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Push) SubscribePushDeviceToChannel(ctx context.Context, request operations.SubscribePushDeviceToChannelRequest) (*operations.SubscribePushDeviceToChannelResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/push/channelSubscriptions"
	...
	res := &operations.SubscribePushDeviceToChannelResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Push) UpdatePushDeviceDetails(ctx context.Context, request operations.UpdatePushDeviceDetailsRequest) (*operations.UpdatePushDeviceDetailsResponseOutput, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/push/deviceRegistrations/{device_id}/resetUpdateToken", request.PathParams)
	...
	res := &operations.UpdatePushDeviceDetailsResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
