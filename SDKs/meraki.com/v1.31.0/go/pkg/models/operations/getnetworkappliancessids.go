...
type GetNetworkApplianceSsids200ApplicationJSON struct {
	...
	RadiusServers []GetNetworkApplianceSsids200ApplicationJSONRadiusServers `json:"radiusServers,omitempty"`
...
type GetNetworkApplianceSsidsResponse struct {
	ContentType string
	StatusCode  int
