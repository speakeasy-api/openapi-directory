...
class JobTerminateRequest:
    headers: JobTerminateHeaders = dataclasses.field()
    path_params: JobTerminatePathParams = dataclasses.field()
    query_params: JobTerminateQueryParams = dataclasses.field()
