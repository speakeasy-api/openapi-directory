...
class RequestUsersRoomsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestUsersRoomsXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestUsersRoomsXSdsDateFormatEnum $xSdsDateFormat = null;
