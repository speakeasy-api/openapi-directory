...
public class CustomerFriends {
	...
	public CustomerFriends(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.GetFriendInfoResponse getFriendInfo(org.openapis.openapi.models.operations.GetFriendInfoRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetFriendInfoResponse res = new org.openapis.openapi.models.operations.GetFriendInfoResponse(contentType, httpRes.statusCode()) {{
            userFriendInfo = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.UserFriendInfo out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.UserFriendInfo.class);
