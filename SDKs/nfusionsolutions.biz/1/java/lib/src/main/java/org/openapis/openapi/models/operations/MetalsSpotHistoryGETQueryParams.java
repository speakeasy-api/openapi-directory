...
public class MetalsSpotHistoryGETQueryParams {
    /**
    ...
    public MetalsSpotHistoryGETQueryParams withCurrency(String currency) {
    ...
    public MetalsSpotHistoryGETQueryParams withEnd(OffsetDateTime end) {
        this.end = end;
        return this;
    }
    ...
    public MetalsSpotHistoryGETQueryParams withFormat(MetalsSpotHistoryGETFormatEnum format) {
        this.format = format;
        return this;
    }
    ...
    public MetalsSpotHistoryGETQueryParams withHistoricalfx(Boolean historicalfx) {
    ...
    public MetalsSpotHistoryGETQueryParams withInterval(String interval) {
    ...
    public MetalsSpotHistoryGETQueryParams withMetals(String metals) {
        this.metals = metals;
        return this;
    }
    ...
    public MetalsSpotHistoryGETQueryParams withStart(OffsetDateTime start) {
        this.start = start;
        return this;
    }
    ...
    public MetalsSpotHistoryGETQueryParams withUnitofmeasure(MetalsSpotHistoryGETUnitofmeasureEnum unitofmeasure) {
