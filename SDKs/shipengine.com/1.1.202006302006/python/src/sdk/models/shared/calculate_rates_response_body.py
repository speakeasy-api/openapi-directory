...
class CalculateRatesResponseBodyInternationalShipmentOptions:
    r"""CalculateRatesResponseBodyInternationalShipmentOptions
...
class CalculateRatesResponseBodyWeight:
    r"""CalculateRatesResponseBodyWeight
...
class CalculateRatesResponseBody:
    ...
    customs: CalculateRatesResponseBodyInternationalShipmentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('customs') }})
    ...
    rate_response: shared_rates_information.RatesInformation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('rate_response') }})
    ...
    total_weight: CalculateRatesResponseBodyWeight = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('total_weight') }})
