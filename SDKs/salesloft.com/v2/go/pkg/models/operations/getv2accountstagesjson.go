...
type GetV2AccountStagesJSONQueryParams struct {
...
type GetV2AccountStagesJSONRequest struct {
	QueryParams GetV2AccountStagesJSONQueryParams
}

type GetV2AccountStagesJSONResponse struct {
	Body        []byte
	ContentType string
	StatusCode  int
