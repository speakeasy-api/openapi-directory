...
class UpdateResourcePolicyRequest:
    headers: UpdateResourcePolicyHeaders = dataclasses.field()
    path_params: UpdateResourcePolicyPathParams = dataclasses.field()
    query_params: UpdateResourcePolicyQueryParams = dataclasses.field()
    request: UpdateResourcePolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
