...
class DescribeEngineVersionsRequest:
    ...
    describe_engine_versions_request: shared_describeengineversionsrequest.DescribeEngineVersionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
