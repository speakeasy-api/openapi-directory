...
class Locationsv1GetV1LocationsLocationIdGetRequest
{
     ...
     * Order by a field
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Locationsv1GetV1LocationsLocationIdGetOrderByLocationsOrderEnum $orderBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order_by')]
    public ?Locationsv1GetV1LocationsLocationIdGetOrderByLocationsOrderEnum $orderBy = null;
     ...
     * Sort Direction
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\Locationsv1GetV1LocationsLocationIdGetSortSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?Locationsv1GetV1LocationsLocationIdGetSortSortEnum $sort = null;
