...
class UsersUpdateStatusRequest:
    path_params: UsersUpdateStatusPathParams = dataclasses.field()
    security: UsersUpdateStatusSecurity = dataclasses.field()
    request: Optional[UsersUpdateStatusRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
