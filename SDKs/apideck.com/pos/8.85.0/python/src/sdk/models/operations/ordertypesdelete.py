...
from ..shared import deleteordertyperesponse as shared_deleteordertyperesponse
...
@dataclasses.dataclass
class OrderTypesDeleteSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class OrderTypesDeleteRequest:
    headers: OrderTypesDeleteHeaders = dataclasses.field()
    path_params: OrderTypesDeletePathParams = dataclasses.field()
    query_params: OrderTypesDeleteQueryParams = dataclasses.field()
    security: OrderTypesDeleteSecurity = dataclasses.field()
    

@dataclasses.dataclass
class OrderTypesDeleteResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    delete_order_type_response: Optional[shared_deleteordertyperesponse.DeleteOrderTypeResponse] = dataclasses.field(default=None)
