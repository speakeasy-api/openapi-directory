...
var Comments = /** @class */ (function () {
     ...
     */
    Comments.prototype.bloggerCommentsGet = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BloggerCommentsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/blogs/{blogId}/posts/{postId}/comments/{commentId}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.BloggerCommentsGetResponse({
     ...
     * Lists comments.
     */
    Comments.prototype.bloggerCommentsList = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BloggerCommentsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/blogs/{blogId}/posts/{postId}/comments", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.BloggerCommentsListResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
