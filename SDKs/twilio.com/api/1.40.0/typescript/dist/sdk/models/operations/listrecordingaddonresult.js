...
exports.ListRecordingAddOnResultResponse = exports.ListRecordingAddOnResultListRecordingAddOnResultResponse = exports.ListRecordingAddOnResultRequest = exports.ListRecordingAddOnResultSecurity = exports.ListRecordingAddOnResultServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListRecordingAddOnResultServerList = [
...
var ListRecordingAddOnResultSecurity = /** @class */ (function (_super) {
    ...
    ], ListRecordingAddOnResultSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListRecordingAddOnResultSecurity.prototype, "username", void 0);
    return ListRecordingAddOnResultSecurity;
}(utils_1.SpeakeasyBase));
exports.ListRecordingAddOnResultSecurity = ListRecordingAddOnResultSecurity;
var ListRecordingAddOnResultRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListRecordingAddOnResultRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListRecordingAddOnResultRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListRecordingAddOnResultRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListRecordingAddOnResultRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ReferenceSid",
        }),
        __metadata("design:type", String)
    ], ListRecordingAddOnResultRequest.prototype, "referenceSid", void 0);
    return ListRecordingAddOnResultRequest;
}(utils_1.SpeakeasyBase));
exports.ListRecordingAddOnResultRequest = ListRecordingAddOnResultRequest;
/**
 * OK
 */
var ListRecordingAddOnResultListRecordingAddOnResultResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "add_on_results" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountRecordingRecordingAddOnResult; }),
...
exports.ListRecordingAddOnResultListRecordingAddOnResultResponse = ListRecordingAddOnResultListRecordingAddOnResultResponse;
var ListRecordingAddOnResultResponse = /** @class */ (function (_super) {
    ...
    ], ListRecordingAddOnResultResponse.prototype, "rawResponse", void 0);
    return ListRecordingAddOnResultResponse;
}(utils_1.SpeakeasyBase));
exports.ListRecordingAddOnResultResponse = ListRecordingAddOnResultResponse;
