...
func (e ModifyBackupAttributesXAmzTargetEnum) ToPointer() *ModifyBackupAttributesXAmzTargetEnum {
	return &e
}
...
func (e *ModifyBackupAttributesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "BaldrApiService.ModifyBackupAttributes":
		*e = ModifyBackupAttributesXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ModifyBackupAttributesXAmzTargetEnum: %v", v)
	}
}

type ModifyBackupAttributesRequest struct {
	ModifyBackupAttributesRequest shared.ModifyBackupAttributesRequest `request:"mediaType=application/json"`
