...
var Oauth = /** @class */ (function () {
     ...
     *
     */
    Oauth.prototype.getConnect = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetConnectResponse({
     ...
     */
    Oauth.prototype.postOauth2Token = function (req, security, config) {
        var _a;
        var baseURL = this._serverURL;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostOauth2TokenResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
