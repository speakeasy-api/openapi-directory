 ...
 * @access public
 * @see https://docs.aws.amazon.com/gamelift/
 */
class SDK
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\AcceptMatchRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\AcceptMatchResponse
     */
	public function acceptMatch(
        \OpenAPI\OpenAPI\Models\Operations\AcceptMatchRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\AcceptMatchResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.AcceptMatch');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "acceptMatchInput", "json");
        if ($body === null) {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\AcceptMatchResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->acceptMatchOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->unsupportedRegionException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ClaimGameServerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ClaimGameServerResponse
     */
	public function claimGameServer(
        \OpenAPI\OpenAPI\Models\Operations\ClaimGameServerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ClaimGameServerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ClaimGameServer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "claimGameServerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ClaimGameServerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->claimGameServerOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ClaimGameServerOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->outOfCapacityException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateAlias');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createAliasInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createAliasOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateAliasOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->taggingFailedException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateBuild');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createBuildInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createBuildOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateBuildOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateFleet');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createFleetInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createFleetOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateFleetOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateFleetLocationsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateFleetLocationsResponse
     */
	public function createFleetLocations(
        \OpenAPI\OpenAPI\Models\Operations\CreateFleetLocationsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateFleetLocationsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateFleetLocations');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createFleetLocationsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateFleetLocationsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createFleetLocationsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateFleetLocationsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidFleetStatusException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 485) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateGameServerGroupRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateGameServerGroupResponse
     */
	public function createGameServerGroup(
        \OpenAPI\OpenAPI\Models\Operations\CreateGameServerGroupRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateGameServerGroupResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateGameServerGroup');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createGameServerGroupInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateGameServerGroupResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createGameServerGroupOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateGameServerGroupOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionResponse
     */
	public function createGameSession(
        \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateGameSession');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createGameSessionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createGameSessionOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateGameSessionOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->terminalRoutingStrategyException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 485) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->fleetCapacityExceededException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionQueueRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionQueueResponse
     */
	public function createGameSessionQueue(
        \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionQueueRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionQueueResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateGameSessionQueue');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createGameSessionQueueInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateGameSessionQueueResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createGameSessionQueueOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateGameSessionQueueOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateLocation');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createLocationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createLocationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateLocationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingConfigurationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingConfigurationResponse
     */
	public function createMatchmakingConfiguration(
        \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingConfigurationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingConfigurationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateMatchmakingConfiguration');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createMatchmakingConfigurationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingConfigurationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createMatchmakingConfigurationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateMatchmakingConfigurationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingRuleSetRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingRuleSetResponse
     */
	public function createMatchmakingRuleSet(
        \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingRuleSetRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingRuleSetResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateMatchmakingRuleSet');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createMatchmakingRuleSetInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateMatchmakingRuleSetResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createMatchmakingRuleSetOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateMatchmakingRuleSetOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionResponse
     */
	public function createPlayerSession(
        \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreatePlayerSession');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createPlayerSessionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createPlayerSessionOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreatePlayerSessionOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidGameSessionStatusException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 483) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->gameSessionFullException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 484) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionsResponse
     */
	public function createPlayerSessions(
        \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreatePlayerSessions');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createPlayerSessionsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreatePlayerSessionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createPlayerSessionsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreatePlayerSessionsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateScript');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createScriptInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createScriptOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateScriptOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringAuthorizationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringAuthorizationResponse
     */
	public function createVpcPeeringAuthorization(
        \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringAuthorizationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringAuthorizationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateVpcPeeringAuthorization');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createVpcPeeringAuthorizationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringAuthorizationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createVpcPeeringAuthorizationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\CreateVpcPeeringAuthorizationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringConnectionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringConnectionResponse
     */
	public function createVpcPeeringConnection(
        \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringConnectionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringConnectionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.CreateVpcPeeringConnection');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "createVpcPeeringConnectionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateVpcPeeringConnectionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->createVpcPeeringConnectionOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteAlias');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteAliasInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteBuild');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteBuildInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteFleet');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteFleetInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteFleetLocationsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteFleetLocationsResponse
     */
	public function deleteFleetLocations(
        \OpenAPI\OpenAPI\Models\Operations\DeleteFleetLocationsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteFleetLocationsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteFleetLocations');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteFleetLocationsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteFleetLocationsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteFleetLocationsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DeleteFleetLocationsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteGameServerGroupRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteGameServerGroupResponse
     */
	public function deleteGameServerGroup(
        \OpenAPI\OpenAPI\Models\Operations\DeleteGameServerGroupRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteGameServerGroupResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteGameServerGroup');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteGameServerGroupInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteGameServerGroupResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteGameServerGroupOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DeleteGameServerGroupOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteGameSessionQueueRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteGameSessionQueueResponse
     */
	public function deleteGameSessionQueue(
        \OpenAPI\OpenAPI\Models\Operations\DeleteGameSessionQueueRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteGameSessionQueueResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteGameSessionQueue');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteGameSessionQueueInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteGameSessionQueueResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteGameSessionQueueOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteLocation');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteLocationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteLocationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingConfigurationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingConfigurationResponse
     */
	public function deleteMatchmakingConfiguration(
        \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingConfigurationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingConfigurationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteMatchmakingConfiguration');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteMatchmakingConfigurationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingConfigurationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteMatchmakingConfigurationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingRuleSetRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingRuleSetResponse
     */
	public function deleteMatchmakingRuleSet(
        \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingRuleSetRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingRuleSetResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteMatchmakingRuleSet');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteMatchmakingRuleSetInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteMatchmakingRuleSetResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteMatchmakingRuleSetOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteScalingPolicy');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteScalingPolicyInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteScript');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteScriptInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringAuthorizationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringAuthorizationResponse
     */
	public function deleteVpcPeeringAuthorization(
        \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringAuthorizationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringAuthorizationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteVpcPeeringAuthorization');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteVpcPeeringAuthorizationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringAuthorizationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteVpcPeeringAuthorizationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringConnectionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringConnectionResponse
     */
	public function deleteVpcPeeringConnection(
        \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringConnectionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringConnectionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeleteVpcPeeringConnection');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deleteVpcPeeringConnectionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeleteVpcPeeringConnectionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteVpcPeeringConnectionOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeregisterComputeRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeregisterComputeResponse
     */
	public function deregisterCompute(
        \OpenAPI\OpenAPI\Models\Operations\DeregisterComputeRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeregisterComputeResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeregisterCompute');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deregisterComputeInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeregisterComputeResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deregisterComputeOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DeregisterGameServerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DeregisterGameServerResponse
     */
	public function deregisterGameServer(
        \OpenAPI\OpenAPI\Models\Operations\DeregisterGameServerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DeregisterGameServerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DeregisterGameServer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "deregisterGameServerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DeregisterGameServerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeAliasRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeAliasResponse
     */
	public function describeAlias(
        \OpenAPI\OpenAPI\Models\Operations\DescribeAliasRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeAliasResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeAlias');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeAliasInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeAliasResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeAliasOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeAliasOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeBuildRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeBuildResponse
     */
	public function describeBuild(
        \OpenAPI\OpenAPI\Models\Operations\DescribeBuildRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeBuildResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeBuild');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeBuildInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeBuildResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeBuildOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeBuildOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeComputeRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeComputeResponse
     */
	public function describeCompute(
        \OpenAPI\OpenAPI\Models\Operations\DescribeComputeRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeComputeResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeCompute');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeComputeInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeComputeResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeComputeOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeComputeOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeEc2InstanceLimitsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeEc2InstanceLimitsResponse
     */
	public function describeEc2InstanceLimits(
        \OpenAPI\OpenAPI\Models\Operations\DescribeEc2InstanceLimitsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeEc2InstanceLimitsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeEC2InstanceLimits');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeEc2InstanceLimitsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeEc2InstanceLimitsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeEc2InstanceLimitsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeEc2InstanceLimitsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetAttributesRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetAttributesResponse
     */
	public function describeFleetAttributes(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetAttributesRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetAttributesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetAttributes');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetAttributesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeFleetAttributesRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetAttributesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetAttributesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetAttributesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetCapacityRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetCapacityResponse
     */
	public function describeFleetCapacity(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetCapacityRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetCapacityResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetCapacity');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetCapacityInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeFleetCapacityRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetCapacityResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetCapacityOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetCapacityOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetEventsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetEventsResponse
     */
	public function describeFleetEvents(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetEventsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetEventsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetEvents');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetEventsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeFleetEventsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetEventsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetEventsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetEventsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationAttributesRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationAttributesResponse
     */
	public function describeFleetLocationAttributes(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationAttributesRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationAttributesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetLocationAttributes');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetLocationAttributesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationAttributesRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationAttributesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetLocationAttributesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetLocationAttributesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationCapacityRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationCapacityResponse
     */
	public function describeFleetLocationCapacity(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationCapacityRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationCapacityResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetLocationCapacity');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetLocationCapacityInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationCapacityResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetLocationCapacityOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetLocationCapacityOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationUtilizationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationUtilizationResponse
     */
	public function describeFleetLocationUtilization(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationUtilizationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationUtilizationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetLocationUtilization');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetLocationUtilizationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetLocationUtilizationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetLocationUtilizationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetLocationUtilizationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetPortSettingsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetPortSettingsResponse
     */
	public function describeFleetPortSettings(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetPortSettingsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetPortSettingsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetPortSettings');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetPortSettingsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetPortSettingsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetPortSettingsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetPortSettingsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeFleetUtilizationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeFleetUtilizationResponse
     */
	public function describeFleetUtilization(
        \OpenAPI\OpenAPI\Models\Operations\DescribeFleetUtilizationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeFleetUtilizationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeFleetUtilization');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeFleetUtilizationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeFleetUtilizationRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeFleetUtilizationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeFleetUtilizationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeFleetUtilizationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerResponse
     */
	public function describeGameServer(
        \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeGameServer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeGameServerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeGameServerOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeGameServerOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerGroupRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerGroupResponse
     */
	public function describeGameServerGroup(
        \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerGroupRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerGroupResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeGameServerGroup');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeGameServerGroupInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerGroupResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeGameServerGroupOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeGameServerGroupOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerInstancesRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerInstancesResponse
     */
	public function describeGameServerInstances(
        \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerInstancesRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerInstancesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeGameServerInstances');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeGameServerInstancesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeGameServerInstancesRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeGameServerInstancesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeGameServerInstancesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeGameServerInstancesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionDetailsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionDetailsResponse
     */
	public function describeGameSessionDetails(
        \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionDetailsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionDetailsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeGameSessionDetails');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeGameSessionDetailsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionDetailsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionDetailsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeGameSessionDetailsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeGameSessionDetailsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionPlacementRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionPlacementResponse
     */
	public function describeGameSessionPlacement(
        \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionPlacementRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionPlacementResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeGameSessionPlacement');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeGameSessionPlacementInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionPlacementResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeGameSessionPlacementOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeGameSessionPlacementOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionQueuesRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionQueuesResponse
     */
	public function describeGameSessionQueues(
        \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionQueuesRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionQueuesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeGameSessionQueues');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeGameSessionQueuesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionQueuesRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionQueuesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeGameSessionQueuesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeGameSessionQueuesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionsResponse
     */
	public function describeGameSessions(
        \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeGameSessions');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeGameSessionsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeGameSessionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeGameSessionsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeGameSessionsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeInstances');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeInstancesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeInstancesRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeInstancesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeInstancesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingResponse
     */
	public function describeMatchmaking(
        \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeMatchmaking');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeMatchmakingInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeMatchmakingOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeMatchmakingOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingConfigurationsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingConfigurationsResponse
     */
	public function describeMatchmakingConfigurations(
        \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingConfigurationsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingConfigurationsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeMatchmakingConfigurations');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeMatchmakingConfigurationsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingConfigurationsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingConfigurationsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeMatchmakingConfigurationsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeMatchmakingConfigurationsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRuleSetsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRuleSetsResponse
     */
	public function describeMatchmakingRuleSets(
        \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRuleSetsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRuleSetsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeMatchmakingRuleSets');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeMatchmakingRuleSetsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRuleSetsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeMatchmakingRuleSetsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeMatchmakingRuleSetsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeMatchmakingRuleSetsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribePlayerSessionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribePlayerSessionsResponse
     */
	public function describePlayerSessions(
        \OpenAPI\OpenAPI\Models\Operations\DescribePlayerSessionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribePlayerSessionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribePlayerSessions');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describePlayerSessionsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\DescribePlayerSessionsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribePlayerSessionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describePlayerSessionsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribePlayerSessionsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeRuntimeConfigurationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeRuntimeConfigurationResponse
     */
	public function describeRuntimeConfiguration(
        \OpenAPI\OpenAPI\Models\Operations\DescribeRuntimeConfigurationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeRuntimeConfigurationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeRuntimeConfiguration');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeRuntimeConfigurationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeRuntimeConfigurationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeRuntimeConfigurationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeRuntimeConfigurationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeScalingPolicies');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeScalingPoliciesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeScalingPoliciesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeScalingPoliciesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeScriptRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeScriptResponse
     */
	public function describeScript(
        \OpenAPI\OpenAPI\Models\Operations\DescribeScriptRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeScriptResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeScript');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeScriptInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeScriptResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeScriptOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeScriptOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringAuthorizationsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringAuthorizationsResponse
     */
	public function describeVpcPeeringAuthorizations(
        \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringAuthorizationsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringAuthorizationsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeVpcPeeringAuthorizations');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringAuthorizationsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeVpcPeeringAuthorizationsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeVpcPeeringAuthorizationsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringConnectionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringConnectionsResponse
     */
	public function describeVpcPeeringConnections(
        \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringConnectionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringConnectionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.DescribeVpcPeeringConnections');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "describeVpcPeeringConnectionsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\DescribeVpcPeeringConnectionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->describeVpcPeeringConnectionsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DescribeVpcPeeringConnectionsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetComputeAccessRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetComputeAccessResponse
     */
	public function getComputeAccess(
        \OpenAPI\OpenAPI\Models\Operations\GetComputeAccessRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetComputeAccessResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.GetComputeAccess');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getComputeAccessInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetComputeAccessResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getComputeAccessOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetComputeAccessOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetComputeAuthTokenRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetComputeAuthTokenResponse
     */
	public function getComputeAuthToken(
        \OpenAPI\OpenAPI\Models\Operations\GetComputeAuthTokenRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetComputeAuthTokenResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.GetComputeAuthToken');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getComputeAuthTokenInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetComputeAuthTokenResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getComputeAuthTokenOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetComputeAuthTokenOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetGameSessionLogUrlRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetGameSessionLogUrlResponse
     */
	public function getGameSessionLogUrl(
        \OpenAPI\OpenAPI\Models\Operations\GetGameSessionLogUrlRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetGameSessionLogUrlResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.GetGameSessionLogUrl');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getGameSessionLogUrlInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetGameSessionLogUrlResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getGameSessionLogUrlOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetGameSessionLogUrlOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetInstanceAccessRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetInstanceAccessResponse
     */
	public function getInstanceAccess(
        \OpenAPI\OpenAPI\Models\Operations\GetInstanceAccessRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetInstanceAccessResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.GetInstanceAccess');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "getInstanceAccessInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetInstanceAccessResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getInstanceAccessOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetInstanceAccessOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListAliases');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listAliasesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listAliasesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListAliasesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListBuilds');
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListComputeRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListComputeResponse
     */
	public function listCompute(
        \OpenAPI\OpenAPI\Models\Operations\ListComputeRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListComputeResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListCompute');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listComputeInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListComputeRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListComputeResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listComputeOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListComputeOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListFleets');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listFleetsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listFleetsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListFleetsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListGameServerGroupsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListGameServerGroupsResponse
     */
	public function listGameServerGroups(
        \OpenAPI\OpenAPI\Models\Operations\ListGameServerGroupsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListGameServerGroupsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListGameServerGroups');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listGameServerGroupsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListGameServerGroupsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListGameServerGroupsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listGameServerGroupsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListGameServerGroupsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListGameServersRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListGameServersResponse
     */
	public function listGameServers(
        \OpenAPI\OpenAPI\Models\Operations\ListGameServersRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListGameServersResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListGameServers');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listGameServersInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListGameServersRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListGameServersResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listGameServersOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListGameServersOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListLocations');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listLocationsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listLocationsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListLocationsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListScriptsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListScriptsResponse
     */
	public function listScripts(
        \OpenAPI\OpenAPI\Models\Operations\ListScriptsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListScriptsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListScripts');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listScriptsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListScriptsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListScriptsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listScriptsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListScriptsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ListTagsForResource');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.PutScalingPolicy');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "putScalingPolicyInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->putScalingPolicyOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\PutScalingPolicyOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RegisterComputeRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RegisterComputeResponse
     */
	public function registerCompute(
        \OpenAPI\OpenAPI\Models\Operations\RegisterComputeRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RegisterComputeResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.RegisterCompute');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "registerComputeInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RegisterComputeResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->registerComputeOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\RegisterComputeOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RegisterGameServerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RegisterGameServerResponse
     */
	public function registerGameServer(
        \OpenAPI\OpenAPI\Models\Operations\RegisterGameServerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RegisterGameServerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.RegisterGameServer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "registerGameServerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RegisterGameServerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->registerGameServerOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\RegisterGameServerOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RequestUploadCredentialsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RequestUploadCredentialsResponse
     */
	public function requestUploadCredentials(
        \OpenAPI\OpenAPI\Models\Operations\RequestUploadCredentialsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RequestUploadCredentialsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.RequestUploadCredentials');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "requestUploadCredentialsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RequestUploadCredentialsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->requestUploadCredentialsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\RequestUploadCredentialsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ResolveAliasRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ResolveAliasResponse
     */
	public function resolveAlias(
        \OpenAPI\OpenAPI\Models\Operations\ResolveAliasRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ResolveAliasResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ResolveAlias');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "resolveAliasInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ResolveAliasResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->resolveAliasOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ResolveAliasOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ResumeGameServerGroupRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ResumeGameServerGroupResponse
     */
	public function resumeGameServerGroup(
        \OpenAPI\OpenAPI\Models\Operations\ResumeGameServerGroupRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ResumeGameServerGroupResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ResumeGameServerGroup');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "resumeGameServerGroupInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ResumeGameServerGroupResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->resumeGameServerGroupOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ResumeGameServerGroupOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\SearchGameSessionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\SearchGameSessionsResponse
     */
	public function searchGameSessions(
        \OpenAPI\OpenAPI\Models\Operations\SearchGameSessionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\SearchGameSessionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.SearchGameSessions');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "searchGameSessionsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\SearchGameSessionsRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\SearchGameSessionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->searchGameSessionsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\SearchGameSessionsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StartFleetActionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StartFleetActionsResponse
     */
	public function startFleetActions(
        \OpenAPI\OpenAPI\Models\Operations\StartFleetActionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StartFleetActionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.StartFleetActions');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "startFleetActionsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StartFleetActionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->startFleetActionsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\StartFleetActionsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StartGameSessionPlacementRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StartGameSessionPlacementResponse
     */
	public function startGameSessionPlacement(
        \OpenAPI\OpenAPI\Models\Operations\StartGameSessionPlacementRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StartGameSessionPlacementResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.StartGameSessionPlacement');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "startGameSessionPlacementInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StartGameSessionPlacementResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->startGameSessionPlacementOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\StartGameSessionPlacementOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StartMatchBackfillRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StartMatchBackfillResponse
     */
	public function startMatchBackfill(
        \OpenAPI\OpenAPI\Models\Operations\StartMatchBackfillRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StartMatchBackfillResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.StartMatchBackfill');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "startMatchBackfillInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StartMatchBackfillResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->startMatchBackfillOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\StartMatchBackfillOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StartMatchmakingRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StartMatchmakingResponse
     */
	public function startMatchmaking(
        \OpenAPI\OpenAPI\Models\Operations\StartMatchmakingRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StartMatchmakingResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.StartMatchmaking');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "startMatchmakingInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StartMatchmakingResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->startMatchmakingOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\StartMatchmakingOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StopFleetActionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StopFleetActionsResponse
     */
	public function stopFleetActions(
        \OpenAPI\OpenAPI\Models\Operations\StopFleetActionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StopFleetActionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.StopFleetActions');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "stopFleetActionsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StopFleetActionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->stopFleetActionsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\StopFleetActionsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StopGameSessionPlacementRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StopGameSessionPlacementResponse
     */
	public function stopGameSessionPlacement(
        \OpenAPI\OpenAPI\Models\Operations\StopGameSessionPlacementRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StopGameSessionPlacementResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.StopGameSessionPlacement');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "stopGameSessionPlacementInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StopGameSessionPlacementResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->stopGameSessionPlacementOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\StopGameSessionPlacementOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StopMatchmakingRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\StopMatchmakingResponse
     */
	public function stopMatchmaking(
        \OpenAPI\OpenAPI\Models\Operations\StopMatchmakingRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\StopMatchmakingResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.StopMatchmaking');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "stopMatchmakingInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StopMatchmakingResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->stopMatchmakingOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'array<string, mixed>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\SuspendGameServerGroupRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\SuspendGameServerGroupResponse
     */
	public function suspendGameServerGroup(
        \OpenAPI\OpenAPI\Models\Operations\SuspendGameServerGroupRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\SuspendGameServerGroupResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.SuspendGameServerGroup');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "suspendGameServerGroupInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\SuspendGameServerGroupResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->suspendGameServerGroupOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\SuspendGameServerGroupOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.TagResource');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UntagResource');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateAlias');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateAliasInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateAliasOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateAliasOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateBuildRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateBuildResponse
     */
	public function updateBuild(
        \OpenAPI\OpenAPI\Models\Operations\UpdateBuildRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateBuildResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateBuild');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateBuildInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateBuildResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateBuildOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateBuildOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateFleetAttributesRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateFleetAttributesResponse
     */
	public function updateFleetAttributes(
        \OpenAPI\OpenAPI\Models\Operations\UpdateFleetAttributesRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateFleetAttributesResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateFleetAttributes');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateFleetAttributesInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateFleetAttributesResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateFleetAttributesOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateFleetAttributesOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateFleetCapacityRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateFleetCapacityResponse
     */
	public function updateFleetCapacity(
        \OpenAPI\OpenAPI\Models\Operations\UpdateFleetCapacityRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateFleetCapacityResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateFleetCapacity');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateFleetCapacityInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateFleetCapacityResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateFleetCapacityOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateFleetCapacityOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateFleetPortSettingsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateFleetPortSettingsResponse
     */
	public function updateFleetPortSettings(
        \OpenAPI\OpenAPI\Models\Operations\UpdateFleetPortSettingsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateFleetPortSettingsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateFleetPortSettings');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateFleetPortSettingsInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateFleetPortSettingsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateFleetPortSettingsOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateFleetPortSettingsOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerResponse
     */
	public function updateGameServer(
        \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateGameServer');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateGameServerInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateGameServerOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateGameServerOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerGroupRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerGroupResponse
     */
	public function updateGameServerGroup(
        \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerGroupRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerGroupResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateGameServerGroup');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateGameServerGroupInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateGameServerGroupResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateGameServerGroupOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateGameServerGroupOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionResponse
     */
	public function updateGameSession(
        \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateGameSession');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateGameSessionInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateGameSessionOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateGameSessionOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionQueueRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionQueueResponse
     */
	public function updateGameSessionQueue(
        \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionQueueRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionQueueResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateGameSessionQueue');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateGameSessionQueueInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateGameSessionQueueResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateGameSessionQueueOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateGameSessionQueueOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateMatchmakingConfigurationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateMatchmakingConfigurationResponse
     */
	public function updateMatchmakingConfiguration(
        \OpenAPI\OpenAPI\Models\Operations\UpdateMatchmakingConfigurationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateMatchmakingConfigurationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateMatchmakingConfiguration');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateMatchmakingConfigurationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateMatchmakingConfigurationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateMatchmakingConfigurationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateMatchmakingConfigurationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateRuntimeConfigurationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateRuntimeConfigurationResponse
     */
	public function updateRuntimeConfiguration(
        \OpenAPI\OpenAPI\Models\Operations\UpdateRuntimeConfigurationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateRuntimeConfigurationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateRuntimeConfiguration');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateRuntimeConfigurationInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateRuntimeConfigurationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateRuntimeConfigurationOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateRuntimeConfigurationOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.UpdateScript');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateScriptInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->updateScriptOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\UpdateScriptOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ValidateMatchmakingRuleSetRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ValidateMatchmakingRuleSetResponse
     */
	public function validateMatchmakingRuleSet(
        \OpenAPI\OpenAPI\Models\Operations\ValidateMatchmakingRuleSetRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ValidateMatchmakingRuleSetResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=GameLift.ValidateMatchmakingRuleSet');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "validateMatchmakingRuleSetInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ValidateMatchmakingRuleSetResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->validateMatchmakingRuleSetOutput = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ValidateMatchmakingRuleSetOutput', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
