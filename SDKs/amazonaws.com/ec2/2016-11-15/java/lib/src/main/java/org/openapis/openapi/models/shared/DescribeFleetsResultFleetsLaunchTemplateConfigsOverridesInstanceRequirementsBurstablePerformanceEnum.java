 ...
 */
public enum DescribeFleetsResultFleetsLaunchTemplateConfigsOverridesInstanceRequirementsBurstablePerformanceEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private DescribeFleetsResultFleetsLaunchTemplateConfigsOverridesInstanceRequirementsBurstablePerformanceEnum(String value) {
        this.value = value;
    }
}
