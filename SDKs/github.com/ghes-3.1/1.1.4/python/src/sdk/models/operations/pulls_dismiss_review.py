...
class PullsDismissReviewRequest:
    path_params: PullsDismissReviewPathParams = dataclasses.field()
    request: Optional[PullsDismissReviewRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
