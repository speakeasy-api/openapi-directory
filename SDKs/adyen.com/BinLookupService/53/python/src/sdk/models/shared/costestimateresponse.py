...
class CostEstimateResponse:
    ...
    cost_estimate_reference: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('costEstimateReference'), 'exclude': lambda f: f is None }})
    r"""Adyen's 16-character reference associated with the request."""  
