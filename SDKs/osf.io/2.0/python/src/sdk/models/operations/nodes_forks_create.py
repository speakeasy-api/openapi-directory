...
class NodesForksCreateNodeAttributesInput:
    ...
    category: NodesForksCreateNodeAttributesCategoryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category') }})
    r"""The category of the node, as selected by project contributors."""  
...
class NodesForksCreateNodeInput:
    ...
    attributes: NodesForksCreateNodeAttributesInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes') }})
    r"""The properties of the node entity."""  
...
class NodesForksCreateRequest:
    ...
    request_body: NodesForksCreateNodeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
