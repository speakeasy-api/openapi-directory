...
export class ReposCreateDeploymentBranchPolicyRequest extends SpeakeasyBase {
...
export class ReposCreateDeploymentBranchPolicyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
