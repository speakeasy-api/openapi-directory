...
class SecuritycenterOrganizationsAssetsListRequest:
    ...
    r"""Required. Name of the organization assets should belong to. Its format is \\"organizations/[organization_id]\\"."""  
