...
from ..shared import googlecloudretailv2alpharemovecatalogattributerequest as shared_googlecloudretailv2alpharemovecatalogattributerequest
...
class RetailProjectsLocationsCatalogsAttributesConfigRemoveCatalogAttributeRequest:
    ...
    google_cloud_retail_v2alpha_remove_catalog_attribute_request: Optional[shared_googlecloudretailv2alpharemovecatalogattributerequest.GoogleCloudRetailV2alphaRemoveCatalogAttributeRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
