 ...
 */
export enum NodesContributorsListContributorAttributesPermissionEnum {
  Read = "read",
  Write = "write",
  Admin = "admin",
}
 ...
 */
export class NodesContributorsListContributorAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class NodesContributorsListContributorLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesContributorsListContributorRelationships extends SpeakeasyBase {
  /**
...
export class NodesContributorsListContributor extends SpeakeasyBase {
  /**
   * The properties of the contributor entity.
   */
  @SpeakeasyMetadata()
