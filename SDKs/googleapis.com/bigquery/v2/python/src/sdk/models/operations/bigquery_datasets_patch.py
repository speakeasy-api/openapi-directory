...
@dataclasses.dataclass
class BigqueryDatasetsPatchSecurity:
    
    option1: Optional[BigqueryDatasetsPatchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[BigqueryDatasetsPatchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class BigqueryDatasetsPatchRequest:
    ...
    r"""Dataset ID of the dataset being updated"""  
    project_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'projectId', 'style': 'simple', 'explode': False }})
    r"""Project ID of the dataset being updated"""  
