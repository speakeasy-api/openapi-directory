  ...
  **/
  getUserInformation(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetUserInformationResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
