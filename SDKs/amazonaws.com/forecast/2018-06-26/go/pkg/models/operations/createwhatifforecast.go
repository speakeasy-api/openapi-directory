...
func (e *CreateWhatIfForecastXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonForecast.CreateWhatIfForecast":
		*e = CreateWhatIfForecastXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateWhatIfForecastXAmzTargetEnum: %s", s)
	}
}

type CreateWhatIfForecastHeaders struct {
...
type CreateWhatIfForecastRequest struct {
	Headers CreateWhatIfForecastHeaders
	Request shared.CreateWhatIfForecastRequest `request:"mediaType=application/json"`
}
