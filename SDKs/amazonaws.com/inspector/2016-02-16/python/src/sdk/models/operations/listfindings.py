...
from ..shared import listfindingsrequest as shared_listfindingsrequest
...
class ListFindingsHeaders:
    x_amz_target: ListFindingsXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFindingsRequest:
    ...
    request: shared_listfindingsrequest.ListFindingsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
