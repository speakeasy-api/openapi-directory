...
public class Projects {
    ...
    **/
    public openapisdk.models.operations.PolicyanalyzerProjectsLocationsActivityTypesActivitiesQueryResponse policyanalyzerProjectsLocationsActivityTypesActivitiesQuery(openapisdk.models.operations.PolicyanalyzerProjectsLocationsActivityTypesActivitiesQueryRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1beta1/{parent}/activities:query", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse.class);
