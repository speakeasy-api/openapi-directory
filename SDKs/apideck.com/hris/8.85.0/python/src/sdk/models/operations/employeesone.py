...
from ..shared import getemployeeresponse as shared_getemployeeresponse
...
class EmployeesOneRequest:
    headers: EmployeesOneHeaders = dataclasses.field()
    path_params: EmployeesOnePathParams = dataclasses.field()
    query_params: EmployeesOneQueryParams = dataclasses.field()
    security: EmployeesOneSecurity = dataclasses.field()
...
class EmployeesOneResponse:
    ...
    get_employee_response: Optional[shared_getemployeeresponse.GetEmployeeResponse] = dataclasses.field(default=None)
