...
class ListObjectParentsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListObjectParentsXAmzConsistencyLevelEnum $xAmzConsistencyLevel
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=x-amz-consistency-level')]
    public ?ListObjectParentsXAmzConsistencyLevelEnum $xAmzConsistencyLevel = null;
	...
	public function __construct()
	{
		...
		$this->nextToken = null;
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\ListObjectParentsRequestBody();
