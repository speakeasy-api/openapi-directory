...
class TagmanagerAccountsContainersEnvironmentsGetSecurity:
    ...
    option1: Optional[TagmanagerAccountsContainersEnvironmentsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[TagmanagerAccountsContainersEnvironmentsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
