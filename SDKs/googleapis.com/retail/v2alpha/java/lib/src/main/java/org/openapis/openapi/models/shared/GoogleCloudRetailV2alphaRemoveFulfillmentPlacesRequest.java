 ...
 */
public class GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest {
    /**
    ...
    public GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest withAllowMissing(Boolean allowMissing) {
    ...
    public GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest withPlaceIds(String[] placeIds) {
    ...
    public GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest withRemoveTime(String removeTime) {
    ...
    public GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest withType(String type) {
        this.type = type;
        return this;
    }
    
    public GoogleCloudRetailV2alphaRemoveFulfillmentPlacesRequest(){}
}
