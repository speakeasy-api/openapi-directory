...
class DeleteOtaUpdateRequest:
    headers: DeleteOtaUpdateHeaders = dataclasses.field()
    path_params: DeleteOtaUpdatePathParams = dataclasses.field()
    query_params: DeleteOtaUpdateQueryParams = dataclasses.field()
