...
@dataclasses.dataclass
class DisplayvideoAdvertisersCreativesGetQueryParams:
...
class DisplayvideoAdvertisersCreativesGetRequest:
    path_params: DisplayvideoAdvertisersCreativesGetPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersCreativesGetQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersCreativesGetSecurity = dataclasses.field()
