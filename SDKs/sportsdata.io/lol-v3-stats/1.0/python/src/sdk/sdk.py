...
class SDK:
    ...
    def champions(self, request: operations.ChampionsRequest) -> operations.ChampionsResponse:
        ...
        url = utils.generate_url(operations.ChampionsRequest, base_url, '/{format}/Champions', request)
        ...
        res = operations.ChampionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Champion]])
                res.champions = out
    ...
    def items(self, request: operations.ItemsRequest) -> operations.ItemsResponse:
        ...
        url = utils.generate_url(operations.ItemsRequest, base_url, '/{format}/Items', request)
    ...
    def spells(self, request: operations.SpellsRequest) -> operations.SpellsResponse:
        ...
        url = utils.generate_url(operations.SpellsRequest, base_url, '/{format}/Spells', request)
        ...
        res = operations.SpellsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Spell]])
                res.spells = out
