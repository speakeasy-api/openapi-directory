...
export class IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
