...
class ListNotificationRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Notification resources to read."""  
...
class ListNotificationListNotificationResponse:
    ...
    notifications: Optional[list[shared_api_v2010_account_notification.APIV2010AccountNotification]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('notifications'), 'exclude': lambda f: f is None }})  
