...
class GetResumeProcessesQueryParams:
    action: GetResumeProcessesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetResumeProcessesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetResumeProcessesRequest:
    headers: GetResumeProcessesHeaders = dataclasses.field()
    query_params: GetResumeProcessesQueryParams = dataclasses.field()
