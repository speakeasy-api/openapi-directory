...
from ..shared import revertbuiltinvariableresponse as shared_revertbuiltinvariableresponse
...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum(str, Enum):
    r"""The type of built-in variable to revert."""
...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertRequest:
    ...
    r"""GTM BuiltInVariable's API relative path. Example: accounts/{account_id}/containers/{container_id}/workspaces/{workspace_id}/built_in_variables"""  
    ...
    type: Optional[TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""The type of built-in variable to revert."""  
...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertResponse:
    ...
    revert_built_in_variable_response: Optional[shared_revertbuiltinvariableresponse.RevertBuiltInVariableResponse] = dataclasses.field(default=None)
