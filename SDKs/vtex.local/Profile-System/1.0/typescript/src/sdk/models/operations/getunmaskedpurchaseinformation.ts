...
export class GetUnmaskedPurchaseInformationRequest extends SpeakeasyBase {
  /**
...
export class GetUnmaskedPurchaseInformationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getUnmaskedPurchaseInformation200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
