...
from ..shared import modelpackagegroupsortby_enum as shared_modelpackagegroupsortby_enum
...
class ListModelPackageGroupsInput:
    ...
    sort_by: Optional[shared_modelpackagegroupsortby_enum.ModelPackageGroupSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
