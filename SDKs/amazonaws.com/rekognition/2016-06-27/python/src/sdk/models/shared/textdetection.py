...
class TextDetection:
    ...
    detected_text: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DetectedText') }})
    ...
    type: Optional[shared_texttypes_enum.TextTypesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Type') }})
