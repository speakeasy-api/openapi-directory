...
class DescribeSentimentDetectionJobRequest:
    ...
    describe_sentiment_detection_job_request: shared_describesentimentdetectionjobrequest.DescribeSentimentDetectionJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
