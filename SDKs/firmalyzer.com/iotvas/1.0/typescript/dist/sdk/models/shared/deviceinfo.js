...
var DeviceInfoFirmwareInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sha2" }),
        __metadata("design:type", String)
...
var DeviceInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "cve_list" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "firmware_info" }),
        (0, class_transformer_1.Type)(function () { return DeviceInfoFirmwareInfo; }),
        __metadata("design:type", DeviceInfoFirmwareInfo)
    ], DeviceInfo.prototype, "firmwareInfo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "firmware_version" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "firmwareVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is_discontinued" }),
        __metadata("design:type", Boolean)
    ], DeviceInfo.prototype, "isDiscontinued", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "latest_firmware_info" }),
        (0, class_transformer_1.Type)(function () { return DeviceInfoFirmwareInfo; }),
        __metadata("design:type", DeviceInfoFirmwareInfo)
