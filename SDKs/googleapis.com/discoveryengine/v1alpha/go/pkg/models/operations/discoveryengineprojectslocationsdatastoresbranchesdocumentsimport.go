...
type DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsImportRequest struct {
	...
	GoogleCloudDiscoveryengineV1alphaImportDocumentsRequest *shared.GoogleCloudDiscoveryengineV1alphaImportDocumentsRequest `request:"mediaType=application/json"`
	// OAuth access token.
