...
from ..shared import refundnotpaidouttransfersresponse as shared_refundnotpaidouttransfersresponse
...
class PostRefundNotPaidOutTransfersResponse:
    ...
    refund_not_paid_out_transfers_response: Optional[shared_refundnotpaidouttransfersresponse.RefundNotPaidOutTransfersResponse] = dataclasses.field(default=None)
