...
class DriveDrivesCreateQueryParams:
...
@dataclasses.dataclass
class DriveDrivesCreateSecurity:
...
class DriveDrivesCreateRequest:
    query_params: DriveDrivesCreateQueryParams = dataclasses.field()
    security: DriveDrivesCreateSecurity = dataclasses.field()
