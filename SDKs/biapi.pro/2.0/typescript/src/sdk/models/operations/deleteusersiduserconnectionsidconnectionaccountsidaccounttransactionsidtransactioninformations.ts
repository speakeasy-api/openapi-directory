...
export class DeleteUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DeleteUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
