...
public class GetNamesSearchQueryParams {
    ...
    public GetNamesSearchQueryParams withEmbed(GetNamesSearchEmbedEnum embed) {
        this.embed = embed;
        return this;
    }
    ...
    public GetNamesSearchQueryParams withExactSpelling(GetNamesSearchExactSpellingEnum exactSpelling) {
    ...
    public GetNamesSearchQueryParams withOutputSRS(GetNamesSearchOutputSrsEnum outputSRS) {
