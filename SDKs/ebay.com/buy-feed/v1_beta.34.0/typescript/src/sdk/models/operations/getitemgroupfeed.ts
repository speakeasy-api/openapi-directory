...
export class GetItemGroupFeedSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetItemGroupFeedRequest extends SpeakeasyBase {
  /**
...
export class GetItemGroupFeedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
