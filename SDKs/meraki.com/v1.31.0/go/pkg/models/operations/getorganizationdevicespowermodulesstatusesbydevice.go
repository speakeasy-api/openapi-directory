...
type GetOrganizationDevicesPowerModulesStatusesByDevicePathParams struct {
...
type GetOrganizationDevicesPowerModulesStatusesByDeviceRequest struct {
	PathParams  GetOrganizationDevicesPowerModulesStatusesByDevicePathParams
	QueryParams GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams
}
