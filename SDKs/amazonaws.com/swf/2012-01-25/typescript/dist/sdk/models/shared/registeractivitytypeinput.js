...
var RegisterActivityTypeInput = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "defaultTaskHeartbeatTimeout" }),
        __metadata("design:type", String)
    ], RegisterActivityTypeInput.prototype, "defaultTaskHeartbeatTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultTaskList" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultTaskPriority" }),
        __metadata("design:type", String)
    ], RegisterActivityTypeInput.prototype, "defaultTaskPriority", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultTaskScheduleToCloseTimeout" }),
        __metadata("design:type", String)
    ], RegisterActivityTypeInput.prototype, "defaultTaskScheduleToCloseTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultTaskScheduleToStartTimeout" }),
        __metadata("design:type", String)
    ], RegisterActivityTypeInput.prototype, "defaultTaskScheduleToStartTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultTaskStartToCloseTimeout" }),
        __metadata("design:type", String)
