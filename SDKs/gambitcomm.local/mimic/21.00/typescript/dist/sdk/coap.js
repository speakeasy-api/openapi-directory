...
var Coap = /** @class */ (function () {
    function Coap(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Coap.prototype.protocolCoapGetArgs = function (req, config) {
     ...
     * Agent's COAP configuration with port,rule,prompt,paging_prompt,userdb,keymap
    **/
    Coap.prototype.protocolCoapGetConfig = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Coap.prototype.protocolCoapGetStatistics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Coap.prototype.protocolCoapGetStatsHdr = function (config) {
        var baseURL = this._serverURL;
    ...
    **/
    Coap.prototype.protocolCoapGetTrace = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Agent's COAP configuration with port,rule,prompt,paging_prompt,userdb,keymap
    **/
    Coap.prototype.protocolCoapSetConfig = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Coap.prototype.protocolCoapSetTrace = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
