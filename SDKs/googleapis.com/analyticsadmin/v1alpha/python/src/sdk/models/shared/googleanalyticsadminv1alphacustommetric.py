...
class GoogleAnalyticsAdminV1alphaCustomMetric:
    ...
    measurement_unit: Optional[GoogleAnalyticsAdminV1alphaCustomMetricMeasurementUnitEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('measurementUnit'), 'exclude': lambda f: f is None }})
    r"""Required. The type for the custom metric's value."""  
    ...
    restricted_metric_type: Optional[list[GoogleAnalyticsAdminV1alphaCustomMetricRestrictedMetricTypeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('restrictedMetricType'), 'exclude': lambda f: f is None }})
    ...
    scope: Optional[GoogleAnalyticsAdminV1alphaCustomMetricScopeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scope'), 'exclude': lambda f: f is None }})
    r"""Required. Immutable. The scope of this custom metric."""  
