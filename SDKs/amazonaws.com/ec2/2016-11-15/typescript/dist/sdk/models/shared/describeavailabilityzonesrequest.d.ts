 ...
 */
export declare class DescribeAvailabilityZonesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeAvailabilityZonesRequest extends SpeakeasyBase {
