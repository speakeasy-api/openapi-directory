...
var GetEntitiesRequest = /** @class */ (function (_super) {
    ...
    ], GetEntitiesRequest.prototype, "xAppToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=app_token",
        }),
        __metadata("design:type", String)
    ], GetEntitiesRequest.prototype, "appToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=entity_id",
        }),
        __metadata("design:type", String)
    ], GetEntitiesRequest.prototype, "entityId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=entity_name",
        }),
        __metadata("design:type", String)
    ], GetEntitiesRequest.prototype, "entityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=entity_type",
        }),
        __metadata("design:type", String)
    ], GetEntitiesRequest.prototype, "entityType", void 0);
