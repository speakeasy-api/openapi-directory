...
export class FirebaseappcheckProjectsAppsRecaptchaConfigBatchGetSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseappcheckProjectsAppsRecaptchaConfigBatchGetSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseappcheckProjectsAppsRecaptchaConfigBatchGetSecurity extends SpeakeasyBase {
...
export class FirebaseappcheckProjectsAppsRecaptchaConfigBatchGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseappcheckProjectsAppsRecaptchaConfigBatchGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
