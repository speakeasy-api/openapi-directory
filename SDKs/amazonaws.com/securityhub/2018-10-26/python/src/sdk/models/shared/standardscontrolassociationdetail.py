...
class StandardsControlAssociationDetail:
    r"""Provides details about a control's enablement status in a specified standard."""
    ...
    standards_control_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StandardsControlArns'), 'exclude': lambda f: f is None }})  
