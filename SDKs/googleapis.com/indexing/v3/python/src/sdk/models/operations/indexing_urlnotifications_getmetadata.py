...
class IndexingURLNotificationsGetMetadataQueryParams:
...
class IndexingURLNotificationsGetMetadataRequest:
    query_params: IndexingURLNotificationsGetMetadataQueryParams = dataclasses.field()
    security: IndexingURLNotificationsGetMetadataSecurity = dataclasses.field()
...
class IndexingURLNotificationsGetMetadataResponse:
    ...
    url_notification_metadata: Optional[shared_urlnotificationmetadata.URLNotificationMetadata] = dataclasses.field(default=None)
