...
public class Point {
     ...
     */
    public org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionResponse getGeomarksGeomarkIdPointFileFormatExtension(org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionPathParams.class, baseUrl, "/geomarks/{geomarkId}/point.{fileFormatExtension}", request.pathParams, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionResponse res = new org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionResponse() {{
        }};
