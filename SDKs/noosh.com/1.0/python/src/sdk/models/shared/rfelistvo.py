...
import dataclasses
from ..shared import rfesimplevo as shared_rfesimplevo
...
class RfeListVO:
    r"""Java type: com.noosh.nooshapi.vo.RfeListVO"""
    
    results: Optional[list[shared_rfesimplevo.RfeSimpleVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
