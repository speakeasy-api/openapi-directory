...
type SearchDatabasesByLFTagsQueryParams struct {
	// Pagination limit
...
type SearchDatabasesByLFTagsRequest struct {
	QueryParams SearchDatabasesByLFTagsQueryParams
	Headers     SearchDatabasesByLFTagsHeaders
	Request     SearchDatabasesByLFTagsRequestBody `request:"mediaType=application/json"`
}
