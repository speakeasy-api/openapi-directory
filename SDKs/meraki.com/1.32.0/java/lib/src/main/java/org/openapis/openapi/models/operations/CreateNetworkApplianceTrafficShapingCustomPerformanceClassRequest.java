...
public class CreateNetworkApplianceTrafficShapingCustomPerformanceClassRequest {
    ...
    public CreateNetworkApplianceTrafficShapingCustomPerformanceClassRequest(@JsonProperty("RequestBody") CreateNetworkApplianceTrafficShapingCustomPerformanceClassRequestBody requestBody, @JsonProperty("networkId") String networkId) {
        this.requestBody = requestBody;
        this.networkId = networkId;
  }
}
