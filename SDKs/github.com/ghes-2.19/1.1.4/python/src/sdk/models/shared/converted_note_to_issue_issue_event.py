...
class ConvertedNoteToIssueIssueEvent:
    r"""Converted Note to Issue Issue Event"""
    ...
    url: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('url') }})  
    project_card: Optional[ConvertedNoteToIssueIssueEventProjectCard] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('project_card'), 'exclude': lambda f: f is None }})  
