...
func (s *Apps) AppsCreateContentAttachment(ctx context.Context, request operations.AppsCreateContentAttachmentRequest) (*operations.AppsCreateContentAttachmentResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/content_references/{content_reference_id}/attachments", request.PathParams)
...
func (s *Apps) AppsGetSubscriptionPlanForAccount(ctx context.Context, request operations.AppsGetSubscriptionPlanForAccountRequest) (*operations.AppsGetSubscriptionPlanForAccountResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/marketplace_listing/accounts/{account_id}", request.PathParams)
	...
	res := &operations.AppsGetSubscriptionPlanForAccountResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.MarketplacePurchase
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Apps) AppsGetSubscriptionPlanForAccountStubbed(ctx context.Context, request operations.AppsGetSubscriptionPlanForAccountStubbedRequest) (*operations.AppsGetSubscriptionPlanForAccountStubbedResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/marketplace_listing/stubbed/accounts/{account_id}", request.PathParams)
	...
	res := &operations.AppsGetSubscriptionPlanForAccountStubbedResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Apps) AppsListAccountsForPlan(ctx context.Context, request operations.AppsListAccountsForPlanRequest) (*operations.AppsListAccountsForPlanResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/marketplace_listing/plans/{plan_id}/accounts", request.PathParams)
	...
	res := &operations.AppsListAccountsForPlanResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Apps) AppsListAccountsForPlanStubbed(ctx context.Context, request operations.AppsListAccountsForPlanStubbedRequest) (*operations.AppsListAccountsForPlanStubbedResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/marketplace_listing/stubbed/plans/{plan_id}/accounts", request.PathParams)
	...
	res := &operations.AppsListAccountsForPlanStubbedResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Apps) AppsListPlans(ctx context.Context, request operations.AppsListPlansRequest) (*operations.AppsListPlansResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/marketplace_listing/plans"
	...
	res := &operations.AppsListPlansResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out []shared.MarketplaceListingPlan
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Apps) AppsListPlansStubbed(ctx context.Context, request operations.AppsListPlansStubbedRequest) (*operations.AppsListPlansStubbedResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/marketplace_listing/stubbed/plans"
	...
	res := &operations.AppsListPlansStubbedResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Apps) AppsListSubscriptionsForAuthenticatedUser(ctx context.Context, request operations.AppsListSubscriptionsForAuthenticatedUserRequest) (*operations.AppsListSubscriptionsForAuthenticatedUserResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/user/marketplace_purchases"
	...
	res := &operations.AppsListSubscriptionsForAuthenticatedUserResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out []shared.UserMarketplacePurchase
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *Apps) AppsListSubscriptionsForAuthenticatedUserStubbed(ctx context.Context, request operations.AppsListSubscriptionsForAuthenticatedUserStubbedRequest) (*operations.AppsListSubscriptionsForAuthenticatedUserStubbedResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/user/marketplace_purchases/stubbed"
	...
	res := &operations.AppsListSubscriptionsForAuthenticatedUserStubbedResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
