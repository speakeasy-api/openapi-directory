...
class DeploymentmanagerDeploymentsInsertRequest:
    path_params: DeploymentmanagerDeploymentsInsertPathParams = dataclasses.field()
    query_params: DeploymentmanagerDeploymentsInsertQueryParams = dataclasses.field()
    security: DeploymentmanagerDeploymentsInsertSecurity = dataclasses.field()
