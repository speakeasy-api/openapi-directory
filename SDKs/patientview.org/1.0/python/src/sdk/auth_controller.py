...
class AuthController:
    ...
    def get_basic_user_information(self, request: operations.GetBasicUserInformationRequest) -> operations.GetBasicUserInformationResponse:
        ...
        url = utils.generate_url(operations.GetBasicUserInformationRequest, base_url, '/auth/{token}/basicuserinformation', request)
        ...
        res = operations.GetBasicUserInformationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def log_in(self, request: shared.Credentials) -> operations.LogInResponse:
        r"""Log In
    ...
    def log_out(self, request: operations.LogOutRequest) -> operations.LogOutResponse:
        ...
        url = utils.generate_url(operations.LogOutRequest, base_url, '/auth/logout/{token}', request)
