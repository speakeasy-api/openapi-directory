...
class ListRoleListRoleResponse:
    ...
    roles: Optional[list[shared_chat_v1_service_role.ChatV1ServiceRole]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('roles'), 'exclude': lambda f: f is None }})  
