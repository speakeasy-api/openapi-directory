...
func (e CisLineCisLinePayFrequencyEnum) ToPointer() *CisLineCisLinePayFrequencyEnum {
	return &e
}
...
func (e *CisLineCisLinePayFrequencyEnum) UnmarshalJSON(data []byte) error {
	...
	case "Monthly":
		fallthrough
	case "Weekly":
		*e = CisLineCisLinePayFrequencyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CisLineCisLinePayFrequencyEnum: %v", v)
	}
}
...
func (e CisLineCisLineTaxTreatmentEnum) ToPointer() *CisLineCisLineTaxTreatmentEnum {
	return &e
}
...
func (e *CisLineCisLineTaxTreatmentEnum) UnmarshalJSON(data []byte) error {
	...
	case "Notional":
		fallthrough
	case "Materials":
		*e = CisLineCisLineTaxTreatmentEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CisLineCisLineTaxTreatmentEnum: %v", v)
	}
}
...
func (e CisLineCisLineUOMEnum) ToPointer() *CisLineCisLineUOMEnum {
	return &e
}
...
func (e *CisLineCisLineUOMEnum) UnmarshalJSON(data []byte) error {
	...
	case "Year":
		fallthrough
	case "Unit":
		*e = CisLineCisLineUOMEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CisLineCisLineUOMEnum: %v", v)
	}
}
