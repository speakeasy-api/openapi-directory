...
import dataclasses
from ..shared import fleetcapacityreservationtenancy_enum as shared_fleetcapacityreservationtenancy_enum
from ..shared import fleetinstancematchcriteria_enum as shared_fleetinstancematchcriteria_enum
from ..shared import reservationfleetinstancespecification as shared_reservationfleetinstancespecification
from datetime import datetime
from enum import Enum
from typing import Optional

class CreateCapacityReservationFleetRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateCapacityReservationFleetRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateCapacityReservationFleetRequestTagSpecifications:
    ...
    resource_type: Optional[CreateCapacityReservationFleetRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateCapacityReservationFleetRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateCapacityReservationFleetRequest:
    
    instance_type_specifications: list[shared_reservationfleetinstancespecification.ReservationFleetInstanceSpecification] = dataclasses.field()  
    ...
    instance_match_criteria: Optional[shared_fleetinstancematchcriteria_enum.FleetInstanceMatchCriteriaEnum] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateCapacityReservationFleetRequestTagSpecifications]] = dataclasses.field(default=None)  
    tenancy: Optional[shared_fleetcapacityreservationtenancy_enum.FleetCapacityReservationTenancyEnum] = dataclasses.field(default=None)  
