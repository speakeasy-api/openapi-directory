...
class StartMLLabelingSetGenerationTaskRunRequest:
    ...
    start_ml_labeling_set_generation_task_run_request: shared_startmllabelingsetgenerationtaskrunrequest.StartMLLabelingSetGenerationTaskRunRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
