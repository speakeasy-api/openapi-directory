...
export enum GETAttachVerifiedAccessTrustProviderActionEnum {
  AttachVerifiedAccessTrustProvider = "AttachVerifiedAccessTrustProvider",
}

export enum GETAttachVerifiedAccessTrustProviderVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETAttachVerifiedAccessTrustProviderRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETAttachVerifiedAccessTrustProviderResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
