...
func (s *config) RequestClassificationPoliciesConfigInfo(ctx context.Context, request operations.RequestClassificationPoliciesConfigInfoRequest) (*operations.RequestClassificationPoliciesConfigInfoResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/config/info/policies/classifications"
	...
	res := &operations.RequestClassificationPoliciesConfigInfoResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
//
// ### Further Information:
func (s *config) RequestCurrentProductPackages(ctx context.Context, request operations.RequestCurrentProductPackagesRequest) (*operations.RequestCurrentProductPackagesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/config/info/product_packages/current"
	...
	res := &operations.RequestCurrentProductPackagesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.ProductPackageResponseList
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// ### Further Information:
// None.
func (s *config) RequestGuestUsersPoliciesConfigInfo(ctx context.Context, request operations.RequestGuestUsersPoliciesConfigInfoRequest) (*operations.RequestGuestUsersPoliciesConfigInfoResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/config/info/policies/guest_users"
	...
	res := &operations.RequestGuestUsersPoliciesConfigInfoResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
//
// ### Further Information:
func (s *config) RequestProductPackages(ctx context.Context, request operations.RequestProductPackagesRequest) (*operations.RequestProductPackagesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/config/info/product_packages"
	...
	res := &operations.RequestProductPackagesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *config) UpdateSystemSettings(ctx context.Context, request operations.UpdateSystemSettingsRequest) (*operations.UpdateSystemSettingsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ConfigOptionList", "json")
	if err != nil {
