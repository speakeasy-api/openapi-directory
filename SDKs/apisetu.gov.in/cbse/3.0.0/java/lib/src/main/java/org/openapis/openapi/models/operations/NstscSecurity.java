...
public class NstscSecurity {
    ...
    public NstscSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public NstscSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public NstscSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
