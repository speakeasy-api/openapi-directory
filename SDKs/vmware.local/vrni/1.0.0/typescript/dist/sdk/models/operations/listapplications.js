...
exports.ListApplicationsResponse = exports.ListApplicationsRequest = exports.ListApplicationsSecurity = void 0;
...
var ListApplicationsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListApplicationsRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=end_time",
        }),
        __metadata("design:type", Number)
    ], ListApplicationsRequest.prototype, "endTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=size" }),
        __metadata("design:type", Number)
    ], ListApplicationsRequest.prototype, "size", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=start_time",
        }),
        __metadata("design:type", Number)
    ], ListApplicationsRequest.prototype, "startTime", void 0);
