...
export class ContentProductsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentProductsUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentProductsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
