...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities:
    r"""APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities
...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocal:
    ...
    capabilities: Optional[APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberLocalCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
