...
class VideoObjectTrackingEvaluationMetrics:
    ...
    r"""Output only. The total number of bounding boxes (i.e. summed over all frames) the ground truth used to create this evaluation had."""  
    evaluated_frame_count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('evaluatedFrameCount'), 'exclude': lambda f: f is None }})
    r"""Output only. The number of video frames used to create this evaluation."""  
