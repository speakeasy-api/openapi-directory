...
var Communication = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attachmentSet", elemType: attachmentdetails_1.AttachmentDetails }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=submittedBy" }),
        __metadata("design:type", String)
