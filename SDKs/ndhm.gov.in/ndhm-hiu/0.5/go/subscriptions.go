...
func (s *Subscriptions) PostV05SubscriptionRequestsHiuOnInit(ctx context.Context, request operations.PostV05SubscriptionRequestsHiuOnInitRequest) (*operations.PostV05SubscriptionRequestsHiuOnInitResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v0.5/subscription-requests/hiu/on-init"
	...
	res := &operations.PostV05SubscriptionRequestsHiuOnInitResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
