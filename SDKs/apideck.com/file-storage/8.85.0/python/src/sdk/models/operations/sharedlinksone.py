...
from ..shared import getsharedlinkresponse as shared_getsharedlinkresponse
...
@dataclasses.dataclass
class SharedLinksOneSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class SharedLinksOneRequest:
    headers: SharedLinksOneHeaders = dataclasses.field()
    path_params: SharedLinksOnePathParams = dataclasses.field()
    query_params: SharedLinksOneQueryParams = dataclasses.field()
    security: SharedLinksOneSecurity = dataclasses.field()
    

@dataclasses.dataclass
class SharedLinksOneResponseOutput:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_shared_link_response: Optional[shared_getsharedlinkresponse.GetSharedLinkResponseOutput] = dataclasses.field(default=None)
