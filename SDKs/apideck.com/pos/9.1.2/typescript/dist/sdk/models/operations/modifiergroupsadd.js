...
exports.ModifierGroupsAddResponse = exports.ModifierGroupsAddRequest = exports.ModifierGroupsAddSecurity = void 0;
...
var ModifierGroupsAddRequest = /** @class */ (function (_super) {
    ...
    ], ModifierGroupsAddRequest.prototype, "modifierGroupInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], ModifierGroupsAddRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ModifierGroupsAddRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], ModifierGroupsAddRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], ModifierGroupsAddRequest.prototype, "xApideckServiceId", void 0);
...
var ModifierGroupsAddResponse = /** @class */ (function (_super) {
    ...
    ], ModifierGroupsAddResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
