...
public class CreateNodegroupRequestBody {
    ...
    public CreateNodegroupRequestBody(@JsonProperty("nodeRole") String nodeRole, @JsonProperty("nodegroupName") String nodegroupName, @JsonProperty("subnets") String[] subnets) {
        this.nodeRole = nodeRole;
        this.nodegroupName = nodegroupName;
        this.subnets = subnets;
  }
