...
export class AndroiddeviceprovisioningCustomersConfigurationsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AndroiddeviceprovisioningCustomersConfigurationsCreateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
