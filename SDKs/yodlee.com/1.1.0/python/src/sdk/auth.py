...
class Auth:
    ...
    def delete_api_key(self, request: operations.DeleteAPIKeyRequest) -> operations.DeleteAPIKeyResponse:
        ...
        url = utils.generate_url(base_url, "/auth/apiKey/{key}", request.path_params)
    ...
    def generate_access_token(self) -> operations.GenerateAccessTokenResponse:
        r"""Generate Access Token
        ...
        res = operations.GenerateAccessTokenResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json;charset=UTF-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.ClientCredentialTokenResponse])
                res.client_credential_token_response = out
        elif r.status_code == 400:
            if utils.match_content_type(content_type, "application/json;charset=UTF-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.YodleeError])
                res.yodlee_error = out
    ...
    def generate_api_key(self, request: operations.GenerateAPIKeyRequest) -> operations.GenerateAPIKeyResponse:
        r"""Generate API Key
        ...
        url = base_url.removesuffix("/") + "/auth/apiKey"
        ...
        res = operations.GenerateAPIKeyResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json;charset=UTF-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIKeyResponse])
