...
class CreateBudgetActionRequest:
    ...
    create_budget_action_request: shared_createbudgetactionrequest.CreateBudgetActionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
