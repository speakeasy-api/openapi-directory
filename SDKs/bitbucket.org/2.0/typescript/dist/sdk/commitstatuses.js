...
exports.CommitStatuses = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CommitStatuses = /** @class */ (function () {
    function CommitStatuses(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CommitStatuses.prototype.getRepositoriesWorkspaceRepoSlugCommitCommitStatuses = function (req, config) {
    ...
    **/
    CommitStatuses.prototype.getRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKey = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * request.
    **/
    CommitStatuses.prototype.getRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdStatuses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CommitStatuses.prototype.postRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuild = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CommitStatuses.prototype.putRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKey = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CommitStatuses = CommitStatuses;
