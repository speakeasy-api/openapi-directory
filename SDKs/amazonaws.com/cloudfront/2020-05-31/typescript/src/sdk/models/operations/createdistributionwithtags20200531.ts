 ...
 */
export class CreateDistributionWithTags20200531RequestBodyDistributionConfigWithTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateDistributionWithTags20200531RequestBody extends SpeakeasyBase {
  /**
   * A distribution Configuration and a list of tags to be associated with the distribution.
   */
  @SpeakeasyMetadata()
...
export enum CreateDistributionWithTags20200531WithTagsEnum {
  True = "true",
}
