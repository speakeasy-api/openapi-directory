...
export class Teams {
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          ...
          case httpRes?.status == 422:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.teamsAddMemberLegacy422ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  teamsAddOrUpdateMembershipForUserInOrg(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          ...
          case httpRes?.status == 422:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.teamsAddOrUpdateMembershipForUserInOrg422ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  teamsAddOrUpdateMembershipForUserLegacy(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          ...
          case httpRes?.status == 422:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.teamsAddOrUpdateMembershipForUserLegacy422ApplicationJSONObject = httpRes?.data;
            }
            break;
        }
  ...
  **/
  teamsCreateOrUpdateIdpGroupConnectionsInOrg(
    req: operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/orgs/{org}/teams/{team_slug}/team-sync/group-mappings", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.groupMapping = httpRes?.data;
            }
            break;
        }
  ...
  **/
  teamsCreateOrUpdateIdpGroupConnectionsLegacy(
    req: operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/teams/{team_id}/team-sync/group-mappings", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.groupMapping = httpRes?.data;
  ...
  **/
  teamsListIdpGroupsForLegacy(
    req: operations.TeamsListIdpGroupsForLegacyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TeamsListIdpGroupsForLegacyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsListIdpGroupsForLegacyRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.TeamsListIdpGroupsForLegacyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.groupMapping = httpRes?.data;
  ...
  **/
  teamsListIdpGroupsForOrg(
    req: operations.TeamsListIdpGroupsForOrgRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TeamsListIdpGroupsForOrgResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsListIdpGroupsForOrgRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/orgs/{org}/team-sync/groups", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.TeamsListIdpGroupsForOrgResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.groupMapping = httpRes?.data;
  ...
  **/
  teamsListIdpGroupsInOrg(
    req: operations.TeamsListIdpGroupsInOrgRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TeamsListIdpGroupsInOrgResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsListIdpGroupsInOrgRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.TeamsListIdpGroupsInOrgResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.groupMapping = httpRes?.data;
  ...
  **/
  teamsListPendingInvitationsInOrg(
    req: operations.TeamsListPendingInvitationsInOrgRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TeamsListPendingInvitationsInOrgResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsListPendingInvitationsInOrgRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/orgs/{org}/teams/{team_slug}/invitations", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.TeamsListPendingInvitationsInOrgResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  teamsListPendingInvitationsLegacy(
    req: operations.TeamsListPendingInvitationsLegacyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.TeamsListPendingInvitationsLegacyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsListPendingInvitationsLegacyRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/teams/{team_id}/invitations", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.TeamsListPendingInvitationsLegacyResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.organizationInvitations = httpRes?.data;
