...
export class CreateFilePaymentConsentsConsentIdFileRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateFilePaymentConsentsConsentIdFileRawRequest extends SpeakeasyBase {
  /**
...
export class CreateFilePaymentConsentsConsentIdFileRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
