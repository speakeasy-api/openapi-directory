...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum {
...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
