...
public class LocaleGetSecurity {
    ...
    public LocaleGetSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public LocaleGetSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public LocaleGetSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public LocaleGetSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
