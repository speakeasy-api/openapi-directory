 ...
 */
export enum NetworkEndpointGroupsListNetworkEndpointsWarningCodeEnum {
...
export class NetworkEndpointGroupsListNetworkEndpointsWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkEndpointGroupsListNetworkEndpointsWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
 ...
 * Successful response
 */
export class NetworkEndpointGroupsListNetworkEndpoints extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkEndpointWithHealthStatus })
  @Expose({ name: "items" })
