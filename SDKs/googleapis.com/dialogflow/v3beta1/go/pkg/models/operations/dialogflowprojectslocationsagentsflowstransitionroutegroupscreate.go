...
type DialogflowProjectsLocationsAgentsFlowsTransitionRouteGroupsCreateRequest struct {
	...
	GoogleCloudDialogflowCxV3beta1TransitionRouteGroupInput *shared.GoogleCloudDialogflowCxV3beta1TransitionRouteGroupInput `request:"mediaType=application/json"`
	// OAuth access token.
