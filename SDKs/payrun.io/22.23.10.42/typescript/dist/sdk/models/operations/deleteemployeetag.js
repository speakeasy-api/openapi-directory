...
exports.DeleteEmployeeTagResponse = exports.DeleteEmployeeTagRequest = void 0;
...
var DeleteEmployeeTagRequest = /** @class */ (function (_super) {
    ...
    ], DeleteEmployeeTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployeeId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeTagRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeleteEmployeeTagRequest.prototype, "tagId", void 0);
...
var DeleteEmployeeTagResponse = /** @class */ (function (_super) {
    ...
    ], DeleteEmployeeTagResponse.prototype, "rawResponse", void 0);
