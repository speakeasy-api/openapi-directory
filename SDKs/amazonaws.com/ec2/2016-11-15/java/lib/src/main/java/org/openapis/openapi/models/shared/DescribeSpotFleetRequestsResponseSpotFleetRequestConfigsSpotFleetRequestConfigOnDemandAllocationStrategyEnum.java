 ...
 */
public enum DescribeSpotFleetRequestsResponseSpotFleetRequestConfigsSpotFleetRequestConfigOnDemandAllocationStrategyEnum {
    ...
    private DescribeSpotFleetRequestsResponseSpotFleetRequestConfigsSpotFleetRequestConfigOnDemandAllocationStrategyEnum(String value) {
        this.value = value;
    }
}
