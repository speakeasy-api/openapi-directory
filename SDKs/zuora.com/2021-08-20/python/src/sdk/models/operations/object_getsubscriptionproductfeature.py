...
from ..shared import proxygetsubscriptionproductfeature as shared_proxygetsubscriptionproductfeature
...
class ObjectGETSubscriptionProductFeatureResponse:
    ...
    proxy_get_subscription_product_feature: Optional[shared_proxygetsubscriptionproductfeature.ProxyGetSubscriptionProductFeature] = dataclasses.field(default=None)  
