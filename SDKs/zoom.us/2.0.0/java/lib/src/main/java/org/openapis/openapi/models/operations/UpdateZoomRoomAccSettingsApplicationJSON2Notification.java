 ...
 */
public class UpdateZoomRoomAccSettingsApplicationJSON2Notification {
    /**
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withAudioMeetUsabilityThreshold(Boolean audioMeetUsabilityThreshold) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withAudioNotMeetUsabilityThreshold(Boolean audioNotMeetUsabilityThreshold) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withBatteryIsCharging(Boolean batteryIsCharging) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withBatteryLowAndNotCharging(Boolean batteryLowAndNotCharging) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withBatteryPercentage(String batteryPercentage) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withControllerSchedulingDisconnected(Boolean controllerSchedulingDisconnected) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withControllerSchedulingReconnected(Boolean controllerSchedulingReconnected) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withCpuUsageHighDetected(Boolean cpuUsageHighDetected) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withMicSpeakerCameraDisconnected(Boolean micSpeakerCameraDisconnected) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withMicSpeakerCameraReconnected(Boolean micSpeakerCameraReconnected) {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("network_stable_detected")
    public Boolean networkStableDetected;
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withNetworkStableDetected(Boolean networkStableDetected) {
        this.networkStableDetected = networkStableDetected;
        return this;
    }
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withNetworkUnstableDetected(Boolean networkUnstableDetected) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withSipRegistrationFailed(Boolean sipRegistrationFailed) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withSipRegistrationReEnabled(Boolean sipRegistrationReEnabled) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withZoomRoomComeBackOnline(Boolean zoomRoomComeBackOnline) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withZoomRoomDisplayDisconnected(Boolean zoomRoomDisplayDisconnected) {
    ...
    public UpdateZoomRoomAccSettingsApplicationJSON2Notification withZoomRoomOffline(Boolean zoomRoomOffline) {
