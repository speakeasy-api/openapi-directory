...
class DescribeServiceErrorsRequest:
    ...
    service_error_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ServiceErrorIds'), 'exclude': lambda f: f is None }})  
