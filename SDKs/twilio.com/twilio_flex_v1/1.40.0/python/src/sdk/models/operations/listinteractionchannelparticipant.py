...
class ListInteractionChannelParticipantListInteractionChannelParticipantResponse:
    ...
    meta: Optional[ListInteractionChannelParticipantListInteractionChannelParticipantResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    participants: Optional[list[shared_flex_v1_interaction_interaction_channel_interaction_channel_participant.FlexV1InteractionInteractionChannelInteractionChannelParticipant]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participants'), 'exclude': lambda f: f is None }})  
