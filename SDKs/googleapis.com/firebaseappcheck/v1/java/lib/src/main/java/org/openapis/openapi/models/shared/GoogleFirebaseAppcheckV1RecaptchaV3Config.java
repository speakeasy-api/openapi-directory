 ...
 */
public class GoogleFirebaseAppcheckV1RecaptchaV3Config {
    /**
    ...
    public GoogleFirebaseAppcheckV1RecaptchaV3Config withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GoogleFirebaseAppcheckV1RecaptchaV3Config withSiteSecret(String siteSecret) {
    ...
    public GoogleFirebaseAppcheckV1RecaptchaV3Config withSiteSecretSet(Boolean siteSecretSet) {
    ...
    public GoogleFirebaseAppcheckV1RecaptchaV3Config withTokenTtl(String tokenTtl) {
        this.tokenTtl = tokenTtl;
        return this;
    }
    
    public GoogleFirebaseAppcheckV1RecaptchaV3Config(){}
}
