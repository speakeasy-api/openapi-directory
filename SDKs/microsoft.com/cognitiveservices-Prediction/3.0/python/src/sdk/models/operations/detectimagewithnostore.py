...
class DetectImageWithNoStoreRequestBody:
    ...
    r"""Binary image data. Supported formats are JPEG, GIF, PNG, and BMP. Supports images up to 0MB."""  
...
class DetectImageWithNoStoreRequest:
    ...
    request_body: DetectImageWithNoStoreRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'multipart/form-data' }})  
