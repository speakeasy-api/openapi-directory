...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/aiimsmangalagiri/3.0.0/go
```
...
func main() {
    ...
    res, err := s.APIs.Labrp(ctx, operations.LabrpRequestBody{
        CertificateParameters: &operations.LabrpRequestBodyCertificateParameters{
            Dob: "31-12-1980",
            FullName: "Sunil Kumar",
            Gender: "M",
            MobileNoRQ: "DigiLocker will only fetch the latest report if multiple laboratory reports are found.",
        },
        ...
        Format: operations.LabrpRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.LabrpSecurity{
