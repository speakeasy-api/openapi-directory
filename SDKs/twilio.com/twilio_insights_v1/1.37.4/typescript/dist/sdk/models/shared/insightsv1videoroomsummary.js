...
var InsightsV1VideoRoomSummary = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=concurrent_participants" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=created_method" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=room_status" }),
        __metadata("design:type", String)
    ], InsightsV1VideoRoomSummary.prototype, "roomStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=room_type" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_participant_duration_sec" }),
        __metadata("design:type", Number)
    ], InsightsV1VideoRoomSummary.prototype, "totalParticipantDurationSec", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_recording_duration_sec" }),
        __metadata("design:type", Number)
    ], InsightsV1VideoRoomSummary.prototype, "totalRecordingDurationSec", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unique_participant_identities" }),
        __metadata("design:type", Number)
