...
class CreateDatasetImportJobRequest:
    ...
    create_dataset_import_job_request: shared_createdatasetimportjobrequest.CreateDatasetImportJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
