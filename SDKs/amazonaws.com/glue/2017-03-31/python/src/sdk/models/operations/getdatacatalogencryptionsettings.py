...
class GetDataCatalogEncryptionSettingsRequest:
    ...
    get_data_catalog_encryption_settings_request: shared_getdatacatalogencryptionsettingsrequest.GetDataCatalogEncryptionSettingsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
