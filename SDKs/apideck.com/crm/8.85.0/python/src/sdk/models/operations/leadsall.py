...
from ..shared import leadsfilter as shared_leadsfilter
from ..shared import leadssort as shared_leadssort
from ..shared import security as shared_security
from ..shared import badrequestresponse as shared_badrequestresponse
from ..shared import getleadsresponse as shared_getleadsresponse
...
class LeadsAllQueryParams:
    ...
    filter: Optional[shared_leadsfilter.LeadsFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    ...
    sort: Optional[shared_leadssort.LeadsSort] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
...
class LeadsAllRequest:
    headers: LeadsAllHeaders = dataclasses.field()
    query_params: LeadsAllQueryParams = dataclasses.field()
    security: LeadsAllSecurity = dataclasses.field()
...
class LeadsAllResponse:
    ...
    get_leads_response: Optional[shared_getleadsresponse.GetLeadsResponse] = dataclasses.field(default=None)
