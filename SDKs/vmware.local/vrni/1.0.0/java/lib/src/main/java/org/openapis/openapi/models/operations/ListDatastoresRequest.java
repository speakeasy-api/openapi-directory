...
public class ListDatastoresRequest {
    ...
    public ListDatastoresRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public ListDatastoresRequest withEndTime(Double endTime) {
    ...
    public ListDatastoresRequest withSize(Double size) {
        this.size = size;
        return this;
    }
    ...
    public ListDatastoresRequest withStartTime(Double startTime) {
