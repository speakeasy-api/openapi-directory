...
class DNSResponsePolicyRulesDeleteSecurity:
    option1: Optional[DNSResponsePolicyRulesDeleteSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSResponsePolicyRulesDeleteSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DNSResponsePolicyRulesDeleteRequest:
    path_params: DNSResponsePolicyRulesDeletePathParams = dataclasses.field()
    query_params: DNSResponsePolicyRulesDeleteQueryParams = dataclasses.field()
    security: DNSResponsePolicyRulesDeleteSecurity = dataclasses.field()
