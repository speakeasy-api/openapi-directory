...
import { InterconnectRemoteLocation } from "./interconnectremotelocation";
import { Expose, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum InterconnectRemoteLocationListWarningCodeEnum {
...
export class InterconnectRemoteLocationListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InterconnectRemoteLocationListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: InterconnectRemoteLocationListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: InterconnectRemoteLocationListWarningData })
  @Expose({ name: "data" })
  @Type(() => InterconnectRemoteLocationListWarningData)
  data?: InterconnectRemoteLocationListWarningData[];
 ...
 */
export class InterconnectRemoteLocationList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InterconnectRemoteLocation })
  @Expose({ name: "items" })
  @Type(() => InterconnectRemoteLocation)
  items?: InterconnectRemoteLocation[];
