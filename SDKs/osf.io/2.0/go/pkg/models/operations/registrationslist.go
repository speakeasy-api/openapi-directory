...
func (e RegistrationsListRegistrationAttributesCategoryEnum) ToPointer() *RegistrationsListRegistrationAttributesCategoryEnum {
	return &e
}
...
func (e *RegistrationsListRegistrationAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "software":
		fallthrough
	case "other":
		*e = RegistrationsListRegistrationAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RegistrationsListRegistrationAttributesCategoryEnum: %v", v)
	}
}
