...
import dataclasses
from ..shared import googleclouddialogflowcxv3beta1fulfillmentconditionalcasescasecasecontent as shared_googleclouddialogflowcxv3beta1fulfillmentconditionalcasescasecasecontent
...
class GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCase:
    ...
    case_content: Optional[list[shared_googleclouddialogflowcxv3beta1fulfillmentconditionalcasescasecasecontent.GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('caseContent'), 'exclude': lambda f: f is None }})
...
class GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseInput:
    ...
    case_content: Optional[list[shared_googleclouddialogflowcxv3beta1fulfillmentconditionalcasescasecasecontent.GoogleCloudDialogflowCxV3beta1FulfillmentConditionalCasesCaseCaseContentInput]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('caseContent'), 'exclude': lambda f: f is None }})
    r"""A list of case content."""  
    condition: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('condition'), 'exclude': lambda f: f is None }})
    r"""The condition to activate and select this case. Empty means the condition is always true. The condition is evaluated against form parameters or session parameters. See the [conditions reference](https://cloud.google.com/dialogflow/cx/docs/reference/condition)."""  
