...
class DeleteFlowRequest:
    headers: DeleteFlowHeaders = dataclasses.field()
    request: DeleteFlowRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteFlowResponse:
    ...
    delete_flow_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
