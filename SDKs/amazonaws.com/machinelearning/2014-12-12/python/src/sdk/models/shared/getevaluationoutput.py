...
class GetEvaluationOutput:
    ...
    evaluation_data_source_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('EvaluationDataSourceId') }})
    ...
    performance_metrics: Optional[shared_performancemetrics.PerformanceMetrics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PerformanceMetrics') }})
