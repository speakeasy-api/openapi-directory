...
export class LinkTokenCreateRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "additional_consented_products" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "android_package_name" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "identity_verification" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "link_customization_name" })
