 ...
 */
export enum AutoscalingPolicyCustomMetricUtilizationUtilizationTargetTypeEnum {
 ...
 */
export class AutoscalingPolicyCustomMetricUtilization extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "singleInstanceAssignment" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "utilizationTargetType" })
