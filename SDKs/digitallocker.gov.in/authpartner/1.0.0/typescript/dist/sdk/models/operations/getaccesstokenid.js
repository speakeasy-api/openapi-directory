...
exports.GetaccesstokenIdResponse = exports.GetaccesstokenIdRequest = exports.GetaccesstokenIdRequestBody = void 0;
...
var GetaccesstokenIdRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Get access token using authorization code" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Get access token using device code and OTP" }),
        __metadata("design:type", Object)
    ], GetaccesstokenIdRequestBody.prototype, "getAccessTokenUsingDeviceCodeAndOTP", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Get access token using refresh token" }),
...
exports.GetaccesstokenIdRequestBody = GetaccesstokenIdRequestBody;
...
exports.GetaccesstokenIdRequest = GetaccesstokenIdRequest;
...
exports.GetaccesstokenIdResponse = GetaccesstokenIdResponse;
