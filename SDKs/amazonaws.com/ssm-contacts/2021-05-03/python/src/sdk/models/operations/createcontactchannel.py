...
class CreateContactChannelRequest:
    ...
    create_contact_channel_request: shared_createcontactchannelrequest.CreateContactChannelRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
