...
class ProjectTemplateBaseColorEnum(str, Enum):
...
class ProjectTemplateBase:
    ...
    color: Optional[ProjectTemplateBaseColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('color'), 'exclude': lambda f: f is None }})
    r"""Color of the project template."""  
