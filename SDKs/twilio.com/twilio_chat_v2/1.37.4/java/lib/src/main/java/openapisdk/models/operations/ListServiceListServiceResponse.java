...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.ChatV2Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.ChatV2Service[] services) {
