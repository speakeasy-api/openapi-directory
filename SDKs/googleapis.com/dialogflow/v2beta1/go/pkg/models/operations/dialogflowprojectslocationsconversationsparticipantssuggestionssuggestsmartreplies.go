...
type DialogflowProjectsLocationsConversationsParticipantsSuggestionsSuggestSmartRepliesRequest struct {
	...
	GoogleCloudDialogflowV2beta1SuggestSmartRepliesRequest *shared.GoogleCloudDialogflowV2beta1SuggestSmartRepliesRequest `request:"mediaType=application/json"`
	// OAuth access token.
