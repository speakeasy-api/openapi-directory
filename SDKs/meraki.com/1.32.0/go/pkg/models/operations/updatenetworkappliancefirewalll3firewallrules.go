...
func (e UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesPolicyEnum) ToPointer() *UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesPolicyEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesPolicyEnum) UnmarshalJSON(data []byte) error {
	...
	case "allow":
		fallthrough
	case "deny":
		*e = UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesPolicyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesPolicyEnum: %v", v)
	}
}
...
func (e UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesProtocolEnum) ToPointer() *UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesProtocolEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesProtocolEnum) UnmarshalJSON(data []byte) error {
	...
	case "tcp":
		fallthrough
	case "udp":
		*e = UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesProtocolEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallL3FirewallRulesRequestBodyRulesProtocolEnum: %v", v)
	}
}
