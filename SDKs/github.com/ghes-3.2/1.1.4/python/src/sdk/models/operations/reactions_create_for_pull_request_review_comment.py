...
class ReactionsCreateForPullRequestReviewCommentRequestBodyContentEnum(str, Enum):
    r"""The [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types) to add to the pull request review comment."""
    PLUS_1 = '+1'
    MINUS_1 = '-1'
    LAUGH = 'laugh'
    CONFUSED = 'confused'
...
class ReactionsCreateForPullRequestReviewCommentRequestBody:
    ...
    content: ReactionsCreateForPullRequestReviewCommentRequestBodyContentEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content') }})
    r"""The [reaction type](https://docs.github.com/enterprise-server@3.2/rest/reference/reactions#reaction-types) to add to the pull request review comment."""  
...
class ReactionsCreateForPullRequestReviewCommentRequest:
    ...
    request_body: ReactionsCreateForPullRequestReviewCommentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
