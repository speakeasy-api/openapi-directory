...
public class AddFundsToInsuranceRequestBody {
    ...
    public AddFundsToInsuranceRequestBody withCurrency(String currency) {
        this.currency = currency;
        return this;
    }
    
    public AddFundsToInsuranceRequestBody(@JsonProperty("amount") Double amount, @JsonProperty("currency") String currency) {
        this.amount = amount;
        this.currency = currency;
  }
}
