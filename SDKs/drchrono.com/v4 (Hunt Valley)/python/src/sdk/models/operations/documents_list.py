...
class DocumentsList200ApplicationJSON:
    ...
    data: Optional[list[shared_scannedclinicaldocument.ScannedClinicalDocument]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""result data"""  
