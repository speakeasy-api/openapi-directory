...
class Campaign:
    ...
    r"""Name of this campaign. This is a required field and must be less than 256 characters long and unique among campaigns of the same advertiser."""  
    ...
    r"""Whether Nielsen reports are enabled for this campaign."""  
    ...
    trafficker_emails: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('traffickerEmails'), 'exclude': lambda f: f is None }})
    r"""Campaign trafficker contact emails."""  
