 ...
 */
export declare enum InterconnectAttachmentsScopedListWarningCodeEnum {
...
export declare class InterconnectAttachmentsScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class InterconnectAttachmentsScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class InterconnectAttachmentsScopedList extends SpeakeasyBase {
    /**
