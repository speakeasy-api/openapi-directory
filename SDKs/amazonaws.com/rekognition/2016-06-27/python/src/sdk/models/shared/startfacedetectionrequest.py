...
class StartFaceDetectionRequest:
    ...
    face_attributes: Optional[shared_faceattributes_enum.FaceAttributesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FaceAttributes'), 'exclude': lambda f: f is None }})  
