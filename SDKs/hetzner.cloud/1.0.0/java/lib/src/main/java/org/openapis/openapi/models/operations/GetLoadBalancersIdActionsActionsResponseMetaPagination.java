...
public class GetLoadBalancersIdActionsActionsResponseMetaPagination {
    ...
    public GetLoadBalancersIdActionsActionsResponseMetaPagination(@JsonProperty("last_page") Double lastPage, @JsonProperty("next_page") Double nextPage, @JsonProperty("page") Double page, @JsonProperty("per_page") Double perPage, @JsonProperty("previous_page") Double previousPage, @JsonProperty("total_entries") Double totalEntries) {
        this.lastPage = lastPage;
        this.nextPage = nextPage;
        this.page = page;
        this.perPage = perPage;
