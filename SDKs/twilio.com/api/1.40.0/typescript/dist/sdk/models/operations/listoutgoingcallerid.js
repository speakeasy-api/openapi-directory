...
exports.ListOutgoingCallerIdResponse = exports.ListOutgoingCallerIdListOutgoingCallerIdResponse = exports.ListOutgoingCallerIdRequest = exports.ListOutgoingCallerIdSecurity = exports.ListOutgoingCallerIdServerList = void 0;
...
var ListOutgoingCallerIdSecurity = /** @class */ (function (_super) {
    ...
    ], ListOutgoingCallerIdSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListOutgoingCallerIdSecurity.prototype, "username", void 0);
...
var ListOutgoingCallerIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListOutgoingCallerIdRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FriendlyName",
        }),
        __metadata("design:type", String)
    ], ListOutgoingCallerIdRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListOutgoingCallerIdRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListOutgoingCallerIdRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListOutgoingCallerIdRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PhoneNumber",
        }),
        __metadata("design:type", String)
    ], ListOutgoingCallerIdRequest.prototype, "phoneNumber", void 0);
...
var ListOutgoingCallerIdListOutgoingCallerIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ApiV2010AccountOutgoingCallerId }),
        (0, class_transformer_1.Expose)({ name: "outgoing_caller_ids" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountOutgoingCallerId; }),
...
var ListOutgoingCallerIdResponse = /** @class */ (function (_super) {
    ...
    ], ListOutgoingCallerIdResponse.prototype, "rawResponse", void 0);
