...
type SuggestBidsPathParams struct {
...
type SuggestBidsRequest struct {
	PathParams SuggestBidsPathParams
	// The data requested to retrieve the suggested bids.
	Request  shared.TargetedBidRequest `request:"mediaType=application/json"`
	Security SuggestBidsSecurity
}
