...
func (e CreateReplicationInstanceXAmzTargetEnum) ToPointer() *CreateReplicationInstanceXAmzTargetEnum {
	return &e
}
...
func (e *CreateReplicationInstanceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonDMSv20160101.CreateReplicationInstance":
		*e = CreateReplicationInstanceXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateReplicationInstanceXAmzTargetEnum: %v", v)
	}
}

type CreateReplicationInstanceRequest struct {
	CreateReplicationInstanceMessage shared.CreateReplicationInstanceMessage `request:"mediaType=application/json"`
