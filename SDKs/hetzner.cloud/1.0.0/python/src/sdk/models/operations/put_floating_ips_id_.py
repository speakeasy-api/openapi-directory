...
class PutFloatingIpsIDRequest:
    ...
    request_body: Optional[PutFloatingIpsIDUpdateFloatingIPRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PutFloatingIpsID200ApplicationJSONFloatingIP:
    ...
    dns_ptr: list[PutFloatingIpsID200ApplicationJSONFloatingIPDNSPtr] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dns_ptr') }})
    r"""Array of reverse DNS entries"""  
    home_location: PutFloatingIpsID200ApplicationJSONFloatingIPHomeLocation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('home_location') }})
    r"""Location the Floating IP was created in. Routing is optimized for this Location."""  
    ...
    protection: PutFloatingIpsID200ApplicationJSONFloatingIPProtection = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protection') }})
    r"""Protection configuration for the Resource"""  
    ...
    type: PutFloatingIpsID200ApplicationJSONFloatingIPTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of the Floating IP"""  
...
class PutFloatingIpsID200ApplicationJSON:
    r"""The `floating_ip` key in the reply contains the modified Floating IP object with the new description"""
    
    floating_ip: PutFloatingIpsID200ApplicationJSONFloatingIP = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('floating_ip') }})  
