...
<https://docs.github.com/enterprise-server@2.22/rest/reference/search#search-code>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("debitis") {{
                order = OrderEnum.ASC;
                page = 575062L;
                perPage = 280859L;
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/search#search-commits>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("numquam") {{
                order = OrderEnum.ASC;
                page = 236790L;
                perPage = 728559L;
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/search#search-issues-and-pull-requests>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("minima") {{
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/search#search-labels>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("hic", 392319L) {{
                order = OrderEnum.ASC;
                page = 221218L;
                perPage = 496548L;
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/search#search-repositories>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("minima") {{
                order = OrderEnum.DESC;
                page = 181476L;
                perPage = 397026L;
                sort = SearchReposSortEnum.STARS;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/search#search-topics>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("incidunt") {{
                page = 240490L;
                perPage = 506343L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@2.22/rest/reference/search#search-users>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("dolor") {{
                order = OrderEnum.DESC;
                page = 709701L;
                perPage = 706411L;
