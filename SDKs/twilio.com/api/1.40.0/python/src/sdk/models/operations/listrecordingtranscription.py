...
class ListRecordingTranscriptionRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Transcription resources to read."""  
    recording_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'RecordingSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the [Recording](https://www.twilio.com/docs/voice/api/recording) that created the transcriptions to read."""  
...
class ListRecordingTranscriptionListRecordingTranscriptionResponse:
    ...
    transcriptions: Optional[list[shared_api_v2010_account_recording_recording_transcription.APIV2010AccountRecordingRecordingTranscription]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transcriptions'), 'exclude': lambda f: f is None }})  
