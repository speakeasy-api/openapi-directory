...
public class BacerSecurity {
    ...
    public BacerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public BacerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public BacerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
