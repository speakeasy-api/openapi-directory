...
export class ContentQuotasListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentQuotasListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentQuotasListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
