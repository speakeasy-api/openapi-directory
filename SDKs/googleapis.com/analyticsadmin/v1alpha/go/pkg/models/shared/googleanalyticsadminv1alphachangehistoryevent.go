...
func (e *GoogleAnalyticsAdminV1alphaChangeHistoryEventActorTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "SYSTEM":
		fallthrough
	case "SUPPORT":
		*e = GoogleAnalyticsAdminV1alphaChangeHistoryEventActorTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleAnalyticsAdminV1alphaChangeHistoryEventActorTypeEnum: %s", s)
	}
}
