...
public class GetNhInteriorItemHeaders {
    /**
    ...
    public GetNhInteriorItemHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhInteriorItemHeaders withXApiKey(String xApiKey) {
