...
class InsightsV1CallSummary:
    ...
    annotation: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('annotation'), 'exclude': lambda f: f is None }})  
    answered_by: Optional[shared_summary_enum_answered_by_enum.SummaryEnumAnsweredByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('answered_by'), 'exclude': lambda f: f is None }})  
    ...
    call_state: Optional[shared_summary_enum_call_state_enum.SummaryEnumCallStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('call_state'), 'exclude': lambda f: f is None }})  
    call_type: Optional[shared_summary_enum_call_type_enum.SummaryEnumCallTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('call_type'), 'exclude': lambda f: f is None }})  
    ...
    processing_state: Optional[shared_summary_enum_processing_state_enum.SummaryEnumProcessingStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('processing_state'), 'exclude': lambda f: f is None }})  
