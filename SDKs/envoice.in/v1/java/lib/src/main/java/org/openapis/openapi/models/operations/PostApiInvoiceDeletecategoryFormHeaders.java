...
public class PostApiInvoiceDeletecategoryFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceDeletecategoryFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceDeletecategoryFormHeaders withXAuthSecret(String xAuthSecret) {
