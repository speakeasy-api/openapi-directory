...
export class GetModelDiseaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetModelDiseaseAssociationsQueryParams extends SpeakeasyBase {
...
export class GetModelDiseaseAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetModelDiseaseAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
