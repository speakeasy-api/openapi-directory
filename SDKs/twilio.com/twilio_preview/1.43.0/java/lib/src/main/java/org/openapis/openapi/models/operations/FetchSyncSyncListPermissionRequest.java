...
public class FetchSyncSyncListPermissionRequest {
    ...
    public FetchSyncSyncListPermissionRequest(@JsonProperty("Identity") String identity, @JsonProperty("ListSid") String listSid, @JsonProperty("ServiceSid") String serviceSid) {
        this.identity = identity;
        this.listSid = listSid;
        this.serviceSid = serviceSid;
  }
