...
class PatientHealthMetricCreateResourceAttributesCode:
    
    system: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('system') }})  
    value: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value') }})  
    
class PatientHealthMetricCreateResourceAttributesTypeEnum(str, Enum):
...
class PatientHealthMetricCreateResourceAttributes:
    ...
    code: Optional[PatientHealthMetricCreateResourceAttributesCode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})  
    ...
    type: Optional[PatientHealthMetricCreateResourceAttributesTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PatientHealthMetricCreateResourceRelationshipsPatientDataMetaQueryIdentifier:
...
class PatientHealthMetricCreateResourceRelationshipsPatientDataMetaQuery:
    ...
    identifier: PatientHealthMetricCreateResourceRelationshipsPatientDataMetaQueryIdentifier = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('identifier') }})  
...
class PatientHealthMetricCreateResourceRelationshipsPatientDataMeta:
    ...
    query: PatientHealthMetricCreateResourceRelationshipsPatientDataMetaQuery = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('query') }})
    r"""The query must return one and only one patient."""  
...
class PatientHealthMetricCreateResourceRelationshipsPatientData:
    ...
    meta: Optional[PatientHealthMetricCreateResourceRelationshipsPatientDataMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})
    r"""Allows the specification of a query for a patient rather than providing a patient id directly"""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PatientHealthMetricCreateResourceRelationshipsPatient:
    
    data: Optional[PatientHealthMetricCreateResourceRelationshipsPatientData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class PatientHealthMetricCreateResourceRelationships:
    ...
    patient: Optional[PatientHealthMetricCreateResourceRelationshipsPatient] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('patient'), 'exclude': lambda f: f is None }})  
...
class PatientHealthMetricCreateResource:
    ...
    attributes: Optional[PatientHealthMetricCreateResourceAttributes] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes'), 'exclude': lambda f: f is None }})  
    relationships: Optional[PatientHealthMetricCreateResourceRelationships] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('relationships'), 'exclude': lambda f: f is None }})  
