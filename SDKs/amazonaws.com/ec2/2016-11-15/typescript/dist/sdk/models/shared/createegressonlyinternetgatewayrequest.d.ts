 ...
 */
export declare enum CreateEgressOnlyInternetGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateEgressOnlyInternetGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateEgressOnlyInternetGatewayRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateEgressOnlyInternetGatewayRequest extends SpeakeasyBase {
    clientToken?: string;
    dryRun?: boolean;
