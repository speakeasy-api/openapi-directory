...
public class Creators {
     ...
     */
    public org.openapis.openapi.models.operations.CreatorsListResponse creatorsList(org.openapis.openapi.models.operations.CreatorsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/creators");
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.CreatorsList200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.CreatorsList200ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.CreatorsReadResponse creatorsRead(org.openapis.openapi.models.operations.CreatorsReadRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.PersonSingle out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.PersonSingle.class);
