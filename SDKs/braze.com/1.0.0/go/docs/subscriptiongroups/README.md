...
func main() {
    ...
    res, err := s.SubscriptionGroups.ListUserSSubscriptionGroupSms(ctx, operations.ListUserSSubscriptionGroupSmsRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SubscriptionGroups.ListUserSSubscriptionGroupStatusSms(ctx, operations.ListUserSSubscriptionGroupStatusSmsRequest{
