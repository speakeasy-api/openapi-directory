...
class FeaturedCollection:
    ...
    cover_item: Optional[shared_featuredcollectioncoveritem.FeaturedCollectionCoverItem] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cover_item') }})
    ...
    hero_item: Optional[shared_featuredcollectioncoveritem.FeaturedCollectionCoverItem] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hero_item') }})
