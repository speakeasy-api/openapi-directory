...
var PropertyValue = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "persistenceTimestamp" }),
        __metadata("design:type", Number)
    ], PropertyValue.prototype, "persistenceTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selectedByUser" }),
        __metadata("design:type", Boolean)
    ], PropertyValue.prototype, "selectedByUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selectedByUserTimestamp" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sourceLabel" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sourceVid" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "updatedByUserId" }),
        __metadata("design:type", Number)
    ], PropertyValue.prototype, "updatedByUserId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "useTimestampAsPersistenceTimestamp" }),
        __metadata("design:type", Boolean)
    ], PropertyValue.prototype, "useTimestampAsPersistenceTimestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
