 ...
 */
export enum TargetHttpsProxyAggregatedListWarningCodeEnum {
...
export class TargetHttpsProxyAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetHttpsProxyAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetHttpsProxyAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class TargetHttpsProxyAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetHttpsProxiesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, TargetHttpsProxiesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], TargetHttpsProxiesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
