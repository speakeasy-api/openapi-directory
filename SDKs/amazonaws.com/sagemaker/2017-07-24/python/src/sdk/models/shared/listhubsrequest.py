...
from ..shared import hubsortby_enum as shared_hubsortby_enum
...
class ListHubsRequest:
    ...
    sort_by: Optional[shared_hubsortby_enum.HubSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
