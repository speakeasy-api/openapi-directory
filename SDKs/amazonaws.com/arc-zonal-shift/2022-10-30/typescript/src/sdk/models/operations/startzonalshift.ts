...
export class StartZonalShiftRequestBody extends SpeakeasyBase {
  /**
...
export class StartZonalShiftRequest extends SpeakeasyBase {
...
export class StartZonalShiftResponse extends SpeakeasyBase {
  /**
