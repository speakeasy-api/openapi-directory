...
export class CloudchannelAccountsCustomersEntitlementsActivateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersEntitlementsActivateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersEntitlementsActivateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
