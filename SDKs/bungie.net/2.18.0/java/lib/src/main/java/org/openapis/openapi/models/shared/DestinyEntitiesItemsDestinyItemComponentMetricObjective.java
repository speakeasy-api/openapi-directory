...
/**
 * DestinyEntitiesItemsDestinyItemComponentMetricObjective - Returns data about a character's status with a given Objective. Combine with DestinyObjectiveDefinition static data for display purposes.
 */
public class DestinyEntitiesItemsDestinyItemComponentMetricObjective {
    /**
    ...
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective withActivityHash(Long activityHash) {
    ...
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective withComplete(Boolean complete) {
    ...
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective withCompletionValue(Integer completionValue) {
    ...
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective withDestinationHash(Long destinationHash) {
    ...
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective withObjectiveHash(Long objectiveHash) {
    ...
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective withProgress(Integer progress) {
    ...
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective withVisible(Boolean visible) {
        this.visible = visible;
        return this;
    }
    
    public DestinyEntitiesItemsDestinyItemComponentMetricObjective(){}
}
