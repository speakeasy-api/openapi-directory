...
// SaveTransactionWithIDClearedEnum - The cleared status of the transaction
type SaveTransactionWithIDClearedEnum string

const (
	SaveTransactionWithIDClearedEnumCleared    SaveTransactionWithIDClearedEnum = "cleared"
	SaveTransactionWithIDClearedEnumUncleared  SaveTransactionWithIDClearedEnum = "uncleared"
...
type SaveTransactionWithID struct {
	...
	Cleared *SaveTransactionWithIDClearedEnum `json:"cleared,omitempty"`
	// The transaction date in ISO format (e.g. 2016-12-01).  Future dates (scheduled transactions) are not permitted.  Split transaction dates cannot be changed and if a different date is supplied it will be ignored.
	Date *types.Date `json:"date,omitempty"`
	// The transaction flag
	FlagColor *SaveTransactionWithIDFlagColorEnum `json:"flag_color,omitempty"`
