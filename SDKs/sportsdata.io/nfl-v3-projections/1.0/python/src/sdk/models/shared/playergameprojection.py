...
class PlayerGameProjection:
    ...
    game_date: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('GameDate'), 'exclude': lambda f: f is None }})  
    ...
    offensive_fumble_recovery_touchdowns: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('OffensiveFumbleRecoveryTouchdowns'), 'exclude': lambda f: f is None }})  
    ...
    snap_counts_confirmed: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SnapCountsConfirmed'), 'exclude': lambda f: f is None }})  
    ...
    victiv_salary: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VictivSalary'), 'exclude': lambda f: f is None }})  
