...
class GetPercentilesRequestBody:
    ...
    percents: Optional[list[float]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('percents'), 'exclude': lambda f: f is None }})
    r"""The percentile groups returned."""  
...
class GetPercentilesRequest:
    ...
    request_body: GetPercentilesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
