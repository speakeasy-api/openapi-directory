 ...
 */
exports.ServerList = ["https://genomics.googleapis.com/"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.workers = new workers_1.Workers(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
