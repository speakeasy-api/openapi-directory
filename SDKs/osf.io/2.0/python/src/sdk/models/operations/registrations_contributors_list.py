...
class RegistrationsContributorsListContributorAttributesPermissionEnum(str, Enum):
...
@dataclasses.dataclass
class RegistrationsContributorsListContributorAttributes:
    ...
    permission: Optional[RegistrationsContributorsListContributorAttributesPermissionEnum] = dataclasses.field(default=None)
    r"""The permission level of the contributor. The default value is 'write'."""  
...
@dataclasses.dataclass
class RegistrationsContributorsListContributorLinks:
...
@dataclasses.dataclass
class RegistrationsContributorsListContributorRelationships:
...
@dataclasses.dataclass
class RegistrationsContributorsListContributor:
    
    relationships: RegistrationsContributorsListContributorRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the contributor entity."""  
    type: str = dataclasses.field()
    r"""The type identifier of the contributor entity (`contributors`)."""  
    attributes: Optional[RegistrationsContributorsListContributorAttributes] = dataclasses.field(default=None)
    r"""The properties of the contributor entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the contributor entity. Contributor identifiers have the form {node_id}-{user_id}."""  
    links: Optional[RegistrationsContributorsListContributorLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the contributor entity."""  
