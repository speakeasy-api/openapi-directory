...
func (e JobEmploymentTermsEnum) ToPointer() *JobEmploymentTermsEnum {
	return &e
}
...
func (e *JobEmploymentTermsEnum) UnmarshalJSON(data []byte) error {
	...
	case "volunteer":
		fallthrough
	case "other":
		*e = JobEmploymentTermsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for JobEmploymentTermsEnum: %v", v)
	}
}
