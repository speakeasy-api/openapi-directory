...
var ConnectionProfile = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "bigqueryProfile" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "forwardSshConnectivity" }),
        (0, class_transformer_1.Type)(function () { return forwardsshtunnelconnectivity_1.ForwardSshTunnelConnectivity; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "gcsProfile" }),
        (0, class_transformer_1.Type)(function () { return gcsprofile_1.GcsProfile; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mysqlProfile" }),
        (0, class_transformer_1.Type)(function () { return mysqlprofile_1.MysqlProfile; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "oracleProfile" }),
        (0, class_transformer_1.Type)(function () { return oracleprofile_1.OracleProfile; }),
        __metadata("design:type", oracleprofile_1.OracleProfile)
    ], ConnectionProfile.prototype, "oracleProfile", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "postgresqlProfile" }),
        (0, class_transformer_1.Type)(function () { return postgresqlprofile_1.PostgresqlProfile; }),
        __metadata("design:type", postgresqlprofile_1.PostgresqlProfile)
    ], ConnectionProfile.prototype, "postgresqlProfile", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "privateConnectivity" }),
        (0, class_transformer_1.Type)(function () { return privateconnectivity_1.PrivateConnectivity; }),
        __metadata("design:type", privateconnectivity_1.PrivateConnectivity)
    ], ConnectionProfile.prototype, "privateConnectivity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "staticServiceIpConnectivity" }),
        __metadata("design:type", Object)
...
var ConnectionProfileInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mysqlProfile" }),
        (0, class_transformer_1.Type)(function () { return mysqlprofile_1.MysqlProfileInput; }),
        __metadata("design:type", mysqlprofile_1.MysqlProfileInput)
