...
class GetGenotypeVariantAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypeVariantAssociationsQueryParams:
...
class GetGenotypeVariantAssociationsRequest:
    path_params: GetGenotypeVariantAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypeVariantAssociationsQueryParams = dataclasses.field()
