...
class BookingMybookingsRequest:
    ...
    r"""**email address** of the booker for the booking"""  
    ...
    r"""The booking reference number of the item
...
class BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions:
    ...
    cancellation_from_tour_date: Optional[list[BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditionsCancellationFromTourDate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cancellationFromTourDate'), 'exclude': lambda f: f is None }})
...
class BookingMybookings200ApplicationJSONDataItemSummaries:
    ...
    *one of* the following:
    ...
    r"""**natural-language description** of the product's departure point"""  
    ...
    - For more information, see: [Merchant pricing](#section/Merchant-APIs/Merchant-pricing)
    """  
    merchant_terms_and_conditions: Optional[BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('merchantTermsAndConditions'), 'exclude': lambda f: f is None }})  
    ...
    r"""**numeric merchant total price** of the product that was booked
    - For more information, see: [Merchant pricing](#section/Merchant-APIs/Merchant-pricing)
    """  
    ...
    traveller_age_bands: Optional[list[BookingMybookings200ApplicationJSONDataItemSummariesTravellerAgeBands]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('travellerAgeBands'), 'exclude': lambda f: f is None }})
...
class BookingMybookings200ApplicationJSONData:
    ...
    r"""**exchange rate** applied to the pricing"""  
    ...
    item_summaries: Optional[list[BookingMybookings200ApplicationJSONDataItemSummaries]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemSummaries'), 'exclude': lambda f: f is None }})
    ...
    r"""ignore (Viator only)"""  
    sort_order: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sortOrder'), 'exclude': lambda f: f is None }})
    r"""**sort order** for the booking object"""  
    ...
    r"""**currency-formatted merchant total price** of *this* booking
    - For more information, see: [Merchant pricing](#section/Merchant-APIs/Merchant-pricing)
    """  
...
class BookingMybookings200ApplicationJSON:
    ...
    data: Optional[BookingMybookings200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
