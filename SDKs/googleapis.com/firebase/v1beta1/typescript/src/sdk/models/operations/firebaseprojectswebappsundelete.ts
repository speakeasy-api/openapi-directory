...
export class FirebaseProjectsWebAppsUndeleteSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseProjectsWebAppsUndeleteSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseProjectsWebAppsUndeleteSecurity extends SpeakeasyBase {
...
export class FirebaseProjectsWebAppsUndeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseProjectsWebAppsUndeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
