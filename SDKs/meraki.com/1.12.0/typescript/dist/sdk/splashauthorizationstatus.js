...
exports.SplashAuthorizationStatus = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var SplashAuthorizationStatus = /** @class */ (function () {
    function SplashAuthorizationStatus(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SplashAuthorizationStatus.prototype.getNetworkClientSplashAuthorizationStatus = function (req, config) {
    ...
    **/
    SplashAuthorizationStatus.prototype.updateNetworkClientSplashAuthorizationStatus = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.SplashAuthorizationStatus = SplashAuthorizationStatus;
