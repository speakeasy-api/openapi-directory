...
from ..shared import cctotalsbycandidatepage as shared_cctotalsbycandidatepage
...
class GetCommunicationCostsTotalsByCandidateRequest:
    query_params: GetCommunicationCostsTotalsByCandidateQueryParams = dataclasses.field()
...
class GetCommunicationCostsTotalsByCandidateResponse:
    ...
    cc_totals_by_candidate_page: Optional[shared_cctotalsbycandidatepage.CcTotalsByCandidatePage] = dataclasses.field(default=None)
