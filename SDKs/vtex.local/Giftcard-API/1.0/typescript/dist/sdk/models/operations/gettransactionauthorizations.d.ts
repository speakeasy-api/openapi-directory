...
export declare class GetTransactionAuthorizationsRequest extends SpeakeasyBase {
    /**
...
export declare class GetTransactionAuthorizationsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
