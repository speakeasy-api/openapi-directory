...
class DistributedVirtualPortgroup:
    distributed_virtual_switch: Optional[shared_reference.Reference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('distributed_virtual_switch') }})
