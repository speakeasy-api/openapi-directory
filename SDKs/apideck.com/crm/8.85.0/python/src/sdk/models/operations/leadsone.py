...
class LeadsOneRequest:
    headers: LeadsOneHeaders = dataclasses.field()
    path_params: LeadsOnePathParams = dataclasses.field()
    query_params: LeadsOneQueryParams = dataclasses.field()
    security: LeadsOneSecurity = dataclasses.field()
