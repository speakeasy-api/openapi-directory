...
class ListRegexMatchSetsRequest:
    ...
    list_regex_match_sets_request: shared_listregexmatchsetsrequest.ListRegexMatchSetsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
