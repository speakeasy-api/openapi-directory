...
exports.GetProfileResponse = exports.GetProfileRequest = exports.GetProfileQueryParams = void 0;
...
var GetProfileQueryParams = /** @class */ (function (_super) {
    ...
    ], GetProfileQueryParams.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=service" }),
        __metadata("design:type", String)
    ], GetProfileQueryParams.prototype, "service", void 0);
    return GetProfileQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetProfileQueryParams = GetProfileQueryParams;
