...
public class GetTransactionCancellationsHeaders {
    /**
    ...
    public GetTransactionCancellationsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public GetTransactionCancellationsHeaders withContentType(String contentType) {
