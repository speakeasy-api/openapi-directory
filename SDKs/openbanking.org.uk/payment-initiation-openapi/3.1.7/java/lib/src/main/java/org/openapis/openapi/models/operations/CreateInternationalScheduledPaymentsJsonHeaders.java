...
public class CreateInternationalScheduledPaymentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalScheduledPaymentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalScheduledPaymentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalScheduledPaymentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalScheduledPaymentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalScheduledPaymentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalScheduledPaymentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalScheduledPaymentsJsonHeaders withXJwsSignature(String xJwsSignature) {
