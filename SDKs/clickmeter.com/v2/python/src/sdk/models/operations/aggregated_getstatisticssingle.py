...
class AggregatedGetStatisticsSingleRequest:
    ...
    time_frame: AggregatedGetStatisticsSingleTimeFrameEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'timeFrame', 'style': 'form', 'explode': True }})
    r"""Timeframe of the request. See list at $timeframeList"""  
    ...
    only_favorites: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'onlyFavorites', 'style': 'form', 'explode': True }})  
