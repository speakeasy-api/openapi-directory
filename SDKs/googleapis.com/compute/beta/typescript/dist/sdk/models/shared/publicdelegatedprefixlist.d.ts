 ...
 */
export declare enum PublicDelegatedPrefixListWarningCodeEnum {
...
export declare class PublicDelegatedPrefixListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class PublicDelegatedPrefixListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: PublicDelegatedPrefixListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: PublicDelegatedPrefixListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class PublicDelegatedPrefixList extends SpeakeasyBase {
    /**
