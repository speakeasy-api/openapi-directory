 ...
 */
export declare enum ServiceAttachmentsScopedListWarningCodeEnum {
...
export declare class ServiceAttachmentsScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ServiceAttachmentsScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class ServiceAttachmentsScopedList extends SpeakeasyBase {
    /**
