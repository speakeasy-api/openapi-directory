...
public class PaymentEventResponse {
    ...
    public PaymentEventResponse(@JsonProperty("eventDateTime") OffsetDateTime eventDateTime, @JsonProperty("eventId") String eventId, @JsonProperty("eventType") String eventType) {
        this.eventDateTime = eventDateTime;
        this.eventId = eventId;
        this.eventType = eventType;
  }
