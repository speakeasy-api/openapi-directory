 ...
 */
export enum TargetTcpProxyListWarningCodeEnum {
...
export class TargetTcpProxyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetTcpProxyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetTcpProxyListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class TargetTcpProxyList extends SpeakeasyBase {
  /**
