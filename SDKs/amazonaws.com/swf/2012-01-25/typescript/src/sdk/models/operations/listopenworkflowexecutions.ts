...
export enum ListOpenWorkflowExecutionsXAmzTargetEnum {
  SimpleWorkflowServiceListOpenWorkflowExecutions = "SimpleWorkflowService.ListOpenWorkflowExecutions",
}

export class ListOpenWorkflowExecutionsRequest extends SpeakeasyBase {
...
export class ListOpenWorkflowExecutionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
