 ...
 */
public enum GetNetworkSwitchAccessPolicies200ApplicationJSONAccessPolicyTypeEnum {
    ...
    private GetNetworkSwitchAccessPolicies200ApplicationJSONAccessPolicyTypeEnum(String value) {
        this.value = value;
    }
}
