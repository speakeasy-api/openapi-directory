...
export class PaymentInitiationServicePIS {
      ...
      switch (true) {
        case httpRes?.status == 202:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paymentInitiationCancelResponse202 = utils.objectToClass(
              httpRes?.data,
              shared.PaymentInitiationCancelResponse202
            );
          }
          break;
        ...
        case httpRes?.status == 405:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.error405NGPISCANC = utils.objectToClass(
              httpRes?.data,
              shared.Error405NGPISCANC
            );
          }
          if (utils.matchContentType(contentType, `application/problem+json`)) {
            res.error405PISCANC = utils.objectToClass(
              httpRes?.data,
              shared.Error405PISCANC
            );
          }
          break;
  ...
  getPaymentInformation(
    ...
    security: operations.GetPaymentInformationSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetPaymentInformationResponse =
        new operations.GetPaymentInformationResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  getPaymentInitiationCancellationAuthorisationInformation(
    ...
    security: operations.GetPaymentInitiationCancellationAuthorisationInformationSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetPaymentInitiationCancellationAuthorisationInformationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetPaymentInitiationCancellationAuthorisationInformationRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetPaymentInitiationCancellationAuthorisationInformationSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetPaymentInitiationCancellationAuthorisationInformationResponse =
        new operations.GetPaymentInitiationCancellationAuthorisationInformationResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  getPaymentInitiationStatus(
    ...
    security: operations.GetPaymentInitiationStatusSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetPaymentInitiationStatusResponse =
        new operations.GetPaymentInitiationStatusResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paymentInitiationStatusResponse200Json = utils.objectToClass(
              httpRes?.data,
              shared.PaymentInitiationStatusResponse200Json
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            res.paymentInitiationStatusResponse200Xml = httpRes?.data;
          }
          break;
        case httpRes?.status == 400:
          if (utils.matchContentType(contentType, `application/json`)) {
   ...
   */
  initiatePaymentJson(
    req: operations.InitiatePaymentJsonRequest,
    security: operations.InitiatePaymentJsonSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.InitiatePaymentJsonResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.InitiatePaymentJsonResponse =
        new operations.InitiatePaymentJsonResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paymentInitationRequestResponse201 = utils.objectToClass(
              httpRes?.data,
              shared.PaymentInitationRequestResponse201
            );
          }
          break;
        case httpRes?.status == 400:
  ...
  initiatePaymentMultipart(
    req: operations.InitiatePaymentMultipartRequest,
    security: operations.InitiatePaymentMultipartSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.InitiatePaymentMultipartResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.InitiatePaymentMultipartResponse =
        new operations.InitiatePaymentMultipartResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
   ...
   */
  initiatePaymentRaw(
    req: operations.InitiatePaymentRawRequest,
    security: operations.InitiatePaymentRawSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.InitiatePaymentRawResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.InitiatePaymentRawResponse =
        new operations.InitiatePaymentRawResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
