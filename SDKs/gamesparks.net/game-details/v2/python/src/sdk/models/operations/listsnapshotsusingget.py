...
class ListSnapshotsUsingGETRequest:
...
@dataclasses.dataclass
class ListSnapshotsUsingGETResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    manage_snapshots: Optional[list[shared_managesnapshot.ManageSnapshot]] = dataclasses.field(default=None)
    r"""OK"""  
