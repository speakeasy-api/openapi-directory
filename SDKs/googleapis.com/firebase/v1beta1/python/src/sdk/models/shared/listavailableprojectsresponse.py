...
class ListAvailableProjectsResponse:
    ...
    project_info: Optional[list[shared_projectinfo.ProjectInfo]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('projectInfo'), 'exclude': lambda f: f is None }})
    r"""The list of GCP `Projects` which can have Firebase resources added to them."""  
