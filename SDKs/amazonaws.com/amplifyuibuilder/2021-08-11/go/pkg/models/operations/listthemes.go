...
type ListThemesPathParams struct {
...
type ListThemesQueryParams struct {
...
type ListThemesRequest struct {
	PathParams  ListThemesPathParams
	QueryParams ListThemesQueryParams
	Headers     ListThemesHeaders
}
