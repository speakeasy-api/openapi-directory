 ...
 */
export declare const ServerList: readonly ["http://mturk-requester.{region}.amazonaws.com", "https://mturk-requester.{region}.amazonaws.com", "http://mturk-requester.{region}.amazonaws.com.cn", "https://mturk-requester.{region}.amazonaws.com.cn"];
/**
...
export declare class SDK {
     ...
     */
    acceptQualificationRequest(req: operations.AcceptQualificationRequestRequest, config?: AxiosRequestConfig): Promise<operations.AcceptQualificationRequestResponse>;
    /**
     ...
     */
    approveAssignment(req: operations.ApproveAssignmentRequest, config?: AxiosRequestConfig): Promise<operations.ApproveAssignmentResponse>;
    /**
     ...
     */
    associateQualificationWithWorker(req: operations.AssociateQualificationWithWorkerRequest, config?: AxiosRequestConfig): Promise<operations.AssociateQualificationWithWorkerResponse>;
    /**
     ...
     */
    createAdditionalAssignmentsForHIT(req: operations.CreateAdditionalAssignmentsForHITRequest, config?: AxiosRequestConfig): Promise<operations.CreateAdditionalAssignmentsForHITResponse>;
    /**
     ...
     */
    createHIT(req: operations.CreateHITRequest, config?: AxiosRequestConfig): Promise<operations.CreateHITResponse>;
    /**
     ...
     */
    createHITType(req: operations.CreateHITTypeRequest, config?: AxiosRequestConfig): Promise<operations.CreateHITTypeResponse>;
    /**
     ...
     */
    createHITWithHITType(req: operations.CreateHITWithHITTypeRequest, config?: AxiosRequestConfig): Promise<operations.CreateHITWithHITTypeResponse>;
    /**
     ...
     */
    createQualificationType(req: operations.CreateQualificationTypeRequest, config?: AxiosRequestConfig): Promise<operations.CreateQualificationTypeResponse>;
    /**
     ...
     */
    createWorkerBlock(req: operations.CreateWorkerBlockRequest, config?: AxiosRequestConfig): Promise<operations.CreateWorkerBlockResponse>;
    /**
     ...
     */
    deleteHIT(req: operations.DeleteHITRequest, config?: AxiosRequestConfig): Promise<operations.DeleteHITResponse>;
    /**
     ...
     */
    deleteQualificationType(req: operations.DeleteQualificationTypeRequest, config?: AxiosRequestConfig): Promise<operations.DeleteQualificationTypeResponse>;
    /**
     * The <code>DeleteWorkerBlock</code> operation allows you to reinstate a blocked Worker to work on your HITs. This operation reverses the effects of the CreateWorkerBlock operation. You need the Worker ID to use this operation. If the Worker ID is missing or invalid, this operation fails and returns the message “WorkerId is invalid.” If the specified Worker is not blocked, this operation returns successfully.
     */
    deleteWorkerBlock(req: operations.DeleteWorkerBlockRequest, config?: AxiosRequestConfig): Promise<operations.DeleteWorkerBlockResponse>;
    /**
     ...
     */
    disassociateQualificationFromWorker(req: operations.DisassociateQualificationFromWorkerRequest, config?: AxiosRequestConfig): Promise<operations.DisassociateQualificationFromWorkerResponse>;
    /**
     ...
     */
    getAssignment(req: operations.GetAssignmentRequest, config?: AxiosRequestConfig): Promise<operations.GetAssignmentResponse>;
    /**
     ...
     */
    getFileUploadURL(req: operations.GetFileUploadURLRequest, config?: AxiosRequestConfig): Promise<operations.GetFileUploadURLResponse>;
    /**
     *  The <code>GetHIT</code> operation retrieves the details of the specified HIT.
     */
    getHIT(req: operations.GetHITRequest, config?: AxiosRequestConfig): Promise<operations.GetHITResponse>;
    /**
     ...
     */
    getQualificationScore(req: operations.GetQualificationScoreRequest, config?: AxiosRequestConfig): Promise<operations.GetQualificationScoreResponse>;
    /**
     *  The <code>GetQualificationType</code>operation retrieves information about a Qualification type using its ID.
     */
    getQualificationType(req: operations.GetQualificationTypeRequest, config?: AxiosRequestConfig): Promise<operations.GetQualificationTypeResponse>;
    /**
     ...
     */
    listAssignmentsForHIT(req: operations.ListAssignmentsForHITRequest, config?: AxiosRequestConfig): Promise<operations.ListAssignmentsForHITResponse>;
    /**
     ...
     */
    listBonusPayments(req: operations.ListBonusPaymentsRequest, config?: AxiosRequestConfig): Promise<operations.ListBonusPaymentsResponse>;
    /**
     ...
     */
    listHITs(req: operations.ListHITsRequest, config?: AxiosRequestConfig): Promise<operations.ListHITsResponse>;
    /**
     ...
     */
    listHITsForQualificationType(req: operations.ListHITsForQualificationTypeRequest, config?: AxiosRequestConfig): Promise<operations.ListHITsForQualificationTypeResponse>;
    /**
     ...
     */
    listQualificationRequests(req: operations.ListQualificationRequestsRequest, config?: AxiosRequestConfig): Promise<operations.ListQualificationRequestsResponse>;
    /**
     *  The <code>ListQualificationTypes</code> operation returns a list of Qualification types, filtered by an optional search term.
     */
    listQualificationTypes(req: operations.ListQualificationTypesRequest, config?: AxiosRequestConfig): Promise<operations.ListQualificationTypesResponse>;
    /**
     *  The <code>ListReviewPolicyResultsForHIT</code> operation retrieves the computed results and the actions taken in the course of executing your Review Policies for a given HIT. For information about how to specify Review Policies when you call CreateHIT, see Review Policies. The ListReviewPolicyResultsForHIT operation can return results for both Assignment-level and HIT-level review results.
     */
    listReviewPolicyResultsForHIT(req: operations.ListReviewPolicyResultsForHITRequest, config?: AxiosRequestConfig): Promise<operations.ListReviewPolicyResultsForHITResponse>;
    /**
     ...
     */
    listReviewableHITs(req: operations.ListReviewableHITsRequest, config?: AxiosRequestConfig): Promise<operations.ListReviewableHITsResponse>;
    /**
     * The <code>ListWorkersBlocks</code> operation retrieves a list of Workers who are blocked from working on your HITs.
     */
    listWorkerBlocks(req: operations.ListWorkerBlocksRequest, config?: AxiosRequestConfig): Promise<operations.ListWorkerBlocksResponse>;
    /**
     ...
     */
    listWorkersWithQualificationType(req: operations.ListWorkersWithQualificationTypeRequest, config?: AxiosRequestConfig): Promise<operations.ListWorkersWithQualificationTypeResponse>;
    /**
     *  The <code>NotifyWorkers</code> operation sends an email to one or more Workers that you specify with the Worker ID. You can specify up to 100 Worker IDs to send the same message with a single call to the NotifyWorkers operation. The NotifyWorkers operation will send a notification email to a Worker only if you have previously approved or rejected work from the Worker.
     */
    notifyWorkers(req: operations.NotifyWorkersRequest, config?: AxiosRequestConfig): Promise<operations.NotifyWorkersResponse>;
    /**
     ...
     */
    rejectAssignment(req: operations.RejectAssignmentRequest, config?: AxiosRequestConfig): Promise<operations.RejectAssignmentResponse>;
    /**
     ...
     */
    rejectQualificationRequest(req: operations.RejectQualificationRequestRequest, config?: AxiosRequestConfig): Promise<operations.RejectQualificationRequestResponse>;
    /**
     ...
     */
    sendBonus(req: operations.SendBonusRequest, config?: AxiosRequestConfig): Promise<operations.SendBonusResponse>;
    /**
     ...
     */
    sendTestEventNotification(req: operations.SendTestEventNotificationRequest, config?: AxiosRequestConfig): Promise<operations.SendTestEventNotificationResponse>;
    /**
     ...
     */
    updateExpirationForHIT(req: operations.UpdateExpirationForHITRequest, config?: AxiosRequestConfig): Promise<operations.UpdateExpirationForHITResponse>;
    /**
     ...
     */
    updateHITReviewStatus(req: operations.UpdateHITReviewStatusRequest, config?: AxiosRequestConfig): Promise<operations.UpdateHITReviewStatusResponse>;
    /**
     ...
     */
    updateHITTypeOfHIT(req: operations.UpdateHITTypeOfHITRequest, config?: AxiosRequestConfig): Promise<operations.UpdateHITTypeOfHITResponse>;
    /**
     ...
     */
    updateNotificationSettings(req: operations.UpdateNotificationSettingsRequest, config?: AxiosRequestConfig): Promise<operations.UpdateNotificationSettingsResponse>;
    /**
     ...
     */
    updateQualificationType(req: operations.UpdateQualificationTypeRequest, config?: AxiosRequestConfig): Promise<operations.UpdateQualificationTypeResponse>;
}
