...
export class GetPublicationPhenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPublicationPhenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPublicationPhenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPublicationPhenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
