...
class WritableVirtualMachineInterfaceInput:
    ...
    type: WritableVirtualMachineInterfaceTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
    ...
    mode: Optional[WritableVirtualMachineInterfaceModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mode'), 'exclude': lambda f: f is None }})  
