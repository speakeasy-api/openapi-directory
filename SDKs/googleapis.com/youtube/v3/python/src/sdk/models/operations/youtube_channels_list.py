...
class YoutubeChannelsListRequest:
    ...
    r"""The *part* parameter specifies a comma-separated list of one or more channel resource properties that the API response will include. If the parameter identifies a property that contains child properties, the child properties will be included in the response. For example, in a channel resource, the contentDetails property contains other properties, such as the uploads properties. As such, if you set *part=contentDetails*, the API response will also contain all of those nested properties."""  
    ...
    r"""Return the channels within the specified guide category ID."""  
    ...
    r"""Return the channel associated with a YouTube username."""  
    ...
    r"""Return the channels with the specified IDs."""  
    ...
    r"""Return the channels managed by the authenticated user."""  
    ...
    r"""Return the ids of channels owned by the authenticated user."""  
    ...
    r"""Return the channels subscribed to the authenticated user"""  
