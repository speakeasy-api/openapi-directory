...
public class ApiV2010AccountUsageUsageRecord {
    /**
    ...
    public ApiV2010AccountUsageUsageRecord withAccountSid(String accountSid) {
    ...
    public ApiV2010AccountUsageUsageRecord withApiVersion(String apiVersion) {
    ...
    public ApiV2010AccountUsageUsageRecord withAsOf(String asOf) {
        this.asOf = asOf;
        return this;
    }
    ...
    public UsageRecordEnumCategoryEnum category;

    public ApiV2010AccountUsageUsageRecord withCategory(UsageRecordEnumCategoryEnum category) {
    ...
    public ApiV2010AccountUsageUsageRecord withCount(String count) {
        this.count = count;
        return this;
    }
    ...
    public ApiV2010AccountUsageUsageRecord withCountUnit(String countUnit) {
    ...
    public ApiV2010AccountUsageUsageRecord withDescription(String description) {
    ...
    public ApiV2010AccountUsageUsageRecord withEndDate(LocalDate endDate) {
    ...
    public ApiV2010AccountUsageUsageRecord withPrice(Double price) {
        this.price = price;
        return this;
    }
    ...
    public ApiV2010AccountUsageUsageRecord withPriceUnit(String priceUnit) {
    ...
    public ApiV2010AccountUsageUsageRecord withStartDate(LocalDate startDate) {
    ...
    public ApiV2010AccountUsageUsageRecord withSubresourceUris(java.util.Map<String, Object> subresourceUris) {
    ...
    public ApiV2010AccountUsageUsageRecord withUri(String uri) {
        this.uri = uri;
        return this;
    }
    ...
    public ApiV2010AccountUsageUsageRecord withUsage(String usage) {
        this.usage = usage;
        return this;
    }
    ...
    public ApiV2010AccountUsageUsageRecord withUsageUnit(String usageUnit) {
        this.usageUnit = usageUnit;
        return this;
    }
    
    public ApiV2010AccountUsageUsageRecord(){}
}
