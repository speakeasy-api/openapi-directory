...
from ..shared import sortinferenceexperimentsby_enum as shared_sortinferenceexperimentsby_enum
...
class ListInferenceExperimentsRequest:
    ...
    sort_by: Optional[shared_sortinferenceexperimentsby_enum.SortInferenceExperimentsByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    ...
    status_equals: Optional[shared_inferenceexperimentstatus_enum.InferenceExperimentStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
    type: Optional[shared_inferenceexperimenttype_enum.InferenceExperimentTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Type'), 'exclude': lambda f: f is None }})  
