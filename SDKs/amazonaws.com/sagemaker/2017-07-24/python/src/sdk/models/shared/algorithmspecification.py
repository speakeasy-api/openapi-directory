...
from ..shared import trainingimageconfig as shared_trainingimageconfig
...
class AlgorithmSpecification:
    ...
    algorithm_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AlgorithmName'), 'exclude': lambda f: f is None }})  
    ...
    enable_sage_maker_metrics_time_series: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EnableSageMakerMetricsTimeSeries'), 'exclude': lambda f: f is None }})  
    ...
    training_image: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TrainingImage'), 'exclude': lambda f: f is None }})  
    training_image_config: Optional[shared_trainingimageconfig.TrainingImageConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TrainingImageConfig'), 'exclude': lambda f: f is None }})  
