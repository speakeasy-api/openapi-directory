...
public class CloudidentityGroupsMembershipsSearchDirectGroupsPathParams {
    /**
    ...
    public CloudidentityGroupsMembershipsSearchDirectGroupsPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
