...
export class GetPublicationGeneAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPublicationGeneAssociationsQueryParams extends SpeakeasyBase {
