...
public enum CivicinfoRepresentativesRepresentativeInfoByAddressRolesEnum {
    ...
    private CivicinfoRepresentativesRepresentativeInfoByAddressRolesEnum(String value) {
        this.value = value;
    }
}
