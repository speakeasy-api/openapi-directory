...
type DialogflowProjectsLocationsAgentEntityTypesEntitiesBatchUpdateRequest struct {
	...
	GoogleCloudDialogflowV2beta1BatchUpdateEntitiesRequest *shared.GoogleCloudDialogflowV2beta1BatchUpdateEntitiesRequest `request:"mediaType=application/json"`
	// OAuth access token.
