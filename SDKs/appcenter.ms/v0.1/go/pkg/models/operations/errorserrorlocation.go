...
func (e ErrorsErrorLocationDefaultApplicationJSONErrorCodeEnum) ToPointer() *ErrorsErrorLocationDefaultApplicationJSONErrorCodeEnum {
	return &e
}
...
func (e *ErrorsErrorLocationDefaultApplicationJSONErrorCodeEnum) UnmarshalJSON(data []byte) error {
	...
	case "TooManyRequests":
		*e = ErrorsErrorLocationDefaultApplicationJSONErrorCodeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ErrorsErrorLocationDefaultApplicationJSONErrorCodeEnum: %v", v)
	}
}
