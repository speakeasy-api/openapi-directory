...
public class CripcRequestBodyCertificateParameters {
    ...
    public CripcRequestBodyCertificateParameters(@JsonProperty("FullName") String fullName, @JsonProperty("UDF1") String udf1, @JsonProperty("UDF2") String udf2, @JsonProperty("UDF3") String udf3) {
        this.fullName = fullName;
        this.udf1 = udf1;
        this.udf2 = udf2;
        this.udf3 = udf3;
