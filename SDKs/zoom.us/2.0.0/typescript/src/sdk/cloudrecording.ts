...
export class CloudRecording {
  ...
  getAccountCloudRecording(
    ...
    security: operations.GetAccountCloudRecordingSecurity,
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetAccountCloudRecordingResponse =
        new operations.GetAccountCloudRecordingResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getAccountCloudRecording200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetAccountCloudRecording200ApplicationJSON
              );
          }
  ...
  listArchivedFiles(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListArchivedFilesResponse =
        new operations.ListArchivedFilesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.listArchivedFiles200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.ListArchivedFiles200ApplicationJSON
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  meetingRecordingRegistrantCreate(
    ...
    security: operations.MeetingRecordingRegistrantCreateSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.MeetingRecordingRegistrantCreateSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.MeetingRecordingRegistrantCreateResponse =
        new operations.MeetingRecordingRegistrantCreateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.meetingRecordingRegistrantCreate201ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.MeetingRecordingRegistrantCreate201ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  meetingRecordingRegistrantStatus(
    ...
    security: operations.MeetingRecordingRegistrantStatusSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.MeetingRecordingRegistrantStatusSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.MeetingRecordingRegistrantStatusResponse =
        new operations.MeetingRecordingRegistrantStatusResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  meetingRecordingRegistrants(
    ...
    security: operations.MeetingRecordingRegistrantsSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.MeetingRecordingRegistrantsResponse =
        new operations.MeetingRecordingRegistrantsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.recordingRegistrationList = utils.objectToClass(
              httpRes?.data,
              operations.MeetingRecordingRegistrantsRecordingRegistrationList
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  recordingDelete(
    ...
    security: operations.RecordingDeleteSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingDeleteResponse =
        new operations.RecordingDeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  recordingDeleteOne(
    ...
    security: operations.RecordingDeleteOneSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingDeleteOneResponse =
        new operations.RecordingDeleteOneResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  recordingGet(
    ...
    security: operations.RecordingGetSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingGetResponse =
        new operations.RecordingGetResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.recordingFileList = utils.objectToClass(
              httpRes?.data,
              operations.RecordingGetRecordingFileList
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  recordingRegistrantQuestionUpdate(
    ...
    security: operations.RecordingRegistrantQuestionUpdateSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.RecordingRegistrantQuestionUpdateSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingRegistrantQuestionUpdateResponse =
        new operations.RecordingRegistrantQuestionUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  recordingRegistrantsQuestionsGet(
    ...
    security: operations.RecordingRegistrantsQuestionsGetSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.RecordingRegistrantsQuestionsGetSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingRegistrantsQuestionsGetResponse =
        new operations.RecordingRegistrantsQuestionsGetResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.recordingRegistrantQuestions = utils.objectToClass(
              httpRes?.data,
              operations.RecordingRegistrantsQuestionsGetRecordingRegistrantQuestions
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  recordingSettingUpdate(
    ...
    security: operations.RecordingSettingUpdateSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingSettingUpdateResponse =
        new operations.RecordingSettingUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.recordingSettings = utils.objectToClass(
              httpRes?.data,
              operations.RecordingSettingUpdateRecordingSettings
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  recordingSettingsUpdate(
    ...
    security: operations.RecordingSettingsUpdateSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingSettingsUpdateResponse =
        new operations.RecordingSettingsUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  recordingStatusUpdate(
    ...
    security: operations.RecordingStatusUpdateSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingStatusUpdateResponse =
        new operations.RecordingStatusUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  recordingStatusUpdateOne(
    ...
    security: operations.RecordingStatusUpdateOneSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingStatusUpdateOneResponse =
        new operations.RecordingStatusUpdateOneResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  recordingsList(
    ...
    security: operations.RecordingsListSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RecordingsListResponse =
        new operations.RecordingsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.recordingList = utils.objectToClass(
              httpRes?.data,
              operations.RecordingsListRecordingList
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
