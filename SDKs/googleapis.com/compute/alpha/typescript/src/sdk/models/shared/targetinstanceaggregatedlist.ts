 ...
 */
export enum TargetInstanceAggregatedListWarningCodeEnum {
...
export class TargetInstanceAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetInstanceAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetInstanceAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class TargetInstanceAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetInstancesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, TargetInstancesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], TargetInstancesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
