...
} from "./googleclouddatacatalogv1datasource";
...
} from "./googleclouddatacatalogv1gcsfilesetspec";
...
} from "./googleclouddatacatalogv1usagesignal";
...
export class GoogleCloudDatacatalogV1Entry extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "cloudBigtableSystemSpec" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "dataSourceConnectionSpec" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "sqlDatabaseSystemSpec" })
...
export class GoogleCloudDatacatalogV1EntryInput extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "dataSource" })
  @Type(() => GoogleCloudDatacatalogV1DataSourceInput)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "usageSignal" })
  @Type(() => GoogleCloudDatacatalogV1UsageSignalInput)
