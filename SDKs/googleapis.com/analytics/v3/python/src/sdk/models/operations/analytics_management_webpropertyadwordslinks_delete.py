...
class AnalyticsManagementWebPropertyAdWordsLinksDeleteRequest:
    path_params: AnalyticsManagementWebPropertyAdWordsLinksDeletePathParams = dataclasses.field()
    query_params: AnalyticsManagementWebPropertyAdWordsLinksDeleteQueryParams = dataclasses.field()
    security: AnalyticsManagementWebPropertyAdWordsLinksDeleteSecurity = dataclasses.field()
