...
class GetDeleteSigningCertificateQueryParams:
    action: GetDeleteSigningCertificateActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    certificate_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'CertificateId', 'style': 'form', 'explode': True }})
    version: GetDeleteSigningCertificateVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteSigningCertificateRequest:
    headers: GetDeleteSigningCertificateHeaders = dataclasses.field()
    query_params: GetDeleteSigningCertificateQueryParams = dataclasses.field()
