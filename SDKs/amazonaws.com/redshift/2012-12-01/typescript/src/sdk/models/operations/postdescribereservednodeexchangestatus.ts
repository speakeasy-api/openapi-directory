...
export enum POSTDescribeReservedNodeExchangeStatusActionEnum {
  DescribeReservedNodeExchangeStatus = "DescribeReservedNodeExchangeStatus",
}

export enum POSTDescribeReservedNodeExchangeStatusVersionEnum {
  TwoThousandAndTwelve1201 = "2012-12-01",
}

export class POSTDescribeReservedNodeExchangeStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTDescribeReservedNodeExchangeStatusResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
