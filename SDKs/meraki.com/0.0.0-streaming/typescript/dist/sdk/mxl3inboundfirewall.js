...
exports.Mxl3InboundFirewall = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var Mxl3InboundFirewall = /** @class */ (function () {
    function Mxl3InboundFirewall(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the inbound firewall rules for an MX network
     */
    Mxl3InboundFirewall.prototype.getNetworkApplianceFirewallInboundFirewallRules = function (req, config) {
     ...
     * Update the inbound firewall rules of an MX network
     */
    Mxl3InboundFirewall.prototype.updateNetworkApplianceFirewallInboundFirewallRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
...
exports.Mxl3InboundFirewall = Mxl3InboundFirewall;
