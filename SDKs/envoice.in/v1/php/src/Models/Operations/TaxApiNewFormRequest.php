...
class TaxApiNewFormRequest
{
	#[SpeakeasyMetadata('request:mediaType=application/x-www-form-urlencoded')]
    public \OpenAPI\OpenAPI\Models\Shared\TaxCreateApiModel $taxCreateApiModel;
	...
	{
		$this->taxCreateApiModel = new \OpenAPI\OpenAPI\Models\Shared\TaxCreateApiModel();
		$this->xAuthKey = "";
		$this->xAuthSecret = "";
	}
}
