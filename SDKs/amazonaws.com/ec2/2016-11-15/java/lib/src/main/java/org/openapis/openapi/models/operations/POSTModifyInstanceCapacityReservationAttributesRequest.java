...
public class POSTModifyInstanceCapacityReservationAttributesRequest {
    ...
    public POSTModifyInstanceCapacityReservationAttributesRequest(@JsonProperty("Action") POSTModifyInstanceCapacityReservationAttributesActionEnum action, @JsonProperty("Version") POSTModifyInstanceCapacityReservationAttributesVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
