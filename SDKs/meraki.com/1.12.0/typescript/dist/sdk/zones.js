...
var Zones = /** @class */ (function () {
    function Zones(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Zones.prototype.getDeviceCameraAnalyticsZoneHistory = function (req, config) {
    ...
    **/
    Zones.prototype.getDeviceCameraAnalyticsZones = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
