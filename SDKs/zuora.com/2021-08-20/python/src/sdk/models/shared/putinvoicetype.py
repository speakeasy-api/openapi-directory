...
class PutInvoiceTypeTransferredToAccountingEnum(str, Enum):
...
class PutInvoiceType:
    ...
    **Note:** Invoice items can only be updated when Unified Invoice is enabled and the invoice is a standalone invoice.
    ...
    transferred_to_accounting: Optional[PutInvoiceTypeTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the invoice was transferred to an external accounting system."""  
