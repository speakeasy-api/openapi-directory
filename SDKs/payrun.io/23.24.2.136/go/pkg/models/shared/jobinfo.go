...
func (e JobInfoJobInfoJobStatusEnum) ToPointer() *JobInfoJobInfoJobStatusEnum {
	return &e
}
...
func (e *JobInfoJobInfoJobStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "Failed":
		fallthrough
	case "OnHold":
		*e = JobInfoJobInfoJobStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for JobInfoJobInfoJobStatusEnum: %v", v)
	}
}
