...
exports.GetGetPathwayHistoryResponse = exports.GetGetPathwayHistoryRequest = exports.GetGetPathwayHistoryFormatEnum = void 0;
...
var GetGetPathwayHistoryRequest = /** @class */ (function (_super) {
    ...
    ], GetGetPathwayHistoryRequest.prototype, "format", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=pwId" }),
        __metadata("design:type", String)
    ], GetGetPathwayHistoryRequest.prototype, "pwId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timestamp",
        }),
        __metadata("design:type", String)
    ], GetGetPathwayHistoryRequest.prototype, "timestamp", void 0);
...
var GetGetPathwayHistoryResponse = /** @class */ (function (_super) {
    ...
    ], GetGetPathwayHistoryResponse.prototype, "rawResponse", void 0);
