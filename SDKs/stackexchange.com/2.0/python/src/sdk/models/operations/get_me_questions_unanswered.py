...
class GetMeQuestionsUnansweredOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeQuestionsUnansweredSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
class GetMeQuestionsUnansweredQueryParams:
    ...
    order: Optional[GetMeQuestionsUnansweredOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeQuestionsUnansweredSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetMeQuestionsUnansweredRequest:
    query_params: GetMeQuestionsUnansweredQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetMeQuestionsUnansweredResponse:
