...
from ..shared import unifiedfile as shared_unifiedfile
...
class GetFilesResponse:
    data: list[shared_unifiedfile.UnifiedFile] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
