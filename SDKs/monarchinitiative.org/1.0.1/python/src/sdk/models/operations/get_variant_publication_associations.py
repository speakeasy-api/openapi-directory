...
class GetVariantPublicationAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetVariantPublicationAssociationsQueryParams:
...
class GetVariantPublicationAssociationsRequest:
    path_params: GetVariantPublicationAssociationsPathParams = dataclasses.field()
    query_params: GetVariantPublicationAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetVariantPublicationAssociationsResponse:
