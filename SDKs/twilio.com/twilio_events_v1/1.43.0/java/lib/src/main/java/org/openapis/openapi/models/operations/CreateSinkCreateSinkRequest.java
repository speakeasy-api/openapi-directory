...
public class CreateSinkCreateSinkRequest {
    ...
    public CreateSinkCreateSinkRequest(@JsonProperty("Description") String description, @JsonProperty("SinkConfiguration") Object sinkConfiguration, @JsonProperty("SinkType") org.openapis.openapi.models.shared.SinkEnumSinkTypeEnum sinkType) {
        this.description = description;
        this.sinkConfiguration = sinkConfiguration;
        this.sinkType = sinkType;
  }
