...
public class GetAccountsIdTransactionsQueryParams {
    /**
    ...
    public GetAccountsIdTransactionsQueryParams withEndDate(String endDate) {
    ...
    public GetAccountsIdTransactionsQueryParams withNeedsReview(Long needsReview) {
    ...
    public Long page;
    public GetAccountsIdTransactionsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetAccountsIdTransactionsQueryParams withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public GetAccountsIdTransactionsQueryParams withStartDate(String startDate) {
    ...
    public GetAccountsIdTransactionsQueryParams withType(GetAccountsIdTransactionsTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public GetAccountsIdTransactionsQueryParams withUncategorised(Long uncategorised) {
    ...
    public GetAccountsIdTransactionsQueryParams withUpdatedSince(String updatedSince) {
