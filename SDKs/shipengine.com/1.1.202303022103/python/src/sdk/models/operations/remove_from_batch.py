...
class RemoveFromBatchRequest:
    ...
    r"""Batch ID"""  
    remove_from_batch_request_body: shared_remove_from_batch_request_body.RemoveFromBatchRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
