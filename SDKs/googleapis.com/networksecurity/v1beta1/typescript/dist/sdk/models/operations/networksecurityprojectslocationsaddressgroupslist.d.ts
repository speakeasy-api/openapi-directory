...
export declare class NetworksecurityProjectsLocationsAddressGroupsListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsAddressGroupsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsAddressGroupsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
    listAddressGroupsResponse?: shared.ListAddressGroupsResponse;
    statusCode: number;
