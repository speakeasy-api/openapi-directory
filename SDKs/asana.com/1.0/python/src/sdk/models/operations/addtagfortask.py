...
class AddTagForTaskRequestBody:
    ...
    data: Optional[shared_taskaddtagrequest.TaskAddTagRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class AddTagForTaskRequest:
    
    request_body: AddTagForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The tag to add to the task."""  
...
class AddTagForTask200ApplicationJSON:
    r"""Successfully added the specified tag to the task."""
