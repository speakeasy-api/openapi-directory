...
export class ListNetworkAccessProfileListNetworkAccessProfileResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListNetworkAccessProfileListNetworkAccessProfileResponseMeta)
  meta?: ListNetworkAccessProfileListNetworkAccessProfileResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.SupersimV1NetworkAccessProfile })
  @Expose({ name: "network_access_profiles" })
  @Type(() => shared.SupersimV1NetworkAccessProfile)
