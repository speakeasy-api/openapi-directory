...
type CreateDomesticStandingOrderConsentsRawSecurity struct {
	TPPOAuth2Security shared.SchemeTppoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateDomesticStandingOrderConsentsRawHeaders struct {
...
type CreateDomesticStandingOrderConsentsRawRequest struct {
	Headers CreateDomesticStandingOrderConsentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateDomesticStandingOrderConsentsRawSecurity
}

type CreateDomesticStandingOrderConsentsRawResponse struct {
	Body        []byte
	ContentType string
