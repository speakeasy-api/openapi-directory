...
from ..shared import proxygettaxationitem as shared_proxygettaxationitem
...
class ObjectGETTaxationItemResponse:
    ...
    proxy_get_taxation_item: Optional[shared_proxygettaxationitem.ProxyGetTaxationItem] = dataclasses.field(default=None)  
