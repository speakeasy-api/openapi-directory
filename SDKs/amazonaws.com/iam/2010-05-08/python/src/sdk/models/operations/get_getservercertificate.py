...
class GetGetServerCertificateQueryParams:
    action: GetGetServerCertificateActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetGetServerCertificateVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetServerCertificateRequest:
    headers: GetGetServerCertificateHeaders = dataclasses.field()
    query_params: GetGetServerCertificateQueryParams = dataclasses.field()
