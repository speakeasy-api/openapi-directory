...
try {
    ...
    $request->order = OrderEnum::ASC;
    $request->page = 996072;
    $request->perPage = 921060;
    $request->q = 'architecto';
    $request->repositoryId = 240696;
