...
class SearchBioTaxonomyQueryParams:
    ...
    search_bio_taxonomy_aliases: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_taxonomy.aliases', 'style': 'form', 'explode': True }})
    search_bio_taxonomy_division: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_taxonomy.division', 'style': 'form', 'explode': True }})
    search_bio_taxonomy_embl_code: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_taxonomy.embl_code', 'style': 'form', 'explode': True }})
    search_bio_taxonomy_inherited_div: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_taxonomy.inherited_div', 'style': 'form', 'explode': True }})
    search_bio_taxonomy_rank: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_taxonomy.rank', 'style': 'form', 'explode': True }})
...
class SearchBioTaxonomyRequest:
    query_params: SearchBioTaxonomyQueryParams = dataclasses.field()
