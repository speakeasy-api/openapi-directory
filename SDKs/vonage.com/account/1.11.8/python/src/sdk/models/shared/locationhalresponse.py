...
class LocationHalResponse:
    ...
    embedded: Optional[shared_locationembeddedobject.LocationEmbeddedObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_embedded'), 'exclude': lambda f: f is None }})
    r"""Location object"""  
