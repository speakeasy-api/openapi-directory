...
class GETUntagQueueRequest:
    ...
    action: GETUntagQueueActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    ...
    r"""The list of tags to be removed from the specified queue."""  
    version: GETUntagQueueVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
