...
class SearchBioOntologyAssayQueryParams:
...
@dataclasses.dataclass
class SearchBioOntologyAssayRequest:
    query_params: SearchBioOntologyAssayQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchBioOntologyAssayResponse:
