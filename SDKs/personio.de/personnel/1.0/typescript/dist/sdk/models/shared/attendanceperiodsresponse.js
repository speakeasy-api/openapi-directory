...
exports.AttendancePeriodsResponse = exports.AttendancePeriodsResponseData = exports.AttendancePeriodsResponseDataAttributes = void 0;
...
var AttendancePeriodsResponseDataAttributes = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_holiday" }),
        __metadata("design:type", Boolean)
    ], AttendancePeriodsResponseDataAttributes.prototype, "isHoliday", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_on_time_off" }),
        __metadata("design:type", Boolean)
...
exports.AttendancePeriodsResponseDataAttributes = AttendancePeriodsResponseDataAttributes;
var AttendancePeriodsResponseData = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attributes", elemType: AttendancePeriodsResponseDataAttributes }),
...
exports.AttendancePeriodsResponseData = AttendancePeriodsResponseData;
var AttendancePeriodsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=data", elemType: AttendancePeriodsResponseData }),
        __metadata("design:type", Array)
...
exports.AttendancePeriodsResponse = AttendancePeriodsResponse;
