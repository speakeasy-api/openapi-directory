...
class DescribeCommandsResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribeCommandsResult $describeCommandsResult
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribeCommandsResult $describeCommandsResult = null;
	...
	{
		$this->contentType = "";
		$this->describeCommandsResult = null;
