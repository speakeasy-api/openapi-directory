...
class SandboxTransferTestClockListRequest
{
     ...
     * 
     * @var ?\DateTime $endVirtualTime
     */
	#[\JMS\Serializer\Annotation\SerializedName('end_virtual_time')]
    #[\JMS\Serializer\Annotation\Type("DateTime<'Y-m-d\TH:i:s.up'>")]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?\DateTime $endVirtualTime = null;
     ...
     * 
     * @var ?\DateTime $startVirtualTime
     */
	#[\JMS\Serializer\Annotation\SerializedName('start_virtual_time')]
    #[\JMS\Serializer\Annotation\Type("DateTime<'Y-m-d\TH:i:s.up'>")]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?\DateTime $startVirtualTime = null;
    
	public function __construct()
	{
		$this->clientId = null;
		$this->count = null;
		$this->endVirtualTime = null;
		$this->offset = null;
		$this->secret = null;
		$this->startVirtualTime = null;
	}
}
