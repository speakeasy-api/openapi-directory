...
class RecordPatch:
    ...
    op: shared_operation_enum.OperationEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Op') }})
    sync_count: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SyncCount') }})
