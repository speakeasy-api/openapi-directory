...
from ..shared import imageversionsortby_enum as shared_imageversionsortby_enum
from ..shared import imageversionsortorder_enum as shared_imageversionsortorder_enum
...
class ListImageVersionsRequest:
    ...
    sort_by: Optional[shared_imageversionsortby_enum.ImageVersionSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    sort_order: Optional[shared_imageversionsortorder_enum.ImageVersionSortOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortOrder'), 'exclude': lambda f: f is None }})  
