...
from ..shared import createordertriggerparams as shared_createordertriggerparams

class CreateOrderChargeOverrideBillingBillCycleTypeEnum(str, Enum):
...
class CreateOrderChargeOverrideBillingBillingPeriodEnum(str, Enum):
    MONTH = "Month"
    QUARTER = "Quarter"
...
class CreateOrderChargeOverrideBillingBillingPeriodAlignmentEnum(str, Enum):
    ALIGN_TO_CHARGE = "AlignToCharge"
    ALIGN_TO_SUBSCRIPTION_START = "AlignToSubscriptionStart"
    ALIGN_TO_TERM_START = "AlignToTermStart"

class CreateOrderChargeOverrideBillingBillingTimingEnum(str, Enum):
    IN_ADVANCE = "IN_ADVANCE"
    IN_ARREARS = "IN_ARREARS"

class CreateOrderChargeOverrideBillingWeeklyBillCycleDayEnum(str, Enum):
    SUNDAY = "Sunday"
    MONDAY = "Monday"
    TUESDAY = "Tuesday"
    WEDNESDAY = "Wednesday"
...
class CreateOrderChargeOverrideBilling:
    r"""CreateOrderChargeOverrideBilling
    ...
    bill_cycle_type: Optional[CreateOrderChargeOverrideBillingBillCycleTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billCycleType') }})
    billing_period: Optional[CreateOrderChargeOverrideBillingBillingPeriodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingPeriod') }})
    billing_period_alignment: Optional[CreateOrderChargeOverrideBillingBillingPeriodAlignmentEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingPeriodAlignment') }})
    billing_timing: Optional[CreateOrderChargeOverrideBillingBillingTimingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingTiming') }})
    ...
    weekly_bill_cycle_day: Optional[CreateOrderChargeOverrideBillingWeeklyBillCycleDayEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('weeklyBillCycleDay') }})
    

@dataclass_json
@dataclasses.dataclass
class CreateOrderChargeOverridePricing:
    r"""CreateOrderChargeOverridePricing
...
class CreateOrderChargeOverrideRevRecTriggerConditionEnum(str, Enum):
...
class CreateOrderChargeOverrideRevenueRecognitionRuleNameEnum(str, Enum):
...
@dataclass_json
@dataclasses.dataclass
class CreateOrderChargeOverride:
    r"""CreateOrderChargeOverride
    ...
    billing: Optional[CreateOrderChargeOverrideBilling] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billing') }})
    ...
    pricing: Optional[CreateOrderChargeOverridePricing] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pricing') }})
    ...
    rev_rec_trigger_condition: Optional[CreateOrderChargeOverrideRevRecTriggerConditionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('revRecTriggerCondition') }})
    revenue_recognition_rule_name: Optional[CreateOrderChargeOverrideRevenueRecognitionRuleNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('revenueRecognitionRuleName') }})
    start_date: Optional[shared_createordertriggerparams.CreateOrderTriggerParams] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('startDate') }})
