...
class GoogleCloudIdentitytoolkitV2StartMfaSignInResponse:
    ...
    phone_response_info: Optional[shared_googlecloudidentitytoolkitv2startmfaphoneresponseinfo.GoogleCloudIdentitytoolkitV2StartMfaPhoneResponseInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('phoneResponseInfo') }})
