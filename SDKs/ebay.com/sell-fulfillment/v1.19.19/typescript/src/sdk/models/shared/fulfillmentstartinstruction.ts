...
export class FulfillmentStartInstruction extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "ebaySupportedFulfillment" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "finalDestinationAddress" })
  @Type(() => Address)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "fulfillmentInstructionsType" })
