...
class ObjectDetectionResponse:
    ...
    probabilities: Optional[list[shared_detectionresult.DetectionResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('probabilities'), 'exclude': lambda f: f is None }})  
