...
type ContentCollectionsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentCollectionsDeletePathParams struct {
...
type ContentCollectionsDeleteQueryParams struct {
	// V1 error format.
...
type ContentCollectionsDeleteRequest struct {
...
type ContentCollectionsDeleteResponse struct {
	ContentType string
	StatusCode  int
