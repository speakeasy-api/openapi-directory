...
public class GetNetworkWirelessDataRateHistoryRequest {
    ...
    public String apTag;
    public GetNetworkWirelessDataRateHistoryRequest withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkWirelessDataRateHistoryRequest withAutoResolution(Boolean autoResolution) {
    ...
    public GetNetworkWirelessDataRateHistoryRequest withBand(GetNetworkWirelessDataRateHistoryBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkWirelessDataRateHistoryRequest withClientId(String clientId) {
    ...
    public GetNetworkWirelessDataRateHistoryRequest withDeviceSerial(String deviceSerial) {
    ...
    public GetNetworkWirelessDataRateHistoryRequest withNetworkId(String networkId) {
    ...
    public GetNetworkWirelessDataRateHistoryRequest withResolution(Long resolution) {
    ...
    public Long ssid;
    public GetNetworkWirelessDataRateHistoryRequest withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkWirelessDataRateHistoryRequest withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkWirelessDataRateHistoryRequest withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkWirelessDataRateHistoryRequest withTimespan(Float timespan) {
