...
exports.GetUsersIdWritePermissionsResponse = exports.GetUsersIdWritePermissionsRequest = void 0;
...
var GetUsersIdWritePermissionsRequest = /** @class */ (function (_super) {
    ...
    ], GetUsersIdWritePermissionsRequest.prototype, "callback", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetUsersIdWritePermissionsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetUsersIdWritePermissionsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetUsersIdWritePermissionsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetUsersIdWritePermissionsRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=site" }),
        __metadata("design:type", String)
    ], GetUsersIdWritePermissionsRequest.prototype, "site", void 0);
...
var GetUsersIdWritePermissionsResponse = /** @class */ (function (_super) {
    ...
    ], GetUsersIdWritePermissionsResponse.prototype, "rawResponse", void 0);
