...
import { FleetLaunchTemplateConfigListRequest } from "./fleetlaunchtemplateconfiglistrequest";
 ...
 */
export declare enum CreateFleetRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateFleetRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateFleetRequestTagSpecifications extends SpeakeasyBase {
