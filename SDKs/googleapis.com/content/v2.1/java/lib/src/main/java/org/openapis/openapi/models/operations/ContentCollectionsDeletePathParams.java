...
public class ContentCollectionsDeletePathParams {
    /**
    ...
    public ContentCollectionsDeletePathParams withCollectionId(String collectionId) {
    ...
    public ContentCollectionsDeletePathParams withMerchantId(String merchantId) {
