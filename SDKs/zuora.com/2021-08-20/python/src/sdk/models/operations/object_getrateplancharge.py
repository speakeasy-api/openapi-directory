...
from ..shared import proxygetrateplancharge as shared_proxygetrateplancharge
...
class ObjectGETRatePlanChargeResponse:
    ...
    proxy_get_rate_plan_charge: Optional[shared_proxygetrateplancharge.ProxyGetRatePlanCharge] = dataclasses.field(default=None)  
