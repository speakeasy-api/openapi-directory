...
var PresidentialSummary = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=candidate_contributions_less_repayments" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cash_on_hand_end" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=disbursements_less_offsets" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=individual_contributions_less_refunds" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pac_contributions_less_refunds" }),
        __metadata("design:type", Number)
    ], PresidentialSummary.prototype, "pacContributionsLessRefunds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=party_contributions_less_refunds" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_contribution_refunds" }),
        __metadata("design:type", Number)
    ], PresidentialSummary.prototype, "totalContributionRefunds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=total_loan_repayments_made" }),
        __metadata("design:type", Number)
    ], PresidentialSummary.prototype, "totalLoanRepaymentsMade", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transfers_from_affiliated_committees" }),
        __metadata("design:type", Number)
    ], PresidentialSummary.prototype, "transfersFromAffiliatedCommittees", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transfers_to_other_authorized_committees" }),
        __metadata("design:type", Number)
