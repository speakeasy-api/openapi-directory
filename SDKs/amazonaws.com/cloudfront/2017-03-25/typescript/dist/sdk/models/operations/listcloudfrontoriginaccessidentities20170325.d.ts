...
export declare class ListCloudFrontOriginAccessIdentities20170325Request extends SpeakeasyBase {
    /**
...
export declare class ListCloudFrontOriginAccessIdentities20170325Response extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
