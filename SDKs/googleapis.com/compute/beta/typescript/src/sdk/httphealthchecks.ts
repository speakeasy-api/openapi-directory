...
export class HttpHealthChecks {
  ...
  computeHttpHealthChecksTestIamPermissions(
    req: operations.ComputeHttpHealthChecksTestIamPermissionsRequest,
    security: operations.ComputeHttpHealthChecksTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeHttpHealthChecksTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComputeHttpHealthChecksTestIamPermissionsRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeHttpHealthChecksTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeHttpHealthChecksTestIamPermissionsResponse =
        new operations.ComputeHttpHealthChecksTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
