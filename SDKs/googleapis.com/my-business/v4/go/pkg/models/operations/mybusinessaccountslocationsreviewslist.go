...
type MybusinessAccountsLocationsReviewsListPathParams struct {
	// The name of the location to fetch reviews for.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type MybusinessAccountsLocationsReviewsListQueryParams struct {
	// V1 error format.
