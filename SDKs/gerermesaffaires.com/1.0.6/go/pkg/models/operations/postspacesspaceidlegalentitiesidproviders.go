...
func (e PostSpacesSpaceIDLegalEntitiesIDProvidersRequestBodyLevelEnum) ToPointer() *PostSpacesSpaceIDLegalEntitiesIDProvidersRequestBodyLevelEnum {
	return &e
}
...
func (e *PostSpacesSpaceIDLegalEntitiesIDProvidersRequestBodyLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "regular":
		fallthrough
	case "public":
		*e = PostSpacesSpaceIDLegalEntitiesIDProvidersRequestBodyLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesSpaceIDLegalEntitiesIDProvidersRequestBodyLevelEnum: %v", v)
	}
}
