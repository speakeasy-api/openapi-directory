...
public class ListingRecommendation {
     ...
     */
    public org.openapis.openapi.models.operations.FindListingRecommendationsResponse findListingRecommendations(org.openapis.openapi.models.operations.FindListingRecommendationsRequest request, org.openapis.openapi.models.operations.FindListingRecommendationsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/find");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "findListingRecommendationRequest", "json");
        req.setBody(serializedRequestBody);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.FindListingRecommendationsRequest.class, request, null);
        if (queryParams != null) {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                ...
                org.openapis.openapi.models.shared.PagedListingRecommendationCollection out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.PagedListingRecommendationCollection.class);
