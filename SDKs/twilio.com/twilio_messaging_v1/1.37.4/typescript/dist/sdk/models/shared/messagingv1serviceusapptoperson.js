...
var MessagingV1ServiceUsAppToPerson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=brand_registration_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=campaign_status" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=has_embedded_links" }),
        __metadata("design:type", Boolean)
    ], MessagingV1ServiceUsAppToPerson.prototype, "hasEmbeddedLinks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=has_embedded_phone" }),
        __metadata("design:type", Boolean)
    ], MessagingV1ServiceUsAppToPerson.prototype, "hasEmbeddedPhone", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=help_keywords" }),
        __metadata("design:type", Array)
    ], MessagingV1ServiceUsAppToPerson.prototype, "helpKeywords", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=help_message" }),
        __metadata("design:type", String)
    ], MessagingV1ServiceUsAppToPerson.prototype, "helpMessage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_externally_registered" }),
        __metadata("design:type", Boolean)
    ], MessagingV1ServiceUsAppToPerson.prototype, "isExternallyRegistered", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=message_flow" }),
        __metadata("design:type", String)
    ], MessagingV1ServiceUsAppToPerson.prototype, "messageFlow", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=message_samples" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=opt_in_keywords" }),
        __metadata("design:type", Array)
    ], MessagingV1ServiceUsAppToPerson.prototype, "optInKeywords", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=opt_in_message" }),
        __metadata("design:type", String)
    ], MessagingV1ServiceUsAppToPerson.prototype, "optInMessage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=opt_out_keywords" }),
        __metadata("design:type", Array)
    ], MessagingV1ServiceUsAppToPerson.prototype, "optOutKeywords", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=opt_out_message" }),
        __metadata("design:type", String)
    ], MessagingV1ServiceUsAppToPerson.prototype, "optOutMessage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rate_limits" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=us_app_to_person_usecase" }),
        __metadata("design:type", String)
