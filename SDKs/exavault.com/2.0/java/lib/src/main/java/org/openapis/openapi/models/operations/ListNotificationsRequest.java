...
public class ListNotificationsRequest {
    ...
    public ListNotificationsRequest withAction(ListNotificationsActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public ListNotificationsRequest withEvAccessToken(String evAccessToken) {
    ...
    public ListNotificationsRequest withEvApiKey(String evApiKey) {
    ...
    public ListNotificationsRequest withInclude(ListNotificationsIncludeEnum include) {
    ...
    public ListNotificationsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public ListNotificationsRequest withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public String sort;
    public ListNotificationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public ListNotificationsRequest withType(ListNotificationsTypeEnum type) {
        this.type = type;
        return this;
    }
