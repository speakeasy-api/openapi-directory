...
export class DisplayvideoPartnersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoPartnersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoPartnersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
