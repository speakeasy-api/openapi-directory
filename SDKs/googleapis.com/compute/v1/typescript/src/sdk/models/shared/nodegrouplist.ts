 ...
 */
export enum NodeGroupListWarningCodeEnum {
...
export class NodeGroupListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeGroupListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeGroupListWarningData })
  @Expose({ name: "data" })
