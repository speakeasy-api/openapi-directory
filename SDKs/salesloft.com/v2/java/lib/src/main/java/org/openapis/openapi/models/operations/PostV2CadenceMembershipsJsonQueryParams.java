...
public class PostV2CadenceMembershipsJsonQueryParams {
    /**
    ...
    public PostV2CadenceMembershipsJsonQueryParams withCadenceId(Long cadenceId) {
    ...
    public PostV2CadenceMembershipsJsonQueryParams withPersonId(Long personId) {
    ...
    public Long stepId;
    public PostV2CadenceMembershipsJsonQueryParams withStepId(Long stepId) {
        this.stepId = stepId;
        return this;
    }
    ...
    public Long userId;
    public PostV2CadenceMembershipsJsonQueryParams withUserId(Long userId) {
        this.userId = userId;
        return this;
    }
