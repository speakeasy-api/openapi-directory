...
class SubscribeRequestBillToContact:
    ...
    **Values**: a string of 100 characters or fewer
    ...
    r"""The Zuora account ID associated with this contact. This field is not required when you use the subscribe
    ...
    **Character limit**: 40 **Values: **a string of 40 characters or fewer
    ...
    r"""The country of the contact's address. This field is only required if you enbale taxation."""  
    ...
    r"""The country. May optionally be used by [Z-Tax](/C_Zuora_User_Guides/A_Billing_and_Payments/I_Taxes/Z-Tax) to calculate county tax.
    ...
    **Values**: a string of 32 characters or fewer
    ...
    r"""The ID of the Zuora user who created the contact.
    ...
    **Values**: automatically generated
    ...
    r"""The date when the contact was created.
    ...
    **Character limit:** 20 **Values: **a string of 20 characters or fewer
    ...
    r"""If using [Z-Tax](https://knowledgecenter.zuora.com/CB_Billing/J_Billing_Operations/L_Taxes/A_Z-Tax) tax rules"""  
