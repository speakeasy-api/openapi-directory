...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = "modi"            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckFollowingForUserRequest req = new UsersCheckFollowingForUserRequest("consequuntur", "assumenda");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCheckPersonIsFollowedByAuthenticatedRequest req = new UsersCheckPersonIsFollowedByAuthenticatedRequest("vero");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreateGpgKeyForAuthenticatedRequestBody req = new UsersCreateGpgKeyForAuthenticatedRequestBody("doloribus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersCreatePublicSshKeyForAuthenticatedRequestBody req = new UsersCreatePublicSshKeyForAuthenticatedRequestBody("impedit") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            org.openapis.openapi.models.. req = "accusamus"            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeleteGpgKeyForAuthenticatedRequest req = new UsersDeleteGpgKeyForAuthenticatedRequest(518990L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersDeletePublicSshKeyForAuthenticatedRequest req = new UsersDeletePublicSshKeyForAuthenticatedRequest(969168L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersFollowRequest req = new UsersFollowRequest("ab");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetByUsernameRequest req = new UsersGetByUsernameRequest("sint");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetContextForUserRequest req = new UsersGetContextForUserRequest("nihil") {{
                subjectId = "esse";
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetGpgKeyForAuthenticatedRequest req = new UsersGetGpgKeyForAuthenticatedRequest(485031L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersGetPublicSshKeyForAuthenticatedRequest req = new UsersGetPublicSshKeyForAuthenticatedRequest(202796L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowersForUserRequest req = new UsersListFollowersForUserRequest("distinctio") {{
                page = 262800L;
                perPage = 56372L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListFollowingForUserRequest req = new UsersListFollowingForUserRequest("rem") {{
                page = 978154L;
                perPage = 35160L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListGpgKeysForUserRequest req = new UsersListGpgKeysForUserRequest("neque") {{
                page = 816365L;
                perPage = 307173L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersListPublicKeysForUserRequest req = new UsersListPublicKeysForUserRequest("fugiat") {{
                page = 668577L;
                perPage = 962396L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UsersUnfollowRequest req = new UsersUnfollowRequest("nesciunt");            
