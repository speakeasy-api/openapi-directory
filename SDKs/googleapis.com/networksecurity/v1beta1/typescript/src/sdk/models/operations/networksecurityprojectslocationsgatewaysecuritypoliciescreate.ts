...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=gatewaySecurityPolicyId",
  })
...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
