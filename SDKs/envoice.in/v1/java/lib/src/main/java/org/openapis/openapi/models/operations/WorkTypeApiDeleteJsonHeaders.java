...
public class WorkTypeApiDeleteJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiDeleteJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiDeleteJsonHeaders withXAuthSecret(String xAuthSecret) {
