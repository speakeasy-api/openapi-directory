...
public class IpGeolocationWithConfidenceAreaApiQueryParams {
    /**
    ...
    public String ip;
    public IpGeolocationWithConfidenceAreaApiQueryParams withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public String key;
    public IpGeolocationWithConfidenceAreaApiQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public IpGeolocationWithConfidenceAreaApiQueryParams withLocalityLanguage(String localityLanguage) {
