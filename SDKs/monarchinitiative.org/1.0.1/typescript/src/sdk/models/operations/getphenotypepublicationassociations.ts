...
export class GetPhenotypePublicationAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPhenotypePublicationAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPhenotypePublicationAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPhenotypePublicationAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
