...
from ..shared import deletelocationresponse as shared_deletelocationresponse
...
@dataclasses.dataclass
class LocationsDeleteSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class LocationsDeleteRequest:
    headers: LocationsDeleteHeaders = dataclasses.field()
    path_params: LocationsDeletePathParams = dataclasses.field()
    query_params: LocationsDeleteQueryParams = dataclasses.field()
    security: LocationsDeleteSecurity = dataclasses.field()
    

@dataclasses.dataclass
class LocationsDeleteResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    delete_location_response: Optional[shared_deletelocationresponse.DeleteLocationResponse] = dataclasses.field(default=None)
