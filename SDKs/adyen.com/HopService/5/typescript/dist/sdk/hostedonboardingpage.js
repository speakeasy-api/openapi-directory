...
exports.HostedOnboardingPage = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var HostedOnboardingPage = /** @class */ (function () {
    function HostedOnboardingPage(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    HostedOnboardingPage.prototype.postGetOnboardingUrl = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostGetOnboardingUrlRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/getOnboardingUrl";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getOnboardingUrlResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
...
exports.HostedOnboardingPage = HostedOnboardingPage;
