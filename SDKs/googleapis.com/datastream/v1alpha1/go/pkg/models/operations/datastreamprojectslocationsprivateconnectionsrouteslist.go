...
type DatastreamProjectsLocationsPrivateConnectionsRoutesListPathParams struct {
	// Required. The parent that owns the collection of Routess.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatastreamProjectsLocationsPrivateConnectionsRoutesListQueryParams struct {
	// V1 error format.
