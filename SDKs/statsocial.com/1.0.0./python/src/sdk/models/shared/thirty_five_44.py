...
from ..shared import statistical_info_35 as shared_statistical_info_35
...
class ThirtyFive44:
    ...
    statistical_info: Optional[shared_statistical_info_35.StatisticalInfo35] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('statistical_info') }})
