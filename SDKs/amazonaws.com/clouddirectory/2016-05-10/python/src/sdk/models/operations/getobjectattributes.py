...
class GetObjectAttributesRequestBody:
    ...
    r"""List of attribute names whose values will be retrieved."""  
    object_reference: GetObjectAttributesRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
    schema_facet: GetObjectAttributesRequestBodySchemaFacet = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SchemaFacet') }})
    r"""A facet."""  
    
class GetObjectAttributesXAmzConsistencyLevelEnum(str, Enum):
    r"""The consistency level at which to retrieve the attributes on an object."""
...
class GetObjectAttributesRequest:
    ...
    request_body: GetObjectAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_data_partition: str = dataclasses.field(metadata={'header': { 'field_name': 'x-amz-data-partition', 'style': 'simple', 'explode': False }})
    r"""The Amazon Resource Name (ARN) that is associated with the <a>Directory</a> where the object resides."""  
