...
func main() {
    ...
    res, err := s.Registrations.RegistrationsChildrenList(ctx, operations.RegistrationsChildrenListRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsCitationRead(ctx, operations.RegistrationsCitationReadRequest{
        CitationID: "corporis",
        RegistrationID: "hic",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsCitationsList(ctx, operations.RegistrationsCitationsListRequest{
        RegistrationID: "libero",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsCommentsList(ctx, operations.RegistrationsCommentsListRequest{
        RegistrationID: "nobis",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsContributorsList(ctx, operations.RegistrationsContributorsListRequest{
        RegistrationID: "dolores",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsContributorsRead(ctx, operations.RegistrationsContributorsReadRequest{
        RegistrationID: "quis",
        UserID: "totam",
    })
    if err != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsFilesList(ctx, operations.RegistrationsFilesListRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsFilesRead(ctx, operations.RegistrationsFilesReadRequest{
        Path: "quis",
        Provider: "nesciunt",
        RegistrationID: "eos",
    })
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsForksCreate(ctx, operations.RegistrationsForksCreateRequest{
        RegistrationID: "perferendis",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsForksList(ctx, operations.RegistrationsForksListRequest{
        RegistrationID: "dolores",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsIdentifiersList(ctx, operations.RegistrationsIdentifiersListRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsInstitutionsList(ctx, operations.RegistrationsInstitutionsListRequest{
        RegistrationID: "quam",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsLinkedNodesList(ctx, operations.RegistrationsLinkedNodesListRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsList(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsLogsList(ctx, operations.RegistrationsLogsListRequest{
        RegistrationID: "vero",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsPartialUpdate(ctx, operations.RegistrationsPartialUpdateRequest{
        RegistrationID: "nostrum",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsProvidersList(ctx, operations.RegistrationsProvidersListRequest{
        RegistrationID: "hic",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsRead(ctx, operations.RegistrationsReadRequest{
        RegistrationID: "recusandae",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsViewOnlyLinksList(ctx, operations.RegistrationsViewOnlyLinksListRequest{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsViewOnlyLinksRead(ctx, operations.RegistrationsViewOnlyLinksReadRequest{
        LinkID: "facilis",
        RegistrationID: "perspiciatis",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Registrations.RegistrationsWikisList(ctx, operations.RegistrationsWikisListRequest{
        RegistrationID: "voluptatem",
    })
    if err != nil {
        log.Fatal(err)
    }
