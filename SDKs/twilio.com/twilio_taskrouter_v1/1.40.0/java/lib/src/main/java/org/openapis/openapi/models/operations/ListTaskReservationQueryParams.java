...
public class ListTaskReservationQueryParams {
    ...
    public Long page;
    public ListTaskReservationQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListTaskReservationQueryParams withPageToken(String pageToken) {
    ...
    public ListTaskReservationQueryParams withReservationStatus(org.openapis.openapi.models.shared.TaskReservationEnumStatusEnum reservationStatus) {
