...
class DestinyComponentsProfilesDestinyProfileTransitoryPartyMember:
    ...
    r"""The player's last known display name."""  
    emblem_hash: Optional[int] = dataclasses.field(default=None)
    r"""The identifier for the DestinyInventoryItemDefinition of the player's emblem."""  
    membership_id: Optional[int] = dataclasses.field(default=None)
    r"""The Membership ID that matches the party member."""  
    status: Optional[int] = dataclasses.field(default=None)
    r"""A Flags Enumeration value indicating the states that the player is in relevant to being on a fireteam."""  
