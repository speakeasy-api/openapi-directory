...
func main() {
    ...
    if res.ChatV1ServiceChannelInvite != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    if res.ChatV1ServiceChannelMember != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    if res.ChatV1ServiceChannelMessage != nil {
        // handle response
    }
}
```
