 ...
 * ~
 */
var NumberT = /** @class */ (function (_super) {
    __extends(NumberT, _super);
    function NumberT() {
    ...
    ], NumberT.prototype, "nationalFormat", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "number" }),
        __metadata("design:type", String)
    ], NumberT.prototype, "number", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    ], NumberT.prototype, "region", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sendEmailOnCreate" }),
        __metadata("design:type", Boolean)
    ], NumberT.prototype, "sendEmailOnCreate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "tollFree" }),
        __metadata("design:type", Boolean)
    ], NumberT.prototype, "tollFree", void 0);
    return NumberT;
