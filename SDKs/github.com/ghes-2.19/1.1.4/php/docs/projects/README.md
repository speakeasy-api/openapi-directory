...
try {
    ...
    $request->projectId = 906172;
    $request->username = 'Lily96';
...
try {
    ...
    $request->requestBody->name = 'Patricia Farrell';
    $request->owner = 'unde';
...
try {
    ...
    $request->projectId = 696483;
    $request->username = 'Ike_Schulist64';
...
try {
    ...
    $request->columnId = 29100;
    $request->page = 790840;
    $request->perPage = 919532;
...
try {
    ...
    $request->affiliation = ProjectsListCollaboratorsAffiliationEnum::OUTSIDE;
    $request->page = 542457;
    $request->perPage = 442036;
    $request->projectId = 991142;
...
try {
    ...
    $request->page = 519952;
    $request->perPage = 383103;
    $request->projectId = 693957;
...
try {
    ...
    $request->username = 'Erling_Collier';
...
try {
    ...
    $request->projectId = 621693;
    $request->username = 'Jo_Hoeger54';
