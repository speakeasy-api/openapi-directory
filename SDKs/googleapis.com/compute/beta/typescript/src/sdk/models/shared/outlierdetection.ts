...
export class OutlierDetection extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "consecutiveGatewayFailure" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enforcingConsecutiveErrors" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enforcingConsecutiveGatewayFailure" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enforcingSuccessRate" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "successRateMinimumHosts" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "successRateRequestVolume" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "successRateStdevFactor" })
