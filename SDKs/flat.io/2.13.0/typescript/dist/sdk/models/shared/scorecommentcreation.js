...
exports.ScoreCommentCreation = void 0;
...
**/
var ScoreCommentCreation = /** @class */ (function (_super) {
    __extends(ScoreCommentCreation, _super);
    function ScoreCommentCreation() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=comment" }),
        __metadata("design:type", String)
    ], ScoreCommentCreation.prototype, "comment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=context" }),
        __metadata("design:type", scorecommentcontext_1.ScoreCommentContext)
    ], ScoreCommentCreation.prototype, "context", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mentions" }),
        __metadata("design:type", Array)
    ], ScoreCommentCreation.prototype, "mentions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rawComment" }),
        __metadata("design:type", String)
    ], ScoreCommentCreation.prototype, "rawComment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=replyTo" }),
        __metadata("design:type", String)
    ], ScoreCommentCreation.prototype, "replyTo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=revision" }),
        __metadata("design:type", String)
    ], ScoreCommentCreation.prototype, "revision", void 0);
    return ScoreCommentCreation;
}(utils_1.SpeakeasyBase));
exports.ScoreCommentCreation = ScoreCommentCreation;
