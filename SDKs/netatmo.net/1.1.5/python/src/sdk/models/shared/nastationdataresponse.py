...
import dataclasses
from ..shared import nastationdatabody as shared_nastationdatabody
...
class NAStationDataResponse:
    ...
    body: Optional[shared_nastationdatabody.NAStationDataBody] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
