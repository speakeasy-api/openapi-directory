 ...
 */
export enum UrlMapListWarningCodeEnum {
...
export class UrlMapListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class UrlMapListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: UrlMapListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: UrlMapListWarningData })
  @Expose({ name: "data" })
  @Type(() => UrlMapListWarningData)
  data?: UrlMapListWarningData[];
 ...
 */
export class UrlMapList extends SpeakeasyBase {
  /**
