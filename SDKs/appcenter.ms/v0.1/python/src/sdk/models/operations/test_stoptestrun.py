...
class TestStopTestRunRequest:
    ...
    r"""The ID of the test run to be stopped"""  
...
class TestStopTestRunTestRun:
    ...
    stats: Optional[TestStopTestRunTestRunTestRunStatistics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stats'), 'exclude': lambda f: f is None }})
    r"""Summary single test run on Xamarin Test Cloud"""  
...
class TestStopTestRunResponse:
    ...
    test_run: Optional[TestStopTestRunTestRun] = dataclasses.field(default=None)
    r"""OK"""  
