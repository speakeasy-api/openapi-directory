...
class HouseholdIncomeTargetingOptionDetails:
    r"""HouseholdIncomeTargetingOptionDetails
    ...
    household_income: Optional[HouseholdIncomeTargetingOptionDetailsHouseholdIncomeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('householdIncome') }})
