...
class ChannelCatalogsSettings:
    ...
    def configure_channel_catalog_cost_settings(self, request: operations.ConfigureChannelCatalogCostSettingsRequest) -> operations.ConfigureChannelCatalogCostSettingsResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/channelCatalogs/{channelCatalogId}/settings/cost", request.path_params)
        ...
        res = operations.ConfigureChannelCatalogCostSettingsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def configure_channel_catalog_general_settings(self, request: operations.ConfigureChannelCatalogGeneralSettingsRequest) -> operations.ConfigureChannelCatalogGeneralSettingsResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/channelCatalogs/{channelCatalogId}/settings/general", request.path_params)
        ...
        res = operations.ConfigureChannelCatalogGeneralSettingsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def disable_channel_catalog(self, request: operations.DisableChannelCatalogRequest) -> operations.DisableChannelCatalogResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/channelCatalogs/{channelCatalogId}/disable", request.path_params)
        ...
        res = operations.DisableChannelCatalogResponse(status_code=r.status_code, content_type=content_type)
    ...
    def enable_channel_catalog(self, request: operations.EnableChannelCatalogRequest) -> operations.EnableChannelCatalogResponse:
        ...
        url = utils.generate_url(base_url, "/v2/user/channelCatalogs/{channelCatalogId}/enable", request.path_params)
        ...
        res = operations.EnableChannelCatalogResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 204:
            pass
        elif r.status_code == 402:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpgradeOfferRequired])
