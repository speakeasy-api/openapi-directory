...
class GetUpdateConfigurationSetTrackingOptionsTrackingOptions:
    r"""GetUpdateConfigurationSetTrackingOptionsTrackingOptions
...
class GetUpdateConfigurationSetTrackingOptionsQueryParams:
    action: GetUpdateConfigurationSetTrackingOptionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    tracking_options: GetUpdateConfigurationSetTrackingOptionsTrackingOptions = dataclasses.field(metadata={'query_param': { 'field_name': 'TrackingOptions', 'style': 'form', 'explode': True }})
    version: GetUpdateConfigurationSetTrackingOptionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUpdateConfigurationSetTrackingOptionsRequest:
    headers: GetUpdateConfigurationSetTrackingOptionsHeaders = dataclasses.field()
    query_params: GetUpdateConfigurationSetTrackingOptionsQueryParams = dataclasses.field()
