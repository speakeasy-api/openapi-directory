...
export class CreateDomesticStandingOrdersJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticStandingOrdersJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticStandingOrdersJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
