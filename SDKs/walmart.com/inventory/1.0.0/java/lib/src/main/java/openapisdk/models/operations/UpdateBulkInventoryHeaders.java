...
public class UpdateBulkInventoryHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public UpdateBulkInventoryHeaders withAuthorization(String authorization) {
    ...
    public UpdateBulkInventoryHeaders withWmConsumerChannelType(String wmCONSUMERCHANNELTYPE) {
    ...
    public UpdateBulkInventoryHeaders withWmQosCorrelationId(String wmQOSCORRELATIONID) {
    ...
    public UpdateBulkInventoryHeaders withWmSecAccessToken(String wmSECACCESSTOKEN) {
    ...
    public UpdateBulkInventoryHeaders withWmSvcName(String wmSVCNAME) {
