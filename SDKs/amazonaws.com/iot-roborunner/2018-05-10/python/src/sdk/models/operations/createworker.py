...
from ..shared import createworkerresponse as shared_createworkerresponse
...
class CreateWorkerRequestBodyOrientation:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CreateWorkerRequestBodyVendorProperties:
...
class CreateWorkerRequestBody:
    ...
    orientation: Optional[CreateWorkerRequestBodyOrientation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orientation'), 'exclude': lambda f: f is None }})
    r"""Worker orientation measured in units clockwise from north."""  
    position: Optional[CreateWorkerRequestBodyPosition] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('position'), 'exclude': lambda f: f is None }})
    r"""Supported coordinates for worker position."""  
    vendor_properties: Optional[CreateWorkerRequestBodyVendorProperties] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vendorProperties'), 'exclude': lambda f: f is None }})
    r"""Properties of the worker that are provided by the vendor FMS."""  
...
class CreateWorkerRequest:
    ...
    request_body: CreateWorkerRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CreateWorkerResponse:
    ...
    r"""ConflictException"""  
    create_worker_response: Optional[shared_createworkerresponse.CreateWorkerResponse] = dataclasses.field(default=None)
    r"""Success"""  
