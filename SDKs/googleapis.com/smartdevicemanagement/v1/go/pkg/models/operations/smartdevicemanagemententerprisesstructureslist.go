...
type SmartdevicemanagementEnterprisesStructuresListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SmartdevicemanagementEnterprisesStructuresListPathParams struct {
	// The parent enterprise to list structures under. E.g. "enterprises/XYZ".
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type SmartdevicemanagementEnterprisesStructuresListQueryParams struct {
	// V1 error format.
...
type SmartdevicemanagementEnterprisesStructuresListRequest struct {
...
type SmartdevicemanagementEnterprisesStructuresListResponse struct {
	ContentType string
	// Successful response
