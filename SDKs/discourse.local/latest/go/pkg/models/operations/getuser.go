...
type GetUser200ApplicationJSONUserGroupUsers struct {
...
type GetUser200ApplicationJSONUserGroups struct {
...
type GetUser200ApplicationJSONUserUserAuthTokens struct {
...
type GetUser200ApplicationJSONUserUserFields struct {
	One string `json:"1"`
	Two string `json:"2"`
}

type GetUser200ApplicationJSONUserUserNotificationSchedule struct {
...
type GetUser200ApplicationJSONUserUserOption struct {
...
type GetUser200ApplicationJSONUser struct {
	...
	CreatedAt                    string                                                `json:"created_at"`
	CustomFields                 GetUser200ApplicationJSONUserCustomFields             `json:"custom_fields"`
	...
	FlairURL                     string                                                `json:"flair_url"`
	GroupUsers                   []GetUser200ApplicationJSONUserGroupUsers             `json:"group_users"`
	Groups                       []GetUser200ApplicationJSONUserGroups                 `json:"groups"`
	...
	UserAuthTokens               []GetUser200ApplicationJSONUserUserAuthTokens         `json:"user_auth_tokens"`
	UserFields                   *GetUser200ApplicationJSONUserUserFields              `json:"user_fields,omitempty"`
	UserNotificationSchedule     GetUser200ApplicationJSONUserUserNotificationSchedule `json:"user_notification_schedule"`
	UserOption                   GetUser200ApplicationJSONUserUserOption               `json:"user_option"`
...
type GetUser200ApplicationJSON struct {
	User       GetUser200ApplicationJSONUser `json:"user"`
