...
class TaskDependencies:
    ...
    r"""The list of task ranges that must complete before this task can be scheduled."""  
    ...
    r"""The list of task ids that must complete before this task can be scheduled."""  
