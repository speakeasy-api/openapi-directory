...
var BankAccounts = /** @class */ (function () {
    ...
    **/
    BankAccounts.prototype.createBankAccount = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/api/v1/applications/{application_id}/bank_accounts", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.bankAccountResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    BankAccounts.prototype.deleteBankAccount = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/v1/applications/{application_id}/bank_accounts/{bank_account_id}/{version}", req.pathParams);
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.bankAccountPaginatedResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    BankAccounts.prototype.getBankAccount = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/v1/applications/{application_id}/bank_accounts/{bank_account_id}", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
