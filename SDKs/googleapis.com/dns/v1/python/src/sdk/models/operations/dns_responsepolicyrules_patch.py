...
@dataclasses.dataclass
class DNSResponsePolicyRulesPatchQueryParams:
...
class DNSResponsePolicyRulesPatchRequest:
    path_params: DNSResponsePolicyRulesPatchPathParams = dataclasses.field()
    query_params: DNSResponsePolicyRulesPatchQueryParams = dataclasses.field()
    security: DNSResponsePolicyRulesPatchSecurity = dataclasses.field()
