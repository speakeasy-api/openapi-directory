...
var PersonList = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "contact_cell" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "contact_tel" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "person_guid" }),
        __metadata("design:type", String)
    ], PersonList.prototype, "personGuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: registrationslist_1.RegistrationsList }),
        (0, class_transformer_1.Expose)({ name: "registrations" }),
        (0, class_transformer_1.Type)(function () { return registrationslist_1.RegistrationsList; }),
