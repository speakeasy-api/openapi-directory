...
public class GetOrganizationApiRequestsQueryParams {
    ...
    public GetOrganizationApiRequestsQueryParams withMethod(GetOrganizationApiRequestsMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public GetOrganizationApiRequestsQueryParams withOperationIds(String[] operationIds) {
    ...
    public GetOrganizationApiRequestsQueryParams withUserAgent(String userAgent) {
    ...
    public GetOrganizationApiRequestsQueryParams withVersion(GetOrganizationApiRequestsVersionEnum version) {
