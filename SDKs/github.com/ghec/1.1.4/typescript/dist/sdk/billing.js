...
var Billing = /** @class */ (function () {
    ...
    Billing.prototype.billingGetGithubActionsBillingGhe = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/enterprises/{enterprise}/settings/billing/actions", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.BillingGetGithubActionsBillingGheResponse({
    ...
    Billing.prototype.billingGetGithubPackagesBillingGhe = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/enterprises/{enterprise}/settings/billing/packages", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.BillingGetGithubPackagesBillingGheResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    Billing.prototype.billingGetSharedStorageBillingGhe = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/enterprises/{enterprise}/settings/billing/shared-storage", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.BillingGetSharedStorageBillingGheResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
