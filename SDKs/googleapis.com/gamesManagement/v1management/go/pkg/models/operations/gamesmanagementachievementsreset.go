...
type GamesManagementAchievementsResetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GamesManagementAchievementsResetPathParams struct {
	// The ID of the achievement used by this method.
	AchievementID string `pathParam:"style=simple,explode=false,name=achievementId"`
}

type GamesManagementAchievementsResetQueryParams struct {
	// V1 error format.
...
type GamesManagementAchievementsResetRequest struct {
...
type GamesManagementAchievementsResetResponse struct {
	// Successful response
