...
public class GetBandwidthSnapshotsRequest {
    ...
    public GetBandwidthSnapshotsRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetBandwidthSnapshotsRequest withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetBandwidthSnapshotsRequest withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetBandwidthSnapshotsRequest withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetBandwidthSnapshotsRequest withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetBandwidthSnapshotsRequest withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetBandwidthSnapshotsRequest withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetBandwidthSnapshotsRequest withPerPage(Integer perPage) {
    ...
    public GetBandwidthSnapshotsRequest withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
