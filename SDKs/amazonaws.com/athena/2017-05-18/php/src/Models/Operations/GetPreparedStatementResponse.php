...
class GetPreparedStatementResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetPreparedStatementOutput $getPreparedStatementOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetPreparedStatementOutput $getPreparedStatementOutput = null;
	...
	{
		$this->contentType = "";
		$this->getPreparedStatementOutput = null;
