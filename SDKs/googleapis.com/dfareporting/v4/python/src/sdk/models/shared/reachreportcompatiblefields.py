...
class ReachReportCompatibleFields:
    ...
    reach_by_frequency_metrics: Optional[list[shared_metric.Metric]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reachByFrequencyMetrics') }})
