...
class ContentDatafeedstatusesGetRequest:
    path_params: ContentDatafeedstatusesGetPathParams = dataclasses.field()
    query_params: ContentDatafeedstatusesGetQueryParams = dataclasses.field()
    security: ContentDatafeedstatusesGetSecurity = dataclasses.field()
