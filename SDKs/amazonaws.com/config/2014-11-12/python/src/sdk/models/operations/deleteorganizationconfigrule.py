...
class DeleteOrganizationConfigRuleRequest:
    ...
    delete_organization_config_rule_request: shared_deleteorganizationconfigrulerequest.DeleteOrganizationConfigRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
