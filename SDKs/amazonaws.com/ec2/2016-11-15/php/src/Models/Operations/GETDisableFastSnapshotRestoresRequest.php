...
class GETDisableFastSnapshotRestoresRequest
{
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETDisableFastSnapshotRestoresActionEnum::DISABLE_FAST_SNAPSHOT_RESTORES;
		$this->availabilityZone = [];
		$this->dryRun = null;
		$this->sourceSnapshotId = [];
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETDisableFastSnapshotRestoresVersionEnum::TWO_THOUSAND_AND_SIXTEEN1115;
