...
class GETListVirtualMFADevicesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GETListVirtualMFADevicesAssignmentStatusEnum $assignmentStatus
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=AssignmentStatus')]
    public ?GETListVirtualMFADevicesAssignmentStatusEnum $assignmentStatus = null;
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETListVirtualMFADevicesActionEnum::LIST_VIRTUAL_MFA_DEVICES;
		$this->assignmentStatus = null;
		$this->marker = null;
		$this->maxItems = null;
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETListVirtualMFADevicesVersionEnum::TWO_THOUSAND_AND_TEN0508;
