 ...
 */
public enum CreateInstanceExportTaskRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateInstanceExportTaskRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
