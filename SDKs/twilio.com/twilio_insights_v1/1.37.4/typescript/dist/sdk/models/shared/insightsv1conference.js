...
var InsightsV1Conference = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connect_duration_seconds" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=detected_issues" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ended_by" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max_concurrent_participants" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mixer_region" }),
        __metadata("design:type", String)
    ], InsightsV1Conference.prototype, "mixerRegion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mixer_region_requested" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=recording_enabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tag_info" }),
        __metadata("design:type", Object)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=unique_participants" }),
        __metadata("design:type", Number)
