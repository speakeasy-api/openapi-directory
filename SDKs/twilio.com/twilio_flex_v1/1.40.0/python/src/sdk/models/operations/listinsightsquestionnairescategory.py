...
LIST_INSIGHTS_QUESTIONNAIRES_CATEGORY_SERVERS = [
	"https://flex-api.twilio.com",
]


@dataclasses.dataclass
class ListInsightsQuestionnairesCategorySecurity:
...
class ListInsightsQuestionnairesCategoryListInsightsQuestionnairesCategoryResponse:
    ...
    categories: Optional[list[shared_flex_v1_insights_questionnaires_category.FlexV1InsightsQuestionnairesCategory]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('categories'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListInsightsQuestionnairesCategoryListInsightsQuestionnairesCategoryResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
...
class ListInsightsQuestionnairesCategoryResponse:
    ...
    list_insights_questionnaires_category_response: Optional[ListInsightsQuestionnairesCategoryListInsightsQuestionnairesCategoryResponse] = dataclasses.field(default=None)
    r"""OK"""  
