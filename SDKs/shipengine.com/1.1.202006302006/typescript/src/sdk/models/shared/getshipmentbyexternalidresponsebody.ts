...
**/
export class GetShipmentByExternalIdResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
...
**/
export class GetShipmentByExternalIdResponseBodyWeight extends SpeakeasyBase {
 ...
 * 
**/
export class GetShipmentByExternalIdResponseBody extends SpeakeasyBase {
