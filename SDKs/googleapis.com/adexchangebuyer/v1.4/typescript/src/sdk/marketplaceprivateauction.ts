...
export class Marketplaceprivateauction {
  ...
  **/
  adexchangebuyerMarketplaceprivateauctionUpdateproposal(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.AdexchangebuyerMarketplaceprivateauctionUpdateproposalResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
