...
class ProjectApi 
{
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{projectId}/export', \OpenAPI\OpenAPI\Models\Operations\ExportProjectRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->projectExport = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ProjectExport', 'json');
            }
            if (Utils\Utils::matchContentType($contentType, 'application/xml')) {
                $response->body = $httpResponse->getBody()->getContents();
            }
     ...
     * Imports a project.
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ImportProjectRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ImportProjectResponse
     */
	public function importProject(
        \OpenAPI\OpenAPI\Models\Operations\ImportProjectRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ImportProjectResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/import');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ImportProjectRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('POST', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\ImportProjectResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\TrainProjectFormRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\TrainProjectFormResponse
     */
	public function trainProjectForm(
        \OpenAPI\OpenAPI\Models\Operations\TrainProjectFormRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\TrainProjectFormResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{projectId}/train', \OpenAPI\OpenAPI\Models\Operations\TrainProjectFormRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "trainingParameters", "form");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\TrainProjectFormRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('POST', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\TrainProjectFormResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * Queues project for training.
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\TrainProjectJsonRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\TrainProjectJsonResponse
     */
	public function trainProjectJson(
        \OpenAPI\OpenAPI\Models\Operations\TrainProjectJsonRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\TrainProjectJsonResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{projectId}/train', \OpenAPI\OpenAPI\Models\Operations\TrainProjectJsonRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "trainingParameters", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\TrainProjectJsonRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('POST', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\TrainProjectJsonResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * Queues project for training.
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\TrainProjectRawRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\TrainProjectRawResponse
     */
	public function trainProjectRaw(
        \OpenAPI\OpenAPI\Models\Operations\TrainProjectRawRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\TrainProjectRawResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{projectId}/train', \OpenAPI\OpenAPI\Models\Operations\TrainProjectRawRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "requestBody", "raw");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\TrainProjectRawRequest::class, $request, null));
        
        $httpResponse = $this->_securityClient->request('POST', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\TrainProjectRawResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
