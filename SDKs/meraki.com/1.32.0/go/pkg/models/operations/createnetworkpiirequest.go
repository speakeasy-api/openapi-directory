...
func (e CreateNetworkPiiRequestRequestBodyTypeEnum) ToPointer() *CreateNetworkPiiRequestRequestBodyTypeEnum {
	return &e
}
...
func (e *CreateNetworkPiiRequestRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "restrict processing":
		*e = CreateNetworkPiiRequestRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateNetworkPiiRequestRequestBodyTypeEnum: %v", v)
	}
}
