...
class DescribeCapacityReservationFleetsRequestFilters:
...
class DescribeCapacityReservationFleetsRequest:
    ...
    capacity_reservation_fleet_ids: Optional[list[str]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeCapacityReservationFleetsRequestFilters]] = dataclasses.field(default=None)  
