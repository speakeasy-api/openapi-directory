...
from ..shared import deleteticketresponse as shared_deleteticketresponse
...
class CollectionTicketsDeleteSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CollectionTicketsDeleteRequest:
...
@dataclasses.dataclass
class CollectionTicketsDeleteResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    delete_ticket_response: Optional[shared_deleteticketresponse.DeleteTicketResponse] = dataclasses.field(default=None)
    r"""Delete a Ticket"""  
