...
type ClassifyImageURLWithNoStoreFormPathParams struct {
	// The project id.
...
type ClassifyImageURLWithNoStoreFormQueryParams struct {
	// Optional. Specifies the name of application using the endpoint.
	Application *string `queryParam:"style=form,explode=true,name=application"`
}

type ClassifyImageURLWithNoStoreFormRequest struct {
	PathParams  ClassifyImageURLWithNoStoreFormPathParams
	QueryParams ClassifyImageURLWithNoStoreFormQueryParams
...
type ClassifyImageURLWithNoStoreFormResponse struct {
	Body        []byte
	ContentType string
	// Error response
