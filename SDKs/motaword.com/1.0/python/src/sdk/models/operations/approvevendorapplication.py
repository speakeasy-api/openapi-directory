...
class ApproveVendorApplicationPathParams:
...
class ApproveVendorApplicationRequest:
    path_params: ApproveVendorApplicationPathParams = dataclasses.field()
    security: ApproveVendorApplicationSecurity = dataclasses.field()
