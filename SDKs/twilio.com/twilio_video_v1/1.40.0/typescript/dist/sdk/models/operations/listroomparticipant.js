...
exports.ListRoomParticipantResponse = exports.ListRoomParticipantListRoomParticipantResponse = exports.ListRoomParticipantListRoomParticipantResponseMeta = exports.ListRoomParticipantRequest = exports.ListRoomParticipantSecurity = exports.ListRoomParticipantServerList = void 0;
...
var ListRoomParticipantSecurity = /** @class */ (function (_super) {
    ...
    ], ListRoomParticipantSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListRoomParticipantSecurity.prototype, "username", void 0);
...
var ListRoomParticipantRequest = /** @class */ (function (_super) {
    ...
    ], ListRoomParticipantRequest.prototype, "dateCreatedAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DateCreatedBefore;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ListRoomParticipantRequest.prototype, "dateCreatedBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Identity",
        }),
        __metadata("design:type", String)
    ], ListRoomParticipantRequest.prototype, "identity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListRoomParticipantRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListRoomParticipantRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListRoomParticipantRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RoomSid",
        }),
        __metadata("design:type", String)
    ], ListRoomParticipantRequest.prototype, "roomSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListRoomParticipantRequest.prototype, "status", void 0);
...
var ListRoomParticipantListRoomParticipantResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListRoomParticipantListRoomParticipantResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.VideoV1RoomRoomParticipant }),
        (0, class_transformer_1.Expose)({ name: "participants" }),
        (0, class_transformer_1.Type)(function () { return shared.VideoV1RoomRoomParticipant; }),
...
var ListRoomParticipantResponse = /** @class */ (function (_super) {
    ...
    ], ListRoomParticipantResponse.prototype, "rawResponse", void 0);
