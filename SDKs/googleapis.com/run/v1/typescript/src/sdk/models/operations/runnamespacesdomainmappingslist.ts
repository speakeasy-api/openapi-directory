...
export class RunNamespacesDomainmappingsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesDomainmappingsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesDomainmappingsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
