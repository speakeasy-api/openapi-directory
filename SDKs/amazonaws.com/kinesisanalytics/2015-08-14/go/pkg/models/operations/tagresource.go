...
const (
	TagResourceXAmzTargetEnumKinesisAnalytics20150814TagResource TagResourceXAmzTargetEnum = "KinesisAnalytics_20150814.TagResource"
)
...
func (e *TagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "KinesisAnalytics_20150814.TagResource":
