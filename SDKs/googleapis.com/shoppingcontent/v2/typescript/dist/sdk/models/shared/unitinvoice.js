...
var UnitInvoice = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: unitinvoiceadditionalcharge_1.UnitInvoiceAdditionalCharge }),
        (0, class_transformer_1.Expose)({ name: "additionalCharges" }),
        (0, class_transformer_1.Type)(function () { return unitinvoiceadditionalcharge_1.UnitInvoiceAdditionalCharge; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "unitPricePretax" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: unitinvoicetaxline_1.UnitInvoiceTaxLine }),
        (0, class_transformer_1.Expose)({ name: "unitPriceTaxes" }),
        (0, class_transformer_1.Type)(function () { return unitinvoicetaxline_1.UnitInvoiceTaxLine; }),
        __metadata("design:type", Array)
