...
var LoginSecurity = /** @class */ (function () {
    function LoginSecurity(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Returns the login security settings for an organization.
     */
    LoginSecurity.prototype.getOrganizationLoginSecurity = function (req, config) {
     ...
     * Update the login security settings for an organization
     */
    LoginSecurity.prototype.updateOrganizationLoginSecurity = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
