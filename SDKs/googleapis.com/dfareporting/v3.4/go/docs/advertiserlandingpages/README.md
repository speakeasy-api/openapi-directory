            ...
            DeepLinks: []shared.DeepLink{
                shared.DeepLink{
                    ...
                    MobileApp: &shared.MobileApp{
                        Directory: shared.MobileAppDirectoryEnumAmazonFiretvAppStore.ToPointer(),
                ...
                shared.DeepLink{
                    ...
                    MobileApp: &shared.MobileApp{
                        Directory: shared.MobileAppDirectoryEnumSamsungTvAppStore.ToPointer(),
        ...
        LandingPage: &shared.LandingPage{
            ...
            DeepLinks: []shared.DeepLink{
                shared.DeepLink{
                    ...
                    MobileApp: &shared.MobileApp{
                        Directory: shared.MobileAppDirectoryEnumAppleTvAppStore.ToPointer(),
