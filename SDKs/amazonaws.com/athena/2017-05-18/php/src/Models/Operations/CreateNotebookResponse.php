...
class CreateNotebookResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateNotebookOutput $createNotebookOutput
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\CreateNotebookOutput $createNotebookOutput = null;
	...
	{
		$this->contentType = "";
		$this->createNotebookOutput = null;
