...
public class ListTagsForResourceRequest {
    ...
    public ListTagsForResourceRequestBody requestBody;

    public ListTagsForResourceRequest withRequestBody(ListTagsForResourceRequestBody requestBody) {
    ...
    public ListTagsForResourceRequest(@JsonProperty("RequestBody") ListTagsForResourceRequestBody requestBody) {
        this.requestBody = requestBody;
  }
}
