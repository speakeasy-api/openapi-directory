...
class GetMeQuestionsNoAnswersOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeQuestionsNoAnswersSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
class GetMeQuestionsNoAnswersQueryParams:
    ...
    order: Optional[GetMeQuestionsNoAnswersOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeQuestionsNoAnswersSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeQuestionsNoAnswersRequest:
    query_params: GetMeQuestionsNoAnswersQueryParams = dataclasses.field()
