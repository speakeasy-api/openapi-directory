...
public class ErrorsDeleteErrorRequest {
    ...
    public ErrorsDeleteErrorRequest(@JsonProperty("app_name") String appName, @JsonProperty("errorGroupId") String errorGroupId, @JsonProperty("errorId") String errorId, @JsonProperty("owner_name") String ownerName) {
        this.appName = appName;
        this.errorGroupId = errorGroupId;
        this.errorId = errorId;
        this.ownerName = ownerName;
