...
class DevicesBySubType:
    ...
    def devices_by_sub_type_get(self, request: operations.DevicesBySubTypeGetRequest) -> operations.DevicesBySubTypeGetResponse:
        ...
        query_params = utils.get_query_params(operations.DevicesBySubTypeGetRequest, request)
        ...
        res = operations.DevicesBySubTypeGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
