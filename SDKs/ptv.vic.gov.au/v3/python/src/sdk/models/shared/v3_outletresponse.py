...
class V3OutletResponse:
    ...
    outlets: Optional[list[shared_v3_outlet.V3Outlet]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('outlets'), 'exclude': lambda f: f is None }})
