...
class ListVoiceCountryListVoiceCountryResponse:
    ...
    countries: Optional[list[shared_pricing_v1_voice_voice_country.PricingV1VoiceVoiceCountry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countries'), 'exclude': lambda f: f is None }})  
