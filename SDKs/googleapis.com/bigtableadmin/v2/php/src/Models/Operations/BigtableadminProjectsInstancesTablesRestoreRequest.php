...
class BigtableadminProjectsInstancesTablesRestoreRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\RestoreTableRequest $restoreTableRequest = null;
