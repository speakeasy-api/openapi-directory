...
class APICoreDtoGrantsGrant:
    ...
    entity: Optional[shared_api_core_responses_entityuri_system_int64_.APICoreResponsesEntityURISystemInt64] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Entity'), 'exclude': lambda f: f is None }})  
