...
class GETDebitMemoTypewithSuccessStatusEnum(str, Enum):
...
class GETDebitMemoTypewithSuccessTaxStatusEnum(str, Enum):
...
class GETDebitMemoTypewithSuccessTransferredToAccountingEnum(str, Enum):
...
class GETDebitMemoTypewithSuccess:
    ...
    r"""The applied amount of the debit memo."""  
    ...
    status: Optional[GETDebitMemoTypewithSuccessStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the debit memo."""  
    ...
    tax_status: Optional[GETDebitMemoTypewithSuccessTaxStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxStatus'), 'exclude': lambda f: f is None }})
    r"""The status of tax calculation related to the debit memo.
    ...
    **Note**: This field is only applicable to tax calculation by third-party tax engines.
    ...
    transferred_to_accounting: Optional[GETDebitMemoTypewithSuccessTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the debit memo was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite."""  
    ...
    r"""The date and time when the debit memo was last updated, in `yyyy-mm-dd hh:mm:ss` format. For example, 2017-03-02 15:31:10."""  
