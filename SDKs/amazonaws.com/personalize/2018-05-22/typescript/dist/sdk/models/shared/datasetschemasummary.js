...
exports.DatasetSchemaSummary = void 0;
...
**/
var DatasetSchemaSummary = /** @class */ (function (_super) {
    __extends(DatasetSchemaSummary, _super);
    ...
    ], DatasetSchemaSummary.prototype, "creationDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lastUpdatedDateTime" }),
        __metadata("design:type", Date)
    ], DatasetSchemaSummary.prototype, "lastUpdatedDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], DatasetSchemaSummary.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=schemaArn" }),
        __metadata("design:type", String)
    ], DatasetSchemaSummary.prototype, "schemaArn", void 0);
