...
class GetTransitGatewayPrefixListReferencesRequestFilters:
...
class GetTransitGatewayPrefixListReferencesRequest:
    ...
    filters: Optional[list[GetTransitGatewayPrefixListReferencesRequestFilters]] = dataclasses.field(default=None)  
