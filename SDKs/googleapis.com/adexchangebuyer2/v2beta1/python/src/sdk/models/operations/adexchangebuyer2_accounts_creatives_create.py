...
class Adexchangebuyer2AccountsCreativesCreateDuplicateIDModeEnum(str, Enum):
    r"""Indicates if multiple creatives can share an ID or not. Default is NO_DUPLICATES (one ID per creative)."""
...
class Adexchangebuyer2AccountsCreativesCreateRequest:
    ...
    r"""JSONP"""  
    creative: Optional[shared_creative.Creative] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
