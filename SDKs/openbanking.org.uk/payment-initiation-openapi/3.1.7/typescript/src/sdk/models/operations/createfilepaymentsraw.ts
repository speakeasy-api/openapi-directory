...
export class CreateFilePaymentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateFilePaymentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateFilePaymentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
