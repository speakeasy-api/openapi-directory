...
exports.GetAdvancedTeamSeasonStatsResponse = exports.GetAdvancedTeamSeasonStatsRequest = void 0;
...
var GetAdvancedTeamSeasonStatsRequest = /** @class */ (function (_super) {
    ...
    ], GetAdvancedTeamSeasonStatsRequest.prototype, "endWeek", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=excludeGarbageTime",
        }),
        __metadata("design:type", Boolean)
    ], GetAdvancedTeamSeasonStatsRequest.prototype, "excludeGarbageTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startWeek",
        }),
        __metadata("design:type", Number)
    ], GetAdvancedTeamSeasonStatsRequest.prototype, "startWeek", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=team" }),
        __metadata("design:type", String)
    ], GetAdvancedTeamSeasonStatsRequest.prototype, "team", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=year" }),
        __metadata("design:type", Number)
    ], GetAdvancedTeamSeasonStatsRequest.prototype, "year", void 0);
    return GetAdvancedTeamSeasonStatsRequest;
}(utils_1.SpeakeasyBase));
exports.GetAdvancedTeamSeasonStatsRequest = GetAdvancedTeamSeasonStatsRequest;
var GetAdvancedTeamSeasonStatsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AdvancedSeasonStat }),
    ...
    ], GetAdvancedTeamSeasonStatsResponse.prototype, "rawResponse", void 0);
    return GetAdvancedTeamSeasonStatsResponse;
}(utils_1.SpeakeasyBase));
exports.GetAdvancedTeamSeasonStatsResponse = GetAdvancedTeamSeasonStatsResponse;
