...
public class PaymentLinkApiNewRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PaymentLinkApiNewRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public PaymentLinkApiNewRawHeaders withXAuthSecret(String xAuthSecret) {
