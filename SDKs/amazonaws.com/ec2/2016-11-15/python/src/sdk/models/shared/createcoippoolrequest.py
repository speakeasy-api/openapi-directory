...
class CreateCoipPoolRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateCoipPoolRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
class CreateCoipPoolRequestTagSpecifications:
    ...
    resource_type: Optional[CreateCoipPoolRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateCoipPoolRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateCoipPoolRequest:
    ...
    tag_specifications: Optional[list[CreateCoipPoolRequestTagSpecifications]] = dataclasses.field(default=None)  
