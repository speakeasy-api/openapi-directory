...
class StartFaceDetectionRequest
{
	...
	#[\JMS\Serializer\Annotation\SerializedName('FaceAttributes')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\FaceAttributesEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?FaceAttributesEnum $faceAttributes = null;
