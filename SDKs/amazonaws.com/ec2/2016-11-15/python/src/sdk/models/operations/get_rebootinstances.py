...
class GETRebootInstancesVersionEnum(str, Enum):
...
class GETRebootInstancesRequest:
    ...
    action: GETRebootInstancesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    instance_id: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'InstanceId', 'style': 'form', 'explode': True }})
    r"""The instance IDs."""  
    version: GETRebootInstancesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
