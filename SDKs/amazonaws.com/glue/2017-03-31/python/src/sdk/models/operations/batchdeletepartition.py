...
class BatchDeletePartitionRequest:
    ...
    batch_delete_partition_request: shared_batchdeletepartitionrequest.BatchDeletePartitionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
