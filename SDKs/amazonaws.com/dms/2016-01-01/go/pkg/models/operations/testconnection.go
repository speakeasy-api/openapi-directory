...
func (e TestConnectionXAmzTargetEnum) ToPointer() *TestConnectionXAmzTargetEnum {
	return &e
}
...
func (e *TestConnectionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonDMSv20160101.TestConnection":
		*e = TestConnectionXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TestConnectionXAmzTargetEnum: %v", v)
	}
}
