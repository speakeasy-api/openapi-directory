...
class TargetableRemarketingList:
    ...
    list_source: Optional[TargetableRemarketingListListSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('listSource') }})
