...
public class QueryAPI {
    ...
    public org.openapis.openapi.models.operations.PostSimpleQueryResponse postSimpleQuery(org.openapis.openapi.models.operations.PostSimpleQueryRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.PostSimpleQueryQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
