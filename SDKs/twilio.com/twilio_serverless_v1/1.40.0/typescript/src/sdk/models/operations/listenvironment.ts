...
export class ListEnvironmentListEnvironmentResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ServerlessV1ServiceEnvironment })
  @Expose({ name: "environments" })
  @Type(() => shared.ServerlessV1ServiceEnvironment)
  environments?: shared.ServerlessV1ServiceEnvironment[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListEnvironmentListEnvironmentResponseMeta)
