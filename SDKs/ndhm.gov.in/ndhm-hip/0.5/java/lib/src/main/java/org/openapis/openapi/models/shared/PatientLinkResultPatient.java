...
public class PatientLinkResultPatient {
    ...
    public PatientLinkResultPatient(@JsonProperty("careContexts") CareContextRepresentation[] careContexts, @JsonProperty("display") String display, @JsonProperty("referenceNumber") String referenceNumber) {
        this.careContexts = careContexts;
        this.display = display;
        this.referenceNumber = referenceNumber;
  }
