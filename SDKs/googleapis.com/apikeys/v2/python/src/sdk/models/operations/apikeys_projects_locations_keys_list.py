...
class ApikeysProjectsLocationsKeysListRequest:
    ...
    r"""Required. Lists all API keys associated with this project."""  
    ...
    r"""Optional. Specifies the maximum number of results to be returned at a time."""  
    page_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'pageToken', 'style': 'form', 'explode': True }})
    r"""Optional. Requests a specific page of results."""  
    ...
    r"""Optional. Indicate that keys deleted in the past 30 days should also be returned."""  
