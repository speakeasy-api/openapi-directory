...
public class Company {
    ...
    public Company withDataConnections(Connection[] dataConnections) {
    ...
    public Company(@JsonProperty("id") String id, @JsonProperty("name") String name, @JsonProperty("redirect") String redirect) {
        this.id = id;
        this.name = name;
        this.redirect = redirect;
  }
