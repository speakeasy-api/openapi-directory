...
export class DocumentaiProjectsLocationsProcessorsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DocumentaiProjectsLocationsProcessorsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DocumentaiProjectsLocationsProcessorsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
