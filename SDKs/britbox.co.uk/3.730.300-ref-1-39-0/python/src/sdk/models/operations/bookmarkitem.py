...
from ..shared import bookmark as shared_bookmark
...
class BookmarkItemRequest:
    ...
    r"""The id of the item to bookmark."""  
...
class BookmarkItemResponse:
    ...
    bookmark: Optional[shared_bookmark.Bookmark] = dataclasses.field(default=None)
    r"""Bookmark created."""  
