...
class Shares:
    ...
    def add_share(self, request: operations.AddShareRequest) -> operations.AddShareResponse:
        ...
        **Notes:**
        ...
        res = operations.AddShareResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ShareResponse])
    ...
    def complete_direct_send(self, request: operations.CompleteDirectSendRequest) -> operations.CompleteDirectSendResponse:
        ...
        **How to send files from your computer using the API**:
        ...
        url = utils.generate_url(base_url, "/shares/complete-send/{id}", request.path_params)
        ...
        res = operations.CompleteDirectSendResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_share_by_id(self, request: operations.DeleteShareByIDRequest) -> operations.DeleteShareByIDResponse:
        ...
        **Notes:**
        ...
        url = utils.generate_url(base_url, "/shares/{id}", request.path_params)
        ...
        res = operations.DeleteShareByIDResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_share_by_id(self, request: operations.GetShareByIDRequest) -> operations.GetShareByIDResponse:
        ...
        **Notes:**
        ...
        res = operations.GetShareByIDResponse(status_code=r.status_code, content_type=content_type)
    ...
    def list_shares(self, request: operations.ListSharesRequest) -> operations.ListSharesResponse:
        ...
        **Notes:**
        ...
        res = operations.ListSharesResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ShareCollectionResponse])
    ...
    def update_share_by_id(self, request: operations.UpdateShareByIDRequest) -> operations.UpdateShareByIDResponse:
        ...
        **Notes:**
        ...
        res = operations.UpdateShareByIDResponse(status_code=r.status_code, content_type=content_type)
