...
class UsagePerUnitPricingUpdatePriceChangeOptionEnum(str, Enum):
    NO_CHANGE = "NoChange"
...
class UsagePerUnitPricingUpdate:
    ...
    price_change_option: Optional[UsagePerUnitPricingUpdatePriceChangeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceChangeOption') }})
