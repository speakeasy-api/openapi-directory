...
export class UpdateCustomPolicySecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class UpdateCustomPolicyRequest extends SpeakeasyBase {
  /**
...
export class UpdateCustomPolicyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
