...
func (e RtiJobInstructionRtiJobInstructionLateReasonEnum) ToPointer() *RtiJobInstructionRtiJobInstructionLateReasonEnum {
	return &e
}
...
func (e *RtiJobInstructionRtiJobInstructionLateReasonEnum) UnmarshalJSON(data []byte) error {
	...
	case "G":
		fallthrough
	case "H":
		*e = RtiJobInstructionRtiJobInstructionLateReasonEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RtiJobInstructionRtiJobInstructionLateReasonEnum: %v", v)
	}
}
