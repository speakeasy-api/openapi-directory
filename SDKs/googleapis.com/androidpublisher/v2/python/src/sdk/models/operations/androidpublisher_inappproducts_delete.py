...
class AndroidpublisherInappproductsDeleteRequest:
    path_params: AndroidpublisherInappproductsDeletePathParams = dataclasses.field()
    query_params: AndroidpublisherInappproductsDeleteQueryParams = dataclasses.field()
    security: AndroidpublisherInappproductsDeleteSecurity = dataclasses.field()
