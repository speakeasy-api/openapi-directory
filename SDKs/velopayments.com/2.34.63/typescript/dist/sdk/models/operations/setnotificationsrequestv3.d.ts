...
export declare class SetNotificationsRequestV3Request extends SpeakeasyBase {
    /**
...
export declare class SetNotificationsRequestV3Response extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
