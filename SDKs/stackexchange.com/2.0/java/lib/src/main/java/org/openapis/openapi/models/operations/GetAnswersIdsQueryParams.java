...
public class GetAnswersIdsQueryParams {
    /**
    ...
    public GetAnswersIdsQueryParams withCallback(String callback) {
    ...
    public GetAnswersIdsQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetAnswersIdsQueryParams withFromdate(Long fromdate) {
    ...
    public String max;
    public GetAnswersIdsQueryParams withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public String min;
    public GetAnswersIdsQueryParams withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetAnswersIdsOrderEnum order;
    public GetAnswersIdsQueryParams withOrder(GetAnswersIdsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public GetAnswersIdsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetAnswersIdsQueryParams withPagesize(Long pagesize) {
    ...
    public String site;
    public GetAnswersIdsQueryParams withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetAnswersIdsSortEnum sort;
    public GetAnswersIdsQueryParams withSort(GetAnswersIdsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long todate;
    public GetAnswersIdsQueryParams withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
