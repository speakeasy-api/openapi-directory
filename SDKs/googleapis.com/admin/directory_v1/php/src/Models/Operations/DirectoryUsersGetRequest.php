...
class DirectoryUsersGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryUsersGetProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?DirectoryUsersGetProjectionEnum $projection = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DirectoryUsersGetViewTypeEnum $viewType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=viewType')]
    public ?DirectoryUsersGetViewTypeEnum $viewType = null;
