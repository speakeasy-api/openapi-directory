...
class Metadata:
    ...
    def delete_artifact_version_meta_data(self, request: operations.DeleteArtifactVersionMetaDataRequest) -> operations.DeleteArtifactVersionMetaDataResponse:
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.DeleteArtifactVersionMetaDataRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/versions/{version}/meta', request)
    ...
    def get_artifact_meta_data(self, request: operations.GetArtifactMetaDataRequest) -> operations.GetArtifactMetaDataResponse:
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.GetArtifactMetaDataRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/meta', request)
    ...
    def get_artifact_owner(self, request: operations.GetArtifactOwnerRequest) -> operations.GetArtifactOwnerResponse:
        r"""Get artifact owner
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.GetArtifactOwnerRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/owner', request)
        ...
        res = operations.GetArtifactOwnerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ArtifactOwner])
                res.artifact_owner = out
        elif http_res.status_code in [404, 500]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Error])
                res.error = out
    ...
    def get_artifact_version_meta_data(self, request: operations.GetArtifactVersionMetaDataRequest) -> operations.GetArtifactVersionMetaDataResponse:
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.GetArtifactVersionMetaDataRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/versions/{version}/meta', request)
    ...
    def get_artifact_version_meta_data_by_content(self, request: operations.GetArtifactVersionMetaDataByContentRequest) -> operations.GetArtifactVersionMetaDataByContentResponse:
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.GetArtifactVersionMetaDataByContentRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/meta', request)
        ...
        query_params = utils.get_query_params(operations.GetArtifactVersionMetaDataByContentRequest, request)
        ...
        res = operations.GetArtifactVersionMetaDataByContentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_artifact_meta_data(self, request: operations.UpdateArtifactMetaDataRequest) -> operations.UpdateArtifactMetaDataResponse:
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.UpdateArtifactMetaDataRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/meta', request)
    ...
    def update_artifact_owner(self, request: operations.UpdateArtifactOwnerRequest) -> operations.UpdateArtifactOwnerResponse:
        r"""Update artifact owner
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.UpdateArtifactOwnerRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/owner', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "artifact_owner", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateArtifactOwnerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_artifact_version_meta_data(self, request: operations.UpdateArtifactVersionMetaDataRequest) -> operations.UpdateArtifactVersionMetaDataResponse:
        ...
        * A server error occurred (HTTP error `500`)
        ...
        url = utils.generate_url(operations.UpdateArtifactVersionMetaDataRequest, base_url, '/groups/{groupId}/artifacts/{artifactId}/versions/{version}/meta', request)
