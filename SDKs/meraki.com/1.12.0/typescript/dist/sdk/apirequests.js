...
var ApiRequests = /** @class */ (function () {
    function ApiRequests(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ApiRequests.prototype.getOrganizationApiRequests = function (req, config) {
    ...
    **/
    ApiRequests.prototype.getOrganizationApiRequestsOverview = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
