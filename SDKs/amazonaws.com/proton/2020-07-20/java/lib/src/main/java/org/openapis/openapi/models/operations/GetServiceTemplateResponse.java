...
public class GetServiceTemplateResponse {
    ...
    public org.openapis.openapi.models.shared.GetServiceTemplateOutput getServiceTemplateOutput;

    public GetServiceTemplateResponse withGetServiceTemplateOutput(org.openapis.openapi.models.shared.GetServiceTemplateOutput getServiceTemplateOutput) {
    ...
    public GetServiceTemplateResponse withStatusCode(Integer statusCode) {
    ...
    public GetServiceTemplateResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetServiceTemplateResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
