...
export class CloudchannelAccountsCustomersCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
