...
class GetAccountsAccountIdTransactionsRequest
{
     ...
     * 
     * @var ?\DateTime $fromBookingDateTime
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=fromBookingDateTime,dateTimeFormat=Y-m-d\TH:i:s.up')]
    public ?\DateTime $fromBookingDateTime = null;
     ...
     * 
     * @var ?\DateTime $toBookingDateTime
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=toBookingDateTime,dateTimeFormat=Y-m-d\TH:i:s.up')]
    public ?\DateTime $toBookingDateTime = null;
	...
	{
		$this->accountId = "";
		$this->fromBookingDateTime = null;
		$this->sandboxId = "";
		$this->toBookingDateTime = null;
