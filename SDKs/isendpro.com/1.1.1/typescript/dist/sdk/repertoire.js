...
var Repertoire = /** @class */ (function () {
    function Repertoire(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Repertoire.prototype.repertoire = function (req, config) {
        var _a;
    ...
    **/
    Repertoire.prototype.repertoireCrea = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
