...
func (e RequestUploadShareXSdsDateFormatEnum) ToPointer() *RequestUploadShareXSdsDateFormatEnum {
	return &e
}
...
func (e *RequestUploadShareXSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = RequestUploadShareXSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestUploadShareXSdsDateFormatEnum: %v", v)
	}
}
