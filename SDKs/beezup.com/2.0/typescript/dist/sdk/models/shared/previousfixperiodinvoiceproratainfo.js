...
var PreviousFixPeriodInvoiceProrataInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "amountAfterTax" }),
        __metadata("design:type", Number)
    ], PreviousFixPeriodInvoiceProrataInfo.prototype, "amountAfterTax", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "amountToBePaid" }),
        __metadata("design:type", Number)
    ], PreviousFixPeriodInvoiceProrataInfo.prototype, "amountToBePaid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "computedProrataToBeDeducted" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fixedPeriodEndDate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fixedPeriodStartDate" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            return new Date(value);
        }, { toClassOnly: true }),
