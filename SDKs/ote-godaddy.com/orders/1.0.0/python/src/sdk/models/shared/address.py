...
class AddressCountryEnum(str, Enum):
    r"""Two-letter ISO country code to be used as a hint for target region<br/><br/>
...
class Address:
    ...
    country: AddressCountryEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('country') }})
    r"""Two-letter ISO country code to be used as a hint for target region<br/><br/>
    NOTE: These are sample values, there are many
    <a href='http://www.iso.org/iso/country_codes.htm'>more</a>
    """  
    ...
    r"""State or province or territory"""  
