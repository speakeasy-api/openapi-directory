...
class DeleteReplicationSetRequest:
    headers: DeleteReplicationSetHeaders = dataclasses.field()
    query_params: DeleteReplicationSetQueryParams = dataclasses.field()
...
class DeleteReplicationSetResponse:
    ...
    delete_replication_set_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
