...
class AccountReference16Ch:
    ...
    other_account_identification: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('otherAccountIdentification') }})
