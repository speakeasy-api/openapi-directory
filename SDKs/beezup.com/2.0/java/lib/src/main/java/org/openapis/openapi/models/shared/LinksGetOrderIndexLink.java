...
public class LinksGetOrderIndexLink {
    ...
    public LinksGetOrderIndexLink withAllOptionalParamsProvided(Boolean allOptionalParamsProvided) {
    ...
    public LinksGetOrderIndexLink withAllRequiredParamsProvided(Boolean allRequiredParamsProvided) {
    ...
    public LinksGetOrderIndexLink withDescription(String description) {
    ...
    public LinksGetOrderIndexLink withDocUrl(String docUrl) {
        this.docUrl = docUrl;
        return this;
    }
    ...
    public LinksGetOrderIndexLink withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public LinksGetOrderIndexLink withInfo(BeezUPCommonInfoSummaries info) {
        this.info = info;
        return this;
    }
    ...
    public LinksGetOrderIndexLink withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public LinksGetOrderIndexLink withMethod(BeezUPCommonHttpMethodEnum method) {
        this.method = method;
        return this;
    }
    ...
    public LinksGetOrderIndexLink withOperationId(String operationId) {
    ...
    public LinksGetOrderIndexLink withParameters(java.util.Map<String, BeezUPCommonLinkParameter3> parameters) {
    ...
    public LinksGetOrderIndexLink withUrlTemplated(Boolean urlTemplated) {
        this.urlTemplated = urlTemplated;
        return this;
    }
    
    public LinksGetOrderIndexLink(@JsonProperty("href") String href) {
        this.href = href;
  }
}
