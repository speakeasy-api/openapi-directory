...
exports.AutopilotV1AssistantQuery = void 0;
...
var AutopilotV1AssistantQuery = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dialogue_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=model_build_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sample_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=source_channel" }),
        __metadata("design:type", String)
...
exports.AutopilotV1AssistantQuery = AutopilotV1AssistantQuery;
