...
public class ListFieldLevelEncryptionProfiles20171030QueryParams {
    /**
    ...
    public ListFieldLevelEncryptionProfiles20171030QueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListFieldLevelEncryptionProfiles20171030QueryParams withMaxItems(String maxItems) {
