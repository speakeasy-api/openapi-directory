...
public class IdentityVerificationRetryRequest {
    ...
    public IdentityVerificationRetryRequest(@JsonProperty("client_user_id") String clientUserId, @JsonProperty("strategy") StrategyEnum strategy, @JsonProperty("template_id") String templateId) {
        this.clientUserId = clientUserId;
        this.strategy = strategy;
        this.templateId = templateId;
  }
