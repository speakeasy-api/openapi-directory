...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#add-an-authorized-ssh-key - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#add-custom-labels-to-a-self-hosted-runner-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#add-organization-access-to-a-self-hosted-runner-group-in-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#add-a-self-hosted-runner-to-a-group-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#create-a-github-enterprise-server-license - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#create-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#create-an-impersonation-oauth-token - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#create-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#create-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#create-a-pre-receive-hook - API method documentation
...
// ```
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#create-a-registration-token-for-an-enterprise - API method documentation
...
// ```
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#create-a-remove-token-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#create-self-hosted-runner-group-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#create-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-an-impersonation-oauth-token - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-personal-access-token - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-pre-receive-hook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-public-key - API method documentation
...
//
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-scim-group-from-an-enterprise - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminDeleteScimGroupFromEnterprise(ctx context.Context, request operations.EnterpriseAdminDeleteScimGroupFromEnterpriseRequest) (*operations.EnterpriseAdminDeleteScimGroupFromEnterpriseResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/scim/v2/Groups/{scim_group_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#delete-self-hosted-runner-from-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#delete-a-self-hosted-runner-group-from-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#delete-a-scim-user-from-an-enterprise - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminDeleteUserFromEnterprise(ctx context.Context, request operations.EnterpriseAdminDeleteUserFromEnterpriseRequest) (*operations.EnterpriseAdminDeleteUserFromEnterpriseResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/scim/v2/Users/{scim_user_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#demote-a-site-administrator - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#disable-a-selected-organization-for-github-actions-in-an-enterprise - API method documentation
...
// **Note:** The request body for this operation must be submitted as `application/x-www-form-urlencoded` data. You can submit a parameter value as a string, or you can use a tool such as `curl` to submit a parameter value as the contents of a text file. For more information, see the [`curl` documentation](https://curl.se/docs/manpage.html#--data-urlencode).
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#enable-or-disable-maintenance-mode - API method documentation
...
//
// You must authenticate using an access token with the `admin:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#enable-a-selected-organization-for-github-actions-in-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-all-authorized-ssh-keys - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-statistics - API method documentation
...
//
// You must authenticate using an access token with the `admin:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#get-allowed-actions-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/enterprise-admin/announcement#get-the-global-announcement-banner - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-the-audit-log-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-comment-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-the-configuration-status - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-the-download-status-for-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-gist-statistics - API method documentation
...
//
// You must authenticate using an access token with the `admin:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#get-github-actions-permissions-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-hooks-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-issues-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-license-information - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-the-maintenance-status - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-milestone-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-organization-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-pages-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-a-pre-receive-hook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-a-pre-receive-hook-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-a-pre-receive-hook-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-scim-provisioning-information-for-an-enterprise-group - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminGetProvisioningInformationForEnterpriseGroup(ctx context.Context, request operations.EnterpriseAdminGetProvisioningInformationForEnterpriseGroupRequest) (*operations.EnterpriseAdminGetProvisioningInformationForEnterpriseGroupResponse, error) {
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/scim+json`):
			var out *shared.ScimEnterpriseGroupResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-scim-provisioning-information-for-an-enterprise-user - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminGetProvisioningInformationForEnterpriseUser(ctx context.Context, request operations.EnterpriseAdminGetProvisioningInformationForEnterpriseUserRequest) (*operations.EnterpriseAdminGetProvisioningInformationForEnterpriseUserResponse, error) {
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/scim+json`):
			var out *shared.ScimEnterpriseUserResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-pull-requests-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-repository-statistics - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#get-a-self-hosted-runner-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#get-a-self-hosted-runner-group-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-settings - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#get-users-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-global-webhooks - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#list-labels-for-a-self-hosted-runner-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#list-organization-access-to-a-self-hosted-runner-group-in-a-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-personal-access-tokens - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-pre-receive-environments - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-pre-receive-hooks - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-pre-receive-hooks-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-pre-receive-hooks-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-provisioned-scim-groups-for-an-enterprise - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminListProvisionedGroupsEnterprise(ctx context.Context, request operations.EnterpriseAdminListProvisionedGroupsEnterpriseRequest) (*operations.EnterpriseAdminListProvisionedGroupsEnterpriseResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/scim/v2/Groups"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/scim+json`):
			var out *shared.ScimEnterpriseGroupList
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-scim-provisioned-identities-for-an-enterprise - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminListProvisionedIdentitiesEnterprise(ctx context.Context, request operations.EnterpriseAdminListProvisionedIdentitiesEnterpriseRequest) (*operations.EnterpriseAdminListProvisionedIdentitiesEnterpriseResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/scim/v2/Users"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/scim+json`):
			var out *shared.ScimEnterpriseUserList
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#list-public-keys - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#list-runner-applications-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `admin:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#list-selected-organizations-enabled-for-github-actions-in-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#list-self-hosted-runner-groups-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#list-self-hosted-runners-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#list-self-hosted-runners-in-a-group-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#ping-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#promote-a-user-to-be-a-site-administrator - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#provision-a-scim-enterprise-group - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminProvisionEnterpriseGroup(ctx context.Context, request shared.Group) (*operations.EnterpriseAdminProvisionEnterpriseGroupResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/scim/v2/Groups"
	...
	res := &operations.EnterpriseAdminProvisionEnterpriseGroupResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#provision-a-scim-enterprise-user - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminProvisionEnterpriseUser(ctx context.Context, request shared.User) (*operations.EnterpriseAdminProvisionEnterpriseUserResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/scim/v2/Users"
	...
	res := &operations.EnterpriseAdminProvisionEnterpriseUserResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#remove-all-custom-labels-from-a-self-hosted-runner-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/enterprise-admin/announcement#remove-the-global-announcement-banner - API method documentation
...
// **Note:** The request body for this operation must be submitted as `application/x-www-form-urlencoded` data. You can submit a parameter value as a string, or you can use a tool such as `curl` to submit a parameter value as the contents of a text file. For more information, see the [`curl` documentation](https://curl.se/docs/manpage.html#--data-urlencode).
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#remove-an-authorized-ssh-key - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#remove-a-custom-label-from-a-self-hosted-runner-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#remove-organization-access-to-a-self-hosted-runner-group-in-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#remove-pre-receive-hook-enforcement-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#remove-pre-receive-hook-enforcement-for-a-repository - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#remove-a-self-hosted-runner-from-a-group-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `admin:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#set-allowed-actions-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/enterprise-admin/announcement#set-the-global-announcement-banner - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#set-custom-labels-for-a-self-hosted-runner-for-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `admin:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#set-github-actions-permissions-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#set-scim-information-for-a-provisioned-enterprise-group - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#set-scim-information-for-a-provisioned-enterprise-user - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#set-organization-access-to-a-self-hosted-runner-group-in-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `admin:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#set-selected-organizations-enabled-for-github-actions-in-an-enterprise - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#set-self-hosted-runners-in-a-group-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#set-settings - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#start-a-configuration-process - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#start-a-pre-receive-environment-download - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#suspend-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#sync-ldap-mapping-for-a-team - API method documentation
...
// Note that this API call does not automatically initiate an LDAP sync. Rather, if a `201` is returned, the sync job is queued successfully, and is performed when the instance is ready.
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#sync-ldap-mapping-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#unsuspend-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-an-attribute-for-a-scim-enterprise-group - API method documentation
func (s *enterpriseAdmin) EnterpriseAdminUpdateAttributeForEnterpriseGroup(ctx context.Context, request operations.EnterpriseAdminUpdateAttributeForEnterpriseGroupRequest) (*operations.EnterpriseAdminUpdateAttributeForEnterpriseGroupResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "PatchSchema", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
//
// ```
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-an-attribute-for-a-scim-enterprise-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-ldap-mapping-for-a-team - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-ldap-mapping-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-an-organization-name - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-a-pre-receive-hook - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-pre-receive-hook-enforcement-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-pre-receive-hook-enforcement-for-a-repository - API method documentation
...
//
// You must authenticate using an access token with the `manage_runners:enterprise` scope to use this endpoint.
// https://docs.github.com/enterprise-server@3.6/rest/reference/actions#update-a-self-hosted-runner-group-for-an-enterprise - API method documentation
...
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#update-the-username-for-a-user - API method documentation
...
//
// **Note:** The request body for this operation must be submitted as `multipart/form-data` data. You can can reference the license file by prefixing the filename with the `@` symbol using `curl`. For more information, see the [`curl` documentation](https://curl.se/docs/manpage.html#-F).
// https://docs.github.com/enterprise-server@3.6/rest/reference/enterprise-admin#upgrade-a-license - API method documentation
