...
export class Stats {
  ...
  gamesStatsGet(
    ...
    security: operations.GamesStatsGetSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GamesStatsGetSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GamesStatsGetResponse =
        new operations.GamesStatsGetResponse({
