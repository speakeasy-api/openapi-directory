...
export enum POSTDescribeDBClusterEndpointsActionEnum {
  DescribeDBClusterEndpoints = "DescribeDBClusterEndpoints",
}

export enum POSTDescribeDBClusterEndpointsVersionEnum {
  TwoThousandAndFourteen1031 = "2014-10-31",
}

export class POSTDescribeDBClusterEndpointsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTDescribeDBClusterEndpointsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
