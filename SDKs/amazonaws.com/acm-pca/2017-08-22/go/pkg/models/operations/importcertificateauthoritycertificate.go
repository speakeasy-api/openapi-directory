...
func (e ImportCertificateAuthorityCertificateXAmzTargetEnum) ToPointer() *ImportCertificateAuthorityCertificateXAmzTargetEnum {
	return &e
}
...
func (e *ImportCertificateAuthorityCertificateXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "ACMPrivateCA.ImportCertificateAuthorityCertificate":
		*e = ImportCertificateAuthorityCertificateXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ImportCertificateAuthorityCertificateXAmzTargetEnum: %v", v)
	}
}
