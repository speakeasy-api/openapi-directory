...
var ObcerRequestBodyCertificateParameters = /** @class */ (function (_super) {
    ...
    ], ObcerRequestBodyCertificateParameters.prototype, "dob", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=DSNNo" }),
        __metadata("design:type", String)
    ], ObcerRequestBodyCertificateParameters.prototype, "dsnNo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Father" }),
        __metadata("design:type", String)
    ], ObcerRequestBodyCertificateParameters.prototype, "father", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FullName" }),
        __metadata("design:type", String)
    ], ObcerRequestBodyCertificateParameters.prototype, "fullName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=UID" }),
        __metadata("design:type", String)
    ], ObcerRequestBodyCertificateParameters.prototype, "uid", void 0);
