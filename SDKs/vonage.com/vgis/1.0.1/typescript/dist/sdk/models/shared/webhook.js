...
var WebhookStatistics = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalAttempts" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalSuccesses" }),
        __metadata("design:type", Number)
...
var Webhook = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=purgeAt" }),
        __metadata("design:type", String)
    ], Webhook.prototype, "purgeAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=renewedAt" }),
        __metadata("design:type", String)
