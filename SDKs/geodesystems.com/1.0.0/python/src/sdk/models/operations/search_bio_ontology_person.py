...
class SearchBioOntologyPersonQueryParams:
    ...
    search_bio_ontology_person_gender: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.bio_ontology_person.gender', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchBioOntologyPersonRequest:
    query_params: SearchBioOntologyPersonQueryParams = dataclasses.field()
