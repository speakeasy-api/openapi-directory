 ...
 */
export class UpdateInsightRequestBodyFilters extends SpeakeasyBase {
...
export class UpdateInsightRequestBody extends SpeakeasyBase {
  /**
   * <p>A collection of attributes that are applied to all active Security Hub-aggregated findings and that result in a subset of findings that are included in this insight.</p> <p>You can filter by up to 10 finding attributes. For each attribute, you can provide up to 20 filter values.</p>
   */
  @SpeakeasyMetadata()
  @Expose({ name: "Filters" })
  @Type(() => UpdateInsightRequestBodyFilters)
...
export class UpdateInsightRequest extends SpeakeasyBase {
  /**
  ...
  requestBody: UpdateInsightRequestBody;
...
export class UpdateInsightResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  updateInsightResponse?: Record<string, any>;
}
