...
var Filter = /** @class */ (function () {
    function Filter(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Filter.prototype.getAssociationFilter = function (req, config) {
     ...
     *
    **/
    Filter.prototype.getEvidenceFilter = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Filter.prototype.postAssociationFilter = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Filter.prototype.postEvidenceFilter = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
