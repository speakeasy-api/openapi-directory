...
public class FourDoauthorizationHeaders {
    /**
    ...
    public FourDoauthorizationHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public FourDoauthorizationHeaders withContentType(String contentType) {
    ...
    public FourDoauthorizationHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public FourDoauthorizationHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
