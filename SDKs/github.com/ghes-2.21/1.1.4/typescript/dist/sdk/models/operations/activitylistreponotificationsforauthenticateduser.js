...
exports.ActivityListRepoNotificationsForAuthenticatedUserResponse = exports.ActivityListRepoNotificationsForAuthenticatedUserRequest = void 0;
...
var ActivityListRepoNotificationsForAuthenticatedUserRequest = /** @class */ (function (_super) {
    ...
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "all", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=before;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "before", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=participating",
        }),
        __metadata("design:type", Boolean)
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "participating", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=since;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], ActivityListRepoNotificationsForAuthenticatedUserRequest.prototype, "since", void 0);
...
var ActivityListRepoNotificationsForAuthenticatedUserResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ActivityListRepoNotificationsForAuthenticatedUserResponse.prototype, "rawResponse", void 0);
    __decorate([
