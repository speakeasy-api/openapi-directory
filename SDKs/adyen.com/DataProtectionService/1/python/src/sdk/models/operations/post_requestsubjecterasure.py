...
from ..shared import subjecterasureresponse as shared_subjecterasureresponse
from typing import Optional


@dataclasses.dataclass
class PostRequestSubjectErasureSecurity:
...
@dataclasses.dataclass
class PostRequestSubjectErasureResponse:
    ...
    subject_erasure_response: Optional[shared_subjecterasureresponse.SubjectErasureResponse] = dataclasses.field(default=None)
