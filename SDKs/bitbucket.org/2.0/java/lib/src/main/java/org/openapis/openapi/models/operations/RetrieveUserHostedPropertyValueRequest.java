...
public class RetrieveUserHostedPropertyValueRequest {
    ...
    public RetrieveUserHostedPropertyValueRequest(@JsonProperty("app_key") String appKey, @JsonProperty("property_name") String propertyName, @JsonProperty("selected_user") String selectedUser) {
        this.appKey = appKey;
        this.propertyName = propertyName;
        this.selectedUser = selectedUser;
  }
