...
exports.ListMobileDeviceAccessRulesResponse = exports.ListMobileDeviceAccessRulesRequest = exports.ListMobileDeviceAccessRulesXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ListMobileDeviceAccessRulesXAmzTargetEnum;
...
})(ListMobileDeviceAccessRulesXAmzTargetEnum = exports.ListMobileDeviceAccessRulesXAmzTargetEnum || (exports.ListMobileDeviceAccessRulesXAmzTargetEnum = {}));
var ListMobileDeviceAccessRulesRequest = /** @class */ (function (_super) {
    ...
    ], ListMobileDeviceAccessRulesRequest.prototype, "listMobileDeviceAccessRulesRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ListMobileDeviceAccessRulesRequest.prototype, "xAmzTarget", void 0);
...
var ListMobileDeviceAccessRulesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ListMobileDeviceAccessRulesResponse.prototype, "rawResponse", void 0);
