...
class GoogleCloudRetailV2alphaSearchRequestBoostSpec:
    ...
    condition_boost_specs: Optional[list[shared_googlecloudretailv2alphasearchrequestboostspecconditionboostspec.GoogleCloudRetailV2alphaSearchRequestBoostSpecConditionBoostSpec]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conditionBoostSpecs'), 'exclude': lambda f: f is None }})
