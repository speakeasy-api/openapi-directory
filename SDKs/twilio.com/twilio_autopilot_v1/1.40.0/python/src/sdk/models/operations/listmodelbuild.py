...
class ListModelBuildListModelBuildResponse:
    ...
    meta: Optional[ListModelBuildListModelBuildResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    model_builds: Optional[list[shared_autopilot_v1_assistant_model_build.AutopilotV1AssistantModelBuild]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model_builds'), 'exclude': lambda f: f is None }})  
