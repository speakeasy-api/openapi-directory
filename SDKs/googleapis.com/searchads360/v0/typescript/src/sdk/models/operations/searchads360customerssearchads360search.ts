...
export class Searchads360CustomersSearchAds360SearchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class Searchads360CustomersSearchAds360SearchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class Searchads360CustomersSearchAds360SearchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
