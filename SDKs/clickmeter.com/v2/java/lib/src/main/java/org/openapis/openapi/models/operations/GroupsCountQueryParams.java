...
public class GroupsCountQueryParams {
    /**
    ...
    public GroupsCountQueryParams withCreatedAfter(String createdAfter) {
    ...
    public GroupsCountQueryParams withCreatedBefore(String createdBefore) {
    ...
    public GroupsCountQueryParams withStatus(GroupsCountStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public String tags;
    public GroupsCountQueryParams withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public GroupsCountQueryParams withTextSearch(String textSearch) {
    ...
    public GroupsCountQueryParams withWrite(Boolean write) {
        this.write = write;
        return this;
    }
