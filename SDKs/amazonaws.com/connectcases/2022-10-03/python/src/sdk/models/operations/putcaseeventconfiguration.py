...
class PutCaseEventConfigurationRequestBody:
    ...
    event_bridge: PutCaseEventConfigurationRequestBodyEventBridge = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventBridge') }})
    r"""Configuration to enable EventBridge case event delivery and determine what data is delivered."""  
...
class PutCaseEventConfigurationRequest:
    ...
    request_body: PutCaseEventConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PutCaseEventConfigurationResponse:
    ...
    put_case_event_configuration_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
