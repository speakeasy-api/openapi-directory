...
exports.TimerStartedEventAttributes = void 0;
var utils_1 = require("../../../internal/utils");
// TimerStartedEventAttributes
/**
 * Provides the details of the <code>TimerStarted</code> event.
**/
var TimerStartedEventAttributes = /** @class */ (function (_super) {
    __extends(TimerStartedEventAttributes, _super);
    ...
    ], TimerStartedEventAttributes.prototype, "control", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=decisionTaskCompletedEventId" }),
        __metadata("design:type", Number)
    ], TimerStartedEventAttributes.prototype, "decisionTaskCompletedEventId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startToFireTimeout" }),
        __metadata("design:type", String)
    ], TimerStartedEventAttributes.prototype, "startToFireTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timerId" }),
        __metadata("design:type", String)
    ], TimerStartedEventAttributes.prototype, "timerId", void 0);
