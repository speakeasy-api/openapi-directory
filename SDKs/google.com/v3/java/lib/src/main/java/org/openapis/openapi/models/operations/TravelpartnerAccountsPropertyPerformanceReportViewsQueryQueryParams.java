...
public class TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams {
    /**
     * V1 error format.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=$.xgafv")
    public org.openapis.openapi.models.shared.XgafvEnum dollarXgafv;
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withAccessToken(String accessToken) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withAggregateBy(String aggregateBy) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withCallback(String callback) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public String key;
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withOauthToken(String oauthToken) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withPageSize(Long pageSize) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withPageToken(String pageToken) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withPrettyPrint(Boolean prettyPrint) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withQuotaUser(String quotaUser) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withUploadType(String uploadType) {
    ...
    public TravelpartnerAccountsPropertyPerformanceReportViewsQueryQueryParams withUploadProtocol(String uploadProtocol) {
