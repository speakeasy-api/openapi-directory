...
class PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawVehicleEngineTypeEnum $vehicleEngineType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=vehicleEngineType')]
    public ?PostRoutingVersionNumberCalculateReachableRangeOriginContentTypeRawVehicleEngineTypeEnum $vehicleEngineType = null;
