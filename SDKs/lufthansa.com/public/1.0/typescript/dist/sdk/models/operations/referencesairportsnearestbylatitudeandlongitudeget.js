...
exports.ReferencesAirportsNearestByLatitudeAndLongitudeGetResponse = exports.ReferencesAirportsNearestByLatitudeAndLongitudeGetRequest = exports.ReferencesAirportsNearestByLatitudeAndLongitudeGetSecurity = void 0;
...
var ReferencesAirportsNearestByLatitudeAndLongitudeGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ReferencesAirportsNearestByLatitudeAndLongitudeGetRequest.prototype, "accept", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], ReferencesAirportsNearestByLatitudeAndLongitudeGetRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=latitude",
        }),
        __metadata("design:type", Number)
    ], ReferencesAirportsNearestByLatitudeAndLongitudeGetRequest.prototype, "latitude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=longitude",
        }),
        __metadata("design:type", Number)
    ], ReferencesAirportsNearestByLatitudeAndLongitudeGetRequest.prototype, "longitude", void 0);
...
var ReferencesAirportsNearestByLatitudeAndLongitudeGetResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ReferencesAirportsNearestByLatitudeAndLongitudeGetResponse.prototype, "rawResponse", void 0);
