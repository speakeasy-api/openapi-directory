...
from ..shared import listcredittransfersresponse as shared_listcredittransfersresponse
...
class RetrieveCreditTransfersResponse:
    ...
    list_credit_transfers_response: Optional[shared_listcredittransfersresponse.ListCreditTransfersResponse] = dataclasses.field(default=None)
