...
exports.ListSipAuthCallsCredentialListMappingResponse = exports.ListSipAuthCallsCredentialListMappingListSipAuthCallsCredentialListMappingResponse = exports.ListSipAuthCallsCredentialListMappingRequest = exports.ListSipAuthCallsCredentialListMappingSecurity = exports.ListSipAuthCallsCredentialListMappingServerList = void 0;
...
var ListSipAuthCallsCredentialListMappingSecurity = /** @class */ (function (_super) {
    ...
    ], ListSipAuthCallsCredentialListMappingSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSipAuthCallsCredentialListMappingSecurity.prototype, "username", void 0);
...
var ListSipAuthCallsCredentialListMappingRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSipAuthCallsCredentialListMappingRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomainSid",
        }),
        __metadata("design:type", String)
    ], ListSipAuthCallsCredentialListMappingRequest.prototype, "domainSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSipAuthCallsCredentialListMappingRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSipAuthCallsCredentialListMappingRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSipAuthCallsCredentialListMappingRequest.prototype, "pageToken", void 0);
...
var ListSipAuthCallsCredentialListMappingListSipAuthCallsCredentialListMappingResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping,
        }),
        (0, class_transformer_1.Expose)({ name: "contents" }),
        (0, class_transformer_1.Type)(function () {
            return shared.ApiV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping;
        }),
...
var ListSipAuthCallsCredentialListMappingResponse = /** @class */ (function (_super) {
    ...
    ], ListSipAuthCallsCredentialListMappingResponse.prototype, "rawResponse", void 0);
