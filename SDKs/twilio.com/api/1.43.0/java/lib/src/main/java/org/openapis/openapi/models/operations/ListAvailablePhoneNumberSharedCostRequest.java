...
public class ListAvailablePhoneNumberSharedCostRequest {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withAccountSid(String accountSid) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withAreaCode(Long areaCode) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withBeta(Boolean beta) {
        this.beta = beta;
        return this;
    }
    ...
    public ListAvailablePhoneNumberSharedCostRequest withContains(String contains) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withCountryCode(String countryCode) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withDistance(Long distance) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withExcludeAllAddressRequired(Boolean excludeAllAddressRequired) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withExcludeForeignAddressRequired(Boolean excludeForeignAddressRequired) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withExcludeLocalAddressRequired(Boolean excludeLocalAddressRequired) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withFaxEnabled(Boolean faxEnabled) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withInLata(String inLata) {
        this.inLata = inLata;
        return this;
    }
    ...
    public ListAvailablePhoneNumberSharedCostRequest withInLocality(String inLocality) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withInPostalCode(String inPostalCode) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withInRateCenter(String inRateCenter) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withInRegion(String inRegion) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withMmsEnabled(Boolean mmsEnabled) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withNearLatLong(String nearLatLong) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withNearNumber(String nearNumber) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListAvailablePhoneNumberSharedCostRequest withPageSize(Long pageSize) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withPageToken(String pageToken) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withSmsEnabled(Boolean smsEnabled) {
    ...
    public ListAvailablePhoneNumberSharedCostRequest withVoiceEnabled(Boolean voiceEnabled) {
        this.voiceEnabled = voiceEnabled;
        return this;
    }
    
    public ListAvailablePhoneNumberSharedCostRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CountryCode") String countryCode) {
        this.accountSid = accountSid;
        this.countryCode = countryCode;
  }
}
