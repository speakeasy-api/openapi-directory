...
type DatastreamProjectsLocationsStreamsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatastreamProjectsLocationsStreamsCreatePathParams struct {
	// Required. The parent that owns the collection of streams.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatastreamProjectsLocationsStreamsCreateQueryParams struct {
	// V1 error format.
...
type DatastreamProjectsLocationsStreamsCreateRequest struct {
...
type DatastreamProjectsLocationsStreamsCreateResponse struct {
	ContentType string
	// Successful response
