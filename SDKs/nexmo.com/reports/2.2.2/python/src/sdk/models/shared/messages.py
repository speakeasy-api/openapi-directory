...
class Messages:
    ...
    product: shared_product_messages_enum.ProductMessagesEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('product') }})
    ...
    r"""Search only messages with the specified uuid."""  
