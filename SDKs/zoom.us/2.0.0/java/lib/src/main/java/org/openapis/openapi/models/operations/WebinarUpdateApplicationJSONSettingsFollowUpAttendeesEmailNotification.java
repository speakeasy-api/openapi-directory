...
public class WebinarUpdateApplicationJSONSettingsFollowUpAttendeesEmailNotification {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public WebinarUpdateApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum type;
    public WebinarUpdateApplicationJSONSettingsFollowUpAttendeesEmailNotification withType(WebinarUpdateApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum type) {
        this.type = type;
        return this;
    }
