...
class IPSet:
    ...
    ip_set_descriptors: list[shared_ipsetdescriptor.IPSetDescriptor] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IPSetDescriptors') }})  
