...
export class DialogflowProjectsConversationsParticipantsSuggestionsCompileSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsConversationsParticipantsSuggestionsCompileSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsConversationsParticipantsSuggestionsCompileSecurity extends SpeakeasyBase {
...
export class DialogflowProjectsConversationsParticipantsSuggestionsCompileRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsConversationsParticipantsSuggestionsCompileResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
