...
exports.GetProductsIdOptionsJsonResponse = exports.GetProductsIdOptionsJsonRequest = void 0;
...
var GetProductsIdOptionsJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsIdOptionsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetProductsIdOptionsJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsIdOptionsJsonRequest.prototype, "login", void 0);
    return GetProductsIdOptionsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdOptionsJsonRequest = GetProductsIdOptionsJsonRequest;
var GetProductsIdOptionsJsonResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ProductOption }),
    ...
    ], GetProductsIdOptionsJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsIdOptionsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdOptionsJsonResponse = GetProductsIdOptionsJsonResponse;
