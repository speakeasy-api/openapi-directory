...
public class PointPointGetQueryParams {
    ...
    public PointPointGetQueryParams withLanguage(PointPointGetLanguageLanguageEnum language) {
    ...
    public String lat;
    public PointPointGetQueryParams withLat(String lat) {
        this.lat = lat;
        return this;
    }
    ...
    public String lon;
    public PointPointGetQueryParams withLon(String lon) {
        this.lon = lon;
        return this;
    }
    ...
    public PointPointGetQueryParams withPlaceId(String placeId) {
    ...
    public PointPointGetQueryParams withSections(String sections) {
    ...
    public PointPointGetQueryParams withTimezone(String timezone) {
    ...
    public PointPointGetQueryParams withUnits(PointPointGetUnitsUnitsEnum units) {
        this.units = units;
        return this;
    }
