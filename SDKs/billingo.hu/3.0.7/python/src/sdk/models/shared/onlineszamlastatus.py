...
class OnlineSzamlaStatus:
    ...
    messages: Optional[list[shared_onlineszamlastatusmessage.OnlineSzamlaStatusMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messages'), 'exclude': lambda f: f is None }})  
