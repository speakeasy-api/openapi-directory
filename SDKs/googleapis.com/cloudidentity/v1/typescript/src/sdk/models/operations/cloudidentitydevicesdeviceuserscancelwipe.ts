...
export class CloudidentityDevicesDeviceUsersCancelWipeSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudidentityDevicesDeviceUsersCancelWipeRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudidentityDevicesDeviceUsersCancelWipeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
