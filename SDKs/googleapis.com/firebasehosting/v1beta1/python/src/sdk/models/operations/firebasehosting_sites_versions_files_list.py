...
class FirebasehostingSitesVersionsFilesListStatusEnum(str, Enum):
    r"""The type of files that should be listed for the specified version."""
...
class FirebasehostingSitesVersionsFilesListRequest:
    ...
    r"""Required. The version for which to list files, in the format: sites/SITE_ID /versions/VERSION_ID"""  
    ...
    r"""The maximum number of version files to return. The service may return a lower number if fewer version files exist than this maximum number. If unspecified, defaults to 1000."""  
    page_token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'pageToken', 'style': 'form', 'explode': True }})
    r"""A token from a previous call to `ListVersionFiles` that tells the server where to resume listing."""  
