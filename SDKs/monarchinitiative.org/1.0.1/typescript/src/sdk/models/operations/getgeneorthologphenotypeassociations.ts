...
export class GetGeneOrthologPhenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGeneOrthologPhenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGeneOrthologPhenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneOrthologPhenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
