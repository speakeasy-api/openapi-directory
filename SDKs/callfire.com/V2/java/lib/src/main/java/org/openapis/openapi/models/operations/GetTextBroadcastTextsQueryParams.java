...
public class GetTextBroadcastTextsQueryParams {
    /**
     * ~
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=batchId")
    public Long batchId;
    public GetTextBroadcastTextsQueryParams withBatchId(Long batchId) {
    ...
    public GetTextBroadcastTextsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public GetTextBroadcastTextsQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetTextBroadcastTextsQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
