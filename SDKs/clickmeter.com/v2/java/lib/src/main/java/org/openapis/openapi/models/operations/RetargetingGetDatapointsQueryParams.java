...
public class RetargetingGetDatapointsQueryParams {
    /**
    ...
    public RetargetingGetDatapointsQueryParams withCreatedAfter(String createdAfter) {
    ...
    public RetargetingGetDatapointsQueryParams withCreatedBefore(String createdBefore) {
    ...
    public RetargetingGetDatapointsQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public RetargetingGetDatapointsQueryParams withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public RetargetingGetDatapointsQueryParams withOnlyFavorites(Boolean onlyFavorites) {
    ...
    public RetargetingGetDatapointsQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public RetargetingGetDatapointsQueryParams withSortDirection(RetargetingGetDatapointsSortDirectionEnum sortDirection) {
    ...
    public RetargetingGetDatapointsQueryParams withStatus(RetargetingGetDatapointsStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public String tags;
    public RetargetingGetDatapointsQueryParams withTags(String tags) {
        this.tags = tags;
        return this;
    }
    ...
    public RetargetingGetDatapointsQueryParams withTextSearch(String textSearch) {
