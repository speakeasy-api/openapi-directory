...
class GetActivityTaskRequest:
    ...
    get_activity_task_input: shared_getactivitytaskinput.GetActivityTaskInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
