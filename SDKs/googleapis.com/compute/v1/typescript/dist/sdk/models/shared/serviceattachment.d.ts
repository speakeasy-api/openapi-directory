...
import { ServiceAttachmentConnectedEndpoint } from "./serviceattachmentconnectedendpoint";
import { ServiceAttachmentConsumerProjectLimit } from "./serviceattachmentconsumerprojectlimit";
import { Uint128 } from "./uint128";
/**
 * The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
 */
export declare enum ServiceAttachmentConnectionPreferenceEnum {
 ...
 */
export declare class ServiceAttachment extends SpeakeasyBase {
    /**
