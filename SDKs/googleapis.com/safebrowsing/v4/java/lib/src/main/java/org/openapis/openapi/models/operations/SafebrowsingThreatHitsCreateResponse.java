...
public class SafebrowsingThreatHitsCreateResponse {
    ...
    public SafebrowsingThreatHitsCreateResponse withStatusCode(Integer statusCode) {
    ...
    public SafebrowsingThreatHitsCreateResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public SafebrowsingThreatHitsCreateResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
