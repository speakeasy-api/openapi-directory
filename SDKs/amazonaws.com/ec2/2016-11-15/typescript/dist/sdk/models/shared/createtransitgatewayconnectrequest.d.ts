...
import { CreateTransitGatewayConnectRequestOptions } from "./createtransitgatewayconnectrequestoptions";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateTransitGatewayConnectRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTransitGatewayConnectRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTransitGatewayConnectRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTransitGatewayConnectRequest extends SpeakeasyBase {
    dryRun?: boolean;
