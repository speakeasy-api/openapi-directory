 ...
 */
export declare enum ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnum {
    All = "ALL",
    Regional = "REGIONAL",
    Global = "GLOBAL"
}
export declare class ListPendingInvitationResourcesRequestBody extends SpeakeasyBase {
     ...
     * <p>Specifies that you want the results to include only resources that have the specified scope.</p> <ul> <li> <p> <code>ALL</code> – the results include both global and regional resources or resource types.</p> </li> <li> <p> <code>GLOBAL</code> – the results include only global resources or resource types.</p> </li> <li> <p> <code>REGIONAL</code> – the results include only regional resources or resource types.</p> </li> </ul> <p>The default value is <code>ALL</code>.</p>
     */
    resourceRegionScope?: ListPendingInvitationResourcesRequestBodyResourceRegionScopeEnum;
    /**
...
export declare class ListPendingInvitationResourcesRequest extends SpeakeasyBase {
    requestBody: ListPendingInvitationResourcesRequestBody;
