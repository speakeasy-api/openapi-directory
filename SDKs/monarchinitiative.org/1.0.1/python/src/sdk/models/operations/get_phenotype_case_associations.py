...
class GetPhenotypeCaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypeCaseAssociationsQueryParams:
...
class GetPhenotypeCaseAssociationsRequest:
    path_params: GetPhenotypeCaseAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypeCaseAssociationsQueryParams = dataclasses.field()
