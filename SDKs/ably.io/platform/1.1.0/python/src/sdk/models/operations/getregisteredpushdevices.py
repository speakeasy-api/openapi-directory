...
class GetRegisteredPushDevicesQueryParams:
...
@dataclasses.dataclass
class GetRegisteredPushDevicesHeaders:
...
class GetRegisteredPushDevicesRequest:
    headers: GetRegisteredPushDevicesHeaders = dataclasses.field()
    query_params: GetRegisteredPushDevicesQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetRegisteredPushDevicesResponseOutput:
