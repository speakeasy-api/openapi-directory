...
@dataclasses.dataclass
class AppsGetForOrgUserRequest:
...
class AppsGetForOrgUserDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
@dataclasses.dataclass
class AppsGetForOrgUserDefaultApplicationJSONError:
    
    code: AppsGetForOrgUserDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class AppsGetForOrgUserDefaultApplicationJSON:
    ...
    error: AppsGetForOrgUserDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
...
class AppsGetForOrgUser200ApplicationJSONMemberPermissionsEnum(str, Enum):
    MANAGER = 'manager'
    DEVELOPER = 'developer'
    VIEWER = 'viewer'
    TESTER = 'tester'

class AppsGetForOrgUser200ApplicationJSONOriginEnum(str, Enum):
    r"""The creation origin of this app"""
    APPCENTER = 'appcenter'
    HOCKEYAPP = 'hockeyapp'
    CODEPUSH = 'codepush'

class AppsGetForOrgUser200ApplicationJSONOsEnum(str, Enum):
...
class AppsGetForOrgUser200ApplicationJSONOwnerTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsGetForOrgUser200ApplicationJSONOwner:
    ...
    type: AppsGetForOrgUser200ApplicationJSONOwnerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The owner type. Can either be 'org' or 'user'"""  
...
class AppsGetForOrgUser200ApplicationJSONPlatformEnum(str, Enum):
...
class AppsGetForOrgUser200ApplicationJSON:
    ...
    origin: AppsGetForOrgUser200ApplicationJSONOriginEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin') }})
    r"""The creation origin of this app"""  
    os: AppsGetForOrgUser200ApplicationJSONOsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('os') }})
    r"""The OS the app will be running on"""  
    owner: AppsGetForOrgUser200ApplicationJSONOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The information about the app's owner"""  
    platform: AppsGetForOrgUser200ApplicationJSONPlatformEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform') }})
    r"""The platform of the app"""  
    azure_subscription: Optional[AppsGetForOrgUser200ApplicationJSONAzureSubscription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('azure_subscription'), 'exclude': lambda f: f is None }})  
    ...
    member_permissions: Optional[list[AppsGetForOrgUser200ApplicationJSONMemberPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('member_permissions'), 'exclude': lambda f: f is None }})
...
class AppsGetForOrgUserResponse:
    ...
    apps_get_for_org_user_200_application_json_anies: Optional[list[AppsGetForOrgUser200ApplicationJSON]] = dataclasses.field(default=None)
    r"""Success"""  
    apps_get_for_org_user_default_application_json_object: Optional[AppsGetForOrgUserDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
