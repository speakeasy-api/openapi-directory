...
from ..shared import nhrecipe as shared_nhrecipe
...
class GetNhRecipesRequest:
    ...
    r"""When set to `true`, only recipe names are returned. Instead of an array of objects with all details, the return will be an array of strings."""  
    material: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'material', 'style': 'form', 'explode': True }})
    r"""Specify a material to only get recipes that use that material. You can specify `material` up to six times (no recipe uses more than six materials)."""  
...
class GetNhRecipesResponse:
    ...
    nh_recipes: Optional[list[shared_nhrecipe.NHRecipe]] = dataclasses.field(default=None)
    r"""A JSON array of recipes."""  
