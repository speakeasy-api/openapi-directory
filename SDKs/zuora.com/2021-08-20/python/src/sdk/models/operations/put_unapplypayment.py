...
from ..shared import getarpaymenttype as shared_getarpaymenttype
...
class PUTUnapplyPaymentRequest:
    ...
    r"""The unique ID of an applied payment. For example, 8a8082e65b27f6c3015b89e4344c16b1."""  
    unapply_payment_type: shared_unapplypaymenttype.UnapplyPaymentType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PUTUnapplyPaymentResponse:
    ...
    getar_payment_type: Optional[shared_getarpaymenttype.GETARPaymentType] = dataclasses.field(default=None)  
