...
func (s *ConsentFlow) PostV05ConsentRequestsInit(ctx context.Context, request operations.PostV05ConsentRequestsInitRequest) (*operations.PostV05ConsentRequestsInitResponse, error) {
	...
	res := &operations.PostV05ConsentRequestsInitResponse{
...
func (s *ConsentFlow) PostV05ConsentRequestsStatus(ctx context.Context, request operations.PostV05ConsentRequestsStatusRequest) (*operations.PostV05ConsentRequestsStatusResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05ConsentRequestsStatusResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *ConsentFlow) PostV05ConsentsHipNotify(ctx context.Context, request operations.PostV05ConsentsHipNotifyRequest) (*operations.PostV05ConsentsHipNotifyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05ConsentsHipNotifyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *ConsentFlow) PostV05ConsentsHipOnNotify(ctx context.Context, request operations.PostV05ConsentsHipOnNotifyRequest) (*operations.PostV05ConsentsHipOnNotifyResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PostV05ConsentsHipOnNotifyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
