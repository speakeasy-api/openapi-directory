...
@dataclasses.dataclass
class GetJourneyDateRangeKpiQueryParams:
...
@dataclasses.dataclass
class GetJourneyDateRangeKpiHeaders:
...
class GetJourneyDateRangeKpiRequest:
    headers: GetJourneyDateRangeKpiHeaders = dataclasses.field()
    path_params: GetJourneyDateRangeKpiPathParams = dataclasses.field()
    query_params: GetJourneyDateRangeKpiQueryParams = dataclasses.field()
