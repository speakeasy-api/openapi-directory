...
export class GetGeneCaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGeneCaseAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGeneCaseAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneCaseAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
