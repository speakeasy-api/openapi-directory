...
func (e GetUsersIdsCommentsToidOrderEnum) ToPointer() *GetUsersIdsCommentsToidOrderEnum {
	return &e
}

func (e *GetUsersIdsCommentsToidOrderEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetUsersIdsCommentsToidOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsCommentsToidOrderEnum: %v", v)
	}
}

// GetUsersIdsCommentsToidSortEnum
...
func (e GetUsersIdsCommentsToidSortEnum) ToPointer() *GetUsersIdsCommentsToidSortEnum {
	return &e
}

func (e *GetUsersIdsCommentsToidSortEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetUsersIdsCommentsToidSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIdsCommentsToidSortEnum: %v", v)
	}
}
