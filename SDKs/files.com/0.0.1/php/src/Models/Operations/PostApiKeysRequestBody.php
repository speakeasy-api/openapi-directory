...
class PostApiKeysRequestBody
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\PostApiKeysRequestBodyPermissionSetEnum $permissionSet
     */
	#[SpeakeasyMetadata('multipartForm:name=permission_set')]
    public ?PostApiKeysRequestBodyPermissionSetEnum $permissionSet = null;
