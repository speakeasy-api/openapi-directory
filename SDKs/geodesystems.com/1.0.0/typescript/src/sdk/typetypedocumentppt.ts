...
export class TypeTypeDocumentPpt {
  ...
  searchTypeDocumentPpt(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_document_ppt";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeDocumentPptResponse =
        new operations.SearchTypeDocumentPptResponse({
