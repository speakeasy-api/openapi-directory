 ...
 */
export declare class DescribeReservedInstancesModificationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
/**
 ...
 */
export declare class DescribeReservedInstancesModificationsRequest extends SpeakeasyBase {
    filters?: DescribeReservedInstancesModificationsRequestFilters[];
    nextToken?: string;
