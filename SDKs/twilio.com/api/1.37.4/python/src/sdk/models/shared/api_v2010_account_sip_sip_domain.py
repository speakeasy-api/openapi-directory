...
class APIV2010AccountSipSipDomain:
    ...
    byoc_trunk_sid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('byoc_trunk_sid') }})
    ...
    emergency_caller_sid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('emergency_caller_sid') }})
    emergency_calling_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('emergency_calling_enabled') }})
    ...
    sip_registration: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sip_registration') }})
    ...
    voice_fallback_method: Optional[APIV2010AccountSipSipDomainVoiceFallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_fallback_method') }})
    ...
    voice_method: Optional[APIV2010AccountSipSipDomainVoiceMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_method') }})
    voice_status_callback_method: Optional[APIV2010AccountSipSipDomainVoiceStatusCallbackMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_status_callback_method') }})
    voice_status_callback_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_status_callback_url') }})
