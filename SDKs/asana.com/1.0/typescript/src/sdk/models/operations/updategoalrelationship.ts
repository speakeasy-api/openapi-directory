 ...
 */
export class UpdateGoalRelationshipRequestBodyInput extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
  @Type(() => shared.GoalRelationshipRequestInput)
  data?: shared.GoalRelationshipRequestInput;
}

export class UpdateGoalRelationshipRequest extends SpeakeasyBase {
  /**
   * The updated fields for the goal relationship.
   */
 ...
 */
export class UpdateGoalRelationship200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
...
export class UpdateGoalRelationshipResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
