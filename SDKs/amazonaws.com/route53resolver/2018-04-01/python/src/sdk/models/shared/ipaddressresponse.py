...
class IPAddressResponse:
    ...
    status: Optional[shared_ipaddressstatus_enum.IPAddressStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
