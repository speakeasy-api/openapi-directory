...
exports.UpdateBotResponse = exports.UpdateBotRequest = exports.UpdateBotRequestBody = exports.UpdateBotRequestBodyDataPrivacy = exports.UpdateBotRequestBodyBotTypeEnum = void 0;
 ...
 */
var UpdateBotRequestBodyBotTypeEnum;
(function (UpdateBotRequestBodyBotTypeEnum) {
    UpdateBotRequestBodyBotTypeEnum["Bot"] = "Bot";
    UpdateBotRequestBodyBotTypeEnum["BotNetwork"] = "BotNetwork";
})(UpdateBotRequestBodyBotTypeEnum = exports.UpdateBotRequestBodyBotTypeEnum || (exports.UpdateBotRequestBodyBotTypeEnum = {}));
/**
...
var UpdateBotRequestBody = /** @class */ (function (_super) {
    ...
    ], UpdateBotRequestBody.prototype, "botMembers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateBotRequestBody.prototype, "botType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "dataPrivacy" }),
        (0, class_transformer_1.Type)(function () { return UpdateBotRequestBodyDataPrivacy; }),
...
var UpdateBotRequest = /** @class */ (function (_super) {
    ...
    ], UpdateBotRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=botId",
        }),
        __metadata("design:type", String)
    ], UpdateBotRequest.prototype, "botId", void 0);
...
var UpdateBotResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateBotResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
