...
export class WorkstationsProjectsLocationsWorkstationClustersWorkstationConfigsWorkstationsPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class WorkstationsProjectsLocationsWorkstationClustersWorkstationConfigsWorkstationsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class WorkstationsProjectsLocationsWorkstationClustersWorkstationConfigsWorkstationsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
