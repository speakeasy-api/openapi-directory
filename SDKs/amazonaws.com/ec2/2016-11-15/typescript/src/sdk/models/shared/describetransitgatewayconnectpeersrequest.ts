 ...
 */
export class DescribeTransitGatewayConnectPeersRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayConnectPeersRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
