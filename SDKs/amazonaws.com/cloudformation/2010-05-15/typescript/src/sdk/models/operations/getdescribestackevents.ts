...
export enum GETDescribeStackEventsActionEnum {
  DescribeStackEvents = "DescribeStackEvents",
}

export enum GETDescribeStackEventsVersionEnum {
  TwoThousandAndTen0515 = "2010-05-15",
}

export class GETDescribeStackEventsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDescribeStackEventsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
