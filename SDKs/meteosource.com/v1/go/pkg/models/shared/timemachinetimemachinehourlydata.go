...
type TimeMachineTimeMachineHourlyData struct {
	// Convective available potential energy.
	// Unit: J/kg
	Cape       *int64                               `json:"cape,omitempty"`
	CloudCover TimeMachineTimeMachineCloudCoverData `json:"cloud_cover"`
	...
	// Unit: mm/h
	Evaporation *int64 `json:"evaporation,omitempty"`
	...
	// Unit: W/m2
	Irradiance *int64 `json:"irradiance,omitempty"`
	// Total column of ozone.
	// Unit: Dobson
	Ozone         *int64                                  `json:"ozone,omitempty"`
	Precipitation TimeMachineTimeMachinePrecipitationData `json:"precipitation"`
	...
	Wind    TimeMachineTimeMachineWindData `json:"wind"`
