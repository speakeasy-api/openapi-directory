...
type GetGeneInteractionsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetGeneInteractionsQueryParams struct {
