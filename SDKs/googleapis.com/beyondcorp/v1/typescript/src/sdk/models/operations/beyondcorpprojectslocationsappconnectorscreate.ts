...
export class BeyondcorpProjectsLocationsAppConnectorsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppConnectorsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BeyondcorpProjectsLocationsAppConnectorsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
