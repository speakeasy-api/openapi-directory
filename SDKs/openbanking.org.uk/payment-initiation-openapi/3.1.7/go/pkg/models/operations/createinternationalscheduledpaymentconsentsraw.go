...
type CreateInternationalScheduledPaymentConsentsRawSecurity struct {
	TPPOAuth2Security shared.SchemeTppoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateInternationalScheduledPaymentConsentsRawHeaders struct {
...
type CreateInternationalScheduledPaymentConsentsRawRequest struct {
	Headers CreateInternationalScheduledPaymentConsentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateInternationalScheduledPaymentConsentsRawSecurity
}

type CreateInternationalScheduledPaymentConsentsRawResponse struct {
	Body        []byte
	ContentType string
