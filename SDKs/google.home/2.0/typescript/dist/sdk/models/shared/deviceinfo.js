...
var DeviceInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "4k_blocked" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cloud_device_id" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "cloudDeviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "factory_country_code" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "factoryCountryCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hotspot_bssid" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "hotspotBssid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "local_authorization_token_hash" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ssdp_udn" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "ssdpUdn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "uma_client_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "weave_device_id" }),
        __metadata("design:type", String)
