 ...
 *
 */
export enum GetBatchByIdResponseBodyLabelFormatEnum {
  Pdf = "pdf",
  Png = "png",
  Zpl = "zpl",
}
 ...
 *
 */
export enum GetBatchByIdResponseBodyLabelLayoutEnum {
  Fourx6 = "4x6",
  Letter = "letter",
}
 ...
 */
export enum GetBatchByIdResponseBodyBatchStatusEnum {
  Open = "open",
  Queued = "queued",
...
export class GetBatchByIdResponseBody extends SpeakeasyBase {
  ...
  @Type(() => GetBatchByIdResponseBodyOptionalLink)
  ...
  @Type(() => GetBatchByIdResponseBodyLabelDownload)
