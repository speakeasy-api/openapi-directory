...
class Organizations 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsCancelResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1p1alpha1/{name}:cancel', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsCancelRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1p1alpha1/{name}', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsDeleteRequest::class, $request);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListResponse
     */
	public function securitycenterOrganizationsOperationsList(
        \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1p1alpha1/{name}', \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\SecuritycenterOrganizationsOperationsListResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
