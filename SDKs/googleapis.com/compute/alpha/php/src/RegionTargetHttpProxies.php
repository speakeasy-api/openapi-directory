...
class RegionTargetHttpProxies 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsResponse
     */
	public function computeRegionTargetHttpProxiesTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/targetHttpProxies/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRegionTargetHttpProxiesTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
