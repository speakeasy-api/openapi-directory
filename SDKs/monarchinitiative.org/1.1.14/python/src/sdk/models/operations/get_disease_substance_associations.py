...
class GetDiseaseSubstanceAssociationsRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""CURIE identifier of disease, e.g. DOID:2841 (asthma). Equivalent IDs not yet supported"""  
...
@dataclasses.dataclass
class GetDiseaseSubstanceAssociationsResponse:
