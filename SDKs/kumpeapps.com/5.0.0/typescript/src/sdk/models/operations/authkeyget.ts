...
export class AuthkeyGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AuthkeyGetRequest extends SpeakeasyBase {
  /**
...
export class AuthkeyGetResponse extends SpeakeasyBase {
  /**
   * Access Denied
   */
  @SpeakeasyMetadata()
