...
public class ListStageDeploymentsQueryParams {
    /**
    ...
    public ListStageDeploymentsQueryParams withMaxResults(Long maxResults) {
    ...
    public ListStageDeploymentsQueryParams withNextToken(String nextToken) {
