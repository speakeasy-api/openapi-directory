...
export enum NetworkAttachmentConnectionPreferenceEnum {
 ...
 */
export class NetworkAttachment extends SpeakeasyBase {
  /**
   * [Output Only] An array of connections for all the producers connected to this network attachment.
   */
  @SpeakeasyMetadata({ elemType: NetworkAttachmentConnectedEndpoint })
  @Expose({ name: "connectionEndpoints" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "producerAcceptLists" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "producerRejectLists" })
