...
class GetInAppMessagesPathParams:
...
class GetInAppMessagesRequest:
    headers: GetInAppMessagesHeaders = dataclasses.field()
    path_params: GetInAppMessagesPathParams = dataclasses.field()
