...
exports.PostProductsIdAttachmentsJsonResponse = exports.PostProductsIdAttachmentsJsonRequest = void 0;
...
var PostProductsIdAttachmentsJsonRequest = /** @class */ (function (_super) {
    ...
    ], PostProductsIdAttachmentsJsonRequest.prototype, "attachmentEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PostProductsIdAttachmentsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PostProductsIdAttachmentsJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PostProductsIdAttachmentsJsonRequest.prototype, "login", void 0);
    return PostProductsIdAttachmentsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdAttachmentsJsonRequest = PostProductsIdAttachmentsJsonRequest;
var PostProductsIdAttachmentsJsonResponse = /** @class */ (function (_super) {
    ...
    ], PostProductsIdAttachmentsJsonResponse.prototype, "rawResponse", void 0);
    return PostProductsIdAttachmentsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PostProductsIdAttachmentsJsonResponse = PostProductsIdAttachmentsJsonResponse;
