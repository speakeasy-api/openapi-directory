...
class DeleteSpacesSpaceIDFoldersFolderIDContractualDocumentsDocumentIDRequest:
...
@dataclasses.dataclass
class DeleteSpacesSpaceIDFoldersFolderIDContractualDocumentsDocumentIDResponse:
