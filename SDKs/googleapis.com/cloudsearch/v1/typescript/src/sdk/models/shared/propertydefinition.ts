...
export class PropertyDefinition extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "booleanPropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "datePropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "doublePropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enumPropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "htmlPropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "integerPropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "isWildcardSearchable" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "objectPropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "textPropertyOptions" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "timestampPropertyOptions" })
