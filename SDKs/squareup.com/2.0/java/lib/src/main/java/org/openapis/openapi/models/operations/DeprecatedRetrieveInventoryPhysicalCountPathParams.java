...
public class DeprecatedRetrieveInventoryPhysicalCountPathParams {
    /**
     * ID of the
    ...
    public DeprecatedRetrieveInventoryPhysicalCountPathParams withPhysicalCountId(String physicalCountId) {
