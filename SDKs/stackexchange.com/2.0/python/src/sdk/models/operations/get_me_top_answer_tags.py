...
class GetMeTopAnswerTagsQueryParams:
...
@dataclasses.dataclass
class GetMeTopAnswerTagsRequest:
    query_params: GetMeTopAnswerTagsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetMeTopAnswerTagsResponse:
