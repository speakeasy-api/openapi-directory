...
type FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest struct {
	...
	GoogleFirebaseAppcheckV1betaExchangeRecaptchaEnterpriseTokenRequest *shared.GoogleFirebaseAppcheckV1betaExchangeRecaptchaEnterpriseTokenRequest `request:"mediaType=application/json"`
	// OAuth access token.
