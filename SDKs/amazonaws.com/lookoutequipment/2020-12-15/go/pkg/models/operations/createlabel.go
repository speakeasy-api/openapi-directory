...
func (e CreateLabelXAmzTargetEnum) ToPointer() *CreateLabelXAmzTargetEnum {
	return &e
}
...
func (e *CreateLabelXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSLookoutEquipmentFrontendService.CreateLabel":
		*e = CreateLabelXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateLabelXAmzTargetEnum: %v", v)
	}
}
