...
exports.GetTagFromJournalLineResponse = exports.GetTagFromJournalLineRequest = void 0;
...
var GetTagFromJournalLineRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromJournalLineRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromJournalLineRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromJournalLineRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=JournalLineId",
        }),
        __metadata("design:type", String)
    ], GetTagFromJournalLineRequest.prototype, "journalLineId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromJournalLineRequest.prototype, "tagId", void 0);
    return GetTagFromJournalLineRequest;
}(utils_1.SpeakeasyBase));
exports.GetTagFromJournalLineRequest = GetTagFromJournalLineRequest;
var GetTagFromJournalLineResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromJournalLineResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.GetTagFromJournalLineResponse = GetTagFromJournalLineResponse;
