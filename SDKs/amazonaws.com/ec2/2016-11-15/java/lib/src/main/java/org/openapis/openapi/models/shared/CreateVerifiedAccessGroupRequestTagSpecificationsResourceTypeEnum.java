 ...
 */
public enum CreateVerifiedAccessGroupRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateVerifiedAccessGroupRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
