...
class DisableRegionRequest:
    ...
    request_body: DisableRegionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
