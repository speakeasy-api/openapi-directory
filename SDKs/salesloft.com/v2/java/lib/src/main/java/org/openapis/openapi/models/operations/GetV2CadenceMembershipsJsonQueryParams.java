...
public class GetV2CadenceMembershipsJsonQueryParams {
    /**
    ...
    public GetV2CadenceMembershipsJsonQueryParams withCadenceId(Long cadenceId) {
    ...
    public GetV2CadenceMembershipsJsonQueryParams withCurrentlyOnCadence(Boolean currentlyOnCadence) {
    ...
    public Long[] ids;
    public GetV2CadenceMembershipsJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2CadenceMembershipsJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2CadenceMembershipsJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2CadenceMembershipsJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2CadenceMembershipsJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2CadenceMembershipsJsonQueryParams withPersonId(Long personId) {
    ...
    public GetV2CadenceMembershipsJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2CadenceMembershipsJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2CadenceMembershipsJsonQueryParams withUpdatedAt(String[] updatedAt) {
