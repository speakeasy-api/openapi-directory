...
class CreateAPIRequestBody:
    ...
    protocol_type: CreateAPIRequestBodyProtocolTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocolType') }})
    r"""Represents a protocol type."""  
    ...
    cors_configuration: Optional[CreateAPIRequestBodyCorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('corsConfiguration'), 'exclude': lambda f: f is None }})
    r"""Represents a CORS configuration. Supported only for HTTP APIs. See <a href=\\"https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-cors.html\\">Configuring CORS</a> for more information."""  
...
class CreateAPIRequest:
    ...
    request_body: CreateAPIRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
