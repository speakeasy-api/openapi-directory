...
exports.SearchCommitsResponse = exports.SearchCommits200ApplicationJSON = exports.SearchCommits415ApplicationJSON = exports.SearchCommitsRequest = exports.SearchCommitsSortEnum = void 0;
...
var SearchCommitsRequest = /** @class */ (function (_super) {
    ...
    ], SearchCommitsRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], SearchCommitsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], SearchCommitsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=q" }),
        __metadata("design:type", String)
    ], SearchCommitsRequest.prototype, "q", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], SearchCommitsRequest.prototype, "sort", void 0);
...
var SearchCommits200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.CommitSearchResultItem }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Type)(function () { return shared.CommitSearchResultItem; }),
...
var SearchCommitsResponse = /** @class */ (function (_super) {
    ...
    ], SearchCommitsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
