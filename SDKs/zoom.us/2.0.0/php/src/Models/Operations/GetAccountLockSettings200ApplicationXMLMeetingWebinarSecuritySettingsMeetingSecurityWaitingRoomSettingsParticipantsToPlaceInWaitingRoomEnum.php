 ...
 */
enum GetAccountLockSettings200ApplicationXMLMeetingWebinarSecuritySettingsMeetingSecurityWaitingRoomSettingsParticipantsToPlaceInWaitingRoomEnum: string
{
    case ZERO = '0';
    case ONE = '1';
    case TWO = '2';
