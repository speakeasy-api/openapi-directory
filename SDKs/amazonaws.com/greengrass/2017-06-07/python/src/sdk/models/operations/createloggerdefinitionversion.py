...
from ..shared import createloggerdefinitionversionresponse as shared_createloggerdefinitionversionresponse
...
class CreateLoggerDefinitionVersionRequest:
    headers: CreateLoggerDefinitionVersionHeaders = dataclasses.field()
    path_params: CreateLoggerDefinitionVersionPathParams = dataclasses.field()
    request: CreateLoggerDefinitionVersionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateLoggerDefinitionVersionResponse:
    ...
    create_logger_definition_version_response: Optional[shared_createloggerdefinitionversionresponse.CreateLoggerDefinitionVersionResponse] = dataclasses.field(default=None)
