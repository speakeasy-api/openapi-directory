...
export class CloudchannelAccountsReportJobsFetchReportResultsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsReportJobsFetchReportResultsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsReportJobsFetchReportResultsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
