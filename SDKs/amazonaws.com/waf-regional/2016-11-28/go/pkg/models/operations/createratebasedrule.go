...
const (
	CreateRateBasedRuleXAmzTargetEnumAwswafRegional20161128CreateRateBasedRule CreateRateBasedRuleXAmzTargetEnum = "AWSWAF_Regional_20161128.CreateRateBasedRule"
)
