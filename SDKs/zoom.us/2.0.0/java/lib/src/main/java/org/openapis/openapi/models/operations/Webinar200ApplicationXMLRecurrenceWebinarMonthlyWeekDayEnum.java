 ...
 */
public enum Webinar200ApplicationXMLRecurrenceWebinarMonthlyWeekDayEnum {
    ONE("1"),
    TWO("2"),
    THREE("3"),
    FOUR("4"),
    ...
    private Webinar200ApplicationXMLRecurrenceWebinarMonthlyWeekDayEnum(String value) {
        this.value = value;
    }
}
