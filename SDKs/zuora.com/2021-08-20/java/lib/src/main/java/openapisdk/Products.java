...
public class Products {
    ...
    **/
    public openapisdk.models.operations.ObjectDeleteProductResponse objectDeleteProduct(openapisdk.models.operations.ObjectDeleteProductRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/object/product/{id}", request.pathParams);
        ...
        openapisdk.models.operations.ObjectDeleteProductResponse res = new openapisdk.models.operations.ObjectDeleteProductResponse() {{
    ...
    **/
    public openapisdk.models.operations.ObjectGetProductResponse objectGetProduct(openapisdk.models.operations.ObjectGetProductRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/object/product/{id}", request.pathParams);
        ...
        openapisdk.models.operations.ObjectGetProductResponse res = new openapisdk.models.operations.ObjectGetProductResponse() {{
            proxyGetProduct = null;
            proxyUnauthorizedResponse = null;
    ...
    **/
    public openapisdk.models.operations.ObjectPostProductResponse objectPostProduct(openapisdk.models.operations.ObjectPostProductRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/object/product");
        ...
        openapisdk.models.operations.ObjectPostProductResponse res = new openapisdk.models.operations.ObjectPostProductResponse() {{
    ...
    **/
    public openapisdk.models.operations.ObjectPutProductResponse objectPutProduct(openapisdk.models.operations.ObjectPutProductRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/object/product/{id}", request.pathParams);
        ...
        openapisdk.models.operations.ObjectPutProductResponse res = new openapisdk.models.operations.ObjectPutProductResponse() {{
            proxyCreateOrModifyResponse = null;
            proxyUnauthorizedResponse = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
