...
class UpdateArtifactRuleConfigRequest:
    ...
    rule_path_parameter: UpdateArtifactRuleConfigRuleEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'rule', 'style': 'simple', 'explode': False }})
    r"""The unique name/type of a rule."""  
...
class UpdateArtifactRuleConfigResponse:
    ...
    r"""Rule configuration was updated."""  
