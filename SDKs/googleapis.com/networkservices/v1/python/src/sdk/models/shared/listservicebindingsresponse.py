...
class ListServiceBindingsResponse:
    ...
    service_bindings: Optional[list[shared_servicebinding.ServiceBinding]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('serviceBindings'), 'exclude': lambda f: f is None }})
    r"""List of ServiceBinding resources."""  
