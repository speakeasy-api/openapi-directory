 ...
 * @access public
 */
class CreateNetworkAclRequestTagSpecifications
{
	
    public ?CreateNetworkAclRequestTagSpecificationsResourceTypeEnum $resourceType = null;
    
    /**
     * $tags
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\CreateNetworkAclRequestTagSpecificationsTags> $tags
     */
