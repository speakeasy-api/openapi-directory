...
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#create-a-new-authorization>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#delete-an-authorization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteAuthorizationRequest req = new OauthAuthorizationsDeleteAuthorizationRequest(970732L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#delete-a-grant>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteGrantRequest req = new OauthAuthorizationsDeleteGrantRequest(746837L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#get-a-single-authorization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetAuthorizationRequest req = new OauthAuthorizationsGetAuthorizationRequest(3860L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#get-a-single-grant>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetGrantRequest req = new OauthAuthorizationsGetGrantRequest(608989L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppRequestBody("eos") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app-and-fingerprint>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequestBody("accusamus") {{
                                note = "Update all gems";
                                noteUrl = "voluptatibus";
                                scopes = new String[]{{
                                    add("omnis"),
                                    add("delectus"),
                                    add("minima"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#list-your-authorizations>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#list-your-grants>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/oauth-authorizations#update-an-existing-authorization>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsUpdateAuthorizationRequest req = new OauthAuthorizationsUpdateAuthorizationRequest(520761L) {{
