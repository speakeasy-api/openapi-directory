...
exports.GetTagFromHolidaySchemeResponse = exports.GetTagFromHolidaySchemeRequest = void 0;
...
var GetTagFromHolidaySchemeRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromHolidaySchemeRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=HolidaySchemeId",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRequest.prototype, "holidaySchemeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromHolidaySchemeRequest.prototype, "tagId", void 0);
...
var GetTagFromHolidaySchemeResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromHolidaySchemeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
