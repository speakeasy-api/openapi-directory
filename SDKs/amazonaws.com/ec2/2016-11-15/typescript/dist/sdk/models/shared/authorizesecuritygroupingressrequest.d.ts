 ...
 */
export declare enum AuthorizeSecurityGroupIngressRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class AuthorizeSecurityGroupIngressRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class AuthorizeSecurityGroupIngressRequestTagSpecifications extends SpeakeasyBase {
...
export declare class AuthorizeSecurityGroupIngressRequest extends SpeakeasyBase {
    cidrIp?: string;
    dryRun?: boolean;
    fromPort?: number;
    groupId?: string;
