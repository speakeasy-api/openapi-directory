...
exports.GetOpsMetadataResponse = exports.GetOpsMetadataRequest = exports.GetOpsMetadataXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GetOpsMetadataXAmzTargetEnum;
(function (GetOpsMetadataXAmzTargetEnum) {
    GetOpsMetadataXAmzTargetEnum["AmazonSSMGetOpsMetadata"] = "AmazonSSM.GetOpsMetadata";
})(GetOpsMetadataXAmzTargetEnum = exports.GetOpsMetadataXAmzTargetEnum || (exports.GetOpsMetadataXAmzTargetEnum = {}));
var GetOpsMetadataRequest = /** @class */ (function (_super) {
    ...
    ], GetOpsMetadataRequest.prototype, "getOpsMetadataRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], GetOpsMetadataRequest.prototype, "xAmzTarget", void 0);
...
var GetOpsMetadataResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetOpsMetadataResponse.prototype, "rawResponse", void 0);
    return GetOpsMetadataResponse;
}(utils_1.SpeakeasyBase));
exports.GetOpsMetadataResponse = GetOpsMetadataResponse;
