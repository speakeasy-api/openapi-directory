...
var DataFlow = /** @class */ (function () {
     ...
     *
    **/
    DataFlow.prototype.postV05HealthInformationCmOnRequest = function (req, config) {
        var _a;
     ...
     *
    **/
    DataFlow.prototype.postV05HealthInformationCmRequest = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    DataFlow.prototype.postV05HealthInformationHipOnRequest = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
