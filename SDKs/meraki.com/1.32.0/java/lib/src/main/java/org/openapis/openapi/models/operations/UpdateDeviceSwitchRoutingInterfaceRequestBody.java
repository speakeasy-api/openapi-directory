...
public class UpdateDeviceSwitchRoutingInterfaceRequestBody {
    ...
    public UpdateDeviceSwitchRoutingInterfaceRequestBody withDefaultGateway(String defaultGateway) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("ipv6")
    public UpdateDeviceSwitchRoutingInterfaceRequestBodyIpv6 ipv6;

    public UpdateDeviceSwitchRoutingInterfaceRequestBody withIpv6(UpdateDeviceSwitchRoutingInterfaceRequestBodyIpv6 ipv6) {
        this.ipv6 = ipv6;
        return this;
    }
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("ospfV3")
    public UpdateDeviceSwitchRoutingInterfaceRequestBodyOspfV3 ospfV3;

    public UpdateDeviceSwitchRoutingInterfaceRequestBody withOspfV3(UpdateDeviceSwitchRoutingInterfaceRequestBodyOspfV3 ospfV3) {
        this.ospfV3 = ospfV3;
        return this;
    }
    ...
    public UpdateDeviceSwitchRoutingInterfaceRequestBody(){}
}
