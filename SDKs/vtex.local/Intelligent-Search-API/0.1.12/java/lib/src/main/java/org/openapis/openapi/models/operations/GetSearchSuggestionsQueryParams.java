...
public class GetSearchSuggestionsQueryParams {
    /**
    ...
    public GetSearchSuggestionsQueryParams withLocale(String locale) {
        this.locale = locale;
        return this;
    }
    ...
    public String query;
    public GetSearchSuggestionsQueryParams withQuery(String query) {
        this.query = query;
        return this;
    }
