...
class CreateRouteCalculatorRequestBody:
    ...
    pricing_plan: CreateRouteCalculatorRequestBodyPricingPlanEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PricingPlan') }})
...
class CreateRouteCalculatorRequest:
    headers: CreateRouteCalculatorHeaders = dataclasses.field()
    request: CreateRouteCalculatorRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
