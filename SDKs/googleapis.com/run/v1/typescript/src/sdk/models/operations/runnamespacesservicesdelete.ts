...
export class RunNamespacesServicesDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunNamespacesServicesDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunNamespacesServicesDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
