...
class DescribeIpamResourceDiscoveryAssociationsRequest:
    ...
    filters: Optional[list[DescribeIpamResourceDiscoveryAssociationsRequestFilters]] = dataclasses.field(default=None)  
    ipam_resource_discovery_association_ids: Optional[list[str]] = dataclasses.field(default=None)  
