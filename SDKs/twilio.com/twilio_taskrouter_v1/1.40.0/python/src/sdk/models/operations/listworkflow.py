...
class ListWorkflowRequest:
    ...
    r"""The SID of the Workspace with the Workflow to read."""  
    ...
    r"""The `friendly_name` of the Workflow resources to read."""  
...
class ListWorkflowListWorkflowResponse:
    ...
    meta: Optional[ListWorkflowListWorkflowResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    workflows: Optional[list[shared_taskrouter_v1_workspace_workflow.TaskrouterV1WorkspaceWorkflow]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('workflows'), 'exclude': lambda f: f is None }})  
