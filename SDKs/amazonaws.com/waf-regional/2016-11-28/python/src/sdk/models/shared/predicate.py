...
import dataclasses
from ..shared import predicatetype_enum as shared_predicatetype_enum
...
class Predicate:
    ...
    data_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DataId') }})  
    negated: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Negated') }})  
    type: shared_predicatetype_enum.PredicateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Type') }})  
