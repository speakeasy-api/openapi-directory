...
func (e UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesProtocolEnum) ToPointer() *UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesProtocolEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesProtocolEnum) UnmarshalJSON(data []byte) error {
	...
	case "tcp":
		fallthrough
	case "udp":
		*e = UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesProtocolEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesProtocolEnum: %v", v)
	}
}
...
func (e UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesUplinkEnum) ToPointer() *UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesUplinkEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesUplinkEnum) UnmarshalJSON(data []byte) error {
	...
	case "internet1":
		fallthrough
	case "internet2":
		*e = UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesUplinkEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesUplinkEnum: %v", v)
	}
}
...
type UpdateNetworkApplianceFirewallPortForwardingRulesRequest struct {
	RequestBody UpdateNetworkApplianceFirewallPortForwardingRulesRequestBody `request:"mediaType=application/json"`
