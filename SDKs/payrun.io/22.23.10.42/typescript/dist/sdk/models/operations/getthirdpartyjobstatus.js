...
exports.GetThirdPartyJobStatusResponse = exports.GetThirdPartyJobStatusRequest = void 0;
...
var GetThirdPartyJobStatusRequest = /** @class */ (function (_super) {
    ...
    ], GetThirdPartyJobStatusRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetThirdPartyJobStatusRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=JobId",
        }),
        __metadata("design:type", String)
    ], GetThirdPartyJobStatusRequest.prototype, "jobId", void 0);
    return GetThirdPartyJobStatusRequest;
}(utils_1.SpeakeasyBase));
exports.GetThirdPartyJobStatusRequest = GetThirdPartyJobStatusRequest;
var GetThirdPartyJobStatusResponse = /** @class */ (function (_super) {
    ...
    ], GetThirdPartyJobStatusResponse.prototype, "rawResponse", void 0);
    return GetThirdPartyJobStatusResponse;
}(utils_1.SpeakeasyBase));
exports.GetThirdPartyJobStatusResponse = GetThirdPartyJobStatusResponse;
