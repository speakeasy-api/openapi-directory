...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotAddSelectedRepoToOrgSecretRequest req = new DependabotAddSelectedRepoToOrgSecretRequest("et", 456911L, "eveniet");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotCreateOrUpdateOrgSecretRequest req = new DependabotCreateOrUpdateOrgSecretRequest(                new DependabotCreateOrUpdateOrgSecretRequestBody(DependabotCreateOrUpdateOrgSecretRequestBodyVisibilityEnum.SELECTED) {{
    ...
    public static void main(String[] args) {
        try {
            ...
            DependabotCreateOrUpdateRepoSecretRequest req = new DependabotCreateOrUpdateRepoSecretRequest(                new DependabotCreateOrUpdateRepoSecretRequestBody() {{
                                encryptedValue = "harum";
                                keyId = "molestiae";
                            }};, "rerum", "occaecati", "minima");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotDeleteOrgSecretRequest req = new DependabotDeleteOrgSecretRequest("distinctio", "eligendi");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotDeleteRepoSecretRequest req = new DependabotDeleteRepoSecretRequest("sit", "culpa", "tempore");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetOrgPublicKeyRequest req = new DependabotGetOrgPublicKeyRequest("adipisci");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetOrgSecretRequest req = new DependabotGetOrgSecretRequest("cumque", "consequuntur");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetRepoPublicKeyRequest req = new DependabotGetRepoPublicKeyRequest("consequatur", "minus");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotGetRepoSecretRequest req = new DependabotGetRepoSecretRequest("quaerat", "sapiente", "consectetur");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotListOrgSecretsRequest req = new DependabotListOrgSecretsRequest("esse") {{
                page = 503427L;
                perPage = 590984L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotListRepoSecretsRequest req = new DependabotListRepoSecretsRequest("a", "nulla") {{
                page = 557811L;
                perPage = 457223L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotListSelectedReposForOrgSecretRequest req = new DependabotListSelectedReposForOrgSecretRequest("quasi", "a") {{
                page = 621679L;
                perPage = 575751L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DependabotRemoveSelectedRepoFromOrgSecretRequest req = new DependabotRemoveSelectedRepoFromOrgSecretRequest("pariatur", 820767L, "quia");            
