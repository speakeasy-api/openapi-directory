...
class AndroidpublisherEditsExpansionfilesUploadPathParams:
    ...
    expansion_file_type: AndroidpublisherEditsExpansionfilesUploadExpansionFileTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'expansionFileType', 'style': 'simple', 'explode': False }})
...
class AndroidpublisherEditsExpansionfilesUploadRequest:
    path_params: AndroidpublisherEditsExpansionfilesUploadPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsExpansionfilesUploadQueryParams = dataclasses.field()
    security: AndroidpublisherEditsExpansionfilesUploadSecurity = dataclasses.field()
