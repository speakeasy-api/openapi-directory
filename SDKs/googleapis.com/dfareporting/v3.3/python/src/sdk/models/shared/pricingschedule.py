...
class PricingSchedule:
    ...
    r"""Placement cap cost option."""  
    disregard_overdelivery: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('disregardOverdelivery'), 'exclude': lambda f: f is None }})
    r"""Whether cap costs are ignored by ad serving."""  
