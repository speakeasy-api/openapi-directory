...
public class Oidc {
     ...
     * https://docs.github.com/enterprise-server@3.7/rest/actions/oidc#get-the-customization-template-for-an-oidc-subject-claim-for-an-organization - API method documentation
     ...
     * https://docs.github.com/enterprise-server@3.7/rest/actions/oidc#set-the-customization-template-for-an-oidc-subject-claim-for-an-organization - API method documentation
     * @param request the request object containing all of the parameters for the API call
     * @return the response from the API call
     * @throws Exception if the API call fails
     */
