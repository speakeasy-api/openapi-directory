 ...
 */
export enum SecurityPolicyListWarningCodeEnum {
...
export class SecurityPolicyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SecurityPolicyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SecurityPolicyListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class SecurityPolicyList extends SpeakeasyBase {
  /**
