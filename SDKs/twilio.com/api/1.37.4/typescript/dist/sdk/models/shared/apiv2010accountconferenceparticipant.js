...
exports.ApiV2010AccountConferenceParticipant = void 0;
var utils_1 = require("../../../internal/utils");
var participantenumstatusenum_1 = require("./participantenumstatusenum");
var ApiV2010AccountConferenceParticipant = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=call_sid_to_coach" }),
        __metadata("design:type", String)
    ], ApiV2010AccountConferenceParticipant.prototype, "callSidToCoach", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=coaching" }),
        __metadata("design:type", Boolean)
    ], ApiV2010AccountConferenceParticipant.prototype, "coaching", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=conference_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=end_conference_on_exit" }),
        __metadata("design:type", Boolean)
    ], ApiV2010AccountConferenceParticipant.prototype, "endConferenceOnExit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hold" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=muted" }),
        __metadata("design:type", Boolean)
    ], ApiV2010AccountConferenceParticipant.prototype, "muted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=start_conference_on_enter" }),
        __metadata("design:type", Boolean)
...
exports.ApiV2010AccountConferenceParticipant = ApiV2010AccountConferenceParticipant;
