...
from ..shared import jobpatchparameter as shared_jobpatchparameter
...
class JobPatchRequest:
    ...
    job_patch_parameter: shared_jobpatchparameter.JobPatchParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
