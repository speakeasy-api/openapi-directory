...
func (e UploadFileAsMultipartPublic1XSdsDateFormatEnum) ToPointer() *UploadFileAsMultipartPublic1XSdsDateFormatEnum {
	return &e
}
...
func (e *UploadFileAsMultipartPublic1XSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = UploadFileAsMultipartPublic1XSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UploadFileAsMultipartPublic1XSdsDateFormatEnum: %v", v)
	}
}
