...
func (s *sellerFundsSummary) GetSellerFundsSummary(ctx context.Context, request operations.GetSellerFundsSummaryRequest, security operations.GetSellerFundsSummarySecurity) (*operations.GetSellerFundsSummaryResponse, error) {
	baseURL := s.serverURL
