...
class SDK:
    r"""These APIs allow you to interact with HubSpot's Marketing Events Extension. It allows you to:
    ...
    * Specify a URL that can be called to get the details of a Marketing Event.
    ...
    search: Search
    r"""Endpoints that allow you to search for Marketing Events in HubSpot."""
