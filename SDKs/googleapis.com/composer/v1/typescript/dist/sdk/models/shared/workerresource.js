...
var WorkerResource = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=memoryGb" }),
        __metadata("design:type", Number)
    ], WorkerResource.prototype, "memoryGb", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=minCount" }),
        __metadata("design:type", Number)
    ], WorkerResource.prototype, "minCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=storageGb" }),
        __metadata("design:type", Number)
