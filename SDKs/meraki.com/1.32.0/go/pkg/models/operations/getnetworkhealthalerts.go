...
func (e GetNetworkHealthAlerts200ApplicationJSONSeverityEnum) ToPointer() *GetNetworkHealthAlerts200ApplicationJSONSeverityEnum {
	return &e
}
...
func (e *GetNetworkHealthAlerts200ApplicationJSONSeverityEnum) UnmarshalJSON(data []byte) error {
	...
	case "info":
		fallthrough
	case "warning":
		*e = GetNetworkHealthAlerts200ApplicationJSONSeverityEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkHealthAlerts200ApplicationJSONSeverityEnum: %v", v)
	}
}
