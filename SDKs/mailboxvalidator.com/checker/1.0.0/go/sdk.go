...
func (s *SDK) GetV1EmailFree(ctx context.Context, request operations.GetV1EmailFreeRequest) (*operations.GetV1EmailFreeResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/email/free"
	...
	res := &operations.GetV1EmailFreeResponse{
