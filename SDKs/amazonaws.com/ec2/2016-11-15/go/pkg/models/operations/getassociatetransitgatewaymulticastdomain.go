...
func (e *GETAssociateTransitGatewayMulticastDomainActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "AssociateTransitGatewayMulticastDomain":
		*e = GETAssociateTransitGatewayMulticastDomainActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETAssociateTransitGatewayMulticastDomainActionEnum: %s", s)
	}
}
...
func (e *GETAssociateTransitGatewayMulticastDomainVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2016-11-15":
		*e = GETAssociateTransitGatewayMulticastDomainVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GETAssociateTransitGatewayMulticastDomainVersionEnum: %s", s)
	}
}
