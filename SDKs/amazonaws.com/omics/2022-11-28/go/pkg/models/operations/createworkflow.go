...
func (e CreateWorkflowRequestBodyEngineEnum) ToPointer() *CreateWorkflowRequestBodyEngineEnum {
	return &e
}
...
func (e *CreateWorkflowRequestBodyEngineEnum) UnmarshalJSON(data []byte) error {
	...
	case "WDL":
		fallthrough
	case "NEXTFLOW":
		*e = CreateWorkflowRequestBodyEngineEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateWorkflowRequestBodyEngineEnum: %v", v)
	}
}
