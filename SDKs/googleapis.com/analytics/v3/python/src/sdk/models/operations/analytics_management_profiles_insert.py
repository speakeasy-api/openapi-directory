...
class AnalyticsManagementProfilesInsertRequest:
    path_params: AnalyticsManagementProfilesInsertPathParams = dataclasses.field()
    query_params: AnalyticsManagementProfilesInsertQueryParams = dataclasses.field()
    security: AnalyticsManagementProfilesInsertSecurity = dataclasses.field()
