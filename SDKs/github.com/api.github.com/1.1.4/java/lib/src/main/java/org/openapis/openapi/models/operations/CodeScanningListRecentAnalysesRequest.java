...
public class CodeScanningListRecentAnalysesRequest {
    ...
    public CodeScanningListRecentAnalysesRequest withDirection(org.openapis.openapi.models.shared.DirectionEnum direction) {
    ...
    public CodeScanningListRecentAnalysesSortEnum sort;
    public CodeScanningListRecentAnalysesRequest withSort(CodeScanningListRecentAnalysesSortEnum sort) {
        this.sort = sort;
        return this;
    }
