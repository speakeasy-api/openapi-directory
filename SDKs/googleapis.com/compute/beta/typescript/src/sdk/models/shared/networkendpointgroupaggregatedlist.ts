...
import { NetworkEndpointGroupsScopedList } from "./networkendpointgroupsscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum NetworkEndpointGroupAggregatedListWarningCodeEnum {
...
export class NetworkEndpointGroupAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkEndpointGroupAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: NetworkEndpointGroupAggregatedListWarningCodeEnum;
  ...
  data?: NetworkEndpointGroupAggregatedListWarningData[];
 ...
 * Successful response
 */
export class NetworkEndpointGroupAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkEndpointGroupsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, NetworkEndpointGroupsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], NetworkEndpointGroupsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
