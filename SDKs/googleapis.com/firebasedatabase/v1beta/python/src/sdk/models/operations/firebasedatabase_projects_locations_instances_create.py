...
class FirebasedatabaseProjectsLocationsInstancesCreateRequest:
    ...
    r"""Required. The parent project for which to create a database instance, in the form: `projects/{project-number}/locations/{location-id}`."""  
    ...
    r"""The globally unique identifier of the database instance."""  
    ...
    r"""When set to true, the request will be validated but not submitted."""  
