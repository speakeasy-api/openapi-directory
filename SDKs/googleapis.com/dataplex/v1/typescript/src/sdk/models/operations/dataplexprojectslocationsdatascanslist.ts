...
export class DataplexProjectsLocationsDataScansListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataScansListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsDataScansListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
