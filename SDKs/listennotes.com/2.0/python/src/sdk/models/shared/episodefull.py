...
class EpisodeFull:
    ...
    podcast: Optional[shared_podcastsimple.PodcastSimple] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('podcast'), 'exclude': lambda f: f is None }})  
