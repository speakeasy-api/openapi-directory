...
public class UpdatePriceHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public UpdatePriceHeaders withAuthorization(String authorization) {
    ...
    public UpdatePriceHeaders withWmConsumerChannelType(String wmCONSUMERCHANNELTYPE) {
    ...
    public UpdatePriceHeaders withWmQosCorrelationId(String wmQOSCORRELATIONID) {
    ...
    public UpdatePriceHeaders withWmSecAccessToken(String wmSECACCESSTOKEN) {
    ...
    public UpdatePriceHeaders withWmSvcName(String wmSVCNAME) {
