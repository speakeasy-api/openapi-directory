...
export enum ListModelPackagesXAmzTargetEnum {
  SageMakerListModelPackages = "SageMaker.ListModelPackages",
}

export class ListModelPackagesRequest extends SpeakeasyBase {
...
export class ListModelPackagesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
