...
from ..shared import creditmemofrominvoicetype as shared_creditmemofrominvoicetype
...
class POSTCreditMemoFromInvoiceRequest:
    ...
    credit_memo_from_invoice_type: shared_creditmemofrominvoicetype.CreditMemoFromInvoiceType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    invoice_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'invoiceId', 'style': 'simple', 'explode': False }})
    r"""The ID of an invoice that you want to create a credit memo from."""  
