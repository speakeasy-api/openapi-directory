...
class GetListAttachedUserPoliciesQueryParams:
    action: GetListAttachedUserPoliciesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    user_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'UserName', 'style': 'form', 'explode': True }})
    version: GetListAttachedUserPoliciesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListAttachedUserPoliciesRequest:
    headers: GetListAttachedUserPoliciesHeaders = dataclasses.field()
    query_params: GetListAttachedUserPoliciesQueryParams = dataclasses.field()
