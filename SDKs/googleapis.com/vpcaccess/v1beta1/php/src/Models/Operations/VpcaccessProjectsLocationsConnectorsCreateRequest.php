...
class VpcaccessProjectsLocationsConnectorsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ConnectorInput $connectorInput = null;
