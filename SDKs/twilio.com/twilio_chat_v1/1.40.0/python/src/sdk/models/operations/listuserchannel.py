...
class ListUserChannelListUserChannelResponse:
    ...
    channels: Optional[list[shared_chat_v1_service_user_user_channel.ChatV1ServiceUserUserChannel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('channels'), 'exclude': lambda f: f is None }})  
