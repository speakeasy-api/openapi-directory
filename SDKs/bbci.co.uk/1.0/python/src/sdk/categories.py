...
class Categories:
    ...
    def get_sub_categories_(self, request: operations.GetSubCategoriesRequest) -> operations.GetSubCategoriesResponse:
        ...
        url = utils.generate_url(operations.GetSubCategoriesRequest, base_url, '/categories/{category}', request)
        
        query_params = utils.get_query_params(operations.GetSubCategoriesRequest, request)
        ...
        res = operations.GetSubCategoriesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
