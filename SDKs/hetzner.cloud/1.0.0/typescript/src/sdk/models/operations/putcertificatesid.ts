...
export class PutCertificatesIdCertificateResponseCertificateStatus extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PutCertificatesIdCertificateResponseCertificateStatusError)
...
export class PutCertificatesIdCertificateResponseCertificate extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "status" })
  @Type(() => PutCertificatesIdCertificateResponseCertificateStatus)
  ...
  @Expose({ name: "used_by" })
  @Type(() => PutCertificatesIdCertificateResponseCertificateUsedBy)
...
export class PutCertificatesIdCertificateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "certificate" })
  @Type(() => PutCertificatesIdCertificateResponseCertificate)
