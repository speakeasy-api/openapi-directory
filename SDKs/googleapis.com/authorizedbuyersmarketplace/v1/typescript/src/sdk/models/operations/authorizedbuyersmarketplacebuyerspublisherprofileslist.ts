...
export class AuthorizedbuyersmarketplaceBuyersPublisherProfilesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersPublisherProfilesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersPublisherProfilesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
