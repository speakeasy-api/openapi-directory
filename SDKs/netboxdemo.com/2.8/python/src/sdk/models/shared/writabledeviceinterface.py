...
class WritableDeviceInterfaceConnectionStatusEnum(str, Enum):
    FALSE = 'false'
    TRUE = 'true'
...
class WritableDeviceInterfaceInput:
    ...
    type: WritableDeviceInterfaceTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
    ...
    connection_status: Optional[WritableDeviceInterfaceConnectionStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connection_status'), 'exclude': lambda f: f is None }})  
    ...
    mode: Optional[WritableDeviceInterfaceModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mode'), 'exclude': lambda f: f is None }})  
