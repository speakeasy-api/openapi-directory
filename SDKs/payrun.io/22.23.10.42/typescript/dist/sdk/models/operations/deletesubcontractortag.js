...
exports.DeleteSubContractorTagResponse = exports.DeleteSubContractorTagRequest = void 0;
...
var DeleteSubContractorTagRequest = /** @class */ (function (_super) {
    ...
    ], DeleteSubContractorTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorTagRequest.prototype, "subContractorId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], DeleteSubContractorTagRequest.prototype, "tagId", void 0);
    return DeleteSubContractorTagRequest;
}(utils_1.SpeakeasyBase));
exports.DeleteSubContractorTagRequest = DeleteSubContractorTagRequest;
var DeleteSubContractorTagResponse = /** @class */ (function (_super) {
    ...
    ], DeleteSubContractorTagResponse.prototype, "rawResponse", void 0);
    return DeleteSubContractorTagResponse;
}(utils_1.SpeakeasyBase));
exports.DeleteSubContractorTagResponse = DeleteSubContractorTagResponse;
