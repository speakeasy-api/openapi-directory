...
class SyncV1Service:
    ...
    reachability_debouncing_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reachability_debouncing_enabled') }})
    reachability_debouncing_window: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reachability_debouncing_window') }})
    ...
    webhooks_from_rest_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('webhooks_from_rest_enabled') }})
