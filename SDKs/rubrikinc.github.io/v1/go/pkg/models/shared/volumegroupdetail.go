...
// VolumeGroupDetailSLAAssignmentEnum - The SLA assignment type. Direct SLA assignment means that a SLA Domain was configured directly on the Rubrik object by the user. Derived SLA assignment means that the Rubrik object inherits an SLA Domain from its parent Rubrik object.
type VolumeGroupDetailSLAAssignmentEnum string

const (
	VolumeGroupDetailSLAAssignmentEnumDerived    VolumeGroupDetailSLAAssignmentEnum = "Derived"
	VolumeGroupDetailSLAAssignmentEnumDirect     VolumeGroupDetailSLAAssignmentEnum = "Direct"
	VolumeGroupDetailSLAAssignmentEnumUnassigned VolumeGroupDetailSLAAssignmentEnum = "Unassigned"
)

func (e VolumeGroupDetailSLAAssignmentEnum) ToPointer() *VolumeGroupDetailSLAAssignmentEnum {
	return &e
}

func (e *VolumeGroupDetailSLAAssignmentEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "Direct":
		fallthrough
	case "Unassigned":
		*e = VolumeGroupDetailSLAAssignmentEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for VolumeGroupDetailSLAAssignmentEnum: %v", v)
	}
}

// VolumeGroupDetail - Return details about the Volume Group.
type VolumeGroupDetail struct {
	...
	SLAAssignment VolumeGroupDetailSLAAssignmentEnum `json:"slaAssignment"`
	...
	Volumes []HostVolumeSummary `json:"volumes"`
}
