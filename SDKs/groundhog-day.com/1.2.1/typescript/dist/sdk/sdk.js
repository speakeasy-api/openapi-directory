...
var groundhogs_1 = require("./groundhogs");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.groundhogs = new groundhogs_1.Groundhogs(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.predictions = new predictions_1.Predictions(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
