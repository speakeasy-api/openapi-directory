...
export class ActionWebhookFailures {
  ...
  postActionWebhookFailuresIdRetry(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PostActionWebhookFailuresIdRetryResponse =
        new operations.PostActionWebhookFailuresIdRetryResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case [201, 400, 401, 403, 404, 405, 409, 412, 422, 423, 429].includes(
          httpRes?.status
        ):
          break;
      }
