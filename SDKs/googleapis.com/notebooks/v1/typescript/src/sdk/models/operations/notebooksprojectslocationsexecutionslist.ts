...
export class NotebooksProjectsLocationsExecutionsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NotebooksProjectsLocationsExecutionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NotebooksProjectsLocationsExecutionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
