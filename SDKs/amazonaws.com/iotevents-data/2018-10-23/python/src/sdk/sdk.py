...
class SDK:
    ...
    def batch_acknowledge_alarm(self, request: operations.BatchAcknowledgeAlarmRequest) -> operations.BatchAcknowledgeAlarmResponse:
        ...
        res = operations.BatchAcknowledgeAlarmResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchAcknowledgeAlarmResponse])
    ...
    def batch_disable_alarm(self, request: operations.BatchDisableAlarmRequest) -> operations.BatchDisableAlarmResponse:
        ...
        res = operations.BatchDisableAlarmResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchDisableAlarmResponse])
    ...
    def batch_enable_alarm(self, request: operations.BatchEnableAlarmRequest) -> operations.BatchEnableAlarmResponse:
        ...
        res = operations.BatchEnableAlarmResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchEnableAlarmResponse])
    ...
    def batch_reset_alarm(self, request: operations.BatchResetAlarmRequest) -> operations.BatchResetAlarmResponse:
        ...
        res = operations.BatchResetAlarmResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchResetAlarmResponse])
    ...
    def batch_snooze_alarm(self, request: operations.BatchSnoozeAlarmRequest) -> operations.BatchSnoozeAlarmResponse:
        ...
        res = operations.BatchSnoozeAlarmResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchSnoozeAlarmResponse])
    ...
    def batch_update_detector(self, request: operations.BatchUpdateDetectorRequest) -> operations.BatchUpdateDetectorResponse:
        ...
        res = operations.BatchUpdateDetectorResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchUpdateDetectorResponse])
    ...
    def describe_alarm(self, request: operations.DescribeAlarmRequest) -> operations.DescribeAlarmResponse:
        ...
        res = operations.DescribeAlarmResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeAlarmResponse])
    ...
    def describe_detector(self, request: operations.DescribeDetectorRequest) -> operations.DescribeDetectorResponse:
        ...
        res = operations.DescribeDetectorResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeDetectorResponse])
    ...
    def list_alarms(self, request: operations.ListAlarmsRequest) -> operations.ListAlarmsResponse:
        ...
        res = operations.ListAlarmsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListAlarmsResponse])
    ...
    def list_detectors(self, request: operations.ListDetectorsRequest) -> operations.ListDetectorsResponse:
        ...
        res = operations.ListDetectorsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListDetectorsResponse])
