...
class Actions:
    ...
    def action_pos_tamend(self, request: operations.ActionPosTamendRequest) -> operations.ActionPosTamendResponse:
        ...
        **Note:** When you call this operation, Zuora modifies the subscription in the order that you specify Amendment objects in the request body.
        ...
        res = operations.ActionPosTamendResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyActionamendResponse])
    ...
    def action_pos_tcreate(self, request: operations.ActionPosTcreateRequest) -> operations.ActionPosTcreateResponse:
        ...
        * All objects must be of the same type.
        ...
        res = operations.ActionPosTcreateResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.SaveResult]])
    ...
    def action_pos_tdelete(self, request: operations.ActionPosTdeleteRequest) -> operations.ActionPosTdeleteResponse:
        ...
        * All objects in a specific delete call must be of the same type.
        ...
        res = operations.ActionPosTdeleteResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.DeleteResult]])
    ...
    def action_pos_texecute(self, request: operations.ActionPosTexecuteRequest) -> operations.ActionPosTexecuteResponse:
        ...
        * Asynchronous process: yes
        ...
        res = operations.ActionPosTexecuteResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.ExecuteResult]])
    ...
    def action_pos_tgenerate(self, request: operations.ActionPosTgenerateRequest) -> operations.ActionPosTgenerateResponse:
        ...
        * Asynchronous process: yes
        ...
        res = operations.ActionPosTgenerateResponse(status_code=r.status_code, content_type=content_type)
    ...
    def action_pos_tquery(self, request: operations.ActionPosTqueryRequest) -> operations.ActionPosTqueryResponse:
        ...
        * The default WSDL version for Actions is 79. To query objects or fields according to a different WSDL version, set the `X-Zuora-WSDL-Version` header. To find out in which WSDL version a particular object or field was introduced, see [Zuora SOAP API Version History](https://knowledgecenter.zuora.com/DC_Developers/G_SOAP_API/Zuora_SOAP_API_Version_History).
        ...
        res = operations.ActionPosTqueryResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyActionqueryResponse])
    ...
    def action_pos_tquery_more(self, request: operations.ActionPosTqueryMoreRequest) -> operations.ActionPosTqueryMoreResponse:
        ...
        **Note:** Zuora expires queryMore cursors after 15 minutes of activity.
        ...
        res = operations.ActionPosTqueryMoreResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyActionqueryMoreResponse])
    ...
    def action_pos_tsubscribe(self, request: operations.ActionPosTsubscribeRequest) -> operations.ActionPosTsubscribeResponse:
        ...
        * **Subscription number**: The value generated by Zuora automatically if you do not specify a subscription name. 
        ...
        res = operations.ActionPosTsubscribeResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.SubscribeResult]])
    ...
    def action_pos_tupdate(self, request: operations.ActionPosTupdateRequest) -> operations.ActionPosTupdateResponse:
        ...
        * The default WSDL version for Actions is 79. To update objects or fields according to a different WSDL version, set the `X-Zuora-WSDL-Version` header. To find out in which WSDL version a particular object or field was introduced, see [Zuora SOAP API Version History](https://knowledgecenter.zuora.com/DC_Developers/G_SOAP_API/Zuora_SOAP_API_Version_History).
        ...
        res = operations.ActionPosTupdateResponse(status_code=r.status_code, content_type=content_type)
