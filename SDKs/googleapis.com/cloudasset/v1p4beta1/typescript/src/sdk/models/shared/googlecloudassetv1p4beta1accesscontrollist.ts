...
export class GoogleCloudAssetV1p4beta1AccessControlList extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudAssetV1p4beta1Access })
  @Expose({ name: "accesses" })
  @Type(() => GoogleCloudAssetV1p4beta1Access)
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudAssetV1p4beta1Resource })
  @Expose({ name: "resources" })
  @Type(() => GoogleCloudAssetV1p4beta1Resource)
