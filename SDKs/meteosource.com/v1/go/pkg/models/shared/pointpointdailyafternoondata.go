...
type PointPointDailyAfternoonData struct {
	CloudCover PointPointDailyAfternoonCloudCoverData `json:"cloud_cover"`
	...
	Precipitation PointPointDailyAfternoonPrecipitationData `json:"precipitation"`
	// Atmospheric pressure at mean sea level. (afternoon avg)
	// Units: metric = hPa, us = Hg, uk = hPa, ca = kPa
	Pressure    *float64                         `json:"pressure,omitempty"`
	Probability PointPointDailyAfternoonProbData `json:"probability"`
	...
	Wind    PointPointDailyAfternoonWindData `json:"wind"`
	// Temperature 2 metres above ground. (afternoon avg)
	// Units: metric = °C, us = °F, uk = °C, ca = °C
