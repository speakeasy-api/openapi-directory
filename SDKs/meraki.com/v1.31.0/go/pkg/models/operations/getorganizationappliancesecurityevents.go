...
func (e *GetOrganizationApplianceSecurityEventsSortOrderEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "ascending":
		fallthrough
	case "descending":
		*e = GetOrganizationApplianceSecurityEventsSortOrderEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationApplianceSecurityEventsSortOrderEnum: %s", s)
	}
}
...
type GetOrganizationApplianceSecurityEventsResponse struct {
	...
	GetOrganizationApplianceSecurityEvents200ApplicationJSONObjects []map[string]interface{}
}
