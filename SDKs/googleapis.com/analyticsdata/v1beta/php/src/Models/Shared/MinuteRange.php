...
class MinuteRange
{
     ...
     * 
     * @var ?int $endMinutesAgo
     */
	#[\JMS\Serializer\Annotation\SerializedName('endMinutesAgo')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $endMinutesAgo = null;
     ...
     * 
     * @var ?int $startMinutesAgo
     */
	#[\JMS\Serializer\Annotation\SerializedName('startMinutesAgo')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $startMinutesAgo = null;
    
	public function __construct()
	{
		$this->endMinutesAgo = null;
		$this->name = null;
		$this->startMinutesAgo = null;
	}
}
