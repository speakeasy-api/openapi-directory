...
export enum GETContinueUpdateRollbackActionEnum {
  ContinueUpdateRollback = "ContinueUpdateRollback",
}

export enum GETContinueUpdateRollbackVersionEnum {
  TwoThousandAndTen0515 = "2010-05-15",
}

export class GETContinueUpdateRollbackRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=Action",
  })
  action: GETContinueUpdateRollbackActionEnum;
  ...
  version: GETContinueUpdateRollbackVersionEnum;
...
export class GETContinueUpdateRollbackResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
