...
public class BillsUpdateRequest {
    ...
    public BillsUpdateRequest(@JsonProperty("BillInput") org.openapis.openapi.models.shared.BillInput billInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.billInput = billInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
