...
type GetNhBugsBugHeaders struct {
...
type GetNhBugsBugRequest struct {
	PathParams  GetNhBugsBugPathParams
	QueryParams GetNhBugsBugQueryParams
	Headers     GetNhBugsBugHeaders
}
