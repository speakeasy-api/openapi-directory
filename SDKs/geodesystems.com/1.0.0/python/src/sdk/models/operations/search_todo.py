...
class SearchTodoQueryParams:
    ...
    search_db_todo_category: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_todo.category', 'style': 'form', 'explode': True }})
    search_db_todo_checked: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_todo.checked', 'style': 'form', 'explode': True }})
    search_db_todo_title: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_todo.title', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchTodoRequest:
    query_params: SearchTodoQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTodoResponse:
