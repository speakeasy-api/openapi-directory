...
class Objects 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicyRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicySecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicyResponse
     */
	public function storageObjectsGetIamPolicy(
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicyRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicySecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/b/{bucket}/o/{object}/iam', \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicyRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicyRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StorageObjectsGetIamPolicyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteResponse
     */
	public function storageObjectsRewrite(
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/b/{sourceBucket}/o/{sourceObject}/rewriteTo/b/{destinationBucket}/o/{destinationObject}', \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "object", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StorageObjectsRewriteResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->rewriteResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\RewriteResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicyRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicySecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicyResponse
     */
	public function storageObjectsSetIamPolicy(
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicyRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicySecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/b/{bucket}/o/{object}/iam', \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicyRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "policy", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicyRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StorageObjectsSetIamPolicyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsResponse
     */
	public function storageObjectsTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/b/{bucket}/o/{object}/iam/testPermissions', \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\StorageObjectsTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
