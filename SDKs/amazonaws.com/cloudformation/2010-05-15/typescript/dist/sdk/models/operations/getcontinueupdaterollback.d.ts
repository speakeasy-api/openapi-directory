...
export declare enum GETContinueUpdateRollbackActionEnum {
    ContinueUpdateRollback = "ContinueUpdateRollback"
}
export declare enum GETContinueUpdateRollbackVersionEnum {
    TwoThousandAndTen0515 = "2010-05-15"
}
export declare class GETContinueUpdateRollbackRequest extends SpeakeasyBase {
...
export declare class GETContinueUpdateRollbackResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
