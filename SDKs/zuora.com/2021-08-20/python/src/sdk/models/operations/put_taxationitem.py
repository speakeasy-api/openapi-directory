...
from ..shared import gettaxationitemtype as shared_gettaxationitemtype
from ..shared import puttaxationitemtype as shared_puttaxationitemtype
...
class PUTTaxationItemRequest:
    ...
    r"""The unique ID of a taxation item."""  
    put_taxation_item_type: shared_puttaxationitemtype.PUTTaxationItemType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PUTTaxationItemResponse:
    ...
    get_taxation_item_type: Optional[shared_gettaxationitemtype.GETTaxationItemType] = dataclasses.field(default=None)  
