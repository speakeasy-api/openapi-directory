...
import dataclasses
from ..shared import googlecloudretailv2betapriceinfopricerange as shared_googlecloudretailv2betapriceinfopricerange
...
class GoogleCloudRetailV2betaPriceInfo:
    ...
    price_range: Optional[shared_googlecloudretailv2betapriceinfopricerange.GoogleCloudRetailV2betaPriceInfoPriceRange] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priceRange'), 'exclude': lambda f: f is None }})
