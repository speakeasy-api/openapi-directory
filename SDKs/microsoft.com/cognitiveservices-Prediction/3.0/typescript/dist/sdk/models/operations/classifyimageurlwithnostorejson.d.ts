...
export declare class ClassifyImageUrlWithNoStoreJsonRequest extends SpeakeasyBase {
    /**
...
export declare class ClassifyImageUrlWithNoStoreJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * Error response
