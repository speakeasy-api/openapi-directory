...
class EmployeesUpdateRequest:
    headers: EmployeesUpdateHeaders = dataclasses.field()
    path_params: EmployeesUpdatePathParams = dataclasses.field()
    query_params: EmployeesUpdateQueryParams = dataclasses.field()
    request: shared_employee.EmployeeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: EmployeesUpdateSecurity = dataclasses.field()
