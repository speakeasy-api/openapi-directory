...
func (e ListIndexesRequestBodyTypeEnum) ToPointer() *ListIndexesRequestBodyTypeEnum {
	return &e
}
...
func (e *ListIndexesRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "LOCAL":
		fallthrough
	case "AGGREGATOR":
		*e = ListIndexesRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListIndexesRequestBodyTypeEnum: %v", v)
	}
}
