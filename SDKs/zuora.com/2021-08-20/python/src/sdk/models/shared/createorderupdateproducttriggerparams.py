...
class CreateOrderUpdateProductTriggerParams:
    r"""CreateOrderUpdateProductTriggerParams
    ...
    trigger_event: Optional[CreateOrderUpdateProductTriggerParamsTriggerEventEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('triggerEvent') }})
