...
public class GetModelCaseAssociationsRequest {
    ...
    public GetModelCaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetModelCaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetModelCaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetModelCaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetModelCaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetModelCaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetModelCaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetModelCaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetModelCaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetModelCaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetModelCaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetModelCaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetModelCaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
