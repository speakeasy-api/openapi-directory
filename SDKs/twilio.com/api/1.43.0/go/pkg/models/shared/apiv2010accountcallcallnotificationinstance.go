...
func (e APIV2010AccountCallCallNotificationInstanceRequestMethodEnum) ToPointer() *APIV2010AccountCallCallNotificationInstanceRequestMethodEnum {
	return &e
}
...
func (e *APIV2010AccountCallCallNotificationInstanceRequestMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountCallCallNotificationInstanceRequestMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountCallCallNotificationInstanceRequestMethodEnum: %v", v)
	}
}
