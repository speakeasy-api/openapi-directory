...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_messaging_v1_service.MessagingV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('services') }})
