...
var Reactions = /** @class */ (function () {
     ...
     */
    Reactions.prototype.postApiReactions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostApiReactionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/reactions";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostApiReactionsResponse({
     ...
     */
    Reactions.prototype.postApiReactionsToggle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostApiReactionsToggleRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/reactions/toggle";
        var client = this._securityClient || this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "post" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostApiReactionsToggleResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
