...
class MergeCombinePdfs:
    ...
    def merge_post(self, request: shared.MergeRequest) -> operations.MergePostResponse:
        ...
        **Authorization: YOUR-API-KEY**
        ...
        res = operations.MergePostResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
