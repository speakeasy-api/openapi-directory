...
class PostMerchantsMerchantIDTerminalOrdersSecurity:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDTerminalOrdersRequest:
...
@dataclasses.dataclass
class PostMerchantsMerchantIDTerminalOrdersResponse:
