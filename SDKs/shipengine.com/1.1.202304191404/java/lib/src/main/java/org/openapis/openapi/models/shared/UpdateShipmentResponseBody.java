...
public class UpdateShipmentResponseBody {
    ...
    public UpdateShipmentResponseBody withIsReturn(Boolean isReturn) {
    ...
    public UpdateShipmentResponseBody(@JsonProperty("address_validation") AddressValidationResult addressValidation, @JsonProperty("advanced_options") AdvancedShipmentOptions advancedOptions, @JsonProperty("carrier_id") String carrierId, @JsonProperty("confirmation") UpdateShipmentResponseBodyDeliveryConfirmationEnum confirmation, @JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("customs") UpdateShipmentResponseBodyInternationalShipmentOptions customs, @JsonProperty("errors") String[] errors, @JsonProperty("insurance_provider") UpdateShipmentResponseBodyInsuranceProviderEnum insuranceProvider, @JsonProperty("packages") Package[] packages, @JsonProperty("return_to") ShippingAddress returnTo, @JsonProperty("service_code") String serviceCode, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("ship_from") ShippingAddress shipFrom, @JsonProperty("ship_to") ShippingAddress shipTo, @JsonProperty("shipment_id") String shipmentId, @JsonProperty("shipment_status") UpdateShipmentResponseBodyShipmentStatusEnum shipmentStatus, @JsonProperty("tags") Tag[] tags, @JsonProperty("total_weight") UpdateShipmentResponseBodyWeight totalWeight) {
        this.addressValidation = addressValidation;
        this.advancedOptions = advancedOptions;
        this.carrierId = carrierId;
        this.confirmation = confirmation;
