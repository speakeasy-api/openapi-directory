...
class BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest:
    headers: BatchDisassociateApprovalRuleTemplateFromRepositoriesHeaders = dataclasses.field()
    request: shared_batchdisassociateapprovalruletemplatefromrepositoriesinput.BatchDisassociateApprovalRuleTemplateFromRepositoriesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
