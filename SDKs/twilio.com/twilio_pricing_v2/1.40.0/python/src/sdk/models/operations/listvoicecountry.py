...
class ListVoiceCountryListVoiceCountryResponse:
    ...
    countries: Optional[list[shared_pricing_v2_voice_voice_country.PricingV2VoiceVoiceCountry]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countries'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListVoiceCountryListVoiceCountryResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
