...
export declare class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare enum ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteForceOnlyEnum {
...
export declare class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
