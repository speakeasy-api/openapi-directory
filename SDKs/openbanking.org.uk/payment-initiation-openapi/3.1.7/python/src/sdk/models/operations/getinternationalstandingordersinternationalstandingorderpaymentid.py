...
class GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPathParams:
...
@dataclasses.dataclass
class GetInternationalStandingOrdersInternationalStandingOrderPaymentIDHeaders:
...
class GetInternationalStandingOrdersInternationalStandingOrderPaymentIDRequest:
    headers: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDHeaders = dataclasses.field()
    path_params: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPathParams = dataclasses.field()
    security: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDSecurity = dataclasses.field()
