...
class GETDescribeAccountAttributesAttributeNameEnum(str, Enum):
...
class GETDescribeAccountAttributesRequest:
    ...
    attribute_name: Optional[list[GETDescribeAccountAttributesAttributeNameEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'AttributeName', 'style': 'form', 'explode': True }})
    r"""The account attribute names."""  
