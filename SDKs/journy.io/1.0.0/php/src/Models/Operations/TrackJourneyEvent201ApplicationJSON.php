...
class TrackJourneyEvent201ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\TrackJourneyEvent201ApplicationJSONMeta')]
    public TrackJourneyEvent201ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\TrackJourneyEvent201ApplicationJSONMeta();
	}
}
