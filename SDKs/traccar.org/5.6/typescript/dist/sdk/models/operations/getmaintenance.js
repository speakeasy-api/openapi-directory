...
exports.GetMaintenanceResponse = exports.GetMaintenanceRequest = void 0;
...
var GetMaintenanceRequest = /** @class */ (function (_super) {
    ...
    ], GetMaintenanceRequest.prototype, "all", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=deviceId",
        }),
        __metadata("design:type", Number)
    ], GetMaintenanceRequest.prototype, "deviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupId",
        }),
        __metadata("design:type", Number)
    ], GetMaintenanceRequest.prototype, "groupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=refresh",
        }),
        __metadata("design:type", Boolean)
    ], GetMaintenanceRequest.prototype, "refresh", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userId",
        }),
        __metadata("design:type", Number)
    ], GetMaintenanceRequest.prototype, "userId", void 0);
...
var GetMaintenanceResponse = /** @class */ (function (_super) {
    ...
    ], GetMaintenanceResponse.prototype, "rawResponse", void 0);
