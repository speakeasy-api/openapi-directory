 ...
 */
export enum GetMandateMandateCurrencyCodeEnum {
  Eur = "EUR",
  Gbp = "GBP",
}
 ...
 * The currency.
 */
export class GetMandateMandateCurrency extends SpeakeasyBase {
  /**
   * The three letter code for the currency - either `EUR` or `GBP`.
   */
  @SpeakeasyMetadata()
 ...
 */
export enum GetMandateMandateFireRejectionReasonEnum {
 ...
 *
 */
export enum GetMandateMandateStatusEnum {
  Created = "CREATED",
  Live = "LIVE",
 ...
 */
export class GetMandateMandate extends SpeakeasyBase {
  /**
  ...
  @Type(() => GetMandateMandateCurrency)
