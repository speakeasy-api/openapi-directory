...
exports.PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeResponse = exports.PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeRequest = exports.PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurity = void 0;
...
var PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeRequest = /** @class */ (function (_super) {
    ...
    ], PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=async" }),
        __metadata("design:type", Boolean)
    ], PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeRequest.prototype, "async", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=pull_request_id",
        }),
        __metadata("design:type", Number)
    ], PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeRequest.prototype, "pullRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeRequest.prototype, "workspace", void 0);
...
var PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
