...
var ItemDraft = /** @class */ (function () {
     ...
     */
    ItemDraft.prototype.createItemDraft = function (req, security, config) {
        var _a;
        ...
        try {
            _a = utils.serializeRequestBody(req, "itemDraft", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.CreateItemDraftSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CreateItemDraftResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.itemDraftResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ItemDraftResponse);
                    }
                    break;
