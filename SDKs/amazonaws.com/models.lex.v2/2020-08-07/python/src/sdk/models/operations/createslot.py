...
class CreateSlotRequestBody:
    ...
    value_elicitation_setting: CreateSlotRequestBodyValueElicitationSetting = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('valueElicitationSetting') }})
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description') }})
    multiple_values_setting: Optional[CreateSlotRequestBodyMultipleValuesSetting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('multipleValuesSetting') }})
    obfuscation_setting: Optional[CreateSlotRequestBodyObfuscationSetting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('obfuscationSetting') }})
    

@dataclasses.dataclass
class CreateSlotRequest:
    headers: CreateSlotHeaders = dataclasses.field()
    path_params: CreateSlotPathParams = dataclasses.field()
    request: CreateSlotRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
