...
var Payment = /** @class */ (function () {
  ...
  > Learn more about [Transaction Details](https://help.vtex.com/en/tutorial/how-to-view-the-orders-details).
     ...
     */
    Payment.prototype.sendPaymentNotification2 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SendPaymentNotification2Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/orders/pvt/document/{orderId}/payment/{paymentId}/notify-payment", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.SendPaymentNotification2Response({
