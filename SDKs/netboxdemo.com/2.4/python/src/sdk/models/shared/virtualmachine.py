...
class VirtualMachine:
    ...
    primary_ip: Optional[shared_virtualmachineipaddress.VirtualMachineIPAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_ip'), 'exclude': lambda f: f is None }})  
    primary_ip4: Optional[shared_virtualmachineipaddress.VirtualMachineIPAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_ip4'), 'exclude': lambda f: f is None }})  
    primary_ip6: Optional[shared_virtualmachineipaddress.VirtualMachineIPAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_ip6'), 'exclude': lambda f: f is None }})  
    ...
    status: Optional[VirtualMachineStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
