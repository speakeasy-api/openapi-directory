...
export declare class Gists {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#check-if-a-gist-is-starred} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#create-a-gist} - API method documentation
     */
    gistsCreate(req: operations.GistsCreateRequestBody, config?: AxiosRequestConfig): Promise<operations.GistsCreateResponse>;
    /**
     * Create a gist comment
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#create-a-gist-comment} - API method documentation
     */
     ...
     * Delete a gist
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#delete-a-gist} - API method documentation
     */
    gistsDelete(req: operations.GistsDeleteRequest, config?: AxiosRequestConfig): Promise<operations.GistsDeleteResponse>;
    /**
     * Delete a gist comment
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#delete-a-gist-comment} - API method documentation
     */
     ...
     * Fork a gist
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#fork-a-gist} - API method documentation
     */
    gistsFork(req: operations.GistsForkRequest, config?: AxiosRequestConfig): Promise<operations.GistsForkResponse>;
    /**
     * Get a gist
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#get-a-gist} - API method documentation
     */
    gistsGet(req: operations.GistsGetRequest, config?: AxiosRequestConfig): Promise<operations.GistsGetResponse>;
    /**
     * Get a gist comment
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#get-a-gist-comment} - API method documentation
     */
     ...
     * Get a gist revision
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#get-a-gist-revision} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#list-gists-for-the-authenticated-user} - API method documentation
     */
    gistsList(req: operations.GistsListRequest, config?: AxiosRequestConfig): Promise<operations.GistsListResponse>;
    /**
     * List gist comments
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#list-gist-comments} - API method documentation
     */
     ...
     * List gist commits
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#list-gist-commits} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#list-gists-for-a-user} - API method documentation
     */
     ...
     * List gist forks
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#list-gist-forks} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#list-public-gists} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#list-starred-gists} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#star-a-gist} - API method documentation
     */
    gistsStar(req: operations.GistsStarRequest, config?: AxiosRequestConfig): Promise<operations.GistsStarResponse>;
    /**
     * Unstar a gist
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#unstar-a-gist} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists/#update-a-gist} - API method documentation
     */
    gistsUpdate(req: operations.GistsUpdateRequest, config?: AxiosRequestConfig): Promise<operations.GistsUpdateResponse>;
    /**
     * Update a gist comment
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/gists#update-a-gist-comment} - API method documentation
     */
