...
type DeleteEdgeDeploymentPlanHeaders struct {
...
type DeleteEdgeDeploymentPlanRequest struct {
	Headers DeleteEdgeDeploymentPlanHeaders
	Request shared.DeleteEdgeDeploymentPlanRequest `request:"mediaType=application/json"`
}
