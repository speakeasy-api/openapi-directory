...
var Products = /** @class */ (function () {
    ...
    Products.prototype.createProduct = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/organizations/{organizationId}/products", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "createProductRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/hal+json")) {
                        res.productModelHaljson = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ProductModelHaljson);
                    }
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.productModel = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ProductModel);
                    }
                    break;
    ...
    Products.prototype.deleteProduct = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/products/{productId}", req);
        var client = this._securityClient || this._defaultClient;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/hal+json")) {
                        ...
                        res.productModelHaljsons = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ProductModelHaljson, resFieldDepth);
                    }
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.productModels = [];
                        var resFieldDepth = utils.getResFieldDepth(res);
                        res.productModels = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ProductModel, resFieldDepth);
                    }
                    break;
    ...
    Products.prototype.updateProduct = function (req, config) {
        ...
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "updateProductRequest", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
            if (e instanceof Error) {
                throw new Error("Error serializing request body, cause: ".concat(e.message));
