 ...
 */
public enum CreateParticipantCreateParticipantRequestRecordingStatusCallbackMethodEnum {
    HEAD("HEAD"),
    GET("GET"),
    POST("POST"),
    PATCH("PATCH"),
    ...
    private CreateParticipantCreateParticipantRequestRecordingStatusCallbackMethodEnum(String value) {
        this.value = value;
    }
}
