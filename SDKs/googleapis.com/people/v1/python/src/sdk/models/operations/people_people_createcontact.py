...
class PeoplePeopleCreateContactQueryParams:
    ...
    sources: Optional[list[PeoplePeopleCreateContactSourcesEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sources', 'style': 'form', 'explode': True }})
...
class PeoplePeopleCreateContactRequest:
    query_params: PeoplePeopleCreateContactQueryParams = dataclasses.field()
    security: PeoplePeopleCreateContactSecurity = dataclasses.field()
