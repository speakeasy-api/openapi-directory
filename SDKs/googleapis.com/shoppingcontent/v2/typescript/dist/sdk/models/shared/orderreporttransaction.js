...
var OrderReportTransaction = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "disbursementAmount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "disbursementCreationDate" }),
        __metadata("design:type", String)
    ], OrderReportTransaction.prototype, "disbursementCreationDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "disbursementDate" }),
        __metadata("design:type", String)
    ], OrderReportTransaction.prototype, "disbursementDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "disbursementId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "productAmount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "productAmountWithRemittedTax" }),
        (0, class_transformer_1.Type)(function () { return productamount_1.ProductAmount; }),
