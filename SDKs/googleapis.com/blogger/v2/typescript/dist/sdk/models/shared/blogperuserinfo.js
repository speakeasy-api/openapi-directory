...
var BlogPerUserInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=blogId" }),
        __metadata("design:type", String)
    ], BlogPerUserInfo.prototype, "blogId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hasAdminAccess" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=photosAlbumKey" }),
        __metadata("design:type", String)
