...
class ObjectAccessControl:
    ...
    r"""The content generation of the object, if applied to an object."""  
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})
    r"""The ID of the access-control entry."""  
    kind: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kind'), 'exclude': lambda f: f is None }})
    r"""The kind of item this is. For object access control entries, this is always storage#objectAccessControl."""  
    ...
    r"""The name of the object, if applied to an object."""  
    project_team: Optional[ObjectAccessControlProjectTeam] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('projectTeam'), 'exclude': lambda f: f is None }})
    r"""The project team associated with the entity, if any."""  
    ...
    r"""The access permission for the entity."""  
