...
from ..shared import getuploadeddocumentsresponse as shared_getuploadeddocumentsresponse
...
class PostGetUploadedDocumentsResponse:
    ...
    get_uploaded_documents_response: Optional[shared_getuploadeddocumentsresponse.GetUploadedDocumentsResponse] = dataclasses.field(default=None)
