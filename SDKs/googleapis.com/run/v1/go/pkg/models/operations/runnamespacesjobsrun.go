...
type RunNamespacesJobsRunSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RunNamespacesJobsRunPathParams struct {
...
type RunNamespacesJobsRunQueryParams struct {
	// V1 error format.
...
type RunNamespacesJobsRunResponse struct {
	ContentType string
	// Successful response
