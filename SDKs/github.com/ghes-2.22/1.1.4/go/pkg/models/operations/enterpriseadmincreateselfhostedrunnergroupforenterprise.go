...
func (e *EnterpriseAdminCreateSelfHostedRunnerGroupForEnterpriseRequestBodyVisibilityEnum) UnmarshalJSON(data []byte) error {
	...
	case "selected":
		fallthrough
	case "all":
		*e = EnterpriseAdminCreateSelfHostedRunnerGroupForEnterpriseRequestBodyVisibilityEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for EnterpriseAdminCreateSelfHostedRunnerGroupForEnterpriseRequestBodyVisibilityEnum: %s", s)
	}
}
