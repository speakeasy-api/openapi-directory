...
public class GetPensionFromEmployerRequest {
    ...
    public GetPensionFromEmployerRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerId") String employerId, @JsonProperty("PensionId") String pensionId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerId = employerId;
        this.pensionId = pensionId;
