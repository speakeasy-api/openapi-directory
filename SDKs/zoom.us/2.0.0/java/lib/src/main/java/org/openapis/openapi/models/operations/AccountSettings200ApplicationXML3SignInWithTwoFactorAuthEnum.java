 ...
 * 
 */
public enum AccountSettings200ApplicationXML3SignInWithTwoFactorAuthEnum {
    ALL("all"),
    GROUP("group"),
    ROLE("role"),
    NONE("none");
    ...
    private AccountSettings200ApplicationXML3SignInWithTwoFactorAuthEnum(String value) {
        this.value = value;
    }
}
