...
try {
    ...
    $request->certificateParameters->reportdate = '25011980 or NA if report date is not available';
    $request->certificateParameters->uhid = '150801XXX - If multiple laboratory reports are found only the latest report will be fetched';
