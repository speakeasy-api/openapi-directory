...
// set.
func (s *v1beta1) ServicebrokerGetIamPolicy(ctx context.Context, request operations.ServicebrokerGetIamPolicyRequest, security operations.ServicebrokerGetIamPolicySecurity) (*operations.ServicebrokerGetIamPolicyResponse, error) {
	baseURL := s.serverURL
...
func (s *v1beta1) ServicebrokerSetIamPolicy(ctx context.Context, request operations.ServicebrokerSetIamPolicyRequest, security operations.ServicebrokerSetIamPolicySecurity) (*operations.ServicebrokerSetIamPolicyResponse, error) {
	baseURL := s.serverURL
...
func (s *v1beta1) ServicebrokerTestIamPermissions(ctx context.Context, request operations.ServicebrokerTestIamPermissionsRequest, security operations.ServicebrokerTestIamPermissionsSecurity) (*operations.ServicebrokerTestIamPermissionsResponse, error) {
	baseURL := s.serverURL
