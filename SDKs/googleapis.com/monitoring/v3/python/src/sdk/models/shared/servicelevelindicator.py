...
class ServiceLevelIndicator:
    ...
    basic_sli: Optional[shared_basicsli.BasicSli] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicSli'), 'exclude': lambda f: f is None }})
    ...
    request_based: Optional[shared_requestbasedsli.RequestBasedSli] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requestBased'), 'exclude': lambda f: f is None }})
    r"""Service Level Indicators for which atomic units of service are counted directly."""  
    windows_based: Optional[shared_windowsbasedsli.WindowsBasedSli] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('windowsBased'), 'exclude': lambda f: f is None }})
