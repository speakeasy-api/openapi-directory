...
public class ContainerProjectsZonesClustersNodePoolsGetPathParams {
    /**
    ...
    public ContainerProjectsZonesClustersNodePoolsGetPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersNodePoolsGetPathParams withNodePoolId(String nodePoolId) {
    ...
    public ContainerProjectsZonesClustersNodePoolsGetPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersNodePoolsGetPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
