...
class GooglePrivacyDlpV2StatisticalTable:
    ...
    quasi_ids: Optional[list[shared_googleprivacydlpv2quasiidentifierfield.GooglePrivacyDlpV2QuasiIdentifierField]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('quasiIds') }})
