...
exports.GetNetworkNetworkHealthChannelUtilizationResponse = exports.GetNetworkNetworkHealthChannelUtilizationRequest = void 0;
...
var GetNetworkNetworkHealthChannelUtilizationRequest = /** @class */ (function (_super) {
    ...
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "endingBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=networkId",
        }),
        __metadata("design:type", String)
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "networkId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=perPage",
        }),
        __metadata("design:type", Number)
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resolution",
        }),
        __metadata("design:type", Number)
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "resolution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startingAfter",
        }),
        __metadata("design:type", String)
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "startingAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t0" }),
        __metadata("design:type", String)
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "t0", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=t1" }),
        __metadata("design:type", String)
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "t1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timespan",
        }),
        __metadata("design:type", Number)
    ], GetNetworkNetworkHealthChannelUtilizationRequest.prototype, "timespan", void 0);
...
var GetNetworkNetworkHealthChannelUtilizationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetNetworkNetworkHealthChannelUtilizationResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Array)
    ], GetNetworkNetworkHealthChannelUtilizationResponse.prototype, "getNetworkNetworkHealthChannelUtilization200ApplicationJSONObjects", void 0);
