...
type PUTSubscriptionResumeTypeRunBillingEnum string

const (
	PUTSubscriptionResumeTypeRunBillingEnumTrue  PUTSubscriptionResumeTypeRunBillingEnum = "true"
	PUTSubscriptionResumeTypeRunBillingEnumFalse PUTSubscriptionResumeTypeRunBillingEnum = "false"
)

func (e *PUTSubscriptionResumeTypeRunBillingEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "true":
		fallthrough
	case "false":
		*e = PUTSubscriptionResumeTypeRunBillingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PUTSubscriptionResumeTypeRunBillingEnum: %s", s)
	}
}
...
type PUTSubscriptionResumeType struct {
	...
	// in the request header.
	//
	RunBilling *PUTSubscriptionResumeTypeRunBillingEnum `json:"runBilling,omitempty"`
