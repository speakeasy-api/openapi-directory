 ...
 */
export class DescribeTransitGatewayRouteTablesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayRouteTablesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
