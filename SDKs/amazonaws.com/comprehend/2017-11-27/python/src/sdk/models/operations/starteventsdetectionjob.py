...
class StartEventsDetectionJobRequest:
    ...
    start_events_detection_job_request: shared_starteventsdetectionjobrequest.StartEventsDetectionJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
