...
export class PipelinesUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PipelinesUpdateRequest extends SpeakeasyBase {
...
export class PipelinesUpdateResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
