...
class LibreOffice:
    ...
    def libre_convert_post(self, request: shared.LibreOfficeConvertRequest) -> operations.LibreConvertPostResponse:
        ...
        **Authorization: YOUR-API-KEY**
        ...
        res = operations.LibreConvertPostResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
