...
class RemoveMembersForPortfolioRequest:
    ...
    request_body: RemoveMembersForPortfolioRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Information about the members being removed."""  
...
class RemoveMembersForPortfolio200ApplicationJSON:
    r"""Successfully removed the members from the portfolio."""
