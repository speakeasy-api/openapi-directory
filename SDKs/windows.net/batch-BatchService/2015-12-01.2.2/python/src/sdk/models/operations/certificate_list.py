...
class CertificateListRequest:
    headers: CertificateListHeaders = dataclasses.field()
    query_params: CertificateListQueryParams = dataclasses.field()
...
class CertificateListResponse:
    ...
    certificate_list_result: Optional[Any] = dataclasses.field(default=None)
