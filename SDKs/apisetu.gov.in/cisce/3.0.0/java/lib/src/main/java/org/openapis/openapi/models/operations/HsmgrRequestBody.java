...
public class HsmgrRequestBody {
    ...
    public HsmgrRequestBody withConsentArtifact(org.openapis.openapi.models.shared.ConsentArtifactSchema consentArtifact) {
    ...
    public HsmgrRequestBody(@JsonProperty("format") HsmgrRequestBodyFormatEnum format, @JsonProperty("txnId") String txnId) {
        this.format = format;
        this.txnId = txnId;
  }
}
