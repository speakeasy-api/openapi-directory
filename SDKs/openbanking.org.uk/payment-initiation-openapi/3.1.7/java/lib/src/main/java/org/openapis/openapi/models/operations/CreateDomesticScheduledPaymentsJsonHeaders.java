...
public class CreateDomesticScheduledPaymentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticScheduledPaymentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticScheduledPaymentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticScheduledPaymentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticScheduledPaymentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticScheduledPaymentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticScheduledPaymentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticScheduledPaymentsJsonHeaders withXJwsSignature(String xJwsSignature) {
