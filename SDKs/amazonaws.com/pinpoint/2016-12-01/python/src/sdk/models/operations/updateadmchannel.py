...
class UpdateADMChannelRequestBodyADMChannelRequest:
    r"""Specifies the status and settings of the ADM (Amazon Device Messaging) channel for an application."""
...
class UpdateAdmChannelRequestBody:
    ...
    adm_channel_request: UpdateADMChannelRequestBodyADMChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ADMChannelRequest') }})
    r"""Specifies the status and settings of the ADM (Amazon Device Messaging) channel for an application."""  
...
class UpdateAdmChannelRequest:
    ...
    request_body: UpdateAdmChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
