...
class GetPhenotypeAnatomyAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypeAnatomyAssociationsQueryParams:
...
class GetPhenotypeAnatomyAssociationsRequest:
    path_params: GetPhenotypeAnatomyAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypeAnatomyAssociationsQueryParams = dataclasses.field()
...
class GetPhenotypeAnatomyAssociationsResponse:
    ...
    named_objects: Optional[list[shared_namedobject.NamedObject]] = dataclasses.field(default=None)
