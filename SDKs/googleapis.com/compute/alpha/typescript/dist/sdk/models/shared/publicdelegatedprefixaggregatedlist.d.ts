...
import { PublicDelegatedPrefixesScopedList } from "./publicdelegatedprefixesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum PublicDelegatedPrefixAggregatedListWarningCodeEnum {
...
export declare class PublicDelegatedPrefixAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class PublicDelegatedPrefixAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: PublicDelegatedPrefixAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: PublicDelegatedPrefixAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class PublicDelegatedPrefixAggregatedList extends SpeakeasyBase {
    /**
     ...
     */
    items?: Record<string, PublicDelegatedPrefixesScopedList>;
    /**
