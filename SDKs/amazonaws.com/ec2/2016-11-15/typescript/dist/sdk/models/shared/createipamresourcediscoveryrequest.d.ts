 ...
 */
export declare enum CreateIpamResourceDiscoveryRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateIpamResourceDiscoveryRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateIpamResourceDiscoveryRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateIpamResourceDiscoveryRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
