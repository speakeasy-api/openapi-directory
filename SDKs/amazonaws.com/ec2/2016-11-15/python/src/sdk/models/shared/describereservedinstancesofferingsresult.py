...
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsCurrencyCodeEnum(str, Enum):
    r"""The currency of the Reserved Instance offering you are purchasing. It's specified using ISO 4217 standard currency codes. At this time, the only supported currency is <code>USD</code>."""
    USD = 'USD'

class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsInstanceTenancyEnum(str, Enum):
    r"""The tenancy of the instance."""
    DEFAULT = 'default'
    DEDICATED = 'dedicated'
    HOST = 'host'

class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsInstanceTypeEnum(str, Enum):
...
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsOfferingClassEnum(str, Enum):
    r"""If <code>convertible</code> it can be exchanged for Reserved Instances of the same or higher monetary value, with different configurations. If <code>standard</code>, it is not possible to perform an exchange."""
    STANDARD = 'standard'
    CONVERTIBLE = 'convertible'

class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsOfferingTypeEnum(str, Enum):
...
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsPricingDetails:
    r"""Describes a Reserved Instance offering."""
    
    count: Optional[int] = dataclasses.field(default=None)  
    price: Optional[float] = dataclasses.field(default=None)  
    
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsProductDescriptionEnum(str, Enum):
...
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsRecurringChargesFrequencyEnum(str, Enum):
...
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsRecurringCharges:
    ...
    frequency: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsRecurringChargesFrequencyEnum] = dataclasses.field(default=None)  
    
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsScopeEnum(str, Enum):
    r"""Whether the Reserved Instance is applied to instances in a Region or an Availability Zone."""
...
class DescribeReservedInstancesOfferingsResultReservedInstancesOfferings:
    ...
    currency_code: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsCurrencyCodeEnum] = dataclasses.field(default=None)  
    duration: Optional[int] = dataclasses.field(default=None)  
    fixed_price: Optional[float] = dataclasses.field(default=None)  
    instance_tenancy: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsInstanceTenancyEnum] = dataclasses.field(default=None)  
    instance_type: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsInstanceTypeEnum] = dataclasses.field(default=None)  
    marketplace: Optional[bool] = dataclasses.field(default=None)  
    offering_class: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsOfferingClassEnum] = dataclasses.field(default=None)  
    offering_type: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsOfferingTypeEnum] = dataclasses.field(default=None)  
    pricing_details: Optional[list[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsPricingDetails]] = dataclasses.field(default=None)  
    product_description: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsProductDescriptionEnum] = dataclasses.field(default=None)  
    recurring_charges: Optional[list[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsRecurringCharges]] = dataclasses.field(default=None)  
    reserved_instances_offering_id: Optional[str] = dataclasses.field(default=None)  
    scope: Optional[DescribeReservedInstancesOfferingsResultReservedInstancesOfferingsScopeEnum] = dataclasses.field(default=None)  
    usage_price: Optional[float] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class DescribeReservedInstancesOfferingsResult:
    r"""Contains the output of DescribeReservedInstancesOfferings."""
    
    next_token: Optional[str] = dataclasses.field(default=None)  
    reserved_instances_offerings: Optional[list[DescribeReservedInstancesOfferingsResultReservedInstancesOfferings]] = dataclasses.field(default=None)  
