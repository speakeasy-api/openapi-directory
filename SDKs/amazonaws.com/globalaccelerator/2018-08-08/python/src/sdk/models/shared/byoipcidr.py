...
class ByoipCidr:
    ...
    events: Optional[list[shared_byoipcidrevent.ByoipCidrEvent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Events') }})
    state: Optional[shared_byoipcidrstate_enum.ByoipCidrStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('State') }})
