...
var Media = /** @class */ (function () {
    ...
    Media.prototype.mediaSearchRead = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/api/v1/media/search/{movie_title}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.MediaSearchReadResponse({
    ...
    Media.prototype.mediaSearchallRead = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/v1/media/searchall/{user}", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.MediaSearchallReadResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
