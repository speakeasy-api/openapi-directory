...
public class FetchTaskQueueCumulativeStatisticsSecurity {
    ...
    public FetchTaskQueueCumulativeStatisticsSecurity withPassword(String password) {
    ...
    public FetchTaskQueueCumulativeStatisticsSecurity withUsername(String username) {
