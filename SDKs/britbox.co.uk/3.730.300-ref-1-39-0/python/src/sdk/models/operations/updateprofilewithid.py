...
from ..shared import profileupdaterequest as shared_profileupdaterequest
...
class UpdateProfileWithIDRequest:
    ...
    r"""The identifier of the profile to update."""  
    profile_update_request: shared_profileupdaterequest.ProfileUpdateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
