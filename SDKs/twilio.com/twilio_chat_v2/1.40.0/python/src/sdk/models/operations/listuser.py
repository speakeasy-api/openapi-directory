...
class ListUserRequest:
    ...
    r"""The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to read the User resources from."""  
...
class ListUserListUserResponse:
    ...
    users: Optional[list[shared_chat_v2_service_user.ChatV2ServiceUser]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users'), 'exclude': lambda f: f is None }})  
