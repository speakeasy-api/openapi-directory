...
public class FullRepository {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("has_advanced_security")
    public Boolean hasAdvancedSecurity;
    public FullRepository withHasAdvancedSecurity(Boolean hasAdvancedSecurity) {
        this.hasAdvancedSecurity = hasAdvancedSecurity;
        return this;
    }
