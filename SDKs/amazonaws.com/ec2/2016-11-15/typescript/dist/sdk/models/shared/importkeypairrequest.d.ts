 ...
 */
export declare enum ImportKeyPairRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class ImportKeyPairRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class ImportKeyPairRequestTagSpecifications extends SpeakeasyBase {
