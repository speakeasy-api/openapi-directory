 ...
 */
exports.ServerList = ["https://chat.googleapis.com/"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.spaces = new spaces_1.Spaces(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
