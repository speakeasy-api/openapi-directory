...
var DeviceInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "deviceModelName" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "languageCodeFromWebview" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "languageCodeFromWebview", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "languageCodeRaw" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "languageCodeRaw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "screenResolutionHeight" }),
        __metadata("design:type", String)
    ], DeviceInfo.prototype, "screenResolutionHeight", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "screenResolutionWidth" }),
        __metadata("design:type", String)
