...
@dataclasses.dataclass
class AppengineAppsServicesVersionsPatchQueryParams:
...
class AppengineAppsServicesVersionsPatchRequest:
    path_params: AppengineAppsServicesVersionsPatchPathParams = dataclasses.field()
    query_params: AppengineAppsServicesVersionsPatchQueryParams = dataclasses.field()
    security: AppengineAppsServicesVersionsPatchSecurity = dataclasses.field()
