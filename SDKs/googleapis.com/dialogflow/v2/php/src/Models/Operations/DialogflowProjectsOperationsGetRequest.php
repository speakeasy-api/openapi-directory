...
class DialogflowProjectsOperationsGetRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DialogflowProjectsOperationsGetIntentViewEnum $intentView
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=intentView')]
    public ?DialogflowProjectsOperationsGetIntentViewEnum $intentView = null;
