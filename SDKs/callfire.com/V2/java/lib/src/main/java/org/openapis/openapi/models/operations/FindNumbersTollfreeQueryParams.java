...
public class FindNumbersTollfreeQueryParams {
    /**
     * Limit fields received in response. E.g. fields: id, name or fields items (id, name), see more at [partial response](https://developers.callfire.com/docs.html#partial-response) page.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=fields")
    public String fields;
    public FindNumbersTollfreeQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public FindNumbersTollfreeQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public FindNumbersTollfreeQueryParams withPattern(String pattern) {
