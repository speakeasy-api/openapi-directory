...
**/
var ModelVersion = /** @class */ (function (_super) {
    __extends(ModelVersion, _super);
    function ModelVersion() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dated" }),
        __metadata("design:type", String)
    ], ModelVersion.prototype, "dated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=major" }),
        __metadata("design:type", Number)
    ], ModelVersion.prototype, "major", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=minor" }),
        __metadata("design:type", Number)
    ], ModelVersion.prototype, "minor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=patch" }),
        __metadata("design:type", Number)
    ], ModelVersion.prototype, "patch", void 0);
    return ModelVersion;
