...
public class RegriiRequestBody {
    ...
    public RegriiRequestBody withConsentArtifact(org.openapis.openapi.models.shared.ConsentArtifactSchema consentArtifact) {
    ...
    public RegriiRequestBody(@JsonProperty("format") RegriiRequestBodyFormatEnum format, @JsonProperty("txnId") String txnId) {
        this.format = format;
        this.txnId = txnId;
  }
}
