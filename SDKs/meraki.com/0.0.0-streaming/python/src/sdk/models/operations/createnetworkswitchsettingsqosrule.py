...
class CreateNetworkSwitchSettingsQosRuleRequestBodyProtocolEnum(str, Enum):
...
class CreateNetworkSwitchSettingsQosRuleRequestBody:
    ...
    protocol: Optional[CreateNetworkSwitchSettingsQosRuleRequestBodyProtocolEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""The protocol of the incoming packet. Can be one of \\"ANY\\", \\"TCP\\" or \\"UDP\\". Default value is \\"ANY\\" """  
...
class CreateNetworkSwitchSettingsQosRuleRequest:
    ...
    request_body: CreateNetworkSwitchSettingsQosRuleRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class CreateNetworkSwitchSettingsQosRuleResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    create_network_switch_settings_qos_rule_201_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
