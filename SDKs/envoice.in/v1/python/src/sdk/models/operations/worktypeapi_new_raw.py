...
class WorkTypeAPINewRawRequest:
...
class WorkTypeAPINewRawResponse:
    ...
    work_type_api_new_raw_200_application_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
    work_type_api_new_raw_200_text_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
