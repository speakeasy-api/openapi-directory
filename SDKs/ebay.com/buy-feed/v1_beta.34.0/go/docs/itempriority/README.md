...
func main() {
    ...
    res, err := s.ItemPriority.GetItemPriorityFeed(ctx, operations.GetItemPriorityFeedRequest{
        Accept: "suscipit",
        Range: "molestiae",
        XEbayCMarketplaceID: "minus",
        CategoryID: "placeat",
        Date: "voluptatum",
    }, operations.GetItemPriorityFeedSecurity{
    ...
    if res.ItemPriorityResponse != nil {
        // handle response
    }
}
```
