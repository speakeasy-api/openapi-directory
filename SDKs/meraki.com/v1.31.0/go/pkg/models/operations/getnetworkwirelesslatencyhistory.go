...
func (e *GetNetworkWirelessLatencyHistoryAccessCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "videoTraffic":
		fallthrough
	case "voiceTraffic":
		*e = GetNetworkWirelessLatencyHistoryAccessCategoryEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessLatencyHistoryAccessCategoryEnum: %s", s)
	}
}
...
func (e *GetNetworkWirelessLatencyHistoryBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetNetworkWirelessLatencyHistoryBandEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkWirelessLatencyHistoryBandEnum: %s", s)
	}
}
