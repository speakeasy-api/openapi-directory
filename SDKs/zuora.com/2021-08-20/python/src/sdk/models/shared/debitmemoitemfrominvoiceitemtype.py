...
import dataclasses
from ..shared import debitmemotaxitemfrominvoicetaxitemtype as shared_debitmemotaxitemfrominvoicetaxitemtype
...
class DebitMemoItemFromInvoiceItemTypeFinanceInformation:
...
class DebitMemoItemFromInvoiceItemTypeTaxModeEnum(str, Enum):
...
class DebitMemoItemFromInvoiceItemType:
    ...
    r"""TThe name of the charge associated with the invoice."""  
    ...
    **Note**: This field is only available if you set the `zuora-version` request header to `257.0` or later.
    """  
    finance_information: Optional[DebitMemoItemFromInvoiceItemTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the debit memo item."""  
    ...
    tax_items: Optional[list[shared_debitmemotaxitemfrominvoicetaxitemtype.DebitMemoTaxItemFromInvoiceTaxItemType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxItems'), 'exclude': lambda f: f is None }})
    r"""Container for taxation items."""  
    tax_mode: Optional[DebitMemoItemFromInvoiceItemTypeTaxModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taxMode'), 'exclude': lambda f: f is None }})
    r"""The tax mode of the debit memo item, indicating whether the amount of the debit memo item includes tax.
