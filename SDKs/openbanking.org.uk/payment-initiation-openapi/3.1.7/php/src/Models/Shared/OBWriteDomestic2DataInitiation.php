...
class OBWriteDomestic2DataInitiation
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationCreditorAccount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomestic2DataInitiationDebtorAccount $debtorAccount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationInstructedAmount $instructedAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('InstructedAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationInstructedAmount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationRemittanceInformation $remittanceInformation
     */
	#[\JMS\Serializer\Annotation\SerializedName('RemittanceInformation')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationRemittanceInformation')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomestic2DataInitiationRemittanceInformation $remittanceInformation = null;
	...
	{
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationCreditorAccount();
		$this->creditorPostalAddress = null;
		$this->debtorAccount = null;
		$this->endToEndIdentification = "";
		$this->instructedAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomestic2DataInitiationInstructedAmount();
