...
var StandingOrders = /** @class */ (function () {
     ...
     */
    StandingOrders.prototype.getAccountsAccountIdStandingOrders = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAccountsAccountIdStandingOrdersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/accounts/{accountId}/standing-orders", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.GetAccountsAccountIdStandingOrdersSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetAccountsAccountIdStandingOrdersResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.obReadStandingOrder6 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.OBReadStandingOrder6);
                    }
