...
export class CommunicationCost {
  ...
  getCommunicationCosts(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetCommunicationCostsResponse =
        new operations.GetCommunicationCostsResponse({
      ...
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.communicationCostPage = utils.objectToClass(
              httpRes?.data,
              shared.CommunicationCostPage
            );
          }
          break;
      }
  ...
  getCommunicationCostsAggregates(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/communication_costs/aggregates/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetCommunicationCostsAggregatesResponse =
        new operations.GetCommunicationCostsAggregatesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.communicationCostByCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.CommunicationCostByCandidatePage
            );
          }
          break;
      }
  ...
  getCommunicationCostsByCandidate(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/communication_costs/by_candidate/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetCommunicationCostsByCandidateResponse =
        new operations.GetCommunicationCostsByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getCommunicationCostsTotalsByCandidate(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/communication_costs/totals/by_candidate/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetCommunicationCostsTotalsByCandidateResponse =
        new operations.GetCommunicationCostsTotalsByCandidateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        default:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.ccTotalsByCandidatePage = utils.objectToClass(
              httpRes?.data,
              shared.CCTotalsByCandidatePage
            );
          }
          break;
      }
