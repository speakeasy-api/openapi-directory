...
var IssuancePolicy = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "allowedIssuanceModes" }),
        (0, class_transformer_1.Type)(function () { return issuancemodes_1.IssuanceModes; }),
        __metadata("design:type", issuancemodes_1.IssuanceModes)
    ], IssuancePolicy.prototype, "allowedIssuanceModes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: allowedkeytype_1.AllowedKeyType }),
        (0, class_transformer_1.Expose)({ name: "allowedKeyTypes" }),
        (0, class_transformer_1.Type)(function () { return allowedkeytype_1.AllowedKeyType; }),
        __metadata("design:type", Array)
    ], IssuancePolicy.prototype, "allowedKeyTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "baselineValues" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maximumLifetime" }),
