...
} from "./accountimageimprovements";
import {
  AccountItemUpdates,
  AccountItemUpdatesInput,
} from "./accountitemupdates";
...
export class AccountAutomaticImprovementsInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "imageImprovements" })
  @Type(() => AccountImageImprovementsInput)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "itemUpdates" })
  @Type(() => AccountItemUpdatesInput)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "shippingImprovements" })
  @Type(() => AccountShippingImprovements)
