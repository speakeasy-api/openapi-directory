...
public class GetPayLinesFromPayRunPathParams {
    /**
     * The employers' unique identifier. E.g ER001
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=EmployerId")
    public String employerId;
    public GetPayLinesFromPayRunPathParams withEmployerId(String employerId) {
    ...
    public GetPayLinesFromPayRunPathParams withPayRunId(String payRunId) {
    ...
    public GetPayLinesFromPayRunPathParams withPayScheduleId(String payScheduleId) {
