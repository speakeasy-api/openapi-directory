...
public class ConfirmReservationRequest {
    ...
    public ConfirmReservationRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("reservationId") String reservationId) {
        this.accept = accept;
        this.contentType = contentType;
        this.reservationId = reservationId;
  }
