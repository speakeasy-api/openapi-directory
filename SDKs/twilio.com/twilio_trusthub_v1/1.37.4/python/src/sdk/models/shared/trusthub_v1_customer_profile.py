...
class TrusthubV1CustomerProfile:
    ...
    status: Optional[shared_customer_profile_enum_status_enum.CustomerProfileEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
