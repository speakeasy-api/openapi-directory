...
from ..shared import listvirtualservicesoutput as shared_listvirtualservicesoutput
...
class ListVirtualServicesRequest:
    headers: ListVirtualServicesHeaders = dataclasses.field()
    path_params: ListVirtualServicesPathParams = dataclasses.field()
    query_params: ListVirtualServicesQueryParams = dataclasses.field()
...
class ListVirtualServicesResponse:
    ...
    list_virtual_services_output: Optional[shared_listvirtualservicesoutput.ListVirtualServicesOutput] = dataclasses.field(default=None)
