...
class GetNetworkDeviceLatencyStatsBandEnum(str, Enum):
...
class GetNetworkDeviceLatencyStatsRequest:
    ...
    band: Optional[GetNetworkDeviceLatencyStatsBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information."""  
    fields_: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': True }})
    r"""Partial selection: If present, this call will return only the selected fields of [\\"rawDistribution\\", \\"avg\\"]. All fields will be returned by default. Selected fields must be entered as a comma separated string."""  
...
@dataclasses.dataclass
class GetNetworkDeviceLatencyStatsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    get_network_device_latency_stats_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
