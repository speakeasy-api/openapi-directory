...
from ..shared import resendsellerleadrequestrequest as shared_resendsellerleadrequestrequest
...
class ResendSellerLeadRequestRequest:
    ...
    resend_seller_lead_request_request: shared_resendsellerleadrequestrequest.ResendSellerLeadRequestRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class ResendSellerLeadRequestResponse:
