...
from ..shared import shareprofileacknowledgement as shared_shareprofileacknowledgement
...
class ShareProfileResult:
    acknowledgement: shared_shareprofileacknowledgement.ShareProfileAcknowledgement = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
