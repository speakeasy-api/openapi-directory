...
class DescribeEcsClustersRequest:
    ...
    ecs_cluster_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EcsClusterArns'), 'exclude': lambda f: f is None }})  
