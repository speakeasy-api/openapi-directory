...
@dataclasses.dataclass
class JobDisableRequest:
    headers: JobDisableHeaders = dataclasses.field()
    path_params: JobDisablePathParams = dataclasses.field()
    query_params: JobDisableQueryParams = dataclasses.field()
    request: Any = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class JobDisableResponse:
