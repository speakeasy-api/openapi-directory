...
var AndroidNotification = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bodyLocArgs" }),
        __metadata("design:type", Array)
    ], AndroidNotification.prototype, "bodyLocArgs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bodyLocKey" }),
        __metadata("design:type", String)
    ], AndroidNotification.prototype, "bodyLocKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bypassProxyNotification" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=clickAction" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=defaultLightSettings" }),
        __metadata("design:type", Boolean)
    ], AndroidNotification.prototype, "defaultLightSettings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=defaultSound" }),
        __metadata("design:type", Boolean)
    ], AndroidNotification.prototype, "defaultSound", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=defaultVibrateTimings" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lightSettings" }),
        __metadata("design:type", lightsettings_1.LightSettings)
    ], AndroidNotification.prototype, "lightSettings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=localOnly" }),
        __metadata("design:type", Boolean)
    ], AndroidNotification.prototype, "localOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notificationCount" }),
        __metadata("design:type", Number)
    ], AndroidNotification.prototype, "notificationCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notificationPriority" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=titleLocArgs" }),
        __metadata("design:type", Array)
    ], AndroidNotification.prototype, "titleLocArgs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=titleLocKey" }),
        __metadata("design:type", String)
    ], AndroidNotification.prototype, "titleLocKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vibrateTimings" }),
        __metadata("design:type", Array)
