...
class ToolresultsProjectsHistoriesExecutionsStepsPublishXunitXMLFilesRequest:
    ...
    publish_xunit_xml_files_request: Optional[shared_publishxunitxmlfilesrequest.PublishXunitXMLFilesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
