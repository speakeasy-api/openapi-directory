...
func (e *GoogleCloudDiscoveryengineV1betaImportDocumentsRequestReconciliationModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "INCREMENTAL":
		fallthrough
	case "FULL":
		*e = GoogleCloudDiscoveryengineV1betaImportDocumentsRequestReconciliationModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDiscoveryengineV1betaImportDocumentsRequestReconciliationModeEnum: %s", s)
	}
}
