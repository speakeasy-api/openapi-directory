 ...
 */
export enum ImageListWarningCodeEnum {
...
export class ImageListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ImageListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ImageListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class ImageList extends SpeakeasyBase {
  /**
