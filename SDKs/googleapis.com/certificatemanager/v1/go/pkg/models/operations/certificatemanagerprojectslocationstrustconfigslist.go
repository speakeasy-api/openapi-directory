...
type CertificatemanagerProjectsLocationsTrustConfigsListSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type CertificatemanagerProjectsLocationsTrustConfigsListRequest struct {
	// V1 error format.
...
type CertificatemanagerProjectsLocationsTrustConfigsListResponse struct {
	ContentType string
	// Successful response
	ListTrustConfigsResponse *shared.ListTrustConfigsResponse
	StatusCode               int
