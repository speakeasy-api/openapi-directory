...
func (e IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum) ToPointer() *IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum {
	return &e
}

func (e *IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for IdpProjectedPlayerGameStatsByTeamWInjuriesLineupsDfsSalariesFormatEnum: %v", v)
	}
}
