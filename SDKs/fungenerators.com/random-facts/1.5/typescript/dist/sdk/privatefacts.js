...
exports.PrivateFacts = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var PrivateFacts = /** @class */ (function () {
    function PrivateFacts(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PrivateFacts.prototype.deleteFact = function (req, config) {
    ...
    **/
    PrivateFacts.prototype.getFact = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PrivateFacts.prototype.putFact = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.PrivateFacts = PrivateFacts;
