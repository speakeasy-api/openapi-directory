...
var BundleDownloadEntity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "bundle_registration" }),
        (0, class_transformer_1.Type)(function () { return bundleregistrationentity_1.BundleRegistrationEntity; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "download_method" }),
