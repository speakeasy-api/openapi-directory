...
from ..shared import getmodifiergroupsresponse as shared_getmodifiergroupsresponse
...
class ModifierGroupsAllQueryParams:
...
@dataclasses.dataclass
class ModifierGroupsAllHeaders:
...
@dataclasses.dataclass
class ModifierGroupsAllSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class ModifierGroupsAllRequest:
    headers: ModifierGroupsAllHeaders = dataclasses.field()
    query_params: ModifierGroupsAllQueryParams = dataclasses.field()
    security: ModifierGroupsAllSecurity = dataclasses.field()
    

@dataclasses.dataclass
class ModifierGroupsAllResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_modifier_groups_response: Optional[shared_getmodifiergroupsresponse.GetModifierGroupsResponse] = dataclasses.field(default=None)
