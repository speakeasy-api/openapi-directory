...
func NewSpecTemplate(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *SpecTemplate {
	return &SpecTemplate{
...
func (s *SpecTemplate) GetSpecTemplate(ctx context.Context, request operations.GetSpecTemplateRequest) (*operations.GetSpecTemplateResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/v1/workgroups/{workgroup_id}/specTemplates/{spec_template_id}", request.PathParams)
	...
	res := &operations.GetSpecTemplateResponse{
...
func (s *SpecTemplate) GetSpecTemplateList(ctx context.Context, request operations.GetSpecTemplateListRequest) (*operations.GetSpecTemplateListResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/workgroups/{workgroup_id}/specTemplates", request.PathParams)
	...
	res := &operations.GetSpecTemplateListResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
