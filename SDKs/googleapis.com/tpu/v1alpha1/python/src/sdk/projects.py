...
class Projects:
    ...
    def tpu_projects_locations_accelerator_types_list(self, request: operations.TpuProjectsLocationsAcceleratorTypesListRequest) -> operations.TpuProjectsLocationsAcceleratorTypesListResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha1/{parent}/acceleratorTypes", request.path_params)
    ...
    def tpu_projects_locations_nodes_reimage(self, request: operations.TpuProjectsLocationsNodesReimageRequest) -> operations.TpuProjectsLocationsNodesReimageResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha1/{name}:reimage", request.path_params)
    ...
    def tpu_projects_locations_nodes_start(self, request: operations.TpuProjectsLocationsNodesStartRequest) -> operations.TpuProjectsLocationsNodesStartResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha1/{name}:start", request.path_params)
    ...
    def tpu_projects_locations_nodes_stop(self, request: operations.TpuProjectsLocationsNodesStopRequest) -> operations.TpuProjectsLocationsNodesStopResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha1/{name}:stop", request.path_params)
    ...
    def tpu_projects_locations_tensorflow_versions_list(self, request: operations.TpuProjectsLocationsTensorflowVersionsListRequest) -> operations.TpuProjectsLocationsTensorflowVersionsListResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha1/{parent}/tensorflowVersions", request.path_params)
