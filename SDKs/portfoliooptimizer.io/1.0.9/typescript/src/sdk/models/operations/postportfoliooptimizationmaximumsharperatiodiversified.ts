...
export class PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBodyConstraints extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(
    () =>
      PostPortfolioOptimizationMaximumSharpeRatioDiversifiedRequestBodyConstraints
  )
 ...
 * OK
 */
export class PostPortfolioOptimizationMaximumSharpeRatioDiversified200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class PostPortfolioOptimizationMaximumSharpeRatioDiversifiedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
