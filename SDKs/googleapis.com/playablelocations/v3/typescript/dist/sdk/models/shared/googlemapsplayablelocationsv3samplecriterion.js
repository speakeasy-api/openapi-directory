...
var GoogleMapsPlayablelocationsV3SampleCriterion = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "fieldsToReturn" }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return googlemapsplayablelocationsv3samplefilter_1.GoogleMapsPlayablelocationsV3SampleFilter; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "gameObjectType" }),
