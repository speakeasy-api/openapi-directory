...
public class Point {
    ...
    public org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionResponse getGeomarksGeomarkIdPointFileFormatExtension(org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionRequest.class, baseUrl, "/geomarks/{geomarkId}/point.{fileFormatExtension}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetGeomarksGeomarkIdPointFileFormatExtensionRequest.class, request, null);
        if (queryParams != null) {
