...
class GetV2SuccessesJSONRequest:
    
    ids: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ids', 'style': 'form', 'explode': False }})
    r"""IDs of successes to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
    ...
    r"""Filters successes by person_id. Multiple person ids can be applied"""  
    sort_by: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort_by', 'style': 'form', 'explode': True }})
    r"""Key to sort on, must be one of: created_at, updated_at, succeeded_at. Defaults to updated_at"""  
...
@dataclasses.dataclass
class GetV2SuccessesJSONResponse:
