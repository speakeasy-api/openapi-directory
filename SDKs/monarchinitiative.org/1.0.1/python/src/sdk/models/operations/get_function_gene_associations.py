...
class GetFunctionGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    
class GetFunctionGeneAssociationsRelationshipTypeEnum(str, Enum):
...
@dataclasses.dataclass
class GetFunctionGeneAssociationsQueryParams:
    ...
    relationship_type: Optional[GetFunctionGeneAssociationsRelationshipTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'relationship_type', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class GetFunctionGeneAssociationsRequest:
    path_params: GetFunctionGeneAssociationsPathParams = dataclasses.field()
    query_params: GetFunctionGeneAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetFunctionGeneAssociationsResponse:
