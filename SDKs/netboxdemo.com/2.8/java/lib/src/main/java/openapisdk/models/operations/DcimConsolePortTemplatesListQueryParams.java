...
public class DcimConsolePortTemplatesListQueryParams {
    ...
    public DcimConsolePortTemplatesListQueryParams withDevicetypeIdN(String devicetypeIdN) {
        this.devicetypeIdN = devicetypeIdN;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=id")
    public String id;
    public DcimConsolePortTemplatesListQueryParams withId(String id) {
        this.id = id;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=id__gt")
    public String idGt;
    public DcimConsolePortTemplatesListQueryParams withIdGt(String idGt) {
        this.idGt = idGt;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=id__gte")
    public String idGte;
    public DcimConsolePortTemplatesListQueryParams withIdGte(String idGte) {
        this.idGte = idGte;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=id__lt")
    public String idLt;
    public DcimConsolePortTemplatesListQueryParams withIdLt(String idLt) {
        this.idLt = idLt;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=id__lte")
    public String idLte;
    public DcimConsolePortTemplatesListQueryParams withIdLte(String idLte) {
        this.idLte = idLte;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=id__n")
    public String idN;
    public DcimConsolePortTemplatesListQueryParams withIdN(String idN) {
        this.idN = idN;
        return this;
    }
    ...
    public String q;
    public DcimConsolePortTemplatesListQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=type")
    public String type;
    public DcimConsolePortTemplatesListQueryParams withType(String type) {
        this.type = type;
        return this;
    }
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=type__n")
    public String typeN;
    public DcimConsolePortTemplatesListQueryParams withTypeN(String typeN) {
        this.typeN = typeN;
        return this;
    }
}