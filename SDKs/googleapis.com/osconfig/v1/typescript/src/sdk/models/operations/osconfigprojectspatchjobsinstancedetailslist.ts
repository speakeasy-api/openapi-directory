...
export class OsconfigProjectsPatchJobsInstanceDetailsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OsconfigProjectsPatchJobsInstanceDetailsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OsconfigProjectsPatchJobsInstanceDetailsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
