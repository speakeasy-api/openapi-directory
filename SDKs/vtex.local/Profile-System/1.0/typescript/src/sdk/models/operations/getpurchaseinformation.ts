...
export class GetPurchaseInformationRequest extends SpeakeasyBase {
  /**
...
export class GetPurchaseInformationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getPurchaseInformation200ApplicationJSONAnies?: any[];
