...
public class GetGeneVariantAssociationsRequest {
    ...
    public GetGeneVariantAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneVariantAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneVariantAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneVariantAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneVariantAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneVariantAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withRelation(String relation) {
    ...
    public GetGeneVariantAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneVariantAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneVariantAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneVariantAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
