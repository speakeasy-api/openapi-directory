...
public class GETDisassociateIamInstanceProfileRequest {
    ...
    public GETDisassociateIamInstanceProfileRequest(@JsonProperty("Action") GETDisassociateIamInstanceProfileActionEnum action, @JsonProperty("AssociationId") String associationId, @JsonProperty("Version") GETDisassociateIamInstanceProfileVersionEnum version) {
        this.action = action;
        this.associationId = associationId;
        this.version = version;
  }
