...
type SecretmanagerProjectsSecretsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecretmanagerProjectsSecretsListPathParams struct {
	// Required. The resource name of the project associated with the Secrets, in the format `projects/*`.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type SecretmanagerProjectsSecretsListQueryParams struct {
	// V1 error format.
...
type SecretmanagerProjectsSecretsListRequest struct {
...
type SecretmanagerProjectsSecretsListResponse struct {
	ContentType string
	// Successful response
