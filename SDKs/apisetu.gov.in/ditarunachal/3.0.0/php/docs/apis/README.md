...
use \OpenAPI\OpenAPI\Models\Operations\IlpmtRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\IlpmtRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\IlpmtRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\IlpmtSecurity;
...
try {
    ...
    $request->certificateParameters = new IlpmtRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->uid = '123412341234';
    $request->certificateParameters->eILPAppId = '94XXX';
    $request->certificateParameters->eILPContactNumber = '98765XXXXX';
    ...
    $request->format = IlpmtRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new IlpmtSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->ilpmt($request, $requestSecurity);
