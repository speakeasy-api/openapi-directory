...
public class Applications {
    ...
    **/
    public openapisdk.models.operations.ApplicationGetResponse applicationGet(openapisdk.models.operations.ApplicationGetRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/applications/{applicationId}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.ApplicationListResponse applicationList(openapisdk.models.operations.ApplicationListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.ApplicationListResponse res = new openapisdk.models.operations.ApplicationListResponse() {{
