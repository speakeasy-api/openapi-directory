...
exports.TaskrouterV1WorkspaceTaskQueue = void 0;
var utils_1 = require("../../../internal/utils");
var taskqueueenumtaskorderenum_1 = require("./taskqueueenumtaskorderenum");
var TaskrouterV1WorkspaceTaskQueue = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=assignment_activity_name" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceTaskQueue.prototype, "assignmentActivityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=assignment_activity_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max_reserved_workers" }),
        __metadata("design:type", Number)
    ], TaskrouterV1WorkspaceTaskQueue.prototype, "maxReservedWorkers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reservation_activity_name" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceTaskQueue.prototype, "reservationActivityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reservation_activity_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=target_workers" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceTaskQueue.prototype, "targetWorkers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=task_order" }),
        __metadata("design:type", String)
...
exports.TaskrouterV1WorkspaceTaskQueue = TaskrouterV1WorkspaceTaskQueue;
