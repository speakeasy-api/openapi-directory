...
var FastestAndNextDepartures = /** @class */ (function () {
    ...
    FastestAndNextDepartures.prototype.getFastestDeparturesByCRS = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/getFastestDeparturesByCRS/{CRS}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetFastestDeparturesByCRSResponse({
    ...
    FastestAndNextDepartures.prototype.getNextDeparturesByCRS = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/getNextDeparturesByCRS/{CRS}", req);
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetNextDeparturesByCRSResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
