...
class AndroidpublisherPurchasesCancelRequest:
    path_params: AndroidpublisherPurchasesCancelPathParams = dataclasses.field()
    query_params: AndroidpublisherPurchasesCancelQueryParams = dataclasses.field()
    security: AndroidpublisherPurchasesCancelSecurity = dataclasses.field()
