...
exports.GetSetupV1LocationsResponse = exports.GetSetupV1LocationsRequest = void 0;
...
var GetSetupV1LocationsRequest = /** @class */ (function (_super) {
    ...
    ], GetSetupV1LocationsRequest.prototype, "deleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=friendlyId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1LocationsRequest.prototype, "friendlyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetSetupV1LocationsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], GetSetupV1LocationsRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetSetupV1LocationsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=serviceId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1LocationsRequest.prototype, "serviceId", void 0);
...
var GetSetupV1LocationsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.LocationListViewModel)
    ...
    ], GetSetupV1LocationsResponse.prototype, "rawResponse", void 0);
