...
class Invoices:
    ...
    def get_invoice_application_parts(self, request: operations.GetInvoiceApplicationPartsRequest) -> operations.GetInvoiceApplicationPartsResponse:
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information.
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/application-parts", request.path_params)
        ...
        res = operations.GetInvoiceApplicationPartsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetInvoiceApplicationPartCollectionType])
    ...
    def get_invoice_files(self, request: operations.GetInvoiceFilesRequest) -> operations.GetInvoiceFilesResponse:
        ...
        **Note**: This API only retrieves the PDF files that have been generated. If the latest PDF file is being generated, it will not be included in the response.
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/files", request.path_params)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetInvoiceFilesResponse])
    ...
    def get_invoice_items(self, request: operations.GetInvoiceItemsRequest) -> operations.GetInvoiceItemsResponse:
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/items", request.path_params)
    ...
    def get_taxation_items_of_invoice_item(self, request: operations.GetTaxationItemsOfInvoiceItemRequest) -> operations.GetTaxationItemsOfInvoiceItemResponse:
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/items/{itemId}/taxation-items", request.path_params)
        ...
        res = operations.GetTaxationItemsOfInvoiceItemResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetInvoiceTaxationItemsResponse])
    ...
    def object_delete_invoice(self, request: operations.ObjectDeleteInvoiceRequest) -> operations.ObjectDeleteInvoiceResponse:
        ...
        url = utils.generate_url(base_url, "/v1/object/invoice/{id}", request.path_params)
        ...
        res = operations.ObjectDeleteInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def object_get_invoice(self, request: operations.ObjectGetInvoiceRequest) -> operations.ObjectGetInvoiceResponse:
        ...
        res = operations.ObjectGetInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def object_put_invoice(self, request: operations.ObjectPutInvoiceRequest) -> operations.ObjectPutInvoiceResponse:
        ...
        res = operations.ObjectPutInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def post_credit_memo_from_invoice(self, request: operations.PostCreditMemoFromInvoiceRequest) -> operations.PostCreditMemoFromInvoiceResponse:
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. 
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/creditmemos", request.path_params)
        ...
        res = operations.PostCreditMemoFromInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def post_debit_memo_from_invoice(self, request: operations.PostDebitMemoFromInvoiceRequest) -> operations.PostDebitMemoFromInvoiceResponse:
        ...
        **Note:** This operation is only available if you have [Invoice Settlement](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement) enabled. The Invoice Settlement feature is generally available as of Zuora Billing Release 296 (March 2021). This feature includes Unapplied Payments, Credit and Debit Memo, and Invoice Item Settlement. If you want to enable Invoice Settlement, see [Invoice Settlement Enablement and Checklist Guide](https://knowledgecenter.zuora.com/Billing/Billing_and_Payments/Invoice_Settlement/Invoice_Settlement_Migration_Checklist_and_Guide) for more information. 
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/debitmemos", request.path_params)
        ...
        res = operations.PostDebitMemoFromInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def post_email_invoice(self, request: operations.PostEmailInvoiceRequest) -> operations.PostEmailInvoiceResponse:
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/emails", request.path_params)
        ...
        res = operations.PostEmailInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def post_standalone_invoice(self, request: operations.PostStandaloneInvoiceRequest) -> operations.PostStandaloneInvoiceResponse:
        ...
        **Note:** This operation is only available if you have Unified Invoicing enabled. The Unified Invoicing feature is in the Early Adopter phase. We are actively soliciting feedback from a small set of early adopters before releasing it as generally available. If you want to join this early adopter program, submit a request at [Zuora Global Support](http://support.zuora.com/).
        ...
        res = operations.PostStandaloneInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def post_upload_file_for_invoice(self, request: operations.PostUploadFileForInvoiceRequest) -> operations.PostUploadFileForInvoiceResponse:
        ...
        res = operations.PostUploadFileForInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def put_batch_update_invoices(self, request: operations.PutBatchUpdateInvoicesRequest) -> operations.PutBatchUpdateInvoicesResponse:
        ...
        * You can update a maximum of 50 invoices by one call.
        ...
        res = operations.PutBatchUpdateInvoicesResponse(status_code=r.status_code, content_type=content_type)
    ...
    def put_reverse_invoice(self, request: operations.PutReverseInvoiceRequest) -> operations.PutReverseInvoiceResponse:
        ...
        * An invoice contains more than 2,000 items in total, including invoice items, discount items, and taxation items.
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/reverse", request.path_params)
        ...
        res = operations.PutReverseInvoiceResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutReverseInvoiceResponseType])
    ...
    def put_update_invoice(self, request: operations.PutUpdateInvoiceRequest) -> operations.PutUpdateInvoiceResponse:
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}", request.path_params)
        ...
        res = operations.PutUpdateInvoiceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def put_write_off_invoice(self, request: operations.PutWriteOffInvoiceRequest) -> operations.PutWriteOffInvoiceResponse:
        ...
        * An invoice contains more than 2,000 items in total, including invoice items, discount items, and taxation items.
        ...
        url = utils.generate_url(base_url, "/v1/invoices/{invoiceId}/write-off", request.path_params)
        ...
        res = operations.PutWriteOffInvoiceResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json; charset=utf-8"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutWriteOffInvoiceResponse])
