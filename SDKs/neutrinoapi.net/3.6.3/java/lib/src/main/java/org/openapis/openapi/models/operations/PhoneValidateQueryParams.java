...
public class PhoneValidateQueryParams {
    /**
    ...
    public PhoneValidateQueryParams withCountryCode(String countryCode) {
    ...
    public String ip;
    public PhoneValidateQueryParams withIp(String ip) {
        this.ip = ip;
        return this;
    }
    ...
    public PhoneValidateQueryParams withNumber(String number) {
        this.number = number;
        return this;
    }
