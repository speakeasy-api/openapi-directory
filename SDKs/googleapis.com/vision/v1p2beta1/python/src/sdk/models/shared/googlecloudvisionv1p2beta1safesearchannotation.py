...
class GoogleCloudVisionV1p2beta1SafeSearchAnnotation:
    ...
    adult: Optional[GoogleCloudVisionV1p2beta1SafeSearchAnnotationAdultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('adult'), 'exclude': lambda f: f is None }})
    r"""Represents the adult content likelihood for the image. Adult content may contain elements such as nudity, pornographic images or cartoons, or sexual activities."""  
    medical: Optional[GoogleCloudVisionV1p2beta1SafeSearchAnnotationMedicalEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('medical'), 'exclude': lambda f: f is None }})
    r"""Likelihood that this is a medical image."""  
    racy: Optional[GoogleCloudVisionV1p2beta1SafeSearchAnnotationRacyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('racy'), 'exclude': lambda f: f is None }})
    r"""Likelihood that the request image contains racy content. Racy content may include (but is not limited to) skimpy or sheer clothing, strategically covered nudity, lewd or provocative poses, or close-ups of sensitive body areas."""  
    spoof: Optional[GoogleCloudVisionV1p2beta1SafeSearchAnnotationSpoofEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('spoof'), 'exclude': lambda f: f is None }})
    r"""Spoof likelihood. The likelihood that an modification was made to the image's canonical version to make it appear funny or offensive."""  
    violence: Optional[GoogleCloudVisionV1p2beta1SafeSearchAnnotationViolenceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('violence'), 'exclude': lambda f: f is None }})
    r"""Likelihood that this image contains violent content."""  
