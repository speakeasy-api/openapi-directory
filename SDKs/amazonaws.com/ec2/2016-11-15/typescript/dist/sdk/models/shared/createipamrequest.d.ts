 ...
 */
export declare enum CreateIpamRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateIpamRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateIpamRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateIpamRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateIpamRequestTagSpecificationsTags[];
}
export declare class CreateIpamRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
