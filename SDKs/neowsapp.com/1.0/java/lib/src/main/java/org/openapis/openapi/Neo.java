...
public class Neo {
     ...
     */
    public org.openapis.openapi.models.operations.BrowseNearEarthObjectsResponse browseNearEarthObjects(org.openapis.openapi.models.operations.BrowseNearEarthObjectsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/rest/v1/neo/browse");
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.NearEarthObject out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.NearEarthObject.class);
