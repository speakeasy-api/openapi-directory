...
class GetAPIVVersionMetalsBenchmarkSummaryRequest:
    path_params: GetAPIVVersionMetalsBenchmarkSummaryPathParams = dataclasses.field()
    query_params: GetAPIVVersionMetalsBenchmarkSummaryQueryParams = dataclasses.field()
