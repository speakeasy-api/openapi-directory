...
class CreateDefaultSubnetResultSubnetIpv6CidrBlockAssociationSetIpv6CidrBlockStateStateEnum(str, Enum):
...
class CreateDefaultSubnetResultSubnetIpv6CidrBlockAssociationSetIpv6CidrBlockState:
    ...
    state: Optional[CreateDefaultSubnetResultSubnetIpv6CidrBlockAssociationSetIpv6CidrBlockStateStateEnum] = dataclasses.field(default=None)  
...
class CreateDefaultSubnetResultSubnetIpv6CidrBlockAssociationSet:
    ...
    ipv6_cidr_block_state: Optional[CreateDefaultSubnetResultSubnetIpv6CidrBlockAssociationSetIpv6CidrBlockState] = dataclasses.field(default=None)  
    
class CreateDefaultSubnetResultSubnetPrivateDNSNameOptionsOnLaunchHostnameTypeEnum(str, Enum):
...
class CreateDefaultSubnetResultSubnetPrivateDNSNameOptionsOnLaunch:
    ...
    hostname_type: Optional[CreateDefaultSubnetResultSubnetPrivateDNSNameOptionsOnLaunchHostnameTypeEnum] = dataclasses.field(default=None)  
    
class CreateDefaultSubnetResultSubnetStateEnum(str, Enum):
...
class CreateDefaultSubnetResultSubnet:
    ...
    ipv6_cidr_block_association_set: Optional[list[CreateDefaultSubnetResultSubnetIpv6CidrBlockAssociationSet]] = dataclasses.field(default=None)  
    ...
    private_dns_name_options_on_launch: Optional[CreateDefaultSubnetResultSubnetPrivateDNSNameOptionsOnLaunch] = dataclasses.field(default=None)  
    state: Optional[CreateDefaultSubnetResultSubnetStateEnum] = dataclasses.field(default=None)  
    subnet_arn: Optional[str] = dataclasses.field(default=None)  
    subnet_id: Optional[str] = dataclasses.field(default=None)  
    tags: Optional[list[CreateDefaultSubnetResultSubnetTags]] = dataclasses.field(default=None)  
