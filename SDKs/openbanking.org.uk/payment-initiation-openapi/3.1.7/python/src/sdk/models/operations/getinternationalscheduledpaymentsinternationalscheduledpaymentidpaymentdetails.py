...
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsPathParams:
...
@dataclasses.dataclass
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsHeaders:
...
@dataclasses.dataclass
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsSecurity:
    tppo_auth2_security: shared_security.SchemeTppoAuth2Security = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsRequest:
    headers: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsHeaders = dataclasses.field()
    path_params: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsPathParams = dataclasses.field()
    security: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsResponse:
