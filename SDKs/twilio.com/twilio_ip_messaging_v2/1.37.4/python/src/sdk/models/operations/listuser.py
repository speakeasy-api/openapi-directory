...
class ListUserListUserResponse:
    ...
    users: Optional[list[shared_ip_messaging_v2_service_user.IPMessagingV2ServiceUser]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
