...
class VeteranConfirmationStatus 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetVeteranStatusResponse
    {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetVeteranStatusResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->veteranStatusConfirmation = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\VeteranStatusConfirmation', 'json');
            }
        }
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->authorizationError = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\AuthorizationError', 'json');
            }
        }
