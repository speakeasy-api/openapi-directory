...
class ListPackageTypesResponseBodyPackageType:
    r"""ListPackageTypesResponseBodyPackageType
...
class ListPackageTypesResponseBody:
    r"""ListPackageTypesResponseBody
    A list package types response body
    """
    
    packages: Optional[list[ListPackageTypesResponseBodyPackageType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('packages') }})
