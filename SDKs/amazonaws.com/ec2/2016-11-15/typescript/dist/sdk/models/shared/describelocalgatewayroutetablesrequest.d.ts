 ...
 */
export declare class DescribeLocalGatewayRouteTablesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLocalGatewayRouteTablesRequest extends SpeakeasyBase {
    dryRun?: boolean;
