 ...
 */
export declare class DescribeRouteTablesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeRouteTablesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeRouteTablesRequestFilters[];
    maxResults?: number;
    nextToken?: string;
