...
class ListRoleListRoleResponse:
    ...
    roles: Optional[list[shared_chat_v2_service_role.ChatV2ServiceRole]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('roles') }})
