...
class GetDeprovisionByoipCidrQueryParams:
    action: GetDeprovisionByoipCidrActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cidr: str = dataclasses.field(metadata={'query_param': { 'field_name': 'Cidr', 'style': 'form', 'explode': True }})
    version: GetDeprovisionByoipCidrVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeprovisionByoipCidrRequest:
    headers: GetDeprovisionByoipCidrHeaders = dataclasses.field()
    query_params: GetDeprovisionByoipCidrQueryParams = dataclasses.field()
