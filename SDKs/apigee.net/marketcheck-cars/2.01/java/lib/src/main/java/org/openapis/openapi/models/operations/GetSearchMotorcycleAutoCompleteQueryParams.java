...
public class GetSearchMotorcycleAutoCompleteQueryParams {
    ...
    public GetSearchMotorcycleAutoCompleteQueryParams withFacetMinCount(Double facetMinCount) {
    ...
    public GetSearchMotorcycleAutoCompleteFieldEnum field;
    public GetSearchMotorcycleAutoCompleteQueryParams withField(GetSearchMotorcycleAutoCompleteFieldEnum field) {
        this.field = field;
        return this;
    }
    ...
    public GetSearchMotorcycleAutoCompleteQueryParams withInventoryType(org.openapis.openapi.models.shared.InventoryTypeEnum inventoryType) {
    ...
    public GetSearchMotorcycleAutoCompleteQueryParams withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetSearchMotorcycleAutoCompleteQueryParams withSellerType(String sellerType) {
    ...
    public GetSearchMotorcycleAutoCompleteSortByEnum sortBy;
    public GetSearchMotorcycleAutoCompleteQueryParams withSortBy(GetSearchMotorcycleAutoCompleteSortByEnum sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public String zip;
    public GetSearchMotorcycleAutoCompleteQueryParams withZip(String zip) {
        this.zip = zip;
        return this;
    }
