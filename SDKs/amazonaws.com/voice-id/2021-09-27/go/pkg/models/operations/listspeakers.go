...
type ListSpeakersQueryParams struct {
	// Pagination limit
...
type ListSpeakersHeaders struct {
...
type ListSpeakersRequest struct {
	QueryParams ListSpeakersQueryParams
	Headers     ListSpeakersHeaders
	Request     shared.ListSpeakersRequest `request:"mediaType=application/json"`
}
