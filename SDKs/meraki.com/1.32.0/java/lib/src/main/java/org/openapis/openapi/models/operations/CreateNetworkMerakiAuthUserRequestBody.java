...
public class CreateNetworkMerakiAuthUserRequestBody {
    ...
    public CreateNetworkMerakiAuthUserRequestBody(@JsonProperty("authorizations") CreateNetworkMerakiAuthUserRequestBodyAuthorizations[] authorizations, @JsonProperty("email") String email) {
        this.authorizations = authorizations;
        this.email = email;
  }
}
