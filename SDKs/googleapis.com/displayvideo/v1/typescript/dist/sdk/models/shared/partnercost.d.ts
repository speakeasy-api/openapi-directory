 ...
 */
export declare enum PartnerCostCostTypeEnum {
 ...
 */
export declare enum PartnerCostFeeTypeEnum {
 ...
 */
export declare enum PartnerCostInvoiceTypeEnum {
 ...
 */
export declare class PartnerCost extends SpeakeasyBase {
    /**
     * Required. The type of the partner cost.
     */
