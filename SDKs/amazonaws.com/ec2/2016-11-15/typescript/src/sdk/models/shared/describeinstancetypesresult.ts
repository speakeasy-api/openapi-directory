 ...
 */
export class DescribeInstanceTypesResultInstanceTypesEbsInfoEbsOptimizedInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum DescribeInstanceTypesResultInstanceTypesEbsInfoEbsOptimizedSupportEnum {
 ...
 */
export enum DescribeInstanceTypesResultInstanceTypesEbsInfoEncryptionSupportEnum {
  Unsupported = "unsupported",
  Supported = "supported",
}
 ...
 */
export enum DescribeInstanceTypesResultInstanceTypesEbsInfoNvmeSupportEnum {
  Unsupported = "unsupported",
  Supported = "supported",
  Required = "required",
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesEbsInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesFpgaInfoFpgasMemoryInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
  sizeInMiB?: number;
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesFpgaInfoFpgas extends SpeakeasyBase {
  @SpeakeasyMetadata()
  count?: number;
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesFpgaInfo extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesGpuInfoGpusMemoryInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
  sizeInMiB?: number;
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesGpuInfoGpus extends SpeakeasyBase {
  @SpeakeasyMetadata()
  count?: number;
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesGpuInfo extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DescribeInstanceTypesResultInstanceTypesHypervisorEnum {
  Nitro = "nitro",
  Xen = "xen",
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesInferenceAcceleratorInfo extends SpeakeasyBase {
 ...
 * The type of disk.
 */
export enum DescribeInstanceTypesResultInstanceTypesInstanceStorageInfoDisksTypeEnum {
  Hdd = "hdd",
  Ssd = "ssd",
}
 ...
 * Describes a disk.
 */
export class DescribeInstanceTypesResultInstanceTypesInstanceStorageInfoDisks extends SpeakeasyBase {
  @SpeakeasyMetadata()
  count?: number;
 ...
 */
export enum DescribeInstanceTypesResultInstanceTypesInstanceStorageInfoEncryptionSupportEnum {
  Unsupported = "unsupported",
  Required = "required",
}
 ...
 * Indicates whether non-volatile memory express (NVMe) is supported.
 */
export enum DescribeInstanceTypesResultInstanceTypesInstanceStorageInfoNvmeSupportEnum {
  Unsupported = "unsupported",
  Supported = "supported",
  Required = "required",
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesInstanceStorageInfo extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DescribeInstanceTypesResultInstanceTypesInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesMemoryInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
  sizeInMiB?: number;
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesNetworkInfoEfaInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum DescribeInstanceTypesResultInstanceTypesNetworkInfoEnaSupportEnum {
  Unsupported = "unsupported",
  Supported = "supported",
  Required = "required",
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesNetworkInfoNetworkCards extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesNetworkInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export enum DescribeInstanceTypesResultInstanceTypesPlacementGroupInfoSupportedStrategiesEnum {
  Cluster = "cluster",
  Partition = "partition",
  Spread = "spread",
}
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesPlacementGroupInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
  supportedStrategies?: DescribeInstanceTypesResultInstanceTypesPlacementGroupInfoSupportedStrategiesEnum[];
}

export enum DescribeInstanceTypesResultInstanceTypesProcessorInfoSupportedArchitecturesEnum {
  I386 = "i386",
  X8664 = "x86_64",
  Arm64 = "arm64",
  X8664Mac = "x86_64_mac",
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesProcessorInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export enum DescribeInstanceTypesResultInstanceTypesSupportedBootModesEnum {
  LegacyBios = "legacy-bios",
  Uefi = "uefi",
}

export enum DescribeInstanceTypesResultInstanceTypesSupportedRootDeviceTypesEnum {
  Ebs = "ebs",
  InstanceStore = "instance-store",
}

export enum DescribeInstanceTypesResultInstanceTypesSupportedUsageClassesEnum {
  Spot = "spot",
  OnDemand = "on-demand",
}

export enum DescribeInstanceTypesResultInstanceTypesSupportedVirtualizationTypesEnum {
  Hvm = "hvm",
 ...
 */
export class DescribeInstanceTypesResultInstanceTypesVCpuInfo extends SpeakeasyBase {
  @SpeakeasyMetadata()
  defaultCores?: number;
 ...
 */
export class DescribeInstanceTypesResultInstanceTypes extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DescribeInstanceTypesResult extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: DescribeInstanceTypesResultInstanceTypes })
