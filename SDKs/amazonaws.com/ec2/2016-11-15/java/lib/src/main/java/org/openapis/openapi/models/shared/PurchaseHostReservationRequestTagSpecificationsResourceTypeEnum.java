 ...
 */
public enum PurchaseHostReservationRequestTagSpecificationsResourceTypeEnum {
    ...
    private PurchaseHostReservationRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
