...
public class DescribeClassicLinkInstancesRequestFilters {
    ...
    public DescribeClassicLinkInstancesRequestFilters withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public DescribeClassicLinkInstancesRequestFilters(){}
}
