...
public class GetNhSeaQueryParams {
    /**
    ...
    public GetNhSeaQueryParams withExcludedetails(String excludedetails) {
    ...
    public String month;
    public GetNhSeaQueryParams withMonth(String month) {
        this.month = month;
        return this;
    }
    ...
    public GetNhSeaQueryParams withThumbsize(Long thumbsize) {
