 ...
 */
export enum AutoscalerAggregatedListWarningCodeEnum {
...
export class AutoscalerAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class AutoscalerAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: AutoscalerAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class AutoscalerAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: AutoscalersScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, AutoscalersScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], AutoscalersScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
