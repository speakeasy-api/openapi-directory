...
class DescribeVerifiedAccessInstanceLoggingConfigurationsRequestFilters:
...
class DescribeVerifiedAccessInstanceLoggingConfigurationsRequest:
    ...
    filters: Optional[list[DescribeVerifiedAccessInstanceLoggingConfigurationsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    verified_access_instance_ids: Optional[list[str]] = dataclasses.field(default=None)  
