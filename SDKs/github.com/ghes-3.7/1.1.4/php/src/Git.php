...
class Git 
{
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-blob
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-commit
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-reference
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-tag-object
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#create-a-tree
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#delete-a-reference
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-blob
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-commit
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-reference
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-tag
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#get-a-tree
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#list-matching-references
     */
     ...
     * @see https://docs.github.com/enterprise-server@3.7/rest/reference/git#update-a-reference
     */
