...
class MergeCellsRequestMergeTypeEnum(str, Enum):
    r"""How the cells should be merged."""
    MERGE_ALL = 'MERGE_ALL'
...
class MergeCellsRequest:
    ...
    merge_type: Optional[MergeCellsRequestMergeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mergeType'), 'exclude': lambda f: f is None }})
    r"""How the cells should be merged."""  
