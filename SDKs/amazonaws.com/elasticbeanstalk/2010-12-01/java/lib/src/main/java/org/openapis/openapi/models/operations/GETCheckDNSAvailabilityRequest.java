...
public class GETCheckDNSAvailabilityRequest {
    ...
    public GETCheckDNSAvailabilityRequest(@JsonProperty("Action") GETCheckDNSAvailabilityActionEnum action, @JsonProperty("CNAMEPrefix") String cnamePrefix, @JsonProperty("Version") GETCheckDNSAvailabilityVersionEnum version) {
        this.action = action;
        this.cnamePrefix = cnamePrefix;
        this.version = version;
  }
