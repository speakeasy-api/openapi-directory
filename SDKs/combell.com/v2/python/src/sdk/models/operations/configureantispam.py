...
from ..shared import updateantispamrequest as shared_updateantispamrequest
...
class ConfigureAntiSpamRequest:
    ...
    update_anti_spam_request: Optional[shared_updateantispamrequest.UpdateAntiSpamRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
