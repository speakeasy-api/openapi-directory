...
class DeleteRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDRequestChangesRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDRequestChangesPathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDRequestChangesSecurity = dataclasses.field()
