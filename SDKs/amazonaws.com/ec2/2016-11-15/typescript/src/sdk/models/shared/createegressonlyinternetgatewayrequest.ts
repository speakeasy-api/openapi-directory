 ...
 */
export enum CreateEgressOnlyInternetGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateEgressOnlyInternetGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateEgressOnlyInternetGatewayRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateEgressOnlyInternetGatewayRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
