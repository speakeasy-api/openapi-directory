...
func (e GETDescribeEndpointAccessActionEnum) ToPointer() *GETDescribeEndpointAccessActionEnum {
	return &e
}
...
func (e *GETDescribeEndpointAccessActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeEndpointAccess":
		*e = GETDescribeEndpointAccessActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeEndpointAccessActionEnum: %v", v)
	}
}
...
func (e GETDescribeEndpointAccessVersionEnum) ToPointer() *GETDescribeEndpointAccessVersionEnum {
	return &e
}
...
func (e *GETDescribeEndpointAccessVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2012-12-01":
		*e = GETDescribeEndpointAccessVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeEndpointAccessVersionEnum: %v", v)
	}
}
