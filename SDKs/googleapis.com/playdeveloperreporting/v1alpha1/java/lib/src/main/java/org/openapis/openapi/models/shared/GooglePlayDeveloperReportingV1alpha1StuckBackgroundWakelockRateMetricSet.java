 ...
 */
public class GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet {
    /**
    ...
    @JsonProperty("freshnessInfo")
    public GooglePlayDeveloperReportingV1alpha1FreshnessInfo freshnessInfo;

    public GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet withFreshnessInfo(GooglePlayDeveloperReportingV1alpha1FreshnessInfo freshnessInfo) {
    ...
    public GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet withName(String name) {
        this.name = name;
        return this;
    }
    
    public GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet(){}
}
