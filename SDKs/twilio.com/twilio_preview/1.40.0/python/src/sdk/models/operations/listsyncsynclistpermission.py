...
class ListSyncSyncListPermissionListSyncSyncListPermissionResponse:
    ...
    meta: Optional[ListSyncSyncListPermissionListSyncSyncListPermissionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    permissions: Optional[list[shared_preview_sync_service_sync_list_sync_list_permission.PreviewSyncServiceSyncListSyncListPermission]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permissions'), 'exclude': lambda f: f is None }})  
