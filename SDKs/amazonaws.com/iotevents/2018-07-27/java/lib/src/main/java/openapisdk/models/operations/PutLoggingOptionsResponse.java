...
public class PutLoggingOptionsResponse {
    ...
    public PutLoggingOptionsResponse withResourceInUseException(Object resourceInUseException) {
    ...
    public PutLoggingOptionsResponse withUnsupportedOperationException(Object unsupportedOperationException) {
