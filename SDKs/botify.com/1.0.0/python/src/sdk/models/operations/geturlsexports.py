...
class GetUrlsExportsPathParams:
...
@dataclasses.dataclass
class GetUrlsExportsQueryParams:
...
@dataclass_json
@dataclasses.dataclass
class GetUrlsExports200ApplicationJSON:
    count: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count') }})
    next: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('next') }})
    page: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('page') }})
    previous: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('previous') }})
    results: Optional[list[shared_csvexportstatus.CsvExportStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    size: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('size') }})
    

@dataclasses.dataclass
class GetUrlsExportsRequest:
    path_params: GetUrlsExportsPathParams = dataclasses.field()
    query_params: GetUrlsExportsQueryParams = dataclasses.field()
...
class GetUrlsExportsResponse:
    ...
    get_urls_exports_200_application_json_object: Optional[GetUrlsExports200ApplicationJSON] = dataclasses.field(default=None)
