...
@dataclasses.dataclass
class ListVmknicsSecurity:
    api_key_auth: shared_security.SchemeAPIKeyAuth = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class ListVmknicsRequest:
    query_params: ListVmknicsQueryParams = dataclasses.field()
    security: ListVmknicsSecurity = dataclasses.field()
    

@dataclasses.dataclass
class ListVmknicsResponse:
