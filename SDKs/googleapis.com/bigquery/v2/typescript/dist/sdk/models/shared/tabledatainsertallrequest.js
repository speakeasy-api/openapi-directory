...
exports.TableDataInsertAllRequest = exports.TableDataInsertAllRequestRows = void 0;
...
exports.TableDataInsertAllRequestRows = TableDataInsertAllRequestRows;
var TableDataInsertAllRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: TableDataInsertAllRequestRows }),
        (0, class_transformer_1.Expose)({ name: "rows" }),
        (0, class_transformer_1.Type)(function () { return TableDataInsertAllRequestRows; }),
        __metadata("design:type", Array)
    ], TableDataInsertAllRequest.prototype, "rows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "skipInvalidRows" }),
        __metadata("design:type", Boolean)
    ], TableDataInsertAllRequest.prototype, "skipInvalidRows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "templateSuffix" }),
        __metadata("design:type", String)
    ], TableDataInsertAllRequest.prototype, "templateSuffix", void 0);
    return TableDataInsertAllRequest;
}(utils_1.SpeakeasyBase));
exports.TableDataInsertAllRequest = TableDataInsertAllRequest;
