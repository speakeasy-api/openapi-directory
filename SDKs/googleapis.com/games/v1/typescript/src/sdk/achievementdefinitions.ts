...
export class AchievementDefinitions {
  ...
  gamesAchievementDefinitionsList(
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GamesAchievementDefinitionsListSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GamesAchievementDefinitionsListResponse =
        new operations.GamesAchievementDefinitionsListResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.achievementDefinitionsListResponse = utils.objectToClass(
              httpRes?.data,
              shared.AchievementDefinitionsListResponse
            );
          }
          break;
      }
