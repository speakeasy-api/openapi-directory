...
var SimulationJobBatchSummary = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "createdRequestCount" }),
        __metadata("design:type", Number)
    ], SimulationJobBatchSummary.prototype, "createdRequestCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "failedRequestCount" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "pendingRequestCount" }),
        __metadata("design:type", Number)
