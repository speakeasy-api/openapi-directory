...
<https://docs.github.com/enterprise-server@3.2/rest/reference/search#search-code>
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/search#search-commits>
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/search#search-issues-and-pull-requests>
...
try {
    ...
    $request->q = 'cumque';
    $request->sort = SearchIssuesAndPullRequestsSortEnum::UPDATED;
...
Find labels in a repository with names or descriptions that match search keywords. Returns up to 100 results [per page](https://docs.github.com/enterprise-server@3.2/rest/overview/resources-in-the-rest-api#pagination).
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/search#search-labels>
...
try {
    ...
    $request->order = OrderEnum::DESC;
    $request->page = 712640;
    $request->perPage = 548256;
    $request->q = 'rem';
    $request->repositoryId = 543353;
    $request->sort = SearchLabelsSortEnum::UPDATED;
...
Find repositories via various criteria. This method returns up to 100 results [per page](https://docs.github.com/enterprise-server@3.2/rest/overview/resources-in-the-rest-api#pagination).
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/search#search-repositories>
...
try {
    ...
    $request->order = OrderEnum::ASC;
    $request->page = 863330;
    $request->perPage = 956871;
    $request->q = 'quo';
    $request->sort = SearchReposSortEnum::FORKS;
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/search#search-topics>
...
Find users via various criteria. This method returns up to 100 results [per page](https://docs.github.com/enterprise-server@3.2/rest/overview/resources-in-the-rest-api#pagination).
...
API method documentation
<https://docs.github.com/enterprise-server@3.2/rest/reference/search#search-users>
