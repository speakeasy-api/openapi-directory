...
class SubtaskInformationPreviousStateEnum(str, Enum):
    r"""Gets or sets the previous state of the subtask. This property is not set if the subtask is in its initial Active state."""
    ACTIVE = 'active'
    PREPARING = 'preparing'
    RUNNING = 'running'
    COMPLETED = 'completed'
...
class SubtaskInformationStateEnum(str, Enum):
    r"""Gets or sets the current state of the subtask."""
    ACTIVE = 'active'
    PREPARING = 'preparing'
    RUNNING = 'running'
    COMPLETED = 'completed'
...
class SubtaskInformation:
    ...
    r"""Gets or sets the time at which the subtask completed. This property is set only if the subtask is in the Completed state."""  
    ...
    r"""Gets or sets the exit code of the subtask. This property is set only if the subtask is in the Completed state."""  
    id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})
    r"""Gets or sets the id of the subtask."""  
    ...
    r"""Gets or sets the time at which the subtask entered its previous state. This property is not set if the subtask is in its initial Active state."""  
    ...
    r"""Gets or sets the time at which the subtask started running. If the subtask has been restarted or retried, this is the most recent time at which the subtask started running."""  
    ...
    r"""Gets or sets the time at which the subtask entered its current state."""  
