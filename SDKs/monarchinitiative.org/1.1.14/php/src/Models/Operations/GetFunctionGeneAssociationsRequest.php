...
class GetFunctionGeneAssociationsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetFunctionGeneAssociationsRelationshipTypeEnum $relationshipType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=relationship_type')]
    public ?GetFunctionGeneAssociationsRelationshipTypeEnum $relationshipType = null;
