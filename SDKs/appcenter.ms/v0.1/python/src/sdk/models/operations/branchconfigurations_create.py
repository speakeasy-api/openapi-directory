...
class BranchConfigurationsCreateRequestBodyArtifactVersioningBuildNumberFormatEnum(str, Enum):
    BUILD_ID = 'buildId'
    TIMESTAMP = 'timestamp'
...
class BranchConfigurationsCreateRequestBodyArtifactVersioning:
    ...
    build_number_format: Optional[BranchConfigurationsCreateRequestBodyArtifactVersioningBuildNumberFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('buildNumberFormat'), 'exclude': lambda f: f is None }})  
...
class BranchConfigurationsCreateRequestBodyToolsetsXcode:
    ...
    app_extension_provisioning_profile_files: Optional[list[BranchConfigurationsCreateRequestBodyToolsetsXcodeAppExtensionProvisioningProfileFiles]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('appExtensionProvisioningProfileFiles'), 'exclude': lambda f: f is None }})  
...
class BranchConfigurationsCreateRequestBodyToolsets:
    ...
    android: Optional[BranchConfigurationsCreateRequestBodyToolsetsAndroid] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('android'), 'exclude': lambda f: f is None }})
    r"""Build configuration for Android projects"""  
    javascript: Optional[BranchConfigurationsCreateRequestBodyToolsetsJavascript] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('javascript'), 'exclude': lambda f: f is None }})
    r"""Build configuration when React Native, or other JavaScript tech, is part of the build steps"""  
    xamarin: Optional[BranchConfigurationsCreateRequestBodyToolsetsXamarin] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('xamarin'), 'exclude': lambda f: f is None }})
    r"""Build configuration for Xamarin projects"""  
    xcode: Optional[BranchConfigurationsCreateRequestBodyToolsetsXcode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('xcode'), 'exclude': lambda f: f is None }})
    r"""Build configuration when Xcode is part of the build steps"""  
    
class BranchConfigurationsCreateRequestBodyTriggerEnum(str, Enum):
    CONTINOUS = 'continous'
...
class BranchConfigurationsCreateRequestBody:
    ...
    artifact_versioning: Optional[BranchConfigurationsCreateRequestBodyArtifactVersioning] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('artifactVersioning'), 'exclude': lambda f: f is None }})
    r"""The versioning configuration for artifacts built for this branch"""  
    ...
    toolsets: Optional[BranchConfigurationsCreateRequestBodyToolsets] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('toolsets'), 'exclude': lambda f: f is None }})
    r"""The branch build configuration for each toolset"""  
    trigger: Optional[BranchConfigurationsCreateRequestBodyTriggerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('trigger'), 'exclude': lambda f: f is None }})  
...
class BranchConfigurationsCreateRequest:
    ...
    request_body: BranchConfigurationsCreateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Parameters of the configuration"""  
    
class BranchConfigurationsCreate200ApplicationJSONArtifactVersioningBuildNumberFormatEnum(str, Enum):
    BUILD_ID = 'buildId'
    TIMESTAMP = 'timestamp'
...
class BranchConfigurationsCreate200ApplicationJSONArtifactVersioning:
    ...
    build_number_format: Optional[BranchConfigurationsCreate200ApplicationJSONArtifactVersioningBuildNumberFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('buildNumberFormat'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class BranchConfigurationsCreate200ApplicationJSONToolsetsJavascript:
    r"""Build configuration when React Native, or other JavaScript tech, is part of the build steps"""
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class BranchConfigurationsCreate200ApplicationJSONToolsetsXcodeAppExtensionProvisioningProfileFiles:
    r"""Provisioning profile fetch and store information"""
...
class BranchConfigurationsCreate200ApplicationJSONToolsetsXcode:
    ...
    app_extension_provisioning_profile_files: Optional[list[BranchConfigurationsCreate200ApplicationJSONToolsetsXcodeAppExtensionProvisioningProfileFiles]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('appExtensionProvisioningProfileFiles'), 'exclude': lambda f: f is None }})  
    archive_configuration: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('archiveConfiguration'), 'exclude': lambda f: f is None }})
    r"""The build configuration of the target to archive"""  
    automatic_signing: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('automaticSigning'), 'exclude': lambda f: f is None }})  
    cartfile_path: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cartfilePath'), 'exclude': lambda f: f is None }})
...
class BranchConfigurationsCreate200ApplicationJSONToolsets:
    ...
    android: Optional[BranchConfigurationsCreate200ApplicationJSONToolsetsAndroid] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('android'), 'exclude': lambda f: f is None }})
    r"""Build configuration for Android projects"""  
    javascript: Optional[BranchConfigurationsCreate200ApplicationJSONToolsetsJavascript] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('javascript'), 'exclude': lambda f: f is None }})
    r"""Build configuration when React Native, or other JavaScript tech, is part of the build steps"""  
    xamarin: Optional[BranchConfigurationsCreate200ApplicationJSONToolsetsXamarin] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('xamarin'), 'exclude': lambda f: f is None }})
    r"""Build configuration for Xamarin projects"""  
    xcode: Optional[BranchConfigurationsCreate200ApplicationJSONToolsetsXcode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('xcode'), 'exclude': lambda f: f is None }})
    r"""Build configuration when Xcode is part of the build steps"""  
    
class BranchConfigurationsCreate200ApplicationJSONTriggerEnum(str, Enum):
    CONTINOUS = 'continous'
    CONTINUOUS = 'continuous'
    MANUAL = 'manual'
...
class BranchConfigurationsCreate200ApplicationJSON:
    ...
    artifact_versioning: Optional[BranchConfigurationsCreate200ApplicationJSONArtifactVersioning] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('artifactVersioning'), 'exclude': lambda f: f is None }})
    r"""The versioning configuration for artifacts built for this branch"""  
    badge_is_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('badgeIsEnabled'), 'exclude': lambda f: f is None }})  
    clone_from_branch: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cloneFromBranch'), 'exclude': lambda f: f is None }})
    r"""A configured branch name to clone from. If provided, all other parameters will be ignored. Only supported in POST requests."""  
    signed: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('signed'), 'exclude': lambda f: f is None }})  
    tests_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('testsEnabled'), 'exclude': lambda f: f is None }})  
    toolsets: Optional[BranchConfigurationsCreate200ApplicationJSONToolsets] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('toolsets'), 'exclude': lambda f: f is None }})
    r"""The branch build configuration for each toolset"""  
    trigger: Optional[BranchConfigurationsCreate200ApplicationJSONTriggerEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('trigger'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class BranchConfigurationsCreateResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    branch_configurations_create_200_application_json_object: Optional[BranchConfigurationsCreate200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
