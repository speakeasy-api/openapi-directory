...
var SearchResourcesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: matchingresource_1.MatchingResource }),
        (0, class_transformer_1.Expose)({ name: "matchingResources" }),
        (0, class_transformer_1.Type)(function () { return matchingresource_1.MatchingResource; }),
