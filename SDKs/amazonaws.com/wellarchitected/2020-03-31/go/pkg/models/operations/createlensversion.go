...
type CreateLensVersionPathParams struct {
	LensAlias string `pathParam:"style=simple,explode=false,name=LensAlias"`
}

type CreateLensVersionHeaders struct {
...
type CreateLensVersionRequest struct {
	PathParams CreateLensVersionPathParams
	Headers    CreateLensVersionHeaders
	Request    CreateLensVersionRequestBody `request:"mediaType=application/json"`
}
