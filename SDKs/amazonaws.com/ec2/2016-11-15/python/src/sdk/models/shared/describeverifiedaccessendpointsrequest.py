...
class DescribeVerifiedAccessEndpointsRequestFilters:
...
class DescribeVerifiedAccessEndpointsRequest:
    ...
    filters: Optional[list[DescribeVerifiedAccessEndpointsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    verified_access_endpoint_ids: Optional[list[str]] = dataclasses.field(default=None)  
