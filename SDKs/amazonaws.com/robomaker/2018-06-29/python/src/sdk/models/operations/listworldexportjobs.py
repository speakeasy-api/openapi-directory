...
class ListWorldExportJobsRequest:
    ...
    request_body: ListWorldExportJobsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
