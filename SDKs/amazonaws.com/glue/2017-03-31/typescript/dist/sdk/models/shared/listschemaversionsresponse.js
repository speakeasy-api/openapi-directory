...
var ListSchemaVersionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: schemaversionlistitem_1.SchemaVersionListItem }),
        (0, class_transformer_1.Expose)({ name: "Schemas" }),
        (0, class_transformer_1.Type)(function () { return schemaversionlistitem_1.SchemaVersionListItem; }),
