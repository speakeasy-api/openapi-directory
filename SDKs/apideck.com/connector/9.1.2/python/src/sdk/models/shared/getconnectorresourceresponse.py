...
import dataclasses
from ..shared import connectorresource as shared_connectorresource
...
class GetConnectorResourceResponse:
    ...
    data: shared_connectorresource.ConnectorResource = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
