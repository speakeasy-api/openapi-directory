...
export class MetastoreProjectsLocationsFederationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsFederationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MetastoreProjectsLocationsFederationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
