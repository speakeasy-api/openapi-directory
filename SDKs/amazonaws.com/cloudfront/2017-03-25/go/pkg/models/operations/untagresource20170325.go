...
func (e UntagResource20170325OperationEnum) ToPointer() *UntagResource20170325OperationEnum {
	return &e
}
...
func (e *UntagResource20170325OperationEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "Untag":
		*e = UntagResource20170325OperationEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UntagResource20170325OperationEnum: %v", v)
	}
}
