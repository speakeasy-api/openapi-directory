...
import dataclasses
from ..shared import application_response as shared_application_response
...
class ApplicationStatus:
    ...
    data: Optional[shared_application_response.ApplicationResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
