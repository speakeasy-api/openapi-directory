...
export class CrashesGetNativeCrashSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CrashesGetNativeCrashRequest extends SpeakeasyBase {
  /**
 ...
 * Error
 */
export class CrashesGetNativeCrashDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "message" })
  message: string;
}

export class CrashesGetNativeCrashResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
