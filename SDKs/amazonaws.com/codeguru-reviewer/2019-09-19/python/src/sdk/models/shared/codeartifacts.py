...
class CodeArtifacts:
    ...
    source_code_artifacts_object_key: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SourceCodeArtifactsObjectKey') }})
    build_artifacts_object_key: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('BuildArtifactsObjectKey') }})
