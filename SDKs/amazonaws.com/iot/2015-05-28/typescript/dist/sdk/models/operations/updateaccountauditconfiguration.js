...
exports.UpdateAccountAuditConfigurationResponse = exports.UpdateAccountAuditConfigurationRequest = exports.UpdateAccountAuditConfigurationRequestBody = void 0;
...
var UpdateAccountAuditConfigurationRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AuditCheckConfiguration }),
        (0, class_transformer_1.Expose)({ name: "auditCheckConfigurations" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], shared.AuditCheckConfiguration);
            }
            return obj;
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.AuditNotificationTarget }),
        (0, class_transformer_1.Expose)({ name: "auditNotificationTargetConfigurations" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], shared.AuditNotificationTarget);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
...
exports.UpdateAccountAuditConfigurationRequestBody = UpdateAccountAuditConfigurationRequestBody;
var UpdateAccountAuditConfigurationRequest = /** @class */ (function (_super) {
    ...
    ], UpdateAccountAuditConfigurationRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateAccountAuditConfigurationRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateAccountAuditConfigurationRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateAccountAuditConfigurationRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateAccountAuditConfigurationRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateAccountAuditConfigurationRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateAccountAuditConfigurationRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateAccountAuditConfigurationRequest.prototype, "xAmzSignedHeaders", void 0);
    return UpdateAccountAuditConfigurationRequest;
}(utils_1.SpeakeasyBase));
exports.UpdateAccountAuditConfigurationRequest = UpdateAccountAuditConfigurationRequest;
var UpdateAccountAuditConfigurationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateAccountAuditConfigurationResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.UpdateAccountAuditConfigurationResponse = UpdateAccountAuditConfigurationResponse;
