...
class CreateIpamPoolResultIpamPoolAddressFamilyEnum(str, Enum):
...
class CreateIpamPoolResultIpamPoolAwsServiceEnum(str, Enum):
...
class CreateIpamPoolResultIpamPoolIpamScopeTypeEnum(str, Enum):
...
class CreateIpamPoolResultIpamPoolPublicIPSourceEnum(str, Enum):
...
class CreateIpamPoolResultIpamPoolStateEnum(str, Enum):
...
@dataclasses.dataclass
class CreateIpamPoolResultIpamPoolTags:
    r"""Describes a tag."""
...
class CreateIpamPoolResultIpamPool:
    r"""Information about the IPAM pool created."""
    
    address_family: Optional[CreateIpamPoolResultIpamPoolAddressFamilyEnum] = dataclasses.field(default=None)  
    ...
    allocation_resource_tags: Optional[list[CreateIpamPoolResultIpamPoolAllocationResourceTags]] = dataclasses.field(default=None)  
    auto_import: Optional[bool] = dataclasses.field(default=None)  
    aws_service: Optional[CreateIpamPoolResultIpamPoolAwsServiceEnum] = dataclasses.field(default=None)  
    ...
    ipam_scope_type: Optional[CreateIpamPoolResultIpamPoolIpamScopeTypeEnum] = dataclasses.field(default=None)  
    ...
    public_ip_source: Optional[CreateIpamPoolResultIpamPoolPublicIPSourceEnum] = dataclasses.field(default=None)  
    ...
    state: Optional[CreateIpamPoolResultIpamPoolStateEnum] = dataclasses.field(default=None)  
    state_message: Optional[str] = dataclasses.field(default=None)  
    tags: Optional[list[CreateIpamPoolResultIpamPoolTags]] = dataclasses.field(default=None)  
...
class CreateIpamPoolResult:
    ...
    ipam_pool: Optional[CreateIpamPoolResultIpamPool] = dataclasses.field(default=None)  
