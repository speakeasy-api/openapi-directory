...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesAllRequest;
use \OpenAPI\OpenAPI\Models\Shared\ActivitiesFilter;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesAllSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ActivitiesAllRequest();
    $request->cursor = 'deserunt';
    $request->fields = 'suscipit';
    $request->filter = new ActivitiesFilter();
    $request->filter->updatedSince = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2020-09-30T07:43:32.000Z');
    $request->limit = 437587;
    $request->raw = false;
    $request->xApideckAppId = 'magnam';
    $request->xApideckConsumerId = 'debitis';
    $request->xApideckServiceId = 'ipsa';

    $requestSecurity = new ActivitiesAllSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';

    $response = $sdk->activities->activitiesAll($request, $requestSecurity);

    if ($response->getActivitiesResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesDeleteRequest;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesDeleteSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ActivitiesDeleteRequest();
    $request->id = 'f467cc87-96ed-4151-a05d-fc2ddf7cc78c';
    $request->raw = false;
    $request->xApideckAppId = 'dolorum';
    $request->xApideckConsumerId = 'dicta';
    $request->xApideckServiceId = 'nam';

    $requestSecurity = new ActivitiesDeleteSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';

    $response = $sdk->activities->activitiesDelete($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesOneRequest;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesOneSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ActivitiesOneRequest();
    ...
    $requestSecurity = new ActivitiesOneSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';

    $response = $sdk->activities->activitiesOne($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesUpdateRequest;
use \OpenAPI\OpenAPI\Models\Shared\ActivityInput;
use \OpenAPI\OpenAPI\Models\Shared\ActivityAttendeeInput;
use \OpenAPI\OpenAPI\Models\Shared\ActivityAttendeeStatusEnum;
use \OpenAPI\OpenAPI\Models\Shared\CustomField;
...
use \OpenAPI\OpenAPI\Models\Shared\ActivityShowAsEnum;
use \OpenAPI\OpenAPI\Models\Shared\ActivityTypeEnum;
use \OpenAPI\OpenAPI\Models\Operations\ActivitiesUpdateSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ActivitiesUpdateRequest();
    $request->activityInput = new ActivityInput();
    $request->activityInput->accountId = '12345';
    $request->activityInput->activityDate = '2021-05-01';
    $request->activityInput->activityDatetime = '2021-05-01T12:00:00.000Z';
    ...
    $request->activityInput->videoConferenceId = 'zoom:88120759396';
    $request->activityInput->videoConferenceUrl = 'https://us02web.zoom.us/j/88120759396';
    $request->id = 'faaa2352-c595-4590-baff-1a3a2fa94677';
    $request->raw = false;
    $request->xApideckAppId = 'velit';
    $request->xApideckConsumerId = 'error';
    $request->xApideckServiceId = 'quia';

    $requestSecurity = new ActivitiesUpdateSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';

    $response = $sdk->activities->activitiesUpdate($request, $requestSecurity);
