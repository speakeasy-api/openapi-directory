...
class GetRelationalDatabaseMetricDataRequest:
    ...
    get_relational_database_metric_data_request: shared_getrelationaldatabasemetricdatarequest.GetRelationalDatabaseMetricDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
