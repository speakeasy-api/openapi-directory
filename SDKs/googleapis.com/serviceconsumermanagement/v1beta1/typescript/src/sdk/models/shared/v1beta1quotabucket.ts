 ...
 */
export class V1Beta1QuotaBucket extends SpeakeasyBase {
  /**
   * A quota override
   */
  @SpeakeasyMetadata()
  @Expose({ name: "adminOverride" })
