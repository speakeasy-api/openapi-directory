...
class GetPublicationDiseaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPublicationDiseaseAssociationsQueryParams:
...
class GetPublicationDiseaseAssociationsRequest:
    path_params: GetPublicationDiseaseAssociationsPathParams = dataclasses.field()
    query_params: GetPublicationDiseaseAssociationsQueryParams = dataclasses.field()
