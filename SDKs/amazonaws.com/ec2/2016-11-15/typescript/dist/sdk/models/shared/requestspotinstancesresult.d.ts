 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsFault extends SpeakeasyBase {
    code?: string;
    message?: string;
}
/**
 ...
 */
export declare enum RequestSpotInstancesResultSpotInstanceRequestsInstanceInterruptionBehaviorEnum {
    Hibernate = "hibernate",
    Stop = "stop",
    Terminate = "terminate"
}
 ...
 */
export declare enum RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbsVolumeTypeEnum {
    Standard = "standard",
    Io1 = "io1",
    Io2 = "io2",
    Gp2 = "gp2",
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappingsEbs extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationBlockDeviceMappings extends SpeakeasyBase {
    deviceName?: string;
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationIamInstanceProfile extends SpeakeasyBase {
    arn?: string;
    name?: string;
}
/**
 ...
 */
export declare enum RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationMonitoring extends SpeakeasyBase {
    enabled: boolean;
}
/**
 * Describes the IPv4 prefix option for a network interface.
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv4Prefixes extends SpeakeasyBase {
    ipv4Prefix?: string;
}
/**
 * Describes an IPv6 address.
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Addresses extends SpeakeasyBase {
    ipv6Address?: string;
}
/**
 * Describes the IPv4 prefix option for a network interface.
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesIpv6Prefixes extends SpeakeasyBase {
    ipv6Prefix?: string;
}
/**
 * Describes a secondary private IPv4 address for a network interface.
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfacesPrivateIpAddresses extends SpeakeasyBase {
    primary?: boolean;
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationNetworkInterfaces extends SpeakeasyBase {
 ...
 */
export declare enum RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationPlacementTenancyEnum {
    Default = "default",
    Dedicated = "dedicated",
    Host = "host"
}
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationPlacement extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecificationSecurityGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsLaunchSpecification extends SpeakeasyBase {
 ...
 */
export declare enum RequestSpotInstancesResultSpotInstanceRequestsProductDescriptionEnum {
 ...
 */
export declare enum RequestSpotInstancesResultSpotInstanceRequestsStateEnum {
    Open = "open",
    Active = "active",
    Closed = "closed",
    Cancelled = "cancelled",
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsStatus extends SpeakeasyBase {
    code?: string;
    message?: string;
    updateTime?: Date;
}
 ...
 * Describes a tag.
 */
export declare class RequestSpotInstancesResultSpotInstanceRequestsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare enum RequestSpotInstancesResultSpotInstanceRequestsTypeEnum {
    OneTime = "one-time",
 ...
 */
export declare class RequestSpotInstancesResultSpotInstanceRequests extends SpeakeasyBase {
