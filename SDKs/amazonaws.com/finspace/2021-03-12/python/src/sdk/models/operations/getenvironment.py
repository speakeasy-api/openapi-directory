...
from ..shared import getenvironmentresponse as shared_getenvironmentresponse
...
class GetEnvironmentResponse:
    ...
    get_environment_response: Optional[shared_getenvironmentresponse.GetEnvironmentResponse] = dataclasses.field(default=None)
