...
class Customers:
    ...
    def customers_add(self, request: operations.CustomersAddRequest, security: operations.CustomersAddSecurity) -> operations.CustomersAddResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "customer_support_customer_input", 'json')
        ...
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateCustomerSupportCustomerResponse])
    ...
    def customers_all(self, request: operations.CustomersAllRequest, security: operations.CustomersAllSecurity) -> operations.CustomersAllResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetCustomerSupportCustomersResponse])
    ...
    def customers_delete(self, request: operations.CustomersDeleteRequest, security: operations.CustomersDeleteSecurity) -> operations.CustomersDeleteResponse:
        ...
        url = utils.generate_url(operations.CustomersDeleteRequest, base_url, '/customer-support/customers/{id}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteCustomerSupportCustomerResponse])
    ...
    def customers_one(self, request: operations.CustomersOneRequest, security: operations.CustomersOneSecurity) -> operations.CustomersOneResponse:
        ...
        url = utils.generate_url(operations.CustomersOneRequest, base_url, '/customer-support/customers/{id}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetCustomerSupportCustomerResponse])
    ...
    def customers_update(self, request: operations.CustomersUpdateRequest, security: operations.CustomersUpdateSecurity) -> operations.CustomersUpdateResponse:
        ...
        url = utils.generate_url(operations.CustomersUpdateRequest, base_url, '/customer-support/customers/{id}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateCustomerSupportCustomerResponse])
