...
class PullsCreateRequestBody:
    ...
    r"""Indicates whether the pull request is a draft. See \\"[Draft Pull Requests](https://docs.github.com/enterprise-server@3.7/articles/about-pull-requests#draft-pull-requests)\\" in the GitHub Help documentation to learn more."""  
    ...
    r"""Indicates whether [maintainers can modify](https://docs.github.com/enterprise-server@3.7/articles/allowing-changes-to-a-pull-request-branch-created-from-a-fork/) the pull request."""  
