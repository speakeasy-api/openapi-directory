...
export class Slack {
  ...
  slackGetSlackGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SlackGetSlackGetResponse =
        new operations.SlackGetSlackGetResponse({
  ...
  slackPostSlackPost(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SlackPostSlackPostResponse =
        new operations.SlackPostSlackPostResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
