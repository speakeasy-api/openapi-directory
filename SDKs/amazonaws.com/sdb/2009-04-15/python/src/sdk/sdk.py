...
__doc__ = """ SDK Documentation: https://docs.aws.amazon.com/sdb/ - Amazon Web Services documentation"""
import requests
...
class SDK:
    r"""SDK Documentation: https://docs.aws.amazon.com/sdb/ - Amazon Web Services documentation"""
    ...
    def get_domain_metadata(self, request: operations.GetDomainMetadataRequest) -> operations.GetDomainMetadataResponse:
        r""" Returns information about the domain, including when the domain was created, the number of items and attributes in the domain, and the size of the attribute names and values. 
        """
