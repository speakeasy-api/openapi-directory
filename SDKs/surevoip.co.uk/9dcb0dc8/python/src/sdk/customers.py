...
class Customers:
    ...
    def get_customer(self, request: operations.GetCustomerRequest) -> operations.GetCustomerResponse:
        ...
        url = utils.generate_url(operations.GetCustomerRequest, base_url, '/customers/{account}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetCustomer200ApplicationJSON])
    ...
    def get_customers(self) -> operations.GetCustomersResponse:
        ...
        if http_res.status_code == 302:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.GetCustomers302ApplicationJSON])
