 ...
 */
public class GoogleFirebaseAppcheckV1SafetyNetConfig {
    /**
    ...
    public GoogleFirebaseAppcheckV1SafetyNetConfig withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GoogleFirebaseAppcheckV1SafetyNetConfig withTokenTtl(String tokenTtl) {
        this.tokenTtl = tokenTtl;
        return this;
    }
    
    public GoogleFirebaseAppcheckV1SafetyNetConfig(){}
}
