...
exports.SlackGetSlackGetResponse = exports.SlackGetSlackGetRequest = void 0;
...
var SlackGetSlackGetRequest = /** @class */ (function (_super) {
    ...
    ], SlackGetSlackGetRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=base64_message",
        }),
        __metadata("design:type", String)
    ], SlackGetSlackGetRequest.prototype, "base64Message", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=channel",
        }),
        __metadata("design:type", String)
    ], SlackGetSlackGetRequest.prototype, "channel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=message",
        }),
        __metadata("design:type", String)
    ], SlackGetSlackGetRequest.prototype, "message", void 0);
...
var SlackGetSlackGetResponse = /** @class */ (function (_super) {
    ...
    ], SlackGetSlackGetResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
