...
export class TypeTypePointInline {
  ...
  searchTypePointInline(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_point_inline";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypePointInlineResponse =
        new operations.SearchTypePointInlineResponse({
