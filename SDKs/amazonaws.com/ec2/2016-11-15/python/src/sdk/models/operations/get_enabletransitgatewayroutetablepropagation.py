...
class GetEnableTransitGatewayRouteTablePropagationQueryParams:
    action: GetEnableTransitGatewayRouteTablePropagationActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetEnableTransitGatewayRouteTablePropagationVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetEnableTransitGatewayRouteTablePropagationRequest:
    headers: GetEnableTransitGatewayRouteTablePropagationHeaders = dataclasses.field()
    query_params: GetEnableTransitGatewayRouteTablePropagationQueryParams = dataclasses.field()
