...
func (s *Projects) BigtableadminProjectsInstancesClustersBackupsPatch(ctx context.Context, request operations.BigtableadminProjectsInstancesClustersBackupsPatchRequest) (*operations.BigtableadminProjectsInstancesClustersBackupsPatchResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.BigtableadminProjectsInstancesClustersBackupsPatchResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
