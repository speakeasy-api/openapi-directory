...
class SearchTypePointOpenaqQueryParams:
    ...
    search_type_point_openaq_city: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.city', 'style': 'form', 'explode': True }})
    search_type_point_openaq_country: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.country', 'style': 'form', 'explode': True }})
    search_type_point_openaq_hours_offset: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.hours_offset', 'style': 'form', 'explode': True }})
    search_type_point_openaq_location: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.location', 'style': 'form', 'explode': True }})
...
class SearchTypePointOpenaqRequest:
    query_params: SearchTypePointOpenaqQueryParams = dataclasses.field()
