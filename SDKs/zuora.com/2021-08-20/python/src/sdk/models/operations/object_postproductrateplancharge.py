...
class ObjectPostProductRatePlanChargeQueryParams:
...
@dataclasses.dataclass
class ObjectPostProductRatePlanChargeHeaders:
...
@dataclasses.dataclass
class ObjectPostProductRatePlanChargeRequest:
    headers: ObjectPostProductRatePlanChargeHeaders = dataclasses.field()
    query_params: ObjectPostProductRatePlanChargeQueryParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPostProductRatePlanChargeResponse:
