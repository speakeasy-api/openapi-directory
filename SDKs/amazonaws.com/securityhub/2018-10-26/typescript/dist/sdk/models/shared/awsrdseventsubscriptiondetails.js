...
exports.AwsRdsEventSubscriptionDetails = void 0;
...
var AwsRdsEventSubscriptionDetails = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "CustSubscriptionId" }),
        __metadata("design:type", String)
    ], AwsRdsEventSubscriptionDetails.prototype, "custSubscriptionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CustomerAwsId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EventCategoriesList" }),
        __metadata("design:type", Array)
    ], AwsRdsEventSubscriptionDetails.prototype, "eventCategoriesList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EventSubscriptionArn" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SourceIdsList" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SubscriptionCreationTime" }),
        __metadata("design:type", String)
    ], AwsRdsEventSubscriptionDetails.prototype, "subscriptionCreationTime", void 0);
    return AwsRdsEventSubscriptionDetails;
}(utils_1.SpeakeasyBase));
exports.AwsRdsEventSubscriptionDetails = AwsRdsEventSubscriptionDetails;
