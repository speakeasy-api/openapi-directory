...
var ExternallyHostedApk = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "applicationLabel" }),
        __metadata("design:type", String)
    ], ExternallyHostedApk.prototype, "applicationLabel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "certificateBase64s" }),
        __metadata("design:type", Array)
    ], ExternallyHostedApk.prototype, "certificateBase64s", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "externallyHostedUrl" }),
        __metadata("design:type", String)
    ], ExternallyHostedApk.prototype, "externallyHostedUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fileSha1Base64" }),
        __metadata("design:type", String)
    ], ExternallyHostedApk.prototype, "fileSha1Base64", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "fileSha256Base64" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "iconBase64" }),
        __metadata("design:type", String)
    ], ExternallyHostedApk.prototype, "iconBase64", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "maximumSdk" }),
        __metadata("design:type", Number)
    ], ExternallyHostedApk.prototype, "maximumSDK", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "minimumSdk" }),
        __metadata("design:type", Number)
    ], ExternallyHostedApk.prototype, "minimumSDK", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nativeCodes" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "usesFeatures" }),
        __metadata("design:type", Array)
    ], ExternallyHostedApk.prototype, "usesFeatures", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: externallyhostedapkusespermission_1.ExternallyHostedApkUsesPermission }),
        (0, class_transformer_1.Expose)({ name: "usesPermissions" }),
        (0, class_transformer_1.Type)(function () { return externallyhostedapkusespermission_1.ExternallyHostedApkUsesPermission; }),
        __metadata("design:type", Array)
