...
func (e PutParameterXAmzTargetEnum) ToPointer() *PutParameterXAmzTargetEnum {
	return &e
}
...
func (e *PutParameterXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.PutParameter":
		*e = PutParameterXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PutParameterXAmzTargetEnum: %v", v)
	}
}
