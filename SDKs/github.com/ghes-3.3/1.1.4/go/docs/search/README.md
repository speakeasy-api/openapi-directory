...
func main() {
    ...
    res, err := s.Search.SearchCommits(ctx, operations.SearchCommitsRequest{
        ...
        Page: sdk.Int64(400448),
        PerPage: sdk.Int64(513185),
        Q: "est",
...
func main() {
    ...
    res, err := s.Search.SearchIssuesAndPullRequests(ctx, operations.SearchIssuesAndPullRequestsRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(232316),
        PerPage: sdk.Int64(768195),
        Q: "rem",
        Sort: operations.SearchIssuesAndPullRequestsSortEnumReactionsThinkingFace.ToPointer(),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Search.SearchLabels(ctx, operations.SearchLabelsRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(237523),
        PerPage: sdk.Int64(927959),
        Q: "tempora",
        RepositoryID: 503449,
...
func main() {
    ...
    res, err := s.Search.SearchRepos(ctx, operations.SearchReposRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(532320),
        PerPage: sdk.Int64(27078),
        Q: "rerum",
...
func main() {
    ...
    res, err := s.Search.SearchTopics(ctx, operations.SearchTopicsRequest{
        Page: sdk.Int64(949280),
        PerPage: sdk.Int64(419858),
        Q: "quidem",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Search.SearchUsers(ctx, operations.SearchUsersRequest{
        Order: shared.OrderEnumAsc.ToPointer(),
        Page: sdk.Int64(781193),
        PerPage: sdk.Int64(646491),
        Q: "magni",
