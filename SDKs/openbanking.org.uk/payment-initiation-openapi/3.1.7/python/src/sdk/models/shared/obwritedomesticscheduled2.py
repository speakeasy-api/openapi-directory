...
class ObWriteDomesticScheduled2DataInitiation:
    ...
    creditor_account: ObWriteDomesticScheduled2DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreditorAccount') }})
    instructed_amount: ObWriteDomesticScheduled2DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('InstructedAmount') }})
    ...
    debtor_account: Optional[ObWriteDomesticScheduled2DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DebtorAccount') }})
    ...
    remittance_information: Optional[ObWriteDomesticScheduled2DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RemittanceInformation') }})
...
class ObWriteDomesticScheduled2Data:
    ...
    initiation: ObWriteDomesticScheduled2DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Initiation') }})
    

@dataclass_json
@dataclasses.dataclass
class ObWriteDomesticScheduled2:
    data: ObWriteDomesticScheduled2Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
