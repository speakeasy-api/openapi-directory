...
export class MybusinessplaceactionsLocationsPlaceActionLinksPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessplaceactionsLocationsPlaceActionLinksPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
