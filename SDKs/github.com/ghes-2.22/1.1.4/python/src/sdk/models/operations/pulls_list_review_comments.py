...
class PullsListReviewCommentsRequest:
    ...
    direction: Optional[PullsListReviewCommentsDirectionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'direction', 'style': 'form', 'explode': True }})
    r"""Can be either `asc` or `desc`. Ignored without `sort` parameter."""  
