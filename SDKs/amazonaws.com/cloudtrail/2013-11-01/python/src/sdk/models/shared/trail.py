...
class Trail:
    ...
    has_insight_selectors: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('HasInsightSelectors'), 'exclude': lambda f: f is None }})  
