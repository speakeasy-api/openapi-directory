 ...
 * 
 */
public enum GetGroupSettings200ApplicationXML1InMeetingWhoCanShareScreenEnum {
    HOST("host"),
    ALL("all");
    ...
    private GetGroupSettings200ApplicationXML1InMeetingWhoCanShareScreenEnum(String value) {
        this.value = value;
    }
}
