...
export enum ListCodeRepositoriesXAmzTargetEnum {
  SageMakerListCodeRepositories = "SageMaker.ListCodeRepositories",
}

export class ListCodeRepositoriesRequest extends SpeakeasyBase {
...
export class ListCodeRepositoriesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
