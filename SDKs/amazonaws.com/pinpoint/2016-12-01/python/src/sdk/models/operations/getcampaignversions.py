...
from ..shared import getcampaignversionsresponse as shared_getcampaignversionsresponse


@dataclasses.dataclass
class GetCampaignVersionsPathParams:
...
@dataclasses.dataclass
class GetCampaignVersionsQueryParams:
...
@dataclasses.dataclass
class GetCampaignVersionsHeaders:
...
class GetCampaignVersionsRequest:
    headers: GetCampaignVersionsHeaders = dataclasses.field()
    path_params: GetCampaignVersionsPathParams = dataclasses.field()
    query_params: GetCampaignVersionsQueryParams = dataclasses.field()
...
class GetCampaignVersionsResponse:
    ...
    get_campaign_versions_response: Optional[shared_getcampaignversionsresponse.GetCampaignVersionsResponse] = dataclasses.field(default=None)
