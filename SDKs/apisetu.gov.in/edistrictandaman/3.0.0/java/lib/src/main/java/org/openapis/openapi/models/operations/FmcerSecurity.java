...
public class FmcerSecurity {
    ...
    public FmcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public FmcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public FmcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
