...
from ..shared import getbillresponse as shared_getbillresponse
...
class BillsOneSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class BillsOneRequest:
...
class BillsOneResponse:
    ...
    r"""Bad Request"""  
    get_bill_response: Optional[shared_getbillresponse.GetBillResponse] = dataclasses.field(default=None)
    r"""Bill"""  
