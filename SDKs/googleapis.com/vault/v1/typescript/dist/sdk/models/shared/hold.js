...
var Hold = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=accounts", elemType: heldaccount_1.HeldAccount }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=holdId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=orgUnit" }),
