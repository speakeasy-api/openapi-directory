...
class MeetingUpdateMultipartFormDataRecurrence
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekEnum $monthlyWeek
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekEnum $monthlyWeek = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekDayEnum $monthlyWeekDay
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week_day')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekDayEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingUpdateMultipartFormDataRecurrenceMonthlyWeekDayEnum $monthlyWeekDay = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceTypeEnum>')]
    public MeetingUpdateMultipartFormDataRecurrenceTypeEnum $type;
     ...
     *  <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceWeeklyDaysEnum $weeklyDays
     */
	#[\JMS\Serializer\Annotation\SerializedName('weekly_days')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceWeeklyDaysEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingUpdateMultipartFormDataRecurrenceWeeklyDaysEnum $weeklyDays = null;
	...
	public function __construct()
	{
		...
		$this->type = \OpenAPI\OpenAPI\Models\Operations\MeetingUpdateMultipartFormDataRecurrenceTypeEnum::ONE;
