...
export class RetailProjectsLocationsCatalogsCompletionDataImportSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsCompletionDataImportRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsCompletionDataImportResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
