...
type GetNetworkSmTrustedAccessConfigsPathParams struct {
...
type GetNetworkSmTrustedAccessConfigsRequest struct {
	PathParams  GetNetworkSmTrustedAccessConfigsPathParams
	QueryParams GetNetworkSmTrustedAccessConfigsQueryParams
}
...
func (e *GetNetworkSmTrustedAccessConfigs200ApplicationJSONTimeboundTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "dynamic":
		fallthrough
	case "static":
		*e = GetNetworkSmTrustedAccessConfigs200ApplicationJSONTimeboundTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSmTrustedAccessConfigs200ApplicationJSONTimeboundTypeEnum: %s", s)
	}
}
