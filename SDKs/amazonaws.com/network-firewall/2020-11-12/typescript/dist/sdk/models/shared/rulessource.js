...
var RulesSource = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "RulesSourceList" }),
        (0, class_transformer_1.Type)(function () { return rulessourcelist_1.RulesSourceList; }),
        __metadata("design:type", rulessourcelist_1.RulesSourceList)
    ], RulesSource.prototype, "rulesSourceList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RulesString" }),
        __metadata("design:type", String)
    ], RulesSource.prototype, "rulesString", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: statefulrule_1.StatefulRule }),
        (0, class_transformer_1.Expose)({ name: "StatefulRules" }),
        (0, class_transformer_1.Type)(function () { return statefulrule_1.StatefulRule; }),
        __metadata("design:type", Array)
    ], RulesSource.prototype, "statefulRules", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "StatelessRulesAndCustomActions" }),
        (0, class_transformer_1.Type)(function () { return statelessrulesandcustomactions_1.StatelessRulesAndCustomActions; }),
