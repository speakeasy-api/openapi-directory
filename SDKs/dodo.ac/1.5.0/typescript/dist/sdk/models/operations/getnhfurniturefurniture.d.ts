...
export declare class GetNhFurnitureFurnitureRequest extends SpeakeasyBase {
    /**
...
export declare class GetNhFurnitureFurnitureResponse extends SpeakeasyBase {
    contentType: string;
    /**
     ...
     */
    nhFurniture?: shared.NHFurniture;
    statusCode: number;
