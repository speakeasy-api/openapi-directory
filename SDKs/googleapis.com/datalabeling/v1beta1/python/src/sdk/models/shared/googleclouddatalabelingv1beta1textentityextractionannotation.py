...
class GoogleCloudDatalabelingV1beta1TextEntityExtractionAnnotation:
    ...
    sequential_segment: Optional[shared_googleclouddatalabelingv1beta1sequentialsegment.GoogleCloudDatalabelingV1beta1SequentialSegment] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sequentialSegment'), 'exclude': lambda f: f is None }})
