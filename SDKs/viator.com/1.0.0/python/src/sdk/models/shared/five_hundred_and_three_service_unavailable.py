...
class FiveHundredAndThreeSERVICEUNAVAILABLE:
    ...
    code: Optional[FiveHundredAndThreeSERVICEUNAVAILABLECodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})  
    message: Optional[FiveHundredAndThreeSERVICEUNAVAILABLEMessageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message'), 'exclude': lambda f: f is None }})  
