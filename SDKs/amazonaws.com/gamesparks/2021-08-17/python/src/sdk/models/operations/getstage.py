...
from ..shared import getstageresult as shared_getstageresult
...
class GetStageResponse:
    ...
    get_stage_result: Optional[shared_getstageresult.GetStageResult] = dataclasses.field(default=None)
    r"""Success"""  
