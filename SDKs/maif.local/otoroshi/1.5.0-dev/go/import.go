...
func (s *Import) FullExport(ctx context.Context, request operations.FullExportRequest) (*operations.FullExportResponse, error) {
...
func (s *Import) FullImport(ctx context.Context, request operations.FullImportRequest) (*operations.FullImportResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/api/otoroshi.json"
...
func (s *Import) FullImportFromFile(ctx context.Context, request operations.FullImportFromFileRequest) (*operations.FullImportFromFileResponse, error) {
	baseURL := s._serverURL
