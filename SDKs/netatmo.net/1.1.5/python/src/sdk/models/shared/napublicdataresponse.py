...
import dataclasses
from ..shared import napublicdata as shared_napublicdata
...
class NAPublicDataResponse:
    ...
    body: Optional[list[shared_napublicdata.NAPublicData]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
