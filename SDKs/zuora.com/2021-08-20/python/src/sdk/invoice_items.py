...
class InvoiceItems:
    ...
    def object_get_invoice_item(self, request: operations.ObjectGETInvoiceItemRequest) -> operations.ObjectGETInvoiceItemResponse:
        ...
        url = utils.generate_url(operations.ObjectGETInvoiceItemRequest, base_url, '/v1/object/invoice-item/{id}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ObjectGETInvoiceItemRequest, request)
        ...
        res = operations.ObjectGETInvoiceItemResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json; charset=utf-8'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProxyGetInvoiceItem])
