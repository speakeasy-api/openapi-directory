...
class TagRequestInput:
    ...
    color: Optional[TagRequestColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('color'), 'exclude': lambda f: f is None }})
    r"""Color of the tag."""  
