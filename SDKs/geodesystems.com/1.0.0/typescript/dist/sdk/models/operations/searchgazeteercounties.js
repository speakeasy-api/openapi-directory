...
exports.SearchGazeteerCountiesResponse = exports.SearchGazeteerCountiesRequest = exports.SearchGazeteerCountiesQueryParams = void 0;
...
var SearchGazeteerCountiesQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.area_land" }),
        __metadata("design:type", Number)
    ], SearchGazeteerCountiesQueryParams.prototype, "searchDbGazeteerCountiesAreaLand", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.area_water" }),
        __metadata("design:type", Number)
    ], SearchGazeteerCountiesQueryParams.prototype, "searchDbGazeteerCountiesAreaWater", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.county_fips" }),
        __metadata("design:type", String)
    ], SearchGazeteerCountiesQueryParams.prototype, "searchDbGazeteerCountiesCountyFips", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.county_name" }),
        __metadata("design:type", String)
    ], SearchGazeteerCountiesQueryParams.prototype, "searchDbGazeteerCountiesCountyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.full_county_fips" }),
        __metadata("design:type", String)
    ], SearchGazeteerCountiesQueryParams.prototype, "searchDbGazeteerCountiesFullCountyFips", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.location" }),
        __metadata("design:type", String)
    ], SearchGazeteerCountiesQueryParams.prototype, "searchDbGazeteerCountiesLocation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.state_abbreviation" }),
        __metadata("design:type", String)
    ], SearchGazeteerCountiesQueryParams.prototype, "searchDbGazeteerCountiesStateAbbreviation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_gazeteer_counties.state_fips" }),
        __metadata("design:type", String)
...
exports.SearchGazeteerCountiesQueryParams = SearchGazeteerCountiesQueryParams;
