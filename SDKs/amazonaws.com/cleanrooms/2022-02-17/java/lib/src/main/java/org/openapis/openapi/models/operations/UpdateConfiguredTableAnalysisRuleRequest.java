...
public class UpdateConfiguredTableAnalysisRuleRequest {
    ...
    public UpdateConfiguredTableAnalysisRuleRequest(@JsonProperty("RequestBody") UpdateConfiguredTableAnalysisRuleRequestBody requestBody, @JsonProperty("analysisRuleType") UpdateConfiguredTableAnalysisRuleAnalysisRuleTypeEnum analysisRuleType, @JsonProperty("configuredTableIdentifier") String configuredTableIdentifier) {
        this.requestBody = requestBody;
        this.analysisRuleType = analysisRuleType;
        this.configuredTableIdentifier = configuredTableIdentifier;
  }
