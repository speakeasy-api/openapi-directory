 ...
 */
exports.ServerList = ["https://api.nexmo.com/v1/redact"];
/**
...
var SDK = /** @class */ (function () {
     ...
     */
    SDK.prototype.redactMessage = function (req, security, config) {
        var _a;
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.RedactMessageResponse({
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 404:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.errorInvalidId = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ErrorInvalidId);
                    }
                    break;
