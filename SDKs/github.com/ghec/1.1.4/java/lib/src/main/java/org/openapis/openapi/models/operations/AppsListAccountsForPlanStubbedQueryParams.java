...
public class AppsListAccountsForPlanStubbedQueryParams {
    ...
    public AppsListAccountsForPlanStubbedQueryParams withDirection(AppsListAccountsForPlanStubbedDirectionEnum direction) {
    ...
    public AppsListAccountsForPlanStubbedQueryParams withSort(org.openapis.openapi.models.shared.SortEnum sort) {
        this.sort = sort;
        return this;
    }
