...
public class GetSalesCountQueryParams {
    ...
    public GetSalesCountQueryParams withCarType(GetSalesCountCarTypeEnum carType) {
    ...
    public GetSalesCountQueryParams withCountry(GetSalesCountCountryEnum country) {
