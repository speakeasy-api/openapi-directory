...
func (e UpdateSyslogConfigProtocolEnum) ToPointer() *UpdateSyslogConfigProtocolEnum {
	return &e
}
...
func (e *UpdateSyslogConfigProtocolEnum) UnmarshalJSON(data []byte) error {
	...
	case "TCP":
		fallthrough
	case "UDP":
		*e = UpdateSyslogConfigProtocolEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateSyslogConfigProtocolEnum: %v", v)
	}
}
