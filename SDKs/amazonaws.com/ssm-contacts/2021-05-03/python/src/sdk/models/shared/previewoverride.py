...
class PreviewOverride:
    r"""Information about contacts and times that an on-call override replaces."""
    ...
    new_members: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('NewMembers'), 'exclude': lambda f: f is None }})  
