...
public class CreateInternationalPaymentConsentsRawRequest {
    ...
    public CreateInternationalPaymentConsentsRawRequest(@JsonProperty("Authorization") String authorization, @JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("x-idempotency-key") String xIdempotencyKey, @JsonProperty("x-jws-signature") String xJwsSignature) {
        this.authorization = authorization;
        this.requestBody = requestBody;
        this.xIdempotencyKey = xIdempotencyKey;
        this.xJwsSignature = xJwsSignature;
