...
public class GetTransactionsFilteredByIdCardTransactionsv1Transaction {
    /**
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withAmountAfterCharges(Long amountAfterCharges) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withAmountBeforeCharges(Long amountBeforeCharges) {
    ...
    public Long balance;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withBalance(Long balance) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1TransactionBatchItemDetails batchItemDetails;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withBatchItemDetails(GetTransactionsFilteredByIdCardTransactionsv1TransactionBatchItemDetails batchItemDetails) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("card")
    public GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedCard card;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withCard(GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedCard card) {
        this.card = card;
        return this;
    }
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrency currency;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withCurrency(GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrency currency) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withDateAcknowledged(OffsetDateTime dateAcknowledged) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1TransactionDirectDebitDetails directDebitDetails;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withDirectDebitDetails(GetTransactionsFilteredByIdCardTransactionsv1TransactionDirectDebitDetails directDebitDetails) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withEventUuid(String eventUuid) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withFeeAmount(Long feeAmount) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1TransactionFxTrade fxTradeDetails;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withFxTradeDetails(GetTransactionsFilteredByIdCardTransactionsv1TransactionFxTrade fxTradeDetails) {
    ...
    @JsonProperty("ican")
    public Long ican;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withIcan(Long ican) {
        this.ican = ican;
        return this;
    }
    ...
    @JsonProperty("myRef")
    public String myRef;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withMyRef(String myRef) {
        this.myRef = myRef;
        return this;
    }
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withPaymentRequestPublicCode(String paymentRequestPublicCode) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1TransactionProprietarySchemeDetails[] proprietarySchemeDetails;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withProprietarySchemeDetails(GetTransactionsFilteredByIdCardTransactionsv1TransactionProprietarySchemeDetails[] proprietarySchemeDetails) {
    ...
    @JsonProperty("refId")
    public Long refId;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withRefId(Long refId) {
        this.refId = refId;
        return this;
    }
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withRelatedParty(Object relatedParty) {
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withTaxAmount(Long taxAmount) {
    ...
    @JsonProperty("txnId")
    public Long txnId;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withTxnId(Long txnId) {
        this.txnId = txnId;
        return this;
    }
    ...
    @JsonProperty("type")
    public String type;
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public GetTransactionsFilteredByIdCardTransactionsv1Transaction withYourRef(String yourRef) {
