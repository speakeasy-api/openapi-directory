...
type RunNamespacesDomainmappingsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RunNamespacesDomainmappingsDeletePathParams struct {
...
type RunNamespacesDomainmappingsDeleteQueryParams struct {
	// V1 error format.
...
type RunNamespacesDomainmappingsDeleteRequest struct {
...
type RunNamespacesDomainmappingsDeleteResponse struct {
	ContentType string
	// Successful response
