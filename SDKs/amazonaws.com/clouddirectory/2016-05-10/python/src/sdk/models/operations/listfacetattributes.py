...
from ..shared import listfacetattributesresponse as shared_listfacetattributesresponse
...
class ListFacetAttributesRequest:
    headers: ListFacetAttributesHeaders = dataclasses.field()
    query_params: ListFacetAttributesQueryParams = dataclasses.field()
    request: ListFacetAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ListFacetAttributesResponse:
    ...
    list_facet_attributes_response: Optional[shared_listfacetattributesresponse.ListFacetAttributesResponse] = dataclasses.field(default=None)
