...
public class StartResourceScanResponse {
    ...
    public StartResourceScanResponse withStatusCode(Integer statusCode) {
    ...
    public StartResourceScanResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public StartResourceScanResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
