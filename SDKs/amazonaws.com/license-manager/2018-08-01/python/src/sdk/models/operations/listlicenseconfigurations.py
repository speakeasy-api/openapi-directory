...
class ListLicenseConfigurationsRequest:
    ...
    list_license_configurations_request: shared_listlicenseconfigurationsrequest.ListLicenseConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
