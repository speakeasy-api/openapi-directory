...
func (e GetImageCollectionListEmbedEnum) ToPointer() *GetImageCollectionListEmbedEnum {
	return &e
}
...
func (e *GetImageCollectionListEmbedEnum) UnmarshalJSON(data []byte) error {
	...
	case "share_code":
		fallthrough
	case "share_url":
		*e = GetImageCollectionListEmbedEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetImageCollectionListEmbedEnum: %v", v)
	}
}
