...
from ..shared import googleplaydeveloperreportingv1alpha1stuckbackgroundwakelockratemetricset as shared_googleplaydeveloperreportingv1alpha1stuckbackgroundwakelockratemetricset
...
class PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetResponse:
    ...
    google_play_developer_reporting_v1alpha1_stuck_background_wakelock_rate_metric_set: Optional[shared_googleplaydeveloperreportingv1alpha1stuckbackgroundwakelockratemetricset.GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet] = dataclasses.field(default=None)
