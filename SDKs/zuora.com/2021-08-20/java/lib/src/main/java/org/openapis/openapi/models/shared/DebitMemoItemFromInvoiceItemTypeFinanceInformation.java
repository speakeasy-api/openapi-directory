 ...
 * 
 */
public class DebitMemoItemFromInvoiceItemTypeFinanceInformation {
    /**
    ...
    public DebitMemoItemFromInvoiceItemTypeFinanceInformation withDeferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
    ...
    public DebitMemoItemFromInvoiceItemTypeFinanceInformation withRecognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
    ...
    public DebitMemoItemFromInvoiceItemTypeFinanceInformation withRevenueRecognitionRuleName(String revenueRecognitionRuleName) {
