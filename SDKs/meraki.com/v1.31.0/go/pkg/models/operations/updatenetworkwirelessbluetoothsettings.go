...
func (e *UpdateNetworkWirelessBluetoothSettingsRequestBodyMajorMinorAssignmentModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Non-unique":
		fallthrough
	case "Unique":
		*e = UpdateNetworkWirelessBluetoothSettingsRequestBodyMajorMinorAssignmentModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessBluetoothSettingsRequestBodyMajorMinorAssignmentModeEnum: %s", s)
	}
}
