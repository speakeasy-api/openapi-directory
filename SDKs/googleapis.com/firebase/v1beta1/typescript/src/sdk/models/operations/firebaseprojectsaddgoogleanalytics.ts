...
export class FirebaseProjectsAddGoogleAnalyticsSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebaseProjectsAddGoogleAnalyticsSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class FirebaseProjectsAddGoogleAnalyticsSecurity extends SpeakeasyBase {
...
export class FirebaseProjectsAddGoogleAnalyticsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebaseProjectsAddGoogleAnalyticsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
