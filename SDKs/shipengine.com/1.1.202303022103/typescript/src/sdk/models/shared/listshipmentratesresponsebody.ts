 ...
 */
export enum ListShipmentRatesResponseBodyRateRateTypeEnum {
  Check = "check",
  Shipment = "shipment",
}
 ...
 */
export enum ListShipmentRatesResponseBodyRateValidationStatusEnum {
  Valid = "valid",
  Invalid = "invalid",
...
export class ListShipmentRatesResponseBodyRate extends SpeakeasyBase {
  ...
  @Type(() => ListShipmentRatesResponseBodyRateMonetaryValue)
 ...
 */
export enum ListShipmentRatesResponseBodyRateResponseStatusEnum {
  Working = "working",
  Completed = "completed",
  Partial = "partial",
  Error = "error",
...
export class ListShipmentRatesResponseBody extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: ListShipmentRatesResponseBodyRate })
  @Expose({ name: "invalid_rates" })
  @Type(() => ListShipmentRatesResponseBodyRate)
