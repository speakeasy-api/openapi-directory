...
public class ListOrdersQueryParams {
    ...
    public String fRnB;
    public ListOrdersQueryParams withFRnB(String fRnB) {
        this.fRnB = fRnB;
        return this;
    }
    ...
    public ListOrdersQueryParams withFUtmSource(String fUtmSource) {
    ...
    public ListOrdersQueryParams withFAffiliateId(String fAffiliateId) {
    ...
    public ListOrdersQueryParams withFAuthorizedDate(String fAuthorizedDate) {
    ...
    public ListOrdersQueryParams withFCallCenterOperatorName(String fCallCenterOperatorName) {
    ...
    public ListOrdersQueryParams withFCreationDate(String fCreationDate) {
    ...
    public ListOrdersQueryParams withFHasInputInvoice(Boolean fHasInputInvoice) {
    ...
    public ListOrdersQueryParams withFInvoicedDate(String fInvoicedDate) {
    ...
    public ListOrdersQueryParams withFIsInstore(Boolean fIsInstore) {
    ...
    public ListOrdersQueryParams withFPaymentNames(String fPaymentNames) {
    ...
    public ListOrdersQueryParams withFSalesChannel(String fSalesChannel) {
    ...
    public ListOrdersQueryParams withFSellerNames(String fSellerNames) {
    ...
    public ListOrdersQueryParams withFShippingEstimate(String fShippingEstimate) {
    ...
    public ListOrdersQueryParams withFStatus(String fStatus) {
    ...
    public ListOrdersQueryParams withIncompleteOrders(Boolean incompleteOrders) {
    ...
    public ListOrdersQueryParams withOrderBy(String orderBy) {
    ...
    public Integer page;
    public ListOrdersQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public ListOrdersQueryParams withPerPage(Integer perPage) {
    ...
    public String q;
    public ListOrdersQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public ListOrdersQueryParams withSalesChannelId(String salesChannelId) {
    ...
    public ListOrdersQueryParams withSearchField(String searchField) {
    ...
    public Integer utc;
    public ListOrdersQueryParams withUtc(Integer utc) {
        this.utc = utc;
        return this;
    }
