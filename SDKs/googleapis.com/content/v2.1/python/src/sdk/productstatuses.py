...
class Productstatuses:
    ...
    def content_productstatuses_repricingreports_list(self, request: operations.ContentProductstatusesRepricingreportsListRequest, security: operations.ContentProductstatusesRepricingreportsListSecurity) -> operations.ContentProductstatusesRepricingreportsListResponse:
        r"""Lists the metrics report for a given Repricing product."""
        base_url = self._server_url
        
        url = utils.generate_url(operations.ContentProductstatusesRepricingreportsListRequest, base_url, '/{merchantId}/productstatuses/{productId}/repricingreports', request)
        
        query_params = utils.get_query_params(operations.ContentProductstatusesRepricingreportsListRequest, request)
        ...
        res = operations.ContentProductstatusesRepricingreportsListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListRepricingProductReportsResponse])
