...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/monarchinitiative.org/1.1.14/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/monarchinitiative.org/1.1.14/typescript
```
