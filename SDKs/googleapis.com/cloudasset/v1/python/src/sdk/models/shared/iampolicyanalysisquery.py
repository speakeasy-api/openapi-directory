...
from ..shared import conditioncontext as shared_conditioncontext
...
class IamPolicyAnalysisQuery:
    ...
    r"""Specifies roles and/or permissions to analyze, to determine both the identities possessing them and the resources they control. If multiple values are specified, results will include roles or permissions matching any of them. The total number of roles and permissions should be equal or less than 10."""  
    condition_context: Optional[shared_conditioncontext.ConditionContext] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conditionContext'), 'exclude': lambda f: f is None }})
