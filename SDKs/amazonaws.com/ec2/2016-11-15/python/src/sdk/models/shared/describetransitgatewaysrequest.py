...
class DescribeTransitGatewaysRequestFilters:
...
class DescribeTransitGatewaysRequest:
    ...
    filters: Optional[list[DescribeTransitGatewaysRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    transit_gateway_ids: Optional[list[str]] = dataclasses.field(default=None)  
