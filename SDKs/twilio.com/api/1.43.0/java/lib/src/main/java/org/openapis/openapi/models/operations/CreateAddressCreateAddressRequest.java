...
public class CreateAddressCreateAddressRequest {
    ...
    public CreateAddressCreateAddressRequest(@JsonProperty("City") String city, @JsonProperty("CustomerName") String customerName, @JsonProperty("IsoCountry") String isoCountry, @JsonProperty("PostalCode") String postalCode, @JsonProperty("Region") String region, @JsonProperty("Street") String street) {
        this.city = city;
        this.customerName = customerName;
        this.isoCountry = isoCountry;
        this.postalCode = postalCode;
