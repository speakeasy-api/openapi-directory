...
type AnalyticsCrashGroupOperatingSystemCountsPathParams struct {
...
type AnalyticsCrashGroupOperatingSystemCountsQueryParams struct {
...
type AnalyticsCrashGroupOperatingSystemCountsRequest struct {
	PathParams  AnalyticsCrashGroupOperatingSystemCountsPathParams
	QueryParams AnalyticsCrashGroupOperatingSystemCountsQueryParams
	Security    AnalyticsCrashGroupOperatingSystemCountsSecurity
}
