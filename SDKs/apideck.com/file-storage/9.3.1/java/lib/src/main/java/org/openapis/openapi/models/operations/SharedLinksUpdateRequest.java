...
public class SharedLinksUpdateRequest {
    ...
    public SharedLinksUpdateRequest(@JsonProperty("SharedLinkInput") org.openapis.openapi.models.shared.SharedLinkInput sharedLinkInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.sharedLinkInput = sharedLinkInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
