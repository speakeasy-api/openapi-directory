...
type StartRecommendationsHeaders struct {
...
type StartRecommendationsRequest struct {
	Headers StartRecommendationsHeaders
	Request shared.StartRecommendationsRequest `request:"mediaType=application/json"`
}
