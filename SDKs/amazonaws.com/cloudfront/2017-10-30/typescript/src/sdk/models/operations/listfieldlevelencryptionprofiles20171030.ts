...
export class ListFieldLevelEncryptionProfiles20171030Request extends SpeakeasyBase {
  /**
...
export class ListFieldLevelEncryptionProfiles20171030Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
