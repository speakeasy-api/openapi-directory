...
type DescribeLocationFsxOntapHeaders struct {
...
type DescribeLocationFsxOntapRequest struct {
	Headers DescribeLocationFsxOntapHeaders
	Request shared.DescribeLocationFsxOntapRequest `request:"mediaType=application/json"`
}
