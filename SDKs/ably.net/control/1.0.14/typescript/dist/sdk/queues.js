...
var Queues = /** @class */ (function () {
    ...
    **/
    Queues.prototype.deleteAppsAppIdQueuesQueueId = function (req, config) {
    ...
    **/
    Queues.prototype.getAppsAppIdQueues = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Queues.prototype.postAppsAppIdQueues = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
