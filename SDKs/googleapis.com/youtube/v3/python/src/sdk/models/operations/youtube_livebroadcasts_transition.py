...
class YoutubeLiveBroadcastsTransitionQueryParams:
    broadcast_status: YoutubeLiveBroadcastsTransitionBroadcastStatusEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'broadcastStatus', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class YoutubeLiveBroadcastsTransitionSecurity:
    option1: Optional[YoutubeLiveBroadcastsTransitionSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeLiveBroadcastsTransitionSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class YoutubeLiveBroadcastsTransitionRequest:
    query_params: YoutubeLiveBroadcastsTransitionQueryParams = dataclasses.field()
    security: YoutubeLiveBroadcastsTransitionSecurity = dataclasses.field()
