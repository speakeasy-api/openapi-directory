...
class GetEnrollmentStatusResponse:
    ...
    member_accounts_enrolled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('memberAccountsEnrolled'), 'exclude': lambda f: f is None }})  
    number_of_member_accounts_opted_in: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('numberOfMemberAccountsOptedIn'), 'exclude': lambda f: f is None }})  
