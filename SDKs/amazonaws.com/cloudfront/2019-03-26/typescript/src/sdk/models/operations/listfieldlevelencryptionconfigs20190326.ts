...
export class ListFieldLevelEncryptionConfigs20190326Request extends SpeakeasyBase {
  /**
...
export class ListFieldLevelEncryptionConfigs20190326Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
