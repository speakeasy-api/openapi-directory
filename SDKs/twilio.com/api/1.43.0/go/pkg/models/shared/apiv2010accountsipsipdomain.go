...
func (e APIV2010AccountSipSipDomainVoiceFallbackMethodEnum) ToPointer() *APIV2010AccountSipSipDomainVoiceFallbackMethodEnum {
	return &e
}
...
func (e *APIV2010AccountSipSipDomainVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountSipSipDomainVoiceFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountSipSipDomainVoiceFallbackMethodEnum: %v", v)
	}
}
...
func (e APIV2010AccountSipSipDomainVoiceMethodEnum) ToPointer() *APIV2010AccountSipSipDomainVoiceMethodEnum {
	return &e
}
...
func (e *APIV2010AccountSipSipDomainVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountSipSipDomainVoiceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountSipSipDomainVoiceMethodEnum: %v", v)
	}
}
...
func (e APIV2010AccountSipSipDomainVoiceStatusCallbackMethodEnum) ToPointer() *APIV2010AccountSipSipDomainVoiceStatusCallbackMethodEnum {
	return &e
}
...
func (e *APIV2010AccountSipSipDomainVoiceStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountSipSipDomainVoiceStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountSipSipDomainVoiceStatusCallbackMethodEnum: %v", v)
	}
}
