...
public class GETDescribeStackSetQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETDescribeStackSetActionEnum action;
    public GETDescribeStackSetQueryParams withAction(GETDescribeStackSetActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETDescribeStackSetQueryParams withCallAs(GETDescribeStackSetCallAsEnum callAs) {
        this.callAs = callAs;
        return this;
    }
    ...
    public GETDescribeStackSetQueryParams withStackSetName(String stackSetName) {
    ...
    public GETDescribeStackSetQueryParams withVersion(GETDescribeStackSetVersionEnum version) {
