 ...
 */
public enum UserSettings200ApplicationXMLUserSettingsUserSettingsMeetingSettingsAudioTypeEnum {
    BOTH("both"),
    TELEPHONY("telephony"),
    VOIP("voip"),
    ...
    private UserSettings200ApplicationXMLUserSettingsUserSettingsMeetingSettingsAudioTypeEnum(String value) {
        this.value = value;
    }
}
