...
class GetAccountsAccountIDStatementsStatementIDTransactionsRequest:
    headers: GetAccountsAccountIDStatementsStatementIDTransactionsHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDStatementsStatementIDTransactionsPathParams = dataclasses.field()
    security: GetAccountsAccountIDStatementsStatementIDTransactionsSecurity = dataclasses.field()
