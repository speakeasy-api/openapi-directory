...
exports.JobScheduleTerminateResponse = exports.JobScheduleTerminateRequest = void 0;
...
var JobScheduleTerminateRequest = /** @class */ (function (_super) {
    ...
    ], JobScheduleTerminateRequest.prototype, "ifMatch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=If-Modified-Since",
        }),
        __metadata("design:type", String)
    ], JobScheduleTerminateRequest.prototype, "ifModifiedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=If-None-Match",
        }),
        __metadata("design:type", String)
    ], JobScheduleTerminateRequest.prototype, "ifNoneMatch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=If-Unmodified-Since",
        }),
        __metadata("design:type", String)
    ], JobScheduleTerminateRequest.prototype, "ifUnmodifiedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], JobScheduleTerminateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], JobScheduleTerminateRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=jobScheduleId",
        }),
        __metadata("design:type", String)
    ], JobScheduleTerminateRequest.prototype, "jobScheduleId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], JobScheduleTerminateRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], JobScheduleTerminateRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], JobScheduleTerminateRequest.prototype, "timeout", void 0);
...
var JobScheduleTerminateResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], JobScheduleTerminateResponse.prototype, "rawResponse", void 0);
