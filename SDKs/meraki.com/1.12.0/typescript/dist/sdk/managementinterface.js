...
exports.ManagementInterface = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ManagementInterface = /** @class */ (function () {
    function ManagementInterface(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ManagementInterface.prototype.getDeviceManagementInterface = function (req, config) {
    ...
    **/
    ManagementInterface.prototype.updateDeviceManagementInterface = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
