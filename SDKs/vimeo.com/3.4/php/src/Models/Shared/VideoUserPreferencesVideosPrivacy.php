...
class VideoUserPreferencesVideosPrivacy
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VideoUserPreferencesVideosPrivacyCommentsEnum $comments
     */
	#[\JMS\Serializer\Annotation\SerializedName('comments')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoUserPreferencesVideosPrivacyCommentsEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoUserPreferencesVideosPrivacyCommentsEnum $comments = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VideoUserPreferencesVideosPrivacyEmbedEnum $embed
     */
	#[\JMS\Serializer\Annotation\SerializedName('embed')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoUserPreferencesVideosPrivacyEmbedEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoUserPreferencesVideosPrivacyEmbedEnum $embed = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\VideoUserPreferencesVideosPrivacyViewEnum $view
     */
	#[\JMS\Serializer\Annotation\SerializedName('view')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoUserPreferencesVideosPrivacyViewEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?VideoUserPreferencesVideosPrivacyViewEnum $view = null;
