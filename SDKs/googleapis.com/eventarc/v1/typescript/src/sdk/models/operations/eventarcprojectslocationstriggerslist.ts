...
export class EventarcProjectsLocationsTriggersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsTriggersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class EventarcProjectsLocationsTriggersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
