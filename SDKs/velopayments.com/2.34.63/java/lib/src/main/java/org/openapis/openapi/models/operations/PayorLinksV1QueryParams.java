...
public class PayorLinksV1QueryParams {
    /**
    ...
    public PayorLinksV1QueryParams withDescendantsOfPayor(String descendantsOfPayor) {
    ...
    public PayorLinksV1QueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public PayorLinksV1QueryParams withParentOfPayor(String parentOfPayor) {
