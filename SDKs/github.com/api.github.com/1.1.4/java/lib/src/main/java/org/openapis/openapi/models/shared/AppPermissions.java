...
public class AppPermissions {
    ...
    public AppPermissionsOrganizationAnnouncementBannersEnum organizationAnnouncementBanners;
    public AppPermissions withOrganizationAnnouncementBanners(AppPermissionsOrganizationAnnouncementBannersEnum organizationAnnouncementBanners) {
    ...
    public AppPermissionsOrganizationCustomRolesEnum organizationCustomRoles;
    public AppPermissions withOrganizationCustomRoles(AppPermissionsOrganizationCustomRolesEnum organizationCustomRoles) {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("repository_announcement_banners")
    public AppPermissionsRepositoryAnnouncementBannersEnum repositoryAnnouncementBanners;
    public AppPermissions withRepositoryAnnouncementBanners(AppPermissionsRepositoryAnnouncementBannersEnum repositoryAnnouncementBanners) {
