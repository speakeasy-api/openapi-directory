...
export class ProductServices {
  ...
  availableProducts(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AvailableProductsResponse =
        new operations.AvailableProductsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.availableProducts200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.AvailableProducts200ApplicationJSON
            );
          }
          break;
      }
  ...
  product(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ProductResponse = new operations.ProductResponse({
        statusCode: httpRes.status,
        contentType: contentType,
        rawResponse: httpRes,
      });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.product200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.Product200ApplicationJSON
            );
          }
          break;
      }
  ...
  productPhotos(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ProductPhotosResponse =
        new operations.ProductPhotosResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.productPhotos200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.ProductPhotos200ApplicationJSON
            );
          }
          break;
      }
  ...
  productReviews(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ProductReviewsResponse =
        new operations.ProductReviewsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.productReviews200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.ProductReviews200ApplicationJSON
            );
          }
          break;
      }
  ...
  searchFreetext(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchFreetextResponse =
        new operations.SearchFreetextResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchFreetext200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchFreetext200ApplicationJSON
            );
          }
          break;
      }
  ...
  searchProducts(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchProducts200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchProducts200ApplicationJSON
            );
          }
          break;
      }
  ...
  searchProductsCodes(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchProductsCodesResponse =
        new operations.SearchProductsCodesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchProductsCodes200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.SearchProductsCodes200ApplicationJSON
              );
          }
          break;
      }
