...
// RemoveSubgoalRequestBody - The goal to be removed as a subgoal
...
type RemoveSubgoalRequest struct {
	...
	// The goal to be removed as a subgoal
	Request RemoveSubgoalRequestBody `request:"mediaType=application/json"`
}

// RemoveSubgoal200ApplicationJSON - Successfully removed subgoal.
