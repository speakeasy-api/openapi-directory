...
public class GetNextPlaybackItemQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetNextPlaybackItemQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetNextPlaybackItemQueryParams withExpand(GetNextPlaybackItemExpandEnum expand) {
        this.expand = expand;
        return this;
    }
    ...
    public GetNextPlaybackItemQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public String lang;
    public GetNextPlaybackItemQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetNextPlaybackItemQueryParams withMaxRating(String maxRating) {
    ...
    public GetNextPlaybackItemQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetNextPlaybackItemQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
