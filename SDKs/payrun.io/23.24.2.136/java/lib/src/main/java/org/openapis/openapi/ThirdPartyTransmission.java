...
public class ThirdPartyTransmission {
    ...
    public org.openapis.openapi.models.operations.DeleteThirdPartyTransactionResponse deleteThirdPartyTransaction(org.openapis.openapi.models.operations.DeleteThirdPartyTransactionRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.DeleteThirdPartyTransactionResponse res = new org.openapis.openapi.models.operations.DeleteThirdPartyTransactionResponse(contentType, httpRes.statusCode()) {{
            errorModel = null;
        }};
    ...
    public org.openapis.openapi.models.operations.GetThirdPartyTransactionResponse getThirdPartyTransaction(org.openapis.openapi.models.operations.GetThirdPartyTransactionRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetThirdPartyTransactionResponse res = new org.openapis.openapi.models.operations.GetThirdPartyTransactionResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.ThirdPartyTransaction out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.ThirdPartyTransaction.class);
    ...
    public org.openapis.openapi.models.operations.GetThirdPartyTransactionsResponse getThirdPartyTransactions(org.openapis.openapi.models.operations.GetThirdPartyTransactionsRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetThirdPartyTransactionsResponse res = new org.openapis.openapi.models.operations.GetThirdPartyTransactionsResponse(contentType, httpRes.statusCode()) {{
            linkCollection = null;
            errorModel = null;
        }};
        res.rawResponse = httpRes;
