...
public class GetServerDetailsQueryParams {
    /**
     *  The maximum number of items to include in the response. The maximum value is 100. 
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=maxResults")
    public Long maxResults;
    public GetServerDetailsQueryParams withMaxResults(Long maxResults) {
    ...
    public GetServerDetailsQueryParams withNextToken(String nextToken) {
