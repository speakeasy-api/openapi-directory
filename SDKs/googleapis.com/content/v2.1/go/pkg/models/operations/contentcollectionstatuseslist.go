...
type ContentCollectionstatusesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentCollectionstatusesListPathParams struct {
	// Required. The ID of the account that contains the collection. This account cannot be a multi-client account.
	MerchantID string `pathParam:"style=simple,explode=false,name=merchantId"`
}

type ContentCollectionstatusesListQueryParams struct {
	// V1 error format.
...
type ContentCollectionstatusesListRequest struct {
...
type ContentCollectionstatusesListResponse struct {
	ContentType string
	// Successful response
