...
SERVERS = [
    ...
    r"""VA.gov API sandbox environment"""
    "https://api.va.gov/services/va_forms/{version}",
    r"""VA.gov API production environment"""
]
"""Contains the list of servers available to the SDK"""

class SDK:
    r"""Use the VA Forms API to search for VA forms, get the form's PDF link and metadata, and check for new versions.
