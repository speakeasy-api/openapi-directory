...
export class MonitoringProjectsNotificationChannelsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MonitoringProjectsNotificationChannelsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsNotificationChannelsListSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsNotificationChannelsListSecurity extends SpeakeasyBase {
...
export class MonitoringProjectsNotificationChannelsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MonitoringProjectsNotificationChannelsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
