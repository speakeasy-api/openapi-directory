...
enum DescribeSpotFleetRequestsResponseSpotFleetRequestConfigsSpotFleetRequestConfigSpotMaintenanceStrategiesCapacityRebalanceReplacementStrategyEnum: string
{
    case LAUNCH = 'launch';
