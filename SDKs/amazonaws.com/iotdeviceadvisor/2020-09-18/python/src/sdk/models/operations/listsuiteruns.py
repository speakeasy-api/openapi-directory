...
class ListSuiteRunsRequest:
    ...
    r"""Lists the test suite runs of the specified test suite based on suite definition ID."""  
    ...
    r"""Must be passed along with <code>suiteDefinitionId</code>. Lists the test suite runs of the specified test suite based on suite definition version."""  
