...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/meark/3.0.0/python
```
...
res = s.ap_is.adcrd(req, operations.AdcrdSecurity(
