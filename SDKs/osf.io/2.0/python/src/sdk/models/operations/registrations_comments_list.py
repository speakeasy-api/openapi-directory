...
@dataclasses.dataclass
class RegistrationsCommentsListCommentAttributes:
...
@dataclasses.dataclass
class RegistrationsCommentsListCommentLinks:
...
@dataclasses.dataclass
class RegistrationsCommentsListCommentRelationships:
...
class RegistrationsCommentsListComment:
    ...
    attributes: Optional[RegistrationsCommentsListCommentAttributes] = dataclasses.field(default=None)
    r"""The properties of the comment entity."""  
    links: Optional[RegistrationsCommentsListCommentLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the comment entity."""  
    relationships: Optional[RegistrationsCommentsListCommentRelationships] = dataclasses.field(default=None)
    r"""URLs to other entities or entity collections that have a relationship to the comment entity."""  
