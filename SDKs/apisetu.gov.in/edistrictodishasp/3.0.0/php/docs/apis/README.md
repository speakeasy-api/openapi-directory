...
use \OpenAPI\OpenAPI\Models\Operations\EgcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\EgcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\EgcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\EgcerSecurity;
...
try {
    ...
    $request->certificateParameters = new EgcerRequestBodyCertificateParameters();
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->refNo = 'E-RES/2019/12345';
    $request->certificateParameters->tokenNo = '0B9AB69C';
    ...
    $request->format = EgcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new EgcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->egcer($request, $requestSecurity);
