...
/**
 * StoragePoolAggregatedListWarningCodeEnum - [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
public enum StoragePoolAggregatedListWarningCodeEnum {
    ...
    private StoragePoolAggregatedListWarningCodeEnum(String value) {
        this.value = value;
    }
}
