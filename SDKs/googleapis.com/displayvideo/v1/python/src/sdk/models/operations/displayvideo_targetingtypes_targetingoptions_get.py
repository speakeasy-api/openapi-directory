...
class DisplayvideoTargetingTypesTargetingOptionsGetPathParams:
    targeting_option_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingOptionId', 'style': 'simple', 'explode': False }})
    targeting_type: DisplayvideoTargetingTypesTargetingOptionsGetTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoTargetingTypesTargetingOptionsGetQueryParams:
...
class DisplayvideoTargetingTypesTargetingOptionsGetRequest:
    path_params: DisplayvideoTargetingTypesTargetingOptionsGetPathParams = dataclasses.field()
    query_params: DisplayvideoTargetingTypesTargetingOptionsGetQueryParams = dataclasses.field()
    security: DisplayvideoTargetingTypesTargetingOptionsGetSecurity = dataclasses.field()
...
class DisplayvideoTargetingTypesTargetingOptionsGetResponse:
    ...
    targeting_option: Optional[shared_targetingoption.TargetingOption] = dataclasses.field(default=None)
