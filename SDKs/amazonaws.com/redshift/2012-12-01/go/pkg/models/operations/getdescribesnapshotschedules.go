...
func (e GETDescribeSnapshotSchedulesActionEnum) ToPointer() *GETDescribeSnapshotSchedulesActionEnum {
	return &e
}
...
func (e *GETDescribeSnapshotSchedulesActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeSnapshotSchedules":
		*e = GETDescribeSnapshotSchedulesActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeSnapshotSchedulesActionEnum: %v", v)
	}
}
...
func (e GETDescribeSnapshotSchedulesVersionEnum) ToPointer() *GETDescribeSnapshotSchedulesVersionEnum {
	return &e
}
...
func (e *GETDescribeSnapshotSchedulesVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2012-12-01":
		*e = GETDescribeSnapshotSchedulesVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeSnapshotSchedulesVersionEnum: %v", v)
	}
}
