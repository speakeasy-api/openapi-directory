...
func newIdentities(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *identities {
	return &identities{
...
func (s *identities) GetAdministeredIdentitiesMe(ctx context.Context) (*operations.GetAdministeredIdentitiesMeResponse, error) {
	baseURL := s.serverURL
