...
class IdentitytoolkitProjectsTenantsGetIamPolicySecurity:
    option1: Optional[IdentitytoolkitProjectsTenantsGetIamPolicySecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[IdentitytoolkitProjectsTenantsGetIamPolicySecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class IdentitytoolkitProjectsTenantsGetIamPolicyRequest:
    path_params: IdentitytoolkitProjectsTenantsGetIamPolicyPathParams = dataclasses.field()
    query_params: IdentitytoolkitProjectsTenantsGetIamPolicyQueryParams = dataclasses.field()
    security: IdentitytoolkitProjectsTenantsGetIamPolicySecurity = dataclasses.field()
