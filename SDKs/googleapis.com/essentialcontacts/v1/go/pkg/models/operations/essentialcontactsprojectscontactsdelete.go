...
type EssentialcontactsProjectsContactsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type EssentialcontactsProjectsContactsDeletePathParams struct {
...
type EssentialcontactsProjectsContactsDeleteQueryParams struct {
	// V1 error format.
...
type EssentialcontactsProjectsContactsDeleteRequest struct {
...
type EssentialcontactsProjectsContactsDeleteResponse struct {
	ContentType string
	// Successful response
