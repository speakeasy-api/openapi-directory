...
class DeleteRobotApplicationRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the the robot application."""  
    ...
    r"""The version of the robot application to delete."""  
    

@dataclasses.dataclass
class DeleteRobotApplicationRequest:
    
    request_body: DeleteRobotApplicationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
