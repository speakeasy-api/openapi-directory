...
from ..shared import obfundsconfirmationconsent1 as shared_obfundsconfirmationconsent1
from ..shared import oberrorresponse1 as shared_oberrorresponse1
from ..shared import obfundsconfirmationconsentresponse1 as shared_obfundsconfirmationconsentresponse1
...
class CreateFundsConfirmationConsentsRequest:
    headers: CreateFundsConfirmationConsentsHeaders = dataclasses.field()
    request: shared_obfundsconfirmationconsent1.ObFundsConfirmationConsent1 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: CreateFundsConfirmationConsentsSecurity = dataclasses.field()
...
class CreateFundsConfirmationConsentsResponse:
    ...
    ob_funds_confirmation_consent_response1: Optional[shared_obfundsconfirmationconsentresponse1.ObFundsConfirmationConsentResponse1] = dataclasses.field(default=None)
