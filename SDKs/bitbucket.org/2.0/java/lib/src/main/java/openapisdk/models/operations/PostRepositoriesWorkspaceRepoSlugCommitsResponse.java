...
public class PostRepositoriesWorkspaceRepoSlugCommitsResponse {
    ...
    public PostRepositoriesWorkspaceRepoSlugCommitsResponse withStatusCode(Long statusCode) {
    ...
    public PostRepositoriesWorkspaceRepoSlugCommitsResponse withPaginatedChangeset(openapisdk.models.shared.PaginatedChangeset paginatedChangeset) {
