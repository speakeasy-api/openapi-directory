...
public class ProcessorTokenCreateRequest {
    ...
    public ProcessorTokenCreateRequest(@JsonProperty("access_token") String accessToken, @JsonProperty("account_id") String accountId, @JsonProperty("processor") ProcessorTokenCreateRequestProcessorEnum processor) {
        this.accessToken = accessToken;
        this.accountId = accountId;
        this.processor = processor;
  }
