...
class SocialDeclineFriendRequestSecurity:
...
class SocialDeclineFriendRequestRequest:
    ...
    r"""The membership id of the user you wish to decline."""  
    

@dataclasses.dataclass
class SocialDeclineFriendRequest200Wildcard:
...
@dataclasses.dataclass
class SocialDeclineFriendRequestResponse:
