...
export class Projects {
  ...
  datastreamProjectsLocationsStreamsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/streams", req);
  ...
  datastreamProjectsLocationsStreamsObjectsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/objects", req);
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
  ...
  datastreamProjectsLocationsStreamsObjectsLookup(
    ...
    security: operations.DatastreamProjectsLocationsStreamsObjectsLookupSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.DatastreamProjectsLocationsStreamsObjectsLookupResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.DatastreamProjectsLocationsStreamsObjectsLookupRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.DatastreamProjectsLocationsStreamsObjectsLookupSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DatastreamProjectsLocationsStreamsObjectsLookupResponse =
        new operations.DatastreamProjectsLocationsStreamsObjectsLookupResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
