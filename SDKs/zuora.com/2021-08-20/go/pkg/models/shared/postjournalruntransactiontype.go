...
func (e *POSTJournalRunTransactionTypeTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "External Refund Application Item":
		*e = POSTJournalRunTransactionTypeTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTJournalRunTransactionTypeTypeEnum: %s", s)
	}
}
