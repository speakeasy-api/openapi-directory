 ...
 */
export class DescribeSnapshotTierStatusRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeSnapshotTierStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeSnapshotTierStatusRequestFilters })
