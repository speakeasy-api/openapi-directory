...
export declare class DataplexProjectsLocationsDataAttributeBindingsCreateSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class DataplexProjectsLocationsDataAttributeBindingsCreateRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DataplexProjectsLocationsDataAttributeBindingsCreateResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
