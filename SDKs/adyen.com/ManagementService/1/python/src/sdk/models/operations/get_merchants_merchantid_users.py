...
from ..shared import listmerchantusersresponse as shared_listmerchantusersresponse
...
class GetMerchantsMerchantIDUsersSecurity:
...
class GetMerchantsMerchantIDUsersResponse:
    ...
    list_merchant_users_response: Optional[shared_listmerchantusersresponse.ListMerchantUsersResponse] = dataclasses.field(default=None)
