...
export class Component {
  ...
  deleteRealmComponentsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DeleteRealmComponentsIdResponse =
        new operations.DeleteRealmComponentsIdResponse({
  ...
  getRealmComponents(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/{realm}/components", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRealmComponentsResponse =
        new operations.GetRealmComponentsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status >= 200 && httpRes?.status < 300:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.componentRepresentations = utils.objectToClass(
              httpRes?.data,
              shared.ComponentRepresentation,
              resFieldDepth
            );
          }
          break;
  ...
  getRealmComponentsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRealmComponentsIdResponse =
        new operations.GetRealmComponentsIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status >= 200 && httpRes?.status < 300:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.componentRepresentation = utils.objectToClass(
              httpRes?.data,
              shared.ComponentRepresentation
            );
          }
  ...
  getRealmComponentsIdSubComponentTypes(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRealmComponentsIdSubComponentTypesResponse =
        new operations.GetRealmComponentsIdSubComponentTypesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postRealmComponents(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostRealmComponentsResponse =
        new operations.PostRealmComponentsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  putRealmComponentsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutRealmComponentsIdResponse =
        new operations.PutRealmComponentsIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
