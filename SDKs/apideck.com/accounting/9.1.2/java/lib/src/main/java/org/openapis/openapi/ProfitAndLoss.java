...
public class ProfitAndLoss {
	...
	public ProfitAndLoss(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
     ...
     */
    public org.openapis.openapi.models.operations.ProfitAndLossOneResponse profitAndLossOne(org.openapis.openapi.models.operations.ProfitAndLossOneRequest request, org.openapis.openapi.models.operations.ProfitAndLossOneSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/accounting/profit-and-loss");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ProfitAndLossOneRequest.class, request, null);
        if (queryParams != null) {
        ...
        org.openapis.openapi.models.operations.ProfitAndLossOneResponse res = new org.openapis.openapi.models.operations.ProfitAndLossOneResponse() {{
            getProfitAndLossResponse = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.GetProfitAndLossResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.GetProfitAndLossResponse.class);
