...
class DescribeGameServerInstancesRequest:
    ...
    describe_game_server_instances_input: shared_describegameserverinstancesinput.DescribeGameServerInstancesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
