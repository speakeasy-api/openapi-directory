...
class RetargetingGetDatapointsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RetargetingGetDatapointsSortDirectionEnum $sortDirection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortDirection')]
    public ?RetargetingGetDatapointsSortDirectionEnum $sortDirection = null;
    
    /**
     * Status of the datapoint
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RetargetingGetDatapointsStatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?RetargetingGetDatapointsStatusEnum $status = null;
