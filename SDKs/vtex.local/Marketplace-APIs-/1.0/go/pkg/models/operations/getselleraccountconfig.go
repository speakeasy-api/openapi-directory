...
type GetselleraccountconfigPathParams struct {
...
type GetselleraccountconfigQueryParams struct {
...
type GetselleraccountconfigHeaders struct {
...
type GetselleraccountconfigRequest struct {
	PathParams  GetselleraccountconfigPathParams
	QueryParams GetselleraccountconfigQueryParams
	Headers     GetselleraccountconfigHeaders
}
