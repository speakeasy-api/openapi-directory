...
class ListUsageRecordYesterdayListUsageRecordYesterdayResponse:
    ...
    usage_records: Optional[list[shared_api_v2010_account_usage_usage_record_usage_record_yesterday.APIV2010AccountUsageUsageRecordUsageRecordYesterday]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('usage_records'), 'exclude': lambda f: f is None }})  
