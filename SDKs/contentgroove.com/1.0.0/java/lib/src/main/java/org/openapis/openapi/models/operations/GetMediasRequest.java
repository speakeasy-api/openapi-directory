...
public class GetMediasRequest {
    ...
    public GetMediasRequest withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMediasRequest withPage(java.util.Map<String, Object> page) {
        this.page = page;
        return this;
    }
    ...
    public GetMediasSortEnum sort;

    public GetMediasRequest withSort(GetMediasSortEnum sort) {
        this.sort = sort;
        return this;
    }
    
    public GetMediasRequest(){}
}
