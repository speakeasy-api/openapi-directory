...
public class DimensionValues {
	...
	public DimensionValues(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.DfareportingDimensionValuesQueryResponse dfareportingDimensionValuesQuery(org.openapis.openapi.models.operations.DfareportingDimensionValuesQueryRequest request, org.openapis.openapi.models.operations.DfareportingDimensionValuesQuerySecurity security) throws Exception {
        ...
        org.openapis.openapi.models.operations.DfareportingDimensionValuesQueryResponse res = new org.openapis.openapi.models.operations.DfareportingDimensionValuesQueryResponse(contentType, httpRes.statusCode()) {{
            dimensionValueList = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.DimensionValueList out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.DimensionValueList.class);
