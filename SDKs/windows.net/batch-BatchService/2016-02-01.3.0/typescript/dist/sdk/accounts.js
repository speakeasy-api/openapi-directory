...
var Accounts = /** @class */ (function () {
    ...
    Accounts.prototype.accountListNodeAgentSkus = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AccountListNodeAgentSkusResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.accountListNodeAgentSkusResult = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.AccountListNodeAgentSkusResult);
                    }
                    break;
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
