...
var MenuItem = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "contextual_command" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "removeWhenSelected" }),
        __metadata("design:type", Boolean)
    ], MenuItem.prototype, "removeWhenSelected", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: menuvalue_1.MenuValue }),
        (0, class_transformer_1.Expose)({ name: "values" }),
        (0, class_transformer_1.Type)(function () { return menuvalue_1.MenuValue; }),
