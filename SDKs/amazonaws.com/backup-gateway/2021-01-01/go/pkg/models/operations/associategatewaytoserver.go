...
type AssociateGatewayToServerHeaders struct {
...
type AssociateGatewayToServerRequest struct {
	Headers AssociateGatewayToServerHeaders
	Request shared.AssociateGatewayToServerInput `request:"mediaType=application/json"`
}
