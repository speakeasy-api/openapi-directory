...
class UpdateBaiduChannelRequestBodyBaiduChannelRequest:
    r"""Specifies the status and settings of the Baidu (Baidu Cloud Push) channel for an application."""
...
class UpdateBaiduChannelRequestBody:
    ...
    baidu_channel_request: UpdateBaiduChannelRequestBodyBaiduChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('BaiduChannelRequest') }})
    r"""Specifies the status and settings of the Baidu (Baidu Cloud Push) channel for an application."""  
...
class UpdateBaiduChannelRequest:
    ...
    request_body: UpdateBaiduChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
