...
class TagTypeEnum(str, Enum):
    r"""Gets or sets the type of the tag."""
    REGULAR = 'Regular'
    NEGATIVE = 'Negative'
...
class TagInput:
    ...
    type: Optional[TagTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }, 'form': { 'field_name': 'type' }})
    r"""Gets or sets the type of the tag."""  
...
class Tag:
    ...
    r"""Gets or sets the name of the tag."""  
    type: Optional[TagTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Gets or sets the type of the tag."""  
