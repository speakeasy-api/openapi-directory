...
class TaskrouterV1WorkspaceTaskQueueTaskQueuesStatistics:
    ...
    r"""An object that contains the cumulative statistics for the TaskQueues."""  
    ...
    r"""An object that contains the real-time statistics for the TaskQueues."""  
    ...
    r"""The SID of the Workspace that contains the TaskQueues."""  
