...
public class Users {
    ...
    **/
    public openapisdk.models.operations.UsersBlockResponse usersBlock(openapisdk.models.operations.UsersBlockRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/user/blocks/{username}", request.pathParams);
        ...
        openapisdk.models.operations.UsersBlockResponse res = new openapisdk.models.operations.UsersBlockResponse() {{
            basicError = null;
            basicError = null;
            basicError = null;
            validationError = null;
    ...
    **/
    public openapisdk.models.operations.UsersCheckBlockedResponse usersCheckBlocked(openapisdk.models.operations.UsersCheckBlockedRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/user/blocks/{username}", request.pathParams);
        ...
        openapisdk.models.operations.UsersCheckBlockedResponse res = new openapisdk.models.operations.UsersCheckBlockedResponse() {{
            basicError = null;
            basicError = null;
            basicError = null;
        }};
    ...
    **/
    public openapisdk.models.operations.UsersListBlockedByAuthenticatedResponse usersListBlockedByAuthenticated() throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/user/blocks");
        ...
        openapisdk.models.operations.UsersListBlockedByAuthenticatedResponse res = new openapisdk.models.operations.UsersListBlockedByAuthenticatedResponse() {{
            simpleUsers = null;
            basicError = null;
            basicError = null;
            basicError = null;
            usersListBlockedByAuthenticated415ApplicationJSONObject = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.UsersListBlockedByAuthenticated415ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.UsersListBlockedByAuthenticated415ApplicationJson.class);
                res.usersListBlockedByAuthenticated415ApplicationJSONObject = out;
            }
        }
    ...
    **/
    public openapisdk.models.operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse usersSetPrimaryEmailVisibilityForAuthenticated(openapisdk.models.operations.UsersSetPrimaryEmailVisibilityForAuthenticatedRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/user/email/visibility");
        ...
        openapisdk.models.operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse res = new openapisdk.models.operations.UsersSetPrimaryEmailVisibilityForAuthenticatedResponse() {{
            emails = null;
            basicError = null;
            basicError = null;
            basicError = null;
    ...
    **/
    public openapisdk.models.operations.UsersUnblockResponse usersUnblock(openapisdk.models.operations.UsersUnblockRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/user/blocks/{username}", request.pathParams);
        ...
        openapisdk.models.operations.UsersUnblockResponse res = new openapisdk.models.operations.UsersUnblockResponse() {{
            basicError = null;
            basicError = null;
            basicError = null;
        }};
