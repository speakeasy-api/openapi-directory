...
class SearchStatusboardQueryParams:
    ...
    search_db_statusboard_status: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_statusboard.status', 'style': 'form', 'explode': True }})
    search_db_statusboard_what: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.db_statusboard.what', 'style': 'form', 'explode': True }})
...
class SearchStatusboardRequest:
    query_params: SearchStatusboardQueryParams = dataclasses.field()
