...
export class SecuritycenterOrganizationsAssetsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsAssetsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsAssetsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
