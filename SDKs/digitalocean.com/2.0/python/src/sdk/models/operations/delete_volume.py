...
class DeleteVolumeRequest:
    path_params: DeleteVolumePathParams = dataclasses.field()
...
class DeleteVolumeResponse:
    ...
    delete_volume_401_application_json_object: Optional[DeleteVolume401ApplicationJSON] = dataclasses.field(default=None)
