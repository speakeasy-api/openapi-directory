...
from ..shared import updatetimeoffrequestresponse as shared_updatetimeoffrequestresponse
from typing import Optional


@dataclasses.dataclass
class TimeOffRequestsUpdateSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class TimeOffRequestsUpdateRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""ID of the record you are acting upon."""  
    time_off_request_input: shared_timeoffrequest.TimeOffRequestInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class TimeOffRequestsUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_time_off_request_response: Optional[shared_updatetimeoffrequestresponse.UpdateTimeOffRequestResponse] = dataclasses.field(default=None)
    r"""TimeOffRequests"""  
