...
class Readinglist:
    ...
    def get_readinglist(self, request: operations.GetReadinglistRequest) -> operations.GetReadinglistResponse:
        ...
        query_params = utils.get_query_params(operations.GetReadinglistRequest, request)
        ...
        res = operations.GetReadinglistResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
