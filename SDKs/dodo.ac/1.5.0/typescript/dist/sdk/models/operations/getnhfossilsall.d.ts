...
export declare class GetNhFossilsAllRequest extends SpeakeasyBase {
    /**
...
export declare class GetNhFossilsAllResponse extends SpeakeasyBase {
    contentType: string;
    /**
     ...
     */
    nhFossilGroupWithIndividualFossilsNoMatcheds?: shared.NHFossilGroupWithIndividualFossilsNoMatched[];
    statusCode: number;
