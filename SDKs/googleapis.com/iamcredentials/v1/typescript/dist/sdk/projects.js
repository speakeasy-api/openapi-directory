...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.iamcredentialsProjectsServiceAccountsGenerateAccessToken = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.IamcredentialsProjectsServiceAccountsGenerateAccessTokenRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{name}:generateAccessToken", req.pathParams);
    ...
    **/
    Projects.prototype.iamcredentialsProjectsServiceAccountsGenerateIdToken = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.IamcredentialsProjectsServiceAccountsGenerateIdTokenRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{name}:generateIdToken", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.generateIdTokenResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.iamcredentialsProjectsServiceAccountsSignBlob = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.iamcredentialsProjectsServiceAccountsSignJwt = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
