...
class PostMerchantsMerchantIDPaymentMethodSettingsPaymentMethodIDAddApplePayDomainsSecurity:
...
class PostMerchantsMerchantIDPaymentMethodSettingsPaymentMethodIDAddApplePayDomainsRequest:
    ...
    apple_pay_info: Optional[shared_applepayinfo.ApplePayInfo] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
