...
export class DatacatalogProjectsLocationsEntryGroupsTagsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsEntryGroupsTagsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsEntryGroupsTagsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
