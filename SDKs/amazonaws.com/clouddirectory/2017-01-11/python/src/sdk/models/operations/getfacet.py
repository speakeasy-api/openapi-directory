...
from ..shared import getfacetresponse as shared_getfacetresponse
...
class GetFacetRequest:
    headers: GetFacetHeaders = dataclasses.field()
    request: GetFacetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetFacetResponse:
    ...
    get_facet_response: Optional[shared_getfacetresponse.GetFacetResponse] = dataclasses.field(default=None)
