...
export class ListSourceIpMappingListSourceIpMappingResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListSourceIpMappingListSourceIpMappingResponseMeta)
  meta?: ListSourceIpMappingListSourceIpMappingResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.VoiceV1SourceIpMapping })
  @Expose({ name: "source_ip_mappings" })
  @Type(() => shared.VoiceV1SourceIpMapping)
