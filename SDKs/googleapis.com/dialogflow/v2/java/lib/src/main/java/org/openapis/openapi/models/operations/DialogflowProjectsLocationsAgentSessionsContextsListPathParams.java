...
public class DialogflowProjectsLocationsAgentSessionsContextsListPathParams {
    /**
    ...
    public DialogflowProjectsLocationsAgentSessionsContextsListPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
