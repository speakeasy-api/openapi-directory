...
class DfareportingCreativeFieldsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingCreativeFieldsListSortFieldEnum $sortField
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortField')]
    public ?DfareportingCreativeFieldsListSortFieldEnum $sortField = null;
    
    /**
     * Order of sorted results.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DfareportingCreativeFieldsListSortOrderEnum $sortOrder
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortOrder')]
    public ?DfareportingCreativeFieldsListSortOrderEnum $sortOrder = null;
