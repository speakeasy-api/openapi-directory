...
public class GetNetworkDevicesLatencyStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkDevicesLatencyStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsQueryParams withBand(GetNetworkDevicesLatencyStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkDevicesLatencyStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkDevicesLatencyStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkDevicesLatencyStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkDevicesLatencyStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkDevicesLatencyStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
