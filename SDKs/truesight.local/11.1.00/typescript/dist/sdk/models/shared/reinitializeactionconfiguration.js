...
exports.ReinitializeActionConfiguration = void 0;
...
var ReinitializeActionConfiguration = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetAlertActions" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetAlertActions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetAlertAfterNTimes" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetAlertAfterNTimes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetDebugMode" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetDebugMode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetDiscoveryAndPollingIntervals" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetDiscoveryAndPollingIntervals", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetJavaSettings" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetJavaSettings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetOtherAlertSettings" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetOtherAlertSettings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetRemovedPausedObjectList" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetRemovedPausedObjectList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetReportSettings" }),
        __metadata("design:type", Number)
    ], ReinitializeActionConfiguration.prototype, "resetReportSettings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resetThresholds" }),
        __metadata("design:type", Number)
