...
class CustomersOneRequest:
    headers: CustomersOneHeaders = dataclasses.field()
    path_params: CustomersOnePathParams = dataclasses.field()
    query_params: CustomersOneQueryParams = dataclasses.field()
    security: CustomersOneSecurity = dataclasses.field()
