...
exports.DataPointsGetStatisticsSingleResponse = exports.DataPointsGetStatisticsSingleRequest = exports.DataPointsGetStatisticsSingleTimeFrameEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Timeframe of the request. See list at $timeframeList
 */
var DataPointsGetStatisticsSingleTimeFrameEnum;
...
})(DataPointsGetStatisticsSingleTimeFrameEnum = exports.DataPointsGetStatisticsSingleTimeFrameEnum || (exports.DataPointsGetStatisticsSingleTimeFrameEnum = {}));
var DataPointsGetStatisticsSingleRequest = /** @class */ (function (_super) {
    ...
    ], DataPointsGetStatisticsSingleRequest.prototype, "fromDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=hourly",
        }),
        __metadata("design:type", Boolean)
    ], DataPointsGetStatisticsSingleRequest.prototype, "hourly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], DataPointsGetStatisticsSingleRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeFrame",
        }),
        __metadata("design:type", String)
    ], DataPointsGetStatisticsSingleRequest.prototype, "timeFrame", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=toDay" }),
        __metadata("design:type", String)
    ], DataPointsGetStatisticsSingleRequest.prototype, "toDay", void 0);
    return DataPointsGetStatisticsSingleRequest;
}(utils_1.SpeakeasyBase));
exports.DataPointsGetStatisticsSingleRequest = DataPointsGetStatisticsSingleRequest;
var DataPointsGetStatisticsSingleResponse = /** @class */ (function (_super) {
    ...
    ], DataPointsGetStatisticsSingleResponse.prototype, "rawResponse", void 0);
    return DataPointsGetStatisticsSingleResponse;
}(utils_1.SpeakeasyBase));
exports.DataPointsGetStatisticsSingleResponse = DataPointsGetStatisticsSingleResponse;
