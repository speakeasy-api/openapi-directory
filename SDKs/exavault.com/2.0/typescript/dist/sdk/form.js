...
var Form = /** @class */ (function () {
    ...
    **/
    Form.prototype.deleteFormMessageById = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/forms/entries/{id}", req.pathParams);
    ...
    **/
    Form.prototype.getFormById = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/forms/{id}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
    ...
    Form.prototype.getFormEntries = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.formEntryResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
