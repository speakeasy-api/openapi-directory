...
public class ListContactsRequest {
    ...
    public org.openapis.openapi.models.shared.ListContactsRequest listContactsRequest;

    public ListContactsRequest withListContactsRequest(org.openapis.openapi.models.shared.ListContactsRequest listContactsRequest) {
    ...
    public ListContactsRequest withXAmzTarget(ListContactsXAmzTargetEnum xAmzTarget) {
        this.xAmzTarget = xAmzTarget;
        return this;
    }
    
    public ListContactsRequest(@JsonProperty("ListContactsRequest") org.openapis.openapi.models.shared.ListContactsRequest listContactsRequest, @JsonProperty("X-Amz-Target") ListContactsXAmzTargetEnum xAmzTarget) {
        this.listContactsRequest = listContactsRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
