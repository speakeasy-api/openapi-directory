...
class Statistics 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetStatisticsResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/statistics');
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\GetStatisticsRequest::class, $request, null));
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->statistics = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\Statistics>', 'json');
            }
        }
