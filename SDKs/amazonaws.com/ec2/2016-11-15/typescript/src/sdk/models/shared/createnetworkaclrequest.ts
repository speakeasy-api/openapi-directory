 ...
 */
export enum CreateNetworkAclRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateNetworkAclRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateNetworkAclRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateNetworkAclRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateNetworkAclRequestTagSpecificationsTags })
  tags?: CreateNetworkAclRequestTagSpecificationsTags[];
}

export class CreateNetworkAclRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: CreateNetworkAclRequestTagSpecifications })
