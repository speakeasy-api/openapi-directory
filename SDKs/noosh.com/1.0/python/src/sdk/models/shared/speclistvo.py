...
class SpecListVO:
    r"""Java type: com.noosh.nooshapi.vo.SpecListVO"""
    
    results: Optional[list[shared_specsimplevo.SpecSimpleVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
