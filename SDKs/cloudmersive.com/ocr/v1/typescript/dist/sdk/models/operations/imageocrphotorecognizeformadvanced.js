...
exports.ImageOcrPhotoRecognizeFormAdvancedResponse = exports.ImageOcrPhotoRecognizeFormAdvancedRequest = exports.ImageOcrPhotoRecognizeFormAdvancedRequestBody = exports.ImageOcrPhotoRecognizeFormAdvancedRequestBodyImageFile = exports.ImageOcrPhotoRecognizeFormAdvancedSecurity = void 0;
...
var ImageOcrPhotoRecognizeFormAdvancedRequest = /** @class */ (function (_super) {
    ...
    ], ImageOcrPhotoRecognizeFormAdvancedRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=bucketID",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoRecognizeFormAdvancedRequest.prototype, "bucketID", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=bucketSecretKey",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoRecognizeFormAdvancedRequest.prototype, "bucketSecretKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=diagnostics",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoRecognizeFormAdvancedRequest.prototype, "diagnostics", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=preprocessing",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoRecognizeFormAdvancedRequest.prototype, "preprocessing", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=recognitionMode",
        }),
        __metadata("design:type", String)
    ], ImageOcrPhotoRecognizeFormAdvancedRequest.prototype, "recognitionMode", void 0);
...
var ImageOcrPhotoRecognizeFormAdvancedResponse = /** @class */ (function (_super) {
    ...
    ], ImageOcrPhotoRecognizeFormAdvancedResponse.prototype, "rawResponse", void 0);
