...
func (e CreateProfilingGroupRequestBodyComputePlatformEnum) ToPointer() *CreateProfilingGroupRequestBodyComputePlatformEnum {
	return &e
}
...
func (e *CreateProfilingGroupRequestBodyComputePlatformEnum) UnmarshalJSON(data []byte) error {
	...
	case "Default":
		fallthrough
	case "AWSLambda":
		*e = CreateProfilingGroupRequestBodyComputePlatformEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateProfilingGroupRequestBodyComputePlatformEnum: %v", v)
	}
}
