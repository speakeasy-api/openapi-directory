...
func (e POSTRegisterTransitGatewayMulticastGroupSourcesActionEnum) ToPointer() *POSTRegisterTransitGatewayMulticastGroupSourcesActionEnum {
	return &e
}

func (e *POSTRegisterTransitGatewayMulticastGroupSourcesActionEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "RegisterTransitGatewayMulticastGroupSources":
		*e = POSTRegisterTransitGatewayMulticastGroupSourcesActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTRegisterTransitGatewayMulticastGroupSourcesActionEnum: %v", v)
	}
}

// POSTRegisterTransitGatewayMulticastGroupSourcesVersionEnum
...
func (e POSTRegisterTransitGatewayMulticastGroupSourcesVersionEnum) ToPointer() *POSTRegisterTransitGatewayMulticastGroupSourcesVersionEnum {
	return &e
}

func (e *POSTRegisterTransitGatewayMulticastGroupSourcesVersionEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "2016-11-15":
		*e = POSTRegisterTransitGatewayMulticastGroupSourcesVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTRegisterTransitGatewayMulticastGroupSourcesVersionEnum: %v", v)
	}
}
