...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            LpgsvRequestBody req = new LpgsvRequestBody(LpgsvRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new LpgsvRequestBodyCertificateParameters("10000000101128965", "4108652444");;
            ...
            LpgsvResponse res = sdk.apIs.lpgsv(req, new LpgsvSecurity("molestiae", "minus") {{
...
* [lpgsv](docs/apis/README.md#lpgsv) - LPG Subscription Voucher
