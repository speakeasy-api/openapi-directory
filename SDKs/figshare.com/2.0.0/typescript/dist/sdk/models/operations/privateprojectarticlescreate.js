...
exports.PrivateProjectArticlesCreateResponse = exports.PrivateProjectArticlesCreateRequest = exports.PrivateProjectArticlesCreateSecurity = void 0;
...
var PrivateProjectArticlesCreateRequest = /** @class */ (function (_super) {
    ...
    ], PrivateProjectArticlesCreateRequest.prototype, "articleProjectCreate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], PrivateProjectArticlesCreateRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], PrivateProjectArticlesCreateRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], PrivateProjectArticlesCreateRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], PrivateProjectArticlesCreateRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project_id",
        }),
        __metadata("design:type", Number)
    ], PrivateProjectArticlesCreateRequest.prototype, "projectId", void 0);
...
var PrivateProjectArticlesCreateResponse = /** @class */ (function (_super) {
    ...
    ], PrivateProjectArticlesCreateResponse.prototype, "locationWarnings", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PrivateProjectArticlesCreateResponse.prototype, "rawResponse", void 0);
