...
class GetNhFossilsGroupsRequest:
...
@dataclasses.dataclass
class GetNhFossilsGroupsResponse:
    ...
    nh_fossil_groups: Optional[list[shared_nhfossilgroup.NHFossilGroup]] = dataclasses.field(default=None)
    r"""A JSON array of fossil groups."""  
