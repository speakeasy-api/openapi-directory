...
public class GetNhFurnitureHeaders {
    /**
    ...
    public GetNhFurnitureHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFurnitureHeaders withXApiKey(String xApiKey) {
