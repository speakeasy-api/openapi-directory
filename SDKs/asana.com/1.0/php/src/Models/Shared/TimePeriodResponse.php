...
class TimePeriodResponse
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\TimePeriodCompact')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TimePeriodCompact $parent = null;
    
    /**
     * The cadence and index of the time period. The value is one of: `FY`, `H1`, `H2`, `Q1`, `Q2`, `Q3`, or `Q4`.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TimePeriodResponsePeriodEnum $period
     */
	#[\JMS\Serializer\Annotation\SerializedName('period')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TimePeriodResponsePeriodEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TimePeriodResponsePeriodEnum $period = null;
