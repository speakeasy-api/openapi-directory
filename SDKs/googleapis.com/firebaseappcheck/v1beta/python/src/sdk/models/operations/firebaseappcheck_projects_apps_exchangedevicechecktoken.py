...
class FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest:
    ...
    google_firebase_appcheck_v1beta_exchange_device_check_token_request: Optional[shared_googlefirebaseappcheckv1betaexchangedevicechecktokenrequest.GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
