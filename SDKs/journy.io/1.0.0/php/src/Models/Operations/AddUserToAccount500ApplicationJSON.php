...
class AddUserToAccount500ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\AddUserToAccount500ApplicationJSONMeta')]
    public AddUserToAccount500ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\AddUserToAccount500ApplicationJSONMeta();
	}
}
