...
type RecommenderProjectsLocationsRecommendersRecommendationsMarkFailedRequest struct {
	...
	GoogleCloudRecommenderV1MarkRecommendationFailedRequest *shared.GoogleCloudRecommenderV1MarkRecommendationFailedRequest `request:"mediaType=application/json"`
	// OAuth access token.
