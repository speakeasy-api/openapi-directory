...
func (e PostServersIDActionsRequestConsole201ApplicationJSONActionStatusEnum) ToPointer() *PostServersIDActionsRequestConsole201ApplicationJSONActionStatusEnum {
	return &e
}
...
func (e *PostServersIDActionsRequestConsole201ApplicationJSONActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsRequestConsole201ApplicationJSONActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsRequestConsole201ApplicationJSONActionStatusEnum: %v", v)
	}
}
