...
class GoogleCloudPaymentsResellerSubscriptionV1SubscriptionCancellationDetails:
    ...
    reason: Optional[GoogleCloudPaymentsResellerSubscriptionV1SubscriptionCancellationDetailsReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reason') }})
