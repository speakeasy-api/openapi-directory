...
public class GoogleCloudAssuredworkloadsV1Workload {
    ...
    public GoogleCloudAssuredworkloadsV1Workload withViolationNotificationsEnabled(Boolean violationNotificationsEnabled) {
        this.violationNotificationsEnabled = violationNotificationsEnabled;
        return this;
    }
    
    public GoogleCloudAssuredworkloadsV1Workload(){}
}
