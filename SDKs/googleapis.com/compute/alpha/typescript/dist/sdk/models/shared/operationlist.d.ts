 ...
 */
export declare enum OperationListWarningCodeEnum {
...
export declare class OperationListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class OperationListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class OperationList extends SpeakeasyBase {
    /**
