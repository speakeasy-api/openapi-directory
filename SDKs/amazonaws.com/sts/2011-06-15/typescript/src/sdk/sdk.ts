...
export class SDK {
  ...
  **/
  getDecodeAuthorizationMessage(
  ...
  ): Promise<operations.GetDecodeAuthorizationMessageResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetDecodeAuthorizationMessageRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=DecodeAuthorizationMessage";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetDecodeAuthorizationMessageResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  getGetAccessKeyInfo(
    req: operations.GetGetAccessKeyInfoRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetGetAccessKeyInfoResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetGetAccessKeyInfoRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=GetAccessKeyInfo";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetGetAccessKeyInfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  getGetCallerIdentity(
    req: operations.GetGetCallerIdentityRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetGetCallerIdentityResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetGetCallerIdentityRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=GetCallerIdentity";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetGetCallerIdentityResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  getGetSessionToken(
    req: operations.GetGetSessionTokenRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetGetSessionTokenResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetGetSessionTokenRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=GetSessionToken";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetGetSessionTokenResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postAssumeRole(
    req: operations.PostAssumeRoleRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostAssumeRoleResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostAssumeRoleRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=AssumeRole";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostAssumeRoleResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postAssumeRoleWithSaml(
    req: operations.PostAssumeRoleWithSamlRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostAssumeRoleWithSamlResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostAssumeRoleWithSamlRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=AssumeRoleWithSAML";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostAssumeRoleWithSamlResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postAssumeRoleWithWebIdentity(
    req: operations.PostAssumeRoleWithWebIdentityRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostAssumeRoleWithWebIdentityResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostAssumeRoleWithWebIdentityRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=AssumeRoleWithWebIdentity";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostAssumeRoleWithWebIdentityResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postDecodeAuthorizationMessage(
    req: operations.PostDecodeAuthorizationMessageRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostDecodeAuthorizationMessageResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostDecodeAuthorizationMessageRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostDecodeAuthorizationMessageResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postGetAccessKeyInfo(
    req: operations.PostGetAccessKeyInfoRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostGetAccessKeyInfoResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostGetAccessKeyInfoRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostGetAccessKeyInfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postGetCallerIdentity(
    req: operations.PostGetCallerIdentityRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostGetCallerIdentityResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostGetCallerIdentityRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostGetCallerIdentityResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postGetFederationToken(
    req: operations.PostGetFederationTokenRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostGetFederationTokenResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostGetFederationTokenRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/#Action=GetFederationToken";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostGetFederationTokenResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  **/
  postGetSessionToken(
    req: operations.PostGetSessionTokenRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PostGetSessionTokenResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PostGetSessionTokenRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostGetSessionTokenResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `text/xml`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
