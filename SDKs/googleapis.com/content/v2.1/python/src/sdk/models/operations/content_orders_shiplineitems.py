...
class ContentOrdersShiplineitemsRequest:
    ...
    orders_ship_line_items_request: Optional[shared_ordersshiplineitemsrequest.OrdersShipLineItemsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
