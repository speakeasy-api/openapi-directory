 ...
 */
export declare enum CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateLocalGatewayRouteTableVpcAssociationRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateLocalGatewayRouteTableVpcAssociationRequest extends SpeakeasyBase {
    dryRun?: boolean;
