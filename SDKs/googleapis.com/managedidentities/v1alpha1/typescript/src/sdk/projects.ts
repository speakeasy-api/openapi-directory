...
export class Projects {
  ...
  managedidentitiesProjectsLocationsGlobalOperationsList(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ManagedidentitiesProjectsLocationsGlobalOperationsListRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ManagedidentitiesProjectsLocationsGlobalOperationsListSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ManagedidentitiesProjectsLocationsGlobalOperationsListResponse =
        new operations.ManagedidentitiesProjectsLocationsGlobalOperationsListResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
