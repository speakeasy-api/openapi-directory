...
var BaselineValueFormat = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "negativeColor" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "negativeColorStyle" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "positiveColor" }),
        (0, class_transformer_1.Type)(function () { return color_1.Color; }),
        __metadata("design:type", color_1.Color)
    ], BaselineValueFormat.prototype, "positiveColor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "positiveColorStyle" }),
        (0, class_transformer_1.Type)(function () { return colorstyle_1.ColorStyle; }),
        __metadata("design:type", colorstyle_1.ColorStyle)
