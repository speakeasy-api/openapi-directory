...
class UpdateCertificateRequest:
    headers: UpdateCertificateHeaders = dataclasses.field()
    path_params: UpdateCertificatePathParams = dataclasses.field()
    query_params: UpdateCertificateQueryParams = dataclasses.field()
