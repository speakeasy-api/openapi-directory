...
func (e GetNetworkDeviceLatencyStatsBandEnum) ToPointer() *GetNetworkDeviceLatencyStatsBandEnum {
	return &e
}
...
func (e *GetNetworkDeviceLatencyStatsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "2.4":
		fallthrough
	case "5":
		*e = GetNetworkDeviceLatencyStatsBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkDeviceLatencyStatsBandEnum: %v", v)
	}
}
