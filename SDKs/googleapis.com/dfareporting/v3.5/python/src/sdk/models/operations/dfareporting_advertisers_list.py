...
class DfareportingAdvertisersListStatusEnum(str, Enum):
    r"""Select only advertisers with the specified status."""
    APPROVED = 'APPROVED'
    ON_HOLD = 'ON_HOLD'
...
class DfareportingAdvertisersListRequest:
    ...
    r"""Select only advertisers with these advertiser group IDs."""  
    ...
    r"""Select only advertisers which do not belong to any advertiser group."""  
    ...
    r"""Select only advertisers which use another advertiser's floodlight configuration."""  
    ...
    r"""Allows searching for objects by name or ID. Wildcards (*) are allowed. For example, \\"advertiser*2015\\" will return objects with names like \\"advertiser June 2015\\", \\"advertiser April 2015\\", or simply \\"advertiser 2015\\". Most of the searches also add wildcards implicitly at the start and the end of the search string. For example, a search string of \\"advertiser\\" will match objects with name \\"my advertiser\\", \\"advertiser 2015\\", or simply \\"advertiser\\" ."""  
    ...
    r"""Select only advertisers with these subaccount IDs."""  
