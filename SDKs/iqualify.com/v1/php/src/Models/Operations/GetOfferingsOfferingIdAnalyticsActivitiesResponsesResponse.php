...
class GetOfferingsOfferingIdAnalyticsActivitiesResponsesResponse
{
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\ActivityAttemptOpenResponse> $activityAttemptOpenResponses
     */
	
    public ?array $activityAttemptOpenResponses = null;
	...
	{
		$this->activityAttemptOpenResponses = null;
		$this->contentType = "";
		$this->error = null;
		$this->statusCode = 0;
