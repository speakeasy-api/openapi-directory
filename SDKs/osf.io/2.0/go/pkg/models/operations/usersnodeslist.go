...
type UsersNodesListNodeAttributesCategoryEnum string

const (
	UsersNodesListNodeAttributesCategoryEnumAnalysis           UsersNodesListNodeAttributesCategoryEnum = "analysis"
	UsersNodesListNodeAttributesCategoryEnumCommunication      UsersNodesListNodeAttributesCategoryEnum = "communication"
	UsersNodesListNodeAttributesCategoryEnumData               UsersNodesListNodeAttributesCategoryEnum = "data"
	UsersNodesListNodeAttributesCategoryEnumHypothesis         UsersNodesListNodeAttributesCategoryEnum = "hypothesis"
	UsersNodesListNodeAttributesCategoryEnumInstrumentation    UsersNodesListNodeAttributesCategoryEnum = "instrumentation"
	UsersNodesListNodeAttributesCategoryEnumMethodsAndMeasures UsersNodesListNodeAttributesCategoryEnum = "methods and measures"
	UsersNodesListNodeAttributesCategoryEnumProcedure          UsersNodesListNodeAttributesCategoryEnum = "procedure"
	UsersNodesListNodeAttributesCategoryEnumProject            UsersNodesListNodeAttributesCategoryEnum = "project"
	UsersNodesListNodeAttributesCategoryEnumSoftware           UsersNodesListNodeAttributesCategoryEnum = "software"
	UsersNodesListNodeAttributesCategoryEnumOther              UsersNodesListNodeAttributesCategoryEnum = "other"
)

func (e UsersNodesListNodeAttributesCategoryEnum) ToPointer() *UsersNodesListNodeAttributesCategoryEnum {
	return &e
}

func (e *UsersNodesListNodeAttributesCategoryEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "software":
		fallthrough
	case "other":
		*e = UsersNodesListNodeAttributesCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UsersNodesListNodeAttributesCategoryEnum: %v", v)
	}
}

// UsersNodesListNodeAttributes - The properties of the node entity.
type UsersNodesListNodeAttributes struct {
...
type UsersNodesListNodeLinks struct {
...
type UsersNodesListNodeRelationships struct {
...
type UsersNodesListNode struct {
