...
class ListPrincipalsForPortfolioRequest:
    ...
    list_principals_for_portfolio_input: shared_listprincipalsforportfolioinput.ListPrincipalsForPortfolioInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
