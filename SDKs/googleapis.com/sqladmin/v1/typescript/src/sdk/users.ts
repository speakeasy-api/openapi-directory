...
export class Users {
  ...
  **/
  sqlUsersDelete(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/projects/{project}/instances/{instance}/users", req.pathParams);
  ...
  **/
  sqlUsersGet(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/projects/{project}/instances/{instance}/users/{name}", req.pathParams);
