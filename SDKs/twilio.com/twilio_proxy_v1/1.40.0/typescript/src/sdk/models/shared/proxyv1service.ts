...
export class ProxyV1Service extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "default_ttl" })
  defaultTtl?: number;

  @SpeakeasyMetadata()
  @Expose({ name: "geo_match_level" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "intercept_callback_url" })
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "number_selection_behavior" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "out_of_session_callback_url" })
