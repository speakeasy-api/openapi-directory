...
var VideoMetadata = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isValidVast" }),
        __metadata("design:type", Boolean)
    ], VideoMetadata.prototype, "isValidVast", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isVpaid" }),
        __metadata("design:type", Boolean)
    ], VideoMetadata.prototype, "isVpaid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: mediafile_1.MediaFile }),
        (0, class_transformer_1.Expose)({ name: "mediaFiles" }),
        (0, class_transformer_1.Type)(function () { return mediafile_1.MediaFile; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "vastVersion" }),
        __metadata("design:type", String)
