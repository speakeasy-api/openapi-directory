...
public class AdsenseAccountsReportsSavedGenerateQueryParams {
    ...
    public AdsenseAccountsReportsSavedGenerateQueryParams withLocale(String locale) {
        this.locale = locale;
        return this;
    }
    ...
    public AdsenseAccountsReportsSavedGenerateQueryParams withMaxResults(Long maxResults) {
    ...
    public AdsenseAccountsReportsSavedGenerateQueryParams withStartIndex(Long startIndex) {
    ...
    public AdsenseAccountsReportsSavedGenerateQueryParams withUserIp(String userIp) {
        this.userIp = userIp;
        return this;
    }
