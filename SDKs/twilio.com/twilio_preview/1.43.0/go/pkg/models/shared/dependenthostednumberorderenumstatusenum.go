...
func (e DependentHostedNumberOrderEnumStatusEnum) ToPointer() *DependentHostedNumberOrderEnumStatusEnum {
	return &e
}
...
func (e *DependentHostedNumberOrderEnumStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "action-required":
		*e = DependentHostedNumberOrderEnumStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DependentHostedNumberOrderEnumStatusEnum: %v", v)
	}
}
