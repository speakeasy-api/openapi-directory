...
exports.GetMaintenanceWindowExecutionTaskResponse = exports.GetMaintenanceWindowExecutionTaskRequest = exports.GetMaintenanceWindowExecutionTaskXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GetMaintenanceWindowExecutionTaskXAmzTargetEnum;
...
})(GetMaintenanceWindowExecutionTaskXAmzTargetEnum = exports.GetMaintenanceWindowExecutionTaskXAmzTargetEnum || (exports.GetMaintenanceWindowExecutionTaskXAmzTargetEnum = {}));
var GetMaintenanceWindowExecutionTaskRequest = /** @class */ (function (_super) {
    ...
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "getMaintenanceWindowExecutionTaskRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionTaskRequest.prototype, "xAmzTarget", void 0);
...
var GetMaintenanceWindowExecutionTaskResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetMaintenanceWindowExecutionTaskResponse.prototype, "rawResponse", void 0);
    return GetMaintenanceWindowExecutionTaskResponse;
}(utils_1.SpeakeasyBase));
exports.GetMaintenanceWindowExecutionTaskResponse = GetMaintenanceWindowExecutionTaskResponse;
