...
public class DataExtracts {
	...
	public DataExtracts(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    **/
    public openapisdk.models.operations.GetDataExtractsEventsResponse getDataExtractsEvents(openapisdk.models.operations.GetDataExtractsEventsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/dataExtracts/events");
        ...
        openapisdk.models.operations.GetDataExtractsEventsResponse res = new openapisdk.models.operations.GetDataExtractsEventsResponse() {{
            dataExtractsEventResponse = null;
            yodleeError = null;
        }};
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                ...
                openapisdk.models.shared.DataExtractsEventResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DataExtractsEventResponse.class);
    ...
    **/
    public openapisdk.models.operations.GetDataExtractsUserDataResponse getDataExtractsUserData(openapisdk.models.operations.GetDataExtractsUserDataRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/dataExtracts/userData");
        ...
        openapisdk.models.operations.GetDataExtractsUserDataResponse res = new openapisdk.models.operations.GetDataExtractsUserDataResponse() {{
            dataExtractsUserDataResponse = null;
            yodleeError = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DataExtractsUserDataResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DataExtractsUserDataResponse.class);
