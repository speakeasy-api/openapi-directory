 ...
 * 
 */
public class POSTRevenueScheduleByTransactionRatablyCMType {
    /**
    ...
    public POSTRevenueScheduleByTransactionRatablyCMType withDistributionType(String distributionType) {
    ...
    @JsonProperty("notes")
    public String notes;
    public POSTRevenueScheduleByTransactionRatablyCMType withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public POSTRevenueScheduleByTransactionRatablyCMType withRecognitionEnd(LocalDate recognitionEnd) {
    ...
    public POSTRevenueScheduleByTransactionRatablyCMType withRecognitionStart(LocalDate recognitionStart) {
    ...
    public POSTRevenueScheduleByTransactionRatablyCMType withRevenueEvent(POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent revenueEvent) {
