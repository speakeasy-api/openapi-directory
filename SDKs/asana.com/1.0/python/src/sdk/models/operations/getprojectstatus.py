...
class GetProjectStatusRequest:
    ...
    r"""The project status update to get."""  
...
class GetProjectStatus200ApplicationJSON:
    r"""Successfully retrieved the specified project's status updates."""
    
    data: Optional[shared_projectstatusresponse.ProjectStatusResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
