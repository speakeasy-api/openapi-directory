...
class ListItemAssignmentListItemAssignmentResponse:
    ...
    meta: Optional[ListItemAssignmentListItemAssignmentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    results: Optional[list[shared_numbers_v2_regulatory_compliance_bundle_item_assignment.NumbersV2RegulatoryComplianceBundleItemAssignment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
