...
public class GetIterationRequest {
    ...
    public GetIterationRequest(@JsonProperty("Training-Key") String trainingKey, @JsonProperty("iterationId") String iterationId, @JsonProperty("projectId") String projectId) {
        this.trainingKey = trainingKey;
        this.iterationId = iterationId;
        this.projectId = projectId;
  }
