...
use \OpenAPI\OpenAPI\Models\Operations\PmjayRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\PmjayRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\PmjayRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\PmjaySecurity;
...
try {
    ...
    $request->certificateParameters = new PmjayRequestBodyCertificateParameters();
    $request->certificateParameters->dob = '31-12-1980';
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->udf1 = 'PMJAY0000';
    $request->certificateParameters->udf2 = 'JAMMU AND KASHMIR,HIMACHAL PRADESH,PUNJAB,CHANDIGARH,UTTARAKHAND,HARYANA,DELHI,RAJASTHAN,UTTAR PRADE';
    ...
    $request->format = PmjayRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new PmjaySecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->pmjay($request, $requestSecurity);
