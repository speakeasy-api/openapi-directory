...
from ..shared import security as shared_security
from ..shared import offers as shared_offers


@dataclasses.dataclass
class BooksPromoofferGetQueryParams:
...
class BooksPromoofferGetRequest:
    query_params: BooksPromoofferGetQueryParams = dataclasses.field()
    security: BooksPromoofferGetSecurity = dataclasses.field()
...
class BooksPromoofferGetResponse:
    ...
    offers: Optional[shared_offers.Offers] = dataclasses.field(default=None)
