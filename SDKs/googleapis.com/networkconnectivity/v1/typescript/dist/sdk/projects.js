...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.networkconnectivityProjectsLocationsGlobalHubsCreate = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/{parent}/hubs", req.pathParams);
    ...
    **/
    Projects.prototype.networkconnectivityProjectsLocationsInternalRangesCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/internalRanges", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.networkconnectivityProjectsLocationsSpokesCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/spokes", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
