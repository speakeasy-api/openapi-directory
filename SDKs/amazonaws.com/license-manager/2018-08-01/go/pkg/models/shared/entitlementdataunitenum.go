...
func (e EntitlementDataUnitEnum) ToPointer() *EntitlementDataUnitEnum {
	return &e
}
...
func (e *EntitlementDataUnitEnum) UnmarshalJSON(data []byte) error {
	...
	case "Terabits/Second":
		fallthrough
	case "Count/Second":
		*e = EntitlementDataUnitEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EntitlementDataUnitEnum: %v", v)
	}
}
