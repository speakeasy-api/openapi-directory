...
public class EstimationApiUriHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiUriHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiUriHeaders withXAuthSecret(String xAuthSecret) {
