...
export const ListParticipantServerList = ["https://proxy.twilio.com"] as const;
...
export class ListParticipantListParticipantResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListParticipantListParticipantResponseMeta)
  meta?: ListParticipantListParticipantResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.ProxyV1ServiceSessionParticipant })
  @Expose({ name: "participants" })
  @Type(() => shared.ProxyV1ServiceSessionParticipant)
