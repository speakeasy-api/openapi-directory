...
from ..shared import dictlayerdata as shared_dictlayerdata
...
class DictionaryAnnotationdata:
    ...
    data: Optional[shared_dictlayerdata.Dictlayerdata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
