...
exports.ListSyncMapPermissionResponse = exports.ListSyncMapPermissionListSyncMapPermissionResponse = exports.ListSyncMapPermissionListSyncMapPermissionResponseMeta = exports.ListSyncMapPermissionRequest = exports.ListSyncMapPermissionSecurity = exports.ListSyncMapPermissionServerList = void 0;
...
var ListSyncMapPermissionSecurity = /** @class */ (function (_super) {
    ...
    ], ListSyncMapPermissionSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSyncMapPermissionSecurity.prototype, "username", void 0);
...
var ListSyncMapPermissionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSyncMapPermissionRequest.prototype, "mapSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSyncMapPermissionRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSyncMapPermissionRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSyncMapPermissionRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListSyncMapPermissionRequest.prototype, "serviceSid", void 0);
...
var ListSyncMapPermissionListSyncMapPermissionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListSyncMapPermissionListSyncMapPermissionResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SyncV1ServiceSyncMapSyncMapPermission }),
        (0, class_transformer_1.Expose)({ name: "permissions" }),
        (0, class_transformer_1.Type)(function () { return shared.SyncV1ServiceSyncMapSyncMapPermission; }),
...
var ListSyncMapPermissionResponse = /** @class */ (function (_super) {
    ...
    ], ListSyncMapPermissionResponse.prototype, "rawResponse", void 0);
