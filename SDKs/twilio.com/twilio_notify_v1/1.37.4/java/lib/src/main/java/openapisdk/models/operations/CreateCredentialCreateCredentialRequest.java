...
public class CreateCredentialCreateCredentialRequest {
    ...
    public openapisdk.models.shared.CredentialEnumPushServiceEnum type;
    public CreateCredentialCreateCredentialRequest withType(openapisdk.models.shared.CredentialEnumPushServiceEnum type) {
        this.type = type;
        return this;
    }
}