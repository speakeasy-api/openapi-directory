 ...
 */
export enum NodeTypeListWarningCodeEnum {
...
export class NodeTypeListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NodeTypeListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NodeTypeListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class NodeTypeList extends SpeakeasyBase {
  /**
