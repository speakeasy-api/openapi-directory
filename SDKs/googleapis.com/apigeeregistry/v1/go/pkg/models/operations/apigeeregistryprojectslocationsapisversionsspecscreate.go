...
type ApigeeregistryProjectsLocationsApisVersionsSpecsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ApigeeregistryProjectsLocationsApisVersionsSpecsCreatePathParams struct {
	// Required. The parent, which owns this collection of specs. Format: `projects/*/locations/*/apis/*/versions/*`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeregistryProjectsLocationsApisVersionsSpecsCreateQueryParams struct {
	// V1 error format.
...
type ApigeeregistryProjectsLocationsApisVersionsSpecsCreateRequest struct {
...
type ApigeeregistryProjectsLocationsApisVersionsSpecsCreateResponse struct {
	// Successful response
