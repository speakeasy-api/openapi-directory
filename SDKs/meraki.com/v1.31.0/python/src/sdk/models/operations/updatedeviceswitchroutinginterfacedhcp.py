...
class UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum(str, Enum):
    r"""The DHCP lease time config for the dhcp server running on switch interface ('30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week')"""
    ONE_DAY = '1 day'
    ONE_HOUR = '1 hour'
    ONE_WEEK = '1 week'
...
class UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpModeEnum(str, Enum):
    r"""The DHCP mode options for the switch interface ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')"""
...
class UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptions:
    ...
    type: UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptionsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The type of the DHCP option which should be one of ('text', 'ip', 'integer' or 'hex')"""  
...
class UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum(str, Enum):
    r"""The DHCP name server option for the dhcp server running on the switch interface ('googlePublicDns', 'openDns' or 'custom')"""
    CUSTOM = 'custom'
...
class UpdateDeviceSwitchRoutingInterfaceDhcpRequestBody:
    ...
    r"""The PXE boot server filename for the DHCP server running on the switch interface"""  
    ...
    r"""The PXE boot server IP for the DHCP server running on the switch interface"""  
    ...
    r"""Enable DHCP boot options to provide PXE boot options configs for the dhcp server running on the switch interface"""  
    dhcp_lease_time: Optional[UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpLeaseTimeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dhcpLeaseTime'), 'exclude': lambda f: f is None }})
    r"""The DHCP lease time config for the dhcp server running on switch interface ('30 minutes', '1 hour', '4 hours', '12 hours', '1 day' or '1 week')"""  
    dhcp_mode: Optional[UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dhcpMode'), 'exclude': lambda f: f is None }})
    r"""The DHCP mode options for the switch interface ('dhcpDisabled', 'dhcpRelay' or 'dhcpServer')"""  
    dhcp_options: Optional[list[UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDhcpOptions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dhcpOptions'), 'exclude': lambda f: f is None }})
    r"""Array of DHCP options consisting of code, type and value for the DHCP server running on the switch interface"""  
    ...
    r"""The DHCP relay server IPs to which DHCP packets would get relayed for the switch interface"""  
    ...
    dns_nameservers_option: Optional[UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyDNSNameserversOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dnsNameserversOption'), 'exclude': lambda f: f is None }})
    r"""The DHCP name server option for the dhcp server running on the switch interface ('googlePublicDns', 'openDns' or 'custom')"""  
    fixed_ip_assignments: Optional[list[UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyFixedIPAssignments]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fixedIpAssignments'), 'exclude': lambda f: f is None }})
    r"""Array of DHCP fixed IP assignments for the DHCP server running on the switch interface"""  
    reserved_ip_ranges: Optional[list[UpdateDeviceSwitchRoutingInterfaceDhcpRequestBodyReservedIPRanges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reservedIpRanges'), 'exclude': lambda f: f is None }})
    r"""Array of DHCP reserved IP assignments for the DHCP server running on the switch interface"""  
...
class UpdateDeviceSwitchRoutingInterfaceDhcpRequest:
    ...
    request_body: Optional[UpdateDeviceSwitchRoutingInterfaceDhcpRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
