...
public class GetTransactionSettlementsHeaders {
    /**
    ...
    public GetTransactionSettlementsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public GetTransactionSettlementsHeaders withContentType(String contentType) {
