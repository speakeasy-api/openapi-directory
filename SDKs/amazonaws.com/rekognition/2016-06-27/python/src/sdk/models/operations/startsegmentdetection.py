...
class StartSegmentDetectionRequest:
    ...
    start_segment_detection_request: shared_startsegmentdetectionrequest.StartSegmentDetectionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
