...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/googleapis.com/baremetalsolution/v1/go
```
...
func main() {
    ...
    res, err := s.Operations.BaremetalsolutionOperationsCancel(ctx, operations.BaremetalsolutionOperationsCancelRequest{
    ...
    }, operations.BaremetalsolutionOperationsCancelSecurity{
