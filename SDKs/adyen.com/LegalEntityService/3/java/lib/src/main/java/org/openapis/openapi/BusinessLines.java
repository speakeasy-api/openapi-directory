...
public class BusinessLines {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PatchBusinessLinesIdResponse patchBusinessLinesId(org.openapis.openapi.models.operations.PatchBusinessLinesIdRequest request, org.openapis.openapi.models.operations.PatchBusinessLinesIdSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.PatchBusinessLinesIdRequest.class, baseUrl, "/businessLines/{id}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("PATCH");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "businessLineInfoUpdateInput", "json");
