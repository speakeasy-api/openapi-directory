...
type GetGenePhenotypeAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetGenePhenotypeAssociationsQueryParams struct {
