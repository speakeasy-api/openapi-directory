...
exports.Volume = exports.VolumeInput = exports.VolumeProtocolEnum = exports.VolumeWorkloadProfileEnum = exports.VolumeStorageTypeEnum = exports.VolumeStateEnum = exports.VolumeSnapshotAutoDeleteBehaviorEnum = exports.VolumePerformanceTierEnum = void 0;
...
var VolumeInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=autoGrownSizeGib" }),
        __metadata("design:type", String)
    ], VolumeInput.prototype, "autoGrownSizeGib", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=currentSizeGib" }),
        __metadata("design:type", String)
    ], VolumeInput.prototype, "currentSizeGib", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=emergencySizeGib" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=maxSizeGib" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=originallyRequestedSizeGib" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=remainingSpaceGib" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=snapshotAutoDeleteBehavior" }),
        __metadata("design:type", String)
    ], VolumeInput.prototype, "snapshotAutoDeleteBehavior", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=snapshotEnabled" }),
        __metadata("design:type", Boolean)
    ], VolumeInput.prototype, "snapshotEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=snapshotReservationDetail" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=snapshotSchedulePolicy" }),
        __metadata("design:type", String)
...
var Volume = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bootVolume" }),
        __metadata("design:type", Boolean)
