...
var listedworkflow_1 = require("./listedworkflow");
...
var ListWorkflowsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: listedworkflow_1.ListedWorkflow }),
        (0, class_transformer_1.Expose)({ name: "Workflows" }),
        (0, class_transformer_1.Type)(function () { return listedworkflow_1.ListedWorkflow; }),
