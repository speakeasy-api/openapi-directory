...
class NumbersV2RegulatoryComplianceBundleReplaceItems:
    ...
    status: Optional[shared_replace_items_enum_status_enum.ReplaceItemsEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
