...
class ListEndUserTypeListEndUserTypeResponse:
    end_user_types: Optional[list[shared_trusthub_v1_end_user_type.TrusthubV1EndUserType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('end_user_types') }})
