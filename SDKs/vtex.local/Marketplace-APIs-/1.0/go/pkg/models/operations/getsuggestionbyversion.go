...
type GetSuggestionbyversionPathParams struct {
...
type GetSuggestionbyversionRequest struct {
	PathParams  GetSuggestionbyversionPathParams
	QueryParams GetSuggestionbyversionQueryParams
	Headers     GetSuggestionbyversionHeaders
}
