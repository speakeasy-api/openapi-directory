...
func (e POSTDeleteConfigurationSetActionEnum) ToPointer() *POSTDeleteConfigurationSetActionEnum {
	return &e
}
...
func (e *POSTDeleteConfigurationSetActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DeleteConfigurationSet":
		*e = POSTDeleteConfigurationSetActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDeleteConfigurationSetActionEnum: %v", v)
	}
}
...
func (e POSTDeleteConfigurationSetVersionEnum) ToPointer() *POSTDeleteConfigurationSetVersionEnum {
	return &e
}
...
func (e *POSTDeleteConfigurationSetVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2010-12-01":
		*e = POSTDeleteConfigurationSetVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDeleteConfigurationSetVersionEnum: %v", v)
	}
}
