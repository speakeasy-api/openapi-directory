...
func (s *operationsT) FirebasehostingOperationsCancel(ctx context.Context, request operations.FirebasehostingOperationsCancelRequest) (*operations.FirebasehostingOperationsCancelResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) FirebasehostingOperationsDelete(ctx context.Context, request operations.FirebasehostingOperationsDeleteRequest) (*operations.FirebasehostingOperationsDeleteResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) FirebasehostingOperationsList(ctx context.Context, request operations.FirebasehostingOperationsListRequest) (*operations.FirebasehostingOperationsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request, nil)
