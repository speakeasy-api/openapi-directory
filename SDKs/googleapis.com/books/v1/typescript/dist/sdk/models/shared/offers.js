...
var OffersItemsItems = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=canonicalVolumeLink" }),
        __metadata("design:type", String)
    ], OffersItemsItems.prototype, "canonicalVolumeLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=coverUrl" }),
        __metadata("design:type", String)
...
var OffersItems = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=artUrl" }),
        __metadata("design:type", String)
    ], OffersItems.prototype, "artUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gservicesKey" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=items", elemType: OffersItemsItems }),
...
var Offers = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=items", elemType: OffersItems }),
        __metadata("design:type", Array)
