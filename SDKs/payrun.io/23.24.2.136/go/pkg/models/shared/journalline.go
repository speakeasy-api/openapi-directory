...
func (e JournalLineJournalLinePayFrequencyEnum) ToPointer() *JournalLineJournalLinePayFrequencyEnum {
	return &e
}
...
func (e *JournalLineJournalLinePayFrequencyEnum) UnmarshalJSON(data []byte) error {
	...
	case "FourWeekly":
		fallthrough
	case "Yearly":
		*e = JournalLineJournalLinePayFrequencyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for JournalLineJournalLinePayFrequencyEnum: %v", v)
	}
}
