...
class RefundNotPaidOutTransfersRequest:
    ...
    r"""The code of the account from which to perform the refund(s)."""  
    account_holder_code: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('accountHolderCode') }})
    r"""The code of the Account Holder which owns the account from which to perform the refund(s)."""  
