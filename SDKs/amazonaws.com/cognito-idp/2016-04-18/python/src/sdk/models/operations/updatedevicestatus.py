...
class UpdateDeviceStatusRequest:
    ...
    update_device_status_request: shared_updatedevicestatusrequest.UpdateDeviceStatusRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
