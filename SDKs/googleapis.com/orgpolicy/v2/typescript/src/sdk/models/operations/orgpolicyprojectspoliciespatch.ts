...
export class OrgpolicyProjectsPoliciesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class OrgpolicyProjectsPoliciesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class OrgpolicyProjectsPoliciesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
