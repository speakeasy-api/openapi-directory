...
from ..shared import getclusteroutput as shared_getclusteroutput
...
class GetClusterResponse:
    ...
    get_cluster_output: Optional[shared_getclusteroutput.GetClusterOutput] = dataclasses.field(default=None)
    r"""Success"""  
