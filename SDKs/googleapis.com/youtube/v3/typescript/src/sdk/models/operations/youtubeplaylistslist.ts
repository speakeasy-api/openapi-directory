...
export class YoutubePlaylistsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class YoutubePlaylistsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class YoutubePlaylistsListSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class YoutubePlaylistsListSecurityOption4 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class YoutubePlaylistsListSecurity extends SpeakeasyBase {
...
export class YoutubePlaylistsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class YoutubePlaylistsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
