...
export class BatchProjectsLocationsJobsTaskGroupsTasksListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BatchProjectsLocationsJobsTaskGroupsTasksListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BatchProjectsLocationsJobsTaskGroupsTasksListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
