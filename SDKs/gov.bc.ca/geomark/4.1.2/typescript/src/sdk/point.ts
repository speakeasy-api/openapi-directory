...
export class Point {
  ...
  getGeomarksGeomarkIdPointFileFormatExtension(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetGeomarksGeomarkIdPointFileFormatExtensionRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetGeomarksGeomarkIdPointFileFormatExtensionResponse =
        new operations.GetGeomarksGeomarkIdPointFileFormatExtensionResponse({
