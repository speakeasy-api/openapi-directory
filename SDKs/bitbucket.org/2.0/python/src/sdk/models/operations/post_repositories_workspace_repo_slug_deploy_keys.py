...
class PostRepositoriesWorkspaceRepoSlugDeployKeysRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugDeployKeysPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugDeployKeysSecurity = dataclasses.field()
