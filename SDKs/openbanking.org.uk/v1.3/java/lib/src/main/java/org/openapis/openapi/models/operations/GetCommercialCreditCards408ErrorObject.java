...
public class GetCommercialCreditCards408ErrorObject {
    ...
    public GetCommercialCreditCards408ErrorObject(@JsonProperty("description") GetCommercialCreditCards408ErrorObjectDescriptionEnum description, @JsonProperty("status") GetCommercialCreditCards408ErrorObjectStatusEnum status, @JsonProperty("title") GetCommercialCreditCards408ErrorObjectTitleEnum title) {
        this.description = description;
        this.status = status;
        this.title = title;
  }
