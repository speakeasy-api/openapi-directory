...
public class GetKvPairsRequest {
    ...
    public GetKvPairsRequest withAfter(OffsetDateTime after) {
        this.after = after;
        return this;
    }
    ...
    public GetKvPairsRequest withAfterId(String afterId) {
    ...
    public GetKvPairsRequest withBefore(String before) {
        this.before = before;
        return this;
    }
    ...
    public GetKvPairsRequest withBeforeId(String beforeId) {
    ...
    public GetKvPairsRequest withFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public GetKvPairsRequest withFromId(String fromId) {
        this.fromId = fromId;
        return this;
    }
    ...
    public GetKvPairsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetKvPairsRequest withIdOnly(Boolean idOnly) {
        this.idOnly = idOnly;
        return this;
    }
    ...
    public GetKvPairsRequest withKvKey(String kvKey) {
        this.kvKey = kvKey;
        return this;
    }
    ...
    public GetKvPairsRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetKvPairsRequest withPopulate(String populate) {
    ...
    public GetKvPairsRequest withResultsOnly(Boolean resultsOnly) {
    ...
    public GetKvPairsRequest withSelect(String select) {
        this.select = select;
        return this;
    }
    ...
    public GetKvPairsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetKvPairsRequest withTimeCreated(String timeCreated) {
    ...
    public GetKvPairsRequest withTimeUpdated(String timeUpdated) {
    ...
    public GetKvPairsRequest withTimeoutS(Double timeoutS) {
    ...
    public GetKvPairsRequest withUntil(String until) {
        this.until = until;
        return this;
    }
    ...
    public GetKvPairsRequest withUntilId(String untilId) {
        this.untilId = untilId;
        return this;
    }
    
    public GetKvPairsRequest(){}
}
