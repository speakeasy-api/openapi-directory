...
class PreviewOrderRatePlanOverride:
    ...
    charge_overrides: Optional[list[shared_previeworderchargeoverride.PreviewOrderChargeOverride]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('chargeOverrides'), 'exclude': lambda f: f is None }})
