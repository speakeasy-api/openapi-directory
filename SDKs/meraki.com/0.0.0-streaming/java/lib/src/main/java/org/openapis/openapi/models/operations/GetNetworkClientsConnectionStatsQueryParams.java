...
public class GetNetworkClientsConnectionStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkClientsConnectionStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkClientsConnectionStatsQueryParams withBand(GetNetworkClientsConnectionStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkClientsConnectionStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkClientsConnectionStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkClientsConnectionStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkClientsConnectionStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkClientsConnectionStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
