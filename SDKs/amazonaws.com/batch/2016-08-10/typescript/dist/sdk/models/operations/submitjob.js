...
exports.SubmitJobHeaders = SubmitJobHeaders;
...
var SubmitJobRequestBodyNodeOverrides = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nodePropertyOverrides", elemType: shared.NodePropertyOverride }),
        __metadata("design:type", Array)
...
var SubmitJobRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dependsOn", elemType: shared.JobDependency }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nodeOverrides" }),
