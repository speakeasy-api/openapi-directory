...
export class ReportWebinarDetailsPathParams extends SpeakeasyBase {
...
export class ReportWebinarDetails200ApplicationJson extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=custom_keys", elemType: ReportWebinarDetails200ApplicationJsonCustomKeys })
  ...
  @SpeakeasyMetadata({ data: "json, name=tracking_fields", elemType: ReportWebinarDetails200ApplicationJsonTrackingFields })
