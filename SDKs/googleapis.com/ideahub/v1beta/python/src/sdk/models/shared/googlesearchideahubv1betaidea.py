...
class GoogleSearchIdeahubV1betaIdea:
    ...
    r"""The idea’s text."""  
    topics: Optional[list[shared_googlesearchideahubv1betatopic.GoogleSearchIdeahubV1betaTopic]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topics'), 'exclude': lambda f: f is None }})
