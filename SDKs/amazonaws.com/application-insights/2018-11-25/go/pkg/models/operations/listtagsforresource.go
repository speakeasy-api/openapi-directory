...
const (
	ListTagsForResourceXAmzTargetEnumEc2WindowsBarleyServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "EC2WindowsBarleyService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "EC2WindowsBarleyService.ListTagsForResource":
