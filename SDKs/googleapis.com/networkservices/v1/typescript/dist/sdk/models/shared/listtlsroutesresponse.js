...
var ListTlsRoutesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: tlsroute_1.TlsRoute }),
        (0, class_transformer_1.Expose)({ name: "tlsRoutes" }),
        (0, class_transformer_1.Type)(function () { return tlsroute_1.TlsRoute; }),
