...
var AirtravelMultilegRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=apiKey_l1" }),
        __metadata("design:type", String)
    ], AirtravelMultilegRequest.prototype, "apiKeyL1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=apiKey_l2" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=leg1" }),
        __metadata("design:type", leg1_1.Leg1)
    ], AirtravelMultilegRequest.prototype, "leg1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=leg2" }),
        __metadata("design:type", leg1_1.Leg1)
    ], AirtravelMultilegRequest.prototype, "leg2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=leg3" }),
        __metadata("design:type", leg1_1.Leg1)
    ], AirtravelMultilegRequest.prototype, "leg3", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=legs_count" }),
        __metadata("design:type", String)
    ], AirtravelMultilegRequest.prototype, "legsCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=number_of_passengers" }),
        __metadata("design:type", String)
    ], AirtravelMultilegRequest.prototype, "numberOfPassengers", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=travel_mode" }),
        __metadata("design:type", String)
