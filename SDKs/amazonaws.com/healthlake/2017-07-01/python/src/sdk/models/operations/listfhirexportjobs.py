...
class ListFHIRExportJobsRequest:
    ...
    list_fhir_export_jobs_request: shared_listfhirexportjobsrequest.ListFHIRExportJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
