...
public class TargetVpnGateways {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeTargetVpnGatewaysTestIamPermissionsResponse computeTargetVpnGatewaysTestIamPermissions(org.openapis.openapi.models.operations.ComputeTargetVpnGatewaysTestIamPermissionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeTargetVpnGatewaysTestIamPermissionsPathParams.class, baseUrl, "/projects/{project}/regions/{region}/targetVpnGateways/{resource}/testIamPermissions", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeTargetVpnGatewaysTestIamPermissionsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
