...
import { OperationsScopedList } from "./operationsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum OperationAggregatedListWarningCodeEnum {
...
export declare class OperationAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class OperationAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: OperationAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: OperationAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class OperationAggregatedList extends SpeakeasyBase {
    /**
