...
class WithdrawPaymentRequest:
    ...
    r"""Id of the Payment"""  
    withdraw_payment_request: shared_withdrawpaymentrequest.WithdrawPaymentRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""details for withdrawal"""  
