...
exports.ConversionsGetStatisticsAllListResponse = exports.ConversionsGetStatisticsAllListRequest = exports.ConversionsGetStatisticsAllListTimeFrameEnum = exports.ConversionsGetStatisticsAllListStatusEnum = exports.ConversionsGetStatisticsAllListGroupByEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * The temporal entity you want to group by ("week"/"month"). If unspecified is "day".
 */
var ConversionsGetStatisticsAllListGroupByEnum;
...
})(ConversionsGetStatisticsAllListGroupByEnum = exports.ConversionsGetStatisticsAllListGroupByEnum || (exports.ConversionsGetStatisticsAllListGroupByEnum = {}));
/**
 * Status of conversion ("deleted"/"active")
 */
var ConversionsGetStatisticsAllListStatusEnum;
...
})(ConversionsGetStatisticsAllListStatusEnum = exports.ConversionsGetStatisticsAllListStatusEnum || (exports.ConversionsGetStatisticsAllListStatusEnum = {}));
/**
 * Timeframe of the request. See list at $timeframeList
 */
var ConversionsGetStatisticsAllListTimeFrameEnum;
...
})(ConversionsGetStatisticsAllListTimeFrameEnum = exports.ConversionsGetStatisticsAllListTimeFrameEnum || (exports.ConversionsGetStatisticsAllListTimeFrameEnum = {}));
var ConversionsGetStatisticsAllListRequest = /** @class */ (function (_super) {
    ...
    ], ConversionsGetStatisticsAllListRequest.prototype, "fromDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupBy",
        }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsAllListRequest.prototype, "groupBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsAllListRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeFrame",
        }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsAllListRequest.prototype, "timeFrame", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=toDay" }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsAllListRequest.prototype, "toDay", void 0);
    return ConversionsGetStatisticsAllListRequest;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetStatisticsAllListRequest = ConversionsGetStatisticsAllListRequest;
var ConversionsGetStatisticsAllListResponse = /** @class */ (function (_super) {
    ...
    ], ConversionsGetStatisticsAllListResponse.prototype, "rawResponse", void 0);
    return ConversionsGetStatisticsAllListResponse;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetStatisticsAllListResponse = ConversionsGetStatisticsAllListResponse;
