...
func (e GoogleChromeManagementV1NetworkStatusReportConnectionStateEnum) ToPointer() *GoogleChromeManagementV1NetworkStatusReportConnectionStateEnum {
	return &e
}
...
func (e *GoogleChromeManagementV1NetworkStatusReportConnectionStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "CONNECTING":
		fallthrough
	case "NOT_CONNECTED":
		*e = GoogleChromeManagementV1NetworkStatusReportConnectionStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleChromeManagementV1NetworkStatusReportConnectionStateEnum: %v", v)
	}
}
...
func (e GoogleChromeManagementV1NetworkStatusReportConnectionTypeEnum) ToPointer() *GoogleChromeManagementV1NetworkStatusReportConnectionTypeEnum {
	return &e
}
...
func (e *GoogleChromeManagementV1NetworkStatusReportConnectionTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "VPN":
		fallthrough
	case "WIFI":
		*e = GoogleChromeManagementV1NetworkStatusReportConnectionTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleChromeManagementV1NetworkStatusReportConnectionTypeEnum: %v", v)
	}
}
