...
export class CreateInternationalScheduledPaymentConsentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalScheduledPaymentConsentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalScheduledPaymentConsentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
