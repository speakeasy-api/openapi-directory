...
class JobSchedulePatchRequest:
    headers: JobSchedulePatchHeaders = dataclasses.field()
    path_params: JobSchedulePatchPathParams = dataclasses.field()
    query_params: JobSchedulePatchQueryParams = dataclasses.field()
