...
var Statements = /** @class */ (function () {
    ...
    **/
    Statements.prototype.getAccountsAccountIdStatements = function (req, config) {
    ...
    **/
    Statements.prototype.getAccountsAccountIdStatementsStatementId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Statements.prototype.getAccountsAccountIdStatementsStatementIdFile = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
