...
export class GoogleCloudRetailV2betaProductInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "collectionMemberIds" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2betaFulfillmentInfo })
  @Expose({ name: "fulfillmentInfo" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2betaImage })
  @Expose({ name: "images" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "primaryProductId" })
  primaryProductId?: string;

  /**
   * The promotions applied to the product. A maximum of 10 values are allowed per Product. Only Promotion.promotion_id will be used, other fields will be ignored if set.
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2betaPromotion })
...
export class GoogleCloudRetailV2betaProduct extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2betaLocalInventory })
