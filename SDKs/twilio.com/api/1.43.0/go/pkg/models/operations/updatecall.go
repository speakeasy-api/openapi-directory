...
func (e UpdateCallUpdateCallRequestFallbackMethodEnum) ToPointer() *UpdateCallUpdateCallRequestFallbackMethodEnum {
	return &e
}
...
func (e *UpdateCallUpdateCallRequestFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateCallUpdateCallRequestFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateCallUpdateCallRequestFallbackMethodEnum: %v", v)
	}
}
...
func (e UpdateCallUpdateCallRequestMethodEnum) ToPointer() *UpdateCallUpdateCallRequestMethodEnum {
	return &e
}
...
func (e *UpdateCallUpdateCallRequestMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateCallUpdateCallRequestMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateCallUpdateCallRequestMethodEnum: %v", v)
	}
}
...
func (e UpdateCallUpdateCallRequestStatusCallbackMethodEnum) ToPointer() *UpdateCallUpdateCallRequestStatusCallbackMethodEnum {
	return &e
}
...
func (e *UpdateCallUpdateCallRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateCallUpdateCallRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateCallUpdateCallRequestStatusCallbackMethodEnum: %v", v)
	}
}
