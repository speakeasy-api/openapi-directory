...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/googleapis.com/publicca/v1alpha1/python
```
...
* `publicca_projects_locations_external_account_keys_create` - Creates a new ExternalAccountKey bound to the project.
