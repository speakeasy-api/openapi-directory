...
class GetSnippetsWorkspaceEncodedIDFilesPathRequest:
    path_params: GetSnippetsWorkspaceEncodedIDFilesPathPathParams = dataclasses.field()
    security: GetSnippetsWorkspaceEncodedIDFilesPathSecurity = dataclasses.field()
