...
from ..shared import orderdetailwithindicatorvo as shared_orderdetailwithindicatorvo
...
class GetOrderResponse:
    ...
    order_detail_with_indicator_vo: Optional[shared_orderdetailwithindicatorvo.OrderDetailWithIndicatorVO] = dataclasses.field(default=None)
