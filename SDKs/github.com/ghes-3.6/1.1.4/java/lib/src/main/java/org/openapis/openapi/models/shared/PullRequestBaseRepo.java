...
public class PullRequestBaseRepo {
    ...
    public PullRequestBaseRepo withHasDiscussions(Boolean hasDiscussions) {
    ...
    public PullRequestBaseRepo withWebCommitSignoffRequired(Boolean webCommitSignoffRequired) {
