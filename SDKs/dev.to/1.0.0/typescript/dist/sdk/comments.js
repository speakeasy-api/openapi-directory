...
var Comments = /** @class */ (function () {
     ...
     */
    Comments.prototype.getCommentById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCommentByIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/api/comments/{id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetCommentByIdResponse({
     ...
     */
    Comments.prototype.getCommentsByArticleId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCommentsByArticleIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/comments";
        var client = this._securityClient || this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetCommentsByArticleIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
