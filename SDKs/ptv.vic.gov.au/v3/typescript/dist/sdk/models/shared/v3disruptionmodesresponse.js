...
var V3DisruptionModesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: v3disruptionmode_1.V3DisruptionMode }),
        (0, class_transformer_1.Expose)({ name: "disruption_modes" }),
        (0, class_transformer_1.Type)(function () { return v3disruptionmode_1.V3DisruptionMode; }),
