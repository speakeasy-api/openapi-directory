...
func (e GetDeploymentTargetXAmzTargetEnum) ToPointer() *GetDeploymentTargetXAmzTargetEnum {
	return &e
}
...
func (e *GetDeploymentTargetXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeDeploy_20141006.GetDeploymentTarget":
		*e = GetDeploymentTargetXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeploymentTargetXAmzTargetEnum: %v", v)
	}
}
