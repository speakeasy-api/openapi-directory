...
public class WorkTypeApiDeleteFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiDeleteFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiDeleteFormHeaders withXAuthSecret(String xAuthSecret) {
