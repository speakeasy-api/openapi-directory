...
class CreateFundsConfirmationConsentsRequest:
    ...
    ob_funds_confirmation_consent1: shared_obfundsconfirmationconsent1.OBFundsConfirmationConsent1 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Default"""  
