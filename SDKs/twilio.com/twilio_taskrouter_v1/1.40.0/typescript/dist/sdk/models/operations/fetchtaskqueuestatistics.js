...
exports.FetchTaskQueueStatisticsResponse = exports.FetchTaskQueueStatisticsRequest = exports.FetchTaskQueueStatisticsSecurity = exports.FetchTaskQueueStatisticsServerList = void 0;
...
var FetchTaskQueueStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchTaskQueueStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueStatisticsSecurity.prototype, "username", void 0);
...
var FetchTaskQueueStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchTaskQueueStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchTaskQueueStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SplitByWaitTime",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueStatisticsRequest.prototype, "splitByWaitTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchTaskQueueStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TaskQueueSid",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueStatisticsRequest.prototype, "taskQueueSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchTaskQueueStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchTaskQueueStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchTaskQueueStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
