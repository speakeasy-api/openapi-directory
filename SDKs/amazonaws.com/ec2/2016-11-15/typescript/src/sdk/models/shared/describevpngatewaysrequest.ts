 ...
 */
export class DescribeVpnGatewaysRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export class DescribeVpnGatewaysRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeVpnGatewaysRequestFilters })
