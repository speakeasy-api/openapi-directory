...
func (s *SDK) CreateCertificateAuthority(ctx context.Context, request operations.CreateCertificateAuthorityRequest) (*operations.CreateCertificateAuthorityResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthority"
	...
	res := &operations.CreateCertificateAuthorityResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CreateCertificateAuthorityResponse
...
func (s *SDK) CreateCertificateAuthorityAuditReport(ctx context.Context, request operations.CreateCertificateAuthorityAuditReportRequest) (*operations.CreateCertificateAuthorityAuditReportResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.CreateCertificateAuthorityAuditReport"
	...
	res := &operations.CreateCertificateAuthorityAuditReportResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CreateCertificateAuthorityAuditReportResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) CreatePermission(ctx context.Context, request operations.CreatePermissionRequest) (*operations.CreatePermissionResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.CreatePermission"
...
func (s *SDK) DeleteCertificateAuthority(ctx context.Context, request operations.DeleteCertificateAuthorityRequest) (*operations.DeleteCertificateAuthorityResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.DeleteCertificateAuthority"
	...
	res := &operations.DeleteCertificateAuthorityResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) DeletePermission(ctx context.Context, request operations.DeletePermissionRequest) (*operations.DeletePermissionResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.DeletePermission"
...
func (s *SDK) DeletePolicy(ctx context.Context, request operations.DeletePolicyRequest) (*operations.DeletePolicyResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.DeletePolicy"
...
func (s *SDK) DescribeCertificateAuthority(ctx context.Context, request operations.DescribeCertificateAuthorityRequest) (*operations.DescribeCertificateAuthorityResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthority"
	...
	res := &operations.DescribeCertificateAuthorityResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeCertificateAuthorityResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) DescribeCertificateAuthorityAuditReport(ctx context.Context, request operations.DescribeCertificateAuthorityAuditReportRequest) (*operations.DescribeCertificateAuthorityAuditReportResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.DescribeCertificateAuthorityAuditReport"
	...
	res := &operations.DescribeCertificateAuthorityAuditReportResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.DescribeCertificateAuthorityAuditReportResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetCertificate(ctx context.Context, request operations.GetCertificateRequest) (*operations.GetCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.GetCertificate"
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetCertificateResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetCertificateAuthorityCertificate(ctx context.Context, request operations.GetCertificateAuthorityCertificateRequest) (*operations.GetCertificateAuthorityCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCertificate"
	...
	res := &operations.GetCertificateAuthorityCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetCertificateAuthorityCertificateResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetCertificateAuthorityCsr(ctx context.Context, request operations.GetCertificateAuthorityCsrRequest) (*operations.GetCertificateAuthorityCsrResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.GetCertificateAuthorityCsr"
	...
	res := &operations.GetCertificateAuthorityCsrResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.GetCertificateAuthorityCsrResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) GetPolicy(ctx context.Context, request operations.GetPolicyRequest) (*operations.GetPolicyResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.GetPolicy"
...
func (s *SDK) ImportCertificateAuthorityCertificate(ctx context.Context, request operations.ImportCertificateAuthorityCertificateRequest) (*operations.ImportCertificateAuthorityCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.ImportCertificateAuthorityCertificate"
	...
	res := &operations.ImportCertificateAuthorityCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) IssueCertificate(ctx context.Context, request operations.IssueCertificateRequest) (*operations.IssueCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.IssueCertificate"
	...
	res := &operations.IssueCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.IssueCertificateResponse
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *SDK) ListCertificateAuthorities(ctx context.Context, request operations.ListCertificateAuthoritiesRequest) (*operations.ListCertificateAuthoritiesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.ListCertificateAuthorities"
	...
	res := &operations.ListCertificateAuthoritiesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) ListPermissions(ctx context.Context, request operations.ListPermissionsRequest) (*operations.ListPermissionsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.ListPermissions"
...
func (s *SDK) ListTags(ctx context.Context, request operations.ListTagsRequest) (*operations.ListTagsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.ListTags"
...
func (s *SDK) PutPolicy(ctx context.Context, request operations.PutPolicyRequest) (*operations.PutPolicyResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.PutPolicy"
...
func (s *SDK) RestoreCertificateAuthority(ctx context.Context, request operations.RestoreCertificateAuthorityRequest) (*operations.RestoreCertificateAuthorityResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.RestoreCertificateAuthority"
	...
	res := &operations.RestoreCertificateAuthorityResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) RevokeCertificate(ctx context.Context, request operations.RevokeCertificateRequest) (*operations.RevokeCertificateResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.RevokeCertificate"
	...
	res := &operations.RevokeCertificateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) TagCertificateAuthority(ctx context.Context, request operations.TagCertificateAuthorityRequest) (*operations.TagCertificateAuthorityResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.TagCertificateAuthority"
	...
	res := &operations.TagCertificateAuthorityResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) UntagCertificateAuthority(ctx context.Context, request operations.UntagCertificateAuthorityRequest) (*operations.UntagCertificateAuthorityResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.UntagCertificateAuthority"
	...
	res := &operations.UntagCertificateAuthorityResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) UpdateCertificateAuthority(ctx context.Context, request operations.UpdateCertificateAuthorityRequest) (*operations.UpdateCertificateAuthorityResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/#X-Amz-Target=ACMPrivateCA.UpdateCertificateAuthority"
	...
	res := &operations.UpdateCertificateAuthorityResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
