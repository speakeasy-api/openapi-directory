...
class CreatePolicyRequestBody:
    ...
    r"""The JSON document that describes the policy. <b>policyDocument</b> must have a minimum length of 1, with a maximum length of 2048, excluding whitespace."""  
...
class CreatePolicyRequest:
    ...
    r"""The policy name."""  
    request_body: CreatePolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
