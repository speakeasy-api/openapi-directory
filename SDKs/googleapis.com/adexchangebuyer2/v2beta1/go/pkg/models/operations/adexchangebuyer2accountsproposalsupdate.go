...
type Adexchangebuyer2AccountsProposalsUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type Adexchangebuyer2AccountsProposalsUpdatePathParams struct {
...
type Adexchangebuyer2AccountsProposalsUpdateQueryParams struct {
	// V1 error format.
...
type Adexchangebuyer2AccountsProposalsUpdateResponse struct {
	ContentType string
	// Successful response
