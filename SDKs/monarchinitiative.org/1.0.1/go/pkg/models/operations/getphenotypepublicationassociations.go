...
type GetPhenotypePublicationAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetPhenotypePublicationAssociationsQueryParams struct {
