...
use \OpenAPI\OpenAPI\Models\Shared\EndpointEventBus;
use \OpenAPI\OpenAPI\Models\Shared\ReplicationConfig;
use \OpenAPI\OpenAPI\Models\Shared\ReplicationStateEnum;
use \OpenAPI\OpenAPI\Models\Shared\RoutingConfig;
use \OpenAPI\OpenAPI\Models\Shared\FailoverConfig;
use \OpenAPI\OpenAPI\Models\Shared\Primary;
use \OpenAPI\OpenAPI\Models\Shared\Secondary;
...
try {
    ...
    $request->createEndpointRequest->description = 'explicabo';
    $request->createEndpointRequest->eventBuses = [
        new EndpointEventBus(),
        new EndpointEventBus(),
        new EndpointEventBus(),
        new EndpointEventBus(),
    ];
    $request->createEndpointRequest->name = 'Guadalupe Hickle';
    $request->createEndpointRequest->replicationConfig = new ReplicationConfig();
    $request->createEndpointRequest->replicationConfig->state = ReplicationStateEnum::ENABLED;
    $request->createEndpointRequest->roleArn = 'iure';
    $request->createEndpointRequest->routingConfig = new RoutingConfig();
    $request->createEndpointRequest->routingConfig->failoverConfig = new FailoverConfig();
    $request->createEndpointRequest->routingConfig->failoverConfig->primary = new Primary();
    $request->createEndpointRequest->routingConfig->failoverConfig->primary->healthCheck = 'culpa';
    $request->createEndpointRequest->routingConfig->failoverConfig->secondary = new Secondary();
    $request->createEndpointRequest->routingConfig->failoverConfig->secondary->route = 'doloribus';
    ...
    $request->xAmzTarget = CreateEndpointXAmzTargetEnum::AWS_EVENTS_CREATE_ENDPOINT;
...
try {
    ...
    $request->createEventBusRequest->eventSourceName = 'mollitia';
    $request->createEventBusRequest->name = 'Francis Jerde';
...
try {
    ...
    $request->createPartnerEventSourceRequest->account = 'odit';
    $request->createPartnerEventSourceRequest->name = 'Jimmy Wiegand';
...
try {
    ...
    $request->deactivateEventSourceRequest->name = 'Jan Thiel';
...
try {
    ...
    $request->deauthorizeConnectionRequest->name = 'Mrs. April Wuckert';
...
try {
    ...
    $request->deleteApiDestinationRequest->name = 'Edna Pouros';
...
try {
    ...
    $request->deleteArchiveRequest->archiveName = 'sint';
...
try {
    ...
    $request->deleteConnectionRequest->name = 'Joanna Rau';
...
try {
    ...
    $request->deleteEndpointRequest->name = 'Vernon Abshire';
    ...
    $request->xAmzTarget = DeleteEndpointXAmzTargetEnum::AWS_EVENTS_DELETE_ENDPOINT;
...
try {
    ...
    $request->deleteEventBusRequest->name = 'Sheri Mayer';
...
try {
    ...
    $request->deletePartnerEventSourceRequest->account = 'in';
    $request->deletePartnerEventSourceRequest->name = 'Angel Wolff II';
...
try {
    ...
    $request->deleteRuleRequest->eventBusName = 'occaecati';
    $request->deleteRuleRequest->force = false;
    $request->deleteRuleRequest->name = 'Sophia Wintheiser';
...
try {
    ...
    $request->describeApiDestinationRequest->name = 'Wilma Mosciski';
...
try {
    ...
    $request->describeArchiveRequest->archiveName = 'suscipit';
...
try {
    ...
    $request->describeConnectionRequest->name = 'Miriam Hermann';
...
try {
    ...
    $request->describeEndpointRequest->homeRegion = 'dolor';
    $request->describeEndpointRequest->name = 'Ms. Fred Hilll';
    ...
    $request->xAmzTarget = DescribeEndpointXAmzTargetEnum::AWS_EVENTS_DESCRIBE_ENDPOINT;
...
try {
    ...
    $request->describeEventBusRequest->name = 'Elvira Herman';
...
try {
    ...
    $request->describeEventSourceRequest->name = 'Miss Nick Cummerata';
    $request->xAmzAlgorithm = 'pariatur';
...
try {
    ...
    $request->describePartnerEventSourceRequest->name = 'Ebony Predovic';
...
try {
    ...
    $request->describeReplayRequest->replayName = 'fugiat';
...
try {
    ...
    $request->describeRuleRequest->eventBusName = 'dolores';
    $request->describeRuleRequest->name = 'Mrs. Deanna Kuhn';
...
try {
    ...
    $request->disableRuleRequest->eventBusName = 'nostrum';
    $request->disableRuleRequest->name = 'Percy Mohr';
...
try {
    ...
    $request->enableRuleRequest->eventBusName = 'rerum';
    $request->enableRuleRequest->name = 'Ollie Watsica';
...
try {
    ...
    $request->listApiDestinationsRequest->connectionArn = 'quaerat';
    $request->listApiDestinationsRequest->limit = 554242;
    $request->listApiDestinationsRequest->namePrefix = 'aliquid';
    $request->listApiDestinationsRequest->nextToken = 'dolorem';
...
try {
    ...
    $request->listArchivesRequest->eventSourceArn = 'voluptate';
    $request->listArchivesRequest->limit = 490459;
    $request->listArchivesRequest->namePrefix = 'reiciendis';
    $request->listArchivesRequest->nextToken = 'amet';
    $request->listArchivesRequest->state = ArchiveStateEnum::CREATE_FAILED;
...
try {
    ...
    $request->listConnectionsRequest->connectionState = ConnectionStateEnum::DEAUTHORIZING;
    $request->listConnectionsRequest->limit = 696344;
    $request->listConnectionsRequest->namePrefix = 'voluptatibus';
    $request->listConnectionsRequest->nextToken = 'voluptas';
    $request->xAmzAlgorithm = 'natus';
...
try {
    ...
    $request->listEndpointsRequest->homeRegion = 'dolorum';
    $request->listEndpointsRequest->maxResults = 478596;
    $request->listEndpointsRequest->namePrefix = 'voluptate';
    $request->listEndpointsRequest->nextToken = 'dolorum';
    ...
    $request->xAmzTarget = ListEndpointsXAmzTargetEnum::AWS_EVENTS_LIST_ENDPOINTS;
...
try {
    ...
    $request->listEventBusesRequest->limit = 456015;
    $request->listEventBusesRequest->namePrefix = 'id';
    $request->listEventBusesRequest->nextToken = 'saepe';
...
try {
    ...
    $request->listEventSourcesRequest->limit = 904425;
    $request->listEventSourcesRequest->namePrefix = 'suscipit';
    $request->listEventSourcesRequest->nextToken = 'deserunt';
...
try {
    ...
    $request->listPartnerEventSourceAccountsRequest->eventSourceName = 'quaerat';
    $request->listPartnerEventSourceAccountsRequest->limit = 273542;
    $request->listPartnerEventSourceAccountsRequest->nextToken = 'vel';
    $request->xAmzAlgorithm = 'quod';
...
try {
    ...
    $request->listPartnerEventSourcesRequest->limit = 483409;
    $request->listPartnerEventSourcesRequest->namePrefix = 'ipsum';
    $request->listPartnerEventSourcesRequest->nextToken = 'quisquam';
...
try {
    ...
    $request->listReplaysRequest->eventSourceArn = 'sapiente';
    $request->listReplaysRequest->limit = 518201;
    $request->listReplaysRequest->namePrefix = 'nihil';
    $request->listReplaysRequest->nextToken = 'sit';
    $request->listReplaysRequest->state = ReplayStateEnum::CANCELLED;
...
try {
    ...
    $request->listRuleNamesByTargetRequest->eventBusName = 'ipsum';
    $request->listRuleNamesByTargetRequest->limit = 277628;
    $request->listRuleNamesByTargetRequest->nextToken = 'qui';
    $request->listRuleNamesByTargetRequest->targetArn = 'cupiditate';
...
try {
    ...
    $request->listRulesRequest->eventBusName = 'aspernatur';
    $request->listRulesRequest->limit = 174909;
    $request->listRulesRequest->namePrefix = 'distinctio';
    $request->listRulesRequest->nextToken = 'facilis';
...
try {
    ...
    $request->listTagsForResourceRequest->resourceARN = 'magni';
...
try {
    ...
    $request->listTargetsByRuleRequest->eventBusName = 'soluta';
    $request->listTargetsByRuleRequest->limit = 748664;
    $request->listTargetsByRuleRequest->nextToken = 'et';
    $request->listTargetsByRuleRequest->rule = 'saepe';
...
try {
    ...
    $request->putEventsRequest->endpointId = 'delectus';
...
try {
    ...
    $request->putPermissionRequest->action = 'facilis';
    $request->putPermissionRequest->condition = new Condition();
    $request->putPermissionRequest->condition->key = 'cupiditate';
    $request->putPermissionRequest->condition->type = 'qui';
    $request->putPermissionRequest->condition->value = 'quae';
    $request->putPermissionRequest->eventBusName = 'laudantium';
    $request->putPermissionRequest->policy = 'odio';
    $request->putPermissionRequest->principal = 'occaecati';
    $request->putPermissionRequest->statementId = 'voluptatibus';
...
try {
    ...
    $request->putRuleRequest->description = 'consectetur';
    $request->putRuleRequest->eventBusName = 'vero';
    $request->putRuleRequest->eventPattern = 'tenetur';
    $request->putRuleRequest->name = 'Darla Rau';
    $request->putRuleRequest->roleArn = 'similique';
    $request->putRuleRequest->scheduleExpression = 'facilis';
...
try {
    ...
    $request->putTargetsRequest->eventBusName = 'voluptatibus';
    $request->putTargetsRequest->rule = 'exercitationem';
...
try {
    ...
    $request->removePermissionRequest->eventBusName = 'alias';
    $request->removePermissionRequest->removeAllPermissions = false;
    $request->removePermissionRequest->statementId = 'officia';
...
try {
    ...
    $request->removeTargetsRequest->eventBusName = 'ratione';
    $request->removeTargetsRequest->force = false;
    $request->removeTargetsRequest->ids = [
        'laudantium',
        'dicta',
    ];
    $request->removeTargetsRequest->rule = 'dolor';
...
try {
    ...
    $request->startReplayRequest->description = 'sapiente';
    $request->startReplayRequest->destination = new ReplayDestination();
    $request->startReplayRequest->destination->arn = 'quisquam';
    ...
    $request->startReplayRequest->eventEndTime = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-12-02T09:33:05.571Z');
    $request->startReplayRequest->eventSourceArn = 'magnam';
    $request->startReplayRequest->eventStartTime = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-24T01:04:28.722Z');
    $request->startReplayRequest->replayName = 'consectetur';
    $request->xAmzAlgorithm = 'recusandae';
    $request->xAmzContentSha256 = 'aspernatur';
...
try {
    ...
    $request->tagResourceRequest->resourceARN = 'aut';
...
try {
    ...
    $request->testEventPatternRequest->event = 'dolorum';
    $request->testEventPatternRequest->eventPattern = 'laborum';
...
try {
    ...
    $request->untagResourceRequest->resourceARN = 'nulla';
...
try {
    ...
    $request->updateApiDestinationRequest->connectionArn = 'odio';
    $request->updateApiDestinationRequest->description = 'eius';
    $request->updateApiDestinationRequest->httpMethod = ApiDestinationHttpMethodEnum::OPTIONS;
    $request->updateApiDestinationRequest->invocationEndpoint = 'esse';
    $request->updateApiDestinationRequest->invocationRateLimitPerSecond = 524593;
    $request->updateApiDestinationRequest->name = 'Mitchell Predovic';
...
try {
    ...
    $request->updateArchiveRequest->archiveName = 'ipsa';
    $request->updateArchiveRequest->description = 'id';
    $request->updateArchiveRequest->eventPattern = 'quidem';
    $request->updateArchiveRequest->retentionDays = 206594;
...
try {
    ...
    $request->updateConnectionRequest->authParameters->apiKeyAuthParameters->apiKeyName = 'ab';
    $request->updateConnectionRequest->authParameters->apiKeyAuthParameters->apiKeyValue = 'cupiditate';
    $request->updateConnectionRequest->authParameters->basicAuthParameters = new UpdateConnectionBasicAuthRequestParameters();
    $request->updateConnectionRequest->authParameters->basicAuthParameters->password = 'consequatur';
    $request->updateConnectionRequest->authParameters->basicAuthParameters->username = 'Donny.Toy';
    ...
    $request->updateConnectionRequest->authParameters->oAuthParameters->authorizationEndpoint = 'recusandae';
    ...
    $request->updateConnectionRequest->authParameters->oAuthParameters->clientParameters->clientID = 'aperiam';
    $request->updateConnectionRequest->authParameters->oAuthParameters->clientParameters->clientSecret = 'distinctio';
    $request->updateConnectionRequest->authParameters->oAuthParameters->httpMethod = ConnectionOAuthHttpMethodEnum::PUT;
    ...
    $request->updateConnectionRequest->authorizationType = ConnectionAuthorizationTypeEnum::OAUTH_CLIENT_CREDENTIALS;
    $request->updateConnectionRequest->description = 'accusamus';
    $request->updateConnectionRequest->name = 'Courtney Mayert';
...
try {
    ...
    $request->updateEndpointRequest->description = 'praesentium';
    $request->updateEndpointRequest->eventBuses = [
        new EndpointEventBus(),
    ];
    $request->updateEndpointRequest->name = 'Wayne Parker';
    $request->updateEndpointRequest->replicationConfig = new ReplicationConfig();
    $request->updateEndpointRequest->replicationConfig->state = ReplicationStateEnum::DISABLED;
    $request->updateEndpointRequest->roleArn = 'explicabo';
    $request->updateEndpointRequest->routingConfig = new RoutingConfig();
    $request->updateEndpointRequest->routingConfig->failoverConfig = new FailoverConfig();
    $request->updateEndpointRequest->routingConfig->failoverConfig->primary = new Primary();
    $request->updateEndpointRequest->routingConfig->failoverConfig->primary->healthCheck = 'minima';
    $request->updateEndpointRequest->routingConfig->failoverConfig->secondary = new Secondary();
    $request->updateEndpointRequest->routingConfig->failoverConfig->secondary->route = 'nisi';
    $request->xAmzAlgorithm = 'fugit';
    ...
    $request->xAmzSignedHeaders = 'occaecati';
    $request->xAmzTarget = UpdateEndpointXAmzTargetEnum::AWS_EVENTS_UPDATE_ENDPOINT;
