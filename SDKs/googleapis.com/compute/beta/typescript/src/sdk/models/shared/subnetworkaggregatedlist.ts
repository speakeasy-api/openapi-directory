 ...
 */
export enum SubnetworkAggregatedListWarningCodeEnum {
...
export class SubnetworkAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class SubnetworkAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: SubnetworkAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class SubnetworkAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: SubnetworksScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, SubnetworksScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], SubnetworksScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
