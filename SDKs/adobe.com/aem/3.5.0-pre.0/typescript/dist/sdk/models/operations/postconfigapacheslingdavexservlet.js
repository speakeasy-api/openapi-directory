...
exports.PostConfigApacheSlingDavExServletResponse = exports.PostConfigApacheSlingDavExServletRequest = exports.PostConfigApacheSlingDavExServletQueryParams = void 0;
...
var PostConfigApacheSlingDavExServletQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alias@TypeHint" }),
        __metadata("design:type", String)
    ], PostConfigApacheSlingDavExServletQueryParams.prototype, "aliasAtTypeHint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=dav.create-absolute-uri" }),
        __metadata("design:type", Boolean)
    ], PostConfigApacheSlingDavExServletQueryParams.prototype, "davCreateAbsoluteUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=dav.create-absolute-uri@TypeHint" }),
        __metadata("design:type", String)
...
exports.PostConfigApacheSlingDavExServletQueryParams = PostConfigApacheSlingDavExServletQueryParams;
