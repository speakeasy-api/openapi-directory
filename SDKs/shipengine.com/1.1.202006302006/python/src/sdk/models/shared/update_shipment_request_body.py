...
class UpdateShipmentRequestBodyInternationalShipmentOptionsInput:
    r"""UpdateShipmentRequestBodyInternationalShipmentOptionsInput
...
class UpdateShipmentRequestBodyInput:
    r"""UpdateShipmentRequestBodyInput
    ...
    customs: Optional[UpdateShipmentRequestBodyInternationalShipmentOptionsInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('customs') }})
