...
export declare class BackendBuckets {
     ...
     */
    computeBackendBucketsGetIamPolicy(req: operations.ComputeBackendBucketsGetIamPolicyRequest, security: operations.ComputeBackendBucketsGetIamPolicySecurity, config?: AxiosRequestConfig): Promise<operations.ComputeBackendBucketsGetIamPolicyResponse>;
    /**
     ...
     */
    computeBackendBucketsSetIamPolicy(req: operations.ComputeBackendBucketsSetIamPolicyRequest, security: operations.ComputeBackendBucketsSetIamPolicySecurity, config?: AxiosRequestConfig): Promise<operations.ComputeBackendBucketsSetIamPolicyResponse>;
    /**
     * Returns permissions that a caller has on the specified resource.
     */
    computeBackendBucketsTestIamPermissions(req: operations.ComputeBackendBucketsTestIamPermissionsRequest, security: operations.ComputeBackendBucketsTestIamPermissionsSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeBackendBucketsTestIamPermissionsResponse>;
    /**
