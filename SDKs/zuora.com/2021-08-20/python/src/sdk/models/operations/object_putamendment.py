...
class ObjectPutAmendmentPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutAmendmentQueryParams:
...
@dataclasses.dataclass
class ObjectPutAmendmentHeaders:
...
class ObjectPutAmendmentRequest:
    headers: ObjectPutAmendmentHeaders = dataclasses.field()
    path_params: ObjectPutAmendmentPathParams = dataclasses.field()
    query_params: ObjectPutAmendmentQueryParams = dataclasses.field()
