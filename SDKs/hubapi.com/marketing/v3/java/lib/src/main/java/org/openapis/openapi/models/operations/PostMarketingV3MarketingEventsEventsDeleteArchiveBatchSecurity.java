...
public class PostMarketingV3MarketingEventsEventsDeleteArchiveBatchSecurity {
    ...
    public PostMarketingV3MarketingEventsEventsDeleteArchiveBatchSecurity withOauth2Legacy(String oauth2Legacy) {
    ...
    public PostMarketingV3MarketingEventsEventsDeleteArchiveBatchSecurity withPrivateAppsLegacy(String privateAppsLegacy) {
        this.privateAppsLegacy = privateAppsLegacy;
        return this;
    }
    
    public PostMarketingV3MarketingEventsEventsDeleteArchiveBatchSecurity(){}
}
