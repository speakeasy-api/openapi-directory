...
from ..shared import untagresourceoutput as shared_untagresourceoutput
...
class UntagResourceResponse:
    ...
    untag_resource_output: Optional[shared_untagresourceoutput.UntagResourceOutput] = dataclasses.field(default=None)
    r"""Success"""  
