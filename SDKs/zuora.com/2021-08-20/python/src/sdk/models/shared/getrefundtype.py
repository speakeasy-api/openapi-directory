...
class GETRefundTypeFinanceInformationTransferredToAccountingEnum(str, Enum):
...
class GETRefundTypeFinanceInformation:
    ...
    transferred_to_accounting: Optional[GETRefundTypeFinanceInformationTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the refund was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite."""  
...
class GETRefundTypeGatewayStateEnum(str, Enum):
...
class GETRefundTypeMethodTypeEnum(str, Enum):
...
class GETRefundTypeStatusEnum(str, Enum):
...
class GETRefundTypeTypeEnum(str, Enum):
...
class GETRefundType:
    ...
    finance_information: Optional[GETRefundTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the refund."""  
    ...
    gateway_state: Optional[GETRefundTypeGatewayStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gatewayState'), 'exclude': lambda f: f is None }})
    r"""The status of the refund in the gateway."""  
    ...
    method_type: Optional[GETRefundTypeMethodTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('methodType'), 'exclude': lambda f: f is None }})
    r"""How an external refund was issued to a customer."""  
    ...
    r"""A payment gateway-specific field that maps Zuora to other gateways."""  
    status: Optional[GETRefundTypeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the refund."""  
    ...
    type: Optional[GETRefundTypeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the refund."""  
