...
class PutRepositoriesWorkspaceRepoSlugDeployKeysKeyIDRequest:
    path_params: PutRepositoriesWorkspaceRepoSlugDeployKeysKeyIDPathParams = dataclasses.field()
    security: PutRepositoriesWorkspaceRepoSlugDeployKeysKeyIDSecurity = dataclasses.field()
