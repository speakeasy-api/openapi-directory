...
func (e GetNetworkFirmwareUpgradesStagedEvents200ApplicationJSONReasonsCategoryEnum) ToPointer() *GetNetworkFirmwareUpgradesStagedEvents200ApplicationJSONReasonsCategoryEnum {
	return &e
}
...
func (e *GetNetworkFirmwareUpgradesStagedEvents200ApplicationJSONReasonsCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "unifying networks versions":
		*e = GetNetworkFirmwareUpgradesStagedEvents200ApplicationJSONReasonsCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkFirmwareUpgradesStagedEvents200ApplicationJSONReasonsCategoryEnum: %v", v)
	}
}
