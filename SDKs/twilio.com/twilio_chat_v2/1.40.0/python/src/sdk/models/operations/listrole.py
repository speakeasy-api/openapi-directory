...
class ListRoleRequest:
    ...
    r"""The SID of the [Service](https://www.twilio.com/docs/chat/rest/service-resource) to read the Role resources from."""  
...
class ListRoleListRoleResponse:
    ...
    roles: Optional[list[shared_chat_v2_service_role.ChatV2ServiceRole]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('roles'), 'exclude': lambda f: f is None }})  
