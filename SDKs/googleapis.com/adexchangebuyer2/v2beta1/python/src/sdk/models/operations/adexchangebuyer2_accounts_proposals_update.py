...
class Adexchangebuyer2AccountsProposalsUpdateRequest:
    path_params: Adexchangebuyer2AccountsProposalsUpdatePathParams = dataclasses.field()
    query_params: Adexchangebuyer2AccountsProposalsUpdateQueryParams = dataclasses.field()
    security: Adexchangebuyer2AccountsProposalsUpdateSecurity = dataclasses.field()
