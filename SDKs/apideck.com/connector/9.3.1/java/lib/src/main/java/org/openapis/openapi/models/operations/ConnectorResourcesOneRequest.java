...
public class ConnectorResourcesOneRequest {
    ...
    public ConnectorResourcesOneRequest(@JsonProperty("id") String id, @JsonProperty("resource_id") String resourceId, @JsonProperty("x-apideck-app-id") String xApideckAppId) {
        this.id = id;
        this.resourceId = resourceId;
        this.xApideckAppId = xApideckAppId;
  }
