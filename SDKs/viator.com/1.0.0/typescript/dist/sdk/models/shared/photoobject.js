...
var PhotoObject = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=editorsPick" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=photoHiResURL" }),
        __metadata("design:type", String)
    ], PhotoObject.prototype, "photoHiResURL", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=photoId" }),
        __metadata("design:type", Number)
    ], PhotoObject.prototype, "photoId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=photoMediumResURL" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeUploaded" }),
        __metadata("design:type", String)
