...
class CloudassetProjectsExportAssetsRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ExportAssetsRequest $exportAssetsRequest = null;
