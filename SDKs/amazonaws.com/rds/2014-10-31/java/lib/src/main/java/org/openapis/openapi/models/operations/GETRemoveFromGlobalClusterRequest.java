...
public class GETRemoveFromGlobalClusterRequest {
    ...
    public GETRemoveFromGlobalClusterRequest(@JsonProperty("Action") GETRemoveFromGlobalClusterActionEnum action, @JsonProperty("Version") GETRemoveFromGlobalClusterVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
