...
import dataclasses
from ..shared import transitgatewayconnectrequestbgpoptions as shared_transitgatewayconnectrequestbgpoptions
from enum import Enum
from typing import Optional

class CreateTransitGatewayConnectPeerRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateTransitGatewayConnectPeerRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateTransitGatewayConnectPeerRequestTagSpecifications:
    ...
    resource_type: Optional[CreateTransitGatewayConnectPeerRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateTransitGatewayConnectPeerRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateTransitGatewayConnectPeerRequest:
    
    inside_cidr_blocks: list[str] = dataclasses.field()  
    peer_address: str = dataclasses.field()  
    transit_gateway_attachment_id: str = dataclasses.field()  
    bgp_options: Optional[shared_transitgatewayconnectrequestbgpoptions.TransitGatewayConnectRequestBgpOptions] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateTransitGatewayConnectPeerRequestTagSpecifications]] = dataclasses.field(default=None)  
