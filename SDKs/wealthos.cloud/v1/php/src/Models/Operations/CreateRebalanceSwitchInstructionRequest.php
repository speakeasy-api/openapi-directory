...
class CreateRebalanceSwitchInstructionRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\CreateRebalanceSwitchInstructionRequestTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\CreateRebalanceSwitchInstructionRequestTypeEnum>')]
	...
	{
		$this->requestId = "";
		$this->type = \OpenAPI\OpenAPI\Models\Operations\CreateRebalanceSwitchInstructionRequestTypeEnum::POT;
		$this->values = [];
	}
}
