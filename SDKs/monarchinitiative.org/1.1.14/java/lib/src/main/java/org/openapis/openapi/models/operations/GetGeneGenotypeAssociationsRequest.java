...
public class GetGeneGenotypeAssociationsRequest {
    ...
    public GetGeneGenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGeneGenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneGenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneGenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneGenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneGenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetGeneGenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGeneGenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneGenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneGenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
