...
export class GetGenePathwayAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenePathwayAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenePathwayAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenePathwayAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
