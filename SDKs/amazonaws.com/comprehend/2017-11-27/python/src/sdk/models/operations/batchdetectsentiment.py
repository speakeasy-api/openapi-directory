...
class BatchDetectSentimentRequest:
    ...
    batch_detect_sentiment_request: shared_batchdetectsentimentrequest.BatchDetectSentimentRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
