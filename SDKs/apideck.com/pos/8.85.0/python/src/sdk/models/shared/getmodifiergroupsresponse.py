...
from ..shared import modifiergroup as shared_modifiergroup
...
class GetModifierGroupsResponse:
    data: list[shared_modifiergroup.ModifierGroup] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
