...
class UpdateCustomFieldRequestBodyInput:
    r"""The custom field object with all updated properties."""
...
class UpdateCustomFieldRequest:
    ...
    """  
    request_body: Optional[UpdateCustomFieldRequestBodyInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""The custom field object with all updated properties."""  
...
class UpdateCustomField200ApplicationJSON:
    r"""The custom field was successfully updated."""
