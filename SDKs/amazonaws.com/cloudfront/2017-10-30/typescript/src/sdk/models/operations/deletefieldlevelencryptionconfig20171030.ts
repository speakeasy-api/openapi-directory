...
export class DeleteFieldLevelEncryptionConfig20171030Request extends SpeakeasyBase {
  /**
...
export class DeleteFieldLevelEncryptionConfig20171030Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
