...
class DriveFilesUpdateRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DriveFilesUpdateModifiedDateBehaviorEnum $modifiedDateBehavior
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=modifiedDateBehavior')]
    public ?DriveFilesUpdateModifiedDateBehaviorEnum $modifiedDateBehavior = null;
