...
export class AdsenseAccountsAdclientsAdunitsListLinkedCustomChannelsSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdsenseAccountsAdclientsAdunitsListLinkedCustomChannelsSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AdsenseAccountsAdclientsAdunitsListLinkedCustomChannelsSecurity extends SpeakeasyBase {
...
export class AdsenseAccountsAdclientsAdunitsListLinkedCustomChannelsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdsenseAccountsAdclientsAdunitsListLinkedCustomChannelsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
