...
public class GetWindowsHostingRequest {
    ...
    public GetWindowsHostingRequest(@JsonProperty("domainNamePathParameter") String domainNamePathParameter, @JsonProperty("domain_nameQueryParameter") String domainNameQueryParameter) {
        this.domainNamePathParameter = domainNamePathParameter;
        this.domainNameQueryParameter = domainNameQueryParameter;
  }
}
