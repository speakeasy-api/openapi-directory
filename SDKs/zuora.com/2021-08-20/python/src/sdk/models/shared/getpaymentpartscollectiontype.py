...
class GETPaymentPartsCollectionType:
    ...
    parts: Optional[list[shared_getpaymentparttypewithsuccess.GETPaymentPartTypewithSuccess]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('parts'), 'exclude': lambda f: f is None }})
    r"""Container for payment parts."""  
