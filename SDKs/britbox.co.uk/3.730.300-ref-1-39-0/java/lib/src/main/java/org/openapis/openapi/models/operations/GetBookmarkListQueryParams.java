...
public class GetBookmarkListQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetBookmarkListQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetBookmarkListQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetBookmarkListQueryParams withItemType(org.openapis.openapi.models.shared.ItemTypeEnum itemType) {
    ...
    public String lang;
    public GetBookmarkListQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetBookmarkListQueryParams withOrder(org.openapis.openapi.models.shared.ListOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Integer page;
    public GetBookmarkListQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public GetBookmarkListQueryParams withPageSize(Integer pageSize) {
    ...
    public GetBookmarkListQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetBookmarkListQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
