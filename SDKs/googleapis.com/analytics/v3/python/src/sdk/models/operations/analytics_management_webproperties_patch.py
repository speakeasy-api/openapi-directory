...
class AnalyticsManagementWebpropertiesPatchRequest:
    ...
    r"""Account ID to which the web property belongs"""  
    ...
    webproperty_input: Optional[shared_webproperty.WebpropertyInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
