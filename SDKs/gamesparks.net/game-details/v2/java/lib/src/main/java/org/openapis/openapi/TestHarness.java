...
public class TestHarness {
	...
	public TestHarness(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.CreateTestHarnessScenarioUsingPOSTResponse createTestHarnessScenarioUsingPOST(org.openapis.openapi.models.operations.CreateTestHarnessScenarioUsingPOSTRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 201) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                ...
                org.openapis.openapi.models.shared.TestHarnessScenarioModel out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.TestHarnessScenarioModel.class);
