...
class EmployeeResponseData:
    ...
    attributes: list[EmployeeResponseDataAttributes] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes') }})  
...
class EmployeeResponse:
    ...
    data: EmployeeResponseData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
