...
export class NullableIssueLabels2 extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "color" })
  color?: string;
...
export class NullableIssuePullRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class NullableIssue extends SpeakeasyBase {
  @SpeakeasyMetadata()
