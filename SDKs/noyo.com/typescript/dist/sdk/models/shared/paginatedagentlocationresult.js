...
var PaginatedAgentLocationResult = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return PaginatedAgentLocationResultMeta; }),
        __metadata("design:type", PaginatedAgentLocationResultMeta)
    ], PaginatedAgentLocationResult.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: agentlocationresult_1.AgentLocationResult }),
        (0, class_transformer_1.Expose)({ name: "response" }),
        (0, class_transformer_1.Type)(function () { return agentlocationresult_1.AgentLocationResult; }),
