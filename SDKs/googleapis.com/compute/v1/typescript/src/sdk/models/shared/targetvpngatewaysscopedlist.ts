 ...
 */
export enum TargetVpnGatewaysScopedListWarningCodeEnum {
...
export class TargetVpnGatewaysScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetVpnGatewaysScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: TargetVpnGatewaysScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: TargetVpnGatewaysScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => TargetVpnGatewaysScopedListWarningData)
  data?: TargetVpnGatewaysScopedListWarningData[];
...
export class TargetVpnGatewaysScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of target VPN gateways contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: TargetVpnGateway })
  @Expose({ name: "targetVpnGateways" })
