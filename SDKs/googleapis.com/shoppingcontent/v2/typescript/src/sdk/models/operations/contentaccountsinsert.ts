...
export class ContentAccountsInsertSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccountsInsertRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccountsInsertResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
