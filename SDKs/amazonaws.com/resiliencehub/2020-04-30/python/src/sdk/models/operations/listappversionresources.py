...
from ..shared import listappversionresourcesresponse as shared_listappversionresourcesresponse
...
class ListAppVersionResourcesRequestBody:
...
class ListAppVersionResourcesRequest:
    ...
    request_body: ListAppVersionResourcesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListAppVersionResourcesResponse:
    ...
    list_app_version_resources_response: Optional[shared_listappversionresourcesresponse.ListAppVersionResourcesResponse] = dataclasses.field(default=None)
    r"""Success"""  
