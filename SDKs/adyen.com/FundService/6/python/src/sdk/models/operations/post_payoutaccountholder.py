...
from ..shared import payoutaccountholderresponse as shared_payoutaccountholderresponse
...
class PostPayoutAccountHolderResponse:
    ...
    payout_account_holder_response: Optional[shared_payoutaccountholderresponse.PayoutAccountHolderResponse] = dataclasses.field(default=None)
