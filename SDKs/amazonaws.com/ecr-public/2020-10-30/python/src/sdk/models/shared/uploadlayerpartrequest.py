...
class UploadLayerPartRequest:
    ...
    layer_part_blob: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('layerPartBlob') }})  
    part_first_byte: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('partFirstByte') }})  
    part_last_byte: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('partLastByte') }})  
