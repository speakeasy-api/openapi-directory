...
export class Teams {
  ...
  teamsCreateOrUpdateIdpGroupConnectionsInOrg(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgResponse =
        new operations.TeamsCreateOrUpdateIdpGroupConnectionsInOrgResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.groupMapping = utils.objectToClass(
              httpRes?.data,
              shared.GroupMapping
            );
          }
  ...
  teamsCreateOrUpdateIdpGroupConnectionsLegacy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyRequest(
        req
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyResponse =
        new operations.TeamsCreateOrUpdateIdpGroupConnectionsLegacyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  teamsListIdpGroupsForLegacy(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TeamsListIdpGroupsForLegacyResponse =
        new operations.TeamsListIdpGroupsForLegacyResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  teamsListIdpGroupsForOrg(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TeamsListIdpGroupsForOrgResponse =
        new operations.TeamsListIdpGroupsForOrgResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
          headers: utils.getHeadersFromResponse(httpRes.headers),
  ...
  teamsListIdpGroupsInOrg(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TeamsListIdpGroupsInOrgResponse =
        new operations.TeamsListIdpGroupsInOrgResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
