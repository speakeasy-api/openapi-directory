...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetUser200ApplicationJSONUserUserAuthTokens:
...
class GetUser200ApplicationJSONUser:
    ...
    created_at: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('created_at') }})  
    custom_fields: GetUser200ApplicationJSONUserCustomFields = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom_fields') }})  
    ...
    flair_url: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flair_url') }})  
    group_users: list[GetUser200ApplicationJSONUserGroupUsers] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('group_users') }})  
    groups: list[GetUser200ApplicationJSONUserGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('groups') }})  
    ...
    user_auth_tokens: list[GetUser200ApplicationJSONUserUserAuthTokens] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user_auth_tokens') }})  
    user_notification_schedule: GetUser200ApplicationJSONUserUserNotificationSchedule = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user_notification_schedule') }})  
    user_option: GetUser200ApplicationJSONUserUserOption = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user_option') }})  
    ...
    user_fields: Optional[GetUser200ApplicationJSONUserUserFields] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user_fields'), 'exclude': lambda f: f is None }})  
...
class GetUser200ApplicationJSON:
    ...
    user: GetUser200ApplicationJSONUser = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('user') }})  
