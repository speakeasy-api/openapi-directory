...
exports.GetVariantModelAssociationsResponse = exports.GetVariantModelAssociationsRequest = void 0;
...
var GetVariantModelAssociationsRequest = /** @class */ (function (_super) {
    ...
    ], GetVariantModelAssociationsRequest.prototype, "direct", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=evidence",
        }),
        __metadata("design:type", String)
    ], GetVariantModelAssociationsRequest.prototype, "evidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=exclude_automatic_assertions",
        }),
        __metadata("design:type", Boolean)
    ], GetVariantModelAssociationsRequest.prototype, "excludeAutomaticAssertions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=facet" }),
        __metadata("design:type", Boolean)
    ], GetVariantModelAssociationsRequest.prototype, "facet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=facet_fields",
        }),
        __metadata("design:type", Array)
    ], GetVariantModelAssociationsRequest.prototype, "facetFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fetch_objects",
        }),
        __metadata("design:type", Boolean)
    ], GetVariantModelAssociationsRequest.prototype, "fetchObjects", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetVariantModelAssociationsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rows" }),
        __metadata("design:type", Number)
    ], GetVariantModelAssociationsRequest.prototype, "rows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=slim" }),
        __metadata("design:type", Array)
    ], GetVariantModelAssociationsRequest.prototype, "slim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start" }),
        __metadata("design:type", Number)
    ], GetVariantModelAssociationsRequest.prototype, "start", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=unselect_evidence",
        }),
        __metadata("design:type", Boolean)
    ], GetVariantModelAssociationsRequest.prototype, "unselectEvidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=use_compact_associations",
        }),
        __metadata("design:type", Boolean)
    ], GetVariantModelAssociationsRequest.prototype, "useCompactAssociations", void 0);
...
var GetVariantModelAssociationsResponse = /** @class */ (function (_super) {
    ...
    ], GetVariantModelAssociationsResponse.prototype, "rawResponse", void 0);
