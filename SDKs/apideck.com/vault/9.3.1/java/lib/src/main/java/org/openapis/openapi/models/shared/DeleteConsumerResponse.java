...
public class DeleteConsumerResponse {
    ...
    public DeleteConsumerResponse(@JsonProperty("data") DeleteConsumerResponseData data, @JsonProperty("status") String status, @JsonProperty("status_code") Long statusCode) {
        this.data = data;
        this.status = status;
        this.statusCode = statusCode;
  }
