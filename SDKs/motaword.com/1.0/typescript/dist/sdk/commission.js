...
var Commission = /** @class */ (function () {
    function Commission(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Commission.prototype.getCommissions = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/commissions";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.commissionList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Commission.prototype.getCommissionsByFilter = function (req, config) {
        var _a;
