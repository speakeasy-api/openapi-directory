...
const (
	CreateDatasetImportJobXAmzTargetEnumAmazonForecastCreateDatasetImportJob CreateDatasetImportJobXAmzTargetEnum = "AmazonForecast.CreateDatasetImportJob"
)
...
func (e *CreateDatasetImportJobXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AmazonForecast.CreateDatasetImportJob":
