...
class NetworkconnectivityProjectsLocationsSpokesSetIamPolicyRequest:
    path_params: NetworkconnectivityProjectsLocationsSpokesSetIamPolicyPathParams = dataclasses.field()
    query_params: NetworkconnectivityProjectsLocationsSpokesSetIamPolicyQueryParams = dataclasses.field()
    security: NetworkconnectivityProjectsLocationsSpokesSetIamPolicySecurity = dataclasses.field()
