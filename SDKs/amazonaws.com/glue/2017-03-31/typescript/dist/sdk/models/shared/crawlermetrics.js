...
var CrawlerMetrics = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "LastRuntimeSeconds" }),
        __metadata("design:type", Number)
    ], CrawlerMetrics.prototype, "lastRuntimeSeconds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MedianRuntimeSeconds" }),
        __metadata("design:type", Number)
    ], CrawlerMetrics.prototype, "medianRuntimeSeconds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "StillEstimating" }),
        __metadata("design:type", Boolean)
    ], CrawlerMetrics.prototype, "stillEstimating", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TablesCreated" }),
        __metadata("design:type", Number)
    ], CrawlerMetrics.prototype, "tablesCreated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TablesDeleted" }),
        __metadata("design:type", Number)
    ], CrawlerMetrics.prototype, "tablesDeleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TablesUpdated" }),
        __metadata("design:type", Number)
    ], CrawlerMetrics.prototype, "tablesUpdated", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TimeLeftSeconds" }),
        __metadata("design:type", Number)
