...
**/
var ActionTypeId = /** @class */ (function (_super) {
    __extends(ActionTypeId, _super);
    ...
    ], ActionTypeId.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=owner" }),
        __metadata("design:type", String)
    ], ActionTypeId.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=provider" }),
        __metadata("design:type", String)
    ], ActionTypeId.prototype, "provider", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=version" }),
        __metadata("design:type", String)
    ], ActionTypeId.prototype, "version", void 0);
    return ActionTypeId;
