...
class ListConversationMessageReceiptListConversationMessageReceiptResponse:
    ...
    delivery_receipts: Optional[list[shared_conversations_v1_conversation_conversation_message_conversation_message_receipt.ConversationsV1ConversationConversationMessageConversationMessageReceipt]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('delivery_receipts'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListConversationMessageReceiptListConversationMessageReceiptResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
