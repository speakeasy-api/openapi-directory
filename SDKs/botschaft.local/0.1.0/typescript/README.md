...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/botschaft.local/0.1.0/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/botschaft.local/0.1.0/typescript
```
