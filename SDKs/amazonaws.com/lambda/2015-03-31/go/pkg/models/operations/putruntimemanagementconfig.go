...
func (e PutRuntimeManagementConfigRequestBodyUpdateRuntimeOnEnum) ToPointer() *PutRuntimeManagementConfigRequestBodyUpdateRuntimeOnEnum {
	return &e
}
...
func (e *PutRuntimeManagementConfigRequestBodyUpdateRuntimeOnEnum) UnmarshalJSON(data []byte) error {
	...
	case "Manual":
		fallthrough
	case "FunctionUpdate":
		*e = PutRuntimeManagementConfigRequestBodyUpdateRuntimeOnEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PutRuntimeManagementConfigRequestBodyUpdateRuntimeOnEnum: %v", v)
	}
}
