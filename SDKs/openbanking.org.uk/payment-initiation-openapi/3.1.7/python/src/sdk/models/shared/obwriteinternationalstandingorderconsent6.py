...
class OBWriteInternationalStandingOrderConsent6DataAuthorisation:
    ...
    authorisation_type: OBWriteInternationalStandingOrderConsent6DataAuthorisationAuthorisationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorisationType') }})
    r"""Type of authorisation flow requested."""  
...
class OBWriteInternationalStandingOrderConsent6DataInitiation:
    ...
    creditor_account: OBWriteInternationalStandingOrderConsent6DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Provides the details to identify the beneficiary account."""  
    ...
    """  
    instructed_amount: OBWriteInternationalStandingOrderConsent6DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructedAmount') }})
    r"""Amount of money to be moved between the debtor and creditor, before deduction of charges, expressed in the currency as ordered by the initiating party.
    Usage: This amount has to be transported unchanged through the transaction chain.
    """  
    ...
    creditor: Optional[OBWriteInternationalStandingOrderConsent6DataInitiationCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Creditor'), 'exclude': lambda f: f is None }})
    r"""Party to which an amount of money is due."""  
    creditor_agent: Optional[OBWriteInternationalStandingOrderConsent6DataInitiationCreditorAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAgent'), 'exclude': lambda f: f is None }})
    r"""Party that manages the account on behalf of the account owner, that is manages the registration and booking of entries on the account, calculates balances on the account and provides information about the account.
    This is the servicer of the beneficiary account.
    """  
    debtor_account: Optional[OBWriteInternationalStandingOrderConsent6DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Provides the details to identify the debtor account."""  
...
class OBWriteInternationalStandingOrderConsent6Data:
    ...
    initiation: OBWriteInternationalStandingOrderConsent6DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for an international standing order."""  
    permission: OBWriteInternationalStandingOrderConsent6DataPermissionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Permission') }})
    r"""Specifies the Open Banking service request types."""  
    authorisation: Optional[OBWriteInternationalStandingOrderConsent6DataAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Authorisation'), 'exclude': lambda f: f is None }})
    r"""The authorisation type request from the TPP."""  
    read_refund_account: Optional[OBWriteInternationalStandingOrderConsent6DataReadRefundAccountEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ReadRefundAccount'), 'exclude': lambda f: f is None }})
    r"""Specifies to share the refund account details with PISP"""  
...
class OBWriteInternationalStandingOrderConsent6:
    ...
    data: OBWriteInternationalStandingOrderConsent6Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
