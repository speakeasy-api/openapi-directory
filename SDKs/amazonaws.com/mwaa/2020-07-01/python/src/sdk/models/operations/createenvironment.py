...
class CreateEnvironmentRequestBody:
    ...
    dag_s3_path: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DagS3Path') }})
    ...
    r"""The Amazon Resource Name (ARN) of the execution role for your environment. An execution role is an Amazon Web Services Identity and Access Management (IAM) role that grants MWAA permission to access Amazon Web Services services and resources used by your environment. For example, <code>arn:aws:iam::123456789:role/my-execution-role</code>. To learn more, see <a href=\\"https://docs.aws.amazon.com/mwaa/latest/userguide/mwaa-create-role.html\\">Amazon MWAA Execution role</a>."""  
    network_configuration: CreateEnvironmentRequestBodyNetworkConfiguration = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('NetworkConfiguration') }})
    r"""Describes the VPC networking components used to secure and enable network traffic between the Amazon Web Services resources for your environment. To learn more, see <a href=\\"https://docs.aws.amazon.com/mwaa/latest/userguide/networking-about.html\\">About networking on Amazon MWAA</a>."""  
    source_bucket_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SourceBucketArn') }})
    ...
    r"""The Amazon Web Services Key Management Service (KMS) key to encrypt the data in your environment. You can use an Amazon Web Services owned CMK, or a Customer managed CMK (advanced). To learn more, see <a href=\\"https://docs.aws.amazon.com/mwaa/latest/userguide/create-environment.html\\">Create an Amazon MWAA environment</a>."""  
    logging_configuration: Optional[CreateEnvironmentRequestBodyLoggingConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LoggingConfiguration'), 'exclude': lambda f: f is None }})
    r"""Defines the Apache Airflow log types to send to CloudWatch Logs."""  
    ...
    r"""<p>The number of Apache Airflow schedulers to run in your environment. Valid values:</p> <ul> <li> <p>v2 - Accepts between 2 to 5. Defaults to 2.</p> </li> <li> <p>v1 - Accepts 1.</p> </li> </ul>"""  
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Tags'), 'exclude': lambda f: f is None }})
    r"""The key-value tag pairs you want to associate to your environment. For example, <code>\\"Environment\\": \\"Staging\\"</code>. To learn more, see <a href=\\"https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html\\">Tagging Amazon Web Services resources</a>."""  
    webserver_access_mode: Optional[CreateEnvironmentRequestBodyWebserverAccessModeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WebserverAccessMode'), 'exclude': lambda f: f is None }})
    r"""The Apache Airflow <i>Web server</i> access mode. To learn more, see <a href=\\"https://docs.aws.amazon.com/mwaa/latest/userguide/configuring-networking.html\\">Apache Airflow access modes</a>."""  
...
class CreateEnvironmentRequest:
    ...
    r"""The name of the Amazon MWAA environment. For example, <code>MyMWAAEnvironment</code>."""  
