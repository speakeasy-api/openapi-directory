...
class ImportationDeleteCustomColumnPathParams:
...
@dataclasses.dataclass
class ImportationDeleteCustomColumnRequest:
    path_params: ImportationDeleteCustomColumnPathParams = dataclasses.field()
    

@dataclasses.dataclass
class ImportationDeleteCustomColumnResponse:
