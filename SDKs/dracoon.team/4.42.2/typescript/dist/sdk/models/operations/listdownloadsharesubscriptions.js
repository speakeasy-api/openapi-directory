...
exports.ListDownloadShareSubscriptionsResponse = exports.ListDownloadShareSubscriptionsRequest = void 0;
...
var ListDownloadShareSubscriptionsRequest = /** @class */ (function (_super) {
    ...
    ], ListDownloadShareSubscriptionsRequest.prototype, "xSdsAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], ListDownloadShareSubscriptionsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], ListDownloadShareSubscriptionsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], ListDownloadShareSubscriptionsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], ListDownloadShareSubscriptionsRequest.prototype, "sort", void 0);
    return ListDownloadShareSubscriptionsRequest;
}(utils_1.SpeakeasyBase));
exports.ListDownloadShareSubscriptionsRequest = ListDownloadShareSubscriptionsRequest;
var ListDownloadShareSubscriptionsResponse = /** @class */ (function (_super) {
    ...
    ], ListDownloadShareSubscriptionsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ListDownloadShareSubscriptionsResponse = ListDownloadShareSubscriptionsResponse;
