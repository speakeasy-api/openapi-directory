...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
/**
 ...
 */
export declare enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum {
...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
     ...
     * Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL`
     */
    targetingType: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum;
    /**
...
export declare class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetResponse extends SpeakeasyBase {
    /**
     * Successful response
     */
