...
use \OpenAPI\OpenAPI\Models\Operations\GetUpcomingScheduledCampaignsAndCanvasesRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetUpcomingScheduledCampaignsAndCanvasesRequest();
    $request->endTime = '2018-09-01T00:00:00-04:00';

    $response = $sdk->scheduleMesages->getUpcomingScheduledCampaignsAndCanvases($request);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleApiTriggeredCanvasesRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleApiTriggeredCanvasesRequestBodyAudience;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleApiTriggeredCanvasesRequestBodyAudienceAND;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleApiTriggeredCanvasesRequestBodyAudienceANDCustomAttribute;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleApiTriggeredCanvasesRequestBodyRecipients;
use \OpenAPI\OpenAPI\Models\Operations\ScheduleApiTriggeredCanvasesRequestBodySchedule;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ScheduleApiTriggeredCanvasesRequestBody();
    $request->audience = new ScheduleApiTriggeredCanvasesRequestBodyAudience();
    $request->audience->and = [
        new ScheduleApiTriggeredCanvasesRequestBodyAudienceAND(),
        new ScheduleApiTriggeredCanvasesRequestBodyAudienceAND(),
        new ScheduleApiTriggeredCanvasesRequestBodyAudienceAND(),
    ];
    $request->broadcast = false;
    $request->canvasEntryProperties = [
        'iure' => 'magnam',
        'debitis' => 'ipsa',
    ];
    $request->canvasId = 'canvas_identifier';
    $request->recipients = [
        new ScheduleApiTriggeredCanvasesRequestBodyRecipients(),
        new ScheduleApiTriggeredCanvasesRequestBodyRecipients(),
        new ScheduleApiTriggeredCanvasesRequestBodyRecipients(),
        new ScheduleApiTriggeredCanvasesRequestBodyRecipients(),
    ];
    $request->schedule = new ScheduleApiTriggeredCanvasesRequestBodySchedule();
    $request->schedule->atOptimalTime = false;
    $request->schedule->inLocalTime = false;
    $request->schedule->time = 'tempora';

    $response = $sdk->scheduleMesages->scheduleApiTriggeredCanvases($request);
