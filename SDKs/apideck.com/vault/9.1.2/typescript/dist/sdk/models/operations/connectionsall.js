...
exports.ConnectionsAllResponse = exports.ConnectionsAllRequest = exports.ConnectionsAllSecurity = void 0;
...
exports.ConnectionsAllSecurity = ConnectionsAllSecurity;
var ConnectionsAllRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=api" }),
        __metadata("design:type", String)
    ], ConnectionsAllRequest.prototype, "api", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=configured",
        }),
        __metadata("design:type", Boolean)
    ], ConnectionsAllRequest.prototype, "configured", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ConnectionsAllRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], ConnectionsAllRequest.prototype, "xApideckConsumerId", void 0);
    return ConnectionsAllRequest;
}(utils_1.SpeakeasyBase));
exports.ConnectionsAllRequest = ConnectionsAllRequest;
var ConnectionsAllResponse = /** @class */ (function (_super) {
    ...
    ], ConnectionsAllResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ConnectionsAllResponse = ConnectionsAllResponse;
