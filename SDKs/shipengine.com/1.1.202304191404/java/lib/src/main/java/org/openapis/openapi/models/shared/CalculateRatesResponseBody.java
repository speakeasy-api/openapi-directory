...
public class CalculateRatesResponseBody {
    ...
    public CalculateRatesResponseBody withIsReturn(Boolean isReturn) {
    ...
    public CalculateRatesResponseBody(@JsonProperty("advanced_options") AdvancedShipmentOptions advancedOptions, @JsonProperty("confirmation") CalculateRatesResponseBodyDeliveryConfirmationEnum confirmation, @JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("customs") CalculateRatesResponseBodyInternationalShipmentOptions customs, @JsonProperty("insurance_provider") CalculateRatesResponseBodyInsuranceProviderEnum insuranceProvider, @JsonProperty("modified_at") OffsetDateTime modifiedAt, @JsonProperty("packages") Package[] packages, @JsonProperty("rate_response") RatesInformation rateResponse, @JsonProperty("return_to") ShippingAddress returnTo, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("shipment_id") String shipmentId, @JsonProperty("shipment_status") CalculateRatesResponseBodyShipmentStatusEnum shipmentStatus, @JsonProperty("tags") Tag[] tags, @JsonProperty("total_weight") CalculateRatesResponseBodyWeight totalWeight) {
        this.advancedOptions = advancedOptions;
        this.confirmation = confirmation;
        this.createdAt = createdAt;
        this.customs = customs;
