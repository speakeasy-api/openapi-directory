...
export enum TestHypervisorConfigurationXAmzTargetEnum {
  BackupOnPremisesV20210101TestHypervisorConfiguration = "BackupOnPremises_v20210101.TestHypervisorConfiguration",
}

export class TestHypervisorConfigurationRequest extends SpeakeasyBase {
...
export class TestHypervisorConfigurationResponse extends SpeakeasyBase {
  /**
   * ConflictException
   */
  @SpeakeasyMetadata()
