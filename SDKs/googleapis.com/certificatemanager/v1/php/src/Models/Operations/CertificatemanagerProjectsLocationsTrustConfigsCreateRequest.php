...
class CertificatemanagerProjectsLocationsTrustConfigsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\TrustConfigInput $trustConfigInput = null;
     ...
     * 
     * @var ?string $trustConfigId
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=trustConfigId')]
    public ?string $trustConfigId = null;
