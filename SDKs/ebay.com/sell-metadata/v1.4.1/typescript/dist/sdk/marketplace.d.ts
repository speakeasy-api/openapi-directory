...
export declare class Marketplace {
    ...
    **/
    getAutomotivePartsCompatibilityPolicies(req: operations.GetAutomotivePartsCompatibilityPoliciesRequest, config?: AxiosRequestConfig): Promise<operations.GetAutomotivePartsCompatibilityPoliciesResponse>;
    /**
    ...
    **/
    getItemConditionPolicies(req: operations.GetItemConditionPoliciesRequest, config?: AxiosRequestConfig): Promise<operations.GetItemConditionPoliciesResponse>;
    /**
    ...
    **/
    getListingStructurePolicies(req: operations.GetListingStructurePoliciesRequest, config?: AxiosRequestConfig): Promise<operations.GetListingStructurePoliciesResponse>;
    /**
    ...
    **/
    getNegotiatedPricePolicies(req: operations.GetNegotiatedPricePoliciesRequest, config?: AxiosRequestConfig): Promise<operations.GetNegotiatedPricePoliciesResponse>;
    /**
    ...
    **/
    getProductAdoptionPolicies(req: operations.GetProductAdoptionPoliciesRequest, config?: AxiosRequestConfig): Promise<operations.GetProductAdoptionPoliciesResponse>;
    /**
