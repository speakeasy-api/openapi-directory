...
exports.InvoicesUpdateResponse = exports.InvoicesUpdateRequest = exports.InvoicesUpdateSecurity = void 0;
...
exports.InvoicesUpdateSecurity = InvoicesUpdateSecurity;
var InvoicesUpdateRequest = /** @class */ (function (_super) {
    ...
    ], InvoicesUpdateRequest.prototype, "invoiceInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], InvoicesUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], InvoicesUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], InvoicesUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], InvoicesUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], InvoicesUpdateRequest.prototype, "xApideckServiceId", void 0);
    return InvoicesUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.InvoicesUpdateRequest = InvoicesUpdateRequest;
var InvoicesUpdateResponse = /** @class */ (function (_super) {
    ...
    ], InvoicesUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.InvoicesUpdateResponse = InvoicesUpdateResponse;
