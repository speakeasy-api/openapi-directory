...
class GetRampMetricsBySubscriptionKeyResponseType:
    ...
    reasons: Optional[list[GetRampMetricsBySubscriptionKeyResponseTypeReasons]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reasons') }})
