 ...
 */
export declare enum NodesRegistrationsListRegistrationAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class NodesRegistrationsListRegistrationAttributes extends SpeakeasyBase {
    /**
     * The category of the registered node.
     */
 ...
 */
export declare class NodesRegistrationsListRegistrationLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodesRegistrationsListRegistrationRelationships extends SpeakeasyBase {
    /**
...
export declare class NodesRegistrationsListRegistration extends SpeakeasyBase {
    /**
     * The properties of the registration entity.
     */
