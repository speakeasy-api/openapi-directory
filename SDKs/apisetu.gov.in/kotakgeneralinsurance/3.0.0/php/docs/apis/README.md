...
try {
    ...
    $request->certificateParameters->policyNo = 'PolicyNo';
    $request->certificateParameters->val = 'Please enter EngineNumber and ChasisNumber for motor cases and MobileNumber for health cases';
    $request->certificateParameters->verification = 'EngineNumber,ChasisNumber, MobileNumber';
