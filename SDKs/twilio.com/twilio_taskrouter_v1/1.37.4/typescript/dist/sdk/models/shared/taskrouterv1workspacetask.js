...
var TaskrouterV1WorkspaceTask = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=addons" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=assignment_status" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=task_queue_entered_date" }),
        __metadata("design:type", Date)
    ], TaskrouterV1WorkspaceTask.prototype, "taskQueueEnteredDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=task_queue_friendly_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=workflow_friendly_name" }),
        __metadata("design:type", String)
    ], TaskrouterV1WorkspaceTask.prototype, "workflowFriendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=workflow_sid" }),
        __metadata("design:type", String)
