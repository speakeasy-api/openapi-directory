...
class AddThingToBillingGroupHeaders:
...
class AddThingToBillingGroupRequest:
    headers: AddThingToBillingGroupHeaders = dataclasses.field()
    request: AddThingToBillingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
