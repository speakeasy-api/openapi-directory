 ...
 */
export declare class DescribeTransitGatewayPeeringAttachmentsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayPeeringAttachmentsRequest extends SpeakeasyBase {
    dryRun?: boolean;
