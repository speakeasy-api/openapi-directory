 ...
 */
public enum WebinarUpdateApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarUpdateApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
