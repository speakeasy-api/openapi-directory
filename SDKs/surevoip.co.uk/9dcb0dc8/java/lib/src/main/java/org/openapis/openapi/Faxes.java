...
public class Faxes {
     ...
     */
    public org.openapis.openapi.models.operations.GetFaxesResponse getFaxes() throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(baseUrl, "/faxes");
