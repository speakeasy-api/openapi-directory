...
import dataclasses
from ..shared import paymentinitiationconsentscope_enum as shared_paymentinitiationconsentscope_enum
...
class PaymentInitiationConsentCreateRequest:
    ...
    constraints: dict[str, Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints') }})
    ...
    scopes: list[shared_paymentinitiationconsentscope_enum.PaymentInitiationConsentScopeEnum] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scopes') }})
