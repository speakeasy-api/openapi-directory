...
from ..shared import paymentinstrumentgroup as shared_paymentinstrumentgroup
...
class GetPaymentInstrumentGroupsIDResponse:
    ...
    payment_instrument_group: Optional[shared_paymentinstrumentgroup.PaymentInstrumentGroup] = dataclasses.field(default=None)
