...
class ClassroomCoursesAnnouncementsModifyAssigneesRequest:
    ...
    modify_announcement_assignees_request: Optional[shared_modifyannouncementassigneesrequest.ModifyAnnouncementAssigneesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
