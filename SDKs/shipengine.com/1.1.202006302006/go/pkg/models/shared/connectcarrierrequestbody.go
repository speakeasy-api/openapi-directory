...
const (
	...
	ConnectCarrierRequestBodyTypeConnectGlobegisticsRequestBody      ConnectCarrierRequestBodyType = "connect_globegistics_request_body"
...
type ConnectCarrierRequestBody struct {
	...
	ConnectGlobegisticsRequestBody      *ConnectGlobegisticsRequestBody
...
func CreateConnectCarrierRequestBodyConnectGlobegisticsRequestBody(connectGlobegisticsRequestBody ConnectGlobegisticsRequestBody) ConnectCarrierRequestBody {
	typ := ConnectCarrierRequestBodyTypeConnectGlobegisticsRequestBody
...
func (u *ConnectCarrierRequestBody) UnmarshalJSON(data []byte) error {
	...
	connectGlobegisticsRequestBody := new(ConnectGlobegisticsRequestBody)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&connectGlobegisticsRequestBody); err == nil {
		u.ConnectGlobegisticsRequestBody = connectGlobegisticsRequestBody
		u.Type = ConnectCarrierRequestBodyTypeConnectGlobegisticsRequestBody
		return nil
	}
...
func (u ConnectCarrierRequestBody) MarshalJSON() ([]byte, error) {
	...
	if u.ConnectGlobegisticsRequestBody != nil {
		return json.Marshal(u.ConnectGlobegisticsRequestBody)
	}
