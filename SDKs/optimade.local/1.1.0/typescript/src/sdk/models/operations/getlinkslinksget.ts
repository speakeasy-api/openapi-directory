...
export class GetLinksLinksGetQueryParams extends SpeakeasyBase {
...
export class GetLinksLinksGetRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetLinksLinksGetQueryParams;
}


export class GetLinksLinksGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
