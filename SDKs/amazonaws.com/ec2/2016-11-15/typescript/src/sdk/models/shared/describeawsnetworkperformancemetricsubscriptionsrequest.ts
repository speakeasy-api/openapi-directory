 ...
 */
export class DescribeAwsNetworkPerformanceMetricSubscriptionsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeAwsNetworkPerformanceMetricSubscriptionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  filters?: DescribeAwsNetworkPerformanceMetricSubscriptionsRequestFilters[];
