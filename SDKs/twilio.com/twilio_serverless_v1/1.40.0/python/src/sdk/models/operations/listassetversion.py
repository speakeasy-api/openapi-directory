...
class ListAssetVersionRequest:
    ...
    r"""The SID of the Asset resource that is the parent of the Asset Version resources to read."""  
    service_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ServiceSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the Service to read the Asset Version resource from."""  
...
class ListAssetVersionListAssetVersionResponse:
    ...
    asset_versions: Optional[list[shared_serverless_v1_service_asset_asset_version.ServerlessV1ServiceAssetAssetVersion]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('asset_versions'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListAssetVersionListAssetVersionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
