 ...
 */
public enum GetPotTransactions200ApplicationJSONTransactionsSubTypeEnum {
    ...
    private GetPotTransactions200ApplicationJSONTransactionsSubTypeEnum(String value) {
        this.value = value;
    }
}
