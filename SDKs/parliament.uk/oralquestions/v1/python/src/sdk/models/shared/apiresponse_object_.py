...
class APIResponseObject:
    ...
    status_code: Optional[APIResponseObjectStatusCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusCode'), 'exclude': lambda f: f is None }})  
