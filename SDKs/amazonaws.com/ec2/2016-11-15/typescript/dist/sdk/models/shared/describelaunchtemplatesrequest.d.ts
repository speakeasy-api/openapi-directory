 ...
 */
export declare class DescribeLaunchTemplatesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLaunchTemplatesRequest extends SpeakeasyBase {
    dryRun?: boolean;
