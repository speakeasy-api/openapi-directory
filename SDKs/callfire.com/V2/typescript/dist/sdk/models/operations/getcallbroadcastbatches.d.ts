...
export declare class GetCallBroadcastBatchesSecurity extends SpeakeasyBase {
    password: string;
    username: string;
}
export declare class GetCallBroadcastBatchesRequest extends SpeakeasyBase {
    /**
...
export declare class GetCallBroadcastBatchesResponse extends SpeakeasyBase {
    /**
