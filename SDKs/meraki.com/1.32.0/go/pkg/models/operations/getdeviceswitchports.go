...
func (e GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum) ToPointer() *GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum {
	return &e
}
...
func (e *GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Sticky MAC allow list":
		*e = GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPorts200ApplicationJSONAccessPolicyTypeEnum: %v", v)
	}
}
...
func (e GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum) ToPointer() *GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum {
	return &e
}
...
func (e *GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum) UnmarshalJSON(data []byte) error {
	...
	case "loop guard":
		fallthrough
	case "root guard":
		*e = GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPorts200ApplicationJSONStpGuardEnum: %v", v)
	}
}
...
func (e GetDeviceSwitchPorts200ApplicationJSONTypeEnum) ToPointer() *GetDeviceSwitchPorts200ApplicationJSONTypeEnum {
	return &e
}
...
func (e *GetDeviceSwitchPorts200ApplicationJSONTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "access":
		fallthrough
	case "trunk":
		*e = GetDeviceSwitchPorts200ApplicationJSONTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPorts200ApplicationJSONTypeEnum: %v", v)
	}
}
...
func (e GetDeviceSwitchPorts200ApplicationJSONUdldEnum) ToPointer() *GetDeviceSwitchPorts200ApplicationJSONUdldEnum {
	return &e
}
...
func (e *GetDeviceSwitchPorts200ApplicationJSONUdldEnum) UnmarshalJSON(data []byte) error {
	...
	case "Alert only":
		fallthrough
	case "Enforce":
		*e = GetDeviceSwitchPorts200ApplicationJSONUdldEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceSwitchPorts200ApplicationJSONUdldEnum: %v", v)
	}
}
