...
public class PoolGetHeaders {
    ...
    public PoolGetHeaders withIfMatch(String ifMatch) {
    ...
    public PoolGetHeaders withIfModifiedSince(String ifModifiedSince) {
    ...
    public PoolGetHeaders withIfNoneMatch(String ifNoneMatch) {
    ...
    public PoolGetHeaders withIfUnmodifiedSince(String ifUnmodifiedSince) {
    ...
    public PoolGetHeaders withOcpDate(String ocpDate) {
    ...
    public PoolGetHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
