...
public class GoogleCloudRetailV2alphaSearchRequestFacetSpec {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpec withEnableDynamicPosition(Boolean enableDynamicPosition) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpec withExcludedFilterKeys(String[] excludedFilterKeys) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey facetKey;
    public GoogleCloudRetailV2alphaSearchRequestFacetSpec withFacetKey(GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey facetKey) {
    ...
    public GoogleCloudRetailV2alphaSearchRequestFacetSpec withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
