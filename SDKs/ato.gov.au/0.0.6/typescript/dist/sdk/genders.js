...
var Genders = /** @class */ (function () {
    function Genders(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Genders.prototype.getClassificationsGenders = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetClassificationsGendersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/classifications/genders";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetClassificationsGendersResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        ...
                        res.genders = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.Gender, resFieldDepth);
                    }
                    break;
