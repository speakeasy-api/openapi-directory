...
class DrivePermissionsCreateQueryParams:
    ...
    send_notification_email: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sendNotificationEmail', 'style': 'form', 'explode': True }})
...
class DrivePermissionsCreateSecurity:
    option1: Optional[DrivePermissionsCreateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DrivePermissionsCreateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DrivePermissionsCreateRequest:
    path_params: DrivePermissionsCreatePathParams = dataclasses.field()
    query_params: DrivePermissionsCreateQueryParams = dataclasses.field()
    security: DrivePermissionsCreateSecurity = dataclasses.field()
