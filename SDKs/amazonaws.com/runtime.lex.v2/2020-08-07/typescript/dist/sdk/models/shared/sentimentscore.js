 ...
 */
var SentimentScore = /** @class */ (function (_super) {
    __extends(SentimentScore, _super);
    function SentimentScore() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mixed" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "neutral" }),
        __metadata("design:type", Number)
    ], SentimentScore.prototype, "neutral", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "positive" }),
        __metadata("design:type", Number)
