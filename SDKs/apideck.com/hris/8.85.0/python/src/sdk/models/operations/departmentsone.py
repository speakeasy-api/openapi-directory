...
from ..shared import getdepartmentresponse as shared_getdepartmentresponse
...
class DepartmentsOneRequest:
    headers: DepartmentsOneHeaders = dataclasses.field()
    path_params: DepartmentsOnePathParams = dataclasses.field()
    query_params: DepartmentsOneQueryParams = dataclasses.field()
    security: DepartmentsOneSecurity = dataclasses.field()
...
class DepartmentsOneResponse:
    ...
    get_department_response: Optional[shared_getdepartmentresponse.GetDepartmentResponse] = dataclasses.field(default=None)
