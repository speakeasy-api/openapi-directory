 ...
 */
public enum RejectTransitGatewayVpcAttachmentResultTransitGatewayVpcAttachmentStateEnum {
    ...
    private RejectTransitGatewayVpcAttachmentResultTransitGatewayVpcAttachmentStateEnum(String value) {
        this.value = value;
    }
}
