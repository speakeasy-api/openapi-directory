 ...
 */
export enum StoredValueLoadRequestLoadTypeEnum {
 ...
 */
export enum StoredValueLoadRequestShopperInteractionEnum {
  Ecommerce = "Ecommerce",
  ContAuth = "ContAuth",
  Moto = "Moto",
  Pos = "POS",
...
export class StoredValueLoadRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "amount" })
  @Type(() => Amount)
  amount: Amount;
