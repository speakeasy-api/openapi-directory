 ...
 */
export enum ReservationsScopedListWarningCodeEnum {
...
export class ReservationsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ReservationsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ReservationsScopedListWarningData })
  @Expose({ name: "data" })
...
export class ReservationsScopedList extends SpeakeasyBase {
  /**
