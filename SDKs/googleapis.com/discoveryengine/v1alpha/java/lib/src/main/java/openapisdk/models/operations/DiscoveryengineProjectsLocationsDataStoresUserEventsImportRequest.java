...
public class DiscoveryengineProjectsLocationsDataStoresUserEventsImportRequest {
    ...
    public openapisdk.models.shared.GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest request;
    public DiscoveryengineProjectsLocationsDataStoresUserEventsImportRequest withRequest(openapisdk.models.shared.GoogleCloudDiscoveryengineV1alphaImportUserEventsRequest request) {
