...
class ClassifyImageURLPathParams:
...
@dataclasses.dataclass
class ClassifyImageURLQueryParams:
...
@dataclasses.dataclass
class ClassifyImageURLRequests:
...
@dataclasses.dataclass
class ClassifyImageURLRequest:
    path_params: ClassifyImageURLPathParams = dataclasses.field()
    query_params: ClassifyImageURLQueryParams = dataclasses.field()
    request: ClassifyImageURLRequests = dataclasses.field()
    

@dataclasses.dataclass
class ClassifyImageURLResponse:
