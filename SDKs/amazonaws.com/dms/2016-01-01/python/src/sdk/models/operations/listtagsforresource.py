...
class ListTagsForResourceRequest:
    ...
    list_tags_for_resource_message: shared_listtagsforresourcemessage.ListTagsForResourceMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
