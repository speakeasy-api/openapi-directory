...
public class User {
     ...
     */
    public org.openapis.openapi.models.operations.GetUserExtensionsResponse getUserExtensions(org.openapis.openapi.models.operations.GetUserExtensionsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.Extension[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.Extension[].class);
                res.extensions = out;
            }
        }
