...
class StromQuittung:
    ...
    def quittung_comit(self, request: operations.QuittungComitRequestBody) -> operations.QuittungComitResponse:
        ...
        res = operations.QuittungComitResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                res.quittung_comit_200_application_json_string = http_res.content

        return res

    def quittung_create(self, request: operations.QuittungCreateRequestBody) -> operations.QuittungCreateResponse:
        ...
        res = operations.QuittungCreateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                res.quittung_create_200_application_json_string = http_res.content

        return res

    def quittung_prepare(self, request: operations.QuittungPrepareRequestBody) -> operations.QuittungPrepareResponse:
        ...
        res = operations.QuittungPrepareResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                res.quittung_prepare_200_application_json_string = http_res.content
