...
import dataclasses
from ..shared import userdetailsvo as shared_userdetailsvo
...
class UserDetailsExpandVO:
    r"""Java type: com.noosh.nooshapi.vo.UserDetailsExpandVO"""
    
    result: Optional[shared_userdetailsvo.UserDetailsVO] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('result'), 'exclude': lambda f: f is None }})
