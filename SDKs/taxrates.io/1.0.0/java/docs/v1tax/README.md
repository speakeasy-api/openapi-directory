...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.TaxRatesByIpAddressRequest;
import org.openapis.openapi.models.operations.TaxRatesByIpAddressResponse;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            TaxRatesByIpAddressRequest req = new TaxRatesByIpAddressRequest() {{
                domain = "api.taxrates.io";
                filter = "unde";
                ip = "86.139.70.49";
                productCode = "C010";
            ...
            TaxRatesByIpAddressResponse res = sdk.v1Tax.taxRatesByIpAddress(req);

            if (res.taxRatesByIpAddress200ApplicationJSONObjects != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
