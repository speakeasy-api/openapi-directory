...
export declare class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesPatchSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare enum ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesPatchForceOnlyEnum {
...
export declare class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesPatchRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesPatchResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
