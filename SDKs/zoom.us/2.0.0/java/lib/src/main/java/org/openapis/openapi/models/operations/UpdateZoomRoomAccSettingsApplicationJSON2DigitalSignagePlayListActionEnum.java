 ...
 * 
 */
public enum UpdateZoomRoomAccSettingsApplicationJSON2DigitalSignagePlayListActionEnum {
    ADD("add"),
    UPDATE("update"),
    DELETE("delete");
    ...
    private UpdateZoomRoomAccSettingsApplicationJSON2DigitalSignagePlayListActionEnum(String value) {
        this.value = value;
    }
}
