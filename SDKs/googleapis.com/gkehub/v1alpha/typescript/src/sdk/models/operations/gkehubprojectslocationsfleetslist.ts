...
export class GkehubProjectsLocationsFleetsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsFleetsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GkehubProjectsLocationsFleetsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
