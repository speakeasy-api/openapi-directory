...
from ..shared import chromeosdeviceaction as shared_chromeosdeviceaction
...
class DirectoryChromeosdevicesActionRequest:
    ...
    r"""The unique ID of the device. The `resourceId`s are returned in the response from the [chromeosdevices.list](/admin-sdk/directory/v1/reference/chromeosdevices/list) method."""  
    ...
    r"""JSONP"""  
    chrome_os_device_action: Optional[shared_chromeosdeviceaction.ChromeOsDeviceAction] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
