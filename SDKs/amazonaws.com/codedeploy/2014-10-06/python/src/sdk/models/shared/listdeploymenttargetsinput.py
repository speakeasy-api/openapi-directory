...
class ListDeploymentTargetsInput:
    ...
    target_filters: Optional[dict[str, list[str]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('targetFilters'), 'exclude': lambda f: f is None }})  
