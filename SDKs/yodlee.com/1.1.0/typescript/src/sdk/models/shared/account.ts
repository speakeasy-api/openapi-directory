...
export enum AccountContainerEnum {
    Bank = "bank",
...
export enum AccountAccountStatusEnum {
    Active = "ACTIVE",
    Inactive = "INACTIVE",
...
export enum AccountAggregationSourceEnum {
    System = "SYSTEM",
    User = "USER"
}
...
export enum AccountFrequencyEnum {
    Daily = "DAILY",
    OneTime = "ONE_TIME",
    Weekly = "WEEKLY",
...
export enum AccountHomeInsuranceTypeEnum {
...
export enum AccountInterestRateTypeEnum {
    Fixed = "FIXED",
    Variable = "VARIABLE",
    Unknown = "UNKNOWN",
    Other = "OTHER"
...
export enum AccountLifeInsuranceTypeEnum {
    Other = "OTHER",
...
export enum AccountOauthMigrationStatusEnum {
    InProgress = "IN_PROGRESS",
    ToBeMigrated = "TO_BE_MIGRATED",
    Completed = "COMPLETED"
}

export enum AccountPolicyStatusEnum {
    Active = "ACTIVE",
    Inactive = "INACTIVE",
    Other = "OTHER"
}

export enum AccountRepaymentPlanTypeEnum {
    Standard = "STANDARD",
    Graduated = "GRADUATED",
    Extended = "EXTENDED",
...
export enum AccountSourceAccountStatusEnum {
...
export enum AccountUserClassificationEnum {
    Business = "BUSINESS",
    Personal = "PERSONAL"
}

export enum AccountValuationTypeEnum {
    System = "SYSTEM",
    Manual = "MANUAL"
}
...
export class Account extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=autoRefresh" })
  ...
  @SpeakeasyMetadata({ data: "json, name=fullAccountNumberList" })
  ...
  @SpeakeasyMetadata({ data: "json, name=paymentProfile" })
