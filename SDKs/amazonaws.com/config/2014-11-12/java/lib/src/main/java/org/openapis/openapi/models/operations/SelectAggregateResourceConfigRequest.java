...
public class SelectAggregateResourceConfigRequest {
    ...
    public SelectAggregateResourceConfigRequest(@JsonProperty("SelectAggregateResourceConfigRequest") org.openapis.openapi.models.shared.SelectAggregateResourceConfigRequest selectAggregateResourceConfigRequest, @JsonProperty("X-Amz-Target") SelectAggregateResourceConfigXAmzTargetEnum xAmzTarget) {
        this.selectAggregateResourceConfigRequest = selectAggregateResourceConfigRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
