...
class UpdateSigningBasketPsuDataRequest:
    headers: UpdateSigningBasketPsuDataHeaders = dataclasses.field()
    path_params: UpdateSigningBasketPsuDataPathParams = dataclasses.field()
    security: UpdateSigningBasketPsuDataSecurity = dataclasses.field()
...
class UpdateSigningBasketPsuDataResponse:
    ...
    update_signing_basket_psu_data_200_application_json_one_of: Optional[Any] = dataclasses.field(default=None)
