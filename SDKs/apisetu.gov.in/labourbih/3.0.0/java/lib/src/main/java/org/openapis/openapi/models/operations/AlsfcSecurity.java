...
public class AlsfcSecurity {
    ...
    public AlsfcSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public AlsfcSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public AlsfcSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
