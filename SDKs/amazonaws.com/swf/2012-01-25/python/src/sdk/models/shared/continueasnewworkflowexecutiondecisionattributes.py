...
class ContinueAsNewWorkflowExecutionDecisionAttributes:
    ...
    workflow_type_version: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('workflowTypeVersion'), 'exclude': lambda f: f is None }})  
