...
class TaskAddRequest:
    ...
    r"""The id of the job to which the task is to be added."""  
    task_add_parameter: shared_taskaddparameter.TaskAddParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Specifies the task to be added."""  
