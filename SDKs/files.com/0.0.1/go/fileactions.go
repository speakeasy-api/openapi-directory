...
func NewFileActions(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *FileActions {
	return &FileActions{
...
func (s *FileActions) FileActionBeginUpload(ctx context.Context, request operations.FileActionBeginUploadRequest) (*operations.FileActionBeginUploadResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/file_actions/begin_upload/{path}", request.PathParams)
	...
	res := &operations.FileActionBeginUploadResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out []shared.FileUploadPartEntity
...
func (s *FileActions) FileActionCopy(ctx context.Context, request operations.FileActionCopyRequest) (*operations.FileActionCopyResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/file_actions/copy/{path}", request.PathParams)
	...
	res := &operations.FileActionCopyResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 201:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.FileActionEntity
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *FileActions) FileActionMetadata(ctx context.Context, request operations.FileActionMetadataRequest) (*operations.FileActionMetadataResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/file_actions/metadata/{path}", request.PathParams)
...
func (s *FileActions) FileActionMove(ctx context.Context, request operations.FileActionMoveRequest) (*operations.FileActionMoveResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/file_actions/move/{path}", request.PathParams)
	...
	res := &operations.FileActionMoveResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
