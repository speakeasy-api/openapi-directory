...
public class GetQuestionsIdsAnswersRequest {
    ...
    public GetQuestionsIdsAnswersRequest withCallback(String callback) {
    ...
    public GetQuestionsIdsAnswersRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withFromdate(Long fromdate) {
    ...
    public GetQuestionsIdsAnswersRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withOrder(GetQuestionsIdsAnswersOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withPagesize(Long pagesize) {
    ...
    public GetQuestionsIdsAnswersRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withSort(GetQuestionsIdsAnswersSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetQuestionsIdsAnswersRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetQuestionsIdsAnswersRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
