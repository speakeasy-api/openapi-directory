...
public class LhcerSecurity {
    ...
    public LhcerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public LhcerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public LhcerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
