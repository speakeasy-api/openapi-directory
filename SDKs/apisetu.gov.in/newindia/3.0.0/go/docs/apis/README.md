...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Tripc(ctx, operations.TripcRequestBody{
        CertificateParameters: &operations.TripcRequestBodyCertificateParameters{
            FullName: "Sunil Kumar",
            Udf1: "1301002334568097565",
            Udf2: "PO98765432",
            Udf3: "DD/MM/YYYY",
        ...
        Format: operations.TripcRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.TripcSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
