...
class UpdateCredentialAwsRequest:
    ...
    r"""The Twilio-provided string that uniquely identifies the AWS resource to update."""  
    request_body: Optional[UpdateCredentialAwsUpdateCredentialAwsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
