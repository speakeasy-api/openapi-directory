...
class AuditConfig:
    ...
    audit_log_configs: Optional[list[shared_auditlogconfig.AuditLogConfig]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('auditLogConfigs') }})
