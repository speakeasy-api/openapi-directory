...
type SearchBioOntologyStudyQueryParams struct {
...
type SearchBioOntologyStudyRequest struct {
	QueryParams SearchBioOntologyStudyQueryParams
}

type SearchBioOntologyStudyResponse struct {
	ContentType string
	StatusCode  int
