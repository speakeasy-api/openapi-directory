...
try {
    ...
    $request->all = false;
    $request->before = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-08T23:33:14.875Z');
    $request->page = 831049;
    $request->participating = false;
    $request->perPage = 519711;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-12-31T23:01:47.942Z');
...
try {
    ...
    $request->org = 'at';
    $request->page = 311860;
    $request->perPage = 273542;
    $request->username = 'Herminia.Schmeler67';
...
try {
    ...
    $request->page = 471752;
    $request->perPage = 25662;
    $request->username = 'Merlin42';
...
try {
    ...
    $request->page = 730442;
    $request->perPage = 374170;
    $request->username = 'Lura27';
...
try {
    ...
    $request->all = false;
    $request->before = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-10-07T04:50:29.805Z');
    $request->owner = 'laborum';
    $request->page = 517379;
    $request->participating = false;
    $request->perPage = 276894;
    $request->repo = 'aspernatur';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-04-14T08:18:32.851Z');
...
try {
    ...
    $request->direction = DirectionEnum::DESC;
    $request->page = 183280;
    $request->perPage = 204865;
    $request->sort = SortEnum::CREATED;
    $request->username = 'Casimir35';
...
try {
    ...
    $request->username = 'Alexander_Runolfsdottir9';
...
try {
    ...
    $request->lastReadAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-09-18T06:37:26.413Z');
    $request->read = false;
...
try {
    ...
    $request->requestBody->lastReadAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-04-28T19:10:24.037Z');
