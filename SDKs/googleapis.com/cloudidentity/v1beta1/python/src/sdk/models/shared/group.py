...
from ..shared import posixgroup as shared_posixgroup
...
class Group:
    ...
    posix_groups: Optional[list[shared_posixgroup.PosixGroup]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('posixGroups') }})
