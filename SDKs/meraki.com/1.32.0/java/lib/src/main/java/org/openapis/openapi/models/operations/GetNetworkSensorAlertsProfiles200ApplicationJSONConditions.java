...
public class GetNetworkSensorAlertsProfiles200ApplicationJSONConditions {
    ...
    public GetNetworkSensorAlertsProfiles200ApplicationJSONConditions(@JsonProperty("metric") String metric, @JsonProperty("threshold") GetNetworkSensorAlertsProfiles200ApplicationJSONConditionsThreshold threshold) {
        this.metric = metric;
        this.threshold = threshold;
  }
}
