...
export class GkehubProjectsLocationsMembershipsGenerateConnectManifestRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=connectAgent.name",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=connectAgent.namespace",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=connectAgent.proxy",
  })
