...
class DescribeSnapshotsRequest:
    ...
    filters: Optional[list[DescribeSnapshotsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    owner_ids: Optional[list[str]] = dataclasses.field(default=None)  
    restorable_by_user_ids: Optional[list[str]] = dataclasses.field(default=None)  
