 ...
 */
public enum GetNetworkSensorAlertsProfile200ApplicationJSONConditionsDurationEnum {
    ZERO(0L),
    SIXTY(60L),
    ...
    private GetNetworkSensorAlertsProfile200ApplicationJSONConditionsDurationEnum(Long value) {
        this.value = value;
    }
}
