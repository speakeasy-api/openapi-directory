...
class DisconnectFromServiceRequestBody:
    ...
    r"""Request to disconnect Source Server from service by Server ID."""  
    

@dataclasses.dataclass
class DisconnectFromServiceRequest:
    
    request_body: DisconnectFromServiceRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
