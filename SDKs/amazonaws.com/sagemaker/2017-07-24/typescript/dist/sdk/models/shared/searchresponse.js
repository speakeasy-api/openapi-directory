...
var searchrecord_1 = require("./searchrecord");
...
var SearchResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: searchrecord_1.SearchRecord }),
        (0, class_transformer_1.Expose)({ name: "Results" }),
        (0, class_transformer_1.Type)(function () { return searchrecord_1.SearchRecord; }),
