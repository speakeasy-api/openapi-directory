...
func (s *settings) RemoveWebhook(ctx context.Context, request operations.RemoveWebhookRequest) (*operations.RemoveWebhookResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/settings/webhooks/{webhook_id}", request, nil)
	if err != nil {
...
func (s *settings) RequestAllSystemRescueKeyPairs(ctx context.Context, request operations.RequestAllSystemRescueKeyPairsRequest) (*operations.RequestAllSystemRescueKeyPairsResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/settings/keypairs"
...
func (s *settings) RequestSystemRescueKeyPair(ctx context.Context, request operations.RequestSystemRescueKeyPairRequest) (*operations.RequestSystemRescueKeyPairResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/settings/keypair"
...
func (s *settings) ResetWebhookLifetime(ctx context.Context, request operations.ResetWebhookLifetimeRequest) (*operations.ResetWebhookLifetimeResponse, error) {
	baseURL := s.serverURL
	url, err := utils.GenerateURL(ctx, baseURL, "/v4/settings/webhooks/{webhook_id}/reset_lifetime", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *settings) SetSettings(ctx context.Context, request operations.SetSettingsRequest) (*operations.SetSettingsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CustomerSettingsRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *settings) ToggleNotificationChannels(ctx context.Context, request operations.ToggleNotificationChannelsRequest) (*operations.ToggleNotificationChannelsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "NotificationChannelActivationRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
