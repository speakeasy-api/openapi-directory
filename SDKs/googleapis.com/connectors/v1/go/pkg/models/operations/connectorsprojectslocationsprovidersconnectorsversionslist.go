...
func (e *ConnectorsProjectsLocationsProvidersConnectorsVersionsListViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "CONNECTOR_VERSION_VIEW_FULL":
		*e = ConnectorsProjectsLocationsProvidersConnectorsVersionsListViewEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ConnectorsProjectsLocationsProvidersConnectorsVersionsListViewEnum: %s", s)
	}
}
