...
export class ModifiersAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ModifiersAddRequest extends SpeakeasyBase {
...
export class ModifiersAddResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
