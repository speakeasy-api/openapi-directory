...
type TagmanagerAccountsContainersEnvironmentsReauthorizeSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TagmanagerAccountsContainersEnvironmentsReauthorizePathParams struct {
...
type TagmanagerAccountsContainersEnvironmentsReauthorizeQueryParams struct {
	// V1 error format.
...
type TagmanagerAccountsContainersEnvironmentsReauthorizeRequest struct {
...
type TagmanagerAccountsContainersEnvironmentsReauthorizeResponse struct {
	ContentType string
	// Successful response
