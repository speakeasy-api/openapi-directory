...
export class BooksLayersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BooksLayersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BooksLayersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
