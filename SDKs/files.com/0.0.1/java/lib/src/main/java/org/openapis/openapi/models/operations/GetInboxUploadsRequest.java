...
public class GetInboxUploadsRequest {
    ...
    public GetInboxUploadsRequest withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public GetInboxUploadsRequest withFilter(java.util.Map<String, Object> filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetInboxUploadsRequest withFilterGt(java.util.Map<String, Object> filterGt) {
    ...
    public GetInboxUploadsRequest withFilterGteq(java.util.Map<String, Object> filterGteq) {
    ...
    public GetInboxUploadsRequest withFilterLike(java.util.Map<String, Object> filterLike) {
    ...
    public GetInboxUploadsRequest withFilterLt(java.util.Map<String, Object> filterLt) {
    ...
    public GetInboxUploadsRequest withFilterLteq(java.util.Map<String, Object> filterLteq) {
    ...
    public GetInboxUploadsRequest withInboxId(Integer inboxId) {
    ...
    public GetInboxUploadsRequest withInboxRegistrationId(Integer inboxRegistrationId) {
    ...
    public GetInboxUploadsRequest withPerPage(Integer perPage) {
    ...
    public GetInboxUploadsRequest withSortBy(java.util.Map<String, Object> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
