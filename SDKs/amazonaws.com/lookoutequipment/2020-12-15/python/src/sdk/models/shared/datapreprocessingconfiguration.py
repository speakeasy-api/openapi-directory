...
class DataPreProcessingConfiguration:
    ...
    target_sampling_rate: Optional[shared_targetsamplingrate_enum.TargetSamplingRateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('TargetSamplingRate') }})
