...
exports.RejectSharedDirectoryResponse = exports.RejectSharedDirectoryRequest = exports.RejectSharedDirectoryXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var RejectSharedDirectoryXAmzTargetEnum;
...
})(RejectSharedDirectoryXAmzTargetEnum = exports.RejectSharedDirectoryXAmzTargetEnum || (exports.RejectSharedDirectoryXAmzTargetEnum = {}));
var RejectSharedDirectoryRequest = /** @class */ (function (_super) {
    ...
    ], RejectSharedDirectoryRequest.prototype, "rejectSharedDirectoryRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], RejectSharedDirectoryRequest.prototype, "xAmzTarget", void 0);
...
var RejectSharedDirectoryResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], RejectSharedDirectoryResponse.prototype, "rawResponse", void 0);
    return RejectSharedDirectoryResponse;
}(utils_1.SpeakeasyBase));
exports.RejectSharedDirectoryResponse = RejectSharedDirectoryResponse;
