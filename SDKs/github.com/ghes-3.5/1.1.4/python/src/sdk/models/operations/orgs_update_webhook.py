...
class OrgsUpdateWebhookRequestBodyConfig:
    r"""Key/value pairs to provide settings for this webhook. [These are defined below](https://docs.github.com/enterprise-server@3.5/rest/reference/orgs#update-hook-config-params)."""
...
class OrgsUpdateWebhookRequestBody:
    ...
    r"""Determines what [events](https://docs.github.com/enterprise-server@3.5/webhooks/event-payloads) the hook is triggered for."""  
