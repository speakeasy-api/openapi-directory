...
export class ApigatewayProjectsLocationsGatewaysPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ApigatewayProjectsLocationsGatewaysPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ApigatewayProjectsLocationsGatewaysPatchResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
