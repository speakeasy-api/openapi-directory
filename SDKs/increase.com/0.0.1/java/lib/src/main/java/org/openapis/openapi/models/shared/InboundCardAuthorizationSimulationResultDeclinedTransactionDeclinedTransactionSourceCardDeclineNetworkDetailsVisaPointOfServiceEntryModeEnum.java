 ...
 */
public enum InboundCardAuthorizationSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetailsVisaPointOfServiceEntryModeEnum {
    MANUAL("manual"),
    ...
    private InboundCardAuthorizationSimulationResultDeclinedTransactionDeclinedTransactionSourceCardDeclineNetworkDetailsVisaPointOfServiceEntryModeEnum(String value) {
        this.value = value;
    }
}
