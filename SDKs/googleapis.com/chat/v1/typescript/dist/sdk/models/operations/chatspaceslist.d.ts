...
export declare class ChatSpacesListSecurityOption1 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesListSecurityOption2 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesListSecurityOption3 extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class ChatSpacesListSecurity extends SpeakeasyBase {
    option1?: ChatSpacesListSecurityOption1;
    option2?: ChatSpacesListSecurityOption2;
    option3?: ChatSpacesListSecurityOption3;
}
