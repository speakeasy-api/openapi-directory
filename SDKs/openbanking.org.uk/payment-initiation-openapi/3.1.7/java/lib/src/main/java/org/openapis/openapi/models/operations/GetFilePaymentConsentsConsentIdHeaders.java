...
public class GetFilePaymentConsentsConsentIdHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public GetFilePaymentConsentsConsentIdHeaders withAuthorization(String authorization) {
    ...
    public GetFilePaymentConsentsConsentIdHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetFilePaymentConsentsConsentIdHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetFilePaymentConsentsConsentIdHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public GetFilePaymentConsentsConsentIdHeaders withXFapiInteractionId(String xFapiInteractionId) {
