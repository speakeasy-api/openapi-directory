...
SERVERS = [
    ...
    r"""The Amazon Inspector multi-region endpoint"""
    "https://inspector.{region}.amazonaws.com",
    r"""The Amazon Inspector multi-region endpoint"""
    "http://inspector.{region}.amazonaws.com.cn",
    r"""The Amazon Inspector endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    r"""<fullname>Amazon Inspector</fullname> <p>Amazon Inspector enables you to analyze the behavior of your AWS resources and to identify potential security issues. For more information, see <a href=\\"https://docs.aws.amazon.com/inspector/latest/userguide/inspector_introduction.html\\"> Amazon Inspector User Guide</a>.</p>
    ...
    def add_attributes_to_findings(self, request: operations.AddAttributesToFindingsRequest) -> operations.AddAttributesToFindingsResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "add_attributes_to_findings_request", 'json')
        ...
        res = operations.AddAttributesToFindingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.AddAttributesToFindingsResponse])
    ...
    def create_assessment_target(self, request: operations.CreateAssessmentTargetRequest) -> operations.CreateAssessmentTargetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_assessment_target_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateAssessmentTargetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateAssessmentTargetResponse])
    ...
    def create_assessment_template(self, request: operations.CreateAssessmentTemplateRequest) -> operations.CreateAssessmentTemplateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_assessment_template_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateAssessmentTemplateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateAssessmentTemplateResponse])
    ...
    def create_exclusions_preview(self, request: operations.CreateExclusionsPreviewRequest) -> operations.CreateExclusionsPreviewResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_exclusions_preview_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateExclusionsPreviewResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateExclusionsPreviewResponse])
    ...
    def create_resource_group(self, request: operations.CreateResourceGroupRequest) -> operations.CreateResourceGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_resource_group_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateResourceGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateResourceGroupResponse])
    ...
    def delete_assessment_run(self, request: operations.DeleteAssessmentRunRequest) -> operations.DeleteAssessmentRunResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_assessment_run_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteAssessmentRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_assessment_target(self, request: operations.DeleteAssessmentTargetRequest) -> operations.DeleteAssessmentTargetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_assessment_target_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteAssessmentTargetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_assessment_template(self, request: operations.DeleteAssessmentTemplateRequest) -> operations.DeleteAssessmentTemplateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_assessment_template_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteAssessmentTemplateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_assessment_runs(self, request: operations.DescribeAssessmentRunsRequest) -> operations.DescribeAssessmentRunsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_assessment_runs_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeAssessmentRunsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeAssessmentRunsResponse])
    ...
    def describe_assessment_targets(self, request: operations.DescribeAssessmentTargetsRequest) -> operations.DescribeAssessmentTargetsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_assessment_targets_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeAssessmentTargetsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeAssessmentTargetsResponse])
    ...
    def describe_assessment_templates(self, request: operations.DescribeAssessmentTemplatesRequest) -> operations.DescribeAssessmentTemplatesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_assessment_templates_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeAssessmentTemplatesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeAssessmentTemplatesResponse])
    ...
    def describe_cross_account_access_role(self, request: operations.DescribeCrossAccountAccessRoleRequest) -> operations.DescribeCrossAccountAccessRoleResponse:
        ...
        res = operations.DescribeCrossAccountAccessRoleResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeCrossAccountAccessRoleResponse])
    ...
    def describe_exclusions(self, request: operations.DescribeExclusionsRequest) -> operations.DescribeExclusionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_exclusions_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeExclusionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeExclusionsResponse])
    ...
    def describe_findings(self, request: operations.DescribeFindingsRequest) -> operations.DescribeFindingsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_findings_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeFindingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFindingsResponse])
    ...
    def describe_resource_groups(self, request: operations.DescribeResourceGroupsRequest) -> operations.DescribeResourceGroupsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_resource_groups_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeResourceGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeResourceGroupsResponse])
    ...
    def describe_rules_packages(self, request: operations.DescribeRulesPackagesRequest) -> operations.DescribeRulesPackagesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_rules_packages_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeRulesPackagesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeRulesPackagesResponse])
    ...
    def get_assessment_report(self, request: operations.GetAssessmentReportRequest) -> operations.GetAssessmentReportResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_assessment_report_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetAssessmentReportResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetAssessmentReportResponse])
    ...
    def get_exclusions_preview(self, request: operations.GetExclusionsPreviewRequest) -> operations.GetExclusionsPreviewResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_exclusions_preview_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.GetExclusionsPreviewRequest, request)
        ...
        res = operations.GetExclusionsPreviewResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetExclusionsPreviewResponse])
    ...
    def get_telemetry_metadata(self, request: operations.GetTelemetryMetadataRequest) -> operations.GetTelemetryMetadataResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_telemetry_metadata_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetTelemetryMetadataResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetTelemetryMetadataResponse])
    ...
    def list_assessment_run_agents(self, request: operations.ListAssessmentRunAgentsRequest) -> operations.ListAssessmentRunAgentsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_assessment_run_agents_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListAssessmentRunAgentsRequest, request)
        ...
        res = operations.ListAssessmentRunAgentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAssessmentRunAgentsResponse])
    ...
    def list_assessment_runs(self, request: operations.ListAssessmentRunsRequest) -> operations.ListAssessmentRunsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_assessment_runs_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListAssessmentRunsRequest, request)
        ...
        res = operations.ListAssessmentRunsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAssessmentRunsResponse])
    ...
    def list_assessment_targets(self, request: operations.ListAssessmentTargetsRequest) -> operations.ListAssessmentTargetsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_assessment_targets_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListAssessmentTargetsRequest, request)
        ...
        res = operations.ListAssessmentTargetsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAssessmentTargetsResponse])
    ...
    def list_assessment_templates(self, request: operations.ListAssessmentTemplatesRequest) -> operations.ListAssessmentTemplatesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_assessment_templates_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListAssessmentTemplatesRequest, request)
        ...
        res = operations.ListAssessmentTemplatesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAssessmentTemplatesResponse])
    ...
    def list_event_subscriptions(self, request: operations.ListEventSubscriptionsRequest) -> operations.ListEventSubscriptionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_event_subscriptions_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListEventSubscriptionsResponse])
    ...
    def list_exclusions(self, request: operations.ListExclusionsRequest) -> operations.ListExclusionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_exclusions_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListExclusionsRequest, request)
        ...
        res = operations.ListExclusionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListExclusionsResponse])
    ...
    def list_findings(self, request: operations.ListFindingsRequest) -> operations.ListFindingsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_findings_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def list_rules_packages(self, request: operations.ListRulesPackagesRequest) -> operations.ListRulesPackagesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_rules_packages_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListRulesPackagesRequest, request)
        ...
        res = operations.ListRulesPackagesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListRulesPackagesResponse])
    ...
    def preview_agents(self, request: operations.PreviewAgentsRequest) -> operations.PreviewAgentsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "preview_agents_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.PreviewAgentsRequest, request)
        ...
        res = operations.PreviewAgentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PreviewAgentsResponse])
    ...
    def register_cross_account_access_role(self, request: operations.RegisterCrossAccountAccessRoleRequest) -> operations.RegisterCrossAccountAccessRoleResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_cross_account_access_role_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RegisterCrossAccountAccessRoleResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_attributes_from_findings(self, request: operations.RemoveAttributesFromFindingsRequest) -> operations.RemoveAttributesFromFindingsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "remove_attributes_from_findings_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RemoveAttributesFromFindingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RemoveAttributesFromFindingsResponse])
    ...
    def set_tags_for_resource(self, request: operations.SetTagsForResourceRequest) -> operations.SetTagsForResourceResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "set_tags_for_resource_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SetTagsForResourceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def start_assessment_run(self, request: operations.StartAssessmentRunRequest) -> operations.StartAssessmentRunResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_assessment_run_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartAssessmentRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartAssessmentRunResponse])
    ...
    def stop_assessment_run(self, request: operations.StopAssessmentRunRequest) -> operations.StopAssessmentRunResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "stop_assessment_run_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StopAssessmentRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def subscribe_to_event(self, request: operations.SubscribeToEventRequest) -> operations.SubscribeToEventResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "subscribe_to_event_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SubscribeToEventResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def unsubscribe_from_event(self, request: operations.UnsubscribeFromEventRequest) -> operations.UnsubscribeFromEventResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "unsubscribe_from_event_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UnsubscribeFromEventResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_assessment_target(self, request: operations.UpdateAssessmentTargetRequest) -> operations.UpdateAssessmentTargetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_assessment_target_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateAssessmentTargetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
