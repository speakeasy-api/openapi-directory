...
export class RetailProjectsLocationsCatalogsServingConfigsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsServingConfigsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsServingConfigsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
