...
**/
export class GetShipmentByIdResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
...
**/
export class GetShipmentByIdResponseBodyWeight extends SpeakeasyBase {
 ...
 * 
**/
export class GetShipmentByIdResponseBody extends SpeakeasyBase {
