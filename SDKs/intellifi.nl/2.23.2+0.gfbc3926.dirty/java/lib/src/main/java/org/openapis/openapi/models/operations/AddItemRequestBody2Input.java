...
public class AddItemRequestBody2Input {
    /**
    ...
    public AddItemRequestBody2Input withCodeHex(String codeHex) {
    ...
    public AddItemRequestBody2Input withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public AddItemRequestBody2Input withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    @JsonProperty("label")
    public String label;
    public AddItemRequestBody2Input withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public AddItemRequestBody2Input withLocationRequest(String locationRequest) {
    ...
    public AddItemRequestBody2Input withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public AddItemRequestBody2Input withProtocol(org.openapis.openapi.models.shared.ItemProtocolEnum protocol) {
    ...
    public AddItemRequestBody2Input withTechnology(org.openapis.openapi.models.shared.TechnologyEnum technology) {
    ...
    public AddItemRequestBody2Input withType(org.openapis.openapi.models.shared.ItemTypeEnum type) {
        this.type = type;
        return this;
    }
