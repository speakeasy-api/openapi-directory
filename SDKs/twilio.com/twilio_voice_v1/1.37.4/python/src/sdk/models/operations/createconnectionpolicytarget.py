...
class CreateConnectionPolicyTargetCreateConnectionPolicyTargetRequest:
    target: str = dataclasses.field(metadata={'form': { 'field_name': 'Target' }})
...
class CreateConnectionPolicyTargetRequest:
    path_params: CreateConnectionPolicyTargetPathParams = dataclasses.field()
    security: CreateConnectionPolicyTargetSecurity = dataclasses.field()
    request: Optional[CreateConnectionPolicyTargetCreateConnectionPolicyTargetRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
