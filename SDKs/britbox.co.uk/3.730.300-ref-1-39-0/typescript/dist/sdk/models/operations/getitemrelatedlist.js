...
exports.GetItemRelatedListResponse = exports.GetItemRelatedListRequest = void 0;
...
var GetItemRelatedListRequest = /** @class */ (function (_super) {
    ...
    ], GetItemRelatedListRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=false;name=ff" }),
        __metadata("design:type", Array)
    ], GetItemRelatedListRequest.prototype, "ff", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetItemRelatedListRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetItemRelatedListRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=max_rating",
        }),
        __metadata("design:type", String)
    ], GetItemRelatedListRequest.prototype, "maxRating", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetItemRelatedListRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], GetItemRelatedListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=segments",
        }),
        __metadata("design:type", Array)
    ], GetItemRelatedListRequest.prototype, "segments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sub" }),
        __metadata("design:type", String)
    ], GetItemRelatedListRequest.prototype, "sub", void 0);
    return GetItemRelatedListRequest;
}(utils_1.SpeakeasyBase));
exports.GetItemRelatedListRequest = GetItemRelatedListRequest;
var GetItemRelatedListResponse = /** @class */ (function (_super) {
    ...
    ], GetItemRelatedListResponse.prototype, "rawResponse", void 0);
    return GetItemRelatedListResponse;
}(utils_1.SpeakeasyBase));
exports.GetItemRelatedListResponse = GetItemRelatedListResponse;
