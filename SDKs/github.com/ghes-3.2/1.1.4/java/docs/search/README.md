...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("mollitia") {{
                order = OrderEnum.ASC;
                page = 687589L;
                perPage = 769156L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("doloremque") {{
                order = OrderEnum.ASC;
                page = 549237L;
                perPage = 53733L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("aliquid") {{
                order = OrderEnum.ASC;
                page = 167435L;
                perPage = 273677L;
                sort = SearchIssuesAndPullRequestsSortEnum.CREATED;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("dolor", 700529L) {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("minus") {{
                order = OrderEnum.ASC;
                page = 550338L;
                perPage = 994234L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("iste") {{
                page = 361106L;
                perPage = 37129L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("illo") {{
                order = OrderEnum.DESC;
                page = 984031L;
                perPage = 342104L;
