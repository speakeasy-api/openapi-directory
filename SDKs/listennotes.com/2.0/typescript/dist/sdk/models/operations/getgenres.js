...
exports.GetGenresResponse = exports.GetGenresRequest = exports.GetGenresTopLevelOnlyEnum = void 0;
 ...
 *
 */
var GetGenresTopLevelOnlyEnum;
(function (GetGenresTopLevelOnlyEnum) {
    GetGenresTopLevelOnlyEnum["Zero"] = "0";
    GetGenresTopLevelOnlyEnum["One"] = "1";
})(GetGenresTopLevelOnlyEnum = exports.GetGenresTopLevelOnlyEnum || (exports.GetGenresTopLevelOnlyEnum = {}));
var GetGenresRequest = /** @class */ (function (_super) {
    ...
    ], GetGenresRequest.prototype, "xListenAPIKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=top_level_only",
        }),
        __metadata("design:type", String)
    ], GetGenresRequest.prototype, "topLevelOnly", void 0);
...
var GetGenresResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetGenresResponse.prototype, "rawResponse", void 0);
