...
exports.CreateTimelineEventResponse = exports.CreateTimelineEventRequest = exports.CreateTimelineEventRequestBody = void 0;
...
var CreateTimelineEventRequestBody = /** @class */ (function (_super) {
    ...
    ], CreateTimelineEventRequestBody.prototype, "eventReferences", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreateTimelineEventRequestBody = CreateTimelineEventRequestBody;
var CreateTimelineEventRequest = /** @class */ (function (_super) {
    ...
    ], CreateTimelineEventRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateTimelineEventRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateTimelineEventRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateTimelineEventRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateTimelineEventRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateTimelineEventRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateTimelineEventRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateTimelineEventRequest.prototype, "xAmzSignedHeaders", void 0);
    return CreateTimelineEventRequest;
}(utils_1.SpeakeasyBase));
exports.CreateTimelineEventRequest = CreateTimelineEventRequest;
var CreateTimelineEventResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateTimelineEventResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.CreateTimelineEventResponse = CreateTimelineEventResponse;
