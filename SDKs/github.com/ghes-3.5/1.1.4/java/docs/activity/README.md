...
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#check-if-a-repository-is-starred-by-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityCheckRepoIsStarredByAuthenticatedUserRequest req = new ActivityCheckRepoIsStarredByAuthenticatedUserRequest("atque", "sit");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#delete-a-repository-subscription>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityDeleteRepoSubscriptionRequest req = new ActivityDeleteRepoSubscriptionRequest("fugiat", "ab");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#delete-a-thread-subscription>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityDeleteThreadSubscriptionRequest req = new ActivityDeleteThreadSubscriptionRequest(743835L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#get-feeds>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#get-a-repository-subscription>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityGetRepoSubscriptionRequest req = new ActivityGetRepoSubscriptionRequest("dolorum", "iusto");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#get-a-thread>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityGetThreadRequest req = new ActivityGetThreadRequest(453697L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#get-a-thread-subscription-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityGetThreadSubscriptionForAuthenticatedUserRequest req = new ActivityGetThreadSubscriptionForAuthenticatedUserRequest(677082L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-events-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListEventsForAuthenticatedUserRequest req = new ActivityListEventsForAuthenticatedUserRequest("deleniti") {{
                page = 607045L;
                perPage = 896672L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-notifications-for-the-authenticated-user>
    ...
    public static void main(String[] args) {
        try {
            ...
            ActivityListNotificationsForAuthenticatedUserRequest req = new ActivityListNotificationsForAuthenticatedUserRequest() {{
                all = false;
                before = OffsetDateTime.parse("2021-01-08T01:15:41.988Z");
                page = 469497L;
                participating = false;
                perPage = 216897L;
                since = OffsetDateTime.parse("2022-05-03T23:26:05.435Z");
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-organization-events-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListOrgEventsForAuthenticatedUserRequest req = new ActivityListOrgEventsForAuthenticatedUserRequest("saepe", "eius") {{
                page = 137220L;
                perPage = 20651L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-public-events>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-public-events-for-a-network-of-repositories>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListPublicEventsForRepoNetworkRequest req = new ActivityListPublicEventsForRepoNetworkRequest("accusamus", "ad") {{
                page = 904425L;
                perPage = 383464L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-public-events-for-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListPublicEventsForUserRequest req = new ActivityListPublicEventsForUserRequest("deserunt") {{
                page = 588317L;
                perPage = 324683L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-public-organization-events>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListPublicOrgEventsRequest req = new ActivityListPublicOrgEventsRequest("repellendus") {{
                page = 519711L;
                perPage = 628982L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-events-received-by-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReceivedEventsForUserRequest req = new ActivityListReceivedEventsForUserRequest("alias") {{
                page = 872651L;
                perPage = 311860L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-public-events-received-by-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReceivedPublicEventsForUserRequest req = new ActivityListReceivedPublicEventsForUserRequest("tempora") {{
                page = 425451L;
                perPage = 798047L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-repository-events>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListRepoEventsRequest req = new ActivityListRepoEventsRequest("officiis", "qui") {{
                page = 679880L;
                perPage = 952792L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-repository-notifications-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListRepoNotificationsForAuthenticatedUserRequest req = new ActivityListRepoNotificationsForAuthenticatedUserRequest("esse", "harum") {{
                all = false;
                before = OffsetDateTime.parse("2022-10-14T08:09:09.090Z");
                page = 788740L;
                participating = false;
                perPage = 947371L;
                since = OffsetDateTime.parse("2022-04-09T05:42:11.142Z");
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-repositories-starred-by-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-repositories-starred-by-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReposStarredByUserRequest req = new ActivityListReposStarredByUserRequest("sapiente") {{
                direction = DirectionEnum.DESC;
                page = 471752L;
                perPage = 25662L;
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-repositories-watched-by-a-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListReposWatchedByUserRequest req = new ActivityListReposWatchedByUserRequest("neque") {{
                page = 153694L;
                perPage = 424685L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-stargazers>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListStargazersForRepoRequest req = new ActivityListStargazersForRepoRequest("libero", "voluptas") {{
                page = 646265L;
                perPage = 463575L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-repositories-watched-by-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#list-watchers>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityListWatchersForRepoRequest req = new ActivityListWatchersForRepoRequest("qui", "cupiditate") {{
                page = 807581L;
                perPage = 863856L;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#mark-notifications-as-read>
    ...
    public static void main(String[] args) {
        try {
            ...
            ActivityMarkNotificationsAsReadRequestBody req = new ActivityMarkNotificationsAsReadRequestBody() {{
                lastReadAt = OffsetDateTime.parse("2022-10-07T04:50:29.805Z");
                read = false;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#mark-repository-notifications-as-read>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityMarkRepoNotificationsAsReadRequest req = new ActivityMarkRepoNotificationsAsReadRequest("laborum", "totam") {{
                requestBody = new ActivityMarkRepoNotificationsAsReadRequestBody() {{
                    lastReadAt = OffsetDateTime.parse("2022-11-13T19:04:59.225Z");
                }};;
            }};            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#mark-a-thread-as-read>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityMarkThreadAsReadRequest req = new ActivityMarkThreadAsReadRequest(174909L);            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#set-a-repository-subscription>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivitySetRepoSubscriptionRequest req = new ActivitySetRepoSubscriptionRequest("distinctio", "facilis") {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#set-a-thread-subscription>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivitySetThreadSubscriptionRequest req = new ActivitySetThreadSubscriptionRequest(396060L) {{
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#star-a-repository-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityStarRepoForAuthenticatedUserRequest req = new ActivityStarRepoForAuthenticatedUserRequest("quam", "molestias");            
...
API method documentation
<https://docs.github.com/enterprise-server@3.5/rest/reference/activity#unstar-a-repository-for-the-authenticated-user>
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ActivityUnstarRepoForAuthenticatedUserRequest req = new ActivityUnstarRepoForAuthenticatedUserRequest("temporibus", "qui");            
