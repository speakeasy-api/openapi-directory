...
var Notifications = /** @class */ (function () {
    ...
    Notifications.prototype.deleteNotificationsId = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/notifications/{id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DeleteNotificationsIdResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        ...
                        res.notificationEntities = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.NotificationEntity, resFieldDepth);
                    }
                    break;
    ...
    Notifications.prototype.getNotificationsId = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetNotificationsIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.notificationEntity = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.NotificationEntity);
                    }
                    break;
                case [400, 401, 403, 404, 405, 409, 412, 422, 423, 429].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
                    break;
    ...
    Notifications.prototype.patchNotificationsId = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PatchNotificationsIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    Notifications.prototype.postNotifications = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostNotificationsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
