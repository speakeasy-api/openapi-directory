...
type DescribeLocationFsxOpenZfsHeaders struct {
...
type DescribeLocationFsxOpenZfsRequest struct {
	Headers DescribeLocationFsxOpenZfsHeaders
	Request shared.DescribeLocationFsxOpenZfsRequest `request:"mediaType=application/json"`
}
