...
class AssetReportAuditCopyCreateRequest:
    ...
    auditor_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auditor_id'), 'exclude': lambda f: f is None }})
    r"""The `auditor_id` of the third party with whom you would like to share the Asset Report."""  
