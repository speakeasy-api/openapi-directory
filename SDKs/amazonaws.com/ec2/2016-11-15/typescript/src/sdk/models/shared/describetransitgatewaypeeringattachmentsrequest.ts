 ...
 */
export class DescribeTransitGatewayPeeringAttachmentsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayPeeringAttachmentsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  filters?: DescribeTransitGatewayPeeringAttachmentsRequestFilters[];
