...
var AccountDetails = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "accountActivity" }),
        (0, class_transformer_1.Type)(function () { return accountactivity_1.AccountActivity; }),
        __metadata("design:type", accountactivity_1.AccountActivity)
    ], AccountDetails.prototype, "accountActivity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "appLicensingVerdict" }),
