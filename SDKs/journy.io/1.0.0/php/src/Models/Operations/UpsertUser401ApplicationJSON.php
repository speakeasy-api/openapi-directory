...
class UpsertUser401ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\UpsertUser401ApplicationJSONMeta')]
    public UpsertUser401ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\UpsertUser401ApplicationJSONMeta();
	}
}
