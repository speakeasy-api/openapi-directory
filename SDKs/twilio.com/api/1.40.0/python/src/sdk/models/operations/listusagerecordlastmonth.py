...
class ListUsageRecordLastMonthListUsageRecordLastMonthResponse:
    ...
    usage_records: Optional[list[shared_api_v2010_account_usage_usage_record_usage_record_last_month.APIV2010AccountUsageUsageRecordUsageRecordLastMonth]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('usage_records'), 'exclude': lambda f: f is None }})  
