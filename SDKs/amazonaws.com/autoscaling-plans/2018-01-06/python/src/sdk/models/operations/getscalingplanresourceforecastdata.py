...
class GetScalingPlanResourceForecastDataRequest:
    ...
    get_scaling_plan_resource_forecast_data_request: shared_getscalingplanresourceforecastdatarequest.GetScalingPlanResourceForecastDataRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
