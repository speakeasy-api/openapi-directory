 ...
 */
export enum GetInventory200ApplicationXMLQuantityUnitEnum {
  Each = "EACH",
}
 ...
 */
export class GetInventory200ApplicationXMLQuantity extends SpeakeasyBase {
  /**
   * Inventory Count
   */
  @SpeakeasyMetadata()
 ...
 */
export class GetInventory200ApplicationXML extends SpeakeasyBase {
  /**
   * Quantity that has been ordered by the customers but not yet shipped
   */
  @SpeakeasyMetadata()
...
export class GetInventory200ApplicationJSON extends SpeakeasyBase {
  ...
  @Type(() => GetInventory200ApplicationJSONQuantity)
