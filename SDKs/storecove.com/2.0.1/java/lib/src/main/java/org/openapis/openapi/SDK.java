...
public class SDK {
    ...
    public AdditionalTaxIdentifiers additionalTaxIdentifiers;
    ...
    public ReceivedDocuments receivedDocuments;
	...
	private SDK(HTTPClient client, org.openapis.openapi.models.shared.Security security, String serverUrl, java.util.Map<String, String> params) throws Exception {
		...
		this.additionalTaxIdentifiers = new AdditionalTaxIdentifiers(
			this._defaultClient,
		...
		this.receivedDocuments = new ReceivedDocuments(
			this._defaultClient,
			this._securityClient,
			this._serverUrl,
			this._language,
