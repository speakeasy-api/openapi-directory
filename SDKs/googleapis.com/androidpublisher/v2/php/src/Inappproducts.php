...
class Inappproducts 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\AndroidpublisherInappproductsDeleteResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/{packageName}/inappproducts/{sku}', \OpenAPI\OpenAPI\Models\Operations\AndroidpublisherInappproductsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{packageName}/inappproducts/{sku}', \OpenAPI\OpenAPI\Models\Operations\AndroidpublisherInappproductsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{packageName}/inappproducts', \OpenAPI\OpenAPI\Models\Operations\AndroidpublisherInappproductsInsertRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{packageName}/inappproducts', \OpenAPI\OpenAPI\Models\Operations\AndroidpublisherInappproductsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{packageName}/inappproducts/{sku}', \OpenAPI\OpenAPI\Models\Operations\AndroidpublisherInappproductsPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/{packageName}/inappproducts/{sku}', \OpenAPI\OpenAPI\Models\Operations\AndroidpublisherInappproductsUpdateRequest::class, $request);
