...
import dataclasses
from ..shared import googleclouddocumentaiv1beta3processortypelocationinfo as shared_googleclouddocumentaiv1beta3processortypelocationinfo
...
class GoogleCloudDocumentaiV1beta3ProcessorType:
    ...
    available_locations: Optional[list[shared_googleclouddocumentaiv1beta3processortypelocationinfo.GoogleCloudDocumentaiV1beta3ProcessorTypeLocationInfo]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('availableLocations'), 'exclude': lambda f: f is None }})
    ...
    launch_stage: Optional[GoogleCloudDocumentaiV1beta3ProcessorTypeLaunchStageEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('launchStage'), 'exclude': lambda f: f is None }})
    r"""Launch stage of the processor type"""  
