...
public class PayorAddPayorLogoV1Request {
    ...
    public PayorAddPayorLogoV1Request(@JsonProperty("PayorLogoRequest") org.openapis.openapi.models.shared.PayorLogoRequest payorLogoRequest, @JsonProperty("payorId") String payorId) {
        this.payorLogoRequest = payorLogoRequest;
        this.payorId = payorId;
  }
}
