...
var Invoices = /** @class */ (function () {
     ...
     * List Invoices
    **/
    Invoices.prototype.getInvoices = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetInvoicesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/invoices";
     ...
     * Show Invoice
    **/
    Invoices.prototype.getInvoicesId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetInvoicesIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/invoices/{id}", req.pathParams);
        var client = this._defaultClient;
