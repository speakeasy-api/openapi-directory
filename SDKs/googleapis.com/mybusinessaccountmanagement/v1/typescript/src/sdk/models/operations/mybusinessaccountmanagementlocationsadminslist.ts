...
export class MybusinessaccountmanagementLocationsAdminsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessaccountmanagementLocationsAdminsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
