 ...
 */
public enum CreateCarrierGatewayRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateCarrierGatewayRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
