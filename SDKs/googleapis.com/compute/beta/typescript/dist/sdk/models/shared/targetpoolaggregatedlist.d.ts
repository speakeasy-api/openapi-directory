...
import { TargetPoolsScopedList } from "./targetpoolsscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum TargetPoolAggregatedListWarningCodeEnum {
...
export declare class TargetPoolAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetPoolAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetPoolAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetPoolAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class TargetPoolAggregatedList extends SpeakeasyBase {
    /**
