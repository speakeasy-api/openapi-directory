...
class GroupUserUploadQuotaSpace
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GroupUserUploadQuotaSpaceShowingEnum $showing
     */
	#[\JMS\Serializer\Annotation\SerializedName('showing')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GroupUserUploadQuotaSpaceShowingEnum>')]
	...
	public function __construct()
	{
		$this->free = 0;
		$this->max = 0;
		$this->showing = \OpenAPI\OpenAPI\Models\Shared\GroupUserUploadQuotaSpaceShowingEnum::LIFETIME;
		$this->used = 0;
	}
}
