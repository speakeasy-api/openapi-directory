...
class ListLogPatternSetsResponse:
    ...
    log_pattern_sets: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LogPatternSets'), 'exclude': lambda f: f is None }})  
