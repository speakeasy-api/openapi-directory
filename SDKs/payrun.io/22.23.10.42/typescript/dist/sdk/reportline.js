...
exports.ReportLine = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var shared = __importStar(require("./models/shared"));
var ReportLine = /** @class */ (function () {
    function ReportLine(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    ReportLine.prototype.getReportLineFromEmployer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportLineFromEmployerRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/Employer/{EmployerId}/ReportLine/{ReportLineId}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetReportLineFromEmployerResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.reportLine = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ReportLine);
                    }
                    break;
     ...
     */
    ReportLine.prototype.getReportLinesFromEmployer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportLinesFromEmployerRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/Employer/{EmployerId}/ReportLines", req);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetReportLinesFromEmployerResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    ReportLine.prototype.getReportLinesFromPayRun = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
