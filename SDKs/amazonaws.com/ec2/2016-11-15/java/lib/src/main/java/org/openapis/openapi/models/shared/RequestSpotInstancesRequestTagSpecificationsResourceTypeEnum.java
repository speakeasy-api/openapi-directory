 ...
 */
public enum RequestSpotInstancesRequestTagSpecificationsResourceTypeEnum {
    ...
    private RequestSpotInstancesRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
