...
class ListRxNormInferenceJobsRequest:
    ...
    list_rx_norm_inference_jobs_request: shared_listrxnorminferencejobsrequest.ListRxNormInferenceJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
