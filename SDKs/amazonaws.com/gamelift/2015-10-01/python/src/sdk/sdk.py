...
SERVERS = [
    ...
    r"""The Amazon GameLift multi-region endpoint"""
    "https://gamelift.{region}.amazonaws.com",
    r"""The Amazon GameLift multi-region endpoint"""
    "http://gamelift.{region}.amazonaws.com.cn",
    r"""The Amazon GameLift endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def accept_match(self, request: operations.AcceptMatchRequest) -> operations.AcceptMatchResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "accept_match_input", 'json')
        ...
        res = operations.AcceptMatchResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def claim_game_server(self, request: operations.ClaimGameServerRequest) -> operations.ClaimGameServerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "claim_game_server_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ClaimGameServerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ClaimGameServerOutput])
    ...
    def create_alias(self, request: operations.CreateAliasRequest) -> operations.CreateAliasResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_alias_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateAliasOutput])
    ...
    def create_build(self, request: operations.CreateBuildRequest) -> operations.CreateBuildResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_build_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateBuildOutput])
    ...
    def create_fleet(self, request: operations.CreateFleetRequest) -> operations.CreateFleetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_fleet_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateFleetOutput])
    ...
    def create_fleet_locations(self, request: operations.CreateFleetLocationsRequest) -> operations.CreateFleetLocationsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_fleet_locations_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateFleetLocationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateFleetLocationsOutput])
    ...
    def create_game_server_group(self, request: operations.CreateGameServerGroupRequest) -> operations.CreateGameServerGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_game_server_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateGameServerGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateGameServerGroupOutput])
    ...
    def create_game_session(self, request: operations.CreateGameSessionRequest) -> operations.CreateGameSessionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_game_session_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateGameSessionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateGameSessionOutput])
    ...
    def create_game_session_queue(self, request: operations.CreateGameSessionQueueRequest) -> operations.CreateGameSessionQueueResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_game_session_queue_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateGameSessionQueueResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateGameSessionQueueOutput])
    ...
    def create_location(self, request: operations.CreateLocationRequest) -> operations.CreateLocationResponse:
        r"""Creates a custom location for use in an Anywhere fleet."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.CreateLocation'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_location_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateLocationOutput])
                res.create_location_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def create_matchmaking_configuration(self, request: operations.CreateMatchmakingConfigurationRequest) -> operations.CreateMatchmakingConfigurationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_matchmaking_configuration_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateMatchmakingConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateMatchmakingConfigurationOutput])
    ...
    def create_matchmaking_rule_set(self, request: operations.CreateMatchmakingRuleSetRequest) -> operations.CreateMatchmakingRuleSetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_matchmaking_rule_set_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateMatchmakingRuleSetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateMatchmakingRuleSetOutput])
    ...
    def create_player_session(self, request: operations.CreatePlayerSessionRequest) -> operations.CreatePlayerSessionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_player_session_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreatePlayerSessionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreatePlayerSessionOutput])
    ...
    def create_player_sessions(self, request: operations.CreatePlayerSessionsRequest) -> operations.CreatePlayerSessionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_player_sessions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreatePlayerSessionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreatePlayerSessionsOutput])
    ...
    def create_script(self, request: operations.CreateScriptRequest) -> operations.CreateScriptResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_script_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateScriptOutput])
    ...
    def create_vpc_peering_authorization(self, request: operations.CreateVpcPeeringAuthorizationRequest) -> operations.CreateVpcPeeringAuthorizationResponse:
        ...
        res = operations.CreateVpcPeeringAuthorizationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateVpcPeeringAuthorizationOutput])
    ...
    def create_vpc_peering_connection(self, request: operations.CreateVpcPeeringConnectionRequest) -> operations.CreateVpcPeeringConnectionResponse:
        ...
        res = operations.CreateVpcPeeringConnectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_alias(self, request: operations.DeleteAliasRequest) -> operations.DeleteAliasResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_alias_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def delete_build(self, request: operations.DeleteBuildRequest) -> operations.DeleteBuildResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_build_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def delete_fleet(self, request: operations.DeleteFleetRequest) -> operations.DeleteFleetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_fleet_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def delete_fleet_locations(self, request: operations.DeleteFleetLocationsRequest) -> operations.DeleteFleetLocationsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_fleet_locations_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteFleetLocationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteFleetLocationsOutput])
    ...
    def delete_game_server_group(self, request: operations.DeleteGameServerGroupRequest) -> operations.DeleteGameServerGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_game_server_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteGameServerGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DeleteGameServerGroupOutput])
    ...
    def delete_game_session_queue(self, request: operations.DeleteGameSessionQueueRequest) -> operations.DeleteGameSessionQueueResponse:
        r"""Deletes a game session queue. Once a queue is successfully deleted, unfulfilled <a href=\\"https://docs.aws.amazon.com/gamelift/latest/apireference/API_StartGameSessionPlacement.html\\">StartGameSessionPlacement</a> requests that reference the queue will fail. To delete a queue, specify the queue name."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.DeleteGameSessionQueue'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_game_session_queue_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteGameSessionQueueResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_location(self, request: operations.DeleteLocationRequest) -> operations.DeleteLocationResponse:
        r"""<p>Deletes a custom location.</p> <p>Before deleting a custom location, review any fleets currently using the custom location and deregister the location if it is in use. For more information see, <a href=\\"https://docs.aws.amazon.com/gamelift/latest/apireference/API_DeregisterCompute.html\\">DeregisterCompute</a>.</p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.DeleteLocation'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_location_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[dict[str, Any]])
                res.delete_location_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def delete_matchmaking_configuration(self, request: operations.DeleteMatchmakingConfigurationRequest) -> operations.DeleteMatchmakingConfigurationResponse:
        r"""Permanently removes a FlexMatch matchmaking configuration. To delete, specify the configuration name. A matchmaking configuration cannot be deleted if it is being used in any active matchmaking tickets."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.DeleteMatchmakingConfiguration'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_matchmaking_configuration_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteMatchmakingConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_matchmaking_rule_set(self, request: operations.DeleteMatchmakingRuleSetRequest) -> operations.DeleteMatchmakingRuleSetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_matchmaking_rule_set_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteMatchmakingRuleSetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_scaling_policy(self, request: operations.DeleteScalingPolicyRequest) -> operations.DeleteScalingPolicyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_scaling_policy_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def delete_script(self, request: operations.DeleteScriptRequest) -> operations.DeleteScriptResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_script_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def delete_vpc_peering_authorization(self, request: operations.DeleteVpcPeeringAuthorizationRequest) -> operations.DeleteVpcPeeringAuthorizationResponse:
        r"""<p>Cancels a pending VPC peering authorization for the specified VPC. If you need to delete an existing VPC peering connection, use <a href=\\"https://docs.aws.amazon.com/gamelift/latest/apireference/API_DeleteVpcPeeringConnection.html\\">DeleteVpcPeeringConnection</a>.</p> <p> <b>Related actions</b> </p> <p> <a href=\\"https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets\\">All APIs by task</a> </p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.DeleteVpcPeeringAuthorization'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_vpc_peering_authorization_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteVpcPeeringAuthorizationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_vpc_peering_connection(self, request: operations.DeleteVpcPeeringConnectionRequest) -> operations.DeleteVpcPeeringConnectionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_vpc_peering_connection_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteVpcPeeringConnectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def deregister_compute(self, request: operations.DeregisterComputeRequest) -> operations.DeregisterComputeResponse:
        r"""Removes a compute resource from the specified fleet. Deregister your compute resources before you delete the compute."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.DeregisterCompute'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "deregister_compute_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeregisterComputeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[dict[str, Any]])
                res.deregister_compute_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def deregister_game_server(self, request: operations.DeregisterGameServerRequest) -> operations.DeregisterGameServerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "deregister_game_server_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeregisterGameServerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_alias(self, request: operations.DescribeAliasRequest) -> operations.DescribeAliasResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_alias_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeAliasResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeAliasOutput])
    ...
    def describe_build(self, request: operations.DescribeBuildRequest) -> operations.DescribeBuildResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_build_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeBuildResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeBuildOutput])
    ...
    def describe_compute(self, request: operations.DescribeComputeRequest) -> operations.DescribeComputeResponse:
        r"""Retrieves properties for a compute resource. To request a compute resource specify the fleet ID and compute name. If successful, GameLift returns an object containing the build properties."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.DescribeCompute'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_compute_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeComputeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeComputeOutput])
                res.describe_compute_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def describe_ec2_instance_limits(self, request: operations.DescribeEc2InstanceLimitsRequest) -> operations.DescribeEc2InstanceLimitsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_ec2_instance_limits_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeEc2InstanceLimitsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeEc2InstanceLimitsOutput])
    ...
    def describe_fleet_attributes(self, request: operations.DescribeFleetAttributesRequest) -> operations.DescribeFleetAttributesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_attributes_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeFleetAttributesRequest, request)
        ...
        res = operations.DescribeFleetAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetAttributesOutput])
    ...
    def describe_fleet_capacity(self, request: operations.DescribeFleetCapacityRequest) -> operations.DescribeFleetCapacityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_capacity_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeFleetCapacityRequest, request)
        ...
        res = operations.DescribeFleetCapacityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetCapacityOutput])
    ...
    def describe_fleet_events(self, request: operations.DescribeFleetEventsRequest) -> operations.DescribeFleetEventsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_events_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeFleetEventsRequest, request)
        ...
        res = operations.DescribeFleetEventsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetEventsOutput])
    ...
    def describe_fleet_location_attributes(self, request: operations.DescribeFleetLocationAttributesRequest) -> operations.DescribeFleetLocationAttributesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_location_attributes_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeFleetLocationAttributesRequest, request)
        ...
        res = operations.DescribeFleetLocationAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetLocationAttributesOutput])
    ...
    def describe_fleet_location_capacity(self, request: operations.DescribeFleetLocationCapacityRequest) -> operations.DescribeFleetLocationCapacityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_location_capacity_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeFleetLocationCapacityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetLocationCapacityOutput])
    ...
    def describe_fleet_location_utilization(self, request: operations.DescribeFleetLocationUtilizationRequest) -> operations.DescribeFleetLocationUtilizationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_location_utilization_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeFleetLocationUtilizationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetLocationUtilizationOutput])
    ...
    def describe_fleet_port_settings(self, request: operations.DescribeFleetPortSettingsRequest) -> operations.DescribeFleetPortSettingsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_port_settings_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeFleetPortSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetPortSettingsOutput])
    ...
    def describe_fleet_utilization(self, request: operations.DescribeFleetUtilizationRequest) -> operations.DescribeFleetUtilizationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_fleet_utilization_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeFleetUtilizationRequest, request)
        ...
        res = operations.DescribeFleetUtilizationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeFleetUtilizationOutput])
    ...
    def describe_game_server(self, request: operations.DescribeGameServerRequest) -> operations.DescribeGameServerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_game_server_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeGameServerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeGameServerOutput])
    ...
    def describe_game_server_group(self, request: operations.DescribeGameServerGroupRequest) -> operations.DescribeGameServerGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_game_server_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeGameServerGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeGameServerGroupOutput])
    ...
    def describe_game_server_instances(self, request: operations.DescribeGameServerInstancesRequest) -> operations.DescribeGameServerInstancesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_game_server_instances_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeGameServerInstancesRequest, request)
        ...
        res = operations.DescribeGameServerInstancesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeGameServerInstancesOutput])
    ...
    def describe_game_session_details(self, request: operations.DescribeGameSessionDetailsRequest) -> operations.DescribeGameSessionDetailsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_game_session_details_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeGameSessionDetailsRequest, request)
        ...
        res = operations.DescribeGameSessionDetailsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeGameSessionDetailsOutput])
    ...
    def describe_game_session_placement(self, request: operations.DescribeGameSessionPlacementRequest) -> operations.DescribeGameSessionPlacementResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_game_session_placement_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeGameSessionPlacementResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeGameSessionPlacementOutput])
    ...
    def describe_game_session_queues(self, request: operations.DescribeGameSessionQueuesRequest) -> operations.DescribeGameSessionQueuesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_game_session_queues_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeGameSessionQueuesRequest, request)
        ...
        res = operations.DescribeGameSessionQueuesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeGameSessionQueuesOutput])
    ...
    def describe_game_sessions(self, request: operations.DescribeGameSessionsRequest) -> operations.DescribeGameSessionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_game_sessions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeGameSessionsRequest, request)
        ...
        res = operations.DescribeGameSessionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeGameSessionsOutput])
    ...
    def describe_instances(self, request: operations.DescribeInstancesRequest) -> operations.DescribeInstancesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_instances_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeInstancesRequest, request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeInstancesOutput])
    ...
    def describe_matchmaking(self, request: operations.DescribeMatchmakingRequest) -> operations.DescribeMatchmakingResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_matchmaking_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeMatchmakingResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeMatchmakingOutput])
    ...
    def describe_matchmaking_configurations(self, request: operations.DescribeMatchmakingConfigurationsRequest) -> operations.DescribeMatchmakingConfigurationsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_matchmaking_configurations_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeMatchmakingConfigurationsRequest, request)
        ...
        res = operations.DescribeMatchmakingConfigurationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeMatchmakingConfigurationsOutput])
    ...
    def describe_matchmaking_rule_sets(self, request: operations.DescribeMatchmakingRuleSetsRequest) -> operations.DescribeMatchmakingRuleSetsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_matchmaking_rule_sets_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeMatchmakingRuleSetsRequest, request)
        ...
        res = operations.DescribeMatchmakingRuleSetsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeMatchmakingRuleSetsOutput])
    ...
    def describe_player_sessions(self, request: operations.DescribePlayerSessionsRequest) -> operations.DescribePlayerSessionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_player_sessions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribePlayerSessionsRequest, request)
        ...
        res = operations.DescribePlayerSessionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribePlayerSessionsOutput])
    ...
    def describe_runtime_configuration(self, request: operations.DescribeRuntimeConfigurationRequest) -> operations.DescribeRuntimeConfigurationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_runtime_configuration_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeRuntimeConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeRuntimeConfigurationOutput])
    ...
    def describe_scaling_policies(self, request: operations.DescribeScalingPoliciesRequest) -> operations.DescribeScalingPoliciesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_scaling_policies_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeScalingPoliciesOutput])
    ...
    def describe_script(self, request: operations.DescribeScriptRequest) -> operations.DescribeScriptResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_script_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeScriptResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeScriptOutput])
    ...
    def describe_vpc_peering_authorizations(self, request: operations.DescribeVpcPeeringAuthorizationsRequest) -> operations.DescribeVpcPeeringAuthorizationsResponse:
        ...
        res = operations.DescribeVpcPeeringAuthorizationsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeVpcPeeringAuthorizationsOutput])
    ...
    def describe_vpc_peering_connections(self, request: operations.DescribeVpcPeeringConnectionsRequest) -> operations.DescribeVpcPeeringConnectionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_vpc_peering_connections_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeVpcPeeringConnectionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeVpcPeeringConnectionsOutput])
    ...
    def get_compute_access(self, request: operations.GetComputeAccessRequest) -> operations.GetComputeAccessResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.GetComputeAccess'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_compute_access_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetComputeAccessResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetComputeAccessOutput])
                res.get_compute_access_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def get_compute_auth_token(self, request: operations.GetComputeAuthTokenRequest) -> operations.GetComputeAuthTokenResponse:
        r"""Requests an authorization token from GameLift. The authorization token is used by your game server to authenticate with GameLift. Each authentication token has an expiration token. To continue using the compute resource to host your game server, regularly retrieve a new authorization token."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.GetComputeAuthToken'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_compute_auth_token_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetComputeAuthTokenResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetComputeAuthTokenOutput])
                res.get_compute_auth_token_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def get_game_session_log_url(self, request: operations.GetGameSessionLogURLRequest) -> operations.GetGameSessionLogURLResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_game_session_log_url_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetGameSessionLogURLResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetGameSessionLogURLOutput])
    ...
    def get_instance_access(self, request: operations.GetInstanceAccessRequest) -> operations.GetInstanceAccessResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_instance_access_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetInstanceAccessResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetInstanceAccessOutput])
    ...
    def list_aliases(self, request: operations.ListAliasesRequest) -> operations.ListAliasesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_aliases_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListAliasesOutput])
    ...
    def list_compute(self, request: operations.ListComputeRequest) -> operations.ListComputeResponse:
        r"""Retrieves all compute resources registered to a fleet in your Amazon Web Services account. You can filter the result set by location."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.ListCompute'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_compute_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListComputeRequest, request)
        ...
        res = operations.ListComputeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListComputeOutput])
                res.list_compute_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def list_fleets(self, request: operations.ListFleetsRequest) -> operations.ListFleetsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_fleets_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListFleetsOutput])
    ...
    def list_game_server_groups(self, request: operations.ListGameServerGroupsRequest) -> operations.ListGameServerGroupsResponse:
        r"""Lists a game server groups."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.ListGameServerGroups'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_game_server_groups_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListGameServerGroupsRequest, request)
        ...
        res = operations.ListGameServerGroupsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListGameServerGroupsOutput])
    ...
    def list_game_servers(self, request: operations.ListGameServersRequest) -> operations.ListGameServersResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_game_servers_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListGameServersRequest, request)
        ...
        res = operations.ListGameServersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListGameServersOutput])
    ...
    def list_locations(self, request: operations.ListLocationsRequest) -> operations.ListLocationsResponse:
        r"""Lists all custom and Amazon Web Services locations."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.ListLocations'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_locations_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListLocationsOutput])
                res.list_locations_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def list_scripts(self, request: operations.ListScriptsRequest) -> operations.ListScriptsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_scripts_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListScriptsRequest, request)
        ...
        res = operations.ListScriptsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListScriptsOutput])
    ...
    def put_scaling_policy(self, request: operations.PutScalingPolicyRequest) -> operations.PutScalingPolicyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "put_scaling_policy_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PutScalingPolicyOutput])
    ...
    def register_compute(self, request: operations.RegisterComputeRequest) -> operations.RegisterComputeResponse:
        r"""<p>Registers your compute resources in a fleet you previously created. After you register a compute to your fleet, you can monitor and manage your compute using GameLift. The operation returns the compute resource containing SDK endpoint you can use to connect your game server to GameLift.</p> <p> <b>Learn more</b> </p> <ul> <li> <p> <a href=\\"https://docs.aws.amazon.com/gamelift/latest/developerguide/fleets-creating-anywhere.html\\">Create an Anywhere fleet</a> </p> </li> <li> <p> <a href=\\"https://docs.aws.amazon.com/gamelift/latest/developerguide/integration-testing.html\\">Test your integration</a> </p> </li> </ul>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.RegisterCompute'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_compute_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RegisterComputeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RegisterComputeOutput])
                res.register_compute_output = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.unauthorized_exception = out
    ...
    def register_game_server(self, request: operations.RegisterGameServerRequest) -> operations.RegisterGameServerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_game_server_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RegisterGameServerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RegisterGameServerOutput])
    ...
    def request_upload_credentials(self, request: operations.RequestUploadCredentialsRequest) -> operations.RequestUploadCredentialsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "request_upload_credentials_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RequestUploadCredentialsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RequestUploadCredentialsOutput])
    ...
    def resolve_alias(self, request: operations.ResolveAliasRequest) -> operations.ResolveAliasResponse:
        r"""<p>Retrieves the fleet ID that an alias is currently pointing to.</p> <p> <b>Related actions</b> </p> <p> <a href=\\"https://docs.aws.amazon.com/gamelift/latest/developerguide/reference-awssdk.html#reference-awssdk-resources-fleets\\">All APIs by task</a> </p>"""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.ResolveAlias'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "resolve_alias_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ResolveAliasResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ResolveAliasOutput])
    ...
    def resume_game_server_group(self, request: operations.ResumeGameServerGroupRequest) -> operations.ResumeGameServerGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "resume_game_server_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ResumeGameServerGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ResumeGameServerGroupOutput])
    ...
    def search_game_sessions(self, request: operations.SearchGameSessionsRequest) -> operations.SearchGameSessionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "search_game_sessions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.SearchGameSessionsRequest, request)
        ...
        res = operations.SearchGameSessionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SearchGameSessionsOutput])
    ...
    def start_fleet_actions(self, request: operations.StartFleetActionsRequest) -> operations.StartFleetActionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_fleet_actions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartFleetActionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartFleetActionsOutput])
    ...
    def start_game_session_placement(self, request: operations.StartGameSessionPlacementRequest) -> operations.StartGameSessionPlacementResponse:
        ...
        res = operations.StartGameSessionPlacementResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartGameSessionPlacementOutput])
    ...
    def start_match_backfill(self, request: operations.StartMatchBackfillRequest) -> operations.StartMatchBackfillResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_match_backfill_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartMatchBackfillResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartMatchBackfillOutput])
    ...
    def start_matchmaking(self, request: operations.StartMatchmakingRequest) -> operations.StartMatchmakingResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_matchmaking_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartMatchmakingResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartMatchmakingOutput])
    ...
    def stop_fleet_actions(self, request: operations.StopFleetActionsRequest) -> operations.StopFleetActionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "stop_fleet_actions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StopFleetActionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StopFleetActionsOutput])
    ...
    def stop_game_session_placement(self, request: operations.StopGameSessionPlacementRequest) -> operations.StopGameSessionPlacementResponse:
        r"""Cancels a game session placement that is in <code>PENDING</code> status. To stop a placement, provide the placement ID values. If successful, the placement is moved to <code>CANCELLED</code> status."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=GameLift.StopGameSessionPlacement'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "stop_game_session_placement_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StopGameSessionPlacementResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StopGameSessionPlacementOutput])
    ...
    def stop_matchmaking(self, request: operations.StopMatchmakingRequest) -> operations.StopMatchmakingResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "stop_matchmaking_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StopMatchmakingResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def suspend_game_server_group(self, request: operations.SuspendGameServerGroupRequest) -> operations.SuspendGameServerGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "suspend_game_server_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SuspendGameServerGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SuspendGameServerGroupOutput])
    ...
    def update_alias(self, request: operations.UpdateAliasRequest) -> operations.UpdateAliasResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_alias_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateAliasOutput])
    ...
    def update_build(self, request: operations.UpdateBuildRequest) -> operations.UpdateBuildResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_build_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateBuildResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateBuildOutput])
    ...
    def update_fleet_attributes(self, request: operations.UpdateFleetAttributesRequest) -> operations.UpdateFleetAttributesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_fleet_attributes_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateFleetAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateFleetAttributesOutput])
    ...
    def update_fleet_capacity(self, request: operations.UpdateFleetCapacityRequest) -> operations.UpdateFleetCapacityResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_fleet_capacity_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateFleetCapacityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateFleetCapacityOutput])
    ...
    def update_fleet_port_settings(self, request: operations.UpdateFleetPortSettingsRequest) -> operations.UpdateFleetPortSettingsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_fleet_port_settings_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateFleetPortSettingsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateFleetPortSettingsOutput])
    ...
    def update_game_server(self, request: operations.UpdateGameServerRequest) -> operations.UpdateGameServerResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_game_server_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateGameServerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateGameServerOutput])
    ...
    def update_game_server_group(self, request: operations.UpdateGameServerGroupRequest) -> operations.UpdateGameServerGroupResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_game_server_group_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateGameServerGroupResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateGameServerGroupOutput])
    ...
    def update_game_session(self, request: operations.UpdateGameSessionRequest) -> operations.UpdateGameSessionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_game_session_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateGameSessionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateGameSessionOutput])
    ...
    def update_game_session_queue(self, request: operations.UpdateGameSessionQueueRequest) -> operations.UpdateGameSessionQueueResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_game_session_queue_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateGameSessionQueueResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateGameSessionQueueOutput])
    ...
    def update_matchmaking_configuration(self, request: operations.UpdateMatchmakingConfigurationRequest) -> operations.UpdateMatchmakingConfigurationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_matchmaking_configuration_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateMatchmakingConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateMatchmakingConfigurationOutput])
    ...
    def update_runtime_configuration(self, request: operations.UpdateRuntimeConfigurationRequest) -> operations.UpdateRuntimeConfigurationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_runtime_configuration_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateRuntimeConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateRuntimeConfigurationOutput])
    ...
    def update_script(self, request: operations.UpdateScriptRequest) -> operations.UpdateScriptResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_script_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.UpdateScriptOutput])
    ...
    def validate_matchmaking_rule_set(self, request: operations.ValidateMatchmakingRuleSetRequest) -> operations.ValidateMatchmakingRuleSetResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "validate_matchmaking_rule_set_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ValidateMatchmakingRuleSetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ValidateMatchmakingRuleSetOutput])
