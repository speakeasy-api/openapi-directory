...
public class ProcessorBankTransferCreateRequest {
    ...
    public ProcessorBankTransferCreateRequest(@JsonProperty("amount") String amount, @JsonProperty("description") String description, @JsonProperty("idempotency_key") String idempotencyKey, @JsonProperty("iso_currency_code") String isoCurrencyCode, @JsonProperty("network") BankTransferNetworkEnum network, @JsonProperty("processor_token") String processorToken, @JsonProperty("type") BankTransferTypeEnum type, @JsonProperty("user") java.util.Map<String, Object> user) {
        this.amount = amount;
        this.description = description;
        this.idempotencyKey = idempotencyKey;
        this.isoCurrencyCode = isoCurrencyCode;
