...
import dataclasses
from ..shared import googleclouddocumentaiv1beta2documentrevisionhumanreview as shared_googleclouddocumentaiv1beta2documentrevisionhumanreview
...
class GoogleCloudDocumentaiV1beta2DocumentRevision:
    ...
    human_review: Optional[shared_googleclouddocumentaiv1beta2documentrevisionhumanreview.GoogleCloudDocumentaiV1beta2DocumentRevisionHumanReview] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('humanReview'), 'exclude': lambda f: f is None }})
