...
public class GetAnswersIdsRequest {
    ...
    public GetAnswersIdsRequest withCallback(String callback) {
    ...
    public GetAnswersIdsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetAnswersIdsRequest withFromdate(Long fromdate) {
    ...
    public GetAnswersIdsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetAnswersIdsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetAnswersIdsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetAnswersIdsRequest withOrder(GetAnswersIdsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetAnswersIdsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetAnswersIdsRequest withPagesize(Long pagesize) {
    ...
    public GetAnswersIdsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetAnswersIdsRequest withSort(GetAnswersIdsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetAnswersIdsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetAnswersIdsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
