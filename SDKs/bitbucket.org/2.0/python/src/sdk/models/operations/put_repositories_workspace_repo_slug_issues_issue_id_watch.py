...
class PutRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchRequest:
    path_params: PutRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchPathParams = dataclasses.field()
    security: PutRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchSecurity = dataclasses.field()
