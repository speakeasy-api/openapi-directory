...
class UpdateOAuthClientRequest:
    r"""Request model for updating an OAuth client"""
    
    grant_types: UpdateOAuthClientRequestGrantTypesEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('grantTypes') }})
    r"""Authorized grant types
    ...
    * `refresh_token`
    ...
    client_type: Optional[UpdateOAuthClientRequestClientTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('clientType'), 'exclude': lambda f: f is None }})
    r"""Determines whether client is a confidential or public client."""  
