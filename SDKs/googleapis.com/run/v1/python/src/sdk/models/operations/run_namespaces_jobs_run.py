...
@dataclasses.dataclass
class RunNamespacesJobsRunQueryParams:
...
class RunNamespacesJobsRunRequest:
    path_params: RunNamespacesJobsRunPathParams = dataclasses.field()
    query_params: RunNamespacesJobsRunQueryParams = dataclasses.field()
    security: RunNamespacesJobsRunSecurity = dataclasses.field()
