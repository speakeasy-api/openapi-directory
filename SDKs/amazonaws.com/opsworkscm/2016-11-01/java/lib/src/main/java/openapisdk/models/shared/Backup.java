...
public class Backup {
    ...
    public java.util.Map<String, Object> s3DataSize;
    public Backup withS3DataSize(java.util.Map<String, Object> s3DataSize) {
        this.s3DataSize = s3DataSize;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("S3DataUrl")
    public java.util.Map<String, Object> s3DataUrl;
    public Backup withS3DataUrl(java.util.Map<String, Object> s3DataUrl) {
