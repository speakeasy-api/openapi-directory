...
export class DisplayvideoAdvertisersLocationListsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersLocationListsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersLocationListsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
