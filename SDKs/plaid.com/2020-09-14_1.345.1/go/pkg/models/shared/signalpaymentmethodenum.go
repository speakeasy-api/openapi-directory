...
func (e SignalPaymentMethodEnum) ToPointer() *SignalPaymentMethodEnum {
	return &e
}
...
func (e *SignalPaymentMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "MULTIPLE_PAYMENT_METHODS":
		*e = SignalPaymentMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SignalPaymentMethodEnum: %v", v)
	}
}
