...
type UKBaseListing struct {
	...
	CarLocation *CarLocation `json:"car_location,omitempty"`
	...
	InsuranceGroup *string `json:"insurance_group,omitempty"`
	...
	// Number of owners
	NumOwners *string `json:"num_owners,omitempty"`
	...
	// UVC ID of the car
	UvcID *string `json:"uvc_id,omitempty"`
