...
public class GetMeQuestionsUnacceptedRequest {
    ...
    public GetMeQuestionsUnacceptedRequest withCallback(String callback) {
    ...
    public GetMeQuestionsUnacceptedRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetMeQuestionsUnacceptedRequest withFromdate(Long fromdate) {
    ...
    public GetMeQuestionsUnacceptedRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetMeQuestionsUnacceptedRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetMeQuestionsUnacceptedRequest withOrder(GetMeQuestionsUnacceptedOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetMeQuestionsUnacceptedRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetMeQuestionsUnacceptedRequest withPagesize(Long pagesize) {
    ...
    public GetMeQuestionsUnacceptedRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetMeQuestionsUnacceptedRequest withSort(GetMeQuestionsUnacceptedSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetMeQuestionsUnacceptedRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetMeQuestionsUnacceptedRequest(@JsonProperty("site") String site) {
        this.site = site;
  }
}
