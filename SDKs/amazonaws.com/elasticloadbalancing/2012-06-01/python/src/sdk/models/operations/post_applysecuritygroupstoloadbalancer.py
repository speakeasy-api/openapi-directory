...
class PostApplySecurityGroupsToLoadBalancerQueryParams:
    action: PostApplySecurityGroupsToLoadBalancerActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostApplySecurityGroupsToLoadBalancerVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostApplySecurityGroupsToLoadBalancerRequest:
    headers: PostApplySecurityGroupsToLoadBalancerHeaders = dataclasses.field()
    query_params: PostApplySecurityGroupsToLoadBalancerQueryParams = dataclasses.field()
