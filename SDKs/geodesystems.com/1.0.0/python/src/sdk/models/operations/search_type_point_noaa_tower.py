...
class SearchTypePointNoaaTowerQueryParams:
    ...
    search_type_point_noaa_tower_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_tower.site_id', 'style': 'form', 'explode': True }})
...
class SearchTypePointNoaaTowerRequest:
    query_params: SearchTypePointNoaaTowerQueryParams = dataclasses.field()
