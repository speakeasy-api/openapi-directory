...
export const ListBundleCopyServerList = ["https://numbers.twilio.com"] as const;
...
export class ListBundleCopyListBundleCopyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListBundleCopyListBundleCopyResponseMeta)
  ...
  @Expose({ name: "results" })
  @Type(() => shared.NumbersV2RegulatoryComplianceBundleBundleCopy)
