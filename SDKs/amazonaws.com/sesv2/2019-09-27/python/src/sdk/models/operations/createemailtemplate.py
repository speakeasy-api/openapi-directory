...
class CreateEmailTemplateRequestBody:
    template_content: CreateEmailTemplateRequestBodyTemplateContent = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TemplateContent') }})
...
class CreateEmailTemplateResponse:
    ...
    create_email_template_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
