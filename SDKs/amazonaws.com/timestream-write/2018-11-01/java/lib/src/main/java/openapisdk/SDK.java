...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.CreateDatabaseResponse createDatabase(openapisdk.models.operations.CreateDatabaseRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.CreateDatabase");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CreateDatabaseResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateDatabaseResponse.class);
    ...
    **/
    public openapisdk.models.operations.CreateTableResponse createTable(openapisdk.models.operations.CreateTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.CreateTable");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.CreateTableResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateTableResponse.class);
    ...
    **/
    public openapisdk.models.operations.DeleteDatabaseResponse deleteDatabase(openapisdk.models.operations.DeleteDatabaseRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.DeleteDatabase");
    ...
    **/
    public openapisdk.models.operations.DeleteTableResponse deleteTable(openapisdk.models.operations.DeleteTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.DeleteTable");
    ...
    **/
    public openapisdk.models.operations.DescribeDatabaseResponse describeDatabase(openapisdk.models.operations.DescribeDatabaseRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.DescribeDatabase");
        ...
        openapisdk.models.operations.DescribeDatabaseResponse res = new openapisdk.models.operations.DescribeDatabaseResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeDatabaseResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeDatabaseResponse.class);
    ...
    **/
    public openapisdk.models.operations.DescribeEndpointsResponse describeEndpoints(openapisdk.models.operations.DescribeEndpointsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.DescribeEndpoints");
    ...
    **/
    public openapisdk.models.operations.DescribeTableResponse describeTable(openapisdk.models.operations.DescribeTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.DescribeTable");
    ...
    **/
    public openapisdk.models.operations.ListDatabasesResponse listDatabases(openapisdk.models.operations.ListDatabasesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.ListDatabases");
    ...
    **/
    public openapisdk.models.operations.ListTablesResponse listTables(openapisdk.models.operations.ListTablesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.ListTables");
    ...
    **/
    public openapisdk.models.operations.ListTagsForResourceResponse listTagsForResource(openapisdk.models.operations.ListTagsForResourceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.ListTagsForResource");
    ...
    **/
    public openapisdk.models.operations.TagResourceResponse tagResource(openapisdk.models.operations.TagResourceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.TagResource");
    ...
    **/
    public openapisdk.models.operations.UntagResourceResponse untagResource(openapisdk.models.operations.UntagResourceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.UntagResource");
    ...
    **/
    public openapisdk.models.operations.UpdateDatabaseResponse updateDatabase(openapisdk.models.operations.UpdateDatabaseRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.UpdateDatabase");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateDatabaseResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateDatabaseResponse.class);
    ...
    **/
    public openapisdk.models.operations.UpdateTableResponse updateTable(openapisdk.models.operations.UpdateTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.UpdateTable");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateTableResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateTableResponse.class);
    ...
    **/
    public openapisdk.models.operations.WriteRecordsResponse writeRecords(openapisdk.models.operations.WriteRecordsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=Timestream_20181101.WriteRecords");
        ...
        openapisdk.models.operations.WriteRecordsResponse res = new openapisdk.models.operations.WriteRecordsResponse() {{
            internalServerException = null;
            throttlingException = null;
            validationException = null;
            resourceNotFoundException = null;
