...
var GooglePrivacyDlpV2AnalyzeDataSourceRiskDetails = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "categoricalStatsResult" }),
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2categoricalstatsresult_1.GooglePrivacyDlpV2CategoricalStatsResult; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "deltaPresenceEstimationResult" }),
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2deltapresenceestimationresult_1.GooglePrivacyDlpV2DeltaPresenceEstimationResult; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kAnonymityResult" }),
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2kanonymityresult_1.GooglePrivacyDlpV2KAnonymityResult; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kMapEstimationResult" }),
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2kmapestimationresult_1.GooglePrivacyDlpV2KMapEstimationResult; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lDiversityResult" }),
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2ldiversityresult_1.GooglePrivacyDlpV2LDiversityResult; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "numericalStatsResult" }),
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2numericalstatsresult_1.GooglePrivacyDlpV2NumericalStatsResult; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2requestedriskanalysisoptions_1.GooglePrivacyDlpV2RequestedRiskAnalysisOptions; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "requestedPrivacyMetric" }),
        (0, class_transformer_1.Type)(function () { return googleprivacydlpv2privacymetric_1.GooglePrivacyDlpV2PrivacyMetric; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "requestedSourceTable" }),
