...
class CreateRecordingSettingsCreateRecordingSettingsRequest:
    ...
    r"""A descriptive string that you create to describe the resource and be shown to users in the console"""  
    ...
    r"""Whether all recordings should be written to the `aws_s3_url`. When `false`, all recordings are stored in our cloud."""  
    encryption_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'form': { 'field_name': 'EncryptionEnabled' }})
    r"""Whether all recordings should be stored in an encrypted form. The default is `false`."""  
