...
exports.DeletedApplications = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var DeletedApplications = /** @class */ (function () {
    function DeletedApplications(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    DeletedApplications.prototype.deletedApplicationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeletedApplicationsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{tenantID}/deletedApplications", req.pathParams);
    ...
    **/
    DeletedApplications.prototype.deletedApplicationsRestore = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeletedApplicationsRestoreRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{tenantID}/deletedApplications/{objectId}/restore", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
