...
from ..shared import fantasydefensegameprojection as shared_fantasydefensegameprojection
...
class ProjectedFantasyDefenseGameStatsWDfsSalariesResponse:
    ...
    fantasy_defense_game_projections: Optional[list[shared_fantasydefensegameprojection.FantasyDefenseGameProjection]] = dataclasses.field(default=None)  
