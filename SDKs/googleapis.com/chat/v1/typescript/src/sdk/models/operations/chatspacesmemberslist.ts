...
export class ChatSpacesMembersListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ChatSpacesMembersListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ChatSpacesMembersListSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ChatSpacesMembersListSecurity extends SpeakeasyBase {
  ...
  option1?: ChatSpacesMembersListSecurityOption1;

  @SpeakeasyMetadata({ data: "security, option=true" })
  option2?: ChatSpacesMembersListSecurityOption2;

  @SpeakeasyMetadata({ data: "security, option=true" })
  option3?: ChatSpacesMembersListSecurityOption3;
}
