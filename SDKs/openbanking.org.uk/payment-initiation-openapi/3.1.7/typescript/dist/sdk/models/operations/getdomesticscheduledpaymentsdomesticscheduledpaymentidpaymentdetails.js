...
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsResponse = exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest = exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsSecurity = void 0;
...
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsSecurity = GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsSecurity;
var GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomesticScheduledPaymentId",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest.prototype, "domesticScheduledPaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest.prototype, "xFapiInteractionId", void 0);
    return GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest;
}(utils_1.SpeakeasyBase));
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest = GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsRequest;
var GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsResponse.prototype, "rawResponse", void 0);
    return GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsResponse;
}(utils_1.SpeakeasyBase));
exports.GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsResponse = GetDomesticScheduledPaymentsDomesticScheduledPaymentIdPaymentDetailsResponse;
