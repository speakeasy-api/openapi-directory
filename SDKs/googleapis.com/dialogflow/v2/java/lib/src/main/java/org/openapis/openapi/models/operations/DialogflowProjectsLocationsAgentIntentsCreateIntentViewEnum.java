 ...
 */
public enum DialogflowProjectsLocationsAgentIntentsCreateIntentViewEnum {
    ...
    private DialogflowProjectsLocationsAgentIntentsCreateIntentViewEnum(String value) {
        this.value = value;
    }
}
