...
public class ListMonitoringAlertHistoryRequest {
    ...
    public ListMonitoringAlertHistoryRequest(@JsonProperty("ListMonitoringAlertHistoryRequest") org.openapis.openapi.models.shared.ListMonitoringAlertHistoryRequest listMonitoringAlertHistoryRequest, @JsonProperty("X-Amz-Target") ListMonitoringAlertHistoryXAmzTargetEnum xAmzTarget) {
        this.listMonitoringAlertHistoryRequest = listMonitoringAlertHistoryRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
