...
exports.ChannelsModerators = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ChannelsModerators = /** @class */ (function () {
    function ChannelsModerators(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ChannelsModerators.prototype.addChannelModerator = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddChannelModeratorRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/channels/{channel_id}/moderators/{user_id}", req.pathParams);
    ...
    **/
    ChannelsModerators.prototype.addChannelModerators = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddChannelModeratorsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/channels/{channel_id}/moderators", req.pathParams);
    ...
    **/
    ChannelsModerators.prototype.getChannelModerator = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsModerators.prototype.getChannelModerators = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsModerators.prototype.removeChannelModerator = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsModerators.prototype.removeChannelModerators = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsModerators.prototype.replaceChannelModerators = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ChannelsModerators = ChannelsModerators;
