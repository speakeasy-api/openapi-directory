...
public class StorageDefaultObjectAccessControlsListRequest {
    ...
    public StorageDefaultObjectAccessControlsListRequest withUploadType(String uploadType) {
    ...
    public StorageDefaultObjectAccessControlsListRequest withUserProject(String userProject) {
