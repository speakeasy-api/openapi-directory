...
class OBWriteDomesticStandingOrderConsentResponse6DataAuthorisation:
    ...
    authorisation_type: OBWriteDomesticStandingOrderConsentResponse6DataAuthorisationAuthorisationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorisationType') }})
    r"""Type of authorisation flow requested."""  
...
class OBWriteDomesticStandingOrderConsentResponse6DataInitiation:
    ...
    creditor_account: OBWriteDomesticStandingOrderConsentResponse6DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Identification assigned by an institution to identify an account. This identification is known by the account owner."""  
    first_payment_amount: OBWriteDomesticStandingOrderConsentResponse6DataInitiationFirstPaymentAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FirstPaymentAmount') }})
    r"""The amount of the first Standing Order"""  
    ...
    """  
    debtor_account: Optional[OBWriteDomesticStandingOrderConsentResponse6DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction."""  
    final_payment_amount: Optional[OBWriteDomesticStandingOrderConsentResponse6DataInitiationFinalPaymentAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FinalPaymentAmount'), 'exclude': lambda f: f is None }})
    r"""The amount of the final Standing Order"""  
    ...
    recurring_payment_amount: Optional[OBWriteDomesticStandingOrderConsentResponse6DataInitiationRecurringPaymentAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RecurringPaymentAmount'), 'exclude': lambda f: f is None }})
    r"""The amount of the recurring Standing Order"""  
...
class OBWriteDomesticStandingOrderConsentResponse6Data:
    ...
    2017-04-05T10:43:07+00:00
    """  
    initiation: OBWriteDomesticStandingOrderConsentResponse6DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for a domestic standing order."""  
    permission: OBWriteDomesticStandingOrderConsentResponse6DataPermissionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Permission') }})
    r"""Specifies the Open Banking service request types."""  
    status: OBWriteDomesticStandingOrderConsentResponse6DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    r"""Specifies the status of consent resource in code form."""  
    ...
    2017-04-05T10:43:07+00:00
    """  
    authorisation: Optional[OBWriteDomesticStandingOrderConsentResponse6DataAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Authorisation'), 'exclude': lambda f: f is None }})
    r"""The authorisation type request from the TPP."""  
    charges: Optional[list[OBWriteDomesticStandingOrderConsentResponse6DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Charges'), 'exclude': lambda f: f is None }})  
    ...
    read_refund_account: Optional[OBWriteDomesticStandingOrderConsentResponse6DataReadRefundAccountEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ReadRefundAccount'), 'exclude': lambda f: f is None }})
    r"""Specifies to share the refund account details with PISP"""  
...
class OBWriteDomesticStandingOrderConsentResponse6:
    ...
    data: OBWriteDomesticStandingOrderConsentResponse6Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
