...
type SearchTypePointIcebridgeParisQueryParams struct {
...
type SearchTypePointIcebridgeParisRequest struct {
	QueryParams SearchTypePointIcebridgeParisQueryParams
}

type SearchTypePointIcebridgeParisResponse struct {
	ContentType string
	StatusCode  int
