...
class GetRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchSecurity = dataclasses.field()
