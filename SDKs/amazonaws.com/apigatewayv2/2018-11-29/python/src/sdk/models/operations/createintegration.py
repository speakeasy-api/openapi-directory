...
class CreateIntegrationRequestBody:
    ...
    integration_type: CreateIntegrationRequestBodyIntegrationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('integrationType') }})
    r"""Represents an API method integration type."""  
    ...
    connection_type: Optional[CreateIntegrationRequestBodyConnectionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connectionType'), 'exclude': lambda f: f is None }})
    r"""Represents a connection type."""  
    content_handling_strategy: Optional[CreateIntegrationRequestBodyContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contentHandlingStrategy'), 'exclude': lambda f: f is None }})
    r"""Specifies how to handle response payload content type conversions. Supported only for WebSocket APIs."""  
    ...
    passthrough_behavior: Optional[CreateIntegrationRequestBodyPassthroughBehaviorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('passthroughBehavior'), 'exclude': lambda f: f is None }})
    r"""Represents passthrough behavior for an integration response. Supported only for WebSocket APIs."""  
    ...
    tls_config: Optional[CreateIntegrationRequestBodyTLSConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tlsConfig'), 'exclude': lambda f: f is None }})
    r"""The TLS configuration for a private integration. If you specify a TLS configuration, private integration traffic uses the HTTPS protocol. Supported only for HTTP APIs."""  
...
class CreateIntegrationRequest:
    ...
    request_body: CreateIntegrationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
