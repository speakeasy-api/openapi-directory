...
@dataclasses.dataclass
class ListInvalidations20181105QueryParams:
...
@dataclasses.dataclass
class ListInvalidations20181105Headers:
...
class ListInvalidations20181105Request:
    headers: ListInvalidations20181105Headers = dataclasses.field()
    path_params: ListInvalidations20181105PathParams = dataclasses.field()
    query_params: ListInvalidations20181105QueryParams = dataclasses.field()
