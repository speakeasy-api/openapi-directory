...
public class DevicelistQueryParams {
    ...
    public DevicelistQueryParams withAppType(DevicelistAppTypeEnum appType) {
    ...
    public DevicelistQueryParams withDeviceId(String deviceId) {
    ...
    public DevicelistQueryParams withGetFavorites(Boolean getFavorites) {
