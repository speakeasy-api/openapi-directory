 ...
 */
export declare enum MachineTypesScopedListWarningCodeEnum {
...
export declare class MachineTypesScopedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class MachineTypesScopedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
...
export declare class MachineTypesScopedList extends SpeakeasyBase {
    /**
