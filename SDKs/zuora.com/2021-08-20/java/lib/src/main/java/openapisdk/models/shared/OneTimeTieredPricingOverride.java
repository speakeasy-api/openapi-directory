 ...
 * 
**/
public class OneTimeTieredPricingOverride {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("quantity")
    public Double quantity;
    public OneTimeTieredPricingOverride withQuantity(Double quantity) {
    ...
    public OneTimeTieredPricingOverride withTiers(ChargeTier[] tiers) {
        this.tiers = tiers;
        return this;
    }
}