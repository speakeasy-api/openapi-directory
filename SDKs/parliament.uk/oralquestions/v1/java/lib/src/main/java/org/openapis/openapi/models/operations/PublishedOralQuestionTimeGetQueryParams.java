...
public class PublishedOralQuestionTimeGetQueryParams {
    /**
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersAnsweringBodyIds(Integer[] parametersAnsweringBodyIds) {
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersAnsweringDateEnd(OffsetDateTime parametersAnsweringDateEnd) {
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersAnsweringDateStart(OffsetDateTime parametersAnsweringDateStart) {
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersDeadlineDateEnd(OffsetDateTime parametersDeadlineDateEnd) {
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersDeadlineDateStart(OffsetDateTime parametersDeadlineDateStart) {
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersOralQuestionTimeId(Integer parametersOralQuestionTimeId) {
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersSkip(Integer parametersSkip) {
    ...
    public PublishedOralQuestionTimeGetQueryParams withParametersTake(Integer parametersTake) {
