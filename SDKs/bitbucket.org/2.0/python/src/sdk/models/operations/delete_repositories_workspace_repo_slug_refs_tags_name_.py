...
class DeleteRepositoriesWorkspaceRepoSlugRefsTagsNameRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugRefsTagsNamePathParams = dataclasses.field()
    security: DeleteRepositoriesWorkspaceRepoSlugRefsTagsNameSecurity = dataclasses.field()
