...
from ..shared import routingidentifier as shared_routingidentifier
...
class Routing:
    ...
    e_identifiers: Optional[list[shared_routingidentifier.RoutingIdentifier]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('eIdentifiers') }})
