...
class CreateIntegrationResponseRequestBody:
    integration_response_key: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('integrationResponseKey') }})
    content_handling_strategy: Optional[CreateIntegrationResponseRequestBodyContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contentHandlingStrategy') }})
...
class CreateIntegrationResponseRequest:
    headers: CreateIntegrationResponseHeaders = dataclasses.field()
    path_params: CreateIntegrationResponsePathParams = dataclasses.field()
    request: CreateIntegrationResponseRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
