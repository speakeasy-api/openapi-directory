...
class DescribeLocationFsxOntapResponse:
    ...
    fsx_filesystem_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FsxFilesystemArn'), 'exclude': lambda f: f is None }})  
    ...
    storage_virtual_machine_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StorageVirtualMachineArn'), 'exclude': lambda f: f is None }})  
