...
class ReportStateAndNotificationResponse:
    r"""Response type for the [`ReportStateAndNotification`](#google.home.graph.v1.HomeGraphApiService.ReportStateAndNotification) call."""
    ...
    r"""Request ID copied from ReportStateAndNotificationRequest."""  
