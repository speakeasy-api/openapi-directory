  ...
  **/
  applicantsAdd(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.ApplicantsAddResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  applicantsAll(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ApplicantsAllResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  applicantsOne(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ApplicantsOneResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
