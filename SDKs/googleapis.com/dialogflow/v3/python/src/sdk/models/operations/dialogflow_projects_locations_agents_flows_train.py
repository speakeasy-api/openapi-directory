...
class DialogflowProjectsLocationsAgentsFlowsTrainSecurity:
    ...
    option1: Optional[DialogflowProjectsLocationsAgentsFlowsTrainSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DialogflowProjectsLocationsAgentsFlowsTrainSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DialogflowProjectsLocationsAgentsFlowsTrainRequest:
    ...
    r"""Required. The flow to train. Format: `projects//locations//agents//flows/`."""  
