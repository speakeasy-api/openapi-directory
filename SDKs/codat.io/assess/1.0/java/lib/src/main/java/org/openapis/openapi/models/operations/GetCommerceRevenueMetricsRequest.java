...
public class GetCommerceRevenueMetricsRequest {
    ...
    public GetCommerceRevenueMetricsRequest withPeriodUnit(org.openapis.openapi.models.shared.PeriodUnitEnum periodUnit) {
    ...
    public GetCommerceRevenueMetricsRequest(@JsonProperty("companyId") String companyId, @JsonProperty("connectionId") String connectionId, @JsonProperty("numberOfPeriods") Long numberOfPeriods, @JsonProperty("periodLength") Long periodLength, @JsonProperty("periodUnit") org.openapis.openapi.models.shared.PeriodUnitEnum periodUnit, @JsonProperty("reportDate") String reportDate) {
        this.companyId = companyId;
        this.connectionId = connectionId;
        this.numberOfPeriods = numberOfPeriods;
        this.periodLength = periodLength;
