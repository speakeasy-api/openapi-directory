...
public class RetailProjectsLocationsCatalogsBranchesProductsRemoveLocalInventoriesPathParams {
    /**
    ...
    public RetailProjectsLocationsCatalogsBranchesProductsRemoveLocalInventoriesPathParams withProduct(String product) {
