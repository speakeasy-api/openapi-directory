...
public class PresenceItem2 {
    ...
    public PresenceItem2 withCodeHex(String codeHex) {
    ...
    public PresenceItem2 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public PresenceItem2 withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    public PresenceItem2 withGeoCoords(GeoCoordsReadOnly geoCoords) {
    ...
    @JsonProperty("id")
    public String id;
    public PresenceItem2 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PresenceItem2 withIsPresent(Boolean isPresent) {
    ...
    @JsonProperty("label")
    public String label;
    public PresenceItem2 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public PresenceItem2 withLocationId(String locationId) {
    ...
    public PresenceItem2 withLocationRequest(String locationRequest) {
    ...
    public PresenceItem2 withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public PresenceItem2 withMoveCount(Long moveCount) {
    ...
    public PresenceItem2 withProtocol(ItemProtocolEnum protocol) {
    ...
    @JsonProperty("sets")
    public String[] sets;
    public PresenceItem2 withSets(String[] sets) {
        this.sets = sets;
        return this;
    }
    ...
    public PresenceItem2 withTechnology(TechnologyEnum technology) {
    ...
    public PresenceItem2 withTimeCreated(String timeCreated) {
    ...
    public PresenceItem2 withTimeLastPresent(String timeLastPresent) {
    ...
    public PresenceItem2 withTimeMoved(String timeMoved) {
    ...
    public PresenceItem2 withTimeUpdated(String timeUpdated) {
    ...
    public PresenceItem2 withType(ItemTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    @JsonProperty("url")
    public String url;
    public PresenceItem2 withUrl(String url) {
        this.url = url;
        return this;
    }
