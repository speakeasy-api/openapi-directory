...
class UpdatePaymentPsuDataRequest:
    headers: UpdatePaymentPsuDataHeaders = dataclasses.field()
    path_params: UpdatePaymentPsuDataPathParams = dataclasses.field()
    security: UpdatePaymentPsuDataSecurity = dataclasses.field()
