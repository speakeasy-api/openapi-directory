...
export enum GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum {
  Uniform = "uniform",
}
 ...
 */
export class GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionUniform extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "lower" })
  lower?: number;
...
export enum GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum {
  Lognormal = "lognormal",
}
 ...
 */
export class GetAdminMappings200ApplicationJSONMappingsResponseDelayDistributionLogNormal extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "median" })
  median?: number;
...
export class GetAdminMappings200ApplicationJSONMappings extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "request" })
  @Type(() => GetAdminMappings200ApplicationJSONMappingsRequest)
  ...
  @Type(() => GetAdminMappings200ApplicationJSONMappingsResponse)
...
export class GetAdminMappings200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: GetAdminMappings200ApplicationJSONMappings })
  @Expose({ name: "mappings" })
  @Type(() => GetAdminMappings200ApplicationJSONMappings)
  mappings?: GetAdminMappings200ApplicationJSONMappings[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => GetAdminMappings200ApplicationJSONMeta)
