...
class DialogflowProjectsLocationsAgentIntentsListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DialogflowProjectsLocationsAgentIntentsListIntentViewEnum $intentView
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=intentView')]
    public ?DialogflowProjectsLocationsAgentIntentsListIntentViewEnum $intentView = null;
