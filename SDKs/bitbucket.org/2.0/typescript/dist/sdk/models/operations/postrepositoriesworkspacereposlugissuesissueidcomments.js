...
exports.PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsResponse = exports.PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsRequest = exports.PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsSecurity = void 0;
...
var PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsRequest = /** @class */ (function (_super) {
    ...
    ], PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=issue_id",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsRequest.prototype, "issueId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsRequest.prototype, "workspace", void 0);
...
var PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PostRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
