...
class AndroidpublisherEditsApklistingsPatchRequest:
    path_params: AndroidpublisherEditsApklistingsPatchPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsApklistingsPatchQueryParams = dataclasses.field()
    security: AndroidpublisherEditsApklistingsPatchSecurity = dataclasses.field()
