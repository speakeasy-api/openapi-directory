...
class UpdateSecurityHubConfigurationHeaders:
...
class UpdateSecurityHubConfigurationRequest:
    headers: UpdateSecurityHubConfigurationHeaders = dataclasses.field()
    request: UpdateSecurityHubConfigurationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
