 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigAllocationStrategyEnum {
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigExcessCapacityTerminationPolicyEnum {
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigInstanceInterruptionBehaviorEnum {
    Hibernate = "hibernate",
    Stop = "stop",
    Terminate = "terminate"
}
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsBlockDeviceMappingsEbsVolumeTypeEnum {
    Standard = "standard",
    Io1 = "io1",
    Io2 = "io2",
    Gp2 = "gp2",
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsBlockDeviceMappingsEbs extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsBlockDeviceMappings extends SpeakeasyBase {
    deviceName?: string;
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsIamInstanceProfile extends SpeakeasyBase {
    arn?: string;
    name?: string;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsAcceleratorCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsAcceleratorManufacturersEnum {
    Nvidia = "nvidia",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services",
    Xilinx = "xilinx"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsAcceleratorNamesEnum {
    A100 = "a100",
    V100 = "v100",
    K80 = "k80",
    T4 = "t4",
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsAcceleratorTotalMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsAcceleratorTypesEnum {
    Gpu = "gpu",
    Fpga = "fpga",
    Inference = "inference"
}
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsBareMetalEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsBaselineEbsBandwidthMbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsBurstablePerformanceEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsCpuManufacturersEnum {
    Intel = "intel",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsInstanceGenerationsEnum {
    Current = "current",
    Previous = "previous"
}
/**
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsLocalStorageEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsLocalStorageTypesEnum {
    Hdd = "hdd",
    Ssd = "ssd"
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsMemoryGiBPerVCpu extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsNetworkBandwidthGbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsNetworkInterfaceCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsTotalLocalStorageGB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirementsVCpuCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceRequirements extends SpeakeasyBase {
 ...
 * The instance type.
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsMonitoring extends SpeakeasyBase {
    enabled?: boolean;
}
/**
 * Describes the IPv4 prefix option for a network interface.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsNetworkInterfacesIpv4Prefixes extends SpeakeasyBase {
    ipv4Prefix?: string;
}
/**
 * Describes an IPv6 address.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsNetworkInterfacesIpv6Addresses extends SpeakeasyBase {
    ipv6Address?: string;
}
/**
 * Describes the IPv4 prefix option for a network interface.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsNetworkInterfacesIpv6Prefixes extends SpeakeasyBase {
    ipv6Prefix?: string;
}
/**
 * Describes a secondary private IPv4 address for a network interface.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsNetworkInterfacesPrivateIpAddresses extends SpeakeasyBase {
    primary?: boolean;
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsNetworkInterfaces extends SpeakeasyBase {
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsPlacementTenancyEnum {
    Default = "default",
    Dedicated = "dedicated",
    Host = "host"
}
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsPlacement extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsSecurityGroups extends SpeakeasyBase {
    groupId?: string;
    groupName?: string;
}
/**
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecificationsTagSpecifications extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchSpecifications extends SpeakeasyBase {
 ...
 * The launch template.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsLaunchTemplateSpecification extends SpeakeasyBase {
 ...
 * <p>The minimum and maximum number of accelerators (GPUs, FPGAs, or Amazon Web Services Inferentia chips) on an instance.</p> <p>To exclude accelerator-enabled instance types, set <code>Max</code> to <code>0</code>.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorManufacturersEnum {
    Nvidia = "nvidia",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services",
    Xilinx = "xilinx"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorNamesEnum {
    A100 = "a100",
    V100 = "v100",
    K80 = "k80",
    T4 = "t4",
 ...
 * <p>The minimum and maximum amount of total accelerator memory, in MiB.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTotalMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsAcceleratorTypesEnum {
    Gpu = "gpu",
    Fpga = "fpga",
    Inference = "inference"
}
 ...
 * <p>Indicates whether bare metal instance types must be included, excluded, or required.</p> <ul> <li> <p>To include bare metal instance types, specify <code>included</code>.</p> </li> <li> <p>To require only bare metal instance types, specify <code>required</code>.</p> </li> <li> <p>To exclude bare metal instance types, specify <code>excluded</code>.</p> </li> </ul> <p>Default: <code>excluded</code> </p>
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsBareMetalEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
 ...
 * <p>The minimum and maximum baseline bandwidth to Amazon EBS, in Mbps. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ebs-optimized.html">Amazon EBS–optimized instances</a> in the <i>Amazon EC2 User Guide</i>.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsBaselineEbsBandwidthMbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>Indicates whether burstable performance T instance types are included, excluded, or required. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html">Burstable performance instances</a>.</p> <ul> <li> <p>To include burstable performance instance types, specify <code>included</code>.</p> </li> <li> <p>To require only burstable performance instance types, specify <code>required</code>.</p> </li> <li> <p>To exclude burstable performance instance types, specify <code>excluded</code>.</p> </li> </ul> <p>Default: <code>excluded</code> </p>
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsBurstablePerformanceEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsCpuManufacturersEnum {
    Intel = "intel",
    Amd = "amd",
    AmazonWebServices = "amazon-web-services"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsInstanceGenerationsEnum {
    Current = "current",
    Previous = "previous"
}
/**
 * <p>Indicates whether instance types with instance store volumes are included, excluded, or required. For more information, <a href="https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/InstanceStorage.html">Amazon EC2 instance store</a> in the <i>Amazon EC2 User Guide</i>.</p> <ul> <li> <p>To include instance types with instance store volumes, specify <code>included</code>.</p> </li> <li> <p>To require only instance types with instance store volumes, specify <code>required</code>.</p> </li> <li> <p>To exclude instance types with instance store volumes, specify <code>excluded</code>.</p> </li> </ul> <p>Default: <code>included</code> </p>
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageEnum {
    Included = "included",
    Required = "required",
    Excluded = "excluded"
}
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsLocalStorageTypesEnum {
    Hdd = "hdd",
    Ssd = "ssd"
}
/**
 * <p>The minimum and maximum amount of memory per vCPU, in GiB.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsMemoryGiBPerVCpu extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * The minimum and maximum amount of memory, in MiB.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsMemoryMiB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>The minimum and maximum amount of network bandwidth, in gigabits per second (Gbps).</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsNetworkBandwidthGbps extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>The minimum and maximum number of network interfaces.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsNetworkInterfaceCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * <p>The minimum and maximum amount of total local storage, in GB.</p> <p>Default: No minimum or maximum limits</p>
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsTotalLocalStorageGB extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 * The minimum and maximum number of vCPUs.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirementsVCpuCount extends SpeakeasyBase {
    max?: number;
    min?: number;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceRequirements extends SpeakeasyBase {
 ...
 * The instance type.
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverridesInstanceTypeEnum {
    A1Medium = "a1.medium",
    A1Large = "a1.large",
    A1Xlarge = "a1.xlarge",
    A12xlarge = "a1.2xlarge",
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigsOverrides extends SpeakeasyBase {
    availabilityZone?: string;
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLaunchTemplateConfigs extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLoadBalancersConfigClassicLoadBalancersConfigClassicLoadBalancers extends SpeakeasyBase {
    name?: string;
}
/**
 * The Classic Load Balancers.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLoadBalancersConfigClassicLoadBalancersConfig extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLoadBalancersConfigTargetGroupsConfigTargetGroups extends SpeakeasyBase {
    arn?: string;
}
/**
 * The target groups.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLoadBalancersConfigTargetGroupsConfig extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigLoadBalancersConfig extends SpeakeasyBase {
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigOnDemandAllocationStrategyEnum {
    LowestPrice = "lowestPrice",
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigSpotMaintenanceStrategiesCapacityRebalanceReplacementStrategyEnum {
    Launch = "launch",
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigSpotMaintenanceStrategiesCapacityRebalance extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigSpotMaintenanceStrategies extends SpeakeasyBase {
    capacityRebalance?: RequestSpotFleetRequestSpotFleetRequestConfigSpotMaintenanceStrategiesCapacityRebalance;
}
/**
 * The type of resource to tag on creation.
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigTagSpecificationsResourceTypeEnum {
    CapacityReservation = "capacity-reservation",
    ClientVpnEndpoint = "client-vpn-endpoint",
    CustomerGateway = "customer-gateway",
    CarrierGateway = "carrier-gateway",
 ...
 * Describes a tag.
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfigTagSpecifications extends SpeakeasyBase {
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigTargetCapacityUnitTypeEnum {
    Vcpu = "vcpu",
 ...
 */
export declare enum RequestSpotFleetRequestSpotFleetRequestConfigTypeEnum {
    Request = "request",
    Maintain = "maintain",
    Instant = "instant"
}
 ...
 */
export declare class RequestSpotFleetRequestSpotFleetRequestConfig extends SpeakeasyBase {
 ...
 */
export declare class RequestSpotFleetRequest extends SpeakeasyBase {
    dryRun?: boolean;
