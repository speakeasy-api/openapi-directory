...
class BatchDisassociateUserStackRequest:
    ...
    batch_disassociate_user_stack_request: shared_batchdisassociateuserstackrequest.BatchDisassociateUserStackRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
