...
public class CreateDomesticStandingOrdersHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticStandingOrdersHeaders withAuthorization(String authorization) {
        this.authorization = authorization;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-customer-user-agent")
    public String xCustomerUserAgent;
    public CreateDomesticStandingOrdersHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticStandingOrdersHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticStandingOrdersHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
        this.xFapiCustomerIpAddress = xFapiCustomerIpAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-fapi-interaction-id")
    public String xFapiInteractionId;
    public CreateDomesticStandingOrdersHeaders withXFapiInteractionId(String xFapiInteractionId) {
        this.xFapiInteractionId = xFapiInteractionId;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-idempotency-key")
    public String xIdempotencyKey;
    public CreateDomesticStandingOrdersHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticStandingOrdersHeaders withXJwsSignature(String xJwsSignature) {
