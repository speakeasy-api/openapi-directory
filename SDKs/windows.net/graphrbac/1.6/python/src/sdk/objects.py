...
class Objects:
    ...
    def objects_get_objects_by_object_ids(self, request: operations.ObjectsGetObjectsByObjectIdsRequest) -> operations.ObjectsGetObjectsByObjectIdsResponse:
        ...
        url = utils.generate_url(operations.ObjectsGetObjectsByObjectIdsRequest, base_url, '/{tenantID}/getObjectsByObjectIds', request)
        ...
        query_params = utils.get_query_params(operations.ObjectsGetObjectsByObjectIdsRequest, request)
        ...
        res = operations.ObjectsGetObjectsByObjectIdsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
