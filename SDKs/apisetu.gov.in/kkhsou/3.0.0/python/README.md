...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/kkhsou/3.0.0/python
```
...
res = s.ap_is.pvcer(req, operations.PvcerSecurity(
