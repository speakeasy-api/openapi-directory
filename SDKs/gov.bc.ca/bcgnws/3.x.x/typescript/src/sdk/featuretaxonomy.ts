...
export class FeatureTaxonomy {
  ...
  getFeatureCategories(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetFeatureCategoriesResponse =
        new operations.GetFeatureCategoriesResponse({
  ...
  getFeatureClasses(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetFeatureClassesResponse =
        new operations.GetFeatureClassesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getFeatureTypes(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetFeatureTypesResponse =
        new operations.GetFeatureTypesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
