...
class LanguageDTO:
    ...
    iso6391: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('iso6391'), 'exclude': lambda f: f is None }})
    r"""<a href=\\"http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes\\">ISO 639-1 code</a>"""  
    iso6392: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('iso6392'), 'exclude': lambda f: f is None }})
    r"""<a href=\\"http://en.wikipedia.org/wiki/List_of_ISO_639-2_codes\\">ISO 639-2 code</a>"""  
