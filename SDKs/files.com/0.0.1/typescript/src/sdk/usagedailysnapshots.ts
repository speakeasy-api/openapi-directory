...
export class UsageDailySnapshots {
  ...
  getUsageDailySnapshots(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetUsageDailySnapshotsResponse =
        new operations.GetUsageDailySnapshotsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.usageDailySnapshotEntities = utils.objectToClass(
              httpRes?.data,
              shared.UsageDailySnapshotEntity,
              resFieldDepth
            );
          }
          break;
