...
class PostAdminRecordingsStop200ApplicationJSONMappingsRequest:
    ...
    basic_auth_credentials: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsRequestBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
...
class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum(str, Enum):
    UNIFORM = 'uniform'
...
class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniform:
    ...
    type: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum(str, Enum):
    LOGNORMAL = 'lognormal'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormal:
    ...
    type: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PostAdminRecordingsStop200ApplicationJSONMappingsResponse:
    ...
    fault: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsResponseFaultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fault'), 'exclude': lambda f: f is None }})
    r"""The fault to apply (instead of a full, valid response)."""  
...
class PostAdminRecordingsStop200ApplicationJSONMappings:
    ...
    request: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})  
    ...
    response: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response'), 'exclude': lambda f: f is None }})  
...
class PostAdminRecordingsStop200ApplicationJSON:
    r"""Successfully stopped recording"""
    
    mappings: Optional[list[PostAdminRecordingsStop200ApplicationJSONMappings]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mappings'), 'exclude': lambda f: f is None }})  
    meta: Optional[PostAdminRecordingsStop200ApplicationJSONMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
