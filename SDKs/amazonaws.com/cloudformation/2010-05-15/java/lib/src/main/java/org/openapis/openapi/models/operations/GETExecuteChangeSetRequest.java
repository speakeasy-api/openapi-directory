...
public class GETExecuteChangeSetRequest {
    ...
    public GETExecuteChangeSetRequest(@JsonProperty("Action") GETExecuteChangeSetActionEnum action, @JsonProperty("ChangeSetName") String changeSetName, @JsonProperty("Version") GETExecuteChangeSetVersionEnum version) {
        this.action = action;
        this.changeSetName = changeSetName;
        this.version = version;
  }
