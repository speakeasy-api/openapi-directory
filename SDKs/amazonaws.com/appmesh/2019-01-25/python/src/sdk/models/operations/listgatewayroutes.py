...
@dataclasses.dataclass
class ListGatewayRoutesQueryParams:
...
@dataclasses.dataclass
class ListGatewayRoutesHeaders:
...
class ListGatewayRoutesRequest:
    headers: ListGatewayRoutesHeaders = dataclasses.field()
    path_params: ListGatewayRoutesPathParams = dataclasses.field()
    query_params: ListGatewayRoutesQueryParams = dataclasses.field()
