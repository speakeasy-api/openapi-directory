...
func (e *GoogleCloudRetailV2alphaProductAvailabilityEnum) UnmarshalJSON(data []byte) error {
	...
	case "PREORDER":
		fallthrough
	case "BACKORDER":
		*e = GoogleCloudRetailV2alphaProductAvailabilityEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaProductAvailabilityEnum: %s", s)
	}
}
...
func (e *GoogleCloudRetailV2alphaProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "VARIANT":
		fallthrough
	case "COLLECTION":
		*e = GoogleCloudRetailV2alphaProductTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2alphaProductTypeEnum: %s", s)
	}
}
