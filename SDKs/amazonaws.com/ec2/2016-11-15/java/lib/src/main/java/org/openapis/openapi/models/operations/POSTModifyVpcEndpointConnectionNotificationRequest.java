...
public class POSTModifyVpcEndpointConnectionNotificationRequest {
    ...
    public POSTModifyVpcEndpointConnectionNotificationRequest(@JsonProperty("Action") POSTModifyVpcEndpointConnectionNotificationActionEnum action, @JsonProperty("Version") POSTModifyVpcEndpointConnectionNotificationVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
