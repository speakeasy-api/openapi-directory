...
exports.PostCustomGatewayPaymentOwnershipIdResponse = exports.PostCustomGatewayPaymentOwnershipIdRequest = void 0;
...
var PostCustomGatewayPaymentOwnershipIdRequest = /** @class */ (function (_super) {
    ...
    ], PostCustomGatewayPaymentOwnershipIdRequest.prototype, "amount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=customData",
        }),
        __metadata("design:type", String)
    ], PostCustomGatewayPaymentOwnershipIdRequest.prototype, "customData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date" }),
        __metadata("design:type", Number)
    ], PostCustomGatewayPaymentOwnershipIdRequest.prototype, "date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=developerAmount",
        }),
        __metadata("design:type", Number)
    ], PostCustomGatewayPaymentOwnershipIdRequest.prototype, "developerAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=feeAmount",
        }),
        __metadata("design:type", Number)
    ], PostCustomGatewayPaymentOwnershipIdRequest.prototype, "feeAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=marketplaceAmount",
        }),
        __metadata("design:type", Number)
    ], PostCustomGatewayPaymentOwnershipIdRequest.prototype, "marketplaceAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ownershipId",
        }),
        __metadata("design:type", String)
    ], PostCustomGatewayPaymentOwnershipIdRequest.prototype, "ownershipId", void 0);
...
var PostCustomGatewayPaymentOwnershipIdResponse = /** @class */ (function (_super) {
    ...
    ], PostCustomGatewayPaymentOwnershipIdResponse.prototype, "rawResponse", void 0);
