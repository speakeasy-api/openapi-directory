...
export class GetNetworksIdActionsActionsResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => GetNetworksIdActionsActionsResponseActionError)
  ...
  @Type(() => GetNetworksIdActionsActionsResponseActionResources)
...
export class GetNetworksIdActionsActionsResponseMeta extends SpeakeasyBase {
  ...
  @Type(() => GetNetworksIdActionsActionsResponseMetaPagination)
...
export class GetNetworksIdActionsActionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: GetNetworksIdActionsActionsResponseAction })
  @Expose({ name: "actions" })
  @Type(() => GetNetworksIdActionsActionsResponseAction)
  actions: GetNetworksIdActionsActionsResponseAction[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => GetNetworksIdActionsActionsResponseMeta)
