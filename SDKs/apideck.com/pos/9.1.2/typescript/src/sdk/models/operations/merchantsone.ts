...
export class MerchantsOneSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MerchantsOneRequest extends SpeakeasyBase {
  /**
...
export class MerchantsOneResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
