...
class ListShipmentsResponseBodyPaginationLink:
    r"""ListShipmentsResponseBodyPaginationLink
...
class ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptions:
    r"""ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptions
...
class ListShipmentsResponseBodyPartialShipmentWeight:
    r"""ListShipmentsResponseBodyPartialShipmentWeight
...
class ListShipmentsResponseBodyPartialShipment:
    r"""ListShipmentsResponseBodyPartialShipment
    ...
    customs: ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('customs') }})
    ...
    total_weight: ListShipmentsResponseBodyPartialShipmentWeight = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('total_weight') }})
...
class ListShipmentsResponseBody:
    r"""ListShipmentsResponseBody
    A list shipment response body
    """
    
    links: ListShipmentsResponseBodyPaginationLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
    ...
    shipments: list[ListShipmentsResponseBodyPartialShipment] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('shipments') }})
