...
class GetAPIVVersionMetalsBenchmarkHistoryRequest:
    path_params: GetAPIVVersionMetalsBenchmarkHistoryPathParams = dataclasses.field()
    query_params: GetAPIVVersionMetalsBenchmarkHistoryQueryParams = dataclasses.field()
