...
func (e EnableKeyXAmzTargetEnum) ToPointer() *EnableKeyXAmzTargetEnum {
	return &e
}

func (e *EnableKeyXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "TrentService.EnableKey":
		*e = EnableKeyXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EnableKeyXAmzTargetEnum: %v", v)
	}
}
