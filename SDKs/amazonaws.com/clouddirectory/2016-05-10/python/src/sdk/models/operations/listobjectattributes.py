...
class ListObjectAttributesRequestBody:
    ...
    object_reference: ListObjectAttributesRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
    facet_filter: Optional[ListObjectAttributesRequestBodyFacetFilter] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FacetFilter'), 'exclude': lambda f: f is None }})
    r"""A facet."""  
...
class ListObjectAttributesRequest:
    ...
    request_body: ListObjectAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
