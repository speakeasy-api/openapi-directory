...
class ReportsEntityUsageReportsGetRequest:
    path_params: ReportsEntityUsageReportsGetPathParams = dataclasses.field()
    query_params: ReportsEntityUsageReportsGetQueryParams = dataclasses.field()
    security: ReportsEntityUsageReportsGetSecurity = dataclasses.field()
