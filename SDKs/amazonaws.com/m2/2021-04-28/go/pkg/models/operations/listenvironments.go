...
func (e ListEnvironmentsEngineTypeEnum) ToPointer() *ListEnvironmentsEngineTypeEnum {
	return &e
}
...
func (e *ListEnvironmentsEngineTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "microfocus":
		fallthrough
	case "bluage":
		*e = ListEnvironmentsEngineTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListEnvironmentsEngineTypeEnum: %v", v)
	}
}
