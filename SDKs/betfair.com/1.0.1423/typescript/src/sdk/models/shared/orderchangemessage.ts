 ...
 */
export enum OrderChangeMessageCtEnum {
  SubImage = "SUB_IMAGE",
 ...
 */
export enum OrderChangeMessageSegmentTypeEnum {
  SegStart = "SEG_START",
  Seg = "SEG",
  SegEnd = "SEG_END",
}

export class OrderChangeMessage extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: OrderMarketChange })
  @Expose({ name: "oc" })
