...
public class RemoveAChannelMemberRequest {
    ...
    public RemoveAChannelMemberRequest withChannelId(String channelId) {
    ...
    public RemoveAChannelMemberRequest withMemberId(String memberId) {
    ...
    public RemoveAChannelMemberRequest withUserId(String userId) {
        this.userId = userId;
        return this;
    }
