...
class StorageBucketsPatchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\StorageBucketsPatchPredefinedACLEnum $predefinedAcl
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=predefinedAcl')]
    public ?StorageBucketsPatchPredefinedACLEnum $predefinedAcl = null;
    
    /**
     * Apply a predefined set of default object access controls to this bucket.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\StorageBucketsPatchPredefinedDefaultObjectACLEnum $predefinedDefaultObjectAcl
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=predefinedDefaultObjectAcl')]
    public ?StorageBucketsPatchPredefinedDefaultObjectACLEnum $predefinedDefaultObjectAcl = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\StorageBucketsPatchProjectionEnum $projection
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=projection')]
    public ?StorageBucketsPatchProjectionEnum $projection = null;
