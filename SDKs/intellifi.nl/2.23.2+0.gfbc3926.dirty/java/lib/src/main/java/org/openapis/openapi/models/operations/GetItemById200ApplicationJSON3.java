...
public class GetItemById200ApplicationJSON3 {
    /**
    ...
    public GetItemById200ApplicationJSON3 withCodeHex(String codeHex) {
    ...
    public GetItemById200ApplicationJSON3 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetItemById200ApplicationJSON3 withCustom(Object custom) {
        this.custom = custom;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON3 withGeoCoords(org.openapis.openapi.models.shared.GeoCoordsReadOnly geoCoords) {
    ...
    @JsonProperty("id")
    public String id;
    public GetItemById200ApplicationJSON3 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON3 withIsPresent(Boolean isPresent) {
    ...
    @JsonProperty("label")
    public String label;
    public GetItemById200ApplicationJSON3 withLabel(String label) {
        this.label = label;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON3 withLocationRequest(String locationRequest) {
    ...
    public GetItemById200ApplicationJSON3 withLocationUrl(String locationUrl) {
    ...
    public GetItemById200ApplicationJSON3 withMetadata(java.util.Map<String, Object> metadata) {
    ...
    public GetItemById200ApplicationJSON3 withMoveCount(Long moveCount) {
    ...
    public GetItemById200ApplicationJSON3 withProtocol(org.openapis.openapi.models.shared.ItemProtocolEnum protocol) {
    ...
    @JsonProperty("sets")
    public String[] sets;
    public GetItemById200ApplicationJSON3 withSets(String[] sets) {
        this.sets = sets;
        return this;
    }
    ...
    public GetItemById200ApplicationJSON3 withTechnology(org.openapis.openapi.models.shared.TechnologyEnum technology) {
    ...
    public GetItemById200ApplicationJSON3 withTimeCreated(String timeCreated) {
    ...
    public GetItemById200ApplicationJSON3 withTimeLastPresent(String timeLastPresent) {
    ...
    public GetItemById200ApplicationJSON3 withTimeMoved(String timeMoved) {
    ...
    public GetItemById200ApplicationJSON3 withTimeUpdated(String timeUpdated) {
    ...
    public GetItemById200ApplicationJSON3 withType(org.openapis.openapi.models.shared.ItemTypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    @JsonProperty("url")
    public String url;
    public GetItemById200ApplicationJSON3 withUrl(String url) {
        this.url = url;
        return this;
    }
