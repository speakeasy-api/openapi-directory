...
class GetScreenshots:
    ...
    def screenshots(self, request: operations.ScreenshotsRequest) -> operations.ScreenshotsResponse:
        ...
        res = operations.ScreenshotsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ScreenshotDetails])
                res.screenshot_details = out
