...
export class GetCompaniesCompanyIdTerminalLogosSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetCompaniesCompanyIdTerminalLogosRequest extends SpeakeasyBase {
  /**
...
export class GetCompaniesCompanyIdTerminalLogosResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
