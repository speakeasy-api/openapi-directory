...
var ApiV2010AccountAuthorizedConnectApp = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connect_app_company_name" }),
        __metadata("design:type", String)
    ], ApiV2010AccountAuthorizedConnectApp.prototype, "connectAppCompanyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connect_app_description" }),
        __metadata("design:type", String)
    ], ApiV2010AccountAuthorizedConnectApp.prototype, "connectAppDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connect_app_friendly_name" }),
        __metadata("design:type", String)
    ], ApiV2010AccountAuthorizedConnectApp.prototype, "connectAppFriendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connect_app_homepage_url" }),
        __metadata("design:type", String)
    ], ApiV2010AccountAuthorizedConnectApp.prototype, "connectAppHomepageUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connect_app_sid" }),
        __metadata("design:type", String)
