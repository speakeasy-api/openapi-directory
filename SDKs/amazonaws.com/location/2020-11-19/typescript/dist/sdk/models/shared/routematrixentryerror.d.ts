...
import { RouteMatrixErrorCodeEnum } from "./routematrixerrorcodeenum";
/**
 ...
 */
export declare class RouteMatrixEntryError extends SpeakeasyBase {
    code: RouteMatrixErrorCodeEnum;
    message?: string;
}
