 ...
 * ~
 */
var MediaPage = /** @class */ (function (_super) {
    __extends(MediaPage, _super);
    function MediaPage() {
    ...
    ], MediaPage.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "limit" }),
        __metadata("design:type", Number)
    ], MediaPage.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "offset" }),
        __metadata("design:type", Number)
    ], MediaPage.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "totalCount" }),
        __metadata("design:type", Number)
    ], MediaPage.prototype, "totalCount", void 0);
    return MediaPage;
