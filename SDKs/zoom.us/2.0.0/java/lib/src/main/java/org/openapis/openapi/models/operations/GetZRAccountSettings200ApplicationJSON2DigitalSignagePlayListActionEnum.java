 ...
 * 
 */
public enum GetZRAccountSettings200ApplicationJSON2DigitalSignagePlayListActionEnum {
    ADD("add"),
    UPDATE("update"),
    DELETE("delete");
    ...
    private GetZRAccountSettings200ApplicationJSON2DigitalSignagePlayListActionEnum(String value) {
        this.value = value;
    }
}
