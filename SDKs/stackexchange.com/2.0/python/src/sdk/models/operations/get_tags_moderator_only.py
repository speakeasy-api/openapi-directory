...
class GetTagsModeratorOnlyOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetTagsModeratorOnlySortEnum(str, Enum):
    POPULAR = "popular"
    ACTIVITY = "activity"
    NAME = "name"
...
class GetTagsModeratorOnlyQueryParams:
    ...
    order: Optional[GetTagsModeratorOnlyOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetTagsModeratorOnlySortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetTagsModeratorOnlyRequest:
    query_params: GetTagsModeratorOnlyQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetTagsModeratorOnlyResponse:
