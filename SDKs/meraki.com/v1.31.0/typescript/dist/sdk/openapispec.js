...
var OpenapiSpec = /** @class */ (function () {
    function OpenapiSpec(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the OpenAPI 2.0 Specification of the organization's API documentation in JSON
     */
    OpenapiSpec.prototype.getOrganizationOpenapiSpec = function (req, config) {
