...
func main() {
    ...
    res, err := s.BusinessLines.PatchBusinessLinesID(ctx, operations.PatchBusinessLinesIDRequest{
        BusinessLineInfoUpdateInput: &shared.BusinessLineInfoUpdateInput{
            ...
            Service: shared.BusinessLineInfoUpdateServiceEnumPaymentProcessing,
            SourceOfFunds: &shared.SourceOfFunds{
                AcquiringBusinessLineID: sdk.String("excepturi"),
            ...
            WebData: []shared.WebDataInput{
                shared.WebDataInput{
                    WebAddress: sdk.String("culpa"),
                },
                shared.WebDataInput{
                    WebAddress: sdk.String("doloribus"),
                },
            },
...
func main() {
    ...
    res, err := s.BusinessLines.PostBusinessLines(ctx, shared.BusinessLineInfoInput{
        Capability: sdk.String("temporibus"),
        IndustryCode: "laborum",
        LegalEntityID: "quasi",
        SalesChannels: []string{
            "voluptatibus",
            "vero",
        ...
        Service: shared.BusinessLineInfoServiceEnumBanking,
        SourceOfFunds: &shared.SourceOfFunds{
            AcquiringBusinessLineID: sdk.String("ipsa"),
            AdyenProcessedFunds: sdk.Bool(false),
        ...
        WebData: []shared.WebDataInput{
            ...
            shared.WebDataInput{
                WebAddress: sdk.String("perferendis"),
            },
        },
        WebDataExemption: &shared.WebDataExemption{
            Reason: shared.WebDataExemptionReasonEnumNoOnlinePresence.ToPointer(),
