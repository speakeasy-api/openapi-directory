...
class ComputeTargetHttpProxiesPatchRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\TargetHttpProxy $targetHttpProxy1 = null;
     ...
     * 
     * @var string $targetHttpProxyPathParameter
     */
	#[SpeakeasyMetadata('pathParam:style=simple,explode=false,name=targetHttpProxy')]
    public string $targetHttpProxyPathParameter;
	...
	public function __construct()
	{
		...
		$this->quotaUser = null;
		$this->requestId = null;
		$this->targetHttpProxyPathParameter = "";
