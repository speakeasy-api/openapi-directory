...
// List Priorities
func (s *priorities) GetPriorities(ctx context.Context, request operations.GetPrioritiesRequest) (*operations.GetPrioritiesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/priorities"
	...
	res := &operations.GetPrioritiesResponse{
