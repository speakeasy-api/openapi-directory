...
exports.AnalyticsMetadataColumnsListResponse = exports.AnalyticsMetadataColumnsListRequest = exports.AnalyticsMetadataColumnsListSecurity = exports.AnalyticsMetadataColumnsListSecurityOption3 = exports.AnalyticsMetadataColumnsListSecurityOption2 = exports.AnalyticsMetadataColumnsListSecurityOption1 = void 0;
...
var AnalyticsMetadataColumnsListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AnalyticsMetadataColumnsListRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AnalyticsMetadataColumnsListRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AnalyticsMetadataColumnsListRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AnalyticsMetadataColumnsListRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AnalyticsMetadataColumnsListRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AnalyticsMetadataColumnsListRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=reportType",
        }),
        __metadata("design:type", String)
    ], AnalyticsMetadataColumnsListRequest.prototype, "reportType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AnalyticsMetadataColumnsListRequest.prototype, "userIp", void 0);
...
var AnalyticsMetadataColumnsListResponse = /** @class */ (function (_super) {
    ...
    ], AnalyticsMetadataColumnsListResponse.prototype, "rawResponse", void 0);
