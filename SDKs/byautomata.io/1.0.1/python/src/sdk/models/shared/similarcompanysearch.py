...
class SimilarCompanySearch:
    ...
    snippets: Optional[list[shared_snippet.Snippet]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('snippets'), 'exclude': lambda f: f is None }})  
