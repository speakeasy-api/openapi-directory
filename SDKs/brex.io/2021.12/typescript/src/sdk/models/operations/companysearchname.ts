 ...
 */
export class CompanySearchNameDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code: number;
...
export class CompanySearchName200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "address" })
  address?: string[];
...
export class CompanySearchNameResponse extends SpeakeasyBase {
   ...
   * List of companies
   */
  @SpeakeasyMetadata({ elemType: CompanySearchName200ApplicationJSON })
