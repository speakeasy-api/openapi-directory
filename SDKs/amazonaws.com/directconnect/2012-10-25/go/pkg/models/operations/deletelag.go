...
func (e DeleteLagXAmzTargetEnum) ToPointer() *DeleteLagXAmzTargetEnum {
	return &e
}
...
func (e *DeleteLagXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "OvertureService.DeleteLag":
		*e = DeleteLagXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteLagXAmzTargetEnum: %v", v)
	}
}
