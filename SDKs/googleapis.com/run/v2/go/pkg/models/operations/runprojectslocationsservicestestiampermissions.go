...
type RunProjectsLocationsServicesTestIamPermissionsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RunProjectsLocationsServicesTestIamPermissionsPathParams struct {
	// REQUIRED: The resource for which the policy detail is being requested. See [Resource names](https://cloud.google.com/apis/design/resource_names) for the appropriate value for this field.
	Resource string `pathParam:"style=simple,explode=false,name=resource"`
}

type RunProjectsLocationsServicesTestIamPermissionsQueryParams struct {
	// V1 error format.
...
type RunProjectsLocationsServicesTestIamPermissionsRequest struct {
...
type RunProjectsLocationsServicesTestIamPermissionsResponse struct {
	ContentType string
	// Successful response
