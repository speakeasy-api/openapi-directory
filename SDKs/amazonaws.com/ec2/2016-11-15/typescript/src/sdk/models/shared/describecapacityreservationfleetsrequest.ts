 ...
 */
export class DescribeCapacityReservationFleetsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeCapacityReservationFleetsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
