...
export class PatientsOnpatientAccessReadPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class PatientsOnpatientAccessReadQueryParams extends SpeakeasyBase {
...
export class PatientsOnpatientAccessReadSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  drchronoOauth2: shared.SchemeDrchronoOauth2;
}


export class PatientsOnpatientAccessReadRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PatientsOnpatientAccessReadResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
