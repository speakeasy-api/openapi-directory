...
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#cancel-an-import>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/users#delete-a-user-migration-archive>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/orgs#delete-an-organization-migration-archive>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/orgs#download-an-organization-migration-archive>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/users#download-a-user-migration-archive>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#get-commit-authors>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#get-an-import-status>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#get-large-files>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/users#get-a-user-migration-status>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/orgs#get-an-organization-migration-status>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/users#list-user-migrations>
...
func main() {
    ...
    res, err := s.Migrations.MigrationsListForAuthenticatedUser(ctx, operations.MigrationsListForAuthenticatedUserRequest{
        Page: sdk.Int64(32055),
        PerPage: sdk.Int64(322829),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/orgs#list-organization-migrations>
...
func main() {
    ...
    res, err := s.Migrations.MigrationsListForOrg(ctx, operations.MigrationsListForOrgRequest{
        ...
        Org: "amet",
        Page: sdk.Int64(849320),
        PerPage: sdk.Int64(506863),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/users#list-repositories-for-a-user-migration>
...
func main() {
    ...
    res, err := s.Migrations.MigrationsListReposForAuthenticatedUser(ctx, operations.MigrationsListReposForAuthenticatedUserRequest{
        MigrationID: 695526,
        Page: sdk.Int64(736853),
        PerPage: sdk.Int64(230411),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/orgs#list-repositories-in-an-organization-migration>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#map-a-commit-author>
...
func main() {
    ...
    res, err := s.Migrations.MigrationsMapCommitAuthor(ctx, operations.MigrationsMapCommitAuthorRequest{
        RequestBody: &operations.MigrationsMapCommitAuthorRequestBody{
            Email: sdk.String("Jayce_Fay@hotmail.com"),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#update-git-lfs-preference>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/users#start-a-user-migration>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/orgs#start-an-organization-migration>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#start-an-import>
...
func main() {
    ...
    res, err := s.Migrations.MigrationsStartImport(ctx, operations.MigrationsStartImportRequest{
        RequestBody: operations.MigrationsStartImportRequestBody{
            TfvcProject: sdk.String("sunt"),
            Vcs: operations.MigrationsStartImportRequestBodyVcsEnumTfvc.ToPointer(),
            VcsPassword: sdk.String("dolor"),
            VcsURL: "occaecati",
            VcsUsername: sdk.String("atque"),
        },
        Owner: "beatae",
        Repo: "at",
    })
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/users#unlock-a-user-repository>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/orgs#unlock-an-organization-repository>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/migrations/source-imports#update-an-import>
...
func main() {
    ...
    res, err := s.Migrations.MigrationsUpdateImport(ctx, operations.MigrationsUpdateImportRequest{
        RequestBody: &operations.MigrationsUpdateImportRequestBody{
            ...
            Vcs: operations.MigrationsUpdateImportRequestBodyVcsEnumGit.ToPointer(),
            VcsPassword: sdk.String("ea"),
            VcsUsername: sdk.String("aperiam"),
        },
        Owner: "dignissimos",
        Repo: "repellat",
    })
