...
func (e GETAssociateTrunkInterfaceActionEnum) ToPointer() *GETAssociateTrunkInterfaceActionEnum {
	return &e
}
...
func (e *GETAssociateTrunkInterfaceActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "AssociateTrunkInterface":
		*e = GETAssociateTrunkInterfaceActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETAssociateTrunkInterfaceActionEnum: %v", v)
	}
}
...
func (e GETAssociateTrunkInterfaceVersionEnum) ToPointer() *GETAssociateTrunkInterfaceVersionEnum {
	return &e
}
...
func (e *GETAssociateTrunkInterfaceVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2016-11-15":
		*e = GETAssociateTrunkInterfaceVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETAssociateTrunkInterfaceVersionEnum: %v", v)
	}
}
