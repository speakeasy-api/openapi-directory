...
export class SecuritycenterProjectsFindingsBulkMuteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsFindingsBulkMuteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsFindingsBulkMuteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
