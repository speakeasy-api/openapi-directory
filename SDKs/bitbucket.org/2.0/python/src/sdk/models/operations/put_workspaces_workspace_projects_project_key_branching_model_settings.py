...
class PutWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsSecurity:
...
@dataclasses.dataclass
class PutWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsRequest:
...
@dataclasses.dataclass
class PutWorkspacesWorkspaceProjectsProjectKeyBranchingModelSettingsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    branching_model_settings: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""The updated branching model configuration"""  
    error: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""If the request contains an invalid branching model configuration"""  
