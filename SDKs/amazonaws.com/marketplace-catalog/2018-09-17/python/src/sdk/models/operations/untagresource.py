...
class UntagResourceRequestBody:
    ...
    r"""Required. The Amazon Resource Name (ARN) associated with the resource you want to remove the tag from."""  
    tag_keys: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TagKeys') }})
    r"""Required. A list of key names of tags to be removed. Number of strings allowed: 0-256."""  
