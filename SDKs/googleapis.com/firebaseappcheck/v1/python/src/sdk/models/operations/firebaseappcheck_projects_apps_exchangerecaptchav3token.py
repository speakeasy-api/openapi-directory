...
from ..shared import security as shared_security
from ..shared import googlefirebaseappcheckv1exchangerecaptchav3tokenrequest as shared_googlefirebaseappcheckv1exchangerecaptchav3tokenrequest
...
class FirebaseappcheckProjectsAppsExchangeRecaptchaV3TokenRequest:
    ...
    request: Optional[shared_googlefirebaseappcheckv1exchangerecaptchav3tokenrequest.GoogleFirebaseAppcheckV1ExchangeRecaptchaV3TokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
