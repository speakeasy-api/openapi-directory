...
var Summary = /** @class */ (function () {
    function Summary(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the top 10 appliances sorted by utilization over given time range.
     */
    Summary.prototype.getOrganizationSummaryTopAppliancesByUtilization = function (req, config) {
     ...
     * Return metrics for organization's top 10 clients by data usage (in mb) over given time range.
     */
    Summary.prototype.getOrganizationSummaryTopClientsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return metrics for organization's top clients by data usage (in mb) over given time range, grouped by manufacturer.
     */
    Summary.prototype.getOrganizationSummaryTopClientsManufacturersByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     */
    Summary.prototype.getOrganizationSummaryTopDevicesByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    Summary.prototype.getOrganizationSummaryTopDevicesModelsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    Summary.prototype.getOrganizationSummaryTopSsidsByUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    Summary.prototype.getOrganizationSummaryTopSwitchesByEnergyUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
