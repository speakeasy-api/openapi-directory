...
public class TransactionDetailsHeaders {
    /**
    ...
    public TransactionDetailsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public TransactionDetailsHeaders withContentType(String contentType) {
    ...
    public TransactionDetailsHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public TransactionDetailsHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
