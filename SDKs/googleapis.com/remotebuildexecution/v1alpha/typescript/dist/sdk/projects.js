...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsInstancesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RemotebuildexecutionProjectsInstancesCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1alpha/{parent}/instances", req.pathParams);
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsInstancesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.googleDevtoolsRemotebuildexecutionAdminV1alphaListInstancesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsInstancesTestNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RemotebuildexecutionProjectsInstancesTestNotifyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1alpha/{name}:testNotify", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsInstancesWorkerpoolsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RemotebuildexecutionProjectsInstancesWorkerpoolsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1alpha/{parent}/workerpools", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsInstancesWorkerpoolsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsInstancesWorkerpoolsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.googleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsInstancesWorkerpoolsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.remotebuildexecutionProjectsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
