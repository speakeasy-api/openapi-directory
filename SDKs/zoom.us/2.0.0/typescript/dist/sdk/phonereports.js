...
var PhoneReports = /** @class */ (function () {
    ...
    PhoneReports.prototype.getPSOperationLogs = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetPSOperationLogsResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getPSOperationLogs200ApplicationJSONObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetPSOperationLogs200ApplicationJSON);
                    }
