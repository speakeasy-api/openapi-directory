...
from ..shared import scheduleabystatepage as shared_scheduleabystatepage
...
class GetSchedulesScheduleAByStateQueryParams:
    ...
    hide_null: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'hide_null', 'style': 'form', 'explode': True }})
...
class GetSchedulesScheduleAByStateRequest:
    query_params: GetSchedulesScheduleAByStateQueryParams = dataclasses.field()
...
class GetSchedulesScheduleAByStateResponse:
    ...
    schedule_a_by_state_page: Optional[shared_scheduleabystatepage.ScheduleAByStatePage] = dataclasses.field(default=None)
