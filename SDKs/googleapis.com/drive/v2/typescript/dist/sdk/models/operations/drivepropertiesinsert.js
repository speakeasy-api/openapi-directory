...
exports.DrivePropertiesInsertResponse = exports.DrivePropertiesInsertRequest = exports.DrivePropertiesInsertSecurity = exports.DrivePropertiesInsertSecurityOption4 = exports.DrivePropertiesInsertSecurityOption3 = exports.DrivePropertiesInsertSecurityOption2 = exports.DrivePropertiesInsertSecurityOption1 = void 0;
...
var DrivePropertiesInsertRequest = /** @class */ (function (_super) {
    ...
    ], DrivePropertiesInsertRequest.prototype, "property", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], DrivePropertiesInsertRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DrivePropertiesInsertRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fileId",
        }),
        __metadata("design:type", String)
    ], DrivePropertiesInsertRequest.prototype, "fileId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DrivePropertiesInsertRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DrivePropertiesInsertRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DrivePropertiesInsertRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DrivePropertiesInsertRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DrivePropertiesInsertRequest.prototype, "userIp", void 0);
...
var DrivePropertiesInsertResponse = /** @class */ (function (_super) {
    ...
    ], DrivePropertiesInsertResponse.prototype, "rawResponse", void 0);
