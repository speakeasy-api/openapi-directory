...
class ListEventsDetectionJobsRequest:
    ...
    list_events_detection_jobs_request: shared_listeventsdetectionjobsrequest.ListEventsDetectionJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
