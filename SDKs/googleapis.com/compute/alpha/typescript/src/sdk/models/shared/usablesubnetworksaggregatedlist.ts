 ...
 */
export enum UsableSubnetworksAggregatedListWarningCodeEnum {
...
export class UsableSubnetworksAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class UsableSubnetworksAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: UsableSubnetworksAggregatedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: UsableSubnetworksAggregatedListWarningData })
  @Expose({ name: "data" })
  @Type(() => UsableSubnetworksAggregatedListWarningData)
  data?: UsableSubnetworksAggregatedListWarningData[];
 ...
 * Successful response
 */
export class UsableSubnetworksAggregatedList extends SpeakeasyBase {
  /**
