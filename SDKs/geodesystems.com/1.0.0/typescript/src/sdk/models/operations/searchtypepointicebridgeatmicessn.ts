...
export class SearchTypePointIcebridgeAtmIcessnRequest extends SpeakeasyBase {
  /**
...
export class SearchTypePointIcebridgeAtmIcessnResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
