...
class JobScheduleListRequest:
    headers: JobScheduleListHeaders = dataclasses.field()
    query_params: JobScheduleListQueryParams = dataclasses.field()
...
class JobScheduleListResponse:
    ...
    cloud_job_schedule_list_result: Optional[Any] = dataclasses.field(default=None)
