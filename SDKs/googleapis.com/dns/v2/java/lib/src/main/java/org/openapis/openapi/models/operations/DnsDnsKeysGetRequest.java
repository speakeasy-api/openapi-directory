...
public class DnsDnsKeysGetRequest {
    ...
    public DnsDnsKeysGetRequest withLocation(String location) {
    ...
    public DnsDnsKeysGetRequest(@JsonProperty("dnsKeyId") String dnsKeyId, @JsonProperty("location") String location, @JsonProperty("managedZone") String managedZone, @JsonProperty("project") String project) {
        this.dnsKeyId = dnsKeyId;
        this.location = location;
        this.managedZone = managedZone;
        this.project = project;
