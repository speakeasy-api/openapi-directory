...
var primaryipactions_1 = require("./primaryipactions");
var primaryips_1 = require("./primaryips");
 ...
 */
exports.ServerList = ["https://api.hetzner.cloud/v1"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.primaryIPActions = new primaryipactions_1.PrimaryIPActions(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.primaryIPs = new primaryips_1.PrimaryIPs(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
