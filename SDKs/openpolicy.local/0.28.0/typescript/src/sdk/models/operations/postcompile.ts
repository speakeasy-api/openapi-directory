...
export class PostCompile200ApplicationJSONExplanationLocals extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "key" })
  @Type(() => PostCompile200ApplicationJSONExplanationLocalsKey)
  key?: PostCompile200ApplicationJSONExplanationLocalsKey;

  @SpeakeasyMetadata()
  @Expose({ name: "value" })
  @Type(() => PostCompile200ApplicationJSONExplanationLocalsValue)
...
export class PostCompile200ApplicationJSONExplanationNode extends SpeakeasyBase {
  ...
  @Expose({ name: "terms" })
  @Type(() => PostCompile200ApplicationJSONExplanationNodeTerms)
...
export class PostCompile200ApplicationJSONExplanation extends SpeakeasyBase {
  ...
  @Expose({ name: "locals" })
  @Type(() => PostCompile200ApplicationJSONExplanationLocals)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "node" })
  @Type(() => PostCompile200ApplicationJSONExplanationNode)
 ...
 */
export enum PostCompile200ApplicationJSONResultAstPackagePathTypeEnum {
  Import = "import",
  Package = "package",
}

export class PostCompile200ApplicationJSONResultAstPackagePath extends SpeakeasyBase {
  /**
   * The type of the path operation
   */
  @SpeakeasyMetadata()
...
export class PostCompile200ApplicationJSONResultAstPackage extends SpeakeasyBase {
  /**
  ...
  @Expose({ name: "path" })
  @Type(() => PostCompile200ApplicationJSONResultAstPackagePath)
  path?: PostCompile200ApplicationJSONResultAstPackagePath[];
}

export class PostCompile200ApplicationJSONResultAstRulesBodyTermsValue extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "type" })
  type?: string;
...
export class PostCompile200ApplicationJSONResultAstRulesBodyTerms extends SpeakeasyBase {
  /**
  ...
  @Expose({ name: "value" })
  @Type(() => PostCompile200ApplicationJSONResultAstRulesBodyTermsValue)
  value?: PostCompile200ApplicationJSONResultAstRulesBodyTermsValue[];
}

export class PostCompile200ApplicationJSONResultAstRulesBody extends SpeakeasyBase {
  /**
  ...
  @Expose({ name: "terms" })
  @Type(() => PostCompile200ApplicationJSONResultAstRulesBodyTerms)
 ...
 */
export class PostCompile200ApplicationJSONResultAstRulesHeadKey extends SpeakeasyBase {
  /**
...
export class PostCompile200ApplicationJSONResultAstRulesHead extends SpeakeasyBase {
  /**
   * The type/value pairing for this rule's head
   */
  @SpeakeasyMetadata()
  @Expose({ name: "key" })
  @Type(() => PostCompile200ApplicationJSONResultAstRulesHeadKey)
...
export class PostCompile200ApplicationJSONResultAstRules extends SpeakeasyBase {
  /**
  ...
  @Expose({ name: "body" })
  @Type(() => PostCompile200ApplicationJSONResultAstRulesBody)
  body?: PostCompile200ApplicationJSONResultAstRulesBody[];

  @SpeakeasyMetadata()
  @Expose({ name: "head" })
  @Type(() => PostCompile200ApplicationJSONResultAstRulesHead)
 ...
 * @see {@link https://godoc.org/github.com/open-policy-agent/opa/ast} - AST
 */
export class PostCompile200ApplicationJSONResultAst extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "package" })
  @Type(() => PostCompile200ApplicationJSONResultAstPackage)
   ...
   */
  @SpeakeasyMetadata({ elemType: PostCompile200ApplicationJSONResultAstRules })
  @Expose({ name: "rules" })
  @Type(() => PostCompile200ApplicationJSONResultAstRules)
  rules?: PostCompile200ApplicationJSONResultAstRules[];
}

export class PostCompile200ApplicationJSONResult extends SpeakeasyBase {
  /**
   * The types for declarations and runtime objects passed to your implementation. This consists of an abstract syntax tree (AST) of policy modules, package and import declarations, rules, expressions, and terms.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "ast" })
  @Type(() => PostCompile200ApplicationJSONResultAst)
...
export class PostCompile200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: PostCompile200ApplicationJSONExplanation })
  @Expose({ name: "explanation" })
  @Type(() => PostCompile200ApplicationJSONExplanation)
  explanation?: PostCompile200ApplicationJSONExplanation[];

  @SpeakeasyMetadata()
  @Expose({ name: "metrics" })
  @Type(() => PostCompile200ApplicationJSONMetrics)
  metrics?: PostCompile200ApplicationJSONMetrics;

  @SpeakeasyMetadata({ elemType: PostCompile200ApplicationJSONResult })
  @Expose({ name: "result" })
  @Type(() => PostCompile200ApplicationJSONResult)
