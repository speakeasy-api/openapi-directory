...
public class DELETEWorkflowRequest {
    ...
    public DELETEWorkflowRequest withAuthorization(String authorization) {
    ...
    public DELETEWorkflowRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public DELETEWorkflowRequest withZuoraTrackId(String zuoraTrackId) {
