...
from ..shared import proxycreatepaymentmethod as shared_proxycreatepaymentmethod
...
class ObjectPOSTPaymentMethodRequest:
    ...
    proxy_create_payment_method: shared_proxycreatepaymentmethod.ProxyCreatePaymentMethod = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
