...
from ..shared import security as shared_security
from ..shared import floodlightactivitiesgeneratetagresponse as shared_floodlightactivitiesgeneratetagresponse
...
class DfareportingFloodlightActivitiesGeneratetagRequest:
    path_params: DfareportingFloodlightActivitiesGeneratetagPathParams = dataclasses.field()
    query_params: DfareportingFloodlightActivitiesGeneratetagQueryParams = dataclasses.field()
    security: DfareportingFloodlightActivitiesGeneratetagSecurity = dataclasses.field()
...
class DfareportingFloodlightActivitiesGeneratetagResponse:
    ...
    floodlight_activities_generate_tag_response: Optional[shared_floodlightactivitiesgeneratetagresponse.FloodlightActivitiesGenerateTagResponse] = dataclasses.field(default=None)
