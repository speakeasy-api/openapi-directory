...
export const ListCredentialServerList = ["https://chat.twilio.com"] as const;
...
export class ListCredentialListCredentialResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ChatV2Credential })
  @Expose({ name: "credentials" })
  @Type(() => shared.ChatV2Credential)
  credentials?: shared.ChatV2Credential[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListCredentialListCredentialResponseMeta)
