...
class SingleMock200ApplicationJSON:
    ...
    mock: Optional[SingleMock200ApplicationJSONMock] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mock'), 'exclude': lambda f: f is None }})  
