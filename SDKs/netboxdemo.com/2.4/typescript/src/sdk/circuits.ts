...
export class Circuits {
  ...
  circuitsChoicesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CircuitsChoicesListResponse =
        new operations.CircuitsChoicesListResponse({
  ...
  circuitsChoicesRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CircuitsChoicesReadResponse =
        new operations.CircuitsChoicesReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
