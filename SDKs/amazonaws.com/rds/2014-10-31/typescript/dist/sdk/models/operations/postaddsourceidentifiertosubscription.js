...
exports.POSTAddSourceIdentifierToSubscriptionResponse = exports.POSTAddSourceIdentifierToSubscriptionRequest = exports.POSTAddSourceIdentifierToSubscriptionVersionEnum = exports.POSTAddSourceIdentifierToSubscriptionActionEnum = void 0;
...
(function (POSTAddSourceIdentifierToSubscriptionVersionEnum) {
    POSTAddSourceIdentifierToSubscriptionVersionEnum["TwoThousandAndFourteen1031"] = "2014-10-31";
...
var POSTAddSourceIdentifierToSubscriptionRequest = /** @class */ (function (_super) {
    ...
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], POSTAddSourceIdentifierToSubscriptionRequest.prototype, "xAmzSignedHeaders", void 0);
...
var POSTAddSourceIdentifierToSubscriptionResponse = /** @class */ (function (_super) {
    ...
    ], POSTAddSourceIdentifierToSubscriptionResponse.prototype, "rawResponse", void 0);
