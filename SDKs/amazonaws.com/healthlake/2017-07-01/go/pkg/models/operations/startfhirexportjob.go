...
func (e StartFHIRExportJobXAmzTargetEnum) ToPointer() *StartFHIRExportJobXAmzTargetEnum {
	return &e
}
...
func (e *StartFHIRExportJobXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "HealthLake.StartFHIRExportJob":
		*e = StartFHIRExportJobXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StartFHIRExportJobXAmzTargetEnum: %v", v)
	}
}
