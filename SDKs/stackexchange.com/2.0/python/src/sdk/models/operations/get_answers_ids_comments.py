...
class GetAnswersIdsCommentsQueryParams:
    ...
    order: Optional[GetAnswersIdsCommentsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetAnswersIdsCommentsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetAnswersIdsCommentsRequest:
    path_params: GetAnswersIdsCommentsPathParams = dataclasses.field()
    query_params: GetAnswersIdsCommentsQueryParams = dataclasses.field()
