 ...
 */
export declare class ComponentChromaKey extends SpeakeasyBase {
    /**
 ...
 * Crops the element
 */
export declare class ComponentCrop extends SpeakeasyBase {
    /**
 ...
 */
export declare enum ComponentPanEnum {
    Left = "left",
    Top = "top",
    Right = "right",
    Bottom = "bottom",
 ...
 */
export declare enum ComponentPositionEnum {
    TopLeft = "top-left",
    TopRight = "top-right",
    BottomRight = "bottom-right",
    BottomLeft = "bottom-left",
...
export declare class ComponentRotate extends SpeakeasyBase {
    /**
...
export declare class ComponentScale extends SpeakeasyBase {
    /**
...
export declare class Component extends SpeakeasyBase {
     ...
     * Pans the element to the specified direction. If <code>zoom</code> property is not specified, the effect is a non-zooming pan
     */
    pan?: ComponentPanEnum;
    /**
     * Sets the element position in the scene. A value of 'custom' sets a custom position based on the provided 'x' and 'y' properties
     */
    position?: ComponentPositionEnum;
