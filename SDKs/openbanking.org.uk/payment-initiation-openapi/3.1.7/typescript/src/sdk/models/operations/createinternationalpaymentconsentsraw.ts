...
export class CreateInternationalPaymentConsentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalPaymentConsentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalPaymentConsentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
