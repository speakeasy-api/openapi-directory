...
class SecuritycenterOrganizationsAssetsListPathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class SecuritycenterOrganizationsAssetsListQueryParams:
...
@dataclasses.dataclass
class SecuritycenterOrganizationsAssetsListSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class SecuritycenterOrganizationsAssetsListRequest:
    path_params: SecuritycenterOrganizationsAssetsListPathParams = dataclasses.field()
    query_params: SecuritycenterOrganizationsAssetsListQueryParams = dataclasses.field()
    security: SecuritycenterOrganizationsAssetsListSecurity = dataclasses.field()
    

@dataclasses.dataclass
class SecuritycenterOrganizationsAssetsListResponse:
