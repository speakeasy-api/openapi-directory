...
var Listing = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=carfax_1_owner" }),
        __metadata("design:type", Boolean)
    ], Listing.prototype, "carfax1Owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=carfax_clean_title" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dom_180" }),
        __metadata("design:type", Number)
    ], Listing.prototype, "dom180", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dom_active" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=financing_options", elemType: listingfinance_1.ListingFinance }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=first_seen_at_mc" }),
        __metadata("design:type", Number)
    ], Listing.prototype, "firstSeenAtMc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=first_seen_at_mc_date" }),
        __metadata("design:type", String)
    ], Listing.prototype, "firstSeenAtMcDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=first_seen_at_source" }),
        __metadata("design:type", Number)
    ], Listing.prototype, "firstSeenAtSource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=first_seen_at_source_date" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=leasing_options", elemType: listinglease_1.ListingLease }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ref_miles" }),
        __metadata("design:type", String)
    ], Listing.prototype, "refMiles", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ref_miles_dt" }),
        __metadata("design:type", Number)
    ], Listing.prototype, "refMilesDt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ref_price" }),
        __metadata("design:type", String)
    ], Listing.prototype, "refPrice", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ref_price_dt" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=vdp_url" }),
        __metadata("design:type", String)
