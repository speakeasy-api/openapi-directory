...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/eservicearunachal/3.0.0/python
```
...
req = operations.ChcerRequestBody(
    certificate_parameters=operations.ChcerRequestBodyCertificateParameters(
        ...
        ref_no="eService Certificate No like ARSTC/2018/005241",
        token_no="Printed on the bottom of the certificate like 8624",
    ),
