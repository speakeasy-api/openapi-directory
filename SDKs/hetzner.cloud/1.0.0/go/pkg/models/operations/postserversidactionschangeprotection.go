...
func (e *PostServersIDActionsChangeProtectionActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsChangeProtectionActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsChangeProtectionActionResponseActionStatusEnum: %s", s)
	}
}
