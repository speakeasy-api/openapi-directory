...
class APIV2010AccountCallCallRecording:
    ...
    r"""The API version used to make the recording."""  
    ...
    r"""The SID of the [Call](https://www.twilio.com/docs/voice/api/call-resource) the Recording resource is associated with."""  
    ...
    source: Optional[shared_call_recording_enum_source_enum.CallRecordingEnumSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('source'), 'exclude': lambda f: f is None }})  
    ...
    status: Optional[shared_call_recording_enum_status_enum.CallRecordingEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
    ...
    r"""The recorded track. Can be: `inbound`, `outbound`, or `both`."""  
