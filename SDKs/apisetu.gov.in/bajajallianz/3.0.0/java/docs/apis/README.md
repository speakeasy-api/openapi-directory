...
* [cyipc](#cyipc) - Insurance Policy - Cyber
    ...
    public static void main(String[] args) {
        try {
            ...
            CripcRequestBody req = new CripcRequestBody(CripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CripcRequestBodyCertificateParameters("Sunil Kumar", "OG-XX-XXXX-XXXX-XXXXXXXX");;
    ...
    public static void main(String[] args) {
        try {
            ...
            CvipcRequestBody req = new CvipcRequestBody(CvipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CvipcRequestBodyCertificateParameters("Sunil Kumar", "OG-XX-XXXX-XXXX-XXXXXXXX");;
...
import java.time.OffsetDateTime;
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.CyipcRequestBody;
import org.openapis.openapi.models.operations.CyipcRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.CyipcRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.CyipcResponse;
import org.openapis.openapi.models.operations.CyipcSecurity;
import org.openapis.openapi.models.shared.ConsentArtifactSchema;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsent;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentData;
import org.openapis.openapi.models.shared.ConsentArtifactSchemaConsentDataConsumer;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CyipcRequestBody req = new CyipcRequestBody(CyipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CyipcRequestBodyCertificateParameters("Sunil Kumar", "OG-XX-XXXX-XXXX-XXXXXXXX");;
            ...
            CyipcResponse res = sdk.apIs.cyipc(req, new CyipcSecurity("iure", "saepe") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            HlipcRequestBody req = new HlipcRequestBody(HlipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HlipcRequestBodyCertificateParameters("Sunil Kumar", "OG-XX-XXXX-XXXX-XXXXXXXX");;
    ...
    public static void main(String[] args) {
        try {
            ...
            HmipcRequestBody req = new HmipcRequestBody(HmipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HmipcRequestBodyCertificateParameters("Sunil Kumar", "OG-XX-XXXX-XXXX-XXXXXXXX");;
    ...
    public static void main(String[] args) {
        try {
            ...
            TripcRequestBody req = new TripcRequestBody(TripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TripcRequestBodyCertificateParameters("Sunil Kumar", "OG-XX-XXXX-XXXX-XXXXXXXX");;
    ...
    public static void main(String[] args) {
        try {
            ...
            TwipcRequestBody req = new TwipcRequestBody(TwipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TwipcRequestBodyCertificateParameters("Sunil Kumar", "OG-XX-XXXX-XXXX-XXXXXXXX");;
