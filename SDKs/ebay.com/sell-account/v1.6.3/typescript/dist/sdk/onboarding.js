...
var Onboarding = /** @class */ (function () {
    ...
    **/
    Onboarding.prototype.getPaymentsProgramOnboarding = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPaymentsProgramOnboardingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/payments_program/{marketplace_id}/{payments_program_type}/onboarding", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.paymentsProgramOnboardingResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
