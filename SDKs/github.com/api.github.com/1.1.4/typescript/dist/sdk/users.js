...
var Users = /** @class */ (function () {
    ...
    **/
    Users.prototype.usersBlock = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/user/blocks/{username}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    Users.prototype.usersListBlockedByAuthenticated = function (config) {
        var baseURL = this._serverURL;
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 415:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.usersListBlockedByAuthenticated415ApplicationJSONObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Users.prototype.usersSetPrimaryEmailVisibilityForAuthenticated = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
