...
@dataclasses.dataclass
class FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetQueryParams:
...
class FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetRequest:
    path_params: FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetPathParams = dataclasses.field()
    query_params: FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetQueryParams = dataclasses.field()
    security: FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetSecurity = dataclasses.field()
