...
func (e *UpdateNetworkWirelessSsidFirewallL7FirewallRulesRequestBodyRulesPolicyEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "deny":
		*e = UpdateNetworkWirelessSsidFirewallL7FirewallRulesRequestBodyRulesPolicyEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidFirewallL7FirewallRulesRequestBodyRulesPolicyEnum: %s", s)
	}
}
...
func (e *UpdateNetworkWirelessSsidFirewallL7FirewallRulesRequestBodyRulesTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "ipRange":
		fallthrough
	case "port":
		*e = UpdateNetworkWirelessSsidFirewallL7FirewallRulesRequestBodyRulesTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessSsidFirewallL7FirewallRulesRequestBodyRulesTypeEnum: %s", s)
	}
}
