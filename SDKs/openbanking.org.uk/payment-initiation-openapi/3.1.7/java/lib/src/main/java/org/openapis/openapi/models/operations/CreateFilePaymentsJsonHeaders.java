...
public class CreateFilePaymentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateFilePaymentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateFilePaymentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFilePaymentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateFilePaymentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentsJsonHeaders withXJwsSignature(String xJwsSignature) {
