...
export declare class PostIndividualsPartyIdAddressesRequest extends SpeakeasyBase {
    /**
     * Address resource
     */
...
export declare class PostIndividualsPartyIdAddressesResponse extends SpeakeasyBase {
    contentType: string;
