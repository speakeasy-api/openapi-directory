...
class DescribeReplicationSubnetGroupsRequest:
    ...
    describe_replication_subnet_groups_message: shared_describereplicationsubnetgroupsmessage.DescribeReplicationSubnetGroupsMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
