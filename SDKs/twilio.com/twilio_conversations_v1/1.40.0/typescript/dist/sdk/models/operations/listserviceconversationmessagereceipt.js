...
exports.ListServiceConversationMessageReceiptResponse = exports.ListServiceConversationMessageReceiptListServiceConversationMessageReceiptResponse = exports.ListServiceConversationMessageReceiptListServiceConversationMessageReceiptResponseMeta = exports.ListServiceConversationMessageReceiptRequest = exports.ListServiceConversationMessageReceiptSecurity = exports.ListServiceConversationMessageReceiptServerList = void 0;
...
var ListServiceConversationMessageReceiptSecurity = /** @class */ (function (_super) {
    ...
    ], ListServiceConversationMessageReceiptSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageReceiptSecurity.prototype, "username", void 0);
...
var ListServiceConversationMessageReceiptRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListServiceConversationMessageReceiptRequest.prototype, "chatServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConversationSid",
        }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageReceiptRequest.prototype, "conversationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=MessageSid",
        }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageReceiptRequest.prototype, "messageSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListServiceConversationMessageReceiptRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListServiceConversationMessageReceiptRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageReceiptRequest.prototype, "pageToken", void 0);
...
var ListServiceConversationMessageReceiptListServiceConversationMessageReceiptResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ConversationsV1ServiceServiceConversationServiceConversationMessageServiceConversationMessageReceipt,
        }),
        (0, class_transformer_1.Expose)({ name: "delivery_receipts" }),
        (0, class_transformer_1.Type)(function () {
            return shared.ConversationsV1ServiceServiceConversationServiceConversationMessageServiceConversationMessageReceipt;
        }),
...
var ListServiceConversationMessageReceiptResponse = /** @class */ (function (_super) {
    ...
    ], ListServiceConversationMessageReceiptResponse.prototype, "rawResponse", void 0);
