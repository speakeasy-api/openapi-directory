...
class APIV2010AccountUsageUsageRecordUsageRecordYesterday:
    ...
    category: Optional[shared_usage_record_yesterday_enum_category_enum.UsageRecordYesterdayEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})  
