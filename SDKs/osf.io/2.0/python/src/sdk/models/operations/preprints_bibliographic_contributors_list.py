...
class PreprintsBibliographicContributorsListContributorAttributesPermissionEnum(str, Enum):
...
@dataclasses.dataclass
class PreprintsBibliographicContributorsListContributorAttributes:
    ...
    permission: Optional[PreprintsBibliographicContributorsListContributorAttributesPermissionEnum] = dataclasses.field(default=None)
    r"""The permission level of the contributor. The default value is 'write'."""  
...
@dataclasses.dataclass
class PreprintsBibliographicContributorsListContributorLinks:
...
@dataclasses.dataclass
class PreprintsBibliographicContributorsListContributorRelationships:
...
class PreprintsBibliographicContributorsListContributor:
    ...
    relationships: PreprintsBibliographicContributorsListContributorRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the contributor entity."""  
    type: str = dataclasses.field()
    r"""The type identifier of the contributor entity (`contributors`)."""  
    attributes: Optional[PreprintsBibliographicContributorsListContributorAttributes] = dataclasses.field(default=None)
    r"""The properties of the contributor entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the contributor entity. Contributor identifiers have the form {preprint_id}-{user_id}."""  
    links: Optional[PreprintsBibliographicContributorsListContributorLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the contributor entity."""  
    

@dataclasses.dataclass
class PreprintsBibliographicContributorsListResponse:
