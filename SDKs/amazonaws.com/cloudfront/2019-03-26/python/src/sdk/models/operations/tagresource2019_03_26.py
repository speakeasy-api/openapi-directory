...
class TagResource20190326QueryParams:
...
@dataclasses.dataclass
class TagResource20190326Headers:
...
class TagResource20190326Request:
    headers: TagResource20190326Headers = dataclasses.field()
    query_params: TagResource20190326QueryParams = dataclasses.field()
