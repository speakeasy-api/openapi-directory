 ...
 */
export class CompanySearchNumberDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code: number;
...
export class CompanySearchNumber200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "address" })
  address?: string[];
...
export class CompanySearchNumberResponse extends SpeakeasyBase {
   ...
   * List of companies
   */
  @SpeakeasyMetadata({ elemType: CompanySearchNumber200ApplicationJSON })
