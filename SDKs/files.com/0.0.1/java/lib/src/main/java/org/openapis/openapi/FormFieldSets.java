...
public class FormFieldSets {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetFormFieldSetsResponse getFormFieldSets(org.openapis.openapi.models.operations.GetFormFieldSetsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.FormFieldSetEntity[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.FormFieldSetEntity[].class);
