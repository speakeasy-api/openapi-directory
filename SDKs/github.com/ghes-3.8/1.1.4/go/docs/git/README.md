...
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#create-a-blob>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#create-a-commit>
    ...
    res, err := s.Git.GitCreateCommit(ctx, operations.GitCreateCommitRequest{
        RequestBody: operations.GitCreateCommitRequestBody{
            Author: &operations.GitCreateCommitRequestBodyAuthor{
                Date: types.MustTimeFromString("2022-08-29T02:52:30.806Z"),
                Email: "Monica_Buckridge@yahoo.com",
                Name: "Oliver Luettgen IV",
            },
            Committer: &operations.GitCreateCommitRequestBodyCommitter{
                Date: types.MustTimeFromString("2022-02-01T01:47:57.463Z"),
                Email: sdk.String("Amara75@gmail.com"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#create-a-reference>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#create-a-tag-object>
    ...
    res, err := s.Git.GitCreateTag(ctx, operations.GitCreateTagRequest{
        RequestBody: operations.GitCreateTagRequestBody{
            ...
            Tagger: &operations.GitCreateTagRequestBodyTagger{
                Date: types.MustTimeFromString("2021-12-20T14:00:57.634Z"),
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#create-a-tree>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#delete-a-reference>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#get-a-blob>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#get-a-commit>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#get-a-reference>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#get-a-tag>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#get-a-tree>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#list-matching-references>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/git#update-a-reference>
