...
class ProfitAndLoss:
    ...
    def profit_and_loss_one(self, request: operations.ProfitAndLossOneRequest, security: operations.ProfitAndLossOneSecurity) -> operations.ProfitAndLossOneResponse:
        ...
        query_params = utils.get_query_params(operations.ProfitAndLossOneRequest, request)
        ...
        res = operations.ProfitAndLossOneResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetProfitAndLossResponse])
