...
exports.GetAEAssessmentsFromPayRunResponse = exports.GetAEAssessmentsFromPayRunRequest = void 0;
...
var GetAEAssessmentsFromPayRunRequest = /** @class */ (function (_super) {
    ...
    ], GetAEAssessmentsFromPayRunRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentsFromPayRunRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentsFromPayRunRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayRunId",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentsFromPayRunRequest.prototype, "payRunId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetAEAssessmentsFromPayRunRequest.prototype, "payScheduleId", void 0);
...
var GetAEAssessmentsFromPayRunResponse = /** @class */ (function (_super) {
    ...
    ], GetAEAssessmentsFromPayRunResponse.prototype, "rawResponse", void 0);
