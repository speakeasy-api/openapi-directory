...
from ..shared import createschemainput as shared_createschemainput
...
class CreateSchemaRequest:
    ...
    request: shared_createschemainput.CreateSchemaInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
