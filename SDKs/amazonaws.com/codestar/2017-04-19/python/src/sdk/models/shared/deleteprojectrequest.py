...
class DeleteProjectRequest:
    ...
    delete_stack: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deleteStack'), 'exclude': lambda f: f is None }})  
