...
class PatientPaymentsList200ApplicationJSON:
    ...
    data: Optional[list[shared_cashpayment.CashPayment]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""result data"""  
