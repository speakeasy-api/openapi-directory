...
func (e DeleteEventsIDBehaviourEnum) ToPointer() *DeleteEventsIDBehaviourEnum {
	return &e
}
...
func (e *DeleteEventsIDBehaviourEnum) UnmarshalJSON(data []byte) error {
	...
	case "forward":
		fallthrough
	case "all":
		*e = DeleteEventsIDBehaviourEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteEventsIDBehaviourEnum: %v", v)
	}
}
