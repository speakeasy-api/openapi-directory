...
class AppengineAppsFirewallIngressRulesCreateRequest:
    path_params: AppengineAppsFirewallIngressRulesCreatePathParams = dataclasses.field()
    query_params: AppengineAppsFirewallIngressRulesCreateQueryParams = dataclasses.field()
    security: AppengineAppsFirewallIngressRulesCreateSecurity = dataclasses.field()
