...
func NewHelp(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *Help {
	return &Help{
...
func (s *Help) GetListOfCountries(ctx context.Context, request operations.GetListOfCountriesRequest) (*operations.GetListOfCountriesResponse, error) {
