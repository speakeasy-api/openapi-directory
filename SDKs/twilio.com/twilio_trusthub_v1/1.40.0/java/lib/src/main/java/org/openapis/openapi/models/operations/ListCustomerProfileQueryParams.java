...
public class ListCustomerProfileQueryParams {
    ...
    public Long page;
    public ListCustomerProfileQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListCustomerProfileQueryParams withPageToken(String pageToken) {
    ...
    public ListCustomerProfileQueryParams withStatus(org.openapis.openapi.models.shared.CustomerProfileEnumStatusEnum status) {
        this.status = status;
        return this;
    }
