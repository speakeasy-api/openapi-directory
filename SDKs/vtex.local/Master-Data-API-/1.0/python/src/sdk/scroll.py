...
class Scroll:
    ...
    def scrolldocuments(self, request: operations.ScrolldocumentsRequest) -> operations.ScrolldocumentsResponse:
        ...
        url = utils.generate_url(operations.ScrolldocumentsRequest, base_url, '/api/dataentities/{dataEntityName}/scroll', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ScrolldocumentsRequest, request)
