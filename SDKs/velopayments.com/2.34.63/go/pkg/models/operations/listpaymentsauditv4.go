...
func (e *ListPaymentsAuditV4PostInstructFxStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "RESUBMITTED":
		fallthrough
	case "REFUNDED":
		*e = ListPaymentsAuditV4PostInstructFxStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListPaymentsAuditV4PostInstructFxStatusEnum: %s", s)
	}
}
...
func (e *ListPaymentsAuditV4ScheduleStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "EXECUTED":
		fallthrough
	case "FAILED":
		*e = ListPaymentsAuditV4ScheduleStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ListPaymentsAuditV4ScheduleStatusEnum: %s", s)
	}
}
