...
class RouteRequestAlgorithmEnum(str, Enum):
    r"""Rather than looking for the shortest or fastest path, this lets you solve two different problems related to routing:
...
class RouteRequestVehicleEnum(str, Enum):
    r"""The vehicle profile for which the route should be calculated. Other vehicles are listed [here](#section/Map-Data-and-Routing-Profiles/OpenStreetMap) for the details."""
    CAR = 'car'
    BIKE = 'bike'
    FOOT = 'foot'
    HIKE = 'hike'
...
class RouteRequest:
    ...
    algorithm: Optional[RouteRequestAlgorithmEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('algorithm'), 'exclude': lambda f: f is None }})
    r"""Rather than looking for the shortest or fastest path, this lets you solve two different problems related to routing:
    With `round_trip`, the route will get you back to where you started. This is meant for fun (think of
    a bike trip), so we will add some randomness. This requires `ch.disable=true`.
    With `alternative_route`, we give you not one but several routes that are close to optimal, but
    not too similar to each other. You can control both of these features with additional parameters, see below.
    """  
    alternative_route_max_paths: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alternative_route.max_paths'), 'exclude': lambda f: f is None }})
    ...
    alternative_route_max_share_factor: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alternative_route.max_share_factor'), 'exclude': lambda f: f is None }})
    ...
    alternative_route_max_weight_factor: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('alternative_route.max_weight_factor'), 'exclude': lambda f: f is None }})
    ...
    avoid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('avoid'), 'exclude': lambda f: f is None }})
    ...
    """  
    block_area: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('block_area'), 'exclude': lambda f: f is None }})
    r"""Block road access via a point with the format `latitude,longitude`
    ...
    ch_disable: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ch.disable'), 'exclude': lambda f: f is None }})
    r"""Use this parameter in combination with one or more parameters from below."""  
    curbsides: Optional[list[RouteRequestCurbsidesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('curbsides'), 'exclude': lambda f: f is None }})
    ...
    """  
    elevation: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('elevation'), 'exclude': lambda f: f is None }})
    ...
    """  
    heading_penalty: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('heading_penalty'), 'exclude': lambda f: f is None }})
    r"""Time penalty in seconds for not obeying a specified heading. Requires `ch.disable=true`."""  
    headings: Optional[list[int]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('headings'), 'exclude': lambda f: f is None }})
    ...
    """  
    instructions: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('instructions'), 'exclude': lambda f: f is None }})
    ...
    optimize: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('optimize'), 'exclude': lambda f: f is None }})
    ...
    """  
    pass_through: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pass_through'), 'exclude': lambda f: f is None }})
    ...
    r"""The points for the route in an array of `[longitude,latitude]`. For instance, if you want to calculate a route from point A to B to C
    ...
    """  
    round_trip_distance: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('round_trip.distance'), 'exclude': lambda f: f is None }})
    ...
    round_trip_seed: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('round_trip.seed'), 'exclude': lambda f: f is None }})
    ...
    vehicle: Optional[RouteRequestVehicleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vehicle'), 'exclude': lambda f: f is None }})  
    weighting: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('weighting'), 'exclude': lambda f: f is None }})
    r"""Determines the way the ''best'' route is calculated. Default is `fastest`. Other options are `shortest` (e.g. for `vehicle=foot` or `bike`) and `short_fastest` which finds a reasonable balance between `shortest` and `fastest`. Requires `ch.disable=true`."""  
