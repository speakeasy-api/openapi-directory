...
**/
var PolicyName = /** @class */ (function (_super) {
    __extends(PolicyName, _super);
    function PolicyName() {
    ...
    ], PolicyName.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=region" }),
        __metadata("design:type", String)
    ], PolicyName.prototype, "region", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], PolicyName.prototype, "type", void 0);
    return PolicyName;
