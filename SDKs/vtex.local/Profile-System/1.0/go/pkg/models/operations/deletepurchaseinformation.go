...
type DeletePurchaseInformationPathParams struct {
...
type DeletePurchaseInformationQueryParams struct {
...
type DeletePurchaseInformationHeaders struct {
...
type DeletePurchaseInformationRequest struct {
	PathParams  DeletePurchaseInformationPathParams
	QueryParams DeletePurchaseInformationQueryParams
	Headers     DeletePurchaseInformationHeaders
}

type DeletePurchaseInformationResponse struct {
	ContentType string
	StatusCode  int
