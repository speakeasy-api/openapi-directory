 ...
 */
public enum Webinar200ApplicationXMLSettingsQuestionAndAnswerAnswerQuestionsEnum {
    ONLY("only"),
    ALL("all");
    ...
    private Webinar200ApplicationXMLSettingsQuestionAndAnswerAnswerQuestionsEnum(String value) {
        this.value = value;
    }
}
