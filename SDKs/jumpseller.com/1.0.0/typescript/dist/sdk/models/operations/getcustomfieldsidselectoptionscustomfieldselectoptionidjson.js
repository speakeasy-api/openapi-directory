...
exports.GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonResponse = exports.GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest = void 0;
...
var GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=custom_field_select_option_id",
        }),
        __metadata("design:type", Number)
    ], GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest.prototype, "customFieldSelectOptionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest.prototype, "login", void 0);
    return GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest = GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonRequest;
var GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonResponse.prototype, "rawResponse", void 0);
    return GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonResponse = GetCustomFieldsIdSelectOptionsCustomFieldSelectOptionIdJsonResponse;
