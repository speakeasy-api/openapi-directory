...
class GetOrderResponse:
    ...
    reasons: Optional[list[GetOrderResponseReasons]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reasons'), 'exclude': lambda f: f is None }})  
