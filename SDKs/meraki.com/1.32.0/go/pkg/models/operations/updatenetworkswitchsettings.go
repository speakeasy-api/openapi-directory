...
func (e UpdateNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum) ToPointer() *UpdateNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum {
	return &e
}
...
func (e *UpdateNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "redundant":
		fallthrough
	case "useNetworkSetting":
		*e = UpdateNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum: %v", v)
	}
}
