...
class NodesContributorsReadContributorAttributesPermissionEnum(str, Enum):
...
class NodesContributorsReadContributorAttributes:
    ...
    permission: Optional[NodesContributorsReadContributorAttributesPermissionEnum] = dataclasses.field(default=None)
    r"""The permission level of the contributor. The default value is 'write'."""  
...
@dataclasses.dataclass
class NodesContributorsReadContributorLinks:
...
@dataclasses.dataclass
class NodesContributorsReadContributorRelationships:
...
@dataclasses.dataclass
class NodesContributorsReadContributor:
    
    relationships: NodesContributorsReadContributorRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the contributor entity."""  
    type: str = dataclasses.field()
    r"""The type identifier of the contributor entity (`contributors`)."""  
    attributes: Optional[NodesContributorsReadContributorAttributes] = dataclasses.field(default=None)
    r"""The properties of the contributor entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the contributor entity. Contributor identifiers have the form {node_id}-{user_id}."""  
    links: Optional[NodesContributorsReadContributorLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the contributor entity."""  
