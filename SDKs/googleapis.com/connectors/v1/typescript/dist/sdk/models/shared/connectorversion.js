...
var sslconfigtemplate_1 = require("./sslconfigtemplate");
...
var ConnectorVersion = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: authconfigtemplate_1.AuthConfigTemplate }),
        (0, class_transformer_1.Expose)({ name: "authConfigTemplates" }),
        (0, class_transformer_1.Type)(function () { return authconfigtemplate_1.AuthConfigTemplate; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "configVariableTemplates" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "egressControlConfig" }),
        (0, class_transformer_1.Type)(function () { return egresscontrolconfig_1.EgressControlConfig; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: rolegrant_1.RoleGrant }),
        (0, class_transformer_1.Expose)({ name: "roleGrants" }),
        (0, class_transformer_1.Type)(function () { return rolegrant_1.RoleGrant; }),
        __metadata("design:type", Array)
    ], ConnectorVersion.prototype, "roleGrants", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "sslConfigTemplate" }),
        (0, class_transformer_1.Type)(function () { return sslconfigtemplate_1.SslConfigTemplate; }),
        __metadata("design:type", sslconfigtemplate_1.SslConfigTemplate)
    ], ConnectorVersion.prototype, "sslConfigTemplate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "supportedRuntimeFeatures" }),
        (0, class_transformer_1.Type)(function () { return supportedruntimefeatures_1.SupportedRuntimeFeatures; }),
