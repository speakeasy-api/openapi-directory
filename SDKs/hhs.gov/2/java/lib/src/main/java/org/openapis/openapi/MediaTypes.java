...
public class MediaTypes {
    ...
    public org.openapis.openapi.models.operations.GetResourcesMediaTypesFormatResponse getResourcesMediaTypesFormat(org.openapis.openapi.models.operations.GetResourcesMediaTypesFormatRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetResourcesMediaTypesFormatResponse res = new org.openapis.openapi.models.operations.GetResourcesMediaTypesFormatResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.MediaTypeHolderWrapped[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.MediaTypeHolderWrapped[].class);
