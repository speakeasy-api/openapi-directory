...
@dataclasses.dataclass
class FirebasehostingOperationsListQueryParams:
...
class FirebasehostingOperationsListRequest:
    path_params: FirebasehostingOperationsListPathParams = dataclasses.field()
    query_params: FirebasehostingOperationsListQueryParams = dataclasses.field()
