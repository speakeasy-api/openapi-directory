...
public class PostApiInvoiceUpdatecategoryRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceUpdatecategoryRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceUpdatecategoryRawHeaders withXAuthSecret(String xAuthSecret) {
