...
public class DoubleclicksearchConversionGetRequest {
    ...
    public DoubleclicksearchConversionGetRequest(@JsonProperty("advertiserId") String advertiserId, @JsonProperty("agencyId") String agencyId, @JsonProperty("endDate") Long endDate, @JsonProperty("engineAccountId") String engineAccountId, @JsonProperty("rowCount") Long rowCount, @JsonProperty("startDate") Long startDate, @JsonProperty("startRow") Long startRow) {
        this.advertiserId = advertiserId;
        this.agencyId = agencyId;
        this.endDate = endDate;
        this.engineAccountId = engineAccountId;
