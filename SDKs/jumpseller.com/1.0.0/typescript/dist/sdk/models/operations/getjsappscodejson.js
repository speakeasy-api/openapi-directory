...
exports.GetJsappsCodeJsonResponse = exports.GetJsappsCodeJsonRequest = void 0;
...
var GetJsappsCodeJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetJsappsCodeJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=code",
        }),
        __metadata("design:type", String)
    ], GetJsappsCodeJsonRequest.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetJsappsCodeJsonRequest.prototype, "login", void 0);
    return GetJsappsCodeJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetJsappsCodeJsonRequest = GetJsappsCodeJsonRequest;
var GetJsappsCodeJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetJsappsCodeJsonResponse.prototype, "rawResponse", void 0);
    return GetJsappsCodeJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetJsappsCodeJsonResponse = GetJsappsCodeJsonResponse;
