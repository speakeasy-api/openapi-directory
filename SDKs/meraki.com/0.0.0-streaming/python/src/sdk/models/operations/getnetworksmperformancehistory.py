...
class GetNetworkSmPerformanceHistoryRequest:
...
class GetNetworkSmPerformanceHistoryResponse:
    ...
    get_network_sm_performance_history_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
