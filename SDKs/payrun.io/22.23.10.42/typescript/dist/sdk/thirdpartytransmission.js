...
var ThirdPartyTransmission = /** @class */ (function () {
    ...
    ThirdPartyTransmission.prototype.deleteThirdPartyTransaction = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/Employer/{EmployerId}/ThirdPartyTransaction/{ThirdPartyTransactionId}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DeleteThirdPartyTransactionResponse({
    ...
    ThirdPartyTransmission.prototype.getThirdPartyTransaction = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetThirdPartyTransactionResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    ThirdPartyTransmission.prototype.getThirdPartyTransactions = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/Employer/{EmployerId}/ThirdPartyTransactions", req);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetThirdPartyTransactionsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
