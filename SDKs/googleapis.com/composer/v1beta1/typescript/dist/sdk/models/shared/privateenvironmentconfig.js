...
var PrivateEnvironmentConfigInput = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "cloudComposerConnectionSubnetwork" }),
        __metadata("design:type", String)
    ], PrivateEnvironmentConfigInput.prototype, "cloudComposerConnectionSubnetwork", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cloudComposerNetworkIpv4CidrBlock" }),
        __metadata("design:type", String)
    ], PrivateEnvironmentConfigInput.prototype, "cloudComposerNetworkIpv4CidrBlock", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cloudSqlIpv4CidrBlock" }),
        __metadata("design:type", String)
    ], PrivateEnvironmentConfigInput.prototype, "cloudSqlIpv4CidrBlock", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "enablePrivateEnvironment" }),
        __metadata("design:type", Boolean)
    ], PrivateEnvironmentConfigInput.prototype, "enablePrivateEnvironment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "enablePrivatelyUsedPublicIps" }),
        __metadata("design:type", Boolean)
    ], PrivateEnvironmentConfigInput.prototype, "enablePrivatelyUsedPublicIps", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "networkingConfig" }),
        (0, class_transformer_1.Type)(function () { return networkingconfig_1.NetworkingConfig; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "webServerIpv4CidrBlock" }),
        __metadata("design:type", String)
...
var PrivateEnvironmentConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cloudComposerNetworkIpv4ReservedRange" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "webServerIpv4ReservedRange" }),
        __metadata("design:type", String)
