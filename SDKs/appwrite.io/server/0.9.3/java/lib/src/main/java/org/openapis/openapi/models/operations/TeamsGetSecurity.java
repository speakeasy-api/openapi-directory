...
public class TeamsGetSecurity {
    ...
    public TeamsGetSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public TeamsGetSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public TeamsGetSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public TeamsGetSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
