...
from ..shared import legalentityinfo as shared_legalentityinfo
...
class PatchLegalEntitiesIDRequest:
    ...
    legal_entity_info_input: Optional[shared_legalentityinfo.LegalEntityInfoInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
