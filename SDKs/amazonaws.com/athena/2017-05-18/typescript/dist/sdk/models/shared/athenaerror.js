 ...
 */
var AthenaError = /** @class */ (function (_super) {
    __extends(AthenaError, _super);
    function AthenaError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ErrorCategory" }),
        __metadata("design:type", Number)
    ], AthenaError.prototype, "errorCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ErrorMessage" }),
        __metadata("design:type", String)
    ], AthenaError.prototype, "errorMessage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ErrorType" }),
        __metadata("design:type", Number)
    ], AthenaError.prototype, "errorType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Retryable" }),
        __metadata("design:type", Boolean)
    ], AthenaError.prototype, "retryable", void 0);
    return AthenaError;
