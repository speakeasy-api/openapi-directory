...
class DeregisterTaskDefinitionRequest:
    ...
    deregister_task_definition_request: shared_deregistertaskdefinitionrequest.DeregisterTaskDefinitionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
