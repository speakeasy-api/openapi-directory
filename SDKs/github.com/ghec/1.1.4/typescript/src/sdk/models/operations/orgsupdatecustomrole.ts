 ...
 */
export enum OrgsUpdateCustomRoleRequestBodyBaseRoleEnum {
  Read = "read",
  Triage = "triage",
  Write = "write",
  Maintain = "maintain",
...
export class OrgsUpdateCustomRoleRequestBody extends SpeakeasyBase {
  /**
   * The system role from which this role inherits permissions.
   */
  @SpeakeasyMetadata()
...
export class OrgsUpdateCustomRoleRequest extends SpeakeasyBase {
...
export class OrgsUpdateCustomRoleResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
