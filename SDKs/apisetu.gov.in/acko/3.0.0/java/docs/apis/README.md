    ...
    public static void main(String[] args) {
        try {
            ...
            HlipcRequestBody req = new HlipcRequestBody(HlipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HlipcRequestBodyCertificateParameters("10 Digits without any prefix", "DXXXXXXXXXXXXX/XX OR AROGXXXXXXXXXX");;
            ...
            HlipcResponse res = sdk.apIs.hlipc(req, new HlipcSecurity("qui", "impedit") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            TwipcRequestBody req = new TwipcRequestBody(TwipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TwipcRequestBodyCertificateParameters("10 Digits without any prefix", "DXXXXXXXXXXXXX/XX OR AROGXXXXXXXXXX");;
            ...
            TwipcResponse res = sdk.apIs.twipc(req, new TwipcSecurity("iure", "saepe") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
