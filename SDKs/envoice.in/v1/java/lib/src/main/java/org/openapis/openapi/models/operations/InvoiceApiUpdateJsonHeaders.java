...
public class InvoiceApiUpdateJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiUpdateJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiUpdateJsonHeaders withXAuthSecret(String xAuthSecret) {
