    ...
    public static void main(String[] args) {
        try {
            ...
            DpcerRequestBody req = new DpcerRequestBody(DpcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new DpcerRequestBodyCertificateParameters("Sunil Kumar", "123412341234", "xxxx123");;
            ...
            DpcerResponse res = sdk.apIs.dpcer(req, new DpcerSecurity("maiores", "molestiae") {{
