...
func (e BorderStyleEnum) ToPointer() *BorderStyleEnum {
	return &e
}

func (e *BorderStyleEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "DOUBLE":
		*e = BorderStyleEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BorderStyleEnum: %v", v)
	}
}
