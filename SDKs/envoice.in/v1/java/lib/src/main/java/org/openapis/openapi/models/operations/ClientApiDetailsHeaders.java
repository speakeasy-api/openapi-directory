...
public class ClientApiDetailsHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public ClientApiDetailsHeaders withXAuthKey(String xAuthKey) {
    ...
    public ClientApiDetailsHeaders withXAuthSecret(String xAuthSecret) {
