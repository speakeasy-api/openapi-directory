...
func (e DeleteEdgeDeploymentStageXAmzTargetEnum) ToPointer() *DeleteEdgeDeploymentStageXAmzTargetEnum {
	return &e
}
...
func (e *DeleteEdgeDeploymentStageXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "SageMaker.DeleteEdgeDeploymentStage":
		*e = DeleteEdgeDeploymentStageXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteEdgeDeploymentStageXAmzTargetEnum: %v", v)
	}
}
