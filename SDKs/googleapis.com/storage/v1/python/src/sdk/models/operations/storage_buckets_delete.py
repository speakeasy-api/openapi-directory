...
class StorageBucketsDeleteRequest:
    ...
    r"""If set, only deletes the bucket if its metageneration matches this value."""  
    ...
    r"""If set, only deletes the bucket if its metageneration does not match this value."""  
