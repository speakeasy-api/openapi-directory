...
class Robot:
    ...
    green_grass_group_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('greenGrassGroupId'), 'exclude': lambda f: f is None }})  
