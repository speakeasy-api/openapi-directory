...
class GetAccountsAccountIDBeneficiariesRequest:
    headers: GetAccountsAccountIDBeneficiariesHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDBeneficiariesPathParams = dataclasses.field()
    security: GetAccountsAccountIDBeneficiariesSecurity = dataclasses.field()
