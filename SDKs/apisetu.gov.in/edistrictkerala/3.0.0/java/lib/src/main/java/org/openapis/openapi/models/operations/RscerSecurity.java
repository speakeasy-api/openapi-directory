...
public class RscerSecurity {
    ...
    public RscerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public RscerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public RscerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
