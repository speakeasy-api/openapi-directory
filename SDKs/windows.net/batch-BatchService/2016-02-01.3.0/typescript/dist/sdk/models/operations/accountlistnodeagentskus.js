...
exports.AccountListNodeAgentSkusResponse = exports.AccountListNodeAgentSkusRequest = void 0;
...
var AccountListNodeAgentSkusRequest = /** @class */ (function (_super) {
    ...
    ], AccountListNodeAgentSkusRequest.prototype, "dollarFilter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], AccountListNodeAgentSkusRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], AccountListNodeAgentSkusRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=maxresults",
        }),
        __metadata("design:type", Number)
    ], AccountListNodeAgentSkusRequest.prototype, "maxresults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], AccountListNodeAgentSkusRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], AccountListNodeAgentSkusRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], AccountListNodeAgentSkusRequest.prototype, "timeout", void 0);
...
var AccountListNodeAgentSkusResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.AccountListNodeAgentSkusResult)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], AccountListNodeAgentSkusResponse.prototype, "rawResponse", void 0);
