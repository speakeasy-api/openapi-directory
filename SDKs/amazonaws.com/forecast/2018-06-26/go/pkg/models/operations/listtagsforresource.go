...
const (
	ListTagsForResourceXAmzTargetEnumAmazonForecastListTagsForResource ListTagsForResourceXAmzTargetEnum = "AmazonForecast.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AmazonForecast.ListTagsForResource":
