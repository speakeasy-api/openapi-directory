...
class GetRebalanceSlotsInGlobalReplicationGroupQueryParams:
    action: GetRebalanceSlotsInGlobalReplicationGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetRebalanceSlotsInGlobalReplicationGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRebalanceSlotsInGlobalReplicationGroupRequest:
    headers: GetRebalanceSlotsInGlobalReplicationGroupHeaders = dataclasses.field()
    query_params: GetRebalanceSlotsInGlobalReplicationGroupQueryParams = dataclasses.field()
