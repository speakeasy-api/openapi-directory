...
public class ChromemanagementCustomersTelemetryDevicesListQueryParams {
    ...
    public ChromemanagementCustomersTelemetryDevicesListQueryParams withDollarXgafv(openapisdk.models.shared.XgafvEnum dollarXgafv) {
    ...
    public ChromemanagementCustomersTelemetryDevicesListQueryParams withAlt(openapisdk.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
