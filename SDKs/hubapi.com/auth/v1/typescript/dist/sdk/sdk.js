...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.refreshTokens = new refreshtokens_1.RefreshTokens(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
