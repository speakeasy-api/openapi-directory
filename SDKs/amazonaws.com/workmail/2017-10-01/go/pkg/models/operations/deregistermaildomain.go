...
type DeregisterMailDomainHeaders struct {
...
type DeregisterMailDomainRequest struct {
	Headers DeregisterMailDomainHeaders
	Request shared.DeregisterMailDomainRequest `request:"mediaType=application/json"`
}
