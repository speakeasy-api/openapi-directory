 ...
 *
 */
var BusinessNames = /** @class */ (function () {
    function BusinessNames(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
     */
    BusinessNames.prototype.getBusinessNames = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetBusinessNamesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/business-names";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetBusinessNamesResponse({
...
exports.BusinessNames = BusinessNames;
