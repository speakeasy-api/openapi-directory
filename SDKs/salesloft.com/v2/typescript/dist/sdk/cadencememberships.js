...
exports.CadenceMemberships = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
/**
 * Cadence Membership
 */
var CadenceMemberships = /** @class */ (function () {
    function CadenceMemberships(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
     */
    CadenceMemberships.prototype.deleteV2CadenceMembershipsIdJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteV2CadenceMembershipsIdJsonRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/cadence_memberships/{id}.json", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.DeleteV2CadenceMembershipsIdJsonResponse({
     ...
     *
     */
    CadenceMemberships.prototype.getV2CadenceMembershipsJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetV2CadenceMembershipsJsonRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v2/cadence_memberships.json";
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetV2CadenceMembershipsJsonResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     */
    CadenceMemberships.prototype.getV2CadenceMembershipsIdJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetV2CadenceMembershipsIdJsonResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     *
     */
    CadenceMemberships.prototype.postV2CadenceMembershipsJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostV2CadenceMembershipsJsonResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
...
exports.CadenceMemberships = CadenceMemberships;
