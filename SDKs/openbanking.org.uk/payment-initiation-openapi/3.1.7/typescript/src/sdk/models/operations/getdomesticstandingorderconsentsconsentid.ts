...
export class GetDomesticStandingOrderConsentsConsentIdSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetDomesticStandingOrderConsentsConsentIdRequest extends SpeakeasyBase {
  /**
...
export class GetDomesticStandingOrderConsentsConsentIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
