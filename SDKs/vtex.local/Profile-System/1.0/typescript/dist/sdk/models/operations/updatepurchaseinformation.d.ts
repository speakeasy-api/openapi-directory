...
export declare class UpdatePurchaseInformationRequest extends SpeakeasyBase {
    /**
...
export declare class UpdatePurchaseInformationResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
     ...
     * OK
     */
    updatePurchaseInformation200ApplicationJSONObject?: Record<string, any>;
}
