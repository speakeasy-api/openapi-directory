...
func (e CreateEnvironmentXAmzTargetEnum) ToPointer() *CreateEnvironmentXAmzTargetEnum {
	return &e
}
...
func (e *CreateEnvironmentXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AwsProton20200720.CreateEnvironment":
		*e = CreateEnvironmentXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateEnvironmentXAmzTargetEnum: %v", v)
	}
}
