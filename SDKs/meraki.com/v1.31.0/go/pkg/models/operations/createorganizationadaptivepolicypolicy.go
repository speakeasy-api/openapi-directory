...
func (e *CreateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum) UnmarshalJSON(data []byte) error {
	...
	case "default":
		fallthrough
	case "deny":
		*e = CreateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOrganizationAdaptivePolicyPolicyRequestBodyLastEntryRuleEnum: %s", s)
	}
}
