 ...
 */
export class DescribeClassicLinkInstancesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeClassicLinkInstancesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeClassicLinkInstancesRequestFilters })
  filters?: DescribeClassicLinkInstancesRequestFilters[];
