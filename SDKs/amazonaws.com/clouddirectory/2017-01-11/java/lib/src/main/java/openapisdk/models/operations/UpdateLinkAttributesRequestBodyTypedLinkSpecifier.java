...
**/
public class UpdateLinkAttributesRequestBodyTypedLinkSpecifier {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("IdentityAttributeValues")
    public openapisdk.models.shared.AttributeNameAndValue[] identityAttributeValues;
    public UpdateLinkAttributesRequestBodyTypedLinkSpecifier withIdentityAttributeValues(openapisdk.models.shared.AttributeNameAndValue[] identityAttributeValues) {
    ...
    public UpdateLinkAttributesRequestBodyTypedLinkSpecifier withSourceObjectReference(openapisdk.models.shared.ObjectReference sourceObjectReference) {
    ...
    public UpdateLinkAttributesRequestBodyTypedLinkSpecifier withTargetObjectReference(openapisdk.models.shared.ObjectReference targetObjectReference) {
    ...
    public UpdateLinkAttributesRequestBodyTypedLinkSpecifier withTypedLinkFacet(openapisdk.models.shared.TypedLinkSchemaAndFacetName typedLinkFacet) {
