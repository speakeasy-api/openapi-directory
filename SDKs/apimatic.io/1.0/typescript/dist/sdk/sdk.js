 ...
 */
exports.ServerList = ["https://apimatic.io/api/transform"];
/**
...
var SDK = /** @class */ (function () {
     ...
     * * APIMATIC Format
     */
    SDK.prototype.convertAPI = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConvertAPIRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/transform";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ConvertAPIResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.convertAPI200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
