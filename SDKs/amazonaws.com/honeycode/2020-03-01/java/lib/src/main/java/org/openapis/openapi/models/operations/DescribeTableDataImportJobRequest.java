...
public class DescribeTableDataImportJobRequest {
    ...
    public DescribeTableDataImportJobRequest(@JsonProperty("jobId") String jobId, @JsonProperty("tableId") String tableId, @JsonProperty("workbookId") String workbookId) {
        this.jobId = jobId;
        this.tableId = tableId;
        this.workbookId = workbookId;
  }
