...
from ..shared import wkhtmltopdfurltopdfrequest as shared_wkhtmltopdfurltopdfrequest
...
class WkhtmltopdfFromURLPostRequest:
    request: Optional[shared_wkhtmltopdfurltopdfrequest.WkHTMLToPdfURLToPdfRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
