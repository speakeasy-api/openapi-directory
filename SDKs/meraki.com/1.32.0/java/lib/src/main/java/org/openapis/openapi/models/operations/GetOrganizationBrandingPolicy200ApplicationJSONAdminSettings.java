 ...
 */
public class GetOrganizationBrandingPolicy200ApplicationJSONAdminSettings {
    /**
    ...
    public GetOrganizationBrandingPolicy200ApplicationJSONAdminSettingsAppliesToEnum appliesTo;

    public GetOrganizationBrandingPolicy200ApplicationJSONAdminSettings withAppliesTo(GetOrganizationBrandingPolicy200ApplicationJSONAdminSettingsAppliesToEnum appliesTo) {
    ...
    public GetOrganizationBrandingPolicy200ApplicationJSONAdminSettings withValues(String[] values) {
        this.values = values;
        return this;
    }
    
    public GetOrganizationBrandingPolicy200ApplicationJSONAdminSettings(){}
}
