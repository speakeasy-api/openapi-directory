...
class ModifiersOneRequest:
    headers: ModifiersOneHeaders = dataclasses.field()
    path_params: ModifiersOnePathParams = dataclasses.field()
    query_params: ModifiersOneQueryParams = dataclasses.field()
    security: ModifiersOneSecurity = dataclasses.field()
