 ...
 */
export class UsersPreprintsListPreprintAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class UsersPreprintsListPreprintLinks extends SpeakeasyBase {
  /**
 ...
 */
export class UsersPreprintsListPreprintRelationships extends SpeakeasyBase {
  /**
...
export class UsersPreprintsListPreprint extends SpeakeasyBase {
  /**
   * The properties of the preprint entity.
   */
  @SpeakeasyMetadata()
