...
class GetSchemaByDefinitionRequest:
    ...
    get_schema_by_definition_input: shared_getschemabydefinitioninput.GetSchemaByDefinitionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
