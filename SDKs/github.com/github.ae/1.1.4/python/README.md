...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/github.com/github.ae/1.1.4/python
```
...
* `meta_get` - Get GitHub AE meta information
...
* `repos_create_pages_site` - Create a GitHub AE Pages site
...
* `repos_delete_pages_site` - Delete a GitHub AE Pages site
...
* `repos_get_pages` - Get a GitHub AE Pages site
* `repos_get_pages_build` - Get GitHub AE Pages build
...
* `repos_list_pages_builds` - List GitHub AE Pages builds
...
* `repos_request_pages_build` - Request a GitHub AE Pages build
...
* `repos_update_information_about_pages_site` - Update information about a GitHub AE Pages site
