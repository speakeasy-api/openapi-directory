...
class FormsFormsWatchesCreateRequest:
    ...
    r"""Required. ID of the Form to watch."""  
    ...
    r"""JSONP"""  
    create_watch_request_input: Optional[shared_createwatchrequest.CreateWatchRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
