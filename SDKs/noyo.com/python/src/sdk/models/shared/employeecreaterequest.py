...
class EmployeeCreateRequestEmploymentSalary:
    ...
    type: Optional[EmployeeCreateRequestEmploymentSalaryTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Type of salary earned by the employee"""  
    unit: Optional[EmployeeCreateRequestEmploymentSalaryUnitEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit'), 'exclude': lambda f: f is None }})
    r"""Unit of salary earned by the employee"""  
...
class EmployeeCreateRequestEmployment:
    ...
    employment_dates: Optional[EmployeeCreateRequestEmploymentEmploymentDates] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('employment_dates'), 'exclude': lambda f: f is None }})
    r"""Employee employment dates"""  
    employment_status: Optional[EmployeeCreateRequestEmploymentEmploymentStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('employment_status'), 'exclude': lambda f: f is None }})
    r"""Employee employment status at the company"""  
    ...
    salary: Optional[EmployeeCreateRequestEmploymentSalary] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('salary'), 'exclude': lambda f: f is None }})
    r"""Employee salary information"""  
...
class EmployeeCreateRequestPersonContact:
    ...
    email_address_type: Optional[EmployeeCreateRequestPersonContactEmailAddressTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('email_address_type'), 'exclude': lambda f: f is None }})
    r"""Type of email address"""  
    ...
    preferred_method: Optional[EmployeeCreateRequestPersonContactPreferredMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('preferred_method'), 'exclude': lambda f: f is None }})
    r"""Preferred method of contact for the person"""  
...
class EmployeeCreateRequestPersonDetailsAmericanIndian:
    ...
    state: Optional[EmployeeCreateRequestPersonDetailsAmericanIndianStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""Primary state of the federally-recognized American Indian or Alaska Native tribe, if applicable"""  
...
class EmployeeCreateRequestPersonDetailsTobacco:
    ...
    types: Optional[list[EmployeeCreateRequestPersonDetailsTobaccoTypesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('types'), 'exclude': lambda f: f is None }})
...
class EmployeeCreateRequestPersonDetails:
    ...
    american_indian: Optional[EmployeeCreateRequestPersonDetailsAmericanIndian] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('american_indian'), 'exclude': lambda f: f is None }})
    r"""American Indian status details (if applicable)"""  
    disability: Optional[EmployeeCreateRequestPersonDetailsDisability] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('disability'), 'exclude': lambda f: f is None }})
    r"""Disability details (if applicable)"""  
    ...
    tobacco: Optional[EmployeeCreateRequestPersonDetailsTobacco] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tobacco'), 'exclude': lambda f: f is None }})
    r"""Tobacco usage details (if applicable)"""  
...
class EmployeeCreateRequestPersonHomeAddress:
    ...
    state: EmployeeCreateRequestPersonHomeAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""State postal code of the address"""  
...
class EmployeeCreateRequestPersonMailingAddress:
    ...
    city: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('city') }})
    r"""City of the address"""  
    state: EmployeeCreateRequestPersonMailingAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""State postal code of the address"""  
    street_one: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('street_one') }})
    r"""Line one of the address"""  
    zip_code: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('zip_code') }})
...
class EmployeeCreateRequestPerson:
    ...
    sex: EmployeeCreateRequestPersonSexEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sex') }})
    r"""Sex of the person"""  
    contact: Optional[EmployeeCreateRequestPersonContact] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contact'), 'exclude': lambda f: f is None }})
    r"""Contact information for the person"""  
    details: Optional[EmployeeCreateRequestPersonDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('details'), 'exclude': lambda f: f is None }})
    r"""Additional personal details of the person"""  
    home_address: Optional[EmployeeCreateRequestPersonHomeAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('home_address'), 'exclude': lambda f: f is None }})
    r"""Home address of the person"""  
    mailing_address: Optional[EmployeeCreateRequestPersonMailingAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mailing_address'), 'exclude': lambda f: f is None }})
    r"""Mailing address of the person"""  
    marital_status: Optional[EmployeeCreateRequestPersonMaritalStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('marital_status'), 'exclude': lambda f: f is None }})
    r"""Marital status of the person"""  
...
class EmployeeCreateRequest:
    ...
    person: EmployeeCreateRequestPerson = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('person') }})
    r"""Personal information for the employee"""  
    employment: Optional[EmployeeCreateRequestEmployment] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('employment'), 'exclude': lambda f: f is None }})
    r"""Employment information for the employee"""  
