...
class CustomFields:
    ...
    def create_custom_field(self, request: operations.CreateCustomFieldRequest) -> operations.CreateCustomFieldResponse:
        ...
        url = base_url.removesuffix("/") + "/custom_fields"
        ...
        res = operations.CreateCustomFieldResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.CreateCustomField201ApplicationJSON])
    ...
    def create_enum_option_for_custom_field(self, request: operations.CreateEnumOptionForCustomFieldRequest) -> operations.CreateEnumOptionForCustomFieldResponse:
        ...
        url = utils.generate_url(base_url, "/custom_fields/{custom_field_gid}/enum_options", request.path_params)
        ...
        res = operations.CreateEnumOptionForCustomFieldResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.CreateEnumOptionForCustomField201ApplicationJSON])
    ...
    def delete_custom_field(self, request: operations.DeleteCustomFieldRequest) -> operations.DeleteCustomFieldResponse:
        ...
        url = utils.generate_url(base_url, "/custom_fields/{custom_field_gid}", request.path_params)
        ...
        res = operations.DeleteCustomFieldResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.DeleteCustomField200ApplicationJSON])
    ...
    def get_custom_field(self, request: operations.GetCustomFieldRequest) -> operations.GetCustomFieldResponse:
        ...
        res = operations.GetCustomFieldResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetCustomField200ApplicationJSON])
    ...
    def get_custom_fields_for_workspace(self, request: operations.GetCustomFieldsForWorkspaceRequest) -> operations.GetCustomFieldsForWorkspaceResponse:
        ...
        url = utils.generate_url(base_url, "/workspaces/{workspace_gid}/custom_fields", request.path_params)
        ...
        res = operations.GetCustomFieldsForWorkspaceResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetCustomFieldsForWorkspace200ApplicationJSON])
    ...
    def insert_enum_option_for_custom_field(self, request: operations.InsertEnumOptionForCustomFieldRequest) -> operations.InsertEnumOptionForCustomFieldResponse:
        ...
        url = utils.generate_url(base_url, "/custom_fields/{custom_field_gid}/enum_options/insert", request.path_params)
        ...
        res = operations.InsertEnumOptionForCustomFieldResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.InsertEnumOptionForCustomField200ApplicationJSON])
    ...
    def update_custom_field(self, request: operations.UpdateCustomFieldRequest) -> operations.UpdateCustomFieldResponse:
        ...
        res = operations.UpdateCustomFieldResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.UpdateCustomField200ApplicationJSON])
    ...
    def update_enum_option(self, request: operations.UpdateEnumOptionRequest) -> operations.UpdateEnumOptionResponse:
        ...
        url = utils.generate_url(base_url, "/enum_options/{enum_option_gid}", request.path_params)
        ...
        res = operations.UpdateEnumOptionResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.UpdateEnumOption200ApplicationJSON])
