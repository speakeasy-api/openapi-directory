 ...
 * 
 */
public class POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent {
    /**
    ...
    public POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent withEventType(String eventType) {
    ...
    public POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent withEventTypeSystemId(String eventTypeSystemId) {
    ...
    @JsonProperty("notes")
    public String notes;
    public POSTRevenueScheduleByTransactionRatablyTypeRevenueEvent withNotes(String notes) {
        this.notes = notes;
        return this;
    }
