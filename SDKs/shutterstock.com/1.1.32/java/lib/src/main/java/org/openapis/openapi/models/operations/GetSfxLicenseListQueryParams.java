...
public class GetSfxLicenseListQueryParams {
    /**
    ...
    public GetSfxLicenseListQueryParams withDownloadAvailability(GetSfxLicenseListDownloadAvailabilityEnum downloadAvailability) {
    ...
    public GetSfxLicenseListQueryParams withEndDate(OffsetDateTime endDate) {
    ...
    public GetSfxLicenseListQueryParams withLicense(String license) {
    ...
    public GetSfxLicenseListQueryParams withLicenseId(String licenseId) {
    ...
    public Long page;
    public GetSfxLicenseListQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetSfxLicenseListQueryParams withPerPage(Long perPage) {
    ...
    public String sfxId;
    public GetSfxLicenseListQueryParams withSfxId(String sfxId) {
        this.sfxId = sfxId;
        return this;
    }
    ...
    public GetSfxLicenseListQueryParams withSort(GetSfxLicenseListSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetSfxLicenseListQueryParams withStartDate(OffsetDateTime startDate) {
    ...
    public GetSfxLicenseListQueryParams withTeamHistory(Boolean teamHistory) {
    ...
    public GetSfxLicenseListQueryParams withUsername(String username) {
