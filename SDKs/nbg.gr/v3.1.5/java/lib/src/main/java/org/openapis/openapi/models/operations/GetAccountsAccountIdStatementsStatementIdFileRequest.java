...
public class GetAccountsAccountIdStatementsStatementIdFileRequest {
    ...
    public GetAccountsAccountIdStatementsStatementIdFileRequest(@JsonProperty("accountId") String accountId, @JsonProperty("sandbox-id") String sandboxId, @JsonProperty("statementId") String statementId) {
        this.accountId = accountId;
        this.sandboxId = sandboxId;
        this.statementId = statementId;
  }
