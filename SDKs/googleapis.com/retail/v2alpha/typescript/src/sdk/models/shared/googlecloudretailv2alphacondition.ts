...
export class GoogleCloudRetailV2alphaCondition extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2alphaConditionTimeRange })
  @Expose({ name: "activeTimeRange" })
  @Type(() => GoogleCloudRetailV2alphaConditionTimeRange)
  activeTimeRange?: GoogleCloudRetailV2alphaConditionTimeRange[];

  /**
   * A list (up to 10 entries) of terms to match the query on. If not specified, match all queries. If many query terms are specified, the condition is matched if any of the terms is a match (i.e. using the OR operator).
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudRetailV2alphaConditionQueryTerm })
  @Expose({ name: "queryTerms" })
  @Type(() => GoogleCloudRetailV2alphaConditionQueryTerm)
