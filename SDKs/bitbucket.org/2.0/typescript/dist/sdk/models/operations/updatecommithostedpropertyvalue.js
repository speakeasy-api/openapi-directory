...
exports.UpdateCommitHostedPropertyValueResponse = exports.UpdateCommitHostedPropertyValueRequest = void 0;
...
var UpdateCommitHostedPropertyValueRequest = /** @class */ (function (_super) {
    ...
    ], UpdateCommitHostedPropertyValueRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=app_key",
        }),
        __metadata("design:type", String)
    ], UpdateCommitHostedPropertyValueRequest.prototype, "appKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=commit",
        }),
        __metadata("design:type", String)
    ], UpdateCommitHostedPropertyValueRequest.prototype, "commit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=property_name",
        }),
        __metadata("design:type", String)
    ], UpdateCommitHostedPropertyValueRequest.prototype, "propertyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], UpdateCommitHostedPropertyValueRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], UpdateCommitHostedPropertyValueRequest.prototype, "workspace", void 0);
...
var UpdateCommitHostedPropertyValueResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateCommitHostedPropertyValueResponse.prototype, "rawResponse", void 0);
