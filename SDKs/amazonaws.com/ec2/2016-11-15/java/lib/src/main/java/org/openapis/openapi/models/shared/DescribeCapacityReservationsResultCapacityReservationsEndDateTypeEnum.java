 ...
 */
public enum DescribeCapacityReservationsResultCapacityReservationsEndDateTypeEnum {
    UNLIMITED("unlimited"),
    LIMITED("limited");
    ...
    private DescribeCapacityReservationsResultCapacityReservationsEndDateTypeEnum(String value) {
        this.value = value;
    }
}
