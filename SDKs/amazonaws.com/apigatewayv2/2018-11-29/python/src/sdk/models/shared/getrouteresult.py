...
class GetRouteResultAuthorizationTypeEnum(str, Enum):
...
class GetRouteResult:
    ...
    authorization_type: Optional[GetRouteResultAuthorizationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorizationType'), 'exclude': lambda f: f is None }})  
