...
var Services = /** @class */ (function () {
     ...
     * Get service
     */
    Services.prototype.getServiceById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetServiceByIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/services/{id}", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetServiceByIdResponse({
    ...
    Services.prototype.getServices = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getServices200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetServices200ApplicationJSON);
                    }
                    break;
            }
            return res;
