...
class AddTaskForSectionRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\AddTaskForSectionRequestBody $requestBody
     */
	...
	{
		$this->requestBody = new \OpenAPI\OpenAPI\Models\Operations\AddTaskForSectionRequestBody();
		$this->optFields = null;
		$this->optPretty = null;
		$this->sectionGid = "";
	}
