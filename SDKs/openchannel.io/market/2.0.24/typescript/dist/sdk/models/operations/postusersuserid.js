...
exports.PostUsersUserIdResponse = exports.PostUsersUserIdRequest = void 0;
...
var PostUsersUserIdRequest = /** @class */ (function (_super) {
    ...
    ], PostUsersUserIdRequest.prototype, "customData", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], PostUsersUserIdRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], PostUsersUserIdRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], PostUsersUserIdRequest.prototype, "type", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=userId",
        }),
        __metadata("design:type", String)
    ], PostUsersUserIdRequest.prototype, "userId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=username",
        }),
        __metadata("design:type", String)
    ], PostUsersUserIdRequest.prototype, "username", void 0);
...
var PostUsersUserIdResponse = /** @class */ (function (_super) {
    ...
    ], PostUsersUserIdResponse.prototype, "rawResponse", void 0);
