 ...
 * 
 */
public class RatePlanDataRatePlan {
    /**
    ...
    public RatePlanDataRatePlan withAmendmentId(String amendmentId) {
    ...
    public RatePlanDataRatePlan withAmendmentSubscriptionRatePlanId(String amendmentSubscriptionRatePlanId) {
    ...
    public RatePlanDataRatePlan withAmendmentType(String amendmentType) {
    ...
    public RatePlanDataRatePlan withCreatedById(String createdById) {
    ...
    public RatePlanDataRatePlan withCreatedDate(OffsetDateTime createdDate) {
    ...
    @JsonProperty("Name")
    public String name;
    public RatePlanDataRatePlan withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public RatePlanDataRatePlan withProductRatePlanId(String productRatePlanId) {
    ...
    public RatePlanDataRatePlan withSubscriptionId(String subscriptionId) {
    ...
    public RatePlanDataRatePlan withUpdatedById(String updatedById) {
    ...
    public RatePlanDataRatePlan withUpdatedDate(OffsetDateTime updatedDate) {
