...
export declare enum GoogleAnalyticsAdminV1betaPropertyIndustryCategoryEnum {
...
export declare enum GoogleAnalyticsAdminV1betaPropertyPropertyTypeEnum {
...
export declare enum GoogleAnalyticsAdminV1betaPropertyServiceLevelEnum {
...
**/
export declare class GoogleAnalyticsAdminV1betaProperty extends SpeakeasyBase {
    account?: string;
    createTime?: string;
    currencyCode?: string;
    deleteTime?: string;
 ...
 * A resource message representing a Google Analytics GA4 property.
**/
export declare class GoogleAnalyticsAdminV1betaPropertyInput extends SpeakeasyBase {
    account?: string;
    currencyCode?: string;
    displayName?: string;
    industryCategory?: GoogleAnalyticsAdminV1betaPropertyIndustryCategoryEnum;
