...
public class PatchMerchantsMerchantIdStoresReferenceTerminalLogosQueryParams {
    /**
    ...
    public String model;
    public PatchMerchantsMerchantIdStoresReferenceTerminalLogosQueryParams withModel(String model) {
        this.model = model;
        return this;
    }
