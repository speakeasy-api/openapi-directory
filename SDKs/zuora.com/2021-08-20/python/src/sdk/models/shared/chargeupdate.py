...
from ..shared import pricingupdate as shared_pricingupdate
...
class ChargeUpdate:
    ...
    pricing: Optional[shared_pricingupdate.PricingUpdate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pricing') }})
