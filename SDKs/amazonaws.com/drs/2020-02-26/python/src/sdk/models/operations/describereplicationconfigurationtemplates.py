...
class DescribeReplicationConfigurationTemplatesRequestBody:
    ...
    r"""Maximum number of Replication Configuration Templates to retrieve."""  
    next_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('nextToken'), 'exclude': lambda f: f is None }})
    r"""The token of the next Replication Configuration Template to retrieve."""  
    replication_configuration_template_i_ds: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('replicationConfigurationTemplateIDs'), 'exclude': lambda f: f is None }})
    r"""The IDs of the Replication Configuration Templates to retrieve. An empty list means all Replication Configuration Templates."""  
    

@dataclasses.dataclass
class DescribeReplicationConfigurationTemplatesRequest:
    
    request_body: DescribeReplicationConfigurationTemplatesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
