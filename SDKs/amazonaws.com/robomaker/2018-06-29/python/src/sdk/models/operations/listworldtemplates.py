...
class ListWorldTemplatesRequest:
    ...
    request_body: ListWorldTemplatesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
