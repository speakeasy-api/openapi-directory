...
exports.FeatureFlagAndSettingValues = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var FeatureFlagAndSettingValues = /** @class */ (function () {
    function FeatureFlagAndSettingValues(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    FeatureFlagAndSettingValues.prototype.getSettingValue = function (req, config) {
     ...
     * evaluation order. You can read more about these rules [here](https://configcat.com/docs/advanced/targeting/).
    **/
    FeatureFlagAndSettingValues.prototype.getSettingValues = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    FeatureFlagAndSettingValues.prototype.replaceSettingValue = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * ```
    **/
    FeatureFlagAndSettingValues.prototype.updateSettingValue = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.FeatureFlagAndSettingValues = FeatureFlagAndSettingValues;
