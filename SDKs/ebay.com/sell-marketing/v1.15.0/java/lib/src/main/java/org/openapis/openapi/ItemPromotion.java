...
public class ItemPromotion {
     ...
     */
    public org.openapis.openapi.models.operations.CreateItemPromotionResponse createItemPromotion(org.openapis.openapi.models.shared.ItemPromotion request, org.openapis.openapi.models.operations.CreateItemPromotionSecurity security) throws Exception {
        ...
        org.openapis.openapi.models.operations.CreateItemPromotionResponse res = new org.openapis.openapi.models.operations.CreateItemPromotionResponse(contentType, httpRes.statusCode()) {{
            baseResponse = null;
        }};
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.DeleteItemPromotionResponse deleteItemPromotion(org.openapis.openapi.models.operations.DeleteItemPromotionRequest request, org.openapis.openapi.models.operations.DeleteItemPromotionSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.DeleteItemPromotionRequest.class, baseUrl, "/item_promotion/{promotion_id}", request, null);
        ...
        org.openapis.openapi.models.operations.DeleteItemPromotionResponse res = new org.openapis.openapi.models.operations.DeleteItemPromotionResponse(contentType, httpRes.statusCode()) {{
        }};
        res.rawResponse = httpRes;
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetItemPromotionResponse getItemPromotion(org.openapis.openapi.models.operations.GetItemPromotionRequest request, org.openapis.openapi.models.operations.GetItemPromotionSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetItemPromotionRequest.class, baseUrl, "/item_promotion/{promotion_id}", request, null);
        ...
        org.openapis.openapi.models.operations.GetItemPromotionResponse res = new org.openapis.openapi.models.operations.GetItemPromotionResponse(contentType, httpRes.statusCode()) {{
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.UpdateItemPromotionResponse updateItemPromotion(org.openapis.openapi.models.operations.UpdateItemPromotionRequest request, org.openapis.openapi.models.operations.UpdateItemPromotionSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.UpdateItemPromotionRequest.class, baseUrl, "/item_promotion/{promotion_id}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("PUT");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "itemPromotion", "json");
        req.setBody(serializedRequestBody);
        ...
        org.openapis.openapi.models.operations.UpdateItemPromotionResponse res = new org.openapis.openapi.models.operations.UpdateItemPromotionResponse(contentType, httpRes.statusCode()) {{
            baseResponse = null;
        }};
        res.rawResponse = httpRes;
