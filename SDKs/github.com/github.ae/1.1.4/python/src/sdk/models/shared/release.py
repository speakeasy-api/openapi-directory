...
class Release:
    ...
    discussion_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('discussion_url'), 'exclude': lambda f: f is None }})
    r"""The URL of the release discussion."""  
