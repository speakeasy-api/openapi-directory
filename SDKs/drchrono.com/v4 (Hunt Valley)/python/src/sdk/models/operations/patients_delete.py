...
class PatientsDeletePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PatientsDeleteQueryParams:
...
@dataclasses.dataclass
class PatientsDeleteSecurity:
    drchrono_oauth2: shared_security.SchemeDrchronoOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class PatientsDeleteRequest:
    path_params: PatientsDeletePathParams = dataclasses.field()
    query_params: PatientsDeleteQueryParams = dataclasses.field()
    security: PatientsDeleteSecurity = dataclasses.field()
    

@dataclasses.dataclass
class PatientsDeleteResponse:
