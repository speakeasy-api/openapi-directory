...
class UpdatePullRequestTitleRequest:
    ...
    update_pull_request_title_input: shared_updatepullrequesttitleinput.UpdatePullRequestTitleInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
