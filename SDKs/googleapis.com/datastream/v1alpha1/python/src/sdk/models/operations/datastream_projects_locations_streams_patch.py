...
class DatastreamProjectsLocationsStreamsPatchRequest:
    ...
    r"""Optional. Execute the update without validating it."""  
    ...
    r"""Optional. Only validate the stream with the changes, without actually updating it. The default is false."""  
