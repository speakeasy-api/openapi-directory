...
class DisplayvideoSdfdownloadtasksOperationsGetSecurity:
    option1: Optional[DisplayvideoSdfdownloadtasksOperationsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DisplayvideoSdfdownloadtasksOperationsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DisplayvideoSdfdownloadtasksOperationsGetRequest:
    path_params: DisplayvideoSdfdownloadtasksOperationsGetPathParams = dataclasses.field()
    query_params: DisplayvideoSdfdownloadtasksOperationsGetQueryParams = dataclasses.field()
    security: DisplayvideoSdfdownloadtasksOperationsGetSecurity = dataclasses.field()
