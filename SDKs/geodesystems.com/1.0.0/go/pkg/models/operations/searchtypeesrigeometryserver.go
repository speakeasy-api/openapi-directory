...
type SearchTypeEsriGeometryserverQueryParams struct {
...
type SearchTypeEsriGeometryserverRequest struct {
	QueryParams SearchTypeEsriGeometryserverQueryParams
}

type SearchTypeEsriGeometryserverResponse struct {
	ContentType string
	StatusCode  int
