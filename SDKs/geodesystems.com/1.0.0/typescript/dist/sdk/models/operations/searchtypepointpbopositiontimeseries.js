...
exports.SearchTypePointPboPositionTimeSeriesResponse = exports.SearchTypePointPboPositionTimeSeriesRequest = exports.SearchTypePointPboPositionTimeSeriesQueryParams = void 0;
...
var SearchTypePointPboPositionTimeSeriesQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_pbo_position_time_series.format_version" }),
        __metadata("design:type", String)
    ], SearchTypePointPboPositionTimeSeriesQueryParams.prototype, "searchTypePointPboPositionTimeSeriesFormatVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_pbo_position_time_series.four_char_id" }),
        __metadata("design:type", String)
    ], SearchTypePointPboPositionTimeSeriesQueryParams.prototype, "searchTypePointPboPositionTimeSeriesFourCharId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_pbo_position_time_series.processing_center" }),
        __metadata("design:type", String)
    ], SearchTypePointPboPositionTimeSeriesQueryParams.prototype, "searchTypePointPboPositionTimeSeriesProcessingCenter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_pbo_position_time_series.reference_frame" }),
        __metadata("design:type", String)
    ], SearchTypePointPboPositionTimeSeriesQueryParams.prototype, "searchTypePointPboPositionTimeSeriesReferenceFrame", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_point_pbo_position_time_series.station_name" }),
        __metadata("design:type", String)
...
exports.SearchTypePointPboPositionTimeSeriesQueryParams = SearchTypePointPboPositionTimeSeriesQueryParams;
...
exports.SearchTypePointPboPositionTimeSeriesRequest = SearchTypePointPboPositionTimeSeriesRequest;
...
exports.SearchTypePointPboPositionTimeSeriesResponse = SearchTypePointPboPositionTimeSeriesResponse;
