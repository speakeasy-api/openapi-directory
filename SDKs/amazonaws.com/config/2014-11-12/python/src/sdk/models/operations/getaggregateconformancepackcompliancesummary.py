...
class GetAggregateConformancePackComplianceSummaryRequest:
    ...
    get_aggregate_conformance_pack_compliance_summary_request: shared_getaggregateconformancepackcompliancesummaryrequest.GetAggregateConformancePackComplianceSummaryRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
