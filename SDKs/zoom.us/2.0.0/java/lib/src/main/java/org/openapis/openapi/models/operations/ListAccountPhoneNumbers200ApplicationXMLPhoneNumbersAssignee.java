...
public class ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssignee {
    /**
     * Extension number of the Phone.
     */
    
    public Long extensionNumber;
    public ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssignee withExtensionNumber(Long extensionNumber) {
    ...
    public String id;
    public ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssignee withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public String name;
    public ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssignee withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssigneeTypeEnum type;
    public ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssignee withType(ListAccountPhoneNumbers200ApplicationXMLPhoneNumbersAssigneeTypeEnum type) {
        this.type = type;
        return this;
    }
