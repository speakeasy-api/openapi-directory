...
class Male:
    ...
    statistical_info: Optional[shared_statistical_info_m.StatisticalInfoM] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('statistical_info') }})
