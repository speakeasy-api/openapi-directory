...
var ClientCredentials = /** @class */ (function () {
     ...
     */
    ClientCredentials.prototype.addClientSecret = function (req, security, config) {
        var _a;
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.AddClientSecretResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        ...
                        res.clientCredentialsResponses = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ClientCredentialsResponse, resFieldDepth);
                    }
                    break;
