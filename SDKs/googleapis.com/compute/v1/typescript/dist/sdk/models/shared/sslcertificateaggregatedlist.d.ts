 ...
 */
export declare enum SslCertificateAggregatedListWarningCodeEnum {
...
export declare class SslCertificateAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SslCertificateAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 * Successful response
 */
export declare class SslCertificateAggregatedList extends SpeakeasyBase {
    /**
