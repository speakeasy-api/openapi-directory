...
exports.CreateSlotResponse = void 0;
...
var CreateSlotResponse = /** @class */ (function (_super) {
    ...
    ], CreateSlotResponse.prototype, "botId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=botVersion" }),
        __metadata("design:type", String)
    ], CreateSlotResponse.prototype, "botVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=creationDateTime" }),
        __metadata("design:type", Date)
    ], CreateSlotResponse.prototype, "creationDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], CreateSlotResponse.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=intentId" }),
        __metadata("design:type", String)
    ], CreateSlotResponse.prototype, "intentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=localeId" }),
        __metadata("design:type", String)
    ], CreateSlotResponse.prototype, "localeId", void 0);
    __decorate([
    ...
    ], CreateSlotResponse.prototype, "multipleValuesSetting", void 0);
    __decorate([
    ...
    ], CreateSlotResponse.prototype, "obfuscationSetting", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=slotId" }),
        __metadata("design:type", String)
    ], CreateSlotResponse.prototype, "slotId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=slotName" }),
        __metadata("design:type", String)
    ], CreateSlotResponse.prototype, "slotName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=slotTypeId" }),
        __metadata("design:type", String)
    ], CreateSlotResponse.prototype, "slotTypeId", void 0);
    __decorate([
    ...
    ], CreateSlotResponse.prototype, "valueElicitationSetting", void 0);
