...
export declare class FetchAllFieldsSecurity extends SpeakeasyBase {
    apiKey?: string;
    oauth2AuthorizationCode?: string;
}
export declare class FetchAllFieldsRequest extends SpeakeasyBase {
    /**
...
export declare class FetchAllFieldsResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Not Modified
     */
