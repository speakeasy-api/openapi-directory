...
exports.BeezUpCommonLink3 = void 0;
...
var BeezUpCommonLink3 = /** @class */ (function (_super) {
    __extends(BeezUpCommonLink3, _super);
    function BeezUpCommonLink3() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allOptionalParamsProvided" }),
        __metadata("design:type", Boolean)
    ], BeezUpCommonLink3.prototype, "allOptionalParamsProvided", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=allRequiredParamsProvided" }),
        __metadata("design:type", Boolean)
    ], BeezUpCommonLink3.prototype, "allRequiredParamsProvided", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], BeezUpCommonLink3.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=docUrl" }),
        __metadata("design:type", String)
    ], BeezUpCommonLink3.prototype, "docUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=href" }),
        __metadata("design:type", String)
    ], BeezUpCommonLink3.prototype, "href", void 0);
    __decorate([
    ...
    ], BeezUpCommonLink3.prototype, "info", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=label" }),
        __metadata("design:type", String)
    ], BeezUpCommonLink3.prototype, "label", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=method" }),
        __metadata("design:type", String)
    ], BeezUpCommonLink3.prototype, "method", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operationId" }),
        __metadata("design:type", String)
    ], BeezUpCommonLink3.prototype, "operationId", void 0);
    __decorate([
    ...
    ], BeezUpCommonLink3.prototype, "parameters", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=urlTemplated" }),
        __metadata("design:type", Boolean)
    ], BeezUpCommonLink3.prototype, "urlTemplated", void 0);
    return BeezUpCommonLink3;
}(utils_1.SpeakeasyBase));
exports.BeezUpCommonLink3 = BeezUpCommonLink3;
