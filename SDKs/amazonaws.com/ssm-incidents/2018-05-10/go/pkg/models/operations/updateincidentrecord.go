...
func (e UpdateIncidentRecordRequestBodyStatusEnum) ToPointer() *UpdateIncidentRecordRequestBodyStatusEnum {
	return &e
}
...
func (e *UpdateIncidentRecordRequestBodyStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "OPEN":
		fallthrough
	case "RESOLVED":
		*e = UpdateIncidentRecordRequestBodyStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateIncidentRecordRequestBodyStatusEnum: %v", v)
	}
}
