 ...
 */
export declare enum GetShipmentByExternalIdResponseBodyDeliveryConfirmationEnum {
    None = "none",
    Delivery = "delivery",
    Signature = "signature",
 ...
 */
export declare enum GetShipmentByExternalIdResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export declare enum GetShipmentByExternalIdResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export declare class GetShipmentByExternalIdResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
    /**
     * The type of contents in this shipment.  This may impact import duties or customs treatment.
     */
    contents: GetShipmentByExternalIdResponseBodyInternationalShipmentOptionsPackageContentsEnum;
    /**
     ...
     */
    nonDelivery: GetShipmentByExternalIdResponseBodyInternationalShipmentOptionsNonDeliveryEnum;
}
/**
 * The possible insurance provider values
 */
export declare enum GetShipmentByExternalIdResponseBodyInsuranceProviderEnum {
    None = "none",
 ...
 */
export declare enum GetShipmentByExternalIdResponseBodyOriginTypeEnum {
    Pickup = "pickup",
    DropOff = "drop_off"
}
/**
 ...
 */
export declare enum GetShipmentByExternalIdResponseBodyShipmentStatusEnum {
    Pending = "pending",
 ...
 */
export declare class GetShipmentByExternalIdResponseBodyWeight extends SpeakeasyBase {
    unit: WeightUnitEnum;
    /**
 ...
 *
 */
export declare class GetShipmentByExternalIdResponseBody extends SpeakeasyBase {
    /**
     ...
     */
    confirmation: GetShipmentByExternalIdResponseBodyDeliveryConfirmationEnum;
    /**
     ...
     *
     */
    customs: GetShipmentByExternalIdResponseBodyInternationalShipmentOptions;
    /**
     ...
     *
     */
    insuranceProvider: GetShipmentByExternalIdResponseBodyInsuranceProviderEnum;
    /**
     ...
     * Indicates if the package will be picked up or dropped off by the carrier
     */
    originType?: GetShipmentByExternalIdResponseBodyOriginTypeEnum;
    /**
     ...
     */
    shipmentStatus: GetShipmentByExternalIdResponseBodyShipmentStatusEnum;
    /**
     ...
     */
    totalWeight: GetShipmentByExternalIdResponseBodyWeight;
    /**
