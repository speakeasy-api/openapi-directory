 ...
 * @access public
 */
class GetModifierGroupResponse
{
	#[\JMS\Serializer\Annotation\SerializedName('data')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\ModifierGroup')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\ModifierGroup();
		$this->operation = "";
		$this->resource = "";
		$this->service = "";
		$this->status = "";
