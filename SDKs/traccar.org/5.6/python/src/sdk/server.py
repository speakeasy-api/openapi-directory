...
class Server:
    ...
    def put_server(self, request: shared.Server) -> operations.PutServerResponse:
        r"""Update Server information"""
        base_url = self._server_url
        ...
        res = operations.PutServerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
