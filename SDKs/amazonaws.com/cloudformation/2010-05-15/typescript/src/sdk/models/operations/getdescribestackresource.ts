...
export enum GETDescribeStackResourceActionEnum {
  DescribeStackResource = "DescribeStackResource",
}

export enum GETDescribeStackResourceVersionEnum {
  TwoThousandAndTen0515 = "2010-05-15",
}

export class GETDescribeStackResourceRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDescribeStackResourceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
