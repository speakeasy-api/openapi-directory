...
var BulkCheckRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "allowGoogleInternalDataSources" }),
        __metadata("design:type", Boolean)
    ], BulkCheckRequest.prototype, "allowGoogleInternalDataSources", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultRelation" }),
        __metadata("design:type", String)
    ], BulkCheckRequest.prototype, "defaultRelation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultSource" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "defaultTarget" }),
        (0, class_transformer_1.Type)(function () { return asset_1.Asset; }),
        __metadata("design:type", asset_1.Asset)
    ], BulkCheckRequest.prototype, "defaultTarget", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "skipCacheLookup" }),
        __metadata("design:type", Boolean)
    ], BulkCheckRequest.prototype, "skipCacheLookup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: statementtemplate_1.StatementTemplate }),
        (0, class_transformer_1.Expose)({ name: "statements" }),
        (0, class_transformer_1.Type)(function () { return statementtemplate_1.StatementTemplate; }),
