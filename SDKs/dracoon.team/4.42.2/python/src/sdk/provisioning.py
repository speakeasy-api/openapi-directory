...
class Provisioning:
    ...
    def create_customer(self, request: operations.CreateCustomerRequest) -> operations.CreateCustomerResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "new_customer_request", 'json')
        ...
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.NewCustomerResponse])
                res.new_customer_response = out
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.create_customer_400_application_json_one_of = out
        elif http_res.status_code in [401, 402, 404, 406, 409]:
            if utils.match_content_type(content_type, 'application/json'):
    ...
    def create_tenant_webhook(self, request: operations.CreateTenantWebhookRequest) -> operations.CreateTenantWebhookResponse:
        ...
        res = operations.CreateTenantWebhookResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_customer(self, request: operations.RemoveCustomerRequest) -> operations.RemoveCustomerResponse:
        ...
        url = utils.generate_url(operations.RemoveCustomerRequest, base_url, '/v4/provisioning/customers/{customer_id}', request)
        ...
        res = operations.RemoveCustomerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_customer_attribute(self, request: operations.RemoveCustomerAttributeRequest) -> operations.RemoveCustomerAttributeResponse:
        ...
        * Characters are **case-insensitive**.
        ...
        url = utils.generate_url(operations.RemoveCustomerAttributeRequest, base_url, '/v4/provisioning/customers/{customer_id}/customerAttributes/{key}', request)
        ...
        res = operations.RemoveCustomerAttributeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_tenant_webhook(self, request: operations.RemoveTenantWebhookRequest) -> operations.RemoveTenantWebhookResponse:
        ...
        url = utils.generate_url(operations.RemoveTenantWebhookRequest, base_url, '/v4/provisioning/webhooks/{webhook_id}', request)
        ...
        res = operations.RemoveTenantWebhookResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_customer(self, request: operations.RequestCustomerRequest) -> operations.RequestCustomerResponse:
        ...
        url = utils.generate_url(operations.RequestCustomerRequest, base_url, '/v4/provisioning/customers/{customer_id}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestCustomerRequest, request)
        ...
        res = operations.RequestCustomerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_customer_attributes(self, request: operations.RequestCustomerAttributesRequest) -> operations.RequestCustomerAttributesResponse:
        ...
        url = utils.generate_url(operations.RequestCustomerAttributesRequest, base_url, '/v4/provisioning/customers/{customer_id}/customerAttributes', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestCustomerAttributesRequest, request)
        ...
        res = operations.RequestCustomerAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_customer_users(self, request: operations.RequestCustomerUsersRequest) -> operations.RequestCustomerUsersResponse:
        ...
        url = utils.generate_url(operations.RequestCustomerUsersRequest, base_url, '/v4/provisioning/customers/{customer_id}/users', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestCustomerUsersRequest, request)
        ...
        res = operations.RequestCustomerUsersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_customers(self, request: operations.RequestCustomersRequest) -> operations.RequestCustomersResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestCustomersRequest, request)
        ...
        res = operations.RequestCustomersResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CustomerList])
    ...
    def request_list_of_event_types_for_tenant(self, request: operations.RequestListOfEventTypesForTenantRequest) -> operations.RequestListOfEventTypesForTenantResponse:
        ...
        res = operations.RequestListOfEventTypesForTenantResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_list_of_tenant_webhooks(self, request: operations.RequestListOfTenantWebhooksRequest) -> operations.RequestListOfTenantWebhooksResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.RequestListOfTenantWebhooksRequest, request)
        ...
        res = operations.RequestListOfTenantWebhooksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_tenant_webhook(self, request: operations.RequestTenantWebhookRequest) -> operations.RequestTenantWebhookResponse:
        ...
        url = utils.generate_url(operations.RequestTenantWebhookRequest, base_url, '/v4/provisioning/webhooks/{webhook_id}', request)
        ...
        res = operations.RequestTenantWebhookResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def reset_tenant_webhook_lifetime(self, request: operations.ResetTenantWebhookLifetimeRequest) -> operations.ResetTenantWebhookLifetimeResponse:
        ...
        url = utils.generate_url(operations.ResetTenantWebhookLifetimeRequest, base_url, '/v4/provisioning/webhooks/{webhook_id}/reset_lifetime', request)
        ...
        res = operations.ResetTenantWebhookLifetimeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def set_customer_attributes(self, request: operations.SetCustomerAttributesRequest) -> operations.SetCustomerAttributesResponse:
        ...
        * Characters are **case-insensitive**.
        ...
        url = utils.generate_url(operations.SetCustomerAttributesRequest, base_url, '/v4/provisioning/customers/{customer_id}/customerAttributes', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "customer_attributes", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SetCustomerAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_customer(self, request: operations.UpdateCustomerRequest) -> operations.UpdateCustomerResponse:
        ...
        url = utils.generate_url(operations.UpdateCustomerRequest, base_url, '/v4/provisioning/customers/{customer_id}', request)
        ...
        elif http_res.status_code in [400, 401, 402, 404, 406]:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ErrorResponse])
                res.error_response = out
    ...
    def update_customer_attributes(self, request: operations.UpdateCustomerAttributesRequest) -> operations.UpdateCustomerAttributesResponse:
        ...
        * Characters are **case-insensitive**.
        ...
        url = utils.generate_url(operations.UpdateCustomerAttributesRequest, base_url, '/v4/provisioning/customers/{customer_id}/customerAttributes', request)
        ...
        res = operations.UpdateCustomerAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_tenant_webhook(self, request: operations.UpdateTenantWebhookRequest) -> operations.UpdateTenantWebhookResponse:
        ...
        url = utils.generate_url(operations.UpdateTenantWebhookRequest, base_url, '/v4/provisioning/webhooks/{webhook_id}', request)
        ...
        res = operations.UpdateTenantWebhookResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
