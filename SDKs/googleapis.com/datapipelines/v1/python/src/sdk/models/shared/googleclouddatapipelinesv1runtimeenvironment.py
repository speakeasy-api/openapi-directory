...
class GoogleCloudDatapipelinesV1RuntimeEnvironmentIPConfigurationEnum(str, Enum):
...
class GoogleCloudDatapipelinesV1RuntimeEnvironment:
    ...
    r"""Additional user labels to be specified for the job. Keys and values should follow the restrictions specified in the [labeling restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions) page. An object containing a list of key/value pairs. Example: { \\"name\\": \\"wrench\\", \\"mass\\": \\"1kg\\", \\"count\\": \\"3\\" }."""  
    ...
    r"""Whether to bypass the safety checks for the job's temporary directory. Use with caution."""  
    ...
    ip_configuration: Optional[GoogleCloudDatapipelinesV1RuntimeEnvironmentIPConfigurationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ipConfiguration'), 'exclude': lambda f: f is None }})
    r"""Configuration for VM IPs."""  
    ...
    r"""Name for the Cloud KMS key for the job. The key format is: projects//locations//keyRings//cryptoKeys/"""  
