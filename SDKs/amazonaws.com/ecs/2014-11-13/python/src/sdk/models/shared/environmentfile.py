...
from ..shared import environmentfiletype_enum as shared_environmentfiletype_enum
...
class EnvironmentFile:
    ...
    type: shared_environmentfiletype_enum.EnvironmentFileTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
