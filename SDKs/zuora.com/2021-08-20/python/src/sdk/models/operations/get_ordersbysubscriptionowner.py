...
@dataclasses.dataclass
class GetOrdersBySubscriptionOwnerHeaders:
...
class GetOrdersBySubscriptionOwnerRequest:
    headers: GetOrdersBySubscriptionOwnerHeaders = dataclasses.field()
    path_params: GetOrdersBySubscriptionOwnerPathParams = dataclasses.field()
    query_params: GetOrdersBySubscriptionOwnerQueryParams = dataclasses.field()
