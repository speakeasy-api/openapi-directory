...
class GetDeleteTransitGatewayConnectQueryParams:
    action: GetDeleteTransitGatewayConnectActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteTransitGatewayConnectVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTransitGatewayConnectRequest:
    headers: GetDeleteTransitGatewayConnectHeaders = dataclasses.field()
    query_params: GetDeleteTransitGatewayConnectQueryParams = dataclasses.field()
