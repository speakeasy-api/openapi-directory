...
type liveWebsiteTrackingParameters struct {
...
func newLiveWebsiteTrackingParameters(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *liveWebsiteTrackingParameters {
...
func (s *liveWebsiteTrackingParameters) PostV2LiveWebsiteTrackingParametersJSON(ctx context.Context, request operations.PostV2LiveWebsiteTrackingParametersJSONRequest) (*operations.PostV2LiveWebsiteTrackingParametersJSONResponse, error) {
	...
	res := &operations.PostV2LiveWebsiteTrackingParametersJSONResponse{
