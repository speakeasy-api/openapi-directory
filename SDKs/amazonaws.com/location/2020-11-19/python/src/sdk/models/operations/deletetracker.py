...
class DeleteTrackerRequest:
    headers: DeleteTrackerHeaders = dataclasses.field()
    path_params: DeleteTrackerPathParams = dataclasses.field()
...
class DeleteTrackerResponse:
    ...
    delete_tracker_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
