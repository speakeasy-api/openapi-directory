...
class CreateFieldLevelEncryptionConfig20181105RequestBodyFieldLevelEncryptionConfig:
...
@dataclasses.dataclass
class CreateFieldLevelEncryptionConfig20181105RequestBody:
    
    field_level_encryption_config: CreateFieldLevelEncryptionConfig20181105RequestBodyFieldLevelEncryptionConfig = dataclasses.field()
    r"""A complex data type that includes the profile configurations specified for field-level encryption."""  
