...
use \OpenAPI\OpenAPI\Models\Operations\CreateCustomFieldRequest;
use \OpenAPI\OpenAPI\Models\Operations\CreateCustomFieldRequestBodyInput;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestInput;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestCustomLabelPositionEnum;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestDateValue;
use \OpenAPI\OpenAPI\Models\Shared\EnumOptionInput;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestEnumValueInput;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestFormatEnum;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestResourceSubtypeEnum;
...
try {
    ...
    $request->requestBody = new CreateCustomFieldRequestBodyInput();
    $request->requestBody->data = new CustomFieldRequestInput();
    $request->requestBody->data->currencyCode = 'EUR';
    $request->requestBody->data->customLabel = 'gold pieces';
    $request->requestBody->data->customLabelPosition = CustomFieldRequestCustomLabelPositionEnum::SUFFIX;
    $request->requestBody->data->dateValue = new CustomFieldRequestDateValue();
    $request->requestBody->data->dateValue->date = '2024-08-23';
    $request->requestBody->data->dateValue->dateTime = '2024-08-23T22:00:00.000Z';
    $request->requestBody->data->description = 'Development team priority';
    $request->requestBody->data->enabled = true;
    $request->requestBody->data->enumOptions = [
        new EnumOptionInput(),
        new EnumOptionInput(),
    ];
    $request->requestBody->data->enumValue = new CustomFieldRequestEnumValueInput();
    $request->requestBody->data->enumValue->color = 'blue';
    $request->requestBody->data->enumValue->enabled = true;
    $request->requestBody->data->enumValue->name = 'Low';
    $request->requestBody->data->format = CustomFieldRequestFormatEnum::CUSTOM;
    $request->requestBody->data->hasNotificationsEnabled = true;
    $request->requestBody->data->multiEnumValues = [
        new EnumOptionInput(),
        new EnumOptionInput(),
        new EnumOptionInput(),
        new EnumOptionInput(),
    ];
    $request->requestBody->data->name = 'Status';
    $request->requestBody->data->numberValue = 5.2;
    $request->requestBody->data->peopleValue = [
        'fuga',
        'in',
        'corporis',
        'iste',
    ...
    $request->requestBody->data->resourceSubtype = CustomFieldRequestResourceSubtypeEnum::TEXT;
    $request->requestBody->data->textValue = 'Some Value';
    $request->requestBody->data->workspace = '1331';
    $request->limit = 437032;
    ...
    $response = $sdk->customFields->createCustomField($request);

    if ($response->createCustomField201ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\CreateEnumOptionForCustomFieldRequest;
use \OpenAPI\OpenAPI\Models\Operations\CreateEnumOptionForCustomFieldRequestBodyInput;
use \OpenAPI\OpenAPI\Models\Shared\EnumOptionRequestInput;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateEnumOptionForCustomFieldRequest();
    $request->requestBody = new CreateEnumOptionForCustomFieldRequestBodyInput();
    $request->requestBody->data = new EnumOptionRequestInput();
    $request->requestBody->data->color = 'blue';
    $request->requestBody->data->enabled = true;
    $request->requestBody->data->insertAfter = '12345';
    $request->requestBody->data->insertBefore = '12345';
    $request->requestBody->data->name = 'Low';
    $request->customFieldGid = 'est';
    $request->limit = 653140;
    $request->offset = 'laborum';
    $request->optFields = [
        'dolorem',
    ];
    $request->optPretty = false;

    $response = $sdk->customFields->createEnumOptionForCustomField($request);

    if ($response->createEnumOptionForCustomField201ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\DeleteCustomFieldRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteCustomFieldRequest();
    $request->customFieldGid = 'corporis';
    $request->optFields = [
        'nobis',
    ];
    $request->optPretty = false;

    $response = $sdk->customFields->deleteCustomField($request);

    if ($response->deleteCustomField200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
try {
    ...
    $response = $sdk->customFields->getCustomField($request);

    if ($response->getCustomField200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\GetCustomFieldsForWorkspaceRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetCustomFieldsForWorkspaceRequest();
    $request->limit = 38425;
    $request->offset = 'iure';
    $request->optFields = [
        'doloribus',
    ...
    $request->optPretty = false;
    $request->workspaceGid = 'mollitia';

    $response = $sdk->customFields->getCustomFieldsForWorkspace($request);

    if ($response->getCustomFieldsForWorkspace200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\InsertEnumOptionForCustomFieldRequest;
use \OpenAPI\OpenAPI\Models\Operations\InsertEnumOptionForCustomFieldRequestBody;
use \OpenAPI\OpenAPI\Models\Shared\EnumOptionInsertRequest;

$sdk = SDK::builder()
    ->build();

try {
    $request = new InsertEnumOptionForCustomFieldRequest();
    $request->requestBody = new InsertEnumOptionForCustomFieldRequestBody();
    $request->requestBody->data = new EnumOptionInsertRequest();
    $request->requestBody->data->afterEnumOption = '12345';
    $request->requestBody->data->beforeEnumOption = '12345';
    $request->requestBody->data->enumOption = '97285';
    $request->customFieldGid = 'dolorem';
    $request->optFields = [
        'consequuntur',
        'repellat',
        'mollitia',
    ...
    $response = $sdk->customFields->insertEnumOptionForCustomField($request);

    if ($response->insertEnumOptionForCustomField200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\Models\Operations\UpdateCustomFieldRequestBodyInput;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestInput;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestCustomLabelPositionEnum;
use \OpenAPI\OpenAPI\Models\Shared\CustomFieldRequestDateValue;
use \OpenAPI\OpenAPI\Models\Shared\EnumOptionInput;
...
try {
    ...
    $request->requestBody = new UpdateCustomFieldRequestBodyInput();
    $request->requestBody->data = new CustomFieldRequestInput();
    $request->requestBody->data->currencyCode = 'EUR';
    $request->requestBody->data->customLabel = 'gold pieces';
    $request->requestBody->data->customLabelPosition = CustomFieldRequestCustomLabelPositionEnum::SUFFIX;
    ...
    $response = $sdk->customFields->updateCustomField($request);

    if ($response->updateCustomField200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Shared\Security;
use \OpenAPI\OpenAPI\Models\Operations\UpdateEnumOptionRequest;
use \OpenAPI\OpenAPI\Models\Operations\UpdateEnumOptionRequestBodyInput;
use \OpenAPI\OpenAPI\Models\Shared\EnumOptionRequestInput;
...
try {
    $request = new UpdateEnumOptionRequest();
    $request->requestBody = new UpdateEnumOptionRequestBodyInput();
    $request->requestBody->data = new EnumOptionRequestInput();
    $request->requestBody->data->color = 'blue';
    $request->requestBody->data->enabled = true;
    $request->requestBody->data->insertAfter = '12345';
    ...
    $response = $sdk->customFields->updateEnumOption($request);

    if ($response->updateEnumOption200ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
