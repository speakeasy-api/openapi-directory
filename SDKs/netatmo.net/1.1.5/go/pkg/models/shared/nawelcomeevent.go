...
func (e NAWelcomeEventCategoryEnum) ToPointer() *NAWelcomeEventCategoryEnum {
	return &e
}
...
func (e *NAWelcomeEventCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "animal":
		fallthrough
	case "vehicle":
		*e = NAWelcomeEventCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for NAWelcomeEventCategoryEnum: %v", v)
	}
}
