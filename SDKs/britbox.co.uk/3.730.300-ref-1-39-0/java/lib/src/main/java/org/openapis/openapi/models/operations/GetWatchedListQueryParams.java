...
public class GetWatchedListQueryParams {
    /**
    ...
    public GetWatchedListQueryParams withCompleted(Boolean completed) {
    ...
    public GetWatchedListQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetWatchedListQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetWatchedListQueryParams withItemType(org.openapis.openapi.models.shared.ItemTypeEnum itemType) {
    ...
    public String lang;
    public GetWatchedListQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetWatchedListQueryParams withOrder(org.openapis.openapi.models.shared.ListOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetWatchedListQueryParams withOrderBy(GetWatchedListOrderByEnum orderBy) {
    ...
    public Integer page;
    public GetWatchedListQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public GetWatchedListQueryParams withPageSize(Integer pageSize) {
    ...
    public GetWatchedListQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetWatchedListQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
