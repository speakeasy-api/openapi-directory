...
class RegionCommitments 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsResponse
     */
	public function computeRegionCommitmentsTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/commitments/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsResponse
     */
	public function computeRegionCommitmentsUpdateReservations(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/commitments/{commitment}/updateReservations', \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "regionCommitmentsUpdateReservationsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRegionCommitmentsUpdateReservationsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
