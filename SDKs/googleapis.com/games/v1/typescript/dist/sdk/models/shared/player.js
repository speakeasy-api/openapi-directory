...
exports.Player = exports.PlayerName = exports.PlayerFriendStatusEnum = void 0;
var utils_1 = require("../../../internal/utils");
var playerexperienceinfo_1 = require("./playerexperienceinfo");
var profilesettings_1 = require("./profilesettings");
var PlayerFriendStatusEnum;
...
})(PlayerFriendStatusEnum = exports.PlayerFriendStatusEnum || (exports.PlayerFriendStatusEnum = {}));
// PlayerName
/**
...
var Player = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=avatarImageUrl" }),
        __metadata("design:type", String)
    ], Player.prototype, "avatarImageUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bannerUrlLandscape" }),
        __metadata("design:type", String)
    ], Player.prototype, "bannerUrlLandscape", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bannerUrlPortrait" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=experienceInfo" }),
        __metadata("design:type", playerexperienceinfo_1.PlayerExperienceInfo)
    ], Player.prototype, "experienceInfo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=friendStatus" }),
        __metadata("design:type", String)
    ], Player.prototype, "friendStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gamePlayerId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=originalPlayerId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=profileSettings" }),
