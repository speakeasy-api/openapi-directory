...
type ListUserPrivateMessagesPathParams struct {
	Username string `pathParam:"style=simple,explode=false,name=username"`
}

type ListUserPrivateMessagesRequest struct {
	PathParams ListUserPrivateMessagesPathParams
}

type ListUserPrivateMessages200ApplicationJSONTopicListTopicsParticipants struct {
...
type ListUserPrivateMessages200ApplicationJSONTopicListTopicsPosters struct {
	Description    *string `json:"description,omitempty"`
	Extras         *string `json:"extras,omitempty"`
	PrimaryGroupID *string `json:"primary_group_id,omitempty"`
	UserID         *int64  `json:"user_id,omitempty"`
...
type ListUserPrivateMessages200ApplicationJSONTopicListTopics struct {
	...
	Participants       []ListUserPrivateMessages200ApplicationJSONTopicListTopicsParticipants `json:"participants,omitempty"`
	Pinned             *bool                                                                  `json:"pinned,omitempty"`
	PinnedGlobally     *bool                                                                  `json:"pinned_globally,omitempty"`
	Posters            []ListUserPrivateMessages200ApplicationJSONTopicListTopicsPosters      `json:"posters,omitempty"`
...
type ListUserPrivateMessages200ApplicationJSONTopicList struct {
	...
	Topics         []ListUserPrivateMessages200ApplicationJSONTopicListTopics `json:"topics,omitempty"`
}

type ListUserPrivateMessages200ApplicationJSONUsers struct {
...
type ListUserPrivateMessages200ApplicationJSON struct {
	PrimaryGroups []interface{}                                       `json:"primary_groups,omitempty"`
	TopicList     *ListUserPrivateMessages200ApplicationJSONTopicList `json:"topic_list,omitempty"`
	Users         []ListUserPrivateMessages200ApplicationJSONUsers    `json:"users,omitempty"`
}

type ListUserPrivateMessagesResponse struct {
	ContentType string
	StatusCode  int
