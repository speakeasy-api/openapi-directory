 ...
 */
export enum FutureReservationsListResponseWarningCodeEnum {
...
export class FutureReservationsListResponseWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class FutureReservationsListResponseWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: FutureReservationsListResponseWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class FutureReservationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
