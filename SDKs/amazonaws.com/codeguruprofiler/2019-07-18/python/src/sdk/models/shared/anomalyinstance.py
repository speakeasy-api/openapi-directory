...
class AnomalyInstance:
    ...
    user_feedback: Optional[shared_userfeedback.UserFeedback] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userFeedback') }})
