...
from ..shared import readaccountbalanceresponse_200 as shared_readaccountbalanceresponse_200
...
class GetBalancesRequest:
    headers: GetBalancesHeaders = dataclasses.field()
    path_params: GetBalancesPathParams = dataclasses.field()
    security: GetBalancesSecurity = dataclasses.field()
...
class GetBalancesResponse:
    ...
    read_account_balance_response_200: Optional[shared_readaccountbalanceresponse_200.ReadAccountBalanceResponse200] = dataclasses.field(default=None)
