...
class TasksTasksMoveRequest:
    path_params: TasksTasksMovePathParams = dataclasses.field()
    query_params: TasksTasksMoveQueryParams = dataclasses.field()
    security: TasksTasksMoveSecurity = dataclasses.field()
