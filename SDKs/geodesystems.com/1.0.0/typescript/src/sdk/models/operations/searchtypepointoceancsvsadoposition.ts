...
export class SearchTypePointOceanCsvSadoPositionRequest extends SpeakeasyBase {
  /**
...
export class SearchTypePointOceanCsvSadoPositionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
