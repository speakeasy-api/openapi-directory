...
from ..shared import getpayrollresponse as shared_getpayrollresponse
...
class PayrollsOneRequest:
    headers: PayrollsOneHeaders = dataclasses.field()
    path_params: PayrollsOnePathParams = dataclasses.field()
    query_params: PayrollsOneQueryParams = dataclasses.field()
    security: PayrollsOneSecurity = dataclasses.field()
...
class PayrollsOneResponse:
    ...
    get_payroll_response: Optional[shared_getpayrollresponse.GetPayrollResponse] = dataclasses.field(default=None)
