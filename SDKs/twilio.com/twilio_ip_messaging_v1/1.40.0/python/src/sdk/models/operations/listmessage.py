...
class ListMessageListMessageResponse:
    ...
    messages: Optional[list[shared_ip_messaging_v1_service_channel_message.IPMessagingV1ServiceChannelMessage]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('messages'), 'exclude': lambda f: f is None }})  
