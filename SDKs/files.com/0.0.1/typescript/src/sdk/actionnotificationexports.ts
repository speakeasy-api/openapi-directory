...
export class ActionNotificationExports {
  ...
  **/
  getActionNotificationExportsId(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetActionNotificationExportsIdResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postActionNotificationExports(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostActionNotificationExportsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
