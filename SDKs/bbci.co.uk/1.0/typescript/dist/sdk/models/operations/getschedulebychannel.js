...
exports.GetScheduleByChannelResponse = exports.GetScheduleByChannelRequest = void 0;
...
var GetScheduleByChannelRequest = /** @class */ (function (_super) {
    ...
    ], GetScheduleByChannelRequest.prototype, "availability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=channel",
        }),
        __metadata("design:type", String)
    ], GetScheduleByChannelRequest.prototype, "channel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=date",
        }),
        __metadata("design:type", String)
    ], GetScheduleByChannelRequest.prototype, "date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetScheduleByChannelRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=rights",
        }),
        __metadata("design:type", String)
    ], GetScheduleByChannelRequest.prototype, "rights", void 0);
    return GetScheduleByChannelRequest;
}(utils_1.SpeakeasyBase));
exports.GetScheduleByChannelRequest = GetScheduleByChannelRequest;
var GetScheduleByChannelResponse = /** @class */ (function (_super) {
    ...
    ], GetScheduleByChannelResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.GetScheduleByChannelResponse = GetScheduleByChannelResponse;
