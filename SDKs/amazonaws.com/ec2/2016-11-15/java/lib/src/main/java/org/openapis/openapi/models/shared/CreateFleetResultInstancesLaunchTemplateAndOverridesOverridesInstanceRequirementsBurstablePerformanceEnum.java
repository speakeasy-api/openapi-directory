 ...
 */
public enum CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsBurstablePerformanceEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private CreateFleetResultInstancesLaunchTemplateAndOverridesOverridesInstanceRequirementsBurstablePerformanceEnum(String value) {
        this.value = value;
    }
}
