...
class GetAPIVVersionCurrenciesRateSupportedRequest:
    path_params: GetAPIVVersionCurrenciesRateSupportedPathParams = dataclasses.field()
    query_params: GetAPIVVersionCurrenciesRateSupportedQueryParams = dataclasses.field()
...
class GetAPIVVersionCurrenciesRateSupportedResponse:
    ...
    get_api_v_version_currencies_rate_supported_200_application_json_strings: Optional[list[str]] = dataclasses.field(default=None)
