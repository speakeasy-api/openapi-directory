...
from ..shared import getevidencefoldersbyassessmentcontrolresponse as shared_getevidencefoldersbyassessmentcontrolresponse
...
class GetEvidenceFoldersByAssessmentControlRequest:
    headers: GetEvidenceFoldersByAssessmentControlHeaders = dataclasses.field()
    path_params: GetEvidenceFoldersByAssessmentControlPathParams = dataclasses.field()
    query_params: GetEvidenceFoldersByAssessmentControlQueryParams = dataclasses.field()
...
class GetEvidenceFoldersByAssessmentControlResponse:
    ...
    get_evidence_folders_by_assessment_control_response: Optional[shared_getevidencefoldersbyassessmentcontrolresponse.GetEvidenceFoldersByAssessmentControlResponse] = dataclasses.field(default=None)
