...
class GetContentModerationRequest:
    ...
    sort_by: Optional[shared_contentmoderationsortby_enum.ContentModerationSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
