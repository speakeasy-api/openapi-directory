...
enum AdministrativeActionTypeEnum: string
{
    case FILE_SYSTEM_UPDATE = 'FILE_SYSTEM_UPDATE';
    case STORAGE_OPTIMIZATION = 'STORAGE_OPTIMIZATION';
    case FILE_SYSTEM_ALIAS_ASSOCIATION = 'FILE_SYSTEM_ALIAS_ASSOCIATION';
    case FILE_SYSTEM_ALIAS_DISASSOCIATION = 'FILE_SYSTEM_ALIAS_DISASSOCIATION';
    case VOLUME_UPDATE = 'VOLUME_UPDATE';
    case SNAPSHOT_UPDATE = 'SNAPSHOT_UPDATE';
    case RELEASE_NFS_V3_LOCKS = 'RELEASE_NFS_V3_LOCKS';
    case VOLUME_RESTORE = 'VOLUME_RESTORE';
}
