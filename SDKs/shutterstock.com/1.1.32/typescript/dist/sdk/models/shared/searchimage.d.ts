...
export declare enum SearchImageImageTypeEnum {
    Photo = "photo",
    Illustration = "illustration",
    Vector = "vector"
}
export declare enum SearchImageLicenseEnum {
 ...
 */
export declare enum SearchImageOrientationEnum {
 ...
 */
export declare enum SearchImagePeopleAgeEnum {
    Infants = "infants",
    Children = "children",
    Teenagers = "teenagers",
    Twentys = "20s",
...
export declare enum SearchImagePeopleEthnicityEnum {
    African = "african",
 ...
 */
export declare enum SearchImagePeopleGenderEnum {
    Male = "male",
    Female = "female",
    Both = "both"
}
 ...
 * Sort by
 */
export declare enum SearchImageSortEnum {
    Newest = "newest",
    Popular = "popular",
    Relevance = "relevance",
    Random = "random"
 ...
 */
export declare enum SearchImageViewEnum {
    Minimal = "minimal",
    Full = "full"
}
/**
 ...
 */
export declare class SearchImage extends SpeakeasyBase {
    /**
