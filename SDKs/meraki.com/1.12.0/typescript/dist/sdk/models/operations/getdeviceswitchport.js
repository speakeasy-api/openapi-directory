...
exports.GetDeviceSwitchPortResponse = exports.GetDeviceSwitchPortRequest = exports.GetDeviceSwitchPortPathParams = void 0;
var utils_1 = require("../../../internal/utils");
var GetDeviceSwitchPortPathParams = /** @class */ (function (_super) {
    __extends(GetDeviceSwitchPortPathParams, _super);
    function GetDeviceSwitchPortPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=portId" }),
        __metadata("design:type", String)
    ], GetDeviceSwitchPortPathParams.prototype, "portId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=serial" }),
        __metadata("design:type", String)
    ], GetDeviceSwitchPortPathParams.prototype, "serial", void 0);
    return GetDeviceSwitchPortPathParams;
}(utils_1.SpeakeasyBase));
exports.GetDeviceSwitchPortPathParams = GetDeviceSwitchPortPathParams;
var GetDeviceSwitchPortRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", GetDeviceSwitchPortPathParams)
    ], GetDeviceSwitchPortRequest.prototype, "pathParams", void 0);
