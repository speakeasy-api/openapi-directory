...
class SearchTypeBlsSurveyQueryParams:
...
@dataclasses.dataclass
class SearchTypeBlsSurveyRequest:
    query_params: SearchTypeBlsSurveyQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeBlsSurveyResponse:
