...
from ..shared import describetimeseriesresponse as shared_describetimeseriesresponse
...
class DescribeTimeSeriesResponse:
    ...
    describe_time_series_response: Optional[shared_describetimeseriesresponse.DescribeTimeSeriesResponse] = dataclasses.field(default=None)
    r"""Success"""  
