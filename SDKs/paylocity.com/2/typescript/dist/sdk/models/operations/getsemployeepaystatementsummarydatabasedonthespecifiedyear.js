...
exports.GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearResponse = exports.GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest = exports.GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearSecurity = void 0;
...
var GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest.prototype, "codegroup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=companyId",
        }),
        __metadata("design:type", String)
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest.prototype, "companyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=employeeId",
        }),
        __metadata("design:type", String)
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest.prototype, "employeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=includetotalcount",
        }),
        __metadata("design:type", Boolean)
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest.prototype, "includetotalcount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagenumber",
        }),
        __metadata("design:type", Number)
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest.prototype, "pagenumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pagesize",
        }),
        __metadata("design:type", Number)
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest.prototype, "pagesize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=year",
        }),
        __metadata("design:type", String)
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearRequest.prototype, "year", void 0);
...
var GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearResponse = /** @class */ (function (_super) {
    ...
    ], GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearResponse.prototype, "rawResponse", void 0);
    __decorate([
