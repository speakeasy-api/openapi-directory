...
class DeleteVaultAccessPolicyRequest:
    headers: DeleteVaultAccessPolicyHeaders = dataclasses.field()
    path_params: DeleteVaultAccessPolicyPathParams = dataclasses.field()
