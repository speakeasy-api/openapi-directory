...
const (
	ListTagsForResourceXAmzTargetEnumAmazonAthenaListTagsForResource ListTagsForResourceXAmzTargetEnum = "AmazonAthena.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "AmazonAthena.ListTagsForResource":
