...
type ServicedirectoryProjectsLocationsNamespacesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ServicedirectoryProjectsLocationsNamespacesListPathParams struct {
	// Required. The resource name of the project and location whose namespaces you'd like to list.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ServicedirectoryProjectsLocationsNamespacesListQueryParams struct {
	// V1 error format.
...
type ServicedirectoryProjectsLocationsNamespacesListRequest struct {
...
type ServicedirectoryProjectsLocationsNamespacesListResponse struct {
	ContentType string
	// Successful response
