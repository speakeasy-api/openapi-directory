...
class GetDisableInsightRulesQueryParams:
    action: GetDisableInsightRulesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    rule_names: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'RuleNames', 'style': 'form', 'explode': True }})
    version: GetDisableInsightRulesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisableInsightRulesRequest:
    headers: GetDisableInsightRulesHeaders = dataclasses.field()
    query_params: GetDisableInsightRulesQueryParams = dataclasses.field()
