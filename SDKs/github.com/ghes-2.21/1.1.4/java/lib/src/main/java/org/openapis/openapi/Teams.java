...
public class Teams {
    ...
    public org.openapis.openapi.models.operations.TeamsAddOrUpdateProjectPermissionsLegacyResponse teamsAddOrUpdateProjectPermissionsLegacy(org.openapis.openapi.models.operations.TeamsAddOrUpdateProjectPermissionsLegacyRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 204) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.TeamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.TeamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.TeamsCheckPermissionsForProjectLegacyResponse teamsCheckPermissionsForProjectLegacy(org.openapis.openapi.models.operations.TeamsCheckPermissionsForProjectLegacyRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.TeamsCheckPermissionsForProjectLegacy415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.TeamsCheckPermissionsForProjectLegacy415ApplicationJSON.class);
    ...
    public org.openapis.openapi.models.operations.TeamsListProjectsLegacyResponse teamsListProjectsLegacy(org.openapis.openapi.models.operations.TeamsListProjectsLegacyRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.TeamsListProjectsLegacy415ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.TeamsListProjectsLegacy415ApplicationJSON.class);
