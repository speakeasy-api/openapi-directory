...
func (e GetQuestionsUnansweredOrderEnum) ToPointer() *GetQuestionsUnansweredOrderEnum {
	return &e
}

func (e *GetQuestionsUnansweredOrderEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "desc":
		fallthrough
	case "asc":
		*e = GetQuestionsUnansweredOrderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetQuestionsUnansweredOrderEnum: %v", v)
	}
}
...
func (e GetQuestionsUnansweredSortEnum) ToPointer() *GetQuestionsUnansweredSortEnum {
	return &e
}

func (e *GetQuestionsUnansweredSortEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "creation":
		fallthrough
	case "votes":
		*e = GetQuestionsUnansweredSortEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetQuestionsUnansweredSortEnum: %v", v)
	}
}
