...
from ..shared import setnotificationsrequest_2 as shared_setnotificationsrequest_2
...
class SetNotificationsRequestV3Request:
    ...
    set_notifications_request_2: shared_setnotificationsrequest_2.SetNotificationsRequest2 = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Body to included minimum balance to set"""  
