...
from ..shared import updatephpmemorylimitrequest as shared_updatephpmemorylimitrequest
...
class ChangePhpMemoryLimitRequest:
    ...
    update_php_memory_limit_request: Optional[shared_updatephpmemorylimitrequest.UpdatePhpMemoryLimitRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""Memory limit config"""  
