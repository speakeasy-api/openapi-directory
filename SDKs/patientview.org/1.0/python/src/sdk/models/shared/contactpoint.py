...
from ..shared import contactpointtype as shared_contactpointtype
...
class ContactPoint:
    ...
    contact_point_type: Optional[shared_contactpointtype.ContactPointType] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contactPointType'), 'exclude': lambda f: f is None }})  
