...
class Files:
    ...
    def drive_files_create(self, request: operations.DriveFilesCreateRequest) -> operations.DriveFilesCreateResponse:
        ...
        res = operations.DriveFilesCreateResponse(status_code=r.status_code, content_type=content_type)
