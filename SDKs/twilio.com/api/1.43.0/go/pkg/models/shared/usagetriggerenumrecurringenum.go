...
func (e UsageTriggerEnumRecurringEnum) ToPointer() *UsageTriggerEnumRecurringEnum {
	return &e
}
...
func (e *UsageTriggerEnumRecurringEnum) UnmarshalJSON(data []byte) error {
	...
	case "yearly":
		fallthrough
	case "alltime":
		*e = UsageTriggerEnumRecurringEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UsageTriggerEnumRecurringEnum: %v", v)
	}
}
