...
exports.ListServiceConversationMessageResponse = exports.ListServiceConversationMessageListServiceConversationMessageResponse = exports.ListServiceConversationMessageListServiceConversationMessageResponseMeta = exports.ListServiceConversationMessageRequest = exports.ListServiceConversationMessageSecurity = exports.ListServiceConversationMessageServerList = void 0;
...
var ListServiceConversationMessageSecurity = /** @class */ (function (_super) {
    ...
    ], ListServiceConversationMessageSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageSecurity.prototype, "username", void 0);
...
var ListServiceConversationMessageRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListServiceConversationMessageRequest.prototype, "chatServiceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConversationSid",
        }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageRequest.prototype, "conversationSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Order" }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListServiceConversationMessageRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListServiceConversationMessageRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListServiceConversationMessageRequest.prototype, "pageToken", void 0);
...
var ListServiceConversationMessageListServiceConversationMessageResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ConversationsV1ServiceServiceConversationServiceConversationMessage,
        }),
        (0, class_transformer_1.Expose)({ name: "messages" }),
        (0, class_transformer_1.Type)(function () {
            return shared.ConversationsV1ServiceServiceConversationServiceConversationMessage;
        }),
...
var ListServiceConversationMessageResponse = /** @class */ (function (_super) {
    ...
    ], ListServiceConversationMessageResponse.prototype, "rawResponse", void 0);
