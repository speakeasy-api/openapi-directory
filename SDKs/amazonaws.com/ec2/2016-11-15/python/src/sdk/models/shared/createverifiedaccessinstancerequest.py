...
class CreateVerifiedAccessInstanceRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateVerifiedAccessInstanceRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVerifiedAccessInstanceRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVerifiedAccessInstanceRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateVerifiedAccessInstanceRequest:
    ...
    tag_specifications: Optional[list[CreateVerifiedAccessInstanceRequestTagSpecifications]] = dataclasses.field(default=None)  
