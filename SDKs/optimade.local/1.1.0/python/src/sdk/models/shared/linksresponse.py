...
from ..shared import linksresource as shared_linksresource
...
class LinksResponseJSONAPI:
    r"""LinksResponseJSONAPI
...
@dataclass_json
@dataclasses.dataclass
class LinksResponseToplevelLinks:
    r"""LinksResponseToplevelLinks
...
@dataclass_json
@dataclasses.dataclass
class LinksResponseResponseMetaImplementationImplementationMaintainer:
    r"""LinksResponseResponseMetaImplementationImplementationMaintainer
...
@dataclass_json
@dataclasses.dataclass
class LinksResponseResponseMetaImplementation:
    r"""LinksResponseResponseMetaImplementation
    ...
    maintainer: Optional[LinksResponseResponseMetaImplementationImplementationMaintainer] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintainer') }})
...
@dataclass_json
@dataclasses.dataclass
class LinksResponseResponseMetaProvider:
    r"""LinksResponseResponseMetaProvider
...
@dataclass_json
@dataclasses.dataclass
class LinksResponseResponseMetaResponseMetaQuery:
    r"""LinksResponseResponseMetaResponseMetaQuery
...
@dataclass_json
@dataclasses.dataclass
class LinksResponseResponseMeta:
    r"""LinksResponseResponseMeta
    ...
    query: LinksResponseResponseMetaResponseMetaQuery = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('query') }})
    ...
    implementation: Optional[LinksResponseResponseMetaImplementation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('implementation') }})
    last_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('last_id') }})
    provider: Optional[LinksResponseResponseMetaProvider] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('provider') }})
...
class LinksResponse:
    ...
    meta: LinksResponseResponseMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    ...
    jsonapi: Optional[LinksResponseJSONAPI] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('jsonapi') }})
    links: Optional[LinksResponseToplevelLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
