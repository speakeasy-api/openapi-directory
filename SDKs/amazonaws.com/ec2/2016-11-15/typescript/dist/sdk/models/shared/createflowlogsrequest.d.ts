...
import { DestinationOptionsRequest } from "./destinationoptionsrequest";
import { FlowLogsResourceTypeEnum } from "./flowlogsresourcetypeenum";
import { LogDestinationTypeEnum } from "./logdestinationtypeenum";
import { TrafficTypeEnum } from "./traffictypeenum";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateFlowLogsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateFlowLogsRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateFlowLogsRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateFlowLogsRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateFlowLogsRequestTagSpecificationsTags[];
}
export declare class CreateFlowLogsRequest extends SpeakeasyBase {
    clientToken?: string;
