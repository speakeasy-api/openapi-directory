...
class PostRSforInvoiceItemAdjustmentManualDistributionPathParams:
...
@dataclasses.dataclass
class PostRSforInvoiceItemAdjustmentManualDistributionHeaders:
    zuora_entity_ids: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Entity-Ids', 'style': 'simple', 'explode': False }})
    zuora_track_id: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Track-Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PostRSforInvoiceItemAdjustmentManualDistributionRequest:
    headers: PostRSforInvoiceItemAdjustmentManualDistributionHeaders = dataclasses.field()
    path_params: PostRSforInvoiceItemAdjustmentManualDistributionPathParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PostRSforInvoiceItemAdjustmentManualDistributionResponse:
