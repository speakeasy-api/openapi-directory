...
class HiuFacing:
    ...
    def post_v0_5_health_information_cm_request_json(self, request: operations.PostV05HealthInformationCmRequestJSONRequest) -> operations.PostV05HealthInformationCmRequestJSONResponse:
        ...
        res = operations.PostV05HealthInformationCmRequestJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_v0_5_health_information_cm_request_raw(self, request: operations.PostV05HealthInformationCmRequestRawRequest) -> operations.PostV05HealthInformationCmRequestRawResponse:
        r"""Health information data request
        Request for Health information against a consent id. CM would generate a transactionId against each consent and pass it as trnasaction context / correlation id to the HIP and also return the same to HIU via /on-request.
        """
        base_url = self._server_url
        ...
        res = operations.PostV05HealthInformationCmRequestRawResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_v0_5_patients_find_json(self, request: operations.PostV05PatientsFindJSONRequest) -> operations.PostV05PatientsFindJSONResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "patient_identification_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PostV05PatientsFindJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_v0_5_patients_find_raw(self, request: operations.PostV05PatientsFindRawRequest) -> operations.PostV05PatientsFindRawResponse:
        r"""Identify a patient by her consent-manager user-id
        This API is meant for identify to patient given her consent-manager-user-id
        """
        base_url = self._server_url
        ...
        res = operations.PostV05PatientsFindRawResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_v0_5_subscription_requests_cm_init_json(self, request: operations.PostV05SubscriptionRequestsCmInitJSONRequest) -> operations.PostV05SubscriptionRequestsCmInitJSONResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "subscription_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PostV05SubscriptionRequestsCmInitJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_v0_5_subscription_requests_cm_init_raw(self, request: operations.PostV05SubscriptionRequestsCmInitRawRequest) -> operations.PostV05SubscriptionRequestsCmInitRawResponse:
        r"""Request for subscription
        creates a request for subscription. The subscription categories can be for care-contexts linkages or availability of data against existing care-contexts. Note that the requester must have HIU role
        """
        base_url = self._server_url
        ...
        res = operations.PostV05SubscriptionRequestsCmInitRawResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_v0_5_subscription_requests_hiu_on_notify(self, request: operations.PostV05SubscriptionRequestsHiuOnNotifyRequest) -> operations.PostV05SubscriptionRequestsHiuOnNotifyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "hiu_subscription_request_notification_acknowledgement", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PostV05SubscriptionRequestsHiuOnNotifyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
