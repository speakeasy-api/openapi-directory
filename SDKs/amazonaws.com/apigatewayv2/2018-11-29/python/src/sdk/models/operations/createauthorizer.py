...
class CreateAuthorizerRequestBody:
    ...
    authorizer_type: CreateAuthorizerRequestBodyAuthorizerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authorizerType') }})
    r"""The authorizer type. Specify REQUEST for a Lambda function using incoming request parameters. Specify JWT to use JSON Web Tokens (supported only for HTTP APIs)."""  
    identity_source: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('identitySource') }})
    ...
    jwt_configuration: Optional[CreateAuthorizerRequestBodyJwtConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('jwtConfiguration'), 'exclude': lambda f: f is None }})
    r"""Represents the configuration of a JWT authorizer. Required for the JWT authorizer type. Supported only for HTTP APIs."""  
