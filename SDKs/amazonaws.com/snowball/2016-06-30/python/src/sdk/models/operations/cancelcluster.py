...
from ..shared import cancelclusterrequest as shared_cancelclusterrequest
...
class CancelClusterHeaders:
    x_amz_target: CancelClusterXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelClusterRequest:
    headers: CancelClusterHeaders = dataclasses.field()
    request: shared_cancelclusterrequest.CancelClusterRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CancelClusterResponse:
    ...
    cancel_cluster_result: Optional[dict[str, Any]] = dataclasses.field(default=None)
