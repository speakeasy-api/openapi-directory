...
class DeleteJobRequest:
    ...
    request: DeleteJobRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteJobResponse:
    ...
    delete_job_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
