...
exports.ExportSystemPackagesResponse = exports.ExportSystemPackagesRequest = exports.ExportSystemPackagesSecurity = void 0;
...
var ExportSystemPackagesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ExportSystemPackagesRequest.prototype, "filterDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[evra]",
        }),
        __metadata("design:type", String)
    ], ExportSystemPackagesRequest.prototype, "filterEvra", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[name]",
        }),
        __metadata("design:type", String)
    ], ExportSystemPackagesRequest.prototype, "filterName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[summary]",
        }),
        __metadata("design:type", String)
    ], ExportSystemPackagesRequest.prototype, "filterSummary", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[updatable]",
        }),
        __metadata("design:type", Boolean)
    ], ExportSystemPackagesRequest.prototype, "filterUpdatable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=inventory_id",
        }),
        __metadata("design:type", String)
    ], ExportSystemPackagesRequest.prototype, "inventoryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], ExportSystemPackagesRequest.prototype, "search", void 0);
...
var ExportSystemPackagesResponse = /** @class */ (function (_super) {
    ...
    ], ExportSystemPackagesResponse.prototype, "rawResponse", void 0);
    __decorate([
