 ...
 */
export enum RegistrationsReadRegistrationAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class RegistrationsReadRegistrationAttributes extends SpeakeasyBase {
  /**
   * The category of the registered node.
   */
  @SpeakeasyMetadata()
  category?: RegistrationsReadRegistrationAttributesCategoryEnum;
 ...
 */
export class RegistrationsReadRegistrationLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsReadRegistrationRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class RegistrationsReadRegistration extends SpeakeasyBase {
  /**
   * The properties of the registration entity.
   */
  @SpeakeasyMetadata()
  attributes: RegistrationsReadRegistrationAttributes;
   ...
   */
  @SpeakeasyMetadata()
  links: RegistrationsReadRegistrationLinks;

  /**
   * URLs to other entities or entity collections that have a relationship to the registration entity.
   */
  @SpeakeasyMetadata()
  relationships: RegistrationsReadRegistrationRelationships;
