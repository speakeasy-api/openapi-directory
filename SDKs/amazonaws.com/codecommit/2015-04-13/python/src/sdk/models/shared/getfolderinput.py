...
class GetFolderInput:
    ...
    commit_specifier: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('commitSpecifier'), 'exclude': lambda f: f is None }})  
