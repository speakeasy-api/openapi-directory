...
var IpConfiguration = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: aclentry_1.AclEntry }),
        (0, class_transformer_1.Expose)({ name: "authorizedNetworks" }),
        (0, class_transformer_1.Type)(function () { return aclentry_1.AclEntry; }),
        __metadata("design:type", Array)
    ], IpConfiguration.prototype, "authorizedNetworks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "enablePrivatePathForGoogleCloudServices" }),
        __metadata("design:type", Boolean)
    ], IpConfiguration.prototype, "enablePrivatePathForGoogleCloudServices", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ipv4Enabled" }),
        __metadata("design:type", Boolean)
