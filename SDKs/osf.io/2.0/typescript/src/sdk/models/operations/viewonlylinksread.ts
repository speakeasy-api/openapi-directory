 ...
 */
export class ViewOnlyLinksReadViewOnlyLinksAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class ViewOnlyLinksReadViewOnlyLinksRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class ViewOnlyLinksReadViewOnlyLinks extends SpeakeasyBase {
  /**
   * The properties of the view only link entity.
   */
  @SpeakeasyMetadata()
