...
public class HealthGetCacheSecurity {
    ...
    public HealthGetCacheSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public HealthGetCacheSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public HealthGetCacheSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
