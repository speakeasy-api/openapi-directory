...
class AdsenseReportsGenerateSecurity:
    ...
    option1: Optional[AdsenseReportsGenerateSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[AdsenseReportsGenerateSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class AdsenseReportsGenerateRequest:
    ...
    account_id: Optional[list[str]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'accountId', 'style': 'form', 'explode': True }})
    r"""Accounts upon which to report."""  
