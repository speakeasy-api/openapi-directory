...
export declare class SettleGiftCardTransactionRequest extends SpeakeasyBase {
    /**
...
export declare class SettleGiftCardTransactionResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
