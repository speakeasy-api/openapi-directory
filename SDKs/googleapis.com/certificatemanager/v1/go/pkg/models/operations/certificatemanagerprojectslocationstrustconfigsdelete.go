...
type CertificatemanagerProjectsLocationsTrustConfigsDeleteSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type CertificatemanagerProjectsLocationsTrustConfigsDeleteRequest struct {
	// V1 error format.
...
type CertificatemanagerProjectsLocationsTrustConfigsDeleteResponse struct {
	ContentType string
	// Successful response
