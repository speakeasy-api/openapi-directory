...
public class GetPhenotypePublicationAssociationsQueryParams {
    /**
    ...
    public GetPhenotypePublicationAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPhenotypePublicationAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetPhenotypePublicationAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPhenotypePublicationAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetPhenotypePublicationAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetPhenotypePublicationAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetPhenotypePublicationAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetPhenotypePublicationAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetPhenotypePublicationAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetPhenotypePublicationAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetPhenotypePublicationAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPhenotypePublicationAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPhenotypePublicationAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
