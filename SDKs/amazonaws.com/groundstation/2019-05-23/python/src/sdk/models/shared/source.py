...
class Source:
    ...
    dataflow_source_region: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataflowSourceRegion'), 'exclude': lambda f: f is None }})  
