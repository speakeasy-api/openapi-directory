...
public class TransferMetricsGetRequest {
    ...
    public TransferMetricsGetRequest withClientId(String clientId) {
    ...
    public TransferMetricsGetRequest withOriginatorClientId(String originatorClientId) {
    ...
    public TransferMetricsGetRequest withSecret(String secret) {
        this.secret = secret;
        return this;
    }
    
    public TransferMetricsGetRequest(){}
}
