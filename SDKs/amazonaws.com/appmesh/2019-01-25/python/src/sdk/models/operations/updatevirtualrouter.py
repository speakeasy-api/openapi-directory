...
from ..shared import updatevirtualrouteroutput as shared_updatevirtualrouteroutput
...
class UpdateVirtualRouterRequestBody:
    spec: UpdateVirtualRouterRequestBodySpec = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('spec') }})
    client_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('clientToken') }})
    

@dataclasses.dataclass
class UpdateVirtualRouterRequest:
    headers: UpdateVirtualRouterHeaders = dataclasses.field()
    path_params: UpdateVirtualRouterPathParams = dataclasses.field()
    query_params: UpdateVirtualRouterQueryParams = dataclasses.field()
    request: UpdateVirtualRouterRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateVirtualRouterResponse:
    ...
    update_virtual_router_output: Optional[shared_updatevirtualrouteroutput.UpdateVirtualRouterOutput] = dataclasses.field(default=None)
