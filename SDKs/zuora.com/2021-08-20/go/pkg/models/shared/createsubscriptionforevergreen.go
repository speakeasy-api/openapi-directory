...
// CreateSubscriptionForEvergreenNewSubscriptionOwnerAccount - Information about a new account that will own the subscription. Only available if you have enabled the Owner Transfer feature.
//
...
func (e *CreateSubscriptionForEvergreenTermsInitialTermPeriodTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Day":
		fallthrough
	case "Week":
		*e = CreateSubscriptionForEvergreenTermsInitialTermPeriodTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSubscriptionForEvergreenTermsInitialTermPeriodTypeEnum: %s", s)
	}
}
...
func (e *CreateSubscriptionForEvergreenTermsInitialTermTermTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "TERMED":
		fallthrough
	case "EVERGREEN":
		*e = CreateSubscriptionForEvergreenTermsInitialTermTermTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSubscriptionForEvergreenTermsInitialTermTermTypeEnum: %s", s)
	}
}
...
// CreateSubscriptionForEvergreenTermsRenewalSettingEnum - Specifies the type of the terms that follow the first term if the subscription is renewed. Only applicable if the type of the first term is `TERMED`.
//
...
func (e *CreateSubscriptionForEvergreenTermsRenewalSettingEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "RENEW_TO_EVERGREEN":
		*e = CreateSubscriptionForEvergreenTermsRenewalSettingEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSubscriptionForEvergreenTermsRenewalSettingEnum: %s", s)
	}
}
...
// CreateSubscriptionForEvergreen - Information about an order action of type `CreateSubscription`.
