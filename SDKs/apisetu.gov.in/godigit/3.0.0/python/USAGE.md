...
req = operations.CripcRequestBody(
    certificate_parameters=operations.CripcRequestBodyCertificateParameters(
        dob="31-12-1980",
        document_number="01234567890/12345678901234567/AA11AA1111",
        full_name="Sunil Kumar",
        gender="M",
        policy_number="D0123456789",
        search_document="Mobile Number,Chassis Number,Vehicle Registration Number",
    ),
