 ...
 */
public class FilesetSnapshotDetail {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("archivalLocationIds")
    public String[] archivalLocationIds;

    public FilesetSnapshotDetail withArchivalLocationIds(String[] archivalLocationIds) {
    ...
    public FilesetSnapshotDetail withCloudState(Long cloudState) {
    ...
    public FilesetSnapshotDetail withCloudStorageTier(SnapshotCloudStorageTierEnum cloudStorageTier) {
    ...
    public FilesetSnapshotDetail withConsistencyLevel(String consistencyLevel) {
    ...
    public FilesetSnapshotDetail withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public FilesetSnapshotDetail withExpirationDate(OffsetDateTime expirationDate) {
    ...
    public FilesetSnapshotDetail withFileCount(Long fileCount) {
    ...
    public FilesetSnapshotDetail withFilesetName(String filesetName) {
    ...
    public FilesetSnapshotDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public FilesetSnapshotDetail withIndexState(Long indexState) {
    ...
    public FilesetSnapshotDetail withIsCustomRetentionApplied(Boolean isCustomRetentionApplied) {
    ...
    public FilesetSnapshotDetail withIsOnDemandSnapshot(Boolean isOnDemandSnapshot) {
    ...
    public FilesetSnapshotDetail withIsPlacedOnLegalHold(Boolean isPlacedOnLegalHold) {
    ...
    public FilesetSnapshotDetail withIsRetainedByRetentionLockSla(Boolean isRetainedByRetentionLockSla) {
    ...
    public FilesetSnapshotDetail withLastModified(String lastModified) {
    ...
    public FilesetSnapshotDetail withParentSnapshotId(String parentSnapshotId) {
    ...
    public FilesetSnapshotDetail withReplicationLocationIds(String[] replicationLocationIds) {
    ...
    public FilesetSnapshotDetail withSize(Long size) {
        this.size = size;
        return this;
    }
    ...
    public FilesetSnapshotDetail withSlaId(String slaId) {
        this.slaId = slaId;
        return this;
    }
    ...
    public FilesetSnapshotDetail withSlaName(String slaName) {
    ...
    public FilesetSnapshotDetail withSnapdiffUsed(Boolean snapdiffUsed) {
    ...
    public FilesetSnapshotDetail withSnapshotRetentionInfo(SnapshotRetentionInfo snapshotRetentionInfo) {
    ...
    public FilesetSnapshotDetail withSourceObjectType(String sourceObjectType) {
    ...
    public FilesetSnapshotVerbose verbose;

    public FilesetSnapshotDetail withVerbose(FilesetSnapshotVerbose verbose) {
        this.verbose = verbose;
        return this;
    }
    
    public FilesetSnapshotDetail(@JsonProperty("date") OffsetDateTime date, @JsonProperty("filesetName") String filesetName, @JsonProperty("id") String id, @JsonProperty("isCustomRetentionApplied") Boolean isCustomRetentionApplied, @JsonProperty("isOnDemandSnapshot") Boolean isOnDemandSnapshot, @JsonProperty("lastModified") String lastModified, @JsonProperty("replicationLocationIds") String[] replicationLocationIds, @JsonProperty("size") Long size, @JsonProperty("slaId") String slaId, @JsonProperty("slaName") String slaName) {
        this.date = date;
        this.filesetName = filesetName;
        this.id = id;
        this.isCustomRetentionApplied = isCustomRetentionApplied;
