...
func (e GETDescribeStackDriftDetectionStatusActionEnum) ToPointer() *GETDescribeStackDriftDetectionStatusActionEnum {
	return &e
}
...
func (e *GETDescribeStackDriftDetectionStatusActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeStackDriftDetectionStatus":
		*e = GETDescribeStackDriftDetectionStatusActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeStackDriftDetectionStatusActionEnum: %v", v)
	}
}
...
func (e GETDescribeStackDriftDetectionStatusVersionEnum) ToPointer() *GETDescribeStackDriftDetectionStatusVersionEnum {
	return &e
}
...
func (e *GETDescribeStackDriftDetectionStatusVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2010-05-15":
		*e = GETDescribeStackDriftDetectionStatusVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETDescribeStackDriftDetectionStatusVersionEnum: %v", v)
	}
}
