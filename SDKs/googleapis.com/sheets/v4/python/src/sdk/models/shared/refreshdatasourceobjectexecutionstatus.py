...
class RefreshDataSourceObjectExecutionStatus:
    r"""The execution status of refreshing one data source object."""
    ...
    reference: Optional[shared_datasourceobjectreference.DataSourceObjectReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reference'), 'exclude': lambda f: f is None }})
