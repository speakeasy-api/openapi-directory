...
public class PostMarketingV3MarketingEventsEventsCreateSecurity {
    ...
    public PostMarketingV3MarketingEventsEventsCreateSecurity withOauth2Legacy(String oauth2Legacy) {
    ...
    public PostMarketingV3MarketingEventsEventsCreateSecurity withPrivateAppsLegacy(String privateAppsLegacy) {
        this.privateAppsLegacy = privateAppsLegacy;
        return this;
    }
    
    public PostMarketingV3MarketingEventsEventsCreateSecurity(){}
}
