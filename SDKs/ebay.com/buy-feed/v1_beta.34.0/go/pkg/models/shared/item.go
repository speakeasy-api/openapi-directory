...
type Item struct {
	...
	InferredBrand *string `json:"inferredBrand,omitempty"`
	...
	InferredGtin *string `json:"inferredGtin,omitempty"`
	...
	InferredLocalizedAspects *string `json:"inferredLocalizedAspects,omitempty"`
	...
	InferredMpn *string `json:"inferredMpn,omitempty"`
	...
	LengthUnitOfMeasure *string `json:"lengthUnitOfMeasure,omitempty"`
