...
type AutomlProjectsLocationsDatasetsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AutomlProjectsLocationsDatasetsListPathParams struct {
	// Required. The resource name of the project from which to list datasets.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type AutomlProjectsLocationsDatasetsListQueryParams struct {
	// V1 error format.
...
type AutomlProjectsLocationsDatasetsListRequest struct {
...
type AutomlProjectsLocationsDatasetsListResponse struct {
	ContentType string
	// Successful response
