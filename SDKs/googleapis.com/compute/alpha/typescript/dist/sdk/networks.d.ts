...
export declare class Networks {
     ...
     */
    computeNetworksListIpAddresses(req: operations.ComputeNetworksListIpAddressesRequest, security: operations.ComputeNetworksListIpAddressesSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeNetworksListIpAddressesResponse>;
    /**
     * Lists the internal IP owners in the specified network.
     */
    computeNetworksListIpOwners(req: operations.ComputeNetworksListIpOwnersRequest, security: operations.ComputeNetworksListIpOwnersSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeNetworksListIpOwnersResponse>;
    /**
     ...
     */
    computeNetworksTestIamPermissions(req: operations.ComputeNetworksTestIamPermissionsRequest, security: operations.ComputeNetworksTestIamPermissionsSecurity, config?: AxiosRequestConfig): Promise<operations.ComputeNetworksTestIamPermissionsResponse>;
    /**
