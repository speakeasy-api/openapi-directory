...
class BigqueryreservationProjectsLocationsReservationsAssignmentsCreateRequest:
    ...
    r"""Required. The parent resource name of the assignment E.g. `projects/myproject/locations/US/reservations/team1-prod`"""  
    ...
    r"""The optional assignment ID. Assignment name will be generated automatically if this field is empty. This field must only contain lower case alphanumeric characters or dashes. Max length is 64 characters."""  
    assignment_input: Optional[shared_assignment.AssignmentInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
