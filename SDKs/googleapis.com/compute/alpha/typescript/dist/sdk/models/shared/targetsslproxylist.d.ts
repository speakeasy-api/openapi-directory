 ...
 */
export declare enum TargetSslProxyListWarningCodeEnum {
...
export declare class TargetSslProxyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class TargetSslProxyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: TargetSslProxyListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: TargetSslProxyListWarningData[];
    /**
 ...
 */
export declare class TargetSslProxyList extends SpeakeasyBase {
    /**
