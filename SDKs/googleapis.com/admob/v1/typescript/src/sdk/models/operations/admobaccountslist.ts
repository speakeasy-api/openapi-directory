...
export class AdmobAccountsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdmobAccountsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AdmobAccountsListSecurity extends SpeakeasyBase {
...
export class AdmobAccountsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdmobAccountsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
