...
class AnalyticsManagementRemarketingAudienceListRequest:
    path_params: AnalyticsManagementRemarketingAudienceListPathParams = dataclasses.field()
    query_params: AnalyticsManagementRemarketingAudienceListQueryParams = dataclasses.field()
    security: AnalyticsManagementRemarketingAudienceListSecurity = dataclasses.field()
