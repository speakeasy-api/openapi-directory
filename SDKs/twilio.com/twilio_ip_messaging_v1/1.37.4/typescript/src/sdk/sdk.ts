        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1ServiceChannel = httpRes?.data;
            }
            break;
        }
  ...
  createCredential(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1Credential = httpRes?.data;
            }
            break;
        }
  ...
  createInvite(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1ServiceChannelInvite = httpRes?.data;
            }
            break;
        }
  ...
  createMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1ServiceChannelMember = httpRes?.data;
            }
            break;
        }
  ...
  createMessage(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1ServiceChannelMessage = httpRes?.data;
            }
            break;
        }
  ...
  createRole(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1ServiceRole = httpRes?.data;
            }
            break;
        }
  ...
  createService(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1Service = httpRes?.data;
            }
            break;
        }
  ...
  createUser(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.ipMessagingV1ServiceUser = httpRes?.data;
            }
            break;
        }
