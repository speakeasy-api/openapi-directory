...
public class GetPathwayDiseaseAssociationsQueryParams {
    /**
    ...
    public GetPathwayDiseaseAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPathwayDiseaseAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetPathwayDiseaseAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPathwayDiseaseAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetPathwayDiseaseAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetPathwayDiseaseAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetPathwayDiseaseAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetPathwayDiseaseAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetPathwayDiseaseAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetPathwayDiseaseAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetPathwayDiseaseAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPathwayDiseaseAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPathwayDiseaseAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
