...
class GETEnableFastSnapshotRestoresRequest
{
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETEnableFastSnapshotRestoresActionEnum::ENABLE_FAST_SNAPSHOT_RESTORES;
		$this->availabilityZone = [];
		$this->dryRun = null;
		$this->sourceSnapshotId = [];
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETEnableFastSnapshotRestoresVersionEnum::TWO_THOUSAND_AND_SIXTEEN1115;
