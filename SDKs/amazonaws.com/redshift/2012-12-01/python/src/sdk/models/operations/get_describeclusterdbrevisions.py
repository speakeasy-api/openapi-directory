...
@dataclasses.dataclass
class GetDescribeClusterDbRevisionsHeaders:
...
class GetDescribeClusterDbRevisionsRequest:
    headers: GetDescribeClusterDbRevisionsHeaders = dataclasses.field()
    query_params: GetDescribeClusterDbRevisionsQueryParams = dataclasses.field()
