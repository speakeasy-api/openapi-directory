...
public class OBWriteInternationalScheduled3DataInitiationDebtorAccount {
    ...
    public OBWriteInternationalScheduled3DataInitiationDebtorAccount(@JsonProperty("Identification") String identification, @JsonProperty("SchemeName") String schemeName) {
        this.identification = identification;
        this.schemeName = schemeName;
  }
}
