...
export class MonitoringProjectsCollectdTimeSeriesCreateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class MonitoringProjectsCollectdTimeSeriesCreateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsCollectdTimeSeriesCreateSecurityOption3 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class MonitoringProjectsCollectdTimeSeriesCreateSecurity extends SpeakeasyBase {
...
export class MonitoringProjectsCollectdTimeSeriesCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MonitoringProjectsCollectdTimeSeriesCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
