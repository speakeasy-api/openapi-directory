...
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#add-an-email-address-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#check-if-a-user-follows-another-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#check-if-a-person-is-followed-by-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#create-a-gpg-key-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersCreateGpgKeyForAuthenticatedUser(ctx, operations.UsersCreateGpgKeyForAuthenticatedUserRequestBody{
        ArmoredPublicKey: "alias",
        Name: sdk.String("Frankie Quitzon IV"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#create-a-public-ssh-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#create-an-ssh-signing-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#delete-an-email-address-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#delete-a-gpg-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#delete-a-public-ssh-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#delete-a-ssh-signing-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#follow-a-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#get-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#get-a-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#get-contextual-information-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersGetContextForUser(ctx, operations.UsersGetContextForUserRequest{
        SubjectID: sdk.String("tempora"),
        SubjectType: operations.UsersGetContextForUserSubjectTypeEnumRepository.ToPointer(),
        Username: "Allie_Lowe30",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#get-a-gpg-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#get-a-public-ssh-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#get-a-ssh-signing-key-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-users>
...
func main() {
    ...
    res, err := s.Users.UsersList(ctx, operations.UsersListRequest{
        PerPage: sdk.Int64(68253),
        Since: sdk.Int64(887835),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-email-addresses-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListEmailsForAuthenticatedUser(ctx, operations.UsersListEmailsForAuthenticatedUserRequest{
        Page: sdk.Int64(429823),
        PerPage: sdk.Int64(701257),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-the-people-the-authenticated-user-follows>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowedByAuthenticatedUser(ctx, operations.UsersListFollowedByAuthenticatedUserRequest{
        Page: sdk.Int64(808608),
        PerPage: sdk.Int64(68336),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-followers-of-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowersForAuthenticatedUser(ctx, operations.UsersListFollowersForAuthenticatedUserRequest{
        Page: sdk.Int64(319592),
        PerPage: sdk.Int64(500828),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-followers-of-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowersForUser(ctx, operations.UsersListFollowersForUserRequest{
        Page: sdk.Int64(780370),
        PerPage: sdk.Int64(286486),
        Username: "Omer.Graham25",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-the-people-a-user-follows>
...
func main() {
    ...
    res, err := s.Users.UsersListFollowingForUser(ctx, operations.UsersListFollowingForUserRequest{
        Page: sdk.Int64(314733),
        PerPage: sdk.Int64(585046),
        Username: "Kolby.Ward26",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-gpg-keys-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListGpgKeysForAuthenticatedUser(ctx, operations.UsersListGpgKeysForAuthenticatedUserRequest{
        Page: sdk.Int64(134832),
        PerPage: sdk.Int64(129762),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-gpg-keys-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListGpgKeysForUser(ctx, operations.UsersListGpgKeysForUserRequest{
        Page: sdk.Int64(380450),
        PerPage: sdk.Int64(58808),
        Username: "Talia.Mayer3",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-public-email-addresses-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-public-keys-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListPublicKeysForUser(ctx, operations.UsersListPublicKeysForUserRequest{
        Page: sdk.Int64(927754),
        PerPage: sdk.Int64(451831),
        Username: "Kale71",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-public-ssh-keys-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListPublicSSHKeysForAuthenticatedUser(ctx, operations.UsersListPublicSSHKeysForAuthenticatedUserRequest{
        Page: sdk.Int64(842921),
        PerPage: sdk.Int64(552984),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-public-ssh-signing-keys-for-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Users.UsersListSSHSigningKeysForAuthenticatedUser(ctx, operations.UsersListSSHSigningKeysForAuthenticatedUserRequest{
        Page: sdk.Int64(983203),
        PerPage: sdk.Int64(696678),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#list-ssh-signing-keys-for-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersListSSHSigningKeysForUser(ctx, operations.UsersListSSHSigningKeysForUserRequest{
        Page: sdk.Int64(448601),
        PerPage: sdk.Int64(635314),
        Username: "Allison10",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users#unfollow-a-user>
...
func main() {
    ...
    res, err := s.Users.UsersUnfollow(ctx, operations.UsersUnfollowRequest{
        Username: "Georgiana.Rosenbaum14",
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.8/rest/reference/users/#update-the-authenticated-user>
