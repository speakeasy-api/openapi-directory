...
class VersionMetaData:
    content_id: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('contentId') }})
    ...
    state: Optional[shared_artifactstate_enum.ArtifactStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
