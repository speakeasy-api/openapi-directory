...
public class GetDiseasePublicationAssociationsQueryParams {
    /**
    ...
    public GetDiseasePublicationAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetDiseasePublicationAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetDiseasePublicationAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetDiseasePublicationAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetDiseasePublicationAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetDiseasePublicationAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetDiseasePublicationAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetDiseasePublicationAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetDiseasePublicationAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetDiseasePublicationAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetDiseasePublicationAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetDiseasePublicationAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetDiseasePublicationAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
