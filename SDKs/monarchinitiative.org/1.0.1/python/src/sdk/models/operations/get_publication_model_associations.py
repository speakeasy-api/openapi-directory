...
class GetPublicationModelAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPublicationModelAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPublicationModelAssociationsRequest:
    path_params: GetPublicationModelAssociationsPathParams = dataclasses.field()
    query_params: GetPublicationModelAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPublicationModelAssociationsResponse:
