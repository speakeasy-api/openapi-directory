 ...
 */
export declare class DescribeTransitGatewayMulticastDomainsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayMulticastDomainsRequest extends SpeakeasyBase {
    dryRun?: boolean;
