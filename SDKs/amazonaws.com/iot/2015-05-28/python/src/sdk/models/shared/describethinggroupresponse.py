...
class DescribeThingGroupResponse:
    ...
    status: Optional[shared_dynamicgroupstatus_enum.DynamicGroupStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
    ...
    thing_group_metadata: Optional[shared_thinggroupmetadata.ThingGroupMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('thingGroupMetadata'), 'exclude': lambda f: f is None }})  
    ...
    thing_group_properties: Optional[shared_thinggroupproperties.ThingGroupProperties] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('thingGroupProperties'), 'exclude': lambda f: f is None }})  
