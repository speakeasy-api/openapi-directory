...
class ListIncomingPhoneNumberTollFreeListIncomingPhoneNumberTollFreeResponse:
    ...
    incoming_phone_numbers: Optional[list[shared_api_v2010_account_incoming_phone_number_incoming_phone_number_toll_free.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('incoming_phone_numbers'), 'exclude': lambda f: f is None }})  
...
class ListIncomingPhoneNumberTollFreeResponse:
    ...
    list_incoming_phone_number_toll_free_response: Optional[ListIncomingPhoneNumberTollFreeListIncomingPhoneNumberTollFreeResponse] = dataclasses.field(default=None)
    r"""OK"""  
