...
func (s *Operations) ServicemanagementOperationsGet(ctx context.Context, request operations.ServicemanagementOperationsGetRequest) (*operations.ServicemanagementOperationsGetResponse, error) {
...
func (s *Operations) ServicemanagementOperationsList(ctx context.Context, request operations.ServicemanagementOperationsListRequest) (*operations.ServicemanagementOperationsListResponse, error) {
	baseURL := s._serverURL
