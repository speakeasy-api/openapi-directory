...
public class CreateOrganizationSamlRoleRequestBodyTags {
    ...
    public CreateOrganizationSamlRoleRequestBodyTags(@JsonProperty("access") CreateOrganizationSamlRoleRequestBodyTagsAccessEnum access, @JsonProperty("tag") String tag) {
        this.access = access;
        this.tag = tag;
  }
}
