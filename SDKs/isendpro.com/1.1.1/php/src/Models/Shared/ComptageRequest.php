...
{
	#[\JMS\Serializer\Annotation\SerializedName('comptage')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ComptageRequestComptageEnum>')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ComptageRequestGmtZoneEnum $gmtZone
     */
	#[\JMS\Serializer\Annotation\SerializedName('gmt_zone')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ComptageRequestGmtZoneEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ComptageRequestGmtZoneEnum $gmtZone = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ComptageRequestNumAzurEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ComptageRequestNumAzurEnum $numAzur = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\ComptageRequestSmslongEnum $smslong
     */
	#[\JMS\Serializer\Annotation\SerializedName('smslong')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ComptageRequestSmslongEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ComptageRequestSmslongEnum $smslong = null;
	...
	{
		$this->comptage = \OpenAPI\OpenAPI\Models\Shared\ComptageRequestComptageEnum::ONE;
		$this->dateEnvoi = null;
		$this->emetteur = null;
		$this->gmtZone = null;
		$this->keyid = "";
