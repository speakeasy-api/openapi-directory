...
from ..shared import getmatchesresponse as shared_getmatchesresponse
...
class GetMatchesRequest:
    headers: GetMatchesHeaders = dataclasses.field()
    path_params: GetMatchesPathParams = dataclasses.field()
    query_params: GetMatchesQueryParams = dataclasses.field()
...
class GetMatchesResponse:
    ...
    get_matches_response: Optional[shared_getmatchesresponse.GetMatchesResponse] = dataclasses.field(default=None)
