...
export class PutDraftAppVersionTemplateRequestBody extends SpeakeasyBase {
  /**
...
export class PutDraftAppVersionTemplateRequest extends SpeakeasyBase {
...
export class PutDraftAppVersionTemplateResponse extends SpeakeasyBase {
  /**
