...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.DescribeGroupResponse describeGroup(openapisdk.models.operations.DescribeGroupRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=AWSIdentityStore.DescribeGroup");
        ...
        openapisdk.models.operations.DescribeGroupResponse res = new openapisdk.models.operations.DescribeGroupResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.DescribeGroupResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeGroupResponse.class);
    ...
    **/
    public openapisdk.models.operations.DescribeUserResponse describeUser(openapisdk.models.operations.DescribeUserRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=AWSIdentityStore.DescribeUser");
        ...
        openapisdk.models.operations.DescribeUserResponse res = new openapisdk.models.operations.DescribeUserResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeUserResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeUserResponse.class);
    ...
    **/
    public openapisdk.models.operations.ListGroupsResponse listGroups(openapisdk.models.operations.ListGroupsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=AWSIdentityStore.ListGroups");
    ...
    **/
    public openapisdk.models.operations.ListUsersResponse listUsers(openapisdk.models.operations.ListUsersRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=AWSIdentityStore.ListUsers");
