...
class DescribeSignalingChannelHeaders:
...
class DescribeSignalingChannelRequest:
    headers: DescribeSignalingChannelHeaders = dataclasses.field()
    request: DescribeSignalingChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
