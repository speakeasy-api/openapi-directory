...
public enum GoogleCloudPolicysimulatorV1beta1AccessStateDiffAccessChangeEnum {
    ...
    private GoogleCloudPolicysimulatorV1beta1AccessStateDiffAccessChangeEnum(String value) {
        this.value = value;
    }
}
