...
type PrivatecaProjectsLocationsCertificateTemplatesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type PrivatecaProjectsLocationsCertificateTemplatesListPathParams struct {
...
type PrivatecaProjectsLocationsCertificateTemplatesListQueryParams struct {
	// V1 error format.
...
type PrivatecaProjectsLocationsCertificateTemplatesListRequest struct {
...
type PrivatecaProjectsLocationsCertificateTemplatesListResponse struct {
	ContentType string
	// Successful response
