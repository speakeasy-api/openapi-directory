...
var PaginatedEmployeeResult = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return PaginatedEmployeeResultMeta; }),
        __metadata("design:type", PaginatedEmployeeResultMeta)
    ], PaginatedEmployeeResult.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: employeeresult_1.EmployeeResult }),
        (0, class_transformer_1.Expose)({ name: "response" }),
        (0, class_transformer_1.Type)(function () { return employeeresult_1.EmployeeResult; }),
