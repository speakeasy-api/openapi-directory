...
public class POSTOrderRequest {
    ...
    public POSTOrderRequest withPOSTOrderRequestType(org.openapis.openapi.models.shared.POSTOrderRequestType postOrderRequestType) {
    ...
    public POSTOrderRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public POSTOrderRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public POSTOrderRequest withReturnIds(Boolean returnIds) {
    ...
    public POSTOrderRequest withZuoraVersion(String zuoraVersion) {
