...
public class Address {
    ...
    public Address(@JsonProperty("city") String city, @JsonProperty("country") String country, @JsonProperty("houseNumberOrName") String houseNumberOrName, @JsonProperty("street") String street) {
        this.city = city;
        this.country = country;
        this.houseNumberOrName = houseNumberOrName;
        this.street = street;
