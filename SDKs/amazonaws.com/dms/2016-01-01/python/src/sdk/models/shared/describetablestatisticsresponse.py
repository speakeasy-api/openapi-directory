...
class DescribeTableStatisticsResponse:
    ...
    table_statistics: Optional[list[shared_tablestatistics.TableStatistics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TableStatistics'), 'exclude': lambda f: f is None }})  
