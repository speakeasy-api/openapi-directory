...
exports.GetEmployeesWithTagResponse = exports.GetEmployeesWithTagRequest = void 0;
...
var GetEmployeesWithTagRequest = /** @class */ (function (_super) {
    ...
    ], GetEmployeesWithTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetEmployeesWithTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetEmployeesWithTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetEmployeesWithTagRequest.prototype, "tagId", void 0);
    return GetEmployeesWithTagRequest;
}(utils_1.SpeakeasyBase));
exports.GetEmployeesWithTagRequest = GetEmployeesWithTagRequest;
var GetEmployeesWithTagResponse = /** @class */ (function (_super) {
    ...
    ], GetEmployeesWithTagResponse.prototype, "rawResponse", void 0);
    return GetEmployeesWithTagResponse;
}(utils_1.SpeakeasyBase));
exports.GetEmployeesWithTagResponse = GetEmployeesWithTagResponse;
