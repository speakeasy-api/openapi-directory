...
class GetDetachRolePolicyQueryParams:
    action: GetDetachRolePolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDetachRolePolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDetachRolePolicyRequest:
    headers: GetDetachRolePolicyHeaders = dataclasses.field()
    query_params: GetDetachRolePolicyQueryParams = dataclasses.field()
