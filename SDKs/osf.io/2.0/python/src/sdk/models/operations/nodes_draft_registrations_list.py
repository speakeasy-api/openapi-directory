...
@dataclasses.dataclass
class NodesDraftRegistrationsListDraftRegistrationAttributesNodeLicense:
...
class NodesDraftRegistrationsListDraftRegistrationAttributes:
    ...
    node_license: Optional[NodesDraftRegistrationsListDraftRegistrationAttributesNodeLicense] = dataclasses.field(default=None)  
...
@dataclasses.dataclass
class NodesDraftRegistrationsListDraftRegistrationLinks:
...
class NodesDraftRegistrationsListDraftRegistration:
    ...
    attributes: NodesDraftRegistrationsListDraftRegistrationAttributes = dataclasses.field()
    r"""The properties of the Draft Registration entity."""  
    id: str = dataclasses.field()
    r"""The unique identifier of the draft registration entity."""  
    links: NodesDraftRegistrationsListDraftRegistrationLinks = dataclasses.field()
    r"""URLs to alternative representations of the draft registration entity."""  
    relationships: NodesDraftRegistrationsListDraftRegistrationRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the draft registration entity."""  
