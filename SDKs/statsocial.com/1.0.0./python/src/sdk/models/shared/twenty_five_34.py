...
from ..shared import statistical_info_25 as shared_statistical_info_25
...
class TwentyFive34:
    ...
    statistical_info: Optional[shared_statistical_info_25.StatisticalInfo25] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('statistical_info') }})
