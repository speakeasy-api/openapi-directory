...
public class ProcessorSignalDecisionReportRequest {
    ...
    public ProcessorSignalDecisionReportRequest(@JsonProperty("client_transaction_id") String clientTransactionId, @JsonProperty("initiated") Boolean initiated, @JsonProperty("processor_token") String processorToken) {
        this.clientTransactionId = clientTransactionId;
        this.initiated = initiated;
        this.processorToken = processorToken;
  }
