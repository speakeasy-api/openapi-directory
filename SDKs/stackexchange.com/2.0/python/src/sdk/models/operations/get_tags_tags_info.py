...
class GetTagsTagsInfoQueryParams:
    ...
    order: Optional[GetTagsTagsInfoOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetTagsTagsInfoSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetTagsTagsInfoRequest:
    path_params: GetTagsTagsInfoPathParams = dataclasses.field()
    query_params: GetTagsTagsInfoQueryParams = dataclasses.field()
