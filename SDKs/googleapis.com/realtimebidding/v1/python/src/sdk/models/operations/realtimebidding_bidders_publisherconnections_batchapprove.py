...
class RealtimebiddingBiddersPublisherConnectionsBatchApproveRequest:
    ...
    r"""Required. The bidder for whom publisher connections will be approved. Format: `bidders/{bidder}` where `{bidder}` is the account ID of the bidder."""  
    ...
    batch_approve_publisher_connections_request: Optional[shared_batchapprovepublisherconnectionsrequest.BatchApprovePublisherConnectionsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
