...
public class GetUsersIdsQuestionsUnansweredRequest {
    ...
    public GetUsersIdsQuestionsUnansweredRequest withCallback(String callback) {
    ...
    public GetUsersIdsQuestionsUnansweredRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsQuestionsUnansweredRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withOrder(GetUsersIdsQuestionsUnansweredOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsQuestionsUnansweredRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withSort(GetUsersIdsQuestionsUnansweredSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUsersIdsQuestionsUnansweredRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetUsersIdsQuestionsUnansweredRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
