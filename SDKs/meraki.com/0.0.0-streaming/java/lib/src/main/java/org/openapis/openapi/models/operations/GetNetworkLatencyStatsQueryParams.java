...
public class GetNetworkLatencyStatsQueryParams {
    /**
     * Filter results by AP Tag
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=apTag")
    public String apTag;
    public GetNetworkLatencyStatsQueryParams withApTag(String apTag) {
        this.apTag = apTag;
        return this;
    }
    ...
    public GetNetworkLatencyStatsQueryParams withBand(GetNetworkLatencyStatsBandEnum band) {
        this.band = band;
        return this;
    }
    ...
    public GetNetworkLatencyStatsQueryParams withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public Long ssid;
    public GetNetworkLatencyStatsQueryParams withSsid(Long ssid) {
        this.ssid = ssid;
        return this;
    }
    ...
    public String t0;
    public GetNetworkLatencyStatsQueryParams withT0(String t0) {
        this.t0 = t0;
        return this;
    }
    ...
    public String t1;
    public GetNetworkLatencyStatsQueryParams withT1(String t1) {
        this.t1 = t1;
        return this;
    }
    ...
    public GetNetworkLatencyStatsQueryParams withTimespan(Float timespan) {
    ...
    public Long vlan;
    public GetNetworkLatencyStatsQueryParams withVlan(Long vlan) {
        this.vlan = vlan;
        return this;
    }
