...
exports.ListNetworkResponse = exports.ListNetworkListNetworkResponse = exports.ListNetworkListNetworkResponseMeta = exports.ListNetworkRequest = exports.ListNetworkSecurity = exports.ListNetworkServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListNetworkServerList = ["https://supersim.twilio.com"];
var ListNetworkSecurity = /** @class */ (function (_super) {
    ...
    ], ListNetworkSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListNetworkSecurity.prototype, "username", void 0);
...
var ListNetworkRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListNetworkRequest.prototype, "isoCountry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Mcc" }),
        __metadata("design:type", String)
    ], ListNetworkRequest.prototype, "mcc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Mnc" }),
        __metadata("design:type", String)
    ], ListNetworkRequest.prototype, "mnc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListNetworkRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListNetworkRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListNetworkRequest.prototype, "pageToken", void 0);
...
var ListNetworkListNetworkResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListNetworkListNetworkResponseMeta; }),
        __metadata("design:type", ListNetworkListNetworkResponseMeta)
    ], ListNetworkListNetworkResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SupersimV1Network }),
        (0, class_transformer_1.Expose)({ name: "networks" }),
        (0, class_transformer_1.Type)(function () { return shared.SupersimV1Network; }),
...
var ListNetworkResponse = /** @class */ (function (_super) {
    ...
    ], ListNetworkResponse.prototype, "rawResponse", void 0);
