 ...
 */
export declare class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeLocalGatewayRouteTableVirtualInterfaceGroupAssociationsRequestFilters[];
