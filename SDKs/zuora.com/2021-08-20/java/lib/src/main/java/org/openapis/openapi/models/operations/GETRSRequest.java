...
public class GETRSRequest {
    ...
    public GETRSRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETRSRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETRSRequest withRsNumber(String rsNumber) {
