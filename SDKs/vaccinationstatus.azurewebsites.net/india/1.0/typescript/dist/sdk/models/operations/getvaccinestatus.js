...
exports.GetVaccineStatusResponse = exports.GetVaccineStatusRequest = exports.GetVaccineStatusHeaders = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GetVaccineStatusHeaders = /** @class */ (function (_super) {
    __extends(GetVaccineStatusHeaders, _super);
    function GetVaccineStatusHeaders() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "header, style=simple;explode=false;name=cowinApiKey" }),
        __metadata("design:type", String)
    ], GetVaccineStatusHeaders.prototype, "cowinApiKey", void 0);
    return GetVaccineStatusHeaders;
}(utils_1.SpeakeasyBase));
exports.GetVaccineStatusHeaders = GetVaccineStatusHeaders;
var GetVaccineStatusRequest = /** @class */ (function (_super) {
    __extends(GetVaccineStatusRequest, _super);
    function GetVaccineStatusRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
exports.GetVaccineStatusRequest = GetVaccineStatusRequest;
var GetVaccineStatusResponse = /** @class */ (function (_super) {
    __extends(GetVaccineStatusResponse, _super);
    function GetVaccineStatusResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.GetVaccineStatusResponse = GetVaccineStatusResponse;
