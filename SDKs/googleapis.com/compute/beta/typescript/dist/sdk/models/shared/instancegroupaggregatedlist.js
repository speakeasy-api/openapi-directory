...
exports.InstanceGroupAggregatedList = exports.InstanceGroupAggregatedListWarning = exports.InstanceGroupAggregatedListWarningData = exports.InstanceGroupAggregatedListWarningCodeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var instancegroupsscopedlist_1 = require("./instancegroupsscopedlist");
var class_transformer_1 = require("class-transformer");
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
var InstanceGroupAggregatedListWarningCodeEnum;
(function (InstanceGroupAggregatedListWarningCodeEnum) {
...
})(InstanceGroupAggregatedListWarningCodeEnum = exports.InstanceGroupAggregatedListWarningCodeEnum || (exports.InstanceGroupAggregatedListWarningCodeEnum = {}));
var InstanceGroupAggregatedListWarningData = /** @class */ (function (_super) {
    __extends(InstanceGroupAggregatedListWarningData, _super);
    function InstanceGroupAggregatedListWarningData() {
    ...
    ], InstanceGroupAggregatedListWarningData.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "value" }),
        __metadata("design:type", String)
    ], InstanceGroupAggregatedListWarningData.prototype, "value", void 0);
    return InstanceGroupAggregatedListWarningData;
}(utils_1.SpeakeasyBase));
exports.InstanceGroupAggregatedListWarningData = InstanceGroupAggregatedListWarningData;
/**
 * [Output Only] Informational warning message.
 */
var InstanceGroupAggregatedListWarning = /** @class */ (function (_super) {
    __extends(InstanceGroupAggregatedListWarning, _super);
    function InstanceGroupAggregatedListWarning() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], InstanceGroupAggregatedListWarning.prototype, "code", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: InstanceGroupAggregatedListWarningData }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return InstanceGroupAggregatedListWarningData; }),
        __metadata("design:type", Array)
    ], InstanceGroupAggregatedListWarning.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "message" }),
        __metadata("design:type", String)
    ], InstanceGroupAggregatedListWarning.prototype, "message", void 0);
    return InstanceGroupAggregatedListWarning;
}(utils_1.SpeakeasyBase));
exports.InstanceGroupAggregatedListWarning = InstanceGroupAggregatedListWarning;
/**
 * Successful response
 */
var InstanceGroupAggregatedList = /** @class */ (function (_super) {
    __extends(InstanceGroupAggregatedList, _super);
    function InstanceGroupAggregatedList() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        ...
        __metadata("design:type", String)
    ], InstanceGroupAggregatedList.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: instancegroupsscopedlist_1.InstanceGroupsScopedList }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], instancegroupsscopedlist_1.InstanceGroupsScopedList);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
    ], InstanceGroupAggregatedList.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "kind" }),
        __metadata("design:type", String)
    ], InstanceGroupAggregatedList.prototype, "kind", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "nextPageToken" }),
        __metadata("design:type", String)
    ], InstanceGroupAggregatedList.prototype, "nextPageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "selfLink" }),
        __metadata("design:type", String)
    ], InstanceGroupAggregatedList.prototype, "selfLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "unreachables" }),
        __metadata("design:type", Array)
    ], InstanceGroupAggregatedList.prototype, "unreachables", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "warning" }),
        (0, class_transformer_1.Type)(function () { return InstanceGroupAggregatedListWarning; }),
        __metadata("design:type", InstanceGroupAggregatedListWarning)
    ], InstanceGroupAggregatedList.prototype, "warning", void 0);
    return InstanceGroupAggregatedList;
}(utils_1.SpeakeasyBase));
exports.InstanceGroupAggregatedList = InstanceGroupAggregatedList;
