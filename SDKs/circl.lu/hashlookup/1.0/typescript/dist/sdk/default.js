...
var Default = /** @class */ (function () {
    ...
    **/
    Default.prototype.getLookupSha1Sha1 = function (req, config) {
    ...
    **/
    Default.prototype.getSessionGetName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Default.prototype.getLookup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
