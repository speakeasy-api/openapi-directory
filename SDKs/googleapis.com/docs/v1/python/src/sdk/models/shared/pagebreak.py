...
class PageBreak:
    ...
    r"""The suggested insertion IDs. A PageBreak may have multiple insertion IDs if it's a nested suggested change. If empty, then this is not a suggested insertion."""  
    ...
    r"""The suggested text style changes to this PageBreak, keyed by suggestion ID."""  
