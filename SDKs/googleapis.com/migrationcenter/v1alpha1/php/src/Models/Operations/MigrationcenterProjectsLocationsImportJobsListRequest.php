...
class MigrationcenterProjectsLocationsImportJobsListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MigrationcenterProjectsLocationsImportJobsListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?MigrationcenterProjectsLocationsImportJobsListViewEnum $view = null;
