...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum {
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsGetResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
