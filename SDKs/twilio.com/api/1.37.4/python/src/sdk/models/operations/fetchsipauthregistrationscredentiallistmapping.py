...
class FetchSipAuthRegistrationsCredentialListMappingRequest:
    path_params: FetchSipAuthRegistrationsCredentialListMappingPathParams = dataclasses.field()
    security: FetchSipAuthRegistrationsCredentialListMappingSecurity = dataclasses.field()
