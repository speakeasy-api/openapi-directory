...
class CreateNetworkSiteResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\CreateNetworkSiteResponse $createNetworkSiteResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\CreateNetworkSiteResponse $createNetworkSiteResponse = null;
	...
	{
		$this->contentType = "";
		$this->createNetworkSiteResponse = null;
