...
public class GetTransactionsByAccountIdv1CardTransactionsv1Transaction {
    /**
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withAmountAfterCharges(Long amountAfterCharges) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withAmountBeforeCharges(Long amountBeforeCharges) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withBalance(Long balance) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1TransactionBatchItemDetails batchItemDetails;

    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withBatchItemDetails(GetTransactionsByAccountIdv1CardTransactionsv1TransactionBatchItemDetails batchItemDetails) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("card")
    public GetTransactionsByAccountIdv1CardTransactionsv1TransactionRelatedCard card;

    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withCard(GetTransactionsByAccountIdv1CardTransactionsv1TransactionRelatedCard card) {
        this.card = card;
        return this;
    }
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1TransactionCurrency currency;

    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withCurrency(GetTransactionsByAccountIdv1CardTransactionsv1TransactionCurrency currency) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withDateAcknowledged(OffsetDateTime dateAcknowledged) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1TransactionDirectDebitDetails directDebitDetails;

    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withDirectDebitDetails(GetTransactionsByAccountIdv1CardTransactionsv1TransactionDirectDebitDetails directDebitDetails) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withEventUuid(String eventUuid) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withFeeAmount(Long feeAmount) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1TransactionFxTrade fxTradeDetails;

    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withFxTradeDetails(GetTransactionsByAccountIdv1CardTransactionsv1TransactionFxTrade fxTradeDetails) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withIcan(Long ican) {
        this.ican = ican;
        return this;
    }
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withMyRef(String myRef) {
        this.myRef = myRef;
        return this;
    }
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withPaymentRequestPublicCode(String paymentRequestPublicCode) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1TransactionProprietarySchemeDetails[] proprietarySchemeDetails;

    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withProprietarySchemeDetails(GetTransactionsByAccountIdv1CardTransactionsv1TransactionProprietarySchemeDetails[] proprietarySchemeDetails) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withRefId(Long refId) {
        this.refId = refId;
        return this;
    }
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withRelatedParty(Object relatedParty) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withTaxAmount(Long taxAmount) {
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withTxnId(Long txnId) {
        this.txnId = txnId;
        return this;
    }
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withType(String type) {
        this.type = type;
        return this;
    }
    ...
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction withYourRef(String yourRef) {
        this.yourRef = yourRef;
        return this;
    }
    
    public GetTransactionsByAccountIdv1CardTransactionsv1Transaction(){}
}
