...
class GetSubscriptionsRequest:
    ...
    r"""Filter based on the number of hours events are retained in the database."""  
    description: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'description', 'style': 'form', 'explode': True }})
    r"""Filter based on the description."""  
    ...
    r"""Filter based on subscriptions that populate the events"""  
    ...
    r"""Filter on the topic filter. Make sure to use [percent-encoding](https://en.wikipedia.org/wiki/Percent-encoding) in the query parameter."""  
    ...
    r"""Filter on the verification of the target certificate."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetSubscriptions200ApplicationJSON:
    r"""A JSON object containing a list of subscriptions"""
    ...
    results: Optional[list[shared_subscription.Subscription]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
