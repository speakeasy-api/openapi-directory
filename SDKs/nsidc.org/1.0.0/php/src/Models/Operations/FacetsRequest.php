...
class FacetsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\FacetsSortKeysEnum $sortKeys
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sortKeys')]
    public ?FacetsSortKeysEnum $sortKeys = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\FacetsSourceEnum $source
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=source')]
    public ?FacetsSourceEnum $source = null;
