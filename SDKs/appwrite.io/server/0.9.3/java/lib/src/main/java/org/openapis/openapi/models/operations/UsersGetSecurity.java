...
public class UsersGetSecurity {
    ...
    public UsersGetSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public UsersGetSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public UsersGetSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
