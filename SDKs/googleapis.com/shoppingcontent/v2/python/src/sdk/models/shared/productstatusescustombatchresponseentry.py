...
class ProductstatusesCustomBatchResponseEntry:
    r"""A batch entry encoding a single non-batch productstatuses response."""
    ...
    r"""Identifies what kind of resource this is. Value: the fixed string \\"`content#productstatusesCustomBatchResponseEntry`\\" """  
    product_status: Optional[shared_productstatus.ProductStatus] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('productStatus'), 'exclude': lambda f: f is None }})
