...
class OBWriteDomesticStandingOrderConsentResponse6
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6Data();
		$this->links = null;
		$this->meta = null;
