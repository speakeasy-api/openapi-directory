...
class DescribePullThroughCacheRulesRequest:
    ...
    ecr_repository_prefixes: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ecrRepositoryPrefixes'), 'exclude': lambda f: f is None }})  
