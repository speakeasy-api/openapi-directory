...
export class CodespacesListSelectedReposForOrgSecretRequest extends SpeakeasyBase {
  /**
 ...
 * Response
 */
export class CodespacesListSelectedReposForOrgSecret200ApplicationJSON extends SpeakeasyBase {
...
export class CodespacesListSelectedReposForOrgSecretResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
