...
exports.GetSetupV1ServicesIdAllocationsResponse = exports.GetSetupV1ServicesIdAllocationsRequest = void 0;
...
var GetSetupV1ServicesIdAllocationsRequest = /** @class */ (function (_super) {
    ...
    ], GetSetupV1ServicesIdAllocationsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetSetupV1ServicesIdAllocationsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetSetupV1ServicesIdAllocationsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locationId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1ServicesIdAllocationsRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetSetupV1ServicesIdAllocationsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resourceId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1ServicesIdAllocationsRequest.prototype, "resourceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetSetupV1ServicesIdAllocationsRequest.prototype, "startDate", void 0);
...
var GetSetupV1ServicesIdAllocationsResponse = /** @class */ (function (_super) {
    ...
    ], GetSetupV1ServicesIdAllocationsResponse.prototype, "rawResponse", void 0);
