...
from ..shared import tweetlookupresponse as shared_tweetlookupresponse
...
class FindTweetsByIDResponse:
    ...
    tweet_lookup_response: Optional[shared_tweetlookupresponse.TweetLookupResponse] = dataclasses.field(default=None)
