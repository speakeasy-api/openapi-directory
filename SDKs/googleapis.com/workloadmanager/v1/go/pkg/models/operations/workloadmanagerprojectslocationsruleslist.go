...
type WorkloadmanagerProjectsLocationsRulesListSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type WorkloadmanagerProjectsLocationsRulesListRequest struct {
	// V1 error format.
...
type WorkloadmanagerProjectsLocationsRulesListResponse struct {
	ContentType string
	// Successful response
