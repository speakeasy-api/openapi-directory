...
from ..shared import orgunits as shared_orgunits
...
class DirectoryOrgunitsListSecurity:
    ...
    option1: Optional[DirectoryOrgunitsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DirectoryOrgunitsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DirectoryOrgunitsListRequest:
    ...
    r"""The full path to the organizational unit or its unique ID. Returns the children of the specified organizational unit."""  
    pretty_print: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'prettyPrint', 'style': 'form', 'explode': True }})
    r"""Returns response with indentations and line breaks."""  
    quota_user: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'quotaUser', 'style': 'form', 'explode': True }})
    r"""Available to use for quota purposes for server-side applications. Can be any arbitrary string assigned to a user, but should not exceed 40 characters."""  
    type: Optional[DirectoryOrgunitsListTypeEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""Whether to return all sub-organizations or just immediate children."""  
...
class DirectoryOrgunitsListResponse:
    ...
    org_units: Optional[shared_orgunits.OrgUnits] = dataclasses.field(default=None)
