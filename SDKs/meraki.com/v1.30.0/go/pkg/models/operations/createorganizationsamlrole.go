...
// CreateOrganizationSamlRoleRequestBodyNetworksAccessEnum - The privilege of the SAML administrator on the network. Can be one of 'full', 'read-only', 'guest-ambassador', 'monitor-only' or 'ssid-admins'
...
const (
	...
	CreateOrganizationSamlRoleRequestBodyNetworksAccessEnumSsidAdmins      CreateOrganizationSamlRoleRequestBodyNetworksAccessEnum = "ssid-admins"
)
