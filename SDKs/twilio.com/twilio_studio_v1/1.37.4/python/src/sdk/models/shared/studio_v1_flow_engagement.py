...
class StudioV1FlowEngagement:
    ...
    status: Optional[shared_engagement_enum_status_enum.EngagementEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
