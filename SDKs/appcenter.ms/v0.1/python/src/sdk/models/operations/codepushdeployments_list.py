...
class CodePushDeploymentsList200ApplicationJSONLatestReleaseReleaseMethodEnum(str, Enum):
...
class CodePushDeploymentsList200ApplicationJSONLatestRelease:
    ...
    diff_package_map: Optional[dict[str, CodePushDeploymentsList200ApplicationJSONLatestReleaseDiffPackageMap]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('diff_package_map'), 'exclude': lambda f: f is None }})  
    ...
    release_method: Optional[CodePushDeploymentsList200ApplicationJSONLatestReleaseReleaseMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('release_method'), 'exclude': lambda f: f is None }})
    r"""The release method is unknown if unspecified"""  
...
class CodePushDeploymentsList200ApplicationJSON:
    ...
    latest_release: Optional[CodePushDeploymentsList200ApplicationJSONLatestRelease] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('latest_release'), 'exclude': lambda f: f is None }})  
...
class CodePushDeploymentsListResponse:
    ...
    code_push_deployments_list_200_application_json_objects: Optional[list[CodePushDeploymentsList200ApplicationJSON]] = dataclasses.field(default=None)
    r"""Success"""  
    code_push_deployments_list_default_application_json_object: Optional[CodePushDeploymentsListDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
