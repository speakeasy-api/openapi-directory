...
class CinemaDetail:
    ...
    def cinema_detail_search_read(self, request: operations.CinemaDetailSearchReadRequest) -> operations.CinemaDetailSearchReadResponse:
        ...
        * __{cinema_name}__: Used as a key word to search cinemas,
        ...
        url = utils.generate_url(operations.CinemaDetailSearchReadRequest, base_url, '/api/v1/cinema-detail/search/{cinema_name}', request)
        ...
        res = operations.CinemaDetailSearchReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
