...
class DimensionOrderBy:
    ...
    order_type: Optional[DimensionOrderByOrderTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('orderType'), 'exclude': lambda f: f is None }})
    r"""Controls the rule for dimension value ordering."""  
