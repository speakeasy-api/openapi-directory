...
class UpdateResolverRequestBody:
    caching_config: Optional[UpdateResolverRequestBodyCachingConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cachingConfig') }})
    ...
    kind: Optional[UpdateResolverRequestBodyKindEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kind') }})
    pipeline_config: Optional[UpdateResolverRequestBodyPipelineConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pipelineConfig') }})
    ...
    sync_config: Optional[UpdateResolverRequestBodySyncConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('syncConfig') }})
    

@dataclasses.dataclass
class UpdateResolverRequest:
    headers: UpdateResolverHeaders = dataclasses.field()
    path_params: UpdateResolverPathParams = dataclasses.field()
    request: UpdateResolverRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
