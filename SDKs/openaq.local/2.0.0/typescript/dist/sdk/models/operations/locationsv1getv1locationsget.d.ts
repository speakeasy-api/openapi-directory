 ...
 * An enumeration.
 */
export declare enum Locationsv1GetV1LocationsGetOrderByLocationsOrderEnum {
    City = "city",
    Country = "country",
    Location = "location",
 ...
 * An enumeration.
 */
export declare enum Locationsv1GetV1LocationsGetSortSortEnum {
    Asc = "asc",
    Desc = "desc"
}
export declare class Locationsv1GetV1LocationsGetRequest extends SpeakeasyBase {
    /**
     *
     * @remarks
...
export declare class Locationsv1GetV1LocationsGetResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Validation Error
     */
