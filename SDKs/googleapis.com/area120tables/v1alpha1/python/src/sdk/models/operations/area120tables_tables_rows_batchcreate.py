...
class Area120tablesTablesRowsBatchCreateRequest:
    ...
    r"""Required. The parent table where the rows will be created. Format: tables/{table}"""  
    ...
    batch_create_rows_request: Optional[shared_batchcreaterowsrequest.BatchCreateRowsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
