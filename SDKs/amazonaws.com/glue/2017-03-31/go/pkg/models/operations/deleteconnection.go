...
const (
	DeleteConnectionXAmzTargetEnumAwsGlueDeleteConnection DeleteConnectionXAmzTargetEnum = "AWSGlue.DeleteConnection"
)
...
type DeleteConnectionResponse struct {
	ContentType string
	// Success
	DeleteConnectionResponse map[string]interface{}
