...
public class GetRecordsRecordIdFormatRequest {
    ...
    public GetRecordsRecordIdFormatRequest withAuthenticationToken(String authenticationToken) {
    ...
    public GetRecordsRecordIdFormatRequest withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public GetRecordsRecordIdFormatRequest withFormat(org.openapis.openapi.models.shared.FormatEnum format) {
        this.format = format;
        return this;
    }
    ...
    public GetRecordsRecordIdFormatRequest withRecordId(Long recordId) {
