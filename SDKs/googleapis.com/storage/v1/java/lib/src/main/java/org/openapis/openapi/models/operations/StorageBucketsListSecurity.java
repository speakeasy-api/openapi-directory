...
public class StorageBucketsListSecurity {
    ...
    @SpeakeasyMetadata("security:option=true")
    public StorageBucketsListSecurityOption4 option4;

    public StorageBucketsListSecurity withOption4(StorageBucketsListSecurityOption4 option4) {
        this.option4 = option4;
        return this;
    }
    
    @SpeakeasyMetadata("security:option=true")
    public StorageBucketsListSecurityOption5 option5;

    public StorageBucketsListSecurity withOption5(StorageBucketsListSecurityOption5 option5) {
        this.option5 = option5;
        return this;
    }
    
    public StorageBucketsListSecurity(){}
}
