...
type RechnungsdruckWebAppControllersAPIOrderStateUpdateNewStateIDEnum string
...
func (e *RechnungsdruckWebAppControllersAPIOrderStateUpdateNewStateIDEnum) UnmarshalJSON(data []byte) error {
	...
	case "15":
		fallthrough
	case "16":
		*e = RechnungsdruckWebAppControllersAPIOrderStateUpdateNewStateIDEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for RechnungsdruckWebAppControllersAPIOrderStateUpdateNewStateIDEnum: %s", s)
	}
}
