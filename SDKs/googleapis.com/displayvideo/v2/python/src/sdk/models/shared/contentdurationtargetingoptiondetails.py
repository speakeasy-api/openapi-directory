...
class ContentDurationTargetingOptionDetails:
    ...
    content_duration: Optional[ContentDurationTargetingOptionDetailsContentDurationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contentDuration'), 'exclude': lambda f: f is None }})
    r"""Output only. The content duration."""  
