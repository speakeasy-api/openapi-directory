...
type DataplexProjectsLocationsDataScansListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DataplexProjectsLocationsDataScansListPathParams struct {
...
type DataplexProjectsLocationsDataScansListQueryParams struct {
	// V1 error format.
...
type DataplexProjectsLocationsDataScansListRequest struct {
	PathParams  DataplexProjectsLocationsDataScansListPathParams
	QueryParams DataplexProjectsLocationsDataScansListQueryParams
	Security    DataplexProjectsLocationsDataScansListSecurity
}

type DataplexProjectsLocationsDataScansListResponse struct {
	ContentType string
	// Successful response
