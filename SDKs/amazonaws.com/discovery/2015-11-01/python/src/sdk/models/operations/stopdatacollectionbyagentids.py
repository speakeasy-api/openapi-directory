...
class StopDataCollectionByAgentIdsRequest:
    ...
    stop_data_collection_by_agent_ids_request: shared_stopdatacollectionbyagentidsrequest.StopDataCollectionByAgentIdsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
