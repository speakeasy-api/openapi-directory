...
class ConnectionSettingsAllRequest:
    headers: ConnectionSettingsAllHeaders = dataclasses.field()
    path_params: ConnectionSettingsAllPathParams = dataclasses.field()
    security: ConnectionSettingsAllSecurity = dataclasses.field()
