...
export declare enum PowerOutletTemplateFeedLegLabelEnum {
    A = "A",
    B = "B",
    C = "C"
}
export declare enum PowerOutletTemplateFeedLegValueEnum {
    A = "A",
    B = "B",
    C = "C"
}
export declare class PowerOutletTemplateFeedLeg extends SpeakeasyBase {
    label: PowerOutletTemplateFeedLegLabelEnum;
    value: PowerOutletTemplateFeedLegValueEnum;
}
export declare enum PowerOutletTemplateTypeLabelEnum {
    C5 = "C5",
    C7 = "C7",
    C13 = "C13",
    C15 = "C15",
...
export declare enum PowerOutletTemplateTypeValueEnum {
...
export declare class PowerOutletTemplateType extends SpeakeasyBase {
    label: PowerOutletTemplateTypeLabelEnum;
    value: PowerOutletTemplateTypeValueEnum;
}
export declare class PowerOutletTemplate extends SpeakeasyBase {
    deviceType: NestedDeviceType;
    feedLeg?: PowerOutletTemplateFeedLeg;
    id?: number;
    name: string;
    powerPort?: NestedPowerPortTemplate;
