...
func (s *Cities) CitiesDrillersList(ctx context.Context) (*operations.CitiesDrillersListResponse, error) {
...
func (s *Cities) CitiesInstallersList(ctx context.Context) (*operations.CitiesInstallersListResponse, error) {
	baseURL := s._serverURL
