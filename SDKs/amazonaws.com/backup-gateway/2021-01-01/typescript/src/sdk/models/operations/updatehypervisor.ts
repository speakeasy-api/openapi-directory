...
export enum UpdateHypervisorXAmzTargetEnum {
  BackupOnPremisesV20210101UpdateHypervisor = "BackupOnPremises_v20210101.UpdateHypervisor",
}

export class UpdateHypervisorRequest extends SpeakeasyBase {
...
export class UpdateHypervisorResponse extends SpeakeasyBase {
  /**
