...
class UpdateFileSystemOntapConfiguration:
    ...
    add_route_table_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AddRouteTableIds'), 'exclude': lambda f: f is None }})  
    ...
    remove_route_table_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RemoveRouteTableIds'), 'exclude': lambda f: f is None }})  
