...
class UnsubscribeUserNotificationPathParams:
...
class UnsubscribeUserNotificationRequest:
    path_params: UnsubscribeUserNotificationPathParams = dataclasses.field()
    security: UnsubscribeUserNotificationSecurity = dataclasses.field()
