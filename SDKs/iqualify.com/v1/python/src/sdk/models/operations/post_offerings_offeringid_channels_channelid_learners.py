...
class PostOfferingsOfferingIDChannelsChannelIDLearnersRequest:
    path_params: PostOfferingsOfferingIDChannelsChannelIDLearnersPathParams = dataclasses.field()
    request: PostOfferingsOfferingIDChannelsChannelIDLearnersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
