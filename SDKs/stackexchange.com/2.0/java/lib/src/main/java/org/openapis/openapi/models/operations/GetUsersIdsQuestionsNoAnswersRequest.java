...
public class GetUsersIdsQuestionsNoAnswersRequest {
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withCallback(String callback) {
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withFromdate(Long fromdate) {
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withMin(String min) {
        this.min = min;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withOrder(GetUsersIdsQuestionsNoAnswersOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withSite(String site) {
        this.site = site;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withSort(GetUsersIdsQuestionsNoAnswersSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetUsersIdsQuestionsNoAnswersRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetUsersIdsQuestionsNoAnswersRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
