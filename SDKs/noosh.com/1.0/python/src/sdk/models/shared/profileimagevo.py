...
class ProfileImageVO:
    r"""Java type: com.noosh.nooshapi.vo.ProfileImageVO"""
    
    profile_img_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('profileImgUrl'), 'exclude': lambda f: f is None }})  
