...
class SearchProjectGpsControlpointsQueryParams:
...
class SearchProjectGpsControlpointsRequest:
    query_params: SearchProjectGpsControlpointsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectGpsControlpointsResponse:
