...
type SearchContactQueryParams struct {
	...
	// Email
	SearchDbContactEmail *string `queryParam:"style=form,explode=true,name=search.db_contact.email"`
	// Institution
	SearchDbContactInstitution *string `queryParam:"style=form,explode=true,name=search.db_contact.institution"`
	// Name
	SearchDbContactName *string `queryParam:"style=form,explode=true,name=search.db_contact.name"`
	// Number to skip
