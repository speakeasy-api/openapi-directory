...
type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsAcknowledgeRequest struct {
	...
	GoogleCloudAssuredworkloadsV1AcknowledgeViolationRequest *shared.GoogleCloudAssuredworkloadsV1AcknowledgeViolationRequest `request:"mediaType=application/json"`
	// OAuth access token.
