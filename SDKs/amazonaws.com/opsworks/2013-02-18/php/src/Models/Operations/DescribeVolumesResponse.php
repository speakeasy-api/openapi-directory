...
class DescribeVolumesResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\DescribeVolumesResult $describeVolumesResult
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\DescribeVolumesResult $describeVolumesResult = null;
	...
	{
		$this->contentType = "";
		$this->describeVolumesResult = null;
