...
exports.GetRemoveCurationTagResponse = exports.GetRemoveCurationTagRequest = exports.GetRemoveCurationTagFormatEnum = void 0;
...
var GetRemoveCurationTagRequest = /** @class */ (function (_super) {
    ...
    ], GetRemoveCurationTagRequest.prototype, "auth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=format",
        }),
        __metadata("design:type", String)
    ], GetRemoveCurationTagRequest.prototype, "format", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=pwId" }),
        __metadata("design:type", String)
    ], GetRemoveCurationTagRequest.prototype, "pwId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=tagName",
        }),
        __metadata("design:type", String)
    ], GetRemoveCurationTagRequest.prototype, "tagName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=username",
        }),
        __metadata("design:type", String)
    ], GetRemoveCurationTagRequest.prototype, "username", void 0);
...
var GetRemoveCurationTagResponse = /** @class */ (function (_super) {
    ...
    ], GetRemoveCurationTagResponse.prototype, "rawResponse", void 0);
