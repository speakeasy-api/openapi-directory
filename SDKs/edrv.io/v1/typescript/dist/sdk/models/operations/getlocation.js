...
var GetLocationRequest = /** @class */ (function (_super) {
    ...
    ], GetLocationRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=include_chargestations",
        }),
        __metadata("design:type", Boolean)
    ], GetLocationRequest.prototype, "includeChargestations", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=include_organization",
        }),
        __metadata("design:type", Boolean)
    ], GetLocationRequest.prototype, "includeOrganization", void 0);
