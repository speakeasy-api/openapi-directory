...
class DirectoryChromeosdevicesUpdateRequest:
    ...
    projection: Optional[DirectoryChromeosdevicesUpdateProjectionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'projection', 'style': 'form', 'explode': True }})
    r"""Restrict information returned to a set of selected fields."""  
