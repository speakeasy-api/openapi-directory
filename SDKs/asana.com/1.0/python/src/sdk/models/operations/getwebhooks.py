...
class GetWebhooksRequest:
    ...
    r"""The workspace to query for webhooks in."""  
    ...
    r"""Only return webhooks for the given resource."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetWebhooks200ApplicationJSON:
    r"""Successfully retrieved the requested webhooks."""
    
    data: Optional[list[shared_webhookresponse.WebhookResponse]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
