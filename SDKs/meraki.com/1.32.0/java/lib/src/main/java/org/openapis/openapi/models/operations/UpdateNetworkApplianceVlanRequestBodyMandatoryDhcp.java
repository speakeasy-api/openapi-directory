 ...
 */
public class UpdateNetworkApplianceVlanRequestBodyMandatoryDhcp {
    /**
    ...
    public UpdateNetworkApplianceVlanRequestBodyMandatoryDhcp withEnabled(Boolean enabled) {
        this.enabled = enabled;
        return this;
    }
    
    public UpdateNetworkApplianceVlanRequestBodyMandatoryDhcp(){}
}
