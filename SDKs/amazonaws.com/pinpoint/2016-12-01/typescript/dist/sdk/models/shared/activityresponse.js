...
var ActivityResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ScheduledStart" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SuccessfulEndpointCount" }),
        __metadata("design:type", Number)
    ], ActivityResponse.prototype, "successfulEndpointCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TimezonesCompletedCount" }),
        __metadata("design:type", Number)
    ], ActivityResponse.prototype, "timezonesCompletedCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TimezonesTotalCount" }),
        __metadata("design:type", Number)
    ], ActivityResponse.prototype, "timezonesTotalCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "TotalEndpointCount" }),
        __metadata("design:type", Number)
