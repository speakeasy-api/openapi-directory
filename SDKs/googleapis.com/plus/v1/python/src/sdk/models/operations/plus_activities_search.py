...
class PlusActivitiesSearchOrderByEnum(str, Enum):
    r"""Specifies how to order search results."""
    BEST = 'best'
    RECENT = 'recent'
...
class PlusActivitiesSearchRequest:
    ...
    r"""The maximum number of activities to include in the response, which is used for paging. For any response, the actual number returned might be less than the specified maxResults."""  
