...
export class DatafusionProjectsLocationsInstancesDnsPeeringsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatafusionProjectsLocationsInstancesDnsPeeringsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatafusionProjectsLocationsInstancesDnsPeeringsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
