...
class PostServersIDActionsAddToPlacementGroupAddToPlacementGroupRequest:
    ...
    placement_group: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('placement_group') }})
    r"""ID of Placement Group the Server should be added to"""  
...
class PostServersIDActionsAddToPlacementGroupRequest:
    ...
    r"""ID of the Server"""  
    request_body: Optional[PostServersIDActionsAddToPlacementGroupAddToPlacementGroupRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostServersIDActionsAddToPlacementGroupActionResponseAction:
    ...
    error: PostServersIDActionsAddToPlacementGroupActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostServersIDActionsAddToPlacementGroupActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostServersIDActionsAddToPlacementGroupActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostServersIDActionsAddToPlacementGroupActionResponse:
    ...
    action: PostServersIDActionsAddToPlacementGroupActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
