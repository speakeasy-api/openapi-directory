...
class GetNhFurnitureFurnitureRequest:
    ...
    furniture: str = dataclasses.field(metadata={'path_param': { 'field_name': 'furniture', 'style': 'simple', 'explode': False }})
    r"""The name of the furniture you wish to retrieve information about."""  
...
@dataclasses.dataclass
class GetNhFurnitureFurnitureResponse:
    ...
    nh_furniture: Optional[shared_nhfurniture.NHFurniture] = dataclasses.field(default=None)
