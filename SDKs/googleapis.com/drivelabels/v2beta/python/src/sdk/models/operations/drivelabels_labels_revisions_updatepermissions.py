...
class DrivelabelsLabelsRevisionsUpdatePermissionsRequest:
    path_params: DrivelabelsLabelsRevisionsUpdatePermissionsPathParams = dataclasses.field()
    query_params: DrivelabelsLabelsRevisionsUpdatePermissionsQueryParams = dataclasses.field()
