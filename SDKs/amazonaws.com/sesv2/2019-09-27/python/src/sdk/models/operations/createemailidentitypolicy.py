...
class CreateEmailIdentityPolicyRequest:
    headers: CreateEmailIdentityPolicyHeaders = dataclasses.field()
    path_params: CreateEmailIdentityPolicyPathParams = dataclasses.field()
    request: CreateEmailIdentityPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateEmailIdentityPolicyResponse:
    ...
    create_email_identity_policy_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
