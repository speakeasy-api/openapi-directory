 ...
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionBatchItemDetails extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedCard extends SpeakeasyBase {
    alias?: string;
    cardId?: number;
 ...
 */
export declare enum GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrencyCodeEnum {
    Eur = "EUR",
    Gbp = "GBP"
}
/**
 * The currency.
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrency extends SpeakeasyBase {
    /**
     * The three letter code for the currency - either `EUR` or `GBP`.
     */
    code?: GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrencyCodeEnum;
    /**
 ...
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionDirectDebitDetails extends SpeakeasyBase {
    /**
 ...
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionFxTrade extends SpeakeasyBase {
    /**
...
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionProprietarySchemeDetails extends SpeakeasyBase {
    /**
...
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyCardPaymentCardMerchant extends SpeakeasyBase {
...
export declare enum GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyCardPaymentTypeEnum {
 ...
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyCardPayment extends SpeakeasyBase {
    cardMerchant?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyCardPaymentCardMerchant;
    type?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyCardPaymentTypeEnum;
}
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyPayeeAccount extends SpeakeasyBase {
    /**
...
export declare enum GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyPayeeTypeEnum {
    WithdrawalAccount = "WITHDRAWAL_ACCOUNT"
}
/**
 * Details of the related third party involved in the transaction.
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyPayee extends SpeakeasyBase {
    account?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyPayeeAccount;
    type?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyPayeeTypeEnum;
}
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccountAccount extends SpeakeasyBase {
    /**
...
export declare enum GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccountTypeEnum {
    ExternalAccount = "EXTERNAL_ACCOUNT"
}
/**
 * Details of the related third party involved in the transaction.
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccount extends SpeakeasyBase {
    account?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccountAccount;
    type?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyExternalAccountTypeEnum;
}
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccountAccount extends SpeakeasyBase {
    /**
     * the Account Number of the account.
     */
    accountNumber?: string;
...
export declare enum GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccountTypeEnum {
    FireAccount = "FIRE_ACCOUNT"
}
/**
 * Details of the related third party involved in the transaction.
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccount extends SpeakeasyBase {
    account?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccountAccount;
    type?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedPartyRelatedPartyFireAccountTypeEnum;
}
export declare class GetTransactionsFilteredByIdCardTransactionsv1Transaction extends SpeakeasyBase {
    /**
     ...
     * Details of the batch run if this transaction was part of a batch.
     */
    batchItemDetails?: GetTransactionsFilteredByIdCardTransactionsv1TransactionBatchItemDetails;
    /**
     * Details of the card used (if applicable)
     */
    card?: GetTransactionsFilteredByIdCardTransactionsv1TransactionRelatedCard;
    /**
     * The currency.
     */
    currency?: GetTransactionsFilteredByIdCardTransactionsv1TransactionCurrency;
    /**
     ...
     * Details of the direct debit (if applicable)
     */
    directDebitDetails?: GetTransactionsFilteredByIdCardTransactionsv1TransactionDirectDebitDetails;
    /**
     ...
     * Details of the FX trade (if applicable)
     */
    fxTradeDetails?: GetTransactionsFilteredByIdCardTransactionsv1TransactionFxTrade;
    /**
     ...
     */
    proprietarySchemeDetails?: GetTransactionsFilteredByIdCardTransactionsv1TransactionProprietarySchemeDetails[];
    /**
 ...
 */
export declare class GetTransactionsFilteredByIdCardTransactionsv1 extends SpeakeasyBase {
    /**
     ...
     */
    total?: number;
    transactions?: GetTransactionsFilteredByIdCardTransactionsv1Transaction[];
}
export declare class GetTransactionsFilteredByIdResponse extends SpeakeasyBase {
     ...
     * An array of transaction objects for the account with a count (`total`) filtered by the specified query parameter.
     */
    cardTransactionsv1?: GetTransactionsFilteredByIdCardTransactionsv1;
}
