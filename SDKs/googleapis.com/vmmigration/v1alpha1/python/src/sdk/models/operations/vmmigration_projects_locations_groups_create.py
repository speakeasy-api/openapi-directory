...
class VmmigrationProjectsLocationsGroupsCreateRequest:
    path_params: VmmigrationProjectsLocationsGroupsCreatePathParams = dataclasses.field()
    query_params: VmmigrationProjectsLocationsGroupsCreateQueryParams = dataclasses.field()
    security: VmmigrationProjectsLocationsGroupsCreateSecurity = dataclasses.field()
