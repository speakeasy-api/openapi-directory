...
from ..shared import security as shared_security
from ..shared import lookupselfdeviceusersresponse as shared_lookupselfdeviceusersresponse
...
class CloudidentityDevicesDeviceUsersLookupRequest:
    path_params: CloudidentityDevicesDeviceUsersLookupPathParams = dataclasses.field()
    query_params: CloudidentityDevicesDeviceUsersLookupQueryParams = dataclasses.field()
    security: CloudidentityDevicesDeviceUsersLookupSecurity = dataclasses.field()
...
class CloudidentityDevicesDeviceUsersLookupResponse:
    ...
    lookup_self_device_users_response: Optional[shared_lookupselfdeviceusersresponse.LookupSelfDeviceUsersResponse] = dataclasses.field(default=None)
