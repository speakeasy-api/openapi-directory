 ...
 */
export declare enum CreateLaunchTemplateRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateLaunchTemplateRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateLaunchTemplateRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateLaunchTemplateRequest extends SpeakeasyBase {
    clientToken?: string;
    dryRun?: boolean;
