...
func (e UpdateNetworkApplianceSsidRequestBodyAuthModeEnum) ToPointer() *UpdateNetworkApplianceSsidRequestBodyAuthModeEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceSsidRequestBodyAuthModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "open":
		fallthrough
	case "psk":
		*e = UpdateNetworkApplianceSsidRequestBodyAuthModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceSsidRequestBodyAuthModeEnum: %v", v)
	}
}
...
func (e UpdateNetworkApplianceSsidRequestBodyEncryptionModeEnum) ToPointer() *UpdateNetworkApplianceSsidRequestBodyEncryptionModeEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceSsidRequestBodyEncryptionModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "wep":
		fallthrough
	case "wpa":
		*e = UpdateNetworkApplianceSsidRequestBodyEncryptionModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceSsidRequestBodyEncryptionModeEnum: %v", v)
	}
}
...
func (e UpdateNetworkApplianceSsidRequestBodyWpaEncryptionModeEnum) ToPointer() *UpdateNetworkApplianceSsidRequestBodyWpaEncryptionModeEnum {
	return &e
}
...
func (e *UpdateNetworkApplianceSsidRequestBodyWpaEncryptionModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "WPA3 Transition Mode":
		fallthrough
	case "WPA3 only":
		*e = UpdateNetworkApplianceSsidRequestBodyWpaEncryptionModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceSsidRequestBodyWpaEncryptionModeEnum: %v", v)
	}
}
