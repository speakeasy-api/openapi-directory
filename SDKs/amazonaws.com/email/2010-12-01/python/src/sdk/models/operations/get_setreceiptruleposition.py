...
class GETSetReceiptRulePositionRequest:
    ...
    r"""The name of the receipt rule to reposition."""  
    rule_set_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'RuleSetName', 'style': 'form', 'explode': True }})
    r"""The name of the receipt rule set that contains the receipt rule to reposition."""  
    ...
    r"""The name of the receipt rule after which to place the specified receipt rule."""  
