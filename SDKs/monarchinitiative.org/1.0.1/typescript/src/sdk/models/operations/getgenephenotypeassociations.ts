...
export class GetGenePhenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGenePhenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGenePhenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenePhenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
