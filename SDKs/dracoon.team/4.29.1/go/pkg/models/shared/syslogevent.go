...
// SyslogEventStatusEnum - Operation status:
//
// * `0` - Success
//
// * `2` - Error
type SyslogEventStatusEnum string

const (
	SyslogEventStatusEnumZero SyslogEventStatusEnum = "0"
	SyslogEventStatusEnumTwo  SyslogEventStatusEnum = "2"
)

func (e *SyslogEventStatusEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "0":
		fallthrough
	case "2":
		*e = SyslogEventStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for SyslogEventStatusEnum: %s", s)
	}
}

// SyslogEvent - Syslog event information
type SyslogEvent struct {
	...
	//
	// * `2` - Error
	Status *SyslogEventStatusEnum `json:"status,omitempty"`
	// Event timestamp
