...
public class CreateInternationalPaymentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalPaymentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalPaymentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalPaymentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalPaymentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalPaymentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalPaymentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalPaymentsJsonHeaders withXJwsSignature(String xJwsSignature) {
