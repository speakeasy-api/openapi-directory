...
class GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult:
    ...
    object_annotations: Optional[list[shared_googlecloudvisionv1p2beta1productsearchresultsobjectannotation.GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('objectAnnotations'), 'exclude': lambda f: f is None }})
    r"""List of generic predictions for the object in the bounding box."""  
    results: Optional[list[shared_googlecloudvisionv1p2beta1productsearchresultsresult.GoogleCloudVisionV1p2beta1ProductSearchResultsResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
