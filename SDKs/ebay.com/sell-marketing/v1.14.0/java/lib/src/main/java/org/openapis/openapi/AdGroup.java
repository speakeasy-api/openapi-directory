...
public class AdGroup {
     ...
     */
    public org.openapis.openapi.models.operations.CreateAdGroupResponse createAdGroup(org.openapis.openapi.models.operations.CreateAdGroupRequest request, org.openapis.openapi.models.operations.CreateAdGroupSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.CreateAdGroupRequest.class, baseUrl, "/ad_campaign/{campaign_id}/ad_group", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "createAdGroupRequest", "json");
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetAdGroupResponse getAdGroup(org.openapis.openapi.models.operations.GetAdGroupRequest request, org.openapis.openapi.models.operations.GetAdGroupSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetAdGroupRequest.class, baseUrl, "/ad_campaign/{campaign_id}/ad_group/{ad_group_id}", request, null);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.GetAdGroupsResponse getAdGroups(org.openapis.openapi.models.operations.GetAdGroupsRequest request, org.openapis.openapi.models.operations.GetAdGroupsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.GetAdGroupsRequest.class, baseUrl, "/ad_campaign/{campaign_id}/ad_group", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetAdGroupsRequest.class, request, null);
        if (queryParams != null) {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.SuggestBidsResponse suggestBids(org.openapis.openapi.models.operations.SuggestBidsRequest request, org.openapis.openapi.models.operations.SuggestBidsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.SuggestBidsRequest.class, baseUrl, "/ad_campaign/{campaign_id}/ad_group/{ad_group_id}/suggest_bids", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "targetedBidRequest", "json");
        if (serializedRequestBody == null) {
            throw new Exception("Request body is required");
        }
        req.setBody(serializedRequestBody);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.SuggestKeywordsResponse suggestKeywords(org.openapis.openapi.models.operations.SuggestKeywordsRequest request, org.openapis.openapi.models.operations.SuggestKeywordsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.SuggestKeywordsRequest.class, baseUrl, "/ad_campaign/{campaign_id}/ad_group/{ad_group_id}/suggest_keywords", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "targetedKeywordRequest", "json");
        req.setBody(serializedRequestBody);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.UpdateAdGroupResponse updateAdGroup(org.openapis.openapi.models.operations.UpdateAdGroupRequest request, org.openapis.openapi.models.operations.UpdateAdGroupSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.UpdateAdGroupRequest.class, baseUrl, "/ad_campaign/{campaign_id}/ad_group/{ad_group_id}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("PUT");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "updateAdGroupRequest", "json");
        if (serializedRequestBody == null) {
            throw new Exception("Request body is required");
        }
        req.setBody(serializedRequestBody);
