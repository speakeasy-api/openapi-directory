...
class GetDeploymentResponseDeploymentStatusEnum(str, Enum):
...
class GetDeploymentResponse:
    ...
    deployment_status: Optional[GetDeploymentResponseDeploymentStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeploymentStatus'), 'exclude': lambda f: f is None }})  
