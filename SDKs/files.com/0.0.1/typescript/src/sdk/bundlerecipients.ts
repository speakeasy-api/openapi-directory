  ...
  **/
  getBundleRecipients(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetBundleRecipientsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postBundleRecipients(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostBundleRecipientsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
