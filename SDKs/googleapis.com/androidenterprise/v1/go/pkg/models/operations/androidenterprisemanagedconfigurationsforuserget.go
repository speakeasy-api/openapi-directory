...
type AndroidenterpriseManagedconfigurationsforuserGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseManagedconfigurationsforuserGetPathParams struct {
...
type AndroidenterpriseManagedconfigurationsforuserGetQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseManagedconfigurationsforuserGetRequest struct {
...
type AndroidenterpriseManagedconfigurationsforuserGetResponse struct {
	ContentType string
	// Successful response
