...
class OBWriteInternationalStandingOrderResponse7DataInitiation:
    ...
    creditor_account: OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAccount') }})
    r"""Provides the details to identify the beneficiary account."""  
    ...
    """  
    instructed_amount: OBWriteInternationalStandingOrderResponse7DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InstructedAmount') }})
    r"""Amount of money to be moved between the debtor and creditor, before deduction of charges, expressed in the currency as ordered by the initiating party.
    Usage: This amount has to be transported unchanged through the transaction chain.
    """  
    ...
    r"""Specifies which party/parties will bear the charges associated with the processing of the payment transaction."""  
    creditor: Optional[OBWriteInternationalStandingOrderResponse7DataInitiationCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Creditor'), 'exclude': lambda f: f is None }})
    r"""Party to which an amount of money is due."""  
    creditor_agent: Optional[OBWriteInternationalStandingOrderResponse7DataInitiationCreditorAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CreditorAgent'), 'exclude': lambda f: f is None }})
    r"""Party that manages the account on behalf of the account owner, that is manages the registration and booking of entries on the account, calculates balances on the account and provides information about the account.
    This is the servicer of the beneficiary account.
    """  
    debtor_account: Optional[OBWriteInternationalStandingOrderResponse7DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DebtorAccount'), 'exclude': lambda f: f is None }})
    r"""Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction."""  
...
class OBWriteInternationalStandingOrderResponse7DataMultiAuthorisation:
    ...
    status: OBWriteInternationalStandingOrderResponse7DataMultiAuthorisationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    r"""Specifies the status of the authorisation flow in code form."""  
...
class OBWriteInternationalStandingOrderResponse7DataRefund:
    ...
    account: OBWriteInternationalStandingOrderResponse7DataRefundAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Account') }})
    r"""Provides the details to identify an account."""  
    agent: Optional[OBWriteInternationalStandingOrderResponse7DataRefundAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Agent'), 'exclude': lambda f: f is None }})
    r"""Set of elements used to uniquely and unambiguously identify a financial institution or a branch of a financial institution."""  
    creditor: Optional[OBWriteInternationalStandingOrderResponse7DataRefundCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Creditor'), 'exclude': lambda f: f is None }})
    r"""Set of elements used to identify a person or an organisation."""  
...
class OBWriteInternationalStandingOrderResponse7Data:
    ...
    2017-04-05T10:43:07+00:00
    """  
    initiation: OBWriteInternationalStandingOrderResponse7DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Initiation') }})
    r"""The Initiation payload is sent by the initiating party to the ASPSP. It is used to request movement of funds from the debtor account to a creditor for an international standing order."""  
    international_standing_order_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('InternationalStandingOrderId') }})
    r"""OB: Unique identification as assigned by the ASPSP to uniquely identify the international standing order resource."""  
    status: OBWriteInternationalStandingOrderResponse7DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Status') }})
    r"""Specifies the status of resource in code form."""  
    ...
    2017-04-05T10:43:07+00:00
    """  
    charges: Optional[list[OBWriteInternationalStandingOrderResponse7DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Charges'), 'exclude': lambda f: f is None }})  
    ...
    multi_authorisation: Optional[OBWriteInternationalStandingOrderResponse7DataMultiAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MultiAuthorisation'), 'exclude': lambda f: f is None }})
    r"""The multiple authorisation flow response from the ASPSP."""  
    refund: Optional[OBWriteInternationalStandingOrderResponse7DataRefund] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Refund'), 'exclude': lambda f: f is None }})  
...
class OBWriteInternationalStandingOrderResponse7:
    ...
    data: OBWriteInternationalStandingOrderResponse7Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Data') }})  
