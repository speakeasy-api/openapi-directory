...
/**
 * SDK - <fullname>Certificate Manager</fullname> <p>You can use Certificate Manager (ACM) to manage SSL/TLS certificates for your Amazon Web Services-based websites and applications. For more information about using ACM, see the <a href="https://docs.aws.amazon.com/acm/latest/userguide/">Certificate Manager User Guide</a>.</p>
 * 
 * https://docs.aws.amazon.com/acm/ - Amazon Web Services documentation
 * 
 * @package OpenAPI\OpenAPI
 * @access public
 * @see https://docs.aws.amazon.com/acm/
 */
class SDK
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\AddTagsToCertificateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\AddTagsToCertificateResponse
     */
	public function addTagsToCertificate(
        \OpenAPI\OpenAPI\Models\Operations\AddTagsToCertificateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\AddTagsToCertificateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.AddTagsToCertificate');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "addTagsToCertificateRequest", "json");
        if ($body === null) {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\AddTagsToCertificateResponse();
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.DeleteCertificate');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.DescribeCertificate');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.ExportCertificate');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "exportCertificateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->exportCertificateResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ExportCertificateResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\GetAccountConfigurationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\GetAccountConfigurationResponse
     */
	public function getAccountConfiguration(
        \OpenAPI\OpenAPI\Models\Operations\GetAccountConfigurationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\GetAccountConfigurationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.GetAccountConfiguration');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetAccountConfigurationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->getAccountConfigurationResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GetAccountConfigurationResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.GetCertificate');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.ImportCertificate');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.ListCertificates');
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListTagsForCertificateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ListTagsForCertificateResponse
     */
	public function listTagsForCertificate(
        \OpenAPI\OpenAPI\Models\Operations\ListTagsForCertificateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ListTagsForCertificateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.ListTagsForCertificate');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "listTagsForCertificateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListTagsForCertificateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listTagsForCertificateResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListTagsForCertificateResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\PutAccountConfigurationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\PutAccountConfigurationResponse
     */
	public function putAccountConfiguration(
        \OpenAPI\OpenAPI\Models\Operations\PutAccountConfigurationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\PutAccountConfigurationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.PutAccountConfiguration');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "putAccountConfigurationRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PutAccountConfigurationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromCertificateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromCertificateResponse
     */
	public function removeTagsFromCertificate(
        \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromCertificateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromCertificateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.RemoveTagsFromCertificate');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "removeTagsFromCertificateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RemoveTagsFromCertificateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RenewCertificateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RenewCertificateResponse
     */
	public function renewCertificate(
        \OpenAPI\OpenAPI\Models\Operations\RenewCertificateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RenewCertificateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.RenewCertificate');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "renewCertificateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RenewCertificateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\RequestCertificateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\RequestCertificateResponse
     */
	public function requestCertificate(
        \OpenAPI\OpenAPI\Models\Operations\RequestCertificateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\RequestCertificateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.RequestCertificate');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "requestCertificateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\RequestCertificateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->requestCertificateResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\RequestCertificateResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 480) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->invalidDomainValidationOptionsException = $serializer->deserialize((string)$httpResponse->getBody(), 'mixed', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 482) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ResendValidationEmailRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ResendValidationEmailResponse
     */
	public function resendValidationEmail(
        \OpenAPI\OpenAPI\Models\Operations\ResendValidationEmailRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ResendValidationEmailResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.ResendValidationEmail');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "resendValidationEmailRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ResendValidationEmailResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateCertificateOptionsRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateCertificateOptionsResponse
     */
	public function updateCertificateOptions(
        \OpenAPI\OpenAPI\Models\Operations\UpdateCertificateOptionsRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateCertificateOptionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/#X-Amz-Target=CertificateManager.UpdateCertificateOptions');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "updateCertificateOptionsRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateCertificateOptionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
