...
class DeleteSubscriptionNotificationConfigurationRequest:
    ...
    r"""The ID of the Security Lake subscriber account."""  
...
class DeleteSubscriptionNotificationConfigurationResponse:
    ...
    delete_subscription_notification_configuration_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
