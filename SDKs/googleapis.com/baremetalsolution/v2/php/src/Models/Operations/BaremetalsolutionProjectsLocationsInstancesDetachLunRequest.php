...
class BaremetalsolutionProjectsLocationsInstancesDetachLunRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\DetachLunRequest $detachLunRequest = null;
