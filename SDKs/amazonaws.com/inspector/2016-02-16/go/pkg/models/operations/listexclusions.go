...
func (e ListExclusionsXAmzTargetEnum) ToPointer() *ListExclusionsXAmzTargetEnum {
	return &e
}
...
func (e *ListExclusionsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "InspectorService.ListExclusions":
		*e = ListExclusionsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListExclusionsXAmzTargetEnum: %v", v)
	}
}

type ListExclusionsRequest struct {
	ListExclusionsRequest shared.ListExclusionsRequest `request:"mediaType=application/json"`
