...
class RegisterWorkspaceDirectoryRequest:
    ...
    enable_work_docs: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EnableWorkDocs') }})  
    enable_self_service: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EnableSelfService'), 'exclude': lambda f: f is None }})  
