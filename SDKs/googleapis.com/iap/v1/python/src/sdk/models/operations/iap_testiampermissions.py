...
@dataclasses.dataclass
class IapTestIamPermissionsSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class IapTestIamPermissionsRequest:
    path_params: IapTestIamPermissionsPathParams = dataclasses.field()
    query_params: IapTestIamPermissionsQueryParams = dataclasses.field()
    security: IapTestIamPermissionsSecurity = dataclasses.field()
...
@dataclasses.dataclass
class IapTestIamPermissionsResponse:
