...
export class CreateInternationalStandingOrderConsentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalStandingOrderConsentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalStandingOrderConsentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
