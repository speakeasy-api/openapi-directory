...
class Databases:
    ...
    def sql_databases_delete(self, request: operations.SQLDatabasesDeleteRequest) -> operations.SQLDatabasesDeleteResponse:
        ...
        url = utils.generate_url(base_url, "/sql/v1beta4/projects/{project}/instances/{instance}/databases/{database}", request.path_params)
    ...
    def sql_databases_insert(self, request: operations.SQLDatabasesInsertRequest) -> operations.SQLDatabasesInsertResponse:
        ...
        url = utils.generate_url(base_url, "/sql/v1beta4/projects/{project}/instances/{instance}/databases", request.path_params)
