...
class ListUserBindingListUserBindingResponse:
    bindings: Optional[list[shared_ip_messaging_v2_service_user_user_binding.IPMessagingV2ServiceUserUserBinding]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bindings') }})
