 ...
 *
 */
export declare enum PaymentInstrumentInfoStatusEnum {
    Active = "Active",
    Closed = "Closed",
    Inactive = "Inactive",
    Lost = "Lost",
 ...
 */
export declare enum PaymentInstrumentInfoTypeEnum {
    BankAccount = "bankAccount",
    Card = "card"
}
export declare class PaymentInstrumentInfo extends SpeakeasyBase {
    /**
     ...
     *
     */
    status?: PaymentInstrumentInfoStatusEnum;
    /**
     * Type of payment instrument.
     *
     * @remarks
     ...
     * Possible value: **card**, **bankAccount**.
     */
    type: PaymentInstrumentInfoTypeEnum;
}
