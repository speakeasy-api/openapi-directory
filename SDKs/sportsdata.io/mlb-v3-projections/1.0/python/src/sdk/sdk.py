...
class SDK:
    ...
    def projected_player_game_stats_by_date_w_injuries_lineups_dfs_salaries(self, request: operations.ProjectedPlayerGameStatsByDateWInjuriesLineupsDfsSalariesRequest) -> operations.ProjectedPlayerGameStatsByDateWInjuriesLineupsDfsSalariesResponse:
        r"""Projected Player Game Stats by Date (w/ Injuries, Lineups, DFS Salaries)
        """
        ...
        res = operations.ProjectedPlayerGameStatsByDateWInjuriesLineupsDfsSalariesResponse(status_code=r.status_code, content_type=content_type)
    ...
    def projected_player_season_stats_with_adp(self, request: operations.ProjectedPlayerSeasonStatsWithAdpRequest) -> operations.ProjectedPlayerSeasonStatsWithAdpResponse:
        r"""Projected Player Season Stats (with ADP)
        """
        ...
        res = operations.ProjectedPlayerSeasonStatsWithAdpResponse(status_code=r.status_code, content_type=content_type)
