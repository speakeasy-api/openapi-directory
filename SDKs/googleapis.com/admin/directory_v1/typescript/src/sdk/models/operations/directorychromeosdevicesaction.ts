...
export class DirectoryChromeosdevicesActionSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DirectoryChromeosdevicesActionRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DirectoryChromeosdevicesActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
