...
public class JobDisableHeaders {
    /**
    ...
    public JobDisableHeaders withIfMatch(String ifMatch) {
    ...
    public JobDisableHeaders withIfModifiedSince(String ifModifiedSince) {
    ...
    public JobDisableHeaders withIfNoneMatch(String ifNoneMatch) {
    ...
    public JobDisableHeaders withIfUnmodifiedSince(String ifUnmodifiedSince) {
    ...
    public JobDisableHeaders withClientRequestId(String clientRequestId) {
    ...
    public JobDisableHeaders withOcpDate(String ocpDate) {
    ...
    public JobDisableHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
