...
func (e PutPermissionActionGroupEnum) ToPointer() *PutPermissionActionGroupEnum {
	return &e
}
...
func (e *PutPermissionActionGroupEnum) UnmarshalJSON(data []byte) error {
	...
	case "agentPermissions":
		*e = PutPermissionActionGroupEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PutPermissionActionGroupEnum: %v", v)
	}
}
