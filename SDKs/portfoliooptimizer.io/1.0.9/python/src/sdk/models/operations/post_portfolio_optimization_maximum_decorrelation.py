...
class PostPortfolioOptimizationMaximumDecorrelationRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMaximumDecorrelationRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
