...
exports.GetConsumerV1ServicesIdAllocationsResponse = exports.GetConsumerV1ServicesIdAllocationsRequest = void 0;
...
var GetConsumerV1ServicesIdAllocationsRequest = /** @class */ (function (_super) {
    ...
    ], GetConsumerV1ServicesIdAllocationsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetConsumerV1ServicesIdAllocationsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetConsumerV1ServicesIdAllocationsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locationId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1ServicesIdAllocationsRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetConsumerV1ServicesIdAllocationsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resourceId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1ServicesIdAllocationsRequest.prototype, "resourceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetConsumerV1ServicesIdAllocationsRequest.prototype, "startDate", void 0);
...
var GetConsumerV1ServicesIdAllocationsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.ServiceAllocationListViewModel)
    ...
    ], GetConsumerV1ServicesIdAllocationsResponse.prototype, "rawResponse", void 0);
