...
class DeleteProvisionedConcurrencyConfigRequest:
    headers: DeleteProvisionedConcurrencyConfigHeaders = dataclasses.field()
    path_params: DeleteProvisionedConcurrencyConfigPathParams = dataclasses.field()
    query_params: DeleteProvisionedConcurrencyConfigQueryParams = dataclasses.field()
