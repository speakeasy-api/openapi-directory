 ...
 */
public enum GetOrganizationDevicesUplinksAddressesByDeviceTagsFilterTypeEnum {
    ...
    private GetOrganizationDevicesUplinksAddressesByDeviceTagsFilterTypeEnum(String value) {
        this.value = value;
    }
}
