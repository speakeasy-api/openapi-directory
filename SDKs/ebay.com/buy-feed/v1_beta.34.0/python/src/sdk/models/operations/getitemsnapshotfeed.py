...
from ..shared import itemsnapshotresponse as shared_itemsnapshotresponse
from typing import Optional


@dataclasses.dataclass
class GetItemSnapshotFeedSecurity:
...
class GetItemSnapshotFeedRequest:
    ...
    snapshot_date: str = dataclasses.field(metadata={'query_param': { 'field_name': 'snapshot_date', 'style': 'form', 'explode': True }})
...
class GetItemSnapshotFeedResponse:
    ...
    item_snapshot_response: Optional[shared_itemsnapshotresponse.ItemSnapshotResponse] = dataclasses.field(default=None)
    r"""Partial Content"""  
