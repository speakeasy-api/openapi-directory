...
class GetMeQuestionsOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeQuestionsSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
class GetMeQuestionsQueryParams:
    ...
    order: Optional[GetMeQuestionsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeQuestionsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetMeQuestionsRequest:
    query_params: GetMeQuestionsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetMeQuestionsResponse:
