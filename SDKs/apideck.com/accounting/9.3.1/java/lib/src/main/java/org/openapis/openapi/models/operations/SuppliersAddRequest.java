...
public class SuppliersAddRequest {
    ...
    public SuppliersAddRequest(@JsonProperty("SupplierInput") org.openapis.openapi.models.shared.SupplierInput supplierInput, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.supplierInput = supplierInput;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
  }
