...
public class GETRefundPartRequest {
    ...
    public GETRefundPartRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETRefundPartRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETRefundPartRequest withRefundId(String refundId) {
    ...
    public GETRefundPartRequest withRefundpartid(String refundpartid) {
