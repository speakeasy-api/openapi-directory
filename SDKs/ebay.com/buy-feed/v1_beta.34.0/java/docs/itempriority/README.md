...
import org.openapis.openapi.models.operations.GetItemPriorityFeedRequest;
import org.openapis.openapi.models.operations.GetItemPriorityFeedResponse;
import org.openapis.openapi.models.operations.GetItemPriorityFeedSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetItemPriorityFeedRequest req = new GetItemPriorityFeedRequest("placeat", "voluptatum", "iusto", "excepturi", "nisi");            

            GetItemPriorityFeedResponse res = sdk.itemPriority.getItemPriorityFeed(req, new GetItemPriorityFeedSecurity("recusandae") {{
                clientCredentials = "Bearer YOUR_ACCESS_TOKEN_HERE";
            }});

            if (res.itemPriorityResponse != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
