...
type ConnectorsProjectsLocationsProvidersListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ConnectorsProjectsLocationsProvidersListPathParams struct {
...
type ConnectorsProjectsLocationsProvidersListQueryParams struct {
	// V1 error format.
...
type ConnectorsProjectsLocationsProvidersListRequest struct {
...
type ConnectorsProjectsLocationsProvidersListResponse struct {
	ContentType string
	// Successful response
