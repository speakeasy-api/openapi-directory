...
export class ContainerProjectsLocationsOperationsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsOperationsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsOperationsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
