...
@dataclasses.dataclass
class TestArchiveTestRunRequest:
...
class TestArchiveTestRunTestRun:
    ...
    stats: Optional[TestArchiveTestRunTestRunTestRunStatistics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stats'), 'exclude': lambda f: f is None }})
    r"""Summary single test run on Xamarin Test Cloud"""  
...
@dataclasses.dataclass
class TestArchiveTestRunResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)  
    test_run: Optional[TestArchiveTestRunTestRun] = dataclasses.field(default=None)
    r"""OK"""  
