...
func (e RestoreEventDataStoreXAmzTargetEnum) ToPointer() *RestoreEventDataStoreXAmzTargetEnum {
	return &e
}
...
func (e *RestoreEventDataStoreXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "com.amazonaws.cloudtrail.v20131101.CloudTrail_20131101.RestoreEventDataStore":
		*e = RestoreEventDataStoreXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RestoreEventDataStoreXAmzTargetEnum: %v", v)
	}
}
