...
class GetPersonalizedRankingRequestBody:
    ...
    input_list: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('inputList') }})
...
class GetPersonalizedRankingRequest:
    headers: GetPersonalizedRankingHeaders = dataclasses.field()
    request: GetPersonalizedRankingRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
