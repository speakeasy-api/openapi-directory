...
exports.FetchWorkflowStatisticsResponse = exports.FetchWorkflowStatisticsRequest = exports.FetchWorkflowStatisticsSecurity = exports.FetchWorkflowStatisticsServerList = void 0;
...
var FetchWorkflowStatisticsSecurity = /** @class */ (function (_super) {
    ...
    ], FetchWorkflowStatisticsSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowStatisticsSecurity.prototype, "username", void 0);
...
var FetchWorkflowStatisticsRequest = /** @class */ (function (_super) {
    ...
    ], FetchWorkflowStatisticsRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Minutes",
        }),
        __metadata("design:type", Number)
    ], FetchWorkflowStatisticsRequest.prototype, "minutes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SplitByWaitTime",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowStatisticsRequest.prototype, "splitByWaitTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], FetchWorkflowStatisticsRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskChannel",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowStatisticsRequest.prototype, "taskChannel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkflowSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowStatisticsRequest.prototype, "workflowSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], FetchWorkflowStatisticsRequest.prototype, "workspaceSid", void 0);
...
var FetchWorkflowStatisticsResponse = /** @class */ (function (_super) {
    ...
    ], FetchWorkflowStatisticsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
