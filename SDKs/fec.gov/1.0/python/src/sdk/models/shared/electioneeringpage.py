...
from ..shared import electioneering as shared_electioneering
...
class ElectioneeringPage:
    ...
    results: Optional[list[shared_electioneering.Electioneering]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
