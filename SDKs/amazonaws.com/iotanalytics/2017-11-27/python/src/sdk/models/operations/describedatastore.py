...
from ..shared import describedatastoreresponse as shared_describedatastoreresponse
...
class DescribeDatastoreRequest:
    headers: DescribeDatastoreHeaders = dataclasses.field()
    path_params: DescribeDatastorePathParams = dataclasses.field()
    query_params: DescribeDatastoreQueryParams = dataclasses.field()
...
class DescribeDatastoreResponse:
    ...
    describe_datastore_response: Optional[shared_describedatastoreresponse.DescribeDatastoreResponse] = dataclasses.field(default=None)
