...
func (e DescribeLogGroupsXAmzTargetEnum) ToPointer() *DescribeLogGroupsXAmzTargetEnum {
	return &e
}
...
func (e *DescribeLogGroupsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "Logs_20140328.DescribeLogGroups":
		*e = DescribeLogGroupsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeLogGroupsXAmzTargetEnum: %v", v)
	}
}
