...
public class GetBusinessCurrentAccounts429ErrorObject {
    ...
    public GetBusinessCurrentAccounts429ErrorObject(@JsonProperty("description") GetBusinessCurrentAccounts429ErrorObjectDescriptionEnum description, @JsonProperty("status") GetBusinessCurrentAccounts429ErrorObjectStatusEnum status, @JsonProperty("title") GetBusinessCurrentAccounts429ErrorObjectTitleEnum title) {
        this.description = description;
        this.status = status;
        this.title = title;
  }
