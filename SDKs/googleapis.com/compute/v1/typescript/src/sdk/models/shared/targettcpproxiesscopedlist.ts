 ...
 */
export enum TargetTcpProxiesScopedListWarningCodeEnum {
...
export class TargetTcpProxiesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetTcpProxiesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: TargetTcpProxiesScopedListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: TargetTcpProxiesScopedListWarningData })
  @Expose({ name: "data" })
  @Type(() => TargetTcpProxiesScopedListWarningData)
  data?: TargetTcpProxiesScopedListWarningData[];
...
export class TargetTcpProxiesScopedList extends SpeakeasyBase {
  /**
   * A list of TargetTcpProxies contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: TargetTcpProxy })
  @Expose({ name: "targetTcpProxies" })
  @Type(() => TargetTcpProxy)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "warning" })
  @Type(() => TargetTcpProxiesScopedListWarning)
