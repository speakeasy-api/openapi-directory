...
class GetDocumentWithWebHook200ApplicationJSONExplanationLocals:
    key: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationLocalsKey] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('key') }})
    value: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationLocalsValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('value') }})
...
class GetDocumentWithWebHook200ApplicationJSONExplanationNode:
    ...
    terms: Optional[list[GetDocumentWithWebHook200ApplicationJSONExplanationNodeTerms]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('terms') }})
...
class GetDocumentWithWebHook200ApplicationJSONExplanation:
    locals: Optional[list[GetDocumentWithWebHook200ApplicationJSONExplanationLocals]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('locals') }})
    node: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationNode] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('node') }})
    op: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationOpEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('op') }})
    ...
    type: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
...
class GetDocumentWithWebHook200ApplicationJSON:
    explanation: Optional[list[GetDocumentWithWebHook200ApplicationJSONExplanation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('explanation') }})
    metrics: Optional[GetDocumentWithWebHook200ApplicationJSONMetrics] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('metrics') }})
    provenance: Optional[GetDocumentWithWebHook200ApplicationJSONProvenance] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('provenance') }})
...
class GetDocumentWithWebHookRequest:
    path_params: GetDocumentWithWebHookPathParams = dataclasses.field()
    query_params: GetDocumentWithWebHookQueryParams = dataclasses.field()
...
class GetDocumentWithWebHookResponse:
    ...
    get_document_with_web_hook_200_application_json_object: Optional[GetDocumentWithWebHook200ApplicationJSON] = dataclasses.field(default=None)
