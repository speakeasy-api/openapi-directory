...
class ListSyncDocumentPermissionListSyncDocumentPermissionResponse:
    ...
    meta: Optional[ListSyncDocumentPermissionListSyncDocumentPermissionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    permissions: Optional[list[shared_preview_sync_service_document_document_permission.PreviewSyncServiceDocumentDocumentPermission]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permissions'), 'exclude': lambda f: f is None }})  
