...
var Ntp1 = /** @class */ (function () {
    ...
    **/
    Ntp1.prototype.getAddressInfo = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ntp1/addressinfo/{address}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    Ntp1.prototype.getTokenHolders = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ntp1/stakeholders/{tokenid}", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Ntp1.prototype.getTokenId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ntp1/tokenid/{tokensymbol}", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Ntp1.prototype.getTokenMetadata = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ntp1/tokenmetadata/{tokenid}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    Ntp1.prototype.getTokenMetadataOfUtxo = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ntp1/tokenmetadata/{tokenid}/{utxo}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    Ntp1.prototype.getTransactionInfo = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/ntp1/transactioninfo/{txid}", req.pathParams);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
