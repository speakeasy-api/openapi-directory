...
class DisplayvideoFirstAndThirdPartyAudiencesEditCustomerMatchMembersRequest:
    ...
    r"""Required. The ID of the Customer Match FirstAndThirdPartyAudience whose members will be edited."""  
    ...
    r"""JSONP"""  
    edit_customer_match_members_request: Optional[shared_editcustomermatchmembersrequest.EditCustomerMatchMembersRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
