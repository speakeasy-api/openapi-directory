...
exports.SystemPackagesResponse = exports.SystemPackagesRequest = exports.SystemPackagesSecurity = void 0;
...
var SystemPackagesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SystemPackagesRequest.prototype, "filterDescription", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[evra]",
        }),
        __metadata("design:type", String)
    ], SystemPackagesRequest.prototype, "filterEvra", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[name]",
        }),
        __metadata("design:type", String)
    ], SystemPackagesRequest.prototype, "filterName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[summary]",
        }),
        __metadata("design:type", String)
    ], SystemPackagesRequest.prototype, "filterSummary", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter[updatable]",
        }),
        __metadata("design:type", Boolean)
    ], SystemPackagesRequest.prototype, "filterUpdatable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=inventory_id",
        }),
        __metadata("design:type", String)
    ], SystemPackagesRequest.prototype, "inventoryId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], SystemPackagesRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], SystemPackagesRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=search",
        }),
        __metadata("design:type", String)
    ], SystemPackagesRequest.prototype, "search", void 0);
...
var SystemPackagesResponse = /** @class */ (function (_super) {
    ...
    ], SystemPackagesResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
