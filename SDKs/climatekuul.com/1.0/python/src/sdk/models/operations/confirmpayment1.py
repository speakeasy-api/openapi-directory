...
CONFIRM_PAYMENT1_SERVERS = [
	"http://api.climatekuul.com:8000/footprint",
]


@dataclasses.dataclass
class ConfirmPayment1RequestBody:
...
@dataclasses.dataclass
class ConfirmPayment1Request:
    request: Optional[ConfirmPayment1RequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
    server_url: Optional[str] = dataclasses.field(default=None)
    

@dataclasses.dataclass
class ConfirmPayment1Response:
