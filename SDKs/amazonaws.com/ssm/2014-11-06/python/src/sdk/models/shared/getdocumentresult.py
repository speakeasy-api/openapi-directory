...
from ..shared import attachmentcontent as shared_attachmentcontent
...
class GetDocumentResult:
    ...
    attachments_content: Optional[list[shared_attachmentcontent.AttachmentContent]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AttachmentsContent'), 'exclude': lambda f: f is None }})  
