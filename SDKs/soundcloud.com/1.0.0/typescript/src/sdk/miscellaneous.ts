...
export class Miscellaneous {
  ...
  getResolve(
    ...
    security: operations.GetResolveSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetResolveSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetResolveResponse =
        new operations.GetResolveResponse({
      ...
      switch (true) {
        case httpRes?.status == 302:
          if (
            ...
            res.found = utils.objectToClass(httpRes?.data, shared.Found);
          }
          break;
      }
