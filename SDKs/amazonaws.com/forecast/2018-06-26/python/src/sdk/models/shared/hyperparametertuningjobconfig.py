...
class HyperParameterTuningJobConfig:
    ...
    parameter_ranges: Optional[shared_parameterranges.ParameterRanges] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ParameterRanges') }})
