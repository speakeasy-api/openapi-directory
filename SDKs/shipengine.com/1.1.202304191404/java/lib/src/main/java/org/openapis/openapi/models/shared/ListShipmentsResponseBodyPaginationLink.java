...
public class ListShipmentsResponseBodyPaginationLink {
    ...
    public ListShipmentsResponseBodyPaginationLink(@JsonProperty("first") Link first, @JsonProperty("last") Link last, @JsonProperty("next") OptionalLink next, @JsonProperty("prev") OptionalLink prev) {
        this.first = first;
        this.last = last;
        this.next = next;
        this.prev = prev;
