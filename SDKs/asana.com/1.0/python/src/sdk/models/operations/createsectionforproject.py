...
class CreateSectionForProjectRequest:
    ...
    request_body: CreateSectionForProjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The section to create."""  
...
class CreateSectionForProject201ApplicationJSON:
    r"""Successfully created the specified section."""
