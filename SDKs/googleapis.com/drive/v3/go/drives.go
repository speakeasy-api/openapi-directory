...
func (s *drives) DriveDrivesCreate(ctx context.Context, request operations.DriveDrivesCreateRequest, security operations.DriveDrivesCreateSecurity) (*operations.DriveDrivesCreateResponse, error) {
	baseURL := s.serverURL
