...
func (e UpdateNetworkWirelessBillingRequestBodyPlansTimeLimitEnum) ToPointer() *UpdateNetworkWirelessBillingRequestBodyPlansTimeLimitEnum {
	return &e
}
...
func (e *UpdateNetworkWirelessBillingRequestBodyPlansTimeLimitEnum) UnmarshalJSON(data []byte) error {
	...
	case "1 week":
		fallthrough
	case "30 days":
		*e = UpdateNetworkWirelessBillingRequestBodyPlansTimeLimitEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkWirelessBillingRequestBodyPlansTimeLimitEnum: %v", v)
	}
}
