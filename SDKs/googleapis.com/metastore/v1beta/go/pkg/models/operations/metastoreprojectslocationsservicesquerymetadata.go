...
type MetastoreProjectsLocationsServicesQueryMetadataPathParams struct {
...
type MetastoreProjectsLocationsServicesQueryMetadataQueryParams struct {
	// V1 error format.
...
type MetastoreProjectsLocationsServicesQueryMetadataRequest struct {
	...
	Request     *shared.QueryMetadataRequest `request:"mediaType=application/json"`
