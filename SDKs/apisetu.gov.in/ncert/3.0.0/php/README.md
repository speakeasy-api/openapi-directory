...
use \OpenAPI\OpenAPI\Models\Operations\MrcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\MrcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\MrcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\MrcerSecurity;
...
try {
    ...
    $request->certificateParameters = new MrcerRequestBodyCertificateParameters();
    $request->certificateParameters->dob = '31-12-1980';
    $request->certificateParameters->fullName = 'Sunil Kumar';
    $request->certificateParameters->rroll = '22018207';
    ...
    $request->format = MrcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new MrcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->mrcer($request, $requestSecurity);
...
* [mrcer](docs/apis/README.md#mrcer) - Merit Certificate
