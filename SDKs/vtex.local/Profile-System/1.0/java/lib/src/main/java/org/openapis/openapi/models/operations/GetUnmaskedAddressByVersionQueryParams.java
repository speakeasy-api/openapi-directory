...
public class GetUnmaskedAddressByVersionQueryParams {
    /**
    ...
    public GetUnmaskedAddressByVersionQueryParams withAlternativeKey(String alternativeKey) {
    ...
    public GetUnmaskedAddressByVersionQueryParams withReason(String reason) {
        this.reason = reason;
        return this;
    }
