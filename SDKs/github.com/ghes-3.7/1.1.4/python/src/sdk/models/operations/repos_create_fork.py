...
class ReposCreateForkRequestBody:
    ...
    default_branch_only: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('default_branch_only'), 'exclude': lambda f: f is None }})
    r"""When forking from an existing repository, fork with only the default branch."""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name'), 'exclude': lambda f: f is None }})
    r"""When forking from an existing repository, a new name for the fork."""  
