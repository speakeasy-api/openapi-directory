...
exports.InvoiceItemsOneResponse = exports.InvoiceItemsOneRequest = exports.InvoiceItemsOneSecurity = void 0;
...
exports.InvoiceItemsOneSecurity = InvoiceItemsOneSecurity;
var InvoiceItemsOneRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], InvoiceItemsOneRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], InvoiceItemsOneRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], InvoiceItemsOneRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsOneRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsOneRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsOneRequest.prototype, "xApideckServiceId", void 0);
    return InvoiceItemsOneRequest;
}(utils_1.SpeakeasyBase));
exports.InvoiceItemsOneRequest = InvoiceItemsOneRequest;
var InvoiceItemsOneResponse = /** @class */ (function (_super) {
    ...
    ], InvoiceItemsOneResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.InvoiceItemsOneResponse = InvoiceItemsOneResponse;
