...
req = operations.NbcerRequestBody(
    certificate_parameters=operations.NbcerRequestBodyCertificateParameters(
        ref_no="SRHR/2017/231234",
        token_no="2912337nNn123 or date of issue in dd/mm/yyyy format if token number is less than 8 chars",
    ),
...
res = s.ap_is.nbcer(req, operations.NbcerSecurity(
