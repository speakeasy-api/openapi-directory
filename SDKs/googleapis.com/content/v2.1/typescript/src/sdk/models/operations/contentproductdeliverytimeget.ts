...
export class ContentProductdeliverytimeGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentProductdeliverytimeGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentProductdeliverytimeGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
