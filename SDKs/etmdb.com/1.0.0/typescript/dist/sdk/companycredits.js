...
exports.CompanyCredits = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CompanyCredits = /** @class */ (function () {
    function CompanyCredits(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CompanyCredits.prototype.companyCreditsSearchRead = function (req, config) {
    ...
    **/
    CompanyCredits.prototype.companyCreditsSearchallRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CompanyCredits = CompanyCredits;
