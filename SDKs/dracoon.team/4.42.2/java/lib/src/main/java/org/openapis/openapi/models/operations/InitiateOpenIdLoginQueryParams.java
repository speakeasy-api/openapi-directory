...
public class InitiateOpenIdLoginQueryParams {
    /**
    ...
    public InitiateOpenIdLoginQueryParams withIssuer(String issuer) {
        this.issuer = issuer;
        return this;
    }
    ...
    public InitiateOpenIdLoginQueryParams withLanguage(String language) {
    ...
    public InitiateOpenIdLoginQueryParams withRedirectUri(String redirectUri) {
    ...
    public Boolean test;
    public InitiateOpenIdLoginQueryParams withTest(Boolean test) {
        this.test = test;
        return this;
    }
