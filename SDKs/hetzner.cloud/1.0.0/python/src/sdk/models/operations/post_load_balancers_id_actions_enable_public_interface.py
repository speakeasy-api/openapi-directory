...
class PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseAction:
    ...
    error: PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostLoadBalancersIDActionsEnablePublicInterfaceActionResponse:
    r"""The `action` key contains the `enable_public_interface` Action"""
    
    action: PostLoadBalancersIDActionsEnablePublicInterfaceActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
