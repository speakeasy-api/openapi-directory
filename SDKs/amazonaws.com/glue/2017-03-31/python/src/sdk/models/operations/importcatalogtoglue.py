...
class ImportCatalogToGlueRequest:
    ...
    import_catalog_to_glue_request: shared_importcatalogtogluerequest.ImportCatalogToGlueRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
