...
class GetNetworkClientsBandwidthUsageHistoryRequest:
...
class GetNetworkClientsBandwidthUsageHistoryResponse:
    ...
    get_network_clients_bandwidth_usage_history_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
