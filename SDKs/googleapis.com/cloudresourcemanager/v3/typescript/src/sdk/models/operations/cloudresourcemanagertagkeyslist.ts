...
export class CloudresourcemanagerTagKeysListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerTagKeysListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudresourcemanagerTagKeysListSecurity extends SpeakeasyBase {
...
export class CloudresourcemanagerTagKeysListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudresourcemanagerTagKeysListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
