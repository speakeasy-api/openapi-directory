...
@dataclasses.dataclass
class NodesCommentsListCommentAttributes:
...
@dataclasses.dataclass
class NodesCommentsListCommentLinks:
...
@dataclasses.dataclass
class NodesCommentsListCommentRelationships:
...
class NodesCommentsListComment:
    ...
    attributes: Optional[NodesCommentsListCommentAttributes] = dataclasses.field(default=None)
    r"""The properties of the comment entity."""  
    links: Optional[NodesCommentsListCommentLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the comment entity."""  
    relationships: Optional[NodesCommentsListCommentRelationships] = dataclasses.field(default=None)
    r"""URLs to other entities or entity collections that have a relationship to the comment entity."""  
