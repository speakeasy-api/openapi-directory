...
class ListIncomingPhoneNumberLocalListIncomingPhoneNumberLocalResponse:
    ...
    incoming_phone_numbers: Optional[list[shared_api_v2010_account_incoming_phone_number_incoming_phone_number_local.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('incoming_phone_numbers'), 'exclude': lambda f: f is None }})  
