...
class ProcessorBankTransferCreateRequest:
    ...
    network: shared_banktransfernetwork_enum.BankTransferNetworkEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('network') }})
    ...
    type: shared_banktransfertype_enum.BankTransferTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
