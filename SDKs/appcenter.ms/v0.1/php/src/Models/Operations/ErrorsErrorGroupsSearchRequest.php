...
class ErrorsErrorGroupsSearchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ErrorsErrorGroupsSearchOrderEnum $order
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=order')]
    public ?ErrorsErrorGroupsSearchOrderEnum $order = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ErrorsErrorGroupsSearchSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?ErrorsErrorGroupsSearchSortEnum $sort = null;
