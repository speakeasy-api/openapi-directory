...
public class Extras {
    ...
    public openapisdk.models.operations.ExtrasChoicesListResponse extrasChoicesList() throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/_choices/");
        ...
        openapisdk.models.operations.ExtrasChoicesListResponse res = new openapisdk.models.operations.ExtrasChoicesListResponse() {{
        }};
    ...
    public openapisdk.models.operations.ExtrasChoicesReadResponse extrasChoicesRead(openapisdk.models.operations.ExtrasChoicesReadRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/_choices/{id}/", request.pathParams);
        ...
        openapisdk.models.operations.ExtrasChoicesReadResponse res = new openapisdk.models.operations.ExtrasChoicesReadResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    ...
    public openapisdk.models.operations.ExtrasRecentActivityListResponse extrasRecentActivityList(openapisdk.models.operations.ExtrasRecentActivityListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/recent-activity/");
        ...
        openapisdk.models.operations.ExtrasRecentActivityListResponse res = new openapisdk.models.operations.ExtrasRecentActivityListResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.ExtrasRecentActivityList200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.ExtrasRecentActivityList200ApplicationJson.class);
    ...
    public openapisdk.models.operations.ExtrasRecentActivityReadResponse extrasRecentActivityRead(openapisdk.models.operations.ExtrasRecentActivityReadRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/recent-activity/{id}/", request.pathParams);
        ...
        openapisdk.models.operations.ExtrasRecentActivityReadResponse res = new openapisdk.models.operations.ExtrasRecentActivityReadResponse() {{
            userAction = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UserAction out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UserAction.class);
                res.userAction = out;
            }
        }
    ...
    public openapisdk.models.operations.ExtrasTopologyMapsCreateResponse extrasTopologyMapsCreate(openapisdk.models.operations.ExtrasTopologyMapsCreateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/topology-maps/");
        ...
        openapisdk.models.operations.ExtrasTopologyMapsCreateResponse res = new openapisdk.models.operations.ExtrasTopologyMapsCreateResponse() {{
            topologyMap = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.TopologyMap out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.TopologyMap.class);
                res.topologyMap = out;
            }
        }
    ...
    public openapisdk.models.operations.ExtrasTopologyMapsDeleteResponse extrasTopologyMapsDelete(openapisdk.models.operations.ExtrasTopologyMapsDeleteRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/topology-maps/{id}/", request.pathParams);
        ...
        openapisdk.models.operations.ExtrasTopologyMapsDeleteResponse res = new openapisdk.models.operations.ExtrasTopologyMapsDeleteResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    public openapisdk.models.operations.ExtrasTopologyMapsListResponse extrasTopologyMapsList(openapisdk.models.operations.ExtrasTopologyMapsListRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/topology-maps/");
        ...
        openapisdk.models.operations.ExtrasTopologyMapsListResponse res = new openapisdk.models.operations.ExtrasTopologyMapsListResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.ExtrasTopologyMapsList200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.ExtrasTopologyMapsList200ApplicationJson.class);
    ...
    public openapisdk.models.operations.ExtrasTopologyMapsPartialUpdateResponse extrasTopologyMapsPartialUpdate(openapisdk.models.operations.ExtrasTopologyMapsPartialUpdateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/topology-maps/{id}/", request.pathParams);
        ...
        openapisdk.models.operations.ExtrasTopologyMapsPartialUpdateResponse res = new openapisdk.models.operations.ExtrasTopologyMapsPartialUpdateResponse() {{
            topologyMap = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    public openapisdk.models.operations.ExtrasTopologyMapsReadResponse extrasTopologyMapsRead(openapisdk.models.operations.ExtrasTopologyMapsReadRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/topology-maps/{id}/", request.pathParams);
        ...
        openapisdk.models.operations.ExtrasTopologyMapsReadResponse res = new openapisdk.models.operations.ExtrasTopologyMapsReadResponse() {{
            topologyMap = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    public openapisdk.models.operations.ExtrasTopologyMapsRenderResponse extrasTopologyMapsRender(openapisdk.models.operations.ExtrasTopologyMapsRenderRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/topology-maps/{id}/render/", request.pathParams);
        ...
        openapisdk.models.operations.ExtrasTopologyMapsRenderResponse res = new openapisdk.models.operations.ExtrasTopologyMapsRenderResponse() {{
            topologyMap = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    public openapisdk.models.operations.ExtrasTopologyMapsUpdateResponse extrasTopologyMapsUpdate(openapisdk.models.operations.ExtrasTopologyMapsUpdateRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/extras/topology-maps/{id}/", request.pathParams);
        ...
        openapisdk.models.operations.ExtrasTopologyMapsUpdateResponse res = new openapisdk.models.operations.ExtrasTopologyMapsUpdateResponse() {{
            topologyMap = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
