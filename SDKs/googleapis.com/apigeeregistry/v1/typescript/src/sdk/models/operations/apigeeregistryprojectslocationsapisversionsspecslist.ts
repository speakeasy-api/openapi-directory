...
export class ApigeeregistryProjectsLocationsApisVersionsSpecsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ApigeeregistryProjectsLocationsApisVersionsSpecsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ApigeeregistryProjectsLocationsApisVersionsSpecsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
