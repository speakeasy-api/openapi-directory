...
public class CreateDomesticPaymentConsentsJsonHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticPaymentConsentsJsonHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticPaymentConsentsJsonHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticPaymentConsentsJsonHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticPaymentConsentsJsonHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticPaymentConsentsJsonHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticPaymentConsentsJsonHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticPaymentConsentsJsonHeaders withXJwsSignature(String xJwsSignature) {
