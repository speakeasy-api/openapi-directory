...
class ThirdPartyTrackingURL:
    ...
    third_party_url_type: Optional[ThirdPartyTrackingURLThirdPartyURLTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('thirdPartyUrlType') }})
