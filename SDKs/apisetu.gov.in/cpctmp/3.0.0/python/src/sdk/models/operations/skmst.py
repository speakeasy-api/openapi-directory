...
class SkmstRequestBodyCertificateParameters:
    txt10th_roll_no: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('txt10thRollNo') }})
    txt_candidate_app_seq: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('txtCandidateAppSeq') }})
    txt_exam_date: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('txtExamDate') }})
