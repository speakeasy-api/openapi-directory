...
export declare class NetworksecurityProjectsLocationsTlsInspectionPoliciesListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class NetworksecurityProjectsLocationsTlsInspectionPoliciesListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class NetworksecurityProjectsLocationsTlsInspectionPoliciesListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
