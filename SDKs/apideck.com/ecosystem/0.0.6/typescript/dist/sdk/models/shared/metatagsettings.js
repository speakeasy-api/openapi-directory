...
var MetaTagSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "description_category_page" }),
        __metadata("design:type", String)
    ], MetaTagSettings.prototype, "descriptionCategoryPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "description_collection_page" }),
        __metadata("design:type", String)
    ], MetaTagSettings.prototype, "descriptionCollectionPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "description_listing_page" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "title_postfix" }),
        __metadata("design:type", String)
