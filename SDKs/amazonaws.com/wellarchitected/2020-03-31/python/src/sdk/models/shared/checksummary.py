...
class CheckSummary:
    r"""Trusted Advisor check summary."""
    
    account_summary: Optional[dict[str, int]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AccountSummary'), 'exclude': lambda f: f is None }})  
