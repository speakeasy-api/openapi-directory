...
class UpdateCustomMetricResponse:
    ...
    metric_type: Optional[shared_custommetrictype_enum.CustomMetricTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricType'), 'exclude': lambda f: f is None }})  
