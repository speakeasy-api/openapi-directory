...
type GetPhenotypeVariantAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetPhenotypeVariantAssociationsQueryParams struct {
