...
func (e CreateDataSourceRequestBodyTypeEnum) ToPointer() *CreateDataSourceRequestBodyTypeEnum {
	return &e
}
...
func (e *CreateDataSourceRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "AMAZON_EVENTBRIDGE":
		*e = CreateDataSourceRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateDataSourceRequestBodyTypeEnum: %v", v)
	}
}
