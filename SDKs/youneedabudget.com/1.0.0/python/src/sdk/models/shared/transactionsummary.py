...
class TransactionSummaryDebtTransactionTypeEnum(str, Enum):
...
class TransactionSummary:
    ...
    cleared: TransactionSummaryClearedEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cleared') }})
    r"""The cleared status of the transaction"""  
    ...
    debt_transaction_type: Optional[TransactionSummaryDebtTransactionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('debt_transaction_type'), 'exclude': lambda f: f is None }})
    r"""If the transaction is a debt/loan account transaction, the type of transaction"""  
    flag_color: Optional[TransactionSummaryFlagColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flag_color'), 'exclude': lambda f: f is None }})
    r"""The transaction flag"""  
