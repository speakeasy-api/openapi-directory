...
class AdminSetUserSettingsRequest:
    ...
    admin_set_user_settings_request: shared_adminsetusersettingsrequest.AdminSetUserSettingsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
