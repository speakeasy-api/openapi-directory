...
class BatchSegmentJob:
    r"""Contains information on a batch segment job."""
    
    batch_segment_job_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('batchSegmentJobArn'), 'exclude': lambda f: f is None }})  
    ...
    job_input: Optional[shared_batchsegmentjobinput.BatchSegmentJobInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('jobInput'), 'exclude': lambda f: f is None }})  
    ...
    job_output: Optional[shared_batchsegmentjoboutput.BatchSegmentJobOutput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('jobOutput'), 'exclude': lambda f: f is None }})  
