...
export class GoogleCloudDocumentaiV1beta2Document extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudDocumentaiV1beta2DocumentEntityRelation,
  })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDocumentaiV1beta2DocumentLabel })
  @Expose({ name: "labels" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDocumentaiV1beta2DocumentPage })
  @Expose({ name: "pages" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDocumentaiV1beta2DocumentRevision })
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudDocumentaiV1beta2DocumentTextChange,
  })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDocumentaiV1beta2DocumentStyle })
