...
class TriggerParams:
     ...
     * TermsAndConditions
    """  
    trigger_event: Optional[TriggerParamsTriggerEventEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('triggerEvent'), 'exclude': lambda f: f is None }})
    r"""Condition for the charge to become active.
