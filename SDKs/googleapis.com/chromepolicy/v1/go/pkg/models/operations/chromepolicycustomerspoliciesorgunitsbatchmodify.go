...
type ChromepolicyCustomersPoliciesOrgunitsBatchModifyRequest struct {
	...
	GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest *shared.GoogleChromePolicyVersionsV1BatchModifyOrgUnitPoliciesRequest `request:"mediaType=application/json"`
	// OAuth access token.
