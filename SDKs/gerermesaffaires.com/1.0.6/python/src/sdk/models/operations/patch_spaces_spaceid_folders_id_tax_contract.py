...
class PatchSpacesSpaceIDFoldersIDTaxContractRequestBodyLevelEnum(str, Enum):
...
class PatchSpacesSpaceIDFoldersIDTaxContractRequestBody:
    r"""Tax contract to modify (except name, class and archivaldate)"""
    ...
    level: Optional[PatchSpacesSpaceIDFoldersIDTaxContractRequestBodyLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
...
class PatchSpacesSpaceIDFoldersIDTaxContractRequest:
    ...
    r"""Id of the folder"""  
    request_body: PatchSpacesSpaceIDFoldersIDTaxContractRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Tax contract to modify (except name, class and archivaldate)"""  
