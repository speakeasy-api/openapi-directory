...
class GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequest:
    ...
    annotation: Optional[GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequestAnnotationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('annotation') }})
    ...
    reasons: Optional[list[GoogleCloudRecaptchaenterpriseV1AnnotateAssessmentRequestReasonsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reasons') }})
