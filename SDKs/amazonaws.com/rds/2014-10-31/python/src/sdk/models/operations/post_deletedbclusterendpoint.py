...
class POSTDeleteDBClusterEndpointRequest:
    ...
    action: POSTDeleteDBClusterEndpointActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    version: POSTDeleteDBClusterEndpointVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
