...
func (e GetUsersIDBudgetSummaryPeriodEnum) ToPointer() *GetUsersIDBudgetSummaryPeriodEnum {
	return &e
}
...
func (e *GetUsersIDBudgetSummaryPeriodEnum) UnmarshalJSON(data []byte) error {
	...
	case "years":
		fallthrough
	case "event":
		*e = GetUsersIDBudgetSummaryPeriodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetUsersIDBudgetSummaryPeriodEnum: %v", v)
	}
}
