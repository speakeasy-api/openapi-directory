...
class UntagResource20181105QueryParams:
    operation: UntagResource20181105OperationEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class UntagResource20181105Request:
    headers: UntagResource20181105Headers = dataclasses.field()
    query_params: UntagResource20181105QueryParams = dataclasses.field()
