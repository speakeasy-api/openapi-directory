...
class PutReportDefinitionRequest:
    ...
    put_report_definition_request: shared_putreportdefinitionrequest.PutReportDefinitionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class PutReportDefinitionResponse:
    ...
    r"""DuplicateReportNameException"""  
