...
export class DigitalassetlinksAssetlinksCheckRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=target.androidApp.certificate.sha256Fingerprint",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=target.androidApp.packageName",
  })
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=target.web.site",
  })
