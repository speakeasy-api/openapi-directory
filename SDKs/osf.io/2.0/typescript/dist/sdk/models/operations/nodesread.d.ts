 ...
 */
export declare enum NodesReadNodeAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class NodesReadNodeAttributes extends SpeakeasyBase {
    /**
     * The category of the node, as selected by project contributors.
     */
    category: NodesReadNodeAttributesCategoryEnum;
    /**
 ...
 */
export declare class NodesReadNodeLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class NodesReadNodeRelationships extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export declare class NodesReadNode extends SpeakeasyBase {
    /**
     * The properties of the node entity.
     */
    attributes: NodesReadNodeAttributes;
    /**
     ...
     * URLs to alternative representations of the node entity.
     */
    links?: NodesReadNodeLinks;
    /**
     * URLs to other entities or entity collections that have a relationship to the node entity.
     */
    relationships?: NodesReadNodeRelationships;
    /**
