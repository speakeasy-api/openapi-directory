...
class GetDASHStreamingSessionURLRequestBody
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector $dashFragmentSelector
     */
	#[\JMS\Serializer\Annotation\SerializedName('DASHFragmentSelector')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetDASHStreamingSessionURLRequestBodyDASHFragmentSelector $dashFragmentSelector = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyDisplayFragmentNumberEnum $displayFragmentNumber
     */
	#[\JMS\Serializer\Annotation\SerializedName('DisplayFragmentNumber')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyDisplayFragmentNumberEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetDASHStreamingSessionURLRequestBodyDisplayFragmentNumberEnum $displayFragmentNumber = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum $displayFragmentTimestamp
     */
	#[\JMS\Serializer\Annotation\SerializedName('DisplayFragmentTimestamp')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetDASHStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum $displayFragmentTimestamp = null;
     ...
     * 
     * @var ?int $maxManifestFragmentResults
     */
	#[\JMS\Serializer\Annotation\SerializedName('MaxManifestFragmentResults')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $maxManifestFragmentResults = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyPlaybackModeEnum $playbackMode
     */
	#[\JMS\Serializer\Annotation\SerializedName('PlaybackMode')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetDASHStreamingSessionURLRequestBodyPlaybackModeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetDASHStreamingSessionURLRequestBodyPlaybackModeEnum $playbackMode = null;
	...
	{
		$this->dashFragmentSelector = null;
		$this->displayFragmentNumber = null;
		$this->displayFragmentTimestamp = null;
		$this->expires = null;
		$this->maxManifestFragmentResults = null;
