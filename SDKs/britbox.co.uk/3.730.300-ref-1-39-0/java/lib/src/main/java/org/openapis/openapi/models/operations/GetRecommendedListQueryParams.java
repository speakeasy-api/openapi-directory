...
public class GetRecommendedListQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetRecommendedListQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetRecommendedListQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetRecommendedListQueryParams withItemTypes(String[] itemTypes) {
    ...
    public String lang;
    public GetRecommendedListQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public Integer page;
    public GetRecommendedListQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public GetRecommendedListQueryParams withPageSize(Integer pageSize) {
    ...
    public GetRecommendedListQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetRecommendedListQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
