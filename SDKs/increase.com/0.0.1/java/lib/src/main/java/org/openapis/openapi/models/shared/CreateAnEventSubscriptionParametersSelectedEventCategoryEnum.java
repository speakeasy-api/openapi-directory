 ...
 */
public enum CreateAnEventSubscriptionParametersSelectedEventCategoryEnum {
    ...
    private CreateAnEventSubscriptionParametersSelectedEventCategoryEnum(String value) {
        this.value = value;
    }
}
