...
class DisplayvideoCustomBiddingAlgorithmsUploadScriptRequest:
    path_params: DisplayvideoCustomBiddingAlgorithmsUploadScriptPathParams = dataclasses.field()
    query_params: DisplayvideoCustomBiddingAlgorithmsUploadScriptQueryParams = dataclasses.field()
    security: DisplayvideoCustomBiddingAlgorithmsUploadScriptSecurity = dataclasses.field()
...
class DisplayvideoCustomBiddingAlgorithmsUploadScriptResponse:
    ...
    custom_bidding_script_ref: Optional[shared_custombiddingscriptref.CustomBiddingScriptRef] = dataclasses.field(default=None)
