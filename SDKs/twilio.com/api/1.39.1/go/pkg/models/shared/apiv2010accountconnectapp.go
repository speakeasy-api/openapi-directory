...
func (e *APIV2010AccountConnectAppDeauthorizeCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountConnectAppDeauthorizeCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountConnectAppDeauthorizeCallbackMethodEnum: %s", s)
	}
}
