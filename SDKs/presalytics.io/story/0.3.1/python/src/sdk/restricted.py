...
class Restricted:
    ...
    def collaborators_post(self, request: shared.CollaboratorBulkUpdateRequest) -> operations.CollaboratorsPostResponse:
        ...
        res = operations.CollaboratorsPostResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
