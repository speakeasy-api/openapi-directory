 ...
 * 
 */
public enum POSTSubscriptionCancellationTypeRunBillingEnum {
    TRUE("true"),
    FALSE("false");
    ...
    private POSTSubscriptionCancellationTypeRunBillingEnum(String value) {
        this.value = value;
    }
}
