...
public class GetUsersIdInboxUnreadRequest {
    ...
    public GetUsersIdInboxUnreadRequest withCallback(String callback) {
    ...
    public GetUsersIdInboxUnreadRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetUsersIdInboxUnreadRequest withId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public GetUsersIdInboxUnreadRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetUsersIdInboxUnreadRequest withPagesize(Long pagesize) {
    ...
    public GetUsersIdInboxUnreadRequest withSince(Long since) {
        this.since = since;
        return this;
    }
    ...
    public GetUsersIdInboxUnreadRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    public GetUsersIdInboxUnreadRequest(@JsonProperty("id") Long id, @JsonProperty("site") String site) {
        this.id = id;
        this.site = site;
  }
}
