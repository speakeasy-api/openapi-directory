...
class ViolatingSites:
    ...
    def adexperiencereport_violating_sites_list(self, request: operations.AdexperiencereportViolatingSitesListRequest) -> operations.AdexperiencereportViolatingSitesListResponse:
        ...
        query_params = utils.get_query_params(operations.AdexperiencereportViolatingSitesListRequest, request)
        ...
        res = operations.AdexperiencereportViolatingSitesListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
