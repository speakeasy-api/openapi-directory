...
class AccountHolders 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\CloseStoresRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\PostCloseStoresSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\PostCloseStoresResponse
     */
	public function postCloseStores(
        \OpenAPI\OpenAPI\Models\Shared\CloseStoresRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\PostCloseStoresSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\PostCloseStoresResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/closeStores');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\PostCloseStoresResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
