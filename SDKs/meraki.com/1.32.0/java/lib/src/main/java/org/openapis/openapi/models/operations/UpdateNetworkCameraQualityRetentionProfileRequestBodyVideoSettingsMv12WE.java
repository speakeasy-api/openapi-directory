...
public class UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WE {
    ...
    public UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WE(@JsonProperty("quality") UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WEQualityEnum quality, @JsonProperty("resolution") UpdateNetworkCameraQualityRetentionProfileRequestBodyVideoSettingsMv12WEResolutionEnum resolution) {
        this.quality = quality;
        this.resolution = resolution;
  }
}
