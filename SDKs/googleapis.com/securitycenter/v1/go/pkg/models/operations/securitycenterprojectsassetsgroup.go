...
type SecuritycenterProjectsAssetsGroupSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecuritycenterProjectsAssetsGroupPathParams struct {
...
type SecuritycenterProjectsAssetsGroupQueryParams struct {
	// V1 error format.
...
type SecuritycenterProjectsAssetsGroupRequest struct {
...
type SecuritycenterProjectsAssetsGroupResponse struct {
	ContentType string
	// Successful response
