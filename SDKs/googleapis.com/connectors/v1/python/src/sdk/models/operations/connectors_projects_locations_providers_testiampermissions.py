...
class ConnectorsProjectsLocationsProvidersTestIamPermissionsRequest:
    path_params: ConnectorsProjectsLocationsProvidersTestIamPermissionsPathParams = dataclasses.field()
    query_params: ConnectorsProjectsLocationsProvidersTestIamPermissionsQueryParams = dataclasses.field()
    security: ConnectorsProjectsLocationsProvidersTestIamPermissionsSecurity = dataclasses.field()
