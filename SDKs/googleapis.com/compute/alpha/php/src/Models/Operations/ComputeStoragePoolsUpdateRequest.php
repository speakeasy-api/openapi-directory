...
class ComputeStoragePoolsUpdateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\StoragePool $storagePool1 = null;
     ...
     * 
     * @var string $storagePoolPathParameter
     */
