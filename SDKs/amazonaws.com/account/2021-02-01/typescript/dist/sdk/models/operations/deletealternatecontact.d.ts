 ...
 */
export declare enum DeleteAlternateContactRequestBodyAlternateContactTypeEnum {
    Billing = "BILLING",
    Operations = "OPERATIONS",
    Security = "SECURITY"
}
export declare class DeleteAlternateContactRequestBody extends SpeakeasyBase {
    /**
     ...
     * Specifies which of the alternate contacts to delete.
     */
    alternateContactType: DeleteAlternateContactRequestBodyAlternateContactTypeEnum;
}
export declare class DeleteAlternateContactRequest extends SpeakeasyBase {
    requestBody: DeleteAlternateContactRequestBody;
...
export declare class DeleteAlternateContactResponse extends SpeakeasyBase {
    /**
