...
export class AnalyticsadminPropertiesUserLinksBatchUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesUserLinksBatchUpdateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AnalyticsadminPropertiesUserLinksBatchUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
