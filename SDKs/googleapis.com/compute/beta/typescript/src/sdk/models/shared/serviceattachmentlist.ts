 ...
 */
export enum ServiceAttachmentListWarningCodeEnum {
...
export class ServiceAttachmentListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ServiceAttachmentListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: ServiceAttachmentListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: ServiceAttachmentListWarningData })
  @Expose({ name: "data" })
  @Type(() => ServiceAttachmentListWarningData)
  data?: ServiceAttachmentListWarningData[];
 ...
 * Successful response
 */
export class ServiceAttachmentList extends SpeakeasyBase {
  /**
