...
class Permission:
    ...
    actions: Optional[list[shared_actiontype_enum.ActionTypeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Actions') }})
