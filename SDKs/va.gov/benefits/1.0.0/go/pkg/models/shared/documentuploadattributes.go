...
func (e DocumentUploadAttributesStatusEnum) ToPointer() *DocumentUploadAttributesStatusEnum {
	return &e
}
...
func (e *DocumentUploadAttributesStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "vbms":
		fallthrough
	case "error":
		*e = DocumentUploadAttributesStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DocumentUploadAttributesStatusEnum: %v", v)
	}
}
