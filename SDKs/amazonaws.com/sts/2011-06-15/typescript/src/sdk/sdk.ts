 ...
 *
 * @see {@link https://docs.aws.amazon.com/sts/} - Amazon Web Services documentation
 */
export class SDK {
  ...
  getDecodeAuthorizationMessage(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/#Action=DecodeAuthorizationMessage";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GETDecodeAuthorizationMessageResponse =
        new operations.GETDecodeAuthorizationMessageResponse({
  ...
  getGETAccessKeyInfo(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#Action=GetAccessKeyInfo";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETGETAccessKeyInfoResponse =
        new operations.GETGETAccessKeyInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getGETCallerIdentity(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#Action=GetCallerIdentity";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETGETCallerIdentityResponse =
        new operations.GETGETCallerIdentityResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getGETSessionToken(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GETGETSessionTokenResponse =
        new operations.GETGETSessionTokenResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postAssumeRole(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTAssumeRoleResponse =
        new operations.POSTAssumeRoleResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postAssumeRoleWithSAML(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#Action=AssumeRoleWithSAML";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTAssumeRoleWithSAMLResponse =
        new operations.POSTAssumeRoleWithSAMLResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postAssumeRoleWithWebIdentity(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#Action=AssumeRoleWithWebIdentity";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTAssumeRoleWithWebIdentityResponse =
        new operations.POSTAssumeRoleWithWebIdentityResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postDecodeAuthorizationMessage(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTDecodeAuthorizationMessageResponse =
        new operations.POSTDecodeAuthorizationMessageResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postGetAccessKeyInfo(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTGetAccessKeyInfoResponse =
        new operations.POSTGetAccessKeyInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postGetCallerIdentity(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTGetCallerIdentityResponse =
        new operations.POSTGetCallerIdentityResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postGetFederationToken(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/#Action=GetFederationToken";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTGetFederationTokenResponse =
        new operations.POSTGetFederationTokenResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postGetSessionToken(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.POSTGetSessionTokenResponse =
        new operations.POSTGetSessionTokenResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
