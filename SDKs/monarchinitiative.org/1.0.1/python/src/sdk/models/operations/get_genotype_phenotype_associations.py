...
class GetGenotypePhenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypePhenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGenotypePhenotypeAssociationsRequest:
    path_params: GetGenotypePhenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypePhenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGenotypePhenotypeAssociationsResponse:
