...
exports.DescribeAssociationExecutionTargetsResponse = exports.DescribeAssociationExecutionTargetsRequest = exports.DescribeAssociationExecutionTargetsXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var DescribeAssociationExecutionTargetsXAmzTargetEnum;
...
})(DescribeAssociationExecutionTargetsXAmzTargetEnum = exports.DescribeAssociationExecutionTargetsXAmzTargetEnum || (exports.DescribeAssociationExecutionTargetsXAmzTargetEnum = {}));
var DescribeAssociationExecutionTargetsRequest = /** @class */ (function (_super) {
    ...
    ], DescribeAssociationExecutionTargetsRequest.prototype, "describeAssociationExecutionTargetsRequest", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], DescribeAssociationExecutionTargetsRequest.prototype, "xAmzTarget", void 0);
...
var DescribeAssociationExecutionTargetsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], DescribeAssociationExecutionTargetsResponse.prototype, "rawResponse", void 0);
    return DescribeAssociationExecutionTargetsResponse;
}(utils_1.SpeakeasyBase));
exports.DescribeAssociationExecutionTargetsResponse = DescribeAssociationExecutionTargetsResponse;
