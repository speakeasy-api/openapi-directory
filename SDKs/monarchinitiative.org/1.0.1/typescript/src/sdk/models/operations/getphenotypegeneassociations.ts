...
export class GetPhenotypeGeneAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPhenotypeGeneAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPhenotypeGeneAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  pathParams: GetPhenotypeGeneAssociationsPathParams;

  @SpeakeasyMetadata()
  queryParams: GetPhenotypeGeneAssociationsQueryParams;
}


export class GetPhenotypeGeneAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
