...
class OBWriteDomesticStandingOrderConsentResponse6DataInitiation
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationCreditorAccount $creditorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('CreditorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationCreditorAccount')]
    public OBWriteDomesticStandingOrderConsentResponse6DataInitiationCreditorAccount $creditorAccount;
    
    /**
     * Unambiguous identification of the account of the debtor to which a debit entry will be made as a result of the transaction.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationDebtorAccount $debtorAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('DebtorAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationDebtorAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticStandingOrderConsentResponse6DataInitiationDebtorAccount $debtorAccount = null;
    
    /**
     * The amount of the final Standing Order
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationFinalPaymentAmount $finalPaymentAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('FinalPaymentAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationFinalPaymentAmount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticStandingOrderConsentResponse6DataInitiationFinalPaymentAmount $finalPaymentAmount = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationFirstPaymentAmount $firstPaymentAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('FirstPaymentAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationFirstPaymentAmount')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationRecurringPaymentAmount $recurringPaymentAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('RecurringPaymentAmount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationRecurringPaymentAmount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OBWriteDomesticStandingOrderConsentResponse6DataInitiationRecurringPaymentAmount $recurringPaymentAmount = null;
	...
	{
		$this->creditorAccount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationCreditorAccount();
		$this->debtorAccount = null;
		$this->finalPaymentAmount = null;
		$this->finalPaymentDateTime = null;
		$this->firstPaymentAmount = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticStandingOrderConsentResponse6DataInitiationFirstPaymentAmount();
