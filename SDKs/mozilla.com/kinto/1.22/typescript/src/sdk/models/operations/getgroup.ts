 ...
 */
export class GetGroupErrorSchema extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code: number;
...
export class GetGroupObjectSchemaData extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "members" })
  members?: string[];
}

export class GetGroupObjectSchemaPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "read" })
  read?: string[];
 ...
 */
export class GetGroupObjectSchema extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
  @Type(() => GetGroupObjectSchemaData)
  data?: GetGroupObjectSchemaData;

  @SpeakeasyMetadata()
  @Expose({ name: "permissions" })
  @Type(() => GetGroupObjectSchemaPermissions)
