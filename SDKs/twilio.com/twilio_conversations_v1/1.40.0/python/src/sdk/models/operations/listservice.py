...
class ListServiceListServiceResponse:
    ...
    meta: Optional[ListServiceListServiceResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    services: Optional[list[shared_conversations_v1_service.ConversationsV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})  
