...
class ListQueueListQueueResponse:
    ...
    queues: Optional[list[shared_api_v2010_account_queue.APIV2010AccountQueue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('queues') }})
...
class ListQueueRequest:
    path_params: ListQueuePathParams = dataclasses.field()
    query_params: ListQueueQueryParams = dataclasses.field()
    security: ListQueueSecurity = dataclasses.field()
...
class ListQueueResponse:
    ...
    list_queue_response: Optional[ListQueueListQueueResponse] = dataclasses.field(default=None)
