...
class ListSyncListPermissionRequest:
    ...
    r"""The SID of the Sync List with the Sync List Permission resources to read. Can be the Sync List resource's `sid` or its `unique_name`."""  
    service_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ServiceSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the [Sync Service](https://www.twilio.com/docs/sync/api/service) with the Sync List Permission resources to read."""  
...
class ListSyncListPermissionListSyncListPermissionResponse:
    ...
    meta: Optional[ListSyncListPermissionListSyncListPermissionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    permissions: Optional[list[shared_sync_v1_service_sync_list_sync_list_permission.SyncV1ServiceSyncListSyncListPermission]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permissions'), 'exclude': lambda f: f is None }})  
