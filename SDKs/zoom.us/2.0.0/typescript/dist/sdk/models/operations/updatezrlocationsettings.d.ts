 ...
 */
export declare class UpdateZRLocationSettingsApplicationJson2ClientAlert extends SpeakeasyBase {
    /**
...
export declare class UpdateZRLocationSettingsApplicationJson2DigitalSignageBanner extends SpeakeasyBase {
 ...
 */
export declare class UpdateZRLocationSettingsApplicationJson2DigitalSignageDisplayPeriod extends SpeakeasyBase {
    /**
 ...
 *
 */
export declare enum UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayListActionEnum {
    Add = "add",
    Update = "update",
    Delete = "delete"
}
 ...
 * Content list.
 */
export declare class UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayListContents extends SpeakeasyBase {
    /**
...
export declare class UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayList extends SpeakeasyBase {
    /**
     * Specify an action for the content list. The value can be one of the following:<br>
     *
     * @remarks
     ...
     *
     */
    action?: UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayListActionEnum;
    contents?: UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayListContents[];
    /**
...
export declare class UpdateZRLocationSettingsApplicationJson2DigitalSignage extends SpeakeasyBase {
    banner?: UpdateZRLocationSettingsApplicationJson2DigitalSignageBanner;
    /**
     * Display period object lets you define the number of minutes before or after the scheduled meeting time you would like the content to display.
     */
    displayPeriod?: UpdateZRLocationSettingsApplicationJson2DigitalSignageDisplayPeriod;
    /**
     ...
     * Content list.
     */
    playList?: UpdateZRLocationSettingsApplicationJson2DigitalSignagePlayList[];
}
/**
 ...
 */
export declare class UpdateZRLocationSettingsApplicationJson2Notification extends SpeakeasyBase {
    /**
...
export declare class UpdateZRLocationSettingsApplicationJson2 extends SpeakeasyBase {
    /**
     * The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
     */
    clientAlert?: UpdateZRLocationSettingsApplicationJson2ClientAlert;
    digitalSignage?: UpdateZRLocationSettingsApplicationJson2DigitalSignage;
    /**
     * [Notifications Settings](https://support.zoom.us/hc/en-us/articles/205394099-Zoom-Room-Alerts#h_b430b5f2-5150-4522-9c96-c77f22ab70bc) includes the circumstances in which the room sends an email alert to the support team to notify them of a potentially urgent issue. These issues can affect the operation of the room, but do not display on the TV screen. The email alert is sent to the email address specified in the Notification Email Recipients section.
     */
    notification?: UpdateZRLocationSettingsApplicationJson2Notification;
}
/**
 ...
 */
export declare enum UpdateZRLocationSettingsApplicationJson1MeetingSecurityEncryptionTypeEnum {
    EnhancedEncryption = "enhanced_encryption",
    E2ee = "e2ee"
}
export declare class UpdateZRLocationSettingsApplicationJson1MeetingSecurity extends SpeakeasyBase {
    /**
     * Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
     *
     * @remarks
     ...
     * `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
     */
    encryptionType?: UpdateZRLocationSettingsApplicationJson1MeetingSecurityEncryptionTypeEnum;
    /**
...
export declare class UpdateZRLocationSettingsApplicationJson1ZoomRooms extends SpeakeasyBase {
    /**
...
export declare class UpdateZRLocationSettingsApplicationJson1 extends SpeakeasyBase {
    meetingSecurity?: UpdateZRLocationSettingsApplicationJson1MeetingSecurity;
    zoomRooms?: UpdateZRLocationSettingsApplicationJson1ZoomRooms;
}
