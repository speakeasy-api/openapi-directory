...
func (e *CreateStreamCreateStreamRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateStreamCreateStreamRequestStatusCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateStreamCreateStreamRequestStatusCallbackMethodEnum: %s", s)
	}
}
