...
class ListShipmentRatesResponseBodyRateRateTypeEnum(str, Enum):
    r"""The possible rate type values"""
    CHECK = 'check'
    SHIPMENT = 'shipment'

class ListShipmentRatesResponseBodyRateValidationStatusEnum(str, Enum):
...
class ListShipmentRatesResponseBodyRate:
    ...
    r"""carrier nickname"""  
    confirmation_amount: ListShipmentRatesResponseBodyRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confirmation_amount') }})
    ...
    insurance_amount: ListShipmentRatesResponseBodyRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('insurance_amount') }})
    ...
    other_amount: ListShipmentRatesResponseBodyRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('other_amount') }})
    ...
    rate_type: ListShipmentRatesResponseBodyRateRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rate_type') }})  
    ...
    r"""service type"""  
    shipping_amount: ListShipmentRatesResponseBodyRateMonetaryValue = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('shipping_amount') }})
    ...
    validation_status: ListShipmentRatesResponseBodyRateValidationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('validation_status') }})  
    ...
    r"""ship date"""  
    tax_amount: Optional[ListShipmentRatesResponseBodyRateMonetaryValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tax_amount'), 'exclude': lambda f: f is None }})
    r"""Tariff and additional taxes associated with an international shipment."""  
    
class ListShipmentRatesResponseBodyRateResponseStatusEnum(str, Enum):
...
class ListShipmentRatesResponseBody:
    ...
    invalid_rates: list[ListShipmentRatesResponseBodyRate] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invalid_rates') }})
    ...
    rates: list[ListShipmentRatesResponseBodyRate] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rates') }})
    ...
    status: ListShipmentRatesResponseBodyRateResponseStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
