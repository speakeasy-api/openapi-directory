...
class ListUserChannelListUserChannelResponse:
    channels: Optional[list[shared_ip_messaging_v2_service_user_user_channel.IPMessagingV2ServiceUserUserChannel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('channels') }})
