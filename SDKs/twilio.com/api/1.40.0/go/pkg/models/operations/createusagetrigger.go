...
func (e *CreateUsageTriggerCreateUsageTriggerRequestCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateUsageTriggerCreateUsageTriggerRequestCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateUsageTriggerCreateUsageTriggerRequestCallbackMethodEnum: %s", s)
	}
}
