...
exports.DeleteReportResponse = exports.DeleteReportRequest = void 0;
...
var DeleteReportRequest = /** @class */ (function (_super) {
    ...
    ], DeleteReportRequest.prototype, "commit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], DeleteReportRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=reportId",
        }),
        __metadata("design:type", String)
    ], DeleteReportRequest.prototype, "reportId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], DeleteReportRequest.prototype, "workspace", void 0);
