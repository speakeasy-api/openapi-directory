...
from ..shared import deviceauthorizationcode as shared_deviceauthorizationcode
...
class GenerateDeviceAuthorizationCodeRequest:
    ...
    r"""Details of the device being authorized."""  
...
class GenerateDeviceAuthorizationCodeResponse:
    ...
    device_authorization_code: Optional[shared_deviceauthorizationcode.DeviceAuthorizationCode] = dataclasses.field(default=None)
    r"""OK"""  
