...
var ExpiredCertPublicKey = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "bits" }),
...
var ExpiredCert = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "file_hash" }),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ExpiredCertPublicKey; }),
        __metadata("design:type", ExpiredCertPublicKey)
    ], ExpiredCert.prototype, "publicKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "subject_name" }),
        __metadata("design:type", String)
    ], ExpiredCert.prototype, "subjectName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "thumb_print" }),
        __metadata("design:type", String)
    ], ExpiredCert.prototype, "thumbPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "valid_from" }),
        __metadata("design:type", String)
    ], ExpiredCert.prototype, "validFrom", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "valid_to" }),
        __metadata("design:type", String)
