...
from ..shared import createbuiltinvariableresponse as shared_createbuiltinvariableresponse
...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateTypeEnum(str, Enum):
...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateRequest:
    ...
    type: Optional[list[TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateTypeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    r"""The types of built-in variables to enable."""  
...
@dataclasses.dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    create_built_in_variable_response: Optional[shared_createbuiltinvariableresponse.CreateBuiltInVariableResponse] = dataclasses.field(default=None)
