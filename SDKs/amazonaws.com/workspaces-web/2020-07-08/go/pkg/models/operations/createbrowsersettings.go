...
type CreateBrowserSettingsHeaders struct {
...
type CreateBrowserSettingsRequestBody struct {
...
type CreateBrowserSettingsRequest struct {
	Headers CreateBrowserSettingsHeaders
	Request CreateBrowserSettingsRequestBody `request:"mediaType=application/json"`
}
