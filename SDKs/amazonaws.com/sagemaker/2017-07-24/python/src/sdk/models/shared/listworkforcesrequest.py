...
import dataclasses
from ..shared import listworkforcessortbyoptions_enum as shared_listworkforcessortbyoptions_enum
...
class ListWorkforcesRequest:
    ...
    sort_by: Optional[shared_listworkforcessortbyoptions_enum.ListWorkforcesSortByOptionsEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
