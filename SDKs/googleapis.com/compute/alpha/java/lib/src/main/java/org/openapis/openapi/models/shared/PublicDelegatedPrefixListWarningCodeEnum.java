...
/**
 * PublicDelegatedPrefixListWarningCodeEnum - [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
public enum PublicDelegatedPrefixListWarningCodeEnum {
    ...
    private PublicDelegatedPrefixListWarningCodeEnum(String value) {
        this.value = value;
    }
}
