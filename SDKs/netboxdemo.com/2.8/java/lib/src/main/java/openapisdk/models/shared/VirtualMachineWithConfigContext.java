...
public class VirtualMachineWithConfigContext {
    ...
    public VirtualMachineWithConfigContext withConfigContext(java.util.Map<String, String> configContext) {
    ...
    public VirtualMachineWithConfigContext withPrimaryIp(NestedIpAddress primaryIp) {
    ...
    public VirtualMachineWithConfigContext withPrimaryIp4(NestedIpAddress primaryIp4) {
    ...
    public VirtualMachineWithConfigContext withPrimaryIp6(NestedIpAddress primaryIp6) {
    ...
    public VirtualMachineWithConfigContext withSite(NestedSite site) {
        this.site = site;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
