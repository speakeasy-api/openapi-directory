...
try {
    ...
    $request->requestBody->newOwner = 'in';
...
try {
    ...
    $request->requestBody->defaultBranch = 'impedit';
    $request->requestBody->deleteBranchOnMerge = false;
    $request->requestBody->description = 'beatae';
    $request->requestBody->hasIssues = false;
    $request->requestBody->hasProjects = false;
    $request->requestBody->hasWiki = false;
    $request->requestBody->homepage = 'incidunt';
    $request->requestBody->isTemplate = false;
    $request->requestBody->name = 'Christina Herzog V';
    $request->requestBody->private = false;
...
try {
    ...
    $request->requestBody->requiredPullRequestReviews->requiredApprovingReviewCount = 278116;
...
try {
    ...
    $request->requestBody->cname = 'aliquid';
    ...
    $request->requestBody->source->branch = 'a';
...
try {
    ...
    $request->requestBody->requiredApprovingReviewCount = 194058;
...
try {
    ...
    $request->requestBody->draft = false;
    $request->requestBody->name = 'Jerald Wilkinson';
    $request->requestBody->prerelease = false;
    $request->requestBody->tagName = 'itaque';
    $request->requestBody->targetCommitish = 'nulla';
    $request->owner = 'deserunt';
    $request->releaseId = 359097;
    $request->repo = 'velit';
...
try {
    ...
    $request->label = 'neque';
    $request->name = 'Lila Harris II';
    $request->owner = 'veniam';
    $request->releaseId = 469994;
    $request->repo = 'ad';
