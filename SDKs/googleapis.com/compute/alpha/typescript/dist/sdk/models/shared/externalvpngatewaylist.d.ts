 ...
 */
export declare enum ExternalVpnGatewayListWarningCodeEnum {
...
export declare class ExternalVpnGatewayListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ExternalVpnGatewayListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class ExternalVpnGatewayList extends SpeakeasyBase {
    etag?: string;
    /**
