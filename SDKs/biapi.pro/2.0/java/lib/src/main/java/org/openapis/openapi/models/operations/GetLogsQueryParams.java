...
public class GetLogsQueryParams {
    ...
    public GetLogsQueryParams withConnectorUuid(String connectorUuid) {
    ...
    public String error;
    public GetLogsQueryParams withError(String error) {
        this.error = error;
        return this;
    }
    ...
    public GetLogsQueryParams withExpand(String expand) {
        this.expand = expand;
        return this;
    }
    ...
    public GetLogsQueryParams withIdConnection(Long idConnection) {
    ...
    public GetLogsQueryParams withIdConnector(Long idConnector) {
    ...
    public Long idMax;
    public GetLogsQueryParams withIdMax(Long idMax) {
        this.idMax = idMax;
        return this;
    }
    ...
    public GetLogsQueryParams withIdSource(Long idSource) {
    ...
    public Long idUser;
    public GetLogsQueryParams withIdUser(Long idUser) {
        this.idUser = idUser;
        return this;
    }
    ...
    public Long limit;
    public GetLogsQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetLogsQueryParams withMaxDate(LocalDate maxDate) {
    ...
    public GetLogsQueryParams withMinDate(LocalDate minDate) {
    ...
    public Long offset;
    public GetLogsQueryParams withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GetLogsQueryParams withPeriod(String period) {
        this.period = period;
        return this;
    }
