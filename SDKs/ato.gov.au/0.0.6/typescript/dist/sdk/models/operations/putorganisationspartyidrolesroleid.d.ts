...
export declare class PutOrganisationsPartyIdRolesRoleIdRequest extends SpeakeasyBase {
    /**
     * The API key.
     */
    apiKey: string;
...
export declare class PutOrganisationsPartyIdRolesRoleIdResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
