...
class PrincipalResourcePermissions:
    r"""The permissions granted or revoked on a resource."""
    
    additional_details: Optional[shared_detailsmap.DetailsMap] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AdditionalDetails'), 'exclude': lambda f: f is None }})  
