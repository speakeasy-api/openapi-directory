...
class UpdateShareInvitationRequestBodyShareInvitationActionEnum(str, Enum):
    r"""Share invitation action taken by contributor."""
    ACCEPT = 'ACCEPT'
    REJECT = 'REJECT'
...
class UpdateShareInvitationRequestBody:
    ...
    share_invitation_action: UpdateShareInvitationRequestBodyShareInvitationActionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ShareInvitationAction') }})
    r"""Share invitation action taken by contributor."""  
...
class UpdateShareInvitationRequest:
    ...
    request_body: UpdateShareInvitationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    share_invitation_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ShareInvitationId', 'style': 'simple', 'explode': False }})
    r"""The ID assigned to the share invitation."""  
