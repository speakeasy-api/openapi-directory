...
public class GetReportTasksRequest {
    ...
    public GetReportTasksRequest withLimit(String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetReportTasksRequest withOffset(String offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GetReportTasksRequest withReportTaskStatuses(String reportTaskStatuses) {
        this.reportTaskStatuses = reportTaskStatuses;
        return this;
    }
    
    public GetReportTasksRequest(){}
}
