...
func main() {
    ...
    res, err := s.APIKeyCompanyLevel.PostCompaniesCompanyIDAPICredentialsAPICredentialIDGenerateAPIKey(ctx, operations.PostCompaniesCompanyIDAPICredentialsAPICredentialIDGenerateAPIKeyRequest{
        APICredentialID: "modi",
        CompanyID: "qui",
    }, operations.PostCompaniesCompanyIDAPICredentialsAPICredentialIDGenerateAPIKeySecurity{
