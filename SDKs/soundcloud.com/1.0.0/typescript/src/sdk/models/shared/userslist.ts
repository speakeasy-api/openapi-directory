 ...
 * product
 */
export class UsersListSubscriptions1Product extends SpeakeasyBase {
  /**
 ...
 * subscription
 */
export class UsersListSubscriptions1 extends SpeakeasyBase {
  /**
   * product
   */
  @SpeakeasyMetadata()
  @Expose({ name: "product" })
  @Type(() => UsersListSubscriptions1Product)
