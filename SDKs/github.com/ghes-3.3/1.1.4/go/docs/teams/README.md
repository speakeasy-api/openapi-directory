...
func main() {
    ...
    res, err := s.Teams.TeamsDeleteDiscussionCommentInOrg(ctx, operations.TeamsDeleteDiscussionCommentInOrgRequest{
        CommentNumber: 430235,
        DiscussionNumber: 365539,
        Org: "illum",
        TeamSlug: "nesciunt",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Teams.TeamsGetDiscussionCommentInOrg(ctx, operations.TeamsGetDiscussionCommentInOrgRequest{
        CommentNumber: 537170,
        DiscussionNumber: 122744,
        Org: "nesciunt",
        TeamSlug: "delectus",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Teams.TeamsGetDiscussionCommentLegacy(ctx, operations.TeamsGetDiscussionCommentLegacyRequest{
        CommentNumber: 673653,
        DiscussionNumber: 303421,
        TeamID: 644223,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListChildInOrg(ctx, operations.TeamsListChildInOrgRequest{
        Org: "optio",
        Page: sdk.Int64(750537),
        PerPage: sdk.Int64(404422),
        TeamSlug: "repellat",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListChildLegacy(ctx, operations.TeamsListChildLegacyRequest{
        Page: sdk.Int64(65118),
        PerPage: sdk.Int64(533978),
        TeamID: 711615,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListDiscussionCommentsInOrg(ctx, operations.TeamsListDiscussionCommentsInOrgRequest{
        ...
        DiscussionNumber: 569834,
        Org: "aliquid",
        Page: sdk.Int64(151385),
        PerPage: sdk.Int64(106682),
        TeamSlug: "similique",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListDiscussionCommentsLegacy(ctx, operations.TeamsListDiscussionCommentsLegacyRequest{
        ...
        DiscussionNumber: 657301,
        Page: sdk.Int64(296128),
        PerPage: sdk.Int64(945419),
        TeamID: 493407,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListDiscussionsInOrg(ctx, operations.TeamsListDiscussionsInOrgRequest{
        Direction: shared.DirectionEnumAsc.ToPointer(),
        Org: "animi",
        Page: sdk.Int64(512488),
        PerPage: sdk.Int64(461050),
        Pinned: sdk.String("eveniet"),
        TeamSlug: "earum",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListDiscussionsLegacy(ctx, operations.TeamsListDiscussionsLegacyRequest{
        Direction: shared.DirectionEnumAsc.ToPointer(),
        Page: sdk.Int64(884765),
        PerPage: sdk.Int64(263346),
        TeamID: 701978,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListMembersInOrg(ctx, operations.TeamsListMembersInOrgRequest{
        Org: "ipsam",
        Page: sdk.Int64(131687),
        PerPage: sdk.Int64(771632),
        Role: operations.TeamsListMembersInOrgRoleEnumMaintainer.ToPointer(),
        TeamSlug: "quis",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListMembersLegacy(ctx, operations.TeamsListMembersLegacyRequest{
        Page: sdk.Int64(704402),
        PerPage: sdk.Int64(218128),
...
func main() {
    ...
    res, err := s.Teams.TeamsListProjectsInOrg(ctx, operations.TeamsListProjectsInOrgRequest{
        Org: "architecto",
        Page: sdk.Int64(506966),
        PerPage: sdk.Int64(907899),
        TeamSlug: "dolor",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsListReposLegacy(ctx, operations.TeamsListReposLegacyRequest{
        Page: sdk.Int64(576657),
        PerPage: sdk.Int64(483459),
        TeamID: 315671,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsUpdateDiscussionCommentInOrg(ctx, operations.TeamsUpdateDiscussionCommentInOrgRequest{
        ...
        CommentNumber: 196451,
        DiscussionNumber: 785555,
        Org: "laborum",
        TeamSlug: "nobis",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Teams.TeamsUpdateDiscussionCommentLegacy(ctx, operations.TeamsUpdateDiscussionCommentLegacyRequest{
        ...
        CommentNumber: 607624,
        DiscussionNumber: 16252,
        TeamID: 369941,
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Teams.TeamsUpdateDiscussionInOrg(ctx, operations.TeamsUpdateDiscussionInOrgRequest{
        RequestBody: &operations.TeamsUpdateDiscussionInOrgRequestBody{
            Body: sdk.String("officia"),
            Title: sdk.String("Ms."),
        },
        DiscussionNumber: 442873,
        Org: "quia",
...
func main() {
    ...
    res, err := s.Teams.TeamsUpdateInOrg(ctx, operations.TeamsUpdateInOrgRequest{
        RequestBody: &operations.TeamsUpdateInOrgRequestBody{
            ...
            Name: sdk.String("Aaron Connelly"),
            ParentTeamID: sdk.Int64(176935),
            Permission: operations.TeamsUpdateInOrgRequestBodyPermissionEnumAdmin.ToPointer(),
