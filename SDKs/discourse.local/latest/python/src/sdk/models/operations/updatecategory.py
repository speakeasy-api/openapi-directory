...
class UpdateCategoryRequest:
    ...
    request_body: Optional[UpdateCategoryRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateCategory200ApplicationJSONCategoryGroupPermissions:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateCategory200ApplicationJSONCategoryRequiredTagGroups:
...
class UpdateCategory200ApplicationJSONCategory:
    ...
    form_template_ids: list[Any] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('form_template_ids') }})  
    group_permissions: list[UpdateCategory200ApplicationJSONCategoryGroupPermissions] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('group_permissions') }})  
    ...
    required_tag_groups: list[UpdateCategory200ApplicationJSONCategoryRequiredTagGroups] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('required_tag_groups') }})  
...
class UpdateCategory200ApplicationJSON:
    ...
    category: UpdateCategory200ApplicationJSONCategory = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category') }})  
...
class UpdateCategoryResponse:
    ...
    update_category_200_application_json_object: Optional[UpdateCategory200ApplicationJSON] = dataclasses.field(default=None)
    r"""success response"""  
