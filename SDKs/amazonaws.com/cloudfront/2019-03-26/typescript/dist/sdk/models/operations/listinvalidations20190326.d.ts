...
export declare class ListInvalidations20190326Request extends SpeakeasyBase {
    /**
...
export declare class ListInvalidations20190326Response extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
