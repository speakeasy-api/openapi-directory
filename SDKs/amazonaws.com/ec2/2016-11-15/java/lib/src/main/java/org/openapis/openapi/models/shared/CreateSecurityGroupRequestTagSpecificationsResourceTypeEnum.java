 ...
 */
public enum CreateSecurityGroupRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateSecurityGroupRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
