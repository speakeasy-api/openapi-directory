...
exports.AdsenseAccountsListResponse = exports.AdsenseAccountsListRequest = exports.AdsenseAccountsListSecurity = exports.AdsenseAccountsListSecurityOption2 = exports.AdsenseAccountsListSecurityOption1 = void 0;
...
exports.AdsenseAccountsListSecurityOption1 = AdsenseAccountsListSecurityOption1;
...
exports.AdsenseAccountsListSecurityOption2 = AdsenseAccountsListSecurityOption2;
...
exports.AdsenseAccountsListSecurity = AdsenseAccountsListSecurity;
var AdsenseAccountsListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdsenseAccountsListRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsListRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsenseAccountsListRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=maxResults",
        }),
        __metadata("design:type", Number)
    ], AdsenseAccountsListRequest.prototype, "maxResults", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsListRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageToken",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsListRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsenseAccountsListRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsListRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsenseAccountsListRequest.prototype, "userIp", void 0);
    return AdsenseAccountsListRequest;
}(utils_1.SpeakeasyBase));
exports.AdsenseAccountsListRequest = AdsenseAccountsListRequest;
var AdsenseAccountsListResponse = /** @class */ (function (_super) {
    ...
    ], AdsenseAccountsListResponse.prototype, "rawResponse", void 0);
    return AdsenseAccountsListResponse;
}(utils_1.SpeakeasyBase));
exports.AdsenseAccountsListResponse = AdsenseAccountsListResponse;
