...
class ListSipAuthCallsCredentialListMappingRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the CredentialListMapping resources to read."""  
...
class ListSipAuthCallsCredentialListMappingListSipAuthCallsCredentialListMappingResponse:
    ...
    contents: Optional[list[shared_api_v2010_account_sip_sip_domain_sip_auth_sip_auth_calls_sip_auth_calls_credential_list_mapping.APIV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contents'), 'exclude': lambda f: f is None }})  
...
class ListSipAuthCallsCredentialListMappingResponse:
    ...
    list_sip_auth_calls_credential_list_mapping_response: Optional[ListSipAuthCallsCredentialListMappingListSipAuthCallsCredentialListMappingResponse] = dataclasses.field(default=None)
    r"""OK"""  
