...
exports.ActivitiesAddResponse = exports.ActivitiesAddRequest = exports.ActivitiesAddSecurity = void 0;
...
exports.ActivitiesAddSecurity = ActivitiesAddSecurity;
var ActivitiesAddRequest = /** @class */ (function (_super) {
    ...
    ], ActivitiesAddRequest.prototype, "activityInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], ActivitiesAddRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], ActivitiesAddRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], ActivitiesAddRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], ActivitiesAddRequest.prototype, "xApideckServiceId", void 0);
    return ActivitiesAddRequest;
}(utils_1.SpeakeasyBase));
exports.ActivitiesAddRequest = ActivitiesAddRequest;
var ActivitiesAddResponse = /** @class */ (function (_super) {
    ...
    ], ActivitiesAddResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.ActivitiesAddResponse = ActivitiesAddResponse;
