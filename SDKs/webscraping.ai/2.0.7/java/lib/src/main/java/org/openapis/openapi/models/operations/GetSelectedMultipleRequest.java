...
public class GetSelectedMultipleRequest {
    /**
    ...
    public GetSelectedMultipleRequest withCountry(org.openapis.openapi.models.shared.CountryEnum country) {
    ...
    public GetSelectedMultipleRequest withDevice(org.openapis.openapi.models.shared.DeviceEnum device) {
        this.device = device;
        return this;
    }
    ...
    public GetSelectedMultipleRequest withErrorOn404(Boolean errorOn404) {
    ...
    public GetSelectedMultipleRequest withErrorOnRedirect(Boolean errorOnRedirect) {
    ...
    public GetSelectedMultipleRequest withHeaders(java.util.Map<String, String> headers) {
    ...
    public Boolean js;
    public GetSelectedMultipleRequest withJs(Boolean js) {
        this.js = js;
        return this;
    }
    ...
    public GetSelectedMultipleRequest withJsTimeout(Long jsTimeout) {
    ...
    public GetSelectedMultipleRequest withProxy(org.openapis.openapi.models.shared.ProxyEnum proxy) {
        this.proxy = proxy;
        return this;
    }
    ...
    public GetSelectedMultipleRequest withSelectors(String[] selectors) {
    ...
    public Long timeout;
    public GetSelectedMultipleRequest withTimeout(Long timeout) {
    ...
    public String url;
    public GetSelectedMultipleRequest withUrl(String url) {
        this.url = url;
        return this;
    }
