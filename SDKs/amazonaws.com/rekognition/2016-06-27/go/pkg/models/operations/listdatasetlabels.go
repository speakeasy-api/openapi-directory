...
type ListDatasetLabelsQueryParams struct {
	// Pagination limit
...
type ListDatasetLabelsHeaders struct {
...
type ListDatasetLabelsRequest struct {
	QueryParams ListDatasetLabelsQueryParams
	Headers     ListDatasetLabelsHeaders
	Request     shared.ListDatasetLabelsRequest `request:"mediaType=application/json"`
}
