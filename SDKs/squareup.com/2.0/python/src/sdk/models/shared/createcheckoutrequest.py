...
from ..shared import chargerequestadditionalrecipient as shared_chargerequestadditionalrecipient
from ..shared import createorderrequest as shared_createorderrequest
...
class CreateCheckoutRequest:
    ...
    r"""A unique string that identifies this checkout among others you have created. It can be
    ...
    """  
    order: shared_createorderrequest.CreateOrderRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('order') }})  
    additional_recipients: Optional[list[shared_chargerequestadditionalrecipient.ChargeRequestAdditionalRecipient]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additional_recipients'), 'exclude': lambda f: f is None }})
    r"""The basic primitive of a multi-party transaction. The value is optional.
    ...
    r"""If `true`, Square Checkout collects shipping information on your behalf and stores
    ...
    r"""An optional note to associate with the `checkout` object.
    ...
    r"""If provided, the buyer's email is prepopulated on the checkout page
    ...
    r"""The URL to redirect to after the checkout is completed with `checkoutId`,
