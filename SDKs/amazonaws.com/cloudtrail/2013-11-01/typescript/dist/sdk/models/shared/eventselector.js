...
var EventSelector = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: dataresource_1.DataResource }),
        (0, class_transformer_1.Expose)({ name: "DataResources" }),
        (0, class_transformer_1.Type)(function () { return dataresource_1.DataResource; }),
        __metadata("design:type", Array)
    ], EventSelector.prototype, "dataResources", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ExcludeManagementEventSources" }),
        __metadata("design:type", Array)
    ], EventSelector.prototype, "excludeManagementEventSources", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "IncludeManagementEvents" }),
        __metadata("design:type", Boolean)
    ], EventSelector.prototype, "includeManagementEvents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ReadWriteType" }),
