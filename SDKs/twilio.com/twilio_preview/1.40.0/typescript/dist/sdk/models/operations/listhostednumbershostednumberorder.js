...
exports.ListHostedNumbersHostedNumberOrderResponse = exports.ListHostedNumbersHostedNumberOrderListHostedNumbersHostedNumberOrderResponse = exports.ListHostedNumbersHostedNumberOrderListHostedNumbersHostedNumberOrderResponseMeta = exports.ListHostedNumbersHostedNumberOrderRequest = exports.ListHostedNumbersHostedNumberOrderSecurity = exports.ListHostedNumbersHostedNumberOrderServerList = void 0;
...
var ListHostedNumbersHostedNumberOrderSecurity = /** @class */ (function (_super) {
    ...
    ], ListHostedNumbersHostedNumberOrderSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersHostedNumberOrderSecurity.prototype, "username", void 0);
...
var ListHostedNumbersHostedNumberOrderRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IncomingPhoneNumberSid",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "incomingPhoneNumberSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PhoneNumber",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "phoneNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=UniqueName",
        }),
        __metadata("design:type", String)
    ], ListHostedNumbersHostedNumberOrderRequest.prototype, "uniqueName", void 0);
...
var ListHostedNumbersHostedNumberOrderListHostedNumbersHostedNumberOrderResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewHostedNumbersHostedNumberOrder }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewHostedNumbersHostedNumberOrder; }),
...
var ListHostedNumbersHostedNumberOrderResponse = /** @class */ (function (_super) {
    ...
    ], ListHostedNumbersHostedNumberOrderResponse.prototype, "rawResponse", void 0);
