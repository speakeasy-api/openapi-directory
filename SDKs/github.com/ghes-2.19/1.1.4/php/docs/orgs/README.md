...
try {
    ...
    $request->org = 'in';
    $request->username = 'Elenor_Haag35';
...
try {
    ...
    $request->username = 'Myron_Kuvalis';
...
try {
    ...
    $request->requestBody->name = 'Miss Jorge Rolfson';
...
try {
    ...
    $request->username = 'Viviane_Aufderhar';
...
try {
    ...
    $request->requestBody->billingEmail = 'nostrum';
    $request->requestBody->blog = '"http://github.blog"';
    $request->requestBody->company = 'Padberg - Lowe';
    ...
    $request->requestBody->email = 'Caleigh.Grady63@yahoo.com';
    $request->requestBody->hasOrganizationProjects = false;
    $request->requestBody->hasRepositoryProjects = false;
    $request->requestBody->location = 'expedita';
    $request->requestBody->membersAllowedRepositoryCreationType = OrgsUpdateRequestBodyMembersAllowedRepositoryCreationTypeEnum::ALL;
    ...
    $request->requestBody->name = 'Ms. Georgia Hintz';
    $request->requestBody->twitterUsername = 'repudiandae';
...
try {
    ...
    $request->requestBody->config->contentType = '"json"';
    $request->requestBody->config->insecureSsl = 4059.42;
    $request->requestBody->config->secret = '"********"';
    $request->requestBody->config->url = 'https://example.com/webhook';
    $request->requestBody->events = [
        'sit',
