...
class ExecuteBuyTrasactionBuyTransactionRequest:
    r"""Definition of an buy transaction request"""
    
    investment_instructions: list[ExecuteBuyTrasactionBuyTransactionRequestInstructionBuySell] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('investment_instructions') }})  
...
class ExecuteBuyTrasactionRequest:
    ...
    r"""ApiSecretKey"""  
    request_body: Optional[ExecuteBuyTrasactionBuyTransactionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ExecuteBuyTrasaction429ApplicationJSON:
...
class ExecuteBuyTrasaction409ApplicationJSONStatusEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ExecuteBuyTrasaction409ApplicationJSON:
    r"""Duplicate request"""
    
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})
    r"""Human readable description of the error"""  
    status: ExecuteBuyTrasaction409ApplicationJSONStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Current status of the original request"""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ExecuteBuyTrasaction403ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ExecuteBuyTrasaction400ApplicationJSON:
...
class ExecuteBuyTrasaction200ApplicationJSONStatusEnum(str, Enum):
...
class ExecuteBuyTrasaction200ApplicationJSONTransactionsDirectionEnum(str, Enum):
    r"""in = cash payment or pending buy transaction, out= cash out or pending sell transaction."""
    IN = 'in'
    OUT = 'out'

class ExecuteBuyTrasaction200ApplicationJSONTransactionsOriginEnum(str, Enum):
...
class ExecuteBuyTrasaction200ApplicationJSONTransactionsPrimaryTransactionTypeEnum(str, Enum):
    FEES = 'Fees'
    BUY = 'Buy'
    SELL = 'Sell'
    TRANSFERS = 'Transfers'
...
class ExecuteBuyTrasaction200ApplicationJSONTransactionsStatusEnum(str, Enum):
    SUBMITTED = 'submitted'
    FAILED = 'failed'

class ExecuteBuyTrasaction200ApplicationJSONTransactionsSubTransactionTypeEnum(str, Enum):
...
class ExecuteBuyTrasaction200ApplicationJSONTransactionsSubTypeEnum(str, Enum):
...
class ExecuteBuyTrasaction200ApplicationJSONTransactionsTypeEnum(str, Enum):
...
class ExecuteBuyTrasaction200ApplicationJSONTransactions:
    ...
    direction: ExecuteBuyTrasaction200ApplicationJSONTransactionsDirectionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('direction') }})
    r"""in = cash payment or pending buy transaction, out= cash out or pending sell transaction."""  
    investment_product_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('investment_product_id') }})
    r"""Investment product id of the transaction. Will be 'cash' for cash transaction"""  
    origin: ExecuteBuyTrasaction200ApplicationJSONTransactionsOriginEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin') }})
    r"""Origin of the transaction"""  
    primary_transaction_type: ExecuteBuyTrasaction200ApplicationJSONTransactionsPrimaryTransactionTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_transaction_type') }})  
    status: ExecuteBuyTrasaction200ApplicationJSONTransactionsStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
    sub_transaction_type: ExecuteBuyTrasaction200ApplicationJSONTransactionsSubTransactionTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sub_transaction_type') }})
    r"""Sub transaction type"""  
    sub_type: ExecuteBuyTrasaction200ApplicationJSONTransactionsSubTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sub_type') }})
    r"""Sub state of the transaction. instructed, confirmed, priced and scheduled sub_types are applicable for pending state and rejected, cancelled, settled sub_types applicable for archived state"""  
    ...
    type: ExecuteBuyTrasaction200ApplicationJSONTransactionsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""State of the transaction"""  
...
class ExecuteBuyTrasaction200ApplicationJSON:
    ...
    pot_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pot_id') }})  
    status: ExecuteBuyTrasaction200ApplicationJSONStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""status of the transaction request
    . `submitted`: All requested transactions submitted
    . `partially_submitted`: Some (but not all) requested transactions submitted
    """  
    ...
    transactions: Optional[list[ExecuteBuyTrasaction200ApplicationJSONTransactions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transactions'), 'exclude': lambda f: f is None }})  
...
class ExecuteBuyTrasactionResponse:
    ...
    execute_buy_trasaction_200_application_json_object: Optional[ExecuteBuyTrasaction200ApplicationJSON] = dataclasses.field(default=None)
    r"""success"""  
    execute_buy_trasaction_400_application_json_object: Optional[ExecuteBuyTrasaction400ApplicationJSON] = dataclasses.field(default=None)
    r"""Request is not complete and may have one or more validations errors. Please check the error message and the code"""  
    execute_buy_trasaction_401_application_json_object: Optional[ExecuteBuyTrasaction401ApplicationJSON] = dataclasses.field(default=None)
    r"""You do not have permissions to access this resource."""  
    execute_buy_trasaction_403_application_json_object: Optional[ExecuteBuyTrasaction403ApplicationJSON] = dataclasses.field(default=None)
    r"""Your authentication information is missing or invalid. Please check the keys are properly set and its correct"""  
    execute_buy_trasaction_404_application_json_object: Optional[ExecuteBuyTrasaction404ApplicationJSON] = dataclasses.field(default=None)
    r"""The specified resource was not found"""  
    execute_buy_trasaction_409_application_json_object: Optional[ExecuteBuyTrasaction409ApplicationJSON] = dataclasses.field(default=None)
    r"""Duplicate request"""  
    execute_buy_trasaction_429_application_json_object: Optional[ExecuteBuyTrasaction429ApplicationJSON] = dataclasses.field(default=None)
    r"""You have sent too many requests to the system. Please retry later. If you need to increase your throtteling limits, please contact WOS support"""  
    execute_buy_trasaction_500_application_json_object: Optional[ExecuteBuyTrasaction500ApplicationJSON] = dataclasses.field(default=None)
    r"""System error. Retry later. If the error persist, contact WOS support"""  
