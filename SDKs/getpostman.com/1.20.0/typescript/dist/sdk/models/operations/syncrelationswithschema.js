...
exports.SyncRelationsWithSchemaResponse = exports.SyncRelationsWithSchema200ApplicationJSON = exports.SyncRelationsWithSchema400ApplicationJSON = exports.SyncRelationsWithSchema400ApplicationJSONError = exports.SyncRelationsWithSchemaRequest = void 0;
...
var SyncRelationsWithSchemaRequest = /** @class */ (function (_super) {
    ...
    ], SyncRelationsWithSchemaRequest.prototype, "apiId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=apiVersionId",
        }),
        __metadata("design:type", String)
    ], SyncRelationsWithSchemaRequest.prototype, "apiVersionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=entityId",
        }),
        __metadata("design:type", String)
    ], SyncRelationsWithSchemaRequest.prototype, "entityId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=entityType",
        }),
        __metadata("design:type", String)
    ], SyncRelationsWithSchemaRequest.prototype, "entityType", void 0);
...
var SyncRelationsWithSchema400ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return SyncRelationsWithSchema400ApplicationJSONError; }),
...
var SyncRelationsWithSchemaResponse = /** @class */ (function (_super) {
    ...
    ], SyncRelationsWithSchemaResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
