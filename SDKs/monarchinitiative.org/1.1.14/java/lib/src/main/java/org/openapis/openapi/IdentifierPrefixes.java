...
public class IdentifierPrefixes {
    ...
    public org.openapis.openapi.models.operations.GetPrefixCollectionResponse getPrefixCollection() throws Exception {
        ...
        org.openapis.openapi.models.operations.GetPrefixCollectionResponse res = new org.openapis.openapi.models.operations.GetPrefixCollectionResponse() {{
        }};
    ...
    public org.openapis.openapi.models.operations.GetPrefixContractResponse getPrefixContract(org.openapis.openapi.models.operations.GetPrefixContractRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetPrefixContractResponse res = new org.openapis.openapi.models.operations.GetPrefixContractResponse() {{
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        res.rawResponse = httpRes;
    ...
    public org.openapis.openapi.models.operations.GetPrefixExpandResponse getPrefixExpand(org.openapis.openapi.models.operations.GetPrefixExpandRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetPrefixExpandResponse res = new org.openapis.openapi.models.operations.GetPrefixExpandResponse() {{
        }};
        res.statusCode = httpRes.statusCode();
        res.contentType = contentType;
        res.rawResponse = httpRes;
