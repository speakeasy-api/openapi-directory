...
class GoalMetricRequestProgressSourceEnum(str, Enum):
...
class GoalMetricRequestInput:
    ...
    """  
    progress_source: Optional[GoalMetricRequestProgressSourceEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('progress_source'), 'exclude': lambda f: f is None }})
    r"""This field defines how the progress value of a goal metric is being calculated. A goal's progress can be provided manually by the user, calculated automatically from contributing subgoals or projects, or managed by an integration with an external data source, such as Salesforce."""  
    ...
    unit: Optional[GoalMetricRequestUnitEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('unit'), 'exclude': lambda f: f is None }})
    r"""A supported unit of measure for the goal metric, or none."""  
