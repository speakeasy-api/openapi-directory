...
class ClientTLSPolicy:
    ...
    client_certificate: Optional[shared_googlecloudnetworksecurityv1beta1certificateprovider.GoogleCloudNetworksecurityV1beta1CertificateProvider] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('clientCertificate'), 'exclude': lambda f: f is None }})
