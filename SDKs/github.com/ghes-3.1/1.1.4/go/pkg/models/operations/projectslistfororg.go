...
func (e ProjectsListForOrgStateEnum) ToPointer() *ProjectsListForOrgStateEnum {
	return &e
}
...
func (e *ProjectsListForOrgStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "closed":
		fallthrough
	case "all":
		*e = ProjectsListForOrgStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ProjectsListForOrgStateEnum: %v", v)
	}
}
