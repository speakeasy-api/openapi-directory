...
type GetDataQualityRulesetHeaders struct {
...
type GetDataQualityRulesetRequest struct {
	Headers GetDataQualityRulesetHeaders
	Request shared.GetDataQualityRulesetRequest `request:"mediaType=application/json"`
}
