...
from ..shared import obwritedomestic2 as shared_obwritedomestic2
...
class CreateDomesticPaymentsRequests:
    ...
    ob_write_domestic2: Optional[shared_obwritedomestic2.ObWriteDomestic2] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    ob_write_domestic3: Optional[shared_obwritedomestic2.ObWriteDomestic2] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateDomesticPaymentsRequest:
    headers: CreateDomesticPaymentsHeaders = dataclasses.field()
    request: CreateDomesticPaymentsRequests = dataclasses.field()
    security: CreateDomesticPaymentsSecurity = dataclasses.field()
