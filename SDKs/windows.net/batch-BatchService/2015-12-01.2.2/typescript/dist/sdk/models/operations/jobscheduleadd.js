...
exports.JobScheduleAddResponse = exports.JobScheduleAddRequest = void 0;
...
var JobScheduleAddRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", shared.JobScheduleAddParameter)
    ], JobScheduleAddRequest.prototype, "jobScheduleAddParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=api-version",
        }),
        __metadata("design:type", String)
    ], JobScheduleAddRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=client-request-id",
        }),
        __metadata("design:type", String)
    ], JobScheduleAddRequest.prototype, "clientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=ocp-date",
        }),
        __metadata("design:type", String)
    ], JobScheduleAddRequest.prototype, "ocpDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=return-client-request-id",
        }),
        __metadata("design:type", Boolean)
    ], JobScheduleAddRequest.prototype, "returnClientRequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeout",
        }),
        __metadata("design:type", Number)
    ], JobScheduleAddRequest.prototype, "timeout", void 0);
...
var JobScheduleAddResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], JobScheduleAddResponse.prototype, "rawResponse", void 0);
