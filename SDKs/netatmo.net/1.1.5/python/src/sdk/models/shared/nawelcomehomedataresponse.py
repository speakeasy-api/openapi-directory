...
import dataclasses
from ..shared import nawelcomehomedata as shared_nawelcomehomedata
...
class NAWelcomeHomeDataResponse:
    ...
    body: Optional[shared_nawelcomehomedata.NAWelcomeHomeData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('body'), 'exclude': lambda f: f is None }})  
