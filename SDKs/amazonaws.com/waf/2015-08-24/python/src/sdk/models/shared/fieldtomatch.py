...
from ..shared import matchfieldtype_enum as shared_matchfieldtype_enum
...
class FieldToMatch:
    ...
    type: shared_matchfieldtype_enum.MatchFieldTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Type') }})
