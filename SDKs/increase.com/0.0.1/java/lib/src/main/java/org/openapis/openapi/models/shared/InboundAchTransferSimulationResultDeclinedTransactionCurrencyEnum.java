 ...
 */
public enum InboundAchTransferSimulationResultDeclinedTransactionCurrencyEnum {
    CAD("CAD"),
    CHF("CHF"),
    EUR("EUR"),
    GBP("GBP"),
    ...
    private InboundAchTransferSimulationResultDeclinedTransactionCurrencyEnum(String value) {
        this.value = value;
    }
}
