...
from ..shared import deletemodifiergroupresponse as shared_deletemodifiergroupresponse
...
class ModifierGroupsDeleteRequest:
    headers: ModifierGroupsDeleteHeaders = dataclasses.field()
    path_params: ModifierGroupsDeletePathParams = dataclasses.field()
    query_params: ModifierGroupsDeleteQueryParams = dataclasses.field()
    security: ModifierGroupsDeleteSecurity = dataclasses.field()
...
class ModifierGroupsDeleteResponse:
    ...
    delete_modifier_group_response: Optional[shared_deletemodifiergroupresponse.DeleteModifierGroupResponse] = dataclasses.field(default=None)
