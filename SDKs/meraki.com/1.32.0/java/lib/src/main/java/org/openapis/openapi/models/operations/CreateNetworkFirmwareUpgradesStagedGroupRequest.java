...
public class CreateNetworkFirmwareUpgradesStagedGroupRequest {
    ...
    public CreateNetworkFirmwareUpgradesStagedGroupRequest(@JsonProperty("RequestBody") CreateNetworkFirmwareUpgradesStagedGroupRequestBody requestBody, @JsonProperty("networkId") String networkId) {
        this.requestBody = requestBody;
        this.networkId = networkId;
  }
}
