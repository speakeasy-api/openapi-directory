...
export declare class Rooms {
     ...
     */
    addARoom(req: operations.AddARoomApplicationJSON, security: operations.AddARoomSecurity, config?: AxiosRequestConfig): Promise<operations.AddARoomResponse>;
    /**
     ...
     */
    changeZRLocation(req: operations.ChangeZRLocationRequest, security: operations.ChangeZRLocationSecurity, config?: AxiosRequestConfig): Promise<operations.ChangeZRLocationResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Light`
     */
    deleteAZoomRoom(req: operations.DeleteAZoomRoomRequest, security: operations.DeleteAZoomRoomSecurity, config?: AxiosRequestConfig): Promise<operations.DeleteAZoomRoomResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`
     */
    getZRProfile(req: operations.GetZRProfileRequest, security: operations.GetZRProfileSecurity, config?: AxiosRequestConfig): Promise<operations.GetZRProfileResponse>;
    /**
     ...
     */
    getZRSettings(req: operations.GetZRSettingsRequest, security: operations.GetZRSettingsSecurity, config?: AxiosRequestConfig): Promise<operations.GetZRSettingsResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`
     */
    listZRDevices(req: operations.ListZRDevicesRequest, security: operations.ListZRDevicesSecurity, config?: AxiosRequestConfig): Promise<operations.ListZRDevicesResponse>;
    /**
     * List Zoom Rooms
     *
     * @remarks
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`
     */
    listZoomRooms(req: operations.ListZoomRoomsRequest, security: operations.ListZoomRoomsSecurity, config?: AxiosRequestConfig): Promise<operations.ListZoomRoomsResponse>;
    /**
     ...
     *
     */
    manageE911signage(req: any, config?: AxiosRequestConfig): Promise<operations.ManageE911signageResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`
     */
    updateRoomProfile(req: operations.UpdateRoomProfileRequest, security: operations.UpdateRoomProfileSecurity, config?: AxiosRequestConfig): Promise<operations.UpdateRoomProfileResponse>;
    /**
     ...
     *  **[Rate Limit Label](https://marketplace.zoom.us/docs/api-reference/rate-limits#rate-limits):** `Medium`
     */
    updateZRSettings(req: operations.UpdateZRSettingsRequest, security: operations.UpdateZRSettingsSecurity, config?: AxiosRequestConfig): Promise<operations.UpdateZRSettingsResponse>;
}
