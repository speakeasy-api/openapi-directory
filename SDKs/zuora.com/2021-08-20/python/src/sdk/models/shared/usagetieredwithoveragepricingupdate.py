...
class UsageTieredWithOveragePricingUpdatePriceChangeOptionEnum(str, Enum):
    NO_CHANGE = "NoChange"
...
class UsageTieredWithOveragePricingUpdate:
    ...
    price_change_option: Optional[UsageTieredWithOveragePricingUpdatePriceChangeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceChangeOption') }})
