...
use \OpenAPI\OpenAPI\Models\Operations\CreateCustomPolicyRequest;
use \OpenAPI\OpenAPI\Models\Shared\CustomPolicyCreateRequest;
use \OpenAPI\OpenAPI\Models\Operations\CreateCustomPolicySecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new CreateCustomPolicyRequest();
    $request->customPolicyCreateRequest = new CustomPolicyCreateRequest();
    $request->customPolicyCreateRequest->description = 'unde';
    $request->customPolicyCreateRequest->label = 'nulla';
    $request->customPolicyCreateRequest->name = 'Dallas Kassulke';
    $request->customPolicyCreateRequest->policyType = 'suscipit';
    $request->xEbayCMarketplaceId = 'iure';

    $requestSecurity = new CreateCustomPolicySecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->customPolicy->createCustomPolicy($request, $requestSecurity);

    if ($response->createCustomPolicy201ApplicationJSONObject !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\GetCustomPoliciesRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetCustomPoliciesSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetCustomPoliciesRequest();
    $request->xEbayCMarketplaceId = 'magnam';
    $request->policyTypes = 'debitis';

    $requestSecurity = new GetCustomPoliciesSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->customPolicy->getCustomPolicies($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\GetCustomPolicyRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetCustomPolicySecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetCustomPolicyRequest();
    $request->xEbayCMarketplaceId = 'ipsa';
    $request->customPolicyId = 'delectus';

    $requestSecurity = new GetCustomPolicySecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->customPolicy->getCustomPolicy($request, $requestSecurity);

    if ($response->customPolicy !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCustomPolicyRequest;
use \OpenAPI\OpenAPI\Models\Shared\CustomPolicyRequest;
use \OpenAPI\OpenAPI\Models\Operations\UpdateCustomPolicySecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new UpdateCustomPolicyRequest();
    $request->customPolicyRequest = new CustomPolicyRequest();
    $request->customPolicyRequest->description = 'tempora';
    $request->customPolicyRequest->label = 'suscipit';
    $request->customPolicyRequest->name = 'Alexandra Schulist';
    $request->xEbayCMarketplaceId = 'excepturi';
    $request->customPolicyId = 'nisi';

    $requestSecurity = new UpdateCustomPolicySecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->customPolicy->updateCustomPolicy($request, $requestSecurity);
