...
public class SchemaResponseActionReadRequest {
    ...
    public SchemaResponseActionReadRequest withSchemaResponseId(String schemaResponseId) {
        this.schemaResponseId = schemaResponseId;
        return this;
    }
    
    public SchemaResponseActionReadRequest(@JsonProperty("schema_response_id") String schemaResponseId) {
        this.schemaResponseId = schemaResponseId;
  }
}
