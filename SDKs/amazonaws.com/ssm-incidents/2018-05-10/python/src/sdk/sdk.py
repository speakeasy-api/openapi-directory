...
SERVERS = [
    ...
    r"""The SSM Incidents multi-region endpoint"""
    "https://ssm-incidents.{region}.amazonaws.com",
    r"""The SSM Incidents multi-region endpoint"""
    "http://ssm-incidents.{region}.amazonaws.com.cn",
    r"""The SSM Incidents endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def create_replication_set(self, request: operations.CreateReplicationSetRequest) -> operations.CreateReplicationSetResponse:
        ...
        res = operations.CreateReplicationSetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateReplicationSetOutput])
    ...
    def create_response_plan(self, request: operations.CreateResponsePlanRequest) -> operations.CreateResponsePlanResponse:
        ...
        res = operations.CreateResponsePlanResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateResponsePlanOutput])
    ...
    def create_timeline_event(self, request: operations.CreateTimelineEventRequest) -> operations.CreateTimelineEventResponse:
        r"""Creates a custom timeline event on the incident details page of an incident record. Incident Manager automatically creates timeline events that mark key moments during an incident. You can create custom timeline events to mark important events that Incident Manager can detect automatically."""
        base_url = self._server_url
        ...
        res = operations.CreateTimelineEventResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateTimelineEventOutput])
    ...
    def delete_incident_record(self, request: operations.DeleteIncidentRecordRequest) -> operations.DeleteIncidentRecordResponse:
        ...
        res = operations.DeleteIncidentRecordResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_replication_set(self, request: operations.DeleteReplicationSetRequest) -> operations.DeleteReplicationSetResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.DeleteReplicationSetRequest, request)
        ...
        res = operations.DeleteReplicationSetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_resource_policy(self, request: operations.DeleteResourcePolicyRequest) -> operations.DeleteResourcePolicyResponse:
        r"""Deletes the resource policy that Resource Access Manager uses to share your Incident Manager resource."""
        base_url = self._server_url
    ...
    def delete_response_plan(self, request: operations.DeleteResponsePlanRequest) -> operations.DeleteResponsePlanResponse:
        ...
        res = operations.DeleteResponsePlanResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_timeline_event(self, request: operations.DeleteTimelineEventRequest) -> operations.DeleteTimelineEventResponse:
        ...
        res = operations.DeleteTimelineEventResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_incident_record(self, request: operations.GetIncidentRecordRequest) -> operations.GetIncidentRecordResponse:
        r"""Returns the details for the specified incident record."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/getIncidentRecord#arn'
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GetIncidentRecordRequest, request)
        ...
        res = operations.GetIncidentRecordResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetIncidentRecordOutput])
    ...
    def get_replication_set(self, request: operations.GetReplicationSetRequest) -> operations.GetReplicationSetResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GetReplicationSetRequest, request)
        ...
        res = operations.GetReplicationSetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetReplicationSetOutput])
    ...
    def get_resource_policies(self, request: operations.GetResourcePoliciesRequest) -> operations.GetResourcePoliciesResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetResourcePoliciesOutput])
    ...
    def get_response_plan(self, request: operations.GetResponsePlanRequest) -> operations.GetResponsePlanResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GetResponsePlanRequest, request)
        ...
        res = operations.GetResponsePlanResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetResponsePlanOutput])
    ...
    def get_timeline_event(self, request: operations.GetTimelineEventRequest) -> operations.GetTimelineEventResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.GetTimelineEventRequest, request)
        ...
        res = operations.GetTimelineEventResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetTimelineEventOutput])
    ...
    def list_incident_records(self, request: operations.ListIncidentRecordsRequest) -> operations.ListIncidentRecordsResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListIncidentRecordsRequest, request)
        ...
        res = operations.ListIncidentRecordsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListIncidentRecordsOutput])
    ...
    def list_related_items(self, request: operations.ListRelatedItemsRequest) -> operations.ListRelatedItemsResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListRelatedItemsRequest, request)
        ...
        res = operations.ListRelatedItemsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListRelatedItemsOutput])
    ...
    def list_replication_sets(self, request: operations.ListReplicationSetsRequest) -> operations.ListReplicationSetsResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListReplicationSetsRequest, request)
        ...
        res = operations.ListReplicationSetsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListReplicationSetsOutput])
    ...
    def list_response_plans(self, request: operations.ListResponsePlansRequest) -> operations.ListResponsePlansResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListResponsePlansRequest, request)
        ...
        res = operations.ListResponsePlansResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListResponsePlansOutput])
    ...
    def list_timeline_events(self, request: operations.ListTimelineEventsRequest) -> operations.ListTimelineEventsResponse:
        r"""Lists timeline events for the specified incident record."""
        base_url = self._server_url
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListTimelineEventsRequest, request)
        ...
        res = operations.ListTimelineEventsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListTimelineEventsOutput])
    ...
    def put_resource_policy(self, request: operations.PutResourcePolicyRequest) -> operations.PutResourcePolicyResponse:
        r"""Adds a resource policy to the specified response plan. The resource policy is used to share the response plan using Resource Access Manager (RAM). For more information about cross-account sharing, see <a href=\\"https://docs.aws.amazon.com/incident-manager/latest/userguide/incident-manager-cross-account-cross-region.html\\">Cross-Region and cross-account incident management</a>."""
        base_url = self._server_url
    ...
    def start_incident(self, request: operations.StartIncidentRequest) -> operations.StartIncidentResponse:
        ...
        res = operations.StartIncidentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartIncidentOutput])
    ...
    def update_deletion_protection(self, request: operations.UpdateDeletionProtectionRequest) -> operations.UpdateDeletionProtectionResponse:
        ...
        res = operations.UpdateDeletionProtectionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_incident_record(self, request: operations.UpdateIncidentRecordRequest) -> operations.UpdateIncidentRecordResponse:
        ...
        res = operations.UpdateIncidentRecordResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_related_items(self, request: operations.UpdateRelatedItemsRequest) -> operations.UpdateRelatedItemsResponse:
        ...
        res = operations.UpdateRelatedItemsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_replication_set(self, request: operations.UpdateReplicationSetRequest) -> operations.UpdateReplicationSetResponse:
        ...
        res = operations.UpdateReplicationSetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_response_plan(self, request: operations.UpdateResponsePlanRequest) -> operations.UpdateResponsePlanResponse:
        ...
        res = operations.UpdateResponsePlanResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_timeline_event(self, request: operations.UpdateTimelineEventRequest) -> operations.UpdateTimelineEventResponse:
        ...
        res = operations.UpdateTimelineEventResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
