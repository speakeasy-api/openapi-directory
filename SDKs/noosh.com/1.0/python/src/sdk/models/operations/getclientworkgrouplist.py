...
from ..shared import clientworkgrouplistvo as shared_clientworkgrouplistvo
...
class GetClientWorkgroupListResponse:
    ...
    client_workgroup_list_vo: Optional[shared_clientworkgrouplistvo.ClientWorkgroupListVO] = dataclasses.field(default=None)
