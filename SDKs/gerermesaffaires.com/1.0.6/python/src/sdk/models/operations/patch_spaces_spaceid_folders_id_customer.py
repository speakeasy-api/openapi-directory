...
class PatchSpacesSpaceIDFoldersIDCustomerRequestBodyLevelEnum(str, Enum):
...
class PatchSpacesSpaceIDFoldersIDCustomerRequestBody:
    r"""Customer to modify (except name, class and archivaldate)"""
    ...
    keep_old: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('KeepOld'), 'exclude': lambda f: f is None }})  
    ...
    level: Optional[PatchSpacesSpaceIDFoldersIDCustomerRequestBodyLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
    ...
    secondary_portfolio_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SecondaryPortfolioId'), 'exclude': lambda f: f is None }})  
...
@dataclasses.dataclass
class PatchSpacesSpaceIDFoldersIDCustomerRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""Id of the folder"""  
    request_body: PatchSpacesSpaceIDFoldersIDCustomerRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Customer to modify (except name, class and archivaldate)"""  
...
@dataclasses.dataclass
class PatchSpacesSpaceIDFoldersIDCustomerResponse:
