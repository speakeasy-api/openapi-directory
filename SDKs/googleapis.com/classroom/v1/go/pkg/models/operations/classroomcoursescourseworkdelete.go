...
type ClassroomCoursesCourseWorkDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ClassroomCoursesCourseWorkDeletePathParams struct {
...
type ClassroomCoursesCourseWorkDeleteQueryParams struct {
	// V1 error format.
...
type ClassroomCoursesCourseWorkDeleteRequest struct {
...
type ClassroomCoursesCourseWorkDeleteResponse struct {
	ContentType string
	// Successful response
