...
from ..shared import createtestcardrangesresult as shared_createtestcardrangesresult
...
class PostCreateTestCardRangesResponse:
    ...
    create_test_card_ranges_result: Optional[shared_createtestcardrangesresult.CreateTestCardRangesResult] = dataclasses.field(default=None)
