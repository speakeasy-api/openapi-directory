...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.copyBackupToRegion = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.CopyBackupToRegion";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.copyBackupToRegionResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    SDK.prototype.createCluster = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.CreateCluster";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.deleteBackup = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.DeleteBackup";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.deleteCluster = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.DeleteCluster";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.describeBackups = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.DescribeBackups";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.describeClusters = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.DescribeClusters";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.initializeCluster = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.InitializeCluster";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.initializeClusterResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.matchContentType(contentType, "application/json")) {
    ...
    **/
    SDK.prototype.modifyBackupAttributes = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.ModifyBackupAttributes";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.modifyBackupAttributesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.matchContentType(contentType, "application/json")) {
    ...
    **/
    SDK.prototype.modifyCluster = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.ModifyCluster";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.modifyClusterResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.matchContentType(contentType, "application/json")) {
    ...
    **/
    SDK.prototype.restoreBackup = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.RestoreBackup";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.restoreBackupResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.matchContentType(contentType, "application/json")) {
    ...
    **/
    SDK.prototype.untagResource = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=BaldrApiService.UntagResource";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
