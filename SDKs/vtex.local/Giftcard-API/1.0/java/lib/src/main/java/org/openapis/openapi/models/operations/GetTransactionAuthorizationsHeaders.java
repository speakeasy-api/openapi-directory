...
public class GetTransactionAuthorizationsHeaders {
    /**
    ...
    public GetTransactionAuthorizationsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public GetTransactionAuthorizationsHeaders withContentType(String contentType) {
