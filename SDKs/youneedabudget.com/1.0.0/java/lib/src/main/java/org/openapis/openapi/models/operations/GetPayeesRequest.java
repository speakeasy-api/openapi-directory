...
public class GetPayeesRequest {
    ...
    public GetPayeesRequest withBudgetId(String budgetId) {
    ...
    public GetPayeesRequest withLastKnowledgeOfServer(Long lastKnowledgeOfServer) {
        this.lastKnowledgeOfServer = lastKnowledgeOfServer;
        return this;
    }
    
    public GetPayeesRequest(@JsonProperty("budget_id") String budgetId) {
        this.budgetId = budgetId;
  }
}
