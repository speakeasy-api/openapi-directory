...
class RequestUploadShareQrRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestUploadShareQrXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestUploadShareQrXSdsDateFormatEnum $xSdsDateFormat = null;
