...
export class AuthkeyPostSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AuthkeyPostRequest extends SpeakeasyBase {
  /**
...
export class AuthkeyPostResponse extends SpeakeasyBase {
  /**
   * Access Denied
   */
  @SpeakeasyMetadata()
