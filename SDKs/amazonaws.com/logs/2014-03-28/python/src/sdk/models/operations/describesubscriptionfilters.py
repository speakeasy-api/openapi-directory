...
class DescribeSubscriptionFiltersRequest:
    ...
    describe_subscription_filters_request: shared_describesubscriptionfiltersrequest.DescribeSubscriptionFiltersRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
