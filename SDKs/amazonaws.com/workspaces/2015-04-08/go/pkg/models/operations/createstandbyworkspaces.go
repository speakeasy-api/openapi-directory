...
type CreateStandbyWorkspacesHeaders struct {
...
type CreateStandbyWorkspacesRequest struct {
	Headers CreateStandbyWorkspacesHeaders
	Request shared.CreateStandbyWorkspacesRequest `request:"mediaType=application/json"`
}
