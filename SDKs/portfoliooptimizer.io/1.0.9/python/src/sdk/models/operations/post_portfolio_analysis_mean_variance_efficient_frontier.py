...
class PostPortfolioAnalysisMeanVarianceEfficientFrontierRequestBody:
    ...
    constraints: Optional[PostPortfolioAnalysisMeanVarianceEfficientFrontierRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
    ...
    r"""The number of portfolios to compute on the mean-variance efficient frontier"""  
...
class PostPortfolioAnalysisMeanVarianceEfficientFrontier200ApplicationJSON:
    ...
    portfolios: list[PostPortfolioAnalysisMeanVarianceEfficientFrontier200ApplicationJSONPortfolios] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portfolios') }})  
