...
func (e *UpdateNetworkApplianceVpnSiteToSiteVpnRequestBodyModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "none":
		fallthrough
	case "spoke":
		*e = UpdateNetworkApplianceVpnSiteToSiteVpnRequestBodyModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceVpnSiteToSiteVpnRequestBodyModeEnum: %s", s)
	}
}
