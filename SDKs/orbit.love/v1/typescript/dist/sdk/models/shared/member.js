...
var Member = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=devto" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tags_to_add" }),
        __metadata("design:type", String)
    ], Member.prototype, "tagsToAdd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=teammate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tshirt" }),
        __metadata("design:type", String)
