 ...
 */
export declare enum IntegrationConnectionTypeEnum {
    Internet = "INTERNET",
    VpcLink = "VPC_LINK"
}
/**
 ...
 */
export declare enum IntegrationContentHandlingStrategyEnum {
 ...
 */
export declare enum IntegrationIntegrationTypeEnum {
    Aws = "AWS",
    Http = "HTTP",
    Mock = "MOCK",
 ...
 */
export declare enum IntegrationPassthroughBehaviorEnum {
 ...
 */
export declare class IntegrationTlsConfig extends SpeakeasyBase {
...
export declare class Integration extends SpeakeasyBase {
    ...
    connectionId?: string;
    connectionType?: IntegrationConnectionTypeEnum;
    contentHandlingStrategy?: IntegrationContentHandlingStrategyEnum;
    ...
    integrationType?: IntegrationIntegrationTypeEnum;
    integrationUri?: string;
    passthroughBehavior?: IntegrationPassthroughBehaviorEnum;
