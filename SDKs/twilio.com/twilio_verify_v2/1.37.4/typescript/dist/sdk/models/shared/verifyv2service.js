...
var VerifyV2Service = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=code_length" }),
        __metadata("design:type", Number)
    ], VerifyV2Service.prototype, "codeLength", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=custom_code_enabled" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_template_sid" }),
        __metadata("design:type", String)
    ], VerifyV2Service.prototype, "defaultTemplateSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=do_not_share_warning_enabled" }),
        __metadata("design:type", Boolean)
    ], VerifyV2Service.prototype, "doNotShareWarningEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dtmf_input_required" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lookup_enabled" }),
        __metadata("design:type", Boolean)
    ], VerifyV2Service.prototype, "lookupEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=psd2_enabled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=skip_sms_to_landlines" }),
        __metadata("design:type", Boolean)
    ], VerifyV2Service.prototype, "skipSmsToLandlines", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totp" }),
        __metadata("design:type", Object)
    ], VerifyV2Service.prototype, "totp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=tts_name" }),
        __metadata("design:type", String)
