...
export class TypeProjectInstrument {
  ...
  searchProjectInstrument(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/project_instrument";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchProjectInstrumentResponse =
        new operations.SearchProjectInstrumentResponse({
