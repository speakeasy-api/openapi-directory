...
public class GetItvPageQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetItvPageQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetItvPageQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetItvPageQueryParams withItemDetailExpand(GetItvPageItemDetailExpandEnum itemDetailExpand) {
    ...
    public GetItvPageQueryParams withItemDetailSelectSeason(GetItvPageItemDetailSelectSeasonEnum itemDetailSelectSeason) {
    ...
    public String lang;
    public GetItvPageQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetItvPageQueryParams withListPageSize(Integer listPageSize) {
    ...
    public GetItvPageQueryParams withListPageSizeLarge(Integer listPageSizeLarge) {
    ...
    public GetItvPageQueryParams withMaxListPrefetch(Integer maxListPrefetch) {
    ...
    public GetItvPageQueryParams withMaxRating(String maxRating) {
    ...
    public String path;
    public GetItvPageQueryParams withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public GetItvPageQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetItvPageQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
    ...
    public GetItvPageQueryParams withTextEntryFormat(GetItvPageTextEntryFormatEnum textEntryFormat) {
