...
public class Services {
    ...
    **/
    public openapisdk.models.operations.GetOneServiceResponse getOneService(openapisdk.models.operations.GetOneServiceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hardware/services/{serviceId}", request.pathParams);
        ...
        openapisdk.models.operations.GetOneServiceResponse res = new openapisdk.models.operations.GetOneServiceResponse() {{
            body = null;
            body = null;
            body = null;
        }};
    ...
    **/
    public openapisdk.models.operations.GetServicesResponse getServices(openapisdk.models.operations.GetServicesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/hardware/services");
