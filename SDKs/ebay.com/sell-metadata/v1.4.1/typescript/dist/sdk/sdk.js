...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.marketplace = new marketplace_1.Marketplace(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
