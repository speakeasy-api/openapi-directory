...
exports.StartIncidentResponse = exports.StartIncidentRequest = exports.StartIncidentRequestBody = exports.StartIncidentRequestBodyTriggerDetails = void 0;
...
var StartIncidentRequestBodyTriggerDetails = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "triggerArn" }),
        __metadata("design:type", String)
    ], StartIncidentRequestBodyTriggerDetails.prototype, "triggerArn", void 0);
    return StartIncidentRequestBodyTriggerDetails;
}(utils_1.SpeakeasyBase));
exports.StartIncidentRequestBodyTriggerDetails = StartIncidentRequestBodyTriggerDetails;
var StartIncidentRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.RelatedItem }),
        (0, class_transformer_1.Expose)({ name: "relatedItems" }),
        (0, class_transformer_1.Type)(function () { return shared.RelatedItem; }),
        __metadata("design:type", Array)
    ], StartIncidentRequestBody.prototype, "relatedItems", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "responsePlanArn" }),
        __metadata("design:type", String)
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return StartIncidentRequestBodyTriggerDetails; }),
...
exports.StartIncidentRequestBody = StartIncidentRequestBody;
var StartIncidentRequest = /** @class */ (function (_super) {
    ...
    ], StartIncidentRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], StartIncidentRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], StartIncidentRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], StartIncidentRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], StartIncidentRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], StartIncidentRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], StartIncidentRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], StartIncidentRequest.prototype, "xAmzSignedHeaders", void 0);
    return StartIncidentRequest;
}(utils_1.SpeakeasyBase));
exports.StartIncidentRequest = StartIncidentRequest;
var StartIncidentResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], StartIncidentResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.StartIncidentResponse = StartIncidentResponse;
