...
public class GetNhBugsQueryParams {
    /**
    ...
    public GetNhBugsQueryParams withExcludedetails(String excludedetails) {
    ...
    public String month;
    public GetNhBugsQueryParams withMonth(String month) {
        this.month = month;
        return this;
    }
    ...
    public GetNhBugsQueryParams withThumbsize(Long thumbsize) {
