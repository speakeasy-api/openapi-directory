...
class IdentitytoolkitRelyingpartySignupNewUserRequest:
    ...
    identitytoolkit_relyingparty_signup_new_user_request: Optional[shared_identitytoolkitrelyingpartysignupnewuserrequest.IdentitytoolkitRelyingpartySignupNewUserRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
