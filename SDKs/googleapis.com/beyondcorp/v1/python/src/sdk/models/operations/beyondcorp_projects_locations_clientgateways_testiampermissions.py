...
class BeyondcorpProjectsLocationsClientGatewaysTestIamPermissionsRequest:
    ...
    google_iam_v1_test_iam_permissions_request: Optional[shared_googleiamv1testiampermissionsrequest.GoogleIamV1TestIamPermissionsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
