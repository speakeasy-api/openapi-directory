...
export class CloudidentityGroupsMembershipsModifyMembershipRolesSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudidentityGroupsMembershipsModifyMembershipRolesSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudidentityGroupsMembershipsModifyMembershipRolesSecurity extends SpeakeasyBase {
...
export class CloudidentityGroupsMembershipsModifyMembershipRolesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudidentityGroupsMembershipsModifyMembershipRolesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
