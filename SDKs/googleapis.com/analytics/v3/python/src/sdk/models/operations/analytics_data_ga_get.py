...
class AnalyticsDataGaGetOutputEnum(str, Enum):
    r"""The selected format for the response. Default format is JSON."""
...
class AnalyticsDataGaGetRequest:
    ...
    r"""End date for fetching Analytics data. Request can should specify an end date formatted as YYYY-MM-DD, or as a relative date (e.g., today, yesterday, or 7daysAgo). The default value is yesterday."""  
    ...
    r"""A comma-separated list of Analytics metrics. E.g., 'ga:sessions,ga:pageviews'. At least one metric must be specified."""  
    ...
    r"""A comma-separated list of dimension or metric filters to be applied to Analytics data."""  
    ...
    r"""The response will include empty rows if this parameter is set to true, the default is true"""  
    ...
    r"""An Analytics segment to be applied to data."""  
    sort: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""A comma-separated list of dimensions or metrics that determine the sort order for Analytics data."""  
