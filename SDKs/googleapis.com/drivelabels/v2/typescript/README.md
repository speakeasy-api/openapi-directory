...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/drivelabels/v2/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/drivelabels/v2/typescript
```
...
import {
  AltEnum,
  GoogleAppsDriveLabelsV2LabelLabelTypeEnum,
...
const req: DrivelabelsLabelsCreateRequest = {
  ...
  googleAppsDriveLabelsV2LabelInput: {
    ...
    appliedLabelPolicy: {
      copyMode: GoogleAppsDriveLabelsV2LabelAppliedLabelPolicyCopyModeEnum.AlwaysCopy,
    },
    creator: {
      person: "distinctio",
    },
    ...
    fields: [
      {
        ...
        dateOptions: {
          dateFormatType: GoogleAppsDriveLabelsV2FieldDateOptionsDateFormatTypeEnum.ShortDate,
          maxValue: {
            day: 423655,
            month: 623564,
            year: 645894,
      ...
      },
      {
        ...
        dateOptions: {
          dateFormatType: GoogleAppsDriveLabelsV2FieldDateOptionsDateFormatTypeEnum.DateFormatUnspecified,
          maxValue: {
            day: 570197,
            month: 38425,
            year: 438601,
      ...
      },
      {
        ...
        dateOptions: {
          dateFormatType: GoogleAppsDriveLabelsV2FieldDateOptionsDateFormatTypeEnum.LongDate,
          maxValue: {
            day: 248753,
            month: 756107,
            year: 576157,
    ...
    labelType: GoogleAppsDriveLabelsV2LabelLabelTypeEnum.Shared,
    learnMoreUri: "nobis",
    lifecycle: {
      disabledPolicy: {
        hideInSearch: false,
