...
export class RecognitionMetadata extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "industryNaicsCodeOfAudio" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "microphoneDistance" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "recordingDeviceName" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "recordingDeviceType" })
