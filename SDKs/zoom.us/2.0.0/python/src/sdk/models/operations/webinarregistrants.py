...
class WebinarRegistrantsRequest:
    ...
    r"""The tracking source ID for the registrants. Useful if you share the webinar registration page in multiple locations. See [Creating source tracking links for webinar registration](https://support.zoom.us/hc/en-us/articles/360000315683-Creating-source-tracking-links-for-webinar-registration) for details."""  
...
class WebinarRegistrantsRegistrationListRegistrants:
    ...
    custom_questions: Optional[list[WebinarRegistrantsRegistrationListRegistrantsCustomQuestions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom_questions'), 'exclude': lambda f: f is None }})
    r"""Custom questions."""  
...
class WebinarRegistrantsRegistrationList:
    ...
    registrants: Optional[list[WebinarRegistrantsRegistrationListRegistrants]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('registrants'), 'exclude': lambda f: f is None }})
