...
type SearchMediaVideoQuicktimeQueryParams struct {
...
type SearchMediaVideoQuicktimeRequest struct {
	QueryParams SearchMediaVideoQuicktimeQueryParams
}

type SearchMediaVideoQuicktimeResponse struct {
	ContentType string
	StatusCode  int
