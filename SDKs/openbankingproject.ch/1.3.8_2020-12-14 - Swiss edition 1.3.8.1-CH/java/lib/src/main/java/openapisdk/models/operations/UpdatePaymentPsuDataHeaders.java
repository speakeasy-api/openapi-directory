...
public class UpdatePaymentPsuDataHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Digest")
    public String digest;
    public UpdatePaymentPsuDataHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-Accept")
    public String psuAccept;
    public UpdatePaymentPsuDataHeaders withPsuAccept(String psuAccept) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuAcceptCharset(String psuAcceptCharset) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuAcceptEncoding(String psuAcceptEncoding) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuAcceptLanguage(String psuAcceptLanguage) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuCorporateId(String psuCorporateID) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuCorporateIdType(String psuCorporateIDType) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuDeviceId(String psuDeviceID) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuGeoLocation(String psuGeoLocation) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuHttpMethod(openapisdk.models.shared.PsuHttpMethodEnum psuHttpMethod) {
        this.psuHttpMethod = psuHttpMethod;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-ID")
    public String psuID;
    public UpdatePaymentPsuDataHeaders withPsuId(String psuID) {
        this.psuID = psuID;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-ID-Type")
    public String psuIDType;
    public UpdatePaymentPsuDataHeaders withPsuIdType(String psuIDType) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuIpAddress(String psuIPAddress) {
        this.psuIPAddress = psuIPAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-IP-Port")
    public String psuIPPort;
    public UpdatePaymentPsuDataHeaders withPsuIpPort(String psuIPPort) {
    ...
    public UpdatePaymentPsuDataHeaders withPsuUserAgent(String psuUserAgent) {
        this.psuUserAgent = psuUserAgent;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Signature")
    public String signature;
    public UpdatePaymentPsuDataHeaders withSignature(String signature) {
    ...
    public UpdatePaymentPsuDataHeaders withTppSignatureCertificate(String tppSignatureCertificate) {
    ...
    public UpdatePaymentPsuDataHeaders withXRequestId(String xRequestID) {
