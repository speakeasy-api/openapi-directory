...
class SpectacularRequisitionV2RequisitionStatusEnum(str, Enum):
...
class SpectacularRequisitionV2:
    ...
    status: Optional[SpectacularRequisitionV2RequisitionStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""status of this requisition"""  
