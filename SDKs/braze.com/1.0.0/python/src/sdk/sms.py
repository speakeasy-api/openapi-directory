...
class Sms:
    ...
    def list_user_s_subscription_group_sms(self, request: operations.ListUserSSubscriptionGroupSmsRequest) -> operations.ListUserSSubscriptionGroupSmsResponse:
        ...
        query_params = utils.get_query_params(operations.ListUserSSubscriptionGroupSmsRequest, request)
        ...
        res = operations.ListUserSSubscriptionGroupSmsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def list_user_s_subscription_group_status_sms(self, request: operations.ListUserSSubscriptionGroupStatusSmsRequest) -> operations.ListUserSSubscriptionGroupStatusSmsResponse:
        ...
        query_params = utils.get_query_params(operations.ListUserSSubscriptionGroupStatusSmsRequest, request)
        ...
        res = operations.ListUserSSubscriptionGroupStatusSmsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
