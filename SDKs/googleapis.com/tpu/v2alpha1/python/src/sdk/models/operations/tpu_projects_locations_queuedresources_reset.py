...
class TpuProjectsLocationsQueuedResourcesResetSecurity:
...
@dataclasses.dataclass
class TpuProjectsLocationsQueuedResourcesResetRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Required. The name of the queued resource."""  
...
@dataclasses.dataclass
class TpuProjectsLocationsQueuedResourcesResetResponse:
