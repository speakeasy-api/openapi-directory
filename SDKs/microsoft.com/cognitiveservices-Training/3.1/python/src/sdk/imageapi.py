...
class ImageAPI:
    ...
    def query_suggested_image_count(self, request: operations.QuerySuggestedImageCountRequest) -> operations.QuerySuggestedImageCountResponse:
        ...
        url = utils.generate_url(base_url, "/projects/{projectId}/images/suggested/count", request.path_params)
        ...
        res = operations.QuerySuggestedImageCountResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, int]])
                res.query_suggested_image_count_200_application_json_object = out
            if utils.match_content_type(content_type, "application/xml"):
                res.body = r.content
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
    ...
    def query_suggested_images(self, request: operations.QuerySuggestedImagesRequest) -> operations.QuerySuggestedImagesResponse:
        ...
        url = utils.generate_url(base_url, "/projects/{projectId}/images/suggested", request.path_params)
        ...
        res = operations.QuerySuggestedImagesResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SuggestedTagAndRegionQuery])
