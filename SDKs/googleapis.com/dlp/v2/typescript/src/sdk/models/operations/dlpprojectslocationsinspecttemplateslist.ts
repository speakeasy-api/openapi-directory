...
export class DlpProjectsLocationsInspectTemplatesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DlpProjectsLocationsInspectTemplatesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DlpProjectsLocationsInspectTemplatesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
