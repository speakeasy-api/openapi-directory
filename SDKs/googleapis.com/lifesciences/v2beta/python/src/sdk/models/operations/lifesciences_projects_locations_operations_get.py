...
class LifesciencesProjectsLocationsOperationsGetRequest:
    path_params: LifesciencesProjectsLocationsOperationsGetPathParams = dataclasses.field()
    query_params: LifesciencesProjectsLocationsOperationsGetQueryParams = dataclasses.field()
    security: LifesciencesProjectsLocationsOperationsGetSecurity = dataclasses.field()
