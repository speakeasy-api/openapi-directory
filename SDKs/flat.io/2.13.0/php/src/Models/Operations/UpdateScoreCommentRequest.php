...
class UpdateScoreCommentRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\ScoreCommentUpdate $scoreCommentUpdate;
	...
	{
		$this->scoreCommentUpdate = new \OpenAPI\OpenAPI\Models\Shared\ScoreCommentUpdate();
		$this->comment = "";
		$this->score = "";
