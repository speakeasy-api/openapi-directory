...
class MergeDeveloperIdentitiesRequest:
    ...
    merge_developer_identities_input: shared_mergedeveloperidentitiesinput.MergeDeveloperIdentitiesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
