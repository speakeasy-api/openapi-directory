...
public class GetNhFishFishRequest {
    ...
    public GetNhFishFishRequest withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFishFishRequest withXApiKey(String xApiKey) {
    ...
    public String fish;
    public GetNhFishFishRequest withFish(String fish) {
        this.fish = fish;
        return this;
    }
    ...
    public GetNhFishFishRequest withThumbsize(Long thumbsize) {
