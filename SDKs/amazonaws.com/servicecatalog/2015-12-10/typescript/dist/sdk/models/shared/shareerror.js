 ...
 */
var ShareError = /** @class */ (function (_super) {
    __extends(ShareError, _super);
    function ShareError() {
    ...
    ], ShareError.prototype, "accounts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Error" }),
        __metadata("design:type", String)
    ], ShareError.prototype, "error", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Message" }),
        __metadata("design:type", String)
    ], ShareError.prototype, "message", void 0);
    return ShareError;
