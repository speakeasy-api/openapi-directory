...
class MeetingCreateApplicationJSONRecurrence
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceMonthlyWeekEnum $monthlyWeek
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceMonthlyWeekEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingCreateApplicationJSONRecurrenceMonthlyWeekEnum $monthlyWeek = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceMonthlyWeekDayEnum $monthlyWeekDay
     */
	#[\JMS\Serializer\Annotation\SerializedName('monthly_week_day')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceMonthlyWeekDayEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingCreateApplicationJSONRecurrenceMonthlyWeekDayEnum $monthlyWeekDay = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceTypeEnum>')]
    public MeetingCreateApplicationJSONRecurrenceTypeEnum $type;
     ...
     *  <br>`1`  - Sunday. <br>`2` - Monday.<br>`3` - Tuesday.<br>`4` -  Wednesday.<br>`5` -  Thursday.<br>`6` - Friday.<br>`7` - Saturday.
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceWeeklyDaysEnum $weeklyDays
     */
	#[\JMS\Serializer\Annotation\SerializedName('weekly_days')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceWeeklyDaysEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?MeetingCreateApplicationJSONRecurrenceWeeklyDaysEnum $weeklyDays = null;
	...
	public function __construct()
	{
		...
		$this->type = \OpenAPI\OpenAPI\Models\Operations\MeetingCreateApplicationJSONRecurrenceTypeEnum::ONE;
