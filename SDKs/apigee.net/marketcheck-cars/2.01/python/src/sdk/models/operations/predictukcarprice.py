...
class PredictUkCarPriceTransmissionEnum(str, Enum):
...
class PredictUkCarPriceRequest:
    ...
    city_mpg: Optional[float] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'city_mpg', 'style': 'form', 'explode': True }})
    r"""City mileage of the car"""  
    combined_mpg: Optional[float] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'combined_mpg', 'style': 'form', 'explode': True }})
    r"""Combiined mileage of the car"""  
    ...
    highway_mpg: Optional[float] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'highway_mpg', 'style': 'form', 'explode': True }})
    r"""Highway mileage"""  
    ...
    r"""Car's model"""  
    transmission: Optional[PredictUkCarPriceTransmissionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'transmission', 'style': 'form', 'explode': True }})
    r"""Transmission on the car"""  
...
@dataclasses.dataclass
class PredictUkCarPriceResponse:
