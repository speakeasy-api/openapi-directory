...
@dataclasses.dataclass
class CompanySearchNameDefaultApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CompanySearchName200ApplicationJSON:
...
class CompanySearchNameResponse:
    ...
    company_search_name_200_application_json_objects: Optional[list[CompanySearchName200ApplicationJSON]] = dataclasses.field(default=None)
    r"""List of companies"""  
    company_search_name_default_application_json_object: Optional[CompanySearchNameDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
