...
func (e ConferenceParticipantEnumCallTypeEnum) ToPointer() *ConferenceParticipantEnumCallTypeEnum {
	return &e
}
...
func (e *ConferenceParticipantEnumCallTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "client":
		fallthrough
	case "sip":
		*e = ConferenceParticipantEnumCallTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConferenceParticipantEnumCallTypeEnum: %v", v)
	}
}
