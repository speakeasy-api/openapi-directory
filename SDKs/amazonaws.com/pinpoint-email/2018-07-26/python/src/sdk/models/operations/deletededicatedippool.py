...
class DeleteDedicatedIPPoolRequest:
    headers: DeleteDedicatedIPPoolHeaders = dataclasses.field()
    path_params: DeleteDedicatedIPPoolPathParams = dataclasses.field()
...
class DeleteDedicatedIPPoolResponse:
    ...
    delete_dedicated_ip_pool_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
