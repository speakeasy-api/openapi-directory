...
type SoldToContactPostOrderOtherPhoneTypeEnum string

const (
	SoldToContactPostOrderOtherPhoneTypeEnumWork   SoldToContactPostOrderOtherPhoneTypeEnum = "Work"
	SoldToContactPostOrderOtherPhoneTypeEnumMobile SoldToContactPostOrderOtherPhoneTypeEnum = "Mobile"
	SoldToContactPostOrderOtherPhoneTypeEnumHome   SoldToContactPostOrderOtherPhoneTypeEnum = "Home"
	SoldToContactPostOrderOtherPhoneTypeEnumOther  SoldToContactPostOrderOtherPhoneTypeEnum = "Other"
)

func (e *SoldToContactPostOrderOtherPhoneTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "Home":
		fallthrough
	case "Other":
		*e = SoldToContactPostOrderOtherPhoneTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for SoldToContactPostOrderOtherPhoneTypeEnum: %s", s)
	}
}

// SoldToContactPostOrder - Container for custom fields of a Contact object.
type SoldToContactPostOrder struct {
	...
	//
	OtherPhoneType *SoldToContactPostOrderOtherPhoneTypeEnum `json:"otherPhoneType,omitempty"`
