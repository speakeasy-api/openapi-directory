...
func (e CancelLeaseRequestResponseViewEnum) ToPointer() *CancelLeaseRequestResponseViewEnum {
	return &e
}
...
func (e *CancelLeaseRequestResponseViewEnum) UnmarshalJSON(data []byte) error {
	...
	case "BASIC":
		fallthrough
	case "FULL":
		*e = CancelLeaseRequestResponseViewEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CancelLeaseRequestResponseViewEnum: %v", v)
	}
}
