 ...
 */
export enum TargetGrpcProxyListWarningCodeEnum {
...
export class TargetGrpcProxyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetGrpcProxyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetGrpcProxyListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class TargetGrpcProxyList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetGrpcProxy })
  @Expose({ name: "items" })
