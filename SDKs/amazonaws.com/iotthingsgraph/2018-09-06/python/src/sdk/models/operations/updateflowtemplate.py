...
class UpdateFlowTemplateRequest:
    ...
    update_flow_template_request: shared_updateflowtemplaterequest.UpdateFlowTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
