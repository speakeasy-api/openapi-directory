...
export class CrashesListSessionLogsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CrashesListSessionLogsRequest extends SpeakeasyBase {
  /**
...
export enum CrashesListSessionLogsDefaultApplicationJSONErrorCodeEnum {
...
export class CrashesListSessionLogsDefaultApplicationJSONError extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code: CrashesListSessionLogsDefaultApplicationJSONErrorCodeEnum;
 ...
 */
export class CrashesListSessionLogsDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => CrashesListSessionLogsDefaultApplicationJSONError)
  error: CrashesListSessionLogsDefaultApplicationJSONError;
}

/**
 * Device characteristics.
 */
export class CrashesListSessionLogs200ApplicationJSONLogsDevice extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum CrashesListSessionLogs200ApplicationJSONLogsTypeEnum {
  Event = "event",
  Page = "page",
 ...
 * Generic log.
 */
export class CrashesListSessionLogs200ApplicationJSONLogs extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "device" })
  @Type(() => CrashesListSessionLogs200ApplicationJSONLogsDevice)
  device: CrashesListSessionLogs200ApplicationJSONLogsDevice;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "type" })
  type: CrashesListSessionLogs200ApplicationJSONLogsTypeEnum;
}

/**
 * Session logs of specific crash
 */
export class CrashesListSessionLogs200ApplicationJSON extends SpeakeasyBase {
  /**
   ...
   * the list of logs
   */
  @SpeakeasyMetadata({ elemType: CrashesListSessionLogs200ApplicationJSONLogs })
  @Expose({ name: "logs" })
  @Type(() => CrashesListSessionLogs200ApplicationJSONLogs)
  logs: CrashesListSessionLogs200ApplicationJSONLogs[];
}

export class CrashesListSessionLogsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
