...
exports.DeletePullRequestHostedPropertyValueResponse = exports.DeletePullRequestHostedPropertyValueRequest = void 0;
...
var DeletePullRequestHostedPropertyValueRequest = /** @class */ (function (_super) {
    ...
    ], DeletePullRequestHostedPropertyValueRequest.prototype, "appKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=property_name",
        }),
        __metadata("design:type", String)
    ], DeletePullRequestHostedPropertyValueRequest.prototype, "propertyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=pullrequest_id",
        }),
        __metadata("design:type", String)
    ], DeletePullRequestHostedPropertyValueRequest.prototype, "pullrequestId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], DeletePullRequestHostedPropertyValueRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], DeletePullRequestHostedPropertyValueRequest.prototype, "workspace", void 0);
...
var DeletePullRequestHostedPropertyValueResponse = /** @class */ (function (_super) {
    ...
    ], DeletePullRequestHostedPropertyValueResponse.prototype, "rawResponse", void 0);
