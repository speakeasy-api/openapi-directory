...
var Accounts = /** @class */ (function () {
     ...
     */
    Accounts.prototype.accountsGet = function (config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.pageResultAccountDto = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.PageResultAccountDto);
                    }
                    break;
            }
            return res;
