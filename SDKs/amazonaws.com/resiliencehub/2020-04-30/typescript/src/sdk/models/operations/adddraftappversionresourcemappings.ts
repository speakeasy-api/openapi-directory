...
export class AddDraftAppVersionResourceMappingsRequestBody extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: shared.ResourceMapping })
  @Expose({ name: "resourceMappings" })
  @Type(() => shared.ResourceMapping)
  resourceMappings: shared.ResourceMapping[];
}

export class AddDraftAppVersionResourceMappingsRequest extends SpeakeasyBase {
