...
from ..shared import deletecommentresponse as shared_deletecommentresponse
...
class CollectionTicketCommentsDeleteSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class CollectionTicketCommentsDeleteRequest:
...
@dataclasses.dataclass
class CollectionTicketCommentsDeleteResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    delete_comment_response: Optional[shared_deletecommentresponse.DeleteCommentResponse] = dataclasses.field(default=None)
    r"""Delete a Comment"""  
