...
class DataPointsGetStatisticsAllListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsAllListGroupByEnum $groupBy
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=groupBy')]
    public ?DataPointsGetStatisticsAllListGroupByEnum $groupBy = null;
    
    /**
     * Status of datapoint ("deleted"/"active"/"paused"/"spam")
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsAllListStatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?DataPointsGetStatisticsAllListStatusEnum $status = null;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsAllListTimeFrameEnum $timeFrame
     */
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsAllListTypeEnum $type
     */
	...
	public function __construct()
	{
		...
		$this->status = null;
		$this->tag = null;
		$this->timeFrame = \OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsAllListTimeFrameEnum::TODAY;
		$this->toDay = null;
		$this->type = \OpenAPI\OpenAPI\Models\Operations\DataPointsGetStatisticsAllListTypeEnum::TP;
	}
}
