...
class UploadSessionsUploadPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class UploadSessionsUploadQueryParams:
...
@dataclasses.dataclass
class UploadSessionsUploadHeaders:
...
class UploadSessionsUploadRequest:
    headers: UploadSessionsUploadHeaders = dataclasses.field()
    path_params: UploadSessionsUploadPathParams = dataclasses.field()
    query_params: UploadSessionsUploadQueryParams = dataclasses.field()
    request: bytes = dataclasses.field(metadata={'request': { 'media_type': '*/*' }})
    security: UploadSessionsUploadSecurity = dataclasses.field()
