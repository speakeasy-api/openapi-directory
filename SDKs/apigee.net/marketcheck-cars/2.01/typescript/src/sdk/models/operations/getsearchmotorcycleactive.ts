...
export class GetSearchMotorcycleActiveQueryParams extends SpeakeasyBase {
...
export class GetSearchMotorcycleActiveRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetSearchMotorcycleActiveQueryParams;
}


export class GetSearchMotorcycleActiveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
