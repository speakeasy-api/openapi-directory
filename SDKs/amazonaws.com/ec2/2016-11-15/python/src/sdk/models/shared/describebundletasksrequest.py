...
class DescribeBundleTasksRequestFilters:
...
class DescribeBundleTasksRequest:
    ...
    bundle_ids: Optional[list[str]] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeBundleTasksRequestFilters]] = dataclasses.field(default=None)  
