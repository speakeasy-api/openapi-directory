...
public class PostApiInvoiceUpdatecategoryJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public PostApiInvoiceUpdatecategoryJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public PostApiInvoiceUpdatecategoryJsonHeaders withXAuthSecret(String xAuthSecret) {
