...
class Apps 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\AppsAddRepoToInstallationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\AppsAddRepoToInstallationResponse
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#add-a-repository-to-an-app-installation
     */
	public function appsAddRepoToInstallation(
        \OpenAPI\OpenAPI\Models\Operations\AppsAddRepoToInstallationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\AppsAddRepoToInstallationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/user/installations/{installation_id}/repositories/{repository_id}', \OpenAPI\OpenAPI\Models\Operations\AppsAddRepoToInstallationRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\AppsAddRepoToInstallationResponse();
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#check-an-authorization
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#check-a-token
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#create-a-content-attachment
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#create-a-github-app-from-a-manifest
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps/#create-an-installation-access-token-for-an-app
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\AppsCreateInstallationAccessTokenResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 201) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->appsCreateInstallationAccessToken415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\AppsCreateInstallationAccessToken415ApplicationJSON', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 422) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#delete-an-app-authorization
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#delete-an-installation-for-the-authenticated-app
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#delete-an-app-token
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#get-the-authenticated-app
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps/#get-an-app
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\AppsGetBySlugResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->appsGetBySlug415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\AppsGetBySlug415ApplicationJSON', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#get-an-installation-for-the-authenticated-app
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\AppsGetInstallationResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->installationGhes2 = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\InstallationGhes2', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 404) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->appsGetInstallation415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\AppsGetInstallation415ApplicationJSON', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#get-an-organization-installation-for-the-authenticated-app
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#get-a-repository-installation-for-the-authenticated-app
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#get-a-user-installation-for-the-authenticated-app
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#list-repositories-accessible-to-the-user-access-token
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#list-installations-for-the-authenticated-app
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\AppsListInstallationsResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->installationGhes2s = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\InstallationGhes2>', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#list-app-installations-accessible-to-the-user-access-token
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\AppsListInstallationsForAuthenticatedUserResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->appsListInstallationsForAuthenticatedUser415ApplicationJSONObject = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\AppsListInstallationsForAuthenticatedUser415ApplicationJSON', 'json');
            }
        }
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#list-repositories-accessible-to-the-app-installation
     */
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\AppsRemoveRepoFromInstallationRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\AppsRemoveRepoFromInstallationResponse
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#remove-a-repository-from-an-app-installation
     */
	public function appsRemoveRepoFromInstallation(
        \OpenAPI\OpenAPI\Models\Operations\AppsRemoveRepoFromInstallationRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\AppsRemoveRepoFromInstallationResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/user/installations/{installation_id}/repositories/{repository_id}', \OpenAPI\OpenAPI\Models\Operations\AppsRemoveRepoFromInstallationRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\AppsRemoveRepoFromInstallationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#reset-an-authorization
     * @deprecated this method will be removed in a future release, please migrate away from it as soon as possible
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#reset-a-token
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#revoke-an-authorization-for-an-application
     * @deprecated this method will be removed in a future release, please migrate away from it as soon as possible
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#revoke-a-grant-for-an-application
     * @deprecated this method will be removed in a future release, please migrate away from it as soon as possible
     */
     ...
     * @see https://docs.github.com/enterprise-server@2.20/rest/reference/apps#revoke-an-installation-access-token
     */
