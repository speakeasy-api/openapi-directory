...
from ..shared import clientvpnauthenticationrequest as shared_clientvpnauthenticationrequest
...
class CreateClientVpnEndpointRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateClientVpnEndpointRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
class CreateClientVpnEndpointRequestTagSpecifications:
    ...
    resource_type: Optional[CreateClientVpnEndpointRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateClientVpnEndpointRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateClientVpnEndpointRequest:
    
    authentication_options: list[shared_clientvpnauthenticationrequest.ClientVpnAuthenticationRequest] = dataclasses.field()  
    client_cidr_block: str = dataclasses.field()  
    connection_log_options: shared_connectionlogoptions.ConnectionLogOptions = dataclasses.field()  
    server_certificate_arn: str = dataclasses.field()  
    ...
    tag_specifications: Optional[list[CreateClientVpnEndpointRequestTagSpecifications]] = dataclasses.field(default=None)  
    transport_protocol: Optional[shared_transportprotocol_enum.TransportProtocolEnum] = dataclasses.field(default=None)  
