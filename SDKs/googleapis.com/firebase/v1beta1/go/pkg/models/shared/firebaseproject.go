...
func (e FirebaseProjectStateEnum) ToPointer() *FirebaseProjectStateEnum {
	return &e
}
...
func (e *FirebaseProjectStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "ACTIVE":
		fallthrough
	case "DELETED":
		*e = FirebaseProjectStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for FirebaseProjectStateEnum: %v", v)
	}
}
