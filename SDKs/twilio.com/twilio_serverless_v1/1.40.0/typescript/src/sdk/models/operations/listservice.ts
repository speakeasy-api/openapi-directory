...
export const ListServiceServerList = ["https://serverless.twilio.com"] as const;
...
export class ListServiceListServiceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListServiceListServiceResponseMeta)
  meta?: ListServiceListServiceResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.ServerlessV1Service })
  @Expose({ name: "services" })
  @Type(() => shared.ServerlessV1Service)
  services?: shared.ServerlessV1Service[];
}
