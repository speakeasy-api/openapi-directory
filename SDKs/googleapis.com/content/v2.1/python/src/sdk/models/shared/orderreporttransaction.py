...
class OrderReportTransaction:
    ...
    product_amount: Optional[shared_productamount.ProductAmount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('productAmount'), 'exclude': lambda f: f is None }})  
