...
class CodesOfConduct:
    ...
    def codes_of_conduct_get_for_repo(self, request: operations.CodesOfConductGetForRepoRequest) -> operations.CodesOfConductGetForRepoResponse:
        r"""Get the code of conduct for a repository
        ...
        url = utils.generate_url(base_url, "/repos/{owner}/{repo}/community/code_of_conduct", request.path_params)
        ...
        res = operations.CodesOfConductGetForRepoResponse(status_code=r.status_code, content_type=content_type)
