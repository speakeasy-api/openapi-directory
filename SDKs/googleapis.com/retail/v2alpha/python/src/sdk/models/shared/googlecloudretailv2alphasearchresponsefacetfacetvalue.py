...
class GoogleCloudRetailV2alphaSearchResponseFacetFacetValue:
    ...
    interval: Optional[shared_googlecloudretailv2alphainterval.GoogleCloudRetailV2alphaInterval] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interval'), 'exclude': lambda f: f is None }})
