...
class FormsFormsBatchUpdateRequest:
    ...
    batch_update_form_request_input: Optional[shared_batchupdateformrequest.BatchUpdateFormRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
