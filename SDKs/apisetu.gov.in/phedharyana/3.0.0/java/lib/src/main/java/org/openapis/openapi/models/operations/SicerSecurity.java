...
public class SicerSecurity {
    ...
    public SicerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public SicerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public SicerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
