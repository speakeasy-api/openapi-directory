...
export class GetLoadBalancersIdActionsActionIdActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => GetLoadBalancersIdActionsActionIdActionResponseActionError)
   ...
   */
  @SpeakeasyMetadata({
    elemType: GetLoadBalancersIdActionsActionIdActionResponseActionResources,
  })
  @Expose({ name: "resources" })
  @Type(() => GetLoadBalancersIdActionsActionIdActionResponseActionResources)
...
export class GetLoadBalancersIdActionsActionIdActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => GetLoadBalancersIdActionsActionIdActionResponseAction)
