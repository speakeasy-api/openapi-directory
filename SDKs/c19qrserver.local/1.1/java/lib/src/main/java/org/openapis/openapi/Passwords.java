...
public class Passwords {
    ...
    public org.openapis.openapi.models.operations.PostRequestPasswordResetResponse postRequestPasswordReset(org.openapis.openapi.models.operations.PostRequestPasswordResetSample request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.RequestPasswordResetResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.RequestPasswordResetResponse.class);
