...
public class RepoSearchResultItem {
    ...
    public RepoSearchResultItem withHasDiscussions(Boolean hasDiscussions) {
    ...
    public RepoSearchResultItem withWebCommitSignoffRequired(Boolean webCommitSignoffRequired) {
