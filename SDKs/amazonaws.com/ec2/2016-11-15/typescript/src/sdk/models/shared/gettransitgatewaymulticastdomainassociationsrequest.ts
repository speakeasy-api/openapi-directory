 ...
 */
export class GetTransitGatewayMulticastDomainAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetTransitGatewayMulticastDomainAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
  ...
  filters?: GetTransitGatewayMulticastDomainAssociationsRequestFilters[];
