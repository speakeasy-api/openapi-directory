...
class DataprocProjectsRegionsJobsListRequest:
    path_params: DataprocProjectsRegionsJobsListPathParams = dataclasses.field()
    query_params: DataprocProjectsRegionsJobsListQueryParams = dataclasses.field()
    security: DataprocProjectsRegionsJobsListSecurity = dataclasses.field()
