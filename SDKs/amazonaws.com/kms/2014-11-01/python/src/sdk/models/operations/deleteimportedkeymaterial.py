...
class DeleteImportedKeyMaterialRequest:
    ...
    delete_imported_key_material_request: shared_deleteimportedkeymaterialrequest.DeleteImportedKeyMaterialRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
