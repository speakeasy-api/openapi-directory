...
public class Login {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ResetPasswordResponse resetPassword(org.openapis.openapi.models.shared.ResetPasswordRequest request) throws Exception {
        String baseUrl = this._serverUrl;
    ...
    public org.openapis.openapi.models.operations.ValidateAccessTokenResponse validateAccessToken(org.openapis.openapi.models.operations.ValidateAccessTokenRequest request) throws Exception {
        ...
        req.setMethod("POST");
        req.setURL(url);
        SerializedBody serializedRequestBody = org.openapis.openapi.utils.Utils.serializeRequestBody(request, "accessTokenValidationRequest", "json");
        if (serializedRequestBody == null) {
            throw new Exception("Request body is required");
        }
        req.setBody(serializedRequestBody);
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.VeloAuthResponse veloAuth(org.openapis.openapi.models.operations.VeloAuthRequest request, org.openapis.openapi.models.operations.VeloAuthSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.VeloAuthRequest.class, request, null);
        if (queryParams != null) {
