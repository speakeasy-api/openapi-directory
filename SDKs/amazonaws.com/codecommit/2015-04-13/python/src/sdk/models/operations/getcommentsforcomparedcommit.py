...
class GetCommentsForComparedCommitRequest:
    headers: GetCommentsForComparedCommitHeaders = dataclasses.field()
    query_params: GetCommentsForComparedCommitQueryParams = dataclasses.field()
    request: shared_getcommentsforcomparedcommitinput.GetCommentsForComparedCommitInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
