...
class TagCertificateAuthorityRequest:
    ...
    tag_certificate_authority_request: shared_tagcertificateauthorityrequest.TagCertificateAuthorityRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
