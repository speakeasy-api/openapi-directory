...
public class GeocodeReverseQueryParams {
    /**
    ...
    public GeocodeReverseQueryParams withLanguageCode(String languageCode) {
    ...
    public GeocodeReverseQueryParams withLatitude(String latitude) {
    ...
    public GeocodeReverseQueryParams withLongitude(String longitude) {
    ...
    public String zoom;
    public GeocodeReverseQueryParams withZoom(String zoom) {
        this.zoom = zoom;
        return this;
    }
