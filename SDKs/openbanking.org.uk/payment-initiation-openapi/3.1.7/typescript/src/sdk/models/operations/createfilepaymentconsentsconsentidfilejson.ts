...
export class CreateFilePaymentConsentsConsentIdFileJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateFilePaymentConsentsConsentIdFileJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateFilePaymentConsentsConsentIdFileJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
