...
var SendQuota = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Max24HourSend" }),
        __metadata("design:type", Number)
    ], SendQuota.prototype, "max24HourSend", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MaxSendRate" }),
        __metadata("design:type", Number)
    ], SendQuota.prototype, "maxSendRate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SentLast24Hours" }),
        __metadata("design:type", Number)
