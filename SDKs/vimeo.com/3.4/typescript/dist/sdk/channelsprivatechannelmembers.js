...
exports.ChannelsPrivateChannelMembers = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ChannelsPrivateChannelMembers = /** @class */ (function () {
    function ChannelsPrivateChannelMembers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ChannelsPrivateChannelMembers.prototype.deleteChannelPrivacyUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteChannelPrivacyUserRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/channels/{channel_id}/privacy/users/{user_id}", req.pathParams);
    ...
    **/
    ChannelsPrivateChannelMembers.prototype.getChannelPrivacyUsers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetChannelPrivacyUsersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/channels/{channel_id}/privacy/users", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    ChannelsPrivateChannelMembers.prototype.setChannelPrivacyUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsPrivateChannelMembers.prototype.setChannelPrivacyUsers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ChannelsPrivateChannelMembers = ChannelsPrivateChannelMembers;
