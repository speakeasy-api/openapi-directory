...
public class PaymentDispute {
    ...
    **/
    public openapisdk.models.operations.AcceptPaymentDisputeResponse acceptPaymentDispute(openapisdk.models.operations.AcceptPaymentDisputeRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.AcceptPaymentDisputeRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}/accept", request.pathParams);
        ...
        openapisdk.models.operations.AcceptPaymentDisputeResponse res = new openapisdk.models.operations.AcceptPaymentDisputeResponse() {{
        }};
    ...
    **/
    public openapisdk.models.operations.AddEvidenceResponse addEvidence(openapisdk.models.operations.AddEvidenceRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.AddEvidenceRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}/add_evidence", request.pathParams);
        ...
        openapisdk.models.operations.AddEvidenceResponse res = new openapisdk.models.operations.AddEvidenceResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.AddEvidencePaymentDisputeResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.AddEvidencePaymentDisputeResponse.class);
    ...
    **/
    public openapisdk.models.operations.ContestPaymentDisputeResponse contestPaymentDispute(openapisdk.models.operations.ContestPaymentDisputeRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.ContestPaymentDisputeRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}/contest", request.pathParams);
        ...
        openapisdk.models.operations.ContestPaymentDisputeResponse res = new openapisdk.models.operations.ContestPaymentDisputeResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.FetchEvidenceContentResponse fetchEvidenceContent(openapisdk.models.operations.FetchEvidenceContentRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.FetchEvidenceContentRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}/fetch_evidence_content", request.pathParams);
        ...
        openapisdk.models.operations.FetchEvidenceContentResponse res = new openapisdk.models.operations.FetchEvidenceContentResponse() {{
            body = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.GetActivitiesResponse getActivities(openapisdk.models.operations.GetActivitiesRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.GetActivitiesRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}/activity", request.pathParams);
        ...
        openapisdk.models.operations.GetActivitiesResponse res = new openapisdk.models.operations.GetActivitiesResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.PaymentDisputeActivityHistory out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PaymentDisputeActivityHistory.class);
    ...
    **/
    public openapisdk.models.operations.GetPaymentDisputeResponse getPaymentDispute(openapisdk.models.operations.GetPaymentDisputeRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.GetPaymentDisputeRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}", request.pathParams);
        ...
        openapisdk.models.operations.GetPaymentDisputeResponse res = new openapisdk.models.operations.GetPaymentDisputeResponse() {{
            paymentDispute = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.PaymentDispute out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PaymentDispute.class);
    ...
    **/
    public openapisdk.models.operations.GetPaymentDisputeSummariesResponse getPaymentDisputeSummaries(openapisdk.models.operations.GetPaymentDisputeSummariesRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.GetPaymentDisputeSummariesRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute_summary");
        ...
        openapisdk.models.operations.GetPaymentDisputeSummariesResponse res = new openapisdk.models.operations.GetPaymentDisputeSummariesResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DisputeSummaryResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DisputeSummaryResponse.class);
    ...
    **/
    public openapisdk.models.operations.UpdateEvidenceResponse updateEvidence(openapisdk.models.operations.UpdateEvidenceRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.UpdateEvidenceRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}/update_evidence", request.pathParams);
        ...
        openapisdk.models.operations.UpdateEvidenceResponse res = new openapisdk.models.operations.UpdateEvidenceResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
    ...
    **/
    public openapisdk.models.operations.UploadEvidenceFileResponse uploadEvidenceFile(openapisdk.models.operations.UploadEvidenceFileRequest request) throws Exception {
        String baseUrl = openapisdk.models.operations.UploadEvidenceFileRequestServerList.SERVERS[0];
        if (request.serverURL != null && !request.serverURL.isBlank()) {
            baseUrl = request.serverURL;
        }
        
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payment_dispute/{payment_dispute_id}/upload_evidence_file", request.pathParams);
        ...
        openapisdk.models.operations.UploadEvidenceFileResponse res = new openapisdk.models.operations.UploadEvidenceFileResponse() {{
            fileEvidence = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.FileEvidence out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.FileEvidence.class);
