...
class GetGeomarksGeomarkIdFileFormatExtensionRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\GetGeomarksGeomarkIdFileFormatExtensionFileFormatExtensionEnum $fileFormatExtension
     */
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGeomarksGeomarkIdFileFormatExtensionSridEnum $srid
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=srid')]
    public ?GetGeomarksGeomarkIdFileFormatExtensionSridEnum $srid = null;
    
	public function __construct()
	{
		$this->fileFormatExtension = \OpenAPI\OpenAPI\Models\Operations\GetGeomarksGeomarkIdFileFormatExtensionFileFormatExtensionEnum::JSON;
		$this->geomarkId = "";
		$this->srid = null;
	}
}
