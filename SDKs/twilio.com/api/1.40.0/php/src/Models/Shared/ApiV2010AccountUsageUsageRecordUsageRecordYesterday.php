...
class ApiV2010AccountUsageUsageRecordUsageRecordYesterday
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\UsageRecordYesterdayEnumCategoryEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?UsageRecordYesterdayEnumCategoryEnum $category = null;
