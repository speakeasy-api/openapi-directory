...
exports.GetMaintenanceWindowExecutionResponse = exports.GetMaintenanceWindowExecutionRequest = exports.GetMaintenanceWindowExecutionXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GetMaintenanceWindowExecutionXAmzTargetEnum;
...
})(GetMaintenanceWindowExecutionXAmzTargetEnum = exports.GetMaintenanceWindowExecutionXAmzTargetEnum || (exports.GetMaintenanceWindowExecutionXAmzTargetEnum = {}));
var GetMaintenanceWindowExecutionRequest = /** @class */ (function (_super) {
    ...
    ], GetMaintenanceWindowExecutionRequest.prototype, "getMaintenanceWindowExecutionRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], GetMaintenanceWindowExecutionRequest.prototype, "xAmzTarget", void 0);
...
var GetMaintenanceWindowExecutionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetMaintenanceWindowExecutionResponse.prototype, "rawResponse", void 0);
    return GetMaintenanceWindowExecutionResponse;
}(utils_1.SpeakeasyBase));
exports.GetMaintenanceWindowExecutionResponse = GetMaintenanceWindowExecutionResponse;
