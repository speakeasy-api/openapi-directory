...
public class GetContinueWatchingListQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetContinueWatchingListQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetContinueWatchingListQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetContinueWatchingListQueryParams withInclude(GetContinueWatchingListIncludeEnum[] include) {
    ...
    public String lang;
    public GetContinueWatchingListQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetContinueWatchingListQueryParams withMaxRating(String maxRating) {
    ...
    public Integer page;
    public GetContinueWatchingListQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public GetContinueWatchingListQueryParams withPageSize(Integer pageSize) {
    ...
    public GetContinueWatchingListQueryParams withSegments(String[] segments) {
    ...
    public GetContinueWatchingListQueryParams withShowItemType(GetContinueWatchingListShowItemTypeEnum showItemType) {
    ...
    public String sub;
    public GetContinueWatchingListQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
