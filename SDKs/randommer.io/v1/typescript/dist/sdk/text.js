...
var Text = /** @class */ (function () {
    function Text(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Text.prototype.getApiTextLoremIpsum = function (req, config) {
    ...
    **/
    Text.prototype.getApiTextPassword = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Text.prototype.postApiTextHumanize = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Text.prototype.postApiTextTransform = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
