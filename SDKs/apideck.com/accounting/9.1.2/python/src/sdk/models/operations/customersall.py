...
from ..shared import customersfilter as shared_customersfilter
from ..shared import getcustomersresponse as shared_getcustomersresponse
...
class CustomersAllRequest:
    ...
    filter: Optional[shared_customersfilter.CustomersFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
class CustomersAllResponse:
    ...
    r"""Bad Request"""  
    get_customers_response: Optional[shared_getcustomersresponse.GetCustomersResponse] = dataclasses.field(default=None)
    r"""Customers"""  
