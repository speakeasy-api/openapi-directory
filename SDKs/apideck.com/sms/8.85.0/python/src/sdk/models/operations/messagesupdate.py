...
from ..shared import updatemessageresponse as shared_updatemessageresponse


@dataclasses.dataclass
class MessagesUpdatePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class MessagesUpdateQueryParams:
    raw: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'raw', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class MessagesUpdateHeaders:
...
@dataclasses.dataclass
class MessagesUpdateSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class MessagesUpdateRequest:
    headers: MessagesUpdateHeaders = dataclasses.field()
    path_params: MessagesUpdatePathParams = dataclasses.field()
    query_params: MessagesUpdateQueryParams = dataclasses.field()
    request: shared_message.MessageInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: MessagesUpdateSecurity = dataclasses.field()
    

@dataclasses.dataclass
class MessagesUpdateResponse:
    ...
    update_message_response: Optional[shared_updatemessageresponse.UpdateMessageResponse] = dataclasses.field(default=None)
