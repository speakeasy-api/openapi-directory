...
exports.VppAccounts = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var VppAccounts = /** @class */ (function () {
    function VppAccounts(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VppAccounts.prototype.getOrganizationSmVppAccount = function (req, config) {
    ...
    **/
    VppAccounts.prototype.getOrganizationSmVppAccounts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.VppAccounts = VppAccounts;
