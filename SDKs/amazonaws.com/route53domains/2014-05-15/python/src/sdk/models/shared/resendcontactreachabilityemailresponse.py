...
class ResendContactReachabilityEmailResponse:
    ...
    is_already_verified: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('isAlreadyVerified'), 'exclude': lambda f: f is None }})  
