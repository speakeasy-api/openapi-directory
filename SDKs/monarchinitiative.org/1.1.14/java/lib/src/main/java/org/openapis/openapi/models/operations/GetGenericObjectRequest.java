...
public class GetGenericObjectRequest {
    ...
    public GetGenericObjectRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenericObjectRequest withEvidence(String evidence) {
    ...
    public GetGenericObjectRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenericObjectRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenericObjectRequest withFacetFields(String[] facetFields) {
    ...
    public GetGenericObjectRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGenericObjectRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGenericObjectRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGenericObjectRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGenericObjectRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGenericObjectRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenericObjectRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGenericObjectRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
