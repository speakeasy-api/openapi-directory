...
class ListServiceConversationMessageReceiptListServiceConversationMessageReceiptResponse:
    ...
    delivery_receipts: Optional[list[shared_conversations_v1_service_service_conversation_service_conversation_message_service_conversation_message_receipt.ConversationsV1ServiceServiceConversationServiceConversationMessageServiceConversationMessageReceipt]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('delivery_receipts'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListServiceConversationMessageReceiptListServiceConversationMessageReceiptResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
