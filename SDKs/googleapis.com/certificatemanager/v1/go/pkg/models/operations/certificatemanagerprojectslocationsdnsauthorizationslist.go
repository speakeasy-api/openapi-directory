...
type CertificatemanagerProjectsLocationsDNSAuthorizationsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CertificatemanagerProjectsLocationsDNSAuthorizationsListPathParams struct {
...
type CertificatemanagerProjectsLocationsDNSAuthorizationsListQueryParams struct {
	// V1 error format.
...
type CertificatemanagerProjectsLocationsDNSAuthorizationsListRequest struct {
...
type CertificatemanagerProjectsLocationsDNSAuthorizationsListResponse struct {
	ContentType string
	// Successful response
