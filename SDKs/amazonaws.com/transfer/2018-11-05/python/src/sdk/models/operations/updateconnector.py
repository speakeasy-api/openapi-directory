...
class UpdateConnectorXAmzTargetEnum(str, Enum):
...
class UpdateConnectorRequest:
    ...
    update_connector_request: shared_updateconnectorrequest.UpdateConnectorRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_target: UpdateConnectorXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})  
