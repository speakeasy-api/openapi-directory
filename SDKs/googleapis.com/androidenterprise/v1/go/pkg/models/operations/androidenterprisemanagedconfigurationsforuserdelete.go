...
type AndroidenterpriseManagedconfigurationsforuserDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseManagedconfigurationsforuserDeletePathParams struct {
...
type AndroidenterpriseManagedconfigurationsforuserDeleteQueryParams struct {
	// V1 error format.
...
type AndroidenterpriseManagedconfigurationsforuserDeleteRequest struct {
...
type AndroidenterpriseManagedconfigurationsforuserDeleteResponse struct {
	ContentType string
	StatusCode  int
