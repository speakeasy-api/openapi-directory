 ...
 * 
 */
public class GETDebitMemoTypewithSuccess {
    /**
    ...
    public GETDebitMemoTypewithSuccess withIntegrationIdNS(String integrationIdNS) {
    ...
    public GETDebitMemoTypewithSuccess withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public GETDebitMemoTypewithSuccess withSyncDateNS(String syncDateNS) {
    ...
    public GETDebitMemoTypewithSuccess withAccountId(String accountId) {
    ...
    public GETDebitMemoTypewithSuccess withAmount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public GETDebitMemoTypewithSuccess withAutoPay(Boolean autoPay) {
    ...
    public GETDebitMemoTypewithSuccess withBalance(Double balance) {
    ...
    public GETDebitMemoTypewithSuccess withBeAppliedAmount(Double beAppliedAmount) {
    ...
    public GETDebitMemoTypewithSuccess withCancelledById(String cancelledById) {
    ...
    public GETDebitMemoTypewithSuccess withCancelledOn(OffsetDateTime cancelledOn) {
    ...
    public GETDebitMemoTypewithSuccess withComment(String comment) {
    ...
    public GETDebitMemoTypewithSuccess withCreatedById(String createdById) {
    ...
    public GETDebitMemoTypewithSuccess withCreatedDate(OffsetDateTime createdDate) {
    ...
    public GETDebitMemoTypewithSuccess withDebitMemoDate(LocalDate debitMemoDate) {
    ...
    public GETDebitMemoTypewithSuccess withDueDate(LocalDate dueDate) {
    ...
    @JsonProperty("id")
    public String id;
    public GETDebitMemoTypewithSuccess withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GETDebitMemoTypewithSuccess withLatestPDFFileId(String latestPDFFileId) {
    ...
    public GETDebitMemoTypewithSuccess withNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    public GETDebitMemoTypewithSuccess withPostedById(String postedById) {
    ...
    public GETDebitMemoTypewithSuccess withPostedOn(OffsetDateTime postedOn) {
    ...
    public GETDebitMemoTypewithSuccess withReasonCode(String reasonCode) {
    ...
    public GETDebitMemoTypewithSuccess withReferredInvoiceId(String referredInvoiceId) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("status")
    public GETDebitMemoTypewithSuccessStatusEnum status;
    public GETDebitMemoTypewithSuccess withStatus(GETDebitMemoTypewithSuccessStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public GETDebitMemoTypewithSuccess withTargetDate(LocalDate targetDate) {
    ...
    public GETDebitMemoTypewithSuccess withTaxAmount(Double taxAmount) {
    ...
    public GETDebitMemoTypewithSuccess withTaxMessage(String taxMessage) {
    ...
    public GETDebitMemoTypewithSuccessTaxStatusEnum taxStatus;
    public GETDebitMemoTypewithSuccess withTaxStatus(GETDebitMemoTypewithSuccessTaxStatusEnum taxStatus) {
    ...
    public GETDebitMemoTypewithSuccess withTotalTaxExemptAmount(Double totalTaxExemptAmount) {
    ...
    public GETDebitMemoTypewithSuccessTransferredToAccountingEnum transferredToAccounting;
    public GETDebitMemoTypewithSuccess withTransferredToAccounting(GETDebitMemoTypewithSuccessTransferredToAccountingEnum transferredToAccounting) {
    ...
    public GETDebitMemoTypewithSuccess withUpdatedById(String updatedById) {
    ...
    public GETDebitMemoTypewithSuccess withUpdatedDate(OffsetDateTime updatedDate) {
