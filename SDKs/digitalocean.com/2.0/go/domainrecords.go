...
func NewDomainRecords(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *DomainRecords {
...
func (s *DomainRecords) CreateDomainRecord(ctx context.Context, request operations.CreateDomainRecordRequest) (*operations.CreateDomainRecordResponse, error) {
...
func (s *DomainRecords) DeleteDomainRecord(ctx context.Context, request operations.DeleteDomainRecordRequest) (*operations.DeleteDomainRecordResponse, error) {
	baseURL := s._serverURL
...
func (s *DomainRecords) GetDomainRecord(ctx context.Context, request operations.GetDomainRecordRequest) (*operations.GetDomainRecordResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/domains/{domain_name}/records/{domain_record_id}", request.PathParams)
...
func (s *DomainRecords) ListAllDomainRecords(ctx context.Context, request operations.ListAllDomainRecordsRequest) (*operations.ListAllDomainRecordsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/domains/{domain_name}/records", request.PathParams)
...
func (s *DomainRecords) PatchUpdateDomainRecord(ctx context.Context, request operations.PatchUpdateDomainRecordRequest) (*operations.PatchUpdateDomainRecordResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/domains/{domain_name}/records/{domain_record_id}", request.PathParams)
...
// See the [attribute table](#tag/Domain-Records) for details regarding record
// types and their respective attributes.
func (s *DomainRecords) UpdateDomainRecord(ctx context.Context, request operations.UpdateDomainRecordRequest) (*operations.UpdateDomainRecordResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2/domains/{domain_name}/records/{domain_record_id}", request.PathParams)
