...
export class InvoicesAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class InvoicesAddRequest extends SpeakeasyBase {
...
export class InvoicesAddResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
