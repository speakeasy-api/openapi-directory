 ...
 */
export class UpdateFieldLevelEncryptionConfig20181105RequestBodyFieldLevelEncryptionConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateFieldLevelEncryptionConfig20181105RequestBody extends SpeakeasyBase {
  /**
   * A complex data type that includes the profile configurations specified for field-level encryption.
   */
  @SpeakeasyMetadata()
