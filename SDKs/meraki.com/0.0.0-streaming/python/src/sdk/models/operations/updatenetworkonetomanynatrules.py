...
class UpdateNetworkOneToManyNatRulesRequestBodyRulesPortRulesProtocolEnum(str, Enum):
    r"""'tcp' or 'udp'"""
    TCP = 'tcp'
    UDP = 'udp'
...
class UpdateNetworkOneToManyNatRulesRequestBodyRulesPortRules:
    ...
    protocol: Optional[UpdateNetworkOneToManyNatRulesRequestBodyRulesPortRulesProtocolEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol'), 'exclude': lambda f: f is None }})
    r"""'tcp' or 'udp'"""  
...
class UpdateNetworkOneToManyNatRulesRequestBodyRulesUplinkEnum(str, Enum):
...
class UpdateNetworkOneToManyNatRulesRequestBodyRules:
    ...
    port_rules: list[UpdateNetworkOneToManyNatRulesRequestBodyRulesPortRules] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portRules') }})
    ...
    uplink: UpdateNetworkOneToManyNatRulesRequestBodyRulesUplinkEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uplink') }})
    r"""The physical WAN interface on which the traffic will arrive ('internet1' or, if available, 'internet2')"""  
...
class UpdateNetworkOneToManyNatRulesRequestBody:
    ...
    rules: list[UpdateNetworkOneToManyNatRulesRequestBodyRules] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules') }})
...
class UpdateNetworkOneToManyNatRulesRequest:
    ...
    request_body: UpdateNetworkOneToManyNatRulesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateNetworkOneToManyNatRulesResponse:
    ...
    update_network_one_to_many_nat_rules_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
