...
from ..shared import deletescalingpolicyinput as shared_deletescalingpolicyinput
...
class DeleteScalingPolicyRequest:
    ...
    request: shared_deletescalingpolicyinput.DeleteScalingPolicyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
