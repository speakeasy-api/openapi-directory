...
class GetNetworkPiiPiiKeysPathParams:
    network_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'networkId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetNetworkPiiPiiKeysQueryParams:
...
class GetNetworkPiiPiiKeysRequest:
    path_params: GetNetworkPiiPiiKeysPathParams = dataclasses.field()
    query_params: GetNetworkPiiPiiKeysQueryParams = dataclasses.field()
