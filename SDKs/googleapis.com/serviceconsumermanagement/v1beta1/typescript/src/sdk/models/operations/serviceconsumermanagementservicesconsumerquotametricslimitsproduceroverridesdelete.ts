...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export enum ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteForceOnlyEnum {
...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
