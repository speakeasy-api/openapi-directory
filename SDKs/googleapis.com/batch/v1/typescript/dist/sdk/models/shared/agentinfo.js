...
var AgentInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "taskGroupId" }),
        __metadata("design:type", String)
    ], AgentInfo.prototype, "taskGroupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: agenttaskinfo_1.AgentTaskInfo }),
        (0, class_transformer_1.Expose)({ name: "tasks" }),
        (0, class_transformer_1.Type)(function () { return agenttaskinfo_1.AgentTaskInfo; }),
