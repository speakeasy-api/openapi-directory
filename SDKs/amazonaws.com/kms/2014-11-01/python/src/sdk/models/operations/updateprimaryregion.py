...
class UpdatePrimaryRegionRequest:
    headers: UpdatePrimaryRegionHeaders = dataclasses.field()
    request: shared_updateprimaryregionrequest.UpdatePrimaryRegionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
