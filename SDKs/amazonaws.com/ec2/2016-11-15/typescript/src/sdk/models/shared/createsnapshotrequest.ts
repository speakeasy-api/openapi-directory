 ...
 */
export enum CreateSnapshotRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateSnapshotRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateSnapshotRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateSnapshotRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateSnapshotRequestTagSpecificationsTags })
...
export class CreateSnapshotRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: CreateSnapshotRequestTagSpecifications })
