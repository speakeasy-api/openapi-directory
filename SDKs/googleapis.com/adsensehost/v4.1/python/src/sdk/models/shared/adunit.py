...
class AdUnitContentAdsSettingsBackupOption:
    ...
    r"""Color to use when type is set to COLOR. These are represented as six hexadecimal characters, similar to HTML color codes, but without the leading hash."""  
...
class AdUnitContentAdsSettings:
    ...
    r"""Size of this ad unit. Size values are in the form SIZE_{width}_{height}."""  
    type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Type of this ad unit. Possible values are TEXT, TEXT_IMAGE, IMAGE and LINK."""  
...
class AdUnit:
    ...
    r"""Kind of resource this is, in this case adsensehost#adUnit."""  
