...
class RegionInfo:
    r"""Information about a Amazon Web Services Region in your replication set."""
    
    status: shared_regionstatus_enum.RegionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})  
