...
var ServicePrincipal = /** @class */ (function () {
    ...
    **/
    ServicePrincipal.prototype.servicePrincipalsCreate = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/{tenantID}/servicePrincipals", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.servicePrincipal = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    ServicePrincipal.prototype.servicePrincipalsDelete = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{tenantID}/servicePrincipals/{objectId}", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    ServicePrincipal.prototype.servicePrincipalsList = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.servicePrincipalListResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.matchContentType(contentType, "text/json")) {
                        res.servicePrincipalListResult = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
