...
class GetMeMentionedOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeMentionedSortEnum(str, Enum):
    CREATION = "creation"
    VOTES = "votes"


@dataclasses.dataclass
class GetMeMentionedQueryParams:
    ...
    order: Optional[GetMeMentionedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeMentionedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeMentionedRequest:
    query_params: GetMeMentionedQueryParams = dataclasses.field()
