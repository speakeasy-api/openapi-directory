...
class Hits:
    ...
    def hits_get_hits(self, request: operations.HitsGetHitsRequest) -> operations.HitsGetHitsResponse:
        ...
        query_params = utils.get_query_params(operations.HitsGetHitsRequest, request)
        ...
        res = operations.HitsGetHitsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
