...
exports.ListWebhookResponse = exports.ListWebhookListWebhookResponse = exports.ListWebhookListWebhookResponseMeta = exports.ListWebhookRequest = exports.ListWebhookSecurity = exports.ListWebhookServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListWebhookServerList = ["https://verify.twilio.com"];
var ListWebhookSecurity = /** @class */ (function (_super) {
    ...
    ], ListWebhookSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListWebhookSecurity.prototype, "username", void 0);
...
var ListWebhookRequest = /** @class */ (function (_super) {
    ...
    ], ListWebhookRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListWebhookRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListWebhookRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListWebhookRequest.prototype, "serviceSid", void 0);
...
var ListWebhookListWebhookResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListWebhookListWebhookResponseMeta; }),
        __metadata("design:type", ListWebhookListWebhookResponseMeta)
    ], ListWebhookListWebhookResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.VerifyV2ServiceWebhook }),
        (0, class_transformer_1.Expose)({ name: "webhooks" }),
        (0, class_transformer_1.Type)(function () { return shared.VerifyV2ServiceWebhook; }),
...
var ListWebhookResponse = /** @class */ (function (_super) {
    ...
    ], ListWebhookResponse.prototype, "rawResponse", void 0);
