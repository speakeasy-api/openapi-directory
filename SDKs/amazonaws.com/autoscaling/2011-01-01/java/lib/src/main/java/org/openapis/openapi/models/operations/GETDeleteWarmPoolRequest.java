...
public class GETDeleteWarmPoolRequest {
    ...
    public GETDeleteWarmPoolRequest(@JsonProperty("Action") GETDeleteWarmPoolActionEnum action, @JsonProperty("AutoScalingGroupName") String autoScalingGroupName, @JsonProperty("Version") GETDeleteWarmPoolVersionEnum version) {
        this.action = action;
        this.autoScalingGroupName = autoScalingGroupName;
        this.version = version;
  }
