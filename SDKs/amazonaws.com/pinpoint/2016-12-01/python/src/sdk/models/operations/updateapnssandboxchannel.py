...
class UpdateAPNSSandboxChannelRequestBodyAPNSSandboxChannelRequest:
    r"""Specifies the status and settings of the APNs (Apple Push Notification service) sandbox channel for an application."""
...
class UpdateApnsSandboxChannelRequestBody:
    ...
    apns_sandbox_channel_request: UpdateAPNSSandboxChannelRequestBodyAPNSSandboxChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('APNSSandboxChannelRequest') }})
    r"""Specifies the status and settings of the APNs (Apple Push Notification service) sandbox channel for an application."""  
...
class UpdateApnsSandboxChannelRequest:
    ...
    request_body: UpdateApnsSandboxChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
