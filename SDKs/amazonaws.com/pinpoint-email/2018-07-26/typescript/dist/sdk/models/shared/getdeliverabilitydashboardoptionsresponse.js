...
var GetDeliverabilityDashboardOptionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: domaindeliverabilitytrackingoption_1.DomainDeliverabilityTrackingOption }),
        (0, class_transformer_1.Expose)({ name: "ActiveSubscribedDomains" }),
        (0, class_transformer_1.Type)(function () { return domaindeliverabilitytrackingoption_1.DomainDeliverabilityTrackingOption; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: domaindeliverabilitytrackingoption_1.DomainDeliverabilityTrackingOption }),
        (0, class_transformer_1.Expose)({ name: "PendingExpirationSubscribedDomains" }),
        (0, class_transformer_1.Type)(function () { return domaindeliverabilitytrackingoption_1.DomainDeliverabilityTrackingOption; }),
        __metadata("design:type", Array)
    ], GetDeliverabilityDashboardOptionsResponse.prototype, "pendingExpirationSubscribedDomains", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "SubscriptionExpiryDate" }),
