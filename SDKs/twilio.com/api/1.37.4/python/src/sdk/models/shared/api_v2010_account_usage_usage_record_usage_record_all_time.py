...
class APIV2010AccountUsageUsageRecordUsageRecordAllTime:
    ...
    category: Optional[shared_usage_record_all_time_enum_category_enum.UsageRecordAllTimeEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('category') }})
