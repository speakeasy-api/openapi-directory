...
class GetPaymentCancellationScaStatusPathParams:
...
@dataclasses.dataclass
class GetPaymentCancellationScaStatusHeaders:
...
@dataclasses.dataclass
class GetPaymentCancellationScaStatusSecurity:
...
@dataclasses.dataclass
class GetPaymentCancellationScaStatusRequest:
    headers: GetPaymentCancellationScaStatusHeaders = dataclasses.field()
    path_params: GetPaymentCancellationScaStatusPathParams = dataclasses.field()
    security: GetPaymentCancellationScaStatusSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetPaymentCancellationScaStatusResponse:
