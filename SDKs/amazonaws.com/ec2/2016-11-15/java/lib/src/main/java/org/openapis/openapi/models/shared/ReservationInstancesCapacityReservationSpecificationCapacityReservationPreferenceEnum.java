 ...
 */
public enum ReservationInstancesCapacityReservationSpecificationCapacityReservationPreferenceEnum {
    OPEN("open"),
    NONE("none");
    ...
    private ReservationInstancesCapacityReservationSpecificationCapacityReservationPreferenceEnum(String value) {
        this.value = value;
    }
}
