 ...
 */
public enum StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsResourceTypeEnum {
    ...
    private StartNetworkInsightsAccessScopeAnalysisRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
