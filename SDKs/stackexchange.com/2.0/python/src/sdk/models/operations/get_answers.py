...
class GetAnswersQueryParams:
    ...
    order: Optional[GetAnswersOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetAnswersSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetAnswersRequest:
    query_params: GetAnswersQueryParams = dataclasses.field()
