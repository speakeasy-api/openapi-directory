...
public class AuditLogAPI {
	...
	public AuditLogAPI(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.GetAuditLogEventsResponse getAuditLogEvents(org.openapis.openapi.models.operations.GetAuditLogEventsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.GetAuditLogEvents200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetAuditLogEvents200ApplicationJSON.class);
