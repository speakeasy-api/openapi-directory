...
type BaremetalsolutionProjectsLocationsNetworksListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BaremetalsolutionProjectsLocationsNetworksListPathParams struct {
	// Required. Parent value for ListNetworksRequest.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type BaremetalsolutionProjectsLocationsNetworksListQueryParams struct {
	// V1 error format.
...
type BaremetalsolutionProjectsLocationsNetworksListRequest struct {
...
type BaremetalsolutionProjectsLocationsNetworksListResponse struct {
	ContentType string
	// Successful response
