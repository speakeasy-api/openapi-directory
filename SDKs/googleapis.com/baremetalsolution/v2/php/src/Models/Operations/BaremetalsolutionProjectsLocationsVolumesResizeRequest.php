...
class BaremetalsolutionProjectsLocationsVolumesResizeRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ResizeVolumeRequest $resizeVolumeRequest = null;
