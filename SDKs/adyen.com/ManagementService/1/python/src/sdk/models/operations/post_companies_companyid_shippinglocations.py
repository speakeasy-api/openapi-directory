...
class PostCompaniesCompanyIDShippingLocationsSecurity:
...
@dataclasses.dataclass
class PostCompaniesCompanyIDShippingLocationsRequest:
    
    company_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'companyId', 'style': 'simple', 'explode': False }})
    r"""The unique identifier of the company account."""  
    shipping_location: Optional[shared_shippinglocation.ShippingLocation] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclasses.dataclass
class PostCompaniesCompanyIDShippingLocationsResponse:
    ...
    shipping_location: Optional[shared_shippinglocation.ShippingLocation] = dataclasses.field(default=None)
