...
class UpdateFieldLevelEncryptionProfile20190326Request:
    headers: UpdateFieldLevelEncryptionProfile20190326Headers = dataclasses.field()
    path_params: UpdateFieldLevelEncryptionProfile20190326PathParams = dataclasses.field()
