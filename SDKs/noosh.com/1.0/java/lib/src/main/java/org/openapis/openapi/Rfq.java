...
public class Rfq {
	...
	public Rfq(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.GetRfqResponse getRfq(org.openapis.openapi.models.operations.GetRfqRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.RfqExpandVO out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.RfqExpandVO.class);
                res.rfqExpandVO = out;
            }
    ...
    public org.openapis.openapi.models.operations.GetRfqListResponse getRfqList(org.openapis.openapi.models.operations.GetRfqListRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.RfqListVO out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.RfqListVO.class);
                res.rfqListVO = out;
            }
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/x-json-smile")) {
                ObjectMapper mapper = JSON.getMapper();
