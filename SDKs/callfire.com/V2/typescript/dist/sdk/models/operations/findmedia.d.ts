...
export declare class FindMediaSecurity extends SpeakeasyBase {
    password: string;
    username: string;
}
export declare class FindMediaRequest extends SpeakeasyBase {
    /**
...
export declare class FindMediaResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Bad request
     */
