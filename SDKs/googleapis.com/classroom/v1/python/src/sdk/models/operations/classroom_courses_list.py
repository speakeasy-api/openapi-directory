...
class ClassroomCoursesListQueryParams:
...
class ClassroomCoursesListRequest:
    query_params: ClassroomCoursesListQueryParams = dataclasses.field()
    security: ClassroomCoursesListSecurity = dataclasses.field()
