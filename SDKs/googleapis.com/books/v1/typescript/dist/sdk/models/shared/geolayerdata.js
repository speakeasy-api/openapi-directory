...
var GeolayerdataCommon = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "previewImageUrl" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "snippetUrl" }),
        __metadata("design:type", String)
...
var GeolayerdataGeoViewport = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hi" }),
        (0, class_transformer_1.Type)(function () { return GeolayerdataGeoViewportHi; }),
        __metadata("design:type", GeolayerdataGeoViewportHi)
    ], GeolayerdataGeoViewport.prototype, "hi", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lo" }),
        (0, class_transformer_1.Type)(function () { return GeolayerdataGeoViewportLo; }),
...
var GeolayerdataGeo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "boundary" }),
        __metadata("design:type", Array)
    ], GeolayerdataGeo.prototype, "boundary", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "cachePolicy" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mapType" }),
        __metadata("design:type", String)
    ], GeolayerdataGeo.prototype, "mapType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "viewport" }),
        (0, class_transformer_1.Type)(function () { return GeolayerdataGeoViewport; }),
...
var Geolayerdata = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return GeolayerdataCommon; }),
        __metadata("design:type", GeolayerdataCommon)
    ], Geolayerdata.prototype, "common", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "geo" }),
        (0, class_transformer_1.Type)(function () { return GeolayerdataGeo; }),
