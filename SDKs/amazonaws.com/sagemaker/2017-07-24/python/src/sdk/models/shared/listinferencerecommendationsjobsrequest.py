...
from ..shared import listinferencerecommendationsjobssortby_enum as shared_listinferencerecommendationsjobssortby_enum
...
class ListInferenceRecommendationsJobsRequest:
    ...
    sort_by: Optional[shared_listinferencerecommendationsjobssortby_enum.ListInferenceRecommendationsJobsSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    ...
    status_equals: Optional[shared_recommendationjobstatus_enum.RecommendationJobStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
