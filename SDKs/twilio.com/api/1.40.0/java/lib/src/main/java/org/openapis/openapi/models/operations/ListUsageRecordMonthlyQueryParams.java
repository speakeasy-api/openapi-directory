...
public class ListUsageRecordMonthlyQueryParams {
    ...
    public ListUsageRecordMonthlyQueryParams withCategory(org.openapis.openapi.models.shared.UsageRecordMonthlyEnumCategoryEnum category) {
    ...
    public Long page;
    public ListUsageRecordMonthlyQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListUsageRecordMonthlyQueryParams withPageToken(String pageToken) {
