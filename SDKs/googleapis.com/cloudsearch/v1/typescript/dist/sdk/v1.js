...
var V1 = /** @class */ (function () {
     ...
     */
    V1.prototype.cloudsearchInitializeCustomer = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudsearchInitializeCustomerRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1:initializeCustomer";
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.CloudsearchInitializeCustomerSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CloudsearchInitializeCustomerResponse({
