...
var Similarity = /** @class */ (function () {
    function Similarity(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Similarity.prototype.srcSearchlyApiV1ControllersSimilarityByContent = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SrcSearchlyApiV1ControllersSimilarityByContentRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/similarity/by_content";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.apiResponseSimilarity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                default:
                    if (utils.matchContentType(contentType, "application/text")) {
                        res.srcSearchlyApiV1ControllersSimilarityByContentDefaultApplicationTextString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
     ...
     *
    **/
    Similarity.prototype.srcSearchlyApiV1ControllersSimilarityBySong = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SrcSearchlyApiV1ControllersSimilarityBySongRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/similarity/by_song";
        var client = this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                default:
                    if (utils.matchContentType(contentType, "application/text")) {
                        res.srcSearchlyApiV1ControllersSimilarityBySongDefaultApplicationTextString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
