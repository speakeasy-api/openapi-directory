...
class PostAdminMappingsFindByMetadata200ApplicationJSONMappingsRequest:
    ...
    basic_auth_credentials: Optional[PostAdminMappingsFindByMetadata200ApplicationJSONMappingsRequestBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
...
class PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum(str, Enum):
    UNIFORM = 'uniform'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponseDelayDistributionUniform:
    ...
    type: Optional[PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponseDelayDistributionUniformTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum(str, Enum):
    LOGNORMAL = 'lognormal'
...
class PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponseDelayDistributionLogNormal:
    ...
    type: Optional[PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponseDelayDistributionLogNormalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponse:
    ...
    fault: Optional[PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponseFaultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fault'), 'exclude': lambda f: f is None }})
    r"""The fault to apply (instead of a full, valid response)."""  
...
class PostAdminMappingsFindByMetadata200ApplicationJSONMappings:
    ...
    request: Optional[PostAdminMappingsFindByMetadata200ApplicationJSONMappingsRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})  
    ...
    response: Optional[PostAdminMappingsFindByMetadata200ApplicationJSONMappingsResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response'), 'exclude': lambda f: f is None }})  
...
class PostAdminMappingsFindByMetadata200ApplicationJSON:
    r"""Matched stub mappings"""
    
    mappings: Optional[list[PostAdminMappingsFindByMetadata200ApplicationJSONMappings]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mappings'), 'exclude': lambda f: f is None }})  
    meta: Optional[PostAdminMappingsFindByMetadata200ApplicationJSONMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
