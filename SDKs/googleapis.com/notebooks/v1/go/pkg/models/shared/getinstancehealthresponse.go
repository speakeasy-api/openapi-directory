...
func (e GetInstanceHealthResponseHealthStateEnum) ToPointer() *GetInstanceHealthResponseHealthStateEnum {
	return &e
}
...
func (e *GetInstanceHealthResponseHealthStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "AGENT_NOT_RUNNING":
		*e = GetInstanceHealthResponseHealthStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetInstanceHealthResponseHealthStateEnum: %v", v)
	}
}
