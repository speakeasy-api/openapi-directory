...
exports.GetPresidentialContributionsByCandidateResponse = exports.GetPresidentialContributionsByCandidateRequest = void 0;
...
var GetPresidentialContributionsByCandidateRequest = /** @class */ (function (_super) {
    ...
    ], GetPresidentialContributionsByCandidateRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=contributor_state",
        }),
        __metadata("design:type", Array)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "contributorState", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=election_year",
        }),
        __metadata("design:type", Array)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "electionYear", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetPresidentialContributionsByCandidateRequest.prototype, "sortNullsLast", void 0);
...
var GetPresidentialContributionsByCandidateResponse = /** @class */ (function (_super) {
    ...
    ], GetPresidentialContributionsByCandidateResponse.prototype, "rawResponse", void 0);
