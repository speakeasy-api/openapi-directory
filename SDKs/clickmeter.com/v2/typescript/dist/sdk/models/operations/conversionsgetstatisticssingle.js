...
exports.ConversionsGetStatisticsSingleResponse = exports.ConversionsGetStatisticsSingleRequest = exports.ConversionsGetStatisticsSingleTimeFrameEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Timeframe of the request. See list at $timeframeList
 */
var ConversionsGetStatisticsSingleTimeFrameEnum;
...
})(ConversionsGetStatisticsSingleTimeFrameEnum = exports.ConversionsGetStatisticsSingleTimeFrameEnum || (exports.ConversionsGetStatisticsSingleTimeFrameEnum = {}));
var ConversionsGetStatisticsSingleRequest = /** @class */ (function (_super) {
    ...
    ], ConversionsGetStatisticsSingleRequest.prototype, "conversionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=favourite",
        }),
        __metadata("design:type", Boolean)
    ], ConversionsGetStatisticsSingleRequest.prototype, "favourite", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fromDay",
        }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsSingleRequest.prototype, "fromDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=hourly",
        }),
        __metadata("design:type", Boolean)
    ], ConversionsGetStatisticsSingleRequest.prototype, "hourly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tag" }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsSingleRequest.prototype, "tag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeFrame",
        }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsSingleRequest.prototype, "timeFrame", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=toDay" }),
        __metadata("design:type", String)
    ], ConversionsGetStatisticsSingleRequest.prototype, "toDay", void 0);
    return ConversionsGetStatisticsSingleRequest;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetStatisticsSingleRequest = ConversionsGetStatisticsSingleRequest;
var ConversionsGetStatisticsSingleResponse = /** @class */ (function (_super) {
    ...
    ], ConversionsGetStatisticsSingleResponse.prototype, "rawResponse", void 0);
    return ConversionsGetStatisticsSingleResponse;
}(utils_1.SpeakeasyBase));
exports.ConversionsGetStatisticsSingleResponse = ConversionsGetStatisticsSingleResponse;
