...
var Alias = /** @class */ (function () {
    function Alias(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Alias.prototype.createAlias = function (req, config) {
        var _a;
    ...
    **/
    Alias.prototype.deleteAlias = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Alias.prototype.getAlias = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Alias.prototype.getAliases = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Alias.prototype.updateAlias = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
