...
PRODUCT_SEARCH_FILTEREDAND_ORDERED_SERVERS = [
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples:
...
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion:
    ...
    zero: Optional[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('0'), 'exclude': lambda f: f is None }})
    r"""Delivery SLA ID."""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferInstallments:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments:
    ...
    interest_rate: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interestRate') }})
    r"""Interest rate."""  
    seller_merchant_installments: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sellerMerchantInstallments') }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions:
    
    bin: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bin') }})
    r"""Bin."""  
    installments: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('installments') }})
    r"""Installments."""  
...
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptions:
    ...
    r"""GiftCards."""  
    installment_options: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('installmentOptions') }})
    ...
    r"""Payments."""  
    payment_systems: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('paymentSystems') }})
    r"""Payment systems."""  
...
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOffer:
    ...
    delivery_sla_samples: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeliverySlaSamples') }})
    r"""Delivery SLA samples."""  
    delivery_sla_samples_per_region: ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeliverySlaSamplesPerRegion') }})
    r"""Delivery SLA samples per region."""  
    ...
    installments: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferInstallments] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Installments') }})
    ...
    payment_options: ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOfferPaymentOptions = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PaymentOptions') }})
    r"""Payment options."""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductSearchFilteredandOrdered200ApplicationJSONItemsSellers:
    ...
    commertial_offer: ProductSearchFilteredandOrdered200ApplicationJSONItemsSellersCommertialOffer = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('commertialOffer') }})
    r"""AKA Commertial Condition."""  
...
class ProductSearchFilteredandOrdered200ApplicationJSONItems:
    ...
    images: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsImages] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('images') }})
    ...
    item_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('itemId') }})
    r"""SKU ID."""  
    kit_items: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsKitItems] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kitItems') }})
    ...
    r"""SKU complete name."""  
    reference_id: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsReferenceID] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('referenceId') }})
    r"""Reference code ID."""  
    sellers: list[ProductSearchFilteredandOrdered200ApplicationJSONItemsSellers] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sellers') }})
...
class ProductSearchFilteredandOrdered200ApplicationJSON:
    ...
    items: list[ProductSearchFilteredandOrdered200ApplicationJSONItems] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items') }})
...
class ProductSearchFilteredandOrderedResponse:
    ...
    product_search_filteredand_ordered_200_application_json_objects: Optional[list[ProductSearchFilteredandOrdered200ApplicationJSON]] = dataclasses.field(default=None)
    r"""OK"""  
