...
from ..shared import security as shared_security
from ..shared import googlecloudbillingbudgetsv1beta1updatebudgetrequest as shared_googlecloudbillingbudgetsv1beta1updatebudgetrequest
...
class BillingbudgetsBillingAccountsBudgetsPatchRequest:
    ...
    request: Optional[shared_googlecloudbillingbudgetsv1beta1updatebudgetrequest.GoogleCloudBillingBudgetsV1beta1UpdateBudgetRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
