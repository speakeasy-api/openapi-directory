 ...
 * An enumeration.
 */
export enum LocationsGetV2LocationsGetOrderByLocationsOrderEnum {
  City = "city",
  Country = "country",
  Location = "location",
 ...
 * An enumeration.
 */
export enum LocationsGetV2LocationsGetSortSortEnum {
  Asc = "asc",
  Desc = "desc",
}
...
export class LocationsGetV2LocationsGetRequest extends SpeakeasyBase {
  ...
  orderBy?: LocationsGetV2LocationsGetOrderByLocationsOrderEnum;
  ...
  sort?: LocationsGetV2LocationsGetSortSortEnum;
