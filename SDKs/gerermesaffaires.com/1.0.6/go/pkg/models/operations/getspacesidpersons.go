...
func (e GetSpacesIDPersonsValidatedEnum) ToPointer() *GetSpacesIDPersonsValidatedEnum {
	return &e
}
...
func (e *GetSpacesIDPersonsValidatedEnum) UnmarshalJSON(data []byte) error {
	...
	case "true":
		fallthrough
	case "false":
		*e = GetSpacesIDPersonsValidatedEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetSpacesIDPersonsValidatedEnum: %v", v)
	}
}
