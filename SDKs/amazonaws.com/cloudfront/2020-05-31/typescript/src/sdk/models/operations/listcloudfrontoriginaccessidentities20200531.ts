...
export class ListCloudFrontOriginAccessIdentities20200531Request extends SpeakeasyBase {
  /**
...
export class ListCloudFrontOriginAccessIdentities20200531Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
