...
class CreateBotVersionResponse:
    ...
    bot_version_locale_specification: Optional[dict[str, shared_botversionlocaledetails.BotVersionLocaleDetails]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('botVersionLocaleSpecification'), 'exclude': lambda f: f is None }})  
