 ...
 * @access public
 */
class InterestPaymentSimulationResultTransactionTransactionSourceCardSettlement
{
    /**
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementCurrencyEnum $currency
     */
	#[\JMS\Serializer\Annotation\SerializedName('currency')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementCurrencyEnum>')]
    public InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementCurrencyEnum $currency;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementTypeEnum>')]
    public InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementTypeEnum $type;
    
	public function __construct()
	{
		$this->amount = 0;
		$this->cardAuthorization = "";
		$this->currency = \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementCurrencyEnum::CAD;
		$this->id = "";
		...
		$this->type = \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCardSettlementTypeEnum::CARD_SETTLEMENT;
	}
}
