...
func (e DailyFantasyPlayersFormatEnum) ToPointer() *DailyFantasyPlayersFormatEnum {
	return &e
}
...
func (e *DailyFantasyPlayersFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = DailyFantasyPlayersFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DailyFantasyPlayersFormatEnum: %v", v)
	}
}
