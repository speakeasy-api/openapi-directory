...
public class ListPhoneNumberListPhoneNumberResponse {
    ...
    public openapisdk.models.shared.MessagingV1ServicePhoneNumber[] phoneNumbers;
    public ListPhoneNumberListPhoneNumberResponse withPhoneNumbers(openapisdk.models.shared.MessagingV1ServicePhoneNumber[] phoneNumbers) {
