...
class CancelImageCreationRequest:
    headers: CancelImageCreationHeaders = dataclasses.field()
    request: CancelImageCreationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
