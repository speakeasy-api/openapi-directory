...
public class MinimalRepositoryRepositoryTemplateRepository {
    ...
    public MinimalRepositoryRepositoryTemplateRepository withDeleteBranchOnMerge(Boolean deleteBranchOnMerge) {
    ...
    public MinimalRepositoryRepositoryTemplateRepository withTempCloneToken(String tempCloneToken) {
    ...
    public MinimalRepositoryRepositoryTemplateRepository withVisibility(String visibility) {
