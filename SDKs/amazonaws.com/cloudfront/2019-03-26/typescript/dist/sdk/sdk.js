...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.createCloudFrontOriginAccessIdentity20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateCloudFrontOriginAccessIdentity20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/origin-access-identity/cloudfront";
    ...
    **/
    SDK.prototype.createDistribution20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateDistribution20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/distribution";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.createDistributionWithTags20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateDistributionWithTags20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/distribution#WithTags";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 523:
                    ...
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 524:
                    if (utils.matchContentType(contentType, "text/xml")) {
                        var resBody = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, null, 0);
                        var out = new Uint8Array(resBody.length);
                        for (var i = 0; i < resBody.length; i++)
    ...
    **/
    SDK.prototype.createFieldLevelEncryptionConfig20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateFieldLevelEncryptionConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/field-level-encryption";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.createFieldLevelEncryptionProfile20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateFieldLevelEncryptionProfile20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/field-level-encryption-profile";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.createInvalidation20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateInvalidation20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/distribution/{DistributionId}/invalidation", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.createPublicKey20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreatePublicKey20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/public-key";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.createStreamingDistribution20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateStreamingDistribution20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/streaming-distribution";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.createStreamingDistributionWithTags20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateStreamingDistributionWithTags20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/streaming-distribution#WithTags";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.deleteCloudFrontOriginAccessIdentity20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteCloudFrontOriginAccessIdentity20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/origin-access-identity/cloudfront/{Id}", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    SDK.prototype.deleteDistribution20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteDistribution20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/distribution/{Id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.deleteFieldLevelEncryptionConfig20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFieldLevelEncryptionConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/field-level-encryption/{Id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.deleteFieldLevelEncryptionProfile20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFieldLevelEncryptionProfile20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/field-level-encryption-profile/{Id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.deletePublicKey20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeletePublicKey20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/public-key/{Id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.deleteStreamingDistribution20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteStreamingDistribution20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/streaming-distribution/{Id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.getCloudFrontOriginAccessIdentity20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCloudFrontOriginAccessIdentity20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/origin-access-identity/cloudfront/{Id}", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    SDK.prototype.getCloudFrontOriginAccessIdentityConfig20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCloudFrontOriginAccessIdentityConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/origin-access-identity/cloudfront/{Id}/config", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.getDistribution20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.getDistributionConfig20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetDistributionConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/distribution/{Id}/config", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.getFieldLevelEncryption20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.getFieldLevelEncryptionConfig20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFieldLevelEncryptionConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/field-level-encryption/{Id}/config", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.getFieldLevelEncryptionProfile20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.getFieldLevelEncryptionProfileConfig20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFieldLevelEncryptionProfileConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/field-level-encryption-profile/{Id}/config", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.getInvalidation20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetInvalidation20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/distribution/{DistributionId}/invalidation/{Id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.getPublicKey20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.getPublicKeyConfig20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPublicKeyConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/public-key/{Id}/config", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.getStreamingDistribution20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.getStreamingDistributionConfig20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetStreamingDistributionConfig20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/streaming-distribution/{Id}/config", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "get", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    **/
    SDK.prototype.listCloudFrontOriginAccessIdentities20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListCloudFrontOriginAccessIdentities20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/origin-access-identity/cloudfront";
        var client = this._securityClient;
    ...
    **/
    SDK.prototype.listDistributions20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.listDistributionsByWebAclId20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListDistributionsByWebAclId20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/distributionsByWebACLId/{WebACLId}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    **/
    SDK.prototype.listFieldLevelEncryptionConfigs20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.listFieldLevelEncryptionProfiles20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.listInvalidations20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.listPublicKeys20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.listStreamingDistributions20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.listTagsForResource20190326 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListTagsForResource20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/tagging#Resource";
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    **/
    SDK.prototype.tagResource20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TagResource20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/tagging#Operation=Tag&Resource";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.untagResource20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UntagResource20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2019-03-26/tagging#Operation=Untag&Resource";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.updateCloudFrontOriginAccessIdentity20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateCloudFrontOriginAccessIdentity20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/origin-access-identity/cloudfront/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
    ...
    **/
    SDK.prototype.updateDistribution20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.updateFieldLevelEncryptionConfig20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.updateFieldLevelEncryptionProfile20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateFieldLevelEncryptionProfile20190326Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/2019-03-26/field-level-encryption-profile/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
    ...
    **/
    SDK.prototype.updatePublicKey20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.updateStreamingDistribution20190326 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
