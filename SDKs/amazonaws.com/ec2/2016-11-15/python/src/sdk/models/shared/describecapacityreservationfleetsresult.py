...
class DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceMatchCriteriaEnum(str, Enum):
    r"""<p>Indicates the type of instance launches that the Capacity Reservation Fleet accepts. All Capacity Reservations in the Fleet inherit this instance matching criteria.</p> <p>Currently, Capacity Reservation Fleets support <code>open</code> instance matching criteria only. This means that instances that have matching attributes (instance type, platform, and Availability Zone) run in the Capacity Reservations automatically. Instances do not need to explicitly target a Capacity Reservation Fleet to use its reserved capacity.</p>"""
    OPEN = 'open'

class DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceTypeSpecificationsInstancePlatformEnum(str, Enum):
...
class DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceTypeSpecificationsInstanceTypeEnum(str, Enum):
...
class DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceTypeSpecifications:
    ...
    instance_platform: Optional[DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceTypeSpecificationsInstancePlatformEnum] = dataclasses.field(default=None)  
    instance_type: Optional[DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceTypeSpecificationsInstanceTypeEnum] = dataclasses.field(default=None)  
...
class DescribeCapacityReservationFleetsResultCapacityReservationFleets:
    ...
    instance_match_criteria: Optional[DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceMatchCriteriaEnum] = dataclasses.field(default=None)  
    instance_type_specifications: Optional[list[DescribeCapacityReservationFleetsResultCapacityReservationFleetsInstanceTypeSpecifications]] = dataclasses.field(default=None)  
    state: Optional[DescribeCapacityReservationFleetsResultCapacityReservationFleetsStateEnum] = dataclasses.field(default=None)  
    tags: Optional[list[DescribeCapacityReservationFleetsResultCapacityReservationFleetsTags]] = dataclasses.field(default=None)  
    tenancy: Optional[DescribeCapacityReservationFleetsResultCapacityReservationFleetsTenancyEnum] = dataclasses.field(default=None)  
...
class DescribeCapacityReservationFleetsResult:
    ...
    capacity_reservation_fleets: Optional[list[DescribeCapacityReservationFleetsResultCapacityReservationFleets]] = dataclasses.field(default=None)  
