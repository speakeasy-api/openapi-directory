...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.CreateCliTokenResponse createCliToken(openapisdk.models.operations.CreateCliTokenRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/clitoken/{Name}", request.pathParams);
        ...
        openapisdk.models.operations.CreateCliTokenResponse res = new openapisdk.models.operations.CreateCliTokenResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CreateCliTokenResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateCliTokenResponse.class);
    ...
    **/
    public openapisdk.models.operations.CreateEnvironmentResponse createEnvironment(openapisdk.models.operations.CreateEnvironmentRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/environments/{Name}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.CreateEnvironmentOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateEnvironmentOutput.class);
    ...
    **/
    public openapisdk.models.operations.CreateWebLoginTokenResponse createWebLoginToken(openapisdk.models.operations.CreateWebLoginTokenRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/webtoken/{Name}", request.pathParams);
        ...
        openapisdk.models.operations.CreateWebLoginTokenResponse res = new openapisdk.models.operations.CreateWebLoginTokenResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.CreateWebLoginTokenResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateWebLoginTokenResponse.class);
    ...
    public openapisdk.models.operations.GetEnvironmentResponse getEnvironment(openapisdk.models.operations.GetEnvironmentRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetEnvironmentOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetEnvironmentOutput.class);
    ...
    public openapisdk.models.operations.ListEnvironmentsResponse listEnvironments(openapisdk.models.operations.ListEnvironmentsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ListEnvironmentsOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ListEnvironmentsOutput.class);
    ...
    **/
    public openapisdk.models.operations.PublishMetricsResponse publishMetrics(openapisdk.models.operations.PublishMetricsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/metrics/environments/{EnvironmentName}", request.pathParams);
        ...
        openapisdk.models.operations.PublishMetricsResponse res = new openapisdk.models.operations.PublishMetricsResponse() {{
    ...
    public openapisdk.models.operations.UpdateEnvironmentResponse updateEnvironment(openapisdk.models.operations.UpdateEnvironmentRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateEnvironmentOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateEnvironmentOutput.class);
