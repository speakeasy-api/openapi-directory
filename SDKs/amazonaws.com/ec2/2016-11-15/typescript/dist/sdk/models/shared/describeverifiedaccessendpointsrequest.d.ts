 ...
 */
export declare class DescribeVerifiedAccessEndpointsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeVerifiedAccessEndpointsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeVerifiedAccessEndpointsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
