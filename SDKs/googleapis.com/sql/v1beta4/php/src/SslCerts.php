...
class SslCerts 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\SqlSslCertsCreateEphemeralResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/createEphemeral', \OpenAPI\OpenAPI\Models\Operations\SqlSslCertsCreateEphemeralRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts/{sha1Fingerprint}', \OpenAPI\OpenAPI\Models\Operations\SqlSslCertsDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts/{sha1Fingerprint}', \OpenAPI\OpenAPI\Models\Operations\SqlSslCertsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts', \OpenAPI\OpenAPI\Models\Operations\SqlSslCertsInsertRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts', \OpenAPI\OpenAPI\Models\Operations\SqlSslCertsListRequest::class, $request);
