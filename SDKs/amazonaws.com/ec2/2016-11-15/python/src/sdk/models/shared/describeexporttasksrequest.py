...
class DescribeExportTasksRequestFilters:
...
class DescribeExportTasksRequest:
    ...
    export_task_ids: Optional[list[str]] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeExportTasksRequestFilters]] = dataclasses.field(default=None)  
