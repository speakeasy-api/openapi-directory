...
class GetV2NotesJSONRequest:
    ...
    associated_with_id: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'associated_with_id', 'style': 'form', 'explode': True }})
    r"""ID of the item with which the note is associated.  The associated_with_type must also be present if this parameter is used"""  
    associated_with_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'associated_with_type', 'style': 'form', 'explode': True }})
    ...
    r"""IDs of notes to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
