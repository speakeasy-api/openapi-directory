...
class DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsDeletePathParams:
    ...
    keyword_value: str = dataclasses.field(metadata={'path_param': { 'field_name': 'keywordValue', 'style': 'simple', 'explode': False }})
...
class DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsDeleteRequest:
    path_params: DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsDeletePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsDeleteQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersNegativeKeywordListsNegativeKeywordsDeleteSecurity = dataclasses.field()
