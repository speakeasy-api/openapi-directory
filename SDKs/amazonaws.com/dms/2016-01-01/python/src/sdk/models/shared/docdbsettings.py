...
class DocDbSettings:
    ...
    docs_to_investigate: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DocsToInvestigate'), 'exclude': lambda f: f is None }})  
    extract_doc_id: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ExtractDocId'), 'exclude': lambda f: f is None }})  
