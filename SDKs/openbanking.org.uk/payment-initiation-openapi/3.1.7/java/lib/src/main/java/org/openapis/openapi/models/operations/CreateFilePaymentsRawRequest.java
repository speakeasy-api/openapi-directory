...
public class CreateFilePaymentsRawRequest {
    ...
    public CreateFilePaymentsRawRequest withAuthorization(String authorization) {
    ...
    public CreateFilePaymentsRawRequest withRequestBody(byte[] requestBody) {
    ...
    public CreateFilePaymentsRawRequest withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateFilePaymentsRawRequest withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateFilePaymentsRawRequest withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateFilePaymentsRawRequest withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateFilePaymentsRawRequest withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateFilePaymentsRawRequest withXJwsSignature(String xJwsSignature) {
        this.xJwsSignature = xJwsSignature;
        return this;
    }
    
    public CreateFilePaymentsRawRequest(@JsonProperty("Authorization") String authorization, @JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("x-idempotency-key") String xIdempotencyKey, @JsonProperty("x-jws-signature") String xJwsSignature) {
        this.authorization = authorization;
        this.requestBody = requestBody;
        this.xIdempotencyKey = xIdempotencyKey;
        this.xJwsSignature = xJwsSignature;
