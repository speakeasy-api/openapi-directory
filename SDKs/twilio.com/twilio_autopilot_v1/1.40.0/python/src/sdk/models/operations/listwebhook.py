...
class ListWebhookListWebhookResponse:
    ...
    webhooks: Optional[list[shared_autopilot_v1_assistant_webhook.AutopilotV1AssistantWebhook]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webhooks'), 'exclude': lambda f: f is None }})  
