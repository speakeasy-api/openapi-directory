...
from ..shared import proxygetinvoice as shared_proxygetinvoice
...
class ObjectGETInvoiceResponse:
    ...
    proxy_get_invoice: Optional[shared_proxygetinvoice.ProxyGetInvoice] = dataclasses.field(default=None)  
