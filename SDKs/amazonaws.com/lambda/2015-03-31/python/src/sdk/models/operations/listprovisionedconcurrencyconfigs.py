...
class ListProvisionedConcurrencyConfigsRequest:
    ...
    list_: ListProvisionedConcurrencyConfigsListEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'List', 'style': 'form', 'explode': True }})  
    ...
    r"""Specify a number to limit the number of configurations returned."""  
