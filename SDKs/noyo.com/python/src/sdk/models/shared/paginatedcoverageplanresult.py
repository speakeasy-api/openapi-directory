...
class PaginatedCoveragePlanResult:
    ...
    meta: PaginatedCoveragePlanResultMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta') }})
    r"""Metadata associated with the response data"""  
    response: list[shared_coverageplanresult.CoveragePlanResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response') }})
    r"""List of coverage plan results"""  
