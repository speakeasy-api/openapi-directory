...
public class ObjectPOSTUsageRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyCreateUsage proxyCreateUsage;
    public ObjectPOSTUsageRequest withProxyCreateUsage(org.openapis.openapi.models.shared.ProxyCreateUsage proxyCreateUsage) {
    ...
    public ObjectPOSTUsageRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ObjectPOSTUsageRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ObjectPOSTUsageRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
