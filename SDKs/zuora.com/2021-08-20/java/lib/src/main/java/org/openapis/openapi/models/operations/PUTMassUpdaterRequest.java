...
public class PUTMassUpdaterRequest {
    ...
    public PUTMassUpdaterRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public PUTMassUpdaterRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public PUTMassUpdaterRequest withBulkKey(String bulkKey) {
