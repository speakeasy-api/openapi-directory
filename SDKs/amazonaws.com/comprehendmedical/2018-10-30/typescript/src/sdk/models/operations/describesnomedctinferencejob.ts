...
export enum DescribeSNOMEDCTInferenceJobXAmzTargetEnum {
  ComprehendMedical20181030DescribeSNOMEDCTInferenceJob = "ComprehendMedical_20181030.DescribeSNOMEDCTInferenceJob",
}

export class DescribeSNOMEDCTInferenceJobRequest extends SpeakeasyBase {
...
export class DescribeSNOMEDCTInferenceJobResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
