...
public class Drives {
     ...
     * Get game drives
    **/
    public openapisdk.models.operations.GetDrivesResponse getDrives(openapisdk.models.operations.GetDrivesRequest request) throws Exception {
        ...
        openapisdk.models.operations.GetDrivesResponse res = new openapisdk.models.operations.GetDrivesResponse() {{
            drives = null;
        }};
