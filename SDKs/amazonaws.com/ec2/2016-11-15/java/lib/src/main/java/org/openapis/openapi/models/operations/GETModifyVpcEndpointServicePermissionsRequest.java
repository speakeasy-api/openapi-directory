...
public class GETModifyVpcEndpointServicePermissionsRequest {
    ...
    public GETModifyVpcEndpointServicePermissionsRequest(@JsonProperty("Action") GETModifyVpcEndpointServicePermissionsActionEnum action, @JsonProperty("ServiceId") String serviceId, @JsonProperty("Version") GETModifyVpcEndpointServicePermissionsVersionEnum version) {
        this.action = action;
        this.serviceId = serviceId;
        this.version = version;
  }
