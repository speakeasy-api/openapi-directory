 ...
 */
export enum GoogleAdsSearchads360V0ResourcesCampaignCriterionTypeEnum {
 ...
 */
export class GoogleAdsSearchads360V0ResourcesCampaignCriterion extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "device" })
  @Type(() => GoogleAdsSearchads360V0CommonDeviceInfo)
  ...
  @Type(() => GoogleAdsSearchads360V0CommonLanguageInfo)
  ...
  @Type(() => GoogleAdsSearchads360V0CommonLocationInfo)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "locationGroup" })
  @Type(() => GoogleAdsSearchads360V0CommonLocationGroupInfo)
