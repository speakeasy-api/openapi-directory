 ...
 */
export declare enum CreateInternetGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateInternetGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateInternetGatewayRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateInternetGatewayRequest extends SpeakeasyBase {
    dryRun?: boolean;
