...
type ContentConversionsourcesListPathParams struct {
	// Required. The ID of the account that owns the new conversion source.
	MerchantID string `pathParam:"style=simple,explode=false,name=merchantId"`
}

type ContentConversionsourcesListQueryParams struct {
	// V1 error format.
...
type ContentConversionsourcesListRequest struct {
	PathParams  ContentConversionsourcesListPathParams
	QueryParams ContentConversionsourcesListQueryParams
	Security    ContentConversionsourcesListSecurity
}
