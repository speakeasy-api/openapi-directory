...
export class GetConsentStatusPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=consentId" })
  consentId: string;
}


export class GetConsentStatusHeaders extends SpeakeasyBase {
...
export class GetConsentStatusSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class GetConsentStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetConsentStatusResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
