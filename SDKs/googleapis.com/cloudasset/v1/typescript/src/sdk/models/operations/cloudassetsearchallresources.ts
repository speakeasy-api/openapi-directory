...
export class CloudassetSearchAllResourcesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudassetSearchAllResourcesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudassetSearchAllResourcesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
