...
export class PostOrganisationsPartyIdElectronicAddressesRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class PostOrganisationsPartyIdElectronicAddressesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
