...
import dataclasses
from ..shared import tunnelinsideipversion_enum as shared_tunnelinsideipversion_enum
from ..shared import vpntunneloptionsspecification as shared_vpntunneloptionsspecification
...
class CreateVpnConnectionRequestOptions:
    r"""The options for the VPN connection."""
    ...
    tunnel_inside_ip_version: Optional[shared_tunnelinsideipversion_enum.TunnelInsideIPVersionEnum] = dataclasses.field(default=None)  
    tunnel_options: Optional[list[shared_vpntunneloptionsspecification.VpnTunnelOptionsSpecification]] = dataclasses.field(default=None)  
    
class CreateVpnConnectionRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateVpnConnectionRequestTagSpecifications:
    ...
    resource_type: Optional[CreateVpnConnectionRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateVpnConnectionRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateVpnConnectionRequest:
    r"""Contains the parameters for CreateVpnConnection."""
    
    customer_gateway_id: str = dataclasses.field()  
    type: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    options: Optional[CreateVpnConnectionRequestOptions] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateVpnConnectionRequestTagSpecifications]] = dataclasses.field(default=None)  
