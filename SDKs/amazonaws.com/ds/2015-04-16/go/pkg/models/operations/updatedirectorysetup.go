...
type UpdateDirectorySetupHeaders struct {
...
type UpdateDirectorySetupRequest struct {
	Headers UpdateDirectorySetupHeaders
	Request shared.UpdateDirectorySetupRequest `request:"mediaType=application/json"`
}
