...
public class ListCallSummariesRequest {
    ...
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=AnsweredBy")
    public org.openapis.openapi.models.shared.CallSummariesEnumAnsweredByEnum answeredBy;

    public ListCallSummariesRequest withAnsweredBy(org.openapis.openapi.models.shared.CallSummariesEnumAnsweredByEnum answeredBy) {
