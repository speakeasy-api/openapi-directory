...
class GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationRequest:
    headers: GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationHeaders = dataclasses.field()
    path_params: GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationPathParams = dataclasses.field()
    security: GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationSecurity = dataclasses.field()
