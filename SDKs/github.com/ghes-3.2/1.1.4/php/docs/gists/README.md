...
try {
    ...
    $request->files = [
        'reiciendis' => new GistsCreateRequestBodyFiles(),
    ];
    $request->public = true;
...
try {
    ...
    $request->commentId = 292794;
    $request->gistId = 'laborum';
...
try {
    ...
    $request->page = 417486;
    $request->perPage = 696077;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-08-15T21:51:46.128Z');
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-01-15T21:52:35.790Z');
    $request->username = 'Dorothy.Cormier';
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-09T12:57:54.030Z');
...
try {
    ...
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-10-18T02:58:04.604Z');
...
try {
    ...
    $request->requestBody->files = [
        'facilis' => new GistsUpdateRequestBody2Files1(),
        'incidunt' => new GistsUpdateRequestBody2Files2(),
        'debitis' => new GistsUpdateRequestBody2Files2(),
    ];
    $request->gistId = 'sit';
...
try {
    ...
    $request->requestBody->body = 'Body of the attachment';
    $request->commentId = 750595;
    $request->gistId = 'error';
