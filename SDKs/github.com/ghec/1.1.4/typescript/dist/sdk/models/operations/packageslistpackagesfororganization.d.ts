 ...
 */
export declare enum PackagesListPackagesForOrganizationPackageTypeEnum {
    Npm = "npm",
    Maven = "maven",
    Rubygems = "rubygems",
    Docker = "docker",
...
export declare class PackagesListPackagesForOrganizationRequest extends SpeakeasyBase {
    /**
...
export declare class PackagesListPackagesForOrganizationResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
