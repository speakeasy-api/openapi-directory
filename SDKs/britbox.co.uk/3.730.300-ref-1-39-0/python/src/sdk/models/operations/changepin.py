...
from ..shared import changepinrequest as shared_changepinrequest
...
class ChangePinRequest:
    ...
    change_pin_request: shared_changepinrequest.ChangePinRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The new account pin."""  
