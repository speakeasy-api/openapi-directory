...
public class OrderApiChangeStatusFormHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiChangeStatusFormHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiChangeStatusFormHeaders withXAuthSecret(String xAuthSecret) {
