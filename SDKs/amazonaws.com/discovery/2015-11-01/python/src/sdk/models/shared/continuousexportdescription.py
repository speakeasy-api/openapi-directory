...
class ContinuousExportDescription:
    r"""A list of continuous export descriptions."""
    ...
    status: Optional[shared_continuousexportstatus_enum.ContinuousExportStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})  
