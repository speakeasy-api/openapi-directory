...
class GetEmployerSummaryRequest:
...
@dataclasses.dataclass
class GetEmployerSummaryResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    employer_summary: Optional[Any] = dataclasses.field(default=None)
    r"""The employer summary object."""  
