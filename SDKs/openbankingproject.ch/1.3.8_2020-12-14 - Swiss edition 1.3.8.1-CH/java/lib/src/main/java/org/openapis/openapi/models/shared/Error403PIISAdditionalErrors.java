...
/**
 * Error403PIISAdditionalErrors - This is a data element to support the declaration of additional errors in the context of [RFC7807].
 */
public class Error403PIISAdditionalErrors {
    ...
    public Error403PIISAdditionalErrors(@JsonProperty("code") MessageCode403PIISEnum code) {
        this.code = code;
  }
}
