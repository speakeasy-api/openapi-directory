...
@dataclasses.dataclass
class ReportWebinarDetails200ApplicationXMLTrackingFields:
...
class ReportWebinarDetails200ApplicationXML:
    ...
    custom_keys: Optional[list[ReportWebinarDetails200ApplicationXMLCustomKeys]] = dataclasses.field(default=None)
    ...
    r"""Number of Webinar minutes. This represents the total amount of Webinar minutes attended by each participant including the host, for a Webinar hosted by the user. For instance if there were one host(named A) and one participant(named B) in a Webinar, the value of total_minutes would be calculated as below:
    
    **total_minutes** = Total Webinar Attendance Minutes of A + Total Webinar Attendance Minutes of B
    """  
    tracking_fields: Optional[list[ReportWebinarDetails200ApplicationXMLTrackingFields]] = dataclasses.field(default=None)
    r"""Tracking fields."""  
    ...
    r"""Webinar UUID. Each webinar instance will generate its own UUID(i.e., after a meeting ends, a new UUID will be generated when the next instance of the webinar starts). Double encode the UUID when using it for API calls if the UUID begins with a '/' or contains '//' in it."""  
...
class ReportWebinarDetails200ApplicationJSON:
    ...
    custom_keys: Optional[list[ReportWebinarDetails200ApplicationJSONCustomKeys]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom_keys'), 'exclude': lambda f: f is None }})
    r"""Custom keys and values assigned to the meeting."""  
    ...
    **total_minutes** = Total Webinar Attendance Minutes of A + Total Webinar Attendance Minutes of B
    """  
    tracking_fields: Optional[list[ReportWebinarDetails200ApplicationJSONTrackingFields]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tracking_fields'), 'exclude': lambda f: f is None }})
    r"""Tracking fields."""  
