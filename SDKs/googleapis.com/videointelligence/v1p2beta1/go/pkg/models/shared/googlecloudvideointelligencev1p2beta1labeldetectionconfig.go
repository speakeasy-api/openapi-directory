...
func (e GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum) ToPointer() *GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum {
	return &e
}

func (e *GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "SHOT_AND_FRAME_MODE":
		*e = GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfigLabelDetectionModeEnum: %v", v)
	}
}

// GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig - Config for LABEL_DETECTION.
