...
class DisplayvideoAdvertisersLocationListsPatchRequest:
    ...
    r"""Required. The ID of the DV360 advertiser to which the location lists belongs."""  
    ...
    location_list_input: Optional[shared_locationlist.LocationListInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class DisplayvideoAdvertisersLocationListsPatchResponse:
    ...
    location_list: Optional[shared_locationlist.LocationList] = dataclasses.field(default=None)
