...
class Actions:
    ...
    def collect_now(self, request: operations.CollectNowRequest) -> operations.CollectNowResponse:
        ...
        url = utils.generate_url(operations.CollectNowRequest, base_url, '/hardware/actions/{deviceId}/collect-now', request)
        
        query_params = utils.get_query_params(operations.CollectNowRequest, request)
        ...
        res = operations.CollectNowResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [200, 403, 500]:
    ...
    def rediscover(self, request: operations.RediscoverRequest) -> operations.RediscoverResponse:
        ...
        url = utils.generate_url(operations.RediscoverRequest, base_url, '/hardware/actions/{deviceId}/rediscover', request)
        ...
        res = operations.RediscoverResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def reinitialize(self, request: operations.ReinitializeRequest) -> operations.ReinitializeResponse:
        ...
        url = utils.generate_url(operations.ReinitializeRequest, base_url, '/hardware/actions/{deviceId}/reinitialize', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "reinitialize_action_configuration", 'json')
        ...
        res = operations.ReinitializeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove(self, request: operations.RemoveRequest) -> operations.RemoveResponse:
        ...
        url = utils.generate_url(operations.RemoveRequest, base_url, '/hardware/actions/{deviceId}/remove', request)
        
        query_params = utils.get_query_params(operations.RemoveRequest, request)
    ...
    def reset(self, request: operations.ResetRequest) -> operations.ResetResponse:
        ...
        url = utils.generate_url(operations.ResetRequest, base_url, '/hardware/actions/{deviceId}/reset-error-count', request)
        
        query_params = utils.get_query_params(operations.ResetRequest, request)
