...
class DialogflowProjectsLocationsAgentsEnvironmentsRunContinuousTestSecurity:
    ...
    option1: Optional[DialogflowProjectsLocationsAgentsEnvironmentsRunContinuousTestSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DialogflowProjectsLocationsAgentsEnvironmentsRunContinuousTestSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DialogflowProjectsLocationsAgentsEnvironmentsRunContinuousTestRequest:
    ...
    r"""Required. Format: `projects//locations//agents//environments/`."""  
