...
type PatientsOnpatientAccessDeletePathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type PatientsOnpatientAccessDeleteQueryParams struct {
...
type PatientsOnpatientAccessDeleteSecurity struct {
	DrchronoOauth2 shared.SchemeDrchronoOauth2 `security:"scheme,type=oauth2"`
}

type PatientsOnpatientAccessDeleteRequest struct {
...
type PatientsOnpatientAccessDeleteResponse struct {
	ContentType string
	StatusCode  int64
}
