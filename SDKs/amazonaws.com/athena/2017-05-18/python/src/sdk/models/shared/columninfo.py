...
class ColumnInfo:
    ...
    nullable: Optional[shared_columnnullable_enum.ColumnNullableEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Nullable') }})
