...
export declare class InventoryperdockandwarehouseRequest extends SpeakeasyBase {
    /**
...
export declare class Inventoryperdockandwarehouse200ApplicationJSON extends SpeakeasyBase {
    /**
...
export declare class InventoryperdockandwarehouseResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
