...
func (e PayCodePayCodeRegionEnum) ToPointer() *PayCodePayCodeRegionEnum {
	return &e
}
...
func (e *PayCodePayCodeRegionEnum) UnmarshalJSON(data []byte) error {
	...
	case "Scotland":
		fallthrough
	case "Wales":
		*e = PayCodePayCodeRegionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PayCodePayCodeRegionEnum: %v", v)
	}
}
...
func (e PayCodePayCodeTerritoryEnum) ToPointer() *PayCodePayCodeTerritoryEnum {
	return &e
}
...
func (e *PayCodePayCodeTerritoryEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "UnitedKingdom":
		*e = PayCodePayCodeTerritoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PayCodePayCodeTerritoryEnum: %v", v)
	}
}
...
func (e PayCodePayCodeTypeEnum) ToPointer() *PayCodePayCodeTypeEnum {
	return &e
}
...
func (e *PayCodePayCodeTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Payment":
		fallthrough
	case "Deduction":
		*e = PayCodePayCodeTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PayCodePayCodeTypeEnum: %v", v)
	}
}
