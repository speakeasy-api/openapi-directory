...
class BatchReadOperation:
    ...
    list_object_parents: Optional[shared_batchlistobjectparents.BatchListObjectParents] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ListObjectParents') }})
