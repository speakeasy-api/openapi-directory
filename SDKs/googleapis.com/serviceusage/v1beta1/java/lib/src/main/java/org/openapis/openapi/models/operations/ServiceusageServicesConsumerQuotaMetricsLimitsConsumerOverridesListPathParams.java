...
public class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesListPathParams {
    /**
    ...
    public ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesListPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
