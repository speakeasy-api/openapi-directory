...
export class PostServersIdActionsDisableRescueActionResponseAction extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "error" })
  @Type(() => PostServersIdActionsDisableRescueActionResponseActionError)
   ...
   */
  @SpeakeasyMetadata({
    elemType: PostServersIdActionsDisableRescueActionResponseActionResources,
  })
  @Expose({ name: "resources" })
  @Type(() => PostServersIdActionsDisableRescueActionResponseActionResources)
...
export class PostServersIdActionsDisableRescueActionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  @Type(() => PostServersIdActionsDisableRescueActionResponseAction)
