...
func (s *admin) Anonymize(ctx context.Context, request operations.AnonymizeRequest) (*operations.AnonymizeResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/api2/json/anonymize/{source}/{anonymized}", request.PathParams, nil)
...
func (s *admin) Disable(ctx context.Context, request operations.DisableRequest) (*operations.DisableResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/api2/json/disable/{source}/{disabled}", request.PathParams, nil)
...
func (s *admin) Learnable(ctx context.Context, request operations.LearnableRequest) (*operations.LearnableResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/api2/json/learnable/{source}/{learnable}", request.PathParams, nil)
