...
export class Groups {
  ...
  **/
  cloudidentityGroupsMembershipsCheckTransitiveMembership(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/memberships:checkTransitiveMembership", req.pathParams);
  ...
  **/
  cloudidentityGroupsMembershipsDelete(
    req: operations.CloudidentityGroupsMembershipsDeleteRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudidentityGroupsMembershipsDeleteResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CloudidentityGroupsMembershipsDeleteRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CloudidentityGroupsMembershipsDeleteResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  **/
  cloudidentityGroupsMembershipsGet(
    req: operations.CloudidentityGroupsMembershipsGetRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudidentityGroupsMembershipsGetResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CloudidentityGroupsMembershipsGetRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CloudidentityGroupsMembershipsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  cloudidentityGroupsMembershipsGetMembershipGraph(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/memberships:getMembershipGraph", req.pathParams);
  ...
  **/
  cloudidentityGroupsMembershipsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CloudidentityGroupsMembershipsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
  ...
  **/
  cloudidentityGroupsMembershipsLookup(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/memberships:lookup", req.pathParams);
  ...
  **/
  cloudidentityGroupsMembershipsModifyMembershipRoles(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{name}:modifyMembershipRoles", req.pathParams);
  ...
  **/
  cloudidentityGroupsMembershipsSearchTransitiveGroups(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/memberships:searchTransitiveGroups", req.pathParams);
  ...
  **/
  cloudidentityGroupsMembershipsSearchTransitiveMemberships(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/memberships:searchTransitiveMemberships", req.pathParams);
  ...
  **/
  cloudidentityGroupsUpdateSecuritySettings(
    req: operations.CloudidentityGroupsUpdateSecuritySettingsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudidentityGroupsUpdateSecuritySettingsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CloudidentityGroupsUpdateSecuritySettingsRequest(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CloudidentityGroupsUpdateSecuritySettingsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
