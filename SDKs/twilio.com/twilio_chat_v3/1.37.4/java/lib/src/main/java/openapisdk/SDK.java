...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.UpdateChannelResponse updateChannel(openapisdk.models.operations.UpdateChannelRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v3/Services/{ServiceSid}/Channels/{Sid}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.ChatV3Channel out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ChatV3Channel.class);
