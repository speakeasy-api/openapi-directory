...
func (e CalendarEventsListOrderByEnum) ToPointer() *CalendarEventsListOrderByEnum {
	return &e
}
...
func (e *CalendarEventsListOrderByEnum) UnmarshalJSON(data []byte) error {
	...
	case "startTime":
		fallthrough
	case "updated":
		*e = CalendarEventsListOrderByEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CalendarEventsListOrderByEnum: %v", v)
	}
}
