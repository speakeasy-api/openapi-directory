...
public class AndroidpublisherEditsTestersGetRequest {
    ...
    public AndroidpublisherEditsTestersGetRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public AndroidpublisherEditsTestersGetRequest withAccessToken(String accessToken) {
    ...
    public AndroidpublisherEditsTestersGetRequest withCallback(String callback) {
    ...
    public AndroidpublisherEditsTestersGetRequest withUploadType(String uploadType) {
    ...
    public AndroidpublisherEditsTestersGetRequest withUploadProtocol(String uploadProtocol) {
