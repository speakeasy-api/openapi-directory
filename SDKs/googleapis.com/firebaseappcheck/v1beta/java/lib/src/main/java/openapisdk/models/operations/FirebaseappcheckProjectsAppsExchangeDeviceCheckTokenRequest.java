...
public class FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest request;
    public FirebaseappcheckProjectsAppsExchangeDeviceCheckTokenRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1betaExchangeDeviceCheckTokenRequest request) {
