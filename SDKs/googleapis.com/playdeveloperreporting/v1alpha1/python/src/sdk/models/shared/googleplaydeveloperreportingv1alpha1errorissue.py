...
class GooglePlayDeveloperReportingV1alpha1ErrorIssue:
    ...
    type: Optional[GooglePlayDeveloperReportingV1alpha1ErrorIssueTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Type of the errors grouped in this issue."""  
