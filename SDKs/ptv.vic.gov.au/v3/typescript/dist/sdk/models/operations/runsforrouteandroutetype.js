...
exports.RunsForRouteAndRouteTypeResponse = exports.RunsForRouteAndRouteTypeRequest = exports.RunsForRouteAndRouteTypeRouteTypeEnum = exports.RunsForRouteAndRouteTypeExpandEnum = void 0;
 ...
 */
var RunsForRouteAndRouteTypeRouteTypeEnum;
(function (RunsForRouteAndRouteTypeRouteTypeEnum) {
    RunsForRouteAndRouteTypeRouteTypeEnum["Zero"] = "0";
    RunsForRouteAndRouteTypeRouteTypeEnum["One"] = "1";
    RunsForRouteAndRouteTypeRouteTypeEnum["Two"] = "2";
    RunsForRouteAndRouteTypeRouteTypeEnum["Three"] = "3";
    RunsForRouteAndRouteTypeRouteTypeEnum["Four"] = "4";
})(RunsForRouteAndRouteTypeRouteTypeEnum = exports.RunsForRouteAndRouteTypeRouteTypeEnum || (exports.RunsForRouteAndRouteTypeRouteTypeEnum = {}));
var RunsForRouteAndRouteTypeRequest = /** @class */ (function (_super) {
    ...
    ], RunsForRouteAndRouteTypeRequest.prototype, "dateUtc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=devid" }),
        __metadata("design:type", String)
    ], RunsForRouteAndRouteTypeRequest.prototype, "devid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=expand",
        }),
        __metadata("design:type", Array)
    ], RunsForRouteAndRouteTypeRequest.prototype, "expand", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=route_id",
        }),
        __metadata("design:type", Number)
    ], RunsForRouteAndRouteTypeRequest.prototype, "routeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=route_type",
        }),
        __metadata("design:type", String)
    ], RunsForRouteAndRouteTypeRequest.prototype, "routeType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=signature",
        }),
        __metadata("design:type", String)
    ], RunsForRouteAndRouteTypeRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=token" }),
        __metadata("design:type", String)
    ], RunsForRouteAndRouteTypeRequest.prototype, "token", void 0);
...
var RunsForRouteAndRouteTypeResponse = /** @class */ (function (_super) {
    ...
    ], RunsForRouteAndRouteTypeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
