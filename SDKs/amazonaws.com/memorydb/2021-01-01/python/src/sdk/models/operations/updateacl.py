...
class UpdateACLRequest:
    headers: UpdateACLHeaders = dataclasses.field()
    request: shared_updateaclrequest.UpdateACLRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
