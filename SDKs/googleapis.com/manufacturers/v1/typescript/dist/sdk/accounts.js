...
var Accounts = /** @class */ (function () {
    ...
    **/
    Accounts.prototype.manufacturersAccountsProductsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ManufacturersAccountsProductsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/products/{name}", req.pathParams);
    ...
    **/
    Accounts.prototype.manufacturersAccountsProductsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Accounts.prototype.manufacturersAccountsProductsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Accounts.prototype.manufacturersAccountsProductsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
