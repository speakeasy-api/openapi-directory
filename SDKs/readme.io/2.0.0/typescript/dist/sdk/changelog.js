...
var Changelog = /** @class */ (function () {
    function Changelog(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Changelog.prototype.createChangelog = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateChangelogRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/changelogs";
    ...
    **/
    Changelog.prototype.deleteChangelog = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteChangelogRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/changelogs/{slug}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    Changelog.prototype.getChangelog = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Changelog.prototype.getChangelogs = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Changelog.prototype.updateChangelog = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
