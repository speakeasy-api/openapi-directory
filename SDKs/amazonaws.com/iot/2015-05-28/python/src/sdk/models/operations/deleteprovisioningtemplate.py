...
class DeleteProvisioningTemplateRequest:
    headers: DeleteProvisioningTemplateHeaders = dataclasses.field()
    path_params: DeleteProvisioningTemplatePathParams = dataclasses.field()
...
class DeleteProvisioningTemplateResponse:
    ...
    delete_provisioning_template_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
