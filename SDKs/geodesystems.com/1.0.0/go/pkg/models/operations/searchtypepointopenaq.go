...
type SearchTypePointOpenaqQueryParams struct {
	...
	// City
	SearchTypePointOpenaqCity *string `queryParam:"style=form,explode=true,name=search.type_point_openaq.city"`
	// Country
	SearchTypePointOpenaqCountry *string `queryParam:"style=form,explode=true,name=search.type_point_openaq.country"`
	// Offset Hours
	SearchTypePointOpenaqHoursOffset *int64 `queryParam:"style=form,explode=true,name=search.type_point_openaq.hours_offset"`
	// Location
	SearchTypePointOpenaqLocation *string `queryParam:"style=form,explode=true,name=search.type_point_openaq.location"`
	// Number to skip
...
type SearchTypePointOpenaqRequest struct {
	QueryParams SearchTypePointOpenaqQueryParams
}

type SearchTypePointOpenaqResponse struct {
	ContentType string
	StatusCode  int
