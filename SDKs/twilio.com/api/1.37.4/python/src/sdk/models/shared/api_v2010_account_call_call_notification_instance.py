...
class APIV2010AccountCallCallNotificationInstance:
    ...
    request_method: Optional[APIV2010AccountCallCallNotificationInstanceRequestMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request_method') }})
