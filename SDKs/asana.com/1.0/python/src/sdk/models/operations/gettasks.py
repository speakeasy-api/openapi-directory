...
class GetTasksRequest:
    ...
    r"""The assignee to filter tasks on. If searching for unassigned tasks, assignee.any = null can be specified.
    *Note: If you specify `assignee`, you must also specify the `workspace` to filter on.*
    ...
    r"""Only return tasks that are either incomplete or that have been completed since this time."""  
    ...
    *Note: Currently, this is only supported in board views.*
    ...
    r"""The workspace to filter tasks on.
...
class GetTasks200ApplicationJSON:
    r"""Successfully retrieved requested tasks."""
