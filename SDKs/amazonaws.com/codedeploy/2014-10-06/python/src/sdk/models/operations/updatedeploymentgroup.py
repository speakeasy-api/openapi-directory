...
class UpdateDeploymentGroupRequest:
    ...
    update_deployment_group_input: shared_updatedeploymentgroupinput.UpdateDeploymentGroupInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
