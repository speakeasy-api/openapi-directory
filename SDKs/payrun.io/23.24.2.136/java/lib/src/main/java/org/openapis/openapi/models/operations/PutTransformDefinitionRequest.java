...
public class PutTransformDefinitionRequest {
    ...
    public PutTransformDefinitionRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("TransformDefinition") org.openapis.openapi.models.shared.TransformDefinition transformDefinition, @JsonProperty("TransformDefinitionId") String transformDefinitionId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.transformDefinition = transformDefinition;
        this.transformDefinitionId = transformDefinitionId;
