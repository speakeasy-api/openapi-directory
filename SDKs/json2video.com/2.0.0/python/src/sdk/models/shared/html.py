...
class HTMLPositionEnum(str, Enum):
...
@dataclasses.dataclass
class HTML:
    r"""Creates a video recording or a screenshot of the provided HTML snippet"""
    
    html: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('html') }})
    r"""HTML snippet to render. Compatible with HTML5, CSS3 and Javascript"""  
    type: HTMLTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
    ...
    chroma_key: Optional[HTMLChromaKey] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('chroma-key'), 'exclude': lambda f: f is None }})
    r"""Allows to define a color (or a range of colors) that will be converted to transparent"""  
    comment: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('comment'), 'exclude': lambda f: f is None }})
    r"""Used for adding your comments"""  
    crop: Optional[HTMLCrop] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('crop'), 'exclude': lambda f: f is None }})
    r"""Crops the element"""  
    ...
    height: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('height'), 'exclude': lambda f: f is None }})
    r"""Desired text element height. A value of <code>-1</code> means inherits scenes or movie height"""  
    pan: Optional[HTMLPanEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pan'), 'exclude': lambda f: f is None }})
    r"""Pans the element to the specified direction. If <code>zoom</code> property is not specified, the effect is a non-zooming pan"""  
    position: Optional[HTMLPositionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('position'), 'exclude': lambda f: f is None }})
    r"""Sets the element position in the scene. A value of 'custom' sets a custom position based on the provided 'x' and 'y' properties"""  
    rotate: Optional[HTMLRotate] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rotate'), 'exclude': lambda f: f is None }})  
    scale: Optional[HTMLScale] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scale'), 'exclude': lambda f: f is None }})  
    ...
    tailwindcss: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tailwindcss'), 'exclude': lambda f: f is None }})
    r"""Enables usage of TailwindCSS for the HTML snippet"""  
    width: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('width'), 'exclude': lambda f: f is None }})
    r"""Desired text element width. A value of <code>-1</code> means inherits scenes or movie width"""  
