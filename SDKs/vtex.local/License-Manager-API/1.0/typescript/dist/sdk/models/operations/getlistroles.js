...
exports.GetListRolesResponse = exports.GetListRolesRequest = void 0;
...
var GetListRolesRequest = /** @class */ (function (_super) {
    ...
    ], GetListRolesRequest.prototype, "contentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=numItems",
        }),
        __metadata("design:type", Number)
    ], GetListRolesRequest.prototype, "numItems", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageNumber",
        }),
        __metadata("design:type", Number)
    ], GetListRolesRequest.prototype, "pageNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetListRolesRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sortType",
        }),
        __metadata("design:type", String)
    ], GetListRolesRequest.prototype, "sortType", void 0);
    return GetListRolesRequest;
}(utils_1.SpeakeasyBase));
exports.GetListRolesRequest = GetListRolesRequest;
var GetListRolesResponse = /** @class */ (function (_super) {
    ...
    ], GetListRolesResponse.prototype, "listRolesResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
    ...
    ], GetListRolesResponse.prototype, "rawResponse", void 0);
    return GetListRolesResponse;
}(utils_1.SpeakeasyBase));
exports.GetListRolesResponse = GetListRolesResponse;
