...
func (s *messaging) ScheduleAPITriggeredCanvases(ctx context.Context, request operations.ScheduleAPITriggeredCanvasesRequestBody) (*operations.ScheduleAPITriggeredCanvasesResponse, error) {
	baseURL := s.serverURL
