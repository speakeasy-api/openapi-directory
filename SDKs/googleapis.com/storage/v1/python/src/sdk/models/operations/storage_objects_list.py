...
class StorageObjectsListRequest:
    ...
    match_glob: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'matchGlob', 'style': 'form', 'explode': True }})
    r"""Filter results to objects and prefixes that match this glob pattern."""  
