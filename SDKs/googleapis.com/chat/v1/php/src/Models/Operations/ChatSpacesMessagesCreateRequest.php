...
class ChatSpacesMessagesCreateRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ChatSpacesMessagesCreateMessageReplyOptionEnum $messageReplyOption
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=messageReplyOption')]
    public ?ChatSpacesMessagesCreateMessageReplyOptionEnum $messageReplyOption = null;
