...
export class DataExtracts {
  ...
  **/
  getDataExtractsEvents(
    req: operations.GetDataExtractsEventsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetDataExtractsEventsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetDataExtractsEventsRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/dataExtracts/events";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetDataExtractsEventsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json;charset=UTF-8`)) {
                res.dataExtractsEventResponse = httpRes?.data;
            }
            break;
  ...
  **/
  getDataExtractsUserData(
    req: operations.GetDataExtractsUserDataRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.GetDataExtractsUserDataResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetDataExtractsUserDataRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/dataExtracts/userData";
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetDataExtractsUserDataResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.matchContentType(contentType, `application/json;charset=UTF-8`)) {
                res.dataExtractsUserDataResponse = httpRes?.data;
            }
            break;
          case httpRes?.status == 400:
            if (utils.matchContentType(contentType, `application/json;charset=UTF-8`)) {
