...
var Applications = /** @class */ (function () {
    ...
    **/
    Applications.prototype.addApplication = function (req, config) {
        var _a;
    ...
    **/
    Applications.prototype.addTier = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddTierRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/applications/{id}/tiers", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.tier = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/json")) {
    ...
    **/
    Applications.prototype.deleteApplication = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteApplicationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/applications/{id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    Applications.prototype.deleteTier = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteTierRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/applications/{id}/tiers/{tier-id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Applications.prototype.getApplication = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Show tier details
    **/
    Applications.prototype.getApplicationTier = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Show tier details
    **/
    Applications.prototype.getTier = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetTierRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/tiers/{tier-id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    Applications.prototype.listApplicationTiers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.tierListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    break;
     ...
     * List applications
    **/
    Applications.prototype.listApplications = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.pagedListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    break;
