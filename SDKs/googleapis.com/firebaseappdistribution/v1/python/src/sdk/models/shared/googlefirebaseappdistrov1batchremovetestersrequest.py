...
class GoogleFirebaseAppdistroV1BatchRemoveTestersRequest:
    r"""The request message for `BatchRemoveTesters`."""
    ...
    r"""Required. The email addresses of the tester resources to removed. A maximum of 999 and a minimum of 1 testers can be deleted in a batch."""  
