...
public class PostTruckOptimalDirectionsOutputFormatQueryParams {
    ...
    public PostTruckOptimalDirectionsOutputFormatOutputSrsEnum outputSRS;
    public PostTruckOptimalDirectionsOutputFormatQueryParams withOutputSRS(PostTruckOptimalDirectionsOutputFormatOutputSrsEnum outputSRS) {
    ...
    public PostTruckOptimalDirectionsOutputFormatQueryParams withPartition(String partition) {
    ...
    public PostTruckOptimalDirectionsOutputFormatQueryParams withTruckRouteMultiplier(Long truckRouteMultiplier) {
