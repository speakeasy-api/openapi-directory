...
import { GoogleCloudDatapipelinesV1ScheduleSpec, GoogleCloudDatapipelinesV1ScheduleSpecInput } from "./googleclouddatapipelinesv1schedulespec";
 ...
 * The main pipeline entity and all the necessary metadata for launching and managing linked jobs.
 */
export declare class GoogleCloudDatapipelinesV1PipelineInput extends SpeakeasyBase {
    /**
     * Required. The display name of the pipeline. It can contain only letters ([A-Za-z]), numbers ([0-9]), hyphens (-), and underscores (_).
     */
    displayName?: string;
