...
class SearchEditorialImagesQueryParams:
...
class SearchEditorialImagesRequest:
    query_params: SearchEditorialImagesQueryParams = dataclasses.field()
    security: SearchEditorialImagesSecurity = dataclasses.field()
