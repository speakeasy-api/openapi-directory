...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/mailboxvalidator.com/validation/0.1/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/mailboxvalidator.com/validation/0.1/typescript
```
