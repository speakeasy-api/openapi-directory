...
class CreateEventSubscriptionRequest:
    headers: CreateEventSubscriptionHeaders = dataclasses.field()
    request: shared_createeventsubscriptionmessage.CreateEventSubscriptionMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
