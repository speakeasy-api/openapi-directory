...
export const ListCredentialServerList = ["https://notify.twilio.com"] as const;
...
export class ListCredentialListCredentialResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.NotifyV1Credential })
  @Expose({ name: "credentials" })
  @Type(() => shared.NotifyV1Credential)
