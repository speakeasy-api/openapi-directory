...
export class SearchTypeEsriLayerRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=search.type_esri_layer.layer_type",
  })
...
export class SearchTypeEsriLayerResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
