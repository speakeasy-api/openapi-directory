...
public class Name {
    ...
    **/
    public openapisdk.models.operations.GetNamesNameIdOutputFormatResponse getNamesNameIdOutputFormat(openapisdk.models.operations.GetNamesNameIdOutputFormatRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/names/{nameId}.{outputFormat}", request.pathParams);
        ...
        openapisdk.models.operations.GetNamesNameIdOutputFormatResponse res = new openapisdk.models.operations.GetNamesNameIdOutputFormatResponse() {{
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
