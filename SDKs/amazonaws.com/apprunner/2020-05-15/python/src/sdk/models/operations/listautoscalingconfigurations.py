...
class ListAutoScalingConfigurationsRequest:
    ...
    list_auto_scaling_configurations_request: shared_listautoscalingconfigurationsrequest.ListAutoScalingConfigurationsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
