...
class PostCreateAppCookieStickinessPolicyQueryParams:
    action: PostCreateAppCookieStickinessPolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateAppCookieStickinessPolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateAppCookieStickinessPolicyRequest:
    headers: PostCreateAppCookieStickinessPolicyHeaders = dataclasses.field()
    query_params: PostCreateAppCookieStickinessPolicyQueryParams = dataclasses.field()
