...
export declare class DraftRegistrationsReadDraftRegistrationAttributesNodeLicense extends SpeakeasyBase {
    /**
 ...
 */
export declare class DraftRegistrationsReadDraftRegistrationAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class DraftRegistrationsReadDraftRegistrationLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class DraftRegistrationsReadDraftRegistrationRelationships extends SpeakeasyBase {
    /**
 ...
 * OK
 */
export declare class DraftRegistrationsReadDraftRegistration extends SpeakeasyBase {
    /**
     * The properties of the Draft Registration entity.
     */
...
export declare class DraftRegistrationsReadResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
