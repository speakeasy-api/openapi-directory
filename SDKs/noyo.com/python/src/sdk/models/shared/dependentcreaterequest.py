...
class DependentCreateRequestPersonContact:
    ...
    email_address_type: Optional[DependentCreateRequestPersonContactEmailAddressTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('email_address_type'), 'exclude': lambda f: f is None }})
    r"""Type of email address"""  
    ...
    preferred_method: Optional[DependentCreateRequestPersonContactPreferredMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('preferred_method'), 'exclude': lambda f: f is None }})
    r"""Preferred method of contact for the person"""  
...
class DependentCreateRequestPersonDetailsAmericanIndian:
    ...
    state: Optional[DependentCreateRequestPersonDetailsAmericanIndianStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""Primary state of the federally-recognized American Indian or Alaska Native tribe, if applicable"""  
...
class DependentCreateRequestPersonDetailsTobacco:
    ...
    types: Optional[list[DependentCreateRequestPersonDetailsTobaccoTypesEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('types'), 'exclude': lambda f: f is None }})
...
class DependentCreateRequestPersonDetails:
    ...
    american_indian: Optional[DependentCreateRequestPersonDetailsAmericanIndian] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('american_indian'), 'exclude': lambda f: f is None }})
    r"""American Indian status details (if applicable)"""  
    disability: Optional[DependentCreateRequestPersonDetailsDisability] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('disability'), 'exclude': lambda f: f is None }})
    r"""Disability details (if applicable)"""  
    ...
    tobacco: Optional[DependentCreateRequestPersonDetailsTobacco] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tobacco'), 'exclude': lambda f: f is None }})
    r"""Tobacco usage details (if applicable)"""  
...
class DependentCreateRequestPersonHomeAddress:
    ...
    state: DependentCreateRequestPersonHomeAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""State postal code of the address"""  
...
class DependentCreateRequestPersonMailingAddress:
    ...
    city: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('city') }})
    r"""City of the address"""  
    state: DependentCreateRequestPersonMailingAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""State postal code of the address"""  
    street_one: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('street_one') }})
    r"""Line one of the address"""  
    zip_code: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('zip_code') }})
...
class DependentCreateRequestPerson:
    ...
    sex: DependentCreateRequestPersonSexEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sex') }})
    r"""Sex of the person"""  
    contact: Optional[DependentCreateRequestPersonContact] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contact'), 'exclude': lambda f: f is None }})
    r"""Contact information for the person"""  
    details: Optional[DependentCreateRequestPersonDetails] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('details'), 'exclude': lambda f: f is None }})
    r"""Additional personal details of the person"""  
    home_address: Optional[DependentCreateRequestPersonHomeAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('home_address'), 'exclude': lambda f: f is None }})
    r"""Home address of the person"""  
    mailing_address: Optional[DependentCreateRequestPersonMailingAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('mailing_address'), 'exclude': lambda f: f is None }})
    r"""Mailing address of the person"""  
    marital_status: Optional[DependentCreateRequestPersonMaritalStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('marital_status'), 'exclude': lambda f: f is None }})
    r"""Marital status of the person"""  
...
class DependentCreateRequest:
    ...
    person: DependentCreateRequestPerson = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('person') }})
    r"""Personal information for the dependent"""  
    relationship: DependentCreateRequestRelationshipEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('relationship') }})
    r"""Relationship of the dependent to the employee"""  
