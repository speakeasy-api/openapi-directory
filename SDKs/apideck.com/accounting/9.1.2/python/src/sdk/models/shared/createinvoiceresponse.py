...
import dataclasses
from ..shared import invoiceresponse as shared_invoiceresponse
...
class CreateInvoiceResponse:
    ...
    data: shared_invoiceresponse.InvoiceResponse = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
