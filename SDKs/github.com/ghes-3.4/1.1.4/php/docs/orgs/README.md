...
try {
    ...
    $request->org = 'facere';
    $request->username = 'Mona.Brakus78';
...
try {
    ...
    $request->requestBody->name = 'Pat Wolf';
    $request->org = 'alias';
...
try {
    ...
    $request->before = 'non';
    $request->include = AuditLogIncludeEnum::WEB;
    $request->order = AuditLogOrderEnum::DESC;
    $request->org = 'sit';
    $request->page = 39992;
    $request->perPage = 7468;
...
try {
    ...
    $request->org = 'ea';
    $request->username = 'Matilde_Hodkiewicz59';
...
try {
    ...
    $request->deliveryId = 351936;
    $request->hookId = 600193;
...
try {
    ...
    $request->page = 85066;
    $request->perPage = 874400;
    $request->username = 'Daron21';
...
try {
    ...
    $request->org = 'dolores';
    $request->username = 'Reuben_Breitenberg54';
...
try {
    ...
    $request->username = 'Laila_Tillman57';
...
try {
    ...
    $request->requestBody->billingEmail = 'ea';
    $request->requestBody->blog = '"http://github.blog"';
    $request->requestBody->company = 'Hintz - Prosacco';
    ...
    $request->requestBody->name = 'Steven Rath';
    $request->requestBody->twitterUsername = 'quibusdam';
    $request->org = 'odio';
