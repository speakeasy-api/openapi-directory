...
class CreateFunctionRequestBody:
    code: CreateFunctionRequestBodyCode = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Code') }})
    ...
    code_signing_config_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CodeSigningConfigArn') }})
    dead_letter_config: Optional[CreateFunctionRequestBodyDeadLetterConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DeadLetterConfig') }})
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Description') }})
    environment: Optional[CreateFunctionRequestBodyEnvironment] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Environment') }})
    ...
    image_config: Optional[CreateFunctionRequestBodyImageConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ImageConfig') }})
    kms_key_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('KMSKeyArn') }})
    layers: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Layers') }})
    ...
    package_type: Optional[CreateFunctionRequestBodyPackageTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PackageType') }})
    publish: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Publish') }})
    runtime: Optional[CreateFunctionRequestBodyRuntimeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Runtime') }})
    ...
    tracing_config: Optional[CreateFunctionRequestBodyTracingConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('TracingConfig') }})
    vpc_config: Optional[CreateFunctionRequestBodyVpcConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('VpcConfig') }})
    

@dataclasses.dataclass
class CreateFunctionRequest:
    headers: CreateFunctionHeaders = dataclasses.field()
    request: CreateFunctionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
