...
export class SpeechProjectsLocationsPhraseSetsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SpeechProjectsLocationsPhraseSetsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SpeechProjectsLocationsPhraseSetsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
