...
exports.CalloutStatusRow = void 0;
...
**/
var CalloutStatusRow = /** @class */ (function (_super) {
    __extends(CalloutStatusRow, _super);
    function CalloutStatusRow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=calloutStatusId" }),
        __metadata("design:type", Number)
    ], CalloutStatusRow.prototype, "calloutStatusId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=impressionCount" }),
        __metadata("design:type", metricvalue_1.MetricValue)
    ], CalloutStatusRow.prototype, "impressionCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rowDimensions" }),
        __metadata("design:type", rowdimensions_1.RowDimensions)
    ], CalloutStatusRow.prototype, "rowDimensions", void 0);
    return CalloutStatusRow;
}(utils_1.SpeakeasyBase));
exports.CalloutStatusRow = CalloutStatusRow;
