...
export class CertificatemanagerProjectsLocationsDnsAuthorizationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsDnsAuthorizationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsDnsAuthorizationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
