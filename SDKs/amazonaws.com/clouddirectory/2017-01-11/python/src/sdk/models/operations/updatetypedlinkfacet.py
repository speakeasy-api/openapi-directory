...
class UpdateTypedLinkFacetRequestBody:
    attribute_updates: list[shared_typedlinkfacetattributeupdate.TypedLinkFacetAttributeUpdate] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AttributeUpdates') }})
    identity_attribute_order: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('IdentityAttributeOrder') }})
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Name') }})
    

@dataclasses.dataclass
class UpdateTypedLinkFacetRequest:
    headers: UpdateTypedLinkFacetHeaders = dataclasses.field()
    request: UpdateTypedLinkFacetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
