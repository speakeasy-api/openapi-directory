...
public class ContainerProjectsZonesClustersSetMasterAuthPathParams {
    /**
     * Required. Deprecated. The name of the cluster to upgrade. This field has been deprecated and replaced by the name field.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=clusterId")
    public String clusterId;
    public ContainerProjectsZonesClustersSetMasterAuthPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersSetMasterAuthPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersSetMasterAuthPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
