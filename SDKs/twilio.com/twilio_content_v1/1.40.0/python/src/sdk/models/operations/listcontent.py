...
class ListContentListContentResponse:
    ...
    contents: Optional[list[shared_content_v1_content.ContentV1Content]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('contents'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListContentListContentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
