...
class PaginatedAgentResultMeta:
    r"""PaginatedAgentResultMeta
...
class PaginatedAgentResult:
    meta: PaginatedAgentResultMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    response: list[shared_agentresult.AgentResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('response') }})
