...
class CreateCommentReplyRequest:
    ...
    request_body: CreateCommentReplyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/vnd.vimeo.comment+json' }})  
