...
export class ListUnderstandFieldTypeListUnderstandFieldTypeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.PreviewUnderstandAssistantFieldType })
  @Expose({ name: "field_types" })
  @Type(() => shared.PreviewUnderstandAssistantFieldType)
  fieldTypes?: shared.PreviewUnderstandAssistantFieldType[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListUnderstandFieldTypeListUnderstandFieldTypeResponseMeta)
