...
var Certificate = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: domainvalidationrecord_1.DomainValidationRecord }),
        (0, class_transformer_1.Expose)({ name: "domainValidationRecords" }),
        (0, class_transformer_1.Type)(function () { return domainvalidationrecord_1.DomainValidationRecord; }),
        __metadata("design:type", Array)
    ], Certificate.prototype, "domainValidationRecords", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "eligibleToRenew" }),
        __metadata("design:type", String)
    ], Certificate.prototype, "eligibleToRenew", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "inUseResourceCount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "issuerCA" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "requestFailureReason" }),
        __metadata("design:type", String)
