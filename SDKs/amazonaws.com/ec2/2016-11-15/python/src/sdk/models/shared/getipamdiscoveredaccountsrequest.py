...
class GetIpamDiscoveredAccountsRequestFilters:
...
class GetIpamDiscoveredAccountsRequest:
    ...
    discovery_region: str = dataclasses.field()  
    ipam_resource_discovery_id: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[GetIpamDiscoveredAccountsRequestFilters]] = dataclasses.field(default=None)  
