...
class Activity:
    ...
    def get_activities(self, request: operations.GetActivitiesRequest) -> operations.GetActivitiesResponse:
        r"""Get a list of realtime activities.
        Get a list of realtime activities on the project, such as translation suggestion and translation approval.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/projects/{projectId}/activities", request.path_params)
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ActivityList])
    ...
    def get_activity(self, request: operations.GetActivityRequest) -> operations.GetActivityResponse:
        r"""Get a single realtime activity.
        Get a single realtime activity.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/projects/{projectId}/activities/{activityId}", request.path_params)
    ...
    def get_activity_comments(self, request: operations.GetActivityCommentsRequest) -> operations.GetActivityCommentsResponse:
        r"""Get a list of comments belonging to this activity.
        Get a list of comments belonging to this activity.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/projects/{projectId}/activities/{activityId}/comments", request.path_params)
        ...
        res = operations.GetActivityCommentsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_comments(self, request: operations.GetCommentsRequest) -> operations.GetCommentsResponse:
        r"""Get a list of activity comments throughout the whole project.
        Get a list of activity comments throughout the whole project.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/projects/{projectId}/comments", request.path_params)
    ...
    def get_sales_activities(self, request: operations.GetSalesActivitiesRequest) -> operations.GetSalesActivitiesResponse:
        ...
        url = utils.generate_url(base_url, "/projects/{id}/sales/activities", request.path_params)
        ...
        res = operations.GetSalesActivitiesResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SalesActivities])
    ...
    def insert_sales_activity(self, request: operations.InsertSalesActivityRequest) -> operations.InsertSalesActivityResponse:
        ...
        res = operations.InsertSalesActivityResponse(status_code=r.status_code, content_type=content_type)
    ...
    def submit_comment(self, request: operations.SubmitCommentRequest) -> operations.SubmitCommentResponse:
        r"""Submit a comment to an activity.
        ...
        res = operations.SubmitCommentResponse(status_code=r.status_code, content_type=content_type)
