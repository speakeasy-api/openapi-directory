...
export class IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadFileFormatEnum {
  FileFormatUnspecified = "FILE_FORMAT_UNSPECIFIED",
  Json = "JSON",
  Yaml = "YAML",
}

export class IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
