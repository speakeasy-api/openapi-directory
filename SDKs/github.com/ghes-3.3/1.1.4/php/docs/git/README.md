...
try {
    ...
    $request->requestBody->encoding = 'laboriosam';
...
try {
    ...
    $request->requestBody->author->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-02-10T08:43:29.852Z');
    $request->requestBody->author->email = 'Sister.Doyle63@hotmail.com';
    $request->requestBody->author->name = 'Byron Thiel';
    $request->requestBody->committer = new GitCreateCommitRequestBodyCommitter();
    $request->requestBody->committer->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-09-19T19:33:03.218Z');
    $request->requestBody->committer->email = 'Alexa.Nicolas0@hotmail.com';
    $request->requestBody->committer->name = 'Brittany Bailey';
    $request->requestBody->message = 'repudiandae';
    $request->requestBody->parents = [
        'et',
        'blanditiis',
    ];
    $request->requestBody->signature = 'ex';
    $request->requestBody->tree = 'sed';
    $request->owner = 'sit';
    $request->repo = 'vel';
...
try {
    ...
    $request->requestBody->ref = 'nostrum';
    $request->requestBody->sha = 'saepe';
    $request->owner = 'error';
...
try {
    ...
    $request->requestBody->message = 'incidunt';
    $request->requestBody->object = 'reiciendis';
    $request->requestBody->tag = 'dolorem';
    $request->requestBody->tagger = new GitCreateTagRequestBodyTagger();
    $request->requestBody->tagger->date = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-10-08T12:52:44.610Z');
    $request->requestBody->tagger->email = 'Kitty_Greenfelder67@gmail.com';
    $request->requestBody->tagger->name = 'Mrs. Roman Howell';
...
try {
    ...
    $request->requestBody->baseTree = 'provident';
