...
class GetPublicationVariantAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPublicationVariantAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPublicationVariantAssociationsRequest:
    path_params: GetPublicationVariantAssociationsPathParams = dataclasses.field()
    query_params: GetPublicationVariantAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPublicationVariantAssociationsResponse:
