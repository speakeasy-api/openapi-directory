...
type PaymentsresellersubscriptionPartnersSubscriptionsExtendRequest struct {
	...
	GoogleCloudPaymentsResellerSubscriptionV1ExtendSubscriptionRequest *shared.GoogleCloudPaymentsResellerSubscriptionV1ExtendSubscriptionRequest `request:"mediaType=application/json"`
	// OAuth access token.
