 ...
 */
export enum CreateVpcEndpointServiceConfigurationRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateVpcEndpointServiceConfigurationRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateVpcEndpointServiceConfigurationRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateVpcEndpointServiceConfigurationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
