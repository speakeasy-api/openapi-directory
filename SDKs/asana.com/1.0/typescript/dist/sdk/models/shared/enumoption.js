...
exports.EnumOption = exports.EnumOptionInput = void 0;
...
**/
var EnumOptionInput = /** @class */ (function (_super) {
    __extends(EnumOptionInput, _super);
    function EnumOptionInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=color" }),
        __metadata("design:type", String)
    ], EnumOptionInput.prototype, "color", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=enabled" }),
        __metadata("design:type", Boolean)
    ], EnumOptionInput.prototype, "enabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], EnumOptionInput.prototype, "name", void 0);
    return EnumOptionInput;
}(utils_1.SpeakeasyBase));
exports.EnumOptionInput = EnumOptionInput;
// EnumOption
/**
 * Enum options are the possible values which an enum custom field can adopt. An enum custom field must contain at least 1 enum option but no more than 50.
 *
...
var EnumOption = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], EnumOption.prototype, "resourceType", void 0);
    return EnumOption;
}(utils_1.SpeakeasyBase));
