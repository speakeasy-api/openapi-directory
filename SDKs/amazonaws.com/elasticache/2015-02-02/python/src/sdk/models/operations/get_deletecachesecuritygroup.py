...
class GetDeleteCacheSecurityGroupQueryParams:
    action: GetDeleteCacheSecurityGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteCacheSecurityGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteCacheSecurityGroupRequest:
    headers: GetDeleteCacheSecurityGroupHeaders = dataclasses.field()
    query_params: GetDeleteCacheSecurityGroupQueryParams = dataclasses.field()
