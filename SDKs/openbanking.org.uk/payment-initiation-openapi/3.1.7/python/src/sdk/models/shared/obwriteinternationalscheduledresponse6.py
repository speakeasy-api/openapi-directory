...
class ObWriteInternationalScheduledResponse6DataExchangeRateInformation:
    ...
    rate_type: ObWriteInternationalScheduledResponse6DataExchangeRateInformationRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('RateType') }})
...
class ObWriteInternationalScheduledResponse6DataInitiationExchangeRateInformation:
    ...
    rate_type: ObWriteInternationalScheduledResponse6DataInitiationExchangeRateInformationRateTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('RateType') }})
    unit_currency: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('UnitCurrency') }})
    contract_identification: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ContractIdentification') }})
...
class ObWriteInternationalScheduledResponse6DataInitiation:
    ...
    creditor_account: ObWriteInternationalScheduledResponse6DataInitiationCreditorAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreditorAccount') }})
    currency_of_transfer: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CurrencyOfTransfer') }})
    instructed_amount: ObWriteInternationalScheduledResponse6DataInitiationInstructedAmount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('InstructedAmount') }})
    ...
    creditor: Optional[ObWriteInternationalScheduledResponse6DataInitiationCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Creditor') }})
    creditor_agent: Optional[ObWriteInternationalScheduledResponse6DataInitiationCreditorAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreditorAgent') }})
    debtor_account: Optional[ObWriteInternationalScheduledResponse6DataInitiationDebtorAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DebtorAccount') }})
    ...
    exchange_rate_information: Optional[ObWriteInternationalScheduledResponse6DataInitiationExchangeRateInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ExchangeRateInformation') }})
    ...
    instruction_priority: Optional[ObWriteInternationalScheduledResponse6DataInitiationInstructionPriorityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('InstructionPriority') }})
    ...
    remittance_information: Optional[ObWriteInternationalScheduledResponse6DataInitiationRemittanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RemittanceInformation') }})
...
class ObWriteInternationalScheduledResponse6DataMultiAuthorisation:
    ...
    status: ObWriteInternationalScheduledResponse6DataMultiAuthorisationStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
    expiration_date_time: Optional[datetime] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ExpirationDateTime'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
...
class ObWriteInternationalScheduledResponse6DataRefund:
    account: ObWriteInternationalScheduledResponse6DataRefundAccount = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Account') }})
    agent: Optional[ObWriteInternationalScheduledResponse6DataRefundAgent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Agent') }})
    creditor: Optional[ObWriteInternationalScheduledResponse6DataRefundCreditor] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Creditor') }})
...
class ObWriteInternationalScheduledResponse6Data:
    ...
    initiation: ObWriteInternationalScheduledResponse6DataInitiation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Initiation') }})
    international_scheduled_payment_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('InternationalScheduledPaymentId') }})
    status: ObWriteInternationalScheduledResponse6DataStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
    ...
    charges: Optional[list[ObWriteInternationalScheduledResponse6DataCharges]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Charges') }})
    ...
    exchange_rate_information: Optional[ObWriteInternationalScheduledResponse6DataExchangeRateInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ExchangeRateInformation') }})
    ...
    multi_authorisation: Optional[ObWriteInternationalScheduledResponse6DataMultiAuthorisation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MultiAuthorisation') }})
    refund: Optional[ObWriteInternationalScheduledResponse6DataRefund] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Refund') }})
    

@dataclass_json
@dataclasses.dataclass
class ObWriteInternationalScheduledResponse6:
    data: ObWriteInternationalScheduledResponse6Data = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
