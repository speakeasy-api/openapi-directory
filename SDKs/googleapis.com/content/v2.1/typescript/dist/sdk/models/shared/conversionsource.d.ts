...
import { GoogleAnalyticsLink, GoogleAnalyticsLinkInput } from "./googleanalyticslink";
import { MerchantCenterDestination, MerchantCenterDestinationInput } from "./merchantcenterdestination";
/**
 * Represents a conversion source owned by a Merchant account. A merchant account can have up to 200 conversion sources.
 */
export declare class ConversionSourceInput extends SpeakeasyBase {
    /**
 ...
 */
export declare enum ConversionSourceStateEnum {
 ...
 * Represents a conversion source owned by a Merchant account. A merchant account can have up to 200 conversion sources.
 */
export declare class ConversionSource extends SpeakeasyBase {
    /**
