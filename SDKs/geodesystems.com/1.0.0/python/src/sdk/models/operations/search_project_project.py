...
class SearchProjectProjectQueryParams:
...
@dataclasses.dataclass
class SearchProjectProjectRequest:
    query_params: SearchProjectProjectQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectProjectResponse:
