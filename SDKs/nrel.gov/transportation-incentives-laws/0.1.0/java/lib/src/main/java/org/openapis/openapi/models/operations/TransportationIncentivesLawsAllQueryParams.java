...
public class TransportationIncentivesLawsAllQueryParams {
    /**
     * API Key
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=api_key")
    public String apiKey;
    public TransportationIncentivesLawsAllQueryParams withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public TransportationIncentivesLawsAllQueryParams withExpired(Boolean expired) {
    ...
    public TransportationIncentivesLawsAllQueryParams withIncentiveType(String incentiveType) {
    ...
    public TransportationIncentivesLawsAllQueryParams withJurisdiction(String jurisdiction) {
    ...
    public TransportationIncentivesLawsAllQueryParams withKeyword(String keyword) {
    ...
    public TransportationIncentivesLawsAllQueryParams withLawType(String lawType) {
    ...
    public Long limit;
    public TransportationIncentivesLawsAllQueryParams withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public TransportationIncentivesLawsAllQueryParams withLocal(Boolean local) {
        this.local = local;
        return this;
    }
    ...
    public Boolean poc;
    public TransportationIncentivesLawsAllQueryParams withPoc(Boolean poc) {
        this.poc = poc;
        return this;
    }
    ...
    public TransportationIncentivesLawsAllQueryParams withRecent(Boolean recent) {
        this.recent = recent;
        return this;
    }
    ...
    public TransportationIncentivesLawsAllQueryParams withRegulationType(String regulationType) {
    ...
    public TransportationIncentivesLawsAllQueryParams withTechnology(String technology) {
    ...
    public TransportationIncentivesLawsAllQueryParams withUserType(String userType) {
