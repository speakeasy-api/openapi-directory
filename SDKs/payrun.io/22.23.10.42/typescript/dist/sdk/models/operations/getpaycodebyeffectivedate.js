...
exports.GetPayCodeByEffectiveDateResponse = exports.GetPayCodeByEffectiveDateRequest = void 0;
...
var GetPayCodeByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetPayCodeByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetPayCodeByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetPayCodeByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetPayCodeByEffectiveDateRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayCodeId",
        }),
        __metadata("design:type", String)
    ], GetPayCodeByEffectiveDateRequest.prototype, "payCodeId", void 0);
...
var GetPayCodeByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetPayCodeByEffectiveDateResponse.prototype, "rawResponse", void 0);
