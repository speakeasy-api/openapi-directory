...
var GetEc2InstanceRecommendationsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: instancerecommendation_1.InstanceRecommendation }),
        (0, class_transformer_1.Expose)({ name: "instanceRecommendations" }),
        (0, class_transformer_1.Type)(function () { return instancerecommendation_1.InstanceRecommendation; }),
        __metadata("design:type", Array)
