...
public class GetQuestionsIdsRequest {
    ...
    public GetQuestionsIdsRequest withCallback(String callback) {
    ...
    public GetQuestionsIdsRequest withFilter(String filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GetQuestionsIdsRequest withFromdate(Long fromdate) {
    ...
    public GetQuestionsIdsRequest withIds(String ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetQuestionsIdsRequest withMax(String max) {
        this.max = max;
        return this;
    }
    ...
    public GetQuestionsIdsRequest withMin(String min) {
        this.min = min;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=order")
    public GetQuestionsIdsOrderEnum order;

    public GetQuestionsIdsRequest withOrder(GetQuestionsIdsOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetQuestionsIdsRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GetQuestionsIdsRequest withPagesize(Long pagesize) {
    ...
    public GetQuestionsIdsRequest withSite(String site) {
        this.site = site;
        return this;
    }
    
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=sort")
    public GetQuestionsIdsSortEnum sort;

    public GetQuestionsIdsRequest withSort(GetQuestionsIdsSortEnum sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetQuestionsIdsRequest withTodate(Long todate) {
        this.todate = todate;
        return this;
    }
    
    public GetQuestionsIdsRequest(@JsonProperty("ids") String ids, @JsonProperty("site") String site) {
        this.ids = ids;
        this.site = site;
  }
}
