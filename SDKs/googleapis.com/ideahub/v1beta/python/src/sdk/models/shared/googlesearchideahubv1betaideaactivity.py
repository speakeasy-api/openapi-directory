...
class GoogleSearchIdeahubV1betaIdeaActivity:
    ...
    type: Optional[GoogleSearchIdeahubV1betaIdeaActivityTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of activity performed."""  
