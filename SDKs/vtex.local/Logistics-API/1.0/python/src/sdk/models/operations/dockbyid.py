...
class DockByID200ApplicationJSON:
    ...
    pickup_store_info: DockByID200ApplicationJSONPickupStoreInfo1 = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pickupStoreInfo') }})  
...
@dataclasses.dataclass
class DockByIDResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    dock_by_id_200_application_json_object: Optional[DockByID200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
