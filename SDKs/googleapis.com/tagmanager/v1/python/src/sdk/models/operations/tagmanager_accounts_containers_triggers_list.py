...
class TagmanagerAccountsContainersTriggersListSecurity:
    ...
    option1: Optional[TagmanagerAccountsContainersTriggersListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[TagmanagerAccountsContainersTriggersListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
