...
var OptionalClaims = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: optionalclaim_1.OptionalClaim }),
        (0, class_transformer_1.Expose)({ name: "accessToken" }),
        (0, class_transformer_1.Type)(function () { return optionalclaim_1.OptionalClaim; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: optionalclaim_1.OptionalClaim }),
        (0, class_transformer_1.Expose)({ name: "samlToken" }),
        (0, class_transformer_1.Type)(function () { return optionalclaim_1.OptionalClaim; }),
        __metadata("design:type", Array)
