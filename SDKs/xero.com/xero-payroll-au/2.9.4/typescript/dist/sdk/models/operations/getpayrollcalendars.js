...
exports.GetPayrollCalendarsResponse = exports.GetPayrollCalendarsRequest = exports.GetPayrollCalendarsSecurity = void 0;
...
var GetPayrollCalendarsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetPayrollCalendarsRequest.prototype, "ifModifiedSince", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Xero-Tenant-Id",
        }),
        __metadata("design:type", String)
    ], GetPayrollCalendarsRequest.prototype, "xeroTenantId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=order" }),
        __metadata("design:type", String)
    ], GetPayrollCalendarsRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetPayrollCalendarsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=where" }),
        __metadata("design:type", String)
    ], GetPayrollCalendarsRequest.prototype, "where", void 0);
...
var GetPayrollCalendarsResponse = /** @class */ (function (_super) {
    ...
    ], GetPayrollCalendarsResponse.prototype, "rawResponse", void 0);
