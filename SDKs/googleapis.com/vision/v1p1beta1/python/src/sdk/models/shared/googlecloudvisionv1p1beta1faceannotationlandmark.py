...
class GoogleCloudVisionV1p1beta1FaceAnnotationLandmark:
    ...
    position: Optional[shared_googlecloudvisionv1p1beta1position.GoogleCloudVisionV1p1beta1Position] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('position'), 'exclude': lambda f: f is None }})
    ...
    type: Optional[GoogleCloudVisionV1p1beta1FaceAnnotationLandmarkTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Face landmark type."""  
