...
type DiscoveryengineProjectsLocationsDataStoresServingConfigsRecommendRequest struct {
	...
	GoogleCloudDiscoveryengineV1betaRecommendRequest *shared.GoogleCloudDiscoveryengineV1betaRecommendRequest `request:"mediaType=application/json"`
	// OAuth access token.
...
type DiscoveryengineProjectsLocationsDataStoresServingConfigsRecommendResponse struct {
	ContentType string
	// Successful response
	GoogleCloudDiscoveryengineV1betaRecommendResponse *shared.GoogleCloudDiscoveryengineV1betaRecommendResponse
	StatusCode                                        int
