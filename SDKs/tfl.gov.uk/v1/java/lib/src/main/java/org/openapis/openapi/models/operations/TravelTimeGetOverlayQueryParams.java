...
public class TravelTimeGetOverlayQueryParams {
    /**
     * The direction of travel.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=direction")
    public TravelTimeGetOverlayDirectionEnum direction;
    public TravelTimeGetOverlayQueryParams withDirection(TravelTimeGetOverlayDirectionEnum direction) {
    ...
    public TravelTimeGetOverlayQueryParams withModeId(String modeId) {
        this.modeId = modeId;
        return this;
    }
    ...
    public TravelTimeGetOverlayQueryParams withScenarioTitle(String scenarioTitle) {
    ...
    public TravelTimeGetOverlayQueryParams withTimeOfDayId(String timeOfDayId) {
    ...
    public TravelTimeGetOverlayQueryParams withTravelTimeInterval(Integer travelTimeInterval) {
