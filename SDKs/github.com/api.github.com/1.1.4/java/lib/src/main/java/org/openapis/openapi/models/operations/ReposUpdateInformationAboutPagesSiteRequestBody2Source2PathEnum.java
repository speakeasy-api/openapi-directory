 ...
 */
public enum ReposUpdateInformationAboutPagesSiteRequestBody2Source2PathEnum {
    ROOT("/"),
    ROOT_DOCS("/docs");
    ...
    private ReposUpdateInformationAboutPagesSiteRequestBody2Source2PathEnum(String value) {
        this.value = value;
    }
}
