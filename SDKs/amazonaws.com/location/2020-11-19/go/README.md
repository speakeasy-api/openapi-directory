...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/amazonaws.com/location/2020-11-19/go
```
...
func main() {
    ...
    res, err := s.AssociateTrackerConsumer(ctx, operations.AssociateTrackerConsumerRequest{
