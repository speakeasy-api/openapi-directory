...
public class PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("assetsGroups")
    public Long[][] assetsGroups;

    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withAssetsGroups(Long[][] assetsGroups) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withAssetsGroupsMatrix(Double[][] assetsGroupsMatrix) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withDeltaReturn(Double deltaReturn) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withDeltaVolatility(Double deltaVolatility) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withMaximumAssetsGroupsWeights(Double[] maximumAssetsGroupsWeights) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withMaximumAssetsWeights(Double[] maximumAssetsWeights) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withMaximumPortfolioExposure(Double maximumPortfolioExposure) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withMinimumAssetsWeights(Double[] minimumAssetsWeights) {
    ...
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints withMinimumPortfolioExposure(Double minimumPortfolioExposure) {
        this.minimumPortfolioExposure = minimumPortfolioExposure;
        return this;
    }
    
    public PostPortfolioOptimizationMaximumReturnDiversifiedRequestBodyConstraints(){}
}
