...
class OnDemandPageVideoUserUploadQuotaSpace
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserUploadQuotaSpaceShowingEnum $showing
     */
	#[\JMS\Serializer\Annotation\SerializedName('showing')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserUploadQuotaSpaceShowingEnum>')]
	...
	public function __construct()
	{
		$this->free = 0;
		$this->max = 0;
		$this->showing = \OpenAPI\OpenAPI\Models\Shared\OnDemandPageVideoUserUploadQuotaSpaceShowingEnum::LIFETIME;
		$this->used = 0;
	}
}
