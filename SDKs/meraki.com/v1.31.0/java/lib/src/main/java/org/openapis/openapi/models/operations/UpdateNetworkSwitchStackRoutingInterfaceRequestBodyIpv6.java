 ...
 */
public class UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 {
    /**
    ...
    public UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 withAddress(String address) {
    ...
    public UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 withAssignmentMode(String assignmentMode) {
    ...
    public UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 withGateway(String gateway) {
    ...
    public UpdateNetworkSwitchStackRoutingInterfaceRequestBodyIpv6 withPrefix(String prefix) {
        this.prefix = prefix;
        return this;
    }
