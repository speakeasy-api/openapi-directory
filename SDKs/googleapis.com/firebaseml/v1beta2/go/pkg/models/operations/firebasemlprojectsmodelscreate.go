...
type FirebasemlProjectsModelsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type FirebasemlProjectsModelsCreatePathParams struct {
...
type FirebasemlProjectsModelsCreateQueryParams struct {
	// V1 error format.
...
type FirebasemlProjectsModelsCreateResponse struct {
	ContentType string
	// Successful response
