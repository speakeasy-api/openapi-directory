...
class DataIssueDetailDataIssueSeverityEnum(str, Enum):
    r"""The severity of the data issue."""
    DATA_ISSUE_SEVERITY_UNSPECIFIED = 'DATA_ISSUE_SEVERITY_UNSPECIFIED'
    ERROR = 'ERROR'
    WARNING = 'WARNING'
    INFO = 'INFO'

class DataIssueDetailDataIssueTypeEnum(str, Enum):
    r"""The type of the data issue."""
...
class DataIssueDetail:
    r"""Details on a data issue in the listing."""
    
    data_issue_severity: Optional[DataIssueDetailDataIssueSeverityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataIssueSeverity'), 'exclude': lambda f: f is None }})
    r"""The severity of the data issue."""  
    data_issue_type: Optional[DataIssueDetailDataIssueTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dataIssueType'), 'exclude': lambda f: f is None }})
    r"""The type of the data issue."""  
    is_self_resolving: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('isSelfResolving'), 'exclude': lambda f: f is None }})
    r"""Whether or not the issue is self-resolving. If true, the issue is expected to resolve itself. If false or not set, action is needed to resolve the issue. Refer to documentation on the data issue’s type for further information."""  
