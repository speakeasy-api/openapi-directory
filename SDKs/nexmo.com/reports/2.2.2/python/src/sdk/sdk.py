...
class SDK:
    ...
    def cancel_report(self, request: operations.CancelReportRequest) -> operations.CancelReportResponse:
        ...
        res = operations.CancelReportResponse(status_code=r.status_code, content_type=content_type)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.cancel_report_401_application_json_any = out
        elif r.status_code == 404:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.cancel_report_404_application_json_any = out
        elif r.status_code == 409:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.cancel_report_409_application_json_any = out
    ...
    def create_async_report(self, request: operations.CreateAsyncReportRequest) -> operations.CreateAsyncReportResponse:
        ...
        res = operations.CreateAsyncReportResponse(status_code=r.status_code, content_type=content_type)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.create_async_report_400_application_json_any = out
        elif r.status_code == 401:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.create_async_report_401_application_json_any = out
        elif r.status_code == 403:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.create_async_report_403_application_json_any = out
        elif r.status_code == 422:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.create_async_report_422_application_json_any = out
    ...
    def download_report(self, request: operations.DownloadReportRequest) -> operations.DownloadReportResponse:
        ...
        res = operations.DownloadReportResponse(status_code=r.status_code, content_type=content_type)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.download_report_401_application_json_any = out
        elif r.status_code == 404:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.download_report_404_application_json_any = out
    ...
    def get_records(self, request: operations.GetRecordsRequest) -> operations.GetRecordsResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.get_records_403_application_json_any = out
        elif r.status_code == 422:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
    ...
    def get_report(self, request: operations.GetReportRequest) -> operations.GetReportResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.get_report_401_application_json_any = out
        elif r.status_code == 404:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.get_report_404_application_json_any = out
    ...
    def list_reports(self, request: operations.ListReportsRequest) -> operations.ListReportsResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.list_reports_400_application_json_any = out
        elif r.status_code == 401:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.list_reports_401_application_json_any = out
