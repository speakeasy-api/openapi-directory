...
class RemoveTagsFromVaultRequestBody:
    ...
    r"""A list of tag keys. Each corresponding tag is removed from the vault."""  
...
class RemoveTagsFromVaultRequest:
    ...
    request_body: RemoveTagsFromVaultRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
