...
export class MessageInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: AttachmentInput })
   ...
   */
  @SpeakeasyMetadata({ elemType: CardWithId })
  @Expose({ name: "cardsV2" })
  @Type(() => CardWithId)
  cardsV2?: CardWithId[];
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "clientAssignedMessageId" })
