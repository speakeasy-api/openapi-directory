...
class Projects:
    ...
    def appengine_projects_locations_applications_create(self, request: operations.AppengineProjectsLocationsApplicationsCreateRequest) -> operations.AppengineProjectsLocationsApplicationsCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta/projects/{projectsId}/locations/{locationsId}/applications", request.path_params)
        ...
        res = operations.AppengineProjectsLocationsApplicationsCreateResponse(status_code=r.status_code, content_type=content_type)
    ...
    def appengine_projects_locations_applications_get(self, request: operations.AppengineProjectsLocationsApplicationsGetRequest) -> operations.AppengineProjectsLocationsApplicationsGetResponse:
        r"""Gets information about an application.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/v1beta/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}", request.path_params)
        ...
        res = operations.AppengineProjectsLocationsApplicationsGetResponse(status_code=r.status_code, content_type=content_type)
    ...
    def appengine_projects_locations_applications_repair(self, request: operations.AppengineProjectsLocationsApplicationsRepairRequest) -> operations.AppengineProjectsLocationsApplicationsRepairResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta/projects/{projectsId}/locations/{locationsId}/applications/{applicationsId}:repair", request.path_params)
        ...
        res = operations.AppengineProjectsLocationsApplicationsRepairResponse(status_code=r.status_code, content_type=content_type)
    ...
    def appengine_projects_locations_get(self, request: operations.AppengineProjectsLocationsGetRequest) -> operations.AppengineProjectsLocationsGetResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta/projects/{projectsId}/locations/{locationsId}", request.path_params)
    ...
    def appengine_projects_locations_list(self, request: operations.AppengineProjectsLocationsListRequest) -> operations.AppengineProjectsLocationsListResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta/projects/{projectsId}/locations", request.path_params)
    ...
    def appengine_projects_locations_operations_get(self, request: operations.AppengineProjectsLocationsOperationsGetRequest) -> operations.AppengineProjectsLocationsOperationsGetResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta/projects/{projectsId}/locations/{locationsId}/operations/{operationsId}", request.path_params)
    ...
    def appengine_projects_locations_operations_list(self, request: operations.AppengineProjectsLocationsOperationsListRequest) -> operations.AppengineProjectsLocationsOperationsListResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta/projects/{projectsId}/locations/{locationsId}/operations", request.path_params)
