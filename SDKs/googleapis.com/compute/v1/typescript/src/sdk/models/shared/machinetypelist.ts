 ...
 */
export enum MachineTypeListWarningCodeEnum {
...
export class MachineTypeListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class MachineTypeListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: MachineTypeListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: MachineTypeListWarningData })
  @Expose({ name: "data" })
  @Type(() => MachineTypeListWarningData)
  data?: MachineTypeListWarningData[];
 ...
 */
export class MachineTypeList extends SpeakeasyBase {
  /**
