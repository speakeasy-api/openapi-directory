...
import { InternalIpAddress } from "./internalipaddress";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum IpAddressesListWarningCodeEnum {
...
export declare class IpAddressesListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class IpAddressesListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: IpAddressesListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: IpAddressesListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class IpAddressesList extends SpeakeasyBase {
    /**
     ...
     * [Output Only] Informational warning message.
     */
    warning?: IpAddressesListWarning;
}
