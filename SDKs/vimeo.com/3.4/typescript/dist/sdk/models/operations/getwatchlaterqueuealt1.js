...
exports.GetWatchLaterQueueAlt1Response = exports.GetWatchLaterQueueAlt1Request = exports.GetWatchLaterQueueAlt1SortEnum = exports.GetWatchLaterQueueAlt1FilterEnum = exports.GetWatchLaterQueueAlt1DirectionEnum = exports.GetWatchLaterQueueAlt1Security = void 0;
...
var GetWatchLaterQueueAlt1Request = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetWatchLaterQueueAlt1Request.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], GetWatchLaterQueueAlt1Request.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter_embeddable",
        }),
        __metadata("design:type", Boolean)
    ], GetWatchLaterQueueAlt1Request.prototype, "filterEmbeddable", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetWatchLaterQueueAlt1Request.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetWatchLaterQueueAlt1Request.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetWatchLaterQueueAlt1Request.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetWatchLaterQueueAlt1Request.prototype, "sort", void 0);
...
var GetWatchLaterQueueAlt1Response = /** @class */ (function (_super) {
    ...
    ], GetWatchLaterQueueAlt1Response.prototype, "rawResponse", void 0);
    __decorate([
