...
var Users = /** @class */ (function () {
     ...
     */
    Users.prototype.addUser = function (req, security, config) {
        var _a;
     ...
     * Can only be used by an **administrative** user.
     */
    Users.prototype.deleteUser = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Can only be used by an **administrative** user.
     */
    Users.prototype.getUserById = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.user = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.UserOutput);
                    }
                    break;
            }
            return res;
     ...
     * Can only be used by an **administrative** user.
     */
    Users.prototype.getUsers = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Can only be used by an **administrative** user.
     */
    Users.prototype.updateUser = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
