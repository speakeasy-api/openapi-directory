...
var atoz_1 = require("./atoz");
var categories_1 = require("./categories");
var channels_1 = require("./channels");
var episodes_1 = require("./episodes");
var metadata_1 = require("./metadata");
var shared = __importStar(require("./models/shared"));
var programmestleos_1 = require("./programmestleos");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.aToZ = new atoz_1.AToZ(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.programmesTLEOs = new programmestleos_1.ProgrammesTLEOs(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
