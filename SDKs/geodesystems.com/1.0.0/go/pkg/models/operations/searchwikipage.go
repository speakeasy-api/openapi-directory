...
type SearchWikipageQueryParams struct {
	...
	// Wiki Page Category
	SearchWikipageCategory *string `queryParam:"style=form,explode=true,name=search.wikipage.category"`
	// Wiki Text
	SearchWikipageWikitext *string `queryParam:"style=form,explode=true,name=search.wikipage.wikitext"`
	// Number to skip
