...
from ..shared import openzfscreaterootvolumeconfiguration as shared_openzfscreaterootvolumeconfiguration
...
class CreateFileSystemOpenZFSConfiguration:
    r"""The Amazon FSx for OpenZFS configuration properties for the file system that you are creating."""
    
    deployment_type: shared_openzfsdeploymenttype_enum.OpenZFSDeploymentTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeploymentType') }})  
    ...
    root_volume_configuration: Optional[shared_openzfscreaterootvolumeconfiguration.OpenZFSCreateRootVolumeConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RootVolumeConfiguration'), 'exclude': lambda f: f is None }})  
