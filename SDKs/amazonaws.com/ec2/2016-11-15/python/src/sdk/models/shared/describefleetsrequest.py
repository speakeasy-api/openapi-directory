...
class DescribeFleetsRequestFilters:
...
class DescribeFleetsRequest:
    ...
    filters: Optional[list[DescribeFleetsRequestFilters]] = dataclasses.field(default=None)  
    fleet_ids: Optional[list[str]] = dataclasses.field(default=None)  
