...
try {
    ...
    $request->clientSecret = 'labore';
    $request->fingerprint = 'veritatis';
    $request->note = 'Update all gems';
    $request->noteUrl = 'vero';
    $request->scopes = [
        'vitae',
    ];
...
try {
    ...
    $request->requestBody->fingerprint = 'ex';
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'nemo';
...
try {
    ...
    $request->requestBody->clientSecret = 'fugit';
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'alias';
    $request->requestBody->scopes = [
        'vel',
    ];
    $request->clientId = 'quae';
    $request->fingerprint = 'quae';
...
try {
    ...
    $request->requestBody->fingerprint = 'quia';
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'quia';
    ...
    $request->authorizationId = 727888;
