...
class PutSchemaFromJSONRequest:
    headers: PutSchemaFromJSONHeaders = dataclasses.field()
    request: PutSchemaFromJSONRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class PutSchemaFromJSONResponse:
    ...
    invalid_schema_doc_exception: Optional[Any] = dataclasses.field(default=None)
