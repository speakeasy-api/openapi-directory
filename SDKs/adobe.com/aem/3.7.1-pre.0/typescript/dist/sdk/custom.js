...
var Custom = /** @class */ (function () {
    function Custom(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    Custom.prototype.getAemHealthCheck = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetAemHealthCheckResponse({
    ...
    Custom.prototype.postConfigAemHealthCheckServlet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostConfigAemHealthCheckServletResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    Custom.prototype.postConfigAemPasswordReset = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.PostConfigAemPasswordResetResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
