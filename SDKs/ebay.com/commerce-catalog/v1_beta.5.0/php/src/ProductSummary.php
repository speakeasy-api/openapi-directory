...
class ProductSummary 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\SearchResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/product_summary/search');
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->productSearchResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ProductSearchResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 204 or $httpResponse->getStatusCode() === 400 or $httpResponse->getStatusCode() === 403 or $httpResponse->getStatusCode() === 500) {
        }
