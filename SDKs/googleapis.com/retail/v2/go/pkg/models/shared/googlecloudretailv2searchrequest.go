...
func (e GoogleCloudRetailV2SearchRequestSearchModeEnum) ToPointer() *GoogleCloudRetailV2SearchRequestSearchModeEnum {
	return &e
}

func (e *GoogleCloudRetailV2SearchRequestSearchModeEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "FACETED_SEARCH_ONLY":
		*e = GoogleCloudRetailV2SearchRequestSearchModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudRetailV2SearchRequestSearchModeEnum: %v", v)
	}
}
