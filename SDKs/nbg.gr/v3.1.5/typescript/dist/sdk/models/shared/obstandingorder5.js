...
exports.ObStandingOrder5 = void 0;
...
var obexternalstandingorderstatus1codeenum_1 = require("./obexternalstandingorderstatus1codeenum");
var ObStandingOrder5 = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FinalPaymentAmount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FinalPaymentDateTime" }),
        __metadata("design:type", Date)
    ], ObStandingOrder5.prototype, "finalPaymentDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FirstPaymentAmount" }),
        __metadata("design:type", obactiveorhistoriccurrencyandamount_1.ObActiveOrHistoricCurrencyAndAmount)
    ], ObStandingOrder5.prototype, "firstPaymentAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=FirstPaymentDateTime" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=LastPaymentDateTime" }),
        __metadata("design:type", Date)
    ], ObStandingOrder5.prototype, "lastPaymentDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NextPaymentAmount" }),
        __metadata("design:type", obactiveorhistoriccurrencyandamount_1.ObActiveOrHistoricCurrencyAndAmount)
    ], ObStandingOrder5.prototype, "nextPaymentAmount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NextPaymentDateTime" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=StandingOrderId" }),
        __metadata("design:type", String)
    ], ObStandingOrder5.prototype, "standingOrderId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=StandingOrderStatusCode" }),
        __metadata("design:type", String)
    ], ObStandingOrder5.prototype, "standingOrderStatusCode", void 0);
    return ObStandingOrder5;
}(utils_1.SpeakeasyBase));
exports.ObStandingOrder5 = ObStandingOrder5;
