...
func (e AndroidenterpriseEnterprisesCreateEnrollmentTokenDeviceTypeEnum) ToPointer() *AndroidenterpriseEnterprisesCreateEnrollmentTokenDeviceTypeEnum {
	return &e
}
...
func (e *AndroidenterpriseEnterprisesCreateEnrollmentTokenDeviceTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "knowledgeWorker":
		*e = AndroidenterpriseEnterprisesCreateEnrollmentTokenDeviceTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for AndroidenterpriseEnterprisesCreateEnrollmentTokenDeviceTypeEnum: %v", v)
	}
}
