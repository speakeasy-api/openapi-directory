...
from ..shared import importreferencesourceitem as shared_importreferencesourceitem
...
class GetReferenceImportJobResponse:
    ...
    sources: list[shared_importreferencesourceitem.ImportReferenceSourceItem] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sources') }})  
