...
export class ConsentFlow {
  ...
  **/
  postV05ConsentRequestsOnInit(
    ...
    let baseURL: string = operations.PostV05ConsentRequestsOnInitServerList[0];
    if (req.serverURL) {
  ...
  **/
  postV05ConsentRequestsOnStatus(
    ...
    let baseURL: string = operations.PostV05ConsentRequestsOnStatusServerList[0];
    if (req.serverURL) {
      baseURL = req.serverURL;
    }
  ...
  **/
  postV05ConsentsOnFetch(
    ...
    let baseURL: string = operations.PostV05ConsentsOnFetchServerList[0];
    if (req.serverURL) {
      baseURL = req.serverURL;
    }
