...
from ..shared import sizeconstraint as shared_sizeconstraint


@dataclass_json
@dataclasses.dataclass
class SizeConstraintSetUpdate:
    r"""SizeConstraintSetUpdate
    ...
    size_constraint: shared_sizeconstraint.SizeConstraint = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SizeConstraint') }})
