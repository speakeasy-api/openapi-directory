...
class UpdateNetworkWirelessSettings200ApplicationJSONNamedVlans:
    ...
    pool_dhcp_monitoring: Optional[UpdateNetworkWirelessSettings200ApplicationJSONNamedVlansPoolDhcpMonitoring] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('poolDhcpMonitoring'), 'exclude': lambda f: f is None }})
    r"""Named VLAN Pool DHCP Monitoring settings."""  
    
class UpdateNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum(str, Enum):
    r"""The upgrade strategy to apply to the network. Must be one of 'minimizeUpgradeTime' or 'minimizeClientDowntime'. Requires firmware version MR 26.8 or higher'"""
    MINIMIZE_CLIENT_DOWNTIME = 'minimizeClientDowntime'
    MINIMIZE_UPGRADE_TIME = 'minimizeUpgradeTime'
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateNetworkWirelessSettings200ApplicationJSON:
    ...
    meshing_enabled: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meshingEnabled'), 'exclude': lambda f: f is None }})
    r"""Toggle for enabling or disabling meshing in a network"""  
    named_vlans: Optional[UpdateNetworkWirelessSettings200ApplicationJSONNamedVlans] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('namedVlans'), 'exclude': lambda f: f is None }})
    r"""Named VLAN settings for wireless networks."""  
    upgrade_strategy: Optional[UpdateNetworkWirelessSettings200ApplicationJSONUpgradeStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('upgradeStrategy'), 'exclude': lambda f: f is None }})
    r"""The upgrade strategy to apply to the network. Must be one of 'minimizeUpgradeTime' or 'minimizeClientDowntime'. Requires firmware version MR 26.8 or higher'"""  
...
class UpdateNetworkWirelessSettingsResponse:
    ...
    update_network_wireless_settings_200_application_json_object: Optional[UpdateNetworkWirelessSettings200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
