...
public class PostLoadBalancersCreateLoadBalancerRequestLoadBalancerServiceLoadBalancerServiceHealthCheck {
    ...
    public PostLoadBalancersCreateLoadBalancerRequestLoadBalancerServiceLoadBalancerServiceHealthCheck(@JsonProperty("interval") Long interval, @JsonProperty("port") Long port, @JsonProperty("protocol") PostLoadBalancersCreateLoadBalancerRequestLoadBalancerServiceLoadBalancerServiceHealthCheckProtocolEnum protocol, @JsonProperty("retries") Long retries, @JsonProperty("timeout") Long timeout) {
        this.interval = interval;
        this.port = port;
        this.protocol = protocol;
        this.retries = retries;
