...
export class ComputeServiceAttachmentsPatchSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ComputeServiceAttachmentsPatchSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ComputeServiceAttachmentsPatchSecurity extends SpeakeasyBase {
...
export class ComputeServiceAttachmentsPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
   ...
   */
  @SpeakeasyMetadata({
    data: "queryParam, style=form;explode=true;name=reconcileConnections",
  })
...
export class ComputeServiceAttachmentsPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
