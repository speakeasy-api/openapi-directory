...
class Transaction
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\TransactionCurrencyEnum $currency
     */
	#[\JMS\Serializer\Annotation\SerializedName('currency')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TransactionCurrencyEnum>')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\TransactionRouteTypeEnum $routeType
     */
	#[\JMS\Serializer\Annotation\SerializedName('route_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TransactionRouteTypeEnum>')]
    public TransactionRouteTypeEnum $routeType;
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\TransactionTransactionSource $source
     */
	#[\JMS\Serializer\Annotation\SerializedName('source')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\TransactionTransactionSource')]
	...
	public function __construct()
	{
		...
		$this->currency = \OpenAPI\OpenAPI\Models\Shared\TransactionCurrencyEnum::CAD;
		$this->description = "";
		$this->id = "";
		$this->routeId = "";
		$this->routeType = \OpenAPI\OpenAPI\Models\Shared\TransactionRouteTypeEnum::ACCOUNT_NUMBER;
		$this->source = new \OpenAPI\OpenAPI\Models\Shared\TransactionTransactionSource();
		$this->type = \OpenAPI\OpenAPI\Models\Shared\TransactionTypeEnum::TRANSACTION;
	}
}
