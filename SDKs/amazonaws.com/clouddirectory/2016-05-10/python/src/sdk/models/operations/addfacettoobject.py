...
class AddFacetToObjectRequestBody:
    object_reference: AddFacetToObjectRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    schema_facet: AddFacetToObjectRequestBodySchemaFacet = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SchemaFacet') }})
...
class AddFacetToObjectRequest:
    headers: AddFacetToObjectHeaders = dataclasses.field()
    request: AddFacetToObjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
