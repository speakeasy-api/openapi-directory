...
from ..shared import googlecloudvideointelligencev1_speechcontext as shared_googlecloudvideointelligencev1_speechcontext
...
class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[list[shared_googlecloudvideointelligencev1_speechcontext.GoogleCloudVideointelligenceV1SpeechContext]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
