...
export enum DerivedHoldingHoldingTypeEnum {
    Stock = "stock",
...
export enum DerivedHoldingOptionTypeEnum {
    Put = "put",
    Call = "call",
    Unknown = "unknown",
    Other = "other"
...
export class DerivedHolding extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=assetClassification" })
  ...
  holdingType?: DerivedHoldingHoldingTypeEnum;
  ...
  optionType?: DerivedHoldingOptionTypeEnum;
