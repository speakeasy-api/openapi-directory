...
exports.ListPlayerStreamerResponse = exports.ListPlayerStreamerListPlayerStreamerResponse = exports.ListPlayerStreamerListPlayerStreamerResponseMeta = exports.ListPlayerStreamerRequest = exports.ListPlayerStreamerSecurity = exports.ListPlayerStreamerServerList = void 0;
...
var ListPlayerStreamerSecurity = /** @class */ (function (_super) {
    ...
    ], ListPlayerStreamerSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListPlayerStreamerSecurity.prototype, "username", void 0);
...
var ListPlayerStreamerRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListPlayerStreamerRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListPlayerStreamerRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListPlayerStreamerRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListPlayerStreamerRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListPlayerStreamerRequest.prototype, "status", void 0);
...
var ListPlayerStreamerListPlayerStreamerResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListPlayerStreamerListPlayerStreamerResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.MediaV1PlayerStreamer }),
        (0, class_transformer_1.Expose)({ name: "player_streamers" }),
        (0, class_transformer_1.Type)(function () { return shared.MediaV1PlayerStreamer; }),
...
var ListPlayerStreamerResponse = /** @class */ (function (_super) {
    ...
    ], ListPlayerStreamerResponse.prototype, "rawResponse", void 0);
