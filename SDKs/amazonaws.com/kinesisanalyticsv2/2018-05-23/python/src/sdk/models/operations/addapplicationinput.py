...
from ..shared import addapplicationinputresponse as shared_addapplicationinputresponse

class AddApplicationInputXAmzTargetEnum(str, Enum):
    KINESIS_ANALYTICS_20180523_ADD_APPLICATION_INPUT = "KinesisAnalytics_20180523.AddApplicationInput"
...
class AddApplicationInputResponse:
    ...
    add_application_input_response: Optional[shared_addapplicationinputresponse.AddApplicationInputResponse] = dataclasses.field(default=None)
