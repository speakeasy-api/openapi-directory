...
public class GetSKUoffersRequest {
    ...
    public GetSKUoffersRequest(@JsonProperty("Accept") String accept, @JsonProperty("Content-Type") String contentType, @JsonProperty("accountName") String accountName, @JsonProperty("environment") String environment, @JsonProperty("productId") String productId, @JsonProperty("skuId") String skuId) {
        this.accept = accept;
        this.contentType = contentType;
        this.accountName = accountName;
        this.environment = environment;
