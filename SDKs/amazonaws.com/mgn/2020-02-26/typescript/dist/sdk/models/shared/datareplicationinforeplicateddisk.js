...
exports.DataReplicationInfoReplicatedDisk = void 0;
var utils_1 = require("../../../internal/utils");
// DataReplicationInfoReplicatedDisk
/**
 * Request to query disks replicated.
**/
var DataReplicationInfoReplicatedDisk = /** @class */ (function (_super) {
    __extends(DataReplicationInfoReplicatedDisk, _super);
    function DataReplicationInfoReplicatedDisk() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=backloggedStorageBytes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=replicatedStorageBytes" }),
        __metadata("design:type", Number)
    ], DataReplicationInfoReplicatedDisk.prototype, "replicatedStorageBytes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rescannedStorageBytes" }),
        __metadata("design:type", Number)
    ], DataReplicationInfoReplicatedDisk.prototype, "rescannedStorageBytes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalStorageBytes" }),
        __metadata("design:type", Number)
