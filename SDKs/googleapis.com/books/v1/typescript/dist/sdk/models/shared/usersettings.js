...
var UsersettingsNotesExport = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "folderName" }),
...
var UsersettingsNotificationMatchMyInterests = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "opted_state" }),
        __metadata("design:type", String)
...
var UsersettingsNotification = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "matchMyInterests" }),
        (0, class_transformer_1.Type)(function () { return UsersettingsNotificationMatchMyInterests; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "moreFromAuthors" }),
        (0, class_transformer_1.Type)(function () { return UsersettingsNotificationMoreFromAuthors; }),
        __metadata("design:type", UsersettingsNotificationMoreFromAuthors)
    ], UsersettingsNotification.prototype, "moreFromAuthors", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "moreFromSeries" }),
        (0, class_transformer_1.Type)(function () { return UsersettingsNotificationMoreFromSeries; }),
        __metadata("design:type", UsersettingsNotificationMoreFromSeries)
    ], UsersettingsNotification.prototype, "moreFromSeries", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "priceDrop" }),
        (0, class_transformer_1.Type)(function () { return UsersettingsNotificationPriceDrop; }),
        __metadata("design:type", UsersettingsNotificationPriceDrop)
    ], UsersettingsNotification.prototype, "priceDrop", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "rewardExpirations" }),
        (0, class_transformer_1.Type)(function () { return UsersettingsNotificationRewardExpirations; }),
...
var Usersettings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "notesExport" }),
        (0, class_transformer_1.Type)(function () { return UsersettingsNotesExport; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return UsersettingsNotification; }),
