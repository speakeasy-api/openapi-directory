...
export class User {
  ...
  apiKeyOwner(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ApiKeyOwnerResponse =
        new operations.ApiKeyOwnerResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.apiKeyOwner200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.ApiKeyOwner200ApplicationJSON
            );
          }
          break;
      }
