...
type BaremetalsolutionProjectsLocationsVolumesSnapshotsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BaremetalsolutionProjectsLocationsVolumesSnapshotsListPathParams struct {
	// Required. Parent value for ListVolumesRequest.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type BaremetalsolutionProjectsLocationsVolumesSnapshotsListQueryParams struct {
	// V1 error format.
...
type BaremetalsolutionProjectsLocationsVolumesSnapshotsListRequest struct {
...
type BaremetalsolutionProjectsLocationsVolumesSnapshotsListResponse struct {
	ContentType string
	// Successful response
