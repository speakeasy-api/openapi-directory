...
export declare class CreateDomesticScheduledPaymentConsentsJsonSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateDomesticScheduledPaymentConsentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticScheduledPaymentConsentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
