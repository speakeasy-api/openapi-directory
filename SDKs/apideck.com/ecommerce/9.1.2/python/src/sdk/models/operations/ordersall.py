...
from ..shared import ecommerceordersfilter as shared_ecommerceordersfilter
from ..shared import getecommerceordersresponse as shared_getecommerceordersresponse
...
class OrdersAllRequest:
    ...
    filter: Optional[shared_ecommerceordersfilter.EcommerceOrdersFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
class OrdersAllResponse:
    ...
    r"""Bad Request"""  
    get_ecommerce_orders_response: Optional[shared_getecommerceordersresponse.GetEcommerceOrdersResponse] = dataclasses.field(default=None)
    r"""Orders"""  
