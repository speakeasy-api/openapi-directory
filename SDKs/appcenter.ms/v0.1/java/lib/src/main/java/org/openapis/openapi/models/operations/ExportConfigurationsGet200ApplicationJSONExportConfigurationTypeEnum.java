 ...
 */
public enum ExportConfigurationsGet200ApplicationJSONExportConfigurationTypeEnum {
    ...
    private ExportConfigurationsGet200ApplicationJSONExportConfigurationTypeEnum(String value) {
        this.value = value;
    }
}
