...
exports.GetDomesticStandingOrdersDomesticStandingOrderIdResponse = exports.GetDomesticStandingOrdersDomesticStandingOrderIdRequest = exports.GetDomesticStandingOrdersDomesticStandingOrderIdSecurity = void 0;
...
exports.GetDomesticStandingOrdersDomesticStandingOrderIdSecurity = GetDomesticStandingOrdersDomesticStandingOrderIdSecurity;
var GetDomesticStandingOrdersDomesticStandingOrderIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomesticStandingOrderId",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdRequest.prototype, "domesticStandingOrderId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetDomesticStandingOrdersDomesticStandingOrderIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetDomesticStandingOrdersDomesticStandingOrderIdRequest = GetDomesticStandingOrdersDomesticStandingOrderIdRequest;
var GetDomesticStandingOrdersDomesticStandingOrderIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdResponse.prototype, "rawResponse", void 0);
    return GetDomesticStandingOrdersDomesticStandingOrderIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetDomesticStandingOrdersDomesticStandingOrderIdResponse = GetDomesticStandingOrdersDomesticStandingOrderIdResponse;
