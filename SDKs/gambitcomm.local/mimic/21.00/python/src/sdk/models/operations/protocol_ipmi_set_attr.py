...
class ProtocolIpmiSetAttrRequest:
    path_params: ProtocolIpmiSetAttrPathParams = dataclasses.field()
...
class ProtocolIpmiSetAttrResponse:
    ...
    protocol_ipmi_set_attr_200_application_json_string: Optional[str] = dataclasses.field(default=None)
