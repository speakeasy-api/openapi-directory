...
class ListMedicalVocabulariesRequest:
    ...
    list_medical_vocabularies_request: shared_listmedicalvocabulariesrequest.ListMedicalVocabulariesRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
