...
class ListResolverQueryLogConfigsRequest:
    ...
    list_resolver_query_log_configs_request: shared_listresolverquerylogconfigsrequest.ListResolverQueryLogConfigsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
