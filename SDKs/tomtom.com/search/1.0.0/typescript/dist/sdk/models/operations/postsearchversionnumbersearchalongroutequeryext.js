...
var PostSearchVersionNumberSearchAlongRouteQueryExtRequestBodyRoute = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: PostSearchVersionNumberSearchAlongRouteQueryExtRequestBodyRoutePoints,
        }),
        (0, class_transformer_1.Expose)({ name: "points" }),
        (0, class_transformer_1.Type)(function () { return PostSearchVersionNumberSearchAlongRouteQueryExtRequestBodyRoutePoints; }),
...
var PostSearchVersionNumberSearchAlongRouteQueryExtRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return PostSearchVersionNumberSearchAlongRouteQueryExtRequestBodyRoute; }),
...
var PostSearchVersionNumberSearchAlongRouteQueryExtRequest = /** @class */ (function (_super) {
    ...
    ], PostSearchVersionNumberSearchAlongRouteQueryExtRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ext" }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberSearchAlongRouteQueryExtRequest.prototype, "ext", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], PostSearchVersionNumberSearchAlongRouteQueryExtRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=maxDetourTime",
        }),
        __metadata("design:type", Number)
    ], PostSearchVersionNumberSearchAlongRouteQueryExtRequest.prototype, "maxDetourTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=query",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberSearchAlongRouteQueryExtRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=versionNumber",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberSearchAlongRouteQueryExtRequest.prototype, "versionNumber", void 0);
...
var PostSearchVersionNumberSearchAlongRouteQueryExtResponse = /** @class */ (function (_super) {
    ...
    ], PostSearchVersionNumberSearchAlongRouteQueryExtResponse.prototype, "rawResponse", void 0);
