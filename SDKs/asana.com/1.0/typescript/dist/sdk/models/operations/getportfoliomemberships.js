...
exports.GetPortfolioMembershipsResponse = exports.GetPortfolioMemberships200ApplicationJSON = exports.GetPortfolioMembershipsRequest = void 0;
...
var GetPortfolioMembershipsRequest = /** @class */ (function (_super) {
    ...
    ], GetPortfolioMembershipsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", String)
    ], GetPortfolioMembershipsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=opt_fields",
        }),
        __metadata("design:type", Array)
    ], GetPortfolioMembershipsRequest.prototype, "optFields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=opt_pretty",
        }),
        __metadata("design:type", Boolean)
    ], GetPortfolioMembershipsRequest.prototype, "optPretty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=portfolio",
        }),
        __metadata("design:type", String)
    ], GetPortfolioMembershipsRequest.prototype, "portfolio", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=user" }),
        __metadata("design:type", String)
    ], GetPortfolioMembershipsRequest.prototype, "user", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetPortfolioMembershipsRequest.prototype, "workspace", void 0);
...
var GetPortfolioMemberships200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PortfolioMembershipCompact }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.PortfolioMembershipCompact; }),
        __metadata("design:type", Array)
...
var GetPortfolioMembershipsResponse = /** @class */ (function (_super) {
    ...
    ], GetPortfolioMembershipsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
