...
exports.CreateObjectResponse = exports.CreateObjectRequest = exports.CreateObjectRequestBody = exports.CreateObjectRequestBodyParentReference = void 0;
...
var CreateObjectRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return CreateObjectRequestBodyParentReference; }),
        __metadata("design:type", CreateObjectRequestBodyParentReference)
    ], CreateObjectRequestBody.prototype, "parentReference", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SchemaFacet }),
        (0, class_transformer_1.Expose)({ name: "SchemaFacets" }),
        (0, class_transformer_1.Type)(function () { return shared.SchemaFacet; }),
        __metadata("design:type", Array)
...
var CreateObjectRequest = /** @class */ (function (_super) {
    ...
    ], CreateObjectRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-amz-data-partition",
        }),
        __metadata("design:type", String)
    ], CreateObjectRequest.prototype, "xAmzDataPartition", void 0);
...
var CreateObjectResponse = /** @class */ (function (_super) {
    ...
    ], CreateObjectResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
