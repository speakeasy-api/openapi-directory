...
class ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetRequest:
    path_params: ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetPathParams = dataclasses.field()
    query_params: ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetQueryParams = dataclasses.field()
    security: ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetSecurity = dataclasses.field()
