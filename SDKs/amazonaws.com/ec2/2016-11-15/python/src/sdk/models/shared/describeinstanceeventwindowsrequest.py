...
class DescribeInstanceEventWindowsRequest:
    r"""<para>Describe instance event windows by InstanceEventWindow.</para>"""
    
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeInstanceEventWindowsRequestFilters]] = dataclasses.field(default=None)  
    instance_event_window_ids: Optional[list[str]] = dataclasses.field(default=None)  
