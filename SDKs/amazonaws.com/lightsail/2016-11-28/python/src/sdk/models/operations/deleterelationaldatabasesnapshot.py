...
class DeleteRelationalDatabaseSnapshotRequest:
    ...
    delete_relational_database_snapshot_request: shared_deleterelationaldatabasesnapshotrequest.DeleteRelationalDatabaseSnapshotRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
