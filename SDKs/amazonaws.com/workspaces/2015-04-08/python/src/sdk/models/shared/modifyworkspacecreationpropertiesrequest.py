...
class ModifyWorkspaceCreationPropertiesRequest:
    ...
    workspace_creation_properties: shared_workspacecreationproperties.WorkspaceCreationProperties = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WorkspaceCreationProperties') }})  
