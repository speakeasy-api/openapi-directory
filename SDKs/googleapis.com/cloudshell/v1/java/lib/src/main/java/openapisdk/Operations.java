...
public class Operations {
    ...
    **/
    public openapisdk.models.operations.CloudshellOperationsCancelResponse cloudshellOperationsCancel(openapisdk.models.operations.CloudshellOperationsCancelRequest request) throws Exception {
        ...
        openapisdk.models.operations.CloudshellOperationsCancelResponse res = new openapisdk.models.operations.CloudshellOperationsCancelResponse() {{
            empty = null;
        }};
    ...
    **/
    public openapisdk.models.operations.CloudshellOperationsDeleteResponse cloudshellOperationsDelete(openapisdk.models.operations.CloudshellOperationsDeleteRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.CloudshellOperationsDeleteResponse res = new openapisdk.models.operations.CloudshellOperationsDeleteResponse() {{
            empty = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
