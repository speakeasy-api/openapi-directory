...
export declare class GetUnmaskedClientAddressesRequest extends SpeakeasyBase {
    /**
...
export declare class GetUnmaskedClientAddressesResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
    getUnmaskedClientAddresses200ApplicationJSONObjects?: Record<string, any>[];
    statusCode: number;
