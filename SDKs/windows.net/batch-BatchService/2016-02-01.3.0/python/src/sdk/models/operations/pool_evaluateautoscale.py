...
@dataclasses.dataclass
class PoolEvaluateAutoScaleHeaders:
...
@dataclasses.dataclass
class PoolEvaluateAutoScaleRequest:
    headers: PoolEvaluateAutoScaleHeaders = dataclasses.field()
    path_params: PoolEvaluateAutoScalePathParams = dataclasses.field()
    query_params: PoolEvaluateAutoScaleQueryParams = dataclasses.field()
    request: Any = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PoolEvaluateAutoScaleResponse:
    content_type: str = dataclasses.field()
    headers: dict[str, list[str]] = dataclasses.field()
    status_code: int = dataclasses.field()
    auto_scale_run: Optional[Any] = dataclasses.field(default=None)
