...
class IdentitytoolkitRelyingpartyVerifyPasswordRequest:
    ...
    identitytoolkit_relyingparty_verify_password_request: Optional[shared_identitytoolkitrelyingpartyverifypasswordrequest.IdentitytoolkitRelyingpartyVerifyPasswordRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
