...
public enum GoogleCloudVideointelligenceV1beta2AnnotateVideoRequestFeaturesEnum {
    ...
    private GoogleCloudVideointelligenceV1beta2AnnotateVideoRequestFeaturesEnum(String value) {
        this.value = value;
    }
}
