...
public class RegistryUpdateApiDeploymentQueryParams {
    /**
    ...
    public RegistryUpdateApiDeploymentQueryParams withAllowMissing(Boolean allowMissing) {
    ...
    public RegistryUpdateApiDeploymentQueryParams withUpdateMask(String updateMask) {
