...
class ListConnectorVersionsResponse:
    ...
    connector_versions: Optional[list[shared_connectorversion.ConnectorVersion]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('connectorVersions'), 'exclude': lambda f: f is None }})
    r"""A list of connector versions."""  
