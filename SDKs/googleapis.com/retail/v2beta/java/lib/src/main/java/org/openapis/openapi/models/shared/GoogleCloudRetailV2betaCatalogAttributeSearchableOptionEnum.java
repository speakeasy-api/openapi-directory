 ...
 */
public enum GoogleCloudRetailV2betaCatalogAttributeSearchableOptionEnum {
    ...
    private GoogleCloudRetailV2betaCatalogAttributeSearchableOptionEnum(String value) {
        this.value = value;
    }
}
