...
export class CloudassetSavedQueriesGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudassetSavedQueriesGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudassetSavedQueriesGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
