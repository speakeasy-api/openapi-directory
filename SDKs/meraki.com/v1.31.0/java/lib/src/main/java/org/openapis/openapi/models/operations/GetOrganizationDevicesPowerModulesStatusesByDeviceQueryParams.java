...
public class GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams {
    /**
     * A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=endingBefore")
    public String endingBefore;
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withEndingBefore(String endingBefore) {
    ...
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withNetworkIds(String[] networkIds) {
    ...
    public Long perPage;
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withPerPage(Long perPage) {
    ...
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withProductTypes(String[] productTypes) {
    ...
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withSerials(String[] serials) {
    ...
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withStartingAfter(String startingAfter) {
    ...
    public String[] tags;
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withTags(String[] tags) {
        this.tags = tags;
        return this;
    }
    ...
    public GetOrganizationDevicesPowerModulesStatusesByDeviceQueryParams withTagsFilterType(GetOrganizationDevicesPowerModulesStatusesByDeviceTagsFilterTypeEnum tagsFilterType) {
