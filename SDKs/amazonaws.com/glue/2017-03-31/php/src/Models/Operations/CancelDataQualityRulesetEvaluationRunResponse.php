...
class CancelDataQualityRulesetEvaluationRunResponse
{
     ...
     * Success
     * 
     * @var ?array<string, mixed> $cancelDataQualityRulesetEvaluationRunResponse
     */
	
    public ?array $cancelDataQualityRulesetEvaluationRunResponse = null;
	...
	{
		$this->cancelDataQualityRulesetEvaluationRunResponse = null;
		$this->contentType = "";
