...
export class GetCategory200ApplicationJSONCategoryGroupPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetCategory200ApplicationJSONCategoryRequiredTagGroups extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetCategory200ApplicationJSONCategory extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @Type(() => GetCategory200ApplicationJSONCategoryGroupPermissions)
  ...
  @Type(() => GetCategory200ApplicationJSONCategoryRequiredTagGroups)
 ...
 * response
 */
export class GetCategory200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "category" })
  @Type(() => GetCategory200ApplicationJSONCategory)
