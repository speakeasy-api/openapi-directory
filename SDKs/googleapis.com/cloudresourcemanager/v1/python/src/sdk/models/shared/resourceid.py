...
class ResourceID:
    ...
    r"""The type-specific id. This should correspond to the id used in the type-specific API's."""  
    type: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The resource type this id is for. At present, the valid types are: \\"organization\\", \\"folder\\", and \\"project\\"."""  
