...
exports.GETOrdersBySubscriptionNumberResponse = exports.GETOrdersBySubscriptionNumberRequest = void 0;
...
var GETOrdersBySubscriptionNumberRequest = /** @class */ (function (_super) {
    ...
    ], GETOrdersBySubscriptionNumberRequest.prototype, "zuoraEntityIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Zuora-Track-Id",
        }),
        __metadata("design:type", String)
    ], GETOrdersBySubscriptionNumberRequest.prototype, "zuoraTrackId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=dateFilterOption",
        }),
        __metadata("design:type", String)
    ], GETOrdersBySubscriptionNumberRequest.prototype, "dateFilterOption", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=endDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GETOrdersBySubscriptionNumberRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GETOrdersBySubscriptionNumberRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], GETOrdersBySubscriptionNumberRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=startDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GETOrdersBySubscriptionNumberRequest.prototype, "startDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=subscriptionNumber",
        }),
        __metadata("design:type", String)
    ], GETOrdersBySubscriptionNumberRequest.prototype, "subscriptionNumber", void 0);
...
var GETOrdersBySubscriptionNumberResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GETOrdersBySubscriptionNumberResponse.prototype, "rawResponse", void 0);
