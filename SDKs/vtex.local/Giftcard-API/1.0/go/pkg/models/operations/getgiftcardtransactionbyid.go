...
type GetGiftCardTransactionbyIDPathParams struct {
...
type GetGiftCardTransactionbyIDHeaders struct {
...
type GetGiftCardTransactionbyIDRequest struct {
	PathParams GetGiftCardTransactionbyIDPathParams
	Headers    GetGiftCardTransactionbyIDHeaders
}

type GetGiftCardTransactionbyIDResponse struct {
	ContentType string
	StatusCode  int
