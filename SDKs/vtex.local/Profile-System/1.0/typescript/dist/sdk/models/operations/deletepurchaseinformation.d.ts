...
export declare class DeletePurchaseInformationRequest extends SpeakeasyBase {
    /**
...
export declare class DeletePurchaseInformationResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
