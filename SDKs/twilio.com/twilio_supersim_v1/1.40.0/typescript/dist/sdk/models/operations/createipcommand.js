...
exports.CreateIpCommandResponse = exports.CreateIpCommandCreateIpCommandRequest = exports.CreateIpCommandCreateIpCommandRequestCallbackMethodEnum = exports.CreateIpCommandSecurity = exports.CreateIpCommandServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.CreateIpCommandServerList = [
...
var CreateIpCommandSecurity = /** @class */ (function (_super) {
    ...
    ], CreateIpCommandSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], CreateIpCommandSecurity.prototype, "username", void 0);
    return CreateIpCommandSecurity;
}(utils_1.SpeakeasyBase));
exports.CreateIpCommandSecurity = CreateIpCommandSecurity;
/**
 * The HTTP method we should use to call `callback_url`. Can be `GET` or `POST`, and the default is `POST`.
 */
var CreateIpCommandCreateIpCommandRequestCallbackMethodEnum;
...
})(CreateIpCommandCreateIpCommandRequestCallbackMethodEnum = exports.CreateIpCommandCreateIpCommandRequestCallbackMethodEnum || (exports.CreateIpCommandCreateIpCommandRequestCallbackMethodEnum = {}));
var CreateIpCommandCreateIpCommandRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=DevicePort" }),
        __metadata("design:type", Number)
    ], CreateIpCommandCreateIpCommandRequest.prototype, "devicePort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=Payload" }),
        __metadata("design:type", String)
    ], CreateIpCommandCreateIpCommandRequest.prototype, "payload", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=PayloadType" }),
        __metadata("design:type", String)
...
exports.CreateIpCommandCreateIpCommandRequest = CreateIpCommandCreateIpCommandRequest;
var CreateIpCommandResponse = /** @class */ (function (_super) {
    ...
    ], CreateIpCommandResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.CreateIpCommandResponse = CreateIpCommandResponse;
