...
public class CloudassetSearchAllIamPoliciesRequest {
    ...
    public CloudassetSearchAllIamPoliciesRequest withDollarXgafv(org.openapis.openapi.models.shared.XgafvEnum dollarXgafv) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withAccessToken(String accessToken) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public CloudassetSearchAllIamPoliciesRequest withAssetTypes(String[] assetTypes) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withCallback(String callback) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withFields(String fields) {
        this.fields = fields;
        return this;
    }
    ...
    public CloudassetSearchAllIamPoliciesRequest withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public CloudassetSearchAllIamPoliciesRequest withOauthToken(String oauthToken) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withOrderBy(String orderBy) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withPageSize(Long pageSize) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withPageToken(String pageToken) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withPrettyPrint(Boolean prettyPrint) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withQuery(String query) {
        this.query = query;
        return this;
    }
    ...
    public CloudassetSearchAllIamPoliciesRequest withQuotaUser(String quotaUser) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withScope(String scope) {
        this.scope = scope;
        return this;
    }
    ...
    public CloudassetSearchAllIamPoliciesRequest withUploadType(String uploadType) {
    ...
    public CloudassetSearchAllIamPoliciesRequest withUploadProtocol(String uploadProtocol) {
        this.uploadProtocol = uploadProtocol;
        return this;
    }
    
    public CloudassetSearchAllIamPoliciesRequest(@JsonProperty("scope") String scope) {
        this.scope = scope;
  }
}
