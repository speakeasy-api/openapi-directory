 ...
 */
export declare class DescribeIpamsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeIpamsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeIpamsRequestFilters[];
    ipamIds?: string[];
    maxResults?: number;
    nextToken?: string;
}
