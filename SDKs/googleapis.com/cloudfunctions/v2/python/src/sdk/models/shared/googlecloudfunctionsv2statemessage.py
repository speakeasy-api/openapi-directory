...
class GoogleCloudFunctionsV2StateMessage:
    ...
    r"""The message."""  
    severity: Optional[GoogleCloudFunctionsV2StateMessageSeverityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('severity'), 'exclude': lambda f: f is None }})
    r"""Severity of the state message."""  
