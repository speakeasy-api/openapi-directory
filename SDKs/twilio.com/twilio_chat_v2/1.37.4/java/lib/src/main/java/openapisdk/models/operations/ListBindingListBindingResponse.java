...
public class ListBindingListBindingResponse {
    ...
    public openapisdk.models.shared.ChatV2ServiceBinding[] bindings;
    public ListBindingListBindingResponse withBindings(openapisdk.models.shared.ChatV2ServiceBinding[] bindings) {
