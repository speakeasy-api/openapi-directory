...
class PostServersIDActionsRemoveFromPlacementGroupActionResponseAction:
    ...
    error: PostServersIDActionsRemoveFromPlacementGroupActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostServersIDActionsRemoveFromPlacementGroupActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostServersIDActionsRemoveFromPlacementGroupActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostServersIDActionsRemoveFromPlacementGroupActionResponse:
    ...
    action: PostServersIDActionsRemoveFromPlacementGroupActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
