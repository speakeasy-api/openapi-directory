...
export class TypeCommunityDatahub {
  ...
  searchCommunityDatahub(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/community_datahub";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchCommunityDatahubResponse =
        new operations.SearchCommunityDatahubResponse({
