 ...
 */
export enum HealthCheckServiceAggregatedListWarningCodeEnum {
...
export class HealthCheckServiceAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HealthCheckServiceAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: HealthCheckServiceAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class HealthCheckServiceAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: HealthCheckServicesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, HealthCheckServicesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], HealthCheckServicesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
