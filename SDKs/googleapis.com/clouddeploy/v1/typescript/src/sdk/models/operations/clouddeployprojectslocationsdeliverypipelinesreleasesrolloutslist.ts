...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
