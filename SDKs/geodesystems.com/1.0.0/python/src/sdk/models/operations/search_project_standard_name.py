...
class SearchProjectStandardNameQueryParams:
    ...
    search_project_standard_name_aliases: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_standard_name.aliases', 'style': 'form', 'explode': True }})
    search_project_standard_name_unit: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_standard_name.unit', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchProjectStandardNameRequest:
    query_params: SearchProjectStandardNameQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchProjectStandardNameResponse:
