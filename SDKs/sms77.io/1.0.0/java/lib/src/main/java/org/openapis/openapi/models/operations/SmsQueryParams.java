...
public class SmsQueryParams {
    ...
    public SmsQueryParams withDebug(SmsDebugEnum debug) {
        this.debug = debug;
        return this;
    }
    ...
    public SmsQueryParams withDetails(SmsDetailsEnum details) {
    ...
    public SmsQueryParams withFlash(SmsFlashEnum flash) {
        this.flash = flash;
        return this;
    }
    ...
    public SmsQueryParams withJson(SmsJSONEnum json) {
        this.json = json;
        return this;
    }
    ...
    public SmsQueryParams withNoReload(SmsNoReloadEnum noReload) {
    ...
    public SmsQueryParams withPerformanceTracking(SmsPerformanceTrackingEnum performanceTracking) {
    ...
    public SmsQueryParams withReturnMsgId(SmsReturnMsgIDEnum returnMsgId) {
    ...
    public SmsQueryParams withUnicode(SmsUnicodeEnum unicode) {
    ...
    public SmsQueryParams withUtf8(SmsUtf8Enum utf8) {
        this.utf8 = utf8;
        return this;
    }
