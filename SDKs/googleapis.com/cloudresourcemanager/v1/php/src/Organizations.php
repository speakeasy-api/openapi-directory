...
class Organizations 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\CloudresourcemanagerOrganizationsGetResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{name}', \OpenAPI\OpenAPI\Models\Operations\CloudresourcemanagerOrganizationsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:getIamPolicy', \OpenAPI\OpenAPI\Models\Operations\CloudresourcemanagerOrganizationsGetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/organizations:search');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "searchOrganizationsRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:setIamPolicy', \OpenAPI\OpenAPI\Models\Operations\CloudresourcemanagerOrganizationsSetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{resource}:testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\CloudresourcemanagerOrganizationsTestIamPermissionsRequest::class, $request);
