...
class TagSpecificationListResourceTypeEnum(str, Enum):
...
class TagSpecificationListTags:
    r"""Describes a tag."""
...
class TagSpecificationList:
    ...
    resource_type: Optional[TagSpecificationListResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[TagSpecificationListTags]] = dataclasses.field(default=None)  
