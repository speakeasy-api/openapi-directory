...
class ListRequestedServiceQuotaChangeHistoryRequest:
    ...
    list_requested_service_quota_change_history_request: shared_listrequestedservicequotachangehistoryrequest.ListRequestedServiceQuotaChangeHistoryRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
