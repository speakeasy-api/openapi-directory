...
class TeamPPADefense:
    ...
    cumulative: Optional[TeamPPADefenseCumulative] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cumulative'), 'exclude': lambda f: f is None }})  
...
class TeamPPAOffense:
    ...
    cumulative: Optional[TeamPPAOffenseCumulative] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cumulative'), 'exclude': lambda f: f is None }})  
    first_down: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('firstDown'), 'exclude': lambda f: f is None }})  
    overall: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('overall'), 'exclude': lambda f: f is None }})  
    passing: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('passing'), 'exclude': lambda f: f is None }})  
    rushing: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rushing'), 'exclude': lambda f: f is None }})  
...
class TeamPPA:
    ...
    defense: Optional[TeamPPADefense] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('defense'), 'exclude': lambda f: f is None }})  
    offense: Optional[TeamPPAOffense] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('offense'), 'exclude': lambda f: f is None }})  
