...
class GETRegisterTransitGatewayMulticastGroupMembersRequest:
    ...
    action: GETRegisterTransitGatewayMulticastGroupMembersActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    network_interface_ids: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'NetworkInterfaceIds', 'style': 'form', 'explode': True }})
    r"""The group members' network interface IDs to register with the transit gateway multicast group."""  
    ...
    version: GETRegisterTransitGatewayMulticastGroupMembersVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
