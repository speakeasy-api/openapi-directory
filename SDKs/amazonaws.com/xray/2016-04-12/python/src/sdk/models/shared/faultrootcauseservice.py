...
class FaultRootCauseService:
    r"""A collection of fields identifying the services in a trace summary fault."""
    
    account_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AccountId'), 'exclude': lambda f: f is None }})  
    entity_path: Optional[list[shared_faultrootcauseentity.FaultRootCauseEntity]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EntityPath'), 'exclude': lambda f: f is None }})  
