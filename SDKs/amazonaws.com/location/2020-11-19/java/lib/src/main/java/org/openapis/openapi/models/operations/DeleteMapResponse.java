...
public class DeleteMapResponse {
    ...
    public DeleteMapResponse withStatusCode(Integer statusCode) {
    ...
    public DeleteMapResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public DeleteMapResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
