...
SERVERS = [
    ...
    r"""The KMS multi-region endpoint"""
    "https://kms.{region}.amazonaws.com",
    r"""The KMS multi-region endpoint"""
    "http://kms.{region}.amazonaws.com.cn",
    r"""The KMS endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def cancel_key_deletion(self, request: operations.CancelKeyDeletionRequest) -> operations.CancelKeyDeletionResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "cancel_key_deletion_request", 'json')
        ...
        res = operations.CancelKeyDeletionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CancelKeyDeletionResponse])
    ...
    def connect_custom_key_store(self, request: operations.ConnectCustomKeyStoreRequest) -> operations.ConnectCustomKeyStoreResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "connect_custom_key_store_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ConnectCustomKeyStoreResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def create_custom_key_store(self, request: operations.CreateCustomKeyStoreRequest) -> operations.CreateCustomKeyStoreResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_custom_key_store_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CreateCustomKeyStoreResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.CreateCustomKeyStoreResponse])
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_uri_in_use_exception = out
        elif http_res.status_code == 489:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_uri_endpoint_in_use_exception = out
        elif http_res.status_code == 490:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_uri_unreachable_exception = out
        elif http_res.status_code == 491:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_incorrect_authentication_credential_exception = out
        elif http_res.status_code == 492:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_vpc_endpoint_service_in_use_exception = out
        elif http_res.status_code == 493:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_vpc_endpoint_service_not_found_exception = out
        elif http_res.status_code == 494:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_vpc_endpoint_service_invalid_configuration_exception = out
        elif http_res.status_code == 495:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_invalid_response_exception = out
        elif http_res.status_code == 496:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_proxy_invalid_configuration_exception = out
    ...
    def create_key(self, request: operations.CreateKeyRequest) -> operations.CreateKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "create_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_key_invalid_configuration_exception = out
        elif http_res.status_code == 491:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_key_already_in_use_exception = out
        elif http_res.status_code == 492:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.xks_key_not_found_exception = out
    ...
    def decrypt(self, request: operations.DecryptRequest) -> operations.DecryptResponse:
        ...
        res = operations.DecryptResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_custom_key_store(self, request: operations.DeleteCustomKeyStoreRequest) -> operations.DeleteCustomKeyStoreResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_custom_key_store_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteCustomKeyStoreResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def delete_imported_key_material(self, request: operations.DeleteImportedKeyMaterialRequest) -> operations.DeleteImportedKeyMaterialResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "delete_imported_key_material_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeleteImportedKeyMaterialResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_custom_key_stores(self, request: operations.DescribeCustomKeyStoresRequest) -> operations.DescribeCustomKeyStoresResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_custom_key_stores_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.DescribeCustomKeyStoresRequest, request)
        ...
        res = operations.DescribeCustomKeyStoresResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeCustomKeyStoresResponse])
    ...
    def describe_key(self, request: operations.DescribeKeyRequest) -> operations.DescribeKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def disable_key(self, request: operations.DisableKeyRequest) -> operations.DisableKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disable_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisableKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def disable_key_rotation(self, request: operations.DisableKeyRotationRequest) -> operations.DisableKeyRotationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disable_key_rotation_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisableKeyRotationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def disconnect_custom_key_store(self, request: operations.DisconnectCustomKeyStoreRequest) -> operations.DisconnectCustomKeyStoreResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "disconnect_custom_key_store_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DisconnectCustomKeyStoreResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def enable_key(self, request: operations.EnableKeyRequest) -> operations.EnableKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "enable_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.EnableKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def enable_key_rotation(self, request: operations.EnableKeyRotationRequest) -> operations.EnableKeyRotationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "enable_key_rotation_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.EnableKeyRotationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def encrypt(self, request: operations.EncryptRequest) -> operations.EncryptResponse:
        ...
        res = operations.EncryptResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def generate_data_key(self, request: operations.GenerateDataKeyRequest) -> operations.GenerateDataKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "generate_data_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GenerateDataKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GenerateDataKeyResponse])
    ...
    def generate_data_key_pair(self, request: operations.GenerateDataKeyPairRequest) -> operations.GenerateDataKeyPairResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "generate_data_key_pair_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GenerateDataKeyPairResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GenerateDataKeyPairResponse])
    ...
    def generate_data_key_pair_without_plaintext(self, request: operations.GenerateDataKeyPairWithoutPlaintextRequest) -> operations.GenerateDataKeyPairWithoutPlaintextResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "generate_data_key_pair_without_plaintext_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GenerateDataKeyPairWithoutPlaintextResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GenerateDataKeyPairWithoutPlaintextResponse])
    ...
    def generate_data_key_without_plaintext(self, request: operations.GenerateDataKeyWithoutPlaintextRequest) -> operations.GenerateDataKeyWithoutPlaintextResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "generate_data_key_without_plaintext_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GenerateDataKeyWithoutPlaintextResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GenerateDataKeyWithoutPlaintextResponse])
    ...
    def generate_mac(self, request: operations.GenerateMacRequest) -> operations.GenerateMacResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=TrentService.GenerateMac'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "generate_mac_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GenerateMacResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GenerateMacResponse])
                res.generate_mac_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.not_found_exception = out
    ...
    def generate_random(self, request: operations.GenerateRandomRequest) -> operations.GenerateRandomResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "generate_random_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GenerateRandomResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GenerateRandomResponse])
    ...
    def get_key_policy(self, request: operations.GetKeyPolicyRequest) -> operations.GetKeyPolicyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_key_policy_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetKeyPolicyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetKeyPolicyResponse])
    ...
    def get_key_rotation_status(self, request: operations.GetKeyRotationStatusRequest) -> operations.GetKeyRotationStatusResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_key_rotation_status_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.GetKeyRotationStatusResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetKeyRotationStatusResponse])
    ...
    def get_parameters_for_import(self, request: operations.GetParametersForImportRequest) -> operations.GetParametersForImportResponse:
        ...
        res = operations.GetParametersForImportResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetParametersForImportResponse])
    ...
    def get_public_key(self, request: operations.GetPublicKeyRequest) -> operations.GetPublicKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_public_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetPublicKeyResponse])
    ...
    def import_key_material(self, request: operations.ImportKeyMaterialRequest) -> operations.ImportKeyMaterialResponse:
        ...
        res = operations.ImportKeyMaterialResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def list_grants(self, request: operations.ListGrantsRequest) -> operations.ListGrantsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_grants_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListGrantsRequest, request)
        ...
        res = operations.ListGrantsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListGrantsResponse])
    ...
    def list_key_policies(self, request: operations.ListKeyPoliciesRequest) -> operations.ListKeyPoliciesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_key_policies_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListKeyPoliciesRequest, request)
        ...
        res = operations.ListKeyPoliciesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListKeyPoliciesResponse])
    ...
    def list_keys(self, request: operations.ListKeysRequest) -> operations.ListKeysResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_keys_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def list_resource_tags(self, request: operations.ListResourceTagsRequest) -> operations.ListResourceTagsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_resource_tags_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListResourceTagsRequest, request)
        ...
        res = operations.ListResourceTagsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListResourceTagsResponse])
    ...
    def list_retirable_grants(self, request: operations.ListRetirableGrantsRequest) -> operations.ListRetirableGrantsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_retirable_grants_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListRetirableGrantsRequest, request)
        ...
        res = operations.ListRetirableGrantsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def put_key_policy(self, request: operations.PutKeyPolicyRequest) -> operations.PutKeyPolicyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "put_key_policy_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PutKeyPolicyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def re_encrypt(self, request: operations.ReEncryptRequest) -> operations.ReEncryptResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "re_encrypt_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ReEncryptResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ReEncryptResponse])
    ...
    def replicate_key(self, request: operations.ReplicateKeyRequest) -> operations.ReplicateKeyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "replicate_key_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ReplicateKeyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ReplicateKeyResponse])
    ...
    def retire_grant(self, request: operations.RetireGrantRequest) -> operations.RetireGrantResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "retire_grant_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RetireGrantResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def revoke_grant(self, request: operations.RevokeGrantRequest) -> operations.RevokeGrantResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "revoke_grant_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RevokeGrantResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def schedule_key_deletion(self, request: operations.ScheduleKeyDeletionRequest) -> operations.ScheduleKeyDeletionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "schedule_key_deletion_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ScheduleKeyDeletionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ScheduleKeyDeletionResponse])
    ...
    def sign(self, request: operations.SignRequest) -> operations.SignResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "sign_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SignResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SignResponse])
    ...
    def update_custom_key_store(self, request: operations.UpdateCustomKeyStoreRequest) -> operations.UpdateCustomKeyStoreResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_custom_key_store_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateCustomKeyStoreResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_key_description(self, request: operations.UpdateKeyDescriptionRequest) -> operations.UpdateKeyDescriptionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_key_description_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateKeyDescriptionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_primary_region(self, request: operations.UpdatePrimaryRegionRequest) -> operations.UpdatePrimaryRegionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_primary_region_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdatePrimaryRegionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def verify(self, request: operations.VerifyRequest) -> operations.VerifyResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "verify_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.VerifyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.VerifyResponse])
    ...
    def verify_mac(self, request: operations.VerifyMacRequest) -> operations.VerifyMacResponse:
        ...
        url = base_url.removesuffix('/') + '/#X-Amz-Target=TrentService.VerifyMac'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "verify_mac_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.VerifyMacResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.VerifyMacResponse])
                res.verify_mac_response = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.not_found_exception = out
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.kms_invalid_mac_exception = out
        elif http_res.status_code == 487:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
                res.kms_invalid_state_exception = out
