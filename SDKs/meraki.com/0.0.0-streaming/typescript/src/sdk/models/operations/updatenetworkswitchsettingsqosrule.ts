 ...
 */
export enum UpdateNetworkSwitchSettingsQosRuleRequestBodyProtocolEnum {
  Any = "ANY",
  Tcp = "TCP",
  Udp = "UDP",
}

export class UpdateNetworkSwitchSettingsQosRuleRequestBody extends SpeakeasyBase {
  /**
...
export class UpdateNetworkSwitchSettingsQosRuleRequest extends SpeakeasyBase {
...
export class UpdateNetworkSwitchSettingsQosRuleResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  updateNetworkSwitchSettingsQosRule200ApplicationJSONObject?: Record<
    string,
    any
  >;
}
