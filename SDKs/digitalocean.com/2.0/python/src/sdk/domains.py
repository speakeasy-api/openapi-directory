...
class Domains:
    ...
    def list_all_domains(self) -> operations.ListAllDomainsResponseOutput:
        r"""List All Domains
        ...
        res = operations.ListAllDomainsResponseOutput(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            res.headers = r.headers
            
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListAllDomains200ApplicationJSONOutput])
