...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.servicePrincipalAppRoleAssignedTo = new serviceprincipalapproleassignedto_1.ServicePrincipalAppRoleAssignedTo(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.servicePrincipalAppRoleAssignments = new serviceprincipalapproleassignments_1.ServicePrincipalAppRoleAssignments(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.servicePrincipalPasswordCredentials = new serviceprincipalpasswordcredentials_1.ServicePrincipalPasswordCredentials(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
