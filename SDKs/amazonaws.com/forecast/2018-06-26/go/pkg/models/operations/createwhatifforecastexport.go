...
type CreateWhatIfForecastExportHeaders struct {
...
type CreateWhatIfForecastExportRequest struct {
	Headers CreateWhatIfForecastExportHeaders
	Request shared.CreateWhatIfForecastExportRequest `request:"mediaType=application/json"`
}
