...
export class PaymentMethodAccountHolderInfo extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum PaymentMethodBankAccountTypeEnum {
 ...
 *
 */
export enum PaymentMethodMitConsentAgreementSrcEnum {
  External = "External",
}
 ...
 *
 */
export enum PaymentMethodMitProfileActionEnum {
  Activate = "Activate",
  Persist = "Persist",
}
 ...
 *
 */
export enum PaymentMethodMitProfileTypeEnum {
  Recurring = "Recurring",
...
export class PaymentMethod extends SpeakeasyBase {
  ...
  @Type(() => PaymentMethodAccountHolderInfo)
