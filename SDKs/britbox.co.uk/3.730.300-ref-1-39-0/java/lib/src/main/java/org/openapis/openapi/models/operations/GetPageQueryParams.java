...
public class GetPageQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetPageQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetPageQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetPageQueryParams withItemDetailExpand(GetPageItemDetailExpandEnum itemDetailExpand) {
    ...
    public GetPageQueryParams withItemDetailSelectSeason(GetPageItemDetailSelectSeasonEnum itemDetailSelectSeason) {
    ...
    public String lang;
    public GetPageQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetPageQueryParams withListPageSize(Integer listPageSize) {
    ...
    public GetPageQueryParams withListPageSizeLarge(Integer listPageSizeLarge) {
    ...
    public GetPageQueryParams withMaxListPrefetch(Integer maxListPrefetch) {
    ...
    public GetPageQueryParams withMaxRating(String maxRating) {
    ...
    public String path;
    public GetPageQueryParams withPath(String path) {
        this.path = path;
        return this;
    }
    ...
    public GetPageQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetPageQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
    ...
    public GetPageQueryParams withTextEntryFormat(GetPageTextEntryFormatEnum textEntryFormat) {
