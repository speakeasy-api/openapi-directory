...
type ListPermissionVersionsQueryParams struct {
	// Pagination limit
...
type ListPermissionVersionsHeaders struct {
...
type ListPermissionVersionsRequest struct {
	QueryParams ListPermissionVersionsQueryParams
	Headers     ListPermissionVersionsHeaders
	Request     ListPermissionVersionsRequestBody `request:"mediaType=application/json"`
}
