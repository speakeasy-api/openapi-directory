...
from ..shared import obreadaccount5 as shared_obreadaccount5
...
class GetAccountsAccountIDRequest:
    headers: GetAccountsAccountIDHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDPathParams = dataclasses.field()
    security: GetAccountsAccountIDSecurity = dataclasses.field()
...
class GetAccountsAccountIDResponse:
    ...
    ob_read_account5: Optional[shared_obreadaccount5.ObReadAccount5] = dataclasses.field(default=None)
