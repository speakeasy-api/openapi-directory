...
public class GroupV2GetPotentialGroupsForMemberPathParams {
    /**
    ...
    public GroupV2GetPotentialGroupsForMemberPathParams withFilter(Integer filter) {
        this.filter = filter;
        return this;
    }
    ...
    public GroupV2GetPotentialGroupsForMemberPathParams withGroupType(Integer groupType) {
    ...
    public GroupV2GetPotentialGroupsForMemberPathParams withMembershipId(Long membershipId) {
    ...
    public GroupV2GetPotentialGroupsForMemberPathParams withMembershipType(Integer membershipType) {
