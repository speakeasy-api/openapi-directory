...
func (e GetOrganizationSensorReadingsHistory200ApplicationJSONButtonPressTypeEnum) ToPointer() *GetOrganizationSensorReadingsHistory200ApplicationJSONButtonPressTypeEnum {
	return &e
}
...
func (e *GetOrganizationSensorReadingsHistory200ApplicationJSONButtonPressTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "long":
		fallthrough
	case "short":
		*e = GetOrganizationSensorReadingsHistory200ApplicationJSONButtonPressTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationSensorReadingsHistory200ApplicationJSONButtonPressTypeEnum: %v", v)
	}
}
...
func (e GetOrganizationSensorReadingsHistory200ApplicationJSONMetricEnum) ToPointer() *GetOrganizationSensorReadingsHistory200ApplicationJSONMetricEnum {
	return &e
}
...
func (e *GetOrganizationSensorReadingsHistory200ApplicationJSONMetricEnum) UnmarshalJSON(data []byte) error {
	...
	case "tvoc":
		fallthrough
	case "water":
		*e = GetOrganizationSensorReadingsHistory200ApplicationJSONMetricEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationSensorReadingsHistory200ApplicationJSONMetricEnum: %v", v)
	}
}
