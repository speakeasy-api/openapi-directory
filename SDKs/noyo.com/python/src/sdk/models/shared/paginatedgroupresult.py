...
class PaginatedGroupResult:
    ...
    meta: PaginatedGroupResultMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta') }})
    r"""Metadata associated with the response data"""  
    response: list[shared_groupresult.GroupResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response') }})
