...
public class GetNhFossilsIndividualsHeaders {
    /**
    ...
    public GetNhFossilsIndividualsHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhFossilsIndividualsHeaders withXApiKey(String xApiKey) {
