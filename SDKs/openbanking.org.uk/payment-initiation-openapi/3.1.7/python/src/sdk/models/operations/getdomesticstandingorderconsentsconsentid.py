...
from ..shared import obwritedomesticstandingorderconsentresponse6 as shared_obwritedomesticstandingorderconsentresponse6


@dataclasses.dataclass
class GetDomesticStandingOrderConsentsConsentIDPathParams:
    consent_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ConsentId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDomesticStandingOrderConsentsConsentIDHeaders:
...
@dataclasses.dataclass
class GetDomesticStandingOrderConsentsConsentIDRequest:
    headers: GetDomesticStandingOrderConsentsConsentIDHeaders = dataclasses.field()
    path_params: GetDomesticStandingOrderConsentsConsentIDPathParams = dataclasses.field()
    security: GetDomesticStandingOrderConsentsConsentIDSecurity = dataclasses.field()
...
class GetDomesticStandingOrderConsentsConsentIDResponse:
    ...
    ob_write_domestic_standing_order_consent_response6: Optional[shared_obwritedomesticstandingorderconsentresponse6.ObWriteDomesticStandingOrderConsentResponse6] = dataclasses.field(default=None)
