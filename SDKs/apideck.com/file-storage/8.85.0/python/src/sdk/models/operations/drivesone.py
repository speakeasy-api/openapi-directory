...
from ..shared import getdriveresponse as shared_getdriveresponse
...
@dataclasses.dataclass
class DrivesOneRequest:
    headers: DrivesOneHeaders = dataclasses.field()
    path_params: DrivesOnePathParams = dataclasses.field()
    query_params: DrivesOneQueryParams = dataclasses.field()
    security: DrivesOneSecurity = dataclasses.field()
    

@dataclasses.dataclass
class DrivesOneResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    get_drive_response: Optional[shared_getdriveresponse.GetDriveResponse] = dataclasses.field(default=None)
