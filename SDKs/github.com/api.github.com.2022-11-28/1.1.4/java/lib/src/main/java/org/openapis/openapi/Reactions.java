...
public class Reactions {
     ...
     * https://docs.github.com/rest/reference/reactions/#create-reaction-for-a-release - API method documentation
     * @param request the request object containing all of the parameters for the API call
     * @return the response from the API call
     * @throws Exception if the API call fails
     */
     ...
     * https://docs.github.com/rest/reference/reactions/#delete-a-release-reaction - API method documentation
     * @param request the request object containing all of the parameters for the API call
     * @return the response from the API call
     * @throws Exception if the API call fails
     */
     ...
     * https://docs.github.com/rest/reference/reactions/#list-reactions-for-a-release - API method documentation
     * @param request the request object containing all of the parameters for the API call
     * @return the response from the API call
     * @throws Exception if the API call fails
     */
