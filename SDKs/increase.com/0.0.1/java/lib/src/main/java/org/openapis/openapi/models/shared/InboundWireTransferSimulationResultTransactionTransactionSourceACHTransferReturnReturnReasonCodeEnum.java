 ...
 */
public enum InboundWireTransferSimulationResultTransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum {
    ...
    private InboundWireTransferSimulationResultTransactionTransactionSourceACHTransferReturnReturnReasonCodeEnum(String value) {
        this.value = value;
    }
}
