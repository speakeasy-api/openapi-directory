...
class SecuritycenterOrganizationsSourcesFindingsListPathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class SecuritycenterOrganizationsSourcesFindingsListQueryParams:
...
class SecuritycenterOrganizationsSourcesFindingsListRequest:
    path_params: SecuritycenterOrganizationsSourcesFindingsListPathParams = dataclasses.field()
    query_params: SecuritycenterOrganizationsSourcesFindingsListQueryParams = dataclasses.field()
    security: SecuritycenterOrganizationsSourcesFindingsListSecurity = dataclasses.field()
