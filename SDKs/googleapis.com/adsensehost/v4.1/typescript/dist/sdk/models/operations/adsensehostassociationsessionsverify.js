...
exports.AdsensehostAssociationsessionsVerifyResponse = exports.AdsensehostAssociationsessionsVerifyRequest = exports.AdsensehostAssociationsessionsVerifySecurity = void 0;
...
var AdsensehostAssociationsessionsVerifyRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=token" }),
        __metadata("design:type", String)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "token", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsensehostAssociationsessionsVerifyRequest.prototype, "userIp", void 0);
...
var AdsensehostAssociationsessionsVerifyResponse = /** @class */ (function (_super) {
    ...
    ], AdsensehostAssociationsessionsVerifyResponse.prototype, "rawResponse", void 0);
