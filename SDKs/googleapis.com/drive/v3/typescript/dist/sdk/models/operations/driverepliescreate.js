...
exports.DriveRepliesCreateResponse = exports.DriveRepliesCreateRequest = exports.DriveRepliesCreateSecurity = exports.DriveRepliesCreateSecurityOption2 = exports.DriveRepliesCreateSecurityOption1 = void 0;
...
var DriveRepliesCreateRequest = /** @class */ (function (_super) {
    ...
    ], DriveRepliesCreateRequest.prototype, "reply", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=commentId",
        }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "commentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=fileId",
        }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "fileId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DriveRepliesCreateRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DriveRepliesCreateRequest.prototype, "userIp", void 0);
...
var DriveRepliesCreateResponse = /** @class */ (function (_super) {
    ...
    ], DriveRepliesCreateResponse.prototype, "rawResponse", void 0);
