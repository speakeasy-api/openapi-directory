...
export declare class AnalyticsGenericLogFlowSecurity extends SpeakeasyBase {
    apiToken: string;
}
export declare class AnalyticsGenericLogFlowRequest extends SpeakeasyBase {
    /**
...
export declare enum AnalyticsGenericLogFlowDefaultApplicationJSONErrorCodeEnum {
...
export declare class AnalyticsGenericLogFlowDefaultApplicationJSONError extends SpeakeasyBase {
 ...
 */
export declare class AnalyticsGenericLogFlowDefaultApplicationJSON extends SpeakeasyBase {
    error: AnalyticsGenericLogFlowDefaultApplicationJSONError;
}
/**
 * Device characteristics.
 */
export declare class AnalyticsGenericLogFlow200ApplicationJSONLogsDevice extends SpeakeasyBase {
    /**
 ...
 *
 */
export declare enum AnalyticsGenericLogFlow200ApplicationJSONLogsTypeEnum {
    Event = "event",
    Page = "page",
 ...
 * Generic log.
 */
export declare class AnalyticsGenericLogFlow200ApplicationJSONLogs extends SpeakeasyBase {
    /**
 ...
 */
export declare class AnalyticsGenericLogFlow200ApplicationJSON extends SpeakeasyBase {
    /**
...
export declare class AnalyticsGenericLogFlowResponse extends SpeakeasyBase {
    /**
     * List of logs for the requested time range.
     */
