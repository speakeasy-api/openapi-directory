...
export class TypeProjectVocabulary {
  ...
  searchProjectVocabulary(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/project_vocabulary";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchProjectVocabularyResponse =
        new operations.SearchProjectVocabularyResponse({
