...
class GETRegisterTransitGatewayMulticastGroupSourcesRequest
{
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETRegisterTransitGatewayMulticastGroupSourcesActionEnum::REGISTER_TRANSIT_GATEWAY_MULTICAST_GROUP_SOURCES;
		$this->dryRun = null;
		$this->groupIpAddress = null;
		$this->networkInterfaceIds = [];
		$this->transitGatewayMulticastDomainId = "";
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETRegisterTransitGatewayMulticastGroupSourcesVersionEnum::TWO_THOUSAND_AND_SIXTEEN1115;
