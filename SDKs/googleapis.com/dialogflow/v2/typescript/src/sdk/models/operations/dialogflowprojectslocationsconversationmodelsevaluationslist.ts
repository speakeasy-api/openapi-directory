...
export class DialogflowProjectsLocationsConversationModelsEvaluationsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsConversationModelsEvaluationsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsConversationModelsEvaluationsListSecurity extends SpeakeasyBase {
...
export class DialogflowProjectsLocationsConversationModelsEvaluationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsConversationModelsEvaluationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
