...
func (e GetFirewallsIDActionsActionIDActionResponseActionStatusEnum) ToPointer() *GetFirewallsIDActionsActionIDActionResponseActionStatusEnum {
	return &e
}

func (e *GetFirewallsIDActionsActionIDActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "running":
		fallthrough
	case "error":
		*e = GetFirewallsIDActionsActionIDActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetFirewallsIDActionsActionIDActionResponseActionStatusEnum: %v", v)
	}
}
