...
class Batches:
    ...
    def add_to_batch(self, request: operations.AddToBatchRequest) -> operations.AddToBatchResponse:
        ...
        url = utils.generate_url(base_url, "/v1/batches/{batch_id}/add", request.path_params)
        ...
        res = operations.AddToBatchResponse(status_code=r.status_code, content_type=content_type)
    ...
    def create_batch(self, request: operations.CreateBatchRequest) -> operations.CreateBatchResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateBatchResponseBody])
    ...
    def delete_batch(self, request: operations.DeleteBatchRequest) -> operations.DeleteBatchResponse:
        ...
        url = utils.generate_url(base_url, "/v1/batches/{batch_id}", request.path_params)
    ...
    def get_batch_by_external_id(self, request: operations.GetBatchByExternalIDRequest) -> operations.GetBatchByExternalIDResponse:
        ...
        url = utils.generate_url(base_url, "/v1/batches/external_batch_id/{external_batch_id}", request.path_params)
        ...
        res = operations.GetBatchByExternalIDResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetBatchByExternalIDResponseBody])
    ...
    def get_batch_by_id(self, request: operations.GetBatchByIDRequest) -> operations.GetBatchByIDResponse:
        ...
        res = operations.GetBatchByIDResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetBatchByIDResponseBody])
    ...
    def list_batch_errors(self, request: operations.ListBatchErrorsRequest) -> operations.ListBatchErrorsResponse:
        ...
        url = utils.generate_url(base_url, "/v1/batches/{batch_id}/errors", request.path_params)
        ...
        res = operations.ListBatchErrorsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListBatchErrorsResponseBody])
    ...
    def list_batches(self, request: operations.ListBatchesRequest) -> operations.ListBatchesResponse:
        ...
        res = operations.ListBatchesResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListBatchesResponseBody])
    ...
    def process_batch(self, request: operations.ProcessBatchRequest) -> operations.ProcessBatchResponse:
        ...
        url = utils.generate_url(base_url, "/v1/batches/{batch_id}/process/labels", request.path_params)
        ...
        res = operations.ProcessBatchResponse(status_code=r.status_code, content_type=content_type)
    ...
    def remove_from_batch(self, request: operations.RemoveFromBatchRequest) -> operations.RemoveFromBatchResponse:
        ...
        url = utils.generate_url(base_url, "/v1/batches/{batch_id}/remove", request.path_params)
        ...
        res = operations.RemoveFromBatchResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_batch(self, request: operations.UpdateBatchRequest) -> operations.UpdateBatchResponse:
        ...
        res = operations.UpdateBatchResponse(status_code=r.status_code, content_type=content_type)
