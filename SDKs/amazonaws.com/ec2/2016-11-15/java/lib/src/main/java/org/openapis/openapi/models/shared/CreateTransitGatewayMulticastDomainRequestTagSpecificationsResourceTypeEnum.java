 ...
 */
public enum CreateTransitGatewayMulticastDomainRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTransitGatewayMulticastDomainRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
