...
class CreateBadge200ApplicationJSON:
    ...
    badge: CreateBadge200ApplicationJSONBadge = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('badge') }})  
    badge_types: list[CreateBadge200ApplicationJSONBadgeTypes] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('badge_types') }})  
...
class CreateBadgeResponse:
    ...
    create_badge_200_application_json_object: Optional[CreateBadge200ApplicationJSON] = dataclasses.field(default=None)
    r"""success response"""  
