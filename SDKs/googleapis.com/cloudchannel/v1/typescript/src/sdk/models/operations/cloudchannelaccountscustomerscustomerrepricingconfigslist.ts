...
export class CloudchannelAccountsCustomersCustomerRepricingConfigsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersCustomerRepricingConfigsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsCustomersCustomerRepricingConfigsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
