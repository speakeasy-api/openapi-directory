...
/**
 * Error401AISAdditionalErrors - This is a data element to support the declaration of additional errors in the context of [RFC7807].
 */
public class Error401AISAdditionalErrors {
    ...
    public Error401AISAdditionalErrors(@JsonProperty("code") MessageCode401AISEnum code) {
        this.code = code;
  }
}
