...
class CreateCarrierGatewayRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateCarrierGatewayRequestTagSpecifications:
    ...
    resource_type: Optional[CreateCarrierGatewayRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateCarrierGatewayRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateCarrierGatewayRequest:
    ...
    tag_specifications: Optional[list[CreateCarrierGatewayRequestTagSpecifications]] = dataclasses.field(default=None)  
