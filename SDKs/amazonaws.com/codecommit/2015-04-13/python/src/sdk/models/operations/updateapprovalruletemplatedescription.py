...
class UpdateApprovalRuleTemplateDescriptionRequest:
    ...
    update_approval_rule_template_description_input: shared_updateapprovalruletemplatedescriptioninput.UpdateApprovalRuleTemplateDescriptionInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
