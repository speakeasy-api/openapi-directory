...
class PostNetworksIDActionsAddRouteRequest:
    ...
    r"""ID of the Network"""  
    request_body: Optional[PostNetworksIDActionsAddRouteAddDeleteRouteRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class PostNetworksIDActionsAddRouteActionResponseAction:
    ...
    error: PostNetworksIDActionsAddRouteActionResponseActionError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})
    r"""Error message for the Action if error occurred, otherwise null"""  
    ...
    resources: list[PostNetworksIDActionsAddRouteActionResponseActionResources] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources') }})
    ...
    status: PostNetworksIDActionsAddRouteActionResponseActionStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Status of the Action"""  
...
class PostNetworksIDActionsAddRouteActionResponse:
    r"""The `action` key contains the `add_route` Action"""
    
    action: PostNetworksIDActionsAddRouteActionResponseAction = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('action') }})  
