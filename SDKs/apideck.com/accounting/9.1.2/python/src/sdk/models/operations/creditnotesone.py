...
from ..shared import getcreditnoteresponse as shared_getcreditnoteresponse
...
class CreditNotesOneResponse:
    ...
    r"""Bad Request"""  
    get_credit_note_response: Optional[shared_getcreditnoteresponse.GetCreditNoteResponse] = dataclasses.field(default=None)
    r"""Credit Note"""  
