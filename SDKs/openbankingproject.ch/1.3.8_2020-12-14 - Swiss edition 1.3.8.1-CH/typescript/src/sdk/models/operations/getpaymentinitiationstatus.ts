...
export class GetPaymentInitiationStatusPathParams extends SpeakeasyBase {
...
export class GetPaymentInitiationStatusHeaders extends SpeakeasyBase {
...
export class GetPaymentInitiationStatusSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class GetPaymentInitiationStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPaymentInitiationStatusResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
