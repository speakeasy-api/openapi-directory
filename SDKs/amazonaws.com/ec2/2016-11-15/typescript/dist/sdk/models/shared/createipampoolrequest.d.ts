...
import { IpamPoolAwsServiceEnum } from "./ipampoolawsserviceenum";
import { IpamPoolPublicIpSourceEnum } from "./ipampoolpublicipsourceenum";
/**
 * A tag on an IPAM resource.
 */
export declare class CreateIpamPoolRequestAllocationResourceTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare enum CreateIpamPoolRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateIpamPoolRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateIpamPoolRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateIpamPoolRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateIpamPoolRequestTagSpecificationsTags[];
}
export declare class CreateIpamPoolRequest extends SpeakeasyBase {
