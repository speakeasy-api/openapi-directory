...
export class GetNhBugsBugRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=bug" })
  bug: string;
...
export class GetNhBugsBugResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
