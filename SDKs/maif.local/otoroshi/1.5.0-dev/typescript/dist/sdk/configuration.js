...
var Configuration = /** @class */ (function () {
    ...
    **/
    Configuration.prototype.globalConfig = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GlobalConfigRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/globalconfig";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.globalConfig = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Configuration.prototype.patchGlobalConfig = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Configuration.prototype.putGlobalConfig = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
