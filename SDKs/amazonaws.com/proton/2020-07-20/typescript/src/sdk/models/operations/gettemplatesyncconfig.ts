...
export enum GetTemplateSyncConfigXAmzTargetEnum {
  AwsProton20200720GetTemplateSyncConfig = "AwsProton20200720.GetTemplateSyncConfig",
}

export class GetTemplateSyncConfigRequest extends SpeakeasyBase {
...
export class GetTemplateSyncConfigResponse extends SpeakeasyBase {
  /**
