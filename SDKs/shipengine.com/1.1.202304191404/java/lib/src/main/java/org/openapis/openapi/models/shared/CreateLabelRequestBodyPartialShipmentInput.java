...
public class CreateLabelRequestBodyPartialShipmentInput {
    ...
    public CreateLabelRequestBodyPartialShipmentInput withIsReturn(Boolean isReturn) {
    ...
    public CreateLabelRequestBodyPartialShipmentInput(@JsonProperty("advanced_options") AdvancedShipmentOptions advancedOptions, @JsonProperty("carrier_id") String carrierId, @JsonProperty("confirmation") CreateLabelRequestBodyPartialShipmentDeliveryConfirmationEnum confirmation, @JsonProperty("customs") CreateLabelRequestBodyPartialShipmentInternationalShipmentOptionsInput customs, @JsonProperty("insurance_provider") CreateLabelRequestBodyPartialShipmentInsuranceProviderEnum insuranceProvider, @JsonProperty("packages") PackageInput[] packages, @JsonProperty("return_to") ShippingAddress returnTo, @JsonProperty("service_code") String serviceCode, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("ship_from") ShippingAddress shipFrom, @JsonProperty("ship_to") ShippingAddress shipTo, @JsonProperty("warehouse_id") String warehouseId) {
        this.advancedOptions = advancedOptions;
        this.carrierId = carrierId;
        this.confirmation = confirmation;
        this.customs = customs;
