...
class TextFieldFontEnum(str, Enum):
    r"""An enumeration."""
    COURIER = 'courier'
    HELVETICA = 'helvetica'
    TIMES_ROMAN = 'times_roman'

class TextFieldHorizontalAlignEnum(str, Enum):
    r"""An enumeration."""
    L = 'L'
    C = 'C'
    R = 'R'

class TextFieldTypeEnum(str, Enum):
    TEXT = 'text'

class TextFieldVerticalAlignEnum(str, Enum):
    r"""An enumeration."""
    T = 'T'
    C = 'C'
    B = 'B'
...
class TextField:
    ...
    type: TextFieldTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
    ...
    font: Optional[TextFieldFontEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('font'), 'exclude': lambda f: f is None }})  
    ...
    h_align: Optional[TextFieldHorizontalAlignEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('h_align'), 'exclude': lambda f: f is None }})  
    required: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('required'), 'exclude': lambda f: f is None }})  
    v_align: Optional[TextFieldVerticalAlignEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('v_align'), 'exclude': lambda f: f is None }})  
