...
public class PostV05PatientsProfileShareRawRequest {
    ...
    public PostV05PatientsProfileShareRawRequest(@JsonProperty("Authorization") String authorization, @JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("X-HIP-ID") String xHipId) {
        this.authorization = authorization;
        this.requestBody = requestBody;
        this.xHipId = xHipId;
  }
