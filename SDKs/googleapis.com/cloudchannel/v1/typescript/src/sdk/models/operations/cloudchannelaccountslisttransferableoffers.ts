...
export class CloudchannelAccountsListTransferableOffersSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsListTransferableOffersRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudchannelAccountsListTransferableOffersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
