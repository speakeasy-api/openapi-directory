...
import org.openapis.openapi.models.operations.CreateCustomPolicyRequest;
import org.openapis.openapi.models.operations.CreateCustomPolicyResponse;
import org.openapis.openapi.models.operations.CreateCustomPolicySecurity;
import org.openapis.openapi.models.shared.CustomPolicyCreateRequest;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CreateCustomPolicyRequest req = new CreateCustomPolicyRequest(                new CustomPolicyCreateRequest() {{
            ...
            CreateCustomPolicyResponse res = sdk.customPolicy.createCustomPolicy(req, new CreateCustomPolicySecurity("ipsa") {{
                apiAuth = "Bearer YOUR_ACCESS_TOKEN_HERE";
            }});

            if (res.createCustomPolicy201ApplicationJSONObject != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetCustomPoliciesRequest;
import org.openapis.openapi.models.operations.GetCustomPoliciesResponse;
import org.openapis.openapi.models.operations.GetCustomPoliciesSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetCustomPoliciesRequest req = new GetCustomPoliciesRequest("delectus") {{
                policyTypes = "tempora";
            }};            

            GetCustomPoliciesResponse res = sdk.customPolicy.getCustomPolicies(req, new GetCustomPoliciesSecurity("suscipit") {{
                apiAuth = "Bearer YOUR_ACCESS_TOKEN_HERE";
            }});

            if (res.customPolicyResponse != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.GetCustomPolicyRequest;
import org.openapis.openapi.models.operations.GetCustomPolicyResponse;
import org.openapis.openapi.models.operations.GetCustomPolicySecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GetCustomPolicyRequest req = new GetCustomPolicyRequest("molestiae", "minus");            

            GetCustomPolicyResponse res = sdk.customPolicy.getCustomPolicy(req, new GetCustomPolicySecurity("placeat") {{
                apiAuth = "Bearer YOUR_ACCESS_TOKEN_HERE";
            }});

            if (res.customPolicy != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
...
import org.openapis.openapi.SDK;
import org.openapis.openapi.models.operations.UpdateCustomPolicyRequest;
import org.openapis.openapi.models.operations.UpdateCustomPolicyResponse;
import org.openapis.openapi.models.operations.UpdateCustomPolicySecurity;
import org.openapis.openapi.models.shared.CustomPolicyRequest;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            UpdateCustomPolicyRequest req = new UpdateCustomPolicyRequest(                new CustomPolicyRequest() {{
                                description = "voluptatum";
                                label = "iusto";
                                name = "Charlie Walsh II";
                            }};, "veritatis", "deserunt");            

            UpdateCustomPolicyResponse res = sdk.customPolicy.updateCustomPolicy(req, new UpdateCustomPolicySecurity("perferendis") {{
                apiAuth = "Bearer YOUR_ACCESS_TOKEN_HERE";
            }});
