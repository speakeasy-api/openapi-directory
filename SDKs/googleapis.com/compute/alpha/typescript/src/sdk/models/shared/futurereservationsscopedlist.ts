 ...
 */
export enum FutureReservationsScopedListWarningCodeEnum {
...
export class FutureReservationsScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class FutureReservationsScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: FutureReservationsScopedListWarningData })
  @Expose({ name: "data" })
...
export class FutureReservationsScopedList extends SpeakeasyBase {
  /**
   * A list of future reservations contained in this scope.
   */
  @SpeakeasyMetadata({ elemType: FutureReservation })
  @Expose({ name: "futureReservations" })
