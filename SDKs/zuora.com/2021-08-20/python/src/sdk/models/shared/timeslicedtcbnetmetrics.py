...
class TimeSlicedTcbNetMetrics:
    ...
    generated_reason: Optional[TimeSlicedTcbNetMetricsGeneratedReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('generatedReason'), 'exclude': lambda f: f is None }})
    r"""Specify the reason why the metrics are generated by the certain order action.
    ...
    * The \"Generated Reason\" and \"Order Item ID\" fields in the Order MRR, Order TCB, Order TCV, and Order Quantity objects
    ...
    type: Optional[TimeSlicedTcbNetMetricsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Indicates whether this metrics is for a regular charge or a discount charge."""  
