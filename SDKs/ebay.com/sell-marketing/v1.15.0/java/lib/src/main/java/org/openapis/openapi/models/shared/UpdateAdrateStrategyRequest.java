...
public class UpdateAdrateStrategyRequest {
    ...
    public UpdateAdrateStrategyRequest withAdRateStrategy(String adRateStrategy) {
    ...
    public UpdateAdrateStrategyRequest withBidPercentage(String bidPercentage) {
    ...
    public UpdateAdrateStrategyRequest withDynamicAdRatePreferences(DynamicAdRatePreference[] dynamicAdRatePreferences) {
        this.dynamicAdRatePreferences = dynamicAdRatePreferences;
        return this;
    }
    
    public UpdateAdrateStrategyRequest(){}
}
