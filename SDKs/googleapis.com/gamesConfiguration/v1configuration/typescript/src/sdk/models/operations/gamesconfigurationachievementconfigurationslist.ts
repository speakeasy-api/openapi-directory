...
export class GamesConfigurationAchievementConfigurationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GamesConfigurationAchievementConfigurationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class GamesConfigurationAchievementConfigurationsListResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
