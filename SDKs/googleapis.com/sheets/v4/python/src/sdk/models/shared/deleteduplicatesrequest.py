...
class DeleteDuplicatesRequest:
    ...
    comparison_columns: Optional[list[shared_dimensionrange.DimensionRange]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('comparisonColumns') }})
