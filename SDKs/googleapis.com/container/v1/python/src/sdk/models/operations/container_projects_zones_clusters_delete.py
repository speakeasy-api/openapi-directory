...
@dataclasses.dataclass
class ContainerProjectsZonesClustersDeleteRequest:
    
    cluster_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'clusterId', 'style': 'simple', 'explode': False }})
    r"""Deprecated. The name of the cluster to delete. This field has been deprecated and replaced by the name field."""  
    ...
    r"""The name (project, location, cluster) of the cluster to delete. Specified in the format `projects/*/locations/*/clusters/*`."""  
...
@dataclasses.dataclass
class ContainerProjectsZonesClustersDeleteResponse:
