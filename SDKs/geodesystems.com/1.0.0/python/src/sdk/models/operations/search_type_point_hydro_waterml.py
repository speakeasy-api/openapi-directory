...
class SearchTypePointHydroWatermlQueryParams:
    ...
    search_type_point_hydro_waterml_site_code: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_hydro_waterml.site_code', 'style': 'form', 'explode': True }})
    search_type_point_hydro_waterml_site_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_hydro_waterml.site_name', 'style': 'form', 'explode': True }})
...
class SearchTypePointHydroWatermlRequest:
    query_params: SearchTypePointHydroWatermlQueryParams = dataclasses.field()
