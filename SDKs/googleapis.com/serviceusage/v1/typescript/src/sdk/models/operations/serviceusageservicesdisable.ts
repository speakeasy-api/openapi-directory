...
export class ServiceusageServicesDisableSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ServiceusageServicesDisableSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class ServiceusageServicesDisableSecurity extends SpeakeasyBase {
...
export class ServiceusageServicesDisableRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ServiceusageServicesDisableResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
