...
from ..shared import pagedpayeeinvitationstatusresponsev4 as shared_pagedpayeeinvitationstatusresponsev4
...
class GetPayeesInvitationStatusV4Response:
    ...
    paged_payee_invitation_status_response_v4: Optional[shared_pagedpayeeinvitationstatusresponsev4.PagedPayeeInvitationStatusResponseV4] = dataclasses.field(default=None)
