...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/adyen.com/LegalEntityService/3/python
```
...
* `post_legal_entities_id_check_verification_errors` - Check a legal entity's verification errors
