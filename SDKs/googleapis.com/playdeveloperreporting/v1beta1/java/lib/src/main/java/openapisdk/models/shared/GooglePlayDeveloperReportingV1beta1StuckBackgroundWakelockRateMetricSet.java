...
public class GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet {
    ...
    public GooglePlayDeveloperReportingV1beta1FreshnessInfo freshnessInfo;
    public GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet withFreshnessInfo(GooglePlayDeveloperReportingV1beta1FreshnessInfo freshnessInfo) {
    ...
    @JsonProperty("name")
    public String name;
    public GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet withName(String name) {
        this.name = name;
        return this;
    }
}