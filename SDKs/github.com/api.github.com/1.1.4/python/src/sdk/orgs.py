...
class Orgs:
    ...
    def orgs_block_user(self, request: operations.OrgsBlockUserRequest) -> operations.OrgsBlockUserResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/blocks/{username}", request.path_params)
        ...
        res = operations.OrgsBlockUserResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_cancel_invitation(self, request: operations.OrgsCancelInvitationRequest) -> operations.OrgsCancelInvitationResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/invitations/{invitation_id}", request.path_params)
        ...
        res = operations.OrgsCancelInvitationResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_check_blocked_user(self, request: operations.OrgsCheckBlockedUserRequest) -> operations.OrgsCheckBlockedUserResponse:
        ...
        res = operations.OrgsCheckBlockedUserResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_convert_member_to_outside_collaborator(self, request: operations.OrgsConvertMemberToOutsideCollaboratorRequest) -> operations.OrgsConvertMemberToOutsideCollaboratorResponse:
        ...
        if r.status_code == 202:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.OrgsConvertMemberToOutsideCollaborator403ApplicationJSON])
                res.orgs_convert_member_to_outside_collaborator_403_application_json_object = out
        elif r.status_code == 404:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BasicError])
                res.basic_error = out
    ...
    def orgs_create_invitation(self, request: operations.OrgsCreateInvitationRequest) -> operations.OrgsCreateInvitationResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/invitations", request.path_params)
        ...
        res = operations.OrgsCreateInvitationResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_list_blocked_users(self, request: operations.OrgsListBlockedUsersRequest) -> operations.OrgsListBlockedUsersResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/blocks", request.path_params)
        ...
        res = operations.OrgsListBlockedUsersResponse(status_code=r.status_code, content_type=content_type)
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.OrgsListBlockedUsers415ApplicationJSON])
                res.orgs_list_blocked_users_415_application_json_object = out
    ...
    def orgs_list_failed_invitations(self, request: operations.OrgsListFailedInvitationsRequest) -> operations.OrgsListFailedInvitationsResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/failed_invitations", request.path_params)
        ...
        res = operations.OrgsListFailedInvitationsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_list_invitation_teams(self, request: operations.OrgsListInvitationTeamsRequest) -> operations.OrgsListInvitationTeamsResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/invitations/{invitation_id}/teams", request.path_params)
        ...
        res = operations.OrgsListInvitationTeamsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_list_pending_invitations(self, request: operations.OrgsListPendingInvitationsRequest) -> operations.OrgsListPendingInvitationsResponse:
        ...
        res = operations.OrgsListPendingInvitationsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_list_saml_sso_authorizations(self, request: operations.OrgsListSamlSsoAuthorizationsRequest) -> operations.OrgsListSamlSsoAuthorizationsResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/credential-authorizations", request.path_params)
        ...
        res = operations.OrgsListSamlSsoAuthorizationsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[list[shared.CredentialAuthorization]])
    ...
    def orgs_remove_saml_sso_authorization(self, request: operations.OrgsRemoveSamlSsoAuthorizationRequest) -> operations.OrgsRemoveSamlSsoAuthorizationResponse:
        ...
        url = utils.generate_url(base_url, "/orgs/{org}/credential-authorizations/{credential_id}", request.path_params)
        ...
        res = operations.OrgsRemoveSamlSsoAuthorizationResponse(status_code=r.status_code, content_type=content_type)
    ...
    def orgs_unblock_user(self, request: operations.OrgsUnblockUserRequest) -> operations.OrgsUnblockUserResponse:
        ...
        res = operations.OrgsUnblockUserResponse(status_code=r.status_code, content_type=content_type)
