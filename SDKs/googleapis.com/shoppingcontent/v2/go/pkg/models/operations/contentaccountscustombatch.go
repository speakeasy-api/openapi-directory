...
type ContentAccountsCustombatchSecurity struct {
...
type ContentAccountsCustombatchRequest struct {
	...
	AccountsCustomBatchRequest *shared.AccountsCustomBatchRequest `request:"mediaType=application/json"`
	// OAuth access token.
...
type ContentAccountsCustombatchResponse struct {
	// Successful response
