...
export declare class PreprintProvidersPreprintsListRequest extends SpeakeasyBase {
    /**
 ...
 */
export declare class PreprintProvidersPreprintsListPreprintAttributes extends SpeakeasyBase {
    /**
 ...
 */
export declare class PreprintProvidersPreprintsListPreprintLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class PreprintProvidersPreprintsListPreprintRelationships extends SpeakeasyBase {
    /**
...
export declare class PreprintProvidersPreprintsListPreprint extends SpeakeasyBase {
    /**
     * The properties of the preprint entity.
     */
...
export declare class PreprintProvidersPreprintsListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
