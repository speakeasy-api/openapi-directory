...
export class AdsenseAccountsListChildAccountsSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdsenseAccountsListChildAccountsSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AdsenseAccountsListChildAccountsSecurity extends SpeakeasyBase {
...
export class AdsenseAccountsListChildAccountsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdsenseAccountsListChildAccountsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
