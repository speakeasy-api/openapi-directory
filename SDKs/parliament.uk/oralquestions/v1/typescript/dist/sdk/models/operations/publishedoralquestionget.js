...
exports.PublishedOralQuestionGetResponse = exports.PublishedOralQuestionGetRequest = exports.PublishedOralQuestionGetParametersQuestionTypeEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Oral Questions where the question type is the selected type, substantive or topical.
 */
var PublishedOralQuestionGetParametersQuestionTypeEnum;
...
})(PublishedOralQuestionGetParametersQuestionTypeEnum = exports.PublishedOralQuestionGetParametersQuestionTypeEnum || (exports.PublishedOralQuestionGetParametersQuestionTypeEnum = {}));
var PublishedOralQuestionGetRequest = /** @class */ (function (_super) {
    ...
    ], PublishedOralQuestionGetRequest.prototype, "parametersAnsweringBodyIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.answeringDateEnd;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], PublishedOralQuestionGetRequest.prototype, "parametersAnsweringDateEnd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.answeringDateStart;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], PublishedOralQuestionGetRequest.prototype, "parametersAnsweringDateStart", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.askingMemberIds",
        }),
        __metadata("design:type", Array)
    ], PublishedOralQuestionGetRequest.prototype, "parametersAskingMemberIds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.oralQuestionTimeId",
        }),
        __metadata("design:type", Number)
    ], PublishedOralQuestionGetRequest.prototype, "parametersOralQuestionTimeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.questionType",
        }),
        __metadata("design:type", String)
    ], PublishedOralQuestionGetRequest.prototype, "parametersQuestionType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.skip",
        }),
        __metadata("design:type", Number)
    ], PublishedOralQuestionGetRequest.prototype, "parametersSkip", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.take",
        }),
        __metadata("design:type", Number)
    ], PublishedOralQuestionGetRequest.prototype, "parametersTake", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parameters.uINs",
        }),
        __metadata("design:type", Array)
    ], PublishedOralQuestionGetRequest.prototype, "parametersUINs", void 0);
    return PublishedOralQuestionGetRequest;
}(utils_1.SpeakeasyBase));
exports.PublishedOralQuestionGetRequest = PublishedOralQuestionGetRequest;
var PublishedOralQuestionGetResponse = /** @class */ (function (_super) {
    ...
    ], PublishedOralQuestionGetResponse.prototype, "rawResponse", void 0);
    return PublishedOralQuestionGetResponse;
}(utils_1.SpeakeasyBase));
exports.PublishedOralQuestionGetResponse = PublishedOralQuestionGetResponse;
