...
type AdsenseAccountsAdclientsCustomchannelsListSecurityOption1 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AdsenseAccountsAdclientsCustomchannelsListSecurityOption2 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AdsenseAccountsAdclientsCustomchannelsListSecurity struct {
	Option1 *AdsenseAccountsAdclientsCustomchannelsListSecurityOption1 `security:"option"`
	Option2 *AdsenseAccountsAdclientsCustomchannelsListSecurityOption2 `security:"option"`
}

type AdsenseAccountsAdclientsCustomchannelsListPathParams struct {
...
type AdsenseAccountsAdclientsCustomchannelsListQueryParams struct {
	// V1 error format.
...
type AdsenseAccountsAdclientsCustomchannelsListRequest struct {
...
type AdsenseAccountsAdclientsCustomchannelsListResponse struct {
	ContentType string
	// Successful response
