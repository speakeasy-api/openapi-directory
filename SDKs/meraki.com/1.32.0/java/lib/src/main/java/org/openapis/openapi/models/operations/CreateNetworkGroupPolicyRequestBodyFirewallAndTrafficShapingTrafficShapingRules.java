...
public class CreateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingTrafficShapingRules {
    ...
    public CreateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingTrafficShapingRules(@JsonProperty("definitions") CreateNetworkGroupPolicyRequestBodyFirewallAndTrafficShapingTrafficShapingRulesDefinitions[] definitions) {
        this.definitions = definitions;
  }
}
