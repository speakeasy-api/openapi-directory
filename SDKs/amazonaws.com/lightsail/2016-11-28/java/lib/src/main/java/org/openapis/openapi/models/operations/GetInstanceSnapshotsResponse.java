...
public class GetInstanceSnapshotsResponse {
    ...
    public org.openapis.openapi.models.shared.GetInstanceSnapshotsResult getInstanceSnapshotsResult;

    public GetInstanceSnapshotsResponse withGetInstanceSnapshotsResult(org.openapis.openapi.models.shared.GetInstanceSnapshotsResult getInstanceSnapshotsResult) {
    ...
    public GetInstanceSnapshotsResponse withStatusCode(Integer statusCode) {
    ...
    public GetInstanceSnapshotsResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public GetInstanceSnapshotsResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
