...
var Departures = /** @class */ (function () {
    function Departures(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Departures.prototype.departuresGetForStop = function (req, config) {
    ...
    **/
    Departures.prototype.departuresGetForStopAndRoute = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
