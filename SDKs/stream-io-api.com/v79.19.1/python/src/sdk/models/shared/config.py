...
class ConfigDefaultRoleEnum(str, Enum):
    ATTENDEE = 'attendee'
    PUBLISHER = 'publisher'
...
class Config:
    ...
    default_role: Optional[ConfigDefaultRoleEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('default_role'), 'exclude': lambda f: f is None }})  
