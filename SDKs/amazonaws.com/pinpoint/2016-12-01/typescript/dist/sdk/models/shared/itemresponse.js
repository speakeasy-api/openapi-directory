...
var ItemResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "EndpointItemResponse" }),
        (0, class_transformer_1.Type)(function () { return endpointitemresponse_1.EndpointItemResponse; }),
        __metadata("design:type", endpointitemresponse_1.EndpointItemResponse)
    ], ItemResponse.prototype, "endpointItemResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: eventitemresponse_1.EventItemResponse }),
        (0, class_transformer_1.Expose)({ name: "EventsItemResponse" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], eventitemresponse_1.EventItemResponse);
            }
            return obj;
        }, { toClassOnly: true }),
