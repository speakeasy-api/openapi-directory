...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/privateca/v1beta1/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/googleapis.com/privateca/v1beta1/typescript
```
...
```typescript
import {
  PrivatecaProjectsLocationsListRequest,
  PrivatecaProjectsLocationsListResponse
...
const req: PrivatecaProjectsLocationsListRequest = {
...
sdk.projects.privatecaProjectsLocationsList(req).then((res: PrivatecaProjectsLocationsListResponse | AxiosError) => {
   // handle response
});
```
