...
class AddTagsToCertificateRequest:
    headers: AddTagsToCertificateHeaders = dataclasses.field()
    request: shared_addtagstocertificaterequest.AddTagsToCertificateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
