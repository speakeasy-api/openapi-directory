...
class POSTCreateEmailTemplateRequest:
    ...
    """  
    post_public_email_template_request: shared_postpublicemailtemplaterequest.POSTPublicEmailTemplateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
