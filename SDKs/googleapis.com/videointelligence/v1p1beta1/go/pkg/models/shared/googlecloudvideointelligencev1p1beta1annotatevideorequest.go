...
func (e *GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum) UnmarshalJSON(data []byte) error {
	...
	case "PERSON_DETECTION":
		*e = GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum: %s", s)
	}
}
