...
public class Sms {
    ...
    public org.openapis.openapi.models.operations.ListUserSSubscriptionGroupSmsResponse listUserSSubscriptionGroupSms(org.openapis.openapi.models.operations.ListUserSSubscriptionGroupSmsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListUserSSubscriptionGroupSmsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.ListUserSSubscriptionGroupStatusSmsResponse listUserSSubscriptionGroupStatusSms(org.openapis.openapi.models.operations.ListUserSSubscriptionGroupStatusSmsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListUserSSubscriptionGroupStatusSmsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
