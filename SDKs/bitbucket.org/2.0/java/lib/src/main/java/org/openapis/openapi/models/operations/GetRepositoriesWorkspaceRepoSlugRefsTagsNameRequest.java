...
public class GetRepositoriesWorkspaceRepoSlugRefsTagsNameRequest {
    ...
    public GetRepositoriesWorkspaceRepoSlugRefsTagsNameRequest(@JsonProperty("name") String name, @JsonProperty("repo_slug") String repoSlug, @JsonProperty("workspace") String workspace) {
        this.name = name;
        this.repoSlug = repoSlug;
        this.workspace = workspace;
  }
