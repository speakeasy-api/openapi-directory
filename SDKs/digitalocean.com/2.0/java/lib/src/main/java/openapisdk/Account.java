...
public class Account {
    ...
    **/
    public openapisdk.models.operations.GetUserInformationResponse getUserInformation() throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v2/account");
        ...
        openapisdk.models.operations.GetUserInformationResponse res = new openapisdk.models.operations.GetUserInformationResponse() {{
            getUserInformation200ApplicationJSONAny = null;
            getUserInformation401ApplicationJSONObject = null;
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetUserInformation401ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetUserInformation401ApplicationJson.class);
