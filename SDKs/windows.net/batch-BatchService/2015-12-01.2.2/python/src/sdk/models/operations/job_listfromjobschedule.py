...
from ..shared import cloudjoblistresult as shared_cloudjoblistresult
...
class JobListFromJobScheduleRequest:
    ...
    r"""The id of the job schedule from which you want to get a list of jobs."""  
...
class JobListFromJobScheduleResponse:
    ...
    cloud_job_list_result: Optional[shared_cloudjoblistresult.CloudJobListResult] = dataclasses.field(default=None)  
