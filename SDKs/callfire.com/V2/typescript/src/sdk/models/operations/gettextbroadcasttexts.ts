...
export class GetTextBroadcastTextsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetTextBroadcastTextsRequest extends SpeakeasyBase {
  /**
   * ~
   */
  @SpeakeasyMetadata({
...
export class GetTextBroadcastTextsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
