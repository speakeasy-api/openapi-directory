...
from ..shared import createorupdateenvironmentaccessmodel as shared_createorupdateenvironmentaccessmodel
...
class CreatePermissionGroupRequest:
    ...
    environment_accesses: Optional[list[shared_createorupdateenvironmentaccessmodel.CreateOrUpdateEnvironmentAccessModel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('environmentAccesses'), 'exclude': lambda f: f is None }})  
