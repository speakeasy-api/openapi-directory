...
class ListIncomingPhoneNumberAssignedAddOnListIncomingPhoneNumberAssignedAddOnResponse:
    ...
    assigned_add_ons: Optional[list[shared_api_v2010_account_incoming_phone_number_incoming_phone_number_assigned_add_on.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assigned_add_ons'), 'exclude': lambda f: f is None }})  
