...
type SearchTypeDocumentPdfQueryParams struct {
...
type SearchTypeDocumentPdfRequest struct {
	QueryParams SearchTypeDocumentPdfQueryParams
}

type SearchTypeDocumentPdfResponse struct {
	ContentType string
	StatusCode  int
