 ...
 */
export declare class DescribeIamInstanceProfileAssociationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeIamInstanceProfileAssociationsRequest extends SpeakeasyBase {
    associationIds?: string[];
    filters?: DescribeIamInstanceProfileAssociationsRequestFilters[];
    maxResults?: number;
    nextToken?: string;
}
