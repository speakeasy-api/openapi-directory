...
exports.AspectRecommendations = void 0;
...
**/
var AspectRecommendations = /** @class */ (function (_super) {
    __extends(AspectRecommendations, _super);
    function AspectRecommendations() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=suggestedValues" }),
        __metadata("design:type", Array)
    ], AspectRecommendations.prototype, "suggestedValues", void 0);
    return AspectRecommendations;
}(utils_1.SpeakeasyBase));
exports.AspectRecommendations = AspectRecommendations;
