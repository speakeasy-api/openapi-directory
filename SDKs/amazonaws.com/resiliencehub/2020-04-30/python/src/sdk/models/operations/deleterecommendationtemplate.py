...
from ..shared import deleterecommendationtemplateresponse as shared_deleterecommendationtemplateresponse
...
class DeleteRecommendationTemplateRequest:
    ...
    request_body: DeleteRecommendationTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteRecommendationTemplateResponse:
    ...
    delete_recommendation_template_response: Optional[shared_deleterecommendationtemplateresponse.DeleteRecommendationTemplateResponse] = dataclasses.field(default=None)
    r"""Success"""  
