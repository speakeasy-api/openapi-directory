...
class HeavyEquipmentsBaseListing:
    r"""Base heavy equipment listing"""
    
    build: Optional[shared_heavyequipmentsbuild.HeavyEquipmentsBuild] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('build'), 'exclude': lambda f: f is None }})
    ...
    r"""Distance of the quipments's location from the specified user lcoation"""  
    ...
    r"""Details Page url of the specific heavy equipment"""  
    ...
    r"""Exterior color of the heavy equipment"""  
    ...
    r"""Interior color of the heavy equipment"""  
    ...
    r"""Inventory type of heavy equipment"""  
    ...
    r"""Odometer reading / reported miles usage for the heavy equipment"""  
    ...
    r"""MSRP for the heavy equipment"""  
    ...
    r"""Asking price for the heavy equipment"""  
    ...
    r"""Seller type for the heavy equipment"""  
    ...
    r"""Stock number of heavy equipment in dealers inventory"""  
