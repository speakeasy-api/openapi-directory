...
type ArtistAPIPostEditCommentFormPathParams struct {
	// ID of the comment to be edited.
	CommentID int `pathParam:"style=simple,explode=false,name=commentId"`
}

type ArtistAPIPostEditCommentFormRequest struct {
	PathParams ArtistAPIPostEditCommentFormPathParams
...
type ArtistAPIPostEditCommentFormResponse struct {
	ContentType string
	StatusCode  int
