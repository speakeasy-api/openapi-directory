...
export class Link {
  ...
  **/
  postV05LinksLinkConfirm(
    ...
    let baseURL: string = operations.PostV05LinksLinkConfirmServerList[0];
    if (req.serverURL) {
  ...
  **/
  postV05LinksLinkInit(
    ...
    let baseURL: string = operations.PostV05LinksLinkInitServerList[0];
    if (req.serverURL) {
      baseURL = req.serverURL;
    }
  ...
  **/
  postV05LinksLinkOnAddContexts(
    ...
    let baseURL: string = operations.PostV05LinksLinkOnAddContextsServerList[0];
    if (req.serverURL) {
      baseURL = req.serverURL;
    }
