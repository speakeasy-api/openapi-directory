...
class DeclineInvitationsRequestBody:
    ...
    r"""An array that lists Amazon Web Services account IDs, one for each account that sent an invitation to decline."""  
    

@dataclasses.dataclass
class DeclineInvitationsRequest:
    
    request_body: DeclineInvitationsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
