...
var Uplink = /** @class */ (function () {
    function Uplink(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Uplink.prototype.getNetworkCellularGatewayUplink = function (req, config) {
    ...
    **/
    Uplink.prototype.getOrganizationApplianceUplinkStatuses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Uplink.prototype.getOrganizationCellularGatewayUplinkStatuses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Uplink.prototype.updateNetworkCellularGatewayUplink = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
