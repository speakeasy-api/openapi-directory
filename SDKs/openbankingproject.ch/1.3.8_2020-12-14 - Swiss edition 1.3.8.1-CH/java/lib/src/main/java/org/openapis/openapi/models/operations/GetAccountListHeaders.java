...
public class GetAccountListHeaders {
    /**
    ...
    public GetAccountListHeaders withConsentID(String consentID) {
    ...
    public GetAccountListHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    ...
    public GetAccountListHeaders withPSUAccept(String psuAccept) {
    ...
    public GetAccountListHeaders withPSUAcceptCharset(String psuAcceptCharset) {
    ...
    public GetAccountListHeaders withPSUAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetAccountListHeaders withPSUAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetAccountListHeaders withPSUDeviceID(String psuDeviceID) {
    ...
    public GetAccountListHeaders withPSUGeoLocation(String psuGeoLocation) {
    ...
    public GetAccountListHeaders withPSUHttpMethod(org.openapis.openapi.models.shared.PSUHttpMethodEnum psuHttpMethod) {
    ...
    public GetAccountListHeaders withPSUIPAddress(String psuIPAddress) {
    ...
    public GetAccountListHeaders withPSUIPPort(String psuIPPort) {
    ...
    public GetAccountListHeaders withPSUUserAgent(String psuUserAgent) {
    ...
    public GetAccountListHeaders withSignature(String signature) {
    ...
    public GetAccountListHeaders withTPPSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetAccountListHeaders withXRequestID(String xRequestID) {
