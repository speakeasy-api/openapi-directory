...
class Projects:
    ...
    def gkehub_projects_locations_features_create(self, request: operations.GkehubProjectsLocationsFeaturesCreateRequest) -> operations.GkehubProjectsLocationsFeaturesCreateResponse:
        r"""Adds a new Feature.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/v1beta/{parent}/features", request.path_params)
        ...
        res = operations.GkehubProjectsLocationsFeaturesCreateResponse(status_code=r.status_code, content_type=content_type)
    ...
    def gkehub_projects_locations_features_list(self, request: operations.GkehubProjectsLocationsFeaturesListRequest) -> operations.GkehubProjectsLocationsFeaturesListResponse:
        ...
        res = operations.GkehubProjectsLocationsFeaturesListResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFeaturesResponse])
                res.list_features_response = out

        return res

    
    def gkehub_projects_locations_features_patch(self, request: operations.GkehubProjectsLocationsFeaturesPatchRequest) -> operations.GkehubProjectsLocationsFeaturesPatchResponse:
        ...
        res = operations.GkehubProjectsLocationsFeaturesPatchResponse(status_code=r.status_code, content_type=content_type)
