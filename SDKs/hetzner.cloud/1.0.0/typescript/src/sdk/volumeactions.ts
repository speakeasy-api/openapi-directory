...
export class VolumeActions {
  ...
  getVolumesIdActions(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetVolumesIdActionsResponse =
        new operations.GetVolumesIdActionsResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.actionsResponse = utils.objectToClass(
              httpRes?.data,
              operations.GetVolumesIdActionsActionsResponse
            );
          }
          break;
      }
  ...
  getVolumesIdActionsActionId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetVolumesIdActionsActionIdResponse =
        new operations.GetVolumesIdActionsActionIdResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.actionResponse = utils.objectToClass(
              httpRes?.data,
              operations.GetVolumesIdActionsActionIdActionResponse
            );
          }
          break;
      }
  ...
  postVolumesIdActionsAttach(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostVolumesIdActionsAttachResponse =
        new operations.PostVolumesIdActionsAttachResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.actionResponse = utils.objectToClass(
              httpRes?.data,
              operations.PostVolumesIdActionsAttachActionResponse
            );
          }
          break;
      }
  ...
  postVolumesIdActionsChangeProtection(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostVolumesIdActionsChangeProtectionResponse =
        new operations.PostVolumesIdActionsChangeProtectionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.actionResponse = utils.objectToClass(
              httpRes?.data,
              operations.PostVolumesIdActionsChangeProtectionActionResponse
            );
          }
          break;
      }
  ...
  postVolumesIdActionsDetach(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostVolumesIdActionsDetachResponse =
        new operations.PostVolumesIdActionsDetachResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.actionResponse = utils.objectToClass(
              httpRes?.data,
              operations.PostVolumesIdActionsDetachActionResponse
            );
          }
          break;
      }
  ...
  postVolumesIdActionsResize(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostVolumesIdActionsResizeResponse =
        new operations.PostVolumesIdActionsResizeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.actionResponse = utils.objectToClass(
              httpRes?.data,
              operations.PostVolumesIdActionsResizeActionResponse
            );
          }
          break;
      }
