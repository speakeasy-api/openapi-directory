...
public class Jobs {
    ...
    **/
    public openapisdk.models.operations.GetJobResponse getJob(openapisdk.models.operations.GetJobRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/jobs/{job_gid}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.GetJob200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetJob200ApplicationJson.class);
