...
public class GETCreditMemoPartRequest {
    ...
    public GETCreditMemoPartRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETCreditMemoPartRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETCreditMemoPartRequest withCreditMemoId(String creditMemoId) {
    ...
    public GETCreditMemoPartRequest withPartid(String partid) {
        this.partid = partid;
        return this;
    }
