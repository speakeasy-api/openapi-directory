...
export class CreateDomesticScheduledPaymentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticScheduledPaymentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticScheduledPaymentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
