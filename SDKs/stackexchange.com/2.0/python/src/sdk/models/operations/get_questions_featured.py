...
class GetQuestionsFeaturedOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetQuestionsFeaturedSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
class GetQuestionsFeaturedQueryParams:
    ...
    order: Optional[GetQuestionsFeaturedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetQuestionsFeaturedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class GetQuestionsFeaturedRequest:
    query_params: GetQuestionsFeaturedQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetQuestionsFeaturedResponse:
