 ...
 */
export class CompanyMonitorListDefaultApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code: number;
...
export class CompanyMonitorList200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CompanyMonitorListResponse extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: CompanyMonitorList200ApplicationJSON })
