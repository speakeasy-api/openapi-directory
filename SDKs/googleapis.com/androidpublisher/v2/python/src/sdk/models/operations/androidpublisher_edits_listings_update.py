...
class AndroidpublisherEditsListingsUpdateRequest:
    ...
    r"""The language code (a BCP-47 language tag) of the localized listing to read or modify. For example, to select Austrian German, pass \\"de-AT\\"."""  
    ...
    listing: Optional[shared_listing.Listing] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
