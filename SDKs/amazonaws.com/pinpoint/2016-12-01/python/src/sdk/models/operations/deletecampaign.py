...
from ..shared import deletecampaignresponse as shared_deletecampaignresponse
...
class DeleteCampaignResponse:
    ...
    delete_campaign_response: Optional[shared_deletecampaignresponse.DeleteCampaignResponse] = dataclasses.field(default=None)
