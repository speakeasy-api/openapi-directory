...
from ..shared import deletetenderresponse as shared_deletetenderresponse
...
class TendersDeleteRequest:
    headers: TendersDeleteHeaders = dataclasses.field()
    path_params: TendersDeletePathParams = dataclasses.field()
    query_params: TendersDeleteQueryParams = dataclasses.field()
    security: TendersDeleteSecurity = dataclasses.field()
...
class TendersDeleteResponse:
    ...
    delete_tender_response: Optional[shared_deletetenderresponse.DeleteTenderResponse] = dataclasses.field(default=None)
