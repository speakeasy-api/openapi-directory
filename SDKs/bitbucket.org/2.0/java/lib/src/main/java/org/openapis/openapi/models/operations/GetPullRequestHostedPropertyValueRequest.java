...
public class GetPullRequestHostedPropertyValueRequest {
    ...
    public GetPullRequestHostedPropertyValueRequest(@JsonProperty("app_key") String appKey, @JsonProperty("property_name") String propertyName, @JsonProperty("pullrequest_id") String pullrequestId, @JsonProperty("repo_slug") String repoSlug, @JsonProperty("workspace") String workspace) {
        this.appKey = appKey;
        this.propertyName = propertyName;
        this.pullrequestId = pullrequestId;
        this.repoSlug = repoSlug;
