...
class GetBatchByExternalIDResponseBodyOptionalLink:
    r"""GetBatchByExternalIDResponseBodyOptionalLink
...
class GetBatchByExternalIDResponseBodyLabelDownload:
    r"""GetBatchByExternalIDResponseBodyLabelDownload
...
class GetBatchByExternalIDResponseBody:
    r"""GetBatchByExternalIDResponseBody
    ...
    batch_errors_url: GetBatchByExternalIDResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('batch_errors_url') }})
    ...
    form_download: GetBatchByExternalIDResponseBodyOptionalLink = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('form_download') }})
    forms: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('forms') }})
    label_download: GetBatchByExternalIDResponseBodyLabelDownload = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_download') }})
