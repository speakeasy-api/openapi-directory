...
export class NetworkservicesProjectsLocationsGrpcRoutesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsGrpcRoutesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsGrpcRoutesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
