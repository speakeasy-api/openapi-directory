...
class AndroidpublisherEditsExpansionfilesGetPathParams:
    ...
    expansion_file_type: AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'expansionFileType', 'style': 'simple', 'explode': False }})
    package_name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'packageName', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class AndroidpublisherEditsExpansionfilesGetQueryParams:
...
class AndroidpublisherEditsExpansionfilesGetRequest:
    path_params: AndroidpublisherEditsExpansionfilesGetPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsExpansionfilesGetQueryParams = dataclasses.field()
    security: AndroidpublisherEditsExpansionfilesGetSecurity = dataclasses.field()
