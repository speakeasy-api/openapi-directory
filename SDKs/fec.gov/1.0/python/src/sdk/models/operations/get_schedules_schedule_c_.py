...
class GetSchedulesScheduleCDefaultApplicationJSON:
    ...
    results: Optional[list[GetSchedulesScheduleCDefaultApplicationJSONResults]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    

@dataclasses.dataclass
class GetSchedulesScheduleCRequest:
    query_params: GetSchedulesScheduleCQueryParams = dataclasses.field()
