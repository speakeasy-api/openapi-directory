...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/netboxdemo.com/2.4/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/netboxdemo.com/2.4/typescript
```
