 ...
 */
public enum RollbacksNetworkFirmwareUpgradesStagedEventsRequestBodyReasonsCategoryEnum {
    ...
    private RollbacksNetworkFirmwareUpgradesStagedEventsRequestBodyReasonsCategoryEnum(String value) {
        this.value = value;
    }
}
