...
export enum GETDeleteVerifiedAccessGroupActionEnum {
  DeleteVerifiedAccessGroup = "DeleteVerifiedAccessGroup",
}

export enum GETDeleteVerifiedAccessGroupVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETDeleteVerifiedAccessGroupRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETDeleteVerifiedAccessGroupResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
