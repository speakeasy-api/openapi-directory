...
class RegionBackendServices 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicyRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicySecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicyResponse
     */
	public function computeRegionBackendServicesSetSecurityPolicy(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicyRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicySecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicyResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/backendServices/{backendService}/setSecurityPolicy', \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicyRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "securityPolicyReference", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicyRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesSetSecurityPolicyResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsResponse
     */
	public function computeRegionBackendServicesTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/backendServices/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRegionBackendServicesTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
