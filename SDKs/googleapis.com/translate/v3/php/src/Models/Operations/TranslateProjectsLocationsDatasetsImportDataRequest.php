...
class TranslateProjectsLocationsDatasetsImportDataRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ImportDataRequest $importDataRequest = null;
