...
public class UpdateUserHeaders {
    ...
    public UpdateUserHeaders withXSdsAuthToken(String xSdsAuthToken) {
    ...
    public UpdateUserHeaders withXSdsDateFormat(UpdateUserXSdsDateFormatEnum xSdsDateFormat) {
