...
exports.UpdateBucketResponse = exports.UpdateBucketRequest = exports.UpdateBucketUpdateBucketRequest = exports.UpdateBucketSecurity = exports.UpdateBucketServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.UpdateBucketServerList = ["https://verify.twilio.com"];
var UpdateBucketSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateBucketSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], UpdateBucketSecurity.prototype, "username", void 0);
    return UpdateBucketSecurity;
}(utils_1.SpeakeasyBase));
exports.UpdateBucketSecurity = UpdateBucketSecurity;
...
exports.UpdateBucketUpdateBucketRequest = UpdateBucketUpdateBucketRequest;
var UpdateBucketRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateBucketRequest.prototype, "rateLimitSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "request, media_type=application/x-www-form-urlencoded",
        }),
        __metadata("design:type", UpdateBucketUpdateBucketRequest)
    ], UpdateBucketRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], UpdateBucketRequest.prototype, "serviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=Sid" }),
        __metadata("design:type", String)
    ], UpdateBucketRequest.prototype, "sid", void 0);
...
var UpdateBucketResponse = /** @class */ (function (_super) {
    ...
    ], UpdateBucketResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.UpdateBucketResponse = UpdateBucketResponse;
