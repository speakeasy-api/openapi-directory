...
public class GetPublicItemMediaFilesQueryParams {
    /**
    ...
    public GetPublicItemMediaFilesQueryParams withDelivery(org.openapis.openapi.models.shared.MediaFileDeliveryEnum[] delivery) {
    ...
    public GetPublicItemMediaFilesQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetPublicItemMediaFilesQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetPublicItemMediaFilesQueryParams withFormats(org.openapis.openapi.models.shared.MediaFileFormatsEnum[] formats) {
    ...
    public String lang;
    public GetPublicItemMediaFilesQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetPublicItemMediaFilesQueryParams withResolution(org.openapis.openapi.models.shared.MediaFileResolutionEnum resolution) {
    ...
    public GetPublicItemMediaFilesQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetPublicItemMediaFilesQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
