...
class AdsenseAdunitsGetSecurity:
    ...
    option1: Optional[AdsenseAdunitsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[AdsenseAdunitsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
