...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteAuthorizationRequest req = new OauthAuthorizationsDeleteAuthorizationRequest(174772L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsDeleteGrantRequest req = new OauthAuthorizationsDeleteGrantRequest(316488L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetAuthorizationRequest req = new OauthAuthorizationsGetAuthorizationRequest(389135L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetGrantRequest req = new OauthAuthorizationsGetGrantRequest(246535L);            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppRequestBody("a") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest req = new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequest(                new OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprintRequestBody("adipisci") {{
                                note = "Update all gems";
                                noteUrl = "eveniet";
                                scopes = new String[]{{
                                    add("consequuntur"),
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            OauthAuthorizationsUpdateAuthorizationRequest req = new OauthAuthorizationsUpdateAuthorizationRequest(878493L) {{
