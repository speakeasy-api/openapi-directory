...
export class Config {
  ...
  requestAlgorithms(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/policies/algorithms";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.RequestAlgorithmsResponse =
        new operations.RequestAlgorithmsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.algorithmVersionInfoList = utils.objectToClass(
              httpRes?.data,
              shared.AlgorithmVersionInfoList
            );
          }
          break;
  ...
  requestClassificationPoliciesConfigInfo(
    req: operations.RequestClassificationPoliciesConfigInfoRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.RequestClassificationPoliciesConfigInfoResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.RequestClassificationPoliciesConfigInfoRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/policies/classifications";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestClassificationPoliciesConfigInfoResponse =
        new operations.RequestClassificationPoliciesConfigInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  requestCurrentProductPackages(
    req: operations.RequestCurrentProductPackagesRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.RequestCurrentProductPackagesResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.RequestCurrentProductPackagesRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/product_packages/current";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestCurrentProductPackagesResponse =
        new operations.RequestCurrentProductPackagesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.productPackageResponseList = utils.objectToClass(
              httpRes?.data,
              shared.ProductPackageResponseList
            );
          }
          break;
        case [401, 406, 412].includes(httpRes?.status):
  ...
  requestGeneralSettingsInfo(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestGeneralSettingsInfoResponse =
        new operations.RequestGeneralSettingsInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.generalSettingsInfo = utils.objectToClass(
              httpRes?.data,
              shared.GeneralSettingsInfo
            );
          }
          break;
        case [401, 406, 412].includes(httpRes?.status):
  ...
  requestGuestUsersPoliciesConfigInfo(
    req: operations.RequestGuestUsersPoliciesConfigInfoRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.RequestGuestUsersPoliciesConfigInfoResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.RequestGuestUsersPoliciesConfigInfoRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/policies/guest_users";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestGuestUsersPoliciesConfigInfoResponse =
        new operations.RequestGuestUsersPoliciesConfigInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  requestInfrastructurePropertiesInfo(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/infrastructure";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestInfrastructurePropertiesInfoResponse =
        new operations.RequestInfrastructurePropertiesInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.infrastructureProperties = utils.objectToClass(
              httpRes?.data,
              shared.InfrastructureProperties
            );
          }
          break;
        case [401, 406, 412].includes(httpRes?.status):
  ...
  requestNotificationChannelsInfo(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/notifications/channels";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestNotificationChannelsInfoResponse =
        new operations.RequestNotificationChannelsInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  requestPasswordPoliciesConfigInfo(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/policies/passwords";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestPasswordPoliciesConfigInfoResponse =
        new operations.RequestPasswordPoliciesConfigInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  requestProductPackages(
    req: operations.RequestProductPackagesRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.RequestProductPackagesResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.RequestProductPackagesRequest(req);
    }

    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v4/config/info/product_packages";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestProductPackagesResponse =
        new operations.RequestProductPackagesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  requestS3TagsInfo(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestS3TagsInfoResponse =
        new operations.RequestS3TagsInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  requestSystemDefaultsInfo(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestSystemDefaultsInfoResponse =
        new operations.RequestSystemDefaultsInfoResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.systemDefaults = utils.objectToClass(
              httpRes?.data,
              shared.SystemDefaults
            );
          }
          break;
        case [401, 406, 412].includes(httpRes?.status):
  ...
  requestSystemSettings(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RequestSystemSettingsResponse =
        new operations.RequestSystemSettingsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.configOptionList = utils.objectToClass(
              httpRes?.data,
              shared.ConfigOptionList
            );
          }
          break;
        case [401, 406, 412].includes(httpRes?.status):
  ...
  updateSystemSettings(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.UpdateSystemSettingsResponse =
        new operations.UpdateSystemSettingsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
