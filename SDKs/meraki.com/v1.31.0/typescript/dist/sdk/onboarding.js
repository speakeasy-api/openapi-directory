...
var Onboarding = /** @class */ (function () {
     ...
     * Imports event logs related to the onboarding app into elastisearch
     */
    Onboarding.prototype.createOrganizationInventoryOnboardingCloudMonitoringExportEvent = function (req, config) {
        var _a;
     ...
     * Commits the import operation to complete the onboarding of a device into Dashboard for monitoring.
     */
    Onboarding.prototype.createOrganizationInventoryOnboardingCloudMonitoringImport = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     * Check the status of a committed Import operation
     */
    Onboarding.prototype.getOrganizationInventoryOnboardingCloudMonitoringImports = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
     ...
     * Returns list of networks eligible for adding cloud monitored device
     */
    Onboarding.prototype.getOrganizationInventoryOnboardingCloudMonitoringNetworks = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
