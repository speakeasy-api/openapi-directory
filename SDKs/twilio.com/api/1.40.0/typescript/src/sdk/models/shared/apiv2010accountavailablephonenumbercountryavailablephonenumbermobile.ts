 ...
 */
export class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobileCapabilities extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "fax" })
  fax?: boolean;
...
export class ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile extends SpeakeasyBase {
  /**
