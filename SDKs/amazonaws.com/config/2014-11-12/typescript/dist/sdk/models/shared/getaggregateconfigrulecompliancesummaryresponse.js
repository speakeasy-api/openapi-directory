...
var GetAggregateConfigRuleComplianceSummaryResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: aggregatecompliancecount_1.AggregateComplianceCount }),
        (0, class_transformer_1.Expose)({ name: "AggregateComplianceCounts" }),
        (0, class_transformer_1.Type)(function () { return aggregatecompliancecount_1.AggregateComplianceCount; }),
