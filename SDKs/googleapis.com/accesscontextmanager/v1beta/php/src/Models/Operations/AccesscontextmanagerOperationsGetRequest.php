...
class AccesscontextmanagerOperationsGetRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AccesscontextmanagerOperationsGetAccessLevelFormatEnum $accessLevelFormat
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=accessLevelFormat')]
    public ?AccesscontextmanagerOperationsGetAccessLevelFormatEnum $accessLevelFormat = null;
