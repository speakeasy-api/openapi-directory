...
export class BaremetalsolutionProjectsLocationsProvisioningQuotasListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsProvisioningQuotasListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BaremetalsolutionProjectsLocationsProvisioningQuotasListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
