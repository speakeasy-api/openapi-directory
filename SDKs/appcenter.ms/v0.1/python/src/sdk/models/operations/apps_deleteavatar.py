...
class AppsDeleteAvatarSecurity:
    
    api_token: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'X-API-Token' }})  
    

@dataclasses.dataclass
class AppsDeleteAvatarRequest:
...
class AppsDeleteAvatarDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
@dataclasses.dataclass
class AppsDeleteAvatarDefaultApplicationJSONError:
    
    code: AppsDeleteAvatarDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsDeleteAvatarDefaultApplicationJSON:
    r"""Error"""
    
    error: AppsDeleteAvatarDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsDeleteAvatar200ApplicationJSONAzureSubscription:
...
class AppsDeleteAvatar200ApplicationJSONMemberPermissionsEnum(str, Enum):
    MANAGER = 'manager'
    DEVELOPER = 'developer'
    VIEWER = 'viewer'
    TESTER = 'tester'

class AppsDeleteAvatar200ApplicationJSONOriginEnum(str, Enum):
    r"""The creation origin of this app"""
    APPCENTER = 'appcenter'
    HOCKEYAPP = 'hockeyapp'
    CODEPUSH = 'codepush'

class AppsDeleteAvatar200ApplicationJSONOsEnum(str, Enum):
...
class AppsDeleteAvatar200ApplicationJSONOwnerTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsDeleteAvatar200ApplicationJSONOwner:
    ...
    type: AppsDeleteAvatar200ApplicationJSONOwnerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The owner type. Can either be 'org' or 'user'"""  
...
class AppsDeleteAvatar200ApplicationJSONPlatformEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsDeleteAvatar200ApplicationJSON:
    r"""Success"""
    ...
    origin: AppsDeleteAvatar200ApplicationJSONOriginEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin') }})
    r"""The creation origin of this app"""  
    os: AppsDeleteAvatar200ApplicationJSONOsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('os') }})
    r"""The OS the app will be running on"""  
    owner: AppsDeleteAvatar200ApplicationJSONOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The information about the app's owner"""  
    platform: AppsDeleteAvatar200ApplicationJSONPlatformEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform') }})
    r"""The platform of the app"""  
    azure_subscription: Optional[AppsDeleteAvatar200ApplicationJSONAzureSubscription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('azure_subscription'), 'exclude': lambda f: f is None }})  
    ...
    member_permissions: Optional[list[AppsDeleteAvatar200ApplicationJSONMemberPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('member_permissions'), 'exclude': lambda f: f is None }})
...
class AppsDeleteAvatarResponse:
    ...
    apps_delete_avatar_200_application_json_object: Optional[AppsDeleteAvatar200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    apps_delete_avatar_default_application_json_object: Optional[AppsDeleteAvatarDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
