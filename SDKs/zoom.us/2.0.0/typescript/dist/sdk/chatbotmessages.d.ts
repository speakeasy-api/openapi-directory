...
export declare class ChatbotMessages {
    ...
    **/
    deleteAChatbotMessage(req: operations.DeleteAChatbotMessageRequest, config?: AxiosRequestConfig): Promise<operations.DeleteAChatbotMessageResponse>;
    /**
     ...
     * Learn more about how to authotize chatbots in the [Chatbot Authorization](https://marketplace.zoom.us/docs/guides/chatbots/authorization) guide.
    **/
    editChatbotMessage(req: operations.EditChatbotMessageRequest, config?: AxiosRequestConfig): Promise<operations.EditChatbotMessageResponse>;
    /**
    ...
    **/
    sendchatbot(req: operations.SendchatbotRequest, config?: AxiosRequestConfig): Promise<operations.SendchatbotResponse>;
}
