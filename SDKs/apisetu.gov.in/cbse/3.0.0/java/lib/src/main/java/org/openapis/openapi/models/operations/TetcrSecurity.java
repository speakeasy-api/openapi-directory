...
public class TetcrSecurity {
    ...
    public TetcrSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public TetcrSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public TetcrSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
