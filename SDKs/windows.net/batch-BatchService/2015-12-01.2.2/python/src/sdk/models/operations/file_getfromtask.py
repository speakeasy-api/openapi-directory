...
class FileGetFromTaskRequest:
    headers: FileGetFromTaskHeaders = dataclasses.field()
    path_params: FileGetFromTaskPathParams = dataclasses.field()
    query_params: FileGetFromTaskQueryParams = dataclasses.field()
...
class FileGetFromTaskResponse:
    ...
    file_get_from_task_200_application_json_binary_string: Optional[bytes] = dataclasses.field(default=None)
