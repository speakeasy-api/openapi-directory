...
func (e EnrolledServiceEnrollmentLevelEnum) ToPointer() *EnrolledServiceEnrollmentLevelEnum {
	return &e
}
...
func (e *EnrolledServiceEnrollmentLevelEnum) UnmarshalJSON(data []byte) error {
	...
	case "ENROLLMENT_LEVEL_UNSPECIFIED":
		fallthrough
	case "BLOCK_ALL":
		*e = EnrolledServiceEnrollmentLevelEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EnrolledServiceEnrollmentLevelEnum: %v", v)
	}
}
