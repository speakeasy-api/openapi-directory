...
class GetRebootClusterQueryParams:
    action: GetRebootClusterActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cluster_identifier: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ClusterIdentifier', 'style': 'form', 'explode': True }})
    version: GetRebootClusterVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRebootClusterRequest:
    headers: GetRebootClusterHeaders = dataclasses.field()
    query_params: GetRebootClusterQueryParams = dataclasses.field()
