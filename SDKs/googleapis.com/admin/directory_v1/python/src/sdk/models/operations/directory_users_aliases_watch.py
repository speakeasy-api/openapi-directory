...
class DirectoryUsersAliasesWatchSecurity:
    ...
    option1: Optional[DirectoryUsersAliasesWatchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DirectoryUsersAliasesWatchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option3: Optional[DirectoryUsersAliasesWatchSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option4: Optional[DirectoryUsersAliasesWatchSecurityOption4] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DirectoryUsersAliasesWatchRequest:
    ...
    r"""Email or immutable ID of the user"""  
    ...
    event: Optional[DirectoryUsersAliasesWatchEventEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'event', 'style': 'form', 'explode': True }})
    r"""Events to watch for."""  
