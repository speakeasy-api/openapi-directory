...
public class RegionTargetHttpsProxies {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsResponse computeRegionTargetHttpsProxiesTestIamPermissions(org.openapis.openapi.models.operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsPathParams.class, baseUrl, "/projects/{project}/regions/{region}/targetHttpsProxies/{resource}/testIamPermissions", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
