...
class CreateRateBasedRuleRequest:
    ...
    create_rate_based_rule_request: shared_createratebasedrulerequest.CreateRateBasedRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
