...
export declare class Licenses {
     ...
     * Get a license
     *
     * @see {@link https://docs.github.com/enterprise-server@3.6/rest/reference/licenses#get-a-license} - API method documentation
     */
    licensesGet(req: operations.LicensesGetRequest, config?: AxiosRequestConfig): Promise<operations.LicensesGetResponse>;
    /**
     * Get all commonly used licenses
     *
     * @see {@link https://docs.github.com/enterprise-server@3.6/rest/reference/licenses#get-all-commonly-used-licenses} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.6/rest/reference/licenses/#get-the-license-for-a-repository} - API method documentation
     */
