...
class DriveFilesModifyLabelsRequest:
    ...
    r"""The ID of the file for which the labels are modified."""  
    ...
    modify_labels_request: Optional[shared_modifylabelsrequest.ModifyLabelsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
