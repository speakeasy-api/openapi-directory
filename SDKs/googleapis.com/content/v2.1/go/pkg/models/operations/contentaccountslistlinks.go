...
type ContentAccountsListlinksSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentAccountsListlinksPathParams struct {
...
type ContentAccountsListlinksQueryParams struct {
	// V1 error format.
...
type ContentAccountsListlinksRequest struct {
...
type ContentAccountsListlinksResponse struct {
	// Successful response
