...
var Inventory = /** @class */ (function () {
     ...
     */
    Inventory.prototype.getInventory = function (req, security, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.itemInventoryArrayV2 = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetInventoryItemInventoryArrayV2);
                    }
                    break;
