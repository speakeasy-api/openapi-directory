...
from ..shared import tppmessage405_ais as shared_tppmessage405_ais
...
class Error405NgAis:
    ...
    tpp_messages: Optional[list[shared_tppmessage405_ais.TppMessage405Ais]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
