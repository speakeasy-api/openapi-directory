...
exports.GetProjectsResponse = exports.GetProjectsRequest = exports.GetProjectsQueryParams = exports.GetProjectsOrderByEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var GetProjectsOrderByEnum;
(function (GetProjectsOrderByEnum) {
    GetProjectsOrderByEnum["Id"] = "id";
    GetProjectsOrderByEnum["Status"] = "status";
    GetProjectsOrderByEnum["Delivery"] = "delivery";
    GetProjectsOrderByEnum["Price"] = "price";
})(GetProjectsOrderByEnum = exports.GetProjectsOrderByEnum || (exports.GetProjectsOrderByEnum = {}));
var GetProjectsQueryParams = /** @class */ (function (_super) {
    ...
    ], GetProjectsQueryParams.prototype, "orderBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=order_type" }),
        __metadata("design:type", String)
    ], GetProjectsQueryParams.prototype, "orderType", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=with_completed" }),
        __metadata("design:type", Boolean)
    ], GetProjectsQueryParams.prototype, "withCompleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=with_pending" }),
        __metadata("design:type", Boolean)
    ], GetProjectsQueryParams.prototype, "withPending", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=with_started" }),
        __metadata("design:type", Boolean)
    ], GetProjectsQueryParams.prototype, "withStarted", void 0);
...
var GetProjectsResponse = /** @class */ (function (_super) {
    ...
    ], GetProjectsResponse.prototype, "projectList", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
