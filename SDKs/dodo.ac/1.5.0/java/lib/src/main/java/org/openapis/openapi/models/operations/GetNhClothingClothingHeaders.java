...
public class GetNhClothingClothingHeaders {
    /**
    ...
    public GetNhClothingClothingHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhClothingClothingHeaders withXApiKey(String xApiKey) {
