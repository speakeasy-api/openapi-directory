...
var Genres = /** @class */ (function () {
    function Genres(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Genres.prototype.genresList = function (req, config) {
    ...
    **/
    Genres.prototype.genresRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
