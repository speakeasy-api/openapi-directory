 ...
 */
export class ImportImageRequestDiskContainers extends SpeakeasyBase {
  @SpeakeasyMetadata()
  description?: string;
 ...
 */
export enum ImportImageRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class ImportImageRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class ImportImageRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: ImportImageRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: ImportImageRequestTagSpecificationsTags })
  tags?: ImportImageRequestTagSpecificationsTags[];
}

export class ImportImageRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  architecture?: string;
  ...
  @SpeakeasyMetadata({ elemType: ImportImageRequestDiskContainers })
  ...
  @SpeakeasyMetadata({ elemType: ImportImageLicenseSpecificationListRequest })
  ...
  @SpeakeasyMetadata({ elemType: ImportImageRequestTagSpecifications })
