...
export const ListInteractionServerList = ["https://proxy.twilio.com"] as const;
...
export class ListInteractionListInteractionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.ProxyV1ServiceSessionInteraction })
  @Expose({ name: "interactions" })
  @Type(() => shared.ProxyV1ServiceSessionInteraction)
  interactions?: shared.ProxyV1ServiceSessionInteraction[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListInteractionListInteractionResponseMeta)
