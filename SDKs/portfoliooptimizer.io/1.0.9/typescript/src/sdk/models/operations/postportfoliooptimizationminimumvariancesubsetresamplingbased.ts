...
export class PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodySubsetPortfoliosAggregationMethodEnum {
  Average = "average",
  Median = "median",
}
 ...
 */
export enum PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodySubsetPortfoliosEnumerationMethodEnum {
  Complete = "complete",
  RandomSampling = "randomSampling",
}

export class PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBody extends SpeakeasyBase {
  /**
  ...
  @Type(
    () =>
      PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints
  )
 ...
 * OK
 */
export class PostPortfolioOptimizationMinimumVarianceSubsetResamplingBased200ApplicationJSON extends SpeakeasyBase {
  /**
...
export class PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
