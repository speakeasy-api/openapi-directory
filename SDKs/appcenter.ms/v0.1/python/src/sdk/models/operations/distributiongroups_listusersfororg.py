...
@dataclasses.dataclass
class DistributionGroupsListUsersForOrgRequest:
...
class DistributionGroupsListUsersForOrgDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
class DistributionGroupsListUsersForOrgDefaultApplicationJSONError:
    ...
    code: DistributionGroupsListUsersForOrgDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class DistributionGroupsListUsersForOrgDefaultApplicationJSON:
    ...
    error: DistributionGroupsListUsersForOrgDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class DistributionGroupsListUsersForOrg200ApplicationJSON:
...
@dataclasses.dataclass
class DistributionGroupsListUsersForOrgResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    distribution_groups_list_users_for_org_200_application_json_objects: Optional[list[DistributionGroupsListUsersForOrg200ApplicationJSON]] = dataclasses.field(default=None)
    r"""Success"""  
    distribution_groups_list_users_for_org_default_application_json_object: Optional[DistributionGroupsListUsersForOrgDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error"""  
