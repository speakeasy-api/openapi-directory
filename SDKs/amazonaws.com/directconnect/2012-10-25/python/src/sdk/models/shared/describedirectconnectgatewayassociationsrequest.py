...
class DescribeDirectConnectGatewayAssociationsRequest:
    ...
    associated_gateway_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('associatedGatewayId'), 'exclude': lambda f: f is None }})  
