...
func (e ListOpsMetadataXAmzTargetEnum) ToPointer() *ListOpsMetadataXAmzTargetEnum {
	return &e
}
...
func (e *ListOpsMetadataXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.ListOpsMetadata":
		*e = ListOpsMetadataXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListOpsMetadataXAmzTargetEnum: %v", v)
	}
}

type ListOpsMetadataRequest struct {
	ListOpsMetadataRequest shared.ListOpsMetadataRequest `request:"mediaType=application/json"`
	// Pagination limit
