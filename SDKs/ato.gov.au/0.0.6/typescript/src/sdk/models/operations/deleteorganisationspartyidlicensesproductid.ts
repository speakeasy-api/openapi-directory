...
export class DeleteOrganisationsPartyIdLicensesProductIdRequest extends SpeakeasyBase {
  /**
   * The API key.
   */
...
export class DeleteOrganisationsPartyIdLicensesProductIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
