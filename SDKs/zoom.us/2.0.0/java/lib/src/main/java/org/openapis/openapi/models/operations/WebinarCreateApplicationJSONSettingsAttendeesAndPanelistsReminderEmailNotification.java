...
public class WebinarCreateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotification {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public WebinarCreateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum type;
    public WebinarCreateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotification withType(WebinarCreateApplicationJSONSettingsAttendeesAndPanelistsReminderEmailNotificationTypeEnum type) {
        this.type = type;
        return this;
    }
