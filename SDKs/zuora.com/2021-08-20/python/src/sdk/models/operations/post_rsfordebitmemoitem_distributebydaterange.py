...
from ..shared import postrevenueschedulebytransactionratablydmtype as shared_postrevenueschedulebytransactionratablydmtype
...
class POSTRSforDebitMemoItemDistributeByDateRangeRequest:
    ...
    post_revenue_schedule_by_transaction_ratably_dm_type: shared_postrevenueschedulebytransactionratablydmtype.POSTRevenueScheduleByTransactionRatablyDMType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
