...
var AccountSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dr-callback-url" }),
        __metadata("design:type", String)
    ], AccountSettings.prototype, "drCallbackUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max-calls-per-second" }),
        __metadata("design:type", Number)
    ], AccountSettings.prototype, "maxCallsPerSecond", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max-inbound-request" }),
        __metadata("design:type", Number)
    ], AccountSettings.prototype, "maxInboundRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=max-outbound-request" }),
        __metadata("design:type", Number)
    ], AccountSettings.prototype, "maxOutboundRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mo-callback-url" }),
        __metadata("design:type", String)
