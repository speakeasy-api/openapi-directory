...
class HiuSubscriptionRequestNotificationAcknowledgementAcknowledgement:
    status: HiuSubscriptionRequestNotificationAcknowledgementAcknowledgementStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    subscription_request_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('subscriptionRequestId') }})
...
class HiuSubscriptionRequestNotificationAcknowledgement:
    ...
    acknowledgement: Optional[HiuSubscriptionRequestNotificationAcknowledgementAcknowledgement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
