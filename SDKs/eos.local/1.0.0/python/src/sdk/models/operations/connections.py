...
class Connections200ApplicationJSON:
    ...
    last_handshake: Optional[Connections200ApplicationJSONLastHandshake] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('last_handshake') }})
