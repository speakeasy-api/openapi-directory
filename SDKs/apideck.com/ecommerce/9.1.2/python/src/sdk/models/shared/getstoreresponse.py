...
import dataclasses
from ..shared import ecommercestore as shared_ecommercestore
...
class GetStoreResponse:
    ...
    data: shared_ecommercestore.EcommerceStore = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
