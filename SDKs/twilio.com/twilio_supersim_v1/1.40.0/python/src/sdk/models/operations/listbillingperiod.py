...
class ListBillingPeriodRequest:
    ...
    r"""The SID of the Super SIM to list Billing Periods for."""  
...
class ListBillingPeriodListBillingPeriodResponse:
    ...
    billing_periods: Optional[list[shared_supersim_v1_sim_billing_period.SupersimV1SimBillingPeriod]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('billing_periods'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListBillingPeriodListBillingPeriodResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
