...
exports.AdsenseCustomchannelsGetResponse = exports.AdsenseCustomchannelsGetRequest = exports.AdsenseCustomchannelsGetSecurity = exports.AdsenseCustomchannelsGetSecurityOption2 = exports.AdsenseCustomchannelsGetSecurityOption1 = void 0;
...
exports.AdsenseCustomchannelsGetSecurityOption1 = AdsenseCustomchannelsGetSecurityOption1;
...
exports.AdsenseCustomchannelsGetSecurityOption2 = AdsenseCustomchannelsGetSecurityOption2;
...
exports.AdsenseCustomchannelsGetSecurity = AdsenseCustomchannelsGetSecurity;
var AdsenseCustomchannelsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "adClientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=customChannelId",
        }),
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "customChannelId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsenseCustomchannelsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsenseCustomchannelsGetRequest.prototype, "userIp", void 0);
    return AdsenseCustomchannelsGetRequest;
}(utils_1.SpeakeasyBase));
exports.AdsenseCustomchannelsGetRequest = AdsenseCustomchannelsGetRequest;
var AdsenseCustomchannelsGetResponse = /** @class */ (function (_super) {
    ...
    ], AdsenseCustomchannelsGetResponse.prototype, "rawResponse", void 0);
    return AdsenseCustomchannelsGetResponse;
}(utils_1.SpeakeasyBase));
exports.AdsenseCustomchannelsGetResponse = AdsenseCustomchannelsGetResponse;
