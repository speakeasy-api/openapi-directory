...
export class AndroidpublisherEditsListingsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AndroidpublisherEditsListingsUpdateRequest extends SpeakeasyBase {
...
export class AndroidpublisherEditsListingsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
