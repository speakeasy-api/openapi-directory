...
public class ArticleGetReservedAmountQueryParams {
    /**
     * The id or the sku of the article to query
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=id")
    public String id;
    public ArticleGetReservedAmountQueryParams withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ArticleGetReservedAmountQueryParams withLookupBy(String lookupBy) {
    ...
    public Long stockId;
    public ArticleGetReservedAmountQueryParams withStockId(Long stockId) {
