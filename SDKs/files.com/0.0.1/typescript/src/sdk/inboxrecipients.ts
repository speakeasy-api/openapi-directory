  ...
  **/
  getInboxRecipients(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetInboxRecipientsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  postInboxRecipients(
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostInboxRecipientsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
