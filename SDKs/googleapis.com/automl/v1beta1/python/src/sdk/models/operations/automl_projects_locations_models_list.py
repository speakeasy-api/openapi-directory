...
class AutomlProjectsLocationsModelsListRequest:
    ...
    r"""Required. Resource name of the project, from which to list the models."""  
    ...
    r"""A token identifying a page of results for the server to return Typically obtained via ListModelsResponse.next_page_token of the previous AutoMl.ListModels call."""  
