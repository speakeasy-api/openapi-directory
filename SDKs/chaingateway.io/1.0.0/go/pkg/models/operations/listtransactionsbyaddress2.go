...
type Listtransactionsbyaddress2Request struct {
	// account address
...
type Listtransactionsbyaddress2200ApplicationJSONDataMetaAccountedFor struct {
...
type Listtransactionsbyaddress2200ApplicationJSONDataMetaNamedTo0xa57bd00134b2850b2a1c55860c9e9ea100fdd6cf struct {
...
type Listtransactionsbyaddress2200ApplicationJSONDataMetaNamedTo struct {
	Zeroxa57bd00134b2850b2a1c55860c9e9ea100fdd6cf *Listtransactionsbyaddress2200ApplicationJSONDataMetaNamedTo0xa57bd00134b2850b2a1c55860c9e9ea100fdd6cf `json:"0xa57bd00134b2850b2a1c55860c9e9ea100fdd6cf,omitempty"`
}

type Listtransactionsbyaddress2200ApplicationJSONDataMetaUnNamedFrom struct {
...
type Listtransactionsbyaddress2200ApplicationJSONDataMetaUnNamedTo struct {
...
type Listtransactionsbyaddress2200ApplicationJSONDataMeta struct {
	AccountedFor *Listtransactionsbyaddress2200ApplicationJSONDataMetaAccountedFor `json:"accountedFor,omitempty"`
	...
	NamedTo      *Listtransactionsbyaddress2200ApplicationJSONDataMetaNamedTo      `json:"namedTo,omitempty"`
	NetworkID    *float64                                                          `json:"networkId,omitempty"`
	Ripe         *float64                                                          `json:"ripe,omitempty"`
	Staging      *float64                                                          `json:"staging,omitempty"`
	UnNamedFrom  *Listtransactionsbyaddress2200ApplicationJSONDataMetaUnNamedFrom  `json:"unNamedFrom,omitempty"`
	UnNamedTo    *Listtransactionsbyaddress2200ApplicationJSONDataMetaUnNamedTo    `json:"unNamedTo,omitempty"`
	Unripe       *float64                                                          `json:"unripe,omitempty"`
}

type Listtransactionsbyaddress2200ApplicationJSONDataTransactionsReceipt struct {
...
type Listtransactionsbyaddress2200ApplicationJSONDataTransactions struct {
	...
	Receipt              *Listtransactionsbyaddress2200ApplicationJSONDataTransactionsReceipt `json:"receipt,omitempty"`
...
type Listtransactionsbyaddress2200ApplicationJSONData struct {
	CurrentPage  *float64                                                       `json:"current_page,omitempty"`
	MaxPages     *float64                                                       `json:"max_pages,omitempty"`
	Meta         *Listtransactionsbyaddress2200ApplicationJSONDataMeta          `json:"meta,omitempty"`
	Transactions []Listtransactionsbyaddress2200ApplicationJSONDataTransactions `json:"transactions,omitempty"`
}

// Listtransactionsbyaddress2200ApplicationJSON - 200
type Listtransactionsbyaddress2200ApplicationJSON struct {
	Data    *Listtransactionsbyaddress2200ApplicationJSONData `json:"data,omitempty"`
	Message *string                                           `json:"message,omitempty"`
	Ok      *bool                                             `json:"ok,omitempty"`
	Status  *float64                                          `json:"status,omitempty"`
}

type Listtransactionsbyaddress2Response struct {
	ContentType string
	Headers     map[string][]string
	StatusCode  int
	RawResponse *http.Response
	// 200
	Listtransactionsbyaddress2200ApplicationJSONObject *Listtransactionsbyaddress2200ApplicationJSON
}
