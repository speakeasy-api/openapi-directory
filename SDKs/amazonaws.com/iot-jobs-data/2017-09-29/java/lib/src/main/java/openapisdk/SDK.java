...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.GetPendingJobExecutionsResponse getPendingJobExecutions(openapisdk.models.operations.GetPendingJobExecutionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        ...
        openapisdk.models.operations.GetPendingJobExecutionsResponse res = new openapisdk.models.operations.GetPendingJobExecutionsResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetPendingJobExecutionsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetPendingJobExecutionsResponse.class);
    ...
    **/
    public openapisdk.models.operations.StartNextPendingJobExecutionResponse startNextPendingJobExecution(openapisdk.models.operations.StartNextPendingJobExecutionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/things/{thingName}/jobs/$next", request.pathParams);
        ...
        openapisdk.models.operations.StartNextPendingJobExecutionResponse res = new openapisdk.models.operations.StartNextPendingJobExecutionResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.StartNextPendingJobExecutionResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.StartNextPendingJobExecutionResponse.class);
    ...
    **/
    public openapisdk.models.operations.UpdateJobExecutionResponse updateJobExecution(openapisdk.models.operations.UpdateJobExecutionRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/things/{thingName}/jobs/{jobId}", request.pathParams);
        ...
        openapisdk.models.operations.UpdateJobExecutionResponse res = new openapisdk.models.operations.UpdateJobExecutionResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateJobExecutionResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateJobExecutionResponse.class);
