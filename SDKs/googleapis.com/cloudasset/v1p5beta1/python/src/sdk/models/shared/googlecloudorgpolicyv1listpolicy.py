...
class GoogleCloudOrgpolicyV1ListPolicy:
    ...
    all_values: Optional[GoogleCloudOrgpolicyV1ListPolicyAllValuesEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('allValues') }})
