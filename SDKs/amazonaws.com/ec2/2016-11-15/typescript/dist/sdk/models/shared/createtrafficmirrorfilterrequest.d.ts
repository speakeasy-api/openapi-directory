 ...
 */
export declare enum CreateTrafficMirrorFilterRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTrafficMirrorFilterRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTrafficMirrorFilterRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTrafficMirrorFilterRequest extends SpeakeasyBase {
    clientToken?: string;
    description?: string;
    dryRun?: boolean;
