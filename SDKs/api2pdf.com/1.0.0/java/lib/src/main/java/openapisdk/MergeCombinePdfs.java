...
public class MergeCombinePdfs {
    ...
    **/
    public openapisdk.models.operations.MergePostResponse mergePost(openapisdk.models.operations.MergePostRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/merge");
        ...
        openapisdk.models.operations.MergePostResponse res = new openapisdk.models.operations.MergePostResponse() {{
