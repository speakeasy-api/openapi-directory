...
class ListChannelListChannelResponse:
    ...
    channels: Optional[list[shared_ip_messaging_v1_service_channel.IPMessagingV1ServiceChannel]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('channels'), 'exclude': lambda f: f is None }})  
