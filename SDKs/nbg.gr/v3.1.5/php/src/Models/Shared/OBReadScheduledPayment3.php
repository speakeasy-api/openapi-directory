...
class OBReadScheduledPayment3
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBReadDataScheduledPayment3')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBReadDataScheduledPayment3();
		$this->links = null;
		$this->meta = null;
	}
}
