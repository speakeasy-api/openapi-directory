...
var VerifyAccount = /** @class */ (function () {
    function VerifyAccount(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VerifyAccount.prototype.initiateAccountVerification = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.InitiateAccountVerificationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/verifyAccount/{providerAccountId}", req.pathParams);
