 ...
 */
export declare class DescribeInstanceCreditSpecificationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeInstanceCreditSpecificationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeInstanceCreditSpecificationsRequestFilters[];
    instanceIds?: string[];
    maxResults?: number;
    nextToken?: string;
}
