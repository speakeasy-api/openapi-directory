 ...
 */
export declare enum GetLabelByExternalShipmentIdResponseBodyDisplaySchemeEnum {
    Label = "label",
    QrCode = "qr_code",
 ...
 *
 */
export declare enum GetLabelByExternalShipmentIdResponseBodyLabelFormatEnum {
    Pdf = "pdf",
    Png = "png",
    Zpl = "zpl"
}
 ...
 *
 */
export declare enum GetLabelByExternalShipmentIdResponseBodyLabelLayoutEnum {
    Fourx6 = "4x6",
    Letter = "letter"
}
/**
 ...
 *
 */
export declare enum GetLabelByExternalShipmentIdResponseBodyLabelStatusEnum {
 ...
 */
export declare enum GetLabelByExternalShipmentIdResponseBodyTrackingStatusEnum {
    Unknown = "unknown",
...
export declare class GetLabelByExternalShipmentIdResponseBodyOutput extends SpeakeasyBase {
     ...
     * The display format that the label should be shown in.
     */
    displayScheme?: GetLabelByExternalShipmentIdResponseBodyDisplaySchemeEnum;
    /**
     ...
     *
     */
    labelFormat?: GetLabelByExternalShipmentIdResponseBodyLabelFormatEnum;
    /**
     ...
     *
     */
    labelLayout?: GetLabelByExternalShipmentIdResponseBodyLabelLayoutEnum;
    /**
     ...
     */
    shipmentId?: string;
    status?: GetLabelByExternalShipmentIdResponseBodyLabelStatusEnum;
    /**
     ...
     */
    trackingStatus?: GetLabelByExternalShipmentIdResponseBodyTrackingStatusEnum;
    /**
