...
var Projects = /** @class */ (function () {
     ...
     */
    Projects.prototype.cloudprofilerProjectsProfilesCreate = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudprofilerProjectsProfilesCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/{parent}/profiles", req);
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.CloudprofilerProjectsProfilesCreateSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CloudprofilerProjectsProfilesCreateResponse({
     ...
     */
    Projects.prototype.cloudprofilerProjectsProfilesCreateOffline = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudprofilerProjectsProfilesCreateOfflineRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v2/{parent}/profiles:createOffline", req);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security =
                new operations.CloudprofilerProjectsProfilesCreateOfflineSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        var headers = __assign(__assign({}, reqBodyHeaders), config === null || config === void 0 ? void 0 : config.headers);
        var queryParams = utils.serializeQueryParams(req);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.CloudprofilerProjectsProfilesCreateOfflineResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    Projects.prototype.cloudprofilerProjectsProfilesPatch = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.CloudprofilerProjectsProfilesPatchSecurity(security);
        }
        var client = utils.createSecurityClient(this._defaultClient, security);
        var headers = __assign(__assign({}, reqBodyHeaders), config === null || config === void 0 ? void 0 : config.headers);
        var queryParams = utils.serializeQueryParams(req);
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.CloudprofilerProjectsProfilesPatchResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
