...
from ..shared import dealershipdatapaginated as shared_dealershipdatapaginated


@dataclass_json
@dataclasses.dataclass
class DealershipDataPaginatedResp:
    data: shared_dealershipdatapaginated.DealershipDataPaginated = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
