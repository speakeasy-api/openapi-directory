...
/**
 * AsrResponseGetReport - ASR
 */
public class AsrResponseGetReport {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("_links")
    public Links links;
    public AsrResponseGetReport withLinks(Links links) {
        this.links = links;
        return this;
    }
    ...
    public AsrResponseGetReport withAccountId(String accountId) {
    ...
    public AsrResponseGetReport withCallbackUrl(String callbackUrl) {
    ...
    public AsrResponseGetReport withDateEnd(LocalDate dateEnd) {
    ...
    public AsrResponseGetReport withDateStart(LocalDate dateStart) {
    ...
    public AsrResponseGetReport withDirection(DirectionEnum direction) {
    ...
    @JsonProperty("from")
    public String from;
    public AsrResponseGetReport withFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public AsrResponseGetReport withIncludeSubaccounts(IncludeSubaccountsEnum includeSubaccounts) {
    ...
    public AsrResponseGetReport withItemsCount(Long itemsCount) {
    ...
    public AsrResponseGetReport withProduct(ProductAsrEnum product) {
    ...
    public AsrResponseGetReport withReceiveTime(LocalDate receiveTime) {
    ...
    public AsrResponseGetReport withRequestId(String requestId) {
    ...
    public AsrResponseGetReport withRequestStatus(RequestStatusEnum requestStatus) {
    ...
    public AsrResponseGetReport withStartTime(LocalDate startTime) {
    ...
    public AsrResponseGetReport withStatus(AsrStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    @JsonProperty("to")
    public String to;
    public AsrResponseGetReport withTo(String to) {
        this.to = to;
        return this;
    }
