...
public class ListSimRequest {
    ...
    public String eId;
    public ListSimRequest withEId(String eId) {
        this.eId = eId;
        return this;
    }
    ...
    public ListSimRequest withRatePlan(String ratePlan) {
    ...
    public ListSimRequest withSimRegistrationCode(String simRegistrationCode) {
