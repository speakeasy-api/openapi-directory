...
exports.BatchPutGeofenceResponse = exports.BatchPutGeofenceRequest = exports.BatchPutGeofenceRequestBody = void 0;
...
var BatchPutGeofenceRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.BatchPutGeofenceRequestEntry }),
        (0, class_transformer_1.Expose)({ name: "Entries" }),
        (0, class_transformer_1.Type)(function () { return shared.BatchPutGeofenceRequestEntry; }),
        __metadata("design:type", Array)
    ], BatchPutGeofenceRequestBody.prototype, "entries", void 0);
    return BatchPutGeofenceRequestBody;
}(utils_1.SpeakeasyBase));
exports.BatchPutGeofenceRequestBody = BatchPutGeofenceRequestBody;
var BatchPutGeofenceRequest = /** @class */ (function (_super) {
    ...
    ], BatchPutGeofenceRequest.prototype, "collectionName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", BatchPutGeofenceRequestBody)
    ], BatchPutGeofenceRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], BatchPutGeofenceRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], BatchPutGeofenceRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], BatchPutGeofenceRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], BatchPutGeofenceRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], BatchPutGeofenceRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], BatchPutGeofenceRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], BatchPutGeofenceRequest.prototype, "xAmzSignedHeaders", void 0);
...
var BatchPutGeofenceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], BatchPutGeofenceResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
