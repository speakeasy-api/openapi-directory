...
public class GETAllOrdersRequest {
    ...
    public GETAllOrdersRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETAllOrdersRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETAllOrdersRequest withDateFilterOption(String dateFilterOption) {
    ...
    public GETAllOrdersRequest withEndDate(LocalDate endDate) {
    ...
    public Long page;
    public GETAllOrdersRequest withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public GETAllOrdersRequest withPageSize(Long pageSize) {
    ...
    public GETAllOrdersRequest withStartDate(LocalDate startDate) {
