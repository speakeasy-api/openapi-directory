...
class DialogflowProjectsLocationsKnowledgeBasesDocumentsPatchRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\DialogflowProjectsLocationsKnowledgeBasesDocumentsPatchUpdateMaskEnum $updateMask
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=updateMask')]
    public ?DialogflowProjectsLocationsKnowledgeBasesDocumentsPatchUpdateMaskEnum $updateMask = null;
