...
class Tokeninfo:
    ...
    issued_at: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('issued_at'), 'exclude': lambda f: f is None }})
    r"""The issue time of the token, as number of seconds."""  
