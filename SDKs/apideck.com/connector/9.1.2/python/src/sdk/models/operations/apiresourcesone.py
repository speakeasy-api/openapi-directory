...
from ..shared import getapiresourceresponse as shared_getapiresourceresponse
...
class APIResourcesOneResponse:
    ...
    get_api_resource_response: Optional[shared_getapiresourceresponse.GetAPIResourceResponse] = dataclasses.field(default=None)
    r"""ApiResources"""  
