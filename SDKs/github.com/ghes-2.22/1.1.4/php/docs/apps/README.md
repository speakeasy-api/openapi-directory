...
try {
    ...
    $request->installationId = 339404;
    $request->repositoryId = 521037;
...
try {
    ...
    $request->requestBody->accessToken = 'quis';
    $request->clientId = 'nesciunt';
...
try {
    ...
    $request->contentReferenceId = 179490;
...
try {
    ...
    $request->requestBody->accessToken = 'amet';
...
try {
    ...
    $request->requestBody->accessToken = 'veritatis';
...
try {
    ...
    $request->installationId = 179603;
    $request->page = 542499;
    $request->perPage = 24678;
...
try {
    ...
    $request->outdated = 'fugiat';
    $request->page = 67249;
    $request->perPage = 743835;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-01-16T14:59:31.978Z');
...
try {
    ...
    $request->installationId = 896672;
    $request->repositoryId = 714697;
