...
from ..shared import describefilesystemsrequest as shared_describefilesystemsrequest
...
class DescribeFileSystemsRequest:
    ...
    describe_file_systems_request: shared_describefilesystemsrequest.DescribeFileSystemsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_target: DescribeFileSystemsXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})  
