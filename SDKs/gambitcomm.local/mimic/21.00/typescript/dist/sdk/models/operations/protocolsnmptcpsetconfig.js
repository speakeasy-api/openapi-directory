...
exports.ProtocolSnmptcpSetConfigResponse = exports.ProtocolSnmptcpSetConfigRequest = void 0;
...
var ProtocolSnmptcpSetConfigRequest = /** @class */ (function (_super) {
    ...
    ], ProtocolSnmptcpSetConfigRequest.prototype, "agentNum", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=argument",
        }),
        __metadata("design:type", String)
    ], ProtocolSnmptcpSetConfigRequest.prototype, "argument", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=value",
        }),
        __metadata("design:type", String)
    ], ProtocolSnmptcpSetConfigRequest.prototype, "value", void 0);
...
var ProtocolSnmptcpSetConfigResponse = /** @class */ (function (_super) {
    ...
    ], ProtocolSnmptcpSetConfigResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
