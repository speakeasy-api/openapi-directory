...
exports.ListWorkspaceResponse = exports.ListWorkspaceListWorkspaceResponse = exports.ListWorkspaceListWorkspaceResponseMeta = exports.ListWorkspaceRequest = exports.ListWorkspaceSecurity = exports.ListWorkspaceServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListWorkspaceServerList = [
...
var ListWorkspaceSecurity = /** @class */ (function (_super) {
    ...
    ], ListWorkspaceSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListWorkspaceSecurity.prototype, "username", void 0);
    return ListWorkspaceSecurity;
}(utils_1.SpeakeasyBase));
exports.ListWorkspaceSecurity = ListWorkspaceSecurity;
var ListWorkspaceRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListWorkspaceRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListWorkspaceRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListWorkspaceRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListWorkspaceRequest.prototype, "pageToken", void 0);
    return ListWorkspaceRequest;
}(utils_1.SpeakeasyBase));
exports.ListWorkspaceRequest = ListWorkspaceRequest;
...
exports.ListWorkspaceListWorkspaceResponseMeta = ListWorkspaceListWorkspaceResponseMeta;
/**
 * OK
 */
var ListWorkspaceListWorkspaceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListWorkspaceListWorkspaceResponseMeta; }),
        __metadata("design:type", ListWorkspaceListWorkspaceResponseMeta)
    ], ListWorkspaceListWorkspaceResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TaskrouterV1Workspace }),
        (0, class_transformer_1.Expose)({ name: "workspaces" }),
        (0, class_transformer_1.Type)(function () { return shared.TaskrouterV1Workspace; }),
        __metadata("design:type", Array)
    ], ListWorkspaceListWorkspaceResponse.prototype, "workspaces", void 0);
    return ListWorkspaceListWorkspaceResponse;
}(utils_1.SpeakeasyBase));
exports.ListWorkspaceListWorkspaceResponse = ListWorkspaceListWorkspaceResponse;
var ListWorkspaceResponse = /** @class */ (function (_super) {
    ...
    ], ListWorkspaceResponse.prototype, "rawResponse", void 0);
    return ListWorkspaceResponse;
}(utils_1.SpeakeasyBase));
exports.ListWorkspaceResponse = ListWorkspaceResponse;
