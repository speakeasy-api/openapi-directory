 ...
 * 
 */
public enum AccountSettingsUpdateApplicationJSONUpdateAccountSettingsSecuritySignInWithTwoFactorAuthEnum {
    ALL("all"),
    GROUP("group"),
    ROLE("role"),
    NONE("none");
    ...
    private AccountSettingsUpdateApplicationJSONUpdateAccountSettingsSecuritySignInWithTwoFactorAuthEnum(String value) {
        this.value = value;
    }
}
