...
export declare class Assistant {
     ...
     */
    accessibility(req: shared.AccessibilityRequest, config?: AxiosRequestConfig): Promise<operations.AccessibilityResponse>;
    /**
     * Alarm Volume
     *
     * @remarks
     ...
     */
    alarmVolume(req: shared.AlarmVolumeRequest, config?: AxiosRequestConfig): Promise<operations.AlarmVolumeResponse>;
    /**
     ...
     */
    deleteAlarmsandTimers(req: shared.DeleteAlarmsandTimersRequest, config?: AxiosRequestConfig): Promise<operations.DeleteAlarmsandTimersResponse>;
    /**
     * Do Not Disturb
     *
     * @remarks
     ...
     */
    setEqualizerValues(req: shared.SetEqualizerValuesRequest, config?: AxiosRequestConfig): Promise<operations.SetEqualizerValuesResponse>;
}
