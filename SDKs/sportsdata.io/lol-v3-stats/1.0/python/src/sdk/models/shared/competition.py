...
class Competition:
    ...
    player_stats_coverage: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PlayerStatsCoverage'), 'exclude': lambda f: f is None }})  
