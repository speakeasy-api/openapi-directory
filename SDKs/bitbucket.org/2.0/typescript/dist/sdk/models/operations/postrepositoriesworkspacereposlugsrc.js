...
exports.PostRepositoriesWorkspaceRepoSlugSrcResponse = exports.PostRepositoriesWorkspaceRepoSlugSrcRequest = exports.PostRepositoriesWorkspaceRepoSlugSrcSecurity = void 0;
...
var PostRepositoriesWorkspaceRepoSlugSrcRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugSrcRequest.prototype, "author", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=branch",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugSrcRequest.prototype, "branch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=files" }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugSrcRequest.prototype, "files", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=message",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugSrcRequest.prototype, "message", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parents",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugSrcRequest.prototype, "parents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugSrcRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], PostRepositoriesWorkspaceRepoSlugSrcRequest.prototype, "workspace", void 0);
...
var PostRepositoriesWorkspaceRepoSlugSrcResponse = /** @class */ (function (_super) {
    ...
    ], PostRepositoriesWorkspaceRepoSlugSrcResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
