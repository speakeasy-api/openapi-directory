...
class GETRemoveFromGlobalClusterRequest:
    ...
    r"""The Amazon Resource Name (ARN) identifying the cluster that was detached from the Amazon DocumentDB global cluster."""  
    ...
    r"""The cluster identifier to detach from the Amazon DocumentDB global cluster."""  
