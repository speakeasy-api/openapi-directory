...
class PostDescribeNotificationConfigurationsQueryParams:
    action: PostDescribeNotificationConfigurationsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeNotificationConfigurationsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeNotificationConfigurationsRequest:
    headers: PostDescribeNotificationConfigurationsHeaders = dataclasses.field()
    query_params: PostDescribeNotificationConfigurationsQueryParams = dataclasses.field()
