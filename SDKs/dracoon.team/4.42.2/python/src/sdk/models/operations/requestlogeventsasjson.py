...
class RequestLogEventsAsJSONXSdsDateFormatEnum(str, Enum):
...
class RequestLogEventsAsJSONStatusEnum(str, Enum):
    r"""Operation status:
...
class RequestLogEventsAsJSONRequest:
    ...
    r"""Sort string"""  
    status: Optional[RequestLogEventsAsJSONStatusEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'status', 'style': 'form', 'explode': True }})
    r"""Operation status:
    ...
    * `2` - Error
    ...
    """  
    user_client: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'user_client', 'style': 'form', 'explode': True }})
    r"""User client"""  
    ...
    x_sds_date_format: Optional[RequestLogEventsAsJSONXSdsDateFormatEnum] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-Sds-Date-Format', 'style': 'simple', 'explode': False }})
    r"""Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))"""  
