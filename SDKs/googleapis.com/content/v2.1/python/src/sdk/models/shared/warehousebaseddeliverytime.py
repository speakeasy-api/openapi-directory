...
class WarehouseBasedDeliveryTime:
    ...
    r"""Required. Carrier, such as `\\"UPS\\"` or `\\"Fedex\\"`. The list of supported carriers can be retrieved through the `listSupportedCarriers` method."""  
    ...
    r"""Required. Carrier service, such as `\\"ground\\"` or `\\"2 days\\"`. The list of supported services for a carrier can be retrieved through the `listSupportedCarriers` method. The name of the service must be in the eddSupportedServices list."""  
    ...
    r"""Shipping origin's country represented as a [CLDR territory code](https://github.com/unicode-org/cldr/blob/latest/common/main/en.xml)."""  
