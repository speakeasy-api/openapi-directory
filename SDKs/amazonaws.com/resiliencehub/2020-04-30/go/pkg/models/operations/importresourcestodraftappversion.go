...
func (e ImportResourcesToDraftAppVersionRequestBodyImportStrategyEnum) ToPointer() *ImportResourcesToDraftAppVersionRequestBodyImportStrategyEnum {
	return &e
}
...
func (e *ImportResourcesToDraftAppVersionRequestBodyImportStrategyEnum) UnmarshalJSON(data []byte) error {
	...
	case "AddOnly":
		fallthrough
	case "ReplaceAll":
		*e = ImportResourcesToDraftAppVersionRequestBodyImportStrategyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ImportResourcesToDraftAppVersionRequestBodyImportStrategyEnum: %v", v)
	}
}
