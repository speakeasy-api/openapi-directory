 ...
 */
export enum InstantSnapshotListWarningCodeEnum {
...
export class InstantSnapshotListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstantSnapshotListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstantSnapshotListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class InstantSnapshotList extends SpeakeasyBase {
  /**
