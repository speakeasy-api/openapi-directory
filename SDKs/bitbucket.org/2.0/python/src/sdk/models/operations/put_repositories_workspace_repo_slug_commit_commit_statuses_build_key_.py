...
class PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyRequest:
    path_params: PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeyPathParams = dataclasses.field()
    security: PutRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildKeySecurity = dataclasses.field()
