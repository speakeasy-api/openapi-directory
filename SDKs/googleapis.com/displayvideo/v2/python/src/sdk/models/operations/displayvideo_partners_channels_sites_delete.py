...
class DisplayvideoPartnersChannelsSitesDeleteRequest:
    path_params: DisplayvideoPartnersChannelsSitesDeletePathParams = dataclasses.field()
    query_params: DisplayvideoPartnersChannelsSitesDeleteQueryParams = dataclasses.field()
    security: DisplayvideoPartnersChannelsSitesDeleteSecurity = dataclasses.field()
