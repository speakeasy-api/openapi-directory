...
func (e ListFiltersRequestBodyActionEnum) ToPointer() *ListFiltersRequestBodyActionEnum {
	return &e
}
...
func (e *ListFiltersRequestBodyActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "NONE":
		fallthrough
	case "SUPPRESS":
		*e = ListFiltersRequestBodyActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListFiltersRequestBodyActionEnum: %v", v)
	}
}
