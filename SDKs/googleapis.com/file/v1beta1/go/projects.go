...
func (s *Projects) FileProjectsLocationsBackupsCreate(ctx context.Context, request operations.FileProjectsLocationsBackupsCreateRequest) (*operations.FileProjectsLocationsBackupsCreateResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/backups", request.PathParams)
...
func (s *Projects) FileProjectsLocationsInstancesRevert(ctx context.Context, request operations.FileProjectsLocationsInstancesRevertRequest) (*operations.FileProjectsLocationsInstancesRevertResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}:revert", request.PathParams)
...
func (s *Projects) FileProjectsLocationsInstancesSharesCreate(ctx context.Context, request operations.FileProjectsLocationsInstancesSharesCreateRequest) (*operations.FileProjectsLocationsInstancesSharesCreateResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/shares", request.PathParams)
...
func (s *Projects) FileProjectsLocationsInstancesSharesList(ctx context.Context, request operations.FileProjectsLocationsInstancesSharesListRequest) (*operations.FileProjectsLocationsInstancesSharesListResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/shares", request.PathParams)
...
func (s *Projects) FileProjectsLocationsInstancesSnapshotsCreate(ctx context.Context, request operations.FileProjectsLocationsInstancesSnapshotsCreateRequest) (*operations.FileProjectsLocationsInstancesSnapshotsCreateResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/snapshots", request.PathParams)
