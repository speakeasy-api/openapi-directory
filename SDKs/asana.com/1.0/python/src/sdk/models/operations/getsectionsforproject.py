...
class GetSectionsForProject200ApplicationJSON:
    r"""Successfully retrieved sections in project."""
    
    data: Optional[list[shared_sectioncompact.SectionCompact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
