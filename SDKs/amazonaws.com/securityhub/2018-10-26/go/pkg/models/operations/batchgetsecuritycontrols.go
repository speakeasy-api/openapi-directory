...
type BatchGetSecurityControlsHeaders struct {
...
type BatchGetSecurityControlsRequest struct {
	Headers BatchGetSecurityControlsHeaders
	Request BatchGetSecurityControlsRequestBody `request:"mediaType=application/json"`
}
