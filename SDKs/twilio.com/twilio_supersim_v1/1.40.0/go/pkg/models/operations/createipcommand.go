...
func (e *CreateIPCommandCreateIPCommandRequestCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateIPCommandCreateIPCommandRequestCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateIPCommandCreateIPCommandRequestCallbackMethodEnum: %s", s)
	}
}
