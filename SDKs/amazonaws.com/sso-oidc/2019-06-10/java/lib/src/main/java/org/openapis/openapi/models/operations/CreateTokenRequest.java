...
public class CreateTokenRequest {
    ...
    public CreateTokenRequest withRequestBody(CreateTokenRequestBody requestBody) {
    ...
    public CreateTokenRequest(@JsonProperty("RequestBody") CreateTokenRequestBody requestBody) {
        this.requestBody = requestBody;
  }
}
