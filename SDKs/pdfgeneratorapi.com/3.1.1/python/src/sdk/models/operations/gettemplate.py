...
class GetTemplate401ApplicationJSON:
    error: Optional[GetTemplate401ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
...
class GetTemplate403ApplicationJSON:
    error: Optional[GetTemplate403ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    status: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class GetTemplate404ApplicationJSON:
    error: Optional[GetTemplate404ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    status: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class GetTemplate422ApplicationJSON:
    error: Optional[GetTemplate422ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    status: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class GetTemplateRequest:
    query_params: GetTemplateQueryParams = dataclasses.field()
...
class GetTemplateResponse:
    ...
    get_template_200_application_json_object: Optional[GetTemplate200ApplicationJSON] = dataclasses.field(default=None)
    get_template_401_application_json_object: Optional[GetTemplate401ApplicationJSON] = dataclasses.field(default=None)
    get_template_403_application_json_object: Optional[GetTemplate403ApplicationJSON] = dataclasses.field(default=None)
    get_template_404_application_json_object: Optional[GetTemplate404ApplicationJSON] = dataclasses.field(default=None)
    get_template_422_application_json_object: Optional[GetTemplate422ApplicationJSON] = dataclasses.field(default=None)
    get_template_500_application_json_object: Optional[GetTemplate500ApplicationJSON] = dataclasses.field(default=None)
