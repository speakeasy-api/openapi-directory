...
class DisassociateConfigurationItemsFromApplicationRequest:
    ...
    disassociate_configuration_items_from_application_request: shared_disassociateconfigurationitemsfromapplicationrequest.DisassociateConfigurationItemsFromApplicationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
