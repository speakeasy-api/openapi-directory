...
exports.PostAlmawsV1TaskListsRsLendingRequestsResponse = exports.PostAlmawsV1TaskListsRsLendingRequestsRequest = void 0;
...
var PostAlmawsV1TaskListsRsLendingRequestsRequest = /** @class */ (function (_super) {
    ...
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "library", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=op" }),
        __metadata("design:type", String)
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "op", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=partner",
        }),
        __metadata("design:type", String)
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "partner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=printed",
        }),
        __metadata("design:type", String)
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "printed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=reported",
        }),
        __metadata("design:type", String)
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "reported", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=requested_format",
        }),
        __metadata("design:type", String)
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "requestedFormat", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=supplied_format",
        }),
        __metadata("design:type", String)
    ], PostAlmawsV1TaskListsRsLendingRequestsRequest.prototype, "suppliedFormat", void 0);
...
var PostAlmawsV1TaskListsRsLendingRequestsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], PostAlmawsV1TaskListsRsLendingRequestsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
