...
var DiscoveryclustersClustersBannerWithContentContainer = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fillColorArgb" }),
...
var DiscoveryclustersClusters = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=banner_with_content_container" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalVolumes" }),
...
var Discoveryclusters = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=clusters", elemType: DiscoveryclustersClusters }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=totalClusters" }),
        __metadata("design:type", Number)
