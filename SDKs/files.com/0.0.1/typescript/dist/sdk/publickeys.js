...
exports.PublicKeys = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var PublicKeys = /** @class */ (function () {
    function PublicKeys(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Delete Public Key
    **/
    PublicKeys.prototype.deletePublicKeysId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeletePublicKeysIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/public_keys/{id}", req.pathParams);
     ...
     * List Public Keys
    **/
    PublicKeys.prototype.getPublicKeys = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPublicKeysRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/public_keys";
        var client = this._defaultClient;
     ...
     * Show Public Key
    **/
    PublicKeys.prototype.getPublicKeysId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update Public Key
    **/
    PublicKeys.prototype.patchPublicKeysId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Create Public Key
    **/
    PublicKeys.prototype.postPublicKeys = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
