...
class RealtimebiddingBiddersPretargetingConfigsRemoveTargetedPublishersRequest:
    ...
    remove_targeted_publishers_request: Optional[shared_removetargetedpublishersrequest.RemoveTargetedPublishersRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
