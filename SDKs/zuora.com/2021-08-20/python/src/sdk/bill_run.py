...
class BillRun:
    ...
    def object_delete_bill_run(self, request: operations.ObjectDELETEBillRunRequest) -> operations.ObjectDELETEBillRunResponse:
        ...
        url = utils.generate_url(operations.ObjectDELETEBillRunRequest, base_url, '/v1/object/bill-run/{id}', request)
        ...
        res = operations.ObjectDELETEBillRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def object_get_bill_run(self, request: operations.ObjectGETBillRunRequest) -> operations.ObjectGETBillRunResponse:
        ...
        url = utils.generate_url(operations.ObjectGETBillRunRequest, base_url, '/v1/object/bill-run/{id}', request)
        
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ObjectGETBillRunRequest, request)
        ...
        res = operations.ObjectGETBillRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json; charset=utf-8'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ProxyGetBillRun])
    ...
    def object_post_bill_run(self, request: operations.ObjectPOSTBillRunRequest) -> operations.ObjectPOSTBillRunResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "proxy_create_bill_run", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ObjectPOSTBillRunRequest, request)
        ...
        res = operations.ObjectPOSTBillRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def object_put_bill_run(self, request: operations.ObjectPUTBillRunRequest) -> operations.ObjectPUTBillRunResponse:
        ...
        * Canceling a bill run with a `Pending` status.
        ...
        url = utils.generate_url(operations.ObjectPUTBillRunRequest, base_url, '/v1/object/bill-run/{id}', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "proxy_modify_bill_run", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ObjectPUTBillRunRequest, request)
        ...
        res = operations.ObjectPUTBillRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_email_billing_documentsfrom_bill_run(self, request: operations.POSTEmailBillingDocumentsfromBillRunRequest) -> operations.POSTEmailBillingDocumentsfromBillRunResponse:
        ...
        url = utils.generate_url(operations.POSTEmailBillingDocumentsfromBillRunRequest, base_url, '/v1/bill-runs/{billRunId}/emails', request)
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "post_email_billing_docfrom_bill_run_type", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.POSTEmailBillingDocumentsfromBillRunResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
