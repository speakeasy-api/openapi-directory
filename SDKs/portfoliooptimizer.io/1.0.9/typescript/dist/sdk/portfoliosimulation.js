...
exports.PortfolioSimulation = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var PortfolioSimulation = /** @class */ (function () {
    function PortfolioSimulation(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    PortfolioSimulation.prototype.postPortfolioSimulationRebalancingDriftWeight = function (req, config) {
        var _a;
     ...
     *
    **/
    PortfolioSimulation.prototype.postPortfolioSimulationRebalancingFixedWeight = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    PortfolioSimulation.prototype.postPortfolioSimulationRebalancingRandomWeight = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.PortfolioSimulation = PortfolioSimulation;
