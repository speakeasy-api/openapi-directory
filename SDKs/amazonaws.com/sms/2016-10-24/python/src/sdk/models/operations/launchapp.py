...
class LaunchAppRequest:
    headers: LaunchAppHeaders = dataclasses.field()
    request: shared_launchapprequest.LaunchAppRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
