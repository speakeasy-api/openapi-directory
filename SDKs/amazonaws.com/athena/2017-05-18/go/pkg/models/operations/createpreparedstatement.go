...
func (e CreatePreparedStatementXAmzTargetEnum) ToPointer() *CreatePreparedStatementXAmzTargetEnum {
	return &e
}
...
func (e *CreatePreparedStatementXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonAthena.CreatePreparedStatement":
		*e = CreatePreparedStatementXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreatePreparedStatementXAmzTargetEnum: %v", v)
	}
}
