...
export class UpdateCurrentUserRequestBody extends SpeakeasyBase {
   ...
   *
   */
  @SpeakeasyMetadata({ data: "multipart_form, name=email_message_delay" })
   ...
   */
  @SpeakeasyMetadata({ data: "multipart_form, name=email_newsletters" })
   ...
   */
  @SpeakeasyMetadata({ data: "multipart_form, name=email_post_reminders" })
   ...
   *
   */
  @SpeakeasyMetadata({ data: "multipart_form, name=email_posts_frequency" })
   ...
   */
  @SpeakeasyMetadata({ data: "multipart_form, name=email_search_alerts" })
   ...
   *
   */
  @SpeakeasyMetadata({ data: "multipart_form, name=notify_about_reposts" })
