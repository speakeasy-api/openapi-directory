...
class UpdateIntegrationResponseResponseContentHandlingStrategyEnum(str, Enum):
...
class UpdateIntegrationResponseResponse:
    ...
    content_handling_strategy: Optional[UpdateIntegrationResponseResponseContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ContentHandlingStrategy'), 'exclude': lambda f: f is None }})  
