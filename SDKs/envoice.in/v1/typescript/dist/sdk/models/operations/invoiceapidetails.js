...
exports.InvoiceApiDetailsResponse = exports.InvoiceApiDetailsRequest = void 0;
...
var InvoiceApiDetailsRequest = /** @class */ (function (_super) {
    ...
    ], InvoiceApiDetailsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], InvoiceApiDetailsRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], InvoiceApiDetailsRequest.prototype, "xAuthSecret", void 0);
    return InvoiceApiDetailsRequest;
}(utils_1.SpeakeasyBase));
exports.InvoiceApiDetailsRequest = InvoiceApiDetailsRequest;
var InvoiceApiDetailsResponse = /** @class */ (function (_super) {
    ...
    ], InvoiceApiDetailsResponse.prototype, "rawResponse", void 0);
    return InvoiceApiDetailsResponse;
}(utils_1.SpeakeasyBase));
exports.InvoiceApiDetailsResponse = InvoiceApiDetailsResponse;
