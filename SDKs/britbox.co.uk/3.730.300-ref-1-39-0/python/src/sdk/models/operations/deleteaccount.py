...
from ..shared import itvdeleteaccountrequest as shared_itvdeleteaccountrequest
...
class DeleteAccountRequest:
    ...
    itv_delete_account_request: shared_itvdeleteaccountrequest.ItvDeleteAccountRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""New email address & ITV profile token."""  
