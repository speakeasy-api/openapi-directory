...
public class ItemDraft {
    ...
    **/
    public openapisdk.models.operations.CreateItemDraftResponse createItemDraft(openapisdk.models.operations.CreateItemDraftRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/item_draft/");
        ...
        openapisdk.models.operations.CreateItemDraftResponse res = new openapisdk.models.operations.CreateItemDraftResponse() {{
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.ItemDraftResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ItemDraftResponse.class);
