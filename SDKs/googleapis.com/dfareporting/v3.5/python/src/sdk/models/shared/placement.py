...
class Placement:
    ...
    r"""Name of this placement.This is a required field and must be less than or equal to 512 characters long."""  
    partner_wrapping_data: Optional[shared_measurementpartnerwrappingdata.MeasurementPartnerWrappingData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('partnerWrappingData'), 'exclude': lambda f: f is None }})
    ...
    r"""VPAID adapter setting for this placement. Controls which VPAID format the measurement adapter will use for in-stream video creatives assigned to this placement. *Note:* Flash is no longer supported. This field now defaults to HTML5 when the following values are provided: FLASH, BOTH."""  
    wrapping_opt_out: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('wrappingOptOut'), 'exclude': lambda f: f is None }})
    r"""Whether this placement opts out of tag wrapping."""  
