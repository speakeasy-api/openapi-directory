...
func (e RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum) ToPointer() *RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum {
	return &e
}
...
func (e *RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "unused":
		fallthrough
	case "unusedActive":
		*e = RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RenewOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum: %v", v)
	}
}
