...
export class ChartSpec extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "backgroundColorStyle" })
  @Type(() => ColorStyle)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "dataSourceChartProperties" })
  @Type(() => DataSourceChartProperties)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "hiddenDimensionStrategy" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "subtitleTextFormat" })
  @Type(() => TextFormat)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "subtitleTextPosition" })
  @Type(() => TextPosition)
