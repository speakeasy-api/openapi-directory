...
@dataclasses.dataclass
class PoolUpgradeOsRequest:
    headers: PoolUpgradeOsHeaders = dataclasses.field()
    path_params: PoolUpgradeOsPathParams = dataclasses.field()
    query_params: PoolUpgradeOsQueryParams = dataclasses.field()
    request: Any = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PoolUpgradeOsResponse:
