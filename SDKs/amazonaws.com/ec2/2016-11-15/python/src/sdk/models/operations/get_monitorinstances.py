...
class GETMonitorInstancesVersionEnum(str, Enum):
...
class GETMonitorInstancesRequest:
    ...
    action: GETMonitorInstancesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    ...
    version: GETMonitorInstancesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
