...
exports.GetStartExportTaskResponse = exports.GetStartExportTaskRequest = exports.GetStartExportTaskHeaders = exports.GetStartExportTaskQueryParams = exports.GetStartExportTaskVersionEnum = exports.GetStartExportTaskActionEnum = void 0;
...
var GetStartExportTaskQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ExportOnly" }),
        __metadata("design:type", Array)
    ], GetStartExportTaskQueryParams.prototype, "exportOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ExportTaskIdentifier" }),
        __metadata("design:type", String)
    ], GetStartExportTaskQueryParams.prototype, "exportTaskIdentifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=IamRoleArn" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=S3BucketName" }),
        __metadata("design:type", String)
    ], GetStartExportTaskQueryParams.prototype, "s3BucketName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=S3Prefix" }),
        __metadata("design:type", String)
    ], GetStartExportTaskQueryParams.prototype, "s3Prefix", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=SourceArn" }),
        __metadata("design:type", String)
...
exports.GetStartExportTaskQueryParams = GetStartExportTaskQueryParams;
...
exports.GetStartExportTaskHeaders = GetStartExportTaskHeaders;
