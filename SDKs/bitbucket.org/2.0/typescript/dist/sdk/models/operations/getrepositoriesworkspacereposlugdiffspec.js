...
exports.GetRepositoriesWorkspaceRepoSlugDiffSpecResponse = exports.GetRepositoriesWorkspaceRepoSlugDiffSpecRequest = exports.GetRepositoriesWorkspaceRepoSlugDiffSpecSecurity = void 0;
...
var GetRepositoriesWorkspaceRepoSlugDiffSpecRequest = /** @class */ (function (_super) {
    ...
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "binary", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=context",
        }),
        __metadata("design:type", Number)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "context", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ignore_whitespace",
        }),
        __metadata("design:type", Boolean)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "ignoreWhitespace", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=merge" }),
        __metadata("design:type", Boolean)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "merge", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=path" }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "path", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=renames",
        }),
        __metadata("design:type", Boolean)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "renames", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=spec",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "spec", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=topic" }),
        __metadata("design:type", Boolean)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "topic", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecRequest.prototype, "workspace", void 0);
...
var GetRepositoriesWorkspaceRepoSlugDiffSpecResponse = /** @class */ (function (_super) {
    ...
    ], GetRepositoriesWorkspaceRepoSlugDiffSpecResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
