...
class GetDescribeSynonymOptionsQueryParams:
    action: GetDescribeSynonymOptionsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetDescribeSynonymOptionsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeSynonymOptionsRequest:
    headers: GetDescribeSynonymOptionsHeaders = dataclasses.field()
    query_params: GetDescribeSynonymOptionsQueryParams = dataclasses.field()
