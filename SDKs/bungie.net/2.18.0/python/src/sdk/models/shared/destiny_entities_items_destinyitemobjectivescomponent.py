...
class DestinyEntitiesItemsDestinyItemObjectivesComponent:
    ...
    date_completed: Optional[datetime] = dataclasses.field(default=None)
    r"""If we have any information on when these objectives were completed, this will be the date of that completion. This won't be on many items, but could be interesting for some items that do store this information."""  
    flavor_objective: Optional[DestinyEntitiesItemsDestinyItemObjectivesComponentFlavorObjective] = dataclasses.field(default=None)
    ...
    r"""If the item has a hard association with objectives, your progress on them will be defined here.
