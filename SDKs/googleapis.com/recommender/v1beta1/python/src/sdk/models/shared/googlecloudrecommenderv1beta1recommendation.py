...
class GoogleCloudRecommenderV1beta1Recommendation:
    ...
    additional_impact: Optional[list[shared_googlecloudrecommenderv1beta1impact.GoogleCloudRecommenderV1beta1Impact]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalImpact'), 'exclude': lambda f: f is None }})
    ...
    associated_insights: Optional[list[shared_googlecloudrecommenderv1beta1recommendationinsightreference.GoogleCloudRecommenderV1beta1RecommendationInsightReference]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('associatedInsights'), 'exclude': lambda f: f is None }})
    r"""Insights that led to this recommendation."""  
    content: Optional[shared_googlecloudrecommenderv1beta1recommendationcontent.GoogleCloudRecommenderV1beta1RecommendationContent] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content'), 'exclude': lambda f: f is None }})
    ...
    primary_impact: Optional[shared_googlecloudrecommenderv1beta1impact.GoogleCloudRecommenderV1beta1Impact] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primaryImpact'), 'exclude': lambda f: f is None }})
    r"""Contains the impact a recommendation can have for a given category."""  
    priority: Optional[GoogleCloudRecommenderV1beta1RecommendationPriorityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priority'), 'exclude': lambda f: f is None }})
    r"""Recommendation's priority."""  
    ...
    state_info: Optional[shared_googlecloudrecommenderv1beta1recommendationstateinfo.GoogleCloudRecommenderV1beta1RecommendationStateInfo] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('stateInfo'), 'exclude': lambda f: f is None }})
