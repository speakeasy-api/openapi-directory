...
class ListFindingsResponse:
    ...
    list_findings_results: Optional[list[shared_listfindingsresult.ListFindingsResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('listFindingsResults'), 'exclude': lambda f: f is None }})
