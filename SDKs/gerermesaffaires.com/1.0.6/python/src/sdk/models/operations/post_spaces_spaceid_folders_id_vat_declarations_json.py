...
class PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2AccountingWorkbookEnum(str, Enum):
    CUSTOMER = 'customer'
    PROVIDER = 'provider'
    BANK = 'bank'
...
class PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2Accounting:
    ...
    workbook: Optional[PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2AccountingWorkbookEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Workbook'), 'exclude': lambda f: f is None }})  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2File:
...
class PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2:
    ...
    file: PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2File = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('File') }})  
    title: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Title') }})  
    accounting: Optional[PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2Accounting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Accounting'), 'exclude': lambda f: f is None }})  
...
class PostSpacesSpaceIDFoldersIDVatDeclarationsJSONResponse:
    ...
    post_spaces_space_id_folders_id_vat_declarations_json_201_application_json_object: Optional[PostSpacesSpaceIDFoldersIDVatDeclarationsJSON201ApplicationJSON] = dataclasses.field(default=None)
    r"""Id of document created"""  
