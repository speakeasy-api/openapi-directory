...
export class ListCredentialListListCredentialListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.TrunkingV1TrunkCredentialList })
  @Expose({ name: "credential_lists" })
  @Type(() => shared.TrunkingV1TrunkCredentialList)
  credentialLists?: shared.TrunkingV1TrunkCredentialList[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListCredentialListListCredentialListResponseMeta)
