...
class GetServicesRequest:
    ...
    r"""Filter based on the name of the resource. Supports wildcards: `*`"""  
...
class GetServices200ApplicationJSON:
    r"""A JSON object containing a list of services"""
    ...
    results: Optional[list[shared_service.Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
