...
public class UpdateNetworkSwitchAccessPolicyRequestBodyRadiusAccountingServers {
    ...
    public UpdateNetworkSwitchAccessPolicyRequestBodyRadiusAccountingServers(@JsonProperty("host") String host, @JsonProperty("port") Long port, @JsonProperty("secret") String secret) {
        this.host = host;
        this.port = port;
        this.secret = secret;
  }
