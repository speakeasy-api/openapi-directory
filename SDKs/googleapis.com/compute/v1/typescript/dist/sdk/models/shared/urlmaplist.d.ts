 ...
 */
export declare enum UrlMapListWarningCodeEnum {
...
export declare class UrlMapListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class UrlMapListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class UrlMapList extends SpeakeasyBase {
    /**
