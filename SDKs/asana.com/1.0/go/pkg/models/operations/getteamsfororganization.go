...
// GetTeamsForOrganization200ApplicationJSON - Returns the team records for all teams in the organization or workspace accessible to the authenticated user.
