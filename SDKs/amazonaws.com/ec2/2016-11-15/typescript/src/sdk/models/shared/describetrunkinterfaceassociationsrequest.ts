 ...
 */
export class DescribeTrunkInterfaceAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTrunkInterfaceAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({
    elemType: DescribeTrunkInterfaceAssociationsRequestFilters,
  })
  filters?: DescribeTrunkInterfaceAssociationsRequestFilters[];
