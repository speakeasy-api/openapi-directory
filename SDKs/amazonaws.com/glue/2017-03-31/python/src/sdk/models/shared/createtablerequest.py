...
class CreateTableRequest:
    ...
    partition_indexes: Optional[list[shared_partitionindex.PartitionIndex]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PartitionIndexes'), 'exclude': lambda f: f is None }})  
