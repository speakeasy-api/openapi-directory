...
class TransactionSummary:
    ...
    cleared: TransactionSummaryClearedEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('cleared') }})
    ...
    flag_color: Optional[TransactionSummaryFlagColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('flag_color') }})
