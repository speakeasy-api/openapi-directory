...
public class FundingStrategy {
    ...
    @JsonProperty("adRateStrategy")
    public String adRateStrategy;

    public FundingStrategy withAdRateStrategy(String adRateStrategy) {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("dynamicAdRatePreferences")
    public DynamicAdRatePreference[] dynamicAdRatePreferences;

    public FundingStrategy withDynamicAdRatePreferences(DynamicAdRatePreference[] dynamicAdRatePreferences) {
