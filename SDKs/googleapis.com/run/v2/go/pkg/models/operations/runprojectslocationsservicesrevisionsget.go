...
type RunProjectsLocationsServicesRevisionsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RunProjectsLocationsServicesRevisionsGetPathParams struct {
...
type RunProjectsLocationsServicesRevisionsGetQueryParams struct {
	// V1 error format.
...
type RunProjectsLocationsServicesRevisionsGetRequest struct {
...
type RunProjectsLocationsServicesRevisionsGetResponse struct {
	ContentType string
	// Successful response
