 ...
 */
export declare class DescribeLocalGatewayVirtualInterfacesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLocalGatewayVirtualInterfacesRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeLocalGatewayVirtualInterfacesRequestFilters[];
