...
class UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityEncryptionTypeEnum(str, Enum):
...
class UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityMeetingPasswordRequirementConsecutiveCharactersLengthEnum(str, Enum):
    ZERO = '0'
    FOUR = '4'
    FIVE = '5'
    SIX = '6'
...
class UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityMeetingPasswordRequirement:
    ...
    consecutive_characters_length: Optional[UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityMeetingPasswordRequirementConsecutiveCharactersLengthEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('consecutive_characters_length'), 'exclude': lambda f: f is None }})  
...
class UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityWaitingRoomSettingsParticipantsToPlaceInWaitingRoomEnum(str, Enum):
...
class UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityWaitingRoomSettings:
    ...
    participants_to_place_in_waiting_room: Optional[UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityWaitingRoomSettingsParticipantsToPlaceInWaitingRoomEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participants_to_place_in_waiting_room'), 'exclude': lambda f: f is None }})
    r"""Specify who should be admitted to the waiting room. The value of this field can be one of the following:<br>
    `0`: All attendees<br> `1`: Users who are not in your account<br> `2`: Users who are not in your account and are not part of your whitelisted domains that are specified in
    """  
...
class UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurity:
    ...
    encryption_type: Optional[UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityEncryptionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('encryption_type'), 'exclude': lambda f: f is None }})
    r"""Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
    `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
    ...
    meeting_password_requirement: Optional[UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityMeetingPasswordRequirement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meeting_password_requirement'), 'exclude': lambda f: f is None }})
    r"""Meeting/webinar [passcode requirements](https://support.zoom.us/hc/en-us/articles/360033559832-Meeting-and-webinar-passwords#h_a427384b-e383-4f80-864d-794bf0a37604)."""  
    ...
    waiting_room_settings: Optional[UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurityWaitingRoomSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('waiting_room_settings'), 'exclude': lambda f: f is None }})
    r"""Specify the settings to be applied if waiting room is enabled."""  
...
class UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettings:
    ...
    meeting_security: Optional[UpdateAccountLockSettingsApplicationJSONMeetingWebinarSecuritySettingsMeetingSecurity] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meeting_security'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateAccountLockSettingsApplicationJSON1EmailNotification:
...
class UpdateAccountLockSettingsApplicationJSON1InMeeting:
    ...
    **This field has been deprecated and is no longer supported.**
    ...
    r"""Indicate whether the [**Request permission to unmute participants**](https://support.zoom.us/hc/en-us/articles/203435537-Muting-and-unmuting-participants-in-a-meeting#h_01EGK4XFWS1SJGZ71MYGKF7260) option should be enabled and locked for the account or not."""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class UpdateAccountLockSettingsApplicationJSON1Recording:
    ...
    ip_address_access_control: Optional[UpdateAccountLockSettingsApplicationJSON1RecordingIPAddressAccessControl] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ip_address_access_control'), 'exclude': lambda f: f is None }})
    r"""Setting to allow cloud recording access only from specific IP address ranges."""  
...
class UpdateAccountLockSettingsApplicationJSON1ScheduleMeeting:
    ...
    r"""Participants must always sign in before joining the scheduled meeting."""  
    ...
    r"""Turn the lock setting on or off for the **Enable Personal Meeting ID** setting for an entire account.<br><br>
...
class UpdateAccountLockSettingsApplicationJSON1:
    ...
    email_notification: Optional[UpdateAccountLockSettingsApplicationJSON1EmailNotification] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('email_notification'), 'exclude': lambda f: f is None }})  
    in_meeting: Optional[UpdateAccountLockSettingsApplicationJSON1InMeeting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('in_meeting'), 'exclude': lambda f: f is None }})  
    recording: Optional[UpdateAccountLockSettingsApplicationJSON1Recording] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recording'), 'exclude': lambda f: f is None }})  
    schedule_meeting: Optional[UpdateAccountLockSettingsApplicationJSON1ScheduleMeeting] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('schedule_meeting'), 'exclude': lambda f: f is None }})  
    telephony: Optional[UpdateAccountLockSettingsApplicationJSON1Telephony] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('telephony'), 'exclude': lambda f: f is None }})  
    tsp: Optional[UpdateAccountLockSettingsApplicationJSON1Tsp] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tsp'), 'exclude': lambda f: f is None }})  
