...
func (e MediaV1PlayerStreamerStatusCallbackMethodEnum) ToPointer() *MediaV1PlayerStreamerStatusCallbackMethodEnum {
	return &e
}
...
func (e *MediaV1PlayerStreamerStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = MediaV1PlayerStreamerStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MediaV1PlayerStreamerStatusCallbackMethodEnum: %v", v)
	}
}
