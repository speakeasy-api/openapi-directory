...
public class ListAvailablePhoneNumberSharedCostQueryParams {
    ...
    public Long page;
    public ListAvailablePhoneNumberSharedCostQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListAvailablePhoneNumberSharedCostQueryParams withPageToken(String pageToken) {
