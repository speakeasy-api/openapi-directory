...
class GetPaymentInitiationAuthorisationPathParams:
...
@dataclasses.dataclass
class GetPaymentInitiationAuthorisationHeaders:
...
@dataclasses.dataclass
class GetPaymentInitiationAuthorisationSecurity:
...
@dataclasses.dataclass
class GetPaymentInitiationAuthorisationRequest:
    headers: GetPaymentInitiationAuthorisationHeaders = dataclasses.field()
    path_params: GetPaymentInitiationAuthorisationPathParams = dataclasses.field()
    security: GetPaymentInitiationAuthorisationSecurity = dataclasses.field()
    

@dataclasses.dataclass
class GetPaymentInitiationAuthorisationResponse:
