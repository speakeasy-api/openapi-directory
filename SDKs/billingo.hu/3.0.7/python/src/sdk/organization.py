...
class Organization:
    ...
    def get_organization_data(self) -> operations.GetOrganizationDataResponse:
        ...
        res = operations.GetOrganizationDataResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.OrganizationData])
