...
<https://docs.github.com/github-ae@latest/rest/reference/issues#add-assignees-to-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#add-labels-to-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#check-if-a-user-can-be-assigned>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#create-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#create-an-issue-comment>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#create-a-label>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#create-a-milestone>
...
func main() {
    ...
    res, err := s.Issues.IssuesCreateMilestone(ctx, operations.IssuesCreateMilestoneRequest{
        RequestBody: operations.IssuesCreateMilestoneRequestBody{
            ...
            DueOn: types.MustTimeFromString("2021-12-15T01:59:29.520Z"),
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#delete-an-issue-comment>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#delete-a-label>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#delete-a-milestone>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#get-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#get-an-issue-comment>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#get-an-issue-event>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#get-a-label>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#get-a-milestone>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesList(ctx, operations.IssuesListRequest{
        ...
        Labels: sdk.String("voluptatibus"),
        Orgs: sdk.Bool(false),
        Owned: sdk.Bool(false),
        Page: sdk.Int64(271653),
        PerPage: sdk.Int64(273009),
        Pulls: sdk.Bool(false),
        Since: types.MustTimeFromString("2022-01-11T22:08:32.388Z"),
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-assignees>
...
func main() {
    ...
    res, err := s.Issues.IssuesListAssignees(ctx, operations.IssuesListAssigneesRequest{
        Owner: "non",
        Page: sdk.Int64(888044),
        PerPage: sdk.Int64(505866),
        Repo: "facilis",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-issue-comments>
...
func main() {
    ...
    res, err := s.Issues.IssuesListComments(ctx, operations.IssuesListCommentsRequest{
        IssueNumber: 310381,
        Owner: "incidunt",
        Page: sdk.Int64(373035),
        PerPage: sdk.Int64(894864),
        Repo: "rem",
        Since: types.MustTimeFromString("2022-04-02T00:47:15.232Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-issue-comments-for-a-repository>
...
func main() {
    ...
    res, err := s.Issues.IssuesListCommentsForRepo(ctx, operations.IssuesListCommentsForRepoRequest{
        ...
        Owner: "veniam",
        Page: sdk.Int64(329543),
        PerPage: sdk.Int64(924159),
        Repo: "reiciendis",
        Since: types.MustTimeFromString("2022-06-30T09:48:42.630Z"),
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-issue-events>
...
func main() {
    ...
    res, err := s.Issues.IssuesListEvents(ctx, operations.IssuesListEventsRequest{
        IssueNumber: 901483,
        Owner: "numquam",
        Page: sdk.Int64(329935),
        PerPage: sdk.Int64(446135),
        Repo: "officiis",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-issue-events-for-a-repository>
...
func main() {
    ...
    res, err := s.Issues.IssuesListEventsForRepo(ctx, operations.IssuesListEventsForRepoRequest{
        Owner: "beatae",
        Page: sdk.Int64(512452),
        PerPage: sdk.Int64(348476),
        Repo: "praesentium",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-timeline-events-for-an-issue>
...
func main() {
    ...
    res, err := s.Issues.IssuesListEventsForTimeline(ctx, operations.IssuesListEventsForTimelineRequest{
        IssueNumber: 740098,
        Owner: "laboriosam",
        Page: sdk.Int64(680515),
        PerPage: sdk.Int64(530089),
        Repo: "error",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-user-account-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForAuthenticatedUser(ctx, operations.IssuesListForAuthenticatedUserRequest{
        ...
        Page: sdk.Int64(204923),
        PerPage: sdk.Int64(677115),
        Since: types.MustTimeFromString("2022-05-12T18:07:12.039Z"),
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-organization-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForOrg(ctx, operations.IssuesListForOrgRequest{
        ...
        Labels: sdk.String("atque"),
        Org: "fugit",
        Page: sdk.Int64(282699),
        PerPage: sdk.Int64(856303),
        Since: types.MustTimeFromString("2022-05-14T04:54:08.545Z"),
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-repository-issues>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForRepo(ctx, operations.IssuesListForRepoRequest{
        Assignee: sdk.String("consequatur"),
        Creator: sdk.String("esse"),
        Direction: shared.DirectionEnumAsc.ToPointer(),
        Labels: sdk.String("sit"),
        Mentioned: sdk.String("voluptatum"),
        Milestone: sdk.String("quas"),
        Owner: "repudiandae",
        Page: sdk.Int64(361151),
        PerPage: sdk.Int64(89494),
        Repo: "blanditiis",
        Since: types.MustTimeFromString("2022-11-05T22:13:21.002Z"),
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-labels-for-issues-in-a-milestone>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-labels-for-a-repository>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-labels-for-an-issue>
...
func main() {
    ...
    res, err := s.Issues.IssuesListLabelsOnIssue(ctx, operations.IssuesListLabelsOnIssueRequest{
        IssueNumber: 99416,
        Owner: "occaecati",
        Page: sdk.Int64(289776),
        PerPage: sdk.Int64(695270),
        Repo: "atque",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#list-milestones>
...
func main() {
    ...
    res, err := s.Issues.IssuesListMilestones(ctx, operations.IssuesListMilestonesRequest{
        ...
        Owner: "nam",
        Page: sdk.Int64(948861),
        PerPage: sdk.Int64(388867),
        Repo: "alias",
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#lock-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#remove-all-labels-from-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#remove-assignees-from-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#remove-a-label-from-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#set-labels-for-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#unlock-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#update-an-issue>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#update-an-issue-comment>
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#update-a-label>
...
func main() {
    ...
    res, err := s.Issues.IssuesUpdateLabel(ctx, operations.IssuesUpdateLabelRequest{
        RequestBody: &operations.IssuesUpdateLabelRequestBody{
            Color: sdk.String("maiores"),
            Description: sdk.String("corrupti"),
            NewName: sdk.String("at"),
        },
        Name: "Guy Hoeger",
        Owner: "atque",
        Repo: "sunt",
...
API method documentation
<https://docs.github.com/github-ae@latest/rest/reference/issues#update-a-milestone>
