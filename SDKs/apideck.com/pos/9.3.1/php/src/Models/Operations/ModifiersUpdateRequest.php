...
class ModifiersUpdateRequest
{
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public \OpenAPI\OpenAPI\Models\Shared\ModifierInput $modifierInput;
	...
	{
		$this->modifierInput = new \OpenAPI\OpenAPI\Models\Shared\ModifierInput();
		$this->id = "";
		$this->raw = null;
		$this->xApideckAppId = "";
