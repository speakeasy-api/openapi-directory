    ...
    public static void main(String[] args) {
        try {
            ...
            SscerRequestBody req = new SscerRequestBody(SscerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new SscerRequestBodyCertificateParameters("31-12-1980", "Sunil Kumar", "173XX23", "11XX1", "2018,2019");;
            ...
            SscerResponse res = sdk.apIs.sscer(req, new SscerSecurity("molestiae", "minus") {{
