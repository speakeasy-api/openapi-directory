...
class GoogleCloudDataplexV1EntityCompatibilityStatusCompatibility:
    ...
    r"""Output only. Whether the entity is compatible and can be represented in the metadata store."""  
    reason: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    r"""Output only. Provides additional detail if the entity is incompatible with the metadata store."""  
