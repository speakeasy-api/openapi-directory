...
class CreateResourceShareRequestBody:
    ...
    r"""Specifies the name of the resource share."""  
    ...
    permission_arns: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('permissionArns'), 'exclude': lambda f: f is None }})
    ...
    r"""Specifies a list of one or more ARNs of the resources to associate with the resource share."""  
    tags: Optional[list[shared_tag.Tag]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tags'), 'exclude': lambda f: f is None }})
    r"""Specifies one or more tags to attach to the resource share itself. It doesn't attach the tags to the resources associated with the resource share."""  
    

@dataclasses.dataclass
class CreateResourceShareRequest:
    
    request_body: CreateResourceShareRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
