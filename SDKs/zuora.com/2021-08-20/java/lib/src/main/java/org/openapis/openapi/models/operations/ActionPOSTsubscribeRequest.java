...
public class ActionPOSTsubscribeRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActionsubscribeRequest proxyActionsubscribeRequest;
    public ActionPOSTsubscribeRequest withProxyActionsubscribeRequest(org.openapis.openapi.models.shared.ProxyActionsubscribeRequest proxyActionsubscribeRequest) {
        this.proxyActionsubscribeRequest = proxyActionsubscribeRequest;
        return this;
    }
    ...
    public ActionPOSTsubscribeRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTsubscribeRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTsubscribeRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTsubscribeRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
