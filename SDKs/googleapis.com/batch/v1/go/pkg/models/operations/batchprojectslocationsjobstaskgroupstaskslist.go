...
type BatchProjectsLocationsJobsTaskGroupsTasksListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BatchProjectsLocationsJobsTaskGroupsTasksListPathParams struct {
...
type BatchProjectsLocationsJobsTaskGroupsTasksListQueryParams struct {
	// V1 error format.
...
type BatchProjectsLocationsJobsTaskGroupsTasksListRequest struct {
...
type BatchProjectsLocationsJobsTaskGroupsTasksListResponse struct {
	ContentType string
	// Successful response
