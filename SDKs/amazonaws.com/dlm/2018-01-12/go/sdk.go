...
// SDK Documentation: https://docs.aws.amazon.com/dlm/ - Amazon Web Services documentation
type SDK struct {
...
func (s *SDK) DeleteLifecyclePolicy(ctx context.Context, request operations.DeleteLifecyclePolicyRequest) (*operations.DeleteLifecyclePolicyResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/policies/{policyId}/", request.PathParams)
