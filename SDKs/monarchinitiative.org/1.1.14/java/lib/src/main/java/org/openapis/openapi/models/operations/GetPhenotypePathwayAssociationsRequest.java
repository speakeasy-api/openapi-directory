...
public class GetPhenotypePathwayAssociationsRequest {
    ...
    public GetPhenotypePathwayAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPhenotypePathwayAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPhenotypePathwayAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPhenotypePathwayAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPhenotypePathwayAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPhenotypePathwayAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withRelation(String relation) {
    ...
    public GetPhenotypePathwayAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPhenotypePathwayAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPhenotypePathwayAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPhenotypePathwayAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
