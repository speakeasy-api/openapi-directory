...
try {
    ...
    $request->page = 859003;
    $request->perPage = 640907;
    $request->q = 'sed';
    $request->sort = SearchIssuesAndPullRequestsSortEnum::COMMENTS;
...
try {
    ...
    $request->order = OrderEnum::DESC;
    $request->page = 910073;
    $request->perPage = 941668;
    $request->q = 'voluptatem';
    $request->repositoryId = 278325;
