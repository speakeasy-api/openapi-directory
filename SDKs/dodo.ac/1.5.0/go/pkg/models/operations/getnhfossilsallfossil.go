...
type GetNhFossilsAllFossilPathParams struct {
...
type GetNhFossilsAllFossilQueryParams struct {
...
type GetNhFossilsAllFossilHeaders struct {
...
type GetNhFossilsAllFossilRequest struct {
	PathParams  GetNhFossilsAllFossilPathParams
	QueryParams GetNhFossilsAllFossilQueryParams
	Headers     GetNhFossilsAllFossilHeaders
}
