...
class Ec2CreateRouteAction:
    r"""Information about the CreateRoute action in Amazon EC2."""
    ...
    vpc_endpoint_id: Optional[shared_actiontarget.ActionTarget] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VpcEndpointId'), 'exclude': lambda f: f is None }})  
