...
export class AuthorizedbuyersmarketplaceBuyersAuctionPackagesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersAuctionPackagesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AuthorizedbuyersmarketplaceBuyersAuctionPackagesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
