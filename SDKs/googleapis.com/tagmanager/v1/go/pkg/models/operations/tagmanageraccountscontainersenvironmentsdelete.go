...
type TagmanagerAccountsContainersEnvironmentsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TagmanagerAccountsContainersEnvironmentsDeletePathParams struct {
	// The GTM Account ID.
...
type TagmanagerAccountsContainersEnvironmentsDeleteQueryParams struct {
	// V1 error format.
...
type TagmanagerAccountsContainersEnvironmentsDeleteRequest struct {
...
type TagmanagerAccountsContainersEnvironmentsDeleteResponse struct {
	ContentType string
	StatusCode  int
