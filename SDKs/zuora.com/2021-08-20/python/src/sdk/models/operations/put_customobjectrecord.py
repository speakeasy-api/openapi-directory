...
class PutCustomObjectRecordRequest:
    headers: PutCustomObjectRecordHeaders = dataclasses.field()
    path_params: PutCustomObjectRecordPathParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PutCustomObjectRecordResponse:
