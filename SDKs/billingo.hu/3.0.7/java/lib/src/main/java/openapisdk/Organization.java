...
public class Organization {
    ...
    **/
    public openapisdk.models.operations.GetOrganizationDataResponse getOrganizationData() throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/organization");
        ...
        openapisdk.models.operations.GetOrganizationDataResponse res = new openapisdk.models.operations.GetOrganizationDataResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            ...
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.OrganizationData out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.OrganizationData.class);
