...
exports.CreateAssessmentFrameworkResponse = exports.CreateAssessmentFrameworkRequest = exports.CreateAssessmentFrameworkRequestBody = void 0;
...
var CreateAssessmentFrameworkRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.CreateAssessmentFrameworkControlSet }),
        (0, class_transformer_1.Expose)({ name: "controlSets" }),
        (0, class_transformer_1.Type)(function () { return shared.CreateAssessmentFrameworkControlSet; }),
...
exports.CreateAssessmentFrameworkRequestBody = CreateAssessmentFrameworkRequestBody;
var CreateAssessmentFrameworkRequest = /** @class */ (function (_super) {
    ...
    ], CreateAssessmentFrameworkRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkRequest.prototype, "xAmzSignedHeaders", void 0);
    return CreateAssessmentFrameworkRequest;
}(utils_1.SpeakeasyBase));
exports.CreateAssessmentFrameworkRequest = CreateAssessmentFrameworkRequest;
var CreateAssessmentFrameworkResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateAssessmentFrameworkResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateAssessmentFrameworkResponse.prototype, "serviceQuotaExceededException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.CreateAssessmentFrameworkResponse = CreateAssessmentFrameworkResponse;
