...
public class GetAddressByVersionQueryParams {
    /**
    ...
    public GetAddressByVersionQueryParams withAlternativeKey(String alternativeKey) {
    ...
    public GetAddressByVersionQueryParams withReason(String reason) {
        this.reason = reason;
        return this;
    }
