...
type GetZRSettings200ApplicationXML2ClientAlert struct {
...
// GetZRSettings200ApplicationXML2DigitalSignageBanner - Specifies the elements that you want to display in the top banner.
type GetZRSettings200ApplicationXML2DigitalSignageBanner struct {
...
// GetZRSettings200ApplicationXML2DigitalSignageDisplayPeriod - Display period object lets you define the number of minutes before or after the scheduled meeting time you would like the content to display.
type GetZRSettings200ApplicationXML2DigitalSignageDisplayPeriod struct {
...
// GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum - Specify an action for the content list. The value can be one of the following:<br>
// `add`: Add another content list.<br>
// `update`: Update existing content list.<br>
// `delete`: Delete content list.
type GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum string

const (
	GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnumAdd    GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum = "add"
	GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnumUpdate GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum = "update"
	GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnumDelete GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum = "delete"
)

func (e *GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	case "update":
		fallthrough
	case "delete":
		*e = GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetZRSettings200ApplicationXML2DigitalSignagePlayListActionEnum: %s", s)
	}
}

// GetZRSettings200ApplicationXML2DigitalSignagePlayListContents - Content list.
type GetZRSettings200ApplicationXML2DigitalSignagePlayListContents struct {
	// Content Id.
	ContentID *string
...
type GetZRSettings200ApplicationXML2DigitalSignagePlayList struct {
...
type GetZRSettings200ApplicationXML2DigitalSignage struct {
...
type GetZRSettings200ApplicationXML2Notification struct {
...
type GetZRSettings200ApplicationXML2 struct {
...
// GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum - Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
// `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
//
// `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
type GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum string

const (
	GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnumEnhancedEncryption GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum = "enhanced_encryption"
	GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnumE2ee               GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum = "e2ee"
)

func (e *GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "enhanced_encryption":
		fallthrough
	case "e2ee":
		*e = GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetZRSettings200ApplicationXML1MeetingSecurityEncryptionTypeEnum: %s", s)
	}
}

type GetZRSettings200ApplicationXML1MeetingSecurity struct {
...
type GetZRSettings200ApplicationXML1ZoomRooms struct {
...
type GetZRSettings200ApplicationXML1 struct {
	MeetingSecurity *GetZRSettings200ApplicationXML1MeetingSecurity
	ZoomRooms       *GetZRSettings200ApplicationXML1ZoomRooms
}

type GetZRSettings200ApplicationXMLType string

const (
	GetZRSettings200ApplicationXMLTypeGetZRSettings200ApplicationXML1 GetZRSettings200ApplicationXMLType = "getZRSettings_200ApplicationXML_1"
	GetZRSettings200ApplicationXMLTypeGetZRSettings200ApplicationXML2 GetZRSettings200ApplicationXMLType = "getZRSettings_200ApplicationXML_2"
)

type GetZRSettings200ApplicationXML struct {
	GetZRSettings200ApplicationXML1 *GetZRSettings200ApplicationXML1
	GetZRSettings200ApplicationXML2 *GetZRSettings200ApplicationXML2

	Type GetZRSettings200ApplicationXMLType
}

func CreateGetZRSettings200ApplicationXMLGetZRSettings200ApplicationXML1(getZRSettings200ApplicationXML1 GetZRSettings200ApplicationXML1) GetZRSettings200ApplicationXML {
	typ := GetZRSettings200ApplicationXMLTypeGetZRSettings200ApplicationXML1

	return GetZRSettings200ApplicationXML{
		GetZRSettings200ApplicationXML1: &getZRSettings200ApplicationXML1,
		Type:                            typ,
	}
}

func CreateGetZRSettings200ApplicationXMLGetZRSettings200ApplicationXML2(getZRSettings200ApplicationXML2 GetZRSettings200ApplicationXML2) GetZRSettings200ApplicationXML {
	typ := GetZRSettings200ApplicationXMLTypeGetZRSettings200ApplicationXML2
...
func (u *GetZRSettings200ApplicationXML) UnmarshalJSON(data []byte) error {
	var d *json.Decoder

	getZRSettings200ApplicationXML1 := new(GetZRSettings200ApplicationXML1)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&getZRSettings200ApplicationXML1); err == nil {
		u.GetZRSettings200ApplicationXML1 = getZRSettings200ApplicationXML1
		u.Type = GetZRSettings200ApplicationXMLTypeGetZRSettings200ApplicationXML1
		return nil
	}

	getZRSettings200ApplicationXML2 := new(GetZRSettings200ApplicationXML2)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&getZRSettings200ApplicationXML2); err == nil {
		u.GetZRSettings200ApplicationXML2 = getZRSettings200ApplicationXML2
		u.Type = GetZRSettings200ApplicationXMLTypeGetZRSettings200ApplicationXML2
		return nil
	}
...
func (u GetZRSettings200ApplicationXML) MarshalJSON() ([]byte, error) {
	if u.GetZRSettings200ApplicationXML1 != nil {
		return json.Marshal(u.GetZRSettings200ApplicationXML1)
	}

	if u.GetZRSettings200ApplicationXML2 != nil {
		return json.Marshal(u.GetZRSettings200ApplicationXML2)
	}
...
type GetZRSettings200ApplicationJSON2ClientAlert struct {
	// Display an alert message when an issue is detected with a bluetooth microphone.
...
// GetZRSettings200ApplicationJSON2DigitalSignageBanner - Specifies the elements that you want to display in the top banner.
type GetZRSettings200ApplicationJSON2DigitalSignageBanner struct {
	// Display or hide banner room name.
...
// GetZRSettings200ApplicationJSON2DigitalSignageDisplayPeriod - Display period object lets you define the number of minutes before or after the scheduled meeting time you would like the content to display.
type GetZRSettings200ApplicationJSON2DigitalSignageDisplayPeriod struct {
	// Start displaying digital signage content after certain duration after the meeting ends. The value of this field indicates the duration in minutes.
...
// GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum - Specify an action for the content list. The value can be one of the following:<br>
// `add`: Add another content list.<br>
// `update`: Update existing content list.<br>
// `delete`: Delete content list.
type GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum string

const (
	GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnumAdd    GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum = "add"
	GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnumUpdate GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum = "update"
	GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnumDelete GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum = "delete"
)

func (e *GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "update":
		fallthrough
	case "delete":
		*e = GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum: %s", s)
	}
}

// GetZRSettings200ApplicationJSON2DigitalSignagePlayListContents - Content list.
type GetZRSettings200ApplicationJSON2DigitalSignagePlayListContents struct {
	// Content Id.
...
type GetZRSettings200ApplicationJSON2DigitalSignagePlayList struct {
	// Specify an action for the content list. The value can be one of the following:<br>
	// `add`: Add another content list.<br>
	// `update`: Update existing content list.<br>
	// `delete`: Delete content list.
	//
	Action   *GetZRSettings200ApplicationJSON2DigitalSignagePlayListActionEnum `json:"action,omitempty"`
	Contents []GetZRSettings200ApplicationJSON2DigitalSignagePlayListContents  `json:"contents,omitempty"`
	// Specify the display end time for the content list in GMT.
...
type GetZRSettings200ApplicationJSON2DigitalSignage struct {
	// Specifies the elements that you want to display in the top banner.
	Banner *GetZRSettings200ApplicationJSON2DigitalSignageBanner `json:"banner,omitempty"`
	// Display period object lets you define the number of minutes before or after the scheduled meeting time you would like the content to display.
	DisplayPeriod *GetZRSettings200ApplicationJSON2DigitalSignageDisplayPeriod `json:"display_period,omitempty"`
	// [Indicates whether digital signage is on or off,](https://support.zoom.us/hc/en-us/articles/360000030683-Zoom-Rooms-digital-signage#h_767fbb33-82a8-45a8-8392-a1bfa9687edd). <br>
	// `true`: enable<br> `false`: disable
	...
	// Content list.
	PlayList []GetZRSettings200ApplicationJSON2DigitalSignagePlayList `json:"play_list,omitempty"`
}

// GetZRSettings200ApplicationJSON2Notification - [Notifications Settings](https://support.zoom.us/hc/en-us/articles/205394099-Zoom-Room-Alerts#h_b430b5f2-5150-4522-9c96-c77f22ab70bc) includes the circumstances in which the room sends an email alert to the support team to notify them of a potentially urgent issue. These issues can affect the operation of the room, but do not display on the TV screen. The email alert is sent to the email address specified in the Notification Email Recipients section.
type GetZRSettings200ApplicationJSON2Notification struct {
	// Send an alert when the audio echo test result meets usability threshold.
...
type GetZRSettings200ApplicationJSON2 struct {
	// The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
	ClientAlert    *GetZRSettings200ApplicationJSON2ClientAlert    `json:"client_alert,omitempty"`
	DigitalSignage *GetZRSettings200ApplicationJSON2DigitalSignage `json:"digital_signage,omitempty"`
	// [Notifications Settings](https://support.zoom.us/hc/en-us/articles/205394099-Zoom-Room-Alerts#h_b430b5f2-5150-4522-9c96-c77f22ab70bc) includes the circumstances in which the room sends an email alert to the support team to notify them of a potentially urgent issue. These issues can affect the operation of the room, but do not display on the TV screen. The email alert is sent to the email address specified in the Notification Email Recipients section.
	Notification *GetZRSettings200ApplicationJSON2Notification `json:"notification,omitempty"`
}

// GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum - Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
// `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
//
// `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
type GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum string

const (
	GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnumEnhancedEncryption GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum = "enhanced_encryption"
	GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnumE2ee               GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum = "e2ee"
)

func (e *GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum) UnmarshalJSON(data []byte) error {
	var s string
	if err := json.Unmarshal(data, &s); err != nil {
		return err
	}
	...
	case "enhanced_encryption":
		fallthrough
	case "e2ee":
		*e = GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum: %s", s)
	}
}

type GetZRSettings200ApplicationJSON1MeetingSecurity struct {
	// Choose between enhanced encryption and [end-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871) when starting or a meeting. When using end-to-end encryption, several features (e.g. cloud recording, phone/SIP/H.323 dial-in) will be **automatically disabled**. <br><br>The value of this field can be one of the following:<br>
	// `enhanced_encryption`: Enhanced encryption. Encryption is stored in the cloud if you enable this option. <br>
	//
	// `e2ee`: [End-to-end encryption](https://support.zoom.us/hc/en-us/articles/360048660871). The encryption key is stored in your local device and can not be obtained by anyone else. Enabling this setting also **disables** the following features: join before host, cloud recording, streaming, live transcription, breakout rooms, polling, 1:1 private chat, and meeting reactions.
	EncryptionType *GetZRSettings200ApplicationJSON1MeetingSecurityEncryptionTypeEnum `json:"encryption_type,omitempty"`
	// Allow use of end-to-end encryption for meetings. If set to `true`, you can specify the encryption type in `encryption_type` field.
	EndToEndEncryptedMeetings *bool `json:"end_to_end_encrypted_meetings,omitempty"`
}

type GetZRSettings200ApplicationJSON1ZoomRooms struct {
	// Enable multiple participants to [share content simultaneously](https://support.zoom.us/hc/en-us/articles/360017767812-Sharing-Multiple-Screens-in-a-Zoom-Room) by default.
...
type GetZRSettings200ApplicationJSON1 struct {
	MeetingSecurity *GetZRSettings200ApplicationJSON1MeetingSecurity `json:"meeting_security,omitempty"`
	ZoomRooms       *GetZRSettings200ApplicationJSON1ZoomRooms       `json:"zoom_rooms,omitempty"`
}

type GetZRSettings200ApplicationJSONType string

const (
	GetZRSettings200ApplicationJSONTypeGetZRSettings200ApplicationJSON1 GetZRSettings200ApplicationJSONType = "getZRSettings_200ApplicationJSON_1"
	GetZRSettings200ApplicationJSONTypeGetZRSettings200ApplicationJSON2 GetZRSettings200ApplicationJSONType = "getZRSettings_200ApplicationJSON_2"
)

type GetZRSettings200ApplicationJSON struct {
	GetZRSettings200ApplicationJSON1 *GetZRSettings200ApplicationJSON1
	GetZRSettings200ApplicationJSON2 *GetZRSettings200ApplicationJSON2

	Type GetZRSettings200ApplicationJSONType
}

func CreateGetZRSettings200ApplicationJSONGetZRSettings200ApplicationJSON1(getZRSettings200ApplicationJSON1 GetZRSettings200ApplicationJSON1) GetZRSettings200ApplicationJSON {
	typ := GetZRSettings200ApplicationJSONTypeGetZRSettings200ApplicationJSON1

	return GetZRSettings200ApplicationJSON{
		GetZRSettings200ApplicationJSON1: &getZRSettings200ApplicationJSON1,
		Type:                             typ,
	}
}

func CreateGetZRSettings200ApplicationJSONGetZRSettings200ApplicationJSON2(getZRSettings200ApplicationJSON2 GetZRSettings200ApplicationJSON2) GetZRSettings200ApplicationJSON {
	typ := GetZRSettings200ApplicationJSONTypeGetZRSettings200ApplicationJSON2
...
func (u *GetZRSettings200ApplicationJSON) UnmarshalJSON(data []byte) error {
	var d *json.Decoder

	getZRSettings200ApplicationJSON1 := new(GetZRSettings200ApplicationJSON1)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&getZRSettings200ApplicationJSON1); err == nil {
		u.GetZRSettings200ApplicationJSON1 = getZRSettings200ApplicationJSON1
		u.Type = GetZRSettings200ApplicationJSONTypeGetZRSettings200ApplicationJSON1
		return nil
	}

	getZRSettings200ApplicationJSON2 := new(GetZRSettings200ApplicationJSON2)
	d = json.NewDecoder(bytes.NewReader(data))
	d.DisallowUnknownFields()
	if err := d.Decode(&getZRSettings200ApplicationJSON2); err == nil {
		u.GetZRSettings200ApplicationJSON2 = getZRSettings200ApplicationJSON2
		u.Type = GetZRSettings200ApplicationJSONTypeGetZRSettings200ApplicationJSON2
		return nil
	}
...
func (u GetZRSettings200ApplicationJSON) MarshalJSON() ([]byte, error) {
	if u.GetZRSettings200ApplicationJSON1 != nil {
		return json.Marshal(u.GetZRSettings200ApplicationJSON1)
	}

	if u.GetZRSettings200ApplicationJSON2 != nil {
		return json.Marshal(u.GetZRSettings200ApplicationJSON2)
	}
...
type GetZRSettingsResponse struct {
	...
	GetZRSettings200ApplicationJSONObject *GetZRSettings200ApplicationJSON
}
