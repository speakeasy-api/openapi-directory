...
export class DialogflowProjectsLocationsAgentEnvironmentsCreateSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentEnvironmentsCreateSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsAgentEnvironmentsCreateSecurity extends SpeakeasyBase {
...
export class DialogflowProjectsLocationsAgentEnvironmentsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentEnvironmentsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
