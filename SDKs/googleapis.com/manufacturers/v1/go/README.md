...
func main() {
    ...
    res, err := s.Accounts.ManufacturersAccountsLanguagesProductCertificationsDelete(ctx, req, operations.ManufacturersAccountsLanguagesProductCertificationsDeleteSecurity{
