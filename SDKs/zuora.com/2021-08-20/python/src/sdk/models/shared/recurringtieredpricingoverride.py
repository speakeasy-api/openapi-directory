...
class RecurringTieredPricingOverride:
    r"""RecurringTieredPricingOverride
    ...
    list_price_base: Optional[RecurringTieredPricingOverrideListPriceBaseEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('listPriceBase') }})
    price_change_option: Optional[RecurringTieredPricingOverridePriceChangeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceChangeOption') }})
