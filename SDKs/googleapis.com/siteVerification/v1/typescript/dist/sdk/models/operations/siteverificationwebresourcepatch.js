...
exports.SiteVerificationWebResourcePatchResponse = exports.SiteVerificationWebResourcePatchRequest = exports.SiteVerificationWebResourcePatchSecurity = void 0;
...
var SiteVerificationWebResourcePatchRequest = /** @class */ (function (_super) {
    ...
    ], SiteVerificationWebResourcePatchRequest.prototype, "siteVerificationWebResourceResource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], SiteVerificationWebResourcePatchRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], SiteVerificationWebResourcePatchRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], SiteVerificationWebResourcePatchRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], SiteVerificationWebResourcePatchRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], SiteVerificationWebResourcePatchRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], SiteVerificationWebResourcePatchRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], SiteVerificationWebResourcePatchRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], SiteVerificationWebResourcePatchRequest.prototype, "userIp", void 0);
...
var SiteVerificationWebResourcePatchResponse = /** @class */ (function (_super) {
    ...
    ], SiteVerificationWebResourcePatchResponse.prototype, "rawResponse", void 0);
