...
exports.DriveFilesEmptyTrashResponse = exports.DriveFilesEmptyTrashRequest = exports.DriveFilesEmptyTrashSecurity = void 0;
...
exports.DriveFilesEmptyTrashSecurity = DriveFilesEmptyTrashSecurity;
var DriveFilesEmptyTrashRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DriveFilesEmptyTrashRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=enforceSingleParent",
        }),
        __metadata("design:type", Boolean)
    ], DriveFilesEmptyTrashRequest.prototype, "enforceSingleParent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], DriveFilesEmptyTrashRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], DriveFilesEmptyTrashRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], DriveFilesEmptyTrashRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], DriveFilesEmptyTrashRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], DriveFilesEmptyTrashRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], DriveFilesEmptyTrashRequest.prototype, "userIp", void 0);
    return DriveFilesEmptyTrashRequest;
}(utils_1.SpeakeasyBase));
exports.DriveFilesEmptyTrashRequest = DriveFilesEmptyTrashRequest;
var DriveFilesEmptyTrashResponse = /** @class */ (function (_super) {
    ...
    ], DriveFilesEmptyTrashResponse.prototype, "rawResponse", void 0);
    return DriveFilesEmptyTrashResponse;
}(utils_1.SpeakeasyBase));
exports.DriveFilesEmptyTrashResponse = DriveFilesEmptyTrashResponse;
