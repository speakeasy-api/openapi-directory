...
class NSXVManagerDataSourceRequest:
    ...
    credentials: shared_passwordcredentials.PasswordCredentials = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials') }})  
    ...
    vcenter_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('vcenter_id') }})
