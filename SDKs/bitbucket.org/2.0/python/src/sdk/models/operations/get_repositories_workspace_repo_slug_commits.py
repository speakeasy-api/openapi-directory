...
class GetRepositoriesWorkspaceRepoSlugCommitsRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugCommitsPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugCommitsSecurity = dataclasses.field()
