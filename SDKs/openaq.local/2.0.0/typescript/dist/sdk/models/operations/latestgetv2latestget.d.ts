 ...
 * An enumeration.
 */
export declare enum LatestGetV2LatestGetOrderByLocationsOrderEnum {
    City = "city",
    Country = "country",
    Location = "location",
 ...
 * An enumeration.
 */
export declare enum LatestGetV2LatestGetSortSortEnum {
    Asc = "asc",
    Desc = "desc"
}
export declare class LatestGetV2LatestGetRequest extends SpeakeasyBase {
     ...
     * Order by a field
     */
    orderBy?: LatestGetV2LatestGetOrderByLocationsOrderEnum;
    /**
     ...
     * Sort Direction
     */
    sort?: LatestGetV2LatestGetSortSortEnum;
    /**
