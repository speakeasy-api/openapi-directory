...
export class MybusinessAccountsLocationsVerifyRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessAccountsLocationsVerifyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
