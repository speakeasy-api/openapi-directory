...
var WorkspaceCreationProperties = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "CustomSecurityGroupId" }),
        __metadata("design:type", String)
    ], WorkspaceCreationProperties.prototype, "customSecurityGroupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DefaultOu" }),
        __metadata("design:type", String)
    ], WorkspaceCreationProperties.prototype, "defaultOu", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EnableInternetAccess" }),
        __metadata("design:type", Boolean)
    ], WorkspaceCreationProperties.prototype, "enableInternetAccess", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EnableMaintenanceMode" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "UserEnabledAsLocalAdministrator" }),
        __metadata("design:type", Boolean)
