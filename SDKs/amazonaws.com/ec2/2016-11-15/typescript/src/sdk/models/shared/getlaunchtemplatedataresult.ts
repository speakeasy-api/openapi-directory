 ...
 * The volume type.
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappingsEbsVolumeTypeEnum {
  Standard = "standard",
  Io1 = "io1",
  Io2 = "io2",
  Gp2 = "gp2",
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappingsEbs extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappings extends SpeakeasyBase {
  @SpeakeasyMetadata()
  deviceName?: string;
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataCapacityReservationSpecificationCapacityReservationPreferenceEnum {
  Open = "open",
  None = "none",
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataElasticGpuSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  type?: string;
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataElasticInferenceAccelerators extends SpeakeasyBase {
  @SpeakeasyMetadata()
  count?: number;
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceInitiatedShutdownBehaviorEnum {
  Stop = "stop",
  Terminate = "terminate",
}
 ...
 * The market type.
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsMarketTypeEnum {
  Spot = "spot",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsSpotOptionsInstanceInterruptionBehaviorEnum {
  Hibernate = "hibernate",
  Stop = "stop",
  Terminate = "terminate",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsSpotOptionsSpotInstanceTypeEnum {
  OneTime = "one-time",
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorCount extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
...
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorManufacturersEnum {
  Nvidia = "nvidia",
  Amd = "amd",
...
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorNamesEnum {
  A100 = "a100",
  V100 = "v100",
  K80 = "k80",
  T4 = "t4",
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiB extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
...
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorTypesEnum {
  Gpu = "gpu",
  Fpga = "fpga",
  Inference = "inference",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBareMetalEnum {
  Included = "included",
  Required = "required",
  Excluded = "excluded",
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBaselineEbsBandwidthMbps extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBurstablePerformanceEnum {
  Included = "included",
  Required = "required",
  Excluded = "excluded",
}

export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsCpuManufacturersEnum {
  Intel = "intel",
  Amd = "amd",
  AmazonWebServices = "amazon-web-services",
}

export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsInstanceGenerationsEnum {
  Current = "current",
  Previous = "previous",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsLocalStorageEnum {
  Included = "included",
  Required = "required",
  Excluded = "excluded",
}

export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsLocalStorageTypesEnum {
  Hdd = "hdd",
  Ssd = "ssd",
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpu extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsMemoryMiB extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsNetworkBandwidthGbps extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsNetworkInterfaceCount extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsTotalLocalStorageGB extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsVCpuCount extends SpeakeasyBase {
  @SpeakeasyMetadata()
  max?: number;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirements extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 * The instance type.
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataLicenseSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataMaintenanceOptionsAutoRecoveryEnum {
  Default = "default",
  Disabled = "disabled",
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataMaintenanceOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHttpEndpointEnum {
  Disabled = "disabled",
  Enabled = "enabled",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHttpProtocolIpv6Enum {
  Disabled = "disabled",
  Enabled = "enabled",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHttpTokensEnum {
  Optional = "optional",
  Required = "required",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsInstanceMetadataTagsEnum {
  Disabled = "disabled",
  Enabled = "enabled",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsStateEnum {
  Pending = "pending",
  Applied = "applied",
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv4Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv4Prefix?: string;
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Addresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Address?: string;
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Prefixes extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ipv6Prefix?: string;
}
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesPrivateIpAddresses extends SpeakeasyBase {
  @SpeakeasyMetadata()
  primary?: boolean;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfaces extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv4Prefixes,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Addresses,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Prefixes,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesPrivateIpAddresses,
  })
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataPlacementTenancyEnum {
  Default = "default",
  Dedicated = "dedicated",
  Host = "host",
}
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataPrivateDnsNameOptionsHostnameTypeEnum {
  IpName = "ip-name",
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataPrivateDnsNameOptions extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export enum GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class GetLaunchTemplateDataResultLaunchTemplateDataTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsTags,
  })
...
export class GetLaunchTemplateDataResultLaunchTemplateData extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataElasticGpuSpecifications,
  })
  elasticGpuSpecifications?: GetLaunchTemplateDataResultLaunchTemplateDataElasticGpuSpecifications[];

  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataElasticInferenceAccelerators,
  })
  ...
  @SpeakeasyMetadata({
    elemType:
      GetLaunchTemplateDataResultLaunchTemplateDataLicenseSpecifications,
  })
