...
export class CloudassetQueryAssetsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudassetQueryAssetsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudassetQueryAssetsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
