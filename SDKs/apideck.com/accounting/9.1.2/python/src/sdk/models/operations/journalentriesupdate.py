...
from ..shared import updatejournalentryresponse as shared_updatejournalentryresponse
from typing import Optional


@dataclasses.dataclass
class JournalEntriesUpdateSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class JournalEntriesUpdateRequest:
    
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    r"""ID of the record you are acting upon."""  
    journal_entry_input: shared_journalentry.JournalEntryInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class JournalEntriesUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_journal_entry_response: Optional[shared_updatejournalentryresponse.UpdateJournalEntryResponse] = dataclasses.field(default=None)
    r"""JournalEntries"""  
