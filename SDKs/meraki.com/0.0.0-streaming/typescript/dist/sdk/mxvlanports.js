...
exports.MXVLANPorts = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var MXVLANPorts = /** @class */ (function () {
    function MXVLANPorts(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return per-port VLAN settings for a single MX port.
     */
    MXVLANPorts.prototype.getNetworkAppliancePort = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetNetworkAppliancePortRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/networks/{networkId}/appliancePorts/{appliancePortId}", req);
     ...
     * List per-port VLAN settings for all ports of a MX.
     */
    MXVLANPorts.prototype.getNetworkAppliancePorts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetNetworkAppliancePortsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/networks/{networkId}/appliancePorts", req);
        var client = this._securityClient || this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
     ...
     * Update the per-port VLAN settings for a single MX port.
     */
    MXVLANPorts.prototype.updateNetworkAppliancePort = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.MXVLANPorts = MXVLANPorts;
