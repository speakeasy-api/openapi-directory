...
class ValidateResourcePolicyRequest:
    ...
    validate_resource_policy_request: shared_validateresourcepolicyrequest.ValidateResourcePolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
