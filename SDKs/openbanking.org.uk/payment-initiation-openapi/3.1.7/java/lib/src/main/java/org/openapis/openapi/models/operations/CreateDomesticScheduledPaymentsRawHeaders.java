...
public class CreateDomesticScheduledPaymentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateDomesticScheduledPaymentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateDomesticScheduledPaymentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateDomesticScheduledPaymentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateDomesticScheduledPaymentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateDomesticScheduledPaymentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateDomesticScheduledPaymentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateDomesticScheduledPaymentsRawHeaders withXJwsSignature(String xJwsSignature) {
