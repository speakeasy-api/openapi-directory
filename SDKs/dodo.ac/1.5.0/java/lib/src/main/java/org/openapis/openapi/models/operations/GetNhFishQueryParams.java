...
public class GetNhFishQueryParams {
    /**
    ...
    public GetNhFishQueryParams withExcludedetails(String excludedetails) {
    ...
    public String month;
    public GetNhFishQueryParams withMonth(String month) {
        this.month = month;
        return this;
    }
    ...
    public GetNhFishQueryParams withThumbsize(Long thumbsize) {
