...
public class ListMediaProcessorQueryParams {
    ...
    public ListMediaProcessorQueryParams withOrder(org.openapis.openapi.models.shared.MediaProcessorEnumOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public Long page;
    public ListMediaProcessorQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public ListMediaProcessorQueryParams withPageToken(String pageToken) {
    ...
    public ListMediaProcessorQueryParams withStatus(org.openapis.openapi.models.shared.MediaProcessorEnumStatusEnum status) {
        this.status = status;
        return this;
    }
