 ...
 */
export enum UpdateIntegrationResultConnectionTypeEnum {
  Internet = "INTERNET",
  VpcLink = "VPC_LINK",
}
 ...
 */
export enum UpdateIntegrationResultContentHandlingStrategyEnum {
 ...
 */
export enum UpdateIntegrationResultIntegrationTypeEnum {
  Aws = "AWS",
  Http = "HTTP",
  Mock = "MOCK",
 ...
 */
export enum UpdateIntegrationResultPassthroughBehaviorEnum {
...
export class UpdateIntegrationResult extends SpeakeasyBase {
  ...
  @Type(() => UpdateIntegrationResultTlsConfig)
