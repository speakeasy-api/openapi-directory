...
from ..shared import createfindingaggregatorresponse as shared_createfindingaggregatorresponse
...
class CreateFindingAggregatorRequest:
    ...
    request_body: CreateFindingAggregatorRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CreateFindingAggregatorResponse:
    ...
    create_finding_aggregator_response: Optional[shared_createfindingaggregatorresponse.CreateFindingAggregatorResponse] = dataclasses.field(default=None)
    r"""Success"""  
