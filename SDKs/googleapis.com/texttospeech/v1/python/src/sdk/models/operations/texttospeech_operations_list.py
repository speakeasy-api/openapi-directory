...
class TexttospeechOperationsListPathParams:
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class TexttospeechOperationsListQueryParams:
...
@dataclasses.dataclass
class TexttospeechOperationsListSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class TexttospeechOperationsListRequest:
    path_params: TexttospeechOperationsListPathParams = dataclasses.field()
    query_params: TexttospeechOperationsListQueryParams = dataclasses.field()
    security: TexttospeechOperationsListSecurity = dataclasses.field()
    

@dataclasses.dataclass
class TexttospeechOperationsListResponse:
