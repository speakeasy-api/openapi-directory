...
class DriveCommentsPatchSecurity:
    option1: Optional[DriveCommentsPatchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveCommentsPatchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DriveCommentsPatchRequest:
    path_params: DriveCommentsPatchPathParams = dataclasses.field()
    query_params: DriveCommentsPatchQueryParams = dataclasses.field()
    security: DriveCommentsPatchSecurity = dataclasses.field()
