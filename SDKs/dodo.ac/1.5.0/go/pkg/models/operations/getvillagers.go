...
func (e *GetVillagersGameEnum) UnmarshalJSON(data []byte) error {
	...
	case "HHD":
		fallthrough
	case "PC":
		*e = GetVillagersGameEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetVillagersGameEnum: %s", s)
	}
}
...
func (e *GetVillagersPersonalityEnum) UnmarshalJSON(data []byte) error {
	...
	case "snooty":
		fallthrough
	case "sisterly":
		*e = GetVillagersPersonalityEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetVillagersPersonalityEnum: %s", s)
	}
}
...
func (e *GetVillagersSpeciesEnum) UnmarshalJSON(data []byte) error {
	...
	case "tiger":
		fallthrough
	case "wolf":
		*e = GetVillagersSpeciesEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetVillagersSpeciesEnum: %s", s)
	}
}
