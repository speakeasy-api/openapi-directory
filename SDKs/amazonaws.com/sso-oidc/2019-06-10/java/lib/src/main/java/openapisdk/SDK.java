...
public class SDK {
    ...
    public openapisdk.models.operations.CreateTokenResponse createToken(openapisdk.models.operations.CreateTokenRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.CreateTokenResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateTokenResponse.class);
    ...
    **/
    public openapisdk.models.operations.RegisterClientResponse registerClient(openapisdk.models.operations.RegisterClientRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/client/register");
        ...
        openapisdk.models.operations.RegisterClientResponse res = new openapisdk.models.operations.RegisterClientResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.RegisterClientResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.RegisterClientResponse.class);
    ...
    **/
    public openapisdk.models.operations.StartDeviceAuthorizationResponse startDeviceAuthorization(openapisdk.models.operations.StartDeviceAuthorizationRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/device_authorization");
        ...
        openapisdk.models.operations.StartDeviceAuthorizationResponse res = new openapisdk.models.operations.StartDeviceAuthorizationResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.StartDeviceAuthorizationResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.StartDeviceAuthorizationResponse.class);
