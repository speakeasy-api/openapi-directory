...
class EmployeeCustomDateFields
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\EmployeeCustomDateFieldsCategoryEnum $category
     */
	#[\JMS\Serializer\Annotation\SerializedName('category')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\EmployeeCustomDateFieldsCategoryEnum>')]
	...
	{
		$this->category = \OpenAPI\OpenAPI\Models\Shared\EmployeeCustomDateFieldsCategoryEnum::PAYROLL_AND_HR;
		$this->label = "";
		$this->value = "";
	}
}
