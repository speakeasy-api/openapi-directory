...
class ObjectPutSubscriptionPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectPutSubscriptionQueryParams:
...
@dataclasses.dataclass
class ObjectPutSubscriptionHeaders:
...
class ObjectPutSubscriptionRequest:
    headers: ObjectPutSubscriptionHeaders = dataclasses.field()
    path_params: ObjectPutSubscriptionPathParams = dataclasses.field()
    query_params: ObjectPutSubscriptionQueryParams = dataclasses.field()
    request: dict[str, Any] = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class ObjectPutSubscriptionResponse:
