...
class LocationsGetV2LocationsLocationIDGetRequest:
    path_params: LocationsGetV2LocationsLocationIDGetPathParams = dataclasses.field()
    query_params: LocationsGetV2LocationsLocationIDGetQueryParams = dataclasses.field()
