...
public class Webhook {
    ...
    public Webhook(@JsonProperty("delivery_url") String deliveryUrl, @JsonProperty("events") WebhookEventTypeEnum[] events, @JsonProperty("execute_base_url") String executeBaseUrl, @JsonProperty("status") StatusEnum status, @JsonProperty("unified_api") UnifiedApiIdEnum unifiedApi) {
        this.deliveryUrl = deliveryUrl;
        this.events = events;
        this.executeBaseUrl = executeBaseUrl;
        this.status = status;
