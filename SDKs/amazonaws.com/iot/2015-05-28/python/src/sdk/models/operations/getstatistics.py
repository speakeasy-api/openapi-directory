...
class GetStatisticsRequest:
    headers: GetStatisticsHeaders = dataclasses.field()
    request: GetStatisticsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
