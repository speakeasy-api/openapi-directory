...
func (e EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum) ToPointer() *EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum {
	return &e
}
...
func (e *EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "RETRY_ON_HOLD":
		fallthrough
	case "SUSPENDED":
		*e = EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum: %v", v)
	}
}
