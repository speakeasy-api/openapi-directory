...
func (e CompareFacesXAmzTargetEnum) ToPointer() *CompareFacesXAmzTargetEnum {
	return &e
}
...
func (e *CompareFacesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "RekognitionService.CompareFaces":
		*e = CompareFacesXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CompareFacesXAmzTargetEnum: %v", v)
	}
}
