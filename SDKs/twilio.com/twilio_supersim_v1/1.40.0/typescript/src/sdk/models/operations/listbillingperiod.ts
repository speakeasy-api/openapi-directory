...
export class ListBillingPeriodListBillingPeriodResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.SupersimV1SimBillingPeriod })
  @Expose({ name: "billing_periods" })
  @Type(() => shared.SupersimV1SimBillingPeriod)
  billingPeriods?: shared.SupersimV1SimBillingPeriod[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListBillingPeriodListBillingPeriodResponseMeta)
