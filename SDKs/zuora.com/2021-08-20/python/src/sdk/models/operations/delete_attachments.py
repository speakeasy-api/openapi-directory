...
class DeleteAttachmentsRequest:
    headers: DeleteAttachmentsHeaders = dataclasses.field()
    path_params: DeleteAttachmentsPathParams = dataclasses.field()
