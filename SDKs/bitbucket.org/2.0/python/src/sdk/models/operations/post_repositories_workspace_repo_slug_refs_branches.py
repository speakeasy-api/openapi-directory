...
class PostRepositoriesWorkspaceRepoSlugRefsBranchesRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugRefsBranchesPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugRefsBranchesSecurity = dataclasses.field()
