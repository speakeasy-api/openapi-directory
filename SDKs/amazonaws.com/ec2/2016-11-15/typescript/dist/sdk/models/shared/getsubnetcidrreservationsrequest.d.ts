 ...
 */
export declare class GetSubnetCidrReservationsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class GetSubnetCidrReservationsRequest extends SpeakeasyBase {
    dryRun?: boolean;
