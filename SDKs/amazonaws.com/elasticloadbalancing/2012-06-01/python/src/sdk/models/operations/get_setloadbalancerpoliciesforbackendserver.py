...
class GETSetLoadBalancerPoliciesForBackendServerRequest:
    ...
    r"""The port number associated with the EC2 instance."""  
    ...
    r"""The names of the policies. If the list is empty, then all current polices are removed from the EC2 instance."""  
