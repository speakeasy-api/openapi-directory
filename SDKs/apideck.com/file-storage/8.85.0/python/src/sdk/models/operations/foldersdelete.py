...
class FoldersDeleteRequest:
    headers: FoldersDeleteHeaders = dataclasses.field()
    path_params: FoldersDeletePathParams = dataclasses.field()
    query_params: FoldersDeleteQueryParams = dataclasses.field()
    security: FoldersDeleteSecurity = dataclasses.field()
