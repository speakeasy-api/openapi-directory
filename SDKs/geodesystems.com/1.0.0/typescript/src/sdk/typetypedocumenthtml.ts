...
export class TypeTypeDocumentHtml {
  ...
  searchTypeDocumentHtml(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_document_html";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeDocumentHtmlResponse =
        new operations.SearchTypeDocumentHtmlResponse({
