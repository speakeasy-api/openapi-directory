...
class RemoveProjectForTaskRequestBody:
    ...
    data: Optional[shared_taskremoveprojectrequest.TaskRemoveProjectRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    

@dataclasses.dataclass
class RemoveProjectForTaskRequest:
    
    request_body: RemoveProjectForTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The project to remove the task from."""  
...
class RemoveProjectForTask200ApplicationJSON:
    r"""Successfully removed the specified project from the task."""
