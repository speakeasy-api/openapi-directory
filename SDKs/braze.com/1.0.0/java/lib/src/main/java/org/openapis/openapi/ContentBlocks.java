...
public class ContentBlocks {
    ...
    public org.openapis.openapi.models.operations.ListAvailableContentBlocksResponse listAvailableContentBlocks(org.openapis.openapi.models.operations.ListAvailableContentBlocksRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListAvailableContentBlocksQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.SeeContentBlockInformationResponse seeContentBlockInformation(org.openapis.openapi.models.operations.SeeContentBlockInformationRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.SeeContentBlockInformationQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
