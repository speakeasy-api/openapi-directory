...
class DescribeIamInstanceProfileAssociationsRequestFilters:
...
class DescribeIamInstanceProfileAssociationsRequest:
    ...
    filters: Optional[list[DescribeIamInstanceProfileAssociationsRequestFilters]] = dataclasses.field(default=None)  
