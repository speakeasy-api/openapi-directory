...
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#create-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#create-a-check-suite>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#get-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#get-a-check-suite>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#list-check-run-annotations>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#list-check-runs-for-a-git-reference>
...
func main() {
    ...
    res, err := s.Checks.ChecksListForRef(ctx, operations.ChecksListForRefRequest{
        AppID: sdk.Int64(696997),
        CheckName: sdk.String("neque"),
        Filter: operations.ChecksListForRefFilterEnumAll.ToPointer(),
        Owner: "illum",
        Page: sdk.Int64(777408),
        PerPage: sdk.Int64(681359),
        Ref: "eius",
        Repo: "eos",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#list-check-runs-in-a-check-suite>
...
func main() {
    ...
    res, err := s.Checks.ChecksListForSuite(ctx, operations.ChecksListForSuiteRequest{
        CheckName: sdk.String("ab"),
        CheckSuiteID: 587600,
        Filter: operations.ChecksListForSuiteFilterEnumLatest.ToPointer(),
        Owner: "tempora",
        Page: sdk.Int64(892050),
        PerPage: sdk.Int64(370853),
        Repo: "aspernatur",
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#list-check-suites-for-a-git-reference>
...
func main() {
    ...
    res, err := s.Checks.ChecksListSuitesForRef(ctx, operations.ChecksListSuitesForRefRequest{
        AppID: sdk.Int64(779192),
        CheckName: sdk.String("esse"),
        Owner: "recusandae",
        Page: sdk.Int64(44612),
        PerPage: sdk.Int64(715179),
        Ref: "quod",
        Repo: "dignissimos",
    })
    if err != nil {
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#rerequest-a-check-run>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#rerequest-a-check-suite>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#update-repository-preferences-for-check-suites>
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/checks#update-a-check-run>
