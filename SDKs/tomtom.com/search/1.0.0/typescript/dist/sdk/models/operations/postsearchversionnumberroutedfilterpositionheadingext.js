...
var PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBodyPoiList,
        }),
...
var PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest = /** @class */ (function (_super) {
    ...
    ], PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=ext" }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest.prototype, "ext", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=heading",
        }),
        __metadata("design:type", Number)
    ], PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest.prototype, "heading", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=position",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest.prototype, "position", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=routingTimeout",
        }),
        __metadata("design:type", Number)
    ], PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest.prototype, "routingTimeout", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=versionNumber",
        }),
        __metadata("design:type", String)
    ], PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest.prototype, "versionNumber", void 0);
...
var PostSearchVersionNumberRoutedFilterPositionHeadingExtResponse = /** @class */ (function (_super) {
    ...
    ], PostSearchVersionNumberRoutedFilterPositionHeadingExtResponse.prototype, "rawResponse", void 0);
