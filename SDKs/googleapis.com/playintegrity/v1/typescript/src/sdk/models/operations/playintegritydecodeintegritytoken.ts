...
export class PlayintegrityDecodeIntegrityTokenSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PlayintegrityDecodeIntegrityTokenRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PlayintegrityDecodeIntegrityTokenResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
