...
class RegistryCredential:
    ...
    credential: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('credential') }})
    credential_provider: shared_credentialprovidertype_enum.CredentialProviderTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('credentialProvider') }})
