 ...
 */
public enum UpdateNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum {
    ...
    private UpdateNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum(String value) {
        this.value = value;
    }
}
