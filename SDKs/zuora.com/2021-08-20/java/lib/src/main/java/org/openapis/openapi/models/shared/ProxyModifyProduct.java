...
public class ProxyModifyProduct {
    ...
    public ProxyModifyProduct withAllowFeatureChanges(Boolean allowFeatureChanges) {
    ...
    public ProxyModifyProduct withCategory(String category) {
    ...
    public ProxyModifyProduct withDescription(String description) {
    ...
    public ProxyModifyProduct withEffectiveEndDate(LocalDate effectiveEndDate) {
    ...
    public ProxyModifyProduct withEffectiveStartDate(LocalDate effectiveStartDate) {
    ...
    public ProxyModifyProduct withIntegrationIdNS(String integrationIdNS) {
    ...
    public ProxyModifyProduct withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public ProxyModifyProductItemTypeNSEnum itemTypeNS;
    public ProxyModifyProduct withItemTypeNS(ProxyModifyProductItemTypeNSEnum itemTypeNS) {
    ...
    @JsonProperty("Name")
    public String name;
    public ProxyModifyProduct withName(String name) {
        this.name = name;
        return this;
    }
    ...
    @JsonProperty("SKU")
    public String sku;
    public ProxyModifyProduct withSku(String sku) {
        this.sku = sku;
        return this;
    }
    ...
    public ProxyModifyProduct withSyncDateNS(String syncDateNS) {
