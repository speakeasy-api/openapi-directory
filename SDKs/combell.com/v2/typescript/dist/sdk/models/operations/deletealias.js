...
var DeleteAliasRequest = /** @class */ (function (_super) {
    ...
    ], DeleteAliasRequest.prototype, "domainNamePathParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=domain_name",
        }),
        __metadata("design:type", String)
    ], DeleteAliasRequest.prototype, "domainNameQueryParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=emailAddress",
        }),
        __metadata("design:type", String)
    ], DeleteAliasRequest.prototype, "emailAddressPathParameter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=email_address",
        }),
        __metadata("design:type", String)
    ], DeleteAliasRequest.prototype, "emailAddressQueryParameter", void 0);
