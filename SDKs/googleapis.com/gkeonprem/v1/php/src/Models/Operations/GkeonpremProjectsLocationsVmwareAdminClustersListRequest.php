...
class GkeonpremProjectsLocationsVmwareAdminClustersListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GkeonpremProjectsLocationsVmwareAdminClustersListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?GkeonpremProjectsLocationsVmwareAdminClustersListViewEnum $view = null;
