...
type PolicytroubleshooterIamTroubleshootRequest struct {
	...
	GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest *shared.GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest `request:"mediaType=application/json"`
	// OAuth access token.
