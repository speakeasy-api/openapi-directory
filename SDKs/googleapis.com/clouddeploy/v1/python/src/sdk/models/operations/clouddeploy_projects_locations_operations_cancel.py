...
@dataclasses.dataclass
class ClouddeployProjectsLocationsOperationsCancelQueryParams:
...
class ClouddeployProjectsLocationsOperationsCancelRequest:
    path_params: ClouddeployProjectsLocationsOperationsCancelPathParams = dataclasses.field()
    query_params: ClouddeployProjectsLocationsOperationsCancelQueryParams = dataclasses.field()
    security: ClouddeployProjectsLocationsOperationsCancelSecurity = dataclasses.field()
