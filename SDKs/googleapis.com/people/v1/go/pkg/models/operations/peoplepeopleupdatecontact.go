...
func (e PeoplePeopleUpdateContactSourcesEnum) ToPointer() *PeoplePeopleUpdateContactSourcesEnum {
	return &e
}

func (e *PeoplePeopleUpdateContactSourcesEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "READ_SOURCE_TYPE_DOMAIN_CONTACT":
		*e = PeoplePeopleUpdateContactSourcesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PeoplePeopleUpdateContactSourcesEnum: %v", v)
	}
}
