...
var Head = /** @class */ (function () {
    function Head(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Head.prototype.headKeyPk = function (req, config) {
    ...
    **/
    Head.prototype.signRetrieveHead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
