...
class GkeonpremProjectsLocationsVmwareClustersVmwareNodePoolsCreateRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\VmwareNodePoolInput $vmwareNodePoolInput = null;
     ...
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=vmwareNodePoolId')]
    public ?string $vmwareNodePoolId = null;
    
	public function __construct()
	{
		$this->dollarXgafv = null;
		$this->vmwareNodePoolInput = null;
