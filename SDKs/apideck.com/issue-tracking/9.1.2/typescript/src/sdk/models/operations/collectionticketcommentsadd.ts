...
export class CollectionTicketCommentsAddSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CollectionTicketCommentsAddRequest extends SpeakeasyBase {
...
export class CollectionTicketCommentsAddResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
