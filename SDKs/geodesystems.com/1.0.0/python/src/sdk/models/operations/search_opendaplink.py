...
class SearchOpendaplinkQueryParams:
...
@dataclasses.dataclass
class SearchOpendaplinkRequest:
    query_params: SearchOpendaplinkQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchOpendaplinkResponse:
