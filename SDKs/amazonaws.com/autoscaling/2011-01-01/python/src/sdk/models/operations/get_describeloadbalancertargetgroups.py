...
class GetDescribeLoadBalancerTargetGroupsQueryParams:
    action: GetDescribeLoadBalancerTargetGroupsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDescribeLoadBalancerTargetGroupsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeLoadBalancerTargetGroupsRequest:
    headers: GetDescribeLoadBalancerTargetGroupsHeaders = dataclasses.field()
    query_params: GetDescribeLoadBalancerTargetGroupsQueryParams = dataclasses.field()
