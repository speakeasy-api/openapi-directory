...
var Calendars = /** @class */ (function () {
    ...
    **/
    Calendars.prototype.calendarCalendarsClear = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CalendarCalendarsClearRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/calendars/{calendarId}/clear", req.pathParams);
    ...
    **/
    Calendars.prototype.calendarCalendarsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CalendarCalendarsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/calendars/{calendarId}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    **/
    Calendars.prototype.calendarCalendarsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Calendars.prototype.calendarCalendarsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Calendars.prototype.calendarCalendarsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Calendars.prototype.calendarCalendarsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
