...
export class VersionhistoryPlatformsChannelsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class VersionhistoryPlatformsChannelsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
