...
class POSTCreateNotificationDefinitionRequest:
    ...
    """  
    post_public_notification_definition_request: shared_postpublicnotificationdefinitionrequest.POSTPublicNotificationDefinitionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
