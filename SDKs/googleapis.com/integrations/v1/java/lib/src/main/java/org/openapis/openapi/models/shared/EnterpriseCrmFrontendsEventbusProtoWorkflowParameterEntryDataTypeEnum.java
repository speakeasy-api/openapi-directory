 ...
 */
public enum EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryDataTypeEnum {
    ...
    private EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntryDataTypeEnum(String value) {
        this.value = value;
    }
}
