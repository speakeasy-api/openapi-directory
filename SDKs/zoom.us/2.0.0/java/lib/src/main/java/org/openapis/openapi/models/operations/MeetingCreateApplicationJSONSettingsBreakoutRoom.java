 ...
 */
public class MeetingCreateApplicationJSONSettingsBreakoutRoom {
    /**
    ...
    public MeetingCreateApplicationJSONSettingsBreakoutRoom withEnable(Boolean enable) {
        this.enable = enable;
        return this;
    }
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("rooms")
    public MeetingCreateApplicationJSONSettingsBreakoutRoomRooms[] rooms;
    public MeetingCreateApplicationJSONSettingsBreakoutRoom withRooms(MeetingCreateApplicationJSONSettingsBreakoutRoomRooms[] rooms) {
        this.rooms = rooms;
        return this;
    }
