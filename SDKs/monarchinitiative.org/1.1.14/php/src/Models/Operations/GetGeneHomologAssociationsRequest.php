...
class GetGeneHomologAssociationsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGeneHomologAssociationsHomologyTypeEnum $homologyType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=homology_type')]
    public ?GetGeneHomologAssociationsHomologyTypeEnum $homologyType = null;
