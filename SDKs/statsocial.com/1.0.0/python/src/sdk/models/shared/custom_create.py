...
import dataclasses
from ..shared import custom_create_response as shared_custom_create_response
...
class CustomCreate:
    ...
    data: Optional[shared_custom_create_response.CustomCreateResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
