...
func main() {
    ...
    res, err := s.General.PostAccountHolderTransactionList(ctx, shared.AccountHolderTransactionListRequest{
        ...
        TransactionListsPerAccount: []shared.TransactionListForAccountWrapper{
            shared.TransactionListForAccountWrapper{
                TransactionListForAccount: &shared.TransactionListForAccount{
                    AccountCode: "unde",
                    Page: 857946,
                },
            },
...
func main() {
    ...
    res, err := s.General.PostRefundFundsTransfer(ctx, shared.RefundFundsTransferRequest{
        ...
        MerchantReference: sdk.String("optio"),
        OriginalReference: "totam",
...
func main() {
    ...
    res, err := s.General.PostSetupBeneficiary(ctx, shared.SetupBeneficiaryRequest{
        DestinationAccountCode: "molestiae",
        MerchantReference: sdk.String("modi"),
        SourceAccountCode: "qui",
...
func main() {
    ...
    res, err := s.General.PostTransferFunds(ctx, shared.TransferFundsRequest{
        ...
        DestinationAccountCode: "esse",
        MerchantReference: sdk.String("ipsum"),
        SourceAccountCode: "excepturi",
        TransferCode: "aspernatur",
