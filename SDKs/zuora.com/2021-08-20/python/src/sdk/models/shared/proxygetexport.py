...
class ProxyGetExport:
    ...
    **Character limit**: **Values**: a list of valid currency codes
    ...
    r"""The user ID of the person who created the export.
    ...
    **Character limit**: 32 **Values**: automatically generated
    """  
    format: Optional[ProxyGetExportFormatEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Format'), 'exclude': lambda f: f is None }})
    r"""The format that you want the export file to use.
    **Character limit**: 5
    """  
    ...
    **Character limi**t: 255 **Values**: automatically generated
    ...
    r"""The ID of the user who last updated the export.
    **Character limit**: 32 **Values**: automatically generated
    """  
    ...
    r"""The date when the expotr was last updated.
    **Character limit**: 29 **Values**: automatically generated
    """  
