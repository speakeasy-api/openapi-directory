...
var IpamAggregatesListQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date_added__gt" }),
        __metadata("design:type", String)
    ], IpamAggregatesListQueryParams.prototype, "dateAddedGt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date_added__gte" }),
        __metadata("design:type", String)
    ], IpamAggregatesListQueryParams.prototype, "dateAddedGte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date_added__lt" }),
        __metadata("design:type", String)
    ], IpamAggregatesListQueryParams.prototype, "dateAddedLt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date_added__lte" }),
        __metadata("design:type", String)
    ], IpamAggregatesListQueryParams.prototype, "dateAddedLte", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date_added__n" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rir__n" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rir_id__n" }),
        __metadata("design:type", String)
