...
public class OptionsTransactionHashResponse {
    ...
    public OptionsTransactionHashResponse withStatusCode(Integer statusCode) {
    ...
    public OptionsTransactionHashResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public OptionsTransactionHashResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
