...
public class ResendPayeeInviteV3Request {
    ...
    public ResendPayeeInviteV3Request(@JsonProperty("InvitePayeeRequestV3") org.openapis.openapi.models.shared.InvitePayeeRequestV3 invitePayeeRequestV3, @JsonProperty("payeeId") String payeeId) {
        this.invitePayeeRequestV3 = invitePayeeRequestV3;
        this.payeeId = payeeId;
  }
}
