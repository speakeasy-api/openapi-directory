...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateBlobRequest req = new GitCreateBlobRequest(                new GitCreateBlobRequestBody("exercitationem") {{
                                encoding = "earum";
                            }};, "facere", "numquam");            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            GitCreateCommitRequest req = new GitCreateCommitRequest(                new GitCreateCommitRequestBody("doloribus", "suscipit") {{
                                author = new GitCreateCommitRequestBodyAuthor("reiciendis", "quidem") {{
                                    date = OffsetDateTime.parse("2020-04-23T16:59:51.275Z");
                                }};;
