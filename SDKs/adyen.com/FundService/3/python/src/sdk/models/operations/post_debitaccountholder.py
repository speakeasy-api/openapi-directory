...
from ..shared import debitaccountholderresponse as shared_debitaccountholderresponse
...
class PostDebitAccountHolderResponse:
    ...
    debit_account_holder_response: Optional[shared_debitaccountholderresponse.DebitAccountHolderResponse] = dataclasses.field(default=None)
