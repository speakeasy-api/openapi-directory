...
func (e CreateCallCreateCallRequestAsyncAmdStatusCallbackMethodEnum) ToPointer() *CreateCallCreateCallRequestAsyncAmdStatusCallbackMethodEnum {
	return &e
}

func (e *CreateCallCreateCallRequestAsyncAmdStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCallCreateCallRequestAsyncAmdStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCallCreateCallRequestAsyncAmdStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e CreateCallCreateCallRequestFallbackMethodEnum) ToPointer() *CreateCallCreateCallRequestFallbackMethodEnum {
	return &e
}

func (e *CreateCallCreateCallRequestFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCallCreateCallRequestFallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCallCreateCallRequestFallbackMethodEnum: %v", v)
	}
}
...
func (e CreateCallCreateCallRequestMethodEnum) ToPointer() *CreateCallCreateCallRequestMethodEnum {
	return &e
}

func (e *CreateCallCreateCallRequestMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCallCreateCallRequestMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCallCreateCallRequestMethodEnum: %v", v)
	}
}
...
func (e CreateCallCreateCallRequestRecordingStatusCallbackMethodEnum) ToPointer() *CreateCallCreateCallRequestRecordingStatusCallbackMethodEnum {
	return &e
}

func (e *CreateCallCreateCallRequestRecordingStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCallCreateCallRequestRecordingStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCallCreateCallRequestRecordingStatusCallbackMethodEnum: %v", v)
	}
}
...
func (e CreateCallCreateCallRequestStatusCallbackMethodEnum) ToPointer() *CreateCallCreateCallRequestStatusCallbackMethodEnum {
	return &e
}

func (e *CreateCallCreateCallRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCallCreateCallRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCallCreateCallRequestStatusCallbackMethodEnum: %v", v)
	}
}
