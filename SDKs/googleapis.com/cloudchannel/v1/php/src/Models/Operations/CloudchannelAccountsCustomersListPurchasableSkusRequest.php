...
class CloudchannelAccountsCustomersListPurchasableSkusRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CloudchannelAccountsCustomersListPurchasableSkusChangeOfferPurchaseChangeTypeEnum $changeOfferPurchaseChangeType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=changeOfferPurchase.changeType')]
    public ?CloudchannelAccountsCustomersListPurchasableSkusChangeOfferPurchaseChangeTypeEnum $changeOfferPurchaseChangeType = null;
     ...
     * 
     * @var ?string $createEntitlementPurchaseProduct
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=createEntitlementPurchase.product')]
    public ?string $createEntitlementPurchaseProduct = null;
	...
	public function __construct()
	{
		...
		$this->alt = null;
		$this->callback = null;
		$this->changeOfferPurchaseChangeType = null;
		$this->changeOfferPurchaseEntitlement = null;
		$this->createEntitlementPurchaseProduct = null;
		$this->customer = "";
		$this->fields = null;
		$this->key = null;
