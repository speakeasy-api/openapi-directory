...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeletePathParams:
    ...
    targeting_type: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteQueryParams:
...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteRequest:
    path_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeletePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteSecurity = dataclasses.field()
