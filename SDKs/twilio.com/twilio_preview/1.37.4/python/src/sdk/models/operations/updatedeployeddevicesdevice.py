...
class UpdateDeployedDevicesDeviceRequest:
    path_params: UpdateDeployedDevicesDevicePathParams = dataclasses.field()
    security: UpdateDeployedDevicesDeviceSecurity = dataclasses.field()
    request: Optional[UpdateDeployedDevicesDeviceUpdateDeployedDevicesDeviceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
