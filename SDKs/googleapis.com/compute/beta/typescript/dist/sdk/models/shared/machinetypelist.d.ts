 ...
 */
export declare enum MachineTypeListWarningCodeEnum {
...
export declare class MachineTypeListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class MachineTypeListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class MachineTypeList extends SpeakeasyBase {
    /**
