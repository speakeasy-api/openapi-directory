...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/revenueodisha/3.0.0/go
```
...
* [Rdcer](docs/apis/README.md#rdcer) - Copy of Registered Deed
* [Ror1b](docs/apis/README.md#ror1b) - Records of Rights
