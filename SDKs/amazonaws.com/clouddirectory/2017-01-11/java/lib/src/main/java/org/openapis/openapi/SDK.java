...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.ListManagedSchemaArnsResponse listManagedSchemaArns(org.openapis.openapi.models.operations.ListManagedSchemaArnsRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ListManagedSchemaArnsRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
