...
class WebhookEntry:
    ...
    trigger_scope: WebhookEntryTriggerScopeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('triggerScope') }})
    ...
    invoke_option: Optional[WebhookEntryInvokeOptionEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('invokeOption') }})
