...
public class ImportationDeleteCustomColumnRequest {
    ...
    public ImportationDeleteCustomColumnRequest(@JsonProperty("columnId") String columnId, @JsonProperty("executionId") String executionId, @JsonProperty("storeId") String storeId) {
        this.columnId = columnId;
        this.executionId = executionId;
        this.storeId = storeId;
  }
