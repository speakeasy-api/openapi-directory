...
class LoyaltyObjectListResponse:
    ...
    resources: Optional[list[shared_loyaltyobject.LoyaltyObject]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('resources'), 'exclude': lambda f: f is None }})
