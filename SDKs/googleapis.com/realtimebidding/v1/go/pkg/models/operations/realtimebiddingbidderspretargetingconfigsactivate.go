...
type RealtimebiddingBiddersPretargetingConfigsActivateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RealtimebiddingBiddersPretargetingConfigsActivatePathParams struct {
...
type RealtimebiddingBiddersPretargetingConfigsActivateQueryParams struct {
	// V1 error format.
...
type RealtimebiddingBiddersPretargetingConfigsActivateRequest struct {
...
type RealtimebiddingBiddersPretargetingConfigsActivateResponse struct {
	ContentType string
	// Successful response
