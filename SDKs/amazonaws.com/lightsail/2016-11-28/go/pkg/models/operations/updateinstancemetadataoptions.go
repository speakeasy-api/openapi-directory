...
type UpdateInstanceMetadataOptionsHeaders struct {
...
type UpdateInstanceMetadataOptionsRequest struct {
	Headers UpdateInstanceMetadataOptionsHeaders
	Request shared.UpdateInstanceMetadataOptionsRequest `request:"mediaType=application/json"`
}
