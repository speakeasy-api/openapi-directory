 ...
 */
export declare enum CommitmentListWarningCodeEnum {
...
export declare class CommitmentListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class CommitmentListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class CommitmentList extends SpeakeasyBase {
    /**
