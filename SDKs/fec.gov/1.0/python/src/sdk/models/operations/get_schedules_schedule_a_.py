...
class GetSchedulesScheduleAQueryParams:
    ...
    contributor_type: Optional[list[GetSchedulesScheduleAContributorTypeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'contributor_type', 'style': 'form', 'explode': True }})
    ...
    recipient_committee_designation: Optional[list[GetSchedulesScheduleARecipientCommitteeDesignationEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'recipient_committee_designation', 'style': 'form', 'explode': True }})
    recipient_committee_org_type: Optional[list[GetSchedulesScheduleARecipientCommitteeOrgTypeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'recipient_committee_org_type', 'style': 'form', 'explode': True }})
    recipient_committee_type: Optional[list[GetSchedulesScheduleARecipientCommitteeTypeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'recipient_committee_type', 'style': 'form', 'explode': True }})
...
class GetSchedulesScheduleARequest:
    query_params: GetSchedulesScheduleAQueryParams = dataclasses.field()
