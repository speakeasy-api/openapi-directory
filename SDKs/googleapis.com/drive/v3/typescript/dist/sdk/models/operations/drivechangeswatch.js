...
var DriveChangesWatchQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=includeCorpusRemovals" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=includeRemoved" }),
        __metadata("design:type", Boolean)
    ], DriveChangesWatchQueryParams.prototype, "includeRemoved", void 0);
    __decorate([
    ...
    ], DriveChangesWatchQueryParams.prototype, "pageSize", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=restrictToMyDrive" }),
        __metadata("design:type", Boolean)
    ], DriveChangesWatchQueryParams.prototype, "restrictToMyDrive", void 0);
    __decorate([
...
exports.DriveChangesWatchQueryParams = DriveChangesWatchQueryParams;
