...
type GkehubProjectsLocationsFleetsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GkehubProjectsLocationsFleetsListPathParams struct {
...
type GkehubProjectsLocationsFleetsListQueryParams struct {
	// V1 error format.
...
type GkehubProjectsLocationsFleetsListRequest struct {
...
type GkehubProjectsLocationsFleetsListResponse struct {
	ContentType string
	// Successful response
