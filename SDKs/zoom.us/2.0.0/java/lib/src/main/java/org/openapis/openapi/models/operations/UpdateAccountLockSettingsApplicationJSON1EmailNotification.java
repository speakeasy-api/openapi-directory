...
public class UpdateAccountLockSettingsApplicationJSON1EmailNotification {
    /**
    ...
    public UpdateAccountLockSettingsApplicationJSON1EmailNotification withAlternativeHostReminder(Boolean alternativeHostReminder) {
    ...
    public UpdateAccountLockSettingsApplicationJSON1EmailNotification withCancelMeetingReminder(Boolean cancelMeetingReminder) {
    ...
    public UpdateAccountLockSettingsApplicationJSON1EmailNotification withCloudRecordingAvailableReminder(Boolean cloudRecordingAvailableReminder) {
    ...
    public UpdateAccountLockSettingsApplicationJSON1EmailNotification withJbhReminder(Boolean jbhReminder) {
    ...
    public UpdateAccountLockSettingsApplicationJSON1EmailNotification withScheduleForHostReminder(Boolean scheduleForHostReminder) {
