...
> The `Cancel order` resource is needed to use this API request. This is included in `OMS - Full access` and `IntegrationProfile - Fulfillment Oms`, among other default roles available in the Admin. Learn more about the [License manager roles and resources](https://help.vtex.com/en/tutorial/roles--7HKK5Uau2H6wxE1rH5oRbc#).
   */
  cancelOrder2(
    req: operations.CancelOrder2Request,
    config?: AxiosRequestConfig
  ): Promise<operations.CancelOrder2Response> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CancelOrder2Request(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CancelOrder2Response =
        new operations.CancelOrder2Response({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.cancelOrder2200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.CancelOrder2200ApplicationJSON
            );
          }
          break;
...
## Request object has the following properties:
   ...
   */
  getOrder2(
    req: operations.GetOrder2Request,
    config?: AxiosRequestConfig
  ): Promise<operations.GetOrder2Response> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetOrder2Request(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetOrder2Response =
        new operations.GetOrder2Response({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getOrder2200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetOrder2200ApplicationJSON
            );
          }
          break;
      }
...
| Attribute    | Type        | Description |
   ...
   */
  listOrders2(
    req: operations.ListOrders2Request,
    config?: AxiosRequestConfig
  ): Promise<operations.ListOrders2Response> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ListOrders2Request(req);
    }

    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/api/orders/extendsearch/orders";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListOrders2Response =
        new operations.ListOrders2Response({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (
            ...
            res.listOrders = utils.objectToClass(
              httpRes?.data,
              shared.ListOrders
            );
          }
...
> The `Change order workflow status` resource is needed to use this API request. This is included in `OMS - Full access` and `IntegrationProfile - Fulfillment Oms`, among other default roles available in the Admin. Learn more about the [License manager roles and resources](https://help.vtex.com/en/tutorial/roles--7HKK5Uau2H6wxE1rH5oRbc#).
   */
  startHandling2(
    req: operations.StartHandling2Request,
    config?: AxiosRequestConfig
  ): Promise<operations.StartHandling2Response> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.StartHandling2Request(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StartHandling2Response =
        new operations.StartHandling2Response({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case [204, 403, 404, 429].includes(httpRes?.status):
          break;
      }
