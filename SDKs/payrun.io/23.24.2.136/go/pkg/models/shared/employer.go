...
func (e EmployerEmployerHmrcSettingsSenderEnum) ToPointer() *EmployerEmployerHmrcSettingsSenderEnum {
	return &e
}
...
func (e *EmployerEmployerHmrcSettingsSenderEnum) UnmarshalJSON(data []byte) error {
	...
	case "ActingInCapacity":
		fallthrough
	case "Other":
		*e = EmployerEmployerHmrcSettingsSenderEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployerEmployerHmrcSettingsSenderEnum: %v", v)
	}
}
...
func (e EmployerEmployerHmrcSettingsStateAidSectorEnum) ToPointer() *EmployerEmployerHmrcSettingsStateAidSectorEnum {
	return &e
}
...
func (e *EmployerEmployerHmrcSettingsStateAidSectorEnum) UnmarshalJSON(data []byte) error {
	...
	case "Industrial":
		fallthrough
	case "NotApplicable":
		*e = EmployerEmployerHmrcSettingsStateAidSectorEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployerEmployerHmrcSettingsStateAidSectorEnum: %v", v)
	}
}
...
func (e EmployerEmployerRegionEnum) ToPointer() *EmployerEmployerRegionEnum {
	return &e
}
...
func (e *EmployerEmployerRegionEnum) UnmarshalJSON(data []byte) error {
	...
	case "Scotland":
		fallthrough
	case "Wales":
		*e = EmployerEmployerRegionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployerEmployerRegionEnum: %v", v)
	}
}
...
func (e EmployerEmployerRuleExclusionsEnum) ToPointer() *EmployerEmployerRuleExclusionsEnum {
	return &e
}
...
func (e *EmployerEmployerRuleExclusionsEnum) UnmarshalJSON(data []byte) error {
	...
	case "BenefitInstructionAutoEndRule":
		*e = EmployerEmployerRuleExclusionsEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployerEmployerRuleExclusionsEnum: %v", v)
	}
}
...
func (e EmployerEmployerTerritoryEnum) ToPointer() *EmployerEmployerTerritoryEnum {
	return &e
}
...
func (e *EmployerEmployerTerritoryEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "UnitedKingdom":
		*e = EmployerEmployerTerritoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for EmployerEmployerTerritoryEnum: %v", v)
	}
}
