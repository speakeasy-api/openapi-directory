...
class CreateDomainAssociationRequestBody:
    ...
    r"""The domain name for the domain association."""  
    sub_domain_settings: list[shared_subdomainsetting.SubDomainSetting] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subDomainSettings') }})
    r"""The setting for the subdomain."""  
...
class CreateDomainAssociationRequest:
    ...
    request_body: CreateDomainAssociationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
