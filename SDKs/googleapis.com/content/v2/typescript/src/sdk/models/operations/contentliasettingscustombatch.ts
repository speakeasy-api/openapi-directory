...
export class ContentLiasettingsCustombatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentLiasettingsCustombatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentLiasettingsCustombatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
