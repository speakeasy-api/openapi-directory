...
class LocationResultAddressStateEnum(str, Enum):
    AK = "AK"
    AL = "AL"
    AR = "AR"
    AS = "AS"
...
class LocationResultAddress:
    r"""LocationResultAddress
    Address of the group location
    """
    
    city: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('city') }})
    state: LocationResultAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
...
class LocationResult:
    address: LocationResultAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('address') }})
    billing_location: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('billing_location') }})
