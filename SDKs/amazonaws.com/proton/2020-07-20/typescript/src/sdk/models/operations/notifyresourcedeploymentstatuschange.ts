...
export enum NotifyResourceDeploymentStatusChangeXAmzTargetEnum {
  AwsProton20200720NotifyResourceDeploymentStatusChange = "AwsProton20200720.NotifyResourceDeploymentStatusChange",
}

export class NotifyResourceDeploymentStatusChangeRequest extends SpeakeasyBase {
...
export class NotifyResourceDeploymentStatusChangeResponse extends SpeakeasyBase {
  /**
