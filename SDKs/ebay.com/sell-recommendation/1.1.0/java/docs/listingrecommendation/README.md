...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            FindListingRecommendationsRequest req = new FindListingRecommendationsRequest("error") {{
            ...
            FindListingRecommendationsResponse res = sdk.listingRecommendation.findListingRecommendations(req, new FindListingRecommendationsSecurity("tempora") {{
