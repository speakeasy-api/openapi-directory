...
var Pathway = /** @class */ (function () {
    function Pathway(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Pathway.prototype.getPathwaysWithDiagramsForCategoryUsingGet = function (req, config) {
    ...
    **/
    Pathway.prototype.searchPathwaysUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
