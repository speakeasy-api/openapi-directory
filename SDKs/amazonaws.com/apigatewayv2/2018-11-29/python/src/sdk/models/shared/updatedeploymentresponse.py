...
class UpdateDeploymentResponseDeploymentStatusEnum(str, Enum):
...
class UpdateDeploymentResponse:
    ...
    deployment_status: Optional[UpdateDeploymentResponseDeploymentStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('DeploymentStatus'), 'exclude': lambda f: f is None }})  
