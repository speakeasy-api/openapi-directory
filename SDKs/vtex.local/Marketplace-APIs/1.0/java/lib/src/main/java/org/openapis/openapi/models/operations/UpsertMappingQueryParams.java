...
public class UpsertMappingQueryParams {
    /**
    ...
    public UpsertMappingQueryParams withAccountName(String accountName) {
    ...
    public String an;
    public UpsertMappingQueryParams withAn(String an) {
        this.an = an;
        return this;
    }
    ...
    public UpsertMappingQueryParams withEnvironment(String environment) {
