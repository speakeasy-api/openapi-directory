...
class PatchDeveloperAccountsDeveloperAccountIDRequest:
    path_params: PatchDeveloperAccountsDeveloperAccountIDPathParams = dataclasses.field()
    query_params: PatchDeveloperAccountsDeveloperAccountIDQueryParams = dataclasses.field()
