 ...
 */
export declare class SearchTransitGatewayRoutesRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class SearchTransitGatewayRoutesRequest extends SpeakeasyBase {
    dryRun?: boolean;
