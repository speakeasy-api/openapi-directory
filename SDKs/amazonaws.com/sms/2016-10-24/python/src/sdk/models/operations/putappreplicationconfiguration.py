...
class PutAppReplicationConfigurationRequest:
    ...
    put_app_replication_configuration_request: shared_putappreplicationconfigurationrequest.PutAppReplicationConfigurationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
