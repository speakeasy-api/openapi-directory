...
class AssociateMemberToGroupRequest:
    ...
    associate_member_to_group_request: shared_associatemembertogrouprequest.AssociateMemberToGroupRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
