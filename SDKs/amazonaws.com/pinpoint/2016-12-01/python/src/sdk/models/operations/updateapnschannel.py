...
class UpdateAPNSChannelRequestBodyAPNSChannelRequest:
    r"""Specifies the status and settings of the APNs (Apple Push Notification service) channel for an application."""
...
class UpdateApnsChannelRequestBody:
    ...
    apns_channel_request: UpdateAPNSChannelRequestBodyAPNSChannelRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('APNSChannelRequest') }})
    r"""Specifies the status and settings of the APNs (Apple Push Notification service) channel for an application."""  
...
class UpdateApnsChannelRequest:
    ...
    request_body: UpdateApnsChannelRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
