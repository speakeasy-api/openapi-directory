...
class LinkTokenCreateRequestAuth:
    ...
    flow_type: Optional[LinkTokenCreateRequestAuthFlowTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flow_type'), 'exclude': lambda f: f is None }})
    r"""This field has been deprecated in favor of `auth_type_select_enabled`."""  
