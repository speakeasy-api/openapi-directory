...
class Git:
    ...
    def git_create_blob(self, request: operations.GitCreateBlobRequest) -> operations.GitCreateBlobResponse:
        ...
        url = utils.generate_url(operations.GitCreateBlobRequest, base_url, '/repos/{owner}/{repo}/git/blobs', request)
        ...
        res = operations.GitCreateBlobResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ShortBlob])
                res.short_blob = out
    ...
    def git_create_commit(self, request: operations.GitCreateCommitRequest) -> operations.GitCreateCommitResponse:
        ...
        **Signature verification object**
        ...
        url = utils.generate_url(operations.GitCreateCommitRequest, base_url, '/repos/{owner}/{repo}/git/commits', request)
        ...
        res = operations.GitCreateCommitResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def git_create_ref(self, request: operations.GitCreateRefRequest) -> operations.GitCreateRefResponse:
        ...
        url = utils.generate_url(operations.GitCreateRefRequest, base_url, '/repos/{owner}/{repo}/git/refs', request)
        ...
        res = operations.GitCreateRefResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GitRef])
                res.git_ref = out
        elif http_res.status_code == 422:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ValidationError])
    ...
    def git_create_tag(self, request: operations.GitCreateTagRequest) -> operations.GitCreateTagResponse:
        ...
        **Signature verification object**
        ...
        url = utils.generate_url(operations.GitCreateTagRequest, base_url, '/repos/{owner}/{repo}/git/tags', request)
        ...
        res = operations.GitCreateTagResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GitTag])
                res.git_tag = out
        elif http_res.status_code == 422:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ValidationError])
    ...
    def git_create_tree(self, request: operations.GitCreateTreeRequest) -> operations.GitCreateTreeResponse:
        ...
        url = utils.generate_url(operations.GitCreateTreeRequest, base_url, '/repos/{owner}/{repo}/git/trees', request)
        ...
        res = operations.GitCreateTreeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 201:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GitTree])
                res.git_tree = out
    ...
    def git_delete_ref(self, request: operations.GitDeleteRefRequest) -> operations.GitDeleteRefResponse:
        ...
        url = utils.generate_url(operations.GitDeleteRefRequest, base_url, '/repos/{owner}/{repo}/git/refs/{ref}', request)
        ...
        res = operations.GitDeleteRefResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def git_get_blob(self, request: operations.GitGetBlobRequest) -> operations.GitGetBlobResponse:
        ...
        url = utils.generate_url(operations.GitGetBlobRequest, base_url, '/repos/{owner}/{repo}/git/blobs/{file_sha}', request)
        ...
        res = operations.GitGetBlobResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def git_get_commit(self, request: operations.GitGetCommitRequest) -> operations.GitGetCommitResponse:
        ...
        **Signature verification object**
        ...
        url = utils.generate_url(operations.GitGetCommitRequest, base_url, '/repos/{owner}/{repo}/git/commits/{commit_sha}', request)
        ...
        res = operations.GitGetCommitResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def git_get_ref(self, request: operations.GitGetRefRequest) -> operations.GitGetRefResponse:
        ...
        **Note:** You need to explicitly [request a pull request](https://docs.github.com/enterprise-server@2.21/rest/reference/pulls#get-a-pull-request) to trigger a test merge commit, which checks the mergeability of pull requests. For more information, see \"[Checking mergeability of pull requests](https://docs.github.com/enterprise-server@2.21/rest/guides/getting-started-with-the-git-database-api#checking-mergeability-of-pull-requests)\".
        ...
        url = utils.generate_url(operations.GitGetRefRequest, base_url, '/repos/{owner}/{repo}/git/ref/{ref}', request)
        ...
        res = operations.GitGetRefResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def git_get_tag(self, request: operations.GitGetTagRequest) -> operations.GitGetTagResponse:
        ...
        **Signature verification object**
        ...
        url = utils.generate_url(operations.GitGetTagRequest, base_url, '/repos/{owner}/{repo}/git/tags/{tag_sha}', request)
        ...
        res = operations.GitGetTagResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def git_get_tree(self, request: operations.GitGetTreeRequest) -> operations.GitGetTreeResponse:
        ...
        url = utils.generate_url(operations.GitGetTreeRequest, base_url, '/repos/{owner}/{repo}/git/trees/{tree_sha}', request)
        
        query_params = utils.get_query_params(operations.GitGetTreeRequest, request)
        ...
        res = operations.GitGetTreeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def git_list_matching_refs(self, request: operations.GitListMatchingRefsRequest) -> operations.GitListMatchingRefsResponse:
        ...
        **Note:** You need to explicitly [request a pull request](https://docs.github.com/enterprise-server@2.21/rest/reference/pulls#get-a-pull-request) to trigger a test merge commit, which checks the mergeability of pull requests. For more information, see \"[Checking mergeability of pull requests](https://docs.github.com/enterprise-server@2.21/rest/guides/getting-started-with-the-git-database-api#checking-mergeability-of-pull-requests)\".
        ...
        url = utils.generate_url(operations.GitListMatchingRefsRequest, base_url, '/repos/{owner}/{repo}/git/matching-refs/{ref}', request)
        
        query_params = utils.get_query_params(operations.GitListMatchingRefsRequest, request)
        ...
        res = operations.GitListMatchingRefsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            res.headers = http_res.headers
            
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.GitRef]])
                res.git_refs = out
    ...
    def git_update_ref(self, request: operations.GitUpdateRefRequest) -> operations.GitUpdateRefResponse:
        ...
        url = utils.generate_url(operations.GitUpdateRefRequest, base_url, '/repos/{owner}/{repo}/git/refs/{ref}', request)
        ...
        res = operations.GitUpdateRefResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
