...
public class ContainerProjectsZonesClustersLocationsPathParams {
    /**
     * Required. Deprecated. The name of the cluster to upgrade. This field has been deprecated and replaced by the name field.
     */
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=clusterId")
    public String clusterId;
    public ContainerProjectsZonesClustersLocationsPathParams withClusterId(String clusterId) {
    ...
    public ContainerProjectsZonesClustersLocationsPathParams withProjectId(String projectId) {
    ...
    public String zone;
    public ContainerProjectsZonesClustersLocationsPathParams withZone(String zone) {
        this.zone = zone;
        return this;
    }
