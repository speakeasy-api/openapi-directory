...
class GETModifyVerifiedAccessEndpointPolicyActionEnum(str, Enum):
    MODIFY_VERIFIED_ACCESS_ENDPOINT_POLICY = 'ModifyVerifiedAccessEndpointPolicy'

class GETModifyVerifiedAccessEndpointPolicyVersionEnum(str, Enum):
...
class GETModifyVerifiedAccessEndpointPolicyRequest:
    ...
    action: GETModifyVerifiedAccessEndpointPolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})  
    ...
    version: GETModifyVerifiedAccessEndpointPolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})  
...
@dataclasses.dataclass
class GETModifyVerifiedAccessEndpointPolicyResponse:
