...
public class CreateNetworkSwitchRoutingMulticastRendezvousPointRequestBody {
    ...
    public CreateNetworkSwitchRoutingMulticastRendezvousPointRequestBody(@JsonProperty("interfaceIp") String interfaceIp, @JsonProperty("multicastGroup") String multicastGroup) {
        this.interfaceIp = interfaceIp;
        this.multicastGroup = multicastGroup;
  }
}
