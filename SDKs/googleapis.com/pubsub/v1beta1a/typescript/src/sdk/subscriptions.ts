...
export class Subscriptions {
  ...
  pubsubSubscriptionsAcknowledge(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1a/subscriptions/acknowledge";
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.PubsubSubscriptionsAcknowledgeSecurity(
        security
      );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PubsubSubscriptionsAcknowledgeResponse =
        new operations.PubsubSubscriptionsAcknowledgeResponse({
  ...
  pubsubSubscriptionsCreate(
    ...
    security: operations.PubsubSubscriptionsCreateSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsCreateResponse =
        new operations.PubsubSubscriptionsCreateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  pubsubSubscriptionsDelete(
    ...
    security: operations.PubsubSubscriptionsDeleteSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsDeleteResponse =
        new operations.PubsubSubscriptionsDeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  pubsubSubscriptionsGet(
    ...
    security: operations.PubsubSubscriptionsGetSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsGetResponse =
        new operations.PubsubSubscriptionsGetResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  pubsubSubscriptionsList(
    ...
    security: operations.PubsubSubscriptionsListSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsListResponse =
        new operations.PubsubSubscriptionsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  pubsubSubscriptionsModifyAckDeadline(
    ...
    security: operations.PubsubSubscriptionsModifyAckDeadlineSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1a/subscriptions/modifyAckDeadline";
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.PubsubSubscriptionsModifyAckDeadlineSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsModifyAckDeadlineResponse =
        new operations.PubsubSubscriptionsModifyAckDeadlineResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  pubsubSubscriptionsModifyPushConfig(
    ...
    security: operations.PubsubSubscriptionsModifyPushConfigSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1a/subscriptions/modifyPushConfig";
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.PubsubSubscriptionsModifyPushConfigSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsModifyPushConfigResponse =
        new operations.PubsubSubscriptionsModifyPushConfigResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  pubsubSubscriptionsPull(
    ...
    security: operations.PubsubSubscriptionsPullSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1a/subscriptions/pull";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsPullResponse =
        new operations.PubsubSubscriptionsPullResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.pullResponse = utils.objectToClass(
              httpRes?.data,
              shared.PullResponse
            );
          }
  ...
  pubsubSubscriptionsPullBatch(
    ...
    security: operations.PubsubSubscriptionsPullBatchSecurity,
    config?: AxiosRequestConfig
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1a/subscriptions/pullBatch";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PubsubSubscriptionsPullBatchResponse =
        new operations.PubsubSubscriptionsPullBatchResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.pullBatchResponse = utils.objectToClass(
              httpRes?.data,
              shared.PullBatchResponse
            );
          }
          break;
      }
