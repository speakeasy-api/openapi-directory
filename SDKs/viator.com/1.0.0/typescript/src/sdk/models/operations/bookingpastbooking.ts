...
export class BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditions extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    elemType:
      BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditionsCancellationFromTourDate,
  })
...
export class BookingPastbooking200ApplicationJSONDataItemSummaries extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    elemType:
      BookingPastbooking200ApplicationJSONDataItemSummariesTravellerAgeBands,
  })
...
export class BookingPastbooking200ApplicationJSONData extends SpeakeasyBase {
  ...
  @Type(() => BookingPastbooking200ApplicationJSONDataItemSummaries)
...
export class BookingPastbooking200ApplicationJSON extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "data" })
  @Type(() => BookingPastbooking200ApplicationJSONData)
