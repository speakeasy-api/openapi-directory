...
class DeleteMailboxPermissionsRequest:
    ...
    delete_mailbox_permissions_request: shared_deletemailboxpermissionsrequest.DeleteMailboxPermissionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
