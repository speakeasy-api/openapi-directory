...
public class EmployeesUpdateRequest {
    ...
    public EmployeesUpdateRequest(@JsonProperty("EmployeeInput") org.openapis.openapi.models.shared.EmployeeInput employeeInput, @JsonProperty("id") String id, @JsonProperty("x-apideck-app-id") String xApideckAppId, @JsonProperty("x-apideck-consumer-id") String xApideckConsumerId) {
        this.employeeInput = employeeInput;
        this.id = id;
        this.xApideckAppId = xApideckAppId;
        this.xApideckConsumerId = xApideckConsumerId;
