...
public class RepoCreatePullReviewRequestsRawRequest {
    ...
    public RepoCreatePullReviewRequestsRawRequest(@JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("index") Long index, @JsonProperty("owner") String owner, @JsonProperty("repo") String repo) {
        this.requestBody = requestBody;
        this.index = index;
        this.owner = owner;
        this.repo = repo;
