 ...
 */
export enum VpnTunnelListWarningCodeEnum {
...
export class VpnTunnelListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class VpnTunnelListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnTunnelListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class VpnTunnelList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: VpnTunnel })
  @Expose({ name: "items" })
  @Type(() => VpnTunnel)
  items?: VpnTunnel[];
