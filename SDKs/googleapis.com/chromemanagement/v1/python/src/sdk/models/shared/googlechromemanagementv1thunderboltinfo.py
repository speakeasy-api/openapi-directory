...
class GoogleChromeManagementV1ThunderboltInfo:
    ...
    security_level: Optional[GoogleChromeManagementV1ThunderboltInfoSecurityLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('securityLevel') }})
