...
class PatchBundlesIDRequestBodyPermissionsEnum(str, Enum):
...
class PatchBundlesIDRequestBodyWatermarkAttachmentFile:
...
class PatchBundlesIDRequestBody:
    ...
    paths: Optional[list[str]] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'paths' }})
    r"""A list of paths to include in this bundle."""  
    permissions: Optional[PatchBundlesIDRequestBodyPermissionsEnum] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'permissions' }})
    r"""Permissions that apply to Folders in this Share Link."""  
    ...
    watermark_attachment_delete: Optional[bool] = dataclasses.field(default=None, metadata={'multipart_form': { 'field_name': 'watermark_attachment_delete' }})
    r"""If true, will delete the file stored in watermark_attachment"""  
    watermark_attachment_file: Optional[PatchBundlesIDRequestBodyWatermarkAttachmentFile] = dataclasses.field(default=None, metadata={'multipart_form': { 'file': True }})
...
class PatchBundlesIDRequest:
    ...
    r"""Bundle ID."""  
    request_body: Optional[PatchBundlesIDRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})  
