...
export declare class AnalyticsadminPropertiesAccessBindingsBatchDeleteSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class AnalyticsadminPropertiesAccessBindingsBatchDeleteRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class AnalyticsadminPropertiesAccessBindingsBatchDeleteResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
