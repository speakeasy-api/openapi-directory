 ...
 */
export class DescribeReservedInstancesListingsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export class DescribeReservedInstancesListingsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
