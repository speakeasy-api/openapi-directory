 ...
 */
export class DescribeTransitGatewayAttachmentsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeTransitGatewayAttachmentsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
