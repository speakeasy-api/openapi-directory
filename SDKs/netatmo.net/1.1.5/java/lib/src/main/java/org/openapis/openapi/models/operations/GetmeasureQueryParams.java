...
public class GetmeasureQueryParams {
    /**
    ...
    public GetmeasureQueryParams withDateBegin(Integer dateBegin) {
    ...
    public GetmeasureQueryParams withDateEnd(String dateEnd) {
    ...
    public GetmeasureQueryParams withDeviceId(String deviceId) {
    ...
    public GetmeasureQueryParams withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetmeasureQueryParams withModuleId(String moduleId) {
    ...
    public GetmeasureQueryParams withOptimize(Boolean optimize) {
    ...
    public GetmeasureQueryParams withRealTime(Boolean realTime) {
    ...
    public GetmeasureQueryParams withScale(GetmeasureScaleEnum scale) {
        this.scale = scale;
        return this;
    }
    ...
    public GetmeasureQueryParams withType(GetmeasureTypeEnum[] type) {
        this.type = type;
        return this;
    }
