...
class EditCommentRequestBody:
    ...
    r"""The next text of the comment."""  
...
class EditCommentRequest:
    ...
    request_body: EditCommentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/vnd.vimeo.comment+json' }})  
