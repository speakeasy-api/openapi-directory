...
func (e BatchGetImageXAmzTargetEnum) ToPointer() *BatchGetImageXAmzTargetEnum {
	return &e
}
...
func (e *BatchGetImageXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonEC2ContainerRegistry_V20150921.BatchGetImage":
		*e = BatchGetImageXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BatchGetImageXAmzTargetEnum: %v", v)
	}
}
