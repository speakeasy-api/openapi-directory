...
from ..shared import getactivityresponse as shared_getactivityresponse
...
class ActivitiesOneRequest:
    headers: ActivitiesOneHeaders = dataclasses.field()
    path_params: ActivitiesOnePathParams = dataclasses.field()
    query_params: ActivitiesOneQueryParams = dataclasses.field()
    security: ActivitiesOneSecurity = dataclasses.field()
...
class ActivitiesOneResponse:
    ...
    get_activity_response: Optional[shared_getactivityresponse.GetActivityResponse] = dataclasses.field(default=None)
