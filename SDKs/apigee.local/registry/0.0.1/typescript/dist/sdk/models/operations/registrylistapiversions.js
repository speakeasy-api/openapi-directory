...
exports.RegistryListApiVersionsResponse = exports.RegistryListApiVersionsRequest = void 0;
...
var RegistryListApiVersionsRequest = /** @class */ (function (_super) {
    ...
    ], RegistryListApiVersionsRequest.prototype, "api", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], RegistryListApiVersionsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=location",
        }),
        __metadata("design:type", String)
    ], RegistryListApiVersionsRequest.prototype, "location", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageSize",
        }),
        __metadata("design:type", Number)
    ], RegistryListApiVersionsRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=pageToken",
        }),
        __metadata("design:type", String)
    ], RegistryListApiVersionsRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project",
        }),
        __metadata("design:type", String)
    ], RegistryListApiVersionsRequest.prototype, "project", void 0);
...
var RegistryListApiVersionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.ListApiVersionsResponse)
    ], RegistryListApiVersionsResponse.prototype, "listApiVersionsResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.Status)
    ], RegistryListApiVersionsResponse.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Number)
    ...
    ], RegistryListApiVersionsResponse.prototype, "rawResponse", void 0);
