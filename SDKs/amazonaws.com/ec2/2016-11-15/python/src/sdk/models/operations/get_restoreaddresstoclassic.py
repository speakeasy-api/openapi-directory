...
class GetRestoreAddressToClassicQueryParams:
    action: GetRestoreAddressToClassicActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    public_ip: str = dataclasses.field(metadata={'query_param': { 'field_name': 'PublicIp', 'style': 'form', 'explode': True }})
    version: GetRestoreAddressToClassicVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRestoreAddressToClassicRequest:
    headers: GetRestoreAddressToClassicHeaders = dataclasses.field()
    query_params: GetRestoreAddressToClassicQueryParams = dataclasses.field()
