...
exports.ListDocumentPermissionResponse = exports.ListDocumentPermissionListDocumentPermissionResponse = exports.ListDocumentPermissionListDocumentPermissionResponseMeta = exports.ListDocumentPermissionRequest = exports.ListDocumentPermissionSecurity = exports.ListDocumentPermissionServerList = void 0;
...
var ListDocumentPermissionSecurity = /** @class */ (function (_super) {
    ...
    ], ListDocumentPermissionSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListDocumentPermissionSecurity.prototype, "username", void 0);
...
var ListDocumentPermissionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListDocumentPermissionRequest.prototype, "documentSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListDocumentPermissionRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListDocumentPermissionRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListDocumentPermissionRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListDocumentPermissionRequest.prototype, "serviceSid", void 0);
...
var ListDocumentPermissionListDocumentPermissionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListDocumentPermissionListDocumentPermissionResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.SyncV1ServiceDocumentDocumentPermission,
        }),
        (0, class_transformer_1.Expose)({ name: "permissions" }),
        (0, class_transformer_1.Type)(function () { return shared.SyncV1ServiceDocumentDocumentPermission; }),
...
var ListDocumentPermissionResponse = /** @class */ (function (_super) {
    ...
    ], ListDocumentPermissionResponse.prototype, "rawResponse", void 0);
