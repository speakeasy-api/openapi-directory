...
class DescribeNetworkInsightsAccessScopesRequestFilters:
...
class DescribeNetworkInsightsAccessScopesRequest:
    ...
    filters: Optional[list[DescribeNetworkInsightsAccessScopesRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    network_insights_access_scope_ids: Optional[list[str]] = dataclasses.field(default=None)  
