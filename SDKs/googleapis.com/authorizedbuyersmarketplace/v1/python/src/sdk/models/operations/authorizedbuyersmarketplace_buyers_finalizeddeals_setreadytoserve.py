...
class AuthorizedbuyersmarketplaceBuyersFinalizedDealsSetReadyToServeRequest:
    path_params: AuthorizedbuyersmarketplaceBuyersFinalizedDealsSetReadyToServePathParams = dataclasses.field()
    query_params: AuthorizedbuyersmarketplaceBuyersFinalizedDealsSetReadyToServeQueryParams = dataclasses.field()
    security: AuthorizedbuyersmarketplaceBuyersFinalizedDealsSetReadyToServeSecurity = dataclasses.field()
