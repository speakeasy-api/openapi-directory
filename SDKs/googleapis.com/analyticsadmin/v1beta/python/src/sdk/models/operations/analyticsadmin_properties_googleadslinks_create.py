...
class AnalyticsadminPropertiesGoogleAdsLinksCreateRequest:
    ...
    google_analytics_admin_v1beta_google_ads_link_input: Optional[shared_googleanalyticsadminv1betagoogleadslink.GoogleAnalyticsAdminV1betaGoogleAdsLinkInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
