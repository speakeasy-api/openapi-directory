...
exports.CreateHrisCompanyResponse = void 0;
...
var CreateHrisCompanyResponse = /** @class */ (function (_super) {
    ...
    ], CreateHrisCompanyResponse.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operation" }),
        __metadata("design:type", String)
    ], CreateHrisCompanyResponse.prototype, "operation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=resource" }),
        __metadata("design:type", String)
    ], CreateHrisCompanyResponse.prototype, "resource", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=service" }),
        __metadata("design:type", String)
    ], CreateHrisCompanyResponse.prototype, "service", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], CreateHrisCompanyResponse.prototype, "status", void 0);
    __decorate([
