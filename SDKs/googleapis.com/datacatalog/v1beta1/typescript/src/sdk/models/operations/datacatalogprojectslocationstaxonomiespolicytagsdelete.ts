...
export class DatacatalogProjectsLocationsTaxonomiesPolicyTagsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsTaxonomiesPolicyTagsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsTaxonomiesPolicyTagsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
