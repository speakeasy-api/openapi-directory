...
class ListShortCodeListShortCodeResponse:
    ...
    meta: Optional[ListShortCodeListShortCodeResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    short_codes: Optional[list[shared_messaging_v1_service_short_code.MessagingV1ServiceShortCode]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('short_codes'), 'exclude': lambda f: f is None }})  
