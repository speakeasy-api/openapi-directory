...
export class CertificatemanagerProjectsLocationsCertificatesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsCertificatesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CertificatemanagerProjectsLocationsCertificatesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
