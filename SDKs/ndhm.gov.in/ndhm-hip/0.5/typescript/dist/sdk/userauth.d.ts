...
export declare class UserAuth {
     ...
     *
     */
    postV05UsersAuthOnConfirmJson(req: operations.PostV05UsersAuthOnConfirmJsonRequest, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.PostV05UsersAuthOnConfirmJsonResponse>;
    /**
     * callback API for /auth/confirm (in case of MEDIATED auth) to confirm user authentication or not
     *
     * @remarks
     ...
     *
     */
    postV05UsersAuthOnConfirmRaw(req: operations.PostV05UsersAuthOnConfirmRawRequest, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.PostV05UsersAuthOnConfirmRawResponse>;
    /**
     ...
     *
     */
    postV05UsersAuthOnInitJson(req: operations.PostV05UsersAuthOnInitJsonRequest, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.PostV05UsersAuthOnInitJsonResponse>;
    /**
     * Response to user authentication initialization from HIP
     *
     * @remarks
     ...
     *
     */
    postV05UsersAuthOnInitRaw(req: operations.PostV05UsersAuthOnInitRawRequest, serverURL?: string, config?: AxiosRequestConfig): Promise<operations.PostV05UsersAuthOnInitRawResponse>;
}
