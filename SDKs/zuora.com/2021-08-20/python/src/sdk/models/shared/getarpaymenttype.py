...
class GETARPaymentTypeFinanceInformationTransferredToAccountingEnum(str, Enum):
...
class GETARPaymentTypeFinanceInformation:
    ...
    transferred_to_accounting: Optional[GETARPaymentTypeFinanceInformationTransferredToAccountingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('transferredToAccounting'), 'exclude': lambda f: f is None }})
    r"""Whether the payment was transferred to an external accounting system. Use this field for integration with accounting systems, such as NetSuite."""  
...
class GETARPaymentTypeGatewayStateEnum(str, Enum):
...
class GETARPaymentTypeStatusEnum(str, Enum):
...
class GETARPaymentTypeTypeEnum(str, Enum):
...
class GETARPaymentType:
    ...
    finance_information: Optional[GETARPaymentTypeFinanceInformation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('financeInformation'), 'exclude': lambda f: f is None }})
    r"""Container for the finance information related to the payment."""  
    ...
    gateway_state: Optional[GETARPaymentTypeGatewayStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('gatewayState'), 'exclude': lambda f: f is None }})
    r"""The status of the payment in the gateway; use for reconciliation."""  
    ...
    r"""This field is only available if the support for standalone payment is enabled. This field is not available for transferring, applying, or unapplying a payment.
    ...
    """  
    status: Optional[GETARPaymentTypeStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the payment."""  
    ...
    type: Optional[GETARPaymentTypeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""The type of the payment."""  
