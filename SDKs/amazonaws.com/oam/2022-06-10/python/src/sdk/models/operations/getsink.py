...
from ..shared import getsinkoutput as shared_getsinkoutput
...
class GetSinkRequestBody:
    ...
    r"""The ARN of the sink to retrieve information for."""  
    

@dataclasses.dataclass
class GetSinkRequest:
    
    request_body: GetSinkRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class GetSinkResponse:
    ...
    get_sink_output: Optional[shared_getsinkoutput.GetSinkOutput] = dataclasses.field(default=None)
    r"""Success"""  
