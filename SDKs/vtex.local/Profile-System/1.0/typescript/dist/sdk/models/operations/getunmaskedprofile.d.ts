...
export declare class GetUnmaskedProfileRequest extends SpeakeasyBase {
    /**
...
export declare class GetUnmaskedProfileResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
    getUnmaskedProfile200ApplicationJSONAnies?: any[];
    statusCode: number;
