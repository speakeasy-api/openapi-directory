...
public class DescribeAssessmentRunsResponse {
    ...
    public DescribeAssessmentRunsResponse(@JsonProperty("assessmentRuns") AssessmentRun[] assessmentRuns, @JsonProperty("failedItems") java.util.Map<String, FailedItemDetails> failedItems) {
        this.assessmentRuns = assessmentRuns;
        this.failedItems = failedItems;
  }
}
