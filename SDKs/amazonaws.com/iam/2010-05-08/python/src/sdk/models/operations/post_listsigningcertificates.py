...
class PostListSigningCertificatesQueryParams:
    action: PostListSigningCertificatesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostListSigningCertificatesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostListSigningCertificatesRequest:
    headers: PostListSigningCertificatesHeaders = dataclasses.field()
    query_params: PostListSigningCertificatesQueryParams = dataclasses.field()
