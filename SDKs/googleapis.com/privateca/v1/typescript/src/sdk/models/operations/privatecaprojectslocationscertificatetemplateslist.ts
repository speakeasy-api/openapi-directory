...
export class PrivatecaProjectsLocationsCertificateTemplatesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PrivatecaProjectsLocationsCertificateTemplatesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PrivatecaProjectsLocationsCertificateTemplatesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
