...
from ..shared import noderebootparameter as shared_noderebootparameter
...
class ComputeNodeRebootRequest:
    ...
    node_reboot_parameter: Optional[shared_noderebootparameter.NodeRebootParameter] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
