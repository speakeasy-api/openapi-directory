...
func (s *feedV3) Commititemfeedorderstatus(ctx context.Context, request operations.CommititemfeedorderstatusRequest) (*operations.CommititemfeedorderstatusResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CommititemfeedorderstatusRequest", "json")
	if err != nil {
...
func (s *feedV3) FeedConfiguration(ctx context.Context, request operations.FeedConfigurationRequest) (*operations.FeedConfigurationResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "FeedConfigurationRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *feedV3) TestJSONataExpression(ctx context.Context, request operations.TestJSONataExpressionRequest) (*operations.TestJSONataExpressionResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "TestJSONataExpression", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
