...
class GetDeletePlatformVersionQueryParams:
    action: GetDeletePlatformVersionActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDeletePlatformVersionVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeletePlatformVersionRequest:
    headers: GetDeletePlatformVersionHeaders = dataclasses.field()
    query_params: GetDeletePlatformVersionQueryParams = dataclasses.field()
