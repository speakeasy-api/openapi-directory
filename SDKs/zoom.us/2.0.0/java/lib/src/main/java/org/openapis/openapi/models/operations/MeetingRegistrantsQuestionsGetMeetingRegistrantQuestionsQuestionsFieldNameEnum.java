 ...
 */
public enum MeetingRegistrantsQuestionsGetMeetingRegistrantQuestionsQuestionsFieldNameEnum {
    ADDRESS("address"),
    CITY("city"),
    COUNTRY("country"),
    ZIP("zip"),
    ...
    private MeetingRegistrantsQuestionsGetMeetingRegistrantQuestionsQuestionsFieldNameEnum(String value) {
        this.value = value;
    }
}
