...
func (e GetDeviceWirelessConnectionStatsBandEnum) ToPointer() *GetDeviceWirelessConnectionStatsBandEnum {
	return &e
}
...
func (e *GetDeviceWirelessConnectionStatsBandEnum) UnmarshalJSON(data []byte) error {
	...
	case "5":
		fallthrough
	case "6":
		*e = GetDeviceWirelessConnectionStatsBandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetDeviceWirelessConnectionStatsBandEnum: %v", v)
	}
}
