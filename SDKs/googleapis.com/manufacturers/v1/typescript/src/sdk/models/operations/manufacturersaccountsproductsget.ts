...
export class ManufacturersAccountsProductsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export enum ManufacturersAccountsProductsGetIncludeEnum {
  Unknown = "UNKNOWN",
...
export class ManufacturersAccountsProductsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ManufacturersAccountsProductsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
