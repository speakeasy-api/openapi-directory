...
import org.openapis.openapi.models.operations.TdcerRequestBody;
import org.openapis.openapi.models.operations.TdcerRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.TdcerRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.TdcerResponse;
import org.openapis.openapi.models.operations.TdcerSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            TdcerRequestBody req = new TdcerRequestBody(TdcerRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TdcerRequestBodyCertificateParameters("Enter 14 Digit A/c No - TDS Information will be generated for all A/cs associated with Customer ID.", "31-12-1980", "2018-2019");;
            ...
            TdcerResponse res = sdk.apIs.tdcer(req, new TdcerSecurity("maiores", "molestiae") {{
