...
type DescribePullThroughCacheRulesQueryParams struct {
	// Pagination limit
...
type DescribePullThroughCacheRulesHeaders struct {
...
type DescribePullThroughCacheRulesRequest struct {
	QueryParams DescribePullThroughCacheRulesQueryParams
	Headers     DescribePullThroughCacheRulesHeaders
	Request     shared.DescribePullThroughCacheRulesRequest `request:"mediaType=application/json"`
}
