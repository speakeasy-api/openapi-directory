...
var Extension = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "avg_rating" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "install_count" }),
        __metadata("design:type", Number)
    ], Extension.prototype, "installCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "prev_avg_rating" }),
        __metadata("design:type", Number)
    ], Extension.prototype, "prevAvgRating", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "prev_install_count" }),
        __metadata("design:type", Number)
    ], Extension.prototype, "prevInstallCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "prev_rating_count" }),
        __metadata("design:type", Number)
    ], Extension.prototype, "prevRatingCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "rating_count" }),
        __metadata("design:type", Number)
    ], Extension.prototype, "ratingCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "update_ts" }),
