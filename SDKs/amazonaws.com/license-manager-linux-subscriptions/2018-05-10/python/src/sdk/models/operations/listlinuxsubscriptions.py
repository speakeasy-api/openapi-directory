...
from ..shared import listlinuxsubscriptionsresponse as shared_listlinuxsubscriptionsresponse
...
class ListLinuxSubscriptionsRequestBody:
...
class ListLinuxSubscriptionsRequest:
    ...
    request_body: ListLinuxSubscriptionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ListLinuxSubscriptionsResponse:
    ...
    list_linux_subscriptions_response: Optional[shared_listlinuxsubscriptionsresponse.ListLinuxSubscriptionsResponse] = dataclasses.field(default=None)
    r"""Success"""  
