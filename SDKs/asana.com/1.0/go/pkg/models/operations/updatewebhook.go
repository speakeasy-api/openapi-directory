...
type UpdateWebhookQueryParams struct {
...
type UpdateWebhookRequestBody struct {
	Data *shared.WebhookUpdateRequest `json:"data,omitempty"`
}

type UpdateWebhookRequest struct {
	PathParams  UpdateWebhookPathParams
	QueryParams UpdateWebhookQueryParams
...
type UpdateWebhook200ApplicationJSON struct {
