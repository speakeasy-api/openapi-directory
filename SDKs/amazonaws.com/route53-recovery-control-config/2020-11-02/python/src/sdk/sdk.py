...
class SDK:
    ...
    def create_control_panel(self, request: operations.CreateControlPanelRequest) -> operations.CreateControlPanelResponse:
        ...
        res = operations.CreateControlPanelResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateControlPanelResponse])
    ...
    def create_routing_control(self, request: operations.CreateRoutingControlRequest) -> operations.CreateRoutingControlResponse:
        ...
        res = operations.CreateRoutingControlResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateRoutingControlResponse])
    ...
    def create_safety_rule(self, request: operations.CreateSafetyRuleRequest) -> operations.CreateSafetyRuleResponse:
        ...
        res = operations.CreateSafetyRuleResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateSafetyRuleResponse])
    ...
    def delete_control_panel(self, request: operations.DeleteControlPanelRequest) -> operations.DeleteControlPanelResponse:
        ...
        res = operations.DeleteControlPanelResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_routing_control(self, request: operations.DeleteRoutingControlRequest) -> operations.DeleteRoutingControlResponse:
        ...
        res = operations.DeleteRoutingControlResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_safety_rule(self, request: operations.DeleteSafetyRuleRequest) -> operations.DeleteSafetyRuleResponse:
        ...
        res = operations.DeleteSafetyRuleResponse(status_code=r.status_code, content_type=content_type)
    ...
    def describe_cluster(self, request: operations.DescribeClusterRequest) -> operations.DescribeClusterResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeClusterResponse])
    ...
    def describe_control_panel(self, request: operations.DescribeControlPanelRequest) -> operations.DescribeControlPanelResponse:
        ...
        res = operations.DescribeControlPanelResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeControlPanelResponse])
    ...
    def describe_routing_control(self, request: operations.DescribeRoutingControlRequest) -> operations.DescribeRoutingControlResponse:
        ...
        res = operations.DescribeRoutingControlResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeRoutingControlResponse])
    ...
    def describe_safety_rule(self, request: operations.DescribeSafetyRuleRequest) -> operations.DescribeSafetyRuleResponse:
        ...
        res = operations.DescribeSafetyRuleResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeSafetyRuleResponse])
    ...
    def list_associated_route53_health_checks(self, request: operations.ListAssociatedRoute53HealthChecksRequest) -> operations.ListAssociatedRoute53HealthChecksResponse:
        ...
        res = operations.ListAssociatedRoute53HealthChecksResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListAssociatedRoute53HealthChecksResponse])
    ...
    def list_control_panels(self, request: operations.ListControlPanelsRequest) -> operations.ListControlPanelsResponse:
        ...
        res = operations.ListControlPanelsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListControlPanelsResponse])
    ...
    def list_routing_controls(self, request: operations.ListRoutingControlsRequest) -> operations.ListRoutingControlsResponse:
        ...
        res = operations.ListRoutingControlsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListRoutingControlsResponse])
    ...
    def list_safety_rules(self, request: operations.ListSafetyRulesRequest) -> operations.ListSafetyRulesResponse:
        ...
        res = operations.ListSafetyRulesResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListSafetyRulesResponse])
    ...
    def update_control_panel(self, request: operations.UpdateControlPanelRequest) -> operations.UpdateControlPanelResponse:
        ...
        res = operations.UpdateControlPanelResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateControlPanelResponse])
    ...
    def update_routing_control(self, request: operations.UpdateRoutingControlRequest) -> operations.UpdateRoutingControlResponse:
        ...
        res = operations.UpdateRoutingControlResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateRoutingControlResponse])
    ...
    def update_safety_rule(self, request: operations.UpdateSafetyRuleRequest) -> operations.UpdateSafetyRuleResponse:
        ...
        res = operations.UpdateSafetyRuleResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateSafetyRuleResponse])
