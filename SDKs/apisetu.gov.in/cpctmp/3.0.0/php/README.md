...
try {
    ...
    $request->certificateParameters->txt10thRollNo = 'eg 000000001';
    $request->certificateParameters->txtCandidateAppSeq = '0000001';
    $request->certificateParameters->txtExamDate = 'yyyy-mm-dd';
