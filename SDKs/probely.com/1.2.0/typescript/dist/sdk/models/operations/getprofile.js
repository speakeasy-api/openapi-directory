...
var GetProfileQueryParams = /** @class */ (function (_super) {
    ...
    ], GetProfileQueryParams.prototype, "length", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ordering" }),
        __metadata("design:type", String)
    ], GetProfileQueryParams.prototype, "ordering", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetProfileQueryParams.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search" }),
        __metadata("design:type", String)
    ], GetProfileQueryParams.prototype, "search", void 0);
...
var GetProfileResponse = /** @class */ (function (_super) {
    ...
    ], GetProfileResponse.prototype, "user", void 0);
