...
try {
    ...
    $request->requestBody->headSha = 'ipsa';
...
try {
    ...
    $request->checkName = 'neque';
    $request->checkSuiteId = 778696;
    $request->filter = ChecksListForSuiteFilterEnum::ALL;
    $request->owner = 'quo';
    $request->page = 681359;
    $request->perPage = 259422;
    $request->repo = 'eos';
