...
class GetCandidateCandidateIDHistoryCycleRequest:
    path_params: GetCandidateCandidateIDHistoryCyclePathParams = dataclasses.field()
    query_params: GetCandidateCandidateIDHistoryCycleQueryParams = dataclasses.field()
