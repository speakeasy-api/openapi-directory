...
class PatientLabResultsCreateQueryParams:
...
class PatientLabResultsCreateRequest:
    query_params: PatientLabResultsCreateQueryParams = dataclasses.field()
    security: PatientLabResultsCreateSecurity = dataclasses.field()
