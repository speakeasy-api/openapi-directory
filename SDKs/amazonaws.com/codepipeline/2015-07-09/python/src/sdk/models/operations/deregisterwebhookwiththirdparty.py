...
class DeregisterWebhookWithThirdPartyRequest:
    ...
    deregister_webhook_with_third_party_input: shared_deregisterwebhookwiththirdpartyinput.DeregisterWebhookWithThirdPartyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
