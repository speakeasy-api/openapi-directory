...
class ListKeyPhrasesDetectionJobsRequest:
    ...
    list_key_phrases_detection_jobs_request: shared_listkeyphrasesdetectionjobsrequest.ListKeyPhrasesDetectionJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
