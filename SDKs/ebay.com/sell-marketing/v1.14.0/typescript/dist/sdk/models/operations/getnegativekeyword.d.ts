...
export declare class GetNegativeKeywordSecurity extends SpeakeasyBase {
    apiAuth: string;
}
export declare class GetNegativeKeywordRequest extends SpeakeasyBase {
    /**
...
export declare class GetNegativeKeywordResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Success
     */
