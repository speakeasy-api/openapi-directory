...
class TransactionTransactionSourceCheckTransferReturn
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\TransactionTransactionSourceCheckTransferReturnReasonEnum $reason
     */
	#[\JMS\Serializer\Annotation\SerializedName('reason')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TransactionTransactionSourceCheckTransferReturnReasonEnum>')]
    public TransactionTransactionSourceCheckTransferReturnReasonEnum $reason;
	...
	{
		$this->fileId = "";
		$this->reason = \OpenAPI\OpenAPI\Models\Shared\TransactionTransactionSourceCheckTransferReturnReasonEnum::MAIL_DELIVERY_FAILURE;
