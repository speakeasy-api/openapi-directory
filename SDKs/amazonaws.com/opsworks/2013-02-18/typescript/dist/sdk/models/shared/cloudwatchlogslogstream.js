...
var CloudWatchLogsLogStream = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "BatchCount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "BufferDuration" }),
        __metadata("design:type", Number)
    ], CloudWatchLogsLogStream.prototype, "bufferDuration", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DatetimeFormat" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "FileFingerprintLines" }),
        __metadata("design:type", String)
    ], CloudWatchLogsLogStream.prototype, "fileFingerprintLines", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "InitialPosition" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MultiLineStartPattern" }),
        __metadata("design:type", String)
