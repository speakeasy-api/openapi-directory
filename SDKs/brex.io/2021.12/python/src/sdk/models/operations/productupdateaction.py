...
class ProductUpdateActionRequestBody:
    r"""Parameters for the update order endpoint"""
    
    credits: Optional[float] = dataclasses.field(default=None, metadata={'form': { 'field_name': 'credits' }})
    r"""Specify an amount of credits which should be added to the order"""  
...
class ProductUpdateActionRequest:
    ...
    r"""The action you want to perform for the order"""  
    ...
    request_body: Optional[ProductUpdateActionRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
    r"""Parameters for the update order endpoint"""  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ProductUpdateActionDefaultApplicationJSON:
...
class ProductUpdateActionResponse:
    ...
    product_update_action_200_application_json_object: Optional[ProductUpdateAction200ApplicationJSON] = dataclasses.field(default=None)
    r"""Product order details"""  
    product_update_action_default_application_json_object: Optional[ProductUpdateActionDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
