...
class AnalyticsGenericLogFlowSecurity:
...
class AnalyticsGenericLogFlowRequest:
    ...
    r"""Start date time in data in ISO 8601 date time format. It must be within the current day in the UTC timezone. The default value is the start time of the current day in UTC timezone."""  
    
class AnalyticsGenericLogFlowDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
@dataclasses.dataclass
class AnalyticsGenericLogFlowDefaultApplicationJSONError:
    
    code: AnalyticsGenericLogFlowDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AnalyticsGenericLogFlowDefaultApplicationJSON:
    r"""Error code with reason"""
    
    error: AnalyticsGenericLogFlowDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AnalyticsGenericLogFlow200ApplicationJSONLogsDevice:
...
class AnalyticsGenericLogFlow200ApplicationJSONLogsTypeEnum(str, Enum):
    r"""Log type."""
    EVENT = 'event'
    PAGE = 'page'
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AnalyticsGenericLogFlow200ApplicationJSONLogs:
    r"""Generic log."""
    
    device: AnalyticsGenericLogFlow200ApplicationJSONLogsDevice = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('device') }})
    r"""Device characteristics."""  
    ...
    type: AnalyticsGenericLogFlow200ApplicationJSONLogsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Log type."""  
    ...
    r"""Account ID of the authenticated user."""  
    auth_provider: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('auth_provider'), 'exclude': lambda f: f is None }})
    r"""Auth service provider."""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AnalyticsGenericLogFlow200ApplicationJSON:
    r"""List of logs for the requested time range."""
    
    logs: list[AnalyticsGenericLogFlow200ApplicationJSONLogs] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('logs') }})
    r"""the list of logs"""  
...
class AnalyticsGenericLogFlowResponse:
    ...
    analytics_generic_log_flow_200_application_json_object: Optional[AnalyticsGenericLogFlow200ApplicationJSON] = dataclasses.field(default=None)
    r"""List of logs for the requested time range."""  
    analytics_generic_log_flow_default_application_json_object: Optional[AnalyticsGenericLogFlowDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Error code with reason"""  
