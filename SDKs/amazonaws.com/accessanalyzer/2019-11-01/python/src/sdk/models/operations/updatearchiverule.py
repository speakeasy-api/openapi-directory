...
class UpdateArchiveRuleRequest:
    headers: UpdateArchiveRuleHeaders = dataclasses.field()
    path_params: UpdateArchiveRulePathParams = dataclasses.field()
    request: UpdateArchiveRuleRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
