...
type ContactcenterinsightsProjectsLocationsConversationsIngestRequest struct {
	...
	GoogleCloudContactcenterinsightsV1IngestConversationsRequest *shared.GoogleCloudContactcenterinsightsV1IngestConversationsRequest `request:"mediaType=application/json"`
	// OAuth access token.
