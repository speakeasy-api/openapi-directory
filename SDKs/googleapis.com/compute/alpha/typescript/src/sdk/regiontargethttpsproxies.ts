...
export class RegionTargetHttpsProxies {
  ...
  computeRegionTargetHttpsProxiesTestIamPermissions(
    req: operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsRequest,
    security: operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsRequest(
          req
        );
    }
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/regions/{region}/targetHttpsProxies/{resource}/testIamPermissions",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsResponse =
        new operations.ComputeRegionTargetHttpsProxiesTestIamPermissionsResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
