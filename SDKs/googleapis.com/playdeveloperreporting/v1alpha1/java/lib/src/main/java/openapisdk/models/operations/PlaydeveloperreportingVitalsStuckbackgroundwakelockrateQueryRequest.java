...
public class PlaydeveloperreportingVitalsStuckbackgroundwakelockrateQueryRequest {
    ...
    public openapisdk.models.shared.GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetRequest request;
    public PlaydeveloperreportingVitalsStuckbackgroundwakelockrateQueryRequest withRequest(openapisdk.models.shared.GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetRequest request) {
