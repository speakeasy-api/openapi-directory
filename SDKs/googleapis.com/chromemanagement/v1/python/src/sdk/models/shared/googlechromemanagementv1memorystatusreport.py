...
class GoogleChromeManagementV1MemoryStatusReport:
    ...
    page_faults: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pageFaults') }})
    ...
    system_ram_free_bytes: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('systemRamFreeBytes') }})
