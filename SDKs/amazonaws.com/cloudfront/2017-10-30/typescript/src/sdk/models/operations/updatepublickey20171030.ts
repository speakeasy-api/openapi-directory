 ...
 */
export class UpdatePublicKey20171030RequestBodyPublicKeyConfig extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdatePublicKey20171030RequestBody extends SpeakeasyBase {
  /**
   * Information about a public key you add to CloudFront to use with features like field-level encryption.
   */
  @SpeakeasyMetadata()
