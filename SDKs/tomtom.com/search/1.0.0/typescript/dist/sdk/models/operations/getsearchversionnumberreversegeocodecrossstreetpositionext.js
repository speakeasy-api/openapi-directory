...
exports.GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtResponse = exports.GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest = void 0;
...
var GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest = /** @class */ (function (_super) {
    ...
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "ext", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=heading",
        }),
        __metadata("design:type", Number)
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "heading", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=language",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=position",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "position", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=radius",
        }),
        __metadata("design:type", Number)
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "radius", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=spatialKeys",
        }),
        __metadata("design:type", Boolean)
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "spatialKeys", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=versionNumber",
        }),
        __metadata("design:type", String)
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtRequest.prototype, "versionNumber", void 0);
...
var GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtResponse = /** @class */ (function (_super) {
    ...
    ], GetSearchVersionNumberReverseGeocodeCrossStreetPositionExtResponse.prototype, "rawResponse", void 0);
