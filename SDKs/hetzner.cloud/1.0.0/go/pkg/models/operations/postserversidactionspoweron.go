...
func (e *PostServersIDActionsPoweronActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsPoweronActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsPoweronActionResponseActionStatusEnum: %s", s)
	}
}
