...
public class GetStoriesQueryParams {
    /**
    ...
    public GetStoriesQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public GetStoriesQueryParams withLatitude(Double latitude) {
    ...
    public GetStoriesQueryParams withLongitude(Double longitude) {
    ...
    public Long page;
    public GetStoriesQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetStoriesQueryParams withPerPage(Long perPage) {
    ...
    public GetStoriesQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
