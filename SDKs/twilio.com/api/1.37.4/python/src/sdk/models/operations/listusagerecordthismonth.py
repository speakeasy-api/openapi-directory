...
from ..shared import api_v2010_account_usage_usage_record_usage_record_this_month as shared_api_v2010_account_usage_usage_record_usage_record_this_month
...
class ListUsageRecordThisMonthQueryParams:
    category: Optional[shared_usage_record_this_month_enum_category_enum.UsageRecordThisMonthEnumCategoryEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Category', 'style': 'form', 'explode': True }})
...
class ListUsageRecordThisMonthListUsageRecordThisMonthResponse:
    ...
    usage_records: Optional[list[shared_api_v2010_account_usage_usage_record_usage_record_this_month.APIV2010AccountUsageUsageRecordUsageRecordThisMonth]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclasses.dataclass
class ListUsageRecordThisMonthRequest:
    path_params: ListUsageRecordThisMonthPathParams = dataclasses.field()
    query_params: ListUsageRecordThisMonthQueryParams = dataclasses.field()
    security: ListUsageRecordThisMonthSecurity = dataclasses.field()
...
class ListUsageRecordThisMonthResponse:
    ...
    list_usage_record_this_month_response: Optional[ListUsageRecordThisMonthListUsageRecordThisMonthResponse] = dataclasses.field(default=None)
