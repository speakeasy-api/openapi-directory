...
export class CreativeServingDecision extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "chinaPolicyCompliance" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "dealsPolicyCompliance" })
  @Type(() => PolicyCompliance)
   ...
   */
  @SpeakeasyMetadata({ elemType: AdvertiserAndBrand })
  @Expose({ name: "detectedAdvertisers" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "detectedAttributes" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "detectedClickThroughUrls" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "networkPolicyCompliance" })
  @Type(() => PolicyCompliance)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "platformPolicyCompliance" })
  @Type(() => PolicyCompliance)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "russiaPolicyCompliance" })
  @Type(() => PolicyCompliance)
