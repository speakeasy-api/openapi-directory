...
var Task = /** @class */ (function () {
    ...
    Task.prototype.showTask = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/tasks/{id}", req);
        var client = this._securityClient || this._defaultClient;
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ShowTaskResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
    ...
    Task.prototype.updateTask = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "taskInput", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
