...
@dataclasses.dataclass
class StartSchemaCreationHeaders:
...
class StartSchemaCreationRequest:
    headers: StartSchemaCreationHeaders = dataclasses.field()
    path_params: StartSchemaCreationPathParams = dataclasses.field()
    request: StartSchemaCreationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
