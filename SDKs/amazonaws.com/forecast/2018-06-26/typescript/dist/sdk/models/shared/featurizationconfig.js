...
exports.FeaturizationConfig = void 0;
var utils_1 = require("../../../internal/utils");
var featurization_1 = require("./featurization");
// FeaturizationConfig
/**
...
var FeaturizationConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Featurizations", elemType: featurization_1.Featurization }),
        __metadata("design:type", Array)
    ], FeaturizationConfig.prototype, "featurizations", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ForecastDimensions" }),
        __metadata("design:type", Array)
    ], FeaturizationConfig.prototype, "forecastDimensions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ForecastFrequency" }),
