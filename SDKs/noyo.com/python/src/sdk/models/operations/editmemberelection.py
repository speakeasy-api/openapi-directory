...
class EditMemberElectionRequest:
    ...
    r"""The unique identifier of the member election in Noyo"""  
    member_election_edit_request: shared_memberelectioneditrequest.MemberElectionEditRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    version: str = dataclasses.field(metadata={'path_param': { 'field_name': 'version', 'style': 'simple', 'explode': False }})
    r"""The current version identifier of the member election"""  
...
class EditMemberElectionResponse:
    ...
    r"""Successful Response - Returns the modified Member Election"""  
