...
exports.GetInternationalPaymentConsentsConsentIdFundsConfirmationResponse = exports.GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest = exports.GetInternationalPaymentConsentsConsentIdFundsConfirmationSecurity = void 0;
...
exports.GetInternationalPaymentConsentsConsentIdFundsConfirmationSecurity = GetInternationalPaymentConsentsConsentIdFundsConfirmationSecurity;
var GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ConsentId",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest.prototype, "consentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest.prototype, "xFapiInteractionId", void 0);
    return GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest = GetInternationalPaymentConsentsConsentIdFundsConfirmationRequest;
var GetInternationalPaymentConsentsConsentIdFundsConfirmationResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetInternationalPaymentConsentsConsentIdFundsConfirmationResponse.prototype, "rawResponse", void 0);
    return GetInternationalPaymentConsentsConsentIdFundsConfirmationResponse;
}(utils_1.SpeakeasyBase));
exports.GetInternationalPaymentConsentsConsentIdFundsConfirmationResponse = GetInternationalPaymentConsentsConsentIdFundsConfirmationResponse;
