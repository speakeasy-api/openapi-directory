...
class PriorityConfiguration:
    ...
    location_order: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('LocationOrder') }})
    priority_order: Optional[list[shared_prioritytype_enum.PriorityTypeEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PriorityOrder') }})
