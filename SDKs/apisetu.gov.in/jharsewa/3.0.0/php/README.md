...
try {
    ...
    $request->certificateParameters->refNo = 'Ex. JHRC/2018/236543';
    $request->certificateParameters->tokenNo = 'Ex. 2924637nNv839 or date of issue in dd/mm/yyyy. if tokan number is less than 8 chars';
