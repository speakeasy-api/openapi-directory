...
exports.GetAssociationsFromResponse = exports.GetAssociationsFromRequest = void 0;
...
var GetAssociationsFromRequest = /** @class */ (function (_super) {
    ...
    ], GetAssociationsFromRequest.prototype, "evidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=exclude_automatic_assertions",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationsFromRequest.prototype, "excludeAutomaticAssertions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=object_taxon",
        }),
        __metadata("design:type", String)
    ], GetAssociationsFromRequest.prototype, "objectTaxon", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=relation",
        }),
        __metadata("design:type", String)
    ], GetAssociationsFromRequest.prototype, "relation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rows" }),
        __metadata("design:type", Number)
    ], GetAssociationsFromRequest.prototype, "rows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start" }),
        __metadata("design:type", Number)
    ], GetAssociationsFromRequest.prototype, "start", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=subject",
        }),
        __metadata("design:type", String)
    ], GetAssociationsFromRequest.prototype, "subject", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=unselect_evidence",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationsFromRequest.prototype, "unselectEvidence", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=use_compact_associations",
        }),
        __metadata("design:type", Boolean)
    ], GetAssociationsFromRequest.prototype, "useCompactAssociations", void 0);
...
var GetAssociationsFromResponse = /** @class */ (function (_super) {
    ...
    ], GetAssociationsFromResponse.prototype, "rawResponse", void 0);
