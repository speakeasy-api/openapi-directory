...
class IndependentExpenditures:
    ...
    def get_schedules_schedule_e_(self, request: operations.GetSchedulesScheduleERequest) -> operations.GetSchedulesScheduleEResponse:
        r"""Schedule E covers the line item expenditures for independent expenditures. For example, if a super PAC
        ...
        query_params = utils.get_query_params(operations.GetSchedulesScheduleERequest, request)
        ...
        res = operations.GetSchedulesScheduleEResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if True:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ScheduleEPage])
    ...
    def get_schedules_schedule_e_by_candidate_(self, request: operations.GetSchedulesScheduleEByCandidateRequest) -> operations.GetSchedulesScheduleEByCandidateResponse:
        r"""Schedule E receipts aggregated by recipient candidate. To avoid double
        ...
        query_params = utils.get_query_params(operations.GetSchedulesScheduleEByCandidateRequest, request)
        ...
        res = operations.GetSchedulesScheduleEByCandidateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if True:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ScheduleEByCandidatePage])
    ...
    def get_schedules_schedule_e_efile_(self, request: operations.GetSchedulesScheduleEEfileRequest) -> operations.GetSchedulesScheduleEEfileResponse:
        ...
        query_params = utils.get_query_params(operations.GetSchedulesScheduleEEfileRequest, request)
        ...
        res = operations.GetSchedulesScheduleEEfileResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if True:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ScheduleEEfilePage])
    ...
    def get_schedules_schedule_e_totals_by_candidate_(self, request: operations.GetSchedulesScheduleETotalsByCandidateRequest) -> operations.GetSchedulesScheduleETotalsByCandidateResponse:
        r"""Total independent expenditure on supported or opposed candidates by cycle or candidate election year."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/schedules/schedule_e/totals/by_candidate/'
        
        query_params = utils.get_query_params(operations.GetSchedulesScheduleETotalsByCandidateRequest, request)
        ...
        res = operations.GetSchedulesScheduleETotalsByCandidateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if True:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.IETotalsByCandidatePage])
