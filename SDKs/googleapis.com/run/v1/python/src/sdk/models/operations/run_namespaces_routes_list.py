...
class RunNamespacesRoutesListRequest:
    path_params: RunNamespacesRoutesListPathParams = dataclasses.field()
    query_params: RunNamespacesRoutesListQueryParams = dataclasses.field()
    security: RunNamespacesRoutesListSecurity = dataclasses.field()
