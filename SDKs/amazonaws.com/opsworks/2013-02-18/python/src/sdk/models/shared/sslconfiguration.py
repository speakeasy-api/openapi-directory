...
class SslConfiguration:
    r"""Describes an app's SSL configuration."""
    ...
    chain: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Chain'), 'exclude': lambda f: f is None }})  
