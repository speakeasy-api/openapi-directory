...
from ..shared import objectalreadydetachedexception as shared_objectalreadydetachedexception
...
class DetachFromIndexResponse:
    ...
    object_already_detached_exception: Optional[shared_objectalreadydetachedexception.ObjectAlreadyDetachedException] = dataclasses.field(default=None)
