...
class ExportEBSVolumeRecommendationsRequest:
    ...
    fields_to_export: Optional[list[shared_exportablevolumefield_enum.ExportableVolumeFieldEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fieldsToExport'), 'exclude': lambda f: f is None }})  
