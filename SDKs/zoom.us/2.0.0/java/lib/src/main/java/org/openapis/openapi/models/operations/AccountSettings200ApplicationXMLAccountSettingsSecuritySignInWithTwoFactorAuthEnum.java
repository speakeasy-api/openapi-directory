 ...
 * 
 */
public enum AccountSettings200ApplicationXMLAccountSettingsSecuritySignInWithTwoFactorAuthEnum {
    ALL("all"),
    GROUP("group"),
    ROLE("role"),
    NONE("none");
    ...
    private AccountSettings200ApplicationXMLAccountSettingsSecuritySignInWithTwoFactorAuthEnum(String value) {
        this.value = value;
    }
}
