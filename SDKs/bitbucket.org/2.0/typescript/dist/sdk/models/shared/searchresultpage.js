...
var SearchResultPage = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "query_substituted" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: searchcodesearchresult_1.SearchCodeSearchResult }),
        (0, class_transformer_1.Expose)({ name: "values" }),
        (0, class_transformer_1.Type)(function () { return searchcodesearchresult_1.SearchCodeSearchResult; }),
