...
public class VochseSecurity {
    ...
    public VochseSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public VochseSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public VochseSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
