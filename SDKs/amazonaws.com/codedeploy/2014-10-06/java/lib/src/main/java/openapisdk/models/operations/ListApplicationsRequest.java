...
public class ListApplicationsRequest {
    ...
    public openapisdk.models.shared.ListApplicationsInput request;
    public ListApplicationsRequest withRequest(openapisdk.models.shared.ListApplicationsInput request) {
