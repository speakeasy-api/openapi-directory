 ...
 */
export declare enum CreatePlacementGroupRequestStrategyEnum {
    Cluster = "cluster",
    Spread = "spread",
    Partition = "partition"
}
 ...
 */
export declare enum CreatePlacementGroupRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreatePlacementGroupRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreatePlacementGroupRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreatePlacementGroupRequest extends SpeakeasyBase {
    dryRun?: boolean;
    groupName?: string;
