...
var GetTrackQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=trackingNumber" }),
        __metadata("design:type", String)
    ], GetTrackQueryParams.prototype, "trackingNumber", void 0);
    return GetTrackQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetTrackQueryParams = GetTrackQueryParams;
...
var GetTrackTrackingResponseTrackingEventV2 = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=eventCategoryCode" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=eventLocation" }),
...
var GetTrackTrackingResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=fdcOrderId" }),
        __metadata("design:type", Number)
    ], GetTrackTrackingResponse.prototype, "fdcOrderId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=firstCheckedDateTime" }),
        __metadata("design:type", Date)
    ], GetTrackTrackingResponse.prototype, "firstCheckedDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=firstTransitEvent" }),
        __metadata("design:type", Date)
    ], GetTrackTrackingResponse.prototype, "firstTransitEvent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lastCheckedDateTime" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=statusCategoryCode" }),
        __metadata("design:type", Number)
    ], GetTrackTrackingResponse.prototype, "statusCategoryCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=statusDateTime" }),
        __metadata("design:type", Date)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=trackedEvents", elemType: GetTrackTrackingResponseTrackingEventV2 }),
        __metadata("design:type", Array)
