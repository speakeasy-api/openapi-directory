...
func (e StopCrawlerXAmzTargetEnum) ToPointer() *StopCrawlerXAmzTargetEnum {
	return &e
}
...
func (e *StopCrawlerXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AWSGlue.StopCrawler":
		*e = StopCrawlerXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StopCrawlerXAmzTargetEnum: %v", v)
	}
}
