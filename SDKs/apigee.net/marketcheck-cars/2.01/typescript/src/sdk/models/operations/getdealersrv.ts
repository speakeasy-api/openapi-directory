...
export class GetDealersRvQueryParams extends SpeakeasyBase {
...
export class GetDealersRvRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetDealersRvQueryParams;
}


export class GetDealersRvResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
