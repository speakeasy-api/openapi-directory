...
from ..shared import paymentlinkuriapimodel as shared_paymentlinkuriapimodel
...
class PaymentLinkAPIURIResponse:
    ...
    payment_link_uri_api_model: Optional[shared_paymentlinkuriapimodel.PaymentLinkURIAPIModel] = dataclasses.field(default=None)
    r"""OK"""  
