...
public class ListEnvironmentsRequest {
    ...
    public openapisdk.models.shared.ListEnvironmentsRequest request;
    public ListEnvironmentsRequest withRequest(openapisdk.models.shared.ListEnvironmentsRequest request) {
