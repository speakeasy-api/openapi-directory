...
export declare class RegistrationsLinkedNodesListRequest extends SpeakeasyBase {
    /**
 ...
 */
export declare enum RegistrationsLinkedNodesListNodeAttributesCategoryEnum {
    Analysis = "analysis",
 ...
 */
export declare class RegistrationsLinkedNodesListNodeAttributes extends SpeakeasyBase {
    /**
     * The category of the node, as selected by project contributors.
     */
 ...
 */
export declare class RegistrationsLinkedNodesListNodeLinks extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegistrationsLinkedNodesListNodeRelationships extends SpeakeasyBase {
    /**
...
export declare class RegistrationsLinkedNodesListNode extends SpeakeasyBase {
    /**
     * The properties of the node entity.
     */
...
export declare class RegistrationsLinkedNodesListResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
