...
class PutPlaylistsPlaylistIDRequest:
    ...
    create_update_playlist_request: Optional[shared_createupdateplaylistrequest.CreateUpdatePlaylistRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""Playlist payload"""  
...
class PutPlaylistsPlaylistID200ApplicationJSON:
    ...
    r"""Count of tracks."""  
    tracks: Optional[list[PutPlaylistsPlaylistID200ApplicationJSONTracks]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tracks'), 'exclude': lambda f: f is None }})
    r"""List of tracks."""  
