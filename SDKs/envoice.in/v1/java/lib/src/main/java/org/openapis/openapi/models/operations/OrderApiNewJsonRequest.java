...
public class OrderApiNewJsonRequest {
    ...
    public OrderApiNewJsonRequest(@JsonProperty("OrderCreateApiModel") org.openapis.openapi.models.shared.OrderCreateApiModel orderCreateApiModel, @JsonProperty("x-auth-key") String xAuthKey, @JsonProperty("x-auth-secret") String xAuthSecret) {
        this.orderCreateApiModel = orderCreateApiModel;
        this.xAuthKey = xAuthKey;
        this.xAuthSecret = xAuthSecret;
  }
