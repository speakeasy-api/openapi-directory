...
class UpdateNsxvControllerClusterRequest:
    ...
    r"""entity id"""  
    nsx_controller_data_collection: Optional[shared_nsxcontrollerdatacollection.NSXControllerDataCollection] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
