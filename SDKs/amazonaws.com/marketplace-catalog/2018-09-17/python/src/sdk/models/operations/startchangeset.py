...
class StartChangeSetRequestBody:
    ...
    change_set: list[shared_change.Change] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ChangeSet') }})
...
class StartChangeSetRequest:
    headers: StartChangeSetHeaders = dataclasses.field()
    request: StartChangeSetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
