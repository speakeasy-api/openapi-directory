...
from ..shared import createmerchantresponse as shared_createmerchantresponse
...
class MerchantsAddRequest:
    headers: MerchantsAddHeaders = dataclasses.field()
    query_params: MerchantsAddQueryParams = dataclasses.field()
    request: shared_merchant.MerchantInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: MerchantsAddSecurity = dataclasses.field()
...
class MerchantsAddResponse:
    ...
    create_merchant_response: Optional[shared_createmerchantresponse.CreateMerchantResponse] = dataclasses.field(default=None)
