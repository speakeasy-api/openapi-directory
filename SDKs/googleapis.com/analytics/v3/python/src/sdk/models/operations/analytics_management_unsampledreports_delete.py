...
@dataclasses.dataclass
class AnalyticsManagementUnsampledReportsDeleteQueryParams:
...
class AnalyticsManagementUnsampledReportsDeleteRequest:
    path_params: AnalyticsManagementUnsampledReportsDeletePathParams = dataclasses.field()
    query_params: AnalyticsManagementUnsampledReportsDeleteQueryParams = dataclasses.field()
    security: AnalyticsManagementUnsampledReportsDeleteSecurity = dataclasses.field()
