...
var BalanceSheet = /** @class */ (function () {
    function BalanceSheet(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Get BalanceSheet
     */
    BalanceSheet.prototype.balanceSheetOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BalanceSheetOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/accounting/balance-sheet";
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.BalanceSheetOneSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.BalanceSheetOneResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getBalanceSheetResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetBalanceSheetResponse);
                    }
                    break;
