...
class EnterpriseCrmEventbusProtoEventExecutionSnapshot:
    r"""Contains the snapshot of the event execution for a given checkpoint. Next available id: 13"""
    ...
    diff_params: Optional[shared_enterprisecrmeventbusprotoeventparameters.EnterpriseCrmEventbusProtoEventParameters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('diffParams'), 'exclude': lambda f: f is None }})
    ...
    event_params: Optional[shared_enterprisecrmeventbusprotoeventparameters.EnterpriseCrmEventbusProtoEventParameters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventParams'), 'exclude': lambda f: f is None }})
    r"""LINT.IfChange This message is used for processing and persisting (when applicable) key value pair parameters for each event in the event bus. Please see"""  
    exceed_max_size: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('exceedMaxSize'), 'exclude': lambda f: f is None }})
    r"""indicate whether snapshot exceeded maximum size before clean up"""  
