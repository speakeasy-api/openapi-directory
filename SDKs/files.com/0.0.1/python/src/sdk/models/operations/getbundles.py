...
class GetBundlesRequest:
    query_params: GetBundlesQueryParams = dataclasses.field()
...
class GetBundlesResponse:
    ...
    bundle_entities: Optional[list[shared_bundleentity.BundleEntity]] = dataclasses.field(default=None)
