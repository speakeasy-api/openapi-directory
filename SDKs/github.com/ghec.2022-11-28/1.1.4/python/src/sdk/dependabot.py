...
class Dependabot:
    ...
    def dependabot_add_selected_repo_to_org_secret(self, request: operations.DependabotAddSelectedRepoToOrgSecretRequest) -> operations.DependabotAddSelectedRepoToOrgSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#add-selected-repository-to-an-organization-secret - API method documentation
        """
    ...
    def dependabot_create_or_update_org_secret(self, request: operations.DependabotCreateOrUpdateOrgSecretRequest) -> operations.DependabotCreateOrUpdateOrgSecretResponse:
        ...
        ```
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#create-or-update-an-organization-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_create_or_update_repo_secret(self, request: operations.DependabotCreateOrUpdateRepoSecretRequest) -> operations.DependabotCreateOrUpdateRepoSecretResponse:
        ...
        puts Base64.strict_encode64(encrypted_secret)
        ```
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#create-or-update-a-repository-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_delete_org_secret(self, request: operations.DependabotDeleteOrgSecretRequest) -> operations.DependabotDeleteOrgSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#delete-an-organization-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_delete_repo_secret(self, request: operations.DependabotDeleteRepoSecretRequest) -> operations.DependabotDeleteRepoSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#delete-a-repository-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_get_alert(self, request: operations.DependabotGetAlertRequest) -> operations.DependabotGetAlertResponse:
        r"""Get a Dependabot alert
        You must use an access token with the `security_events` scope to use this endpoint with private repositories.
        You can also use tokens with the `public_repo` scope for public repositories only.
        GitHub Apps must have **Dependabot alerts** read permission to use this endpoint.
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#get-a-dependabot-alert - API method documentation
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DependabotGetAlertRequest, base_url, '/repos/{owner}/{repo}/dependabot/alerts/{alert_number}', request)
        ...
        res = operations.DependabotGetAlertResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DependabotAlert])
                res.dependabot_alert = out
    ...
    def dependabot_get_org_public_key(self, request: operations.DependabotGetOrgPublicKeyRequest) -> operations.DependabotGetOrgPublicKeyResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#get-an-organization-public-key - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_get_org_secret(self, request: operations.DependabotGetOrgSecretRequest) -> operations.DependabotGetOrgSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#get-an-organization-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_get_repo_public_key(self, request: operations.DependabotGetRepoPublicKeyRequest) -> operations.DependabotGetRepoPublicKeyResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#get-a-repository-public-key - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_get_repo_secret(self, request: operations.DependabotGetRepoSecretRequest) -> operations.DependabotGetRepoSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#get-a-repository-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_list_alerts_for_enterprise(self, request: operations.DependabotListAlertsForEnterpriseRequest) -> operations.DependabotListAlertsForEnterpriseResponse:
        r"""List Dependabot alerts for an enterprise
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/dependabot/alerts#list-dependabot-alerts-for-an-enterprise - API method documentation
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DependabotListAlertsForEnterpriseRequest, base_url, '/enterprises/{enterprise}/dependabot/alerts', request)
        
        query_params = utils.get_query_params(operations.DependabotListAlertsForEnterpriseRequest, request)
        ...
        res = operations.DependabotListAlertsForEnterpriseResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.DependabotAlertWithRepository]])
                res.dependabot_alert_with_repositories = out
        elif http_res.status_code == 304:
            pass
        elif http_res.status_code in [403, 404]:
            if utils.match_content_type(content_type, 'application/json'):
    ...
    def dependabot_list_alerts_for_org(self, request: operations.DependabotListAlertsForOrgRequest) -> operations.DependabotListAlertsForOrgResponse:
        r"""List Dependabot alerts for an organization
        ...
        GitHub Apps must have **Dependabot alerts** read permission to use this endpoint.
        https://docs.github.com/enterprise-cloud@latest//rest/dependabot/alerts#list-dependabot-alerts-for-an-organization - API method documentation
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DependabotListAlertsForOrgRequest, base_url, '/orgs/{org}/dependabot/alerts', request)
        
        query_params = utils.get_query_params(operations.DependabotListAlertsForOrgRequest, request)
        ...
        res = operations.DependabotListAlertsForOrgResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def dependabot_list_alerts_for_repo(self, request: operations.DependabotListAlertsForRepoRequest) -> operations.DependabotListAlertsForRepoResponse:
        r"""List Dependabot alerts for a repository
        You must use an access token with the `security_events` scope to use this endpoint with private repositories.
        You can also use tokens with the `public_repo` scope for public repositories only.
        GitHub Apps must have **Dependabot alerts** read permission to use this endpoint.
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#list-dependabot-alerts-for-a-repository - API method documentation
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DependabotListAlertsForRepoRequest, base_url, '/repos/{owner}/{repo}/dependabot/alerts', request)
        
        query_params = utils.get_query_params(operations.DependabotListAlertsForRepoRequest, request)
        ...
        res = operations.DependabotListAlertsForRepoResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.DependabotAlert]])
                res.dependabot_alerts = out
        elif http_res.status_code == 304:
            pass
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/json'):
    ...
    def dependabot_list_org_secrets(self, request: operations.DependabotListOrgSecretsRequest) -> operations.DependabotListOrgSecretsResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#list-organization-secrets - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_list_repo_secrets(self, request: operations.DependabotListRepoSecretsRequest) -> operations.DependabotListRepoSecretsResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#list-repository-secrets - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_list_selected_repos_for_org_secret(self, request: operations.DependabotListSelectedReposForOrgSecretRequest) -> operations.DependabotListSelectedReposForOrgSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#list-selected-repositories-for-an-organization-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_remove_selected_repo_from_org_secret(self, request: operations.DependabotRemoveSelectedRepoFromOrgSecretRequest) -> operations.DependabotRemoveSelectedRepoFromOrgSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#remove-selected-repository-from-an-organization-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_set_selected_repos_for_org_secret(self, request: operations.DependabotSetSelectedReposForOrgSecretRequest) -> operations.DependabotSetSelectedReposForOrgSecretResponse:
        ...
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#set-selected-repositories-for-an-organization-secret - API method documentation
        """
        base_url = self._server_url
    ...
    def dependabot_update_alert(self, request: operations.DependabotUpdateAlertRequest) -> operations.DependabotUpdateAlertResponse:
        r"""Update a Dependabot alert
        You must use an access token with the `security_events` scope to use this endpoint with private repositories.
        You can also use tokens with the `public_repo` scope for public repositories only.
        GitHub Apps must have **Dependabot alerts** write permission to use this endpoint.
        https://docs.github.com/enterprise-cloud@latest//rest/reference/dependabot#update-a-dependabot-alert - API method documentation
        """
        base_url = self._server_url
        
        url = utils.generate_url(operations.DependabotUpdateAlertRequest, base_url, '/repos/{owner}/{repo}/dependabot/alerts/{alert_number}', request)
        ...
        res = operations.DependabotUpdateAlertResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
