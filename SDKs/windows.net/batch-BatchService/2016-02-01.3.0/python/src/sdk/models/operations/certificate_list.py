...
from ..shared import certificatelistresult as shared_certificatelistresult
...
class CertificateListResponse:
    ...
    certificate_list_result: Optional[shared_certificatelistresult.CertificateListResult] = dataclasses.field(default=None)
    r"""Gets the list of certificates."""  
