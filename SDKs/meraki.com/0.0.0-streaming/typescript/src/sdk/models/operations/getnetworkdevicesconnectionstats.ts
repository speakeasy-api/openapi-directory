 ...
 */
export enum GetNetworkDevicesConnectionStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkDevicesConnectionStatsRequest extends SpeakeasyBase {
  /**
...
export class GetNetworkDevicesConnectionStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkDevicesConnectionStats200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
