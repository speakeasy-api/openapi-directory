...
public class DeleteParticipantRequest {
    ...
    public DeleteParticipantRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CallSid") String callSid, @JsonProperty("ConferenceSid") String conferenceSid) {
        this.accountSid = accountSid;
        this.callSid = callSid;
        this.conferenceSid = conferenceSid;
  }
