...
const (
	UntagResourceXAmzTargetEnumIoTSecuredTunnelingUntagResource UntagResourceXAmzTargetEnum = "IoTSecuredTunneling.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "IoTSecuredTunneling.UntagResource":
