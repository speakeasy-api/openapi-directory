...
class SDK
{
	...
	public const CREATE_TOLLFREE_VERIFICATION_SERVERS = [
		'https://messaging.twilio.com',
	];
	...
	public const FETCH_TOLLFREE_VERIFICATION_SERVERS = [
		'https://messaging.twilio.com',
	];
	...
	public const LIST_TOLLFREE_VERIFICATION_SERVERS = [
		'https://messaging.twilio.com',
	];
	...
	public const UPDATE_TOLLFREE_VERIFICATION_SERVERS = [
		'https://messaging.twilio.com',
	];
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateTollfreeVerificationCreateTollfreeVerificationRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\CreateTollfreeVerificationSecurity $security
     * @param string $serverURL
     * @return \OpenAPI\OpenAPI\Models\Operations\CreateTollfreeVerificationResponse
     */
	public function createTollfreeVerification(
        \OpenAPI\OpenAPI\Models\Operations\CreateTollfreeVerificationCreateTollfreeVerificationRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\CreateTollfreeVerificationSecurity $security,
        string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\CreateTollfreeVerificationResponse
    {
        $baseUrl = SDK::CREATE_TOLLFREE_VERIFICATION_SERVERS[0];
        if (!empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/Tollfree/Verifications');
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\CreateTollfreeVerificationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 201) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->messagingV1TollfreeVerification = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\MessagingV1TollfreeVerification', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationSecurity $security
     * @param string $serverURL
     * @return \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationResponse
     */
	public function fetchTollfreeVerification(
        \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationSecurity $security,
        string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationResponse
    {
        $baseUrl = SDK::FETCH_TOLLFREE_VERIFICATION_SERVERS[0];
        if (!empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/Tollfree/Verifications/{Sid}', \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\FetchTollfreeVerificationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationSecurity $security
     * @param string $serverURL
     * @return \OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationResponse
     */
	public function listTollfreeVerification(
        \OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationSecurity $security,
        string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationResponse
    {
        $baseUrl = SDK::LIST_TOLLFREE_VERIFICATION_SERVERS[0];
        if (!empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        ...
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->listTollfreeVerificationResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Operations\ListTollfreeVerificationListTollfreeVerificationResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationSecurity $security
     * @param string $serverURL
     * @return \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationResponse
     */
	public function updateTollfreeVerification(
        \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationSecurity $security,
        string $serverURL = null,
    ): \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationResponse
    {
        $baseUrl = SDK::UPDATE_TOLLFREE_VERIFICATION_SERVERS[0];
        if (!empty($serverURL)) {
            $baseUrl = $serverURL;
        }
        
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/Tollfree/Verifications/{Sid}', \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationRequest::class, $request);
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\UpdateTollfreeVerificationResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
