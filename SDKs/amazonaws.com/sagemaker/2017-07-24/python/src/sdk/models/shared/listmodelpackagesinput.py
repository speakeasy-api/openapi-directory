...
from ..shared import modelpackagesortby_enum as shared_modelpackagesortby_enum
from ..shared import modelpackagetype_enum as shared_modelpackagetype_enum
...
class ListModelPackagesInput:
    ...
    model_package_type: Optional[shared_modelpackagetype_enum.ModelPackageTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ModelPackageType'), 'exclude': lambda f: f is None }})  
    ...
    sort_by: Optional[shared_modelpackagesortby_enum.ModelPackageSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
