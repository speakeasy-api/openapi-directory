      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1ServiceChannel = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1ServiceChannel
            );
          }
          break;
      }
  ...
  createCredential(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1Credential = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1Credential
            );
          }
          break;
      }
  ...
  createInvite(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1ServiceChannelInvite = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1ServiceChannelInvite
            );
          }
          break;
      }
  ...
  createMember(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1ServiceChannelMember = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1ServiceChannelMember
            );
          }
          break;
      }
  ...
  createMessage(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1ServiceChannelMessage = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1ServiceChannelMessage
            );
          }
          break;
      }
  ...
  createRole(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1ServiceRole = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1ServiceRole
            );
          }
          break;
      }
  ...
  createService(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1Service = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1Service
            );
          }
          break;
      }
  ...
  createUser(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.chatV1ServiceUser = utils.objectToClass(
              httpRes?.data,
              shared.ChatV1ServiceUser
            );
          }
          break;
      }
