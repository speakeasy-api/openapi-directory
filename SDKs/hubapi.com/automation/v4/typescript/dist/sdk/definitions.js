...
var Definitions = /** @class */ (function () {
    ...
    **/
    Definitions.prototype.deleteAutomationV4ActionsAppIdDefinitionIdArchive = function (req, config) {
    ...
    **/
    Definitions.prototype.getAutomationV4ActionsAppIdDefinitionIdGetById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Definitions.prototype.getAutomationV4ActionsAppIdGetPage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Definitions.prototype.patchAutomationV4ActionsAppIdDefinitionIdUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Definitions.prototype.postAutomationV4ActionsAppIdCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
