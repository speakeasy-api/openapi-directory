...
var Operations = /** @class */ (function () {
     ...
     */
    Operations.prototype.cloudsearchOperationsGet = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.CloudsearchOperationsGetResponse({
     ...
     */
    Operations.prototype.cloudsearchOperationsLroList = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudsearchOperationsLroListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{name}/lro", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.CloudsearchOperationsLroListResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
