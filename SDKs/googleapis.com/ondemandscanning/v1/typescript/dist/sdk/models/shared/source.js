...
var Source = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "additionalContexts" }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "artifactStorageSourceUri" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: filehashes_1.FileHashes }),
        (0, class_transformer_1.Expose)({ name: "fileHashes" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], filehashes_1.FileHashes);
            }
            return obj;
        }, { toClassOnly: true }),
