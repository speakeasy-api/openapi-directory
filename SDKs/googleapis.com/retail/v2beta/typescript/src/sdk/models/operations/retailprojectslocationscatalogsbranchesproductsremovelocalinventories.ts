...
export class RetailProjectsLocationsCatalogsBranchesProductsRemoveLocalInventoriesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsBranchesProductsRemoveLocalInventoriesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsBranchesProductsRemoveLocalInventoriesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
