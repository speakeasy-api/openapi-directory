...
public class GetDefinitionsRequest {
    ...
    public GetDefinitionsRequest withIncludeRelated(String includeRelated) {
    ...
    public GetDefinitionsRequest withIncludeTags(GetDefinitionsIncludeTagsEnum includeTags) {
    ...
    public GetDefinitionsRequest withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetDefinitionsRequest withPartOfSpeech(GetDefinitionsPartOfSpeechEnum partOfSpeech) {
    ...
    public GetDefinitionsRequest withSourceDictionaries(GetDefinitionsSourceDictionariesEnum sourceDictionaries) {
    ...
    public GetDefinitionsRequest withUseCanonical(GetDefinitionsUseCanonicalEnum useCanonical) {
    ...
    public String word;
    public GetDefinitionsRequest withWord(String word) {
        this.word = word;
        return this;
    }
