...
func NewEventlog(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *Eventlog {
	return &Eventlog{
...
//
// </details>
func (s *Eventlog) RequestAuditNodeUserData(ctx context.Context, request operations.RequestAuditNodeUserDataRequest) (*operations.RequestAuditNodeUserDataResponse, error) {
...
//
// </details>
func (s *Eventlog) RequestLogEventsAsJSON(ctx context.Context, request operations.RequestLogEventsAsJSONRequest) (*operations.RequestLogEventsAsJSONResponse, error) {
	baseURL := s._serverURL
...
// ### Further Information:
// None.
func (s *Eventlog) RequestLogOperations(ctx context.Context, request operations.RequestLogOperationsRequest) (*operations.RequestLogOperationsResponse, error) {
	baseURL := s._serverURL
