...
class ObjectPOSTPaymentRequest
{
    ...
    public \OpenAPI\OpenAPI\Models\Shared\ProxyCreatePayment $proxyCreatePayment;
	...
	{
		$this->proxyCreatePayment = new \OpenAPI\OpenAPI\Models\Shared\ProxyCreatePayment();
