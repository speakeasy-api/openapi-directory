        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.teamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.TeamsAddOrUpdateProjectPermissionsLegacy415ApplicationJSON
              );
          }
          break;
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.teamsCheckPermissionsForProjectLegacy415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.TeamsCheckPermissionsForProjectLegacy415ApplicationJSON
              );
          }
          break;
      }
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.teamsListProjectsLegacy415ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.TeamsListProjectsLegacy415ApplicationJSON
              );
          }
          break;
      }
