...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDSecurity = dataclasses.field()
