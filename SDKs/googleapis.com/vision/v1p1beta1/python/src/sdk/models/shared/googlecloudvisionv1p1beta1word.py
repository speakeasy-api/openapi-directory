...
class GoogleCloudVisionV1p1beta1Word:
    ...
    symbols: Optional[list[shared_googlecloudvisionv1p1beta1symbol.GoogleCloudVisionV1p1beta1Symbol]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('symbols'), 'exclude': lambda f: f is None }})
