...
from ..shared import messagemoderationresult as shared_messagemoderationresult
...
class MessageFlag:
    ...
    moderation_result: Optional[shared_messagemoderationresult.MessageModerationResult] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('moderation_result'), 'exclude': lambda f: f is None }})  
    ...
    reviewed_by: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reviewed_by'), 'exclude': lambda f: f is None }})
