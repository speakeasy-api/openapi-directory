...
class DcimFrontPortTemplatesListQueryParams:
...
@dataclass_json
@dataclasses.dataclass
class DcimFrontPortTemplatesList200ApplicationJSON:
    count: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('count') }})
    results: list[shared_frontporttemplate.FrontPortTemplate] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    next: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('next') }})
    previous: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('previous') }})
    

@dataclasses.dataclass
class DcimFrontPortTemplatesListRequest:
    query_params: DcimFrontPortTemplatesListQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class DcimFrontPortTemplatesListResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    dcim_front_port_templates_list_200_application_json_object: Optional[DcimFrontPortTemplatesList200ApplicationJSON] = dataclasses.field(default=None)
