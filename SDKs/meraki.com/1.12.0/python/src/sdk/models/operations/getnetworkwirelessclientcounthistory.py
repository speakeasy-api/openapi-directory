...
class GetNetworkWirelessClientCountHistoryPathParams:
    network_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'networkId', 'style': 'simple', 'explode': False }})
    
class GetNetworkWirelessClientCountHistoryBandEnum(str, Enum):
    TWO_4 = "2.4"
    FIVE = "5"


@dataclasses.dataclass
class GetNetworkWirelessClientCountHistoryQueryParams:
    ...
    band: Optional[GetNetworkWirelessClientCountHistoryBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class GetNetworkWirelessClientCountHistoryRequest:
    path_params: GetNetworkWirelessClientCountHistoryPathParams = dataclasses.field()
    query_params: GetNetworkWirelessClientCountHistoryQueryParams = dataclasses.field()
...
class GetNetworkWirelessClientCountHistoryResponse:
    ...
    get_network_wireless_client_count_history_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
