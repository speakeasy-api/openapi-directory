...
import { NetworkEdgeSecurityServicesScopedList } from "./networkedgesecurityservicesscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum NetworkEdgeSecurityServiceAggregatedListWarningCodeEnum {
...
export class NetworkEdgeSecurityServiceAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkEdgeSecurityServiceAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: NetworkEdgeSecurityServiceAggregatedListWarningCodeEnum;
  ...
  data?: NetworkEdgeSecurityServiceAggregatedListWarningData[];
 ...
 * Successful response
 */
export class NetworkEdgeSecurityServiceAggregatedList extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "etag" })
  etag?: string;
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkEdgeSecurityServicesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, NetworkEdgeSecurityServicesScopedList> = {};
  ...
  items?: Record<string, NetworkEdgeSecurityServicesScopedList>;
