...
class Reactions:
    ...
    def reactions_delete_legacy(self, request: operations.ReactionsDeleteLegacyRequest) -> operations.ReactionsDeleteLegacyResponse:
        ...
        **Deprecation Notice:** This endpoint route is deprecated and will be removed from the Reactions API. We recommend migrating your existing code to use the new delete reactions endpoints. For more information, see this [blog post](https://developer.github.com/changes/2020-02-26-new-delete-reactions-endpoints/).
        ...
        url = utils.generate_url(operations.ReactionsDeleteLegacyRequest, base_url, '/reactions/{reaction_id}', request)
        ...
        res = operations.ReactionsDeleteLegacyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
