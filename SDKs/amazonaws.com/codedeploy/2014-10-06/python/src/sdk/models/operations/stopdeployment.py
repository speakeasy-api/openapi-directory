...
class StopDeploymentRequest:
    headers: StopDeploymentHeaders = dataclasses.field()
    request: shared_stopdeploymentinput.StopDeploymentInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
