...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.createChannel = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceChannel = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createChannelWebhook = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateChannelWebhookRequest(req);
        }
        var baseURL = operations.CreateChannelWebhookServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceChannelChannelWebhook = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createCredential = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/v2/Credentials";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2Credential = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createInvite = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Invites", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceChannelInvite = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createMember = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceChannelMember = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createMessage = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceChannelMessage = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createRole = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Roles", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceRole = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createService = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2Service = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.createUser = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceUser = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.deleteBinding = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Bindings/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    SDK.prototype.deleteChannel = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    SDK.prototype.deleteChannelWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteChannelWebhookRequest(req);
        }
        var baseURL = operations.DeleteChannelWebhookServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    SDK.prototype.deleteCredential = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Credentials/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    SDK.prototype.deleteInvite = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Invites/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    SDK.prototype.deleteMember = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Members/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    SDK.prototype.deleteMessage = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Messages/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
    ...
    SDK.prototype.deleteRole = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Roles/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    SDK.prototype.deleteUser = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    SDK.prototype.deleteUserBinding = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteUserBindingRequest(req);
        }
        var baseURL = operations.DeleteUserBindingServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Bindings/{Sid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var r = client.request(__assign({ url: url, method: "delete" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.deleteUserChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteUserChannelRequest(req);
        }
        var baseURL = operations.DeleteUserChannelServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var r = client.request(__assign({ url: url, method: "delete", headers: headers }, config));
        return r.then(function (httpRes) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceBinding = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.fetchChannelWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FetchChannelWebhookRequest(req);
        }
        var baseURL = operations.FetchChannelWebhookServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}", req.pathParams);
    ...
    SDK.prototype.fetchUserBinding = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FetchUserBindingRequest(req);
        }
        var baseURL = operations.FetchUserBindingServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Bindings/{Sid}", req.pathParams);
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceUserUserBinding = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.fetchUserChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FetchUserChannelRequest(req);
        }
        var baseURL = operations.FetchUserChannelServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}", req.pathParams);
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.chatV2ServiceUserUserChannel = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.listBinding = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Bindings", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    SDK.prototype.listChannelWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListChannelWebhookRequest(req);
        }
        var baseURL = operations.ListChannelWebhookServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks", req.pathParams);
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listChannelWebhookResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.listUserBinding = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListUserBindingRequest(req);
        }
        var baseURL = operations.ListUserBindingServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Bindings", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listUserBindingResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.listUserChannel = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    SDK.prototype.updateChannelWebhook = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateChannelWebhookRequest(req);
        }
        var baseURL = operations.UpdateChannelWebhookServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}", req.pathParams);
    ...
    SDK.prototype.updateUserChannel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateUserChannelRequest(req);
        }
        var baseURL = operations.UpdateUserChannelServerList[0];
        if (req.serverURL) {
            baseURL = req.serverURL;
        }
        var url = utils.generateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}", req.pathParams);
