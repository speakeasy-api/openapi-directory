...
class SendCustomVerificationEmailRequest:
    headers: SendCustomVerificationEmailHeaders = dataclasses.field()
    request: SendCustomVerificationEmailRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
