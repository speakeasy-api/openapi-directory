 ...
 */
export declare enum HealthCheckServicesListWarningCodeEnum {
...
export declare class HealthCheckServicesListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class HealthCheckServicesListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: HealthCheckServicesListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: HealthCheckServicesListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class HealthCheckServicesList extends SpeakeasyBase {
    /**
