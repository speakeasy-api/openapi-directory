...
SERVERS = [
    ...
    r"""The general Amazon SimpleDB endpoint for US East (N. Virginia)"""
    "https://sdb.amazonaws.com",
    r"""The general Amazon SimpleDB endpoint for US East (N. Virginia)"""
    "http://sdb.{region}.amazonaws.com",
    r"""The Amazon SimpleDB multi-region endpoint"""
    "https://sdb.{region}.amazonaws.com",
    r"""The Amazon SimpleDB multi-region endpoint"""
    "http://sdb.{region}.amazonaws.com.cn",
    r"""The Amazon SimpleDB endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def get_domain_metadata(self, request: operations.GETDomainMetadataRequest) -> operations.GETDomainMetadataResponse:
        ...
        query_params = utils.get_query_params(operations.GETDomainMetadataRequest, request)
        ...
        res = operations.GETDomainMetadataResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_get_attributes(self, request: operations.GETGETAttributesRequest) -> operations.GETGETAttributesResponse:
        ...
        query_params = utils.get_query_params(operations.GETGETAttributesRequest, request)
        ...
        res = operations.GETGETAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_list_domains(self, request: operations.GETListDomainsRequest) -> operations.GETListDomainsResponse:
        ...
        query_params = utils.get_query_params(operations.GETListDomainsRequest, request)
        ...
        res = operations.GETListDomainsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def get_select(self, request: operations.GETSelectRequest) -> operations.GETSelectResponse:
        ...
        query_params = utils.get_query_params(operations.GETSelectRequest, request)
        ...
        res = operations.GETSelectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code in [200, 400, 408]:
            if utils.match_content_type(content_type, 'text/xml'):
                res.body = http_res.content
    ...
    def post_batch_delete_attributes(self, request: operations.POSTBatchDeleteAttributesRequest) -> operations.POSTBatchDeleteAttributesResponse:
        ...
        query_params = utils.get_query_params(operations.POSTBatchDeleteAttributesRequest, request)
        ...
        res = operations.POSTBatchDeleteAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_batch_put_attributes(self, request: operations.POSTBatchPutAttributesRequest) -> operations.POSTBatchPutAttributesResponse:
        ...
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.POSTBatchPutAttributesRequest, request)
        ...
        res = operations.POSTBatchPutAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_delete_attributes(self, request: operations.POSTDeleteAttributesRequest) -> operations.POSTDeleteAttributesResponse:
        ...
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.POSTDeleteAttributesRequest, request)
        ...
        res = operations.POSTDeleteAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_domain_metadata(self, request: operations.POSTDomainMetadataRequest) -> operations.POSTDomainMetadataResponse:
        ...
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.POSTDomainMetadataRequest, request)
        ...
        res = operations.POSTDomainMetadataResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_get_attributes(self, request: operations.POSTGetAttributesRequest) -> operations.POSTGetAttributesResponse:
        ...
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.POSTGetAttributesRequest, request)
        ...
        res = operations.POSTGetAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_list_domains(self, request: operations.POSTListDomainsRequest) -> operations.POSTListDomainsResponse:
        ...
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.POSTListDomainsRequest, request)
        ...
        res = operations.POSTListDomainsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_put_attributes(self, request: operations.POSTPutAttributesRequest) -> operations.POSTPutAttributesResponse:
        ...
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.POSTPutAttributesRequest, request)
        ...
        res = operations.POSTPutAttributesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_select(self, request: operations.POSTSelectRequest) -> operations.POSTSelectResponse:
        ...
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        query_params = utils.get_query_params(operations.POSTSelectRequest, request)
        ...
        res = operations.POSTSelectResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
