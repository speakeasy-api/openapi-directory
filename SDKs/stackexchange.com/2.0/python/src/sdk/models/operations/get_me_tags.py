...
class GetMeTagsQueryParams:
    ...
    order: Optional[GetMeTagsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeTagsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeTagsRequest:
    query_params: GetMeTagsQueryParams = dataclasses.field()
