...
exports.GetConversationsResponse = exports.GetConversations200ApplicationJSON = exports.GetConversationsRequest = void 0;
...
var GetConversationsRequest = /** @class */ (function (_super) {
    ...
    ], GetConversationsRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=device_pixel_ratio",
        }),
        __metadata("design:type", Number)
    ], GetConversationsRequest.prototype, "devicePixelRatio", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=include_num_unread",
        }),
        __metadata("design:type", Number)
    ], GetConversationsRequest.prototype, "includeNumUnread", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=num_messages",
        }),
        __metadata("design:type", Number)
    ], GetConversationsRequest.prototype, "numMessages", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetConversationsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetConversationsRequest.prototype, "perPage", void 0);
...
var GetConversations200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "num_unread" }),
        __metadata("design:type", Number)
