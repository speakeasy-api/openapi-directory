...
class DescribeDirectConnectGatewaysHeaders:
...
class DescribeDirectConnectGatewaysRequest:
    headers: DescribeDirectConnectGatewaysHeaders = dataclasses.field()
    request: shared_describedirectconnectgatewaysrequest.DescribeDirectConnectGatewaysRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
