...
class GetEntitlementsRequest:
    headers: GetEntitlementsHeaders = dataclasses.field()
    request: shared_getentitlementsrequest.GetEntitlementsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
