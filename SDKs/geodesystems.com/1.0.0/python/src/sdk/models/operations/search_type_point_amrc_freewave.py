...
class SearchTypePointAmrcFreewaveQueryParams:
    ...
    search_type_point_amrc_freewave_datalogger_model: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_amrc_freewave.datalogger_model', 'style': 'form', 'explode': True }})
    search_type_point_amrc_freewave_datalogger_serial: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_amrc_freewave.datalogger_serial', 'style': 'form', 'explode': True }})
    search_type_point_amrc_freewave_format: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_amrc_freewave.format', 'style': 'form', 'explode': True }})
    search_type_point_amrc_freewave_station_name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_amrc_freewave.station_name', 'style': 'form', 'explode': True }})
...
class SearchTypePointAmrcFreewaveRequest:
    query_params: SearchTypePointAmrcFreewaveQueryParams = dataclasses.field()
