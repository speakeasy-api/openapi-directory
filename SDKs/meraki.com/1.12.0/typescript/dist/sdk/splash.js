...
var Splash = /** @class */ (function () {
    function Splash(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Splash.prototype.getNetworkWirelessSsidSplashSettings = function (req, config) {
    ...
    **/
    Splash.prototype.updateNetworkWirelessSsidSplashSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
