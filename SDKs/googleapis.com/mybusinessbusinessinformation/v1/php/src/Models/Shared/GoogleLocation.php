...
class GoogleLocation
{
     ...
     * 
     * @var ?string $requestAdminRightsUri
     */
	#[\JMS\Serializer\Annotation\SerializedName('requestAdminRightsUri')]
    #[\JMS\Serializer\Annotation\Type('string')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?string $requestAdminRightsUri = null;
    
	public function __construct()
	{
		$this->location = null;
		$this->name = null;
		$this->requestAdminRightsUri = null;
	}
}
