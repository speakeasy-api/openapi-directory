...
func main() {
    ...
    res, err := s.Orgs.OrgsGetMembershipForUser(ctx, operations.OrgsGetMembershipForUserRequest{
        Org: "dolorem",
        Username: "Caleb.Runolfsdottir65",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsList(ctx, operations.OrgsListRequest{
        PerPage: sdk.Int64(8931),
        Since: sdk.Int64(97258),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListAppInstallations(ctx, operations.OrgsListAppInstallationsRequest{
        Org: "et",
        Page: sdk.Int64(497777),
        PerPage: sdk.Int64(619183),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListForUser(ctx, operations.OrgsListForUserRequest{
        Page: sdk.Int64(241557),
        PerPage: sdk.Int64(96562),
        Username: "Cathy_Wyman5",
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListMembers(ctx, operations.OrgsListMembersRequest{
        ...
        Org: "nihil",
        Page: sdk.Int64(473190),
        PerPage: sdk.Int64(115834),
...
func main() {
    ...
    res, err := s.Orgs.OrgsListMembershipsForAuthenticatedUser(ctx, operations.OrgsListMembershipsForAuthenticatedUserRequest{
        Page: sdk.Int64(457059),
        PerPage: sdk.Int64(508390),
...
func main() {
    ...
    res, err := s.Orgs.OrgsListOutsideCollaborators(ctx, operations.OrgsListOutsideCollaboratorsRequest{
        ...
        Org: "vel",
        Page: sdk.Int64(99958),
        PerPage: sdk.Int64(857125),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListPublicMembers(ctx, operations.OrgsListPublicMembersRequest{
        Org: "doloremque",
        Page: sdk.Int64(117315),
        PerPage: sdk.Int64(483706),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsListWebhooks(ctx, operations.OrgsListWebhooksRequest{
        Org: "tempora",
        Page: sdk.Int64(458259),
        PerPage: sdk.Int64(403793),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Orgs.OrgsUpdate(ctx, operations.OrgsUpdateRequest{
        RequestBody: &operations.OrgsUpdateRequestBody{
            BillingEmail: sdk.String("expedita"),
            Blog: sdk.String(""http://github.blog""),
            Company: sdk.String("MacGyver LLC"),
            ...
            Email: sdk.String("Lemuel_Bogan63@yahoo.com"),
            ...
            TwitterUsername: sdk.String("voluptatem"),
        },
        Org: "alias",
    })
    if err != nil {
