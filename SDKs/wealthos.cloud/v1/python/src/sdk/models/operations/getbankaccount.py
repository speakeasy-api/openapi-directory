...
@dataclasses.dataclass
class GetBankAccount500ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBankAccount429ApplicationJSON:
...
class GetBankAccount409ApplicationJSONStatusEnum(str, Enum):
...
class GetBankAccount409ApplicationJSON:
    ...
    message: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message') }})
    r"""Human readable description of the error"""  
    status: GetBankAccount409ApplicationJSONStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status') }})
    r"""Current status of the original request"""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBankAccount404ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBankAccount403ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBankAccount401ApplicationJSON:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBankAccount400ApplicationJSON:
...
class GetBankAccount200ApplicationJSONAccountStatusEnum(str, Enum):
    r"""If not populated, will be defaulted to inactive"""
    ACTIVE = 'active'
    INACTIVE = 'inactive'

class GetBankAccount200ApplicationJSONDefaultAccountEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetBankAccount200ApplicationJSON:
    r"""success"""
    ...
    default_account: GetBankAccount200ApplicationJSONDefaultAccountEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('default_account') }})
    r"""Only one account should be the default"""  
    investor_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('investor_id') }})  
    account_status: Optional[GetBankAccount200ApplicationJSONAccountStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('account_status'), 'exclude': lambda f: f is None }})
    r"""If not populated, will be defaulted to inactive"""  
...
class GetBankAccountResponse:
    ...
    get_bank_account_200_application_json_object: Optional[GetBankAccount200ApplicationJSON] = dataclasses.field(default=None)
    r"""success"""  
    get_bank_account_400_application_json_object: Optional[GetBankAccount400ApplicationJSON] = dataclasses.field(default=None)
    r"""Request is not complete and may have one or more validations errors. Please check the error message and the code"""  
    get_bank_account_401_application_json_object: Optional[GetBankAccount401ApplicationJSON] = dataclasses.field(default=None)
    r"""You do not have permissions to access this resource."""  
    get_bank_account_403_application_json_object: Optional[GetBankAccount403ApplicationJSON] = dataclasses.field(default=None)
    r"""Your authentication information is missing or invalid. Please check the keys are properly set and its correct"""  
    get_bank_account_404_application_json_object: Optional[GetBankAccount404ApplicationJSON] = dataclasses.field(default=None)
    r"""The specified resource was not found"""  
    get_bank_account_409_application_json_object: Optional[GetBankAccount409ApplicationJSON] = dataclasses.field(default=None)
    r"""Duplicate request"""  
    get_bank_account_429_application_json_object: Optional[GetBankAccount429ApplicationJSON] = dataclasses.field(default=None)
    r"""You have sent too many requests to the system. Please retry later. If you need to increase your throtteling limits, please contact WOS support"""  
    get_bank_account_500_application_json_object: Optional[GetBankAccount500ApplicationJSON] = dataclasses.field(default=None)
    r"""System error. Retry later. If the error persist, contact WOS support"""  
