...
class DescribeTableStatisticsRequest:
    ...
    describe_table_statistics_message: shared_describetablestatisticsmessage.DescribeTableStatisticsMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
