...
export class CloudidentityOrgUnitsMembershipsMoveRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudidentityOrgUnitsMembershipsMoveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
