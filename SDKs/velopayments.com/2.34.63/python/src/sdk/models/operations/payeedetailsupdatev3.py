...
from ..shared import updatepayeedetailsrequestv3 as shared_updatepayeedetailsrequestv3
...
class PayeeDetailsUpdateV3Request:
    ...
    update_payee_details_request_v3_input: shared_updatepayeedetailsrequestv3.UpdatePayeeDetailsRequestV3Input = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
