...
func (e PaymentCardCardBrandEnum) ToPointer() *PaymentCardCardBrandEnum {
	return &e
}
...
func (e *PaymentCardCardBrandEnum) UnmarshalJSON(data []byte) error {
	...
	case "ebt":
		fallthrough
	case "other":
		*e = PaymentCardCardBrandEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PaymentCardCardBrandEnum: %v", v)
	}
}
...
func (e PaymentCardCardTypeEnum) ToPointer() *PaymentCardCardTypeEnum {
	return &e
}
...
func (e *PaymentCardCardTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "prepaid":
		fallthrough
	case "other":
		*e = PaymentCardCardTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PaymentCardCardTypeEnum: %v", v)
	}
}
...
func (e PaymentCardPrepaidTypeEnum) ToPointer() *PaymentCardPrepaidTypeEnum {
	return &e
}
...
func (e *PaymentCardPrepaidTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "prepaid":
		fallthrough
	case "unknown":
		*e = PaymentCardPrepaidTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PaymentCardPrepaidTypeEnum: %v", v)
	}
}
