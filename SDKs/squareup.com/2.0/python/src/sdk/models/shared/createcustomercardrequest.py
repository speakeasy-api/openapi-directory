...
class CreateCustomerCardRequest:
    r"""Defines the fields that are included in the request body of a request
    to the `CreateCustomerCard` endpoint.
    """
    
    card_nonce: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('card_nonce') }})
    r"""A card nonce representing the credit card to link to the customer.
    ...
    r"""The full name printed on the credit card."""  
