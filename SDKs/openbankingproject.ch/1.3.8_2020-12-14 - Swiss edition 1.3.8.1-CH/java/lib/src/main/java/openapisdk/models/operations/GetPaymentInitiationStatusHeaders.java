...
public class GetPaymentInitiationStatusHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Digest")
    public String digest;
    public GetPaymentInitiationStatusHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-Accept")
    public String psuAccept;
    public GetPaymentInitiationStatusHeaders withPsuAccept(String psuAccept) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuAcceptCharset(String psuAcceptCharset) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuDeviceId(String psuDeviceID) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuGeoLocation(String psuGeoLocation) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuHttpMethod(openapisdk.models.shared.PsuHttpMethodEnum psuHttpMethod) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuIpAddress(String psuIPAddress) {
        this.psuIPAddress = psuIPAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-IP-Port")
    public String psuIPPort;
    public GetPaymentInitiationStatusHeaders withPsuIpPort(String psuIPPort) {
    ...
    public GetPaymentInitiationStatusHeaders withPsuUserAgent(String psuUserAgent) {
        this.psuUserAgent = psuUserAgent;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Signature")
    public String signature;
    public GetPaymentInitiationStatusHeaders withSignature(String signature) {
    ...
    public GetPaymentInitiationStatusHeaders withTppSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetPaymentInitiationStatusHeaders withXRequestId(String xRequestID) {
