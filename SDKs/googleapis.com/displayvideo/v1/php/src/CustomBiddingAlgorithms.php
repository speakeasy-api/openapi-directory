...
class CustomBiddingAlgorithms 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DisplayvideoCustomBiddingAlgorithmsCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/customBiddingAlgorithms');
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/customBiddingAlgorithms/{customBiddingAlgorithmId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoCustomBiddingAlgorithmsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/customBiddingAlgorithms/{customBiddingAlgorithmId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoCustomBiddingAlgorithmsPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoCustomBiddingAlgorithmsScriptsCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts/{customBiddingScriptId}', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoCustomBiddingAlgorithmsScriptsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoCustomBiddingAlgorithmsScriptsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/customBiddingAlgorithms/{customBiddingAlgorithmId}:uploadScript', \OpenAPI\OpenAPI\Models\Operations\DisplayvideoCustomBiddingAlgorithmsUploadScriptRequest::class, $request);
