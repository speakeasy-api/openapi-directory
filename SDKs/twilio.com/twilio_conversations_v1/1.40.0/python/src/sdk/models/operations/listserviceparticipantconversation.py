...
class ListServiceParticipantConversationRequest:
    ...
    r"""The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) the Participant Conversations resource is associated with."""  
    address: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'Address', 'style': 'form', 'explode': True }})
    r"""A unique string identifier for the conversation participant who's not a Conversation User. This parameter could be found in messaging_binding.address field of Participant resource. It should be url-encoded."""  
...
class ListServiceParticipantConversationListServiceParticipantConversationResponse:
    ...
    conversations: Optional[list[shared_conversations_v1_service_service_participant_conversation.ConversationsV1ServiceServiceParticipantConversation]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('conversations'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListServiceParticipantConversationListServiceParticipantConversationResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
