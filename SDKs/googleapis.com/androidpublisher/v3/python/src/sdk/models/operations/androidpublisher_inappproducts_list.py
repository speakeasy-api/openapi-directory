...
class AndroidpublisherInappproductsListRequest:
    ...
    r"""Deprecated and ignored. The page size is determined by the server."""  
    ...
    r"""Deprecated and ignored. Set the `token` parameter to rertieve the next page."""  
    token: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'token', 'style': 'form', 'explode': True }})
    r"""Pagination token. If empty, list starts at the first product."""  
