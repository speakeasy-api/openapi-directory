...
exports.GooglePlayDeveloperReportingV1beta1Anomaly = void 0;
...
**/
var GooglePlayDeveloperReportingV1beta1Anomaly = /** @class */ (function (_super) {
    __extends(GooglePlayDeveloperReportingV1beta1Anomaly, _super);
    function GooglePlayDeveloperReportingV1beta1Anomaly() {
    ...
    ], GooglePlayDeveloperReportingV1beta1Anomaly.prototype, "dimensions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=metric" }),
        __metadata("design:type", googleplaydeveloperreportingv1beta1metricvalue_1.GooglePlayDeveloperReportingV1beta1MetricValue)
    ], GooglePlayDeveloperReportingV1beta1Anomaly.prototype, "metric", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=metricSet" }),
        __metadata("design:type", String)
    ], GooglePlayDeveloperReportingV1beta1Anomaly.prototype, "metricSet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], GooglePlayDeveloperReportingV1beta1Anomaly.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timelineSpec" }),
        __metadata("design:type", googleplaydeveloperreportingv1beta1timelinespec_1.GooglePlayDeveloperReportingV1beta1TimelineSpec)
    ], GooglePlayDeveloperReportingV1beta1Anomaly.prototype, "timelineSpec", void 0);
    return GooglePlayDeveloperReportingV1beta1Anomaly;
}(utils_1.SpeakeasyBase));
exports.GooglePlayDeveloperReportingV1beta1Anomaly = GooglePlayDeveloperReportingV1beta1Anomaly;
