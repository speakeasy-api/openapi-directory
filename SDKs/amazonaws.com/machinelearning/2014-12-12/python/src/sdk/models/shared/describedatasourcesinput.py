...
from ..shared import datasourcefiltervariable_enum as shared_datasourcefiltervariable_enum
...
class DescribeDataSourcesInput:
    ...
    filter_variable: Optional[shared_datasourcefiltervariable_enum.DataSourceFilterVariableEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FilterVariable') }})
