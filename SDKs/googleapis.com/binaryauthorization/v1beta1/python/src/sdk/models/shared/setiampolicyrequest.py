...
class SetIamPolicyRequest:
    ...
    policy: Optional[shared_iampolicy.IamPolicy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policy'), 'exclude': lambda f: f is None }})
