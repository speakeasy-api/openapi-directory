...
export declare class Public {
     ...
     * None.
     */
    cancelFileUploadViaShare(req: operations.CancelFileUploadViaShareRequest, config?: AxiosRequestConfig): Promise<operations.CancelFileUploadViaShareResponse>;
    /**
     ...
     * None.
     */
    checkPublicDownloadSharePassword(req: operations.CheckPublicDownloadSharePasswordRequest, config?: AxiosRequestConfig): Promise<operations.CheckPublicDownloadSharePasswordResponse>;
    /**
     ...
     */
    completeFileUploadViaShare(req: operations.CompleteFileUploadViaShareRequest, config?: AxiosRequestConfig): Promise<operations.CompleteFileUploadViaShareResponse>;
    /**
     ...
     *
     */
    completeS3FileUploadViaShare(req: operations.CompleteS3FileUploadViaShareRequest, config?: AxiosRequestConfig): Promise<operations.CompleteS3FileUploadViaShareResponse>;
    /**
     ...
     *
     */
    createShareUploadChannel(req: operations.CreateShareUploadChannelRequest, config?: AxiosRequestConfig): Promise<operations.CreateShareUploadChannelResponse>;
    /**
     ...
     * @see {@link https://tools.ietf.org/html/rfc7233} - Range Requests
     */
    downloadFileViaTokenPublic(req: operations.DownloadFileViaTokenPublicRequest, config?: AxiosRequestConfig): Promise<operations.DownloadFileViaTokenPublicResponse>;
    /**
     * Download file with token
     *
     * @remarks
     ...
     * @see {@link https://tools.ietf.org/html/rfc7233} - Range Requests
     */
    downloadFileViaTokenPublic1(req: operations.DownloadFileViaTokenPublic1Request, config?: AxiosRequestConfig): Promise<operations.DownloadFileViaTokenPublic1Response>;
    /**
     ...
     */
    generateDownloadUrlPublic(req: operations.GenerateDownloadUrlPublicRequest, config?: AxiosRequestConfig): Promise<operations.GenerateDownloadUrlPublicResponse>;
    /**
     ...
     */
    generatePresignedUrlsPublic(req: operations.GeneratePresignedUrlsPublicRequest, config?: AxiosRequestConfig): Promise<operations.GeneratePresignedUrlsPublicResponse>;
    /**
     ...
     * None.
     */
    requestActiveDirectoryAuthInfo(req: operations.RequestActiveDirectoryAuthInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestActiveDirectoryAuthInfoResponse>;
    /**
     ...
     * None.
     */
    requestOpenIdAuthInfo(req: operations.RequestOpenIdAuthInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestOpenIdAuthInfoResponse>;
    /**
     ...
     * None.
     */
    requestPublicDownloadShareInfo(req: operations.RequestPublicDownloadShareInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestPublicDownloadShareInfoResponse>;
    /**
     ...
     *
     */
    requestPublicUploadShareInfo(req: operations.RequestPublicUploadShareInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestPublicUploadShareInfoResponse>;
    /**
     ...
     */
    requestSoftwareVersion(req: operations.RequestSoftwareVersionRequest, config?: AxiosRequestConfig): Promise<operations.RequestSoftwareVersionResponse>;
    /**
     ...
     */
    requestSystemInfo(req: operations.RequestSystemInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestSystemInfoResponse>;
    /**
     * Request system time
     *
     * @remarks
     ...
     * None.
     */
    requestSystemTime(req: operations.RequestSystemTimeRequest, config?: AxiosRequestConfig): Promise<operations.RequestSystemTimeResponse>;
    /**
     ...
     *
     */
    requestThirdPartyDependencies(config?: AxiosRequestConfig): Promise<operations.RequestThirdPartyDependenciesResponse>;
    /**
     ...
     * </details>
     */
    requestUploadStatusPublic(req: operations.RequestUploadStatusPublicRequest, config?: AxiosRequestConfig): Promise<operations.RequestUploadStatusPublicResponse>;
    /**
     * Upload file
     *
     * @remarks
     ...
     * @see {@link https://tools.ietf.org/html/rfc7233} - Range Requests
     */
    uploadFileAsMultipartPublic1(req: operations.UploadFileAsMultipartPublic1Request, config?: AxiosRequestConfig): Promise<operations.UploadFileAsMultipartPublic1Response>;
}
