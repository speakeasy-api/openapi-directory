...
exports.BucketAccessControls = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var BucketAccessControls = /** @class */ (function () {
    function BucketAccessControls(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    BucketAccessControls.prototype.storageBucketAccessControlsDelete = function (req, config) {
    ...
    **/
    BucketAccessControls.prototype.storageBucketAccessControlsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    BucketAccessControls.prototype.storageBucketAccessControlsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    BucketAccessControls.prototype.storageBucketAccessControlsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    BucketAccessControls.prototype.storageBucketAccessControlsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    BucketAccessControls.prototype.storageBucketAccessControlsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.BucketAccessControls = BucketAccessControls;
