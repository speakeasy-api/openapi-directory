...
export class Commits {
  ...
  deleteRepositoriesWorkspaceRepoSlugCommitCommitApprove(
    ...
    security: operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveSecurity(
          security
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveResponse =
        new operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  deleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentId(
    req: operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdRequest,
    security: operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse =
        new operations.DeleteRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  getRepositoriesWorkspaceRepoSlugCommitCommit(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetRepositoriesWorkspaceRepoSlugCommitCommitResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.commit = utils.objectToClass(httpRes?.data);
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
  ...
  getRepositoriesWorkspaceRepoSlugCommitCommitComments(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paginatedCommitComments = utils.objectToClass(
              httpRes?.data,
              shared.PaginatedCommitComments
            );
          }
          break;
      }
  ...
  getRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentId(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.commitComment = utils.objectToClass(httpRes?.data);
          }
          break;
      }
  ...
  getRepositoriesWorkspaceRepoSlugCommits(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugCommitsSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.GetRepositoriesWorkspaceRepoSlugCommitsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugCommitsResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paginatedChangeset = utils.objectToClass(
              httpRes?.data,
              shared.PaginatedChangeset
            );
          }
          break;
        case httpRes?.status == 404:
  ...
  getRepositoriesWorkspaceRepoSlugCommitsRevision(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitsRevisionRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitsRevisionSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugCommitsRevisionResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugCommitsRevisionResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getRepositoriesWorkspaceRepoSlugDiffSpec(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugDiffSpecSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugDiffSpecSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugDiffSpecResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugDiffSpecResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getRepositoriesWorkspaceRepoSlugDiffstatSpec(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugDiffstatSpecSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetRepositoriesWorkspaceRepoSlugDiffstatSpecResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetRepositoriesWorkspaceRepoSlugDiffstatSpecRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugDiffstatSpecSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugDiffstatSpecResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugDiffstatSpecResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paginatedDiffstats = utils.objectToClass(
              httpRes?.data,
              shared.PaginatedDiffstats
            );
          }
          break;
        case httpRes?.status == 555:
  ...
  getRepositoriesWorkspaceRepoSlugMergeBaseRevspec(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  getRepositoriesWorkspaceRepoSlugPatchSpec(
    ...
    security: operations.GetRepositoriesWorkspaceRepoSlugPatchSpecSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.GetRepositoriesWorkspaceRepoSlugPatchSpecResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GetRepositoriesWorkspaceRepoSlugPatchSpecRequest(
        req
      );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.GetRepositoriesWorkspaceRepoSlugPatchSpecSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetRepositoriesWorkspaceRepoSlugPatchSpecResponse =
        new operations.GetRepositoriesWorkspaceRepoSlugPatchSpecResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postRepositoriesWorkspaceRepoSlugCommitCommitApprove(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitApproveRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitApproveSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostRepositoriesWorkspaceRepoSlugCommitCommitApproveResponse =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitApproveResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  postRepositoriesWorkspaceRepoSlugCommitCommitComments(
    ...
    security: operations.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitCommitCommentsResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  postRepositoriesWorkspaceRepoSlugCommits(
    ...
    security: operations.PostRepositoriesWorkspaceRepoSlugCommitsSecurity,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitsSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostRepositoriesWorkspaceRepoSlugCommitsResponse =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  postRepositoriesWorkspaceRepoSlugCommitsRevision(
    ...
    security: operations.PostRepositoriesWorkspaceRepoSlugCommitsRevisionSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.PostRepositoriesWorkspaceRepoSlugCommitsRevisionResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitsRevisionRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitsRevisionSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PostRepositoriesWorkspaceRepoSlugCommitsRevisionResponse =
        new operations.PostRepositoriesWorkspaceRepoSlugCommitsRevisionResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
  ...
  putRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentId(
    req: operations.PutRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdRequest,
    security: operations.PutRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.PutRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.PutRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.PutRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdSecurity(
          security
        );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse =
        new operations.PutRepositoriesWorkspaceRepoSlugCommitCommitCommentsCommentIdResponse(
          {
            statusCode: httpRes.status,
            contentType: contentType,
            rawResponse: httpRes,
