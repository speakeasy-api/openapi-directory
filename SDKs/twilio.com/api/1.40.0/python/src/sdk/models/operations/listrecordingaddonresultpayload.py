...
class ListRecordingAddOnResultPayloadRequest:
    ...
    r"""The SID of the [Account](https://www.twilio.com/docs/iam/api/account) that created the Recording AddOnResult Payload resources to read."""  
    add_on_result_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'AddOnResultSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the AddOnResult to which the payloads to read belongs."""  
    reference_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ReferenceSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the recording to which the AddOnResult resource that contains the payloads to read belongs."""  
...
class ListRecordingAddOnResultPayloadListRecordingAddOnResultPayloadResponse:
    ...
    payloads: Optional[list[shared_api_v2010_account_recording_recording_add_on_result_recording_add_on_result_payload.APIV2010AccountRecordingRecordingAddOnResultRecordingAddOnResultPayload]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('payloads'), 'exclude': lambda f: f is None }})  
