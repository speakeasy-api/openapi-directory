...
class SheetsSpreadsheetsBatchUpdateRequest:
    ...
    r"""The spreadsheet to apply the updates to."""  
    ...
    batch_update_spreadsheet_request: Optional[shared_batchupdatespreadsheetrequest.BatchUpdateSpreadsheetRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
