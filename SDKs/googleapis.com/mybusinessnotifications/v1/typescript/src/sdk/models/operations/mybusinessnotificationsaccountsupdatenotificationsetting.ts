...
export class MybusinessnotificationsAccountsUpdateNotificationSettingRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class MybusinessnotificationsAccountsUpdateNotificationSettingResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
