...
class AdsensehostAccountsAdunitsInsertRequest:
    ...
    r"""Account which will contain the ad unit."""  
    ad_client_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'adClientId', 'style': 'simple', 'explode': False }})
    r"""Ad client into which to insert the ad unit."""  
    ad_unit: Optional[shared_adunit.AdUnit] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
