...
public class CancelDeploymentResponse {
    ...
    public org.openapis.openapi.models.shared.CancelDeploymentResponse cancelDeploymentResponse;

    public CancelDeploymentResponse withCancelDeploymentResponse(org.openapis.openapi.models.shared.CancelDeploymentResponse cancelDeploymentResponse) {
    ...
    public CancelDeploymentResponse withStatusCode(Integer statusCode) {
    ...
    public CancelDeploymentResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public CancelDeploymentResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
