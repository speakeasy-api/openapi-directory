...
func (e DescribeGameSessionsXAmzTargetEnum) ToPointer() *DescribeGameSessionsXAmzTargetEnum {
	return &e
}
...
func (e *DescribeGameSessionsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "GameLift.DescribeGameSessions":
		*e = DescribeGameSessionsXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeGameSessionsXAmzTargetEnum: %v", v)
	}
}
