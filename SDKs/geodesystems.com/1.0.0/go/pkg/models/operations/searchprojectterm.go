...
type SearchProjectTermQueryParams struct {
	...
	// Term Value
	SearchProjectTermValue *string `queryParam:"style=form,explode=true,name=search.project_term.value"`
	// Number to skip
...
type SearchProjectTermRequest struct {
	QueryParams SearchProjectTermQueryParams
}

type SearchProjectTermResponse struct {
	ContentType string
	StatusCode  int
