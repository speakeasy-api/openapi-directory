...
class GETRestoreDBInstanceToPointInTimeRequest
{
	...
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=RestoreTime,dateTimeFormat=Y-m-d\TH:i:s.up')]
	...
	{
		$this->action = \OpenAPI\OpenAPI\Models\Operations\GETRestoreDBInstanceToPointInTimeActionEnum::RESTORE_DB_INSTANCE_TO_POINT_IN_TIME;
		...
		$this->version = \OpenAPI\OpenAPI\Models\Operations\GETRestoreDBInstanceToPointInTimeVersionEnum::TWO_THOUSAND_AND_THIRTEEN0110;
