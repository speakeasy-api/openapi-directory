...
export class GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIdSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIdRequest extends SpeakeasyBase {
  /**
...
export class GetWorkspacesWorkspaceProjectsProjectKeyDeployKeysKeyIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
