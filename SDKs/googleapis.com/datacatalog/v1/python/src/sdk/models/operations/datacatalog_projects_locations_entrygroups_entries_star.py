...
class DatacatalogProjectsLocationsEntryGroupsEntriesStarRequest:
    ...
    r"""Required. The name of the entry to mark as starred."""  
...
class DatacatalogProjectsLocationsEntryGroupsEntriesStarResponse:
    ...
    google_cloud_datacatalog_v1_star_entry_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
