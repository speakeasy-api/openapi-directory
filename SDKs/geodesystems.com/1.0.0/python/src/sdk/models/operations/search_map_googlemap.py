...
class SearchMapGooglemapQueryParams:
...
@dataclasses.dataclass
class SearchMapGooglemapRequest:
    query_params: SearchMapGooglemapQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchMapGooglemapResponse:
