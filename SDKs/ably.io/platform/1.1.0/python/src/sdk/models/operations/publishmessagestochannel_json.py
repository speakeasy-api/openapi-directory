...
class PublishMessagesToChannelJSONRequest:
...
@dataclasses.dataclass
class PublishMessagesToChannelJSON2XXApplicationJSON:
    r"""OK"""
...
class PublishMessagesToChannelJSONResponse:
    ...
    r"""Error"""  
    publish_messages_to_channel_json_2_xx_application_json_object: Optional[PublishMessagesToChannelJSON2XXApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
