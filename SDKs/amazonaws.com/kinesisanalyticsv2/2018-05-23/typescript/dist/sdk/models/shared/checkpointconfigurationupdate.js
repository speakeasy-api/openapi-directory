...
exports.CheckpointConfigurationUpdate = void 0;
 ...
 */
var CheckpointConfigurationUpdate = /** @class */ (function (_super) {
    __extends(CheckpointConfigurationUpdate, _super);
    function CheckpointConfigurationUpdate() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CheckpointIntervalUpdate" }),
        __metadata("design:type", Number)
    ], CheckpointConfigurationUpdate.prototype, "checkpointIntervalUpdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CheckpointingEnabledUpdate" }),
        __metadata("design:type", Boolean)
    ], CheckpointConfigurationUpdate.prototype, "checkpointingEnabledUpdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ConfigurationTypeUpdate" }),
        __metadata("design:type", String)
    ], CheckpointConfigurationUpdate.prototype, "configurationTypeUpdate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MinPauseBetweenCheckpointsUpdate" }),
        __metadata("design:type", Number)
