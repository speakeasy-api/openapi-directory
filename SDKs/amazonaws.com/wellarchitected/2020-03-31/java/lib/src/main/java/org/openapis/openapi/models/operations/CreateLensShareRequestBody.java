...
public class CreateLensShareRequestBody {
    /**
    ...
    public CreateLensShareRequestBody withClientRequestToken(String clientRequestToken) {
    ...
    public CreateLensShareRequestBody withSharedWith(String sharedWith) {
        this.sharedWith = sharedWith;
        return this;
    }
    
    public CreateLensShareRequestBody(@JsonProperty("ClientRequestToken") String clientRequestToken, @JsonProperty("SharedWith") String sharedWith) {
        this.clientRequestToken = clientRequestToken;
        this.sharedWith = sharedWith;
  }
}
