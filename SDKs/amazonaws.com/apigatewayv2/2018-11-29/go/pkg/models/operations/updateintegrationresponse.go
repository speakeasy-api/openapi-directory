...
func (e *UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum) UnmarshalJSON(data []byte) error {
	...
	case "CONVERT_TO_TEXT":
		*e = UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateIntegrationResponseRequestBodyContentHandlingStrategyEnum: %s", s)
	}
}
