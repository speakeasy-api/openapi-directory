...
class GetVerifyEmailIdentityQueryParams:
    action: GetVerifyEmailIdentityActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    email_address: str = dataclasses.field(metadata={'query_param': { 'field_name': 'EmailAddress', 'style': 'form', 'explode': True }})
    version: GetVerifyEmailIdentityVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetVerifyEmailIdentityRequest:
    headers: GetVerifyEmailIdentityHeaders = dataclasses.field()
    query_params: GetVerifyEmailIdentityQueryParams = dataclasses.field()
