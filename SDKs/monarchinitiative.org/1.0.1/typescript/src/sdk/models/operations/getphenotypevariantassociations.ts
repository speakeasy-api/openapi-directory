...
export class GetPhenotypeVariantAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetPhenotypeVariantAssociationsQueryParams extends SpeakeasyBase {
...
export class GetPhenotypeVariantAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetPhenotypeVariantAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
