...
var PricingV2TrunkingNumber = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=originating_call_price" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=terminating_prefix_prices", elemType: PricingV2TrunkingNumberTerminatingPrefixPrices }),
        __metadata("design:type", Array)
