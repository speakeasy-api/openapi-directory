...
export declare enum PafAliasAddressCountryEnum {
    England = "England",
    Scotland = "Scotland",
    Wales = "Wales",
...
export declare enum PafAliasAddressCountryIsoEnum {
    Gbr = "GBR",
    Imn = "IMN",
    Jey = "JEY",
    Ggy = "GGY"
}
export declare enum PafAliasAddressCountryIso2Enum {
    Gb = "GB",
    Im = "IM",
    Je = "JE",
    Gg = "GG"
}
export declare enum PafAliasAddressDatasetEnum {
    Pafa = "pafa"
}
export declare enum PafAliasAddressLanguageEnum {
    En = "en"
}
/**
 ...
 */
export declare class PafAliasAddress extends SpeakeasyBase {
    /**
