...
from .transaction_accounts import TransactionAccounts
...
class SDK:
    ...
    def _init_sdks(self):
        ...
        self.category_rules = CategoryRules(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
        ...
        self.transaction_accounts = TransactionAccounts(
            self._client,
            self._security_client,
            self._server_url,
            self._language,
