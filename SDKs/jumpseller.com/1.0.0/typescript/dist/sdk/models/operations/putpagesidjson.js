...
exports.PutPagesIdJsonResponse = exports.PutPagesIdJsonRequest = void 0;
...
var PutPagesIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutPagesIdJsonRequest.prototype, "pageModify", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutPagesIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutPagesIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutPagesIdJsonRequest.prototype, "login", void 0);
    return PutPagesIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutPagesIdJsonRequest = PutPagesIdJsonRequest;
var PutPagesIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutPagesIdJsonResponse.prototype, "rawResponse", void 0);
    return PutPagesIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PutPagesIdJsonResponse = PutPagesIdJsonResponse;
