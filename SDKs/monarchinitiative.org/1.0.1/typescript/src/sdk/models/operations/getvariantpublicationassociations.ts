...
export class GetVariantPublicationAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetVariantPublicationAssociationsQueryParams extends SpeakeasyBase {
...
export class GetVariantPublicationAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetVariantPublicationAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
