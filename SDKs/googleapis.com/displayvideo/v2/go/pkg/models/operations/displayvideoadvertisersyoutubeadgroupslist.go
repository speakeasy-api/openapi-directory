...
type DisplayvideoAdvertisersYoutubeAdGroupsListPathParams struct {
	// Required. The ID of the advertiser the ad groups belongs to.
	AdvertiserID string `pathParam:"style=simple,explode=false,name=advertiserId"`
}

type DisplayvideoAdvertisersYoutubeAdGroupsListQueryParams struct {
	// V1 error format.
...
type DisplayvideoAdvertisersYoutubeAdGroupsListRequest struct {
	PathParams  DisplayvideoAdvertisersYoutubeAdGroupsListPathParams
	QueryParams DisplayvideoAdvertisersYoutubeAdGroupsListQueryParams
	Security    DisplayvideoAdvertisersYoutubeAdGroupsListSecurity
}
