...
import dataclasses
from ..shared import stationfilters as shared_stationfilters
...
class StationSearchParams:
    r"""Station search params"""
    
    filters: Optional[shared_stationfilters.StationFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('filters'), 'exclude': lambda f: f is None }})
