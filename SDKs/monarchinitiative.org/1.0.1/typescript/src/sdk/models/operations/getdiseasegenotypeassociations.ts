...
export class GetDiseaseGenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetDiseaseGenotypeAssociationsQueryParams extends SpeakeasyBase {
