...
public class Error {
    ...
    public Error(@JsonProperty("error_code") ErrorCodeEnum errorCode, @JsonProperty("error_source") ErrorSourceEnum errorSource, @JsonProperty("error_type") ErrorTypeEnum errorType, @JsonProperty("message") String message) {
        this.errorCode = errorCode;
        this.errorSource = errorSource;
        this.errorType = errorType;
        this.message = message;
