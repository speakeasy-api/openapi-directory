...
class BatchUpdatePartitionRequest:
    ...
    batch_update_partition_request: shared_batchupdatepartitionrequest.BatchUpdatePartitionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
