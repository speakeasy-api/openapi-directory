...
class ManagedZones 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesCreateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/managedZones', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesCreateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/managedZones/{managedZone}', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/managedZones/{managedZone}', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/{resource}:getIamPolicy', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesGetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/managedZones', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/managedZones/{managedZone}', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/{resource}:setIamPolicy', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesSetIamPolicyRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/{resource}:testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesTestIamPermissionsRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/dns/v1/projects/{project}/managedZones/{managedZone}', \OpenAPI\OpenAPI\Models\Operations\DnsManagedZonesUpdateRequest::class, $request);
