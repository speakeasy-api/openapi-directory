...
class GoogleCloudRecommenderV1beta1InsightStateInfo:
    ...
    state: Optional[GoogleCloudRecommenderV1beta1InsightStateInfoStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})
    r"""Insight state."""  
