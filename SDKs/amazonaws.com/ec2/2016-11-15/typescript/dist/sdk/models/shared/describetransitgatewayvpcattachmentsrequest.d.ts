 ...
 */
export declare class DescribeTransitGatewayVpcAttachmentsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayVpcAttachmentsRequest extends SpeakeasyBase {
    dryRun?: boolean;
