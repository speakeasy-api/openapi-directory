...
exports.PutSchemaVersionMetadataResponse = void 0;
...
var PutSchemaVersionMetadataResponse = /** @class */ (function (_super) {
    ...
    ], PutSchemaVersionMetadataResponse.prototype, "latestVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MetadataKey" }),
        __metadata("design:type", String)
    ], PutSchemaVersionMetadataResponse.prototype, "metadataKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=MetadataValue" }),
        __metadata("design:type", String)
    ], PutSchemaVersionMetadataResponse.prototype, "metadataValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=RegistryName" }),
        __metadata("design:type", String)
    ], PutSchemaVersionMetadataResponse.prototype, "registryName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SchemaArn" }),
        __metadata("design:type", String)
    ], PutSchemaVersionMetadataResponse.prototype, "schemaArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SchemaName" }),
        __metadata("design:type", String)
    ], PutSchemaVersionMetadataResponse.prototype, "schemaName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=SchemaVersionId" }),
        __metadata("design:type", String)
    ], PutSchemaVersionMetadataResponse.prototype, "schemaVersionId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=VersionNumber" }),
        __metadata("design:type", Number)
    ], PutSchemaVersionMetadataResponse.prototype, "versionNumber", void 0);
    return PutSchemaVersionMetadataResponse;
}(utils_1.SpeakeasyBase));
exports.PutSchemaVersionMetadataResponse = PutSchemaVersionMetadataResponse;
