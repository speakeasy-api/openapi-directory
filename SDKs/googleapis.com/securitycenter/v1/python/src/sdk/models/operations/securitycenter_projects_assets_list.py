...
@dataclasses.dataclass
class SecuritycenterProjectsAssetsListQueryParams:
...
class SecuritycenterProjectsAssetsListRequest:
    path_params: SecuritycenterProjectsAssetsListPathParams = dataclasses.field()
    query_params: SecuritycenterProjectsAssetsListQueryParams = dataclasses.field()
    security: SecuritycenterProjectsAssetsListSecurity = dataclasses.field()
