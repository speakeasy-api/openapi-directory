...
exports.GetEventsV3EventsGetPageResponse = exports.GetEventsV3EventsGetPageRequest = exports.GetEventsV3EventsGetPageSecurity = void 0;
...
var GetEventsV3EventsGetPageRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetEventsV3EventsGetPageRequest.prototype, "after", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=before",
        }),
        __metadata("design:type", String)
    ], GetEventsV3EventsGetPageRequest.prototype, "before", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=eventType",
        }),
        __metadata("design:type", String)
    ], GetEventsV3EventsGetPageRequest.prototype, "eventType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetEventsV3EventsGetPageRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=objectId",
        }),
        __metadata("design:type", Number)
    ], GetEventsV3EventsGetPageRequest.prototype, "objectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=objectType",
        }),
        __metadata("design:type", String)
    ], GetEventsV3EventsGetPageRequest.prototype, "objectType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=occurredAfter;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetEventsV3EventsGetPageRequest.prototype, "occurredAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=occurredBefore;dateTimeFormat=YYYY-MM-DDThh:mm:ss.sssZ",
        }),
        __metadata("design:type", Date)
    ], GetEventsV3EventsGetPageRequest.prototype, "occurredBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", Array)
    ], GetEventsV3EventsGetPageRequest.prototype, "sort", void 0);
...
var GetEventsV3EventsGetPageResponse = /** @class */ (function (_super) {
    ...
    ], GetEventsV3EventsGetPageResponse.prototype, "rawResponse", void 0);
