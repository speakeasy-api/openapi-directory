...
class GicerRequestBodyCertificateParameters:
    ...
    val: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Val') }})
    verification: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Verification') }})
