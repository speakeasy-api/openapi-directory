...
public class GetFactFodCategoriesSecurity {
    ...
    public GetFactFodCategoriesSecurity withXFungeneratorsApiSecret(String xFungeneratorsApiSecret) {
        this.xFungeneratorsApiSecret = xFungeneratorsApiSecret;
        return this;
    }
    
    public GetFactFodCategoriesSecurity(@JsonProperty("X-Fungenerators-Api-Secret") String xFungeneratorsApiSecret) {
        this.xFungeneratorsApiSecret = xFungeneratorsApiSecret;
  }
}
