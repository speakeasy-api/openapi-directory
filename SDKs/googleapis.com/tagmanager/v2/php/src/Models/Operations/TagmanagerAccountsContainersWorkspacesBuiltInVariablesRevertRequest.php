...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum $type
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=type')]
    public ?TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum $type = null;
