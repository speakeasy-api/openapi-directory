...
from ..shared import changegroupmembersrequest as shared_changegroupmembersrequest
from ..shared import errorresponse as shared_errorresponse
from ..shared import group as shared_group
from enum import Enum
from typing import Optional

class AddGroupMembersXSdsDateFormatEnum(str, Enum):
...
class AddGroupMembersRequest:
    ...
    change_group_members_request: shared_changegroupmembersrequest.ChangeGroupMembersRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    ...
    x_sds_date_format: Optional[AddGroupMembersXSdsDateFormatEnum] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-Sds-Date-Format', 'style': 'simple', 'explode': False }})
    r"""Date time format (cf. [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) & [leettime.de](http://leettime.de/))"""  
