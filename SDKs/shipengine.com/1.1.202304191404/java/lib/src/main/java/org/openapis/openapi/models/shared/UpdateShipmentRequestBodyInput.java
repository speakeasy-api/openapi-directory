...
public class UpdateShipmentRequestBodyInput {
    ...
    public UpdateShipmentRequestBodyInput withIsReturn(Boolean isReturn) {
    ...
    public UpdateShipmentRequestBodyInput(@JsonProperty("ship_from") ShippingAddress shipFrom, @JsonProperty("ship_to") ShippingAddress shipTo) {
        this.shipFrom = shipFrom;
        this.shipTo = shipTo;
  }
}
