...
exports.DriveAppsListResponse = exports.DriveAppsListRequest = exports.DriveAppsListSecurity = exports.DriveAppsListQueryParams = void 0;
...
var DriveAppsListQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=appFilterExtensions" }),
        __metadata("design:type", String)
    ], DriveAppsListQueryParams.prototype, "appFilterExtensions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=appFilterMimeTypes" }),
        __metadata("design:type", String)
...
exports.DriveAppsListQueryParams = DriveAppsListQueryParams;
...
exports.DriveAppsListSecurity = DriveAppsListSecurity;
...
exports.DriveAppsListRequest = DriveAppsListRequest;
...
exports.DriveAppsListResponse = DriveAppsListResponse;
