...
@dataclasses.dataclass
class DfareportingUserRolesDeleteQueryParams:
...
class DfareportingUserRolesDeleteRequest:
    path_params: DfareportingUserRolesDeletePathParams = dataclasses.field()
    query_params: DfareportingUserRolesDeleteQueryParams = dataclasses.field()
    security: DfareportingUserRolesDeleteSecurity = dataclasses.field()
