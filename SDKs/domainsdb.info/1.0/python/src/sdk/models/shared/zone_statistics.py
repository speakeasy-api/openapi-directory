...
class ZoneStatistics:
    ...
    r"""Report Date"""  
    dec: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dec') }})
    r"""Increase"""  
    inc: int = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('inc') }})
    r"""Decrease"""  
