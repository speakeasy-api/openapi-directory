...
exports.StartThingRegistrationTaskResponse = exports.StartThingRegistrationTaskRequest = exports.StartThingRegistrationTaskRequestBody = void 0;
...
var StartThingRegistrationTaskRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "inputFileBucket" }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequestBody.prototype, "inputFileBucket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "inputFileKey" }),
        __metadata("design:type", String)
...
exports.StartThingRegistrationTaskRequestBody = StartThingRegistrationTaskRequestBody;
var StartThingRegistrationTaskRequest = /** @class */ (function (_super) {
    ...
    ], StartThingRegistrationTaskRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], StartThingRegistrationTaskRequest.prototype, "xAmzSignedHeaders", void 0);
    return StartThingRegistrationTaskRequest;
}(utils_1.SpeakeasyBase));
exports.StartThingRegistrationTaskRequest = StartThingRegistrationTaskRequest;
var StartThingRegistrationTaskResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], StartThingRegistrationTaskResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.StartThingRegistrationTaskResponse = StartThingRegistrationTaskResponse;
