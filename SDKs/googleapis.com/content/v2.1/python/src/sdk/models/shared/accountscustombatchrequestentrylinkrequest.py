...
class AccountsCustomBatchRequestEntryLinkRequest:
    ...
    r"""Provided services. Acceptable values are: - \\"`shoppingAdsProductManagement`\\" - \\"`shoppingActionsProductManagement`\\" - \\"`shoppingActionsOrderManagement`\\" - \\"`paymentProcessing`\\" """  
