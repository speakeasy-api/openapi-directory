...
class AndroidpublisherEditsDetailsUpdateRequest:
    path_params: AndroidpublisherEditsDetailsUpdatePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsDetailsUpdateQueryParams = dataclasses.field()
    security: AndroidpublisherEditsDetailsUpdateSecurity = dataclasses.field()
