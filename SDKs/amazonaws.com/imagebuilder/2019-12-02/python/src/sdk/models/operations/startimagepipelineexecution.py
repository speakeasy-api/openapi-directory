...
class StartImagePipelineExecutionRequest:
    headers: StartImagePipelineExecutionHeaders = dataclasses.field()
    request: StartImagePipelineExecutionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
