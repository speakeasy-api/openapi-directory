...
exports.SearchJeopardyResponse = exports.SearchJeopardyRequest = exports.SearchJeopardyQueryParams = void 0;
...
var SearchJeopardyQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_jeopardy.air_date" }),
        __metadata("design:type", String)
    ], SearchJeopardyQueryParams.prototype, "searchDbJeopardyAirDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_jeopardy.answer" }),
        __metadata("design:type", String)
    ], SearchJeopardyQueryParams.prototype, "searchDbJeopardyAnswer", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_jeopardy.category" }),
        __metadata("design:type", String)
    ], SearchJeopardyQueryParams.prototype, "searchDbJeopardyCategory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_jeopardy.question" }),
        __metadata("design:type", String)
    ], SearchJeopardyQueryParams.prototype, "searchDbJeopardyQuestion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.db_jeopardy.round" }),
        __metadata("design:type", String)
...
exports.SearchJeopardyQueryParams = SearchJeopardyQueryParams;
...
exports.SearchJeopardyRequest = SearchJeopardyRequest;
...
exports.SearchJeopardyResponse = SearchJeopardyResponse;
