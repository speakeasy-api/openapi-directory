...
class GetPutUserPolicyQueryParams:
    action: GetPutUserPolicyActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetPutUserPolicyVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetPutUserPolicyRequest:
    headers: GetPutUserPolicyHeaders = dataclasses.field()
    query_params: GetPutUserPolicyQueryParams = dataclasses.field()
