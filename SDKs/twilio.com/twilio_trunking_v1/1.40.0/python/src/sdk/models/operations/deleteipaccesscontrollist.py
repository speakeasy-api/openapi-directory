...
class DeleteIPAccessControlListRequest:
    ...
    r"""The unique string that we created to identify the IpAccessControlList resource to delete."""  
    trunk_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'TrunkSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the Trunk from which to delete the IP Access Control List."""  
