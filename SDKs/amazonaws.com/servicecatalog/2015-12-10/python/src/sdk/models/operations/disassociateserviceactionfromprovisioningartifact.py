...
class DisassociateServiceActionFromProvisioningArtifactRequest:
    ...
    disassociate_service_action_from_provisioning_artifact_input: shared_disassociateserviceactionfromprovisioningartifactinput.DisassociateServiceActionFromProvisioningArtifactInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
