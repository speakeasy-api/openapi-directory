...
export class KeepNotesPermissionsBatchCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class KeepNotesPermissionsBatchCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class KeepNotesPermissionsBatchCreateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
