...
export class OrderMarginRequirements {
  ...
  postAccountsAccountOrderImpact(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PostAccountsAccountOrderImpactResponse =
        new operations.PostAccountsAccountOrderImpactResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.postAccountsAccountOrderImpact200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.PostAccountsAccountOrderImpact200ApplicationJSON
              );
          }
          break;
