...
type TagmanagerAccountsPermissionsUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TagmanagerAccountsPermissionsUpdatePathParams struct {
	// The GTM Account ID.
...
type TagmanagerAccountsPermissionsUpdateQueryParams struct {
	// V1 error format.
...
type TagmanagerAccountsPermissionsUpdateRequest struct {
...
type TagmanagerAccountsPermissionsUpdateResponse struct {
	ContentType string
	StatusCode  int
