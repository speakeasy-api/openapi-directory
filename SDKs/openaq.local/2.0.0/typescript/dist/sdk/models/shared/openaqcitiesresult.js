...
var OpenAQCitiesResult = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return OpenAQCitiesResultMeta; }),
        __metadata("design:type", OpenAQCitiesResultMeta)
    ], OpenAQCitiesResult.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: citiesrow_1.CitiesRow }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return citiesrow_1.CitiesRow; }),
