...
class BankAccountPaginatedResult:
    ...
    meta: BankAccountPaginatedResultMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta') }})
    r"""Metadata associated with the response data"""  
    response: list[shared_bankaccountresult.BankAccountResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response') }})
    r"""The list of bank accounts"""  
