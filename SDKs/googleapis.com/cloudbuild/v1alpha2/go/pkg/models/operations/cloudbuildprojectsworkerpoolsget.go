...
type CloudbuildProjectsWorkerPoolsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudbuildProjectsWorkerPoolsGetPathParams struct {
	// Required. The name of the `WorkerPool` to retrieve. Format: projects/{project}/workerPools/{workerPool}
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type CloudbuildProjectsWorkerPoolsGetQueryParams struct {
	// V1 error format.
...
type CloudbuildProjectsWorkerPoolsGetRequest struct {
...
type CloudbuildProjectsWorkerPoolsGetResponse struct {
	ContentType string
	StatusCode  int
