...
from ..shared import updateaccountresponse as shared_updateaccountresponse
...
class PostUpdateAccountResponse:
    ...
    update_account_response: Optional[shared_updateaccountresponse.UpdateAccountResponse] = dataclasses.field(default=None)
