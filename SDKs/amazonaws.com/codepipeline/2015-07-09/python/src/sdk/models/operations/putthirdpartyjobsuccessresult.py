...
class PutThirdPartyJobSuccessResultRequest:
    ...
    put_third_party_job_success_result_input: shared_putthirdpartyjobsuccessresultinput.PutThirdPartyJobSuccessResultInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
