...
class PaginatedContactResult:
    ...
    meta: PaginatedContactResultMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta') }})
    r"""Metadata associated with the response data"""  
    response: list[shared_contactresult.ContactResult] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response') }})
    r"""List of contact results"""  
