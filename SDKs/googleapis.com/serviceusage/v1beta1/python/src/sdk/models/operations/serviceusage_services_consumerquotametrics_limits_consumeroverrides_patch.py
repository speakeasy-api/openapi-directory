...
class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatchSecurity:
    ...
    option1: Optional[ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatchSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatchSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatchRequest:
    ...
    r"""The resource name of the override to update. An example name would be: `projects/123/services/compute.googleapis.com/consumerQuotaMetrics/compute.googleapis.com%2Fcpus/limits/%2Fproject%2Fregion/consumerOverrides/4a3f2c1d`"""  
    ...
    force_only: Optional[list[ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesPatchForceOnlyEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'forceOnly', 'style': 'form', 'explode': True }})
    ...
    r"""Update only the specified fields of the override. If unset, all fields will be updated."""  
