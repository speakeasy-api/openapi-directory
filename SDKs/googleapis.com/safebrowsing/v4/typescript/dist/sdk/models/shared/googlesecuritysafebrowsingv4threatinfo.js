...
var GoogleSecuritySafebrowsingV4ThreatInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: googlesecuritysafebrowsingv4threatentry_1.GoogleSecuritySafebrowsingV4ThreatEntry }),
        (0, class_transformer_1.Expose)({ name: "threatEntries" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "threatEntryTypes" }),
        __metadata("design:type", Array)
    ], GoogleSecuritySafebrowsingV4ThreatInfo.prototype, "threatEntryTypes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "threatTypes" }),
        __metadata("design:type", Array)
