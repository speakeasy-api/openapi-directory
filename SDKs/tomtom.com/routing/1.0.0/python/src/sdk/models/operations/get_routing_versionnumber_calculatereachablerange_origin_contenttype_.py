...
@dataclasses.dataclass
class GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeQueryParams:
...
class GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeRequest:
    path_params: GetRoutingVersionNumberCalculateReachableRangeOriginContentTypePathParams = dataclasses.field()
    query_params: GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeQueryParams = dataclasses.field()
