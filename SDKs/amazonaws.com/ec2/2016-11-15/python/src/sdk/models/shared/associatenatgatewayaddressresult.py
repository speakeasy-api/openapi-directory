...
class AssociateNatGatewayAddressResultNatGatewayAddressesStatusEnum(str, Enum):
...
class AssociateNatGatewayAddressResultNatGatewayAddresses:
    ...
    status: Optional[AssociateNatGatewayAddressResultNatGatewayAddressesStatusEnum] = dataclasses.field(default=None)  
...
class AssociateNatGatewayAddressResult:
    ...
    nat_gateway_addresses: Optional[list[AssociateNatGatewayAddressResultNatGatewayAddresses]] = dataclasses.field(default=None)  
