...
class StagedEmployeeCustomNumberFields
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomNumberFieldsCategoryEnum $category
     */
	#[\JMS\Serializer\Annotation\SerializedName('category')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomNumberFieldsCategoryEnum>')]
	...
	{
		$this->category = \OpenAPI\OpenAPI\Models\Shared\StagedEmployeeCustomNumberFieldsCategoryEnum::PAYROLL_AND_HR;
		$this->label = "";
		$this->value = 0;
	}
}
