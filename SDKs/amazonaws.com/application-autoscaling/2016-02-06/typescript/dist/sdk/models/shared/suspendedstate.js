...
var SuspendedState = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "DynamicScalingInSuspended" }),
        __metadata("design:type", Boolean)
    ], SuspendedState.prototype, "dynamicScalingInSuspended", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "DynamicScalingOutSuspended" }),
        __metadata("design:type", Boolean)
    ], SuspendedState.prototype, "dynamicScalingOutSuspended", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ScheduledScalingSuspended" }),
        __metadata("design:type", Boolean)
