...
class FormsIndexAttributesBenefitCategories:
...
class FormsIndexAttributes:
    ...
    benefit_categories: Optional[list[FormsIndexAttributesBenefitCategories]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('benefit_categories'), 'exclude': lambda f: f is None }})
    ...
    last_sha256_change: Optional[date] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('last_sha256_change'), 'encoder': utils.dateisoformat(True), 'decoder': utils.datefromisoformat, 'mm_field': fields.DateTime(format='iso'), 'exclude': lambda f: f is None }})
    r"""The date of the last sha256 hash change"""  
...
@dataclasses.dataclass
class FormsIndex:
    r"""A listing of available VA forms and their location."""
    
    attributes: Optional[FormsIndexAttributes] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes'), 'exclude': lambda f: f is None }})  
