...
type SmartdevicemanagementEnterprisesDevicesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SmartdevicemanagementEnterprisesDevicesListPathParams struct {
	// The parent enterprise to list devices under. E.g. "enterprises/XYZ".
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type SmartdevicemanagementEnterprisesDevicesListQueryParams struct {
	// V1 error format.
...
type SmartdevicemanagementEnterprisesDevicesListRequest struct {
...
type SmartdevicemanagementEnterprisesDevicesListResponse struct {
	ContentType string
	// Successful response
