...
class TravelTimeGetOverlayRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\TravelTimeGetOverlayDirectionEnum $direction
     */
	...
	{
		$this->direction = \OpenAPI\OpenAPI\Models\Operations\TravelTimeGetOverlayDirectionEnum::AVERAGE;
		$this->height = 0;
		$this->mapCenterLat = 0;
		$this->mapCenterLon = 0;
		$this->modeId = "";
