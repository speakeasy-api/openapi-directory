...
type SearchBioOntologyAssayQueryParams struct {
...
type SearchBioOntologyAssayRequest struct {
	QueryParams SearchBioOntologyAssayQueryParams
}

type SearchBioOntologyAssayResponse struct {
	ContentType string
	StatusCode  int
