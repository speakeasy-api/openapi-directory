...
type GetTransactionAuthorizationsPathParams struct {
...
type GetTransactionAuthorizationsHeaders struct {
...
type GetTransactionAuthorizationsRequest struct {
	PathParams GetTransactionAuthorizationsPathParams
	Headers    GetTransactionAuthorizationsHeaders
}

type GetTransactionAuthorizationsResponse struct {
	ContentType string
	StatusCode  int
