...
from ..shared import googlecloudretailv2alphareplacecatalogattributerequest as shared_googlecloudretailv2alphareplacecatalogattributerequest
...
class RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttributeRequest:
    ...
    google_cloud_retail_v2alpha_replace_catalog_attribute_request_input: Optional[shared_googlecloudretailv2alphareplacecatalogattributerequest.GoogleCloudRetailV2alphaReplaceCatalogAttributeRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
