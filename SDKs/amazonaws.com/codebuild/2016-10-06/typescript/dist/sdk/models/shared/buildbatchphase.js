...
exports.BuildBatchPhase = void 0;
var utils_1 = require("../../../internal/utils");
var phasecontext_1 = require("./phasecontext");
var statustypeenum_1 = require("./statustypeenum");
var buildbatchphasetypeenum_1 = require("./buildbatchphasetypeenum");
// BuildBatchPhase
/**
 * Contains information about a stage for a batch build.
**/
var BuildBatchPhase = /** @class */ (function (_super) {
    __extends(BuildBatchPhase, _super);
    ...
    ], BuildBatchPhase.prototype, "contexts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=durationInSeconds" }),
        __metadata("design:type", Number)
    ], BuildBatchPhase.prototype, "durationInSeconds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=endTime" }),
        __metadata("design:type", Date)
    ], BuildBatchPhase.prototype, "endTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phaseStatus" }),
        __metadata("design:type", String)
    ], BuildBatchPhase.prototype, "phaseStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=phaseType" }),
        __metadata("design:type", String)
    ], BuildBatchPhase.prototype, "phaseType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=startTime" }),
        __metadata("design:type", Date)
    ], BuildBatchPhase.prototype, "startTime", void 0);
