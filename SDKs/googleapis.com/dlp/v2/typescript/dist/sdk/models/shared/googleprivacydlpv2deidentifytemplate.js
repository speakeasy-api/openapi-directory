...
**/
var GooglePrivacyDlpV2DeidentifyTemplate = /** @class */ (function (_super) {
    __extends(GooglePrivacyDlpV2DeidentifyTemplate, _super);
    function GooglePrivacyDlpV2DeidentifyTemplate() {
 ...
 * DeidentifyTemplates contains instructions on how to de-identify content. See https://cloud.google.com/dlp/docs/concepts-templates to learn more.
**/
var GooglePrivacyDlpV2DeidentifyTemplateInput = /** @class */ (function (_super) {
    __extends(GooglePrivacyDlpV2DeidentifyTemplateInput, _super);
    function GooglePrivacyDlpV2DeidentifyTemplateInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=deidentifyConfig" }),
