...
class GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappingsEbsVolumeTypeEnum(str, Enum):
    r"""The volume type."""
    STANDARD = 'standard'
    IO1 = 'io1'
    IO2 = 'io2'
...
class GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappingsEbs:
    ...
    volume_type: Optional[GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappingsEbsVolumeTypeEnum] = dataclasses.field(default=None)  
...
class GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappings:
    ...
    ebs: Optional[GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappingsEbs] = dataclasses.field(default=None)  
    no_device: Optional[str] = dataclasses.field(default=None)  
    virtual_name: Optional[str] = dataclasses.field(default=None)  
    
class GetLaunchTemplateDataResultLaunchTemplateDataCapacityReservationSpecificationCapacityReservationPreferenceEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataCapacityReservationSpecification:
    ...
    capacity_reservation_preference: Optional[GetLaunchTemplateDataResultLaunchTemplateDataCapacityReservationSpecificationCapacityReservationPreferenceEnum] = dataclasses.field(default=None)  
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataElasticGpuSpecifications:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataElasticInferenceAccelerators:
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceInitiatedShutdownBehaviorEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsMarketTypeEnum(str, Enum):
    r"""The market type."""
    SPOT = 'spot'

class GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsSpotOptionsInstanceInterruptionBehaviorEnum(str, Enum):
    r"""The behavior when a Spot Instance is interrupted."""
    HIBERNATE = 'hibernate'
    STOP = 'stop'
    TERMINATE = 'terminate'

class GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsSpotOptionsSpotInstanceTypeEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsSpotOptions:
    ...
    instance_interruption_behavior: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsSpotOptionsInstanceInterruptionBehaviorEnum] = dataclasses.field(default=None)  
    max_price: Optional[str] = dataclasses.field(default=None)  
    spot_instance_type: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsSpotOptionsSpotInstanceTypeEnum] = dataclasses.field(default=None)  
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptions:
    ...
    market_type: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceMarketOptionsMarketTypeEnum] = dataclasses.field(default=None)  
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorCount:
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorManufacturersEnum(str, Enum):
    NVIDIA = 'nvidia'
    AMD = 'amd'
    AMAZON_WEB_SERVICES = 'amazon-web-services'
    XILINX = 'xilinx'

class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorNamesEnum(str, Enum):
    A100 = 'a100'
    V100 = 'v100'
    K80 = 'k80'
    T4 = 't4'
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiB:
    r"""<p>The minimum and maximum amount of total accelerator memory, in MiB.</p> <p>Default: No minimum or maximum limits</p>"""
    
    max: Optional[int] = dataclasses.field(default=None)  
    min: Optional[int] = dataclasses.field(default=None)  
    
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorTypesEnum(str, Enum):
    GPU = 'gpu'
    FPGA = 'fpga'
    INFERENCE = 'inference'

class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBareMetalEnum(str, Enum):
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBaselineEbsBandwidthMbps:
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBurstablePerformanceEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsCPUManufacturersEnum(str, Enum):
    INTEL = 'intel'
    AMD = 'amd'
    AMAZON_WEB_SERVICES = 'amazon-web-services'

class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsInstanceGenerationsEnum(str, Enum):
    CURRENT = 'current'
    PREVIOUS = 'previous'

class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsLocalStorageEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsLocalStorageTypesEnum(str, Enum):
    HDD = 'hdd'
    SSD = 'ssd'


@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsMemoryGiBPerVCPU:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsMemoryMiB:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsNetworkBandwidthGbps:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsNetworkInterfaceCount:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsTotalLocalStorageGB:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsVCPUCount:
...
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirements:
    ...
    accelerator_count: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorCount] = dataclasses.field(default=None)  
    accelerator_manufacturers: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorManufacturersEnum]] = dataclasses.field(default=None)  
    accelerator_names: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorNamesEnum]] = dataclasses.field(default=None)  
    accelerator_total_memory_mi_b: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiB] = dataclasses.field(default=None)  
    accelerator_types: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsAcceleratorTypesEnum]] = dataclasses.field(default=None)  
    allowed_instance_types: Optional[list[str]] = dataclasses.field(default=None)  
    bare_metal: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBareMetalEnum] = dataclasses.field(default=None)  
    baseline_ebs_bandwidth_mbps: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBaselineEbsBandwidthMbps] = dataclasses.field(default=None)  
    burstable_performance: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBurstablePerformanceEnum] = dataclasses.field(default=None)  
    cpu_manufacturers: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsCPUManufacturersEnum]] = dataclasses.field(default=None)  
    excluded_instance_types: Optional[list[str]] = dataclasses.field(default=None)  
    instance_generations: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsInstanceGenerationsEnum]] = dataclasses.field(default=None)  
    local_storage: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsLocalStorageEnum] = dataclasses.field(default=None)  
    local_storage_types: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsLocalStorageTypesEnum]] = dataclasses.field(default=None)  
    memory_gi_b_per_v_cpu: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsMemoryGiBPerVCPU] = dataclasses.field(default=None)  
    memory_mi_b: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsMemoryMiB] = dataclasses.field(default=None)  
    network_bandwidth_gbps: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsNetworkBandwidthGbps] = dataclasses.field(default=None)  
    network_interface_count: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsNetworkInterfaceCount] = dataclasses.field(default=None)  
    ...
    total_local_storage_gb: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsTotalLocalStorageGB] = dataclasses.field(default=None)  
    v_cpu_count: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsVCPUCount] = dataclasses.field(default=None)  
    
class GetLaunchTemplateDataResultLaunchTemplateDataInstanceTypeEnum(str, Enum):
    r"""The instance type."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
class GetLaunchTemplateDataResultLaunchTemplateDataMaintenanceOptionsAutoRecoveryEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataMaintenanceOptions:
    ...
    auto_recovery: Optional[GetLaunchTemplateDataResultLaunchTemplateDataMaintenanceOptionsAutoRecoveryEnum] = dataclasses.field(default=None)  
    
class GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHTTPEndpointEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHTTPProtocolIpv6Enum(str, Enum):
    r"""<p>Enables or disables the IPv6 endpoint for the instance metadata service.</p> <p>Default: <code>disabled</code> </p>"""
    DISABLED = 'disabled'
    ENABLED = 'enabled'

class GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHTTPTokensEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsInstanceMetadataTagsEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsStateEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptions:
    ...
    http_endpoint: Optional[GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHTTPEndpointEnum] = dataclasses.field(default=None)  
    http_protocol_ipv6: Optional[GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHTTPProtocolIpv6Enum] = dataclasses.field(default=None)  
    http_put_response_hop_limit: Optional[int] = dataclasses.field(default=None)  
    http_tokens: Optional[GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsHTTPTokensEnum] = dataclasses.field(default=None)  
    instance_metadata_tags: Optional[GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsInstanceMetadataTagsEnum] = dataclasses.field(default=None)  
    state: Optional[GetLaunchTemplateDataResultLaunchTemplateDataMetadataOptionsStateEnum] = dataclasses.field(default=None)  
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Addresses:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Prefixes:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesPrivateIPAddresses:
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfaces:
    ...
    ipv4_prefixes: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv4Prefixes]] = dataclasses.field(default=None)  
    ipv6_address_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_addresses: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Addresses]] = dataclasses.field(default=None)  
    ipv6_prefix_count: Optional[int] = dataclasses.field(default=None)  
    ipv6_prefixes: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesIpv6Prefixes]] = dataclasses.field(default=None)  
    ...
    private_ip_address: Optional[str] = dataclasses.field(default=None)  
    private_ip_addresses: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfacesPrivateIPAddresses]] = dataclasses.field(default=None)  
...
class GetLaunchTemplateDataResultLaunchTemplateDataPlacementTenancyEnum(str, Enum):
...
class GetLaunchTemplateDataResultLaunchTemplateDataPlacement:
    ...
    tenancy: Optional[GetLaunchTemplateDataResultLaunchTemplateDataPlacementTenancyEnum] = dataclasses.field(default=None)  
    
class GetLaunchTemplateDataResultLaunchTemplateDataPrivateDNSNameOptionsHostnameTypeEnum(str, Enum):
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataPrivateDNSNameOptions:
    ...
    hostname_type: Optional[GetLaunchTemplateDataResultLaunchTemplateDataPrivateDNSNameOptionsHostnameTypeEnum] = dataclasses.field(default=None)  
    
class GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsTags:
    r"""Describes a tag."""
...
class GetLaunchTemplateDataResultLaunchTemplateDataTagSpecifications:
    ...
    resource_type: Optional[GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class GetLaunchTemplateDataResultLaunchTemplateData:
    ...
    block_device_mappings: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataBlockDeviceMappings]] = dataclasses.field(default=None)  
    ...
    elastic_gpu_specifications: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataElasticGpuSpecifications]] = dataclasses.field(default=None)  
    elastic_inference_accelerators: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataElasticInferenceAccelerators]] = dataclasses.field(default=None)  
    ...
    instance_initiated_shutdown_behavior: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceInitiatedShutdownBehaviorEnum] = dataclasses.field(default=None)  
    ...
    instance_requirements: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirements] = dataclasses.field(default=None)  
    instance_type: Optional[GetLaunchTemplateDataResultLaunchTemplateDataInstanceTypeEnum] = dataclasses.field(default=None)  
    kernel_id: Optional[str] = dataclasses.field(default=None)  
    key_name: Optional[str] = dataclasses.field(default=None)  
    license_specifications: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataLicenseSpecifications]] = dataclasses.field(default=None)  
    maintenance_options: Optional[GetLaunchTemplateDataResultLaunchTemplateDataMaintenanceOptions] = dataclasses.field(default=None)  
    ...
    network_interfaces: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataNetworkInterfaces]] = dataclasses.field(default=None)  
    placement: Optional[GetLaunchTemplateDataResultLaunchTemplateDataPlacement] = dataclasses.field(default=None)  
    private_dns_name_options: Optional[GetLaunchTemplateDataResultLaunchTemplateDataPrivateDNSNameOptions] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[GetLaunchTemplateDataResultLaunchTemplateDataTagSpecifications]] = dataclasses.field(default=None)  
