...
func (e *DescribeMaintenanceWindowExecutionTaskInvocationsXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.DescribeMaintenanceWindowExecutionTaskInvocations":
		*e = DescribeMaintenanceWindowExecutionTaskInvocationsXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeMaintenanceWindowExecutionTaskInvocationsXAmzTargetEnum: %s", s)
	}
}
