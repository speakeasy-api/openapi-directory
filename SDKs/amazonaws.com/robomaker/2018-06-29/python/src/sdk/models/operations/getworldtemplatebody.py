...
from ..shared import getworldtemplatebodyresponse as shared_getworldtemplatebodyresponse
...
class GetWorldTemplateBodyRequest:
    headers: GetWorldTemplateBodyHeaders = dataclasses.field()
    request: GetWorldTemplateBodyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetWorldTemplateBodyResponse:
    ...
    get_world_template_body_response: Optional[shared_getworldtemplatebodyresponse.GetWorldTemplateBodyResponse] = dataclasses.field(default=None)
