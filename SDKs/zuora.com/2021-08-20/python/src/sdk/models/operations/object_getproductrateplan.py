...
from ..shared import proxygetproductrateplan as shared_proxygetproductrateplan
...
class ObjectGETProductRatePlanResponse:
    ...
    proxy_get_product_rate_plan: Optional[shared_proxygetproductrateplan.ProxyGetProductRatePlan] = dataclasses.field(default=None)  
