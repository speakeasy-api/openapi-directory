...
class AnalyticsManagementWebPropertyAdWordsLinksListRequest:
    ...
    r"""Web property ID to retrieve the Google Ads links for."""  
    ...
    r"""The maximum number of webProperty-Google Ads links to include in this response."""  
    ...
    r"""An index of the first webProperty-Google Ads link to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter."""  
