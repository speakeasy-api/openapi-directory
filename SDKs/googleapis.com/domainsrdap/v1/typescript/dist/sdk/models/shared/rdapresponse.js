...
var RdapResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=jsonResponse" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notices", elemType: notice_1.Notice }),
        __metadata("design:type", Array)
    ], RdapResponse.prototype, "notices", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rdapConformance" }),
        __metadata("design:type", Array)
