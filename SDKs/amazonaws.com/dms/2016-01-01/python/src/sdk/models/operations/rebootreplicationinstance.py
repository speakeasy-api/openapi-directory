...
class RebootReplicationInstanceRequest:
    ...
    reboot_replication_instance_message: shared_rebootreplicationinstancemessage.RebootReplicationInstanceMessage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
