...
from ..shared import gethriscompaniesresponse as shared_gethriscompaniesresponse
...
class CompaniesAllResponse:
    ...
    get_hris_companies_response: Optional[shared_gethriscompaniesresponse.GetHrisCompaniesResponse] = dataclasses.field(default=None)
