...
try {
    ...
    $request->requestBody->name = 'Joseph Orn';
    $request->org = 'facere';
...
try {
    ...
    $request->requestBody->body = 'fuga';
    $request->requestBody->name = 'Miss Hubert Hartmann';
    $request->owner = 'quasi';
    $request->repo = 'atque';
...
try {
    ...
    $request->projectId = 90885;
    $request->username = 'Jairo.Farrell53';
...
try {
    ...
    $request->columnId = 887265;
    $request->page = 886961;
    $request->perPage = 880107;
...
try {
    ...
    $request->owner = 'atque';
    $request->page = 541381;
    $request->perPage = 120919;
    $request->repo = 'recusandae';
    $request->state = ProjectsListForRepoStateEnum::ALL;
...
try {
    ...
    $request->page = 829898;
    $request->perPage = 287119;
    $request->state = ProjectsListForUserStateEnum::ALL;
    $request->username = 'Alphonso3';
...
try {
    ...
    $request->projectId = 316488;
    $request->username = 'Gillian_Franecki30';
