...
class ProtectedBranch:
    ...
    required_conversation_resolution: Optional[ProtectedBranchRequiredConversationResolution] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('required_conversation_resolution') }})
