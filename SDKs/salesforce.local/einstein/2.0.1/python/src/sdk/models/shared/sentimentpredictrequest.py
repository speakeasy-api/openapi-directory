...
class SentimentPredictRequest:
    ...
    document: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('document') }, 'multipart_form': { 'field_name': 'document' }})
    r"""Text for which you want to return a sentiment prediction."""  
    ...
    r"""ID of the model that makes the prediction. The model must have been created from a dataset with a type of text-sentiment."""  
