...
var Step = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=deviceUsageDuration" }),
        __metadata("design:type", duration_1.Duration)
    ], Step.prototype, "deviceUsageDuration", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dimensionValue", elemType: stepdimensionvalueentry_1.StepDimensionValueEntry }),
        __metadata("design:type", Array)
    ], Step.prototype, "dimensionValue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=hasImages" }),
        __metadata("design:type", Boolean)
    ], Step.prototype, "hasImages", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=labels", elemType: steplabelsentry_1.StepLabelsEntry }),
        __metadata("design:type", Array)
    ], Step.prototype, "labels", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=multiStep" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=testExecutionStep" }),
        __metadata("design:type", testexecutionstep_1.TestExecutionStep)
    ], Step.prototype, "testExecutionStep", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=toolExecutionStep" }),
