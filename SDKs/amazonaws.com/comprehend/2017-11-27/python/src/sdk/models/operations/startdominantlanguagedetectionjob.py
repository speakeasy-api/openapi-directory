...
class StartDominantLanguageDetectionJobRequest:
    ...
    start_dominant_language_detection_job_request: shared_startdominantlanguagedetectionjobrequest.StartDominantLanguageDetectionJobRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
