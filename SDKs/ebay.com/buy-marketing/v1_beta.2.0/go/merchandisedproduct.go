...
func (s *merchandisedProduct) GetMerchandisedProducts(ctx context.Context, request operations.GetMerchandisedProductsRequest) (*operations.GetMerchandisedProductsResponse, error) {
	baseURL := s.serverURL
