...
type SecuritycenterProjectsSecurityHealthAnalyticsSettingsCustomModulesDeleteSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type SecuritycenterProjectsSecurityHealthAnalyticsSettingsCustomModulesDeleteRequest struct {
	// V1 error format.
...
type SecuritycenterProjectsSecurityHealthAnalyticsSettingsCustomModulesDeleteResponse struct {
	ContentType string
	// Successful response
