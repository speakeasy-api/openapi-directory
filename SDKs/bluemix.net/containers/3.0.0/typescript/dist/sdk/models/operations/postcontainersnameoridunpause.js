...
exports.PostContainersNameOrIdUnpauseResponse = exports.PostContainersNameOrIdUnpauseRequest = void 0;
...
var PostContainersNameOrIdUnpauseRequest = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdUnpauseRequest.prototype, "xAuthProjectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Auth-Token",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdUnpauseRequest.prototype, "xAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name_or_id",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdUnpauseRequest.prototype, "nameOrId", void 0);
...
var PostContainersNameOrIdUnpauseResponse = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdUnpauseResponse.prototype, "rawResponse", void 0);
