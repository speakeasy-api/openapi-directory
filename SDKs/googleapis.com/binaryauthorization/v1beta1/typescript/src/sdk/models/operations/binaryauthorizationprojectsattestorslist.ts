...
export class BinaryauthorizationProjectsAttestorsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BinaryauthorizationProjectsAttestorsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class BinaryauthorizationProjectsAttestorsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
