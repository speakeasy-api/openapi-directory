 ...
 */
export class CreateStreamingDistributionWithTags20190326RequestBodyStreamingDistributionConfigWithTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateStreamingDistributionWithTags20190326RequestBody extends SpeakeasyBase {
  /**
   * A streaming distribution Configuration and a list of tags to be associated with the streaming distribution.
   */
  @SpeakeasyMetadata()
...
export enum CreateStreamingDistributionWithTags20190326WithTagsEnum {
  True = "true",
}
