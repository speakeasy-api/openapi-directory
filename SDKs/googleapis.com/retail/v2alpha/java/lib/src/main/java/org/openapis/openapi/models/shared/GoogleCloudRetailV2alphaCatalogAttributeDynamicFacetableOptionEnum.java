 ...
 */
public enum GoogleCloudRetailV2alphaCatalogAttributeDynamicFacetableOptionEnum {
    ...
    private GoogleCloudRetailV2alphaCatalogAttributeDynamicFacetableOptionEnum(String value) {
        this.value = value;
    }
}
