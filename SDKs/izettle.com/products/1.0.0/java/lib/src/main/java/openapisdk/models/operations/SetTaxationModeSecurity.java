...
public class SetTaxationModeSecurity {
    ...
    public SetTaxationModeSecurity withZettleApiKey(openapisdk.models.shared.SchemeZettleApiKey zettleApiKey) {
        this.zettleApiKey = zettleApiKey;
        return this;
    }
    @SpeakeasyMetadata("security:scheme=true,type=oauth2")
    public openapisdk.models.shared.SchemeZettleOauth zettleOauth;
    public SetTaxationModeSecurity withZettleOauth(openapisdk.models.shared.SchemeZettleOauth zettleOauth) {
