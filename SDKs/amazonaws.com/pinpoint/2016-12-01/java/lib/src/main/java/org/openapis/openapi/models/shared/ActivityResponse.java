...
public class ActivityResponse {
    ...
    public java.util.Map<String, String> executionMetrics;
    ...
    public ActivityResponse(@JsonProperty("ApplicationId") String applicationId, @JsonProperty("CampaignId") String campaignId, @JsonProperty("Id") String id) {
        this.applicationId = applicationId;
        this.campaignId = campaignId;
        this.id = id;
  }
