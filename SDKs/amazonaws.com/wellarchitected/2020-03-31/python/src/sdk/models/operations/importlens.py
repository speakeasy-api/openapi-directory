...
from ..shared import importlensoutput as shared_importlensoutput
...
class ImportLensRequestBody:
    ...
    json_string: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('JSONString') }})
    r"""The JSON representation of a lens."""  
    ...
    r"""Tags to associate to a lens."""  
    

@dataclasses.dataclass
class ImportLensRequest:
    
    request_body: ImportLensRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class ImportLensResponse:
    ...
    r"""ConflictException"""  
    import_lens_output: Optional[shared_importlensoutput.ImportLensOutput] = dataclasses.field(default=None)
    r"""Success"""  
