...
func (s *codeScanning) CodeScanningGetCodeqlDatabase(ctx context.Context, request operations.CodeScanningGetCodeqlDatabaseRequest) (*operations.CodeScanningGetCodeqlDatabaseResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/code-scanning/codeql/databases/{language}", request.PathParams, nil)
	...
	res := &operations.CodeScanningGetCodeqlDatabaseResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.CodeScanningCodeqlDatabase
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
	...
	case httpRes.StatusCode == 503:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.CodeScanningGetCodeqlDatabase503ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
...
func (s *codeScanning) CodeScanningListCodeqlDatabases(ctx context.Context, request operations.CodeScanningListCodeqlDatabasesRequest) (*operations.CodeScanningListCodeqlDatabasesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/code-scanning/codeql/databases", request.PathParams, nil)
	...
	res := &operations.CodeScanningListCodeqlDatabasesResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 503:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.CodeScanningListCodeqlDatabases503ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
