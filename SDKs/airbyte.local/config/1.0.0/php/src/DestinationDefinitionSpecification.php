...
class DestinationDefinitionSpecification 
{
     ...
     * @return \OpenAPI\OpenAPI\Models\Operations\GetDestinationDefinitionSpecificationResponse
     */
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\GetDestinationDefinitionSpecificationResponse
    {
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\GetDestinationDefinitionSpecificationResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->destinationDefinitionSpecificationRead = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\DestinationDefinitionSpecificationRead', 'json');
            }
        }
