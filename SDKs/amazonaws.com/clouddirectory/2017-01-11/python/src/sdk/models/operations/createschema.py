...
class CreateSchemaRequestBody:
    ...
    r"""The name that is associated with the schema. This is unique to each account and in each region."""  
    

@dataclasses.dataclass
class CreateSchemaRequest:
    
    request_body: CreateSchemaRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
