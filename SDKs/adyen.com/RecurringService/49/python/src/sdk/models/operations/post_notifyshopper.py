...
from ..shared import notifyshopperresult as shared_notifyshopperresult
...
class PostNotifyShopperResponse:
    ...
    notify_shopper_result: Optional[shared_notifyshopperresult.NotifyShopperResult] = dataclasses.field(default=None)
