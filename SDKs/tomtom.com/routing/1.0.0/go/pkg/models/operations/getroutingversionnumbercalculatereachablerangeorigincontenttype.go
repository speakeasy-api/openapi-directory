...
func (e *GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "combustion":
		fallthrough
	case "electric":
		*e = GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum: %s", s)
	}
}
