...
class UpdateCompositionHookUpdateCompositionHookRequest:
    ...
    r"""Whether the composition hook is active. When `true`, the composition hook will be triggered for every completed Group Room in the account. When `false`, the composition hook never triggers."""  
    ...
    * CIF = `320x240`
    ...
    r"""A JSON object that describes the video layout of the composition hook in terms of regions. See [Specifying Video Layouts](https://www.twilio.com/docs/video/api/compositions-resource#specifying-video-layouts) for more info."""  
...
class UpdateCompositionHookRequest:
    ...
    r"""The SID of the CompositionHook resource to update."""  
    request_body: Optional[UpdateCompositionHookUpdateCompositionHookRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
