 ...
 */
public class MssqlDbSnapshotDetail {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("archivalLocationIds")
    public String[] archivalLocationIds;

    public MssqlDbSnapshotDetail withArchivalLocationIds(String[] archivalLocationIds) {
    ...
    public MssqlDbSnapshotDetail withCanLiveMount(Boolean canLiveMount) {
    ...
    public MssqlDbSnapshotDetail withCloudState(Long cloudState) {
    ...
    public MssqlDbSnapshotDetail withCloudStorageTier(SnapshotCloudStorageTierEnum cloudStorageTier) {
    ...
    public MssqlDbSnapshotDetail withConfig(String config) {
        this.config = config;
        return this;
    }
    ...
    public MssqlDbSnapshotDetail withConsistencyLevel(String consistencyLevel) {
    ...
    public MssqlDbSummary database;

    public MssqlDbSnapshotDetail withDatabase(MssqlDbSummary database) {
    ...
    public MssqlDbSnapshotDetail withDate(OffsetDateTime date) {
        this.date = date;
        return this;
    }
    ...
    public MssqlDbSnapshotDetail withExpirationDate(OffsetDateTime expirationDate) {
    ...
    public MssqlDbSnapshotDetail withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public MssqlDbSnapshotDetail withIndexState(Long indexState) {
    ...
    public MssqlDbSnapshotDetail withIsCorrupt(Boolean isCorrupt) {
    ...
    public MssqlDbSnapshotDetail withIsCustomRetentionApplied(Boolean isCustomRetentionApplied) {
    ...
    public MssqlDbSnapshotDetail withIsOnDemandSnapshot(Boolean isOnDemandSnapshot) {
    ...
    public MssqlDbSnapshotDetail withIsPlacedOnLegalHold(Boolean isPlacedOnLegalHold) {
    ...
    public MssqlDbSnapshotDetail withIsRetainedByRetentionLockSla(Boolean isRetainedByRetentionLockSla) {
    ...
    public MssqlDbSnapshotDetail withParentSnapshotId(String parentSnapshotId) {
    ...
    public MssqlDbSnapshotDetail withReplicationLocationIds(String[] replicationLocationIds) {
    ...
    public MssqlDbSnapshotDetail withSlaId(String slaId) {
        this.slaId = slaId;
        return this;
    }
    ...
    public MssqlDbSnapshotDetail withSlaName(String slaName) {
    ...
    public MssqlDbSnapshotDetail withSnapshotRetentionInfo(SnapshotRetentionInfo snapshotRetentionInfo) {
    ...
    public MssqlDbSnapshotDetail withSourceObjectType(String sourceObjectType) {
        this.sourceObjectType = sourceObjectType;
        return this;
    }
    
    public MssqlDbSnapshotDetail(@JsonProperty("canLiveMount") Boolean canLiveMount, @JsonProperty("date") OffsetDateTime date, @JsonProperty("id") String id, @JsonProperty("isCustomRetentionApplied") Boolean isCustomRetentionApplied, @JsonProperty("isOnDemandSnapshot") Boolean isOnDemandSnapshot, @JsonProperty("replicationLocationIds") String[] replicationLocationIds, @JsonProperty("slaId") String slaId, @JsonProperty("slaName") String slaName) {
        this.canLiveMount = canLiveMount;
        this.date = date;
        this.id = id;
        this.isCustomRetentionApplied = isCustomRetentionApplied;
