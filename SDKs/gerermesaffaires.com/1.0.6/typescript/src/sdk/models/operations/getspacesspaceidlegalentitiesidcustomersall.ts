...
export class GetSpacesSpaceIdLegalEntitiesIdCustomersAllRequest extends SpeakeasyBase {
  /**
...
export class GetSpacesSpaceIdLegalEntitiesIdCustomersAllResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
