...
export declare class DatalineageProjectsLocationsProcessesRunsListSecurity extends SpeakeasyBase {
    oauth2: string;
    oauth2c: string;
}
export declare class DatalineageProjectsLocationsProcessesRunsListRequest extends SpeakeasyBase {
    /**
     * V1 error format.
     */
...
export declare class DatalineageProjectsLocationsProcessesRunsListResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Successful response
     */
    googleCloudDatacatalogLineageV1ListRunsResponse?: shared.GoogleCloudDatacatalogLineageV1ListRunsResponse;
    statusCode: number;
