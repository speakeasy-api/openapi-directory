...
public enum GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequestFeaturesEnum {
    ...
    private GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequestFeaturesEnum(String value) {
        this.value = value;
    }
}
