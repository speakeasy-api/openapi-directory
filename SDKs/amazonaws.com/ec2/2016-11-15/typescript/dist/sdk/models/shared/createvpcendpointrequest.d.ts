 ...
 */
export declare enum CreateVpcEndpointRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateVpcEndpointRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateVpcEndpointRequestTagSpecifications extends SpeakeasyBase {
