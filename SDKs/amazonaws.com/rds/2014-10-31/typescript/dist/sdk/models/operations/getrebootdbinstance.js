...
exports.GETRebootDBInstanceResponse = exports.GETRebootDBInstanceRequest = exports.GETRebootDBInstanceVersionEnum = exports.GETRebootDBInstanceActionEnum = void 0;
...
(function (GETRebootDBInstanceVersionEnum) {
    GETRebootDBInstanceVersionEnum["TwoThousandAndFourteen1031"] = "2014-10-31";
...
var GETRebootDBInstanceRequest = /** @class */ (function (_super) {
    ...
    ], GETRebootDBInstanceRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=DBInstanceIdentifier",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "dbInstanceIdentifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ForceFailover",
        }),
        __metadata("design:type", Boolean)
    ], GETRebootDBInstanceRequest.prototype, "forceFailover", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], GETRebootDBInstanceRequest.prototype, "xAmzSignedHeaders", void 0);
...
var GETRebootDBInstanceResponse = /** @class */ (function (_super) {
    ...
    ], GETRebootDBInstanceResponse.prototype, "rawResponse", void 0);
