...
class MerchantsOneRequest:
    headers: MerchantsOneHeaders = dataclasses.field()
    path_params: MerchantsOnePathParams = dataclasses.field()
    query_params: MerchantsOneQueryParams = dataclasses.field()
    security: MerchantsOneSecurity = dataclasses.field()
