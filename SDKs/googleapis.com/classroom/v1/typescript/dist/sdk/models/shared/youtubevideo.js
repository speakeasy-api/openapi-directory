...
var YouTubeVideo = /** @class */ (function (_super) {
    ...
    ], YouTubeVideo.prototype, "alternateLink", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=id" }),
        __metadata("design:type", String)
    ], YouTubeVideo.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=thumbnailUrl" }),
        __metadata("design:type", String)
    ], YouTubeVideo.prototype, "thumbnailUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=title" }),
        __metadata("design:type", String)
    ], YouTubeVideo.prototype, "title", void 0);
    return YouTubeVideo;
