...
class GetActivityTaskOutput:
    ...
    task_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('taskToken'), 'exclude': lambda f: f is None }})  
