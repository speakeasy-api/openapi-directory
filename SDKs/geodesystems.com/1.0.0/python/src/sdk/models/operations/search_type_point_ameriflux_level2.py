...
class SearchTypePointAmerifluxLevel2QueryParams:
    ...
    search_type_point_ameriflux_level2_contact: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_ameriflux_level2.contact', 'style': 'form', 'explode': True }})
    search_type_point_ameriflux_level2_ecosystem_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_ameriflux_level2.ecosystem_type', 'style': 'form', 'explode': True }})
    search_type_point_ameriflux_level2_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_ameriflux_level2.site_id', 'style': 'form', 'explode': True }})
...
@dataclasses.dataclass
class SearchTypePointAmerifluxLevel2Request:
    query_params: SearchTypePointAmerifluxLevel2QueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointAmerifluxLevel2Response:
