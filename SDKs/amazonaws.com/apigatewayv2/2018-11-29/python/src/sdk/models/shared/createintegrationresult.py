...
class CreateIntegrationResultConnectionTypeEnum(str, Enum):
...
class CreateIntegrationResultContentHandlingStrategyEnum(str, Enum):
...
class CreateIntegrationResultIntegrationTypeEnum(str, Enum):
...
class CreateIntegrationResultPassthroughBehaviorEnum(str, Enum):
...
class CreateIntegrationResult:
    ...
    connection_type: Optional[CreateIntegrationResultConnectionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ConnectionType'), 'exclude': lambda f: f is None }})  
    content_handling_strategy: Optional[CreateIntegrationResultContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ContentHandlingStrategy'), 'exclude': lambda f: f is None }})  
    ...
    integration_type: Optional[CreateIntegrationResultIntegrationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IntegrationType'), 'exclude': lambda f: f is None }})  
    ...
    passthrough_behavior: Optional[CreateIntegrationResultPassthroughBehaviorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PassthroughBehavior'), 'exclude': lambda f: f is None }})  
    ...
    tls_config: Optional[CreateIntegrationResultTLSConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TlsConfig'), 'exclude': lambda f: f is None }})  
