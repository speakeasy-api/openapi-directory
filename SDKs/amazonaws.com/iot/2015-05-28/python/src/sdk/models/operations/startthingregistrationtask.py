...
class StartThingRegistrationTaskRequestBody:
    input_file_bucket: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('inputFileBucket') }})
    input_file_key: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('inputFileKey') }})
...
class StartThingRegistrationTaskRequest:
    headers: StartThingRegistrationTaskHeaders = dataclasses.field()
    request: StartThingRegistrationTaskRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
