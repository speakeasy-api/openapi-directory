...
const (
	ListTagsForResourceXAmzTargetEnumAwsKendraRerankingFrontendServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "AWSKendraRerankingFrontendService.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AWSKendraRerankingFrontendService.ListTagsForResource":
