...
class GetDeploymentInstanceRequest:
    ...
    get_deployment_instance_input: shared_getdeploymentinstanceinput.GetDeploymentInstanceInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
