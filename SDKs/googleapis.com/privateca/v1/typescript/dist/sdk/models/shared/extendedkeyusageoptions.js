...
var ExtendedKeyUsageOptions = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "clientAuth" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "emailProtection" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "emailProtection", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ocspSigning" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "ocspSigning", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "serverAuth" }),
        __metadata("design:type", Boolean)
    ], ExtendedKeyUsageOptions.prototype, "serverAuth", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "timeStamping" }),
        __metadata("design:type", Boolean)
