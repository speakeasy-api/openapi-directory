...
class GetAccessPolicyResponse
{
     ...
     * Success
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\GetAccessPolicyResponse $getAccessPolicyResponse
     */
	
    public ?\OpenAPI\OpenAPI\Models\Shared\GetAccessPolicyResponse $getAccessPolicyResponse = null;
	...
	{
		$this->contentType = "";
		$this->getAccessPolicyResponse = null;
