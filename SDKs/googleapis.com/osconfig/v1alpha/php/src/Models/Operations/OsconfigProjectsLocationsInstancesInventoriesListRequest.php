...
class OsconfigProjectsLocationsInstancesInventoriesListRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\OsconfigProjectsLocationsInstancesInventoriesListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?OsconfigProjectsLocationsInstancesInventoriesListViewEnum $view = null;
