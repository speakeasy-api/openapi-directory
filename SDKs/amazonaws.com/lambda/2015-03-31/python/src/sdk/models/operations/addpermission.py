...
class AddPermissionRequestBody:
    ...
    event_source_token: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('EventSourceToken') }})
...
class AddPermissionRequest:
    headers: AddPermissionHeaders = dataclasses.field()
    path_params: AddPermissionPathParams = dataclasses.field()
    query_params: AddPermissionQueryParams = dataclasses.field()
    request: AddPermissionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
