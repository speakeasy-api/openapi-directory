...
export class ItemPriceMarkdown extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "blockPriceIncreaseInItemRevision" })
   ...
   */
  @SpeakeasyMetadata({ elemType: SelectedInventoryDiscount })
  @Expose({ name: "selectedInventoryDiscounts" })
  @Type(() => SelectedInventoryDiscount)
