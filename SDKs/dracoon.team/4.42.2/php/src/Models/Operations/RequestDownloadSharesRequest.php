...
class RequestDownloadSharesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\RequestDownloadSharesXSdsDateFormatEnum $xSdsDateFormat
     */
	#[SpeakeasyMetadata('header:style=simple,explode=false,name=X-Sds-Date-Format')]
    public ?RequestDownloadSharesXSdsDateFormatEnum $xSdsDateFormat = null;
