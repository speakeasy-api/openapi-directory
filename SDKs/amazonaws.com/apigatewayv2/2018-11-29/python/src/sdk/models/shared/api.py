...
class APIProtocolTypeEnum(str, Enum):
    r"""The API protocol."""
    WEBSOCKET = 'WEBSOCKET'
    HTTP = 'HTTP'
...
class API:
    ...
    protocol_type: APIProtocolTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ProtocolType') }})  
    route_selection_expression: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RouteSelectionExpression') }})  
    ...
    cors_configuration: Optional[APICorsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CorsConfiguration'), 'exclude': lambda f: f is None }})  
