...
export class CreateInternationalScheduledPaymentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateInternationalScheduledPaymentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateInternationalScheduledPaymentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
