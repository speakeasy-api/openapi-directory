...
class WebmastersSitesDeleteRequest:
    path_params: WebmastersSitesDeletePathParams = dataclasses.field()
    query_params: WebmastersSitesDeleteQueryParams = dataclasses.field()
    security: WebmastersSitesDeleteSecurity = dataclasses.field()
