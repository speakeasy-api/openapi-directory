...
func (e ListAttributesXAmzTargetEnum) ToPointer() *ListAttributesXAmzTargetEnum {
	return &e
}
...
func (e *ListAttributesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonEC2ContainerServiceV20141113.ListAttributes":
		*e = ListAttributesXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListAttributesXAmzTargetEnum: %v", v)
	}
}
