...
public class UsersListSecurity {
    ...
    public UsersListSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public UsersListSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public UsersListSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
