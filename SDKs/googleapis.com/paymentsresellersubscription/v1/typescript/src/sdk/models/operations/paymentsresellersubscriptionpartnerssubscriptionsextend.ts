...
export class PaymentsresellersubscriptionPartnersSubscriptionsExtendRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PaymentsresellersubscriptionPartnersSubscriptionsExtendResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
