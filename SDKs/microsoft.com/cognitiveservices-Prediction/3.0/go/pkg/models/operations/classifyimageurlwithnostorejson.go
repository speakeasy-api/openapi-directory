...
type ClassifyImageURLWithNoStoreJSONPathParams struct {
	// The project id.
...
type ClassifyImageURLWithNoStoreJSONQueryParams struct {
	// Optional. Specifies the name of application using the endpoint.
	Application *string `queryParam:"style=form,explode=true,name=application"`
}

type ClassifyImageURLWithNoStoreJSONRequest struct {
	PathParams  ClassifyImageURLWithNoStoreJSONPathParams
	QueryParams ClassifyImageURLWithNoStoreJSONQueryParams
...
type ClassifyImageURLWithNoStoreJSONResponse struct {
	Body        []byte
	ContentType string
	// Error response
