...
public class FindUserByUsernameQueryParams {
    ...
    public FindUserByUsernameQueryParams withExpansions(openapisdk.models.shared.UserExpansionsParameterEnum[] expansions) {
    ...
    public FindUserByUsernameQueryParams withMediaFields(openapisdk.models.shared.MediaFieldsParameterEnum[] mediaFields) {
    ...
    public FindUserByUsernameQueryParams withPlaceFields(openapisdk.models.shared.PlaceFieldsParameterEnum[] placeFields) {
    ...
    public FindUserByUsernameQueryParams withPollFields(openapisdk.models.shared.PollFieldsParameterEnum[] pollFields) {
    ...
    public FindUserByUsernameQueryParams withTweetFields(openapisdk.models.shared.TweetFieldsParameterEnum[] tweetFields) {
    ...
    public FindUserByUsernameQueryParams withUserFields(openapisdk.models.shared.UserFieldsParameterEnum[] userFields) {
