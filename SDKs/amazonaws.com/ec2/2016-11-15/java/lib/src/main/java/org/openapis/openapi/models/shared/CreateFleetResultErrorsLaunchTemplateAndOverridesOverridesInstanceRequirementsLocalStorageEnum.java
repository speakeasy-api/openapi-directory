 ...
 */
public enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsLocalStorageEnum(String value) {
        this.value = value;
    }
}
