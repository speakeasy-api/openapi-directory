...
type GetAs2IncomingMessagesQueryParams struct {
...
type GetAs2IncomingMessagesRequest struct {
	QueryParams GetAs2IncomingMessagesQueryParams
}

type GetAs2IncomingMessagesResponse struct {
