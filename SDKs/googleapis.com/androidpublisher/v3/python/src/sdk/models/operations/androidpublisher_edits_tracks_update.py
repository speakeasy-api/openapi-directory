...
class AndroidpublisherEditsTracksUpdateRequest:
    path_params: AndroidpublisherEditsTracksUpdatePathParams = dataclasses.field()
    query_params: AndroidpublisherEditsTracksUpdateQueryParams = dataclasses.field()
    security: AndroidpublisherEditsTracksUpdateSecurity = dataclasses.field()
