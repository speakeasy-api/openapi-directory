...
exports.CommitteeHistory = void 0;
...
var CommitteeHistory = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=convert_to_pac_flag" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cycles_has_activity" }),
        __metadata("design:type", Array)
    ], CommitteeHistory.prototype, "cyclesHasActivity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cycles_has_financial" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=former_candidate_election_year" }),
        __metadata("design:type", Number)
    ], CommitteeHistory.prototype, "formerCandidateElectionYear", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=former_candidate_id" }),
        __metadata("design:type", String)
    ], CommitteeHistory.prototype, "formerCandidateId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=former_candidate_name" }),
        __metadata("design:type", String)
    ], CommitteeHistory.prototype, "formerCandidateName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=former_committee_name" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_cycle_has_activity" }),
        __metadata("design:type", Number)
    ], CommitteeHistory.prototype, "lastCycleHasActivity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_cycle_has_financial" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sponsor_candidate_ids" }),
        __metadata("design:type", Array)
...
exports.CommitteeHistory = CommitteeHistory;
