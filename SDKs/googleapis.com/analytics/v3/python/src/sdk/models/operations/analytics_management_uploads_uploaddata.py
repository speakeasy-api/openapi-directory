...
class AnalyticsManagementUploadsUploadDataRequest:
    path_params: AnalyticsManagementUploadsUploadDataPathParams = dataclasses.field()
    query_params: AnalyticsManagementUploadsUploadDataQueryParams = dataclasses.field()
    security: AnalyticsManagementUploadsUploadDataSecurity = dataclasses.field()
