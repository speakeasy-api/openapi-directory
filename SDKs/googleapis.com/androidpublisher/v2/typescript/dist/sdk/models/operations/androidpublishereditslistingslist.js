...
exports.AndroidpublisherEditsListingsListResponse = exports.AndroidpublisherEditsListingsListRequest = exports.AndroidpublisherEditsListingsListSecurity = void 0;
...
var AndroidpublisherEditsListingsListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=editId",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "editId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=packageName",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "packageName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AndroidpublisherEditsListingsListRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AndroidpublisherEditsListingsListRequest.prototype, "userIp", void 0);
...
var AndroidpublisherEditsListingsListResponse = /** @class */ (function (_super) {
    ...
    ], AndroidpublisherEditsListingsListResponse.prototype, "rawResponse", void 0);
