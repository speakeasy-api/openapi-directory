 ...
 */
export declare const ServerList: readonly ["https://nla.zapier.com"];
/**
...
export declare class SDK {
     ...
     */
    check(config?: AxiosRequestConfig): Promise<operations.CheckResponse>;
    /**
     ...
     */
    executeAppActionEndpoint(req: operations.ExecuteAppActionEndpointRequest, security: operations.ExecuteAppActionEndpointSecurity, config?: AxiosRequestConfig): Promise<operations.ExecuteAppActionEndpointResponse>;
    /**
     ...
     */
    getConfigurationLink(config?: AxiosRequestConfig): Promise<operations.GetConfigurationLinkResponse>;
    /**
     ...
     */
    listExposedActions(config?: AxiosRequestConfig): Promise<operations.ListExposedActionsResponse>;
}
