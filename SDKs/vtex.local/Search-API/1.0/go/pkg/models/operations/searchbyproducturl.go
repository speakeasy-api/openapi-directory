...
var SearchbyproducturlServerList = []string{
	"http://example.com/.{environment}.com.br",
}

type SearchbyproducturlPathParams struct {
	// Product URL
	ProductTextLink string `pathParam:"style=simple,explode=false,name=product-text-link"`
}

type SearchbyproducturlHeaders struct {
...
type SearchbyproducturlRequest struct {
	PathParams SearchbyproducturlPathParams
	Headers    SearchbyproducturlHeaders
	ServerURL  *string
}

type Searchbyproducturl200ApplicationJSONItemsImages struct {
	// Image ID.
...
type Searchbyproducturl200ApplicationJSONItemsKitItems struct {
...
type Searchbyproducturl200ApplicationJSONItemsReferenceID struct {
	// Reference Code.
	Key string `json:"Key"`
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples struct {
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0 struct {
	// Delivery SLA per types.
	DeliverySLAPerTypes []interface{} `json:"DeliverySlaPerTypes"`
	// Region.
	Region string `json:"Region"`
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion struct {
	// Delivery SLA ID.
	Zero *Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion0 `json:"0,omitempty"`
}

type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferInstallments struct {
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments struct {
	// Count.
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments struct {
	// Count.
	Count int64 `json:"count"`
	// Has interest rate.
	HasInterestRate bool `json:"hasInterestRate"`
	...
	SellerMerchantInstallments []Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallmentsSellerMerchantInstallments `json:"sellerMerchantInstallments"`
	// Total.
	Total int64 `json:"total"`
	// Value.
	Value int64 `json:"value"`
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions struct {
	// Bin.
	Bin string `json:"bin"`
	// Installments.
	Installments []Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptionsInstallments `json:"installments"`
	// Payment group name.
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems struct {
	// Available payments.
...
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptions struct {
	// Available accounts.
	...
	// installment options.
	InstallmentOptions []Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsInstallmentOptions `json:"installmentOptions"`
	// Payment systems.
	PaymentSystems []Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptionsPaymentSystems `json:"paymentSystems"`
	// Payments.
	Payments []interface{} `json:"payments"`
}

// Searchbyproducturl200ApplicationJSONItemsSellersCommertialOffer - AKA Commertial Condition.
type Searchbyproducturl200ApplicationJSONItemsSellersCommertialOffer struct {
	...
	DeliverySLASamples []Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamples `json:"DeliverySlaSamples"`
	// Delivery SLA samples per region.
	DeliverySLASamplesPerRegion Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferDeliverySLASamplesPerRegion `json:"DeliverySlaSamplesPerRegion"`
	// Discount hightlight.
	...
	Installments []Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferInstallments `json:"Installments"`
	...
	// Payment options.
	PaymentOptions Searchbyproducturl200ApplicationJSONItemsSellersCommertialOfferPaymentOptions `json:"PaymentOptions"`
...
type Searchbyproducturl200ApplicationJSONItemsSellers struct {
	// URL to add the product to the cart.
	AddToCartLink string `json:"addToCartLink"`
	// AKA Commertial Condition.
	CommertialOffer Searchbyproducturl200ApplicationJSONItemsSellersCommertialOffer `json:"commertialOffer"`
...
type Searchbyproducturl200ApplicationJSONItems struct {
	// Videos.
	...
	Images []Searchbyproducturl200ApplicationJSONItemsImages `json:"images"`
	// If the SKU is part of a kit.
	IsKit bool `json:"isKit"`
	// SKU ID.
	ItemID string `json:"itemId"`
	// Array with information of SKUs components from a Kit.
	KitItems []Searchbyproducturl200ApplicationJSONItemsKitItems `json:"kitItems"`
	...
	// Reference code ID.
	ReferenceID []Searchbyproducturl200ApplicationJSONItemsReferenceID `json:"referenceId"`
	// Array of SKU sellers.
	Sellers []Searchbyproducturl200ApplicationJSONItemsSellers `json:"sellers"`
...
type Searchbyproducturl200ApplicationJSON struct {
	...
	Items []Searchbyproducturl200ApplicationJSONItems `json:"items"`
	// Product URL.
...
type SearchbyproducturlResponse struct {
	ContentType                                 string
