...
var Achievements = /** @class */ (function () {
    ...
    **/
    Achievements.prototype.gamesManagementAchievementsReset = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesManagementAchievementsResetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/games/v1management/achievements/{achievementId}/reset", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.achievementResetResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Achievements.prototype.gamesManagementAchievementsResetAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesManagementAchievementsResetAllRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/games/v1management/achievements/reset";
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "post" }, requestConfig));
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.achievementResetAllResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Achievements.prototype.gamesManagementAchievementsResetAllForAllPlayers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesManagementAchievementsResetAllForAllPlayersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/games/v1management/achievements/resetAllForAllPlayers";
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "post" }, requestConfig));
    ...
    **/
    Achievements.prototype.gamesManagementAchievementsResetForAllPlayers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesManagementAchievementsResetForAllPlayersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/games/v1management/achievements/{achievementId}/resetForAllPlayers", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "post" }, requestConfig));
    ...
    **/
    Achievements.prototype.gamesManagementAchievementsResetMultipleForAllPlayers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesManagementAchievementsResetMultipleForAllPlayersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/games/v1management/achievements/resetMultipleForAllPlayers";
