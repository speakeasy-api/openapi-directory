...
from ..shared import projectcategorylistvo as shared_projectcategorylistvo
...
class GetProjectCategoryListResponse:
    ...
    project_category_list_vo: Optional[shared_projectcategorylistvo.ProjectCategoryListVO] = dataclasses.field(default=None)
