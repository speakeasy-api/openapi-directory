...
class MovedColumnInProjectIssueEvent:
    r"""Moved Column in Project Issue Event"""
    ...
    url: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('url') }})  
    project_card: Optional[MovedColumnInProjectIssueEventProjectCard] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('project_card'), 'exclude': lambda f: f is None }})  
