...
exports.ListSyncStreamResponse = exports.ListSyncStreamListSyncStreamResponse = exports.ListSyncStreamListSyncStreamResponseMeta = exports.ListSyncStreamRequest = exports.ListSyncStreamSecurity = exports.ListSyncStreamServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSyncStreamServerList = ["https://sync.twilio.com"];
var ListSyncStreamSecurity = /** @class */ (function (_super) {
    ...
    ], ListSyncStreamSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSyncStreamSecurity.prototype, "username", void 0);
...
var ListSyncStreamRequest = /** @class */ (function (_super) {
    ...
    ], ListSyncStreamRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSyncStreamRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSyncStreamRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListSyncStreamRequest.prototype, "serviceSid", void 0);
...
var ListSyncStreamListSyncStreamResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListSyncStreamListSyncStreamResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SyncV1ServiceSyncStream }),
        (0, class_transformer_1.Expose)({ name: "streams" }),
        (0, class_transformer_1.Type)(function () { return shared.SyncV1ServiceSyncStream; }),
...
var ListSyncStreamResponse = /** @class */ (function (_super) {
    ...
    ], ListSyncStreamResponse.prototype, "rawResponse", void 0);
