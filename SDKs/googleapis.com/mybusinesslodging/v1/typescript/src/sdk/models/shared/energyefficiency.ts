...
export class EnergyEfficiencyInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "carbonFreeEnergySources" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "carbonFreeEnergySourcesException" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energyConservationProgram" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energyConservationProgramException" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energyEfficientHeatingAndCoolingSystems" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energyEfficientHeatingAndCoolingSystemsException" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energyEfficientLighting" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energyEfficientLightingException" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energySavingThermostats" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "energySavingThermostatsException" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "independentOrganizationAuditsEnergyUse" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "independentOrganizationAuditsEnergyUseException" })
...
export class EnergyEfficiency extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "greenBuildingDesign" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "greenBuildingDesignException" })
