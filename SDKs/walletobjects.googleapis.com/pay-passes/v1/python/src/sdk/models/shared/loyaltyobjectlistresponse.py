...
class LoyaltyObjectListResponse:
    ...
    resources: Optional[list[shared_loyaltyobject.LoyaltyObject]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resources') }})
