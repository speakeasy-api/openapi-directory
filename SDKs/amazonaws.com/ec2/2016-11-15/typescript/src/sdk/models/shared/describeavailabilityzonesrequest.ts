 ...
 */
export class DescribeAvailabilityZonesRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeAvailabilityZonesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: DescribeAvailabilityZonesRequestFilters })
  filters?: DescribeAvailabilityZonesRequestFilters[];
