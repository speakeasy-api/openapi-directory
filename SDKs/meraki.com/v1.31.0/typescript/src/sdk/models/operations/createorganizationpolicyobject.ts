...
export class CreateOrganizationPolicyObjectRequestBody extends SpeakeasyBase {
  /**
...
export class CreateOrganizationPolicyObjectRequest extends SpeakeasyBase {
...
export class CreateOrganizationPolicyObjectResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
