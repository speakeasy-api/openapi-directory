...
class AppsUpdateRequestBody:
    r"""The partial data for the app"""
    ...
    icon_asset_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('icon_asset_id'), 'exclude': lambda f: f is None }})
    r"""The uuid for the icon's asset id from ACFUS"""  
...
class AppsUpdateRequest:
    ...
    request_body: Optional[AppsUpdateRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    r"""The partial data for the app"""  
    
class AppsUpdateDefaultApplicationJSONErrorCodeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsUpdateDefaultApplicationJSONError:
    
    code: AppsUpdateDefaultApplicationJSONErrorCodeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})  
...
class AppsUpdateDefaultApplicationJSON:
    ...
    error: AppsUpdateDefaultApplicationJSONError = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('error') }})  
...
class AppsUpdate200ApplicationJSONMemberPermissionsEnum(str, Enum):
    MANAGER = 'manager'
    DEVELOPER = 'developer'
    VIEWER = 'viewer'
    TESTER = 'tester'

class AppsUpdate200ApplicationJSONOriginEnum(str, Enum):
    r"""The creation origin of this app"""
    APPCENTER = 'appcenter'
    HOCKEYAPP = 'hockeyapp'
    CODEPUSH = 'codepush'

class AppsUpdate200ApplicationJSONOsEnum(str, Enum):
...
class AppsUpdate200ApplicationJSONOwnerTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsUpdate200ApplicationJSONOwner:
    ...
    type: AppsUpdate200ApplicationJSONOwnerTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""The owner type. Can either be 'org' or 'user'"""  
...
class AppsUpdate200ApplicationJSONPlatformEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class AppsUpdate200ApplicationJSON:
    r"""Success"""
    ...
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""The name of the app used in URLs"""  
    origin: AppsUpdate200ApplicationJSONOriginEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('origin') }})
    r"""The creation origin of this app"""  
    os: AppsUpdate200ApplicationJSONOsEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('os') }})
    r"""The OS the app will be running on"""  
    owner: AppsUpdate200ApplicationJSONOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The information about the app's owner"""  
    platform: AppsUpdate200ApplicationJSONPlatformEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('platform') }})
    r"""The platform of the app"""  
    azure_subscription: Optional[AppsUpdate200ApplicationJSONAzureSubscription] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('azure_subscription'), 'exclude': lambda f: f is None }})  
    ...
    icon_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('icon_url'), 'exclude': lambda f: f is None }})
    r"""The string representation of the URL pointing to the app's icon"""  
    member_permissions: Optional[list[AppsUpdate200ApplicationJSONMemberPermissionsEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('member_permissions'), 'exclude': lambda f: f is None }})
...
class AppsUpdateResponse:
    ...
    apps_update_200_application_json_object: Optional[AppsUpdate200ApplicationJSON] = dataclasses.field(default=None)
    r"""Success"""  
    apps_update_default_application_json_object: Optional[AppsUpdateDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""BadRequest"""  
