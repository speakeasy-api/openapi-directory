...
class UpdatePipelineRequestBody:
    pipeline_activities: list[shared_pipelineactivity.PipelineActivity] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('pipelineActivities') }})
