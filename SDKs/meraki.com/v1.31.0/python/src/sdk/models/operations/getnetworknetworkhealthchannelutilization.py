...
class GetNetworkNetworkHealthChannelUtilizationRequest:
    ...
    r"""The number of entries per page returned. Acceptable range is 3 - 100. Default is 10."""  
    ...
    r"""The time resolution in seconds for returned data. The valid resolutions are: 600. The default is 600."""  
...
class GetNetworkNetworkHealthChannelUtilizationResponse:
    ...
    get_network_network_health_channel_utilization_200_application_json_objects: Optional[list[dict[str, Any]]] = dataclasses.field(default=None)
