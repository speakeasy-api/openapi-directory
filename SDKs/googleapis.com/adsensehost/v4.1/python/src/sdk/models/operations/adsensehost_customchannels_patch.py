...
class AdsensehostCustomchannelsPatchRequest:
    ...
    r"""Ad client in which the custom channel will be updated."""  
    custom_channel_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'customChannelId', 'style': 'form', 'explode': True }})
    r"""Custom channel to get."""  
    alt: Optional[shared_alt_enum.AltEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    r"""Data format for the response."""  
    custom_channel: Optional[shared_customchannel.CustomChannel] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
