...
var IETotalsByCandidatePage = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: ietotalsbycandidate_1.IETotalsByCandidate }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return ietotalsbycandidate_1.IETotalsByCandidate; }),
