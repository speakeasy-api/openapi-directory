...
class DependabotListSelectedReposForOrgSecretResponse:
    ...
    dependabot_list_selected_repos_for_org_secret_200_application_json_object: Optional[DependabotListSelectedReposForOrgSecret200ApplicationJSON] = dataclasses.field(default=None)
    r"""Response"""  
