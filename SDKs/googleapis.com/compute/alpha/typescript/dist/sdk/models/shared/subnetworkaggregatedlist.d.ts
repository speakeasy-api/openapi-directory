...
import { SubnetworksScopedList } from "./subnetworksscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum SubnetworkAggregatedListWarningCodeEnum {
...
export declare class SubnetworkAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class SubnetworkAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: SubnetworkAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: SubnetworkAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class SubnetworkAggregatedList extends SpeakeasyBase {
    /**
