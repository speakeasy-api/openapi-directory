...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum {
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
