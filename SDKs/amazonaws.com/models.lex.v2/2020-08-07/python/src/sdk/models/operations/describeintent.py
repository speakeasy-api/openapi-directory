...
from ..shared import describeintentresponse as shared_describeintentresponse


@dataclasses.dataclass
class DescribeIntentPathParams:
...
class DescribeIntentRequest:
    headers: DescribeIntentHeaders = dataclasses.field()
    path_params: DescribeIntentPathParams = dataclasses.field()
...
class DescribeIntentResponse:
    ...
    describe_intent_response: Optional[shared_describeintentresponse.DescribeIntentResponse] = dataclasses.field(default=None)
