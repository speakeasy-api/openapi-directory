...
class GmailpostmastertoolsDomainsTrafficStatsListRequest:
    path_params: GmailpostmastertoolsDomainsTrafficStatsListPathParams = dataclasses.field()
    query_params: GmailpostmastertoolsDomainsTrafficStatsListQueryParams = dataclasses.field()
    security: GmailpostmastertoolsDomainsTrafficStatsListSecurity = dataclasses.field()
