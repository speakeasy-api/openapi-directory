...
export const ListUsageRecordServerList = ["https://api.twilio.com"] as const;
...
export class ListUsageRecordListUsageRecordResponse extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: shared.ApiV2010AccountUsageUsageRecord })
  @Expose({ name: "usage_records" })
  @Type(() => shared.ApiV2010AccountUsageUsageRecord)
