...
func (e *GetFirewallsIDActionsActionIDActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = GetFirewallsIDActionsActionIDActionResponseActionStatusEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GetFirewallsIDActionsActionIDActionResponseActionStatusEnum: %s", s)
	}
}
