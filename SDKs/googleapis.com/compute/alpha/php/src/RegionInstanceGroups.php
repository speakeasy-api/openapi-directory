...
class RegionInstanceGroups 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsResponse
     */
	public function computeRegionInstanceGroupsTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/regions/{region}/instanceGroups/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeRegionInstanceGroupsTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
