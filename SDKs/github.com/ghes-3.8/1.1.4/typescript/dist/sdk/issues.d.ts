...
export declare class Issues {
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#add-assignees-to-an-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#add-labels-to-an-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#check-if-a-user-can-be-assigned} - API method documentation
     */
     ...
     * Otherwise a `404` status code is returned.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-an-issue} - API method documentation
     */
     ...
     * This endpoint triggers [notifications](https://docs.github.com/enterprise-server@3.8/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. See "[Secondary rate limits](https://docs.github.com/enterprise-server@3.8/rest/overview/resources-in-the-rest-api#secondary-rate-limits)" and "[Dealing with secondary rate limits](https://docs.github.com/enterprise-server@3.8/rest/guides/best-practices-for-integrators#dealing-with-secondary-rate-limits)" for details.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-an-issue-comment} - API method documentation
     */
     ...
     * Create a label
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-a-label} - API method documentation
     */
     ...
     * Create a milestone
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#create-a-milestone} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#delete-an-issue-comment} - API method documentation
     */
     ...
     * Delete a label
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#delete-a-label} - API method documentation
     */
     ...
     * Delete a milestone
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#delete-a-milestone} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-an-issue} - API method documentation
     */
    issuesGet(req: operations.IssuesGetRequest, config?: AxiosRequestConfig): Promise<operations.IssuesGetResponse>;
    /**
     * Get an issue comment
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-an-issue-comment} - API method documentation
     */
     ...
     * Get an issue event
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-an-issue-event} - API method documentation
     */
    issuesGetEvent(req: operations.IssuesGetEventRequest, config?: AxiosRequestConfig): Promise<operations.IssuesGetEventResponse>;
    /**
     * Get a label
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-a-label} - API method documentation
     */
    issuesGetLabel(req: operations.IssuesGetLabelRequest, config?: AxiosRequestConfig): Promise<operations.IssuesGetLabelResponse>;
    /**
     * Get a milestone
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#get-a-milestone} - API method documentation
     */
     ...
     * request id, use the "[List pull requests](https://docs.github.com/enterprise-server@3.8/rest/reference/pulls#list-pull-requests)" endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issues-assigned-to-the-authenticated-user} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-assignees} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-comments} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-comments-for-a-repository} - API method documentation
     */
     ...
     * List issue events
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-events} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-issue-events-for-a-repository} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-timeline-events-for-an-issue} - API method documentation
     */
     ...
     * request id, use the "[List pull requests](https://docs.github.com/enterprise-server@3.8/rest/reference/pulls#list-pull-requests)" endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-user-account-issues-assigned-to-the-authenticated-user} - API method documentation
     */
     ...
     * request id, use the "[List pull requests](https://docs.github.com/enterprise-server@3.8/rest/reference/pulls#list-pull-requests)" endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-organization-issues-assigned-to-the-authenticated-user} - API method documentation
     */
     ...
     * request id, use the "[List pull requests](https://docs.github.com/enterprise-server@3.8/rest/reference/pulls#list-pull-requests)" endpoint.
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-repository-issues} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-labels-for-issues-in-a-milestone} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-labels-for-a-repository} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-labels-for-an-issue} - API method documentation
     */
     ...
     * List milestones
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#list-milestones} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#lock-an-issue} - API method documentation
     */
    issuesLock(req: operations.IssuesLockRequest, config?: AxiosRequestConfig): Promise<operations.IssuesLockResponse>;
    /**
     * Remove all labels from an issue
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#remove-all-labels-from-an-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#remove-assignees-from-an-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#remove-a-label-from-an-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#set-labels-for-an-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#unlock-an-issue} - API method documentation
     */
     ...
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-an-issue} - API method documentation
     */
    issuesUpdate(req: operations.IssuesUpdateRequest, config?: AxiosRequestConfig): Promise<operations.IssuesUpdateResponse>;
    /**
     * Update an issue comment
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-an-issue-comment} - API method documentation
     */
     ...
     * Update a label
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-a-label} - API method documentation
     */
     ...
     * Update a milestone
     *
     * @see {@link https://docs.github.com/enterprise-server@3.8/rest/reference/issues#update-a-milestone} - API method documentation
     */
