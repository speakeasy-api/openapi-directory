...
public class GetSpotById200ApplicationJSON2 {
    /**
    ...
    public GetSpotById200ApplicationJSON2AntennaReportLocations[] antennaReportLocations;

    public GetSpotById200ApplicationJSON2 withAntennaReportLocations(GetSpotById200ApplicationJSON2AntennaReportLocations[] antennaReportLocations) {
    ...
    public GetSpotById200ApplicationJSON2 withConfig(java.util.Map<String, Object> config) {
        this.config = config;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON2 withConfigRequest(java.util.Map<String, Object> configRequest) {
    ...
    public GetSpotById200ApplicationJSON2 withGeoCoords(org.openapis.openapi.models.shared.GeoCoords geoCoords) {
    ...
    public GetSpotById200ApplicationJSON2 withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON2 withIsOnline(Boolean isOnline) {
    ...
    public GetSpotById200ApplicationJSON2 withReportLocationId(String reportLocationId) {
    ...
    public GetSpotById200ApplicationJSON2 withRequestCounter(Long requestCounter) {
    ...
    public GetSpotById200ApplicationJSON2 withSenses(java.util.Map<String, Object> senses) {
        this.senses = senses;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON2 withSensesRequest(java.util.Map<String, Object> sensesRequest) {
    ...
    public GetSpotById200ApplicationJSON2 withSerialNumber(Long serialNumber) {
    ...
    public GetSpotById200ApplicationJSON2 withStatus(Object status) {
        this.status = status;
        return this;
    }
    ...
    public GetSpotById200ApplicationJSON2 withTimeCreated(String timeCreated) {
    ...
    public GetSpotById200ApplicationJSON2 withTimeUpdated(String timeUpdated) {
    ...
    public GetSpotById200ApplicationJSON2 withUrl(String url) {
        this.url = url;
        return this;
    }
    
    public GetSpotById200ApplicationJSON2(){}
}
