 ...
 */
export declare class DescribeNetworkInterfacePermissionsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
/**
 ...
 */
export declare class DescribeNetworkInterfacePermissionsRequest extends SpeakeasyBase {
    filters?: DescribeNetworkInterfacePermissionsRequestFilters[];
    maxResults?: number;
