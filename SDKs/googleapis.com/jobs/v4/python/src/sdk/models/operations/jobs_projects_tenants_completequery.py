...
class JobsProjectsTenantsCompleteQueryScopeEnum(str, Enum):
    r"""The scope of the completion. The defaults is CompletionScope.PUBLIC."""
    COMPLETION_SCOPE_UNSPECIFIED = 'COMPLETION_SCOPE_UNSPECIFIED'
    TENANT = 'TENANT'
    PUBLIC = 'PUBLIC'

class JobsProjectsTenantsCompleteQueryTypeEnum(str, Enum):
    r"""The completion topic. The default is CompletionType.COMBINED."""
...
class JobsProjectsTenantsCompleteQueryRequest:
    ...
    r"""Required. Resource name of tenant the completion is performed within. The format is \\"projects/{project_id}/tenants/{tenant_id}\\", for example, \\"projects/foo/tenants/bar\\"."""  
    ...
    r"""If provided, restricts completion to specified company. The format is \\"projects/{project_id}/tenants/{tenant_id}/companies/{company_id}\\", for example, \\"projects/foo/tenants/bar/companies/baz\\"."""  
    ...
    r"""The list of languages of the query. This is the BCP-47 language code, such as \\"en-US\\" or \\"sr-Latn\\". For more information, see [Tags for Identifying Languages](https://tools.ietf.org/html/bcp47). The maximum number of allowed characters is 255."""  
