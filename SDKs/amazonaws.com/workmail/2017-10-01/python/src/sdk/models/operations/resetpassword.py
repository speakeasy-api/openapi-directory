...
class ResetPasswordXAmzTargetEnum(str, Enum):
    WORK_MAIL_SERVICE_RESET_PASSWORD = "WorkMailService.ResetPassword"


@dataclasses.dataclass
class ResetPasswordHeaders:
    x_amz_target: ResetPasswordXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ResetPasswordRequest:
    headers: ResetPasswordHeaders = dataclasses.field()
...
class ResetPasswordResponse:
    ...
    reset_password_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
