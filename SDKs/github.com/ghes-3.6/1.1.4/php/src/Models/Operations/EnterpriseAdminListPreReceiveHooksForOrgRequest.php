...
class EnterpriseAdminListPreReceiveHooksForOrgRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\EnterpriseAdminListPreReceiveHooksForOrgSortEnum $sort
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=sort')]
    public ?EnterpriseAdminListPreReceiveHooksForOrgSortEnum $sort = null;
