...
export declare class FirebasestorageProjectsBucketsRemoveFirebasePathParams extends SpeakeasyBase {
    bucket: string;
}
export declare class FirebasestorageProjectsBucketsRemoveFirebaseQueryParams extends SpeakeasyBase {
