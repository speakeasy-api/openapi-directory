...
class GetSendDiagnosticInterruptQueryParams:
    action: GetSendDiagnosticInterruptActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    instance_id: str = dataclasses.field(metadata={'query_param': { 'field_name': 'InstanceId', 'style': 'form', 'explode': True }})
    version: GetSendDiagnosticInterruptVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetSendDiagnosticInterruptRequest:
    headers: GetSendDiagnosticInterruptHeaders = dataclasses.field()
    query_params: GetSendDiagnosticInterruptQueryParams = dataclasses.field()
