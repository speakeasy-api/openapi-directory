...
export enum WritableDeviceInterfaceConnectionStatusEnum {
  False = "false",
  True = "true",
}

export enum WritableDeviceInterfaceModeEnum {
  Access = "access",
  Tagged = "tagged",
  TaggedAll = "tagged-all",
}

export enum WritableDeviceInterfaceTypeEnum {
  Virtual = "virtual",
  Lag = "lag",
...
export class WritableDeviceInterfaceInput extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "cable" })
