...
class AppointmentsDeletePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class AppointmentsDeleteQueryParams:
...
@dataclasses.dataclass
class AppointmentsDeleteRequest:
    path_params: AppointmentsDeletePathParams = dataclasses.field()
    query_params: AppointmentsDeleteQueryParams = dataclasses.field()
    security: AppointmentsDeleteSecurity = dataclasses.field()
