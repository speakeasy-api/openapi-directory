...
class UpdatePackageTypeRequest:
    ...
    r"""Package ID"""  
    update_package_type_request_body: shared_update_package_type_request_body.UpdatePackageTypeRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
