...
from ..shared import security as shared_security
from ..shared import listrevisionsresponse as shared_listrevisionsresponse


@dataclasses.dataclass
class RunProjectsLocationsRevisionsListPathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class RunProjectsLocationsRevisionsListQueryParams:
...
@dataclasses.dataclass
class RunProjectsLocationsRevisionsListSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class RunProjectsLocationsRevisionsListRequest:
    path_params: RunProjectsLocationsRevisionsListPathParams = dataclasses.field()
    query_params: RunProjectsLocationsRevisionsListQueryParams = dataclasses.field()
    security: RunProjectsLocationsRevisionsListSecurity = dataclasses.field()
    

@dataclasses.dataclass
class RunProjectsLocationsRevisionsListResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    list_revisions_response: Optional[shared_listrevisionsresponse.ListRevisionsResponse] = dataclasses.field(default=None)
