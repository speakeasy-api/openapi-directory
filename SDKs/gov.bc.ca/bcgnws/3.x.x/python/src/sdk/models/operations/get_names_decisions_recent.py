...
class GetNamesDecisionsRecentEmbedEnum(str, Enum):
...
class GetNamesDecisionsRecentOutputSrsEnum(str, Enum):
...
class GetNamesDecisionsRecentRequest:
    ...
    r"""The number of days used to define the time window of naming decisions to search.  The number is interpreted as searching for 'names affected by decisions within the last X days'."""  
    ...
    r"""The format of the output."""  
    embed: Optional[GetNamesDecisionsRecentEmbedEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'embed', 'style': 'form', 'explode': True }})
    r"""A flag to indicate whether to embed the corresponding 'feature' into each matching name"""  
    ...
    output_srs: Optional[GetNamesDecisionsRecentOutputSrsEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'outputSRS', 'style': 'form', 'explode': True }})
    r"""The EPSG code of the spatial reference system (SRS) to use for output geometries."""  
