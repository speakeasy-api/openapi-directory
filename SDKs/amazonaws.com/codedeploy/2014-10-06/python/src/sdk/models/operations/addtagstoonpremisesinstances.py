...
class AddTagsToOnPremisesInstancesRequest:
    headers: AddTagsToOnPremisesInstancesHeaders = dataclasses.field()
    request: shared_addtagstoonpremisesinstancesinput.AddTagsToOnPremisesInstancesInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
