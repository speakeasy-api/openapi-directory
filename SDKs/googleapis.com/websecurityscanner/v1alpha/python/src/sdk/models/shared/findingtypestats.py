...
class FindingTypeStats:
    ...
    finding_type: Optional[FindingTypeStatsFindingTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('findingType') }})
