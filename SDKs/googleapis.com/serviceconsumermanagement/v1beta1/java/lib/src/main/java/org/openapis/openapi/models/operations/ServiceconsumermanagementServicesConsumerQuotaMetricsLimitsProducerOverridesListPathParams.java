...
public class ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesListPathParams {
    /**
    ...
    public ServiceconsumermanagementServicesConsumerQuotaMetricsLimitsProducerOverridesListPathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
