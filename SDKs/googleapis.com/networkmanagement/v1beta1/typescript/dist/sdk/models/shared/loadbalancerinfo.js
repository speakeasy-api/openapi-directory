...
var LoadBalancerInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "backendUri" }),
        __metadata("design:type", String)
    ], LoadBalancerInfo.prototype, "backendUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: loadbalancerbackend_1.LoadBalancerBackend }),
        (0, class_transformer_1.Expose)({ name: "backends" }),
        (0, class_transformer_1.Type)(function () { return loadbalancerbackend_1.LoadBalancerBackend; }),
        __metadata("design:type", Array)
    ], LoadBalancerInfo.prototype, "backends", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "healthCheckUri" }),
        __metadata("design:type", String)
