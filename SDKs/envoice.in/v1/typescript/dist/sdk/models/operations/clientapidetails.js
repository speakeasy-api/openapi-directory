...
exports.ClientApiDetailsResponse = exports.ClientApiDetailsRequest = void 0;
...
var ClientApiDetailsRequest = /** @class */ (function (_super) {
    ...
    ], ClientApiDetailsRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], ClientApiDetailsRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], ClientApiDetailsRequest.prototype, "xAuthSecret", void 0);
    return ClientApiDetailsRequest;
}(utils_1.SpeakeasyBase));
exports.ClientApiDetailsRequest = ClientApiDetailsRequest;
var ClientApiDetailsResponse = /** @class */ (function (_super) {
    ...
    ], ClientApiDetailsResponse.prototype, "rawResponse", void 0);
    return ClientApiDetailsResponse;
}(utils_1.SpeakeasyBase));
exports.ClientApiDetailsResponse = ClientApiDetailsResponse;
