...
public class GetPaymentInformationHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Digest")
    public String digest;
    public GetPaymentInformationHeaders withDigest(String digest) {
        this.digest = digest;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-Accept")
    public String psuAccept;
    public GetPaymentInformationHeaders withPsuAccept(String psuAccept) {
    ...
    public GetPaymentInformationHeaders withPsuAcceptCharset(String psuAcceptCharset) {
    ...
    public GetPaymentInformationHeaders withPsuAcceptEncoding(String psuAcceptEncoding) {
    ...
    public GetPaymentInformationHeaders withPsuAcceptLanguage(String psuAcceptLanguage) {
    ...
    public GetPaymentInformationHeaders withPsuDeviceId(String psuDeviceID) {
    ...
    public GetPaymentInformationHeaders withPsuGeoLocation(String psuGeoLocation) {
    ...
    public GetPaymentInformationHeaders withPsuHttpMethod(openapisdk.models.shared.PsuHttpMethodEnum psuHttpMethod) {
    ...
    public GetPaymentInformationHeaders withPsuIpAddress(String psuIPAddress) {
        this.psuIPAddress = psuIPAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=PSU-IP-Port")
    public String psuIPPort;
    public GetPaymentInformationHeaders withPsuIpPort(String psuIPPort) {
    ...
    public GetPaymentInformationHeaders withPsuUserAgent(String psuUserAgent) {
        this.psuUserAgent = psuUserAgent;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Signature")
    public String signature;
    public GetPaymentInformationHeaders withSignature(String signature) {
    ...
    public GetPaymentInformationHeaders withTppSignatureCertificate(String tppSignatureCertificate) {
    ...
    public GetPaymentInformationHeaders withXRequestId(String xRequestID) {
