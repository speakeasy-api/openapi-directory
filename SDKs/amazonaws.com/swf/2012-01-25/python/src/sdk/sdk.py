...
SERVERS = [
    ...
    r"""The Amazon SWF multi-region endpoint"""
    "https://swf.{region}.amazonaws.com",
    r"""The Amazon SWF multi-region endpoint"""
    "http://swf.{region}.amazonaws.com.cn",
    r"""The Amazon SWF endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def count_closed_workflow_executions(self, request: operations.CountClosedWorkflowExecutionsRequest) -> operations.CountClosedWorkflowExecutionsResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "count_closed_workflow_executions_input", 'json')
        ...
        res = operations.CountClosedWorkflowExecutionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.WorkflowExecutionCount])
    ...
    def count_open_workflow_executions(self, request: operations.CountOpenWorkflowExecutionsRequest) -> operations.CountOpenWorkflowExecutionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "count_open_workflow_executions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CountOpenWorkflowExecutionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def count_pending_activity_tasks(self, request: operations.CountPendingActivityTasksRequest) -> operations.CountPendingActivityTasksResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "count_pending_activity_tasks_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CountPendingActivityTasksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PendingTaskCount])
    ...
    def count_pending_decision_tasks(self, request: operations.CountPendingDecisionTasksRequest) -> operations.CountPendingDecisionTasksResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "count_pending_decision_tasks_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.CountPendingDecisionTasksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def deprecate_activity_type(self, request: operations.DeprecateActivityTypeRequest) -> operations.DeprecateActivityTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "deprecate_activity_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeprecateActivityTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def deprecate_domain(self, request: operations.DeprecateDomainRequest) -> operations.DeprecateDomainResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "deprecate_domain_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeprecateDomainResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def deprecate_workflow_type(self, request: operations.DeprecateWorkflowTypeRequest) -> operations.DeprecateWorkflowTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "deprecate_workflow_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DeprecateWorkflowTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_activity_type(self, request: operations.DescribeActivityTypeRequest) -> operations.DescribeActivityTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_activity_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeActivityTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ActivityTypeDetail])
    ...
    def describe_domain(self, request: operations.DescribeDomainRequest) -> operations.DescribeDomainResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_domain_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def describe_workflow_execution(self, request: operations.DescribeWorkflowExecutionRequest) -> operations.DescribeWorkflowExecutionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_workflow_execution_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeWorkflowExecutionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.WorkflowExecutionDetail])
    ...
    def describe_workflow_type(self, request: operations.DescribeWorkflowTypeRequest) -> operations.DescribeWorkflowTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "describe_workflow_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.DescribeWorkflowTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.WorkflowTypeDetail])
    ...
    def get_workflow_execution_history(self, request: operations.GetWorkflowExecutionHistoryRequest) -> operations.GetWorkflowExecutionHistoryResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_workflow_execution_history_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.GetWorkflowExecutionHistoryRequest, request)
        ...
        res = operations.GetWorkflowExecutionHistoryResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def list_activity_types(self, request: operations.ListActivityTypesRequest) -> operations.ListActivityTypesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_activity_types_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListActivityTypesRequest, request)
        ...
        res = operations.ListActivityTypesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ActivityTypeInfos])
    ...
    def list_closed_workflow_executions(self, request: operations.ListClosedWorkflowExecutionsRequest) -> operations.ListClosedWorkflowExecutionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_closed_workflow_executions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListClosedWorkflowExecutionsRequest, request)
        ...
        res = operations.ListClosedWorkflowExecutionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.WorkflowExecutionInfos])
    ...
    def list_domains(self, request: operations.ListDomainsRequest) -> operations.ListDomainsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_domains_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DomainInfos])
    ...
    def list_open_workflow_executions(self, request: operations.ListOpenWorkflowExecutionsRequest) -> operations.ListOpenWorkflowExecutionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_open_workflow_executions_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListOpenWorkflowExecutionsRequest, request)
        ...
        res = operations.ListOpenWorkflowExecutionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def list_workflow_types(self, request: operations.ListWorkflowTypesRequest) -> operations.ListWorkflowTypesResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_workflow_types_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.ListWorkflowTypesRequest, request)
        ...
        res = operations.ListWorkflowTypesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.WorkflowTypeInfos])
    ...
    def poll_for_activity_task(self, request: operations.PollForActivityTaskRequest) -> operations.PollForActivityTaskResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "poll_for_activity_task_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PollForActivityTaskResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ActivityTask])
    ...
    def poll_for_decision_task(self, request: operations.PollForDecisionTaskRequest) -> operations.PollForDecisionTaskResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "poll_for_decision_task_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = utils.get_query_params(operations.PollForDecisionTaskRequest, request)
        ...
        res = operations.PollForDecisionTaskResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DecisionTask])
    ...
    def record_activity_task_heartbeat(self, request: operations.RecordActivityTaskHeartbeatRequest) -> operations.RecordActivityTaskHeartbeatResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "record_activity_task_heartbeat_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RecordActivityTaskHeartbeatResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ActivityTaskStatus])
    ...
    def register_activity_type(self, request: operations.RegisterActivityTypeRequest) -> operations.RegisterActivityTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_activity_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RegisterActivityTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def register_domain(self, request: operations.RegisterDomainRequest) -> operations.RegisterDomainResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_domain_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def register_workflow_type(self, request: operations.RegisterWorkflowTypeRequest) -> operations.RegisterWorkflowTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "register_workflow_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RegisterWorkflowTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_cancel_workflow_execution(self, request: operations.RequestCancelWorkflowExecutionRequest) -> operations.RequestCancelWorkflowExecutionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "request_cancel_workflow_execution_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RequestCancelWorkflowExecutionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def respond_activity_task_canceled(self, request: operations.RespondActivityTaskCanceledRequest) -> operations.RespondActivityTaskCanceledResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "respond_activity_task_canceled_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RespondActivityTaskCanceledResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def respond_activity_task_completed(self, request: operations.RespondActivityTaskCompletedRequest) -> operations.RespondActivityTaskCompletedResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "respond_activity_task_completed_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RespondActivityTaskCompletedResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def respond_activity_task_failed(self, request: operations.RespondActivityTaskFailedRequest) -> operations.RespondActivityTaskFailedResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "respond_activity_task_failed_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RespondActivityTaskFailedResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def respond_decision_task_completed(self, request: operations.RespondDecisionTaskCompletedRequest) -> operations.RespondDecisionTaskCompletedResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "respond_decision_task_completed_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RespondDecisionTaskCompletedResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def signal_workflow_execution(self, request: operations.SignalWorkflowExecutionRequest) -> operations.SignalWorkflowExecutionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "signal_workflow_execution_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.SignalWorkflowExecutionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def start_workflow_execution(self, request: operations.StartWorkflowExecutionRequest) -> operations.StartWorkflowExecutionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "start_workflow_execution_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.StartWorkflowExecutionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Run])
                res.run = out
        elif http_res.status_code == 480:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[Any])
    ...
    def terminate_workflow_execution(self, request: operations.TerminateWorkflowExecutionRequest) -> operations.TerminateWorkflowExecutionResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "terminate_workflow_execution_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.TerminateWorkflowExecutionResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def undeprecate_activity_type(self, request: operations.UndeprecateActivityTypeRequest) -> operations.UndeprecateActivityTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "undeprecate_activity_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UndeprecateActivityTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def undeprecate_domain(self, request: operations.UndeprecateDomainRequest) -> operations.UndeprecateDomainResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "undeprecate_domain_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UndeprecateDomainResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def undeprecate_workflow_type(self, request: operations.UndeprecateWorkflowTypeRequest) -> operations.UndeprecateWorkflowTypeResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "undeprecate_workflow_type_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UndeprecateWorkflowTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
