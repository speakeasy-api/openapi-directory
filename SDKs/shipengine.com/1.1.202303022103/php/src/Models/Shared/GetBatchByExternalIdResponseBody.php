...
class GetBatchByExternalIdResponseBody
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyOptionalLink $batchErrorsUrl
     */
	#[\JMS\Serializer\Annotation\SerializedName('batch_errors_url')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyOptionalLink')]
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyOptionalLink $formDownload
     */
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelDownload $labelDownload
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_download')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelDownload')]
    public GetBatchByExternalIdResponseBodyLabelDownload $labelDownload;
    
	#[\JMS\Serializer\Annotation\SerializedName('label_format')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelFormatEnum>')]
    public GetBatchByExternalIdResponseBodyLabelFormatEnum $labelFormat;
    
    /**
     * label layout
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelLayoutEnum $labelLayout
     */
	#[\JMS\Serializer\Annotation\SerializedName('label_layout')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelLayoutEnum>')]
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyBatchStatusEnum>')]
	...
	{
		$this->batchErrorsUrl = new \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyOptionalLink();
		$this->batchId = "";
		...
		$this->formDownload = new \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyOptionalLink();
		$this->forms = 0;
		$this->labelDownload = new \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelDownload();
		$this->labelFormat = \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelFormatEnum::PDF;
		$this->labelLayout = \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyLabelLayoutEnum::FOURX6;
		$this->processedAt = new \DateTime();
		$this->status = \OpenAPI\OpenAPI\Models\Shared\GetBatchByExternalIdResponseBodyBatchStatusEnum::OPEN;
		$this->warnings = 0;
	}
}
