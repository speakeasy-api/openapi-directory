...
var Notification = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=crmExperimentIds" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=doc_type" }),
        __metadata("design:type", String)
    ], Notification.prototype, "docType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=dont_show_notification" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=is_document_mature" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notificationGroup" }),
        __metadata("design:type", String)
    ], Notification.prototype, "notificationGroup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=notification_type" }),
        __metadata("design:type", String)
    ], Notification.prototype, "notificationType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pcampaign_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=show_notification_settings_action" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timeToExpireMs" }),
        __metadata("design:type", String)
