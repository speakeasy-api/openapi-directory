...
/**
 * PreprintsListPreprintAttributes - The properties of the preprint entity.
 */
public class PreprintsListPreprintAttributes {
    /**
    ...
    public PreprintsListPreprintAttributes withDateCreated(OffsetDateTime dateCreated) {
    ...
    public PreprintsListPreprintAttributes withDateModified(OffsetDateTime dateModified) {
    ...
    public PreprintsListPreprintAttributes withDatePublished(OffsetDateTime datePublished) {
    ...
    public PreprintsListPreprintAttributes withDoi(String doi) {
        this.doi = doi;
        return this;
    }
    ...
    public PreprintsListPreprintAttributes withIsPreprintOrphan(Boolean isPreprintOrphan) {
    ...
    public PreprintsListPreprintAttributes withLicenseRecord(String licenseRecord) {
    ...
    public PreprintsListPreprintAttributes withSubjects(String[] subjects) {
        this.subjects = subjects;
        return this;
    }
    
    public PreprintsListPreprintAttributes(){}
}
