...
export enum GetComputeAccessXAmzTargetEnum {
  GameLiftGetComputeAccess = "GameLift.GetComputeAccess",
}

export class GetComputeAccessRequest extends SpeakeasyBase {
...
export class GetComputeAccessResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
