...
type RecommendationengineProjectsLocationsCatalogsCatalogItemsPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RecommendationengineProjectsLocationsCatalogsCatalogItemsPatchPathParams struct {
...
type RecommendationengineProjectsLocationsCatalogsCatalogItemsPatchQueryParams struct {
	// V1 error format.
...
type RecommendationengineProjectsLocationsCatalogsCatalogItemsPatchRequest struct {
...
type RecommendationengineProjectsLocationsCatalogsCatalogItemsPatchResponse struct {
	ContentType string
	// Successful response
