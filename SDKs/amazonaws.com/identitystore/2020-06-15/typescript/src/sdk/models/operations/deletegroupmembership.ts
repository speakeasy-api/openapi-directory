...
export enum DeleteGroupMembershipXAmzTargetEnum {
  AWSIdentityStoreDeleteGroupMembership = "AWSIdentityStore.DeleteGroupMembership",
}

export class DeleteGroupMembershipRequest extends SpeakeasyBase {
...
export class DeleteGroupMembershipResponse extends SpeakeasyBase {
  /**
