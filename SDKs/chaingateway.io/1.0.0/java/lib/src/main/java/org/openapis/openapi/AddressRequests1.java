...
public class AddressRequests1 {
	...
	public AddressRequests1(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
