...
class VatRates:
    ...
    def vat_rates_get(self) -> operations.VatRatesGetResponse:
        ...
        res = operations.VatRatesGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PageResultVatRateDto])
                res.page_result_vat_rate_dto = out
