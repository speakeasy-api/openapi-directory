...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Mbcer(ctx, operations.MbcerRequestBody{
        CertificateParameters: &operations.MbcerRequestBodyCertificateParameters{
            CertType: "ACS,FCS,COP",
            FullName: "Sunil Kumar",
            MembershipNo: "128XX",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.MbcerRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.MbcerSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
