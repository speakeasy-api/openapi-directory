...
class DeleteGitHubAccountTokenRequest:
    ...
    delete_git_hub_account_token_input: shared_deletegithubaccounttokeninput.DeleteGitHubAccountTokenInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
