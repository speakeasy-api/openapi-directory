...
export class EmployeeResultEmployment extends SpeakeasyBase {
  ...
  @Type(() => EmployeeResultEmploymentEmploymentDates)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "salary" })
  @Type(() => EmployeeResultEmploymentSalary)
...
export class EmployeeResultPersonDetails extends SpeakeasyBase {
  ...
  @Type(() => EmployeeResultPersonDetailsAmericanIndian)
  ...
  @Type(() => EmployeeResultPersonDetailsDisability)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "tobacco" })
  @Type(() => EmployeeResultPersonDetailsTobacco)
...
export class EmployeeResultPerson extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "contact" })
  @Type(() => EmployeeResultPersonContact)
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "details" })
  @Type(() => EmployeeResultPersonDetails)
  ...
  @Type(() => EmployeeResultPersonHomeAddress)
  ...
  @Type(() => EmployeeResultPersonMailingAddress)
