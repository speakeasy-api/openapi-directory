...
class FetchUnderstandAssistantFallbackActionsRequest:
    path_params: FetchUnderstandAssistantFallbackActionsPathParams = dataclasses.field()
    security: FetchUnderstandAssistantFallbackActionsSecurity = dataclasses.field()
