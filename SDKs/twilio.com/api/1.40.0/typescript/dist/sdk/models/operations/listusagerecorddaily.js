...
exports.ListUsageRecordDailyResponse = exports.ListUsageRecordDailyListUsageRecordDailyResponse = exports.ListUsageRecordDailyRequest = exports.ListUsageRecordDailySecurity = exports.ListUsageRecordDailyServerList = void 0;
...
var ListUsageRecordDailySecurity = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordDailySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordDailySecurity.prototype, "username", void 0);
...
var ListUsageRecordDailyRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUsageRecordDailyRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Category",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordDailyRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EndDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordDailyRequest.prototype, "endDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=IncludeSubaccounts",
        }),
        __metadata("design:type", Boolean)
    ], ListUsageRecordDailyRequest.prototype, "includeSubaccounts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUsageRecordDailyRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUsageRecordDailyRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUsageRecordDailyRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], ListUsageRecordDailyRequest.prototype, "startDate", void 0);
...
var ListUsageRecordDailyListUsageRecordDailyResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.ApiV2010AccountUsageUsageRecordUsageRecordDaily,
        }),
        (0, class_transformer_1.Expose)({ name: "usage_records" }),
        (0, class_transformer_1.Type)(function () { return shared.ApiV2010AccountUsageUsageRecordUsageRecordDaily; }),
...
var ListUsageRecordDailyResponse = /** @class */ (function (_super) {
    ...
    ], ListUsageRecordDailyResponse.prototype, "rawResponse", void 0);
