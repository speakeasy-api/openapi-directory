...
class AcceptDisputeResponse:
    r"""Defines the fields in an `AcceptDispute` response."""
    
    dispute: Optional[shared_dispute.Dispute] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dispute'), 'exclude': lambda f: f is None }})
