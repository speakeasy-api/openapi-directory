...
from ..shared import putaccountingcodetype as shared_putaccountingcodetype
...
class PUTAccountingCodeRequest:
    ...
    r"""ID of the accounting code you want to update."""  
    put_accounting_code_type: shared_putaccountingcodetype.PUTAccountingCodeType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
