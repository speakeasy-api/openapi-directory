...
class PutJournalRunPathParams:
    jr_number: str = dataclasses.field(metadata={'path_param': { 'field_name': 'jr-number', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PutJournalRunHeaders:
    zuora_entity_ids: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Entity-Ids', 'style': 'simple', 'explode': False }})
    zuora_track_id: Optional[str] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'Zuora-Track-Id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PutJournalRunRequest:
    headers: PutJournalRunHeaders = dataclasses.field()
    path_params: PutJournalRunPathParams = dataclasses.field()
    

@dataclasses.dataclass
class PutJournalRunResponse:
