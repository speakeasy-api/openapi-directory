...
// ReactionsCreateForCommitCommentRequestBodyContentEnum - The [reaction type](https://docs.github.com/github-ae@latest/rest/reference/reactions#reaction-types) to add to the commit comment.
