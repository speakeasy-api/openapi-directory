...
var PaymentPolicy = /** @class */ (function () {
    ...
    **/
    PaymentPolicy.prototype.createPaymentPolicy = function (req, config) {
        var _a;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.setPaymentPolicyResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    PaymentPolicy.prototype.deletePaymentPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeletePaymentPolicyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/payment_policy/{payment_policy_id}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
    ...
    **/
    PaymentPolicy.prototype.getPaymentPolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.paymentPolicyResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    PaymentPolicy.prototype.getPaymentPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.paymentPolicy = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    PaymentPolicy.prototype.getPaymentPolicyByName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PaymentPolicy.prototype.updatePaymentPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
