...
type DataprocProjectsRegionsJobsSubmitSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DataprocProjectsRegionsJobsSubmitPathParams struct {
...
type DataprocProjectsRegionsJobsSubmitQueryParams struct {
	// V1 error format.
...
type DataprocProjectsRegionsJobsSubmitResponse struct {
	ContentType string
	// Successful response
	Job         *shared.Job
	StatusCode  int
