...
class GoogleCloudRetailV2SearchResponseSearchResult:
    ...
    product: Optional[shared_googlecloudretailv2product.GoogleCloudRetailV2Product] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('product'), 'exclude': lambda f: f is None }})
