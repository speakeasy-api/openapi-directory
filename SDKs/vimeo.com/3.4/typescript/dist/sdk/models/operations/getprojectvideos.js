...
exports.GetProjectVideosResponse = exports.GetProjectVideosRequest = exports.GetProjectVideosSortEnum = exports.GetProjectVideosDirectionEnum = exports.GetProjectVideosSecurity = void 0;
...
var GetProjectVideosRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetProjectVideosRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetProjectVideosRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetProjectVideosRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=project_id",
        }),
        __metadata("design:type", Number)
    ], GetProjectVideosRequest.prototype, "projectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetProjectVideosRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=user_id",
        }),
        __metadata("design:type", Number)
    ], GetProjectVideosRequest.prototype, "userId", void 0);
...
var GetProjectVideosResponse = /** @class */ (function (_super) {
    ...
    ], GetProjectVideosResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
