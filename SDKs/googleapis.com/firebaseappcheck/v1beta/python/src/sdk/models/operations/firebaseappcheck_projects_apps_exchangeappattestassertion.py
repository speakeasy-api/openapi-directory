...
class FirebaseappcheckProjectsAppsExchangeAppAttestAssertionRequest:
    ...
    google_firebase_appcheck_v1beta_exchange_app_attest_assertion_request: Optional[shared_googlefirebaseappcheckv1betaexchangeappattestassertionrequest.GoogleFirebaseAppcheckV1betaExchangeAppAttestAssertionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
