...
class ListEndpointPoliciesResponse:
    ...
    endpoint_policies: Optional[list[shared_endpointpolicy.EndpointPolicy]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('endpointPolicies'), 'exclude': lambda f: f is None }})
    r"""List of EndpointPolicy resources."""  
