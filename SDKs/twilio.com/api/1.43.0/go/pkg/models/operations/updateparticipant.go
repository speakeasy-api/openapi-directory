...
func (e UpdateParticipantUpdateParticipantRequestAnnounceMethodEnum) ToPointer() *UpdateParticipantUpdateParticipantRequestAnnounceMethodEnum {
	return &e
}
...
func (e *UpdateParticipantUpdateParticipantRequestAnnounceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateParticipantUpdateParticipantRequestAnnounceMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateParticipantUpdateParticipantRequestAnnounceMethodEnum: %v", v)
	}
}
...
func (e UpdateParticipantUpdateParticipantRequestHoldMethodEnum) ToPointer() *UpdateParticipantUpdateParticipantRequestHoldMethodEnum {
	return &e
}
...
func (e *UpdateParticipantUpdateParticipantRequestHoldMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateParticipantUpdateParticipantRequestHoldMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateParticipantUpdateParticipantRequestHoldMethodEnum: %v", v)
	}
}
...
func (e UpdateParticipantUpdateParticipantRequestWaitMethodEnum) ToPointer() *UpdateParticipantUpdateParticipantRequestWaitMethodEnum {
	return &e
}
...
func (e *UpdateParticipantUpdateParticipantRequestWaitMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = UpdateParticipantUpdateParticipantRequestWaitMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateParticipantUpdateParticipantRequestWaitMethodEnum: %v", v)
	}
}
