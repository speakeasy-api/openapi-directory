...
exports.ReactionsListForIssueResponse = exports.ReactionsListForIssue415ApplicationJSON = exports.ReactionsListForIssueRequest = exports.ReactionsListForIssueContentEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
/**
 * Returns a single [reaction type](https://docs.github.com/enterprise-server@2.21/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue.
 */
var ReactionsListForIssueContentEnum;
...
})(ReactionsListForIssueContentEnum = exports.ReactionsListForIssueContentEnum || (exports.ReactionsListForIssueContentEnum = {}));
var ReactionsListForIssueRequest = /** @class */ (function (_super) {
    ...
    ], ReactionsListForIssueRequest.prototype, "content", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=issue_number",
        }),
        __metadata("design:type", Number)
    ], ReactionsListForIssueRequest.prototype, "issueNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ReactionsListForIssueRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ReactionsListForIssueRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ReactionsListForIssueRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ReactionsListForIssueRequest.prototype, "repo", void 0);
...
var ReactionsListForIssueResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ReactionsListForIssueResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
