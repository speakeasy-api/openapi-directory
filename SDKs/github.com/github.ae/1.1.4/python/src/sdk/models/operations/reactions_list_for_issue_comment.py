...
class ReactionsListForIssueCommentContentEnum(str, Enum):
    r"""Returns a single [reaction type](https://docs.github.com/github-ae@latest/rest/reference/reactions#reaction-types). Omit this parameter to list all reactions to an issue comment."""
    PLUS_1 = '+1'
    MINUS_1 = '-1'
    LAUGH = 'laugh'
    CONFUSED = 'confused'
