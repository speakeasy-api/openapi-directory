...
exports.UpdateNetworkApplianceVpnBgpResponse = exports.UpdateNetworkApplianceVpnBgpRequest = exports.UpdateNetworkApplianceVpnBgpRequestBody = exports.UpdateNetworkApplianceVpnBgpRequestBodyNeighbors = exports.UpdateNetworkApplianceVpnBgpPathParams = void 0;
...
exports.UpdateNetworkApplianceVpnBgpPathParams = UpdateNetworkApplianceVpnBgpPathParams;
var UpdateNetworkApplianceVpnBgpRequestBodyNeighbors = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=receiveLimit" }),
        __metadata("design:type", Number)
    ], UpdateNetworkApplianceVpnBgpRequestBodyNeighbors.prototype, "receiveLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=remoteAsNumber" }),
        __metadata("design:type", Number)
...
var UpdateNetworkApplianceVpnBgpRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=asNumber" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=ibgpHoldTimer" }),
        __metadata("design:type", Number)
    ], UpdateNetworkApplianceVpnBgpRequestBody.prototype, "ibgpHoldTimer", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=neighbors", elemType: UpdateNetworkApplianceVpnBgpRequestBodyNeighbors }),
