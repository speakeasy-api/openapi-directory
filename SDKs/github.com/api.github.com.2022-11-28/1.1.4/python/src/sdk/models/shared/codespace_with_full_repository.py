...
class CodespaceWithFullRepositoryLocationEnum(str, Enum):
...
class CodespaceWithFullRepositoryStateEnum(str, Enum):
...
class CodespaceWithFullRepository:
    ...
    git_status: CodespaceWithFullRepositoryGitStatus = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('git_status') }})
    r"""Details about the codespace's git repository."""  
    ...
    location: CodespaceWithFullRepositoryLocationEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('location') }})
    r"""The Azure region where this codespace is located."""  
    ...
    repository: shared_full_repository.FullRepository = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('repository') }})
    r"""Full Repository"""  
    ...
    state: CodespaceWithFullRepositoryStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state') }})
    r"""State of this codespace."""  
    ...
    runtime_constraints: Optional[CodespaceWithFullRepositoryRuntimeConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('runtime_constraints'), 'exclude': lambda f: f is None }})  
