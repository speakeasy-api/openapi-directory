...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworksecurityProjectsLocationsGatewaySecurityPoliciesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
