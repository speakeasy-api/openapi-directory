...
class PostDescribeReservedCacheNodesOfferingsQueryParams:
    action: PostDescribeReservedCacheNodesOfferingsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeReservedCacheNodesOfferingsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeReservedCacheNodesOfferingsRequest:
    headers: PostDescribeReservedCacheNodesOfferingsHeaders = dataclasses.field()
    query_params: PostDescribeReservedCacheNodesOfferingsQueryParams = dataclasses.field()
