...
exports.BankAccountList = void 0;
...
**/
var BankAccountList = /** @class */ (function (_super) {
    __extends(BankAccountList, _super);
    ...
    ], BankAccountList.prototype, "currentPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=data", elemType: bankaccount_1.BankAccount }),
        __metadata("design:type", Array)
    ], BankAccountList.prototype, "data", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_page" }),
        __metadata("design:type", Number)
    ], BankAccountList.prototype, "lastPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=next_page_url" }),
        __metadata("design:type", String)
    ], BankAccountList.prototype, "nextPageUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=per_page" }),
        __metadata("design:type", Number)
    ], BankAccountList.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=prev_page_url" }),
        __metadata("design:type", String)
    ], BankAccountList.prototype, "prevPageUrl", void 0);
    __decorate([
