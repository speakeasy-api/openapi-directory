...
import org.openapis.openapi.models.operations.ApmclRequestBody;
import org.openapis.openapi.models.operations.ApmclRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.ApmclRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.ApmclResponse;
import org.openapis.openapi.models.operations.ApmclSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            ApmclRequestBody req = new ApmclRequestBody(ApmclRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new ApmclRequestBodyCertificateParameters("123456789");;
            ...
            ApmclResponse res = sdk.apIs.apmcl(req, new ApmclSecurity("molestiae", "minus") {{
