...
var ApIs = /** @class */ (function () {
    ...
    **/
    ApIs.prototype.kecer = function (req, config) {
        var _a;
    ...
    **/
    ApIs.prototype.tapcn = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApIs.prototype.tdlcs = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ApIs.prototype.ugdcn = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
