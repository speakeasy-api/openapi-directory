...
public class EstimationApiChangeStatusFormRequest {
    ...
    public EstimationApiChangeStatusFormRequest(@JsonProperty("EstimationChangeStatusApiModel") org.openapis.openapi.models.shared.EstimationChangeStatusApiModel estimationChangeStatusApiModel, @JsonProperty("x-auth-key") String xAuthKey, @JsonProperty("x-auth-secret") String xAuthSecret) {
        this.estimationChangeStatusApiModel = estimationChangeStatusApiModel;
        this.xAuthKey = xAuthKey;
        this.xAuthSecret = xAuthSecret;
  }
