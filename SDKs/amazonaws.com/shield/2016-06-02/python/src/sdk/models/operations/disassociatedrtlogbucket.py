...
class DisassociateDRTLogBucketRequest:
    ...
    disassociate_drt_log_bucket_request: shared_disassociatedrtlogbucketrequest.DisassociateDRTLogBucketRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
