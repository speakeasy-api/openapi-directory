...
exports.POSTGetStatusResponse = exports.POSTGetStatusRequest = exports.POSTGetStatusVersionEnum = exports.POSTGetStatusOperationEnum = exports.POSTGetStatusActionEnum = void 0;
...
var POSTGetStatusRequest = /** @class */ (function (_super) {
    ...
    ], POSTGetStatusRequest.prototype, "awsAccessKeyId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Action",
        }),
        __metadata("design:type", String)
    ], POSTGetStatusRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Operation",
        }),
        __metadata("design:type", String)
    ], POSTGetStatusRequest.prototype, "operation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTGetStatusRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Signature",
        }),
        __metadata("design:type", String)
    ], POSTGetStatusRequest.prototype, "signature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureMethod",
        }),
        __metadata("design:type", String)
    ], POSTGetStatusRequest.prototype, "signatureMethod", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SignatureVersion",
        }),
        __metadata("design:type", String)
    ], POSTGetStatusRequest.prototype, "signatureVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Timestamp",
        }),
        __metadata("design:type", String)
    ], POSTGetStatusRequest.prototype, "timestamp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTGetStatusRequest.prototype, "version", void 0);
...
var POSTGetStatusResponse = /** @class */ (function (_super) {
    ...
    ], POSTGetStatusResponse.prototype, "rawResponse", void 0);
