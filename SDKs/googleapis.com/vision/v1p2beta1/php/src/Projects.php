...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\VisionProjectsLocationsFilesAnnotateResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1p2beta1/{parent}/files:annotate', \OpenAPI\OpenAPI\Models\Operations\VisionProjectsLocationsFilesAnnotateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1p2beta1/{parent}/files:asyncBatchAnnotate', \OpenAPI\OpenAPI\Models\Operations\VisionProjectsLocationsFilesAsyncBatchAnnotateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1p2beta1/{parent}/images:annotate', \OpenAPI\OpenAPI\Models\Operations\VisionProjectsLocationsImagesAnnotateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1p2beta1/{parent}/images:asyncBatchAnnotate', \OpenAPI\OpenAPI\Models\Operations\VisionProjectsLocationsImagesAsyncBatchAnnotateRequest::class, $request);
