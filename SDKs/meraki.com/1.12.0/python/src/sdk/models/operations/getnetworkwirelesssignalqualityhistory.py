...
class GetNetworkWirelessSignalQualityHistoryRequest:
    path_params: GetNetworkWirelessSignalQualityHistoryPathParams = dataclasses.field()
    query_params: GetNetworkWirelessSignalQualityHistoryQueryParams = dataclasses.field()
...
class GetNetworkWirelessSignalQualityHistoryResponse:
    ...
    get_network_wireless_signal_quality_history_200_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
