...
type CreateInternationalScheduledPaymentsRawSecurity struct {
	PSUOAuth2Security shared.SchemePsuoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateInternationalScheduledPaymentsRawHeaders struct {
...
type CreateInternationalScheduledPaymentsRawRequest struct {
	Headers CreateInternationalScheduledPaymentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateInternationalScheduledPaymentsRawSecurity
}

type CreateInternationalScheduledPaymentsRawResponse struct {
	Body        []byte
	ContentType string
