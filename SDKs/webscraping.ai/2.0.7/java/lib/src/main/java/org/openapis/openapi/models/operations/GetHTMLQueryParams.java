...
public class GetHTMLQueryParams {
    ...
    public GetHTMLQueryParams withCountry(org.openapis.openapi.models.shared.CountryEnum country) {
    ...
    public GetHTMLQueryParams withDevice(org.openapis.openapi.models.shared.DeviceEnum device) {
        this.device = device;
        return this;
    }
    ...
    public GetHTMLQueryParams withErrorOn404(Boolean errorOn404) {
    ...
    public GetHTMLQueryParams withErrorOnRedirect(Boolean errorOnRedirect) {
    ...
    public GetHTMLQueryParams withJsTimeout(Long jsTimeout) {
    ...
    public GetHTMLQueryParams withProxy(org.openapis.openapi.models.shared.ProxyEnum proxy) {
        this.proxy = proxy;
        return this;
    }
