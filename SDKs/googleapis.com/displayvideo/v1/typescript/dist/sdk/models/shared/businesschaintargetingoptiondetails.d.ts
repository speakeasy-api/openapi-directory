 ...
 */
export declare enum BusinessChainTargetingOptionDetailsGeoRegionTypeEnum {
 ...
 */
export declare class BusinessChainTargetingOptionDetails extends SpeakeasyBase {
    /**
