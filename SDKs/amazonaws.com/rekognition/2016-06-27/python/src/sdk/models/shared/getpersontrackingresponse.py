...
from ..shared import persondetection as shared_persondetection
...
class GetPersonTrackingResponse:
    ...
    persons: Optional[list[shared_persondetection.PersonDetection]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Persons') }})
