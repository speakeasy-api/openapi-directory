 ...
 */
export enum CreateStageResponseDefaultRouteSettingsLoggingLevelEnum {
  Error = "ERROR",
  Info = "INFO",
  Off = "OFF",
}
...
export class CreateStageResponse extends SpeakeasyBase {
  ...
  @Type(() => CreateStageResponseAccessLogSettings)
  ...
  @Type(() => CreateStageResponseDefaultRouteSettings)
