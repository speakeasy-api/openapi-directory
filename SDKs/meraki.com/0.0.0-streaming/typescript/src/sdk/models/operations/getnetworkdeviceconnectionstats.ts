 ...
 */
export enum GetNetworkDeviceConnectionStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkDeviceConnectionStatsRequest extends SpeakeasyBase {
  /**
  ...
  band?: GetNetworkDeviceConnectionStatsBandEnum;
...
export class GetNetworkDeviceConnectionStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkDeviceConnectionStats200ApplicationJSONObject?: Record<string, any>;
}
