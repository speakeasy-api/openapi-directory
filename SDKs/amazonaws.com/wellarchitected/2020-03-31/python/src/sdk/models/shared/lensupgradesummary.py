...
class LensUpgradeSummary:
    r"""Lens upgrade summary return object."""
    
    current_lens_version: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('CurrentLensVersion'), 'exclude': lambda f: f is None }})  
