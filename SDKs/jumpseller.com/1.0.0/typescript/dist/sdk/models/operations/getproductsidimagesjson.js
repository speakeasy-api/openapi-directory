...
exports.GetProductsIdImagesJsonResponse = exports.GetProductsIdImagesJsonRequest = void 0;
...
var GetProductsIdImagesJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetProductsIdImagesJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetProductsIdImagesJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetProductsIdImagesJsonRequest.prototype, "login", void 0);
    return GetProductsIdImagesJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdImagesJsonRequest = GetProductsIdImagesJsonRequest;
var GetProductsIdImagesJsonResponse = /** @class */ (function (_super) {
    ...
    ], GetProductsIdImagesJsonResponse.prototype, "rawResponse", void 0);
    return GetProductsIdImagesJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetProductsIdImagesJsonResponse = GetProductsIdImagesJsonResponse;
