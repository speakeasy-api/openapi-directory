...
from ..shared import getledgeraccountresponse as shared_getledgeraccountresponse
...
class LedgerAccountsOneSecurity:
    
    api_key: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header', 'field_name': 'Authorization' }})  
    

@dataclasses.dataclass
class LedgerAccountsOneRequest:
...
@dataclasses.dataclass
class LedgerAccountsOneResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    bad_request_response: Optional[shared_badrequestresponse.BadRequestResponse] = dataclasses.field(default=None)
    r"""Bad Request"""  
    get_ledger_account_response: Optional[shared_getledgeraccountresponse.GetLedgerAccountResponse] = dataclasses.field(default=None)
    r"""LedgerAccount"""  
