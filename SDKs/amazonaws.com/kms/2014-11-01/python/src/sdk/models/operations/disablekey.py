...
from ..shared import disablekeyrequest as shared_disablekeyrequest
...
class DisableKeyHeaders:
    x_amz_target: DisableKeyXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableKeyRequest:
    headers: DisableKeyHeaders = dataclasses.field()
    request: shared_disablekeyrequest.DisableKeyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
