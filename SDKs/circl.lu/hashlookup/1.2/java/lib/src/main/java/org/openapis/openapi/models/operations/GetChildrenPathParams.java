...
public class GetChildrenPathParams {
    @SpeakeasyMetadata("pathParam:style=simple,explode=false,name=count")
    public Long count;
    public GetChildrenPathParams withCount(Long count) {
        this.count = count;
        return this;
    }
    ...
    public GetChildrenPathParams withCursor(String cursor) {
        this.cursor = cursor;
        return this;
    }
    ...
    public String sha1;
    public GetChildrenPathParams withSha1(String sha1) {
        this.sha1 = sha1;
        return this;
    }
