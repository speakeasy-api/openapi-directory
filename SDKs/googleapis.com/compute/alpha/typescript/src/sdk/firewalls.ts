...
export class Firewalls {
  ...
  computeFirewallsTestIamPermissions(
    req: operations.ComputeFirewallsTestIamPermissionsRequest,
    security: operations.ComputeFirewallsTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeFirewallsTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeFirewallsTestIamPermissionsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeFirewallsTestIamPermissionsResponse =
        new operations.ComputeFirewallsTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
