...
var Contact = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=acceptCommands", elemType: command_1.Command }),
        __metadata("design:type", Array)
    ], Contact.prototype, "acceptCommands", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=acceptTypes" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sharingFeatures" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=speakableName" }),
        __metadata("design:type", String)
