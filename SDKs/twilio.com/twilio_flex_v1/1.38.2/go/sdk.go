...
func (s *SDK) CreateAssessments(ctx context.Context, request operations.CreateAssessmentsRequest) (*operations.CreateAssessmentsResponse, error) {
	baseURL := operations.CreateAssessmentsServerList[0]
	if request.ServerURL != nil {
		baseURL = *request.ServerURL
	}

	url := strings.TrimSuffix(baseURL, "/") + "/v1/Accounts/Assessments"
	...
	res := &operations.CreateAssessmentsResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.FlexV1Assessments
