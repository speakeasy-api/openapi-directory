...
public class AffiliationByIdHeaders {
    /**
    ...
    public AffiliationByIdHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public AffiliationByIdHeaders withContentType(String contentType) {
    ...
    public AffiliationByIdHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public AffiliationByIdHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
