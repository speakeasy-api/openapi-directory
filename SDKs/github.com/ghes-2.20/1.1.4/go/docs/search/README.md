...
<https://docs.github.com/enterprise-server@2.20/rest/reference/search#search-code>
...
func main() {
    ...
    res, err := s.Search.SearchCode(ctx, operations.SearchCodeRequest{
        ...
        Page: sdk.Int64(475826),
        PerPage: sdk.Int64(930840),
        Q: "facilis",
...
API method documentation
<https://docs.github.com/enterprise-server@2.20/rest/reference/search#search-commits>
...
func main() {
    ...
    res, err := s.Search.SearchCommits(ctx, operations.SearchCommitsRequest{
        ...
        Page: sdk.Int64(43975),
        PerPage: sdk.Int64(574092),
        Q: "accusamus",
...
API method documentation
<https://docs.github.com/enterprise-server@2.20/rest/reference/search#search-issues-and-pull-requests>
...
func main() {
    ...
    res, err := s.Search.SearchIssuesAndPullRequests(ctx, operations.SearchIssuesAndPullRequestsRequest{
        Order: shared.OrderEnumAsc.ToPointer(),
        Page: sdk.Int64(115861),
        PerPage: sdk.Int64(30661),
        Q: "velit",
        Sort: operations.SearchIssuesAndPullRequestsSortEnumReactionsPlus1.ToPointer(),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@2.20/rest/reference/search#search-labels>
...
func main() {
    ...
    res, err := s.Search.SearchLabels(ctx, operations.SearchLabelsRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(953676),
        PerPage: sdk.Int64(223291),
        Q: "occaecati",
        RepositoryID: 539813,
...
API method documentation
<https://docs.github.com/enterprise-server@2.20/rest/reference/search#search-repositories>
...
func main() {
    ...
    res, err := s.Search.SearchRepos(ctx, operations.SearchReposRequest{
        Order: shared.OrderEnumAsc.ToPointer(),
        Page: sdk.Int64(287544),
        PerPage: sdk.Int64(794988),
        Q: "esse",
...
API method documentation
<https://docs.github.com/enterprise-server@2.20/rest/reference/search#search-topics>
...
func main() {
    ...
    res, err := s.Search.SearchTopics(ctx, operations.SearchTopicsRequest{
        Page: sdk.Int64(20950),
        PerPage: sdk.Int64(698558),
        Q: "ea",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-server@2.20/rest/reference/search#search-users>
...
func main() {
    ...
    res, err := s.Search.SearchUsers(ctx, operations.SearchUsersRequest{
        Order: shared.OrderEnumDesc.ToPointer(),
        Page: sdk.Int64(489459),
        PerPage: sdk.Int64(998026),
        Q: "velit",
