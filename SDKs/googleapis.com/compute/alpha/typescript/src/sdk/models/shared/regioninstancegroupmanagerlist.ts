 ...
 */
export enum RegionInstanceGroupManagerListWarningCodeEnum {
...
export class RegionInstanceGroupManagerListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RegionInstanceGroupManagerListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: RegionInstanceGroupManagerListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: RegionInstanceGroupManagerListWarningData })
  @Expose({ name: "data" })
  @Type(() => RegionInstanceGroupManagerListWarningData)
  data?: RegionInstanceGroupManagerListWarningData[];
 ...
 */
export class RegionInstanceGroupManagerList extends SpeakeasyBase {
  /**
