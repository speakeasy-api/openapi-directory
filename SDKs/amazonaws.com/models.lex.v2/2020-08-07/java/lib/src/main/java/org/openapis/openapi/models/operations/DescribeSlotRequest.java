...
public class DescribeSlotRequest {
    ...
    public DescribeSlotRequest(@JsonProperty("botId") String botId, @JsonProperty("botVersion") String botVersion, @JsonProperty("intentId") String intentId, @JsonProperty("localeId") String localeId, @JsonProperty("slotId") String slotId) {
        this.botId = botId;
        this.botVersion = botVersion;
        this.intentId = intentId;
        this.localeId = localeId;
