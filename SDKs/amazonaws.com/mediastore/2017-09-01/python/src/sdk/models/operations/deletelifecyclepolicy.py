...
from ..shared import deletelifecyclepolicyinput as shared_deletelifecyclepolicyinput

class DeleteLifecyclePolicyXAmzTargetEnum(str, Enum):
    MEDIA_STORE_20170901_DELETE_LIFECYCLE_POLICY = "MediaStore_20170901.DeleteLifecyclePolicy"
...
class DeleteLifecyclePolicyRequest:
    ...
    request: shared_deletelifecyclepolicyinput.DeleteLifecyclePolicyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteLifecyclePolicyResponse:
    ...
    delete_lifecycle_policy_output: Optional[dict[str, Any]] = dataclasses.field(default=None)
