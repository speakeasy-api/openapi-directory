...
exports.EstimationApiAllResponse = exports.EstimationApiAllRequest = void 0;
...
var EstimationApiAllRequest = /** @class */ (function (_super) {
    ...
    ], EstimationApiAllRequest.prototype, "queryOptionsPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=queryOptions.pageSize",
        }),
        __metadata("design:type", Number)
    ], EstimationApiAllRequest.prototype, "queryOptionsPageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], EstimationApiAllRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], EstimationApiAllRequest.prototype, "xAuthSecret", void 0);
    return EstimationApiAllRequest;
}(utils_1.SpeakeasyBase));
exports.EstimationApiAllRequest = EstimationApiAllRequest;
var EstimationApiAllResponse = /** @class */ (function (_super) {
    ...
    ], EstimationApiAllResponse.prototype, "rawResponse", void 0);
    return EstimationApiAllResponse;
}(utils_1.SpeakeasyBase));
exports.EstimationApiAllResponse = EstimationApiAllResponse;
