...
export declare class CreateDomesticStandingOrderConsentsRawSecurity extends SpeakeasyBase {
    tppoAuth2Security: string;
}
export declare class CreateDomesticStandingOrderConsentsRawRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticStandingOrderConsentsRawResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
