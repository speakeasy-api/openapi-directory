...
/**
 * GETCreditMemoItemTypeFinanceInformation - Container for the finance information related to the credit memo item.
 * 
 */
public class GETCreditMemoItemTypeFinanceInformation {
    /**
    ...
    public GETCreditMemoItemTypeFinanceInformation withDeferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
    ...
    public GETCreditMemoItemTypeFinanceInformation withDeferredRevenueAccountingCodeType(String deferredRevenueAccountingCodeType) {
    ...
    public GETCreditMemoItemTypeFinanceInformation withOnAccountAccountingCode(String onAccountAccountingCode) {
    ...
    public GETCreditMemoItemTypeFinanceInformation withOnAccountAccountingCodeType(String onAccountAccountingCodeType) {
    ...
    public GETCreditMemoItemTypeFinanceInformation withRecognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
    ...
    public GETCreditMemoItemTypeFinanceInformation withRecognizedRevenueAccountingCodeType(String recognizedRevenueAccountingCodeType) {
    ...
    public GETCreditMemoItemTypeFinanceInformation withRevenueRecognitionRuleName(String revenueRecognitionRuleName) {
    ...
    public GETCreditMemoItemTypeFinanceInformation withRevenueScheduleNumber(String revenueScheduleNumber) {
