...
public class WorkTypeApiAllHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public WorkTypeApiAllHeaders withXAuthKey(String xAuthKey) {
    ...
    public WorkTypeApiAllHeaders withXAuthSecret(String xAuthSecret) {
