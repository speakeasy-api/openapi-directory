...
class StopStreamRequestBody:
    ...
    r"""ARN of the channel for which the stream is to be stopped."""  
    

@dataclasses.dataclass
class StopStreamRequest:
    
    request_body: StopStreamRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
