...
@dataclasses.dataclass
class BooksBookshelvesVolumesListSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class BooksBookshelvesVolumesListRequest:
    path_params: BooksBookshelvesVolumesListPathParams = dataclasses.field()
    query_params: BooksBookshelvesVolumesListQueryParams = dataclasses.field()
    security: BooksBookshelvesVolumesListSecurity = dataclasses.field()
