...
exports.ExportTemplateInput = exports.ExportTemplate = void 0;
...
var ExportTemplateInput = /** @class */ (function (_super) {
    __extends(ExportTemplateInput, _super);
    function ExportTemplateInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=content_type" }),
        __metadata("design:type", Number)
    ], ExportTemplateInput.prototype, "contentType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], ExportTemplateInput.prototype, "description", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=file_extension" }),
        __metadata("design:type", String)
    ], ExportTemplateInput.prototype, "fileExtension", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=mime_type" }),
        __metadata("design:type", String)
    ], ExportTemplateInput.prototype, "mimeType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], ExportTemplateInput.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=template_code" }),
        __metadata("design:type", String)
    ], ExportTemplateInput.prototype, "templateCode", void 0);
    return ExportTemplateInput;
}(utils_1.SpeakeasyBase));
exports.ExportTemplateInput = ExportTemplateInput;
