...
export class GetApiV1WebhookSubscriptionsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum GetApiV1WebhookSubscriptionsSortEnum {
...
export class GetApiV1WebhookSubscriptionsRequest extends SpeakeasyBase {
  /**
...
export class GetApiV1WebhookSubscriptionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
