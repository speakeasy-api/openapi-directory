 ...
 */
public enum DisplayvideoTargetingTypesTargetingOptionsGetTargetingTypeEnum {
    ...
    private DisplayvideoTargetingTypesTargetingOptionsGetTargetingTypeEnum(String value) {
        this.value = value;
    }
}
