...
class GetRepositoryTriggersRequest:
    ...
    get_repository_triggers_input: shared_getrepositorytriggersinput.GetRepositoryTriggersInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
