...
class Transfer
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\TransferCategoryEnum $category
     */
	#[\JMS\Serializer\Annotation\SerializedName('category')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TransferCategoryEnum>')]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\TransferPriorityEnum $priority
     */
	#[\JMS\Serializer\Annotation\SerializedName('priority')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\TransferPriorityEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TransferPriorityEnum $priority = null;
