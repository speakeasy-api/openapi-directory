...
from ..shared import getexportjobresponse as shared_getexportjobresponse


@dataclasses.dataclass
class GetExportJobPathParams:
...
class GetExportJobRequest:
    headers: GetExportJobHeaders = dataclasses.field()
    path_params: GetExportJobPathParams = dataclasses.field()
...
class GetExportJobResponse:
    ...
    get_export_job_response: Optional[shared_getexportjobresponse.GetExportJobResponse] = dataclasses.field(default=None)
