...
class ParametersGetV2ParametersGetQueryParams:
...
@dataclasses.dataclass
class ParametersGetV2ParametersGetRequest:
    query_params: ParametersGetV2ParametersGetQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class ParametersGetV2ParametersGetResponse:
