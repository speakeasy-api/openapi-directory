...
public class StorageBucketAccessControlsGetQueryParams {
    ...
    public StorageBucketAccessControlsGetQueryParams withAlt(org.openapis.openapi.models.shared.AltEnum alt) {
        this.alt = alt;
        return this;
    }
    ...
    public StorageBucketAccessControlsGetQueryParams withUploadType(String uploadType) {
    ...
    public StorageBucketAccessControlsGetQueryParams withUserProject(String userProject) {
