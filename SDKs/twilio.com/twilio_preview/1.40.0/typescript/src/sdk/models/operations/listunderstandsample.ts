...
export class ListUnderstandSampleListUnderstandSampleResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListUnderstandSampleListUnderstandSampleResponseMeta)
  meta?: ListUnderstandSampleListUnderstandSampleResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.PreviewUnderstandAssistantTaskSample })
  @Expose({ name: "samples" })
  @Type(() => shared.PreviewUnderstandAssistantTaskSample)
