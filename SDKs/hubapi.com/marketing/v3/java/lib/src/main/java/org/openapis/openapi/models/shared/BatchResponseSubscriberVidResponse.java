...
public class BatchResponseSubscriberVidResponse {
    ...
    public BatchResponseSubscriberVidResponse(@JsonProperty("completedAt") OffsetDateTime completedAt, @JsonProperty("results") SubscriberVidResponse[] results, @JsonProperty("startedAt") OffsetDateTime startedAt, @JsonProperty("status") BatchResponseSubscriberVidResponseStatusEnum status) {
        this.completedAt = completedAt;
        this.results = results;
        this.startedAt = startedAt;
        this.status = status;
