...
class ListCallRecordingListCallRecordingResponse:
    ...
    recordings: Optional[list[shared_api_v2010_account_call_call_recording.APIV2010AccountCallCallRecording]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recordings'), 'exclude': lambda f: f is None }})  
