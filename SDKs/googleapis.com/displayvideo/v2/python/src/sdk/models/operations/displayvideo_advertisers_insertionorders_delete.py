...
@dataclasses.dataclass
class DisplayvideoAdvertisersInsertionOrdersDeleteQueryParams:
...
class DisplayvideoAdvertisersInsertionOrdersDeleteRequest:
    path_params: DisplayvideoAdvertisersInsertionOrdersDeletePathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersInsertionOrdersDeleteQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersInsertionOrdersDeleteSecurity = dataclasses.field()
