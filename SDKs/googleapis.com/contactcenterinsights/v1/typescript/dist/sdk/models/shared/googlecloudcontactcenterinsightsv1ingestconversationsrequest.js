...
var GoogleCloudContactcenterinsightsV1IngestConversationsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "conversationConfig" }),
        (0, class_transformer_1.Type)(function () {
            return googlecloudcontactcenterinsightsv1ingestconversationsrequestconversationconfig_1.GoogleCloudContactcenterinsightsV1IngestConversationsRequestConversationConfig;
        }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return googlecloudcontactcenterinsightsv1ingestconversationsrequestgcssource_1.GoogleCloudContactcenterinsightsV1IngestConversationsRequestGcsSource; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "transcriptObjectConfig" }),
        (0, class_transformer_1.Type)(function () {
            return googlecloudcontactcenterinsightsv1ingestconversationsrequesttranscriptobjectconfig_1.GoogleCloudContactcenterinsightsV1IngestConversationsRequestTranscriptObjectConfig;
        }),
