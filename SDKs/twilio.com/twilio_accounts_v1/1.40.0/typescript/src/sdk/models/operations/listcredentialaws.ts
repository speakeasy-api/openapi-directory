...
export class ListCredentialAwsListCredentialAwsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.AccountsV1CredentialCredentialAws })
  @Expose({ name: "credentials" })
  @Type(() => shared.AccountsV1CredentialCredentialAws)
  credentials?: shared.AccountsV1CredentialCredentialAws[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListCredentialAwsListCredentialAwsResponseMeta)
