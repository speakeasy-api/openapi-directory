...
from ..shared import licensevideoresult as shared_licensevideoresult
...
class LicenseVideoResultDataList:
    r"""List of video license results"""
    
    data: Optional[list[shared_licensevideoresult.LicenseVideoResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""License results"""  
