...
type AdsenseAccountsAdclientsAdunitsListSecurityOption1 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AdsenseAccountsAdclientsAdunitsListSecurityOption2 struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AdsenseAccountsAdclientsAdunitsListSecurity struct {
	Option1 *AdsenseAccountsAdclientsAdunitsListSecurityOption1 `security:"option"`
	Option2 *AdsenseAccountsAdclientsAdunitsListSecurityOption2 `security:"option"`
}

type AdsenseAccountsAdclientsAdunitsListPathParams struct {
	// Required. The ad client which owns the collection of ad units. Format: accounts/{account}/adclients/{adclient}
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type AdsenseAccountsAdclientsAdunitsListQueryParams struct {
	// V1 error format.
...
type AdsenseAccountsAdclientsAdunitsListRequest struct {
...
type AdsenseAccountsAdclientsAdunitsListResponse struct {
	ContentType string
	// Successful response
