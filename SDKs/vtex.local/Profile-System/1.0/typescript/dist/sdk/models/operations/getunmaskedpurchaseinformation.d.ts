...
export declare class GetUnmaskedPurchaseInformationRequest extends SpeakeasyBase {
    /**
...
export declare class GetUnmaskedPurchaseInformationResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * OK
     */
    getUnmaskedPurchaseInformation200ApplicationJSONObjects?: Record<string, any>[];
    statusCode: number;
