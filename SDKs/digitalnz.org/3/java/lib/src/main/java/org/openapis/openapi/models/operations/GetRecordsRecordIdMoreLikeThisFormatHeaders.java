...
public class GetRecordsRecordIdMoreLikeThisFormatHeaders {
    /**
    ...
    public GetRecordsRecordIdMoreLikeThisFormatHeaders withAuthenticationToken(String authenticationToken) {
