...
export class V1Tax {
  ...
  taxRatesByCountryCode(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.TaxRatesByCountryCodeResponse =
        new operations.TaxRatesByCountryCodeResponse({
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.taxRatesByCountryCode200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.TaxRatesByCountryCode200ApplicationJSON
              );
          }
          break;
        ...
        case httpRes?.status == 500:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.taxRatesByCountryCode500ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.TaxRatesByCountryCode500ApplicationJSON
              );
          }
          break;
      }
  ...
  taxRatesByIpAddress(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TaxRatesByIpAddressResponse =
        new operations.TaxRatesByIpAddressResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            ...
            res.taxRatesByIpAddress200ApplicationJSONObjects =
              utils.objectToClass(
                httpRes?.data,
                operations.TaxRatesByIpAddress200ApplicationJSON,
                resFieldDepth
              );
          }
          break;
        ...
        case httpRes?.status == 500:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.taxRatesByIpAddress500ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.TaxRatesByIpAddress500ApplicationJSON
              );
          }
          break;
      }
