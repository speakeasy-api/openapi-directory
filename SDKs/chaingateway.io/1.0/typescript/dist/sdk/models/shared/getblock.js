...
var GetBlock = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=difficulty" }),
        __metadata("design:type", String)
    ], GetBlock.prototype, "difficulty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gas_limit" }),
        __metadata("design:type", String)
    ], GetBlock.prototype, "gasLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gas_used" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=miner" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=parent_hash" }),
        __metadata("design:type", String)
    ], GetBlock.prototype, "parentHash", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=size_in_bytes" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=transactions_count" }),
        __metadata("design:type", String)
