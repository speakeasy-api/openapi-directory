...
exports.OAuth2PermissionGrantDeleteResponse = exports.OAuth2PermissionGrantDeleteRequest = void 0;
...
var OAuth2PermissionGrantDeleteRequest = /** @class */ (function (_super) {
    ...
    ], OAuth2PermissionGrantDeleteRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=objectId",
        }),
        __metadata("design:type", String)
    ], OAuth2PermissionGrantDeleteRequest.prototype, "objectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=tenantID",
        }),
        __metadata("design:type", String)
    ], OAuth2PermissionGrantDeleteRequest.prototype, "tenantID", void 0);
...
var OAuth2PermissionGrantDeleteResponse = /** @class */ (function (_super) {
    ...
    ], OAuth2PermissionGrantDeleteResponse.prototype, "rawResponse", void 0);
