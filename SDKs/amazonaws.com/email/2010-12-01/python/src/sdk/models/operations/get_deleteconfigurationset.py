...
class GetDeleteConfigurationSetQueryParams:
    action: GetDeleteConfigurationSetActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteConfigurationSetVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteConfigurationSetRequest:
    headers: GetDeleteConfigurationSetHeaders = dataclasses.field()
    query_params: GetDeleteConfigurationSetQueryParams = dataclasses.field()
