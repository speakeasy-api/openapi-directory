...
class Environments:
    ...
    def all_environments(self) -> operations.AllEnvironmentsResponse:
        ...
        res = operations.AllEnvironmentsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.AllEnvironments200ApplicationJSON])
                res.all_environments_200_application_json_object = out

        return res

    def create_environment(self, request: operations.CreateEnvironmentRequestBody) -> operations.CreateEnvironmentResponse:
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateEnvironment200ApplicationJSON])
                res.create_environment_200_application_json_object = out
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.CreateEnvironment400ApplicationJSON])
    ...
    def delete_environment(self, request: operations.DeleteEnvironmentRequest) -> operations.DeleteEnvironmentResponse:
        ...
        url = utils.generate_url(operations.DeleteEnvironmentRequest, base_url, '/environments/{environment_uid}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteEnvironment200ApplicationJSON])
                res.delete_environment_200_application_json_object = out
        elif http_res.status_code == 404:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.DeleteEnvironment404ApplicationJSON])
    ...
    def single_environment(self, request: operations.SingleEnvironmentRequest) -> operations.SingleEnvironmentResponse:
        ...
        url = utils.generate_url(operations.SingleEnvironmentRequest, base_url, '/environments/{environment_uid}', request)
        ...
        res = operations.SingleEnvironmentResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.SingleEnvironment200ApplicationJSON])
    ...
    def update_environment(self, request: operations.UpdateEnvironmentRequest) -> operations.UpdateEnvironmentResponse:
        ...
        url = utils.generate_url(operations.UpdateEnvironmentRequest, base_url, '/environments/{environment_uid}', request)
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateEnvironment200ApplicationJSON])
                res.update_environment_200_application_json_object = out
        elif http_res.status_code == 400:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.UpdateEnvironment400ApplicationJSON])
