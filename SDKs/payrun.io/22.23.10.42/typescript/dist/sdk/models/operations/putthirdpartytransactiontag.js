...
exports.PutThirdPartyTransactionTagResponse = exports.PutThirdPartyTransactionTagRequest = void 0;
...
var PutThirdPartyTransactionTagRequest = /** @class */ (function (_super) {
    ...
    ], PutThirdPartyTransactionTagRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], PutThirdPartyTransactionTagRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], PutThirdPartyTransactionTagRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], PutThirdPartyTransactionTagRequest.prototype, "tagId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ThirdPartyTransactionId",
        }),
        __metadata("design:type", String)
    ], PutThirdPartyTransactionTagRequest.prototype, "thirdPartyTransactionId", void 0);
    return PutThirdPartyTransactionTagRequest;
}(utils_1.SpeakeasyBase));
exports.PutThirdPartyTransactionTagRequest = PutThirdPartyTransactionTagRequest;
var PutThirdPartyTransactionTagResponse = /** @class */ (function (_super) {
    ...
    ], PutThirdPartyTransactionTagResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.PutThirdPartyTransactionTagResponse = PutThirdPartyTransactionTagResponse;
