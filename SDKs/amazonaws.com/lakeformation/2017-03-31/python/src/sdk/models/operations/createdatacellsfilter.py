...
class CreateDataCellsFilterRequestBodyTableData:
...
class CreateDataCellsFilterRequestBody:
    ...
    table_data: CreateDataCellsFilterRequestBodyTableData = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TableData') }})
    r"""A structure that describes certain columns on certain rows."""  
...
class CreateDataCellsFilterRequest:
    ...
    request_body: CreateDataCellsFilterRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CreateDataCellsFilterResponse:
    ...
    create_data_cells_filter_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
