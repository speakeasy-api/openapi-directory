 ...
 */
public enum GetIpamAddressHistoryResultHistoryRecordsResourceOverlapStatusEnum {
    ...
    private GetIpamAddressHistoryResultHistoryRecordsResourceOverlapStatusEnum(String value) {
        this.value = value;
    }
}
