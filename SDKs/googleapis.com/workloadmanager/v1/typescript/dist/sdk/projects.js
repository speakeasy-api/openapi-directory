...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.workloadmanagerProjectsLocationsEvaluationsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WorkloadmanagerProjectsLocationsEvaluationsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/evaluations", req.pathParams);
    ...
    **/
    Projects.prototype.workloadmanagerProjectsLocationsEvaluationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listEvaluationsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.workloadmanagerProjectsLocationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workloadmanagerProjectsLocationsOperationsCancel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workloadmanagerProjectsLocationsOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workloadmanagerProjectsLocationsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.workloadmanagerProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
