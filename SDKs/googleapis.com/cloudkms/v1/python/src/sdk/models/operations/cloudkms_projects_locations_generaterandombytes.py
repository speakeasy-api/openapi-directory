...
class CloudkmsProjectsLocationsGenerateRandomBytesRequest:
    ...
    r"""The project-specific location in which to generate random bytes. For example, \\"projects/my-project/locations/us-central1\\"."""  
    ...
    generate_random_bytes_request: Optional[shared_generaterandombytesrequest.GenerateRandomBytesRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
