...
from ..shared import containersquotainfo as shared_containersquotainfo
...
class GetContainersQuotaResponse:
    ...
    containers_quota_info: Optional[shared_containersquotainfo.ContainersQuotaInfo] = dataclasses.field(default=None)
