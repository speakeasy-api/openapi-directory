...
public class GetPlacementGroupsIdPlacementGroupResponse {
    ...
    public GetPlacementGroupsIdPlacementGroupResponse(@JsonProperty("placement_group") GetPlacementGroupsIdPlacementGroupResponsePlacementGroup placementGroup) {
        this.placementGroup = placementGroup;
  }
}
