...
public class FxSummaryV3 {
    ...
    public FxSummaryV3(@JsonProperty("creationDateTime") OffsetDateTime creationDateTime, @JsonProperty("fundingStatus") String fundingStatus, @JsonProperty("invertedRate") Float invertedRate, @JsonProperty("quoteId") String quoteId, @JsonProperty("rate") Float rate, @JsonProperty("status") String status, @JsonProperty("totalCost") Long totalCost, @JsonProperty("totalPaymentAmount") Long totalPaymentAmount) {
        this.creationDateTime = creationDateTime;
        this.fundingStatus = fundingStatus;
        this.invertedRate = invertedRate;
        this.quoteId = quoteId;
