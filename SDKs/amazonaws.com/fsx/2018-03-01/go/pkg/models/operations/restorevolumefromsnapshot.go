...
type RestoreVolumeFromSnapshotHeaders struct {
...
type RestoreVolumeFromSnapshotRequest struct {
	Headers RestoreVolumeFromSnapshotHeaders
	Request shared.RestoreVolumeFromSnapshotRequest `request:"mediaType=application/json"`
}
