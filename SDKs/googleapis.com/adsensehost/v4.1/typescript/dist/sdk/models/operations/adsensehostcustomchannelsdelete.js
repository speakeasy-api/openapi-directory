...
exports.AdsensehostCustomchannelsDeleteResponse = exports.AdsensehostCustomchannelsDeleteRequest = exports.AdsensehostCustomchannelsDeleteSecurity = void 0;
...
var AdsensehostCustomchannelsDeleteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "adClientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=customChannelId",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "customChannelId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsensehostCustomchannelsDeleteRequest.prototype, "userIp", void 0);
...
var AdsensehostCustomchannelsDeleteResponse = /** @class */ (function (_super) {
    ...
    ], AdsensehostCustomchannelsDeleteResponse.prototype, "rawResponse", void 0);
