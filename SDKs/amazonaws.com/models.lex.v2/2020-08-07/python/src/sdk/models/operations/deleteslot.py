...
class DeleteSlotRequest:
    ...
    r"""The identifier of the bot associated with the slot to delete."""  
    bot_version: str = dataclasses.field(metadata={'path_param': { 'field_name': 'botVersion', 'style': 'simple', 'explode': False }})
    r"""The version of the bot associated with the slot to delete."""  
    intent_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'intentId', 'style': 'simple', 'explode': False }})
    r"""The identifier of the intent associated with the slot."""  
    locale_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'localeId', 'style': 'simple', 'explode': False }})
    r"""The identifier of the language and locale that the slot will be deleted from. The string must match one of the supported locales. For more information, see <a href=\\"https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html\\">Supported languages</a>."""  
    slot_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'slotId', 'style': 'simple', 'explode': False }})
    r"""The identifier of the slot to delete."""  
