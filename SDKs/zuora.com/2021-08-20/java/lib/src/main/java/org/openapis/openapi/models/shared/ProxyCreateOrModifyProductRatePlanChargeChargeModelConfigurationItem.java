...
public class ProxyCreateOrModifyProductRatePlanChargeChargeModelConfigurationItem {
    /**
    ...
    @JsonProperty("Key")
    public String key;
    public ProxyCreateOrModifyProductRatePlanChargeChargeModelConfigurationItem withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    @JsonProperty("Value")
    public String value;
    public ProxyCreateOrModifyProductRatePlanChargeChargeModelConfigurationItem withValue(String value) {
        this.value = value;
        return this;
    }
