 ...
 *
 */
export enum ProxyCreateAccountCustomerTypeNSEnum {
  Company = "Company",
 ...
 *
 */
export enum ProxyCreateAccountStatusEnum {
  Draft = "Draft",
  Active = "Active",
  Canceled = "Canceled",
}
 ...
 *
 */
export enum ProxyCreateAccountSynctoNetSuiteNSEnum {
  Yes = "Yes",
  No = "No",
}
 ...
 *
 */
export class ProxyCreateAccount extends SpeakeasyBase {
  /**
  ...
  customerTypeNS?: ProxyCreateAccountCustomerTypeNSEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "Status" })
  status: ProxyCreateAccountStatusEnum;
  ...
  synctoNetSuiteNS?: ProxyCreateAccountSynctoNetSuiteNSEnum;
