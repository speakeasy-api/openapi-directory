...
class MergePullRequestBySquashRequest:
    headers: MergePullRequestBySquashHeaders = dataclasses.field()
    request: shared_mergepullrequestbysquashinput.MergePullRequestBySquashInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
