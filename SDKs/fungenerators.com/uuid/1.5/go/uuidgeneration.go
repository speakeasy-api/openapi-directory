...
func NewUUIDGeneration(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *UUIDGeneration {
...
func (s *UUIDGeneration) GetUUIDVersionVersion(ctx context.Context, request operations.GetUUIDVersionVersionRequest) (*operations.GetUUIDVersionVersionResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/uuid/version/{version}", request.PathParams)
	...
	res := &operations.GetUUIDVersionVersionResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
