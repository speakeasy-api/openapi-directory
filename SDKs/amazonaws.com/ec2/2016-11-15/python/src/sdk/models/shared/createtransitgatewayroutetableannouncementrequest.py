...
class CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
@dataclasses.dataclass
class CreateTransitGatewayRouteTableAnnouncementRequestTagSpecifications:
    ...
    resource_type: Optional[CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateTransitGatewayRouteTableAnnouncementRequest:
    
    peering_attachment_id: str = dataclasses.field()  
    transit_gateway_route_table_id: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateTransitGatewayRouteTableAnnouncementRequestTagSpecifications]] = dataclasses.field(default=None)  
