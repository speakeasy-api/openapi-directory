...
class IdentitytoolkitRelyingpartyVerifyAssertionRequest:
    ...
    identitytoolkit_relyingparty_verify_assertion_request: Optional[shared_identitytoolkitrelyingpartyverifyassertionrequest.IdentitytoolkitRelyingpartyVerifyAssertionRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
