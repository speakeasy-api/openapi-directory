...
class DocumentClassifierProperties:
    ...
    classifier_metadata: Optional[shared_classifiermetadata.ClassifierMetadata] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ClassifierMetadata') }})
    ...
    input_data_config: Optional[shared_documentclassifierinputdataconfig.DocumentClassifierInputDataConfig] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('InputDataConfig') }})
