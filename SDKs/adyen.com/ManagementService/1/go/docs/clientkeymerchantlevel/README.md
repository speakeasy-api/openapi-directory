...
func main() {
    ...
    res, err := s.ClientKeyMerchantLevel.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKey(ctx, operations.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKeyRequest{
        APICredentialID: "dolor",
        MerchantID: "necessitatibus",
    }, operations.PostMerchantsMerchantIDAPICredentialsAPICredentialIDGenerateClientKeySecurity{
