...
from ..shared import enterprisecrmfrontendseventbusprotoeventexecutionsnapshot as shared_enterprisecrmfrontendseventbusprotoeventexecutionsnapshot
...
class EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum(str, Enum):
    r"""The execution state of this event."""
...
class EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails:
    ...
    event_execution_snapshot: Optional[list[shared_enterprisecrmfrontendseventbusprotoeventexecutionsnapshot.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventExecutionSnapshot'), 'exclude': lambda f: f is None }})
    r"""After snapshot migration, this field will no longer be populated, but old execution snapshots will still be accessible."""  
    event_execution_state: Optional[EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('eventExecutionState'), 'exclude': lambda f: f is None }})
    r"""The execution state of this event."""  
