...
class OptimiseAllRequest:
    path_params: OptimiseAllPathParams = dataclasses.field()
    request: shared_optimiseallrequest.OptimiseAllRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
