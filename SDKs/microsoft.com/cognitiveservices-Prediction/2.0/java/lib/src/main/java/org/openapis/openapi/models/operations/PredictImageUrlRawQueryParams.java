...
public class PredictImageUrlRawQueryParams {
    /**
     * Optional. Specifies the name of application using the endpoint
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=application")
    public String application;
    public PredictImageUrlRawQueryParams withApplication(String application) {
    ...
    public PredictImageUrlRawQueryParams withIterationId(String iterationId) {
