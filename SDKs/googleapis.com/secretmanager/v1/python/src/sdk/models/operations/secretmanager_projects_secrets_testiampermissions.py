...
@dataclasses.dataclass
class SecretmanagerProjectsSecretsTestIamPermissionsQueryParams:
...
class SecretmanagerProjectsSecretsTestIamPermissionsRequest:
    path_params: SecretmanagerProjectsSecretsTestIamPermissionsPathParams = dataclasses.field()
    query_params: SecretmanagerProjectsSecretsTestIamPermissionsQueryParams = dataclasses.field()
    security: SecretmanagerProjectsSecretsTestIamPermissionsSecurity = dataclasses.field()
