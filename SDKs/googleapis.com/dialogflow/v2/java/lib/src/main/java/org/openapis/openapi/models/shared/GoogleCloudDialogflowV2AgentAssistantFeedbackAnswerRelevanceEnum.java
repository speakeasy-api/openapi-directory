 ...
 */
public enum GoogleCloudDialogflowV2AgentAssistantFeedbackAnswerRelevanceEnum {
    ...
    private GoogleCloudDialogflowV2AgentAssistantFeedbackAnswerRelevanceEnum(String value) {
        this.value = value;
    }
}
