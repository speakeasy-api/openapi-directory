...
class POSTDMTaxationItemsRequest:
    ...
    post_taxation_item_list_for_dm_type: shared_posttaxationitemlistfordmtype.POSTTaxationItemListForDMType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
