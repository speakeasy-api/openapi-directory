...
public class DeleteSipAuthRegistrationsCredentialListMappingRequest {
    ...
    public DeleteSipAuthRegistrationsCredentialListMappingRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("DomainSid") String domainSid, @JsonProperty("Sid") String sid) {
        this.accountSid = accountSid;
        this.domainSid = domainSid;
        this.sid = sid;
  }
