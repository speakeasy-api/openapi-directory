...
class KeywordLeasePage:
    ...
    items: Optional[list[shared_keywordlease.KeywordLease]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('items'), 'exclude': lambda f: f is None }})  
