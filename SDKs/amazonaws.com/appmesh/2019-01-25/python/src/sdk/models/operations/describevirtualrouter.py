...
from ..shared import describevirtualrouteroutput as shared_describevirtualrouteroutput
...
@dataclasses.dataclass
class DescribeVirtualRouterQueryParams:
...
class DescribeVirtualRouterRequest:
    headers: DescribeVirtualRouterHeaders = dataclasses.field()
    path_params: DescribeVirtualRouterPathParams = dataclasses.field()
    query_params: DescribeVirtualRouterQueryParams = dataclasses.field()
...
class DescribeVirtualRouterResponse:
    ...
    describe_virtual_router_output: Optional[shared_describevirtualrouteroutput.DescribeVirtualRouterOutput] = dataclasses.field(default=None)
