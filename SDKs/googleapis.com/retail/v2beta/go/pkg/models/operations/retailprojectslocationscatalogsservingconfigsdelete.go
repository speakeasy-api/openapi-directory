...
type RetailProjectsLocationsCatalogsServingConfigsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type RetailProjectsLocationsCatalogsServingConfigsDeletePathParams struct {
...
type RetailProjectsLocationsCatalogsServingConfigsDeleteQueryParams struct {
	// V1 error format.
...
type RetailProjectsLocationsCatalogsServingConfigsDeleteRequest struct {
...
type RetailProjectsLocationsCatalogsServingConfigsDeleteResponse struct {
	ContentType string
	// Successful response
