...
from ..shared import modifyresponse as shared_modifyresponse
...
@dataclasses.dataclass
class PostConfirmThirdPartyResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    modify_response: Optional[shared_modifyresponse.ModifyResponse] = dataclasses.field(default=None)
