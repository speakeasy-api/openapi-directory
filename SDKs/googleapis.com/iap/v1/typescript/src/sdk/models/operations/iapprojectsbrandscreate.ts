...
export class IapProjectsBrandsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IapProjectsBrandsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IapProjectsBrandsCreateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
