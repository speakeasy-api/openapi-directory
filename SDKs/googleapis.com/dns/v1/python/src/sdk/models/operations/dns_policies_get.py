...
class DNSPoliciesGetSecurity:
    option1: Optional[DNSPoliciesGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSPoliciesGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DNSPoliciesGetSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DNSPoliciesGetSecurityOption4] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class DNSPoliciesGetRequest:
    path_params: DNSPoliciesGetPathParams = dataclasses.field()
    query_params: DNSPoliciesGetQueryParams = dataclasses.field()
    security: DNSPoliciesGetSecurity = dataclasses.field()
