...
use \OpenAPI\OpenAPI\Models\Shared\CreateReportTask;
use \OpenAPI\OpenAPI\Models\Shared\Dimension;
use \OpenAPI\OpenAPI\Models\Shared\InventoryReference;
use \OpenAPI\OpenAPI\Models\Operations\CreateReportTaskSecurity;
...
try {
    ...
    $request->dateFrom = 'explicabo';
    $request->dateTo = 'nobis';
    $request->dimensions = [
        new Dimension(),
        new Dimension(),
    ];
    $request->fundingModels = [
        'nemo',
        'minima',
        'excepturi',
    ];
    $request->inventoryReferences = [
    ...
    $request->marketplaceId = 'sapiente';
    $request->metricKeys = [
        'mollitia',
    ];
    $request->reportFormat = 'dolorem';
    $request->reportType = 'culpa';

    $requestSecurity = new CreateReportTaskSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->adReportTask->createReportTask($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\DeleteReportTaskRequest;
use \OpenAPI\OpenAPI\Models\Operations\DeleteReportTaskSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new DeleteReportTaskRequest();
    $request->reportTaskId = 'consequuntur';

    $requestSecurity = new DeleteReportTaskSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->adReportTask->deleteReportTask($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\GetReportTaskRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetReportTaskSecurity;
...
try {
    ...
    $request->reportTaskId = 'repellat';

    $requestSecurity = new GetReportTaskSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->adReportTask->getReportTask($request, $requestSecurity);

    if ($response->reportTask !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\GetReportTasksRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetReportTasksSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetReportTasksRequest();
    $request->limit = 'mollitia';
    $request->offset = 'occaecati';
    $request->reportTaskStatuses = 'numquam';

    $requestSecurity = new GetReportTasksSecurity();
    $requestSecurity->apiAuth = 'Bearer YOUR_ACCESS_TOKEN_HERE';

    $response = $sdk->adReportTask->getReportTasks($request, $requestSecurity);

    if ($response->reportTaskPagedCollection !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
