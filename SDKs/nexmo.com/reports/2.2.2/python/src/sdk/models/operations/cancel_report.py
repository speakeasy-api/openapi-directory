...
class CancelReportRequest:
    path_params: CancelReportPathParams = dataclasses.field()
    security: CancelReportSecurity = dataclasses.field()
...
class CancelReportResponse:
    ...
    cancel_report_401_application_json_any: Optional[Any] = dataclasses.field(default=None)
    cancel_report_404_application_json_any: Optional[Any] = dataclasses.field(default=None)
    cancel_report_409_application_json_any: Optional[Any] = dataclasses.field(default=None)
