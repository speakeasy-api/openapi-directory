...
from ..shared import tiering as shared_tiering
...
class PricingRuleListElement:
    r"""A representation of a pricing rule."""
    ...
    tiering: Optional[shared_tiering.Tiering] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Tiering'), 'exclude': lambda f: f is None }})  
