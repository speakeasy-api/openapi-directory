...
from ..shared import getemployeepayrollsresponse as shared_getemployeepayrollsresponse
...
from ..shared import payrollsfilter as shared_payrollsfilter
...
class EmployeePayrollsAllRequest:
    ...
    filter: Optional[shared_payrollsfilter.PayrollsFilter] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    r"""Apply filters"""  
...
class EmployeePayrollsAllResponse:
    ...
    r"""Bad Request"""  
    get_employee_payrolls_response: Optional[shared_getemployeepayrollsresponse.GetEmployeePayrollsResponse] = dataclasses.field(default=None)
    r"""EmployeePayrolls"""  
