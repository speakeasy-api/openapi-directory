...
export class DeleteUsersIdUserConnectionsIdConnectionAccountsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DeleteUsersIdUserConnectionsIdConnectionAccountsResponse extends SpeakeasyBase {
  /**
