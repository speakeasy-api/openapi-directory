 ...
 */
export declare class DescribeClientVpnEndpointsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeClientVpnEndpointsRequest extends SpeakeasyBase {
