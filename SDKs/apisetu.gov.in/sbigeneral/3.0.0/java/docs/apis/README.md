    ...
    public static void main(String[] args) {
        try {
            ...
            CripcRequestBody req = new CripcRequestBody(CripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CripcRequestBodyCertificateParameters("0000001234567890-001", "For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.");;
    ...
    public static void main(String[] args) {
        try {
            ...
            CvipcRequestBody req = new CvipcRequestBody(CvipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new CvipcRequestBodyCertificateParameters("0000001234567890-001", "For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.");;
    ...
    public static void main(String[] args) {
        try {
            ...
            HlipcRequestBody req = new HlipcRequestBody(HlipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new HlipcRequestBodyCertificateParameters("0000001234567890-001", "For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.");;
    ...
    public static void main(String[] args) {
        try {
            ...
            TripcRequestBody req = new TripcRequestBody(TripcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TripcRequestBodyCertificateParameters("0000001234567890-001", "For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.");;
            ...
            TripcResponse res = sdk.apIs.tripc(req, new TripcSecurity("culpa", "doloribus") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
    ...
    public static void main(String[] args) {
        try {
            ...
            TwipcRequestBody req = new TwipcRequestBody(TwipcRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new TwipcRequestBodyCertificateParameters("0000001234567890-001", "For Motor- Enter Last 5 Digits of Engine/Chasis No. Or Full RegNo - For Others- Enter Mobile No.");;
            ...
            TwipcResponse res = sdk.apIs.twipc(req, new TwipcSecurity("animi", "enim") {{
                apiKey = "YOUR_API_KEY_HERE";
                clientId = "YOUR_API_KEY_HERE";
            }});
