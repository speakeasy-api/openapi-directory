...
var CodeCoverage = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "branchCoveragePercentage" }),
        __metadata("design:type", Number)
    ], CodeCoverage.prototype, "branchCoveragePercentage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "branchesCovered" }),
        __metadata("design:type", Number)
    ], CodeCoverage.prototype, "branchesCovered", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "branchesMissed" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "lineCoveragePercentage" }),
        __metadata("design:type", Number)
    ], CodeCoverage.prototype, "lineCoveragePercentage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "linesCovered" }),
        __metadata("design:type", Number)
    ], CodeCoverage.prototype, "linesCovered", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "linesMissed" }),
        __metadata("design:type", Number)
    ], CodeCoverage.prototype, "linesMissed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "reportARN" }),
        __metadata("design:type", String)
