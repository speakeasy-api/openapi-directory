...
export class PivotTable extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: PivotGroup })
  @Expose({ name: "columns" })
  @Type(() => PivotGroup)
  columns?: PivotGroup[];
   ...
   */
  @SpeakeasyMetadata({ elemType: PivotFilterCriteria })
  @Expose({ name: "criteria" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, PivotFilterCriteria> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], PivotFilterCriteria);
      }
      return obj;
    },
    { toClassOnly: true }
   ...
   */
  @SpeakeasyMetadata({ elemType: PivotFilterSpec })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "valueLayout" })
  valueLayout?: PivotTableValueLayoutEnum;

  /**
   * A list of values to include in the pivot table.
   */
  @SpeakeasyMetadata({ elemType: PivotValue })
  @Expose({ name: "values" })
  @Type(() => PivotValue)
  values?: PivotValue[];
}
