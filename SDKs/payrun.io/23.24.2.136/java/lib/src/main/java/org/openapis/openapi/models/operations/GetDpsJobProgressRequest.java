...
public class GetDpsJobProgressRequest {
    ...
    public GetDpsJobProgressRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("JobId") String jobId) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.jobId = jobId;
  }
