...
class OrderRampIntervalMetrics:
    ...
    interval_delta_metrics: Optional[list[shared_rampintervalchargedeltametrics.RampIntervalChargeDeltaMetrics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('intervalDeltaMetrics'), 'exclude': lambda f: f is None }})
    r"""Container for the delta metrics for each rate plan charge in each ramp interval. The delta is the difference of the subscription metrics between before and after the order."""  
