...
from ..shared import userdetailsexpandvo as shared_userdetailsexpandvo
...
class GetContactUserInfoResponse:
    ...
    user_details_expand_vo: Optional[shared_userdetailsexpandvo.UserDetailsExpandVO] = dataclasses.field(default=None)
