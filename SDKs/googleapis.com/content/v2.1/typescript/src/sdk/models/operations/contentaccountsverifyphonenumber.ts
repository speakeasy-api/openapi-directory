...
export class ContentAccountsVerifyphonenumberSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccountsVerifyphonenumberRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccountsVerifyphonenumberResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
