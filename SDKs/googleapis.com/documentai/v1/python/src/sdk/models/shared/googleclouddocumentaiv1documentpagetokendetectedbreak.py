...
class GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak:
    ...
    type: Optional[GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreakTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Detected break type."""  
