...
public class PutPermissionResponse {
    ...
    public PutPermissionResponse withErrorModel(openapisdk.models.shared.ErrorModel errorModel) {
        this.errorModel = errorModel;
        return this;
    }
    public openapisdk.models.shared.Permission permission;
    public PutPermissionResponse withPermission(openapisdk.models.shared.Permission permission) {
