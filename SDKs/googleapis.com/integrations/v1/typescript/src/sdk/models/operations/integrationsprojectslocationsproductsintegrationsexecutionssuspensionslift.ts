...
export class IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsLiftSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsLiftRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsExecutionsSuspensionsLiftResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
