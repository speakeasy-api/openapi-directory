...
export class Orders {
   ...
   */
  addLog(
    req: operations.AddLogRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.AddLogResponse> {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AddLogResponse = new operations.AddLogResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.cancelOrder200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.CancelOrder200ApplicationJSON
            );
          }
          break;
  ...
  getOrder(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getOrder200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetOrder200ApplicationJSON
            );
          }
          break;
      }
...
This endpoint returns only orders that already have been indexed, which takes approximately four minutes. Because of this, the data retrieved may present inconsistencies. To get live up-to-date information and [build order integrations](https://developers.vtex.com/vtex-rest-api/docs/erp-integration-set-up-order-integration) use the [orders Feed or hook](https://developers.vtex.com/docs/guides/orders-feed).
  ...
  listOrders(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/api/oms/pvt/orders";
...
> The `Change order` resource is needed to use this API request. This is included in `OMS - Full access` and `IntegrationProfile - Fulfillment Oms`, among other default roles available in the Admin. Learn more about the [License manager roles and resources](https://help.vtex.com/en/tutorial/roles--7HKK5Uau2H6wxE1rH5oRbc#).
   */
  registerChange(
    req: operations.RegisterChangeRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.RegisterChangeResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RegisterChangeResponse =
        new operations.RegisterChangeResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.registerChange = utils.objectToClass(
              httpRes?.data,
              shared.RegisterChange
            );
          }
          break;
      }
...
> The `Change order workflow status` resource is needed to use this API request. This is included in `OMS - Full access` and `IntegrationProfile - Fulfillment Oms`, among other default roles available in the Admin. Learn more about the [License manager roles and resources](https://help.vtex.com/en/tutorial/roles--7HKK5Uau2H6wxE1rH5oRbc#).
   */
  startHandling(
    req: operations.StartHandlingRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.StartHandlingResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.StartHandlingResponse =
        new operations.StartHandlingResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        ...
        case httpRes?.status == 401:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.startHandling401ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.StartHandling401ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 409:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.startHandling409ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.StartHandling409ApplicationJSON
            );
          }
          break;
      }
