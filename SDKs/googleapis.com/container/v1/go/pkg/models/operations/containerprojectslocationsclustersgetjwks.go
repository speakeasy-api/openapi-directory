...
type ContainerProjectsLocationsClustersGetJwksPathParams struct {
...
type ContainerProjectsLocationsClustersGetJwksQueryParams struct {
	// V1 error format.
...
type ContainerProjectsLocationsClustersGetJwksRequest struct {
...
type ContainerProjectsLocationsClustersGetJwksResponse struct {
	ContentType string
	// Successful response
