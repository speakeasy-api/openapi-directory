...
class IntegrationResponseContentHandlingStrategyEnum(str, Enum):
...
class IntegrationResponse:
    r"""Represents an integration response."""
    ...
    content_handling_strategy: Optional[IntegrationResponseContentHandlingStrategyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ContentHandlingStrategy'), 'exclude': lambda f: f is None }})  
