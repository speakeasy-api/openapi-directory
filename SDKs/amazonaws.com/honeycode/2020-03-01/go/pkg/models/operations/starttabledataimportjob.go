...
func (e StartTableDataImportJobRequestBodyDataFormatEnum) ToPointer() *StartTableDataImportJobRequestBodyDataFormatEnum {
	return &e
}
...
func (e *StartTableDataImportJobRequestBodyDataFormatEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "DELIMITED_TEXT":
		*e = StartTableDataImportJobRequestBodyDataFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StartTableDataImportJobRequestBodyDataFormatEnum: %v", v)
	}
}
