...
class Reactions:
    ...
    def reactions_list_for_release(self, request: operations.ReactionsListForReleaseRequest) -> operations.ReactionsListForReleaseResponse:
        ...
        if http_res.status_code == 200:
            ...
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[operations.ReactionsListForRelease415ApplicationJSON])
                res.reactions_list_for_release_415_application_json_object = out
