...
**/
var TrackingInfo = /** @class */ (function (_super) {
    __extends(TrackingInfo, _super);
    ...
    ], TrackingInfo.prototype, "shipmentTrackingNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=shippingCarrierCode" }),
        __metadata("design:type", String)
    ], TrackingInfo.prototype, "shippingCarrierCode", void 0);
    return TrackingInfo;
