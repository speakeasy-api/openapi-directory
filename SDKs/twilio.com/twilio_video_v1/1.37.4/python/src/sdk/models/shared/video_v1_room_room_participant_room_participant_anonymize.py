...
class VideoV1RoomRoomParticipantRoomParticipantAnonymize:
    ...
    status: Optional[shared_room_participant_anonymize_enum_status_enum.RoomParticipantAnonymizeEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
