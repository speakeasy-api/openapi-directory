...
class AutomlProjectsLocationsModelsBatchPredictRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\BatchPredictRequest $batchPredictRequest = null;
