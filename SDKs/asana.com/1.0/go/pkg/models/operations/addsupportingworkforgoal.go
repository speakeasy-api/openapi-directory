...
// AddSupportingWorkForGoalRequestBody - The project/portfolio to set as supporting work
...
type AddSupportingWorkForGoalRequest struct {
	...
	// The project/portfolio to set as supporting work
	Request AddSupportingWorkForGoalRequestBody `request:"mediaType=application/json"`
}

// AddSupportingWorkForGoal200ApplicationJSON - Successfully set specified project/portfolio as supporting work on the given goal.
...
type AddSupportingWorkForGoalResponse struct {
	...
	// Successfully set specified project/portfolio as supporting work on the given goal.
