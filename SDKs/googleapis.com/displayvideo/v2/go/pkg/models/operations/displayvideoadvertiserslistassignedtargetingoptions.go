...
type DisplayvideoAdvertisersListAssignedTargetingOptionsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoAdvertisersListAssignedTargetingOptionsPathParams struct {
	// Required. The ID of the advertiser the line item belongs to.
	AdvertiserID string `pathParam:"style=simple,explode=false,name=advertiserId"`
}

type DisplayvideoAdvertisersListAssignedTargetingOptionsQueryParams struct {
	// V1 error format.
...
type DisplayvideoAdvertisersListAssignedTargetingOptionsRequest struct {
...
type DisplayvideoAdvertisersListAssignedTargetingOptionsResponse struct {
	// Successful response
