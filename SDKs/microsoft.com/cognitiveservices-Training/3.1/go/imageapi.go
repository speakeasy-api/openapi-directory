...
func (s *ImageAPI) QuerySuggestedImageCount(ctx context.Context, request operations.QuerySuggestedImageCountRequest) (*operations.QuerySuggestedImageCountResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/projects/{projectId}/images/suggested/count", request.PathParams)
	...
	res := &operations.QuerySuggestedImageCountResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *ImageAPI) QuerySuggestedImages(ctx context.Context, request operations.QuerySuggestedImagesRequest) (*operations.QuerySuggestedImagesResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/projects/{projectId}/images/suggested", request.PathParams)
	...
	res := &operations.QuerySuggestedImagesResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.SuggestedTagAndRegionQuery
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
