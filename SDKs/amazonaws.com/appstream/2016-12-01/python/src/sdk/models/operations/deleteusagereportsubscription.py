...
class DeleteUsageReportSubscriptionHeaders:
    x_amz_target: DeleteUsageReportSubscriptionXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteUsageReportSubscriptionRequest:
    headers: DeleteUsageReportSubscriptionHeaders = dataclasses.field()
...
class DeleteUsageReportSubscriptionResponse:
    ...
    delete_usage_report_subscription_result: Optional[dict[str, Any]] = dataclasses.field(default=None)
