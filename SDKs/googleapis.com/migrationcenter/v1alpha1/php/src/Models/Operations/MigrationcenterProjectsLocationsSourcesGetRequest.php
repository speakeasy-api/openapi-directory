...
class MigrationcenterProjectsLocationsSourcesGetRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MigrationcenterProjectsLocationsSourcesGetViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?MigrationcenterProjectsLocationsSourcesGetViewEnum $view = null;
