...
func (e CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum) ToPointer() *CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum {
	return &e
}
...
func (e *CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateSiprecCreateSiprecRequestStatusCallbackMethodEnum: %v", v)
	}
}
