...
from ..shared import proxygetcontact as shared_proxygetcontact
...
class ObjectGETContactResponse:
    ...
    proxy_get_contact: Optional[shared_proxygetcontact.ProxyGetContact] = dataclasses.field(default=None)  
