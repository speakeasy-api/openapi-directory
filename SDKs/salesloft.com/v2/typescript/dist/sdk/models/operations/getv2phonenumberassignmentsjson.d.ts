...
export declare class GetV2PhoneNumberAssignmentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class GetV2PhoneNumberAssignmentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
