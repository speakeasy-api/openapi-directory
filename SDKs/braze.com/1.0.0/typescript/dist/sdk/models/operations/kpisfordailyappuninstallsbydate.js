...
exports.KpIsForDailyAppUninstallsByDateResponse = exports.KpIsForDailyAppUninstallsByDateRequest = void 0;
...
var KpIsForDailyAppUninstallsByDateRequest = /** @class */ (function (_super) {
    ...
    ], KpIsForDailyAppUninstallsByDateRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ending_at",
        }),
        __metadata("design:type", String)
    ], KpIsForDailyAppUninstallsByDateRequest.prototype, "endingAt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=length",
        }),
        __metadata("design:type", String)
    ], KpIsForDailyAppUninstallsByDateRequest.prototype, "length", void 0);
...
var KpIsForDailyAppUninstallsByDateResponse = /** @class */ (function (_super) {
    ...
    ], KpIsForDailyAppUninstallsByDateResponse.prototype, "rawResponse", void 0);
