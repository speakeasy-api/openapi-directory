...
from ..shared import hrisjobs as shared_hrisjobs


@dataclass_json
@dataclasses.dataclass
class GetHrisJobsResponse:
    data: shared_hrisjobs.HrisJobs = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
