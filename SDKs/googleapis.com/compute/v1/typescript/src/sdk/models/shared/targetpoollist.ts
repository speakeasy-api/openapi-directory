 ...
 */
export enum TargetPoolListWarningCodeEnum {
...
export class TargetPoolListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetPoolListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetPoolListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class TargetPoolList extends SpeakeasyBase {
  /**
