...
class PeopleOtherContactsSearchQueryParams:
...
class PeopleOtherContactsSearchRequest:
    query_params: PeopleOtherContactsSearchQueryParams = dataclasses.field()
    security: PeopleOtherContactsSearchSecurity = dataclasses.field()
