...
exports.PostContainersNameOrIdStartResponse = exports.PostContainersNameOrIdStartRequest = void 0;
...
var PostContainersNameOrIdStartRequest = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdStartRequest.prototype, "xAuthProjectId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Auth-Token",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdStartRequest.prototype, "xAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=name_or_id",
        }),
        __metadata("design:type", String)
    ], PostContainersNameOrIdStartRequest.prototype, "nameOrId", void 0);
...
var PostContainersNameOrIdStartResponse = /** @class */ (function (_super) {
    ...
    ], PostContainersNameOrIdStartResponse.prototype, "rawResponse", void 0);
