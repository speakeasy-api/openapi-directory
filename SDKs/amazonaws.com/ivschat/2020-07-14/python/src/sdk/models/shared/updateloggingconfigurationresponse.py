...
from ..shared import updateloggingconfigurationstate_enum as shared_updateloggingconfigurationstate_enum
...
class UpdateLoggingConfigurationResponse:
    ...
    state: Optional[shared_updateloggingconfigurationstate_enum.UpdateLoggingConfigurationStateEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state'), 'exclude': lambda f: f is None }})  
