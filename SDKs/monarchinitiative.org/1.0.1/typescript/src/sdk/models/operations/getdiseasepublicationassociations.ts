...
export class GetDiseasePublicationAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetDiseasePublicationAssociationsQueryParams extends SpeakeasyBase {
...
export class GetDiseasePublicationAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetDiseasePublicationAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
