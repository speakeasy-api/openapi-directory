...
try {
    ...
    $request->requestBody->permission = 'odit';
    $request->owner = 'deleniti';
    $request->repo = 'enim';
    $request->username = 'Jabari72';
...
try {
    ...
    $request->basehead = 'iusto';
    $request->owner = 'quas';
    $request->page = 91728;
    $request->perPage = 704948;
    $request->repo = 'amet';
...
try {
    ...
    $request->requestBody->keyPrefix = 'autem';
    $request->requestBody->urlTemplate = 'fuga';
    $request->owner = 'alias';
    $request->repo = 'rem';
...
try {
    ...
    $request->requestBody->line = 550055;
    $request->requestBody->path = 'laudantium';
    $request->requestBody->position = 832239;
    $request->commitSha = 'veritatis';
    $request->owner = 'quae';
    $request->repo = 'eaque';
...
try {
    ...
    $request->requestBody->key = 'voluptatem';
...
try {
    ...
    $request->requestBody->task = 'sequi';
...
try {
    ...
    $request->environmentName = 'impedit';
...
try {
    ...
    $request->requestBody->environmentUrl = 'repellat';
    $request->requestBody->logUrl = 'nulla';
    $request->requestBody->state = ReposCreateDeploymentStatusRequestBodyStateEnum::QUEUED;
    $request->requestBody->targetUrl = 'natus';
    $request->deploymentId = 883780;
...
try {
    ...
    $request->requestBody->eventType = 'quisquam';
    $request->owner = 'dicta';
...
try {
    ...
    $request->homepage = 'quae';
    $request->isTemplate = true;
    $request->licenseTemplate = 'mit';
    $request->mergeCommitMessage = ReposCreateForAuthenticatedUserRequestBodyMergeCommitMessageEnum::BLANK;
    ...
    $request->squashMergeCommitMessage = ReposCreateForAuthenticatedUserRequestBodySquashMergeCommitMessageEnum::PR_BODY;
    $request->squashMergeCommitTitle = ReposCreateForAuthenticatedUserRequestBodySquashMergeCommitTitleEnum::PR_TITLE;
    $request->teamId = 758985;
...
try {
    ...
    $request->requestBody->organization = 'rem';
...
try {
    ...
    $request->requestBody->gitignoreTemplate = 'a';
    ...
    $request->requestBody->homepage = 'iste';
    $request->requestBody->isTemplate = false;
    $request->requestBody->licenseTemplate = 'dicta';
    ...
    $request->requestBody->squashMergeCommitMessage = ReposCreateInOrgRequestBodySquashMergeCommitMessageEnum::PR_BODY;
    $request->requestBody->squashMergeCommitTitle = ReposCreateInOrgRequestBodySquashMergeCommitTitleEnum::COMMIT_OR_PR_TITLE;
    $request->requestBody->teamId = 876840;
...
try {
    ...
    $request->requestBody->author->email = 'Kiera.Kozey@gmail.com';
    $request->requestBody->author->name = 'Crystal Tremblay';
    $request->requestBody->branch = 'corporis';
    ...
    $request->requestBody->committer->email = 'Cary_Nitzsche@yahoo.com';
    $request->requestBody->committer->name = 'Angela Lebsack II';
    $request->requestBody->content = 'saepe';
    $request->requestBody->message = 'neque';
    $request->requestBody->sha = 'facere';
...
try {
    ...
    $request->requestBody = new ReposCreatePagesSiteRequestBody2();
    $request->requestBody->buildType = ReposCreatePagesSiteRequestBody2BuildTypeEnum::WORKFLOW;
    $request->requestBody->source = new ReposCreatePagesSiteRequestBody2Source();
    $request->requestBody->source->branch = 'delectus';
    $request->requestBody->source->path = ReposCreatePagesSiteRequestBody2SourcePathEnum::ROOT;
    $request->owner = 'vitae';
...
try {
    ...
    $request->requestBody->body = 'similique';
    $request->requestBody->draft = false;
    $request->requestBody->generateReleaseNotes = false;
    $request->requestBody->name = 'Winifred Hettinger';
    $request->requestBody->prerelease = false;
    $request->requestBody->tagName = 'unde';
    $request->requestBody->targetCommitish = 'incidunt';
...
try {
    ...
    $request->requestBody->name = 'John Predovic';
    $request->requestBody->owner = 'sapiente';
    $request->requestBody->private = false;
    $request->templateOwner = 'consequuntur';
    $request->templateRepo = 'veniam';
...
try {
    ...
    $request->requestBody->config->insecureSsl = 6383.9;
    ...
    $request->requestBody->name = 'Pam Kirlin';
    $request->owner = 'minus';
    $request->repo = 'ab';
...
try {
    ...
    $request->branchPolicyId = 955569;
    $request->environmentName = 'quisquam';
    $request->owner = 'enim';
    $request->repo = 'doloribus';
...
try {
    ...
    $request->requestBody->author->email = 'Sherwood63@hotmail.com';
    $request->requestBody->author->name = 'Della Treutel III';
    $request->requestBody->branch = 'perspiciatis';
    $request->requestBody->committer = new ReposDeleteFileRequestBodyCommitter();
    $request->requestBody->committer->email = 'Filomena1@hotmail.com';
    $request->requestBody->committer->name = 'Ramona Runolfsson';
    $request->requestBody->message = 'quod';
    $request->requestBody->sha = 'nemo';
...
try {
    ...
    $request->requestBody->configurationFilePath = 'nesciunt';
    $request->requestBody->previousTagName = 'illum';
    $request->requestBody->tagName = 'nemo';
    $request->requestBody->targetCommitish = 'illum';
    $request->owner = 'facilis';
    $request->repo = 'non';
...
try {
    ...
    $request->owner = 'error';
    $request->repo = 'mollitia';
    $request->username = 'Elias_Heathcote';
...
try {
    ...
    $request->owner = 'quod';
    $request->page = 385739;
    $request->perPage = 41179;
    $request->ref = 'voluptatem';
    $request->repo = 'facere';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/comments#get-a-commit-comment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#get-commit-signature-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#get-repository-content>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/metrics/statistics#get-all-contributor-commit-activity>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deploy-keys#get-a-deploy-key>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/deployments#get-a-deployment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/branch-policies#get-deployment-branch-policy>
...
try {
    ...
    $request->branchPolicyId = 691;
    $request->environmentName = 'asperiores';
    $request->owner = 'rem';
    $request->repo = 'dicta';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/statuses#get-a-deployment-status>
...
try {
    ...
    $request->deploymentId = 380595;
    $request->owner = 'earum';
    $request->repo = 'doloribus';
    $request->statusId = 244569;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/environments#get-an-environment>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/pages#get-latest-pages-build>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#get-the-latest-release>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/pages#get-a-github-pages-site>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/pages#get-github-pages-build>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/metrics/statistics#get-the-weekly-commit-count>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#get-pull-request-review-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/metrics/statistics#get-the-hourly-commit-count-for-each-day>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#get-a-repository-readme>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#get-a-repository-directory-readme>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#get-a-release>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#get-a-release-asset>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#get-a-release-by-tag-name>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#get-status-checks-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#list-teams-with-access-to-the-protected-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#list-users-with-access-to-the-protected-branch>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repos#get-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repo-config#get-a-webhook-configuration-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repo-deliveries#get-a-delivery-for-a-repository-webhook>
...
try {
    ...
    $request->deliveryId = 948444;
    $request->hookId = 555294;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/repos/autolinks#list-all-autolinks-of-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branches#list-branches>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/commits#list-branches-for-head-commit>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-repository-cache-replication-status>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/collaborators/collaborators#list-repository-collaborators>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/comments#list-commit-comments>
...
try {
    ...
    $request->commitSha = 'esse';
    $request->owner = 'blanditiis';
    $request->page = 573610;
    $request->perPage = 996541;
    $request->repo = 'a';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/comments#list-commit-comments-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/statuses#list-commit-statuses-for-a-reference>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/commits#list-commits>
...
try {
    ...
    $request->author = 'officia';
    $request->owner = 'saepe';
    $request->page = 429997;
    $request->path = 'repudiandae';
    $request->perPage = 35742;
    $request->repo = 'officia';
    $request->sha = 'impedit';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-07-01T17:33:17.808Z');
    $request->until = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-20T00:59:19.184Z');
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-repository-contributors>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deploy-keys#list-deploy-keys>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/branch-policies#list-deployment-branch-policies>
...
try {
    ...
    $request->environmentName = 'corrupti';
    $request->owner = 'amet';
    $request->page = 473326;
    $request->perPage = 227156;
    $request->repo = 'laborum';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/statuses#list-deployment-statuses>
...
try {
    ...
    $request->deploymentId = 266946;
    $request->owner = 'perferendis';
    $request->page = 897058;
    $request->perPage = 102316;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/deployments#list-deployments>
...
try {
    ...
    $request->environment = 'dolore';
    $request->owner = 'sunt';
    $request->page = 982991;
    $request->perPage = 205011;
    $request->ref = 'odit';
    $request->repo = 'earum';
    $request->sha = 'veniam';
    $request->task = 'ipsam';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-repositories-for-the-authenticated-user>
...
try {
    ...
    $request->affiliation = 'eaque';
    $request->before = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-09-02T02:05:03.967Z');
    $request->direction = ReposListForAuthenticatedUserDirectionEnum::ASC;
    $request->page = 320326;
    $request->perPage = 394161;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-12-26T13:57:53.481Z');
    $request->sort = ReposListForAuthenticatedUserSortEnum::FULL_NAME;
    $request->type = ReposListForAuthenticatedUserTypeEnum::OWNER;
    $request->visibility = ReposListForAuthenticatedUserVisibilityEnum::PUBLIC;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-organization-repositories>
...
try {
    ...
    $request->org = 'sit';
    $request->page = 694728;
    $request->perPage = 831031;
    $request->sort = ReposListForOrgSortEnum::CREATED;
    $request->type = ReposListForOrgTypeEnum::SOURCES;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-repositories-for-a-user>
...
try {
    ...
    $request->page = 152364;
    $request->perPage = 823572;
    $request->sort = ReposListForUserSortEnum::FULL_NAME;
    $request->type = ReposListForUserTypeEnum::MEMBER;
    $request->username = 'Barbara_Fisher29';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-forks>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/collaborators/invitations#list-repository-invitations>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/collaborators/invitations#list-repository-invitations-for-the-authenticated-user>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-repository-languages>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/pages#list-github-pages-builds>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-public-repositories>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/commits#list-pull-requests-associated-with-a-commit>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-release-assets>
...
try {
    ...
    $request->owner = 'magni';
    $request->page = 273677;
    $request->perPage = 821904;
    $request->releaseId = 220824;
    $request->repo = 'rerum';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-releases>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-repository-tags>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#list-repository-teams>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repo-deliveries#list-deliveries-for-a-repository-webhook>
...
try {
    ...
    $request->cursor = 'illo';
    $request->hookId = 14251;
    $request->owner = 'doloribus';
    $request->perPage = 342104;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repos#list-repository-webhooks>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branches#merge-a-branch>
...
try {
    ...
    $request->requestBody->base = 'sapiente';
    $request->requestBody->commitMessage = 'mollitia';
    $request->requestBody->head = 'quae';
    $request->owner = 'quos';
    $request->repo = 'aperiam';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branches#sync-a-fork-branch-with-the-upstream-repository>
...
try {
    ...
    $request->requestBody->branch = 'non';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repos#ping-a-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repo-deliveries#redeliver-a-delivery-for-a-repository-webhook>
...
try {
    ...
    $request->deliveryId = 162450;
    $request->hookId = 982445;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#remove-app-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/collaborators/collaborators#remove-a-repository-collaborator>
...
try {
    ...
    $request->username = 'Timothy.Goldner';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#remove-status-check-contexts>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#remove-status-check-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#remove-team-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#remove-user-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branches#rename-a-branch>
...
try {
    ...
    $request->requestBody->newName = 'placeat';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#replace-all-repository-topics>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/pages#request-a-github-pages-build>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#set-admin-branch-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#set-app-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#set-status-check-contexts>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#set-team-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#set-user-access-restrictions>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repos#test-the-push-repository-webhook>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#transfer-a-repository>
...
try {
    ...
    $request->requestBody->newOwner = 'dolor';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/repos/repos#update-a-repository>
...
try {
    ...
    $request->requestBody->defaultBranch = 'at';
    $request->requestBody->deleteBranchOnMerge = false;
    $request->requestBody->description = 'eum';
    $request->requestBody->hasIssues = false;
    $request->requestBody->hasProjects = false;
    $request->requestBody->hasWiki = false;
    $request->requestBody->homepage = 'reprehenderit';
    $request->requestBody->isTemplate = false;
    $request->requestBody->mergeCommitMessage = ReposUpdateRequestBodyMergeCommitMessageEnum::PR_TITLE;
    $request->requestBody->mergeCommitTitle = ReposUpdateRequestBodyMergeCommitTitleEnum::MERGE_MESSAGE;
    $request->requestBody->name = 'Penny Price';
    $request->requestBody->private = false;
    $request->requestBody->squashMergeCommitMessage = ReposUpdateRequestBodySquashMergeCommitMessageEnum::COMMIT_MESSAGES;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#update-branch-protection>
...
try {
    ...
    $request->requestBody->requiredPullRequestReviews->requiredApprovingReviewCount = 201266;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/commits/comments#update-a-commit-comment>
...
try {
    ...
    $request->requestBody->body = 'deserunt';
    $request->commentId = 266680;
    $request->owner = 'sunt';
    $request->repo = 'impedit';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/deployments/branch-policies#update-deployment-branch-policy>
...
try {
    ...
    $request->branchPolicyId = 259600;
    $request->deploymentBranchPolicyNamePattern = new DeploymentBranchPolicyNamePattern();
    $request->deploymentBranchPolicyNamePattern->name = 'release/*';
    $request->environmentName = 'voluptatum';
    $request->owner = 'ipsa';
    $request->repo = 'at';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/pages#update-information-about-a-github-pages-site>
...
try {
    ...
    $request->requestBody = new ReposUpdateInformationAboutPagesSiteRequestBody2();
    $request->requestBody->buildType = ReposUpdateInformationAboutPagesSiteRequestBody2BuildTypeEnum::WORKFLOW;
    $request->requestBody->cname = 'aspernatur';
    $request->requestBody->httpsEnforced = false;
    $request->requestBody->source = ReposUpdateInformationAboutPagesSiteRequestBody2Source1Enum::GH_PAGES;
    $request->owner = 'fugit';
    $request->repo = 'fuga';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/collaborators/invitations#update-a-repository-invitation>
...
try {
    ...
    $request->requestBody->permissions = ReposUpdateInvitationRequestBodyPermissionsEnum::ADMIN;
    $request->invitationId = 49499;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#update-pull-request-review-protection>
...
try {
    ...
    $request->requestBody->requiredApprovingReviewCount = 627341;
    $request->branch = 'ea';
    $request->owner = 'animi';
    $request->repo = 'dolore';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#update-a-release>
...
try {
    ...
    $request->requestBody->draft = false;
    $request->requestBody->name = 'Tamara O'Kon';
    $request->requestBody->prerelease = false;
    $request->requestBody->tagName = 'eveniet';
    $request->requestBody->targetCommitish = 'earum';
    $request->owner = 'velit';
    $request->releaseId = 884765;
    $request->repo = 'eius';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#update-a-release-asset>
...
try {
    ...
    $request->requestBody->label = 'rerum';
    $request->requestBody->name = 'Lance Hintz';
    $request->requestBody->state = '"uploaded"';
    $request->assetId = 397014;
    $request->owner = 'quis';
    $request->repo = 'facilis';
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/branches/branch-protection#update-status-check-protection>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repos#update-a-repository-webhook>
...
try {
    ...
    $request->requestBody->config->contentType = '"json"';
    $request->requestBody->config->insecureSsl = 5533.15;
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/webhooks/repo-config#update-a-webhook-configuration-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-server@3.4/rest/reference/repos#upload-a-release-asset>
...
try {
    ...
    $request->label = 'earum';
    $request->name = 'Suzanne Grant';
    $request->owner = 'saepe';
    $request->releaseId = 8904;
    $request->repo = 'esse';
