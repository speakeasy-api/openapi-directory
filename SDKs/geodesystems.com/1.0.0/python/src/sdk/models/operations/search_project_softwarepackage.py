...
class SearchProjectSoftwarepackageQueryParams:
    ...
    search_project_softwarepackage_capabilities: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_softwarepackage.capabilities', 'style': 'form', 'explode': True }})
    search_project_softwarepackage_domain: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_softwarepackage.domain', 'style': 'form', 'explode': True }})
    search_project_softwarepackage_license: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_softwarepackage.license', 'style': 'form', 'explode': True }})
    search_project_softwarepackage_platform: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_softwarepackage.platform', 'style': 'form', 'explode': True }})
    search_project_softwarepackage_software_type: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_softwarepackage.software_type', 'style': 'form', 'explode': True }})
    search_project_softwarepackage_software_use: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_softwarepackage.software_use', 'style': 'form', 'explode': True }})
    search_project_softwarepackage_status: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.project_softwarepackage.status', 'style': 'form', 'explode': True }})
...
class SearchProjectSoftwarepackageRequest:
    query_params: SearchProjectSoftwarepackageQueryParams = dataclasses.field()
