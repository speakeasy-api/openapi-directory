...
export class TypeTypeDocumentCsv {
  ...
  searchTypeDocumentCsv(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_document_csv";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeDocumentCsvResponse =
        new operations.SearchTypeDocumentCsvResponse({
