...
exports.ListDataSessionResponse = exports.ListDataSessionListDataSessionResponse = exports.ListDataSessionListDataSessionResponseMeta = exports.ListDataSessionRequest = exports.ListDataSessionSecurity = exports.ListDataSessionServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListDataSessionServerList = [
...
var ListDataSessionSecurity = /** @class */ (function (_super) {
    ...
    ], ListDataSessionSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListDataSessionSecurity.prototype, "username", void 0);
    return ListDataSessionSecurity;
}(utils_1.SpeakeasyBase));
exports.ListDataSessionSecurity = ListDataSessionSecurity;
var ListDataSessionRequest = /** @class */ (function (_super) {
    ...
    ], ListDataSessionRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListDataSessionRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListDataSessionRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SimSid",
        }),
        __metadata("design:type", String)
    ], ListDataSessionRequest.prototype, "simSid", void 0);
    return ListDataSessionRequest;
}(utils_1.SpeakeasyBase));
exports.ListDataSessionRequest = ListDataSessionRequest;
...
exports.ListDataSessionListDataSessionResponseMeta = ListDataSessionListDataSessionResponseMeta;
/**
 * OK
 */
var ListDataSessionListDataSessionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.WirelessV1SimDataSession }),
        (0, class_transformer_1.Expose)({ name: "data_sessions" }),
        (0, class_transformer_1.Type)(function () { return shared.WirelessV1SimDataSession; }),
        __metadata("design:type", Array)
    ], ListDataSessionListDataSessionResponse.prototype, "dataSessions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListDataSessionListDataSessionResponseMeta; }),
...
exports.ListDataSessionListDataSessionResponse = ListDataSessionListDataSessionResponse;
var ListDataSessionResponse = /** @class */ (function (_super) {
    ...
    ], ListDataSessionResponse.prototype, "rawResponse", void 0);
    return ListDataSessionResponse;
}(utils_1.SpeakeasyBase));
exports.ListDataSessionResponse = ListDataSessionResponse;
