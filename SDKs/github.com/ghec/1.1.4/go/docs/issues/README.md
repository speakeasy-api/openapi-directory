...
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#add-assignees-to-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#add-labels-to-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#check-if-a-user-can-be-assigned>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#check-if-a-user-can-be-assigned-to-a-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#create-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#create-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#create-a-label>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#create-a-milestone>
...
func main() {
    ...
    res, err := s.Issues.IssuesCreateMilestone(ctx, operations.IssuesCreateMilestoneRequest{
        RequestBody: operations.IssuesCreateMilestoneRequestBody{
            ...
            DueOn: types.MustTimeFromString("2022-09-14T03:12:12.516Z"),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#delete-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#delete-a-label>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#delete-a-milestone>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#get-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#get-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#get-an-issue-event>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#get-a-label>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#get-a-milestone>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesList(ctx, operations.IssuesListRequest{
        ...
        Labels: sdk.String("similique"),
        Orgs: sdk.Bool(false),
        Owned: sdk.Bool(false),
        Page: sdk.Int64(763165),
        PerPage: sdk.Int64(401428),
        Pulls: sdk.Bool(false),
        Since: types.MustTimeFromString("2022-08-01T21:46:48.262Z"),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-assignees>
...
func main() {
    ...
    res, err := s.Issues.IssuesListAssignees(ctx, operations.IssuesListAssigneesRequest{
        Owner: "quidem",
        Page: sdk.Int64(348192),
        PerPage: sdk.Int64(463344),
        Repo: "dolorem",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-issue-comments>
...
func main() {
    ...
    res, err := s.Issues.IssuesListComments(ctx, operations.IssuesListCommentsRequest{
        IssueNumber: 264619,
        Owner: "ipsa",
        Page: sdk.Int64(575534),
        PerPage: sdk.Int64(876027),
        Repo: "sequi",
        Since: types.MustTimeFromString("2020-10-11T08:25:54.157Z"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-issue-comments-for-a-repository>
...
func main() {
    ...
    res, err := s.Issues.IssuesListCommentsForRepo(ctx, operations.IssuesListCommentsForRepoRequest{
        ...
        Repo: "dolores",
        Since: types.MustTimeFromString("2022-10-08T09:27:30.689Z"),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-issue-events>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-issue-events-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-timeline-events-for-an-issue>
...
func main() {
    ...
    res, err := s.Issues.IssuesListEventsForTimeline(ctx, operations.IssuesListEventsForTimelineRequest{
        IssueNumber: 729448,
        Owner: "excepturi",
        Page: sdk.Int64(578210),
        PerPage: sdk.Int64(367917),
        Repo: "aliquam",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-user-account-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForAuthenticatedUser(ctx, operations.IssuesListForAuthenticatedUserRequest{
        ...
        Labels: sdk.String("eligendi"),
        Page: sdk.Int64(574032),
        PerPage: sdk.Int64(314573),
        Since: types.MustTimeFromString("2021-01-11T05:39:31.724Z"),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-organization-issues-assigned-to-the-authenticated-user>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForOrg(ctx, operations.IssuesListForOrgRequest{
        ...
        Labels: sdk.String("eaque"),
        Org: "saepe",
        Page: sdk.Int64(104078),
        PerPage: sdk.Int64(554645),
        Since: types.MustTimeFromString("2021-05-07T09:23:04.849Z"),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-repository-issues>
...
func main() {
    ...
    res, err := s.Issues.IssuesListForRepo(ctx, operations.IssuesListForRepoRequest{
        Assignee: sdk.String("velit"),
        Creator: sdk.String("doloremque"),
        Direction: shared.DirectionEnumDesc.ToPointer(),
        Labels: sdk.String("impedit"),
        Mentioned: sdk.String("cum"),
        Milestone: sdk.String("ipsum"),
        Owner: "adipisci",
        Page: sdk.Int64(903150),
        PerPage: sdk.Int64(644420),
        Repo: "doloremque",
        Since: types.MustTimeFromString("2022-09-01T10:17:19.810Z"),
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-labels-for-issues-in-a-milestone>
...
func main() {
    ...
    res, err := s.Issues.IssuesListLabelsForMilestone(ctx, operations.IssuesListLabelsForMilestoneRequest{
        MilestoneNumber: 584593,
        Owner: "molestiae",
        Page: sdk.Int64(756654),
        PerPage: sdk.Int64(820023),
        Repo: "non",
    })
    if err != nil {
        log.Fatal(err)
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-labels-for-a-repository>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-labels-for-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#list-milestones>
...
func main() {
    ...
    res, err := s.Issues.IssuesListMilestones(ctx, operations.IssuesListMilestonesRequest{
        ...
        Owner: "amet",
        Page: sdk.Int64(347698),
        PerPage: sdk.Int64(68852),
        Repo: "velit",
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#lock-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#remove-all-labels-from-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#remove-assignees-from-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#remove-a-label-from-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#set-labels-for-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#unlock-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#update-an-issue>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#update-an-issue-comment>
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#update-a-label>
...
func main() {
    ...
    res, err := s.Issues.IssuesUpdateLabel(ctx, operations.IssuesUpdateLabelRequest{
        RequestBody: &operations.IssuesUpdateLabelRequestBody{
            Color: sdk.String("delectus"),
            Description: sdk.String("iusto"),
            NewName: sdk.String("dignissimos"),
        },
...
API method documentation
<https://docs.github.com/enterprise-cloud@latest//rest/reference/issues#update-a-milestone>
...
func main() {
    ...
    res, err := s.Issues.IssuesUpdateMilestone(ctx, operations.IssuesUpdateMilestoneRequest{
        RequestBody: &operations.IssuesUpdateMilestoneRequestBody{
            ...
            DueOn: types.MustTimeFromString("2022-01-11T22:06:57.023Z"),
            State: operations.IssuesUpdateMilestoneRequestBodyStateEnumClosed.ToPointer(),
            Title: sdk.String("Ms."),
        },
        MilestoneNumber: 506312,
        Owner: "nemo",
        Repo: "repellat",
    })
    if err != nil {
