...
class GetVariantCaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetVariantCaseAssociationsQueryParams:
...
@dataclasses.dataclass
class GetVariantCaseAssociationsRequest:
    path_params: GetVariantCaseAssociationsPathParams = dataclasses.field()
    query_params: GetVariantCaseAssociationsQueryParams = dataclasses.field()
