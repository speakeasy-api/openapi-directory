...
export class Sns {
  ...
  snsGetSnsGet(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SnsGetSnsGetResponse =
        new operations.SnsGetSnsGetResponse({
  ...
  snsPostSnsPost(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SnsPostSnsPostResponse =
        new operations.SnsPostSnsPostResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
