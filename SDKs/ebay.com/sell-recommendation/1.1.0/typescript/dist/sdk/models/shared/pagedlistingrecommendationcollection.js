...
var PagedListingRecommendationCollection = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: listingrecommendation_1.ListingRecommendation }),
        (0, class_transformer_1.Expose)({ name: "listingRecommendations" }),
        (0, class_transformer_1.Type)(function () { return listingrecommendation_1.ListingRecommendation; }),
