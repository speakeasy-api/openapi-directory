...
var Uploads = /** @class */ (function () {
    ...
    Uploads.prototype.uploadsCreate = function (req, config) {
        ...
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UploadsCreateRequestBody(req);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.UploadsCreateResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.fileResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.FileResponse);
                    }
                    break;
