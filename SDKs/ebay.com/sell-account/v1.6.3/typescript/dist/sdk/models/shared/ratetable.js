...
**/
var RateTable = /** @class */ (function (_super) {
    __extends(RateTable, _super);
    function RateTable() {
    ...
    ], RateTable.prototype, "countryCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=locality" }),
        __metadata("design:type", String)
    ], RateTable.prototype, "locality", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], RateTable.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=rateTableId" }),
        __metadata("design:type", String)
    ], RateTable.prototype, "rateTableId", void 0);
    return RateTable;
