...
public class DescribeDeviceEc2InstancesRequest {
    ...
    public DescribeDeviceEc2InstancesRequest(@JsonProperty("RequestBody") DescribeDeviceEc2InstancesRequestBody requestBody, @JsonProperty("managedDeviceId") String managedDeviceId) {
        this.requestBody = requestBody;
        this.managedDeviceId = managedDeviceId;
  }
}
