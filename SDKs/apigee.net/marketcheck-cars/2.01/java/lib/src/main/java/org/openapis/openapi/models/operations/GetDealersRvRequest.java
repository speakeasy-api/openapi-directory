...
public class GetDealersRvRequest {
    /**
     * The API Authentication Key. Mandatory with all API calls.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=api_key")
    public String apiKey;
    public GetDealersRvRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public String city;
    public GetDealersRvRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetDealersRvRequest withCountry(org.openapis.openapi.models.shared.NonDefaultCountryEnum country) {
    ...
    public GetDealersRvRequest withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetDealersRvRequest withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetDealersRvRequest withInventoryUrl(String inventoryUrl) {
    ...
    public GetDealersRvRequest withLatitude(Double latitude) {
    ...
    public GetDealersRvRequest withListingCountRange(String listingCountRange) {
    ...
    public GetDealersRvRequest withLongitude(Double longitude) {
    ...
    public GetDealersRvRequest withProvider(Boolean provider) {
    ...
    public GetDealersRvRequest withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetDealersRvRequest withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetDealersRvRequest withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDealersRvRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetDealersRvRequest withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetDealersRvRequest withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public GetDealersRvRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String zip;
    public GetDealersRvRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
