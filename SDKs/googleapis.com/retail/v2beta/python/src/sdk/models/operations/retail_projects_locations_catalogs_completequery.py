...
from ..shared import googlecloudretailv2betacompletequeryresponse as shared_googlecloudretailv2betacompletequeryresponse
...
class RetailProjectsLocationsCatalogsCompleteQueryResponse:
    ...
    google_cloud_retail_v2beta_complete_query_response: Optional[shared_googlecloudretailv2betacompletequeryresponse.GoogleCloudRetailV2betaCompleteQueryResponse] = dataclasses.field(default=None)
