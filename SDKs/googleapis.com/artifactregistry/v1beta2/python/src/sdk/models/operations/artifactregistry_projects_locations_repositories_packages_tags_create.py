...
class ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreateRequest:
    path_params: ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreatePathParams = dataclasses.field()
    query_params: ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreateQueryParams = dataclasses.field()
    security: ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreateSecurity = dataclasses.field()
