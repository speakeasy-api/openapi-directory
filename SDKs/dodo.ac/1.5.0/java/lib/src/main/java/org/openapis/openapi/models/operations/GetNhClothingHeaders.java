...
public class GetNhClothingHeaders {
    /**
    ...
    public GetNhClothingHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetNhClothingHeaders withXApiKey(String xApiKey) {
