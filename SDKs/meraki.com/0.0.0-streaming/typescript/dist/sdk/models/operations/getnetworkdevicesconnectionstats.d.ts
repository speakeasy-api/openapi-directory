 ...
 */
export declare enum GetNetworkDevicesConnectionStatsBandEnum {
    Two4 = "2.4",
    Five = "5"
}
export declare class GetNetworkDevicesConnectionStatsRequest extends SpeakeasyBase {
    /**
     ...
     * Filter results by band (either '2.4' or '5'). Note that data prior to February 2020 will not have band information.
     */
    band?: GetNetworkDevicesConnectionStatsBandEnum;
    networkId: string;
    /**
...
export declare class GetNetworkDevicesConnectionStatsResponse extends SpeakeasyBase {
    contentType: string;
    statusCode: number;
     ...
     */
    getNetworkDevicesConnectionStats200ApplicationJSONObjects?: Record<string, any>[];
}
