...
type Listtransactionsbyaddress3Request struct {
	// account address
...
type Listtransactionsbyaddress3200ApplicationJSONDataMetaAccountedFor struct {
...
type Listtransactionsbyaddress3200ApplicationJSONDataMetaNamedTo0xa57bd00134b2850b2a1c55860c9e9ea100fdd6cf struct {
...
type Listtransactionsbyaddress3200ApplicationJSONDataMetaNamedTo struct {
	Zeroxa57bd00134b2850b2a1c55860c9e9ea100fdd6cf *Listtransactionsbyaddress3200ApplicationJSONDataMetaNamedTo0xa57bd00134b2850b2a1c55860c9e9ea100fdd6cf `json:"0xa57bd00134b2850b2a1c55860c9e9ea100fdd6cf,omitempty"`
}

type Listtransactionsbyaddress3200ApplicationJSONDataMetaUnNamedFrom struct {
...
type Listtransactionsbyaddress3200ApplicationJSONDataMetaUnNamedTo struct {
...
type Listtransactionsbyaddress3200ApplicationJSONDataMeta struct {
	AccountedFor *Listtransactionsbyaddress3200ApplicationJSONDataMetaAccountedFor `json:"accountedFor,omitempty"`
	...
	NamedTo      *Listtransactionsbyaddress3200ApplicationJSONDataMetaNamedTo      `json:"namedTo,omitempty"`
	NetworkID    *float64                                                          `json:"networkId,omitempty"`
	Ripe         *float64                                                          `json:"ripe,omitempty"`
	Staging      *float64                                                          `json:"staging,omitempty"`
	UnNamedFrom  *Listtransactionsbyaddress3200ApplicationJSONDataMetaUnNamedFrom  `json:"unNamedFrom,omitempty"`
	UnNamedTo    *Listtransactionsbyaddress3200ApplicationJSONDataMetaUnNamedTo    `json:"unNamedTo,omitempty"`
	Unripe       *float64                                                          `json:"unripe,omitempty"`
}

type Listtransactionsbyaddress3200ApplicationJSONDataTransactionsReceipt struct {
...
type Listtransactionsbyaddress3200ApplicationJSONDataTransactions struct {
	...
	Receipt              *Listtransactionsbyaddress3200ApplicationJSONDataTransactionsReceipt `json:"receipt,omitempty"`
...
type Listtransactionsbyaddress3200ApplicationJSONData struct {
	CurrentPage  *float64                                                       `json:"current_page,omitempty"`
	MaxPages     *float64                                                       `json:"max_pages,omitempty"`
	Meta         *Listtransactionsbyaddress3200ApplicationJSONDataMeta          `json:"meta,omitempty"`
	Transactions []Listtransactionsbyaddress3200ApplicationJSONDataTransactions `json:"transactions,omitempty"`
}

// Listtransactionsbyaddress3200ApplicationJSON - 200
type Listtransactionsbyaddress3200ApplicationJSON struct {
	Data    *Listtransactionsbyaddress3200ApplicationJSONData `json:"data,omitempty"`
	Message *string                                           `json:"message,omitempty"`
	Ok      *bool                                             `json:"ok,omitempty"`
	Status  *float64                                          `json:"status,omitempty"`
}

type Listtransactionsbyaddress3Response struct {
	ContentType string
	Headers     map[string][]string
	StatusCode  int
	RawResponse *http.Response
	// 200
	Listtransactionsbyaddress3200ApplicationJSONObject *Listtransactionsbyaddress3200ApplicationJSON
}
