...
class HipConsentNotificationResponse:
    ...
    acknowledgement: Optional[shared_consentacknowledgement.ConsentAcknowledgement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
