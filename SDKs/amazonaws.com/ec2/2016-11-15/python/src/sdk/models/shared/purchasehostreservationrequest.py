...
import dataclasses
from ..shared import currencycodevalues_enum as shared_currencycodevalues_enum
from enum import Enum
from typing import Optional

class PurchaseHostReservationRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class PurchaseHostReservationRequestTagSpecifications:
    ...
    resource_type: Optional[PurchaseHostReservationRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[PurchaseHostReservationRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class PurchaseHostReservationRequest:
    ...
    currency_code: Optional[shared_currencycodevalues_enum.CurrencyCodeValuesEnum] = dataclasses.field(default=None)  
    limit_price: Optional[str] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[PurchaseHostReservationRequestTagSpecifications]] = dataclasses.field(default=None)  
