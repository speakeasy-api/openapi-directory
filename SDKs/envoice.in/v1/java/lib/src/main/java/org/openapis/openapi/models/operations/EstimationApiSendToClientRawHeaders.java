...
public class EstimationApiSendToClientRawHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public EstimationApiSendToClientRawHeaders withXAuthKey(String xAuthKey) {
    ...
    public EstimationApiSendToClientRawHeaders withXAuthSecret(String xAuthSecret) {
