...
class GetRelationUsagePivotResourceQueryParams:
...
class GetRelationUsagePivotResourceRequest:
    query_params: GetRelationUsagePivotResourceQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetRelationUsagePivotResourceResponse:
