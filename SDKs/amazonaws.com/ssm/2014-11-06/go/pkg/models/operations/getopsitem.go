...
func (e GetOpsItemXAmzTargetEnum) ToPointer() *GetOpsItemXAmzTargetEnum {
	return &e
}
...
func (e *GetOpsItemXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.GetOpsItem":
		*e = GetOpsItemXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOpsItemXAmzTargetEnum: %v", v)
	}
}

type GetOpsItemRequest struct {
	GetOpsItemRequest shared.GetOpsItemRequest `request:"mediaType=application/json"`
