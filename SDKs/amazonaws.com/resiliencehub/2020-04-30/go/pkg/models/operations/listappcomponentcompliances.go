...
type ListAppComponentCompliancesQueryParams struct {
	// Pagination limit
...
type ListAppComponentCompliancesHeaders struct {
...
type ListAppComponentCompliancesRequestBody struct {
...
type ListAppComponentCompliancesRequest struct {
	QueryParams ListAppComponentCompliancesQueryParams
	Headers     ListAppComponentCompliancesHeaders
	Request     ListAppComponentCompliancesRequestBody `request:"mediaType=application/json"`
}
