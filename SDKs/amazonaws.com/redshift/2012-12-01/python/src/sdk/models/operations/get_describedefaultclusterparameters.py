...
class GetDescribeDefaultClusterParametersQueryParams:
...
@dataclasses.dataclass
class GetDescribeDefaultClusterParametersHeaders:
...
class GetDescribeDefaultClusterParametersRequest:
    headers: GetDescribeDefaultClusterParametersHeaders = dataclasses.field()
    query_params: GetDescribeDefaultClusterParametersQueryParams = dataclasses.field()
