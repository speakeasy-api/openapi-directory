...
export class ContentReturnpolicyGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentReturnpolicyGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentReturnpolicyGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
