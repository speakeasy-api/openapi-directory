...
export class Sms {
  ...
  listUserSSubscriptionGroupSms(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/subscription/user/status";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ListUserSSubscriptionGroupSmsResponse =
        new operations.ListUserSSubscriptionGroupSmsResponse({
  ...
  listUserSSubscriptionGroupStatusSms(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ListUserSSubscriptionGroupStatusSmsResponse =
        new operations.ListUserSSubscriptionGroupStatusSmsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
