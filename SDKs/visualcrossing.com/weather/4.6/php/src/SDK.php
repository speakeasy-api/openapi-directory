...
/**
 * SDK - Weather Forecast and Historical Weather Data via RESTful API.
 * 
 * https://www.visualcrossing.com/resources/documentation/weather-api/timeline-weather-api/ - Full Timeline Weather API Documentation
 * 
...
class SDK
{
	...
	public function __construct(?\GuzzleHttp\ClientInterface $client, string $serverUrl, ?array $params)
	{
		...
		$this->timelineWeatherAPI15DayForecastRequest = new TimelineWeatherAPI15DayForecastRequest(
			$this->_defaultClient,
			$this->_securityClient,
			$this->_serverUrl,
			$this->_language,
		...
		$this->timelineWeatherAPIDateRangeRequest = new TimelineWeatherAPIDateRangeRequest(
			$this->_defaultClient,
			$this->_securityClient,
			$this->_serverUrl,
			$this->_language,
		...
		$this->timelineWeatherAPISingleDateRequest = new TimelineWeatherAPISingleDateRequest(
			$this->_defaultClient,
			$this->_securityClient,
			$this->_serverUrl,
			$this->_language,
