...
class VsamDetailAttributes:
    ...
    cache_at_startup: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cacheAtStartup'), 'exclude': lambda f: f is None }})  
    ...
    record_format: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('recordFormat'), 'exclude': lambda f: f is None }})  
