...
public class FirebaseappcheckProjectsAppsDebugTokensCreateRequest {
    ...
    public openapisdk.models.shared.GoogleFirebaseAppcheckV1DebugToken request;
    public FirebaseappcheckProjectsAppsDebugTokensCreateRequest withRequest(openapisdk.models.shared.GoogleFirebaseAppcheckV1DebugToken request) {
