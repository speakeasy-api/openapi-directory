...
exports.CreateTokenResponse = exports.CreateTokenRequest = exports.CreateTokenSecurity = exports.CreateTokenCreateTokenRequest = exports.CreateTokenServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.CreateTokenServerList = [
...
var CreateTokenCreateTokenRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=ClientSecret;" }),
        __metadata("design:type", String)
    ], CreateTokenCreateTokenRequest.prototype, "clientSecret", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=ClientSid;" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=CodeVerifier;" }),
        __metadata("design:type", String)
    ], CreateTokenCreateTokenRequest.prototype, "codeVerifier", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=DeviceCode;" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=GrantType;" }),
        __metadata("design:type", String)
    ], CreateTokenCreateTokenRequest.prototype, "grantType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=RefreshToken;" }),
        __metadata("design:type", String)
