 ...
 */
export declare class DescribeFastSnapshotRestoresRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeFastSnapshotRestoresRequest extends SpeakeasyBase {
    dryRun?: boolean;
