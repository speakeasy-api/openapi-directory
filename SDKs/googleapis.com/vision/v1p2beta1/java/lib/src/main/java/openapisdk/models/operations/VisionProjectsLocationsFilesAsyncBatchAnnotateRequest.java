...
public class VisionProjectsLocationsFilesAsyncBatchAnnotateRequest {
    ...
    public VisionProjectsLocationsFilesAsyncBatchAnnotateRequest withRequest(openapisdk.models.shared.GoogleCloudVisionV1p2beta1AsyncBatchAnnotateFilesRequest request) {
