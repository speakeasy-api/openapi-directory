...
class LogDestinationConfig:
    ...
    log_destination: dict[str, str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('LogDestination') }})
    log_destination_type: shared_logdestinationtype_enum.LogDestinationTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('LogDestinationType') }})
