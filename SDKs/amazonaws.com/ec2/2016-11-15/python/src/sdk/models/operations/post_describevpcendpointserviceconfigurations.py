...
class PostDescribeVpcEndpointServiceConfigurationsQueryParams:
    action: PostDescribeVpcEndpointServiceConfigurationsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeVpcEndpointServiceConfigurationsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeVpcEndpointServiceConfigurationsRequest:
    headers: PostDescribeVpcEndpointServiceConfigurationsHeaders = dataclasses.field()
    query_params: PostDescribeVpcEndpointServiceConfigurationsQueryParams = dataclasses.field()
