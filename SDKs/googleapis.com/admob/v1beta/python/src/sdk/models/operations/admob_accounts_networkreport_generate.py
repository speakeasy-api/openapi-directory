...
class AdmobAccountsNetworkReportGenerateRequest:
    ...
    generate_network_report_request: Optional[shared_generatenetworkreportrequest.GenerateNetworkReportRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
