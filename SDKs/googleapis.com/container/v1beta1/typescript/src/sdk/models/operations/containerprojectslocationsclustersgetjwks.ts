...
export class ContainerProjectsLocationsClustersGetJwksRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsClustersGetJwksResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
