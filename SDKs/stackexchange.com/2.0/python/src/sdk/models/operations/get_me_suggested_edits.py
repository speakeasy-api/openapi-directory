...
class GetMeSuggestedEditsOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeSuggestedEditsSortEnum(str, Enum):
    CREATION = "creation"
    APPROVAL = "approval"
    REJECTION = "rejection"
...
class GetMeSuggestedEditsQueryParams:
    ...
    order: Optional[GetMeSuggestedEditsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeSuggestedEditsSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetMeSuggestedEditsRequest:
    query_params: GetMeSuggestedEditsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetMeSuggestedEditsResponse:
