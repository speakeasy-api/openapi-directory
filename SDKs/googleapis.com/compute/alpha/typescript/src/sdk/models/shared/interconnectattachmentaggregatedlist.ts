...
import { InterconnectAttachmentsScopedList } from "./interconnectattachmentsscopedlist";
import { Expose, Transform, Type } from "class-transformer";

/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export enum InterconnectAttachmentAggregatedListWarningCodeEnum {
...
export class InterconnectAttachmentAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InterconnectAttachmentAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: InterconnectAttachmentAggregatedListWarningCodeEnum;
  ...
  data?: InterconnectAttachmentAggregatedListWarningData[];
 ...
 * Successful response
 */
export class InterconnectAttachmentAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: InterconnectAttachmentsScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, InterconnectAttachmentsScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], InterconnectAttachmentsScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
