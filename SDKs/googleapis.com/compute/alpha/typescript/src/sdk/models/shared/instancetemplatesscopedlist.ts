 ...
 */
export enum InstanceTemplatesScopedListWarningCodeEnum {
...
export class InstanceTemplatesScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class InstanceTemplatesScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: InstanceTemplatesScopedListWarningData })
  @Expose({ name: "data" })
...
export class InstanceTemplatesScopedList extends SpeakeasyBase {
  /**
   * [Output Only] A list of instance templates that are contained within the specified project and zone.
   */
  @SpeakeasyMetadata({ elemType: InstanceTemplate })
  @Expose({ name: "instanceTemplates" })
