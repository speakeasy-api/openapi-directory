...
from ..shared import getcustomersearchapplicationstatsresponse as shared_getcustomersearchapplicationstatsresponse
...
class CloudsearchStatsGetSearchapplicationSecurity:
    ...
    option1: Optional[CloudsearchStatsGetSearchapplicationSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[CloudsearchStatsGetSearchapplicationSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option3: Optional[CloudsearchStatsGetSearchapplicationSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class CloudsearchStatsGetSearchapplicationResponse:
    ...
    get_customer_search_application_stats_response: Optional[shared_getcustomersearchapplicationstatsresponse.GetCustomerSearchApplicationStatsResponse] = dataclasses.field(default=None)
