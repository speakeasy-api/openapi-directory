...
func (e *UpdateDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "camera":
		fallthrough
	case "sensor":
		*e = UpdateDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateDeviceSensorRelationships200ApplicationJSONLivestreamRelatedDevicesProductTypeEnum: %s", s)
	}
}
