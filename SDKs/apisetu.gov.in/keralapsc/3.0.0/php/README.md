...
use \OpenAPI\OpenAPI\Models\Operations\OtcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\OtcerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\OtcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\OtcerSecurity;
...
try {
    ...
    $request->certificateParameters = new OtcerRequestBodyCertificateParameters();
    ...
    $request->format = OtcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new OtcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->otcer($request, $requestSecurity);
...
* [otcer](docs/apis/README.md#otcer) - OTV Certificate
