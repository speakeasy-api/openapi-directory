...
exports.PostRejectPaymentRequest = void 0;
...
var PostRejectPaymentRequest = /** @class */ (function (_super) {
    ...
    ], PostRejectPaymentRequest.prototype, "gatewayResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=gatewayResponseCode" }),
        __metadata("design:type", String)
    ], PostRejectPaymentRequest.prototype, "gatewayResponseCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=referenceId" }),
        __metadata("design:type", String)
    ], PostRejectPaymentRequest.prototype, "referenceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=secondReferenceId" }),
        __metadata("design:type", String)
    ], PostRejectPaymentRequest.prototype, "secondReferenceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=settledOn" }),
        __metadata("design:type", Date)
    ], PostRejectPaymentRequest.prototype, "settledOn", void 0);
