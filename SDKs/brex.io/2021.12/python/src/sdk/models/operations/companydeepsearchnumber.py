...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CompanyDeepsearchNumber200ApplicationJSON:
...
class CompanyDeepsearchNumberResponse:
    ...
    company_deepsearch_number_200_application_json_objects: Optional[list[CompanyDeepsearchNumber200ApplicationJSON]] = dataclasses.field(default=None)
    r"""List of companies"""  
    company_deepsearch_number_default_application_json_object: Optional[CompanyDeepsearchNumberDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
