...
class GetCommunicationCostsAggregatesRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetCommunicationCostsAggregatesSupportOpposeIndicatorEnum $supportOpposeIndicator
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=support_oppose_indicator')]
    public ?GetCommunicationCostsAggregatesSupportOpposeIndicatorEnum $supportOpposeIndicator = null;
