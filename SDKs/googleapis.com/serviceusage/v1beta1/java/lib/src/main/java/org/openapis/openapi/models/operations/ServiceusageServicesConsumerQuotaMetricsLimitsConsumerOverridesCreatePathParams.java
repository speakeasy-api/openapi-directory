...
public class ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreatePathParams {
    /**
    ...
    public ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreatePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
