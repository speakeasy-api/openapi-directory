...
class CustomerDto:
    r"""Information of Customer to create."""
    ...
    opening_balance: Optional[shared_owneropeningbalanceinperiodsdto.OwnerOpeningBalanceInPeriodsDto] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('openingBalance'), 'exclude': lambda f: f is None }})  
    opening_balances: Optional[list[shared_owneropeningbalancedto.OwnerOpeningBalanceDto]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('openingBalances'), 'exclude': lambda f: f is None }})  
