...
export class Account {
  ...
  getAllAccounts(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetAllAccountsResponse =
        new operations.GetAllAccountsResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getAllAccounts200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetAllAccounts200ApplicationJSON
            );
          }
          break;
