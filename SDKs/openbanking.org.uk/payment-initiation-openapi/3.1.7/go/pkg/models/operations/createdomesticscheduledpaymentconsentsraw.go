...
type CreateDomesticScheduledPaymentConsentsRawSecurity struct {
	TPPOAuth2Security shared.SchemeTppoAuth2Security `security:"scheme,type=oauth2"`
}

type CreateDomesticScheduledPaymentConsentsRawHeaders struct {
...
type CreateDomesticScheduledPaymentConsentsRawRequest struct {
	Headers CreateDomesticScheduledPaymentConsentsRawHeaders
	// Default
	Request  []byte `request:"mediaType=application/jose+jwe"`
	Security CreateDomesticScheduledPaymentConsentsRawSecurity
}

type CreateDomesticScheduledPaymentConsentsRawResponse struct {
	Body        []byte
	ContentType string
