...
public class ListAlarmsResponse {
    ...
    public org.openapis.openapi.models.shared.ListAlarmsResponse listAlarmsResponse;

    public ListAlarmsResponse withListAlarmsResponse(org.openapis.openapi.models.shared.ListAlarmsResponse listAlarmsResponse) {
    ...
    public ListAlarmsResponse withStatusCode(Integer statusCode) {
    ...
    public ListAlarmsResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public ListAlarmsResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
