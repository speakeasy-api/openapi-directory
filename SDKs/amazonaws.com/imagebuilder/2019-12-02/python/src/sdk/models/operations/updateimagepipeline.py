...
class UpdateImagePipelineRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the image pipeline that you want to update."""  
    ...
    r"""The Amazon Resource Name (ARN) of the infrastructure configuration that will be used to build images updated by this image pipeline."""  
    ...
    r"""The Amazon Resource Name (ARN) of the container pipeline to update."""  
    ...
    r"""The Amazon Resource Name (ARN) of the distribution configuration that will be used to configure and distribute images updated by this image pipeline."""  
    ...
    r"""The Amazon Resource Name (ARN) of the image recipe that will be used to configure images updated by this image pipeline."""  
    image_tests_configuration: Optional[UpdateImagePipelineRequestBodyImageTestsConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('imageTestsConfiguration'), 'exclude': lambda f: f is None }})
    r"""Configure image tests for your pipeline build. Tests run after building the image, to verify that the AMI or container image is valid before distributing it."""  
    schedule: Optional[UpdateImagePipelineRequestBodySchedule] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('schedule'), 'exclude': lambda f: f is None }})
    r"""A schedule configures how often and when a pipeline will automatically create a new image."""  
    status: Optional[UpdateImagePipelineRequestBodyStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of the image pipeline."""  
...
class UpdateImagePipelineRequest:
    ...
    request_body: UpdateImagePipelineRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
