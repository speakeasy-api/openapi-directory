...
exports.GetPromotionsJsonResponse = exports.GetPromotionsJsonRequest = void 0;
...
var GetPromotionsJsonRequest = /** @class */ (function (_super) {
    ...
    ], GetPromotionsJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetPromotionsJsonRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], GetPromotionsJsonRequest.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetPromotionsJsonRequest.prototype, "page", void 0);
    return GetPromotionsJsonRequest;
}(utils_1.SpeakeasyBase));
exports.GetPromotionsJsonRequest = GetPromotionsJsonRequest;
var GetPromotionsJsonResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.Promotion }),
    ...
    ], GetPromotionsJsonResponse.prototype, "rawResponse", void 0);
    return GetPromotionsJsonResponse;
}(utils_1.SpeakeasyBase));
exports.GetPromotionsJsonResponse = GetPromotionsJsonResponse;
