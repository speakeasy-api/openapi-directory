...
class ListUnderstandAssistantListUnderstandAssistantResponse:
    ...
    assistants: Optional[list[shared_preview_understand_assistant.PreviewUnderstandAssistant]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assistants'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListUnderstandAssistantListUnderstandAssistantResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
