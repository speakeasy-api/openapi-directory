...
var EcsTaskSet = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=identifer" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=targetGroup" }),
        __metadata("design:type", targetgroupinfo_1.TargetGroupInfo)
    ], EcsTaskSet.prototype, "targetGroup", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=taskSetLabel" }),
        __metadata("design:type", String)
    ], EcsTaskSet.prototype, "taskSetLabel", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=trafficWeight" }),
        __metadata("design:type", Number)
