...
class UpdatePsuAuthenticationResponse:
    r"""Body of the JSON response for a successful update PSU authentication request."""
    ...
    r"""A list of hyperlinks to be recognised by the TPP. Might be contained, if several authentication methods
    ...
    """  
    authorisation_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('authorisationId'), 'exclude': lambda f: f is None }})
