...
public class OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation {
    ...
    public OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation withReference(String reference) {
    ...
    public OBWriteDomesticScheduledConsentResponse5DataInitiationRemittanceInformation withUnstructured(String unstructured) {
