...
class EnterpriseAdminSuspendUserRequest:
    ...
    request_body: Optional[EnterpriseAdminSuspendUserRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
