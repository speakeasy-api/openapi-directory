...
type GetVariantGeneAssociationsPathParams struct {
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetVariantGeneAssociationsQueryParams struct {
