...
class ClassroomUserProfilesGuardianInvitationsGetSecurity:
    option1: Optional[ClassroomUserProfilesGuardianInvitationsGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ClassroomUserProfilesGuardianInvitationsGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class ClassroomUserProfilesGuardianInvitationsGetRequest:
    path_params: ClassroomUserProfilesGuardianInvitationsGetPathParams = dataclasses.field()
    query_params: ClassroomUserProfilesGuardianInvitationsGetQueryParams = dataclasses.field()
    security: ClassroomUserProfilesGuardianInvitationsGetSecurity = dataclasses.field()
...
class ClassroomUserProfilesGuardianInvitationsGetResponse:
    ...
    guardian_invitation: Optional[shared_guardianinvitation.GuardianInvitation] = dataclasses.field(default=None)
