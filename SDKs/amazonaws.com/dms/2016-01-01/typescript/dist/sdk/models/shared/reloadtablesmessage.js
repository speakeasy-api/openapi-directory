...
var ReloadTablesMessage = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "ReloadOption" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: tabletoreload_1.TableToReload }),
        (0, class_transformer_1.Expose)({ name: "TablesToReload" }),
        (0, class_transformer_1.Type)(function () { return tabletoreload_1.TableToReload; }),
