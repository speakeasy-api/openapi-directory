...
public class Destiny2SearchDestinyPlayerByBungieNamePathParams {
    /**
    ...
    public Destiny2SearchDestinyPlayerByBungieNamePathParams withMembershipType(Integer membershipType) {
