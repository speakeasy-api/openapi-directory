...
class GooglePlayDeveloperReportingV1beta1ErrorReportTypeEnum(str, Enum):
...
class GooglePlayDeveloperReportingV1beta1ErrorReport:
    ...
    type: Optional[GooglePlayDeveloperReportingV1beta1ErrorReportTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Type of the error for which this report was generated."""  
