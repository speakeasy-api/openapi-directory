...
var Volumeannotation = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=annotationDataId" }),
        __metadata("design:type", String)
    ], Volumeannotation.prototype, "annotationDataId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=annotationDataLink" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=contentRanges" }),
