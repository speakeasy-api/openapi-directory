...
class AnalyticsadminAccountsSearchChangeHistoryEventsRequest:
    ...
    r"""Required. The account resource for which to return change history resources."""  
    ...
    google_analytics_admin_v1beta_search_change_history_events_request: Optional[shared_googleanalyticsadminv1betasearchchangehistoryeventsrequest.GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
