...
export class Meta {
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@2.20/rest/reference/meta#get-github-meta-information} - API method documentation
   */
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@2.20/rest/reference/meta#get-octocat} - API method documentation
   */
  metaGetOctocat(
   ...
   *
   * @see {@link https://docs.github.com/enterprise-server@2.20/rest/overview/resources-in-the-rest-api#root-endpoint} - API method documentation
   */
