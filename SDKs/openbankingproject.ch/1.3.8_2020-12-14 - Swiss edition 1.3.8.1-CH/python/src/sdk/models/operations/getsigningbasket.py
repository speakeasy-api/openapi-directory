...
from ..shared import signingbasketresponse_200 as shared_signingbasketresponse_200
...
class GetSigningBasketRequest:
    headers: GetSigningBasketHeaders = dataclasses.field()
    path_params: GetSigningBasketPathParams = dataclasses.field()
    security: GetSigningBasketSecurity = dataclasses.field()
...
class GetSigningBasketResponse:
    ...
    signing_basket_response_200: Optional[shared_signingbasketresponse_200.SigningBasketResponse200] = dataclasses.field(default=None)
