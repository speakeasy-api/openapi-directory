...
class GoogleCloudRecommenderV1beta1ReliabilityProjection:
    ...
    risks: Optional[list[GoogleCloudRecommenderV1beta1ReliabilityProjectionRisksEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('risks'), 'exclude': lambda f: f is None }})
