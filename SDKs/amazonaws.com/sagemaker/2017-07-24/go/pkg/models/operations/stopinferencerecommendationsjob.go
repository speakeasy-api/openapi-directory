...
type StopInferenceRecommendationsJobHeaders struct {
...
type StopInferenceRecommendationsJobRequest struct {
	Headers StopInferenceRecommendationsJobHeaders
	Request shared.StopInferenceRecommendationsJobRequest `request:"mediaType=application/json"`
}
