...
public class UpdateFirewallRuleResponse {
    ...
    public UpdateFirewallRuleResponse withStatusCode(Long statusCode) {
    ...
    public openapisdk.models.shared.UpdateFirewallRuleResponse updateFirewallRuleResponse;
    public UpdateFirewallRuleResponse withUpdateFirewallRuleResponse(openapisdk.models.shared.UpdateFirewallRuleResponse updateFirewallRuleResponse) {
