...
func (e CreateUploadRequestBodyTypeEnum) ToPointer() *CreateUploadRequestBodyTypeEnum {
	return &e
}
...
func (e *CreateUploadRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "custom_emoji":
		fallthrough
	case "composer":
		*e = CreateUploadRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateUploadRequestBodyTypeEnum: %v", v)
	}
}
