...
var Roles = /** @class */ (function () {
     ...
     */
    Roles.prototype.getClassificationsRoles = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetClassificationsRolesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/classifications/roles";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetClassificationsRolesResponse({
