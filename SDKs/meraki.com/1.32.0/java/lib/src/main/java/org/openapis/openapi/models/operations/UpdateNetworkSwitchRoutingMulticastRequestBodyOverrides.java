...
public class UpdateNetworkSwitchRoutingMulticastRequestBodyOverrides {
    ...
    public UpdateNetworkSwitchRoutingMulticastRequestBodyOverrides(@JsonProperty("floodUnknownMulticastTrafficEnabled") Boolean floodUnknownMulticastTrafficEnabled, @JsonProperty("igmpSnoopingEnabled") Boolean igmpSnoopingEnabled) {
        this.floodUnknownMulticastTrafficEnabled = floodUnknownMulticastTrafficEnabled;
        this.igmpSnoopingEnabled = igmpSnoopingEnabled;
  }
}
