...
class EstimationActivityAPIModel:
    ...
    estimation_number: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('EstimationNumber'), 'exclude': lambda f: f is None }})
    r"""Indicates to which estimation this activity refers to"""  
    id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Id'), 'exclude': lambda f: f is None }})
    r"""Id of estimation activity"""  
    ...
    type: Optional[EstimationActivityAPIModelTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Type'), 'exclude': lambda f: f is None }})
    r"""Type of the activity"""  
