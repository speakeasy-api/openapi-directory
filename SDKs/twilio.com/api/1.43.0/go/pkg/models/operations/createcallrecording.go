...
func (e CreateCallRecordingCreateCallRecordingRequestRecordingStatusCallbackMethodEnum) ToPointer() *CreateCallRecordingCreateCallRecordingRequestRecordingStatusCallbackMethodEnum {
	return &e
}
...
func (e *CreateCallRecordingCreateCallRecordingRequestRecordingStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = CreateCallRecordingCreateCallRecordingRequestRecordingStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateCallRecordingCreateCallRecordingRequestRecordingStatusCallbackMethodEnum: %v", v)
	}
}
