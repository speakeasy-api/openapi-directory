...
var Reviews = /** @class */ (function () {
    ...
    **/
    Reviews.prototype.androidpublisherReviewsGet = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/{packageName}/reviews/{reviewId}", req.pathParams);
    ...
    **/
    Reviews.prototype.androidpublisherReviewsList = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{packageName}/reviews", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
    ...
    **/
    Reviews.prototype.androidpublisherReviewsReply = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/{packageName}/reviews/{reviewId}:reply", req.pathParams);
