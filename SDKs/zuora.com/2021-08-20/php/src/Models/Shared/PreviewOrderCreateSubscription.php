...
class PreviewOrderCreateSubscription
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount $newSubscriptionOwnerAccount
     */
	#[\JMS\Serializer\Annotation\SerializedName('newSubscriptionOwnerAccount')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PreviewOrderCreateSubscriptionNewSubscriptionOwnerAccount $newSubscriptionOwnerAccount = null;
     ...
     * 
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Shared\PreviewOrderRatePlanOverride> $subscribeToRatePlans
     */
	#[\JMS\Serializer\Annotation\SerializedName('subscribeToRatePlans')]
    #[\JMS\Serializer\Annotation\Type('array<OpenAPI\OpenAPI\Models\Shared\PreviewOrderRatePlanOverride>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTerms $terms
     */
	#[\JMS\Serializer\Annotation\SerializedName('terms')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\PreviewOrderCreateSubscriptionTerms')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PreviewOrderCreateSubscriptionTerms $terms = null;
