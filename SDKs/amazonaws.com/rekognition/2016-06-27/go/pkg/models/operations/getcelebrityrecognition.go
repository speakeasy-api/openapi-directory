...
func (e GetCelebrityRecognitionXAmzTargetEnum) ToPointer() *GetCelebrityRecognitionXAmzTargetEnum {
	return &e
}
...
func (e *GetCelebrityRecognitionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "RekognitionService.GetCelebrityRecognition":
		*e = GetCelebrityRecognitionXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetCelebrityRecognitionXAmzTargetEnum: %v", v)
	}
}
