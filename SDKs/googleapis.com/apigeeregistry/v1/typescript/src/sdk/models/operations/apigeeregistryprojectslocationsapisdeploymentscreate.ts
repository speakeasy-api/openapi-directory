...
export class ApigeeregistryProjectsLocationsApisDeploymentsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ApigeeregistryProjectsLocationsApisDeploymentsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ApigeeregistryProjectsLocationsApisDeploymentsCreateResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
