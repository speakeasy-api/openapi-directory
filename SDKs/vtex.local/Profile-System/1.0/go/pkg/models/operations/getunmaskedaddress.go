...
type GetUnmaskedAddressPathParams struct {
...
type GetUnmaskedAddressQueryParams struct {
...
type GetUnmaskedAddressHeaders struct {
...
type GetUnmaskedAddressRequest struct {
	PathParams  GetUnmaskedAddressPathParams
	QueryParams GetUnmaskedAddressQueryParams
	Headers     GetUnmaskedAddressHeaders
}

type GetUnmaskedAddressResponse struct {
	ContentType string
	// OK
	GetUnmaskedAddress200ApplicationJSONObject map[string]interface{}
	StatusCode                                 int
