...
export class GetConnectorsIdConnectorSourcesIdSourceRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetConnectorsIdConnectorSourcesIdSourceResponse extends SpeakeasyBase {
  /**
