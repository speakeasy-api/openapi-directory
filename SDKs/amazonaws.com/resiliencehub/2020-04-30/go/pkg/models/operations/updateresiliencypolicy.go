...
type UpdateResiliencyPolicyHeaders struct {
...
type UpdateResiliencyPolicyRequest struct {
	Headers UpdateResiliencyPolicyHeaders
	Request UpdateResiliencyPolicyRequestBody `request:"mediaType=application/json"`
}
