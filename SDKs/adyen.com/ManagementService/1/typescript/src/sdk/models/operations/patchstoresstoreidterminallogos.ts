...
export class PatchStoresStoreIdTerminalLogosSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PatchStoresStoreIdTerminalLogosRequest extends SpeakeasyBase {
...
export class PatchStoresStoreIdTerminalLogosResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
