...
class GetRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDPathParams = dataclasses.field()
    security: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDSecurity = dataclasses.field()
