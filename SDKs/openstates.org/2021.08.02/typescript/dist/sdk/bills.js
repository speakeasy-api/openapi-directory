...
var Bills = /** @class */ (function () {
    function Bills(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Bills.prototype.billDetailBillsJurisdictionSessionBillIdGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BillDetailBillsJurisdictionSessionBillIdGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/bills/{jurisdiction}/{session}/{bill_id}", req.pathParams);
    ...
    **/
    Bills.prototype.billDetailByIdBillsOcdBillOpenstatesBillIdGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BillDetailByIdBillsOcdBillOpenstatesBillIdGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/bills/ocd-bill/{openstates_bill_id}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    **/
    Bills.prototype.billsSearchBillsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BillsSearchBillsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/bills";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.getHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.billList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 422:
                    if (utils.matchContentType(contentType, "application/json")) {
