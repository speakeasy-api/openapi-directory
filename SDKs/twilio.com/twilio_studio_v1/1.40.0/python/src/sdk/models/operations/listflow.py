...
class ListFlowListFlowResponse:
    ...
    flows: Optional[list[shared_studio_v1_flow.StudioV1Flow]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flows'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListFlowListFlowResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
