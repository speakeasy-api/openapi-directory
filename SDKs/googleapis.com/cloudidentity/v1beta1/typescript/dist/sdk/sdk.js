...
var inboundsamlssoprofiles_1 = require("./inboundsamlssoprofiles");
var inboundssoassignments_1 = require("./inboundssoassignments");
var orgunits_1 = require("./orgunits");
var axios_1 = __importDefault(require("axios"));
/**
 * Contains the list of servers available to the SDK
 */
exports.ServerList = ["https://cloudidentity.googleapis.com/"];
/**
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.inboundSamlSsoProfiles = new inboundsamlssoprofiles_1.InboundSamlSsoProfiles(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.inboundSsoAssignments = new inboundssoassignments_1.InboundSsoAssignments(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
