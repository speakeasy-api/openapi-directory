...
public class ListMapsRequestBody {
    /**
    ...
    public ListMapsRequestBody withMaxResults(Long maxResults) {
    ...
    public ListMapsRequestBody withNextToken(String nextToken) {
        this.nextToken = nextToken;
        return this;
    }
    
    public ListMapsRequestBody(){}
}
