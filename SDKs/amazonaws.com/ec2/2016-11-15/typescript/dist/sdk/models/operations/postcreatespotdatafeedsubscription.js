...
exports.POSTCreateSpotDatafeedSubscriptionResponse = exports.POSTCreateSpotDatafeedSubscriptionRequest = exports.POSTCreateSpotDatafeedSubscriptionVersionEnum = exports.POSTCreateSpotDatafeedSubscriptionActionEnum = void 0;
...
var POSTCreateSpotDatafeedSubscriptionRequest = /** @class */ (function (_super) {
    ...
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "action", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=text/xml" }),
        __metadata("design:type", Uint8Array)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Version",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "version", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], POSTCreateSpotDatafeedSubscriptionRequest.prototype, "xAmzSignedHeaders", void 0);
...
var POSTCreateSpotDatafeedSubscriptionResponse = /** @class */ (function (_super) {
    ...
    ], POSTCreateSpotDatafeedSubscriptionResponse.prototype, "rawResponse", void 0);
