...
class ListNetworkAccessProfileListNetworkAccessProfileResponse:
    ...
    meta: Optional[ListNetworkAccessProfileListNetworkAccessProfileResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    network_access_profiles: Optional[list[shared_supersim_v1_network_access_profile.SupersimV1NetworkAccessProfile]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('network_access_profiles'), 'exclude': lambda f: f is None }})  
