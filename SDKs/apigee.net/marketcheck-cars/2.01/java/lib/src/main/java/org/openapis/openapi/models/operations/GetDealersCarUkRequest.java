...
public class GetDealersCarUkRequest {
    ...
    public GetDealersCarUkRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public String city;
    public GetDealersCarUkRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetDealersCarUkRequest withCountry(org.openapis.openapi.models.shared.NonDefaultCountryEnum country) {
    ...
    public GetDealersCarUkRequest withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public GetDealersCarUkRequest withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetDealersCarUkRequest withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetDealersCarUkRequest withInventoryUrl(String inventoryUrl) {
    ...
    public GetDealersCarUkRequest withLatitude(Double latitude) {
    ...
    public GetDealersCarUkRequest withListingCountRange(String listingCountRange) {
    ...
    public GetDealersCarUkRequest withLongitude(Double longitude) {
    ...
    public GetDealersCarUkRequest withPostalCode(String postalCode) {
    ...
    public GetDealersCarUkRequest withProvider(Boolean provider) {
    ...
    public GetDealersCarUkRequest withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetDealersCarUkRequest withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetDealersCarUkRequest withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDealersCarUkRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetDealersCarUkRequest withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetDealersCarUkRequest withStart(Integer start) {
        this.start = start;
        return this;
    }
