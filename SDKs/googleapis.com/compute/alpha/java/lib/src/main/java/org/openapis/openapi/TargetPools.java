...
public class TargetPools {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputeTargetPoolsTestIamPermissionsResponse computeTargetPoolsTestIamPermissions(org.openapis.openapi.models.operations.ComputeTargetPoolsTestIamPermissionsRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputeTargetPoolsTestIamPermissionsPathParams.class, baseUrl, "/projects/{project}/regions/{region}/targetPools/{resource}/testIamPermissions", request.pathParams, null);
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputeTargetPoolsTestIamPermissionsQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
