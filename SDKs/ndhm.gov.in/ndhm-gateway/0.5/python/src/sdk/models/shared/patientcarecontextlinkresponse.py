...
class PatientCareContextLinkResponseAcknowledgement:
    status: PatientCareContextLinkResponseAcknowledgementStatusEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class PatientCareContextLinkResponse:
    ...
    acknowledgement: Optional[PatientCareContextLinkResponseAcknowledgement] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
