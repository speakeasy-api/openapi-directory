...
export class AdvisorynotificationsOrganizationsLocationsNotificationsGetSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdvisorynotificationsOrganizationsLocationsNotificationsGetRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdvisorynotificationsOrganizationsLocationsNotificationsGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
