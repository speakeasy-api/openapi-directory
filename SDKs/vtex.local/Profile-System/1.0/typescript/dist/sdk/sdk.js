...
var prospects_1 = require("./prospects");
var purchaseinformation_1 = require("./purchaseinformation");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.prospects = new prospects_1.Prospects(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.purchaseInformation = new purchaseinformation_1.PurchaseInformation(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
