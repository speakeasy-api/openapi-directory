...
class AuthorizationValue:
    ...
    url_matcher: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('urlMatcher'), 'exclude': lambda f: f is None }})  
