...
export class GetModelCaseAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetModelCaseAssociationsQueryParams extends SpeakeasyBase {
...
export class GetModelCaseAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetModelCaseAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
