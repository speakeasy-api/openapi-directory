...
class CreateCapacityReservationFleetResultFleetCapacityReservationsInstancePlatformEnum(str, Enum):
...
class CreateCapacityReservationFleetResultFleetCapacityReservationsInstanceTypeEnum(str, Enum):
    r"""The instance type for which the Capacity Reservation reserves capacity."""
    A1_MEDIUM = 'a1.medium'
    A1_LARGE = 'a1.large'
    A1_XLARGE = 'a1.xlarge'
...
class CreateCapacityReservationFleetResultFleetCapacityReservations:
    r"""Information about a Capacity Reservation in a Capacity Reservation Fleet."""
    ...
    instance_platform: Optional[CreateCapacityReservationFleetResultFleetCapacityReservationsInstancePlatformEnum] = dataclasses.field(default=None)  
    instance_type: Optional[CreateCapacityReservationFleetResultFleetCapacityReservationsInstanceTypeEnum] = dataclasses.field(default=None)  
...
class CreateCapacityReservationFleetResultInstanceMatchCriteriaEnum(str, Enum):
    r"""The instance matching criteria for the Capacity Reservation Fleet."""
    OPEN = 'open'

class CreateCapacityReservationFleetResultStateEnum(str, Enum):
    r"""The status of the Capacity Reservation Fleet."""
    SUBMITTED = 'submitted'
    MODIFYING = 'modifying'
    ACTIVE = 'active'
...
@dataclasses.dataclass
class CreateCapacityReservationFleetResultTags:
    r"""Describes a tag."""
    
    key: Optional[str] = dataclasses.field(default=None)  
    value: Optional[str] = dataclasses.field(default=None)  
    
class CreateCapacityReservationFleetResultTenancyEnum(str, Enum):
    r"""Indicates the tenancy of Capacity Reservation Fleet."""
    DEFAULT = 'default'
...
class CreateCapacityReservationFleetResult:
    ...
    allocation_strategy: Optional[str] = dataclasses.field(default=None)  
    ...
    fleet_capacity_reservations: Optional[list[CreateCapacityReservationFleetResultFleetCapacityReservations]] = dataclasses.field(default=None)  
    instance_match_criteria: Optional[CreateCapacityReservationFleetResultInstanceMatchCriteriaEnum] = dataclasses.field(default=None)  
    state: Optional[CreateCapacityReservationFleetResultStateEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateCapacityReservationFleetResultTags]] = dataclasses.field(default=None)  
    tenancy: Optional[CreateCapacityReservationFleetResultTenancyEnum] = dataclasses.field(default=None)  
    total_fulfilled_capacity: Optional[float] = dataclasses.field(default=None)  
