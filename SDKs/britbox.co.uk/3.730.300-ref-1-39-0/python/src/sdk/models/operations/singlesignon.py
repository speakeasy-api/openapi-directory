...
from ..shared import singlesignonrequest as shared_singlesignonrequest
...
class SingleSignOnRequest:
    ...
    single_sign_on_request: shared_singlesignonrequest.SingleSignOnRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
