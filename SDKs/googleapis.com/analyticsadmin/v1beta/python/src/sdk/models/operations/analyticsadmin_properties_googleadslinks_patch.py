...
class AnalyticsadminPropertiesGoogleAdsLinksPatchPathParams:
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class AnalyticsadminPropertiesGoogleAdsLinksPatchQueryParams:
...
class AnalyticsadminPropertiesGoogleAdsLinksPatchRequest:
    path_params: AnalyticsadminPropertiesGoogleAdsLinksPatchPathParams = dataclasses.field()
    query_params: AnalyticsadminPropertiesGoogleAdsLinksPatchQueryParams = dataclasses.field()
    security: AnalyticsadminPropertiesGoogleAdsLinksPatchSecurity = dataclasses.field()
