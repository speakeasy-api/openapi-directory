...
func (e UploadDatasetSyncRequestBodyTypeEnum) ToPointer() *UploadDatasetSyncRequestBodyTypeEnum {
	return &e
}
...
func (e *UploadDatasetSyncRequestBodyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "text-intent":
		fallthrough
	case "text-sentiment":
		*e = UploadDatasetSyncRequestBodyTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for UploadDatasetSyncRequestBodyTypeEnum: %v", v)
	}
}
