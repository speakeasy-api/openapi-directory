...
from ..shared import googlecloudvisionv1p2beta1paragraph as shared_googlecloudvisionv1p2beta1paragraph
...
class GoogleCloudVisionV1p2beta1Block:
    ...
    block_type: Optional[GoogleCloudVisionV1p2beta1BlockBlockTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('blockType') }})
    ...
    paragraphs: Optional[list[shared_googlecloudvisionv1p2beta1paragraph.GoogleCloudVisionV1p2beta1Paragraph]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paragraphs') }})
