...
exports.ProceduresListResponse = exports.ProceduresList200ApplicationJSON = exports.ProceduresListRequest = exports.ProceduresListSecurity = void 0;
...
var ProceduresListRequest = /** @class */ (function (_super) {
    ...
    ], ProceduresListRequest.prototype, "appointment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cursor",
        }),
        __metadata("design:type", String)
    ], ProceduresListRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], ProceduresListRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=mu_date",
        }),
        __metadata("design:type", String)
    ], ProceduresListRequest.prototype, "muDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=mu_date_range",
        }),
        __metadata("design:type", String)
    ], ProceduresListRequest.prototype, "muDateRange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], ProceduresListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], ProceduresListRequest.prototype, "patient", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=service_date",
        }),
        __metadata("design:type", String)
    ], ProceduresListRequest.prototype, "serviceDate", void 0);
...
var ProceduresList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.BillingLineItem }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.BillingLineItem; }),
...
var ProceduresListResponse = /** @class */ (function (_super) {
    ...
    ], ProceduresListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
