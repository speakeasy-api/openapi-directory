 ...
 */
export enum CreateLocalGatewayRouteTableRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateLocalGatewayRouteTableRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateLocalGatewayRouteTableRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateLocalGatewayRouteTableRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
