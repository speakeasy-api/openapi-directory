 ...
 */
export enum PurchaseHostReservationRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class PurchaseHostReservationRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class PurchaseHostReservationRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PurchaseHostReservationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
