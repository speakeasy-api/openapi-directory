...
export class RoutineInput extends SpeakeasyBase {
   ...
   * Optional.
   */
  @SpeakeasyMetadata({ elemType: Argument })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "remoteFunctionOptions" })
