...
func (e VideoV1RecordingStatusCallbackMethodEnum) ToPointer() *VideoV1RecordingStatusCallbackMethodEnum {
	return &e
}
...
func (e *VideoV1RecordingStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = VideoV1RecordingStatusCallbackMethodEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for VideoV1RecordingStatusCallbackMethodEnum: %v", v)
	}
}
