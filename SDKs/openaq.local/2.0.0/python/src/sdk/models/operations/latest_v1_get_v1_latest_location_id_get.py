...
class LatestV1GetV1LatestLocationIDGetOrderByLocationsOrderEnum(str, Enum):
    r"""An enumeration."""
    CITY = 'city'
    COUNTRY = 'country'
    LOCATION = 'location'
...
class LatestV1GetV1LatestLocationIDGetSortSortEnum(str, Enum):
    r"""An enumeration."""
    ASC = 'asc'
    DESC = 'desc'
...
class LatestV1GetV1LatestLocationIDGetRequest:
    ...
    order_by: Optional[LatestV1GetV1LatestLocationIDGetOrderByLocationsOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
    r"""Order by a field"""  
    ...
    r"""Type of Sensor"""  
    sort: Optional[LatestV1GetV1LatestLocationIDGetSortSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    r"""Sort Direction"""  
