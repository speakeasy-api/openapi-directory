...
exports.GetTagFromEmployerResponse = exports.GetTagFromEmployerRequest = void 0;
...
var GetTagFromEmployerRequest = /** @class */ (function (_super) {
    ...
    ], GetTagFromEmployerRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetTagFromEmployerRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetTagFromEmployerRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=TagId",
        }),
        __metadata("design:type", String)
    ], GetTagFromEmployerRequest.prototype, "tagId", void 0);
    return GetTagFromEmployerRequest;
}(utils_1.SpeakeasyBase));
exports.GetTagFromEmployerRequest = GetTagFromEmployerRequest;
var GetTagFromEmployerResponse = /** @class */ (function (_super) {
    ...
    ], GetTagFromEmployerResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.GetTagFromEmployerResponse = GetTagFromEmployerResponse;
