...
func (e PostV1VerificationSendFormatEnum) ToPointer() *PostV1VerificationSendFormatEnum {
	return &e
}
...
func (e *PostV1VerificationSendFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "json":
		fallthrough
	case "xml":
		*e = PostV1VerificationSendFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostV1VerificationSendFormatEnum: %v", v)
	}
}
