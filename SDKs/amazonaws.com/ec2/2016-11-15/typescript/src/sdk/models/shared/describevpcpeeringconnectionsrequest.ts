 ...
 */
export class DescribeVpcPeeringConnectionsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVpcPeeringConnectionsRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: DescribeVpcPeeringConnectionsRequestFilters })
  filters?: DescribeVpcPeeringConnectionsRequestFilters[];
