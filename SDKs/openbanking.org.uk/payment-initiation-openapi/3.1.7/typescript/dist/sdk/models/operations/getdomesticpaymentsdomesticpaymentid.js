...
exports.GetDomesticPaymentsDomesticPaymentIdResponse = exports.GetDomesticPaymentsDomesticPaymentIdRequest = exports.GetDomesticPaymentsDomesticPaymentIdSecurity = void 0;
...
exports.GetDomesticPaymentsDomesticPaymentIdSecurity = GetDomesticPaymentsDomesticPaymentIdSecurity;
var GetDomesticPaymentsDomesticPaymentIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomesticPaymentId",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdRequest.prototype, "domesticPaymentId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetDomesticPaymentsDomesticPaymentIdRequest.prototype, "xFapiInteractionId", void 0);
    return GetDomesticPaymentsDomesticPaymentIdRequest;
}(utils_1.SpeakeasyBase));
exports.GetDomesticPaymentsDomesticPaymentIdRequest = GetDomesticPaymentsDomesticPaymentIdRequest;
var GetDomesticPaymentsDomesticPaymentIdResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetDomesticPaymentsDomesticPaymentIdResponse.prototype, "rawResponse", void 0);
    return GetDomesticPaymentsDomesticPaymentIdResponse;
}(utils_1.SpeakeasyBase));
exports.GetDomesticPaymentsDomesticPaymentIdResponse = GetDomesticPaymentsDomesticPaymentIdResponse;
