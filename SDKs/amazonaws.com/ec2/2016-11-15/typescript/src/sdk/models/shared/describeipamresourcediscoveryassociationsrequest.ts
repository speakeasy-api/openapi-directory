 ...
 */
export class DescribeIpamResourceDiscoveryAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeIpamResourceDiscoveryAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
