...
exports.PutHooksIdJsonResponse = exports.PutHooksIdJsonRequest = void 0;
...
var PutHooksIdJsonRequest = /** @class */ (function (_super) {
    ...
    ], PutHooksIdJsonRequest.prototype, "hookEdit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=authtoken",
        }),
        __metadata("design:type", String)
    ], PutHooksIdJsonRequest.prototype, "authtoken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], PutHooksIdJsonRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutHooksIdJsonRequest.prototype, "login", void 0);
    return PutHooksIdJsonRequest;
}(utils_1.SpeakeasyBase));
exports.PutHooksIdJsonRequest = PutHooksIdJsonRequest;
var PutHooksIdJsonResponse = /** @class */ (function (_super) {
    ...
    ], PutHooksIdJsonResponse.prototype, "rawResponse", void 0);
    return PutHooksIdJsonResponse;
}(utils_1.SpeakeasyBase));
exports.PutHooksIdJsonResponse = PutHooksIdJsonResponse;
