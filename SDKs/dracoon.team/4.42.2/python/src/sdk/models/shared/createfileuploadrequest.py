...
class CreateFileUploadRequestClassificationEnum(str, Enum):
    r"""Classification ID:
...
class CreateFileUploadRequest:
    ...
    classification: Optional[CreateFileUploadRequestClassificationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('classification'), 'exclude': lambda f: f is None }})
    r"""Classification ID:
