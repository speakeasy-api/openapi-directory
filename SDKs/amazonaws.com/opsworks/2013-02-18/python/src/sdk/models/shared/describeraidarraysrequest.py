...
class DescribeRaidArraysRequest:
    ...
    raid_array_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RaidArrayIds'), 'exclude': lambda f: f is None }})  
