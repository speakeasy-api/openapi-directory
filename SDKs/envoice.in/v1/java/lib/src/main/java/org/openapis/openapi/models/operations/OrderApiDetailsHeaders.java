...
public class OrderApiDetailsHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiDetailsHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiDetailsHeaders withXAuthSecret(String xAuthSecret) {
