 ...
 */
public enum CreateVpcEndpointServiceConfigurationRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateVpcEndpointServiceConfigurationRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
