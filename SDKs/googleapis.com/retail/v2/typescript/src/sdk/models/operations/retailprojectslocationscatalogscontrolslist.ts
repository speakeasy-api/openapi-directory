...
export class RetailProjectsLocationsCatalogsControlsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsControlsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsControlsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
