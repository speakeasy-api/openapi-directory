...
class GetNetworksID200ApplicationJSONNetworkSubnets:
    ...
    type: GetNetworksID200ApplicationJSONNetworkSubnetsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of Subnetwork"""  
...
class GetNetworksID200ApplicationJSONNetwork:
    ...
    protection: GetNetworksID200ApplicationJSONNetworkProtection = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protection') }})
    r"""Protection configuration for the Network"""  
    routes: list[GetNetworksID200ApplicationJSONNetworkRoutes] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('routes') }})
    ...
    subnets: list[GetNetworksID200ApplicationJSONNetworkSubnets] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subnets') }})
...
class GetNetworksID200ApplicationJSON:
    r"""The `network` key contains the network"""
    
    network: Optional[GetNetworksID200ApplicationJSONNetwork] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('network'), 'exclude': lambda f: f is None }})  
