...
exports.ListSmsCommandResponse = exports.ListSmsCommandListSmsCommandResponse = exports.ListSmsCommandListSmsCommandResponseMeta = exports.ListSmsCommandRequest = exports.ListSmsCommandSecurity = exports.ListSmsCommandServerList = void 0;
...
var ListSmsCommandSecurity = /** @class */ (function (_super) {
    ...
    ], ListSmsCommandSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSmsCommandSecurity.prototype, "username", void 0);
...
var ListSmsCommandRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSmsCommandRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSmsCommandRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSmsCommandRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSmsCommandRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Sim" }),
        __metadata("design:type", String)
    ], ListSmsCommandRequest.prototype, "sim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListSmsCommandRequest.prototype, "status", void 0);
...
var ListSmsCommandListSmsCommandResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListSmsCommandListSmsCommandResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SupersimV1SmsCommand }),
        (0, class_transformer_1.Expose)({ name: "sms_commands" }),
        (0, class_transformer_1.Type)(function () { return shared.SupersimV1SmsCommand; }),
...
var ListSmsCommandResponse = /** @class */ (function (_super) {
    ...
    ], ListSmsCommandResponse.prototype, "rawResponse", void 0);
