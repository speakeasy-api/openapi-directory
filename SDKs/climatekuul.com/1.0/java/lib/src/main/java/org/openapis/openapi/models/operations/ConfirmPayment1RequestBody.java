...
public class ConfirmPayment1RequestBody {
    ...
    public ConfirmPayment1RequestBody(@JsonProperty("apiKey_l1") String apiKeyL1, @JsonProperty("apiKey_l2") String apiKeyL2, @JsonProperty("confirmPayment") String confirmPayment, @JsonProperty("paymentID") Integer paymentID, @JsonProperty("transaction_id") String transactionId) {
        this.apiKeyL1 = apiKeyL1;
        this.apiKeyL2 = apiKeyL2;
        this.confirmPayment = confirmPayment;
        this.paymentID = paymentID;
