...
var NumberSystemsConversion = /** @class */ (function () {
    ...
    **/
    NumberSystemsConversion.prototype.getNumbersNumeralChinese = function (req, config) {
    ...
    **/
    NumberSystemsConversion.prototype.getNumbersNumeralEgyptian = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    NumberSystemsConversion.prototype.getNumbersNumeralRoman = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
