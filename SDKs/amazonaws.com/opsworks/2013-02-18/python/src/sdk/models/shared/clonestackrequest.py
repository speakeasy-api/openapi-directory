...
class CloneStackRequest:
    ...
    source_stack_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SourceStackId') }})
    ...
    clone_app_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CloneAppIds') }})
    clone_permissions: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ClonePermissions') }})
