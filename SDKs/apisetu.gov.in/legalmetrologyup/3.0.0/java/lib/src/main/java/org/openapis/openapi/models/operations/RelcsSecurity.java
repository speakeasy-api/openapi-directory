...
public class RelcsSecurity {
    ...
    public RelcsSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public RelcsSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public RelcsSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
