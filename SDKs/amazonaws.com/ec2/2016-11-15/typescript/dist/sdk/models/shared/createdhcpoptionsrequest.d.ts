...
export declare class CreateDhcpOptionsRequestDhcpConfigurations extends SpeakeasyBase {
    key?: string;
    values?: string[];
}
/**
 ...
 */
export declare enum CreateDhcpOptionsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateDhcpOptionsRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateDhcpOptionsRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateDhcpOptionsRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateDhcpOptionsRequestTagSpecificationsTags[];
}
export declare class CreateDhcpOptionsRequest extends SpeakeasyBase {
