...
public class GetSelectedQueryParams {
    ...
    public GetSelectedQueryParams withCountry(org.openapis.openapi.models.shared.CountryEnum country) {
    ...
    public GetSelectedQueryParams withDevice(org.openapis.openapi.models.shared.DeviceEnum device) {
        this.device = device;
        return this;
    }
    ...
    public GetSelectedQueryParams withErrorOn404(Boolean errorOn404) {
    ...
    public GetSelectedQueryParams withErrorOnRedirect(Boolean errorOnRedirect) {
    ...
    public GetSelectedQueryParams withJsTimeout(Long jsTimeout) {
    ...
    public GetSelectedQueryParams withProxy(org.openapis.openapi.models.shared.ProxyEnum proxy) {
        this.proxy = proxy;
        return this;
    }
