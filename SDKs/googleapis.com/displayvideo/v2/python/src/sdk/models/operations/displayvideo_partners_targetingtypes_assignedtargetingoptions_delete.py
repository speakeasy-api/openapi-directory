...
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteSecurity:
    
    oauth2: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2', 'field_name': 'Authorization' }})  
    oauth2c: str = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2', 'field_name': 'Authorization' }})  
    
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum(str, Enum):
    r"""Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL`"""
...
@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteRequest:
    ...
    r"""Required. The ID of the assigned targeting option to delete."""  
    ...
    targeting_type: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum = dataclasses.field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    r"""Required. Identifies the type of this assigned targeting option. Supported targeting types: * `TARGETING_TYPE_CHANNEL`"""  
...
@dataclasses.dataclass
class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteResponse:
