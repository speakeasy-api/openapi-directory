...
class Adexchangebuyer2AccountsProposalsUpdateRequest:
    ...
    r"""The unique ID of the proposal."""  
    ...
    proposal_input: Optional[shared_proposal.ProposalInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
