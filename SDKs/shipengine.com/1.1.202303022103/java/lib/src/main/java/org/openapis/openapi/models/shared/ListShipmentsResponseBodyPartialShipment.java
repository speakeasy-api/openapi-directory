...
public class ListShipmentsResponseBodyPartialShipment {
    ...
    public ListShipmentsResponseBodyPartialShipmentDeliveryConfirmationEnum confirmation;
    public ListShipmentsResponseBodyPartialShipment withConfirmation(ListShipmentsResponseBodyPartialShipmentDeliveryConfirmationEnum confirmation) {
    ...
    public ListShipmentsResponseBodyPartialShipment withCreatedAt(OffsetDateTime createdAt) {
    ...
    public ListShipmentsResponseBodyPartialShipmentInsuranceProviderEnum insuranceProvider;
    public ListShipmentsResponseBodyPartialShipment withInsuranceProvider(ListShipmentsResponseBodyPartialShipmentInsuranceProviderEnum insuranceProvider) {
    ...
    public ListShipmentsResponseBodyPartialShipment withModifiedAt(OffsetDateTime modifiedAt) {
    ...
    public ListShipmentsResponseBodyPartialShipmentOriginTypeEnum originType;
    public ListShipmentsResponseBodyPartialShipment withOriginType(ListShipmentsResponseBodyPartialShipmentOriginTypeEnum originType) {
    ...
    public ListShipmentsResponseBodyPartialShipment withReturnTo(ShippingAddress returnTo) {
    ...
    public ListShipmentsResponseBodyPartialShipment withShipFrom(ShippingAddress shipFrom) {
    ...
    public ListShipmentsResponseBodyPartialShipment withShipTo(ShippingAddress shipTo) {
        this.shipTo = shipTo;
        return this;
    }
    ...
    public ListShipmentsResponseBodyPartialShipment withShipmentId(String shipmentId) {
    ...
    public ListShipmentsResponseBodyPartialShipment withShipmentNumber(String shipmentNumber) {
    ...
    public ListShipmentsResponseBodyPartialShipmentShipmentStatusEnum shipmentStatus;
    public ListShipmentsResponseBodyPartialShipment withShipmentStatus(ListShipmentsResponseBodyPartialShipmentShipmentStatusEnum shipmentStatus) {
    ...
    public ListShipmentsResponseBodyPartialShipment withTaxIdentifiers(TaxIdentifier[] taxIdentifiers) {
    ...
    public ListShipmentsResponseBodyPartialShipment withWarehouseId(String warehouseId) {
