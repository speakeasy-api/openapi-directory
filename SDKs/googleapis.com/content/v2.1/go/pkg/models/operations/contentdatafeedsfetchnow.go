...
type ContentDatafeedsFetchnowSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentDatafeedsFetchnowPathParams struct {
...
type ContentDatafeedsFetchnowQueryParams struct {
	// V1 error format.
...
type ContentDatafeedsFetchnowRequest struct {
...
type ContentDatafeedsFetchnowResponse struct {
	ContentType string
	// Successful response
