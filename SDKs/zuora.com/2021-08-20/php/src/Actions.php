...
class Actions 
{
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTamendRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTamendResponse
     */
	public function actionPOSTamend(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTamendRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTamendResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/amend');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActionamendRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTamendRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTamendResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json; charset=utf-8')) {
                ...
                $response->proxyActionamendResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ProxyActionamendResponse', 'json');
            }
        }
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTcreateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTcreateResponse
     */
	public function actionPOSTcreate(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTcreateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTcreateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/create');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActioncreateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTcreateRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTcreateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json; charset=utf-8')) {
                $serializer = Utils\JSON::createSerializer();
                $response->saveResults = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\SaveResult>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 401) {
            $response->headers = $httpResponse->getHeaders();
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTdeleteRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTdeleteResponse
     */
	public function actionPOSTdelete(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTdeleteRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTdeleteResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/delete');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActiondeleteRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTdeleteRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTdeleteResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json; charset=utf-8')) {
                $serializer = Utils\JSON::createSerializer();
                $response->deleteResults = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\DeleteResult>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 401) {
            $response->headers = $httpResponse->getHeaders();
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTexecuteRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTexecuteResponse
     */
	public function actionPOSTexecute(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTexecuteRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTexecuteResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/execute');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActionexecuteRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTexecuteRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTexecuteResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json; charset=utf-8')) {
                $serializer = Utils\JSON::createSerializer();
                $response->executeResults = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\ExecuteResult>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 401) {
            $response->headers = $httpResponse->getHeaders();
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTgenerateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTgenerateResponse
     */
	public function actionPOSTgenerate(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTgenerateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTgenerateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/generate');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActiongenerateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTgenerateRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTgenerateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryResponse
     */
	public function actionPOSTquery(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/query');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActionqueryRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json; charset=utf-8')) {
                $serializer = Utils\JSON::createSerializer();
                $response->proxyActionqueryResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ProxyActionqueryResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 401) {
            $response->headers = $httpResponse->getHeaders();
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryMoreRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryMoreResponse
     */
	public function actionPOSTqueryMore(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryMoreRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryMoreResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/queryMore');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActionqueryMoreRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryMoreRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTqueryMoreResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json; charset=utf-8')) {
                $serializer = Utils\JSON::createSerializer();
                $response->proxyActionqueryMoreResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ProxyActionqueryMoreResponse', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 401) {
            $response->headers = $httpResponse->getHeaders();
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTsubscribeRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTsubscribeResponse
     */
	public function actionPOSTsubscribe(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTsubscribeRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTsubscribeResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/subscribe');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActionsubscribeRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTsubscribeRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTsubscribeResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json; charset=utf-8')) {
                $serializer = Utils\JSON::createSerializer();
                $response->subscribeResults = $serializer->deserialize((string)$httpResponse->getBody(), 'array<OpenAPI\OpenAPI\Models\Shared\SubscribeResult>', 'json');
            }
        }
        else if ($httpResponse->getStatusCode() === 401) {
            $response->headers = $httpResponse->getHeaders();
     ...
     * 
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ActionPOSTupdateRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\ActionPOSTupdateResponse
     */
	public function actionPOSTupdate(
        \OpenAPI\OpenAPI\Models\Operations\ActionPOSTupdateRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\ActionPOSTupdateResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/action/update');
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "proxyActionupdateRequest", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ActionPOSTupdateRequest::class, $request, null));
        $options = array_merge_recursive($options, Utils\Utils::getHeaders($request));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ActionPOSTupdateResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
