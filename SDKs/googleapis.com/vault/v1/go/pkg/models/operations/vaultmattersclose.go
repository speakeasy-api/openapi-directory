...
type VaultMattersCloseSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type VaultMattersClosePathParams struct {
	// The matter ID.
	MatterID string `pathParam:"style=simple,explode=false,name=matterId"`
}

type VaultMattersCloseQueryParams struct {
	// V1 error format.
...
type VaultMattersCloseRequest struct {
...
type VaultMattersCloseResponse struct {
	// Successful response
