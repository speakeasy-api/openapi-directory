...
class ManagedZonesListResponse:
    ...
    r"""Type of resource."""  
    managed_zones: Optional[list[shared_managedzone.ManagedZone]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('managedZones'), 'exclude': lambda f: f is None }})
    r"""The managed zone resources."""  
