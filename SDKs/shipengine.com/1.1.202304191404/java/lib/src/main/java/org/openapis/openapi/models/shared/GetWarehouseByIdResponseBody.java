...
public class GetWarehouseByIdResponseBody {
    ...
    public GetWarehouseByIdResponseBody(@JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("name") String name, @JsonProperty("origin_address") Address originAddress, @JsonProperty("return_address") Address returnAddress, @JsonProperty("warehouse_id") String warehouseId) {
        this.createdAt = createdAt;
        this.name = name;
        this.originAddress = originAddress;
        this.returnAddress = returnAddress;
