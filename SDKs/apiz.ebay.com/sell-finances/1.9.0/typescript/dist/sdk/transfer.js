...
var Transfer = /** @class */ (function () {
    function Transfer(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Transfer.prototype.getTransfer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetTransferRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/transfer/{transfer_Id}", req.pathParams);
