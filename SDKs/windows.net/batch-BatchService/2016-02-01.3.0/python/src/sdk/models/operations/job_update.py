...
from ..shared import jobupdateparameter as shared_jobupdateparameter
...
class JobUpdateRequest:
    ...
    r"""The id of the job whose properties you want to update."""  
    job_update_parameter: shared_jobupdateparameter.JobUpdateParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
