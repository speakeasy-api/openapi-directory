 ...
 */
public enum CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTransitGatewayPeeringAttachmentRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
