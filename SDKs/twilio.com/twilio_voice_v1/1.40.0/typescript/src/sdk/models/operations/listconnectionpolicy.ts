...
export class ListConnectionPolicyListConnectionPolicyResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.VoiceV1ConnectionPolicy })
  @Expose({ name: "connection_policies" })
  @Type(() => shared.VoiceV1ConnectionPolicy)
  connectionPolicies?: shared.VoiceV1ConnectionPolicy[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListConnectionPolicyListConnectionPolicyResponseMeta)
