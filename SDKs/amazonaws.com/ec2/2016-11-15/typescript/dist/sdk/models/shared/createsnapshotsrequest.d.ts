...
import { CopyTagsFromSourceEnum } from "./copytagsfromsourceenum";
import { InstanceSpecification } from "./instancespecification";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateSnapshotsRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateSnapshotsRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateSnapshotsRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateSnapshotsRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateSnapshotsRequestTagSpecificationsTags[];
}
export declare class CreateSnapshotsRequest extends SpeakeasyBase {
