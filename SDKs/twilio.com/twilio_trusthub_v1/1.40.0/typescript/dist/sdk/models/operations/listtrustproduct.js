...
exports.ListTrustProductResponse = exports.ListTrustProductListTrustProductResponse = exports.ListTrustProductListTrustProductResponseMeta = exports.ListTrustProductRequest = exports.ListTrustProductSecurity = exports.ListTrustProductServerList = void 0;
...
var ListTrustProductSecurity = /** @class */ (function (_super) {
    ...
    ], ListTrustProductSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListTrustProductSecurity.prototype, "username", void 0);
...
var ListTrustProductRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListTrustProductRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListTrustProductRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListTrustProductRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListTrustProductRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PolicySid",
        }),
        __metadata("design:type", String)
    ], ListTrustProductRequest.prototype, "policySid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListTrustProductRequest.prototype, "status", void 0);
...
var ListTrustProductListTrustProductResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListTrustProductListTrustProductResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TrusthubV1TrustProduct }),
        (0, class_transformer_1.Expose)({ name: "results" }),
        (0, class_transformer_1.Type)(function () { return shared.TrusthubV1TrustProduct; }),
...
var ListTrustProductResponse = /** @class */ (function (_super) {
    ...
    ], ListTrustProductResponse.prototype, "rawResponse", void 0);
