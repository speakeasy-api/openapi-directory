...
exports.MeteringDecorator = void 0;
 ...
 *
 */
var MeteringDecorator = /** @class */ (function () {
    function MeteringDecorator(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
     */
    MeteringDecorator.prototype.meteringGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MeteringGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/metering/reading";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.MeteringGetResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.meteringGet200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.MeteringGet200ApplicationJSON);
                    }
                    break;
            }
            return res;
     ...
     *
     */
    MeteringDecorator.prototype.meteringPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.MeteringPostResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.meteringPost200ApplicationJSONObject = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.MeteringPost200ApplicationJSON);
                    }
                    break;
            }
            return res;
...
exports.MeteringDecorator = MeteringDecorator;
