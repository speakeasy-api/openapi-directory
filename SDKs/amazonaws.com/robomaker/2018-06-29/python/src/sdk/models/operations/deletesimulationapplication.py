...
class DeleteSimulationApplicationRequest:
    headers: DeleteSimulationApplicationHeaders = dataclasses.field()
    request: DeleteSimulationApplicationRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
