...
class PostPortfolioSimulationRebalancingFixedWeightRequestBody:
    ...
    assets: list[PostPortfolioSimulationRebalancingFixedWeightRequestBodyAssets] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assets') }})  
    portfolios: list[PostPortfolioSimulationRebalancingFixedWeightRequestBodyPortfolios] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portfolios') }})  
...
class PostPortfolioSimulationRebalancingFixedWeight200ApplicationJSON:
    ...
    portfolios: list[PostPortfolioSimulationRebalancingFixedWeight200ApplicationJSONPortfolios] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('portfolios') }})  
