...
class ListMessageInteractionRequest:
    ...
    r"""The SID of the [Participant](https://www.twilio.com/docs/proxy/api/participant) to read the resources from."""  
    service_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ServiceSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the parent [Service](https://www.twilio.com/docs/proxy/api/service) to read the resources from."""  
    session_sid: str = dataclasses.field(metadata={'path_param': { 'field_name': 'SessionSid', 'style': 'simple', 'explode': False }})
    r"""The SID of the parent [Session](https://www.twilio.com/docs/proxy/api/session) to read the resources from."""  
...
class ListMessageInteractionListMessageInteractionResponse:
    ...
    interactions: Optional[list[shared_proxy_v1_service_session_participant_message_interaction.ProxyV1ServiceSessionParticipantMessageInteraction]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('interactions'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListMessageInteractionListMessageInteractionResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
