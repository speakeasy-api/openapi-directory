...
class GetPermissionRequestBody:
    ...
    r"""Specifies identifier for the version of the RAM permission to retrieve. If you don't specify this parameter, the operation retrieves the default version."""  
    

@dataclasses.dataclass
class GetPermissionRequest:
    
    request_body: GetPermissionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
