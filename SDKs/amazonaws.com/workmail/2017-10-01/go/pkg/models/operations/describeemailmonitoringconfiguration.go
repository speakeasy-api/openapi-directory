...
func (e DescribeEmailMonitoringConfigurationXAmzTargetEnum) ToPointer() *DescribeEmailMonitoringConfigurationXAmzTargetEnum {
	return &e
}
...
func (e *DescribeEmailMonitoringConfigurationXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "WorkMailService.DescribeEmailMonitoringConfiguration":
		*e = DescribeEmailMonitoringConfigurationXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeEmailMonitoringConfigurationXAmzTargetEnum: %v", v)
	}
}
