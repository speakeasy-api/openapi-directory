...
public class POSTSetIdentityFeedbackForwardingEnabledRequest {
    ...
    public POSTSetIdentityFeedbackForwardingEnabledRequest(@JsonProperty("Action") POSTSetIdentityFeedbackForwardingEnabledActionEnum action, @JsonProperty("Version") POSTSetIdentityFeedbackForwardingEnabledVersionEnum version) {
        this.action = action;
        this.version = version;
  }
}
