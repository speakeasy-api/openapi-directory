...
var UserLinks = /** @class */ (function (_super) {
    __extends(UserLinks, _super);
    function UserLinks() {
    ...
    ], UserLinks.prototype, "projects", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=responsivity" }),
        __metadata("design:type", href_1.Href)
    ], UserLinks.prototype, "responsivity", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=self" }),
        __metadata("design:type", href_1.Href)
    ], UserLinks.prototype, "self", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=stats" }),
        __metadata("design:type", href_1.Href)
    ], UserLinks.prototype, "stats", void 0);
    return UserLinks;
