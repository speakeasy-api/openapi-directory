...
public class PUTAccountTypeSoldToContact {
    ...
    public PUTAccountTypeSoldToContact withAddress1(String address1) {
    ...
    public PUTAccountTypeSoldToContact withAddress2(String address2) {
    ...
    @JsonProperty("city")
    public String city;
    public PUTAccountTypeSoldToContact withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public PUTAccountTypeSoldToContact withCountry(String country) {
    ...
    public PUTAccountTypeSoldToContact withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    @JsonProperty("fax")
    public String fax;
    public PUTAccountTypeSoldToContact withFax(String fax) {
        this.fax = fax;
        return this;
    }
    ...
    public PUTAccountTypeSoldToContact withFirstName(String firstName) {
    ...
    public PUTAccountTypeSoldToContact withHomePhone(String homePhone) {
    ...
    public PUTAccountTypeSoldToContact withLastName(String lastName) {
    ...
    public PUTAccountTypeSoldToContact withMobilePhone(String mobilePhone) {
    ...
    public PUTAccountTypeSoldToContact withNickname(String nickname) {
    ...
    public PUTAccountTypeSoldToContact withOtherPhone(String otherPhone) {
    ...
    public PUTAccountTypeSoldToContact withOtherPhoneType(String otherPhoneType) {
    ...
    public PUTAccountTypeSoldToContact withPersonalEmail(String personalEmail) {
    ...
    @JsonProperty("state")
    public String state;
    public PUTAccountTypeSoldToContact withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public PUTAccountTypeSoldToContact withTaxRegion(String taxRegion) {
    ...
    public PUTAccountTypeSoldToContact withWorkEmail(String workEmail) {
    ...
    public PUTAccountTypeSoldToContact withWorkPhone(String workPhone) {
    ...
    public PUTAccountTypeSoldToContact withZipCode(String zipCode) {
