...
public class UpdateUserPoolClientRequest {
    ...
    public UpdateUserPoolClientRequest withAuthSessionValidity(Long authSessionValidity) {
    ...
    public UpdateUserPoolClientRequest(@JsonProperty("ClientId") String clientId, @JsonProperty("UserPoolId") String userPoolId) {
        this.clientId = clientId;
        this.userPoolId = userPoolId;
  }
}
