...
class GetListAttachedGroupPoliciesQueryParams:
    action: GetListAttachedGroupPoliciesActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    group_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'GroupName', 'style': 'form', 'explode': True }})
    version: GetListAttachedGroupPoliciesVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListAttachedGroupPoliciesRequest:
    headers: GetListAttachedGroupPoliciesHeaders = dataclasses.field()
    query_params: GetListAttachedGroupPoliciesQueryParams = dataclasses.field()
