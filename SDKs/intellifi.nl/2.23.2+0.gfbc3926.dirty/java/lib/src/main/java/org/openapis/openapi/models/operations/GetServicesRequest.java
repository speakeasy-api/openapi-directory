...
public class GetServicesRequest {
    ...
    public GetServicesRequest withAfter(OffsetDateTime after) {
        this.after = after;
        return this;
    }
    ...
    public GetServicesRequest withAfterId(String afterId) {
    ...
    public GetServicesRequest withBefore(String before) {
        this.before = before;
        return this;
    }
    ...
    public GetServicesRequest withBeforeId(String beforeId) {
    ...
    public String from;
    public GetServicesRequest withFrom(String from) {
        this.from = from;
        return this;
    }
    ...
    public GetServicesRequest withFromId(String fromId) {
        this.fromId = fromId;
        return this;
    }
    ...
    public String id;
    public GetServicesRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetServicesRequest withIdOnly(Boolean idOnly) {
        this.idOnly = idOnly;
        return this;
    }
    ...
    public Long limit;
    public GetServicesRequest withLimit(Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public String name;
    public GetServicesRequest withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public GetServicesRequest withPopulate(String populate) {
    ...
    public GetServicesRequest withResultsOnly(Boolean resultsOnly) {
    ...
    public GetServicesRequest withSelect(String select) {
        this.select = select;
        return this;
    }
    ...
    public GetServicesRequest withTimeCreated(String timeCreated) {
    ...
    public GetServicesRequest withTimeUpdated(String timeUpdated) {
    ...
    public GetServicesRequest withTimeoutS(Double timeoutS) {
    ...
    public String until;
    public GetServicesRequest withUntil(String until) {
        this.until = until;
        return this;
    }
    ...
    public GetServicesRequest withUntilId(String untilId) {
