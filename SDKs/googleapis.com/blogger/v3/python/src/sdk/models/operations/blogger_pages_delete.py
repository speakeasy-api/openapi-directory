...
@dataclasses.dataclass
class BloggerPagesDeleteQueryParams:
...
class BloggerPagesDeleteRequest:
    path_params: BloggerPagesDeletePathParams = dataclasses.field()
    query_params: BloggerPagesDeleteQueryParams = dataclasses.field()
    security: BloggerPagesDeleteSecurity = dataclasses.field()
