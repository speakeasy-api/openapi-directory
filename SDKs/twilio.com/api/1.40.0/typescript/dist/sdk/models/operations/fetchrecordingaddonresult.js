...
exports.FetchRecordingAddOnResultResponse = exports.FetchRecordingAddOnResultRequest = exports.FetchRecordingAddOnResultSecurity = exports.FetchRecordingAddOnResultServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
exports.FetchRecordingAddOnResultServerList = [
...
var FetchRecordingAddOnResultSecurity = /** @class */ (function (_super) {
    ...
    ], FetchRecordingAddOnResultSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], FetchRecordingAddOnResultSecurity.prototype, "username", void 0);
    return FetchRecordingAddOnResultSecurity;
}(utils_1.SpeakeasyBase));
exports.FetchRecordingAddOnResultSecurity = FetchRecordingAddOnResultSecurity;
var FetchRecordingAddOnResultRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], FetchRecordingAddOnResultRequest.prototype, "accountSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ReferenceSid",
        }),
        __metadata("design:type", String)
    ], FetchRecordingAddOnResultRequest.prototype, "referenceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=Sid" }),
        __metadata("design:type", String)
    ], FetchRecordingAddOnResultRequest.prototype, "sid", void 0);
    return FetchRecordingAddOnResultRequest;
}(utils_1.SpeakeasyBase));
exports.FetchRecordingAddOnResultRequest = FetchRecordingAddOnResultRequest;
var FetchRecordingAddOnResultResponse = /** @class */ (function (_super) {
    ...
    ], FetchRecordingAddOnResultResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.FetchRecordingAddOnResultResponse = FetchRecordingAddOnResultResponse;
