...
class ListServiceRoleRequest:
    ...
    r"""The SID of the [Conversation Service](https://www.twilio.com/docs/conversations/api/service-resource) to read the Role resources from."""  
...
class ListServiceRoleListServiceRoleResponse:
    ...
    meta: Optional[ListServiceRoleListServiceRoleResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    roles: Optional[list[shared_conversations_v1_service_service_role.ConversationsV1ServiceServiceRole]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('roles'), 'exclude': lambda f: f is None }})  
