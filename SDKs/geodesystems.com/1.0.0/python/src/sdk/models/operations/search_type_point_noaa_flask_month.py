...
class SearchTypePointNoaaFlaskMonthQueryParams:
    ...
    search_type_point_noaa_flask_month_lab_id_number: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_month.lab_id_number', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_month_measurement_group: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_month.measurement_group', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_month_parameter: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_month.parameter', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_month_project: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_month.project', 'style': 'form', 'explode': True }})
    search_type_point_noaa_flask_month_site_id: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_flask_month.site_id', 'style': 'form', 'explode': True }})
...
class SearchTypePointNoaaFlaskMonthRequest:
    query_params: SearchTypePointNoaaFlaskMonthQueryParams = dataclasses.field()
