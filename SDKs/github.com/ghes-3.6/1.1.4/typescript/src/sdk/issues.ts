...
export class Issues {
  ...
  issuesCheckUserCanBeAssignedToIssue(
    req: operations.IssuesCheckUserCanBeAssignedToIssueRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.IssuesCheckUserCanBeAssignedToIssueResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.IssuesCheckUserCanBeAssignedToIssueResponse =
        new operations.IssuesCheckUserCanBeAssignedToIssueResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
