...
class Firewalls 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsResponse
     */
	public function computeFirewallsTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/firewalls/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeFirewallsTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
