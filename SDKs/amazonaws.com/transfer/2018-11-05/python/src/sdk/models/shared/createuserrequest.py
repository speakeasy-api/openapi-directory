...
class CreateUserRequest:
    ...
    ssh_public_key_body: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SshPublicKeyBody'), 'exclude': lambda f: f is None }})  
