...
class ListMemberRequest:
    ...
    r"""The unique ID of the [Channel](https://www.twilio.com/docs/api/chat/rest/channels) the members to read belong to. Can be the Channel resource's `sid` or `unique_name` value."""  
...
class ListMemberListMemberResponse:
    ...
    members: Optional[list[shared_chat_v1_service_channel_member.ChatV1ServiceChannelMember]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('members'), 'exclude': lambda f: f is None }})  
