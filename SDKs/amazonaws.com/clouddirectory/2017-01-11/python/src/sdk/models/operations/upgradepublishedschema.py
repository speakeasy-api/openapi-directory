...
class UpgradePublishedSchemaRequestBody:
    development_schema_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DevelopmentSchemaArn') }})
...
class UpgradePublishedSchemaRequest:
    headers: UpgradePublishedSchemaHeaders = dataclasses.field()
    request: UpgradePublishedSchemaRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
