...
class AnomalyGroupSummary:
    r"""Details about a group of anomalous metrics."""
    ...
    anomaly_group_score: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AnomalyGroupScore'), 'exclude': lambda f: f is None }})  
    ...
    primary_metric_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('PrimaryMetricName'), 'exclude': lambda f: f is None }})  
