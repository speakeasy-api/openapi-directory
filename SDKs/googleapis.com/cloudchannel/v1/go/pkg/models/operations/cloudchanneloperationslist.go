...
type CloudchannelOperationsListFilterEnum string

const (
	CloudchannelOperationsListFilterEnumUnspecified CloudchannelOperationsListFilterEnum = "UNSPECIFIED"
	CloudchannelOperationsListFilterEnumBasic       CloudchannelOperationsListFilterEnum = "BASIC"
