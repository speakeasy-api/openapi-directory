 ...
 */
export declare enum NetworkEndpointGroupListWarningCodeEnum {
...
export declare class NetworkEndpointGroupListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkEndpointGroupListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NetworkEndpointGroupListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NetworkEndpointGroupListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class NetworkEndpointGroupList extends SpeakeasyBase {
    /**
