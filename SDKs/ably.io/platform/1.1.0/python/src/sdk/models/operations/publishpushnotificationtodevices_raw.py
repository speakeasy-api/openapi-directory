...
class PublishPushNotificationToDevicesApplicationXMsgpack:
    ...
    recipient: shared_recipient.Recipient = dataclasses.field()
    r"""Push recipient details for a device."""  
    push: Optional[shared_push.Push] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class PublishPushNotificationToDevicesRawRequest:
...
@dataclasses.dataclass
class PublishPushNotificationToDevicesRawResponse:
