 ...
 */
public class GetZRAccountSettings200ApplicationJSON2Notification {
    /**
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withAudioMeetUsabilityThreshold(Boolean audioMeetUsabilityThreshold) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withAudioNotMeetUsabilityThreshold(Boolean audioNotMeetUsabilityThreshold) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withBatteryIsCharging(Boolean batteryIsCharging) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withBatteryLowAndNotCharging(Boolean batteryLowAndNotCharging) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withBatteryPercentage(String batteryPercentage) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withControllerSchedulingDisconnected(Boolean controllerSchedulingDisconnected) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withControllerSchedulingReconnected(Boolean controllerSchedulingReconnected) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withCpuUsageHighDetected(Boolean cpuUsageHighDetected) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withMicSpeakerCameraDisconnected(Boolean micSpeakerCameraDisconnected) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withMicSpeakerCameraReconnected(Boolean micSpeakerCameraReconnected) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withNetworkUnstableDetected(Boolean networkUnstableDetected) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withSipRegistrationFailed(Boolean sipRegistrationFailed) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withSipRegistrationReEnabled(Boolean sipRegistrationReEnabled) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withZoomRoomComeBackOnline(Boolean zoomRoomComeBackOnline) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withZoomRoomDisplayDisconnected(Boolean zoomRoomDisplayDisconnected) {
    ...
    public GetZRAccountSettings200ApplicationJSON2Notification withZoomRoomOffline(Boolean zoomRoomOffline) {
