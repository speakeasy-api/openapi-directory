...
export class PlayablelocationsSamplePlayableLocationsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class PlayablelocationsSamplePlayableLocationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
