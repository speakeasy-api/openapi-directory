...
public class ComputeNodeRebootHeaders {
    /**
    ...
    public ComputeNodeRebootHeaders withOcpDate(String ocpDate) {
    ...
    public ComputeNodeRebootHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
