...
class ProvisionNetworkClientsRequestBodyDevicePolicyEnum(str, Enum):
    r"""The policy to apply to the specified client. Can be 'Group policy', 'Allowed', 'Blocked', 'Per connection' or 'Normal'. Required."""
    ALLOWED = 'Allowed'
    BLOCKED = 'Blocked'
...
class ProvisionNetworkClientsRequestBodyPoliciesBySecurityApplianceDevicePolicyEnum(str, Enum):
    r"""The policy to apply to the specified client. Can be 'Allowed', 'Blocked' or 'Normal'. Required."""
    ALLOWED = 'Allowed'
    BLOCKED = 'Blocked'
    NORMAL = 'Normal'
...
class ProvisionNetworkClientsRequestBodyPoliciesBySsid0DevicePolicyEnum(str, Enum):
    r"""The policy to apply to the specified client. Can be 'Allowed', 'Blocked', 'Normal' or 'Group policy'. Required."""
    ALLOWED = 'Allowed'
    BLOCKED = 'Blocked'
    GROUP_POLICY = 'Group policy'
    NORMAL = 'Normal'
...
class ProvisionNetworkClientsRequestBody:
    ...
    clients: list[ProvisionNetworkClientsRequestBodyClients] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('clients') }})
    r"""The array of clients to provision"""  
