...
exports.InvoiceItemsUpdateResponse = exports.InvoiceItemsUpdateRequest = exports.InvoiceItemsUpdateSecurity = void 0;
...
exports.InvoiceItemsUpdateSecurity = InvoiceItemsUpdateSecurity;
var InvoiceItemsUpdateRequest = /** @class */ (function (_super) {
    ...
    ], InvoiceItemsUpdateRequest.prototype, "invoiceItemInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], InvoiceItemsUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], InvoiceItemsUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], InvoiceItemsUpdateRequest.prototype, "xApideckServiceId", void 0);
    return InvoiceItemsUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.InvoiceItemsUpdateRequest = InvoiceItemsUpdateRequest;
var InvoiceItemsUpdateResponse = /** @class */ (function (_super) {
    ...
    ], InvoiceItemsUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.InvoiceItemsUpdateResponse = InvoiceItemsUpdateResponse;
