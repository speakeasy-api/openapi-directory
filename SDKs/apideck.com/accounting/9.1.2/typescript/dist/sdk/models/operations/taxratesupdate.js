...
exports.TaxRatesUpdateResponse = exports.TaxRatesUpdateRequest = exports.TaxRatesUpdateSecurity = void 0;
...
exports.TaxRatesUpdateSecurity = TaxRatesUpdateSecurity;
var TaxRatesUpdateRequest = /** @class */ (function (_super) {
    ...
    ], TaxRatesUpdateRequest.prototype, "taxRateInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], TaxRatesUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=raw" }),
        __metadata("design:type", Boolean)
    ], TaxRatesUpdateRequest.prototype, "raw", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-app-id",
        }),
        __metadata("design:type", String)
    ], TaxRatesUpdateRequest.prototype, "xApideckAppId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-consumer-id",
        }),
        __metadata("design:type", String)
    ], TaxRatesUpdateRequest.prototype, "xApideckConsumerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-apideck-service-id",
        }),
        __metadata("design:type", String)
    ], TaxRatesUpdateRequest.prototype, "xApideckServiceId", void 0);
    return TaxRatesUpdateRequest;
}(utils_1.SpeakeasyBase));
exports.TaxRatesUpdateRequest = TaxRatesUpdateRequest;
var TaxRatesUpdateResponse = /** @class */ (function (_super) {
    ...
    ], TaxRatesUpdateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.TaxRatesUpdateResponse = TaxRatesUpdateResponse;
