...
* [pvcer](#pvcer) - Provisional Certificate
...
use \OpenAPI\OpenAPI\Models\Operations\MicerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\MicerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\MicerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\MicerSecurity;
...
try {
    ...
    $request->certificateParameters = new MicerRequestBodyCertificateParameters();
    $request->certificateParameters->appno = 'MMIG1907220002';
    $request->certificateParameters->dateOfBirth = '11-11-1990';
    $request->certificateParameters->enrolno = 'MG005M010916003';
    $request->certificateParameters->rollno = '1938805';
    ...
    $request->format = MicerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new MicerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->micer($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\PvcerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\PvcerRequestBodyCertificateParameters;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchema;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsent;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentData;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentDataConsumer;
...
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaConsentUser;
use \OpenAPI\OpenAPI\Models\Shared\ConsentArtifactSchemaSignature;
use \OpenAPI\OpenAPI\Models\Operations\PvcerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\PvcerSecurity;
...
try {
    ...
    $request->certificateParameters = new PvcerRequestBodyCertificateParameters();
    $request->certificateParameters->appno = 'MMIG1907220002';
    $request->certificateParameters->dateOfBirth = '11-11-1990';
    $request->certificateParameters->enrolno = 'MG005M010916003';
    $request->certificateParameters->rollno = '1938805';
    ...
    $request->format = PvcerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new PvcerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->pvcer($request, $requestSecurity);
