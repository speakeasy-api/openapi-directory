...
var ChannelCatalogProductInfo = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "excludedBy" }),
        __metadata("design:type", Array)
    ], ChannelCatalogProductInfo.prototype, "excludedBy", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "links" }),
        (0, class_transformer_1.Type)(function () { return channelcatalogproductinfolinks_1.ChannelCatalogProductInfoLinks; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: productoverridewithcatalogvalue_1.ProductOverrideWithCatalogValue }),
        (0, class_transformer_1.Expose)({ name: "overrides" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], productoverridewithcatalogvalue_1.ProductOverrideWithCatalogValue);
            }
            return obj;
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "uncategorized" }),
        __metadata("design:type", Boolean)
