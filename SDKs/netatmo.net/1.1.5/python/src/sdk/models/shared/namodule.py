...
class NAModule:
    ...
    main_device: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('main_device'), 'exclude': lambda f: f is None }})  
