...
type ActivateDeviceIdentifierHeaders struct {
...
type ActivateDeviceIdentifierRequest struct {
	Headers ActivateDeviceIdentifierHeaders
	Request ActivateDeviceIdentifierRequestBody `request:"mediaType=application/json"`
}
