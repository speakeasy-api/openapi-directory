...
exports.GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsResponse = exports.GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest = exports.GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsSecurity = void 0;
...
exports.GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsSecurity = GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsSecurity;
var GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=DomesticStandingOrderId",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest.prototype, "domesticStandingOrderId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-customer-user-agent",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest.prototype, "xCustomerUserAgent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-auth-date",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest.prototype, "xFapiAuthDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-customer-ip-address",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest.prototype, "xFapiCustomerIpAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-fapi-interaction-id",
        }),
        __metadata("design:type", String)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest.prototype, "xFapiInteractionId", void 0);
    return GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest;
}(utils_1.SpeakeasyBase));
exports.GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest = GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsRequest;
var GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsResponse.prototype, "rawResponse", void 0);
    return GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsResponse;
}(utils_1.SpeakeasyBase));
exports.GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsResponse = GetDomesticStandingOrdersDomesticStandingOrderIdPaymentDetailsResponse;
