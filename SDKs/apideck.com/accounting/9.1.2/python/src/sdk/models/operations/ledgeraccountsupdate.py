...
from ..shared import updateledgeraccountresponse as shared_updateledgeraccountresponse
...
class LedgerAccountsUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_ledger_account_response: Optional[shared_updateledgeraccountresponse.UpdateLedgerAccountResponse] = dataclasses.field(default=None)
