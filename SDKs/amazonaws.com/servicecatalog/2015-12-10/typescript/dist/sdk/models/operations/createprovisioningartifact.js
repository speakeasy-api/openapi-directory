...
exports.CreateProvisioningArtifactResponse = exports.CreateProvisioningArtifactRequest = exports.CreateProvisioningArtifactXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var CreateProvisioningArtifactXAmzTargetEnum;
...
})(CreateProvisioningArtifactXAmzTargetEnum = exports.CreateProvisioningArtifactXAmzTargetEnum || (exports.CreateProvisioningArtifactXAmzTargetEnum = {}));
var CreateProvisioningArtifactRequest = /** @class */ (function (_super) {
    ...
    ], CreateProvisioningArtifactRequest.prototype, "createProvisioningArtifactInput", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], CreateProvisioningArtifactRequest.prototype, "xAmzTarget", void 0);
    return CreateProvisioningArtifactRequest;
}(utils_1.SpeakeasyBase));
exports.CreateProvisioningArtifactRequest = CreateProvisioningArtifactRequest;
var CreateProvisioningArtifactResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], CreateProvisioningArtifactResponse.prototype, "rawResponse", void 0);
    return CreateProvisioningArtifactResponse;
}(utils_1.SpeakeasyBase));
exports.CreateProvisioningArtifactResponse = CreateProvisioningArtifactResponse;
