...
public class PermissionGroupModel {
    ...
    public PermissionGroupModel withCanCreateOrUpdateSegments(Boolean canCreateOrUpdateSegments) {
    ...
    public PermissionGroupModel withCanDeleteSegments(Boolean canDeleteSegments) {
    ...
    public PermissionGroupModel withCanViewProductAuditLog(Boolean canViewProductAuditLog) {
    ...
    public PermissionGroupModel withCanViewProductStatistics(Boolean canViewProductStatistics) {
    ...
    public PermissionGroupModel withProduct(ProductModel product) {
