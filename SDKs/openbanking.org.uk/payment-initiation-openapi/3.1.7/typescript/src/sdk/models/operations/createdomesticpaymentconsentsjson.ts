...
export class CreateDomesticPaymentConsentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateDomesticPaymentConsentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateDomesticPaymentConsentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
