...
exports.LatencyHistory = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var LatencyHistory = /** @class */ (function () {
    function LatencyHistory(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    LatencyHistory.prototype.getNetworkWirelessClientLatencyHistory = function (req, config) {
    ...
    **/
    LatencyHistory.prototype.getNetworkWirelessLatencyHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.LatencyHistory = LatencyHistory;
