...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(str, Enum):
    r"""Required. Identifies the type of assigned targeting options to list. Supported targeting types: * `TARGETING_TYPE_CHANNEL` * `TARGETING_TYPE_DIGITAL_CONTENT_LABEL_EXCLUSION` * `TARGETING_TYPE_OMID` * `TARGETING_TYPE_SENSITIVE_CATEGORY_EXCLUSION` * `TARGETING_TYPE_YOUTUBE_VIDEO` * `TARGETING_TYPE_YOUTUBE_CHANNEL`"""
...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListRequest:
    ...
    r"""Required. The ID of the advertiser."""  
    ...
    r"""A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListAdvertiserAssignedTargetingOptions` method. If not specified, the first page of results will be returned."""  
