...
var UnitOfMeasure = /** @class */ (function () {
    ...
    **/
    UnitOfMeasure.prototype.objectDeleteUnitOfMeasure = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/v1/object/unit-of-measure/{id}", req.pathParams);
    ...
    UnitOfMeasure.prototype.objectGetUnitOfMeasure = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetUnitOfMeasure = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
