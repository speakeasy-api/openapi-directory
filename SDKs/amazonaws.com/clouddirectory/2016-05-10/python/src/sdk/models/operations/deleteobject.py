...
class DeleteObjectRequestBody:
    ...
    object_reference: DeleteObjectRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ObjectReference') }})
    r"""The reference that identifies an object."""  
...
class DeleteObjectRequest:
    ...
    request_body: DeleteObjectRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
