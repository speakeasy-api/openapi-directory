...
export class Files {
  ...
  **/
  getFiles(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/files/{file-id}", req.pathParams);
    ...
    return r.then((httpRes: AxiosResponse) => {
        ...
        const res: operations.GetFilesResponse = {statusCode: httpRes.status, contentType: contentType, headers: utils.getHeadersFromResponse(httpRes.headers)};
        switch (true) {
