 ...
 *
 */
export enum GETRetrieveAllPaymentsStatusEnum {
  Draft = "Draft",
 ...
 *
 */
export enum GETRetrieveAllPaymentsTypeEnum {
  External = "External",
...
export class GETRetrieveAllPaymentsRequest extends SpeakeasyBase {
  ...
  status?: GETRetrieveAllPaymentsStatusEnum;
  ...
  type?: GETRetrieveAllPaymentsTypeEnum;
