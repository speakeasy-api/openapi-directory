...
export class RecaptchaenterpriseProjectsRelatedaccountgroupsMembershipsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RecaptchaenterpriseProjectsRelatedaccountgroupsMembershipsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RecaptchaenterpriseProjectsRelatedaccountgroupsMembershipsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
