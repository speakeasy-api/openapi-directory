 ...
 */
export enum NodesReadNodeAttributesCategoryEnum {
  Analysis = "analysis",
 ...
 */
export class NodesReadNodeAttributes extends SpeakeasyBase {
  /**
   * The category of the node, as selected by project contributors.
   */
  @SpeakeasyMetadata()
 ...
 */
export class NodesReadNodeLinks extends SpeakeasyBase {
  /**
 ...
 */
export class NodesReadNodeRelationships extends SpeakeasyBase {
  /**
 ...
 * OK
 */
export class NodesReadNode extends SpeakeasyBase {
  /**
   * The properties of the node entity.
   */
  @SpeakeasyMetadata()
