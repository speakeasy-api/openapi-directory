...
export class RootV1ScoringsConsolidatedQueryParams extends SpeakeasyBase {
...
export class RootV1ScoringsConsolidatedRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: RootV1ScoringsConsolidatedQueryParams;
}


export class RootV1ScoringsConsolidatedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
