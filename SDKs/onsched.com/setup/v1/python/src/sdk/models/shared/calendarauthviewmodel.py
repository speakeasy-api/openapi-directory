...
class CalendarAuthViewModel:
    ...
    calendar_auth_url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('calendarAuthUrl'), 'exclude': lambda f: f is None }})  
