 ...
 */
export declare enum AcceptAddressTransferRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class AcceptAddressTransferRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class AcceptAddressTransferRequestTagSpecifications extends SpeakeasyBase {
...
export declare class AcceptAddressTransferRequest extends SpeakeasyBase {
    address: string;
    dryRun?: boolean;
