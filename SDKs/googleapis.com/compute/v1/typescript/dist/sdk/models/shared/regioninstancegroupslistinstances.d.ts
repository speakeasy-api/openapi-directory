...
import { InstanceWithNamedPorts } from "./instancewithnamedports";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum RegionInstanceGroupsListInstancesWarningCodeEnum {
...
export declare class RegionInstanceGroupsListInstancesWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RegionInstanceGroupsListInstancesWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: RegionInstanceGroupsListInstancesWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: RegionInstanceGroupsListInstancesWarningData[];
    /**
 ...
 * Successful response
 */
export declare class RegionInstanceGroupsListInstances extends SpeakeasyBase {
    /**
