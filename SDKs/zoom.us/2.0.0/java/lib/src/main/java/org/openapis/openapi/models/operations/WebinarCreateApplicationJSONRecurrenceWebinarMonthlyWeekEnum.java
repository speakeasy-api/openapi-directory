 ...
 */
public enum WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekEnum {
    MINUS1("-1"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreateApplicationJSONRecurrenceWebinarMonthlyWeekEnum(String value) {
        this.value = value;
    }
}
