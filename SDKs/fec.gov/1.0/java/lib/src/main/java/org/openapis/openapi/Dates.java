...
public class Dates {
    ...
    public org.openapis.openapi.models.operations.GetCalendarDatesResponse getCalendarDates(org.openapis.openapi.models.operations.GetCalendarDatesRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetCalendarDatesQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
    ...
    public org.openapis.openapi.models.operations.GetCalendarDatesExportResponse getCalendarDatesExport(org.openapis.openapi.models.operations.GetCalendarDatesExportRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetCalendarDatesExportQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public org.openapis.openapi.models.operations.GetElectionDatesResponse getElectionDates(org.openapis.openapi.models.operations.GetElectionDatesRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetElectionDatesQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
    ...
    public org.openapis.openapi.models.operations.GetReportingDatesResponse getReportingDates(org.openapis.openapi.models.operations.GetReportingDatesRequest request) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.GetReportingDatesQueryParams.class, request.queryParams, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
