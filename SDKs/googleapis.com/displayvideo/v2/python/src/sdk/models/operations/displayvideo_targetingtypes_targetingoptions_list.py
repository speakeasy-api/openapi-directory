...
class DisplayvideoTargetingTypesTargetingOptionsListRequest:
    path_params: DisplayvideoTargetingTypesTargetingOptionsListPathParams = dataclasses.field()
    query_params: DisplayvideoTargetingTypesTargetingOptionsListQueryParams = dataclasses.field()
    security: DisplayvideoTargetingTypesTargetingOptionsListSecurity = dataclasses.field()
