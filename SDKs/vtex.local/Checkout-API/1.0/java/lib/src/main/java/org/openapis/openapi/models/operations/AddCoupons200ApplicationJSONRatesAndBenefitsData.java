...
/**
 * AddCoupons200ApplicationJSONRatesAndBenefitsData - Information on rates and benefits that apply to the order.
 */
public class AddCoupons200ApplicationJSONRatesAndBenefitsData {
    /**
