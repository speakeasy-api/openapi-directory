...
class TestUpdateDeviceSetOfUserSecurity:
...
class TestUpdateDeviceSetOfUserRequest:
    ...
    request_body: TestUpdateDeviceSetOfUserDeviceSetUpdateInformation = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TestUpdateDeviceSetOfUserTestCloudErrorDetails:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TestUpdateDeviceSetOfUserDeviceSetDeviceConfigurationsImage:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TestUpdateDeviceSetOfUserDeviceSetDeviceConfigurations:
    
    id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id'), 'exclude': lambda f: f is None }})
    r"""The unique id of the device configuration"""  
    image: Optional[TestUpdateDeviceSetOfUserDeviceSetDeviceConfigurationsImage] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('image'), 'exclude': lambda f: f is None }})  
    model: Optional[TestUpdateDeviceSetOfUserDeviceSetDeviceConfigurationsModel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('model'), 'exclude': lambda f: f is None }})  
...
class TestUpdateDeviceSetOfUserDeviceSet:
    ...
    device_configurations: list[TestUpdateDeviceSetOfUserDeviceSetDeviceConfigurations] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deviceConfigurations') }})  
    id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('id') }})
    r"""Identifier of the device set"""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""Name of the device set"""  
    owner: TestUpdateDeviceSetOfUserDeviceSetDeviceSetOwner = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('owner') }})
    r"""The owner of a device set"""  
...
class TestUpdateDeviceSetOfUserResponse:
    ...
    device_set: Optional[TestUpdateDeviceSetOfUserDeviceSet] = dataclasses.field(default=None)
    r"""OK"""  
    raw_response: Optional[requests_http.Response] = dataclasses.field(default=None)  
    test_cloud_error_details: Optional[TestUpdateDeviceSetOfUserTestCloudErrorDetails] = dataclasses.field(default=None)
