...
export class Secrets {
  ...
  secretsChoicesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SecretsChoicesListResponse =
        new operations.SecretsChoicesListResponse({
  ...
  secretsChoicesRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SecretsChoicesReadResponse =
        new operations.SecretsChoicesReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
