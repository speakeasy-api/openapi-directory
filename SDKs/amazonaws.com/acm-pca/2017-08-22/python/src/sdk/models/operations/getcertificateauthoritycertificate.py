...
class GetCertificateAuthorityCertificateRequest:
    ...
    get_certificate_authority_certificate_request: shared_getcertificateauthoritycertificaterequest.GetCertificateAuthorityCertificateRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
