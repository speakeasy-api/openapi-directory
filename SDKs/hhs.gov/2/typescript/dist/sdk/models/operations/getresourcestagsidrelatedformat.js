...
exports.GetResourcesTagsIdRelatedFormatResponse = exports.GetResourcesTagsIdRelatedFormatRequest = void 0;
...
var GetResourcesTagsIdRelatedFormatRequest = /** @class */ (function (_super) {
    ...
    ], GetResourcesTagsIdRelatedFormatRequest.prototype, "format", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], GetResourcesTagsIdRelatedFormatRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=false;name=max" }),
        __metadata("design:type", Number)
    ], GetResourcesTagsIdRelatedFormatRequest.prototype, "max", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetResourcesTagsIdRelatedFormatRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=false;name=sort" }),
        __metadata("design:type", String)
    ], GetResourcesTagsIdRelatedFormatRequest.prototype, "sort", void 0);
...
var GetResourcesTagsIdRelatedFormatResponse = /** @class */ (function (_super) {
    ...
    ], GetResourcesTagsIdRelatedFormatResponse.prototype, "rawResponse", void 0);
    __decorate([
