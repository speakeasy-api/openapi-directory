...
var Granite = /** @class */ (function () {
    function Granite(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    Granite.prototype.sslSetup = function (req, config) {
        var _a;
