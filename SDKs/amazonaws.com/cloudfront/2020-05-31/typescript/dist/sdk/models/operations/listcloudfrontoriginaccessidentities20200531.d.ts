...
export declare class ListCloudFrontOriginAccessIdentities20200531Request extends SpeakeasyBase {
    /**
...
export declare class ListCloudFrontOriginAccessIdentities20200531Response extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    statusCode: number;
