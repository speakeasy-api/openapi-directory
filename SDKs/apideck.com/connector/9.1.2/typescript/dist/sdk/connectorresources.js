...
exports.ConnectorResources = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var shared = __importStar(require("./models/shared"));
var ConnectorResources = /** @class */ (function () {
    function ConnectorResources(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Get Connector Resource
     */
    ConnectorResources.prototype.connectorResourcesOne = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectorResourcesOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/connector/connectors/{id}/resources/{resource_id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
            security = new operations.ConnectorResourcesOneSecurity(security);
        }
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.ConnectorResourcesOneResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.getConnectorResourceResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.GetConnectorResourceResponse);
                    }
                    break;
...
exports.ConnectorResources = ConnectorResources;
