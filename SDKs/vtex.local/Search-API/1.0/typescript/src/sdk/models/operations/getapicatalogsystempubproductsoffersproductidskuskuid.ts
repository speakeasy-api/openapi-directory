...
export class GetApiCatalogSystemPubProductsOffersProductIdSkuSkuIdRequest extends SpeakeasyBase {
  /**
 ...
 */
export class GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSONMainImage extends SpeakeasyBase {
  /**
...
export class GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSONOffersOffersPerSalesChannel extends SpeakeasyBase {
  /**
...
export class GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSONOffers extends SpeakeasyBase {
  /**
  ...
  @SpeakeasyMetadata({
    elemType:
      GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSONOffersOffersPerSalesChannel,
  })
...
export class GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSON extends SpeakeasyBase {
  /**
  ...
  @Type(
    () =>
      GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSONMainImage
  )
  ...
  @SpeakeasyMetadata({
    elemType:
      GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSONOffers,
  })
  @Expose({ name: "Offers" })
  @Type(
    () =>
...
export class GetApiCatalogSystemPubProductsOffersProductIdSkuSkuIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
  ...
  @SpeakeasyMetadata({
    elemType:
      GetApiCatalogSystemPubProductsOffersProductIdSkuSkuId200ApplicationJSON,
  })
