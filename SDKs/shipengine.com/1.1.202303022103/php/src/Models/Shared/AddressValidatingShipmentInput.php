...
class AddressValidatingShipmentInput
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentDeliveryConfirmationEnum $confirmation
     */
	#[\JMS\Serializer\Annotation\SerializedName('confirmation')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentDeliveryConfirmationEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AddressValidatingShipmentDeliveryConfirmationEnum $confirmation = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentInternationalShipmentOptionsInput $customs
     */
	#[\JMS\Serializer\Annotation\SerializedName('customs')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentInternationalShipmentOptionsInput')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AddressValidatingShipmentInternationalShipmentOptionsInput $customs = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentInsuranceProviderEnum $insuranceProvider
     */
	#[\JMS\Serializer\Annotation\SerializedName('insurance_provider')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentInsuranceProviderEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AddressValidatingShipmentInsuranceProviderEnum $insuranceProvider = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentOriginTypeEnum $originType
     */
	#[\JMS\Serializer\Annotation\SerializedName('origin_type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentOriginTypeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AddressValidatingShipmentOriginTypeEnum $originType = null;
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\AddressValidatingShipmentValidateAddressEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AddressValidatingShipmentValidateAddressEnum $validateAddress = null;
