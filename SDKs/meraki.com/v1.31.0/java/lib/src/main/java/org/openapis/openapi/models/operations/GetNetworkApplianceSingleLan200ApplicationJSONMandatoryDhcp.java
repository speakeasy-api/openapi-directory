 ...
 */
public class GetNetworkApplianceSingleLan200ApplicationJSONMandatoryDhcp {
    /**
    ...
    public GetNetworkApplianceSingleLan200ApplicationJSONMandatoryDhcp withEnabled(Boolean enabled) {
