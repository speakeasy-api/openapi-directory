...
func (e ScorePrivacyEnum) ToPointer() *ScorePrivacyEnum {
	return &e
}

func (e *ScorePrivacyEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "organizationPublic":
		fallthrough
	case "privateLink":
		*e = ScorePrivacyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ScorePrivacyEnum: %v", v)
	}
}
