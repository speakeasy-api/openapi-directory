...
class PostServersCreateServerResponseServerIso
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostServersCreateServerResponseServerIsoArchitectureEnum $architecture
     */
	#[\JMS\Serializer\Annotation\SerializedName('architecture')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\PostServersCreateServerResponseServerIsoArchitectureEnum>')]
     ...
     * Type of the ISO
     * 
     * @var \OpenAPI\OpenAPI\Models\Operations\PostServersCreateServerResponseServerIsoTypeEnum $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\PostServersCreateServerResponseServerIsoTypeEnum>')]
    public PostServersCreateServerResponseServerIsoTypeEnum $type;
    
	public function __construct()
	{
		$this->architecture = \OpenAPI\OpenAPI\Models\Operations\PostServersCreateServerResponseServerIsoArchitectureEnum::X86;
		$this->deprecated = "";
		$this->description = "";
		$this->id = 0;
		$this->name = "";
		$this->type = \OpenAPI\OpenAPI\Models\Operations\PostServersCreateServerResponseServerIsoTypeEnum::PUBLIC;
	}
}
