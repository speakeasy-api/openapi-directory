...
public class GetRatingsListQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetRatingsListQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetRatingsListQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetRatingsListQueryParams withItemType(org.openapis.openapi.models.shared.ItemTypeEnum itemType) {
    ...
    public String lang;
    public GetRatingsListQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetRatingsListQueryParams withOrder(org.openapis.openapi.models.shared.ListOrderEnum order) {
        this.order = order;
        return this;
    }
    ...
    public GetRatingsListQueryParams withOrderBy(GetRatingsListOrderByEnum orderBy) {
    ...
    public Integer page;
    public GetRatingsListQueryParams withPage(Integer page) {
        this.page = page;
        return this;
    }
    ...
    public GetRatingsListQueryParams withPageSize(Integer pageSize) {
    ...
    public GetRatingsListQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetRatingsListQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
