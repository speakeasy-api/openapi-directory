...
export class SecuritycenterOrganizationsSourcesFindingsGroupSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsSourcesFindingsGroupRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterOrganizationsSourcesFindingsGroupResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
