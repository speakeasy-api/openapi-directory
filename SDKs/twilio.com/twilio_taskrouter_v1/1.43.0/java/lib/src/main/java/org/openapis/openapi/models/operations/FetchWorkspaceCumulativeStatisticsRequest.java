...
public class FetchWorkspaceCumulativeStatisticsRequest {
    ...
    public FetchWorkspaceCumulativeStatisticsRequest withEndDate(OffsetDateTime endDate) {
    ...
    public FetchWorkspaceCumulativeStatisticsRequest withMinutes(Long minutes) {
    ...
    public FetchWorkspaceCumulativeStatisticsRequest withSplitByWaitTime(String splitByWaitTime) {
    ...
    public FetchWorkspaceCumulativeStatisticsRequest withStartDate(OffsetDateTime startDate) {
    ...
    public FetchWorkspaceCumulativeStatisticsRequest withTaskChannel(String taskChannel) {
    ...
    public FetchWorkspaceCumulativeStatisticsRequest withWorkspaceSid(String workspaceSid) {
        this.workspaceSid = workspaceSid;
        return this;
    }
    
    public FetchWorkspaceCumulativeStatisticsRequest(@JsonProperty("WorkspaceSid") String workspaceSid) {
        this.workspaceSid = workspaceSid;
  }
}
