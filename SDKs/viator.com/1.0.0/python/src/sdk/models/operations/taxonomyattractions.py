...
class TaxonomyAttractionsRequestBody:
    ...
    sort_order: Optional[TaxonomyAttractionsRequestBodySortOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sortOrder') }})
...
class TaxonomyAttractions200ApplicationJSONData:
    attraction_city: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attractionCity') }})
    attraction_latitude: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attractionLatitude') }})
    attraction_longitude: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attractionLongitude') }})
    attraction_state: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attractionState') }})
    attraction_street_address: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attractionStreetAddress') }})
    ...
    page_url_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pageUrlName') }})
    ...
    seo_id: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('seoId') }})
...
class TaxonomyAttractions200ApplicationJSON:
    data: Optional[list[TaxonomyAttractions200ApplicationJSONData]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class TaxonomyAttractionsRequest:
    headers: TaxonomyAttractionsHeaders = dataclasses.field()
    request: Optional[TaxonomyAttractionsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
