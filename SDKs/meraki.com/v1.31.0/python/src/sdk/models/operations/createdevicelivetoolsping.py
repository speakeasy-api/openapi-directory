...
class CreateDeviceLiveToolsPingRequest:
    ...
    request_body: CreateDeviceLiveToolsPingRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    serial: str = dataclasses.field(metadata={'path_param': { 'field_name': 'serial', 'style': 'simple', 'explode': False }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class CreateDeviceLiveToolsPing201ApplicationJSONRequest:
...
class CreateDeviceLiveToolsPing201ApplicationJSON:
    ...
    request: Optional[CreateDeviceLiveToolsPing201ApplicationJSONRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})
    r"""Ping request parameters"""  
...
class CreateDeviceLiveToolsPingResponse:
    ...
    create_device_live_tools_ping_201_application_json_object: Optional[CreateDeviceLiveToolsPing201ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
