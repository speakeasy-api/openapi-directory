...
class TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics:
    ...
    longest_relative_task_age_in_queue: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('longest_relative_task_age_in_queue') }})
    longest_relative_task_sid_in_queue: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('longest_relative_task_sid_in_queue') }})
    ...
    total_available_workers: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('total_available_workers') }})
    total_eligible_workers: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('total_eligible_workers') }})
