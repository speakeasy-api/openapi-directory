...
public class GetPublicItemMediaFilesRequest {
    ...
    public GetPublicItemMediaFilesRequest withDelivery(org.openapis.openapi.models.shared.MediaFileDeliveryEnum[] delivery) {
    ...
    public GetPublicItemMediaFilesRequest withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetPublicItemMediaFilesRequest withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetPublicItemMediaFilesRequest withFormats(org.openapis.openapi.models.shared.MediaFileFormatsEnum[] formats) {
    ...
    public GetPublicItemMediaFilesRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPublicItemMediaFilesRequest withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetPublicItemMediaFilesRequest withResolution(org.openapis.openapi.models.shared.MediaFileResolutionEnum resolution) {
    ...
    public GetPublicItemMediaFilesRequest withSegments(String[] segments) {
    ...
    public GetPublicItemMediaFilesRequest withSub(String sub) {
        this.sub = sub;
        return this;
    }
    
    public GetPublicItemMediaFilesRequest(@JsonProperty("delivery") org.openapis.openapi.models.shared.MediaFileDeliveryEnum[] delivery, @JsonProperty("id") String id, @JsonProperty("resolution") org.openapis.openapi.models.shared.MediaFileResolutionEnum resolution) {
        this.delivery = delivery;
        this.id = id;
        this.resolution = resolution;
  }
