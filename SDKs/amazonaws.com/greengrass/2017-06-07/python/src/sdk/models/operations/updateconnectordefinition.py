...
class UpdateConnectorDefinitionRequest:
    headers: UpdateConnectorDefinitionHeaders = dataclasses.field()
    path_params: UpdateConnectorDefinitionPathParams = dataclasses.field()
    request: UpdateConnectorDefinitionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateConnectorDefinitionResponse:
    ...
    update_connector_definition_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
