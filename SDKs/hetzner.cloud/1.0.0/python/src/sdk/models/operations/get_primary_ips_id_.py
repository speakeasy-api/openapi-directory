...
class GetPrimaryIpsIDPrimaryIPResponsePrimaryIPAssigneeTypeEnum(str, Enum):
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetPrimaryIpsIDPrimaryIPResponsePrimaryIPDatacenter:
    ...
    r"""ID of the Resource"""  
    location: GetPrimaryIpsIDPrimaryIPResponsePrimaryIPDatacenterLocation = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('location') }})  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""Unique identifier of the Datacenter"""  
    server_types: GetPrimaryIpsIDPrimaryIPResponsePrimaryIPDatacenterServerTypes = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('server_types') }})
    r"""The Server types the Datacenter can handle"""  
...
class GetPrimaryIpsIDPrimaryIPResponsePrimaryIPTypeEnum(str, Enum):
...
class GetPrimaryIpsIDPrimaryIPResponsePrimaryIP:
    ...
    assignee_type: GetPrimaryIpsIDPrimaryIPResponsePrimaryIPAssigneeTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assignee_type') }})
    r"""Resource type the Primary IP can be assigned to"""  
    ...
    datacenter: GetPrimaryIpsIDPrimaryIPResponsePrimaryIPDatacenter = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('datacenter') }})
    r"""Datacenter this Primary IP is located at"""  
    dns_ptr: list[GetPrimaryIpsIDPrimaryIPResponsePrimaryIPDNSPtr] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('dns_ptr') }})
    ...
    protection: GetPrimaryIpsIDPrimaryIPResponsePrimaryIPProtection = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protection') }})
    r"""Protection configuration for the Resource"""  
    type: GetPrimaryIpsIDPrimaryIPResponsePrimaryIPTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""Type of the Primary IP"""  
...
class GetPrimaryIpsIDPrimaryIPResponse:
    r"""The `primary_ip` key contains a Primary IP object"""
    
    primary_ip: GetPrimaryIpsIDPrimaryIPResponsePrimaryIP = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('primary_ip') }})  
...
class GetPrimaryIpsIDResponse:
    ...
    primary_ip_response: Optional[GetPrimaryIpsIDPrimaryIPResponse] = dataclasses.field(default=None)
    r"""The `primary_ip` key contains a Primary IP object"""  
