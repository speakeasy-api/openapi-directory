...
class PostDescribeCacheSubnetGroupsQueryParams:
    action: PostDescribeCacheSubnetGroupsActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeCacheSubnetGroupsVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeCacheSubnetGroupsRequest:
    headers: PostDescribeCacheSubnetGroupsHeaders = dataclasses.field()
    query_params: PostDescribeCacheSubnetGroupsQueryParams = dataclasses.field()
