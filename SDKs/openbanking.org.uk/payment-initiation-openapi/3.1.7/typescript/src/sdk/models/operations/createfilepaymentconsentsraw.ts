...
export class CreateFilePaymentConsentsRawSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateFilePaymentConsentsRawRequest extends SpeakeasyBase {
  /**
...
export class CreateFilePaymentConsentsRawResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
