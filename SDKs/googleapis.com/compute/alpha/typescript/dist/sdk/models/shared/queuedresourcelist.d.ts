 ...
 */
export declare enum QueuedResourceListWarningCodeEnum {
...
export declare class QueuedResourceListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class QueuedResourceListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: QueuedResourceListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: QueuedResourceListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class QueuedResourceList extends SpeakeasyBase {
    /**
     ...
     * Informational warning message.
     */
    warning?: QueuedResourceListWarning;
}
