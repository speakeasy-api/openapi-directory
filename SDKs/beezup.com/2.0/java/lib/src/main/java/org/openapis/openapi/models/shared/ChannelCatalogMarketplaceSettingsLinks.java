...
public class ChannelCatalogMarketplaceSettingsLinks {
    ...
    public ChannelCatalogMarketplaceSettingsLinks(@JsonProperty("save") LinksSetChannelCatalogMarketplaceSettingsLink save, @JsonProperty("self") LinksGetChannelCatalogMarketplaceSettingsLink self) {
        this.save = save;
        this.self = self;
  }
}
