...
class SubmitContainerStateChangeRequest:
    ...
    submit_container_state_change_request: shared_submitcontainerstatechangerequest.SubmitContainerStateChangeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
