...
public class Tags {
    ...
    **/
    public openapisdk.models.operations.CreateTagResponse createTag(openapisdk.models.operations.CreateTagRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.CreateTag201ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.CreateTag201ApplicationJson.class);
     ...
     * Returns the full record of the newly created tag.
    **/
    public openapisdk.models.operations.CreateTagForWorkspaceResponse createTagForWorkspace(openapisdk.models.operations.CreateTagForWorkspaceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspace_gid}/tags", request.pathParams);
        ...
        openapisdk.models.operations.CreateTagForWorkspaceResponse res = new openapisdk.models.operations.CreateTagForWorkspaceResponse() {{
        ...
        if (httpRes.statusCode() == 201) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.CreateTagForWorkspace201ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.CreateTagForWorkspace201ApplicationJson.class);
    ...
    **/
    public openapisdk.models.operations.DeleteTagResponse deleteTag(openapisdk.models.operations.DeleteTagRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/tags/{tag_gid}", request.pathParams);
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.DeleteTag200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.DeleteTag200ApplicationJson.class);
    ...
    public openapisdk.models.operations.GetTagsResponse getTags(openapisdk.models.operations.GetTagsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetTags200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetTags200ApplicationJson.class);
    ...
    **/
    public openapisdk.models.operations.GetTagsForTaskResponse getTagsForTask(openapisdk.models.operations.GetTagsForTaskRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/tasks/{task_gid}/tags", request.pathParams);
        ...
        openapisdk.models.operations.GetTagsForTaskResponse res = new openapisdk.models.operations.GetTagsForTaskResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetTagsForTask200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetTagsForTask200ApplicationJson.class);
     ...
     * Returns the compact tag records for some filtered set of tags. Use one or more of the parameters provided to filter the tags returned.
    **/
    public openapisdk.models.operations.GetTagsForWorkspaceResponse getTagsForWorkspace(openapisdk.models.operations.GetTagsForWorkspaceRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/workspaces/{workspace_gid}/tags", request.pathParams);
        ...
        openapisdk.models.operations.GetTagsForWorkspaceResponse res = new openapisdk.models.operations.GetTagsForWorkspaceResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.GetTagsForWorkspace200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.GetTagsForWorkspace200ApplicationJson.class);
    ...
    public openapisdk.models.operations.UpdateTagResponse updateTag(openapisdk.models.operations.UpdateTagRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.operations.UpdateTag200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.UpdateTag200ApplicationJson.class);
