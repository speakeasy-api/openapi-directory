...
var Partners = /** @class */ (function () {
    ...
    **/
    Partners.prototype.putOrdersIdShip = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PutOrdersIdShipRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orders/{id}/ship", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.oneordersPostResponses201ContentApplication1jsonSchema = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
     ...
     * Note, this API is used to update orders and is reserved for our shipping partners.
    **/
    Partners.prototype.putOrdersIdStatus = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PutOrdersIdStatusRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/orders/{id}/status", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
