...
export class CreateCategoryRequestBody extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateCategory200ApplicationJSONCategoryGroupPermissions extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateCategory200ApplicationJSONCategoryRequiredTagGroups extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateCategory200ApplicationJSONCategory extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @Type(() => CreateCategory200ApplicationJSONCategoryGroupPermissions)
  ...
  @Type(() => CreateCategory200ApplicationJSONCategoryRequiredTagGroups)
 ...
 * success response
 */
export class CreateCategory200ApplicationJSON extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "category" })
  @Type(() => CreateCategory200ApplicationJSONCategory)
  category: CreateCategory200ApplicationJSONCategory;
}

export class CreateCategoryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
