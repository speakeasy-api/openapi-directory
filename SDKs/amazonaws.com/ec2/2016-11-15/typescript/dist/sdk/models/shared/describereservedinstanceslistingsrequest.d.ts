 ...
 */
export declare class DescribeReservedInstancesListingsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
/**
 ...
 */
export declare class DescribeReservedInstancesListingsRequest extends SpeakeasyBase {
