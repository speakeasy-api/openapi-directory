...
func main() {
    ...
    res, err := s.Orders.CancelOrder2(ctx, operations.CancelOrder2Request{
        Accept: "application/json",
        ContentType: "application/json",
        RequestBody: &operations.CancelOrder2RequestBody{
            Reason: sdk.String("Unexpected stock shortage"),
        },
    ...
    if res.CancelOrder2200ApplicationJSONObject != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Orders.GetOrder2(ctx, operations.GetOrder2Request{
        Accept: "application/json",
        ContentType: "application/json",
        OrderID: "70caf3941s6df1",
    ...
    if res.GetOrder2200ApplicationJSONObject != nil {
        // handle response
    }
}
```
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Orders.ListOrders2(ctx, operations.ListOrders2Request{
        Accept: "application/json",
        ContentType: "application/json",
        RequestBody: &operations.ListOrders2RequestBody{
            FCreationDate: "creationDate:[2021-11-01T00:00:00.000Z TO 2022-11-10T02:00:00.000Z]",
            Page: 1,
            PerPage: 15,
            Q: sdk.String("Postman Test"),
        },
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Orders.StartHandling2(ctx, operations.StartHandling2Request{
        Accept: "application/json",
        ContentType: "application/json",
        OrderID: "70caf3941s6df1",
    })
