...
class Licenses:
    ...
    def license_list(self) -> operations.LicenseListResponse:
        ...
        res = operations.LicenseListResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def licenses_read(self, request: operations.LicensesReadRequest) -> operations.LicensesReadResponse:
        ...
        url = utils.generate_url(operations.LicensesReadRequest, base_url, '/license/{license_id}/', request)
        ...
        res = operations.LicensesReadResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
