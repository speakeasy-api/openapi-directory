...
class GetSearchVersionNumberPoiSearchQueryExtRequest:
    path_params: GetSearchVersionNumberPoiSearchQueryExtPathParams = dataclasses.field()
    query_params: GetSearchVersionNumberPoiSearchQueryExtQueryParams = dataclasses.field()
