...
export class EnterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequestBody extends SpeakeasyBase {
  /**
...
export class EnterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseRequest extends SpeakeasyBase {
 ...
 * Response
 */
export class EnterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterprise200ApplicationJSON extends SpeakeasyBase {
...
export class EnterpriseAdminAddCustomLabelsToSelfHostedRunnerForEnterpriseResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
