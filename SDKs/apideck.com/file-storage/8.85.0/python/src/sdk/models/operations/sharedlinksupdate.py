...
from ..shared import updatesharedlinkresponse as shared_updatesharedlinkresponse


@dataclasses.dataclass
class SharedLinksUpdatePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class SharedLinksUpdateQueryParams:
    raw: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'raw', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class SharedLinksUpdateHeaders:
...
@dataclasses.dataclass
class SharedLinksUpdateSecurity:
    api_key: shared_security.SchemeAPIKey = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclasses.dataclass
class SharedLinksUpdateRequest:
    headers: SharedLinksUpdateHeaders = dataclasses.field()
    path_params: SharedLinksUpdatePathParams = dataclasses.field()
    query_params: SharedLinksUpdateQueryParams = dataclasses.field()
    request: shared_sharedlink.SharedLinkInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: SharedLinksUpdateSecurity = dataclasses.field()
    

@dataclasses.dataclass
class SharedLinksUpdateResponse:
    ...
    update_shared_link_response: Optional[shared_updatesharedlinkresponse.UpdateSharedLinkResponse] = dataclasses.field(default=None)
