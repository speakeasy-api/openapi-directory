...
public class GETGETVerifiedAccessGroupPolicyRequest {
    ...
    public GETGETVerifiedAccessGroupPolicyRequest(@JsonProperty("Action") GETGETVerifiedAccessGroupPolicyActionEnum action, @JsonProperty("VerifiedAccessGroupId") String verifiedAccessGroupId, @JsonProperty("Version") GETGETVerifiedAccessGroupPolicyVersionEnum version) {
        this.action = action;
        this.verifiedAccessGroupId = verifiedAccessGroupId;
        this.version = version;
  }
