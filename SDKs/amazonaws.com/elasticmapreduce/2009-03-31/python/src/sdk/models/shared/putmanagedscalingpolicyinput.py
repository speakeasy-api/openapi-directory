...
class PutManagedScalingPolicyInput:
    ...
    managed_scaling_policy: shared_managedscalingpolicy.ManagedScalingPolicy = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ManagedScalingPolicy') }})  
