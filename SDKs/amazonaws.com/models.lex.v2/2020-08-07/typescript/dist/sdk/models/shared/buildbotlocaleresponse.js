...
exports.BuildBotLocaleResponse = void 0;
...
var BuildBotLocaleResponse = /** @class */ (function (_super) {
    ...
    ], BuildBotLocaleResponse.prototype, "botId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=botLocaleStatus" }),
        __metadata("design:type", String)
    ], BuildBotLocaleResponse.prototype, "botLocaleStatus", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=botVersion" }),
        __metadata("design:type", String)
    ], BuildBotLocaleResponse.prototype, "botVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=lastBuildSubmittedDateTime" }),
        __metadata("design:type", Date)
    ], BuildBotLocaleResponse.prototype, "lastBuildSubmittedDateTime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=localeId" }),
        __metadata("design:type", String)
    ], BuildBotLocaleResponse.prototype, "localeId", void 0);
    return BuildBotLocaleResponse;
}(utils_1.SpeakeasyBase));
exports.BuildBotLocaleResponse = BuildBotLocaleResponse;
