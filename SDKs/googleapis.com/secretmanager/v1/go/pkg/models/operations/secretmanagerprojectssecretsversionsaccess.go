...
type SecretmanagerProjectsSecretsVersionsAccessSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type SecretmanagerProjectsSecretsVersionsAccessPathParams struct {
...
type SecretmanagerProjectsSecretsVersionsAccessQueryParams struct {
	// V1 error format.
...
type SecretmanagerProjectsSecretsVersionsAccessRequest struct {
...
type SecretmanagerProjectsSecretsVersionsAccessResponse struct {
	// Successful response
