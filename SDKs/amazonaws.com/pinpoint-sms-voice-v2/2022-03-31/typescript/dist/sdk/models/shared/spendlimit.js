...
var spendlimitnameenum_1 = require("./spendlimitnameenum");
 ...
 */
var SpendLimit = /** @class */ (function (_super) {
    __extends(SpendLimit, _super);
    function SpendLimit() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "EnforcedLimit" }),
        __metadata("design:type", Number)
    ], SpendLimit.prototype, "enforcedLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MaxLimit" }),
        __metadata("design:type", Number)
    ], SpendLimit.prototype, "maxLimit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Name" }),
        __metadata("design:type", String)
    ], SpendLimit.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "Overridden" }),
        __metadata("design:type", Boolean)
    ], SpendLimit.prototype, "overridden", void 0);
    return SpendLimit;
