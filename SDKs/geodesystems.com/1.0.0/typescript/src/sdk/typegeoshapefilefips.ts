...
export class TypeGeoShapefileFips {
  ...
  searchGeoShapefileFips(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/geo_shapefile_fips";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchGeoShapefileFipsResponse =
        new operations.SearchGeoShapefileFipsResponse({
