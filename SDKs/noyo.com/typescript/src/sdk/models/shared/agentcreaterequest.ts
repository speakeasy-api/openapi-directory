 ...
 */
export class AgentCreateRequestAgentDetails extends SpeakeasyBase {
  /**
...
export class AgentCreateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @Type(() => AgentCreateRequestAgentDetails)
