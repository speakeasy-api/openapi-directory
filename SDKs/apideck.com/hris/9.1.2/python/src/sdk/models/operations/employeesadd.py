...
from ..shared import createemployeeresponse as shared_createemployeeresponse
...
class EmployeesAddRequest:
    ...
    employee_input: shared_employee.EmployeeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class EmployeesAddResponse:
    ...
    r"""Bad Request"""  
    create_employee_response: Optional[shared_createemployeeresponse.CreateEmployeeResponse] = dataclasses.field(default=None)
    r"""Employees"""  
