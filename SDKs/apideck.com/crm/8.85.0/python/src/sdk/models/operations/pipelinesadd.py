...
class PipelinesAddRequest:
    headers: PipelinesAddHeaders = dataclasses.field()
    query_params: PipelinesAddQueryParams = dataclasses.field()
    request: shared_pipeline.PipelineInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: PipelinesAddSecurity = dataclasses.field()
