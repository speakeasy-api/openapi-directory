 ...
 */
public enum ReservationInstancesMetadataOptionsInstanceMetadataTagsEnum {
    DISABLED("disabled"),
    ENABLED("enabled");
    ...
    private ReservationInstancesMetadataOptionsInstanceMetadataTagsEnum(String value) {
        this.value = value;
    }
}
