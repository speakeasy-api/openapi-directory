...
class GetDomesticPaymentConsentsConsentIDRequest:
    headers: GetDomesticPaymentConsentsConsentIDHeaders = dataclasses.field()
    path_params: GetDomesticPaymentConsentsConsentIDPathParams = dataclasses.field()
    security: GetDomesticPaymentConsentsConsentIDSecurity = dataclasses.field()
