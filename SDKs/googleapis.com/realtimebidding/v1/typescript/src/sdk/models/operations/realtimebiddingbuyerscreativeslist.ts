...
export class RealtimebiddingBuyersCreativesListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum RealtimebiddingBuyersCreativesListViewEnum {
  CreativeViewUnspecified = "CREATIVE_VIEW_UNSPECIFIED",
  ServingDecisionOnly = "SERVING_DECISION_ONLY",
  Full = "FULL",
}

export class RealtimebiddingBuyersCreativesListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RealtimebiddingBuyersCreativesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
