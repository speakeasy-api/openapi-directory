...
export enum ListApplicationDPUSizesXAmzTargetEnum {
  AmazonAthenaListApplicationDPUSizes = "AmazonAthena.ListApplicationDPUSizes",
}

export class ListApplicationDPUSizesRequest extends SpeakeasyBase {
...
export class ListApplicationDPUSizesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
