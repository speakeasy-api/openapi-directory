 ...
 */
export enum CreateTrackerRequestBodyPositionFilteringEnum {
  TimeBased = "TimeBased",
 ...
 */
export enum CreateTrackerRequestBodyPricingPlanEnum {
  RequestBasedUsage = "RequestBasedUsage",
  MobileAssetTracking = "MobileAssetTracking",
  MobileAssetManagement = "MobileAssetManagement",
}

export class CreateTrackerRequestBody extends SpeakeasyBase {
  /**
  ...
  positionFiltering?: CreateTrackerRequestBodyPositionFilteringEnum;
...
export class CreateTrackerRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "request, media_type=application/json" })
  requestBody: CreateTrackerRequestBody;
