...
export class GetItemPriorityFeedSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GetItemPriorityFeedRequest extends SpeakeasyBase {
  /**
...
export class GetItemPriorityFeedResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
