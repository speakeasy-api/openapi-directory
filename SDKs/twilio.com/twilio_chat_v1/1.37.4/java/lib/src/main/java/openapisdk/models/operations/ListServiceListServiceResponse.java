...
public class ListServiceListServiceResponse {
    ...
    public openapisdk.models.shared.ChatV1Service[] services;
    public ListServiceListServiceResponse withServices(openapisdk.models.shared.ChatV1Service[] services) {
