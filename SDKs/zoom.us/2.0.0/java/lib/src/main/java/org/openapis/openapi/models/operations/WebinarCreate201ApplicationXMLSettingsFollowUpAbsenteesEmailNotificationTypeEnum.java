 ...
 */
public enum WebinarCreate201ApplicationXMLSettingsFollowUpAbsenteesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private WebinarCreate201ApplicationXMLSettingsFollowUpAbsenteesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
