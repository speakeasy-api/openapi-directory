...
public class GetDealersMotorcycleRequest {
    ...
    public GetDealersMotorcycleRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public String city;
    public GetDealersMotorcycleRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetDealersMotorcycleRequest withCountry(org.openapis.openapi.models.shared.NonDefaultCountryEnum country) {
    ...
    public GetDealersMotorcycleRequest withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetDealersMotorcycleRequest withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetDealersMotorcycleRequest withInventoryUrl(String inventoryUrl) {
    ...
    public GetDealersMotorcycleRequest withLatitude(Double latitude) {
    ...
    public GetDealersMotorcycleRequest withListingCountRange(String listingCountRange) {
    ...
    public GetDealersMotorcycleRequest withLongitude(Double longitude) {
    ...
    public GetDealersMotorcycleRequest withProvider(Boolean provider) {
    ...
    public GetDealersMotorcycleRequest withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetDealersMotorcycleRequest withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetDealersMotorcycleRequest withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDealersMotorcycleRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetDealersMotorcycleRequest withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetDealersMotorcycleRequest withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public GetDealersMotorcycleRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String zip;
    public GetDealersMotorcycleRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
