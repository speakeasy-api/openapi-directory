...
public class PaymentDetailsHeaders {
    /**
    ...
    public PaymentDetailsHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public PaymentDetailsHeaders withContentType(String contentType) {
    ...
    public PaymentDetailsHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public PaymentDetailsHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
