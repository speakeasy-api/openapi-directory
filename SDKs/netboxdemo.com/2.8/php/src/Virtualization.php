...
class Virtualization 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\WritableVirtualMachineInterfaceInput $request
	...
	public function virtualizationInterfacesCreate(
        \OpenAPI\OpenAPI\Models\Shared\WritableVirtualMachineInterfaceInput $request,
    ): \OpenAPI\OpenAPI\Models\Operations\VirtualizationInterfacesCreateResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 201) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->virtualMachineInterface = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\VirtualMachineInterface', 'json');
            }
        }
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\VirtualizationInterfacesPartialUpdateResponse
    {
        ...
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "writableVirtualMachineInterfaceInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Shared\WritableVirtualMachineWithConfigContextInput $request
	...
	public function virtualizationVirtualMachinesCreate(
        \OpenAPI\OpenAPI\Models\Shared\WritableVirtualMachineWithConfigContextInput $request,
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\VirtualizationVirtualMachinesPartialUpdateResponse
    {
        ...
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "writableVirtualMachineWithConfigContextInput", "json");
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $options = array_merge_recursive($options, $body);
