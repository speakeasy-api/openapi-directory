...
import org.openapis.openapi.models.shared.AltEnum;
import org.openapis.openapi.models.shared.AnalyzePackagesRequestV1;
    ...
    public static void main(String[] args) {
        try {
            ...
            OndemandscanningProjectsLocationsScansAnalyzePackagesRequest req = new OndemandscanningProjectsLocationsScansAnalyzePackagesRequest("iure") {{
                dollarXgafv = XgafvEnum.TWO;
                analyzePackagesRequestV1 = new AnalyzePackagesRequestV1() {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            if (res.listVulnerabilitiesResponseV1 != null) {
                // handle response
            }
        } catch (Exception e) {
            // handle exception
