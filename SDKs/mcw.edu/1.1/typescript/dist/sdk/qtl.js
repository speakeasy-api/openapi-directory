...
var Qtl = /** @class */ (function () {
    function Qtl(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Qtl.prototype.getMappedQtlByPositionUsingGet = function (req, config) {
    ...
    **/
    Qtl.prototype.getQtlByRgdIdUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Qtl.prototype.getQtlListByPositionUsingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
