...
type GetModelPublicationAssociationsPathParams struct {
	// CURIE identifier for a model, e.g. MGI:5644542
	ID string `pathParam:"style=simple,explode=false,name=id"`
}

type GetModelPublicationAssociationsQueryParams struct {
