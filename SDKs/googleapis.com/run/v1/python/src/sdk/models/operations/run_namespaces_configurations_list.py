...
class RunNamespacesConfigurationsListPathParams:
    parent: str = dataclasses.field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class RunNamespacesConfigurationsListQueryParams:
...
@dataclasses.dataclass
class RunNamespacesConfigurationsListSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class RunNamespacesConfigurationsListRequest:
    path_params: RunNamespacesConfigurationsListPathParams = dataclasses.field()
    query_params: RunNamespacesConfigurationsListQueryParams = dataclasses.field()
    security: RunNamespacesConfigurationsListSecurity = dataclasses.field()
