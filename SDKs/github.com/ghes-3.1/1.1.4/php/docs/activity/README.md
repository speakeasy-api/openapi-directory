...
try {
    ...
    $request->page = 806194;
    $request->perPage = 537023;
    $request->username = 'Mckenna9';
...
try {
    ...
    $request->all = false;
    $request->before = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-12-11T05:14:57.773Z');
    $request->page = 714242;
    $request->participating = false;
    $request->perPage = 469249;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2020-06-23T22:50:14.437Z');
...
try {
    ...
    $request->username = 'Mireya.Beatty97';
...
try {
    ...
    $request->page = 16627;
    $request->perPage = 855804;
    $request->username = 'Darian.Anderson94';
...
try {
    ...
    $request->all = false;
    $request->before = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-01-08T15:06:08.615Z');
    $request->owner = 'eaque';
    $request->page = 338985;
    $request->participating = false;
    $request->perPage = 199996;
    $request->repo = 'eos';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-10-30T14:09:25.982Z');
...
try {
    ...
    $request->page = 944120;
    $request->perPage = 928082;
    $request->sort = SortEnum::UPDATED;
    $request->username = 'Mckenzie78';
...
try {
    ...
    $request->lastReadAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-01-26T22:08:21.462Z');
    $request->read = false;
...
try {
    ...
    $request->requestBody->lastReadAt = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-06-12T16:50:10.090Z');
