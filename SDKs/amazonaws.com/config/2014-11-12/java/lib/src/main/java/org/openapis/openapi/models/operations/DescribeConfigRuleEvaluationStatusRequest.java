...
public class DescribeConfigRuleEvaluationStatusRequest {
    ...
    public DescribeConfigRuleEvaluationStatusRequest(@JsonProperty("DescribeConfigRuleEvaluationStatusRequest") org.openapis.openapi.models.shared.DescribeConfigRuleEvaluationStatusRequest describeConfigRuleEvaluationStatusRequest, @JsonProperty("X-Amz-Target") DescribeConfigRuleEvaluationStatusXAmzTargetEnum xAmzTarget) {
        this.describeConfigRuleEvaluationStatusRequest = describeConfigRuleEvaluationStatusRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
