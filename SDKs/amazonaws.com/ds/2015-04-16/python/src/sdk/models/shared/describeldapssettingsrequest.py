...
class DescribeLDAPSSettingsRequest:
    ...
    type: Optional[shared_ldapstype_enum.LDAPSTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Type'), 'exclude': lambda f: f is None }})  
