...
from ..shared import mobiledeviceaction as shared_mobiledeviceaction
...
class DirectoryMobiledevicesActionSecurity:
    ...
    option1: Optional[DirectoryMobiledevicesActionSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DirectoryMobiledevicesActionSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DirectoryMobiledevicesActionRequest:
    ...
    mobile_device_action: Optional[shared_mobiledeviceaction.MobileDeviceAction] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
