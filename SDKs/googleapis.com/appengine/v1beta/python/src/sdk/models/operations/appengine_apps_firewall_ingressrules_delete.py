...
class AppengineAppsFirewallIngressRulesDeleteRequest:
    path_params: AppengineAppsFirewallIngressRulesDeletePathParams = dataclasses.field()
    query_params: AppengineAppsFirewallIngressRulesDeleteQueryParams = dataclasses.field()
    security: AppengineAppsFirewallIngressRulesDeleteSecurity = dataclasses.field()
