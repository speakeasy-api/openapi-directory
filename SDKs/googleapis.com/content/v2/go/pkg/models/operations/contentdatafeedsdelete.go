...
type ContentDatafeedsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentDatafeedsDeletePathParams struct {
...
type ContentDatafeedsDeleteQueryParams struct {
	// V1 error format.
...
type ContentDatafeedsDeleteRequest struct {
...
type ContentDatafeedsDeleteResponse struct {
	ContentType string
	StatusCode  int
