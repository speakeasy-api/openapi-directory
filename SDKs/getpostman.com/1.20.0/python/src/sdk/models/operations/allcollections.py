...
class AllCollections200ApplicationJSON:
    ...
    collections: Optional[list[AllCollections200ApplicationJSONCollections]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('collections'), 'exclude': lambda f: f is None }})  
