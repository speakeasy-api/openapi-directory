...
class MonitoringServicesServiceLevelObjectivesListRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\MonitoringServicesServiceLevelObjectivesListViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?MonitoringServicesServiceLevelObjectivesListViewEnum $view = null;
