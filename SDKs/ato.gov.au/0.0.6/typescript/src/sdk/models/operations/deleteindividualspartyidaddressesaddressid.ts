...
export class DeleteIndividualsPartyIdAddressesAddressIdRequest extends SpeakeasyBase {
  /**
...
export class DeleteIndividualsPartyIdAddressesAddressIdResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
