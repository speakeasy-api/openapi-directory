...
import { LocalGatewayRouteTableModeEnum } from "./localgatewayroutetablemodeenum";
/**
 * The type of resource to tag on creation.
 */
export declare enum CreateLocalGatewayRouteTableRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateLocalGatewayRouteTableRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateLocalGatewayRouteTableRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateLocalGatewayRouteTableRequest extends SpeakeasyBase {
    dryRun?: boolean;
