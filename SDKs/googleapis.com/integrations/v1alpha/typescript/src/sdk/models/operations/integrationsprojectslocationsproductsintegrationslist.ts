...
export class IntegrationsProjectsLocationsProductsIntegrationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
