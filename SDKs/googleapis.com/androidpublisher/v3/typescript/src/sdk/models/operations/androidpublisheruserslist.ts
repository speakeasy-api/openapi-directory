...
export class AndroidpublisherUsersListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AndroidpublisherUsersListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AndroidpublisherUsersListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
