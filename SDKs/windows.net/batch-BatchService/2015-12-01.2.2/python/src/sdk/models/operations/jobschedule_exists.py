...
@dataclasses.dataclass
class JobScheduleExistsHeaders:
...
class JobScheduleExistsRequest:
    headers: JobScheduleExistsHeaders = dataclasses.field()
    path_params: JobScheduleExistsPathParams = dataclasses.field()
    query_params: JobScheduleExistsQueryParams = dataclasses.field()
