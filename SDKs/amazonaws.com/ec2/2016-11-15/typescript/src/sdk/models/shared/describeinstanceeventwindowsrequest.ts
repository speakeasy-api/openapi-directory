 ...
 */
export class DescribeInstanceEventWindowsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export class DescribeInstanceEventWindowsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeInstanceEventWindowsRequestFilters })
  filters?: DescribeInstanceEventWindowsRequestFilters[];
