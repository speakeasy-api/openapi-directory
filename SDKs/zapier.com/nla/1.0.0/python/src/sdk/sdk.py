...
class SDK:
    r"""<img src=\\"https://cdn.zappy.app/945f9bf9e44126873952ec5113949c3f.png\\" width=\\"100\\" />
    ...
    * Route: `/api/v1/exposed/`
    ...
    def check(self) -> operations.CheckResponse:
        r"""Check
        Test that the API and auth are working.
        """
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/api/v1/check/'
    ...
    def execute_app_action_endpoint(self, request: operations.ExecuteAppActionEndpointRequest, security: operations.ExecuteAppActionEndpointSecurity) -> operations.ExecuteAppActionEndpointResponse:
        r"""Execute App Action Endpoint
        ...
        url = utils.generate_url(operations.ExecuteAppActionEndpointRequest, base_url, '/api/v1/exposed/{exposed_app_action_id}/execute/', request)
        
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "execute_request", 'json')
        ...
        res = operations.ExecuteAppActionEndpointResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ExecuteResponse])
                res.execute_response = out
    ...
    def get_configuration_link(self) -> operations.GetConfigurationLinkResponse:
        r"""Get Configuration Link
        If the user wants to execute actions that are not exposed, they can
        go here to configure and expose more.
        """
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/api/v1/configuration-link/'
        ...
        res = operations.GetConfigurationLinkResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        

        return res

    def list_exposed_actions(self) -> operations.ListExposedActionsResponse:
        r"""List Exposed Actions
        List all the currently exposed actions for the given account.
        """
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/api/v1/exposed/'
        ...
        res = operations.ListExposedActionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ExposedActionResponseSchema])
                res.exposed_action_response_schema = out
