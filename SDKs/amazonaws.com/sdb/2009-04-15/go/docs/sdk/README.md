...
func main() {
    ...
    res, err := s.SDK.GETCreateDomain(ctx, operations.GETCreateDomainRequest{
        ...
        DomainName: "illum",
        Signature: "vel",
        SignatureMethod: "error",
        SignatureVersion: "deserunt",
        Timestamp: "suscipit",
...
func main() {
    ...
    res, err := s.SDK.GETDeleteDomain(ctx, operations.GETDeleteDomainRequest{
        ...
        DomainName: "magnam",
        Signature: "debitis",
        SignatureMethod: "ipsa",
        SignatureVersion: "delectus",
        Timestamp: "tempora",
        Version: operations.GETDeleteDomainVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GETDomainMetadata(ctx, operations.GETDomainMetadataRequest{
        AWSAccessKeyID: "suscipit",
        Action: operations.GETDomainMetadataActionEnumDomainMetadata,
        DomainName: "molestiae",
        Signature: "minus",
        SignatureMethod: "placeat",
        SignatureVersion: "voluptatum",
        Timestamp: "iusto",
        Version: operations.GETDomainMetadataVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GETGETAttributes(ctx, operations.GETGETAttributesRequest{
        AWSAccessKeyID: "excepturi",
        Action: operations.GETGETAttributesActionEnumGetAttributes,
        ...
        ItemName: "quis",
        Signature: "veritatis",
        SignatureMethod: "deserunt",
        SignatureVersion: "perferendis",
        Timestamp: "ipsam",
        Version: operations.GETGETAttributesVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GETListDomains(ctx, operations.GETListDomainsRequest{
        AWSAccessKeyID: "repellendus",
        Action: operations.GETListDomainsActionEnumListDomains,
        MaxNumberOfDomains: sdk.Int64(957156),
        NextToken: sdk.String("quo"),
        Signature: "odit",
        SignatureMethod: "at",
        SignatureVersion: "at",
        Timestamp: "maiores",
        Version: operations.GETListDomainsVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.GETSelect(ctx, operations.GETSelectRequest{
        AWSAccessKeyID: "molestiae",
        Action: operations.GETSelectActionEnumSelect,
        ConsistentRead: sdk.Bool(false),
        NextToken: sdk.String("quod"),
        SelectExpression: "quod",
        Signature: "esse",
        SignatureMethod: "totam",
        SignatureVersion: "porro",
        Timestamp: "dolorum",
        Version: operations.GETSelectVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTBatchDeleteAttributes(ctx, operations.POSTBatchDeleteAttributesRequest{
        AWSAccessKeyID: "dicta",
        Action: operations.POSTBatchDeleteAttributesActionEnumBatchDeleteAttributes,
        RequestBody: []byte("nam"),
        Signature: "officia",
        SignatureMethod: "occaecati",
        SignatureVersion: "fugit",
        Timestamp: "deleniti",
        Version: operations.POSTBatchDeleteAttributesVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTBatchPutAttributes(ctx, operations.POSTBatchPutAttributesRequest{
        AWSAccessKeyID: "hic",
        Action: operations.POSTBatchPutAttributesActionEnumBatchPutAttributes,
        RequestBody: []byte("optio"),
        Signature: "totam",
        SignatureMethod: "beatae",
        SignatureVersion: "commodi",
        Timestamp: "molestiae",
        Version: operations.POSTBatchPutAttributesVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.POSTCreateDomain(ctx, operations.POSTCreateDomainRequest{
        ...
        Signature: "impedit",
        SignatureMethod: "cum",
        SignatureVersion: "esse",
        Timestamp: "ipsum",
        Version: operations.POSTCreateDomainVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTDeleteAttributes(ctx, operations.POSTDeleteAttributesRequest{
        AWSAccessKeyID: "excepturi",
        Action: operations.POSTDeleteAttributesActionEnumDeleteAttributes,
        RequestBody: []byte("aspernatur"),
        Signature: "perferendis",
        SignatureMethod: "ad",
        SignatureVersion: "natus",
        Timestamp: "sed",
        Version: operations.POSTDeleteAttributesVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.SDK.POSTDeleteDomain(ctx, operations.POSTDeleteDomainRequest{
        ...
        Signature: "natus",
        SignatureMethod: "laboriosam",
        SignatureVersion: "hic",
        Timestamp: "saepe",
        Version: operations.POSTDeleteDomainVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTDomainMetadata(ctx, operations.POSTDomainMetadataRequest{
        AWSAccessKeyID: "fuga",
        Action: operations.POSTDomainMetadataActionEnumDomainMetadata,
        RequestBody: []byte("in"),
        Signature: "corporis",
        SignatureMethod: "iste",
        SignatureVersion: "iure",
        Timestamp: "saepe",
        Version: operations.POSTDomainMetadataVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTGetAttributes(ctx, operations.POSTGetAttributesRequest{
        AWSAccessKeyID: "quidem",
        Action: operations.POSTGetAttributesActionEnumGetAttributes,
        RequestBody: []byte("architecto"),
        Signature: "ipsa",
        SignatureMethod: "reiciendis",
        SignatureVersion: "est",
        Timestamp: "mollitia",
        Version: operations.POSTGetAttributesVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTListDomains(ctx, operations.POSTListDomainsRequest{
        AWSAccessKeyID: "laborum",
        Action: operations.POSTListDomainsActionEnumListDomains,
        MaxNumberOfDomains: sdk.String("dolores"),
        NextToken: sdk.String("dolorem"),
        RequestBody: []byte("corporis"),
        Signature: "explicabo",
        SignatureMethod: "nobis",
        SignatureVersion: "enim",
        Timestamp: "omnis",
        Version: operations.POSTListDomainsVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTPutAttributes(ctx, operations.POSTPutAttributesRequest{
        AWSAccessKeyID: "nemo",
        Action: operations.POSTPutAttributesActionEnumPutAttributes,
        RequestBody: []byte("minima"),
        Signature: "excepturi",
        SignatureMethod: "accusantium",
        SignatureVersion: "iure",
        Timestamp: "culpa",
        Version: operations.POSTPutAttributesVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.SDK.POSTSelect(ctx, operations.POSTSelectRequest{
        AWSAccessKeyID: "doloribus",
        Action: operations.POSTSelectActionEnumSelect,
        NextToken: sdk.String("sapiente"),
        RequestBody: []byte("architecto"),
        Signature: "mollitia",
        SignatureMethod: "dolorem",
        SignatureVersion: "culpa",
        Timestamp: "consequuntur",
        Version: operations.POSTSelectVersionEnumTwoThousandAndNine0415,
    })
    if err != nil {
        log.Fatal(err)
    }
