...
class TenancyTenantGroupsListQueryParams:
    ...
    parent_n: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'parent__n', 'style': 'form', 'explode': True }})
...
class TenancyTenantGroupsList200ApplicationJSON:
    ...
    results: list[shared_tenantgroup.TenantGroup] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class TenancyTenantGroupsListRequest:
    query_params: TenancyTenantGroupsListQueryParams = dataclasses.field()
...
class TenancyTenantGroupsListResponse:
    ...
    tenancy_tenant_groups_list_200_application_json_object: Optional[TenancyTenantGroupsList200ApplicationJSON] = dataclasses.field(default=None)
