...
class Metadata:
    ...
    completeness: Optional[shared_completeness.Completeness] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('completeness'), 'exclude': lambda f: f is None }})
