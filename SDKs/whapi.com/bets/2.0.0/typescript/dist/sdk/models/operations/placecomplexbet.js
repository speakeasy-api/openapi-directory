...
exports.PlaceComplexBetResponse = exports.PlaceComplexBetRequest = void 0;
...
var PlaceComplexBetRequest = /** @class */ (function (_super) {
    ...
    ], PlaceComplexBetRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=apiSecret",
        }),
        __metadata("design:type", String)
    ], PlaceComplexBetRequest.prototype, "apiSecret", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=apiTicket",
        }),
        __metadata("design:type", String)
    ], PlaceComplexBetRequest.prototype, "apiTicket", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.ComplexBetRequestBody)
    ], PlaceComplexBetRequest.prototype, "complexBetRequestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=exclude",
        }),
        __metadata("design:type", Array)
    ], PlaceComplexBetRequest.prototype, "exclude", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=fields",
        }),
        __metadata("design:type", Array)
    ], PlaceComplexBetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=include",
        }),
        __metadata("design:type", Array)
    ], PlaceComplexBetRequest.prototype, "include", void 0);
...
var PlaceComplexBetResponse = /** @class */ (function (_super) {
    ...
    ], PlaceComplexBetResponse.prototype, "rawResponse", void 0);
    __decorate([
