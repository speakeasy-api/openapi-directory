...
from ..shared import jobterminateparameter as shared_jobterminateparameter
...
class JobTerminateRequest:
    ...
    r"""The id of the job to terminate."""  
    ...
    job_terminate_parameter: Optional[shared_jobterminateparameter.JobTerminateParameter] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
