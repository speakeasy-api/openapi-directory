...
from ..shared import deleteassetmodelresponse as shared_deleteassetmodelresponse
...
class DeleteAssetModelRequest:
    headers: DeleteAssetModelHeaders = dataclasses.field()
    path_params: DeleteAssetModelPathParams = dataclasses.field()
    query_params: DeleteAssetModelQueryParams = dataclasses.field()
...
class DeleteAssetModelResponse:
    ...
    delete_asset_model_response: Optional[shared_deleteassetmodelresponse.DeleteAssetModelResponse] = dataclasses.field(default=None)
