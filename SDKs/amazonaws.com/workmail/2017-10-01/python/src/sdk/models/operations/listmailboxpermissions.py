...
class ListMailboxPermissionsRequest:
    ...
    list_mailbox_permissions_request: shared_listmailboxpermissionsrequest.ListMailboxPermissionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
