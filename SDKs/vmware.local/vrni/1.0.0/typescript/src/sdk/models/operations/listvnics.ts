...
export class ListVnicsSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ListVnicsRequest extends SpeakeasyBase {
  /**
...
export class ListVnicsResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
