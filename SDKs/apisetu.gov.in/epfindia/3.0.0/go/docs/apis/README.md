...
func main() {
    ...
    ctx := context.Background()
    res, err := s.APIs.Uncrd(ctx, operations.UncrdRequestBody{
        CertificateParameters: &operations.UncrdRequestBodyCertificateParameters{
            Dob: "31-12-1980",
            Uan: "10000003577",
        },
        ConsentArtifact: &shared.ConsentArtifactSchema{
        ...
        Format: operations.UncrdRequestBodyFormatEnumPdf,
        TxnID: "f7f1469c-29b0-4325-9dfc-c567200a70f7",
    }, operations.UncrdSecurity{
        APIKey: "YOUR_API_KEY_HERE",
        ClientID: "YOUR_API_KEY_HERE",
    })
    if err != nil {
