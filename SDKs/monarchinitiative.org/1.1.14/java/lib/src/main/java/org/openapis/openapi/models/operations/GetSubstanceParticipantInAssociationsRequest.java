...
public class GetSubstanceParticipantInAssociationsRequest {
    ...
    public GetSubstanceParticipantInAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsRequest withEvidence(String evidence) {
    ...
    public GetSubstanceParticipantInAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetSubstanceParticipantInAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetSubstanceParticipantInAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetSubstanceParticipantInAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetSubstanceParticipantInAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetSubstanceParticipantInAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetSubstanceParticipantInAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
