...
export class OfferingMetadata {
  ...
  putOfferingsOfferingIdMetadataCategory(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.PutOfferingsOfferingIdMetadataCategoryResponse =
        new operations.PutOfferingsOfferingIdMetadataCategoryResponse({
  ...
  putOfferingsOfferingIdMetadataLevel(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutOfferingsOfferingIdMetadataLevelResponse =
        new operations.PutOfferingsOfferingIdMetadataLevelResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  putOfferingsOfferingIdMetadataTags(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutOfferingsOfferingIdMetadataTagsResponse =
        new operations.PutOfferingsOfferingIdMetadataTagsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  putOfferingsOfferingIdMetadataTopic(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.PutOfferingsOfferingIdMetadataTopicResponse =
        new operations.PutOfferingsOfferingIdMetadataTopicResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
