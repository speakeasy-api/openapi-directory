 ...
 */
export class DescribeIamInstanceProfileAssociationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeIamInstanceProfileAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
