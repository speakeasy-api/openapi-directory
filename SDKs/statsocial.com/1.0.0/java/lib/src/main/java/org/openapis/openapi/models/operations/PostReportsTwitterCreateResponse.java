...
public class PostReportsTwitterCreateResponse {
    /**
    ...
    public PostReportsTwitterCreateResponse withFourHundredError(org.openapis.openapi.models.shared.FourHundredError fourHundredError) {
    ...
    public PostReportsTwitterCreateResponse withFourHundredAndOneError(org.openapis.openapi.models.shared.FourHundredAndOneError fourHundredAndOneError) {
    ...
    public PostReportsTwitterCreateResponse withFourHundredAndThreeError(org.openapis.openapi.models.shared.FourHundredAndThreeError fourHundredAndThreeError) {
    ...
    public PostReportsTwitterCreateResponse withFiveHundredError(org.openapis.openapi.models.shared.FiveHundredError fiveHundredError) {
    ...
    public PostReportsTwitterCreateResponse withContentType(String contentType) {
    ...
    public PostReportsTwitterCreateResponse withCreateTwitter(org.openapis.openapi.models.shared.CreateTwitter createTwitter) {
    ...
    public PostReportsTwitterCreateResponse withStatusCode(Integer statusCode) {
    ...
    public PostReportsTwitterCreateResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
        this.rawResponse = rawResponse;
        return this;
    }
    
    public PostReportsTwitterCreateResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
