...
type ClouddeployProjectsLocationsTargetsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ClouddeployProjectsLocationsTargetsCreatePathParams struct {
...
type ClouddeployProjectsLocationsTargetsCreateQueryParams struct {
	// V1 error format.
	...
	TargetID *string `queryParam:"style=form,explode=true,name=targetId"`
...
type ClouddeployProjectsLocationsTargetsCreateRequest struct {
...
type ClouddeployProjectsLocationsTargetsCreateResponse struct {
	ContentType string
	// Successful response
