...
class AnalyticsManagementRemarketingAudienceUpdateRequest:
    ...
    r"""The account ID of the remarketing audience to update."""  
    ...
    remarketing_audience_input: Optional[shared_remarketingaudience.RemarketingAudienceInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
