...
class GetMeQuestionsUnacceptedQueryParams:
    ...
    order: Optional[GetMeQuestionsUnacceptedOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeQuestionsUnacceptedSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeQuestionsUnacceptedRequest:
    query_params: GetMeQuestionsUnacceptedQueryParams = dataclasses.field()
