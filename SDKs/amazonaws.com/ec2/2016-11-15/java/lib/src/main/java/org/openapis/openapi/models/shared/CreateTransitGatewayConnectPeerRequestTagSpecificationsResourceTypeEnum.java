 ...
 */
public enum CreateTransitGatewayConnectPeerRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTransitGatewayConnectPeerRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
