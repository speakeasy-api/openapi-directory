 ...
 */
var AlternateKey = /** @class */ (function (_super) {
    __extends(AlternateKey, _super);
    function AlternateKey() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "allowDuplicates" }),
        __metadata("design:type", Boolean)
    ], AlternateKey.prototype, "allowDuplicates", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "length" }),
        __metadata("design:type", Number)
    ], AlternateKey.prototype, "length", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "name" }),
        __metadata("design:type", String)
    ], AlternateKey.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "offset" }),
        __metadata("design:type", Number)
    ], AlternateKey.prototype, "offset", void 0);
    return AlternateKey;
