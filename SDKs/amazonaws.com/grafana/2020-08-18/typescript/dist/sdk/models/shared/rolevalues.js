 ...
 */
var RoleValues = /** @class */ (function (_super) {
    __extends(RoleValues, _super);
    function RoleValues() {
    ...
    ], RoleValues.prototype, "admin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "editor" }),
        __metadata("design:type", Array)
    ], RoleValues.prototype, "editor", void 0);
    return RoleValues;
