 ...
 */
export declare enum CreateCarrierGatewayRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateCarrierGatewayRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateCarrierGatewayRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateCarrierGatewayRequest extends SpeakeasyBase {
    clientToken?: string;
    dryRun?: boolean;
