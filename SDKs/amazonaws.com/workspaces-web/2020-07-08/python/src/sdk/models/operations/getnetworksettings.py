...
from ..shared import getnetworksettingsresponse as shared_getnetworksettingsresponse
...
class GetNetworkSettingsResponse:
    ...
    get_network_settings_response: Optional[shared_getnetworksettingsresponse.GetNetworkSettingsResponse] = dataclasses.field(default=None)
    r"""Success"""  
