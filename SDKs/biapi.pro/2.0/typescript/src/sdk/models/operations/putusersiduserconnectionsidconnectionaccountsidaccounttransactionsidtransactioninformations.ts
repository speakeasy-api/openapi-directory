...
export class PutUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PutUsersIdUserConnectionsIdConnectionAccountsIdAccountTransactionsIdTransactionInformationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
