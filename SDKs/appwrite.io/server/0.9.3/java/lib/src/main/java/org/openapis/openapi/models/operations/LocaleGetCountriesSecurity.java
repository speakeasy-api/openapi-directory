...
public class LocaleGetCountriesSecurity {
    ...
    public LocaleGetCountriesSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public LocaleGetCountriesSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public LocaleGetCountriesSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public LocaleGetCountriesSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
