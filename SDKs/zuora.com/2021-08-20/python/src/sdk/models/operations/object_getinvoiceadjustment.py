...
from ..shared import proxygetinvoiceadjustment as shared_proxygetinvoiceadjustment
...
class ObjectGETInvoiceAdjustmentResponse:
    ...
    proxy_get_invoice_adjustment: Optional[shared_proxygetinvoiceadjustment.ProxyGetInvoiceAdjustment] = dataclasses.field(default=None)  
