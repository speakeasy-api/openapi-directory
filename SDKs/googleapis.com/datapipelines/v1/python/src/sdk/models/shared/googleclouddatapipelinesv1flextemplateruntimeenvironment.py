...
class GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment:
    ...
    r"""Additional user labels to be specified for the job. Keys and values must follow the restrictions specified in the [labeling restrictions](https://cloud.google.com/compute/docs/labeling-resources#restrictions). An object containing a list of key/value pairs. Example: `{ \\"name\\": \\"wrench\\", \\"mass\\": \\"1kg\\", \\"count\\": \\"3\\" }`."""  
    ...
    flexrs_goal: Optional[GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentFlexrsGoalEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flexrsGoal'), 'exclude': lambda f: f is None }})
    r"""Set FlexRS goal for the job. https://cloud.google.com/dataflow/docs/guides/flexrs"""  
    ip_configuration: Optional[GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironmentIPConfigurationEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ipConfiguration'), 'exclude': lambda f: f is None }})
    r"""Configuration for VM IPs."""  
    ...
    r"""The maximum number of Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000."""  
    ...
    r"""The initial number of Compute Engine instances for the job."""  
    ...
    r"""The Compute Engine region (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. \\"us-west1\\". Mutually exclusive with worker_zone. If neither worker_region nor worker_zone is specified, defaults to the control plane region."""  
    ...
    r"""The Compute Engine zone (https://cloud.google.com/compute/docs/regions-zones/regions-zones) in which worker processing should occur, e.g. \\"us-west1-a\\". Mutually exclusive with worker_region. If neither worker_region nor worker_zone is specified, a zone in the control plane region is chosen based on available capacity. If both `worker_zone` and `zone` are set, `worker_zone` takes precedence."""  
