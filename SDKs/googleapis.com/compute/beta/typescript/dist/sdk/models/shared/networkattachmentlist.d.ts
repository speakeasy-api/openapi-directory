 ...
 */
export declare enum NetworkAttachmentListWarningCodeEnum {
...
export declare class NetworkAttachmentListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class NetworkAttachmentListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: NetworkAttachmentListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: NetworkAttachmentListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class NetworkAttachmentList extends SpeakeasyBase {
    /**
