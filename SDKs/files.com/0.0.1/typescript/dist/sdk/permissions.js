...
var Permissions = /** @class */ (function () {
     ...
     * Delete Permission
    **/
    Permissions.prototype.deletePermissionsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeletePermissionsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/permissions/{id}", req.pathParams);
     ...
     * List Permissions
    **/
    Permissions.prototype.getPermissions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Create Permission
    **/
    Permissions.prototype.postPermissions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.permissionEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
