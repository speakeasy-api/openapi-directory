...
class TaskrouterV1WorkspaceTaskTaskReservation:
    ...
    reservation_status: Optional[shared_task_reservation_enum_status_enum.TaskReservationEnumStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reservation_status') }})
