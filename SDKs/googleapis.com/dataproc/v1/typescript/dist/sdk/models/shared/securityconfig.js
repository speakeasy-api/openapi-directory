...
var identityconfig_1 = require("./identityconfig");
...
var SecurityConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=identityConfig" }),
        __metadata("design:type", identityconfig_1.IdentityConfig)
