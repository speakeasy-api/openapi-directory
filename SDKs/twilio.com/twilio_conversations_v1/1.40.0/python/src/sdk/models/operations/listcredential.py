...
class ListCredentialListCredentialResponse:
    ...
    credentials: Optional[list[shared_conversations_v1_credential.ConversationsV1Credential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('credentials'), 'exclude': lambda f: f is None }})  
