...
class AccountHalResponse:
    ...
    embedded: Optional[shared_accountembeddedobject.AccountEmbeddedObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('_embedded'), 'exclude': lambda f: f is None }})
    r"""Account object"""  
