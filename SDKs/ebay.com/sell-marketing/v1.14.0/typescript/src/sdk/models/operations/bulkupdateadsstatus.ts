...
export class BulkUpdateAdsStatusSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BulkUpdateAdsStatusRequest extends SpeakeasyBase {
  /**
...
export class BulkUpdateAdsStatusResponse extends SpeakeasyBase {
  /**
   * Success
   */
  @SpeakeasyMetadata()
