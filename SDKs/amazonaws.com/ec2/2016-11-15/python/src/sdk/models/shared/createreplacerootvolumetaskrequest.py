...
class CreateReplaceRootVolumeTaskRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateReplaceRootVolumeTaskRequestTagSpecificationsTags:
    r"""Describes a tag."""
...
class CreateReplaceRootVolumeTaskRequestTagSpecifications:
    ...
    resource_type: Optional[CreateReplaceRootVolumeTaskRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateReplaceRootVolumeTaskRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateReplaceRootVolumeTaskRequest:
    ...
    tag_specifications: Optional[list[CreateReplaceRootVolumeTaskRequestTagSpecifications]] = dataclasses.field(default=None)  
