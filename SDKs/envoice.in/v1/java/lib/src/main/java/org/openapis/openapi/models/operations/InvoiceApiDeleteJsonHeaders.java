...
public class InvoiceApiDeleteJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public InvoiceApiDeleteJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public InvoiceApiDeleteJsonHeaders withXAuthSecret(String xAuthSecret) {
