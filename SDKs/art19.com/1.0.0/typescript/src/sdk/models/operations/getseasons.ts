...
export class GetSeasons400ApplicationVndApiPlusJsonErrors extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "source" })
  @Type(() => GetSeasons400ApplicationVndApiPlusJsonErrorsSource)
...
export class GetSeasons400ApplicationVndApiPlusJson extends SpeakeasyBase {
   ...
   *
   */
  @SpeakeasyMetadata({ elemType: GetSeasons400ApplicationVndApiPlusJsonErrors })
  @Expose({ name: "errors" })
  @Type(() => GetSeasons400ApplicationVndApiPlusJsonErrors)
...
export class GetSeasons200ApplicationVndApiPlusJson extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.Season })
  @Expose({ name: "data" })
  @Type(() => shared.Season)
  data?: shared.Season[];
