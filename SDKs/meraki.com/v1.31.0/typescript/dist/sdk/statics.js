...
var Statics = /** @class */ (function () {
    function Statics(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Add a static delegated prefix from a network
     */
    Statics.prototype.createNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        var _a;
     ...
     * Delete a static delegated prefix from a network
     */
    Statics.prototype.deleteNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Return a static delegated prefix from a network
     */
    Statics.prototype.getNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * List static delegated prefixes for a network
     */
    Statics.prototype.getNetworkAppliancePrefixesDelegatedStatics = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update a static delegated prefix from a network
     */
    Statics.prototype.updateNetworkAppliancePrefixesDelegatedStatic = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
