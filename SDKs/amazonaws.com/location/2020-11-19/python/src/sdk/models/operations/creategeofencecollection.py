...
from ..shared import creategeofencecollectionresponse as shared_creategeofencecollectionresponse
...
class CreateGeofenceCollectionRequestBody:
    ...
    pricing_plan: CreateGeofenceCollectionRequestBodyPricingPlanEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PricingPlan') }})
...
class CreateGeofenceCollectionRequest:
    headers: CreateGeofenceCollectionHeaders = dataclasses.field()
    request: CreateGeofenceCollectionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateGeofenceCollectionResponse:
    ...
    create_geofence_collection_response: Optional[shared_creategeofencecollectionresponse.CreateGeofenceCollectionResponse] = dataclasses.field(default=None)
