...
public class GetV2CrmActivitiesJsonQueryParams {
    /**
     * IDs of crm activities to fetch.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=false,name=ids")
    public Long[] ids;
    public GetV2CrmActivitiesJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2CrmActivitiesJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2CrmActivitiesJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2CrmActivitiesJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2CrmActivitiesJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2CrmActivitiesJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2CrmActivitiesJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public GetV2CrmActivitiesJsonQueryParams withUpdatedAt(String[] updatedAt) {
