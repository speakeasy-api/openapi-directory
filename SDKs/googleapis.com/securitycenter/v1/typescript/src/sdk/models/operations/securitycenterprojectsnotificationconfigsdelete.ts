...
export class SecuritycenterProjectsNotificationConfigsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsNotificationConfigsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class SecuritycenterProjectsNotificationConfigsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
