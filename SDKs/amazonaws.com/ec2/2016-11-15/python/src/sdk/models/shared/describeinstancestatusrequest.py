...
class DescribeInstanceStatusRequestFilters:
...
class DescribeInstanceStatusRequest:
    ...
    filters: Optional[list[DescribeInstanceStatusRequestFilters]] = dataclasses.field(default=None)  
    include_all_instances: Optional[bool] = dataclasses.field(default=None)  
