...
exports.AdsenseAdunitsGetResponse = exports.AdsenseAdunitsGetRequest = exports.AdsenseAdunitsGetSecurity = exports.AdsenseAdunitsGetSecurityOption2 = exports.AdsenseAdunitsGetSecurityOption1 = void 0;
...
exports.AdsenseAdunitsGetSecurityOption1 = AdsenseAdunitsGetSecurityOption1;
...
exports.AdsenseAdunitsGetSecurityOption2 = AdsenseAdunitsGetSecurityOption2;
...
exports.AdsenseAdunitsGetSecurity = AdsenseAdunitsGetSecurity;
var AdsenseAdunitsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "adClientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=adUnitId",
        }),
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "adUnitId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdsenseAdunitsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdsenseAdunitsGetRequest.prototype, "userIp", void 0);
    return AdsenseAdunitsGetRequest;
}(utils_1.SpeakeasyBase));
exports.AdsenseAdunitsGetRequest = AdsenseAdunitsGetRequest;
var AdsenseAdunitsGetResponse = /** @class */ (function (_super) {
    ...
    ], AdsenseAdunitsGetResponse.prototype, "rawResponse", void 0);
    return AdsenseAdunitsGetResponse;
}(utils_1.SpeakeasyBase));
exports.AdsenseAdunitsGetResponse = AdsenseAdunitsGetResponse;
