...
class DatamigrationProjectsLocationsPrivateConnectionsDeleteSecurity:
...
@dataclasses.dataclass
class DatamigrationProjectsLocationsPrivateConnectionsDeleteRequest:
    
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    r"""Required. The name of the private connection to delete."""  
...
@dataclasses.dataclass
class DatamigrationProjectsLocationsPrivateConnectionsDeleteResponse:
