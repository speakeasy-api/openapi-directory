...
class AppengineAppsServicesVersionsInstancesDebugRequest:
    ...
    r"""JSONP"""  
    debug_instance_request: Optional[shared_debuginstancerequest.DebugInstanceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
