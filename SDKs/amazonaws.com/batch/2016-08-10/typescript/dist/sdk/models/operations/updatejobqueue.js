...
exports.UpdateJobQueueResponse = exports.UpdateJobQueueRequest = exports.UpdateJobQueueRequestBody = exports.UpdateJobQueueRequestBodyStateEnum = void 0;
...
var UpdateJobQueueRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ComputeEnvironmentOrder }),
        (0, class_transformer_1.Expose)({ name: "computeEnvironmentOrder" }),
        (0, class_transformer_1.Type)(function () { return shared.ComputeEnvironmentOrder; }),
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateJobQueueRequestBody.prototype, "schedulingPolicyArn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
var UpdateJobQueueRequest = /** @class */ (function (_super) {
    ...
    ], UpdateJobQueueRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], UpdateJobQueueRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], UpdateJobQueueRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], UpdateJobQueueRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], UpdateJobQueueRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], UpdateJobQueueRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], UpdateJobQueueRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], UpdateJobQueueRequest.prototype, "xAmzSignedHeaders", void 0);
...
var UpdateJobQueueResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], UpdateJobQueueResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
