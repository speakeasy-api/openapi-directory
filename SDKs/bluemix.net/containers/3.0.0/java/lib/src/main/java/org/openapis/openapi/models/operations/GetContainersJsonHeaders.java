...
public class GetContainersJsonHeaders {
    /**
    ...
    public GetContainersJsonHeaders withXAuthProjectId(String xAuthProjectId) {
    ...
    public GetContainersJsonHeaders withXAuthToken(String xAuthToken) {
