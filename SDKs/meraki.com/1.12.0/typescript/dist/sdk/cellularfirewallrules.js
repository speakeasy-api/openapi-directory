...
exports.CellularFirewallRules = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var CellularFirewallRules = /** @class */ (function () {
    function CellularFirewallRules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CellularFirewallRules.prototype.getNetworkApplianceFirewallCellularFirewallRules = function (req, config) {
    ...
    **/
    CellularFirewallRules.prototype.updateNetworkApplianceFirewallCellularFirewallRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.CellularFirewallRules = CellularFirewallRules;
