...
exports.ActionBatches = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var ActionBatches = /** @class */ (function () {
    function ActionBatches(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ActionBatches.prototype.createOrganizationActionBatch = function (req, config) {
        var _a;
    ...
    **/
    ActionBatches.prototype.deleteOrganizationActionBatch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ActionBatches.prototype.getOrganizationActionBatch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ActionBatches.prototype.getOrganizationActionBatches = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ActionBatches.prototype.updateOrganizationActionBatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.ActionBatches = ActionBatches;
