...
/**
 * TargetedAdsPagedCollection - A type that defines the keywords of the paged collection.
 */
public class TargetedAdsPagedCollection {
    ...
    public TargetedAdsPagedCollection withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public TargetedAdsPagedCollection withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
    ...
    public TargetedAdsPagedCollection withNext(String next) {
        this.next = next;
        return this;
    }
    ...
    public TargetedAdsPagedCollection withOffset(Integer offset) {
        this.offset = offset;
        return this;
    }
    ...
    public TargetedAdsPagedCollection withPrev(String prev) {
        this.prev = prev;
        return this;
    }
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("suggestedItems")
    public TargetingItems[] suggestedItems;

    public TargetedAdsPagedCollection withSuggestedItems(TargetingItems[] suggestedItems) {
    ...
    public TargetedAdsPagedCollection withTotal(Integer total) {
        this.total = total;
        return this;
    }
