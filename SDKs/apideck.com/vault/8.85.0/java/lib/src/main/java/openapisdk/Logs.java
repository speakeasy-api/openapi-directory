...
public class Logs {
     ...
     * 
    **/
    public openapisdk.models.operations.LogsAllResponse logsAll(openapisdk.models.operations.LogsAllRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/vault/logs");
        ...
        openapisdk.models.operations.LogsAllResponse res = new openapisdk.models.operations.LogsAllResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.GetLogsResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetLogsResponse.class);
