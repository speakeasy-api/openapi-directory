 ...
 */
export declare enum ResourcePolicyListWarningCodeEnum {
...
export declare class ResourcePolicyListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class ResourcePolicyListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: ResourcePolicyListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: ResourcePolicyListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class ResourcePolicyList extends SpeakeasyBase {
    etag?: string;
    /**
