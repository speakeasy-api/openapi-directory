...
var connectivityenum_1 = require("./connectivityenum");
...
var taskstopcodeenum_1 = require("./taskstopcodeenum");
...
var Task = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=connectivityAt" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=stopCode" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=stoppedReason" }),
        __metadata("design:type", String)
    ], Task.prototype, "stoppedReason", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=stoppingAt" }),
        __metadata("design:type", Date)
