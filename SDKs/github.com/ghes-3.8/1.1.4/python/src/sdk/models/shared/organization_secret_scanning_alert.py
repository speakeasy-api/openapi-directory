...
class OrganizationSecretScanningAlert:
    ...
    r"""A GitHub user."""  
    repository: Optional[shared_simple_repository.SimpleRepository] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('repository'), 'exclude': lambda f: f is None }})
    ...
    r"""The comment that was optionally added when this alert was closed"""  
