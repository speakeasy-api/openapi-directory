    ...
    public openapisdk.models.operations.GetStatementsResponse getStatements(openapisdk.models.operations.GetStatementsRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json;charset=UTF-8")) {
                ...
                openapisdk.models.shared.StatementResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.StatementResponse.class);
