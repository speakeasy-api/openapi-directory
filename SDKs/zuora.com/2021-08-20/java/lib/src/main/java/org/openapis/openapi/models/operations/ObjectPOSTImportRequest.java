...
public class ObjectPOSTImportRequest {
    ...
    public ObjectPOSTImportRequest withRequestBody(ObjectPOSTImportRequestBody requestBody) {
    ...
    public ObjectPOSTImportRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ObjectPOSTImportRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ObjectPOSTImportRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
