...
class ListServiceListServiceResponse:
    ...
    services: Optional[list[shared_ip_messaging_v1_service.IPMessagingV1Service]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('services') }})
