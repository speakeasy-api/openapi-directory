...
class AndroidpublisherEditsApklistingsDeleteallRequest:
    path_params: AndroidpublisherEditsApklistingsDeleteallPathParams = dataclasses.field()
    query_params: AndroidpublisherEditsApklistingsDeleteallQueryParams = dataclasses.field()
    security: AndroidpublisherEditsApklistingsDeleteallSecurity = dataclasses.field()
