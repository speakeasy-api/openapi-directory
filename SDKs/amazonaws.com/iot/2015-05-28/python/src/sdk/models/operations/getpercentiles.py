...
from ..shared import getpercentilesresponse as shared_getpercentilesresponse
...
class GetPercentilesRequestBody:
    ...
    percents: Optional[list[float]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('percents') }})
...
class GetPercentilesRequest:
    headers: GetPercentilesHeaders = dataclasses.field()
    request: GetPercentilesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetPercentilesResponse:
    ...
    get_percentiles_response: Optional[shared_getpercentilesresponse.GetPercentilesResponse] = dataclasses.field(default=None)
