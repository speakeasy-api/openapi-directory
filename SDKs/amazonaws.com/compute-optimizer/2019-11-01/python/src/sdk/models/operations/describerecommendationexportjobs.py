...
class DescribeRecommendationExportJobsRequest:
    ...
    describe_recommendation_export_jobs_request: shared_describerecommendationexportjobsrequest.DescribeRecommendationExportJobsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
