...
var JsonRpc = /** @class */ (function () {
    function JsonRpc(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    JsonRpc.prototype.jsonRpc = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.JsonRpcRequest(req);
        }
        var baseURL = operations.JsonRpcServerList[0];
        if (req.serverURL) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.rpcResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
