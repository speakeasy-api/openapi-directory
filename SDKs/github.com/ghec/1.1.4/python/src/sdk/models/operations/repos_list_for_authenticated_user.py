...
class ReposListForAuthenticatedUserTypeEnum(str, Enum):
    r"""Limit results to repositories of the specified type. Will cause a `422` error if used in the same request as **visibility** or **affiliation**."""
    ALL = 'all'
    OWNER = 'owner'
    PUBLIC = 'public'
    PRIVATE = 'private'
...
class ReposListForAuthenticatedUserVisibilityEnum(str, Enum):
    r"""Limit results to repositories with the specified visibility."""
    ALL = 'all'
    PUBLIC = 'public'
    PRIVATE = 'private'
