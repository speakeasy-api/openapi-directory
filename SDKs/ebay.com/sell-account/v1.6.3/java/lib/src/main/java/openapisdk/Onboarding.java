...
public class Onboarding {
    ...
    **/
    public openapisdk.models.operations.GetPaymentsProgramOnboardingResponse getPaymentsProgramOnboarding(openapisdk.models.operations.GetPaymentsProgramOnboardingRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/payments_program/{marketplace_id}/{payments_program_type}/onboarding", request.pathParams);
        ...
        openapisdk.models.operations.GetPaymentsProgramOnboardingResponse res = new openapisdk.models.operations.GetPaymentsProgramOnboardingResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.PaymentsProgramOnboardingResponse out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PaymentsProgramOnboardingResponse.class);
