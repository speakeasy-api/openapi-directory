...
export class GetDiseasePhenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetDiseasePhenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetDiseasePhenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetDiseasePhenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
