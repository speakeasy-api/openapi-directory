...
import dataclasses
from ..shared import connectivitytype_enum as shared_connectivitytype_enum
from enum import Enum
from typing import Optional

class CreateNatGatewayRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateNatGatewayRequestTagSpecifications:
    ...
    resource_type: Optional[CreateNatGatewayRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateNatGatewayRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateNatGatewayRequest:
    ...
    connectivity_type: Optional[shared_connectivitytype_enum.ConnectivityTypeEnum] = dataclasses.field(default=None)  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    private_ip_address: Optional[str] = dataclasses.field(default=None)  
    secondary_allocation_ids: Optional[list[str]] = dataclasses.field(default=None)  
    secondary_private_ip_address_count: Optional[int] = dataclasses.field(default=None)  
    secondary_private_ip_addresses: Optional[list[str]] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateNatGatewayRequestTagSpecifications]] = dataclasses.field(default=None)  
