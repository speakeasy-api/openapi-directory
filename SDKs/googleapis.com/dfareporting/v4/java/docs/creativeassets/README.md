...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            DfareportingCreativeAssetsInsertRequest req = new DfareportingCreativeAssetsInsertRequest("laborum", "magnam") {{
            ...
            DfareportingCreativeAssetsInsertResponse res = sdk.creativeAssets.dfareportingCreativeAssetsInsert(req, new DfareportingCreativeAssetsInsertSecurity("esse", "quasi") {{
