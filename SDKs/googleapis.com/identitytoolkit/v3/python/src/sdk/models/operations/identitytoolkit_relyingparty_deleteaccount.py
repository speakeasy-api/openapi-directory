...
class IdentitytoolkitRelyingpartyDeleteAccountRequest:
    ...
    identitytoolkit_relyingparty_delete_account_request: Optional[shared_identitytoolkitrelyingpartydeleteaccountrequest.IdentitytoolkitRelyingpartyDeleteAccountRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
