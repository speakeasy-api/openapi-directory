...
class ListUserPrivateMessages200ApplicationJSONTopicListTopics:
    ...
    participants: Optional[list[ListUserPrivateMessages200ApplicationJSONTopicListTopicsParticipants]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('participants'), 'exclude': lambda f: f is None }})  
    ...
    posters: Optional[list[ListUserPrivateMessages200ApplicationJSONTopicListTopicsPosters]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('posters'), 'exclude': lambda f: f is None }})  
...
class ListUserPrivateMessages200ApplicationJSONTopicList:
    ...
    topics: Optional[list[ListUserPrivateMessages200ApplicationJSONTopicListTopics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topics'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ListUserPrivateMessages200ApplicationJSONUsers:
...
class ListUserPrivateMessages200ApplicationJSON:
    ...
    topic_list: Optional[ListUserPrivateMessages200ApplicationJSONTopicList] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('topic_list'), 'exclude': lambda f: f is None }})  
    users: Optional[list[ListUserPrivateMessages200ApplicationJSONUsers]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('users'), 'exclude': lambda f: f is None }})  
...
class ListUserPrivateMessagesResponse:
    ...
    list_user_private_messages_200_application_json_object: Optional[ListUserPrivateMessages200ApplicationJSON] = dataclasses.field(default=None)
    r"""private messages"""  
