...
func (e ListAuthorizersStatusEnum) ToPointer() *ListAuthorizersStatusEnum {
	return &e
}
...
func (e *ListAuthorizersStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "ACTIVE":
		fallthrough
	case "INACTIVE":
		*e = ListAuthorizersStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListAuthorizersStatusEnum: %v", v)
	}
}
