...
class DcimConsolePortsListRequest:
    query_params: DcimConsolePortsListQueryParams = dataclasses.field()
...
class DcimConsolePortsListResponse:
    ...
    dcim_console_ports_list_200_application_json_object: Optional[DcimConsolePortsList200ApplicationJSON] = dataclasses.field(default=None)
