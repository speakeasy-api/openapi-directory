...
public class GetVariantPhenotypeAssociationsRequest {
    /**
    ...
    public GetVariantPhenotypeAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetVariantPhenotypeAssociationsRequest withEvidence(String evidence) {
    ...
    public GetVariantPhenotypeAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetVariantPhenotypeAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetVariantPhenotypeAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetVariantPhenotypeAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withRelation(String relation) {
    ...
    public GetVariantPhenotypeAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetVariantPhenotypeAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetVariantPhenotypeAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetVariantPhenotypeAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
