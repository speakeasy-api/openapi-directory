...
exports.GkeNodeConfig = void 0;
var utils_1 = require("../../../internal/utils");
var gkenodepoolacceleratorconfig_1 = require("./gkenodepoolacceleratorconfig");
// GkeNodeConfig
/**
...
var GkeNodeConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=accelerators", elemType: gkenodepoolacceleratorconfig_1.GkeNodePoolAcceleratorConfig }),
        __metadata("design:type", Array)
    ], GkeNodeConfig.prototype, "accelerators", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=bootDiskKmsKey" }),
        __metadata("design:type", String)
    ], GkeNodeConfig.prototype, "bootDiskKmsKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=localSsdCount" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=spot" }),
        __metadata("design:type", Boolean)
    ], GkeNodeConfig.prototype, "spot", void 0);
    return GkeNodeConfig;
}(utils_1.SpeakeasyBase));
exports.GkeNodeConfig = GkeNodeConfig;
