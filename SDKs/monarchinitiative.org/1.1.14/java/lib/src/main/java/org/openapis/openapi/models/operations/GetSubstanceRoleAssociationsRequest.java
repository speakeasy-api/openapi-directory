...
public class GetSubstanceRoleAssociationsRequest {
    ...
    public GetSubstanceRoleAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetSubstanceRoleAssociationsRequest withEvidence(String evidence) {
    ...
    public GetSubstanceRoleAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetSubstanceRoleAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetSubstanceRoleAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetSubstanceRoleAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetSubstanceRoleAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetSubstanceRoleAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetSubstanceRoleAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetSubstanceRoleAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetSubstanceRoleAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetSubstanceRoleAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetSubstanceRoleAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
