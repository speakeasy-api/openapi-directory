...
from .detailed_zip_code_information import DetailedZipCodeInformation
...
class SDK:
    ...
    detailed_zip_code_information: DetailedZipCodeInformation
    ...
    def _init_sdks(self):
        ...
        self.detailed_zip_code_information = DetailedZipCodeInformation(
            self._client,
