...
public class GETCancelSpotFleetRequestsRequest {
    ...
    public GETCancelSpotFleetRequestsRequest(@JsonProperty("Action") GETCancelSpotFleetRequestsActionEnum action, @JsonProperty("SpotFleetRequestId") String[] spotFleetRequestId, @JsonProperty("TerminateInstances") Boolean terminateInstances, @JsonProperty("Version") GETCancelSpotFleetRequestsVersionEnum version) {
        this.action = action;
        this.spotFleetRequestId = spotFleetRequestId;
        this.terminateInstances = terminateInstances;
        this.version = version;
