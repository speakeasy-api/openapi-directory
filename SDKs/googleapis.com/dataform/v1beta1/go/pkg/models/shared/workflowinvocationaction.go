...
func (e WorkflowInvocationActionStateEnum) ToPointer() *WorkflowInvocationActionStateEnum {
	return &e
}
...
func (e *WorkflowInvocationActionStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "CANCELLED":
		fallthrough
	case "FAILED":
		*e = WorkflowInvocationActionStateEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for WorkflowInvocationActionStateEnum: %v", v)
	}
}
