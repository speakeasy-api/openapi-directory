...
use \OpenAPI\OpenAPI\Models\Operations\DeleteGlobalRuleRuleEnum;
...
try {
    ...
    $request->rule = DeleteGlobalRuleRuleEnum::COMPATIBILITY;
...
use \OpenAPI\OpenAPI\Models\Operations\GetGlobalRuleConfigRuleEnum;
...
try {
    ...
    $request->rule = GetGlobalRuleConfigRuleEnum::COMPATIBILITY;
...
use \OpenAPI\OpenAPI\Models\Shared\Rule;
use \OpenAPI\OpenAPI\Models\Shared\RuleTypeEnum;
use \OpenAPI\OpenAPI\Models\Operations\UpdateGlobalRuleConfigRuleEnum;
...
try {
    ...
    $request->rule1->config = 'quo';
    $request->rule1->type = RuleTypeEnum::VALIDITY;
    $request->rulePathParameter = UpdateGlobalRuleConfigRuleEnum::VALIDITY;
