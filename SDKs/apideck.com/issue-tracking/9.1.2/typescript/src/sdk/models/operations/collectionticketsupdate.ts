...
export class CollectionTicketsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CollectionTicketsUpdateRequest extends SpeakeasyBase {
...
export class CollectionTicketsUpdateResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
