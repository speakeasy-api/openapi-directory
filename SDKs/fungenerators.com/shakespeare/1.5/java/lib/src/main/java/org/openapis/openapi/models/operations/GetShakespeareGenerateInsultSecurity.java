...
public class GetShakespeareGenerateInsultSecurity {
    ...
    public GetShakespeareGenerateInsultSecurity withXFungeneratorsApiSecret(String xFungeneratorsApiSecret) {
        this.xFungeneratorsApiSecret = xFungeneratorsApiSecret;
        return this;
    }
    
    public GetShakespeareGenerateInsultSecurity(@JsonProperty("X-Fungenerators-Api-Secret") String xFungeneratorsApiSecret) {
        this.xFungeneratorsApiSecret = xFungeneratorsApiSecret;
  }
}
