...
class ServicecontrolServicesReportRequest:
    ...
    r"""The service name as specified in its service configuration. For example, `\\"pubsub.googleapis.com\\"`. See [google.api.Service](https://cloud.google.com/service-management/reference/rpc/google.api#google.api.Service) for the definition of a service name."""  
    ...
    report_request: Optional[shared_reportrequest.ReportRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
