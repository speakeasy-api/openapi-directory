...
const (
	ListTagsForResourceXAmzTargetEnumOpenSearchServerlessListTagsForResource ListTagsForResourceXAmzTargetEnum = "OpenSearchServerless.ListTagsForResource"
)
...
func (e *ListTagsForResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "OpenSearchServerless.ListTagsForResource":
