...
func (s *orders) CancelOrder2(ctx context.Context, request operations.CancelOrder2Request) (*operations.CancelOrder2Response, error) {
	...
	res := &operations.CancelOrder2Response{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.CancelOrder2200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}

			res.CancelOrder2200ApplicationJSONObject = out
		}
...
func (s *orders) GetOrder2(ctx context.Context, request operations.GetOrder2Request) (*operations.GetOrder2Response, error) {
	...
	res := &operations.GetOrder2Response{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *operations.GetOrder2200ApplicationJSON
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}

			res.GetOrder2200ApplicationJSONObject = out
		}
	}
...
func (s *orders) ListOrders2(ctx context.Context, request operations.ListOrders2Request) (*operations.ListOrders2Response, error) {
	baseURL := s.serverURL
	...
	res := &operations.ListOrders2Response{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *orders) StartHandling2(ctx context.Context, request operations.StartHandling2Request) (*operations.StartHandling2Response, error) {
	...
	res := &operations.StartHandling2Response{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
