...
class GetDiseaseVariantAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetDiseaseVariantAssociationsQueryParams:
...
@dataclasses.dataclass
class GetDiseaseVariantAssociationsRequest:
    path_params: GetDiseaseVariantAssociationsPathParams = dataclasses.field()
    query_params: GetDiseaseVariantAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetDiseaseVariantAssociationsResponse:
