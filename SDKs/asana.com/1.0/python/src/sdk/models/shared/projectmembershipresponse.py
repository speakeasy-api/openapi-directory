...
class ProjectMembershipResponse:
    ...
    write_access: Optional[ProjectMembershipResponseWriteAccessEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('write_access'), 'exclude': lambda f: f is None }})
    r"""Whether the user has full access to the project or has comment-only access."""  
