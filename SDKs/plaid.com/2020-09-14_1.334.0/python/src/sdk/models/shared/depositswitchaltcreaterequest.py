...
class DepositSwitchAltCreateRequest:
    ...
    country_code: Optional[DepositSwitchAltCreateRequestCountryCodeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('country_code'), 'exclude': lambda f: f is None }})
    r"""ISO-3166-1 alpha-2 country code standard."""  
