...
class CreateBillingGroupRequestBody:
    billing_group_properties: Optional[CreateBillingGroupRequestBodyBillingGroupProperties] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('billingGroupProperties') }})
    tags: Optional[list[shared_tag.Tag]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    

@dataclasses.dataclass
class CreateBillingGroupRequest:
    headers: CreateBillingGroupHeaders = dataclasses.field()
    path_params: CreateBillingGroupPathParams = dataclasses.field()
    request: CreateBillingGroupRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
