...
type DescribeLineageGroupHeaders struct {
...
type DescribeLineageGroupRequest struct {
	Headers DescribeLineageGroupHeaders
	Request shared.DescribeLineageGroupRequest `request:"mediaType=application/json"`
}
