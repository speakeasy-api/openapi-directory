...
public class GetV2StepsJsonQueryParams {
    ...
    public GetV2StepsJsonQueryParams withHasDueActions(Boolean hasDueActions) {
    ...
    public Long[] ids;
    public GetV2StepsJsonQueryParams withIds(Long[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2StepsJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2StepsJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2StepsJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2StepsJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2StepsJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2StepsJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public String type;
    public GetV2StepsJsonQueryParams withType(String type) {
        this.type = type;
        return this;
    }
