...
from ..shared import listtypedlinkfacetattributesresponse as shared_listtypedlinkfacetattributesresponse
...
class ListTypedLinkFacetAttributesRequest:
    headers: ListTypedLinkFacetAttributesHeaders = dataclasses.field()
    query_params: ListTypedLinkFacetAttributesQueryParams = dataclasses.field()
    request: ListTypedLinkFacetAttributesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class ListTypedLinkFacetAttributesResponse:
    ...
    list_typed_link_facet_attributes_response: Optional[shared_listtypedlinkfacetattributesresponse.ListTypedLinkFacetAttributesResponse] = dataclasses.field(default=None)
