 ...
 */
export declare enum HTTPHealthCheckPortSpecificationEnum {
 ...
 */
export declare enum HTTPHealthCheckProxyHeaderEnum {
    None = "NONE",
    ProxyV1 = "PROXY_V1"
}
/**
 ...
 */
export declare enum HTTPHealthCheckWeightReportModeEnum {
    Disable = "DISABLE",
    DryRun = "DRY_RUN",
    Enable = "ENABLE"
}
export declare class HTTPHealthCheck extends SpeakeasyBase {
    /**
     ...
     * Weight report mode. used for weighted Load Balancing.
     */
    weightReportMode?: HTTPHealthCheckWeightReportModeEnum;
}
