...
exports.ListSyncDocumentResponse = exports.ListSyncDocumentListSyncDocumentResponse = exports.ListSyncDocumentListSyncDocumentResponseMeta = exports.ListSyncDocumentRequest = exports.ListSyncDocumentSecurity = exports.ListSyncDocumentServerList = void 0;
...
var ListSyncDocumentSecurity = /** @class */ (function (_super) {
    ...
    ], ListSyncDocumentSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSyncDocumentSecurity.prototype, "username", void 0);
...
var ListSyncDocumentRequest = /** @class */ (function (_super) {
    ...
    ], ListSyncDocumentRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSyncDocumentRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSyncDocumentRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListSyncDocumentRequest.prototype, "serviceSid", void 0);
...
var ListSyncDocumentListSyncDocumentResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewSyncServiceDocument }),
        (0, class_transformer_1.Expose)({ name: "documents" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewSyncServiceDocument; }),
        __metadata("design:type", Array)
    ], ListSyncDocumentListSyncDocumentResponse.prototype, "documents", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListSyncDocumentListSyncDocumentResponseMeta; }),
...
var ListSyncDocumentResponse = /** @class */ (function (_super) {
    ...
    ], ListSyncDocumentResponse.prototype, "rawResponse", void 0);
