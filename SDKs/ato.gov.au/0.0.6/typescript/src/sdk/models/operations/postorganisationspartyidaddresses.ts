...
export class PostOrganisationsPartyIdAddressesRequest extends SpeakeasyBase {
  /**
   * Address resource
   */
...
export class PostOrganisationsPartyIdAddressesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
