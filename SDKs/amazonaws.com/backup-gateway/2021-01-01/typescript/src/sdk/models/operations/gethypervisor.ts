...
export enum GetHypervisorXAmzTargetEnum {
  BackupOnPremisesV20210101GetHypervisor = "BackupOnPremises_v20210101.GetHypervisor",
}

export class GetHypervisorRequest extends SpeakeasyBase {
...
export class GetHypervisorResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
