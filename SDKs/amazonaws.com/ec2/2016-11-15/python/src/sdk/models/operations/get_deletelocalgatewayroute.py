...
class GETDeleteLocalGatewayRouteRequest:
    ...
    r"""The CIDR range for the route. This must match the CIDR for the route exactly."""  
    ...
    r"""Use a prefix list in place of <code>DestinationCidrBlock</code>. You cannot use <code>DestinationPrefixListId</code> and <code>DestinationCidrBlock</code> in the same request."""  
