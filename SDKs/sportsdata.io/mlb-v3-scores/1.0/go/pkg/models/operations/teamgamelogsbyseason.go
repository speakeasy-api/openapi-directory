...
func (e TeamGameLogsBySeasonFormatEnum) ToPointer() *TeamGameLogsBySeasonFormatEnum {
	return &e
}
...
func (e *TeamGameLogsBySeasonFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = TeamGameLogsBySeasonFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TeamGameLogsBySeasonFormatEnum: %v", v)
	}
}
