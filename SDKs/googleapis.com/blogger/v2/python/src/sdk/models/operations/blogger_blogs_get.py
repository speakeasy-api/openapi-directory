...
class BloggerBlogsGetRequest:
    path_params: BloggerBlogsGetPathParams = dataclasses.field()
    query_params: BloggerBlogsGetQueryParams = dataclasses.field()
    security: BloggerBlogsGetSecurity = dataclasses.field()
...
class BloggerBlogsGetResponse:
    ...
    blog: Optional[shared_blog.Blog] = dataclasses.field(default=None)
