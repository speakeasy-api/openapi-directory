...
from ..shared import listmerchantresponse as shared_listmerchantresponse
...
class GetCompaniesCompanyIDMerchantsSecurity:
...
@dataclasses.dataclass
class GetCompaniesCompanyIDMerchantsRequest:
...
@dataclasses.dataclass
class GetCompaniesCompanyIDMerchantsResponse:
    
    content_type: str = dataclasses.field()  
    status_code: int = dataclasses.field()  
    list_merchant_response: Optional[shared_listmerchantresponse.ListMerchantResponse] = dataclasses.field(default=None)
