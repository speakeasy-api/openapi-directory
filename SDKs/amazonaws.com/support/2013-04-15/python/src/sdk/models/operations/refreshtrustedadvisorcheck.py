...
class RefreshTrustedAdvisorCheckRequest:
    ...
    refresh_trusted_advisor_check_request: shared_refreshtrustedadvisorcheckrequest.RefreshTrustedAdvisorCheckRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
