...
class MeetingRegistrantsPathParams:
...
@dataclasses.dataclass
class MeetingRegistrantsQueryParams:
...
class MeetingRegistrantsRegistrationListRegistrantsCustomQuestions:
    r"""MeetingRegistrantsRegistrationListRegistrantsCustomQuestions
    Custom Question.
    """
...
class MeetingRegistrantsRegistrationListRegistrants:
    r"""MeetingRegistrantsRegistrationListRegistrants
    ...
    custom_questions: Optional[list[MeetingRegistrantsRegistrationListRegistrantsCustomQuestions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('custom_questions') }})
...
class MeetingRegistrantsRegistrationList:
    r"""MeetingRegistrantsRegistrationList
    Pagination Object.
    """
    ...
    registrants: Optional[list[MeetingRegistrantsRegistrationListRegistrants]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('registrants') }})
    total_records: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('total_records') }})
    

@dataclasses.dataclass
class MeetingRegistrantsRequest:
    path_params: MeetingRegistrantsPathParams = dataclasses.field()
    query_params: MeetingRegistrantsQueryParams = dataclasses.field()
    security: MeetingRegistrantsSecurity = dataclasses.field()
