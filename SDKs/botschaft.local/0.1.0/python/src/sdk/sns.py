...
class Sns:
    ...
    def sns_get_sns_get(self, request: operations.SnsGetSnsGetRequest) -> operations.SnsGetSnsGetResponse:
        ...
        query_params = utils.get_query_params(operations.SnsGetSnsGetRequest, request)
        ...
        res = operations.SnsGetSnsGetResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def sns_post_sns_post(self, request: operations.SnsPostSnsPostRequest) -> operations.SnsPostSnsPostResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "sns_message_request", 'json')
        ...
        res = operations.SnsPostSnsPostResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
