...
exports.PostPermissionAppsAppIdResponse = exports.PostPermissionAppsAppIdRequest = void 0;
...
var PostPermissionAppsAppIdRequest = /** @class */ (function (_super) {
    ...
    ], PostPermissionAppsAppIdRequest.prototype, "appId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=date" }),
        __metadata("design:type", Number)
    ], PostPermissionAppsAppIdRequest.prototype, "date", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=ip" }),
        __metadata("design:type", String)
    ], PostPermissionAppsAppIdRequest.prototype, "ip", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userId",
        }),
        __metadata("design:type", String)
    ], PostPermissionAppsAppIdRequest.prototype, "userId", void 0);
...
var PostPermissionAppsAppIdResponse = /** @class */ (function (_super) {
    ...
    ], PostPermissionAppsAppIdResponse.prototype, "rawResponse", void 0);
