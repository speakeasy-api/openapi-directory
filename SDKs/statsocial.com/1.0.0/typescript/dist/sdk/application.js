...
var Application = /** @class */ (function () {
     ...
     *
     */
    Application.prototype.getApplicationsStatus = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetApplicationsStatusRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/applications/status/";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetApplicationsStatusResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.applicationStatus = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ApplicationStatus);
                    }
                    break;
