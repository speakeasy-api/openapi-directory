...
public class FDXNotification {
    ...
    public FDXNotification(@JsonProperty("category") FDXNotificationCategoryEnum category, @JsonProperty("notificationId") String notificationId, @JsonProperty("notificationPayload") FDXNotificationPayload notificationPayload, @JsonProperty("publisher") FDXParty publisher, @JsonProperty("sentOn") OffsetDateTime sentOn, @JsonProperty("type") FDXNotificationTypeEnum type) {
        this.category = category;
        this.notificationId = notificationId;
        this.notificationPayload = notificationPayload;
        this.publisher = publisher;
