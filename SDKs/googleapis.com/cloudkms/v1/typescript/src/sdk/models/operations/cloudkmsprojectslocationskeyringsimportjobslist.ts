...
export class CloudkmsProjectsLocationsKeyRingsImportJobsListSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudkmsProjectsLocationsKeyRingsImportJobsListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class CloudkmsProjectsLocationsKeyRingsImportJobsListSecurity extends SpeakeasyBase {
...
export class CloudkmsProjectsLocationsKeyRingsImportJobsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudkmsProjectsLocationsKeyRingsImportJobsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
