 ...
 */
export declare enum CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateTransitGatewayRouteTableAnnouncementRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateTransitGatewayRouteTableAnnouncementRequestTagSpecifications extends SpeakeasyBase {
...
export declare class CreateTransitGatewayRouteTableAnnouncementRequest extends SpeakeasyBase {
    dryRun?: boolean;
