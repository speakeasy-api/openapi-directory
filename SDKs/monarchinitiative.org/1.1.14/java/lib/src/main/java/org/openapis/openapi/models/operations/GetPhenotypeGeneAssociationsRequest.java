...
public class GetPhenotypeGeneAssociationsRequest {
    ...
    public GetPhenotypeGeneAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPhenotypeGeneAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPhenotypeGeneAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPhenotypeGeneAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPhenotypeGeneAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPhenotypeGeneAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withRelation(String relation) {
    ...
    public GetPhenotypeGeneAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPhenotypeGeneAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPhenotypeGeneAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPhenotypeGeneAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
