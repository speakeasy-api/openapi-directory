...
public class ComputeSubnetworksPatchRequest {
    ...
    public ComputeSubnetworksPatchRequest(@JsonProperty("project") String project, @JsonProperty("region") String region, @JsonProperty("subnetworkPathParameter") String subnetworkPathParameter) {
        this.project = project;
        this.region = region;
        this.subnetworkPathParameter = subnetworkPathParameter;
  }
