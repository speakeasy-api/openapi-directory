...
public class CommunicationProfiles {
    ...
    public org.openapis.openapi.models.operations.ObjectGETCommunicationProfileResponse objectGETCommunicationProfile(org.openapis.openapi.models.operations.ObjectGETCommunicationProfileRequest request) throws Exception {
        ...
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ObjectGETCommunicationProfileRequest.class, baseUrl, "/v1/object/communication-profile/{id}", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ObjectGETCommunicationProfileRequest.class, request, null);
        if (queryParams != null) {
