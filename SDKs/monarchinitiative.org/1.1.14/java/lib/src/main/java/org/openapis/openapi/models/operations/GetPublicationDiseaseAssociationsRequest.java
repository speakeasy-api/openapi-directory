...
public class GetPublicationDiseaseAssociationsRequest {
    ...
    public GetPublicationDiseaseAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withDirectTaxon(Boolean directTaxon) {
    ...
    public GetPublicationDiseaseAssociationsRequest withEvidence(String evidence) {
    ...
    public GetPublicationDiseaseAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetPublicationDiseaseAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetPublicationDiseaseAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetPublicationDiseaseAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withRelation(String relation) {
    ...
    public GetPublicationDiseaseAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetPublicationDiseaseAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetPublicationDiseaseAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetPublicationDiseaseAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
