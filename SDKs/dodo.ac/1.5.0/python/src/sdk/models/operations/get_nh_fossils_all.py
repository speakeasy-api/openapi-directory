...
from ..shared import nhfossilgroupwithindividualfossilsnomatched as shared_nhfossilgroupwithindividualfossilsnomatched
...
class GetNhFossilsAllResponse:
    ...
    nh_fossil_group_with_individual_fossils_no_matcheds: Optional[list[shared_nhfossilgroupwithindividualfossilsnomatched.NHFossilGroupWithIndividualFossilsNoMatched]] = dataclasses.field(default=None)
