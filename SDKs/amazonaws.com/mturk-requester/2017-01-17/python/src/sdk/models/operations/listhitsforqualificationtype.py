...
class ListHITsForQualificationTypeRequest:
    ...
    list_hi_ts_for_qualification_type_request: shared_listhitsforqualificationtyperequest.ListHITsForQualificationTypeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
