...
from ..shared import security as shared_security
from ..shared import googlefirebaseappcheckv1batchgetrecaptchaenterpriseconfigsresponse as shared_googlefirebaseappcheckv1batchgetrecaptchaenterpriseconfigsresponse
...
class FirebaseappcheckProjectsAppsRecaptchaEnterpriseConfigBatchGetResponse:
    ...
    google_firebase_appcheck_v1_batch_get_recaptcha_enterprise_configs_response: Optional[shared_googlefirebaseappcheckv1batchgetrecaptchaenterpriseconfigsresponse.GoogleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse] = dataclasses.field(default=None)
