...
type DescribeLocationFsxLustreHeaders struct {
...
type DescribeLocationFsxLustreRequest struct {
	Headers DescribeLocationFsxLustreHeaders
	Request shared.DescribeLocationFsxLustreRequest `request:"mediaType=application/json"`
}
