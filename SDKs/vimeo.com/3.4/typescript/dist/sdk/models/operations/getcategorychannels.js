...
exports.GetCategoryChannelsResponse = exports.GetCategoryChannelsRequest = exports.GetCategoryChannelsSortEnum = exports.GetCategoryChannelsDirectionEnum = void 0;
...
var GetCategoryChannelsRequest = /** @class */ (function (_super) {
    ...
    ], GetCategoryChannelsRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=direction",
        }),
        __metadata("design:type", String)
    ], GetCategoryChannelsRequest.prototype, "direction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetCategoryChannelsRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetCategoryChannelsRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], GetCategoryChannelsRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetCategoryChannelsRequest.prototype, "sort", void 0);
...
var GetCategoryChannelsResponse = /** @class */ (function (_super) {
    ...
    ], GetCategoryChannelsResponse.prototype, "rawResponse", void 0);
    __decorate([
