...
class GetSQLModeRequest:
    path_params: GetSQLModePathParams = dataclasses.field()
...
class GetSQLModeResponse:
    ...
    get_sql_mode_200_application_json_object: Optional[GetSQLMode200ApplicationJSON] = dataclasses.field(default=None)
    get_sql_mode_401_application_json_object: Optional[GetSQLMode401ApplicationJSON] = dataclasses.field(default=None)
