...
class TagResourceRequestBody:
    ...
    r"""A map that contains tag keys and tag values that are attached to the resource."""  
...
class TagResourceRequest:
    ...
    r"""The Amazon Resource Name (ARN) of the AWS RoboMaker resource you are tagging."""  
