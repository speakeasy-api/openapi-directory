 ...
 * V1PaymentItemDetail
 */
var V1PaymentItemDetail = /** @class */ (function (_super) {
    __extends(V1PaymentItemDetail, _super);
    ...
    ], V1PaymentItemDetail.prototype, "categoryName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "item_id" }),
        __metadata("design:type", String)
    ], V1PaymentItemDetail.prototype, "itemId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "item_variation_id" }),
        __metadata("design:type", String)
    ], V1PaymentItemDetail.prototype, "itemVariationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
