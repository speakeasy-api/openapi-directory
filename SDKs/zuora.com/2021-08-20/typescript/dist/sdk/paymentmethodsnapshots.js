...
exports.PaymentMethodSnapshots = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var PaymentMethodSnapshots = /** @class */ (function () {
    function PaymentMethodSnapshots(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    PaymentMethodSnapshots.prototype.objectGetPaymentMethodSnapshot = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ObjectGetPaymentMethodSnapshotRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/object/payment-method-snapshot/{id}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.proxyGetPaymentMethodSnapshot = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
...
exports.PaymentMethodSnapshots = PaymentMethodSnapshots;
