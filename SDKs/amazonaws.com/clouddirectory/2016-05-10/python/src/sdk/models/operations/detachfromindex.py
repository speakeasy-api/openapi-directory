...
class DetachFromIndexRequestBody:
    ...
    index_reference: DetachFromIndexRequestBodyIndexReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('IndexReference') }})
    r"""The reference that identifies an object."""  
    target_reference: DetachFromIndexRequestBodyTargetReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('TargetReference') }})
    r"""The reference that identifies an object."""  
...
class DetachFromIndexRequest:
    ...
    request_body: DetachFromIndexRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
    x_amz_data_partition: str = dataclasses.field(metadata={'header': { 'field_name': 'x-amz-data-partition', 'style': 'simple', 'explode': False }})
    r"""The Amazon Resource Name (ARN) of the directory the index and object exist in."""  
