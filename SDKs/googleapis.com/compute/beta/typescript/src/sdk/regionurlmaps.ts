...
export class RegionUrlMaps {
  ...
  computeRegionUrlMapsInvalidateCache(
    req: operations.ComputeRegionUrlMapsInvalidateCacheRequest,
    security: operations.ComputeRegionUrlMapsInvalidateCacheSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeRegionUrlMapsInvalidateCacheResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeRegionUrlMapsInvalidateCacheSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeRegionUrlMapsInvalidateCacheResponse =
        new operations.ComputeRegionUrlMapsInvalidateCacheResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  computeRegionUrlMapsTestIamPermissions(
    req: operations.ComputeRegionUrlMapsTestIamPermissionsRequest,
    security: operations.ComputeRegionUrlMapsTestIamPermissionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.ComputeRegionUrlMapsTestIamPermissionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/projects/{project}/regions/{region}/urlMaps/{resource}/testIamPermissions",
      req
    );
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.ComputeRegionUrlMapsTestIamPermissionsSecurity(
        security
      );
    }
    const client: AxiosInstance = utils.createSecurityClient(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ComputeRegionUrlMapsTestIamPermissionsResponse =
        new operations.ComputeRegionUrlMapsTestIamPermissionsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
