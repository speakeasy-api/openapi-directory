 ...
 */
public enum DeclinedTransactionDeclinedTransactionSourceCardDeclineReasonEnum {
    ...
    private DeclinedTransactionDeclinedTransactionSourceCardDeclineReasonEnum(String value) {
        this.value = value;
    }
}
