...
exports.GetHolidaySchemeFromEmployerResponse = exports.GetHolidaySchemeFromEmployerRequest = void 0;
...
var GetHolidaySchemeFromEmployerRequest = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeFromEmployerRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeFromEmployerRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeFromEmployerRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=HolidaySchemeId",
        }),
        __metadata("design:type", String)
    ], GetHolidaySchemeFromEmployerRequest.prototype, "holidaySchemeId", void 0);
    return GetHolidaySchemeFromEmployerRequest;
}(utils_1.SpeakeasyBase));
exports.GetHolidaySchemeFromEmployerRequest = GetHolidaySchemeFromEmployerRequest;
var GetHolidaySchemeFromEmployerResponse = /** @class */ (function (_super) {
    ...
    ], GetHolidaySchemeFromEmployerResponse.prototype, "rawResponse", void 0);
    return GetHolidaySchemeFromEmployerResponse;
}(utils_1.SpeakeasyBase));
exports.GetHolidaySchemeFromEmployerResponse = GetHolidaySchemeFromEmployerResponse;
