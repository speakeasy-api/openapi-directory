...
func (s *versions) Getversion(ctx context.Context, request operations.GetversionRequest) (*operations.GetversionResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/api/dataentities/{acronym}/documents/{id}/versions/{versionId}", request.PathParams, nil)
...
func (s *versions) Listversions(ctx context.Context, request operations.ListversionsRequest) (*operations.ListversionsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/api/dataentities/{acronym}/documents/{id}/versions", request.PathParams, nil)
