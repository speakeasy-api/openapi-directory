...
var PricingV2VoiceVoiceNumber = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=destination_number" }),
        __metadata("design:type", String)
    ], PricingV2VoiceVoiceNumber.prototype, "destinationNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=inbound_call_price" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=origination_number" }),
        __metadata("design:type", String)
    ], PricingV2VoiceVoiceNumber.prototype, "originationNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outbound_call_prices", elemType: PricingV2VoiceVoiceNumberOutboundCallPrices }),
        __metadata("design:type", Array)
