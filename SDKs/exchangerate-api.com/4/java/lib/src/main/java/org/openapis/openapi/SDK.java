...
public class SDK {
    ...
    public org.openapis.openapi.models.operations.GetLatestBaseCurrencyResponse getLatestBaseCurrency(org.openapis.openapi.models.operations.GetLatestBaseCurrencyRequest request) throws Exception {
        ...
        org.openapis.openapi.models.operations.GetLatestBaseCurrencyResponse res = new org.openapis.openapi.models.operations.GetLatestBaseCurrencyResponse(contentType, httpRes.statusCode()) {{
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.GetLatestBaseCurrency200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetLatestBaseCurrency200ApplicationJSON.class);
            ...
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.operations.GetLatestBaseCurrency404ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.GetLatestBaseCurrency404ApplicationJSON.class);
