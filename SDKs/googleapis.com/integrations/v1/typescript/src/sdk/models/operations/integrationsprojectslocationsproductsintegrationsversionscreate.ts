...
export class IntegrationsProjectsLocationsProductsIntegrationsVersionsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IntegrationsProjectsLocationsProductsIntegrationsVersionsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
  ...
  googleCloudIntegrationsV1alphaIntegrationVersionInput?: shared.GoogleCloudIntegrationsV1alphaIntegrationVersionInput;
...
export class IntegrationsProjectsLocationsProductsIntegrationsVersionsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
