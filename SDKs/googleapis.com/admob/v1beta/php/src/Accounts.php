...
class Accounts 
{
     ...
     * List the ad sources.
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdSourcesListRequest $request
     * @return \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdSourcesListResponse
     */
	public function admobAccountsAdSourcesList(
        \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdSourcesListRequest $request,
    ): \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdSourcesListResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/adSources', \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdSourcesListRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdSourcesListRequest::class, $request, null));
        
        $httpResponse = $this->_defaultClient->request('GET', $url, $options);
        
        $contentType = $httpResponse->getHeader('Content-Type')[0] ?? '';

        $response = new \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdSourcesListResponse();
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->listAdSourcesResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\ListAdSourcesResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/adUnits', \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAdUnitsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/apps', \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsAppsListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{name}', \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/mediationReport:generate', \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsMediationReportGenerateRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta/{parent}/networkReport:generate', \OpenAPI\OpenAPI\Models\Operations\AdmobAccountsNetworkReportGenerateRequest::class, $request);
