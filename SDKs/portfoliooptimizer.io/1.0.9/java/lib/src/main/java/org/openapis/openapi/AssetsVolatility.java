    ...
    public org.openapis.openapi.models.operations.PostAssetsVolatilityResponse postAssetsVolatility(Object request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.PostAssetsVolatility200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.PostAssetsVolatility200ApplicationJSON.class);
