...
exports.GetGenreResponse = exports.GetGenreRequest = exports.GetGenreQueryParams = exports.GetGenreIncludeLicensedContentEnum = exports.GetGenrePathParams = void 0;
...
var GetGenrePathParams = /** @class */ (function (_super) {
    ...
    ], GetGenrePathParams.prototype, "id", void 0);
    return GetGenrePathParams;
}(utils_1.SpeakeasyBase));
exports.GetGenrePathParams = GetGenrePathParams;
var GetGenreIncludeLicensedContentEnum;
(function (GetGenreIncludeLicensedContentEnum) {
    GetGenreIncludeLicensedContentEnum["Yes"] = "yes";
    GetGenreIncludeLicensedContentEnum["No"] = " no";
})(GetGenreIncludeLicensedContentEnum = exports.GetGenreIncludeLicensedContentEnum || (exports.GetGenreIncludeLicensedContentEnum = {}));
var GetGenreQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetGenreQueryParams.prototype, "includeLicensedContent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=locale" }),
        __metadata("design:type", String)
    ], GetGenreQueryParams.prototype, "locale", void 0);
    return GetGenreQueryParams;
}(utils_1.SpeakeasyBase));
exports.GetGenreQueryParams = GetGenreQueryParams;
...
exports.GetGenreRequest = GetGenreRequest;
var GetGenreResponse = /** @class */ (function (_super) {
    ...
    ], GetGenreResponse.prototype, "body", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
...
exports.GetGenreResponse = GetGenreResponse;
