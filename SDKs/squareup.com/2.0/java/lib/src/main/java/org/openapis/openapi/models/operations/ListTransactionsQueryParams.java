...
public class ListTransactionsQueryParams {
    ...
    public ListTransactionsQueryParams withBeginTime(String beginTime) {
    ...
    public ListTransactionsQueryParams withEndTime(String endTime) {
    ...
    public ListTransactionsQueryParams withSortOrder(String sortOrder) {
