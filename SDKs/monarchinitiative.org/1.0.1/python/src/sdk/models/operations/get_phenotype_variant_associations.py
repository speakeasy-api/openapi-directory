...
class GetPhenotypeVariantAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPhenotypeVariantAssociationsQueryParams:
...
@dataclasses.dataclass
class GetPhenotypeVariantAssociationsRequest:
    path_params: GetPhenotypeVariantAssociationsPathParams = dataclasses.field()
    query_params: GetPhenotypeVariantAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetPhenotypeVariantAssociationsResponse:
