...
var ApiResponseSimilarityResponseSimilarityList = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=artist_name" }),
        __metadata("design:type", String)
    ], ApiResponseSimilarityResponseSimilarityList.prototype, "artistName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=artist_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=index_id" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=song_name" }),
        __metadata("design:type", String)
    ], ApiResponseSimilarityResponseSimilarityList.prototype, "songName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=song_url" }),
        __metadata("design:type", String)
...
var ApiResponseSimilarityResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=similarity_list", elemType: ApiResponseSimilarityResponseSimilarityList }),
