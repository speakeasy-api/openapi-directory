 ...
 */
export class UpdateZoomRoomAccSettingsApplicationJson2ClientAlert extends SpeakeasyBase {
  /**
...
export class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignageBanner extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignageDisplayPeriod extends SpeakeasyBase {
  /**
 ...
 *
 */
export enum UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayListActionEnum {
  Add = "add",
  Update = "update",
  Delete = "delete",
}
 ...
 * Content list.
 */
export class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayListContents extends SpeakeasyBase {
  /**
...
export class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayList extends SpeakeasyBase {
  /**
   * Specify an action for the content list. The value can be one of the following:<br>
   *
   * @remarks
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "action" })
  action?: UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayListActionEnum;

  @SpeakeasyMetadata({
    elemType:
      UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayListContents,
  })
  ...
  contents?: UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayListContents[];
...
export class UpdateZoomRoomAccSettingsApplicationJson2DigitalSignage extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "banner" })
  @Type(() => UpdateZoomRoomAccSettingsApplicationJson2DigitalSignageBanner)
  banner?: UpdateZoomRoomAccSettingsApplicationJson2DigitalSignageBanner;
  ...
  displayPeriod?: UpdateZoomRoomAccSettingsApplicationJson2DigitalSignageDisplayPeriod;
  ...
  @Type(() => UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayList)
  playList?: UpdateZoomRoomAccSettingsApplicationJson2DigitalSignagePlayList[];
}
 ...
 */
export class UpdateZoomRoomAccSettingsApplicationJson2Notification extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "network_stable_detected" })
  networkStableDetected?: boolean;
...
export class UpdateZoomRoomAccSettingsApplicationJson2 extends SpeakeasyBase {
  /**
   * The Client Alert Settings section includes alerts that display on the TV screen of the Zoom Room. Disable these settings if you have deliberately disconnected one or more peripheral devices or have never enabled them.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "client_alert" })
  @Type(() => UpdateZoomRoomAccSettingsApplicationJson2ClientAlert)
  clientAlert?: UpdateZoomRoomAccSettingsApplicationJson2ClientAlert;

  @SpeakeasyMetadata()
  @Expose({ name: "digital_signage" })
  @Type(() => UpdateZoomRoomAccSettingsApplicationJson2DigitalSignage)
  digitalSignage?: UpdateZoomRoomAccSettingsApplicationJson2DigitalSignage;
  ...
  @Type(() => UpdateZoomRoomAccSettingsApplicationJson2Notification)
  notification?: UpdateZoomRoomAccSettingsApplicationJson2Notification;
}

export class UpdateZoomRoomAccSettingsApplicationJson1ZoomRooms extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "email_address_prompt_before_recording" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "make_room_alternative_host" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "secure_connection_channel" })
...
export class UpdateZoomRoomAccSettingsApplicationJson1 extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "zoom_rooms" })
  @Type(() => UpdateZoomRoomAccSettingsApplicationJson1ZoomRooms)
  zoomRooms?: UpdateZoomRoomAccSettingsApplicationJson1ZoomRooms;
}
