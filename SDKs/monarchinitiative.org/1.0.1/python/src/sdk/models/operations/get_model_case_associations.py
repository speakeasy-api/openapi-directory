...
class GetModelCaseAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetModelCaseAssociationsQueryParams:
...
@dataclasses.dataclass
class GetModelCaseAssociationsRequest:
    path_params: GetModelCaseAssociationsPathParams = dataclasses.field()
    query_params: GetModelCaseAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetModelCaseAssociationsResponse:
