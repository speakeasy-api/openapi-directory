...
class DescribeElasticGpusRequest:
    ...
    elastic_gpu_ids: Optional[list[str]] = dataclasses.field(default=None)  
    filters: Optional[list[DescribeElasticGpusRequestFilters]] = dataclasses.field(default=None)  
