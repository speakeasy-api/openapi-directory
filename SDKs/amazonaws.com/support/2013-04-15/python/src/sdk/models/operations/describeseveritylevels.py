...
class DescribeSeverityLevelsRequest:
    ...
    describe_severity_levels_request: shared_describeseveritylevelsrequest.DescribeSeverityLevelsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
