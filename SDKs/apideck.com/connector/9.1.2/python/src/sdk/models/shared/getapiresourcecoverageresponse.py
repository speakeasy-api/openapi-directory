...
import dataclasses
from ..shared import apiresourcecoverage as shared_apiresourcecoverage
...
class GetAPIResourceCoverageResponse:
    ...
    data: shared_apiresourcecoverage.APIResourceCoverage = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
