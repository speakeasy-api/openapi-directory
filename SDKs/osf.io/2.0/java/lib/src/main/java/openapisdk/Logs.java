...
public class Logs {
    ...
    **/
    public openapisdk.models.operations.LogsActionsResponse logsActions() throws Exception {
        ...
        openapisdk.models.operations.LogsActionsResponse res = new openapisdk.models.operations.LogsActionsResponse() {{
        }};
    ...
    **/
    public openapisdk.models.operations.LogsReadResponse logsRead(openapisdk.models.operations.LogsReadRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/logs/{log_id}/", request.pathParams);
        ...
        openapisdk.models.operations.LogsReadResponse res = new openapisdk.models.operations.LogsReadResponse() {{
            body = null;
        }};
        res.statusCode = Long.valueOf(httpRes.statusCode());
        res.contentType = contentType;
