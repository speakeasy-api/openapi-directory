...
type ListDistributions20171030QueryParams struct {
...
type ListDistributions20171030Headers struct {
...
type ListDistributions20171030Request struct {
	QueryParams ListDistributions20171030QueryParams
	Headers     ListDistributions20171030Headers
}

type ListDistributions20171030Response struct {
	Body        []byte
	ContentType string
	StatusCode  int
