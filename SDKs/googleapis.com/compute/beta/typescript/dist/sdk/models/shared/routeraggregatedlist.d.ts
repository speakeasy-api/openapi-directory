 ...
 */
export declare enum RouterAggregatedListWarningCodeEnum {
...
export declare class RouterAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class RouterAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
 ...
 */
export declare class RouterAggregatedList extends SpeakeasyBase {
    /**
