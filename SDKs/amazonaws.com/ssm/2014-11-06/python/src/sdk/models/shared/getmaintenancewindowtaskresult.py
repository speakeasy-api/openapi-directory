...
class GetMaintenanceWindowTaskResult:
    ...
    window_task_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WindowTaskId'), 'exclude': lambda f: f is None }})  
