...
public class ServicenetworkingServicesDnsRecordSetsRemovePathParams {
    /**
    ...
    public ServicenetworkingServicesDnsRecordSetsRemovePathParams withParent(String parent) {
        this.parent = parent;
        return this;
    }
