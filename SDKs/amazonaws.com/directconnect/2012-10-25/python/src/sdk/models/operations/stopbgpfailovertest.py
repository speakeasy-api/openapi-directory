...
class StopBgpFailoverTestRequest:
    ...
    stop_bgp_failover_test_request: shared_stopbgpfailovertestrequest.StopBgpFailoverTestRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
