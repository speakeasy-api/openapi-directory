...
class AppengineAppsServicesVersionsGetRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\AppengineAppsServicesVersionsGetViewEnum $view
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=view')]
    public ?AppengineAppsServicesVersionsGetViewEnum $view = null;
