...
from ..shared import poolevaluateautoscaleparameter as shared_poolevaluateautoscaleparameter
...
class PoolEvaluateAutoScaleRequest:
    ...
    pool_evaluate_auto_scale_parameter: shared_poolevaluateautoscaleparameter.PoolEvaluateAutoScaleParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    ...
    r"""The id of the pool on which to evaluate the automatic scaling formula."""  
...
class PoolEvaluateAutoScaleResponse:
    ...
    auto_scale_run: Optional[shared_autoscalerun.AutoScaleRun] = dataclasses.field(default=None)  
