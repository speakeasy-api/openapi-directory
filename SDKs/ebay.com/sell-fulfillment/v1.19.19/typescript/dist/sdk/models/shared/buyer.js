...
var Buyer = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "taxAddress" }),
        (0, class_transformer_1.Type)(function () { return taxaddress_1.TaxAddress; }),
        __metadata("design:type", taxaddress_1.TaxAddress)
    ], Buyer.prototype, "taxAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "taxIdentifier" }),
