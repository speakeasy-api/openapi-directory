...
export class Documents {
  ...
  languageDocumentsAnalyzeEntities(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1/documents:analyzeEntities";
  ...
  languageDocumentsAnalyzeSentiment(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1/documents:analyzeSentiment";
  ...
  languageDocumentsAnalyzeSyntax(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1/documents:analyzeSyntax";
  ...
  languageDocumentsAnnotateText(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/v1beta1/documents:annotateText";
