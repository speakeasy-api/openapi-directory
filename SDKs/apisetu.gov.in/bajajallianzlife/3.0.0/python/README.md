...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/bajajallianzlife/3.0.0/python
```
...
req = operations.LicerRequestBody(
    certificate_parameters=operations.LicerRequestBodyCertificateParameters(
        ...
        policy_number="10 Digit Policy Number eg 0355555111",
    ),
...
res = s.ap_is.licer(req, operations.LicerSecurity(
