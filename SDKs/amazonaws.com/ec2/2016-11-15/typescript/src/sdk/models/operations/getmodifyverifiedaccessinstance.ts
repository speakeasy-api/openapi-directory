...
export enum GETModifyVerifiedAccessInstanceActionEnum {
  ModifyVerifiedAccessInstance = "ModifyVerifiedAccessInstance",
}

export enum GETModifyVerifiedAccessInstanceVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETModifyVerifiedAccessInstanceRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETModifyVerifiedAccessInstanceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
