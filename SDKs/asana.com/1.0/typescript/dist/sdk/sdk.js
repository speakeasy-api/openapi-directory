...
var auditlogapi_1 = require("./auditlogapi");
...
var goalrelationships_1 = require("./goalrelationships");
...
var projectbriefs_1 = require("./projectbriefs");
var projectmemberships_1 = require("./projectmemberships");
var projects_1 = require("./projects");
var projectstatuses_1 = require("./projectstatuses");
var projecttemplates_1 = require("./projecttemplates");
var sections_1 = require("./sections");
var statusupdates_1 = require("./statusupdates");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.auditLogAPI = new auditlogapi_1.AuditLogAPI(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.goalRelationships = new goalrelationships_1.GoalRelationships(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.projectBriefs = new projectbriefs_1.ProjectBriefs(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.projectTemplates = new projecttemplates_1.ProjectTemplates(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.statusUpdates = new statusupdates_1.StatusUpdates(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
