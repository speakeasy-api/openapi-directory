...
class DisplayvideoAdvertisersManualTriggersPatchRequest:
    path_params: DisplayvideoAdvertisersManualTriggersPatchPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersManualTriggersPatchQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersManualTriggersPatchSecurity = dataclasses.field()
