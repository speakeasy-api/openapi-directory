...
public class RetailProjectsLocationsCatalogsBranchesProductsAddFulfillmentPlacesPathParams {
    /**
    ...
    public RetailProjectsLocationsCatalogsBranchesProductsAddFulfillmentPlacesPathParams withProduct(String product) {
