...
from ..shared import accountembeddedobject as shared_accountembeddedobject
...
class AccountHalResponse:
    embedded: Optional[shared_accountembeddedobject.AccountEmbeddedObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_embedded') }})
