...
func (s *userProfiles) ClassroomUserProfilesGet(ctx context.Context, request operations.ClassroomUserProfilesGetRequest) (*operations.ClassroomUserProfilesGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/userProfiles/{userId}", request.PathParams, nil)
...
func (s *userProfiles) ClassroomUserProfilesGuardianInvitationsCreate(ctx context.Context, request operations.ClassroomUserProfilesGuardianInvitationsCreateRequest) (*operations.ClassroomUserProfilesGuardianInvitationsCreateResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/userProfiles/{studentId}/guardianInvitations", request.PathParams, nil)
...
func (s *userProfiles) ClassroomUserProfilesGuardianInvitationsGet(ctx context.Context, request operations.ClassroomUserProfilesGuardianInvitationsGetRequest) (*operations.ClassroomUserProfilesGuardianInvitationsGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/userProfiles/{studentId}/guardianInvitations/{invitationId}", request.PathParams, nil)
...
func (s *userProfiles) ClassroomUserProfilesGuardiansDelete(ctx context.Context, request operations.ClassroomUserProfilesGuardiansDeleteRequest) (*operations.ClassroomUserProfilesGuardiansDeleteResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/userProfiles/{studentId}/guardians/{guardianId}", request.PathParams, nil)
...
func (s *userProfiles) ClassroomUserProfilesGuardiansList(ctx context.Context, request operations.ClassroomUserProfilesGuardiansListRequest) (*operations.ClassroomUserProfilesGuardiansListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/userProfiles/{studentId}/guardians", request.PathParams, nil)
