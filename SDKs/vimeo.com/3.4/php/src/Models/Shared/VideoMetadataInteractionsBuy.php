...
class VideoMetadataInteractionsBuy
{
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\VideoMetadataInteractionsBuyDownloadEnum $download
     */
	#[\JMS\Serializer\Annotation\SerializedName('download')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoMetadataInteractionsBuyDownloadEnum>')]
     ...
     * 
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\VideoMetadataInteractionsBuyStreamEnum $stream
     */
	#[\JMS\Serializer\Annotation\SerializedName('stream')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\VideoMetadataInteractionsBuyStreamEnum>')]
	...
	public function __construct()
	{
		$this->currency = "";
		$this->displayPrice = "";
		$this->download = \OpenAPI\OpenAPI\Models\Shared\VideoMetadataInteractionsBuyDownloadEnum::AVAILABLE;
		$this->drm = false;
		$this->link = "";
		$this->price = 0;
		$this->purchaseTime = "";
		$this->stream = \OpenAPI\OpenAPI\Models\Shared\VideoMetadataInteractionsBuyStreamEnum::AVAILABLE;
		$this->uri = "";
	}
}
