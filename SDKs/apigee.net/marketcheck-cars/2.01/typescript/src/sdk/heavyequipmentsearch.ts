...
export class HeavyEquipmentSearch {
  ...
  getListingHeavyEquipmentId(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetListingHeavyEquipmentIdResponse =
        new operations.GetListingHeavyEquipmentIdResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.heavyEquipmentsListing = utils.objectToClass(
              httpRes?.data,
              shared.HeavyEquipmentsListing
            );
          }
          break;
        default:
  ...
  getListingHeavyEquipmentIdExtra(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetListingHeavyEquipmentIdExtraResponse =
        new operations.GetListingHeavyEquipmentIdExtraResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getListingHeavyEquipmentIdMedia(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetListingHeavyEquipmentIdMediaResponse =
        new operations.GetListingHeavyEquipmentIdMediaResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getSearchHeavyEquipmentActive(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/search/heavy-equipment/active";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSearchHeavyEquipmentActiveResponse =
        new operations.GetSearchHeavyEquipmentActiveResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.heavyEquipmentsSearchResponse = utils.objectToClass(
              httpRes?.data,
              shared.HeavyEquipmentsSearchResponse
            );
          }
          break;
        default:
  ...
  getSearchHeavyEquipmentAutoComplete(
    ...
    const baseURL: string = this._serverURL;
    const url: string =
      baseURL.replace(/\/$/, "") + "/search/heavy-equipment/auto-complete";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetSearchHeavyEquipmentAutoCompleteResponse =
        new operations.GetSearchHeavyEquipmentAutoCompleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
