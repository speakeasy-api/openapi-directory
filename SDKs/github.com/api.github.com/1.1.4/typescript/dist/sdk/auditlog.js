...
var AuditLog = /** @class */ (function () {
    function AuditLog(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    AuditLog.prototype.auditLogGetAuditLog = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AuditLogGetAuditLogRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/enterprises/{enterprise}/audit-log", req.pathParams);
