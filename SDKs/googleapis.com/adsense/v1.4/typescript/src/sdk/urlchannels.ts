...
export class Urlchannels {
  ...
  adsenseUrlchannelsList(
    ...
    security: operations.AdsenseUrlchannelsListSecurity,
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.AdsenseUrlchannelsListSecurity(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AdsenseUrlchannelsListResponse =
        new operations.AdsenseUrlchannelsListResponse({
