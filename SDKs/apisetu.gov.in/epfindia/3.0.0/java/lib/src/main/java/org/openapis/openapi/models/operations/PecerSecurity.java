...
public class PecerSecurity {
    ...
    public PecerSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public PecerSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public PecerSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
