...
class CustomersUpdateRequest:
    headers: CustomersUpdateHeaders = dataclasses.field()
    path_params: CustomersUpdatePathParams = dataclasses.field()
    query_params: CustomersUpdateQueryParams = dataclasses.field()
    request: shared_customersupportcustomer.CustomerSupportCustomerInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: CustomersUpdateSecurity = dataclasses.field()
