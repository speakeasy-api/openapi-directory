...
class CreateEnvironmentEc2Request:
    headers: CreateEnvironmentEc2Headers = dataclasses.field()
    request: shared_createenvironmentec2request.CreateEnvironmentEc2Request = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
