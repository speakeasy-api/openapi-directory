 ...
 */
export enum SmsUniqueRequestGmtZoneEnum {
...
export enum SmsUniqueRequestNumAzurEnum {
  One = "1",
}
...
export class SmsUniqueRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "gmt_zone" })
  gmtZone?: SmsUniqueRequestGmtZoneEnum;
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "numAzur" })
  numAzur?: SmsUniqueRequestNumAzurEnum;
