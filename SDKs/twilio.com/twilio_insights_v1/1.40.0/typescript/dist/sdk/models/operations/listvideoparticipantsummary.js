...
exports.ListVideoParticipantSummaryResponse = exports.ListVideoParticipantSummaryListVideoParticipantSummaryResponse = exports.ListVideoParticipantSummaryListVideoParticipantSummaryResponseMeta = exports.ListVideoParticipantSummaryRequest = exports.ListVideoParticipantSummarySecurity = exports.ListVideoParticipantSummaryServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListVideoParticipantSummaryServerList = [
...
var ListVideoParticipantSummarySecurity = /** @class */ (function (_super) {
    ...
    ], ListVideoParticipantSummarySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListVideoParticipantSummarySecurity.prototype, "username", void 0);
    return ListVideoParticipantSummarySecurity;
}(utils_1.SpeakeasyBase));
exports.ListVideoParticipantSummarySecurity = ListVideoParticipantSummarySecurity;
var ListVideoParticipantSummaryRequest = /** @class */ (function (_super) {
    ...
    ], ListVideoParticipantSummaryRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListVideoParticipantSummaryRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListVideoParticipantSummaryRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=RoomSid",
        }),
        __metadata("design:type", String)
    ], ListVideoParticipantSummaryRequest.prototype, "roomSid", void 0);
    return ListVideoParticipantSummaryRequest;
}(utils_1.SpeakeasyBase));
exports.ListVideoParticipantSummaryRequest = ListVideoParticipantSummaryRequest;
...
exports.ListVideoParticipantSummaryListVideoParticipantSummaryResponseMeta = ListVideoParticipantSummaryListVideoParticipantSummaryResponseMeta;
/**
 * OK
 */
var ListVideoParticipantSummaryListVideoParticipantSummaryResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListVideoParticipantSummaryListVideoParticipantSummaryResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: shared.InsightsV1VideoRoomSummaryVideoParticipantSummary,
        }),
        (0, class_transformer_1.Expose)({ name: "participants" }),
        (0, class_transformer_1.Type)(function () { return shared.InsightsV1VideoRoomSummaryVideoParticipantSummary; }),
...
exports.ListVideoParticipantSummaryListVideoParticipantSummaryResponse = ListVideoParticipantSummaryListVideoParticipantSummaryResponse;
var ListVideoParticipantSummaryResponse = /** @class */ (function (_super) {
    ...
    ], ListVideoParticipantSummaryResponse.prototype, "rawResponse", void 0);
    return ListVideoParticipantSummaryResponse;
}(utils_1.SpeakeasyBase));
exports.ListVideoParticipantSummaryResponse = ListVideoParticipantSummaryResponse;
