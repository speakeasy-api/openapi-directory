 ...
 */
public enum GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBurstablePerformanceEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private GetLaunchTemplateDataResultLaunchTemplateDataInstanceRequirementsBurstablePerformanceEnum(String value) {
        this.value = value;
    }
}
