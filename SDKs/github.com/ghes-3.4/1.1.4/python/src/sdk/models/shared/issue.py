...
class IssueStateReasonEnum(str, Enum):
...
class Issue:
    ...
    state_reason: Optional[IssueStateReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('state_reason'), 'exclude': lambda f: f is None }})
    r"""The reason for the current state"""  
