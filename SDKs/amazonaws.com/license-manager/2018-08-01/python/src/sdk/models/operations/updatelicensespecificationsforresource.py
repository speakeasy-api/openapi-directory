...
class UpdateLicenseSpecificationsForResourceRequest:
    ...
    update_license_specifications_for_resource_request: shared_updatelicensespecificationsforresourcerequest.UpdateLicenseSpecificationsForResourceRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
