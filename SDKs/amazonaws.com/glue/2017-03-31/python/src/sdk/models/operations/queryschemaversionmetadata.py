...
class QuerySchemaVersionMetadataRequest:
    ...
    query_schema_version_metadata_input: shared_queryschemaversionmetadatainput.QuerySchemaVersionMetadataInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
