...
@dataclasses.dataclass
class NodesPreprintsListPreprintAttributes:
...
@dataclasses.dataclass
class NodesPreprintsListPreprintLinks:
...
@dataclasses.dataclass
class NodesPreprintsListPreprintRelationships:
...
class NodesPreprintsListPreprint:
    ...
    relationships: NodesPreprintsListPreprintRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the preprint entity."""  
    type: str = dataclasses.field()
    r"""The type identifier of the preprint entity (`preprints`)."""  
    attributes: Optional[NodesPreprintsListPreprintAttributes] = dataclasses.field(default=None)
    r"""The properties of the preprint entity."""  
    id: Optional[str] = dataclasses.field(default=None)
    r"""The identifier of the preprint entity."""  
    links: Optional[NodesPreprintsListPreprintLinks] = dataclasses.field(default=None)
    r"""URLs to alternative representations of the preprint entity."""  
