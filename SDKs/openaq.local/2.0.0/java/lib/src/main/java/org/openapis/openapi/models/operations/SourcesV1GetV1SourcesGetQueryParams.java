...
public class SourcesV1GetV1SourcesGetQueryParams {
    ...
    public SourcesV1GetV1SourcesGetQueryParams withOrderBy(SourcesV1GetV1SourcesGetOrderBySourcesV1OrderEnum orderBy) {
    ...
    public SourcesV1GetV1SourcesGetQueryParams withSort(SourcesV1GetV1SourcesGetSortSortEnum sort) {
        this.sort = sort;
        return this;
    }
