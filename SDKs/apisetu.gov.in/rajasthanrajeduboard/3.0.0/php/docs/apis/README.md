...
try {
    ...
    $request->certificateParameters->cname = 'Your Name';
    $request->certificateParameters->roll = '2500000';
...
try {
    ...
    $request->certificateParameters->cname = 'DEEPAK TANWAR';
    $request->certificateParameters->roll = '1300009';
    $request->certificateParameters->year = '2018,2019,2020';
    $request->consentArtifact = new ConsentArtifactSchema();
    $request->consentArtifact->consent = new ConsentArtifactSchemaConsent();
    $request->consentArtifact->consent->consentId = 'ea9c43aa-7f5a-4bf3-a0be-e1caa24737ba';
