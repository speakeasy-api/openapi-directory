...
var InsightsV1ConferenceConferenceParticipant = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "call_direction" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "coached_participants" }),
        __metadata("design:type", Array)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "coachedParticipants", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "conference_region" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "is_coach" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "jitter_buffer_size" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "outbound_queue_length" }),
        __metadata("design:type", Number)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "outboundQueueLength", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "outbound_time_in_queue" }),
        __metadata("design:type", Number)
    ], InsightsV1ConferenceConferenceParticipant.prototype, "outboundTimeInQueue", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "participant_region" }),
        __metadata("design:type", String)
