...
public class GETRSbyDebitMemoItemRequest {
    ...
    public GETRSbyDebitMemoItemRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETRSbyDebitMemoItemRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public String dmiId;
    public GETRSbyDebitMemoItemRequest withDmiId(String dmiId) {
        this.dmiId = dmiId;
        return this;
    }
