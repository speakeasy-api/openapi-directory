...
class ScanConfigError:
    ...
    r"""Indicates the full name of the ScanConfig field that triggers this error, for example \\"scan_config.max_qps\\". This field is provided for troubleshooting purposes only and its actual value can change in the future."""  
