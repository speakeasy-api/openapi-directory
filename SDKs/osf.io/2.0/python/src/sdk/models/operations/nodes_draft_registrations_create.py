...
class NodesDraftRegistrationsCreateDraftRegistrationAttributesNodeLicense:
...
class NodesDraftRegistrationsCreateDraftRegistrationAttributesInput:
    ...
    node_license: Optional[NodesDraftRegistrationsCreateDraftRegistrationAttributesNodeLicense] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('node_license'), 'exclude': lambda f: f is None }})  
...
class NodesDraftRegistrationsCreateDraftRegistrationInput:
    ...
    attributes: NodesDraftRegistrationsCreateDraftRegistrationAttributesInput = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('attributes') }})
    r"""The properties of the Draft Registration entity."""  
...
class NodesDraftRegistrationsCreateRequest:
    ...
    request_body: NodesDraftRegistrationsCreateDraftRegistrationInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
