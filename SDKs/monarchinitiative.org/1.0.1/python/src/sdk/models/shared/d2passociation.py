...
class D2PAssociation:
    ...
    frequency: Optional[shared_entityreference.EntityReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('frequency') }})
    ...
    onset: Optional[shared_entityreference.EntityReference] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('onset') }})
