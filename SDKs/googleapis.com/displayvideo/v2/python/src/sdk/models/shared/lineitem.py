...
from ..shared import youtubeandpartnerssettings as shared_youtubeandpartnerssettings
from ..shared import lineitembudget as shared_lineitembudget
from ..shared import mobileapp as shared_mobileapp
...
class LineItem:
    ...
    youtube_and_partners_settings: Optional[shared_youtubeandpartnerssettings.YoutubeAndPartnersSettings] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('youtubeAndPartnersSettings') }})
