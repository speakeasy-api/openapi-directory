...
public class GetGeneFunctionAssociationsRequest {
    ...
    public GetGeneFunctionAssociationsRequest withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGeneFunctionAssociationsRequest withEvidence(String evidence) {
    ...
    public GetGeneFunctionAssociationsRequest withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGeneFunctionAssociationsRequest withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGeneFunctionAssociationsRequest withFacetFields(String[] facetFields) {
    ...
    public GetGeneFunctionAssociationsRequest withFetchObjects(Boolean fetchObjects) {
    ...
    public GetGeneFunctionAssociationsRequest withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public GetGeneFunctionAssociationsRequest withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetGeneFunctionAssociationsRequest withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public GetGeneFunctionAssociationsRequest withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public GetGeneFunctionAssociationsRequest withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGeneFunctionAssociationsRequest withUseCompactAssociations(Boolean useCompactAssociations) {
        this.useCompactAssociations = useCompactAssociations;
        return this;
    }
    
    public GetGeneFunctionAssociationsRequest(@JsonProperty("id") String id) {
        this.id = id;
  }
}
