...
from ..shared import proxymodifyproductrateplan as shared_proxymodifyproductrateplan
...
class ObjectPUTProductRatePlanRequest:
    ...
    r"""Object id"""  
    proxy_modify_product_rate_plan: shared_proxymodifyproductrateplan.ProxyModifyProductRatePlan = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
