...
export enum POSTGetReservedNodeExchangeConfigurationOptionsActionEnum {
  GetReservedNodeExchangeConfigurationOptions = "GetReservedNodeExchangeConfigurationOptions",
}

export enum POSTGetReservedNodeExchangeConfigurationOptionsVersionEnum {
  TwoThousandAndTwelve1201 = "2012-12-01",
}

export class POSTGetReservedNodeExchangeConfigurationOptionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class POSTGetReservedNodeExchangeConfigurationOptionsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
