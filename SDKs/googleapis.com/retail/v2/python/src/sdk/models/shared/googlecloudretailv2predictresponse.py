...
import dataclasses
from ..shared import googlecloudretailv2predictresponsepredictionresult as shared_googlecloudretailv2predictresponsepredictionresult
...
class GoogleCloudRetailV2PredictResponse:
    ...
    results: Optional[list[shared_googlecloudretailv2predictresponsepredictionresult.GoogleCloudRetailV2PredictResponsePredictionResult]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})
