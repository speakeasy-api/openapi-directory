...
exports.CreateChannelResponse = exports.CreateChannelRequest = exports.CreateChannelRequestBody = exports.CreateChannelRequestBodyRetentionPeriod = exports.CreateChannelRequestBodyChannelStorage = void 0;
...
var CreateChannelRequestBodyChannelStorage = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.CustomerManagedChannelS3Storage; }),
...
exports.CreateChannelRequestBodyChannelStorage = CreateChannelRequestBodyChannelStorage;
/**
...
exports.CreateChannelRequestBodyRetentionPeriod = CreateChannelRequestBodyRetentionPeriod;
var CreateChannelRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "channelStorage" }),
        (0, class_transformer_1.Type)(function () { return CreateChannelRequestBodyChannelStorage; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return CreateChannelRequestBodyRetentionPeriod; }),
...
var CreateChannelRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateChannelRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], CreateChannelRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], CreateChannelRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], CreateChannelRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], CreateChannelRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], CreateChannelRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], CreateChannelRequest.prototype, "xAmzSignedHeaders", void 0);
