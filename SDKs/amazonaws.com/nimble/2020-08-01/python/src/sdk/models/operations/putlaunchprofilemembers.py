...
class PutLaunchProfileMembersRequestBody:
    ...
    members: list[shared_newlaunchprofilemember.NewLaunchProfileMember] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('members') }})
    

@dataclasses.dataclass
class PutLaunchProfileMembersRequest:
    headers: PutLaunchProfileMembersHeaders = dataclasses.field()
    path_params: PutLaunchProfileMembersPathParams = dataclasses.field()
    request: PutLaunchProfileMembersRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
