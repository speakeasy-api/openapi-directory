 ...
 */
export enum RoutersScopedListWarningCodeEnum {
...
export class RoutersScopedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RoutersScopedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: RoutersScopedListWarningData })
  @Expose({ name: "data" })
...
export class RoutersScopedList extends SpeakeasyBase {
  /**
