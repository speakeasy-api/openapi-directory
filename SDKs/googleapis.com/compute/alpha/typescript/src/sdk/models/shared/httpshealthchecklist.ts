 ...
 */
export enum HttpsHealthCheckListWarningCodeEnum {
...
export class HttpsHealthCheckListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class HttpsHealthCheckListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: HttpsHealthCheckListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class HttpsHealthCheckList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: HttpsHealthCheck1 })
  @Expose({ name: "items" })
  @Type(() => HttpsHealthCheck1)
