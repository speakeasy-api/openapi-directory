...
var Shipment = /** @class */ (function () {
    ...
    **/
    Shipment.prototype.cancelShipment = function (req, config) {
    ...
    **/
    Shipment.prototype.createFromShippingQuote = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Shipment.prototype.downloadLabelFile = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
