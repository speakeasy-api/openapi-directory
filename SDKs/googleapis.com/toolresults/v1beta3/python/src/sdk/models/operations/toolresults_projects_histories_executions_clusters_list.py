...
from ..shared import security as shared_security
from ..shared import listscreenshotclustersresponse as shared_listscreenshotclustersresponse
...
class ToolresultsProjectsHistoriesExecutionsClustersListRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsClustersListPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsClustersListQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsClustersListSecurity = dataclasses.field()
...
class ToolresultsProjectsHistoriesExecutionsClustersListResponse:
    ...
    list_screenshot_clusters_response: Optional[shared_listscreenshotclustersresponse.ListScreenshotClustersResponse] = dataclasses.field(default=None)
