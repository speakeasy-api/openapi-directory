...
class GetFilePaymentsFilePaymentIDRequest:
    headers: GetFilePaymentsFilePaymentIDHeaders = dataclasses.field()
    path_params: GetFilePaymentsFilePaymentIDPathParams = dataclasses.field()
    security: GetFilePaymentsFilePaymentIDSecurity = dataclasses.field()
