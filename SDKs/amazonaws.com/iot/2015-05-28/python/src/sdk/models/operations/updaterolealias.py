...
class UpdateRoleAliasRequest:
    headers: UpdateRoleAliasHeaders = dataclasses.field()
    path_params: UpdateRoleAliasPathParams = dataclasses.field()
    request: UpdateRoleAliasRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
