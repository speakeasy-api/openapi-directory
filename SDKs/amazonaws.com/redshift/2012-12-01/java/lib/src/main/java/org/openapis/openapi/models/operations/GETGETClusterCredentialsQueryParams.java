...
public class GETGETClusterCredentialsQueryParams {
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=Action")
    public GETGETClusterCredentialsActionEnum action;
    public GETGETClusterCredentialsQueryParams withAction(GETGETClusterCredentialsActionEnum action) {
        this.action = action;
        return this;
    }
    ...
    public GETGETClusterCredentialsQueryParams withAutoCreate(Boolean autoCreate) {
    ...
    public GETGETClusterCredentialsQueryParams withClusterIdentifier(String clusterIdentifier) {
    ...
    public GETGETClusterCredentialsQueryParams withDbGroups(String[] dbGroups) {
    ...
    public GETGETClusterCredentialsQueryParams withDbName(String dbName) {
        this.dbName = dbName;
        return this;
    }
    ...
    public GETGETClusterCredentialsQueryParams withDbUser(String dbUser) {
        this.dbUser = dbUser;
        return this;
    }
    ...
    public GETGETClusterCredentialsQueryParams withDurationSeconds(Long durationSeconds) {
    ...
    public GETGETClusterCredentialsQueryParams withVersion(GETGETClusterCredentialsVersionEnum version) {
