...
type VolumeGroupSnapshotSummary struct {
	...
	IncludedVolumes []VolumeGroupSnapshotVolumeSummary `json:"includedVolumes"`
	...
	UsedFastVhdx *bool `json:"usedFastVhdx,omitempty"`
