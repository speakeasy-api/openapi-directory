...
var Offer = /** @class */ (function () {
    function Offer(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Offer.prototype.findEligibleItems = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FindEligibleItemsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/find_eligible_items";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.pagedEligibleItemCollection = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Offer.prototype.sendOfferToInterestedBuyers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SendOfferToInterestedBuyersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/send_offer_to_interested_buyers";
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.sendOfferToInterestedBuyersCollectionResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
