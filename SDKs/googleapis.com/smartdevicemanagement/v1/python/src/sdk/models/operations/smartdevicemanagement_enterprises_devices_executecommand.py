...
class SmartdevicemanagementEnterprisesDevicesExecuteCommandRequest:
    ...
    r"""The name of the device requested. For example: \\"enterprises/XYZ/devices/123\\" """  
    ...
    google_home_enterprise_sdm_v1_execute_device_command_request: Optional[shared_googlehomeenterprisesdmv1executedevicecommandrequest.GoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
