...
var Stores = /** @class */ (function () {
    function Stores(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Stores.prototype.storesList = function (req, config) {
    ...
    **/
    Stores.prototype.storesRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
