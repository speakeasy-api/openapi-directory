...
class SpotSetTypeAreacodeTypeEnum(str, Enum):
    r"""Spot set type `areacode`; Matches Item with the same Area Code as specified by this set"""
    AREACODE = 'areacode'
...
class SpotSetTypeAreacodeInput:
    ...
    area_code: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('area_code'), 'exclude': lambda f: f is None }})
    r"""Area Code"""  
    ...
    type: Optional[SpotSetTypeAreacodeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Spot set type `areacode`; Matches Item with the same Area Code as specified by this set"""  
