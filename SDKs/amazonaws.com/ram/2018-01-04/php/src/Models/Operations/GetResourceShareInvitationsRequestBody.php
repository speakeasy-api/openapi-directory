...
class GetResourceShareInvitationsRequestBody
{
     ...
     * 
     * @var ?array<string> $resourceShareInvitationArns
     */
	#[\JMS\Serializer\Annotation\SerializedName('resourceShareInvitationArns')]
    #[\JMS\Serializer\Annotation\Type('array<string>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?array $resourceShareInvitationArns = null;
