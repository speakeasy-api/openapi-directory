...
func (e *UpdateNetworkSwitchAccessPolicyRequestBodyAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "MAC authentication bypass":
		*e = UpdateNetworkSwitchAccessPolicyRequestBodyAccessPolicyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchAccessPolicyRequestBodyAccessPolicyTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "both":
		fallthrough
	case "inbound":
		*e = UpdateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchAccessPolicyRequestBodyDot1xControlDirectionEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchAccessPolicyRequestBodyHostModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Multi-Host":
		fallthrough
	case "Single-Host":
		*e = UpdateNetworkSwitchAccessPolicyRequestBodyHostModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchAccessPolicyRequestBodyHostModeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Hybrid authentication":
		fallthrough
	case "MAC authentication bypass":
		*e = UpdateNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchAccessPolicy200ApplicationJSONAccessPolicyTypeEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "both":
		fallthrough
	case "inbound":
		*e = UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchAccessPolicy200ApplicationJSONDot1xControlDirectionEnum: %s", s)
	}
}
...
func (e *UpdateNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "Multi-Host":
		fallthrough
	case "Single-Host":
		*e = UpdateNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkSwitchAccessPolicy200ApplicationJSONHostModeEnum: %s", s)
	}
}
