...
exports.GetConsumerV1ResourcesResponse = exports.GetConsumerV1ResourcesRequest = void 0;
...
var GetConsumerV1ResourcesRequest = /** @class */ (function (_super) {
    ...
    ], GetConsumerV1ResourcesRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetConsumerV1ResourcesRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locationId",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1ResourcesRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], GetConsumerV1ResourcesRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetConsumerV1ResourcesRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resourceGroupId",
        }),
        __metadata("design:type", Number)
    ], GetConsumerV1ResourcesRequest.prototype, "resourceGroupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sortOrder",
        }),
        __metadata("design:type", String)
    ], GetConsumerV1ResourcesRequest.prototype, "sortOrder", void 0);
...
var GetConsumerV1ResourcesResponse = /** @class */ (function (_super) {
    ...
    ], GetConsumerV1ResourcesResponse.prototype, "rawResponse", void 0);
