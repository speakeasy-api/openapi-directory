...
type PutBandwidthRateLimitScheduleHeaders struct {
...
type PutBandwidthRateLimitScheduleRequest struct {
	Headers PutBandwidthRateLimitScheduleHeaders
	Request shared.PutBandwidthRateLimitScheduleInput `request:"mediaType=application/json"`
}
