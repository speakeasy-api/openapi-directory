 ...
 */
export enum TargetHttpProxyListWarningCodeEnum {
...
export class TargetHttpProxyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class TargetHttpProxyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: TargetHttpProxyListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class TargetHttpProxyList extends SpeakeasyBase {
  /**
   ...
   * A list of TargetHttpProxy resources.
   */
  @SpeakeasyMetadata({ elemType: TargetHttpProxy })
  @Expose({ name: "items" })
