...
from ..shared import setloggingservicerequest as shared_setloggingservicerequest
from typing import Optional


@dataclasses.dataclass
class ContainerProjectsZonesClustersLoggingSecurity:
...
@dataclasses.dataclass
class ContainerProjectsZonesClustersLoggingRequest:
    ...
    set_logging_service_request: Optional[shared_setloggingservicerequest.SetLoggingServiceRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
@dataclasses.dataclass
class ContainerProjectsZonesClustersLoggingResponse:
