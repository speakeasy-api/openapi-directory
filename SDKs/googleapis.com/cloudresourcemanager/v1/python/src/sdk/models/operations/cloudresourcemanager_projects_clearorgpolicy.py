...
class CloudresourcemanagerProjectsClearOrgPolicyRequest:
    ...
    r"""Name of the resource for the `Policy` to clear."""  
    ...
    r"""JSONP"""  
    clear_org_policy_request: Optional[shared_clearorgpolicyrequest.ClearOrgPolicyRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
