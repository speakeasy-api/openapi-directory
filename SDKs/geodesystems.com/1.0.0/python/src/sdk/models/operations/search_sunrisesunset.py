...
class SearchSunrisesunsetQueryParams:
...
@dataclasses.dataclass
class SearchSunrisesunsetRequest:
    query_params: SearchSunrisesunsetQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchSunrisesunsetResponse:
