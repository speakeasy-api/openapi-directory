...
class StorageObjectsWatchAllRequest:
    path_params: StorageObjectsWatchAllPathParams = dataclasses.field()
    query_params: StorageObjectsWatchAllQueryParams = dataclasses.field()
    security: StorageObjectsWatchAllSecurity = dataclasses.field()
