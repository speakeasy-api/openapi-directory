...
type GkeonpremProjectsLocationsBareMetalClustersBareMetalNodePoolsListSecurity struct {
	Oauth2  string `security:"scheme,type=oauth2,name=Authorization"`
	Oauth2c string `security:"scheme,type=oauth2,name=Authorization"`
}

type GkeonpremProjectsLocationsBareMetalClustersBareMetalNodePoolsListRequest struct {
	// V1 error format.
...
type GkeonpremProjectsLocationsBareMetalClustersBareMetalNodePoolsListResponse struct {
	ContentType string
	// Successful response
	ListBareMetalNodePoolsResponse *shared.ListBareMetalNodePoolsResponse
	StatusCode                     int
