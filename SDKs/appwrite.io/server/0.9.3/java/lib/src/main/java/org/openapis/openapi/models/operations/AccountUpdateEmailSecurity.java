...
public class AccountUpdateEmailSecurity {
    ...
    public AccountUpdateEmailSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public AccountUpdateEmailSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public AccountUpdateEmailSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.project = project;
  }
}
