...
class OBWriteDomesticScheduledResponse5
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledResponse5Data')]
	...
	{
		$this->data = new \OpenAPI\OpenAPI\Models\Shared\OBWriteDomesticScheduledResponse5Data();
		$this->links = null;
		$this->meta = null;
	}
}
