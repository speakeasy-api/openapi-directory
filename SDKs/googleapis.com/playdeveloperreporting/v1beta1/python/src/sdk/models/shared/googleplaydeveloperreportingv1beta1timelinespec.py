...
class GooglePlayDeveloperReportingV1beta1TimelineSpec:
    ...
    aggregation_period: Optional[GooglePlayDeveloperReportingV1beta1TimelineSpecAggregationPeriodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('aggregationPeriod'), 'exclude': lambda f: f is None }})
    r"""Type of the aggregation period of the datapoints in the timeline. Intervals are identified by the date and time at the start of the interval."""  
