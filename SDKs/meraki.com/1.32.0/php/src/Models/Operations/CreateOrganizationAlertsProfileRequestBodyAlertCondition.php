...
class CreateOrganizationAlertsProfileRequestBodyAlertCondition
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum $interface
     */
	#[\JMS\Serializer\Annotation\SerializedName('interface')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CreateOrganizationAlertsProfileRequestBodyAlertConditionInterfaceEnum $interface = null;
