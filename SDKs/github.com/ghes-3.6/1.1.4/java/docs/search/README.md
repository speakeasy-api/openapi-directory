...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCodeRequest req = new SearchCodeRequest("libero") {{
                order = OrderEnum.ASC;
                page = 74921L;
                perPage = 792499L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchCommitsRequest req = new SearchCommitsRequest("quos") {{
                order = OrderEnum.ASC;
                page = 576657L;
                perPage = 483459L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchIssuesAndPullRequestsRequest req = new SearchIssuesAndPullRequestsRequest("accusamus") {{
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchLabelsRequest req = new SearchLabelsRequest("quae", 607545L) {{
                order = OrderEnum.ASC;
                page = 526584L;
                perPage = 949370L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchReposRequest req = new SearchReposRequest("modi") {{
                order = OrderEnum.ASC;
                page = 101374L;
                perPage = 305189L;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchTopicsRequest req = new SearchTopicsRequest("maiores") {{
                page = 196646L;
                perPage = 902132L;
            }};            
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            SearchUsersRequest req = new SearchUsersRequest("consequatur") {{
                order = OrderEnum.DESC;
                page = 891302L;
                perPage = 817454L;
