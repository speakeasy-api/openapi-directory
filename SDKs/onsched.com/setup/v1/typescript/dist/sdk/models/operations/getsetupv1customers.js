...
exports.GetSetupV1CustomersResponse = exports.GetSetupV1CustomersRequest = void 0;
...
var GetSetupV1CustomersRequest = /** @class */ (function (_super) {
    ...
    ], GetSetupV1CustomersRequest.prototype, "deleted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=email" }),
        __metadata("design:type", String)
    ], GetSetupV1CustomersRequest.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=groupId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1CustomersRequest.prototype, "groupId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=lastname",
        }),
        __metadata("design:type", String)
    ], GetSetupV1CustomersRequest.prototype, "lastname", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], GetSetupV1CustomersRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=locationId",
        }),
        __metadata("design:type", String)
    ], GetSetupV1CustomersRequest.prototype, "locationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], GetSetupV1CustomersRequest.prototype, "offset", void 0);
...
var GetSetupV1CustomersResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", shared.CustomerListViewModel)
    ...
    ], GetSetupV1CustomersResponse.prototype, "rawResponse", void 0);
