...
export class CreateFilePaymentsJsonSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CreateFilePaymentsJsonRequest extends SpeakeasyBase {
  /**
...
export class CreateFilePaymentsJsonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
