...
class ScimSchemaAttributeTypeEnum(str, Enum):
    STRING = 'string'
    BOOLEAN = 'boolean'
    COMPLEX = 'complex'
...
class ScimSchemaAttribute:
    ...
    type: Optional[ScimSchemaAttributeTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
