...
exports.ListWorkerResponse = exports.ListWorkerListWorkerResponse = exports.ListWorkerListWorkerResponseMeta = exports.ListWorkerRequest = exports.ListWorkerSecurity = exports.ListWorkerServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListWorkerServerList = ["https://taskrouter.twilio.com"];
var ListWorkerSecurity = /** @class */ (function (_super) {
    ...
    ], ListWorkerSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListWorkerSecurity.prototype, "username", void 0);
...
var ListWorkerRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "activityName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ActivitySid",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "activitySid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Available",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "available", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=FriendlyName",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "friendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Ordering",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "ordering", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListWorkerRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListWorkerRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TargetWorkersExpression",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "targetWorkersExpression", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskQueueName",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "taskQueueName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaskQueueSid",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "taskQueueSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=WorkspaceSid",
        }),
        __metadata("design:type", String)
    ], ListWorkerRequest.prototype, "workspaceSid", void 0);
...
var ListWorkerListWorkerResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListWorkerListWorkerResponseMeta; }),
        __metadata("design:type", ListWorkerListWorkerResponseMeta)
    ], ListWorkerListWorkerResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.TaskrouterV1WorkspaceWorker }),
        (0, class_transformer_1.Expose)({ name: "workers" }),
        (0, class_transformer_1.Type)(function () { return shared.TaskrouterV1WorkspaceWorker; }),
...
var ListWorkerResponse = /** @class */ (function (_super) {
    ...
    ], ListWorkerResponse.prototype, "rawResponse", void 0);
