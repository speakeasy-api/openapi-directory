...
from ..shared import enabledirectoryresponse as shared_enabledirectoryresponse


@dataclasses.dataclass
class EnableDirectoryHeaders:
...
class EnableDirectoryRequest:
    headers: EnableDirectoryHeaders = dataclasses.field()
...
class EnableDirectoryResponse:
    ...
    enable_directory_response: Optional[shared_enabledirectoryresponse.EnableDirectoryResponse] = dataclasses.field(default=None)
