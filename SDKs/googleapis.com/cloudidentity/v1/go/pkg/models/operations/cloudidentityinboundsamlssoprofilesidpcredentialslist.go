...
type CloudidentityInboundSamlSsoProfilesIdpCredentialsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudidentityInboundSamlSsoProfilesIdpCredentialsListPathParams struct {
...
type CloudidentityInboundSamlSsoProfilesIdpCredentialsListQueryParams struct {
	// V1 error format.
...
type CloudidentityInboundSamlSsoProfilesIdpCredentialsListRequest struct {
...
type CloudidentityInboundSamlSsoProfilesIdpCredentialsListResponse struct {
	ContentType string
	// Successful response
