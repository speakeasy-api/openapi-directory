...
public class DcimInterfaceConnectionsListQueryParams {
    ...
    public DcimInterfaceConnectionsListQueryParams withConnectionStatusN(String connectionStatusN) {
    ...
    public DcimInterfaceConnectionsListQueryParams withDeviceId(String deviceId) {
