...
from ..shared import updatenoteresponse as shared_updatenoteresponse
...
class NotesUpdateRequest:
    ...
    note_input: shared_note.NoteInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class NotesUpdateResponse:
    ...
    r"""Unprocessable"""  
    update_note_response: Optional[shared_updatenoteresponse.UpdateNoteResponse] = dataclasses.field(default=None)
    r"""Note updated"""  
