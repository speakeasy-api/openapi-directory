...
class CloudTaskPreviousStateEnum(str, Enum):
    r"""The previous state of the task. This property is not set if the task is in its initial Active state."""
    ACTIVE = 'active'
    PREPARING = 'preparing'
    RUNNING = 'running'
    COMPLETED = 'completed'
...
class CloudTaskStateEnum(str, Enum):
    r"""The current state of the task."""
    ACTIVE = 'active'
    PREPARING = 'preparing'
    RUNNING = 'running'
    COMPLETED = 'completed'
...
class CloudTask:
    ...
    r"""The command line of the task. For multi-instance tasks, the command line is executed on the primary subtask after all the subtasks have finished executing the coordination command line."""  
    ...
    r"""The creation time of the task."""  
    ...
    r"""A list of environment variable settings for the task."""  
    ...
    r"""A string that uniquely identifies the task within the job. The id can contain any combination of alphanumeric characters including hyphens and underscores, and cannot contain more than 64 characters."""  
    ...
    r"""The time at which the task entered its previous state. This property is not set if the task is in its initial Active state."""  
    ...
    r"""A list of files that the Batch service will download to the compute node before running the command line. For multi-instance tasks, the resource files will only be downloaded to the compute node on which the primary subtask is executed."""  
    ...
    r"""Whether to run the task in elevated mode."""  
    ...
    r"""The time at which the task entered its current state."""  
