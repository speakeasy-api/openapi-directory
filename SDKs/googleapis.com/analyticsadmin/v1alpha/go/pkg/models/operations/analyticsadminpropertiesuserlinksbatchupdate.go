...
type AnalyticsadminPropertiesUserLinksBatchUpdateRequest struct {
	...
	GoogleAnalyticsAdminV1alphaBatchUpdateUserLinksRequestInput *shared.GoogleAnalyticsAdminV1alphaBatchUpdateUserLinksRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
