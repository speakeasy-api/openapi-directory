...
class RouteAuthorizationTypeEnum(str, Enum):
...
class Route:
    ...
    authorization_type: Optional[RouteAuthorizationTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorizationType'), 'exclude': lambda f: f is None }})  
