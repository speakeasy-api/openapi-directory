...
class DescribeEventTrackerRequest:
    ...
    describe_event_tracker_request: shared_describeeventtrackerrequest.DescribeEventTrackerRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
