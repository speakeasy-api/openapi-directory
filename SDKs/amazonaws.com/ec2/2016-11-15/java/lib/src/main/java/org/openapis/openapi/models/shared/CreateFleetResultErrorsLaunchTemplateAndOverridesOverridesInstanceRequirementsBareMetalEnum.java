 ...
 */
public enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsBareMetalEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsBareMetalEnum(String value) {
        this.value = value;
    }
}
