...
from ..shared import roleuserlist as shared_roleuserlist
from ..shared import userids as shared_userids
...
class RevokeRoleUsersRequest:
    ...
    r"""Role ID"""  
    user_ids: shared_userids.UserIds = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class RevokeRoleUsersResponse:
    ...
    role_user_list: Optional[shared_roleuserlist.RoleUserList] = dataclasses.field(default=None)
    r"""OK"""  
