...
class EnableMacieRequestBody:
    ...
    finding_publishing_frequency: Optional[EnableMacieRequestBodyFindingPublishingFrequencyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('findingPublishingFrequency'), 'exclude': lambda f: f is None }})
    r"""The frequency with which Amazon Macie publishes updates to policy findings for an account. This includes publishing updates to Security Hub and Amazon EventBridge (formerly Amazon CloudWatch Events). For more information, see <a href=\\"https://docs.aws.amazon.com/macie/latest/user/findings-monitor.html\\">Monitoring and processing findings</a> in the <i>Amazon Macie User Guide</i>. Valid values are:"""  
    status: Optional[EnableMacieRequestBodyStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
    r"""The status of an Amazon Macie account. Valid values are:"""  
...
class EnableMacieRequest:
    ...
    request_body: EnableMacieRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
