...
from ..shared import tppmessage401_ais as shared_tppmessage401_ais
...
class Error401NgAis:
    ...
    tpp_messages: Optional[list[shared_tppmessage401_ais.TppMessage401Ais]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
