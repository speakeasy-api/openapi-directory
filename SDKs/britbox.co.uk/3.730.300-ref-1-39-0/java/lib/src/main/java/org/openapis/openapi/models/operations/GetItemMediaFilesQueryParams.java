...
public class GetItemMediaFilesQueryParams {
    /**
    ...
    public GetItemMediaFilesQueryParams withDelivery(org.openapis.openapi.models.shared.MediaFileDeliveryEnum[] delivery) {
    ...
    public GetItemMediaFilesQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetItemMediaFilesQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public GetItemMediaFilesQueryParams withFormats(org.openapis.openapi.models.shared.MediaFileFormatsEnum[] formats) {
    ...
    public String lang;
    public GetItemMediaFilesQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetItemMediaFilesQueryParams withResolution(org.openapis.openapi.models.shared.MediaFileResolutionEnum resolution) {
    ...
    public GetItemMediaFilesQueryParams withSegments(String[] segments) {
    ...
    public String sub;
    public GetItemMediaFilesQueryParams withSub(String sub) {
        this.sub = sub;
        return this;
    }
