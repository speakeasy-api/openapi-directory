...
var V3StopTicket = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "is_free_fare_zone" }),
        __metadata("design:type", Boolean)
    ], V3StopTicket.prototype, "isFreeFareZone", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ticket_checks" }),
        __metadata("design:type", Boolean)
    ], V3StopTicket.prototype, "ticketChecks", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ticket_machine" }),
        __metadata("design:type", Boolean)
    ], V3StopTicket.prototype, "ticketMachine", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ticket_type" }),
        __metadata("design:type", String)
    ], V3StopTicket.prototype, "ticketType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "ticket_zones" }),
        __metadata("design:type", Array)
    ], V3StopTicket.prototype, "ticketZones", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "vline_reservation" }),
        __metadata("design:type", Boolean)
