 ...
 */
export declare class DescribeLocalGatewaysRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeLocalGatewaysRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeLocalGatewaysRequestFilters[];
