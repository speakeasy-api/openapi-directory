...
public class GetRepositoriesWorkspaceRepoSlugRefsBranchesNameResponse {
    ...
    public GetRepositoriesWorkspaceRepoSlugRefsBranchesNameResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
