...
export declare class InitiatePaymentMultipartSecurity extends SpeakeasyBase {
    bearerAuthOAuth?: string;
}
export declare class InitiatePaymentMultipartRequest extends SpeakeasyBase {
    /**
...
export declare class InitiatePaymentMultipartResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Bad Request
     */
