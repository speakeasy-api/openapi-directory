...
class IamRolesListViewEnum(str, Enum):
    BASIC = "BASIC"
    FULL = "FULL"


@dataclasses.dataclass
class IamRolesListQueryParams:
    ...
    view: Optional[IamRolesListViewEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class IamRolesListSecurity:
    oauth2: shared_security.SchemeOauth2 = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared_security.SchemeOauth2c = dataclasses.field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclasses.dataclass
class IamRolesListRequest:
    query_params: IamRolesListQueryParams = dataclasses.field()
    security: IamRolesListSecurity = dataclasses.field()
    

@dataclasses.dataclass
class IamRolesListResponse:
