...
func (s *User) ChangeUserPassword(ctx context.Context, request operations.ChangeUserPasswordRequest) (*operations.ChangeUserPasswordResponse, error) {
...
func (s *User) CreateAndPreserveUserKeyPair(ctx context.Context, request operations.CreateAndPreserveUserKeyPairRequest) (*operations.CreateAndPreserveUserKeyPairResponse, error) {
	baseURL := s._serverURL
...
func (s *User) EnableCustomerEncryption(ctx context.Context, request operations.EnableCustomerEncryptionRequest) (*operations.EnableCustomerEncryptionResponse, error) {
	baseURL := s._serverURL
...
//
// </details>
func (s *User) ListDownloadShareSubscriptions(ctx context.Context, request operations.ListDownloadShareSubscriptionsRequest) (*operations.ListDownloadShareSubscriptionsResponse, error) {
	baseURL := s._serverURL
...
//
// </details>
func (s *User) ListNodeSubscriptions(ctx context.Context, request operations.ListNodeSubscriptionsRequest) (*operations.ListNodeSubscriptionsResponse, error) {
	baseURL := s._serverURL
...
//
// </details>
func (s *User) ListUploadShareSubscriptions(ctx context.Context, request operations.ListUploadShareSubscriptionsRequest) (*operations.ListUploadShareSubscriptionsResponse, error) {
	baseURL := s._serverURL
...
// ### Further Information:
// None.
func (s *User) Logout(ctx context.Context, request operations.LogoutRequest) (*operations.LogoutResponse, error) {
	baseURL := s._serverURL
...
// ### Further Information:
// None.
func (s *User) PingUser(ctx context.Context, request operations.PingUserRequest) (*operations.PingUserResponse, error) {
	baseURL := s._serverURL
...
func (s *User) RemoveUserKeyPair(ctx context.Context, request operations.RemoveUserKeyPairRequest) (*operations.RemoveUserKeyPairResponse, error) {
	baseURL := s._serverURL
...
// ### Further Information:
// None.
func (s *User) RequestAvatar(ctx context.Context, request operations.RequestAvatarRequest) (*operations.RequestAvatarResponse, error) {
	baseURL := s._serverURL
...
// ### Further Information:
// None.
func (s *User) RequestCustomerInfo(ctx context.Context, request operations.RequestCustomerInfoRequest) (*operations.RequestCustomerInfoResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/customer"
...
func (s *User) RequestCustomerKeyPair(ctx context.Context, request operations.RequestCustomerKeyPairRequest) (*operations.RequestCustomerKeyPairResponseOutput, error) {
	baseURL := s._serverURL
	...
	res := &operations.RequestCustomerKeyPairResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
// ### Further Information:
// None.
func (s *User) RequestListOfNotificationConfigs(ctx context.Context, request operations.RequestListOfNotificationConfigsRequest) (*operations.RequestListOfNotificationConfigsResponse, error) {
	baseURL := s._serverURL
...
//
// </details>
func (s *User) RequestOAuthApprovals(ctx context.Context, request operations.RequestOAuthApprovalsRequest) (*operations.RequestOAuthApprovalsResponse, error) {
	baseURL := s._serverURL
...
//
// </details>
func (s *User) RequestOAuthAuthorizations(ctx context.Context, request operations.RequestOAuthAuthorizationsRequest) (*operations.RequestOAuthAuthorizationsResponse, error) {
	baseURL := s._serverURL
...
//
// </details>
func (s *User) RequestProfileAttributes(ctx context.Context, request operations.RequestProfileAttributesRequest) (*operations.RequestProfileAttributesResponse, error) {
	baseURL := s._serverURL
...
func (s *User) RequestUserInfo(ctx context.Context, request operations.RequestUserInfoRequest) (*operations.RequestUserInfoResponse, error) {
	baseURL := s._serverURL
...
// ### Further Information:
// The private key is password-based encrypted with `AES256` / `PBKDF2`.
func (s *User) RequestUserKeyPair(ctx context.Context, request operations.RequestUserKeyPairRequest) (*operations.RequestUserKeyPairResponseOutput, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/keypair"
	...
	res := &operations.RequestUserKeyPairResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
// ### Further Information:
// None.
func (s *User) RequestUserKeyPairs(ctx context.Context, request operations.RequestUserKeyPairsRequest) (*operations.RequestUserKeyPairsResponseOutput, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/keypairs"
	...
	res := &operations.RequestUserKeyPairsResponseOutput{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
// ### Further Information:
// None.
func (s *User) ResetAvatar(ctx context.Context, request operations.ResetAvatarRequest) (*operations.ResetAvatarResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/avatar"
...
func (s *User) SetProfileAttributes(ctx context.Context, request operations.SetProfileAttributesRequest) (*operations.SetProfileAttributesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/profileAttributes"
...
// The private key is password-based encrypted with `AES256` / `PBKDF2`.
func (s *User) SetUserKeyPair(ctx context.Context, request operations.SetUserKeyPairRequest) (*operations.SetUserKeyPairResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/keypair"
...
func (s *User) SubscribeDownloadShares(ctx context.Context, request operations.SubscribeDownloadSharesRequest) (*operations.SubscribeDownloadSharesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/subscriptions/download_shares"
...
// ### Further Information:
// Maximum number of subscriptions is 200.
func (s *User) SubscribeUploadShares(ctx context.Context, request operations.SubscribeUploadSharesRequest) (*operations.SubscribeUploadSharesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/subscriptions/upload_shares"
...
// ### Further Information:
// Maximum number of subscriptions is 200.
func (s *User) UpdateNodeSubscriptions(ctx context.Context, request operations.UpdateNodeSubscriptionsRequest) (*operations.UpdateNodeSubscriptionsResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/subscriptions/nodes"
...
// * Maximum key length is **255**
// * Maximum value length is **4096**
func (s *User) UpdateProfileAttributes(ctx context.Context, request operations.UpdateProfileAttributesRequest) (*operations.UpdateProfileAttributesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/profileAttributes"
...
//
// `customer` (`CustomerData`) attribute in `UserAccount` response model is deprecated. Please use response from `GET /user/account/customer` instead.
func (s *User) UpdateUserAccount(ctx context.Context, request operations.UpdateUserAccountRequest) (*operations.UpdateUserAccountResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account"
...
func (s *User) UploadAvatarAsMultipart(ctx context.Context, request operations.UploadAvatarAsMultipartRequest) (*operations.UploadAvatarAsMultipartResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v4/user/account/avatar"
