...
func (e ListFirewallPoliciesXAmzTargetEnum) ToPointer() *ListFirewallPoliciesXAmzTargetEnum {
	return &e
}
...
func (e *ListFirewallPoliciesXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "NetworkFirewall_20201112.ListFirewallPolicies":
		*e = ListFirewallPoliciesXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ListFirewallPoliciesXAmzTargetEnum: %v", v)
	}
}

type ListFirewallPoliciesRequest struct {
	ListFirewallPoliciesRequest shared.ListFirewallPoliciesRequest `request:"mediaType=application/json"`
	// Pagination limit
