...
class UpdateInteractionChannelParticipantRequest:
    ...
    r"""The unique string created by Twilio to identify an Interaction Channel resource."""  
    request_body: Optional[UpdateInteractionChannelParticipantUpdateInteractionChannelParticipantRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
