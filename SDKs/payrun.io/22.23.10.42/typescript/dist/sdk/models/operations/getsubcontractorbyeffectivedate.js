...
exports.GetSubContractorByEffectiveDateResponse = exports.GetSubContractorByEffectiveDateRequest = void 0;
...
var GetSubContractorByEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetSubContractorByEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetSubContractorByEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetSubContractorByEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetSubContractorByEffectiveDateRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SubContractorId",
        }),
        __metadata("design:type", String)
    ], GetSubContractorByEffectiveDateRequest.prototype, "subContractorId", void 0);
    return GetSubContractorByEffectiveDateRequest;
}(utils_1.SpeakeasyBase));
exports.GetSubContractorByEffectiveDateRequest = GetSubContractorByEffectiveDateRequest;
var GetSubContractorByEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetSubContractorByEffectiveDateResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
...
exports.GetSubContractorByEffectiveDateResponse = GetSubContractorByEffectiveDateResponse;
