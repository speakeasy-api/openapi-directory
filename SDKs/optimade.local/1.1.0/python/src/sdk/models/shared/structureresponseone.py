...
class StructureResponseOneJSONAPI:
    r"""StructureResponseOneJSONAPI
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseOneToplevelLinks:
    r"""StructureResponseOneToplevelLinks
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseOneResponseMetaImplementationImplementationMaintainer:
    r"""StructureResponseOneResponseMetaImplementationImplementationMaintainer
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseOneResponseMetaImplementation:
    r"""StructureResponseOneResponseMetaImplementation
    ...
    maintainer: Optional[StructureResponseOneResponseMetaImplementationImplementationMaintainer] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintainer') }})
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseOneResponseMetaProvider:
    r"""StructureResponseOneResponseMetaProvider
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseOneResponseMetaResponseMetaQuery:
    r"""StructureResponseOneResponseMetaResponseMetaQuery
...
@dataclass_json
@dataclasses.dataclass
class StructureResponseOneResponseMeta:
    r"""StructureResponseOneResponseMeta
    ...
    query: StructureResponseOneResponseMetaResponseMetaQuery = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('query') }})
    ...
    implementation: Optional[StructureResponseOneResponseMetaImplementation] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('implementation') }})
    last_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('last_id') }})
    provider: Optional[StructureResponseOneResponseMetaProvider] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('provider') }})
...
class StructureResponseOne:
    r"""StructureResponseOne
    errors are not allowed
    """
    
    data: Any = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    meta: StructureResponseOneResponseMeta = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    ...
    jsonapi: Optional[StructureResponseOneJSONAPI] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('jsonapi') }})
    links: Optional[StructureResponseOneToplevelLinks] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
