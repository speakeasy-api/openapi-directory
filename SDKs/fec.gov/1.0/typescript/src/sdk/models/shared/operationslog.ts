...
export class OperationsLog extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "candidate_committee_id" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "summary_data_complete_date" })
  @Transform(({ value }) => new Date(value), { toClassOnly: true })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "summary_data_verification_date" })
  @Transform(({ value }) => new Date(value), { toClassOnly: true })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "transaction_data_complete_date" })
  @Transform(({ value }) => new Date(value), { toClassOnly: true })
