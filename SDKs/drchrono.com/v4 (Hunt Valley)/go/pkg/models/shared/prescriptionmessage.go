...
func (e PrescriptionMessageMessageDirectionEnum) ToPointer() *PrescriptionMessageMessageDirectionEnum {
	return &e
}
...
func (e *PrescriptionMessageMessageDirectionEnum) UnmarshalJSON(data []byte) error {
	...
	case "I":
		fallthrough
	case "O":
		*e = PrescriptionMessageMessageDirectionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PrescriptionMessageMessageDirectionEnum: %v", v)
	}
}
