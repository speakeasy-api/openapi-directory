...
type IapProjectsIapTunnelLocationsDestGroupsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type IapProjectsIapTunnelLocationsDestGroupsGetPathParams struct {
...
type IapProjectsIapTunnelLocationsDestGroupsGetQueryParams struct {
	// V1 error format.
...
type IapProjectsIapTunnelLocationsDestGroupsGetRequest struct {
...
type IapProjectsIapTunnelLocationsDestGroupsGetResponse struct {
	ContentType string
	StatusCode  int
