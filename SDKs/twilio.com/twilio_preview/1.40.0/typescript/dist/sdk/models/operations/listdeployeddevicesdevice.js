...
exports.ListDeployedDevicesDeviceResponse = exports.ListDeployedDevicesDeviceListDeployedDevicesDeviceResponse = exports.ListDeployedDevicesDeviceListDeployedDevicesDeviceResponseMeta = exports.ListDeployedDevicesDeviceRequest = exports.ListDeployedDevicesDeviceSecurity = exports.ListDeployedDevicesDeviceServerList = void 0;
...
var ListDeployedDevicesDeviceSecurity = /** @class */ (function (_super) {
    ...
    ], ListDeployedDevicesDeviceSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListDeployedDevicesDeviceSecurity.prototype, "username", void 0);
...
var ListDeployedDevicesDeviceRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListDeployedDevicesDeviceRequest.prototype, "deploymentSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=FleetSid",
        }),
        __metadata("design:type", String)
    ], ListDeployedDevicesDeviceRequest.prototype, "fleetSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListDeployedDevicesDeviceRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListDeployedDevicesDeviceRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListDeployedDevicesDeviceRequest.prototype, "pageToken", void 0);
...
var ListDeployedDevicesDeviceListDeployedDevicesDeviceResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewDeployedDevicesFleetDevice }),
        (0, class_transformer_1.Expose)({ name: "devices" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewDeployedDevicesFleetDevice; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListDeployedDevicesDeviceListDeployedDevicesDeviceResponseMeta; }),
...
var ListDeployedDevicesDeviceResponse = /** @class */ (function (_super) {
    ...
    ], ListDeployedDevicesDeviceResponse.prototype, "rawResponse", void 0);
