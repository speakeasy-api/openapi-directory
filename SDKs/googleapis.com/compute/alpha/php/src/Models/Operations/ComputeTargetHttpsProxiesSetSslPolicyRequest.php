...
class ComputeTargetHttpsProxiesSetSslPolicyRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\SslPolicyReference $sslPolicyReference = null;
