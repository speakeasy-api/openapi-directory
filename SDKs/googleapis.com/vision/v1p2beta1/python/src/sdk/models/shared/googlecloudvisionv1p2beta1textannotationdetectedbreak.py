...
class GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreak:
    ...
    type: Optional[GoogleCloudVisionV1p2beta1TextAnnotationDetectedBreakTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
