...
class SpotSetTypeAnyTypeEnum(str, Enum):
    r"""Spot set type `any`; A wildcard that matches all type of items"""
    ANY = 'any'
...
class SpotSetTypeAny:
    ...
    type: Optional[SpotSetTypeAnyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Spot set type `any`; A wildcard that matches all type of items"""  
