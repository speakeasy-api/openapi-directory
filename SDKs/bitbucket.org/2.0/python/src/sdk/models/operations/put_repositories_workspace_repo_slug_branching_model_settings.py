...
class PutRepositoriesWorkspaceRepoSlugBranchingModelSettingsRequest:
    path_params: PutRepositoriesWorkspaceRepoSlugBranchingModelSettingsPathParams = dataclasses.field()
    security: PutRepositoriesWorkspaceRepoSlugBranchingModelSettingsSecurity = dataclasses.field()
