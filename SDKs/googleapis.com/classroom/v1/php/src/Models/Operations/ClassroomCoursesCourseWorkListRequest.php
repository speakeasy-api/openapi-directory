...
class ClassroomCoursesCourseWorkListRequest
{
     ...
     * 
     * @var ?array<\OpenAPI\OpenAPI\Models\Operations\ClassroomCoursesCourseWorkListCourseWorkStatesEnum> $courseWorkStates
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=courseWorkStates')]
    public ?array $courseWorkStates = null;
