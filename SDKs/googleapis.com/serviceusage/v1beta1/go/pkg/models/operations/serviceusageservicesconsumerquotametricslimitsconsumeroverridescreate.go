...
func (e *ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateForceOnlyEnum) UnmarshalJSON(data []byte) error {
	...
	case "LIMIT_DECREASE_PERCENTAGE_TOO_HIGH":
		*e = ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateForceOnlyEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for ServiceusageServicesConsumerQuotaMetricsLimitsConsumerOverridesCreateForceOnlyEnum: %s", s)
	}
}
