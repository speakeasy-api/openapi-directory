...
exports.GetRealmComponentsResponse = exports.GetRealmComponentsRequest = void 0;
...
var GetRealmComponentsRequest = /** @class */ (function (_super) {
    ...
    ], GetRealmComponentsRequest.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=parent",
        }),
        __metadata("design:type", String)
    ], GetRealmComponentsRequest.prototype, "parent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=realm",
        }),
        __metadata("design:type", String)
    ], GetRealmComponentsRequest.prototype, "realm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], GetRealmComponentsRequest.prototype, "type", void 0);
    return GetRealmComponentsRequest;
}(utils_1.SpeakeasyBase));
exports.GetRealmComponentsRequest = GetRealmComponentsRequest;
var GetRealmComponentsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.ComponentRepresentation }),
    ...
    ], GetRealmComponentsResponse.prototype, "rawResponse", void 0);
    return GetRealmComponentsResponse;
}(utils_1.SpeakeasyBase));
exports.GetRealmComponentsResponse = GetRealmComponentsResponse;
