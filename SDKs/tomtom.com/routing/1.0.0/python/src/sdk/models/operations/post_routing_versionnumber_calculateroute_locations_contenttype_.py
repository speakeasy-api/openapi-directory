...
from ..shared import calculateroutepostdataparameters as shared_calculateroutepostdataparameters
...
@dataclasses.dataclass
class PostRoutingVersionNumberCalculateRouteLocationsContentTypeQueryParams:
...
class PostRoutingVersionNumberCalculateRouteLocationsContentTypeRequests:
    ...
    calculate_route_post_data_parameters: Optional[shared_calculateroutepostdataparameters.CalculateRoutePostDataParameters] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PostRoutingVersionNumberCalculateRouteLocationsContentTypeRequest:
    path_params: PostRoutingVersionNumberCalculateRouteLocationsContentTypePathParams = dataclasses.field()
    query_params: PostRoutingVersionNumberCalculateRouteLocationsContentTypeQueryParams = dataclasses.field()
    request: Optional[PostRoutingVersionNumberCalculateRouteLocationsContentTypeRequests] = dataclasses.field(default=None)
