...
from ..shared import createpatientresponse as shared_createpatientresponse
...
class CreatePatientResponse:
    ...
    r"""Unauthorized"""  
    create_patient_response: Optional[shared_createpatientresponse.CreatePatientResponse] = dataclasses.field(default=None)
    r"""Created"""  
