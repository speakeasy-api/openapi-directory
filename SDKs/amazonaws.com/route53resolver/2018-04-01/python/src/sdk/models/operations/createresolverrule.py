...
class CreateResolverRuleRequest:
    ...
    create_resolver_rule_request: shared_createresolverrulerequest.CreateResolverRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
