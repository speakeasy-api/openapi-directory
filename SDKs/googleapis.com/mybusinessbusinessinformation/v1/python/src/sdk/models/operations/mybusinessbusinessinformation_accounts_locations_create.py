...
class MybusinessbusinessinformationAccountsLocationsCreateRequest:
    path_params: MybusinessbusinessinformationAccountsLocationsCreatePathParams = dataclasses.field()
    query_params: MybusinessbusinessinformationAccountsLocationsCreateQueryParams = dataclasses.field()
