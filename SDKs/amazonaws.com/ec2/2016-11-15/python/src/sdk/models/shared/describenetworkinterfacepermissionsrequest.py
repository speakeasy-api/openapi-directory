...
class DescribeNetworkInterfacePermissionsRequest:
    r"""Contains the parameters for DescribeNetworkInterfacePermissions."""
    
    filters: Optional[list[DescribeNetworkInterfacePermissionsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    network_interface_permission_ids: Optional[list[str]] = dataclasses.field(default=None)  
