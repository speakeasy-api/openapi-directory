...
exports.AggregateConformancePackCompliance = void 0;
...
var AggregateConformancePackCompliance = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CompliantRuleCount" }),
        __metadata("design:type", Number)
    ], AggregateConformancePackCompliance.prototype, "compliantRuleCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NonCompliantRuleCount" }),
        __metadata("design:type", Number)
    ], AggregateConformancePackCompliance.prototype, "nonCompliantRuleCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TotalRuleCount" }),
        __metadata("design:type", Number)
