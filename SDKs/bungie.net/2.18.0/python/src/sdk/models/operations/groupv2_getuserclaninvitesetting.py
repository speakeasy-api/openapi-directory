...
class GroupV2GetUserClanInviteSettingRequest:
    ...
    m_type: int = dataclasses.field(metadata={'path_param': { 'field_name': 'mType', 'style': 'simple', 'explode': False }})
    r"""The Destiny membership type of the account we wish to access settings."""  
    

@dataclasses.dataclass
class GroupV2GetUserClanInviteSetting200Wildcard:
