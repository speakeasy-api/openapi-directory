...
class Virtualization:
    ...
    def virtualization_interfaces_create(self, request: shared.WritableVirtualMachineInterfaceInput) -> operations.VirtualizationInterfacesCreateResponse:
        base_url = self._server_url
        ...
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.VirtualMachineInterface])
    ...
    def virtualization_interfaces_partial_update(self, request: operations.VirtualizationInterfacesPartialUpdateRequest) -> operations.VirtualizationInterfacesPartialUpdateResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "writable_virtual_machine_interface_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
    ...
    def virtualization_virtual_machines_create(self, request: shared.WritableVirtualMachineWithConfigContextInput) -> operations.VirtualizationVirtualMachinesCreateResponse:
        base_url = self._server_url
    ...
    def virtualization_virtual_machines_partial_update(self, request: operations.VirtualizationVirtualMachinesPartialUpdateRequest) -> operations.VirtualizationVirtualMachinesPartialUpdateResponse:
        ...
        headers = {}
        req_content_type, data, form = utils.serialize_request_body(request, "writable_virtual_machine_with_config_context_input", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
