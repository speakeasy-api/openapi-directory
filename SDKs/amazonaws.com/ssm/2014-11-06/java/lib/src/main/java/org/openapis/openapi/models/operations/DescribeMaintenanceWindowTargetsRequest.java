...
public class DescribeMaintenanceWindowTargetsRequest {
    ...
    public DescribeMaintenanceWindowTargetsRequest(@JsonProperty("DescribeMaintenanceWindowTargetsRequest") org.openapis.openapi.models.shared.DescribeMaintenanceWindowTargetsRequest describeMaintenanceWindowTargetsRequest, @JsonProperty("X-Amz-Target") DescribeMaintenanceWindowTargetsXAmzTargetEnum xAmzTarget) {
        this.describeMaintenanceWindowTargetsRequest = describeMaintenanceWindowTargetsRequest;
        this.xAmzTarget = xAmzTarget;
  }
}
