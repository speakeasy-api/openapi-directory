...
export enum BatchGetPreparedStatementXAmzTargetEnum {
  AmazonAthenaBatchGetPreparedStatement = "AmazonAthena.BatchGetPreparedStatement",
}

export class BatchGetPreparedStatementRequest extends SpeakeasyBase {
...
export class BatchGetPreparedStatementResponse extends SpeakeasyBase {
  /**
   * Success
   */
  @SpeakeasyMetadata()
