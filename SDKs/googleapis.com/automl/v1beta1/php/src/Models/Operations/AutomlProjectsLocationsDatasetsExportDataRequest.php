...
class AutomlProjectsLocationsDatasetsExportDataRequest
{
    /**
     * V1 error format.
     * 
    ...
    public ?\OpenAPI\OpenAPI\Models\Shared\ExportDataRequest $exportDataRequest = null;
