...
exports.SearchEditorialResponse = exports.SearchEditorialRequest = exports.SearchEditorialSortEnum = exports.SearchEditorialSecurity = void 0;
...
var SearchEditorialRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SearchEditorialRequest.prototype, "category", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=country",
        }),
        __metadata("design:type", String)
    ], SearchEditorialRequest.prototype, "country", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cursor",
        }),
        __metadata("design:type", String)
    ], SearchEditorialRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=date_end;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], SearchEditorialRequest.prototype, "dateEnd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=date_start;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], SearchEditorialRequest.prototype, "dateStart", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], SearchEditorialRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=query" }),
        __metadata("design:type", String)
    ], SearchEditorialRequest.prototype, "query", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], SearchEditorialRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=supplier_code",
        }),
        __metadata("design:type", Array)
    ], SearchEditorialRequest.prototype, "supplierCode", void 0);
...
var SearchEditorialResponse = /** @class */ (function (_super) {
    ...
    ], SearchEditorialResponse.prototype, "rawResponse", void 0);
