...
var LiaCountrySettings = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return liaaboutpagesettings_1.LiaAboutPageSettings; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "hostedLocalStorefrontActive" }),
        __metadata("design:type", Boolean)
    ], LiaCountrySettings.prototype, "hostedLocalStorefrontActive", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "inventory" }),
        (0, class_transformer_1.Type)(function () { return liainventorysettings_1.LiaInventorySettings; }),
        __metadata("design:type", liainventorysettings_1.LiaInventorySettings)
    ], LiaCountrySettings.prototype, "inventory", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "onDisplayToOrder" }),
        (0, class_transformer_1.Type)(function () { return liaondisplaytoordersettings_1.LiaOnDisplayToOrderSettings; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "posDataProvider" }),
        (0, class_transformer_1.Type)(function () { return liaposdataprovider_1.LiaPosDataProvider; }),
        __metadata("design:type", liaposdataprovider_1.LiaPosDataProvider)
    ], LiaCountrySettings.prototype, "posDataProvider", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "storePickupActive" }),
        __metadata("design:type", Boolean)
