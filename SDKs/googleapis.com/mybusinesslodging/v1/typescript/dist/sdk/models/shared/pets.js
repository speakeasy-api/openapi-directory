...
var Pets = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "catsAllowed" }),
        __metadata("design:type", Boolean)
    ], Pets.prototype, "catsAllowed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "catsAllowedException" }),
        __metadata("design:type", String)
    ], Pets.prototype, "catsAllowedException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "dogsAllowed" }),
        __metadata("design:type", Boolean)
    ], Pets.prototype, "dogsAllowed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "dogsAllowedException" }),
        __metadata("design:type", String)
    ], Pets.prototype, "dogsAllowedException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "petsAllowed" }),
        __metadata("design:type", Boolean)
    ], Pets.prototype, "petsAllowed", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "petsAllowedException" }),
        __metadata("design:type", String)
    ], Pets.prototype, "petsAllowedException", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "petsAllowedFree" }),
        __metadata("design:type", Boolean)
    ], Pets.prototype, "petsAllowedFree", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "petsAllowedFreeException" }),
        __metadata("design:type", String)
