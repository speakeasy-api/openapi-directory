...
try {
    ...
    $request->certificateParameters->applNo = 'A18xxxxxx';
    $request->certificateParameters->dob = '01-01-2001';
    $request->certificateParameters->fullName = 'Ashish Ranjan';
    $request->certificateParameters->session = '2018 - 2019';
