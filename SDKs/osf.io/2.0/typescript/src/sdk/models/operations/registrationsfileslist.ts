 ...
 */
export class RegistrationsFilesListFileAttributes extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsFilesListFileLinks extends SpeakeasyBase {
  /**
 ...
 */
export class RegistrationsFilesListFileRelationships extends SpeakeasyBase {
  /**
...
export class RegistrationsFilesListFile extends SpeakeasyBase {
  /**
   * The properties of the file entity.
   */
  @SpeakeasyMetadata()
