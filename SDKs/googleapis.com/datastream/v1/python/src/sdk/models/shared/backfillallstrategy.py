...
class BackfillAllStrategy:
    ...
    postgresql_excluded_objects: Optional[shared_postgresqlrdbms.PostgresqlRdbms] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('postgresqlExcludedObjects') }})
