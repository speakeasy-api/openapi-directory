...
class PostAuthObtain200ApplicationJSON:
...
@dataclass_json
@dataclasses.dataclass
class PostAuthObtain400ApplicationJSON:
...
@dataclass_json
@dataclasses.dataclass
class PostAuthObtain500ApplicationJSON:
    detail: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('detail') }})
    

@dataclasses.dataclass
class PostAuthObtainRequest:
    request: shared_login.Login = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    

@dataclasses.dataclass
class PostAuthObtainResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    post_auth_obtain_200_application_json_object: Optional[PostAuthObtain200ApplicationJSON] = dataclasses.field(default=None)
    post_auth_obtain_400_application_json_object: Optional[PostAuthObtain400ApplicationJSON] = dataclasses.field(default=None)
    post_auth_obtain_500_application_json_object: Optional[PostAuthObtain500ApplicationJSON] = dataclasses.field(default=None)
