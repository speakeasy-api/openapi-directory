...
class Error409NgPiis:
    ...
    tpp_messages: Optional[list[shared_tppmessage409_piis.TppMessage409Piis]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
