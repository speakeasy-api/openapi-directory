...
class VaultMattersHoldsAddHeldAccountsRequest:
    ...
    add_held_accounts_request: Optional[shared_addheldaccountsrequest.AddHeldAccountsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
