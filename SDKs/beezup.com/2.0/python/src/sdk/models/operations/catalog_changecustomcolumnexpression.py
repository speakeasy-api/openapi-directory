...
class CatalogChangeCustomColumnExpressionRequest:
    ...
    change_custom_column_expression_request: shared_changecustomcolumnexpressionrequest.ChangeCustomColumnExpressionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class CatalogChangeCustomColumnExpressionResponse:
    ...
    r"""Occurs when the user try to change a custom column related to a Category. If you want to change this custom column expression you have to make a new manual importation."""  
