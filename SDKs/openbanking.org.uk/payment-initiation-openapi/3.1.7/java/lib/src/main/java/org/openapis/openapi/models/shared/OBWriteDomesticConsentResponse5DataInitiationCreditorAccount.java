...
public class OBWriteDomesticConsentResponse5DataInitiationCreditorAccount {
    ...
    public OBWriteDomesticConsentResponse5DataInitiationCreditorAccount(@JsonProperty("Identification") String identification, @JsonProperty("Name") String name, @JsonProperty("SchemeName") String schemeName) {
        this.identification = identification;
        this.name = name;
        this.schemeName = schemeName;
  }
