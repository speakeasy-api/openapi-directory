...
class DeleteTemplate200ApplicationJSON:
    response: Optional[DeleteTemplate200ApplicationJSONResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('response') }})
...
class DeleteTemplate401ApplicationJSON:
    error: Optional[DeleteTemplate401ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
...
class DeleteTemplate403ApplicationJSON:
    error: Optional[DeleteTemplate403ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    status: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class DeleteTemplate404ApplicationJSON:
    error: Optional[DeleteTemplate404ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    status: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class DeleteTemplate422ApplicationJSON:
    error: Optional[DeleteTemplate422ApplicationJSONErrorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    status: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class DeleteTemplateRequest:
    query_params: DeleteTemplateQueryParams = dataclasses.field()
...
class DeleteTemplateResponse:
    ...
    delete_template_200_application_json_object: Optional[DeleteTemplate200ApplicationJSON] = dataclasses.field(default=None)
    delete_template_401_application_json_object: Optional[DeleteTemplate401ApplicationJSON] = dataclasses.field(default=None)
    delete_template_403_application_json_object: Optional[DeleteTemplate403ApplicationJSON] = dataclasses.field(default=None)
    delete_template_404_application_json_object: Optional[DeleteTemplate404ApplicationJSON] = dataclasses.field(default=None)
    delete_template_422_application_json_object: Optional[DeleteTemplate422ApplicationJSON] = dataclasses.field(default=None)
    delete_template_500_application_json_object: Optional[DeleteTemplate500ApplicationJSON] = dataclasses.field(default=None)
