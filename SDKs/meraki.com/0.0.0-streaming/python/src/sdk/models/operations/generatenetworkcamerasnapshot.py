...
class GenerateNetworkCameraSnapshotRequest:
    ...
    request_body: Optional[GenerateNetworkCameraSnapshotRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class GenerateNetworkCameraSnapshotResponse:
    ...
    generate_network_camera_snapshot_202_application_json_object: Optional[dict[str, Any]] = dataclasses.field(default=None)
