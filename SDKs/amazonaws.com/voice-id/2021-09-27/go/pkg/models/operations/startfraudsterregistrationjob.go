...
func (e *StartFraudsterRegistrationJobXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "VoiceID.StartFraudsterRegistrationJob":
		*e = StartFraudsterRegistrationJobXAmzTargetEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for StartFraudsterRegistrationJobXAmzTargetEnum: %s", s)
	}
}

type StartFraudsterRegistrationJobHeaders struct {
...
type StartFraudsterRegistrationJobRequest struct {
	Headers StartFraudsterRegistrationJobHeaders
	Request shared.StartFraudsterRegistrationJobRequest `request:"mediaType=application/json"`
}
