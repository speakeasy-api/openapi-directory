...
public class GetV2TeamTemplatesJsonQueryParams {
    /**
    ...
    public String[] ids;
    public GetV2TeamTemplatesJsonQueryParams withIds(String[] ids) {
        this.ids = ids;
        return this;
    }
    ...
    public GetV2TeamTemplatesJsonQueryParams withIncludeArchivedTemplates(Boolean includeArchivedTemplates) {
    ...
    public GetV2TeamTemplatesJsonQueryParams withIncludePagingCounts(Boolean includePagingCounts) {
    ...
    public GetV2TeamTemplatesJsonQueryParams withLimitPagingCounts(Boolean limitPagingCounts) {
    ...
    public Long page;
    public GetV2TeamTemplatesJsonQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetV2TeamTemplatesJsonQueryParams withPerPage(Long perPage) {
    ...
    public GetV2TeamTemplatesJsonQueryParams withSearch(String search) {
        this.search = search;
        return this;
    }
    ...
    public GetV2TeamTemplatesJsonQueryParams withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetV2TeamTemplatesJsonQueryParams withSortDirection(String sortDirection) {
    ...
    public String[] tag;
    public GetV2TeamTemplatesJsonQueryParams withTag(String[] tag) {
        this.tag = tag;
        return this;
    }
    ...
    public Long[] tagIds;
    public GetV2TeamTemplatesJsonQueryParams withTagIds(Long[] tagIds) {
        this.tagIds = tagIds;
        return this;
    }
    ...
    public GetV2TeamTemplatesJsonQueryParams withUpdatedAt(String[] updatedAt) {
