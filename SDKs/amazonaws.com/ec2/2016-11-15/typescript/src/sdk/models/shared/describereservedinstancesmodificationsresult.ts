 ...
 */
export enum DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfigurationInstanceTypeEnum {
  A1Medium = "a1.medium",
  A1Large = "a1.large",
  A1Xlarge = "a1.xlarge",
 ...
 */
export enum DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfigurationScopeEnum {
 ...
 */
export class DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResultsTargetConfiguration extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResults extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 */
export class DescribeReservedInstancesModificationsResultReservedInstancesModificationsReservedInstancesIds extends SpeakeasyBase {
  @SpeakeasyMetadata()
  reservedInstancesId?: string;
}
 ...
 */
export class DescribeReservedInstancesModificationsResultReservedInstancesModifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken?: string;
  ...
  @SpeakeasyMetadata({
    elemType:
      DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResults,
  })
  modificationResults?: DescribeReservedInstancesModificationsResultReservedInstancesModificationsModificationResults[];

  @SpeakeasyMetadata({
    elemType:
      DescribeReservedInstancesModificationsResultReservedInstancesModificationsReservedInstancesIds,
  })
...
export class DescribeReservedInstancesModificationsResult extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({
    elemType:
      DescribeReservedInstancesModificationsResultReservedInstancesModifications,
  })
