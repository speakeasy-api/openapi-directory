...
from ..shared import notebookinstancelifecycleconfigsortkey_enum as shared_notebookinstancelifecycleconfigsortkey_enum
from ..shared import notebookinstancelifecycleconfigsortorder_enum as shared_notebookinstancelifecycleconfigsortorder_enum
...
class ListNotebookInstanceLifecycleConfigsInput:
    ...
    sort_by: Optional[shared_notebookinstancelifecycleconfigsortkey_enum.NotebookInstanceLifecycleConfigSortKeyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    sort_order: Optional[shared_notebookinstancelifecycleconfigsortorder_enum.NotebookInstanceLifecycleConfigSortOrderEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortOrder'), 'exclude': lambda f: f is None }})  
