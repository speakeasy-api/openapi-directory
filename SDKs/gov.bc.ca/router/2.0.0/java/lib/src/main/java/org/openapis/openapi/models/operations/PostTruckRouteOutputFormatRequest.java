...
public class PostTruckRouteOutputFormatRequest {
    ...
    public PostTruckRouteOutputFormatRequest withCorrectSide(Boolean correctSide) {
    ...
    public PostTruckRouteOutputFormatRequest withCriteria(PostTruckRouteOutputFormatCriteriaEnum criteria) {
    ...
    public PostTruckRouteOutputFormatRequest withDeparture(OffsetDateTime departure) {
    ...
    public PostTruckRouteOutputFormatRequest withDisable(String disable) {
    ...
    public PostTruckRouteOutputFormatRequest withDistanceUnit(PostTruckRouteOutputFormatDistanceUnitEnum distanceUnit) {
    ...
    public PostTruckRouteOutputFormatRequest withOutputFormat(PostTruckRouteOutputFormatOutputFormatEnum outputFormat) {
    ...
    public PostTruckRouteOutputFormatOutputSrsEnum outputSRS;

    public PostTruckRouteOutputFormatRequest withOutputSRS(PostTruckRouteOutputFormatOutputSrsEnum outputSRS) {
    ...
    public PostTruckRouteOutputFormatRequest withPartition(String partition) {
    ...
    public PostTruckRouteOutputFormatRequest withPoints(String points) {
        this.points = points;
        return this;
    }
    ...
    public PostTruckRouteOutputFormatRequest withRoundTrip(Boolean roundTrip) {
    ...
    public PostTruckRouteOutputFormatRequest withRouteDescription(String routeDescription) {
    ...
    public PostTruckRouteOutputFormatRequest withTruckRouteMultiplier(Long truckRouteMultiplier) {
        this.truckRouteMultiplier = truckRouteMultiplier;
        return this;
    }
    
    public PostTruckRouteOutputFormatRequest(@JsonProperty("outputFormat") PostTruckRouteOutputFormatOutputFormatEnum outputFormat, @JsonProperty("points") String points) {
        this.outputFormat = outputFormat;
        this.points = points;
  }
}
