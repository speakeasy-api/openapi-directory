...
import { DiskTypesScopedList } from "./disktypesscopedlist";
/**
 * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
 */
export declare enum DiskTypeAggregatedListWarningCodeEnum {
...
export declare class DiskTypeAggregatedListWarningData extends SpeakeasyBase {
    /**
 ...
 */
export declare class DiskTypeAggregatedListWarning extends SpeakeasyBase {
    /**
     * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
     */
    code?: DiskTypeAggregatedListWarningCodeEnum;
    /**
     * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
     */
    data?: DiskTypeAggregatedListWarningData[];
    /**
 ...
 * Successful response
 */
export declare class DiskTypeAggregatedList extends SpeakeasyBase {
    /**
