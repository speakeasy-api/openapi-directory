...
from ..shared import ipampoolawsservice_enum as shared_ipampoolawsservice_enum
from ..shared import ipampoolpublicipsource_enum as shared_ipampoolpublicipsource_enum
...
class CreateIpamPoolRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateIpamPoolRequestTagSpecifications:
    ...
    resource_type: Optional[CreateIpamPoolRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateIpamPoolRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
    

@dataclasses.dataclass
class CreateIpamPoolRequest:
    
    address_family: shared_addressfamily_enum.AddressFamilyEnum = dataclasses.field()  
    ...
    allocation_resource_tags: Optional[list[CreateIpamPoolRequestAllocationResourceTags]] = dataclasses.field(default=None)  
    auto_import: Optional[bool] = dataclasses.field(default=None)  
    aws_service: Optional[shared_ipampoolawsservice_enum.IpamPoolAwsServiceEnum] = dataclasses.field(default=None)  
    ...
    public_ip_source: Optional[shared_ipampoolpublicipsource_enum.IpamPoolPublicIPSourceEnum] = dataclasses.field(default=None)  
    ...
    tag_specifications: Optional[list[CreateIpamPoolRequestTagSpecifications]] = dataclasses.field(default=None)  
