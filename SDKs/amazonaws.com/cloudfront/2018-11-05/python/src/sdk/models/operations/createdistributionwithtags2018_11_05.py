...
class CreateDistributionWithTags20181105RequestBodyDistributionConfigWithTags:
...
class CreateDistributionWithTags20181105RequestBody:
    ...
    distribution_config_with_tags: CreateDistributionWithTags20181105RequestBodyDistributionConfigWithTags = dataclasses.field()
    r"""A distribution Configuration and a list of tags to be associated with the distribution."""  
    
class CreateDistributionWithTags20181105WithTagsEnum(str, Enum):
    TRUE = 'true'
...
class CreateDistributionWithTags20181105Request:
    ...
    with_tags: CreateDistributionWithTags20181105WithTagsEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'WithTags', 'style': 'form', 'explode': True }})  
