...
public class ListInsightsQuestionnairesQuestionRequest {
     ...
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=CategorySid")
    public String[] categorySid;

    public ListInsightsQuestionnairesQuestionRequest withCategorySid(String[] categorySid) {
    ...
    public ListInsightsQuestionnairesQuestionRequest(){}
}
