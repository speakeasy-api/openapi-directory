...
class OsloginUsersSshPublicKeysDeleteRequest
{
    /**
     * V1 error format.
     * 
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\OsloginUsersSshPublicKeysDeleteOperatingSystemTypeEnum $operatingSystemType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=operatingSystemType')]
    public ?OsloginUsersSshPublicKeysDeleteOperatingSystemTypeEnum $operatingSystemType = null;
