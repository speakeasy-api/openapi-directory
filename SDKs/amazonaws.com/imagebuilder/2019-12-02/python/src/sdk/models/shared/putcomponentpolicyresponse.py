...
class PutComponentPolicyResponse:
    ...
    component_arn: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('componentArn'), 'exclude': lambda f: f is None }})  
