...
from ..shared import enduserrouteembeddedobject as shared_enduserrouteembeddedobject
...
class EndUserRouteHalResponse:
    embedded: Optional[shared_enduserrouteembeddedobject.EndUserRouteEmbeddedObject] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_embedded') }})
