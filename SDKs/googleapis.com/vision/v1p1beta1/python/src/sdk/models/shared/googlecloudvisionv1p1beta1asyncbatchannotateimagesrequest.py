...
class GoogleCloudVisionV1p1beta1AsyncBatchAnnotateImagesRequest:
    ...
    requests: Optional[list[shared_googlecloudvisionv1p1beta1annotateimagerequest.GoogleCloudVisionV1p1beta1AnnotateImageRequest]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requests'), 'exclude': lambda f: f is None }})
