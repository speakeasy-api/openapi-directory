...
public class GetDealersHeavyEquipmentRequest {
    /**
     * The API Authentication Key. Mandatory with all API calls.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=api_key")
    public String apiKey;
    public GetDealersHeavyEquipmentRequest withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public String city;
    public GetDealersHeavyEquipmentRequest withCity(String city) {
        this.city = city;
        return this;
    }
    ...
    public GetDealersHeavyEquipmentRequest withCountry(org.openapis.openapi.models.shared.NonDefaultCountryEnum country) {
    ...
    public GetDealersHeavyEquipmentRequest withDealerType(org.openapis.openapi.models.shared.DealerTypeEnum dealerType) {
    ...
    public GetDealersHeavyEquipmentRequest withFacets(String facets) {
        this.facets = facets;
        return this;
    }
    ...
    public GetDealersHeavyEquipmentRequest withInventoryUrl(String inventoryUrl) {
    ...
    public GetDealersHeavyEquipmentRequest withLatitude(Double latitude) {
    ...
    public GetDealersHeavyEquipmentRequest withListingCountRange(String listingCountRange) {
    ...
    public GetDealersHeavyEquipmentRequest withLongitude(Double longitude) {
    ...
    public GetDealersHeavyEquipmentRequest withProvider(Boolean provider) {
    ...
    public GetDealersHeavyEquipmentRequest withRadius(Integer radius) {
        this.radius = radius;
        return this;
    }
    ...
    public GetDealersHeavyEquipmentRequest withRangeFacets(String rangeFacets) {
    ...
    public Integer rows;
    public GetDealersHeavyEquipmentRequest withRows(Integer rows) {
        this.rows = rows;
        return this;
    }
    ...
    public GetDealersHeavyEquipmentRequest withSortBy(String sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public GetDealersHeavyEquipmentRequest withSortOrder(org.openapis.openapi.models.shared.SortOrderEnum sortOrder) {
    ...
    public GetDealersHeavyEquipmentRequest withStart(Integer start) {
        this.start = start;
        return this;
    }
    ...
    public String state;
    public GetDealersHeavyEquipmentRequest withState(String state) {
        this.state = state;
        return this;
    }
    ...
    public String zip;
    public GetDealersHeavyEquipmentRequest withZip(String zip) {
        this.zip = zip;
        return this;
    }
