...
from ..shared import itvupdatepaymentstrongrequest as shared_itvupdatepaymentstrongrequest
...
class UpdatePaymentMethodStrongRequest:
    ...
    itv_update_payment_strong_request: shared_itvupdatepaymentstrongrequest.ItvUpdatePaymentStrongRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
