...
public class GoogleCloudRetailV2SearchRequestFacetSpec {
    ...
    @JsonProperty("enableDynamicPosition")
    public Boolean enableDynamicPosition;
    public GoogleCloudRetailV2SearchRequestFacetSpec withEnableDynamicPosition(Boolean enableDynamicPosition) {
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("excludedFilterKeys")
    public String[] excludedFilterKeys;
    public GoogleCloudRetailV2SearchRequestFacetSpec withExcludedFilterKeys(String[] excludedFilterKeys) {
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpecFacetKey facetKey;
    public GoogleCloudRetailV2SearchRequestFacetSpec withFacetKey(GoogleCloudRetailV2SearchRequestFacetSpecFacetKey facetKey) {
    ...
    public GoogleCloudRetailV2SearchRequestFacetSpec withLimit(Integer limit) {
        this.limit = limit;
        return this;
    }
