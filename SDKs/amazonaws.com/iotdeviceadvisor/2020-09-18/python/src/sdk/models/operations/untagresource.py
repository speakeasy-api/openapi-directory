...
class UntagResourceRequest:
    ...
    r"""The resource ARN of an IoT Device Advisor resource. This can be SuiteDefinition ARN or SuiteRun ARN."""  
    tag_keys: list[str] = dataclasses.field(metadata={'query_param': { 'field_name': 'tagKeys', 'style': 'form', 'explode': True }})
    r"""List of tag keys to remove from the IoT Device Advisor resource."""  
