...
const (
	UntagResourceXAmzTargetEnumAmazonPersonalizeUntagResource UntagResourceXAmzTargetEnum = "AmazonPersonalize.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AmazonPersonalize.UntagResource":
