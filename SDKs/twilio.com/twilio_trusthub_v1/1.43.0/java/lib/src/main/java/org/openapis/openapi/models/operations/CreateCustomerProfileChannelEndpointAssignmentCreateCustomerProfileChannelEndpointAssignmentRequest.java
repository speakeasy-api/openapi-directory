...
public class CreateCustomerProfileChannelEndpointAssignmentCreateCustomerProfileChannelEndpointAssignmentRequest {
    ...
    public CreateCustomerProfileChannelEndpointAssignmentCreateCustomerProfileChannelEndpointAssignmentRequest(@JsonProperty("ChannelEndpointSid") String channelEndpointSid, @JsonProperty("ChannelEndpointType") String channelEndpointType) {
        this.channelEndpointSid = channelEndpointSid;
        this.channelEndpointType = channelEndpointType;
  }
}
