...
class StartTaskInformationStateEnum(str, Enum):
    r"""The state of the start task on the compute node."""
    RUNNING = 'running'
    COMPLETED = 'completed'
...
class StartTaskInformation:
    ...
    r"""The time at which the start task started running."""  
    ...
    r"""The time at which the start task stopped running."""  
    ...
    r"""The exit code of the start task."""  
