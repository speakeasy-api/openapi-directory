...
@dataclasses.dataclass
class SiteVerificationWebResourceGetQueryParams:
...
class SiteVerificationWebResourceGetRequest:
    path_params: SiteVerificationWebResourceGetPathParams = dataclasses.field()
    query_params: SiteVerificationWebResourceGetQueryParams = dataclasses.field()
    security: SiteVerificationWebResourceGetSecurity = dataclasses.field()
