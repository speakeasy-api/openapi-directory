...
from ..shared import proxycreateusage as shared_proxycreateusage
...
class ObjectPOSTUsageRequest:
    ...
    proxy_create_usage: shared_proxycreateusage.ProxyCreateUsage = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
