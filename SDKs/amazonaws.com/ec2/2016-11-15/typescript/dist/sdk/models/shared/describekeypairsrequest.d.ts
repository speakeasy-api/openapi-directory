 ...
 */
export declare class DescribeKeyPairsRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeKeyPairsRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeKeyPairsRequestFilters[];
