...
class LoggingConfiguration:
    ...
    log_destination_configs: list[str] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('LogDestinationConfigs') }})  
    resource_arn: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ResourceArn') }})  
    redacted_fields: Optional[list[shared_fieldtomatch.FieldToMatch]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('RedactedFields'), 'exclude': lambda f: f is None }})  
