...
from ..shared import updateassetresponse as shared_updateassetresponse
...
class UpdateAssetRequest:
    headers: UpdateAssetHeaders = dataclasses.field()
    path_params: UpdateAssetPathParams = dataclasses.field()
    request: UpdateAssetRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateAssetResponse:
    ...
    update_asset_response: Optional[shared_updateassetresponse.UpdateAssetResponse] = dataclasses.field(default=None)
