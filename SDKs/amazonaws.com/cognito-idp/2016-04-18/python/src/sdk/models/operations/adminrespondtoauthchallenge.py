...
class AdminRespondToAuthChallengeRequest:
    headers: AdminRespondToAuthChallengeHeaders = dataclasses.field()
    request: shared_adminrespondtoauthchallengerequest.AdminRespondToAuthChallengeRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
