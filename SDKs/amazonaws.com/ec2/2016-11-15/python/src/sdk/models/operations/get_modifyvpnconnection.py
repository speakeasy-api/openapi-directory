...
class GETModifyVpnConnectionRequest:
    ...
    r"""The ID of the customer gateway at your end of the VPN connection."""  
    ...
    r"""The ID of the virtual private gateway at the Amazon Web Services side of the VPN connection."""  
