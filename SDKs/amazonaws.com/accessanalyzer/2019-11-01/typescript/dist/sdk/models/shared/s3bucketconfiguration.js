...
var S3BucketConfiguration = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: s3accesspointconfiguration_1.S3AccessPointConfiguration }),
        (0, class_transformer_1.Expose)({ name: "accessPoints" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], s3accesspointconfiguration_1.S3AccessPointConfiguration);
            }
            return obj;
        }, { toClassOnly: true }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: s3bucketaclgrantconfiguration_1.S3BucketAclGrantConfiguration }),
        (0, class_transformer_1.Expose)({ name: "bucketAclGrants" }),
        (0, class_transformer_1.Type)(function () { return s3bucketaclgrantconfiguration_1.S3BucketAclGrantConfiguration; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "bucketPublicAccessBlock" }),
