...
export class Operations {
  ...
  **/
  sqlOperationsGet(
    ...
    const url: string = utils.generateURL(baseURL, "/v1/projects/{project}/operations/{operation}", req.pathParams);
  ...
  **/
  sqlOperationsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/projects/{project}/operations", req.pathParams);
