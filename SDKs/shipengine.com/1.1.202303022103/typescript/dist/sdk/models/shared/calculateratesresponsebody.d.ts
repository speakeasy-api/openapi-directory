 ...
 */
export declare enum CalculateRatesResponseBodyDeliveryConfirmationEnum {
    None = "none",
    Delivery = "delivery",
    Signature = "signature",
 ...
 */
export declare enum CalculateRatesResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export declare enum CalculateRatesResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
...
export declare class CalculateRatesResponseBodyInternationalShipmentOptions extends SpeakeasyBase {
     ...
     */
    contents: CalculateRatesResponseBodyInternationalShipmentOptionsPackageContentsEnum;
    /**
     ...
     */
    nonDelivery: CalculateRatesResponseBodyInternationalShipmentOptionsNonDeliveryEnum;
}
/**
 * The possible insurance provider values
 */
export declare enum CalculateRatesResponseBodyInsuranceProviderEnum {
    None = "none",
 ...
 */
export declare enum CalculateRatesResponseBodyOriginTypeEnum {
    Pickup = "pickup",
    DropOff = "drop_off"
}
/**
 ...
 */
export declare enum CalculateRatesResponseBodyShipmentStatusEnum {
    Pending = "pending",
...
export declare class CalculateRatesResponseBody extends SpeakeasyBase {
     ...
     */
    confirmation: CalculateRatesResponseBodyDeliveryConfirmationEnum;
    /**
     ...
     *
     */
    insuranceProvider: CalculateRatesResponseBodyInsuranceProviderEnum;
    /**
     ...
     * Indicates if the package will be picked up or dropped off by the carrier
     */
    originType?: CalculateRatesResponseBodyOriginTypeEnum;
    /**
     ...
     */
    shipmentStatus: CalculateRatesResponseBodyShipmentStatusEnum;
    /**
