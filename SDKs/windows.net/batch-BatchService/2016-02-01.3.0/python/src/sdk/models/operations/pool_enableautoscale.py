...
from ..shared import poolenableautoscaleparameter as shared_poolenableautoscaleparameter
...
class PoolEnableAutoScaleRequest:
    ...
    pool_enable_auto_scale_parameter: shared_poolenableautoscaleparameter.PoolEnableAutoScaleParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    ...
    r"""The id of the pool on which to enable automatic scaling."""  
