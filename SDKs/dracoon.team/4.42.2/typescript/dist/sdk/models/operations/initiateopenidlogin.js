...
exports.InitiateOpenIdLoginResponse = exports.InitiateOpenIdLoginRequest = void 0;
...
var InitiateOpenIdLoginRequest = /** @class */ (function (_super) {
    ...
    ], InitiateOpenIdLoginRequest.prototype, "issuer", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=language",
        }),
        __metadata("design:type", String)
    ], InitiateOpenIdLoginRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=redirect_uri",
        }),
        __metadata("design:type", String)
    ], InitiateOpenIdLoginRequest.prototype, "redirectUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=test" }),
        __metadata("design:type", Boolean)
    ], InitiateOpenIdLoginRequest.prototype, "test", void 0);
    return InitiateOpenIdLoginRequest;
}(utils_1.SpeakeasyBase));
exports.InitiateOpenIdLoginRequest = InitiateOpenIdLoginRequest;
var InitiateOpenIdLoginResponse = /** @class */ (function (_super) {
    ...
    ], InitiateOpenIdLoginResponse.prototype, "rawResponse", void 0);
    return InitiateOpenIdLoginResponse;
}(utils_1.SpeakeasyBase));
exports.InitiateOpenIdLoginResponse = InitiateOpenIdLoginResponse;
