...
public class Schemas {
    ...
    **/
    public openapisdk.models.operations.GetSchemaResponse getSchema(openapisdk.models.operations.GetSchemaRequest request) throws Exception {
        ...
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/Schemas/{DtoDataType}", request.pathParams);
    ...
    **/
    public openapisdk.models.operations.GetSchemasResponse getSchemas(openapisdk.models.operations.GetSchemasRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/Schemas");
        ...
        openapisdk.models.operations.GetSchemasResponse res = new openapisdk.models.operations.GetSchemasResponse() {{
            linkCollection = null;
            errorModel = null;
            errorModel = null;
            errorModel = null;
