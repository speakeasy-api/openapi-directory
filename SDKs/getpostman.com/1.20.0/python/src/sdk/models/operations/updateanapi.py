...
class UpdateAnAPIRequestBody:
    ...
    api: Optional[UpdateAnAPIRequestBodyAPI] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('api'), 'exclude': lambda f: f is None }})  
...
class UpdateAnAPIRequest:
    ...
    request_body: Optional[UpdateAnAPIRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
...
class UpdateAnAPI200ApplicationJSON:
    ...
    api: Optional[UpdateAnAPI200ApplicationJSONAPI] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('api'), 'exclude': lambda f: f is None }})  
