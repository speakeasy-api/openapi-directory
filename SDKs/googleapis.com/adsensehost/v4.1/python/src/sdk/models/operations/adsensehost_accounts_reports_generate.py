...
class AdsensehostAccountsReportsGenerateRequest:
    path_params: AdsensehostAccountsReportsGeneratePathParams = dataclasses.field()
    query_params: AdsensehostAccountsReportsGenerateQueryParams = dataclasses.field()
    security: AdsensehostAccountsReportsGenerateSecurity = dataclasses.field()
