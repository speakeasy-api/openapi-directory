...
@dataclasses.dataclass
class GetDraftRegistrationsDraftIDDraftRegistrationAttributes:
    ...
    node_license: Optional[GetDraftRegistrationsDraftIDDraftRegistrationAttributesNodeLicense] = dataclasses.field(default=None)  
...
@dataclasses.dataclass
class GetDraftRegistrationsDraftIDDraftRegistrationLinks:
...
@dataclasses.dataclass
class GetDraftRegistrationsDraftIDDraftRegistrationRelationships:
...
class GetDraftRegistrationsDraftIDDraftRegistration:
    ...
    attributes: GetDraftRegistrationsDraftIDDraftRegistrationAttributes = dataclasses.field()
    r"""The properties of the Draft Registration entity."""  
    id: str = dataclasses.field()
    r"""The unique identifier of the draft registration entity."""  
    links: GetDraftRegistrationsDraftIDDraftRegistrationLinks = dataclasses.field()
    r"""URLs to alternative representations of the draft registration entity."""  
    relationships: GetDraftRegistrationsDraftIDDraftRegistrationRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the draft registration entity."""  
