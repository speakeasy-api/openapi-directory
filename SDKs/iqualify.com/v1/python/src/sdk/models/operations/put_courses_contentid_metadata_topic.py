...
class PutCoursesContentIDMetadataTopicRequest:
    path_params: PutCoursesContentIDMetadataTopicPathParams = dataclasses.field()
    request: PutCoursesContentIDMetadataTopicRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
