...
exports.CalendarCalendarsPatchResponse = exports.CalendarCalendarsPatchRequest = exports.CalendarCalendarsPatchSecurity = void 0;
...
var CalendarCalendarsPatchRequest = /** @class */ (function (_super) {
    ...
    ], CalendarCalendarsPatchRequest.prototype, "calendar", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=alt" }),
        __metadata("design:type", String)
    ], CalendarCalendarsPatchRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=calendarId",
        }),
        __metadata("design:type", String)
    ], CalendarCalendarsPatchRequest.prototype, "calendarId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], CalendarCalendarsPatchRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], CalendarCalendarsPatchRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], CalendarCalendarsPatchRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], CalendarCalendarsPatchRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], CalendarCalendarsPatchRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], CalendarCalendarsPatchRequest.prototype, "userIp", void 0);
...
var CalendarCalendarsPatchResponse = /** @class */ (function (_super) {
    ...
    ], CalendarCalendarsPatchResponse.prototype, "rawResponse", void 0);
