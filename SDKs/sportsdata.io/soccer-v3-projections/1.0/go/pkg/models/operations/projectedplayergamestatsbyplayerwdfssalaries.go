...
func (e ProjectedPlayerGameStatsByPlayerWDfsSalariesFormatEnum) ToPointer() *ProjectedPlayerGameStatsByPlayerWDfsSalariesFormatEnum {
	return &e
}
...
func (e *ProjectedPlayerGameStatsByPlayerWDfsSalariesFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "xml":
		fallthrough
	case "json":
		*e = ProjectedPlayerGameStatsByPlayerWDfsSalariesFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ProjectedPlayerGameStatsByPlayerWDfsSalariesFormatEnum: %v", v)
	}
}
