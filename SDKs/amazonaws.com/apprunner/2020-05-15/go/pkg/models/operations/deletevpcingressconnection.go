...
type DeleteVpcIngressConnectionHeaders struct {
...
type DeleteVpcIngressConnectionRequest struct {
	Headers DeleteVpcIngressConnectionHeaders
	Request shared.DeleteVpcIngressConnectionRequest `request:"mediaType=application/json"`
}
