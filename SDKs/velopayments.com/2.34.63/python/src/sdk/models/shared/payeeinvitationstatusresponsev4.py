...
class PayeeInvitationStatusResponseV4:
    ...
    invitation_status: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invitationStatus') }})
    r"""Payee invitation status. One of the following values: ACCEPTED, PENDING, DECLINED"""  
