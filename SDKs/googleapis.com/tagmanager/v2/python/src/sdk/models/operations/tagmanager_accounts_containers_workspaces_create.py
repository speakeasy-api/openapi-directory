...
class TagmanagerAccountsContainersWorkspacesCreateRequest:
    ...
    r"""GTM parent Container's API relative path. Example: accounts/{account_id}/containers/{container_id}"""  
    ...
    workspace: Optional[shared_workspace.Workspace] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
