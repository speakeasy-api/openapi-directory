...
class Projects 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsInsightTypesInsightsListResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/insights', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsInsightTypesInsightsListRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->googleCloudRecommenderV1beta1ListInsightsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleCloudRecommenderV1beta1ListInsightsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:markAccepted', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsInsightTypesInsightsMarkAcceptedRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudRecommenderV1beta1MarkInsightAcceptedRequest", "json");
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleCloudRecommenderV1beta1Insight = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleCloudRecommenderV1beta1Insight', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsRecommendersRecommendationsGetRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleCloudRecommenderV1beta1Recommendation = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleCloudRecommenderV1beta1Recommendation', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{parent}/recommendations', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsRecommendersRecommendationsListRequest::class, $request);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleCloudRecommenderV1beta1ListRecommendationsResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleCloudRecommenderV1beta1ListRecommendationsResponse', 'json');
            }
        }
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:markClaimed', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimedRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudRecommenderV1beta1MarkRecommendationClaimedRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:markDismissed', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsRecommendersRecommendationsMarkDismissedRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudRecommenderV1beta1MarkRecommendationDismissedRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:markFailed', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsRecommendersRecommendationsMarkFailedRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudRecommenderV1beta1MarkRecommendationFailedRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}:markSucceeded', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsRecommendersRecommendationsMarkSucceededRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudRecommenderV1beta1MarkRecommendationSucceededRequest", "json");
        $options = array_merge_recursive($options, $body);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1beta1/{name}', \OpenAPI\OpenAPI\Models\Operations\RecommenderProjectsLocationsRecommendersUpdateConfigRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "googleCloudRecommenderV1beta1RecommenderConfigInput", "json");
        $options = array_merge_recursive($options, $body);
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleCloudRecommenderV1beta1RecommenderConfig = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleCloudRecommenderV1beta1RecommenderConfig', 'json');
            }
        }
