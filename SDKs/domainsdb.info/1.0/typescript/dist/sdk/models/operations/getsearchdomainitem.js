...
exports.GetSearchDomainItemResponse = exports.GetSearchDomainItemRequest = exports.GetSearchDomainItemQueryParams = void 0;
...
var GetSearchDomainItemQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=A" }),
        __metadata("design:type", String)
    ], GetSearchDomainItemQueryParams.prototype, "a", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=CNAME" }),
        __metadata("design:type", String)
    ], GetSearchDomainItemQueryParams.prototype, "cname", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=MX" }),
        __metadata("design:type", String)
    ], GetSearchDomainItemQueryParams.prototype, "mx", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=NS" }),
        __metadata("design:type", String)
    ], GetSearchDomainItemQueryParams.prototype, "ns", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=TXT" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=isDead" }),
...
exports.GetSearchDomainItemQueryParams = GetSearchDomainItemQueryParams;
...
exports.GetSearchDomainItemRequest = GetSearchDomainItemRequest;
...
exports.GetSearchDomainItemResponse = GetSearchDomainItemResponse;
