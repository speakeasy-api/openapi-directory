...
class DeleteConnectorDefinitionRequest:
    headers: DeleteConnectorDefinitionHeaders = dataclasses.field()
    path_params: DeleteConnectorDefinitionPathParams = dataclasses.field()
...
class DeleteConnectorDefinitionResponse:
    ...
    delete_connector_definition_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
