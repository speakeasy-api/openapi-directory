...
<https://docs.github.com/enterprise-server@3.7/rest/reference/billing#export-advanced-security-active-committers-data-for-enterprise>
...
func main() {
    ...
    res, err := s.Billing.BillingGetGithubAdvancedSecurityBillingGhe(ctx, operations.BillingGetGithubAdvancedSecurityBillingGheRequest{
        Enterprise: "libero",
        Page: sdk.Int64(96549),
        PerPage: sdk.Int64(270328),
    })
    if err != nil {
        log.Fatal(err)
    }
...
API method documentation
<https://docs.github.com/enterprise-server@3.7/rest/reference/billing#get-github-advanced-security-active-committers-for-an-organization>
