...
try {
    ...
    $request->requestBody->assignee = 'minima';
    $request->requestBody->assignees = [
        'ex',
    ];
    ...
    $request->requestBody->milestone = 'repudiandae';
    $request->requestBody->title = 541381;
    $request->owner = 'sunt';
...
try {
    ...
    $request->requestBody->body = 'dolorum';
...
try {
    ...
    $request->requestBody->color = 'doloremque';
    $request->requestBody->description = 'repudiandae';
    $request->requestBody->name = 'Ruth Breitenberg';
...
try {
    ...
    $request->requestBody->dueOn = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-26T23:29:35.541Z');
...
try {
    ...
    $request->milestoneNumber = 625528;
    $request->owner = 'illo';
...
try {
    ...
    $request->milestoneNumber = 672582;
...
try {
    ...
    $request->filter = IssuesListFilterEnum::CREATED;
    $request->labels = 'ad';
    $request->orgs = false;
    $request->owned = false;
    $request->page = 997963;
    ...
    $request->pulls = false;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-27T23:37:34.170Z');
...
try {
    ...
    $request->issueNumber = 174658;
    $request->owner = 'id';
    $request->page = 327988;
    $request->perPage = 293144;
    $request->repo = 'dolorum';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-12-08T22:18:03.712Z');
...
try {
    ...
    $request->direction = DirectionEnum::DESC;
    $request->filter = IssuesListForOrgFilterEnum::ALL;
    $request->labels = 'ullam';
    $request->org = 'in';
    $request->page = 721407;
    $request->perPage = 937636;
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2021-08-28T09:50:26.086Z');
...
try {
    ...
    $request->assignee = 'voluptatibus';
    $request->creator = 'molestias';
    $request->direction = DirectionEnum::DESC;
    $request->labels = 'sapiente';
    $request->mentioned = 'cumque';
    $request->milestone = 'vitae';
    $request->owner = 'rerum';
    $request->page = 272229;
    $request->perPage = 335498;
    $request->repo = 'inventore';
    $request->since = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-03-27T16:13:46.480Z');
...
try {
    ...
    $request->milestoneNumber = 241901;
...
try {
    ...
    $request->issueNumber = 433279;
    $request->owner = 'dicta';
    $request->page = 325118;
    $request->perPage = 107004;
...
try {
    ...
    $request->issueNumber = 898760;
    $request->name = 'Ms. William Boyle';
    $request->owner = 'occaecati';
...
try {
    ...
    $request->requestBody->color = 'nostrum';
    $request->requestBody->description = 'fugiat';
    $request->requestBody->newName = 'expedita';
    $request->name = 'Brandi Homenick III';
    $request->owner = 'voluptas';
    $request->repo = 'iste';
...
try {
    ...
    $request->requestBody->dueOn = DateTime::createFromFormat('Y-m-d\TH:i:sP', '2022-05-17T17:51:43.476Z');
    $request->requestBody->state = IssuesUpdateMilestoneRequestBodyStateEnum::CLOSED;
    $request->requestBody->title = 'Dr.';
    $request->milestoneNumber = 653421;
    $request->owner = 'laborum';
    $request->repo = 'libero';
