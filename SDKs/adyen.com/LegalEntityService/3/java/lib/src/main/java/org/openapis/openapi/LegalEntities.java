...
public class LegalEntities {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.PostLegalEntitiesIdCheckVerificationErrorsResponse postLegalEntitiesIdCheckVerificationErrors(org.openapis.openapi.models.operations.PostLegalEntitiesIdCheckVerificationErrorsRequest request, org.openapis.openapi.models.operations.PostLegalEntitiesIdCheckVerificationErrorsSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.PostLegalEntitiesIdCheckVerificationErrorsRequest.class, baseUrl, "/legalEntities/{id}/checkVerificationErrors", request, null);
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = JSON.getMapper();
                org.openapis.openapi.models.shared.VerificationErrors out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.VerificationErrors.class);
