...
public class GetTrackLicenseListQueryParams {
    ...
    public GetTrackLicenseListQueryParams withDownloadAvailability(GetTrackLicenseListDownloadAvailabilityEnum downloadAvailability) {
    ...
    public GetTrackLicenseListQueryParams withTeamHistory(Boolean teamHistory) {
