...
class GetNetworkWirelessDataRateHistoryRequest:
    ...
    band: Optional[GetNetworkWirelessDataRateHistoryBandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'band', 'style': 'form', 'explode': True }})
    r"""Filter results by band (either '2.4', '5' or '6')."""  
...
class GetNetworkWirelessDataRateHistory200ApplicationJSON:
    ...
    average_kbps: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('averageKbps'), 'exclude': lambda f: f is None }})
    r"""Average data rate in kilobytes-per-second"""  
    download_kbps: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('downloadKbps'), 'exclude': lambda f: f is None }})
    r"""Download rate in kilobytes-per-second"""  
    ...
    upload_kbps: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uploadKbps'), 'exclude': lambda f: f is None }})
    r"""Upload rate in kilobytes-per-second"""  
...
class GetNetworkWirelessDataRateHistoryResponse:
    ...
    get_network_wireless_data_rate_history_200_application_json_objects: Optional[list[GetNetworkWirelessDataRateHistory200ApplicationJSON]] = dataclasses.field(default=None)
