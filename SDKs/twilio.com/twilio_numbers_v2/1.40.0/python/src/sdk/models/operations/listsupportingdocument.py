...
class ListSupportingDocumentListSupportingDocumentResponse:
    ...
    meta: Optional[ListSupportingDocumentListSupportingDocumentResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
    results: Optional[list[shared_numbers_v2_regulatory_compliance_supporting_document.NumbersV2RegulatoryComplianceSupportingDocument]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
