...
class CreateSubscriptionForEvergreenTermsInitialTerm:
    ...
    term_type: CreateSubscriptionForEvergreenTermsInitialTermTermTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('termType') }})
    r"""Type of the first term. If the value of this field is `TERMED`, the first term has a predefined duration based on the value of the `period` field. If the value of this field is `EVERGREEN`, the first term does not have a predefined duration."""  
    ...
    period_type: Optional[CreateSubscriptionForEvergreenTermsInitialTermPeriodTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('periodType'), 'exclude': lambda f: f is None }})
    r"""Unit of time that the first term is measured in. Only applicable if the value of the `termType` field is `TERMED`."""  
...
class CreateSubscriptionForEvergreenTerms:
    ...
    initial_term: CreateSubscriptionForEvergreenTermsInitialTerm = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('initialTerm') }})
    r"""Information about the first term of the subscription."""  
    ...
    renewal_setting: Optional[CreateSubscriptionForEvergreenTermsRenewalSettingEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('renewalSetting'), 'exclude': lambda f: f is None }})
    r"""Specifies the type of the terms that follow the first term if the subscription is renewed. Only applicable if the type of the first term is `TERMED`.
...
class CreateSubscriptionForEvergreen:
    ...
    new_subscription_owner_account: Optional[CreateSubscriptionForEvergreenNewSubscriptionOwnerAccount] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('newSubscriptionOwnerAccount'), 'exclude': lambda f: f is None }})
    r"""Information about a new account that will own the subscription. Only available if you have enabled the Owner Transfer feature.
    ...
    **Note:** The Owner Transfer feature is in **Limited Availability**. If you wish to have access to the feature, submit a request at [Zuora Global Support](http://support.zuora.com/).
    ...
    subscribe_to_rate_plans: Optional[list[shared_rateplanoverrideforevergreen.RatePlanOverrideForEvergreen]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subscribeToRatePlans'), 'exclude': lambda f: f is None }})
    ...
    """  
    terms: Optional[CreateSubscriptionForEvergreenTerms] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('terms'), 'exclude': lambda f: f is None }})
    r"""Container for the terms and renewal settings of the subscription."""  
