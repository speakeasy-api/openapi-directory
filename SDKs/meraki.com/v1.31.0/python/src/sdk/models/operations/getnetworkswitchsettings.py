...
class GetNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum(str, Enum):
...
class GetNetworkSwitchSettings200ApplicationJSONPowerExceptions:
    ...
    power_type: Optional[GetNetworkSwitchSettings200ApplicationJSONPowerExceptionsPowerTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('powerType'), 'exclude': lambda f: f is None }})
    r"""Per switch exception (combined, redundant, useNetworkSetting)"""  
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetNetworkSwitchSettings200ApplicationJSON:
    r"""Successful operation"""
    
    power_exceptions: Optional[list[GetNetworkSwitchSettings200ApplicationJSONPowerExceptions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('powerExceptions'), 'exclude': lambda f: f is None }})
...
class GetNetworkSwitchSettingsResponse:
    ...
    get_network_switch_settings_200_application_json_object: Optional[GetNetworkSwitchSettings200ApplicationJSON] = dataclasses.field(default=None)
    r"""Successful operation"""  
