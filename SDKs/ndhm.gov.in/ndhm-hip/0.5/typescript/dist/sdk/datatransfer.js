...
var DataTransfer = /** @class */ (function () {
    function DataTransfer(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    DataTransfer.prototype.postV05HealthInformationTransfer = function (req, config) {
        var _a;
