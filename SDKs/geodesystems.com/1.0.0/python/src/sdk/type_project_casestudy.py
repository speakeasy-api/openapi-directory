...
class TypeProjectCasestudy:
    ...
    def search_project_casestudy(self, request: operations.SearchProjectCasestudyRequest) -> operations.SearchProjectCasestudyResponse:
        ...
        query_params = utils.get_query_params(operations.SearchProjectCasestudyRequest, request)
        ...
        res = operations.SearchProjectCasestudyResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
