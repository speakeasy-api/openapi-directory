...
exports.ChecksListForSuiteResponse = exports.ChecksListForSuite200ApplicationJSON = exports.ChecksListForSuiteRequest = exports.ChecksListForSuiteFilterEnum = void 0;
 ...
 */
var ChecksListForSuiteFilterEnum;
(function (ChecksListForSuiteFilterEnum) {
    ChecksListForSuiteFilterEnum["Latest"] = "latest";
    ChecksListForSuiteFilterEnum["All"] = "all";
})(ChecksListForSuiteFilterEnum = exports.ChecksListForSuiteFilterEnum || (exports.ChecksListForSuiteFilterEnum = {}));
var ChecksListForSuiteRequest = /** @class */ (function (_super) {
    ...
    ], ChecksListForSuiteRequest.prototype, "checkName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=check_suite_id",
        }),
        __metadata("design:type", Number)
    ], ChecksListForSuiteRequest.prototype, "checkSuiteId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], ChecksListForSuiteRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=owner",
        }),
        __metadata("design:type", String)
    ], ChecksListForSuiteRequest.prototype, "owner", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], ChecksListForSuiteRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], ChecksListForSuiteRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo",
        }),
        __metadata("design:type", String)
    ], ChecksListForSuiteRequest.prototype, "repo", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], ChecksListForSuiteRequest.prototype, "status", void 0);
...
var ChecksListForSuiteResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ChecksListForSuiteResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
