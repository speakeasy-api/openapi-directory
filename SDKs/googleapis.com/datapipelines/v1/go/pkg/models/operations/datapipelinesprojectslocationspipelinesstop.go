...
type DatapipelinesProjectsLocationsPipelinesStopSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatapipelinesProjectsLocationsPipelinesStopPathParams struct {
	// Required. The pipeline name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/pipelines/PIPELINE_ID`.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type DatapipelinesProjectsLocationsPipelinesStopQueryParams struct {
	// V1 error format.
...
type DatapipelinesProjectsLocationsPipelinesStopRequest struct {
...
type DatapipelinesProjectsLocationsPipelinesStopResponse struct {
	ContentType string
	// Successful response
