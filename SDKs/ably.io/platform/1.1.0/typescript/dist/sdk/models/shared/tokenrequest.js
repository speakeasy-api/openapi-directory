...
var TokenRequest = /** @class */ (function (_super) {
    ...
    ], TokenRequest.prototype, "capability", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=clientId" }),
        __metadata("design:type", String)
    ], TokenRequest.prototype, "clientId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=keyName" }),
        __metadata("design:type", String)
    ], TokenRequest.prototype, "keyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=nonce" }),
        __metadata("design:type", String)
    ], TokenRequest.prototype, "nonce", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timestamp" }),
        __metadata("design:type", Number)
    ], TokenRequest.prototype, "timestamp", void 0);
    return TokenRequest;
