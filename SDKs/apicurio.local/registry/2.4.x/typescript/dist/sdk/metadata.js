...
var Metadata = /** @class */ (function () {
    ...
    Metadata.prototype.deleteArtifactVersionMetaData = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/versions/{version}/meta", req);
    ...
    Metadata.prototype.getArtifactMetaData = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/meta", req);
        var client = this._defaultClient;
     ...
     * * A server error occurred (HTTP error `500`)
     */
    Metadata.prototype.getArtifactOwner = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetArtifactOwnerRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/groups/{groupId}/artifacts/{artifactId}/owner", req);
        var client = this._defaultClient;
        var r = client.request(__assign({ url: url, method: "get" }, config));
        return r.then(function (httpRes) {
            var _a, _b;
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetArtifactOwnerResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.artifactOwner = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.ArtifactOwner);
                    }
                    break;
                case [404, 500].includes(httpRes === null || httpRes === void 0 ? void 0 : httpRes.status):
                    if (utils.matchContentType(contentType, "application/json")) {
    ...
    Metadata.prototype.getArtifactVersionMetaDataByContent = function (req, config) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetArtifactVersionMetaDataByContentResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     * * A server error occurred (HTTP error `500`)
     */
    Metadata.prototype.updateArtifactOwner = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "artifactOwner", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
            if (e instanceof Error) {
                throw new Error("Error serializing request body, cause: ".concat(e.message));
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.UpdateArtifactOwnerResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
