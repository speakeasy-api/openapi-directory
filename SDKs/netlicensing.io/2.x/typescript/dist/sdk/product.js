...
var Product = /** @class */ (function () {
     ...
     */
    Product.prototype.createProduct = function (req, security, config) {
        var _a;
     ...
     */
    Product.prototype.deleteProduct = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteProductRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/product/{productNumber}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
     ...
     */
    Product.prototype.listProducts = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/product";
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ListProductsResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    Product.prototype.productNumber = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.ProductNumberResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
     ...
     */
    Product.prototype.updateProduct = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
