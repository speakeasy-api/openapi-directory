...
export class RunProjectsLocationsServicesReplaceServiceSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsServicesReplaceServiceRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RunProjectsLocationsServicesReplaceServiceResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
