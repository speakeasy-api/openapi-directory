...
exports.GetRepositoryPipelineKnownHostResponse = exports.GetRepositoryPipelineKnownHostRequest = void 0;
...
var GetRepositoryPipelineKnownHostRequest = /** @class */ (function (_super) {
    ...
    ], GetRepositoryPipelineKnownHostRequest.prototype, "knownHostUuid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=repo_slug",
        }),
        __metadata("design:type", String)
    ], GetRepositoryPipelineKnownHostRequest.prototype, "repoSlug", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=workspace",
        }),
        __metadata("design:type", String)
    ], GetRepositoryPipelineKnownHostRequest.prototype, "workspace", void 0);
...
var GetRepositoryPipelineKnownHostResponse = /** @class */ (function (_super) {
    ...
    ], GetRepositoryPipelineKnownHostResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
