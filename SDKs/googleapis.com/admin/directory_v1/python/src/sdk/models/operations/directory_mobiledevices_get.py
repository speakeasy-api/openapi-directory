...
class DirectoryMobiledevicesGetSecurity:
    ...
    option1: Optional[DirectoryMobiledevicesGetSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option2: Optional[DirectoryMobiledevicesGetSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
    option3: Optional[DirectoryMobiledevicesGetSecurityOption3] = dataclasses.field(default=None, metadata={'security': { 'option': True }})  
...
class DirectoryMobiledevicesGetRequest:
    ...
    projection: Optional[DirectoryMobiledevicesGetProjectionEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'projection', 'style': 'form', 'explode': True }})
    r"""Restrict information returned to a set of selected fields."""  
...
class DirectoryMobiledevicesGetResponse:
    ...
    mobile_device: Optional[shared_mobiledevice.MobileDevice] = dataclasses.field(default=None)
