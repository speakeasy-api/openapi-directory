...
from ..shared import describeaddonconfigurationresponse as shared_describeaddonconfigurationresponse
...
class DescribeAddonConfigurationRequest:
    ...
    addon_name: str = dataclasses.field(metadata={'query_param': { 'field_name': 'addonName', 'style': 'form', 'explode': True }})
    ...
    addon_version: str = dataclasses.field(metadata={'query_param': { 'field_name': 'addonVersion', 'style': 'form', 'explode': True }})
...
class DescribeAddonConfigurationResponse:
    ...
    describe_addon_configuration_response: Optional[shared_describeaddonconfigurationresponse.DescribeAddonConfigurationResponse] = dataclasses.field(default=None)
    r"""Success"""  
