...
var ReportFiles = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "byteCount" }),
...
var Report = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: ReportFiles }),
        (0, class_transformer_1.Expose)({ name: "files" }),
        (0, class_transformer_1.Type)(function () { return ReportFiles; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "isReportReady" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "statisticsCurrencyCode" }),
        __metadata("design:type", String)
    ], Report.prototype, "statisticsCurrencyCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "statisticsTimeZone" }),
        __metadata("design:type", String)
