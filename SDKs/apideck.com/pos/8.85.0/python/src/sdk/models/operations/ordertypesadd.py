...
from ..shared import createordertyperesponse as shared_createordertyperesponse
...
class OrderTypesAddRequest:
    headers: OrderTypesAddHeaders = dataclasses.field()
    query_params: OrderTypesAddQueryParams = dataclasses.field()
    request: shared_ordertype.OrderTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: OrderTypesAddSecurity = dataclasses.field()
...
class OrderTypesAddResponse:
    ...
    create_order_type_response: Optional[shared_createordertyperesponse.CreateOrderTypeResponse] = dataclasses.field(default=None)
