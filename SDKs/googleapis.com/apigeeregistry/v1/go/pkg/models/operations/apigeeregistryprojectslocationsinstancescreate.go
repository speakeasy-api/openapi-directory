...
type ApigeeregistryProjectsLocationsInstancesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ApigeeregistryProjectsLocationsInstancesCreatePathParams struct {
	// Required. Parent resource of the Instance, of the form: `projects/*/locations/*`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeregistryProjectsLocationsInstancesCreateQueryParams struct {
	// V1 error format.
...
type ApigeeregistryProjectsLocationsInstancesCreateRequest struct {
...
type ApigeeregistryProjectsLocationsInstancesCreateResponse struct {
	ContentType string
	// Successful response
