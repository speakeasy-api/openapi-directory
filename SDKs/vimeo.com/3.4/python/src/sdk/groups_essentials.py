...
class GroupsEssentials:
    ...
    def create_group(self, request: operations.CreateGroupRequestBody, security: operations.CreateGroupSecurity) -> operations.CreateGroupResponse:
        r"""Create a group"""
    ...
    def delete_group(self, request: operations.DeleteGroupRequest, security: operations.DeleteGroupSecurity) -> operations.DeleteGroupResponse:
        ...
        url = utils.generate_url(operations.DeleteGroupRequest, base_url, '/groups/{group_id}', request)
