...
class BillingbudgetsBillingAccountsBudgetsPatchRequest:
    ...
    google_cloud_billing_budgets_v1beta1_update_budget_request_input: Optional[shared_googlecloudbillingbudgetsv1beta1updatebudgetrequest.GoogleCloudBillingBudgetsV1beta1UpdateBudgetRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
