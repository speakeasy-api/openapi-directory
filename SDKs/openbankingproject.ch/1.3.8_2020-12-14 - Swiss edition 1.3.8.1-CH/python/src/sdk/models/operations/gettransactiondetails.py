...
class GetTransactionDetails200ApplicationJSON:
    transactions_details: shared_transactiondetailsbody.TransactionDetailsBody = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('transactionsDetails') }})
    

@dataclasses.dataclass
class GetTransactionDetailsRequest:
    headers: GetTransactionDetailsHeaders = dataclasses.field()
    path_params: GetTransactionDetailsPathParams = dataclasses.field()
    security: GetTransactionDetailsSecurity = dataclasses.field()
