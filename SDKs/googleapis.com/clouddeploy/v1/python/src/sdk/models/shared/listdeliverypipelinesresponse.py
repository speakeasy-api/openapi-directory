...
class ListDeliveryPipelinesResponse:
    ...
    delivery_pipelines: Optional[list[shared_deliverypipeline.DeliveryPipeline]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('deliveryPipelines'), 'exclude': lambda f: f is None }})
    r"""The `DeliveryPipeline` objects."""  
