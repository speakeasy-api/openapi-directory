...
export class TypeTypeMbCollection {
  ...
  searchTypeMbCollection(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/repository/search/type/type_mb_collection";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchTypeMbCollectionResponse =
        new operations.SearchTypeMbCollectionResponse({
