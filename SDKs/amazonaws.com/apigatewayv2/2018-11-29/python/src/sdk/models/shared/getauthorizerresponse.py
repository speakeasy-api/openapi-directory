...
class GetAuthorizerResponseAuthorizerTypeEnum(str, Enum):
...
class GetAuthorizerResponse:
    ...
    authorizer_type: Optional[GetAuthorizerResponseAuthorizerTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AuthorizerType'), 'exclude': lambda f: f is None }})  
    ...
    jwt_configuration: Optional[GetAuthorizerResponseJwtConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('JwtConfiguration'), 'exclude': lambda f: f is None }})  
