...
export class DataplexProjectsLocationsLakesEnvironmentsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesEnvironmentsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DataplexProjectsLocationsLakesEnvironmentsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
