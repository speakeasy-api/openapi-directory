...
exports.ReleaseAsset = exports.ReleaseAssetSimpleUser = exports.ReleaseAssetStateEnum = void 0;
...
exports.ReleaseAssetSimpleUser = ReleaseAssetSimpleUser;
// ReleaseAsset
/**
...
var ReleaseAsset = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=browser_download_url" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=uploader" }),
