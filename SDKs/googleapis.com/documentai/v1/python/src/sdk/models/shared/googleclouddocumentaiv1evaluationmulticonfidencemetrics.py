...
import dataclasses
from ..shared import googleclouddocumentaiv1evaluationconfidencelevelmetrics as shared_googleclouddocumentaiv1evaluationconfidencelevelmetrics
from dataclasses_json import Undefined, dataclass_json
from enum import Enum
from sdk import utils
from typing import Optional

class GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetricsMetricsTypeEnum(str, Enum):
...
class GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetrics:
    ...
    confidence_level_metrics: Optional[list[shared_googleclouddocumentaiv1evaluationconfidencelevelmetrics.GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confidenceLevelMetrics'), 'exclude': lambda f: f is None }})
    r"""Metrics across confidence levels with fuzzy matching enabled."""  
    confidence_level_metrics_exact: Optional[list[shared_googleclouddocumentaiv1evaluationconfidencelevelmetrics.GoogleCloudDocumentaiV1EvaluationConfidenceLevelMetrics]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confidenceLevelMetricsExact'), 'exclude': lambda f: f is None }})
    ...
    metrics_type: Optional[GoogleCloudDocumentaiV1EvaluationMultiConfidenceMetricsMetricsTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricsType'), 'exclude': lambda f: f is None }})
    r"""The metrics type for the label."""  
