...
class DescribeInternetGatewaysRequest:
    ...
    filters: Optional[list[DescribeInternetGatewaysRequestFilters]] = dataclasses.field(default=None)  
    internet_gateway_ids: Optional[list[str]] = dataclasses.field(default=None)  
