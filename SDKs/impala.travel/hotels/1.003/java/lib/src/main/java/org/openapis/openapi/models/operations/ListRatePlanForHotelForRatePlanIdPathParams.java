...
public class ListRatePlanForHotelForRatePlanIdPathParams {
    /**
    ...
    public ListRatePlanForHotelForRatePlanIdPathParams withHotelId(String hotelId) {
    ...
    public ListRatePlanForHotelForRatePlanIdPathParams withRatePlanId(Long ratePlanId) {
