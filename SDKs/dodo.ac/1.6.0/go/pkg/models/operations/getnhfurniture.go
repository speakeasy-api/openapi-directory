...
func (e GetNhFurnitureCategoryEnum) ToPointer() *GetNhFurnitureCategoryEnum {
	return &e
}
...
func (e *GetNhFurnitureCategoryEnum) UnmarshalJSON(data []byte) error {
	...
	case "Miscellaneous":
		fallthrough
	case "Wall-mounted":
		*e = GetNhFurnitureCategoryEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNhFurnitureCategoryEnum: %v", v)
	}
}
...
func (e GetNhFurnitureColorEnum) ToPointer() *GetNhFurnitureColorEnum {
	return &e
}
...
func (e *GetNhFurnitureColorEnum) UnmarshalJSON(data []byte) error {
	...
	case "White":
		fallthrough
	case "Yellow":
		*e = GetNhFurnitureColorEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNhFurnitureColorEnum: %v", v)
	}
}
