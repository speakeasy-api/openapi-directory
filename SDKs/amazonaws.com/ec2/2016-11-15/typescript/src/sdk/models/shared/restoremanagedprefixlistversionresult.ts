 ...
 */
export enum RestoreManagedPrefixListVersionResultPrefixListStateEnum {
 ...
 * Describes a tag.
 */
export class RestoreManagedPrefixListVersionResultPrefixListTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
