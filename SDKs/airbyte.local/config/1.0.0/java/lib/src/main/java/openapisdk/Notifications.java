...
public class Notifications {
    ...
    **/
    public openapisdk.models.operations.TryNotificationConfigResponse tryNotificationConfig(openapisdk.models.operations.TryNotificationConfigRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/v1/notifications/try");
        ...
        openapisdk.models.operations.TryNotificationConfigResponse res = new openapisdk.models.operations.TryNotificationConfigResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.NotificationRead out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.NotificationRead.class);
