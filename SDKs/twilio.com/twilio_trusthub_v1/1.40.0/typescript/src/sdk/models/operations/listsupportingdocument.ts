...
export class ListSupportingDocumentListSupportingDocumentResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListSupportingDocumentListSupportingDocumentResponseMeta)
  meta?: ListSupportingDocumentListSupportingDocumentResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.TrusthubV1SupportingDocument })
  @Expose({ name: "results" })
  @Type(() => shared.TrusthubV1SupportingDocument)
