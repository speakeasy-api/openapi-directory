...
class CreateCustomDataIdentifierRequest:
    headers: CreateCustomDataIdentifierHeaders = dataclasses.field()
    request: CreateCustomDataIdentifierRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
