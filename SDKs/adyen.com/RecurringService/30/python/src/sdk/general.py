...
class General:
    ...
    def post_schedule_account_updater(self, request: operations.PostScheduleAccountUpdaterRequest) -> operations.PostScheduleAccountUpdaterResponse:
        r"""Schedules running of the Account Updater.
        ...
        * If the recurring detail reference is provided, the fields for `shopperReference` and `selectedRecurringDetailReference` are mandatory.
        ...
        res = operations.PostScheduleAccountUpdaterResponse(status_code=r.status_code, content_type=content_type)
