...
export class NetworkservicesProjectsLocationsTlsRoutesPatchSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsTlsRoutesPatchRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class NetworkservicesProjectsLocationsTlsRoutesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
