...
class Error405PIISAdditionalErrors:
    ...
    code: shared_messagecode405_piis_enum.MessageCode405PIISEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
    r"""Message codes defined for PIIS for HTTP Error code 405 (METHOD NOT ALLOWED)."""  
...
class Error405PIIS:
    ...
    additional_errors: Optional[list[Error405PIISAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
