...
import { RedirectActionStatusCodeEnumEnum } from "./redirectactionstatuscodeenumenum";
/**
 ...
 */
export declare class RedirectActionConfig extends SpeakeasyBase {
    host?: string;
    path?: string;
    port?: string;
    protocol?: string;
    query?: string;
    statusCode: RedirectActionStatusCodeEnumEnum;
}
