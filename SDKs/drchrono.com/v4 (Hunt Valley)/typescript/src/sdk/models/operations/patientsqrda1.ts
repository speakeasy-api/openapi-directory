...
export class PatientsQrda1PathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class PatientsQrda1QueryParams extends SpeakeasyBase {
...
export class PatientsQrda1Security extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  drchronoOauth2: shared.SchemeDrchronoOauth2;
}


export class PatientsQrda1Request extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PatientsQrda1Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
