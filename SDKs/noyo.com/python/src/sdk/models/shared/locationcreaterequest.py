...
class LocationCreateRequestAddressStateEnum(str, Enum):
    AK = "AK"
    AL = "AL"
    AR = "AR"
    AS = "AS"
...
class LocationCreateRequestAddress:
    r"""LocationCreateRequestAddress
    Address of the group location
    """
    
    city: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('city') }})
    state: LocationCreateRequestAddressStateEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
...
class LocationCreateRequest:
    address: LocationCreateRequestAddress = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('address') }})
