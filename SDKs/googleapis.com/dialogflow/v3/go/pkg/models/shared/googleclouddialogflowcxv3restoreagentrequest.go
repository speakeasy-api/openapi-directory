...
func (e *GoogleCloudDialogflowCxV3RestoreAgentRequestRestoreOptionEnum) UnmarshalJSON(data []byte) error {
	...
	case "KEEP":
		fallthrough
	case "FALLBACK":
		*e = GoogleCloudDialogflowCxV3RestoreAgentRequestRestoreOptionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudDialogflowCxV3RestoreAgentRequestRestoreOptionEnum: %s", s)
	}
}
