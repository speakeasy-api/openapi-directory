...
class CalendarACLListRequest:
    path_params: CalendarACLListPathParams = dataclasses.field()
    query_params: CalendarACLListQueryParams = dataclasses.field()
    security: CalendarACLListSecurity = dataclasses.field()
...
class CalendarACLListResponse:
    ...
    acl: Optional[shared_acl.ACL] = dataclasses.field(default=None)
