...
public class WebinarCreateApplicationJSONSettingsFollowUpAttendeesEmailNotification {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public WebinarCreateApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum type;
    public WebinarCreateApplicationJSONSettingsFollowUpAttendeesEmailNotification withType(WebinarCreateApplicationJSONSettingsFollowUpAttendeesEmailNotificationTypeEnum type) {
        this.type = type;
        return this;
    }
