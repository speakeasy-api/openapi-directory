...
from ..shared import hriscompany as shared_hriscompany
...
from ..shared import updatehriscompanyresponse as shared_updatehriscompanyresponse
...
class CompaniesUpdateRequest:
    headers: CompaniesUpdateHeaders = dataclasses.field()
    path_params: CompaniesUpdatePathParams = dataclasses.field()
    query_params: CompaniesUpdateQueryParams = dataclasses.field()
    request: shared_hriscompany.HrisCompanyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: CompaniesUpdateSecurity = dataclasses.field()
...
class CompaniesUpdateResponse:
    ...
    update_hris_company_response: Optional[shared_updatehriscompanyresponse.UpdateHrisCompanyResponse] = dataclasses.field(default=None)
