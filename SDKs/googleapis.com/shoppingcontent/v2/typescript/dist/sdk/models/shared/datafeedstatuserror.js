 ...
 */
var DatafeedStatusError = /** @class */ (function (_super) {
    __extends(DatafeedStatusError, _super);
    function DatafeedStatusError() {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: datafeedstatusexample_1.DatafeedStatusExample }),
        (0, class_transformer_1.Expose)({ name: "examples" }),
        (0, class_transformer_1.Type)(function () { return datafeedstatusexample_1.DatafeedStatusExample; }),
