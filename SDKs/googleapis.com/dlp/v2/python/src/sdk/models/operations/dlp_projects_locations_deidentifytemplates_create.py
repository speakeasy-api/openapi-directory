...
class DlpProjectsLocationsDeidentifyTemplatesCreateRequest:
    ...
    google_privacy_dlp_v2_create_deidentify_template_request_input: Optional[shared_googleprivacydlpv2createdeidentifytemplaterequest.GooglePrivacyDlpV2CreateDeidentifyTemplateRequestInput] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
