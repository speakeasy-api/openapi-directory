...
export enum DeleteDataQualityRulesetXAmzTargetEnum {
  AWSGlueDeleteDataQualityRuleset = "AWSGlue.DeleteDataQualityRuleset",
}

export class DeleteDataQualityRulesetRequest extends SpeakeasyBase {
...
export class DeleteDataQualityRulesetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
