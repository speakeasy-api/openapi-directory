...
export class Taxonomies {
  ...
  taxonomiesList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.TaxonomiesListResponse =
        new operations.TaxonomiesListResponse({
  ...
  taxonomiesRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.TaxonomiesReadResponse =
        new operations.TaxonomiesReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
