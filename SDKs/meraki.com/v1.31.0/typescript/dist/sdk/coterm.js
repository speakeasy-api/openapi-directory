...
exports.Coterm = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var Coterm = /** @class */ (function () {
    function Coterm(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * List the licenses in a coterm organization
     */
    Coterm.prototype.getOrganizationLicensingCotermLicenses = function (req, config) {
     ...
     * Moves a license to a different organization (coterm only)
     */
    Coterm.prototype.moveOrganizationLicensingCotermLicenses = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
