...
class PostPortfolioOptimizationMinimumUlcerIndexRequestBodyAssets:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints:
...
class PostPortfolioOptimizationMinimumUlcerIndexRequestBody:
    ...
    assets: list[PostPortfolioOptimizationMinimumUlcerIndexRequestBodyAssets] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assets') }})  
    constraints: Optional[PostPortfolioOptimizationMinimumUlcerIndexRequestBodyConstraints] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('constraints'), 'exclude': lambda f: f is None }})  
    

@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostPortfolioOptimizationMinimumUlcerIndex200ApplicationJSON:
    r"""OK"""
...
class PostPortfolioOptimizationMinimumUlcerIndexResponse:
    ...
    post_portfolio_optimization_minimum_ulcer_index_200_application_json_object: Optional[PostPortfolioOptimizationMinimumUlcerIndex200ApplicationJSON] = dataclasses.field(default=None)
    r"""OK"""  
