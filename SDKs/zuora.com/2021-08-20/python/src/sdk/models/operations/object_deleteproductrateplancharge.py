...
class ObjectDeleteProductRatePlanChargePathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class ObjectDeleteProductRatePlanChargeHeaders:
...
class ObjectDeleteProductRatePlanChargeRequest:
    headers: ObjectDeleteProductRatePlanChargeHeaders = dataclasses.field()
    path_params: ObjectDeleteProductRatePlanChargePathParams = dataclasses.field()
    

@dataclasses.dataclass
class ObjectDeleteProductRatePlanChargeResponse:
