 ...
 */
export declare enum RequestSpotInstancesRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class RequestSpotInstancesRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class RequestSpotInstancesRequestTagSpecifications extends SpeakeasyBase {
 ...
 */
export declare enum RequestSpotInstancesRequestTypeEnum {
    OneTime = "one-time",
 ...
 */
export declare class RequestSpotInstancesRequest extends SpeakeasyBase {
