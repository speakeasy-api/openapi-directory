...
var Functions = /** @class */ (function () {
    ...
    **/
    Functions.prototype.functionsCreateExecution = function (req, config) {
        var _a;
    ...
    **/
    Functions.prototype.functionsGetExecution = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Functions.prototype.functionsListExecutions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
