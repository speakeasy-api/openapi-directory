...
exports.SetV2LoggingOptionsResponse = exports.SetV2LoggingOptionsRequest = exports.SetV2LoggingOptionsRequestBody = exports.SetV2LoggingOptionsRequestBodyDefaultLogLevelEnum = void 0;
var utils_1 = require("../../../internal/utils");
var class_transformer_1 = require("class-transformer");
/**
 * The default logging level.
 */
var SetV2LoggingOptionsRequestBodyDefaultLogLevelEnum;
...
})(SetV2LoggingOptionsRequestBodyDefaultLogLevelEnum = exports.SetV2LoggingOptionsRequestBodyDefaultLogLevelEnum || (exports.SetV2LoggingOptionsRequestBodyDefaultLogLevelEnum = {}));
...
exports.SetV2LoggingOptionsRequestBody = SetV2LoggingOptionsRequestBody;
var SetV2LoggingOptionsRequest = /** @class */ (function (_super) {
    ...
    ], SetV2LoggingOptionsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Algorithm",
        }),
        __metadata("design:type", String)
    ], SetV2LoggingOptionsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], SetV2LoggingOptionsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], SetV2LoggingOptionsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], SetV2LoggingOptionsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], SetV2LoggingOptionsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], SetV2LoggingOptionsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], SetV2LoggingOptionsRequest.prototype, "xAmzSignedHeaders", void 0);
    return SetV2LoggingOptionsRequest;
}(utils_1.SpeakeasyBase));
exports.SetV2LoggingOptionsRequest = SetV2LoggingOptionsRequest;
var SetV2LoggingOptionsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], SetV2LoggingOptionsResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
...
exports.SetV2LoggingOptionsResponse = SetV2LoggingOptionsResponse;
