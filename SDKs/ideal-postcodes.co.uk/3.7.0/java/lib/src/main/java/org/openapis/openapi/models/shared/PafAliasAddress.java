...
public class PafAliasAddress {
    ...
    public PafAliasAddress withAdministrativeCounty(String administrativeCounty) {
    ...
    public PafAliasAddress withBuildingName(String buildingName) {
    ...
    public PafAliasAddress withBuildingNumber(String buildingNumber) {
    ...
    public PafAliasAddress withCountry(PafAliasAddressCountryEnum country) {
    ...
    public PafAliasAddress withCountryIso(PafAliasAddressCountryIsoEnum countryIso) {
    ...
    public PafAliasAddress withCountryIso2(PafAliasAddressCountryIso2Enum countryIso2) {
    ...
    public PafAliasAddress withCounty(String county) {
        this.county = county;
        return this;
    }
    ...
    public PafAliasAddress withCountyCode(String countyCode) {
    ...
    public PafAliasAddress withDataset(PafAliasAddressDatasetEnum dataset) {
    ...
    public PafAliasAddress withDeliveryPointSuffix(String deliveryPointSuffix) {
    ...
    public PafAliasAddress withDepartmentName(String departmentName) {
    ...
    public PafAliasAddress withDependantLocality(String dependantLocality) {
    ...
    public PafAliasAddress withDependantThoroughfare(String dependantThoroughfare) {
    ...
    public PafAliasAddress withDistrict(String district) {
    ...
    public PafAliasAddress withDoubleDependantLocality(String doubleDependantLocality) {
    ...
    public PafAliasAddress withEastings(Object eastings) {
    ...
    @JsonProperty("id")
    public String id;
    public PafAliasAddress withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public PafAliasAddress withLanguage(PafAliasAddressLanguageEnum language) {
    ...
    public PafAliasAddress withLatitude(Object latitude) {
    ...
    @JsonProperty("line_1")
    public String line1;
    public PafAliasAddress withLine1(String line1) {
        this.line1 = line1;
        return this;
    }
    ...
    @JsonProperty("line_2")
    public String line2;
    public PafAliasAddress withLine2(String line2) {
        this.line2 = line2;
        return this;
    }
    ...
    @JsonProperty("line_3")
    public String line3;
    public PafAliasAddress withLine3(String line3) {
        this.line3 = line3;
        return this;
    }
    ...
    public PafAliasAddress withLongitude(Object longitude) {
    ...
    public PafAliasAddress withNorthings(Object northings) {
    ...
    public PafAliasAddress withOrganisationName(String organisationName) {
    ...
    @JsonProperty("po_box")
    public String poBox;
    public PafAliasAddress withPoBox(String poBox) {
        this.poBox = poBox;
        return this;
    }
    ...
    public PafAliasAddress withPostTown(String postTown) {
    ...
    public PafAliasAddress withPostalCounty(String postalCounty) {
    ...
    public PafAliasAddress withPostcode(String postcode) {
    ...
    public PafAliasAddress withPostcodeInward(String postcodeInward) {
    ...
    public PafAliasAddress withPostcodeOutward(String postcodeOutward) {
    ...
    public PafAliasAddress withPostcodeType(PafPostcodeTypeEnum postcodeType) {
    ...
    public PafAliasAddress withPremise(String premise) {
    ...
    public PafAliasAddress withSuOrganisationIndicator(String suOrganisationIndicator) {
    ...
    public PafAliasAddress withSubBuildingName(String subBuildingName) {
    ...
    public PafAliasAddress withThoroughfare(String thoroughfare) {
    ...
    public PafAliasAddress withTraditionalCounty(String traditionalCounty) {
    ...
    public PafAliasAddress withUdprn(Integer udprn) {
        this.udprn = udprn;
        return this;
    }
    ...
    @JsonProperty("umprn")
    public Object umprn;
    public PafAliasAddress withUmprn(Object umprn) {
        this.umprn = umprn;
        return this;
    }
    ...
    @JsonProperty("uprn")
    public String uprn;
    public PafAliasAddress withUprn(String uprn) {
        this.uprn = uprn;
        return this;
    }
    ...
    @JsonProperty("ward")
    public String ward;
    public PafAliasAddress withWard(String ward) {
        this.ward = ward;
        return this;
    }
