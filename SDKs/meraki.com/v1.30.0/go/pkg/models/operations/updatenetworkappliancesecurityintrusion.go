...
func (e *UpdateNetworkApplianceSecurityIntrusionRequestBodyIdsRulesetsEnum) UnmarshalJSON(data []byte) error {
	...
	case "connectivity":
		fallthrough
	case "security":
		*e = UpdateNetworkApplianceSecurityIntrusionRequestBodyIdsRulesetsEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceSecurityIntrusionRequestBodyIdsRulesetsEnum: %s", s)
	}
}
...
func (e *UpdateNetworkApplianceSecurityIntrusionRequestBodyModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "disabled":
		fallthrough
	case "prevention":
		*e = UpdateNetworkApplianceSecurityIntrusionRequestBodyModeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for UpdateNetworkApplianceSecurityIntrusionRequestBodyModeEnum: %s", s)
	}
}
