...
export class Extras {
  ...
  extrasCustomFieldChoicesList(
    ...
    const url: string =
      baseURL.replace(/\/$/, "") + "/extras/_custom_field_choices/";
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.ExtrasCustomFieldChoicesListResponse =
        new operations.ExtrasCustomFieldChoicesListResponse({
  ...
  extrasCustomFieldChoicesRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ExtrasCustomFieldChoicesReadResponse =
        new operations.ExtrasCustomFieldChoicesReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  extrasExportTemplatesCreate(
    req: shared.WritableExportTemplateInput,
    config?: AxiosRequestConfig
  ...
  extrasReportsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ExtrasReportsListResponse =
        new operations.ExtrasReportsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  extrasReportsRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ExtrasReportsReadResponse =
        new operations.ExtrasReportsReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  extrasReportsRun(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ExtrasReportsRunResponse =
        new operations.ExtrasReportsRunResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  extrasScriptsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ExtrasScriptsListResponse =
        new operations.ExtrasScriptsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  extrasScriptsRead(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.ExtrasScriptsReadResponse =
        new operations.ExtrasScriptsReadResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
