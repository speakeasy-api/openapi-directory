...
from ..shared import connectionimportdata as shared_connectionimportdata
...
class ConnectionsImportRequest:
    ...
    connection_import_data: shared_connectionimportdata.ConnectionImportData = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
