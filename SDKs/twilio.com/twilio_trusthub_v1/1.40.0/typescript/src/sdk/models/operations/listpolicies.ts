...
export const ListPoliciesServerList = ["https://trusthub.twilio.com"] as const;
...
export class ListPoliciesListPoliciesResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListPoliciesListPoliciesResponseMeta)
  meta?: ListPoliciesListPoliciesResponseMeta;

  @SpeakeasyMetadata({ elemType: shared.TrusthubV1Policies })
  @Expose({ name: "results" })
  @Type(() => shared.TrusthubV1Policies)
