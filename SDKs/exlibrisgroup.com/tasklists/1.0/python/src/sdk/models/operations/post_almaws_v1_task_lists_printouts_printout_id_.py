...
class PostAlmawsV1TaskListsPrintoutsPrintoutIDPathParams:
    printout_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'printout_id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class PostAlmawsV1TaskListsPrintoutsPrintoutIDQueryParams:
...
class PostAlmawsV1TaskListsPrintoutsPrintoutIDRequest:
    path_params: PostAlmawsV1TaskListsPrintoutsPrintoutIDPathParams = dataclasses.field()
    query_params: PostAlmawsV1TaskListsPrintoutsPrintoutIDQueryParams = dataclasses.field()
