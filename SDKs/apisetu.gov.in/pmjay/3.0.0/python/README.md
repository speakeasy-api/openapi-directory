...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/pmjay/3.0.0/python
```
...
res = s.ap_is.pmjay(req, operations.PmjaySecurity(
