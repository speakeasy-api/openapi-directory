...
exports.GetEmployeesFromPayScheduleOnEffectiveDateResponse = exports.GetEmployeesFromPayScheduleOnEffectiveDateRequest = void 0;
...
var GetEmployeesFromPayScheduleOnEffectiveDateRequest = /** @class */ (function (_super) {
    ...
    ], GetEmployeesFromPayScheduleOnEffectiveDateRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetEmployeesFromPayScheduleOnEffectiveDateRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EffectiveDate;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetEmployeesFromPayScheduleOnEffectiveDateRequest.prototype, "effectiveDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=EmployerId",
        }),
        __metadata("design:type", String)
    ], GetEmployeesFromPayScheduleOnEffectiveDateRequest.prototype, "employerId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=PayScheduleId",
        }),
        __metadata("design:type", String)
    ], GetEmployeesFromPayScheduleOnEffectiveDateRequest.prototype, "payScheduleId", void 0);
...
var GetEmployeesFromPayScheduleOnEffectiveDateResponse = /** @class */ (function (_super) {
    ...
    ], GetEmployeesFromPayScheduleOnEffectiveDateResponse.prototype, "rawResponse", void 0);
