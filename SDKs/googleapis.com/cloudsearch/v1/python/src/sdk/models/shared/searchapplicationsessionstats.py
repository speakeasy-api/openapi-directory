...
class SearchApplicationSessionStats:
    ...
    search_sessions_count: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('searchSessionsCount'), 'exclude': lambda f: f is None }})
    r"""The count of search sessions on the day"""  
