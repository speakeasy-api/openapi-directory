...
var LegalEntities = /** @class */ (function () {
    ...
    **/
    LegalEntities.prototype.getLegalEntitiesId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetLegalEntitiesIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/legalEntities/{id}", req.pathParams);
    ...
    **/
    LegalEntities.prototype.patchLegalEntitiesId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LegalEntities.prototype.postLegalEntities = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
