...
type DownloadShareClassificationEnum int
...
func (e DownloadShareClassificationEnum) ToPointer() *DownloadShareClassificationEnum {
	return &e
}
...
func (e *DownloadShareClassificationEnum) UnmarshalJSON(data []byte) error {
	...
	case 3:
		fallthrough
	case 4:
		*e = DownloadShareClassificationEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DownloadShareClassificationEnum: %v", v)
	}
}
