...
var AccountSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "dr-callback-url" }),
        __metadata("design:type", String)
    ], AccountSettings.prototype, "drCallbackUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "max-calls-per-second" }),
        __metadata("design:type", Number)
    ], AccountSettings.prototype, "maxCallsPerSecond", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "max-inbound-request" }),
        __metadata("design:type", Number)
    ], AccountSettings.prototype, "maxInboundRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "max-outbound-request" }),
        __metadata("design:type", Number)
    ], AccountSettings.prototype, "maxOutboundRequest", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "mo-callback-url" }),
        __metadata("design:type", String)
