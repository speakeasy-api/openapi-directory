...
public class DeleteTranscriptionRequest {
    ...
    public DeleteTranscriptionRequest withAccountSid(String accountSid) {
    ...
    public DeleteTranscriptionRequest withSid(String sid) {
        this.sid = sid;
        return this;
    }
    
    public DeleteTranscriptionRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("Sid") String sid) {
        this.accountSid = accountSid;
        this.sid = sid;
  }
}
