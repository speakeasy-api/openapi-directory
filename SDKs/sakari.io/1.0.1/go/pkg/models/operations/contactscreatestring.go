...
func (e ContactsCreateStringMergeStrategyEnum) ToPointer() *ContactsCreateStringMergeStrategyEnum {
	return &e
}
...
func (e *ContactsCreateStringMergeStrategyEnum) UnmarshalJSON(data []byte) error {
	...
	case "core":
		fallthrough
	case "remove":
		*e = ContactsCreateStringMergeStrategyEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ContactsCreateStringMergeStrategyEnum: %v", v)
	}
}
