...
from ..shared import nextplaybackitem as shared_nextplaybackitem
...
class GetAnonNextPlaybackItemRequest:
    ...
    r"""The identifier of the source item to base the next to watch item off."""  
    ...
    expand: Optional[GetAnonNextPlaybackItemExpandEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'expand', 'style': 'form', 'explode': True }})
    r"""If no value is specified no dependencies are expanded.
...
class GetAnonNextPlaybackItemResponse:
    ...
    next_playback_item: Optional[shared_nextplaybackitem.NextPlaybackItem] = dataclasses.field(default=None)
