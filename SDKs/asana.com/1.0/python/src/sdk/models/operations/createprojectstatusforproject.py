...
class CreateProjectStatusForProjectRequestBodyInput:
    r"""The project status to create."""
    
    data: Optional[shared_projectstatusrequest.ProjectStatusRequestInput] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
...
class CreateProjectStatusForProjectRequest:
    ...
    request_body: CreateProjectStatusForProjectRequestBodyInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""The project status to create."""  
...
class CreateProjectStatusForProject201ApplicationJSON:
    r"""Successfully created a new story."""
