 ...
 */
export declare enum CreateSubnetRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class CreateSubnetRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class CreateSubnetRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: CreateSubnetRequestTagSpecificationsResourceTypeEnum;
    tags?: CreateSubnetRequestTagSpecificationsTags[];
}
export declare class CreateSubnetRequest extends SpeakeasyBase {
