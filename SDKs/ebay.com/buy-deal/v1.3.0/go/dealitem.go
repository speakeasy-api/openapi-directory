...
func NewDealItem(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *DealItem {
	return &DealItem{
...
func (s *DealItem) GetDealItems(ctx context.Context, request operations.GetDealItemsRequest) (*operations.GetDealItemsResponse, error) {
