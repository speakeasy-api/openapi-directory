...
use \OpenAPI\OpenAPI\Models\Operations\NncerRequestBody;
use \OpenAPI\OpenAPI\Models\Operations\NncerRequestBodyCertificateParameters;
...
use \OpenAPI\OpenAPI\Models\Operations\NncerRequestBodyFormatEnum;
use \OpenAPI\OpenAPI\Models\Operations\NncerSecurity;
...
try {
    ...
    $request->certificateParameters = new NncerRequestBodyCertificateParameters();
    $request->certificateParameters->refNo = 'Application Reference No';
    ...
    $request->format = NncerRequestBodyFormatEnum::PDF;
    $request->txnId = 'f7f1469c-29b0-4325-9dfc-c567200a70f7';

    $requestSecurity = new NncerSecurity();
    $requestSecurity->apiKey = 'YOUR_API_KEY_HERE';
    $requestSecurity->clientId = 'YOUR_API_KEY_HERE';

    $response = $sdk->apIs->nncer($request, $requestSecurity);
...
* [nncer](docs/apis/README.md#nncer) - Non-Encumbrance Certificate
