...
func (e ExecutionConfigUsagesEnum) ToPointer() *ExecutionConfigUsagesEnum {
	return &e
}

func (e *ExecutionConfigUsagesEnum) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "DEPLOY":
		fallthrough
	case "VERIFY":
		*e = ExecutionConfigUsagesEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ExecutionConfigUsagesEnum: %v", v)
	}
}
