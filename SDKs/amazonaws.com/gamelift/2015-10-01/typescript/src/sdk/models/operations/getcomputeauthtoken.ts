...
export enum GetComputeAuthTokenXAmzTargetEnum {
  GameLiftGetComputeAuthToken = "GameLift.GetComputeAuthToken",
}

export class GetComputeAuthTokenRequest extends SpeakeasyBase {
...
export class GetComputeAuthTokenResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
