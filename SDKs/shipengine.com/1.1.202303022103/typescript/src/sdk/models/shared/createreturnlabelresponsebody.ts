 ...
 */
export enum CreateReturnLabelResponseBodyDisplaySchemeEnum {
  Label = "label",
  QrCode = "qr_code",
 ...
 *
 */
export enum CreateReturnLabelResponseBodyLabelFormatEnum {
  Pdf = "pdf",
  Png = "png",
  Zpl = "zpl",
}
 ...
 *
 */
export enum CreateReturnLabelResponseBodyLabelLayoutEnum {
  Fourx6 = "4x6",
  Letter = "letter",
}
 ...
 *
 */
export enum CreateReturnLabelResponseBodyLabelStatusEnum {
 ...
 */
export enum CreateReturnLabelResponseBodyTrackingStatusEnum {
  Unknown = "unknown",
...
export class CreateReturnLabelResponseBodyOutput extends SpeakeasyBase {
  ...
  @Type(() => CreateReturnLabelResponseBodyOptionalLink)
  ...
  @Type(() => CreateReturnLabelResponseBodyMonetaryValue)
  ...
  @Type(() => CreateReturnLabelResponseBodyLabelDownload)
