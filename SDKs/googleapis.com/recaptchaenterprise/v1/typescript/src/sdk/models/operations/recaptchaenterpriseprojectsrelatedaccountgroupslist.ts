...
export class RecaptchaenterpriseProjectsRelatedaccountgroupsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RecaptchaenterpriseProjectsRelatedaccountgroupsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RecaptchaenterpriseProjectsRelatedaccountgroupsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
