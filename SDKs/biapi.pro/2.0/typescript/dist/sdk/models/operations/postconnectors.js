...
exports.PostConnectorsResponse = exports.PostConnectorsRequest = exports.PostConnectorsRequestBody = void 0;
...
var PostConnectorsRequestBody = /** @class */ (function (_super) {
    ...
    ], PostConnectorsRequestBody.prototype, "comment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=email" }),
        __metadata("design:type", String)
    ], PostConnectorsRequestBody.prototype, "email", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=login" }),
        __metadata("design:type", String)
    ], PostConnectorsRequestBody.prototype, "login", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=name" }),
        __metadata("design:type", String)
    ], PostConnectorsRequestBody.prototype, "name", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=password" }),
        __metadata("design:type", String)
    ], PostConnectorsRequestBody.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=sendmail" }),
        __metadata("design:type", Boolean)
    ], PostConnectorsRequestBody.prototype, "sendmail", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=types" }),
        __metadata("design:type", String)
    ], PostConnectorsRequestBody.prototype, "types", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "multipart_form, name=url" }),
        __metadata("design:type", String)
    ], PostConnectorsRequestBody.prototype, "url", void 0);
...
var PostConnectorsRequest = /** @class */ (function (_super) {
    ...
    ], PostConnectorsRequest.prototype, "requestBody", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=expand",
        }),
        __metadata("design:type", String)
    ], PostConnectorsRequest.prototype, "expand", void 0);
...
var PostConnectorsResponse = /** @class */ (function (_super) {
    ...
    ], PostConnectorsResponse.prototype, "connector", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", String)
