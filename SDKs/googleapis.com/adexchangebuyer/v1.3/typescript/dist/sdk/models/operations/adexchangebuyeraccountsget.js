...
exports.AdexchangebuyerAccountsGetResponse = exports.AdexchangebuyerAccountsGetRequest = exports.AdexchangebuyerAccountsGetSecurity = void 0;
...
exports.AdexchangebuyerAccountsGetSecurity = AdexchangebuyerAccountsGetSecurity;
var AdexchangebuyerAccountsGetRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsGetRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsGetRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", Number)
    ], AdexchangebuyerAccountsGetRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsGetRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsGetRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], AdexchangebuyerAccountsGetRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsGetRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], AdexchangebuyerAccountsGetRequest.prototype, "userIp", void 0);
    return AdexchangebuyerAccountsGetRequest;
}(utils_1.SpeakeasyBase));
exports.AdexchangebuyerAccountsGetRequest = AdexchangebuyerAccountsGetRequest;
var AdexchangebuyerAccountsGetResponse = /** @class */ (function (_super) {
    ...
    ], AdexchangebuyerAccountsGetResponse.prototype, "rawResponse", void 0);
    return AdexchangebuyerAccountsGetResponse;
}(utils_1.SpeakeasyBase));
exports.AdexchangebuyerAccountsGetResponse = AdexchangebuyerAccountsGetResponse;
