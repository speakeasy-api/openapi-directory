 ...
 */
export enum BackendServiceAggregatedListWarningCodeEnum {
...
export class BackendServiceAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class BackendServiceAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: BackendServiceAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class BackendServiceAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: BackendServicesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, BackendServicesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], BackendServicesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
