...
exports.DigiLockerSignUpApIs = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var DigiLockerSignUpApIs = /** @class */ (function () {
    function DigiLockerSignUpApIs(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    DigiLockerSignUpApIs.prototype.signUpId = function (req, config) {
        var _a;
    ...
    **/
    DigiLockerSignUpApIs.prototype.verifyOtpId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.DigiLockerSignUpApIs = DigiLockerSignUpApIs;
