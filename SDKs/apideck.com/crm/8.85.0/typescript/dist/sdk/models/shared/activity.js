...
exports.ActivityInput = exports.Activity = exports.ActivityTypeEnum = exports.ActivityShowAsEnum = void 0;
var utils_1 = require("../../../internal/utils");
var activityattendee_1 = require("./activityattendee");
var customfield_1 = require("./customfield");
var address_1 = require("./address");
var activityattendee_2 = require("./activityattendee");
var ActivityShowAsEnum;
(function (ActivityShowAsEnum) {
    ActivityShowAsEnum["Free"] = "free";
    ActivityShowAsEnum["Busy"] = "busy";
})(ActivityShowAsEnum = exports.ActivityShowAsEnum || (exports.ActivityShowAsEnum = {}));
...
var Activity = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=activity_date" }),
        __metadata("design:type", String)
    ], Activity.prototype, "activityDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=activity_datetime" }),
        __metadata("design:type", String)
    ], Activity.prototype, "activityDatetime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=all_day_event" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attendees", elemType: activityattendee_1.ActivityAttendee }),
        __metadata("design:type", Array)
    ], Activity.prototype, "attendees", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=campaign_id" }),
        __metadata("design:type", String)
    ], Activity.prototype, "campaignId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=case_id" }),
        __metadata("design:type", String)
    ], Activity.prototype, "caseId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=child" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=custom_object_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=duration_minutes" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=event_sub_type" }),
        __metadata("design:type", String)
    ], Activity.prototype, "eventSubType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=group_event" }),
        __metadata("design:type", Boolean)
    ], Activity.prototype, "groupEvent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=group_event_type" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=location_address" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=recurrent" }),
        __metadata("design:type", Boolean)
    ], Activity.prototype, "recurrent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reminder_datetime" }),
        __metadata("design:type", String)
    ], Activity.prototype, "reminderDatetime", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reminder_set" }),
        __metadata("design:type", Boolean)
    ], Activity.prototype, "reminderSet", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=show_as" }),
        __metadata("design:type", String)
    ], Activity.prototype, "showAs", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=solution_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=video_conference_id" }),
        __metadata("design:type", String)
    ], Activity.prototype, "videoConferenceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=video_conference_url" }),
        __metadata("design:type", String)
...
var ActivityInput = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=attendees", elemType: activityattendee_2.ActivityAttendeeInput }),
        __metadata("design:type", Array)
