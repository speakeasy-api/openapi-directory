...
public class CreateSellerLeadQueryParams {
    /**
    ...
    public CreateSellerLeadQueryParams withAccountName(String accountName) {
    ...
    public CreateSellerLeadQueryParams withEnvironment(String environment) {
