...
export class Dependents {
  ...
  createDependent(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CreateDependentResponse =
        new operations.CreateDependentResponse({
      ...
      switch (true) {
        case httpRes?.status == 201:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.dependentResult = utils.objectToClass(
              httpRes?.data,
              shared.DependentResult
            );
          }
          break;
      }
  ...
  editDependent(
    ...
    const url: string = utils.generateURL(
      baseURL,
      "/api/v1/dependents/{dependent_id}/{version}",
      req
    );
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.EditDependentResponse =
        new operations.EditDependentResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getDependent(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetDependentResponse =
        new operations.GetDependentResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getEmployeeDependentsList(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetEmployeeDependentsListResponse =
        new operations.GetEmployeeDependentsListResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.paginatedDependentResult = utils.objectToClass(
              httpRes?.data,
              shared.PaginatedDependentResult
            );
          }
          break;
      }
