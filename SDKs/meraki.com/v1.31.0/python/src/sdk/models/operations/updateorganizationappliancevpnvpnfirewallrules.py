...
class UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRules:
    ...
    policy: UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRulesPolicyEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policy') }})
    r"""'allow' or 'deny' traffic specified by this rule"""  
    protocol: UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRulesProtocolEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol') }})
    r"""The type of protocol (must be 'tcp', 'udp', 'icmp', 'icmp6' or 'any')"""  
...
class UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBody:
    ...
    rules: Optional[list[UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBodyRules]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules'), 'exclude': lambda f: f is None }})
...
class UpdateOrganizationApplianceVpnVpnFirewallRulesRequest:
    ...
    request_body: Optional[UpdateOrganizationApplianceVpnVpnFirewallRulesRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
