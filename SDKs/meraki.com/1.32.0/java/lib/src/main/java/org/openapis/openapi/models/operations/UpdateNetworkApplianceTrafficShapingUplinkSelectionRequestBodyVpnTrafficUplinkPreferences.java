...
public class UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyVpnTrafficUplinkPreferences {
    ...
    public UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyVpnTrafficUplinkPreferences(@JsonProperty("preferredUplink") UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyVpnTrafficUplinkPreferencesPreferredUplinkEnum preferredUplink, @JsonProperty("trafficFilters") UpdateNetworkApplianceTrafficShapingUplinkSelectionRequestBodyVpnTrafficUplinkPreferencesTrafficFilters[] trafficFilters) {
        this.preferredUplink = preferredUplink;
        this.trafficFilters = trafficFilters;
  }
}
