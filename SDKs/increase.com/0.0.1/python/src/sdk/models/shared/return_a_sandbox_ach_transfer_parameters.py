...
class ReturnASandboxAchTransferParametersReasonEnum(str, Enum):
    r"""The reason why the Federal Reserve or destination bank returned this transfer. Defaults to `no_account`."""
...
class ReturnASandboxAchTransferParameters:
    ...
    reason: Optional[ReturnASandboxAchTransferParametersReasonEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('reason'), 'exclude': lambda f: f is None }})
    r"""The reason why the Federal Reserve or destination bank returned this transfer. Defaults to `no_account`."""  
