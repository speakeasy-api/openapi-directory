...
type ApigeeregistryProjectsLocationsArtifactsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ApigeeregistryProjectsLocationsArtifactsListPathParams struct {
	// Required. The parent, which owns this collection of artifacts. Format: `{parent}`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeregistryProjectsLocationsArtifactsListQueryParams struct {
	// V1 error format.
...
type ApigeeregistryProjectsLocationsArtifactsListRequest struct {
...
type ApigeeregistryProjectsLocationsArtifactsListResponse struct {
	ContentType string
	// Successful response
