...
export class GoogleCloudDocumentaiV1beta3Document extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudDocumentaiV1beta3DocumentEntityRelation,
  })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDocumentaiV1beta3DocumentPage })
  @Expose({ name: "pages" })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDocumentaiV1beta3DocumentRevision })
   ...
   */
  @SpeakeasyMetadata({
    elemType: GoogleCloudDocumentaiV1beta3DocumentTextChange,
  })
   ...
   */
  @SpeakeasyMetadata({ elemType: GoogleCloudDocumentaiV1beta3DocumentStyle })
