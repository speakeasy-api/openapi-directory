...
export class ContainerProjectsLocationsGetServerConfigSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsGetServerConfigRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContainerProjectsLocationsGetServerConfigResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
