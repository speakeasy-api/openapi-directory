...
var Readinglist = /** @class */ (function () {
    function Readinglist(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Readinglist.prototype.getReadinglist = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReadinglistRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/readinglist";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetReadinglistResponse({
