...
export enum GETAssociateTransitGatewayPolicyTableActionEnum {
  AssociateTransitGatewayPolicyTable = "AssociateTransitGatewayPolicyTable",
}

export enum GETAssociateTransitGatewayPolicyTableVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETAssociateTransitGatewayPolicyTableRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETAssociateTransitGatewayPolicyTableResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
