...
var General = /** @class */ (function () {
     ...
     *
     */
    General.prototype.postBalanceTransfer = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new shared.BalanceTransferRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/balanceTransfer";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.PostBalanceTransferResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.balanceTransferResponse = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.BalanceTransferResponse);
                    }
                    break;
            }
            return res;
