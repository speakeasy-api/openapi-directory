...
from ..shared import jobscheduleaddparameter as shared_jobscheduleaddparameter
...
class JobScheduleAddRequest:
    ...
    job_schedule_add_parameter: shared_jobscheduleaddparameter.JobScheduleAddParameter = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    r"""Specifies the job schedule to be added."""  
