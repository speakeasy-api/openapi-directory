...
class AuditLogEventContextAPIAuthenticationMethodEnum(str, Enum):
...
class AuditLogEventContextContextTypeEnum(str, Enum):
...
class AuditLogEventContext:
    ...
    api_authentication_method: Optional[AuditLogEventContextAPIAuthenticationMethodEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('api_authentication_method'), 'exclude': lambda f: f is None }})
    r"""The authentication method used in the context of an API request.
    Only present if the `context_type` is `api`. Can be one of `cookie`, `oauth`, `personal_access_token`, or `service_account`.
    """  
    ...
    context_type: Optional[AuditLogEventContextContextTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('context_type'), 'exclude': lambda f: f is None }})
    r"""The type of context.
    Can be one of `web`, `desktop`, `mobile`, `asana_support`, `asana`, `email`, or `api`.
    """  
