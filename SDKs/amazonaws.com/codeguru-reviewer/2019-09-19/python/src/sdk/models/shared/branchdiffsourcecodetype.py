...
class BranchDiffSourceCodeType:
    ...
    destination_branch_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DestinationBranchName') }})
    source_branch_name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SourceBranchName') }})
