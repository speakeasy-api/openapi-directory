...
export class DatalineageProjectsLocationsProcessesRunsLineageEventsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesRunsLineageEventsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatalineageProjectsLocationsProcessesRunsLineageEventsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
