...
class Properties:
    facility_type: PropertiesFacilityTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('facility_type') }})
    ...
    active_status: Optional[PropertiesActiveStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('active_status') }})
