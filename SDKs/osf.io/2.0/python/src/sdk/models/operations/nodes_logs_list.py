...
@dataclasses.dataclass
class NodesLogsListLogAttributesLogParams:
...
class NodesLogsListLogAttributes:
    ...
    params: Optional[NodesLogsListLogAttributesLogParams] = dataclasses.field(default=None)
    r"""The type of action performed on the OSF. See description for full list of possible actions."""  
...
class NodesLogsListLog:
    ...
    attributes: NodesLogsListLogAttributes = dataclasses.field()
    r"""The properties of the log."""  
    id: str = dataclasses.field()
    r"""The identifier of the log."""  
    links: NodesLogsListLogLinks = dataclasses.field()
    r"""URLs to alternative representations of the log entity."""  
    relationships: NodesLogsListLogRelationships = dataclasses.field()
    r"""URLs to other entities or entity collections that have a relationship to the log."""  
