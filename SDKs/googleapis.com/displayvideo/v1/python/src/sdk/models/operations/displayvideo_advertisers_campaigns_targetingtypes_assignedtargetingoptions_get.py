...
class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetRequest:
    path_params: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetPathParams = dataclasses.field()
    query_params: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetQueryParams = dataclasses.field()
    security: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetSecurity = dataclasses.field()
