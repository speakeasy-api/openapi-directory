...
public class ClassifyImageUrlWithNoStoreRawRequest {
    ...
    public ClassifyImageUrlWithNoStoreRawRequest(@JsonProperty("RequestBody") byte[] requestBody, @JsonProperty("projectId") String projectId, @JsonProperty("publishedName") String publishedName) {
        this.requestBody = requestBody;
        this.projectId = projectId;
        this.publishedName = publishedName;
  }
