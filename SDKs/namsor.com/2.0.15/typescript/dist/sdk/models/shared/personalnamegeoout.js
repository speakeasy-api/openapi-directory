...
exports.PersonalNameGeoOut = void 0;
...
var PersonalNameGeoOut = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=countriesTop" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=countryAlt" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=subRegion" }),
        __metadata("design:type", String)
    ], PersonalNameGeoOut.prototype, "subRegion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=topRegion" }),
        __metadata("design:type", String)
    ], PersonalNameGeoOut.prototype, "topRegion", void 0);
    return PersonalNameGeoOut;
}(utils_1.SpeakeasyBase));
exports.PersonalNameGeoOut = PersonalNameGeoOut;
