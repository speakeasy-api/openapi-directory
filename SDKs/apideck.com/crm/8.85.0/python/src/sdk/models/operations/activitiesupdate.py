...
class ActivitiesUpdateRequest:
    headers: ActivitiesUpdateHeaders = dataclasses.field()
    path_params: ActivitiesUpdatePathParams = dataclasses.field()
    query_params: ActivitiesUpdateQueryParams = dataclasses.field()
    request: shared_activity.ActivityInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: ActivitiesUpdateSecurity = dataclasses.field()
