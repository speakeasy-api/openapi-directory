...
class GetConsumerV1ServicesIDAllocationsRequest:
    ...
    r"""Format YYYY-MM-DD. Filter allocations on/before endDate"""  
    ...
    r"""id of the location, defaults to the primary location"""  
    ...
    r"""id of the resource to filter on"""  
    ...
    r"""Format YYYY-MM-DD: Filter allocations on/after startDate"""  
