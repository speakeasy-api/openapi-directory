...
from ..shared import listgeneratedcodejobsresult as shared_listgeneratedcodejobsresult
...
class ListGeneratedCodeJobsResponse:
    ...
    list_generated_code_jobs_result: Optional[shared_listgeneratedcodejobsresult.ListGeneratedCodeJobsResult] = dataclasses.field(default=None)
    r"""Success"""  
