...
from ..shared import accountlist as shared_accountlist
...
class GetAccountListRequest:
    headers: GetAccountListHeaders = dataclasses.field()
    query_params: GetAccountListQueryParams = dataclasses.field()
    security: GetAccountListSecurity = dataclasses.field()
...
class GetAccountListResponse:
    ...
    account_list: Optional[shared_accountlist.AccountList] = dataclasses.field(default=None)
