 ...
 */
export enum GetShipmentByExternalIdResponseBodyDeliveryConfirmationEnum {
  None = "none",
  Delivery = "delivery",
  Signature = "signature",
 ...
 */
export enum GetShipmentByExternalIdResponseBodyInternationalShipmentOptionsPackageContentsEnum {
 ...
 */
export enum GetShipmentByExternalIdResponseBodyInternationalShipmentOptionsNonDeliveryEnum {
 ...
 */
export enum GetShipmentByExternalIdResponseBodyInsuranceProviderEnum {
  None = "none",
 ...
 */
export enum GetShipmentByExternalIdResponseBodyOriginTypeEnum {
  Pickup = "pickup",
  DropOff = "drop_off",
}
 ...
 */
export enum GetShipmentByExternalIdResponseBodyShipmentStatusEnum {
  Pending = "pending",
...
export class GetShipmentByExternalIdResponseBody extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata()
  @Expose({ name: "customs" })
  @Type(() => GetShipmentByExternalIdResponseBodyInternationalShipmentOptions)
  ...
  @Type(() => GetShipmentByExternalIdResponseBodyWeight)
