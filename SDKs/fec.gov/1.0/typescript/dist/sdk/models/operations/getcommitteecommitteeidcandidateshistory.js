...
exports.GetCommitteeCommitteeIdCandidatesHistoryResponse = exports.GetCommitteeCommitteeIdCandidatesHistoryRequest = void 0;
...
var GetCommitteeCommitteeIdCandidatesHistoryRequest = /** @class */ (function (_super) {
    ...
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "apiKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=committee_id",
        }),
        __metadata("design:type", String)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "committeeId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=election_full",
        }),
        __metadata("design:type", Boolean)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "electionFull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=page" }),
        __metadata("design:type", Number)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=per_page",
        }),
        __metadata("design:type", Number)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "perPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "sort", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_hide_null",
        }),
        __metadata("design:type", Boolean)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "sortHideNull", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_null_only",
        }),
        __metadata("design:type", Boolean)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "sortNullOnly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sort_nulls_last",
        }),
        __metadata("design:type", Boolean)
    ], GetCommitteeCommitteeIdCandidatesHistoryRequest.prototype, "sortNullsLast", void 0);
...
var GetCommitteeCommitteeIdCandidatesHistoryResponse = /** @class */ (function (_super) {
    ...
    ], GetCommitteeCommitteeIdCandidatesHistoryResponse.prototype, "rawResponse", void 0);
