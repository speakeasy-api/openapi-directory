...
class TransactionDetailDebtTransactionTypeEnum(str, Enum):
...
class TransactionDetail:
    ...
    cleared: TransactionDetailClearedEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cleared') }})
    r"""The cleared status of the transaction"""  
    ...
    subtransactions: list[shared_subtransaction.SubTransaction] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('subtransactions') }})
    r"""If a split transaction, the subtransactions."""  
    ...
    debt_transaction_type: Optional[TransactionDetailDebtTransactionTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('debt_transaction_type'), 'exclude': lambda f: f is None }})
    r"""If the transaction is a debt/loan account transaction, the type of transaction"""  
    flag_color: Optional[TransactionDetailFlagColorEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('flag_color'), 'exclude': lambda f: f is None }})
    r"""The transaction flag"""  
