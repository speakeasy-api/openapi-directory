...
class CompanyMonitorListDefaultApplicationJSON:
...
class CompanyMonitorListResponse:
    ...
    company_monitor_list_200_application_json_objects: Optional[list[CompanyMonitorList200ApplicationJSON]] = dataclasses.field(default=None)
    r"""List of monitor webhooks"""  
    company_monitor_list_default_application_json_object: Optional[CompanyMonitorListDefaultApplicationJSON] = dataclasses.field(default=None)
    r"""Detailed information about the error"""  
