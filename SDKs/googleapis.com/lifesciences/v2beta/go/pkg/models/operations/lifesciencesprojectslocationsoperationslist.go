...
type LifesciencesProjectsLocationsOperationsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type LifesciencesProjectsLocationsOperationsListPathParams struct {
	// The name of the operation's parent resource.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type LifesciencesProjectsLocationsOperationsListQueryParams struct {
	// V1 error format.
...
type LifesciencesProjectsLocationsOperationsListRequest struct {
...
type LifesciencesProjectsLocationsOperationsListResponse struct {
	ContentType string
	// Successful response
