...
class PutExternalEvaluationHeaders:
...
class PutExternalEvaluationRequest:
    headers: PutExternalEvaluationHeaders = dataclasses.field()
    request: shared_putexternalevaluationrequest.PutExternalEvaluationRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
