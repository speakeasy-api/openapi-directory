...
public class TlsInspectionPolicy {
    ...
    public TlsInspectionPolicy withCaPool(String caPool) {
        this.caPool = caPool;
        return this;
    }
    ...
    public TlsInspectionPolicy withCreateTime(String createTime) {
    ...
    public TlsInspectionPolicy withDescription(String description) {
    ...
    public TlsInspectionPolicy withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public TlsInspectionPolicy withUpdateTime(String updateTime) {
