...
import dataclasses
from ..shared import ecommercecustomer as shared_ecommercecustomer
...
class GetEcommerceCustomerResponse:
    ...
    data: shared_ecommercecustomer.EcommerceCustomer = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data') }})  
