...
type AndroidpublisherSystemapksVariantsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidpublisherSystemapksVariantsListPathParams struct {
...
type AndroidpublisherSystemapksVariantsListQueryParams struct {
	// V1 error format.
...
type AndroidpublisherSystemapksVariantsListRequest struct {
...
type AndroidpublisherSystemapksVariantsListResponse struct {
	ContentType string
	StatusCode  int
