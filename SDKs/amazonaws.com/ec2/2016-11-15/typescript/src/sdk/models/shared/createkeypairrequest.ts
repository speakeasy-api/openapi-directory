 ...
 */
export enum CreateKeyPairRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateKeyPairRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateKeyPairRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceType?: CreateKeyPairRequestTagSpecificationsResourceTypeEnum;

  @SpeakeasyMetadata({ elemType: CreateKeyPairRequestTagSpecificationsTags })
...
export class CreateKeyPairRequest extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ elemType: CreateKeyPairRequestTagSpecifications })
