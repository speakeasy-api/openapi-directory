...
public class PicoChargingHistory {
	...
	public PicoChargingHistory(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.PicoChargingHistoryGetResponse picoChargingHistoryGet(org.openapis.openapi.models.operations.PicoChargingHistoryGetRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.shared.PicoChargingHistoryData[] out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.shared.PicoChargingHistoryData[].class);
