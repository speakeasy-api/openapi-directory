...
from ..shared import createtenderresponse as shared_createtenderresponse
...
class TendersAddRequest:
    headers: TendersAddHeaders = dataclasses.field()
    query_params: TendersAddQueryParams = dataclasses.field()
    request: shared_tender.TenderInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
    security: TendersAddSecurity = dataclasses.field()
...
class TendersAddResponse:
    ...
    create_tender_response: Optional[shared_createtenderresponse.CreateTenderResponse] = dataclasses.field(default=None)
