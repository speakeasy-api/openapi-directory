...
class GetSpots200ApplicationJSON:
    ...
    results: Optional[list[shared_spotget.SpotGet]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclasses.dataclass
class GetSpotsRequest:
    query_params: GetSpotsQueryParams = dataclasses.field()
