...
export declare class CreateDomesticScheduledPaymentsJsonSecurity extends SpeakeasyBase {
    psuoAuth2Security: string;
}
export declare class CreateDomesticScheduledPaymentsJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CreateDomesticScheduledPaymentsJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
