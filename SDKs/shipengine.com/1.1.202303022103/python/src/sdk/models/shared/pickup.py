...
class PickupPartialAddressAddressResidentialIndicatorEnum(str, Enum):
...
class PickupPartialAddress:
    ...
    address_residential_indicator: PickupPartialAddressAddressResidentialIndicatorEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('address_residential_indicator') }})
...
class PickupOutput:
    ...
    pickup_address: Optional[PickupPartialAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('pickup_address'), 'exclude': lambda f: f is None }})  
