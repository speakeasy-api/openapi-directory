...
class RemoveUserFromAccount429ApplicationJSON
{
    ...
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\RemoveUserFromAccount429ApplicationJSONMeta')]
    public RemoveUserFromAccount429ApplicationJSONMeta $meta;
    
	public function __construct()
	{
		$this->message = "";
		$this->meta = new \OpenAPI\OpenAPI\Models\Operations\RemoveUserFromAccount429ApplicationJSONMeta();
	}
}
