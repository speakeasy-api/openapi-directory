...
class CodePushDeploymentsCreate201ApplicationJSONLatestRelease
{
     ...
     * $diffPackageMap
     * 
     * @var ?array<string, \OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreate201ApplicationJSONLatestReleaseDiffPackageMap> $diffPackageMap
     */
	#[\JMS\Serializer\Annotation\SerializedName('diff_package_map')]
    #[\JMS\Serializer\Annotation\Type('array<string, OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreate201ApplicationJSONLatestReleaseDiffPackageMap>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreate201ApplicationJSONLatestReleaseReleaseMethodEnum $releaseMethod
     */
	#[\JMS\Serializer\Annotation\SerializedName('release_method')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\CodePushDeploymentsCreate201ApplicationJSONLatestReleaseReleaseMethodEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?CodePushDeploymentsCreate201ApplicationJSONLatestReleaseReleaseMethodEnum $releaseMethod = null;
