...
try {
    ...
    $request->clientSecret = 'deleniti';
    $request->fingerprint = 'earum';
...
try {
    ...
    $request->authorizationId = 190567;
...
try {
    ...
    $request->requestBody->clientSecret = 'totam';
    $request->requestBody->fingerprint = 'impedit';
...
try {
    ...
    $request->requestBody->clientSecret = 'inventore';
    $request->requestBody->note = 'Update all gems';
...
try {
    ...
    $request->requestBody->fingerprint = 'fugiat';
    $request->requestBody->note = 'Update all gems';
    $request->requestBody->noteUrl = 'ipsam';
    ...
    $request->authorizationId = 456410;
