...
@dataclasses.dataclass
class MirrorTimelineAttachmentsDeleteQueryParams:
...
class MirrorTimelineAttachmentsDeleteRequest:
    path_params: MirrorTimelineAttachmentsDeletePathParams = dataclasses.field()
    query_params: MirrorTimelineAttachmentsDeleteQueryParams = dataclasses.field()
    security: MirrorTimelineAttachmentsDeleteSecurity = dataclasses.field()
