...
var TargetGroups = /** @class */ (function () {
    function TargetGroups(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Add a target group
    **/
    TargetGroups.prototype.createNetworkSmTargetGroup = function (req, config) {
        var _a;
    ...
    **/
    TargetGroups.prototype.deleteNetworkSmTargetGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    TargetGroups.prototype.getNetworkSmTargetGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    TargetGroups.prototype.getNetworkSmTargetGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    TargetGroups.prototype.updateNetworkSmTargetGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
