...
func (e *PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2AccountingWorkbookEnum) UnmarshalJSON(data []byte) error {
	...
	case "other":
		fallthrough
	case "permanent":
		*e = PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2AccountingWorkbookEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for PostSpacesSpaceIDFoldersIDVatDeclarationsApplicationJSON2AccountingWorkbookEnum: %s", s)
	}
}
