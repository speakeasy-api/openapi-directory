...
class GetEffectivePermissionsForPathRequestBody:
    ...
    r"""The Amazon Resource Name (ARN) of the resource for which you want to get permissions."""  
...
class GetEffectivePermissionsForPathRequest:
    ...
    request_body: GetEffectivePermissionsForPathRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
