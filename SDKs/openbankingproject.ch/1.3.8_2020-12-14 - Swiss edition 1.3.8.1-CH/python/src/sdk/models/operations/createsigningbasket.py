...
from ..shared import signingbasket as shared_signingbasket
...
from ..shared import signingbasketresponse_201 as shared_signingbasketresponse_201
...
@dataclasses.dataclass
class CreateSigningBasketSecurity:
...
class CreateSigningBasketRequest:
    headers: CreateSigningBasketHeaders = dataclasses.field()
    security: CreateSigningBasketSecurity = dataclasses.field()
    request: Optional[shared_signingbasket.SigningBasket] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateSigningBasketResponse:
    ...
    signing_basket_response_201: Optional[shared_signingbasketresponse_201.SigningBasketResponse201] = dataclasses.field(default=None)
