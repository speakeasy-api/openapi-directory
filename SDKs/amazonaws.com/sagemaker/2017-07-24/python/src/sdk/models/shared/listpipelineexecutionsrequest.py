...
from ..shared import sortpipelineexecutionsby_enum as shared_sortpipelineexecutionsby_enum
...
class ListPipelineExecutionsRequest:
    ...
    sort_by: Optional[shared_sortpipelineexecutionsby_enum.SortPipelineExecutionsByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
