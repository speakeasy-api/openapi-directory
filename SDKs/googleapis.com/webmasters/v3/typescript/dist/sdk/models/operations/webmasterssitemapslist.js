...
exports.WebmastersSitemapsListResponse = exports.WebmastersSitemapsListRequest = exports.WebmastersSitemapsListSecurity = exports.WebmastersSitemapsListSecurityOption2 = exports.WebmastersSitemapsListSecurityOption1 = void 0;
...
var WebmastersSitemapsListRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "alt", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fields",
        }),
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "fields", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=key" }),
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "key", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=oauth_token",
        }),
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "oauthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=prettyPrint",
        }),
        __metadata("design:type", Boolean)
    ], WebmastersSitemapsListRequest.prototype, "prettyPrint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=quotaUser",
        }),
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "quotaUser", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=siteUrl",
        }),
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "siteUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=sitemapIndex",
        }),
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "sitemapIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=userIp",
        }),
        __metadata("design:type", String)
    ], WebmastersSitemapsListRequest.prototype, "userIp", void 0);
...
var WebmastersSitemapsListResponse = /** @class */ (function (_super) {
    ...
    ], WebmastersSitemapsListResponse.prototype, "rawResponse", void 0);
