...
func main() {
    ...
    res, err := s.AssociateWebACL(ctx, operations.AssociateWebACLRequest{
        ...
        XAmzTarget: operations.AssociateWebACLXAmzTargetEnumAwswafRegional20161128AssociateWebACL,
    })
    if err != nil {
        log.Fatal(err)
    }
