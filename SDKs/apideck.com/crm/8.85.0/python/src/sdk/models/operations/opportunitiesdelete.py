...
from ..shared import deleteopportunityresponse as shared_deleteopportunityresponse
...
class OpportunitiesDeleteRequest:
    headers: OpportunitiesDeleteHeaders = dataclasses.field()
    path_params: OpportunitiesDeletePathParams = dataclasses.field()
    query_params: OpportunitiesDeleteQueryParams = dataclasses.field()
    security: OpportunitiesDeleteSecurity = dataclasses.field()
...
class OpportunitiesDeleteResponse:
    ...
    delete_opportunity_response: Optional[shared_deleteopportunityresponse.DeleteOpportunityResponse] = dataclasses.field(default=None)
