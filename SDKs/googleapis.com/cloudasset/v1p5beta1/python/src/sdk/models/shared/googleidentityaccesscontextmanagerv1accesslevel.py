...
class GoogleIdentityAccesscontextmanagerV1AccessLevel:
    ...
    basic: Optional[shared_googleidentityaccesscontextmanagerv1basiclevel.GoogleIdentityAccesscontextmanagerV1BasicLevel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basic'), 'exclude': lambda f: f is None }})
    r"""`BasicLevel` is an `AccessLevel` using a set of recommended features."""  
    custom: Optional[shared_googleidentityaccesscontextmanagerv1customlevel.GoogleIdentityAccesscontextmanagerV1CustomLevel] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('custom'), 'exclude': lambda f: f is None }})
