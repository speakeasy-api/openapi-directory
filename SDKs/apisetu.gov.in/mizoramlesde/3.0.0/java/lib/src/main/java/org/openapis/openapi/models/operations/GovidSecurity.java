...
public class GovidSecurity {
    ...
    public GovidSecurity withApiKey(String apiKey) {
        this.apiKey = apiKey;
        return this;
    }
    ...
    public GovidSecurity withClientId(String clientId) {
        this.clientId = clientId;
        return this;
    }
    
    public GovidSecurity(@JsonProperty("apiKey") String apiKey, @JsonProperty("clientId") String clientId) {
        this.apiKey = apiKey;
        this.clientId = clientId;
  }
}
