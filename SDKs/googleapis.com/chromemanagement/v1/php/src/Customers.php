...
class Customers 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterResponse
     */
	public function chromemanagementCustomersReportsCountPrintJobsByPrinter(
        \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{customer}/reports:countPrintJobsByPrinter', \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByPrinterResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleChromeManagementV1CountPrintJobsByPrinterResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleChromeManagementV1CountPrintJobsByPrinterResponse', 'json');
            }
        }
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserResponse
     */
	public function chromemanagementCustomersReportsCountPrintJobsByUser(
        \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/v1/{customer}/reports:countPrintJobsByUser', \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserRequest::class, $request);
        
        $options = ['http_errors' => false];
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ChromemanagementCustomersReportsCountPrintJobsByUserResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->googleChromeManagementV1CountPrintJobsByUserResponse = $serializer->deserialize((string)$httpResponse->getBody(), 'OpenAPI\OpenAPI\Models\Shared\GoogleChromeManagementV1CountPrintJobsByUserResponse', 'json');
            }
        }
