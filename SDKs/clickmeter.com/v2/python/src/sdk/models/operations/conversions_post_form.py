...
class ConversionsPostFormRequest:
    ...
    api_core_dto_conversions_conversion: shared_api_core_dto_conversions_conversion.APICoreDtoConversionsConversion = dataclasses.field(metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
    r"""Updated body of the conversion"""  
...
@dataclasses.dataclass
class ConversionsPostFormResponse:
