...
class ScimSetInformationForProvisionedUserRequestBody:
    ...
    emails: list[ScimSetInformationForProvisionedUserRequestBodyEmails] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('emails') }})
    r"""user emails"""  
    name: ScimSetInformationForProvisionedUserRequestBodyName = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})  
...
class ScimSetInformationForProvisionedUserRequest:
    ...
    request_body: ScimSetInformationForProvisionedUserRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
