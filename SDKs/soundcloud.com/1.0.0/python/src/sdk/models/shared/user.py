...
class UserSubscriptions1:
    ...
    product: Optional[UserSubscriptions1Product] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('product'), 'exclude': lambda f: f is None }})
    r"""product"""  
