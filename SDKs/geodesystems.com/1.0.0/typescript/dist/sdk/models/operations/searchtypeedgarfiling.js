...
exports.SearchTypeEdgarFilingResponse = exports.SearchTypeEdgarFilingRequest = exports.SearchTypeEdgarFilingQueryParams = void 0;
...
var SearchTypeEdgarFilingQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_edgar_filing.cik_number" }),
        __metadata("design:type", String)
    ], SearchTypeEdgarFilingQueryParams.prototype, "searchTypeEdgarFilingCikNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_edgar_filing.company_name" }),
        __metadata("design:type", String)
    ], SearchTypeEdgarFilingQueryParams.prototype, "searchTypeEdgarFilingCompanyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_edgar_filing.form_type" }),
        __metadata("design:type", String)
    ], SearchTypeEdgarFilingQueryParams.prototype, "searchTypeEdgarFilingFormType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_edgar_filing.irs_number" }),
        __metadata("design:type", String)
    ], SearchTypeEdgarFilingQueryParams.prototype, "searchTypeEdgarFilingIrsNumber", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_edgar_filing.standard_industrial_classification" }),
        __metadata("design:type", String)
    ], SearchTypeEdgarFilingQueryParams.prototype, "searchTypeEdgarFilingStandardIndustrialClassification", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=search.type_edgar_filing.state" }),
        __metadata("design:type", String)
...
exports.SearchTypeEdgarFilingQueryParams = SearchTypeEdgarFilingQueryParams;
