...
class Databases 
{
    ...
    ): \OpenAPI\OpenAPI\Models\Operations\SqlDatabasesDeleteResponse
    {
        ...
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/databases/{database}', \OpenAPI\OpenAPI\Models\Operations\SqlDatabasesDeleteRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/databases/{database}', \OpenAPI\OpenAPI\Models\Operations\SqlDatabasesGetRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/databases', \OpenAPI\OpenAPI\Models\Operations\SqlDatabasesInsertRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/databases', \OpenAPI\OpenAPI\Models\Operations\SqlDatabasesListRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/databases/{database}', \OpenAPI\OpenAPI\Models\Operations\SqlDatabasesPatchRequest::class, $request);
    ...
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/sql/v1beta4/projects/{project}/instances/{instance}/databases/{database}', \OpenAPI\OpenAPI\Models\Operations\SqlDatabasesUpdateRequest::class, $request);
