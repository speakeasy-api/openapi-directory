...
exports.TagsGetDatapointsResponse = exports.TagsGetDatapointsRequest = exports.TagsGetDatapointsTypeEnum = exports.TagsGetDatapointsStatusEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Status of the datapoint
 */
var TagsGetDatapointsStatusEnum;
...
})(TagsGetDatapointsStatusEnum = exports.TagsGetDatapointsStatusEnum || (exports.TagsGetDatapointsStatusEnum = {}));
/**
 * Type of the datapoint ("tp"/"tl")
 */
var TagsGetDatapointsTypeEnum;
(function (TagsGetDatapointsTypeEnum) {
    TagsGetDatapointsTypeEnum["Tp"] = "tp";
    TagsGetDatapointsTypeEnum["Tl"] = "tl";
})(TagsGetDatapointsTypeEnum = exports.TagsGetDatapointsTypeEnum || (exports.TagsGetDatapointsTypeEnum = {}));
var TagsGetDatapointsRequest = /** @class */ (function (_super) {
    ...
    ], TagsGetDatapointsRequest.prototype, "createdAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=createdBefore",
        }),
        __metadata("design:type", String)
    ], TagsGetDatapointsRequest.prototype, "createdBefore", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], TagsGetDatapointsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], TagsGetDatapointsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], TagsGetDatapointsRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=tagId",
        }),
        __metadata("design:type", Number)
    ], TagsGetDatapointsRequest.prototype, "tagId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=textSearch",
        }),
        __metadata("design:type", String)
    ], TagsGetDatapointsRequest.prototype, "textSearch", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=type" }),
        __metadata("design:type", String)
    ], TagsGetDatapointsRequest.prototype, "type", void 0);
    return TagsGetDatapointsRequest;
}(utils_1.SpeakeasyBase));
exports.TagsGetDatapointsRequest = TagsGetDatapointsRequest;
var TagsGetDatapointsResponse = /** @class */ (function (_super) {
    ...
    ], TagsGetDatapointsResponse.prototype, "rawResponse", void 0);
    return TagsGetDatapointsResponse;
}(utils_1.SpeakeasyBase));
exports.TagsGetDatapointsResponse = TagsGetDatapointsResponse;
