...
var BatchNameMatchedOut = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: namematchedout_1.NameMatchedOut }),
        (0, class_transformer_1.Expose)({ name: "matchedNames" }),
        (0, class_transformer_1.Type)(function () { return namematchedout_1.NameMatchedOut; }),
