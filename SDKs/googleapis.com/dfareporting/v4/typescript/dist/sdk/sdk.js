...
var advertiserinvoices_1 = require("./advertiserinvoices");
var advertiserlandingpages_1 = require("./advertiserlandingpages");
var advertisers_1 = require("./advertisers");
var billingassignments_1 = require("./billingassignments");
var billingprofiles_1 = require("./billingprofiles");
var billingrates_1 = require("./billingrates");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.advertiserInvoices = new advertiserinvoices_1.AdvertiserInvoices(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.billingAssignments = new billingassignments_1.BillingAssignments(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.billingProfiles = new billingprofiles_1.BillingProfiles(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.billingRates = new billingrates_1.BillingRates(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
