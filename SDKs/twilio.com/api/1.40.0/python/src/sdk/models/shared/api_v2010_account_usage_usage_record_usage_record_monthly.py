...
class APIV2010AccountUsageUsageRecordUsageRecordMonthly:
    ...
    category: Optional[shared_usage_record_monthly_enum_category_enum.UsageRecordMonthlyEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})  
