...
from ..shared import deletereportdefinitionresult as shared_deletereportdefinitionresult
...
class DeleteReportDefinitionResponse:
    ...
    delete_report_definition_result: Optional[shared_deletereportdefinitionresult.DeleteReportDefinitionResult] = dataclasses.field(default=None)
