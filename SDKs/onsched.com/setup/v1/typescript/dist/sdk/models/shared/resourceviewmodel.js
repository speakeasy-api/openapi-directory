...
var ResourceViewModel = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=googleCalendarAuthUrl" }),
        __metadata("design:type", String)
    ], ResourceViewModel.prototype, "googleCalendarAuthUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=googleCalendarAuthorized" }),
        __metadata("design:type", Boolean)
    ], ResourceViewModel.prototype, "googleCalendarAuthorized", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outlookCalendarAuthUrl" }),
        __metadata("design:type", String)
    ], ResourceViewModel.prototype, "outlookCalendarAuthUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outlookCalendarAuthorized" }),
        __metadata("design:type", Boolean)
    ], ResourceViewModel.prototype, "outlookCalendarAuthorized", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=outlookCalendarId" }),
        __metadata("design:type", String)
    ], ResourceViewModel.prototype, "outlookCalendarId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=skypeName" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=timezoneOffset" }),
        __metadata("design:type", Number)
