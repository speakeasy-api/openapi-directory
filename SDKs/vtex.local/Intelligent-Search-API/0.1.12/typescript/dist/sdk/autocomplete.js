...
var Autocomplete = /** @class */ (function () {
     ...
     */
    Autocomplete.prototype.getAutocompleteSuggestions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAutocompleteSuggestionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/autocomplete_suggestions";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetAutocompleteSuggestionsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.autocompleteSearchSuggestions = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.AutocompleteSearchSuggestions);
                    }
                    break;
     ...
     */
    Autocomplete.prototype.getTopSearches = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetTopSearchesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/top_searches";
        var client = this._defaultClient;
        var queryParams = utils.serializeQueryParams(req);
        var r = client.request(__assign({ url: url + queryParams, method: "get" }, config));
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetTopSearchesResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.topSearches = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.TopSearches);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) >= 500 && (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) < 600:
                    if (utils.matchContentType(contentType, "application/json")) {
