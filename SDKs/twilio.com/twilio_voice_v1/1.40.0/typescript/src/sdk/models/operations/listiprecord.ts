...
export const ListIpRecordServerList = ["https://voice.twilio.com"] as const;
...
export class ListIpRecordListIpRecordResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.VoiceV1IpRecord })
  @Expose({ name: "ip_records" })
  @Type(() => shared.VoiceV1IpRecord)
  ipRecords?: shared.VoiceV1IpRecord[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListIpRecordListIpRecordResponseMeta)
