 ...
 */
public enum CreateInstanceEventWindowRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateInstanceEventWindowRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
