...
class ListPaymentsAuditV4Request
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListPaymentsAuditV4PostInstructFxStatusEnum $postInstructFxStatus
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=postInstructFxStatus')]
    public ?ListPaymentsAuditV4PostInstructFxStatusEnum $postInstructFxStatus = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListPaymentsAuditV4ScheduleStatusEnum $scheduleStatus
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=scheduleStatus')]
    public ?ListPaymentsAuditV4ScheduleStatusEnum $scheduleStatus = null;
     ...
     * Payment Status
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListPaymentsAuditV4StatusEnum $status
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=status')]
    public ?ListPaymentsAuditV4StatusEnum $status = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\ListPaymentsAuditV4TransmissionTypeEnum $transmissionType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=transmissionType')]
    public ?ListPaymentsAuditV4TransmissionTypeEnum $transmissionType = null;
	...
	public function __construct()
	{
		...
		$this->payorId = null;
		$this->payorName = null;
		$this->postInstructFxStatus = null;
		$this->railsId = null;
		$this->remoteId = null;
