...
public class PayeeDetailsUpdateV4Request {
    ...
    public PayeeDetailsUpdateV4Request(@JsonProperty("UpdatePayeeDetailsRequestV4Input") org.openapis.openapi.models.shared.UpdatePayeeDetailsRequestV4Input updatePayeeDetailsRequestV4Input, @JsonProperty("payeeId") String payeeId) {
        this.updatePayeeDetailsRequestV4Input = updatePayeeDetailsRequestV4Input;
        this.payeeId = payeeId;
  }
}
