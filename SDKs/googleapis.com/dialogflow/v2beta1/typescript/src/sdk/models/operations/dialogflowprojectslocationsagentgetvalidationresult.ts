...
export class DialogflowProjectsLocationsAgentGetValidationResultSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentGetValidationResultSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class DialogflowProjectsLocationsAgentGetValidationResultSecurity extends SpeakeasyBase {
...
export class DialogflowProjectsLocationsAgentGetValidationResultRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DialogflowProjectsLocationsAgentGetValidationResultResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
