...
class ConversionsGetStatisticsListRequest:
    ...
    time_frame: ConversionsGetStatisticsListTimeFrameEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'timeFrame', 'style': 'form', 'explode': True }})
    r"""Timeframe of the request. See list at $timeframeList"""  
    ...
    group_by: Optional[ConversionsGetStatisticsListGroupByEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'groupBy', 'style': 'form', 'explode': True }})
    r"""The temporal entity you want to group by (\\"week\\"/\\"month\\"). If unspecified is \\"day\\"."""  
