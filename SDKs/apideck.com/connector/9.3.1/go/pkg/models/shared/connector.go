...
func (e ConnectorAuthTypeEnum) ToPointer() *ConnectorAuthTypeEnum {
	return &e
}
...
func (e *ConnectorAuthTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "custom":
		fallthrough
	case "none":
		*e = ConnectorAuthTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConnectorAuthTypeEnum: %v", v)
	}
}
...
func (e ConnectorOauthCredentialsSourceEnum) ToPointer() *ConnectorOauthCredentialsSourceEnum {
	return &e
}
...
func (e *ConnectorOauthCredentialsSourceEnum) UnmarshalJSON(data []byte) error {
	...
	case "integration":
		fallthrough
	case "connection":
		*e = ConnectorOauthCredentialsSourceEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConnectorOauthCredentialsSourceEnum: %v", v)
	}
}
...
func (e ConnectorOauthGrantTypeEnum) ToPointer() *ConnectorOauthGrantTypeEnum {
	return &e
}
...
func (e *ConnectorOauthGrantTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "client_credentials":
		fallthrough
	case "password":
		*e = ConnectorOauthGrantTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ConnectorOauthGrantTypeEnum: %v", v)
	}
}
