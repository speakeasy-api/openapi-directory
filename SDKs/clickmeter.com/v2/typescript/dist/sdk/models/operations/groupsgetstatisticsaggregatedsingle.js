...
exports.GroupsGetStatisticsAggregatedSingleResponse = exports.GroupsGetStatisticsAggregatedSingleRequest = exports.GroupsGetStatisticsAggregatedSingleTimeFrameEnum = exports.GroupsGetStatisticsAggregatedSingleStatusEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
/**
 * Status of group ("deleted"/"active")
 */
var GroupsGetStatisticsAggregatedSingleStatusEnum;
...
})(GroupsGetStatisticsAggregatedSingleStatusEnum = exports.GroupsGetStatisticsAggregatedSingleStatusEnum || (exports.GroupsGetStatisticsAggregatedSingleStatusEnum = {}));
/**
 * Timeframe of the request. See list at $timeframeList
 */
var GroupsGetStatisticsAggregatedSingleTimeFrameEnum;
...
})(GroupsGetStatisticsAggregatedSingleTimeFrameEnum = exports.GroupsGetStatisticsAggregatedSingleTimeFrameEnum || (exports.GroupsGetStatisticsAggregatedSingleTimeFrameEnum = {}));
var GroupsGetStatisticsAggregatedSingleRequest = /** @class */ (function (_super) {
    ...
    ], GroupsGetStatisticsAggregatedSingleRequest.prototype, "favourite", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=fromDay",
        }),
        __metadata("design:type", String)
    ], GroupsGetStatisticsAggregatedSingleRequest.prototype, "fromDay", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=hourly",
        }),
        __metadata("design:type", Boolean)
    ], GroupsGetStatisticsAggregatedSingleRequest.prototype, "hourly", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=status",
        }),
        __metadata("design:type", String)
    ], GroupsGetStatisticsAggregatedSingleRequest.prototype, "status", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=tag" }),
        __metadata("design:type", String)
    ], GroupsGetStatisticsAggregatedSingleRequest.prototype, "tag", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=timeFrame",
        }),
        __metadata("design:type", String)
    ], GroupsGetStatisticsAggregatedSingleRequest.prototype, "timeFrame", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=toDay" }),
        __metadata("design:type", String)
    ], GroupsGetStatisticsAggregatedSingleRequest.prototype, "toDay", void 0);
    return GroupsGetStatisticsAggregatedSingleRequest;
}(utils_1.SpeakeasyBase));
exports.GroupsGetStatisticsAggregatedSingleRequest = GroupsGetStatisticsAggregatedSingleRequest;
var GroupsGetStatisticsAggregatedSingleResponse = /** @class */ (function (_super) {
    ...
    ], GroupsGetStatisticsAggregatedSingleResponse.prototype, "rawResponse", void 0);
    return GroupsGetStatisticsAggregatedSingleResponse;
}(utils_1.SpeakeasyBase));
exports.GroupsGetStatisticsAggregatedSingleResponse = GroupsGetStatisticsAggregatedSingleResponse;
