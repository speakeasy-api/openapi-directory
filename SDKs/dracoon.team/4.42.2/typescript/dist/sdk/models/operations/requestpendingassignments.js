...
exports.RequestPendingAssignmentsResponse = exports.RequestPendingAssignmentsRequest = void 0;
...
var RequestPendingAssignmentsRequest = /** @class */ (function (_super) {
    ...
    ], RequestPendingAssignmentsRequest.prototype, "xSdsAuthToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=filter",
        }),
        __metadata("design:type", String)
    ], RequestPendingAssignmentsRequest.prototype, "filter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=limit" }),
        __metadata("design:type", Number)
    ], RequestPendingAssignmentsRequest.prototype, "limit", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=offset",
        }),
        __metadata("design:type", Number)
    ], RequestPendingAssignmentsRequest.prototype, "offset", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort" }),
        __metadata("design:type", String)
    ], RequestPendingAssignmentsRequest.prototype, "sort", void 0);
    return RequestPendingAssignmentsRequest;
}(utils_1.SpeakeasyBase));
exports.RequestPendingAssignmentsRequest = RequestPendingAssignmentsRequest;
var RequestPendingAssignmentsResponse = /** @class */ (function (_super) {
    ...
    ], RequestPendingAssignmentsResponse.prototype, "rawResponse", void 0);
    return RequestPendingAssignmentsResponse;
}(utils_1.SpeakeasyBase));
exports.RequestPendingAssignmentsResponse = RequestPendingAssignmentsResponse;
