 ...
 */
public enum CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsBurstablePerformanceEnum {
    INCLUDED("included"),
    REQUIRED("required"),
    EXCLUDED("excluded");
    ...
    private CreateFleetResultErrorsLaunchTemplateAndOverridesOverridesInstanceRequirementsBurstablePerformanceEnum(String value) {
        this.value = value;
    }
}
