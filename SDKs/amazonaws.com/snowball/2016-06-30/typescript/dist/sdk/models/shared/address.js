...
var Address = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=IsRestricted" }),
        __metadata("design:type", Boolean)
    ], Address.prototype, "isRestricted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Landmark" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PrefectureOrDistrict" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Street1" }),
        __metadata("design:type", String)
    ], Address.prototype, "street1", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Street2" }),
        __metadata("design:type", String)
    ], Address.prototype, "street2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=Street3" }),
        __metadata("design:type", String)
