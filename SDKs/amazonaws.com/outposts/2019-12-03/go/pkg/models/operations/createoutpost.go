...
func (e CreateOutpostRequestBodySupportedHardwareTypeEnum) ToPointer() *CreateOutpostRequestBodySupportedHardwareTypeEnum {
	return &e
}
...
func (e *CreateOutpostRequestBodySupportedHardwareTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "RACK":
		fallthrough
	case "SERVER":
		*e = CreateOutpostRequestBodySupportedHardwareTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOutpostRequestBodySupportedHardwareTypeEnum: %v", v)
	}
}
