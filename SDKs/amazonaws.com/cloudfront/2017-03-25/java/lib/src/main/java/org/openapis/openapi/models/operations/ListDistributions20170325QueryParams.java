...
public class ListDistributions20170325QueryParams {
    /**
    ...
    public ListDistributions20170325QueryParams withMarker(String marker) {
        this.marker = marker;
        return this;
    }
    ...
    public ListDistributions20170325QueryParams withMaxItems(String maxItems) {
