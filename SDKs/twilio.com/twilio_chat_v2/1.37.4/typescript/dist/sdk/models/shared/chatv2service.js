...
var ChatV2Service = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=consumption_report_interval" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_channel_creator_role_sid" }),
        __metadata("design:type", String)
    ], ChatV2Service.prototype, "defaultChannelCreatorRoleSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_channel_role_sid" }),
        __metadata("design:type", String)
    ], ChatV2Service.prototype, "defaultChannelRoleSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=default_service_role_sid" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=post_webhook_retry_count" }),
        __metadata("design:type", Number)
    ], ChatV2Service.prototype, "postWebhookRetryCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=post_webhook_url" }),
        __metadata("design:type", String)
    ], ChatV2Service.prototype, "postWebhookUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pre_webhook_retry_count" }),
        __metadata("design:type", Number)
    ], ChatV2Service.prototype, "preWebhookRetryCount", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=pre_webhook_url" }),
        __metadata("design:type", String)
    ], ChatV2Service.prototype, "preWebhookUrl", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=reachability_enabled" }),
        __metadata("design:type", Boolean)
    ], ChatV2Service.prototype, "reachabilityEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=read_status_enabled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=typing_indicator_timeout" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=webhook_filters" }),
