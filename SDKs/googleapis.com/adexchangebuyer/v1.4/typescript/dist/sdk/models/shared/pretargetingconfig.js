...
var PretargetingConfigVideoPlayerSizes = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "minHeight" }),
        __metadata("design:type", String)
    ], PretargetingConfigVideoPlayerSizes.prototype, "minHeight", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "minWidth" }),
        __metadata("design:type", String)
...
var PretargetingConfig = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "userIdentifierDataRequired" }),
        __metadata("design:type", Array)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: PretargetingConfigVideoPlayerSizes }),
        (0, class_transformer_1.Expose)({ name: "videoPlayerSizes" }),
        (0, class_transformer_1.Type)(function () { return PretargetingConfigVideoPlayerSizes; }),
        __metadata("design:type", Array)
