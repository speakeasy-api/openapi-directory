...
class GetV2CadencesJSONRequest:
    ...
    r"""Filters by whether the Cadences have been archived. Excluding this field will result in both archived and unarchived Cadences to return."""  
    group_ids: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'group_ids', 'style': 'form', 'explode': True }})
    r"""Filters by group ids. Also supports group ids passed in as a JSON array string"""  
    ids: Optional[list[int]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'ids', 'style': 'form', 'explode': False }})
    r"""IDs of cadences to fetch. If a record can't be found, that record won't be returned and your request will be successful"""  
    ...
    r"""Filters cadences by the owner's guid. Multiple owner guids can be applied"""  
    page: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'page', 'style': 'form', 'explode': True }})
    r"""The current page to fetch results from. Defaults to 1"""  
    people_addable: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'people_addable', 'style': 'form', 'explode': True }})
    r"""Filters cadences by whether they are able to have people added to them"""  
    ...
    r"""Filters cadences by whether they are shared"""  
    ...
    team_cadence: Optional[bool] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'team_cadence', 'style': 'form', 'explode': True }})
    r"""Filters cadences by whether they are a team cadence or not"""  
...
@dataclasses.dataclass
class GetV2CadencesJSONResponse:
