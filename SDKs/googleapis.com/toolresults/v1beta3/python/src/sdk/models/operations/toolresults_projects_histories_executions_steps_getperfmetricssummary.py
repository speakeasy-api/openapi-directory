...
from ..shared import security as shared_security
from ..shared import perfmetricssummary as shared_perfmetricssummary
...
@dataclasses.dataclass
class ToolresultsProjectsHistoriesExecutionsStepsGetPerfMetricsSummaryQueryParams:
...
class ToolresultsProjectsHistoriesExecutionsStepsGetPerfMetricsSummaryRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsGetPerfMetricsSummaryPathParams = dataclasses.field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsGetPerfMetricsSummaryQueryParams = dataclasses.field()
    security: ToolresultsProjectsHistoriesExecutionsStepsGetPerfMetricsSummarySecurity = dataclasses.field()
...
class ToolresultsProjectsHistoriesExecutionsStepsGetPerfMetricsSummaryResponse:
    ...
    perf_metrics_summary: Optional[shared_perfmetricssummary.PerfMetricsSummary] = dataclasses.field(default=None)
