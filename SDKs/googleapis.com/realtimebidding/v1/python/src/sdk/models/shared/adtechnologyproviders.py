...
class AdTechnologyProviders:
    ...
    detected_gvl_ids: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('detectedGvlIds') }})
    ...
    unidentified_provider_domains: Optional[list[str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('unidentifiedProviderDomains') }})
