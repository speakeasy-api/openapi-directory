...
class PutLifecyclePolicyRequest:
    ...
    put_lifecycle_policy_request: shared_putlifecyclepolicyrequest.PutLifecyclePolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
