...
class ListCollectionsRequest:
    headers: ListCollectionsHeaders = dataclasses.field()
    query_params: ListCollectionsQueryParams = dataclasses.field()
    request: shared_listcollectionsrequest.ListCollectionsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
