...
public class GetPartyHeaders {
    ...
    public GetPartyHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetPartyHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetPartyHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public GetPartyHeaders withXFapiInteractionId(String xFapiInteractionId) {
