...
class Bluetooth:
    ...
    def change_discoverability(self, request: shared.ChangeDiscoverabilityRequest) -> operations.ChangeDiscoverabilityResponse:
        ...
        **For Part 1 only**
        ...
        res = operations.ChangeDiscoverabilityResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'text/plain'):
                res.change_discoverability_200_text_plain_object = http_res.content

        return res

    def forgetpaireddevice(self, request: shared.ForgetpaireddeviceRequest) -> operations.ForgetpaireddeviceResponse:
        ...
        **For both parts**
        ...
        res = operations.ForgetpaireddeviceResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'text/plain'):
                res.forgetpaireddevice_200_text_plain_object = http_res.content
    ...
    def get_paired_devices(self) -> operations.GetPairedDevicesResponse:
        ...
        **For both parts**
        ...
        res = operations.GetPairedDevicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Example111]])
                res.example111s = out
    ...
    def get_scan_results(self) -> operations.GetScanResultsResponse:
        ...
        **For Part 2 only**
        ...
        res = operations.GetScanResultsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[list[shared.Example112]])
                res.example112s = out

        return res

    def pairwith_speaker(self, request: shared.PairwithSpeakerRequest) -> operations.PairwithSpeakerResponse:
        r"""Pair with Speaker
        *See note for Bluetooth under `/setup/bluetooth/status`*
        ...
        **For Part 2 only**
        ...
        res = operations.PairwithSpeakerResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'text/plain'):
                res.pairwith_speaker_200_text_plain_object = http_res.content

        return res

    def scanfordevices(self, request: shared.ScanfordevicesRequest) -> operations.ScanfordevicesResponse:
        r"""Scan for devices
        *See note for Bluetooth under `/setup/bluetooth/status`*
        ...
        **For Part 2 only**
        ...
        res = operations.ScanfordevicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'text/plain'):
                res.scanfordevices_200_text_plain_object = http_res.content
    ...
    def status(self) -> operations.StatusResponse:
        ...
        **For both parts**
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.Example110])
                res.example110 = out
