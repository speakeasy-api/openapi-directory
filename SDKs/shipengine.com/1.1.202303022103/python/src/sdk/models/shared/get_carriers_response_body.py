...
class GetCarriersResponseBodyCarrier:
    ...
    options: Optional[list[GetCarriersResponseBodyCarrierCarrierAdvancedOption]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('options'), 'exclude': lambda f: f is None }})
    r"""A list of options that are available to that carrier"""  
    packages: Optional[list[GetCarriersResponseBodyCarrierPackageType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('packages'), 'exclude': lambda f: f is None }})
    ...
    services: Optional[list[GetCarriersResponseBodyCarrierService]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('services'), 'exclude': lambda f: f is None }})
...
class GetCarriersResponseBody:
    ...
    carriers: list[GetCarriersResponseBodyCarrier] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('carriers') }})
    r"""The carrier response body"""  
