...
class CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
@dataclasses.dataclass
class CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecifications:
    ...
    resource_type: Optional[CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequest:
    ...
    local_gateway_virtual_interface_group_id: str = dataclasses.field()  
    dry_run: Optional[bool] = dataclasses.field(default=None)  
    tag_specifications: Optional[list[CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationRequestTagSpecifications]] = dataclasses.field(default=None)  
