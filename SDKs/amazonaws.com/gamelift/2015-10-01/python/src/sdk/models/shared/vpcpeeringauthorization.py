...
class VpcPeeringAuthorization:
    ...
    game_lift_aws_account_id: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('GameLiftAwsAccountId') }})
