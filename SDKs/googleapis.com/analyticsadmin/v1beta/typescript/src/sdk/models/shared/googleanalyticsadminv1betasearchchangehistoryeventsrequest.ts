...
export enum GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestActionEnum {
...
export enum GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequestResourceTypeEnum {
...
**/
export class GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsRequest extends SpeakeasyBase {
