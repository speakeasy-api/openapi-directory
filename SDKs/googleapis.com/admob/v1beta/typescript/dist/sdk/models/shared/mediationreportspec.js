...
var MediationReportSpec = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: mediationreportspecdimensionfilter_1.MediationReportSpecDimensionFilter }),
        (0, class_transformer_1.Expose)({ name: "dimensionFilters" }),
        (0, class_transformer_1.Type)(function () { return mediationreportspecdimensionfilter_1.MediationReportSpecDimensionFilter; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: mediationreportspecsortcondition_1.MediationReportSpecSortCondition }),
        (0, class_transformer_1.Expose)({ name: "sortConditions" }),
        (0, class_transformer_1.Type)(function () { return mediationreportspecsortcondition_1.MediationReportSpecSortCondition; }),
        __metadata("design:type", Array)
