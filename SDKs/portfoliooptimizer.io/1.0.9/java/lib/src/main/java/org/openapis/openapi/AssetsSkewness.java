...
public class AssetsSkewness {
	...
	public AssetsSkewness(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public org.openapis.openapi.models.operations.PostAssetsSkewnessResponse postAssetsSkewness(org.openapis.openapi.models.operations.PostAssetsSkewnessRequest request) throws Exception {
        ...
        if (httpRes.statusCode() == 200) {
            if (org.openapis.openapi.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                org.openapis.openapi.models.operations.PostAssetsSkewness200ApplicationJSON out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), org.openapis.openapi.models.operations.PostAssetsSkewness200ApplicationJSON.class);
