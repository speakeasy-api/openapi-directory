...
public class BatchApi {
    ...
    **/
    public openapisdk.models.operations.CreateBatchRequestResponse createBatchRequest(openapisdk.models.operations.CreateBatchRequestRequest request) throws Exception {
        ...
        openapisdk.models.operations.CreateBatchRequestResponse res = new openapisdk.models.operations.CreateBatchRequestResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.operations.CreateBatchRequest200ApplicationJson out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.operations.CreateBatchRequest200ApplicationJson.class);
