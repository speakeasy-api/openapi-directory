...
@dataclasses.dataclass
class OsconfigProjectsLocationsOsPolicyAssignmentsPatchQueryParams:
...
class OsconfigProjectsLocationsOsPolicyAssignmentsPatchRequest:
    path_params: OsconfigProjectsLocationsOsPolicyAssignmentsPatchPathParams = dataclasses.field()
    query_params: OsconfigProjectsLocationsOsPolicyAssignmentsPatchQueryParams = dataclasses.field()
    security: OsconfigProjectsLocationsOsPolicyAssignmentsPatchSecurity = dataclasses.field()
