...
```bash
npm add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/vonage.com/vgis/1.0.1/typescript
```

### Yarn

```bash
yarn add https://gitpkg.now.sh/speakeasy-api/openapi-directory/SDKs/vonage.com/vgis/1.0.1/typescript
```
