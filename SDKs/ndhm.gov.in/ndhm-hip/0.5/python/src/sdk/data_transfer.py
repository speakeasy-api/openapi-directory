...
class DataTransfer:
    ...
    def post_v0_5_health_information_transfer_json(self, request: operations.PostV05HealthInformationTransferJSONRequest, server_url: Optional[str] = None) -> operations.PostV05HealthInformationTransferJSONResponse:
        ...
        **NOTE**: This API is actually the callback URL that is passed as **dataPushUrl** in the data request API - /v0.5/health-information/hip/request. This API is directly called by HIP Data Bridge and is not mediated via CM, and hence not routed through the Gateway. 
        ...
        """
        base_url = operations.POST_V0_5_HEALTH_INFORMATION_TRANSFER_JSON_SERVERS[0]
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "data_notification", 'json')
        ...
        res = operations.PostV05HealthInformationTransferJSONResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_v0_5_health_information_transfer_raw(self, request: operations.PostV05HealthInformationTransferRawRequest, server_url: Optional[str] = None) -> operations.PostV05HealthInformationTransferRawResponse:
        r"""health information transfer API
        **NOTE**: This API is actually the callback URL that is passed as **dataPushUrl** in the data request API - /v0.5/health-information/hip/request. This API is directly called by HIP Data Bridge and is not mediated via CM, and hence not routed through the Gateway. 
          1. This API should be implemented at HIU side. It maybe implemented by the Data Bridge representing the HIU. 
          2. Entry elements maybe ***content*** or ***link***, although for version 1, entry ***content*** is preferred. 
          ...
          6. Please refer to the NDHM Sandbox Documentation for the format of FHIR bundle that is passed through content
        """
        base_url = operations.POST_V0_5_HEALTH_INFORMATION_TRANSFER_RAW_SERVERS[0]
        if server_url is not None:
            base_url = server_url
        ...
        res = operations.PostV05HealthInformationTransferRawResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
