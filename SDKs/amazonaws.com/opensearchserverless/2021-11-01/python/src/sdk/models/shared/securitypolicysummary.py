...
class SecurityPolicySummary:
    r"""A summary of a security policy for OpenSearch Serverless."""
    ...
    type: Optional[shared_securitypolicytype_enum.SecurityPolicyTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
