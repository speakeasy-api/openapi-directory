...
class DescribeLoadBasedAutoScalingRequest:
    ...
    describe_load_based_auto_scaling_request: shared_describeloadbasedautoscalingrequest.DescribeLoadBasedAutoScalingRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
