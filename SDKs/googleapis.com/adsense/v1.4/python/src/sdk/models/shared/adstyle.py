...
class AdStyleColors:
    r"""The colors which are included in the style. These are represented as six hexadecimal characters, similar to HTML color codes, but without the leading hash."""
...
class AdStyle:
    ...
    r"""Kind this is, in this case adsense#adStyle."""  
