...
class StepAdjustment:
    ...
    metric_interval_lower_bound: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MetricIntervalLowerBound'), 'exclude': lambda f: f is None }})  
    metric_interval_upper_bound: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('MetricIntervalUpperBound'), 'exclude': lambda f: f is None }})  
