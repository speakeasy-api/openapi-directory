...
from ..shared import itvcancelsubscriptionrequest as shared_itvcancelsubscriptionrequest
...
class DeleteItvPurchasePlatformRequest:
    ...
    itv_cancel_subscription_request: shared_itvcancelsubscriptionrequest.ItvCancelSubscriptionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
