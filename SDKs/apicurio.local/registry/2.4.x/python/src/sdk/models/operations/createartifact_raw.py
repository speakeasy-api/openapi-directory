...
class CreateArtifactRawXRegistryHashAlgorithmEnum(str, Enum):
...
class CreateArtifactRawRequest:
    ...
    * XML Schema (`XSD`)
    ...
    x_registry_hash_algorithm: Optional[CreateArtifactRawXRegistryHashAlgorithmEnum] = dataclasses.field(default=None, metadata={'header': { 'field_name': 'X-Registry-Hash-Algorithm', 'style': 'simple', 'explode': False }})
    r"""The algorithm to use when checking the content validity. (available: SHA256, MD5; default: SHA256)"""  
