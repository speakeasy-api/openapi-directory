...
exports.PostConfigApacheSlingReferrerFilterResponse = exports.PostConfigApacheSlingReferrerFilterRequest = exports.PostConfigApacheSlingReferrerFilterQueryParams = void 0;
...
var PostConfigApacheSlingReferrerFilterQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=allow.empty" }),
        __metadata("design:type", Boolean)
    ], PostConfigApacheSlingReferrerFilterQueryParams.prototype, "allowEmpty", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=allow.empty@TypeHint" }),
        __metadata("design:type", String)
    ], PostConfigApacheSlingReferrerFilterQueryParams.prototype, "allowEmptyAtTypeHint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=allow.hosts" }),
        __metadata("design:type", String)
    ], PostConfigApacheSlingReferrerFilterQueryParams.prototype, "allowHosts", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=allow.hosts.regexp" }),
        __metadata("design:type", String)
    ], PostConfigApacheSlingReferrerFilterQueryParams.prototype, "allowHostsRegexp", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=allow.hosts.regexp@TypeHint" }),
        __metadata("design:type", String)
    ], PostConfigApacheSlingReferrerFilterQueryParams.prototype, "allowHostsRegexpAtTypeHint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=allow.hosts@TypeHint" }),
        __metadata("design:type", String)
    ], PostConfigApacheSlingReferrerFilterQueryParams.prototype, "allowHostsAtTypeHint", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filter.methods" }),
        __metadata("design:type", String)
    ], PostConfigApacheSlingReferrerFilterQueryParams.prototype, "filterMethods", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=filter.methods@TypeHint" }),
        __metadata("design:type", String)
...
exports.PostConfigApacheSlingReferrerFilterQueryParams = PostConfigApacheSlingReferrerFilterQueryParams;
