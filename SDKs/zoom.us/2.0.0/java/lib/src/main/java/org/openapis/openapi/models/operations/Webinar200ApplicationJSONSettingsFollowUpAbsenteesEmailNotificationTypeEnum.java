 ...
 */
public enum Webinar200ApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum {
    ZERO("0"),
    ONE("1"),
    TWO("2"),
    THREE("3"),
    ...
    private Webinar200ApplicationJSONSettingsFollowUpAbsenteesEmailNotificationTypeEnum(String value) {
        this.value = value;
    }
}
