...
export class RetailProjectsLocationsCatalogsServingConfigsDeleteSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsServingConfigsDeleteRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsServingConfigsDeleteResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
