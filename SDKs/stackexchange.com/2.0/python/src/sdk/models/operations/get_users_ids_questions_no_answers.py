...
class GetUsersIdsQuestionsNoAnswersPathParams:
    ids: str = dataclasses.field(metadata={'path_param': { 'field_name': 'ids', 'style': 'simple', 'explode': False }})
    
class GetUsersIdsQuestionsNoAnswersOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetUsersIdsQuestionsNoAnswersSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
...
@dataclasses.dataclass
class GetUsersIdsQuestionsNoAnswersQueryParams:
    ...
    order: Optional[GetUsersIdsQuestionsNoAnswersOrderEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetUsersIdsQuestionsNoAnswersSortEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclasses.dataclass
class GetUsersIdsQuestionsNoAnswersRequest:
    path_params: GetUsersIdsQuestionsNoAnswersPathParams = dataclasses.field()
    query_params: GetUsersIdsQuestionsNoAnswersQueryParams = dataclasses.field()
