...
export class GetGeneGenotypeAssociationsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetGeneGenotypeAssociationsQueryParams extends SpeakeasyBase {
...
export class GetGeneGenotypeAssociationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGeneGenotypeAssociationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
