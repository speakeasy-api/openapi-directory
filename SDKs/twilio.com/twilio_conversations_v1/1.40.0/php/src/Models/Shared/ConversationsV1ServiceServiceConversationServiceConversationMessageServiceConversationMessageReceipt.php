...
class ConversationsV1ServiceServiceConversationServiceConversationMessageServiceConversationMessageReceipt
{
    ...
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\ServiceConversationMessageReceiptEnumDeliveryStatusEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ServiceConversationMessageReceiptEnumDeliveryStatusEnum $status = null;
