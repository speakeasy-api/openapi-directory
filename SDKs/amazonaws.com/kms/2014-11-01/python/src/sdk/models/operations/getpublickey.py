...
from ..shared import getpublickeyrequest as shared_getpublickeyrequest
from ..shared import getpublickeyresponse as shared_getpublickeyresponse
...
class GetPublicKeyHeaders:
    x_amz_target: GetPublicKeyXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPublicKeyRequest:
    headers: GetPublicKeyHeaders = dataclasses.field()
    request: shared_getpublickeyrequest.GetPublicKeyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class GetPublicKeyResponse:
    ...
    get_public_key_response: Optional[shared_getpublickeyresponse.GetPublicKeyResponse] = dataclasses.field(default=None)
