...
func (e RequestNodeCommentsXSdsDateFormatEnum) ToPointer() *RequestNodeCommentsXSdsDateFormatEnum {
	return &e
}
...
func (e *RequestNodeCommentsXSdsDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "EPOCH":
		fallthrough
	case "LEET":
		*e = RequestNodeCommentsXSdsDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestNodeCommentsXSdsDateFormatEnum: %v", v)
	}
}
