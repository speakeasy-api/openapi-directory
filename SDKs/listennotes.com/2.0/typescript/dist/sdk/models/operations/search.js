...
exports.SearchResponse = exports.SearchRequest = exports.SearchHeaders = exports.SearchQueryParams = exports.SearchTypeEnum = void 0;
...
var SearchQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=episode_count_max" }),
        __metadata("design:type", Number)
    ], SearchQueryParams.prototype, "episodeCountMax", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=episode_count_min" }),
        __metadata("design:type", Number)
    ], SearchQueryParams.prototype, "episodeCountMin", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=genre_ids" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=len_max" }),
        __metadata("design:type", Number)
    ], SearchQueryParams.prototype, "lenMax", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=len_min" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=only_in" }),
        __metadata("design:type", String)
    ], SearchQueryParams.prototype, "onlyIn", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=published_after" }),
        __metadata("design:type", Number)
    ], SearchQueryParams.prototype, "publishedAfter", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=published_before" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sort_by_date" }),
        __metadata("design:type", Number)
