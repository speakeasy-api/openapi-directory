...
func (e PlayerGameStatsByDateFormatEnum) ToPointer() *PlayerGameStatsByDateFormatEnum {
	return &e
}
...
func (e *PlayerGameStatsByDateFormatEnum) UnmarshalJSON(data []byte) error {
	...
	case "XML":
		fallthrough
	case "JSON":
		*e = PlayerGameStatsByDateFormatEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PlayerGameStatsByDateFormatEnum: %v", v)
	}
}
