...
exports.DriveFilesUpdateResponse = exports.DriveFilesUpdateRequest = exports.DriveFilesUpdateSecurity = exports.DriveFilesUpdateSecurityOption6 = exports.DriveFilesUpdateSecurityOption5 = exports.DriveFilesUpdateSecurityOption4 = exports.DriveFilesUpdateSecurityOption3 = exports.DriveFilesUpdateSecurityOption2 = exports.DriveFilesUpdateSecurityOption1 = exports.DriveFilesUpdateQueryParams = exports.DriveFilesUpdateModifiedDateBehaviorEnum = exports.DriveFilesUpdatePathParams = void 0;
...
var DriveFilesUpdateModifiedDateBehaviorEnum;
(function (DriveFilesUpdateModifiedDateBehaviorEnum) {
    DriveFilesUpdateModifiedDateBehaviorEnum["FromBody"] = "fromBody";
    DriveFilesUpdateModifiedDateBehaviorEnum["FromBodyIfNeeded"] = "fromBodyIfNeeded";
    DriveFilesUpdateModifiedDateBehaviorEnum["FromBodyOrNow"] = "fromBodyOrNow";
    DriveFilesUpdateModifiedDateBehaviorEnum["NoChange"] = "noChange";
    DriveFilesUpdateModifiedDateBehaviorEnum["Now"] = "now";
    DriveFilesUpdateModifiedDateBehaviorEnum["NowIfNeeded"] = "nowIfNeeded";
})(DriveFilesUpdateModifiedDateBehaviorEnum = exports.DriveFilesUpdateModifiedDateBehaviorEnum || (exports.DriveFilesUpdateModifiedDateBehaviorEnum = {}));
var DriveFilesUpdateQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=convert" }),
        __metadata("design:type", Boolean)
    ], DriveFilesUpdateQueryParams.prototype, "convert", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=modifiedDateBehavior" }),
        __metadata("design:type", String)
    ], DriveFilesUpdateQueryParams.prototype, "modifiedDateBehavior", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=newRevision" }),
        __metadata("design:type", Boolean)
    ], DriveFilesUpdateQueryParams.prototype, "newRevision", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], DriveFilesUpdateQueryParams.prototype, "ocr", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], DriveFilesUpdateQueryParams.prototype, "pinned", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=setModifiedDate" }),
        __metadata("design:type", Boolean)
    ], DriveFilesUpdateQueryParams.prototype, "setModifiedDate", void 0);
    __decorate([
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=timedTextLanguage" }),
        __metadata("design:type", String)
    ], DriveFilesUpdateQueryParams.prototype, "timedTextLanguage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=timedTextTrackName" }),
        __metadata("design:type", String)
    ], DriveFilesUpdateQueryParams.prototype, "timedTextTrackName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=updateViewedDate" }),
        __metadata("design:type", Boolean)
    ], DriveFilesUpdateQueryParams.prototype, "updateViewedDate", void 0);
    __decorate([
...
var DriveFilesUpdateSecurityOption6 = /** @class */ (function (_super) {
    __extends(DriveFilesUpdateSecurityOption6, _super);
    function DriveFilesUpdateSecurityOption6() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2)
    ], DriveFilesUpdateSecurityOption6.prototype, "oauth2", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2c)
    ], DriveFilesUpdateSecurityOption6.prototype, "oauth2c", void 0);
    return DriveFilesUpdateSecurityOption6;
}(utils_1.SpeakeasyBase));
exports.DriveFilesUpdateSecurityOption6 = DriveFilesUpdateSecurityOption6;
var DriveFilesUpdateSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "security, option=true" }),
        __metadata("design:type", DriveFilesUpdateSecurityOption6)
    ], DriveFilesUpdateSecurity.prototype, "option6", void 0);
