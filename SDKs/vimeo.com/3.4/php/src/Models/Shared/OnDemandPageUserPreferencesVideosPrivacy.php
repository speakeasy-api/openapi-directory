...
class OnDemandPageUserPreferencesVideosPrivacy
{
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserPreferencesVideosPrivacyCommentsEnum $comments
     */
	#[\JMS\Serializer\Annotation\SerializedName('comments')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserPreferencesVideosPrivacyCommentsEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageUserPreferencesVideosPrivacyCommentsEnum $comments = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserPreferencesVideosPrivacyEmbedEnum $embed
     */
	#[\JMS\Serializer\Annotation\SerializedName('embed')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserPreferencesVideosPrivacyEmbedEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageUserPreferencesVideosPrivacyEmbedEnum $embed = null;
     ...
     * 
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserPreferencesVideosPrivacyViewEnum $view
     */
	#[\JMS\Serializer\Annotation\SerializedName('view')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\OnDemandPageUserPreferencesVideosPrivacyViewEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OnDemandPageUserPreferencesVideosPrivacyViewEnum $view = null;
