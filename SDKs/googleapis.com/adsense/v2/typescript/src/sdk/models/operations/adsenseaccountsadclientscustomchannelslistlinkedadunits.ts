...
export class AdsenseAccountsAdclientsCustomchannelsListLinkedAdUnitsSecurityOption1 extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class AdsenseAccountsAdclientsCustomchannelsListLinkedAdUnitsSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({
    data: "security, scheme=true;type=oauth2;name=Authorization",
  })
  oauth2: string;
...
export class AdsenseAccountsAdclientsCustomchannelsListLinkedAdUnitsSecurity extends SpeakeasyBase {
...
export class AdsenseAccountsAdclientsCustomchannelsListLinkedAdUnitsRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdsenseAccountsAdclientsCustomchannelsListLinkedAdUnitsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
