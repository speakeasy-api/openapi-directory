...
class SearchTypePointGcnetQueryParams:
...
@dataclasses.dataclass
class SearchTypePointGcnetRequest:
    query_params: SearchTypePointGcnetQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypePointGcnetResponse:
