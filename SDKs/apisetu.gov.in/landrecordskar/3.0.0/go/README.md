...
```bash
go get github.com/speakeasy-api/openapi-directory/SDKs/apisetu.gov.in/landrecordskar/3.0.0/go
```
...
* [Mutan](docs/apis/README.md#mutan) - Mutation Report/ePattadar Passbook
