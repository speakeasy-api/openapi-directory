...
class GetUserUsername200ApplicationJSON:
    ...
    address: Optional[GetUserUsername200ApplicationJSONAddress] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address') }})
...
class GetUserUsernameRequest:
    path_params: GetUserUsernamePathParams = dataclasses.field()
