...
class UnsubscribeFromDatasetRequest:
    ...
    r"""The name of the dataset from which to unsubcribe."""  
    ...
    r"""A name-spaced GUID (for example, us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. The ID of the pool to which this identity belongs."""  
