...
import dataclasses
from ..shared import googleclouddialogflowcxv3beta1experimentresultconfidenceinterval as shared_googleclouddialogflowcxv3beta1experimentresultconfidenceinterval
...
class GoogleCloudDialogflowCxV3beta1ExperimentResultMetric:
    ...
    confidence_interval: Optional[shared_googleclouddialogflowcxv3beta1experimentresultconfidenceinterval.GoogleCloudDialogflowCxV3beta1ExperimentResultConfidenceInterval] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('confidenceInterval'), 'exclude': lambda f: f is None }})
    ...
    count_type: Optional[GoogleCloudDialogflowCxV3beta1ExperimentResultMetricCountTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('countType'), 'exclude': lambda f: f is None }})
    r"""Count-based metric type. Only one of type or count_type is specified in each Metric."""  
    ...
    type: Optional[GoogleCloudDialogflowCxV3beta1ExperimentResultMetricTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})
    r"""Ratio-based metric type. Only one of type or count_type is specified in each Metric."""  
