...
class DescribeVpcPeeringConnectionsRequestFilters:
...
class DescribeVpcPeeringConnectionsRequest:
    ...
    filters: Optional[list[DescribeVpcPeeringConnectionsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    next_token: Optional[str] = dataclasses.field(default=None)  
    vpc_peering_connection_ids: Optional[list[str]] = dataclasses.field(default=None)  
