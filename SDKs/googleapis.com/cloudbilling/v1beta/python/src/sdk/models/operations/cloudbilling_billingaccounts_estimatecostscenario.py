...
class CloudbillingBillingAccountsEstimateCostScenarioRequest:
    ...
    r"""Resource name of the billing account for the cost estimate. The resource name has the form `billingAccounts/{billing_acount_id}`. For example, `billingAccounts/012345-567890-ABCDEF` is the resource name for billing account `012345-567890-ABCDEF`. Must be specified."""  
    ...
    r"""JSONP"""  
    estimate_cost_scenario_for_billing_account_request: Optional[shared_estimatecostscenarioforbillingaccountrequest.EstimateCostScenarioForBillingAccountRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
