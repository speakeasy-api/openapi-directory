...
from ..shared import updatedefaultbranchinput as shared_updatedefaultbranchinput
...
class UpdateDefaultBranchHeaders:
    x_amz_target: UpdateDefaultBranchXAmzTargetEnum = dataclasses.field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDefaultBranchRequest:
    headers: UpdateDefaultBranchHeaders = dataclasses.field()
    request: shared_updatedefaultbranchinput.UpdateDefaultBranchInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
