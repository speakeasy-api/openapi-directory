...
class CreateAssessmentRequestBody:
    ...
    assessment_reports_destination: CreateAssessmentRequestBodyAssessmentReportsDestination = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assessmentReportsDestination') }})
    r"""The location where Audit Manager saves assessment reports for the given assessment."""  
    framework_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('frameworkId') }})
    r"""The identifier for the framework that the assessment will be created from."""  
    name: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('name') }})
    r"""The name of the assessment to be created."""  
    ...
    scope: CreateAssessmentRequestBodyScope = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scope') }})
    r"""The wrapper that contains the Amazon Web Services accounts and services that are in scope for the assessment."""  
    description: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('description'), 'exclude': lambda f: f is None }})
    r"""The optional description of the assessment to be created."""  
    tags: Optional[dict[str, str]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('tags'), 'exclude': lambda f: f is None }})
    r"""The tags that are associated with the assessment."""  
    

@dataclasses.dataclass
class CreateAssessmentRequest:
    
    request_body: CreateAssessmentRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
