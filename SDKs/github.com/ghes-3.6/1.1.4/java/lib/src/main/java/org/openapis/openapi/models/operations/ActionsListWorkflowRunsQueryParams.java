...
public class ActionsListWorkflowRunsQueryParams {
    ...
    public ActionsListWorkflowRunsQueryParams withCheckSuiteId(Long checkSuiteId) {
    ...
    public ActionsListWorkflowRunsQueryParams withCreated(OffsetDateTime created) {
    ...
    public ActionsListWorkflowRunsQueryParams withExcludePullRequests(Boolean excludePullRequests) {
    ...
    public ActionsListWorkflowRunsQueryParams withStatus(org.openapis.openapi.models.shared.WorkflowRunStatusEnum status) {
        this.status = status;
        return this;
    }
