...
public class ContainerProjectsZonesClustersLocationsRequest {
    ...
    public ContainerProjectsZonesClustersLocationsRequest(@JsonProperty("clusterId") String clusterId, @JsonProperty("projectId") String projectId, @JsonProperty("zone") String zone) {
        this.clusterId = clusterId;
        this.projectId = projectId;
        this.zone = zone;
  }
