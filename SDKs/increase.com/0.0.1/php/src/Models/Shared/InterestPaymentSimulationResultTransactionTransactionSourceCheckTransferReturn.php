 ...
 * @access public
 */
class InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferReturn
{
    /**
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum $reason
     */
	#[\JMS\Serializer\Annotation\SerializedName('reason')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum>')]
    public InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum $reason;
	...
	{
		$this->fileId = "";
		$this->reason = \OpenAPI\OpenAPI\Models\Shared\InterestPaymentSimulationResultTransactionTransactionSourceCheckTransferReturnReasonEnum::MAIL_DELIVERY_FAILURE;
