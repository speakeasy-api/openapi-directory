 ...
 */
export enum ExternalVpnGatewayRedundancyTypeEnum {
 ...
 */
export class ExternalVpnGateway extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: ExternalVpnGatewayInterface })
