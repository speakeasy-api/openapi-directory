...
var V1beta1 = /** @class */ (function () {
     ...
     */
    V1beta1.prototype.iapGetIamPolicy = function (req, security, config) {
        var _a;
     ...
     */
    V1beta1.prototype.iapSetIamPolicy = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     */
    V1beta1.prototype.iapTestIamPermissions = function (req, security, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
