...
public class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsImportRequest {
    ...
    public openapisdk.models.shared.GoogleCloudDiscoveryengineV1betaImportDocumentsRequest request;
    public DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsImportRequest withRequest(openapisdk.models.shared.GoogleCloudDiscoveryengineV1betaImportDocumentsRequest request) {
