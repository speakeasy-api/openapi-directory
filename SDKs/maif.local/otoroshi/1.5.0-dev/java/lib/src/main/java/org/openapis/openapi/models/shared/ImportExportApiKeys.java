...
public class ImportExportApiKeys {
    ...
    public ImportExportApiKeys(@JsonProperty("authorizedEntities") String[] authorizedEntities, @JsonProperty("clientId") String clientId, @JsonProperty("clientName") String clientName, @JsonProperty("clientSecret") String clientSecret, @JsonProperty("enabled") Boolean enabled) {
        this.authorizedEntities = authorizedEntities;
        this.clientId = clientId;
        this.clientName = clientName;
        this.clientSecret = clientSecret;
