...
class RespondDecisionTaskCompletedRequest:
    ...
    respond_decision_task_completed_input: shared_responddecisiontaskcompletedinput.RespondDecisionTaskCompletedInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
