...
export class DatacatalogProjectsLocationsTagTemplatesFieldsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsTagTemplatesFieldsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DatacatalogProjectsLocationsTagTemplatesFieldsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
