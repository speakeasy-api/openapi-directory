...
import dataclasses
from ..shared import taskstatusvo as shared_taskstatusvo
...
class TaskStatusListVO:
    r"""Java type: com.noosh.nooshapi.vo.TaskStatusListVO"""
    
    results: Optional[list[shared_taskstatusvo.TaskStatusVO]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('results'), 'exclude': lambda f: f is None }})  
