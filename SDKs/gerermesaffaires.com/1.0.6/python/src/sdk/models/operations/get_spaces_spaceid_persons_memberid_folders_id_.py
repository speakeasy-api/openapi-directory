...
class GetSpacesSpaceIDPersonsMemberIDFoldersIDRequest:
...
class GetSpacesSpaceIDPersonsMemberIDFoldersID200ApplicationJSONLevelEnum(str, Enum):
    CONFIDENTIAL = 'confidential'
    REGULAR = 'regular'
    PUBLIC = 'public'

class GetSpacesSpaceIDPersonsMemberIDFoldersID200ApplicationJSONRightEnum(str, Enum):
    WRITE = 'write'
    READ = 'read'
    NONE = 'none'
...
class GetSpacesSpaceIDPersonsMemberIDFoldersID200ApplicationJSON:
    ...
    level: Optional[GetSpacesSpaceIDPersonsMemberIDFoldersID200ApplicationJSONLevelEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Level'), 'exclude': lambda f: f is None }})  
    ...
    right: Optional[GetSpacesSpaceIDPersonsMemberIDFoldersID200ApplicationJSONRightEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('Right'), 'exclude': lambda f: f is None }})  
...
class GetSpacesSpaceIDPersonsMemberIDFoldersIDResponse:
    ...
    get_spaces_space_id_persons_member_id_folders_id_200_application_json_object: Optional[GetSpacesSpaceIDPersonsMemberIDFoldersID200ApplicationJSON] = dataclasses.field(default=None)
    r"""An access to a folder"""  
