...
from ..shared import listrungroupsresponse as shared_listrungroupsresponse
...
class ListRunGroupsRequest:
    ...
    r"""The maximum number of run groups to return in one page of results."""  
    name: Optional[str] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'name', 'style': 'form', 'explode': True }})
    r"""The run groups' name."""  
...
class ListRunGroupsResponse:
    ...
    list_run_groups_response: Optional[shared_listrungroupsresponse.ListRunGroupsResponse] = dataclasses.field(default=None)
    r"""Success"""  
