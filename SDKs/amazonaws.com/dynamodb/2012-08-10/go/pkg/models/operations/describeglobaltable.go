...
func (e DescribeGlobalTableXAmzTargetEnum) ToPointer() *DescribeGlobalTableXAmzTargetEnum {
	return &e
}
...
func (e *DescribeGlobalTableXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "DynamoDB_20120810.DescribeGlobalTable":
		*e = DescribeGlobalTableXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DescribeGlobalTableXAmzTargetEnum: %v", v)
	}
}
