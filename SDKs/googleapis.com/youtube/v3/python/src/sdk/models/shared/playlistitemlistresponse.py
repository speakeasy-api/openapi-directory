...
class PlaylistItemListResponse:
    ...
    r"""A list of playlist items that match the request criteria."""  
    kind: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('kind'), 'exclude': lambda f: f is None }})
    r"""Identifies what kind of resource this is. Value: the fixed string \\"youtube#playlistItemListResponse\\". Etag of this resource."""  
