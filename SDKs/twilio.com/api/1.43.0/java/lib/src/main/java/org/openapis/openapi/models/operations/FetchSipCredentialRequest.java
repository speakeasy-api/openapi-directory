...
public class FetchSipCredentialRequest {
    ...
    public FetchSipCredentialRequest(@JsonProperty("AccountSid") String accountSid, @JsonProperty("CredentialListSid") String credentialListSid, @JsonProperty("Sid") String sid) {
        this.accountSid = accountSid;
        this.credentialListSid = credentialListSid;
        this.sid = sid;
  }
