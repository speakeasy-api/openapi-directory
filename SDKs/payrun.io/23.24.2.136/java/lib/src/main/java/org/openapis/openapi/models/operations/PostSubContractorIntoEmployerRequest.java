...
public class PostSubContractorIntoEmployerRequest {
    ...
    public PostSubContractorIntoEmployerRequest(@JsonProperty("Api-Version") String apiVersion, @JsonProperty("Authorization") String authorization, @JsonProperty("EmployerId") String employerId, @JsonProperty("SubContractor") org.openapis.openapi.models.shared.SubContractor subContractor) {
        this.apiVersion = apiVersion;
        this.authorization = authorization;
        this.employerId = employerId;
        this.subContractor = subContractor;
