 ...
 */
export enum NotificationEndpointListWarningCodeEnum {
...
export class NotificationEndpointListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NotificationEndpointListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: NotificationEndpointListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: NotificationEndpointListWarningData })
  @Expose({ name: "data" })
  @Type(() => NotificationEndpointListWarningData)
  data?: NotificationEndpointListWarningData[];
 ...
 * Successful response
 */
export class NotificationEndpointList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: NotificationEndpoint })
  @Expose({ name: "items" })
