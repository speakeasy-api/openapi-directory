...
class DisplayvideoAdvertisersLineItemsListRequest:
    ...
    r"""Required. The ID of the advertiser to list line items for."""  
    ...
    r"""A token identifying a page of results the server should return. Typically, this is the value of next_page_token returned from the previous call to `ListLineItems` method. If not specified, the first page of results will be returned."""  
