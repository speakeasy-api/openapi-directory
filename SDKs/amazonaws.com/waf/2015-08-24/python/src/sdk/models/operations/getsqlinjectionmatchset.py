...
class GetSQLInjectionMatchSetRequest:
    ...
    get_sql_injection_match_set_request: shared_getsqlinjectionmatchsetrequest.GetSQLInjectionMatchSetRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
