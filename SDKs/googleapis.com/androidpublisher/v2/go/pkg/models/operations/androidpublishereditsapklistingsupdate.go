...
type AndroidpublisherEditsApklistingsUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidpublisherEditsApklistingsUpdatePathParams struct {
...
type AndroidpublisherEditsApklistingsUpdateQueryParams struct {
...
type AndroidpublisherEditsApklistingsUpdateRequest struct {
...
type AndroidpublisherEditsApklistingsUpdateResponse struct {
	Body        []byte
	ContentType string
	StatusCode  int
