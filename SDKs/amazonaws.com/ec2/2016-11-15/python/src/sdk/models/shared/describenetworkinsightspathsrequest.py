...
class DescribeNetworkInsightsPathsRequestFilters:
...
class DescribeNetworkInsightsPathsRequest:
    ...
    filters: Optional[list[DescribeNetworkInsightsPathsRequestFilters]] = dataclasses.field(default=None)  
    max_results: Optional[int] = dataclasses.field(default=None)  
    network_insights_path_ids: Optional[list[str]] = dataclasses.field(default=None)  
