 ...
 */
public enum WebinarCreate201ApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum {
    ONE("1"),
    TWO("2"),
    THREE("3"),
    FOUR("4"),
    ...
    private WebinarCreate201ApplicationJSONRecurrenceWebinarMonthlyWeekDayEnum(String value) {
        this.value = value;
    }
}
