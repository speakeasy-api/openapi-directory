...
class EditSubaccount:
    ...
    def subaccount_edit(self, request: shared.SubaccountRequest) -> operations.SubaccountEditResponse:
        r"""Edit a subaccount
        Edit a subaccount
        """
        ...
        res = operations.SubaccountEditResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
