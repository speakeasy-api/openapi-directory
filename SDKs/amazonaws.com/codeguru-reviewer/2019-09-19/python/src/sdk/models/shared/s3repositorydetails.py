...
class S3RepositoryDetails:
    ...
    code_artifacts: Optional[shared_codeartifacts.CodeArtifacts] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CodeArtifacts') }})
