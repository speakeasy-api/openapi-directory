 ...
 */
export enum StoredValueBalanceMergeRequestShopperInteractionEnum {
  Ecommerce = "Ecommerce",
  ContAuth = "ContAuth",
  Moto = "Moto",
  Pos = "POS",
...
export class StoredValueBalanceMergeRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  @Expose({ name: "amount" })
  @Type(() => Amount)
  amount?: Amount;
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "sourcePaymentMethod" })
