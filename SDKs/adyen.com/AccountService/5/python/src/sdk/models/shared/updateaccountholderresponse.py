...
class UpdateAccountHolderResponseLegalEntityEnum(str, Enum):
...
class UpdateAccountHolderResponse:
    ...
    legal_entity: Optional[UpdateAccountHolderResponseLegalEntityEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('legalEntity'), 'exclude': lambda f: f is None }})
    r"""The legal entity of the account holder."""  
