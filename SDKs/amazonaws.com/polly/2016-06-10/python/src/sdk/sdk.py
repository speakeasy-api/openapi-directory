...
SERVERS = [
    ...
    r"""The Amazon Polly multi-region endpoint"""
    "https://polly.{region}.amazonaws.com",
    r"""The Amazon Polly multi-region endpoint"""
    "http://polly.{region}.amazonaws.com.cn",
    r"""The Amazon Polly endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    ...
    def delete_lexicon(self, request: operations.DeleteLexiconRequest) -> operations.DeleteLexiconResponse:
        ...
        url = utils.generate_url(operations.DeleteLexiconRequest, base_url, '/v1/lexicons/{LexiconName}', request)
        ...
        res = operations.DeleteLexiconResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def describe_voices(self, request: operations.DescribeVoicesRequest) -> operations.DescribeVoicesResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.DescribeVoicesRequest, request)
        ...
        res = operations.DescribeVoicesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.DescribeVoicesOutput])
    ...
    def get_lexicon(self, request: operations.GetLexiconRequest) -> operations.GetLexiconResponse:
        ...
        url = utils.generate_url(operations.GetLexiconRequest, base_url, '/v1/lexicons/{LexiconName}', request)
        ...
        res = operations.GetLexiconResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetLexiconOutput])
    ...
    def get_speech_synthesis_task(self, request: operations.GetSpeechSynthesisTaskRequest) -> operations.GetSpeechSynthesisTaskResponse:
        ...
        url = utils.generate_url(operations.GetSpeechSynthesisTaskRequest, base_url, '/v1/synthesisTasks/{TaskId}', request)
        ...
        res = operations.GetSpeechSynthesisTaskResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetSpeechSynthesisTaskOutput])
    ...
    def list_lexicons(self, request: operations.ListLexiconsRequest) -> operations.ListLexiconsResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ListLexiconsRequest, request)
        ...
        res = operations.ListLexiconsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListLexiconsOutput])
    ...
    def list_speech_synthesis_tasks(self, request: operations.ListSpeechSynthesisTasksRequest) -> operations.ListSpeechSynthesisTasksResponse:
        ...
        headers = utils.get_headers(request)
        query_params = utils.get_query_params(operations.ListSpeechSynthesisTasksRequest, request)
        ...
        res = operations.ListSpeechSynthesisTasksResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListSpeechSynthesisTasksOutput])
    ...
    def put_lexicon(self, request: operations.PutLexiconRequest) -> operations.PutLexiconResponse:
        ...
        url = utils.generate_url(operations.PutLexiconRequest, base_url, '/v1/lexicons/{LexiconName}', request)
        ...
        res = operations.PutLexiconResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def start_speech_synthesis_task(self, request: operations.StartSpeechSynthesisTaskRequest) -> operations.StartSpeechSynthesisTaskResponse:
        ...
        res = operations.StartSpeechSynthesisTaskResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.StartSpeechSynthesisTaskOutput])
    ...
    def synthesize_speech(self, request: operations.SynthesizeSpeechRequest) -> operations.SynthesizeSpeechResponse:
        ...
        res = operations.SynthesizeSpeechResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.SynthesizeSpeechOutput])
