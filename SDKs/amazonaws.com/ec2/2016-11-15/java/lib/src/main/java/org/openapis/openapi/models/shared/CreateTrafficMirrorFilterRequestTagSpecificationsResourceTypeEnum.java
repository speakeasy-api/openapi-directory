 ...
 */
public enum CreateTrafficMirrorFilterRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateTrafficMirrorFilterRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
