...
public class GetDistanceOutputFormatRequest {
    ...
    public GetDistanceOutputFormatRequest withCorrectSide(Boolean correctSide) {
    ...
    public GetDistanceOutputFormatRequest withCriteria(GetDistanceOutputFormatCriteriaEnum criteria) {
    ...
    public GetDistanceOutputFormatRequest withDeparture(OffsetDateTime departure) {
    ...
    public GetDistanceOutputFormatRequest withDisable(String disable) {
    ...
    public GetDistanceOutputFormatRequest withDistanceUnit(GetDistanceOutputFormatDistanceUnitEnum distanceUnit) {
    ...
    public GetDistanceOutputFormatRequest withOutputFormat(GetDistanceOutputFormatOutputFormatEnum outputFormat) {
    ...
    public GetDistanceOutputFormatOutputSrsEnum outputSRS;

    public GetDistanceOutputFormatRequest withOutputSRS(GetDistanceOutputFormatOutputSrsEnum outputSRS) {
    ...
    public GetDistanceOutputFormatRequest withPoints(String points) {
        this.points = points;
        return this;
    }
    ...
    public GetDistanceOutputFormatRequest withRoundTrip(Boolean roundTrip) {
    ...
    public GetDistanceOutputFormatRequest withRouteDescription(String routeDescription) {
        this.routeDescription = routeDescription;
        return this;
    }
    
    public GetDistanceOutputFormatRequest(@JsonProperty("outputFormat") GetDistanceOutputFormatOutputFormatEnum outputFormat, @JsonProperty("points") String points) {
        this.outputFormat = outputFormat;
        this.points = points;
  }
}
