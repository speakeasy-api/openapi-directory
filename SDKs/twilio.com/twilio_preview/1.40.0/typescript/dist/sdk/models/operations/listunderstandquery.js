...
exports.ListUnderstandQueryResponse = exports.ListUnderstandQueryListUnderstandQueryResponse = exports.ListUnderstandQueryListUnderstandQueryResponseMeta = exports.ListUnderstandQueryRequest = exports.ListUnderstandQuerySecurity = exports.ListUnderstandQueryServerList = void 0;
...
var ListUnderstandQuerySecurity = /** @class */ (function (_super) {
    ...
    ], ListUnderstandQuerySecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListUnderstandQuerySecurity.prototype, "username", void 0);
...
var ListUnderstandQueryRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListUnderstandQueryRequest.prototype, "assistantSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Language",
        }),
        __metadata("design:type", String)
    ], ListUnderstandQueryRequest.prototype, "language", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=ModelBuild",
        }),
        __metadata("design:type", String)
    ], ListUnderstandQueryRequest.prototype, "modelBuild", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListUnderstandQueryRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListUnderstandQueryRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListUnderstandQueryRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListUnderstandQueryRequest.prototype, "status", void 0);
...
var ListUnderstandQueryListUnderstandQueryResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListUnderstandQueryListUnderstandQueryResponseMeta; }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.PreviewUnderstandAssistantQuery }),
        (0, class_transformer_1.Expose)({ name: "queries" }),
        (0, class_transformer_1.Type)(function () { return shared.PreviewUnderstandAssistantQuery; }),
...
var ListUnderstandQueryResponse = /** @class */ (function (_super) {
    ...
    ], ListUnderstandQueryResponse.prototype, "rawResponse", void 0);
