...
export declare class Transfer {
     ...
     */
    getTransfer(req: operations.GetTransferRequest, security: operations.GetTransferSecurity, config?: AxiosRequestConfig): Promise<operations.GetTransferResponse>;
}
