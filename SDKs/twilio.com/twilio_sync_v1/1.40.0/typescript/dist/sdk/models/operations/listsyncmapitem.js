...
exports.ListSyncMapItemResponse = exports.ListSyncMapItemListSyncMapItemResponse = exports.ListSyncMapItemListSyncMapItemResponseMeta = exports.ListSyncMapItemRequest = exports.ListSyncMapItemSecurity = exports.ListSyncMapItemServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSyncMapItemServerList = ["https://sync.twilio.com"];
var ListSyncMapItemSecurity = /** @class */ (function (_super) {
    ...
    ], ListSyncMapItemSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSyncMapItemSecurity.prototype, "username", void 0);
...
var ListSyncMapItemRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSyncMapItemRequest.prototype, "bounds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=From" }),
        __metadata("design:type", String)
    ], ListSyncMapItemRequest.prototype, "from", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=MapSid",
        }),
        __metadata("design:type", String)
    ], ListSyncMapItemRequest.prototype, "mapSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Order" }),
        __metadata("design:type", String)
    ], ListSyncMapItemRequest.prototype, "order", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSyncMapItemRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSyncMapItemRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSyncMapItemRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListSyncMapItemRequest.prototype, "serviceSid", void 0);
...
var ListSyncMapItemListSyncMapItemResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.SyncV1ServiceSyncMapSyncMapItem }),
        (0, class_transformer_1.Expose)({ name: "items" }),
        (0, class_transformer_1.Type)(function () { return shared.SyncV1ServiceSyncMapSyncMapItem; }),
        __metadata("design:type", Array)
    ], ListSyncMapItemListSyncMapItemResponse.prototype, "items", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "meta" }),
        (0, class_transformer_1.Type)(function () { return ListSyncMapItemListSyncMapItemResponseMeta; }),
...
var ListSyncMapItemResponse = /** @class */ (function (_super) {
    ...
    ], ListSyncMapItemResponse.prototype, "rawResponse", void 0);
