...
public class GetVillagersHeaders {
    /**
    ...
    public GetVillagersHeaders withAcceptVersion(String acceptVersion) {
    ...
    public GetVillagersHeaders withXApiKey(String xApiKey) {
