...
type RecommenderProjectsLocationsRecommendersRecommendationsMarkDismissedRequest struct {
	...
	GoogleCloudRecommenderV1MarkRecommendationDismissedRequest *shared.GoogleCloudRecommenderV1MarkRecommendationDismissedRequest `request:"mediaType=application/json"`
	// OAuth access token.
