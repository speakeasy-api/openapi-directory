...
class UpdateCampaignRequestBody:
    ...
    write_campaign_request: UpdateCampaignRequestBodyWriteCampaignRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('WriteCampaignRequest') }})
    r"""Specifies the configuration and other settings for a campaign."""  
...
class UpdateCampaignRequest:
    ...
    request_body: UpdateCampaignRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
