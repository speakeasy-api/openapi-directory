...
class GetResumeClusterQueryParams:
    action: GetResumeClusterActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cluster_identifier: str = dataclasses.field(metadata={'query_param': { 'field_name': 'ClusterIdentifier', 'style': 'form', 'explode': True }})
    version: GetResumeClusterVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetResumeClusterRequest:
    headers: GetResumeClusterHeaders = dataclasses.field()
    query_params: GetResumeClusterQueryParams = dataclasses.field()
