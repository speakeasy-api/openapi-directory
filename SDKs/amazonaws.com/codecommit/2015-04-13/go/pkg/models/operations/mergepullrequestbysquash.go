...
func (e MergePullRequestBySquashXAmzTargetEnum) ToPointer() *MergePullRequestBySquashXAmzTargetEnum {
	return &e
}
...
func (e *MergePullRequestBySquashXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "CodeCommit_20150413.MergePullRequestBySquash":
		*e = MergePullRequestBySquashXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for MergePullRequestBySquashXAmzTargetEnum: %v", v)
	}
}
