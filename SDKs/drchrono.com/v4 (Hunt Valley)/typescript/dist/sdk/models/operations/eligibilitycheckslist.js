...
exports.EligibilityChecksListResponse = exports.EligibilityChecksList200ApplicationJSON = exports.EligibilityChecksListRequest = exports.EligibilityChecksListSecurity = void 0;
...
var EligibilityChecksListRequest = /** @class */ (function (_super) {
    ...
    ], EligibilityChecksListRequest.prototype, "appointment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=appointment_date",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksListRequest.prototype, "appointmentDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=appointment_date_range",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksListRequest.prototype, "appointmentDateRange", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=cursor",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksListRequest.prototype, "cursor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], EligibilityChecksListRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=page_size",
        }),
        __metadata("design:type", Number)
    ], EligibilityChecksListRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], EligibilityChecksListRequest.prototype, "patient", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=query_date",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksListRequest.prototype, "queryDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=query_date_range",
        }),
        __metadata("design:type", String)
    ], EligibilityChecksListRequest.prototype, "queryDateRange", void 0);
...
var EligibilityChecksList200ApplicationJSON = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.Coverage }),
        (0, class_transformer_1.Expose)({ name: "data" }),
        (0, class_transformer_1.Type)(function () { return shared.Coverage; }),
...
var EligibilityChecksListResponse = /** @class */ (function (_super) {
    ...
    ], EligibilityChecksListResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
