...
export class ContentAccountsListlinksSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class ContentAccountsListlinksRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class ContentAccountsListlinksResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
