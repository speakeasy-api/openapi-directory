...
export class RetailProjectsLocationsCatalogsModelsCreateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsModelsCreateRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class RetailProjectsLocationsCatalogsModelsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
