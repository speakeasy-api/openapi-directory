...
export class DeleteStreamingDistribution20171030Request extends SpeakeasyBase {
  /**
   * The distribution ID.
   */
...
export class DeleteStreamingDistribution20171030Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
