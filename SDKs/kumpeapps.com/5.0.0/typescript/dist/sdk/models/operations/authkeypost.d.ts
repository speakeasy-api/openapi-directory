...
export declare class AuthkeyPostSecurity extends SpeakeasyBase {
    appKey: string;
}
export declare class AuthkeyPostRequest extends SpeakeasyBase {
    /**
...
export declare class AuthkeyPostResponse extends SpeakeasyBase {
    /**
     * Access Denied
     */
