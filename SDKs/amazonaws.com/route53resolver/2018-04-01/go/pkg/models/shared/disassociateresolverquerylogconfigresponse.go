...
type DisassociateResolverQueryLogConfigResponseResolverQueryLogConfigAssociation struct {
...
type DisassociateResolverQueryLogConfigResponse struct {
	ResolverQueryLogConfigAssociation *DisassociateResolverQueryLogConfigResponseResolverQueryLogConfigAssociation `json:"ResolverQueryLogConfigAssociation,omitempty"`
}
