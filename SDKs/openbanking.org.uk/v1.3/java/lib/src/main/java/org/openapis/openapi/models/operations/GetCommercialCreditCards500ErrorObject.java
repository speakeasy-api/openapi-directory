...
public class GetCommercialCreditCards500ErrorObject {
    ...
    public GetCommercialCreditCards500ErrorObject(@JsonProperty("description") GetCommercialCreditCards500ErrorObjectDescriptionEnum description, @JsonProperty("status") GetCommercialCreditCards500ErrorObjectStatusEnum status, @JsonProperty("title") GetCommercialCreditCards500ErrorObjectTitleEnum title) {
        this.description = description;
        this.status = status;
        this.title = title;
  }
