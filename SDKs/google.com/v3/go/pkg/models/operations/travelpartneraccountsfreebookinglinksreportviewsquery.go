...
type TravelpartnerAccountsFreeBookingLinksReportViewsQueryPathParams struct {
	// The resource name of the account being queried. Format: accounts/{account_id}
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type TravelpartnerAccountsFreeBookingLinksReportViewsQueryQueryParams struct {
	// V1 error format.
...
type TravelpartnerAccountsFreeBookingLinksReportViewsQueryRequest struct {
	PathParams  TravelpartnerAccountsFreeBookingLinksReportViewsQueryPathParams
	QueryParams TravelpartnerAccountsFreeBookingLinksReportViewsQueryQueryParams
}
