...
class OpenInstancePublicPortsRequest:
    ...
    open_instance_public_ports_request: shared_openinstancepublicportsrequest.OpenInstancePublicPortsRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
