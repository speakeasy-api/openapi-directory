...
public class OrderApiChangeStatusJsonHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-auth-key")
    public String xAuthKey;
    public OrderApiChangeStatusJsonHeaders withXAuthKey(String xAuthKey) {
    ...
    public OrderApiChangeStatusJsonHeaders withXAuthSecret(String xAuthSecret) {
