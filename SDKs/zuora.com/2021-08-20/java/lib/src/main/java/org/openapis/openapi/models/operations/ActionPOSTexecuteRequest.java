...
public class ActionPOSTexecuteRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActionexecuteRequest proxyActionexecuteRequest;
    public ActionPOSTexecuteRequest withProxyActionexecuteRequest(org.openapis.openapi.models.shared.ProxyActionexecuteRequest proxyActionexecuteRequest) {
        this.proxyActionexecuteRequest = proxyActionexecuteRequest;
        return this;
    }
    ...
    public ActionPOSTexecuteRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTexecuteRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTexecuteRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTexecuteRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
