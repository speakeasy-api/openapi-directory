...
export class AdvisorynotificationsOrganizationsLocationsNotificationsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
 ...
 */
export enum AdvisorynotificationsOrganizationsLocationsNotificationsListViewEnum {
  NotificationViewUnspecified = "NOTIFICATION_VIEW_UNSPECIFIED",
  Basic = "BASIC",
  Full = "FULL",
}

export class AdvisorynotificationsOrganizationsLocationsNotificationsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class AdvisorynotificationsOrganizationsLocationsNotificationsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
