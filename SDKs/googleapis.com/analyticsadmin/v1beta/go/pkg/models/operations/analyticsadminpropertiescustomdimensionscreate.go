...
type AnalyticsadminPropertiesCustomDimensionsCreateRequest struct {
	...
	Request     *shared.GoogleAnalyticsAdminV1betaCustomDimensionInput `request:"mediaType=application/json"`
...
type AnalyticsadminPropertiesCustomDimensionsCreateResponse struct {
	ContentType                               string
	GoogleAnalyticsAdminV1betaCustomDimension *shared.GoogleAnalyticsAdminV1betaCustomDimension
	StatusCode                                int64
}
