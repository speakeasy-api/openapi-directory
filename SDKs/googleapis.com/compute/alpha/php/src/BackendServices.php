...
class BackendServices 
{
     ...
     * 
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsRequest $request
     * @param \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsSecurity $security
     * @return \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsResponse
     */
	public function computeBackendServicesTestIamPermissions(
        \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsRequest $request,
        \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsSecurity $security,
    ): \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsResponse
    {
        $baseUrl = $this->_serverUrl;
        $url = Utils\Utils::generateUrl($baseUrl, '/projects/{project}/global/backendServices/{resource}/testIamPermissions', \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsRequest::class, $request);
        
        $options = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, "testPermissionsRequest", "json");
        $options = array_merge_recursive($options, $body);
        $options = array_merge_recursive($options, Utils\Utils::getQueryParams(\OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsRequest::class, $request, null));
        ...
        $response = new \OpenAPI\OpenAPI\Models\Operations\ComputeBackendServicesTestIamPermissionsResponse();
        $response->statusCode = $httpResponse->getStatusCode();
        $response->contentType = $contentType;
        $response->rawResponse = $httpResponse;
