...
class Error405PISCANCAdditionalErrors:
    ...
    code: shared_messagecode405_pis_canc_enum.MessageCode405PISCANCEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code') }})
...
class Error405PISCANC:
    ...
    additional_errors: Optional[list[Error405PISCANCAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
