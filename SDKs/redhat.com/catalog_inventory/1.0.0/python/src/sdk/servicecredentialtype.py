...
class ServiceCredentialType:
    ...
    def list_service_credential_types(self, request: operations.ListServiceCredentialTypesRequest) -> operations.ListServiceCredentialTypesResponse:
        ...
        query_params = utils.get_query_params(operations.ListServiceCredentialTypesRequest, request)
        ...
        res = operations.ListServiceCredentialTypesResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ServiceCredentialTypesCollection])
    ...
    def show_service_credential_type(self, request: operations.ShowServiceCredentialTypeRequest) -> operations.ShowServiceCredentialTypeResponse:
        ...
        url = utils.generate_url(operations.ShowServiceCredentialTypeRequest, base_url, '/service_credential_types/{id}', request)
        ...
        res = operations.ShowServiceCredentialTypeResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ServiceCredentialType])
