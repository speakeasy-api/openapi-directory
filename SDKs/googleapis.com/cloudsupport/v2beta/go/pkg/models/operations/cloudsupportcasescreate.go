...
type CloudsupportCasesCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudsupportCasesCreatePathParams struct {
	// Required. The name of the Cloud resource under which the case should be created.
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type CloudsupportCasesCreateQueryParams struct {
	// V1 error format.
...
type CloudsupportCasesCreateResponse struct {
	// Successful response
	Case        *shared.Case
	ContentType string
	StatusCode  int
