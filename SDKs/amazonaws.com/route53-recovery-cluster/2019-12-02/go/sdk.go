...
func (s *SDK) GetRoutingControlState(ctx context.Context, request operations.GetRoutingControlStateRequest) (*operations.GetRoutingControlStateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "GetRoutingControlStateRequest", "json")
	if err != nil {
...
func (s *SDK) ListRoutingControls(ctx context.Context, request operations.ListRoutingControlsRequest) (*operations.ListRoutingControlsResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ListRoutingControlsRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) UpdateRoutingControlState(ctx context.Context, request operations.UpdateRoutingControlStateRequest) (*operations.UpdateRoutingControlStateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateRoutingControlStateRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *SDK) UpdateRoutingControlStates(ctx context.Context, request operations.UpdateRoutingControlStatesRequest) (*operations.UpdateRoutingControlStatesResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "UpdateRoutingControlStatesRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
