...
public class UpdateNetworkApplianceFirewallPortForwardingRulesRequestBody {
    ...
    public UpdateNetworkApplianceFirewallPortForwardingRulesRequestBody(@JsonProperty("rules") UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRules[] rules) {
        this.rules = rules;
  }
}
