...
class ItemsDeleteRequest:
    headers: ItemsDeleteHeaders = dataclasses.field()
    path_params: ItemsDeletePathParams = dataclasses.field()
    query_params: ItemsDeleteQueryParams = dataclasses.field()
    security: ItemsDeleteSecurity = dataclasses.field()
