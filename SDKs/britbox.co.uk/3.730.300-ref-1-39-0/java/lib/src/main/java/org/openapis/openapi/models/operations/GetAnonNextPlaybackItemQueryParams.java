...
public class GetAnonNextPlaybackItemQueryParams {
    /**
     * The type of device the content is targeting.
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=device")
    public String device;
    public GetAnonNextPlaybackItemQueryParams withDevice(String device) {
        this.device = device;
        return this;
    }
    ...
    public GetAnonNextPlaybackItemQueryParams withExpand(GetAnonNextPlaybackItemExpandEnum expand) {
        this.expand = expand;
        return this;
    }
    ...
    public GetAnonNextPlaybackItemQueryParams withFf(org.openapis.openapi.models.shared.FeatureFlagsEnum[] ff) {
        this.ff = ff;
        return this;
    }
    ...
    public String lang;
    public GetAnonNextPlaybackItemQueryParams withLang(String lang) {
        this.lang = lang;
        return this;
    }
    ...
    public GetAnonNextPlaybackItemQueryParams withMaxRating(String maxRating) {
    ...
    public GetAnonNextPlaybackItemQueryParams withSegments(String[] segments) {
