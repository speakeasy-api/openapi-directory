...
from ..shared import getexportjobsresponse as shared_getexportjobsresponse


@dataclasses.dataclass
class GetExportJobsPathParams:
    application_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'application-id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetExportJobsQueryParams:
...
class GetExportJobsRequest:
    headers: GetExportJobsHeaders = dataclasses.field()
    path_params: GetExportJobsPathParams = dataclasses.field()
    query_params: GetExportJobsQueryParams = dataclasses.field()
...
class GetExportJobsResponse:
    ...
    get_export_jobs_response: Optional[shared_getexportjobsresponse.GetExportJobsResponse] = dataclasses.field(default=None)
