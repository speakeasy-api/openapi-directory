...
type DisplayvideoAdvertisersYoutubeAdGroupAdsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoAdvertisersYoutubeAdGroupAdsListPathParams struct {
	// Required. The ID of the advertiser the ad groups belongs to.
	AdvertiserID string `pathParam:"style=simple,explode=false,name=advertiserId"`
}

type DisplayvideoAdvertisersYoutubeAdGroupAdsListQueryParams struct {
	// V1 error format.
...
type DisplayvideoAdvertisersYoutubeAdGroupAdsListRequest struct {
	PathParams  DisplayvideoAdvertisersYoutubeAdGroupAdsListPathParams
	QueryParams DisplayvideoAdvertisersYoutubeAdGroupAdsListQueryParams
	Security    DisplayvideoAdvertisersYoutubeAdGroupAdsListSecurity
}

type DisplayvideoAdvertisersYoutubeAdGroupAdsListResponse struct {
	ContentType string
	// Successful response
