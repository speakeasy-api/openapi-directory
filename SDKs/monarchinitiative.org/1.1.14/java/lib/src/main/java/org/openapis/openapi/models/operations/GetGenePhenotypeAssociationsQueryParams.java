...
public class GetGenePhenotypeAssociationsQueryParams {
    /**
    ...
    public GetGenePhenotypeAssociationsQueryParams withDirect(Boolean direct) {
        this.direct = direct;
        return this;
    }
    ...
    public GetGenePhenotypeAssociationsQueryParams withDirectTaxon(Boolean directTaxon) {
    ...
    public GetGenePhenotypeAssociationsQueryParams withEvidence(String evidence) {
    ...
    public GetGenePhenotypeAssociationsQueryParams withExcludeAutomaticAssertions(Boolean excludeAutomaticAssertions) {
    ...
    public GetGenePhenotypeAssociationsQueryParams withFacet(Boolean facet) {
        this.facet = facet;
        return this;
    }
    ...
    public GetGenePhenotypeAssociationsQueryParams withFacetFields(String[] facetFields) {
    ...
    public GetGenePhenotypeAssociationsQueryParams withFetchObjects(Boolean fetchObjects) {
    ...
    public String q;
    public GetGenePhenotypeAssociationsQueryParams withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetGenePhenotypeAssociationsQueryParams withRelation(String relation) {
    ...
    public Long rows;
    public GetGenePhenotypeAssociationsQueryParams withRows(Long rows) {
        this.rows = rows;
        return this;
    }
    ...
    public String[] slim;
    public GetGenePhenotypeAssociationsQueryParams withSlim(String[] slim) {
        this.slim = slim;
        return this;
    }
    ...
    public String sort;
    public GetGenePhenotypeAssociationsQueryParams withSort(String sort) {
        this.sort = sort;
        return this;
    }
    ...
    public Long start;
    public GetGenePhenotypeAssociationsQueryParams withStart(Long start) {
        this.start = start;
        return this;
    }
    ...
    public String[] taxon;
    public GetGenePhenotypeAssociationsQueryParams withTaxon(String[] taxon) {
        this.taxon = taxon;
        return this;
    }
    ...
    public GetGenePhenotypeAssociationsQueryParams withUnselectEvidence(Boolean unselectEvidence) {
    ...
    public GetGenePhenotypeAssociationsQueryParams withUseCompactAssociations(Boolean useCompactAssociations) {
