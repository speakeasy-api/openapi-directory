...
/**
 * GETRSDetailWithoutSuccessType - Container for custom fields of a Revenue Schedule object.
 * 
 */
public class GETRSDetailWithoutSuccessType {
    ...
    public GETRSDetailWithoutSuccessType withAccountId(String accountId) {
    ...
    public GETRSDetailWithoutSuccessType withAmount(String amount) {
        this.amount = amount;
        return this;
    }
    ...
    public GETRSDetailWithoutSuccessType withCreatedOn(OffsetDateTime createdOn) {
    ...
    public GETRSDetailWithoutSuccessType withCurrency(String currency) {
    ...
    public GETRSDetailWithoutSuccessType withLinkedTransactionId(String linkedTransactionId) {
    ...
    public GETRSDetailWithoutSuccessType withLinkedTransactionNumber(String linkedTransactionNumber) {
    ...
    public GETRSDetailWithoutSuccessType withLinkedTransactionType(String linkedTransactionType) {
    ...
    @JsonProperty("notes")
    public String notes;
    public GETRSDetailWithoutSuccessType withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public GETRSDetailWithoutSuccessType withNumber(String number) {
        this.number = number;
        return this;
    }
    ...
    public GETRSDetailWithoutSuccessType withRecognitionRuleName(String recognitionRuleName) {
    ...
    public GETRSDetailWithoutSuccessType withRecognizedRevenue(String recognizedRevenue) {
    ...
    public GETRSDetailWithoutSuccessType withReferenceId(String referenceId) {
    ...
    public GETRSDetailWithoutSuccessType withRevenueItems(GETRsRevenueItemType[] revenueItems) {
    ...
    public GETRSDetailWithoutSuccessType withRevenueScheduleDate(LocalDate revenueScheduleDate) {
    ...
    public GETRSDetailWithoutSuccessType withSubscriptionChargeId(String subscriptionChargeId) {
    ...
    public GETRSDetailWithoutSuccessType withSubscriptionId(String subscriptionId) {
    ...
    public GETRSDetailWithoutSuccessType withUndistributedUnrecognizedRevenue(String undistributedUnrecognizedRevenue) {
    ...
    public GETRSDetailWithoutSuccessType withUnrecognizedRevenue(String unrecognizedRevenue) {
    ...
    public GETRSDetailWithoutSuccessType withUpdatedOn(OffsetDateTime updatedOn) {
