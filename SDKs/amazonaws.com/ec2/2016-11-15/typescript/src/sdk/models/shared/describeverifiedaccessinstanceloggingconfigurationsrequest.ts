 ...
 */
export class DescribeVerifiedAccessInstanceLoggingConfigurationsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class DescribeVerifiedAccessInstanceLoggingConfigurationsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;
