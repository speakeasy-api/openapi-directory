...
export class DcimRearPortsListQueryParams extends SpeakeasyBase {
...
export class DcimRearPortsList200ApplicationJson extends SpeakeasyBase {
...
export class DcimRearPortsListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: DcimRearPortsListQueryParams;
}


export class DcimRearPortsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
