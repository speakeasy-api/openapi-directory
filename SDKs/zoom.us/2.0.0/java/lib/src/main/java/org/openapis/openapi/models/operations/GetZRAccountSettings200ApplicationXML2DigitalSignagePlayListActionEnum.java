 ...
 * 
 */
public enum GetZRAccountSettings200ApplicationXML2DigitalSignagePlayListActionEnum {
    ADD("add"),
    UPDATE("update"),
    DELETE("delete");
    ...
    private GetZRAccountSettings200ApplicationXML2DigitalSignagePlayListActionEnum(String value) {
        this.value = value;
    }
}
