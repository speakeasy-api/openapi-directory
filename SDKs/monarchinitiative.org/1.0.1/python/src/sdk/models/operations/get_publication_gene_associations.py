...
class GetPublicationGeneAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetPublicationGeneAssociationsQueryParams:
...
class GetPublicationGeneAssociationsRequest:
    path_params: GetPublicationGeneAssociationsPathParams = dataclasses.field()
    query_params: GetPublicationGeneAssociationsQueryParams = dataclasses.field()
