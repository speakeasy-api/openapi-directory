...
class PutConfigurationSetSuppressionOptionsRequest:
    ...
    r"""The name of the configuration set to change the suppression list preferences for."""  
    request_body: PutConfigurationSetSuppressionOptionsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
