...
export class GetNetworkClientsBandwidthUsageHistoryRequest extends SpeakeasyBase {
  /**
...
export class GetNetworkClientsBandwidthUsageHistoryResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkClientsBandwidthUsageHistory200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
