...
type CreateGUISessionAccessDetailsHeaders struct {
...
type CreateGUISessionAccessDetailsRequest struct {
	Headers CreateGUISessionAccessDetailsHeaders
	Request shared.CreateGUISessionAccessDetailsRequest `request:"mediaType=application/json"`
}
