...
class GetHLSStreamingSessionURLRequestBody
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyContainerFormatEnum $containerFormat
     */
	#[\JMS\Serializer\Annotation\SerializedName('ContainerFormat')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyContainerFormatEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetHLSStreamingSessionURLRequestBodyContainerFormatEnum $containerFormat = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyDiscontinuityModeEnum $discontinuityMode
     */
	#[\JMS\Serializer\Annotation\SerializedName('DiscontinuityMode')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyDiscontinuityModeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetHLSStreamingSessionURLRequestBodyDiscontinuityModeEnum $discontinuityMode = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum $displayFragmentTimestamp
     */
	#[\JMS\Serializer\Annotation\SerializedName('DisplayFragmentTimestamp')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetHLSStreamingSessionURLRequestBodyDisplayFragmentTimestampEnum $displayFragmentTimestamp = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyHLSFragmentSelector $hlsFragmentSelector
     */
	#[\JMS\Serializer\Annotation\SerializedName('HLSFragmentSelector')]
    #[\JMS\Serializer\Annotation\Type('OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyHLSFragmentSelector')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetHLSStreamingSessionURLRequestBodyHLSFragmentSelector $hlsFragmentSelector = null;
     ...
     * 
     * @var ?int $maxMediaPlaylistFragmentResults
     */
	#[\JMS\Serializer\Annotation\SerializedName('MaxMediaPlaylistFragmentResults')]
    #[\JMS\Serializer\Annotation\Type('int')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?int $maxMediaPlaylistFragmentResults = null;
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyPlaybackModeEnum $playbackMode
     */
	#[\JMS\Serializer\Annotation\SerializedName('PlaybackMode')]
    #[\JMS\Serializer\Annotation\Type('enum<OpenAPI\OpenAPI\Models\Operations\GetHLSStreamingSessionURLRequestBodyPlaybackModeEnum>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?GetHLSStreamingSessionURLRequestBodyPlaybackModeEnum $playbackMode = null;
	...
	public function __construct()
	{
		...
		$this->discontinuityMode = null;
		$this->displayFragmentTimestamp = null;
		$this->expires = null;
		$this->hlsFragmentSelector = null;
		$this->maxMediaPlaylistFragmentResults = null;
