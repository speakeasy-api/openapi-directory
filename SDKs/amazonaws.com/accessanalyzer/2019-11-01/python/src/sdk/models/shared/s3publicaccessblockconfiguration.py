...
class S3PublicAccessBlockConfiguration:
    ...
    ignore_public_acls: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ignorePublicAcls') }})
    restrict_public_buckets: bool = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('restrictPublicBuckets') }})
