...
class OpportunitiesOneRequest:
    headers: OpportunitiesOneHeaders = dataclasses.field()
    path_params: OpportunitiesOnePathParams = dataclasses.field()
    query_params: OpportunitiesOneQueryParams = dataclasses.field()
    security: OpportunitiesOneSecurity = dataclasses.field()
