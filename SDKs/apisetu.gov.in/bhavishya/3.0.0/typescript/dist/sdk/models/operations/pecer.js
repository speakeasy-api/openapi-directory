...
var PecerRequestBodyCertificateParameters = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], PecerRequestBodyCertificateParameters.prototype, "fullName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=GENDER" }),
        __metadata("design:type", String)
    ], PecerRequestBodyCertificateParameters.prototype, "gender", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PAN" }),
        __metadata("design:type", String)
    ], PecerRequestBodyCertificateParameters.prototype, "pan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=PPO" }),
        __metadata("design:type", String)
    ], PecerRequestBodyCertificateParameters.prototype, "ppo", void 0);
