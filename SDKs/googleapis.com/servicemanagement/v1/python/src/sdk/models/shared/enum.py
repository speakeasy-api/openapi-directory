...
import dataclasses
from ..shared import enumvalue as shared_enumvalue
...
class EnumT:
    ...
    enumvalue: Optional[list[shared_enumvalue.EnumValue]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('enumvalue'), 'exclude': lambda f: f is None }})
    r"""Enum value definitions."""  
    ...
    syntax: Optional[EnumSyntaxEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('syntax'), 'exclude': lambda f: f is None }})
    r"""The source syntax."""  
