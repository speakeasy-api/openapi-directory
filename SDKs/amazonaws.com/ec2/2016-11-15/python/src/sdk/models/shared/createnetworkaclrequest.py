...
class CreateNetworkACLRequestTagSpecificationsResourceTypeEnum(str, Enum):
...
class CreateNetworkACLRequestTagSpecifications:
    ...
    resource_type: Optional[CreateNetworkACLRequestTagSpecificationsResourceTypeEnum] = dataclasses.field(default=None)  
    tags: Optional[list[CreateNetworkACLRequestTagSpecificationsTags]] = dataclasses.field(default=None)  
...
class CreateNetworkACLRequest:
    ...
    tag_specifications: Optional[list[CreateNetworkACLRequestTagSpecifications]] = dataclasses.field(default=None)  
