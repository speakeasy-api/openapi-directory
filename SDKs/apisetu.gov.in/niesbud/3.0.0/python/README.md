...
```bash
pip install git+https://github.com/speakeasy-api/openapi-directory.git#subdirectory=SDKs/apisetu.gov.in/niesbud/3.0.0/python
```
...
req = operations.SkcerRequestBody(
    certificate_parameters=operations.SkcerRequestBodyCertificateParameters(
        course_no="2019/65404/1",
        full_name="Sunil Kumar",
        certificate_type="NIESBUD,PMYUVA",
    ),
...
res = s.ap_is.skcer(req, operations.SkcerSecurity(
