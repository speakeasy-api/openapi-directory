...
export class DrivelabelsLabelsRevisionsPermissionsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DrivelabelsLabelsRevisionsPermissionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
