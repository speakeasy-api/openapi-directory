...
var GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            elemType: googlesecuritysafebrowsingv4fetchthreatlistupdatesresponselistupdateresponse_1.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse,
        }),
        (0, class_transformer_1.Expose)({ name: "listUpdateResponses" }),
        (0, class_transformer_1.Type)(function () {
            return googlesecuritysafebrowsingv4fetchthreatlistupdatesresponselistupdateresponse_1.GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponseListUpdateResponse;
        }),
        __metadata("design:type", Array)
    ], GoogleSecuritySafebrowsingV4FetchThreatListUpdatesResponse.prototype, "listUpdateResponses", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "minimumWaitDuration" }),
