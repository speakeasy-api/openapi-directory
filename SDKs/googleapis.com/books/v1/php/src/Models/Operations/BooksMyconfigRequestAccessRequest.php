...
class BooksMyconfigRequestAccessRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\BooksMyconfigRequestAccessLicenseTypesEnum $licenseTypes
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=licenseTypes')]
    public ?BooksMyconfigRequestAccessLicenseTypesEnum $licenseTypes = null;
