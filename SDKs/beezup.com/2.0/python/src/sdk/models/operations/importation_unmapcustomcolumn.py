...
class ImportationUnmapCustomColumnPathParams:
...
@dataclasses.dataclass
class ImportationUnmapCustomColumnRequest:
    path_params: ImportationUnmapCustomColumnPathParams = dataclasses.field()
