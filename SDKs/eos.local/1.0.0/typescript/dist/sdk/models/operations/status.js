...
exports.StatusResponse = exports.StatusRequest = exports.Status200ApplicationJson = exports.Status200ApplicationJsonLastHandshake = exports.StatusRequestBody = void 0;
...
var Status200ApplicationJsonLastHandshake = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=chain_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=head_id" }),
        __metadata("design:type", String)
    ], Status200ApplicationJsonLastHandshake.prototype, "headId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=head_num" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_irreversible_block_id" }),
        __metadata("design:type", String)
    ], Status200ApplicationJsonLastHandshake.prototype, "lastIrreversibleBlockId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=last_irreversible_block_num" }),
        __metadata("design:type", Number)
    ], Status200ApplicationJsonLastHandshake.prototype, "lastIrreversibleBlockNum", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=network_version" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=p2p_address" }),
        __metadata("design:type", String)
    ], Status200ApplicationJsonLastHandshake.prototype, "p2pAddress", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sig" }),
        __metadata("design:type", String)
