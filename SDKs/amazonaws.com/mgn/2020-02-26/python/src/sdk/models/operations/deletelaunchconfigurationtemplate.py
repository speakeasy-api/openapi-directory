...
class DeleteLaunchConfigurationTemplateRequestBody:
    ...
    r"""ID of resource to be deleted."""  
    

@dataclasses.dataclass
class DeleteLaunchConfigurationTemplateRequest:
    
    request_body: DeleteLaunchConfigurationTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
...
class DeleteLaunchConfigurationTemplateResponse:
    ...
    r"""ConflictException"""  
    delete_launch_configuration_template_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
    r"""Success"""  
