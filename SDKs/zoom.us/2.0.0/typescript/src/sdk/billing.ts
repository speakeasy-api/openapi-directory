...
export class Billing {
  ...
  accountBilling(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AccountBillingResponse =
        new operations.AccountBillingResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.accountBilling200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.AccountBilling200ApplicationJSON
            );
          }
  ...
  accountBillingInvoices(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountBillingInvoicesResponse =
        new operations.AccountBillingInvoicesResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.accountBillingInvoices200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.AccountBillingInvoices200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  accountBillingUpdate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountBillingUpdateResponse =
        new operations.AccountBillingUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  accountPlanAddonCancel(
    ...
    security: operations.AccountPlanAddonCancelSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountPlanAddonCancelResponse =
        new operations.AccountPlanAddonCancelResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  accountPlanAddonCreate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountPlanAddonCreateResponse =
        new operations.AccountPlanAddonCreateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  accountPlanAddonUpdate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountPlanAddonUpdateResponse =
        new operations.AccountPlanAddonUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  accountPlanBaseDelete(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountPlanBaseDeleteResponse =
        new operations.AccountPlanBaseDeleteResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  accountPlanBaseUpdate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountPlanBaseUpdateResponse =
        new operations.AccountPlanBaseUpdateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  accountPlanCreate(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountPlanCreateResponse =
        new operations.AccountPlanCreateResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        ...
        case httpRes?.status == 201:
          ...
          if (utils.matchContentType(contentType, `application/json`)) {
            res.accountPlanCreate201ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.AccountPlanCreate201ApplicationJSON
            );
          }
          break;
  ...
  accountPlans(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.AccountPlansResponse =
        new operations.AccountPlansResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.accountPlans200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.AccountPlans200ApplicationJSON
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getAccountBillingInvoice(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetAccountBillingInvoiceResponse =
        new operations.GetAccountBillingInvoiceResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getAccountBillingInvoice200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.GetAccountBillingInvoice200ApplicationJSON
              );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getPlanUsage(
    ...
    security: operations.GetPlanUsageSecurity,
    config?: AxiosRequestConfig
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetPlanUsageResponse =
        new operations.GetPlanUsageResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getPlanUsage200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetPlanUsage200ApplicationJSON
            );
          }
          if (utils.matchContentType(contentType, `application/xml`)) {
            const resBody: string = JSON.stringify(httpRes?.data, null, 0);
