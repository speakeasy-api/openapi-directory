...
from ..shared import proxymodifyfeature as shared_proxymodifyfeature
...
class ObjectPUTFeatureRequest:
    ...
    r"""Object id"""  
    proxy_modify_feature: shared_proxymodifyfeature.ProxyModifyFeature = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
