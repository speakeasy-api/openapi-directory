 ...
 */
public enum CreateLaunchTemplateRequestTagSpecificationsResourceTypeEnum {
    ...
    private CreateLaunchTemplateRequestTagSpecificationsResourceTypeEnum(String value) {
        this.value = value;
    }
}
