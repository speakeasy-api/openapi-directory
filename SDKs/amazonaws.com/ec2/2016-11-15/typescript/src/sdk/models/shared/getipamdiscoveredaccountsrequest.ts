 ...
 */
export class GetIpamDiscoveredAccountsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
...
export class GetIpamDiscoveredAccountsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({ elemType: GetIpamDiscoveredAccountsRequestFilters })
