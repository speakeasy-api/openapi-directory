 ...
 */
export class MetricTimeseries extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: TimeseriesBin })
  @Expose({ name: "histogramTimeseries" })
  @Type(() => TimeseriesBin)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "percentilesTimeseries" })
