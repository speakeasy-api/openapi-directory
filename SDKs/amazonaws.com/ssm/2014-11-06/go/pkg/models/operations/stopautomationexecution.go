...
func (e StopAutomationExecutionXAmzTargetEnum) ToPointer() *StopAutomationExecutionXAmzTargetEnum {
	return &e
}
...
func (e *StopAutomationExecutionXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "AmazonSSM.StopAutomationExecution":
		*e = StopAutomationExecutionXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for StopAutomationExecutionXAmzTargetEnum: %v", v)
	}
}
