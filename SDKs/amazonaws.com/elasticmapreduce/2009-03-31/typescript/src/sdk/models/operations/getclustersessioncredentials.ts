...
export enum GetClusterSessionCredentialsXAmzTargetEnum {
  ElasticMapReduceGetClusterSessionCredentials = "ElasticMapReduce.GetClusterSessionCredentials",
}

export class GetClusterSessionCredentialsRequest extends SpeakeasyBase {
...
export class GetClusterSessionCredentialsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
