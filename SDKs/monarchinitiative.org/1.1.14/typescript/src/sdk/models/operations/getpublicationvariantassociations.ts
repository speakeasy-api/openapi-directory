...
export class GetPublicationVariantAssociationsRequest extends SpeakeasyBase {
  /**
...
export class GetPublicationVariantAssociationsResponse extends SpeakeasyBase {
  /**
   * Success
   */
  @SpeakeasyMetadata()
