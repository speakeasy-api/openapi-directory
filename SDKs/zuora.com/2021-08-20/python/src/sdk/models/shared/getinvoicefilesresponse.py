...
class GETInvoiceFilesResponse:
    ...
    invoice_files: Optional[list[shared_invoicefile.InvoiceFile]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('invoiceFiles'), 'exclude': lambda f: f is None }})
    r"""Container for invoice PDF files."""  
