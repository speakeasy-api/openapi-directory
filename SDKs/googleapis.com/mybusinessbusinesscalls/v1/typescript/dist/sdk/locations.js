...
var Locations = /** @class */ (function () {
    ...
    **/
    Locations.prototype.mybusinessbusinesscallsLocationsBusinesscallsinsightsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MybusinessbusinesscallsLocationsBusinesscallsinsightsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/v1/{parent}/businesscallsinsights", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.listBusinessCallsInsightsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Locations.prototype.mybusinessbusinesscallsLocationsGetBusinesscallssettings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.businessCallsSettings = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Locations.prototype.mybusinessbusinesscallsLocationsUpdateBusinesscallssettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
