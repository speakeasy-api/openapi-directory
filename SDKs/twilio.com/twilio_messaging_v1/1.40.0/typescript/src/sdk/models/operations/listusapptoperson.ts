...
export class ListUsAppToPersonListUsAppToPersonResponse extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: shared.MessagingV1ServiceUsAppToPerson })
  @Expose({ name: "compliance" })
  @Type(() => shared.MessagingV1ServiceUsAppToPerson)
  compliance?: shared.MessagingV1ServiceUsAppToPerson[];

  @SpeakeasyMetadata()
  @Expose({ name: "meta" })
  @Type(() => ListUsAppToPersonListUsAppToPersonResponseMeta)
