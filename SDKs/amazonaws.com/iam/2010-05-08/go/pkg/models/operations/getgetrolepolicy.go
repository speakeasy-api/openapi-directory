...
func (e GETGETRolePolicyActionEnum) ToPointer() *GETGETRolePolicyActionEnum {
	return &e
}
...
func (e *GETGETRolePolicyActionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "GetRolePolicy":
		*e = GETGETRolePolicyActionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETGETRolePolicyActionEnum: %v", v)
	}
}
...
func (e GETGETRolePolicyVersionEnum) ToPointer() *GETGETRolePolicyVersionEnum {
	return &e
}
...
func (e *GETGETRolePolicyVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch v {
	case "2010-05-08":
		*e = GETGETRolePolicyVersionEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GETGETRolePolicyVersionEnum: %v", v)
	}
}
