...
class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetQueryParams:
    ...
    view: Optional[ConnectorsProjectsLocationsProvidersConnectorsVersionsGetViewEnum] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetRequest:
    path_params: ConnectorsProjectsLocationsProvidersConnectorsVersionsGetPathParams = dataclasses.field()
    query_params: ConnectorsProjectsLocationsProvidersConnectorsVersionsGetQueryParams = dataclasses.field()
    security: ConnectorsProjectsLocationsProvidersConnectorsVersionsGetSecurity = dataclasses.field()
...
class ConnectorsProjectsLocationsProvidersConnectorsVersionsGetResponse:
    ...
    connector_version: Optional[shared_connectorversion.ConnectorVersion] = dataclasses.field(default=None)
