 ...
 */
export enum FirewallPolicyListWarningCodeEnum {
...
export class FirewallPolicyListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class FirewallPolicyListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
  @Expose({ name: "code" })
  code?: FirewallPolicyListWarningCodeEnum;

  /**
   * [Output Only] Metadata about this warning in key: value format. For example: "data": [ { "key": "scope", "value": "zones/us-east1-d" }
   */
  @SpeakeasyMetadata({ elemType: FirewallPolicyListWarningData })
  @Expose({ name: "data" })
  @Type(() => FirewallPolicyListWarningData)
  data?: FirewallPolicyListWarningData[];
 ...
 * Successful response
 */
export class FirewallPolicyList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: FirewallPolicy })
  @Expose({ name: "items" })
  @Type(() => FirewallPolicy)
