...
**/
export class CreateBatchResponseBodyOptionalLink extends SpeakeasyBase {
 ...
 * 
**/
export class CreateBatchResponseBodyLabelDownload extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=href" })
  href?: string;
 ...
 * 
**/
export class CreateBatchResponseBody extends SpeakeasyBase {
