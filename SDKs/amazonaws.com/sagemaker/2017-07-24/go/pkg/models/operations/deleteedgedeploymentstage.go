...
type DeleteEdgeDeploymentStageHeaders struct {
...
type DeleteEdgeDeploymentStageRequest struct {
	Headers DeleteEdgeDeploymentStageHeaders
	Request shared.DeleteEdgeDeploymentStageRequest `request:"mediaType=application/json"`
}
