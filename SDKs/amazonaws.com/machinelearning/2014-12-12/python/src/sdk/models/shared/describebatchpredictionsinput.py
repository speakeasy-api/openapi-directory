...
class DescribeBatchPredictionsInput:
    ...
    filter_variable: Optional[shared_batchpredictionfiltervariable_enum.BatchPredictionFilterVariableEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('FilterVariable'), 'exclude': lambda f: f is None }})  
