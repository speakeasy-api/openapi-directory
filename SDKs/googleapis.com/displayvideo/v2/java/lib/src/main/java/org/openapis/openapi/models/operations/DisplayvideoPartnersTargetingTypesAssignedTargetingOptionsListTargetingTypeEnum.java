 ...
 */
public enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum {
    ...
    private DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum(String value) {
        this.value = value;
    }
}
