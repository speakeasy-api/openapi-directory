...
public class AzureFunctionRuleResponse {
    ...
    public AzureFunctionRuleResponse withRequestMode(String requestMode) {
    ...
    public AzureFunctionRuleResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public AzureFunctionRuleResponse(@JsonProperty("requestMode") String requestMode, @JsonProperty("ruleType") AzureFunctionRuleResponseRuleTypeEnum ruleType, @JsonProperty("source") RuleSource source, @JsonProperty("target") AzureFunctionRuleResponseTarget target) {
        this.requestMode = requestMode;
        this.ruleType = ruleType;
        this.source = source;
        this.target = target;
