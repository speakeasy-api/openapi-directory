...
export class BillsAllSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class BillsAllRequest extends SpeakeasyBase {
  /**
...
export class BillsAllResponse extends SpeakeasyBase {
  /**
   * Bad Request
   */
  @SpeakeasyMetadata()
