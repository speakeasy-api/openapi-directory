...
type ApigatewayProjectsLocationsApisListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ApigatewayProjectsLocationsApisListPathParams struct {
	// Required. Parent resource of the API, of the form: `projects/*/locations/global`
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigatewayProjectsLocationsApisListQueryParams struct {
	// V1 error format.
...
type ApigatewayProjectsLocationsApisListRequest struct {
...
type ApigatewayProjectsLocationsApisListResponse struct {
	// Successful response
