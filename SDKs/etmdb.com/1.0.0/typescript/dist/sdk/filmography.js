...
exports.Filmography = void 0;
var operations = __importStar(require("./models/operations"));
var utils = __importStar(require("../internal/utils"));
var Filmography = /** @class */ (function () {
    function Filmography(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Filmography.prototype.filmographySearchRead = function (req, config) {
     ...
     * [ref]: https://etmdb.com/en/movie-list/-updated_date
    **/
    Filmography.prototype.filmographySearchallRead = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
exports.Filmography = Filmography;
