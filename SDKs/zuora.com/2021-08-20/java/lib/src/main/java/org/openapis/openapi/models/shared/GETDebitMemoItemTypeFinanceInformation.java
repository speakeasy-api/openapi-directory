 ...
 * 
 */
public class GETDebitMemoItemTypeFinanceInformation {
    /**
    ...
    public GETDebitMemoItemTypeFinanceInformation withDeferredRevenueAccountingCode(String deferredRevenueAccountingCode) {
    ...
    public GETDebitMemoItemTypeFinanceInformation withDeferredRevenueAccountingCodeType(String deferredRevenueAccountingCodeType) {
    ...
    public GETDebitMemoItemTypeFinanceInformation withRecognizedRevenueAccountingCode(String recognizedRevenueAccountingCode) {
    ...
    public GETDebitMemoItemTypeFinanceInformation withRecognizedRevenueAccountingCodeType(String recognizedRevenueAccountingCodeType) {
    ...
    public GETDebitMemoItemTypeFinanceInformation withRevenueRecognitionRuleName(String revenueRecognitionRuleName) {
    ...
    public GETDebitMemoItemTypeFinanceInformation withRevenueScheduleNumber(String revenueScheduleNumber) {
