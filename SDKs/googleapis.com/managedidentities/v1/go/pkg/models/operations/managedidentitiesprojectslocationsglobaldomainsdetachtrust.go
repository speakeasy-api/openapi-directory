...
type ManagedidentitiesProjectsLocationsGlobalDomainsDetachTrustSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ManagedidentitiesProjectsLocationsGlobalDomainsDetachTrustPathParams struct {
...
type ManagedidentitiesProjectsLocationsGlobalDomainsDetachTrustQueryParams struct {
	// V1 error format.
...
type ManagedidentitiesProjectsLocationsGlobalDomainsDetachTrustResponse struct {
	ContentType string
	// Successful response
