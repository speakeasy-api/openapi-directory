...
export class GetNhClothingClothingRequest extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({
    data: "pathParam, style=simple;explode=false;name=clothing",
  })
  clothing: string;
...
export class GetNhClothingClothingResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
