...
func (e PostServersIDActionsResetActionResponseActionStatusEnum) ToPointer() *PostServersIDActionsResetActionResponseActionStatusEnum {
	return &e
}
...
func (e *PostServersIDActionsResetActionResponseActionStatusEnum) UnmarshalJSON(data []byte) error {
	...
	case "running":
		fallthrough
	case "error":
		*e = PostServersIDActionsResetActionResponseActionStatusEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for PostServersIDActionsResetActionResponseActionStatusEnum: %v", v)
	}
}
