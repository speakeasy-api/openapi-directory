...
type ContainerProjectsLocationsClustersCompleteIPRotationSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContainerProjectsLocationsClustersCompleteIPRotationPathParams struct {
...
type ContainerProjectsLocationsClustersCompleteIPRotationQueryParams struct {
	// V1 error format.
...
type ContainerProjectsLocationsClustersCompleteIPRotationRequest struct {
...
type ContainerProjectsLocationsClustersCompleteIPRotationResponse struct {
	ContentType string
	// Successful response
