...
public class DirectoryOrgunitsGetPathParams {
    /**
    ...
    public DirectoryOrgunitsGetPathParams withCustomerId(String customerId) {
    ...
    public DirectoryOrgunitsGetPathParams withOrgUnitPath(String orgUnitPath) {
