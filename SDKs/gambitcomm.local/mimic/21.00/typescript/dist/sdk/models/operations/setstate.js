...
exports.SetStateResponse = exports.SetStateRequest = exports.SetStatePathParams = void 0;
...
var SetStatePathParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=state" }),
        __metadata("design:type", Number)
    ], SetStatePathParams.prototype, "state", void 0);
    return SetStatePathParams;
}(utils_1.SpeakeasyBase));
exports.SetStatePathParams = SetStatePathParams;
...
exports.SetStateRequest = SetStateRequest;
...
exports.SetStateResponse = SetStateResponse;
