...
func (e GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum) ToPointer() *GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum {
	return &e
}
...
func (e *GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum) UnmarshalJSON(data []byte) error {
	...
	case "FORECASTED_SPEND":
		*e = GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GoogleCloudBillingBudgetsV1ThresholdRuleSpendBasisEnum: %v", v)
	}
}
