...
var Country = /** @class */ (function () {
    function Country(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    Country.prototype.getSalesTaxJurisdictions = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetSalesTaxJurisdictionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/country/{countryCode}/sales_tax_jurisdiction", req);
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetSalesTaxJurisdictionsResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.salesTaxJurisdictions = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.SalesTaxJurisdictions);
                    }
                    break;
