...
class Error403NgSbs:
    ...
    tpp_messages: Optional[list[shared_tppmessage403_sbs.TppMessage403Sbs]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tppMessages') }})
