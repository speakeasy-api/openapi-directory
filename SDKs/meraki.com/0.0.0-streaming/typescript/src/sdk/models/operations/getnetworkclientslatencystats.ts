 ...
 */
export enum GetNetworkClientsLatencyStatsBandEnum {
  Two4 = "2.4",
  Five = "5",
}

export class GetNetworkClientsLatencyStatsRequest extends SpeakeasyBase {
  /**
...
export class GetNetworkClientsLatencyStatsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
   ...
   */
  @SpeakeasyMetadata()
  getNetworkClientsLatencyStats200ApplicationJSONObjects?: Record<
    string,
    any
  >[];
}
