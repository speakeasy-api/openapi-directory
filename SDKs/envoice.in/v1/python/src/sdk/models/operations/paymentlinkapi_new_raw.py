...
class PaymentLinkAPINewRawRequest:
...
class PaymentLinkAPINewRawResponse:
    ...
    payment_link_api_new_raw_200_application_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
    payment_link_api_new_raw_200_text_json_int32_integer: Optional[int] = dataclasses.field(default=None)
    r"""OK"""  
