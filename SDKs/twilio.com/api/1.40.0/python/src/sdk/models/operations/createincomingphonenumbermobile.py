...
class CreateIncomingPhoneNumberMobileCreateIncomingPhoneNumberMobileRequest:
    ...
    r"""A descriptive string that you created to describe the new phone number. It can be up to 64 characters long. By default, the is a formatted version of the phone number."""  
    ...
    r"""The SID of the application that should handle SMS messages sent to the new phone number. If an `sms_application_sid` is present, we ignore all of the `sms_*_url` urls and use those of the application."""  
...
class CreateIncomingPhoneNumberMobileRequest:
    ...
    request_body: Optional[CreateIncomingPhoneNumberMobileCreateIncomingPhoneNumberMobileRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})  
