 ...
 */
export class UpdateSlotRequestBodySubSlotSetting extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateSlotRequestBody extends SpeakeasyBase {
  ...
  @Type(() => UpdateSlotRequestBodyMultipleValuesSetting)
  ...
  @Type(() => UpdateSlotRequestBodyObfuscationSetting)
  ...
  @Type(() => UpdateSlotRequestBodySubSlotSetting)
  ...
  @Type(() => UpdateSlotRequestBodyValueElicitationSetting)
