...
class DescribeWorkflowTypeRequest:
    ...
    describe_workflow_type_input: shared_describeworkflowtypeinput.DescribeWorkflowTypeInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
