...
export declare class OrgUnits {
     ...
     */
    cloudidentityOrgUnitsMembershipsList(req: operations.CloudidentityOrgUnitsMembershipsListRequest, security: operations.CloudidentityOrgUnitsMembershipsListSecurity, config?: AxiosRequestConfig): Promise<operations.CloudidentityOrgUnitsMembershipsListResponse>;
    /**
