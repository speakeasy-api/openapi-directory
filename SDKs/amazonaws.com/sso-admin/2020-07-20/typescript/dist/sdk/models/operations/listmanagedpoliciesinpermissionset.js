...
exports.ListManagedPoliciesInPermissionSetResponse = exports.ListManagedPoliciesInPermissionSetRequest = exports.ListManagedPoliciesInPermissionSetXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ListManagedPoliciesInPermissionSetXAmzTargetEnum;
...
})(ListManagedPoliciesInPermissionSetXAmzTargetEnum = exports.ListManagedPoliciesInPermissionSetXAmzTargetEnum || (exports.ListManagedPoliciesInPermissionSetXAmzTargetEnum = {}));
var ListManagedPoliciesInPermissionSetRequest = /** @class */ (function (_super) {
    ...
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "listManagedPoliciesInPermissionSetRequest", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ListManagedPoliciesInPermissionSetRequest.prototype, "xAmzTarget", void 0);
...
var ListManagedPoliciesInPermissionSetResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ListManagedPoliciesInPermissionSetResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
