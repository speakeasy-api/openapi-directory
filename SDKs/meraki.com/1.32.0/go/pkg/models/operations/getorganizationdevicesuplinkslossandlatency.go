...
func (e GetOrganizationDevicesUplinksLossAndLatencyUplinkEnum) ToPointer() *GetOrganizationDevicesUplinksLossAndLatencyUplinkEnum {
	return &e
}
...
func (e *GetOrganizationDevicesUplinksLossAndLatencyUplinkEnum) UnmarshalJSON(data []byte) error {
	...
	case "wan1":
		fallthrough
	case "wan2":
		*e = GetOrganizationDevicesUplinksLossAndLatencyUplinkEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetOrganizationDevicesUplinksLossAndLatencyUplinkEnum: %v", v)
	}
}
