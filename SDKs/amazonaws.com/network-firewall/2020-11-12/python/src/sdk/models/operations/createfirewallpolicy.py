...
class CreateFirewallPolicyRequest:
    ...
    create_firewall_policy_request: shared_createfirewallpolicyrequest.CreateFirewallPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
