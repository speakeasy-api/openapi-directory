...
public class GetDocument200ApplicationJSONMetrics {
    /**
    ...
    public GetDocument200ApplicationJSONMetrics withCounterServerQueryCacheHit(Double counterServerQueryCacheHit) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageBuildComprehensionIndexNs(Double timerQueryCompileStageBuildComprehensionIndexNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageCheckSafetyNs(Double timerQueryCompileStageCheckSafetyNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageCheckTypesNs(Double timerQueryCompileStageCheckTypesNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageCheckUndefinedFuncsNs(Double timerQueryCompileStageCheckUndefinedFuncsNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageCheckUnsafeBuiltinsNs(Double timerQueryCompileStageCheckUnsafeBuiltinsNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageResolveRefsNs(Double timerQueryCompileStageResolveRefsNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageRewriteComprehensionTermsNs(Double timerQueryCompileStageRewriteComprehensionTermsNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageRewriteDynamicTermsNs(Double timerQueryCompileStageRewriteDynamicTermsNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageRewriteExprTermsNs(Double timerQueryCompileStageRewriteExprTermsNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageRewriteLocalVarsNs(Double timerQueryCompileStageRewriteLocalVarsNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageRewriteToCaptureValueNs(Double timerQueryCompileStageRewriteToCaptureValueNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerQueryCompileStageRewriteWithValuesNs(Double timerQueryCompileStageRewriteWithValuesNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerRegoInputParseNs(Double timerRegoInputParseNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerRegoModuleCompileNs(Double timerRegoModuleCompileNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerRegoModuleParseNs(Double timerRegoModuleParseNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerRegoQueryCompileNs(Double timerRegoQueryCompileNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerRegoQueryEvalNs(Double timerRegoQueryEvalNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerRegoQueryParseNs(Double timerRegoQueryParseNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerServerHandlerNs(Double timerServerHandlerNs) {
    ...
    public GetDocument200ApplicationJSONMetrics withTimerServerReadBytesNs(Double timerServerReadBytesNs) {
        this.timerServerReadBytesNs = timerServerReadBytesNs;
        return this;
    }
    
    public GetDocument200ApplicationJSONMetrics(){}
}
