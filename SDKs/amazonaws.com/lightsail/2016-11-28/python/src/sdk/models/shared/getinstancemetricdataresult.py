...
class GetInstanceMetricDataResult:
    ...
    metric_name: Optional[shared_instancemetricname_enum.InstanceMetricNameEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('metricName'), 'exclude': lambda f: f is None }})  
