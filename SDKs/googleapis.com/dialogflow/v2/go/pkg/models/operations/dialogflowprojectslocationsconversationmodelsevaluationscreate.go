...
type DialogflowProjectsLocationsConversationModelsEvaluationsCreateRequest struct {
	...
	GoogleCloudDialogflowV2CreateConversationModelEvaluationRequestInput *shared.GoogleCloudDialogflowV2CreateConversationModelEvaluationRequestInput `request:"mediaType=application/json"`
	// OAuth access token.
