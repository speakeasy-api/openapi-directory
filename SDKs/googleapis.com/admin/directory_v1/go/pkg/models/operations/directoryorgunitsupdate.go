...
type DirectoryOrgunitsUpdateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DirectoryOrgunitsUpdatePathParams struct {
...
type DirectoryOrgunitsUpdateQueryParams struct {
	// V1 error format.
...
type DirectoryOrgunitsUpdateRequest struct {
...
type DirectoryOrgunitsUpdateResponse struct {
	ContentType string
	// Successful response
