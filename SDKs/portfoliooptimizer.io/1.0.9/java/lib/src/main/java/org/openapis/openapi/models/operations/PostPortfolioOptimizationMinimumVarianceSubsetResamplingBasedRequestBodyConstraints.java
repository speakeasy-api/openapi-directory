...
public class PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints {
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("assetsGroups")
    public Long[][] assetsGroups;

    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints withAssetsGroups(Long[][] assetsGroups) {
    ...
    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints withAssetsGroupsMatrix(Double[][] assetsGroupsMatrix) {
    ...
    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints withMaximumAssetsGroupsWeights(Double[] maximumAssetsGroupsWeights) {
    ...
    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints withMaximumAssetsWeights(Double[] maximumAssetsWeights) {
    ...
    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints withMaximumPortfolioExposure(Double maximumPortfolioExposure) {
    ...
    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints withMinimumAssetsWeights(Double[] minimumAssetsWeights) {
    ...
    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints withMinimumPortfolioExposure(Double minimumPortfolioExposure) {
        this.minimumPortfolioExposure = minimumPortfolioExposure;
        return this;
    }
    
    public PostPortfolioOptimizationMinimumVarianceSubsetResamplingBasedRequestBodyConstraints(){}
}
