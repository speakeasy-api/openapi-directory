...
public class PoolListPoolUsageMetricsHeaders {
    /**
    ...
    public PoolListPoolUsageMetricsHeaders withOcpDate(String ocpDate) {
    ...
    public PoolListPoolUsageMetricsHeaders withReturnClientRequestId(Boolean returnClientRequestId) {
