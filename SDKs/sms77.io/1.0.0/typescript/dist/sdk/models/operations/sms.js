...
exports.SmsResponse = exports.SmsRequest = exports.Sms200ApplicationJson = exports.Sms200ApplicationJsonSmsTypeEnum = exports.Sms200ApplicationJsonMessages = exports.SmsQueryParams = void 0;
...
var SmsQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=details" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=foreign_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=no_reload" }),
        __metadata("design:type", Number)
    ], SmsQueryParams.prototype, "noReload", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=performance_tracking" }),
        __metadata("design:type", Number)
    ], SmsQueryParams.prototype, "performanceTracking", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=return_msg_id" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=unicode" }),
        __metadata("design:type", Number)
...
exports.SmsQueryParams = SmsQueryParams;
var Sms200ApplicationJsonMessages = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=parts" }),
        __metadata("design:type", Number)
...
var Sms200ApplicationJson = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=messages", elemType: Sms200ApplicationJsonMessages }),
        __metadata("design:type", Array)
    ], Sms200ApplicationJson.prototype, "messages", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=sms_type" }),
        __metadata("design:type", String)
