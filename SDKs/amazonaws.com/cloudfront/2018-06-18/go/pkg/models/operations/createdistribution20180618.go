...
type CreateDistribution20180618Headers struct {
...
type CreateDistribution20180618RequestBodyDistributionConfig struct {
...
type CreateDistribution20180618RequestBody struct {
	// A distribution configuration.
	DistributionConfig CreateDistribution20180618RequestBodyDistributionConfig
}

type CreateDistribution20180618Request struct {
	Headers CreateDistribution20180618Headers
	Request []byte `request:"mediaType=text/xml"`
}

type CreateDistribution20180618Response struct {
	Body        []byte
	ContentType string
	StatusCode  int
