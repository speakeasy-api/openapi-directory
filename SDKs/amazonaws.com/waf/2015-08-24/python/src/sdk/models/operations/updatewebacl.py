...
class UpdateWebACLRequest:
    headers: UpdateWebACLHeaders = dataclasses.field()
    request: shared_updatewebaclrequest.UpdateWebACLRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
