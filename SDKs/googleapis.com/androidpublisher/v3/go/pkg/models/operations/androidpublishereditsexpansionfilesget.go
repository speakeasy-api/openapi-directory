...
func (e *AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "main":
		fallthrough
	case "patch":
		*e = AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for AndroidpublisherEditsExpansionfilesGetExpansionFileTypeEnum: %s", s)
	}
}
