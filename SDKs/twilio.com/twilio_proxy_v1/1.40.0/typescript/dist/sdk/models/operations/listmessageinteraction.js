...
exports.ListMessageInteractionResponse = exports.ListMessageInteractionListMessageInteractionResponse = exports.ListMessageInteractionListMessageInteractionResponseMeta = exports.ListMessageInteractionRequest = exports.ListMessageInteractionSecurity = exports.ListMessageInteractionServerList = void 0;
...
var ListMessageInteractionSecurity = /** @class */ (function (_super) {
    ...
    ], ListMessageInteractionSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListMessageInteractionSecurity.prototype, "username", void 0);
...
var ListMessageInteractionRequest = /** @class */ (function (_super) {
    ...
    ], ListMessageInteractionRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListMessageInteractionRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListMessageInteractionRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ParticipantSid",
        }),
        __metadata("design:type", String)
    ], ListMessageInteractionRequest.prototype, "participantSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=ServiceSid",
        }),
        __metadata("design:type", String)
    ], ListMessageInteractionRequest.prototype, "serviceSid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=SessionSid",
        }),
        __metadata("design:type", String)
    ], ListMessageInteractionRequest.prototype, "sessionSid", void 0);
...
var ListMessageInteractionListMessageInteractionResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return shared.ProxyV1ServiceSessionParticipantMessageInteraction; }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListMessageInteractionListMessageInteractionResponseMeta; }),
...
var ListMessageInteractionResponse = /** @class */ (function (_super) {
    ...
    ], ListMessageInteractionResponse.prototype, "rawResponse", void 0);
