...
from ..shared import listdevicefleetssortby_enum as shared_listdevicefleetssortby_enum
...
class ListDeviceFleetsRequest:
    ...
    sort_by: Optional[shared_listdevicefleetssortby_enum.ListDeviceFleetsSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
