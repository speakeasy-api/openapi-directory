...
class PostRSforInvoiceItemManualDistributionRequest:
    headers: PostRSforInvoiceItemManualDistributionHeaders = dataclasses.field()
    path_params: PostRSforInvoiceItemManualDistributionPathParams = dataclasses.field()
