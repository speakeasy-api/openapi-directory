...
export declare class FindNumberRegionsSecurity extends SpeakeasyBase {
    password: string;
    username: string;
}
export declare class FindNumberRegionsRequest extends SpeakeasyBase {
    /**
     * A city name
     */
    city?: string;
...
export declare class FindNumberRegionsResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Bad request
     */
