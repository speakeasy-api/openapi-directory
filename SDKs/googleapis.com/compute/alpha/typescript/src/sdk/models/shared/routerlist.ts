 ...
 */
export enum RouterListWarningCodeEnum {
...
export class RouterListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class RouterListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: RouterListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class RouterList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: Router })
  @Expose({ name: "items" })
  @Type(() => Router)
  items?: Router[];
