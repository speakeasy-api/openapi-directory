...
export class PatientsUpdatePathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class PatientsUpdateQueryParams extends SpeakeasyBase {
...
export class PatientsUpdateSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  drchronoOauth2: shared.SchemeDrchronoOauth2;
}


export class PatientsUpdateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class PatientsUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
