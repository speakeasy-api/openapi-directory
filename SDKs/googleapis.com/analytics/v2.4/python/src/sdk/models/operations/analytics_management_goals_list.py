...
class AnalyticsManagementGoalsListSecurity:
    option1: Optional[AnalyticsManagementGoalsListSecurityOption1] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementGoalsListSecurityOption2] = dataclasses.field(default=None, metadata={'security': { 'option': True }})
    

@dataclasses.dataclass
class AnalyticsManagementGoalsListRequest:
    path_params: AnalyticsManagementGoalsListPathParams = dataclasses.field()
    query_params: AnalyticsManagementGoalsListQueryParams = dataclasses.field()
    security: AnalyticsManagementGoalsListSecurity = dataclasses.field()
