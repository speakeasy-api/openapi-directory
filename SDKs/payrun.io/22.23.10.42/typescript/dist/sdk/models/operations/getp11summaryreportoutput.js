...
exports.GetP11SummaryReportOutputResponse = exports.GetP11SummaryReportOutputRequest = void 0;
...
var GetP11SummaryReportOutputRequest = /** @class */ (function (_super) {
    ...
    ], GetP11SummaryReportOutputRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetP11SummaryReportOutputRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployerKey",
        }),
        __metadata("design:type", String)
    ], GetP11SummaryReportOutputRequest.prototype, "employerKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MaxIndex",
        }),
        __metadata("design:type", String)
    ], GetP11SummaryReportOutputRequest.prototype, "maxIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PayScheduleKey",
        }),
        __metadata("design:type", String)
    ], GetP11SummaryReportOutputRequest.prototype, "payScheduleKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartIndex",
        }),
        __metadata("design:type", String)
    ], GetP11SummaryReportOutputRequest.prototype, "startIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=TaxYear",
        }),
        __metadata("design:type", String)
    ], GetP11SummaryReportOutputRequest.prototype, "taxYear", void 0);
    return GetP11SummaryReportOutputRequest;
}(utils_1.SpeakeasyBase));
exports.GetP11SummaryReportOutputRequest = GetP11SummaryReportOutputRequest;
var GetP11SummaryReportOutputResponse = /** @class */ (function (_super) {
    ...
    ], GetP11SummaryReportOutputResponse.prototype, "rawResponse", void 0);
    return GetP11SummaryReportOutputResponse;
}(utils_1.SpeakeasyBase));
exports.GetP11SummaryReportOutputResponse = GetP11SummaryReportOutputResponse;
