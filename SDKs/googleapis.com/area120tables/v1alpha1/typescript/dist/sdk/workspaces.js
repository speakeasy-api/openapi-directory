...
var Workspaces = /** @class */ (function () {
     ...
     */
    Workspaces.prototype.area120tablesWorkspacesGet = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.Area120tablesWorkspacesGetResponse({
     ...
     */
    Workspaces.prototype.area120tablesWorkspacesList = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.Area120tablesWorkspacesListResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
            });
