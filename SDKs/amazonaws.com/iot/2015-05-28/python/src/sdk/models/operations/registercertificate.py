...
class RegisterCertificateRequestBody:
    ...
    ca_certificate_pem: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('caCertificatePem') }})
    status: Optional[RegisterCertificateRequestBodyStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    

@dataclasses.dataclass
class RegisterCertificateRequest:
    headers: RegisterCertificateHeaders = dataclasses.field()
    query_params: RegisterCertificateQueryParams = dataclasses.field()
    request: RegisterCertificateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
