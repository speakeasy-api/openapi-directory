...
public class GETEntitiesRequest {
    ...
    public GETEntitiesRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public GETEntitiesRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public GETEntitiesRequest withProvisioned(String provisioned) {
