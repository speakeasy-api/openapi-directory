...
exports.ConnectionsRevokeResponse = exports.ConnectionsRevokeRequest = void 0;
...
var ConnectionsRevokeRequest = /** @class */ (function (_super) {
    ...
    ], ConnectionsRevokeRequest.prototype, "applicationId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=redirect_uri",
        }),
        __metadata("design:type", String)
    ], ConnectionsRevokeRequest.prototype, "redirectUri", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "pathParam, style=simple;explode=false;name=service_id",
        }),
        __metadata("design:type", String)
    ], ConnectionsRevokeRequest.prototype, "serviceId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=state" }),
        __metadata("design:type", String)
    ], ConnectionsRevokeRequest.prototype, "state", void 0);
...
var ConnectionsRevokeResponse = /** @class */ (function (_super) {
    ...
    ], ConnectionsRevokeResponse.prototype, "rawResponse", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
