...
public class GetAccountAccessConsentsConsentIdHeaders {
    @SpeakeasyMetadata("header:style=simple,explode=false,name=sandbox-id")
    public String sandboxId;
    public GetAccountAccessConsentsConsentIdHeaders withSandboxId(String sandboxId) {
        this.sandboxId = sandboxId;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-customer-user-agent")
    public String xCustomerUserAgent;
    public GetAccountAccessConsentsConsentIdHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public GetAccountAccessConsentsConsentIdHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public GetAccountAccessConsentsConsentIdHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
        this.xFapiCustomerIpAddress = xFapiCustomerIpAddress;
        return this;
    }
    @SpeakeasyMetadata("header:style=simple,explode=false,name=x-fapi-interaction-id")
    public String xFapiInteractionId;
    public GetAccountAccessConsentsConsentIdHeaders withXFapiInteractionId(String xFapiInteractionId) {
