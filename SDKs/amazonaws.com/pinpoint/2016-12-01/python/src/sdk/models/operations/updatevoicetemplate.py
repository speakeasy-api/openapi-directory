...
class UpdateVoiceTemplateRequestBodyVoiceTemplateRequest:
    r"""Specifies the content and settings for a message template that can be used in messages that are sent through the voice channel."""
...
class UpdateVoiceTemplateRequestBody:
    ...
    voice_template_request: UpdateVoiceTemplateRequestBodyVoiceTemplateRequest = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('VoiceTemplateRequest') }})
    r"""Specifies the content and settings for a message template that can be used in messages that are sent through the voice channel."""  
...
class UpdateVoiceTemplateRequest:
    ...
    request_body: UpdateVoiceTemplateRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
