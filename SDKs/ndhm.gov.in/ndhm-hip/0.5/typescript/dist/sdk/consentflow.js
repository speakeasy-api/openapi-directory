...
var ConsentFlow = /** @class */ (function () {
     ...
     *
     */
    ConsentFlow.prototype.postV05ConsentsHipNotifyJson = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05ConsentsHipNotifyJsonRequest(req);
        }
        var baseURL = operations.PostV05ConsentsHipNotifyJsonServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
     ...
     *
     */
    ConsentFlow.prototype.postV05ConsentsHipNotifyRaw = function (req, serverURL, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05ConsentsHipNotifyRawRequest(req);
        }
        var baseURL = operations.PostV05ConsentsHipNotifyRawServerList[0];
        if (serverURL) {
            baseURL = serverURL;
        }
        var url = baseURL.replace(/\/$/, "") + "/v0.5/consents/hip/notify";
