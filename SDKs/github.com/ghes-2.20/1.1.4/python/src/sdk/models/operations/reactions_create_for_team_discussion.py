...
class ReactionsCreateForTeamDiscussionRequestBodyContentEnum(str, Enum):
    r"""The [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types) to add to the team discussion."""
    PLUS_1 = '+1'
    MINUS_1 = '-1'
    LAUGH = 'laugh'
    CONFUSED = 'confused'
...
class ReactionsCreateForTeamDiscussionRequestBody:
    ...
    content: ReactionsCreateForTeamDiscussionRequestBodyContentEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('content') }})
    r"""The [reaction type](https://docs.github.com/enterprise-server@2.20/rest/reference/reactions#reaction-types) to add to the team discussion."""  
...
class ReactionsCreateForTeamDiscussionRequest:
    ...
    request_body: ReactionsCreateForTeamDiscussionRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
