...
class ListPackageTypesResponseBody:
    r"""A list package types response body"""
    
    packages: Optional[list[ListPackageTypesResponseBodyPackageType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('packages'), 'exclude': lambda f: f is None }})
