...
class TravelTimeGetCompareOverlayRequest:
    ...
    compare_type: str = dataclasses.field(metadata={'query_param': { 'field_name': 'compareType', 'style': 'form', 'explode': True }})  
    compare_value: str = dataclasses.field(metadata={'query_param': { 'field_name': 'compareValue', 'style': 'form', 'explode': True }})  
    direction: TravelTimeGetCompareOverlayDirectionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'direction', 'style': 'form', 'explode': True }})
    r"""The direction of travel."""  
