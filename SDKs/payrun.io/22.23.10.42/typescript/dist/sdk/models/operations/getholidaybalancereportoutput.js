...
exports.GetHolidayBalanceReportOutputResponse = exports.GetHolidayBalanceReportOutputRequest = void 0;
...
var GetHolidayBalanceReportOutputRequest = /** @class */ (function (_super) {
    ...
    ], GetHolidayBalanceReportOutputRequest.prototype, "apiVersion", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=Authorization",
        }),
        __metadata("design:type", String)
    ], GetHolidayBalanceReportOutputRequest.prototype, "authorization", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployeeCodes",
        }),
        __metadata("design:type", String)
    ], GetHolidayBalanceReportOutputRequest.prototype, "employeeCodes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=EmployerKey",
        }),
        __metadata("design:type", String)
    ], GetHolidayBalanceReportOutputRequest.prototype, "employerKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=HolidayYearEnd;dateTimeFormat=YYYY-MM-DD",
        }),
        __metadata("design:type", Date)
    ], GetHolidayBalanceReportOutputRequest.prototype, "holidayYearEnd", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=MaxIndex",
        }),
        __metadata("design:type", String)
    ], GetHolidayBalanceReportOutputRequest.prototype, "maxIndex", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=StartIndex",
        }),
        __metadata("design:type", String)
    ], GetHolidayBalanceReportOutputRequest.prototype, "startIndex", void 0);
...
var GetHolidayBalanceReportOutputResponse = /** @class */ (function (_super) {
    ...
    ], GetHolidayBalanceReportOutputResponse.prototype, "rawResponse", void 0);
