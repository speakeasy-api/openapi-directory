...
class ListStoresResponse:
    ...
    data: Optional[list[shared_store.Store]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})
    r"""List of stores"""  
