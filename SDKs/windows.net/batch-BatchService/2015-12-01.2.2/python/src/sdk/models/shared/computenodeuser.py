...
class ComputeNodeUser:
    ...
    r"""Gets or sets the user name of the account."""  
    password: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('password') }})
    r"""Gets or sets the password of the account."""  
    ...
    r"""Gets or sets the time at which the account should expire. If omitted, the default is 1 day from the current time."""  
    ...
    r"""Gets or sets whether the account should be an administrator on the compute node."""  
