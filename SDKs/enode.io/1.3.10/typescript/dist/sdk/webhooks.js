...
var Webhooks = /** @class */ (function () {
    ...
    **/
    Webhooks.prototype.postWebhooksFirehoseTest = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostWebhooksFirehoseTestRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/webhooks/firehose/test";
            ...
            switch (true) {
                default:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.postWebhooksFirehoseTestDefaultApplicationJSONString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
    ...
    **/
    Webhooks.prototype.putWebhooksFirehose = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PutWebhooksFirehoseRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/webhooks/firehose";
