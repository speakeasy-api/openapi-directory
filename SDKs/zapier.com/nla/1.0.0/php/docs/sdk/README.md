...
try {
    ...
    $response = $sdk->sdk->check($requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointRequest;
use \OpenAPI\OpenAPI\Models\Shared\ExecuteRequest;
use \OpenAPI\OpenAPI\Models\Operations\ExecuteAppActionEndpointSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new ExecuteAppActionEndpointRequest();
    $request->executeRequest = new ExecuteRequest();
    $request->executeRequest->instructions = 'corrupti';
    $request->executeRequest->previewOnly = false;
    $request->exposedAppActionId = 'provident';

    $requestSecurity = new ExecuteAppActionEndpointSecurity();
    $requestSecurity->accessPointApiKeyHeader = 'YOUR_API_KEY_HERE';

    $response = $sdk->sdk->executeAppActionEndpoint($request, $requestSecurity);

    if ($response->executeResponse !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\GetConfigurationLinkSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $requestSecurity = new GetConfigurationLinkSecurity();
    $requestSecurity->accessPointApiKeyHeader = 'YOUR_API_KEY_HERE';

    $response = $sdk->sdk->getConfigurationLink($requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\GetExecutionLogEndpointRequest;
use \OpenAPI\OpenAPI\Models\Operations\GetExecutionLogEndpointSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $request = new GetExecutionLogEndpointRequest();
    $request->executionLogId = 'distinctio';

    $requestSecurity = new GetExecutionLogEndpointSecurity();
    $requestSecurity->accessPointApiKeyHeader = 'YOUR_API_KEY_HERE';

    $response = $sdk->sdk->getExecutionLogEndpoint($request, $requestSecurity);
...
use \OpenAPI\OpenAPI\SDK;
use \OpenAPI\OpenAPI\Models\Operations\ListExposedActionsSecurity;

$sdk = SDK::builder()
    ->build();

try {
    $requestSecurity = new ListExposedActionsSecurity();
    $requestSecurity->accessPointApiKeyHeader = 'YOUR_API_KEY_HERE';

    $response = $sdk->sdk->listExposedActions($requestSecurity);

    if ($response->exposedActionResponseSchema !== null) {
        // handle response
    }
} catch (Exception $e) {
    // handle exception
