...
class FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest:
    ...
    google_firebase_appcheck_v1_exchange_recaptcha_enterprise_token_request: Optional[shared_googlefirebaseappcheckv1exchangerecaptchaenterprisetokenrequest.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
