...
class GetGotermGeneAssociationsRequest
{
     ...
     * 
     * @var ?\OpenAPI\OpenAPI\Models\Operations\GetGotermGeneAssociationsRelationshipTypeEnum $relationshipType
     */
	#[SpeakeasyMetadata('queryParam:style=form,explode=true,name=relationship_type')]
    public ?GetGotermGeneAssociationsRelationshipTypeEnum $relationshipType = null;
