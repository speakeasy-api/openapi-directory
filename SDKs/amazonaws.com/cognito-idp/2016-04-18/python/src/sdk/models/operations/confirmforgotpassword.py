...
class ConfirmForgotPasswordRequest:
    ...
    confirm_forgot_password_request: shared_confirmforgotpasswordrequest.ConfirmForgotPasswordRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
