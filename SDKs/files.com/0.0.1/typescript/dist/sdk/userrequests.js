...
var UserRequests = /** @class */ (function () {
    function UserRequests(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Delete User Request
    **/
    UserRequests.prototype.deleteUserRequestsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteUserRequestsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/user_requests/{id}", req.pathParams);
     ...
     * List User Requests
    **/
    UserRequests.prototype.getUserRequests = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetUserRequestsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/user_requests";
        var client = this._defaultClient;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.userRequestEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
     ...
     * Show User Request
    **/
    UserRequests.prototype.getUserRequestsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        res.userRequestEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
     ...
     * Create User Request
    **/
    UserRequests.prototype.postUserRequests = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
