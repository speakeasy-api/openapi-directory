...
var Boundaries = /** @class */ (function () {
    ...
    **/
    Boundaries.prototype.fetchBoundaries = function (req, config) {
        var _a;
    ...
    **/
    Boundaries.prototype.fetchBoundaryById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Boundaries.prototype.uploadBoundary = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
