...
exports.InboundCellularFirewallRules = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var InboundCellularFirewallRules = /** @class */ (function () {
    function InboundCellularFirewallRules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return the inbound cellular firewall rules for an MX network
     */
    InboundCellularFirewallRules.prototype.getNetworkApplianceFirewallInboundCellularFirewallRules = function (req, config) {
     ...
     * Update the inbound cellular firewall rules of an MX network
     */
    InboundCellularFirewallRules.prototype.updateNetworkApplianceFirewallInboundCellularFirewallRules = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req =
...
exports.InboundCellularFirewallRules = InboundCellularFirewallRules;
