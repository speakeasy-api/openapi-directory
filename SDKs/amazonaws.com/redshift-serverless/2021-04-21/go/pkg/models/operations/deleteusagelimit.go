...
func (e DeleteUsageLimitXAmzTargetEnum) ToPointer() *DeleteUsageLimitXAmzTargetEnum {
	return &e
}
...
func (e *DeleteUsageLimitXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	case "RedshiftServerless.DeleteUsageLimit":
		*e = DeleteUsageLimitXAmzTargetEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for DeleteUsageLimitXAmzTargetEnum: %v", v)
	}
}
