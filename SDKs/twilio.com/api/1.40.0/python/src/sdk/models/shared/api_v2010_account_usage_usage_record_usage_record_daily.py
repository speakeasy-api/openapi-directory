...
class APIV2010AccountUsageUsageRecordUsageRecordDaily:
    ...
    category: Optional[shared_usage_record_daily_enum_category_enum.UsageRecordDailyEnumCategoryEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('category'), 'exclude': lambda f: f is None }})  
