...
class MergeBranchesBySquashHeaders:
...
class MergeBranchesBySquashRequest:
    headers: MergeBranchesBySquashHeaders = dataclasses.field()
    request: shared_mergebranchesbysquashinput.MergeBranchesBySquashInput = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
