...
public class GetConversationsQueryParams {
    ...
    public GetConversationsQueryParams withCategory(String category) {
    ...
    public GetConversationsQueryParams withDevicePixelRatio(Double devicePixelRatio) {
    ...
    public GetConversationsQueryParams withIncludeNumUnread(Long includeNumUnread) {
    ...
    public GetConversationsQueryParams withNumMessages(Long numMessages) {
    ...
    public Long page;
    public GetConversationsQueryParams withPage(Long page) {
        this.page = page;
        return this;
    }
    ...
    public Long perPage;
    public GetConversationsQueryParams withPerPage(Long perPage) {
