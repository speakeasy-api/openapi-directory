...
export class ClassifyImageUrlWithNoStorePathParams extends SpeakeasyBase {
...
export class ClassifyImageUrlWithNoStoreQueryParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=application" })
  application?: string;
}


export class ClassifyImageUrlWithNoStoreRequests extends SpeakeasyBase {
...
export class ClassifyImageUrlWithNoStoreRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class ClassifyImageUrlWithNoStoreResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
