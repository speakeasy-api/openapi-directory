...
class PutAccessControlRuleRequest:
    ...
    put_access_control_rule_request: shared_putaccesscontrolrulerequest.PutAccessControlRuleRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
