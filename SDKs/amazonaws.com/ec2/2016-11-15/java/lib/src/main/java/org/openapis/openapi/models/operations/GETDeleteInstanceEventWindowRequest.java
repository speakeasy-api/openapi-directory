...
public class GETDeleteInstanceEventWindowRequest {
    ...
    public GETDeleteInstanceEventWindowRequest(@JsonProperty("Action") GETDeleteInstanceEventWindowActionEnum action, @JsonProperty("InstanceEventWindowId") String instanceEventWindowId, @JsonProperty("Version") GETDeleteInstanceEventWindowVersionEnum version) {
        this.action = action;
        this.instanceEventWindowId = instanceEventWindowId;
        this.version = version;
  }
