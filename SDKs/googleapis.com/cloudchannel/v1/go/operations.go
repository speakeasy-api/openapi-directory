...
func (s *operationsT) CloudchannelOperationsCancel(ctx context.Context, request operations.CloudchannelOperationsCancelRequest) (*operations.CloudchannelOperationsCancelResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) CloudchannelOperationsDelete(ctx context.Context, request operations.CloudchannelOperationsDeleteRequest) (*operations.CloudchannelOperationsDeleteResponse, error) {
	baseURL := s.serverURL
...
func (s *operationsT) CloudchannelOperationsList(ctx context.Context, request operations.CloudchannelOperationsListRequest) (*operations.CloudchannelOperationsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request.PathParams, nil)
