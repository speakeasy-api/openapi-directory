...
class GetGeneExpressionAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGeneExpressionAssociationsQueryParams:
...
class GetGeneExpressionAssociationsRequest:
    path_params: GetGeneExpressionAssociationsPathParams = dataclasses.field()
    query_params: GetGeneExpressionAssociationsQueryParams = dataclasses.field()
