...
class PutFirewallRuleGroupPolicyRequest:
    ...
    put_firewall_rule_group_policy_request: shared_putfirewallrulegrouppolicyrequest.PutFirewallRuleGroupPolicyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
