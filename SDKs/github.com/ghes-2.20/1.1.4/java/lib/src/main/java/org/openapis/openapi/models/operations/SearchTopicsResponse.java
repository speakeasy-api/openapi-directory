...
public class SearchTopicsResponse {
    ...
    public SearchTopicsResponse withStatusCode(Integer statusCode) {
    ...
    public SearchTopicsResponse withRawResponse(HttpResponse<byte[]> rawResponse) {
    ...
    public SearchTopicsResponse(@JsonProperty("ContentType") String contentType, @JsonProperty("StatusCode") Integer statusCode) {
        this.contentType = contentType;
        this.statusCode = statusCode;
  }
}
