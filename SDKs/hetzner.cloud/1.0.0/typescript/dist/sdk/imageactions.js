...
var ImageActions = /** @class */ (function () {
    ...
    **/
    ImageActions.prototype.getImagesIdActions = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/images/{id}/actions", req.pathParams);
    ...
    **/
    ImageActions.prototype.getImagesIdActionsActionId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/images/{id}/actions/{action_id}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    ImageActions.prototype.postImagesIdActionsChangeProtection = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/images/{id}/actions/change_protection", req.pathParams);
