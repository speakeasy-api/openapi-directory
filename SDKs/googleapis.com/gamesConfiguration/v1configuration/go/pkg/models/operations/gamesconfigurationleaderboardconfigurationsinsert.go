...
type GamesConfigurationLeaderboardConfigurationsInsertSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type GamesConfigurationLeaderboardConfigurationsInsertPathParams struct {
	// The application ID from the Google Play developer console.
	ApplicationID string `pathParam:"style=simple,explode=false,name=applicationId"`
}

type GamesConfigurationLeaderboardConfigurationsInsertQueryParams struct {
	// V1 error format.
...
type GamesConfigurationLeaderboardConfigurationsInsertRequest struct {
...
type GamesConfigurationLeaderboardConfigurationsInsertResponse struct {
	ContentType string
	// Successful response
