...
class ReplaceAlbumLogoRequest:
    path_params: ReplaceAlbumLogoPathParams = dataclasses.field()
    security: ReplaceAlbumLogoSecurity = dataclasses.field()
    request: Optional[ReplaceAlbumLogoRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/vnd.vimeo.picture+json' }})
