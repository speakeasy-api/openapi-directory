...
import org.openapis.openapi.models.operations.CvcerRequest;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            CvcerRequest req = new CvcerRequest() {{
                security = new CvcerSecurity() {{
            ...
            CvcerResponse res = sdk.apIs.cvcer(req);
