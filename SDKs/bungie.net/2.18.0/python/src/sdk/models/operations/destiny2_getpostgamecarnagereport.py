...
from ..shared import destiny_historicalstats_destinypostgamecarnagereportdata as shared_destiny_historicalstats_destinypostgamecarnagereportdata
...
class Destiny2GetPostGameCarnageReportRequest:
    ...
    r"""The ID of the activity whose PGCR is requested."""  
...
class Destiny2GetPostGameCarnageReport200Wildcard:
    ...
    response: Optional[shared_destiny_historicalstats_destinypostgamecarnagereportdata.DestinyHistoricalStatsDestinyPostGameCarnageReportData] = dataclasses.field(default=None)  
