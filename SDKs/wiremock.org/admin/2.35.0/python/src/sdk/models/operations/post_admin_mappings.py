...
class PostAdminMappingsRequestBodyRequest:
    ...
    basic_auth_credentials: Optional[PostAdminMappingsRequestBodyRequestBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
...
class PostAdminMappingsRequestBodyResponseDelayDistributionUniformTypeEnum(str, Enum):
    UNIFORM = 'uniform'


@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class PostAdminMappingsRequestBodyResponseDelayDistributionUniform:
    ...
    type: Optional[PostAdminMappingsRequestBodyResponseDelayDistributionUniformTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PostAdminMappingsRequestBodyResponseDelayDistributionLogNormalTypeEnum(str, Enum):
    LOGNORMAL = 'lognormal'
...
class PostAdminMappingsRequestBodyResponseDelayDistributionLogNormal:
    ...
    type: Optional[PostAdminMappingsRequestBodyResponseDelayDistributionLogNormalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PostAdminMappingsRequestBodyResponse:
    ...
    fault: Optional[PostAdminMappingsRequestBodyResponseFaultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fault'), 'exclude': lambda f: f is None }})
    r"""The fault to apply (instead of a full, valid response)."""  
...
class PostAdminMappingsRequestBody:
    ...
    request: Optional[PostAdminMappingsRequestBodyRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})  
    ...
    response: Optional[PostAdminMappingsRequestBodyResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response'), 'exclude': lambda f: f is None }})  
...
class PostAdminMappings201ApplicationJSONRequest:
    ...
    basic_auth_credentials: Optional[PostAdminMappings201ApplicationJSONRequestBasicAuthCredentials] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('basicAuthCredentials'), 'exclude': lambda f: f is None }})
    r"""Pre-emptive basic auth credentials to match against"""  
    body_patterns: Optional[list[dict[str, Any]]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('bodyPatterns'), 'exclude': lambda f: f is None }})
    r"""Request body patterns to match against in the <key>: { \\"<predicate>\\": \\"<value>\\" } form"""  
    cookies: Optional[dict[str, Any]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cookies'), 'exclude': lambda f: f is None }})
...
class PostAdminMappings201ApplicationJSONResponseDelayDistributionUniformTypeEnum(str, Enum):
    UNIFORM = 'uniform'
...
class PostAdminMappings201ApplicationJSONResponseDelayDistributionUniform:
    ...
    lower: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('lower'), 'exclude': lambda f: f is None }})  
    type: Optional[PostAdminMappings201ApplicationJSONResponseDelayDistributionUniformTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
    upper: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('upper'), 'exclude': lambda f: f is None }})  
    
class PostAdminMappings201ApplicationJSONResponseDelayDistributionLogNormalTypeEnum(str, Enum):
    LOGNORMAL = 'lognormal'
...
class PostAdminMappings201ApplicationJSONResponseDelayDistributionLogNormal:
    ...
    median: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('median'), 'exclude': lambda f: f is None }})  
    sigma: Optional[float] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sigma'), 'exclude': lambda f: f is None }})  
    type: Optional[PostAdminMappings201ApplicationJSONResponseDelayDistributionLogNormalTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type'), 'exclude': lambda f: f is None }})  
...
class PostAdminMappings201ApplicationJSONResponse:
    ...
    delay_distribution: Optional[Any] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('delayDistribution'), 'exclude': lambda f: f is None }})
    r"""The delay distribution. Valid property configuration is either median/sigma/type or lower/type/upper."""  
    fault: Optional[PostAdminMappings201ApplicationJSONResponseFaultEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fault'), 'exclude': lambda f: f is None }})
    r"""The fault to apply (instead of a full, valid response)."""  
    fixed_delay_milliseconds: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fixedDelayMilliseconds'), 'exclude': lambda f: f is None }})
    r"""Number of milliseconds to delay be before sending the response."""  
    from_configured_stub: Optional[bool] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fromConfiguredStub'), 'exclude': lambda f: f is None }})
...
class PostAdminMappings201ApplicationJSON:
    ...
    priority: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('priority'), 'exclude': lambda f: f is None }})
    r"""This stub mapping's priority relative to others. 1 is highest."""  
    request: Optional[PostAdminMappings201ApplicationJSONRequest] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('request'), 'exclude': lambda f: f is None }})  
    required_scenario_state: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('requiredScenarioState'), 'exclude': lambda f: f is None }})
    r"""The required state of the scenario in order for this stub to be matched."""  
    response: Optional[PostAdminMappings201ApplicationJSONResponse] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('response'), 'exclude': lambda f: f is None }})  
    scenario_name: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('scenarioName'), 'exclude': lambda f: f is None }})
    r"""The name of the scenario that this stub mapping is part of"""  
    uuid: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uuid'), 'exclude': lambda f: f is None }})
    r"""Alias for the id"""  
