...
public class CreateInternationalScheduledPaymentsRawHeaders {
    /**
     * An Authorisation Token as per https://tools.ietf.org/html/rfc6750
     */
    @SpeakeasyMetadata("header:style=simple,explode=false,name=Authorization")
    public String authorization;
    public CreateInternationalScheduledPaymentsRawHeaders withAuthorization(String authorization) {
    ...
    public CreateInternationalScheduledPaymentsRawHeaders withXCustomerUserAgent(String xCustomerUserAgent) {
    ...
    public CreateInternationalScheduledPaymentsRawHeaders withXFapiAuthDate(String xFapiAuthDate) {
    ...
    public CreateInternationalScheduledPaymentsRawHeaders withXFapiCustomerIpAddress(String xFapiCustomerIpAddress) {
    ...
    public CreateInternationalScheduledPaymentsRawHeaders withXFapiInteractionId(String xFapiInteractionId) {
    ...
    public CreateInternationalScheduledPaymentsRawHeaders withXIdempotencyKey(String xIdempotencyKey) {
    ...
    public CreateInternationalScheduledPaymentsRawHeaders withXJwsSignature(String xJwsSignature) {
