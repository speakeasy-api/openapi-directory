...
from ..shared import proxymodifysubscription as shared_proxymodifysubscription
...
class ObjectPUTSubscriptionRequest:
    ...
    r"""Object id"""  
    proxy_modify_subscription: shared_proxymodifysubscription.ProxyModifySubscription = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
