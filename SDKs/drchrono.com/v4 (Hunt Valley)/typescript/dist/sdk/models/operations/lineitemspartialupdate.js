...
exports.LineItemsPartialUpdateResponse = exports.LineItemsPartialUpdateRequest = exports.LineItemsPartialUpdateSecurity = void 0;
...
var LineItemsPartialUpdateRequest = /** @class */ (function (_super) {
    ...
    ], LineItemsPartialUpdateRequest.prototype, "appointment", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=doctor",
        }),
        __metadata("design:type", Number)
    ], LineItemsPartialUpdateRequest.prototype, "doctor", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], LineItemsPartialUpdateRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=office",
        }),
        __metadata("design:type", Number)
    ], LineItemsPartialUpdateRequest.prototype, "office", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=patient",
        }),
        __metadata("design:type", Number)
    ], LineItemsPartialUpdateRequest.prototype, "patient", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=posted_date",
        }),
        __metadata("design:type", String)
    ], LineItemsPartialUpdateRequest.prototype, "postedDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=service_date",
        }),
        __metadata("design:type", String)
    ], LineItemsPartialUpdateRequest.prototype, "serviceDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=since" }),
        __metadata("design:type", String)
    ], LineItemsPartialUpdateRequest.prototype, "since", void 0);
...
var LineItemsPartialUpdateResponse = /** @class */ (function (_super) {
    ...
    ], LineItemsPartialUpdateResponse.prototype, "rawResponse", void 0);
