...
export class IdentitytoolkitRelyingpartyGetAccountInfoSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class IdentitytoolkitRelyingpartyGetAccountInfoResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
