...
import org.openapis.openapi.models.operations.RsbycRequestBody;
import org.openapis.openapi.models.operations.RsbycRequestBodyCertificateParameters;
import org.openapis.openapi.models.operations.RsbycRequestBodyFormatEnum;
import org.openapis.openapi.models.operations.RsbycResponse;
import org.openapis.openapi.models.operations.RsbycSecurity;
...
public class Application {
    public static void main(String[] args) {
        try {
            ...
            RsbycRequestBody req = new RsbycRequestBody(RsbycRequestBodyFormatEnum.PDF, "f7f1469c-29b0-4325-9dfc-c567200a70f7") {{
                certificateParameters = new RsbycRequestBodyCertificateParameters("123412341234");;
            ...
            RsbycResponse res = sdk.apIs.rsbyc(req, new RsbycSecurity("molestiae", "minus") {{
