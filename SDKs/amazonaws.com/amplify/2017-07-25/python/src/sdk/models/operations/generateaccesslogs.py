...
class GenerateAccessLogsRequest:
    headers: GenerateAccessLogsHeaders = dataclasses.field()
    path_params: GenerateAccessLogsPathParams = dataclasses.field()
    request: GenerateAccessLogsRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
