...
type MeetingUpdateJSONPathParams struct {
...
type MeetingUpdateJSONQueryParams struct {
...
type MeetingUpdateJSONRequest struct {
	PathParams  MeetingUpdateJSONPathParams
	QueryParams MeetingUpdateJSONQueryParams
	// Meeting
	Request  MeetingUpdateApplicationJSON `request:"mediaType=application/json"`
	Security MeetingUpdateJSONSecurity
}
