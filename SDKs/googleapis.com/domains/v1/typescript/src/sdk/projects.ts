...
export class Projects {
  ...
  **/
  domainsProjectsLocationsRegistrationsConfigureContactSettings(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{registration}:configureContactSettings", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsConfigureDnsSettings(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{registration}:configureDnsSettings", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsConfigureManagementSettings(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{registration}:configureManagementSettings", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsExport(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{name}:export", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsImport(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/registrations:import", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/registrations", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsRegister(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/registrations:register", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsResetAuthorizationCode(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{registration}:resetAuthorizationCode", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsRetrieveAuthorizationCode(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{registration}:retrieveAuthorizationCode", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsRetrieveImportableDomains(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{location}/registrations:retrieveImportableDomains", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsRetrieveRegisterParameters(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{location}/registrations:retrieveRegisterParameters", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsRetrieveTransferParameters(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{location}/registrations:retrieveTransferParameters", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsSearchDomains(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{location}/registrations:searchDomains", req.pathParams);
  ...
  **/
  domainsProjectsLocationsRegistrationsTransfer(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.generateURL(baseURL, "/v1/{parent}/registrations:transfer", req.pathParams);
