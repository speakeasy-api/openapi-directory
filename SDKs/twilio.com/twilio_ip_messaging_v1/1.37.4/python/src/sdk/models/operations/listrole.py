...
class ListRoleListRoleResponse:
    ...
    roles: Optional[list[shared_ip_messaging_v1_service_role.IPMessagingV1ServiceRole]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('roles') }})
