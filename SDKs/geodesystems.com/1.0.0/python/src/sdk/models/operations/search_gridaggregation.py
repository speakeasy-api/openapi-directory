...
class SearchGridaggregationQueryParams:
...
@dataclasses.dataclass
class SearchGridaggregationRequest:
    query_params: SearchGridaggregationQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchGridaggregationResponse:
