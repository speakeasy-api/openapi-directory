...
class IdentitytoolkitAccountsMfaEnrollmentStartRequest:
    ...
    google_cloud_identitytoolkit_v2_start_mfa_enrollment_request: Optional[shared_googlecloudidentitytoolkitv2startmfaenrollmentrequest.GoogleCloudIdentitytoolkitV2StartMfaEnrollmentRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
