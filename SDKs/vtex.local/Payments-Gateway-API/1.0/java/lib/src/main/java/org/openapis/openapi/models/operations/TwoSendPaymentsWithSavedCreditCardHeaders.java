...
public class TwoSendPaymentsWithSavedCreditCardHeaders {
    /**
    ...
    public TwoSendPaymentsWithSavedCreditCardHeaders withAccept(String accept) {
        this.accept = accept;
        return this;
    }
    ...
    public TwoSendPaymentsWithSavedCreditCardHeaders withContentType(String contentType) {
    ...
    public TwoSendPaymentsWithSavedCreditCardHeaders withXPROVIDERAPIAppKey(String xPROVIDERAPIAppKey) {
    ...
    public TwoSendPaymentsWithSavedCreditCardHeaders withXPROVIDERAPIAppToken(String xPROVIDERAPIAppToken) {
