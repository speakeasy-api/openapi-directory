...
class LookupPolicyRequestBody:
    object_reference: LookupPolicyRequestBodyObjectReference = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
...
class LookupPolicyRequest:
    headers: LookupPolicyHeaders = dataclasses.field()
    query_params: LookupPolicyQueryParams = dataclasses.field()
    request: LookupPolicyRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
