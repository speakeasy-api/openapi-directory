...
export class Search {
  ...
  searchCode(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.SearchCodeResponse =
        new operations.SearchCodeResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchCode200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchCode200ApplicationJSON
            );
          }
          break;
        ...
        case httpRes?.status == 503:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchCode503ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchCode503ApplicationJSON
            );
          }
          break;
      }
  ...
  searchCommits(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchCommitsResponse =
        new operations.SearchCommitsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchCommits200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchCommits200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 304:
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchCommits415ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchCommits415ApplicationJSON
            );
          }
          break;
      }
  ...
  searchIssuesAndPullRequests(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchIssuesAndPullRequestsResponse =
        new operations.SearchIssuesAndPullRequestsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
        ...
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchIssuesAndPullRequests200ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.SearchIssuesAndPullRequests200ApplicationJSON
              );
          }
          break;
        case httpRes?.status == 304:
        ...
        case httpRes?.status == 503:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchIssuesAndPullRequests503ApplicationJSONObject =
              utils.objectToClass(
                httpRes?.data,
                operations.SearchIssuesAndPullRequests503ApplicationJSON
              );
          }
          break;
      }
  ...
  searchLabels(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchLabelsResponse =
        new operations.SearchLabelsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchLabels200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchLabels200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 304:
  ...
  searchRepos(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchReposResponse =
        new operations.SearchReposResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchRepos200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchRepos200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 304:
        ...
        case httpRes?.status == 503:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchRepos503ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchRepos503ApplicationJSON
            );
          }
          break;
      }
  ...
  searchTopics(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchTopicsResponse =
        new operations.SearchTopicsResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchTopics200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchTopics200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 304:
        ...
        case httpRes?.status == 415:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchTopics415ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchTopics415ApplicationJSON
            );
          }
          break;
      }
  ...
  searchUsers(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SearchUsersResponse =
        new operations.SearchUsersResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchUsers200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchUsers200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 304:
        ...
        case httpRes?.status == 503:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.searchUsers503ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SearchUsers503ApplicationJSON
            );
          }
          break;
      }
