...
export enum AccountDatasetAdditionalStatusEnum {
...
export enum AccountDatasetNameEnum {
...
export enum AccountDatasetUpdateEligibilityEnum {
...
export class AccountDataset extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=nextUpdateScheduled" })
  nextUpdateScheduled?: string;

  @SpeakeasyMetadata({ data: "json, name=updateEligibility" })
