...
type ContentRepricingrulesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentRepricingrulesListPathParams struct {
	// Required. The id of the merchant who owns the repricing rule.
	MerchantID string `pathParam:"style=simple,explode=false,name=merchantId"`
}

type ContentRepricingrulesListQueryParams struct {
	// V1 error format.
...
type ContentRepricingrulesListRequest struct {
...
type ContentRepricingrulesListResponse struct {
	ContentType string
	// Successful response
