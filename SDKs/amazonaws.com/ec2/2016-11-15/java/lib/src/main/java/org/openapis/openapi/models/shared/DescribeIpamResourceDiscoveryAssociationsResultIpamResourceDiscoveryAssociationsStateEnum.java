 ...
 */
public enum DescribeIpamResourceDiscoveryAssociationsResultIpamResourceDiscoveryAssociationsStateEnum {
    ...
    private DescribeIpamResourceDiscoveryAssociationsResultIpamResourceDiscoveryAssociationsStateEnum(String value) {
        this.value = value;
    }
}
