...
public class GetlasteventofQueryParams {
    ...
    public Long offset;
    public GetlasteventofQueryParams withOffset(Long offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GetlasteventofQueryParams withPersonId(String personId) {
