...
from ..shared import trending_trendingcategories as shared_trending_trendingcategories
...
class TrendingGetTrendingCategories200Wildcard:
    ...
    response: Optional[shared_trending_trendingcategories.TrendingTrendingCategories] = dataclasses.field(default=None)  
