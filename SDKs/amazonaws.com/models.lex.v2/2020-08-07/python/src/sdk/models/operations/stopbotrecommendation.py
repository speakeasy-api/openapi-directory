...
from ..shared import stopbotrecommendationresponse as shared_stopbotrecommendationresponse
...
class StopBotRecommendationRequest:
    ...
    r"""The unique identifier of the bot containing the bot recommendation to be stopped."""  
    ...
    r"""The unique identifier of the bot recommendation to be stopped."""  
    ...
    r"""The identifier of the language and locale of the bot recommendation to stop. The string must match one of the supported locales. For more information, see <a href=\\"https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html\\">Supported languages</a>"""  
...
class StopBotRecommendationResponse:
    ...
    stop_bot_recommendation_response: Optional[shared_stopbotrecommendationresponse.StopBotRecommendationResponse] = dataclasses.field(default=None)
    r"""Success"""  
