 ...
 * 
 */
public class ProxyModifyAccount {
    /**
    ...
    public ProxyModifyAccount withAccountNumber(String accountNumber) {
    ...
    public ProxyModifyAccount withAdditionalEmailAddresses(String additionalEmailAddresses) {
    ...
    public ProxyModifyAccount withAllowInvoiceEdit(Boolean allowInvoiceEdit) {
    ...
    public ProxyModifyAccount withAutoPay(Boolean autoPay) {
    ...
    @JsonProperty("Batch")
    public String batch;
    public ProxyModifyAccount withBatch(String batch) {
        this.batch = batch;
        return this;
    }
    ...
    public ProxyModifyAccount withBcdSettingOption(String bcdSettingOption) {
    ...
    public ProxyModifyAccount withBillCycleDay(Integer billCycleDay) {
    ...
    public ProxyModifyAccount withBillToId(String billToId) {
    ...
    public ProxyModifyAccount withClassNS(String classNS) {
    ...
    @JsonProperty("CrmId")
    public String crmId;
    public ProxyModifyAccount withCrmId(String crmId) {
        this.crmId = crmId;
        return this;
    }
    ...
    public ProxyModifyAccount withCurrency(String currency) {
    ...
    public ProxyModifyAccount withCustomerServiceRepName(String customerServiceRepName) {
    ...
    public ProxyModifyAccountCustomerTypeNSEnum customerTypeNS;
    public ProxyModifyAccount withCustomerTypeNS(ProxyModifyAccountCustomerTypeNSEnum customerTypeNS) {
    ...
    public ProxyModifyAccount withDefaultPaymentMethodId(String defaultPaymentMethodId) {
    ...
    public ProxyModifyAccount withDepartmentNS(String departmentNS) {
    ...
    public ProxyModifyAccount withIntegrationIdNS(String integrationIdNS) {
    ...
    public ProxyModifyAccount withIntegrationStatusNS(String integrationStatusNS) {
    ...
    public ProxyModifyAccount withInvoiceDeliveryPrefsEmail(Boolean invoiceDeliveryPrefsEmail) {
    ...
    public ProxyModifyAccount withInvoiceDeliveryPrefsPrint(Boolean invoiceDeliveryPrefsPrint) {
    ...
    public ProxyModifyAccount withInvoiceTemplateId(String invoiceTemplateId) {
    ...
    public ProxyModifyAccount withLocationNS(String locationNS) {
    ...
    @JsonProperty("Name")
    public String name;
    public ProxyModifyAccount withName(String name) {
        this.name = name;
        return this;
    }
    ...
    @JsonProperty("Notes")
    public String notes;
    public ProxyModifyAccount withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public ProxyModifyAccount withParentId(String parentId) {
    ...
    public ProxyModifyAccount withPaymentGateway(String paymentGateway) {
    ...
    public ProxyModifyAccount withPaymentTerm(String paymentTerm) {
    ...
    public ProxyModifyAccount withPurchaseOrderNumber(String purchaseOrderNumber) {
    ...
    public ProxyModifyAccount withSalesRepName(String salesRepName) {
    ...
    public ProxyModifyAccount withSoldToId(String soldToId) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("Status")
    public ProxyModifyAccountStatusEnum status;
    public ProxyModifyAccount withStatus(ProxyModifyAccountStatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public ProxyModifyAccount withSubsidiaryNS(String subsidiaryNS) {
    ...
    public ProxyModifyAccount withSyncDateNS(String syncDateNS) {
    ...
    public ProxyModifyAccountSynctoNetSuiteNSEnum synctoNetSuiteNS;
    public ProxyModifyAccount withSynctoNetSuiteNS(ProxyModifyAccountSynctoNetSuiteNSEnum synctoNetSuiteNS) {
    ...
    public ProxyModifyAccount withTaxCompanyCode(String taxCompanyCode) {
    ...
    public ProxyModifyAccount withTaxExemptCertificateID(String taxExemptCertificateID) {
    ...
    public ProxyModifyAccount withTaxExemptCertificateType(String taxExemptCertificateType) {
    ...
    public ProxyModifyAccount withTaxExemptDescription(String taxExemptDescription) {
    ...
    public ProxyModifyAccount withTaxExemptEffectiveDate(LocalDate taxExemptEffectiveDate) {
    ...
    public ProxyModifyAccount withTaxExemptExpirationDate(LocalDate taxExemptExpirationDate) {
    ...
    public ProxyModifyAccount withTaxExemptIssuingJurisdiction(String taxExemptIssuingJurisdiction) {
    ...
    public ProxyModifyAccount withTaxExemptStatus(String taxExemptStatus) {
    ...
    @JsonProperty("VATId")
    public String vatId;
    public ProxyModifyAccount withVATId(String vatId) {
        this.vatId = vatId;
        return this;
    }
    ...
    public ProxyModifyAccount withCommunicationProfileId(String communicationProfileId) {
