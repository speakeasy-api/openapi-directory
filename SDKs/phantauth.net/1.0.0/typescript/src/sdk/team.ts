...
export class Team {
  ...
  getTeamTeamname(
    ...
    const url: string = utils.generateURL(baseURL, "/team/{teamname}", req);
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GetTeamTeamnameResponse =
        new operations.GetTeamTeamnameResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.getTeamTeamname200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.GetTeamTeamname200ApplicationJSON
            );
          }
          break;
      }
