...
class UpdateQueueRequest:
    path_params: UpdateQueuePathParams = dataclasses.field()
    security: UpdateQueueSecurity = dataclasses.field()
    request: Optional[UpdateQueueUpdateQueueRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
