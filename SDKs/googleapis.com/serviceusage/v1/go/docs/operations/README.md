...
func main() {
    ...
    res, err := s.Operations.ServiceusageOperationsCancel(ctx, operations.ServiceusageOperationsCancelRequest{
    ...
    }, operations.ServiceusageOperationsCancelSecurity{
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Operations.ServiceusageOperationsDelete(ctx, operations.ServiceusageOperationsDeleteRequest{
        DollarXgafv: shared.XgafvEnumTwo.ToPointer(),
    ...
    }, operations.ServiceusageOperationsDeleteSecurity{
        Option1: &operations.ServiceusageOperationsDeleteSecurityOption1{
            Oauth2: "Bearer YOUR_ACCESS_TOKEN_HERE",
            Oauth2c: "Bearer YOUR_ACCESS_TOKEN_HERE",
        },
    })
