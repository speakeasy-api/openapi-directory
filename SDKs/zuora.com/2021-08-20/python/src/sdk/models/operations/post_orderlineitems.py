...
class PostOrderLineItemsRequest:
    ...
    post_order_line_items_request_type: shared_postorderlineitemsrequesttype.PostOrderLineItemsRequestType = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
