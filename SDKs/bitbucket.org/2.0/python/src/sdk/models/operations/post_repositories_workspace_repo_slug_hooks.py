...
class PostRepositoriesWorkspaceRepoSlugHooksRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugHooksPathParams = dataclasses.field()
    security: PostRepositoriesWorkspaceRepoSlugHooksSecurity = dataclasses.field()
