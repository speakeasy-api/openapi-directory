...
exports.RestResource = void 0;
var utils_1 = require("../../../internal/utils");
var restmethod_1 = require("./restmethod");
var class_transformer_1 = require("class-transformer");
var RestResource = /** @class */ (function (_super) {
    ...
    ], RestResource.prototype, "methods", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: RestResource }),
        (0, class_transformer_1.Expose)({ name: "resources" }),
        (0, class_transformer_1.Transform)(function (_a) {
            var value = _a.value;
            var obj = {};
            for (var key in value) {
                obj[key] = (0, utils_1.objectToClass)(value[key], RestResource);
            }
            return obj;
        }, { toClassOnly: true }),
        __metadata("design:type", Object)
    ], RestResource.prototype, "resources", void 0);
    return RestResource;
