...
func NewPvAPI(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *PvAPI {
	return &PvAPI{
...
func (s *PvAPI) PvAPIGetList(ctx context.Context, request operations.PvAPIGetListRequest) (*operations.PvAPIGetListResponse, error) {
