...
class Error403PIIS:
    ...
    additional_errors: Optional[list[Error403PIISAdditionalErrors]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('additionalErrors'), 'exclude': lambda f: f is None }})
