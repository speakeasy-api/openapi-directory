 ...
 */
export enum ForwardingRuleAggregatedListWarningCodeEnum {
...
export class ForwardingRuleAggregatedListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class ForwardingRuleAggregatedListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: ForwardingRuleAggregatedListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class ForwardingRuleAggregatedList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: ForwardingRulesScopedList })
  @Expose({ name: "items" })
  @Transform(
    ({ value }) => {
      const obj: Record<string, ForwardingRulesScopedList> = {};
      for (const key in value) {
        obj[key] = objectToClass(value[key], ForwardingRulesScopedList);
      }
      return obj;
    },
    { toClassOnly: true }
