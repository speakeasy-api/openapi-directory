...
class Permissions:
    ...
    def delete_permissions_id(self, request: operations.DeletePermissionsIDRequest) -> operations.DeletePermissionsIDResponse:
        ...
        url = utils.generate_url(operations.DeletePermissionsIDRequest, base_url, '/permissions/{id}', request)
        ...
        res = operations.DeletePermissionsIDResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def post_permissions(self, request: operations.PostPermissionsRequestBody) -> operations.PostPermissionsResponse:
        r"""Create Permission
        Create Permission
        """
        base_url = self._server_url
        ...
        if http_res.status_code == 201:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.PermissionEntity])
