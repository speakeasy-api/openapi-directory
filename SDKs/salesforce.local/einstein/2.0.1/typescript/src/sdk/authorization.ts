...
export class Authorization {
  ...
  generateTokenV2(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.GenerateTokenV2RequestBody(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.GenerateTokenV2Response =
        new operations.GenerateTokenV2Response({
  ...
  revokeRefreshTokenV2(
    ...
    security: operations.RevokeRefreshTokenV2Security,
    config?: AxiosRequestConfig
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security = new operations.RevokeRefreshTokenV2Security(security);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.RevokeRefreshTokenV2Response =
        new operations.RevokeRefreshTokenV2Response({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
