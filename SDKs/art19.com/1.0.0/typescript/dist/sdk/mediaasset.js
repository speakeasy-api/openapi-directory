...
var MediaAsset = /** @class */ (function () {
     ...
     *
     */
    MediaAsset.prototype.getMediaAssets = function (req, security, config) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetMediaAssetsResponse({
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getMediaAssets200ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetMediaAssets200ApplicationVndApiPlusJson);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getMediaAssets400ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetMediaAssets400ApplicationVndApiPlusJson);
                    }
                    break;
     ...
     *
     */
    MediaAsset.prototype.getMediaAssetsId = function (req, security, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetMediaAssetsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/media_assets/{id}", req);
        if (!(security instanceof utils.SpeakeasyBase)) {
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.GetMediaAssetsIdResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/vnd.api+json")) {
                        res.getMediaAssetsId200ApplicationVndApiPlusJsonObject =
                            utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, operations.GetMediaAssetsId200ApplicationVndApiPlusJson);
                    }
                    break;
