 ...
 * 
 */
public enum ReleasesAvailableToTester200ApplicationJSONDestinationTypeEnum {
    GROUP("group"),
    STORE("store"),
    TESTER("tester");
    ...
    private ReleasesAvailableToTester200ApplicationJSONDestinationTypeEnum(String value) {
        this.value = value;
    }
}
