...
export declare class FindNumberLeaseConfigsSecurity extends SpeakeasyBase {
    password: string;
    username: string;
}
export declare class FindNumberLeaseConfigsRequest extends SpeakeasyBase {
    /**
     * A city name
     */
    city?: string;
...
export declare class FindNumberLeaseConfigsResponse extends SpeakeasyBase {
    contentType: string;
    /**
     * Bad request
     */
