...
type NetworksecurityProjectsLocationsServerTLSPoliciesPatchPathParams struct {
...
type NetworksecurityProjectsLocationsServerTLSPoliciesPatchQueryParams struct {
	// V1 error format.
