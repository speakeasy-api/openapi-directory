...
exports.ProductApiAllResponse = exports.ProductApiAllRequest = void 0;
...
var ProductApiAllRequest = /** @class */ (function (_super) {
    ...
    ], ProductApiAllRequest.prototype, "queryOptionsPage", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=queryOptions.pageSize",
        }),
        __metadata("design:type", Number)
    ], ProductApiAllRequest.prototype, "queryOptionsPageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-key",
        }),
        __metadata("design:type", String)
    ], ProductApiAllRequest.prototype, "xAuthKey", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=x-auth-secret",
        }),
        __metadata("design:type", String)
    ], ProductApiAllRequest.prototype, "xAuthSecret", void 0);
    return ProductApiAllRequest;
}(utils_1.SpeakeasyBase));
exports.ProductApiAllRequest = ProductApiAllRequest;
var ProductApiAllResponse = /** @class */ (function (_super) {
    ...
    ], ProductApiAllResponse.prototype, "rawResponse", void 0);
    return ProductApiAllResponse;
}(utils_1.SpeakeasyBase));
exports.ProductApiAllResponse = ProductApiAllResponse;
