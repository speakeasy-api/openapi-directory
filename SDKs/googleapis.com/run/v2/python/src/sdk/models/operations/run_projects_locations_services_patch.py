...
class RunProjectsLocationsServicesPatchPathParams:
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class RunProjectsLocationsServicesPatchQueryParams:
...
class RunProjectsLocationsServicesPatchRequest:
    path_params: RunProjectsLocationsServicesPatchPathParams = dataclasses.field()
    query_params: RunProjectsLocationsServicesPatchQueryParams = dataclasses.field()
    security: RunProjectsLocationsServicesPatchSecurity = dataclasses.field()
