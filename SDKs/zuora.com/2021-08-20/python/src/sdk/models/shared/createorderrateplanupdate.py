...
from ..shared import createorderchargeupdate as shared_createorderchargeupdate


@dataclass_json
@dataclasses.dataclass
class CreateOrderRatePlanUpdate:
    r"""CreateOrderRatePlanUpdate
    Information about an order action of type `UpdateProduct`.
    
    """
    
    charge_updates: Optional[list[shared_createorderchargeupdate.CreateOrderChargeUpdate]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('chargeUpdates') }})
