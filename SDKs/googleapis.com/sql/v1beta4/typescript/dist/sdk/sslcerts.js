...
var SslCerts = /** @class */ (function () {
    ...
    **/
    SslCerts.prototype.sqlSslCertsCreateEphemeral = function (req, config) {
        ...
        var url = utils.generateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/createEphemeral", req.pathParams);
    ...
    **/
    SslCerts.prototype.sqlSslCertsDelete = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts/{sha1Fingerprint}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    **/
    SslCerts.prototype.sqlSslCertsInsert = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/sslCerts", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
