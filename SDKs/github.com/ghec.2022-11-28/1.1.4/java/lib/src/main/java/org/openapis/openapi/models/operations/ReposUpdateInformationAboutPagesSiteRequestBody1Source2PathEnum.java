 ...
 */
public enum ReposUpdateInformationAboutPagesSiteRequestBody1Source2PathEnum {
    ROOT("/"),
    ROOT_DOCS("/docs");
    ...
    private ReposUpdateInformationAboutPagesSiteRequestBody1Source2PathEnum(String value) {
        this.value = value;
    }
}
