...
export class GroupsUsers {
  ...
  checkIfUserJoinedGroup(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.CheckIfUserJoinedGroupResponse =
        new operations.CheckIfUserJoinedGroupResponse({
  ...
  checkIfUserJoinedGroupAlt1(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.CheckIfUserJoinedGroupAlt1Response =
        new operations.CheckIfUserJoinedGroupAlt1Response({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getGroupMembers(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetGroupMembersResponse =
        new operations.GetGroupMembersResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
  ...
  getUserGroupsAlt1(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.GetUserGroupsAlt1Response =
        new operations.GetUserGroupsAlt1Response({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
