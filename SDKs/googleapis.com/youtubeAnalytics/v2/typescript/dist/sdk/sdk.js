...
var groupitems_1 = require("./groupitems");
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.groupItems = new groupitems_1.GroupItems(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
