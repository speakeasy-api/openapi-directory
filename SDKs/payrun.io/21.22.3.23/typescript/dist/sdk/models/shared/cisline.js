...
var CisLineCisLine = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CisDeduction" }),
        __metadata("design:type", Number)
    ], CisLineCisLine.prototype, "cisDeduction", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CisLineType" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=NominalCodeKey" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=TaxTreatment" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=UnitRate" }),
        __metadata("design:type", Number)
...
var CisLine = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=CisLine" }),
