...
class UpdateResolverEndpointRequest:
    ...
    update_resolver_endpoint_request: shared_updateresolverendpointrequest.UpdateResolverEndpointRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
