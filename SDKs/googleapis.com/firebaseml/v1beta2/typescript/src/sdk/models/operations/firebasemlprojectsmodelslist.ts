...
export class FirebasemlProjectsModelsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class FirebasemlProjectsModelsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class FirebasemlProjectsModelsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
