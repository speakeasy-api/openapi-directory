...
class UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRules:
    ...
    protocol: UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesProtocolEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('protocol') }})
    r"""TCP or UDP"""  
    ...
    uplink: Optional[UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRulesUplinkEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('uplink'), 'exclude': lambda f: f is None }})
    r"""The physical WAN interface on which the traffic will arrive ('internet1' or, if available, 'internet2' or 'both')"""  
...
class UpdateNetworkApplianceFirewallPortForwardingRulesRequestBody:
    ...
    rules: list[UpdateNetworkApplianceFirewallPortForwardingRulesRequestBodyRules] = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('rules') }})
...
class UpdateNetworkApplianceFirewallPortForwardingRulesRequest:
    ...
    request_body: UpdateNetworkApplianceFirewallPortForwardingRulesRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
