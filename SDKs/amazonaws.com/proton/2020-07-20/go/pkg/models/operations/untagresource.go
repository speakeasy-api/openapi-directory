...
const (
	UntagResourceXAmzTargetEnumAwsProton20200720UntagResource UntagResourceXAmzTargetEnum = "AwsProton20200720.UntagResource"
)
...
func (e *UntagResourceXAmzTargetEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "AwsProton20200720.UntagResource":
