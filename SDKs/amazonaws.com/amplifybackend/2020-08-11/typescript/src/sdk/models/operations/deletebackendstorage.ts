 ...
 */
export enum DeleteBackendStorageRequestBodyServiceNameEnum {
  S3 = "S3",
}

export class DeleteBackendStorageRequestBody extends SpeakeasyBase {
  /**
...
export class DeleteBackendStorageRequest extends SpeakeasyBase {
