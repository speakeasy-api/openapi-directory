 ...
 */
public class GetZRLocationSettings200ApplicationJSON2Notification {
    /**
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withAudioMeetUsabilityThreshold(Boolean audioMeetUsabilityThreshold) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withAudioNotMeetUsabilityThreshold(Boolean audioNotMeetUsabilityThreshold) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withBatteryIsCharging(Boolean batteryIsCharging) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withBatteryLowAndNotCharging(Boolean batteryLowAndNotCharging) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withBatteryPercentage(String batteryPercentage) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withControllerSchedulingDisconnected(Boolean controllerSchedulingDisconnected) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withControllerSchedulingReconnected(Boolean controllerSchedulingReconnected) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withCpuUsageHighDetected(Boolean cpuUsageHighDetected) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withMicSpeakerCameraDisconnected(Boolean micSpeakerCameraDisconnected) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withMicSpeakerCameraReconnected(Boolean micSpeakerCameraReconnected) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withNetworkUnstableDetected(Boolean networkUnstableDetected) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withSipRegistrationFailed(Boolean sipRegistrationFailed) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withSipRegistrationReEnabled(Boolean sipRegistrationReEnabled) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withZoomRoomComeBackOnline(Boolean zoomRoomComeBackOnline) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withZoomRoomDisplayDisconnected(Boolean zoomRoomDisplayDisconnected) {
    ...
    public GetZRLocationSettings200ApplicationJSON2Notification withZoomRoomOffline(Boolean zoomRoomOffline) {
