...
from ..shared import computenodelistresult as shared_computenodelistresult
...
class ComputeNodeListRequest:
    ...
    r"""The id of the pool from which you want to list nodes."""  
...
class ComputeNodeListResponse:
    ...
    compute_node_list_result: Optional[shared_computenodelistresult.ComputeNodeListResult] = dataclasses.field(default=None)  
