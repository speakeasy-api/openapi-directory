...
export enum GETListImagesInRecycleBinActionEnum {
  ListImagesInRecycleBin = "ListImagesInRecycleBin",
}

export enum GETListImagesInRecycleBinVersionEnum {
  TwoThousandAndSixteen1115 = "2016-11-15",
}

export class GETListImagesInRecycleBinRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class GETListImagesInRecycleBinResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
