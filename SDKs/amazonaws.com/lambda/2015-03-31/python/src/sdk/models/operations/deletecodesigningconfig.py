...
@dataclasses.dataclass
class DeleteCodeSigningConfigHeaders:
...
class DeleteCodeSigningConfigRequest:
    headers: DeleteCodeSigningConfigHeaders = dataclasses.field()
    path_params: DeleteCodeSigningConfigPathParams = dataclasses.field()
...
class DeleteCodeSigningConfigResponse:
    ...
    delete_code_signing_config_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
