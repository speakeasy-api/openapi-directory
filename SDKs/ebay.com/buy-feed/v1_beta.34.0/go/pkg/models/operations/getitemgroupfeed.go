...
type GetItemGroupFeedQueryParams struct {
	...
	FeedScope string `queryParam:"style=form,explode=true,name=feed_scope"`
}

type GetItemGroupFeedHeaders struct {
...
type GetItemGroupFeedRequest struct {
	QueryParams GetItemGroupFeedQueryParams
	Headers     GetItemGroupFeedHeaders
	Security    GetItemGroupFeedSecurity
}

type GetItemGroupFeedResponse struct {
	Body        []byte
	ContentType string
