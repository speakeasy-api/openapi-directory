 ...
 */
export declare enum TagSpecificationListResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class TagSpecificationListTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class TagSpecificationList extends SpeakeasyBase {
