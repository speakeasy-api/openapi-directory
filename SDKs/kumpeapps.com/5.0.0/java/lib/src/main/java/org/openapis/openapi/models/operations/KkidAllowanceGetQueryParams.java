...
public class KkidAllowanceGetQueryParams {
    /**
     * userID of the kid
     */
    @SpeakeasyMetadata("queryParam:style=form,explode=true,name=kidUserId")
    public Long kidUserId;
    public KkidAllowanceGetQueryParams withKidUserId(Long kidUserId) {
    ...
    public KkidAllowanceGetQueryParams withTransactionDays(Long transactionDays) {
