...
class MotorcycleBaseListing:
    r"""Base motorcycle listing"""
    
    build: Optional[shared_motorcyclebuild.MotorcycleBuild] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('build'), 'exclude': lambda f: f is None }})
    ...
    r"""Distance of the motorcycle's location from the specified user lcoation"""  
    ...
    r"""Details Page url of the specific motorcycle"""  
    ...
    r"""Inventory type of motorcycle"""  
    ...
    r"""Odometer reading / reported miles usage for the motorcycle"""  
    ...
    r"""Asking price for the motorcycle"""  
    ...
    r"""Seller type for the motorcycle"""  
    ...
    r"""Stock number of motorcycle in dealers inventory"""  
