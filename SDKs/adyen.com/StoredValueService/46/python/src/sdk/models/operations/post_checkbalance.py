...
from ..shared import storedvaluebalancecheckresponse as shared_storedvaluebalancecheckresponse
from typing import Optional


@dataclasses.dataclass
class PostCheckBalanceSecurity:
...
@dataclasses.dataclass
class PostCheckBalanceResponse:
    ...
    stored_value_balance_check_response: Optional[shared_storedvaluebalancecheckresponse.StoredValueBalanceCheckResponse] = dataclasses.field(default=None)
