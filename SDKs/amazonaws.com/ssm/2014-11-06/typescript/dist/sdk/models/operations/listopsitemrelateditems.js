...
exports.ListOpsItemRelatedItemsResponse = exports.ListOpsItemRelatedItemsRequest = exports.ListOpsItemRelatedItemsXAmzTargetEnum = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var ListOpsItemRelatedItemsXAmzTargetEnum;
...
})(ListOpsItemRelatedItemsXAmzTargetEnum = exports.ListOpsItemRelatedItemsXAmzTargetEnum || (exports.ListOpsItemRelatedItemsXAmzTargetEnum = {}));
var ListOpsItemRelatedItemsRequest = /** @class */ (function (_super) {
    ...
    ], ListOpsItemRelatedItemsRequest.prototype, "listOpsItemRelatedItemsRequest", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256",
        }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzContentSha256", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Credential",
        }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzCredential", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Date",
        }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzDate", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Security-Token",
        }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Signature",
        }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzSignature", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders",
        }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzSignedHeaders", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "header, style=simple;explode=false;name=X-Amz-Target",
        }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "xAmzTarget", void 0);
...
var ListOpsItemRelatedItemsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        __metadata("design:type", Object)
    ], ListOpsItemRelatedItemsResponse.prototype, "rawResponse", void 0);
