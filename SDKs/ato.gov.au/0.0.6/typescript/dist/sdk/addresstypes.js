 ...
 *
 */
var AddressTypes = /** @class */ (function () {
    function AddressTypes(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     */
    AddressTypes.prototype.getClassificationsAddressTypes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetClassificationsAddressTypesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/classifications/address-types";
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.GetClassificationsAddressTypesResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json")) {
                        ...
                        res.addressTypes = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.AddressType, resFieldDepth);
                    }
                    break;
