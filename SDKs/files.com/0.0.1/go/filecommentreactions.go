...
func (s *fileCommentReactions) PostFileCommentReactions(ctx context.Context, request operations.PostFileCommentReactionsRequestBody) (*operations.PostFileCommentReactionsResponse, error) {
	baseURL := s.serverURL
