...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities:
    r"""APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities
...
@dataclass_json
@dataclasses.dataclass
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational:
    ...
    capabilities: Optional[APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNationalCapabilities] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
