...
export class CloudsupportProjectsUpdateCasesSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class CloudsupportProjectsUpdateCasesRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class CloudsupportProjectsUpdateCasesResponse extends SpeakeasyBase {
  /**
   * Successful response
   */
  @SpeakeasyMetadata()
