...
var Reservations = /** @class */ (function () {
    ...
    **/
    Reservations.prototype.getReservation = function (req, config) {
    ...
    **/
    Reservations.prototype.getReservations = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Reservations.prototype.updatereservation = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
