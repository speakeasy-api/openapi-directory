...
public class ListShipmentsResponseBodyPartialShipment {
    ...
    public ListShipmentsResponseBodyPartialShipment withIsReturn(Boolean isReturn) {
    ...
    public ListShipmentsResponseBodyPartialShipment(@JsonProperty("advanced_options") AdvancedShipmentOptions advancedOptions, @JsonProperty("carrier_id") String carrierId, @JsonProperty("confirmation") ListShipmentsResponseBodyPartialShipmentDeliveryConfirmationEnum confirmation, @JsonProperty("created_at") OffsetDateTime createdAt, @JsonProperty("customs") ListShipmentsResponseBodyPartialShipmentInternationalShipmentOptions customs, @JsonProperty("insurance_provider") ListShipmentsResponseBodyPartialShipmentInsuranceProviderEnum insuranceProvider, @JsonProperty("modified_at") OffsetDateTime modifiedAt, @JsonProperty("packages") Package[] packages, @JsonProperty("return_to") ShippingAddress returnTo, @JsonProperty("service_code") String serviceCode, @JsonProperty("ship_date") OffsetDateTime shipDate, @JsonProperty("ship_from") ShippingAddress shipFrom, @JsonProperty("ship_to") ShippingAddress shipTo, @JsonProperty("shipment_id") String shipmentId, @JsonProperty("shipment_status") ListShipmentsResponseBodyPartialShipmentShipmentStatusEnum shipmentStatus, @JsonProperty("tags") Tag[] tags, @JsonProperty("total_weight") ListShipmentsResponseBodyPartialShipmentWeight totalWeight, @JsonProperty("warehouse_id") String warehouseId) {
        this.advancedOptions = advancedOptions;
        this.carrierId = carrierId;
        this.confirmation = confirmation;
        this.createdAt = createdAt;
