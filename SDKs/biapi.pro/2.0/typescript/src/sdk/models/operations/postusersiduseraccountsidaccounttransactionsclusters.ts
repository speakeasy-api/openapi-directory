...
export class PostUsersIdUserAccountsIdAccountTransactionsclustersRequest extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class PostUsersIdUserAccountsIdAccountTransactionsclustersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
