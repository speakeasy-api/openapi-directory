...
class CreateAdByListingIdRequest
{
     ...
     * 
     * @var \OpenAPI\OpenAPI\Models\Shared\CreateAdRequest $createAdRequest
     */
	#[SpeakeasyMetadata('request:mediaType=application/json')]
    public \OpenAPI\OpenAPI\Models\Shared\CreateAdRequest $createAdRequest;
	...
	{
		$this->createAdRequest = new \OpenAPI\OpenAPI\Models\Shared\CreateAdRequest();
		$this->campaignId = "";
	}
}
