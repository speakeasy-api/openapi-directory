...
class DriveCommentsGetRequest:
    path_params: DriveCommentsGetPathParams = dataclasses.field()
    query_params: DriveCommentsGetQueryParams = dataclasses.field()
    security: DriveCommentsGetSecurity = dataclasses.field()
