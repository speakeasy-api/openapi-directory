...
func (e GetNetworkSensorRelationships200ApplicationJSONDeviceProductTypeEnum) ToPointer() *GetNetworkSensorRelationships200ApplicationJSONDeviceProductTypeEnum {
	return &e
}
...
func (e *GetNetworkSensorRelationships200ApplicationJSONDeviceProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "camera":
		fallthrough
	case "sensor":
		*e = GetNetworkSensorRelationships200ApplicationJSONDeviceProductTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSensorRelationships200ApplicationJSONDeviceProductTypeEnum: %v", v)
	}
}
...
func (e GetNetworkSensorRelationships200ApplicationJSONRelationshipsLivestreamRelatedDevicesProductTypeEnum) ToPointer() *GetNetworkSensorRelationships200ApplicationJSONRelationshipsLivestreamRelatedDevicesProductTypeEnum {
	return &e
}
...
func (e *GetNetworkSensorRelationships200ApplicationJSONRelationshipsLivestreamRelatedDevicesProductTypeEnum) UnmarshalJSON(data []byte) error {
	...
	case "camera":
		fallthrough
	case "sensor":
		*e = GetNetworkSensorRelationships200ApplicationJSONRelationshipsLivestreamRelatedDevicesProductTypeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for GetNetworkSensorRelationships200ApplicationJSONRelationshipsLivestreamRelatedDevicesProductTypeEnum: %v", v)
	}
}
