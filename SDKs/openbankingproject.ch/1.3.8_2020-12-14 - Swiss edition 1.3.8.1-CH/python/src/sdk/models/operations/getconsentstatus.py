...
from ..shared import consentstatusresponse_200 as shared_consentstatusresponse_200


@dataclasses.dataclass
class GetConsentStatusPathParams:
    consent_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'consentId', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetConsentStatusHeaders:
...
@dataclasses.dataclass
class GetConsentStatusSecurity:
...
class GetConsentStatusRequest:
    headers: GetConsentStatusHeaders = dataclasses.field()
    path_params: GetConsentStatusPathParams = dataclasses.field()
    security: GetConsentStatusSecurity = dataclasses.field()
...
class GetConsentStatusResponse:
    ...
    consent_status_response_200: Optional[shared_consentstatusresponse_200.ConsentStatusResponse200] = dataclasses.field(default=None)
