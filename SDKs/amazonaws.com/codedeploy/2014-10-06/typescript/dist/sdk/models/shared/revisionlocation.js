...
var RevisionLocation = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "appSpecContent" }),
        (0, class_transformer_1.Type)(function () { return appspeccontent_1.AppSpecContent; }),
        __metadata("design:type", appspeccontent_1.AppSpecContent)
    ], RevisionLocation.prototype, "appSpecContent", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "gitHubLocation" }),
        (0, class_transformer_1.Type)(function () { return githublocation_1.GitHubLocation; }),
        __metadata("design:type", githublocation_1.GitHubLocation)
    ], RevisionLocation.prototype, "gitHubLocation", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "revisionType" }),
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return rawstring_1.RawString; }),
