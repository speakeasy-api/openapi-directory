...
func (e *APIV2010AccountAddressDependentPhoneNumberSmsFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountAddressDependentPhoneNumberSmsFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountAddressDependentPhoneNumberSmsFallbackMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountAddressDependentPhoneNumberSmsMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountAddressDependentPhoneNumberSmsMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountAddressDependentPhoneNumberSmsMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountAddressDependentPhoneNumberStatusCallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountAddressDependentPhoneNumberStatusCallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountAddressDependentPhoneNumberStatusCallbackMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountAddressDependentPhoneNumberVoiceFallbackMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountAddressDependentPhoneNumberVoiceFallbackMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountAddressDependentPhoneNumberVoiceFallbackMethodEnum: %s", s)
	}
}
...
func (e *APIV2010AccountAddressDependentPhoneNumberVoiceMethodEnum) UnmarshalJSON(data []byte) error {
	...
	case "PUT":
		fallthrough
	case "DELETE":
		*e = APIV2010AccountAddressDependentPhoneNumberVoiceMethodEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for APIV2010AccountAddressDependentPhoneNumberVoiceMethodEnum: %s", s)
	}
}
