...
func (e *POSTDescribeReservedCacheNodesActionEnum) UnmarshalJSON(data []byte) error {
	...
	case "DescribeReservedCacheNodes":
		*e = POSTDescribeReservedCacheNodesActionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeReservedCacheNodesActionEnum: %s", s)
	}
}
...
func (e *POSTDescribeReservedCacheNodesVersionEnum) UnmarshalJSON(data []byte) error {
	...
	switch s {
	case "2015-02-02":
		*e = POSTDescribeReservedCacheNodesVersionEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for POSTDescribeReservedCacheNodesVersionEnum: %s", s)
	}
}
