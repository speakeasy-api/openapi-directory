 ...
 *
 */
export declare enum DomainVerificationSummaryStatusEnum {
    Completed = "COMPLETED",
 ...
 *
 */
export declare enum DomainVerificationSummaryTypeEnum {
 ...
 */
export declare enum DomainVerificationSummaryUsageEnum {
    CommonName = "COMMON_NAME",
    SubjectAlternativeName = "SUBJECT_ALTERNATIVE_NAME"
}
export declare class DomainVerificationSummary extends SpeakeasyBase {
    /**
