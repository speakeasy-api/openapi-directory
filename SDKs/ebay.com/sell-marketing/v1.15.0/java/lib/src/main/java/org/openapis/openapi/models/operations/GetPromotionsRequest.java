...
public class GetPromotionsRequest {
    ...
    public GetPromotionsRequest withLimit(String limit) {
        this.limit = limit;
        return this;
    }
    ...
    public GetPromotionsRequest withMarketplaceId(String marketplaceId) {
    ...
    public GetPromotionsRequest withOffset(String offset) {
        this.offset = offset;
        return this;
    }
    ...
    public GetPromotionsRequest withPromotionStatus(String promotionStatus) {
    ...
    public GetPromotionsRequest withPromotionType(String promotionType) {
    ...
    public GetPromotionsRequest withQ(String q) {
        this.q = q;
        return this;
    }
    ...
    public GetPromotionsRequest withSort(String sort) {
        this.sort = sort;
        return this;
    }
    
    public GetPromotionsRequest(@JsonProperty("marketplace_id") String marketplaceId) {
        this.marketplaceId = marketplaceId;
  }
}
