...
exports.CreateChannelResponse = exports.CreateChannelRequest = exports.CreateChannelSecurity = exports.CreateChannelCreateChannelRequest = exports.CreateChannelServerList = void 0;
...
var CreateChannelCreateChannelRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=ChatFriendlyName;" }),
        __metadata("design:type", String)
    ], CreateChannelCreateChannelRequest.prototype, "chatFriendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=ChatUniqueName;" }),
        __metadata("design:type", String)
    ], CreateChannelCreateChannelRequest.prototype, "chatUniqueName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=ChatUserFriendlyName;" }),
        __metadata("design:type", String)
    ], CreateChannelCreateChannelRequest.prototype, "chatUserFriendlyName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=FlexFlowSid;" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=PreEngagementData;" }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=TaskAttributes;" }),
        __metadata("design:type", String)
    ], CreateChannelCreateChannelRequest.prototype, "taskAttributes", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "form, name=TaskSid;" }),
        __metadata("design:type", String)
