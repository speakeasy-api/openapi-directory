...
class PostProxyResponse:
    ...
    post_proxy_200_application_json_any: Optional[Any] = dataclasses.field(default=None)
    r"""Ok"""  
    post_proxy_401_application_json_object: Optional[PostProxy401ApplicationJSON] = dataclasses.field(default=None)
    r"""Unauthorized"""  
    post_proxy_default_application_json_any: Optional[Any] = dataclasses.field(default=None)
    r"""Proxy error"""  
