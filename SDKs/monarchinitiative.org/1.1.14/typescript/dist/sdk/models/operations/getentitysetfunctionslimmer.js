...
exports.GetEntitySetFunctionSlimmerResponse = exports.GetEntitySetFunctionSlimmerRequest = exports.GetEntitySetFunctionSlimmerRelationshipTypeEnum = void 0;
...
var GetEntitySetFunctionSlimmerRequest = /** @class */ (function (_super) {
    ...
    ], GetEntitySetFunctionSlimmerRequest.prototype, "excludeAutomaticAssertions", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=relationship_type",
        }),
        __metadata("design:type", String)
    ], GetEntitySetFunctionSlimmerRequest.prototype, "relationshipType", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=rows" }),
        __metadata("design:type", Number)
    ], GetEntitySetFunctionSlimmerRequest.prototype, "rows", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=slim" }),
        __metadata("design:type", Array)
    ], GetEntitySetFunctionSlimmerRequest.prototype, "slim", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=start" }),
        __metadata("design:type", Number)
    ], GetEntitySetFunctionSlimmerRequest.prototype, "start", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=subject",
        }),
        __metadata("design:type", Array)
    ], GetEntitySetFunctionSlimmerRequest.prototype, "subject", void 0);
...
var GetEntitySetFunctionSlimmerResponse = /** @class */ (function (_super) {
    ...
    ], GetEntitySetFunctionSlimmerResponse.prototype, "rawResponse", void 0);
