...
class ServiceCredentialsCollection:
    data: Optional[list[shared_servicecredential.ServiceCredential]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
