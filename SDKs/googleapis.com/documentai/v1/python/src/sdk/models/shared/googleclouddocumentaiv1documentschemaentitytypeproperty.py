...
class GoogleCloudDocumentaiV1DocumentSchemaEntityTypeProperty:
    ...
    occurrence_type: Optional[GoogleCloudDocumentaiV1DocumentSchemaEntityTypePropertyOccurrenceTypeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('occurrenceType'), 'exclude': lambda f: f is None }})
    r"""Occurrence type limits the number of instances an entity type appears in the document."""  
