...
type ManagedidentitiesProjectsLocationsGlobalDomainsUpdateLdapssettingsPathParams struct {
	// The resource name of the LDAPS settings. Uses the form: `projects/{project}/locations/{location}/domains/{domain}`.
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type ManagedidentitiesProjectsLocationsGlobalDomainsUpdateLdapssettingsQueryParams struct {
	// V1 error format.
