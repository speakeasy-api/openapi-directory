 ...
 */
export enum NetworkAttachmentListWarningCodeEnum {
...
export class NetworkAttachmentListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class NetworkAttachmentListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: NetworkAttachmentListWarningData })
  @Expose({ name: "data" })
 ...
 * Successful response
 */
export class NetworkAttachmentList extends SpeakeasyBase {
  /**
