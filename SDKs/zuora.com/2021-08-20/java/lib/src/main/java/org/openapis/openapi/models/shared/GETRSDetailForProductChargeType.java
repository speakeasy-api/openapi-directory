 ...
 * 
 */
public class GETRSDetailForProductChargeType {
    /**
    ...
    public GETRSDetailForProductChargeType withAccountId(String accountId) {
    ...
    public GETRSDetailForProductChargeType withAmount(String amount) {
        this.amount = amount;
        return this;
    }
    ...
    public GETRSDetailForProductChargeType withCreatedOn(OffsetDateTime createdOn) {
    ...
    public GETRSDetailForProductChargeType withCurrency(String currency) {
    ...
    public GETRSDetailForProductChargeType withLinkedTransactionId(String linkedTransactionId) {
    ...
    public GETRSDetailForProductChargeType withLinkedTransactionNumber(String linkedTransactionNumber) {
    ...
    public GETRSDetailForProductChargeType withLinkedTransactionType(String linkedTransactionType) {
    ...
    @JsonProperty("notes")
    public String notes;
    public GETRSDetailForProductChargeType withNotes(String notes) {
        this.notes = notes;
        return this;
    }
    ...
    public GETRSDetailForProductChargeType withNumber(String number) {
        this.number = number;
        return this;
    }
     ...
     */
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("productChargeId")
    public String productChargeId;
    public GETRSDetailForProductChargeType withProductChargeId(String productChargeId) {
    ...
    public GETRSDetailForProductChargeType withRecognitionRuleName(String recognitionRuleName) {
    ...
    public GETRSDetailForProductChargeType withRecognizedRevenue(String recognizedRevenue) {
    ...
    public GETRSDetailForProductChargeType withReferenceId(String referenceId) {
    ...
    public GETRSDetailForProductChargeType withRevenueItems(GETRsRevenueItemType[] revenueItems) {
    ...
    public GETRSDetailForProductChargeType withRevenueScheduleDate(LocalDate revenueScheduleDate) {
    ...
    public GETRSDetailForProductChargeType withUndistributedUnrecognizedRevenue(String undistributedUnrecognizedRevenue) {
    ...
    public GETRSDetailForProductChargeType withUnrecognizedRevenue(String unrecognizedRevenue) {
    ...
    public GETRSDetailForProductChargeType withUpdatedOn(OffsetDateTime updatedOn) {
