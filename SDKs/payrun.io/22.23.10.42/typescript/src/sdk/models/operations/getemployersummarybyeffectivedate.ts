...
export class GetEmployerSummaryByEffectiveDateRequest extends SpeakeasyBase {
  /**
...
export class GetEmployerSummaryByEffectiveDateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
