...
export class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsListSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsListRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DiscoveryengineProjectsLocationsDataStoresBranchesDocumentsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
