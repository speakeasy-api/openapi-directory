...
export class DrivelabelsLabelsUpdateLabelCopyModeRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DrivelabelsLabelsUpdateLabelCopyModeResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
