 ...
 */
export enum VmEndpointNatMappingsListWarningCodeEnum {
...
export class VmEndpointNatMappingsListWarningData extends SpeakeasyBase {
  /**
 ...
 */
export class VmEndpointNatMappingsListWarning extends SpeakeasyBase {
  /**
   * [Output Only] A warning code, if applicable. For example, Compute Engine returns NO_RESULTS_ON_PAGE if there are no results in the response.
   */
  @SpeakeasyMetadata()
   ...
   */
  @SpeakeasyMetadata({ elemType: VmEndpointNatMappingsListWarningData })
  @Expose({ name: "data" })
 ...
 */
export class VmEndpointNatMappingsList extends SpeakeasyBase {
  /**
   ...
   */
  @SpeakeasyMetadata({ elemType: VmEndpointNatMappings })
  @Expose({ name: "result" })
