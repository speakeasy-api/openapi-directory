...
type CreateUserPoolRequestAccountRecoverySetting struct {
...
type CreateUserPoolRequest struct {
	AccountRecoverySetting      *CreateUserPoolRequestAccountRecoverySetting `json:"AccountRecoverySetting,omitempty"`
