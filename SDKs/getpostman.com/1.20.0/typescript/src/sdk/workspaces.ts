...
export class Workspaces {
  ...
  allWorkspaces(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.AllWorkspacesResponse =
        new operations.AllWorkspacesResponse({
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.allWorkspaces200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.AllWorkspaces200ApplicationJSON
            );
          }
          break;
      }
   ...
   */
  createWorkspace(
    req: operations.CreateWorkspaceRequestBody,
    config?: AxiosRequestConfig
  ): Promise<operations.CreateWorkspaceResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CreateWorkspaceRequestBody(req);
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createWorkspace200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.CreateWorkspace200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 400:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.createWorkspace400ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.CreateWorkspace400ApplicationJSON
            );
          }
          break;
      }
  ...
  singleWorkspace(
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      if (httpRes?.status == null)
        throw new Error(`status code not found in response: ${httpRes}`);
      const res: operations.SingleWorkspaceResponse =
        new operations.SingleWorkspaceResponse({
          statusCode: httpRes.status,
          contentType: contentType,
          rawResponse: httpRes,
        });
      switch (true) {
        case httpRes?.status == 200:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.singleWorkspace200ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SingleWorkspace200ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.singleWorkspace404ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.SingleWorkspace404ApplicationJSON
            );
          }
          break;
      }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      switch (true) {
        ...
        case httpRes?.status == 403:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateWorkspace403ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.UpdateWorkspace403ApplicationJSON
            );
          }
          break;
        case httpRes?.status == 404:
          if (utils.matchContentType(contentType, `application/json`)) {
            res.updateWorkspace404ApplicationJSONObject = utils.objectToClass(
              httpRes?.data,
              operations.UpdateWorkspace404ApplicationJSON
            );
          }
          break;
      }
