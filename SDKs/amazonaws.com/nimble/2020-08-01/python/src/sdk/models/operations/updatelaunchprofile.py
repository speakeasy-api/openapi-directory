...
class UpdateLaunchProfileRequestBody:
    ...
    stream_configuration: Optional[UpdateLaunchProfileRequestBodyStreamConfiguration] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('streamConfiguration'), 'exclude': lambda f: f is None }})
    r"""Configuration for streaming workstations created using this launch profile."""  
...
class UpdateLaunchProfileRequest:
    ...
    request_body: UpdateLaunchProfileRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
