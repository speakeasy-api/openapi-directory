...
class DfareportingReportsPatchRequest:
    path_params: DfareportingReportsPatchPathParams = dataclasses.field()
    query_params: DfareportingReportsPatchQueryParams = dataclasses.field()
    security: DfareportingReportsPatchSecurity = dataclasses.field()
