...
class ListSessionsOfGroupUsingPOST200ApplicationJSONData:
    ...
    sessions: Optional[list[ListSessionsOfGroupUsingPOST200ApplicationJSONDataSessions]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sessions'), 'exclude': lambda f: f is None }})  
...
class ListSessionsOfGroupUsingPOST200ApplicationJSON:
    ...
    code: Optional[int] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('code'), 'exclude': lambda f: f is None }})  
    data: Optional[ListSessionsOfGroupUsingPOST200ApplicationJSONData] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('data'), 'exclude': lambda f: f is None }})  
    message: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('message'), 'exclude': lambda f: f is None }})  
