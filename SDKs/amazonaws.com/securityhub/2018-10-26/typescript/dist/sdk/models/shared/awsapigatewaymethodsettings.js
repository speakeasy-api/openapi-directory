...
exports.AwsApiGatewayMethodSettings = void 0;
...
var AwsApiGatewayMethodSettings = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Expose)({ name: "CacheDataEncrypted" }),
        __metadata("design:type", Boolean)
    ], AwsApiGatewayMethodSettings.prototype, "cacheDataEncrypted", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CacheTtlInSeconds" }),
        __metadata("design:type", Number)
    ], AwsApiGatewayMethodSettings.prototype, "cacheTtlInSeconds", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "CachingEnabled" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "MetricsEnabled" }),
        __metadata("design:type", Boolean)
    ], AwsApiGatewayMethodSettings.prototype, "metricsEnabled", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "RequireAuthorizationForCacheControl" }),
        __metadata("design:type", Boolean)
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)(),
        (0, class_transformer_1.Expose)({ name: "UnauthorizedCacheControlHeaderStrategy" }),
        __metadata("design:type", String)
...
exports.AwsApiGatewayMethodSettings = AwsApiGatewayMethodSettings;
