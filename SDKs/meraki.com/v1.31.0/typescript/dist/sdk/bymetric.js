...
exports.ByMetric = void 0;
var utils = __importStar(require("../internal/utils"));
var operations = __importStar(require("./models/operations"));
var ByMetric = /** @class */ (function () {
    function ByMetric(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Return an overview of currently alerting sensors by metric
     */
    ByMetric.prototype.getNetworkSensorAlertsCurrentOverviewByMetric = function (req, config) {
     ...
     * Return an overview of alert occurrences over a timespan, by metric
     */
    ByMetric.prototype.getNetworkSensorAlertsOverviewByMetric = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
