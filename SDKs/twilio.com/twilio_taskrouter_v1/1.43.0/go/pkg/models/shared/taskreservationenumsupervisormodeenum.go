...
func (e TaskReservationEnumSupervisorModeEnum) ToPointer() *TaskReservationEnumSupervisorModeEnum {
	return &e
}
...
func (e *TaskReservationEnumSupervisorModeEnum) UnmarshalJSON(data []byte) error {
	...
	case "whisper":
		fallthrough
	case "barge":
		*e = TaskReservationEnumSupervisorModeEnum(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TaskReservationEnumSupervisorModeEnum: %v", v)
	}
}
