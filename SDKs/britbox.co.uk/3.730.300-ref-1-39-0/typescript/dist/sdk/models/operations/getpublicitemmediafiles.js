...
exports.GetPublicItemMediaFilesResponse = exports.GetPublicItemMediaFilesRequest = void 0;
...
var GetPublicItemMediaFilesRequest = /** @class */ (function (_super) {
    ...
    ], GetPublicItemMediaFilesRequest.prototype, "delivery", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=device",
        }),
        __metadata("design:type", String)
    ], GetPublicItemMediaFilesRequest.prototype, "device", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=false;name=ff" }),
        __metadata("design:type", Array)
    ], GetPublicItemMediaFilesRequest.prototype, "ff", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=formats",
        }),
        __metadata("design:type", Array)
    ], GetPublicItemMediaFilesRequest.prototype, "formats", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "pathParam, style=simple;explode=false;name=id" }),
        __metadata("design:type", String)
    ], GetPublicItemMediaFilesRequest.prototype, "id", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], GetPublicItemMediaFilesRequest.prototype, "lang", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=resolution",
        }),
        __metadata("design:type", String)
    ], GetPublicItemMediaFilesRequest.prototype, "resolution", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=false;name=segments",
        }),
        __metadata("design:type", Array)
    ], GetPublicItemMediaFilesRequest.prototype, "segments", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=sub" }),
        __metadata("design:type", String)
    ], GetPublicItemMediaFilesRequest.prototype, "sub", void 0);
    return GetPublicItemMediaFilesRequest;
}(utils_1.SpeakeasyBase));
exports.GetPublicItemMediaFilesRequest = GetPublicItemMediaFilesRequest;
var GetPublicItemMediaFilesResponse = /** @class */ (function (_super) {
    ...
    ], GetPublicItemMediaFilesResponse.prototype, "rawResponse", void 0);
    return GetPublicItemMediaFilesResponse;
}(utils_1.SpeakeasyBase));
exports.GetPublicItemMediaFilesResponse = GetPublicItemMediaFilesResponse;
