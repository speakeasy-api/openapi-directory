...
export class Partners {
  ...
  displayvideoPartnersBulkEditPartnerAssignedTargetingOptions(
    req: operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsRequest,
    security: operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsSecurity,
    config?: AxiosRequestConfig
  ): Promise<operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req =
        new operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsRequest(
          req
        );
    }
    ...
    if (!(security instanceof utils.SpeakeasyBase)) {
      security =
        new operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsSecurity(
          security
        );
    }
    ...
    return r.then((httpRes: AxiosResponse) => {
      ...
      const res: operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsResponse =
        new operations.DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsResponse(
          {
  ...
  displayvideoPartnersList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/partners";
    if (!(security instanceof utils.SpeakeasyBase)) {
