...
class ListPhoneNumberRequest:
    ...
    r"""The SID of the parent [Service](https://www.twilio.com/docs/proxy/api/service) of the PhoneNumber resources to read."""  
...
class ListPhoneNumberListPhoneNumberResponse:
    ...
    phone_numbers: Optional[list[shared_proxy_v1_service_phone_number.ProxyV1ServicePhoneNumber]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('phone_numbers'), 'exclude': lambda f: f is None }})  
