...
public class TeamsUpdateSecurity {
    ...
    public TeamsUpdateSecurity withJwt(String jwt) {
        this.jwt = jwt;
        return this;
    }
    ...
    public TeamsUpdateSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public TeamsUpdateSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public TeamsUpdateSecurity(@JsonProperty("JWT") String jwt, @JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.jwt = jwt;
        this.key = key;
        this.project = project;
  }
