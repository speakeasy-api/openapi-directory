...
class ManufacturersAccountsProductsGetQueryParams:
    ...
    include: Optional[list[ManufacturersAccountsProductsGetIncludeEnum]] = dataclasses.field(default=None, metadata={'query_param': { 'field_name': 'include', 'style': 'form', 'explode': True }})
...
class ManufacturersAccountsProductsGetRequest:
    path_params: ManufacturersAccountsProductsGetPathParams = dataclasses.field()
    query_params: ManufacturersAccountsProductsGetQueryParams = dataclasses.field()
    security: ManufacturersAccountsProductsGetSecurity = dataclasses.field()
