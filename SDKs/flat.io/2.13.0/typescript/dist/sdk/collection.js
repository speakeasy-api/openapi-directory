...
var Collection = /** @class */ (function () {
     ...
     *
    **/
    Collection.prototype.addScoreToCollection = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddScoreToCollectionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/collections/{collection}/scores/{score}", req.pathParams);
     ...
     *
    **/
    Collection.prototype.createCollection = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Collection.prototype.deleteCollection = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteCollectionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/collections/{collection}", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
     ...
     *
    **/
    Collection.prototype.deleteScoreFromCollection = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Collection.prototype.editCollection = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Collection.prototype.getCollection = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Collection.prototype.listCollectionScores = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListCollectionScoresRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/collections/{collection}/scores", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.getQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        var r = client.request(__assign({ url: url, method: "get" }, requestConfig));
     ...
     *
    **/
    Collection.prototype.listCollections = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Collection.prototype.untrashCollection = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UntrashCollectionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.generateURL(baseURL, "/collections/{collection}/untrash", req.pathParams);
        var client = utils.createSecurityClient(this._defaultClient, req.security);
