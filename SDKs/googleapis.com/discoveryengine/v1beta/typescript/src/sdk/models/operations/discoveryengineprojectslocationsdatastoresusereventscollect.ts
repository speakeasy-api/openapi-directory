...
export class DiscoveryengineProjectsLocationsDataStoresUserEventsCollectSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({
...
export class DiscoveryengineProjectsLocationsDataStoresUserEventsCollectRequest extends SpeakeasyBase {
  /**
   * V1 error format.
   */
  @SpeakeasyMetadata({
...
export class DiscoveryengineProjectsLocationsDataStoresUserEventsCollectResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
