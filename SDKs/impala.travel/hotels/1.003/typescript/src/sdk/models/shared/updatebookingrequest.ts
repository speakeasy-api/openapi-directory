 ...
 */
export enum UpdateBookingRequestPaymentTypeEnum {
  Api = "API",
}

export class UpdateBookingRequestRooms extends SpeakeasyBase {
  /**
...
export class UpdateBookingRequest extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata({ elemType: UpdateBookingRequestRooms })
  @Expose({ name: "rooms" })
  @Type(() => UpdateBookingRequestRooms)
