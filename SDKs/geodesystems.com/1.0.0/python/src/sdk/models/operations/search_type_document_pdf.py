...
class SearchTypeDocumentPdfQueryParams:
...
@dataclasses.dataclass
class SearchTypeDocumentPdfRequest:
    query_params: SearchTypeDocumentPdfQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class SearchTypeDocumentPdfResponse:
