...
from ..shared import structureresponsemany as shared_structureresponsemany


@dataclasses.dataclass
class GetStructuresStructuresGetQueryParams:
...
@dataclasses.dataclass
class GetStructuresStructuresGetRequest:
    query_params: GetStructuresStructuresGetQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetStructuresStructuresGetResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    error_response: Optional[shared_errorresponse.ErrorResponse] = dataclasses.field(default=None)
    structure_response_many: Optional[shared_structureresponsemany.StructureResponseMany] = dataclasses.field(default=None)
