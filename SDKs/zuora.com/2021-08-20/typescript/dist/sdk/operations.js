...
var Operations = /** @class */ (function () {
    ...
    Operations.prototype.postBillingPreview = function (req, config) {
        ...
        try {
            _a = utils.serializeRequestBody(req, "postBillingPreviewParam", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
        ...
        return r.then(function (httpRes) {
            ...
            var res = new operations.POSTBillingPreviewResponse({
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.billingPreviewResult = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.BillingPreviewResult);
                    }
                    break;
            }
            return res;
    ...
    Operations.prototype.postTransactionInvoicePayment = function (req, config) {
        ...
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.serializeRequestBody(req, "postInvoiceCollectType", "json"), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        catch (e) {
            if (e instanceof Error) {
                throw new Error("Error serializing request body, cause: ".concat(e.message));
        ...
        return r.then(function (httpRes) {
            ...
            if ((httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == null)
                throw new Error("status code not found in response: ".concat(httpRes));
            var res = new operations.POSTTransactionInvoicePaymentResponse({
                statusCode: httpRes.status,
                contentType: contentType,
                rawResponse: httpRes,
                headers: utils.getHeadersFromResponse(httpRes.headers),
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.matchContentType(contentType, "application/json; charset=utf-8")) {
                        res.postInvoiceCollectResponseType = utils.objectToClass(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data, shared.POSTInvoiceCollectResponseType);
                    }
                    break;
            }
            return res;
