...
class DeleteAnomalyDetectorRequest:
    headers: DeleteAnomalyDetectorHeaders = dataclasses.field()
    request: DeleteAnomalyDetectorRequestBody = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteAnomalyDetectorResponse:
    ...
    delete_anomaly_detector_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
