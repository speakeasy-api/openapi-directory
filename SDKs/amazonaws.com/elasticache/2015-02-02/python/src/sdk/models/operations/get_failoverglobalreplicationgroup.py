...
class GetFailoverGlobalReplicationGroupQueryParams:
    action: GetFailoverGlobalReplicationGroupActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    primary_region: str = dataclasses.field(metadata={'query_param': { 'field_name': 'PrimaryRegion', 'style': 'form', 'explode': True }})
    ...
    version: GetFailoverGlobalReplicationGroupVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetFailoverGlobalReplicationGroupRequest:
    headers: GetFailoverGlobalReplicationGroupHeaders = dataclasses.field()
    query_params: GetFailoverGlobalReplicationGroupQueryParams = dataclasses.field()
