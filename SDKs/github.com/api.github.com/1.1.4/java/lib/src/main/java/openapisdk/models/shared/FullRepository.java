...
public class FullRepository {
    ...
    public FullRepositoryLicenseSimple license;
    public FullRepository withLicense(FullRepositoryLicenseSimple license) {
    ...
    public FullRepositorySimpleUser organization;
    public FullRepository withOrganization(FullRepositorySimpleUser organization) {
        this.organization = organization;
        return this;
    }
    @JsonProperty("owner")
    public FullRepositorySimpleUser owner;
    public FullRepository withOwner(FullRepositorySimpleUser owner) {
        this.owner = owner;
        return this;
    }
    @JsonInclude(Include.NON_ABSENT)
    ...
    public FullRepositoryRepository templateRepository;
    public FullRepository withTemplateRepository(FullRepositoryRepository templateRepository) {
