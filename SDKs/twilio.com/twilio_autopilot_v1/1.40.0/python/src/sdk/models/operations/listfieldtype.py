...
class ListFieldTypeListFieldTypeResponse:
    ...
    field_types: Optional[list[shared_autopilot_v1_assistant_field_type.AutopilotV1AssistantFieldType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('field_types'), 'exclude': lambda f: f is None }})  
    meta: Optional[ListFieldTypeListFieldTypeResponseMeta] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('meta'), 'exclude': lambda f: f is None }})  
