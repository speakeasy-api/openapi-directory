...
class GetAuthorizeDataShareQueryParams:
    action: GetAuthorizeDataShareActionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAuthorizeDataShareVersionEnum = dataclasses.field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAuthorizeDataShareRequest:
    headers: GetAuthorizeDataShareHeaders = dataclasses.field()
    query_params: GetAuthorizeDataShareQueryParams = dataclasses.field()
