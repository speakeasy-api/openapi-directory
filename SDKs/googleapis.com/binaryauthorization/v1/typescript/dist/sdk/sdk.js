...
var systempolicy_1 = require("./systempolicy");
exports.ServerList = [
...
var SDK = /** @class */ (function () {
    function SDK(props) {
        ...
        this.systempolicy = new systempolicy_1.Systempolicy(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
exports.SDK = SDK;
