...
public class ActionPOSTcreateRequest {
    ...
    public org.openapis.openapi.models.shared.ProxyActioncreateRequest proxyActioncreateRequest;
    public ActionPOSTcreateRequest withProxyActioncreateRequest(org.openapis.openapi.models.shared.ProxyActioncreateRequest proxyActioncreateRequest) {
        this.proxyActioncreateRequest = proxyActioncreateRequest;
        return this;
    }
    ...
    public ActionPOSTcreateRequest withXZuoraWSDLVersion(String xZuoraWSDLVersion) {
    ...
    public ActionPOSTcreateRequest withZuoraEntityIds(String zuoraEntityIds) {
    ...
    public ActionPOSTcreateRequest withZuoraTrackId(String zuoraTrackId) {
    ...
    public ActionPOSTcreateRequest withRejectUnknownFields(Boolean rejectUnknownFields) {
