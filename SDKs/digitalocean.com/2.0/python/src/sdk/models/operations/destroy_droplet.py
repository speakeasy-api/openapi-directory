...
class DestroyDropletRequest:
    path_params: DestroyDropletPathParams = dataclasses.field()
...
class DestroyDropletResponse:
    ...
    destroy_droplet_401_application_json_object: Optional[DestroyDroplet401ApplicationJSON] = dataclasses.field(default=None)
