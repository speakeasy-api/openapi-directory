...
class GetMeNotificationsQueryParams:
...
@dataclasses.dataclass
class GetMeNotificationsRequest:
    query_params: GetMeNotificationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetMeNotificationsResponse:
