...
public class PublicAdvertisedPrefixes {
     ...
     */
    public org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceResponse computePublicAdvertisedPrefixesAnnounce(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceRequest request, org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceRequest.class, baseUrl, "/projects/{project}/global/publicAdvertisedPrefixes/{publicAdvertisedPrefix}/announce", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesAnnounceRequest.class, request, null);
        if (queryParams != null) {
     ...
     * @throws Exception if the API call fails
     */
    public org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawResponse computePublicAdvertisedPrefixesWithdraw(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawRequest request, org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = org.openapis.openapi.utils.Utils.generateURL(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawRequest.class, baseUrl, "/projects/{project}/global/publicAdvertisedPrefixes/{publicAdvertisedPrefix}/withdraw", request, null);
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("POST");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = org.openapis.openapi.utils.Utils.getQueryParams(org.openapis.openapi.models.operations.ComputePublicAdvertisedPrefixesWithdrawRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
