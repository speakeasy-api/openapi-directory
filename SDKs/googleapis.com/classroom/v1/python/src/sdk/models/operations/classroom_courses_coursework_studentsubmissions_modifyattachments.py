...
class ClassroomCoursesCourseWorkStudentSubmissionsModifyAttachmentsRequest:
    ...
    modify_attachments_request: Optional[shared_modifyattachmentsrequest.ModifyAttachmentsRequest] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
