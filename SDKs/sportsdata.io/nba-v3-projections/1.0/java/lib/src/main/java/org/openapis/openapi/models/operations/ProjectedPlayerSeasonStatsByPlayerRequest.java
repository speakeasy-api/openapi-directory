...
public class ProjectedPlayerSeasonStatsByPlayerRequest {
    ...
    public ProjectedPlayerSeasonStatsByPlayerRequest(@JsonProperty("format") ProjectedPlayerSeasonStatsByPlayerFormatEnum format, @JsonProperty("playerid") String playerid, @JsonProperty("season") String season) {
        this.format = format;
        this.playerid = playerid;
        this.season = season;
  }
