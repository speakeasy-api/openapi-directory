...
public class DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIdWatchRequest {
    ...
    public DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIdWatchRequest(@JsonProperty("issue_id") String issueId, @JsonProperty("repo_slug") String repoSlug, @JsonProperty("workspace") String workspace) {
        this.issueId = issueId;
        this.repoSlug = repoSlug;
        this.workspace = workspace;
  }
