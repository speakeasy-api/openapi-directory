...
public class HealthGetQueueTasksSecurity {
    ...
    public HealthGetQueueTasksSecurity withKey(String key) {
        this.key = key;
        return this;
    }
    ...
    public HealthGetQueueTasksSecurity withProject(String project) {
        this.project = project;
        return this;
    }
    
    public HealthGetQueueTasksSecurity(@JsonProperty("Key") String key, @JsonProperty("Project") String project) {
        this.key = key;
        this.project = project;
  }
}
