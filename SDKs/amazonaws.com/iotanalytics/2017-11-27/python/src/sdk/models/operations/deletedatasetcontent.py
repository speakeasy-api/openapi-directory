...
class DeleteDatasetContentRequest:
    headers: DeleteDatasetContentHeaders = dataclasses.field()
    path_params: DeleteDatasetContentPathParams = dataclasses.field()
    query_params: DeleteDatasetContentQueryParams = dataclasses.field()
