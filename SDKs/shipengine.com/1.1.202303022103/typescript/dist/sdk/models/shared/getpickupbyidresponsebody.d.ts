 ...
 */
export declare enum GetPickupByIdResponseBodyPartialAddressAddressResidentialIndicatorEnum {
    Unknown = "unknown",
    Yes = "yes",
    No = "no"
}
 ...
 */
export declare class GetPickupByIdResponseBodyPartialAddress extends SpeakeasyBase {
    /**
 ...
 *
 */
export declare class GetPickupByIdResponseBodyOutput extends SpeakeasyBase {
    /**
