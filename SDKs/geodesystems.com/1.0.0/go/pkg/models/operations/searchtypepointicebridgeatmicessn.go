...
type SearchTypePointIcebridgeAtmIcessnQueryParams struct {
...
type SearchTypePointIcebridgeAtmIcessnRequest struct {
	QueryParams SearchTypePointIcebridgeAtmIcessnQueryParams
}

type SearchTypePointIcebridgeAtmIcessnResponse struct {
	ContentType string
	StatusCode  int
