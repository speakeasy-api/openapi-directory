...
class EventarcProjectsLocationsTriggersPatchPathParams:
    name: str = dataclasses.field(metadata={'path_param': { 'field_name': 'name', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class EventarcProjectsLocationsTriggersPatchQueryParams:
...
class EventarcProjectsLocationsTriggersPatchRequest:
    path_params: EventarcProjectsLocationsTriggersPatchPathParams = dataclasses.field()
    query_params: EventarcProjectsLocationsTriggersPatchQueryParams = dataclasses.field()
    security: EventarcProjectsLocationsTriggersPatchSecurity = dataclasses.field()
