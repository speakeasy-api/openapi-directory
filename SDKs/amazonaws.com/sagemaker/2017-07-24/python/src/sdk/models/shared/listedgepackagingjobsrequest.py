...
from ..shared import listedgepackagingjobssortby_enum as shared_listedgepackagingjobssortby_enum
...
class ListEdgePackagingJobsRequest:
    ...
    model_name_contains: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('ModelNameContains'), 'exclude': lambda f: f is None }})  
    ...
    sort_by: Optional[shared_listedgepackagingjobssortby_enum.ListEdgePackagingJobsSortByEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('SortBy'), 'exclude': lambda f: f is None }})  
    ...
    status_equals: Optional[shared_edgepackagingjobstatus_enum.EdgePackagingJobStatusEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('StatusEquals'), 'exclude': lambda f: f is None }})  
