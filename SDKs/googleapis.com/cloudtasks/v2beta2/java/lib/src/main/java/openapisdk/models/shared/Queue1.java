...
public class Queue1 {
    ...
    public Queue1 withAppEngineHttpTarget(AppEngineHttpTarget appEngineHttpTarget) {
    ...
    public Queue1 withHttpTarget(HttpTarget httpTarget) {
    ...
    public Queue1 withPullTarget(java.util.Map<String, Object> pullTarget) {
