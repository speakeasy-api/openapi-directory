...
public class CreateLinkshorteningMessagingServicePathParams {
    /**
    ...
    public CreateLinkshorteningMessagingServicePathParams withDomainSid(String domainSid) {
    ...
    public CreateLinkshorteningMessagingServicePathParams withMessagingServiceSid(String messagingServiceSid) {
