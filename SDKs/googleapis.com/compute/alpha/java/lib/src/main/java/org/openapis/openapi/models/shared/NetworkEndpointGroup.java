...
public class NetworkEndpointGroup {
    ...
    public NetworkEndpointGroup withSelfLinkWithId(String selfLinkWithId) {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("type")
    public NetworkEndpointGroupTypeEnum type;

    public NetworkEndpointGroup withType(NetworkEndpointGroupTypeEnum type) {
        this.type = type;
        return this;
    }
