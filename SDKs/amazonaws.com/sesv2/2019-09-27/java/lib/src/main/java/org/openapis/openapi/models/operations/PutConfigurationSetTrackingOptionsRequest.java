...
public class PutConfigurationSetTrackingOptionsRequest {
    ...
    public PutConfigurationSetTrackingOptionsRequest(@JsonProperty("ConfigurationSetName") String configurationSetName, @JsonProperty("RequestBody") PutConfigurationSetTrackingOptionsRequestBody requestBody) {
        this.configurationSetName = configurationSetName;
        this.requestBody = requestBody;
  }
}
