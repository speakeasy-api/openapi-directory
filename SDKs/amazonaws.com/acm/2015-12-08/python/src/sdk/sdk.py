...
SERVERS = [
    ...
    r"""The ACM multi-region endpoint"""
    "https://acm.{region}.amazonaws.com",
    r"""The ACM multi-region endpoint"""
    "http://acm.{region}.amazonaws.com.cn",
    r"""The ACM endpoint for China (Beijing) and China (Ningxia)"""
...
class SDK:
    r"""<fullname>Certificate Manager</fullname> <p>You can use Certificate Manager (ACM) to manage SSL/TLS certificates for your Amazon Web Services-based websites and applications. For more information about using ACM, see the <a href=\\"https://docs.aws.amazon.com/acm/latest/userguide/\\">Certificate Manager User Guide</a>.</p>
    ...
    def add_tags_to_certificate(self, request: operations.AddTagsToCertificateRequest) -> operations.AddTagsToCertificateResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, "add_tags_to_certificate_request", 'json')
        ...
        res = operations.AddTagsToCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def export_certificate(self, request: operations.ExportCertificateRequest) -> operations.ExportCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "export_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ExportCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ExportCertificateResponse])
    ...
    def get_account_configuration(self, request: operations.GetAccountConfigurationRequest) -> operations.GetAccountConfigurationResponse:
        ...
        res = operations.GetAccountConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetAccountConfigurationResponse])
    ...
    def get_certificate(self, request: operations.GetCertificateRequest) -> operations.GetCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "get_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.GetCertificateResponse])
    ...
    def list_tags_for_certificate(self, request: operations.ListTagsForCertificateRequest) -> operations.ListTagsForCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "list_tags_for_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ListTagsForCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.ListTagsForCertificateResponse])
    ...
    def put_account_configuration(self, request: operations.PutAccountConfigurationRequest) -> operations.PutAccountConfigurationResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "put_account_configuration_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.PutAccountConfigurationResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def remove_tags_from_certificate(self, request: operations.RemoveTagsFromCertificateRequest) -> operations.RemoveTagsFromCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "remove_tags_from_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RemoveTagsFromCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def renew_certificate(self, request: operations.RenewCertificateRequest) -> operations.RenewCertificateResponse:
        r"""Renews an eligible ACM certificate. At this time, only exported private certificates can be renewed with this operation. In order to renew your Amazon Web Services Private CA certificates with ACM, you must first <a href=\\"https://docs.aws.amazon.com/privateca/latest/userguide/PcaPermissions.html\\">grant the ACM service principal permission to do so</a>. For more information, see <a href=\\"https://docs.aws.amazon.com/acm/latest/userguide/manual-renewal.html\\">Testing Managed Renewal</a> in the ACM User Guide."""
        base_url = self._server_url
        
        url = base_url.removesuffix('/') + '/#X-Amz-Target=CertificateManager.RenewCertificate'
        
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "renew_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RenewCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def request_certificate(self, request: operations.RequestCertificateRequest) -> operations.RequestCertificateResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "request_certificate_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.RequestCertificateResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
        
        if http_res.status_code == 200:
            if utils.match_content_type(content_type, 'application/json'):
                out = utils.unmarshal_json(http_res.text, Optional[shared.RequestCertificateResponse])
    ...
    def resend_validation_email(self, request: operations.ResendValidationEmailRequest) -> operations.ResendValidationEmailResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "resend_validation_email_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.ResendValidationEmailResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
    ...
    def update_certificate_options(self, request: operations.UpdateCertificateOptionsRequest) -> operations.UpdateCertificateOptionsResponse:
        ...
        headers = utils.get_headers(request)
        req_content_type, data, form = utils.serialize_request_body(request, "update_certificate_options_request", 'json')
        if req_content_type not in ('multipart/form-data', 'multipart/mixed'):
            headers['content-type'] = req_content_type
        if data is None and form is None:
            raise Exception('request body is required')
        ...
        res = operations.UpdateCertificateOptionsResponse(status_code=http_res.status_code, content_type=content_type, raw_response=http_res)
