...
public class SDK {
    ...
    **/
    public openapisdk.models.operations.BatchGetItemResponse batchGetItem(openapisdk.models.operations.BatchGetItemRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.BatchGetItem");
        ...
        openapisdk.models.operations.BatchGetItemResponse res = new openapisdk.models.operations.BatchGetItemResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ...
                openapisdk.models.shared.BatchGetItemOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.BatchGetItemOutput.class);
    ...
    **/
    public openapisdk.models.operations.BatchWriteItemResponse batchWriteItem(openapisdk.models.operations.BatchWriteItemRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.BatchWriteItem");
        ...
        openapisdk.models.operations.BatchWriteItemResponse res = new openapisdk.models.operations.BatchWriteItemResponse() {{
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.BatchWriteItemOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.BatchWriteItemOutput.class);
    ...
    **/
    public openapisdk.models.operations.CreateTableResponse createTable(openapisdk.models.operations.CreateTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.CreateTable");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.CreateTableOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.CreateTableOutput.class);
    ...
    **/
    public openapisdk.models.operations.DeleteItemResponse deleteItem(openapisdk.models.operations.DeleteItemRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.DeleteItem");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DeleteItemOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DeleteItemOutput.class);
    ...
    **/
    public openapisdk.models.operations.DeleteTableResponse deleteTable(openapisdk.models.operations.DeleteTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.DeleteTable");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DeleteTableOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DeleteTableOutput.class);
    ...
    **/
    public openapisdk.models.operations.DescribeTableResponse describeTable(openapisdk.models.operations.DescribeTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.DescribeTable");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.DescribeTableOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.DescribeTableOutput.class);
    ...
    **/
    public openapisdk.models.operations.GetItemResponse getItem(openapisdk.models.operations.GetItemRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.GetItem");
        ...
        openapisdk.models.operations.GetItemResponse res = new openapisdk.models.operations.GetItemResponse() {{
            getItemOutput = null;
            provisionedThroughputExceededException = null;
            resourceNotFoundException = null;
            requestLimitExceeded = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.GetItemOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.GetItemOutput.class);
    ...
    **/
    public openapisdk.models.operations.ListTablesResponse listTables(openapisdk.models.operations.ListTablesRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.ListTables");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ListTablesOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ListTablesOutput.class);
    ...
    **/
    public openapisdk.models.operations.PutItemResponse putItem(openapisdk.models.operations.PutItemRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.PutItem");
        ...
        openapisdk.models.operations.PutItemResponse res = new openapisdk.models.operations.PutItemResponse() {{
            putItemOutput = null;
            conditionalCheckFailedException = null;
            provisionedThroughputExceededException = null;
            resourceNotFoundException = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.PutItemOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.PutItemOutput.class);
    ...
    **/
    public openapisdk.models.operations.QueryResponse query(openapisdk.models.operations.QueryRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.Query");
        ...
        openapisdk.models.operations.QueryResponse res = new openapisdk.models.operations.QueryResponse() {{
            queryOutput = null;
            provisionedThroughputExceededException = null;
            resourceNotFoundException = null;
            requestLimitExceeded = null;
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.QueryOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.QueryOutput.class);
                res.queryOutput = out;
            }
        }
        else if (httpRes.statusCode() == 480) {
    ...
    **/
    public openapisdk.models.operations.ScanResponse scan(openapisdk.models.operations.ScanRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.Scan");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.ScanOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.ScanOutput.class);
                res.scanOutput = out;
            }
        }
        else if (httpRes.statusCode() == 480) {
    ...
    **/
    public openapisdk.models.operations.UpdateItemResponse updateItem(openapisdk.models.operations.UpdateItemRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.UpdateItem");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateItemOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateItemOutput.class);
    ...
    **/
    public openapisdk.models.operations.UpdateTableResponse updateTable(openapisdk.models.operations.UpdateTableRequest request) throws Exception {
        String baseUrl = this._serverUrl;
        String url = openapisdk.utils.Utils.generateURL(baseUrl, "/#X-Amz-Target=DynamoDB_20111205.UpdateTable");
        ...
        if (httpRes.statusCode() == 200) {
            if (openapisdk.utils.Utils.matchContentType(contentType, "application/json")) {
                ObjectMapper mapper = new ObjectMapper();
                mapper.findAndRegisterModules();
                openapisdk.models.shared.UpdateTableOutput out = mapper.readValue(new String(httpRes.body(), StandardCharsets.UTF_8), openapisdk.models.shared.UpdateTableOutput.class);
