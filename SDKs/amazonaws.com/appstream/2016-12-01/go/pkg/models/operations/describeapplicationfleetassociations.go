...
type DescribeApplicationFleetAssociationsHeaders struct {
...
type DescribeApplicationFleetAssociationsRequest struct {
	Headers DescribeApplicationFleetAssociationsHeaders
	Request shared.DescribeApplicationFleetAssociationsRequest `request:"mediaType=application/json"`
}
