...
type SearchProjectVisitQueryParams struct {
...
type SearchProjectVisitRequest struct {
	QueryParams SearchProjectVisitQueryParams
}

type SearchProjectVisitResponse struct {
	ContentType string
	StatusCode  int
