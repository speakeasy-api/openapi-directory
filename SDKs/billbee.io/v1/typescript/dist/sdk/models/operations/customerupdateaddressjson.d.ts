...
export declare class CustomerUpdateAddressJsonRequest extends SpeakeasyBase {
    /**
...
export declare class CustomerUpdateAddressJsonResponse extends SpeakeasyBase {
    body?: Uint8Array;
    contentType: string;
    /**
     * OK
