...
class EditAlbumRequestBody:
    ...
    layout: Optional[EditAlbumRequestBodyLayoutEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('layout'), 'exclude': lambda f: f is None }})
    r"""The type of layout for presenting the album."""  
    ...
    privacy: Optional[EditAlbumRequestBodyPrivacyEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('privacy'), 'exclude': lambda f: f is None }})
    r"""The privacy level of the album."""  
    ...
    sort: Optional[EditAlbumRequestBodySortEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sort'), 'exclude': lambda f: f is None }})
    r"""The default sort order of the album's videos."""  
    theme: Optional[EditAlbumRequestBodyThemeEnum] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('theme'), 'exclude': lambda f: f is None }})
    r"""The color theme of the album."""  
...
class EditAlbumRequest:
    ...
    request_body: Optional[EditAlbumRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/vnd.vimeo.album+json' }})  
