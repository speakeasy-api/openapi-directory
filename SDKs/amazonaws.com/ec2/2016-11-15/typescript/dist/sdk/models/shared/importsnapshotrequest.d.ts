 ...
 */
export declare enum ImportSnapshotRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export declare class ImportSnapshotRequestTagSpecificationsTags extends SpeakeasyBase {
    key?: string;
    value?: string;
}
/**
 ...
 */
export declare class ImportSnapshotRequestTagSpecifications extends SpeakeasyBase {
    resourceType?: ImportSnapshotRequestTagSpecificationsResourceTypeEnum;
    tags?: ImportSnapshotRequestTagSpecificationsTags[];
}
export declare class ImportSnapshotRequest extends SpeakeasyBase {
