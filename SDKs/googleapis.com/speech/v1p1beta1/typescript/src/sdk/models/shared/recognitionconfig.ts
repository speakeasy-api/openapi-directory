...
export class RecognitionConfigInput extends SpeakeasyBase {
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "alternativeLanguageCodes" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "diarizationConfig" })
  @Type(() => SpeakerDiarizationConfigInput)
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enableSeparateRecognitionPerChannel" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enableSpokenEmojis" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enableSpokenPunctuation" })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "enableWordTimeOffsets" })
   ...
   */
  @SpeakeasyMetadata({ elemType: SpeechContext })
   ...
   */
  @SpeakeasyMetadata()
  @Expose({ name: "transcriptNormalization" })
