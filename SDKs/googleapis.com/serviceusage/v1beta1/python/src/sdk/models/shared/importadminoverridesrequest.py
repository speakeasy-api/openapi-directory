...
class ImportAdminOverridesRequest:
    ...
    force_only: Optional[list[ImportAdminOverridesRequestForceOnlyEnum]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('forceOnly'), 'exclude': lambda f: f is None }})
