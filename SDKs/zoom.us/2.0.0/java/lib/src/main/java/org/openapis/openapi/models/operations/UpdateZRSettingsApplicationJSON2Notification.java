 ...
 */
public class UpdateZRSettingsApplicationJSON2Notification {
    /**
    ...
    public UpdateZRSettingsApplicationJSON2Notification withAudioMeetUsabilityThreshold(Boolean audioMeetUsabilityThreshold) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withAudioNotMeetUsabilityThreshold(Boolean audioNotMeetUsabilityThreshold) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withBatteryIsCharging(Boolean batteryIsCharging) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withBatteryLowAndNotCharging(Boolean batteryLowAndNotCharging) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withBatteryPercentage(String batteryPercentage) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withControllerSchedulingDisconnected(Boolean controllerSchedulingDisconnected) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withControllerSchedulingReconnected(Boolean controllerSchedulingReconnected) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withCpuUsageHighDetected(Boolean cpuUsageHighDetected) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withMicSpeakerCameraDisconnected(Boolean micSpeakerCameraDisconnected) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withMicSpeakerCameraReconnected(Boolean micSpeakerCameraReconnected) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withNetworkUnstableDetected(Boolean networkUnstableDetected) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withSipRegistrationFailed(Boolean sipRegistrationFailed) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withSipRegistrationReEnabled(Boolean sipRegistrationReEnabled) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withZoomRoomComeBackOnline(Boolean zoomRoomComeBackOnline) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withZoomRoomDisplayDisconnected(Boolean zoomRoomDisplayDisconnected) {
    ...
    public UpdateZRSettingsApplicationJSON2Notification withZoomRoomOffline(Boolean zoomRoomOffline) {
