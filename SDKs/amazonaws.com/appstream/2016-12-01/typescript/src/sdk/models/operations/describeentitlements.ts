...
export enum DescribeEntitlementsXAmzTargetEnum {
  PhotonAdminProxyServiceDescribeEntitlements = "PhotonAdminProxyService.DescribeEntitlements",
}

export class DescribeEntitlementsRequest extends SpeakeasyBase {
...
export class DescribeEntitlementsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
