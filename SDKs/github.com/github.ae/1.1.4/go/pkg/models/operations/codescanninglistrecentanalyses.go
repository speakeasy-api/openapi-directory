...
const (
	CodeScanningListRecentAnalysesSortEnumCreated CodeScanningListRecentAnalysesSortEnum = "created"
)

func (e *CodeScanningListRecentAnalysesSortEnum) UnmarshalJSON(data []byte) error {
	var s string
	...
	switch s {
	case "created":
		*e = CodeScanningListRecentAnalysesSortEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for CodeScanningListRecentAnalysesSortEnum: %s", s)
	}
}
...
type CodeScanningListRecentAnalysesRequest struct {
	...
	Sort *CodeScanningListRecentAnalysesSortEnum `queryParam:"style=form,explode=true,name=sort"`
