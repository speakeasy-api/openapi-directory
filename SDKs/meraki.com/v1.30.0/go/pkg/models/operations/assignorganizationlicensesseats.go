...
func (e *AssignOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum) UnmarshalJSON(data []byte) error {
	...
	case "unused":
		fallthrough
	case "unusedActive":
		*e = AssignOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum(s)
		return nil
	default:
		return fmt.Errorf("invalid value for AssignOrganizationLicensesSeats200ApplicationJSONResultingLicensesStateEnum: %s", s)
	}
}
