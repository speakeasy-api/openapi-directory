...
class UpdateExpirationForHITRequest:
    ...
    update_expiration_for_hit_request: shared_updateexpirationforhitrequest.UpdateExpirationForHITRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
