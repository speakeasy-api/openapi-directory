...
public class PutFactSecurity {
    ...
    public PutFactSecurity withXFungeneratorsApiSecret(String xFungeneratorsApiSecret) {
        this.xFungeneratorsApiSecret = xFungeneratorsApiSecret;
        return this;
    }
    
    public PutFactSecurity(@JsonProperty("X-Fungenerators-Api-Secret") String xFungeneratorsApiSecret) {
        this.xFungeneratorsApiSecret = xFungeneratorsApiSecret;
  }
}
