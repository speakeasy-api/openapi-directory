...
class PutAutoScalingPolicyInput:
    ...
    auto_scaling_policy: shared_autoscalingpolicy.AutoScalingPolicy = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('AutoScalingPolicy') }})  
