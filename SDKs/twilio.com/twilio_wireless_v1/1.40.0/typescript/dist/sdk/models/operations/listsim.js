...
exports.ListSimResponse = exports.ListSimListSimResponse = exports.ListSimListSimResponseMeta = exports.ListSimRequest = exports.ListSimSecurity = exports.ListSimServerList = void 0;
var utils_1 = require("../../../internal/utils");
var shared = __importStar(require("../shared"));
var class_transformer_1 = require("class-transformer");
exports.ListSimServerList = ["https://wireless.twilio.com"];
var ListSimSecurity = /** @class */ (function (_super) {
    ...
    ], ListSimSecurity.prototype, "password", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "security, scheme=true;type=http;subtype=basic;name=username",
        }),
        __metadata("design:type", String)
    ], ListSimSecurity.prototype, "username", void 0);
...
var ListSimRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListSimRequest.prototype, "eId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Iccid" }),
        __metadata("design:type", String)
    ], ListSimRequest.prototype, "iccid", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "queryParam, style=form;explode=true;name=Page" }),
        __metadata("design:type", Number)
    ], ListSimRequest.prototype, "page", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageSize",
        }),
        __metadata("design:type", Number)
    ], ListSimRequest.prototype, "pageSize", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=PageToken",
        }),
        __metadata("design:type", String)
    ], ListSimRequest.prototype, "pageToken", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=RatePlan",
        }),
        __metadata("design:type", String)
    ], ListSimRequest.prototype, "ratePlan", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=SimRegistrationCode",
        }),
        __metadata("design:type", String)
    ], ListSimRequest.prototype, "simRegistrationCode", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({
            data: "queryParam, style=form;explode=true;name=Status",
        }),
        __metadata("design:type", String)
    ], ListSimRequest.prototype, "status", void 0);
...
var ListSimListSimResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        (0, class_transformer_1.Type)(function () { return ListSimListSimResponseMeta; }),
        __metadata("design:type", ListSimListSimResponseMeta)
    ], ListSimListSimResponse.prototype, "meta", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ elemType: shared.WirelessV1Sim }),
        (0, class_transformer_1.Expose)({ name: "sims" }),
        (0, class_transformer_1.Type)(function () { return shared.WirelessV1Sim; }),
...
var ListSimResponse = /** @class */ (function (_super) {
    ...
    ], ListSimResponse.prototype, "rawResponse", void 0);
