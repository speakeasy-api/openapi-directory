...
class GetAccountsAccountIDStatementsStatementIDRequest:
    headers: GetAccountsAccountIDStatementsStatementIDHeaders = dataclasses.field()
    path_params: GetAccountsAccountIDStatementsStatementIDPathParams = dataclasses.field()
    security: GetAccountsAccountIDStatementsStatementIDSecurity = dataclasses.field()
