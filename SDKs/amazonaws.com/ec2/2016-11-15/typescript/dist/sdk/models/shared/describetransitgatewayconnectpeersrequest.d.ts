 ...
 */
export declare class DescribeTransitGatewayConnectPeersRequestFilters extends SpeakeasyBase {
    name?: string;
    values?: string[];
}
export declare class DescribeTransitGatewayConnectPeersRequest extends SpeakeasyBase {
    dryRun?: boolean;
    filters?: DescribeTransitGatewayConnectPeersRequestFilters[];
    maxResults?: number;
    nextToken?: string;
