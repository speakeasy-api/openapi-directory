...
class HolidaysHoliday:
    ...
    r"""The CLDR territory code of the country in which the holiday is available. E.g. \\"US\\", \\"DE\\", \\"GB\\". A holiday cutoff can only be configured in a shipping settings service with matching delivery country. Always present."""  
    date_: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('date'), 'exclude': lambda f: f is None }})
    r"""Date of the holiday, in ISO 8601 format. E.g. \\"2016-12-25\\" for Christmas 2016. Always present."""  
    ...
    r"""Date on which the order has to arrive at the customer's, in ISO 8601 format. E.g. \\"2016-12-24\\" for 24th December 2016. Always present."""  
