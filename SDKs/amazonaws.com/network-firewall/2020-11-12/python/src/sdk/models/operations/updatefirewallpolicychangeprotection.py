...
class UpdateFirewallPolicyChangeProtectionRequest:
    ...
    update_firewall_policy_change_protection_request: shared_updatefirewallpolicychangeprotectionrequest.UpdateFirewallPolicyChangeProtectionRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})  
