...
exports.WirelessV1SimDataSession = void 0;
...
var WirelessV1SimDataSession = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cell_id" }),
        __metadata("design:type", String)
    ], WirelessV1SimDataSession.prototype, "cellId", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=cell_location_estimate" }),
    ...
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operator_country" }),
        __metadata("design:type", String)
    ], WirelessV1SimDataSession.prototype, "operatorCountry", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operator_mcc" }),
        __metadata("design:type", String)
    ], WirelessV1SimDataSession.prototype, "operatorMcc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operator_mnc" }),
        __metadata("design:type", String)
    ], WirelessV1SimDataSession.prototype, "operatorMnc", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=operator_name" }),
        __metadata("design:type", String)
    ], WirelessV1SimDataSession.prototype, "operatorName", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=packets_downloaded" }),
        __metadata("design:type", Number)
    ], WirelessV1SimDataSession.prototype, "packetsDownloaded", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=packets_uploaded" }),
        __metadata("design:type", Number)
    ], WirelessV1SimDataSession.prototype, "packetsUploaded", void 0);
    __decorate([
        (0, utils_1.SpeakeasyMetadata)({ data: "json, name=radio_link" }),
        __metadata("design:type", String)
...
exports.WirelessV1SimDataSession = WirelessV1SimDataSession;
