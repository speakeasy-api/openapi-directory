 ...
 */
export class CreateNetworkInsightsAccessScopeRequestExcludePathsThroughResources extends SpeakeasyBase {
  @SpeakeasyMetadata()
 ...
 * Describes a path.
 */
export class CreateNetworkInsightsAccessScopeRequestExcludePaths extends SpeakeasyBase {
  @SpeakeasyMetadata()
  ...
  @SpeakeasyMetadata({
    elemType:
      CreateNetworkInsightsAccessScopeRequestExcludePathsThroughResources,
  })
 ...
 * Describes a through resource statement.
 */
export class CreateNetworkInsightsAccessScopeRequestMatchPathsThroughResources extends SpeakeasyBase {
  @SpeakeasyMetadata()
  resourceStatement?: ResourceStatementRequest;
}
 ...
 * Describes a path.
 */
export class CreateNetworkInsightsAccessScopeRequestMatchPaths extends SpeakeasyBase {
  @SpeakeasyMetadata()
  destination?: PathStatementRequest;
 ...
 */
export enum CreateNetworkInsightsAccessScopeRequestTagSpecificationsResourceTypeEnum {
 ...
 * Describes a tag.
 */
export class CreateNetworkInsightsAccessScopeRequestTagSpecificationsTags extends SpeakeasyBase {
  @SpeakeasyMetadata()
  key?: string;
 ...
 */
export class CreateNetworkInsightsAccessScopeRequestTagSpecifications extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class CreateNetworkInsightsAccessScopeRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  clientToken: string;
