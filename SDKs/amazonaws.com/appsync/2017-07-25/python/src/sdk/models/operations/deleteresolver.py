...
class DeleteResolverRequest:
    headers: DeleteResolverHeaders = dataclasses.field()
    path_params: DeleteResolverPathParams = dataclasses.field()
...
class DeleteResolverResponse:
    ...
    delete_resolver_response: Optional[dict[str, Any]] = dataclasses.field(default=None)
