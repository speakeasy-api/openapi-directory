...
class GetGenotypeGenotypeAssociationsPathParams:
    id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class GetGenotypeGenotypeAssociationsQueryParams:
...
@dataclasses.dataclass
class GetGenotypeGenotypeAssociationsRequest:
    path_params: GetGenotypeGenotypeAssociationsPathParams = dataclasses.field()
    query_params: GetGenotypeGenotypeAssociationsQueryParams = dataclasses.field()
    

@dataclasses.dataclass
class GetGenotypeGenotypeAssociationsResponse:
