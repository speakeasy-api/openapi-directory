...
public class CreateArtifactJsonHeaders {
    /**
    ...
    public CreateArtifactJsonHeaders withXRegistryArtifactId(String xRegistryArtifactId) {
    ...
    public CreateArtifactJsonHeaders withXRegistryArtifactType(String xRegistryArtifactType) {
    ...
    public CreateArtifactJsonHeaders withXRegistryContentHash(String xRegistryContentHash) {
    ...
    public CreateArtifactJsonHeaders withXRegistryDescription(String xRegistryDescription) {
    ...
    public CreateArtifactJsonHeaders withXRegistryDescriptionEncoded(String xRegistryDescriptionEncoded) {
    ...
    public CreateArtifactJsonHeaders withXRegistryHashAlgorithm(CreateArtifactJsonXRegistryHashAlgorithmEnum xRegistryHashAlgorithm) {
    ...
    public CreateArtifactJsonHeaders withXRegistryName(String xRegistryName) {
    ...
    public CreateArtifactJsonHeaders withXRegistryNameEncoded(String xRegistryNameEncoded) {
    ...
    public CreateArtifactJsonHeaders withXRegistryVersion(String xRegistryVersion) {
