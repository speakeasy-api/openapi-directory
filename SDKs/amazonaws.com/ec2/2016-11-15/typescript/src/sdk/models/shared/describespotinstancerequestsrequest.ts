 ...
 */
export class DescribeSpotInstanceRequestsRequestFilters extends SpeakeasyBase {
  @SpeakeasyMetadata()
  name?: string;
 ...
 */
export class DescribeSpotInstanceRequestsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  dryRun?: boolean;

  @SpeakeasyMetadata({ elemType: DescribeSpotInstanceRequestsRequestFilters })
  filters?: DescribeSpotInstanceRequestsRequestFilters[];
