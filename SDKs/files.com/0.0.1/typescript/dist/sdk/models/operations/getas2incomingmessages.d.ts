...
export declare class GetAs2IncomingMessagesRequest extends SpeakeasyBase {
    /**
...
export declare class GetAs2IncomingMessagesResponse extends SpeakeasyBase {
    /**
     * A list of As2IncomingMessages objects.
     */
    as2IncomingMessageEntities?: shared.As2IncomingMessageEntity[];
    contentType: string;
    statusCode: number;
